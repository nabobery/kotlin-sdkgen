...
public object ChatCodecs {
  public const val SENDCHATCOMPLETION_REQUEST_CODEC_ID: String = "sendChatCompletion.request"
  ...
  public const val SENDCHATCOMPLETION_RESPONSE_CODEC_ID: String = "sendChatCompletion.response"
  ...
  public val sendChatCompletionResponseCodecAlternative0Registry: MediaTypeCodecRegistry<ChatResult>
  ...
  public val sendChatCompletionResponseCodecAlternative1Registry:
  ...
  public val sendChatCompletionResponseCodecAlternative2Registry:
      MediaTypeCodecRegistry<ErrorResponse> =
      MediaTypeCodecRegistry.of(sendChatCompletionResponseCodecAlternative2Codec)

  public val sendChatCompletionRequestCodecRegistry: MediaTypeCodecRegistry<ChatRequest> =
      MediaTypeCodecRegistry.of(sendChatCompletionRequestCodec)

  public val sendChatCompletionResponseCodecRegistry: MediaTypeCodecRegistry<ChatResult> =
...
public class ChatClient(
   ...
   */
  public suspend fun sendChatCompletion(request: ChatRequest, options: CallOptions = CallOptions()): ChatResult =
    executor.executeWithTypedErrors<ChatRequest, SendChatCompletionResponse, ChatResult>(
    request = SdkExecutionRequest(sendChatCompletionMetadata, baseUri, request, listOf(ChatCodecs
      .SENDCHATCOMPLETION_REQUEST_CODEC_ID), emptyList()),
    ...
    mapSuccess = { response ->
      when (response) {
        ...
        is SendChatCompletionResponse.Http401Json ->
          error("Runtime selected a non-success response for success mapping.")
        is SendChatCompletionResponse.Http500Json ->
          error("Runtime selected a non-success response for success mapping.")
        is SendChatCompletionResponse.Unknown ->
   ...
   * into success values.
   */
  public suspend fun sendChatCompletionWithResponse(request: ChatRequest, options: CallOptions =
    CallOptions()): SdkResponseResult<SendChatCompletionResponse> = executor.executeWithResponse<ChatRequest,
      SendChatCompletionResponse>(SdkExecutionRequest(sendChatCompletionMetadata, baseUri, request, listOf(ChatCodecs
        .SENDCHATCOMPLETION_REQUEST_CODEC_ID), emptyList()), ChatCodecs.sendChatCompletionRequestCodecRegistry,
          SendChatCompletionResponseDecoder, options)
   ...
   */
  public fun sendChatCompletionStream(request: ChatRequest, options: CallOptions = CallOptions()): Flow<ChatDelta> =
    sseFlow(
    streamProvider = {
      executor.executeRawWithTypedErrors<ChatRequest, SendChatCompletionResponse>(
        request = SdkExecutionRequest(sendChatCompletionMetadataStream, baseUri, request, listOf(ChatCodecs
          .SENDCHATCOMPLETION_REQUEST_CODEC_ID), emptyList()),
        requestCodecs = ChatCodecs.sendChatCompletionRequestCodecRegistry,
        responseDecoder = SendChatCompletionResponseDecoder,
        mapError = { response, statusCode, headers ->
    ...
    public override suspend fun decodeWithBody(
      ...
      alternative.id == "sendChatCompletion.response.alternative0" -> SdkResponseDecodeResult(
        value = SendChatCompletionResponse.SuccessJson(
          json = ChatCodecs.sendChatCompletionResponseCodecAlternative0Registry
            .select(listOf("sendChatCompletion.response.alternative0"), mediaType ?: "application/json").decode(body,
      ...
      alternative.id == "sendChatCompletion.response.alternative1" -> SdkResponseDecodeResult(
        value = SendChatCompletionResponse.Http401Json(
          json = ChatCodecs.sendChatCompletionResponseCodecAlternative1Registry
            .select(listOf("sendChatCompletion.response.alternative1"), mediaType ?: "application/json").decode(body,
              mediaType ?: "application/json"),
          statusCode = statusCode,
          headers = headers,
        ),
      ...
      alternative.id == "sendChatCompletion.response.alternative2" -> SdkResponseDecodeResult(
        value = SendChatCompletionResponse.Http500Json(
          json = ChatCodecs.sendChatCompletionResponseCodecAlternative2Registry
            .select(listOf("sendChatCompletion.response.alternative2"), mediaType ?: "application/json").decode(body,
              mediaType ?: "application/json"),
          statusCode = statusCode,
          headers = headers,
        ),
  ...
  public companion object {
    public val sendChatCompletionMetadata: OperationMetadata = OperationMetadata(
          ...
          pagination = null,
          streaming = StreamingDescriptor.ServerSentEvents(terminalSentinel = "[DONE]", inBandError = null,
            requestFlag = null, responseContentType = "text/event-stream"),
        )

    public val sendChatCompletionMetadataStream: OperationMetadata = OperationMetadata(
          operationId = "sendChatCompletion",
          method = "POST",
          path = "/chat/completions",
          requestMediaTypes = listOf("application/json"),
