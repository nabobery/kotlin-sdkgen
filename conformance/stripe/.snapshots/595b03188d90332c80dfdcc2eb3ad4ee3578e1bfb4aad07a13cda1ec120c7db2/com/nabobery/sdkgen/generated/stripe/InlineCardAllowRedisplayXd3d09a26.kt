...
public sealed class InlineCardAllowRedisplayXd3d09a26 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineCardAllowRedisplayXd3d09a26 =
            when (value) {
                Always.value -> Always
    ...
    public object Serializer : KSerializer<InlineCardAllowRedisplayXd3d09a26> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineCardAllowRedisplayXd3d09a26",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineCardAllowRedisplayXd3d09a26 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineCardAllowRedisplayXd3d09a26,
        ) {
