...
public class BillingBillResourceInvoicingPricingPricingPriceDetails(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): BillingBillResourceInvoicingPricingPricingPriceDetails =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<BillingBillResourceInvoicingPricingPricingPriceDetails> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "BillingBillResourceInvoicingPricingPricingPriceDetails must be a JSON object",
                    )
            val price =
                json.decodeRequired<InlineBillingBillResourceInvoicingPricingPricingPriceDetailsPriceXb248ee7a>(
                    rawObject,
                    "price",
                )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: BillingBillResourceInvoicingPricingPricingPriceDetails,
        ) {
...
public fun billingBillResourceInvoicingPricingPricingPriceDetails(
    block: BillingBillResourceInvoicingPricingPricingPriceDetails.Builder.() -> Unit,
): BillingBillResourceInvoicingPricingPricingPriceDetails =
    BillingBillResourceInvoicingPricingPricingPriceDetails.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "BillingBillResourceInvoicingPricingPricingPriceDetails is missing required property '" + name + "'",
            )
