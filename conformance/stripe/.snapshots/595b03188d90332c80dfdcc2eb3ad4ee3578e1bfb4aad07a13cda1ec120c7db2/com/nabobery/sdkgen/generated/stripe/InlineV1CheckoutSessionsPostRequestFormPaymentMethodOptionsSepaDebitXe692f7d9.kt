...
public class InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsSepaDebitXe692f7d9(
    ...
    public val setupFutureUsage: InlineV1CheckoutSessionsPostRequestFormSetupFutureUsageXb8be0a5d? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsSepaDebitXe692f7d9 =
    ...
    public object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsSepaDebitXe692f7d9> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsSepaDebitXe692f7d9 must be a JSON object",
                    )
            return InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsSepaDebitXe692f7d9(
                mandateOptions =
                    rawObject["mandate_options"]?.let {
                        json.decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormMandateOptionsX34040681>(it)
                    },
                setupFutureUsage =
                    rawObject["setup_future_usage"]?.let {
                        json.decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormSetupFutureUsageXb8be0a5d>(it)
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsSepaDebitXe692f7d9,
        ) {
            val jsonEncoder =
...
public fun inlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsSepaDebitXe692f7d9(
    block: InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsSepaDebitXe692f7d9.Builder.() -> Unit,
): InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsSepaDebitXe692f7d9 =
    InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsSepaDebitXe692f7d9.build(block)
