...
public class InlineRefundFailureBalanceTransactionX88292ff3 internal constructor(
        ...
        get() =
            buildSet {
                ...
                if (inspection.matchesBalanceTransaction) {
                    add(
                        InlineRefundFailureBalanceTransactionX88292ff3Branch.BalanceTransaction,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineRefundFailureBalanceTransactionX88292ff3 {
            val inspection = inspectInlineRefundFailureBalanceTransactionX88292ff3(raw)
            if (inspection.matchCount == 0) {
                throw InlineRefundFailureBalanceTransactionX88292ff3NoMatchException(
                    "InlineRefundFailureBalanceTransactionX88292ff3 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineRefundFailureBalanceTransactionX88292ff3> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineRefundFailureBalanceTransactionX88292ff3,
        ) {
...
private fun inspectInlineRefundFailureBalanceTransactionX88292ff3(
    element: JsonElement,
): InlineRefundFailureBalanceTransactionX88292ff3Inspection {
