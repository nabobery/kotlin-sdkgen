...
public class InlineV1BillingPortalConfiab44PostRequestFormFeaturesItemXfa96c7e3(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1BillingPortalConfiab44PostRequestFormFeaturesItemXfa96c7e3 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1BillingPortalConfiab44PostRequestFormFeaturesItemXfa96c7e3> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1BillingPortalConfiab44PostRequestFormFeaturesItemXfa96c7e3 {
            val jsonDecoder =
                decoder.requireJsonDecoder(
                    "InlineV1BillingPortalConfiab44PostRequestFormFeaturesItemXfa96c7e3",
                )
            val json = jsonDecoder.json
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1BillingPortalConfiab44PostRequestFormFeaturesItemXfa96c7e3 must be a JSON object",
                    )
            ...
            return InlineV1BillingPortalConfiab44PostRequestFormFeaturesItemXfa96c7e3(
                ...
                adjustableQuantity =
                    rawObject["adjustable_quantity"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1BillingPortalConfiab44PostRequestFormFeaturesAdjustableQuantityX9bb74386>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1BillingPortalConfiab44PostRequestFormFeaturesItemXfa96c7e3,
        ) {
            val jsonEncoder =
...
public fun inlineV1BillingPortalConfiab44PostRequestFormFeaturesItemXfa96c7e3(
    block: InlineV1BillingPortalConfiab44PostRequestFormFeaturesItemXfa96c7e3.Builder.() -> Unit,
): InlineV1BillingPortalConfiab44PostRequestFormFeaturesItemXfa96c7e3 =
    InlineV1BillingPortalConfiab44PostRequestFormFeaturesItemXfa96c7e3.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1BillingPortalConfiab44PostRequestFormFeaturesItemXfa96c7e3 is missing required property '" +
                    name +
                    "'",
            )
