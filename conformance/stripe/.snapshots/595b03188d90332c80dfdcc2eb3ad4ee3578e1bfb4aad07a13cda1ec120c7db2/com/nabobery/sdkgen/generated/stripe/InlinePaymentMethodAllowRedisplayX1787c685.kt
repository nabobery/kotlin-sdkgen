...
public sealed class InlinePaymentMethodAllowRedisplayX1787c685 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentMethodAllowRedisplayX1787c685 =
            when (value) {
                Always.value -> Always
    ...
    public object Serializer : KSerializer<InlinePaymentMethodAllowRedisplayX1787c685> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentMethodAllowRedisplayX1787c685",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePaymentMethodAllowRedisplayX1787c685 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentMethodAllowRedisplayX1787c685,
        ) {
