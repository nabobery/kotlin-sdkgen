...
public class InlineSetupAttemptSetupIntentX315ddd4f internal constructor(
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineSetupAttemptSetupIntentX315ddd4f {
            val inspection = inspectInlineSetupAttemptSetupIntentX315ddd4f(raw)
            if (inspection.matchCount == 0) {
                throw InlineSetupAttemptSetupIntentX315ddd4fNoMatchException(
                    "InlineSetupAttemptSetupIntentX315ddd4f matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineSetupAttemptSetupIntentX315ddd4f> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineSetupAttemptSetupIntentX315ddd4f,
        ) {
...
private fun inspectInlineSetupAttemptSetupIntentX315ddd4f(
    element: JsonElement,
): InlineSetupAttemptSetupIntentX315ddd4fInspection {
