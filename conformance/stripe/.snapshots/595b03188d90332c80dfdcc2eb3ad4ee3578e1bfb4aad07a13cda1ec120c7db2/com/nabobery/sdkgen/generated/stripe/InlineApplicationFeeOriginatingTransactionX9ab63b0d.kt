...
public class InlineApplicationFeeOriginatingTransactionX9ab63b0d internal constructor(
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineApplicationFeeOriginatingTransactionX9ab63b0d {
            val inspection = inspectInlineApplicationFeeOriginatingTransactionX9ab63b0d(raw)
            if (inspection.matchCount == 0) {
                throw InlineApplicationFeeOriginatingTransactionX9ab63b0dNoMatchException(
                    "InlineApplicationFeeOriginatingTransactionX9ab63b0d matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineApplicationFeeOriginatingTransactionX9ab63b0d> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineApplicationFeeOriginatingTransactionX9ab63b0d,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineApplicationFeeOriginatingTransactionX9ab63b0d",
...
private fun inspectInlineApplicationFeeOriginatingTransactionX9ab63b0d(
    element: JsonElement,
): InlineApplicationFeeOriginatingTransactionX9ab63b0dInspection {
