...
public class InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X70eb0526(
    ...
    public val verificationMethod: InlineV1SubscriptionsPostRequestFormPaymentSettingsVerificationMethodX44d3644a? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X70eb0526 =
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X70eb0526 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X70eb0526> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X70eb0526 must be a JSON object",
                    )
            return InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X70eb0526(
                financialConnections =
                    rawObject["financial_connections"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormPaymentSettingsFinancialConnectionsX405b9039>(
                                it,
                            )
                    },
                verificationMethod =
                    rawObject["verification_method"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormPaymentSettingsVerificationMethodX44d3644a>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X70eb0526,
        ) {
            val jsonEncoder =
...
public fun inlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X70eb0526(
    block: InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X70eb0526.Builder.() -> Unit,
): InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X70eb0526 =
    InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X70eb0526.build(block)
