...
public class InlineV1PaymentRecordsReportPaymentPostRequestFormCustomerDetailsX724b1073(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1PaymentRecordsReportPaymentPostRequestFormCustomerDetailsX724b1073 =
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentRecordsReportPaymentPostRequestFormCustomerDetailsX724b1073 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentRecordsReportPaymentPostRequestFormCustomerDetailsX724b1073> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentRecordsReportPaymentPostRequestFormCustomerDetailsX724b1073 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentRecordsReportPaymentPostRequestFormCustomerDetailsX724b1073,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentRecordsReportPaymentPostRequestFormCustomerDetailsX724b1073(
    block: InlineV1PaymentRecordsReportPaymentPostRequestFormCustomerDetailsX724b1073.Builder.() -> Unit,
): InlineV1PaymentRecordsReportPaymentPostRequestFormCustomerDetailsX724b1073 =
    InlineV1PaymentRecordsReportPaymentPostRequestFormCustomerDetailsX724b1073.build(block)
