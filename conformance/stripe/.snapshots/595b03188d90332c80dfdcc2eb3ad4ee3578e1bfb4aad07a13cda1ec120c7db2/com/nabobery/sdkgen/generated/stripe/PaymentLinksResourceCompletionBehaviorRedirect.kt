...
public class PaymentLinksResourceCompletionBehaviorRedirect(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentLinksResourceCompletionBehaviorRedirect =
    ...
    public object Serializer : KSerializer<PaymentLinksResourceCompletionBehaviorRedirect> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "PaymentLinksResourceCompletionBehaviorRedirect must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentLinksResourceCompletionBehaviorRedirect,
        ) {
...
public fun paymentLinksResourceCompletionBehaviorRedirect(
    block: PaymentLinksResourceCompletionBehaviorRedirect.Builder.() -> Unit,
): PaymentLinksResourceCompletionBehaviorRedirect = PaymentLinksResourceCompletionBehaviorRedirect.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "PaymentLinksResourceCompletionBehaviorRedirect is missing required property '" + name + "'",
            )
