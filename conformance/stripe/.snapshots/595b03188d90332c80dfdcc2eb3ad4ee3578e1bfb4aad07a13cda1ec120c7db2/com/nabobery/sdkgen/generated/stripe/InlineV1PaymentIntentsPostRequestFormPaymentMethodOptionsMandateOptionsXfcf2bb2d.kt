...
public class InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsMandateOptionsXfcf2bb2d(
    public val customMandateUrl: InlineV1PaymentIntentsPostRequestFormCustomMandateUrlX38bc05a1? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsMandateOptionsXfcf2bb2d =
            InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsMandateOptionsXfcf2bb2d(
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsMandateOptionsXfcf2bb2d> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsMandateOptionsXfcf2bb2d must be a JSON object",
                    )
            return InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsMandateOptionsXfcf2bb2d(
                customMandateUrl =
                    rawObject["custom_mandate_url"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormCustomMandateUrlX38bc05a1>(it)
                    },
                intervalDescription =
                ...
                paymentSchedule =
                    rawObject["payment_schedule"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentScheduleX86456689>(it)
                    },
                transactionType =
                    rawObject["transaction_type"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormTransactionTypeX4959f3da>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsMandateOptionsXfcf2bb2d,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsMandateOptionsXfcf2bb2d(
    block: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsMandateOptionsXfcf2bb2d.Builder.() -> Unit,
): InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsMandateOptionsXfcf2bb2d =
    InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsMandateOptionsXfcf2bb2d.build(block)
