...
public class PaymentFlowsAmountDetailsResourceLineItemsListResourceLineItemResourceTax(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): PaymentFlowsAmountDetailsResourceLineItemsListResourceLineItemResourceTax = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentFlowsAmountDetailsResourceLineItemsListResourceLineItemResourceTax> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "PaymentFlowsAmountDetailsResourceLineItemsListResourceLineItemResourceTax must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentFlowsAmountDetailsResourceLineItemsListResourceLineItemResourceTax,
        ) {
            val jsonEncoder =
...
public fun paymentFlowsAmountDetailsResourceLineItemsListResourceLineItemResourceTax(
    block: PaymentFlowsAmountDetailsResourceLineItemsListResourceLineItemResourceTax.Builder.() -> Unit,
): PaymentFlowsAmountDetailsResourceLineItemsListResourceLineItemResourceTax =
    PaymentFlowsAmountDetailsResourceLineItemsListResourceLineItemResourceTax.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "PaymentFlowsAmountDetailsResourceLineItemsListResourceLineItemResourceTax is missing required property '" +
                    name +
                    "'",
            )
