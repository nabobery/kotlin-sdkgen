...
public sealed class InlineV1CustomersSubscriptionsPostRequestFormCollectionMethodX94a7ee9d {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1CustomersSubscriptionsPostRequestFormCollectionMethodX94a7ee9d =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1CustomersSubscriptionsPostRequestFormCollectionMethodX94a7ee9d> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1CustomersSubscriptionsPostRequestFormCollectionMethodX94a7ee9d",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1CustomersSubscriptionsPostRequestFormCollectionMethodX94a7ee9d = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersSubscriptionsPostRequestFormCollectionMethodX94a7ee9d,
        ) {
