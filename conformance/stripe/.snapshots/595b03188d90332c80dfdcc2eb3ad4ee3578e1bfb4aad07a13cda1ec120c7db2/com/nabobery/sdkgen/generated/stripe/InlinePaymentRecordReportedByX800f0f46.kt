...
public sealed class InlinePaymentRecordReportedByX800f0f46 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentRecordReportedByX800f0f46 =
            when (value) {
                Self.value -> Self
                Stripe.value -> Stripe
    ...
    public object Serializer : KSerializer<InlinePaymentRecordReportedByX800f0f46> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentRecordReportedByX800f0f46",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePaymentRecordReportedByX800f0f46 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentRecordReportedByX800f0f46,
        ) {
