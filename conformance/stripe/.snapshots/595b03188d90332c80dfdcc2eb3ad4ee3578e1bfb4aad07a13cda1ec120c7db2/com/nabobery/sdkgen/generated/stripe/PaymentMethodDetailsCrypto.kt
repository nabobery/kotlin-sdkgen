...
public class PaymentMethodDetailsCrypto(
    ...
    public class Builder {
        ...
        public fun build(): PaymentMethodDetailsCrypto =
    ...
    public object Serializer : KSerializer<PaymentMethodDetailsCrypto> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodDetailsCrypto {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodDetailsCrypto must be a JSON object")
            return PaymentMethodDetailsCrypto(
                ...
                network =
                    rawObject["network"]?.let {
                        json.decodeFromJsonElement<InlinePaymentMethodDetailsCryptoNetworkX8770091f>(it)
                    },
                tokenCurrency =
                    rawObject["token_currency"]?.let {
                        json.decodeFromJsonElement<InlinePaymentMethodDetailsCryptoTokenCurrencyX63152529>(it)
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentMethodDetailsCrypto,
        ) {
...
public fun paymentMethodDetailsCrypto(
    block: PaymentMethodDetailsCrypto.Builder.() -> Unit,
): PaymentMethodDetailsCrypto = PaymentMethodDetailsCrypto.build(block)
