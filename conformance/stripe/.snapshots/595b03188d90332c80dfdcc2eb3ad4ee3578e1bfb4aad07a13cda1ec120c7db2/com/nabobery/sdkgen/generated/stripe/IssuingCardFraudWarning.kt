...
public class IssuingCardFraudWarning(
    ...
    public class Builder {
        ...
        public fun build(): IssuingCardFraudWarning =
    ...
    public object Serializer : KSerializer<IssuingCardFraudWarning> {
        ...
        override fun deserialize(decoder: Decoder): IssuingCardFraudWarning {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("IssuingCardFraudWarning must be a JSON object")
            return IssuingCardFraudWarning(
                startedAt =
                    rawObject["started_at"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                type =
                    rawObject["type"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineIssuingCardFraudWarningTypeX2c1248f0?>(element)
                        }
                    },
            )
        }
...
public fun issuingCardFraudWarning(block: IssuingCardFraudWarning.Builder.() -> Unit): IssuingCardFraudWarning =
    IssuingCardFraudWarning.build(block)
