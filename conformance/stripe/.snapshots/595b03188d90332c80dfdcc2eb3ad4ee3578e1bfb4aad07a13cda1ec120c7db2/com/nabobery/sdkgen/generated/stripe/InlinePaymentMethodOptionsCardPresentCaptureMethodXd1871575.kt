...
public sealed class InlinePaymentMethodOptionsCardPresentCaptureMethodXd1871575 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentMethodOptionsCardPresentCaptureMethodXd1871575 =
            when (value) {
                Manual.value -> Manual
    ...
    public object Serializer : KSerializer<InlinePaymentMethodOptionsCardPresentCaptureMethodXd1871575> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentMethodOptionsCardPresentCaptureMethodXd1871575",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePaymentMethodOptionsCardPresentCaptureMethodXd1871575 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentMethodOptionsCardPresentCaptureMethodXd1871575,
        ) {
