...
public sealed class InlineV1InvoicesPostRequestFormPaymentSettingsAmountTypeX1a30f19b {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1InvoicesPostRequestFormPaymentSettingsAmountTypeX1a30f19b =
            when (value) {
                Fixed.value -> Fixed
    ...
    public object Serializer : KSerializer<InlineV1InvoicesPostRequestFormPaymentSettingsAmountTypeX1a30f19b> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1InvoicesPostRequestFormPaymentSettingsAmountTypeX1a30f19b",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1InvoicesPostRequestFormPaymentSettingsAmountTypeX1a30f19b =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesPostRequestFormPaymentSettingsAmountTypeX1a30f19b,
        ) {
