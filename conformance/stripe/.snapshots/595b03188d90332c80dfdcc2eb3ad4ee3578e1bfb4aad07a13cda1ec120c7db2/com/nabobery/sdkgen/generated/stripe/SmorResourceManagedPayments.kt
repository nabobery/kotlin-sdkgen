...
public class SmorResourceManagedPayments(
    ...
    public object Serializer : KSerializer<SmorResourceManagedPayments> {
        ...
        override fun deserialize(decoder: Decoder): SmorResourceManagedPayments {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("SmorResourceManagedPayments must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: SmorResourceManagedPayments,
        ) {
...
public fun smorResourceManagedPayments(
    block: SmorResourceManagedPayments.Builder.() -> Unit,
): SmorResourceManagedPayments = SmorResourceManagedPayments.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException("SmorResourceManagedPayments is missing required property '" + name + "'")
