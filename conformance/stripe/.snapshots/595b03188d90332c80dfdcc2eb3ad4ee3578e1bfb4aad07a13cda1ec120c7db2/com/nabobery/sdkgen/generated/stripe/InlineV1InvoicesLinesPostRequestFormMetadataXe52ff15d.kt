...
public class InlineV1InvoicesLinesPostRequestFormMetadataXe52ff15d internal constructor(
    ...
    public val inlineV1InvoicesLinesPostRequestFormMetadataAnyOf2X524ea29c:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1InvoicesLinesPostRequestFormMetadataAnyOf2X524ea29c) {
                json
                    .decodeFromJsonElement<InlineV1InvoicesLinesPostRequestFormMetadataAnyOf2X524ea29c>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1InvoicesLinesPostRequestFormMetadataXe52ff15dBranch>
        get() =
            buildSet {
                ...
                if (inspection.matchesInlineV1InvoicesLinesPostRequestFormMetadataAnyOf2X524ea29c) {
                    add(
                        InlineV1InvoicesLinesPostRequestFormMetadataXe52ff15dBranch.InlineV1InvoicesLinesPostRequestFormMetadataAnyOf2X524ea29c,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1InvoicesLinesPostRequestFormMetadataXe52ff15d {
            val inspection = inspectInlineV1InvoicesLinesPostRequestFormMetadataXe52ff15d(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1InvoicesLinesPostRequestFormMetadataXe52ff15dNoMatchException(
                    "InlineV1InvoicesLinesPostRequestFormMetadataXe52ff15d matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1InvoicesLinesPostRequestFormMetadataXe52ff15d> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesLinesPostRequestFormMetadataXe52ff15d,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1InvoicesLinesPostRequestFormMetadataXe52ff15d",
...
private fun inspectInlineV1InvoicesLinesPostRequestFormMetadataXe52ff15d(
    element: JsonElement,
): InlineV1InvoicesLinesPostRequestFormMetadataXe52ff15dInspection {
    val matchesBranch1 = element.isJsonDecodable<JsonObject>()
    val matchesInlineV1InvoicesLinesPostRequestFormMetadataAnyOf2X524ea29c =
        element
            .isJsonDecodable<InlineV1InvoicesLinesPostRequestFormMetadataAnyOf2X524ea29c>()
    return InlineV1InvoicesLinesPostRequestFormMetadataXe52ff15dInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1InvoicesLinesPostRequestFormMetadataAnyOf2X524ea29c) {
                    add(
                        "InlineV1InvoicesLinesPostRequestFormMetadataAnyOf2X524ea29c: value does not match InlineV1InvoicesLinesPostRequestFormMetadataAnyOf2X524ea29c",
                    )
                }
            },
    )
