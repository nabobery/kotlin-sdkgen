...
public class InlineSubscriptionDiscountsItemX69962ce0 internal constructor(
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineSubscriptionDiscountsItemX69962ce0 {
            val inspection = inspectInlineSubscriptionDiscountsItemX69962ce0(raw)
            if (inspection.matchCount == 0) {
                throw InlineSubscriptionDiscountsItemX69962ce0NoMatchException(
                    "InlineSubscriptionDiscountsItemX69962ce0 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineSubscriptionDiscountsItemX69962ce0> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineSubscriptionDiscountsItemX69962ce0,
        ) {
...
private fun inspectInlineSubscriptionDiscountsItemX69962ce0(
    element: JsonElement,
): InlineSubscriptionDiscountsItemX69962ce0Inspection {
