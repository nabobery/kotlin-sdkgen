...
public sealed class InlineIssuingDisputeStatusXedda5fca {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineIssuingDisputeStatusXedda5fca =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineIssuingDisputeStatusXedda5fca> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineIssuingDisputeStatusXedda5fca",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineIssuingDisputeStatusXedda5fca =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineIssuingDisputeStatusXedda5fca,
        ) {
