        ...
        override fun deserialize(decoder: Decoder): MandatePayto {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("MandatePayto must be a JSON object")
            val amountType = json.decodeRequired<InlineMandatePaytoAmountTypeXa993e554>(rawObject, "amount_type")
            val paymentSchedule =
                json.decodeRequired<InlineMandatePaytoPaymentScheduleX3b38629b>(
                    rawObject,
                    "payment_schedule",
                )
            return MandatePayto(
                ...
                purpose =
                    rawObject["purpose"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineMandatePaytoPurposeXa378e6f3?>(element)
                        }
                    },
                startDate =
