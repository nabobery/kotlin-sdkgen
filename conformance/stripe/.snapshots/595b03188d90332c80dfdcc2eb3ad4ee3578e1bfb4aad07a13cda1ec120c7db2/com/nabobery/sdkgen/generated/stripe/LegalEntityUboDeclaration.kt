...
public class LegalEntityUboDeclaration(
    ...
    public class Builder {
        ...
        public fun build(): LegalEntityUboDeclaration =
    ...
    public object Serializer : KSerializer<LegalEntityUboDeclaration> {
        ...
        override fun deserialize(decoder: Decoder): LegalEntityUboDeclaration {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("LegalEntityUboDeclaration must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: LegalEntityUboDeclaration,
        ) {
...
public fun legalEntityUboDeclaration(block: LegalEntityUboDeclaration.Builder.() -> Unit): LegalEntityUboDeclaration =
    LegalEntityUboDeclaration.build(block)
