...
public class InlineV1TerminalConfigurationsPostRequestFormOfflineAnyOf1Xe19e9da0(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1TerminalConfigurationsPostRequestFormOfflineAnyOf1Xe19e9da0 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TerminalConfigurationsPostRequestFormOfflineAnyOf1Xe19e9da0> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TerminalConfigurationsPostRequestFormOfflineAnyOf1Xe19e9da0 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TerminalConfigurationsPostRequestFormOfflineAnyOf1Xe19e9da0,
        ) {
            val jsonEncoder =
...
public fun inlineV1TerminalConfigurationsPostRequestFormOfflineAnyOf1Xe19e9da0(
    block: InlineV1TerminalConfigurationsPostRequestFormOfflineAnyOf1Xe19e9da0.Builder.() -> Unit,
): InlineV1TerminalConfigurationsPostRequestFormOfflineAnyOf1Xe19e9da0 =
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TerminalConfigurationsPostRequestFormOfflineAnyOf1Xe19e9da0 is missing required property '" +
                    name +
                    "'",
            )
