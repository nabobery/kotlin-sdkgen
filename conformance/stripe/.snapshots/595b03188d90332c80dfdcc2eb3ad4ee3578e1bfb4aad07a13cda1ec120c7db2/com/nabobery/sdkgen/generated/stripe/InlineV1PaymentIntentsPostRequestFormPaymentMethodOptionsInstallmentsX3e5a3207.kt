...
public class InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsInstallmentsX3e5a3207(
    ...
    public val plan: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsCardAnyOf1PlanX64e4c023? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsInstallmentsX3e5a3207 =
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsInstallmentsX3e5a3207> {
        ...
        override fun deserialize(
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsInstallmentsX3e5a3207 must be a JSON object",
                    )
            return InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsInstallmentsX3e5a3207(
                ...
                plan =
                    rawObject["plan"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsCardAnyOf1PlanX64e4c023>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsInstallmentsX3e5a3207,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsInstallmentsX3e5a3207(
    block: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsInstallmentsX3e5a3207.Builder.() -> Unit,
): InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsInstallmentsX3e5a3207 =
    InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsInstallmentsX3e5a3207.build(block)
