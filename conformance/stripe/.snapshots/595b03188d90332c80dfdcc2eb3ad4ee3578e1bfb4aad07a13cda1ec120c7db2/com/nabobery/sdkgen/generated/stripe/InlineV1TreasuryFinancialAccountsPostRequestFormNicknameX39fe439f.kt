...
internal data class InlineV1TreasuryFinancialAccountsPostRequestFormNicknameX39fe439fInspection(
    ...
    public val matchesInlineV1TreasuryFinancialAccountsPostRequestFormNicknameAnyOf2X5fd1855c: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1TreasuryFinancialAccountsPostRequestFormNicknameAnyOf2X5fd1855c,
            ).count {
                it
            }
}
...
public class InlineV1TreasuryFinancialAccountsPostRequestFormNicknameX39fe439f internal constructor(
    ...
    private val inspection: InlineV1TreasuryFinancialAccountsPostRequestFormNicknameX39fe439fInspection,
) {
    ...
    public val inlineV1TreasuryFinancialAccountsPostRequestFormNicknameAnyOf2X5fd1855c:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1TreasuryFinancialAccountsPostRequestFormNicknameAnyOf2X5fd1855c) {
                json
                    .decodeFromJsonElement<InlineV1TreasuryFinancialAccountsPostRequestFormNicknameAnyOf2X5fd1855c>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1TreasuryFinancialAccountsPostRequestFormNicknameX39fe439fBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1TreasuryFinancialAccountsPostRequestFormNicknameAnyOf2X5fd1855c) {
                    add(
                        InlineV1TreasuryFinancialAccountsPostRequestFormNicknameX39fe439fBranch.InlineV1TreasuryFinancialAccountsPostRequestFormNicknameAnyOf2X5fd1855c,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1TreasuryFinancialAccountsPostRequestFormNicknameX39fe439f {
            val inspection = inspectInlineV1TreasuryFinancialAccountsPostRequestFormNicknameX39fe439f(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1TreasuryFinancialAccountsPostRequestFormNicknameX39fe439fNoMatchException(
                    "InlineV1TreasuryFinancialAccountsPostRequestFormNicknameX39fe439f matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1TreasuryFinancialAccountsPostRequestFormNicknameX39fe439f> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TreasuryFinancialAccountsPostRequestFormNicknameX39fe439f,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1TreasuryFinancialAccountsPostRequestFormNicknameX39fe439f",
...
private fun inspectInlineV1TreasuryFinancialAccountsPostRequestFormNicknameX39fe439f(
    element: JsonElement,
): InlineV1TreasuryFinancialAccountsPostRequestFormNicknameX39fe439fInspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1TreasuryFinancialAccountsPostRequestFormNicknameAnyOf2X5fd1855c =
        element
            .isJsonDecodable<InlineV1TreasuryFinancialAccountsPostRequestFormNicknameAnyOf2X5fd1855c>()
    return InlineV1TreasuryFinancialAccountsPostRequestFormNicknameX39fe439fInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1TreasuryFinancialAccountsPostRequestFormNicknameAnyOf2X5fd1855c) {
                    add(
                        "InlineV1TreasuryFinancialAccountsPostRequestFormNicknameAnyOf2X5fd1855c: value does not match InlineV1TreasuryFinancialAccountsPostRequestFormNicknameAnyOf2X5fd1855c",
                    )
                }
            },
    )
