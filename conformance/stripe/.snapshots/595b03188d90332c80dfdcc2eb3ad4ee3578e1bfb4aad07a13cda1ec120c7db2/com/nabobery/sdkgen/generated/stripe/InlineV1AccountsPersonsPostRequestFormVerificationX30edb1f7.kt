...
public class InlineV1AccountsPersonsPostRequestFormVerificationX30edb1f7(
    public val additionalDocument: InlineV1AccountsPersonsPostRequestFormVerificationAdditionalDocumentX7fb0edd9? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1AccountsPersonsPostRequestFormVerificationX30edb1f7 =
            InlineV1AccountsPersonsPostRequestFormVerificationX30edb1f7(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1AccountsPersonsPostRequestFormVerificationX30edb1f7 =
    ...
    public object Serializer : KSerializer<InlineV1AccountsPersonsPostRequestFormVerificationX30edb1f7> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountsPersonsPostRequestFormVerificationX30edb1f7 must be a JSON object",
                    )
            return InlineV1AccountsPersonsPostRequestFormVerificationX30edb1f7(
                additionalDocument =
                    rawObject["additional_document"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1AccountsPersonsPostRequestFormVerificationAdditionalDocumentX7fb0edd9>(
                                it,
                            )
                    },
                document =
                    rawObject["document"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPersonsPostRequestFormVerificationDocumentXa2eaad71>(
                            it,
                        )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPersonsPostRequestFormVerificationX30edb1f7,
        ) {
...
public fun inlineV1AccountsPersonsPostRequestFormVerificationX30edb1f7(
    block: InlineV1AccountsPersonsPostRequestFormVerificationX30edb1f7.Builder.() -> Unit,
): InlineV1AccountsPersonsPostRequestFormVerificationX30edb1f7 =
    InlineV1AccountsPersonsPostRequestFormVerificationX30edb1f7.build(block)
