...
public class PaymentLinksResourceBusinessName(
    ...
    public object Serializer : KSerializer<PaymentLinksResourceBusinessName> {
        ...
        override fun deserialize(decoder: Decoder): PaymentLinksResourceBusinessName {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentLinksResourceBusinessName must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentLinksResourceBusinessName,
        ) {
...
public fun paymentLinksResourceBusinessName(
    block: PaymentLinksResourceBusinessName.Builder.() -> Unit,
): PaymentLinksResourceBusinessName = PaymentLinksResourceBusinessName.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "PaymentLinksResourceBusinessName is missing required property '" + name + "'",
            )
