...
public class InlineV1TaxRegistrationsPostRequestFormCountryOptionsNoX739993a4(
    ...
    public val standard: InlineV1TaxRegistrationsPostRequestFormCountryOptionsNoStandardX8e1efd55? = null,
) {
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TaxRegistrationsPostRequestFormCountryOptionsNoX739993a4 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TaxRegistrationsPostRequestFormCountryOptionsNoX739993a4> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TaxRegistrationsPostRequestFormCountryOptionsNoX739993a4 must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineV1TaxRegistrationsPostRequestFormCountryOptionsNoTypeXad83099c>(
                    rawObject,
                    "type",
                )
            return InlineV1TaxRegistrationsPostRequestFormCountryOptionsNoX739993a4(
                ...
                standard =
                    rawObject["standard"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsNoStandardX8e1efd55>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TaxRegistrationsPostRequestFormCountryOptionsNoX739993a4,
        ) {
            val jsonEncoder =
...
public fun inlineV1TaxRegistrationsPostRequestFormCountryOptionsNoX739993a4(
    block: InlineV1TaxRegistrationsPostRequestFormCountryOptionsNoX739993a4.Builder.() -> Unit,
): InlineV1TaxRegistrationsPostRequestFormCountryOptionsNoX739993a4 =
    InlineV1TaxRegistrationsPostRequestFormCountryOptionsNoX739993a4.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TaxRegistrationsPostRequestFormCountryOptionsNoX739993a4 is missing required property '" + name +
                    "'",
            )
