...
public data class PaymentLinksResourceCardPaymentMethodOptionsView(
    public val restrictions: InlinePaymentLinksResourceCardPaymentMethodOptionsRestrictionsX3913daa4? = null,
)
...
public class PaymentLinksResourceCardPaymentMethodOptions(
    ...
    public class Builder {
        ...
        public fun build(): PaymentLinksResourceCardPaymentMethodOptions =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentLinksResourceCardPaymentMethodOptions =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentLinksResourceCardPaymentMethodOptions> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "PaymentLinksResourceCardPaymentMethodOptions must be a JSON object",
                    )
                ...
                restrictions =
                    rawObject["restrictions"]?.let { element ->
                        if (element ==
                            ...
                            json
                                .decodeFromJsonElement<InlinePaymentLinksResourceCardPaymentMethodOptionsRestrictionsX3913daa4?>(
                                    element,
                                )
                        }
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentLinksResourceCardPaymentMethodOptions,
        ) {
...
public fun paymentLinksResourceCardPaymentMethodOptions(
    block: PaymentLinksResourceCardPaymentMethodOptions.Builder.() -> Unit,
): PaymentLinksResourceCardPaymentMethodOptions = PaymentLinksResourceCardPaymentMethodOptions.build(block)
