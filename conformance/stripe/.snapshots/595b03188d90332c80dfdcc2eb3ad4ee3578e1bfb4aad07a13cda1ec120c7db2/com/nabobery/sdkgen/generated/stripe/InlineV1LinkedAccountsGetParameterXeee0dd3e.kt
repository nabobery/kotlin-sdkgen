...
public class InlineV1LinkedAccountsGetParameterXeee0dd3e(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1LinkedAccountsGetParameterXeee0dd3e =
            InlineV1LinkedAccountsGetParameterXeee0dd3e(
                account = account,
                customer = customer,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1LinkedAccountsGetParameterXeee0dd3e =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1LinkedAccountsGetParameterXeee0dd3e> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1LinkedAccountsGetParameterXeee0dd3e {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("InlineV1LinkedAccountsGetParameterXeee0dd3e must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1LinkedAccountsGetParameterXeee0dd3e,
        ) {
...
public fun inlineV1LinkedAccountsGetParameterXeee0dd3e(
    block: InlineV1LinkedAccountsGetParameterXeee0dd3e.Builder.() -> Unit,
): InlineV1LinkedAccountsGetParameterXeee0dd3e = InlineV1LinkedAccountsGetParameterXeee0dd3e.build(block)
