...
public class InlineV1CustomersPostRequestFormBankAccountAnyOf1Xe90aabe6(
    ...
    public val accountHolderType: InlineV1CustomersPostRequestFormBankAccountAnyOf1AccountHolderTypeX8ee1b1ea? = null,
    public val currency: String? = null,
    public val objectValue: InlineV1CustomersPostRequestFormBankAccountAnyOf1ObjectValueXa65f79be? = null,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1CustomersPostRequestFormBankAccountAnyOf1Xe90aabe6 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1CustomersPostRequestFormBankAccountAnyOf1Xe90aabe6> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CustomersPostRequestFormBankAccountAnyOf1Xe90aabe6 must be a JSON object",
                    )
            ...
            return InlineV1CustomersPostRequestFormBankAccountAnyOf1Xe90aabe6(
                ...
                accountHolderType =
                    rawObject["account_holder_type"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CustomersPostRequestFormBankAccountAnyOf1AccountHolderTypeX8ee1b1ea>(
                                it,
                            )
                    },
                ...
                objectValue =
                    rawObject["object"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CustomersPostRequestFormBankAccountAnyOf1ObjectValueXa65f79be>(
                                it,
                            )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersPostRequestFormBankAccountAnyOf1Xe90aabe6,
        ) {
...
public fun inlineV1CustomersPostRequestFormBankAccountAnyOf1Xe90aabe6(
    block: InlineV1CustomersPostRequestFormBankAccountAnyOf1Xe90aabe6.Builder.() -> Unit,
): InlineV1CustomersPostRequestFormBankAccountAnyOf1Xe90aabe6 =
    InlineV1CustomersPostRequestFormBankAccountAnyOf1Xe90aabe6.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1CustomersPostRequestFormBankAccountAnyOf1Xe90aabe6 is missing required property '" + name + "'",
            )
