...
public class InlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsAnyOf1Xbba0078b(
    public val amount: InlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsAmountX56d2d1ba? = null,
    public val fromPostalCode: InlineV1PaymentIntentsIncra167PostRequestFormFromPostalCodeX4147c65e? = null,
    public val toPostalCode: InlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsToPostalCodeXcb4c2c53? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsAnyOf1Xbba0078b =
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsAnyOf1Xbba0078b = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsAnyOf1Xbba0078b> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsAnyOf1Xbba0078b must be a JSON object",
                    )
            return InlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsAnyOf1Xbba0078b(
                amount =
                    rawObject["amount"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsAmountX56d2d1ba>(
                                it,
                            )
                    },
                fromPostalCode =
                    rawObject["from_postal_code"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsIncra167PostRequestFormFromPostalCodeX4147c65e>(
                                it,
                            )
                    },
                toPostalCode =
                    rawObject["to_postal_code"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsToPostalCodeXcb4c2c53>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsAnyOf1Xbba0078b,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsAnyOf1Xbba0078b(
    block: InlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsAnyOf1Xbba0078b.Builder.() -> Unit,
): InlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsAnyOf1Xbba0078b =
