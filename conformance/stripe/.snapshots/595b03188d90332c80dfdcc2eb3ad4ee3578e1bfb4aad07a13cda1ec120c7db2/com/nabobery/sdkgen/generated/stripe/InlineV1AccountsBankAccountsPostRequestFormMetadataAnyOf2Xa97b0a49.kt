...
public sealed class InlineV1AccountsBankAccountsPostRequestFormMetadataAnyOf2Xa97b0a49 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1AccountsBankAccountsPostRequestFormMetadataAnyOf2Xa97b0a49 =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1AccountsBankAccountsPostRequestFormMetadataAnyOf2Xa97b0a49> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1AccountsBankAccountsPostRequestFormMetadataAnyOf2Xa97b0a49",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1AccountsBankAccountsPostRequestFormMetadataAnyOf2Xa97b0a49 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsBankAccountsPostRequestFormMetadataAnyOf2Xa97b0a49,
        ) {
