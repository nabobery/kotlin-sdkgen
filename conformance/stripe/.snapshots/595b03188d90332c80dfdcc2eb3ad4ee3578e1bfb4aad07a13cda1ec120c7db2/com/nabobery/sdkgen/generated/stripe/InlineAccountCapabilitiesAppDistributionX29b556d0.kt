...
public sealed class InlineAccountCapabilitiesAppDistributionX29b556d0 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineAccountCapabilitiesAppDistributionX29b556d0 =
            when (value) {
                Active.value -> Active
    ...
    public object Serializer : KSerializer<InlineAccountCapabilitiesAppDistributionX29b556d0> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineAccountCapabilitiesAppDistributionX29b556d0",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineAccountCapabilitiesAppDistributionX29b556d0 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineAccountCapabilitiesAppDistributionX29b556d0,
        ) {
