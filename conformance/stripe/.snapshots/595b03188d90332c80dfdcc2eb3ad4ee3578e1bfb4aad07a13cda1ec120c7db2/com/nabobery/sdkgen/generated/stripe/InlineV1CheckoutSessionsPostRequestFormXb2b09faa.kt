...
public class InlineV1CheckoutSessionsPostRequestFormXb2b09faa(
     ...
     * `custom` sessions.
     */
    public val collectedInformation: InlineV1CheckoutSessionsPostRequestFormCollectedInformationX4b09f07c? = null,
    /**
     ...
     */
    public val lineItems: List<InlineV1CheckoutSessionsPostRequestFormLineItemsItemX031212d6>? = null,
    /**
     ...
     */
    public val shippingOptions: InlineV1CheckoutSessionsPostRequestFormShippingOptionsXe82007b2? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1CheckoutSessionsPostRequestFormXb2b09faa =
            InlineV1CheckoutSessionsPostRequestFormXb2b09faa(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1CheckoutSessionsPostRequestFormXb2b09faa =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormXb2b09faa> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CheckoutSessionsPostRequestFormXb2b09faa must be a JSON object",
                    )
            return InlineV1CheckoutSessionsPostRequestFormXb2b09faa(
                collectedInformation =
                    rawObject["collected_information"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormCollectedInformationX4b09f07c>(
                                it,
                            )
                    },
                ...
                lineItems =
                    rawObject["line_items"]?.let {
                        json.decodeFromJsonElement<List<InlineV1CheckoutSessionsPostRequestFormLineItemsItemX031212d6>>(
                            it,
                        )
                    },
                metadata =
                    rawObject["metadata"]?.let {
                        json.decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormMetadataXea1d646f>(it)
                    },
                shippingOptions =
                    rawObject["shipping_options"]?.let {
                        json.decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormShippingOptionsXe82007b2>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsPostRequestFormXb2b09faa,
        ) {
...
public fun inlineV1CheckoutSessionsPostRequestFormXb2b09faa(
    block: InlineV1CheckoutSessionsPostRequestFormXb2b09faa.Builder.() -> Unit,
): InlineV1CheckoutSessionsPostRequestFormXb2b09faa = InlineV1CheckoutSessionsPostRequestFormXb2b09faa.build(block)
