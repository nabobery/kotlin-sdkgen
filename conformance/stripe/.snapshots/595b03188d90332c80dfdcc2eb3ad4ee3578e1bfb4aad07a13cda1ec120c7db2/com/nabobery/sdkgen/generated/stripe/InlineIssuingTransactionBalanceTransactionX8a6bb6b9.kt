...
public class InlineIssuingTransactionBalanceTransactionX8a6bb6b9 internal constructor(
        ...
        get() =
            buildSet {
                ...
                if (inspection.matchesBalanceTransaction) {
                    add(
                        InlineIssuingTransactionBalanceTransactionX8a6bb6b9Branch.BalanceTransaction,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineIssuingTransactionBalanceTransactionX8a6bb6b9 {
            val inspection = inspectInlineIssuingTransactionBalanceTransactionX8a6bb6b9(raw)
            if (inspection.matchCount == 0) {
                throw InlineIssuingTransactionBalanceTransactionX8a6bb6b9NoMatchException(
                    "InlineIssuingTransactionBalanceTransactionX8a6bb6b9 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineIssuingTransactionBalanceTransactionX8a6bb6b9> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineIssuingTransactionBalanceTransactionX8a6bb6b9,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineIssuingTransactionBalanceTransactionX8a6bb6b9",
...
private fun inspectInlineIssuingTransactionBalanceTransactionX8a6bb6b9(
    element: JsonElement,
): InlineIssuingTransactionBalanceTransactionX8a6bb6b9Inspection {
