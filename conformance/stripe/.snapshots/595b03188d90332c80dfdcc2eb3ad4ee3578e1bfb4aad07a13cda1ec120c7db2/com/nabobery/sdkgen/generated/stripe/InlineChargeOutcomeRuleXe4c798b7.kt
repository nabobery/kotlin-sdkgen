...
public class InlineChargeOutcomeRuleXe4c798b7 internal constructor(
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineChargeOutcomeRuleXe4c798b7 {
            val inspection = inspectInlineChargeOutcomeRuleXe4c798b7(raw)
            if (inspection.matchCount == 0) {
                throw InlineChargeOutcomeRuleXe4c798b7NoMatchException(
                    "InlineChargeOutcomeRuleXe4c798b7 matched 0 branches: " + inspection.failures.joinToString("; "),
                )
            }
    ...
    public object Serializer : KSerializer<InlineChargeOutcomeRuleXe4c798b7> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineChargeOutcomeRuleXe4c798b7,
        ) {
