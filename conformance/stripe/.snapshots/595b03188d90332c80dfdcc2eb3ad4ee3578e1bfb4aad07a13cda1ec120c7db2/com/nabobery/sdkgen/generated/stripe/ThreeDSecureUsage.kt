        ...
        override fun deserialize(decoder: Decoder): ThreeDSecureUsage {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("ThreeDSecureUsage must be a JSON object")
...
public fun threeDSecureUsage(block: ThreeDSecureUsage.Builder.() -> Unit): ThreeDSecureUsage =
    ThreeDSecureUsage.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("ThreeDSecureUsage is missing required property '" + name + "'")
