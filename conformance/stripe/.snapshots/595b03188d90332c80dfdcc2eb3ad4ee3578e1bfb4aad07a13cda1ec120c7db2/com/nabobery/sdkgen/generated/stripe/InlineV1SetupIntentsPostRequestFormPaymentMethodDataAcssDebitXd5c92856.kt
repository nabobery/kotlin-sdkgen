...
public class InlineV1SetupIntentsPostRequestFormPaymentMethodDataAcssDebitXd5c92856(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1SetupIntentsPostRequestFormPaymentMethodDataAcssDebitXd5c92856 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1SetupIntentsPostRequestFormPaymentMethodDataAcssDebitXd5c92856> {
        ...
        override fun deserialize(
            decoder: Decoder,
        ): InlineV1SetupIntentsPostRequestFormPaymentMethodDataAcssDebitXd5c92856 {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SetupIntentsPostRequestFormPaymentMethodDataAcssDebitXd5c92856 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SetupIntentsPostRequestFormPaymentMethodDataAcssDebitXd5c92856,
        ) {
            val jsonEncoder =
...
public fun inlineV1SetupIntentsPostRequestFormPaymentMethodDataAcssDebitXd5c92856(
    block: InlineV1SetupIntentsPostRequestFormPaymentMethodDataAcssDebitXd5c92856.Builder.() -> Unit,
): InlineV1SetupIntentsPostRequestFormPaymentMethodDataAcssDebitXd5c92856 =
    InlineV1SetupIntentsPostRequestFormPaymentMethodDataAcssDebitXd5c92856.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1SetupIntentsPostRequestFormPaymentMethodDataAcssDebitXd5c92856 is missing required property '" +
                    name +
                    "'",
            )
