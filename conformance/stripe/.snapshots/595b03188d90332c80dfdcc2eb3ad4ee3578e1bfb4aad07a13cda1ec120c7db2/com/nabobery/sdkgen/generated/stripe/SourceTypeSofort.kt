...
public class SourceTypeSofort(
    ...
    public class Builder {
        ...
        public fun build(): SourceTypeSofort =
            SourceTypeSofort(
                bankCode = bankCode,
                bankName = bankName,
                bic = bic,
    ...
    public object Serializer : KSerializer<SourceTypeSofort> {
        ...
        override fun deserialize(decoder: Decoder): SourceTypeSofort {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("SourceTypeSofort must be a JSON object")
...
public fun sourceTypeSofort(block: SourceTypeSofort.Builder.() -> Unit): SourceTypeSofort =
    SourceTypeSofort.build(block)
