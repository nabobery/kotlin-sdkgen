...
public class InlineV1AccountsCapabilitiesPostRequestFormX67548eb6(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1AccountsCapabilitiesPostRequestFormX67548eb6 =
            InlineV1AccountsCapabilitiesPostRequestFormX67548eb6(
                expand = expand,
                requested = requested,
            )
    }
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1AccountsCapabilitiesPostRequestFormX67548eb6 =
    ...
    public object Serializer : KSerializer<InlineV1AccountsCapabilitiesPostRequestFormX67548eb6> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountsCapabilitiesPostRequestFormX67548eb6 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsCapabilitiesPostRequestFormX67548eb6,
        ) {
...
public fun inlineV1AccountsCapabilitiesPostRequestFormX67548eb6(
    block: InlineV1AccountsCapabilitiesPostRequestFormX67548eb6.Builder.() -> Unit,
): InlineV1AccountsCapabilitiesPostRequestFormX67548eb6 =
    InlineV1AccountsCapabilitiesPostRequestFormX67548eb6.build(block)
