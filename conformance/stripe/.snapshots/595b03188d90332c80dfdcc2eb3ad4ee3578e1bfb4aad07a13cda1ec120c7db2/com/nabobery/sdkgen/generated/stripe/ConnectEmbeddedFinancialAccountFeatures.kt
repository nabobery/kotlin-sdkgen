...
public class ConnectEmbeddedFinancialAccountFeatures(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): ConnectEmbeddedFinancialAccountFeatures =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<ConnectEmbeddedFinancialAccountFeatures> {
        ...
        override fun deserialize(decoder: Decoder): ConnectEmbeddedFinancialAccountFeatures {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("ConnectEmbeddedFinancialAccountFeatures must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: ConnectEmbeddedFinancialAccountFeatures,
        ) {
...
public fun connectEmbeddedFinancialAccountFeatures(
    block: ConnectEmbeddedFinancialAccountFeatures.Builder.() -> Unit,
): ConnectEmbeddedFinancialAccountFeatures = ConnectEmbeddedFinancialAccountFeatures.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "ConnectEmbeddedFinancialAccountFeatures is missing required property '" + name + "'",
            )
