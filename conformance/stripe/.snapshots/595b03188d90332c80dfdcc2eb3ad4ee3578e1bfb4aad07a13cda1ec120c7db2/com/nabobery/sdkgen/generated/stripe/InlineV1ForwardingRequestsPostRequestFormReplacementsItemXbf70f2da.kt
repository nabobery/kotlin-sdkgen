...
public sealed class InlineV1ForwardingRequestsPostRequestFormReplacementsItemXbf70f2da {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1ForwardingRequestsPostRequestFormReplacementsItemXbf70f2da =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1ForwardingRequestsPostRequestFormReplacementsItemXbf70f2da> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1ForwardingRequestsPostRequestFormReplacementsItemXbf70f2da",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1ForwardingRequestsPostRequestFormReplacementsItemXbf70f2da =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ForwardingRequestsPostRequestFormReplacementsItemXbf70f2da,
        ) {
