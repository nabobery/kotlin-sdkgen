...
public class IssuingDisputeNoValidAuthorizationEvidence(
    ...
    public class Builder {
        ...
        public fun build(): IssuingDisputeNoValidAuthorizationEvidence =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): IssuingDisputeNoValidAuthorizationEvidence =
    ...
    public object Serializer : KSerializer<IssuingDisputeNoValidAuthorizationEvidence> {
        ...
        override fun deserialize(decoder: Decoder): IssuingDisputeNoValidAuthorizationEvidence {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("IssuingDisputeNoValidAuthorizationEvidence must be a JSON object")
                ...
                additionalDocumentation =
                    rawObject["additional_documentation"]?.let { element ->
                        if (element ==
                            ...
                            json
                                .decodeFromJsonElement<InlineIssuingDisputeNoValidAuthorizationEvidenceAdditionalDocumentationX8cce1846?>(
                                    element,
                                )
                        }
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: IssuingDisputeNoValidAuthorizationEvidence,
        ) {
...
public fun issuingDisputeNoValidAuthorizationEvidence(
    block: IssuingDisputeNoValidAuthorizationEvidence.Builder.() -> Unit,
): IssuingDisputeNoValidAuthorizationEvidence = IssuingDisputeNoValidAuthorizationEvidence.build(block)
