...
public class SourceTypeIdeal(
    ...
    public class Builder {
        ...
        public fun build(): SourceTypeIdeal =
            SourceTypeIdeal(
                bank = bank,
                bic = bic,
                ibanLast4 = ibanLast4,
    ...
    public object Serializer : KSerializer<SourceTypeIdeal> {
        ...
        override fun deserialize(decoder: Decoder): SourceTypeIdeal {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("SourceTypeIdeal must be a JSON object")
