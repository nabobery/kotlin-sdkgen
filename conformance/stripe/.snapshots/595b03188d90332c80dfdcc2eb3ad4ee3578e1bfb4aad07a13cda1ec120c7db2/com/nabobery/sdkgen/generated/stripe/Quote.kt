...
public class Quote(
    ...
    public class Builder {
         ...
         * The tax rates applied to this quote.
         */
        public var defaultTaxRates: List<InlineQuoteDefaultTaxRatesItemXd99c0405>? = null
    ...
    public object Serializer : KSerializer<Quote> {
        ...
        override fun deserialize(decoder: Decoder): Quote {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("Quote must be a JSON object")
            ...
            val collectionMethod =
                json.decodeRequired<InlineQuoteCollectionMethodXc934a75e>(
                    rawObject,
                    "collection_method",
                )
            ...
            val statusTransitions =
                json.decodeRequired<QuotesResourceStatusTransitions>(
                    rawObject,
                    "status_transitions",
                )
            val subscriptionData =
                json.decodeRequired<QuotesResourceSubscriptionDataSubscriptionData>(
                    rawObject,
                    "subscription_data",
                )
            ...
            return Quote(
                ...
                application =
                    rawObject["application"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineQuoteApplicationX6159df96?>(element)
                        }
                    },
                ...
                customer =
                    rawObject["customer"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineQuoteCustomerX40ae4996?>(element)
                        }
                    },
                customerAccount =
                ...
                defaultTaxRates =
                    rawObject["default_tax_rates"]?.let {
                        json.decodeFromJsonElement<List<InlineQuoteDefaultTaxRatesItemXd99c0405>>(it)
                    },
                description =
                ...
                fromQuote =
                    rawObject["from_quote"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineQuoteFromQuoteX86014e8c?>(element)
                        }
                    },
                header =
                    rawObject["header"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                invoice =
                    rawObject["invoice"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineQuoteInvoiceX5bd1d2d6?>(element)
                        }
                    },
                lineItems =
                    rawObject["line_items"]?.let {
                        json
                            .decodeFromJsonElement<InlineQuoteLineItemsX6064fea4>(
                                it,
                            )
                    },
                number =
                ...
                onBehalfOf =
                    rawObject["on_behalf_of"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineQuoteOnBehalfOfXcdb50ea5?>(element)
                        }
                    },
                subscription =
                    rawObject["subscription"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineQuoteSubscriptionX578bf401?>(element)
                        }
                    },
                subscriptionSchedule =
                    rawObject["subscription_schedule"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineQuoteSubscriptionScheduleX0c498016?>(element)
                        }
                    },
                testClock =
                    rawObject["test_clock"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineQuoteTestClockXf70c6291?>(element)
                        }
                    },
                transferData =
                    rawObject["transfer_data"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineQuoteTransferDataX81cc6d49?>(element)
                        }
                    },
            )
        }
