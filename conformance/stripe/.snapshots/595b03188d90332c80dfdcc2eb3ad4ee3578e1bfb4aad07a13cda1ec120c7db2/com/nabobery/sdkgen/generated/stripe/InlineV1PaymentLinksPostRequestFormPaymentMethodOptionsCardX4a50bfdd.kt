...
public class InlineV1PaymentLinksPostRequestFormPaymentMethodOptionsCardX4a50bfdd(
    public val restrictions: InlineV1PaymentLinksPostRequestFormPaymentMethodOptionsCardRestrictionsXee8b6d04? = null,
) {
    public class Builder {
        public var restrictions:
            InlineV1PaymentLinksPostRequestFormPaymentMethodOptionsCardRestrictionsXee8b6d04? = null

        public fun build(): InlineV1PaymentLinksPostRequestFormPaymentMethodOptionsCardX4a50bfdd =
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentLinksPostRequestFormPaymentMethodOptionsCardX4a50bfdd = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1PaymentLinksPostRequestFormPaymentMethodOptionsCardX4a50bfdd> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentLinksPostRequestFormPaymentMethodOptionsCardX4a50bfdd must be a JSON object",
                    )
            return InlineV1PaymentLinksPostRequestFormPaymentMethodOptionsCardX4a50bfdd(
                restrictions =
                    rawObject["restrictions"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormPaymentMethodOptionsCardRestrictionsXee8b6d04>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentLinksPostRequestFormPaymentMethodOptionsCardX4a50bfdd,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentLinksPostRequestFormPaymentMethodOptionsCardX4a50bfdd(
    block: InlineV1PaymentLinksPostRequestFormPaymentMethodOptionsCardX4a50bfdd.Builder.() -> Unit,
): InlineV1PaymentLinksPostRequestFormPaymentMethodOptionsCardX4a50bfdd =
    InlineV1PaymentLinksPostRequestFormPaymentMethodOptionsCardX4a50bfdd.build(block)
