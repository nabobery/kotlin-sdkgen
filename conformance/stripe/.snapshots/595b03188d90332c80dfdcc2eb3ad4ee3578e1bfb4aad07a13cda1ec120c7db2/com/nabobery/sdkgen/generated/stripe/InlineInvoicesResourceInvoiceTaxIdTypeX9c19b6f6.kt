...
public sealed class InlineInvoicesResourceInvoiceTaxIdTypeX9c19b6f6 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineInvoicesResourceInvoiceTaxIdTypeX9c19b6f6 =
            when (value) {
                AdNrt.value -> AdNrt
                AeTrn.value -> AeTrn
                AlTin.value -> AlTin
    ...
    public object Serializer : KSerializer<InlineInvoicesResourceInvoiceTaxIdTypeX9c19b6f6> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineInvoicesResourceInvoiceTaxIdTypeX9c19b6f6",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineInvoicesResourceInvoiceTaxIdTypeX9c19b6f6 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineInvoicesResourceInvoiceTaxIdTypeX9c19b6f6,
        ) {
