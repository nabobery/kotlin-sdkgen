...
public class DisputePaymentMethodDetailsAmazonPay(
    ...
    public class Builder {
        ...
        public fun build(): DisputePaymentMethodDetailsAmazonPay =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): DisputePaymentMethodDetailsAmazonPay =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<DisputePaymentMethodDetailsAmazonPay> {
        ...
        override fun deserialize(decoder: Decoder): DisputePaymentMethodDetailsAmazonPay {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("DisputePaymentMethodDetailsAmazonPay must be a JSON object")
            return DisputePaymentMethodDetailsAmazonPay(
                disputeType =
                    rawObject["dispute_type"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineDisputePaymentMethodDetailsAmazonPayDisputeTypeXf591be39?>(
                                element,
                            )
                        }
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: DisputePaymentMethodDetailsAmazonPay,
        ) {
...
public fun disputePaymentMethodDetailsAmazonPay(
    block: DisputePaymentMethodDetailsAmazonPay.Builder.() -> Unit,
): DisputePaymentMethodDetailsAmazonPay = DisputePaymentMethodDetailsAmazonPay.build(block)
