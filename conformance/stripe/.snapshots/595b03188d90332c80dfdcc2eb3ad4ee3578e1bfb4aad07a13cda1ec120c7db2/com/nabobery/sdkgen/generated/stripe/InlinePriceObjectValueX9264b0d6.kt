...
public sealed class InlinePriceObjectValueX9264b0d6 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePriceObjectValueX9264b0d6 =
            when (value) {
                Price.value -> Price
    ...
    public object Serializer : KSerializer<InlinePriceObjectValueX9264b0d6> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePriceObjectValueX9264b0d6",
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlinePriceObjectValueX9264b0d6,
        ) {
