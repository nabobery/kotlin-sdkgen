...
public class SetupIntentPaymentMethodOptionsBacsDebit(
    ...
    public class Builder {
        ...
        public fun build(): SetupIntentPaymentMethodOptionsBacsDebit =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): SetupIntentPaymentMethodOptionsBacsDebit =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<SetupIntentPaymentMethodOptionsBacsDebit> {
        ...
        override fun deserialize(decoder: Decoder): SetupIntentPaymentMethodOptionsBacsDebit {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("SetupIntentPaymentMethodOptionsBacsDebit must be a JSON object")
            return SetupIntentPaymentMethodOptionsBacsDebit(
                mandateOptions =
                    rawObject["mandate_options"]?.let {
                        json.decodeFromJsonElement<SetupIntentPaymentMethodOptionsMandateOptionsBacsDebit>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: SetupIntentPaymentMethodOptionsBacsDebit,
        ) {
...
public fun setupIntentPaymentMethodOptionsBacsDebit(
    block: SetupIntentPaymentMethodOptionsBacsDebit.Builder.() -> Unit,
): SetupIntentPaymentMethodOptionsBacsDebit = SetupIntentPaymentMethodOptionsBacsDebit.build(block)
