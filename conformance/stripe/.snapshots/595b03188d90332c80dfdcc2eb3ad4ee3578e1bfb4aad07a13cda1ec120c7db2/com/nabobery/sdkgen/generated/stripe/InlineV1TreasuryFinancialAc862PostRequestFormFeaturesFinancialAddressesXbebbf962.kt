...
public class InlineV1TreasuryFinancialAc862PostRequestFormFeaturesFinancialAddressesXbebbf962(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1TreasuryFinancialAc862PostRequestFormFeaturesFinancialAddressesXbebbf962 =
    ...
    public object Serializer : KSerializer<InlineV1TreasuryFinancialAc862PostRequestFormFeaturesFinancialAddressesXbebbf962> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TreasuryFinancialAc862PostRequestFormFeaturesFinancialAddressesXbebbf962 must be a JSON object",
                    )
            return InlineV1TreasuryFinancialAc862PostRequestFormFeaturesFinancialAddressesXbebbf962(
                aba =
                    rawObject["aba"]?.let {
                        json.decodeFromJsonElement<InlineV1TreasuryFinancialAc862PostRequestFormFeaturesAbaX20382a3e>(
                            it,
                        )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TreasuryFinancialAc862PostRequestFormFeaturesFinancialAddressesXbebbf962,
        ) {
            val jsonEncoder =
...
public fun inlineV1TreasuryFinancialAc862PostRequestFormFeaturesFinancialAddressesXbebbf962(
    block: InlineV1TreasuryFinancialAc862PostRequestFormFeaturesFinancialAddressesXbebbf962.Builder.() -> Unit,
): InlineV1TreasuryFinancialAc862PostRequestFormFeaturesFinancialAddressesXbebbf962 =
    InlineV1TreasuryFinancialAc862PostRequestFormFeaturesFinancialAddressesXbebbf962.build(block)
