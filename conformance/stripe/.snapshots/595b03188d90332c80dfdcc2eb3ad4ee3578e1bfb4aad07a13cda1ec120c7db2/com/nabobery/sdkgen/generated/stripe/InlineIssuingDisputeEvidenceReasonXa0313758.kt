...
public sealed class InlineIssuingDisputeEvidenceReasonXa0313758 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineIssuingDisputeEvidenceReasonXa0313758 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineIssuingDisputeEvidenceReasonXa0313758> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineIssuingDisputeEvidenceReasonXa0313758",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineIssuingDisputeEvidenceReasonXa0313758 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineIssuingDisputeEvidenceReasonXa0313758,
        ) {
