...
internal data class InlineV1IssuingDisputesPostRequestFormEvidenceAdditionalDocumentationX9ff55b1fInspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2X331b5dd0,
            ).count { it }
}
...
public class InlineV1IssuingDisputesPostRequestFormEvidenceAdditionalDocumentationX9ff55b1f internal constructor(
    ...
    private val inspection: InlineV1IssuingDisputesPostRequestFormEvidenceAdditionalDocumentationX9ff55b1fInspection,
) {
    ...
    public val inlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2X331b5dd0:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2X331b5dd0) {
                json
                    .decodeFromJsonElement<InlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2X331b5dd0>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1IssuingDisputesPostRequestFormEvidenceAdditionalDocumentationX9ff55b1fBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2X331b5dd0) {
                    add(
                        InlineV1IssuingDisputesPostRequestFormEvidenceAdditionalDocumentationX9ff55b1fBranch.InlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2X331b5dd0,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1IssuingDisputesPostRequestFormEvidenceAdditionalDocumentationX9ff55b1f {
            val inspection = inspectInlineV1IssuingDisputesPostRequestFormEvidenceAdditionalDocumentationX9ff55b1f(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1IssuingDisputesPostRequestFormEvidenceAdditionalDocumentationX9ff55b1fNoMatchException(
                    "InlineV1IssuingDisputesPostRequestFormEvidenceAdditionalDocumentationX9ff55b1f matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1IssuingDisputesPostRequestFormEvidenceAdditionalDocumentationX9ff55b1f> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingDisputesPostRequestFormEvidenceAdditionalDocumentationX9ff55b1f,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1IssuingDisputesPostRequestFormEvidenceAdditionalDocumentationX9ff55b1f",
...
private fun inspectInlineV1IssuingDisputesPostRequestFormEvidenceAdditionalDocumentationX9ff55b1f(
    element: JsonElement,
): InlineV1IssuingDisputesPostRequestFormEvidenceAdditionalDocumentationX9ff55b1fInspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2X331b5dd0 =
        element
            .isJsonDecodable<InlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2X331b5dd0>()
    return InlineV1IssuingDisputesPostRequestFormEvidenceAdditionalDocumentationX9ff55b1fInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2X331b5dd0) {
                    add(
                        "InlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2X331b5dd0: value does not match InlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2X331b5dd0",
                    )
                }
            },
    )
