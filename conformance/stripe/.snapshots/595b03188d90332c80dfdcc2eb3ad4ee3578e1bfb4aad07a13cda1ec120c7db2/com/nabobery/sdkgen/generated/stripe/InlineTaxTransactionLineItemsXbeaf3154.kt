...
public class InlineTaxTransactionLineItemsXbeaf3154(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineTaxTransactionLineItemsXbeaf3154 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineTaxTransactionLineItemsXbeaf3154> {
        ...
        override fun deserialize(decoder: Decoder): InlineTaxTransactionLineItemsXbeaf3154 {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("InlineTaxTransactionLineItemsXbeaf3154 must be a JSON object")
            ...
            val objectValue =
                json.decodeRequired<InlineTaxTransactionLineItemsObjectValueXc5879958>(
                    rawObject,
                    "object",
                )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineTaxTransactionLineItemsXbeaf3154,
        ) {
...
public fun inlineTaxTransactionLineItemsXbeaf3154(
    block: InlineTaxTransactionLineItemsXbeaf3154.Builder.() -> Unit,
): InlineTaxTransactionLineItemsXbeaf3154 = InlineTaxTransactionLineItemsXbeaf3154.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineTaxTransactionLineItemsXbeaf3154 is missing required property '" + name + "'",
            )
