...
public class InlineV1SubscriptionsGetParameterXd8a29122 internal constructor(
    ...
    public val inlineV1SubscriptionsGetParameterAnyOf1X7fdd0ed9:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1SubscriptionsGetParameterAnyOf1X7fdd0ed9) {
                json
                    .decodeFromJsonElement<InlineV1SubscriptionsGetParameterAnyOf1X7fdd0ed9>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1SubscriptionsGetParameterXd8a29122Branch>
        get() =
            buildSet {
                if (inspection.matchesInlineV1SubscriptionsGetParameterAnyOf1X7fdd0ed9) {
                    add(
                        InlineV1SubscriptionsGetParameterXd8a29122Branch.InlineV1SubscriptionsGetParameterAnyOf1X7fdd0ed9,
                    )
                }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1SubscriptionsGetParameterXd8a29122 {
            val inspection = inspectInlineV1SubscriptionsGetParameterXd8a29122(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1SubscriptionsGetParameterXd8a29122NoMatchException(
                    "InlineV1SubscriptionsGetParameterXd8a29122 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionsGetParameterXd8a29122> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsGetParameterXd8a29122,
        ) {
...
private fun inspectInlineV1SubscriptionsGetParameterXd8a29122(
    element: JsonElement,
): InlineV1SubscriptionsGetParameterXd8a29122Inspection {
    val matchesInlineV1SubscriptionsGetParameterAnyOf1X7fdd0ed9 =
        element
            .isJsonDecodable<InlineV1SubscriptionsGetParameterAnyOf1X7fdd0ed9>()
    ...
    return InlineV1SubscriptionsGetParameterXd8a29122Inspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1SubscriptionsGetParameterAnyOf1X7fdd0ed9) {
                    add(
                        "InlineV1SubscriptionsGetParameterAnyOf1X7fdd0ed9: value does not match InlineV1SubscriptionsGetParameterAnyOf1X7fdd0ed9",
                    )
                }
