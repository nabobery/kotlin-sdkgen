...
public class InlineV1AccountsPostRequestFormCapabilitiesGbBankTransferPaymentsX380fc838(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1AccountsPostRequestFormCapabilitiesGbBankTransferPaymentsX380fc838 =
            InlineV1AccountsPostRequestFormCapabilitiesGbBankTransferPaymentsX380fc838(
                requested = requested,
            )
    }
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1AccountsPostRequestFormCapabilitiesGbBankTransferPaymentsX380fc838 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1AccountsPostRequestFormCapabilitiesGbBankTransferPaymentsX380fc838> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountsPostRequestFormCapabilitiesGbBankTransferPaymentsX380fc838 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPostRequestFormCapabilitiesGbBankTransferPaymentsX380fc838,
        ) {
            val jsonEncoder =
...
public fun inlineV1AccountsPostRequestFormCapabilitiesGbBankTransferPaymentsX380fc838(
    block: InlineV1AccountsPostRequestFormCapabilitiesGbBankTransferPaymentsX380fc838.Builder.() -> Unit,
): InlineV1AccountsPostRequestFormCapabilitiesGbBankTransferPaymentsX380fc838 =
