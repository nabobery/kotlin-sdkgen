...
public sealed class InlineV1PaymentIntentsConfirmPostRequestFormPreferredLanguageX76489852 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1PaymentIntentsConfirmPostRequestFormPreferredLanguageX76489852 =
            when (value) {
                Value.value -> Value
                De.value -> De
                En.value -> En
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsConfirmPostRequestFormPreferredLanguageX76489852> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1PaymentIntentsConfirmPostRequestFormPreferredLanguageX76489852",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1PaymentIntentsConfirmPostRequestFormPreferredLanguageX76489852 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsConfirmPostRequestFormPreferredLanguageX76489852,
        ) {
