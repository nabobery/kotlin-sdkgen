...
public sealed class InlineFinancialConnectionsAccountSupportedPaymentMethodTypesItemXd2320cf7 {
    ...
    public object Serializer : KSerializer<InlineFinancialConnectionsAccountSupportedPaymentMethodTypesItemXd2320cf7> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineFinancialConnectionsAccountSupportedPaymentMethodTypesItemXd2320cf7",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineFinancialConnectionsAccountSupportedPaymentMethodTypesItemXd2320cf7 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineFinancialConnectionsAccountSupportedPaymentMethodTypesItemXd2320cf7,
        ) {
