...
public class InlineV1IssuingCardholdersPostRequestFormIndividualXc6e742e0(
    public val cardIssuing: InlineV1IssuingCardholdersPostRequestFormIndividualCardIssuingXfa209399? = null,
    public val dob: InlineV1IssuingCardholdersPostRequestFormIndividualDobX630774e1? = null,
    public val firstName: String? = null,
    public val lastName: String? = null,
    public val verification: InlineV1IssuingCardholdersPostRequestFormIndividualVerificationXf831392c? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1IssuingCardholdersPostRequestFormIndividualXc6e742e0 =
            InlineV1IssuingCardholdersPostRequestFormIndividualXc6e742e0(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1IssuingCardholdersPostRequestFormIndividualXc6e742e0 =
    ...
    public object Serializer : KSerializer<InlineV1IssuingCardholdersPostRequestFormIndividualXc6e742e0> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1IssuingCardholdersPostRequestFormIndividualXc6e742e0 must be a JSON object",
                    )
            return InlineV1IssuingCardholdersPostRequestFormIndividualXc6e742e0(
                cardIssuing =
                    rawObject["card_issuing"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1IssuingCardholdersPostRequestFormIndividualCardIssuingXfa209399>(
                                it,
                            )
                    },
                dob =
                    rawObject["dob"]?.let {
                        json.decodeFromJsonElement<InlineV1IssuingCardholdersPostRequestFormIndividualDobX630774e1>(it)
                    },
                ...
                verification =
                    rawObject["verification"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1IssuingCardholdersPostRequestFormIndividualVerificationXf831392c>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingCardholdersPostRequestFormIndividualXc6e742e0,
        ) {
...
public fun inlineV1IssuingCardholdersPostRequestFormIndividualXc6e742e0(
    block: InlineV1IssuingCardholdersPostRequestFormIndividualXc6e742e0.Builder.() -> Unit,
): InlineV1IssuingCardholdersPostRequestFormIndividualXc6e742e0 =
    InlineV1IssuingCardholdersPostRequestFormIndividualXc6e742e0.build(block)
