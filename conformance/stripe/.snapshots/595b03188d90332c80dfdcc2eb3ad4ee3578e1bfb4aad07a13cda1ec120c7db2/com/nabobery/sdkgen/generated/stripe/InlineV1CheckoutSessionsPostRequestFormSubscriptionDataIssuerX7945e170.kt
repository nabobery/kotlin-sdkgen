...
public class InlineV1CheckoutSessionsPostRequestFormSubscriptionDataIssuerX7945e170(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1CheckoutSessionsPostRequestFormSubscriptionDataIssuerX7945e170 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormSubscriptionDataIssuerX7945e170> {
        override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1CheckoutSessionsPostRequestFormSubscriptionDataIssuerX7945e170 {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CheckoutSessionsPostRequestFormSubscriptionDataIssuerX7945e170 must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineV1CheckoutSessionsPostRequestFormSubscriptionDataTypeX5d8856e7>(
                    rawObject,
                    "type",
                )
            return InlineV1CheckoutSessionsPostRequestFormSubscriptionDataIssuerX7945e170(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsPostRequestFormSubscriptionDataIssuerX7945e170,
        ) {
            val jsonEncoder =
...
public fun inlineV1CheckoutSessionsPostRequestFormSubscriptionDataIssuerX7945e170(
    block: InlineV1CheckoutSessionsPostRequestFormSubscriptionDataIssuerX7945e170.Builder.() -> Unit,
): InlineV1CheckoutSessionsPostRequestFormSubscriptionDataIssuerX7945e170 =
    InlineV1CheckoutSessionsPostRequestFormSubscriptionDataIssuerX7945e170.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1CheckoutSessionsPostRequestFormSubscriptionDataIssuerX7945e170 is missing required property '" +
                    name +
                    "'",
            )
