...
public class InlineV1TaxRegistrationsPostRequestFormCountryOptionsAzXbf1d5ac3(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TaxRegistrationsPostRequestFormCountryOptionsAzXbf1d5ac3 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TaxRegistrationsPostRequestFormCountryOptionsAzXbf1d5ac3> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TaxRegistrationsPostRequestFormCountryOptionsAzXbf1d5ac3 must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineV1TaxRegistrationsPostRequestFormCountryOptionsAzTypeXa4a5f793>(
                    rawObject,
                    "type",
                )
            return InlineV1TaxRegistrationsPostRequestFormCountryOptionsAzXbf1d5ac3(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TaxRegistrationsPostRequestFormCountryOptionsAzXbf1d5ac3,
        ) {
            val jsonEncoder =
...
public fun inlineV1TaxRegistrationsPostRequestFormCountryOptionsAzXbf1d5ac3(
    block: InlineV1TaxRegistrationsPostRequestFormCountryOptionsAzXbf1d5ac3.Builder.() -> Unit,
): InlineV1TaxRegistrationsPostRequestFormCountryOptionsAzXbf1d5ac3 =
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TaxRegistrationsPostRequestFormCountryOptionsAzXbf1d5ac3 is missing required property '" + name +
                    "'",
            )
