...
internal data class InlineV1IssuingAuthorizationsPostRequestFormMetadataX8f0ef1ccInspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1IssuingAuthorizationsPostRequestFormMetadataAnyOf2X3f717ec1,
            ).count { it }
}
...
public class InlineV1IssuingAuthorizationsPostRequestFormMetadataX8f0ef1cc internal constructor(
    ...
    public val inlineV1IssuingAuthorizationsPostRequestFormMetadataAnyOf2X3f717ec1:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1IssuingAuthorizationsPostRequestFormMetadataAnyOf2X3f717ec1) {
                json
                    .decodeFromJsonElement<InlineV1IssuingAuthorizationsPostRequestFormMetadataAnyOf2X3f717ec1>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1IssuingAuthorizationsPostRequestFormMetadataX8f0ef1ccBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1IssuingAuthorizationsPostRequestFormMetadataAnyOf2X3f717ec1) {
                    add(
                        InlineV1IssuingAuthorizationsPostRequestFormMetadataX8f0ef1ccBranch.InlineV1IssuingAuthorizationsPostRequestFormMetadataAnyOf2X3f717ec1,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1IssuingAuthorizationsPostRequestFormMetadataX8f0ef1cc {
            val inspection = inspectInlineV1IssuingAuthorizationsPostRequestFormMetadataX8f0ef1cc(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1IssuingAuthorizationsPostRequestFormMetadataX8f0ef1ccNoMatchException(
                    "InlineV1IssuingAuthorizationsPostRequestFormMetadataX8f0ef1cc matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1IssuingAuthorizationsPostRequestFormMetadataX8f0ef1cc> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingAuthorizationsPostRequestFormMetadataX8f0ef1cc,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1IssuingAuthorizationsPostRequestFormMetadataX8f0ef1cc",
...
private fun inspectInlineV1IssuingAuthorizationsPostRequestFormMetadataX8f0ef1cc(
    element: JsonElement,
): InlineV1IssuingAuthorizationsPostRequestFormMetadataX8f0ef1ccInspection {
    val matchesBranch1 = element.isJsonDecodable<JsonObject>()
    val matchesInlineV1IssuingAuthorizationsPostRequestFormMetadataAnyOf2X3f717ec1 =
        element
            .isJsonDecodable<InlineV1IssuingAuthorizationsPostRequestFormMetadataAnyOf2X3f717ec1>()
    return InlineV1IssuingAuthorizationsPostRequestFormMetadataX8f0ef1ccInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1IssuingAuthorizationsPostRequestFormMetadataAnyOf2X3f717ec1) {
                    add(
                        "InlineV1IssuingAuthorizationsPostRequestFormMetadataAnyOf2X3f717ec1: value does not match InlineV1IssuingAuthorizationsPostRequestFormMetadataAnyOf2X3f717ec1",
                    )
                }
            },
    )
