...
internal data class InlineV1ChargesDisputePostRequestFormEvidenceProductDescriptionX734f0e2cInspection(
    ...
    public val matchesInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2X0e742cf2: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2X0e742cf2,
            ).count {
                it
            }
}
...
public class InlineV1ChargesDisputePostRequestFormEvidenceProductDescriptionX734f0e2c internal constructor(
    ...
    private val inspection: InlineV1ChargesDisputePostRequestFormEvidenceProductDescriptionX734f0e2cInspection,
) {
    ...
    public val inlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2X0e742cf2:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2X0e742cf2) {
                json
                    .decodeFromJsonElement<InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2X0e742cf2>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1ChargesDisputePostRequestFormEvidenceProductDescriptionX734f0e2cBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2X0e742cf2) {
                    add(
                        InlineV1ChargesDisputePostRequestFormEvidenceProductDescriptionX734f0e2cBranch.InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2X0e742cf2,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1ChargesDisputePostRequestFormEvidenceProductDescriptionX734f0e2c {
            val inspection = inspectInlineV1ChargesDisputePostRequestFormEvidenceProductDescriptionX734f0e2c(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1ChargesDisputePostRequestFormEvidenceProductDescriptionX734f0e2cNoMatchException(
                    "InlineV1ChargesDisputePostRequestFormEvidenceProductDescriptionX734f0e2c matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1ChargesDisputePostRequestFormEvidenceProductDescriptionX734f0e2c> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ChargesDisputePostRequestFormEvidenceProductDescriptionX734f0e2c,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1ChargesDisputePostRequestFormEvidenceProductDescriptionX734f0e2c",
...
private fun inspectInlineV1ChargesDisputePostRequestFormEvidenceProductDescriptionX734f0e2c(
    element: JsonElement,
): InlineV1ChargesDisputePostRequestFormEvidenceProductDescriptionX734f0e2cInspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2X0e742cf2 =
        element
            .isJsonDecodable<InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2X0e742cf2>()
    return InlineV1ChargesDisputePostRequestFormEvidenceProductDescriptionX734f0e2cInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2X0e742cf2) {
                    add(
                        "InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2X0e742cf2: value does not match InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2X0e742cf2",
                    )
                }
            },
    )
