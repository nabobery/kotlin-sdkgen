...
public class IssuingCardholderCompany(
    ...
    public object Serializer : KSerializer<IssuingCardholderCompany> {
        ...
        override fun deserialize(decoder: Decoder): IssuingCardholderCompany {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("IssuingCardholderCompany must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: IssuingCardholderCompany,
        ) {
...
public fun issuingCardholderCompany(block: IssuingCardholderCompany.Builder.() -> Unit): IssuingCardholderCompany =
    IssuingCardholderCompany.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException("IssuingCardholderCompany is missing required property '" + name + "'")
