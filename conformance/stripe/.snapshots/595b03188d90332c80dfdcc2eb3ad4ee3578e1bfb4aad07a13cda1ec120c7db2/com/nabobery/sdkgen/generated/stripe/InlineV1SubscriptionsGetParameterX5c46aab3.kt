...
public sealed class InlineV1SubscriptionsGetParameterX5c46aab3 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1SubscriptionsGetParameterX5c46aab3 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionsGetParameterX5c46aab3> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1SubscriptionsGetParameterX5c46aab3",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1SubscriptionsGetParameterX5c46aab3 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsGetParameterX5c46aab3,
        ) {
