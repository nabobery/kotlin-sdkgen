...
public class TaxProductRegistrationsResourceCountryOptionsSimplified(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): TaxProductRegistrationsResourceCountryOptionsSimplified =
    ...
    public object Serializer : KSerializer<TaxProductRegistrationsResourceCountryOptionsSimplified> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "TaxProductRegistrationsResourceCountryOptionsSimplified must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineTaxProductRegistrationsResourceCountryOptionsSimplifiedTypeX91637e9c>(
                    rawObject,
                    "type",
                )
            return TaxProductRegistrationsResourceCountryOptionsSimplified(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: TaxProductRegistrationsResourceCountryOptionsSimplified,
        ) {
...
public fun taxProductRegistrationsResourceCountryOptionsSimplified(
    block: TaxProductRegistrationsResourceCountryOptionsSimplified.Builder.() -> Unit,
): TaxProductRegistrationsResourceCountryOptionsSimplified =
    TaxProductRegistrationsResourceCountryOptionsSimplified.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "TaxProductRegistrationsResourceCountryOptionsSimplified is missing required property '" + name + "'",
            )
