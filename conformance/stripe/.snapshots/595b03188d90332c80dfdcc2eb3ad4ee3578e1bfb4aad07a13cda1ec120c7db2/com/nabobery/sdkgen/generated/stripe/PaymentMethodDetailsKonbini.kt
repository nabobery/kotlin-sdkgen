...
public class PaymentMethodDetailsKonbini(
    ...
    public class Builder {
        ...
        public fun build(): PaymentMethodDetailsKonbini =
    ...
    public object Serializer : KSerializer<PaymentMethodDetailsKonbini> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodDetailsKonbini {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodDetailsKonbini must be a JSON object")
                ...
                store =
                    rawObject["store"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentMethodDetailsKonbiniStoreX638fc021?>(element)
                        }
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentMethodDetailsKonbini,
        ) {
...
public fun paymentMethodDetailsKonbini(
    block: PaymentMethodDetailsKonbini.Builder.() -> Unit,
): PaymentMethodDetailsKonbini = PaymentMethodDetailsKonbini.build(block)
