...
public class PaymentMethodDetailsBlik(
    ...
    public class Builder {
        ...
        public fun build(): PaymentMethodDetailsBlik =
    ...
    public object Serializer : KSerializer<PaymentMethodDetailsBlik> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodDetailsBlik {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodDetailsBlik must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentMethodDetailsBlik,
        ) {
...
public fun paymentMethodDetailsBlik(block: PaymentMethodDetailsBlik.Builder.() -> Unit): PaymentMethodDetailsBlik =
    PaymentMethodDetailsBlik.build(block)
