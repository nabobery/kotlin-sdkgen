...
public class ConnectEmbeddedIssuingCardFeatures(
    ...
    public object Serializer : KSerializer<ConnectEmbeddedIssuingCardFeatures> {
        ...
        override fun deserialize(decoder: Decoder): ConnectEmbeddedIssuingCardFeatures {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("ConnectEmbeddedIssuingCardFeatures must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: ConnectEmbeddedIssuingCardFeatures,
        ) {
...
public fun connectEmbeddedIssuingCardFeatures(
    block: ConnectEmbeddedIssuingCardFeatures.Builder.() -> Unit,
): ConnectEmbeddedIssuingCardFeatures = ConnectEmbeddedIssuingCardFeatures.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "ConnectEmbeddedIssuingCardFeatures is missing required property '" + name + "'",
            )
