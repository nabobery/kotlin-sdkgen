...
public class AccountAnnualRevenue(
    ...
    public class Builder {
        ...
        public fun build(): AccountAnnualRevenue =
    ...
    public object Serializer : KSerializer<AccountAnnualRevenue> {
        ...
        override fun deserialize(decoder: Decoder): AccountAnnualRevenue {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("AccountAnnualRevenue must be a JSON object")
            return AccountAnnualRevenue(
                ...
                fiscalYearEnd =
                    rawObject["fiscal_year_end"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
...
public fun accountAnnualRevenue(block: AccountAnnualRevenue.Builder.() -> Unit): AccountAnnualRevenue =
    AccountAnnualRevenue.build(block)
