        ...
        override fun deserialize(decoder: Decoder): MandateSingleUse {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("MandateSingleUse must be a JSON object")
...
public fun mandateSingleUse(block: MandateSingleUse.Builder.() -> Unit): MandateSingleUse =
    MandateSingleUse.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("MandateSingleUse is missing required property '" + name + "'")
