...
internal data class InlineV1BillingPortalConfiab44PostRequestFormPaymentMethodConfigud224X9aac4729Inspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1BillingPortalConfiab44PostRequestFormFeaturesAnyOf2X891712ec,
            ).count { it }
}
...
public class InlineV1BillingPortalConfiab44PostRequestFormPaymentMethodConfigud224X9aac4729 internal constructor(
    ...
    private val inspection: InlineV1BillingPortalConfiab44PostRequestFormPaymentMethodConfigud224X9aac4729Inspection,
) {
    ...
    public val inlineV1BillingPortalConfiab44PostRequestFormFeaturesAnyOf2X891712ec:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1BillingPortalConfiab44PostRequestFormFeaturesAnyOf2X891712ec) {
                json
                    .decodeFromJsonElement<InlineV1BillingPortalConfiab44PostRequestFormFeaturesAnyOf2X891712ec>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1BillingPortalConfiab44PostRequestFormPaymentMethodConfigud224X9aac4729Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1BillingPortalConfiab44PostRequestFormFeaturesAnyOf2X891712ec) {
                    add(
                        InlineV1BillingPortalConfiab44PostRequestFormPaymentMethodConfigud224X9aac4729Branch.InlineV1BillingPortalConfiab44PostRequestFormFeaturesAnyOf2X891712ec,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1BillingPortalConfiab44PostRequestFormPaymentMethodConfigud224X9aac4729 {
            val inspection = inspectInlineV1BillingPortalConfiab44PostRequestFormPaymentMethodConfigud224X9aac4729(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1BillingPortalConfiab44PostRequestFormPaymentMethodConfigud224X9aac4729NoMatchException(
                    "InlineV1BillingPortalConfiab44PostRequestFormPaymentMethodConfigud224X9aac4729 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1BillingPortalConfiab44PostRequestFormPaymentMethodConfigud224X9aac4729> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1BillingPortalConfiab44PostRequestFormPaymentMethodConfigud224X9aac4729,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1BillingPortalConfiab44PostRequestFormPaymentMethodConfigud224X9aac4729",
...
private fun inspectInlineV1BillingPortalConfiab44PostRequestFormPaymentMethodConfigud224X9aac4729(
    element: JsonElement,
): InlineV1BillingPortalConfiab44PostRequestFormPaymentMethodConfigud224X9aac4729Inspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1BillingPortalConfiab44PostRequestFormFeaturesAnyOf2X891712ec =
        element
            .isJsonDecodable<InlineV1BillingPortalConfiab44PostRequestFormFeaturesAnyOf2X891712ec>()
    return InlineV1BillingPortalConfiab44PostRequestFormPaymentMethodConfigud224X9aac4729Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1BillingPortalConfiab44PostRequestFormFeaturesAnyOf2X891712ec) {
                    add(
                        "InlineV1BillingPortalConfiab44PostRequestFormFeaturesAnyOf2X891712ec: value does not match InlineV1BillingPortalConfiab44PostRequestFormFeaturesAnyOf2X891712ec",
                    )
                }
            },
    )
