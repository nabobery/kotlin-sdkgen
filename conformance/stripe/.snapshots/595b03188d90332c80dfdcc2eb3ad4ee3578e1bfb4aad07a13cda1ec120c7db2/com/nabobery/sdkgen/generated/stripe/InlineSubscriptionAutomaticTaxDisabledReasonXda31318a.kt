...
public sealed class InlineSubscriptionAutomaticTaxDisabledReasonXda31318a {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineSubscriptionAutomaticTaxDisabledReasonXda31318a =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineSubscriptionAutomaticTaxDisabledReasonXda31318a> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineSubscriptionAutomaticTaxDisabledReasonXda31318a",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineSubscriptionAutomaticTaxDisabledReasonXda31318a =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineSubscriptionAutomaticTaxDisabledReasonXda31318a,
        ) {
