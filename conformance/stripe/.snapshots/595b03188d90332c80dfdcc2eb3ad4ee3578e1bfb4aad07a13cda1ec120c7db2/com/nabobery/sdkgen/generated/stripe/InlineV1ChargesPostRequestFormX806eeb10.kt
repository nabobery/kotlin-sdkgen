...
public class InlineV1ChargesPostRequestFormX806eeb10(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1ChargesPostRequestFormX806eeb10 =
            InlineV1ChargesPostRequestFormX806eeb10(
                amount = amount,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1ChargesPostRequestFormX806eeb10 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1ChargesPostRequestFormX806eeb10> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1ChargesPostRequestFormX806eeb10 {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("InlineV1ChargesPostRequestFormX806eeb10 must be a JSON object")
            return InlineV1ChargesPostRequestFormX806eeb10(
                ...
                card =
                    rawObject["card"]?.let {
                        json.decodeFromJsonElement<InlineV1ChargesPostRequestFormCardX44ae045e>(
                            it,
                        )
                    },
                ...
                destination =
                    rawObject["destination"]?.let {
                        json.decodeFromJsonElement<InlineV1ChargesPostRequestFormDestinationXa1ddd738>(it)
                    },
                expand = rawObject["expand"]?.let { json.decodeFromJsonElement<List<String>>(it) },
                metadata =
                    rawObject["metadata"]?.let {
                        json.decodeFromJsonElement<InlineV1ChargesPostRequestFormMetadataX62aa1606>(it)
                    },
                onBehalfOf = rawObject["on_behalf_of"]?.let { json.decodeFromJsonElement<String>(it) },
                radarOptions =
                    rawObject["radar_options"]?.let {
                        json.decodeFromJsonElement<InlineV1ChargesPostRequestFormRadarOptionsX5235d18d>(it)
                    },
                receiptEmail = rawObject["receipt_email"]?.let { json.decodeFromJsonElement<String>(it) },
                shipping =
                    rawObject["shipping"]?.let {
                        json.decodeFromJsonElement<InlineV1ChargesPostRequestFormShippingX776066db>(it)
                    },
                ...
                transferData =
                    rawObject["transfer_data"]?.let {
                        json.decodeFromJsonElement<InlineV1ChargesPostRequestFormTransferDataXc3aedd04>(it)
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ChargesPostRequestFormX806eeb10,
        ) {
...
public fun inlineV1ChargesPostRequestFormX806eeb10(
    block: InlineV1ChargesPostRequestFormX806eeb10.Builder.() -> Unit,
): InlineV1ChargesPostRequestFormX806eeb10 = InlineV1ChargesPostRequestFormX806eeb10.build(block)
