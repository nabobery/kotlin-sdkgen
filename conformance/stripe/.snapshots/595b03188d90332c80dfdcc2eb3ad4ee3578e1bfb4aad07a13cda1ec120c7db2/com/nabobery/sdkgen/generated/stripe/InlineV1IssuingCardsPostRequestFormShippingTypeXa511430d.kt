...
public sealed class InlineV1IssuingCardsPostRequestFormShippingTypeXa511430d {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1IssuingCardsPostRequestFormShippingTypeXa511430d =
            when (value) {
                Bulk.value -> Bulk
    ...
    public object Serializer : KSerializer<InlineV1IssuingCardsPostRequestFormShippingTypeXa511430d> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1IssuingCardsPostRequestFormShippingTypeXa511430d",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1IssuingCardsPostRequestFormShippingTypeXa511430d =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingCardsPostRequestFormShippingTypeXa511430d,
        ) {
