...
internal data class InlineV1PaymentIntentsIncra167PostRequestFormDiscountAmountXbfb60a4fInspection(
    ...
    public val matchesInlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsAnyOf2X019c1d98: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsAnyOf2X019c1d98,
            ).count {
                it
            }
}
...
public class InlineV1PaymentIntentsIncra167PostRequestFormDiscountAmountXbfb60a4f internal constructor(
    ...
    private val inspection: InlineV1PaymentIntentsIncra167PostRequestFormDiscountAmountXbfb60a4fInspection,
) {
    ...
    public val inlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsAnyOf2X019c1d98:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsAnyOf2X019c1d98) {
                json
                    .decodeFromJsonElement<InlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsAnyOf2X019c1d98>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1PaymentIntentsIncra167PostRequestFormDiscountAmountXbfb60a4fBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsAnyOf2X019c1d98) {
                    add(
                        InlineV1PaymentIntentsIncra167PostRequestFormDiscountAmountXbfb60a4fBranch.InlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsAnyOf2X019c1d98,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1PaymentIntentsIncra167PostRequestFormDiscountAmountXbfb60a4f {
            val inspection = inspectInlineV1PaymentIntentsIncra167PostRequestFormDiscountAmountXbfb60a4f(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1PaymentIntentsIncra167PostRequestFormDiscountAmountXbfb60a4fNoMatchException(
                    "InlineV1PaymentIntentsIncra167PostRequestFormDiscountAmountXbfb60a4f matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsIncra167PostRequestFormDiscountAmountXbfb60a4f> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsIncra167PostRequestFormDiscountAmountXbfb60a4f,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1PaymentIntentsIncra167PostRequestFormDiscountAmountXbfb60a4f",
...
private fun inspectInlineV1PaymentIntentsIncra167PostRequestFormDiscountAmountXbfb60a4f(
    element: JsonElement,
): InlineV1PaymentIntentsIncra167PostRequestFormDiscountAmountXbfb60a4fInspection {
    val matchesBranch1 = element.isJsonDecodable<Int>()
    val matchesInlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsAnyOf2X019c1d98 =
        element
            .isJsonDecodable<InlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsAnyOf2X019c1d98>()
    return InlineV1PaymentIntentsIncra167PostRequestFormDiscountAmountXbfb60a4fInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsAnyOf2X019c1d98) {
                    add(
                        "InlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsAnyOf2X019c1d98: value does not match InlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsAnyOf2X019c1d98",
                    )
                }
            },
    )
