...
public sealed class InlinePaymentMethodNaverPayFundingX4eb0b779 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentMethodNaverPayFundingX4eb0b779 =
            when (value) {
                Card.value -> Card
                Points.value -> Points
    ...
    public object Serializer : KSerializer<InlinePaymentMethodNaverPayFundingX4eb0b779> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentMethodNaverPayFundingX4eb0b779",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePaymentMethodNaverPayFundingX4eb0b779 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentMethodNaverPayFundingX4eb0b779,
        ) {
