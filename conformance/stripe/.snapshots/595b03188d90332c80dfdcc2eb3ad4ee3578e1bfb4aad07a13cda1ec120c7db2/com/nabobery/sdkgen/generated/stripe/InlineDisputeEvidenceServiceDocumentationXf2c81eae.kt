...
public class InlineDisputeEvidenceServiceDocumentationXf2c81eae internal constructor(
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineDisputeEvidenceServiceDocumentationXf2c81eae {
            val inspection = inspectInlineDisputeEvidenceServiceDocumentationXf2c81eae(raw)
            if (inspection.matchCount == 0) {
                throw InlineDisputeEvidenceServiceDocumentationXf2c81eaeNoMatchException(
                    "InlineDisputeEvidenceServiceDocumentationXf2c81eae matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineDisputeEvidenceServiceDocumentationXf2c81eae> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineDisputeEvidenceServiceDocumentationXf2c81eae,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineDisputeEvidenceServiceDocumentationXf2c81eae",
...
private fun inspectInlineDisputeEvidenceServiceDocumentationXf2c81eae(
    element: JsonElement,
): InlineDisputeEvidenceServiceDocumentationXf2c81eaeInspection {
