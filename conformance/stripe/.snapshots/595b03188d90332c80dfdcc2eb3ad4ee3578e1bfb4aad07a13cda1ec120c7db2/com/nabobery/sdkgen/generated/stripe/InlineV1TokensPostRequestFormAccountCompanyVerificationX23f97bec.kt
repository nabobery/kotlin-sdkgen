...
public class InlineV1TokensPostRequestFormAccountCompanyVerificationX23f97bec(
    public val document: InlineV1TokensPostRequestFormAccountCompanyVerificationDocumentX0029b911? = null,
) {
    public class Builder {
        public var document: InlineV1TokensPostRequestFormAccountCompanyVerificationDocumentX0029b911? =
            null

        public fun build(): InlineV1TokensPostRequestFormAccountCompanyVerificationX23f97bec =
            InlineV1TokensPostRequestFormAccountCompanyVerificationX23f97bec(
                document = document,
            )
    }

    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TokensPostRequestFormAccountCompanyVerificationX23f97bec =
    ...
    public object Serializer : KSerializer<InlineV1TokensPostRequestFormAccountCompanyVerificationX23f97bec> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TokensPostRequestFormAccountCompanyVerificationX23f97bec must be a JSON object",
                    )
            return InlineV1TokensPostRequestFormAccountCompanyVerificationX23f97bec(
                document =
                    rawObject["document"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TokensPostRequestFormAccountCompanyVerificationDocumentX0029b911>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TokensPostRequestFormAccountCompanyVerificationX23f97bec,
        ) {
            val jsonEncoder =
...
public fun inlineV1TokensPostRequestFormAccountCompanyVerificationX23f97bec(
    block: InlineV1TokensPostRequestFormAccountCompanyVerificationX23f97bec.Builder.() -> Unit,
): InlineV1TokensPostRequestFormAccountCompanyVerificationX23f97bec =
    InlineV1TokensPostRequestFormAccountCompanyVerificationX23f97bec.build(block)
