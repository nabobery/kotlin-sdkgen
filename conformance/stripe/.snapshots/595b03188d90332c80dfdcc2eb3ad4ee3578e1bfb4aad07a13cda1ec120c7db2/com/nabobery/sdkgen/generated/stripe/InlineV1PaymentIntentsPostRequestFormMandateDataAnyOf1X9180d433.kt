...
public class InlineV1PaymentIntentsPostRequestFormMandateDataAnyOf1X9180d433(
    public val customerAcceptance: InlineV1PaymentIntentsPostRequestFormMandateDataCustomerAcceptanceXab5ae0e4,
) {
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PaymentIntentsPostRequestFormMandateDataAnyOf1X9180d433 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormMandateDataAnyOf1X9180d433> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsPostRequestFormMandateDataAnyOf1X9180d433 must be a JSON object",
                    )
            val customerAcceptance =
                json
                    .decodeRequired<InlineV1PaymentIntentsPostRequestFormMandateDataCustomerAcceptanceXab5ae0e4>(
                        rawObject,
                        "customer_acceptance",
                    )
            return InlineV1PaymentIntentsPostRequestFormMandateDataAnyOf1X9180d433(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormMandateDataAnyOf1X9180d433,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentIntentsPostRequestFormMandateDataAnyOf1X9180d433(
    block: InlineV1PaymentIntentsPostRequestFormMandateDataAnyOf1X9180d433.Builder.() -> Unit,
): InlineV1PaymentIntentsPostRequestFormMandateDataAnyOf1X9180d433 =
    InlineV1PaymentIntentsPostRequestFormMandateDataAnyOf1X9180d433.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentIntentsPostRequestFormMandateDataAnyOf1X9180d433 is missing required property '" + name +
                    "'",
            )
