...
public sealed class InlineV1PlansPostRequestFormMetadataAnyOf2X8a4e8f7a {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1PlansPostRequestFormMetadataAnyOf2X8a4e8f7a =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1PlansPostRequestFormMetadataAnyOf2X8a4e8f7a> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1PlansPostRequestFormMetadataAnyOf2X8a4e8f7a",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1PlansPostRequestFormMetadataAnyOf2X8a4e8f7a =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PlansPostRequestFormMetadataAnyOf2X8a4e8f7a,
        ) {
