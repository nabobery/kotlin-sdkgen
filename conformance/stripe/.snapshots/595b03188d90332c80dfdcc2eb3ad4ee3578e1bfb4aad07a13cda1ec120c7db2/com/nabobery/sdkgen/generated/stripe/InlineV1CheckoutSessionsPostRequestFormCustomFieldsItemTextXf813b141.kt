...
public class InlineV1CheckoutSessionsPostRequestFormCustomFieldsItemTextXf813b141(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1CheckoutSessionsPostRequestFormCustomFieldsItemTextXf813b141 =
            InlineV1CheckoutSessionsPostRequestFormCustomFieldsItemTextXf813b141(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1CheckoutSessionsPostRequestFormCustomFieldsItemTextXf813b141 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormCustomFieldsItemTextXf813b141> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CheckoutSessionsPostRequestFormCustomFieldsItemTextXf813b141 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsPostRequestFormCustomFieldsItemTextXf813b141,
        ) {
            val jsonEncoder =
...
public fun inlineV1CheckoutSessionsPostRequestFormCustomFieldsItemTextXf813b141(
    block: InlineV1CheckoutSessionsPostRequestFormCustomFieldsItemTextXf813b141.Builder.() -> Unit,
): InlineV1CheckoutSessionsPostRequestFormCustomFieldsItemTextXf813b141 =
    InlineV1CheckoutSessionsPostRequestFormCustomFieldsItemTextXf813b141.build(block)
