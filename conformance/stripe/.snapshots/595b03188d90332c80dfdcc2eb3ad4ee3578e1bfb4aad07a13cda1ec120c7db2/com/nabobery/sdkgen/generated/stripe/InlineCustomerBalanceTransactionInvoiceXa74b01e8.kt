...
public class InlineCustomerBalanceTransactionInvoiceXa74b01e8 internal constructor(
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineCustomerBalanceTransactionInvoiceXa74b01e8 {
            val inspection = inspectInlineCustomerBalanceTransactionInvoiceXa74b01e8(raw)
            if (inspection.matchCount == 0) {
                throw InlineCustomerBalanceTransactionInvoiceXa74b01e8NoMatchException(
                    "InlineCustomerBalanceTransactionInvoiceXa74b01e8 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineCustomerBalanceTransactionInvoiceXa74b01e8> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineCustomerBalanceTransactionInvoiceXa74b01e8,
        ) {
...
private fun inspectInlineCustomerBalanceTransactionInvoiceXa74b01e8(
    element: JsonElement,
): InlineCustomerBalanceTransactionInvoiceXa74b01e8Inspection {
