...
public class PortalFlowsAfterCompletionRedirect(
    ...
    public object Serializer : KSerializer<PortalFlowsAfterCompletionRedirect> {
        ...
        override fun deserialize(decoder: Decoder): PortalFlowsAfterCompletionRedirect {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PortalFlowsAfterCompletionRedirect must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PortalFlowsAfterCompletionRedirect,
        ) {
...
public fun portalFlowsAfterCompletionRedirect(
    block: PortalFlowsAfterCompletionRedirect.Builder.() -> Unit,
): PortalFlowsAfterCompletionRedirect = PortalFlowsAfterCompletionRedirect.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "PortalFlowsAfterCompletionRedirect is missing required property '" + name + "'",
            )
