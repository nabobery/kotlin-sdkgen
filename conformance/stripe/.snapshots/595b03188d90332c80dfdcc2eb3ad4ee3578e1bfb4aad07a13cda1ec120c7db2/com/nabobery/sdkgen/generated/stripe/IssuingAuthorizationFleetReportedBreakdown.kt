...
public class IssuingAuthorizationFleetReportedBreakdown(
    ...
    public class Builder {
        ...
        public fun build(): IssuingAuthorizationFleetReportedBreakdown =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): IssuingAuthorizationFleetReportedBreakdown =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<IssuingAuthorizationFleetReportedBreakdown> {
        ...
        override fun deserialize(decoder: Decoder): IssuingAuthorizationFleetReportedBreakdown {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("IssuingAuthorizationFleetReportedBreakdown must be a JSON object")
                ...
                fuel =
                    rawObject["fuel"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineIssuingAuthorizationFleetReportedBreakdownFuelXad619ce1?>(
                                element,
                            )
                        }
                    },
                nonFuel =
                    rawObject["non_fuel"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                            ...
                            json
                                .decodeFromJsonElement<InlineIssuingAuthorizationFleetReportedBreakdownNonFuelXc3a5c3e6?>(
                                    element,
                                )
                        }
                    },
                tax =
                    rawObject["tax"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineIssuingAuthorizationFleetReportedBreakdownTaxX7563a019?>(
                                element,
                            )
                        }
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: IssuingAuthorizationFleetReportedBreakdown,
        ) {
...
public fun issuingAuthorizationFleetReportedBreakdown(
    block: IssuingAuthorizationFleetReportedBreakdown.Builder.() -> Unit,
): IssuingAuthorizationFleetReportedBreakdown = IssuingAuthorizationFleetReportedBreakdown.build(block)
