...
internal data class InlineV1InvoicesCreatePreviewPostRequestFormOnBehalfOfXaae62e86Inspection(
    ...
    public val matchCount: Int
        get() =
            listOf(matchesBranch1, matchesInlineV1InvoicesCreatePreviewPostRequestFormOnBehalfOfAnyOf2Xa7a31c0f).count {
                it
            }
}
...
public class InlineV1InvoicesCreatePreviewPostRequestFormOnBehalfOfXaae62e86 internal constructor(
    ...
    public val inlineV1InvoicesCreatePreviewPostRequestFormOnBehalfOfAnyOf2Xa7a31c0f:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1InvoicesCreatePreviewPostRequestFormOnBehalfOfAnyOf2Xa7a31c0f) {
                json
                    .decodeFromJsonElement<InlineV1InvoicesCreatePreviewPostRequestFormOnBehalfOfAnyOf2Xa7a31c0f>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1InvoicesCreatePreviewPostRequestFormOnBehalfOfXaae62e86Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1InvoicesCreatePreviewPostRequestFormOnBehalfOfAnyOf2Xa7a31c0f) {
                    add(
                        InlineV1InvoicesCreatePreviewPostRequestFormOnBehalfOfXaae62e86Branch.InlineV1InvoicesCreatePreviewPostRequestFormOnBehalfOfAnyOf2Xa7a31c0f,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1InvoicesCreatePreviewPostRequestFormOnBehalfOfXaae62e86 {
            val inspection = inspectInlineV1InvoicesCreatePreviewPostRequestFormOnBehalfOfXaae62e86(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1InvoicesCreatePreviewPostRequestFormOnBehalfOfXaae62e86NoMatchException(
                    "InlineV1InvoicesCreatePreviewPostRequestFormOnBehalfOfXaae62e86 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1InvoicesCreatePreviewPostRequestFormOnBehalfOfXaae62e86> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesCreatePreviewPostRequestFormOnBehalfOfXaae62e86,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1InvoicesCreatePreviewPostRequestFormOnBehalfOfXaae62e86",
...
private fun inspectInlineV1InvoicesCreatePreviewPostRequestFormOnBehalfOfXaae62e86(
    element: JsonElement,
): InlineV1InvoicesCreatePreviewPostRequestFormOnBehalfOfXaae62e86Inspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1InvoicesCreatePreviewPostRequestFormOnBehalfOfAnyOf2Xa7a31c0f =
        element
            .isJsonDecodable<InlineV1InvoicesCreatePreviewPostRequestFormOnBehalfOfAnyOf2Xa7a31c0f>()
    return InlineV1InvoicesCreatePreviewPostRequestFormOnBehalfOfXaae62e86Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1InvoicesCreatePreviewPostRequestFormOnBehalfOfAnyOf2Xa7a31c0f) {
                    add(
                        "InlineV1InvoicesCreatePreviewPostRequestFormOnBehalfOfAnyOf2Xa7a31c0f: value does not match InlineV1InvoicesCreatePreviewPostRequestFormOnBehalfOfAnyOf2Xa7a31c0f",
                    )
                }
            },
    )
