...
public class TaxProductResourceTaxAssociationTransactionAttemptsResourceCommitted(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): TaxProductResourceTaxAssociationTransactionAttemptsResourceCommitted = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<TaxProductResourceTaxAssociationTransactionAttemptsResourceCommitted> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "TaxProductResourceTaxAssociationTransactionAttemptsResourceCommitted must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: TaxProductResourceTaxAssociationTransactionAttemptsResourceCommitted,
        ) {
            val jsonEncoder =
...
public fun taxProductResourceTaxAssociationTransactionAttemptsResourceCommitted(
    block: TaxProductResourceTaxAssociationTransactionAttemptsResourceCommitted.Builder.() -> Unit,
): TaxProductResourceTaxAssociationTransactionAttemptsResourceCommitted =
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "TaxProductResourceTaxAssociationTransactionAttemptsResourceCommitted is missing required property '" +
                    name +
                    "'",
            )
