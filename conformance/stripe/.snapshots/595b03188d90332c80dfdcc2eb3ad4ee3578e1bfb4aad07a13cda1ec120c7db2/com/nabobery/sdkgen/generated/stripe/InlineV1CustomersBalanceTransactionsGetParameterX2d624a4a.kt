...
internal data class InlineV1CustomersBalanceTransactionsGetParameterX2d624a4aInspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesInlineV1CustomersBalanceTransactionsGetParameterAnyOf1X255bd763,
                matchesBranch2,
            ).count { it }
}
...
public class InlineV1CustomersBalanceTransactionsGetParameterX2d624a4a internal constructor(
    ...
    public val inlineV1CustomersBalanceTransactionsGetParameterAnyOf1X255bd763:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1CustomersBalanceTransactionsGetParameterAnyOf1X255bd763) {
                json
                    .decodeFromJsonElement<InlineV1CustomersBalanceTransactionsGetParameterAnyOf1X255bd763>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1CustomersBalanceTransactionsGetParameterX2d624a4aBranch>
        get() =
            buildSet {
                if (inspection.matchesInlineV1CustomersBalanceTransactionsGetParameterAnyOf1X255bd763) {
                    add(
                        InlineV1CustomersBalanceTransactionsGetParameterX2d624a4aBranch.InlineV1CustomersBalanceTransactionsGetParameterAnyOf1X255bd763,
                    )
                }
                if (inspection.matchesBranch2) {
                    add(
                        InlineV1CustomersBalanceTransactionsGetParameterX2d624a4aBranch.Branch2,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1CustomersBalanceTransactionsGetParameterX2d624a4a {
            val inspection = inspectInlineV1CustomersBalanceTransactionsGetParameterX2d624a4a(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1CustomersBalanceTransactionsGetParameterX2d624a4aNoMatchException(
                    "InlineV1CustomersBalanceTransactionsGetParameterX2d624a4a matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1CustomersBalanceTransactionsGetParameterX2d624a4a> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersBalanceTransactionsGetParameterX2d624a4a,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1CustomersBalanceTransactionsGetParameterX2d624a4a",
...
private fun inspectInlineV1CustomersBalanceTransactionsGetParameterX2d624a4a(
    element: JsonElement,
): InlineV1CustomersBalanceTransactionsGetParameterX2d624a4aInspection {
    val matchesInlineV1CustomersBalanceTransactionsGetParameterAnyOf1X255bd763 =
        element
            .isJsonDecodable<InlineV1CustomersBalanceTransactionsGetParameterAnyOf1X255bd763>()
    ...
    return InlineV1CustomersBalanceTransactionsGetParameterX2d624a4aInspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1CustomersBalanceTransactionsGetParameterAnyOf1X255bd763) {
                    add(
                        "InlineV1CustomersBalanceTransactionsGetParameterAnyOf1X255bd763: value does not match InlineV1CustomersBalanceTransactionsGetParameterAnyOf1X255bd763",
                    )
                }
