...
public sealed class InlinePaymentMethodOptionsMandateOptionsPixAmountTypeX7eacc7de {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentMethodOptionsMandateOptionsPixAmountTypeX7eacc7de =
            when (value) {
                Fixed.value -> Fixed
    ...
    public object Serializer : KSerializer<InlinePaymentMethodOptionsMandateOptionsPixAmountTypeX7eacc7de> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentMethodOptionsMandateOptionsPixAmountTypeX7eacc7de",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePaymentMethodOptionsMandateOptionsPixAmountTypeX7eacc7de =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentMethodOptionsMandateOptionsPixAmountTypeX7eacc7de,
        ) {
