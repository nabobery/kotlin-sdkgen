...
public class InlineV1TerminalReadersSetReaderDisplayPostRequestFormCartLineItemsItemX1b9f6507(
    ...
    public object Serializer : KSerializer<InlineV1TerminalReadersSetReaderDisplayPostRequestFormCartLineItemsItemX1b9f6507> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TerminalReadersSetReaderDisplayPostRequestFormCartLineItemsItemX1b9f6507 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TerminalReadersSetReaderDisplayPostRequestFormCartLineItemsItemX1b9f6507,
        ) {
            val jsonEncoder =
...
public fun inlineV1TerminalReadersSetReaderDisplayPostRequestFormCartLineItemsItemX1b9f6507(
    block: InlineV1TerminalReadersSetReaderDisplayPostRequestFormCartLineItemsItemX1b9f6507.Builder.() -> Unit,
): InlineV1TerminalReadersSetReaderDisplayPostRequestFormCartLineItemsItemX1b9f6507 =
    InlineV1TerminalReadersSetReaderDisplayPostRequestFormCartLineItemsItemX1b9f6507.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TerminalReadersSetReaderDisplayPostRequestFormCartLineItemsItemX1b9f6507 is missing required property '" +
                    name +
                    "'",
            )
