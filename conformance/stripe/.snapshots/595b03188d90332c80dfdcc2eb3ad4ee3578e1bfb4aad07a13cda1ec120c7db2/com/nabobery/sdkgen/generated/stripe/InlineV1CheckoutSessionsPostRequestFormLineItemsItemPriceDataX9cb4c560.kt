...
public class InlineV1CheckoutSessionsPostRequestFormLineItemsItemPriceDataX9cb4c560(
    ...
    public val productData: InlineV1CheckoutSessionsPostRequestFormLineItemsItemProductDataXbefb5e27? = null,
    public val recurring: InlineV1CheckoutSessionsPostRequestFormLineItemsItemPriceDataRecurringX6a0f0542? = null,
    public val taxBehavior: InlineV1CheckoutSessionsPostRequestFormLineItemsItemTaxBehaviorXfb5ebae7? = null,
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1CheckoutSessionsPostRequestFormLineItemsItemPriceDataX9cb4c560 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormLineItemsItemPriceDataX9cb4c560> {
        override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1CheckoutSessionsPostRequestFormLineItemsItemPriceDataX9cb4c560 {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CheckoutSessionsPostRequestFormLineItemsItemPriceDataX9cb4c560 must be a JSON object",
                    )
            ...
            return InlineV1CheckoutSessionsPostRequestFormLineItemsItemPriceDataX9cb4c560(
                ...
                productData =
                    rawObject["product_data"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormLineItemsItemProductDataXbefb5e27>(
                                it,
                            )
                    },
                recurring =
                    rawObject["recurring"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormLineItemsItemPriceDataRecurringX6a0f0542>(
                                it,
                            )
                    },
                taxBehavior =
                    rawObject["tax_behavior"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormLineItemsItemTaxBehaviorXfb5ebae7>(
                                it,
                            )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsPostRequestFormLineItemsItemPriceDataX9cb4c560,
        ) {
            val jsonEncoder =
...
public fun inlineV1CheckoutSessionsPostRequestFormLineItemsItemPriceDataX9cb4c560(
    block: InlineV1CheckoutSessionsPostRequestFormLineItemsItemPriceDataX9cb4c560.Builder.() -> Unit,
): InlineV1CheckoutSessionsPostRequestFormLineItemsItemPriceDataX9cb4c560 =
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1CheckoutSessionsPostRequestFormLineItemsItemPriceDataX9cb4c560 is missing required property '" +
                    name +
                    "'",
            )
