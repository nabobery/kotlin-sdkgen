...
public sealed class InlineThreeDSecureDetailsVersionX2c2943f6 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineThreeDSecureDetailsVersionX2c2943f6 =
            when (value) {
                _102.value -> _102
                _210.value -> _210
                _220.value -> _220
    ...
    public object Serializer : KSerializer<InlineThreeDSecureDetailsVersionX2c2943f6> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineThreeDSecureDetailsVersionX2c2943f6",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineThreeDSecureDetailsVersionX2c2943f6 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineThreeDSecureDetailsVersionX2c2943f6,
        ) {
