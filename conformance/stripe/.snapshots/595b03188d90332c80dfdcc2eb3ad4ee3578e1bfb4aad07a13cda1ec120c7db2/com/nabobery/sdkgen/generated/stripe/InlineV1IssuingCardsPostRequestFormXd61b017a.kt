...
public class InlineV1IssuingCardsPostRequestFormXd61b017a(
     ...
     */
    public val lifecycleControls: InlineV1IssuingCardsPostRequestFormLifecycleControlsX423db20f? = null,
    /**
     ...
     */
    public val replacementReason: InlineV1IssuingCardsPostRequestFormReplacementReasonX68577ce9? = null,
    /**
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1IssuingCardsPostRequestFormXd61b017a =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1IssuingCardsPostRequestFormXd61b017a> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1IssuingCardsPostRequestFormXd61b017a {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1IssuingCardsPostRequestFormXd61b017a must be a JSON object",
                    )
            ...
            return InlineV1IssuingCardsPostRequestFormXd61b017a(
                ...
                lifecycleControls =
                    rawObject["lifecycle_controls"]?.let {
                        json.decodeFromJsonElement<InlineV1IssuingCardsPostRequestFormLifecycleControlsX423db20f>(it)
                    },
                metadata = rawObject["metadata"]?.let { json.decodeFromJsonElement<Map<String, String>>(it) },
                personalizationDesign =
                    rawObject["personalization_design"]?.let {
                ...
                pin =
                    rawObject["pin"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1IssuingCardsPostRequestFormPinXeb8be2a5>(
                                it,
                            )
                    },
                replacementFor = rawObject["replacement_for"]?.let { json.decodeFromJsonElement<String>(it) },
                replacementReason =
                    rawObject["replacement_reason"]?.let {
                        json.decodeFromJsonElement<InlineV1IssuingCardsPostRequestFormReplacementReasonX68577ce9>(it)
                    },
                secondLine =
                    rawObject["second_line"]?.let {
                        json.decodeFromJsonElement<InlineV1IssuingCardsPostRequestFormSecondLineX9917f825>(it)
                    },
                shipping =
                    rawObject["shipping"]?.let {
                        json.decodeFromJsonElement<InlineV1IssuingCardsPostRequestFormShippingXd723d6b8>(it)
                    },
                spendingControls =
                    rawObject["spending_controls"]?.let {
                        json.decodeFromJsonElement<InlineV1IssuingCardsPostRequestFormSpendingControlsXdf7674d3>(it)
                    },
                status =
                    rawObject["status"]?.let {
                        json.decodeFromJsonElement<InlineV1IssuingCardsPostRequestFormStatusXe8004f74>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingCardsPostRequestFormXd61b017a,
        ) {
...
public fun inlineV1IssuingCardsPostRequestFormXd61b017a(
    block: InlineV1IssuingCardsPostRequestFormXd61b017a.Builder.() -> Unit,
): InlineV1IssuingCardsPostRequestFormXd61b017a = InlineV1IssuingCardsPostRequestFormXd61b017a.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1IssuingCardsPostRequestFormXd61b017a is missing required property '" + name + "'",
            )
