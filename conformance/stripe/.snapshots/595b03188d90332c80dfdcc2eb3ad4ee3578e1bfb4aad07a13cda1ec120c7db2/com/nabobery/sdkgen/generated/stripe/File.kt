        ...
        override fun deserialize(decoder: Decoder): File {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("File must be a JSON object")
            ...
            return File(
                ...
                filename =
                    rawObject["filename"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                links =
                    rawObject["links"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineFileLinksXa77d205a?>(element)
                        }
                    },
                title =
