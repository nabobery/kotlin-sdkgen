...
public class DisputePaymentMethodDetails(
    ...
    public object Serializer : KSerializer<DisputePaymentMethodDetails> {
        ...
        override fun deserialize(decoder: Decoder): DisputePaymentMethodDetails {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("DisputePaymentMethodDetails must be a JSON object")
            val type = json.decodeRequired<InlineDisputePaymentMethodDetailsTypeXf1692f08>(rawObject, "type")
            return DisputePaymentMethodDetails(
                type = type,
                amazonPay =
                    rawObject["amazon_pay"]?.let {
                        json.decodeFromJsonElement<DisputePaymentMethodDetailsAmazonPay>(
                            it,
                        )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: DisputePaymentMethodDetails,
        ) {
...
public fun disputePaymentMethodDetails(
    block: DisputePaymentMethodDetails.Builder.() -> Unit,
): DisputePaymentMethodDetails = DisputePaymentMethodDetails.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException("DisputePaymentMethodDetails is missing required property '" + name + "'")
