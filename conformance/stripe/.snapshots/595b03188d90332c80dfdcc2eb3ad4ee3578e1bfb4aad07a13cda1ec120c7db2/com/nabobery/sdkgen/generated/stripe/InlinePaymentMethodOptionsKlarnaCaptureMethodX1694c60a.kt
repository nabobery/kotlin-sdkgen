...
public sealed class InlinePaymentMethodOptionsKlarnaCaptureMethodX1694c60a {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentMethodOptionsKlarnaCaptureMethodX1694c60a =
            when (value) {
                Manual.value -> Manual
    ...
    public object Serializer : KSerializer<InlinePaymentMethodOptionsKlarnaCaptureMethodX1694c60a> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentMethodOptionsKlarnaCaptureMethodX1694c60a",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePaymentMethodOptionsKlarnaCaptureMethodX1694c60a =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentMethodOptionsKlarnaCaptureMethodX1694c60a,
        ) {
