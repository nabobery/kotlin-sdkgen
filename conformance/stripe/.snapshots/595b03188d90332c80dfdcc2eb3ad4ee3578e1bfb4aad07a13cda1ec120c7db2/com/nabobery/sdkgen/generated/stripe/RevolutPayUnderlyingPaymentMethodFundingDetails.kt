...
public class RevolutPayUnderlyingPaymentMethodFundingDetails(
    ...
    public class Builder {
        ...
        public fun build(): RevolutPayUnderlyingPaymentMethodFundingDetails =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): RevolutPayUnderlyingPaymentMethodFundingDetails =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<RevolutPayUnderlyingPaymentMethodFundingDetails> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "RevolutPayUnderlyingPaymentMethodFundingDetails must be a JSON object",
                    )
                ...
                type =
                    rawObject["type"]?.let { element ->
                        if (element ==
                            ...
                            json
                                .decodeFromJsonElement<InlineRevolutPayUnderlyingPaymentMethodFundingDetailsTypeX7f0cf853?>(
                                    element,
                                )
                        }
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: RevolutPayUnderlyingPaymentMethodFundingDetails,
        ) {
...
public fun revolutPayUnderlyingPaymentMethodFundingDetails(
    block: RevolutPayUnderlyingPaymentMethodFundingDetails.Builder.() -> Unit,
): RevolutPayUnderlyingPaymentMethodFundingDetails = RevolutPayUnderlyingPaymentMethodFundingDetails.build(block)
