...
public class InlineV1BillingCreditGrantsPostRequestFormX173ddf21(
     ...
     */
    public val applicabilityConfig: InlineV1BillingCreditGrantsPostRequestFormApplicabilityConfigX8078051e,
    /**
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1BillingCreditGrantsPostRequestFormX173ddf21 =
    ...
    public object Serializer : KSerializer<InlineV1BillingCreditGrantsPostRequestFormX173ddf21> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1BillingCreditGrantsPostRequestFormX173ddf21 must be a JSON object",
                    )
            val amount =
                json.decodeRequired<InlineV1BillingCreditGrantsPostRequestFormAmountXadaed654>(
                    rawObject,
                    "amount",
                )
            val applicabilityConfig =
                json
                    .decodeRequired<InlineV1BillingCreditGrantsPostRequestFormApplicabilityConfigX8078051e>(
                        rawObject,
            ...
            return InlineV1BillingCreditGrantsPostRequestFormX173ddf21(
                ...
                category =
                    rawObject["category"]?.let {
                        json.decodeFromJsonElement<InlineV1BillingCreditGrantsPostRequestFormCategoryXfd62be7a>(it)
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1BillingCreditGrantsPostRequestFormX173ddf21,
        ) {
...
public fun inlineV1BillingCreditGrantsPostRequestFormX173ddf21(
    block: InlineV1BillingCreditGrantsPostRequestFormX173ddf21.Builder.() -> Unit,
): InlineV1BillingCreditGrantsPostRequestFormX173ddf21 =
    InlineV1BillingCreditGrantsPostRequestFormX173ddf21.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1BillingCreditGrantsPostRequestFormX173ddf21 is missing required property '" + name + "'",
            )
