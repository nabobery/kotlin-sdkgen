...
public sealed class InlineV1CheckoutSessionsPostRequestFormTransactionTypeX6e8b2bdb {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1CheckoutSessionsPostRequestFormTransactionTypeX6e8b2bdb =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormTransactionTypeX6e8b2bdb> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1CheckoutSessionsPostRequestFormTransactionTypeX6e8b2bdb",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1CheckoutSessionsPostRequestFormTransactionTypeX6e8b2bdb =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsPostRequestFormTransactionTypeX6e8b2bdb,
        ) {
