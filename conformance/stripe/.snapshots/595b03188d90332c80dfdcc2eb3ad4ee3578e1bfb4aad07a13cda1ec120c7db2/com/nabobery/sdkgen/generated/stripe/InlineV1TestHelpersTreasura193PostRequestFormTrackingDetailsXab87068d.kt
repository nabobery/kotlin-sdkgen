...
public class InlineV1TestHelpersTreasura193PostRequestFormTrackingDetailsXab87068d(
    ...
    public val usDomesticWire: InlineV1TestHelpersTreasura193PostRequestFormUsDomesticWireX81be460c? = null,
) {
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1TestHelpersTreasura193PostRequestFormTrackingDetailsXab87068d = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TestHelpersTreasura193PostRequestFormTrackingDetailsXab87068d> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TestHelpersTreasura193PostRequestFormTrackingDetailsXab87068d must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineV1TestHelpersTreasura193PostRequestFormTrackingDetailsTypeXb3bd0987>(
                    rawObject,
                    "type",
                )
            return InlineV1TestHelpersTreasura193PostRequestFormTrackingDetailsXab87068d(
                ...
                ach =
                    rawObject["ach"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TestHelpersTreasura193PostRequestFormTrackingDetailsAchX11890c43>(
                                it,
                            )
                    },
                usDomesticWire =
                    rawObject["us_domestic_wire"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TestHelpersTreasura193PostRequestFormUsDomesticWireX81be460c>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TestHelpersTreasura193PostRequestFormTrackingDetailsXab87068d,
        ) {
            val jsonEncoder =
...
public fun inlineV1TestHelpersTreasura193PostRequestFormTrackingDetailsXab87068d(
    block: InlineV1TestHelpersTreasura193PostRequestFormTrackingDetailsXab87068d.Builder.() -> Unit,
): InlineV1TestHelpersTreasura193PostRequestFormTrackingDetailsXab87068d =
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TestHelpersTreasura193PostRequestFormTrackingDetailsXab87068d is missing required property '" +
                    name +
                    "'",
            )
