...
public class PaymentMethodCardPresent(
    ...
    public object Serializer : KSerializer<PaymentMethodCardPresent> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodCardPresent {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodCardPresent must be a JSON object")
                ...
                networks =
                    rawObject["networks"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentMethodCardPresentNetworksX9a4922cd?>(element)
                        }
                    },
                offline =
                    rawObject["offline"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentMethodCardPresentOfflineXf940c1ce?>(element)
                        }
                    },
                preferredLocales =
                ...
                readMethod =
                    rawObject["read_method"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentMethodCardPresentReadMethodX5352686b?>(element)
                        }
                    },
                wallet =
                    rawObject["wallet"]?.let {
                        json
                            .decodeFromJsonElement<PaymentFlowsPrivatePaymentMethodsCardPresentCommonWallet>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentMethodCardPresent,
        ) {
...
public fun paymentMethodCardPresent(block: PaymentMethodCardPresent.Builder.() -> Unit): PaymentMethodCardPresent =
    PaymentMethodCardPresent.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException("PaymentMethodCardPresent is missing required property '" + name + "'")
