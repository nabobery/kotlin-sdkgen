...
public sealed class InlineDisputeEnhancedEligibilityTypesItemXa48b4f02 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineDisputeEnhancedEligibilityTypesItemXa48b4f02 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineDisputeEnhancedEligibilityTypesItemXa48b4f02> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineDisputeEnhancedEligibilityTypesItemXa48b4f02",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineDisputeEnhancedEligibilityTypesItemXa48b4f02 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineDisputeEnhancedEligibilityTypesItemXa48b4f02,
        ) {
