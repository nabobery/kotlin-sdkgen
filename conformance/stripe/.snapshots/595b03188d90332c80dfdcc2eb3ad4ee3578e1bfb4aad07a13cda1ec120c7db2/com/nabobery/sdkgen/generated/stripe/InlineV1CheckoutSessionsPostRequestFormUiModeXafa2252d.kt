...
public sealed class InlineV1CheckoutSessionsPostRequestFormUiModeXafa2252d {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1CheckoutSessionsPostRequestFormUiModeXafa2252d =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormUiModeXafa2252d> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1CheckoutSessionsPostRequestFormUiModeXafa2252d",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1CheckoutSessionsPostRequestFormUiModeXafa2252d =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsPostRequestFormUiModeXafa2252d,
        ) {
