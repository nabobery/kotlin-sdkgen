...
public class InlineV1IssuingCardsPostRequestFormMetadataX6dc5840c internal constructor(
    ...
    public val inlineV1IssuingCardsPostRequestFormMetadataAnyOf2Xd06954e3:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1IssuingCardsPostRequestFormMetadataAnyOf2Xd06954e3) {
                json
                    .decodeFromJsonElement<InlineV1IssuingCardsPostRequestFormMetadataAnyOf2Xd06954e3>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1IssuingCardsPostRequestFormMetadataX6dc5840cBranch>
        get() =
            buildSet {
                ...
                if (inspection.matchesInlineV1IssuingCardsPostRequestFormMetadataAnyOf2Xd06954e3) {
                    add(
                        InlineV1IssuingCardsPostRequestFormMetadataX6dc5840cBranch.InlineV1IssuingCardsPostRequestFormMetadataAnyOf2Xd06954e3,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1IssuingCardsPostRequestFormMetadataX6dc5840c {
            val inspection = inspectInlineV1IssuingCardsPostRequestFormMetadataX6dc5840c(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1IssuingCardsPostRequestFormMetadataX6dc5840cNoMatchException(
                    "InlineV1IssuingCardsPostRequestFormMetadataX6dc5840c matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1IssuingCardsPostRequestFormMetadataX6dc5840c> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingCardsPostRequestFormMetadataX6dc5840c,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1IssuingCardsPostRequestFormMetadataX6dc5840c",
...
private fun inspectInlineV1IssuingCardsPostRequestFormMetadataX6dc5840c(
    element: JsonElement,
): InlineV1IssuingCardsPostRequestFormMetadataX6dc5840cInspection {
    val matchesBranch1 = element.isJsonDecodable<JsonObject>()
    val matchesInlineV1IssuingCardsPostRequestFormMetadataAnyOf2Xd06954e3 =
        element
            .isJsonDecodable<InlineV1IssuingCardsPostRequestFormMetadataAnyOf2Xd06954e3>()
    return InlineV1IssuingCardsPostRequestFormMetadataX6dc5840cInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1IssuingCardsPostRequestFormMetadataAnyOf2Xd06954e3) {
                    add(
                        "InlineV1IssuingCardsPostRequestFormMetadataAnyOf2Xd06954e3: value does not match InlineV1IssuingCardsPostRequestFormMetadataAnyOf2Xd06954e3",
                    )
                }
            },
    )
