...
public class InlineV1InvoicesPostRequestFormTransferDataAnyOf1X605738cf(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1InvoicesPostRequestFormTransferDataAnyOf1X605738cf =
    ...
    public object Serializer : KSerializer<InlineV1InvoicesPostRequestFormTransferDataAnyOf1X605738cf> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1InvoicesPostRequestFormTransferDataAnyOf1X605738cf must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesPostRequestFormTransferDataAnyOf1X605738cf,
        ) {
...
public fun inlineV1InvoicesPostRequestFormTransferDataAnyOf1X605738cf(
    block: InlineV1InvoicesPostRequestFormTransferDataAnyOf1X605738cf.Builder.() -> Unit,
): InlineV1InvoicesPostRequestFormTransferDataAnyOf1X605738cf =
    InlineV1InvoicesPostRequestFormTransferDataAnyOf1X605738cf.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1InvoicesPostRequestFormTransferDataAnyOf1X605738cf is missing required property '" + name + "'",
            )
