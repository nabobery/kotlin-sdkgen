...
public sealed class InlinePlanObjectValueXc22de456 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePlanObjectValueXc22de456 =
            when (value) {
                Plan.value -> Plan
    ...
    public object Serializer : KSerializer<InlinePlanObjectValueXc22de456> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePlanObjectValueXc22de456",
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlinePlanObjectValueXc22de456,
        ) {
