...
public sealed class InlineV1InvoicesGetParameterX751afae8 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1InvoicesGetParameterX751afae8 =
            when (value) {
                Draft.value -> Draft
                Open.value -> Open
                Paid.value -> Paid
    ...
    public object Serializer : KSerializer<InlineV1InvoicesGetParameterX751afae8> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1InvoicesGetParameterX751afae8",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1InvoicesGetParameterX751afae8 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesGetParameterX751afae8,
        ) {
