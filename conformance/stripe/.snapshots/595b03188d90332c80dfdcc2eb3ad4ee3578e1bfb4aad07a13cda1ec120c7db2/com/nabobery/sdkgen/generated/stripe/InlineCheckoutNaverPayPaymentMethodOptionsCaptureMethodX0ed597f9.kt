...
public sealed class InlineCheckoutNaverPayPaymentMethodOptionsCaptureMethodX0ed597f9 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineCheckoutNaverPayPaymentMethodOptionsCaptureMethodX0ed597f9 =
            when (value) {
                Manual.value -> Manual
    ...
    public object Serializer : KSerializer<InlineCheckoutNaverPayPaymentMethodOptionsCaptureMethodX0ed597f9> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineCheckoutNaverPayPaymentMethodOptionsCaptureMethodX0ed597f9",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineCheckoutNaverPayPaymentMethodOptionsCaptureMethodX0ed597f9 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineCheckoutNaverPayPaymentMethodOptionsCaptureMethodX0ed597f9,
        ) {
