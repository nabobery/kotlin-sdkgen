...
public class InlineV1AccountSessionsPostRequestFormComponentsTaxSettingsX26422387(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1AccountSessionsPostRequestFormComponentsTaxSettingsX26422387 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1AccountSessionsPostRequestFormComponentsTaxSettingsX26422387> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountSessionsPostRequestFormComponentsTaxSettingsX26422387 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountSessionsPostRequestFormComponentsTaxSettingsX26422387,
        ) {
            val jsonEncoder =
...
public fun inlineV1AccountSessionsPostRequestFormComponentsTaxSettingsX26422387(
    block: InlineV1AccountSessionsPostRequestFormComponentsTaxSettingsX26422387.Builder.() -> Unit,
): InlineV1AccountSessionsPostRequestFormComponentsTaxSettingsX26422387 =
    InlineV1AccountSessionsPostRequestFormComponentsTaxSettingsX26422387.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1AccountSessionsPostRequestFormComponentsTaxSettingsX26422387 is missing required property '" +
                    name +
                    "'",
            )
