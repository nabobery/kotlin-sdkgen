...
public class InlineV1RadarValueListItemsGetParameterAnyOf1Xa279ec1f(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1RadarValueListItemsGetParameterAnyOf1Xa279ec1f =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1RadarValueListItemsGetParameterAnyOf1Xa279ec1f =
    ...
    public object Serializer : KSerializer<InlineV1RadarValueListItemsGetParameterAnyOf1Xa279ec1f> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1RadarValueListItemsGetParameterAnyOf1Xa279ec1f must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1RadarValueListItemsGetParameterAnyOf1Xa279ec1f,
        ) {
...
public fun inlineV1RadarValueListItemsGetParameterAnyOf1Xa279ec1f(
    block: InlineV1RadarValueListItemsGetParameterAnyOf1Xa279ec1f.Builder.() -> Unit,
): InlineV1RadarValueListItemsGetParameterAnyOf1Xa279ec1f =
    InlineV1RadarValueListItemsGetParameterAnyOf1Xa279ec1f.build(block)
