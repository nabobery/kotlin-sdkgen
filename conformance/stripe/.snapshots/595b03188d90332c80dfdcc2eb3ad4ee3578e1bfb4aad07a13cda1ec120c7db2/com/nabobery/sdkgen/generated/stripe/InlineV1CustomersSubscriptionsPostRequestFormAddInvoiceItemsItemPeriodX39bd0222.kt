...
public class InlineV1CustomersSubscriptionsPostRequestFormAddInvoiceItemsItemPeriodX39bd0222(
    ...
    public object Serializer : KSerializer<InlineV1CustomersSubscriptionsPostRequestFormAddInvoiceItemsItemPeriodX39bd0222> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CustomersSubscriptionsPostRequestFormAddInvoiceItemsItemPeriodX39bd0222 must be a JSON object",
                    )
            val end =
                json.decodeRequired<InlineV1CustomersSubscriptionsPostRequestFormAddInvoiceItemsItemEndX5b13774f>(
                    rawObject,
                    "end",
                )
            val start =
                json.decodeRequired<InlineV1CustomersSubscriptionsPostRequestFormAddInvoiceItemsItemStartXb3c48c0a>(
                    rawObject,
                    "start",
                )
            return InlineV1CustomersSubscriptionsPostRequestFormAddInvoiceItemsItemPeriodX39bd0222(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersSubscriptionsPostRequestFormAddInvoiceItemsItemPeriodX39bd0222,
        ) {
            val jsonEncoder =
...
public fun inlineV1CustomersSubscriptionsPostRequestFormAddInvoiceItemsItemPeriodX39bd0222(
    block: InlineV1CustomersSubscriptionsPostRequestFormAddInvoiceItemsItemPeriodX39bd0222.Builder.() -> Unit,
): InlineV1CustomersSubscriptionsPostRequestFormAddInvoiceItemsItemPeriodX39bd0222 =
    InlineV1CustomersSubscriptionsPostRequestFormAddInvoiceItemsItemPeriodX39bd0222.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1CustomersSubscriptionsPostRequestFormAddInvoiceItemsItemPeriodX39bd0222 is missing required property '" +
                    name +
                    "'",
            )
