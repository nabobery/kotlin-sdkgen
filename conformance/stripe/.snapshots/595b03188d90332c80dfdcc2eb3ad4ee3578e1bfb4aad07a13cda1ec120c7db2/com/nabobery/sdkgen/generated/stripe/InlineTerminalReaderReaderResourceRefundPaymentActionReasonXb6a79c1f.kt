...
public sealed class InlineTerminalReaderReaderResourceRefundPaymentActionReasonXb6a79c1f {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineTerminalReaderReaderResourceRefundPaymentActionReasonXb6a79c1f =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineTerminalReaderReaderResourceRefundPaymentActionReasonXb6a79c1f> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineTerminalReaderReaderResourceRefundPaymentActionReasonXb6a79c1f",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineTerminalReaderReaderResourceRefundPaymentActionReasonXb6a79c1f = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineTerminalReaderReaderResourceRefundPaymentActionReasonXb6a79c1f,
        ) {
