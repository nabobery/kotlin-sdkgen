...
public class InlineV1PaymentMethodConfigurationsPostRequestFormZipDisplayPreferenceXade79f20(
    public val preference: InlineV1PaymentMethodConfidc49PostRequestFormZipPreferenceX45f3e9e5? = null,
) {
    public class Builder {
        public var preference: InlineV1PaymentMethodConfidc49PostRequestFormZipPreferenceX45f3e9e5? =
            null

        public fun build(): InlineV1PaymentMethodConfigurationsPostRequestFormZipDisplayPreferenceXade79f20 =
            InlineV1PaymentMethodConfigurationsPostRequestFormZipDisplayPreferenceXade79f20(
    ...
    public object Serializer : KSerializer<InlineV1PaymentMethodConfigurationsPostRequestFormZipDisplayPreferenceXade79f20> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentMethodConfigurationsPostRequestFormZipDisplayPreferenceXade79f20 must be a JSON object",
                    )
            return InlineV1PaymentMethodConfigurationsPostRequestFormZipDisplayPreferenceXade79f20(
                preference =
                    rawObject["preference"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentMethodConfidc49PostRequestFormZipPreferenceX45f3e9e5>(
                            it,
                        )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentMethodConfigurationsPostRequestFormZipDisplayPreferenceXade79f20,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentMethodConfigurationsPostRequestFormZipDisplayPreferenceXade79f20(
    block: InlineV1PaymentMethodConfigurationsPostRequestFormZipDisplayPreferenceXade79f20.Builder.() -> Unit,
): InlineV1PaymentMethodConfigurationsPostRequestFormZipDisplayPreferenceXade79f20 =
    InlineV1PaymentMethodConfigurationsPostRequestFormZipDisplayPreferenceXade79f20.build(block)
