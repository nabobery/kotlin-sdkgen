...
public sealed class InlineV1PaymentIntentsPostRequestFormElectronicCommerceIn67d5Xe3b3f99e {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1PaymentIntentsPostRequestFormElectronicCommerceIn67d5Xe3b3f99e =
            when (value) {
                _01.value -> _01
                _02.value -> _02
                _05.value -> _05
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormElectronicCommerceIn67d5Xe3b3f99e> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1PaymentIntentsPostRequestFormElectronicCommerceIn67d5Xe3b3f99e",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1PaymentIntentsPostRequestFormElectronicCommerceIn67d5Xe3b3f99e = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormElectronicCommerceIn67d5Xe3b3f99e,
        ) {
