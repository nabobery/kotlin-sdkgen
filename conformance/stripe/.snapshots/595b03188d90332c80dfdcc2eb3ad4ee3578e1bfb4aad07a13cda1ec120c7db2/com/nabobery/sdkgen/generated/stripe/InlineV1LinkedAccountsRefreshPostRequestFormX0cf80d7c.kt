...
public class InlineV1LinkedAccountsRefreshPostRequestFormX0cf80d7c(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1LinkedAccountsRefreshPostRequestFormX0cf80d7c =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1LinkedAccountsRefreshPostRequestFormX0cf80d7c> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1LinkedAccountsRefreshPostRequestFormX0cf80d7c must be a JSON object",
                    )
            val features =
                json.decodeRequired<List<InlineV1LinkedAccountsRefreshPostRequestFormFeaturesItemX8b872abb>>(
                    rawObject,
                    "features",
                )
            return InlineV1LinkedAccountsRefreshPostRequestFormX0cf80d7c(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1LinkedAccountsRefreshPostRequestFormX0cf80d7c,
        ) {
...
public fun inlineV1LinkedAccountsRefreshPostRequestFormX0cf80d7c(
    block: InlineV1LinkedAccountsRefreshPostRequestFormX0cf80d7c.Builder.() -> Unit,
): InlineV1LinkedAccountsRefreshPostRequestFormX0cf80d7c =
    InlineV1LinkedAccountsRefreshPostRequestFormX0cf80d7c.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1LinkedAccountsRefreshPostRequestFormX0cf80d7c is missing required property '" + name + "'",
            )
