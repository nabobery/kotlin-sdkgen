...
internal data class InlineV1PaymentIntentsPostRequestFormOffSessionXa86bacecInspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1PaymentIntentsPostRequestFormOffSessionAnyOf2X04ff617c,
            ).count { it }
}
...
public class InlineV1PaymentIntentsPostRequestFormOffSessionXa86bacec internal constructor(
    ...
    public val inlineV1PaymentIntentsPostRequestFormOffSessionAnyOf2X04ff617c:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1PaymentIntentsPostRequestFormOffSessionAnyOf2X04ff617c) {
                json
                    .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormOffSessionAnyOf2X04ff617c>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1PaymentIntentsPostRequestFormOffSessionXa86bacecBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1PaymentIntentsPostRequestFormOffSessionAnyOf2X04ff617c) {
                    add(
                        InlineV1PaymentIntentsPostRequestFormOffSessionXa86bacecBranch.InlineV1PaymentIntentsPostRequestFormOffSessionAnyOf2X04ff617c,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1PaymentIntentsPostRequestFormOffSessionXa86bacec {
            val inspection = inspectInlineV1PaymentIntentsPostRequestFormOffSessionXa86bacec(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1PaymentIntentsPostRequestFormOffSessionXa86bacecNoMatchException(
                    "InlineV1PaymentIntentsPostRequestFormOffSessionXa86bacec matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormOffSessionXa86bacec> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormOffSessionXa86bacec,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1PaymentIntentsPostRequestFormOffSessionXa86bacec",
...
private fun inspectInlineV1PaymentIntentsPostRequestFormOffSessionXa86bacec(
    element: JsonElement,
): InlineV1PaymentIntentsPostRequestFormOffSessionXa86bacecInspection {
    val matchesBranch1 = element.isJsonDecodable<Boolean>()
    val matchesInlineV1PaymentIntentsPostRequestFormOffSessionAnyOf2X04ff617c =
        element
            .isJsonDecodable<InlineV1PaymentIntentsPostRequestFormOffSessionAnyOf2X04ff617c>()
    return InlineV1PaymentIntentsPostRequestFormOffSessionXa86bacecInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1PaymentIntentsPostRequestFormOffSessionAnyOf2X04ff617c) {
                    add(
                        "InlineV1PaymentIntentsPostRequestFormOffSessionAnyOf2X04ff617c: value does not match InlineV1PaymentIntentsPostRequestFormOffSessionAnyOf2X04ff617c",
                    )
                }
            },
    )
