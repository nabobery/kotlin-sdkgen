...
public class InlineV1IssuingDisputesGetResponse200JsonX0e75ecaa(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1IssuingDisputesGetResponse200JsonX0e75ecaa =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1IssuingDisputesGetResponse200JsonX0e75ecaa> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1IssuingDisputesGetResponse200JsonX0e75ecaa {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1IssuingDisputesGetResponse200JsonX0e75ecaa must be a JSON object",
                    )
            ...
            val objectValue =
                json.decodeRequired<InlineV1IssuingDisputesGetResponse200JsonObjectValueX1c058fcb>(
                    rawObject,
                    "object",
                )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingDisputesGetResponse200JsonX0e75ecaa,
        ) {
...
public fun inlineV1IssuingDisputesGetResponse200JsonX0e75ecaa(
    block: InlineV1IssuingDisputesGetResponse200JsonX0e75ecaa.Builder.() -> Unit,
): InlineV1IssuingDisputesGetResponse200JsonX0e75ecaa = InlineV1IssuingDisputesGetResponse200JsonX0e75ecaa.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1IssuingDisputesGetResponse200JsonX0e75ecaa is missing required property '" + name + "'",
            )
