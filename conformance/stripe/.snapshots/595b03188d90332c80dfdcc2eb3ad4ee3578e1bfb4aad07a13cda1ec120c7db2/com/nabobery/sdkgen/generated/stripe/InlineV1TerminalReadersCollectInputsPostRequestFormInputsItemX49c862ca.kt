...
public class InlineV1TerminalReadersCollectInputsPostRequestFormInputsItemX49c862ca(
    public val customText: InlineV1TerminalReadersCollectInputsPostRequestFormInputsItemCustomTextX2e01c768,
    ...
    public val selection: InlineV1TerminalReadersCollectInputsPostRequestFormInputsItemSelectionXc58f8be2? = null,
    public val toggles: List<InlineV1TerminalReadersCol2891PostRequestFormInputsItemTogglesItemXbdad3836>? = null,
) {
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1TerminalReadersCollectInputsPostRequestFormInputsItemX49c862ca = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1TerminalReadersCollectInputsPostRequestFormInputsItemX49c862ca> {
        ...
        override fun deserialize(
            decoder: Decoder,
        ): InlineV1TerminalReadersCollectInputsPostRequestFormInputsItemX49c862ca {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TerminalReadersCollectInputsPostRequestFormInputsItemX49c862ca must be a JSON object",
                    )
            val customText =
                json
                    .decodeRequired<InlineV1TerminalReadersCollectInputsPostRequestFormInputsItemCustomTextX2e01c768>(
                        rawObject,
                        "custom_text",
                    )
            val type =
                json.decodeRequired<InlineV1TerminalReadersCollectInputsPostRequestFormInputsItemTypeXd52e1726>(
                    rawObject,
                    "type",
                )
            return InlineV1TerminalReadersCollectInputsPostRequestFormInputsItemX49c862ca(
                ...
                selection =
                    rawObject["selection"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TerminalReadersCollectInputsPostRequestFormInputsItemSelectionXc58f8be2>(
                                it,
                            )
                    },
                toggles =
                    rawObject["toggles"]?.let {
                        json
                            .decodeFromJsonElement<List<InlineV1TerminalReadersCol2891PostRequestFormInputsItemTogglesItemXbdad3836>>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TerminalReadersCollectInputsPostRequestFormInputsItemX49c862ca,
        ) {
            val jsonEncoder =
...
public fun inlineV1TerminalReadersCollectInputsPostRequestFormInputsItemX49c862ca(
    block: InlineV1TerminalReadersCollectInputsPostRequestFormInputsItemX49c862ca.Builder.() -> Unit,
): InlineV1TerminalReadersCollectInputsPostRequestFormInputsItemX49c862ca =
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TerminalReadersCollectInputsPostRequestFormInputsItemX49c862ca is missing required property '" +
                    name +
                    "'",
            )
