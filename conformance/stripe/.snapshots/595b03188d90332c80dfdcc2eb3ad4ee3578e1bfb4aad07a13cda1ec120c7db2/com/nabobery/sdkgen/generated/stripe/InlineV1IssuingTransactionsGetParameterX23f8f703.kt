...
public class InlineV1IssuingTransactionsGetParameterX23f8f703 internal constructor(
    ...
    public val inlineV1IssuingTransactionsGetParameterAnyOf1Xd7ffb325:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1IssuingTransactionsGetParameterAnyOf1Xd7ffb325) {
                json
                    .decodeFromJsonElement<InlineV1IssuingTransactionsGetParameterAnyOf1Xd7ffb325>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1IssuingTransactionsGetParameterX23f8f703Branch>
        get() =
            buildSet {
                if (inspection.matchesInlineV1IssuingTransactionsGetParameterAnyOf1Xd7ffb325) {
                    add(
                        InlineV1IssuingTransactionsGetParameterX23f8f703Branch.InlineV1IssuingTransactionsGetParameterAnyOf1Xd7ffb325,
                    )
                }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1IssuingTransactionsGetParameterX23f8f703 {
            val inspection = inspectInlineV1IssuingTransactionsGetParameterX23f8f703(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1IssuingTransactionsGetParameterX23f8f703NoMatchException(
                    "InlineV1IssuingTransactionsGetParameterX23f8f703 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1IssuingTransactionsGetParameterX23f8f703> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingTransactionsGetParameterX23f8f703,
        ) {
...
private fun inspectInlineV1IssuingTransactionsGetParameterX23f8f703(
    element: JsonElement,
): InlineV1IssuingTransactionsGetParameterX23f8f703Inspection {
    val matchesInlineV1IssuingTransactionsGetParameterAnyOf1Xd7ffb325 =
        element
            .isJsonDecodable<InlineV1IssuingTransactionsGetParameterAnyOf1Xd7ffb325>()
    ...
    return InlineV1IssuingTransactionsGetParameterX23f8f703Inspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1IssuingTransactionsGetParameterAnyOf1Xd7ffb325) {
                    add(
                        "InlineV1IssuingTransactionsGetParameterAnyOf1Xd7ffb325: value does not match InlineV1IssuingTransactionsGetParameterAnyOf1Xd7ffb325",
                    )
                }
