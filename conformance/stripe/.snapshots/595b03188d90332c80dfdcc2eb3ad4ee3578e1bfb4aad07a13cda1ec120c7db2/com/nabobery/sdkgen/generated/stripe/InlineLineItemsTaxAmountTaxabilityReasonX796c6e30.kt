...
public sealed class InlineLineItemsTaxAmountTaxabilityReasonX796c6e30 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineLineItemsTaxAmountTaxabilityReasonX796c6e30 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineLineItemsTaxAmountTaxabilityReasonX796c6e30> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineLineItemsTaxAmountTaxabilityReasonX796c6e30",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineLineItemsTaxAmountTaxabilityReasonX796c6e30 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineLineItemsTaxAmountTaxabilityReasonX796c6e30,
        ) {
