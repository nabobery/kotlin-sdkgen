...
public class InlineV1AccountsPersonsPostRequestFormDocumentsX9f95ff75(
    public val companyAuthorization: InlineV1AccountsPersonsPostRequestFormDocumentsCompanyAuthorizationX4117d912? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1AccountsPersonsPostRequestFormDocumentsX9f95ff75 =
            InlineV1AccountsPersonsPostRequestFormDocumentsX9f95ff75(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1AccountsPersonsPostRequestFormDocumentsX9f95ff75 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1AccountsPersonsPostRequestFormDocumentsX9f95ff75> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountsPersonsPostRequestFormDocumentsX9f95ff75 must be a JSON object",
                    )
            return InlineV1AccountsPersonsPostRequestFormDocumentsX9f95ff75(
                companyAuthorization =
                    rawObject["company_authorization"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1AccountsPersonsPostRequestFormDocumentsCompanyAuthorizationX4117d912>(
                                it,
                            )
                    },
                passport =
                    rawObject["passport"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPersonsPostRequestFormDocumentsPassportXc400aba0>(it)
                    },
                visa =
                    rawObject["visa"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPersonsPostRequestFormDocumentsVisaX2fb8b73c>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPersonsPostRequestFormDocumentsX9f95ff75,
        ) {
...
public fun inlineV1AccountsPersonsPostRequestFormDocumentsX9f95ff75(
    block: InlineV1AccountsPersonsPostRequestFormDocumentsX9f95ff75.Builder.() -> Unit,
): InlineV1AccountsPersonsPostRequestFormDocumentsX9f95ff75 =
    InlineV1AccountsPersonsPostRequestFormDocumentsX9f95ff75.build(block)
