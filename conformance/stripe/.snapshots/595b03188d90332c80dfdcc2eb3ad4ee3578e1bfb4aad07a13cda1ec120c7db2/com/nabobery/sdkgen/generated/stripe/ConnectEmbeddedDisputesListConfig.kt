...
public class ConnectEmbeddedDisputesListConfig(
    ...
    public object Serializer : KSerializer<ConnectEmbeddedDisputesListConfig> {
        ...
        override fun deserialize(decoder: Decoder): ConnectEmbeddedDisputesListConfig {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("ConnectEmbeddedDisputesListConfig must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: ConnectEmbeddedDisputesListConfig,
        ) {
...
public fun connectEmbeddedDisputesListConfig(
    block: ConnectEmbeddedDisputesListConfig.Builder.() -> Unit,
): ConnectEmbeddedDisputesListConfig = ConnectEmbeddedDisputesListConfig.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "ConnectEmbeddedDisputesListConfig is missing required property '" + name + "'",
            )
