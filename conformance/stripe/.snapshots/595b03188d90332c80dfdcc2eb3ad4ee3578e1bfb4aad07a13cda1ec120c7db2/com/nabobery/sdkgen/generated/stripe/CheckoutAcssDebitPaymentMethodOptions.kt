...
public class CheckoutAcssDebitPaymentMethodOptions(
     ...
     */
    public val setupFutureUsage: InlineCheckoutAcssDebitPaymentMethodOptionsSetupFutureUsageX06041e79? = null,
    /**
     ...
     */
    public val verificationMethod: InlineCheckoutAcssDebitPaymentMethodOptionsVerificationMethodX47ad3a9d? = null,
) {
    public class Builder {
        ...
        public fun build(): CheckoutAcssDebitPaymentMethodOptions =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): CheckoutAcssDebitPaymentMethodOptions =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<CheckoutAcssDebitPaymentMethodOptions> {
        ...
        override fun deserialize(decoder: Decoder): CheckoutAcssDebitPaymentMethodOptions {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("CheckoutAcssDebitPaymentMethodOptions must be a JSON object")
            return CheckoutAcssDebitPaymentMethodOptions(
                currency =
                    rawObject["currency"]?.let {
                        json.decodeFromJsonElement<InlineCheckoutAcssDebitPaymentMethodOptionsCurrencyXfb11cf8a>(it)
                    },
                mandateOptions =
                    rawObject["mandate_options"]?.let {
                        json
                            .decodeFromJsonElement<CheckoutAcssDebitMandateOptions>(
                                it,
                            )
                    },
                setupFutureUsage =
                    rawObject["setup_future_usage"]?.let {
                        json
                            .decodeFromJsonElement<InlineCheckoutAcssDebitPaymentMethodOptionsSetupFutureUsageX06041e79>(
                                it,
                            )
                    },
                ...
                verificationMethod =
                    rawObject["verification_method"]?.let {
                        json
                            .decodeFromJsonElement<InlineCheckoutAcssDebitPaymentMethodOptionsVerificationMethodX47ad3a9d>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: CheckoutAcssDebitPaymentMethodOptions,
        ) {
...
public fun checkoutAcssDebitPaymentMethodOptions(
    block: CheckoutAcssDebitPaymentMethodOptions.Builder.() -> Unit,
): CheckoutAcssDebitPaymentMethodOptions = CheckoutAcssDebitPaymentMethodOptions.build(block)
