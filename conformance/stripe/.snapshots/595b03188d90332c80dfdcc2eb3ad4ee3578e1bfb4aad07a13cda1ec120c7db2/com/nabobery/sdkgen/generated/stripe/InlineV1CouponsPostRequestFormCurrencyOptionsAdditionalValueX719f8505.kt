...
public class InlineV1CouponsPostRequestFormCurrencyOptionsAdditionalValueX719f8505(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1CouponsPostRequestFormCurrencyOptionsAdditionalValueX719f8505 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1CouponsPostRequestFormCurrencyOptionsAdditionalValueX719f8505> {
        ...
        override fun deserialize(
            decoder: Decoder,
        ): InlineV1CouponsPostRequestFormCurrencyOptionsAdditionalValueX719f8505 {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CouponsPostRequestFormCurrencyOptionsAdditionalValueX719f8505 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CouponsPostRequestFormCurrencyOptionsAdditionalValueX719f8505,
        ) {
            val jsonEncoder =
...
public fun inlineV1CouponsPostRequestFormCurrencyOptionsAdditionalValueX719f8505(
    block: InlineV1CouponsPostRequestFormCurrencyOptionsAdditionalValueX719f8505.Builder.() -> Unit,
): InlineV1CouponsPostRequestFormCurrencyOptionsAdditionalValueX719f8505 =
    InlineV1CouponsPostRequestFormCurrencyOptionsAdditionalValueX719f8505.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1CouponsPostRequestFormCurrencyOptionsAdditionalValueX719f8505 is missing required property '" +
                    name +
                    "'",
            )
