...
public sealed class InlineSourceMandateNotificationObjectValueXf8a847b1 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineSourceMandateNotificationObjectValueXf8a847b1 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineSourceMandateNotificationObjectValueXf8a847b1> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineSourceMandateNotificationObjectValueXf8a847b1",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineSourceMandateNotificationObjectValueXf8a847b1 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineSourceMandateNotificationObjectValueXf8a847b1,
        ) {
