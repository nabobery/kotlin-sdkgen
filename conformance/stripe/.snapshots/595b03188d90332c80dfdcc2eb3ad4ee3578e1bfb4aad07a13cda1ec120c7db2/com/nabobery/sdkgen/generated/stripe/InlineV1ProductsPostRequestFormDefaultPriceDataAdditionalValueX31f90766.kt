...
public class InlineV1ProductsPostRequestFormDefaultPriceDataAdditionalValueX31f90766(
    public val customUnitAmount: InlineV1ProductsPostRequestFormDefaultPriceDataCustomUnitAmountX941990ea? = null,
    public val taxBehavior: InlineV1ProductsPostRequestFormDefaultPriceDataTaxBehaviorXd1346b5b? = null,
    public val tiers: List<InlineV1ProductsPostRequestFormDefaultPriceDataCurrencyOptionsItemX80c17ef6>? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1ProductsPostRequestFormDefaultPriceDataAdditionalValueX31f90766 =
            InlineV1ProductsPostRequestFormDefaultPriceDataAdditionalValueX31f90766(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1ProductsPostRequestFormDefaultPriceDataAdditionalValueX31f90766 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1ProductsPostRequestFormDefaultPriceDataAdditionalValueX31f90766> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1ProductsPostRequestFormDefaultPriceDataAdditionalValueX31f90766 must be a JSON object",
                    )
            return InlineV1ProductsPostRequestFormDefaultPriceDataAdditionalValueX31f90766(
                customUnitAmount =
                    rawObject["custom_unit_amount"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1ProductsPostRequestFormDefaultPriceDataCustomUnitAmountX941990ea>(
                                it,
                            )
                    },
                taxBehavior =
                    rawObject["tax_behavior"]?.let {
                        json.decodeFromJsonElement<InlineV1ProductsPostRequestFormDefaultPriceDataTaxBehaviorXd1346b5b>(
                            it,
                        )
                    },
                tiers =
                    rawObject["tiers"]?.let {
                        json
                            .decodeFromJsonElement<List<InlineV1ProductsPostRequestFormDefaultPriceDataCurrencyOptionsItemX80c17ef6>>(
                                it,
                            )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ProductsPostRequestFormDefaultPriceDataAdditionalValueX31f90766,
        ) {
            val jsonEncoder =
...
public fun inlineV1ProductsPostRequestFormDefaultPriceDataAdditionalValueX31f90766(
    block: InlineV1ProductsPostRequestFormDefaultPriceDataAdditionalValueX31f90766.Builder.() -> Unit,
): InlineV1ProductsPostRequestFormDefaultPriceDataAdditionalValueX31f90766 =
    InlineV1ProductsPostRequestFormDefaultPriceDataAdditionalValueX31f90766.build(block)
