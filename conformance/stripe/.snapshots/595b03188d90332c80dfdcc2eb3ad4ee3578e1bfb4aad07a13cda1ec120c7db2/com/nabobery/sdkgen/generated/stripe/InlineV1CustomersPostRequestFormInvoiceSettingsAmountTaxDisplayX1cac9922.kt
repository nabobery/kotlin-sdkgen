...
public sealed class InlineV1CustomersPostRequestFormInvoiceSettingsAmountTaxDisplayX1cac9922 {
    ...
    public object Serializer : KSerializer<InlineV1CustomersPostRequestFormInvoiceSettingsAmountTaxDisplayX1cac9922> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1CustomersPostRequestFormInvoiceSettingsAmountTaxDisplayX1cac9922",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1CustomersPostRequestFormInvoiceSettingsAmountTaxDisplayX1cac9922 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersPostRequestFormInvoiceSettingsAmountTaxDisplayX1cac9922,
        ) {
