...
public sealed class InlinePaymentIntentAmountDetailsLineItemObjectValueX5064f062 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentIntentAmountDetailsLineItemObjectValueX5064f062 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlinePaymentIntentAmountDetailsLineItemObjectValueX5064f062> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentIntentAmountDetailsLineItemObjectValueX5064f062",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePaymentIntentAmountDetailsLineItemObjectValueX5064f062 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentIntentAmountDetailsLineItemObjectValueX5064f062,
        ) {
