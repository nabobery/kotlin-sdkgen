...
public class InlineV1TreasuryFinancialAc862PostRequestFormFeaturesUsDomesticWireX70828828(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1TreasuryFinancialAc862PostRequestFormFeaturesUsDomesticWireX70828828 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1TreasuryFinancialAc862PostRequestFormFeaturesUsDomesticWireX70828828> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TreasuryFinancialAc862PostRequestFormFeaturesUsDomesticWireX70828828 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TreasuryFinancialAc862PostRequestFormFeaturesUsDomesticWireX70828828,
        ) {
            val jsonEncoder =
...
public fun inlineV1TreasuryFinancialAc862PostRequestFormFeaturesUsDomesticWireX70828828(
    block: InlineV1TreasuryFinancialAc862PostRequestFormFeaturesUsDomesticWireX70828828.Builder.() -> Unit,
): InlineV1TreasuryFinancialAc862PostRequestFormFeaturesUsDomesticWireX70828828 =
    InlineV1TreasuryFinancialAc862PostRequestFormFeaturesUsDomesticWireX70828828.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TreasuryFinancialAc862PostRequestFormFeaturesUsDomesticWireX70828828 is missing required property '" +
                    name +
                    "'",
            )
