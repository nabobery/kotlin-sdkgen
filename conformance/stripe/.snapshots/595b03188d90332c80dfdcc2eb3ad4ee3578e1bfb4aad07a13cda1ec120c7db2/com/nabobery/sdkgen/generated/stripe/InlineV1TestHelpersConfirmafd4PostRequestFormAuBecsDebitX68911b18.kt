...
public class InlineV1TestHelpersConfirmafd4PostRequestFormAuBecsDebitX68911b18(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TestHelpersConfirmafd4PostRequestFormAuBecsDebitX68911b18 =
    ...
    public object Serializer : KSerializer<InlineV1TestHelpersConfirmafd4PostRequestFormAuBecsDebitX68911b18> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1TestHelpersConfirmafd4PostRequestFormAuBecsDebitX68911b18 {
            val jsonDecoder =
                decoder.requireJsonDecoder(
                    "InlineV1TestHelpersConfirmafd4PostRequestFormAuBecsDebitX68911b18",
                )
            val json = jsonDecoder.json
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TestHelpersConfirmafd4PostRequestFormAuBecsDebitX68911b18 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TestHelpersConfirmafd4PostRequestFormAuBecsDebitX68911b18,
        ) {
            val jsonEncoder =
...
public fun inlineV1TestHelpersConfirmafd4PostRequestFormAuBecsDebitX68911b18(
    block: InlineV1TestHelpersConfirmafd4PostRequestFormAuBecsDebitX68911b18.Builder.() -> Unit,
): InlineV1TestHelpersConfirmafd4PostRequestFormAuBecsDebitX68911b18 =
    InlineV1TestHelpersConfirmafd4PostRequestFormAuBecsDebitX68911b18.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TestHelpersConfirmafd4PostRequestFormAuBecsDebitX68911b18 is missing required property '" +
                    name +
                    "'",
            )
