...
public sealed class InlineV1IssuingTokensPostRequestFormStatusX8c2dd5a5 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1IssuingTokensPostRequestFormStatusX8c2dd5a5 =
            when (value) {
                Active.value -> Active
    ...
    public object Serializer : KSerializer<InlineV1IssuingTokensPostRequestFormStatusX8c2dd5a5> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1IssuingTokensPostRequestFormStatusX8c2dd5a5",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1IssuingTokensPostRequestFormStatusX8c2dd5a5 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingTokensPostRequestFormStatusX8c2dd5a5,
        ) {
