...
public class InlineV1AccountsPostRequestFormDocumentsX9ce2e389(
    ...
    public val companyLicense: InlineV1AccountsPostRequestFormDocumentsCompanyLicenseX6d61b7c1? = null,
    ...
    public val proofOfAddress: InlineV1AccountsPostRequestFormDocumentsProofOfAddressXf0e6adb0? = null,
    public val proofOfRegistration: InlineV1AccountsPostRequestFormDocumentsProofOfRegistrationXb83dd00f? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1AccountsPostRequestFormDocumentsX9ce2e389 =
            InlineV1AccountsPostRequestFormDocumentsX9ce2e389(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1AccountsPostRequestFormDocumentsX9ce2e389 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1AccountsPostRequestFormDocumentsX9ce2e389> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountsPostRequestFormDocumentsX9ce2e389 must be a JSON object",
                    )
            return InlineV1AccountsPostRequestFormDocumentsX9ce2e389(
                bankAccountOwnershipVerification =
                    rawObject["bank_account_ownership_verification"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1AccountsPostRequestFormDocumentsBankAccountOwnership2a7eXedf86e28>(
                                it,
                            )
                    },
                companyLicense =
                    rawObject["company_license"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPostRequestFormDocumentsCompanyLicenseX6d61b7c1>(it)
                    },
                companyMemorandumOfAssociation =
                    rawObject["company_memorandum_of_association"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1AccountsPostRequestFormDocumentsCompanyMemorandumOfAssociationX750f32be>(
                                it,
                            )
                    },
                companyMinisterialDecree =
                    rawObject["company_ministerial_decree"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1AccountsPostRequestFormDocumentsCompanyMinisterialDecreeX15db2e3c>(
                                it,
                            )
                    },
                companyRegistrationVerification =
                    rawObject["company_registration_verification"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1AccountsPostRequestFormDocumentsCompanyRegistrationVerificationX1624a350>(
                                it,
                            )
                    },
                companyTaxIdVerification =
                    rawObject["company_tax_id_verification"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1AccountsPostRequestFormDocumentsCompanyTaxIdVerificationX446d7e1b>(
                                it,
                            )
                    },
                proofOfAddress =
                    rawObject["proof_of_address"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPostRequestFormDocumentsProofOfAddressXf0e6adb0>(it)
                    },
                proofOfRegistration =
                    rawObject["proof_of_registration"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1AccountsPostRequestFormDocumentsProofOfRegistrationXb83dd00f>(
                                it,
                            )
                    },
                proofOfUltimateBeneficialOwnership =
                    rawObject["proof_of_ultimate_beneficial_ownership"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1AccountsPostRequestFormDocumentsProofOfUltimateBenefebd6X359786cc>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPostRequestFormDocumentsX9ce2e389,
        ) {
...
public fun inlineV1AccountsPostRequestFormDocumentsX9ce2e389(
    block: InlineV1AccountsPostRequestFormDocumentsX9ce2e389.Builder.() -> Unit,
): InlineV1AccountsPostRequestFormDocumentsX9ce2e389 = InlineV1AccountsPostRequestFormDocumentsX9ce2e389.build(block)
