...
public class InlineV1SubscriptionSchedulesPostRequestFormXb0722b29(
     ...
     */
    public val defaultSettings: InlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsXc9278c34? = null,
    /**
     ...
     */
    public val phases: List<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemX8e3ffe4e>? = null,
    /**
     ...
     */
    public val prorationBehavior: InlineV1SubscriptionSchedulesPostRequestFormProrationBehaviorXf4833d31? = null,
) {
    public class Builder {
         ...
         */
        public var phases: List<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemX8e3ffe4e>? = null
        ...
        public fun build(): InlineV1SubscriptionSchedulesPostRequestFormXb0722b29 =
            InlineV1SubscriptionSchedulesPostRequestFormXb0722b29(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1SubscriptionSchedulesPostRequestFormXb0722b29 =
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionSchedulesPostRequestFormXb0722b29> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SubscriptionSchedulesPostRequestFormXb0722b29 must be a JSON object",
                    )
            return InlineV1SubscriptionSchedulesPostRequestFormXb0722b29(
                defaultSettings =
                    rawObject["default_settings"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsXc9278c34>(
                                it,
                            )
                    },
                endBehavior =
                    rawObject["end_behavior"]?.let {
                        json.decodeFromJsonElement<InlineV1SubscriptionSchedulesPostRequestFormEndBehaviorX3218b808>(it)
                    },
                expand = rawObject["expand"]?.let { json.decodeFromJsonElement<List<String>>(it) },
                metadata =
                    rawObject["metadata"]?.let {
                        json.decodeFromJsonElement<InlineV1SubscriptionSchedulesPostRequestFormMetadataX3b47466f>(it)
                    },
                phases =
                    rawObject["phases"]?.let {
                        json
                            .decodeFromJsonElement<List<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemX8e3ffe4e>>(
                                it,
                            )
                    },
                prorationBehavior =
                    rawObject["proration_behavior"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SubscriptionSchedulesPostRequestFormProrationBehaviorXf4833d31>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionSchedulesPostRequestFormXb0722b29,
        ) {
...
public fun inlineV1SubscriptionSchedulesPostRequestFormXb0722b29(
    block: InlineV1SubscriptionSchedulesPostRequestFormXb0722b29.Builder.() -> Unit,
): InlineV1SubscriptionSchedulesPostRequestFormXb0722b29 =
    InlineV1SubscriptionSchedulesPostRequestFormXb0722b29.build(block)
