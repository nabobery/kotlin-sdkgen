...
public class CheckoutSofortPaymentMethodOptions(
     ...
     */
    public val setupFutureUsage: InlineCheckoutSofortPaymentMethodOptionsSetupFutureUsageX06c15030? = null,
) {
    public class Builder {
        ...
        public fun build(): CheckoutSofortPaymentMethodOptions =
    ...
    public object Serializer : KSerializer<CheckoutSofortPaymentMethodOptions> {
        ...
        override fun deserialize(decoder: Decoder): CheckoutSofortPaymentMethodOptions {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("CheckoutSofortPaymentMethodOptions must be a JSON object")
            return CheckoutSofortPaymentMethodOptions(
                setupFutureUsage =
                    rawObject["setup_future_usage"]?.let {
                        json.decodeFromJsonElement<InlineCheckoutSofortPaymentMethodOptionsSetupFutureUsageX06c15030>(
                            it,
                        )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: CheckoutSofortPaymentMethodOptions,
        ) {
...
public fun checkoutSofortPaymentMethodOptions(
    block: CheckoutSofortPaymentMethodOptions.Builder.() -> Unit,
): CheckoutSofortPaymentMethodOptions = CheckoutSofortPaymentMethodOptions.build(block)
