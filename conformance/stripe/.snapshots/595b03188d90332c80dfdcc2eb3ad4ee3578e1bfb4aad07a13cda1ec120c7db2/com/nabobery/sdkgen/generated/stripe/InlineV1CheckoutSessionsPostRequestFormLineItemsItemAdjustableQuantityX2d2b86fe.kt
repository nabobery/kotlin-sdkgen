...
public class InlineV1CheckoutSessionsPostRequestFormLineItemsItemAdjustableQuantityX2d2b86fe(
    ...
    public object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormLineItemsItemAdjustableQuantityX2d2b86fe> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CheckoutSessionsPostRequestFormLineItemsItemAdjustableQuantityX2d2b86fe must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsPostRequestFormLineItemsItemAdjustableQuantityX2d2b86fe,
        ) {
            val jsonEncoder =
...
public fun inlineV1CheckoutSessionsPostRequestFormLineItemsItemAdjustableQuantityX2d2b86fe(
    block: InlineV1CheckoutSessionsPostRequestFormLineItemsItemAdjustableQuantityX2d2b86fe.Builder.() -> Unit,
): InlineV1CheckoutSessionsPostRequestFormLineItemsItemAdjustableQuantityX2d2b86fe =
    InlineV1CheckoutSessionsPostRequestFormLineItemsItemAdjustableQuantityX2d2b86fe.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1CheckoutSessionsPostRequestFormLineItemsItemAdjustableQuantityX2d2b86fe is missing required property '" +
                    name +
                    "'",
            )
