...
public class InlineV1ChargesDisputePostRequestFormEvidenceMastercardComplianceX565e0fa2(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1ChargesDisputePostRequestFormEvidenceMastercardComplianceX565e0fa2 =
            InlineV1ChargesDisputePostRequestFormEvidenceMastercardComplianceX565e0fa2(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1ChargesDisputePostRequestFormEvidenceMastercardComplianceX565e0fa2 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1ChargesDisputePostRequestFormEvidenceMastercardComplianceX565e0fa2> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1ChargesDisputePostRequestFormEvidenceMastercardComplianceX565e0fa2 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ChargesDisputePostRequestFormEvidenceMastercardComplianceX565e0fa2,
        ) {
            val jsonEncoder =
...
public fun inlineV1ChargesDisputePostRequestFormEvidenceMastercardComplianceX565e0fa2(
    block: InlineV1ChargesDisputePostRequestFormEvidenceMastercardComplianceX565e0fa2.Builder.() -> Unit,
): InlineV1ChargesDisputePostRequestFormEvidenceMastercardComplianceX565e0fa2 =
    InlineV1ChargesDisputePostRequestFormEvidenceMastercardComplianceX565e0fa2.build(block)
