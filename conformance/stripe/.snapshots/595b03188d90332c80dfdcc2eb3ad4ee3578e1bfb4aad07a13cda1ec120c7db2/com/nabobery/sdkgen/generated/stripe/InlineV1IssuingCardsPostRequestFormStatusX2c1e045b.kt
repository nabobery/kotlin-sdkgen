...
public sealed class InlineV1IssuingCardsPostRequestFormStatusX2c1e045b {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1IssuingCardsPostRequestFormStatusX2c1e045b =
            when (value) {
                Active.value -> Active
    ...
    public object Serializer : KSerializer<InlineV1IssuingCardsPostRequestFormStatusX2c1e045b> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1IssuingCardsPostRequestFormStatusX2c1e045b",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1IssuingCardsPostRequestFormStatusX2c1e045b =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingCardsPostRequestFormStatusX2c1e045b,
        ) {
