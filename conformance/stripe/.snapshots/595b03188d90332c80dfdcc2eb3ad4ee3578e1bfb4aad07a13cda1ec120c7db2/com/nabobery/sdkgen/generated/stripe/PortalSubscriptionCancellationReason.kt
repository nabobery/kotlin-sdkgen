...
public class PortalSubscriptionCancellationReason(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PortalSubscriptionCancellationReason =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PortalSubscriptionCancellationReason> {
        ...
        override fun deserialize(decoder: Decoder): PortalSubscriptionCancellationReason {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PortalSubscriptionCancellationReason must be a JSON object")
            val enabled = json.decodeRequired<Boolean>(rawObject, "enabled")
            val options =
                json.decodeRequired<List<InlinePortalSubscriptionCancellationReasonOptionsItemX410d9b95>>(
                    rawObject,
                    "options",
                )
            return PortalSubscriptionCancellationReason(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PortalSubscriptionCancellationReason,
        ) {
...
public fun portalSubscriptionCancellationReason(
    block: PortalSubscriptionCancellationReason.Builder.() -> Unit,
): PortalSubscriptionCancellationReason = PortalSubscriptionCancellationReason.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "PortalSubscriptionCancellationReason is missing required property '" + name + "'",
            )
