...
public sealed class InlineGelatoDocumentReportSexX65e79c91 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineGelatoDocumentReportSexX65e79c91 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineGelatoDocumentReportSexX65e79c91> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineGelatoDocumentReportSexX65e79c91",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineGelatoDocumentReportSexX65e79c91 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineGelatoDocumentReportSexX65e79c91,
        ) {
