...
public sealed class InlineShippingRateObjectValueX6333f01b {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineShippingRateObjectValueX6333f01b =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineShippingRateObjectValueX6333f01b> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineShippingRateObjectValueX6333f01b",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineShippingRateObjectValueX6333f01b =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineShippingRateObjectValueX6333f01b,
        ) {
