...
public class SubscriptionSchedulesResourceDefaultSettingsAutomaticTax(
     ...
     */
    public val liability: InlineSubscriptionSchedulesResourceDefaultSettingsAutomaticTaxLiabilityXf82cd398? = null,
) {
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): SubscriptionSchedulesResourceDefaultSettingsAutomaticTax =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<SubscriptionSchedulesResourceDefaultSettingsAutomaticTax> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "SubscriptionSchedulesResourceDefaultSettingsAutomaticTax must be a JSON object",
                    )
                ...
                disabledReason =
                    rawObject["disabled_reason"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineSubscriptionSchedule62cfDisabledReasonXfef27da9?>(element)
                        }
                    },
                liability =
                    rawObject["liability"]?.let { element ->
                        if (element ==
                            ...
                            json
                                .decodeFromJsonElement<InlineSubscriptionSchedulesResourceDefaultSettingsAutomaticTaxLiabilityXf82cd398?>(
                                    element,
                                )
                        }
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: SubscriptionSchedulesResourceDefaultSettingsAutomaticTax,
        ) {
...
public fun subscriptionSchedulesResourceDefaultSettingsAutomaticTax(
    block: SubscriptionSchedulesResourceDefaultSettingsAutomaticTax.Builder.() -> Unit,
): SubscriptionSchedulesResourceDefaultSettingsAutomaticTax =
    SubscriptionSchedulesResourceDefaultSettingsAutomaticTax.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "SubscriptionSchedulesResourceDefaultSettingsAutomaticTax is missing required property '" + name + "'",
            )
