...
public sealed class InlineOutboundPaymentsPaymentMethodDetailsTypeXe5713fd1 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineOutboundPaymentsPaymentMethodDetailsTypeXe5713fd1 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineOutboundPaymentsPaymentMethodDetailsTypeXe5713fd1> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineOutboundPaymentsPaymentMethodDetailsTypeXe5713fd1",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineOutboundPaymentsPaymentMethodDetailsTypeXe5713fd1 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineOutboundPaymentsPaymentMethodDetailsTypeXe5713fd1,
        ) {
