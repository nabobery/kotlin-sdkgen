...
public class PaymentMethodDetailsBacsDebit(
    ...
    public class Builder {
        ...
        public fun build(): PaymentMethodDetailsBacsDebit =
    ...
    public object Serializer : KSerializer<PaymentMethodDetailsBacsDebit> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodDetailsBacsDebit {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodDetailsBacsDebit must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentMethodDetailsBacsDebit,
        ) {
...
public fun paymentMethodDetailsBacsDebit(
    block: PaymentMethodDetailsBacsDebit.Builder.() -> Unit,
): PaymentMethodDetailsBacsDebit = PaymentMethodDetailsBacsDebit.build(block)
