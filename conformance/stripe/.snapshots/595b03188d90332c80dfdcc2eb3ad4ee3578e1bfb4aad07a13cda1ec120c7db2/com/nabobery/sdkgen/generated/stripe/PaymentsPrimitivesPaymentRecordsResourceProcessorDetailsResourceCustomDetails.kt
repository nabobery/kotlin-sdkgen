...
public class PaymentsPrimitivesPaymentRecordsResourceProcessorDetailsResourceCustomDetails(
    ...
    public class Builder {
        ...
        public fun build(): PaymentsPrimitivesPaymentRecordsResourceProcessorDetailsResourceCustomDetails =
    ...
    public object Serializer : KSerializer<PaymentsPrimitivesPaymentRecordsResourceProcessorDetailsResourceCustomDetails> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "PaymentsPrimitivesPaymentRecordsResourceProcessorDetailsResourceCustomDetails must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentsPrimitivesPaymentRecordsResourceProcessorDetailsResourceCustomDetails,
        ) {
            val jsonEncoder =
...
public fun paymentsPrimitivesPaymentRecordsResourceProcessorDetailsResourceCustomDetails(
    block: PaymentsPrimitivesPaymentRecordsResourceProcessorDetailsResourceCustomDetails.Builder.() -> Unit,
): PaymentsPrimitivesPaymentRecordsResourceProcessorDetailsResourceCustomDetails =
    PaymentsPrimitivesPaymentRecordsResourceProcessorDetailsResourceCustomDetails.build(block)
