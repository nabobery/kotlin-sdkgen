...
public class InlineV1CustomersSourcesPostRequestFormX2b7e12c1(
     ...
     */
    public val accountHolderType: InlineV1CustomersSourcesPostRequestFormAccountHolderTypeX0532bd4d? = null,
    /**
    ...
    public class Builder {
        ...
        public fun build(): InlineV1CustomersSourcesPostRequestFormX2b7e12c1 =
            InlineV1CustomersSourcesPostRequestFormX2b7e12c1(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1CustomersSourcesPostRequestFormX2b7e12c1 =
    ...
    public object Serializer : KSerializer<InlineV1CustomersSourcesPostRequestFormX2b7e12c1> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CustomersSourcesPostRequestFormX2b7e12c1 must be a JSON object",
                    )
            return InlineV1CustomersSourcesPostRequestFormX2b7e12c1(
                ...
                accountHolderType =
                    rawObject["account_holder_type"]?.let {
                        json.decodeFromJsonElement<InlineV1CustomersSourcesPostRequestFormAccountHolderTypeX0532bd4d>(
                            it,
                        )
                    },
                ...
                metadata =
                    rawObject["metadata"]?.let {
                        json.decodeFromJsonElement<InlineV1CustomersSourcesPostRequestFormMetadataX22211fb4>(it)
                    },
                name = rawObject["name"]?.let { json.decodeFromJsonElement<String>(it) },
                owner =
                    rawObject["owner"]?.let {
                        json.decodeFromJsonElement<InlineV1CustomersSourcesPostRequestFormOwnerX0cd7fbf8>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersSourcesPostRequestFormX2b7e12c1,
        ) {
...
public fun inlineV1CustomersSourcesPostRequestFormX2b7e12c1(
    block: InlineV1CustomersSourcesPostRequestFormX2b7e12c1.Builder.() -> Unit,
): InlineV1CustomersSourcesPostRequestFormX2b7e12c1 = InlineV1CustomersSourcesPostRequestFormX2b7e12c1.build(block)
