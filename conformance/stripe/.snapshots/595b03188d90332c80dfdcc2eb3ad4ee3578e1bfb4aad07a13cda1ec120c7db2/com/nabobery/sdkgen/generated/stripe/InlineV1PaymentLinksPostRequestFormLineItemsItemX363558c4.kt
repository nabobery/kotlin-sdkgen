...
public class InlineV1PaymentLinksPostRequestFormLineItemsItemX363558c4(
    ...
    public val adjustableQuantity: InlineV1PaymentLinksPostRequestFormLineItemsItemAdjustableQuantityX54c231e1? = null,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PaymentLinksPostRequestFormLineItemsItemX363558c4 =
    ...
    public object Serializer : KSerializer<InlineV1PaymentLinksPostRequestFormLineItemsItemX363558c4> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentLinksPostRequestFormLineItemsItemX363558c4 must be a JSON object",
                    )
            ...
            return InlineV1PaymentLinksPostRequestFormLineItemsItemX363558c4(
                ...
                adjustableQuantity =
                    rawObject["adjustable_quantity"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormLineItemsItemAdjustableQuantityX54c231e1>(
                                it,
                            )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentLinksPostRequestFormLineItemsItemX363558c4,
        ) {
...
public fun inlineV1PaymentLinksPostRequestFormLineItemsItemX363558c4(
    block: InlineV1PaymentLinksPostRequestFormLineItemsItemX363558c4.Builder.() -> Unit,
): InlineV1PaymentLinksPostRequestFormLineItemsItemX363558c4 =
    InlineV1PaymentLinksPostRequestFormLineItemsItemX363558c4.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentLinksPostRequestFormLineItemsItemX363558c4 is missing required property '" + name + "'",
            )
