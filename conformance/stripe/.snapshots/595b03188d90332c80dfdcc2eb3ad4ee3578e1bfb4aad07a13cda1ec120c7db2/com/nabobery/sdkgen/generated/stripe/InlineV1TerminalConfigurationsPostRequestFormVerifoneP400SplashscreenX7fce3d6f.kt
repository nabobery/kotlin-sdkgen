...
internal data class InlineV1TerminalConfigurationsPostRequestFormVerifoneP400SplashscreenX7fce3d6fInspection(
    ...
    public val matchesInlineV1TerminalConfigurationsPostRequestFormVerifoneP400AnyOf1AnyOf2X65697ce9: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1TerminalConfigurationsPostRequestFormVerifoneP400AnyOf1AnyOf2X65697ce9,
            ).count {
                it
            }
}
...
public class InlineV1TerminalConfigurationsPostRequestFormVerifoneP400SplashscreenX7fce3d6f internal constructor(
    ...
    private val inspection: InlineV1TerminalConfigurationsPostRequestFormVerifoneP400SplashscreenX7fce3d6fInspection,
) {
    ...
    public val inlineV1TerminalConfigurationsPostRequestFormVerifoneP400AnyOf1AnyOf2X65697ce9:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1TerminalConfigurationsPostRequestFormVerifoneP400AnyOf1AnyOf2X65697ce9) {
                json
                    .decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormVerifoneP400AnyOf1AnyOf2X65697ce9>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1TerminalConfigurationsPostRequestFormVerifoneP400SplashscreenX7fce3d6fBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1TerminalConfigurationsPostRequestFormVerifoneP400AnyOf1AnyOf2X65697ce9) {
                    add(
                        InlineV1TerminalConfigurationsPostRequestFormVerifoneP400SplashscreenX7fce3d6fBranch.InlineV1TerminalConfigurationsPostRequestFormVerifoneP400AnyOf1AnyOf2X65697ce9,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1TerminalConfigurationsPostRequestFormVerifoneP400SplashscreenX7fce3d6f {
            val inspection = inspectInlineV1TerminalConfigurationsPostRequestFormVerifoneP400SplashscreenX7fce3d6f(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1TerminalConfigurationsPostRequestFormVerifoneP400SplashscreenX7fce3d6fNoMatchException(
                    "InlineV1TerminalConfigurationsPostRequestFormVerifoneP400SplashscreenX7fce3d6f matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1TerminalConfigurationsPostRequestFormVerifoneP400SplashscreenX7fce3d6f> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TerminalConfigurationsPostRequestFormVerifoneP400SplashscreenX7fce3d6f,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1TerminalConfigurationsPostRequestFormVerifoneP400SplashscreenX7fce3d6f",
...
private fun inspectInlineV1TerminalConfigurationsPostRequestFormVerifoneP400SplashscreenX7fce3d6f(
    element: JsonElement,
): InlineV1TerminalConfigurationsPostRequestFormVerifoneP400SplashscreenX7fce3d6fInspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1TerminalConfigurationsPostRequestFormVerifoneP400AnyOf1AnyOf2X65697ce9 =
        element
            .isJsonDecodable<InlineV1TerminalConfigurationsPostRequestFormVerifoneP400AnyOf1AnyOf2X65697ce9>()
    return InlineV1TerminalConfigurationsPostRequestFormVerifoneP400SplashscreenX7fce3d6fInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1TerminalConfigurationsPostRequestFormVerifoneP400AnyOf1AnyOf2X65697ce9) {
                    add(
                        "InlineV1TerminalConfigurationsPostRequestFormVerifoneP400AnyOf1AnyOf2X65697ce9: value does not match InlineV1TerminalConfigurationsPostRequestFormVerifoneP400AnyOf1AnyOf2X65697ce9",
                    )
                }
            },
    )
