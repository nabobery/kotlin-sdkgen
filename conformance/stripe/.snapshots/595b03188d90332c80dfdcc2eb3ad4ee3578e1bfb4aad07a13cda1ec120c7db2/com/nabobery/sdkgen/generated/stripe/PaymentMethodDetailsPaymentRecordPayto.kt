...
public class PaymentMethodDetailsPaymentRecordPayto(
    ...
    public class Builder {
        ...
        public fun build(): PaymentMethodDetailsPaymentRecordPayto =
            PaymentMethodDetailsPaymentRecordPayto(
                bsbNumber = bsbNumber,
                last4 = last4,
                mandate = mandate,
                payId = payId,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentMethodDetailsPaymentRecordPayto =
    ...
    public object Serializer : KSerializer<PaymentMethodDetailsPaymentRecordPayto> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodDetailsPaymentRecordPayto {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodDetailsPaymentRecordPayto must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentMethodDetailsPaymentRecordPayto,
        ) {
...
public fun paymentMethodDetailsPaymentRecordPayto(
    block: PaymentMethodDetailsPaymentRecordPayto.Builder.() -> Unit,
): PaymentMethodDetailsPaymentRecordPayto = PaymentMethodDetailsPaymentRecordPayto.build(block)
