...
public sealed class InlineV1InvoicesRemoveLinesPostRequestFormLinesItemBehaviorX8288b839 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1InvoicesRemoveLinesPostRequestFormLinesItemBehaviorX8288b839 =
            when (value) {
                Delete.value -> Delete
    ...
    public object Serializer : KSerializer<InlineV1InvoicesRemoveLinesPostRequestFormLinesItemBehaviorX8288b839> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1InvoicesRemoveLinesPostRequestFormLinesItemBehaviorX8288b839",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1InvoicesRemoveLinesPostRequestFormLinesItemBehaviorX8288b839 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesRemoveLinesPostRequestFormLinesItemBehaviorX8288b839,
        ) {
