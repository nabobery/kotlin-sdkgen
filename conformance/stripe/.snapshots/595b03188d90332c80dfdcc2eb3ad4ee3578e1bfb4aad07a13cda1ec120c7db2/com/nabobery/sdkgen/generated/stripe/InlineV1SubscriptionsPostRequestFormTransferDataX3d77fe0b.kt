...
public class InlineV1SubscriptionsPostRequestFormTransferDataX3d77fe0b(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1SubscriptionsPostRequestFormTransferDataX3d77fe0b =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1SubscriptionsPostRequestFormTransferDataX3d77fe0b> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SubscriptionsPostRequestFormTransferDataX3d77fe0b must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsPostRequestFormTransferDataX3d77fe0b,
        ) {
...
public fun inlineV1SubscriptionsPostRequestFormTransferDataX3d77fe0b(
    block: InlineV1SubscriptionsPostRequestFormTransferDataX3d77fe0b.Builder.() -> Unit,
): InlineV1SubscriptionsPostRequestFormTransferDataX3d77fe0b =
    InlineV1SubscriptionsPostRequestFormTransferDataX3d77fe0b.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1SubscriptionsPostRequestFormTransferDataX3d77fe0b is missing required property '" + name + "'",
            )
