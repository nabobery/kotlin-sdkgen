...
public sealed class InlinePaymentIntentPaymentMethodOptionsEpsSetupFutureUsageX0a44f328 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentIntentPaymentMethodOptionsEpsSetupFutureUsageX0a44f328 =
            when (value) {
                None.value -> None
    ...
    public object Serializer : KSerializer<InlinePaymentIntentPaymentMethodOptionsEpsSetupFutureUsageX0a44f328> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentIntentPaymentMethodOptionsEpsSetupFutureUsageX0a44f328",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlinePaymentIntentPaymentMethodOptionsEpsSetupFutureUsageX0a44f328 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentIntentPaymentMethodOptionsEpsSetupFutureUsageX0a44f328,
        ) {
