...
public sealed class InlineV1PaymentIntentsPostRequestFormPreferredLanguageX457537b9 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1PaymentIntentsPostRequestFormPreferredLanguageX457537b9 =
            when (value) {
                De.value -> De
                En.value -> En
                Fr.value -> Fr
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormPreferredLanguageX457537b9> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1PaymentIntentsPostRequestFormPreferredLanguageX457537b9",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1PaymentIntentsPostRequestFormPreferredLanguageX457537b9 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormPreferredLanguageX457537b9,
        ) {
