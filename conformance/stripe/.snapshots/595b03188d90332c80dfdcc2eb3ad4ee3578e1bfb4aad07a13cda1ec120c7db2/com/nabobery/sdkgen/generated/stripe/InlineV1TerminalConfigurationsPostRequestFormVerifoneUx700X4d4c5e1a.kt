...
public class InlineV1TerminalConfigurationsPostRequestFormVerifoneUx700X4d4c5e1a(
    public val splashscreen: InlineV1TerminalConfigurationsPostRequestFormVerifoneUx700SplashscreenX78f1caad? = null,
) {
    public class Builder {
        public var splashscreen:
            InlineV1TerminalConfigurationsPostRequestFormVerifoneUx700SplashscreenX78f1caad? = null

        public fun build(): InlineV1TerminalConfigurationsPostRequestFormVerifoneUx700X4d4c5e1a =
            InlineV1TerminalConfigurationsPostRequestFormVerifoneUx700X4d4c5e1a(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1TerminalConfigurationsPostRequestFormVerifoneUx700X4d4c5e1a = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TerminalConfigurationsPostRequestFormVerifoneUx700X4d4c5e1a> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TerminalConfigurationsPostRequestFormVerifoneUx700X4d4c5e1a must be a JSON object",
                    )
            return InlineV1TerminalConfigurationsPostRequestFormVerifoneUx700X4d4c5e1a(
                splashscreen =
                    rawObject["splashscreen"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormVerifoneUx700SplashscreenX78f1caad>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TerminalConfigurationsPostRequestFormVerifoneUx700X4d4c5e1a,
        ) {
            val jsonEncoder =
...
public fun inlineV1TerminalConfigurationsPostRequestFormVerifoneUx700X4d4c5e1a(
    block: InlineV1TerminalConfigurationsPostRequestFormVerifoneUx700X4d4c5e1a.Builder.() -> Unit,
): InlineV1TerminalConfigurationsPostRequestFormVerifoneUx700X4d4c5e1a =
