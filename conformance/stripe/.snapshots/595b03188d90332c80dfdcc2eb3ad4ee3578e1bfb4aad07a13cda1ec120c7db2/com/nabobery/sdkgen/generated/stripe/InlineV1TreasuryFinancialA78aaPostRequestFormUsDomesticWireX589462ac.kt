...
public class InlineV1TreasuryFinancialA78aaPostRequestFormUsDomesticWireX589462ac(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1TreasuryFinancialA78aaPostRequestFormUsDomesticWireX589462ac = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1TreasuryFinancialA78aaPostRequestFormUsDomesticWireX589462ac> {
        ...
        override fun deserialize(
            decoder: Decoder,
        ): InlineV1TreasuryFinancialA78aaPostRequestFormUsDomesticWireX589462ac {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TreasuryFinancialA78aaPostRequestFormUsDomesticWireX589462ac must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TreasuryFinancialA78aaPostRequestFormUsDomesticWireX589462ac,
        ) {
            val jsonEncoder =
...
public fun inlineV1TreasuryFinancialA78aaPostRequestFormUsDomesticWireX589462ac(
    block: InlineV1TreasuryFinancialA78aaPostRequestFormUsDomesticWireX589462ac.Builder.() -> Unit,
): InlineV1TreasuryFinancialA78aaPostRequestFormUsDomesticWireX589462ac =
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TreasuryFinancialA78aaPostRequestFormUsDomesticWireX589462ac is missing required property '" +
                    name +
                    "'",
            )
