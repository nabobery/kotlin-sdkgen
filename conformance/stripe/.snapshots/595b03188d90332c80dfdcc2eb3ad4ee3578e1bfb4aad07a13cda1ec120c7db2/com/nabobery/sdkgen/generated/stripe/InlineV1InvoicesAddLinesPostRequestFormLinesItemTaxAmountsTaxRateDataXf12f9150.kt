...
public class InlineV1InvoicesAddLinesPostRequestFormLinesItemTaxAmountsTaxRateDataXf12f9150(
    ...
    public val jurisdictionLevel: InlineV1InvoicesAddLinesPostRequestFormLinesItemJurisdictionLevelXa21e5c49? = null,
    public val state: String? = null,
    public val taxType: InlineV1InvoicesAddLinesPostRequestFormLinesItemTaxAmountsAnyOf1TaxTypeX769efb47? = null,
) {
    ...
    public object Serializer : KSerializer<InlineV1InvoicesAddLinesPostRequestFormLinesItemTaxAmountsTaxRateDataXf12f9150> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1InvoicesAddLinesPostRequestFormLinesItemTaxAmountsTaxRateDataXf12f9150 must be a JSON object",
                    )
            ...
            return InlineV1InvoicesAddLinesPostRequestFormLinesItemTaxAmountsTaxRateDataXf12f9150(
                ...
                jurisdictionLevel =
                    rawObject["jurisdiction_level"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1InvoicesAddLinesPostRequestFormLinesItemJurisdictionLevelXa21e5c49>(
                                it,
                            )
                    },
                ...
                taxType =
                    rawObject["tax_type"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1InvoicesAddLinesPostRequestFormLinesItemTaxAmountsAnyOf1TaxTypeX769efb47>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesAddLinesPostRequestFormLinesItemTaxAmountsTaxRateDataXf12f9150,
        ) {
            val jsonEncoder =
...
public fun inlineV1InvoicesAddLinesPostRequestFormLinesItemTaxAmountsTaxRateDataXf12f9150(
    block: InlineV1InvoicesAddLinesPostRequestFormLinesItemTaxAmountsTaxRateDataXf12f9150.Builder.() -> Unit,
): InlineV1InvoicesAddLinesPostRequestFormLinesItemTaxAmountsTaxRateDataXf12f9150 =
    InlineV1InvoicesAddLinesPostRequestFormLinesItemTaxAmountsTaxRateDataXf12f9150.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1InvoicesAddLinesPostRequestFormLinesItemTaxAmountsTaxRateDataXf12f9150 is missing required property '" +
                    name +
                    "'",
            )
