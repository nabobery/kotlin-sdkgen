...
public class PaymentMethodDetailsPaymentRecordAcssDebit(
    ...
    public class Builder {
        ...
        public fun build(): PaymentMethodDetailsPaymentRecordAcssDebit =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentMethodDetailsPaymentRecordAcssDebit =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentMethodDetailsPaymentRecordAcssDebit> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodDetailsPaymentRecordAcssDebit {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodDetailsPaymentRecordAcssDebit must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentMethodDetailsPaymentRecordAcssDebit,
        ) {
...
public fun paymentMethodDetailsPaymentRecordAcssDebit(
    block: PaymentMethodDetailsPaymentRecordAcssDebit.Builder.() -> Unit,
): PaymentMethodDetailsPaymentRecordAcssDebit = PaymentMethodDetailsPaymentRecordAcssDebit.build(block)
