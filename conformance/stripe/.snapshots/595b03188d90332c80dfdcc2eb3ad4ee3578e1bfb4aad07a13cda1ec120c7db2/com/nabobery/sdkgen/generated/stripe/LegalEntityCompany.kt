...
public class LegalEntityCompany(
     ...
     */
    public val directorshipDeclaration: InlineLegalEntityCompanyDirectorshipDeclarationX2b6baa8f? = null,
    /**
     ...
     * details.
     */
    public val ownershipExemptionReason: InlineLegalEntityCompanyOwnershipExemptionReasonXfabbe628? = null,
    /**
     ...
     * entity.
     */
    public val representativeDeclaration: InlineLegalEntityCompanyRepresentativeDeclarationXb8056469? = null,
    /**
    ...
    public class Builder {
        ...
        public fun build(): LegalEntityCompany =
            LegalEntityCompany(
                address = address,
    ...
    public object Serializer : KSerializer<LegalEntityCompany> {
        ...
        override fun deserialize(decoder: Decoder): LegalEntityCompany {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("LegalEntityCompany must be a JSON object")
            return LegalEntityCompany(
                address = rawObject["address"]?.let { json.decodeFromJsonElement<Address>(it) },
                addressKana =
                    rawObject["address_kana"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineLegalEntityCompanyAddressKanaX7ebf9838?>(element)
                        }
                    },
                addressKanji =
                    rawObject["address_kanji"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineLegalEntityCompanyAddressKanjiX8e147090?>(element)
                        }
                    },
                directorsProvided = rawObject["directors_provided"]?.let { json.decodeFromJsonElement<Boolean>(it) },
                directorshipDeclaration =
                    rawObject["directorship_declaration"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineLegalEntityCompanyDirectorshipDeclarationX2b6baa8f?>(
                                element,
                            )
                        }
                    },
                ...
                nameKana =
                    rawObject["name_kana"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                nameKanji =
                    rawObject["name_kanji"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                ownershipDeclaration =
                    rawObject["ownership_declaration"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineLegalEntityCompanyOwnershipDeclarationXa6540302?>(element)
                        }
                    },
                ownershipExemptionReason =
                    rawObject["ownership_exemption_reason"]?.let {
                        json.decodeFromJsonElement<InlineLegalEntityCompanyOwnershipExemptionReasonXfabbe628>(it)
                    },
                phone =
                ...
                registrationDate =
                    rawObject["registration_date"]?.let {
                        json
                            .decodeFromJsonElement<LegalEntityRegistrationDate>(
                                it,
                            )
                    },
                representativeDeclaration =
                    rawObject["representative_declaration"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineLegalEntityCompanyRepresentativeDeclarationXb8056469?>(
                                element,
                            )
                        }
                    },
                structure =
                    rawObject["structure"]?.let {
                        json
                            .decodeFromJsonElement<InlineLegalEntityCompanyStructureX496bc498>(
                                it,
                            )
                    },
                ...
                verification =
                    rawObject["verification"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineLegalEntityCompanyVerificationX01f25840?>(element)
                        }
                    },
            )
        }
...
public fun legalEntityCompany(block: LegalEntityCompany.Builder.() -> Unit): LegalEntityCompany =
    LegalEntityCompany.build(block)
