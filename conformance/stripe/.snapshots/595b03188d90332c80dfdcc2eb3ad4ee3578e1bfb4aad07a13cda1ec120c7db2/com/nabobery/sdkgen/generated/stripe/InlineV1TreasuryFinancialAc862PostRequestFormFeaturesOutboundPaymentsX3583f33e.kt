...
public class InlineV1TreasuryFinancialAc862PostRequestFormFeaturesOutboundPaymentsX3583f33e(
    ...
    public val usDomesticWire: InlineV1TreasuryFinancialAc862PostRequestFormFeaturesUsDomesticWireX70828828? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1TreasuryFinancialAc862PostRequestFormFeaturesOutboundPaymentsX3583f33e =
            InlineV1TreasuryFinancialAc862PostRequestFormFeaturesOutboundPaymentsX3583f33e(
                ach = ach,
    ...
    public object Serializer : KSerializer<InlineV1TreasuryFinancialAc862PostRequestFormFeaturesOutboundPaymentsX3583f33e> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TreasuryFinancialAc862PostRequestFormFeaturesOutboundPaymentsX3583f33e must be a JSON object",
                    )
            return InlineV1TreasuryFinancialAc862PostRequestFormFeaturesOutboundPaymentsX3583f33e(
                ach =
                    rawObject["ach"]?.let {
                        json.decodeFromJsonElement<InlineV1TreasuryFinancialAc862PostRequestFormFeaturesAchXecbeab69>(
                            it,
                        )
                    },
                usDomesticWire =
                    rawObject["us_domestic_wire"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TreasuryFinancialAc862PostRequestFormFeaturesUsDomesticWireX70828828>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TreasuryFinancialAc862PostRequestFormFeaturesOutboundPaymentsX3583f33e,
        ) {
            val jsonEncoder =
...
public fun inlineV1TreasuryFinancialAc862PostRequestFormFeaturesOutboundPaymentsX3583f33e(
    block: InlineV1TreasuryFinancialAc862PostRequestFormFeaturesOutboundPaymentsX3583f33e.Builder.() -> Unit,
): InlineV1TreasuryFinancialAc862PostRequestFormFeaturesOutboundPaymentsX3583f33e =
    InlineV1TreasuryFinancialAc862PostRequestFormFeaturesOutboundPaymentsX3583f33e.build(block)
