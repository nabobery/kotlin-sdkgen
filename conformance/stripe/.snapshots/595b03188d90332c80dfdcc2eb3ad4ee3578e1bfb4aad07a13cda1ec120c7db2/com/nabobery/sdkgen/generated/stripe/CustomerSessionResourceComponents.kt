...
public class CustomerSessionResourceComponents(
    ...
    public object Serializer : KSerializer<CustomerSessionResourceComponents> {
        ...
        override fun deserialize(decoder: Decoder): CustomerSessionResourceComponents {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("CustomerSessionResourceComponents must be a JSON object")
            val buyButton =
                json.decodeRequired<CustomerSessionResourceComponentsResourceBuyButton>(
                    rawObject,
                    "buy_button",
                )
            val customerSheet =
                json.decodeRequired<CustomerSessionResourceComponentsResourceCustomerSheet>(
                    rawObject,
                    "customer_sheet",
                )
            val mobilePaymentElement =
                json.decodeRequired<CustomerSessionResourceComponentsResourceMobilePaymentElement>(
                    rawObject,
                    "mobile_payment_element",
                )
            val paymentElement =
                json.decodeRequired<CustomerSessionResourceComponentsResourcePaymentElement>(
                    rawObject,
                    "payment_element",
                )
            val pricingTable =
                json.decodeRequired<CustomerSessionResourceComponentsResourcePricingTable>(
                    rawObject,
                    "pricing_table",
                )
            return CustomerSessionResourceComponents(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: CustomerSessionResourceComponents,
        ) {
...
public fun customerSessionResourceComponents(
    block: CustomerSessionResourceComponents.Builder.() -> Unit,
): CustomerSessionResourceComponents = CustomerSessionResourceComponents.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "CustomerSessionResourceComponents is missing required property '" + name + "'",
            )
