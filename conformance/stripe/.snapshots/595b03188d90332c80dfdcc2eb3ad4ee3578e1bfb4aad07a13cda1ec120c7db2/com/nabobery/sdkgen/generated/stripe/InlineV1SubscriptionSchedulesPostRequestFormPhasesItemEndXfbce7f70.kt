...
public class InlineV1SubscriptionSchedulesPostRequestFormPhasesItemEndXfbce7f70(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1SubscriptionSchedulesPostRequestFormPhasesItemEndXfbce7f70 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemEndXfbce7f70> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SubscriptionSchedulesPostRequestFormPhasesItemEndXfbce7f70 must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemTypeX716fa27f>(
                    rawObject,
                    "type",
                )
            return InlineV1SubscriptionSchedulesPostRequestFormPhasesItemEndXfbce7f70(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionSchedulesPostRequestFormPhasesItemEndXfbce7f70,
        ) {
            val jsonEncoder =
...
public fun inlineV1SubscriptionSchedulesPostRequestFormPhasesItemEndXfbce7f70(
    block: InlineV1SubscriptionSchedulesPostRequestFormPhasesItemEndXfbce7f70.Builder.() -> Unit,
): InlineV1SubscriptionSchedulesPostRequestFormPhasesItemEndXfbce7f70 =
    InlineV1SubscriptionSchedulesPostRequestFormPhasesItemEndXfbce7f70.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1SubscriptionSchedulesPostRequestFormPhasesItemEndXfbce7f70 is missing required property '" +
                    name +
                    "'",
            )
