...
public sealed class InlineV1CustomersPostRequestFormMetadataAnyOf2X129f5b1e {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1CustomersPostRequestFormMetadataAnyOf2X129f5b1e =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1CustomersPostRequestFormMetadataAnyOf2X129f5b1e> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1CustomersPostRequestFormMetadataAnyOf2X129f5b1e",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1CustomersPostRequestFormMetadataAnyOf2X129f5b1e =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersPostRequestFormMetadataAnyOf2X129f5b1e,
        ) {
