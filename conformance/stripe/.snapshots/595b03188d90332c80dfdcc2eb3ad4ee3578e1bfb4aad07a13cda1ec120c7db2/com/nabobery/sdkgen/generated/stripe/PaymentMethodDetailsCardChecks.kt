...
public class PaymentMethodDetailsCardChecks(
    ...
    public class Builder {
        ...
        public fun build(): PaymentMethodDetailsCardChecks =
    ...
    public object Serializer : KSerializer<PaymentMethodDetailsCardChecks> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodDetailsCardChecks {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodDetailsCardChecks must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentMethodDetailsCardChecks,
        ) {
...
public fun paymentMethodDetailsCardChecks(
    block: PaymentMethodDetailsCardChecks.Builder.() -> Unit,
): PaymentMethodDetailsCardChecks = PaymentMethodDetailsCardChecks.build(block)
