...
public sealed class InlineSetupIntentPaymentMethodOptionsAcssDebitVerificationMethodXfec0c5e7 {
    ...
    public object Serializer : KSerializer<InlineSetupIntentPaymentMethodOptionsAcssDebitVerificationMethodXfec0c5e7> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineSetupIntentPaymentMethodOptionsAcssDebitVerificationMethodXfec0c5e7",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineSetupIntentPaymentMethodOptionsAcssDebitVerificationMethodXfec0c5e7 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineSetupIntentPaymentMethodOptionsAcssDebitVerificationMethodXfec0c5e7,
        ) {
