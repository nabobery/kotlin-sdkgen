...
public class ConfirmationTokensResourceMandateDataResourceCustomerAcceptanceResourceOnline(
    ...
    public class Builder {
        ...
        public fun build(): ConfirmationTokensResourceMandateDataResourceCustomerAcceptanceResourceOnline =
    ...
    public object Serializer : KSerializer<ConfirmationTokensResourceMandateDataResourceCustomerAcceptanceResourceOnline> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "ConfirmationTokensResourceMandateDataResourceCustomerAcceptanceResourceOnline must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: ConfirmationTokensResourceMandateDataResourceCustomerAcceptanceResourceOnline,
        ) {
            val jsonEncoder =
...
public fun confirmationTokensResourceMandateDataResourceCustomerAcceptanceResourceOnline(
    block: ConfirmationTokensResourceMandateDataResourceCustomerAcceptanceResourceOnline.Builder.() -> Unit,
): ConfirmationTokensResourceMandateDataResourceCustomerAcceptanceResourceOnline =
    ConfirmationTokensResourceMandateDataResourceCustomerAcceptanceResourceOnline.build(block)
