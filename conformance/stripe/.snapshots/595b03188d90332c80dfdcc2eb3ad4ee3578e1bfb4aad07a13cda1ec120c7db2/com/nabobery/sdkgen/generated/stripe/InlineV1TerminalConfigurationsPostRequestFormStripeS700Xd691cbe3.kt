...
internal data class InlineV1TerminalConfigurationsPostRequestFormStripeS700Xd691cbe3Inspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesInlineV1TerminalConfigurationsPostRequestFormStripeS700AnyOf1Xd8b7a966,
                matchesInlineV1TerminalConfigurationsPostRequestFormStripeS700AnyOf2X82c9c431,
            ).count {
                it
            }
}
...
public class InlineV1TerminalConfigurationsPostRequestFormStripeS700Xd691cbe3 internal constructor(
    ...
    private val inspection: InlineV1TerminalConfigurationsPostRequestFormStripeS700Xd691cbe3Inspection,
) {
    public val inlineV1TerminalConfigurationsPostRequestFormStripeS700AnyOf1Xd8b7a966:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1TerminalConfigurationsPostRequestFormStripeS700AnyOf1Xd8b7a966) {
                json
                    .decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormStripeS700AnyOf1Xd8b7a966>(
                        raw,
                    )
            } else {
                null
    ...
    public val inlineV1TerminalConfigurationsPostRequestFormStripeS700AnyOf2X82c9c431:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1TerminalConfigurationsPostRequestFormStripeS700AnyOf2X82c9c431) {
                json
                    .decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormStripeS700AnyOf2X82c9c431>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches:
        ...
        get() =
            buildSet {
                if (inspection.matchesInlineV1TerminalConfigurationsPostRequestFormStripeS700AnyOf1Xd8b7a966) {
                    add(
                        InlineV1TerminalConfigurationsPostRequestFormStripeS700Xd691cbe3Branch.InlineV1TerminalConfigurationsPostRequestFormStripeS700AnyOf1Xd8b7a966,
                    )
                }
                if (inspection.matchesInlineV1TerminalConfigurationsPostRequestFormStripeS700AnyOf2X82c9c431) {
                    add(
                        InlineV1TerminalConfigurationsPostRequestFormStripeS700Xd691cbe3Branch.InlineV1TerminalConfigurationsPostRequestFormStripeS700AnyOf2X82c9c431,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1TerminalConfigurationsPostRequestFormStripeS700Xd691cbe3 {
            val inspection = inspectInlineV1TerminalConfigurationsPostRequestFormStripeS700Xd691cbe3(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1TerminalConfigurationsPostRequestFormStripeS700Xd691cbe3NoMatchException(
                    "InlineV1TerminalConfigurationsPostRequestFormStripeS700Xd691cbe3 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1TerminalConfigurationsPostRequestFormStripeS700Xd691cbe3> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TerminalConfigurationsPostRequestFormStripeS700Xd691cbe3,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1TerminalConfigurationsPostRequestFormStripeS700Xd691cbe3",
...
private fun inspectInlineV1TerminalConfigurationsPostRequestFormStripeS700Xd691cbe3(
    element: JsonElement,
): InlineV1TerminalConfigurationsPostRequestFormStripeS700Xd691cbe3Inspection {
    val matchesInlineV1TerminalConfigurationsPostRequestFormStripeS700AnyOf1Xd8b7a966 =
        element
            .isJsonDecodable<InlineV1TerminalConfigurationsPostRequestFormStripeS700AnyOf1Xd8b7a966>()
    val matchesInlineV1TerminalConfigurationsPostRequestFormStripeS700AnyOf2X82c9c431 =
        element
            .isJsonDecodable<InlineV1TerminalConfigurationsPostRequestFormStripeS700AnyOf2X82c9c431>()
    return InlineV1TerminalConfigurationsPostRequestFormStripeS700Xd691cbe3Inspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1TerminalConfigurationsPostRequestFormStripeS700AnyOf1Xd8b7a966) {
                    add(
                        "InlineV1TerminalConfigurationsPostRequestFormStripeS700AnyOf1Xd8b7a966: value does not match InlineV1TerminalConfigurationsPostRequestFormStripeS700AnyOf1Xd8b7a966",
                    )
                }
                if (!matchesInlineV1TerminalConfigurationsPostRequestFormStripeS700AnyOf2X82c9c431) {
                    add(
                        "InlineV1TerminalConfigurationsPostRequestFormStripeS700AnyOf2X82c9c431: value does not match InlineV1TerminalConfigurationsPostRequestFormStripeS700AnyOf2X82c9c431",
                    )
                }
            },
    )
