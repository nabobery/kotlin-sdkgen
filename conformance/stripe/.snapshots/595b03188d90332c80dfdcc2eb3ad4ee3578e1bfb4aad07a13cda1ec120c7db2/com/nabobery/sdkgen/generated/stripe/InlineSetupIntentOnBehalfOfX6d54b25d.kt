...
public class InlineSetupIntentOnBehalfOfX6d54b25d internal constructor(
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineSetupIntentOnBehalfOfX6d54b25d {
            val inspection = inspectInlineSetupIntentOnBehalfOfX6d54b25d(raw)
            if (inspection.matchCount == 0) {
                throw InlineSetupIntentOnBehalfOfX6d54b25dNoMatchException(
                    "InlineSetupIntentOnBehalfOfX6d54b25d matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineSetupIntentOnBehalfOfX6d54b25d> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineSetupIntentOnBehalfOfX6d54b25d,
        ) {
...
private fun inspectInlineSetupIntentOnBehalfOfX6d54b25d(
    element: JsonElement,
): InlineSetupIntentOnBehalfOfX6d54b25dInspection {
