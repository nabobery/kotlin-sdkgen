...
public class BankConnectionsResourceBalanceApiResourceCreditBalance(
     ...
     */
    public val used: Map<String, Int>? = null,
) {
    public class Builder {
         ...
         * indicates money owed by the account holder.
         */
        public var used: Map<String, Int>? = null

        public fun build(): BankConnectionsResourceBalanceApiResourceCreditBalance =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): BankConnectionsResourceBalanceApiResourceCreditBalance =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<BankConnectionsResourceBalanceApiResourceCreditBalance> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "BankConnectionsResourceBalanceApiResourceCreditBalance must be a JSON object",
                    )
            return BankConnectionsResourceBalanceApiResourceCreditBalance(
                used =
                    rawObject["used"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: BankConnectionsResourceBalanceApiResourceCreditBalance,
        ) {
...
public fun bankConnectionsResourceBalanceApiResourceCreditBalance(
    block: BankConnectionsResourceBalanceApiResourceCreditBalance.Builder.() -> Unit,
): BankConnectionsResourceBalanceApiResourceCreditBalance =
    BankConnectionsResourceBalanceApiResourceCreditBalance.build(block)
