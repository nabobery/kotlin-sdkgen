...
public sealed class InlinePaymentPagesCheckoutSessionConsentCollectionPromotionsX48634417 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentPagesCheckoutSessionConsentCollectionPromotionsX48634417 =
            when (value) {
                Auto.value -> Auto
                None.value -> None
    ...
    public object Serializer : KSerializer<InlinePaymentPagesCheckoutSessionConsentCollectionPromotionsX48634417> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentPagesCheckoutSessionConsentCollectionPromotionsX48634417",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlinePaymentPagesCheckoutSessionConsentCollectionPromotionsX48634417 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentPagesCheckoutSessionConsentCollectionPromotionsX48634417,
        ) {
