...
public sealed class InlineV1TaxCalculationsPostRequestFormShippingCostTaxBehaviorX0846c4d6 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1TaxCalculationsPostRequestFormShippingCostTaxBehaviorX0846c4d6 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1TaxCalculationsPostRequestFormShippingCostTaxBehaviorX0846c4d6> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1TaxCalculationsPostRequestFormShippingCostTaxBehaviorX0846c4d6",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1TaxCalculationsPostRequestFormShippingCostTaxBehaviorX0846c4d6 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TaxCalculationsPostRequestFormShippingCostTaxBehaviorX0846c4d6,
        ) {
