...
public class PaymentMethodOptionsKonbini(
    ...
    public class Builder {
        ...
        public fun build(): PaymentMethodOptionsKonbini =
    ...
    public object Serializer : KSerializer<PaymentMethodOptionsKonbini> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodOptionsKonbini {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodOptionsKonbini must be a JSON object")
            return PaymentMethodOptionsKonbini(
                confirmationNumber =
                    rawObject["confirmation_number"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                setupFutureUsage =
                    rawObject["setup_future_usage"]?.let {
                        json.decodeFromJsonElement<InlinePaymentMethodOptionsKonbiniSetupFutureUsageXf37dd975>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentMethodOptionsKonbini,
        ) {
...
public fun paymentMethodOptionsKonbini(
    block: PaymentMethodOptionsKonbini.Builder.() -> Unit,
): PaymentMethodOptionsKonbini = PaymentMethodOptionsKonbini.build(block)
