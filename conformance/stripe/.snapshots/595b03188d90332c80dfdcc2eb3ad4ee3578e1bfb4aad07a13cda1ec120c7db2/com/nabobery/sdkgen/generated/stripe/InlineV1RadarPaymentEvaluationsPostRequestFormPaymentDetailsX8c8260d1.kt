...
public class InlineV1RadarPaymentEvaluationsPostRequestFormPaymentDetailsX8c8260d1(
    ...
    public val paymentMethodDetails: InlineV1RadarPaymentEvaluacd5dPostRequestFormPaymentMethodDetailsX2dfa835f,
    public val description: String? = null,
    public val moneyMovementDetails: InlineV1RadarPaymentEvaluacd5dPostRequestFormMoneyMovementDetailsX1bb0eda7? = null,
    public val shippingDetails: InlineV1RadarPaymentEvaluacd5dPostRequestFormShippingDetailsX154c0693? = null,
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1RadarPaymentEvaluationsPostRequestFormPaymentDetailsX8c8260d1 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1RadarPaymentEvaluationsPostRequestFormPaymentDetailsX8c8260d1> {
        override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1RadarPaymentEvaluationsPostRequestFormPaymentDetailsX8c8260d1 {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1RadarPaymentEvaluationsPostRequestFormPaymentDetailsX8c8260d1 must be a JSON object",
                    )
            val amount = json.decodeRequired<Int>(rawObject, "amount")
            val currency = json.decodeRequired<String>(rawObject, "currency")
            val paymentMethodDetails =
                json
                    .decodeRequired<InlineV1RadarPaymentEvaluacd5dPostRequestFormPaymentMethodDetailsX2dfa835f>(
                        rawObject,
            ...
            return InlineV1RadarPaymentEvaluationsPostRequestFormPaymentDetailsX8c8260d1(
                ...
                moneyMovementDetails =
                    rawObject["money_movement_details"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1RadarPaymentEvaluacd5dPostRequestFormMoneyMovementDetailsX1bb0eda7>(
                                it,
                            )
                    },
                shippingDetails =
                    rawObject["shipping_details"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1RadarPaymentEvaluacd5dPostRequestFormShippingDetailsX154c0693>(
                                it,
                            )
                    },
                statementDescriptor =
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1RadarPaymentEvaluationsPostRequestFormPaymentDetailsX8c8260d1,
        ) {
            val jsonEncoder =
...
public fun inlineV1RadarPaymentEvaluationsPostRequestFormPaymentDetailsX8c8260d1(
    block: InlineV1RadarPaymentEvaluationsPostRequestFormPaymentDetailsX8c8260d1.Builder.() -> Unit,
): InlineV1RadarPaymentEvaluationsPostRequestFormPaymentDetailsX8c8260d1 =
    InlineV1RadarPaymentEvaluationsPostRequestFormPaymentDetailsX8c8260d1.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1RadarPaymentEvaluationsPostRequestFormPaymentDetailsX8c8260d1 is missing required property '" +
                    name +
                    "'",
            )
