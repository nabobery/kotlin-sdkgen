...
@Serializable
public data class PromotionCodeView(
        ...
        override fun deserialize(decoder: Decoder): PromotionCode {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PromotionCode must be a JSON object")
                ...
                customer =
                    rawObject["customer"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePromotionCodeCustomerX64b32b82?>(element)
                        }
                    },
                customerAccount =
