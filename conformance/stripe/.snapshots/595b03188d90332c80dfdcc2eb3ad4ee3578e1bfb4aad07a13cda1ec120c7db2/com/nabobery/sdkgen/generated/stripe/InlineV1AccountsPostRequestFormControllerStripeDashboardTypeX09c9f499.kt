...
public sealed class InlineV1AccountsPostRequestFormControllerStripeDashboardTypeX09c9f499 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1AccountsPostRequestFormControllerStripeDashboardTypeX09c9f499 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1AccountsPostRequestFormControllerStripeDashboardTypeX09c9f499> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1AccountsPostRequestFormControllerStripeDashboardTypeX09c9f499",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1AccountsPostRequestFormControllerStripeDashboardTypeX09c9f499 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPostRequestFormControllerStripeDashboardTypeX09c9f499,
        ) {
