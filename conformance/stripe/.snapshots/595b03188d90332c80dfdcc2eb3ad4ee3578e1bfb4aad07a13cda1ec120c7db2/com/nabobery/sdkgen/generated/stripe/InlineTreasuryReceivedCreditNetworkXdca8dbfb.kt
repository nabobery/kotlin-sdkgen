...
public sealed class InlineTreasuryReceivedCreditNetworkXdca8dbfb {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineTreasuryReceivedCreditNetworkXdca8dbfb =
            when (value) {
                Ach.value -> Ach
                Card.value -> Card
                Stripe.value -> Stripe
    ...
    public object Serializer : KSerializer<InlineTreasuryReceivedCreditNetworkXdca8dbfb> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineTreasuryReceivedCreditNetworkXdca8dbfb",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineTreasuryReceivedCreditNetworkXdca8dbfb =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineTreasuryReceivedCreditNetworkXdca8dbfb,
        ) {
