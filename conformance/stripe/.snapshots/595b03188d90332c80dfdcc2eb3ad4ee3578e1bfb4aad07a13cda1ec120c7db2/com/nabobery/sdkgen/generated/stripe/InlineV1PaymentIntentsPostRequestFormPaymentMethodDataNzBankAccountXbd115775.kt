...
public class InlineV1PaymentIntentsPostRequestFormPaymentMethodDataNzBankAccountXbd115775(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentIntentsPostRequestFormPaymentMethodDataNzBankAccountXbd115775 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormPaymentMethodDataNzBankAccountXbd115775> {
        ...
        override fun deserialize(
            decoder: Decoder,
        ): InlineV1PaymentIntentsPostRequestFormPaymentMethodDataNzBankAccountXbd115775 {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsPostRequestFormPaymentMethodDataNzBankAccountXbd115775 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormPaymentMethodDataNzBankAccountXbd115775,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentIntentsPostRequestFormPaymentMethodDataNzBankAccountXbd115775(
    block: InlineV1PaymentIntentsPostRequestFormPaymentMethodDataNzBankAccountXbd115775.Builder.() -> Unit,
): InlineV1PaymentIntentsPostRequestFormPaymentMethodDataNzBankAccountXbd115775 =
    InlineV1PaymentIntentsPostRequestFormPaymentMethodDataNzBankAccountXbd115775.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentIntentsPostRequestFormPaymentMethodDataNzBankAccountXbd115775 is missing required property '" +
                    name +
                    "'",
            )
