...
internal data class InlineV1SubscriptionsPostRequestFormCancellationDetailsCommentXfd0719acInspection(
    ...
    public val matchesInlineV1SubscriptionsPostRequestFormCancellationDetailsCommentAnyOf2X87b33d7d: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1SubscriptionsPostRequestFormCancellationDetailsCommentAnyOf2X87b33d7d,
            ).count {
                it
            }
}
...
public class InlineV1SubscriptionsPostRequestFormCancellationDetailsCommentXfd0719ac internal constructor(
    ...
    private val inspection: InlineV1SubscriptionsPostRequestFormCancellationDetailsCommentXfd0719acInspection,
) {
    ...
    public val inlineV1SubscriptionsPostRequestFormCancellationDetailsCommentAnyOf2X87b33d7d:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1SubscriptionsPostRequestFormCancellationDetailsCommentAnyOf2X87b33d7d) {
                json
                    .decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormCancellationDetailsCommentAnyOf2X87b33d7d>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1SubscriptionsPostRequestFormCancellationDetailsCommentXfd0719acBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1SubscriptionsPostRequestFormCancellationDetailsCommentAnyOf2X87b33d7d) {
                    add(
                        InlineV1SubscriptionsPostRequestFormCancellationDetailsCommentXfd0719acBranch.InlineV1SubscriptionsPostRequestFormCancellationDetailsCommentAnyOf2X87b33d7d,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1SubscriptionsPostRequestFormCancellationDetailsCommentXfd0719ac {
            val inspection = inspectInlineV1SubscriptionsPostRequestFormCancellationDetailsCommentXfd0719ac(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1SubscriptionsPostRequestFormCancellationDetailsCommentXfd0719acNoMatchException(
                    "InlineV1SubscriptionsPostRequestFormCancellationDetailsCommentXfd0719ac matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionsPostRequestFormCancellationDetailsCommentXfd0719ac> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsPostRequestFormCancellationDetailsCommentXfd0719ac,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1SubscriptionsPostRequestFormCancellationDetailsCommentXfd0719ac",
...
private fun inspectInlineV1SubscriptionsPostRequestFormCancellationDetailsCommentXfd0719ac(
    element: JsonElement,
): InlineV1SubscriptionsPostRequestFormCancellationDetailsCommentXfd0719acInspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1SubscriptionsPostRequestFormCancellationDetailsCommentAnyOf2X87b33d7d =
        element
            .isJsonDecodable<InlineV1SubscriptionsPostRequestFormCancellationDetailsCommentAnyOf2X87b33d7d>()
    return InlineV1SubscriptionsPostRequestFormCancellationDetailsCommentXfd0719acInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1SubscriptionsPostRequestFormCancellationDetailsCommentAnyOf2X87b33d7d) {
                    add(
                        "InlineV1SubscriptionsPostRequestFormCancellationDetailsCommentAnyOf2X87b33d7d: value does not match InlineV1SubscriptionsPostRequestFormCancellationDetailsCommentAnyOf2X87b33d7d",
                    )
                }
            },
    )
