...
public sealed class InlineV1SetupIntentsPostRequestFormAmountIncludesIofX60f82d31 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1SetupIntentsPostRequestFormAmountIncludesIofX60f82d31 =
            when (value) {
                Always.value -> Always
                Never.value -> Never
    ...
    public object Serializer : KSerializer<InlineV1SetupIntentsPostRequestFormAmountIncludesIofX60f82d31> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1SetupIntentsPostRequestFormAmountIncludesIofX60f82d31",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1SetupIntentsPostRequestFormAmountIncludesIofX60f82d31 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SetupIntentsPostRequestFormAmountIncludesIofX60f82d31,
        ) {
