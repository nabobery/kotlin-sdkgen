...
public class InlineV1TokensPostRequestFormAccountIndividualAdditionalDocumentX118cd0bd(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1TokensPostRequestFormAccountIndividualAdditionalDocumentX118cd0bd =
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1TokensPostRequestFormAccountIndividualAdditionalDocumentX118cd0bd = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TokensPostRequestFormAccountIndividualAdditionalDocumentX118cd0bd> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TokensPostRequestFormAccountIndividualAdditionalDocumentX118cd0bd must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TokensPostRequestFormAccountIndividualAdditionalDocumentX118cd0bd,
        ) {
            val jsonEncoder =
...
public fun inlineV1TokensPostRequestFormAccountIndividualAdditionalDocumentX118cd0bd(
    block: InlineV1TokensPostRequestFormAccountIndividualAdditionalDocumentX118cd0bd.Builder.() -> Unit,
): InlineV1TokensPostRequestFormAccountIndividualAdditionalDocumentX118cd0bd =
    InlineV1TokensPostRequestFormAccountIndividualAdditionalDocumentX118cd0bd.build(block)
