...
internal data class InlineV1BalanceSettingsPostRequestFormPaymentsPayoutsAdditionalValueX36ae173dInspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1BalanceSettingsPostRequestFormPaymentsPayoutsAnyOf2X107e7ebb,
            ).count { it }
}
...
public class InlineV1BalanceSettingsPostRequestFormPaymentsPayoutsAdditionalValueX36ae173d internal constructor(
    ...
    private val inspection: InlineV1BalanceSettingsPostRequestFormPaymentsPayoutsAdditionalValueX36ae173dInspection,
) {
    ...
    public val inlineV1BalanceSettingsPostRequestFormPaymentsPayoutsAnyOf2X107e7ebb:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1BalanceSettingsPostRequestFormPaymentsPayoutsAnyOf2X107e7ebb) {
                json
                    .decodeFromJsonElement<InlineV1BalanceSettingsPostRequestFormPaymentsPayoutsAnyOf2X107e7ebb>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1BalanceSettingsPostRequestFormPaymentsPayoutsAdditionalValueX36ae173dBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1BalanceSettingsPostRequestFormPaymentsPayoutsAnyOf2X107e7ebb) {
                    add(
                        InlineV1BalanceSettingsPostRequestFormPaymentsPayoutsAdditionalValueX36ae173dBranch.InlineV1BalanceSettingsPostRequestFormPaymentsPayoutsAnyOf2X107e7ebb,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1BalanceSettingsPostRequestFormPaymentsPayoutsAdditionalValueX36ae173d {
            val inspection = inspectInlineV1BalanceSettingsPostRequestFormPaymentsPayoutsAdditionalValueX36ae173d(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1BalanceSettingsPostRequestFormPaymentsPayoutsAdditionalValueX36ae173dNoMatchException(
                    "InlineV1BalanceSettingsPostRequestFormPaymentsPayoutsAdditionalValueX36ae173d matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1BalanceSettingsPostRequestFormPaymentsPayoutsAdditionalValueX36ae173d> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1BalanceSettingsPostRequestFormPaymentsPayoutsAdditionalValueX36ae173d,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1BalanceSettingsPostRequestFormPaymentsPayoutsAdditionalValueX36ae173d",
...
private fun inspectInlineV1BalanceSettingsPostRequestFormPaymentsPayoutsAdditionalValueX36ae173d(
    element: JsonElement,
): InlineV1BalanceSettingsPostRequestFormPaymentsPayoutsAdditionalValueX36ae173dInspection {
    val matchesBranch1 = element.isJsonDecodable<Int>()
    val matchesInlineV1BalanceSettingsPostRequestFormPaymentsPayoutsAnyOf2X107e7ebb =
        element
            .isJsonDecodable<InlineV1BalanceSettingsPostRequestFormPaymentsPayoutsAnyOf2X107e7ebb>()
    return InlineV1BalanceSettingsPostRequestFormPaymentsPayoutsAdditionalValueX36ae173dInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1BalanceSettingsPostRequestFormPaymentsPayoutsAnyOf2X107e7ebb) {
                    add(
                        "InlineV1BalanceSettingsPostRequestFormPaymentsPayoutsAnyOf2X107e7ebb: value does not match InlineV1BalanceSettingsPostRequestFormPaymentsPayoutsAnyOf2X107e7ebb",
                    )
                }
            },
    )
