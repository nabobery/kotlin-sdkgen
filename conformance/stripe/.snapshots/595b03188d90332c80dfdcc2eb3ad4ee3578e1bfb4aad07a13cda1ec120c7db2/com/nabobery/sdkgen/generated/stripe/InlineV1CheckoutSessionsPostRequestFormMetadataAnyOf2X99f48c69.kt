...
public sealed class InlineV1CheckoutSessionsPostRequestFormMetadataAnyOf2X99f48c69 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1CheckoutSessionsPostRequestFormMetadataAnyOf2X99f48c69 =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormMetadataAnyOf2X99f48c69> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1CheckoutSessionsPostRequestFormMetadataAnyOf2X99f48c69",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1CheckoutSessionsPostRequestFormMetadataAnyOf2X99f48c69 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsPostRequestFormMetadataAnyOf2X99f48c69,
        ) {
