...
public class InlineV1PaymentMethodConfigurationsPostRequestFormBlikX3d3a6d6b(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1PaymentMethodConfigurationsPostRequestFormBlikX3d3a6d6b =
            InlineV1PaymentMethodConfigurationsPostRequestFormBlikX3d3a6d6b(
                displayPreference = displayPreference,
            )
    }

    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PaymentMethodConfigurationsPostRequestFormBlikX3d3a6d6b =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentMethodConfigurationsPostRequestFormBlikX3d3a6d6b> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentMethodConfigurationsPostRequestFormBlikX3d3a6d6b must be a JSON object",
                    )
            return InlineV1PaymentMethodConfigurationsPostRequestFormBlikX3d3a6d6b(
                displayPreference =
                    rawObject["display_preference"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentMethodConfigurationsPostRequestFormBlikDisplayPreferenceX4c9d08b1>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentMethodConfigurationsPostRequestFormBlikX3d3a6d6b,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentMethodConfigurationsPostRequestFormBlikX3d3a6d6b(
    block: InlineV1PaymentMethodConfigurationsPostRequestFormBlikX3d3a6d6b.Builder.() -> Unit,
): InlineV1PaymentMethodConfigurationsPostRequestFormBlikX3d3a6d6b =
    InlineV1PaymentMethodConfigurationsPostRequestFormBlikX3d3a6d6b.build(block)
