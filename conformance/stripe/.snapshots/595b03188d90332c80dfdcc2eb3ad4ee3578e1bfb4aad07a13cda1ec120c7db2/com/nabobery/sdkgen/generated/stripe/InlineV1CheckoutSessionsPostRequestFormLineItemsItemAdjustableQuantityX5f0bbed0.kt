...
public class InlineV1CheckoutSessionsPostRequestFormLineItemsItemAdjustableQuantityX5f0bbed0(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1CheckoutSessionsPostRequestFormLineItemsItemAdjustableQuantityX5f0bbed0 =
    ...
    public object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormLineItemsItemAdjustableQuantityX5f0bbed0> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CheckoutSessionsPostRequestFormLineItemsItemAdjustableQuantityX5f0bbed0 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsPostRequestFormLineItemsItemAdjustableQuantityX5f0bbed0,
        ) {
            val jsonEncoder =
...
public fun inlineV1CheckoutSessionsPostRequestFormLineItemsItemAdjustableQuantityX5f0bbed0(
    block: InlineV1CheckoutSessionsPostRequestFormLineItemsItemAdjustableQuantityX5f0bbed0.Builder.() -> Unit,
): InlineV1CheckoutSessionsPostRequestFormLineItemsItemAdjustableQuantityX5f0bbed0 =
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1CheckoutSessionsPostRequestFormLineItemsItemAdjustableQuantityX5f0bbed0 is missing required property '" +
                    name +
                    "'",
            )
