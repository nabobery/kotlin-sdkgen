...
@Serializable
public data class TransferReversalView(
    ...
    public val destinationPaymentRefund: InlineTransferReversalDestinationPaymentRefundX06158f84? = null,
        ...
        override fun deserialize(decoder: Decoder): TransferReversal {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("TransferReversal must be a JSON object")
            ...
            return TransferReversal(
                ...
                balanceTransaction =
                    rawObject["balance_transaction"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineTransferReversalBalanceTransactionX1338043b?>(element)
                        }
                    },
                destinationPaymentRefund =
                    rawObject["destination_payment_refund"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineTransferReversalDestinationPaymentRefundX06158f84?>(
                                element,
                            )
                        }
                    },
                ...
                sourceRefund =
                    rawObject["source_refund"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineTransferReversalSourceRefundXf3d2c1b8?>(element)
                        }
                    },
            )
        }
        ...
        override fun serialize(
            ...
            val raw =
                buildJsonObject {
                    ...
                    value.destinationPaymentRefund?.let {
                        put(
...
public fun transferReversal(block: TransferReversal.Builder.() -> Unit): TransferReversal =
    TransferReversal.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("TransferReversal is missing required property '" + name + "'")
