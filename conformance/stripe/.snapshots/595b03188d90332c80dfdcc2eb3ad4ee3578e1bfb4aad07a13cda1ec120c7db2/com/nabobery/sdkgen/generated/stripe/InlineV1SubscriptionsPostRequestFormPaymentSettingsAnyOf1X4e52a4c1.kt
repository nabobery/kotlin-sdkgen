...
public class InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X4e52a4c1(
    public val mandateOptions: InlineV1SubscriptionsPostRequestFormPaymentSettingsMandateOptionsXd893dcbc? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X4e52a4c1 =
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X4e52a4c1 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X4e52a4c1> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X4e52a4c1 must be a JSON object",
                    )
            return InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X4e52a4c1(
                mandateOptions =
                    rawObject["mandate_options"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormPaymentSettingsMandateOptionsXd893dcbc>(
                                it,
                            )
                    },
                network =
                    rawObject["network"]?.let {
                        json.decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormPaymentSettingsNetworkX3df87131>(
                            it,
                        )
                    },
                requestThreeDSecure =
                    rawObject["request_three_d_secure"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormPaymentSettingsRequestThreeDSecureX5a7126d1>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X4e52a4c1,
        ) {
            val jsonEncoder =
...
public fun inlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X4e52a4c1(
    block: InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X4e52a4c1.Builder.() -> Unit,
): InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X4e52a4c1 =
    InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X4e52a4c1.build(block)
