...
public class InlineV1SubscriptionsPostRequestFormBillingCycleAnchorConfigX18b8a838(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1SubscriptionsPostRequestFormBillingCycleAnchorConfigX18b8a838 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionsPostRequestFormBillingCycleAnchorConfigX18b8a838> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SubscriptionsPostRequestFormBillingCycleAnchorConfigX18b8a838 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsPostRequestFormBillingCycleAnchorConfigX18b8a838,
        ) {
            val jsonEncoder =
...
public fun inlineV1SubscriptionsPostRequestFormBillingCycleAnchorConfigX18b8a838(
    block: InlineV1SubscriptionsPostRequestFormBillingCycleAnchorConfigX18b8a838.Builder.() -> Unit,
): InlineV1SubscriptionsPostRequestFormBillingCycleAnchorConfigX18b8a838 =
    InlineV1SubscriptionsPostRequestFormBillingCycleAnchorConfigX18b8a838.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1SubscriptionsPostRequestFormBillingCycleAnchorConfigX18b8a838 is missing required property '" +
                    name +
                    "'",
            )
