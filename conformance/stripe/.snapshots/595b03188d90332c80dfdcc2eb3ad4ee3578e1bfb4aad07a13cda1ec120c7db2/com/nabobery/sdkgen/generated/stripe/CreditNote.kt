...
@Serializable
public data class CreditNoteView(
    ...
    public val customerBalanceTransaction: InlineCreditNoteCustomerBalanceTransactionX7d3546fb? = null,
...
public class CreditNote(
    ...
    public class Builder {
        ...
        public var discountAmounts: List<DiscountsResourceDiscountAmount>
            get() = requireNotNull(discountAmountsValue) { "discountAmounts is required" }
            set(`value`) {
                discountAmountsValue = value
            }
        ...
        public var pretaxCreditAmounts: List<CreditNotesPretaxCreditAmount>
            get() = requireNotNull(pretaxCreditAmountsValue) { "pretaxCreditAmounts is required" }
            set(`value`) {
                pretaxCreditAmountsValue = value
            }
    ...
    public object Serializer : KSerializer<CreditNote> {
        ...
        override fun deserialize(decoder: Decoder): CreditNote {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("CreditNote must be a JSON object")
            ...
            val discountAmounts =
                json.decodeRequired<List<DiscountsResourceDiscountAmount>>(
                    rawObject,
                    "discount_amounts",
                )
            ...
            val pretaxCreditAmounts =
                json.decodeRequired<List<CreditNotesPretaxCreditAmount>>(
                    rawObject,
            ...
            return CreditNote(
                ...
                customerBalanceTransaction =
                    rawObject["customer_balance_transaction"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineCreditNoteCustomerBalanceTransactionX7d3546fb?>(element)
                        }
                    },
                effectiveAt =
                    rawObject["effective_at"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                outOfBandAmount =
                    rawObject["out_of_band_amount"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                reason =
                    rawObject["reason"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineCreditNoteReasonX7a4479ce?>(element)
                        }
                    },
                shippingCost =
                    rawObject["shipping_cost"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineCreditNoteShippingCostX7ab82b42?>(element)
                        }
                    },
        ...
        override fun serialize(
            ...
            val raw =
                buildJsonObject {
                    ...
                    value.customerBalanceTransaction?.let {
                        put(
