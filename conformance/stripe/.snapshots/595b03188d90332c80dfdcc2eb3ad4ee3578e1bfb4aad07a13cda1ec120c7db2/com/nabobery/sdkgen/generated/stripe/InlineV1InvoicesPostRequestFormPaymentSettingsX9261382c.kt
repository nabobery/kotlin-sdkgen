...
public class InlineV1InvoicesPostRequestFormPaymentSettingsX9261382c(
    public val defaultMandate: InlineV1InvoicesPostRequestFormPaymentSettingsDefaultMandateX3595393c? = null,
    public val paymentMethodOptions: InlineV1InvoicesPostRequestFormPaymentSettingsPaymentMethodOptionsX7dd5ae22? = null,
    public val paymentMethodTypes: InlineV1InvoicesPostRequestFormPaymentSettingsPaymentMethodTypesXf8646576? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1InvoicesPostRequestFormPaymentSettingsX9261382c =
            InlineV1InvoicesPostRequestFormPaymentSettingsX9261382c(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1InvoicesPostRequestFormPaymentSettingsX9261382c =
    ...
    public object Serializer : KSerializer<InlineV1InvoicesPostRequestFormPaymentSettingsX9261382c> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1InvoicesPostRequestFormPaymentSettingsX9261382c must be a JSON object",
                    )
            return InlineV1InvoicesPostRequestFormPaymentSettingsX9261382c(
                defaultMandate =
                    rawObject["default_mandate"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1InvoicesPostRequestFormPaymentSettingsDefaultMandateX3595393c>(
                                it,
                            )
                    },
                paymentMethodOptions =
                    rawObject["payment_method_options"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1InvoicesPostRequestFormPaymentSettingsPaymentMethodOptionsX7dd5ae22>(
                                it,
                            )
                    },
                paymentMethodTypes =
                    rawObject["payment_method_types"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1InvoicesPostRequestFormPaymentSettingsPaymentMethodTypesXf8646576>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesPostRequestFormPaymentSettingsX9261382c,
        ) {
...
public fun inlineV1InvoicesPostRequestFormPaymentSettingsX9261382c(
    block: InlineV1InvoicesPostRequestFormPaymentSettingsX9261382c.Builder.() -> Unit,
): InlineV1InvoicesPostRequestFormPaymentSettingsX9261382c =
    InlineV1InvoicesPostRequestFormPaymentSettingsX9261382c.build(block)
