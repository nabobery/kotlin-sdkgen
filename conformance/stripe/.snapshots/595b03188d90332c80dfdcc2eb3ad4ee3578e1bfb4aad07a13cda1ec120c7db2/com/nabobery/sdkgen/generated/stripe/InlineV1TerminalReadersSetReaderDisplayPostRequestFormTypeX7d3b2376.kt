...
public sealed class InlineV1TerminalReadersSetReaderDisplayPostRequestFormTypeX7d3b2376 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1TerminalReadersSetReaderDisplayPostRequestFormTypeX7d3b2376 =
            when (value) {
                Cart.value -> Cart
    ...
    public object Serializer : KSerializer<InlineV1TerminalReadersSetReaderDisplayPostRequestFormTypeX7d3b2376> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1TerminalReadersSetReaderDisplayPostRequestFormTypeX7d3b2376",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1TerminalReadersSetReaderDisplayPostRequestFormTypeX7d3b2376 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TerminalReadersSetReaderDisplayPostRequestFormTypeX7d3b2376,
        ) {
