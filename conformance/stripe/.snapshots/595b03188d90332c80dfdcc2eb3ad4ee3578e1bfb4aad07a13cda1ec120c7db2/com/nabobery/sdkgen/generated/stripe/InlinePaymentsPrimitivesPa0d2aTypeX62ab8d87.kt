...
public sealed class InlinePaymentsPrimitivesPa0d2aTypeX62ab8d87 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentsPrimitivesPa0d2aTypeX62ab8d87 =
            when (value) {
                Card.value -> Card
    ...
    public object Serializer : KSerializer<InlinePaymentsPrimitivesPa0d2aTypeX62ab8d87> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentsPrimitivesPa0d2aTypeX62ab8d87",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePaymentsPrimitivesPa0d2aTypeX62ab8d87 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentsPrimitivesPa0d2aTypeX62ab8d87,
        ) {
