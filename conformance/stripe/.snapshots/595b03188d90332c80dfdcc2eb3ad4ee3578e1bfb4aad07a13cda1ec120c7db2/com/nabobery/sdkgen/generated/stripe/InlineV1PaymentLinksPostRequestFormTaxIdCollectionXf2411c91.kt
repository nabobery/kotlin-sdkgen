...
public class InlineV1PaymentLinksPostRequestFormTaxIdCollectionXf2411c91(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PaymentLinksPostRequestFormTaxIdCollectionXf2411c91 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentLinksPostRequestFormTaxIdCollectionXf2411c91> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentLinksPostRequestFormTaxIdCollectionXf2411c91 must be a JSON object",
                    )
            ...
            return InlineV1PaymentLinksPostRequestFormTaxIdCollectionXf2411c91(
                ...
                required =
                    rawObject["required"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormTaxIdCollectionRequiredXe4429009>(
                            it,
                        )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentLinksPostRequestFormTaxIdCollectionXf2411c91,
        ) {
...
public fun inlineV1PaymentLinksPostRequestFormTaxIdCollectionXf2411c91(
    block: InlineV1PaymentLinksPostRequestFormTaxIdCollectionXf2411c91.Builder.() -> Unit,
): InlineV1PaymentLinksPostRequestFormTaxIdCollectionXf2411c91 =
    InlineV1PaymentLinksPostRequestFormTaxIdCollectionXf2411c91.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentLinksPostRequestFormTaxIdCollectionXf2411c91 is missing required property '" + name +
                    "'",
            )
