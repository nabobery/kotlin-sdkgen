...
public class InlineV1AccountsPostRequestFormSettingsPayoutsX491a77ee(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1AccountsPostRequestFormSettingsPayoutsX491a77ee =
            InlineV1AccountsPostRequestFormSettingsPayoutsX491a77ee(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1AccountsPostRequestFormSettingsPayoutsX491a77ee =
    ...
    public object Serializer : KSerializer<InlineV1AccountsPostRequestFormSettingsPayoutsX491a77ee> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountsPostRequestFormSettingsPayoutsX491a77ee must be a JSON object",
                    )
            return InlineV1AccountsPostRequestFormSettingsPayoutsX491a77ee(
                ...
                schedule =
                    rawObject["schedule"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPostRequestFormSettingsPayoutsScheduleX28db0ac7>(it)
                    },
                statementDescriptor =
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPostRequestFormSettingsPayoutsX491a77ee,
        ) {
...
public fun inlineV1AccountsPostRequestFormSettingsPayoutsX491a77ee(
    block: InlineV1AccountsPostRequestFormSettingsPayoutsX491a77ee.Builder.() -> Unit,
): InlineV1AccountsPostRequestFormSettingsPayoutsX491a77ee =
    InlineV1AccountsPostRequestFormSettingsPayoutsX491a77ee.build(block)
