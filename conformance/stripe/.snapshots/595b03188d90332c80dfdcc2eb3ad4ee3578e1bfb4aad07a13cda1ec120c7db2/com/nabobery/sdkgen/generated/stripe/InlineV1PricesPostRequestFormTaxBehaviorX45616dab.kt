...
public sealed class InlineV1PricesPostRequestFormTaxBehaviorX45616dab {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1PricesPostRequestFormTaxBehaviorX45616dab =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1PricesPostRequestFormTaxBehaviorX45616dab> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1PricesPostRequestFormTaxBehaviorX45616dab",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1PricesPostRequestFormTaxBehaviorX45616dab =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PricesPostRequestFormTaxBehaviorX45616dab,
        ) {
