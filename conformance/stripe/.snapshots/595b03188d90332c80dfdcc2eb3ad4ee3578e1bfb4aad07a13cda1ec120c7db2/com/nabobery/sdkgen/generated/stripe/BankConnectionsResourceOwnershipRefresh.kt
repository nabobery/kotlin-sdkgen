...
public class BankConnectionsResourceOwnershipRefresh(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): BankConnectionsResourceOwnershipRefresh =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<BankConnectionsResourceOwnershipRefresh> {
        ...
        override fun deserialize(decoder: Decoder): BankConnectionsResourceOwnershipRefresh {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("BankConnectionsResourceOwnershipRefresh must be a JSON object")
            val lastAttemptedAt = json.decodeRequired<Int>(rawObject, "last_attempted_at")
            val status =
                json.decodeRequired<InlineBankConnectionsResourceOwnershipRefreshStatusXc05f47c8>(
                    rawObject,
                    "status",
                )
            return BankConnectionsResourceOwnershipRefresh(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: BankConnectionsResourceOwnershipRefresh,
        ) {
...
public fun bankConnectionsResourceOwnershipRefresh(
    block: BankConnectionsResourceOwnershipRefresh.Builder.() -> Unit,
): BankConnectionsResourceOwnershipRefresh = BankConnectionsResourceOwnershipRefresh.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "BankConnectionsResourceOwnershipRefresh is missing required property '" + name + "'",
            )
