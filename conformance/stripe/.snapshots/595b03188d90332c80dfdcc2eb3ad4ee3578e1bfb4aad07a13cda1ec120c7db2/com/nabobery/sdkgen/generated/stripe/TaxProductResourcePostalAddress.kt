...
public class TaxProductResourcePostalAddress(
    ...
    public object Serializer : KSerializer<TaxProductResourcePostalAddress> {
        ...
        override fun deserialize(decoder: Decoder): TaxProductResourcePostalAddress {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("TaxProductResourcePostalAddress must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: TaxProductResourcePostalAddress,
        ) {
...
public fun taxProductResourcePostalAddress(
    block: TaxProductResourcePostalAddress.Builder.() -> Unit,
): TaxProductResourcePostalAddress = TaxProductResourcePostalAddress.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "TaxProductResourcePostalAddress is missing required property '" + name + "'",
            )
