...
public sealed class InlineTreasuryFinancialAccountsResourceFinancialAddressTypeX6816c6a8 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineTreasuryFinancialAccountsResourceFinancialAddressTypeX6816c6a8 =
            when (value) {
                Aba.value -> Aba
    ...
    public object Serializer : KSerializer<InlineTreasuryFinancialAccountsResourceFinancialAddressTypeX6816c6a8> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineTreasuryFinancialAccountsResourceFinancialAddressTypeX6816c6a8",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineTreasuryFinancialAccountsResourceFinancialAddressTypeX6816c6a8 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineTreasuryFinancialAccountsResourceFinancialAddressTypeX6816c6a8,
        ) {
