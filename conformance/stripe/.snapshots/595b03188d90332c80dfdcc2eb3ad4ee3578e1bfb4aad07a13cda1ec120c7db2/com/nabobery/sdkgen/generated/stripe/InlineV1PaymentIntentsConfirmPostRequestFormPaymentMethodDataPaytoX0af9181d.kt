...
public class InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataPaytoX0af9181d(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataPaytoX0af9181d =
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataPaytoX0af9181d = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataPaytoX0af9181d> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataPaytoX0af9181d must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataPaytoX0af9181d,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataPaytoX0af9181d(
    block: InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataPaytoX0af9181d.Builder.() -> Unit,
): InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataPaytoX0af9181d =
    InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataPaytoX0af9181d.build(block)
