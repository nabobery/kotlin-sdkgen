...
public class InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataX34ae9b07(
    ...
    public val acssDebit: InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataAcssDebitX8d5f67d1? = null,
    public val affirm: JsonObject? = null,
    public val afterpayClearpay: JsonObject? = null,
    public val alipay: JsonObject? = null,
    public val allowRedisplay: InlineV1PaymentIntentsConfirmPostRequestFormAllowRedisplayX05aee8f8? = null,
    ...
    public val bacsDebit: InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataBacsDebitX0683c000? = null,
    public val bancontact: JsonObject? = null,
    public val billie: JsonObject? = null,
    public val billingDetails: InlineV1PaymentIntentsConfirmPostRequestFormBillingDetailsX890d2399? = null,
    public val bizum: JsonObject? = null,
    public val blik: JsonObject? = null,
    public val boleto: InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataBoletoXd8d9ea3a? = null,
    ...
    public val ideal: InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataIdealX1586b560? = null,
    public val interacPresent: JsonObject? = null,
    public val kakaoPay: JsonObject? = null,
    public val klarna: InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataKlarnaX8d1d10d3? = null,
    ...
    public val naverPay: InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataNaverPayXf6a0a08b? = null,
    public val nzBankAccount: InlineV1PaymentIntentsConfirmPostRequestFormNzBankAccountX4d30acf2? = null,
    ...
    public val payto: InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataPaytoX0af9181d? = null,
    public val pix: JsonObject? = null,
    public val promptpay: JsonObject? = null,
    public val radarOptions: InlineV1PaymentIntentsConfirmPostRequestFormRadarOptionsX9a7ca3fe? = null,
    ...
    public val sepaDebit: InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataSepaDebitXa7ba3111? = null,
    public val sofort: InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataSofortXf2040d76? = null,
    ...
    public val usBankAccount: InlineV1PaymentIntentsConfirmPostRequestFormUsBankAccountX09ce459b? = null,
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataX34ae9b07 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataX34ae9b07> {
        ...
        override fun deserialize(
            decoder: Decoder,
        ): InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataX34ae9b07 {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataX34ae9b07 must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataTypeX046b2889>(
                    rawObject,
                    "type",
                )
            return InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataX34ae9b07(
                ...
                acssDebit =
                    rawObject["acss_debit"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataAcssDebitX8d5f67d1>(
                                it,
                            )
                    },
                ...
                allowRedisplay =
                    rawObject["allow_redisplay"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormAllowRedisplayX05aee8f8>(
                            it,
                        )
                    },
                ...
                auBecsDebit =
                    rawObject["au_becs_debit"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormAuBecsDebitX935d2e91>(it)
                    },
                bacsDebit =
                    rawObject["bacs_debit"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataBacsDebitX0683c000>(
                                it,
                            )
                    },
                ...
                billingDetails =
                    rawObject["billing_details"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormBillingDetailsX890d2399>(
                            it,
                        )
                    },
                ...
                boleto =
                    rawObject["boleto"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataBoletoXd8d9ea3a>(
                                it,
                            )
                    },
                ...
                eps =
                    rawObject["eps"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataEpsX877c2fb5>(
                                it,
                            )
                    },
                fpx =
                    rawObject["fpx"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataFpxX6b7277a7>(
                                it,
                            )
                    },
                ...
                ideal =
                    rawObject["ideal"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataIdealX1586b560>(
                                it,
                            )
                    },
                ...
                klarna =
                    rawObject["klarna"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataKlarnaX8d1d10d3>(
                                it,
                            )
                    },
                ...
                naverPay =
                    rawObject["naver_pay"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataNaverPayXf6a0a08b>(
                                it,
                            )
                    },
                nzBankAccount =
                    rawObject["nz_bank_account"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormNzBankAccountX4d30acf2>(
                            it,
                        )
                    },
                ...
                p24 =
                    rawObject["p24"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataP24X9d28c532>(
                                it,
                            )
                    },
                ...
                payto =
                    rawObject["payto"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataPaytoX0af9181d>(
                                it,
                            )
                    },
                ...
                radarOptions =
                    rawObject["radar_options"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormRadarOptionsX9a7ca3fe>(
                            it,
                        )
                    },
                ...
                sepaDebit =
                    rawObject["sepa_debit"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataSepaDebitXa7ba3111>(
                                it,
                            )
                    },
                sofort =
                    rawObject["sofort"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataSofortXf2040d76>(
                                it,
                            )
                    },
                ...
                upi =
                    rawObject["upi"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataUpiXe2281e23>(
                                it,
                            )
                    },
                usBankAccount =
                    rawObject["us_bank_account"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormUsBankAccountX09ce459b>(
                            it,
                        )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataX34ae9b07,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataX34ae9b07(
    block: InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataX34ae9b07.Builder.() -> Unit,
): InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataX34ae9b07 =
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataX34ae9b07 is missing required property '" +
                    name +
                    "'",
            )
