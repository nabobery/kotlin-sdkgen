...
public sealed class InlineV1CustomersPostRequestFormCardAnyOf1ObjectValueX34af4e30 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1CustomersPostRequestFormCardAnyOf1ObjectValueX34af4e30 =
            when (value) {
                Card.value -> Card
    ...
    public object Serializer : KSerializer<InlineV1CustomersPostRequestFormCardAnyOf1ObjectValueX34af4e30> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1CustomersPostRequestFormCardAnyOf1ObjectValueX34af4e30",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1CustomersPostRequestFormCardAnyOf1ObjectValueX34af4e30 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersPostRequestFormCardAnyOf1ObjectValueX34af4e30,
        ) {
