...
public sealed class InlineV1PaymentRecordsReportPaymentPostRequestFormMetadataAnyOf2X98e40c79 {
    ...
    public object Serializer : KSerializer<InlineV1PaymentRecordsReportPaymentPostRequestFormMetadataAnyOf2X98e40c79> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1PaymentRecordsReportPaymentPostRequestFormMetadataAnyOf2X98e40c79",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1PaymentRecordsReportPaymentPostRequestFormMetadataAnyOf2X98e40c79 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentRecordsReportPaymentPostRequestFormMetadataAnyOf2X98e40c79,
        ) {
