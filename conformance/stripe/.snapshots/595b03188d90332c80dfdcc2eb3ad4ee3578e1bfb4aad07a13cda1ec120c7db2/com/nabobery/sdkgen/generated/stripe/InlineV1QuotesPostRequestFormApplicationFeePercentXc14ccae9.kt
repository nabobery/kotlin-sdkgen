...
internal data class InlineV1QuotesPostRequestFormApplicationFeePercentXc14ccae9Inspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1QuotesPostRequestFormApplicationFeePercentAnyOf2Xfd43864c,
            ).count { it }
}
...
public class InlineV1QuotesPostRequestFormApplicationFeePercentXc14ccae9 internal constructor(
    ...
    public val inlineV1QuotesPostRequestFormApplicationFeePercentAnyOf2Xfd43864c:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1QuotesPostRequestFormApplicationFeePercentAnyOf2Xfd43864c) {
                json
                    .decodeFromJsonElement<InlineV1QuotesPostRequestFormApplicationFeePercentAnyOf2Xfd43864c>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1QuotesPostRequestFormApplicationFeePercentXc14ccae9Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1QuotesPostRequestFormApplicationFeePercentAnyOf2Xfd43864c) {
                    add(
                        InlineV1QuotesPostRequestFormApplicationFeePercentXc14ccae9Branch.InlineV1QuotesPostRequestFormApplicationFeePercentAnyOf2Xfd43864c,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1QuotesPostRequestFormApplicationFeePercentXc14ccae9 {
            val inspection = inspectInlineV1QuotesPostRequestFormApplicationFeePercentXc14ccae9(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1QuotesPostRequestFormApplicationFeePercentXc14ccae9NoMatchException(
                    "InlineV1QuotesPostRequestFormApplicationFeePercentXc14ccae9 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1QuotesPostRequestFormApplicationFeePercentXc14ccae9> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1QuotesPostRequestFormApplicationFeePercentXc14ccae9,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1QuotesPostRequestFormApplicationFeePercentXc14ccae9",
...
private fun inspectInlineV1QuotesPostRequestFormApplicationFeePercentXc14ccae9(
    element: JsonElement,
): InlineV1QuotesPostRequestFormApplicationFeePercentXc14ccae9Inspection {
    val matchesBranch1 = element.isJsonDecodable<Double>()
    val matchesInlineV1QuotesPostRequestFormApplicationFeePercentAnyOf2Xfd43864c =
        element
            .isJsonDecodable<InlineV1QuotesPostRequestFormApplicationFeePercentAnyOf2Xfd43864c>()
    return InlineV1QuotesPostRequestFormApplicationFeePercentXc14ccae9Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1QuotesPostRequestFormApplicationFeePercentAnyOf2Xfd43864c) {
                    add(
                        "InlineV1QuotesPostRequestFormApplicationFeePercentAnyOf2Xfd43864c: value does not match InlineV1QuotesPostRequestFormApplicationFeePercentAnyOf2Xfd43864c",
                    )
                }
            },
    )
