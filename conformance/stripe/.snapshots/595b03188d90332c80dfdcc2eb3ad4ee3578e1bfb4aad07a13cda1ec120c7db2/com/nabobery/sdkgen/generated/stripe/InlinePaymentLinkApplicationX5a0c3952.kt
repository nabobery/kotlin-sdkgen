...
public class InlinePaymentLinkApplicationX5a0c3952 internal constructor(
        ...
        get() =
            buildSet {
                ...
                if (inspection.matchesDeletedApplication) {
                    add(
                        InlinePaymentLinkApplicationX5a0c3952Branch.DeletedApplication,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlinePaymentLinkApplicationX5a0c3952 {
            val inspection = inspectInlinePaymentLinkApplicationX5a0c3952(raw)
            if (inspection.matchCount == 0) {
                throw InlinePaymentLinkApplicationX5a0c3952NoMatchException(
                    "InlinePaymentLinkApplicationX5a0c3952 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlinePaymentLinkApplicationX5a0c3952> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentLinkApplicationX5a0c3952,
        ) {
...
private fun inspectInlinePaymentLinkApplicationX5a0c3952(
    element: JsonElement,
): InlinePaymentLinkApplicationX5a0c3952Inspection {
