...
public class InlineV1CouponsPostRequestFormAppliesToXceb8e268(
    public val products: List<String>? = null,
) {
    public class Builder {
        public var products: List<String>? = null

        public fun build(): InlineV1CouponsPostRequestFormAppliesToXceb8e268 =
            InlineV1CouponsPostRequestFormAppliesToXceb8e268(
                products = products,
            )
    }

    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1CouponsPostRequestFormAppliesToXceb8e268 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1CouponsPostRequestFormAppliesToXceb8e268> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CouponsPostRequestFormAppliesToXceb8e268 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CouponsPostRequestFormAppliesToXceb8e268,
        ) {
...
public fun inlineV1CouponsPostRequestFormAppliesToXceb8e268(
    block: InlineV1CouponsPostRequestFormAppliesToXceb8e268.Builder.() -> Unit,
): InlineV1CouponsPostRequestFormAppliesToXceb8e268 = InlineV1CouponsPostRequestFormAppliesToXceb8e268.build(block)
