...
public class InlineV1TokensPostRequestFormCardAnyOf1NetworksX285416f0(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1TokensPostRequestFormCardAnyOf1NetworksX285416f0 =
            InlineV1TokensPostRequestFormCardAnyOf1NetworksX285416f0(
                preferred = preferred,
            )
    }

    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TokensPostRequestFormCardAnyOf1NetworksX285416f0 =
    ...
    public object Serializer : KSerializer<InlineV1TokensPostRequestFormCardAnyOf1NetworksX285416f0> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TokensPostRequestFormCardAnyOf1NetworksX285416f0 must be a JSON object",
                    )
            return InlineV1TokensPostRequestFormCardAnyOf1NetworksX285416f0(
                preferred =
                    rawObject["preferred"]?.let {
                        json.decodeFromJsonElement<InlineV1TokensPostRequestFormCardAnyOf1NetworksPreferredX88e3ea6d>(
                            it,
                        )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TokensPostRequestFormCardAnyOf1NetworksX285416f0,
        ) {
...
public fun inlineV1TokensPostRequestFormCardAnyOf1NetworksX285416f0(
    block: InlineV1TokensPostRequestFormCardAnyOf1NetworksX285416f0.Builder.() -> Unit,
): InlineV1TokensPostRequestFormCardAnyOf1NetworksX285416f0 =
    InlineV1TokensPostRequestFormCardAnyOf1NetworksX285416f0.build(block)
