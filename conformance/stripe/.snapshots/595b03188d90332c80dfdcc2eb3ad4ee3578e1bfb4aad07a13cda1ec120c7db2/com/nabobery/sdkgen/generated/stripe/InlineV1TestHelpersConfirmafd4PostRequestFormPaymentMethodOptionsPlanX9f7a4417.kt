...
public class InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodOptionsPlanX9f7a4417(
    ...
    public object Serializer : KSerializer<InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodOptionsPlanX9f7a4417> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodOptionsPlanX9f7a4417 must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodOptionsTypeXc4cd9e6d>(
                    rawObject,
                    "type",
                )
            return InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodOptionsPlanX9f7a4417(
                ...
                interval =
                    rawObject["interval"]?.let {
                        json.decodeFromJsonElement<InlineV1TestHelpersConfirmafd4PostRequestFormIntervalX9d460ce1>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodOptionsPlanX9f7a4417,
        ) {
            val jsonEncoder =
...
public fun inlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodOptionsPlanX9f7a4417(
    block: InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodOptionsPlanX9f7a4417.Builder.() -> Unit,
): InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodOptionsPlanX9f7a4417 =
    InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodOptionsPlanX9f7a4417.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodOptionsPlanX9f7a4417 is missing required property '" +
                    name +
                    "'",
            )
