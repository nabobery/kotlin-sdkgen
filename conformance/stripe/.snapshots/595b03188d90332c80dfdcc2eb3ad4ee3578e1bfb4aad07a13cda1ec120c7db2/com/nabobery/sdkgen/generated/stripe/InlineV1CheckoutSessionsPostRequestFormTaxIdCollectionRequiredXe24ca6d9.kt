...
public sealed class InlineV1CheckoutSessionsPostRequestFormTaxIdCollectionRequiredXe24ca6d9 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1CheckoutSessionsPostRequestFormTaxIdCollectionRequiredXe24ca6d9 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormTaxIdCollectionRequiredXe24ca6d9> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1CheckoutSessionsPostRequestFormTaxIdCollectionRequiredXe24ca6d9",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1CheckoutSessionsPostRequestFormTaxIdCollectionRequiredXe24ca6d9 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsPostRequestFormTaxIdCollectionRequiredXe24ca6d9,
        ) {
