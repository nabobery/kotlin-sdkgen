...
public class InlineV1CustomersPostRequestFormXe3915cf0(
     ...
     */
    public val taxIdData: List<InlineV1CustomersPostRequestFormTaxIdDataItemXa5c9f532>? = null,
    /**
    ...
    public class Builder {
         ...
         * The customer's tax IDs.
         */
        public var taxIdData: List<InlineV1CustomersPostRequestFormTaxIdDataItemXa5c9f532>? = null
        ...
        public fun build(): InlineV1CustomersPostRequestFormXe3915cf0 =
            InlineV1CustomersPostRequestFormXe3915cf0(
                address = address,
                balance = balance,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1CustomersPostRequestFormXe3915cf0 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1CustomersPostRequestFormXe3915cf0> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1CustomersPostRequestFormXe3915cf0 {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("InlineV1CustomersPostRequestFormXe3915cf0 must be a JSON object")
            return InlineV1CustomersPostRequestFormXe3915cf0(
                address =
                    rawObject["address"]?.let {
                        json.decodeFromJsonElement<InlineV1CustomersPostRequestFormAddressX54fa48b0>(it)
                    },
                balance = rawObject["balance"]?.let { json.decodeFromJsonElement<Int>(it) },
                businessName =
                    rawObject["business_name"]?.let {
                        json.decodeFromJsonElement<InlineV1CustomersPostRequestFormBusinessNameX3b2c85e7>(it)
                    },
                cashBalance =
                    rawObject["cash_balance"]?.let {
                        json.decodeFromJsonElement<InlineV1CustomersPostRequestFormCashBalanceXab2050d3>(it)
                    },
                description = rawObject["description"]?.let { json.decodeFromJsonElement<String>(it) },
                email = rawObject["email"]?.let { json.decodeFromJsonElement<String>(it) },
                expand = rawObject["expand"]?.let { json.decodeFromJsonElement<List<String>>(it) },
                individualName =
                    rawObject["individual_name"]?.let {
                        json.decodeFromJsonElement<InlineV1CustomersPostRequestFormIndividualNameX7e854e90>(it)
                    },
                invoicePrefix = rawObject["invoice_prefix"]?.let { json.decodeFromJsonElement<String>(it) },
                invoiceSettings =
                    rawObject["invoice_settings"]?.let {
                        json.decodeFromJsonElement<InlineV1CustomersPostRequestFormInvoiceSettingsX99c0a3df>(it)
                    },
                metadata =
                    rawObject["metadata"]?.let {
                        json.decodeFromJsonElement<InlineV1CustomersPostRequestFormMetadataXc4710090>(it)
                    },
                ...
                shipping =
                    rawObject["shipping"]?.let {
                        json.decodeFromJsonElement<InlineV1CustomersPostRequestFormShippingX3a4d1b73>(it)
                    },
                source = rawObject["source"]?.let { json.decodeFromJsonElement<String>(it) },
                tax =
                    rawObject["tax"]?.let {
                        json.decodeFromJsonElement<InlineV1CustomersPostRequestFormTaxX65e900f4>(
                            it,
                        )
                    },
                taxExempt =
                    rawObject["tax_exempt"]?.let {
                        json.decodeFromJsonElement<InlineV1CustomersPostRequestFormTaxExemptX72a48ffa>(it)
                    },
                taxIdData =
                    rawObject["tax_id_data"]?.let {
                        json.decodeFromJsonElement<List<InlineV1CustomersPostRequestFormTaxIdDataItemXa5c9f532>>(it)
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersPostRequestFormXe3915cf0,
        ) {
...
public fun inlineV1CustomersPostRequestFormXe3915cf0(
    block: InlineV1CustomersPostRequestFormXe3915cf0.Builder.() -> Unit,
): InlineV1CustomersPostRequestFormXe3915cf0 = InlineV1CustomersPostRequestFormXe3915cf0.build(block)
