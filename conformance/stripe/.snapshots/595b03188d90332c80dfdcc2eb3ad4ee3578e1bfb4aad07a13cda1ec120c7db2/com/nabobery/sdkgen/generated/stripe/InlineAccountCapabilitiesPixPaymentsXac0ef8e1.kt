...
public sealed class InlineAccountCapabilitiesPixPaymentsXac0ef8e1 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineAccountCapabilitiesPixPaymentsXac0ef8e1 =
            when (value) {
                Active.value -> Active
    ...
    public object Serializer : KSerializer<InlineAccountCapabilitiesPixPaymentsXac0ef8e1> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineAccountCapabilitiesPixPaymentsXac0ef8e1",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineAccountCapabilitiesPixPaymentsXac0ef8e1 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineAccountCapabilitiesPixPaymentsXac0ef8e1,
        ) {
