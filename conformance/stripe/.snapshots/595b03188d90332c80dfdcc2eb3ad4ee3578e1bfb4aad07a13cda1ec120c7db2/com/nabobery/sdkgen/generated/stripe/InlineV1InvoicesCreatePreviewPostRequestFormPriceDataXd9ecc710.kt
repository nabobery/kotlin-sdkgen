...
public class InlineV1InvoicesCreatePreviewPostRequestFormPriceDataXd9ecc710(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1InvoicesCreatePreviewPostRequestFormPriceDataXd9ecc710 =
    ...
    public object Serializer : KSerializer<InlineV1InvoicesCreatePreviewPostRequestFormPriceDataXd9ecc710> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1InvoicesCreatePreviewPostRequestFormPriceDataXd9ecc710 {
            val jsonDecoder =
                decoder.requireJsonDecoder(
                    "InlineV1InvoicesCreatePreviewPostRequestFormPriceDataXd9ecc710",
                )
            val json = jsonDecoder.json
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1InvoicesCreatePreviewPostRequestFormPriceDataXd9ecc710 must be a JSON object",
                    )
            val currency = json.decodeRequired<String>(rawObject, "currency")
            val product = json.decodeRequired<String>(rawObject, "product")
            val recurring =
                json.decodeRequired<InlineV1InvoicesCreatePreviewPostRequestFormRecurringXe262fbc6>(
                    rawObject,
                    "recurring",
                )
            return InlineV1InvoicesCreatePreviewPostRequestFormPriceDataXd9ecc710(
                ...
                taxBehavior =
                    rawObject["tax_behavior"]?.let {
                        json.decodeFromJsonElement<InlineV1InvoicesCreatePreviewPostRequestFormTaxBehaviorX61cf247b>(it)
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesCreatePreviewPostRequestFormPriceDataXd9ecc710,
        ) {
            val jsonEncoder =
...
public fun inlineV1InvoicesCreatePreviewPostRequestFormPriceDataXd9ecc710(
    block: InlineV1InvoicesCreatePreviewPostRequestFormPriceDataXd9ecc710.Builder.() -> Unit,
): InlineV1InvoicesCreatePreviewPostRequestFormPriceDataXd9ecc710 =
    InlineV1InvoicesCreatePreviewPostRequestFormPriceDataXd9ecc710.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1InvoicesCreatePreviewPostRequestFormPriceDataXd9ecc710 is missing required property '" + name +
                    "'",
            )
