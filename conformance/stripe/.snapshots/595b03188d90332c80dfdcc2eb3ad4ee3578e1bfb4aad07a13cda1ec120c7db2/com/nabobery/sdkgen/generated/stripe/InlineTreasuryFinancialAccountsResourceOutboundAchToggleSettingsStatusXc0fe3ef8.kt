...
public sealed class InlineTreasuryFinancialAccountsResourceOutboundAchToggleSettingsStatusXc0fe3ef8 {
    ...
    public object Serializer : KSerializer<InlineTreasuryFinancialAccountsResourceOutboundAchToggleSettingsStatusXc0fe3ef8> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineTreasuryFinancialAccountsResourceOutboundAchToggleSettingsStatusXc0fe3ef8",
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineTreasuryFinancialAccountsResourceOutboundAchToggleSettingsStatusXc0fe3ef8,
        ) {
