...
public class TreasurySharedResourceInitiatingPaymentMethodDetailsUsBankAccount(
    ...
    public class Builder {
        ...
        public fun build(): TreasurySharedResourceInitiatingPaymentMethodDetailsUsBankAccount =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): TreasurySharedResourceInitiatingPaymentMethodDetailsUsBankAccount =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<TreasurySharedResourceInitiatingPaymentMethodDetailsUsBankAccount> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "TreasurySharedResourceInitiatingPaymentMethodDetailsUsBankAccount must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: TreasurySharedResourceInitiatingPaymentMethodDetailsUsBankAccount,
        ) {
            val jsonEncoder =
...
public fun treasurySharedResourceInitiatingPaymentMethodDetailsUsBankAccount(
    block: TreasurySharedResourceInitiatingPaymentMethodDetailsUsBankAccount.Builder.() -> Unit,
): TreasurySharedResourceInitiatingPaymentMethodDetailsUsBankAccount =
    TreasurySharedResourceInitiatingPaymentMethodDetailsUsBankAccount.build(block)
