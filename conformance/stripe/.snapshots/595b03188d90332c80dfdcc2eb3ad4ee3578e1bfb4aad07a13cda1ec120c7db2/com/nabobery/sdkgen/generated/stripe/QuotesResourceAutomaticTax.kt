...
public class QuotesResourceAutomaticTax(
    ...
    public object Serializer : KSerializer<QuotesResourceAutomaticTax> {
        ...
        override fun deserialize(decoder: Decoder): QuotesResourceAutomaticTax {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("QuotesResourceAutomaticTax must be a JSON object")
                ...
                liability =
                    rawObject["liability"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineQuotesResourceAutomaticTaxLiabilityX4f951183?>(element)
                        }
                    },
                provider =
                ...
                status =
                    rawObject["status"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineQuotesResourceAutomaticTaxStatusX5a0812d5?>(element)
                        }
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: QuotesResourceAutomaticTax,
        ) {
...
public fun quotesResourceAutomaticTax(
    block: QuotesResourceAutomaticTax.Builder.() -> Unit,
): QuotesResourceAutomaticTax = QuotesResourceAutomaticTax.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException("QuotesResourceAutomaticTax is missing required property '" + name + "'")
