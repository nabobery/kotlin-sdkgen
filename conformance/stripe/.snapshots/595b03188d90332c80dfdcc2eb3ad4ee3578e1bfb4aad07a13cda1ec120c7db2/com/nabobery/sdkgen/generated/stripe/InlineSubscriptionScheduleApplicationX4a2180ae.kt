...
public class InlineSubscriptionScheduleApplicationX4a2180ae internal constructor(
        ...
        get() =
            buildSet {
                ...
                if (inspection.matchesDeletedApplication) {
                    add(
                        InlineSubscriptionScheduleApplicationX4a2180aeBranch.DeletedApplication,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineSubscriptionScheduleApplicationX4a2180ae {
            val inspection = inspectInlineSubscriptionScheduleApplicationX4a2180ae(raw)
            if (inspection.matchCount == 0) {
                throw InlineSubscriptionScheduleApplicationX4a2180aeNoMatchException(
                    "InlineSubscriptionScheduleApplicationX4a2180ae matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineSubscriptionScheduleApplicationX4a2180ae> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineSubscriptionScheduleApplicationX4a2180ae,
        ) {
...
private fun inspectInlineSubscriptionScheduleApplicationX4a2180ae(
    element: JsonElement,
): InlineSubscriptionScheduleApplicationX4a2180aeInspection {
