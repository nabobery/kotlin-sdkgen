...
public class InlineV1AccountsPostRequestFormBusinessProfileAnnualRevenueX7f013cbd(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1AccountsPostRequestFormBusinessProfileAnnualRevenueX7f013cbd = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1AccountsPostRequestFormBusinessProfileAnnualRevenueX7f013cbd> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountsPostRequestFormBusinessProfileAnnualRevenueX7f013cbd must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPostRequestFormBusinessProfileAnnualRevenueX7f013cbd,
        ) {
            val jsonEncoder =
...
public fun inlineV1AccountsPostRequestFormBusinessProfileAnnualRevenueX7f013cbd(
    block: InlineV1AccountsPostRequestFormBusinessProfileAnnualRevenueX7f013cbd.Builder.() -> Unit,
): InlineV1AccountsPostRequestFormBusinessProfileAnnualRevenueX7f013cbd =
    InlineV1AccountsPostRequestFormBusinessProfileAnnualRevenueX7f013cbd.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1AccountsPostRequestFormBusinessProfileAnnualRevenueX7f013cbd is missing required property '" +
                    name +
                    "'",
            )
