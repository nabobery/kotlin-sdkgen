...
public class CheckoutSwishPaymentMethodOptions(
    ...
    public class Builder {
        ...
        public fun build(): CheckoutSwishPaymentMethodOptions =
    ...
    public object Serializer : KSerializer<CheckoutSwishPaymentMethodOptions> {
        ...
        override fun deserialize(decoder: Decoder): CheckoutSwishPaymentMethodOptions {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("CheckoutSwishPaymentMethodOptions must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: CheckoutSwishPaymentMethodOptions,
        ) {
...
public fun checkoutSwishPaymentMethodOptions(
    block: CheckoutSwishPaymentMethodOptions.Builder.() -> Unit,
): CheckoutSwishPaymentMethodOptions = CheckoutSwishPaymentMethodOptions.build(block)
