...
public sealed class InlineV1PaymentIntentsConfirmPostRequestFormIntervalX4adea7c5 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1PaymentIntentsConfirmPostRequestFormIntervalX4adea7c5 =
            when (value) {
                Month.value -> Month
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsConfirmPostRequestFormIntervalX4adea7c5> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1PaymentIntentsConfirmPostRequestFormIntervalX4adea7c5",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1PaymentIntentsConfirmPostRequestFormIntervalX4adea7c5 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsConfirmPostRequestFormIntervalX4adea7c5,
        ) {
