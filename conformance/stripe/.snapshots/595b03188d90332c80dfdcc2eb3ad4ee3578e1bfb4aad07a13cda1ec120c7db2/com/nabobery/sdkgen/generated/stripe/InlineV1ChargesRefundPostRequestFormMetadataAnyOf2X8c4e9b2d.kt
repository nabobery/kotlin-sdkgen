...
public sealed class InlineV1ChargesRefundPostRequestFormMetadataAnyOf2X8c4e9b2d {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1ChargesRefundPostRequestFormMetadataAnyOf2X8c4e9b2d =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1ChargesRefundPostRequestFormMetadataAnyOf2X8c4e9b2d> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1ChargesRefundPostRequestFormMetadataAnyOf2X8c4e9b2d",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1ChargesRefundPostRequestFormMetadataAnyOf2X8c4e9b2d =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ChargesRefundPostRequestFormMetadataAnyOf2X8c4e9b2d,
        ) {
