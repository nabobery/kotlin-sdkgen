...
public class InlineCustomerBalanceTransactionCheckoutSessionX2b2ae84c internal constructor(
    ...
    public val checkoutSession: CheckoutSession? by
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesCheckoutSession) json.decodeFromJsonElement<CheckoutSession>(raw) else null
        }
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineCustomerBalanceTransactionCheckoutSessionX2b2ae84cBranch.Branch1,
                    )
                }
                if (inspection.matchesCheckoutSession) {
                    add(
                        InlineCustomerBalanceTransactionCheckoutSessionX2b2ae84cBranch.CheckoutSession,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineCustomerBalanceTransactionCheckoutSessionX2b2ae84c {
            val inspection = inspectInlineCustomerBalanceTransactionCheckoutSessionX2b2ae84c(raw)
            if (inspection.matchCount == 0) {
                throw InlineCustomerBalanceTransactionCheckoutSessionX2b2ae84cNoMatchException(
                    "InlineCustomerBalanceTransactionCheckoutSessionX2b2ae84c matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineCustomerBalanceTransactionCheckoutSessionX2b2ae84c> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineCustomerBalanceTransactionCheckoutSessionX2b2ae84c,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineCustomerBalanceTransactionCheckoutSessionX2b2ae84c",
...
private fun inspectInlineCustomerBalanceTransactionCheckoutSessionX2b2ae84c(
    element: JsonElement,
): InlineCustomerBalanceTransactionCheckoutSessionX2b2ae84cInspection {
