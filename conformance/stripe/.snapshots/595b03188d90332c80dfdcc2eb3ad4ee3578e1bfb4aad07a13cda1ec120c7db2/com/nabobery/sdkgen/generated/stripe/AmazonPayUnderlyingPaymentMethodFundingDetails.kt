...
public class AmazonPayUnderlyingPaymentMethodFundingDetails(
    ...
    public class Builder {
        ...
        public fun build(): AmazonPayUnderlyingPaymentMethodFundingDetails =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): AmazonPayUnderlyingPaymentMethodFundingDetails =
    ...
    public object Serializer : KSerializer<AmazonPayUnderlyingPaymentMethodFundingDetails> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "AmazonPayUnderlyingPaymentMethodFundingDetails must be a JSON object",
                    )
                ...
                type =
                    rawObject["type"]?.let { element ->
                        if (element ==
                            ...
                            json
                                .decodeFromJsonElement<InlineAmazonPayUnderlyingPaymentMethodFundingDetailsTypeXf7bea956?>(
                                    element,
                                )
                        }
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: AmazonPayUnderlyingPaymentMethodFundingDetails,
        ) {
...
public fun amazonPayUnderlyingPaymentMethodFundingDetails(
    block: AmazonPayUnderlyingPaymentMethodFundingDetails.Builder.() -> Unit,
): AmazonPayUnderlyingPaymentMethodFundingDetails = AmazonPayUnderlyingPaymentMethodFundingDetails.build(block)
