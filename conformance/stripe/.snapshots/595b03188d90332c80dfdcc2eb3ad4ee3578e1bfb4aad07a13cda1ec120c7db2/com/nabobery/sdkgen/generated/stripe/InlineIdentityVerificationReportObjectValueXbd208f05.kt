...
public sealed class InlineIdentityVerificationReportObjectValueXbd208f05 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineIdentityVerificationReportObjectValueXbd208f05 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineIdentityVerificationReportObjectValueXbd208f05> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineIdentityVerificationReportObjectValueXbd208f05",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineIdentityVerificationReportObjectValueXbd208f05 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineIdentityVerificationReportObjectValueXbd208f05,
        ) {
