...
public sealed class InlineV1CustomersSubscriptionsPostRequestFormVerificationMethodX11675a46 {
    ...
    public object Serializer : KSerializer<InlineV1CustomersSubscriptionsPostRequestFormVerificationMethodX11675a46> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1CustomersSubscriptionsPostRequestFormVerificationMethodX11675a46",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1CustomersSubscriptionsPostRequestFormVerificationMethodX11675a46 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersSubscriptionsPostRequestFormVerificationMethodX11675a46,
        ) {
