...
public class InvoiceMandateOptionsCard(
    ...
    public class Builder {
        ...
        public fun build(): InvoiceMandateOptionsCard =
    ...
    public object Serializer : KSerializer<InvoiceMandateOptionsCard> {
        ...
        override fun deserialize(decoder: Decoder): InvoiceMandateOptionsCard {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("InvoiceMandateOptionsCard must be a JSON object")
                ...
                amountType =
                    rawObject["amount_type"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineInvoiceMandateOptionsCardAmountTypeX6ac78e8e?>(element)
                        }
                    },
                description =
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InvoiceMandateOptionsCard,
        ) {
...
public fun invoiceMandateOptionsCard(block: InvoiceMandateOptionsCard.Builder.() -> Unit): InvoiceMandateOptionsCard =
    InvoiceMandateOptionsCard.build(block)
