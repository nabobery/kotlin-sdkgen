...
public sealed class InlineTaxProductResourceTaxSettingsDefaultsProviderX202ce9a1 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineTaxProductResourceTaxSettingsDefaultsProviderX202ce9a1 =
            when (value) {
                Anrok.value -> Anrok
    ...
    public object Serializer : KSerializer<InlineTaxProductResourceTaxSettingsDefaultsProviderX202ce9a1> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineTaxProductResourceTaxSettingsDefaultsProviderX202ce9a1",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineTaxProductResourceTaxSettingsDefaultsProviderX202ce9a1 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineTaxProductResourceTaxSettingsDefaultsProviderX202ce9a1,
        ) {
