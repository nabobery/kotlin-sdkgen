...
public class ConnectEmbeddedFinancialAccountTransactionsConfigClaim(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): ConnectEmbeddedFinancialAccountTransactionsConfigClaim =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<ConnectEmbeddedFinancialAccountTransactionsConfigClaim> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "ConnectEmbeddedFinancialAccountTransactionsConfigClaim must be a JSON object",
                    )
            val enabled = json.decodeRequired<Boolean>(rawObject, "enabled")
            val features =
                json.decodeRequired<ConnectEmbeddedFinancialAccountTransactionsFeatures>(
                    rawObject,
                    "features",
                )
            return ConnectEmbeddedFinancialAccountTransactionsConfigClaim(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: ConnectEmbeddedFinancialAccountTransactionsConfigClaim,
        ) {
...
public fun connectEmbeddedFinancialAccountTransactionsConfigClaim(
    block: ConnectEmbeddedFinancialAccountTransactionsConfigClaim.Builder.() -> Unit,
): ConnectEmbeddedFinancialAccountTransactionsConfigClaim =
    ConnectEmbeddedFinancialAccountTransactionsConfigClaim.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "ConnectEmbeddedFinancialAccountTransactionsConfigClaim is missing required property '" + name + "'",
            )
