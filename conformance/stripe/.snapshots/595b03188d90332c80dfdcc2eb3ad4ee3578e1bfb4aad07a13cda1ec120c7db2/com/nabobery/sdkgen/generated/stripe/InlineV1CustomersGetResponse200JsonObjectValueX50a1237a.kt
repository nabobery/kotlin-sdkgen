...
public sealed class InlineV1CustomersGetResponse200JsonObjectValueX50a1237a {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1CustomersGetResponse200JsonObjectValueX50a1237a =
            when (value) {
                List.value -> List
    ...
    public object Serializer : KSerializer<InlineV1CustomersGetResponse200JsonObjectValueX50a1237a> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1CustomersGetResponse200JsonObjectValueX50a1237a",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1CustomersGetResponse200JsonObjectValueX50a1237a =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersGetResponse200JsonObjectValueX50a1237a,
        ) {
