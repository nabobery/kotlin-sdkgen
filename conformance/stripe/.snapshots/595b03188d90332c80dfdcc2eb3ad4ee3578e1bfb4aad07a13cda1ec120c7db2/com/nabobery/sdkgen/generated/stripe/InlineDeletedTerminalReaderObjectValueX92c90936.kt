...
public sealed class InlineDeletedTerminalReaderObjectValueX92c90936 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineDeletedTerminalReaderObjectValueX92c90936 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineDeletedTerminalReaderObjectValueX92c90936> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineDeletedTerminalReaderObjectValueX92c90936",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineDeletedTerminalReaderObjectValueX92c90936 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineDeletedTerminalReaderObjectValueX92c90936,
        ) {
