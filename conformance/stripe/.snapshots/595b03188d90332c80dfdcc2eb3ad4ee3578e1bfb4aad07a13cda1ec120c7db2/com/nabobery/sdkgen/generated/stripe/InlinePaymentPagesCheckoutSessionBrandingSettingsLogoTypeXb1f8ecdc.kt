...
public sealed class InlinePaymentPagesCheckoutSessionBrandingSettingsLogoTypeXb1f8ecdc {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentPagesCheckoutSessionBrandingSettingsLogoTypeXb1f8ecdc =
            when (value) {
                File.value -> File
                Url.value -> Url
    ...
    public object Serializer : KSerializer<InlinePaymentPagesCheckoutSessionBrandingSettingsLogoTypeXb1f8ecdc> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentPagesCheckoutSessionBrandingSettingsLogoTypeXb1f8ecdc",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePaymentPagesCheckoutSessionBrandingSettingsLogoTypeXb1f8ecdc =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentPagesCheckoutSessionBrandingSettingsLogoTypeXb1f8ecdc,
        ) {
