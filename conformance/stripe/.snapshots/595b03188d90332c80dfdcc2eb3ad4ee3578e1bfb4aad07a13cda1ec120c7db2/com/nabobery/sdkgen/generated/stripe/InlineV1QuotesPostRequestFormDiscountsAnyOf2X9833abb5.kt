...
public sealed class InlineV1QuotesPostRequestFormDiscountsAnyOf2X9833abb5 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1QuotesPostRequestFormDiscountsAnyOf2X9833abb5 =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1QuotesPostRequestFormDiscountsAnyOf2X9833abb5> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1QuotesPostRequestFormDiscountsAnyOf2X9833abb5",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1QuotesPostRequestFormDiscountsAnyOf2X9833abb5 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1QuotesPostRequestFormDiscountsAnyOf2X9833abb5,
        ) {
