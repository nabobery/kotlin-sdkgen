...
public class InlineV1PaymentMethodsPostRequestFormSepaDebitXb60dc83a(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PaymentMethodsPostRequestFormSepaDebitXb60dc83a =
    ...
    public object Serializer : KSerializer<InlineV1PaymentMethodsPostRequestFormSepaDebitXb60dc83a> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentMethodsPostRequestFormSepaDebitXb60dc83a must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentMethodsPostRequestFormSepaDebitXb60dc83a,
        ) {
...
public fun inlineV1PaymentMethodsPostRequestFormSepaDebitXb60dc83a(
    block: InlineV1PaymentMethodsPostRequestFormSepaDebitXb60dc83a.Builder.() -> Unit,
): InlineV1PaymentMethodsPostRequestFormSepaDebitXb60dc83a =
    InlineV1PaymentMethodsPostRequestFormSepaDebitXb60dc83a.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentMethodsPostRequestFormSepaDebitXb60dc83a is missing required property '" + name + "'",
            )
