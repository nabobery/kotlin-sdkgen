...
public sealed class InlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextAnyOf2X9e6b0ed8 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextAnyOf2X9e6b0ed8 =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextAnyOf2X9e6b0ed8> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextAnyOf2X9e6b0ed8",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextAnyOf2X9e6b0ed8 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextAnyOf2X9e6b0ed8,
        ) {
