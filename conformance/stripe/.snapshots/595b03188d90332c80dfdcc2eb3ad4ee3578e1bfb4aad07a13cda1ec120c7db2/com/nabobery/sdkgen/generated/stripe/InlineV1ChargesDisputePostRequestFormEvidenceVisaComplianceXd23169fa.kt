...
public class InlineV1ChargesDisputePostRequestFormEvidenceVisaComplianceXd23169fa(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1ChargesDisputePostRequestFormEvidenceVisaComplianceXd23169fa =
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1ChargesDisputePostRequestFormEvidenceVisaComplianceXd23169fa = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1ChargesDisputePostRequestFormEvidenceVisaComplianceXd23169fa> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1ChargesDisputePostRequestFormEvidenceVisaComplianceXd23169fa must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ChargesDisputePostRequestFormEvidenceVisaComplianceXd23169fa,
        ) {
            val jsonEncoder =
...
public fun inlineV1ChargesDisputePostRequestFormEvidenceVisaComplianceXd23169fa(
    block: InlineV1ChargesDisputePostRequestFormEvidenceVisaComplianceXd23169fa.Builder.() -> Unit,
): InlineV1ChargesDisputePostRequestFormEvidenceVisaComplianceXd23169fa =
    InlineV1ChargesDisputePostRequestFormEvidenceVisaComplianceXd23169fa.build(block)
