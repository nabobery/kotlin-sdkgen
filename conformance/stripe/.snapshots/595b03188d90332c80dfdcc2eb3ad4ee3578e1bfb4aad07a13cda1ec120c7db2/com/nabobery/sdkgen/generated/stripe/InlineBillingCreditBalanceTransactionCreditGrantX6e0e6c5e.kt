...
public class InlineBillingCreditBalanceTransactionCreditGrantX6e0e6c5e internal constructor(
    ...
    public val billingCreditGrant: BillingCreditGrant? by
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesBillingCreditGrant) json.decodeFromJsonElement<BillingCreditGrant>(raw) else null
        }
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineBillingCreditBalanceTransactionCreditGrantX6e0e6c5eBranch.Branch1,
                    )
                }
                if (inspection.matchesBillingCreditGrant) {
                    add(
                        InlineBillingCreditBalanceTransactionCreditGrantX6e0e6c5eBranch.BillingCreditGrant,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineBillingCreditBalanceTransactionCreditGrantX6e0e6c5e {
            val inspection = inspectInlineBillingCreditBalanceTransactionCreditGrantX6e0e6c5e(raw)
            if (inspection.matchCount == 0) {
                throw InlineBillingCreditBalanceTransactionCreditGrantX6e0e6c5eNoMatchException(
                    "InlineBillingCreditBalanceTransactionCreditGrantX6e0e6c5e matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineBillingCreditBalanceTransactionCreditGrantX6e0e6c5e> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineBillingCreditBalanceTransactionCreditGrantX6e0e6c5e,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineBillingCreditBalanceTransactionCreditGrantX6e0e6c5e",
...
private fun inspectInlineBillingCreditBalanceTransactionCreditGrantX6e0e6c5e(
    element: JsonElement,
): InlineBillingCreditBalanceTransactionCreditGrantX6e0e6c5eInspection {
