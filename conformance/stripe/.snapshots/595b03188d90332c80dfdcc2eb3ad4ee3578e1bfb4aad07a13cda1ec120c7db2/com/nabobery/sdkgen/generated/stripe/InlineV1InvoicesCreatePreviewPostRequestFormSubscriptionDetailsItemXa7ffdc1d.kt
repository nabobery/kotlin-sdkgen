...
public class InlineV1InvoicesCreatePreviewPostRequestFormSubscriptionDetailsItemXa7ffdc1d(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1InvoicesCreatePreviewPostRequestFormSubscriptionDetailsItemXa7ffdc1d = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1InvoicesCreatePreviewPostRequestFormSubscriptionDetailsItemXa7ffdc1d> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1InvoicesCreatePreviewPostRequestFormSubscriptionDetailsItemXa7ffdc1d must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineV1InvoicesCreatePreviewPostRequestFormSubscriptionDetailsTypeXddc93d6c>(
                    rawObject,
                    "type",
                )
            return InlineV1InvoicesCreatePreviewPostRequestFormSubscriptionDetailsItemXa7ffdc1d(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesCreatePreviewPostRequestFormSubscriptionDetailsItemXa7ffdc1d,
        ) {
            val jsonEncoder =
...
public fun inlineV1InvoicesCreatePreviewPostRequestFormSubscriptionDetailsItemXa7ffdc1d(
    block: InlineV1InvoicesCreatePreviewPostRequestFormSubscriptionDetailsItemXa7ffdc1d.Builder.() -> Unit,
): InlineV1InvoicesCreatePreviewPostRequestFormSubscriptionDetailsItemXa7ffdc1d =
    InlineV1InvoicesCreatePreviewPostRequestFormSubscriptionDetailsItemXa7ffdc1d.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1InvoicesCreatePreviewPostRequestFormSubscriptionDetailsItemXa7ffdc1d is missing required property '" +
                    name +
                    "'",
            )
