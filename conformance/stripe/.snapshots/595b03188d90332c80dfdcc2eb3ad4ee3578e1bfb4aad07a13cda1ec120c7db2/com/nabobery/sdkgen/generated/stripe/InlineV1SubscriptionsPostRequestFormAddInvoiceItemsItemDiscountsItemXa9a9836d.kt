...
public class InlineV1SubscriptionsPostRequestFormAddInvoiceItemsItemDiscountsItemXa9a9836d(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1SubscriptionsPostRequestFormAddInvoiceItemsItemDiscountsItemXa9a9836d =
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionsPostRequestFormAddInvoiceItemsItemDiscountsItemXa9a9836d> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SubscriptionsPostRequestFormAddInvoiceItemsItemDiscountsItemXa9a9836d must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsPostRequestFormAddInvoiceItemsItemDiscountsItemXa9a9836d,
        ) {
            val jsonEncoder =
...
public fun inlineV1SubscriptionsPostRequestFormAddInvoiceItemsItemDiscountsItemXa9a9836d(
    block: InlineV1SubscriptionsPostRequestFormAddInvoiceItemsItemDiscountsItemXa9a9836d.Builder.() -> Unit,
): InlineV1SubscriptionsPostRequestFormAddInvoiceItemsItemDiscountsItemXa9a9836d =
    InlineV1SubscriptionsPostRequestFormAddInvoiceItemsItemDiscountsItemXa9a9836d.build(block)
