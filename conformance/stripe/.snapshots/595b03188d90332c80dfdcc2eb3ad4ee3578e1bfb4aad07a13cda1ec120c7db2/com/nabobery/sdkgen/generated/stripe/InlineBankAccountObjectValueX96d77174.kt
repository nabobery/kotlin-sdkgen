...
public sealed class InlineBankAccountObjectValueX96d77174 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineBankAccountObjectValueX96d77174 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineBankAccountObjectValueX96d77174> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineBankAccountObjectValueX96d77174",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineBankAccountObjectValueX96d77174 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineBankAccountObjectValueX96d77174,
        ) {
