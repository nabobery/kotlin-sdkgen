...
public sealed class InlineTerminalReaderReaderResourceReaderActionStatusX32065a9f {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineTerminalReaderReaderResourceReaderActionStatusX32065a9f =
            when (value) {
                Failed.value -> Failed
    ...
    public object Serializer : KSerializer<InlineTerminalReaderReaderResourceReaderActionStatusX32065a9f> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineTerminalReaderReaderResourceReaderActionStatusX32065a9f",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineTerminalReaderReaderResourceReaderActionStatusX32065a9f =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineTerminalReaderReaderResourceReaderActionStatusX32065a9f,
        ) {
