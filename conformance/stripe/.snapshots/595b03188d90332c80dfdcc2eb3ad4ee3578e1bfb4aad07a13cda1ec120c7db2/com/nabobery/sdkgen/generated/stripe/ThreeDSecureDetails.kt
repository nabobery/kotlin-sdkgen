...
public data class ThreeDSecureDetailsView(
    ...
    public val electronicCommerceIndicator: InlineThreeDSecureDetailsElectronicCommerceIndicatorX3d6885c0? = null,
...
public class ThreeDSecureDetails(
    ...
    public class Builder {
        ...
        public fun build(): ThreeDSecureDetails =
            ThreeDSecureDetails(
    ...
    public object Serializer : KSerializer<ThreeDSecureDetails> {
        ...
        override fun deserialize(decoder: Decoder): ThreeDSecureDetails {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("ThreeDSecureDetails must be a JSON object")
                ...
                authenticationFlow =
                    rawObject["authentication_flow"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineThreeDSecureDetailsAuthenticationFlowXb45f3ee0?>(element)
                        }
                    },
                electronicCommerceIndicator =
                    rawObject["electronic_commerce_indicator"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineThreeDSecureDetailsElectronicCommerceIndicatorX3d6885c0?>(
                                element,
                            )
                        }
                    },
                result =
                    rawObject["result"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineThreeDSecureDetailsResultXd3f6595d?>(element)
                        }
                    },
                resultReason =
                    rawObject["result_reason"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineThreeDSecureDetailsResultReasonX97352a26?>(element)
                        }
                    },
                transactionId =
                ...
                version =
                    rawObject["version"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineThreeDSecureDetailsVersionX2c2943f6?>(element)
                        }
                    },
            )
        }
...
public fun threeDSecureDetails(block: ThreeDSecureDetails.Builder.() -> Unit): ThreeDSecureDetails =
    ThreeDSecureDetails.build(block)
