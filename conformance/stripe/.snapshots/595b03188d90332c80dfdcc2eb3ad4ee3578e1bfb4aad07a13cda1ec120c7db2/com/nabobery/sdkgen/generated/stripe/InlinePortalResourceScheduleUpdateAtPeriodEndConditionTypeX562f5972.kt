...
public sealed class InlinePortalResourceScheduleUpdateAtPeriodEndConditionTypeX562f5972 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePortalResourceScheduleUpdateAtPeriodEndConditionTypeX562f5972 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlinePortalResourceScheduleUpdateAtPeriodEndConditionTypeX562f5972> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePortalResourceScheduleUpdateAtPeriodEndConditionTypeX562f5972",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlinePortalResourceScheduleUpdateAtPeriodEndConditionTypeX562f5972 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePortalResourceScheduleUpdateAtPeriodEndConditionTypeX562f5972,
        ) {
