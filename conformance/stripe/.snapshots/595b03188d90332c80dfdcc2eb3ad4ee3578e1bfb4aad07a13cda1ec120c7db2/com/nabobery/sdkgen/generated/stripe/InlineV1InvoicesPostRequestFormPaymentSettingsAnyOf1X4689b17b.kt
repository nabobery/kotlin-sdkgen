...
public class InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X4689b17b(
    public val amountIncludesIof: InlineV1InvoicesPostRequestFormPaymentSettingsAmountIncludesIofX353341c5? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X4689b17b =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X4689b17b =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X4689b17b> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X4689b17b must be a JSON object",
                    )
            return InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X4689b17b(
                amountIncludesIof =
                    rawObject["amount_includes_iof"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1InvoicesPostRequestFormPaymentSettingsAmountIncludesIofX353341c5>(
                                it,
                            )
                    },
                expiresAfterSeconds =
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X4689b17b,
        ) {
            val jsonEncoder =
...
public fun inlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X4689b17b(
    block: InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X4689b17b.Builder.() -> Unit,
): InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X4689b17b =
    InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X4689b17b.build(block)
