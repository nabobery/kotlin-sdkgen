...
internal data class InlineV1ChargesDisputePostRequestFormEvidenceCustomerEmailAddressX4a478d96Inspection(
    ...
    public val matchesInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2X20e27f0b: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2X20e27f0b,
            ).count {
                it
            }
}
...
public class InlineV1ChargesDisputePostRequestFormEvidenceCustomerEmailAddressX4a478d96 internal constructor(
    ...
    private val inspection: InlineV1ChargesDisputePostRequestFormEvidenceCustomerEmailAddressX4a478d96Inspection,
) {
    ...
    public val inlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2X20e27f0b:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2X20e27f0b) {
                json
                    .decodeFromJsonElement<InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2X20e27f0b>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1ChargesDisputePostRequestFormEvidenceCustomerEmailAddressX4a478d96Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2X20e27f0b) {
                    add(
                        InlineV1ChargesDisputePostRequestFormEvidenceCustomerEmailAddressX4a478d96Branch.InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2X20e27f0b,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1ChargesDisputePostRequestFormEvidenceCustomerEmailAddressX4a478d96 {
            val inspection = inspectInlineV1ChargesDisputePostRequestFormEvidenceCustomerEmailAddressX4a478d96(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1ChargesDisputePostRequestFormEvidenceCustomerEmailAddressX4a478d96NoMatchException(
                    "InlineV1ChargesDisputePostRequestFormEvidenceCustomerEmailAddressX4a478d96 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1ChargesDisputePostRequestFormEvidenceCustomerEmailAddressX4a478d96> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ChargesDisputePostRequestFormEvidenceCustomerEmailAddressX4a478d96,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1ChargesDisputePostRequestFormEvidenceCustomerEmailAddressX4a478d96",
...
private fun inspectInlineV1ChargesDisputePostRequestFormEvidenceCustomerEmailAddressX4a478d96(
    element: JsonElement,
): InlineV1ChargesDisputePostRequestFormEvidenceCustomerEmailAddressX4a478d96Inspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2X20e27f0b =
        element
            .isJsonDecodable<InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2X20e27f0b>()
    return InlineV1ChargesDisputePostRequestFormEvidenceCustomerEmailAddressX4a478d96Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2X20e27f0b) {
                    add(
                        "InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2X20e27f0b: value does not match InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2X20e27f0b",
                    )
                }
            },
    )
