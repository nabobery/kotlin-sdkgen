...
public class InlineV1SubscriptionsPostRequestFormInvoiceSettingsIssuerX2cff3c51(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1SubscriptionsPostRequestFormInvoiceSettingsIssuerX2cff3c51 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionsPostRequestFormInvoiceSettingsIssuerX2cff3c51> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SubscriptionsPostRequestFormInvoiceSettingsIssuerX2cff3c51 must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineV1SubscriptionsPostRequestFormInvoiceSettingsIssuerTypeXf32f58de>(
                    rawObject,
                    "type",
                )
            return InlineV1SubscriptionsPostRequestFormInvoiceSettingsIssuerX2cff3c51(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsPostRequestFormInvoiceSettingsIssuerX2cff3c51,
        ) {
            val jsonEncoder =
...
public fun inlineV1SubscriptionsPostRequestFormInvoiceSettingsIssuerX2cff3c51(
    block: InlineV1SubscriptionsPostRequestFormInvoiceSettingsIssuerX2cff3c51.Builder.() -> Unit,
): InlineV1SubscriptionsPostRequestFormInvoiceSettingsIssuerX2cff3c51 =
    InlineV1SubscriptionsPostRequestFormInvoiceSettingsIssuerX2cff3c51.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1SubscriptionsPostRequestFormInvoiceSettingsIssuerX2cff3c51 is missing required property '" +
                    name +
                    "'",
            )
