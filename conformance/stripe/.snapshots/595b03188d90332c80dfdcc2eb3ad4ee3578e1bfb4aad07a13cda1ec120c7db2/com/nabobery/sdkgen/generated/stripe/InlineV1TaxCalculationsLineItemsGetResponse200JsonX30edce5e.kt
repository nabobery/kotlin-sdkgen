...
public class InlineV1TaxCalculationsLineItemsGetResponse200JsonX30edce5e(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TaxCalculationsLineItemsGetResponse200JsonX30edce5e =
    ...
    public object Serializer : KSerializer<InlineV1TaxCalculationsLineItemsGetResponse200JsonX30edce5e> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1TaxCalculationsLineItemsGetResponse200JsonX30edce5e {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TaxCalculationsLineItemsGetResponse200JsonX30edce5e must be a JSON object",
                    )
            ...
            val objectValue =
                json.decodeRequired<InlineV1TaxCalculationsLineItemsGetResponse200JsonObjectValueX746a89cc>(
                    rawObject,
                    "object",
                )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TaxCalculationsLineItemsGetResponse200JsonX30edce5e,
        ) {
...
public fun inlineV1TaxCalculationsLineItemsGetResponse200JsonX30edce5e(
    block: InlineV1TaxCalculationsLineItemsGetResponse200JsonX30edce5e.Builder.() -> Unit,
): InlineV1TaxCalculationsLineItemsGetResponse200JsonX30edce5e =
    InlineV1TaxCalculationsLineItemsGetResponse200JsonX30edce5e.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TaxCalculationsLineItemsGetResponse200JsonX30edce5e is missing required property '" + name +
                    "'",
            )
