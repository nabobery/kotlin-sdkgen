...
public class InlineLegalEntityCompanyVerificationDocumentBackX113d3925 internal constructor(
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineLegalEntityCompanyVerificationDocumentBackX113d3925Branch.Branch1,
                    )
                }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineLegalEntityCompanyVerificationDocumentBackX113d3925 {
            val inspection = inspectInlineLegalEntityCompanyVerificationDocumentBackX113d3925(raw)
            if (inspection.matchCount == 0) {
                throw InlineLegalEntityCompanyVerificationDocumentBackX113d3925NoMatchException(
                    "InlineLegalEntityCompanyVerificationDocumentBackX113d3925 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineLegalEntityCompanyVerificationDocumentBackX113d3925> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineLegalEntityCompanyVerificationDocumentBackX113d3925,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineLegalEntityCompanyVerificationDocumentBackX113d3925",
...
private fun inspectInlineLegalEntityCompanyVerificationDocumentBackX113d3925(
    element: JsonElement,
): InlineLegalEntityCompanyVerificationDocumentBackX113d3925Inspection {
