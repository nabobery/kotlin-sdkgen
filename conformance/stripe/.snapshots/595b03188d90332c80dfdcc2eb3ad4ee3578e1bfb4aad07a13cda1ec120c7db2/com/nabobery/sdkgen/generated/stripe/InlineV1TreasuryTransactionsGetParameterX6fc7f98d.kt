...
public sealed class InlineV1TreasuryTransactionsGetParameterX6fc7f98d {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1TreasuryTransactionsGetParameterX6fc7f98d =
            when (value) {
                Open.value -> Open
                Posted.value -> Posted
                Void.value -> Void
    ...
    public object Serializer : KSerializer<InlineV1TreasuryTransactionsGetParameterX6fc7f98d> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1TreasuryTransactionsGetParameterX6fc7f98d",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1TreasuryTransactionsGetParameterX6fc7f98d =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TreasuryTransactionsGetParameterX6fc7f98d,
        ) {
