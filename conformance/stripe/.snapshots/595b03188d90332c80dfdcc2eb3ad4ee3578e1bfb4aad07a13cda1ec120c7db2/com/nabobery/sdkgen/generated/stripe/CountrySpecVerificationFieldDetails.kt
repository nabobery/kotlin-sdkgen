...
public class CountrySpecVerificationFieldDetails(
    ...
    public class Builder {
        ...
        public var additional: List<String>
            get() = requireNotNull(additionalValue) { "additional is required" }
            set(`value`) {
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): CountrySpecVerificationFieldDetails =
    ...
    public object Serializer : KSerializer<CountrySpecVerificationFieldDetails> {
        ...
        override fun deserialize(decoder: Decoder): CountrySpecVerificationFieldDetails {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("CountrySpecVerificationFieldDetails must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: CountrySpecVerificationFieldDetails,
        ) {
...
public fun countrySpecVerificationFieldDetails(
    block: CountrySpecVerificationFieldDetails.Builder.() -> Unit,
): CountrySpecVerificationFieldDetails = CountrySpecVerificationFieldDetails.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "CountrySpecVerificationFieldDetails is missing required property '" + name + "'",
            )
