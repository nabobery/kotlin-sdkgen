...
public sealed class InlineInvoicePaymentMethodOptionsCardRequestThreeDSecureX6b0f6085 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineInvoicePaymentMethodOptionsCardRequestThreeDSecureX6b0f6085 =
            when (value) {
                Any.value -> Any
    ...
    public object Serializer : KSerializer<InlineInvoicePaymentMethodOptionsCardRequestThreeDSecureX6b0f6085> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineInvoicePaymentMethodOptionsCardRequestThreeDSecureX6b0f6085",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineInvoicePaymentMethodOptionsCardRequestThreeDSecureX6b0f6085 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineInvoicePaymentMethodOptionsCardRequestThreeDSecureX6b0f6085,
        ) {
