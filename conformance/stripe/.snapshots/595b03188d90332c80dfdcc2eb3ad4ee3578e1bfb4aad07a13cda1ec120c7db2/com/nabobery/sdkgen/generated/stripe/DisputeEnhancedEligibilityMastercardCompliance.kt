...
public class DisputeEnhancedEligibilityMastercardCompliance(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): DisputeEnhancedEligibilityMastercardCompliance =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<DisputeEnhancedEligibilityMastercardCompliance> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "DisputeEnhancedEligibilityMastercardCompliance must be a JSON object",
                    )
            val status =
                json.decodeRequired<InlineDisputeEnhancedEligibilityMastercardComplianceStatusXd1c2fcf7>(
                    rawObject,
                    "status",
                )
            return DisputeEnhancedEligibilityMastercardCompliance(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: DisputeEnhancedEligibilityMastercardCompliance,
        ) {
...
public fun disputeEnhancedEligibilityMastercardCompliance(
    block: DisputeEnhancedEligibilityMastercardCompliance.Builder.() -> Unit,
): DisputeEnhancedEligibilityMastercardCompliance = DisputeEnhancedEligibilityMastercardCompliance.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "DisputeEnhancedEligibilityMastercardCompliance is missing required property '" + name + "'",
            )
