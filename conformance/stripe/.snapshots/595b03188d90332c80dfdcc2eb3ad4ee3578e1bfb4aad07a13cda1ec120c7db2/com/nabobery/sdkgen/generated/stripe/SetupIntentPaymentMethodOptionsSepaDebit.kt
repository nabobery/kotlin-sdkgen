...
public class SetupIntentPaymentMethodOptionsSepaDebit(
    ...
    public class Builder {
        ...
        public fun build(): SetupIntentPaymentMethodOptionsSepaDebit =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): SetupIntentPaymentMethodOptionsSepaDebit =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<SetupIntentPaymentMethodOptionsSepaDebit> {
        ...
        override fun deserialize(decoder: Decoder): SetupIntentPaymentMethodOptionsSepaDebit {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("SetupIntentPaymentMethodOptionsSepaDebit must be a JSON object")
            return SetupIntentPaymentMethodOptionsSepaDebit(
                mandateOptions =
                    rawObject["mandate_options"]?.let {
                        json.decodeFromJsonElement<SetupIntentPaymentMethodOptionsMandateOptionsSepaDebit>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: SetupIntentPaymentMethodOptionsSepaDebit,
        ) {
...
public fun setupIntentPaymentMethodOptionsSepaDebit(
    block: SetupIntentPaymentMethodOptionsSepaDebit.Builder.() -> Unit,
): SetupIntentPaymentMethodOptionsSepaDebit = SetupIntentPaymentMethodOptionsSepaDebit.build(block)
