...
public class InlineV1AccountsPeoplePostRequestFormVerificationAdditionalDocumentX0a446d4f(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1AccountsPeoplePostRequestFormVerificationAdditionalDocumentX0a446d4f =
            InlineV1AccountsPeoplePostRequestFormVerificationAdditionalDocumentX0a446d4f(
                back = back,
                front = front,
            )
    }
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1AccountsPeoplePostRequestFormVerificationAdditionalDocumentX0a446d4f = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1AccountsPeoplePostRequestFormVerificationAdditionalDocumentX0a446d4f> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountsPeoplePostRequestFormVerificationAdditionalDocumentX0a446d4f must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPeoplePostRequestFormVerificationAdditionalDocumentX0a446d4f,
        ) {
            val jsonEncoder =
...
public fun inlineV1AccountsPeoplePostRequestFormVerificationAdditionalDocumentX0a446d4f(
    block: InlineV1AccountsPeoplePostRequestFormVerificationAdditionalDocumentX0a446d4f.Builder.() -> Unit,
): InlineV1AccountsPeoplePostRequestFormVerificationAdditionalDocumentX0a446d4f =
