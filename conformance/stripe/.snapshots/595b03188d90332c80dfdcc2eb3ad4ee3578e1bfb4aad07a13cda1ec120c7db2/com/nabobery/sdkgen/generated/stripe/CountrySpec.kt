...
public class CountrySpec(
    ...
    public class Builder {
        ...
        public var supportedBankAccountCurrencies: Map<String, List<String>>
            get() = requireNotNull(supportedBankAccountCurrenciesValue) { "supportedBankAccountCurrencies is required" }
            set(`value`) {
                supportedBankAccountCurrenciesValue = value
            }

        private var supportedPaymentCurrenciesValue: List<String>? = null

        public var supportedPaymentCurrencies: List<String>
            get() = requireNotNull(supportedPaymentCurrenciesValue) { "supportedPaymentCurrencies is required" }
            set(`value`) {
                supportedPaymentCurrenciesValue = value
            }

        private var supportedPaymentMethodsValue: List<String>? = null

        public var supportedPaymentMethods: List<String>
            get() = requireNotNull(supportedPaymentMethodsValue) { "supportedPaymentMethods is required" }
            set(`value`) {
                supportedPaymentMethodsValue = value
            }

        private var supportedTransferCountriesValue: List<String>? = null

        public var supportedTransferCountries: List<String>
            get() = requireNotNull(supportedTransferCountriesValue) { "supportedTransferCountries is required" }
            set(`value`) {
                supportedTransferCountriesValue = value
            }
    ...
    public object Serializer : KSerializer<CountrySpec> {
        ...
        override fun deserialize(decoder: Decoder): CountrySpec {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("CountrySpec must be a JSON object")
            ...
            val supportedBankAccountCurrencies =
                json.decodeRequired<Map<String, List<String>>>(
                    rawObject,
                    "supported_bank_account_currencies",
                )
            val supportedPaymentCurrencies =
                json.decodeRequired<List<String>>(
                    rawObject,
                    "supported_payment_currencies",
                )
            val supportedPaymentMethods = json.decodeRequired<List<String>>(rawObject, "supported_payment_methods")
            val supportedTransferCountries =
                json.decodeRequired<List<String>>(
                    rawObject,
                    "supported_transfer_countries",
                )
            val verificationFields =
                json.decodeRequired<CountrySpecVerificationFields>(
                    rawObject,
                    "verification_fields",
                )
            return CountrySpec(
        ...
        override fun serialize(
            ...
            val raw =
                buildJsonObject {
                    ...
                    put(
                        "supported_bank_account_currencies",
                        json.encodeToJsonElement(value.supportedBankAccountCurrencies),
                    )
