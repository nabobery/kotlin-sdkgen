...
public class InlineV1PaymentLinksPostRequestFormAfterCompletionX204f7da4(
    ...
    public val hostedConfirmation: InlineV1PaymentLinksPostRequestFormAfterCompletionHostedConfirmationX45d9cb84? = null,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PaymentLinksPostRequestFormAfterCompletionX204f7da4 =
    ...
    public object Serializer : KSerializer<InlineV1PaymentLinksPostRequestFormAfterCompletionX204f7da4> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentLinksPostRequestFormAfterCompletionX204f7da4 must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineV1PaymentLinksPostRequestFormAfterCompletionTypeXa04bab19>(
                    rawObject,
                    "type",
                )
            return InlineV1PaymentLinksPostRequestFormAfterCompletionX204f7da4(
                ...
                hostedConfirmation =
                    rawObject["hosted_confirmation"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormAfterCompletionHostedConfirmationX45d9cb84>(
                                it,
                            )
                    },
                redirect =
                    rawObject["redirect"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormAfterCompletionRedirectXd22810e9>(
                            it,
                        )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentLinksPostRequestFormAfterCompletionX204f7da4,
        ) {
...
public fun inlineV1PaymentLinksPostRequestFormAfterCompletionX204f7da4(
    block: InlineV1PaymentLinksPostRequestFormAfterCompletionX204f7da4.Builder.() -> Unit,
): InlineV1PaymentLinksPostRequestFormAfterCompletionX204f7da4 =
    InlineV1PaymentLinksPostRequestFormAfterCompletionX204f7da4.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentLinksPostRequestFormAfterCompletionX204f7da4 is missing required property '" + name +
                    "'",
            )
