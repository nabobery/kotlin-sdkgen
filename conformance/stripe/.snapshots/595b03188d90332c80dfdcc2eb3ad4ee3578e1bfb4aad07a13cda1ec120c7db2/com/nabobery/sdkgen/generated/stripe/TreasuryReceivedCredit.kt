        ...
        override fun deserialize(decoder: Decoder): TreasuryReceivedCredit {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("TreasuryReceivedCredit must be a JSON object")
            val amount = json.decodeRequired<Int>(rawObject, "amount")
            val created = json.decodeRequired<Int>(rawObject, "created")
            val currency = json.decodeRequired<String>(rawObject, "currency")
            val description = json.decodeRequired<String>(rawObject, "description")
            val id = json.decodeRequired<String>(rawObject, "id")
            val initiatingPaymentMethodDetails =
                json
                    .decodeRequired<TreasurySharedResourceInitiatingPaymentMethodDetailsInitiatingPaymentMethodDetails>(
                        rawObject,
                ...
                failureCode =
                    rawObject["failure_code"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineTreasuryReceivedCreditFailureCodeX69f05247?>(element)
                        }
                    },
                financialAccount =
                ...
                reversalDetails =
                    rawObject["reversal_details"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineTreasuryReceivedCreditReversalDetailsX2cda43a1?>(element)
                        }
                    },
                transaction =
                    rawObject["transaction"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineTreasuryReceivedCreditTransactionXdd1d426d?>(element)
                        }
                    },
            )
        }
        ...
        override fun serialize(
            ...
            val raw =
                buildJsonObject {
                    ...
                    put(
                        "initiating_payment_method_details",
                        json.encodeToJsonElement(value.initiatingPaymentMethodDetails),
                    )
...
public fun treasuryReceivedCredit(block: TreasuryReceivedCredit.Builder.() -> Unit): TreasuryReceivedCredit =
    TreasuryReceivedCredit.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("TreasuryReceivedCredit is missing required property '" + name + "'")
