...
public data class PaymentPagesCheckoutSessionPaymentMethodReuseAgreementView(
    public val position: InlinePaymentPagesCheckoutSessionPaymentMethodReuseAgreementPositionX2a885d55,
)
...
public class PaymentPagesCheckoutSessionPaymentMethodReuseAgreement(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentPagesCheckoutSessionPaymentMethodReuseAgreement =
    ...
    public object Serializer : KSerializer<PaymentPagesCheckoutSessionPaymentMethodReuseAgreement> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "PaymentPagesCheckoutSessionPaymentMethodReuseAgreement must be a JSON object",
                    )
            val position =
                json.decodeRequired<InlinePaymentPagesCheckoutSessionPaymentMethodReuseAgreementPositionX2a885d55>(
                    rawObject,
                    "position",
                )
            return PaymentPagesCheckoutSessionPaymentMethodReuseAgreement(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentPagesCheckoutSessionPaymentMethodReuseAgreement,
        ) {
...
public fun paymentPagesCheckoutSessionPaymentMethodReuseAgreement(
    block: PaymentPagesCheckoutSessionPaymentMethodReuseAgreement.Builder.() -> Unit,
): PaymentPagesCheckoutSessionPaymentMethodReuseAgreement =
    PaymentPagesCheckoutSessionPaymentMethodReuseAgreement.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "PaymentPagesCheckoutSessionPaymentMethodReuseAgreement is missing required property '" + name + "'",
            )
