...
public class InlineV1TreasuryOutboundTransfersPostRequestFormX91512707(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TreasuryOutboundTransfersPostRequestFormX91512707 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TreasuryOutboundTransfersPostRequestFormX91512707> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TreasuryOutboundTransfersPostRequestFormX91512707 must be a JSON object",
                    )
            ...
            return InlineV1TreasuryOutboundTransfersPostRequestFormX91512707(
                ...
                destinationPaymentMethodData =
                    rawObject["destination_payment_method_data"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TreasuryOutboundTrc70dPostRequestFormDestinationPaymentMec421X49fd33a8>(
                                it,
                            )
                    },
                destinationPaymentMethodOptions =
                    rawObject["destination_payment_method_options"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TreasuryOutboundTrc70dPostRequestFormDestinationPaymentMeeca5X62b85741>(
                                it,
                            )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TreasuryOutboundTransfersPostRequestFormX91512707,
        ) {
...
public fun inlineV1TreasuryOutboundTransfersPostRequestFormX91512707(
    block: InlineV1TreasuryOutboundTransfersPostRequestFormX91512707.Builder.() -> Unit,
): InlineV1TreasuryOutboundTransfersPostRequestFormX91512707 =
    InlineV1TreasuryOutboundTransfersPostRequestFormX91512707.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TreasuryOutboundTransfersPostRequestFormX91512707 is missing required property '" + name + "'",
            )
