...
public class InlineV1TreasuryFinancialA78aaPostRequestFormUsDomesticWireXe9fab32d(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1TreasuryFinancialA78aaPostRequestFormUsDomesticWireXe9fab32d = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TreasuryFinancialA78aaPostRequestFormUsDomesticWireXe9fab32d> {
        override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1TreasuryFinancialA78aaPostRequestFormUsDomesticWireXe9fab32d {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TreasuryFinancialA78aaPostRequestFormUsDomesticWireXe9fab32d must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TreasuryFinancialA78aaPostRequestFormUsDomesticWireXe9fab32d,
        ) {
            val jsonEncoder =
...
public fun inlineV1TreasuryFinancialA78aaPostRequestFormUsDomesticWireXe9fab32d(
    block: InlineV1TreasuryFinancialA78aaPostRequestFormUsDomesticWireXe9fab32d.Builder.() -> Unit,
): InlineV1TreasuryFinancialA78aaPostRequestFormUsDomesticWireXe9fab32d =
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TreasuryFinancialA78aaPostRequestFormUsDomesticWireXe9fab32d is missing required property '" +
                    name +
                    "'",
            )
