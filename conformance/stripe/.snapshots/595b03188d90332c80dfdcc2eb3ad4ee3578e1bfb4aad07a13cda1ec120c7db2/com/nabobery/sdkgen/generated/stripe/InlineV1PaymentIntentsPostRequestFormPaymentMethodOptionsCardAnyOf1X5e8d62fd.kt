...
public class InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsCardAnyOf1X5e8d62fd(
    public val captureMethod: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsCaptureMethodXa6d02e6c? = null,
    public val cvcToken: String? = null,
    public val installments: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsInstallmentsX3e5a3207? = null,
    public val mandateOptions: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsMandateOptionsXfc27da54? = null,
    public val network: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsCardNetworkX3a642352? = null,
    ...
    public val requestMulticapture: InlineV1PaymentIntentsPostRequestFormRequestMulticaptureX44a3355b? = null,
    public val requestOvercapture: InlineV1PaymentIntentsPostRequestFormRequestOvercaptureXac720c4d? = null,
    public val requestThreeDSecure: InlineV1PaymentIntentsPostRequestFormRequestThreeDSecureX39c4c1e0? = null,
    public val requireCvcRecollection: Boolean? = null,
    public val setupFutureUsage: InlineV1PaymentIntentsPostRequestFormSetupFutureUsageXb0d30eaa? = null,
    ...
    public val threeDSecure: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsThreeDSecureX18bd920d? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsCardAnyOf1X5e8d62fd =
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsCardAnyOf1X5e8d62fd = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsCardAnyOf1X5e8d62fd> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsCardAnyOf1X5e8d62fd must be a JSON object",
                    )
            return InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsCardAnyOf1X5e8d62fd(
                captureMethod =
                    rawObject["capture_method"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsCaptureMethodXa6d02e6c>(
                                it,
                            )
                    },
                ...
                installments =
                    rawObject["installments"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsInstallmentsX3e5a3207>(
                                it,
                            )
                    },
                mandateOptions =
                    rawObject["mandate_options"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsMandateOptionsXfc27da54>(
                                it,
                            )
                    },
                network =
                    rawObject["network"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsCardNetworkX3a642352>(
                                it,
                            )
                    },
                requestExtendedAuthorization =
                    rawObject["request_extended_authorization"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormRequestExtendedAutho403fXa523541d>(
                                it,
                            )
                    },
                requestIncrementalAuthorization =
                    rawObject["request_incremental_authorization"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormRequestIncrementalAu57cdX02e5133e>(
                                it,
                            )
                    },
                requestMulticapture =
                    rawObject["request_multicapture"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormRequestMulticaptureX44a3355b>(
                            it,
                        )
                    },
                requestOvercapture =
                    rawObject["request_overcapture"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormRequestOvercaptureXac720c4d>(it)
                    },
                requestThreeDSecure =
                    rawObject["request_three_d_secure"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormRequestThreeDSecureX39c4c1e0>(
                            it,
                        )
                    },
                ...
                setupFutureUsage =
                    rawObject["setup_future_usage"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormSetupFutureUsageXb0d30eaa>(it)
                    },
                statementDescriptorSuffixKana =
                    rawObject["statement_descriptor_suffix_kana"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormStatementDescriptorS583fX7f867e21>(
                                it,
                            )
                    },
                statementDescriptorSuffixKanji =
                    rawObject["statement_descriptor_suffix_kanji"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormStatementDescriptorSb1afXff4e0e50>(
                                it,
                            )
                    },
                threeDSecure =
                    rawObject["three_d_secure"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsThreeDSecureX18bd920d>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsCardAnyOf1X5e8d62fd,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsCardAnyOf1X5e8d62fd(
    block: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsCardAnyOf1X5e8d62fd.Builder.() -> Unit,
): InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsCardAnyOf1X5e8d62fd =
    InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsCardAnyOf1X5e8d62fd.build(block)
