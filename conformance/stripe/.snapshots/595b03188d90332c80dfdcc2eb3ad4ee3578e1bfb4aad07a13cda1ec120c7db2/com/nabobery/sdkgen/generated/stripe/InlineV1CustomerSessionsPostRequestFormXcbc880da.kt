...
public class InlineV1CustomerSessionsPostRequestFormXcbc880da(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1CustomerSessionsPostRequestFormXcbc880da =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1CustomerSessionsPostRequestFormXcbc880da> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CustomerSessionsPostRequestFormXcbc880da must be a JSON object",
                    )
            val components =
                json.decodeRequired<InlineV1CustomerSessionsPostRequestFormComponentsX6c4299e1>(
                    rawObject,
                    "components",
                )
            return InlineV1CustomerSessionsPostRequestFormXcbc880da(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomerSessionsPostRequestFormXcbc880da,
        ) {
...
public fun inlineV1CustomerSessionsPostRequestFormXcbc880da(
    block: InlineV1CustomerSessionsPostRequestFormXcbc880da.Builder.() -> Unit,
): InlineV1CustomerSessionsPostRequestFormXcbc880da = InlineV1CustomerSessionsPostRequestFormXcbc880da.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1CustomerSessionsPostRequestFormXcbc880da is missing required property '" + name + "'",
            )
