...
internal data class InlineV1AccountsPostRequestFormIndividualDobXf914b8b9Inspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesInlineV1AccountsPostRequestFormIndividualDobAnyOf1Xb16dedab,
                matchesInlineV1AccountsPostRequestFormIndividualDobAnyOf2X2b0a85b0,
            ).count {
                it
            }
}
...
public class InlineV1AccountsPostRequestFormIndividualDobXf914b8b9 internal constructor(
    ...
    public val inlineV1AccountsPostRequestFormIndividualDobAnyOf1Xb16dedab:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1AccountsPostRequestFormIndividualDobAnyOf1Xb16dedab) {
                json
                    .decodeFromJsonElement<InlineV1AccountsPostRequestFormIndividualDobAnyOf1Xb16dedab>(
                        raw,
                    )
            } else {
                null
    ...
    public val inlineV1AccountsPostRequestFormIndividualDobAnyOf2X2b0a85b0:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1AccountsPostRequestFormIndividualDobAnyOf2X2b0a85b0) {
                json
                    .decodeFromJsonElement<InlineV1AccountsPostRequestFormIndividualDobAnyOf2X2b0a85b0>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1AccountsPostRequestFormIndividualDobXf914b8b9Branch>
        get() =
            buildSet {
                if (inspection.matchesInlineV1AccountsPostRequestFormIndividualDobAnyOf1Xb16dedab) {
                    add(
                        InlineV1AccountsPostRequestFormIndividualDobXf914b8b9Branch.InlineV1AccountsPostRequestFormIndividualDobAnyOf1Xb16dedab,
                    )
                }
                if (inspection.matchesInlineV1AccountsPostRequestFormIndividualDobAnyOf2X2b0a85b0) {
                    add(
                        InlineV1AccountsPostRequestFormIndividualDobXf914b8b9Branch.InlineV1AccountsPostRequestFormIndividualDobAnyOf2X2b0a85b0,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1AccountsPostRequestFormIndividualDobXf914b8b9 {
            val inspection = inspectInlineV1AccountsPostRequestFormIndividualDobXf914b8b9(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1AccountsPostRequestFormIndividualDobXf914b8b9NoMatchException(
                    "InlineV1AccountsPostRequestFormIndividualDobXf914b8b9 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1AccountsPostRequestFormIndividualDobXf914b8b9> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPostRequestFormIndividualDobXf914b8b9,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1AccountsPostRequestFormIndividualDobXf914b8b9",
...
private fun inspectInlineV1AccountsPostRequestFormIndividualDobXf914b8b9(
    element: JsonElement,
): InlineV1AccountsPostRequestFormIndividualDobXf914b8b9Inspection {
    val matchesInlineV1AccountsPostRequestFormIndividualDobAnyOf1Xb16dedab =
        element
            .isJsonDecodable<InlineV1AccountsPostRequestFormIndividualDobAnyOf1Xb16dedab>()
    val matchesInlineV1AccountsPostRequestFormIndividualDobAnyOf2X2b0a85b0 =
        element
            .isJsonDecodable<InlineV1AccountsPostRequestFormIndividualDobAnyOf2X2b0a85b0>()
    return InlineV1AccountsPostRequestFormIndividualDobXf914b8b9Inspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1AccountsPostRequestFormIndividualDobAnyOf1Xb16dedab) {
                    add(
                        "InlineV1AccountsPostRequestFormIndividualDobAnyOf1Xb16dedab: value does not match InlineV1AccountsPostRequestFormIndividualDobAnyOf1Xb16dedab",
                    )
                }
                if (!matchesInlineV1AccountsPostRequestFormIndividualDobAnyOf2X2b0a85b0) {
                    add(
                        "InlineV1AccountsPostRequestFormIndividualDobAnyOf2X2b0a85b0: value does not match InlineV1AccountsPostRequestFormIndividualDobAnyOf2X2b0a85b0",
                    )
                }
            },
    )
