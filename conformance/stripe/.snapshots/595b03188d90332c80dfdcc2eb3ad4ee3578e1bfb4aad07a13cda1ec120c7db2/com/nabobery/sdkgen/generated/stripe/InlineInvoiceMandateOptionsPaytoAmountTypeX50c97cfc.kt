...
public sealed class InlineInvoiceMandateOptionsPaytoAmountTypeX50c97cfc {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineInvoiceMandateOptionsPaytoAmountTypeX50c97cfc =
            when (value) {
                Fixed.value -> Fixed
    ...
    public object Serializer : KSerializer<InlineInvoiceMandateOptionsPaytoAmountTypeX50c97cfc> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineInvoiceMandateOptionsPaytoAmountTypeX50c97cfc",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineInvoiceMandateOptionsPaytoAmountTypeX50c97cfc =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineInvoiceMandateOptionsPaytoAmountTypeX50c97cfc,
        ) {
