...
public class InlineV1TestHelpersTreasurbf2dPostRequestFormInitiatingPaymentMetfafcX20486327(
    ...
    public val usBankAccount: InlineV1TestHelpersTreasurbf2dPostRequestFormUsBankAccountXd0b12611? = null,
) {
    ...
    public object Serializer : KSerializer<InlineV1TestHelpersTreasurbf2dPostRequestFormInitiatingPaymentMetfafcX20486327> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TestHelpersTreasurbf2dPostRequestFormInitiatingPaymentMetfafcX20486327 must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineV1TestHelpersTreasurbf2dPostRequestFormTypeX7638f3ab>(
                    rawObject,
                    "type",
                )
            return InlineV1TestHelpersTreasurbf2dPostRequestFormInitiatingPaymentMetfafcX20486327(
                ...
                usBankAccount =
                    rawObject["us_bank_account"]?.let {
                        json.decodeFromJsonElement<InlineV1TestHelpersTreasurbf2dPostRequestFormUsBankAccountXd0b12611>(
                            it,
                        )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TestHelpersTreasurbf2dPostRequestFormInitiatingPaymentMetfafcX20486327,
        ) {
            val jsonEncoder =
...
public fun inlineV1TestHelpersTreasurbf2dPostRequestFormInitiatingPaymentMetfafcX20486327(
    block: InlineV1TestHelpersTreasurbf2dPostRequestFormInitiatingPaymentMetfafcX20486327.Builder.() -> Unit,
): InlineV1TestHelpersTreasurbf2dPostRequestFormInitiatingPaymentMetfafcX20486327 =
    InlineV1TestHelpersTreasurbf2dPostRequestFormInitiatingPaymentMetfafcX20486327.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TestHelpersTreasurbf2dPostRequestFormInitiatingPaymentMetfafcX20486327 is missing required property '" +
                    name +
                    "'",
            )
