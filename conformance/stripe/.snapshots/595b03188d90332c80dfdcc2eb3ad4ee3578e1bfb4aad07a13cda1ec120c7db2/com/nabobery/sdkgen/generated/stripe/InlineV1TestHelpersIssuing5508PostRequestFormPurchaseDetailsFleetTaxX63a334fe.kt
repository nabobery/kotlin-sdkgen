...
public class InlineV1TestHelpersIssuing5508PostRequestFormPurchaseDetailsFleetTaxX63a334fe(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1TestHelpersIssuing5508PostRequestFormPurchaseDetailsFleetTaxX63a334fe =
            InlineV1TestHelpersIssuing5508PostRequestFormPurchaseDetailsFleetTaxX63a334fe(
    ...
    public object Serializer : KSerializer<InlineV1TestHelpersIssuing5508PostRequestFormPurchaseDetailsFleetTaxX63a334fe> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TestHelpersIssuing5508PostRequestFormPurchaseDetailsFleetTaxX63a334fe must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TestHelpersIssuing5508PostRequestFormPurchaseDetailsFleetTaxX63a334fe,
        ) {
            val jsonEncoder =
...
public fun inlineV1TestHelpersIssuing5508PostRequestFormPurchaseDetailsFleetTaxX63a334fe(
    block: InlineV1TestHelpersIssuing5508PostRequestFormPurchaseDetailsFleetTaxX63a334fe.Builder.() -> Unit,
): InlineV1TestHelpersIssuing5508PostRequestFormPurchaseDetailsFleetTaxX63a334fe =
    InlineV1TestHelpersIssuing5508PostRequestFormPurchaseDetailsFleetTaxX63a334fe.build(block)
