...
public sealed class InlineV1ChargesRefundsPostRequestFormOriginX4a79114c {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1ChargesRefundsPostRequestFormOriginX4a79114c =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1ChargesRefundsPostRequestFormOriginX4a79114c> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1ChargesRefundsPostRequestFormOriginX4a79114c",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1ChargesRefundsPostRequestFormOriginX4a79114c =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ChargesRefundsPostRequestFormOriginX4a79114c,
        ) {
