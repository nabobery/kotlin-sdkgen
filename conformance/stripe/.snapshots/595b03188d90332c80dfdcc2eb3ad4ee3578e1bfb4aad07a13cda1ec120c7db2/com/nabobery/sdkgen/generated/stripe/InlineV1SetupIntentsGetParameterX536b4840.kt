...
public class InlineV1SetupIntentsGetParameterX536b4840 internal constructor(
    ...
    public val inlineV1SetupIntentsGetParameterAnyOf1X2d9471dc:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1SetupIntentsGetParameterAnyOf1X2d9471dc) {
                json
                    .decodeFromJsonElement<InlineV1SetupIntentsGetParameterAnyOf1X2d9471dc>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1SetupIntentsGetParameterX536b4840Branch>
        get() =
            buildSet {
                if (inspection.matchesInlineV1SetupIntentsGetParameterAnyOf1X2d9471dc) {
                    add(
                        InlineV1SetupIntentsGetParameterX536b4840Branch.InlineV1SetupIntentsGetParameterAnyOf1X2d9471dc,
                    )
                }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1SetupIntentsGetParameterX536b4840 {
            val inspection = inspectInlineV1SetupIntentsGetParameterX536b4840(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1SetupIntentsGetParameterX536b4840NoMatchException(
                    "InlineV1SetupIntentsGetParameterX536b4840 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1SetupIntentsGetParameterX536b4840> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SetupIntentsGetParameterX536b4840,
        ) {
...
private fun inspectInlineV1SetupIntentsGetParameterX536b4840(
    element: JsonElement,
): InlineV1SetupIntentsGetParameterX536b4840Inspection {
    val matchesInlineV1SetupIntentsGetParameterAnyOf1X2d9471dc =
        element
            .isJsonDecodable<InlineV1SetupIntentsGetParameterAnyOf1X2d9471dc>()
    ...
    return InlineV1SetupIntentsGetParameterX536b4840Inspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1SetupIntentsGetParameterAnyOf1X2d9471dc) {
                    add(
                        "InlineV1SetupIntentsGetParameterAnyOf1X2d9471dc: value does not match InlineV1SetupIntentsGetParameterAnyOf1X2d9471dc",
                    )
                }
