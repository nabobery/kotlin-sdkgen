...
public data class CustomerCashBalanceTransactionView(
    ...
    public val adjustedForOverdraft: CustomerBalanceResourceCashBalanceTransactionResourceAdjustedForOverdraft? = null,
    @SerialName("applied_to_payment")
    public val appliedToPayment: CustomerBalanceResourceCashBalanceTransactionResourceAppliedToPaymentTransaction? = null,
    ...
    public val transferredToBalance: CustomerBalanceResourceCashBalanceTransactionResourceTransferredToBalance? = null,
...
public class CustomerCashBalanceTransaction(
    ...
    public object Serializer : KSerializer<CustomerCashBalanceTransaction> {
        ...
        override fun deserialize(decoder: Decoder): CustomerCashBalanceTransaction {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("CustomerCashBalanceTransaction must be a JSON object")
            val created = json.decodeRequired<Int>(rawObject, "created")
            val currency = json.decodeRequired<String>(rawObject, "currency")
            val customer =
                json.decodeRequired<InlineCustomerCashBalanceTransactionCustomerXaefbb309>(
                    rawObject,
                    "customer",
                )
            ...
            val objectValue =
                json.decodeRequired<InlineCustomerCashBalanceTransactionObjectValueXeb412635>(
                    rawObject,
                    "object",
                )
            ...
            return CustomerCashBalanceTransaction(
                ...
                adjustedForOverdraft =
                    rawObject["adjusted_for_overdraft"]?.let {
                        json
                            .decodeFromJsonElement<CustomerBalanceResourceCashBalanceTransactionResourceAdjustedForOverdraft>(
                                it,
                            )
                    },
                appliedToPayment =
                    rawObject["applied_to_payment"]?.let {
                        json
                            .decodeFromJsonElement<CustomerBalanceResourceCashBalanceTransactionResourceAppliedToPaymentTransaction>(
                                it,
                            )
                    },
                customerAccount =
                ...
                funded =
                    rawObject["funded"]?.let {
                        json
                            .decodeFromJsonElement<CustomerBalanceResourceCashBalanceTransactionResourceFundedTransaction>(
                                it,
                            )
                    },
                refundedFromPayment =
                    rawObject["refunded_from_payment"]?.let {
                        json
                            .decodeFromJsonElement<CustomerBalanceResourceCashBalanceTransactionResourceRefundedFromPaymentTransaction>(
                                it,
                            )
                    },
                transferredToBalance =
                    rawObject["transferred_to_balance"]?.let {
                        json
                            .decodeFromJsonElement<CustomerBalanceResourceCashBalanceTransactionResourceTransferredToBalance>(
                                it,
                            )
                    },
                unappliedFromPayment =
                    rawObject["unapplied_from_payment"]?.let {
                        json
                            .decodeFromJsonElement<CustomerBalanceResourceCashBalanceTransactionResourceUnappliedFromPaymentTransaction>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: CustomerCashBalanceTransaction,
        ) {
...
public fun customerCashBalanceTransaction(
    block: CustomerCashBalanceTransaction.Builder.() -> Unit,
): CustomerCashBalanceTransaction = CustomerCashBalanceTransaction.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "CustomerCashBalanceTransaction is missing required property '" + name + "'",
            )
