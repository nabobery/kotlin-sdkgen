...
public class InlineV1CheckoutSessionsPostRequestFormShippingOptionsAdditionalValueX3d05d8d0(
    ...
    public val taxBehavior: InlineV1CheckoutSessionsPostRequestFormShippingOptionsItemTaxBehaviorX7865557a? = null,
) {
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1CheckoutSessionsPostRequestFormShippingOptionsAdditionalValueX3d05d8d0 =
    ...
    public object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormShippingOptionsAdditionalValueX3d05d8d0> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CheckoutSessionsPostRequestFormShippingOptionsAdditionalValueX3d05d8d0 must be a JSON object",
                    )
            ...
            return InlineV1CheckoutSessionsPostRequestFormShippingOptionsAdditionalValueX3d05d8d0(
                ...
                taxBehavior =
                    rawObject["tax_behavior"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormShippingOptionsItemTaxBehaviorX7865557a>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsPostRequestFormShippingOptionsAdditionalValueX3d05d8d0,
        ) {
            val jsonEncoder =
...
public fun inlineV1CheckoutSessionsPostRequestFormShippingOptionsAdditionalValueX3d05d8d0(
    block: InlineV1CheckoutSessionsPostRequestFormShippingOptionsAdditionalValueX3d05d8d0.Builder.() -> Unit,
): InlineV1CheckoutSessionsPostRequestFormShippingOptionsAdditionalValueX3d05d8d0 =
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1CheckoutSessionsPostRequestFormShippingOptionsAdditionalValueX3d05d8d0 is missing required property '" +
                    name +
                    "'",
            )
