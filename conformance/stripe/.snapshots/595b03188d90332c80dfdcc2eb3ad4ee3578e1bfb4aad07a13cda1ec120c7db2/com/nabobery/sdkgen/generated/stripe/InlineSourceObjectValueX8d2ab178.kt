...
public sealed class InlineSourceObjectValueX8d2ab178 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineSourceObjectValueX8d2ab178 =
            when (value) {
                Source.value -> Source
    ...
    public object Serializer : KSerializer<InlineSourceObjectValueX8d2ab178> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineSourceObjectValueX8d2ab178",
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineSourceObjectValueX8d2ab178,
        ) {
