...
public class InlineInvoiceLatestRevisionX60f0e9cc internal constructor(
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineInvoiceLatestRevisionX60f0e9cc {
            val inspection = inspectInlineInvoiceLatestRevisionX60f0e9cc(raw)
            if (inspection.matchCount == 0) {
                throw InlineInvoiceLatestRevisionX60f0e9ccNoMatchException(
                    "InlineInvoiceLatestRevisionX60f0e9cc matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineInvoiceLatestRevisionX60f0e9cc> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineInvoiceLatestRevisionX60f0e9cc,
        ) {
...
private fun inspectInlineInvoiceLatestRevisionX60f0e9cc(
    element: JsonElement,
): InlineInvoiceLatestRevisionX60f0e9ccInspection {
