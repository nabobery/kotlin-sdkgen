...
public sealed class InlineSubscriptionsResourceBillingSchedulesBillUntilTypeX20894bbb {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineSubscriptionsResourceBillingSchedulesBillUntilTypeX20894bbb =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineSubscriptionsResourceBillingSchedulesBillUntilTypeX20894bbb> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineSubscriptionsResourceBillingSchedulesBillUntilTypeX20894bbb",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineSubscriptionsResourceBillingSchedulesBillUntilTypeX20894bbb =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineSubscriptionsResourceBillingSchedulesBillUntilTypeX20894bbb,
        ) {
