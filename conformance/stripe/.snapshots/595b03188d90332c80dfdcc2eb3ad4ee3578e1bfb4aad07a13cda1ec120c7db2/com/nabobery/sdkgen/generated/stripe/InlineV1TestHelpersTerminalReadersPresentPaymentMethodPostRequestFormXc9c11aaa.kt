...
public class InlineV1TestHelpersTerminalReadersPresentPaymentMethodPostRequestFormXc9c11aaa(
     ...
     */
    public val interacPresent: InlineV1TestHelpersTerminad724PostRequestFormInteracPresentX0018263a? = null,
    /**
    ...
    public class Builder {
        ...
        public fun build(): InlineV1TestHelpersTerminalReadersPresentPaymentMethodPostRequestFormXc9c11aaa =
    ...
    public object Serializer : KSerializer<InlineV1TestHelpersTerminalReadersPresentPaymentMethodPostRequestFormXc9c11aaa> {
        ...
        override fun deserialize(
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TestHelpersTerminalReadersPresentPaymentMethodPostRequestFormXc9c11aaa must be a JSON object",
                    )
            return InlineV1TestHelpersTerminalReadersPresentPaymentMethodPostRequestFormXc9c11aaa(
                ...
                card =
                    rawObject["card"]?.let {
                        json.decodeFromJsonElement<InlineV1TestHelpersTerminad724PostRequestFormCardX60eb23c7>(it)
                    },
                cardPresent =
                    rawObject["card_present"]?.let {
                        json.decodeFromJsonElement<InlineV1TestHelpersTerminad724PostRequestFormCardPresentX80a538f3>(
                            it,
                        )
                    },
                ...
                interacPresent =
                    rawObject["interac_present"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TestHelpersTerminad724PostRequestFormInteracPresentX0018263a>(
                                it,
                            )
                    },
                type =
                    rawObject["type"]?.let {
                        json.decodeFromJsonElement<InlineV1TestHelpersTerminad724PostRequestFormTypeX03de22b0>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TestHelpersTerminalReadersPresentPaymentMethodPostRequestFormXc9c11aaa,
        ) {
            val jsonEncoder =
...
public fun inlineV1TestHelpersTerminalReadersPresentPaymentMethodPostRequestFormXc9c11aaa(
    block: InlineV1TestHelpersTerminalReadersPresentPaymentMethodPostRequestFormXc9c11aaa.Builder.() -> Unit,
): InlineV1TestHelpersTerminalReadersPresentPaymentMethodPostRequestFormXc9c11aaa =
    InlineV1TestHelpersTerminalReadersPresentPaymentMethodPostRequestFormXc9c11aaa.build(block)
