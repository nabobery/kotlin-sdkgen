...
public class InlineV1ExternalAccountsPostRequestFormX602302a3(
     ...
     */
    public val accountHolderType: InlineV1ExternalAccountsPostRequestFormAccountHolderTypeXa928777d? = null,
    /**
    ...
    public class Builder {
        ...
        public fun build(): InlineV1ExternalAccountsPostRequestFormX602302a3 =
            InlineV1ExternalAccountsPostRequestFormX602302a3(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1ExternalAccountsPostRequestFormX602302a3 =
    ...
    public object Serializer : KSerializer<InlineV1ExternalAccountsPostRequestFormX602302a3> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1ExternalAccountsPostRequestFormX602302a3 must be a JSON object",
                    )
            return InlineV1ExternalAccountsPostRequestFormX602302a3(
                ...
                accountHolderType =
                    rawObject["account_holder_type"]?.let {
                        json.decodeFromJsonElement<InlineV1ExternalAccountsPostRequestFormAccountHolderTypeXa928777d>(
                            it,
                        )
                    },
                accountType =
                    rawObject["account_type"]?.let {
                        json.decodeFromJsonElement<InlineV1ExternalAccountsPostRequestFormAccountTypeX39c8b49f>(it)
                    },
                ...
                documents =
                    rawObject["documents"]?.let {
                        json.decodeFromJsonElement<InlineV1ExternalAccountsPostRequestFormDocumentsXd8f2694c>(it)
                    },
                ...
                metadata =
                    rawObject["metadata"]?.let {
                        json.decodeFromJsonElement<InlineV1ExternalAccountsPostRequestFormMetadataX1645c9f4>(it)
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ExternalAccountsPostRequestFormX602302a3,
        ) {
...
public fun inlineV1ExternalAccountsPostRequestFormX602302a3(
    block: InlineV1ExternalAccountsPostRequestFormX602302a3.Builder.() -> Unit,
): InlineV1ExternalAccountsPostRequestFormX602302a3 = InlineV1ExternalAccountsPostRequestFormX602302a3.build(block)
