...
public sealed class InlineSubscriptionSchedule62cfDisabledReasonXfef27da9 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineSubscriptionSchedule62cfDisabledReasonXfef27da9 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineSubscriptionSchedule62cfDisabledReasonXfef27da9> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineSubscriptionSchedule62cfDisabledReasonXfef27da9",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineSubscriptionSchedule62cfDisabledReasonXfef27da9 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineSubscriptionSchedule62cfDisabledReasonXfef27da9,
        ) {
