...
public sealed class InlineV1CustomersPostRequestFormAddressAnyOf2X9272aed1 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1CustomersPostRequestFormAddressAnyOf2X9272aed1 =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1CustomersPostRequestFormAddressAnyOf2X9272aed1> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1CustomersPostRequestFormAddressAnyOf2X9272aed1",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1CustomersPostRequestFormAddressAnyOf2X9272aed1 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersPostRequestFormAddressAnyOf2X9272aed1,
        ) {
