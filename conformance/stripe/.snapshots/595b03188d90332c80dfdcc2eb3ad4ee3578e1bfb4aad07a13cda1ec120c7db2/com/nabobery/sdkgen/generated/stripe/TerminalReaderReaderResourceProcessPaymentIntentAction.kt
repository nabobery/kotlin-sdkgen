...
public class TerminalReaderReaderResourceProcessPaymentIntentAction(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): TerminalReaderReaderResourceProcessPaymentIntentAction =
    ...
    public object Serializer : KSerializer<TerminalReaderReaderResourceProcessPaymentIntentAction> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "TerminalReaderReaderResourceProcessPaymentIntentAction must be a JSON object",
                    )
            val paymentIntent =
                json.decodeRequired<InlineTerminalReaderReaderc999PaymentIntentX21e1acb3>(
                    rawObject,
                    "payment_intent",
                )
            return TerminalReaderReaderResourceProcessPaymentIntentAction(
                ...
                processConfig =
                    rawObject["process_config"]?.let {
                        json.decodeFromJsonElement<TerminalReaderReaderResourceProcessConfig>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: TerminalReaderReaderResourceProcessPaymentIntentAction,
        ) {
...
public fun terminalReaderReaderResourceProcessPaymentIntentAction(
    block: TerminalReaderReaderResourceProcessPaymentIntentAction.Builder.() -> Unit,
): TerminalReaderReaderResourceProcessPaymentIntentAction =
    TerminalReaderReaderResourceProcessPaymentIntentAction.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "TerminalReaderReaderResourceProcessPaymentIntentAction is missing required property '" + name + "'",
            )
