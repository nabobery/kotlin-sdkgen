...
public class InlineV1PlansPostRequestFormTiersItemUpToX0066c7be internal constructor(
    ...
    public val inlineV1PlansPostRequestFormTiersItemUpToAnyOf1X1bfa485e:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1PlansPostRequestFormTiersItemUpToAnyOf1X1bfa485e) {
                json
                    .decodeFromJsonElement<InlineV1PlansPostRequestFormTiersItemUpToAnyOf1X1bfa485e>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1PlansPostRequestFormTiersItemUpToX0066c7beBranch>
        get() =
            buildSet {
                if (inspection.matchesInlineV1PlansPostRequestFormTiersItemUpToAnyOf1X1bfa485e) {
                    add(
                        InlineV1PlansPostRequestFormTiersItemUpToX0066c7beBranch.InlineV1PlansPostRequestFormTiersItemUpToAnyOf1X1bfa485e,
                    )
                }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1PlansPostRequestFormTiersItemUpToX0066c7be {
            val inspection = inspectInlineV1PlansPostRequestFormTiersItemUpToX0066c7be(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1PlansPostRequestFormTiersItemUpToX0066c7beNoMatchException(
                    "InlineV1PlansPostRequestFormTiersItemUpToX0066c7be matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1PlansPostRequestFormTiersItemUpToX0066c7be> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PlansPostRequestFormTiersItemUpToX0066c7be,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1PlansPostRequestFormTiersItemUpToX0066c7be",
...
private fun inspectInlineV1PlansPostRequestFormTiersItemUpToX0066c7be(
    element: JsonElement,
): InlineV1PlansPostRequestFormTiersItemUpToX0066c7beInspection {
    val matchesInlineV1PlansPostRequestFormTiersItemUpToAnyOf1X1bfa485e =
        element
            .isJsonDecodable<InlineV1PlansPostRequestFormTiersItemUpToAnyOf1X1bfa485e>()
    ...
    return InlineV1PlansPostRequestFormTiersItemUpToX0066c7beInspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1PlansPostRequestFormTiersItemUpToAnyOf1X1bfa485e) {
                    add(
                        "InlineV1PlansPostRequestFormTiersItemUpToAnyOf1X1bfa485e: value does not match InlineV1PlansPostRequestFormTiersItemUpToAnyOf1X1bfa485e",
                    )
                }
