...
public class PaymentPagesCheckoutSessionCheckoutAddressDetails(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentPagesCheckoutSessionCheckoutAddressDetails =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentPagesCheckoutSessionCheckoutAddressDetails> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "PaymentPagesCheckoutSessionCheckoutAddressDetails must be a JSON object",
                    )
...
public fun paymentPagesCheckoutSessionCheckoutAddressDetails(
    block: PaymentPagesCheckoutSessionCheckoutAddressDetails.Builder.() -> Unit,
): PaymentPagesCheckoutSessionCheckoutAddressDetails = PaymentPagesCheckoutSessionCheckoutAddressDetails.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "PaymentPagesCheckoutSessionCheckoutAddressDetails is missing required property '" + name + "'",
            )
