...
public class InlineV1IssuingAuthorizationsApprovePostRequestFormX50e66fe4(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1IssuingAuthorizationsApprovePostRequestFormX50e66fe4 =
            InlineV1IssuingAuthorizationsApprovePostRequestFormX50e66fe4(
                amount = amount,
                expand = expand,
                metadata = metadata,
            )
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1IssuingAuthorizationsApprovePostRequestFormX50e66fe4 =
    ...
    public object Serializer : KSerializer<InlineV1IssuingAuthorizationsApprovePostRequestFormX50e66fe4> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1IssuingAuthorizationsApprovePostRequestFormX50e66fe4 must be a JSON object",
                    )
            return InlineV1IssuingAuthorizationsApprovePostRequestFormX50e66fe4(
                ...
                metadata =
                    rawObject["metadata"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1IssuingAuthorizationsApprovePostRequestFormMetadataXbd7902bf>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingAuthorizationsApprovePostRequestFormX50e66fe4,
        ) {
...
public fun inlineV1IssuingAuthorizationsApprovePostRequestFormX50e66fe4(
    block: InlineV1IssuingAuthorizationsApprovePostRequestFormX50e66fe4.Builder.() -> Unit,
): InlineV1IssuingAuthorizationsApprovePostRequestFormX50e66fe4 =
    InlineV1IssuingAuthorizationsApprovePostRequestFormX50e66fe4.build(block)
