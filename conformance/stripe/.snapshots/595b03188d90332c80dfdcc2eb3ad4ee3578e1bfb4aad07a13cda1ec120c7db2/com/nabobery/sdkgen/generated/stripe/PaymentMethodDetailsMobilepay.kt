...
public class PaymentMethodDetailsMobilepay(
    ...
    public class Builder {
        ...
        public fun build(): PaymentMethodDetailsMobilepay =
    ...
    public object Serializer : KSerializer<PaymentMethodDetailsMobilepay> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodDetailsMobilepay {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodDetailsMobilepay must be a JSON object")
                ...
                card =
                    rawObject["card"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentMethodDetailsMobilepayCardX8e756108?>(element)
                        }
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentMethodDetailsMobilepay,
        ) {
...
public fun paymentMethodDetailsMobilepay(
    block: PaymentMethodDetailsMobilepay.Builder.() -> Unit,
): PaymentMethodDetailsMobilepay = PaymentMethodDetailsMobilepay.build(block)
