...
internal data class InlineV1PaymentIntentsPostRequestFormTransferDataMetadataX80580355Inspection(
    ...
    public val matchesInlineV1PaymentIntentsPostRequestFormTransferDataMetadataAnyOf2Xff564ca6: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1PaymentIntentsPostRequestFormTransferDataMetadataAnyOf2Xff564ca6,
            ).count {
                it
            }
}
...
public class InlineV1PaymentIntentsPostRequestFormTransferDataMetadataX80580355 internal constructor(
    ...
    private val inspection: InlineV1PaymentIntentsPostRequestFormTransferDataMetadataX80580355Inspection,
) {
    ...
    public val inlineV1PaymentIntentsPostRequestFormTransferDataMetadataAnyOf2Xff564ca6:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1PaymentIntentsPostRequestFormTransferDataMetadataAnyOf2Xff564ca6) {
                json
                    .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormTransferDataMetadataAnyOf2Xff564ca6>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1PaymentIntentsPostRequestFormTransferDataMetadataX80580355Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1PaymentIntentsPostRequestFormTransferDataMetadataAnyOf2Xff564ca6) {
                    add(
                        InlineV1PaymentIntentsPostRequestFormTransferDataMetadataX80580355Branch.InlineV1PaymentIntentsPostRequestFormTransferDataMetadataAnyOf2Xff564ca6,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1PaymentIntentsPostRequestFormTransferDataMetadataX80580355 {
            val inspection = inspectInlineV1PaymentIntentsPostRequestFormTransferDataMetadataX80580355(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1PaymentIntentsPostRequestFormTransferDataMetadataX80580355NoMatchException(
                    "InlineV1PaymentIntentsPostRequestFormTransferDataMetadataX80580355 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormTransferDataMetadataX80580355> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormTransferDataMetadataX80580355,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1PaymentIntentsPostRequestFormTransferDataMetadataX80580355",
...
private fun inspectInlineV1PaymentIntentsPostRequestFormTransferDataMetadataX80580355(
    element: JsonElement,
): InlineV1PaymentIntentsPostRequestFormTransferDataMetadataX80580355Inspection {
    val matchesBranch1 = element.isJsonDecodable<JsonObject>()
    val matchesInlineV1PaymentIntentsPostRequestFormTransferDataMetadataAnyOf2Xff564ca6 =
        element
            .isJsonDecodable<InlineV1PaymentIntentsPostRequestFormTransferDataMetadataAnyOf2Xff564ca6>()
    return InlineV1PaymentIntentsPostRequestFormTransferDataMetadataX80580355Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1PaymentIntentsPostRequestFormTransferDataMetadataAnyOf2Xff564ca6) {
                    add(
                        "InlineV1PaymentIntentsPostRequestFormTransferDataMetadataAnyOf2Xff564ca6: value does not match InlineV1PaymentIntentsPostRequestFormTransferDataMetadataAnyOf2Xff564ca6",
                    )
                }
            },
    )
