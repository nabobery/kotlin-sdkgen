...
public class SourceTypeCardPresent(
    ...
    public class Builder {
        ...
        public fun build(): SourceTypeCardPresent =
    ...
    public object Serializer : KSerializer<SourceTypeCardPresent> {
        ...
        override fun deserialize(decoder: Decoder): SourceTypeCardPresent {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("SourceTypeCardPresent must be a JSON object")
            return SourceTypeCardPresent(
                applicationCryptogram =
                    rawObject["application_cryptogram"]?.let {
                        json.decodeFromJsonElement<String>(
                            it,
                        )
                    },
                applicationPreferredName =
                    rawObject["application_preferred_name"]?.let {
                        json.decodeFromJsonElement<String>(
                            it,
                        )
                    },
                ...
                authorizationResponseCode =
                    rawObject["authorization_response_code"]?.let {
                        json
                ...
                dataType =
                    rawObject["data_type"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                evidenceCustomerSignature =
                    rawObject["evidence_customer_signature"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                evidenceTransactionCertificate =
                    rawObject["evidence_transaction_certificate"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                posDeviceId =
                    rawObject["pos_device_id"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                terminalVerificationResults =
                    rawObject["terminal_verification_results"]?.let {
                        json.decodeFromJsonElement<String>(it)
                    },
                transactionStatusInformation =
                    rawObject["transaction_status_information"]?.let {
                        json.decodeFromJsonElement<String>(it)
                    },
            )
        }
...
public fun sourceTypeCardPresent(block: SourceTypeCardPresent.Builder.() -> Unit): SourceTypeCardPresent =
    SourceTypeCardPresent.build(block)
