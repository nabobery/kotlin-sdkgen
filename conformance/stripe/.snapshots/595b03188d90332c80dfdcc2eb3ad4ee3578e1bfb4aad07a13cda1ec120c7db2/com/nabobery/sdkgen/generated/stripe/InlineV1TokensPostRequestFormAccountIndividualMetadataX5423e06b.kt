...
internal data class InlineV1TokensPostRequestFormAccountIndividualMetadataX5423e06bInspection(
    ...
    public val matchCount: Int
        get() =
            listOf(matchesBranch1, matchesInlineV1TokensPostRequestFormAccountIndividualMetadataAnyOf2Xa647a648).count {
                it
            }
}
...
public class InlineV1TokensPostRequestFormAccountIndividualMetadataX5423e06b internal constructor(
    ...
    public val inlineV1TokensPostRequestFormAccountIndividualMetadataAnyOf2Xa647a648:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1TokensPostRequestFormAccountIndividualMetadataAnyOf2Xa647a648) {
                json
                    .decodeFromJsonElement<InlineV1TokensPostRequestFormAccountIndividualMetadataAnyOf2Xa647a648>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1TokensPostRequestFormAccountIndividualMetadataX5423e06bBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1TokensPostRequestFormAccountIndividualMetadataAnyOf2Xa647a648) {
                    add(
                        InlineV1TokensPostRequestFormAccountIndividualMetadataX5423e06bBranch.InlineV1TokensPostRequestFormAccountIndividualMetadataAnyOf2Xa647a648,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1TokensPostRequestFormAccountIndividualMetadataX5423e06b {
            val inspection = inspectInlineV1TokensPostRequestFormAccountIndividualMetadataX5423e06b(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1TokensPostRequestFormAccountIndividualMetadataX5423e06bNoMatchException(
                    "InlineV1TokensPostRequestFormAccountIndividualMetadataX5423e06b matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1TokensPostRequestFormAccountIndividualMetadataX5423e06b> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TokensPostRequestFormAccountIndividualMetadataX5423e06b,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1TokensPostRequestFormAccountIndividualMetadataX5423e06b",
...
private fun inspectInlineV1TokensPostRequestFormAccountIndividualMetadataX5423e06b(
    element: JsonElement,
): InlineV1TokensPostRequestFormAccountIndividualMetadataX5423e06bInspection {
    val matchesBranch1 = element.isJsonDecodable<JsonObject>()
    val matchesInlineV1TokensPostRequestFormAccountIndividualMetadataAnyOf2Xa647a648 =
        element
            .isJsonDecodable<InlineV1TokensPostRequestFormAccountIndividualMetadataAnyOf2Xa647a648>()
    return InlineV1TokensPostRequestFormAccountIndividualMetadataX5423e06bInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1TokensPostRequestFormAccountIndividualMetadataAnyOf2Xa647a648) {
                    add(
                        "InlineV1TokensPostRequestFormAccountIndividualMetadataAnyOf2Xa647a648: value does not match InlineV1TokensPostRequestFormAccountIndividualMetadataAnyOf2Xa647a648",
                    )
                }
            },
    )
