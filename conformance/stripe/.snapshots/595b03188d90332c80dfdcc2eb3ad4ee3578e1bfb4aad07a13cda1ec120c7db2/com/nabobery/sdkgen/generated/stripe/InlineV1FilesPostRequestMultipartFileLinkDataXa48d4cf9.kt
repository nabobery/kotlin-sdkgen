...
public class InlineV1FilesPostRequestMultipartFileLinkDataXa48d4cf9(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1FilesPostRequestMultipartFileLinkDataXa48d4cf9 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1FilesPostRequestMultipartFileLinkDataXa48d4cf9> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1FilesPostRequestMultipartFileLinkDataXa48d4cf9 must be a JSON object",
                    )
            ...
            return InlineV1FilesPostRequestMultipartFileLinkDataXa48d4cf9(
                ...
                metadata =
                    rawObject["metadata"]?.let {
                        json.decodeFromJsonElement<InlineV1FilesPostRequestMultipartFileLinkDataMetadataXf40108f6>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1FilesPostRequestMultipartFileLinkDataXa48d4cf9,
        ) {
...
public fun inlineV1FilesPostRequestMultipartFileLinkDataXa48d4cf9(
    block: InlineV1FilesPostRequestMultipartFileLinkDataXa48d4cf9.Builder.() -> Unit,
): InlineV1FilesPostRequestMultipartFileLinkDataXa48d4cf9 =
    InlineV1FilesPostRequestMultipartFileLinkDataXa48d4cf9.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1FilesPostRequestMultipartFileLinkDataXa48d4cf9 is missing required property '" + name + "'",
            )
