...
public class InlineV1PaymentMethodsPostRequestFormUpiX90d92384(
    public val mandateOptions: InlineV1PaymentMethodsPostRequestFormUpiMandateOptionsXff16e6d0? = null,
) {
    public class Builder {
        public var mandateOptions: InlineV1PaymentMethodsPostRequestFormUpiMandateOptionsXff16e6d0? =
            null

        public fun build(): InlineV1PaymentMethodsPostRequestFormUpiX90d92384 =
            InlineV1PaymentMethodsPostRequestFormUpiX90d92384(
                mandateOptions = mandateOptions,
            )
    }

    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PaymentMethodsPostRequestFormUpiX90d92384 =
    ...
    public object Serializer : KSerializer<InlineV1PaymentMethodsPostRequestFormUpiX90d92384> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentMethodsPostRequestFormUpiX90d92384 must be a JSON object",
                    )
            return InlineV1PaymentMethodsPostRequestFormUpiX90d92384(
                mandateOptions =
                    rawObject["mandate_options"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentMethodsPostRequestFormUpiMandateOptionsXff16e6d0>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentMethodsPostRequestFormUpiX90d92384,
        ) {
...
public fun inlineV1PaymentMethodsPostRequestFormUpiX90d92384(
    block: InlineV1PaymentMethodsPostRequestFormUpiX90d92384.Builder.() -> Unit,
): InlineV1PaymentMethodsPostRequestFormUpiX90d92384 = InlineV1PaymentMethodsPostRequestFormUpiX90d92384.build(block)
