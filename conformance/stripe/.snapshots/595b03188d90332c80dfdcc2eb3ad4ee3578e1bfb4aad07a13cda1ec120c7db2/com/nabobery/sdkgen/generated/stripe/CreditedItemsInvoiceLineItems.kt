...
public class CreditedItemsInvoiceLineItems(
    ...
    public object Serializer : KSerializer<CreditedItemsInvoiceLineItems> {
        ...
        override fun deserialize(decoder: Decoder): CreditedItemsInvoiceLineItems {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("CreditedItemsInvoiceLineItems must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: CreditedItemsInvoiceLineItems,
        ) {
...
public fun creditedItemsInvoiceLineItems(
    block: CreditedItemsInvoiceLineItems.Builder.() -> Unit,
): CreditedItemsInvoiceLineItems = CreditedItemsInvoiceLineItems.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException("CreditedItemsInvoiceLineItems is missing required property '" + name + "'")
