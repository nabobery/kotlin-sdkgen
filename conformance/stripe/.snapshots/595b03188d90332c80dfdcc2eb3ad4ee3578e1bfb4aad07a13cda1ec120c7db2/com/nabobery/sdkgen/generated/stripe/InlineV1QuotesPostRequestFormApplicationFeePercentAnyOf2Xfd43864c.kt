...
public sealed class InlineV1QuotesPostRequestFormApplicationFeePercentAnyOf2Xfd43864c {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1QuotesPostRequestFormApplicationFeePercentAnyOf2Xfd43864c =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1QuotesPostRequestFormApplicationFeePercentAnyOf2Xfd43864c> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1QuotesPostRequestFormApplicationFeePercentAnyOf2Xfd43864c",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1QuotesPostRequestFormApplicationFeePercentAnyOf2Xfd43864c =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1QuotesPostRequestFormApplicationFeePercentAnyOf2Xfd43864c,
        ) {
