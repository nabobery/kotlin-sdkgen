...
public class OutboundTransfersPaymentMethodDetails(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): OutboundTransfersPaymentMethodDetails =
    ...
    public object Serializer : KSerializer<OutboundTransfersPaymentMethodDetails> {
        ...
        override fun deserialize(decoder: Decoder): OutboundTransfersPaymentMethodDetails {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("OutboundTransfersPaymentMethodDetails must be a JSON object")
            ...
            return OutboundTransfersPaymentMethodDetails(
                ...
                financialAccount =
                    rawObject["financial_account"]?.let {
                        json.decodeFromJsonElement<OutboundTransfersPaymentMethodDetailsFinancialAccount>(it)
                    },
                usBankAccount =
                    rawObject["us_bank_account"]?.let {
                        json.decodeFromJsonElement<OutboundTransfersPaymentMethodDetailsUsBankAccount>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: OutboundTransfersPaymentMethodDetails,
        ) {
...
public fun outboundTransfersPaymentMethodDetails(
    block: OutboundTransfersPaymentMethodDetails.Builder.() -> Unit,
): OutboundTransfersPaymentMethodDetails = OutboundTransfersPaymentMethodDetails.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "OutboundTransfersPaymentMethodDetails is missing required property '" + name + "'",
            )
