...
public class PaymentMethodCard(
    ...
    public object Serializer : KSerializer<PaymentMethodCard> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodCard {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodCard must be a JSON object")
            ...
            return PaymentMethodCard(
                ...
                checks =
                    rawObject["checks"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentMethodCardChecksXeaf46337?>(element)
                        }
                    },
                country =
                ...
                displayBrand =
                    rawObject["display_brand"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                generatedFrom =
                    rawObject["generated_from"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlinePaymentMethodCardGeneratedFromX734e0d2d?>(element)
                        }
                    },
                networks =
                    rawObject["networks"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentMethodCardNetworksXd1a77c6e?>(element)
                        }
                    },
                regulatedStatus =
                    rawObject["regulated_status"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentMethodCardRegulatedStatusX09fde27f?>(element)
                        }
                    },
                threeDSecureUsage =
                    rawObject["three_d_secure_usage"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlinePaymentMethodCardThreeDSecureUsageXbfee3c7f?>(element)
                        }
                    },
                wallet =
                    rawObject["wallet"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentMethodCardWalletXbb510817?>(element)
                        }
                    },
            )
        }
...
public fun paymentMethodCard(block: PaymentMethodCard.Builder.() -> Unit): PaymentMethodCard =
    PaymentMethodCard.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("PaymentMethodCard is missing required property '" + name + "'")
