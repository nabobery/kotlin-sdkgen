...
public class QuotesResourceTotalDetails(
    ...
    public object Serializer : KSerializer<QuotesResourceTotalDetails> {
        ...
        override fun deserialize(decoder: Decoder): QuotesResourceTotalDetails {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("QuotesResourceTotalDetails must be a JSON object")
            ...
            return QuotesResourceTotalDetails(
                ...
                breakdown =
                    rawObject["breakdown"]?.let {
                        json
                            .decodeFromJsonElement<QuotesResourceTotalDetailsResourceBreakdown>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: QuotesResourceTotalDetails,
        ) {
...
public fun quotesResourceTotalDetails(
    block: QuotesResourceTotalDetails.Builder.() -> Unit,
): QuotesResourceTotalDetails = QuotesResourceTotalDetails.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException("QuotesResourceTotalDetails is missing required property '" + name + "'")
