...
public class DisputePaymentMethodDetailsKlarna(
    ...
    public class Builder {
        ...
        public fun build(): DisputePaymentMethodDetailsKlarna =
    ...
    public object Serializer : KSerializer<DisputePaymentMethodDetailsKlarna> {
        ...
        override fun deserialize(decoder: Decoder): DisputePaymentMethodDetailsKlarna {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("DisputePaymentMethodDetailsKlarna must be a JSON object")
            return DisputePaymentMethodDetailsKlarna(
                chargebackLossReasonCode =
                    rawObject["chargeback_loss_reason_code"]?.let {
                        json.decodeFromJsonElement<String>(
                            it,
                        )
                    },
                reasonCode =
                    rawObject["reason_code"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: DisputePaymentMethodDetailsKlarna,
        ) {
...
public fun disputePaymentMethodDetailsKlarna(
    block: DisputePaymentMethodDetailsKlarna.Builder.() -> Unit,
): DisputePaymentMethodDetailsKlarna = DisputePaymentMethodDetailsKlarna.build(block)
