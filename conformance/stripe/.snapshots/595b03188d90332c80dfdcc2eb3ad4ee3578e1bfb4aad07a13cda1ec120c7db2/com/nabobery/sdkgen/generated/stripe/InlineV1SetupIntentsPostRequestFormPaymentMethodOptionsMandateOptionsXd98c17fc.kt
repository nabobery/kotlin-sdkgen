...
public class InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsMandateOptionsXd98c17fc(
    ...
    public val amountType: InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsCardAmountTypeX2edbfbd9,
    ...
    public val supportedTypes: List<InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsCardItemXe5d8b61d>? = null,
) {
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsMandateOptionsXd98c17fc =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsMandateOptionsXd98c17fc> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsMandateOptionsXd98c17fc must be a JSON object",
                    )
            val amount = json.decodeRequired<Int>(rawObject, "amount")
            val amountType =
                json
                    .decodeRequired<InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsCardAmountTypeX2edbfbd9>(
                        rawObject,
                        "amount_type",
                    )
            val currency = json.decodeRequired<String>(rawObject, "currency")
            val interval =
                json.decodeRequired<InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsCardIntervalXef3167cb>(
                    rawObject,
                    "interval",
                )
            ...
            return InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsMandateOptionsXd98c17fc(
                ...
                supportedTypes =
                    rawObject["supported_types"]?.let {
                        json
                            .decodeFromJsonElement<List<InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsCardItemXe5d8b61d>>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsMandateOptionsXd98c17fc,
        ) {
            val jsonEncoder =
...
public fun inlineV1SetupIntentsPostRequestFormPaymentMethodOptionsMandateOptionsXd98c17fc(
    block: InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsMandateOptionsXd98c17fc.Builder.() -> Unit,
): InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsMandateOptionsXd98c17fc =
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsMandateOptionsXd98c17fc is missing required property '" +
                    name +
                    "'",
            )
