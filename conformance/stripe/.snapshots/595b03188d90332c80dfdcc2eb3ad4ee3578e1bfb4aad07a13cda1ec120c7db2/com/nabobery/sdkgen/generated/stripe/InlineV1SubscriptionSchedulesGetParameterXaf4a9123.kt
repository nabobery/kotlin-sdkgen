...
public class InlineV1SubscriptionSchedulesGetParameterXaf4a9123 internal constructor(
    ...
    public val inlineV1SubscriptionSchedulesGetParameterAnyOf1X6958cce1:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1SubscriptionSchedulesGetParameterAnyOf1X6958cce1) {
                json
                    .decodeFromJsonElement<InlineV1SubscriptionSchedulesGetParameterAnyOf1X6958cce1>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1SubscriptionSchedulesGetParameterXaf4a9123Branch>
        get() =
            buildSet {
                if (inspection.matchesInlineV1SubscriptionSchedulesGetParameterAnyOf1X6958cce1) {
                    add(
                        InlineV1SubscriptionSchedulesGetParameterXaf4a9123Branch.InlineV1SubscriptionSchedulesGetParameterAnyOf1X6958cce1,
                    )
                }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1SubscriptionSchedulesGetParameterXaf4a9123 {
            val inspection = inspectInlineV1SubscriptionSchedulesGetParameterXaf4a9123(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1SubscriptionSchedulesGetParameterXaf4a9123NoMatchException(
                    "InlineV1SubscriptionSchedulesGetParameterXaf4a9123 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionSchedulesGetParameterXaf4a9123> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionSchedulesGetParameterXaf4a9123,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1SubscriptionSchedulesGetParameterXaf4a9123",
...
private fun inspectInlineV1SubscriptionSchedulesGetParameterXaf4a9123(
    element: JsonElement,
): InlineV1SubscriptionSchedulesGetParameterXaf4a9123Inspection {
    val matchesInlineV1SubscriptionSchedulesGetParameterAnyOf1X6958cce1 =
        element
            .isJsonDecodable<InlineV1SubscriptionSchedulesGetParameterAnyOf1X6958cce1>()
    ...
    return InlineV1SubscriptionSchedulesGetParameterXaf4a9123Inspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1SubscriptionSchedulesGetParameterAnyOf1X6958cce1) {
                    add(
                        "InlineV1SubscriptionSchedulesGetParameterAnyOf1X6958cce1: value does not match InlineV1SubscriptionSchedulesGetParameterAnyOf1X6958cce1",
                    )
                }
