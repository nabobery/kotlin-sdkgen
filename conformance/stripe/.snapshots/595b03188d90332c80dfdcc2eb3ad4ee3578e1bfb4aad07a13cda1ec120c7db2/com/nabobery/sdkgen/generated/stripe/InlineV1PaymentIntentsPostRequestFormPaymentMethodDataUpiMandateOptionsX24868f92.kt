...
public class InlineV1PaymentIntentsPostRequestFormPaymentMethodDataUpiMandateOptionsX24868f92(
    ...
    public val amountType: InlineV1PaymentIntentsPostRequestFormPaymentMethodDataUpiAmountTypeXf62da571? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1PaymentIntentsPostRequestFormPaymentMethodDataUpiMandateOptionsX24868f92 =
            InlineV1PaymentIntentsPostRequestFormPaymentMethodDataUpiMandateOptionsX24868f92(
                amount = amount,
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormPaymentMethodDataUpiMandateOptionsX24868f92> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsPostRequestFormPaymentMethodDataUpiMandateOptionsX24868f92 must be a JSON object",
                    )
            return InlineV1PaymentIntentsPostRequestFormPaymentMethodDataUpiMandateOptionsX24868f92(
                ...
                amountType =
                    rawObject["amount_type"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodDataUpiAmountTypeXf62da571>(
                                it,
                            )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormPaymentMethodDataUpiMandateOptionsX24868f92,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentIntentsPostRequestFormPaymentMethodDataUpiMandateOptionsX24868f92(
    block: InlineV1PaymentIntentsPostRequestFormPaymentMethodDataUpiMandateOptionsX24868f92.Builder.() -> Unit,
): InlineV1PaymentIntentsPostRequestFormPaymentMethodDataUpiMandateOptionsX24868f92 =
