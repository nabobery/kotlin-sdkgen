...
public class TaxProductRegistrationsResourceCountryOptionsUsStateSalesTaxElection(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): TaxProductRegistrationsResourceCountryOptionsUsStateSalesTaxElection = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<TaxProductRegistrationsResourceCountryOptionsUsStateSalesTaxElection> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "TaxProductRegistrationsResourceCountryOptionsUsStateSalesTaxElection must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: TaxProductRegistrationsResourceCountryOptionsUsStateSalesTaxElection,
        ) {
            val jsonEncoder =
...
public fun taxProductRegistrationsResourceCountryOptionsUsStateSalesTaxElection(
    block: TaxProductRegistrationsResourceCountryOptionsUsStateSalesTaxElection.Builder.() -> Unit,
): TaxProductRegistrationsResourceCountryOptionsUsStateSalesTaxElection =
    TaxProductRegistrationsResourceCountryOptionsUsStateSalesTaxElection.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "TaxProductRegistrationsResourceCountryOptionsUsStateSalesTaxElection is missing required property '" +
                    name +
                    "'",
            )
