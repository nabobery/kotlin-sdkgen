...
public class InlineV1TestHelpersIssuing214aPostRequestFormAuthenticationExemptionXc9b11235(
    public val claimedBy: InlineV1TestHelpersIssuing214aPostRequestFormVerificationDataClaimedByXcd365470,
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1TestHelpersIssuing214aPostRequestFormAuthenticationExemptionXc9b11235 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TestHelpersIssuing214aPostRequestFormAuthenticationExemptionXc9b11235> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TestHelpersIssuing214aPostRequestFormAuthenticationExemptionXc9b11235 must be a JSON object",
                    )
            val claimedBy =
                json
                    .decodeRequired<InlineV1TestHelpersIssuing214aPostRequestFormVerificationDataClaimedByXcd365470>(
                        rawObject,
                        "claimed_by",
                    )
            val type =
                json.decodeRequired<InlineV1TestHelpersIssuing214aPostRequestFormVerificationDataTypeX7d264158>(
                    rawObject,
                    "type",
                )
            return InlineV1TestHelpersIssuing214aPostRequestFormAuthenticationExemptionXc9b11235(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TestHelpersIssuing214aPostRequestFormAuthenticationExemptionXc9b11235,
        ) {
            val jsonEncoder =
...
public fun inlineV1TestHelpersIssuing214aPostRequestFormAuthenticationExemptionXc9b11235(
    block: InlineV1TestHelpersIssuing214aPostRequestFormAuthenticationExemptionXc9b11235.Builder.() -> Unit,
): InlineV1TestHelpersIssuing214aPostRequestFormAuthenticationExemptionXc9b11235 =
    InlineV1TestHelpersIssuing214aPostRequestFormAuthenticationExemptionXc9b11235.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TestHelpersIssuing214aPostRequestFormAuthenticationExemptionXc9b11235 is missing required property '" +
                    name +
                    "'",
            )
