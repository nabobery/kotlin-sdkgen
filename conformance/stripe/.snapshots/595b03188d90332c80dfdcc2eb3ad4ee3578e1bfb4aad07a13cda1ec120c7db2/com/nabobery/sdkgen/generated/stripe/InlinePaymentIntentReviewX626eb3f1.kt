...
public class InlinePaymentIntentReviewX626eb3f1 internal constructor(
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlinePaymentIntentReviewX626eb3f1 {
            val inspection = inspectInlinePaymentIntentReviewX626eb3f1(raw)
            if (inspection.matchCount == 0) {
                throw InlinePaymentIntentReviewX626eb3f1NoMatchException(
                    "InlinePaymentIntentReviewX626eb3f1 matched 0 branches: " + inspection.failures.joinToString("; "),
                )
            }
    ...
    public object Serializer : KSerializer<InlinePaymentIntentReviewX626eb3f1> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentIntentReviewX626eb3f1,
        ) {
...
private fun inspectInlinePaymentIntentReviewX626eb3f1(
    element: JsonElement,
): InlinePaymentIntentReviewX626eb3f1Inspection {
