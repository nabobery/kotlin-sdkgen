...
public class IssuingTransactionFleetFuelPriceData(
    ...
    public class Builder {
        ...
        public fun build(): IssuingTransactionFleetFuelPriceData =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): IssuingTransactionFleetFuelPriceData =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<IssuingTransactionFleetFuelPriceData> {
        ...
        override fun deserialize(decoder: Decoder): IssuingTransactionFleetFuelPriceData {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("IssuingTransactionFleetFuelPriceData must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: IssuingTransactionFleetFuelPriceData,
        ) {
...
public fun issuingTransactionFleetFuelPriceData(
    block: IssuingTransactionFleetFuelPriceData.Builder.() -> Unit,
): IssuingTransactionFleetFuelPriceData = IssuingTransactionFleetFuelPriceData.build(block)
