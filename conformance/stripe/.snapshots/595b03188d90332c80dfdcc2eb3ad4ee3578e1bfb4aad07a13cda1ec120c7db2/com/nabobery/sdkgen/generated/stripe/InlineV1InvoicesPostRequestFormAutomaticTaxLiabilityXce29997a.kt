...
public class InlineV1InvoicesPostRequestFormAutomaticTaxLiabilityXce29997a(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1InvoicesPostRequestFormAutomaticTaxLiabilityXce29997a =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1InvoicesPostRequestFormAutomaticTaxLiabilityXce29997a> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1InvoicesPostRequestFormAutomaticTaxLiabilityXce29997a {
            val jsonDecoder =
                decoder.requireJsonDecoder(
                    "InlineV1InvoicesPostRequestFormAutomaticTaxLiabilityXce29997a",
                )
            val json = jsonDecoder.json
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1InvoicesPostRequestFormAutomaticTaxLiabilityXce29997a must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineV1InvoicesPostRequestFormAutomaticTaxLiabilityTypeXa501ec4e>(
                    rawObject,
                    "type",
                )
            return InlineV1InvoicesPostRequestFormAutomaticTaxLiabilityXce29997a(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesPostRequestFormAutomaticTaxLiabilityXce29997a,
        ) {
            val jsonEncoder =
...
public fun inlineV1InvoicesPostRequestFormAutomaticTaxLiabilityXce29997a(
    block: InlineV1InvoicesPostRequestFormAutomaticTaxLiabilityXce29997a.Builder.() -> Unit,
): InlineV1InvoicesPostRequestFormAutomaticTaxLiabilityXce29997a =
    InlineV1InvoicesPostRequestFormAutomaticTaxLiabilityXce29997a.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1InvoicesPostRequestFormAutomaticTaxLiabilityXce29997a is missing required property '" + name +
                    "'",
            )
