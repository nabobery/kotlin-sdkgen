...
public data class ConfirmationTokensResourcePaymentMethodOptionsResourceCardView(
    ...
    public val installments: ConfirmationTokensResourcePaymentMethodOptionsResourceCardResourceInstallment? = null,
)
...
public class ConfirmationTokensResourcePaymentMethodOptionsResourceCard(
    ...
    public class Builder {
        ...
        public fun build(): ConfirmationTokensResourcePaymentMethodOptionsResourceCard =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): ConfirmationTokensResourcePaymentMethodOptionsResourceCard =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<ConfirmationTokensResourcePaymentMethodOptionsResourceCard> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "ConfirmationTokensResourcePaymentMethodOptionsResourceCard must be a JSON object",
                    )
            return ConfirmationTokensResourcePaymentMethodOptionsResourceCard(
                cvcToken =
                    rawObject["cvc_token"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                installments =
                    rawObject["installments"]?.let {
                        json
                            .decodeFromJsonElement<ConfirmationTokensResourcePaymentMethodOptionsResourceCardResourceInstallment>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: ConfirmationTokensResourcePaymentMethodOptionsResourceCard,
        ) {
...
public fun confirmationTokensResourcePaymentMethodOptionsResourceCard(
    block: ConfirmationTokensResourcePaymentMethodOptionsResourceCard.Builder.() -> Unit,
): ConfirmationTokensResourcePaymentMethodOptionsResourceCard =
    ConfirmationTokensResourcePaymentMethodOptionsResourceCard.build(block)
