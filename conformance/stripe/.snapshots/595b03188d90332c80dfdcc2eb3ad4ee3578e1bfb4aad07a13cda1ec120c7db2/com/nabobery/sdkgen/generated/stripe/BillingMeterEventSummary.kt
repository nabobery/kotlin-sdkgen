...
public class BillingMeterEventSummary(
    ...
    public object Serializer : KSerializer<BillingMeterEventSummary> {
        ...
        override fun deserialize(decoder: Decoder): BillingMeterEventSummary {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("BillingMeterEventSummary must be a JSON object")
            ...
            val objectValue =
                json.decodeRequired<InlineBillingMeterEventSummaryObjectValueX1b2b2ac7>(
                    rawObject,
                    "object",
                )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: BillingMeterEventSummary,
        ) {
...
public fun billingMeterEventSummary(block: BillingMeterEventSummary.Builder.() -> Unit): BillingMeterEventSummary =
    BillingMeterEventSummary.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException("BillingMeterEventSummary is missing required property '" + name + "'")
