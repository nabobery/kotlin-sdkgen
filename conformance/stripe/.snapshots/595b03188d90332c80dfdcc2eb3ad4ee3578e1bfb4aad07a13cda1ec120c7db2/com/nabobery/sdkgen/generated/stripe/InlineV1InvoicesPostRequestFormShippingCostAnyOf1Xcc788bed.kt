...
public class InlineV1InvoicesPostRequestFormShippingCostAnyOf1Xcc788bed(
    ...
    public val shippingRateData: InlineV1InvoicesPostRequestFormShippingCostAnyOf1ShippingRateDataX55e5a199? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1InvoicesPostRequestFormShippingCostAnyOf1Xcc788bed =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1InvoicesPostRequestFormShippingCostAnyOf1Xcc788bed =
    ...
    public object Serializer : KSerializer<InlineV1InvoicesPostRequestFormShippingCostAnyOf1Xcc788bed> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1InvoicesPostRequestFormShippingCostAnyOf1Xcc788bed must be a JSON object",
                    )
            return InlineV1InvoicesPostRequestFormShippingCostAnyOf1Xcc788bed(
                ...
                shippingRateData =
                    rawObject["shipping_rate_data"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1InvoicesPostRequestFormShippingCostAnyOf1ShippingRateDataX55e5a199>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesPostRequestFormShippingCostAnyOf1Xcc788bed,
        ) {
...
public fun inlineV1InvoicesPostRequestFormShippingCostAnyOf1Xcc788bed(
    block: InlineV1InvoicesPostRequestFormShippingCostAnyOf1Xcc788bed.Builder.() -> Unit,
): InlineV1InvoicesPostRequestFormShippingCostAnyOf1Xcc788bed =
    InlineV1InvoicesPostRequestFormShippingCostAnyOf1Xcc788bed.build(block)
