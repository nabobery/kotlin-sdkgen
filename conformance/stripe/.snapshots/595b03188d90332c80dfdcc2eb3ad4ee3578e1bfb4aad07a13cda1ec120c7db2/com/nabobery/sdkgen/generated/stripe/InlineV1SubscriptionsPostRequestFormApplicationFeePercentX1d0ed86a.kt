...
internal data class InlineV1SubscriptionsPostRequestFormApplicationFeePercentX1d0ed86aInspection(
    ...
    public val matchesInlineV1SubscriptionsPostRequestFormApplicationFeePercentAnyOf2Xb2ec1cf7: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1SubscriptionsPostRequestFormApplicationFeePercentAnyOf2Xb2ec1cf7,
            ).count {
                it
            }
}
...
public class InlineV1SubscriptionsPostRequestFormApplicationFeePercentX1d0ed86a internal constructor(
    ...
    private val inspection: InlineV1SubscriptionsPostRequestFormApplicationFeePercentX1d0ed86aInspection,
) {
    ...
    public val inlineV1SubscriptionsPostRequestFormApplicationFeePercentAnyOf2Xb2ec1cf7:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1SubscriptionsPostRequestFormApplicationFeePercentAnyOf2Xb2ec1cf7) {
                json
                    .decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormApplicationFeePercentAnyOf2Xb2ec1cf7>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1SubscriptionsPostRequestFormApplicationFeePercentX1d0ed86aBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1SubscriptionsPostRequestFormApplicationFeePercentAnyOf2Xb2ec1cf7) {
                    add(
                        InlineV1SubscriptionsPostRequestFormApplicationFeePercentX1d0ed86aBranch.InlineV1SubscriptionsPostRequestFormApplicationFeePercentAnyOf2Xb2ec1cf7,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1SubscriptionsPostRequestFormApplicationFeePercentX1d0ed86a {
            val inspection = inspectInlineV1SubscriptionsPostRequestFormApplicationFeePercentX1d0ed86a(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1SubscriptionsPostRequestFormApplicationFeePercentX1d0ed86aNoMatchException(
                    "InlineV1SubscriptionsPostRequestFormApplicationFeePercentX1d0ed86a matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionsPostRequestFormApplicationFeePercentX1d0ed86a> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsPostRequestFormApplicationFeePercentX1d0ed86a,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1SubscriptionsPostRequestFormApplicationFeePercentX1d0ed86a",
...
private fun inspectInlineV1SubscriptionsPostRequestFormApplicationFeePercentX1d0ed86a(
    element: JsonElement,
    ...
    val matchesInlineV1SubscriptionsPostRequestFormApplicationFeePercentAnyOf2Xb2ec1cf7 =
        element
            .isJsonDecodable<InlineV1SubscriptionsPostRequestFormApplicationFeePercentAnyOf2Xb2ec1cf7>()
    return InlineV1SubscriptionsPostRequestFormApplicationFeePercentX1d0ed86aInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1SubscriptionsPostRequestFormApplicationFeePercentAnyOf2Xb2ec1cf7) {
                    add(
                        "InlineV1SubscriptionsPostRequestFormApplicationFeePercentAnyOf2Xb2ec1cf7: value does not match InlineV1SubscriptionsPostRequestFormApplicationFeePercentAnyOf2Xb2ec1cf7",
                    )
                }
            },
    )
