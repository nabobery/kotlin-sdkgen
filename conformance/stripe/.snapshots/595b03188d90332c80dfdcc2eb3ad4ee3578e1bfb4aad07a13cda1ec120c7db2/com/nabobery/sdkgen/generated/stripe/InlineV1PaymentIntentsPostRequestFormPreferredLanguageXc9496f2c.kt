...
public sealed class InlineV1PaymentIntentsPostRequestFormPreferredLanguageXc9496f2c {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1PaymentIntentsPostRequestFormPreferredLanguageXc9496f2c =
            when (value) {
                De.value -> De
                En.value -> En
                Fr.value -> Fr
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormPreferredLanguageXc9496f2c> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1PaymentIntentsPostRequestFormPreferredLanguageXc9496f2c",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1PaymentIntentsPostRequestFormPreferredLanguageXc9496f2c =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormPreferredLanguageXc9496f2c,
        ) {
