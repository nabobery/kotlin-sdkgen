...
public class InlineV1CouponsGetParameterX3b2359f8 internal constructor(
    ...
    public val inlineV1CouponsGetParameterAnyOf1Xcc33bef0: InlineV1CouponsGetParameterAnyOf1Xcc33bef0?
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1CouponsGetParameterAnyOf1Xcc33bef0) {
                json
                    .decodeFromJsonElement<InlineV1CouponsGetParameterAnyOf1Xcc33bef0>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1CouponsGetParameterX3b2359f8Branch>
        get() =
            buildSet {
                if (inspection.matchesInlineV1CouponsGetParameterAnyOf1Xcc33bef0) {
                    add(
                        InlineV1CouponsGetParameterX3b2359f8Branch.InlineV1CouponsGetParameterAnyOf1Xcc33bef0,
                    )
                }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1CouponsGetParameterX3b2359f8 {
            val inspection = inspectInlineV1CouponsGetParameterX3b2359f8(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1CouponsGetParameterX3b2359f8NoMatchException(
                    "InlineV1CouponsGetParameterX3b2359f8 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1CouponsGetParameterX3b2359f8> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CouponsGetParameterX3b2359f8,
        ) {
...
private fun inspectInlineV1CouponsGetParameterX3b2359f8(
    element: JsonElement,
): InlineV1CouponsGetParameterX3b2359f8Inspection {
    val matchesInlineV1CouponsGetParameterAnyOf1Xcc33bef0 =
        element
            .isJsonDecodable<InlineV1CouponsGetParameterAnyOf1Xcc33bef0>()
    ...
    return InlineV1CouponsGetParameterX3b2359f8Inspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1CouponsGetParameterAnyOf1Xcc33bef0) {
                    add(
                        "InlineV1CouponsGetParameterAnyOf1Xcc33bef0: value does not match InlineV1CouponsGetParameterAnyOf1Xcc33bef0",
                    )
                }
