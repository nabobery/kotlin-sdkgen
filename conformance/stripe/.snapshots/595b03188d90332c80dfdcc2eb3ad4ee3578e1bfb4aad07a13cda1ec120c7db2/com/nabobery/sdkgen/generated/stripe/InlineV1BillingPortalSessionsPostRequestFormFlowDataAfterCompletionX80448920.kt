...
public class InlineV1BillingPortalSessionsPostRequestFormFlowDataAfterCompletionX80448920(
    ...
    public val redirect: InlineV1BillingPortalSessionsPostRequestFormFlowDataRedirectX2cd00d6c? = null,
) {
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1BillingPortalSessionsPostRequestFormFlowDataAfterCompletionX80448920 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1BillingPortalSessionsPostRequestFormFlowDataAfterCompletionX80448920> {
        override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1BillingPortalSessionsPostRequestFormFlowDataAfterCompletionX80448920 {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1BillingPortalSessionsPostRequestFormFlowDataAfterCompletionX80448920 must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineV1BillingPortalSessionsPostRequestFormFlowDataAfterCompletionTypeX2b9e28ae>(
                    rawObject,
                    "type",
                )
            return InlineV1BillingPortalSessionsPostRequestFormFlowDataAfterCompletionX80448920(
                ...
                hostedConfirmation =
                    rawObject["hosted_confirmation"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1BillingPortalSessionsPostRequestFormFlowDataHostedConfirmationXba1280c7>(
                                it,
                            )
                    },
                redirect =
                    rawObject["redirect"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1BillingPortalSessionsPostRequestFormFlowDataRedirectX2cd00d6c>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1BillingPortalSessionsPostRequestFormFlowDataAfterCompletionX80448920,
        ) {
            val jsonEncoder =
...
public fun inlineV1BillingPortalSessionsPostRequestFormFlowDataAfterCompletionX80448920(
    block: InlineV1BillingPortalSessionsPostRequestFormFlowDataAfterCompletionX80448920.Builder.() -> Unit,
): InlineV1BillingPortalSessionsPostRequestFormFlowDataAfterCompletionX80448920 =
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1BillingPortalSessionsPostRequestFormFlowDataAfterCompletionX80448920 is missing required property '" +
                    name +
                    "'",
            )
