...
public class InlineV1AccountsPeoplePostRequestFormX16d9e823(
     ...
     */
    public val additionalTosAcceptances: InlineV1AccountsPeoplePostRequestFormAdditionalTosAcceptancesX35344a52? = null,
    /**
     ...
     */
    public val politicalExposure: InlineV1AccountsPeoplePostRequestFormPoliticalExposureX5c41dae4? = null,
    /**
     * The person's registered address.
     */
    public val registeredAddress: InlineV1AccountsPeoplePostRequestFormRegisteredAddressXa789c6e0? = null,
    /**
    ...
    public class Builder {
        ...
        public fun build(): InlineV1AccountsPeoplePostRequestFormX16d9e823 =
            InlineV1AccountsPeoplePostRequestFormX16d9e823(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1AccountsPeoplePostRequestFormX16d9e823 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1AccountsPeoplePostRequestFormX16d9e823> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountsPeoplePostRequestFormX16d9e823 must be a JSON object",
                    )
            return InlineV1AccountsPeoplePostRequestFormX16d9e823(
                additionalTosAcceptances =
                    rawObject["additional_tos_acceptances"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1AccountsPeoplePostRequestFormAdditionalTosAcceptancesX35344a52>(
                                it,
                            )
                    },
                address =
                    rawObject["address"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPeoplePostRequestFormAddressX591c679a>(it)
                    },
                addressKana =
                    rawObject["address_kana"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPeoplePostRequestFormAddressKanaX87d1bc9a>(it)
                    },
                addressKanji =
                    rawObject["address_kanji"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPeoplePostRequestFormAddressKanjiXff7cca37>(it)
                    },
                dob =
                    rawObject["dob"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPeoplePostRequestFormDobX0b84cc8e>(
                            it,
                        )
                    },
                documents =
                    rawObject["documents"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPeoplePostRequestFormDocumentsXd121043a>(it)
                    },
                ...
                fullNameAliases =
                    rawObject["full_name_aliases"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPeoplePostRequestFormFullNameAliasesX852d0816>(it)
                    },
                ...
                metadata =
                    rawObject["metadata"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPeoplePostRequestFormMetadataXae6fb3ec>(it)
                    },
                ...
                politicalExposure =
                    rawObject["political_exposure"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPeoplePostRequestFormPoliticalExposureX5c41dae4>(it)
                    },
                registeredAddress =
                    rawObject["registered_address"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPeoplePostRequestFormRegisteredAddressXa789c6e0>(it)
                    },
                relationship =
                    rawObject["relationship"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPeoplePostRequestFormRelationshipX1f8d312d>(it)
                    },
                ssnLast4 = rawObject["ssn_last_4"]?.let { json.decodeFromJsonElement<String>(it) },
                usCfpbData =
                    rawObject["us_cfpb_data"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPeoplePostRequestFormUsCfpbDataX5223c4aa>(it)
                    },
                verification =
                    rawObject["verification"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPeoplePostRequestFormVerificationXb9b0d33d>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPeoplePostRequestFormX16d9e823,
        ) {
...
public fun inlineV1AccountsPeoplePostRequestFormX16d9e823(
    block: InlineV1AccountsPeoplePostRequestFormX16d9e823.Builder.() -> Unit,
): InlineV1AccountsPeoplePostRequestFormX16d9e823 = InlineV1AccountsPeoplePostRequestFormX16d9e823.build(block)
