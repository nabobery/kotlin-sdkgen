...
public class ConnectEmbeddedBaseConfigClaim(
    ...
    public object Serializer : KSerializer<ConnectEmbeddedBaseConfigClaim> {
        ...
        override fun deserialize(decoder: Decoder): ConnectEmbeddedBaseConfigClaim {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("ConnectEmbeddedBaseConfigClaim must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: ConnectEmbeddedBaseConfigClaim,
        ) {
...
public fun connectEmbeddedBaseConfigClaim(
    block: ConnectEmbeddedBaseConfigClaim.Builder.() -> Unit,
): ConnectEmbeddedBaseConfigClaim = ConnectEmbeddedBaseConfigClaim.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "ConnectEmbeddedBaseConfigClaim is missing required property '" + name + "'",
            )
