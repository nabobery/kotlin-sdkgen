...
public class InlineV1PaymentMethodConfigurationsPostRequestFormBancontactX7ea2e26b(
    public val displayPreference: InlineV1PaymentMethodConfidc49PostRequestFormDisplayPreferenceX2975c00c? = null,
) {
    public class Builder {
        public var displayPreference:
            InlineV1PaymentMethodConfidc49PostRequestFormDisplayPreferenceX2975c00c? = null

        public fun build(): InlineV1PaymentMethodConfigurationsPostRequestFormBancontactX7ea2e26b =
            InlineV1PaymentMethodConfigurationsPostRequestFormBancontactX7ea2e26b(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentMethodConfigurationsPostRequestFormBancontactX7ea2e26b = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1PaymentMethodConfigurationsPostRequestFormBancontactX7ea2e26b> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentMethodConfigurationsPostRequestFormBancontactX7ea2e26b must be a JSON object",
                    )
            return InlineV1PaymentMethodConfigurationsPostRequestFormBancontactX7ea2e26b(
                displayPreference =
                    rawObject["display_preference"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentMethodConfidc49PostRequestFormDisplayPreferenceX2975c00c>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentMethodConfigurationsPostRequestFormBancontactX7ea2e26b,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentMethodConfigurationsPostRequestFormBancontactX7ea2e26b(
    block: InlineV1PaymentMethodConfigurationsPostRequestFormBancontactX7ea2e26b.Builder.() -> Unit,
): InlineV1PaymentMethodConfigurationsPostRequestFormBancontactX7ea2e26b =
