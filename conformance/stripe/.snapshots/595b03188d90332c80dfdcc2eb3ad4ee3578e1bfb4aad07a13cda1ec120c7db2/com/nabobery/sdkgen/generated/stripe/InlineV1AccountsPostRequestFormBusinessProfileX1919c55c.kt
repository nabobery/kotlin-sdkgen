...
public class InlineV1AccountsPostRequestFormBusinessProfileX1919c55c(
    public val annualRevenue: InlineV1AccountsPostRequestFormBusinessProfileAnnualRevenueXdc054527? = null,
    ...
    public val supportAddress: InlineV1AccountsPostRequestFormBusinessProfileSupportAddressX8ce68f99? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1AccountsPostRequestFormBusinessProfileX1919c55c =
            InlineV1AccountsPostRequestFormBusinessProfileX1919c55c(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1AccountsPostRequestFormBusinessProfileX1919c55c =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1AccountsPostRequestFormBusinessProfileX1919c55c> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountsPostRequestFormBusinessProfileX1919c55c must be a JSON object",
                    )
            return InlineV1AccountsPostRequestFormBusinessProfileX1919c55c(
                annualRevenue =
                    rawObject["annual_revenue"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1AccountsPostRequestFormBusinessProfileAnnualRevenueXdc054527>(
                                it,
                            )
                    },
                estimatedWorkerCount =
                    rawObject["estimated_worker_count"]?.let {
                ...
                minorityOwnedBusinessDesignation =
                    rawObject["minority_owned_business_designation"]?.let {
                        json.decodeFromJsonElement<List<InlineV1AccountsPostRequestFormBusinessProfileItemX9abae613>>(
                            it,
                        )
                    },
                monthlyEstimatedRevenue =
                    rawObject["monthly_estimated_revenue"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1AccountsPostRequestFormBusinessProfileMonthlyEstimatedRevenueXcb3827a2>(
                                it,
                            )
                    },
                ...
                supportAddress =
                    rawObject["support_address"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1AccountsPostRequestFormBusinessProfileSupportAddressX8ce68f99>(
                                it,
                            )
                    },
                ...
                supportUrl =
                    rawObject["support_url"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPostRequestFormBusinessProfileSupportUrlX73db74f8>(
                            it,
                        )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPostRequestFormBusinessProfileX1919c55c,
        ) {
            ...
            val raw =
                buildJsonObject {
                    ...
                    value.minorityOwnedBusinessDesignation?.let {
                        put(
                            "minority_owned_business_designation",
                            json.encodeToJsonElement(it),
                        )
                    }
                    value.monthlyEstimatedRevenue?.let {
                        put(
...
public fun inlineV1AccountsPostRequestFormBusinessProfileX1919c55c(
    block: InlineV1AccountsPostRequestFormBusinessProfileX1919c55c.Builder.() -> Unit,
): InlineV1AccountsPostRequestFormBusinessProfileX1919c55c =
    InlineV1AccountsPostRequestFormBusinessProfileX1919c55c.build(block)
