...
public sealed class InlineUsBankAccountNetworksSupportedItemXc9194e8b {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineUsBankAccountNetworksSupportedItemXc9194e8b =
            when (value) {
                Ach.value -> Ach
    ...
    public object Serializer : KSerializer<InlineUsBankAccountNetworksSupportedItemXc9194e8b> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineUsBankAccountNetworksSupportedItemXc9194e8b",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineUsBankAccountNetworksSupportedItemXc9194e8b =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineUsBankAccountNetworksSupportedItemXc9194e8b,
        ) {
