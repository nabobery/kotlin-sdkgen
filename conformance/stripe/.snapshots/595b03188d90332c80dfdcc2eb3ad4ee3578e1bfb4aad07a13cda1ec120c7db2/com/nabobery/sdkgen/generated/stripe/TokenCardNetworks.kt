...
public class TokenCardNetworks(
    ...
    public class Builder {
        ...
        public fun build(): TokenCardNetworks =
            TokenCardNetworks(
                preferred = preferred,
            )
    }
    ...
    public object Serializer : KSerializer<TokenCardNetworks> {
        ...
        override fun deserialize(decoder: Decoder): TokenCardNetworks {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("TokenCardNetworks must be a JSON object")
...
public fun tokenCardNetworks(block: TokenCardNetworks.Builder.() -> Unit): TokenCardNetworks =
    TokenCardNetworks.build(block)
