...
public sealed class InlineV1InvoicesPostRequestFormFromInvoiceActionX46ac8805 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1InvoicesPostRequestFormFromInvoiceActionX46ac8805 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1InvoicesPostRequestFormFromInvoiceActionX46ac8805> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1InvoicesPostRequestFormFromInvoiceActionX46ac8805",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1InvoicesPostRequestFormFromInvoiceActionX46ac8805 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesPostRequestFormFromInvoiceActionX46ac8805,
        ) {
