...
internal data class InlineV1DisputesPostRequestFormEvidenceCustomerDeviceFinger9c71X003f00efInspection(
    ...
    public val matchesInlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2X0f6bed99: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2X0f6bed99,
            ).count {
                it
            }
}
...
public class InlineV1DisputesPostRequestFormEvidenceCustomerDeviceFinger9c71X003f00ef internal constructor(
    ...
    private val inspection: InlineV1DisputesPostRequestFormEvidenceCustomerDeviceFinger9c71X003f00efInspection,
) {
    ...
    public val inlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2X0f6bed99:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2X0f6bed99) {
                json
                    .decodeFromJsonElement<InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2X0f6bed99>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1DisputesPostRequestFormEvidenceCustomerDeviceFinger9c71X003f00efBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2X0f6bed99) {
                    add(
                        InlineV1DisputesPostRequestFormEvidenceCustomerDeviceFinger9c71X003f00efBranch.InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2X0f6bed99,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1DisputesPostRequestFormEvidenceCustomerDeviceFinger9c71X003f00ef {
            val inspection = inspectInlineV1DisputesPostRequestFormEvidenceCustomerDeviceFinger9c71X003f00ef(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1DisputesPostRequestFormEvidenceCustomerDeviceFinger9c71X003f00efNoMatchException(
                    "InlineV1DisputesPostRequestFormEvidenceCustomerDeviceFinger9c71X003f00ef matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1DisputesPostRequestFormEvidenceCustomerDeviceFinger9c71X003f00ef> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1DisputesPostRequestFormEvidenceCustomerDeviceFinger9c71X003f00ef,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1DisputesPostRequestFormEvidenceCustomerDeviceFinger9c71X003f00ef",
...
private fun inspectInlineV1DisputesPostRequestFormEvidenceCustomerDeviceFinger9c71X003f00ef(
    element: JsonElement,
): InlineV1DisputesPostRequestFormEvidenceCustomerDeviceFinger9c71X003f00efInspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2X0f6bed99 =
        element
            .isJsonDecodable<InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2X0f6bed99>()
    return InlineV1DisputesPostRequestFormEvidenceCustomerDeviceFinger9c71X003f00efInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2X0f6bed99) {
                    add(
                        "InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2X0f6bed99: value does not match InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2X0f6bed99",
                    )
                }
            },
    )
