...
public class QuotesResourceRecurring(
    ...
    public object Serializer : KSerializer<QuotesResourceRecurring> {
        ...
        override fun deserialize(decoder: Decoder): QuotesResourceRecurring {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("QuotesResourceRecurring must be a JSON object")
...
public fun quotesResourceRecurring(block: QuotesResourceRecurring.Builder.() -> Unit): QuotesResourceRecurring =
    QuotesResourceRecurring.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("QuotesResourceRecurring is missing required property '" + name + "'")
