...
public sealed class InlinePaymentMethodOptionsPixAmountIncludesIofXb30d753a {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentMethodOptionsPixAmountIncludesIofXb30d753a =
            when (value) {
                Always.value -> Always
                Never.value -> Never
    ...
    public object Serializer : KSerializer<InlinePaymentMethodOptionsPixAmountIncludesIofXb30d753a> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentMethodOptionsPixAmountIncludesIofXb30d753a",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePaymentMethodOptionsPixAmountIncludesIofXb30d753a =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentMethodOptionsPixAmountIncludesIofXb30d753a,
        ) {
