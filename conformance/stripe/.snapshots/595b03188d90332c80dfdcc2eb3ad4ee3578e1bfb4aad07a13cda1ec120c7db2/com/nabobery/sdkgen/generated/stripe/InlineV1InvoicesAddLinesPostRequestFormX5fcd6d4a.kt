...
public class InlineV1InvoicesAddLinesPostRequestFormX5fcd6d4a(
     ...
     */
    public val invoiceMetadata: InlineV1InvoicesAddLinesPostRequestFormInvoiceMetadataXf359f669? = null,
) {
    /**
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1InvoicesAddLinesPostRequestFormX5fcd6d4a =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1InvoicesAddLinesPostRequestFormX5fcd6d4a> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1InvoicesAddLinesPostRequestFormX5fcd6d4a must be a JSON object",
                    )
            val lines =
                json.decodeRequired<List<InlineV1InvoicesAddLinesPostRequestFormLinesItemX4410ce25>>(
                    rawObject,
                    "lines",
                )
            return InlineV1InvoicesAddLinesPostRequestFormX5fcd6d4a(
                ...
                invoiceMetadata =
                    rawObject["invoice_metadata"]?.let {
                        json.decodeFromJsonElement<InlineV1InvoicesAddLinesPostRequestFormInvoiceMetadataXf359f669>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesAddLinesPostRequestFormX5fcd6d4a,
        ) {
...
public fun inlineV1InvoicesAddLinesPostRequestFormX5fcd6d4a(
    block: InlineV1InvoicesAddLinesPostRequestFormX5fcd6d4a.Builder.() -> Unit,
): InlineV1InvoicesAddLinesPostRequestFormX5fcd6d4a = InlineV1InvoicesAddLinesPostRequestFormX5fcd6d4a.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1InvoicesAddLinesPostRequestFormX5fcd6d4a is missing required property '" + name + "'",
            )
