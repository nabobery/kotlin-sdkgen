...
public class PaymentMethodOptionsScalapay(
    ...
    public class Builder {
        ...
        public fun build(): PaymentMethodOptionsScalapay =
    ...
    public object Serializer : KSerializer<PaymentMethodOptionsScalapay> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodOptionsScalapay {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodOptionsScalapay must be a JSON object")
            return PaymentMethodOptionsScalapay(
                captureMethod =
                    rawObject["capture_method"]?.let {
                        json.decodeFromJsonElement<InlinePaymentMethodOptionsScalapayCaptureMethodXcde90371>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentMethodOptionsScalapay,
        ) {
...
public fun paymentMethodOptionsScalapay(
    block: PaymentMethodOptionsScalapay.Builder.() -> Unit,
): PaymentMethodOptionsScalapay = PaymentMethodOptionsScalapay.build(block)
