...
@Serializable
public data class PersonFutureRequirementsView(
...
public class PersonFutureRequirements(
    ...
    public object Serializer : KSerializer<PersonFutureRequirements> {
        ...
        override fun deserialize(decoder: Decoder): PersonFutureRequirements {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PersonFutureRequirements must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PersonFutureRequirements,
        ) {
...
public fun personFutureRequirements(block: PersonFutureRequirements.Builder.() -> Unit): PersonFutureRequirements =
    PersonFutureRequirements.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException("PersonFutureRequirements is missing required property '" + name + "'")
