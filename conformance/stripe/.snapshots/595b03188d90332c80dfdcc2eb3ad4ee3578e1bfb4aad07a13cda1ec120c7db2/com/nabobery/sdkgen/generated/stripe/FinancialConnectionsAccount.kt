...
public class FinancialConnectionsAccount(
     ...
     */
    public val accountNumbers: List<BankConnectionsResourceAccountNumberDetails>? = null,
    /**
     ...
     */
    public val permissions: List<InlineFinancialConnectionsAccountPermissionsItemXe49614b2>? = null,
    public val statusDetails: BankConnectionsResourceAccountStatusDetails? = null,
    /**
     * The list of data refresh subscriptions requested on this account.
     */
    public val subscriptions: List<InlineFinancialConnectionsAccountSubscriptionsItemX9bd93146>? = null,
    /**
     * The state of the most recent attempt to refresh the account transactions.
     */
    public val transactionRefresh: InlineFinancialConnectionsAccountTransactionRefreshX21e2ce83? = null,
) {
    /**
    ...
    public class Builder {
        ...
        public var supportedPaymentMethodTypes:
            List<InlineFinancialConnectionsAccountSupportedPaymentMethodTypesItemXd2320cf7>
            get() = requireNotNull(supportedPaymentMethodTypesValue) { "supportedPaymentMethodTypes is required" }
            set(`value`) {
                supportedPaymentMethodTypesValue = value
            }
         ...
         * Details about the account numbers.
         */
        public var accountNumbers: List<BankConnectionsResourceAccountNumberDetails>? = null
         ...
         * The list of permissions granted by this account.
         */
        public var permissions: List<InlineFinancialConnectionsAccountPermissionsItemXe49614b2>? = null
    ...
    public object Serializer : KSerializer<FinancialConnectionsAccount> {
        ...
        override fun deserialize(decoder: Decoder): FinancialConnectionsAccount {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("FinancialConnectionsAccount must be a JSON object")
            val category =
                json.decodeRequired<InlineFinancialConnectionsAccountCategoryX1214ba08>(
                    rawObject,
                    "category",
                )
            ...
            val objectValue =
                json.decodeRequired<InlineFinancialConnectionsAccountObjectValueXedf79fc2>(
                    rawObject,
                    "object",
                )
            val status = json.decodeRequired<InlineFinancialConnectionsAccountStatusXdb3bb633>(rawObject, "status")
            val subcategory =
                json.decodeRequired<InlineFinancialConnectionsAccountSubcategoryX5a1e63f2>(
                    rawObject,
                    "subcategory",
                )
            val supportedPaymentMethodTypes =
                json
                    .decodeRequired<List<InlineFinancialConnectionsAccountSupportedPaymentMethodTypesItemXd2320cf7>>(
                        rawObject,
            ...
            return FinancialConnectionsAccount(
                ...
                supportedPaymentMethodTypes = supportedPaymentMethodTypes,
                accountHolder =
                    rawObject["account_holder"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineFinancialConnectionsAccountAccountHolderXc752c398?>(
                                element,
                            )
                        }
                    },
                accountNumbers =
                    rawObject["account_numbers"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<List<BankConnectionsResourceAccountNumberDetails>?>(element)
                        }
                    },
                balance =
                    rawObject["balance"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineFinancialConnectionsAccountBalanceX17a8ea78?>(element)
                        }
                    },
                balanceRefresh =
                    rawObject["balance_refresh"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineFinancialConnectionsAccountBalanceRefreshX1bb1e3e5?>(
                                element,
                            )
                        }
                    },
                ...
                ownership =
                    rawObject["ownership"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineFinancialConnectionsAccountOwnershipX0d638327?>(element)
                        }
                    },
                ownershipRefresh =
                    rawObject["ownership_refresh"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineFinancialConnectionsAccountOwnershipRefreshXa966e25a?>(
                                element,
                            )
                        }
                    },
                permissions =
                    rawObject["permissions"]?.let { element ->
                        if (element ==
                            ...
                            json
                                .decodeFromJsonElement<List<InlineFinancialConnectionsAccountPermissionsItemXe49614b2>?>(
                                    element,
                                )
                        }
                    },
                statusDetails =
                    rawObject["status_details"]?.let {
                        json.decodeFromJsonElement<BankConnectionsResourceAccountStatusDetails>(
                            it,
                        )
                    },
                subscriptions =
                    rawObject["subscriptions"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                            ...
                            json
                                .decodeFromJsonElement<List<InlineFinancialConnectionsAccountSubscriptionsItemX9bd93146>?>(
                                    element,
                                )
                        }
                    },
                transactionRefresh =
                    rawObject["transaction_refresh"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineFinancialConnectionsAccountTransactionRefreshX21e2ce83?>(
                                element,
                            )
                        }
                    },
...
public fun financialConnectionsAccount(
    block: FinancialConnectionsAccount.Builder.() -> Unit,
): FinancialConnectionsAccount = FinancialConnectionsAccount.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException("FinancialConnectionsAccount is missing required property '" + name + "'")
