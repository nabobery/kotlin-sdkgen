...
public class InsightsResourcesPaymentEvaluationClientDeviceMetadata(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InsightsResourcesPaymentEvaluationClientDeviceMetadata =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InsightsResourcesPaymentEvaluationClientDeviceMetadata> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InsightsResourcesPaymentEvaluationClientDeviceMetadata must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InsightsResourcesPaymentEvaluationClientDeviceMetadata,
        ) {
...
public fun insightsResourcesPaymentEvaluationClientDeviceMetadata(
    block: InsightsResourcesPaymentEvaluationClientDeviceMetadata.Builder.() -> Unit,
): InsightsResourcesPaymentEvaluationClientDeviceMetadata =
    InsightsResourcesPaymentEvaluationClientDeviceMetadata.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InsightsResourcesPaymentEvaluationClientDeviceMetadata is missing required property '" + name + "'",
            )
