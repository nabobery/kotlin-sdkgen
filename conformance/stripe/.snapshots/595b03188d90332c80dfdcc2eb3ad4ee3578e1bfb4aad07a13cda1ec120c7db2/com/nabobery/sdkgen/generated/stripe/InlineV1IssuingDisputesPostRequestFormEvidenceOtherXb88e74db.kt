...
internal data class InlineV1IssuingDisputesPostRequestFormEvidenceOtherXb88e74dbInspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesInlineV1IssuingDisputesPostRequestFormEvidenceOtherAnyOf1X311fb7bf,
                matchesInlineV1IssuingDisputesPostRequestFormEvidenceOtherAnyOf2X7f6d6046,
            ).count {
                it
            }
}
...
public class InlineV1IssuingDisputesPostRequestFormEvidenceOtherXb88e74db internal constructor(
    ...
    public val inlineV1IssuingDisputesPostRequestFormEvidenceOtherAnyOf1X311fb7bf:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1IssuingDisputesPostRequestFormEvidenceOtherAnyOf1X311fb7bf) {
                json
                    .decodeFromJsonElement<InlineV1IssuingDisputesPostRequestFormEvidenceOtherAnyOf1X311fb7bf>(
                        raw,
                    )
            } else {
                null
    ...
    public val inlineV1IssuingDisputesPostRequestFormEvidenceOtherAnyOf2X7f6d6046:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1IssuingDisputesPostRequestFormEvidenceOtherAnyOf2X7f6d6046) {
                json
                    .decodeFromJsonElement<InlineV1IssuingDisputesPostRequestFormEvidenceOtherAnyOf2X7f6d6046>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches:
        ...
        get() =
            buildSet {
                if (inspection.matchesInlineV1IssuingDisputesPostRequestFormEvidenceOtherAnyOf1X311fb7bf) {
                    add(
                        InlineV1IssuingDisputesPostRequestFormEvidenceOtherXb88e74dbBranch.InlineV1IssuingDisputesPostRequestFormEvidenceOtherAnyOf1X311fb7bf,
                    )
                }
                if (inspection.matchesInlineV1IssuingDisputesPostRequestFormEvidenceOtherAnyOf2X7f6d6046) {
                    add(
                        InlineV1IssuingDisputesPostRequestFormEvidenceOtherXb88e74dbBranch.InlineV1IssuingDisputesPostRequestFormEvidenceOtherAnyOf2X7f6d6046,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1IssuingDisputesPostRequestFormEvidenceOtherXb88e74db {
            val inspection = inspectInlineV1IssuingDisputesPostRequestFormEvidenceOtherXb88e74db(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1IssuingDisputesPostRequestFormEvidenceOtherXb88e74dbNoMatchException(
                    "InlineV1IssuingDisputesPostRequestFormEvidenceOtherXb88e74db matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1IssuingDisputesPostRequestFormEvidenceOtherXb88e74db> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingDisputesPostRequestFormEvidenceOtherXb88e74db,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1IssuingDisputesPostRequestFormEvidenceOtherXb88e74db",
...
private fun inspectInlineV1IssuingDisputesPostRequestFormEvidenceOtherXb88e74db(
    element: JsonElement,
): InlineV1IssuingDisputesPostRequestFormEvidenceOtherXb88e74dbInspection {
    val matchesInlineV1IssuingDisputesPostRequestFormEvidenceOtherAnyOf1X311fb7bf =
        element
            .isJsonDecodable<InlineV1IssuingDisputesPostRequestFormEvidenceOtherAnyOf1X311fb7bf>()
    val matchesInlineV1IssuingDisputesPostRequestFormEvidenceOtherAnyOf2X7f6d6046 =
        element
            .isJsonDecodable<InlineV1IssuingDisputesPostRequestFormEvidenceOtherAnyOf2X7f6d6046>()
    return InlineV1IssuingDisputesPostRequestFormEvidenceOtherXb88e74dbInspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1IssuingDisputesPostRequestFormEvidenceOtherAnyOf1X311fb7bf) {
                    add(
                        "InlineV1IssuingDisputesPostRequestFormEvidenceOtherAnyOf1X311fb7bf: value does not match InlineV1IssuingDisputesPostRequestFormEvidenceOtherAnyOf1X311fb7bf",
                    )
                }
                if (!matchesInlineV1IssuingDisputesPostRequestFormEvidenceOtherAnyOf2X7f6d6046) {
                    add(
                        "InlineV1IssuingDisputesPostRequestFormEvidenceOtherAnyOf2X7f6d6046: value does not match InlineV1IssuingDisputesPostRequestFormEvidenceOtherAnyOf2X7f6d6046",
                    )
                }
            },
    )
