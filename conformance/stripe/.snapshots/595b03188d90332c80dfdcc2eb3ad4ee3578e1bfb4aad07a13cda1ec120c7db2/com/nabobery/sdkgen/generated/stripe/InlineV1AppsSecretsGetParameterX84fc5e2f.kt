...
public class InlineV1AppsSecretsGetParameterX84fc5e2f(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1AppsSecretsGetParameterX84fc5e2f =
    ...
    public object Serializer : KSerializer<InlineV1AppsSecretsGetParameterX84fc5e2f> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1AppsSecretsGetParameterX84fc5e2f {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("InlineV1AppsSecretsGetParameterX84fc5e2f must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AppsSecretsGetParameterX84fc5e2f,
        ) {
...
public fun inlineV1AppsSecretsGetParameterX84fc5e2f(
    block: InlineV1AppsSecretsGetParameterX84fc5e2f.Builder.() -> Unit,
): InlineV1AppsSecretsGetParameterX84fc5e2f = InlineV1AppsSecretsGetParameterX84fc5e2f.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1AppsSecretsGetParameterX84fc5e2f is missing required property '" + name + "'",
            )
