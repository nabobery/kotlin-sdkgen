...
public class PaymentMethodEps(
    ...
    public class Builder {
        ...
        public fun build(): PaymentMethodEps =
            PaymentMethodEps(
                bank = bank,
            )
    }
    ...
    public object Serializer : KSerializer<PaymentMethodEps> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodEps {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodEps must be a JSON object")
                ...
                bank =
                    rawObject["bank"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentMethodEpsBankX43bfcb33?>(element)
                        }
                    },
            )
        }
...
public fun paymentMethodEps(block: PaymentMethodEps.Builder.() -> Unit): PaymentMethodEps =
    PaymentMethodEps.build(block)
