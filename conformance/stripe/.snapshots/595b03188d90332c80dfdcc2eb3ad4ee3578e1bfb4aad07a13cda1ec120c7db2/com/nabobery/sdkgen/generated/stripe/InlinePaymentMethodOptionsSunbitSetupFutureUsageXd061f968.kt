...
public sealed class InlinePaymentMethodOptionsSunbitSetupFutureUsageXd061f968 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentMethodOptionsSunbitSetupFutureUsageXd061f968 =
            when (value) {
                None.value -> None
    ...
    public object Serializer : KSerializer<InlinePaymentMethodOptionsSunbitSetupFutureUsageXd061f968> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentMethodOptionsSunbitSetupFutureUsageXd061f968",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePaymentMethodOptionsSunbitSetupFutureUsageXd061f968 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentMethodOptionsSunbitSetupFutureUsageXd061f968,
        ) {
