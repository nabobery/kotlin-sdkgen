    ...
    public object Serializer : KSerializer<InlineV1InvoicesPostRequestFormPaymentSettingsVerificationMethodX82a41510> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1InvoicesPostRequestFormPaymentSettingsVerificationMethodX82a41510",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1InvoicesPostRequestFormPaymentSettingsVerificationMethodX82a41510 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesPostRequestFormPaymentSettingsVerificationMethodX82a41510,
        ) {
