...
public class InlineV1AccountsPostRequestFormIndividualX0a2dcd83(
    ...
    public val fullNameAliases: InlineV1AccountsPostRequestFormIndividualFullNameAliasesX7c7c6e69? = null,
    ...
    public val politicalExposure: InlineV1AccountsPostRequestFormIndividualPoliticalExposureX1cdcc72c? = null,
    public val registeredAddress: InlineV1AccountsPostRequestFormIndividualRegisteredAddressXc0de757d? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1AccountsPostRequestFormIndividualX0a2dcd83 =
            InlineV1AccountsPostRequestFormIndividualX0a2dcd83(
                address = address,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1AccountsPostRequestFormIndividualX0a2dcd83 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1AccountsPostRequestFormIndividualX0a2dcd83> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountsPostRequestFormIndividualX0a2dcd83 must be a JSON object",
                    )
            return InlineV1AccountsPostRequestFormIndividualX0a2dcd83(
                address =
                    rawObject["address"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPostRequestFormIndividualAddressXcc6c082f>(it)
                    },
                addressKana =
                    rawObject["address_kana"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPostRequestFormIndividualAddressKanaX2bdbb77a>(it)
                    },
                addressKanji =
                    rawObject["address_kanji"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPostRequestFormIndividualAddressKanjiXe788baae>(it)
                    },
                dob =
                    rawObject["dob"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPostRequestFormIndividualDobXf914b8b9>(
                            it,
                        )
                    },
                ...
                fullNameAliases =
                    rawObject["full_name_aliases"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPostRequestFormIndividualFullNameAliasesX7c7c6e69>(
                            it,
                        )
                    },
                ...
                metadata =
                    rawObject["metadata"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPostRequestFormIndividualMetadataX21c1a961>(it)
                    },
                phone = rawObject["phone"]?.let { json.decodeFromJsonElement<String>(it) },
                politicalExposure =
                    rawObject["political_exposure"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPostRequestFormIndividualPoliticalExposureX1cdcc72c>(
                            it,
                        )
                    },
                registeredAddress =
                    rawObject["registered_address"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPostRequestFormIndividualRegisteredAddressXc0de757d>(
                            it,
                        )
                    },
                relationship =
                    rawObject["relationship"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPostRequestFormIndividualRelationshipX7feb9466>(it)
                    },
                ssnLast4 = rawObject["ssn_last_4"]?.let { json.decodeFromJsonElement<String>(it) },
                verification =
                    rawObject["verification"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPostRequestFormIndividualVerificationX19ee9ea5>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPostRequestFormIndividualX0a2dcd83,
        ) {
...
public fun inlineV1AccountsPostRequestFormIndividualX0a2dcd83(
    block: InlineV1AccountsPostRequestFormIndividualX0a2dcd83.Builder.() -> Unit,
): InlineV1AccountsPostRequestFormIndividualX0a2dcd83 = InlineV1AccountsPostRequestFormIndividualX0a2dcd83.build(block)
