...
public sealed class InlineV1TreasuryReceivedDebitsGetParameterXb04fe36d {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1TreasuryReceivedDebitsGetParameterXb04fe36d =
            when (value) {
                Failed.value -> Failed
    ...
    public object Serializer : KSerializer<InlineV1TreasuryReceivedDebitsGetParameterXb04fe36d> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1TreasuryReceivedDebitsGetParameterXb04fe36d",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1TreasuryReceivedDebitsGetParameterXb04fe36d =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TreasuryReceivedDebitsGetParameterXb04fe36d,
        ) {
