...
public class InlineV1ChargesRefundsPostRequestFormMetadataX2be9a45c internal constructor(
    ...
    public val inlineV1ChargesRefundsPostRequestFormMetadataAnyOf2Xb720c67f:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1ChargesRefundsPostRequestFormMetadataAnyOf2Xb720c67f) {
                json
                    .decodeFromJsonElement<InlineV1ChargesRefundsPostRequestFormMetadataAnyOf2Xb720c67f>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1ChargesRefundsPostRequestFormMetadataX2be9a45cBranch>
        get() =
            buildSet {
                ...
                if (inspection.matchesInlineV1ChargesRefundsPostRequestFormMetadataAnyOf2Xb720c67f) {
                    add(
                        InlineV1ChargesRefundsPostRequestFormMetadataX2be9a45cBranch.InlineV1ChargesRefundsPostRequestFormMetadataAnyOf2Xb720c67f,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1ChargesRefundsPostRequestFormMetadataX2be9a45c {
            val inspection = inspectInlineV1ChargesRefundsPostRequestFormMetadataX2be9a45c(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1ChargesRefundsPostRequestFormMetadataX2be9a45cNoMatchException(
                    "InlineV1ChargesRefundsPostRequestFormMetadataX2be9a45c matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1ChargesRefundsPostRequestFormMetadataX2be9a45c> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ChargesRefundsPostRequestFormMetadataX2be9a45c,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1ChargesRefundsPostRequestFormMetadataX2be9a45c",
...
private fun inspectInlineV1ChargesRefundsPostRequestFormMetadataX2be9a45c(
    element: JsonElement,
): InlineV1ChargesRefundsPostRequestFormMetadataX2be9a45cInspection {
    val matchesBranch1 = element.isJsonDecodable<JsonObject>()
    val matchesInlineV1ChargesRefundsPostRequestFormMetadataAnyOf2Xb720c67f =
        element
            .isJsonDecodable<InlineV1ChargesRefundsPostRequestFormMetadataAnyOf2Xb720c67f>()
    return InlineV1ChargesRefundsPostRequestFormMetadataX2be9a45cInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1ChargesRefundsPostRequestFormMetadataAnyOf2Xb720c67f) {
                    add(
                        "InlineV1ChargesRefundsPostRequestFormMetadataAnyOf2Xb720c67f: value does not match InlineV1ChargesRefundsPostRequestFormMetadataAnyOf2Xb720c67f",
                    )
                }
            },
    )
