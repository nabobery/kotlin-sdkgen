...
public class DeletedRadarValueList(
    ...
    public object Serializer : KSerializer<DeletedRadarValueList> {
        ...
        override fun deserialize(decoder: Decoder): DeletedRadarValueList {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("DeletedRadarValueList must be a JSON object")
...
public fun deletedRadarValueList(block: DeletedRadarValueList.Builder.() -> Unit): DeletedRadarValueList =
    DeletedRadarValueList.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("DeletedRadarValueList is missing required property '" + name + "'")
