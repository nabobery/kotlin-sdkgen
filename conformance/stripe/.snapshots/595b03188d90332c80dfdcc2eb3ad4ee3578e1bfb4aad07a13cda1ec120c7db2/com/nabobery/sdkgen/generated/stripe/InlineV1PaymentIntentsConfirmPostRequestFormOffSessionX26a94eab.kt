...
internal data class InlineV1PaymentIntentsConfirmPostRequestFormOffSessionX26a94eabInspection(
    ...
    public val matchCount: Int
        get() =
            listOf(matchesBranch1, matchesInlineV1PaymentIntentsConfirmPostRequestFormOffSessionAnyOf2X477c0ad2).count {
                it
            }
}
...
public class InlineV1PaymentIntentsConfirmPostRequestFormOffSessionX26a94eab internal constructor(
    ...
    public val inlineV1PaymentIntentsConfirmPostRequestFormOffSessionAnyOf2X477c0ad2:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1PaymentIntentsConfirmPostRequestFormOffSessionAnyOf2X477c0ad2) {
                json
                    .decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormOffSessionAnyOf2X477c0ad2>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1PaymentIntentsConfirmPostRequestFormOffSessionX26a94eabBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1PaymentIntentsConfirmPostRequestFormOffSessionAnyOf2X477c0ad2) {
                    add(
                        InlineV1PaymentIntentsConfirmPostRequestFormOffSessionX26a94eabBranch.InlineV1PaymentIntentsConfirmPostRequestFormOffSessionAnyOf2X477c0ad2,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1PaymentIntentsConfirmPostRequestFormOffSessionX26a94eab {
            val inspection = inspectInlineV1PaymentIntentsConfirmPostRequestFormOffSessionX26a94eab(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1PaymentIntentsConfirmPostRequestFormOffSessionX26a94eabNoMatchException(
                    "InlineV1PaymentIntentsConfirmPostRequestFormOffSessionX26a94eab matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsConfirmPostRequestFormOffSessionX26a94eab> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsConfirmPostRequestFormOffSessionX26a94eab,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1PaymentIntentsConfirmPostRequestFormOffSessionX26a94eab",
...
private fun inspectInlineV1PaymentIntentsConfirmPostRequestFormOffSessionX26a94eab(
    element: JsonElement,
): InlineV1PaymentIntentsConfirmPostRequestFormOffSessionX26a94eabInspection {
    val matchesBranch1 = element.isJsonDecodable<Boolean>()
    val matchesInlineV1PaymentIntentsConfirmPostRequestFormOffSessionAnyOf2X477c0ad2 =
        element
            .isJsonDecodable<InlineV1PaymentIntentsConfirmPostRequestFormOffSessionAnyOf2X477c0ad2>()
    return InlineV1PaymentIntentsConfirmPostRequestFormOffSessionX26a94eabInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1PaymentIntentsConfirmPostRequestFormOffSessionAnyOf2X477c0ad2) {
                    add(
                        "InlineV1PaymentIntentsConfirmPostRequestFormOffSessionAnyOf2X477c0ad2: value does not match InlineV1PaymentIntentsConfirmPostRequestFormOffSessionAnyOf2X477c0ad2",
                    )
                }
            },
    )
