...
public sealed class InlineV1CustomersFundingIn90ecPostRequestFormBankTransferItemX9e42681a {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1CustomersFundingIn90ecPostRequestFormBankTransferItemX9e42681a =
            when (value) {
                Iban.value -> Iban
    ...
    public object Serializer : KSerializer<InlineV1CustomersFundingIn90ecPostRequestFormBankTransferItemX9e42681a> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1CustomersFundingIn90ecPostRequestFormBankTransferItemX9e42681a",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1CustomersFundingIn90ecPostRequestFormBankTransferItemX9e42681a = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersFundingIn90ecPostRequestFormBankTransferItemX9e42681a,
        ) {
