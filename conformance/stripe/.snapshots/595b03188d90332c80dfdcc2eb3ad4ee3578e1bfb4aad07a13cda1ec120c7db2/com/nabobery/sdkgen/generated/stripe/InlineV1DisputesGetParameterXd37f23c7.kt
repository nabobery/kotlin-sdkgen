...
public class InlineV1DisputesGetParameterXd37f23c7 internal constructor(
    ...
    public val inlineV1DisputesGetParameterAnyOf1X6a56077b:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1DisputesGetParameterAnyOf1X6a56077b) {
                json
                    .decodeFromJsonElement<InlineV1DisputesGetParameterAnyOf1X6a56077b>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1DisputesGetParameterXd37f23c7Branch>
        get() =
            buildSet {
                if (inspection.matchesInlineV1DisputesGetParameterAnyOf1X6a56077b) {
                    add(
                        InlineV1DisputesGetParameterXd37f23c7Branch.InlineV1DisputesGetParameterAnyOf1X6a56077b,
                    )
                }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1DisputesGetParameterXd37f23c7 {
            val inspection = inspectInlineV1DisputesGetParameterXd37f23c7(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1DisputesGetParameterXd37f23c7NoMatchException(
                    "InlineV1DisputesGetParameterXd37f23c7 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1DisputesGetParameterXd37f23c7> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1DisputesGetParameterXd37f23c7,
        ) {
...
private fun inspectInlineV1DisputesGetParameterXd37f23c7(
    element: JsonElement,
): InlineV1DisputesGetParameterXd37f23c7Inspection {
    val matchesInlineV1DisputesGetParameterAnyOf1X6a56077b =
        element
            .isJsonDecodable<InlineV1DisputesGetParameterAnyOf1X6a56077b>()
    ...
    return InlineV1DisputesGetParameterXd37f23c7Inspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1DisputesGetParameterAnyOf1X6a56077b) {
                    add(
                        "InlineV1DisputesGetParameterAnyOf1X6a56077b: value does not match InlineV1DisputesGetParameterAnyOf1X6a56077b",
                    )
                }
