...
public class InvoiceInstallmentsCard(
    ...
    public class Builder {
        ...
        public fun build(): InvoiceInstallmentsCard =
        ...
        override fun deserialize(decoder: Decoder): InvoiceInstallmentsCard {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("InvoiceInstallmentsCard must be a JSON object")
...
public fun invoiceInstallmentsCard(block: InvoiceInstallmentsCard.Builder.() -> Unit): InvoiceInstallmentsCard =
    InvoiceInstallmentsCard.build(block)
