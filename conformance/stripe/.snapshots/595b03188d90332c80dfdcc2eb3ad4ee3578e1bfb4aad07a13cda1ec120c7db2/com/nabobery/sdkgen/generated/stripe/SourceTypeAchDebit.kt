...
public class SourceTypeAchDebit(
    ...
    public class Builder {
        ...
        public fun build(): SourceTypeAchDebit =
            SourceTypeAchDebit(
                bankName = bankName,
                country = country,
        ...
        override fun deserialize(decoder: Decoder): SourceTypeAchDebit {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("SourceTypeAchDebit must be a JSON object")
...
public fun sourceTypeAchDebit(block: SourceTypeAchDebit.Builder.() -> Unit): SourceTypeAchDebit =
    SourceTypeAchDebit.build(block)
