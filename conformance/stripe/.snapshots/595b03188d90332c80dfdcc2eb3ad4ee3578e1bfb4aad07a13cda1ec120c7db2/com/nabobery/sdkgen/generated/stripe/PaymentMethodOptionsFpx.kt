...
public class PaymentMethodOptionsFpx(
    ...
    public class Builder {
        ...
        public fun build(): PaymentMethodOptionsFpx =
    ...
    public object Serializer : KSerializer<PaymentMethodOptionsFpx> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodOptionsFpx {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodOptionsFpx must be a JSON object")
            return PaymentMethodOptionsFpx(
                setupFutureUsage =
                    rawObject["setup_future_usage"]?.let {
                        json.decodeFromJsonElement<InlinePaymentMethodOptionsFpxSetupFutureUsageXa3a41b53>(it)
                    },
            )
        }
...
public fun paymentMethodOptionsFpx(block: PaymentMethodOptionsFpx.Builder.() -> Unit): PaymentMethodOptionsFpx =
    PaymentMethodOptionsFpx.build(block)
