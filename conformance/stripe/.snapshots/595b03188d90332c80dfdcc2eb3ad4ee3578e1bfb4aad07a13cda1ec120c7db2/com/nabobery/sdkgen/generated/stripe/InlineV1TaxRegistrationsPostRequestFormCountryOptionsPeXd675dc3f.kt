...
public class InlineV1TaxRegistrationsPostRequestFormCountryOptionsPeXd675dc3f(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TaxRegistrationsPostRequestFormCountryOptionsPeXd675dc3f =
    ...
    public object Serializer : KSerializer<InlineV1TaxRegistrationsPostRequestFormCountryOptionsPeXd675dc3f> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TaxRegistrationsPostRequestFormCountryOptionsPeXd675dc3f must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineV1TaxRegistrationsPostRequestFormCountryOptionsPeTypeX46f4fd63>(
                    rawObject,
                    "type",
                )
            return InlineV1TaxRegistrationsPostRequestFormCountryOptionsPeXd675dc3f(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TaxRegistrationsPostRequestFormCountryOptionsPeXd675dc3f,
        ) {
            val jsonEncoder =
...
public fun inlineV1TaxRegistrationsPostRequestFormCountryOptionsPeXd675dc3f(
    block: InlineV1TaxRegistrationsPostRequestFormCountryOptionsPeXd675dc3f.Builder.() -> Unit,
): InlineV1TaxRegistrationsPostRequestFormCountryOptionsPeXd675dc3f =
    InlineV1TaxRegistrationsPostRequestFormCountryOptionsPeXd675dc3f.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TaxRegistrationsPostRequestFormCountryOptionsPeXd675dc3f is missing required property '" + name +
                    "'",
            )
