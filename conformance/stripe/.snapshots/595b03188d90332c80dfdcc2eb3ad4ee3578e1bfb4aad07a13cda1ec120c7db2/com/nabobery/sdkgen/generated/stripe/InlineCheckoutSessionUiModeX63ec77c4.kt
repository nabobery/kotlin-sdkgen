...
public sealed class InlineCheckoutSessionUiModeX63ec77c4 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineCheckoutSessionUiModeX63ec77c4 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineCheckoutSessionUiModeX63ec77c4> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineCheckoutSessionUiModeX63ec77c4",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineCheckoutSessionUiModeX63ec77c4 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineCheckoutSessionUiModeX63ec77c4,
        ) {
