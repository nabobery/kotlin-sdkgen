...
public sealed class InlineGelatoSelfieReportStatusX07703f81 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineGelatoSelfieReportStatusX07703f81 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineGelatoSelfieReportStatusX07703f81> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineGelatoSelfieReportStatusX07703f81",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineGelatoSelfieReportStatusX07703f81 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineGelatoSelfieReportStatusX07703f81,
        ) {
