...
public class PaymentLinksResourceTransferData(
    ...
    public object Serializer : KSerializer<PaymentLinksResourceTransferData> {
        ...
        override fun deserialize(decoder: Decoder): PaymentLinksResourceTransferData {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentLinksResourceTransferData must be a JSON object")
            val destination =
                json.decodeRequired<InlinePaymentLinksResourceTransferDataDestinationXc35ed13b>(
                    rawObject,
                    "destination",
                )
            return PaymentLinksResourceTransferData(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentLinksResourceTransferData,
        ) {
...
public fun paymentLinksResourceTransferData(
    block: PaymentLinksResourceTransferData.Builder.() -> Unit,
): PaymentLinksResourceTransferData = PaymentLinksResourceTransferData.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "PaymentLinksResourceTransferData is missing required property '" + name + "'",
            )
