...
public class TreasuryOutboundTransfer(
    ...
    public class Builder {
        ...
        public var destinationPaymentMethodDetails: OutboundTransfersPaymentMethodDetails
            get() =
                requireNotNull(
                    destinationPaymentMethodDetailsValue,
                ) { "destinationPaymentMethodDetails is required" }
            set(`value`) {
    ...
    public object Serializer : KSerializer<TreasuryOutboundTransfer> {
        ...
        override fun deserialize(decoder: Decoder): TreasuryOutboundTransfer {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("TreasuryOutboundTransfer must be a JSON object")
            val amount = json.decodeRequired<Int>(rawObject, "amount")
            val cancelable = json.decodeRequired<Boolean>(rawObject, "cancelable")
            val created = json.decodeRequired<Int>(rawObject, "created")
            val currency = json.decodeRequired<String>(rawObject, "currency")
            val destinationPaymentMethodDetails =
                json.decodeRequired<OutboundTransfersPaymentMethodDetails>(
                    rawObject,
            ...
            val objectValue =
                json.decodeRequired<InlineTreasuryOutboundTransferObjectValueXc6c9301e>(
                    rawObject,
                    "object",
                )
            ...
            val statusTransitions =
                json.decodeRequired<TreasuryOutboundTransfersResourceStatusTransitions>(
                    rawObject,
                    "status_transitions",
                )
            val transaction =
                json.decodeRequired<InlineTreasuryOutboundTransferTransactionXb03a16d6>(
                    rawObject,
                    "transaction",
                )
            return TreasuryOutboundTransfer(
                ...
                returnedDetails =
                    rawObject["returned_details"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineTreasuryOutboundTransferReturnedDetailsXab1a286e?>(element)
                        }
                    },
                trackingDetails =
                    rawObject["tracking_details"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineTreasuryOutboundTransferTrackingDetailsXb2077f7c?>(element)
                        }
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: TreasuryOutboundTransfer,
        ) {
            ...
            val raw =
                buildJsonObject {
                    ...
                    put(
                        "destination_payment_method_details",
                        json.encodeToJsonElement(value.destinationPaymentMethodDetails),
                    )
...
public fun treasuryOutboundTransfer(block: TreasuryOutboundTransfer.Builder.() -> Unit): TreasuryOutboundTransfer =
    TreasuryOutboundTransfer.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException("TreasuryOutboundTransfer is missing required property '" + name + "'")
