...
public class InlineV1TaxRegistrationsPostRequestFormCountryOptionsEeXa80f8e8c(
    ...
    public val standard: InlineV1TaxRegistrationsPostRequestFormCountryOptionsEeStandardX29797471? = null,
) {
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TaxRegistrationsPostRequestFormCountryOptionsEeXa80f8e8c =
    ...
    public object Serializer : KSerializer<InlineV1TaxRegistrationsPostRequestFormCountryOptionsEeXa80f8e8c> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TaxRegistrationsPostRequestFormCountryOptionsEeXa80f8e8c must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineV1TaxRegistrationsPostRequestFormCountryOptionsEeTypeX21a36213>(
                    rawObject,
                    "type",
                )
            return InlineV1TaxRegistrationsPostRequestFormCountryOptionsEeXa80f8e8c(
                ...
                standard =
                    rawObject["standard"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsEeStandardX29797471>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TaxRegistrationsPostRequestFormCountryOptionsEeXa80f8e8c,
        ) {
            val jsonEncoder =
...
public fun inlineV1TaxRegistrationsPostRequestFormCountryOptionsEeXa80f8e8c(
    block: InlineV1TaxRegistrationsPostRequestFormCountryOptionsEeXa80f8e8c.Builder.() -> Unit,
): InlineV1TaxRegistrationsPostRequestFormCountryOptionsEeXa80f8e8c =
    InlineV1TaxRegistrationsPostRequestFormCountryOptionsEeXa80f8e8c.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TaxRegistrationsPostRequestFormCountryOptionsEeXa80f8e8c is missing required property '" + name +
                    "'",
            )
