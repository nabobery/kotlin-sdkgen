...
public class InlineV1EventsGetParameterX0238b28f internal constructor(
    ...
    public val inlineV1EventsGetParameterAnyOf1X806f5237: InlineV1EventsGetParameterAnyOf1X806f5237?
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1EventsGetParameterAnyOf1X806f5237) {
                json
                    .decodeFromJsonElement<InlineV1EventsGetParameterAnyOf1X806f5237>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1EventsGetParameterX0238b28fBranch>
        get() =
            buildSet {
                if (inspection.matchesInlineV1EventsGetParameterAnyOf1X806f5237) {
                    add(
                        InlineV1EventsGetParameterX0238b28fBranch.InlineV1EventsGetParameterAnyOf1X806f5237,
                    )
                }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1EventsGetParameterX0238b28f {
            val inspection = inspectInlineV1EventsGetParameterX0238b28f(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1EventsGetParameterX0238b28fNoMatchException(
                    "InlineV1EventsGetParameterX0238b28f matched 0 branches: " + inspection.failures.joinToString("; "),
                )
            }
    ...
    public object Serializer : KSerializer<InlineV1EventsGetParameterX0238b28f> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1EventsGetParameterX0238b28f,
        ) {
...
private fun inspectInlineV1EventsGetParameterX0238b28f(
    element: JsonElement,
): InlineV1EventsGetParameterX0238b28fInspection {
    val matchesInlineV1EventsGetParameterAnyOf1X806f5237 =
        element
            .isJsonDecodable<InlineV1EventsGetParameterAnyOf1X806f5237>()
    ...
    return InlineV1EventsGetParameterX0238b28fInspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1EventsGetParameterAnyOf1X806f5237) {
                    add(
                        "InlineV1EventsGetParameterAnyOf1X806f5237: value does not match InlineV1EventsGetParameterAnyOf1X806f5237",
                    )
                }
