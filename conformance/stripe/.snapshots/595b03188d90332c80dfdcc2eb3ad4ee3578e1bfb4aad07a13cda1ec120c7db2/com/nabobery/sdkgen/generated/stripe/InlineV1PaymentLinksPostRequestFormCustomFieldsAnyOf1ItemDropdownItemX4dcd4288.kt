...
public class InlineV1PaymentLinksPostRequestFormCustomFieldsAnyOf1ItemDropdownItemX4dcd4288(
    ...
    public object Serializer : KSerializer<InlineV1PaymentLinksPostRequestFormCustomFieldsAnyOf1ItemDropdownItemX4dcd4288> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentLinksPostRequestFormCustomFieldsAnyOf1ItemDropdownItemX4dcd4288 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentLinksPostRequestFormCustomFieldsAnyOf1ItemDropdownItemX4dcd4288,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentLinksPostRequestFormCustomFieldsAnyOf1ItemDropdownItemX4dcd4288(
    block: InlineV1PaymentLinksPostRequestFormCustomFieldsAnyOf1ItemDropdownItemX4dcd4288.Builder.() -> Unit,
): InlineV1PaymentLinksPostRequestFormCustomFieldsAnyOf1ItemDropdownItemX4dcd4288 =
    InlineV1PaymentLinksPostRequestFormCustomFieldsAnyOf1ItemDropdownItemX4dcd4288.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentLinksPostRequestFormCustomFieldsAnyOf1ItemDropdownItemX4dcd4288 is missing required property '" +
                    name +
                    "'",
            )
