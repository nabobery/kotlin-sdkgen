...
public sealed class InlineBankConnectionsResourceOwnershipRefreshStatusXc05f47c8 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineBankConnectionsResourceOwnershipRefreshStatusXc05f47c8 =
            when (value) {
                Failed.value -> Failed
    ...
    public object Serializer : KSerializer<InlineBankConnectionsResourceOwnershipRefreshStatusXc05f47c8> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineBankConnectionsResourceOwnershipRefreshStatusXc05f47c8",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineBankConnectionsResourceOwnershipRefreshStatusXc05f47c8 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineBankConnectionsResourceOwnershipRefreshStatusXc05f47c8,
        ) {
