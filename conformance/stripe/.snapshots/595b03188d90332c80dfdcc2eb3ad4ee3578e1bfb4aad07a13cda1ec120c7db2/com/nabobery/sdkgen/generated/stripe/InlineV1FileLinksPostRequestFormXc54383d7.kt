...
public class InlineV1FileLinksPostRequestFormXc54383d7(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1FileLinksPostRequestFormXc54383d7 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1FileLinksPostRequestFormXc54383d7> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1FileLinksPostRequestFormXc54383d7 {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("InlineV1FileLinksPostRequestFormXc54383d7 must be a JSON object")
            ...
            return InlineV1FileLinksPostRequestFormXc54383d7(
                ...
                metadata =
                    rawObject["metadata"]?.let {
                        json.decodeFromJsonElement<InlineV1FileLinksPostRequestFormMetadataXaddcdec0>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1FileLinksPostRequestFormXc54383d7,
        ) {
...
public fun inlineV1FileLinksPostRequestFormXc54383d7(
    block: InlineV1FileLinksPostRequestFormXc54383d7.Builder.() -> Unit,
): InlineV1FileLinksPostRequestFormXc54383d7 = InlineV1FileLinksPostRequestFormXc54383d7.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1FileLinksPostRequestFormXc54383d7 is missing required property '" + name + "'",
            )
