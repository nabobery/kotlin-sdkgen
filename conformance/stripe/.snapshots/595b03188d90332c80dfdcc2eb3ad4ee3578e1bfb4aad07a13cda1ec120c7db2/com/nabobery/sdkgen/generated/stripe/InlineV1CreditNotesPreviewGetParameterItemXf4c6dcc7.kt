...
public class InlineV1CreditNotesPreviewGetParameterItemXf4c6dcc7(
    ...
    public val paymentRecordRefund: InlineV1CreditNotesPreviewGetParameterItemPaymentRecordRefundX37e8cc41? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1CreditNotesPreviewGetParameterItemXf4c6dcc7 =
            InlineV1CreditNotesPreviewGetParameterItemXf4c6dcc7(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1CreditNotesPreviewGetParameterItemXf4c6dcc7 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1CreditNotesPreviewGetParameterItemXf4c6dcc7> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CreditNotesPreviewGetParameterItemXf4c6dcc7 must be a JSON object",
                    )
            return InlineV1CreditNotesPreviewGetParameterItemXf4c6dcc7(
                ...
                paymentRecordRefund =
                    rawObject["payment_record_refund"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CreditNotesPreviewGetParameterItemPaymentRecordRefundX37e8cc41>(
                                it,
                            )
                    },
                ...
                type =
                    rawObject["type"]?.let {
                        json.decodeFromJsonElement<InlineV1CreditNotesPreviewGetParameterItemTypeX83dac0bb>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CreditNotesPreviewGetParameterItemXf4c6dcc7,
        ) {
...
public fun inlineV1CreditNotesPreviewGetParameterItemXf4c6dcc7(
    block: InlineV1CreditNotesPreviewGetParameterItemXf4c6dcc7.Builder.() -> Unit,
): InlineV1CreditNotesPreviewGetParameterItemXf4c6dcc7 =
    InlineV1CreditNotesPreviewGetParameterItemXf4c6dcc7.build(block)
