...
public class InlineIssuingPersonalizationDesignCardLogoX9055fd98 internal constructor(
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineIssuingPersonalizationDesignCardLogoX9055fd98 {
            val inspection = inspectInlineIssuingPersonalizationDesignCardLogoX9055fd98(raw)
            if (inspection.matchCount == 0) {
                throw InlineIssuingPersonalizationDesignCardLogoX9055fd98NoMatchException(
                    "InlineIssuingPersonalizationDesignCardLogoX9055fd98 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineIssuingPersonalizationDesignCardLogoX9055fd98> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineIssuingPersonalizationDesignCardLogoX9055fd98,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineIssuingPersonalizationDesignCardLogoX9055fd98",
...
private fun inspectInlineIssuingPersonalizationDesignCardLogoX9055fd98(
    element: JsonElement,
): InlineIssuingPersonalizationDesignCardLogoX9055fd98Inspection {
