...
public class InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsMandateOptionsX08584447(
    public val amount: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPaytoAmountX07d697f1? = null,
    public val amountType: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAmountTypeXcd42b5ec? = null,
    public val endDate: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPaytoEndDateX8e56a011? = null,
    public val paymentSchedule: InlineV1PaymentIntentsPostRequestFormPaymentScheduleX78d5eb0f? = null,
    public val paymentsPerPeriod: InlineV1PaymentIntentsPostRequestFormPaymentsPerPeriodX7ca58858? = null,
    public val purpose: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPaytoPurposeX17ded54f? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsMandateOptionsX08584447 =
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsMandateOptionsX08584447> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsMandateOptionsX08584447 must be a JSON object",
                    )
            return InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsMandateOptionsX08584447(
                amount =
                    rawObject["amount"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPaytoAmountX07d697f1>(
                                it,
                            )
                    },
                amountType =
                    rawObject["amount_type"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAmountTypeXcd42b5ec>(
                                it,
                            )
                    },
                endDate =
                    rawObject["end_date"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPaytoEndDateX8e56a011>(
                                it,
                            )
                    },
                paymentSchedule =
                    rawObject["payment_schedule"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentScheduleX78d5eb0f>(it)
                    },
                paymentsPerPeriod =
                    rawObject["payments_per_period"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentsPerPeriodX7ca58858>(it)
                    },
                purpose =
                    rawObject["purpose"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPaytoPurposeX17ded54f>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsMandateOptionsX08584447,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsMandateOptionsX08584447(
    block: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsMandateOptionsX08584447.Builder.() -> Unit,
): InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsMandateOptionsX08584447 =
    InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsMandateOptionsX08584447.build(block)
