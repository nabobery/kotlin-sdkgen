...
public sealed class InlineAppsSecretObjectValueX998e84c6 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineAppsSecretObjectValueX998e84c6 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineAppsSecretObjectValueX998e84c6> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineAppsSecretObjectValueX998e84c6",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineAppsSecretObjectValueX998e84c6 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineAppsSecretObjectValueX998e84c6,
        ) {
