...
internal data class InlineV1SubscriptionsPostRequestFormCancelAtXcedc0adaInspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1SubscriptionsPostRequestFormCancelAtAnyOf2X036e9478,
                matchesInlineV1SubscriptionsPostRequestFormCancelAtAnyOf3X5d3ea8a1,
            ).count {
                it
            }
}
...
public class InlineV1SubscriptionsPostRequestFormCancelAtXcedc0ada internal constructor(
    ...
    public val inlineV1SubscriptionsPostRequestFormCancelAtAnyOf2X036e9478:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1SubscriptionsPostRequestFormCancelAtAnyOf2X036e9478) {
                json
                    .decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormCancelAtAnyOf2X036e9478>(
                        raw,
                    )
            } else {
                null
    ...
    public val inlineV1SubscriptionsPostRequestFormCancelAtAnyOf3X5d3ea8a1:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1SubscriptionsPostRequestFormCancelAtAnyOf3X5d3ea8a1) {
                json
                    .decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormCancelAtAnyOf3X5d3ea8a1>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1SubscriptionsPostRequestFormCancelAtXcedc0adaBranch>
        get() =
            buildSet {
                ...
                if (inspection.matchesInlineV1SubscriptionsPostRequestFormCancelAtAnyOf2X036e9478) {
                    add(
                        InlineV1SubscriptionsPostRequestFormCancelAtXcedc0adaBranch.InlineV1SubscriptionsPostRequestFormCancelAtAnyOf2X036e9478,
                    )
                }
                if (inspection.matchesInlineV1SubscriptionsPostRequestFormCancelAtAnyOf3X5d3ea8a1) {
                    add(
                        InlineV1SubscriptionsPostRequestFormCancelAtXcedc0adaBranch.InlineV1SubscriptionsPostRequestFormCancelAtAnyOf3X5d3ea8a1,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1SubscriptionsPostRequestFormCancelAtXcedc0ada {
            val inspection = inspectInlineV1SubscriptionsPostRequestFormCancelAtXcedc0ada(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1SubscriptionsPostRequestFormCancelAtXcedc0adaNoMatchException(
                    "InlineV1SubscriptionsPostRequestFormCancelAtXcedc0ada matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionsPostRequestFormCancelAtXcedc0ada> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsPostRequestFormCancelAtXcedc0ada,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1SubscriptionsPostRequestFormCancelAtXcedc0ada",
...
private fun inspectInlineV1SubscriptionsPostRequestFormCancelAtXcedc0ada(
    element: JsonElement,
): InlineV1SubscriptionsPostRequestFormCancelAtXcedc0adaInspection {
    val matchesBranch1 = element.isJsonDecodable<Int>()
    val matchesInlineV1SubscriptionsPostRequestFormCancelAtAnyOf2X036e9478 =
        element
            .isJsonDecodable<InlineV1SubscriptionsPostRequestFormCancelAtAnyOf2X036e9478>()
    val matchesInlineV1SubscriptionsPostRequestFormCancelAtAnyOf3X5d3ea8a1 =
        element
            .isJsonDecodable<InlineV1SubscriptionsPostRequestFormCancelAtAnyOf3X5d3ea8a1>()
    return InlineV1SubscriptionsPostRequestFormCancelAtXcedc0adaInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1SubscriptionsPostRequestFormCancelAtAnyOf2X036e9478) {
                    add(
                        "InlineV1SubscriptionsPostRequestFormCancelAtAnyOf2X036e9478: value does not match InlineV1SubscriptionsPostRequestFormCancelAtAnyOf2X036e9478",
                    )
                }
                if (!matchesInlineV1SubscriptionsPostRequestFormCancelAtAnyOf3X5d3ea8a1) {
                    add(
                        "InlineV1SubscriptionsPostRequestFormCancelAtAnyOf3X5d3ea8a1: value does not match InlineV1SubscriptionsPostRequestFormCancelAtAnyOf3X5d3ea8a1",
                    )
                }
            },
    )
