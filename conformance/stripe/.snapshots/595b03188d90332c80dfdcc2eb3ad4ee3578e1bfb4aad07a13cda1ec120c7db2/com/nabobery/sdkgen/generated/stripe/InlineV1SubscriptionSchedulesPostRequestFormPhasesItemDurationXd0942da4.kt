...
public class InlineV1SubscriptionSchedulesPostRequestFormPhasesItemDurationXd0942da4(
    public val interval: InlineV1SubscriptionSchedulesPostRequestFormPhasesItemDurationIntervalXe0657203,
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1SubscriptionSchedulesPostRequestFormPhasesItemDurationXd0942da4 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemDurationXd0942da4> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SubscriptionSchedulesPostRequestFormPhasesItemDurationXd0942da4 must be a JSON object",
                    )
            val interval =
                json
                    .decodeRequired<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemDurationIntervalXe0657203>(
                        rawObject,
                        "interval",
                    )
            return InlineV1SubscriptionSchedulesPostRequestFormPhasesItemDurationXd0942da4(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionSchedulesPostRequestFormPhasesItemDurationXd0942da4,
        ) {
            val jsonEncoder =
...
public fun inlineV1SubscriptionSchedulesPostRequestFormPhasesItemDurationXd0942da4(
    block: InlineV1SubscriptionSchedulesPostRequestFormPhasesItemDurationXd0942da4.Builder.() -> Unit,
): InlineV1SubscriptionSchedulesPostRequestFormPhasesItemDurationXd0942da4 =
    InlineV1SubscriptionSchedulesPostRequestFormPhasesItemDurationXd0942da4.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1SubscriptionSchedulesPostRequestFormPhasesItemDurationXd0942da4 is missing required property '" +
                    name +
                    "'",
            )
