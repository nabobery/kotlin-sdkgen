...
public class IssuingAuthorizationPendingRequest(
    ...
    public object Serializer : KSerializer<IssuingAuthorizationPendingRequest> {
        ...
        override fun deserialize(decoder: Decoder): IssuingAuthorizationPendingRequest {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("IssuingAuthorizationPendingRequest must be a JSON object")
                ...
                amountDetails =
                    rawObject["amount_details"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineIssuingAuthorizationPendingRequestAmountDetailsX24b05e6e?>(
                                element,
                            )
                        }
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: IssuingAuthorizationPendingRequest,
        ) {
...
public fun issuingAuthorizationPendingRequest(
    block: IssuingAuthorizationPendingRequest.Builder.() -> Unit,
): IssuingAuthorizationPendingRequest = IssuingAuthorizationPendingRequest.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "IssuingAuthorizationPendingRequest is missing required property '" + name + "'",
            )
