...
public class InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesItemXf5e68c73(
    ...
    public val discounts: List<InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesItemX0463581b>? = null,
    public val metadata: Map<String, String>? = null,
    public val period: InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesPeriodXd4ac6b95? = null,
    public val price: String? = null,
    public val priceData: InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPriceDataX9ef5a5aa? = null,
    public val quantity: Int? = null,
    public val taxRates: InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsTaxRatesXe6eb7699? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesItemXf5e68c73 =
    ...
    public object Serializer : KSerializer<InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesItemXf5e68c73> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesItemXf5e68c73 must be a JSON object",
                    )
            return InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesItemXf5e68c73(
                ...
                discounts =
                    rawObject["discounts"]?.let {
                        json
                            .decodeFromJsonElement<List<InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesItemX0463581b>>(
                                it,
                            )
                    },
                ...
                period =
                    rawObject["period"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesPeriodXd4ac6b95>(
                                it,
                            )
                    },
                ...
                priceData =
                    rawObject["price_data"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPriceDataX9ef5a5aa>(
                                it,
                            )
                    },
                ...
                taxRates =
                    rawObject["tax_rates"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsTaxRatesXe6eb7699>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesItemXf5e68c73,
        ) {
            val jsonEncoder =
...
public fun inlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesItemXf5e68c73(
    block: InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesItemXf5e68c73.Builder.() -> Unit,
): InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesItemXf5e68c73 =
    InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesItemXf5e68c73.build(block)
