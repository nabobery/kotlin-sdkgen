...
public class InlineV1BillingPortalConfiab44PostRequestFormFeaturesItemX484b352f(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1BillingPortalConfiab44PostRequestFormFeaturesItemX484b352f = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1BillingPortalConfiab44PostRequestFormFeaturesItemX484b352f> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1BillingPortalConfiab44PostRequestFormFeaturesItemX484b352f must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineV1BillingPortalConfiab44PostRequestFormFeaturesTypeXb73aad6f>(
                    rawObject,
                    "type",
                )
            return InlineV1BillingPortalConfiab44PostRequestFormFeaturesItemX484b352f(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1BillingPortalConfiab44PostRequestFormFeaturesItemX484b352f,
        ) {
            val jsonEncoder =
...
public fun inlineV1BillingPortalConfiab44PostRequestFormFeaturesItemX484b352f(
    block: InlineV1BillingPortalConfiab44PostRequestFormFeaturesItemX484b352f.Builder.() -> Unit,
): InlineV1BillingPortalConfiab44PostRequestFormFeaturesItemX484b352f =
    InlineV1BillingPortalConfiab44PostRequestFormFeaturesItemX484b352f.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1BillingPortalConfiab44PostRequestFormFeaturesItemX484b352f is missing required property '" +
                    name +
                    "'",
            )
