...
public class InlineV1SubscriptionSchedulesGetParameterX38d17dac internal constructor(
    ...
    public val inlineV1SubscriptionSchedulesGetParameterAnyOf1Xc46da545:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1SubscriptionSchedulesGetParameterAnyOf1Xc46da545) {
                json
                    .decodeFromJsonElement<InlineV1SubscriptionSchedulesGetParameterAnyOf1Xc46da545>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1SubscriptionSchedulesGetParameterX38d17dacBranch>
        get() =
            buildSet {
                if (inspection.matchesInlineV1SubscriptionSchedulesGetParameterAnyOf1Xc46da545) {
                    add(
                        InlineV1SubscriptionSchedulesGetParameterX38d17dacBranch.InlineV1SubscriptionSchedulesGetParameterAnyOf1Xc46da545,
                    )
                }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1SubscriptionSchedulesGetParameterX38d17dac {
            val inspection = inspectInlineV1SubscriptionSchedulesGetParameterX38d17dac(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1SubscriptionSchedulesGetParameterX38d17dacNoMatchException(
                    "InlineV1SubscriptionSchedulesGetParameterX38d17dac matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionSchedulesGetParameterX38d17dac> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionSchedulesGetParameterX38d17dac,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1SubscriptionSchedulesGetParameterX38d17dac",
...
private fun inspectInlineV1SubscriptionSchedulesGetParameterX38d17dac(
    element: JsonElement,
): InlineV1SubscriptionSchedulesGetParameterX38d17dacInspection {
    val matchesInlineV1SubscriptionSchedulesGetParameterAnyOf1Xc46da545 =
        element
            .isJsonDecodable<InlineV1SubscriptionSchedulesGetParameterAnyOf1Xc46da545>()
    ...
    return InlineV1SubscriptionSchedulesGetParameterX38d17dacInspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1SubscriptionSchedulesGetParameterAnyOf1Xc46da545) {
                    add(
                        "InlineV1SubscriptionSchedulesGetParameterAnyOf1Xc46da545: value does not match InlineV1SubscriptionSchedulesGetParameterAnyOf1Xc46da545",
                    )
                }
