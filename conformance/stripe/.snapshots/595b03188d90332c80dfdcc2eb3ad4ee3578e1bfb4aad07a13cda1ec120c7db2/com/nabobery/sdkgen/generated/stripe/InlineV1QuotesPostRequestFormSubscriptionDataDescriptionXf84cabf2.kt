...
internal data class InlineV1QuotesPostRequestFormSubscriptionDataDescriptionXf84cabf2Inspection(
    ...
    public val matchesInlineV1QuotesPostRequestFormSubscriptionDataDescriptionAnyOf2X7829aecf: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1QuotesPostRequestFormSubscriptionDataDescriptionAnyOf2X7829aecf,
            ).count {
                it
            }
}
...
public class InlineV1QuotesPostRequestFormSubscriptionDataDescriptionXf84cabf2 internal constructor(
    ...
    private val inspection: InlineV1QuotesPostRequestFormSubscriptionDataDescriptionXf84cabf2Inspection,
) {
    ...
    public val inlineV1QuotesPostRequestFormSubscriptionDataDescriptionAnyOf2X7829aecf:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1QuotesPostRequestFormSubscriptionDataDescriptionAnyOf2X7829aecf) {
                json
                    .decodeFromJsonElement<InlineV1QuotesPostRequestFormSubscriptionDataDescriptionAnyOf2X7829aecf>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1QuotesPostRequestFormSubscriptionDataDescriptionXf84cabf2Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1QuotesPostRequestFormSubscriptionDataDescriptionAnyOf2X7829aecf) {
                    add(
                        InlineV1QuotesPostRequestFormSubscriptionDataDescriptionXf84cabf2Branch.InlineV1QuotesPostRequestFormSubscriptionDataDescriptionAnyOf2X7829aecf,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1QuotesPostRequestFormSubscriptionDataDescriptionXf84cabf2 {
            val inspection = inspectInlineV1QuotesPostRequestFormSubscriptionDataDescriptionXf84cabf2(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1QuotesPostRequestFormSubscriptionDataDescriptionXf84cabf2NoMatchException(
                    "InlineV1QuotesPostRequestFormSubscriptionDataDescriptionXf84cabf2 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1QuotesPostRequestFormSubscriptionDataDescriptionXf84cabf2> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1QuotesPostRequestFormSubscriptionDataDescriptionXf84cabf2,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1QuotesPostRequestFormSubscriptionDataDescriptionXf84cabf2",
...
private fun inspectInlineV1QuotesPostRequestFormSubscriptionDataDescriptionXf84cabf2(
    element: JsonElement,
): InlineV1QuotesPostRequestFormSubscriptionDataDescriptionXf84cabf2Inspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1QuotesPostRequestFormSubscriptionDataDescriptionAnyOf2X7829aecf =
        element
            .isJsonDecodable<InlineV1QuotesPostRequestFormSubscriptionDataDescriptionAnyOf2X7829aecf>()
    return InlineV1QuotesPostRequestFormSubscriptionDataDescriptionXf84cabf2Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1QuotesPostRequestFormSubscriptionDataDescriptionAnyOf2X7829aecf) {
                    add(
                        "InlineV1QuotesPostRequestFormSubscriptionDataDescriptionAnyOf2X7829aecf: value does not match InlineV1QuotesPostRequestFormSubscriptionDataDescriptionAnyOf2X7829aecf",
                    )
                }
            },
    )
