...
internal data class InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsStartDateX2d9726feInspection(
    ...
    public val matchesInlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsPaytoAnyOf2X9ed7e17a: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsPaytoAnyOf2X9ed7e17a,
            ).count {
                it
            }
}
...
public class InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsStartDateX2d9726fe internal constructor(
    ...
    private val inspection: InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsStartDateX2d9726feInspection,
) {
    ...
    public val inlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsPaytoAnyOf2X9ed7e17a:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsPaytoAnyOf2X9ed7e17a) {
                json
                    .decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsPaytoAnyOf2X9ed7e17a>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsStartDateX2d9726feBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsPaytoAnyOf2X9ed7e17a) {
                    add(
                        InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsStartDateX2d9726feBranch.InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsPaytoAnyOf2X9ed7e17a,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsStartDateX2d9726fe {
            val inspection = inspectInlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsStartDateX2d9726fe(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsStartDateX2d9726feNoMatchException(
                    "InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsStartDateX2d9726fe matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsStartDateX2d9726fe> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsStartDateX2d9726fe,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsStartDateX2d9726fe",
...
private fun inspectInlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsStartDateX2d9726fe(
    element: JsonElement,
): InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsStartDateX2d9726feInspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsPaytoAnyOf2X9ed7e17a =
        element
            .isJsonDecodable<InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsPaytoAnyOf2X9ed7e17a>()
    return InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsStartDateX2d9726feInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsPaytoAnyOf2X9ed7e17a) {
                    add(
                        "InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsPaytoAnyOf2X9ed7e17a: value does not match InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsPaytoAnyOf2X9ed7e17a",
                    )
                }
            },
    )
