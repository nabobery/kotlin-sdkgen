...
internal data class InlineV1ChargesDisputePostRequestFormEvidenceCustomerDeviceFinger9c71X3dc81cf4Inspection(
    ...
    public val matchesInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2X445eff50: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2X445eff50,
            ).count {
                it
            }
}
...
public class InlineV1ChargesDisputePostRequestFormEvidenceCustomerDeviceFinger9c71X3dc81cf4 internal constructor(
    ...
    private val inspection: InlineV1ChargesDisputePostRequestFormEvidenceCustomerDeviceFinger9c71X3dc81cf4Inspection,
) {
    ...
    public val inlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2X445eff50:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2X445eff50) {
                json
                    .decodeFromJsonElement<InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2X445eff50>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1ChargesDisputePostRequestFormEvidenceCustomerDeviceFinger9c71X3dc81cf4Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2X445eff50) {
                    add(
                        InlineV1ChargesDisputePostRequestFormEvidenceCustomerDeviceFinger9c71X3dc81cf4Branch.InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2X445eff50,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1ChargesDisputePostRequestFormEvidenceCustomerDeviceFinger9c71X3dc81cf4 {
            val inspection = inspectInlineV1ChargesDisputePostRequestFormEvidenceCustomerDeviceFinger9c71X3dc81cf4(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1ChargesDisputePostRequestFormEvidenceCustomerDeviceFinger9c71X3dc81cf4NoMatchException(
                    "InlineV1ChargesDisputePostRequestFormEvidenceCustomerDeviceFinger9c71X3dc81cf4 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1ChargesDisputePostRequestFormEvidenceCustomerDeviceFinger9c71X3dc81cf4> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ChargesDisputePostRequestFormEvidenceCustomerDeviceFinger9c71X3dc81cf4,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1ChargesDisputePostRequestFormEvidenceCustomerDeviceFinger9c71X3dc81cf4",
...
private fun inspectInlineV1ChargesDisputePostRequestFormEvidenceCustomerDeviceFinger9c71X3dc81cf4(
    element: JsonElement,
): InlineV1ChargesDisputePostRequestFormEvidenceCustomerDeviceFinger9c71X3dc81cf4Inspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2X445eff50 =
        element
            .isJsonDecodable<InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2X445eff50>()
    return InlineV1ChargesDisputePostRequestFormEvidenceCustomerDeviceFinger9c71X3dc81cf4Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2X445eff50) {
                    add(
                        "InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2X445eff50: value does not match InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2X445eff50",
                    )
                }
            },
    )
