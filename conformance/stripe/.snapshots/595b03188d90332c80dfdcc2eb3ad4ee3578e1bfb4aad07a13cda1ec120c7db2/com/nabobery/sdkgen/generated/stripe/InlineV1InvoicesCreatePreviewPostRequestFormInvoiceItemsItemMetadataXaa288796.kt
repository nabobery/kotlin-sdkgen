...
internal data class InlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemMetadataXaa288796Inspection(
    ...
    public val matchesInlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemAnyOf2X5c6068e6: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemAnyOf2X5c6068e6,
            ).count {
                it
            }
}
...
public class InlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemMetadataXaa288796 internal constructor(
    ...
    private val inspection: InlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemMetadataXaa288796Inspection,
) {
    ...
    public val inlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemAnyOf2X5c6068e6:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemAnyOf2X5c6068e6) {
                json
                    .decodeFromJsonElement<InlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemAnyOf2X5c6068e6>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemMetadataXaa288796Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemAnyOf2X5c6068e6) {
                    add(
                        InlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemMetadataXaa288796Branch.InlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemAnyOf2X5c6068e6,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemMetadataXaa288796 {
            val inspection = inspectInlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemMetadataXaa288796(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemMetadataXaa288796NoMatchException(
                    "InlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemMetadataXaa288796 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemMetadataXaa288796> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemMetadataXaa288796,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemMetadataXaa288796",
...
private fun inspectInlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemMetadataXaa288796(
    element: JsonElement,
): InlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemMetadataXaa288796Inspection {
    val matchesBranch1 = element.isJsonDecodable<JsonObject>()
    val matchesInlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemAnyOf2X5c6068e6 =
        element
            .isJsonDecodable<InlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemAnyOf2X5c6068e6>()
    return InlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemMetadataXaa288796Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemAnyOf2X5c6068e6) {
                    add(
                        "InlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemAnyOf2X5c6068e6: value does not match InlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemAnyOf2X5c6068e6",
                    )
                }
            },
    )
