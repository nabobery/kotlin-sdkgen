...
public class InlineCustomerCashBalanceTransactionCustomerXaefbb309 internal constructor(
        ...
        get() =
            buildSet {
                ...
                if (inspection.matchesCustomer) {
                    add(
                        InlineCustomerCashBalanceTransactionCustomerXaefbb309Branch.Customer,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineCustomerCashBalanceTransactionCustomerXaefbb309 {
            val inspection = inspectInlineCustomerCashBalanceTransactionCustomerXaefbb309(raw)
            if (inspection.matchCount == 0) {
                throw InlineCustomerCashBalanceTransactionCustomerXaefbb309NoMatchException(
                    "InlineCustomerCashBalanceTransactionCustomerXaefbb309 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineCustomerCashBalanceTransactionCustomerXaefbb309> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineCustomerCashBalanceTransactionCustomerXaefbb309,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineCustomerCashBalanceTransactionCustomerXaefbb309",
...
private fun inspectInlineCustomerCashBalanceTransactionCustomerXaefbb309(
    element: JsonElement,
): InlineCustomerCashBalanceTransactionCustomerXaefbb309Inspection {
