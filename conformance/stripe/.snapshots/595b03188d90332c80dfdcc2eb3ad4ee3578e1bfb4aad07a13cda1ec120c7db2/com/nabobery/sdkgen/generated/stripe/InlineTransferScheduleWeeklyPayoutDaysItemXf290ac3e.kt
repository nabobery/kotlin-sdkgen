...
public sealed class InlineTransferScheduleWeeklyPayoutDaysItemXf290ac3e {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineTransferScheduleWeeklyPayoutDaysItemXf290ac3e =
            when (value) {
                Friday.value -> Friday
                Monday.value -> Monday
    ...
    public object Serializer : KSerializer<InlineTransferScheduleWeeklyPayoutDaysItemXf290ac3e> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineTransferScheduleWeeklyPayoutDaysItemXf290ac3e",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineTransferScheduleWeeklyPayoutDaysItemXf290ac3e =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineTransferScheduleWeeklyPayoutDaysItemXf290ac3e,
        ) {
