...
public class InlineV1CustomerSessionsPostRequestFormComponentsFeaturesX81cbb57f(
    ...
    public val paymentMethodRemove: InlineV1CustomerSessionsPostRequestFormComponentsPaymentMethodRemoveX914bbfd6? = null,
    public val paymentMethodSave: InlineV1CustomerSessionsPostRequestFormComponentsPaymentMethodSaveX2cb5bdfa? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1CustomerSessionsPostRequestFormComponentsFeaturesX81cbb57f =
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1CustomerSessionsPostRequestFormComponentsFeaturesX81cbb57f = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1CustomerSessionsPostRequestFormComponentsFeaturesX81cbb57f> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CustomerSessionsPostRequestFormComponentsFeaturesX81cbb57f must be a JSON object",
                    )
            return InlineV1CustomerSessionsPostRequestFormComponentsFeaturesX81cbb57f(
                paymentMethodAllowRedisplayFilters =
                    rawObject["payment_method_allow_redisplay_filters"]?.let {
                        json
                            .decodeFromJsonElement<List<InlineV1CustomerSessionsPostRequestFormComponentsItemXcc8a052a>>(
                                it,
                            )
                    },
                paymentMethodRedisplay =
                    rawObject["payment_method_redisplay"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CustomerSessionsPostRequestFormComponentsPaymentMethodRedisplayX2d072cae>(
                                it,
                            )
                    },
                paymentMethodRemove =
                    rawObject["payment_method_remove"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CustomerSessionsPostRequestFormComponentsPaymentMethodRemoveX914bbfd6>(
                                it,
                            )
                    },
                paymentMethodSave =
                    rawObject["payment_method_save"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CustomerSessionsPostRequestFormComponentsPaymentMethodSaveX2cb5bdfa>(
                                it,
                            )
                    },
                paymentMethodSaveAllowRedisplayOverride =
                    rawObject["payment_method_save_allow_redisplay_override"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CustomerSessionsPostRequestFormPaymentMethodSaveAll7d2cX55662ce5>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomerSessionsPostRequestFormComponentsFeaturesX81cbb57f,
        ) {
            val jsonEncoder =
...
public fun inlineV1CustomerSessionsPostRequestFormComponentsFeaturesX81cbb57f(
    block: InlineV1CustomerSessionsPostRequestFormComponentsFeaturesX81cbb57f.Builder.() -> Unit,
): InlineV1CustomerSessionsPostRequestFormComponentsFeaturesX81cbb57f =
    InlineV1CustomerSessionsPostRequestFormComponentsFeaturesX81cbb57f.build(block)
