...
public class InlineV1AppsSecretsDeletePostRequestFormScopeX7f8febf5(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1AppsSecretsDeletePostRequestFormScopeX7f8febf5 =
    ...
    public object Serializer : KSerializer<InlineV1AppsSecretsDeletePostRequestFormScopeX7f8febf5> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AppsSecretsDeletePostRequestFormScopeX7f8febf5 must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineV1AppsSecretsDeletePostRequestFormScopeTypeX35b92a45>(
                    rawObject,
                    "type",
                )
            return InlineV1AppsSecretsDeletePostRequestFormScopeX7f8febf5(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AppsSecretsDeletePostRequestFormScopeX7f8febf5,
        ) {
...
public fun inlineV1AppsSecretsDeletePostRequestFormScopeX7f8febf5(
    block: InlineV1AppsSecretsDeletePostRequestFormScopeX7f8febf5.Builder.() -> Unit,
): InlineV1AppsSecretsDeletePostRequestFormScopeX7f8febf5 =
    InlineV1AppsSecretsDeletePostRequestFormScopeX7f8febf5.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1AppsSecretsDeletePostRequestFormScopeX7f8febf5 is missing required property '" + name + "'",
            )
