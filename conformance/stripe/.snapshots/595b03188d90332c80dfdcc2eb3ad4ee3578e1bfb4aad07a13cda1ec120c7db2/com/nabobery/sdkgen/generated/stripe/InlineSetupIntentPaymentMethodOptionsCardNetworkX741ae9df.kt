...
public sealed class InlineSetupIntentPaymentMethodOptionsCardNetworkX741ae9df {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineSetupIntentPaymentMethodOptionsCardNetworkX741ae9df =
            when (value) {
                Amex.value -> Amex
    ...
    public object Serializer : KSerializer<InlineSetupIntentPaymentMethodOptionsCardNetworkX741ae9df> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineSetupIntentPaymentMethodOptionsCardNetworkX741ae9df",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineSetupIntentPaymentMethodOptionsCardNetworkX741ae9df =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineSetupIntentPaymentMethodOptionsCardNetworkX741ae9df,
        ) {
