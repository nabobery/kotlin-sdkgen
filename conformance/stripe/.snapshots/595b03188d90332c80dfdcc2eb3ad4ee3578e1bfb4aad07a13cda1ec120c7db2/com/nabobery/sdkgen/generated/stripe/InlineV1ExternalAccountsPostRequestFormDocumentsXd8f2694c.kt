...
public class InlineV1ExternalAccountsPostRequestFormDocumentsXd8f2694c(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1ExternalAccountsPostRequestFormDocumentsXd8f2694c =
            InlineV1ExternalAccountsPostRequestFormDocumentsXd8f2694c(
                bankAccountOwnershipVerification = bankAccountOwnershipVerification,
            )
    }

    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1ExternalAccountsPostRequestFormDocumentsXd8f2694c =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1ExternalAccountsPostRequestFormDocumentsXd8f2694c> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1ExternalAccountsPostRequestFormDocumentsXd8f2694c must be a JSON object",
                    )
            return InlineV1ExternalAccountsPostRequestFormDocumentsXd8f2694c(
                bankAccountOwnershipVerification =
                    rawObject["bank_account_ownership_verification"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1ExternalAccountsPostRequestFormBankAccountOwnership2a7eX514a2a38>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ExternalAccountsPostRequestFormDocumentsXd8f2694c,
        ) {
...
public fun inlineV1ExternalAccountsPostRequestFormDocumentsXd8f2694c(
    block: InlineV1ExternalAccountsPostRequestFormDocumentsXd8f2694c.Builder.() -> Unit,
): InlineV1ExternalAccountsPostRequestFormDocumentsXd8f2694c =
    InlineV1ExternalAccountsPostRequestFormDocumentsXd8f2694c.build(block)
