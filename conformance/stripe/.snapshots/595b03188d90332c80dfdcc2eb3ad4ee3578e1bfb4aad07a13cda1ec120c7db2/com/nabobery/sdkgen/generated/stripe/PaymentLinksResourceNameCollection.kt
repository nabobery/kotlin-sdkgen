...
public class PaymentLinksResourceNameCollection(
    ...
    public class Builder {
        ...
        public fun build(): PaymentLinksResourceNameCollection =
    ...
    public object Serializer : KSerializer<PaymentLinksResourceNameCollection> {
        ...
        override fun deserialize(decoder: Decoder): PaymentLinksResourceNameCollection {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentLinksResourceNameCollection must be a JSON object")
            return PaymentLinksResourceNameCollection(
                business =
                    rawObject["business"]?.let {
                        json.decodeFromJsonElement<PaymentLinksResourceBusinessName>(
                            it,
                        )
                    },
                individual =
                    rawObject["individual"]?.let {
                        json.decodeFromJsonElement<PaymentLinksResourceIndividualName>(
                            it,
                        )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentLinksResourceNameCollection,
        ) {
...
public fun paymentLinksResourceNameCollection(
    block: PaymentLinksResourceNameCollection.Builder.() -> Unit,
): PaymentLinksResourceNameCollection = PaymentLinksResourceNameCollection.build(block)
