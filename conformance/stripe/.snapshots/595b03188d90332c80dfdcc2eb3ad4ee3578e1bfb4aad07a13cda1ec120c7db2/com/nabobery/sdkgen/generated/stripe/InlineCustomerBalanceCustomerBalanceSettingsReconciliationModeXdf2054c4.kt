...
public sealed class InlineCustomerBalanceCustomerBalanceSettingsReconciliationModeXdf2054c4 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineCustomerBalanceCustomerBalanceSettingsReconciliationModeXdf2054c4 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineCustomerBalanceCustomerBalanceSettingsReconciliationModeXdf2054c4> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineCustomerBalanceCustomerBalanceSettingsReconciliationModeXdf2054c4",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineCustomerBalanceCustomerBalanceSettingsReconciliationModeXdf2054c4 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineCustomerBalanceCustomerBalanceSettingsReconciliationModeXdf2054c4,
        ) {
