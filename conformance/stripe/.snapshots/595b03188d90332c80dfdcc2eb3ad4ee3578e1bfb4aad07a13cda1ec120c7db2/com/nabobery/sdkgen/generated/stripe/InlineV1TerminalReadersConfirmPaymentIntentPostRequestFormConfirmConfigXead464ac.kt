...
public class InlineV1TerminalReadersConfirmPaymentIntentPostRequestFormConfirmConfigXead464ac(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1TerminalReadersConfirmPaymentIntentPostRequestFormConfirmConfigXead464ac =
            InlineV1TerminalReadersConfirmPaymentIntentPostRequestFormConfirmConfigXead464ac(
                returnUrl = returnUrl,
            )
    }
    ...
    public object Serializer : KSerializer<InlineV1TerminalReadersConfirmPaymentIntentPostRequestFormConfirmConfigXead464ac> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TerminalReadersConfirmPaymentIntentPostRequestFormConfirmConfigXead464ac must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TerminalReadersConfirmPaymentIntentPostRequestFormConfirmConfigXead464ac,
        ) {
            val jsonEncoder =
...
public fun inlineV1TerminalReadersConfirmPaymentIntentPostRequestFormConfirmConfigXead464ac(
    block: InlineV1TerminalReadersConfirmPaymentIntentPostRequestFormConfirmConfigXead464ac.Builder.() -> Unit,
): InlineV1TerminalReadersConfirmPaymentIntentPostRequestFormConfirmConfigXead464ac =
