...
public sealed class InlineV1AccountsPeoplePostRequestFormFullNameAliasesAnyOf2Xf09a781d {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1AccountsPeoplePostRequestFormFullNameAliasesAnyOf2Xf09a781d =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1AccountsPeoplePostRequestFormFullNameAliasesAnyOf2Xf09a781d> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1AccountsPeoplePostRequestFormFullNameAliasesAnyOf2Xf09a781d",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1AccountsPeoplePostRequestFormFullNameAliasesAnyOf2Xf09a781d = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPeoplePostRequestFormFullNameAliasesAnyOf2Xf09a781d,
        ) {
