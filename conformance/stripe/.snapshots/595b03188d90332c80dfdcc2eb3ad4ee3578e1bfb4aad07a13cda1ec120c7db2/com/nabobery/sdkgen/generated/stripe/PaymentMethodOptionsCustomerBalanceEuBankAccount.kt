...
public class PaymentMethodOptionsCustomerBalanceEuBankAccount(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentMethodOptionsCustomerBalanceEuBankAccount =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentMethodOptionsCustomerBalanceEuBankAccount> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "PaymentMethodOptionsCustomerBalanceEuBankAccount must be a JSON object",
                    )
            val country =
                json.decodeRequired<InlinePaymentMethodOptionsCustomerBalanceEuBankAccountCountryXa4573c9a>(
                    rawObject,
                    "country",
                )
            return PaymentMethodOptionsCustomerBalanceEuBankAccount(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentMethodOptionsCustomerBalanceEuBankAccount,
        ) {
...
public fun paymentMethodOptionsCustomerBalanceEuBankAccount(
    block: PaymentMethodOptionsCustomerBalanceEuBankAccount.Builder.() -> Unit,
): PaymentMethodOptionsCustomerBalanceEuBankAccount = PaymentMethodOptionsCustomerBalanceEuBankAccount.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "PaymentMethodOptionsCustomerBalanceEuBankAccount is missing required property '" + name + "'",
            )
