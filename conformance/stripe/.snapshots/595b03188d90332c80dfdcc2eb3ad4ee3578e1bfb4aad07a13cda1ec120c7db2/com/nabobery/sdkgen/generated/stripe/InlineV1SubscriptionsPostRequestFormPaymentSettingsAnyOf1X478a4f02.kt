...
public class InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X478a4f02(
    public val preferredLanguage: InlineV1SubscriptionsPostRequestFormPaymentSettingsPreferredLanguageXed7bbb08? = null,
) {
    public class Builder {
        public var preferredLanguage:
            InlineV1SubscriptionsPostRequestFormPaymentSettingsPreferredLanguageXed7bbb08? = null

        public fun build(): InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X478a4f02 =
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X478a4f02 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X478a4f02> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X478a4f02 must be a JSON object",
                    )
            return InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X478a4f02(
                preferredLanguage =
                    rawObject["preferred_language"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormPaymentSettingsPreferredLanguageXed7bbb08>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X478a4f02,
        ) {
            val jsonEncoder =
...
public fun inlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X478a4f02(
    block: InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X478a4f02.Builder.() -> Unit,
): InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X478a4f02 =
    InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X478a4f02.build(block)
