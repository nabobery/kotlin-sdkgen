...
public sealed class InlineShippingRateTaxBehaviorX98ec2e75 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineShippingRateTaxBehaviorX98ec2e75 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineShippingRateTaxBehaviorX98ec2e75> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineShippingRateTaxBehaviorX98ec2e75",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineShippingRateTaxBehaviorX98ec2e75 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineShippingRateTaxBehaviorX98ec2e75,
        ) {
