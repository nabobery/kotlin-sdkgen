...
public class CheckoutBacsDebitPaymentMethodOptions(
     ...
     */
    public val setupFutureUsage: InlineCheckoutBacsDebitPaymentMethodOptionsSetupFutureUsageX6c1aa115? = null,
    /**
    ...
    public class Builder {
        ...
        public fun build(): CheckoutBacsDebitPaymentMethodOptions =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): CheckoutBacsDebitPaymentMethodOptions =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<CheckoutBacsDebitPaymentMethodOptions> {
        ...
        override fun deserialize(decoder: Decoder): CheckoutBacsDebitPaymentMethodOptions {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("CheckoutBacsDebitPaymentMethodOptions must be a JSON object")
            return CheckoutBacsDebitPaymentMethodOptions(
                mandateOptions =
                    rawObject["mandate_options"]?.let {
                        json.decodeFromJsonElement<CheckoutPaymentMethodOptionsMandateOptionsBacsDebit>(it)
                    },
                setupFutureUsage =
                    rawObject["setup_future_usage"]?.let {
                        json
                            .decodeFromJsonElement<InlineCheckoutBacsDebitPaymentMethodOptionsSetupFutureUsageX6c1aa115>(
                                it,
                            )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: CheckoutBacsDebitPaymentMethodOptions,
        ) {
...
public fun checkoutBacsDebitPaymentMethodOptions(
    block: CheckoutBacsDebitPaymentMethodOptions.Builder.() -> Unit,
): CheckoutBacsDebitPaymentMethodOptions = CheckoutBacsDebitPaymentMethodOptions.build(block)
