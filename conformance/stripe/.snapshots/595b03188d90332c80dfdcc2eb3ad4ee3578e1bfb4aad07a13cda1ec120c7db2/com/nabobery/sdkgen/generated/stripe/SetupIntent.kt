...
@Serializable
public data class SetupIntentView(
    ...
    public val excludedPaymentMethodTypes: List<InlineSetupIntentExcludedPaymentMethodTypesItemXc2cbe4cf>? = null,
    ...
    public val paymentMethodConfigurationDetails: InlineSetupIntentPaymentMethodConfigurationDetailsXbc2a0b90? = null,
...
public class SetupIntent(
    ...
    public class Builder {
         ...
         */
        public var flowDirections: List<InlineSetupIntentFlowDirectionsItemX0f009201>? = null
    ...
    public object Serializer : KSerializer<SetupIntent> {
        ...
        override fun deserialize(decoder: Decoder): SetupIntent {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("SetupIntent must be a JSON object")
                ...
                application =
                    rawObject["application"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineSetupIntentApplicationXbb7ee095?>(element)
                        }
                    },
                ...
                automaticPaymentMethods =
                    rawObject["automatic_payment_methods"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineSetupIntentAutomaticPaymentMethodsX4392fbfe?>(element)
                        }
                    },
                cancellationReason =
                    rawObject["cancellation_reason"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineSetupIntentCancellationReasonX43ba9b44?>(element)
                        }
                    },
                clientSecret =
                ...
                customer =
                    rawObject["customer"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineSetupIntentCustomerXae0c479d?>(element)
                        }
                    },
                customerAccount =
                ...
                excludedPaymentMethodTypes =
                    rawObject["excluded_payment_method_types"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<List<InlineSetupIntentExcludedPaymentMethodTypesItemXc2cbe4cf>?>(
                                element,
                            )
                        }
                    },
                flowDirections =
                    rawObject["flow_directions"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<List<InlineSetupIntentFlowDirectionsItemX0f009201>?>(element)
                        }
                    },
                lastSetupError =
                    rawObject["last_setup_error"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineSetupIntentLastSetupErrorX50a0ebf5?>(element)
                        }
                    },
                latestAttempt =
                    rawObject["latest_attempt"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineSetupIntentLatestAttemptXa0b1ef17?>(element)
                        }
                    },
                managedPayments =
                    rawObject["managed_payments"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineSetupIntentManagedPaymentsXf96d32d2?>(element)
                        }
                    },
                mandate =
                    rawObject["mandate"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineSetupIntentMandateX652efc7a?>(element)
                        }
                    },
                metadata =
                ...
                nextAction =
                    rawObject["next_action"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineSetupIntentNextActionX00e3e8dd?>(element)
                        }
                    },
                onBehalfOf =
                    rawObject["on_behalf_of"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineSetupIntentOnBehalfOfX6d54b25d?>(element)
                        }
                    },
                paymentMethod =
                    rawObject["payment_method"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineSetupIntentPaymentMethodXb9ecb298?>(element)
                        }
                    },
                paymentMethodConfigurationDetails =
                    rawObject["payment_method_configuration_details"]
                        ?.let { element ->
                            if (element ==
                                JsonNull
                            ) {
                                ...
                                json
                                    .decodeFromJsonElement<InlineSetupIntentPaymentMethodConfigurationDetailsXbc2a0b90?>(
                                        element,
                                    )
                            }
                        },
                paymentMethodOptions =
                    rawObject["payment_method_options"]
                        ?.let { element ->
                            if (element ==
                                JsonNull
                            ) {
                                ...
                                json.decodeFromJsonElement<InlineSetupIntentPaymentMethodOptionsXca95335a?>(element)
                            }
                        },
                singleUseMandate =
                    rawObject["single_use_mandate"]
                        ?.let { element ->
                            if (element ==
                                JsonNull
                            ) {
                                ...
                                json.decodeFromJsonElement<InlineSetupIntentSingleUseMandateXf2c7f2f3?>(element)
                            }
                        },
            )
        }
