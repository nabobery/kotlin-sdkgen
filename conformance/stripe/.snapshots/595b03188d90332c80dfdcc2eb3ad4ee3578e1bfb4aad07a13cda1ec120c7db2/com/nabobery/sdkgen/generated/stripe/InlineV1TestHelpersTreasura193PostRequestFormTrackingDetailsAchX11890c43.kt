...
public class InlineV1TestHelpersTreasura193PostRequestFormTrackingDetailsAchX11890c43(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1TestHelpersTreasura193PostRequestFormTrackingDetailsAchX11890c43 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TestHelpersTreasura193PostRequestFormTrackingDetailsAchX11890c43> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TestHelpersTreasura193PostRequestFormTrackingDetailsAchX11890c43 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TestHelpersTreasura193PostRequestFormTrackingDetailsAchX11890c43,
        ) {
            val jsonEncoder =
...
public fun inlineV1TestHelpersTreasura193PostRequestFormTrackingDetailsAchX11890c43(
    block: InlineV1TestHelpersTreasura193PostRequestFormTrackingDetailsAchX11890c43.Builder.() -> Unit,
): InlineV1TestHelpersTreasura193PostRequestFormTrackingDetailsAchX11890c43 =
    InlineV1TestHelpersTreasura193PostRequestFormTrackingDetailsAchX11890c43.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TestHelpersTreasura193PostRequestFormTrackingDetailsAchX11890c43 is missing required property '" +
                    name +
                    "'",
            )
