...
public sealed class InlineV1AccountsExternalAccountsPostRequestFormAccountHolderTypeX8ff22307 {
    ...
    public object Serializer : KSerializer<InlineV1AccountsExternalAccountsPostRequestFormAccountHolderTypeX8ff22307> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1AccountsExternalAccountsPostRequestFormAccountHolderTypeX8ff22307",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1AccountsExternalAccountsPostRequestFormAccountHolderTypeX8ff22307 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsExternalAccountsPostRequestFormAccountHolderTypeX8ff22307,
        ) {
