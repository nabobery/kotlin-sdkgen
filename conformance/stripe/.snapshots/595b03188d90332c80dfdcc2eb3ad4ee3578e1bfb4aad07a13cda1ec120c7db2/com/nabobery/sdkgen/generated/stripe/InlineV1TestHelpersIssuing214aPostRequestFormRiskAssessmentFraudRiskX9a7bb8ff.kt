...
public class InlineV1TestHelpersIssuing214aPostRequestFormRiskAssessmentFraudRiskX9a7bb8ff(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1TestHelpersIssuing214aPostRequestFormRiskAssessmentFraudRiskX9a7bb8ff =
    ...
    public object Serializer : KSerializer<InlineV1TestHelpersIssuing214aPostRequestFormRiskAssessmentFraudRiskX9a7bb8ff> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TestHelpersIssuing214aPostRequestFormRiskAssessmentFraudRiskX9a7bb8ff must be a JSON object",
                    )
            val level =
                json.decodeRequired<InlineV1TestHelpersIssuing214aPostRequestFormRiskAssessmentLevelXe90f37b0>(
                    rawObject,
                    "level",
                )
            return InlineV1TestHelpersIssuing214aPostRequestFormRiskAssessmentFraudRiskX9a7bb8ff(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TestHelpersIssuing214aPostRequestFormRiskAssessmentFraudRiskX9a7bb8ff,
        ) {
            val jsonEncoder =
...
public fun inlineV1TestHelpersIssuing214aPostRequestFormRiskAssessmentFraudRiskX9a7bb8ff(
    block: InlineV1TestHelpersIssuing214aPostRequestFormRiskAssessmentFraudRiskX9a7bb8ff.Builder.() -> Unit,
): InlineV1TestHelpersIssuing214aPostRequestFormRiskAssessmentFraudRiskX9a7bb8ff =
    InlineV1TestHelpersIssuing214aPostRequestFormRiskAssessmentFraudRiskX9a7bb8ff.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TestHelpersIssuing214aPostRequestFormRiskAssessmentFraudRiskX9a7bb8ff is missing required property '" +
                    name +
                    "'",
            )
