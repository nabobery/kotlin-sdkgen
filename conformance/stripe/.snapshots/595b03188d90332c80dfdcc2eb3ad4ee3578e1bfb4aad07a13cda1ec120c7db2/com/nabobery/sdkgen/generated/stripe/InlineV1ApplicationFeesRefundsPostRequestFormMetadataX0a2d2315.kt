...
internal data class InlineV1ApplicationFeesRefundsPostRequestFormMetadataX0a2d2315Inspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1ApplicationFeesRefundsPostRequestFormMetadataAnyOf2Xe97b3b66,
            ).count { it }
}
...
public class InlineV1ApplicationFeesRefundsPostRequestFormMetadataX0a2d2315 internal constructor(
    ...
    public val inlineV1ApplicationFeesRefundsPostRequestFormMetadataAnyOf2Xe97b3b66:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1ApplicationFeesRefundsPostRequestFormMetadataAnyOf2Xe97b3b66) {
                json
                    .decodeFromJsonElement<InlineV1ApplicationFeesRefundsPostRequestFormMetadataAnyOf2Xe97b3b66>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1ApplicationFeesRefundsPostRequestFormMetadataX0a2d2315Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1ApplicationFeesRefundsPostRequestFormMetadataAnyOf2Xe97b3b66) {
                    add(
                        InlineV1ApplicationFeesRefundsPostRequestFormMetadataX0a2d2315Branch.InlineV1ApplicationFeesRefundsPostRequestFormMetadataAnyOf2Xe97b3b66,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1ApplicationFeesRefundsPostRequestFormMetadataX0a2d2315 {
            val inspection = inspectInlineV1ApplicationFeesRefundsPostRequestFormMetadataX0a2d2315(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1ApplicationFeesRefundsPostRequestFormMetadataX0a2d2315NoMatchException(
                    "InlineV1ApplicationFeesRefundsPostRequestFormMetadataX0a2d2315 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1ApplicationFeesRefundsPostRequestFormMetadataX0a2d2315> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ApplicationFeesRefundsPostRequestFormMetadataX0a2d2315,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1ApplicationFeesRefundsPostRequestFormMetadataX0a2d2315",
...
private fun inspectInlineV1ApplicationFeesRefundsPostRequestFormMetadataX0a2d2315(
    element: JsonElement,
): InlineV1ApplicationFeesRefundsPostRequestFormMetadataX0a2d2315Inspection {
    val matchesBranch1 = element.isJsonDecodable<JsonObject>()
    val matchesInlineV1ApplicationFeesRefundsPostRequestFormMetadataAnyOf2Xe97b3b66 =
        element
            .isJsonDecodable<InlineV1ApplicationFeesRefundsPostRequestFormMetadataAnyOf2Xe97b3b66>()
    return InlineV1ApplicationFeesRefundsPostRequestFormMetadataX0a2d2315Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1ApplicationFeesRefundsPostRequestFormMetadataAnyOf2Xe97b3b66) {
                    add(
                        "InlineV1ApplicationFeesRefundsPostRequestFormMetadataAnyOf2Xe97b3b66: value does not match InlineV1ApplicationFeesRefundsPostRequestFormMetadataAnyOf2Xe97b3b66",
                    )
                }
            },
    )
