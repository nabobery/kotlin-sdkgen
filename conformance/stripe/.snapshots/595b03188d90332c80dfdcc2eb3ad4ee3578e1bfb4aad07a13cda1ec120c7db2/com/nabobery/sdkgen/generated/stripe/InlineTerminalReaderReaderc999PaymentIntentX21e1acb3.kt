...
public class InlineTerminalReaderReaderc999PaymentIntentX21e1acb3 internal constructor(
        ...
        get() =
            buildSet {
                ...
                if (inspection.matchesPaymentIntent) {
                    add(
                        InlineTerminalReaderReaderc999PaymentIntentX21e1acb3Branch.PaymentIntent,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineTerminalReaderReaderc999PaymentIntentX21e1acb3 {
            val inspection = inspectInlineTerminalReaderReaderc999PaymentIntentX21e1acb3(raw)
            if (inspection.matchCount == 0) {
                throw InlineTerminalReaderReaderc999PaymentIntentX21e1acb3NoMatchException(
                    "InlineTerminalReaderReaderc999PaymentIntentX21e1acb3 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineTerminalReaderReaderc999PaymentIntentX21e1acb3> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineTerminalReaderReaderc999PaymentIntentX21e1acb3,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineTerminalReaderReaderc999PaymentIntentX21e1acb3",
...
private fun inspectInlineTerminalReaderReaderc999PaymentIntentX21e1acb3(
    element: JsonElement,
): InlineTerminalReaderReaderc999PaymentIntentX21e1acb3Inspection {
