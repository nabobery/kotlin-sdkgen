...
public class InlineV1TransfersPostRequestFormX82d647ba(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TransfersPostRequestFormX82d647ba =
    ...
    public object Serializer : KSerializer<InlineV1TransfersPostRequestFormX82d647ba> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1TransfersPostRequestFormX82d647ba {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("InlineV1TransfersPostRequestFormX82d647ba must be a JSON object")
            ...
            return InlineV1TransfersPostRequestFormX82d647ba(
                ...
                sourceType =
                    rawObject["source_type"]?.let {
                        json.decodeFromJsonElement<InlineV1TransfersPostRequestFormSourceTypeX11473d86>(it)
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TransfersPostRequestFormX82d647ba,
        ) {
...
public fun inlineV1TransfersPostRequestFormX82d647ba(
    block: InlineV1TransfersPostRequestFormX82d647ba.Builder.() -> Unit,
): InlineV1TransfersPostRequestFormX82d647ba = InlineV1TransfersPostRequestFormX82d647ba.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TransfersPostRequestFormX82d647ba is missing required property '" + name + "'",
            )
