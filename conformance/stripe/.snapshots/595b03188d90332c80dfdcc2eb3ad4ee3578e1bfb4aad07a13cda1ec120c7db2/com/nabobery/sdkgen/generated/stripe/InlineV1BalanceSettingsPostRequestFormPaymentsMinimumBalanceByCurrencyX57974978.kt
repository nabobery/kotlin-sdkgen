...
internal data class InlineV1BalanceSettingsPostRequestFormPaymentsMinimumBalanceByCurrencyX57974978Inspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1BalanceSettingsPostRequestFormPaymentsPayoutsAnyOf2X13028417,
            ).count { it }
}
...
public class InlineV1BalanceSettingsPostRequestFormPaymentsMinimumBalanceByCurrencyX57974978 internal constructor(
    ...
    private val inspection: InlineV1BalanceSettingsPostRequestFormPaymentsMinimumBalanceByCurrencyX57974978Inspection,
) {
    ...
    public val inlineV1BalanceSettingsPostRequestFormPaymentsPayoutsAnyOf2X13028417:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1BalanceSettingsPostRequestFormPaymentsPayoutsAnyOf2X13028417) {
                json
                    .decodeFromJsonElement<InlineV1BalanceSettingsPostRequestFormPaymentsPayoutsAnyOf2X13028417>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1BalanceSettingsPostRequestFormPaymentsMinimumBalanceByCurrencyX57974978Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1BalanceSettingsPostRequestFormPaymentsPayoutsAnyOf2X13028417) {
                    add(
                        InlineV1BalanceSettingsPostRequestFormPaymentsMinimumBalanceByCurrencyX57974978Branch.InlineV1BalanceSettingsPostRequestFormPaymentsPayoutsAnyOf2X13028417,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1BalanceSettingsPostRequestFormPaymentsMinimumBalanceByCurrencyX57974978 {
            val inspection = inspectInlineV1BalanceSettingsPostRequestFormPaymentsMinimumBalanceByCurrencyX57974978(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1BalanceSettingsPostRequestFormPaymentsMinimumBalanceByCurrencyX57974978NoMatchException(
                    "InlineV1BalanceSettingsPostRequestFormPaymentsMinimumBalanceByCurrencyX57974978 matched 0 branches: " +
                        inspection.failures.joinToString("; "),
                )
            }
            return InlineV1BalanceSettingsPostRequestFormPaymentsMinimumBalanceByCurrencyX57974978(
                raw,
                json,
                inspection,
            )
    ...
    public object Serializer : KSerializer<InlineV1BalanceSettingsPostRequestFormPaymentsMinimumBalanceByCurrencyX57974978> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1BalanceSettingsPostRequestFormPaymentsMinimumBalanceByCurrencyX57974978,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1BalanceSettingsPostRequestFormPaymentsMinimumBalanceByCurrencyX57974978",
...
private fun inspectInlineV1BalanceSettingsPostRequestFormPaymentsMinimumBalanceByCurrencyX57974978(
    element: JsonElement,
): InlineV1BalanceSettingsPostRequestFormPaymentsMinimumBalanceByCurrencyX57974978Inspection {
    val matchesBranch1 = element.isJsonDecodable<JsonObject>()
    val matchesInlineV1BalanceSettingsPostRequestFormPaymentsPayoutsAnyOf2X13028417 =
        element
            .isJsonDecodable<InlineV1BalanceSettingsPostRequestFormPaymentsPayoutsAnyOf2X13028417>()
    return InlineV1BalanceSettingsPostRequestFormPaymentsMinimumBalanceByCurrencyX57974978Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1BalanceSettingsPostRequestFormPaymentsPayoutsAnyOf2X13028417) {
                    add(
                        "InlineV1BalanceSettingsPostRequestFormPaymentsPayoutsAnyOf2X13028417: value does not match InlineV1BalanceSettingsPostRequestFormPaymentsPayoutsAnyOf2X13028417",
                    )
                }
            },
    )
