...
public class InlineV1BillingAlertsPostRequestFormX87b5449f(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1BillingAlertsPostRequestFormX87b5449f =
    ...
    public object Serializer : KSerializer<InlineV1BillingAlertsPostRequestFormX87b5449f> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1BillingAlertsPostRequestFormX87b5449f {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1BillingAlertsPostRequestFormX87b5449f must be a JSON object",
                    )
            val alertType =
                json.decodeRequired<InlineV1BillingAlertsPostRequestFormAlertTypeX28271849>(
                    rawObject,
                    "alert_type",
                )
            ...
            return InlineV1BillingAlertsPostRequestFormX87b5449f(
                ...
                usageThreshold =
                    rawObject["usage_threshold"]?.let {
                        json.decodeFromJsonElement<InlineV1BillingAlertsPostRequestFormUsageThresholdX6466c8c5>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1BillingAlertsPostRequestFormX87b5449f,
        ) {
...
public fun inlineV1BillingAlertsPostRequestFormX87b5449f(
    block: InlineV1BillingAlertsPostRequestFormX87b5449f.Builder.() -> Unit,
): InlineV1BillingAlertsPostRequestFormX87b5449f = InlineV1BillingAlertsPostRequestFormX87b5449f.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1BillingAlertsPostRequestFormX87b5449f is missing required property '" + name + "'",
            )
