...
public class InlineV1TreasuryFinancialAccountsPostRequestFormFeaturesX61532763(
    public val cardIssuing: InlineV1TreasuryFinancialAccountsPostRequestFormFeaturesCardIssuingXb9b6d958? = null,
    public val depositInsurance: InlineV1TreasuryFinancialAc862PostRequestFormFeaturesDepositInsuranceX4c10a294? = null,
    public val financialAddresses:
        InlineV1TreasuryFinancialAc862PostRequestFormFeaturesFinancialAddressesX66e40cbb? = null,
    public val inboundTransfers: InlineV1TreasuryFinancialAc862PostRequestFormFeaturesInboundTransfersXcb8649ca? = null,
    public val intraStripeFlows: InlineV1TreasuryFinancialAc862PostRequestFormFeaturesIntraStripeFlowsX4de6efdc? = null,
    public val outboundPayments: InlineV1TreasuryFinancialAc862PostRequestFormFeaturesOutboundPaymentsX3583f33e? = null,
    public val outboundTransfers: InlineV1TreasuryFinancialAc862PostRequestFormFeaturesOutboundTransfersXa626e7a5? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1TreasuryFinancialAccountsPostRequestFormFeaturesX61532763 =
            InlineV1TreasuryFinancialAccountsPostRequestFormFeaturesX61532763(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TreasuryFinancialAccountsPostRequestFormFeaturesX61532763 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TreasuryFinancialAccountsPostRequestFormFeaturesX61532763> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TreasuryFinancialAccountsPostRequestFormFeaturesX61532763 must be a JSON object",
                    )
            return InlineV1TreasuryFinancialAccountsPostRequestFormFeaturesX61532763(
                cardIssuing =
                    rawObject["card_issuing"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TreasuryFinancialAccountsPostRequestFormFeaturesCardIssuingXb9b6d958>(
                                it,
                            )
                    },
                depositInsurance =
                    rawObject["deposit_insurance"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TreasuryFinancialAc862PostRequestFormFeaturesDepositInsuranceX4c10a294>(
                                it,
                            )
                    },
                financialAddresses =
                    rawObject["financial_addresses"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TreasuryFinancialAc862PostRequestFormFeaturesFinancialAddressesX66e40cbb>(
                                it,
                            )
                    },
                inboundTransfers =
                    rawObject["inbound_transfers"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TreasuryFinancialAc862PostRequestFormFeaturesInboundTransfersXcb8649ca>(
                                it,
                            )
                    },
                intraStripeFlows =
                    rawObject["intra_stripe_flows"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TreasuryFinancialAc862PostRequestFormFeaturesIntraStripeFlowsX4de6efdc>(
                                it,
                            )
                    },
                outboundPayments =
                    rawObject["outbound_payments"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TreasuryFinancialAc862PostRequestFormFeaturesOutboundPaymentsX3583f33e>(
                                it,
                            )
                    },
                outboundTransfers =
                    rawObject["outbound_transfers"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TreasuryFinancialAc862PostRequestFormFeaturesOutboundTransfersXa626e7a5>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TreasuryFinancialAccountsPostRequestFormFeaturesX61532763,
        ) {
            val jsonEncoder =
...
public fun inlineV1TreasuryFinancialAccountsPostRequestFormFeaturesX61532763(
    block: InlineV1TreasuryFinancialAccountsPostRequestFormFeaturesX61532763.Builder.() -> Unit,
): InlineV1TreasuryFinancialAccountsPostRequestFormFeaturesX61532763 =
    InlineV1TreasuryFinancialAccountsPostRequestFormFeaturesX61532763.build(block)
