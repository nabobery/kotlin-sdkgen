...
internal data class InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsAmountX19dbe9a5Inspection(
    ...
    public val matchesInlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2X244c57cc: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2X244c57cc,
            ).count {
                it
            }
}
...
public class InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsAmountX19dbe9a5 internal constructor(
    ...
    private val inspection: InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsAmountX19dbe9a5Inspection,
) {
    ...
    public val inlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2X244c57cc:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2X244c57cc) {
                json
                    .decodeFromJsonElement<InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2X244c57cc>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsAmountX19dbe9a5Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2X244c57cc) {
                    add(
                        InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsAmountX19dbe9a5Branch.InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2X244c57cc,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsAmountX19dbe9a5 {
            val inspection = inspectInlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsAmountX19dbe9a5(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsAmountX19dbe9a5NoMatchException(
                    "InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsAmountX19dbe9a5 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsAmountX19dbe9a5> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsAmountX19dbe9a5,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsAmountX19dbe9a5",
...
private fun inspectInlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsAmountX19dbe9a5(
    element: JsonElement,
): InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsAmountX19dbe9a5Inspection {
    val matchesBranch1 = element.isJsonDecodable<Int>()
    val matchesInlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2X244c57cc =
        element
            .isJsonDecodable<InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2X244c57cc>()
    return InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsAmountX19dbe9a5Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2X244c57cc) {
                    add(
                        "InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2X244c57cc: value does not match InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2X244c57cc",
                    )
                }
            },
    )
