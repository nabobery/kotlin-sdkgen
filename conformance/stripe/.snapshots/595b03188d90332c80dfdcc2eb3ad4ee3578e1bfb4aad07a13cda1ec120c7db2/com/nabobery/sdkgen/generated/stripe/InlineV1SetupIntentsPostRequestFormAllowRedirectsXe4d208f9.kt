...
public sealed class InlineV1SetupIntentsPostRequestFormAllowRedirectsXe4d208f9 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1SetupIntentsPostRequestFormAllowRedirectsXe4d208f9 =
            when (value) {
                Always.value -> Always
                Never.value -> Never
    ...
    public object Serializer : KSerializer<InlineV1SetupIntentsPostRequestFormAllowRedirectsXe4d208f9> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1SetupIntentsPostRequestFormAllowRedirectsXe4d208f9",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1SetupIntentsPostRequestFormAllowRedirectsXe4d208f9 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SetupIntentsPostRequestFormAllowRedirectsXe4d208f9,
        ) {
