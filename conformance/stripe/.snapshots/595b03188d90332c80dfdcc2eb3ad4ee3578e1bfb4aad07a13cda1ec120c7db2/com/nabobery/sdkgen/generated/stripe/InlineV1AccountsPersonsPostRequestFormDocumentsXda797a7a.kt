...
public class InlineV1AccountsPersonsPostRequestFormDocumentsXda797a7a(
    public val companyAuthorization: InlineV1AccountsPersonsPostRequestFormDocumentsCompanyAuthorizationX6b0cface? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1AccountsPersonsPostRequestFormDocumentsXda797a7a =
            InlineV1AccountsPersonsPostRequestFormDocumentsXda797a7a(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1AccountsPersonsPostRequestFormDocumentsXda797a7a =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1AccountsPersonsPostRequestFormDocumentsXda797a7a> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountsPersonsPostRequestFormDocumentsXda797a7a must be a JSON object",
                    )
            return InlineV1AccountsPersonsPostRequestFormDocumentsXda797a7a(
                companyAuthorization =
                    rawObject["company_authorization"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1AccountsPersonsPostRequestFormDocumentsCompanyAuthorizationX6b0cface>(
                                it,
                            )
                    },
                passport =
                    rawObject["passport"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPersonsPostRequestFormDocumentsPassportXc3eba63f>(it)
                    },
                visa =
                    rawObject["visa"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPersonsPostRequestFormDocumentsVisaXa6fe99c3>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPersonsPostRequestFormDocumentsXda797a7a,
        ) {
...
public fun inlineV1AccountsPersonsPostRequestFormDocumentsXda797a7a(
    block: InlineV1AccountsPersonsPostRequestFormDocumentsXda797a7a.Builder.() -> Unit,
): InlineV1AccountsPersonsPostRequestFormDocumentsXda797a7a =
    InlineV1AccountsPersonsPostRequestFormDocumentsXda797a7a.build(block)
