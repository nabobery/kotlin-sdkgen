...
public class InlineV1PaymentMethodConfigurationsPostRequestFormCustomerBalanceXbc03bc44(
    public val displayPreference: InlineV1PaymentMethodConfidc49PostRequestFormDisplayPreferenceX25e911b3? = null,
) {
    public class Builder {
        public var displayPreference:
            InlineV1PaymentMethodConfidc49PostRequestFormDisplayPreferenceX25e911b3? = null

        public fun build(): InlineV1PaymentMethodConfigurationsPostRequestFormCustomerBalanceXbc03bc44 =
            InlineV1PaymentMethodConfigurationsPostRequestFormCustomerBalanceXbc03bc44(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentMethodConfigurationsPostRequestFormCustomerBalanceXbc03bc44 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1PaymentMethodConfigurationsPostRequestFormCustomerBalanceXbc03bc44> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentMethodConfigurationsPostRequestFormCustomerBalanceXbc03bc44 must be a JSON object",
                    )
            return InlineV1PaymentMethodConfigurationsPostRequestFormCustomerBalanceXbc03bc44(
                displayPreference =
                    rawObject["display_preference"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentMethodConfidc49PostRequestFormDisplayPreferenceX25e911b3>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentMethodConfigurationsPostRequestFormCustomerBalanceXbc03bc44,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentMethodConfigurationsPostRequestFormCustomerBalanceXbc03bc44(
    block: InlineV1PaymentMethodConfigurationsPostRequestFormCustomerBalanceXbc03bc44.Builder.() -> Unit,
): InlineV1PaymentMethodConfigurationsPostRequestFormCustomerBalanceXbc03bc44 =
