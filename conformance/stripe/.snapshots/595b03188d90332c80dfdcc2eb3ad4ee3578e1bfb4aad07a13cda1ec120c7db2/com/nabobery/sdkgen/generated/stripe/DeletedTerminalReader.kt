        ...
        override fun deserialize(decoder: Decoder): DeletedTerminalReader {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("DeletedTerminalReader must be a JSON object")
            val deleted = json.decodeRequired<Boolean>(rawObject, "deleted")
            val deviceType =
                json.decodeRequired<InlineDeletedTerminalReaderDeviceTypeX5fd400f5>(
                    rawObject,
                    "device_type",
                )
...
public fun deletedTerminalReader(block: DeletedTerminalReader.Builder.() -> Unit): DeletedTerminalReader =
    DeletedTerminalReader.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("DeletedTerminalReader is missing required property '" + name + "'")
