...
public class TreasuryTransactionsResourceAbstractTransactionResourceStatusTransitions(
    ...
    public class Builder {
        ...
        public fun build(): TreasuryTransactionsResourceAbstractTransactionResourceStatusTransitions =
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): TreasuryTransactionsResourceAbstractTransactionResourceStatusTransitions = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<TreasuryTransactionsResourceAbstractTransactionResourceStatusTransitions> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "TreasuryTransactionsResourceAbstractTransactionResourceStatusTransitions must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: TreasuryTransactionsResourceAbstractTransactionResourceStatusTransitions,
        ) {
            val jsonEncoder =
...
public fun treasuryTransactionsResourceAbstractTransactionResourceStatusTransitions(
    block: TreasuryTransactionsResourceAbstractTransactionResourceStatusTransitions.Builder.() -> Unit,
): TreasuryTransactionsResourceAbstractTransactionResourceStatusTransitions =
    TreasuryTransactionsResourceAbstractTransactionResourceStatusTransitions.build(block)
