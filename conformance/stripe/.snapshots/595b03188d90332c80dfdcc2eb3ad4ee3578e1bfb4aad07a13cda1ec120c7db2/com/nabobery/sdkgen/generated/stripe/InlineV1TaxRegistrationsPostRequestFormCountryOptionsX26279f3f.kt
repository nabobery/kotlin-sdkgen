...
public class InlineV1TaxRegistrationsPostRequestFormCountryOptionsX26279f3f(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1TaxRegistrationsPostRequestFormCountryOptionsX26279f3f =
            InlineV1TaxRegistrationsPostRequestFormCountryOptionsX26279f3f(
                ae = ae,
                al = al,
                am = am,
                ao = ao,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TaxRegistrationsPostRequestFormCountryOptionsX26279f3f =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TaxRegistrationsPostRequestFormCountryOptionsX26279f3f> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TaxRegistrationsPostRequestFormCountryOptionsX26279f3f must be a JSON object",
                    )
            return InlineV1TaxRegistrationsPostRequestFormCountryOptionsX26279f3f(
                ae =
                    rawObject["ae"]?.let {
                        json.decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsAeX4a371c34>(it)
                    },
                al =
                    rawObject["al"]?.let {
                        json.decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsAlX5d937e7d>(it)
                    },
                am =
                    rawObject["am"]?.let {
                        json.decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsAmX9de82f79>(it)
                    },
                ao =
                    rawObject["ao"]?.let {
                        json.decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsAoX9f7ab562>(it)
                    },
                at =
                    rawObject["at"]?.let {
                        json.decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsAtX3448af85>(it)
                    },
                au =
                    rawObject["au"]?.let {
                        json.decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsAuX90206ae9>(it)
                    },
                aw =
                    rawObject["aw"]?.let {
                        json.decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsAwXa682e6c9>(it)
                    },
                az =
                    rawObject["az"]?.let {
                        json.decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsAzXbf1d5ac3>(it)
                    },
                ba =
                    rawObject["ba"]?.let {
                        json.decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsBaX022f55a3>(it)
                    },
                bb =
                    rawObject["bb"]?.let {
                        json.decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsBbX3c423971>(it)
                    },
                bd =
                    rawObject["bd"]?.let {
                        json.decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsBdXeef5a2db>(it)
                    },
                be =
                    rawObject["be"]?.let {
                        json.decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsBeXbbbd5394>(it)
                    },
                bf =
                    rawObject["bf"]?.let {
                        json.decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsBfX3813f8ea>(it)
                    },
                bg =
                    rawObject["bg"]?.let {
                        json.decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsBgX5250be7d>(it)
                    },
                bh =
                    rawObject["bh"]?.let {
                        json.decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsBhX9505241a>(it)
                    },
                bj =
                    rawObject["bj"]?.let {
                        json.decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsBjXf32e2c77>(it)
                    },
                bs =
                    rawObject["bs"]?.let {
                        json.decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsBsXd6f999bf>(it)
                    },
                by =
                    rawObject["by"]?.let {
                        json.decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsByX937da932>(it)
                    },
                ca =
                    rawObject["ca"]?.let {
                        json.decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsCaX9c53e898>(it)
                    },
                cd =
                    rawObject["cd"]?.let {
                        json.decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsCdX8544aa07>(it)
                    },
                ch =
                    rawObject["ch"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsChXee182dcf>(
                                    it,
                                )
                        },
                cl =
                    rawObject["cl"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsClX163c339d>(
                                    it,
                                )
                        },
                cm =
                    rawObject["cm"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsCmX9fa0d695>(
                                    it,
                                )
                        },
                co =
                    rawObject["co"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsCoX9369899a>(
                                    it,
                                )
                        },
                cr =
                    rawObject["cr"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsCrX3031e896>(
                                    it,
                                )
                        },
                cv =
                    rawObject["cv"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsCvXe5cfa34b>(
                                    it,
                                )
                        },
                cy =
                    rawObject["cy"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsCyXc29a3821>(
                                    it,
                                )
                        },
                cz =
                    rawObject["cz"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsCzX2eb93c2c>(
                                    it,
                                )
                        },
                de =
                    rawObject["de"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsDeXd1582919>(
                                    it,
                                )
                        },
                dk =
                    rawObject["dk"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsDkX1d61896a>(
                                    it,
                                )
                        },
                ec =
                    rawObject["ec"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsEcXa0b60076>(
                                    it,
                                )
                        },
                ee =
                    rawObject["ee"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsEeXa80f8e8c>(
                                    it,
                                )
                        },
                eg =
                    rawObject["eg"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsEgX65bb55f0>(
                                    it,
                                )
                        },
                es =
                    rawObject["es"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsEsX38daea55>(
                                    it,
                                )
                        },
                et =
                    rawObject["et"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsEtX5df896f1>(
                                    it,
                                )
                        },
                fi =
                    rawObject["fi"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsFiX473f840a>(
                                    it,
                                )
                        },
                fr =
                    rawObject["fr"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsFrX12ce88fb>(
                                    it,
                                )
                        },
                gb =
                    rawObject["gb"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsGbX6b70e2dd>(
                                    it,
                                )
                        },
                ge =
                    rawObject["ge"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsGeX84c8bd9c>(
                                    it,
                                )
                        },
                gn =
                    rawObject["gn"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsGnX0684131c>(
                                    it,
                                )
                        },
                gr =
                    rawObject["gr"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsGrX8b2978c4>(
                                    it,
                                )
                        },
                hr =
                    rawObject["hr"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsHrX3149287e>(
                                    it,
                                )
                        },
                hu =
                    rawObject["hu"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsHuXcabe40a7>(
                                    it,
                                )
                        },
                id =
                    rawObject["id"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsIdXce269fac>(
                                    it,
                                )
                        },
                ie =
                    rawObject["ie"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsIeX0dd512c4>(
                                    it,
                                )
                        },
                inValue =
                    rawObject["in"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsInValueX6f675bd2>(
                                    it,
                                )
                        },
                isValue =
                    rawObject["is"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsIsValueX898ebfc3>(
                                    it,
                                )
                        },
                it =
                    rawObject["it"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsItX110877a5>(
                                    it,
                                )
                        },
                jp =
                    rawObject["jp"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsJpX2da4f362>(
                                    it,
                                )
                        },
                ke =
                    rawObject["ke"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsKeXd5bb3a6b>(
                                    it,
                                )
                        },
                kg =
                    rawObject["kg"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsKgX2111e400>(
                                    it,
                                )
                        },
                kh =
                    rawObject["kh"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsKhX60d48d83>(
                                    it,
                                )
                        },
                kr =
                    rawObject["kr"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsKrX34c01240>(
                                    it,
                                )
                        },
                kz =
                    rawObject["kz"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsKzXfab3d420>(
                                    it,
                                )
                        },
                la =
                    rawObject["la"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsLaXea61ab24>(
                                    it,
                                )
                        },
                lk =
                    rawObject["lk"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsLkX8fc9c26f>(
                                    it,
                                )
                        },
                lt =
                    rawObject["lt"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsLtXf1eac8a8>(
                                    it,
                                )
                        },
                lu =
                    rawObject["lu"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsLuX49a06c92>(
                                    it,
                                )
                        },
                lv =
                    rawObject["lv"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsLvX5a1c74d6>(
                                    it,
                                )
                        },
                ma =
                    rawObject["ma"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsMaXd6f1c44a>(
                                    it,
                                )
                        },
                md =
                    rawObject["md"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsMdX141d00aa>(
                                    it,
                                )
                        },
                me =
                    rawObject["me"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsMeXf162aaeb>(
                                    it,
                                )
                        },
                mk =
                    rawObject["mk"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsMkX7cdaab79>(
                                    it,
                                )
                        },
                mr =
                    rawObject["mr"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsMrX7ec42afc>(
                                    it,
                                )
                        },
                mt =
                    rawObject["mt"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsMtX54e2e526>(
                                    it,
                                )
                        },
                mx =
                    rawObject["mx"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsMxXab96b987>(
                                    it,
                                )
                        },
                my =
                    rawObject["my"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsMyXec30ce6d>(
                                    it,
                                )
                        },
                ng =
                    rawObject["ng"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsNgX02a331fc>(
                                    it,
                                )
                        },
                nl =
                    rawObject["nl"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsNlX79ba8edf>(
                                    it,
                                )
                        },
                no =
                    rawObject["no"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsNoX739993a4>(
                                    it,
                                )
                        },
                np =
                    rawObject["np"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsNpXade1c160>(
                                    it,
                                )
                        },
                nz =
                    rawObject["nz"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsNzX61832d1e>(
                                    it,
                                )
                        },
                om =
                    rawObject["om"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsOmXd1efc86b>(
                                    it,
                                )
                        },
                pe =
                    rawObject["pe"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsPeXd675dc3f>(
                                    it,
                                )
                        },
                ph =
                    rawObject["ph"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsPhXd8a91a84>(
                                    it,
                                )
                        },
                pl =
                    rawObject["pl"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsPlX6d6f9312>(
                                    it,
                                )
                        },
                pt =
                    rawObject["pt"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsPtX419f8cb1>(
                                    it,
                                )
                        },
                ro =
                    rawObject["ro"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsRoX9d84d85a>(
                                    it,
                                )
                        },
                rs =
                    rawObject["rs"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsRsX42af46e6>(
                                    it,
                                )
                        },
                ru =
                    rawObject["ru"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsRuX2a33e159>(
                                    it,
                                )
                        },
                sa =
                    rawObject["sa"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsSaX6fb8998d>(
                                    it,
                                )
                        },
                se =
                    rawObject["se"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsSeXbf7b352b>(
                                    it,
                                )
                        },
                sg =
                    rawObject["sg"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsSgX61a30942>(
                                    it,
                                )
                        },
                si =
                    rawObject["si"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsSiXcaafcd68>(
                                    it,
                                )
                        },
                sk =
                    rawObject["sk"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsSkXf4ae1950>(
                                    it,
                                )
                        },
                sn =
                    rawObject["sn"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsSnXa398808c>(
                                    it,
                                )
                        },
                sr =
                    rawObject["sr"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsSrX41805b17>(
                                    it,
                                )
                        },
                th =
                    rawObject["th"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsThX0eac37f1>(
                                    it,
                                )
                        },
                tj =
                    rawObject["tj"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsTjX88e65f38>(
                                    it,
                                )
                        },
                tr =
                    rawObject["tr"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsTrXb43b5199>(
                                    it,
                                )
                        },
                tw =
                    rawObject["tw"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsTwXf7ca1c3b>(
                                    it,
                                )
                        },
                tz =
                    rawObject["tz"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsTzXa8612bc9>(
                                    it,
                                )
                        },
                ua =
                    rawObject["ua"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsUaXc13bf01a>(
                                    it,
                                )
                        },
                ug =
                    rawObject["ug"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsUgXcfbab590>(
                                    it,
                                )
                        },
                us =
                    rawObject["us"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsUsXcc5d9e63>(
                                    it,
                                )
                        },
                uy =
                    rawObject["uy"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsUyXa16d8e25>(
                                    it,
                                )
                        },
                uz =
                    rawObject["uz"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsUzXe654460d>(
                                    it,
                                )
                        },
                vn =
                    rawObject["vn"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsVnX4ce511d0>(
                                    it,
                                )
                        },
                za =
                    rawObject["za"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsZaX2acbc344>(
                                    it,
                                )
                        },
                zm =
                    rawObject["zm"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsZmX72d0d00f>(
                                    it,
                                )
                        },
                zw =
                    rawObject["zw"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsZwXfee2dd95>(
                                    it,
                                )
                        },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TaxRegistrationsPostRequestFormCountryOptionsX26279f3f,
        ) {
            val jsonEncoder =
...
public fun inlineV1TaxRegistrationsPostRequestFormCountryOptionsX26279f3f(
    block: InlineV1TaxRegistrationsPostRequestFormCountryOptionsX26279f3f.Builder.() -> Unit,
): InlineV1TaxRegistrationsPostRequestFormCountryOptionsX26279f3f =
    InlineV1TaxRegistrationsPostRequestFormCountryOptionsX26279f3f.build(block)
