...
public class InlineV1InvoicesCreatePreviewPostRequestFormRecurringXe262fbc6(
    public val interval: InlineV1InvoicesCreatePreviewPostRequestFormSubscriptionDetailsIntervalXa164a440,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1InvoicesCreatePreviewPostRequestFormRecurringXe262fbc6 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1InvoicesCreatePreviewPostRequestFormRecurringXe262fbc6> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1InvoicesCreatePreviewPostRequestFormRecurringXe262fbc6 {
            val jsonDecoder =
                decoder.requireJsonDecoder(
                    "InlineV1InvoicesCreatePreviewPostRequestFormRecurringXe262fbc6",
                )
            val json = jsonDecoder.json
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1InvoicesCreatePreviewPostRequestFormRecurringXe262fbc6 must be a JSON object",
                    )
            val interval =
                json
                    .decodeRequired<InlineV1InvoicesCreatePreviewPostRequestFormSubscriptionDetailsIntervalXa164a440>(
                        rawObject,
                        "interval",
                    )
            return InlineV1InvoicesCreatePreviewPostRequestFormRecurringXe262fbc6(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesCreatePreviewPostRequestFormRecurringXe262fbc6,
        ) {
            val jsonEncoder =
...
public fun inlineV1InvoicesCreatePreviewPostRequestFormRecurringXe262fbc6(
    block: InlineV1InvoicesCreatePreviewPostRequestFormRecurringXe262fbc6.Builder.() -> Unit,
): InlineV1InvoicesCreatePreviewPostRequestFormRecurringXe262fbc6 =
    InlineV1InvoicesCreatePreviewPostRequestFormRecurringXe262fbc6.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1InvoicesCreatePreviewPostRequestFormRecurringXe262fbc6 is missing required property '" + name +
                    "'",
            )
