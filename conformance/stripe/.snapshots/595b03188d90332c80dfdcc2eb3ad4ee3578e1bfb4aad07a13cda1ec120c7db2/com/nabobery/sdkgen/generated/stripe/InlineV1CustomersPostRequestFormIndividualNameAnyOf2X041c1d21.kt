...
public sealed class InlineV1CustomersPostRequestFormIndividualNameAnyOf2X041c1d21 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1CustomersPostRequestFormIndividualNameAnyOf2X041c1d21 =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1CustomersPostRequestFormIndividualNameAnyOf2X041c1d21> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1CustomersPostRequestFormIndividualNameAnyOf2X041c1d21",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1CustomersPostRequestFormIndividualNameAnyOf2X041c1d21 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersPostRequestFormIndividualNameAnyOf2X041c1d21,
        ) {
