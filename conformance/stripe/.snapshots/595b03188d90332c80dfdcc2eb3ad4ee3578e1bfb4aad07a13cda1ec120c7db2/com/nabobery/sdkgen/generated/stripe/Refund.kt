        ...
        override fun deserialize(decoder: Decoder): Refund {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("Refund must be a JSON object")
            ...
            return Refund(
                ...
                balanceTransaction =
                    rawObject["balance_transaction"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineRefundBalanceTransactionX2601d96f?>(element)
                        }
                    },
                charge =
                    rawObject["charge"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineRefundChargeX53a8a3db?>(element)
                        }
                    },
                description = rawObject["description"]?.let { json.decodeFromJsonElement<String>(it) },
                destinationDetails =
                    rawObject["destination_details"]?.let {
                        json
                            .decodeFromJsonElement<RefundDestinationDetails>(
                                it,
                            )
                    },
                failureBalanceTransaction =
                    rawObject["failure_balance_transaction"]?.let {
                        json.decodeFromJsonElement<InlineRefundFailureBalanceTransactionX88292ff3>(it)
                    },
                ...
                paymentIntent =
                    rawObject["payment_intent"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineRefundPaymentIntentX781629cd?>(element)
                        }
                    },
                pendingReason =
                    rawObject["pending_reason"]?.let {
                        json
                            .decodeFromJsonElement<InlineRefundPendingReasonX2f7bc196>(
                                it,
                            )
                    },
                presentmentDetails =
                ...
                reason =
                    rawObject["reason"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineRefundReasonXe77231eb?>(element)
                        }
                    },
                receiptNumber =
                ...
                sourceTransferReversal =
                    rawObject["source_transfer_reversal"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineRefundSourceTransferReversalX9b844182?>(element)
                        }
                    },
                status =
                ...
                transferReversal =
                    rawObject["transfer_reversal"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineRefundTransferReversalX400a6508?>(element)
                        }
                    },
            )
        }
