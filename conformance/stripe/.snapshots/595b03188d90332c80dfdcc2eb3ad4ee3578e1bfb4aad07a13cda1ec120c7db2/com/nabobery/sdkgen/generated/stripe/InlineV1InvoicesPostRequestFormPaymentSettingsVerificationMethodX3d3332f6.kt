    ...
    public object Serializer : KSerializer<InlineV1InvoicesPostRequestFormPaymentSettingsVerificationMethodX3d3332f6> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1InvoicesPostRequestFormPaymentSettingsVerificationMethodX3d3332f6",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1InvoicesPostRequestFormPaymentSettingsVerificationMethodX3d3332f6 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesPostRequestFormPaymentSettingsVerificationMethodX3d3332f6,
        ) {
