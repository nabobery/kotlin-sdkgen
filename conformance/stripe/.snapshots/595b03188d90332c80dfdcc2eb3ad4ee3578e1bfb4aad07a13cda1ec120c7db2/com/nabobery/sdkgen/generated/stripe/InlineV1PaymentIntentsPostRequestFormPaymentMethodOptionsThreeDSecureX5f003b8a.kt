...
public class InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsThreeDSecureX5f003b8a(
    ...
    public val exemptionIndicator: InlineV1PaymentIntentsPostRequestFormExemptionIndicatorX1f8a7819? = null,
    public val networkOptions: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsNetworkOptionsX2223f201? = null,
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsThreeDSecureX5f003b8a> {
        ...
        override fun deserialize(
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsThreeDSecureX5f003b8a must be a JSON object",
                    )
            ...
            val version =
                json.decodeRequired<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsCardVersionXbb14d8f6>(
                    rawObject,
                    "version",
                )
            return InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsThreeDSecureX5f003b8a(
                ...
                aresTransStatus =
                    rawObject["ares_trans_status"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormAresTransStatusXadd670f0>(it)
                    },
                electronicCommerceIndicator =
                    rawObject["electronic_commerce_indicator"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormElectronicCommerceIn67d5Xe3b3f99e>(
                                it,
                            )
                    },
                exemptionIndicator =
                    rawObject["exemption_indicator"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormExemptionIndicatorX1f8a7819>(it)
                    },
                networkOptions =
                    rawObject["network_options"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsNetworkOptionsX2223f201>(
                                it,
                            )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsThreeDSecureX5f003b8a,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsThreeDSecureX5f003b8a(
    block: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsThreeDSecureX5f003b8a.Builder.() -> Unit,
): InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsThreeDSecureX5f003b8a =
    InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsThreeDSecureX5f003b8a.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsThreeDSecureX5f003b8a is missing required property '" +
                    name +
                    "'",
            )
