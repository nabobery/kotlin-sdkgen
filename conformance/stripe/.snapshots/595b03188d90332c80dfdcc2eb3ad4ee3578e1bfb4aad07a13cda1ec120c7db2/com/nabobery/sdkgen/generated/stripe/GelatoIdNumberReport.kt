...
public class GelatoIdNumberReport(
    ...
    public object Serializer : KSerializer<GelatoIdNumberReport> {
        ...
        override fun deserialize(decoder: Decoder): GelatoIdNumberReport {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("GelatoIdNumberReport must be a JSON object")
                ...
                dob =
                    rawObject["dob"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineGelatoIdNumberReportDobX526193ce?>(element)
                        }
                    },
                error =
                    rawObject["error"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineGelatoIdNumberReportErrorX4ba663b0?>(element)
                        }
                    },
                firstName =
                ...
                idNumberType =
                    rawObject["id_number_type"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineGelatoIdNumberReportIdNumberTypeX5d9135a3?>(element)
                        }
                    },
                lastName =
...
public fun gelatoIdNumberReport(block: GelatoIdNumberReport.Builder.() -> Unit): GelatoIdNumberReport =
    GelatoIdNumberReport.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("GelatoIdNumberReport is missing required property '" + name + "'")
