...
public class PaymentMethodDetailsPaymentRecordOxxo(
    ...
    public class Builder {
        ...
        public fun build(): PaymentMethodDetailsPaymentRecordOxxo =
            PaymentMethodDetailsPaymentRecordOxxo(
                number = number,
            )
    }

    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentMethodDetailsPaymentRecordOxxo =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentMethodDetailsPaymentRecordOxxo> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodDetailsPaymentRecordOxxo {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodDetailsPaymentRecordOxxo must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentMethodDetailsPaymentRecordOxxo,
        ) {
...
public fun paymentMethodDetailsPaymentRecordOxxo(
    block: PaymentMethodDetailsPaymentRecordOxxo.Builder.() -> Unit,
): PaymentMethodDetailsPaymentRecordOxxo = PaymentMethodDetailsPaymentRecordOxxo.build(block)
