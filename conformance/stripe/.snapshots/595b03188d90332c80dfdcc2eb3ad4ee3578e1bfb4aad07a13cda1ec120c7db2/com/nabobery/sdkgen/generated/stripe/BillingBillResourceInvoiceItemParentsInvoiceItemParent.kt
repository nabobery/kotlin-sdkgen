...
public data class BillingBillResourceInvoiceItemParentsInvoiceItemParentView(
    ...
    public val subscriptionDetails: InlineBillingBillResourceI4934SubscriptionDetailsX69eb365a? = null,
...
public class BillingBillResourceInvoiceItemParentsInvoiceItemParent(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): BillingBillResourceInvoiceItemParentsInvoiceItemParent =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<BillingBillResourceInvoiceItemParentsInvoiceItemParent> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "BillingBillResourceInvoiceItemParentsInvoiceItemParent must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineBillingBillResourceInvoiceItemParentsInvoiceItemParentTypeX0bce03c4>(
                    rawObject,
                    "type",
                )
            return BillingBillResourceInvoiceItemParentsInvoiceItemParent(
                ...
                subscriptionDetails =
                    rawObject["subscription_details"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineBillingBillResourceI4934SubscriptionDetailsX69eb365a?>(
                                element,
                            )
                        }
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: BillingBillResourceInvoiceItemParentsInvoiceItemParent,
        ) {
...
public fun billingBillResourceInvoiceItemParentsInvoiceItemParent(
    block: BillingBillResourceInvoiceItemParentsInvoiceItemParent.Builder.() -> Unit,
): BillingBillResourceInvoiceItemParentsInvoiceItemParent =
    BillingBillResourceInvoiceItemParentsInvoiceItemParent.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "BillingBillResourceInvoiceItemParentsInvoiceItemParent is missing required property '" + name + "'",
            )
