...
public class InlineV1CustomersSubscriptionsPostRequestFormInvoiceSettingsItemX2e722870(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1CustomersSubscriptionsPostRequestFormInvoiceSettingsItemX2e722870 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1CustomersSubscriptionsPostRequestFormInvoiceSettingsItemX2e722870> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CustomersSubscriptionsPostRequestFormInvoiceSettingsItemX2e722870 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersSubscriptionsPostRequestFormInvoiceSettingsItemX2e722870,
        ) {
            val jsonEncoder =
...
public fun inlineV1CustomersSubscriptionsPostRequestFormInvoiceSettingsItemX2e722870(
    block: InlineV1CustomersSubscriptionsPostRequestFormInvoiceSettingsItemX2e722870.Builder.() -> Unit,
): InlineV1CustomersSubscriptionsPostRequestFormInvoiceSettingsItemX2e722870 =
    InlineV1CustomersSubscriptionsPostRequestFormInvoiceSettingsItemX2e722870.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1CustomersSubscriptionsPostRequestFormInvoiceSettingsItemX2e722870 is missing required property '" +
                    name +
                    "'",
            )
