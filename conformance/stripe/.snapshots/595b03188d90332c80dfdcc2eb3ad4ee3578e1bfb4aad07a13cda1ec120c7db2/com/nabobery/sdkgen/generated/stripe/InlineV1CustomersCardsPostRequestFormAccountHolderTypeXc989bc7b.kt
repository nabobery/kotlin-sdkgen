...
public sealed class InlineV1CustomersCardsPostRequestFormAccountHolderTypeXc989bc7b {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1CustomersCardsPostRequestFormAccountHolderTypeXc989bc7b =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1CustomersCardsPostRequestFormAccountHolderTypeXc989bc7b> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1CustomersCardsPostRequestFormAccountHolderTypeXc989bc7b",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1CustomersCardsPostRequestFormAccountHolderTypeXc989bc7b =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersCardsPostRequestFormAccountHolderTypeXc989bc7b,
        ) {
