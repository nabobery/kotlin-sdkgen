...
public sealed class InlineLinkedAccountOptionsCommonPermissionsItemX23a646ba {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineLinkedAccountOptionsCommonPermissionsItemX23a646ba =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineLinkedAccountOptionsCommonPermissionsItemX23a646ba> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineLinkedAccountOptionsCommonPermissionsItemX23a646ba",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineLinkedAccountOptionsCommonPermissionsItemX23a646ba =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineLinkedAccountOptionsCommonPermissionsItemX23a646ba,
        ) {
