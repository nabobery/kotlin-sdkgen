...
public class PortalLoginPage(
    ...
    public object Serializer : KSerializer<PortalLoginPage> {
        ...
        override fun deserialize(decoder: Decoder): PortalLoginPage {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PortalLoginPage must be a JSON object")
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("PortalLoginPage is missing required property '" + name + "'")
