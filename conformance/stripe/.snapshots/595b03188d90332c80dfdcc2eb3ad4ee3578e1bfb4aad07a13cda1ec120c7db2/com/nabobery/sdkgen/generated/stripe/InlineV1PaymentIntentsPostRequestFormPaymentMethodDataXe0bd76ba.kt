...
public class InlineV1PaymentIntentsPostRequestFormPaymentMethodDataXe0bd76ba(
    ...
    public val acssDebit: InlineV1PaymentIntentsPostRequestFormPaymentMethodDataAcssDebitXfa05ea49? = null,
    public val affirm: JsonObject? = null,
    public val afterpayClearpay: JsonObject? = null,
    public val alipay: JsonObject? = null,
    public val allowRedisplay: InlineV1PaymentIntentsPostRequestFormPaymentMethodDataAllowRedisplayXada9525b? = null,
    public val alma: JsonObject? = null,
    public val amazonPay: JsonObject? = null,
    public val auBecsDebit: InlineV1PaymentIntentsPostRequestFormPaymentMethodDataAuBecsDebitX80b01afd? = null,
    public val bacsDebit: InlineV1PaymentIntentsPostRequestFormPaymentMethodDataBacsDebitXafd7c9f2? = null,
    public val bancontact: JsonObject? = null,
    public val billie: JsonObject? = null,
    public val billingDetails: InlineV1PaymentIntentsPostRequestFormPaymentMethodDataBillingDetailsX7150351e? = null,
    ...
    public val naverPay: InlineV1PaymentIntentsPostRequestFormPaymentMethodDataNaverPayXd162f8c0? = null,
    public val nzBankAccount: InlineV1PaymentIntentsPostRequestFormPaymentMethodDataNzBankAccountXccf4ebef? = null,
    ...
    public val radarOptions: InlineV1PaymentIntentsPostRequestFormPaymentMethodDataRadarOptionsX04473462? = null,
    ...
    public val sepaDebit: InlineV1PaymentIntentsPostRequestFormPaymentMethodDataSepaDebitXb3187e7d? = null,
    ...
    public val usBankAccount: InlineV1PaymentIntentsPostRequestFormPaymentMethodDataUsBankAccountXea50d12b? = null,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PaymentIntentsPostRequestFormPaymentMethodDataXe0bd76ba =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormPaymentMethodDataXe0bd76ba> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1PaymentIntentsPostRequestFormPaymentMethodDataXe0bd76ba {
            val jsonDecoder =
                decoder.requireJsonDecoder(
                    "InlineV1PaymentIntentsPostRequestFormPaymentMethodDataXe0bd76ba",
                )
            val json = jsonDecoder.json
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsPostRequestFormPaymentMethodDataXe0bd76ba must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineV1PaymentIntentsPostRequestFormPaymentMethodDataTypeX2848ed54>(
                    rawObject,
                    "type",
                )
            return InlineV1PaymentIntentsPostRequestFormPaymentMethodDataXe0bd76ba(
                ...
                acssDebit =
                    rawObject["acss_debit"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodDataAcssDebitXfa05ea49>(
                                it,
                            )
                    },
                ...
                allowRedisplay =
                    rawObject["allow_redisplay"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodDataAllowRedisplayXada9525b>(
                                it,
                            )
                    },
                ...
                auBecsDebit =
                    rawObject["au_becs_debit"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodDataAuBecsDebitX80b01afd>(
                                it,
                            )
                    },
                bacsDebit =
                    rawObject["bacs_debit"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodDataBacsDebitXafd7c9f2>(
                                it,
                            )
                    },
                ...
                billingDetails =
                    rawObject["billing_details"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodDataBillingDetailsX7150351e>(
                                it,
                            )
                    },
                ...
                boleto =
                    rawObject["boleto"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodDataBoletoX4f8ac3f4>(
                                it,
                            )
                    },
                ...
                eps =
                    rawObject["eps"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodDataEpsX78d815c7>(
                            it,
                        )
                    },
                fpx =
                    rawObject["fpx"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodDataFpxXa855808d>(
                            it,
                        )
                    },
                ...
                ideal =
                    rawObject["ideal"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodDataIdealX9af01c84>(
                                it,
                            )
                    },
                ...
                klarna =
                    rawObject["klarna"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodDataKlarnaXf43b26c3>(
                                it,
                            )
                    },
                ...
                naverPay =
                    rawObject["naver_pay"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodDataNaverPayXd162f8c0>(
                                it,
                            )
                    },
                nzBankAccount =
                    rawObject["nz_bank_account"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodDataNzBankAccountXccf4ebef>(
                                it,
                            )
                    },
                ...
                p24 =
                    rawObject["p24"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodDataP24Xa9c94549>(
                            it,
                        )
                    },
                ...
                payto =
                    rawObject["payto"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodDataPaytoXf7bd4599>(
                                it,
                            )
                    },
                ...
                radarOptions =
                    rawObject["radar_options"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodDataRadarOptionsX04473462>(
                                it,
                            )
                    },
                ...
                sepaDebit =
                    rawObject["sepa_debit"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodDataSepaDebitXb3187e7d>(
                                it,
                            )
                    },
                sofort =
                    rawObject["sofort"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodDataSofortX4cae65f8>(
                                it,
                            )
                    },
                ...
                upi =
                    rawObject["upi"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodDataUpiX270467f7>(
                            it,
                        )
                    },
                usBankAccount =
                    rawObject["us_bank_account"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodDataUsBankAccountXea50d12b>(
                                it,
                            )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormPaymentMethodDataXe0bd76ba,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentIntentsPostRequestFormPaymentMethodDataXe0bd76ba(
    block: InlineV1PaymentIntentsPostRequestFormPaymentMethodDataXe0bd76ba.Builder.() -> Unit,
): InlineV1PaymentIntentsPostRequestFormPaymentMethodDataXe0bd76ba =
    InlineV1PaymentIntentsPostRequestFormPaymentMethodDataXe0bd76ba.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentIntentsPostRequestFormPaymentMethodDataXe0bd76ba is missing required property '" + name +
                    "'",
            )
