...
public class InlineBankConnectionsResourceAccountholderCustomerX6b1e2861 internal constructor(
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineBankConnectionsResourceAccountholderCustomerX6b1e2861Branch.Branch1,
                    )
                }
                if (inspection.matchesCustomer) {
                    add(
                        InlineBankConnectionsResourceAccountholderCustomerX6b1e2861Branch.Customer,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineBankConnectionsResourceAccountholderCustomerX6b1e2861 {
            val inspection = inspectInlineBankConnectionsResourceAccountholderCustomerX6b1e2861(raw)
            if (inspection.matchCount == 0) {
                throw InlineBankConnectionsResourceAccountholderCustomerX6b1e2861NoMatchException(
                    "InlineBankConnectionsResourceAccountholderCustomerX6b1e2861 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineBankConnectionsResourceAccountholderCustomerX6b1e2861> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineBankConnectionsResourceAccountholderCustomerX6b1e2861,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineBankConnectionsResourceAccountholderCustomerX6b1e2861",
...
private fun inspectInlineBankConnectionsResourceAccountholderCustomerX6b1e2861(
    element: JsonElement,
): InlineBankConnectionsResourceAccountholderCustomerX6b1e2861Inspection {
