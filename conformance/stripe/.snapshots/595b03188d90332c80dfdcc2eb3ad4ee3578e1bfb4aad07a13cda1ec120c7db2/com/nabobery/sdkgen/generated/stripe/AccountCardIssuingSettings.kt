...
public class AccountCardIssuingSettings(
    ...
    public class Builder {
        ...
        public fun build(): AccountCardIssuingSettings =
    ...
    public object Serializer : KSerializer<AccountCardIssuingSettings> {
        ...
        override fun deserialize(decoder: Decoder): AccountCardIssuingSettings {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("AccountCardIssuingSettings must be a JSON object")
            return AccountCardIssuingSettings(
                tosAcceptance =
                    rawObject["tos_acceptance"]?.let {
                        json.decodeFromJsonElement<CardIssuingAccountTermsOfService>(
                            it,
                        )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: AccountCardIssuingSettings,
        ) {
...
public fun accountCardIssuingSettings(
    block: AccountCardIssuingSettings.Builder.() -> Unit,
): AccountCardIssuingSettings = AccountCardIssuingSettings.build(block)
