...
public class InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemsRecurringXb03f15f8(
    public val interval: InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemsItemIntervalX1d9f81f3,
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemsRecurringXb03f15f8> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemsRecurringXb03f15f8 must be a JSON object",
                    )
            val interval =
                json
                    .decodeRequired<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemsItemIntervalX1d9f81f3>(
                        rawObject,
                        "interval",
                    )
            return InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemsRecurringXb03f15f8(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemsRecurringXb03f15f8,
        ) {
            val jsonEncoder =
...
public fun inlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemsRecurringXb03f15f8(
    block: InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemsRecurringXb03f15f8.Builder.() -> Unit,
): InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemsRecurringXb03f15f8 =
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemsRecurringXb03f15f8 is missing required property '" +
                    name +
                    "'",
            )
