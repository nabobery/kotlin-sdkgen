...
public sealed class InlineThreeDSecureDetailsElectronicCommerceIndicatorX3d6885c0 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineThreeDSecureDetailsElectronicCommerceIndicatorX3d6885c0 =
            when (value) {
                _01.value -> _01
                _02.value -> _02
                _05.value -> _05
    ...
    public object Serializer : KSerializer<InlineThreeDSecureDetailsElectronicCommerceIndicatorX3d6885c0> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineThreeDSecureDetailsElectronicCommerceIndicatorX3d6885c0",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineThreeDSecureDetailsElectronicCommerceIndicatorX3d6885c0 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineThreeDSecureDetailsElectronicCommerceIndicatorX3d6885c0,
        ) {
