...
public class InlineV1TaxTransactionsCreateReversalPostRequestFormX5e009492(
     ...
     */
    public val lineItems: List<InlineV1TaxTransactionsCreateReversalPostRequestFormLineItemsItemX750499bb>? = null,
    /**
     ...
     */
    public val shippingCost: InlineV1TaxTransactionsCreateReversalPostRequestFormShippingCostXf7eccb3f? = null,
) {
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TaxTransactionsCreateReversalPostRequestFormX5e009492 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TaxTransactionsCreateReversalPostRequestFormX5e009492> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1TaxTransactionsCreateReversalPostRequestFormX5e009492 {
            val jsonDecoder =
                decoder.requireJsonDecoder(
                    "InlineV1TaxTransactionsCreateReversalPostRequestFormX5e009492",
                )
            val json = jsonDecoder.json
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TaxTransactionsCreateReversalPostRequestFormX5e009492 must be a JSON object",
                    )
            val mode =
                json.decodeRequired<InlineV1TaxTransactionsCreateReversalPostRequestFormModeX191d5fce>(
                    rawObject,
                    "mode",
                )
            ...
            return InlineV1TaxTransactionsCreateReversalPostRequestFormX5e009492(
                ...
                lineItems =
                    rawObject["line_items"]?.let {
                        json
                            .decodeFromJsonElement<List<InlineV1TaxTransactionsCreateReversalPostRequestFormLineItemsItemX750499bb>>(
                                it,
                            )
                    },
                ...
                shippingCost =
                    rawObject["shipping_cost"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TaxTransactionsCreateReversalPostRequestFormShippingCostXf7eccb3f>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TaxTransactionsCreateReversalPostRequestFormX5e009492,
        ) {
            val jsonEncoder =
...
public fun inlineV1TaxTransactionsCreateReversalPostRequestFormX5e009492(
    block: InlineV1TaxTransactionsCreateReversalPostRequestFormX5e009492.Builder.() -> Unit,
): InlineV1TaxTransactionsCreateReversalPostRequestFormX5e009492 =
    InlineV1TaxTransactionsCreateReversalPostRequestFormX5e009492.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TaxTransactionsCreateReversalPostRequestFormX5e009492 is missing required property '" + name +
                    "'",
            )
