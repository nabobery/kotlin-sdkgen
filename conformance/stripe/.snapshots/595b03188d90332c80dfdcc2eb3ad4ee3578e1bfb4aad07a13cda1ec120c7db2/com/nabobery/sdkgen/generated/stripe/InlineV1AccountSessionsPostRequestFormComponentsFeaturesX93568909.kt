...
public class InlineV1AccountSessionsPostRequestFormComponentsFeaturesX93568909(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1AccountSessionsPostRequestFormComponentsFeaturesX93568909 =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1AccountSessionsPostRequestFormComponentsFeaturesX93568909 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1AccountSessionsPostRequestFormComponentsFeaturesX93568909> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountSessionsPostRequestFormComponentsFeaturesX93568909 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountSessionsPostRequestFormComponentsFeaturesX93568909,
        ) {
            val jsonEncoder =
...
public fun inlineV1AccountSessionsPostRequestFormComponentsFeaturesX93568909(
    block: InlineV1AccountSessionsPostRequestFormComponentsFeaturesX93568909.Builder.() -> Unit,
): InlineV1AccountSessionsPostRequestFormComponentsFeaturesX93568909 =
    InlineV1AccountSessionsPostRequestFormComponentsFeaturesX93568909.build(block)
