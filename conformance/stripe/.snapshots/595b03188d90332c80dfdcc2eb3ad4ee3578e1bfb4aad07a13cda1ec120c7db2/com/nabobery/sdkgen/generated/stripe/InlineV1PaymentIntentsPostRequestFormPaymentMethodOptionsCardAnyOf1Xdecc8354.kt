...
public class InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsCardAnyOf1Xdecc8354(
    ...
    public val interval: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsCardIntervalX63ad1233? = null,
) {
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsCardAnyOf1Xdecc8354 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsCardAnyOf1Xdecc8354> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsCardAnyOf1Xdecc8354 must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsCardAnyOf1TypeX7dd2e4f0>(
                    rawObject,
                    "type",
                )
            return InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsCardAnyOf1Xdecc8354(
                ...
                interval =
                    rawObject["interval"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsCardIntervalX63ad1233>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsCardAnyOf1Xdecc8354,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsCardAnyOf1Xdecc8354(
    block: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsCardAnyOf1Xdecc8354.Builder.() -> Unit,
): InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsCardAnyOf1Xdecc8354 =
    InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsCardAnyOf1Xdecc8354.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsCardAnyOf1Xdecc8354 is missing required property '" +
                    name +
                    "'",
            )
