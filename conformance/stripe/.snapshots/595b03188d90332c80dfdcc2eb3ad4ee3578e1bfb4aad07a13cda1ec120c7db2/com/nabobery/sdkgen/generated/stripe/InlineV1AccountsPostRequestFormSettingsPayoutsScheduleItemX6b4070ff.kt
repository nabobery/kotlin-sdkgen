...
public sealed class InlineV1AccountsPostRequestFormSettingsPayoutsScheduleItemX6b4070ff {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1AccountsPostRequestFormSettingsPayoutsScheduleItemX6b4070ff =
            when (value) {
                Friday.value -> Friday
                Monday.value -> Monday
    ...
    public object Serializer : KSerializer<InlineV1AccountsPostRequestFormSettingsPayoutsScheduleItemX6b4070ff> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1AccountsPostRequestFormSettingsPayoutsScheduleItemX6b4070ff",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1AccountsPostRequestFormSettingsPayoutsScheduleItemX6b4070ff = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPostRequestFormSettingsPayoutsScheduleItemX6b4070ff,
        ) {
