...
public class Plan(
     ...
     */
    public val tiers: List<PlanTier>? = null,
    /**
    ...
    public class Builder {
         ...
         * the documentation for `billing_scheme`.
         */
        public var tiers: List<PlanTier>? = null
    ...
    public object Serializer : KSerializer<Plan> {
        ...
        override fun deserialize(decoder: Decoder): Plan {
            ...
            return Plan(
                ...
                amountDecimal =
                    rawObject["amount_decimal"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                product =
                    rawObject["product"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePlanProductXfe94cf9a?>(element)
                        }
                    },
                ...
                tiersMode =
                    rawObject["tiers_mode"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePlanTiersModeXa5bf74cc?>(element)
                        }
                    },
                transformUsage =
                    rawObject["transform_usage"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlinePlanTransformUsageX37dc328e?>(element)
                        }
                    },
                trialPeriodDays =
