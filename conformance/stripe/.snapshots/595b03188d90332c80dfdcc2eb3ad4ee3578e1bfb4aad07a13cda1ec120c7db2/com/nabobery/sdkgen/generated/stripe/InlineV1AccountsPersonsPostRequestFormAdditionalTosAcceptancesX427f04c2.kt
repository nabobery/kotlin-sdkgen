...
public class InlineV1AccountsPersonsPostRequestFormAdditionalTosAcceptancesX427f04c2(
    public val account: InlineV1AccountsPersonsPostRequestFormAdditionalTosAcceptancesAccountX1361dce6? = null,
) {
    public class Builder {
        public var account:
            InlineV1AccountsPersonsPostRequestFormAdditionalTosAcceptancesAccountX1361dce6? = null

        public fun build(): InlineV1AccountsPersonsPostRequestFormAdditionalTosAcceptancesX427f04c2 =
            InlineV1AccountsPersonsPostRequestFormAdditionalTosAcceptancesX427f04c2(
                account = account,
            )
    }
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1AccountsPersonsPostRequestFormAdditionalTosAcceptancesX427f04c2 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1AccountsPersonsPostRequestFormAdditionalTosAcceptancesX427f04c2> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountsPersonsPostRequestFormAdditionalTosAcceptancesX427f04c2 must be a JSON object",
                    )
            return InlineV1AccountsPersonsPostRequestFormAdditionalTosAcceptancesX427f04c2(
                account =
                    rawObject["account"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1AccountsPersonsPostRequestFormAdditionalTosAcceptancesAccountX1361dce6>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPersonsPostRequestFormAdditionalTosAcceptancesX427f04c2,
        ) {
            val jsonEncoder =
...
public fun inlineV1AccountsPersonsPostRequestFormAdditionalTosAcceptancesX427f04c2(
    block: InlineV1AccountsPersonsPostRequestFormAdditionalTosAcceptancesX427f04c2.Builder.() -> Unit,
): InlineV1AccountsPersonsPostRequestFormAdditionalTosAcceptancesX427f04c2 =
