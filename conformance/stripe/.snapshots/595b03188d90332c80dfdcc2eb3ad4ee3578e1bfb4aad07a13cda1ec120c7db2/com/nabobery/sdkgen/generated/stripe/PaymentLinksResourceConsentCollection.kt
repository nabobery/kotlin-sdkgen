...
public data class PaymentLinksResourceConsentCollectionView(
    ...
    public val termsOfService: InlinePaymentLinksResourceConsentCollectionTermsOfServiceXf21a9a25? = null,
)
...
public class PaymentLinksResourceConsentCollection(
    ...
    public class Builder {
        ...
        public fun build(): PaymentLinksResourceConsentCollection =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentLinksResourceConsentCollection =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentLinksResourceConsentCollection> {
        ...
        override fun deserialize(decoder: Decoder): PaymentLinksResourceConsentCollection {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentLinksResourceConsentCollection must be a JSON object")
                ...
                paymentMethodReuseAgreement =
                    rawObject["payment_method_reuse_agreement"]?.let { element ->
                        if (element ==
                            ...
                            json
                                .decodeFromJsonElement<InlinePaymentLinksResourceConsentCollectionPaymentMethodReuseAgreementX67a103a5?>(
                                    element,
                                )
                        }
                    },
                promotions =
                    rawObject["promotions"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentLinksResourceConsentCollectionPromotionsXcf01fe65?>(
                                element,
                            )
                        }
                    },
                termsOfService =
                    rawObject["terms_of_service"]?.let { element ->
                        if (element ==
                            ...
                            json
                                .decodeFromJsonElement<InlinePaymentLinksResourceConsentCollectionTermsOfServiceXf21a9a25?>(
                                    element,
                                )
                        }
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentLinksResourceConsentCollection,
        ) {
...
public fun paymentLinksResourceConsentCollection(
    block: PaymentLinksResourceConsentCollection.Builder.() -> Unit,
): PaymentLinksResourceConsentCollection = PaymentLinksResourceConsentCollection.build(block)
