...
public class InlineV1TreasuryFinancialAc862PostRequestFormFeaturesOutboundTransfersXa626e7a5(
    ...
    public val usDomesticWire: InlineV1TreasuryFinancialAc862PostRequestFormFeaturesUsDomesticWireX1a0cbd81? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1TreasuryFinancialAc862PostRequestFormFeaturesOutboundTransfersXa626e7a5 =
    ...
    public object Serializer : KSerializer<InlineV1TreasuryFinancialAc862PostRequestFormFeaturesOutboundTransfersXa626e7a5> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TreasuryFinancialAc862PostRequestFormFeaturesOutboundTransfersXa626e7a5 must be a JSON object",
                    )
            return InlineV1TreasuryFinancialAc862PostRequestFormFeaturesOutboundTransfersXa626e7a5(
                ach =
                    rawObject["ach"]?.let {
                        json.decodeFromJsonElement<InlineV1TreasuryFinancialAc862PostRequestFormFeaturesAchX83ecfdf2>(
                            it,
                        )
                    },
                usDomesticWire =
                    rawObject["us_domestic_wire"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TreasuryFinancialAc862PostRequestFormFeaturesUsDomesticWireX1a0cbd81>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TreasuryFinancialAc862PostRequestFormFeaturesOutboundTransfersXa626e7a5,
        ) {
            val jsonEncoder =
...
public fun inlineV1TreasuryFinancialAc862PostRequestFormFeaturesOutboundTransfersXa626e7a5(
    block: InlineV1TreasuryFinancialAc862PostRequestFormFeaturesOutboundTransfersXa626e7a5.Builder.() -> Unit,
): InlineV1TreasuryFinancialAc862PostRequestFormFeaturesOutboundTransfersXa626e7a5 =
    InlineV1TreasuryFinancialAc862PostRequestFormFeaturesOutboundTransfersXa626e7a5.build(block)
