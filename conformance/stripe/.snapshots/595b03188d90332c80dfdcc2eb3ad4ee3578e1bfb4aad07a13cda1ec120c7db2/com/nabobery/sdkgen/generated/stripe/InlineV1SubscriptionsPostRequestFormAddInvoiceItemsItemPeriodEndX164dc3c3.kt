...
public class InlineV1SubscriptionsPostRequestFormAddInvoiceItemsItemPeriodEndX164dc3c3(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1SubscriptionsPostRequestFormAddInvoiceItemsItemPeriodEndX164dc3c3 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1SubscriptionsPostRequestFormAddInvoiceItemsItemPeriodEndX164dc3c3> {
        override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1SubscriptionsPostRequestFormAddInvoiceItemsItemPeriodEndX164dc3c3 {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SubscriptionsPostRequestFormAddInvoiceItemsItemPeriodEndX164dc3c3 must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineV1SubscriptionsPostRequestFormAddInvoiceItemsItemPeriodEndTypeX881f1770>(
                    rawObject,
                    "type",
                )
            return InlineV1SubscriptionsPostRequestFormAddInvoiceItemsItemPeriodEndX164dc3c3(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsPostRequestFormAddInvoiceItemsItemPeriodEndX164dc3c3,
        ) {
            val jsonEncoder =
...
public fun inlineV1SubscriptionsPostRequestFormAddInvoiceItemsItemPeriodEndX164dc3c3(
    block: InlineV1SubscriptionsPostRequestFormAddInvoiceItemsItemPeriodEndX164dc3c3.Builder.() -> Unit,
): InlineV1SubscriptionsPostRequestFormAddInvoiceItemsItemPeriodEndX164dc3c3 =
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1SubscriptionsPostRequestFormAddInvoiceItemsItemPeriodEndX164dc3c3 is missing required property '" +
                    name +
                    "'",
            )
