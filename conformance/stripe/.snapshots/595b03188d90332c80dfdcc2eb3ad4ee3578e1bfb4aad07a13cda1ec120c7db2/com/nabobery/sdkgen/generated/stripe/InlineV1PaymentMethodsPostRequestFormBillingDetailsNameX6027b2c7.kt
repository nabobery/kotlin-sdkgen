...
internal data class InlineV1PaymentMethodsPostRequestFormBillingDetailsNameX6027b2c7Inspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1PaymentMethodsPostRequestFormBillingDetailsNameAnyOf2X416f394f,
            ).count {
                it
            }
}
...
public class InlineV1PaymentMethodsPostRequestFormBillingDetailsNameX6027b2c7 internal constructor(
    ...
    private val inspection: InlineV1PaymentMethodsPostRequestFormBillingDetailsNameX6027b2c7Inspection,
) {
    ...
    public val inlineV1PaymentMethodsPostRequestFormBillingDetailsNameAnyOf2X416f394f:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1PaymentMethodsPostRequestFormBillingDetailsNameAnyOf2X416f394f) {
                json
                    .decodeFromJsonElement<InlineV1PaymentMethodsPostRequestFormBillingDetailsNameAnyOf2X416f394f>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1PaymentMethodsPostRequestFormBillingDetailsNameX6027b2c7Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1PaymentMethodsPostRequestFormBillingDetailsNameAnyOf2X416f394f) {
                    add(
                        InlineV1PaymentMethodsPostRequestFormBillingDetailsNameX6027b2c7Branch.InlineV1PaymentMethodsPostRequestFormBillingDetailsNameAnyOf2X416f394f,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1PaymentMethodsPostRequestFormBillingDetailsNameX6027b2c7 {
            val inspection = inspectInlineV1PaymentMethodsPostRequestFormBillingDetailsNameX6027b2c7(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1PaymentMethodsPostRequestFormBillingDetailsNameX6027b2c7NoMatchException(
                    "InlineV1PaymentMethodsPostRequestFormBillingDetailsNameX6027b2c7 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1PaymentMethodsPostRequestFormBillingDetailsNameX6027b2c7> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentMethodsPostRequestFormBillingDetailsNameX6027b2c7,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1PaymentMethodsPostRequestFormBillingDetailsNameX6027b2c7",
...
private fun inspectInlineV1PaymentMethodsPostRequestFormBillingDetailsNameX6027b2c7(
    element: JsonElement,
): InlineV1PaymentMethodsPostRequestFormBillingDetailsNameX6027b2c7Inspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1PaymentMethodsPostRequestFormBillingDetailsNameAnyOf2X416f394f =
        element
            .isJsonDecodable<InlineV1PaymentMethodsPostRequestFormBillingDetailsNameAnyOf2X416f394f>()
    return InlineV1PaymentMethodsPostRequestFormBillingDetailsNameX6027b2c7Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1PaymentMethodsPostRequestFormBillingDetailsNameAnyOf2X416f394f) {
                    add(
                        "InlineV1PaymentMethodsPostRequestFormBillingDetailsNameAnyOf2X416f394f: value does not match InlineV1PaymentMethodsPostRequestFormBillingDetailsNameAnyOf2X416f394f",
                    )
                }
            },
    )
