...
public class PersonAdditionalTosAcceptance(
    ...
    public class Builder {
        ...
        public fun build(): PersonAdditionalTosAcceptance =
    ...
    public object Serializer : KSerializer<PersonAdditionalTosAcceptance> {
        ...
        override fun deserialize(decoder: Decoder): PersonAdditionalTosAcceptance {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PersonAdditionalTosAcceptance must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PersonAdditionalTosAcceptance,
        ) {
...
public fun personAdditionalTosAcceptance(
    block: PersonAdditionalTosAcceptance.Builder.() -> Unit,
): PersonAdditionalTosAcceptance = PersonAdditionalTosAcceptance.build(block)
