...
public sealed class InlineTreasuryDebitReversalStatusX1d772209 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineTreasuryDebitReversalStatusX1d772209 =
            when (value) {
                Failed.value -> Failed
    ...
    public object Serializer : KSerializer<InlineTreasuryDebitReversalStatusX1d772209> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineTreasuryDebitReversalStatusX1d772209",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineTreasuryDebitReversalStatusX1d772209 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineTreasuryDebitReversalStatusX1d772209,
        ) {
