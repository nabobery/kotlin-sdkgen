...
public class InlineV1SubscriptionsPostRequestFormPendingInvoiceItemIntervalAnyOf1Xc54d64cd(
    public val interval: InlineV1SubscriptionsPostRequestFormPendingInvoiceItemIne05dIntervalX1b9d1d74,
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionsPostRequestFormPendingInvoiceItemIntervalAnyOf1Xc54d64cd> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SubscriptionsPostRequestFormPendingInvoiceItemIntervalAnyOf1Xc54d64cd must be a JSON object",
                    )
            val interval =
                json.decodeRequired<InlineV1SubscriptionsPostRequestFormPendingInvoiceItemIne05dIntervalX1b9d1d74>(
                    rawObject,
                    "interval",
                )
            return InlineV1SubscriptionsPostRequestFormPendingInvoiceItemIntervalAnyOf1Xc54d64cd(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsPostRequestFormPendingInvoiceItemIntervalAnyOf1Xc54d64cd,
        ) {
            val jsonEncoder =
...
public fun inlineV1SubscriptionsPostRequestFormPendingInvoiceItemIntervalAnyOf1Xc54d64cd(
    block: InlineV1SubscriptionsPostRequestFormPendingInvoiceItemIntervalAnyOf1Xc54d64cd.Builder.() -> Unit,
): InlineV1SubscriptionsPostRequestFormPendingInvoiceItemIntervalAnyOf1Xc54d64cd =
    InlineV1SubscriptionsPostRequestFormPendingInvoiceItemIntervalAnyOf1Xc54d64cd.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1SubscriptionsPostRequestFormPendingInvoiceItemIntervalAnyOf1Xc54d64cd is missing required property '" +
                    name +
                    "'",
            )
