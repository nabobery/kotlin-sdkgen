...
public class InlineV1TestHelpersIssuingc1dfPostRequestFormPurchaseDetailsLodgingXc7692b05(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1TestHelpersIssuingc1dfPostRequestFormPurchaseDetailsLodgingXc7692b05 =
            InlineV1TestHelpersIssuingc1dfPostRequestFormPurchaseDetailsLodgingXc7692b05(
                checkInAt = checkInAt,
                nights = nights,
            )
    }
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1TestHelpersIssuingc1dfPostRequestFormPurchaseDetailsLodgingXc7692b05 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1TestHelpersIssuingc1dfPostRequestFormPurchaseDetailsLodgingXc7692b05> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TestHelpersIssuingc1dfPostRequestFormPurchaseDetailsLodgingXc7692b05 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TestHelpersIssuingc1dfPostRequestFormPurchaseDetailsLodgingXc7692b05,
        ) {
            val jsonEncoder =
...
public fun inlineV1TestHelpersIssuingc1dfPostRequestFormPurchaseDetailsLodgingXc7692b05(
    block: InlineV1TestHelpersIssuingc1dfPostRequestFormPurchaseDetailsLodgingXc7692b05.Builder.() -> Unit,
): InlineV1TestHelpersIssuingc1dfPostRequestFormPurchaseDetailsLodgingXc7692b05 =
    InlineV1TestHelpersIssuingc1dfPostRequestFormPurchaseDetailsLodgingXc7692b05.build(block)
