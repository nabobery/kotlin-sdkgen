...
public class InlineV1PaymentMethodConfigurationsPostRequestFormPayByBankXb023ae62(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1PaymentMethodConfigurationsPostRequestFormPayByBankXb023ae62 =
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentMethodConfigurationsPostRequestFormPayByBankXb023ae62 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1PaymentMethodConfigurationsPostRequestFormPayByBankXb023ae62> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentMethodConfigurationsPostRequestFormPayByBankXb023ae62 must be a JSON object",
                    )
            return InlineV1PaymentMethodConfigurationsPostRequestFormPayByBankXb023ae62(
                displayPreference =
                    rawObject["display_preference"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentMethodConfidc49PostRequestFormPayByBankDisplayPreferenceXb8076f60>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentMethodConfigurationsPostRequestFormPayByBankXb023ae62,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentMethodConfigurationsPostRequestFormPayByBankXb023ae62(
    block: InlineV1PaymentMethodConfigurationsPostRequestFormPayByBankXb023ae62.Builder.() -> Unit,
): InlineV1PaymentMethodConfigurationsPostRequestFormPayByBankXb023ae62 =
    InlineV1PaymentMethodConfigurationsPostRequestFormPayByBankXb023ae62.build(block)
