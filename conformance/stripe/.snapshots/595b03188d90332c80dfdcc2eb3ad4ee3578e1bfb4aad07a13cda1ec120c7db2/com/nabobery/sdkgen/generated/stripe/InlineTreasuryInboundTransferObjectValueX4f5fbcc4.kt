...
public sealed class InlineTreasuryInboundTransferObjectValueX4f5fbcc4 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineTreasuryInboundTransferObjectValueX4f5fbcc4 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineTreasuryInboundTransferObjectValueX4f5fbcc4> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineTreasuryInboundTransferObjectValueX4f5fbcc4",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineTreasuryInboundTransferObjectValueX4f5fbcc4 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineTreasuryInboundTransferObjectValueX4f5fbcc4,
        ) {
