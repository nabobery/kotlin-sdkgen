...
internal data class InlineV1PaymentIntentsPostRequestFormHooksInputsTaxCalculationX645188b1Inspection(
    ...
    public val matchesInlineV1PaymentIntentsPostRequestFormHooksInputsTaxCalculationAnyOf2Xcb4fb152: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1PaymentIntentsPostRequestFormHooksInputsTaxCalculationAnyOf2Xcb4fb152,
            ).count {
                it
            }
}
...
public class InlineV1PaymentIntentsPostRequestFormHooksInputsTaxCalculationX645188b1 internal constructor(
    ...
    private val inspection: InlineV1PaymentIntentsPostRequestFormHooksInputsTaxCalculationX645188b1Inspection,
) {
    ...
    public val inlineV1PaymentIntentsPostRequestFormHooksInputsTaxCalculationAnyOf2Xcb4fb152:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1PaymentIntentsPostRequestFormHooksInputsTaxCalculationAnyOf2Xcb4fb152) {
                json
                    .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormHooksInputsTaxCalculationAnyOf2Xcb4fb152>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1PaymentIntentsPostRequestFormHooksInputsTaxCalculationX645188b1Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1PaymentIntentsPostRequestFormHooksInputsTaxCalculationAnyOf2Xcb4fb152) {
                    add(
                        InlineV1PaymentIntentsPostRequestFormHooksInputsTaxCalculationX645188b1Branch.InlineV1PaymentIntentsPostRequestFormHooksInputsTaxCalculationAnyOf2Xcb4fb152,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1PaymentIntentsPostRequestFormHooksInputsTaxCalculationX645188b1 {
            val inspection = inspectInlineV1PaymentIntentsPostRequestFormHooksInputsTaxCalculationX645188b1(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1PaymentIntentsPostRequestFormHooksInputsTaxCalculationX645188b1NoMatchException(
                    "InlineV1PaymentIntentsPostRequestFormHooksInputsTaxCalculationX645188b1 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormHooksInputsTaxCalculationX645188b1> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormHooksInputsTaxCalculationX645188b1,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1PaymentIntentsPostRequestFormHooksInputsTaxCalculationX645188b1",
...
private fun inspectInlineV1PaymentIntentsPostRequestFormHooksInputsTaxCalculationX645188b1(
    element: JsonElement,
): InlineV1PaymentIntentsPostRequestFormHooksInputsTaxCalculationX645188b1Inspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1PaymentIntentsPostRequestFormHooksInputsTaxCalculationAnyOf2Xcb4fb152 =
        element
            .isJsonDecodable<InlineV1PaymentIntentsPostRequestFormHooksInputsTaxCalculationAnyOf2Xcb4fb152>()
    return InlineV1PaymentIntentsPostRequestFormHooksInputsTaxCalculationX645188b1Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1PaymentIntentsPostRequestFormHooksInputsTaxCalculationAnyOf2Xcb4fb152) {
                    add(
                        "InlineV1PaymentIntentsPostRequestFormHooksInputsTaxCalculationAnyOf2Xcb4fb152: value does not match InlineV1PaymentIntentsPostRequestFormHooksInputsTaxCalculationAnyOf2Xcb4fb152",
                    )
                }
            },
    )
