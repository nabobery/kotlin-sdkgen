...
public class PaymentMethodDetailsPaymentRecordEps(
    ...
    public class Builder {
        ...
        public fun build(): PaymentMethodDetailsPaymentRecordEps =
            PaymentMethodDetailsPaymentRecordEps(
                bank = bank,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentMethodDetailsPaymentRecordEps =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentMethodDetailsPaymentRecordEps> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodDetailsPaymentRecordEps {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodDetailsPaymentRecordEps must be a JSON object")
                ...
                bank =
                    rawObject["bank"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentMethodDetailsPaymentRecordEpsBankXe829ec92?>(
                                element,
                            )
                        }
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentMethodDetailsPaymentRecordEps,
        ) {
...
public fun paymentMethodDetailsPaymentRecordEps(
    block: PaymentMethodDetailsPaymentRecordEps.Builder.() -> Unit,
): PaymentMethodDetailsPaymentRecordEps = PaymentMethodDetailsPaymentRecordEps.build(block)
