...
internal data class InlineV1AccountsPersonsPostRequestFormDocumentsPassportFilesItemX4062cfcdInspection(
    ...
    public val matchesInlineV1AccountsPersonsPostRequestFormDocumentsPassportFilesItemAnyOf2X26bc14b2: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1AccountsPersonsPostRequestFormDocumentsPassportFilesItemAnyOf2X26bc14b2,
            ).count {
                it
            }
}
...
public class InlineV1AccountsPersonsPostRequestFormDocumentsPassportFilesItemX4062cfcd internal constructor(
    ...
    private val inspection: InlineV1AccountsPersonsPostRequestFormDocumentsPassportFilesItemX4062cfcdInspection,
) {
    ...
    public val inlineV1AccountsPersonsPostRequestFormDocumentsPassportFilesItemAnyOf2X26bc14b2:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1AccountsPersonsPostRequestFormDocumentsPassportFilesItemAnyOf2X26bc14b2) {
                json
                    .decodeFromJsonElement<InlineV1AccountsPersonsPostRequestFormDocumentsPassportFilesItemAnyOf2X26bc14b2>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1AccountsPersonsPostRequestFormDocumentsPassportFilesItemX4062cfcdBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1AccountsPersonsPostRequestFormDocumentsPassportFilesItemAnyOf2X26bc14b2) {
                    add(
                        InlineV1AccountsPersonsPostRequestFormDocumentsPassportFilesItemX4062cfcdBranch.InlineV1AccountsPersonsPostRequestFormDocumentsPassportFilesItemAnyOf2X26bc14b2,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1AccountsPersonsPostRequestFormDocumentsPassportFilesItemX4062cfcd {
            val inspection = inspectInlineV1AccountsPersonsPostRequestFormDocumentsPassportFilesItemX4062cfcd(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1AccountsPersonsPostRequestFormDocumentsPassportFilesItemX4062cfcdNoMatchException(
                    "InlineV1AccountsPersonsPostRequestFormDocumentsPassportFilesItemX4062cfcd matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1AccountsPersonsPostRequestFormDocumentsPassportFilesItemX4062cfcd> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPersonsPostRequestFormDocumentsPassportFilesItemX4062cfcd,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1AccountsPersonsPostRequestFormDocumentsPassportFilesItemX4062cfcd",
...
private fun inspectInlineV1AccountsPersonsPostRequestFormDocumentsPassportFilesItemX4062cfcd(
    element: JsonElement,
): InlineV1AccountsPersonsPostRequestFormDocumentsPassportFilesItemX4062cfcdInspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1AccountsPersonsPostRequestFormDocumentsPassportFilesItemAnyOf2X26bc14b2 =
        element
            .isJsonDecodable<InlineV1AccountsPersonsPostRequestFormDocumentsPassportFilesItemAnyOf2X26bc14b2>()
    return InlineV1AccountsPersonsPostRequestFormDocumentsPassportFilesItemX4062cfcdInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1AccountsPersonsPostRequestFormDocumentsPassportFilesItemAnyOf2X26bc14b2) {
                    add(
                        "InlineV1AccountsPersonsPostRequestFormDocumentsPassportFilesItemAnyOf2X26bc14b2: value does not match InlineV1AccountsPersonsPostRequestFormDocumentsPassportFilesItemAnyOf2X26bc14b2",
                    )
                }
            },
    )
