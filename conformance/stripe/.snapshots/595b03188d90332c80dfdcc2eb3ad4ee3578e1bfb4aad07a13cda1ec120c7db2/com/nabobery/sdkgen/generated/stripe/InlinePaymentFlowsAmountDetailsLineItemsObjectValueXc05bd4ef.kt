...
public sealed class InlinePaymentFlowsAmountDetailsLineItemsObjectValueXc05bd4ef {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentFlowsAmountDetailsLineItemsObjectValueXc05bd4ef =
            when (value) {
                List.value -> List
    ...
    public object Serializer : KSerializer<InlinePaymentFlowsAmountDetailsLineItemsObjectValueXc05bd4ef> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentFlowsAmountDetailsLineItemsObjectValueXc05bd4ef",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePaymentFlowsAmountDetailsLineItemsObjectValueXc05bd4ef =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentFlowsAmountDetailsLineItemsObjectValueXc05bd4ef,
        ) {
