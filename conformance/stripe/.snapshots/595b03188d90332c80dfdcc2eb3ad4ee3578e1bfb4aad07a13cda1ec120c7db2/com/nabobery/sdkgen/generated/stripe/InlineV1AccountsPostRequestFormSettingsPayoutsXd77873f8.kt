...
public class InlineV1AccountsPostRequestFormSettingsPayoutsXd77873f8(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1AccountsPostRequestFormSettingsPayoutsXd77873f8 =
            InlineV1AccountsPostRequestFormSettingsPayoutsXd77873f8(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1AccountsPostRequestFormSettingsPayoutsXd77873f8 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1AccountsPostRequestFormSettingsPayoutsXd77873f8> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountsPostRequestFormSettingsPayoutsXd77873f8 must be a JSON object",
                    )
            return InlineV1AccountsPostRequestFormSettingsPayoutsXd77873f8(
                ...
                schedule =
                    rawObject["schedule"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPostRequestFormSettingsPayoutsScheduleXea38b562>(it)
                    },
                statementDescriptor =
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPostRequestFormSettingsPayoutsXd77873f8,
        ) {
...
public fun inlineV1AccountsPostRequestFormSettingsPayoutsXd77873f8(
    block: InlineV1AccountsPostRequestFormSettingsPayoutsXd77873f8.Builder.() -> Unit,
): InlineV1AccountsPostRequestFormSettingsPayoutsXd77873f8 =
    InlineV1AccountsPostRequestFormSettingsPayoutsXd77873f8.build(block)
