...
public sealed class InlinePaymentIntentPaymentMethodOptionsCardRequestOvercaptureXcd6cdbce {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentIntentPaymentMethodOptionsCardRequestOvercaptureXcd6cdbce =
            when (value) {
    ...
    public object Serializer : KSerializer<InlinePaymentIntentPaymentMethodOptionsCardRequestOvercaptureXcd6cdbce> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentIntentPaymentMethodOptionsCardRequestOvercaptureXcd6cdbce",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlinePaymentIntentPaymentMethodOptionsCardRequestOvercaptureXcd6cdbce = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentIntentPaymentMethodOptionsCardRequestOvercaptureXcd6cdbce,
        ) {
