...
public sealed class InlineV1InvoicePaymentsGetParameterX6fbcf43a {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1InvoicePaymentsGetParameterX6fbcf43a =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1InvoicePaymentsGetParameterX6fbcf43a> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1InvoicePaymentsGetParameterX6fbcf43a",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1InvoicePaymentsGetParameterX6fbcf43a =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicePaymentsGetParameterX6fbcf43a,
        ) {
