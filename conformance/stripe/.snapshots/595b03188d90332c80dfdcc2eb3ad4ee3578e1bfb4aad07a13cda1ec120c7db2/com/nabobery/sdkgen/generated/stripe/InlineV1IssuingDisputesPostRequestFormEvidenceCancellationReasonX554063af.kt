...
internal data class InlineV1IssuingDisputesPostRequestFormEvidenceCancellationReasonX554063afInspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2Xed892c33,
            ).count { it }
}
...
public class InlineV1IssuingDisputesPostRequestFormEvidenceCancellationReasonX554063af internal constructor(
    ...
    private val inspection: InlineV1IssuingDisputesPostRequestFormEvidenceCancellationReasonX554063afInspection,
) {
    ...
    public val inlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2Xed892c33:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2Xed892c33) {
                json
                    .decodeFromJsonElement<InlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2Xed892c33>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1IssuingDisputesPostRequestFormEvidenceCancellationReasonX554063afBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2Xed892c33) {
                    add(
                        InlineV1IssuingDisputesPostRequestFormEvidenceCancellationReasonX554063afBranch.InlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2Xed892c33,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1IssuingDisputesPostRequestFormEvidenceCancellationReasonX554063af {
            val inspection = inspectInlineV1IssuingDisputesPostRequestFormEvidenceCancellationReasonX554063af(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1IssuingDisputesPostRequestFormEvidenceCancellationReasonX554063afNoMatchException(
                    "InlineV1IssuingDisputesPostRequestFormEvidenceCancellationReasonX554063af matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1IssuingDisputesPostRequestFormEvidenceCancellationReasonX554063af> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingDisputesPostRequestFormEvidenceCancellationReasonX554063af,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1IssuingDisputesPostRequestFormEvidenceCancellationReasonX554063af",
...
private fun inspectInlineV1IssuingDisputesPostRequestFormEvidenceCancellationReasonX554063af(
    element: JsonElement,
): InlineV1IssuingDisputesPostRequestFormEvidenceCancellationReasonX554063afInspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2Xed892c33 =
        element
            .isJsonDecodable<InlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2Xed892c33>()
    return InlineV1IssuingDisputesPostRequestFormEvidenceCancellationReasonX554063afInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2Xed892c33) {
                    add(
                        "InlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2Xed892c33: value does not match InlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2Xed892c33",
                    )
                }
            },
    )
