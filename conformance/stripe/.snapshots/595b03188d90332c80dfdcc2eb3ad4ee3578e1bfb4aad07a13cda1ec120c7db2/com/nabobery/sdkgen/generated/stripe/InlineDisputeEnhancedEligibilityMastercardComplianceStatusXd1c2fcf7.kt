...
public sealed class InlineDisputeEnhancedEligibilityMastercardComplianceStatusXd1c2fcf7 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineDisputeEnhancedEligibilityMastercardComplianceStatusXd1c2fcf7 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineDisputeEnhancedEligibilityMastercardComplianceStatusXd1c2fcf7> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineDisputeEnhancedEligibilityMastercardComplianceStatusXd1c2fcf7",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineDisputeEnhancedEligibilityMastercardComplianceStatusXd1c2fcf7 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineDisputeEnhancedEligibilityMastercardComplianceStatusXd1c2fcf7,
        ) {
