...
public class InlineV1InvoicesPostRequestFormEffectiveAtX2b7c3a8a internal constructor(
    ...
    public val inlineV1InvoicesPostRequestFormEffectiveAtAnyOf2Xeb1240d2:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1InvoicesPostRequestFormEffectiveAtAnyOf2Xeb1240d2) {
                json
                    .decodeFromJsonElement<InlineV1InvoicesPostRequestFormEffectiveAtAnyOf2Xeb1240d2>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1InvoicesPostRequestFormEffectiveAtX2b7c3a8aBranch>
        get() =
            buildSet {
                ...
                if (inspection.matchesInlineV1InvoicesPostRequestFormEffectiveAtAnyOf2Xeb1240d2) {
                    add(
                        InlineV1InvoicesPostRequestFormEffectiveAtX2b7c3a8aBranch.InlineV1InvoicesPostRequestFormEffectiveAtAnyOf2Xeb1240d2,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1InvoicesPostRequestFormEffectiveAtX2b7c3a8a {
            val inspection = inspectInlineV1InvoicesPostRequestFormEffectiveAtX2b7c3a8a(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1InvoicesPostRequestFormEffectiveAtX2b7c3a8aNoMatchException(
                    "InlineV1InvoicesPostRequestFormEffectiveAtX2b7c3a8a matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1InvoicesPostRequestFormEffectiveAtX2b7c3a8a> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesPostRequestFormEffectiveAtX2b7c3a8a,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1InvoicesPostRequestFormEffectiveAtX2b7c3a8a",
...
private fun inspectInlineV1InvoicesPostRequestFormEffectiveAtX2b7c3a8a(
    element: JsonElement,
): InlineV1InvoicesPostRequestFormEffectiveAtX2b7c3a8aInspection {
    val matchesBranch1 = element.isJsonDecodable<Int>()
    val matchesInlineV1InvoicesPostRequestFormEffectiveAtAnyOf2Xeb1240d2 =
        element
            .isJsonDecodable<InlineV1InvoicesPostRequestFormEffectiveAtAnyOf2Xeb1240d2>()
    return InlineV1InvoicesPostRequestFormEffectiveAtX2b7c3a8aInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1InvoicesPostRequestFormEffectiveAtAnyOf2Xeb1240d2) {
                    add(
                        "InlineV1InvoicesPostRequestFormEffectiveAtAnyOf2Xeb1240d2: value does not match InlineV1InvoicesPostRequestFormEffectiveAtAnyOf2Xeb1240d2",
                    )
                }
            },
    )
