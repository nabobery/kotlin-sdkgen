...
public sealed class InlineBalanceSettingsResourceAutomaticTransferRuleTypeX33d26c37 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineBalanceSettingsResourceAutomaticTransferRuleTypeX33d26c37 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineBalanceSettingsResourceAutomaticTransferRuleTypeX33d26c37> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineBalanceSettingsResourceAutomaticTransferRuleTypeX33d26c37",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineBalanceSettingsResourceAutomaticTransferRuleTypeX33d26c37 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineBalanceSettingsResourceAutomaticTransferRuleTypeX33d26c37,
        ) {
