...
public class InlineV1TerminalReadersPostRequestFormLabelX28f772fd internal constructor(
    ...
    public val inlineV1TerminalReadersPostRequestFormLabelAnyOf2X13e6c172:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1TerminalReadersPostRequestFormLabelAnyOf2X13e6c172) {
                json
                    .decodeFromJsonElement<InlineV1TerminalReadersPostRequestFormLabelAnyOf2X13e6c172>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1TerminalReadersPostRequestFormLabelX28f772fdBranch>
        get() =
            buildSet {
                ...
                if (inspection.matchesInlineV1TerminalReadersPostRequestFormLabelAnyOf2X13e6c172) {
                    add(
                        InlineV1TerminalReadersPostRequestFormLabelX28f772fdBranch.InlineV1TerminalReadersPostRequestFormLabelAnyOf2X13e6c172,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1TerminalReadersPostRequestFormLabelX28f772fd {
            val inspection = inspectInlineV1TerminalReadersPostRequestFormLabelX28f772fd(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1TerminalReadersPostRequestFormLabelX28f772fdNoMatchException(
                    "InlineV1TerminalReadersPostRequestFormLabelX28f772fd matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1TerminalReadersPostRequestFormLabelX28f772fd> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TerminalReadersPostRequestFormLabelX28f772fd,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1TerminalReadersPostRequestFormLabelX28f772fd",
...
private fun inspectInlineV1TerminalReadersPostRequestFormLabelX28f772fd(
    element: JsonElement,
): InlineV1TerminalReadersPostRequestFormLabelX28f772fdInspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1TerminalReadersPostRequestFormLabelAnyOf2X13e6c172 =
        element
            .isJsonDecodable<InlineV1TerminalReadersPostRequestFormLabelAnyOf2X13e6c172>()
    return InlineV1TerminalReadersPostRequestFormLabelX28f772fdInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1TerminalReadersPostRequestFormLabelAnyOf2X13e6c172) {
                    add(
                        "InlineV1TerminalReadersPostRequestFormLabelAnyOf2X13e6c172: value does not match InlineV1TerminalReadersPostRequestFormLabelAnyOf2X13e6c172",
                    )
                }
            },
    )
