...
public sealed class InlineInvoiceCustomerTaxExemptX99293270 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineInvoiceCustomerTaxExemptX99293270 =
            when (value) {
                Exempt.value -> Exempt
                None.value -> None
    ...
    public object Serializer : KSerializer<InlineInvoiceCustomerTaxExemptX99293270> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineInvoiceCustomerTaxExemptX99293270",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineInvoiceCustomerTaxExemptX99293270 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineInvoiceCustomerTaxExemptX99293270,
        ) {
