...
public class InlineV1SubscriptionsPostRequestFormPaymentSettingsFinancialConnectionsX9a17d584(
    ...
    public val permissions: List<InlineV1SubscriptionsPostRequestFormPaymentSettingsItemXec9b32a0>? = null,
    public val prefetch: List<InlineV1SubscriptionsPostRequestFormPaymentSettingsItemX28f4e986>? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1SubscriptionsPostRequestFormPaymentSettingsFinancialConnectionsX9a17d584 =
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionsPostRequestFormPaymentSettingsFinancialConnectionsX9a17d584> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SubscriptionsPostRequestFormPaymentSettingsFinancialConnectionsX9a17d584 must be a JSON object",
                    )
            return InlineV1SubscriptionsPostRequestFormPaymentSettingsFinancialConnectionsX9a17d584(
                filters =
                    rawObject["filters"]?.let {
                        json.decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormPaymentSettingsFiltersXc9241378>(
                            it,
                        )
                    },
                permissions =
                    rawObject["permissions"]?.let {
                        json
                            .decodeFromJsonElement<List<InlineV1SubscriptionsPostRequestFormPaymentSettingsItemXec9b32a0>>(
                                it,
                            )
                    },
                prefetch =
                    rawObject["prefetch"]?.let {
                        json
                            .decodeFromJsonElement<List<InlineV1SubscriptionsPostRequestFormPaymentSettingsItemX28f4e986>>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsPostRequestFormPaymentSettingsFinancialConnectionsX9a17d584,
        ) {
            val jsonEncoder =
...
public fun inlineV1SubscriptionsPostRequestFormPaymentSettingsFinancialConnectionsX9a17d584(
    block: InlineV1SubscriptionsPostRequestFormPaymentSettingsFinancialConnectionsX9a17d584.Builder.() -> Unit,
): InlineV1SubscriptionsPostRequestFormPaymentSettingsFinancialConnectionsX9a17d584 =
    InlineV1SubscriptionsPostRequestFormPaymentSettingsFinancialConnectionsX9a17d584.build(block)
