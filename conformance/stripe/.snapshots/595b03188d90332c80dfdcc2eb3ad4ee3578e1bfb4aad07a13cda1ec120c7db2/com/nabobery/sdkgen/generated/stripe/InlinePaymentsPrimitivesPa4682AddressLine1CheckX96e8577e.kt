...
public sealed class InlinePaymentsPrimitivesPa4682AddressLine1CheckX96e8577e {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentsPrimitivesPa4682AddressLine1CheckX96e8577e =
            when (value) {
                Fail.value -> Fail
                Pass.value -> Pass
    ...
    public object Serializer : KSerializer<InlinePaymentsPrimitivesPa4682AddressLine1CheckX96e8577e> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentsPrimitivesPa4682AddressLine1CheckX96e8577e",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePaymentsPrimitivesPa4682AddressLine1CheckX96e8577e =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentsPrimitivesPa4682AddressLine1CheckX96e8577e,
        ) {
