 ...
 * oded/schema/properties/evidence
 */
@Serializable(with = InlineV1DisputesPostRequestFormEvidenceXb8c791ab.Serializer::class)
public class InlineV1DisputesPostRequestFormEvidenceXb8c791ab(
    ...
    public val enhancedEvidence: InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceX108ef6c9? = null,
    ...
    public class Builder {
        ...
        public var enhancedEvidence: InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceX108ef6c9? =
            null
        ...
        public fun build(): InlineV1DisputesPostRequestFormEvidenceXb8c791ab =
            InlineV1DisputesPostRequestFormEvidenceXb8c791ab(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1DisputesPostRequestFormEvidenceXb8c791ab =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1DisputesPostRequestFormEvidenceXb8c791ab> {
        override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

        override fun deserialize(decoder: Decoder): InlineV1DisputesPostRequestFormEvidenceXb8c791ab {
            val jsonDecoder = decoder.requireJsonDecoder("InlineV1DisputesPostRequestFormEvidenceXb8c791ab")
            val json = jsonDecoder.json
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1DisputesPostRequestFormEvidenceXb8c791ab must be a JSON object",
                    )
            return InlineV1DisputesPostRequestFormEvidenceXb8c791ab(
                ...
                cancellationPolicyDisclosure =
                    rawObject["cancellation_policy_disclosure"]?.let {
                        json.decodeFromJsonElement<String>(it)
                    },
                cancellationRebuttal =
                    rawObject["cancellation_rebuttal"]?.let {
                        json.decodeFromJsonElement<String>(
                            it,
                        )
                    },
                customerCommunication =
                    rawObject["customer_communication"]?.let {
                        json.decodeFromJsonElement<String>(
                            it,
                        )
                    },
                ...
                duplicateChargeDocumentation =
                    rawObject["duplicate_charge_documentation"]?.let {
                        json.decodeFromJsonElement<String>(it)
                    },
                duplicateChargeExplanation =
                    rawObject["duplicate_charge_explanation"]?.let {
                        json
                ...
                duplicateChargeId =
                    rawObject["duplicate_charge_id"]?.let {
                        json.decodeFromJsonElement<String>(
                            it,
                        )
                    },
                enhancedEvidence =
                    rawObject["enhanced_evidence"]?.let {
                        json.decodeFromJsonElement<InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceX108ef6c9>(it)
                    },
                productDescription =
                ...
                refundPolicyDisclosure =
                    rawObject["refund_policy_disclosure"]?.let {
                        json
                            .decodeFromJsonElement<String>(
                                it,
                            )
                ...
                refundRefusalExplanation =
                    rawObject["refund_refusal_explanation"]?.let {
                        json.decodeFromJsonElement<String>(
                            it,
                        )
                    },
                ...
                serviceDocumentation =
                    rawObject["service_documentation"]?.let {
                        json.decodeFromJsonElement<String>(
                            it,
                        )
                    },
                ...
                shippingDocumentation =
                    rawObject["shipping_documentation"]?.let {
                        json.decodeFromJsonElement<String>(
                            it,
                        )
                    },
                shippingTrackingNumber =
                    rawObject["shipping_tracking_number"]?.let {
                        json
                            .decodeFromJsonElement<String>(
                                it,
                            )
                    },
                uncategorizedFile = rawObject["uncategorized_file"]?.let {
                    json.decodeFromJsonElement<String>(
                        it,
                    )
                },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1DisputesPostRequestFormEvidenceXb8c791ab,
        ) {
            val jsonEncoder = encoder.requireJsonEncoder("InlineV1DisputesPostRequestFormEvidenceXb8c791ab")
...
public fun inlineV1DisputesPostRequestFormEvidenceXb8c791ab(
    block: InlineV1DisputesPostRequestFormEvidenceXb8c791ab.Builder.() -> Unit,
): InlineV1DisputesPostRequestFormEvidenceXb8c791ab = InlineV1DisputesPostRequestFormEvidenceXb8c791ab.build(block)
