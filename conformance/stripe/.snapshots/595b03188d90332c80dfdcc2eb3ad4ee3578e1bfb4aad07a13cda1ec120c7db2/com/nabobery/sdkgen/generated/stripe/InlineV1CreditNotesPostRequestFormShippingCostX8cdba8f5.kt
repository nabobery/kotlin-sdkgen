...
public class InlineV1CreditNotesPostRequestFormShippingCostX8cdba8f5(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1CreditNotesPostRequestFormShippingCostX8cdba8f5 =
            InlineV1CreditNotesPostRequestFormShippingCostX8cdba8f5(
                shippingRate = shippingRate,
            )
    }

    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1CreditNotesPostRequestFormShippingCostX8cdba8f5 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1CreditNotesPostRequestFormShippingCostX8cdba8f5> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CreditNotesPostRequestFormShippingCostX8cdba8f5 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CreditNotesPostRequestFormShippingCostX8cdba8f5,
        ) {
...
public fun inlineV1CreditNotesPostRequestFormShippingCostX8cdba8f5(
    block: InlineV1CreditNotesPostRequestFormShippingCostX8cdba8f5.Builder.() -> Unit,
): InlineV1CreditNotesPostRequestFormShippingCostX8cdba8f5 =
    InlineV1CreditNotesPostRequestFormShippingCostX8cdba8f5.build(block)
