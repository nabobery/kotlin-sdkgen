...
public class InlineV1InvoicesPostRequestFormPaymentSettingsBankTransferX21346e73(
    public val euBankTransfer: InlineV1InvoicesPostRequestFormPaymentSettingsEuBankTransferX874368a2? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1InvoicesPostRequestFormPaymentSettingsBankTransferX21346e73 =
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1InvoicesPostRequestFormPaymentSettingsBankTransferX21346e73 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1InvoicesPostRequestFormPaymentSettingsBankTransferX21346e73> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1InvoicesPostRequestFormPaymentSettingsBankTransferX21346e73 must be a JSON object",
                    )
            return InlineV1InvoicesPostRequestFormPaymentSettingsBankTransferX21346e73(
                euBankTransfer =
                    rawObject["eu_bank_transfer"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1InvoicesPostRequestFormPaymentSettingsEuBankTransferX874368a2>(
                                it,
                            )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesPostRequestFormPaymentSettingsBankTransferX21346e73,
        ) {
            val jsonEncoder =
...
public fun inlineV1InvoicesPostRequestFormPaymentSettingsBankTransferX21346e73(
    block: InlineV1InvoicesPostRequestFormPaymentSettingsBankTransferX21346e73.Builder.() -> Unit,
): InlineV1InvoicesPostRequestFormPaymentSettingsBankTransferX21346e73 =
    InlineV1InvoicesPostRequestFormPaymentSettingsBankTransferX21346e73.build(block)
