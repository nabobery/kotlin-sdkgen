...
public class InlineV1ChargesRefundsGetResponse200JsonX440d849e(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1ChargesRefundsGetResponse200JsonX440d849e =
    ...
    public object Serializer : KSerializer<InlineV1ChargesRefundsGetResponse200JsonX440d849e> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1ChargesRefundsGetResponse200JsonX440d849e must be a JSON object",
                    )
            val data = json.decodeRequired<List<Refund>>(rawObject, "data")
            val hasMore = json.decodeRequired<Boolean>(rawObject, "has_more")
            val objectValue =
                json.decodeRequired<InlineV1ChargesRefundsGetResponse200JsonObjectValueX39dd2cf6>(
                    rawObject,
                    "object",
                )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ChargesRefundsGetResponse200JsonX440d849e,
        ) {
...
public fun inlineV1ChargesRefundsGetResponse200JsonX440d849e(
    block: InlineV1ChargesRefundsGetResponse200JsonX440d849e.Builder.() -> Unit,
): InlineV1ChargesRefundsGetResponse200JsonX440d849e = InlineV1ChargesRefundsGetResponse200JsonX440d849e.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1ChargesRefundsGetResponse200JsonX440d849e is missing required property '" + name + "'",
            )
