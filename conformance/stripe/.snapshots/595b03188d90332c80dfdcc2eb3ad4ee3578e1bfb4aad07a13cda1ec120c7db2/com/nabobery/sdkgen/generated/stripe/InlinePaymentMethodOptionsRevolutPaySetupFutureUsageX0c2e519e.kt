...
public sealed class InlinePaymentMethodOptionsRevolutPaySetupFutureUsageX0c2e519e {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentMethodOptionsRevolutPaySetupFutureUsageX0c2e519e =
            when (value) {
                None.value -> None
    ...
    public object Serializer : KSerializer<InlinePaymentMethodOptionsRevolutPaySetupFutureUsageX0c2e519e> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentMethodOptionsRevolutPaySetupFutureUsageX0c2e519e",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePaymentMethodOptionsRevolutPaySetupFutureUsageX0c2e519e =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentMethodOptionsRevolutPaySetupFutureUsageX0c2e519e,
        ) {
