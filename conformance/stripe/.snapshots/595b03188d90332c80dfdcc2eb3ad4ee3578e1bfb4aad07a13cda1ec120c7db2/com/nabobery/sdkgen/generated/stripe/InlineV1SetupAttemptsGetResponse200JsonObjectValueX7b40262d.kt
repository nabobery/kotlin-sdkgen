...
public sealed class InlineV1SetupAttemptsGetResponse200JsonObjectValueX7b40262d {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1SetupAttemptsGetResponse200JsonObjectValueX7b40262d =
            when (value) {
                List.value -> List
    ...
    public object Serializer : KSerializer<InlineV1SetupAttemptsGetResponse200JsonObjectValueX7b40262d> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1SetupAttemptsGetResponse200JsonObjectValueX7b40262d",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1SetupAttemptsGetResponse200JsonObjectValueX7b40262d =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SetupAttemptsGetResponse200JsonObjectValueX7b40262d,
        ) {
