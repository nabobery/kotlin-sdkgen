...
public sealed class InlineDisputeEnhancedEligibilityVisaCompellingEvidence3StatusX17878737 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineDisputeEnhancedEligibilityVisaCompellingEvidence3StatusX17878737 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineDisputeEnhancedEligibilityVisaCompellingEvidence3StatusX17878737> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineDisputeEnhancedEligibilityVisaCompellingEvidence3StatusX17878737",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineDisputeEnhancedEligibilityVisaCompellingEvidence3StatusX17878737 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineDisputeEnhancedEligibilityVisaCompellingEvidence3StatusX17878737,
        ) {
