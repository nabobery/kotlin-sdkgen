...
public class InlineV1SubscriptionSchedulesPostRequestFormPhasesItemEndX3ee152e2(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1SubscriptionSchedulesPostRequestFormPhasesItemEndX3ee152e2 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemEndX3ee152e2> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1SubscriptionSchedulesPostRequestFormPhasesItemEndX3ee152e2 {
            val jsonDecoder =
                decoder.requireJsonDecoder(
                    "InlineV1SubscriptionSchedulesPostRequestFormPhasesItemEndX3ee152e2",
                )
            val json = jsonDecoder.json
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SubscriptionSchedulesPostRequestFormPhasesItemEndX3ee152e2 must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemTypeX5c521467>(
                    rawObject,
                    "type",
                )
            return InlineV1SubscriptionSchedulesPostRequestFormPhasesItemEndX3ee152e2(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionSchedulesPostRequestFormPhasesItemEndX3ee152e2,
        ) {
            val jsonEncoder =
...
public fun inlineV1SubscriptionSchedulesPostRequestFormPhasesItemEndX3ee152e2(
    block: InlineV1SubscriptionSchedulesPostRequestFormPhasesItemEndX3ee152e2.Builder.() -> Unit,
): InlineV1SubscriptionSchedulesPostRequestFormPhasesItemEndX3ee152e2 =
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1SubscriptionSchedulesPostRequestFormPhasesItemEndX3ee152e2 is missing required property '" +
                    name +
                    "'",
            )
