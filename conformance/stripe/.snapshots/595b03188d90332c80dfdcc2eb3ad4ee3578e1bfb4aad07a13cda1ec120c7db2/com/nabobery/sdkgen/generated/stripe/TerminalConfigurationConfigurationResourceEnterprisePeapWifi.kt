...
public class TerminalConfigurationConfigurationResourceEnterprisePeapWifi(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): TerminalConfigurationConfigurationResourceEnterprisePeapWifi =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<TerminalConfigurationConfigurationResourceEnterprisePeapWifi> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "TerminalConfigurationConfigurationResourceEnterprisePeapWifi must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: TerminalConfigurationConfigurationResourceEnterprisePeapWifi,
        ) {
...
public fun terminalConfigurationConfigurationResourceEnterprisePeapWifi(
    block: TerminalConfigurationConfigurationResourceEnterprisePeapWifi.Builder.() -> Unit,
): TerminalConfigurationConfigurationResourceEnterprisePeapWifi =
    TerminalConfigurationConfigurationResourceEnterprisePeapWifi.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "TerminalConfigurationConfigurationResourceEnterprisePeapWifi is missing required property '" + name +
                    "'",
            )
