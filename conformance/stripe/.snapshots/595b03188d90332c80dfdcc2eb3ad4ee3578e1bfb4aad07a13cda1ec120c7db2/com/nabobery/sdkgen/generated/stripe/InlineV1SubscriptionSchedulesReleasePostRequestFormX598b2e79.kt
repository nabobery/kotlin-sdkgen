...
public class InlineV1SubscriptionSchedulesReleasePostRequestFormX598b2e79(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1SubscriptionSchedulesReleasePostRequestFormX598b2e79 =
            InlineV1SubscriptionSchedulesReleasePostRequestFormX598b2e79(
                expand = expand,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1SubscriptionSchedulesReleasePostRequestFormX598b2e79 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1SubscriptionSchedulesReleasePostRequestFormX598b2e79> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SubscriptionSchedulesReleasePostRequestFormX598b2e79 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionSchedulesReleasePostRequestFormX598b2e79,
        ) {
...
public fun inlineV1SubscriptionSchedulesReleasePostRequestFormX598b2e79(
    block: InlineV1SubscriptionSchedulesReleasePostRequestFormX598b2e79.Builder.() -> Unit,
): InlineV1SubscriptionSchedulesReleasePostRequestFormX598b2e79 =
    InlineV1SubscriptionSchedulesReleasePostRequestFormX598b2e79.build(block)
