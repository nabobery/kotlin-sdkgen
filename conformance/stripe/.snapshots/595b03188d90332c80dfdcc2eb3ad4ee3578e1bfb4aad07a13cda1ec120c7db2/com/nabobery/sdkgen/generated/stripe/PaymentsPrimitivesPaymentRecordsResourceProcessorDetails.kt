...
public class PaymentsPrimitivesPaymentRecordsResourceProcessorDetails(
    ...
    public val custom: PaymentsPrimitivesPaymentRecordsResourceProcessorDetailsResourceCustomDetails? = null,
) {
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentsPrimitivesPaymentRecordsResourceProcessorDetails =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentsPrimitivesPaymentRecordsResourceProcessorDetails> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "PaymentsPrimitivesPaymentRecordsResourceProcessorDetails must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlinePaymentsPrimitivesPaymentRecordsResourceProcessorDetailsTypeXb87541af>(
                    rawObject,
                    "type",
                )
            return PaymentsPrimitivesPaymentRecordsResourceProcessorDetails(
                ...
                custom =
                    rawObject["custom"]?.let {
                        json
                            .decodeFromJsonElement<PaymentsPrimitivesPaymentRecordsResourceProcessorDetailsResourceCustomDetails>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentsPrimitivesPaymentRecordsResourceProcessorDetails,
        ) {
...
public fun paymentsPrimitivesPaymentRecordsResourceProcessorDetails(
    block: PaymentsPrimitivesPaymentRecordsResourceProcessorDetails.Builder.() -> Unit,
): PaymentsPrimitivesPaymentRecordsResourceProcessorDetails =
    PaymentsPrimitivesPaymentRecordsResourceProcessorDetails.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "PaymentsPrimitivesPaymentRecordsResourceProcessorDetails is missing required property '" + name + "'",
            )
