...
public sealed class InlineIssuingAuthorizationFuelDataTypeX66f3603f {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineIssuingAuthorizationFuelDataTypeX66f3603f =
            when (value) {
                Diesel.value -> Diesel
                Other.value -> Other
    ...
    public object Serializer : KSerializer<InlineIssuingAuthorizationFuelDataTypeX66f3603f> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineIssuingAuthorizationFuelDataTypeX66f3603f",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineIssuingAuthorizationFuelDataTypeX66f3603f =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineIssuingAuthorizationFuelDataTypeX66f3603f,
        ) {
