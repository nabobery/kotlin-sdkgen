...
public class InlineV1AccountsPostRequestFormSettingsBrandingX3dbde389(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1AccountsPostRequestFormSettingsBrandingX3dbde389 =
            InlineV1AccountsPostRequestFormSettingsBrandingX3dbde389(
                icon = icon,
                logo = logo,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1AccountsPostRequestFormSettingsBrandingX3dbde389 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1AccountsPostRequestFormSettingsBrandingX3dbde389> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountsPostRequestFormSettingsBrandingX3dbde389 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPostRequestFormSettingsBrandingX3dbde389,
        ) {
...
public fun inlineV1AccountsPostRequestFormSettingsBrandingX3dbde389(
    block: InlineV1AccountsPostRequestFormSettingsBrandingX3dbde389.Builder.() -> Unit,
): InlineV1AccountsPostRequestFormSettingsBrandingX3dbde389 =
    InlineV1AccountsPostRequestFormSettingsBrandingX3dbde389.build(block)
