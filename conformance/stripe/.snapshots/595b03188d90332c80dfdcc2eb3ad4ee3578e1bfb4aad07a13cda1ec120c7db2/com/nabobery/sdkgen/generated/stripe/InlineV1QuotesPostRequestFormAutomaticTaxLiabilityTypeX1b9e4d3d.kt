...
public sealed class InlineV1QuotesPostRequestFormAutomaticTaxLiabilityTypeX1b9e4d3d {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1QuotesPostRequestFormAutomaticTaxLiabilityTypeX1b9e4d3d =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1QuotesPostRequestFormAutomaticTaxLiabilityTypeX1b9e4d3d> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1QuotesPostRequestFormAutomaticTaxLiabilityTypeX1b9e4d3d",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1QuotesPostRequestFormAutomaticTaxLiabilityTypeX1b9e4d3d =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1QuotesPostRequestFormAutomaticTaxLiabilityTypeX1b9e4d3d,
        ) {
