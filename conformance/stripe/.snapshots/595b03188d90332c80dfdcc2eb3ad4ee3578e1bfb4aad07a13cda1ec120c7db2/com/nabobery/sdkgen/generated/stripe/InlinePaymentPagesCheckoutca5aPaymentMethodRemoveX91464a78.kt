...
public sealed class InlinePaymentPagesCheckoutca5aPaymentMethodRemoveX91464a78 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentPagesCheckoutca5aPaymentMethodRemoveX91464a78 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlinePaymentPagesCheckoutca5aPaymentMethodRemoveX91464a78> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentPagesCheckoutca5aPaymentMethodRemoveX91464a78",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePaymentPagesCheckoutca5aPaymentMethodRemoveX91464a78 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentPagesCheckoutca5aPaymentMethodRemoveX91464a78,
        ) {
