...
public class InlineV1PaymentIntentsConfirmPostRequestFormRadarOptionsX9a7ca3fe(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1PaymentIntentsConfirmPostRequestFormRadarOptionsX9a7ca3fe =
            InlineV1PaymentIntentsConfirmPostRequestFormRadarOptionsX9a7ca3fe(
                session = session,
            )
    }

    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PaymentIntentsConfirmPostRequestFormRadarOptionsX9a7ca3fe =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentIntentsConfirmPostRequestFormRadarOptionsX9a7ca3fe> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsConfirmPostRequestFormRadarOptionsX9a7ca3fe must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsConfirmPostRequestFormRadarOptionsX9a7ca3fe,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentIntentsConfirmPostRequestFormRadarOptionsX9a7ca3fe(
    block: InlineV1PaymentIntentsConfirmPostRequestFormRadarOptionsX9a7ca3fe.Builder.() -> Unit,
): InlineV1PaymentIntentsConfirmPostRequestFormRadarOptionsX9a7ca3fe =
