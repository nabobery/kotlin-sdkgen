...
public class InlineV1CheckoutSessionsPostRequestFormSubscriptionDataTrialSettingsX3ed2fa0f(
    public val endBehavior: InlineV1CheckoutSessionsPostRequestFormSubscriptionDataEndBehaviorX414fd5e3,
) {
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1CheckoutSessionsPostRequestFormSubscriptionDataTrialSettingsX3ed2fa0f =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormSubscriptionDataTrialSettingsX3ed2fa0f> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CheckoutSessionsPostRequestFormSubscriptionDataTrialSettingsX3ed2fa0f must be a JSON object",
                    )
            val endBehavior =
                json
                    .decodeRequired<InlineV1CheckoutSessionsPostRequestFormSubscriptionDataEndBehaviorX414fd5e3>(
                        rawObject,
                        "end_behavior",
                    )
            return InlineV1CheckoutSessionsPostRequestFormSubscriptionDataTrialSettingsX3ed2fa0f(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsPostRequestFormSubscriptionDataTrialSettingsX3ed2fa0f,
        ) {
            val jsonEncoder =
...
public fun inlineV1CheckoutSessionsPostRequestFormSubscriptionDataTrialSettingsX3ed2fa0f(
    block: InlineV1CheckoutSessionsPostRequestFormSubscriptionDataTrialSettingsX3ed2fa0f.Builder.() -> Unit,
): InlineV1CheckoutSessionsPostRequestFormSubscriptionDataTrialSettingsX3ed2fa0f =
    InlineV1CheckoutSessionsPostRequestFormSubscriptionDataTrialSettingsX3ed2fa0f.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1CheckoutSessionsPostRequestFormSubscriptionDataTrialSettingsX3ed2fa0f is missing required property '" +
                    name +
                    "'",
            )
