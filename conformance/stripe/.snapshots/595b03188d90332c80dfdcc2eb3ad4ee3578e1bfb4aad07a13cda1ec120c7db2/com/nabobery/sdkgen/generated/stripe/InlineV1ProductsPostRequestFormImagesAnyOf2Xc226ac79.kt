...
public sealed class InlineV1ProductsPostRequestFormImagesAnyOf2Xc226ac79 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1ProductsPostRequestFormImagesAnyOf2Xc226ac79 =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1ProductsPostRequestFormImagesAnyOf2Xc226ac79> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1ProductsPostRequestFormImagesAnyOf2Xc226ac79",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1ProductsPostRequestFormImagesAnyOf2Xc226ac79 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ProductsPostRequestFormImagesAnyOf2Xc226ac79,
        ) {
