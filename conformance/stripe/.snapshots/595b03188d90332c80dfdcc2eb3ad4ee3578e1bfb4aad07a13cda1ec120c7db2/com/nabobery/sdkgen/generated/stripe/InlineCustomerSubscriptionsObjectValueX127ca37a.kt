...
public sealed class InlineCustomerSubscriptionsObjectValueX127ca37a {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineCustomerSubscriptionsObjectValueX127ca37a =
            when (value) {
                List.value -> List
    ...
    public object Serializer : KSerializer<InlineCustomerSubscriptionsObjectValueX127ca37a> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineCustomerSubscriptionsObjectValueX127ca37a",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineCustomerSubscriptionsObjectValueX127ca37a =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineCustomerSubscriptionsObjectValueX127ca37a,
        ) {
