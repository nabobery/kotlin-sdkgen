...
public class InlineV1AccountsPeoplePostRequestFormRegisteredAddressXba767cfc(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1AccountsPeoplePostRequestFormRegisteredAddressXba767cfc =
            InlineV1AccountsPeoplePostRequestFormRegisteredAddressXba767cfc(
                city = city,
                country = country,
                line1 = line1,
                line2 = line2,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1AccountsPeoplePostRequestFormRegisteredAddressXba767cfc =
    ...
    public object Serializer : KSerializer<InlineV1AccountsPeoplePostRequestFormRegisteredAddressXba767cfc> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountsPeoplePostRequestFormRegisteredAddressXba767cfc must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPeoplePostRequestFormRegisteredAddressXba767cfc,
        ) {
            val jsonEncoder =
...
public fun inlineV1AccountsPeoplePostRequestFormRegisteredAddressXba767cfc(
    block: InlineV1AccountsPeoplePostRequestFormRegisteredAddressXba767cfc.Builder.() -> Unit,
): InlineV1AccountsPeoplePostRequestFormRegisteredAddressXba767cfc =
    InlineV1AccountsPeoplePostRequestFormRegisteredAddressXba767cfc.build(block)
