...
public class InboundTransfersPaymentMethodDetailsUsBankAccount(
     ...
     */
    public val accountType: InlineInboundTransfersPaymentMethodDetailsUsBankAccountAccountTypeX1f87d12c? = null,
    /**
     ...
     */
    public val mandate: InlineInboundTransfersPaymentMethodDetailsUsBankAccountMandateX5ef0400d? = null,
    /**
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InboundTransfersPaymentMethodDetailsUsBankAccount =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InboundTransfersPaymentMethodDetailsUsBankAccount> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InboundTransfersPaymentMethodDetailsUsBankAccount must be a JSON object",
                    )
            val network =
                json.decodeRequired<InlineInboundTransfersPaymentMethodDetailsUsBankAccountNetworkXca8f6023>(
                    rawObject,
                    "network",
                )
            return InboundTransfersPaymentMethodDetailsUsBankAccount(
                ...
                accountHolderType =
                    rawObject["account_holder_type"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineInboundTransfersPaymaf43AccountHolderTypeXc7c6f01f?>(
                                element,
                            )
                        }
                    },
                accountType =
                    rawObject["account_type"]?.let { element ->
                        if (element ==
                            ...
                            json
                                .decodeFromJsonElement<InlineInboundTransfersPaymentMethodDetailsUsBankAccountAccountTypeX1f87d12c?>(
                                    element,
                                )
                        }
                    },
                ...
                mandate =
                    rawObject["mandate"]?.let {
                        json
                            .decodeFromJsonElement<InlineInboundTransfersPaymentMethodDetailsUsBankAccountMandateX5ef0400d>(
                                it,
                            )
                    },
                routingNumber =
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InboundTransfersPaymentMethodDetailsUsBankAccount,
        ) {
...
public fun inboundTransfersPaymentMethodDetailsUsBankAccount(
    block: InboundTransfersPaymentMethodDetailsUsBankAccount.Builder.() -> Unit,
): InboundTransfersPaymentMethodDetailsUsBankAccount = InboundTransfersPaymentMethodDetailsUsBankAccount.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InboundTransfersPaymentMethodDetailsUsBankAccount is missing required property '" + name + "'",
            )
