...
public sealed class InlineV1CheckoutSessionsLineItemsGetResponse200JsonObjectValueXeea52be0 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1CheckoutSessionsLineItemsGetResponse200JsonObjectValueXeea52be0 =
            when (value) {
                List.value -> List
    ...
    public object Serializer : KSerializer<InlineV1CheckoutSessionsLineItemsGetResponse200JsonObjectValueXeea52be0> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1CheckoutSessionsLineItemsGetResponse200JsonObjectValueXeea52be0",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1CheckoutSessionsLineItemsGetResponse200JsonObjectValueXeea52be0 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsLineItemsGetResponse200JsonObjectValueXeea52be0,
        ) {
