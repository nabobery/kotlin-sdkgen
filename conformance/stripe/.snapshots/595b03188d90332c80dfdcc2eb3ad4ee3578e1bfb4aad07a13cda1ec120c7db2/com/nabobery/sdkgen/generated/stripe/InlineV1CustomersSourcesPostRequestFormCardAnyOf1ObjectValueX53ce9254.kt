...
public sealed class InlineV1CustomersSourcesPostRequestFormCardAnyOf1ObjectValueX53ce9254 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1CustomersSourcesPostRequestFormCardAnyOf1ObjectValueX53ce9254 =
            when (value) {
                Card.value -> Card
    ...
    public object Serializer : KSerializer<InlineV1CustomersSourcesPostRequestFormCardAnyOf1ObjectValueX53ce9254> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1CustomersSourcesPostRequestFormCardAnyOf1ObjectValueX53ce9254",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1CustomersSourcesPostRequestFormCardAnyOf1ObjectValueX53ce9254 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersSourcesPostRequestFormCardAnyOf1ObjectValueX53ce9254,
        ) {
