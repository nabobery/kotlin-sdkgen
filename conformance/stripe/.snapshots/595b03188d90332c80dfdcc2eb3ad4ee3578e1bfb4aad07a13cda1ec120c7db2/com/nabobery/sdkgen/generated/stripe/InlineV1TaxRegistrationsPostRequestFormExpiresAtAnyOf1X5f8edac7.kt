...
public sealed class InlineV1TaxRegistrationsPostRequestFormExpiresAtAnyOf1X5f8edac7 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1TaxRegistrationsPostRequestFormExpiresAtAnyOf1X5f8edac7 =
            when (value) {
                Now.value -> Now
    ...
    public object Serializer : KSerializer<InlineV1TaxRegistrationsPostRequestFormExpiresAtAnyOf1X5f8edac7> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1TaxRegistrationsPostRequestFormExpiresAtAnyOf1X5f8edac7",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1TaxRegistrationsPostRequestFormExpiresAtAnyOf1X5f8edac7 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TaxRegistrationsPostRequestFormExpiresAtAnyOf1X5f8edac7,
        ) {
