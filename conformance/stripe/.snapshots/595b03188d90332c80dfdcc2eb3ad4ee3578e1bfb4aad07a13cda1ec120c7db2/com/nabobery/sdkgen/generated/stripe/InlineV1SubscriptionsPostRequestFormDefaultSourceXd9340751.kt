...
internal data class InlineV1SubscriptionsPostRequestFormDefaultSourceXd9340751Inspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1SubscriptionsPostRequestFormDefaultSourceAnyOf2Xa23447ef,
            ).count { it }
}
...
public class InlineV1SubscriptionsPostRequestFormDefaultSourceXd9340751 internal constructor(
    ...
    public val inlineV1SubscriptionsPostRequestFormDefaultSourceAnyOf2Xa23447ef:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1SubscriptionsPostRequestFormDefaultSourceAnyOf2Xa23447ef) {
                json
                    .decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormDefaultSourceAnyOf2Xa23447ef>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1SubscriptionsPostRequestFormDefaultSourceXd9340751Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1SubscriptionsPostRequestFormDefaultSourceAnyOf2Xa23447ef) {
                    add(
                        InlineV1SubscriptionsPostRequestFormDefaultSourceXd9340751Branch.InlineV1SubscriptionsPostRequestFormDefaultSourceAnyOf2Xa23447ef,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1SubscriptionsPostRequestFormDefaultSourceXd9340751 {
            val inspection = inspectInlineV1SubscriptionsPostRequestFormDefaultSourceXd9340751(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1SubscriptionsPostRequestFormDefaultSourceXd9340751NoMatchException(
                    "InlineV1SubscriptionsPostRequestFormDefaultSourceXd9340751 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionsPostRequestFormDefaultSourceXd9340751> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsPostRequestFormDefaultSourceXd9340751,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1SubscriptionsPostRequestFormDefaultSourceXd9340751",
...
private fun inspectInlineV1SubscriptionsPostRequestFormDefaultSourceXd9340751(
    element: JsonElement,
): InlineV1SubscriptionsPostRequestFormDefaultSourceXd9340751Inspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1SubscriptionsPostRequestFormDefaultSourceAnyOf2Xa23447ef =
        element
            .isJsonDecodable<InlineV1SubscriptionsPostRequestFormDefaultSourceAnyOf2Xa23447ef>()
    return InlineV1SubscriptionsPostRequestFormDefaultSourceXd9340751Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1SubscriptionsPostRequestFormDefaultSourceAnyOf2Xa23447ef) {
                    add(
                        "InlineV1SubscriptionsPostRequestFormDefaultSourceAnyOf2Xa23447ef: value does not match InlineV1SubscriptionsPostRequestFormDefaultSourceAnyOf2Xa23447ef",
                    )
                }
            },
    )
