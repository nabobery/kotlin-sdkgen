...
public class InlineV1InvoicesUpdateLinesPostRequestFormLinesItemPriceDataProductDataXb15ffacf(
    ...
    public object Serializer : KSerializer<InlineV1InvoicesUpdateLinesPostRequestFormLinesItemPriceDataProductDataXb15ffacf> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1InvoicesUpdateLinesPostRequestFormLinesItemPriceDataProductDataXb15ffacf must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesUpdateLinesPostRequestFormLinesItemPriceDataProductDataXb15ffacf,
        ) {
            val jsonEncoder =
...
public fun inlineV1InvoicesUpdateLinesPostRequestFormLinesItemPriceDataProductDataXb15ffacf(
    block: InlineV1InvoicesUpdateLinesPostRequestFormLinesItemPriceDataProductDataXb15ffacf.Builder.() -> Unit,
): InlineV1InvoicesUpdateLinesPostRequestFormLinesItemPriceDataProductDataXb15ffacf =
    InlineV1InvoicesUpdateLinesPostRequestFormLinesItemPriceDataProductDataXb15ffacf.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1InvoicesUpdateLinesPostRequestFormLinesItemPriceDataProductDataXb15ffacf is missing required property '" +
                    name +
                    "'",
            )
