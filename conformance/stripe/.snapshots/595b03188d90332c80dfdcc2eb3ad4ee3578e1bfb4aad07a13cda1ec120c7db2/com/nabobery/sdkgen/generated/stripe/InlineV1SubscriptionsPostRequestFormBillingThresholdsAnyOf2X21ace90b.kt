...
public sealed class InlineV1SubscriptionsPostRequestFormBillingThresholdsAnyOf2X21ace90b {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1SubscriptionsPostRequestFormBillingThresholdsAnyOf2X21ace90b =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionsPostRequestFormBillingThresholdsAnyOf2X21ace90b> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1SubscriptionsPostRequestFormBillingThresholdsAnyOf2X21ace90b",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1SubscriptionsPostRequestFormBillingThresholdsAnyOf2X21ace90b = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsPostRequestFormBillingThresholdsAnyOf2X21ace90b,
        ) {
