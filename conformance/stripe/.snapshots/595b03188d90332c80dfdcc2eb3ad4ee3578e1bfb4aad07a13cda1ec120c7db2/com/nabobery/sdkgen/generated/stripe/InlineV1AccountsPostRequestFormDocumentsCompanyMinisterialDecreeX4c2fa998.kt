...
public class InlineV1AccountsPostRequestFormDocumentsCompanyMinisterialDecreeX4c2fa998(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1AccountsPostRequestFormDocumentsCompanyMinisterialDecreeX4c2fa998 =
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1AccountsPostRequestFormDocumentsCompanyMinisterialDecreeX4c2fa998 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1AccountsPostRequestFormDocumentsCompanyMinisterialDecreeX4c2fa998> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountsPostRequestFormDocumentsCompanyMinisterialDecreeX4c2fa998 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPostRequestFormDocumentsCompanyMinisterialDecreeX4c2fa998,
        ) {
            val jsonEncoder =
...
public fun inlineV1AccountsPostRequestFormDocumentsCompanyMinisterialDecreeX4c2fa998(
    block: InlineV1AccountsPostRequestFormDocumentsCompanyMinisterialDecreeX4c2fa998.Builder.() -> Unit,
): InlineV1AccountsPostRequestFormDocumentsCompanyMinisterialDecreeX4c2fa998 =
    InlineV1AccountsPostRequestFormDocumentsCompanyMinisterialDecreeX4c2fa998.build(block)
