...
public class InlineV1CheckoutSessionsPostRequestFormCustomerUpdateX6b07f2a0(
    ...
    public val shipping: InlineV1CheckoutSessionsPostRequestFormCustomerUpdateShippingXc58a18ab? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1CheckoutSessionsPostRequestFormCustomerUpdateX6b07f2a0 =
            InlineV1CheckoutSessionsPostRequestFormCustomerUpdateX6b07f2a0(
                address = address,
                name = name,
                shipping = shipping,
            )
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1CheckoutSessionsPostRequestFormCustomerUpdateX6b07f2a0 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormCustomerUpdateX6b07f2a0> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CheckoutSessionsPostRequestFormCustomerUpdateX6b07f2a0 must be a JSON object",
                    )
            return InlineV1CheckoutSessionsPostRequestFormCustomerUpdateX6b07f2a0(
                address =
                    rawObject["address"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormCustomerUpdateAddressXc6dfceb6>(
                                it,
                            )
                    },
                name =
                    rawObject["name"]?.let {
                        json.decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormCustomerUpdateNameXe5eb429f>(
                            it,
                        )
                    },
                shipping =
                    rawObject["shipping"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormCustomerUpdateShippingXc58a18ab>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsPostRequestFormCustomerUpdateX6b07f2a0,
        ) {
            val jsonEncoder =
...
public fun inlineV1CheckoutSessionsPostRequestFormCustomerUpdateX6b07f2a0(
    block: InlineV1CheckoutSessionsPostRequestFormCustomerUpdateX6b07f2a0.Builder.() -> Unit,
): InlineV1CheckoutSessionsPostRequestFormCustomerUpdateX6b07f2a0 =
    InlineV1CheckoutSessionsPostRequestFormCustomerUpdateX6b07f2a0.build(block)
