...
public class InlineV1CustomersBankAccountsGetResponse200JsonX8d3d4b93(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1CustomersBankAccountsGetResponse200JsonX8d3d4b93 =
    ...
    public object Serializer : KSerializer<InlineV1CustomersBankAccountsGetResponse200JsonX8d3d4b93> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CustomersBankAccountsGetResponse200JsonX8d3d4b93 must be a JSON object",
                    )
            val data = json.decodeRequired<List<BankAccount>>(rawObject, "data")
            val hasMore = json.decodeRequired<Boolean>(rawObject, "has_more")
            val objectValue =
                json.decodeRequired<InlineV1CustomersBankAccountsGetResponse200JsonObjectValueXb94138ed>(
                    rawObject,
                    "object",
                )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersBankAccountsGetResponse200JsonX8d3d4b93,
        ) {
...
public fun inlineV1CustomersBankAccountsGetResponse200JsonX8d3d4b93(
    block: InlineV1CustomersBankAccountsGetResponse200JsonX8d3d4b93.Builder.() -> Unit,
): InlineV1CustomersBankAccountsGetResponse200JsonX8d3d4b93 =
    InlineV1CustomersBankAccountsGetResponse200JsonX8d3d4b93.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1CustomersBankAccountsGetResponse200JsonX8d3d4b93 is missing required property '" + name + "'",
            )
