...
internal data class InlineV1TaxRegistrationsPostRequestFormActiveFromX0cdfd46aInspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesInlineV1TaxRegistrationsPostRequestFormActiveFromAnyOf1X0ed5ab40,
                matchesBranch2,
            ).count { it }
}
...
public class InlineV1TaxRegistrationsPostRequestFormActiveFromX0cdfd46a internal constructor(
    ...
    public val inlineV1TaxRegistrationsPostRequestFormActiveFromAnyOf1X0ed5ab40:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1TaxRegistrationsPostRequestFormActiveFromAnyOf1X0ed5ab40) {
                json
                    .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormActiveFromAnyOf1X0ed5ab40>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1TaxRegistrationsPostRequestFormActiveFromX0cdfd46aBranch>
        get() =
            buildSet {
                if (inspection.matchesInlineV1TaxRegistrationsPostRequestFormActiveFromAnyOf1X0ed5ab40) {
                    add(
                        InlineV1TaxRegistrationsPostRequestFormActiveFromX0cdfd46aBranch.InlineV1TaxRegistrationsPostRequestFormActiveFromAnyOf1X0ed5ab40,
                    )
                }
                if (inspection.matchesBranch2) {
                    add(
                        InlineV1TaxRegistrationsPostRequestFormActiveFromX0cdfd46aBranch.Branch2,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1TaxRegistrationsPostRequestFormActiveFromX0cdfd46a {
            val inspection = inspectInlineV1TaxRegistrationsPostRequestFormActiveFromX0cdfd46a(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1TaxRegistrationsPostRequestFormActiveFromX0cdfd46aNoMatchException(
                    "InlineV1TaxRegistrationsPostRequestFormActiveFromX0cdfd46a matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1TaxRegistrationsPostRequestFormActiveFromX0cdfd46a> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TaxRegistrationsPostRequestFormActiveFromX0cdfd46a,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1TaxRegistrationsPostRequestFormActiveFromX0cdfd46a",
...
private fun inspectInlineV1TaxRegistrationsPostRequestFormActiveFromX0cdfd46a(
    element: JsonElement,
): InlineV1TaxRegistrationsPostRequestFormActiveFromX0cdfd46aInspection {
    val matchesInlineV1TaxRegistrationsPostRequestFormActiveFromAnyOf1X0ed5ab40 =
        element
            .isJsonDecodable<InlineV1TaxRegistrationsPostRequestFormActiveFromAnyOf1X0ed5ab40>()
    ...
    return InlineV1TaxRegistrationsPostRequestFormActiveFromX0cdfd46aInspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1TaxRegistrationsPostRequestFormActiveFromAnyOf1X0ed5ab40) {
                    add(
                        "InlineV1TaxRegistrationsPostRequestFormActiveFromAnyOf1X0ed5ab40: value does not match InlineV1TaxRegistrationsPostRequestFormActiveFromAnyOf1X0ed5ab40",
                    )
                }
