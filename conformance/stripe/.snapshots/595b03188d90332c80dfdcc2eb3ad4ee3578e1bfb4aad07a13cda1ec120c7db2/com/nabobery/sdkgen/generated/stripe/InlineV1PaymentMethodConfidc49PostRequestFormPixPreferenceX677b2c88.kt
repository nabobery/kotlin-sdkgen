...
public sealed class InlineV1PaymentMethodConfidc49PostRequestFormPixPreferenceX677b2c88 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1PaymentMethodConfidc49PostRequestFormPixPreferenceX677b2c88 =
            when (value) {
                None.value -> None
                Off.value -> Off
                On.value -> On
    ...
    public object Serializer : KSerializer<InlineV1PaymentMethodConfidc49PostRequestFormPixPreferenceX677b2c88> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1PaymentMethodConfidc49PostRequestFormPixPreferenceX677b2c88",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1PaymentMethodConfidc49PostRequestFormPixPreferenceX677b2c88 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentMethodConfidc49PostRequestFormPixPreferenceX677b2c88,
        ) {
