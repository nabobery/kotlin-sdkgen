...
public class DisputePaymentMethodDetailsPaypal(
    ...
    public class Builder {
        ...
        public fun build(): DisputePaymentMethodDetailsPaypal =
    ...
    public object Serializer : KSerializer<DisputePaymentMethodDetailsPaypal> {
        ...
        override fun deserialize(decoder: Decoder): DisputePaymentMethodDetailsPaypal {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("DisputePaymentMethodDetailsPaypal must be a JSON object")
            return DisputePaymentMethodDetailsPaypal(
                caseId =
                    rawObject["case_id"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: DisputePaymentMethodDetailsPaypal,
        ) {
...
public fun disputePaymentMethodDetailsPaypal(
    block: DisputePaymentMethodDetailsPaypal.Builder.() -> Unit,
): DisputePaymentMethodDetailsPaypal = DisputePaymentMethodDetailsPaypal.build(block)
