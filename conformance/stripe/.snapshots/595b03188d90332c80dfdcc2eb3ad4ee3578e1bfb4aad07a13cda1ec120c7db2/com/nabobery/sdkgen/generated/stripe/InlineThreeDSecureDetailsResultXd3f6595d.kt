...
public sealed class InlineThreeDSecureDetailsResultXd3f6595d {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineThreeDSecureDetailsResultXd3f6595d =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineThreeDSecureDetailsResultXd3f6595d> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineThreeDSecureDetailsResultXd3f6595d",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineThreeDSecureDetailsResultXd3f6595d =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineThreeDSecureDetailsResultXd3f6595d,
        ) {
