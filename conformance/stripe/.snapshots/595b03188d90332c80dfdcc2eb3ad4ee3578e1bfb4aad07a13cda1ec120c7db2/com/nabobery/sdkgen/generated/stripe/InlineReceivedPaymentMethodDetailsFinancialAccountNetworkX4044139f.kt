...
public sealed class InlineReceivedPaymentMethodDetailsFinancialAccountNetworkX4044139f {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineReceivedPaymentMethodDetailsFinancialAccountNetworkX4044139f =
            when (value) {
                Stripe.value -> Stripe
    ...
    public object Serializer : KSerializer<InlineReceivedPaymentMethodDetailsFinancialAccountNetworkX4044139f> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineReceivedPaymentMethodDetailsFinancialAccountNetworkX4044139f",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineReceivedPaymentMethodDetailsFinancialAccountNetworkX4044139f =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineReceivedPaymentMethodDetailsFinancialAccountNetworkX4044139f,
        ) {
