...
public class InlineV1InvoicesSearchGetResponse200JsonX2e73b6f3(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1InvoicesSearchGetResponse200JsonX2e73b6f3 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1InvoicesSearchGetResponse200JsonX2e73b6f3> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1InvoicesSearchGetResponse200JsonX2e73b6f3 must be a JSON object",
                    )
            val data = json.decodeRequired<List<Invoice>>(rawObject, "data")
            val hasMore = json.decodeRequired<Boolean>(rawObject, "has_more")
            val objectValue =
                json.decodeRequired<InlineV1InvoicesSearchGetResponse200JsonObjectValueX5ff404be>(
                    rawObject,
                    "object",
                )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesSearchGetResponse200JsonX2e73b6f3,
        ) {
...
public fun inlineV1InvoicesSearchGetResponse200JsonX2e73b6f3(
    block: InlineV1InvoicesSearchGetResponse200JsonX2e73b6f3.Builder.() -> Unit,
): InlineV1InvoicesSearchGetResponse200JsonX2e73b6f3 = InlineV1InvoicesSearchGetResponse200JsonX2e73b6f3.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1InvoicesSearchGetResponse200JsonX2e73b6f3 is missing required property '" + name + "'",
            )
