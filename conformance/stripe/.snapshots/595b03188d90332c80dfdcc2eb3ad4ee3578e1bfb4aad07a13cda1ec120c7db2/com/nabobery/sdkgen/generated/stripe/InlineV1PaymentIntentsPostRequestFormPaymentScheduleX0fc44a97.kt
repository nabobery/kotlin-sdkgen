...
public sealed class InlineV1PaymentIntentsPostRequestFormPaymentScheduleX0fc44a97 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1PaymentIntentsPostRequestFormPaymentScheduleX0fc44a97 =
            when (value) {
                Value.value -> Value
                Adhoc.value -> Adhoc
                Annual.value -> Annual
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormPaymentScheduleX0fc44a97> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1PaymentIntentsPostRequestFormPaymentScheduleX0fc44a97",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1PaymentIntentsPostRequestFormPaymentScheduleX0fc44a97 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormPaymentScheduleX0fc44a97,
        ) {
