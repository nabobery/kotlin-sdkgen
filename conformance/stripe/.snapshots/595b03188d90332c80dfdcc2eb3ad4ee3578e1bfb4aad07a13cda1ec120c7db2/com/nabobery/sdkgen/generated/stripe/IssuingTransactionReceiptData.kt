...
public class IssuingTransactionReceiptData(
    ...
    public class Builder {
        ...
        public fun build(): IssuingTransactionReceiptData =
    ...
    public object Serializer : KSerializer<IssuingTransactionReceiptData> {
        ...
        override fun deserialize(decoder: Decoder): IssuingTransactionReceiptData {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("IssuingTransactionReceiptData must be a JSON object")
            return IssuingTransactionReceiptData(
                ...
                unitCost =
                    rawObject["unit_cost"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: IssuingTransactionReceiptData,
        ) {
...
public fun issuingTransactionReceiptData(
    block: IssuingTransactionReceiptData.Builder.() -> Unit,
): IssuingTransactionReceiptData = IssuingTransactionReceiptData.build(block)
