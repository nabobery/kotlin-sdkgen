    ...
    public object Serializer : KSerializer<InlineSubscriptionsTrialsResourceEndBehaviorMissingPaymentMethodX58fdd33b> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineSubscriptionsTrialsResourceEndBehaviorMissingPaymentMethodX58fdd33b",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineSubscriptionsTrialsResourceEndBehaviorMissingPaymentMethodX58fdd33b = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineSubscriptionsTrialsResourceEndBehaviorMissingPaymentMethodX58fdd33b,
        ) {
