...
public class InlineDisputeEvidenceCancellationPolicyXcaf1ed70 internal constructor(
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineDisputeEvidenceCancellationPolicyXcaf1ed70 {
            val inspection = inspectInlineDisputeEvidenceCancellationPolicyXcaf1ed70(raw)
            if (inspection.matchCount == 0) {
                throw InlineDisputeEvidenceCancellationPolicyXcaf1ed70NoMatchException(
                    "InlineDisputeEvidenceCancellationPolicyXcaf1ed70 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineDisputeEvidenceCancellationPolicyXcaf1ed70> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineDisputeEvidenceCancellationPolicyXcaf1ed70,
        ) {
...
private fun inspectInlineDisputeEvidenceCancellationPolicyXcaf1ed70(
    element: JsonElement,
): InlineDisputeEvidenceCancellationPolicyXcaf1ed70Inspection {
