...
public class SubscriptionsResourceSubscriptionPresentmentDetails(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): SubscriptionsResourceSubscriptionPresentmentDetails =
    ...
    public object Serializer : KSerializer<SubscriptionsResourceSubscriptionPresentmentDetails> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "SubscriptionsResourceSubscriptionPresentmentDetails must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: SubscriptionsResourceSubscriptionPresentmentDetails,
        ) {
...
public fun subscriptionsResourceSubscriptionPresentmentDetails(
    block: SubscriptionsResourceSubscriptionPresentmentDetails.Builder.() -> Unit,
): SubscriptionsResourceSubscriptionPresentmentDetails =
    SubscriptionsResourceSubscriptionPresentmentDetails.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "SubscriptionsResourceSubscriptionPresentmentDetails is missing required property '" + name + "'",
            )
