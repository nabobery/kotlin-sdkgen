...
public class InlineV1CustomersCardsPostRequestFormBankAccountAnyOf1X93f8721a(
    ...
    public val objectValue: InlineV1CustomersCardsPostRequestFormBankAccountAnyOf1ObjectValueX53d56ed8? = null,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1CustomersCardsPostRequestFormBankAccountAnyOf1X93f8721a =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1CustomersCardsPostRequestFormBankAccountAnyOf1X93f8721a> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CustomersCardsPostRequestFormBankAccountAnyOf1X93f8721a must be a JSON object",
                    )
            ...
            return InlineV1CustomersCardsPostRequestFormBankAccountAnyOf1X93f8721a(
                ...
                accountHolderType =
                    rawObject["account_holder_type"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CustomersCardsPostRequestFormBankAccountAnyOf1AccountHolderTypeX9ef262c2>(
                                it,
                            )
                    },
                ...
                objectValue =
                    rawObject["object"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CustomersCardsPostRequestFormBankAccountAnyOf1ObjectValueX53d56ed8>(
                                it,
                            )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersCardsPostRequestFormBankAccountAnyOf1X93f8721a,
        ) {
            val jsonEncoder =
...
public fun inlineV1CustomersCardsPostRequestFormBankAccountAnyOf1X93f8721a(
    block: InlineV1CustomersCardsPostRequestFormBankAccountAnyOf1X93f8721a.Builder.() -> Unit,
): InlineV1CustomersCardsPostRequestFormBankAccountAnyOf1X93f8721a =
    InlineV1CustomersCardsPostRequestFormBankAccountAnyOf1X93f8721a.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1CustomersCardsPostRequestFormBankAccountAnyOf1X93f8721a is missing required property '" + name +
                    "'",
            )
