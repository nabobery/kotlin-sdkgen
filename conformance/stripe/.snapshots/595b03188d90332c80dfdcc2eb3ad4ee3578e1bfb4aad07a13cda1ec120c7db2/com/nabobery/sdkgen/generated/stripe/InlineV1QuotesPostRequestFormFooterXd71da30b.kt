...
public class InlineV1QuotesPostRequestFormFooterXd71da30b internal constructor(
    ...
    public val inlineV1QuotesPostRequestFormFooterAnyOf2Xc84dafc4:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1QuotesPostRequestFormFooterAnyOf2Xc84dafc4) {
                json
                    .decodeFromJsonElement<InlineV1QuotesPostRequestFormFooterAnyOf2Xc84dafc4>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1QuotesPostRequestFormFooterXd71da30bBranch>
        get() =
            buildSet {
                ...
                if (inspection.matchesInlineV1QuotesPostRequestFormFooterAnyOf2Xc84dafc4) {
                    add(
                        InlineV1QuotesPostRequestFormFooterXd71da30bBranch.InlineV1QuotesPostRequestFormFooterAnyOf2Xc84dafc4,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1QuotesPostRequestFormFooterXd71da30b {
            val inspection = inspectInlineV1QuotesPostRequestFormFooterXd71da30b(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1QuotesPostRequestFormFooterXd71da30bNoMatchException(
                    "InlineV1QuotesPostRequestFormFooterXd71da30b matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1QuotesPostRequestFormFooterXd71da30b> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1QuotesPostRequestFormFooterXd71da30b,
        ) {
...
private fun inspectInlineV1QuotesPostRequestFormFooterXd71da30b(
    element: JsonElement,
): InlineV1QuotesPostRequestFormFooterXd71da30bInspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1QuotesPostRequestFormFooterAnyOf2Xc84dafc4 =
        element
            .isJsonDecodable<InlineV1QuotesPostRequestFormFooterAnyOf2Xc84dafc4>()
    return InlineV1QuotesPostRequestFormFooterXd71da30bInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1QuotesPostRequestFormFooterAnyOf2Xc84dafc4) {
                    add(
                        "InlineV1QuotesPostRequestFormFooterAnyOf2Xc84dafc4: value does not match InlineV1QuotesPostRequestFormFooterAnyOf2Xc84dafc4",
                    )
                }
            },
    )
