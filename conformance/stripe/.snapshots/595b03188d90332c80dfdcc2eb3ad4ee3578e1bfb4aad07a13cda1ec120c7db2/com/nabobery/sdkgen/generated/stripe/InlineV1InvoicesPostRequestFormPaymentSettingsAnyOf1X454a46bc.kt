...
public class InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X454a46bc(
    public val amountIncludesIof: InlineV1InvoicesPostRequestFormPaymentSettingsAmountIncludesIofX2423a186? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X454a46bc =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X454a46bc =
    ...
    public object Serializer : KSerializer<InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X454a46bc> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X454a46bc must be a JSON object",
                    )
            return InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X454a46bc(
                amountIncludesIof =
                    rawObject["amount_includes_iof"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1InvoicesPostRequestFormPaymentSettingsAmountIncludesIofX2423a186>(
                                it,
                            )
                    },
                expiresAfterSeconds =
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X454a46bc,
        ) {
            val jsonEncoder =
...
public fun inlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X454a46bc(
    block: InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X454a46bc.Builder.() -> Unit,
): InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X454a46bc =
    InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X454a46bc.build(block)
