...
public class InlineV1InvoicePaymentsGetParameterX2b044224(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1InvoicePaymentsGetParameterX2b044224 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1InvoicePaymentsGetParameterX2b044224> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1InvoicePaymentsGetParameterX2b044224 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicePaymentsGetParameterX2b044224,
        ) {
...
public fun inlineV1InvoicePaymentsGetParameterX2b044224(
    block: InlineV1InvoicePaymentsGetParameterX2b044224.Builder.() -> Unit,
): InlineV1InvoicePaymentsGetParameterX2b044224 = InlineV1InvoicePaymentsGetParameterX2b044224.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1InvoicePaymentsGetParameterX2b044224 is missing required property '" + name + "'",
            )
