...
public class InlineV1TreasuryFinancialAccountsPostRequestFormFeaturesXf3055bef(
    public val cardIssuing: InlineV1TreasuryFinancialAccountsPostRequestFormFeaturesCardIssuingXfc283de3? = null,
    public val depositInsurance: InlineV1TreasuryFinancialAc862PostRequestFormFeaturesDepositInsuranceXce3cf708? = null,
    public val financialAddresses:
        InlineV1TreasuryFinancialAc862PostRequestFormFeaturesFinancialAddressesXbebbf962? = null,
    public val inboundTransfers: InlineV1TreasuryFinancialAc862PostRequestFormFeaturesInboundTransfersXe1e3fdcd? = null,
    public val intraStripeFlows: InlineV1TreasuryFinancialAc862PostRequestFormFeaturesIntraStripeFlowsX1d590b34? = null,
    public val outboundPayments: InlineV1TreasuryFinancialAc862PostRequestFormFeaturesOutboundPaymentsX4fad88c8? = null,
    public val outboundTransfers: InlineV1TreasuryFinancialAc862PostRequestFormFeaturesOutboundTransfersXccfef52d? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1TreasuryFinancialAccountsPostRequestFormFeaturesXf3055bef =
            InlineV1TreasuryFinancialAccountsPostRequestFormFeaturesXf3055bef(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TreasuryFinancialAccountsPostRequestFormFeaturesXf3055bef =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TreasuryFinancialAccountsPostRequestFormFeaturesXf3055bef> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TreasuryFinancialAccountsPostRequestFormFeaturesXf3055bef must be a JSON object",
                    )
            return InlineV1TreasuryFinancialAccountsPostRequestFormFeaturesXf3055bef(
                cardIssuing =
                    rawObject["card_issuing"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TreasuryFinancialAccountsPostRequestFormFeaturesCardIssuingXfc283de3>(
                                it,
                            )
                    },
                depositInsurance =
                    rawObject["deposit_insurance"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TreasuryFinancialAc862PostRequestFormFeaturesDepositInsuranceXce3cf708>(
                                it,
                            )
                    },
                financialAddresses =
                    rawObject["financial_addresses"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TreasuryFinancialAc862PostRequestFormFeaturesFinancialAddressesXbebbf962>(
                                it,
                            )
                    },
                inboundTransfers =
                    rawObject["inbound_transfers"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TreasuryFinancialAc862PostRequestFormFeaturesInboundTransfersXe1e3fdcd>(
                                it,
                            )
                    },
                intraStripeFlows =
                    rawObject["intra_stripe_flows"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TreasuryFinancialAc862PostRequestFormFeaturesIntraStripeFlowsX1d590b34>(
                                it,
                            )
                    },
                outboundPayments =
                    rawObject["outbound_payments"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TreasuryFinancialAc862PostRequestFormFeaturesOutboundPaymentsX4fad88c8>(
                                it,
                            )
                    },
                outboundTransfers =
                    rawObject["outbound_transfers"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TreasuryFinancialAc862PostRequestFormFeaturesOutboundTransfersXccfef52d>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TreasuryFinancialAccountsPostRequestFormFeaturesXf3055bef,
        ) {
            val jsonEncoder =
...
public fun inlineV1TreasuryFinancialAccountsPostRequestFormFeaturesXf3055bef(
    block: InlineV1TreasuryFinancialAccountsPostRequestFormFeaturesXf3055bef.Builder.() -> Unit,
): InlineV1TreasuryFinancialAccountsPostRequestFormFeaturesXf3055bef =
    InlineV1TreasuryFinancialAccountsPostRequestFormFeaturesXf3055bef.build(block)
