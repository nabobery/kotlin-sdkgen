...
public class InlineTreasuryTransactionEntriesX6cf91389(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineTreasuryTransactionEntriesX6cf91389 =
    ...
    public object Serializer : KSerializer<InlineTreasuryTransactionEntriesX6cf91389> {
        ...
        override fun deserialize(decoder: Decoder): InlineTreasuryTransactionEntriesX6cf91389 {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("InlineTreasuryTransactionEntriesX6cf91389 must be a JSON object")
            ...
            val objectValue =
                json.decodeRequired<InlineTreasuryTransactionEntriesObjectValueXea010c31>(
                    rawObject,
                    "object",
                )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineTreasuryTransactionEntriesX6cf91389,
        ) {
...
public fun inlineTreasuryTransactionEntriesX6cf91389(
    block: InlineTreasuryTransactionEntriesX6cf91389.Builder.() -> Unit,
): InlineTreasuryTransactionEntriesX6cf91389 = InlineTreasuryTransactionEntriesX6cf91389.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineTreasuryTransactionEntriesX6cf91389 is missing required property '" + name + "'",
            )
