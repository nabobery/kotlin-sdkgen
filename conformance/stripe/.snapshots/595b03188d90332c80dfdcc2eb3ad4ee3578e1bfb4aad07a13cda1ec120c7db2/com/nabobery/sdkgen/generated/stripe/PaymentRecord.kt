...
@Serializable
public data class PaymentRecordView(
...
public class PaymentRecord(
    ...
    public object Serializer : KSerializer<PaymentRecord> {
        ...
        override fun deserialize(decoder: Decoder): PaymentRecord {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentRecord must be a JSON object")
            ...
            return PaymentRecord(
                ...
                customerDetails =
                    rawObject["customer_details"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentRecordCustomerDetailsXaff9aeda?>(element)
                        }
                    },
                customerPresence =
                    rawObject["customer_presence"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentRecordCustomerPresenceX0eda3266?>(element)
                        }
                    },
                description =
                ...
                latestPaymentAttemptRecord =
                    rawObject["latest_payment_attempt_record"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                paymentMethodDetails =
                    rawObject["payment_method_details"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentRecordPaymentMethodDetailsX99046c4c?>(element)
                        }
                    },
                shippingDetails =
                    rawObject["shipping_details"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentRecordShippingDetailsXb7edc24f?>(element)
                        }
                    },
            )
        }
