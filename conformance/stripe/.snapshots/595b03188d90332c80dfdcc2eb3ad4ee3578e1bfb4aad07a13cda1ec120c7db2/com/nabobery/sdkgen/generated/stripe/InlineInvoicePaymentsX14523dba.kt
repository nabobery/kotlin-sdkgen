...
public class InlineInvoicePaymentsX14523dba(
    ...
    public object Serializer : KSerializer<InlineInvoicePaymentsX14523dba> {
        ...
        override fun deserialize(decoder: Decoder): InlineInvoicePaymentsX14523dba {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("InlineInvoicePaymentsX14523dba must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineInvoicePaymentsX14523dba,
        ) {
...
public fun inlineInvoicePaymentsX14523dba(
    block: InlineInvoicePaymentsX14523dba.Builder.() -> Unit,
): InlineInvoicePaymentsX14523dba = InlineInvoicePaymentsX14523dba.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineInvoicePaymentsX14523dba is missing required property '" + name + "'",
            )
