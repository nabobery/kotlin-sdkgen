...
internal data class InlineV1IssuingDisputesPostRequestFormEvidenceDuplicateCardStatementX465a104bInspection(
    ...
    public val matchesInlineV1IssuingDisputesPostRequestFormEvidenceDuplicateAnyOf1AnyOf2X58aaec40: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1IssuingDisputesPostRequestFormEvidenceDuplicateAnyOf1AnyOf2X58aaec40,
            ).count {
                it
            }
}
...
public class InlineV1IssuingDisputesPostRequestFormEvidenceDuplicateCardStatementX465a104b internal constructor(
    ...
    private val inspection: InlineV1IssuingDisputesPostRequestFormEvidenceDuplicateCardStatementX465a104bInspection,
) {
    ...
    public val inlineV1IssuingDisputesPostRequestFormEvidenceDuplicateAnyOf1AnyOf2X58aaec40:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1IssuingDisputesPostRequestFormEvidenceDuplicateAnyOf1AnyOf2X58aaec40) {
                json
                    .decodeFromJsonElement<InlineV1IssuingDisputesPostRequestFormEvidenceDuplicateAnyOf1AnyOf2X58aaec40>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1IssuingDisputesPostRequestFormEvidenceDuplicateCardStatementX465a104bBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1IssuingDisputesPostRequestFormEvidenceDuplicateAnyOf1AnyOf2X58aaec40) {
                    add(
                        InlineV1IssuingDisputesPostRequestFormEvidenceDuplicateCardStatementX465a104bBranch.InlineV1IssuingDisputesPostRequestFormEvidenceDuplicateAnyOf1AnyOf2X58aaec40,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1IssuingDisputesPostRequestFormEvidenceDuplicateCardStatementX465a104b {
            val inspection = inspectInlineV1IssuingDisputesPostRequestFormEvidenceDuplicateCardStatementX465a104b(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1IssuingDisputesPostRequestFormEvidenceDuplicateCardStatementX465a104bNoMatchException(
                    "InlineV1IssuingDisputesPostRequestFormEvidenceDuplicateCardStatementX465a104b matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1IssuingDisputesPostRequestFormEvidenceDuplicateCardStatementX465a104b> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingDisputesPostRequestFormEvidenceDuplicateCardStatementX465a104b,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1IssuingDisputesPostRequestFormEvidenceDuplicateCardStatementX465a104b",
...
private fun inspectInlineV1IssuingDisputesPostRequestFormEvidenceDuplicateCardStatementX465a104b(
    element: JsonElement,
): InlineV1IssuingDisputesPostRequestFormEvidenceDuplicateCardStatementX465a104bInspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1IssuingDisputesPostRequestFormEvidenceDuplicateAnyOf1AnyOf2X58aaec40 =
        element
            .isJsonDecodable<InlineV1IssuingDisputesPostRequestFormEvidenceDuplicateAnyOf1AnyOf2X58aaec40>()
    return InlineV1IssuingDisputesPostRequestFormEvidenceDuplicateCardStatementX465a104bInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1IssuingDisputesPostRequestFormEvidenceDuplicateAnyOf1AnyOf2X58aaec40) {
                    add(
                        "InlineV1IssuingDisputesPostRequestFormEvidenceDuplicateAnyOf1AnyOf2X58aaec40: value does not match InlineV1IssuingDisputesPostRequestFormEvidenceDuplicateAnyOf1AnyOf2X58aaec40",
                    )
                }
            },
    )
