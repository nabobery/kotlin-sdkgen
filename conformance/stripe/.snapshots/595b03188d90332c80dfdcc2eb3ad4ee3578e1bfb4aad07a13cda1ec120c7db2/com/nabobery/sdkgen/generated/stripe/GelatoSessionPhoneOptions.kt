...
public class GelatoSessionPhoneOptions(
    ...
    public class Builder {
        ...
        public fun build(): GelatoSessionPhoneOptions =
    ...
    public object Serializer : KSerializer<GelatoSessionPhoneOptions> {
        ...
        override fun deserialize(decoder: Decoder): GelatoSessionPhoneOptions {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("GelatoSessionPhoneOptions must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: GelatoSessionPhoneOptions,
        ) {
...
public fun gelatoSessionPhoneOptions(block: GelatoSessionPhoneOptions.Builder.() -> Unit): GelatoSessionPhoneOptions =
    GelatoSessionPhoneOptions.build(block)
