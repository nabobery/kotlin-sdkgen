...
public class InlineV1TerminalConfigurationsPostRequestFormXaab7b325(
     ...
     */
    public val bbposWisepad3: InlineV1TerminalConfigurationsPostRequestFormBbposWisepad3Xb40e464d? = null,
    /**
     * An object containing device type specific settings for BBPOS WisePOS E readers.
     */
    public val bbposWiseposE: InlineV1TerminalConfigurationsPostRequestFormBbposWiseposEX243645c7? = null,
    /**
     ...
     */
    public val rebootWindow: InlineV1TerminalConfigurationsPostRequestFormRebootWindowX53e669c4? = null,
    /**
     ...
     */
    public val verifoneM425: InlineV1TerminalConfigurationsPostRequestFormVerifoneM425X3cdb3510? = null,
    /**
     * An object containing device type specific settings for Verifone P400 readers.
     */
    public val verifoneP400: InlineV1TerminalConfigurationsPostRequestFormVerifoneP400X801c80d6? = null,
    /**
     * An object containing device type specific settings for Verifone P630 readers.
     */
    public val verifoneP630: InlineV1TerminalConfigurationsPostRequestFormVerifoneP630X04384c33? = null,
    /**
     * An object containing device type specific settings for Verifone UX700 readers.
     */
    public val verifoneUx700: InlineV1TerminalConfigurationsPostRequestFormVerifoneUx700Xedb0d16a? = null,
    /**
     * An object containing device type specific settings for Verifone V660p readers.
     */
    public val verifoneV660p: InlineV1TerminalConfigurationsPostRequestFormVerifoneV660pX7b182895? = null,
    /**
    ...
    public class Builder {
        ...
        public fun build(): InlineV1TerminalConfigurationsPostRequestFormXaab7b325 =
            InlineV1TerminalConfigurationsPostRequestFormXaab7b325(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TerminalConfigurationsPostRequestFormXaab7b325 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TerminalConfigurationsPostRequestFormXaab7b325> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TerminalConfigurationsPostRequestFormXaab7b325 must be a JSON object",
                    )
            return InlineV1TerminalConfigurationsPostRequestFormXaab7b325(
                bbposWisepad3 =
                    rawObject["bbpos_wisepad3"]?.let {
                        json.decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormBbposWisepad3Xb40e464d>(
                            it,
                        )
                    },
                bbposWiseposE =
                    rawObject["bbpos_wisepos_e"]?.let {
                        json.decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormBbposWiseposEX243645c7>(
                            it,
                        )
                    },
                cellular =
                    rawObject["cellular"]?.let {
                        json.decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormCellularX9644e4da>(it)
                    },
                expand = rawObject["expand"]?.let { json.decodeFromJsonElement<List<String>>(it) },
                name = rawObject["name"]?.let { json.decodeFromJsonElement<String>(it) },
                offline =
                    rawObject["offline"]?.let {
                        json.decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormOfflineX683c0a81>(it)
                    },
                rebootWindow =
                    rawObject["reboot_window"]?.let {
                        json.decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormRebootWindowX53e669c4>(
                            it,
                        )
                    },
                stripeS700 =
                    rawObject["stripe_s700"]?.let {
                        json.decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormStripeS700Xd691cbe3>(it)
                    },
                stripeS710 =
                    rawObject["stripe_s710"]?.let {
                        json.decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormStripeS710X72a53b6d>(it)
                    },
                tipping =
                    rawObject["tipping"]?.let {
                        json.decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormTippingXf02f9cf7>(it)
                    },
                verifoneM425 =
                    rawObject["verifone_m425"]?.let {
                        json.decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormVerifoneM425X3cdb3510>(
                            it,
                        )
                    },
                verifoneP400 =
                    rawObject["verifone_p400"]?.let {
                        json.decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormVerifoneP400X801c80d6>(
                            it,
                        )
                    },
                verifoneP630 =
                    rawObject["verifone_p630"]?.let {
                        json.decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormVerifoneP630X04384c33>(
                            it,
                        )
                    },
                verifoneUx700 =
                    rawObject["verifone_ux700"]?.let {
                        json.decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormVerifoneUx700Xedb0d16a>(
                            it,
                        )
                    },
                verifoneV660p =
                    rawObject["verifone_v660p"]?.let {
                        json.decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormVerifoneV660pX7b182895>(
                            it,
                        )
                    },
                wifi =
                    rawObject["wifi"]?.let {
                        json.decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormWifiX5e52b0ba>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TerminalConfigurationsPostRequestFormXaab7b325,
        ) {
...
public fun inlineV1TerminalConfigurationsPostRequestFormXaab7b325(
    block: InlineV1TerminalConfigurationsPostRequestFormXaab7b325.Builder.() -> Unit,
): InlineV1TerminalConfigurationsPostRequestFormXaab7b325 =
    InlineV1TerminalConfigurationsPostRequestFormXaab7b325.build(block)
