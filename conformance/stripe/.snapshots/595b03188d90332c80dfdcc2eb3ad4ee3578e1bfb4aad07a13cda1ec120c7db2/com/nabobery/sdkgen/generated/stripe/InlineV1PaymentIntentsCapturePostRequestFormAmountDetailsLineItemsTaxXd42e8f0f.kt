...
public class InlineV1PaymentIntentsCapturePostRequestFormAmountDetailsLineItemsTaxXd42e8f0f(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentIntentsCapturePostRequestFormAmountDetailsLineItemsTaxXd42e8f0f =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentIntentsCapturePostRequestFormAmountDetailsLineItemsTaxXd42e8f0f> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsCapturePostRequestFormAmountDetailsLineItemsTaxXd42e8f0f must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsCapturePostRequestFormAmountDetailsLineItemsTaxXd42e8f0f,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentIntentsCapturePostRequestFormAmountDetailsLineItemsTaxXd42e8f0f(
    block: InlineV1PaymentIntentsCapturePostRequestFormAmountDetailsLineItemsTaxXd42e8f0f.Builder.() -> Unit,
): InlineV1PaymentIntentsCapturePostRequestFormAmountDetailsLineItemsTaxXd42e8f0f =
    InlineV1PaymentIntentsCapturePostRequestFormAmountDetailsLineItemsTaxXd42e8f0f.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentIntentsCapturePostRequestFormAmountDetailsLineItemsTaxXd42e8f0f is missing required property '" +
                    name +
                    "'",
            )
