...
public sealed class InlineV1BillingMetersPostRequestFormCustomerMappingTypeX9591eda8 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1BillingMetersPostRequestFormCustomerMappingTypeX9591eda8 =
            when (value) {
                ById.value -> ById
    ...
    public object Serializer : KSerializer<InlineV1BillingMetersPostRequestFormCustomerMappingTypeX9591eda8> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1BillingMetersPostRequestFormCustomerMappingTypeX9591eda8",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1BillingMetersPostRequestFormCustomerMappingTypeX9591eda8 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1BillingMetersPostRequestFormCustomerMappingTypeX9591eda8,
        ) {
