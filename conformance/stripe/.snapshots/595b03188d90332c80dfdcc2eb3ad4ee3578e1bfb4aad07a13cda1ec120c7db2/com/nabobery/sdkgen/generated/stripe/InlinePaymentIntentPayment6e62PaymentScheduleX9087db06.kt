...
public sealed class InlinePaymentIntentPayment6e62PaymentScheduleX9087db06 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentIntentPayment6e62PaymentScheduleX9087db06 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlinePaymentIntentPayment6e62PaymentScheduleX9087db06> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentIntentPayment6e62PaymentScheduleX9087db06",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePaymentIntentPayment6e62PaymentScheduleX9087db06 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentIntentPayment6e62PaymentScheduleX9087db06,
        ) {
