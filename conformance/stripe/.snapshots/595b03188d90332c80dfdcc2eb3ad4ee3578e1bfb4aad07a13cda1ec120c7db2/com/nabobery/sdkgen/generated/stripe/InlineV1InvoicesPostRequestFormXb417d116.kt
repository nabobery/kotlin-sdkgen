...
public class InlineV1InvoicesPostRequestFormXb417d116(
     ...
     */
    public val defaultTaxRates: List<String>? = null,
    /**
     ...
     */
    public val pendingInvoiceItemsBehavior: InlineV1InvoicesPostRequestFormPendingInvoiceItemsBehaviorX0af94a86? = null,
    /**
    ...
    public class Builder {
         ...
         * The tax rates that will apply to any line item that does not have `tax_rates` set.
         */
        public var defaultTaxRates: List<String>? = null
        ...
        public fun build(): InlineV1InvoicesPostRequestFormXb417d116 =
            InlineV1InvoicesPostRequestFormXb417d116(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1InvoicesPostRequestFormXb417d116 =
    ...
    public object Serializer : KSerializer<InlineV1InvoicesPostRequestFormXb417d116> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1InvoicesPostRequestFormXb417d116 {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("InlineV1InvoicesPostRequestFormXb417d116 must be a JSON object")
            return InlineV1InvoicesPostRequestFormXb417d116(
                accountTaxIds =
                    rawObject["account_tax_ids"]?.let {
                        json.decodeFromJsonElement<InlineV1InvoicesPostRequestFormAccountTaxIdsX6b707a5b>(it)
                    },
                ...
                automaticTax =
                    rawObject["automatic_tax"]?.let {
                        json.decodeFromJsonElement<InlineV1InvoicesPostRequestFormAutomaticTaxX6ee84378>(it)
                    },
                ...
                collectionMethod =
                    rawObject["collection_method"]?.let {
                        json.decodeFromJsonElement<InlineV1InvoicesPostRequestFormCollectionMethodX6930c6ee>(it)
                    },
                currency = rawObject["currency"]?.let { json.decodeFromJsonElement<String>(it) },
                customFields =
                    rawObject["custom_fields"]?.let {
                        json.decodeFromJsonElement<InlineV1InvoicesPostRequestFormCustomFieldsX0b703902>(it)
                    },
                ...
                discounts =
                    rawObject["discounts"]?.let {
                        json.decodeFromJsonElement<InlineV1InvoicesPostRequestFormDiscountsXf910c8f0>(it)
                    },
                ...
                fromInvoice =
                    rawObject["from_invoice"]?.let {
                        json.decodeFromJsonElement<InlineV1InvoicesPostRequestFormFromInvoiceX08e77076>(it)
                    },
                issuer =
                    rawObject["issuer"]?.let {
                        json.decodeFromJsonElement<InlineV1InvoicesPostRequestFormIssuerXbd5c59bd>(
                            it,
                        )
                    },
                metadata =
                    rawObject["metadata"]?.let {
                        json.decodeFromJsonElement<InlineV1InvoicesPostRequestFormMetadataXb27b75dd>(it)
                    },
                ...
                paymentSettings =
                    rawObject["payment_settings"]?.let {
                        json.decodeFromJsonElement<InlineV1InvoicesPostRequestFormPaymentSettingsX9261382c>(it)
                    },
                pendingInvoiceItemsBehavior =
                    rawObject["pending_invoice_items_behavior"]?.let {
                        json.decodeFromJsonElement<InlineV1InvoicesPostRequestFormPendingInvoiceItemsBehaviorX0af94a86>(
                            it,
                        )
                    },
                rendering =
                    rawObject["rendering"]?.let {
                        json.decodeFromJsonElement<InlineV1InvoicesPostRequestFormRenderingX071c5877>(it)
                    },
                shippingCost =
                    rawObject["shipping_cost"]?.let {
                        json.decodeFromJsonElement<InlineV1InvoicesPostRequestFormShippingCostX8f940f66>(it)
                    },
                shippingDetails =
                    rawObject["shipping_details"]?.let {
                        json.decodeFromJsonElement<InlineV1InvoicesPostRequestFormShippingDetailsX61db64a1>(it)
                    },
                statementDescriptor =
                ...
                transferData =
                    rawObject["transfer_data"]?.let {
                        json.decodeFromJsonElement<InlineV1InvoicesPostRequestFormTransferDataXea589c39>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesPostRequestFormXb417d116,
        ) {
            ...
            val raw =
                buildJsonObject {
                    ...
                    value.pendingInvoiceItemsBehavior?.let {
                        put(
...
public fun inlineV1InvoicesPostRequestFormXb417d116(
    block: InlineV1InvoicesPostRequestFormXb417d116.Builder.() -> Unit,
): InlineV1InvoicesPostRequestFormXb417d116 = InlineV1InvoicesPostRequestFormXb417d116.build(block)
