...
public sealed class InlineBillingAlertAlertTypeX831d1d2e {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineBillingAlertAlertTypeX831d1d2e =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineBillingAlertAlertTypeX831d1d2e> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineBillingAlertAlertTypeX831d1d2e",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineBillingAlertAlertTypeX831d1d2e =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineBillingAlertAlertTypeX831d1d2e,
        ) {
