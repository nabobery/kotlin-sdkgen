...
public class InlineV1TreasuryFinancialAc862PostRequestFormFeaturesInboundTransfersXe1e3fdcd(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1TreasuryFinancialAc862PostRequestFormFeaturesInboundTransfersXe1e3fdcd =
            InlineV1TreasuryFinancialAc862PostRequestFormFeaturesInboundTransfersXe1e3fdcd(
                ach = ach,
            )
    }
    ...
    public object Serializer : KSerializer<InlineV1TreasuryFinancialAc862PostRequestFormFeaturesInboundTransfersXe1e3fdcd> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TreasuryFinancialAc862PostRequestFormFeaturesInboundTransfersXe1e3fdcd must be a JSON object",
                    )
            return InlineV1TreasuryFinancialAc862PostRequestFormFeaturesInboundTransfersXe1e3fdcd(
                ach =
                    rawObject["ach"]?.let {
                        json.decodeFromJsonElement<InlineV1TreasuryFinancialAc862PostRequestFormFeaturesAchXff39d1aa>(
                            it,
                        )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TreasuryFinancialAc862PostRequestFormFeaturesInboundTransfersXe1e3fdcd,
        ) {
            val jsonEncoder =
...
public fun inlineV1TreasuryFinancialAc862PostRequestFormFeaturesInboundTransfersXe1e3fdcd(
    block: InlineV1TreasuryFinancialAc862PostRequestFormFeaturesInboundTransfersXe1e3fdcd.Builder.() -> Unit,
): InlineV1TreasuryFinancialAc862PostRequestFormFeaturesInboundTransfersXe1e3fdcd =
