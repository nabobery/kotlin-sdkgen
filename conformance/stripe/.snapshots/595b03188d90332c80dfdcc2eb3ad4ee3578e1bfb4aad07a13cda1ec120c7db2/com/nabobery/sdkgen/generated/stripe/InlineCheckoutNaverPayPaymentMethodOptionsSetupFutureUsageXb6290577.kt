...
public sealed class InlineCheckoutNaverPayPaymentMethodOptionsSetupFutureUsageXb6290577 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineCheckoutNaverPayPaymentMethodOptionsSetupFutureUsageXb6290577 =
            when (value) {
                None.value -> None
    ...
    public object Serializer : KSerializer<InlineCheckoutNaverPayPaymentMethodOptionsSetupFutureUsageXb6290577> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineCheckoutNaverPayPaymentMethodOptionsSetupFutureUsageXb6290577",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineCheckoutNaverPayPaymentMethodOptionsSetupFutureUsageXb6290577 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineCheckoutNaverPayPaymentMethodOptionsSetupFutureUsageXb6290577,
        ) {
