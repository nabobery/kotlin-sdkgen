...
public class InlineDisputeEvidenceCustomerCommunicationXdea508c4 internal constructor(
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineDisputeEvidenceCustomerCommunicationXdea508c4 {
            val inspection = inspectInlineDisputeEvidenceCustomerCommunicationXdea508c4(raw)
            if (inspection.matchCount == 0) {
                throw InlineDisputeEvidenceCustomerCommunicationXdea508c4NoMatchException(
                    "InlineDisputeEvidenceCustomerCommunicationXdea508c4 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineDisputeEvidenceCustomerCommunicationXdea508c4> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineDisputeEvidenceCustomerCommunicationXdea508c4,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineDisputeEvidenceCustomerCommunicationXdea508c4",
...
private fun inspectInlineDisputeEvidenceCustomerCommunicationXdea508c4(
    element: JsonElement,
): InlineDisputeEvidenceCustomerCommunicationXdea508c4Inspection {
