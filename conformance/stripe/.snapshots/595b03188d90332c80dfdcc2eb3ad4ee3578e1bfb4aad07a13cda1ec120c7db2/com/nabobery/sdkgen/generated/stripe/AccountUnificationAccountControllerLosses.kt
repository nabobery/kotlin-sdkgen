...
public class AccountUnificationAccountControllerLosses(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): AccountUnificationAccountControllerLosses =
    ...
    public object Serializer : KSerializer<AccountUnificationAccountControllerLosses> {
        ...
        override fun deserialize(decoder: Decoder): AccountUnificationAccountControllerLosses {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("AccountUnificationAccountControllerLosses must be a JSON object")
            val payments =
                json.decodeRequired<InlineAccountUnificationAccountControllerLossesPaymentsX6a854391>(
                    rawObject,
                    "payments",
                )
            return AccountUnificationAccountControllerLosses(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: AccountUnificationAccountControllerLosses,
        ) {
...
public fun accountUnificationAccountControllerLosses(
    block: AccountUnificationAccountControllerLosses.Builder.() -> Unit,
): AccountUnificationAccountControllerLosses = AccountUnificationAccountControllerLosses.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "AccountUnificationAccountControllerLosses is missing required property '" + name + "'",
            )
