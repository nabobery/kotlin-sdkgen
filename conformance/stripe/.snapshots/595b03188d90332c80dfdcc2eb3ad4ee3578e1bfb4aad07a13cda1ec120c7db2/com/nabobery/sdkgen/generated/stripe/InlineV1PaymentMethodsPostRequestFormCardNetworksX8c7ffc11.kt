...
public class InlineV1PaymentMethodsPostRequestFormCardNetworksX8c7ffc11(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1PaymentMethodsPostRequestFormCardNetworksX8c7ffc11 =
            InlineV1PaymentMethodsPostRequestFormCardNetworksX8c7ffc11(
                preferred = preferred,
            )
    }

    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PaymentMethodsPostRequestFormCardNetworksX8c7ffc11 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentMethodsPostRequestFormCardNetworksX8c7ffc11> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentMethodsPostRequestFormCardNetworksX8c7ffc11 must be a JSON object",
                    )
            return InlineV1PaymentMethodsPostRequestFormCardNetworksX8c7ffc11(
                preferred =
                    rawObject["preferred"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentMethodsPostRequestFormCardNetworksPreferredXd875bbe4>(
                            it,
                        )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentMethodsPostRequestFormCardNetworksX8c7ffc11,
        ) {
...
public fun inlineV1PaymentMethodsPostRequestFormCardNetworksX8c7ffc11(
    block: InlineV1PaymentMethodsPostRequestFormCardNetworksX8c7ffc11.Builder.() -> Unit,
): InlineV1PaymentMethodsPostRequestFormCardNetworksX8c7ffc11 =
    InlineV1PaymentMethodsPostRequestFormCardNetworksX8c7ffc11.build(block)
