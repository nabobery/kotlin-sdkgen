...
public class InlineV1ChargesPostRequestFormShippingX776066db(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1ChargesPostRequestFormShippingX776066db =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1ChargesPostRequestFormShippingX776066db> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1ChargesPostRequestFormShippingX776066db must be a JSON object",
                    )
            val address =
                json.decodeRequired<InlineV1ChargesPostRequestFormShippingAddressX0eeda288>(
                    rawObject,
                    "address",
                )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ChargesPostRequestFormShippingX776066db,
        ) {
...
public fun inlineV1ChargesPostRequestFormShippingX776066db(
    block: InlineV1ChargesPostRequestFormShippingX776066db.Builder.() -> Unit,
): InlineV1ChargesPostRequestFormShippingX776066db = InlineV1ChargesPostRequestFormShippingX776066db.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1ChargesPostRequestFormShippingX776066db is missing required property '" + name + "'",
            )
