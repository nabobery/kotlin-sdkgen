...
public sealed class InlineV1BillingPortalConfiab44PostRequestFormFeaturesModeX2c690578 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1BillingPortalConfiab44PostRequestFormFeaturesModeX2c690578 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1BillingPortalConfiab44PostRequestFormFeaturesModeX2c690578> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1BillingPortalConfiab44PostRequestFormFeaturesModeX2c690578",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1BillingPortalConfiab44PostRequestFormFeaturesModeX2c690578 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1BillingPortalConfiab44PostRequestFormFeaturesModeX2c690578,
        ) {
