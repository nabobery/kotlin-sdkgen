...
public class IssuingAuthorizationAuthenticationExemption(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): IssuingAuthorizationAuthenticationExemption =
    ...
    public object Serializer : KSerializer<IssuingAuthorizationAuthenticationExemption> {
        ...
        override fun deserialize(decoder: Decoder): IssuingAuthorizationAuthenticationExemption {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("IssuingAuthorizationAuthenticationExemption must be a JSON object")
            val claimedBy =
                json.decodeRequired<InlineIssuingAuthorizationAuthenticationExemptionClaimedByX1e9173cb>(
                    rawObject,
                    "claimed_by",
                )
            val type =
                json.decodeRequired<InlineIssuingAuthorizationAuthenticationExemptionTypeXf06bd416>(
                    rawObject,
                    "type",
                )
            return IssuingAuthorizationAuthenticationExemption(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: IssuingAuthorizationAuthenticationExemption,
        ) {
...
public fun issuingAuthorizationAuthenticationExemption(
    block: IssuingAuthorizationAuthenticationExemption.Builder.() -> Unit,
): IssuingAuthorizationAuthenticationExemption = IssuingAuthorizationAuthenticationExemption.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "IssuingAuthorizationAuthenticationExemption is missing required property '" + name + "'",
            )
