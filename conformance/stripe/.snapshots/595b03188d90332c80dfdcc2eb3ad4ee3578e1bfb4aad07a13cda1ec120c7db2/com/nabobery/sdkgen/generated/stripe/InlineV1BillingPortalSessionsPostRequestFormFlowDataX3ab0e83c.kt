...
public class InlineV1BillingPortalSessionsPostRequestFormFlowDataX3ab0e83c(
    ...
    public val afterCompletion: InlineV1BillingPortalSessionsPostRequestFormFlowDataAfterCompletionX80448920? = null,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1BillingPortalSessionsPostRequestFormFlowDataX3ab0e83c =
    ...
    public object Serializer : KSerializer<InlineV1BillingPortalSessionsPostRequestFormFlowDataX3ab0e83c> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1BillingPortalSessionsPostRequestFormFlowDataX3ab0e83c {
            val jsonDecoder =
                decoder.requireJsonDecoder(
                    "InlineV1BillingPortalSessionsPostRequestFormFlowDataX3ab0e83c",
                )
            val json = jsonDecoder.json
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1BillingPortalSessionsPostRequestFormFlowDataX3ab0e83c must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineV1BillingPortalSessionsPostRequestFormFlowDataTypeXe9325486>(
                    rawObject,
                    "type",
                )
            return InlineV1BillingPortalSessionsPostRequestFormFlowDataX3ab0e83c(
                ...
                afterCompletion =
                    rawObject["after_completion"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1BillingPortalSessionsPostRequestFormFlowDataAfterCompletionX80448920>(
                                it,
                            )
                    },
                subscriptionCancel =
                    rawObject["subscription_cancel"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1BillingPortalSessionsPostRequestFormFlowDataSubscriptionCancelXe06b101e>(
                                it,
                            )
                    },
                subscriptionUpdate =
                    rawObject["subscription_update"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1BillingPortalSessionsPostRequestFormFlowDataSubscriptionUpdateXe87100ee>(
                                it,
                            )
                    },
                subscriptionUpdateConfirm =
                    rawObject["subscription_update_confirm"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1BillingPortalSessionsPostRequestFormSubscriptionUpdateCoe65aX733effd1>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1BillingPortalSessionsPostRequestFormFlowDataX3ab0e83c,
        ) {
            val jsonEncoder =
            ...
            val raw =
                buildJsonObject {
                    ...
                    value.subscriptionUpdateConfirm?.let {
                        put(
...
public fun inlineV1BillingPortalSessionsPostRequestFormFlowDataX3ab0e83c(
    block: InlineV1BillingPortalSessionsPostRequestFormFlowDataX3ab0e83c.Builder.() -> Unit,
): InlineV1BillingPortalSessionsPostRequestFormFlowDataX3ab0e83c =
    InlineV1BillingPortalSessionsPostRequestFormFlowDataX3ab0e83c.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1BillingPortalSessionsPostRequestFormFlowDataX3ab0e83c is missing required property '" + name +
                    "'",
            )
