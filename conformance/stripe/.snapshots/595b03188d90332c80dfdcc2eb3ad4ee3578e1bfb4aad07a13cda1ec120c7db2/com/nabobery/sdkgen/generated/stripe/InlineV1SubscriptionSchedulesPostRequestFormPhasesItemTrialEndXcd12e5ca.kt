...
internal data class InlineV1SubscriptionSchedulesPostRequestFormPhasesItemTrialEndXcd12e5caInspection(
    ...
    public val matchesInlineV1SubscriptionSchedulesPostRequestFormPhasesItemTrialEndAnyOf2Xde110929: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1SubscriptionSchedulesPostRequestFormPhasesItemTrialEndAnyOf2Xde110929,
            ).count {
                it
            }
}
...
public class InlineV1SubscriptionSchedulesPostRequestFormPhasesItemTrialEndXcd12e5ca internal constructor(
    ...
    private val inspection: InlineV1SubscriptionSchedulesPostRequestFormPhasesItemTrialEndXcd12e5caInspection,
) {
    ...
    public val inlineV1SubscriptionSchedulesPostRequestFormPhasesItemTrialEndAnyOf2Xde110929:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1SubscriptionSchedulesPostRequestFormPhasesItemTrialEndAnyOf2Xde110929) {
                json
                    .decodeFromJsonElement<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemTrialEndAnyOf2Xde110929>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1SubscriptionSchedulesPostRequestFormPhasesItemTrialEndXcd12e5caBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1SubscriptionSchedulesPostRequestFormPhasesItemTrialEndAnyOf2Xde110929) {
                    add(
                        InlineV1SubscriptionSchedulesPostRequestFormPhasesItemTrialEndXcd12e5caBranch.InlineV1SubscriptionSchedulesPostRequestFormPhasesItemTrialEndAnyOf2Xde110929,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1SubscriptionSchedulesPostRequestFormPhasesItemTrialEndXcd12e5ca {
            val inspection = inspectInlineV1SubscriptionSchedulesPostRequestFormPhasesItemTrialEndXcd12e5ca(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1SubscriptionSchedulesPostRequestFormPhasesItemTrialEndXcd12e5caNoMatchException(
                    "InlineV1SubscriptionSchedulesPostRequestFormPhasesItemTrialEndXcd12e5ca matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemTrialEndXcd12e5ca> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionSchedulesPostRequestFormPhasesItemTrialEndXcd12e5ca,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1SubscriptionSchedulesPostRequestFormPhasesItemTrialEndXcd12e5ca",
...
private fun inspectInlineV1SubscriptionSchedulesPostRequestFormPhasesItemTrialEndXcd12e5ca(
    element: JsonElement,
): InlineV1SubscriptionSchedulesPostRequestFormPhasesItemTrialEndXcd12e5caInspection {
    val matchesBranch1 = element.isJsonDecodable<Int>()
    val matchesInlineV1SubscriptionSchedulesPostRequestFormPhasesItemTrialEndAnyOf2Xde110929 =
        element
            .isJsonDecodable<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemTrialEndAnyOf2Xde110929>()
    return InlineV1SubscriptionSchedulesPostRequestFormPhasesItemTrialEndXcd12e5caInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1SubscriptionSchedulesPostRequestFormPhasesItemTrialEndAnyOf2Xde110929) {
                    add(
                        "InlineV1SubscriptionSchedulesPostRequestFormPhasesItemTrialEndAnyOf2Xde110929: value does not match InlineV1SubscriptionSchedulesPostRequestFormPhasesItemTrialEndAnyOf2Xde110929",
                    )
                }
            },
    )
