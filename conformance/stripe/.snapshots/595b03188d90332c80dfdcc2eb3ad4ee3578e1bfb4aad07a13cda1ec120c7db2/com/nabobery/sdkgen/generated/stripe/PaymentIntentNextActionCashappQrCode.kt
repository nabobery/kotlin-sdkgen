...
public class PaymentIntentNextActionCashappQrCode(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentIntentNextActionCashappQrCode =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentIntentNextActionCashappQrCode> {
        ...
        override fun deserialize(decoder: Decoder): PaymentIntentNextActionCashappQrCode {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentIntentNextActionCashappQrCode must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentIntentNextActionCashappQrCode,
        ) {
...
public fun paymentIntentNextActionCashappQrCode(
    block: PaymentIntentNextActionCashappQrCode.Builder.() -> Unit,
): PaymentIntentNextActionCashappQrCode = PaymentIntentNextActionCashappQrCode.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "PaymentIntentNextActionCashappQrCode is missing required property '" + name + "'",
            )
