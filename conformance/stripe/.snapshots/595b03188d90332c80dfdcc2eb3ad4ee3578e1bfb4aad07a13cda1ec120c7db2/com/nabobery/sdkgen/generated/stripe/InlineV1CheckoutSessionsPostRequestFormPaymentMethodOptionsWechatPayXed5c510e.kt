...
public class InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsWechatPayXed5c510e(
    ...
    public val setupFutureUsage: InlineV1CheckoutSessionsPostRequestFormSetupFutureUsageXc2862318? = null,
) {
    ...
    public object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsWechatPayXed5c510e> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsWechatPayXed5c510e must be a JSON object",
                    )
            val client =
                json.decodeRequired<InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsClientX84a5ff04>(
                    rawObject,
                    "client",
                )
            return InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsWechatPayXed5c510e(
                ...
                setupFutureUsage =
                    rawObject["setup_future_usage"]?.let {
                        json.decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormSetupFutureUsageXc2862318>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsWechatPayXed5c510e,
        ) {
            val jsonEncoder =
...
public fun inlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsWechatPayXed5c510e(
    block: InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsWechatPayXed5c510e.Builder.() -> Unit,
): InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsWechatPayXed5c510e =
    InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsWechatPayXed5c510e.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsWechatPayXed5c510e is missing required property '" +
                    name +
                    "'",
            )
