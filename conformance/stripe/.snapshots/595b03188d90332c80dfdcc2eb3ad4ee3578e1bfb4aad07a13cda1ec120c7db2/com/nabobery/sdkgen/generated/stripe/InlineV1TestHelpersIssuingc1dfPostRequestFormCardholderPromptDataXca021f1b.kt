...
public class InlineV1TestHelpersIssuingc1dfPostRequestFormCardholderPromptDataXca021f1b(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1TestHelpersIssuingc1dfPostRequestFormCardholderPromptDataXca021f1b =
            InlineV1TestHelpersIssuingc1dfPostRequestFormCardholderPromptDataXca021f1b(
                driverId = driverId,
                odometer = odometer,
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1TestHelpersIssuingc1dfPostRequestFormCardholderPromptDataXca021f1b = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TestHelpersIssuingc1dfPostRequestFormCardholderPromptDataXca021f1b> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TestHelpersIssuingc1dfPostRequestFormCardholderPromptDataXca021f1b must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TestHelpersIssuingc1dfPostRequestFormCardholderPromptDataXca021f1b,
        ) {
            val jsonEncoder =
...
public fun inlineV1TestHelpersIssuingc1dfPostRequestFormCardholderPromptDataXca021f1b(
    block: InlineV1TestHelpersIssuingc1dfPostRequestFormCardholderPromptDataXca021f1b.Builder.() -> Unit,
): InlineV1TestHelpersIssuingc1dfPostRequestFormCardholderPromptDataXca021f1b =
