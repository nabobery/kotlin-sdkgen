...
public class InlineV1SubscriptionItemsPostRequestFormXa277f4ec(
     ...
     */
    public val billingThresholds: InlineV1SubscriptionItemsPostRequestFormBillingThresholdsXca8229d6? = null,
    /**
     ...
     */
    public val paymentBehavior: InlineV1SubscriptionItemsPostRequestFormPaymentBehaviorXc5ed1ece? = null,
    /**
     ...
     */
    public val prorationBehavior: InlineV1SubscriptionItemsPostRequestFormProrationBehaviorX038153bf? = null,
    /**
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1SubscriptionItemsPostRequestFormXa277f4ec =
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionItemsPostRequestFormXa277f4ec> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SubscriptionItemsPostRequestFormXa277f4ec must be a JSON object",
                    )
            ...
            return InlineV1SubscriptionItemsPostRequestFormXa277f4ec(
                ...
                billingThresholds =
                    rawObject["billing_thresholds"]?.let {
                        json.decodeFromJsonElement<InlineV1SubscriptionItemsPostRequestFormBillingThresholdsXca8229d6>(
                            it,
                        )
                    },
                discounts =
                    rawObject["discounts"]?.let {
                        json.decodeFromJsonElement<InlineV1SubscriptionItemsPostRequestFormDiscountsX3d881241>(it)
                    },
                expand = rawObject["expand"]?.let { json.decodeFromJsonElement<List<String>>(it) },
                metadata = rawObject["metadata"]?.let { json.decodeFromJsonElement<Map<String, String>>(it) },
                paymentBehavior =
                    rawObject["payment_behavior"]?.let {
                        json.decodeFromJsonElement<InlineV1SubscriptionItemsPostRequestFormPaymentBehaviorXc5ed1ece>(it)
                    },
                price = rawObject["price"]?.let { json.decodeFromJsonElement<String>(it) },
                priceData =
                    rawObject["price_data"]?.let {
                        json.decodeFromJsonElement<InlineV1SubscriptionItemsPostRequestFormPriceDataX022e42bd>(it)
                    },
                prorationBehavior =
                    rawObject["proration_behavior"]?.let {
                        json.decodeFromJsonElement<InlineV1SubscriptionItemsPostRequestFormProrationBehaviorX038153bf>(
                            it,
                        )
                    },
                ...
                taxRates =
                    rawObject["tax_rates"]?.let {
                        json.decodeFromJsonElement<InlineV1SubscriptionItemsPostRequestFormTaxRatesX127dc7e5>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionItemsPostRequestFormXa277f4ec,
        ) {
...
public fun inlineV1SubscriptionItemsPostRequestFormXa277f4ec(
    block: InlineV1SubscriptionItemsPostRequestFormXa277f4ec.Builder.() -> Unit,
): InlineV1SubscriptionItemsPostRequestFormXa277f4ec = InlineV1SubscriptionItemsPostRequestFormXa277f4ec.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1SubscriptionItemsPostRequestFormXa277f4ec is missing required property '" + name + "'",
            )
