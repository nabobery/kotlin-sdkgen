...
public class InlineV1CustomersCardsPostRequestFormCardAnyOf1NetworkTokenX442fac8a(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1CustomersCardsPostRequestFormCardAnyOf1NetworkTokenX442fac8a =
            InlineV1CustomersCardsPostRequestFormCardAnyOf1NetworkTokenX442fac8a(
                number = number,
            )
    }
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1CustomersCardsPostRequestFormCardAnyOf1NetworkTokenX442fac8a = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1CustomersCardsPostRequestFormCardAnyOf1NetworkTokenX442fac8a> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CustomersCardsPostRequestFormCardAnyOf1NetworkTokenX442fac8a must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersCardsPostRequestFormCardAnyOf1NetworkTokenX442fac8a,
        ) {
            val jsonEncoder =
...
public fun inlineV1CustomersCardsPostRequestFormCardAnyOf1NetworkTokenX442fac8a(
    block: InlineV1CustomersCardsPostRequestFormCardAnyOf1NetworkTokenX442fac8a.Builder.() -> Unit,
): InlineV1CustomersCardsPostRequestFormCardAnyOf1NetworkTokenX442fac8a =
