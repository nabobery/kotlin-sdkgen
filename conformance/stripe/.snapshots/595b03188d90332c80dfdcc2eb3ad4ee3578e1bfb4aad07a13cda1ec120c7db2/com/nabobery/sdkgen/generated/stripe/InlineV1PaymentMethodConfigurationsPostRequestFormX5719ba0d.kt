...
public class InlineV1PaymentMethodConfigurationsPostRequestFormX5719ba0d(
     ...
     */
    public val acssDebit: InlineV1PaymentMethodConfigurationsPostRequestFormAcssDebitX9764890e? = null,
    /**
     ...
     */
    public val afterpayClearpay: InlineV1PaymentMethodConfigurationsPostRequestFormAfterpayClearpayXb760da75? = null,
    /**
     ...
     */
    public val amazonPay: InlineV1PaymentMethodConfigurationsPostRequestFormAmazonPayX931992b6? = null,
    /**
     ...
     */
    public val applePayLater: InlineV1PaymentMethodConfigurationsPostRequestFormApplePayLaterX75c6c3d2? = null,
    /**
     ...
     * details.
     */
    public val auBecsDebit: InlineV1PaymentMethodConfigurationsPostRequestFormAuBecsDebitX39a6c865? = null,
    /**
     ...
     */
    public val bacsDebit: InlineV1PaymentMethodConfigurationsPostRequestFormBacsDebitXbfdd163e? = null,
    /**
     ...
     */
    public val bancontact: InlineV1PaymentMethodConfigurationsPostRequestFormBancontactX7ea2e26b? = null,
    /**
     ...
     */
    public val cartesBancaires: InlineV1PaymentMethodConfigurationsPostRequestFormCartesBancairesXe72f2d6d? = null,
    /**
     ...
     * more details.
     */
    public val customerBalance: InlineV1PaymentMethodConfigurationsPostRequestFormCustomerBalanceXbc03bc44? = null,
    /**
     ...
     */
    public val googlePay: InlineV1PaymentMethodConfigurationsPostRequestFormGooglePayX9a84e1b0? = null,
    /**
     ...
     */
    public val mobilepay: InlineV1PaymentMethodConfigurationsPostRequestFormMobilepayX5b392769? = null,
    /**
     ...
     * method.
     */
    public val multibanco: InlineV1PaymentMethodConfigurationsPostRequestFormMultibancoX7b02ff33? = null,
    /**
     * Configuration name.
     */
     ...
     * details.
     */
    public val nzBankAccount: InlineV1PaymentMethodConfigurationsPostRequestFormNzBankAccountXff771a8a? = null,
    /**
     ...
     */
    public val payByBank: InlineV1PaymentMethodConfigurationsPostRequestFormPayByBankXfed2d5b9? = null,
    /**
     ...
     */
    public val promptpay: InlineV1PaymentMethodConfigurationsPostRequestFormPromptpayXe14676a3? = null,
    /**
     ...
     */
    public val revolutPay: InlineV1PaymentMethodConfigurationsPostRequestFormRevolutPayX0ec08ecf? = null,
    /**
     * Samsung Pay is a [single-use](https://docs.stripe.com/payments/payment-methods#usage local wallet available in
     * South Korea.
     */
    public val samsungPay: InlineV1PaymentMethodConfigurationsPostRequestFormSamsungPayXcbf5604e? = null,
    /**
     ...
     */
    public val sepaDebit: InlineV1PaymentMethodConfigurationsPostRequestFormSepaDebitX2f37b4da? = null,
    /**
     ...
     */
    public val usBankAccount: InlineV1PaymentMethodConfigurationsPostRequestFormUsBankAccountX466be731? = null,
    /**
     ...
     */
    public val wechatPay: InlineV1PaymentMethodConfigurationsPostRequestFormWechatPayXeeceb7b8? = null,
    /**
    ...
    public class Builder {
        ...
        public fun build(): InlineV1PaymentMethodConfigurationsPostRequestFormX5719ba0d =
            InlineV1PaymentMethodConfigurationsPostRequestFormX5719ba0d(
                acssDebit = acssDebit,
                affirm = affirm,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PaymentMethodConfigurationsPostRequestFormX5719ba0d =
    ...
    public object Serializer : KSerializer<InlineV1PaymentMethodConfigurationsPostRequestFormX5719ba0d> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentMethodConfigurationsPostRequestFormX5719ba0d must be a JSON object",
                    )
            return InlineV1PaymentMethodConfigurationsPostRequestFormX5719ba0d(
                acssDebit =
                    rawObject["acss_debit"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentMethodConfigurationsPostRequestFormAcssDebitX9764890e>(
                                it,
                            )
                    },
                affirm =
                    rawObject["affirm"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentMethodConfigurationsPostRequestFormAffirmXc4c91e08>(
                            it,
                        )
                    },
                afterpayClearpay =
                    rawObject["afterpay_clearpay"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentMethodConfigurationsPostRequestFormAfterpayClearpayXb760da75>(
                                it,
                            )
                    },
                alipay =
                    rawObject["alipay"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentMethodConfigurationsPostRequestFormAlipayXeb55fb99>(
                            it,
                        )
                    },
                alma =
                    rawObject["alma"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentMethodConfigurationsPostRequestFormAlmaXff86f3bc>(it)
                    },
                amazonPay =
                    rawObject["amazon_pay"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentMethodConfigurationsPostRequestFormAmazonPayX931992b6>(
                                it,
                            )
                    },
                applePay =
                    rawObject["apple_pay"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentMethodConfigurationsPostRequestFormApplePayX9b8c7cee>(
                            it,
                        )
                    },
                applePayLater =
                    rawObject["apple_pay_later"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentMethodConfigurationsPostRequestFormApplePayLaterX75c6c3d2>(
                                it,
                            )
                    },
                auBecsDebit =
                    rawObject["au_becs_debit"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentMethodConfigurationsPostRequestFormAuBecsDebitX39a6c865>(
                                it,
                            )
                    },
                bacsDebit =
                    rawObject["bacs_debit"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentMethodConfigurationsPostRequestFormBacsDebitXbfdd163e>(
                                it,
                            )
                    },
                bancontact =
                    rawObject["bancontact"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentMethodConfigurationsPostRequestFormBancontactX7ea2e26b>(
                                it,
                            )
                    },
                billie =
                    rawObject["billie"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentMethodConfigurationsPostRequestFormBillieXfb0d80cb>(
                            it,
                        )
                    },
                bizum =
                    rawObject["bizum"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentMethodConfigurationsPostRequestFormBizumXbf47e56c>(it)
                    },
                blik =
                    rawObject["blik"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentMethodConfigurationsPostRequestFormBlikXab8f7ebe>(it)
                    },
                boleto =
                    rawObject["boleto"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentMethodConfigurationsPostRequestFormBoletoX97a9ba83>(
                            it,
                        )
                    },
                card =
                    rawObject["card"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentMethodConfigurationsPostRequestFormCardX9cca27ad>(it)
                    },
                cartesBancaires =
                    rawObject["cartes_bancaires"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentMethodConfigurationsPostRequestFormCartesBancairesXe72f2d6d>(
                                it,
                            )
                    },
                cashapp =
                    rawObject["cashapp"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentMethodConfigurationsPostRequestFormCashappX3f4db87a>(
                            it,
                        )
                    },
                crypto =
                    rawObject["crypto"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentMethodConfigurationsPostRequestFormCryptoX98319527>(
                            it,
                        )
                    },
                customerBalance =
                    rawObject["customer_balance"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1PaymentMethodConfigurationsPostRequestFormCustomerBalanceXbc03bc44>(
                                    it,
                                )
                        },
                eps =
                    rawObject["eps"]
                        ?.let {
                            json.decodeFromJsonElement<InlineV1PaymentMethodConfigurationsPostRequestFormEpsX94fb81fc>(
                                it,
                            )
                        },
                expand =
                ...
                fpx =
                    rawObject["fpx"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentMethodConfigurationsPostRequestFormFpxXfaad8128>(it)
                    },
                frMealVoucherConecs =
                    rawObject["fr_meal_voucher_conecs"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentMethodConfigurationsPostRequestFormFrMealVoucherConecsX2f246ba9>(
                                it,
                            )
                    },
                giropay =
                    rawObject["giropay"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentMethodConfigurationsPostRequestFormGiropayX1d489086>(
                            it,
                        )
                    },
                googlePay =
                    rawObject["google_pay"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentMethodConfigurationsPostRequestFormGooglePayX9a84e1b0>(
                                it,
                            )
                    },
                grabpay =
                    rawObject["grabpay"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentMethodConfigurationsPostRequestFormGrabpayXf70a429a>(
                            it,
                        )
                    },
                ideal =
                    rawObject["ideal"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentMethodConfigurationsPostRequestFormIdealXb4fb328f>(it)
                    },
                jcb =
                    rawObject["jcb"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentMethodConfigurationsPostRequestFormJcbXe8831514>(it)
                    },
                kakaoPay =
                    rawObject["kakao_pay"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentMethodConfigurationsPostRequestFormKakaoPayXec569d7a>(
                            it,
                        )
                    },
                klarna =
                    rawObject["klarna"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentMethodConfigurationsPostRequestFormKlarnaX5689f9f0>(
                            it,
                        )
                    },
                konbini =
                    rawObject["konbini"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentMethodConfigurationsPostRequestFormKonbiniX116d9813>(
                            it,
                        )
                    },
                krCard =
                    rawObject["kr_card"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentMethodConfigurationsPostRequestFormKrCardXd927b236>(
                            it,
                        )
                    },
                link =
                    rawObject["link"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentMethodConfigurationsPostRequestFormLinkX757929f6>(it)
                    },
                mbWay =
                    rawObject["mb_way"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentMethodConfigurationsPostRequestFormMbWayX65d91656>(it)
                    },
                mobilepay =
                    rawObject["mobilepay"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentMethodConfigurationsPostRequestFormMobilepayX5b392769>(
                                it,
                            )
                    },
                multibanco =
                    rawObject["multibanco"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentMethodConfigurationsPostRequestFormMultibancoX7b02ff33>(
                                it,
                            )
                    },
                name =
                ...
                naverPay =
                    rawObject["naver_pay"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentMethodConfigurationsPostRequestFormNaverPayX8fa2157c>(
                            it,
                        )
                    },
                nzBankAccount =
                    rawObject["nz_bank_account"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentMethodConfigurationsPostRequestFormNzBankAccountXff771a8a>(
                                it,
                            )
                    },
                oxxo =
                    rawObject["oxxo"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentMethodConfigurationsPostRequestFormOxxoX3a5c502f>(it)
                    },
                p24 =
                    rawObject["p24"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentMethodConfigurationsPostRequestFormP24X2bf73505>(it)
                    },
                parent = rawObject["parent"]?.let { json.decodeFromJsonElement<String>(it) },
                payByBank =
                    rawObject["pay_by_bank"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentMethodConfigurationsPostRequestFormPayByBankXfed2d5b9>(
                                it,
                            )
                    },
                payco =
                    rawObject["payco"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentMethodConfigurationsPostRequestFormPaycoXd87a3373>(it)
                    },
                paynow =
                    rawObject["paynow"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentMethodConfigurationsPostRequestFormPaynowX28b207a7>(
                            it,
                        )
                    },
                paypal =
                    rawObject["paypal"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentMethodConfigurationsPostRequestFormPaypalX9d9e69bb>(
                            it,
                        )
                    },
                payto =
                    rawObject["payto"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentMethodConfigurationsPostRequestFormPaytoX431cc369>(it)
                    },
                pix =
                    rawObject["pix"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentMethodConfigurationsPostRequestFormPixX91a5b86f>(it)
                    },
                promptpay =
                    rawObject["promptpay"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentMethodConfigurationsPostRequestFormPromptpayXe14676a3>(
                                it,
                            )
                    },
                revolutPay =
                    rawObject["revolut_pay"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentMethodConfigurationsPostRequestFormRevolutPayX0ec08ecf>(
                                it,
                            )
                    },
                samsungPay =
                    rawObject["samsung_pay"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentMethodConfigurationsPostRequestFormSamsungPayXcbf5604e>(
                                it,
                            )
                    },
                satispay =
                    rawObject["satispay"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentMethodConfigurationsPostRequestFormSatispayXe22c1721>(
                            it,
                        )
                    },
                scalapay =
                    rawObject["scalapay"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentMethodConfigurationsPostRequestFormScalapayXda46ec84>(
                            it,
                        )
                    },
                sepaDebit =
                    rawObject["sepa_debit"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentMethodConfigurationsPostRequestFormSepaDebitX2f37b4da>(
                                it,
                            )
                    },
                sofort =
                    rawObject["sofort"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentMethodConfigurationsPostRequestFormSofortX8259f600>(
                            it,
                        )
                    },
                sunbit =
                    rawObject["sunbit"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentMethodConfigurationsPostRequestFormSunbitXa1c2b889>(
                            it,
                        )
                    },
                swish =
                    rawObject["swish"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentMethodConfigurationsPostRequestFormSwishX9f738377>(it)
                    },
                twint =
                    rawObject["twint"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentMethodConfigurationsPostRequestFormTwintX3a398658>(it)
                    },
                upi =
                    rawObject["upi"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentMethodConfigurationsPostRequestFormUpiXa627ca22>(it)
                    },
                usBankAccount =
                    rawObject["us_bank_account"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1PaymentMethodConfigurationsPostRequestFormUsBankAccountX466be731>(
                                    it,
                                )
                        },
                wechatPay =
                    rawObject["wechat_pay"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1PaymentMethodConfigurationsPostRequestFormWechatPayXeeceb7b8>(
                                    it,
                                )
                        },
                zip =
                    rawObject["zip"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentMethodConfigurationsPostRequestFormZipXfe64ad2c>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentMethodConfigurationsPostRequestFormX5719ba0d,
        ) {
...
public fun inlineV1PaymentMethodConfigurationsPostRequestFormX5719ba0d(
    block: InlineV1PaymentMethodConfigurationsPostRequestFormX5719ba0d.Builder.() -> Unit,
): InlineV1PaymentMethodConfigurationsPostRequestFormX5719ba0d =
    InlineV1PaymentMethodConfigurationsPostRequestFormX5719ba0d.build(block)
