...
public class InlineChargeCustomerXaca36065 internal constructor(
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineChargeCustomerXaca36065 {
            val inspection = inspectInlineChargeCustomerXaca36065(raw)
            if (inspection.matchCount == 0) {
                throw InlineChargeCustomerXaca36065NoMatchException(
                    "InlineChargeCustomerXaca36065 matched 0 branches: " + inspection.failures.joinToString("; "),
                )
            }
    ...
    public object Serializer : KSerializer<InlineChargeCustomerXaca36065> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineChargeCustomerXaca36065,
        ) {
