...
public sealed class InlineV1PaymentIntentsPostRequestFormPurchaseIntervalXd1c3e8fd {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1PaymentIntentsPostRequestFormPurchaseIntervalXd1c3e8fd =
            when (value) {
                Day.value -> Day
                Month.value -> Month
                Week.value -> Week
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormPurchaseIntervalXd1c3e8fd> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1PaymentIntentsPostRequestFormPurchaseIntervalXd1c3e8fd",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1PaymentIntentsPostRequestFormPurchaseIntervalXd1c3e8fd =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormPurchaseIntervalXd1c3e8fd,
        ) {
