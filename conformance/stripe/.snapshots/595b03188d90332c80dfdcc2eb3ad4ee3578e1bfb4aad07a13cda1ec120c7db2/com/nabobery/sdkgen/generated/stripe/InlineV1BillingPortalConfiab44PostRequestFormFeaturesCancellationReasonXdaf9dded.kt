...
public class InlineV1BillingPortalConfiab44PostRequestFormFeaturesCancellationReasonXdaf9dded(
    ...
    public object Serializer : KSerializer<InlineV1BillingPortalConfiab44PostRequestFormFeaturesCancellationReasonXdaf9dded> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1BillingPortalConfiab44PostRequestFormFeaturesCancellationReasonXdaf9dded must be a JSON object",
                    )
            ...
            return InlineV1BillingPortalConfiab44PostRequestFormFeaturesCancellationReasonXdaf9dded(
                ...
                options =
                    rawObject["options"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1BillingPortalConfiab44PostRequestFormFeaturesOptionsX205e6660>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1BillingPortalConfiab44PostRequestFormFeaturesCancellationReasonXdaf9dded,
        ) {
            val jsonEncoder =
...
public fun inlineV1BillingPortalConfiab44PostRequestFormFeaturesCancellationReasonXdaf9dded(
    block: InlineV1BillingPortalConfiab44PostRequestFormFeaturesCancellationReasonXdaf9dded.Builder.() -> Unit,
): InlineV1BillingPortalConfiab44PostRequestFormFeaturesCancellationReasonXdaf9dded =
    InlineV1BillingPortalConfiab44PostRequestFormFeaturesCancellationReasonXdaf9dded.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1BillingPortalConfiab44PostRequestFormFeaturesCancellationReasonXdaf9dded is missing required property '" +
                    name +
                    "'",
            )
