...
public sealed class InlineV1CheckoutSessionsPostRequestFormMissingPaymentMethodX2ce1d29e {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1CheckoutSessionsPostRequestFormMissingPaymentMethodX2ce1d29e =
            when (value) {
                Cancel.value -> Cancel
    ...
    public object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormMissingPaymentMethodX2ce1d29e> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1CheckoutSessionsPostRequestFormMissingPaymentMethodX2ce1d29e",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1CheckoutSessionsPostRequestFormMissingPaymentMethodX2ce1d29e = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsPostRequestFormMissingPaymentMethodX2ce1d29e,
        ) {
