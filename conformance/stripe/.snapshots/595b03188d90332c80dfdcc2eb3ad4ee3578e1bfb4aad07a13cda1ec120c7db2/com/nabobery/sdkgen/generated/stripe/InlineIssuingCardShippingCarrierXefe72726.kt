...
public sealed class InlineIssuingCardShippingCarrierXefe72726 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineIssuingCardShippingCarrierXefe72726 =
            when (value) {
                Dhl.value -> Dhl
                Fedex.value -> Fedex
    ...
    public object Serializer : KSerializer<InlineIssuingCardShippingCarrierXefe72726> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineIssuingCardShippingCarrierXefe72726",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineIssuingCardShippingCarrierXefe72726 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineIssuingCardShippingCarrierXefe72726,
        ) {
