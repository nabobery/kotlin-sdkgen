...
public class IssuingDisputeFraudulentEvidence(
     ...
     * dispute.
     */
    public val additionalDocumentation: InlineIssuingDisputeFraudulentEvidenceAdditionalDocumentationXfbcd8448? = null,
    /**
    ...
    public class Builder {
        ...
        public fun build(): IssuingDisputeFraudulentEvidence =
    ...
    public object Serializer : KSerializer<IssuingDisputeFraudulentEvidence> {
        ...
        override fun deserialize(decoder: Decoder): IssuingDisputeFraudulentEvidence {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("IssuingDisputeFraudulentEvidence must be a JSON object")
                ...
                additionalDocumentation =
                    rawObject["additional_documentation"]?.let { element ->
                        if (element ==
                            ...
                            json
                                .decodeFromJsonElement<InlineIssuingDisputeFraudulentEvidenceAdditionalDocumentationXfbcd8448?>(
                                    element,
                                )
                        }
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: IssuingDisputeFraudulentEvidence,
        ) {
...
public fun issuingDisputeFraudulentEvidence(
    block: IssuingDisputeFraudulentEvidence.Builder.() -> Unit,
): IssuingDisputeFraudulentEvidence = IssuingDisputeFraudulentEvidence.build(block)
