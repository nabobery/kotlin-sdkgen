...
public class TreasuryTransactionsResourceFlowDetails(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): TreasuryTransactionsResourceFlowDetails =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<TreasuryTransactionsResourceFlowDetails> {
        ...
        override fun deserialize(decoder: Decoder): TreasuryTransactionsResourceFlowDetails {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("TreasuryTransactionsResourceFlowDetails must be a JSON object")
            val type =
                json.decodeRequired<InlineTreasuryTransactionsResourceFlowDetailsTypeX471eba71>(
                    rawObject,
                    "type",
                )
            return TreasuryTransactionsResourceFlowDetails(
                type = type,
                creditReversal =
                    rawObject["credit_reversal"]?.let {
                        json.decodeFromJsonElement<TreasuryCreditReversal>(
                            it,
                        )
                    },
                debitReversal =
                    rawObject["debit_reversal"]?.let {
                        json.decodeFromJsonElement<TreasuryDebitReversal>(
                            it,
                        )
                    },
                inboundTransfer =
                    rawObject["inbound_transfer"]?.let {
                        json.decodeFromJsonElement<TreasuryInboundTransfer>(
                            it,
                        )
                    },
                issuingAuthorization =
                    rawObject["issuing_authorization"]?.let {
                        json
                            .decodeFromJsonElement<IssuingAuthorization>(
                                it,
                            )
                    },
                outboundPayment =
                    rawObject["outbound_payment"]?.let {
                        json.decodeFromJsonElement<TreasuryOutboundPayment>(
                            it,
                        )
                    },
                outboundTransfer =
                    rawObject["outbound_transfer"]?.let {
                        json.decodeFromJsonElement<TreasuryOutboundTransfer>(
                            it,
                        )
                    },
                receivedCredit =
                    rawObject["received_credit"]?.let {
                        json
                            .decodeFromJsonElement<TreasuryReceivedCredit>(
                                it,
                            )
                    },
                receivedDebit =
                    rawObject["received_debit"]?.let {
                        json.decodeFromJsonElement<TreasuryReceivedDebit>(
                            it,
                        )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: TreasuryTransactionsResourceFlowDetails,
        ) {
...
public fun treasuryTransactionsResourceFlowDetails(
    block: TreasuryTransactionsResourceFlowDetails.Builder.() -> Unit,
): TreasuryTransactionsResourceFlowDetails = TreasuryTransactionsResourceFlowDetails.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "TreasuryTransactionsResourceFlowDetails is missing required property '" + name + "'",
            )
