...
public class InlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemPeriodXcf27e94f(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemPeriodXcf27e94f = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemPeriodXcf27e94f> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemPeriodXcf27e94f must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemPeriodXcf27e94f,
        ) {
            val jsonEncoder =
...
public fun inlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemPeriodXcf27e94f(
    block: InlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemPeriodXcf27e94f.Builder.() -> Unit,
): InlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemPeriodXcf27e94f =
    InlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemPeriodXcf27e94f.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemPeriodXcf27e94f is missing required property '" +
                    name +
                    "'",
            )
