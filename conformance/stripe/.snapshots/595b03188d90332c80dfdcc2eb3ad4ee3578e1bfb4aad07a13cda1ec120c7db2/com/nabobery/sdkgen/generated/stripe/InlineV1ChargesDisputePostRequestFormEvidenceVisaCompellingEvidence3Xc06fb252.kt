...
public class InlineV1ChargesDisputePostRequestFormEvidenceVisaCompellingEvidence3Xc06fb252(
    public val disputedTransaction: InlineV1ChargesDisputePostRequestFormEvidenceDisputedTransactionX1acee5d1? = null,
    public val priorUndisputedTransactions:
        List<InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf1ItemX352b5a32>? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1ChargesDisputePostRequestFormEvidenceVisaCompellingEvidence3Xc06fb252 =
    ...
    public object Serializer : KSerializer<InlineV1ChargesDisputePostRequestFormEvidenceVisaCompellingEvidence3Xc06fb252> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1ChargesDisputePostRequestFormEvidenceVisaCompellingEvidence3Xc06fb252 must be a JSON object",
                    )
            return InlineV1ChargesDisputePostRequestFormEvidenceVisaCompellingEvidence3Xc06fb252(
                disputedTransaction =
                    rawObject["disputed_transaction"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1ChargesDisputePostRequestFormEvidenceDisputedTransactionX1acee5d1>(
                                it,
                            )
                    },
                priorUndisputedTransactions =
                    rawObject["prior_undisputed_transactions"]?.let {
                        json
                            .decodeFromJsonElement<List<InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf1ItemX352b5a32>>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ChargesDisputePostRequestFormEvidenceVisaCompellingEvidence3Xc06fb252,
        ) {
            val jsonEncoder =
...
public fun inlineV1ChargesDisputePostRequestFormEvidenceVisaCompellingEvidence3Xc06fb252(
    block: InlineV1ChargesDisputePostRequestFormEvidenceVisaCompellingEvidence3Xc06fb252.Builder.() -> Unit,
): InlineV1ChargesDisputePostRequestFormEvidenceVisaCompellingEvidence3Xc06fb252 =
    InlineV1ChargesDisputePostRequestFormEvidenceVisaCompellingEvidence3Xc06fb252.build(block)
