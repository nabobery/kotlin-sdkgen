...
internal data class InlineV1AccountsPostRequestFormSettingsTreasuryTosAcceptanceUserAgentXed5c6b70Inspection(
    ...
    public val matchesInlineV1AccountsPostRequestFormSettingsTreasuryTosAcceptanceAnyOf2Xa91b137c: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1AccountsPostRequestFormSettingsTreasuryTosAcceptanceAnyOf2Xa91b137c,
            ).count {
                it
            }
}
...
public class InlineV1AccountsPostRequestFormSettingsTreasuryTosAcceptanceUserAgentXed5c6b70 internal constructor(
    ...
    private val inspection: InlineV1AccountsPostRequestFormSettingsTreasuryTosAcceptanceUserAgentXed5c6b70Inspection,
) {
    ...
    public val inlineV1AccountsPostRequestFormSettingsTreasuryTosAcceptanceAnyOf2Xa91b137c:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1AccountsPostRequestFormSettingsTreasuryTosAcceptanceAnyOf2Xa91b137c) {
                json
                    .decodeFromJsonElement<InlineV1AccountsPostRequestFormSettingsTreasuryTosAcceptanceAnyOf2Xa91b137c>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1AccountsPostRequestFormSettingsTreasuryTosAcceptanceUserAgentXed5c6b70Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1AccountsPostRequestFormSettingsTreasuryTosAcceptanceAnyOf2Xa91b137c) {
                    add(
                        InlineV1AccountsPostRequestFormSettingsTreasuryTosAcceptanceUserAgentXed5c6b70Branch.InlineV1AccountsPostRequestFormSettingsTreasuryTosAcceptanceAnyOf2Xa91b137c,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1AccountsPostRequestFormSettingsTreasuryTosAcceptanceUserAgentXed5c6b70 {
            val inspection = inspectInlineV1AccountsPostRequestFormSettingsTreasuryTosAcceptanceUserAgentXed5c6b70(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1AccountsPostRequestFormSettingsTreasuryTosAcceptanceUserAgentXed5c6b70NoMatchException(
                    "InlineV1AccountsPostRequestFormSettingsTreasuryTosAcceptanceUserAgentXed5c6b70 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1AccountsPostRequestFormSettingsTreasuryTosAcceptanceUserAgentXed5c6b70> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPostRequestFormSettingsTreasuryTosAcceptanceUserAgentXed5c6b70,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1AccountsPostRequestFormSettingsTreasuryTosAcceptanceUserAgentXed5c6b70",
...
private fun inspectInlineV1AccountsPostRequestFormSettingsTreasuryTosAcceptanceUserAgentXed5c6b70(
    element: JsonElement,
): InlineV1AccountsPostRequestFormSettingsTreasuryTosAcceptanceUserAgentXed5c6b70Inspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1AccountsPostRequestFormSettingsTreasuryTosAcceptanceAnyOf2Xa91b137c =
        element
            .isJsonDecodable<InlineV1AccountsPostRequestFormSettingsTreasuryTosAcceptanceAnyOf2Xa91b137c>()
    return InlineV1AccountsPostRequestFormSettingsTreasuryTosAcceptanceUserAgentXed5c6b70Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1AccountsPostRequestFormSettingsTreasuryTosAcceptanceAnyOf2Xa91b137c) {
                    add(
                        "InlineV1AccountsPostRequestFormSettingsTreasuryTosAcceptanceAnyOf2Xa91b137c: value does not match InlineV1AccountsPostRequestFormSettingsTreasuryTosAcceptanceAnyOf2Xa91b137c",
                    )
                }
            },
    )
