...
public class InsightsResourcesPaymentEvaluationShipping(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InsightsResourcesPaymentEvaluationShipping =
    ...
    public object Serializer : KSerializer<InsightsResourcesPaymentEvaluationShipping> {
        ...
        override fun deserialize(decoder: Decoder): InsightsResourcesPaymentEvaluationShipping {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("InsightsResourcesPaymentEvaluationShipping must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InsightsResourcesPaymentEvaluationShipping,
        ) {
...
public fun insightsResourcesPaymentEvaluationShipping(
    block: InsightsResourcesPaymentEvaluationShipping.Builder.() -> Unit,
): InsightsResourcesPaymentEvaluationShipping = InsightsResourcesPaymentEvaluationShipping.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InsightsResourcesPaymentEvaluationShipping is missing required property '" + name + "'",
            )
