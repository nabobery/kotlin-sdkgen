...
public class InlineV1PaymentLinksPostRequestFormSubscriptionDataX7c983df0(
    public val invoiceSettings: InlineV1PaymentLinksPostRequestFormSubscriptionDataInvoiceSettingsX0f24373e? = null,
    public val metadata: InlineV1PaymentLinksPostRequestFormSubscriptionDataMetadataXee471759? = null,
    public val trialPeriodDays: InlineV1PaymentLinksPostRequestFormSubscriptionDataTrialPeriodDaysX6b24bc2a? = null,
    public val trialSettings: InlineV1PaymentLinksPostRequestFormSubscriptionDataTrialSettingsXabb4339c? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1PaymentLinksPostRequestFormSubscriptionDataX7c983df0 =
            InlineV1PaymentLinksPostRequestFormSubscriptionDataX7c983df0(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PaymentLinksPostRequestFormSubscriptionDataX7c983df0 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentLinksPostRequestFormSubscriptionDataX7c983df0> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentLinksPostRequestFormSubscriptionDataX7c983df0 must be a JSON object",
                    )
            return InlineV1PaymentLinksPostRequestFormSubscriptionDataX7c983df0(
                invoiceSettings =
                    rawObject["invoice_settings"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormSubscriptionDataInvoiceSettingsX0f24373e>(
                                it,
                            )
                    },
                metadata =
                    rawObject["metadata"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormSubscriptionDataMetadataXee471759>(
                                it,
                            )
                    },
                trialPeriodDays =
                    rawObject["trial_period_days"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormSubscriptionDataTrialPeriodDaysX6b24bc2a>(
                                it,
                            )
                    },
                trialSettings =
                    rawObject["trial_settings"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormSubscriptionDataTrialSettingsXabb4339c>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentLinksPostRequestFormSubscriptionDataX7c983df0,
        ) {
...
public fun inlineV1PaymentLinksPostRequestFormSubscriptionDataX7c983df0(
    block: InlineV1PaymentLinksPostRequestFormSubscriptionDataX7c983df0.Builder.() -> Unit,
): InlineV1PaymentLinksPostRequestFormSubscriptionDataX7c983df0 =
    InlineV1PaymentLinksPostRequestFormSubscriptionDataX7c983df0.build(block)
