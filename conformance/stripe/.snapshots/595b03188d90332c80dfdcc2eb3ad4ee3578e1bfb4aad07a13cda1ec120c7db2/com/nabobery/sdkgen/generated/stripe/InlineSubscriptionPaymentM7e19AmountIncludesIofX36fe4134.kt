...
public sealed class InlineSubscriptionPaymentM7e19AmountIncludesIofX36fe4134 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineSubscriptionPaymentM7e19AmountIncludesIofX36fe4134 =
            when (value) {
                Always.value -> Always
                Never.value -> Never
    ...
    public object Serializer : KSerializer<InlineSubscriptionPaymentM7e19AmountIncludesIofX36fe4134> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineSubscriptionPaymentM7e19AmountIncludesIofX36fe4134",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineSubscriptionPaymentM7e19AmountIncludesIofX36fe4134 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineSubscriptionPaymentM7e19AmountIncludesIofX36fe4134,
        ) {
