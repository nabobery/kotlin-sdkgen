...
internal data class InlineV1SubscriptionsPostRequestFormPaymentSettingsBancontactXb21f2e38Inspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesInlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X9fed1e9c,
                matchesInlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2X2609a2be,
            ).count {
                it
            }
}
...
public class InlineV1SubscriptionsPostRequestFormPaymentSettingsBancontactXb21f2e38 internal constructor(
    ...
    private val inspection: InlineV1SubscriptionsPostRequestFormPaymentSettingsBancontactXb21f2e38Inspection,
) {
    public val inlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X9fed1e9c:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X9fed1e9c) {
                json
                    .decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X9fed1e9c>(
                        raw,
                    )
            } else {
                null
    ...
    public val inlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2X2609a2be:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2X2609a2be) {
                json
                    .decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2X2609a2be>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches:
        ...
        get() =
            buildSet {
                if (inspection.matchesInlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X9fed1e9c) {
                    add(
                        InlineV1SubscriptionsPostRequestFormPaymentSettingsBancontactXb21f2e38Branch.InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X9fed1e9c,
                    )
                }
                if (inspection.matchesInlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2X2609a2be) {
                    add(
                        InlineV1SubscriptionsPostRequestFormPaymentSettingsBancontactXb21f2e38Branch.InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2X2609a2be,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1SubscriptionsPostRequestFormPaymentSettingsBancontactXb21f2e38 {
            val inspection = inspectInlineV1SubscriptionsPostRequestFormPaymentSettingsBancontactXb21f2e38(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1SubscriptionsPostRequestFormPaymentSettingsBancontactXb21f2e38NoMatchException(
                    "InlineV1SubscriptionsPostRequestFormPaymentSettingsBancontactXb21f2e38 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionsPostRequestFormPaymentSettingsBancontactXb21f2e38> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsPostRequestFormPaymentSettingsBancontactXb21f2e38,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1SubscriptionsPostRequestFormPaymentSettingsBancontactXb21f2e38",
...
private fun inspectInlineV1SubscriptionsPostRequestFormPaymentSettingsBancontactXb21f2e38(
    element: JsonElement,
): InlineV1SubscriptionsPostRequestFormPaymentSettingsBancontactXb21f2e38Inspection {
    val matchesInlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X9fed1e9c =
        element
            .isJsonDecodable<InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X9fed1e9c>()
    val matchesInlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2X2609a2be =
        element
            .isJsonDecodable<InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2X2609a2be>()
    return InlineV1SubscriptionsPostRequestFormPaymentSettingsBancontactXb21f2e38Inspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X9fed1e9c) {
                    add(
                        "InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X9fed1e9c: value does not match InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X9fed1e9c",
                    )
                }
                if (!matchesInlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2X2609a2be) {
                    add(
                        "InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2X2609a2be: value does not match InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2X2609a2be",
                    )
                }
            },
    )
