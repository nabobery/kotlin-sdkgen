...
public class InlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemPriceDataXb2fabe99(
    ...
    public val taxBehavior: InlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemTaxBehaviorX8f1093b9? = null,
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemPriceDataXb2fabe99 =
    ...
    public object Serializer : KSerializer<InlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemPriceDataXb2fabe99> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemPriceDataXb2fabe99 must be a JSON object",
                    )
            ...
            return InlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemPriceDataXb2fabe99(
                ...
                taxBehavior =
                    rawObject["tax_behavior"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemTaxBehaviorX8f1093b9>(
                                it,
                            )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemPriceDataXb2fabe99,
        ) {
            val jsonEncoder =
...
public fun inlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemPriceDataXb2fabe99(
    block: InlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemPriceDataXb2fabe99.Builder.() -> Unit,
): InlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemPriceDataXb2fabe99 =
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemPriceDataXb2fabe99 is missing required property '" +
                    name +
                    "'",
            )
