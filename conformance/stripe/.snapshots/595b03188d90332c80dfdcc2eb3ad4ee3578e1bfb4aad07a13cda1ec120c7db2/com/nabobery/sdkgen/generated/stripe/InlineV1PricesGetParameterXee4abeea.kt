...
public sealed class InlineV1PricesGetParameterXee4abeea {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1PricesGetParameterXee4abeea =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1PricesGetParameterXee4abeea> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1PricesGetParameterXee4abeea",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1PricesGetParameterXee4abeea =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PricesGetParameterXee4abeea,
        ) {
