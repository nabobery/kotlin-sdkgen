...
@Serializable
public data class PaymentLinksResourceInvoiceSettingsView(
    @SerialName("account_tax_ids")
    public val accountTaxIds: List<InlinePaymentLinksResourceInvoiceSettingsAccountTaxIdsItemX4e6052ae>? = null,
    ...
    public val renderingOptions: InlinePaymentLinksResourceInvoiceSettingsRenderingOptionsX61aa2d58? = null,
)
...
public class PaymentLinksResourceInvoiceSettings(
    ...
    public class Builder {
        ...
        public fun build(): PaymentLinksResourceInvoiceSettings =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentLinksResourceInvoiceSettings =
    ...
    public object Serializer : KSerializer<PaymentLinksResourceInvoiceSettings> {
        ...
        override fun deserialize(decoder: Decoder): PaymentLinksResourceInvoiceSettings {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentLinksResourceInvoiceSettings must be a JSON object")
                ...
                accountTaxIds =
                    rawObject["account_tax_ids"]?.let { element ->
                        if (element ==
                            ...
                            json
                                .decodeFromJsonElement<List<InlinePaymentLinksResourceInvoiceSettingsAccountTaxIdsItemX4e6052ae>?>(
                                    element,
                                )
                        }
                    },
                ...
                issuer =
                    rawObject["issuer"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentLinksResourceInvoiceSettingsIssuerXce9c126b?>(
                                element,
                            )
                        }
                    },
                ...
                renderingOptions =
                    rawObject["rendering_options"]?.let { element ->
                        if (element ==
                            ...
                            json
                                .decodeFromJsonElement<InlinePaymentLinksResourceInvoiceSettingsRenderingOptionsX61aa2d58?>(
                                    element,
                                )
                        }
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentLinksResourceInvoiceSettings,
        ) {
...
public fun paymentLinksResourceInvoiceSettings(
    block: PaymentLinksResourceInvoiceSettings.Builder.() -> Unit,
): PaymentLinksResourceInvoiceSettings = PaymentLinksResourceInvoiceSettings.build(block)
