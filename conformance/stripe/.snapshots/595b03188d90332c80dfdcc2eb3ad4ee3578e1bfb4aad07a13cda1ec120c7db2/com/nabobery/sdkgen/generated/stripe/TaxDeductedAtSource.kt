...
public class TaxDeductedAtSource(
    ...
    public object Serializer : KSerializer<TaxDeductedAtSource> {
        ...
        override fun deserialize(decoder: Decoder): TaxDeductedAtSource {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("TaxDeductedAtSource must be a JSON object")
...
public fun taxDeductedAtSource(block: TaxDeductedAtSource.Builder.() -> Unit): TaxDeductedAtSource =
    TaxDeductedAtSource.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("TaxDeductedAtSource is missing required property '" + name + "'")
