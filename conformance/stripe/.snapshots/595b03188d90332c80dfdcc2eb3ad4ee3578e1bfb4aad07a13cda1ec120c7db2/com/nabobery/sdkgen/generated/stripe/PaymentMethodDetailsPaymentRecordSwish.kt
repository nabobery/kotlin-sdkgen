...
public class PaymentMethodDetailsPaymentRecordSwish(
    ...
    public class Builder {
        ...
        public fun build(): PaymentMethodDetailsPaymentRecordSwish =
            PaymentMethodDetailsPaymentRecordSwish(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentMethodDetailsPaymentRecordSwish =
    ...
    public object Serializer : KSerializer<PaymentMethodDetailsPaymentRecordSwish> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodDetailsPaymentRecordSwish {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodDetailsPaymentRecordSwish must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentMethodDetailsPaymentRecordSwish,
        ) {
...
public fun paymentMethodDetailsPaymentRecordSwish(
    block: PaymentMethodDetailsPaymentRecordSwish.Builder.() -> Unit,
): PaymentMethodDetailsPaymentRecordSwish = PaymentMethodDetailsPaymentRecordSwish.build(block)
