...
public class InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsNextBillingXeeb216ca(
    ...
    public object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsNextBillingXeeb216ca> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsNextBillingXeeb216ca must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsNextBillingXeeb216ca,
        ) {
            val jsonEncoder =
...
public fun inlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsNextBillingXeeb216ca(
    block: InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsNextBillingXeeb216ca.Builder.() -> Unit,
): InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsNextBillingXeeb216ca =
    InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsNextBillingXeeb216ca.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsNextBillingXeeb216ca is missing required property '" +
                    name +
                    "'",
            )
