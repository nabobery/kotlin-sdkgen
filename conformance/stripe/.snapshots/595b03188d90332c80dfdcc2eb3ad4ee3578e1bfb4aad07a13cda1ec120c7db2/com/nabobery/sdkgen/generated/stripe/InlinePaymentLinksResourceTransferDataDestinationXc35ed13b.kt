...
public class InlinePaymentLinksResourceTransferDataDestinationXc35ed13b internal constructor(
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlinePaymentLinksResourceTransferDataDestinationXc35ed13bBranch.Branch1,
                    )
                }
                if (inspection.matchesAccount) {
                    add(
                        InlinePaymentLinksResourceTransferDataDestinationXc35ed13bBranch.Account,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlinePaymentLinksResourceTransferDataDestinationXc35ed13b {
            val inspection = inspectInlinePaymentLinksResourceTransferDataDestinationXc35ed13b(raw)
            if (inspection.matchCount == 0) {
                throw InlinePaymentLinksResourceTransferDataDestinationXc35ed13bNoMatchException(
                    "InlinePaymentLinksResourceTransferDataDestinationXc35ed13b matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlinePaymentLinksResourceTransferDataDestinationXc35ed13b> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentLinksResourceTransferDataDestinationXc35ed13b,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlinePaymentLinksResourceTransferDataDestinationXc35ed13b",
...
private fun inspectInlinePaymentLinksResourceTransferDataDestinationXc35ed13b(
    element: JsonElement,
): InlinePaymentLinksResourceTransferDataDestinationXc35ed13bInspection {
