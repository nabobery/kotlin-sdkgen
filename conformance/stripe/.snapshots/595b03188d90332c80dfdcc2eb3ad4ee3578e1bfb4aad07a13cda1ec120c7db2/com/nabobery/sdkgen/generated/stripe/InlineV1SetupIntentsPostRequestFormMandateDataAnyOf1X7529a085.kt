...
public class InlineV1SetupIntentsPostRequestFormMandateDataAnyOf1X7529a085(
    public val customerAcceptance: InlineV1SetupIntentsPostRequestFormMandateDataAnyOf1CustomerAcceptanceX006ccd1e,
) {
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1SetupIntentsPostRequestFormMandateDataAnyOf1X7529a085 =
    ...
    public object Serializer : KSerializer<InlineV1SetupIntentsPostRequestFormMandateDataAnyOf1X7529a085> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SetupIntentsPostRequestFormMandateDataAnyOf1X7529a085 must be a JSON object",
                    )
            val customerAcceptance =
                json
                    .decodeRequired<InlineV1SetupIntentsPostRequestFormMandateDataAnyOf1CustomerAcceptanceX006ccd1e>(
                        rawObject,
                        "customer_acceptance",
                    )
            return InlineV1SetupIntentsPostRequestFormMandateDataAnyOf1X7529a085(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SetupIntentsPostRequestFormMandateDataAnyOf1X7529a085,
        ) {
            val jsonEncoder =
...
public fun inlineV1SetupIntentsPostRequestFormMandateDataAnyOf1X7529a085(
    block: InlineV1SetupIntentsPostRequestFormMandateDataAnyOf1X7529a085.Builder.() -> Unit,
): InlineV1SetupIntentsPostRequestFormMandateDataAnyOf1X7529a085 =
    InlineV1SetupIntentsPostRequestFormMandateDataAnyOf1X7529a085.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1SetupIntentsPostRequestFormMandateDataAnyOf1X7529a085 is missing required property '" + name +
                    "'",
            )
