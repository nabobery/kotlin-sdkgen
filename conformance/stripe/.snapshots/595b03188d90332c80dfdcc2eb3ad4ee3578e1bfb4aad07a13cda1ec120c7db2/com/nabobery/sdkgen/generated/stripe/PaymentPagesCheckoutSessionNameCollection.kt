...
public class PaymentPagesCheckoutSessionNameCollection(
    ...
    public class Builder {
        ...
        public fun build(): PaymentPagesCheckoutSessionNameCollection =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentPagesCheckoutSessionNameCollection =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentPagesCheckoutSessionNameCollection> {
        ...
        override fun deserialize(decoder: Decoder): PaymentPagesCheckoutSessionNameCollection {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentPagesCheckoutSessionNameCollection must be a JSON object")
            return PaymentPagesCheckoutSessionNameCollection(
                business =
                    rawObject["business"]?.let {
                        json.decodeFromJsonElement<PaymentPagesCheckoutSessionBusinessName>(
                            it,
                        )
                    },
                individual =
                    rawObject["individual"]?.let {
                        json
                            .decodeFromJsonElement<PaymentPagesCheckoutSessionIndividualName>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentPagesCheckoutSessionNameCollection,
        ) {
...
public fun paymentPagesCheckoutSessionNameCollection(
    block: PaymentPagesCheckoutSessionNameCollection.Builder.() -> Unit,
): PaymentPagesCheckoutSessionNameCollection = PaymentPagesCheckoutSessionNameCollection.build(block)
