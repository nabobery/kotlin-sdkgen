...
public sealed class InlineV1InvoicesPostRequestFormPaymentSettingsAmountTypeXca78f5b2 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1InvoicesPostRequestFormPaymentSettingsAmountTypeXca78f5b2 =
            when (value) {
                Fixed.value -> Fixed
    ...
    public object Serializer : KSerializer<InlineV1InvoicesPostRequestFormPaymentSettingsAmountTypeXca78f5b2> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1InvoicesPostRequestFormPaymentSettingsAmountTypeXca78f5b2",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1InvoicesPostRequestFormPaymentSettingsAmountTypeXca78f5b2 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesPostRequestFormPaymentSettingsAmountTypeXca78f5b2,
        ) {
