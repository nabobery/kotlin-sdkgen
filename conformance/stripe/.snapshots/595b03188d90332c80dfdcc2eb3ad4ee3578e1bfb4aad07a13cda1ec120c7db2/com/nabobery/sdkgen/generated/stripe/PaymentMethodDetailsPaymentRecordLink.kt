...
public class PaymentMethodDetailsPaymentRecordLink(
    ...
    public class Builder {
        ...
        public fun build(): PaymentMethodDetailsPaymentRecordLink =
            PaymentMethodDetailsPaymentRecordLink(
                country = country,
            )
    }

    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentMethodDetailsPaymentRecordLink =
    ...
    public object Serializer : KSerializer<PaymentMethodDetailsPaymentRecordLink> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodDetailsPaymentRecordLink {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodDetailsPaymentRecordLink must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentMethodDetailsPaymentRecordLink,
        ) {
...
public fun paymentMethodDetailsPaymentRecordLink(
    block: PaymentMethodDetailsPaymentRecordLink.Builder.() -> Unit,
): PaymentMethodDetailsPaymentRecordLink = PaymentMethodDetailsPaymentRecordLink.build(block)
