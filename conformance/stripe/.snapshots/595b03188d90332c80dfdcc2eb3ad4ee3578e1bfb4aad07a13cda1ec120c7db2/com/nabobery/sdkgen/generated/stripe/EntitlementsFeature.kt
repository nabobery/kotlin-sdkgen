...
@Serializable
public data class EntitlementsFeatureView(
...
public class EntitlementsFeature(
    ...
    public object Serializer : KSerializer<EntitlementsFeature> {
        ...
        override fun deserialize(decoder: Decoder): EntitlementsFeature {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("EntitlementsFeature must be a JSON object")
...
public fun entitlementsFeature(block: EntitlementsFeature.Builder.() -> Unit): EntitlementsFeature =
    EntitlementsFeature.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("EntitlementsFeature is missing required property '" + name + "'")
