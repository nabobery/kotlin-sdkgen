...
public sealed class InlineTreasuryOutboundPaymentsResourceReturnedStatusCodeX0c1c9292 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineTreasuryOutboundPaymentsResourceReturnedStatusCodeX0c1c9292 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineTreasuryOutboundPaymentsResourceReturnedStatusCodeX0c1c9292> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineTreasuryOutboundPaymentsResourceReturnedStatusCodeX0c1c9292",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineTreasuryOutboundPaymentsResourceReturnedStatusCodeX0c1c9292 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineTreasuryOutboundPaymentsResourceReturnedStatusCodeX0c1c9292,
        ) {
