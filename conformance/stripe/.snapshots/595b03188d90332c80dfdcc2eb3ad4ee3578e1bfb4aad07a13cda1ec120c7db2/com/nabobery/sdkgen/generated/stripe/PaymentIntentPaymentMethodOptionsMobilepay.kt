...
public data class PaymentIntentPaymentMethodOptionsMobilepayView(
    ...
    public val captureMethod: InlinePaymentIntentPaymentMethodOptionsMobilepayCaptureMethodX6a16f03c? = null,
    @SerialName("setup_future_usage")
    public val setupFutureUsage: InlinePaymentIntentPaymentMethodOptionsMobilepaySetupFutureUsageX9f5b002b? = null,
)
...
public class PaymentIntentPaymentMethodOptionsMobilepay(
    ...
    public class Builder {
        ...
        public fun build(): PaymentIntentPaymentMethodOptionsMobilepay =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentIntentPaymentMethodOptionsMobilepay =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentIntentPaymentMethodOptionsMobilepay> {
        ...
        override fun deserialize(decoder: Decoder): PaymentIntentPaymentMethodOptionsMobilepay {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentIntentPaymentMethodOptionsMobilepay must be a JSON object")
            return PaymentIntentPaymentMethodOptionsMobilepay(
                captureMethod =
                    rawObject["capture_method"]?.let {
                        json
                            .decodeFromJsonElement<InlinePaymentIntentPaymentMethodOptionsMobilepayCaptureMethodX6a16f03c>(
                                it,
                            )
                    },
                setupFutureUsage =
                    rawObject["setup_future_usage"]?.let {
                        json
                            .decodeFromJsonElement<InlinePaymentIntentPaymentMethodOptionsMobilepaySetupFutureUsageX9f5b002b>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentIntentPaymentMethodOptionsMobilepay,
        ) {
...
public fun paymentIntentPaymentMethodOptionsMobilepay(
    block: PaymentIntentPaymentMethodOptionsMobilepay.Builder.() -> Unit,
): PaymentIntentPaymentMethodOptionsMobilepay = PaymentIntentPaymentMethodOptionsMobilepay.build(block)
