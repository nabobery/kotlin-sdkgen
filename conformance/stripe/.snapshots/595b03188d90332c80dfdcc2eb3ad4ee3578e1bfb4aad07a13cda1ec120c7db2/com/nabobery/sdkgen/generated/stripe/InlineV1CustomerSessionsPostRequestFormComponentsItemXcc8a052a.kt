...
public sealed class InlineV1CustomerSessionsPostRequestFormComponentsItemXcc8a052a {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1CustomerSessionsPostRequestFormComponentsItemXcc8a052a =
            when (value) {
                Always.value -> Always
    ...
    public object Serializer : KSerializer<InlineV1CustomerSessionsPostRequestFormComponentsItemXcc8a052a> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1CustomerSessionsPostRequestFormComponentsItemXcc8a052a",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1CustomerSessionsPostRequestFormComponentsItemXcc8a052a =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomerSessionsPostRequestFormComponentsItemXcc8a052a,
        ) {
