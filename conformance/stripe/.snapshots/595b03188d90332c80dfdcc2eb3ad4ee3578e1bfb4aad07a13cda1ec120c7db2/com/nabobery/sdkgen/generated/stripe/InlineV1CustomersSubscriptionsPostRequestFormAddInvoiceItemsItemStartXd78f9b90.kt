...
public class InlineV1CustomersSubscriptionsPostRequestFormAddInvoiceItemsItemStartXd78f9b90(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1CustomersSubscriptionsPostRequestFormAddInvoiceItemsItemStartXd78f9b90 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1CustomersSubscriptionsPostRequestFormAddInvoiceItemsItemStartXd78f9b90> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CustomersSubscriptionsPostRequestFormAddInvoiceItemsItemStartXd78f9b90 must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineV1CustomersSubscriptionsPostRequestFormAddInvoiceItemsItemTypeXca70f805>(
                    rawObject,
                    "type",
                )
            return InlineV1CustomersSubscriptionsPostRequestFormAddInvoiceItemsItemStartXd78f9b90(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersSubscriptionsPostRequestFormAddInvoiceItemsItemStartXd78f9b90,
        ) {
            val jsonEncoder =
...
public fun inlineV1CustomersSubscriptionsPostRequestFormAddInvoiceItemsItemStartXd78f9b90(
    block: InlineV1CustomersSubscriptionsPostRequestFormAddInvoiceItemsItemStartXd78f9b90.Builder.() -> Unit,
): InlineV1CustomersSubscriptionsPostRequestFormAddInvoiceItemsItemStartXd78f9b90 =
    InlineV1CustomersSubscriptionsPostRequestFormAddInvoiceItemsItemStartXd78f9b90.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1CustomersSubscriptionsPostRequestFormAddInvoiceItemsItemStartXd78f9b90 is missing required property '" +
                    name +
                    "'",
            )
