...
internal data class InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsEndDateX467b95e3Inspection(
    ...
    public val matchesInlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesAnyOf2X4da8e126: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesAnyOf2X4da8e126,
            ).count {
                it
            }
}
...
public class InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsEndDateX467b95e3 internal constructor(
    ...
    private val inspection: InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsEndDateX467b95e3Inspection,
) {
    ...
    public val inlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesAnyOf2X4da8e126:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesAnyOf2X4da8e126) {
                json
                    .decodeFromJsonElement<InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesAnyOf2X4da8e126>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsEndDateX467b95e3Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesAnyOf2X4da8e126) {
                    add(
                        InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsEndDateX467b95e3Branch.InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesAnyOf2X4da8e126,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsEndDateX467b95e3 {
            val inspection = inspectInlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsEndDateX467b95e3(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsEndDateX467b95e3NoMatchException(
                    "InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsEndDateX467b95e3 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsEndDateX467b95e3> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsEndDateX467b95e3,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsEndDateX467b95e3",
...
private fun inspectInlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsEndDateX467b95e3(
    element: JsonElement,
): InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsEndDateX467b95e3Inspection {
    val matchesBranch1 = element.isJsonDecodable<Int>()
    val matchesInlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesAnyOf2X4da8e126 =
        element
            .isJsonDecodable<InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesAnyOf2X4da8e126>()
    return InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsEndDateX467b95e3Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesAnyOf2X4da8e126) {
                    add(
                        "InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesAnyOf2X4da8e126: value does not match InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesAnyOf2X4da8e126",
                    )
                }
            },
    )
