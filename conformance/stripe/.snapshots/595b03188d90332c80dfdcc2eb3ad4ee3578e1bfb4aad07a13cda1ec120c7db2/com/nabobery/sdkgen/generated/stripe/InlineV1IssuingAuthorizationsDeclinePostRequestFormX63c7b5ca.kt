...
public class InlineV1IssuingAuthorizationsDeclinePostRequestFormX63c7b5ca(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1IssuingAuthorizationsDeclinePostRequestFormX63c7b5ca =
            InlineV1IssuingAuthorizationsDeclinePostRequestFormX63c7b5ca(
                expand = expand,
                metadata = metadata,
            )
    }
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1IssuingAuthorizationsDeclinePostRequestFormX63c7b5ca =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1IssuingAuthorizationsDeclinePostRequestFormX63c7b5ca> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1IssuingAuthorizationsDeclinePostRequestFormX63c7b5ca must be a JSON object",
                    )
            return InlineV1IssuingAuthorizationsDeclinePostRequestFormX63c7b5ca(
                ...
                metadata =
                    rawObject["metadata"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1IssuingAuthorizationsDeclinePostRequestFormMetadataX10fdf7ca>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingAuthorizationsDeclinePostRequestFormX63c7b5ca,
        ) {
...
public fun inlineV1IssuingAuthorizationsDeclinePostRequestFormX63c7b5ca(
    block: InlineV1IssuingAuthorizationsDeclinePostRequestFormX63c7b5ca.Builder.() -> Unit,
): InlineV1IssuingAuthorizationsDeclinePostRequestFormX63c7b5ca =
    InlineV1IssuingAuthorizationsDeclinePostRequestFormX63c7b5ca.build(block)
