...
public sealed class InlineInsightsResourcesPaymentEvaluationRejectedCardCvcCheckX24884422 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineInsightsResourcesPaymentEvaluationRejectedCardCvcCheckX24884422 =
            when (value) {
                Fail.value -> Fail
                Pass.value -> Pass
    ...
    public object Serializer : KSerializer<InlineInsightsResourcesPaymentEvaluationRejectedCardCvcCheckX24884422> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineInsightsResourcesPaymentEvaluationRejectedCardCvcCheckX24884422",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineInsightsResourcesPaymentEvaluationRejectedCardCvcCheckX24884422 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineInsightsResourcesPaymentEvaluationRejectedCardCvcCheckX24884422,
        ) {
