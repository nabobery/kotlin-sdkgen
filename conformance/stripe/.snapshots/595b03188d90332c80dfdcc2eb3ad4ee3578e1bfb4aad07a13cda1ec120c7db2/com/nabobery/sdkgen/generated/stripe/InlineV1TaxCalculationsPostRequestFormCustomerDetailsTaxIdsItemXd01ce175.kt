...
public class InlineV1TaxCalculationsPostRequestFormCustomerDetailsTaxIdsItemXd01ce175(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1TaxCalculationsPostRequestFormCustomerDetailsTaxIdsItemXd01ce175 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TaxCalculationsPostRequestFormCustomerDetailsTaxIdsItemXd01ce175> {
        override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1TaxCalculationsPostRequestFormCustomerDetailsTaxIdsItemXd01ce175 {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TaxCalculationsPostRequestFormCustomerDetailsTaxIdsItemXd01ce175 must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineV1TaxCalculationsPostRequestFormCustomerDetailsTaxIdsItemTypeXfad006a3>(
                    rawObject,
                    "type",
                )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TaxCalculationsPostRequestFormCustomerDetailsTaxIdsItemXd01ce175,
        ) {
            val jsonEncoder =
...
public fun inlineV1TaxCalculationsPostRequestFormCustomerDetailsTaxIdsItemXd01ce175(
    block: InlineV1TaxCalculationsPostRequestFormCustomerDetailsTaxIdsItemXd01ce175.Builder.() -> Unit,
): InlineV1TaxCalculationsPostRequestFormCustomerDetailsTaxIdsItemXd01ce175 =
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TaxCalculationsPostRequestFormCustomerDetailsTaxIdsItemXd01ce175 is missing required property '" +
                    name +
                    "'",
            )
