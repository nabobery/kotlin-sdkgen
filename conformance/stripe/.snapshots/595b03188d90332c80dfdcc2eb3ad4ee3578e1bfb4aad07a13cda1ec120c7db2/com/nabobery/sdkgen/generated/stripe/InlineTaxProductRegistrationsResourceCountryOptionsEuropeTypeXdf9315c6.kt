...
public sealed class InlineTaxProductRegistrationsResourceCountryOptionsEuropeTypeXdf9315c6 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineTaxProductRegistrationsResourceCountryOptionsEuropeTypeXdf9315c6 =
            when (value) {
                Ioss.value -> Ioss
    ...
    public object Serializer : KSerializer<InlineTaxProductRegistrationsResourceCountryOptionsEuropeTypeXdf9315c6> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineTaxProductRegistrationsResourceCountryOptionsEuropeTypeXdf9315c6",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineTaxProductRegistrationsResourceCountryOptionsEuropeTypeXdf9315c6 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineTaxProductRegistrationsResourceCountryOptionsEuropeTypeXdf9315c6,
        ) {
