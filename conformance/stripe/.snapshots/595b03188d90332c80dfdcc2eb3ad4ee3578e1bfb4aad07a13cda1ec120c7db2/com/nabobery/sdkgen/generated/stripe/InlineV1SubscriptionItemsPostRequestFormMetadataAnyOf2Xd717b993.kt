...
public sealed class InlineV1SubscriptionItemsPostRequestFormMetadataAnyOf2Xd717b993 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1SubscriptionItemsPostRequestFormMetadataAnyOf2Xd717b993 =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionItemsPostRequestFormMetadataAnyOf2Xd717b993> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1SubscriptionItemsPostRequestFormMetadataAnyOf2Xd717b993",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1SubscriptionItemsPostRequestFormMetadataAnyOf2Xd717b993 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionItemsPostRequestFormMetadataAnyOf2Xd717b993,
        ) {
