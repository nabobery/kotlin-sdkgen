...
public sealed class InlineAccountCapabilitiesIndiaInternationalPaymentsX739ccc58 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineAccountCapabilitiesIndiaInternationalPaymentsX739ccc58 =
            when (value) {
                Active.value -> Active
    ...
    public object Serializer : KSerializer<InlineAccountCapabilitiesIndiaInternationalPaymentsX739ccc58> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineAccountCapabilitiesIndiaInternationalPaymentsX739ccc58",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineAccountCapabilitiesIndiaInternationalPaymentsX739ccc58 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineAccountCapabilitiesIndiaInternationalPaymentsX739ccc58,
        ) {
