...
public class CheckoutCardInstallmentsOptions(
    ...
    public class Builder {
        ...
        public fun build(): CheckoutCardInstallmentsOptions =
    ...
    public object Serializer : KSerializer<CheckoutCardInstallmentsOptions> {
        ...
        override fun deserialize(decoder: Decoder): CheckoutCardInstallmentsOptions {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("CheckoutCardInstallmentsOptions must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: CheckoutCardInstallmentsOptions,
        ) {
...
public fun checkoutCardInstallmentsOptions(
    block: CheckoutCardInstallmentsOptions.Builder.() -> Unit,
): CheckoutCardInstallmentsOptions = CheckoutCardInstallmentsOptions.build(block)
