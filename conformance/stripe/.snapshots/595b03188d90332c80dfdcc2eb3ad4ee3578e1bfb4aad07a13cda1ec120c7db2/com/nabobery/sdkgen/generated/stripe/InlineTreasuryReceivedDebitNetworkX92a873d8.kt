...
public sealed class InlineTreasuryReceivedDebitNetworkX92a873d8 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineTreasuryReceivedDebitNetworkX92a873d8 =
            when (value) {
                Ach.value -> Ach
                Card.value -> Card
                Stripe.value -> Stripe
    ...
    public object Serializer : KSerializer<InlineTreasuryReceivedDebitNetworkX92a873d8> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineTreasuryReceivedDebitNetworkX92a873d8",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineTreasuryReceivedDebitNetworkX92a873d8 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineTreasuryReceivedDebitNetworkX92a873d8,
        ) {
