...
public class PaymentMethodDetailsPaymentRecordAmazonPay(
    public val funding: PaymentsPrimitivesPaymentRecordsResourcePaymentMethodAmazonPayDetailsResourceFunding? = null,
    /**
    ...
    public class Builder {
        ...
        public fun build(): PaymentMethodDetailsPaymentRecordAmazonPay =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentMethodDetailsPaymentRecordAmazonPay =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentMethodDetailsPaymentRecordAmazonPay> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodDetailsPaymentRecordAmazonPay {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodDetailsPaymentRecordAmazonPay must be a JSON object")
            return PaymentMethodDetailsPaymentRecordAmazonPay(
                funding =
                    rawObject["funding"]?.let {
                        json
                            .decodeFromJsonElement<PaymentsPrimitivesPaymentRecordsResourcePaymentMethodAmazonPayDetailsResourceFunding>(
                                it,
                            )
                    },
                transactionId =
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentMethodDetailsPaymentRecordAmazonPay,
        ) {
...
public fun paymentMethodDetailsPaymentRecordAmazonPay(
    block: PaymentMethodDetailsPaymentRecordAmazonPay.Builder.() -> Unit,
): PaymentMethodDetailsPaymentRecordAmazonPay = PaymentMethodDetailsPaymentRecordAmazonPay.build(block)
