        ...
        override fun deserialize(decoder: Decoder): DeletedDiscount {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("DeletedDiscount must be a JSON object")
            ...
            return DeletedDiscount(
                ...
                customer =
                    rawObject["customer"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineDeletedDiscountCustomerXb94f9519?>(element)
                        }
                    },
                customerAccount =
                ...
                promotionCode =
                    rawObject["promotion_code"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineDeletedDiscountPromotionCodeX7cdbfc44?>(element)
                        }
                    },
                subscription =
                ...
                subscriptionItem =
                    rawObject["subscription_item"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("DeletedDiscount is missing required property '" + name + "'")
