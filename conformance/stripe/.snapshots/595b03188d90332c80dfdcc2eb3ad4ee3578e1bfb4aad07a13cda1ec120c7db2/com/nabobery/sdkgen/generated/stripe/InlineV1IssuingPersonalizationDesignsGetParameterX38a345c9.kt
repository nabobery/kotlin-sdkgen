...
public class InlineV1IssuingPersonalizationDesignsGetParameterX38a345c9(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1IssuingPersonalizationDesignsGetParameterX38a345c9 =
            InlineV1IssuingPersonalizationDesignsGetParameterX38a345c9(
                isDefault = isDefault,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1IssuingPersonalizationDesignsGetParameterX38a345c9 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1IssuingPersonalizationDesignsGetParameterX38a345c9> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1IssuingPersonalizationDesignsGetParameterX38a345c9 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingPersonalizationDesignsGetParameterX38a345c9,
        ) {
...
public fun inlineV1IssuingPersonalizationDesignsGetParameterX38a345c9(
    block: InlineV1IssuingPersonalizationDesignsGetParameterX38a345c9.Builder.() -> Unit,
): InlineV1IssuingPersonalizationDesignsGetParameterX38a345c9 =
    InlineV1IssuingPersonalizationDesignsGetParameterX38a345c9.build(block)
