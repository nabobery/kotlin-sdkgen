...
internal data class InlineV1SubscriptionSchedulesPostRequestFormPhasesItemDescriptionXc4b6a535Inspection(
    ...
    public val matchesInlineV1SubscriptionSchedulesPostRequestFormPhasesItemDescriptionAnyOf2X917fbfa3: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1SubscriptionSchedulesPostRequestFormPhasesItemDescriptionAnyOf2X917fbfa3,
            ).count {
                it
            }
}
...
public class InlineV1SubscriptionSchedulesPostRequestFormPhasesItemDescriptionXc4b6a535 internal constructor(
    ...
    private val inspection: InlineV1SubscriptionSchedulesPostRequestFormPhasesItemDescriptionXc4b6a535Inspection,
) {
    ...
    public val inlineV1SubscriptionSchedulesPostRequestFormPhasesItemDescriptionAnyOf2X917fbfa3:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1SubscriptionSchedulesPostRequestFormPhasesItemDescriptionAnyOf2X917fbfa3) {
                json
                    .decodeFromJsonElement<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemDescriptionAnyOf2X917fbfa3>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1SubscriptionSchedulesPostRequestFormPhasesItemDescriptionXc4b6a535Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1SubscriptionSchedulesPostRequestFormPhasesItemDescriptionAnyOf2X917fbfa3) {
                    add(
                        InlineV1SubscriptionSchedulesPostRequestFormPhasesItemDescriptionXc4b6a535Branch.InlineV1SubscriptionSchedulesPostRequestFormPhasesItemDescriptionAnyOf2X917fbfa3,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1SubscriptionSchedulesPostRequestFormPhasesItemDescriptionXc4b6a535 {
            val inspection = inspectInlineV1SubscriptionSchedulesPostRequestFormPhasesItemDescriptionXc4b6a535(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1SubscriptionSchedulesPostRequestFormPhasesItemDescriptionXc4b6a535NoMatchException(
                    "InlineV1SubscriptionSchedulesPostRequestFormPhasesItemDescriptionXc4b6a535 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemDescriptionXc4b6a535> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionSchedulesPostRequestFormPhasesItemDescriptionXc4b6a535,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1SubscriptionSchedulesPostRequestFormPhasesItemDescriptionXc4b6a535",
...
private fun inspectInlineV1SubscriptionSchedulesPostRequestFormPhasesItemDescriptionXc4b6a535(
    element: JsonElement,
): InlineV1SubscriptionSchedulesPostRequestFormPhasesItemDescriptionXc4b6a535Inspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1SubscriptionSchedulesPostRequestFormPhasesItemDescriptionAnyOf2X917fbfa3 =
        element
            .isJsonDecodable<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemDescriptionAnyOf2X917fbfa3>()
    return InlineV1SubscriptionSchedulesPostRequestFormPhasesItemDescriptionXc4b6a535Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1SubscriptionSchedulesPostRequestFormPhasesItemDescriptionAnyOf2X917fbfa3) {
                    add(
                        "InlineV1SubscriptionSchedulesPostRequestFormPhasesItemDescriptionAnyOf2X917fbfa3: value does not match InlineV1SubscriptionSchedulesPostRequestFormPhasesItemDescriptionAnyOf2X917fbfa3",
                    )
                }
            },
    )
