...
public class InlineV1TreasuryFinancialAc862PostRequestFormFeaturesOutboundTransfersXccfef52d(
    ...
    public val usDomesticWire: InlineV1TreasuryFinancialAc862PostRequestFormFeaturesUsDomesticWireX67ca64c3? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1TreasuryFinancialAc862PostRequestFormFeaturesOutboundTransfersXccfef52d =
            InlineV1TreasuryFinancialAc862PostRequestFormFeaturesOutboundTransfersXccfef52d(
                ach = ach,
    ...
    public object Serializer : KSerializer<InlineV1TreasuryFinancialAc862PostRequestFormFeaturesOutboundTransfersXccfef52d> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TreasuryFinancialAc862PostRequestFormFeaturesOutboundTransfersXccfef52d must be a JSON object",
                    )
            return InlineV1TreasuryFinancialAc862PostRequestFormFeaturesOutboundTransfersXccfef52d(
                ach =
                    rawObject["ach"]?.let {
                        json.decodeFromJsonElement<InlineV1TreasuryFinancialAc862PostRequestFormFeaturesAchXf8ddf3f8>(
                            it,
                        )
                    },
                usDomesticWire =
                    rawObject["us_domestic_wire"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TreasuryFinancialAc862PostRequestFormFeaturesUsDomesticWireX67ca64c3>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TreasuryFinancialAc862PostRequestFormFeaturesOutboundTransfersXccfef52d,
        ) {
            val jsonEncoder =
...
public fun inlineV1TreasuryFinancialAc862PostRequestFormFeaturesOutboundTransfersXccfef52d(
    block: InlineV1TreasuryFinancialAc862PostRequestFormFeaturesOutboundTransfersXccfef52d.Builder.() -> Unit,
): InlineV1TreasuryFinancialAc862PostRequestFormFeaturesOutboundTransfersXccfef52d =
