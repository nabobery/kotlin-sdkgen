...
@Serializable
public data class BillingCreditGrantView(
...
public class BillingCreditGrant(
    ...
    public object Serializer : KSerializer<BillingCreditGrant> {
        ...
        override fun deserialize(decoder: Decoder): BillingCreditGrant {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("BillingCreditGrant must be a JSON object")
            val amount = json.decodeRequired<BillingCreditGrantsResourceAmount>(rawObject, "amount")
            val applicabilityConfig =
                json.decodeRequired<BillingCreditGrantsResourceApplicabilityConfig>(
                    rawObject,
            ...
            return BillingCreditGrant(
                ...
                priority =
                    rawObject["priority"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                testClock =
                    rawObject["test_clock"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineBillingCreditGrantTestClockXd98a9055?>(element)
                        }
                    },
                voidedAt =
...
public fun billingCreditGrant(block: BillingCreditGrant.Builder.() -> Unit): BillingCreditGrant =
    BillingCreditGrant.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("BillingCreditGrant is missing required property '" + name + "'")
