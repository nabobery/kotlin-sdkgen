...
public class CheckoutAcssDebitMandateOptions(
     ...
     * mode.
     */
    public val defaultFor: List<InlineCheckoutAcssDebitMandateOptionsDefaultForItemX933d1c8b>? = null,
    /**
    ...
    public class Builder {
        ...
        public fun build(): CheckoutAcssDebitMandateOptions =
    ...
    public object Serializer : KSerializer<CheckoutAcssDebitMandateOptions> {
        ...
        override fun deserialize(decoder: Decoder): CheckoutAcssDebitMandateOptions {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("CheckoutAcssDebitMandateOptions must be a JSON object")
            return CheckoutAcssDebitMandateOptions(
                ...
                defaultFor =
                    rawObject["default_for"]?.let {
                        json.decodeFromJsonElement<List<InlineCheckoutAcssDebitMandateOptionsDefaultForItemX933d1c8b>>(
                            it,
                        )
                    },
                intervalDescription =
                ...
                paymentSchedule =
                    rawObject["payment_schedule"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineCheckoutAcssDebitMandateOptionsPaymentScheduleXfdc125d4?>(
                                element,
                            )
                        }
                    },
                transactionType =
                    rawObject["transaction_type"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineCheckoutAcssDebitMandateOptionsTransactionTypeX41610eba?>(
                                element,
                            )
                        }
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: CheckoutAcssDebitMandateOptions,
        ) {
...
public fun checkoutAcssDebitMandateOptions(
    block: CheckoutAcssDebitMandateOptions.Builder.() -> Unit,
): CheckoutAcssDebitMandateOptions = CheckoutAcssDebitMandateOptions.build(block)
