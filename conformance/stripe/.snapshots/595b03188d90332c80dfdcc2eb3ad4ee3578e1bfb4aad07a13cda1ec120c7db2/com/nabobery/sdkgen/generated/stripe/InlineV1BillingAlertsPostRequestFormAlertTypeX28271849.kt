...
public sealed class InlineV1BillingAlertsPostRequestFormAlertTypeX28271849 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1BillingAlertsPostRequestFormAlertTypeX28271849 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1BillingAlertsPostRequestFormAlertTypeX28271849> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1BillingAlertsPostRequestFormAlertTypeX28271849",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1BillingAlertsPostRequestFormAlertTypeX28271849 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1BillingAlertsPostRequestFormAlertTypeX28271849,
        ) {
