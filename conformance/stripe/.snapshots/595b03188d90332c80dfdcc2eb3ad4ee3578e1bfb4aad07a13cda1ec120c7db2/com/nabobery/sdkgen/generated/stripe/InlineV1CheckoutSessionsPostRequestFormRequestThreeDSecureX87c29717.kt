...
public sealed class InlineV1CheckoutSessionsPostRequestFormRequestThreeDSecureX87c29717 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1CheckoutSessionsPostRequestFormRequestThreeDSecureX87c29717 =
            when (value) {
                Any.value -> Any
    ...
    public object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormRequestThreeDSecureX87c29717> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1CheckoutSessionsPostRequestFormRequestThreeDSecureX87c29717",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1CheckoutSessionsPostRequestFormRequestThreeDSecureX87c29717 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsPostRequestFormRequestThreeDSecureX87c29717,
        ) {
