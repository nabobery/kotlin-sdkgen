...
public class IssuingNetworkTokenDevice(
    ...
    public class Builder {
        ...
        public fun build(): IssuingNetworkTokenDevice =
    ...
    public object Serializer : KSerializer<IssuingNetworkTokenDevice> {
        ...
        override fun deserialize(decoder: Decoder): IssuingNetworkTokenDevice {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("IssuingNetworkTokenDevice must be a JSON object")
            return IssuingNetworkTokenDevice(
                ...
                type =
                    rawObject["type"]?.let {
                        json
                            .decodeFromJsonElement<InlineIssuingNetworkTokenDeviceTypeX0d97c801>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: IssuingNetworkTokenDevice,
        ) {
...
public fun issuingNetworkTokenDevice(block: IssuingNetworkTokenDevice.Builder.() -> Unit): IssuingNetworkTokenDevice =
    IssuingNetworkTokenDevice.build(block)
