...
public class InlineV1SourcesPostRequestFormMandateAmountXabd4847d internal constructor(
    ...
    public val inlineV1SourcesPostRequestFormMandateAmountAnyOf2X03b01257:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1SourcesPostRequestFormMandateAmountAnyOf2X03b01257) {
                json
                    .decodeFromJsonElement<InlineV1SourcesPostRequestFormMandateAmountAnyOf2X03b01257>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1SourcesPostRequestFormMandateAmountXabd4847dBranch>
        get() =
            buildSet {
                ...
                if (inspection.matchesInlineV1SourcesPostRequestFormMandateAmountAnyOf2X03b01257) {
                    add(
                        InlineV1SourcesPostRequestFormMandateAmountXabd4847dBranch.InlineV1SourcesPostRequestFormMandateAmountAnyOf2X03b01257,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1SourcesPostRequestFormMandateAmountXabd4847d {
            val inspection = inspectInlineV1SourcesPostRequestFormMandateAmountXabd4847d(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1SourcesPostRequestFormMandateAmountXabd4847dNoMatchException(
                    "InlineV1SourcesPostRequestFormMandateAmountXabd4847d matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1SourcesPostRequestFormMandateAmountXabd4847d> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SourcesPostRequestFormMandateAmountXabd4847d,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1SourcesPostRequestFormMandateAmountXabd4847d",
...
private fun inspectInlineV1SourcesPostRequestFormMandateAmountXabd4847d(
    element: JsonElement,
): InlineV1SourcesPostRequestFormMandateAmountXabd4847dInspection {
    val matchesBranch1 = element.isJsonDecodable<Int>()
    val matchesInlineV1SourcesPostRequestFormMandateAmountAnyOf2X03b01257 =
        element
            .isJsonDecodable<InlineV1SourcesPostRequestFormMandateAmountAnyOf2X03b01257>()
    return InlineV1SourcesPostRequestFormMandateAmountXabd4847dInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1SourcesPostRequestFormMandateAmountAnyOf2X03b01257) {
                    add(
                        "InlineV1SourcesPostRequestFormMandateAmountAnyOf2X03b01257: value does not match InlineV1SourcesPostRequestFormMandateAmountAnyOf2X03b01257",
                    )
                }
            },
    )
