...
internal data class InlineV1IssuingDisputesPostRequestFormEvidenceCancellationPolicyPrf2bfX7204f72dInspection(
    ...
    public val matchesInlineV1IssuingDisputesPostRequestFormEvidenceCanceledAnyOf1AnyOf2X0a09598a: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1IssuingDisputesPostRequestFormEvidenceCanceledAnyOf1AnyOf2X0a09598a,
            ).count {
                it
            }
}
...
public class InlineV1IssuingDisputesPostRequestFormEvidenceCancellationPolicyPrf2bfX7204f72d internal constructor(
    ...
    private val inspection: InlineV1IssuingDisputesPostRequestFormEvidenceCancellationPolicyPrf2bfX7204f72dInspection,
) {
    ...
    public val inlineV1IssuingDisputesPostRequestFormEvidenceCanceledAnyOf1AnyOf2X0a09598a:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1IssuingDisputesPostRequestFormEvidenceCanceledAnyOf1AnyOf2X0a09598a) {
                json
                    .decodeFromJsonElement<InlineV1IssuingDisputesPostRequestFormEvidenceCanceledAnyOf1AnyOf2X0a09598a>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1IssuingDisputesPostRequestFormEvidenceCancellationPolicyPrf2bfX7204f72dBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1IssuingDisputesPostRequestFormEvidenceCanceledAnyOf1AnyOf2X0a09598a) {
                    add(
                        InlineV1IssuingDisputesPostRequestFormEvidenceCancellationPolicyPrf2bfX7204f72dBranch.InlineV1IssuingDisputesPostRequestFormEvidenceCanceledAnyOf1AnyOf2X0a09598a,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1IssuingDisputesPostRequestFormEvidenceCancellationPolicyPrf2bfX7204f72d {
            val inspection = inspectInlineV1IssuingDisputesPostRequestFormEvidenceCancellationPolicyPrf2bfX7204f72d(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1IssuingDisputesPostRequestFormEvidenceCancellationPolicyPrf2bfX7204f72dNoMatchException(
                    "InlineV1IssuingDisputesPostRequestFormEvidenceCancellationPolicyPrf2bfX7204f72d matched 0 branches: " +
                        inspection.failures.joinToString("; "),
                )
            }
            return InlineV1IssuingDisputesPostRequestFormEvidenceCancellationPolicyPrf2bfX7204f72d(
                raw,
                json,
                inspection,
            )
    ...
    public object Serializer : KSerializer<InlineV1IssuingDisputesPostRequestFormEvidenceCancellationPolicyPrf2bfX7204f72d> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingDisputesPostRequestFormEvidenceCancellationPolicyPrf2bfX7204f72d,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1IssuingDisputesPostRequestFormEvidenceCancellationPolicyPrf2bfX7204f72d",
...
private fun inspectInlineV1IssuingDisputesPostRequestFormEvidenceCancellationPolicyPrf2bfX7204f72d(
    element: JsonElement,
    ...
    val matchesInlineV1IssuingDisputesPostRequestFormEvidenceCanceledAnyOf1AnyOf2X0a09598a =
        element
            .isJsonDecodable<InlineV1IssuingDisputesPostRequestFormEvidenceCanceledAnyOf1AnyOf2X0a09598a>()
    return InlineV1IssuingDisputesPostRequestFormEvidenceCancellationPolicyPrf2bfX7204f72dInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1IssuingDisputesPostRequestFormEvidenceCanceledAnyOf1AnyOf2X0a09598a) {
                    add(
                        "InlineV1IssuingDisputesPostRequestFormEvidenceCanceledAnyOf1AnyOf2X0a09598a: value does not match InlineV1IssuingDisputesPostRequestFormEvidenceCanceledAnyOf1AnyOf2X0a09598a",
                    )
                }
            },
    )
