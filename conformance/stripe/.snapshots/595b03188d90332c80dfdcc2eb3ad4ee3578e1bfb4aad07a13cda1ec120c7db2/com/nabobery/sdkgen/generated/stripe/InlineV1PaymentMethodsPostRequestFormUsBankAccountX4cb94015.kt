...
public class InlineV1PaymentMethodsPostRequestFormUsBankAccountX4cb94015(
    public val accountHolderType: InlineV1PaymentMethodsPostRequestFormUsBankAccountAccountHolderTypeXbfa3483d? = null,
    public val accountType: InlineV1PaymentMethodsPostRequestFormUsBankAccountAccountTypeX07faa976? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1PaymentMethodsPostRequestFormUsBankAccountX4cb94015 =
            InlineV1PaymentMethodsPostRequestFormUsBankAccountX4cb94015(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PaymentMethodsPostRequestFormUsBankAccountX4cb94015 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentMethodsPostRequestFormUsBankAccountX4cb94015> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentMethodsPostRequestFormUsBankAccountX4cb94015 must be a JSON object",
                    )
            return InlineV1PaymentMethodsPostRequestFormUsBankAccountX4cb94015(
                accountHolderType =
                    rawObject["account_holder_type"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentMethodsPostRequestFormUsBankAccountAccountHolderTypeXbfa3483d>(
                                it,
                            )
                    },
                accountType =
                    rawObject["account_type"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentMethodsPostRequestFormUsBankAccountAccountTypeX07faa976>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentMethodsPostRequestFormUsBankAccountX4cb94015,
        ) {
...
public fun inlineV1PaymentMethodsPostRequestFormUsBankAccountX4cb94015(
    block: InlineV1PaymentMethodsPostRequestFormUsBankAccountX4cb94015.Builder.() -> Unit,
): InlineV1PaymentMethodsPostRequestFormUsBankAccountX4cb94015 =
    InlineV1PaymentMethodsPostRequestFormUsBankAccountX4cb94015.build(block)
