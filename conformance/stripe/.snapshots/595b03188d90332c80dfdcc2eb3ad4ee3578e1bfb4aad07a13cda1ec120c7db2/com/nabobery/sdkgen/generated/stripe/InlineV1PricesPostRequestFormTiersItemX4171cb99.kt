...
public class InlineV1PricesPostRequestFormTiersItemX4171cb99(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PricesPostRequestFormTiersItemX4171cb99 =
    ...
    public object Serializer : KSerializer<InlineV1PricesPostRequestFormTiersItemX4171cb99> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PricesPostRequestFormTiersItemX4171cb99 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PricesPostRequestFormTiersItemX4171cb99,
        ) {
...
public fun inlineV1PricesPostRequestFormTiersItemX4171cb99(
    block: InlineV1PricesPostRequestFormTiersItemX4171cb99.Builder.() -> Unit,
): InlineV1PricesPostRequestFormTiersItemX4171cb99 = InlineV1PricesPostRequestFormTiersItemX4171cb99.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PricesPostRequestFormTiersItemX4171cb99 is missing required property '" + name + "'",
            )
