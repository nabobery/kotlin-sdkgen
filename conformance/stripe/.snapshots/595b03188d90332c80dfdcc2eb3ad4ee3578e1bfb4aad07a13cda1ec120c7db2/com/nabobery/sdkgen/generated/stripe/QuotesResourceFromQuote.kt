        ...
        override fun deserialize(decoder: Decoder): QuotesResourceFromQuote {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("QuotesResourceFromQuote must be a JSON object")
...
public fun quotesResourceFromQuote(block: QuotesResourceFromQuote.Builder.() -> Unit): QuotesResourceFromQuote =
    QuotesResourceFromQuote.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("QuotesResourceFromQuote is missing required property '" + name + "'")
