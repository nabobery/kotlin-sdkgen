...
public class InlineV1InvoicesAddLinesPostRequestFormLinesItemX4410ce25(
    ...
    public val taxAmounts: InlineV1InvoicesAddLinesPostRequestFormLinesItemTaxAmountsX8ea7adff? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1InvoicesAddLinesPostRequestFormLinesItemX4410ce25 =
            InlineV1InvoicesAddLinesPostRequestFormLinesItemX4410ce25(
                amount = amount,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1InvoicesAddLinesPostRequestFormLinesItemX4410ce25 =
    ...
    public object Serializer : KSerializer<InlineV1InvoicesAddLinesPostRequestFormLinesItemX4410ce25> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1InvoicesAddLinesPostRequestFormLinesItemX4410ce25 must be a JSON object",
                    )
            return InlineV1InvoicesAddLinesPostRequestFormLinesItemX4410ce25(
                ...
                discounts =
                    rawObject["discounts"]?.let {
                        json.decodeFromJsonElement<InlineV1InvoicesAddLinesPostRequestFormLinesItemDiscountsX10cfc38f>(
                            it,
                        )
                    },
                ...
                metadata =
                    rawObject["metadata"]?.let {
                        json.decodeFromJsonElement<InlineV1InvoicesAddLinesPostRequestFormLinesItemMetadataX5b202459>(
                            it,
                        )
                    },
                period =
                    rawObject["period"]?.let {
                        json.decodeFromJsonElement<InlineV1InvoicesAddLinesPostRequestFormLinesItemPeriodXe0553e9c>(it)
                    },
                priceData =
                    rawObject["price_data"]?.let {
                        json.decodeFromJsonElement<InlineV1InvoicesAddLinesPostRequestFormLinesItemPriceDataX27a69332>(
                            it,
                        )
                    },
                pricing =
                    rawObject["pricing"]?.let {
                        json.decodeFromJsonElement<InlineV1InvoicesAddLinesPostRequestFormLinesItemPricingX615d9355>(it)
                    },
                ...
                taxAmounts =
                    rawObject["tax_amounts"]?.let {
                        json.decodeFromJsonElement<InlineV1InvoicesAddLinesPostRequestFormLinesItemTaxAmountsX8ea7adff>(
                            it,
                        )
                    },
                taxRates =
                    rawObject["tax_rates"]?.let {
                        json.decodeFromJsonElement<InlineV1InvoicesAddLinesPostRequestFormLinesItemTaxRatesX936af1c7>(
                            it,
                        )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesAddLinesPostRequestFormLinesItemX4410ce25,
        ) {
...
public fun inlineV1InvoicesAddLinesPostRequestFormLinesItemX4410ce25(
    block: InlineV1InvoicesAddLinesPostRequestFormLinesItemX4410ce25.Builder.() -> Unit,
): InlineV1InvoicesAddLinesPostRequestFormLinesItemX4410ce25 =
    InlineV1InvoicesAddLinesPostRequestFormLinesItemX4410ce25.build(block)
