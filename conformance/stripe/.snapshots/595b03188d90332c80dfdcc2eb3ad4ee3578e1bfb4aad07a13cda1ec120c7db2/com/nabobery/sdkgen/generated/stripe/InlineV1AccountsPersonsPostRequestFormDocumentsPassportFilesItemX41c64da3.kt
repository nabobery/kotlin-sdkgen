...
internal data class InlineV1AccountsPersonsPostRequestFormDocumentsPassportFilesItemX41c64da3Inspection(
    ...
    public val matchesInlineV1AccountsPersonsPostRequestFormDocumentsPassportFilesItemAnyOf2X7ed74d80: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1AccountsPersonsPostRequestFormDocumentsPassportFilesItemAnyOf2X7ed74d80,
            ).count {
                it
            }
}
...
public class InlineV1AccountsPersonsPostRequestFormDocumentsPassportFilesItemX41c64da3 internal constructor(
    ...
    private val inspection: InlineV1AccountsPersonsPostRequestFormDocumentsPassportFilesItemX41c64da3Inspection,
) {
    ...
    public val inlineV1AccountsPersonsPostRequestFormDocumentsPassportFilesItemAnyOf2X7ed74d80:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1AccountsPersonsPostRequestFormDocumentsPassportFilesItemAnyOf2X7ed74d80) {
                json
                    .decodeFromJsonElement<InlineV1AccountsPersonsPostRequestFormDocumentsPassportFilesItemAnyOf2X7ed74d80>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1AccountsPersonsPostRequestFormDocumentsPassportFilesItemX41c64da3Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1AccountsPersonsPostRequestFormDocumentsPassportFilesItemAnyOf2X7ed74d80) {
                    add(
                        InlineV1AccountsPersonsPostRequestFormDocumentsPassportFilesItemX41c64da3Branch.InlineV1AccountsPersonsPostRequestFormDocumentsPassportFilesItemAnyOf2X7ed74d80,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1AccountsPersonsPostRequestFormDocumentsPassportFilesItemX41c64da3 {
            val inspection = inspectInlineV1AccountsPersonsPostRequestFormDocumentsPassportFilesItemX41c64da3(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1AccountsPersonsPostRequestFormDocumentsPassportFilesItemX41c64da3NoMatchException(
                    "InlineV1AccountsPersonsPostRequestFormDocumentsPassportFilesItemX41c64da3 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1AccountsPersonsPostRequestFormDocumentsPassportFilesItemX41c64da3> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPersonsPostRequestFormDocumentsPassportFilesItemX41c64da3,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1AccountsPersonsPostRequestFormDocumentsPassportFilesItemX41c64da3",
...
private fun inspectInlineV1AccountsPersonsPostRequestFormDocumentsPassportFilesItemX41c64da3(
    element: JsonElement,
): InlineV1AccountsPersonsPostRequestFormDocumentsPassportFilesItemX41c64da3Inspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1AccountsPersonsPostRequestFormDocumentsPassportFilesItemAnyOf2X7ed74d80 =
        element
            .isJsonDecodable<InlineV1AccountsPersonsPostRequestFormDocumentsPassportFilesItemAnyOf2X7ed74d80>()
    return InlineV1AccountsPersonsPostRequestFormDocumentsPassportFilesItemX41c64da3Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1AccountsPersonsPostRequestFormDocumentsPassportFilesItemAnyOf2X7ed74d80) {
                    add(
                        "InlineV1AccountsPersonsPostRequestFormDocumentsPassportFilesItemAnyOf2X7ed74d80: value does not match InlineV1AccountsPersonsPostRequestFormDocumentsPassportFilesItemAnyOf2X7ed74d80",
                    )
                }
            },
    )
