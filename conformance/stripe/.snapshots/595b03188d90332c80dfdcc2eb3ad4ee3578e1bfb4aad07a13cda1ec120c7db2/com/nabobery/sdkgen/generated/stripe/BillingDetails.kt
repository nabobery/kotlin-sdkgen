...
public class BillingDetails(
    ...
    public class Builder {
        ...
        public fun build(): BillingDetails =
            BillingDetails(
                address = address,
                email = email,
                name = name,
    ...
    public object Serializer : KSerializer<BillingDetails> {
        ...
        override fun deserialize(decoder: Decoder): BillingDetails {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("BillingDetails must be a JSON object")
                ...
                address =
                    rawObject["address"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineBillingDetailsAddressX0922cd53?>(element)
                        }
                    },
                email =
