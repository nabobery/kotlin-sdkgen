...
public class InvoiceRenderingTemplate(
    ...
    public object Serializer : KSerializer<InvoiceRenderingTemplate> {
        ...
        override fun deserialize(decoder: Decoder): InvoiceRenderingTemplate {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("InvoiceRenderingTemplate must be a JSON object")
            val created = json.decodeRequired<Int>(rawObject, "created")
            val id = json.decodeRequired<String>(rawObject, "id")
            val livemode = json.decodeRequired<Boolean>(rawObject, "livemode")
            val objectValue =
                json.decodeRequired<InlineInvoiceRenderingTemplateObjectValueXd53d954d>(
                    rawObject,
                    "object",
                )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InvoiceRenderingTemplate,
        ) {
...
public fun invoiceRenderingTemplate(block: InvoiceRenderingTemplate.Builder.() -> Unit): InvoiceRenderingTemplate =
    InvoiceRenderingTemplate.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException("InvoiceRenderingTemplate is missing required property '" + name + "'")
