...
public class InlineV1InvoicesPostRequestFormShippingCostAnyOf1DeliveryEstimateX300ea68a(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1InvoicesPostRequestFormShippingCostAnyOf1DeliveryEstimateX300ea68a =
            InlineV1InvoicesPostRequestFormShippingCostAnyOf1DeliveryEstimateX300ea68a(
                maximum = maximum,
                minimum = minimum,
            )
    }
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1InvoicesPostRequestFormShippingCostAnyOf1DeliveryEstimateX300ea68a = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1InvoicesPostRequestFormShippingCostAnyOf1DeliveryEstimateX300ea68a> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1InvoicesPostRequestFormShippingCostAnyOf1DeliveryEstimateX300ea68a must be a JSON object",
                    )
            return InlineV1InvoicesPostRequestFormShippingCostAnyOf1DeliveryEstimateX300ea68a(
                maximum =
                    rawObject["maximum"]?.let {
                        json.decodeFromJsonElement<InlineV1InvoicesPostRequestFormShippingCostAnyOf1MaximumXa136796e>(
                            it,
                        )
                    },
                minimum =
                    rawObject["minimum"]?.let {
                        json.decodeFromJsonElement<InlineV1InvoicesPostRequestFormShippingCostAnyOf1MinimumX30043f42>(
                            it,
                        )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesPostRequestFormShippingCostAnyOf1DeliveryEstimateX300ea68a,
        ) {
            val jsonEncoder =
...
public fun inlineV1InvoicesPostRequestFormShippingCostAnyOf1DeliveryEstimateX300ea68a(
    block: InlineV1InvoicesPostRequestFormShippingCostAnyOf1DeliveryEstimateX300ea68a.Builder.() -> Unit,
): InlineV1InvoicesPostRequestFormShippingCostAnyOf1DeliveryEstimateX300ea68a =
    InlineV1InvoicesPostRequestFormShippingCostAnyOf1DeliveryEstimateX300ea68a.build(block)
