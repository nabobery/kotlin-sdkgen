...
public class FundingInstructionsBankTransferSpeiRecord(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): FundingInstructionsBankTransferSpeiRecord =
    ...
    public object Serializer : KSerializer<FundingInstructionsBankTransferSpeiRecord> {
        ...
        override fun deserialize(decoder: Decoder): FundingInstructionsBankTransferSpeiRecord {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("FundingInstructionsBankTransferSpeiRecord must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: FundingInstructionsBankTransferSpeiRecord,
        ) {
...
public fun fundingInstructionsBankTransferSpeiRecord(
    block: FundingInstructionsBankTransferSpeiRecord.Builder.() -> Unit,
): FundingInstructionsBankTransferSpeiRecord = FundingInstructionsBankTransferSpeiRecord.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "FundingInstructionsBankTransferSpeiRecord is missing required property '" + name + "'",
            )
