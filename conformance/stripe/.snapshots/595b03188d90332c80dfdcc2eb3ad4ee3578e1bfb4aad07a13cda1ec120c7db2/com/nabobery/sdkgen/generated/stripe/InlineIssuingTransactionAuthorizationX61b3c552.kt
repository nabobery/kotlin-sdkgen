...
public class InlineIssuingTransactionAuthorizationX61b3c552 internal constructor(
        ...
        get() =
            buildSet {
                ...
                if (inspection.matchesIssuingAuthorization) {
                    add(
                        InlineIssuingTransactionAuthorizationX61b3c552Branch.IssuingAuthorization,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineIssuingTransactionAuthorizationX61b3c552 {
            val inspection = inspectInlineIssuingTransactionAuthorizationX61b3c552(raw)
            if (inspection.matchCount == 0) {
                throw InlineIssuingTransactionAuthorizationX61b3c552NoMatchException(
                    "InlineIssuingTransactionAuthorizationX61b3c552 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineIssuingTransactionAuthorizationX61b3c552> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineIssuingTransactionAuthorizationX61b3c552,
        ) {
...
private fun inspectInlineIssuingTransactionAuthorizationX61b3c552(
    element: JsonElement,
): InlineIssuingTransactionAuthorizationX61b3c552Inspection {
