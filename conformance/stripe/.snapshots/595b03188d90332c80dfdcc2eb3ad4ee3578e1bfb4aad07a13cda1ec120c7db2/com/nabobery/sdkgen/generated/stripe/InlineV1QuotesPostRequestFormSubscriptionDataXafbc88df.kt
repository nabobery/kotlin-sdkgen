...
public class InlineV1QuotesPostRequestFormSubscriptionDataXafbc88df(
    ...
    public val effectiveDate: InlineV1QuotesPostRequestFormSubscriptionDataEffectiveDateX2c96b2d7? = null,
    public val metadata: Map<String, String>? = null,
    public val trialPeriodDays: InlineV1QuotesPostRequestFormSubscriptionDataTrialPeriodDaysXc072a77f? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1QuotesPostRequestFormSubscriptionDataXafbc88df =
            InlineV1QuotesPostRequestFormSubscriptionDataXafbc88df(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1QuotesPostRequestFormSubscriptionDataXafbc88df =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1QuotesPostRequestFormSubscriptionDataXafbc88df> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1QuotesPostRequestFormSubscriptionDataXafbc88df must be a JSON object",
                    )
            return InlineV1QuotesPostRequestFormSubscriptionDataXafbc88df(
                description =
                    rawObject["description"]?.let {
                        json.decodeFromJsonElement<InlineV1QuotesPostRequestFormSubscriptionDataDescriptionXf84cabf2>(
                            it,
                        )
                    },
                effectiveDate =
                    rawObject["effective_date"]?.let {
                        json.decodeFromJsonElement<InlineV1QuotesPostRequestFormSubscriptionDataEffectiveDateX2c96b2d7>(
                            it,
                        )
                    },
                ...
                trialPeriodDays =
                    rawObject["trial_period_days"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1QuotesPostRequestFormSubscriptionDataTrialPeriodDaysXc072a77f>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1QuotesPostRequestFormSubscriptionDataXafbc88df,
        ) {
...
public fun inlineV1QuotesPostRequestFormSubscriptionDataXafbc88df(
    block: InlineV1QuotesPostRequestFormSubscriptionDataXafbc88df.Builder.() -> Unit,
): InlineV1QuotesPostRequestFormSubscriptionDataXafbc88df =
    InlineV1QuotesPostRequestFormSubscriptionDataXafbc88df.build(block)
