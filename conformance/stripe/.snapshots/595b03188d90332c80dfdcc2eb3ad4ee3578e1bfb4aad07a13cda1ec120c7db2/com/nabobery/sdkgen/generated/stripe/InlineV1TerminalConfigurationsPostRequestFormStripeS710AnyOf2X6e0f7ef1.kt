...
public sealed class InlineV1TerminalConfigurationsPostRequestFormStripeS710AnyOf2X6e0f7ef1 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1TerminalConfigurationsPostRequestFormStripeS710AnyOf2X6e0f7ef1 =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1TerminalConfigurationsPostRequestFormStripeS710AnyOf2X6e0f7ef1> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1TerminalConfigurationsPostRequestFormStripeS710AnyOf2X6e0f7ef1",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1TerminalConfigurationsPostRequestFormStripeS710AnyOf2X6e0f7ef1 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TerminalConfigurationsPostRequestFormStripeS710AnyOf2X6e0f7ef1,
        ) {
