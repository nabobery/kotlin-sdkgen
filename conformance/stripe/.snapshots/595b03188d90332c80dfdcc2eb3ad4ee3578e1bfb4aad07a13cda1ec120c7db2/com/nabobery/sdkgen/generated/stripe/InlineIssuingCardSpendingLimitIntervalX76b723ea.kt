...
public sealed class InlineIssuingCardSpendingLimitIntervalX76b723ea {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineIssuingCardSpendingLimitIntervalX76b723ea =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineIssuingCardSpendingLimitIntervalX76b723ea> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineIssuingCardSpendingLimitIntervalX76b723ea",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineIssuingCardSpendingLimitIntervalX76b723ea =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineIssuingCardSpendingLimitIntervalX76b723ea,
        ) {
