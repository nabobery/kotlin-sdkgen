...
public class InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsCardXf7411bae(
    public val mandateOptions: InlineV1SetupIntentsConfirmPostRequestFormMandateOptionsX5d2b2a00? = null,
    public val network: InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsNetworkX3a46c255? = null,
    public val requestThreeDSecure: InlineV1SetupIntentsConfirmPostRequestFormRequestThreeDSecureX8705b60a? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsCardXf7411bae =
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsCardXf7411bae = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsCardXf7411bae> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsCardXf7411bae must be a JSON object",
                    )
            return InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsCardXf7411bae(
                mandateOptions =
                    rawObject["mandate_options"]?.let {
                        json.decodeFromJsonElement<InlineV1SetupIntentsConfirmPostRequestFormMandateOptionsX5d2b2a00>(
                            it,
                        )
                    },
                network =
                    rawObject["network"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsNetworkX3a46c255>(
                                it,
                            )
                    },
                requestThreeDSecure =
                    rawObject["request_three_d_secure"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SetupIntentsConfirmPostRequestFormRequestThreeDSecureX8705b60a>(
                                it,
                            )
                    },
                threeDSecure =
                    rawObject["three_d_secure"]?.let {
                        json.decodeFromJsonElement<InlineV1SetupIntentsConfirmPostRequestFormThreeDSecureXc3861f7a>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsCardXf7411bae,
        ) {
            val jsonEncoder =
...
public fun inlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsCardXf7411bae(
    block: InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsCardXf7411bae.Builder.() -> Unit,
): InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsCardXf7411bae =
    InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsCardXf7411bae.build(block)
