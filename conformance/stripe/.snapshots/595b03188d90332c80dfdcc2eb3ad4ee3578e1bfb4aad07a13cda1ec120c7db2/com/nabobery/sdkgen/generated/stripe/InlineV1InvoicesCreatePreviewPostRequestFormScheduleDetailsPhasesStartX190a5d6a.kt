...
public class InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesStartX190a5d6a(
    ...
    public object Serializer : KSerializer<InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesStartX190a5d6a> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesStartX190a5d6a must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesTypeX2b9c39cc>(
                    rawObject,
                    "type",
                )
            return InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesStartX190a5d6a(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesStartX190a5d6a,
        ) {
            val jsonEncoder =
...
public fun inlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesStartX190a5d6a(
    block: InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesStartX190a5d6a.Builder.() -> Unit,
): InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesStartX190a5d6a =
    InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesStartX190a5d6a.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesStartX190a5d6a is missing required property '" +
                    name +
                    "'",
            )
