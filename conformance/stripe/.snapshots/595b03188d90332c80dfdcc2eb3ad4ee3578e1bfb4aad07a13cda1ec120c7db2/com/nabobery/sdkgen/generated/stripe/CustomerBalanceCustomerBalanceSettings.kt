...
public class CustomerBalanceCustomerBalanceSettings(
     ...
     */
    public val reconciliationMode: InlineCustomerBalanceCustomerBalanceSettingsReconciliationModeXdf2054c4,
    /**
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): CustomerBalanceCustomerBalanceSettings =
    ...
    public object Serializer : KSerializer<CustomerBalanceCustomerBalanceSettings> {
        ...
        override fun deserialize(decoder: Decoder): CustomerBalanceCustomerBalanceSettings {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("CustomerBalanceCustomerBalanceSettings must be a JSON object")
            val reconciliationMode =
                json
                    .decodeRequired<InlineCustomerBalanceCustomerBalanceSettingsReconciliationModeXdf2054c4>(
                        rawObject,
                        "reconciliation_mode",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: CustomerBalanceCustomerBalanceSettings,
        ) {
...
public fun customerBalanceCustomerBalanceSettings(
    block: CustomerBalanceCustomerBalanceSettings.Builder.() -> Unit,
): CustomerBalanceCustomerBalanceSettings = CustomerBalanceCustomerBalanceSettings.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "CustomerBalanceCustomerBalanceSettings is missing required property '" + name + "'",
            )
