...
public class InlineFileLinkFileX6b7dc052 internal constructor(
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineFileLinkFileX6b7dc052 {
            val inspection = inspectInlineFileLinkFileX6b7dc052(raw)
            if (inspection.matchCount == 0) {
                throw InlineFileLinkFileX6b7dc052NoMatchException(
                    "InlineFileLinkFileX6b7dc052 matched 0 branches: " + inspection.failures.joinToString("; "),
                )
            }
    ...
    public object Serializer : KSerializer<InlineFileLinkFileX6b7dc052> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineFileLinkFileX6b7dc052,
        ) {
