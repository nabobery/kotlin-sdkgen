...
public class InlineV1InvoiceitemsPostRequestFormX1d0b460f(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1InvoiceitemsPostRequestFormX1d0b460f =
            InlineV1InvoiceitemsPostRequestFormX1d0b460f(
                amount = amount,
                currency = currency,
                customer = customer,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1InvoiceitemsPostRequestFormX1d0b460f =
    ...
    public object Serializer : KSerializer<InlineV1InvoiceitemsPostRequestFormX1d0b460f> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1InvoiceitemsPostRequestFormX1d0b460f must be a JSON object",
                    )
            return InlineV1InvoiceitemsPostRequestFormX1d0b460f(
                ...
                discounts =
                    rawObject["discounts"]?.let {
                        json.decodeFromJsonElement<InlineV1InvoiceitemsPostRequestFormDiscountsX8fe1ac66>(it)
                    },
                expand = rawObject["expand"]?.let { json.decodeFromJsonElement<List<String>>(it) },
                invoice = rawObject["invoice"]?.let { json.decodeFromJsonElement<String>(it) },
                metadata =
                    rawObject["metadata"]?.let {
                        json.decodeFromJsonElement<InlineV1InvoiceitemsPostRequestFormMetadataX00b5d18f>(it)
                    },
                period =
                    rawObject["period"]?.let {
                        json.decodeFromJsonElement<InlineV1InvoiceitemsPostRequestFormPeriodX750c3864>(it)
                    },
                priceData =
                    rawObject["price_data"]?.let {
                        json.decodeFromJsonElement<InlineV1InvoiceitemsPostRequestFormPriceDataX837b5eed>(it)
                    },
                pricing =
                    rawObject["pricing"]?.let {
                        json.decodeFromJsonElement<InlineV1InvoiceitemsPostRequestFormPricingXb5ef51f2>(it)
                    },
                ...
                taxBehavior =
                    rawObject["tax_behavior"]?.let {
                        json.decodeFromJsonElement<InlineV1InvoiceitemsPostRequestFormTaxBehaviorX161ea3df>(it)
                    },
                taxCode =
                    rawObject["tax_code"]?.let {
                        json.decodeFromJsonElement<InlineV1InvoiceitemsPostRequestFormTaxCodeX2112798c>(it)
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoiceitemsPostRequestFormX1d0b460f,
        ) {
...
public fun inlineV1InvoiceitemsPostRequestFormX1d0b460f(
    block: InlineV1InvoiceitemsPostRequestFormX1d0b460f.Builder.() -> Unit,
): InlineV1InvoiceitemsPostRequestFormX1d0b460f = InlineV1InvoiceitemsPostRequestFormX1d0b460f.build(block)
