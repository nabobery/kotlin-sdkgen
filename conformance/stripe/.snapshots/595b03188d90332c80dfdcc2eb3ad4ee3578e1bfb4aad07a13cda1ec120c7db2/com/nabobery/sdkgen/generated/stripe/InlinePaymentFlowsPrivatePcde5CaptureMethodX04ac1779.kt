...
public sealed class InlinePaymentFlowsPrivatePcde5CaptureMethodX04ac1779 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentFlowsPrivatePcde5CaptureMethodX04ac1779 =
            when (value) {
                Manual.value -> Manual
    ...
    public object Serializer : KSerializer<InlinePaymentFlowsPrivatePcde5CaptureMethodX04ac1779> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentFlowsPrivatePcde5CaptureMethodX04ac1779",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePaymentFlowsPrivatePcde5CaptureMethodX04ac1779 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentFlowsPrivatePcde5CaptureMethodX04ac1779,
        ) {
