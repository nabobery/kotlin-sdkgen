...
public class InlineV1IssuingCardholdersPostRequestFormIndividualXf02fa7f1(
    public val cardIssuing: InlineV1IssuingCardholdersPostRequestFormIndividualCardIssuingX607eb461? = null,
    public val dob: InlineV1IssuingCardholdersPostRequestFormIndividualDobX98a23742? = null,
    public val firstName: String? = null,
    public val lastName: String? = null,
    public val verification: InlineV1IssuingCardholdersPostRequestFormIndividualVerificationX89586f92? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1IssuingCardholdersPostRequestFormIndividualXf02fa7f1 =
            InlineV1IssuingCardholdersPostRequestFormIndividualXf02fa7f1(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1IssuingCardholdersPostRequestFormIndividualXf02fa7f1 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1IssuingCardholdersPostRequestFormIndividualXf02fa7f1> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1IssuingCardholdersPostRequestFormIndividualXf02fa7f1 must be a JSON object",
                    )
            return InlineV1IssuingCardholdersPostRequestFormIndividualXf02fa7f1(
                cardIssuing =
                    rawObject["card_issuing"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1IssuingCardholdersPostRequestFormIndividualCardIssuingX607eb461>(
                                it,
                            )
                    },
                dob =
                    rawObject["dob"]?.let {
                        json.decodeFromJsonElement<InlineV1IssuingCardholdersPostRequestFormIndividualDobX98a23742>(it)
                    },
                ...
                verification =
                    rawObject["verification"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1IssuingCardholdersPostRequestFormIndividualVerificationX89586f92>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingCardholdersPostRequestFormIndividualXf02fa7f1,
        ) {
...
public fun inlineV1IssuingCardholdersPostRequestFormIndividualXf02fa7f1(
    block: InlineV1IssuingCardholdersPostRequestFormIndividualXf02fa7f1.Builder.() -> Unit,
): InlineV1IssuingCardholdersPostRequestFormIndividualXf02fa7f1 =
    InlineV1IssuingCardholdersPostRequestFormIndividualXf02fa7f1.build(block)
