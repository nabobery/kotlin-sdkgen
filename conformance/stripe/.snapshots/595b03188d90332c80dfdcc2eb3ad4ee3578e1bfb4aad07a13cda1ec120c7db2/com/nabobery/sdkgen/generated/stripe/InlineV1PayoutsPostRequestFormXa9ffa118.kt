...
public class InlineV1PayoutsPostRequestFormXa9ffa118(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PayoutsPostRequestFormXa9ffa118 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PayoutsPostRequestFormXa9ffa118> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1PayoutsPostRequestFormXa9ffa118 {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("InlineV1PayoutsPostRequestFormXa9ffa118 must be a JSON object")
            ...
            return InlineV1PayoutsPostRequestFormXa9ffa118(
                ...
                method =
                    rawObject["method"]?.let {
                        json.decodeFromJsonElement<InlineV1PayoutsPostRequestFormMethodXb57a053f>(
                            it,
                        )
                    },
                payoutMethod = rawObject["payout_method"]?.let { json.decodeFromJsonElement<String>(it) },
                sourceType =
                    rawObject["source_type"]?.let {
                        json.decodeFromJsonElement<InlineV1PayoutsPostRequestFormSourceTypeX11cba1c5>(it)
                    },
                statementDescriptor =
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PayoutsPostRequestFormXa9ffa118,
        ) {
...
public fun inlineV1PayoutsPostRequestFormXa9ffa118(
    block: InlineV1PayoutsPostRequestFormXa9ffa118.Builder.() -> Unit,
): InlineV1PayoutsPostRequestFormXa9ffa118 = InlineV1PayoutsPostRequestFormXa9ffa118.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PayoutsPostRequestFormXa9ffa118 is missing required property '" + name + "'",
            )
