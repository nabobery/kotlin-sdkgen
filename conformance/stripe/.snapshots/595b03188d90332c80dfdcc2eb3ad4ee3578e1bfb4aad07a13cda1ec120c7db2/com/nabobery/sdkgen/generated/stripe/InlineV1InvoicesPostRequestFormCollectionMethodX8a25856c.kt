...
public sealed class InlineV1InvoicesPostRequestFormCollectionMethodX8a25856c {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1InvoicesPostRequestFormCollectionMethodX8a25856c =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1InvoicesPostRequestFormCollectionMethodX8a25856c> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1InvoicesPostRequestFormCollectionMethodX8a25856c",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1InvoicesPostRequestFormCollectionMethodX8a25856c =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesPostRequestFormCollectionMethodX8a25856c,
        ) {
