...
public sealed class InlineV1FilesGetParameterX66bae549 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1FilesGetParameterX66bae549 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1FilesGetParameterX66bae549> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1FilesGetParameterX66bae549",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1FilesGetParameterX66bae549 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1FilesGetParameterX66bae549,
        ) {
