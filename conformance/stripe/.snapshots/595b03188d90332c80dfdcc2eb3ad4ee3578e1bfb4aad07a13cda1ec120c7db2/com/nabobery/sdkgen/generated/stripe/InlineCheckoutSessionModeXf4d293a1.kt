...
public sealed class InlineCheckoutSessionModeXf4d293a1 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineCheckoutSessionModeXf4d293a1 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineCheckoutSessionModeXf4d293a1> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineCheckoutSessionModeXf4d293a1",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineCheckoutSessionModeXf4d293a1 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineCheckoutSessionModeXf4d293a1,
        ) {
