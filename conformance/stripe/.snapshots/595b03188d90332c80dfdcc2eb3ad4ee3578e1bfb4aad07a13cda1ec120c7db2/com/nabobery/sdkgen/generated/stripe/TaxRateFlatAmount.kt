...
public class TaxRateFlatAmount(
    ...
    public object Serializer : KSerializer<TaxRateFlatAmount> {
        ...
        override fun deserialize(decoder: Decoder): TaxRateFlatAmount {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("TaxRateFlatAmount must be a JSON object")
...
public fun taxRateFlatAmount(block: TaxRateFlatAmount.Builder.() -> Unit): TaxRateFlatAmount =
    TaxRateFlatAmount.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("TaxRateFlatAmount is missing required property '" + name + "'")
