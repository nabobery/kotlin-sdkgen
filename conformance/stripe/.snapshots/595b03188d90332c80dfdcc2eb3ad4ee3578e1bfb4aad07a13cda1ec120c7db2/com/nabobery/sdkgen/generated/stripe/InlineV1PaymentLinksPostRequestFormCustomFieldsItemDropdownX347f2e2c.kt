...
public class InlineV1PaymentLinksPostRequestFormCustomFieldsItemDropdownX347f2e2c(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentLinksPostRequestFormCustomFieldsItemDropdownX347f2e2c = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentLinksPostRequestFormCustomFieldsItemDropdownX347f2e2c> {
        override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1PaymentLinksPostRequestFormCustomFieldsItemDropdownX347f2e2c {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentLinksPostRequestFormCustomFieldsItemDropdownX347f2e2c must be a JSON object",
                    )
            val options =
                json
                    .decodeRequired<List<InlineV1PaymentLinksPostRequestFormCustomFieldsItemDropdownOptionsItemX7bb5a8fa>>(
                        rawObject,
                        "options",
                    )
            return InlineV1PaymentLinksPostRequestFormCustomFieldsItemDropdownX347f2e2c(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentLinksPostRequestFormCustomFieldsItemDropdownX347f2e2c,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentLinksPostRequestFormCustomFieldsItemDropdownX347f2e2c(
    block: InlineV1PaymentLinksPostRequestFormCustomFieldsItemDropdownX347f2e2c.Builder.() -> Unit,
): InlineV1PaymentLinksPostRequestFormCustomFieldsItemDropdownX347f2e2c =
    InlineV1PaymentLinksPostRequestFormCustomFieldsItemDropdownX347f2e2c.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentLinksPostRequestFormCustomFieldsItemDropdownX347f2e2c is missing required property '" +
                    name +
                    "'",
            )
