...
public class InlineV1TerminalReadersCollectPaymentMethodPostRequestFormX90003535(
     ...
     */
    public val collectConfig: InlineV1TerminalReadersCollectPaymentMethodPostRequestFormCollectConfigXadf48dd2? = null,
    /**
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1TerminalReadersCollectPaymentMethodPostRequestFormX90003535 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TerminalReadersCollectPaymentMethodPostRequestFormX90003535> {
        override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1TerminalReadersCollectPaymentMethodPostRequestFormX90003535 {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TerminalReadersCollectPaymentMethodPostRequestFormX90003535 must be a JSON object",
                    )
            val paymentIntent = json.decodeRequired<String>(rawObject, "payment_intent")
            return InlineV1TerminalReadersCollectPaymentMethodPostRequestFormX90003535(
                paymentIntent = paymentIntent,
                collectConfig =
                    rawObject["collect_config"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TerminalReadersCollectPaymentMethodPostRequestFormCollectConfigXadf48dd2>(
                                it,
                            )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TerminalReadersCollectPaymentMethodPostRequestFormX90003535,
        ) {
            val jsonEncoder =
...
public fun inlineV1TerminalReadersCollectPaymentMethodPostRequestFormX90003535(
    block: InlineV1TerminalReadersCollectPaymentMethodPostRequestFormX90003535.Builder.() -> Unit,
): InlineV1TerminalReadersCollectPaymentMethodPostRequestFormX90003535 =
    InlineV1TerminalReadersCollectPaymentMethodPostRequestFormX90003535.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TerminalReadersCollectPaymentMethodPostRequestFormX90003535 is missing required property '" +
                    name +
                    "'",
            )
