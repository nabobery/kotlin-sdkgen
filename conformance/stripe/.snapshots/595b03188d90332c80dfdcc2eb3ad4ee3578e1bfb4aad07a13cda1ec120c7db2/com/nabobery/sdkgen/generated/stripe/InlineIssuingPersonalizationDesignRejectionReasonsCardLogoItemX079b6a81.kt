...
public sealed class InlineIssuingPersonalizationDesignRejectionReasonsCardLogoItemX079b6a81 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineIssuingPersonalizationDesignRejectionReasonsCardLogoItemX079b6a81 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineIssuingPersonalizationDesignRejectionReasonsCardLogoItemX079b6a81> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineIssuingPersonalizationDesignRejectionReasonsCardLogoItemX079b6a81",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineIssuingPersonalizationDesignRejectionReasonsCardLogoItemX079b6a81 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineIssuingPersonalizationDesignRejectionReasonsCardLogoItemX079b6a81,
        ) {
