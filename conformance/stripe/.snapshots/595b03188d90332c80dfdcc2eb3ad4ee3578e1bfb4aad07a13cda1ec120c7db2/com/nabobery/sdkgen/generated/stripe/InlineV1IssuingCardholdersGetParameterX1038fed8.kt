...
public sealed class InlineV1IssuingCardholdersGetParameterX1038fed8 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1IssuingCardholdersGetParameterX1038fed8 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1IssuingCardholdersGetParameterX1038fed8> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1IssuingCardholdersGetParameterX1038fed8",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1IssuingCardholdersGetParameterX1038fed8 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingCardholdersGetParameterX1038fed8,
        ) {
