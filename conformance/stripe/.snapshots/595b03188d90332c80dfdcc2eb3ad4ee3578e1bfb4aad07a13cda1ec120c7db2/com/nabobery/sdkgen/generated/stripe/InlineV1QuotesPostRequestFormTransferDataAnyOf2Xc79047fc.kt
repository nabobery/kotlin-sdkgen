...
public sealed class InlineV1QuotesPostRequestFormTransferDataAnyOf2Xc79047fc {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1QuotesPostRequestFormTransferDataAnyOf2Xc79047fc =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1QuotesPostRequestFormTransferDataAnyOf2Xc79047fc> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1QuotesPostRequestFormTransferDataAnyOf2Xc79047fc",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1QuotesPostRequestFormTransferDataAnyOf2Xc79047fc =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1QuotesPostRequestFormTransferDataAnyOf2Xc79047fc,
        ) {
