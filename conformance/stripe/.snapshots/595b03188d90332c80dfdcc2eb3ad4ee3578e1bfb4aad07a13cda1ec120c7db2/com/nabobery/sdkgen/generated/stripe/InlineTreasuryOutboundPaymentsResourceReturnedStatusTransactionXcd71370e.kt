...
public class InlineTreasuryOutboundPaymentsResourceReturnedStatusTransactionXcd71370e internal constructor(
    ...
    private val inspection: InlineTreasuryOutboundPaymentsResourceReturnedStatusTransactionXcd71370eInspection,
) {
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineTreasuryOutboundPaymentsResourceReturnedStatusTransactionXcd71370eBranch.Branch1,
                    )
                }
                if (inspection.matchesTreasuryTransaction) {
                    add(
                        InlineTreasuryOutboundPaymentsResourceReturnedStatusTransactionXcd71370eBranch.TreasuryTransaction,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineTreasuryOutboundPaymentsResourceReturnedStatusTransactionXcd71370e {
            val inspection = inspectInlineTreasuryOutboundPaymentsResourceReturnedStatusTransactionXcd71370e(raw)
            if (inspection.matchCount == 0) {
                throw InlineTreasuryOutboundPaymentsResourceReturnedStatusTransactionXcd71370eNoMatchException(
                    "InlineTreasuryOutboundPaymentsResourceReturnedStatusTransactionXcd71370e matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineTreasuryOutboundPaymentsResourceReturnedStatusTransactionXcd71370e> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineTreasuryOutboundPaymentsResourceReturnedStatusTransactionXcd71370e,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineTreasuryOutboundPaymentsResourceReturnedStatusTransactionXcd71370e",
...
private fun inspectInlineTreasuryOutboundPaymentsResourceReturnedStatusTransactionXcd71370e(
    element: JsonElement,
