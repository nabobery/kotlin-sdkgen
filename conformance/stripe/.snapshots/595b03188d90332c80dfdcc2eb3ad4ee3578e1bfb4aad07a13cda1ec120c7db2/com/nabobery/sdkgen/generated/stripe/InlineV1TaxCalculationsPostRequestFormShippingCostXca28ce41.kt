...
public class InlineV1TaxCalculationsPostRequestFormShippingCostXca28ce41(
    ...
    public val taxBehavior: InlineV1TaxCalculationsPostRequestFormShippingCostTaxBehaviorX0846c4d6? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1TaxCalculationsPostRequestFormShippingCostXca28ce41 =
            InlineV1TaxCalculationsPostRequestFormShippingCostXca28ce41(
                amount = amount,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TaxCalculationsPostRequestFormShippingCostXca28ce41 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TaxCalculationsPostRequestFormShippingCostXca28ce41> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TaxCalculationsPostRequestFormShippingCostXca28ce41 must be a JSON object",
                    )
            return InlineV1TaxCalculationsPostRequestFormShippingCostXca28ce41(
                ...
                taxBehavior =
                    rawObject["tax_behavior"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TaxCalculationsPostRequestFormShippingCostTaxBehaviorX0846c4d6>(
                                it,
                            )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TaxCalculationsPostRequestFormShippingCostXca28ce41,
        ) {
...
public fun inlineV1TaxCalculationsPostRequestFormShippingCostXca28ce41(
    block: InlineV1TaxCalculationsPostRequestFormShippingCostXca28ce41.Builder.() -> Unit,
): InlineV1TaxCalculationsPostRequestFormShippingCostXca28ce41 =
    InlineV1TaxCalculationsPostRequestFormShippingCostXca28ce41.build(block)
