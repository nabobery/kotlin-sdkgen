...
public class InlineV1CheckoutSessionsPostRequestFormShippingOptionsAnyOf1ItemMinimumX058275d2(
    ...
    public object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormShippingOptionsAnyOf1ItemMinimumX058275d2> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CheckoutSessionsPostRequestFormShippingOptionsAnyOf1ItemMinimumX058275d2 must be a JSON object",
                    )
            val unit =
                json.decodeRequired<InlineV1CheckoutSessionsPostRequestFormShippingOptionsAnyOf1ItemUnitX2c8ff34f>(
                    rawObject,
                    "unit",
                )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsPostRequestFormShippingOptionsAnyOf1ItemMinimumX058275d2,
        ) {
            val jsonEncoder =
...
public fun inlineV1CheckoutSessionsPostRequestFormShippingOptionsAnyOf1ItemMinimumX058275d2(
    block: InlineV1CheckoutSessionsPostRequestFormShippingOptionsAnyOf1ItemMinimumX058275d2.Builder.() -> Unit,
): InlineV1CheckoutSessionsPostRequestFormShippingOptionsAnyOf1ItemMinimumX058275d2 =
    InlineV1CheckoutSessionsPostRequestFormShippingOptionsAnyOf1ItemMinimumX058275d2.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1CheckoutSessionsPostRequestFormShippingOptionsAnyOf1ItemMinimumX058275d2 is missing required property '" +
                    name +
                    "'",
            )
