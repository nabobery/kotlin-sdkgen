...
public sealed class InlineV1InvoicePaymentsGetParameterTypeX4ee4ad19 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1InvoicePaymentsGetParameterTypeX4ee4ad19 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1InvoicePaymentsGetParameterTypeX4ee4ad19> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1InvoicePaymentsGetParameterTypeX4ee4ad19",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1InvoicePaymentsGetParameterTypeX4ee4ad19 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicePaymentsGetParameterTypeX4ee4ad19,
        ) {
