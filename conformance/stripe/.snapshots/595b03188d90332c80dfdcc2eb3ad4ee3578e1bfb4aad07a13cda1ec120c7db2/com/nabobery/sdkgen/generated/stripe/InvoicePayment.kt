...
public class InvoicePayment(
    ...
    public object Serializer : KSerializer<InvoicePayment> {
        ...
        override fun deserialize(decoder: Decoder): InvoicePayment {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("InvoicePayment must be a JSON object")
            ...
            val statusTransitions =
                json.decodeRequired<InvoicesPaymentsInvoicePaymentStatusTransitions>(
                    rawObject,
                    "status_transitions",
                )
            return InvoicePayment(
                ...
                statusTransitions = statusTransitions,
                amountPaid =
                    rawObject["amount_paid"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("InvoicePayment is missing required property '" + name + "'")
