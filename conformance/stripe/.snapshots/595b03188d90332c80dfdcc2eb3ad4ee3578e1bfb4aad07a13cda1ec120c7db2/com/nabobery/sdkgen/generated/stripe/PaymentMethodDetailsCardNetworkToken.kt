...
public class PaymentMethodDetailsCardNetworkToken(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentMethodDetailsCardNetworkToken =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentMethodDetailsCardNetworkToken> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodDetailsCardNetworkToken {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodDetailsCardNetworkToken must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentMethodDetailsCardNetworkToken,
        ) {
...
public fun paymentMethodDetailsCardNetworkToken(
    block: PaymentMethodDetailsCardNetworkToken.Builder.() -> Unit,
): PaymentMethodDetailsCardNetworkToken = PaymentMethodDetailsCardNetworkToken.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "PaymentMethodDetailsCardNetworkToken is missing required property '" + name + "'",
            )
