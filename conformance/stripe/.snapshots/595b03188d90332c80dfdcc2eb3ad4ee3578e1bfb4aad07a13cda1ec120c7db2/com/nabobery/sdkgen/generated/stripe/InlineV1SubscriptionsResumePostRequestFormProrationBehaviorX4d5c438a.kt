...
public sealed class InlineV1SubscriptionsResumePostRequestFormProrationBehaviorX4d5c438a {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1SubscriptionsResumePostRequestFormProrationBehaviorX4d5c438a =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionsResumePostRequestFormProrationBehaviorX4d5c438a> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1SubscriptionsResumePostRequestFormProrationBehaviorX4d5c438a",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1SubscriptionsResumePostRequestFormProrationBehaviorX4d5c438a = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsResumePostRequestFormProrationBehaviorX4d5c438a,
        ) {
