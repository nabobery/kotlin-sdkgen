...
public class IssuingTransactionAmountDetails(
    ...
    public class Builder {
        ...
        public fun build(): IssuingTransactionAmountDetails =
    ...
    public object Serializer : KSerializer<IssuingTransactionAmountDetails> {
        ...
        override fun deserialize(decoder: Decoder): IssuingTransactionAmountDetails {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("IssuingTransactionAmountDetails must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: IssuingTransactionAmountDetails,
        ) {
...
public fun issuingTransactionAmountDetails(
    block: IssuingTransactionAmountDetails.Builder.() -> Unit,
): IssuingTransactionAmountDetails = IssuingTransactionAmountDetails.build(block)
