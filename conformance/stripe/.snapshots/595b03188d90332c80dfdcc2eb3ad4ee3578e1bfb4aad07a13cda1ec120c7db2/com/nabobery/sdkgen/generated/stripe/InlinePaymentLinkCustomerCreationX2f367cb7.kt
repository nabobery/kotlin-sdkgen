...
public sealed class InlinePaymentLinkCustomerCreationX2f367cb7 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentLinkCustomerCreationX2f367cb7 =
            when (value) {
                Always.value -> Always
    ...
    public object Serializer : KSerializer<InlinePaymentLinkCustomerCreationX2f367cb7> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentLinkCustomerCreationX2f367cb7",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePaymentLinkCustomerCreationX2f367cb7 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentLinkCustomerCreationX2f367cb7,
        ) {
