...
public sealed class InlineTaxProductRegistratic1c1TypeX979aebb4 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineTaxProductRegistratic1c1TypeX979aebb4 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineTaxProductRegistratic1c1TypeX979aebb4> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineTaxProductRegistratic1c1TypeX979aebb4",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineTaxProductRegistratic1c1TypeX979aebb4 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineTaxProductRegistratic1c1TypeX979aebb4,
        ) {
