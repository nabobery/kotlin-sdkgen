...
public class GelatoEmailReportError(
    ...
    public class Builder {
        ...
        public fun build(): GelatoEmailReportError =
        ...
        override fun deserialize(decoder: Decoder): GelatoEmailReportError {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("GelatoEmailReportError must be a JSON object")
                ...
                code =
                    rawObject["code"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineGelatoEmailReportErrorCodeXba5e0df5?>(element)
                        }
                    },
                reason =
...
public fun gelatoEmailReportError(block: GelatoEmailReportError.Builder.() -> Unit): GelatoEmailReportError =
    GelatoEmailReportError.build(block)
