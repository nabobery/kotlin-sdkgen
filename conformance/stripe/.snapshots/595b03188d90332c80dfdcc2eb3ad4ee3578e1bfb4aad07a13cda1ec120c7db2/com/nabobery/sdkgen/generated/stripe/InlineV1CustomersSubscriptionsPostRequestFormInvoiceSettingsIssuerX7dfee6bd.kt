...
public class InlineV1CustomersSubscriptionsPostRequestFormInvoiceSettingsIssuerX7dfee6bd(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1CustomersSubscriptionsPostRequestFormInvoiceSettingsIssuerX7dfee6bd = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1CustomersSubscriptionsPostRequestFormInvoiceSettingsIssuerX7dfee6bd> {
        override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1CustomersSubscriptionsPostRequestFormInvoiceSettingsIssuerX7dfee6bd {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CustomersSubscriptionsPostRequestFormInvoiceSettingsIssuerX7dfee6bd must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineV1CustomersSubscriptionsPostRequestFormInvoiceSettingsIssuerTypeX52e21ee5>(
                    rawObject,
                    "type",
                )
            return InlineV1CustomersSubscriptionsPostRequestFormInvoiceSettingsIssuerX7dfee6bd(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersSubscriptionsPostRequestFormInvoiceSettingsIssuerX7dfee6bd,
        ) {
            val jsonEncoder =
...
public fun inlineV1CustomersSubscriptionsPostRequestFormInvoiceSettingsIssuerX7dfee6bd(
    block: InlineV1CustomersSubscriptionsPostRequestFormInvoiceSettingsIssuerX7dfee6bd.Builder.() -> Unit,
): InlineV1CustomersSubscriptionsPostRequestFormInvoiceSettingsIssuerX7dfee6bd =
    InlineV1CustomersSubscriptionsPostRequestFormInvoiceSettingsIssuerX7dfee6bd.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1CustomersSubscriptionsPostRequestFormInvoiceSettingsIssuerX7dfee6bd is missing required property '" +
                    name +
                    "'",
            )
