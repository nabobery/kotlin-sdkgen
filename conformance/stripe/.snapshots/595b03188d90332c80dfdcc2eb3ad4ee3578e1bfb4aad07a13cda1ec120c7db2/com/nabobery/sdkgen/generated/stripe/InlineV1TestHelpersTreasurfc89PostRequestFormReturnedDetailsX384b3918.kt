...
public class InlineV1TestHelpersTreasurfc89PostRequestFormReturnedDetailsX384b3918(
    public val code: InlineV1TestHelpersTreasurfc89PostRequestFormReturnedDetailsCodeX94e03237? = null,
) {
    public class Builder {
        public var code: InlineV1TestHelpersTreasurfc89PostRequestFormReturnedDetailsCodeX94e03237? =
            null

        public fun build(): InlineV1TestHelpersTreasurfc89PostRequestFormReturnedDetailsX384b3918 =
            InlineV1TestHelpersTreasurfc89PostRequestFormReturnedDetailsX384b3918(
                code = code,
            )
    }
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1TestHelpersTreasurfc89PostRequestFormReturnedDetailsX384b3918 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1TestHelpersTreasurfc89PostRequestFormReturnedDetailsX384b3918> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TestHelpersTreasurfc89PostRequestFormReturnedDetailsX384b3918 must be a JSON object",
                    )
            return InlineV1TestHelpersTreasurfc89PostRequestFormReturnedDetailsX384b3918(
                code =
                    rawObject["code"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TestHelpersTreasurfc89PostRequestFormReturnedDetailsCodeX94e03237>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TestHelpersTreasurfc89PostRequestFormReturnedDetailsX384b3918,
        ) {
            val jsonEncoder =
...
public fun inlineV1TestHelpersTreasurfc89PostRequestFormReturnedDetailsX384b3918(
    block: InlineV1TestHelpersTreasurfc89PostRequestFormReturnedDetailsX384b3918.Builder.() -> Unit,
): InlineV1TestHelpersTreasurfc89PostRequestFormReturnedDetailsX384b3918 =
    InlineV1TestHelpersTreasurfc89PostRequestFormReturnedDetailsX384b3918.build(block)
