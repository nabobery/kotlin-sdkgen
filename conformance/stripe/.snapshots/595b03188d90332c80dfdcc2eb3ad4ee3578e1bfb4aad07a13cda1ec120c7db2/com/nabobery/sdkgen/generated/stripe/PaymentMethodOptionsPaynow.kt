...
public class PaymentMethodOptionsPaynow(
    ...
    public class Builder {
        ...
        public fun build(): PaymentMethodOptionsPaynow =
    ...
    public object Serializer : KSerializer<PaymentMethodOptionsPaynow> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodOptionsPaynow {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodOptionsPaynow must be a JSON object")
            return PaymentMethodOptionsPaynow(
                setupFutureUsage =
                    rawObject["setup_future_usage"]?.let {
                        json.decodeFromJsonElement<InlinePaymentMethodOptionsPaynowSetupFutureUsageX09a4f505>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentMethodOptionsPaynow,
        ) {
...
public fun paymentMethodOptionsPaynow(
    block: PaymentMethodOptionsPaynow.Builder.() -> Unit,
): PaymentMethodOptionsPaynow = PaymentMethodOptionsPaynow.build(block)
