...
public class InlineV1TreasuryFinancialAc862PostRequestFormFeaturesAchX807eb3a6(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TreasuryFinancialAc862PostRequestFormFeaturesAchX807eb3a6 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TreasuryFinancialAc862PostRequestFormFeaturesAchX807eb3a6> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TreasuryFinancialAc862PostRequestFormFeaturesAchX807eb3a6 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TreasuryFinancialAc862PostRequestFormFeaturesAchX807eb3a6,
        ) {
            val jsonEncoder =
...
public fun inlineV1TreasuryFinancialAc862PostRequestFormFeaturesAchX807eb3a6(
    block: InlineV1TreasuryFinancialAc862PostRequestFormFeaturesAchX807eb3a6.Builder.() -> Unit,
): InlineV1TreasuryFinancialAc862PostRequestFormFeaturesAchX807eb3a6 =
    InlineV1TreasuryFinancialAc862PostRequestFormFeaturesAchX807eb3a6.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TreasuryFinancialAc862PostRequestFormFeaturesAchX807eb3a6 is missing required property '" +
                    name +
                    "'",
            )
