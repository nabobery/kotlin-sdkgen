...
public class PaymentIntentNextActionRedirectToUrl(
    ...
    public class Builder {
        ...
        public fun build(): PaymentIntentNextActionRedirectToUrl =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentIntentNextActionRedirectToUrl =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentIntentNextActionRedirectToUrl> {
        ...
        override fun deserialize(decoder: Decoder): PaymentIntentNextActionRedirectToUrl {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentIntentNextActionRedirectToUrl must be a JSON object")
...
public fun paymentIntentNextActionRedirectToUrl(
    block: PaymentIntentNextActionRedirectToUrl.Builder.() -> Unit,
): PaymentIntentNextActionRedirectToUrl = PaymentIntentNextActionRedirectToUrl.build(block)
