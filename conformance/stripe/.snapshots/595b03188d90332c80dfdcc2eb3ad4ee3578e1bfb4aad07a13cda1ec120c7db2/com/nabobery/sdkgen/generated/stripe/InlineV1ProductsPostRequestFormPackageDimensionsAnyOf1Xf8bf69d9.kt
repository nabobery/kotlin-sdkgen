...
public class InlineV1ProductsPostRequestFormPackageDimensionsAnyOf1Xf8bf69d9(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1ProductsPostRequestFormPackageDimensionsAnyOf1Xf8bf69d9 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1ProductsPostRequestFormPackageDimensionsAnyOf1Xf8bf69d9> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1ProductsPostRequestFormPackageDimensionsAnyOf1Xf8bf69d9 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ProductsPostRequestFormPackageDimensionsAnyOf1Xf8bf69d9,
        ) {
            val jsonEncoder =
...
public fun inlineV1ProductsPostRequestFormPackageDimensionsAnyOf1Xf8bf69d9(
    block: InlineV1ProductsPostRequestFormPackageDimensionsAnyOf1Xf8bf69d9.Builder.() -> Unit,
): InlineV1ProductsPostRequestFormPackageDimensionsAnyOf1Xf8bf69d9 =
    InlineV1ProductsPostRequestFormPackageDimensionsAnyOf1Xf8bf69d9.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1ProductsPostRequestFormPackageDimensionsAnyOf1Xf8bf69d9 is missing required property '" + name +
                    "'",
            )
