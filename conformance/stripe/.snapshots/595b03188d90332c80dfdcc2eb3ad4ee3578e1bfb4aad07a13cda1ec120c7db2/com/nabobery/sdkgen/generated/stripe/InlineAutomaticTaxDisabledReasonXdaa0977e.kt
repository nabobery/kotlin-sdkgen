...
public sealed class InlineAutomaticTaxDisabledReasonXdaa0977e {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineAutomaticTaxDisabledReasonXdaa0977e =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineAutomaticTaxDisabledReasonXdaa0977e> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineAutomaticTaxDisabledReasonXdaa0977e",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineAutomaticTaxDisabledReasonXdaa0977e =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineAutomaticTaxDisabledReasonXdaa0977e,
        ) {
