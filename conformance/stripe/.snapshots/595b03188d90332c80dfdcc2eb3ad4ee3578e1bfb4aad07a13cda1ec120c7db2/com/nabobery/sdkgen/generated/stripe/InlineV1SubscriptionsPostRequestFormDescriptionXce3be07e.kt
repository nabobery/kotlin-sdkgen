...
internal data class InlineV1SubscriptionsPostRequestFormDescriptionXce3be07eInspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1SubscriptionsPostRequestFormDescriptionAnyOf2X29ab626c,
            ).count { it }
}
...
public class InlineV1SubscriptionsPostRequestFormDescriptionXce3be07e internal constructor(
    ...
    public val inlineV1SubscriptionsPostRequestFormDescriptionAnyOf2X29ab626c:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1SubscriptionsPostRequestFormDescriptionAnyOf2X29ab626c) {
                json
                    .decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormDescriptionAnyOf2X29ab626c>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1SubscriptionsPostRequestFormDescriptionXce3be07eBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1SubscriptionsPostRequestFormDescriptionAnyOf2X29ab626c) {
                    add(
                        InlineV1SubscriptionsPostRequestFormDescriptionXce3be07eBranch.InlineV1SubscriptionsPostRequestFormDescriptionAnyOf2X29ab626c,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1SubscriptionsPostRequestFormDescriptionXce3be07e {
            val inspection = inspectInlineV1SubscriptionsPostRequestFormDescriptionXce3be07e(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1SubscriptionsPostRequestFormDescriptionXce3be07eNoMatchException(
                    "InlineV1SubscriptionsPostRequestFormDescriptionXce3be07e matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionsPostRequestFormDescriptionXce3be07e> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsPostRequestFormDescriptionXce3be07e,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1SubscriptionsPostRequestFormDescriptionXce3be07e",
...
private fun inspectInlineV1SubscriptionsPostRequestFormDescriptionXce3be07e(
    element: JsonElement,
): InlineV1SubscriptionsPostRequestFormDescriptionXce3be07eInspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1SubscriptionsPostRequestFormDescriptionAnyOf2X29ab626c =
        element
            .isJsonDecodable<InlineV1SubscriptionsPostRequestFormDescriptionAnyOf2X29ab626c>()
    return InlineV1SubscriptionsPostRequestFormDescriptionXce3be07eInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1SubscriptionsPostRequestFormDescriptionAnyOf2X29ab626c) {
                    add(
                        "InlineV1SubscriptionsPostRequestFormDescriptionAnyOf2X29ab626c: value does not match InlineV1SubscriptionsPostRequestFormDescriptionAnyOf2X29ab626c",
                    )
                }
            },
    )
