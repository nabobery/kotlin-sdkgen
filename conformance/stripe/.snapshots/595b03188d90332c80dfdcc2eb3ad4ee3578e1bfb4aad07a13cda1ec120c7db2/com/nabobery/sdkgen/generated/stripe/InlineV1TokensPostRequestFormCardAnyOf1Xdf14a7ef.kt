...
public class InlineV1TokensPostRequestFormCardAnyOf1Xdf14a7ef(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TokensPostRequestFormCardAnyOf1Xdf14a7ef =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TokensPostRequestFormCardAnyOf1Xdf14a7ef> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TokensPostRequestFormCardAnyOf1Xdf14a7ef must be a JSON object",
                    )
            ...
            return InlineV1TokensPostRequestFormCardAnyOf1Xdf14a7ef(
                ...
                networks =
                    rawObject["networks"]?.let {
                        json.decodeFromJsonElement<InlineV1TokensPostRequestFormCardAnyOf1NetworksX285416f0>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TokensPostRequestFormCardAnyOf1Xdf14a7ef,
        ) {
...
public fun inlineV1TokensPostRequestFormCardAnyOf1Xdf14a7ef(
    block: InlineV1TokensPostRequestFormCardAnyOf1Xdf14a7ef.Builder.() -> Unit,
): InlineV1TokensPostRequestFormCardAnyOf1Xdf14a7ef = InlineV1TokensPostRequestFormCardAnyOf1Xdf14a7ef.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TokensPostRequestFormCardAnyOf1Xdf14a7ef is missing required property '" + name + "'",
            )
