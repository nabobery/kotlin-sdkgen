...
public sealed class InlineMandateUsBankAccountCollectionMethodXad379101 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineMandateUsBankAccountCollectionMethodXad379101 =
            when (value) {
                Paper.value -> Paper
    ...
    public object Serializer : KSerializer<InlineMandateUsBankAccountCollectionMethodXad379101> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineMandateUsBankAccountCollectionMethodXad379101",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineMandateUsBankAccountCollectionMethodXad379101 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineMandateUsBankAccountCollectionMethodXad379101,
        ) {
