...
public class InlineV1LinkAccountSessionsPostRequestFormX42f81b04(
     ...
     */
    public val prefetch: List<InlineV1LinkAccountSessionsPostRequestFormPrefetchItemXf397b7b2>? = null,
    /**
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1LinkAccountSessionsPostRequestFormX42f81b04 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1LinkAccountSessionsPostRequestFormX42f81b04> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1LinkAccountSessionsPostRequestFormX42f81b04 must be a JSON object",
                    )
            val accountHolder =
                json.decodeRequired<InlineV1LinkAccountSessionsPostRequestFormAccountHolderXf956ba1a>(
                    rawObject,
                    "account_holder",
                )
            val permissions =
                json.decodeRequired<List<InlineV1LinkAccountSessionsPostRequestFormPermissionsItemX0bf81dae>>(
                    rawObject,
                    "permissions",
                )
            return InlineV1LinkAccountSessionsPostRequestFormX42f81b04(
                ...
                filters =
                    rawObject["filters"]?.let {
                        json.decodeFromJsonElement<InlineV1LinkAccountSessionsPostRequestFormFiltersXa834bef4>(it)
                    },
                prefetch =
                    rawObject["prefetch"]?.let {
                        json
                            .decodeFromJsonElement<List<InlineV1LinkAccountSessionsPostRequestFormPrefetchItemXf397b7b2>>(
                                it,
                            )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1LinkAccountSessionsPostRequestFormX42f81b04,
        ) {
...
public fun inlineV1LinkAccountSessionsPostRequestFormX42f81b04(
    block: InlineV1LinkAccountSessionsPostRequestFormX42f81b04.Builder.() -> Unit,
): InlineV1LinkAccountSessionsPostRequestFormX42f81b04 =
    InlineV1LinkAccountSessionsPostRequestFormX42f81b04.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1LinkAccountSessionsPostRequestFormX42f81b04 is missing required property '" + name + "'",
            )
