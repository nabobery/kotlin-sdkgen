...
public class InlineV1ChargesDisputePostRequestFormEvidenceXbae9196a(
    ...
    public val enhancedEvidence: InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceX65dc79fc? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1ChargesDisputePostRequestFormEvidenceXbae9196a =
            InlineV1ChargesDisputePostRequestFormEvidenceXbae9196a(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1ChargesDisputePostRequestFormEvidenceXbae9196a =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1ChargesDisputePostRequestFormEvidenceXbae9196a> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1ChargesDisputePostRequestFormEvidenceXbae9196a must be a JSON object",
                    )
            return InlineV1ChargesDisputePostRequestFormEvidenceXbae9196a(
                ...
                enhancedEvidence =
                    rawObject["enhanced_evidence"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceX65dc79fc>(
                                it,
                            )
                    },
                productDescription =
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ChargesDisputePostRequestFormEvidenceXbae9196a,
        ) {
...
public fun inlineV1ChargesDisputePostRequestFormEvidenceXbae9196a(
    block: InlineV1ChargesDisputePostRequestFormEvidenceXbae9196a.Builder.() -> Unit,
): InlineV1ChargesDisputePostRequestFormEvidenceXbae9196a =
    InlineV1ChargesDisputePostRequestFormEvidenceXbae9196a.build(block)
