...
public class InlineV1TerminalReadersProcessPaymentIntentPostRequestFormX05966402(
     ...
     */
    public val processConfig: InlineV1TerminalReadersProcessPaymentIntentPostRequestFormProcessConfigXc6c12c4f? = null,
) {
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1TerminalReadersProcessPaymentIntentPostRequestFormX05966402 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TerminalReadersProcessPaymentIntentPostRequestFormX05966402> {
        override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1TerminalReadersProcessPaymentIntentPostRequestFormX05966402 {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TerminalReadersProcessPaymentIntentPostRequestFormX05966402 must be a JSON object",
                    )
            ...
            return InlineV1TerminalReadersProcessPaymentIntentPostRequestFormX05966402(
                ...
                processConfig =
                    rawObject["process_config"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TerminalReadersProcessPaymentIntentPostRequestFormProcessConfigXc6c12c4f>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TerminalReadersProcessPaymentIntentPostRequestFormX05966402,
        ) {
            val jsonEncoder =
...
public fun inlineV1TerminalReadersProcessPaymentIntentPostRequestFormX05966402(
    block: InlineV1TerminalReadersProcessPaymentIntentPostRequestFormX05966402.Builder.() -> Unit,
): InlineV1TerminalReadersProcessPaymentIntentPostRequestFormX05966402 =
    InlineV1TerminalReadersProcessPaymentIntentPostRequestFormX05966402.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TerminalReadersProcessPaymentIntentPostRequestFormX05966402 is missing required property '" +
                    name +
                    "'",
            )
