...
public class PaymentFlowsPrivatePaymentMethodsSamsungPayPaymentMethodOptions(
    ...
    public class Builder {
        ...
        public fun build(): PaymentFlowsPrivatePaymentMethodsSamsungPayPaymentMethodOptions =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentFlowsPrivatePaymentMethodsSamsungPayPaymentMethodOptions =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentFlowsPrivatePaymentMethodsSamsungPayPaymentMethodOptions> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "PaymentFlowsPrivatePaymentMethodsSamsungPayPaymentMethodOptions must be a JSON object",
                    )
            return PaymentFlowsPrivatePaymentMethodsSamsungPayPaymentMethodOptions(
                captureMethod =
                    rawObject["capture_method"]?.let {
                        json.decodeFromJsonElement<InlinePaymentFlowsPrivatePcde5CaptureMethodX04ac1779>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentFlowsPrivatePaymentMethodsSamsungPayPaymentMethodOptions,
        ) {
            val jsonEncoder =
...
public fun paymentFlowsPrivatePaymentMethodsSamsungPayPaymentMethodOptions(
    block: PaymentFlowsPrivatePaymentMethodsSamsungPayPaymentMethodOptions.Builder.() -> Unit,
): PaymentFlowsPrivatePaymentMethodsSamsungPayPaymentMethodOptions =
    PaymentFlowsPrivatePaymentMethodsSamsungPayPaymentMethodOptions.build(block)
