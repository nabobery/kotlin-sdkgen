...
public class InlineV1PaymentIntentsPostRequestFormFinancialConnectionsX3277c8da(
    public val filters: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsFiltersX910152bd? = null,
    public val permissions: List<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsItemX1aae759b>? = null,
    public val prefetch: List<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsItemX52bd8ec5>? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1PaymentIntentsPostRequestFormFinancialConnectionsX3277c8da =
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentIntentsPostRequestFormFinancialConnectionsX3277c8da = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormFinancialConnectionsX3277c8da> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsPostRequestFormFinancialConnectionsX3277c8da must be a JSON object",
                    )
            return InlineV1PaymentIntentsPostRequestFormFinancialConnectionsX3277c8da(
                filters =
                    rawObject["filters"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsFiltersX910152bd>(
                                it,
                            )
                    },
                permissions =
                    rawObject["permissions"]?.let {
                        json
                            .decodeFromJsonElement<List<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsItemX1aae759b>>(
                                it,
                            )
                    },
                prefetch =
                    rawObject["prefetch"]?.let {
                        json
                            .decodeFromJsonElement<List<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsItemX52bd8ec5>>(
                                it,
                            )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormFinancialConnectionsX3277c8da,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentIntentsPostRequestFormFinancialConnectionsX3277c8da(
    block: InlineV1PaymentIntentsPostRequestFormFinancialConnectionsX3277c8da.Builder.() -> Unit,
): InlineV1PaymentIntentsPostRequestFormFinancialConnectionsX3277c8da =
    InlineV1PaymentIntentsPostRequestFormFinancialConnectionsX3277c8da.build(block)
