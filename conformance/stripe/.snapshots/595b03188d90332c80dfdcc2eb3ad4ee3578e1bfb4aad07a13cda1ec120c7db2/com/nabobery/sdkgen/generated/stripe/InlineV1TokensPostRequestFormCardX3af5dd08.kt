...
public class InlineV1TokensPostRequestFormCardX3af5dd08 internal constructor(
    ...
    public val inlineV1TokensPostRequestFormCardAnyOf1Xdf14a7ef:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1TokensPostRequestFormCardAnyOf1Xdf14a7ef) {
                json
                    .decodeFromJsonElement<InlineV1TokensPostRequestFormCardAnyOf1Xdf14a7ef>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1TokensPostRequestFormCardX3af5dd08Branch>
        get() =
            buildSet {
                if (inspection.matchesInlineV1TokensPostRequestFormCardAnyOf1Xdf14a7ef) {
                    add(
                        InlineV1TokensPostRequestFormCardX3af5dd08Branch.InlineV1TokensPostRequestFormCardAnyOf1Xdf14a7ef,
                    )
                }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1TokensPostRequestFormCardX3af5dd08 {
            val inspection = inspectInlineV1TokensPostRequestFormCardX3af5dd08(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1TokensPostRequestFormCardX3af5dd08NoMatchException(
                    "InlineV1TokensPostRequestFormCardX3af5dd08 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1TokensPostRequestFormCardX3af5dd08> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TokensPostRequestFormCardX3af5dd08,
        ) {
...
private fun inspectInlineV1TokensPostRequestFormCardX3af5dd08(
    element: JsonElement,
): InlineV1TokensPostRequestFormCardX3af5dd08Inspection {
    val matchesInlineV1TokensPostRequestFormCardAnyOf1Xdf14a7ef =
        element
            .isJsonDecodable<InlineV1TokensPostRequestFormCardAnyOf1Xdf14a7ef>()
    ...
    return InlineV1TokensPostRequestFormCardX3af5dd08Inspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1TokensPostRequestFormCardAnyOf1Xdf14a7ef) {
                    add(
                        "InlineV1TokensPostRequestFormCardAnyOf1Xdf14a7ef: value does not match InlineV1TokensPostRequestFormCardAnyOf1Xdf14a7ef",
                    )
                }
