...
public sealed class InlineEphemeralKeyObjectValueXacbdbeaf {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineEphemeralKeyObjectValueXacbdbeaf =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineEphemeralKeyObjectValueXacbdbeaf> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineEphemeralKeyObjectValueXacbdbeaf",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineEphemeralKeyObjectValueXacbdbeaf =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineEphemeralKeyObjectValueXacbdbeaf,
        ) {
