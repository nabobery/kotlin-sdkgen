...
public sealed class InlineAccountCapabilitiesSepaDebitPaymentsX2c568d4f {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineAccountCapabilitiesSepaDebitPaymentsX2c568d4f =
            when (value) {
                Active.value -> Active
    ...
    public object Serializer : KSerializer<InlineAccountCapabilitiesSepaDebitPaymentsX2c568d4f> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineAccountCapabilitiesSepaDebitPaymentsX2c568d4f",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineAccountCapabilitiesSepaDebitPaymentsX2c568d4f =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineAccountCapabilitiesSepaDebitPaymentsX2c568d4f,
        ) {
