...
public class InlineV1PaymentMethodConfigurationsPostRequestFormCashappX3e557dd5(
    public val displayPreference: InlineV1PaymentMethodConfidc49PostRequestFormCashappDisplayPreferenceXe7679c87? = null,
) {
    public class Builder {
        public var displayPreference:
            InlineV1PaymentMethodConfidc49PostRequestFormCashappDisplayPreferenceXe7679c87? = null

        public fun build(): InlineV1PaymentMethodConfigurationsPostRequestFormCashappX3e557dd5 =
            InlineV1PaymentMethodConfigurationsPostRequestFormCashappX3e557dd5(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentMethodConfigurationsPostRequestFormCashappX3e557dd5 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1PaymentMethodConfigurationsPostRequestFormCashappX3e557dd5> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentMethodConfigurationsPostRequestFormCashappX3e557dd5 must be a JSON object",
                    )
            return InlineV1PaymentMethodConfigurationsPostRequestFormCashappX3e557dd5(
                displayPreference =
                    rawObject["display_preference"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentMethodConfidc49PostRequestFormCashappDisplayPreferenceXe7679c87>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentMethodConfigurationsPostRequestFormCashappX3e557dd5,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentMethodConfigurationsPostRequestFormCashappX3e557dd5(
    block: InlineV1PaymentMethodConfigurationsPostRequestFormCashappX3e557dd5.Builder.() -> Unit,
): InlineV1PaymentMethodConfigurationsPostRequestFormCashappX3e557dd5 =
