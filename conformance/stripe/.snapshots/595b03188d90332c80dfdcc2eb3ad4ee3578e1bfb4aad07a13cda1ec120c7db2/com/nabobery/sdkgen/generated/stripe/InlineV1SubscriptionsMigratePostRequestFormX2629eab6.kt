...
public class InlineV1SubscriptionsMigratePostRequestFormX2629eab6(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1SubscriptionsMigratePostRequestFormX2629eab6 =
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionsMigratePostRequestFormX2629eab6> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SubscriptionsMigratePostRequestFormX2629eab6 must be a JSON object",
                    )
            val billingMode =
                json.decodeRequired<InlineV1SubscriptionsMigratePostRequestFormBillingModeX61ce8d93>(
                    rawObject,
                    "billing_mode",
                )
            return InlineV1SubscriptionsMigratePostRequestFormX2629eab6(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsMigratePostRequestFormX2629eab6,
        ) {
...
public fun inlineV1SubscriptionsMigratePostRequestFormX2629eab6(
    block: InlineV1SubscriptionsMigratePostRequestFormX2629eab6.Builder.() -> Unit,
): InlineV1SubscriptionsMigratePostRequestFormX2629eab6 =
    InlineV1SubscriptionsMigratePostRequestFormX2629eab6.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1SubscriptionsMigratePostRequestFormX2629eab6 is missing required property '" + name + "'",
            )
