...
public class InlineInvoiceDefaultPaymentMethodX0987464e internal constructor(
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineInvoiceDefaultPaymentMethodX0987464e {
            val inspection = inspectInlineInvoiceDefaultPaymentMethodX0987464e(raw)
            if (inspection.matchCount == 0) {
                throw InlineInvoiceDefaultPaymentMethodX0987464eNoMatchException(
                    "InlineInvoiceDefaultPaymentMethodX0987464e matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineInvoiceDefaultPaymentMethodX0987464e> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineInvoiceDefaultPaymentMethodX0987464e,
        ) {
...
private fun inspectInlineInvoiceDefaultPaymentMethodX0987464e(
    element: JsonElement,
): InlineInvoiceDefaultPaymentMethodX0987464eInspection {
