...
public sealed class InlineV1PaymentIntentsPostRequestFormTransactionPurposeXfb93bf47 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1PaymentIntentsPostRequestFormTransactionPurposeXfb93bf47 =
            when (value) {
                Value.value -> Value
                Goods.value -> Goods
                Other.value -> Other
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormTransactionPurposeXfb93bf47> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1PaymentIntentsPostRequestFormTransactionPurposeXfb93bf47",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1PaymentIntentsPostRequestFormTransactionPurposeXfb93bf47 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormTransactionPurposeXfb93bf47,
        ) {
