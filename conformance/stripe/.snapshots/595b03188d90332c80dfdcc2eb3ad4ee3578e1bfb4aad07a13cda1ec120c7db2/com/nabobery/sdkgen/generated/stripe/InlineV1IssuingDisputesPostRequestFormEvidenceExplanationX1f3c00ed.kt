...
internal data class InlineV1IssuingDisputesPostRequestFormEvidenceExplanationX1f3c00edInspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2X5e3724ea,
            ).count { it }
}
...
public class InlineV1IssuingDisputesPostRequestFormEvidenceExplanationX1f3c00ed internal constructor(
    ...
    private val inspection: InlineV1IssuingDisputesPostRequestFormEvidenceExplanationX1f3c00edInspection,
) {
    ...
    public val inlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2X5e3724ea:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2X5e3724ea) {
                json
                    .decodeFromJsonElement<InlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2X5e3724ea>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1IssuingDisputesPostRequestFormEvidenceExplanationX1f3c00edBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2X5e3724ea) {
                    add(
                        InlineV1IssuingDisputesPostRequestFormEvidenceExplanationX1f3c00edBranch.InlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2X5e3724ea,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1IssuingDisputesPostRequestFormEvidenceExplanationX1f3c00ed {
            val inspection = inspectInlineV1IssuingDisputesPostRequestFormEvidenceExplanationX1f3c00ed(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1IssuingDisputesPostRequestFormEvidenceExplanationX1f3c00edNoMatchException(
                    "InlineV1IssuingDisputesPostRequestFormEvidenceExplanationX1f3c00ed matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1IssuingDisputesPostRequestFormEvidenceExplanationX1f3c00ed> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingDisputesPostRequestFormEvidenceExplanationX1f3c00ed,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1IssuingDisputesPostRequestFormEvidenceExplanationX1f3c00ed",
...
private fun inspectInlineV1IssuingDisputesPostRequestFormEvidenceExplanationX1f3c00ed(
    element: JsonElement,
): InlineV1IssuingDisputesPostRequestFormEvidenceExplanationX1f3c00edInspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2X5e3724ea =
        element
            .isJsonDecodable<InlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2X5e3724ea>()
    return InlineV1IssuingDisputesPostRequestFormEvidenceExplanationX1f3c00edInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2X5e3724ea) {
                    add(
                        "InlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2X5e3724ea: value does not match InlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2X5e3724ea",
                    )
                }
            },
    )
