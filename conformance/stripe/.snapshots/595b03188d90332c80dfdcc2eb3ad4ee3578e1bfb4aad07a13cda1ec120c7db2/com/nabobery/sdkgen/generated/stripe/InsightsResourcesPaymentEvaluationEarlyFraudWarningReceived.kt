...
public class InsightsResourcesPaymentEvaluationEarlyFraudWarningReceived(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InsightsResourcesPaymentEvaluationEarlyFraudWarningReceived =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InsightsResourcesPaymentEvaluationEarlyFraudWarningReceived> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InsightsResourcesPaymentEvaluationEarlyFraudWarningReceived must be a JSON object",
                    )
            val fraudType =
                json.decodeRequired<InlineInsightsResourcesPay340aFraudTypeX7e796c46>(
                    rawObject,
                    "fraud_type",
                )
            return InsightsResourcesPaymentEvaluationEarlyFraudWarningReceived(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InsightsResourcesPaymentEvaluationEarlyFraudWarningReceived,
        ) {
...
public fun insightsResourcesPaymentEvaluationEarlyFraudWarningReceived(
    block: InsightsResourcesPaymentEvaluationEarlyFraudWarningReceived.Builder.() -> Unit,
): InsightsResourcesPaymentEvaluationEarlyFraudWarningReceived =
    InsightsResourcesPaymentEvaluationEarlyFraudWarningReceived.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InsightsResourcesPaymentEvaluationEarlyFraudWarningReceived is missing required property '" + name +
                    "'",
            )
