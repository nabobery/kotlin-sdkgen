...
public class InlineCustomerBalanceResou7c01BalanceTransactionX245622a8 internal constructor(
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineCustomerBalanceResou7c01BalanceTransactionX245622a8Branch.Branch1,
                    )
                }
                if (inspection.matchesBalanceTransaction) {
                    add(
                        InlineCustomerBalanceResou7c01BalanceTransactionX245622a8Branch.BalanceTransaction,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineCustomerBalanceResou7c01BalanceTransactionX245622a8 {
            val inspection = inspectInlineCustomerBalanceResou7c01BalanceTransactionX245622a8(raw)
            if (inspection.matchCount == 0) {
                throw InlineCustomerBalanceResou7c01BalanceTransactionX245622a8NoMatchException(
                    "InlineCustomerBalanceResou7c01BalanceTransactionX245622a8 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineCustomerBalanceResou7c01BalanceTransactionX245622a8> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineCustomerBalanceResou7c01BalanceTransactionX245622a8,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineCustomerBalanceResou7c01BalanceTransactionX245622a8",
...
private fun inspectInlineCustomerBalanceResou7c01BalanceTransactionX245622a8(
    element: JsonElement,
): InlineCustomerBalanceResou7c01BalanceTransactionX245622a8Inspection {
