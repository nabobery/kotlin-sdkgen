...
public class AccountUnificationAccountController(
     ...
     */
    public val requirementCollection: InlineAccountUnificationAccountControllerRequirementCollectionX2d9f4777? = null,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): AccountUnificationAccountController =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<AccountUnificationAccountController> {
        ...
        override fun deserialize(decoder: Decoder): AccountUnificationAccountController {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("AccountUnificationAccountController must be a JSON object")
            val type = json.decodeRequired<InlineAccountUnificationAccountControllerTypeXb22b053e>(rawObject, "type")
            return AccountUnificationAccountController(
                type = type,
                fees =
                    rawObject["fees"]?.let {
                        json.decodeFromJsonElement<AccountUnificationAccountControllerFees>(
                            it,
                        )
                    },
                ...
                losses =
                    rawObject["losses"]?.let {
                        json
                            .decodeFromJsonElement<AccountUnificationAccountControllerLosses>(
                                it,
                            )
                    },
                requirementCollection =
                    rawObject["requirement_collection"]?.let {
                        json
                            .decodeFromJsonElement<InlineAccountUnificationAccountControllerRequirementCollectionX2d9f4777>(
                                it,
                            )
                    },
                stripeDashboard =
                    rawObject["stripe_dashboard"]?.let {
                        json.decodeFromJsonElement<AccountUnificationAccountControllerStripeDashboard>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: AccountUnificationAccountController,
        ) {
...
public fun accountUnificationAccountController(
    block: AccountUnificationAccountController.Builder.() -> Unit,
): AccountUnificationAccountController = AccountUnificationAccountController.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "AccountUnificationAccountController is missing required property '" + name + "'",
            )
