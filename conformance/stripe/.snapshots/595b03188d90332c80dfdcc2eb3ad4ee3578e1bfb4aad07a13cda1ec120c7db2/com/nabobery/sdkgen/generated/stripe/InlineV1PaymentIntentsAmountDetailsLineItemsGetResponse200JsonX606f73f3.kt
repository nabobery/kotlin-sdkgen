...
public class InlineV1PaymentIntentsAmountDetailsLineItemsGetResponse200JsonX606f73f3(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentIntentsAmountDetailsLineItemsGetResponse200JsonX606f73f3 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentIntentsAmountDetailsLineItemsGetResponse200JsonX606f73f3> {
        override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1PaymentIntentsAmountDetailsLineItemsGetResponse200JsonX606f73f3 {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsAmountDetailsLineItemsGetResponse200JsonX606f73f3 must be a JSON object",
                    )
            ...
            val objectValue =
                json.decodeRequired<InlineV1PaymentIntentsAmou90b6GetResponse200JsonObjectValueXcf6c195b>(
                    rawObject,
                    "object",
                )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsAmountDetailsLineItemsGetResponse200JsonX606f73f3,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentIntentsAmountDetailsLineItemsGetResponse200JsonX606f73f3(
    block: InlineV1PaymentIntentsAmountDetailsLineItemsGetResponse200JsonX606f73f3.Builder.() -> Unit,
): InlineV1PaymentIntentsAmountDetailsLineItemsGetResponse200JsonX606f73f3 =
    InlineV1PaymentIntentsAmountDetailsLineItemsGetResponse200JsonX606f73f3.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentIntentsAmountDetailsLineItemsGetResponse200JsonX606f73f3 is missing required property '" +
                    name +
                    "'",
            )
