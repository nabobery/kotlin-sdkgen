...
internal data class InlineV1BillingPortalConfigurationsPostRequestFormNameX1352debbInspection(
    ...
    public val matchCount: Int
        get() =
            listOf(matchesBranch1, matchesInlineV1BillingPortalConfigurationsPostRequestFormNameAnyOf2X4450d7d7).count {
                it
            }
}
...
public class InlineV1BillingPortalConfigurationsPostRequestFormNameX1352debb internal constructor(
    ...
    public val inlineV1BillingPortalConfigurationsPostRequestFormNameAnyOf2X4450d7d7:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1BillingPortalConfigurationsPostRequestFormNameAnyOf2X4450d7d7) {
                json
                    .decodeFromJsonElement<InlineV1BillingPortalConfigurationsPostRequestFormNameAnyOf2X4450d7d7>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1BillingPortalConfigurationsPostRequestFormNameX1352debbBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1BillingPortalConfigurationsPostRequestFormNameAnyOf2X4450d7d7) {
                    add(
                        InlineV1BillingPortalConfigurationsPostRequestFormNameX1352debbBranch.InlineV1BillingPortalConfigurationsPostRequestFormNameAnyOf2X4450d7d7,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1BillingPortalConfigurationsPostRequestFormNameX1352debb {
            val inspection = inspectInlineV1BillingPortalConfigurationsPostRequestFormNameX1352debb(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1BillingPortalConfigurationsPostRequestFormNameX1352debbNoMatchException(
                    "InlineV1BillingPortalConfigurationsPostRequestFormNameX1352debb matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1BillingPortalConfigurationsPostRequestFormNameX1352debb> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1BillingPortalConfigurationsPostRequestFormNameX1352debb,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1BillingPortalConfigurationsPostRequestFormNameX1352debb",
...
private fun inspectInlineV1BillingPortalConfigurationsPostRequestFormNameX1352debb(
    element: JsonElement,
): InlineV1BillingPortalConfigurationsPostRequestFormNameX1352debbInspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1BillingPortalConfigurationsPostRequestFormNameAnyOf2X4450d7d7 =
        element
            .isJsonDecodable<InlineV1BillingPortalConfigurationsPostRequestFormNameAnyOf2X4450d7d7>()
    return InlineV1BillingPortalConfigurationsPostRequestFormNameX1352debbInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1BillingPortalConfigurationsPostRequestFormNameAnyOf2X4450d7d7) {
                    add(
                        "InlineV1BillingPortalConfigurationsPostRequestFormNameAnyOf2X4450d7d7: value does not match InlineV1BillingPortalConfigurationsPostRequestFormNameAnyOf2X4450d7d7",
                    )
                }
            },
    )
