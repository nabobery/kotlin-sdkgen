...
public sealed class InlineV1TerminalReadersGetParameterX71ea6570 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1TerminalReadersGetParameterX71ea6570 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1TerminalReadersGetParameterX71ea6570> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1TerminalReadersGetParameterX71ea6570",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1TerminalReadersGetParameterX71ea6570 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TerminalReadersGetParameterX71ea6570,
        ) {
