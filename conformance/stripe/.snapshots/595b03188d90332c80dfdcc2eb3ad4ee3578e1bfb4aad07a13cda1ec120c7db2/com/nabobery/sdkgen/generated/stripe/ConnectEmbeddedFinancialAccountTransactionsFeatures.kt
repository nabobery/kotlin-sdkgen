...
public class ConnectEmbeddedFinancialAccountTransactionsFeatures(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): ConnectEmbeddedFinancialAccountTransactionsFeatures =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<ConnectEmbeddedFinancialAccountTransactionsFeatures> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "ConnectEmbeddedFinancialAccountTransactionsFeatures must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: ConnectEmbeddedFinancialAccountTransactionsFeatures,
        ) {
...
public fun connectEmbeddedFinancialAccountTransactionsFeatures(
    block: ConnectEmbeddedFinancialAccountTransactionsFeatures.Builder.() -> Unit,
): ConnectEmbeddedFinancialAccountTransactionsFeatures =
    ConnectEmbeddedFinancialAccountTransactionsFeatures.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "ConnectEmbeddedFinancialAccountTransactionsFeatures is missing required property '" + name + "'",
            )
