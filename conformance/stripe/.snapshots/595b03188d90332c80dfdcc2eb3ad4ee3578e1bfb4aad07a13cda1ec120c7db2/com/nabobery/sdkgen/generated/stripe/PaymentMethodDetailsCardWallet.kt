...
public class PaymentMethodDetailsCardWallet(
    ...
    public object Serializer : KSerializer<PaymentMethodDetailsCardWallet> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodDetailsCardWallet {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodDetailsCardWallet must be a JSON object")
            ...
            return PaymentMethodDetailsCardWallet(
                ...
                masterpass =
                    rawObject["masterpass"]?.let {
                        json
                            .decodeFromJsonElement<PaymentMethodDetailsCardWalletMasterpass>(
                                it,
                            )
                    },
                ...
                visaCheckout =
                    rawObject["visa_checkout"]?.let {
                        json.decodeFromJsonElement<PaymentMethodDetailsCardWalletVisaCheckout>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentMethodDetailsCardWallet,
        ) {
...
public fun paymentMethodDetailsCardWallet(
    block: PaymentMethodDetailsCardWallet.Builder.() -> Unit,
): PaymentMethodDetailsCardWallet = PaymentMethodDetailsCardWallet.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "PaymentMethodDetailsCardWallet is missing required property '" + name + "'",
            )
