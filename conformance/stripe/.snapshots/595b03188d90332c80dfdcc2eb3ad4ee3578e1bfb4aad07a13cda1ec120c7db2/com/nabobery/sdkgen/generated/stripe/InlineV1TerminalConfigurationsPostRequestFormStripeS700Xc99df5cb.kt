...
public class InlineV1TerminalConfigurationsPostRequestFormStripeS700Xc99df5cb(
    public val splashscreen: InlineV1TerminalConfigurationsPostRequestFormStripeS700SplashscreenX91e022dd? = null,
) {
    public class Builder {
        public var splashscreen:
            InlineV1TerminalConfigurationsPostRequestFormStripeS700SplashscreenX91e022dd? = null

        public fun build(): InlineV1TerminalConfigurationsPostRequestFormStripeS700Xc99df5cb =
            InlineV1TerminalConfigurationsPostRequestFormStripeS700Xc99df5cb(
                splashscreen = splashscreen,
            )
    }

    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TerminalConfigurationsPostRequestFormStripeS700Xc99df5cb =
    ...
    public object Serializer : KSerializer<InlineV1TerminalConfigurationsPostRequestFormStripeS700Xc99df5cb> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TerminalConfigurationsPostRequestFormStripeS700Xc99df5cb must be a JSON object",
                    )
            return InlineV1TerminalConfigurationsPostRequestFormStripeS700Xc99df5cb(
                splashscreen =
                    rawObject["splashscreen"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormStripeS700SplashscreenX91e022dd>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TerminalConfigurationsPostRequestFormStripeS700Xc99df5cb,
        ) {
            val jsonEncoder =
...
public fun inlineV1TerminalConfigurationsPostRequestFormStripeS700Xc99df5cb(
    block: InlineV1TerminalConfigurationsPostRequestFormStripeS700Xc99df5cb.Builder.() -> Unit,
): InlineV1TerminalConfigurationsPostRequestFormStripeS700Xc99df5cb =
