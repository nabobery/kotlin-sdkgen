...
public sealed class InlineV1CheckoutSessionsPostRequestFormModeX4d491c23 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1CheckoutSessionsPostRequestFormModeX4d491c23 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormModeX4d491c23> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1CheckoutSessionsPostRequestFormModeX4d491c23",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1CheckoutSessionsPostRequestFormModeX4d491c23 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsPostRequestFormModeX4d491c23,
        ) {
