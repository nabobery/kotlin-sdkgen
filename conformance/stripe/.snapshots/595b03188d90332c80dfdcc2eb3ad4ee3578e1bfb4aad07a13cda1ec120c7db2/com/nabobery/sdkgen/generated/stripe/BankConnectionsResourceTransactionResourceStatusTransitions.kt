...
public class BankConnectionsResourceTransactionResourceStatusTransitions(
    ...
    public class Builder {
        ...
        public fun build(): BankConnectionsResourceTransactionResourceStatusTransitions =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): BankConnectionsResourceTransactionResourceStatusTransitions =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<BankConnectionsResourceTransactionResourceStatusTransitions> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "BankConnectionsResourceTransactionResourceStatusTransitions must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: BankConnectionsResourceTransactionResourceStatusTransitions,
        ) {
...
public fun bankConnectionsResourceTransactionResourceStatusTransitions(
    block: BankConnectionsResourceTransactionResourceStatusTransitions.Builder.() -> Unit,
): BankConnectionsResourceTransactionResourceStatusTransitions =
    BankConnectionsResourceTransactionResourceStatusTransitions.build(block)
