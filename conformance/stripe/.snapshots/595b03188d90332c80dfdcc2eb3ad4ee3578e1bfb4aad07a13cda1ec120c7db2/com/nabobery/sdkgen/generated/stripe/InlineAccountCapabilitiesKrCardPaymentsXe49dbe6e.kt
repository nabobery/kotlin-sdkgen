...
public sealed class InlineAccountCapabilitiesKrCardPaymentsXe49dbe6e {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineAccountCapabilitiesKrCardPaymentsXe49dbe6e =
            when (value) {
                Active.value -> Active
    ...
    public object Serializer : KSerializer<InlineAccountCapabilitiesKrCardPaymentsXe49dbe6e> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineAccountCapabilitiesKrCardPaymentsXe49dbe6e",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineAccountCapabilitiesKrCardPaymentsXe49dbe6e =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineAccountCapabilitiesKrCardPaymentsXe49dbe6e,
        ) {
