...
public class PaymentIntentNextActionKonbiniMinistop(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentIntentNextActionKonbiniMinistop =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentIntentNextActionKonbiniMinistop> {
        ...
        override fun deserialize(decoder: Decoder): PaymentIntentNextActionKonbiniMinistop {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentIntentNextActionKonbiniMinistop must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentIntentNextActionKonbiniMinistop,
        ) {
...
public fun paymentIntentNextActionKonbiniMinistop(
    block: PaymentIntentNextActionKonbiniMinistop.Builder.() -> Unit,
): PaymentIntentNextActionKonbiniMinistop = PaymentIntentNextActionKonbiniMinistop.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "PaymentIntentNextActionKonbiniMinistop is missing required property '" + name + "'",
            )
