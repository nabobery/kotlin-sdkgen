        ...
        override fun deserialize(decoder: Decoder): PortalInvoiceList {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PortalInvoiceList must be a JSON object")
...
public fun portalInvoiceList(block: PortalInvoiceList.Builder.() -> Unit): PortalInvoiceList =
    PortalInvoiceList.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("PortalInvoiceList is missing required property '" + name + "'")
