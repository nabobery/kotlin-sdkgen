...
public class InlineV1SetupIntentsConfirmPostRequestFormMandateDataAnyOf1OnlineXfe8d164f(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1SetupIntentsConfirmPostRequestFormMandateDataAnyOf1OnlineXfe8d164f = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1SetupIntentsConfirmPostRequestFormMandateDataAnyOf1OnlineXfe8d164f> {
        override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1SetupIntentsConfirmPostRequestFormMandateDataAnyOf1OnlineXfe8d164f {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SetupIntentsConfirmPostRequestFormMandateDataAnyOf1OnlineXfe8d164f must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SetupIntentsConfirmPostRequestFormMandateDataAnyOf1OnlineXfe8d164f,
        ) {
            val jsonEncoder =
...
public fun inlineV1SetupIntentsConfirmPostRequestFormMandateDataAnyOf1OnlineXfe8d164f(
    block: InlineV1SetupIntentsConfirmPostRequestFormMandateDataAnyOf1OnlineXfe8d164f.Builder.() -> Unit,
): InlineV1SetupIntentsConfirmPostRequestFormMandateDataAnyOf1OnlineXfe8d164f =
    InlineV1SetupIntentsConfirmPostRequestFormMandateDataAnyOf1OnlineXfe8d164f.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1SetupIntentsConfirmPostRequestFormMandateDataAnyOf1OnlineXfe8d164f is missing required property '" +
                    name +
                    "'",
            )
