...
public class InlineV1CouponsPostRequestFormX8a95aa20(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1CouponsPostRequestFormX8a95aa20 =
            InlineV1CouponsPostRequestFormX8a95aa20(
                amountOff = amountOff,
                appliesTo = appliesTo,
                currency = currency,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1CouponsPostRequestFormX8a95aa20 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1CouponsPostRequestFormX8a95aa20> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1CouponsPostRequestFormX8a95aa20 {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("InlineV1CouponsPostRequestFormX8a95aa20 must be a JSON object")
            return InlineV1CouponsPostRequestFormX8a95aa20(
                ...
                appliesTo =
                    rawObject["applies_to"]?.let {
                        json.decodeFromJsonElement<InlineV1CouponsPostRequestFormAppliesToXceb8e268>(it)
                    },
                currency = rawObject["currency"]?.let { json.decodeFromJsonElement<String>(it) },
                currencyOptions =
                    rawObject["currency_options"]?.let {
                        json
                            .decodeFromJsonElement<Map<String, InlineV1CouponsPostRequestFormCurrencyOptionsAdditionalValueX719f8505>>(
                                it,
                            )
                    },
                duration =
                    rawObject["duration"]?.let {
                        json.decodeFromJsonElement<InlineV1CouponsPostRequestFormDurationX79d6e553>(it)
                    },
                ...
                metadata =
                    rawObject["metadata"]?.let {
                        json.decodeFromJsonElement<InlineV1CouponsPostRequestFormMetadataX20a6c349>(it)
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CouponsPostRequestFormX8a95aa20,
        ) {
...
public fun inlineV1CouponsPostRequestFormX8a95aa20(
    block: InlineV1CouponsPostRequestFormX8a95aa20.Builder.() -> Unit,
): InlineV1CouponsPostRequestFormX8a95aa20 = InlineV1CouponsPostRequestFormX8a95aa20.build(block)
