...
public class InlineV1PaymentIntentsPostRequestFormPaymentMethodDataNzBankAccountXccf4ebef(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentIntentsPostRequestFormPaymentMethodDataNzBankAccountXccf4ebef = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormPaymentMethodDataNzBankAccountXccf4ebef> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsPostRequestFormPaymentMethodDataNzBankAccountXccf4ebef must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormPaymentMethodDataNzBankAccountXccf4ebef,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentIntentsPostRequestFormPaymentMethodDataNzBankAccountXccf4ebef(
    block: InlineV1PaymentIntentsPostRequestFormPaymentMethodDataNzBankAccountXccf4ebef.Builder.() -> Unit,
): InlineV1PaymentIntentsPostRequestFormPaymentMethodDataNzBankAccountXccf4ebef =
    InlineV1PaymentIntentsPostRequestFormPaymentMethodDataNzBankAccountXccf4ebef.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentIntentsPostRequestFormPaymentMethodDataNzBankAccountXccf4ebef is missing required property '" +
                    name +
                    "'",
            )
