...
public class InlineV1TestHelpersIssuingSettlementsPostRequestFormXa1655236(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TestHelpersIssuingSettlementsPostRequestFormXa1655236 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TestHelpersIssuingSettlementsPostRequestFormXa1655236> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1TestHelpersIssuingSettlementsPostRequestFormXa1655236 {
            val jsonDecoder =
                decoder.requireJsonDecoder(
                    "InlineV1TestHelpersIssuingSettlementsPostRequestFormXa1655236",
                )
            val json = jsonDecoder.json
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TestHelpersIssuingSettlementsPostRequestFormXa1655236 must be a JSON object",
                    )
            ...
            return InlineV1TestHelpersIssuingSettlementsPostRequestFormXa1655236(
                ...
                interchangeFeesAmount =
                    rawObject["interchange_fees_amount"]?.let {
                ...
                network =
                    rawObject["network"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TestHelpersIssuingSettlementsPostRequestFormNetworkX8a7c657d>(
                                it,
                            )
                    },
                networkSettlementIdentifier =
                    rawObject["network_settlement_identifier"]?.let {
                        json.decodeFromJsonElement<String>(it)
                    },
                transactionAmount =
                    rawObject["transaction_amount"]?.let {
                        json.decodeFromJsonElement<Int>(
                            it,
                        )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TestHelpersIssuingSettlementsPostRequestFormXa1655236,
        ) {
            val jsonEncoder =
...
public fun inlineV1TestHelpersIssuingSettlementsPostRequestFormXa1655236(
    block: InlineV1TestHelpersIssuingSettlementsPostRequestFormXa1655236.Builder.() -> Unit,
): InlineV1TestHelpersIssuingSettlementsPostRequestFormXa1655236 =
    InlineV1TestHelpersIssuingSettlementsPostRequestFormXa1655236.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TestHelpersIssuingSettlementsPostRequestFormXa1655236 is missing required property '" + name +
                    "'",
            )
