...
public sealed class InlineV1PaymentIntentsConfirmPostRequestFormIntervalX3d3eb2fc {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1PaymentIntentsConfirmPostRequestFormIntervalX3d3eb2fc =
            when (value) {
                Day.value -> Day
                Month.value -> Month
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsConfirmPostRequestFormIntervalX3d3eb2fc> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1PaymentIntentsConfirmPostRequestFormIntervalX3d3eb2fc",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1PaymentIntentsConfirmPostRequestFormIntervalX3d3eb2fc =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsConfirmPostRequestFormIntervalX3d3eb2fc,
        ) {
