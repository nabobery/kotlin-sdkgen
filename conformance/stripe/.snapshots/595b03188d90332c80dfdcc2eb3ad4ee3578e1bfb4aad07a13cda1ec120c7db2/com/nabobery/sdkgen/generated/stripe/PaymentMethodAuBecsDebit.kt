...
public class PaymentMethodAuBecsDebit(
    ...
    public class Builder {
        ...
        public fun build(): PaymentMethodAuBecsDebit =
    ...
    public object Serializer : KSerializer<PaymentMethodAuBecsDebit> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodAuBecsDebit {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodAuBecsDebit must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentMethodAuBecsDebit,
        ) {
...
public fun paymentMethodAuBecsDebit(block: PaymentMethodAuBecsDebit.Builder.() -> Unit): PaymentMethodAuBecsDebit =
    PaymentMethodAuBecsDebit.build(block)
