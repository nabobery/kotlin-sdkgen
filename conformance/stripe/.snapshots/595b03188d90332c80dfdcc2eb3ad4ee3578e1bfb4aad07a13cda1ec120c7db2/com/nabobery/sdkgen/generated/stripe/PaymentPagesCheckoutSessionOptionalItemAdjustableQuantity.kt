...
public class PaymentPagesCheckoutSessionOptionalItemAdjustableQuantity(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentPagesCheckoutSessionOptionalItemAdjustableQuantity =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentPagesCheckoutSessionOptionalItemAdjustableQuantity> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "PaymentPagesCheckoutSessionOptionalItemAdjustableQuantity must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentPagesCheckoutSessionOptionalItemAdjustableQuantity,
        ) {
...
public fun paymentPagesCheckoutSessionOptionalItemAdjustableQuantity(
    block: PaymentPagesCheckoutSessionOptionalItemAdjustableQuantity.Builder.() -> Unit,
): PaymentPagesCheckoutSessionOptionalItemAdjustableQuantity =
    PaymentPagesCheckoutSessionOptionalItemAdjustableQuantity.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "PaymentPagesCheckoutSessionOptionalItemAdjustableQuantity is missing required property '" + name + "'",
            )
