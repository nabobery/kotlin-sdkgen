...
internal data class InlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsOnBehalfOfX63a18718Inspection(
    ...
    public val matchesInlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsAnyOf2X80802d9f: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsAnyOf2X80802d9f,
            ).count {
                it
            }
}
...
public class InlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsOnBehalfOfX63a18718 internal constructor(
    ...
    private val inspection: InlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsOnBehalfOfX63a18718Inspection,
) {
    ...
    public val inlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsAnyOf2X80802d9f:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsAnyOf2X80802d9f) {
                json
                    .decodeFromJsonElement<InlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsAnyOf2X80802d9f>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsOnBehalfOfX63a18718Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsAnyOf2X80802d9f) {
                    add(
                        InlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsOnBehalfOfX63a18718Branch.InlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsAnyOf2X80802d9f,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsOnBehalfOfX63a18718 {
            val inspection = inspectInlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsOnBehalfOfX63a18718(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsOnBehalfOfX63a18718NoMatchException(
                    "InlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsOnBehalfOfX63a18718 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsOnBehalfOfX63a18718> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsOnBehalfOfX63a18718,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsOnBehalfOfX63a18718",
...
private fun inspectInlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsOnBehalfOfX63a18718(
    element: JsonElement,
): InlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsOnBehalfOfX63a18718Inspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsAnyOf2X80802d9f =
        element
            .isJsonDecodable<InlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsAnyOf2X80802d9f>()
    return InlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsOnBehalfOfX63a18718Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsAnyOf2X80802d9f) {
                    add(
                        "InlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsAnyOf2X80802d9f: value does not match InlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsAnyOf2X80802d9f",
                    )
                }
            },
    )
