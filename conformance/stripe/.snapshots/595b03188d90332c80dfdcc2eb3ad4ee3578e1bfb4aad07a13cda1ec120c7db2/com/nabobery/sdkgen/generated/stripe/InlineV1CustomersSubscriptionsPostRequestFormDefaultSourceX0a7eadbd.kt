...
internal data class InlineV1CustomersSubscriptionsPostRequestFormDefaultSourceX0a7eadbdInspection(
    ...
    public val matchesInlineV1CustomersSubscriptionsPostRequestFormDefaultSourceAnyOf2X80e54ff0: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1CustomersSubscriptionsPostRequestFormDefaultSourceAnyOf2X80e54ff0,
            ).count {
                it
            }
}
...
public class InlineV1CustomersSubscriptionsPostRequestFormDefaultSourceX0a7eadbd internal constructor(
    ...
    private val inspection: InlineV1CustomersSubscriptionsPostRequestFormDefaultSourceX0a7eadbdInspection,
) {
    ...
    public val inlineV1CustomersSubscriptionsPostRequestFormDefaultSourceAnyOf2X80e54ff0:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1CustomersSubscriptionsPostRequestFormDefaultSourceAnyOf2X80e54ff0) {
                json
                    .decodeFromJsonElement<InlineV1CustomersSubscriptionsPostRequestFormDefaultSourceAnyOf2X80e54ff0>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1CustomersSubscriptionsPostRequestFormDefaultSourceX0a7eadbdBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1CustomersSubscriptionsPostRequestFormDefaultSourceAnyOf2X80e54ff0) {
                    add(
                        InlineV1CustomersSubscriptionsPostRequestFormDefaultSourceX0a7eadbdBranch.InlineV1CustomersSubscriptionsPostRequestFormDefaultSourceAnyOf2X80e54ff0,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1CustomersSubscriptionsPostRequestFormDefaultSourceX0a7eadbd {
            val inspection = inspectInlineV1CustomersSubscriptionsPostRequestFormDefaultSourceX0a7eadbd(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1CustomersSubscriptionsPostRequestFormDefaultSourceX0a7eadbdNoMatchException(
                    "InlineV1CustomersSubscriptionsPostRequestFormDefaultSourceX0a7eadbd matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1CustomersSubscriptionsPostRequestFormDefaultSourceX0a7eadbd> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersSubscriptionsPostRequestFormDefaultSourceX0a7eadbd,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1CustomersSubscriptionsPostRequestFormDefaultSourceX0a7eadbd",
...
private fun inspectInlineV1CustomersSubscriptionsPostRequestFormDefaultSourceX0a7eadbd(
    element: JsonElement,
): InlineV1CustomersSubscriptionsPostRequestFormDefaultSourceX0a7eadbdInspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1CustomersSubscriptionsPostRequestFormDefaultSourceAnyOf2X80e54ff0 =
        element
            .isJsonDecodable<InlineV1CustomersSubscriptionsPostRequestFormDefaultSourceAnyOf2X80e54ff0>()
    return InlineV1CustomersSubscriptionsPostRequestFormDefaultSourceX0a7eadbdInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1CustomersSubscriptionsPostRequestFormDefaultSourceAnyOf2X80e54ff0) {
                    add(
                        "InlineV1CustomersSubscriptionsPostRequestFormDefaultSourceAnyOf2X80e54ff0: value does not match InlineV1CustomersSubscriptionsPostRequestFormDefaultSourceAnyOf2X80e54ff0",
                    )
                }
            },
    )
