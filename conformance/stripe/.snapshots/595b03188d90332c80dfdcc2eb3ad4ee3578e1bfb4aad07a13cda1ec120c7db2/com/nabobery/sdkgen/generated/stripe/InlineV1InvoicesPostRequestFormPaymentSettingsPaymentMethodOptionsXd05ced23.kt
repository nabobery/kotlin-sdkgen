...
public class InlineV1InvoicesPostRequestFormPaymentSettingsPaymentMethodOptionsXd05ced23(
    ...
    public val card: InlineV1InvoicesPostRequestFormPaymentSettingsPaymentMethodOptionsCardX34294038? = null,
    public val customerBalance: InlineV1InvoicesPostRequestFormPaymentSettingsCustomerBalanceX33d85a46? = null,
    public val konbini: InlineV1InvoicesPostRequestFormPaymentSettingsKonbiniX55ca6b41? = null,
    public val payto: InlineV1InvoicesPostRequestFormPaymentSettingsPaymentMethodOptionsPaytoXbb7d38c6? = null,
    public val pix: InlineV1InvoicesPostRequestFormPaymentSettingsPaymentMethodOptionsPixX49f6e512? = null,
    public val sepaDebit: InlineV1InvoicesPostRequestFormPaymentSettingsSepaDebitXe45dd565? = null,
    public val upi: InlineV1InvoicesPostRequestFormPaymentSettingsPaymentMethodOptionsUpiX74f0e331? = null,
    public val usBankAccount: InlineV1InvoicesPostRequestFormPaymentSettingsUsBankAccountXecbb180f? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1InvoicesPostRequestFormPaymentSettingsPaymentMethodOptionsXd05ced23 =
            InlineV1InvoicesPostRequestFormPaymentSettingsPaymentMethodOptionsXd05ced23(
                acssDebit = acssDebit,
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1InvoicesPostRequestFormPaymentSettingsPaymentMethodOptionsXd05ced23 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1InvoicesPostRequestFormPaymentSettingsPaymentMethodOptionsXd05ced23> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1InvoicesPostRequestFormPaymentSettingsPaymentMethodOptionsXd05ced23 must be a JSON object",
                    )
            return InlineV1InvoicesPostRequestFormPaymentSettingsPaymentMethodOptionsXd05ced23(
                acssDebit =
                    rawObject["acss_debit"]?.let {
                        json.decodeFromJsonElement<InlineV1InvoicesPostRequestFormPaymentSettingsAcssDebitX68ff313d>(it)
                    },
                bancontact =
                    rawObject["bancontact"]?.let {
                        json.decodeFromJsonElement<InlineV1InvoicesPostRequestFormPaymentSettingsBancontactX7fad949d>(
                            it,
                        )
                    },
                card =
                    rawObject["card"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1InvoicesPostRequestFormPaymentSettingsPaymentMethodOptionsCardX34294038>(
                                it,
                            )
                    },
                customerBalance =
                    rawObject["customer_balance"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1InvoicesPostRequestFormPaymentSettingsCustomerBalanceX33d85a46>(
                                it,
                            )
                    },
                konbini =
                    rawObject["konbini"]?.let {
                        json.decodeFromJsonElement<InlineV1InvoicesPostRequestFormPaymentSettingsKonbiniX55ca6b41>(it)
                    },
                payto =
                    rawObject["payto"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1InvoicesPostRequestFormPaymentSettingsPaymentMethodOptionsPaytoXbb7d38c6>(
                                it,
                            )
                    },
                pix =
                    rawObject["pix"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1InvoicesPostRequestFormPaymentSettingsPaymentMethodOptionsPixX49f6e512>(
                                it,
                            )
                    },
                sepaDebit =
                    rawObject["sepa_debit"]?.let {
                        json.decodeFromJsonElement<InlineV1InvoicesPostRequestFormPaymentSettingsSepaDebitXe45dd565>(it)
                    },
                upi =
                    rawObject["upi"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1InvoicesPostRequestFormPaymentSettingsPaymentMethodOptionsUpiX74f0e331>(
                                it,
                            )
                    },
                usBankAccount =
                    rawObject["us_bank_account"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1InvoicesPostRequestFormPaymentSettingsUsBankAccountXecbb180f>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesPostRequestFormPaymentSettingsPaymentMethodOptionsXd05ced23,
        ) {
            val jsonEncoder =
...
public fun inlineV1InvoicesPostRequestFormPaymentSettingsPaymentMethodOptionsXd05ced23(
    block: InlineV1InvoicesPostRequestFormPaymentSettingsPaymentMethodOptionsXd05ced23.Builder.() -> Unit,
): InlineV1InvoicesPostRequestFormPaymentSettingsPaymentMethodOptionsXd05ced23 =
    InlineV1InvoicesPostRequestFormPaymentSettingsPaymentMethodOptionsXd05ced23.build(block)
