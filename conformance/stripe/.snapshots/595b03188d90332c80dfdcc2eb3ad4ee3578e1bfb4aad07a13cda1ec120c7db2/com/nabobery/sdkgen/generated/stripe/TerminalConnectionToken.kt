...
public class TerminalConnectionToken(
    ...
    public object Serializer : KSerializer<TerminalConnectionToken> {
        ...
        override fun deserialize(decoder: Decoder): TerminalConnectionToken {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("TerminalConnectionToken must be a JSON object")
            val objectValue =
                json.decodeRequired<InlineTerminalConnectionTokenObjectValueX834395da>(
                    rawObject,
                    "object",
                )
...
public fun terminalConnectionToken(block: TerminalConnectionToken.Builder.() -> Unit): TerminalConnectionToken =
    TerminalConnectionToken.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("TerminalConnectionToken is missing required property '" + name + "'")
