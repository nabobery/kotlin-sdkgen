...
public class PaymentMethodDetailsPaymentRecordGiropay(
    ...
    public class Builder {
        ...
        public fun build(): PaymentMethodDetailsPaymentRecordGiropay =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentMethodDetailsPaymentRecordGiropay =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentMethodDetailsPaymentRecordGiropay> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodDetailsPaymentRecordGiropay {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodDetailsPaymentRecordGiropay must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentMethodDetailsPaymentRecordGiropay,
        ) {
...
public fun paymentMethodDetailsPaymentRecordGiropay(
    block: PaymentMethodDetailsPaymentRecordGiropay.Builder.() -> Unit,
): PaymentMethodDetailsPaymentRecordGiropay = PaymentMethodDetailsPaymentRecordGiropay.build(block)
