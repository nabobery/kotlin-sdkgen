...
public class PaymentMethodDetailsBoleto(
    ...
    public object Serializer : KSerializer<PaymentMethodDetailsBoleto> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodDetailsBoleto {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodDetailsBoleto must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentMethodDetailsBoleto,
        ) {
...
public fun paymentMethodDetailsBoleto(
    block: PaymentMethodDetailsBoleto.Builder.() -> Unit,
): PaymentMethodDetailsBoleto = PaymentMethodDetailsBoleto.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException("PaymentMethodDetailsBoleto is missing required property '" + name + "'")
