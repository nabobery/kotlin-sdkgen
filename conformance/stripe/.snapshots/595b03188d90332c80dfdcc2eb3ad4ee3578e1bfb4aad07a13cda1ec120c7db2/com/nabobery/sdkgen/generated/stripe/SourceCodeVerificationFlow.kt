...
public class SourceCodeVerificationFlow(
    ...
    public object Serializer : KSerializer<SourceCodeVerificationFlow> {
        ...
        override fun deserialize(decoder: Decoder): SourceCodeVerificationFlow {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("SourceCodeVerificationFlow must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: SourceCodeVerificationFlow,
        ) {
...
public fun sourceCodeVerificationFlow(
    block: SourceCodeVerificationFlow.Builder.() -> Unit,
): SourceCodeVerificationFlow = SourceCodeVerificationFlow.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException("SourceCodeVerificationFlow is missing required property '" + name + "'")
