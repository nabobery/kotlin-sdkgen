...
public class InsightsResourcesPaymentEvaluationRejected(
    ...
    public class Builder {
        ...
        public fun build(): InsightsResourcesPaymentEvaluationRejected =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InsightsResourcesPaymentEvaluationRejected =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InsightsResourcesPaymentEvaluationRejected> {
        ...
        override fun deserialize(decoder: Decoder): InsightsResourcesPaymentEvaluationRejected {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("InsightsResourcesPaymentEvaluationRejected must be a JSON object")
            return InsightsResourcesPaymentEvaluationRejected(
                card =
                    rawObject["card"]?.let {
                        json.decodeFromJsonElement<InsightsResourcesPaymentEvaluationRejectedCard>(
                            it,
                        )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InsightsResourcesPaymentEvaluationRejected,
        ) {
...
public fun insightsResourcesPaymentEvaluationRejected(
    block: InsightsResourcesPaymentEvaluationRejected.Builder.() -> Unit,
): InsightsResourcesPaymentEvaluationRejected = InsightsResourcesPaymentEvaluationRejected.build(block)
