...
public class InlineV1SetupIntentsPostRequestFormMandateDataAnyOf1CustomerAcceptanceX006ccd1e(
    ...
    public object Serializer : KSerializer<InlineV1SetupIntentsPostRequestFormMandateDataAnyOf1CustomerAcceptanceX006ccd1e> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SetupIntentsPostRequestFormMandateDataAnyOf1CustomerAcceptanceX006ccd1e must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineV1SetupIntentsPostRequestFormMandateDataAnyOf1TypeXfbf01faf>(
                    rawObject,
                    "type",
                )
            return InlineV1SetupIntentsPostRequestFormMandateDataAnyOf1CustomerAcceptanceX006ccd1e(
                ...
                online =
                    rawObject["online"]?.let {
                        json.decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormMandateDataAnyOf1OnlineX0371edbf>(
                            it,
                        )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SetupIntentsPostRequestFormMandateDataAnyOf1CustomerAcceptanceX006ccd1e,
        ) {
            val jsonEncoder =
...
public fun inlineV1SetupIntentsPostRequestFormMandateDataAnyOf1CustomerAcceptanceX006ccd1e(
    block: InlineV1SetupIntentsPostRequestFormMandateDataAnyOf1CustomerAcceptanceX006ccd1e.Builder.() -> Unit,
): InlineV1SetupIntentsPostRequestFormMandateDataAnyOf1CustomerAcceptanceX006ccd1e =
    InlineV1SetupIntentsPostRequestFormMandateDataAnyOf1CustomerAcceptanceX006ccd1e.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1SetupIntentsPostRequestFormMandateDataAnyOf1CustomerAcceptanceX006ccd1e is missing required property '" +
                    name +
                    "'",
            )
