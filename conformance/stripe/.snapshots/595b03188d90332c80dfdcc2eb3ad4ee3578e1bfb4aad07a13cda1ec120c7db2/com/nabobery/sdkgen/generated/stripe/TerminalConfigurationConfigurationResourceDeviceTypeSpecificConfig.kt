...
public class TerminalConfigurationConfigurationResourceDeviceTypeSpecificConfig(
    ...
    public class Builder {
        ...
        public fun build(): TerminalConfigurationConfigurationResourceDeviceTypeSpecificConfig =
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): TerminalConfigurationConfigurationResourceDeviceTypeSpecificConfig = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<TerminalConfigurationConfigurationResourceDeviceTypeSpecificConfig> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "TerminalConfigurationConfigurationResourceDeviceTypeSpecificConfig must be a JSON object",
                    )
            return TerminalConfigurationConfigurationResourceDeviceTypeSpecificConfig(
                splashscreen =
                    rawObject["splashscreen"]?.let {
                        json.decodeFromJsonElement<InlineTerminalConfiguratioda89SplashscreenXf7f69cf8>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: TerminalConfigurationConfigurationResourceDeviceTypeSpecificConfig,
        ) {
            val jsonEncoder =
...
public fun terminalConfigurationConfigurationResourceDeviceTypeSpecificConfig(
    block: TerminalConfigurationConfigurationResourceDeviceTypeSpecificConfig.Builder.() -> Unit,
): TerminalConfigurationConfigurationResourceDeviceTypeSpecificConfig =
    TerminalConfigurationConfigurationResourceDeviceTypeSpecificConfig.build(block)
