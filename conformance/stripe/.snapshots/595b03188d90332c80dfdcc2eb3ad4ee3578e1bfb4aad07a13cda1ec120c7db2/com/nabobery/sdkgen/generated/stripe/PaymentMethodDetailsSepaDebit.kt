...
public class PaymentMethodDetailsSepaDebit(
    ...
    public class Builder {
        ...
        public fun build(): PaymentMethodDetailsSepaDebit =
    ...
    public object Serializer : KSerializer<PaymentMethodDetailsSepaDebit> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodDetailsSepaDebit {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodDetailsSepaDebit must be a JSON object")
            return PaymentMethodDetailsSepaDebit(
                ...
                branchCode =
                    rawObject["branch_code"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentMethodDetailsSepaDebit,
        ) {
...
public fun paymentMethodDetailsSepaDebit(
    block: PaymentMethodDetailsSepaDebit.Builder.() -> Unit,
): PaymentMethodDetailsSepaDebit = PaymentMethodDetailsSepaDebit.build(block)
