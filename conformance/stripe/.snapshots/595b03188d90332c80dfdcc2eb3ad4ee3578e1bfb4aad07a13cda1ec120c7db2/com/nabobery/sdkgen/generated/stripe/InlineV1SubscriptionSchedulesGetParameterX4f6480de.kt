...
public class InlineV1SubscriptionSchedulesGetParameterX4f6480de internal constructor(
    ...
    public val inlineV1SubscriptionSchedulesGetParameterAnyOf1X6c6d3061:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1SubscriptionSchedulesGetParameterAnyOf1X6c6d3061) {
                json
                    .decodeFromJsonElement<InlineV1SubscriptionSchedulesGetParameterAnyOf1X6c6d3061>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1SubscriptionSchedulesGetParameterX4f6480deBranch>
        get() =
            buildSet {
                if (inspection.matchesInlineV1SubscriptionSchedulesGetParameterAnyOf1X6c6d3061) {
                    add(
                        InlineV1SubscriptionSchedulesGetParameterX4f6480deBranch.InlineV1SubscriptionSchedulesGetParameterAnyOf1X6c6d3061,
                    )
                }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1SubscriptionSchedulesGetParameterX4f6480de {
            val inspection = inspectInlineV1SubscriptionSchedulesGetParameterX4f6480de(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1SubscriptionSchedulesGetParameterX4f6480deNoMatchException(
                    "InlineV1SubscriptionSchedulesGetParameterX4f6480de matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionSchedulesGetParameterX4f6480de> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionSchedulesGetParameterX4f6480de,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1SubscriptionSchedulesGetParameterX4f6480de",
...
private fun inspectInlineV1SubscriptionSchedulesGetParameterX4f6480de(
    element: JsonElement,
): InlineV1SubscriptionSchedulesGetParameterX4f6480deInspection {
    val matchesInlineV1SubscriptionSchedulesGetParameterAnyOf1X6c6d3061 =
        element
            .isJsonDecodable<InlineV1SubscriptionSchedulesGetParameterAnyOf1X6c6d3061>()
    ...
    return InlineV1SubscriptionSchedulesGetParameterX4f6480deInspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1SubscriptionSchedulesGetParameterAnyOf1X6c6d3061) {
                    add(
                        "InlineV1SubscriptionSchedulesGetParameterAnyOf1X6c6d3061: value does not match InlineV1SubscriptionSchedulesGetParameterAnyOf1X6c6d3061",
                    )
                }
