...
public class InlineSubscriptionScheduleTestClockX22d9a61a internal constructor(
        ...
        get() =
            buildSet {
                ...
                if (inspection.matchesTestHelpersTestClock) {
                    add(
                        InlineSubscriptionScheduleTestClockX22d9a61aBranch.TestHelpersTestClock,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineSubscriptionScheduleTestClockX22d9a61a {
            val inspection = inspectInlineSubscriptionScheduleTestClockX22d9a61a(raw)
            if (inspection.matchCount == 0) {
                throw InlineSubscriptionScheduleTestClockX22d9a61aNoMatchException(
                    "InlineSubscriptionScheduleTestClockX22d9a61a matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineSubscriptionScheduleTestClockX22d9a61a> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineSubscriptionScheduleTestClockX22d9a61a,
        ) {
...
private fun inspectInlineSubscriptionScheduleTestClockX22d9a61a(
    element: JsonElement,
): InlineSubscriptionScheduleTestClockX22d9a61aInspection {
