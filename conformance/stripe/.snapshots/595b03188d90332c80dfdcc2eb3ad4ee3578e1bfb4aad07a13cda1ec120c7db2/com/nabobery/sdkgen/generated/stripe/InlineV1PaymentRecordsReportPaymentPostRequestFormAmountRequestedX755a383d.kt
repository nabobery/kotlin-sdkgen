...
public class InlineV1PaymentRecordsReportPaymentPostRequestFormAmountRequestedX755a383d(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentRecordsReportPaymentPostRequestFormAmountRequestedX755a383d = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentRecordsReportPaymentPostRequestFormAmountRequestedX755a383d> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentRecordsReportPaymentPostRequestFormAmountRequestedX755a383d must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentRecordsReportPaymentPostRequestFormAmountRequestedX755a383d,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentRecordsReportPaymentPostRequestFormAmountRequestedX755a383d(
    block: InlineV1PaymentRecordsReportPaymentPostRequestFormAmountRequestedX755a383d.Builder.() -> Unit,
): InlineV1PaymentRecordsReportPaymentPostRequestFormAmountRequestedX755a383d =
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentRecordsReportPaymentPostRequestFormAmountRequestedX755a383d is missing required property '" +
                    name +
                    "'",
            )
