...
public sealed class InlineV1PaymentMethodsPostRequestFormEpsBankX3483b847 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1PaymentMethodsPostRequestFormEpsBankX3483b847 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1PaymentMethodsPostRequestFormEpsBankX3483b847> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1PaymentMethodsPostRequestFormEpsBankX3483b847",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1PaymentMethodsPostRequestFormEpsBankX3483b847 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentMethodsPostRequestFormEpsBankX3483b847,
        ) {
