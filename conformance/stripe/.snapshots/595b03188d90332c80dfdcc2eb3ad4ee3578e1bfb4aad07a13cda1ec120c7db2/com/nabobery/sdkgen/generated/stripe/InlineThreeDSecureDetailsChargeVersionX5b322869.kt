...
public sealed class InlineThreeDSecureDetailsChargeVersionX5b322869 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineThreeDSecureDetailsChargeVersionX5b322869 =
            when (value) {
                _102.value -> _102
                _210.value -> _210
                _220.value -> _220
    ...
    public object Serializer : KSerializer<InlineThreeDSecureDetailsChargeVersionX5b322869> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineThreeDSecureDetailsChargeVersionX5b322869",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineThreeDSecureDetailsChargeVersionX5b322869 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineThreeDSecureDetailsChargeVersionX5b322869,
        ) {
