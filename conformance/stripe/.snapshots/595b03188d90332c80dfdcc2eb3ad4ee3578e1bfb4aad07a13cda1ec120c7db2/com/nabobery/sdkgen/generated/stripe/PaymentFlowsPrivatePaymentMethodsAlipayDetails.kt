...
public class PaymentFlowsPrivatePaymentMethodsAlipayDetails(
    ...
    public class Builder {
        ...
        public fun build(): PaymentFlowsPrivatePaymentMethodsAlipayDetails =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentFlowsPrivatePaymentMethodsAlipayDetails =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentFlowsPrivatePaymentMethodsAlipayDetails> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "PaymentFlowsPrivatePaymentMethodsAlipayDetails must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentFlowsPrivatePaymentMethodsAlipayDetails,
        ) {
...
public fun paymentFlowsPrivatePaymentMethodsAlipayDetails(
    block: PaymentFlowsPrivatePaymentMethodsAlipayDetails.Builder.() -> Unit,
): PaymentFlowsPrivatePaymentMethodsAlipayDetails = PaymentFlowsPrivatePaymentMethodsAlipayDetails.build(block)
