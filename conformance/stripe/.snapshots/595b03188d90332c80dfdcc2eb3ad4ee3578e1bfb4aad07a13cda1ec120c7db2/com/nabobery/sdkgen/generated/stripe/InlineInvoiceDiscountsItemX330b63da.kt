...
public class InlineInvoiceDiscountsItemX330b63da internal constructor(
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineInvoiceDiscountsItemX330b63da {
            val inspection = inspectInlineInvoiceDiscountsItemX330b63da(raw)
            if (inspection.matchCount == 0) {
                throw InlineInvoiceDiscountsItemX330b63daNoMatchException(
                    "InlineInvoiceDiscountsItemX330b63da matched 0 branches: " + inspection.failures.joinToString("; "),
                )
            }
    ...
    public object Serializer : KSerializer<InlineInvoiceDiscountsItemX330b63da> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineInvoiceDiscountsItemX330b63da,
        ) {
...
private fun inspectInlineInvoiceDiscountsItemX330b63da(
    element: JsonElement,
): InlineInvoiceDiscountsItemX330b63daInspection {
