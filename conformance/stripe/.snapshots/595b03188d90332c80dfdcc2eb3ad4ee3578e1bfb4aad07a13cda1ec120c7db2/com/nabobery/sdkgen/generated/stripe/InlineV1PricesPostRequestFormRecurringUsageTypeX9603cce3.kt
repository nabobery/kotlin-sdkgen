...
public sealed class InlineV1PricesPostRequestFormRecurringUsageTypeX9603cce3 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1PricesPostRequestFormRecurringUsageTypeX9603cce3 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1PricesPostRequestFormRecurringUsageTypeX9603cce3> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1PricesPostRequestFormRecurringUsageTypeX9603cce3",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1PricesPostRequestFormRecurringUsageTypeX9603cce3 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PricesPostRequestFormRecurringUsageTypeX9603cce3,
        ) {
