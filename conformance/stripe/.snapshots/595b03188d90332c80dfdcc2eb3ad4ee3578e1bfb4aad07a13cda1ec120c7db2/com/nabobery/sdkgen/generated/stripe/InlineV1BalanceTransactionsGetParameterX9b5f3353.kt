...
public class InlineV1BalanceTransactionsGetParameterX9b5f3353 internal constructor(
    ...
    public val inlineV1BalanceTransactionsGetParameterAnyOf1X58908c72:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1BalanceTransactionsGetParameterAnyOf1X58908c72) {
                json
                    .decodeFromJsonElement<InlineV1BalanceTransactionsGetParameterAnyOf1X58908c72>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1BalanceTransactionsGetParameterX9b5f3353Branch>
        get() =
            buildSet {
                if (inspection.matchesInlineV1BalanceTransactionsGetParameterAnyOf1X58908c72) {
                    add(
                        InlineV1BalanceTransactionsGetParameterX9b5f3353Branch.InlineV1BalanceTransactionsGetParameterAnyOf1X58908c72,
                    )
                }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1BalanceTransactionsGetParameterX9b5f3353 {
            val inspection = inspectInlineV1BalanceTransactionsGetParameterX9b5f3353(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1BalanceTransactionsGetParameterX9b5f3353NoMatchException(
                    "InlineV1BalanceTransactionsGetParameterX9b5f3353 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1BalanceTransactionsGetParameterX9b5f3353> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1BalanceTransactionsGetParameterX9b5f3353,
        ) {
...
private fun inspectInlineV1BalanceTransactionsGetParameterX9b5f3353(
    element: JsonElement,
): InlineV1BalanceTransactionsGetParameterX9b5f3353Inspection {
    val matchesInlineV1BalanceTransactionsGetParameterAnyOf1X58908c72 =
        element
            .isJsonDecodable<InlineV1BalanceTransactionsGetParameterAnyOf1X58908c72>()
    ...
    return InlineV1BalanceTransactionsGetParameterX9b5f3353Inspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1BalanceTransactionsGetParameterAnyOf1X58908c72) {
                    add(
                        "InlineV1BalanceTransactionsGetParameterAnyOf1X58908c72: value does not match InlineV1BalanceTransactionsGetParameterAnyOf1X58908c72",
                    )
                }
