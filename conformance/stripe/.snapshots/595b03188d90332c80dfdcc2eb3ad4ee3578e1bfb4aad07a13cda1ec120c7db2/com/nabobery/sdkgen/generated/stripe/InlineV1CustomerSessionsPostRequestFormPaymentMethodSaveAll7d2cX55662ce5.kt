    ...
    public object Serializer : KSerializer<InlineV1CustomerSessionsPostRequestFormPaymentMethodSaveAll7d2cX55662ce5> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1CustomerSessionsPostRequestFormPaymentMethodSaveAll7d2cX55662ce5",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1CustomerSessionsPostRequestFormPaymentMethodSaveAll7d2cX55662ce5 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomerSessionsPostRequestFormPaymentMethodSaveAll7d2cX55662ce5,
        ) {
