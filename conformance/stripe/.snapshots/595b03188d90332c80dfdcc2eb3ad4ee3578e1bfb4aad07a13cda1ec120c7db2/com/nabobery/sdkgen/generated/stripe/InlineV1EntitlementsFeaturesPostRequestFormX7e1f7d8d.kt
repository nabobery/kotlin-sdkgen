...
public class InlineV1EntitlementsFeaturesPostRequestFormX7e1f7d8d(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1EntitlementsFeaturesPostRequestFormX7e1f7d8d =
    ...
    public object Serializer : KSerializer<InlineV1EntitlementsFeaturesPostRequestFormX7e1f7d8d> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1EntitlementsFeaturesPostRequestFormX7e1f7d8d must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1EntitlementsFeaturesPostRequestFormX7e1f7d8d,
        ) {
...
public fun inlineV1EntitlementsFeaturesPostRequestFormX7e1f7d8d(
    block: InlineV1EntitlementsFeaturesPostRequestFormX7e1f7d8d.Builder.() -> Unit,
): InlineV1EntitlementsFeaturesPostRequestFormX7e1f7d8d =
    InlineV1EntitlementsFeaturesPostRequestFormX7e1f7d8d.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1EntitlementsFeaturesPostRequestFormX7e1f7d8d is missing required property '" + name + "'",
            )
