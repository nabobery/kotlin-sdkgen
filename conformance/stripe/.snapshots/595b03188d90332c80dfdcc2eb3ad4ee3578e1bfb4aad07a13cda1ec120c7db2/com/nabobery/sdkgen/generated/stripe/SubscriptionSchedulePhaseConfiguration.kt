...
public class SubscriptionSchedulePhaseConfiguration(
     ...
     */
    public val prorationBehavior: InlineSubscriptionSchedulePhaseConfigurationProrationBehaviorX75927419,
    /**
     ...
     */
    public val billingCycleAnchor: InlineSubscriptionSchedulePhaseConfigurationBillingCycleAnchorXdc0a44cb? = null,
    /**
     * Define thresholds at which an invoice will be sent, and the subscription advanced to a new billing period
     */
    public val billingThresholds: InlineSubscriptionSchedulePhaseConfigurationBillingThresholdsXe926a827? = null,
    /**
     ...
     * as `active`.
     */
    public val collectionMethod: InlineSubscriptionSchedulePhaseConfigurationCollectionMethodX592878be? = null,
    /**
     ...
     */
    public val defaultPaymentMethod: InlineSubscriptionSchedulePhaseConfigurationDefaultPaymentMethodX23a6342e? = null,
    /**
     ...
     */
    public val invoiceSettings: InlineSubscriptionSchedulePhaseConfigurationInvoiceSettingsX552904e1? = null,
    /**
     ...
     */
    public val transferData: InlineSubscriptionSchedulePhaseConfigurationTransferDataXc4efc34a? = null,
    /**
    ...
    public class Builder {
        ...
        public var addInvoiceItems: List<SubscriptionScheduleAddInvoiceItem>
            get() = requireNotNull(addInvoiceItemsValue) { "addInvoiceItems is required" }
            set(`value`) {
                addInvoiceItemsValue = value
            }
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): SubscriptionSchedulePhaseConfiguration =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<SubscriptionSchedulePhaseConfiguration> {
        ...
        override fun deserialize(decoder: Decoder): SubscriptionSchedulePhaseConfiguration {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("SubscriptionSchedulePhaseConfiguration must be a JSON object")
            val addInvoiceItems =
                json.decodeRequired<List<SubscriptionScheduleAddInvoiceItem>>(
                    rawObject,
                    "add_invoice_items",
                )
            val currency = json.decodeRequired<String>(rawObject, "currency")
            val discounts =
                json.decodeRequired<List<StackableDiscountWithDiscountSettingsAndDiscountEnd>>(
                    rawObject,
                    "discounts",
                )
            ...
            val prorationBehavior =
                json
                    .decodeRequired<InlineSubscriptionSchedulePhaseConfigurationProrationBehaviorX75927419>(
                        rawObject,
                        "proration_behavior",
                    )
            ...
            return SubscriptionSchedulePhaseConfiguration(
                ...
                automaticTax =
                    rawObject["automatic_tax"]?.let {
                        json.decodeFromJsonElement<SchedulesPhaseAutomaticTax>(
                            it,
                        )
                    },
                billingCycleAnchor =
                    rawObject["billing_cycle_anchor"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                            ...
                            json
                                .decodeFromJsonElement<InlineSubscriptionSchedulePhaseConfigurationBillingCycleAnchorXdc0a44cb?>(
                                    element,
                                )
                        }
                    },
                billingThresholds =
                    rawObject["billing_thresholds"]?.let { element ->
                        if (element ==
                            ...
                            json
                                .decodeFromJsonElement<InlineSubscriptionSchedulePhaseConfigurationBillingThresholdsXe926a827?>(
                                    element,
                                )
                        }
                    },
                collectionMethod =
                    rawObject["collection_method"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                            ...
                            json
                                .decodeFromJsonElement<InlineSubscriptionSchedulePhaseConfigurationCollectionMethodX592878be?>(
                                    element,
                                )
                        }
                    },
                defaultPaymentMethod =
                    rawObject["default_payment_method"]?.let { element ->
                        if (element ==
                            ...
                            json
                                .decodeFromJsonElement<InlineSubscriptionSchedulePhaseConfigurationDefaultPaymentMethodX23a6342e?>(
                                    element,
                                )
                        }
                    },
                ...
                invoiceSettings =
                    rawObject["invoice_settings"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                            ...
                            json
                                .decodeFromJsonElement<InlineSubscriptionSchedulePhaseConfigurationInvoiceSettingsX552904e1?>(
                                    element,
                                )
                        }
                    },
                ...
                onBehalfOf =
                    rawObject["on_behalf_of"]?.let { element ->
                        if (element ==
                            ...
                            json
                                .decodeFromJsonElement<InlineSubscriptionSchedulePhaseConfigurationOnBehalfOfX2e679968?>(
                                    element,
                                )
                        }
                    },
                transferData =
                    rawObject["transfer_data"]?.let { element ->
                        if (element ==
                            ...
                            json
                                .decodeFromJsonElement<InlineSubscriptionSchedulePhaseConfigurationTransferDataXc4efc34a?>(
                                    element,
                                )
                        }
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: SubscriptionSchedulePhaseConfiguration,
        ) {
...
public fun subscriptionSchedulePhaseConfiguration(
    block: SubscriptionSchedulePhaseConfiguration.Builder.() -> Unit,
): SubscriptionSchedulePhaseConfiguration = SubscriptionSchedulePhaseConfiguration.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "SubscriptionSchedulePhaseConfiguration is missing required property '" + name + "'",
            )
