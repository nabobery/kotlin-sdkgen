...
public class InlineRadarValueListListItemsXd336042d(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineRadarValueListListItemsXd336042d =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineRadarValueListListItemsXd336042d> {
        ...
        override fun deserialize(decoder: Decoder): InlineRadarValueListListItemsXd336042d {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("InlineRadarValueListListItemsXd336042d must be a JSON object")
            ...
            val objectValue =
                json.decodeRequired<InlineRadarValueListListItemsObjectValueX193f42fe>(
                    rawObject,
                    "object",
                )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineRadarValueListListItemsXd336042d,
        ) {
...
public fun inlineRadarValueListListItemsXd336042d(
    block: InlineRadarValueListListItemsXd336042d.Builder.() -> Unit,
): InlineRadarValueListListItemsXd336042d = InlineRadarValueListListItemsXd336042d.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineRadarValueListListItemsXd336042d is missing required property '" + name + "'",
            )
