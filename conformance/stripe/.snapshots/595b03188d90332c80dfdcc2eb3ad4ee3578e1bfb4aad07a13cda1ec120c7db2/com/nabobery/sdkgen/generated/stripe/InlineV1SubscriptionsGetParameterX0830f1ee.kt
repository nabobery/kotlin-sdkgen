...
public sealed class InlineV1SubscriptionsGetParameterX0830f1ee {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1SubscriptionsGetParameterX0830f1ee =
            when (value) {
                Active.value -> Active
                All.value -> All
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionsGetParameterX0830f1ee> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1SubscriptionsGetParameterX0830f1ee",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1SubscriptionsGetParameterX0830f1ee =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsGetParameterX0830f1ee,
        ) {
