...
public class InvoiceMandateOptionsPayto(
    ...
    public class Builder {
        ...
        public fun build(): InvoiceMandateOptionsPayto =
    ...
    public object Serializer : KSerializer<InvoiceMandateOptionsPayto> {
        ...
        override fun deserialize(decoder: Decoder): InvoiceMandateOptionsPayto {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("InvoiceMandateOptionsPayto must be a JSON object")
                ...
                amountType =
                    rawObject["amount_type"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineInvoiceMandateOptionsPaytoAmountTypeX50c97cfc?>(element)
                        }
                    },
                purpose =
                    rawObject["purpose"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineInvoiceMandateOptionsPaytoPurposeX001732ff?>(element)
                        }
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InvoiceMandateOptionsPayto,
        ) {
...
public fun invoiceMandateOptionsPayto(
    block: InvoiceMandateOptionsPayto.Builder.() -> Unit,
): InvoiceMandateOptionsPayto = InvoiceMandateOptionsPayto.build(block)
