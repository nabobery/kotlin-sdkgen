...
public class InvoicesPaymentsInvoicePaymentAssociatedPayment(
     ...
     */
    public val paymentIntent: InlineInvoicesPaymentsInvoicePaymentAssociatedPaymentPaymentIntentXd0d3cf11? = null,
    /**
     * ID of the PaymentRecord associated with this payment when `type` is `payment_record`.
     */
    public val paymentRecord: InlineInvoicesPaymentsInvoicePaymentAssociatedPaymentPaymentRecordX9cc47f0a? = null,
) {
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InvoicesPaymentsInvoicePaymentAssociatedPayment =
    ...
    public object Serializer : KSerializer<InvoicesPaymentsInvoicePaymentAssociatedPayment> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InvoicesPaymentsInvoicePaymentAssociatedPayment must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineInvoicesPaymentsInvoicePaymentAssociatedPaymentTypeX71d5b3e0>(
                    rawObject,
                    "type",
                )
            return InvoicesPaymentsInvoicePaymentAssociatedPayment(
                ...
                charge =
                    rawObject["charge"]?.let {
                        json
                            .decodeFromJsonElement<InlineInvoicesPaymentsInvoicePaymentAssociatedPaymentChargeX8b34a4f4>(
                                it,
                            )
                    },
                paymentIntent =
                    rawObject["payment_intent"]?.let {
                        json
                            .decodeFromJsonElement<InlineInvoicesPaymentsInvoicePaymentAssociatedPaymentPaymentIntentXd0d3cf11>(
                                it,
                            )
                    },
                paymentRecord =
                    rawObject["payment_record"]?.let {
                        json
                            .decodeFromJsonElement<InlineInvoicesPaymentsInvoicePaymentAssociatedPaymentPaymentRecordX9cc47f0a>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InvoicesPaymentsInvoicePaymentAssociatedPayment,
        ) {
...
public fun invoicesPaymentsInvoicePaymentAssociatedPayment(
    block: InvoicesPaymentsInvoicePaymentAssociatedPayment.Builder.() -> Unit,
): InvoicesPaymentsInvoicePaymentAssociatedPayment = InvoicesPaymentsInvoicePaymentAssociatedPayment.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InvoicesPaymentsInvoicePaymentAssociatedPayment is missing required property '" + name + "'",
            )
