...
internal data class InlineV1IssuingDisputesPostRequestFormEvidenceReturnedAtX744ccf9eInspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2X831b1588,
            ).count { it }
}
...
public class InlineV1IssuingDisputesPostRequestFormEvidenceReturnedAtX744ccf9e internal constructor(
    ...
    private val inspection: InlineV1IssuingDisputesPostRequestFormEvidenceReturnedAtX744ccf9eInspection,
) {
    ...
    public val inlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2X831b1588:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2X831b1588) {
                json
                    .decodeFromJsonElement<InlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2X831b1588>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1IssuingDisputesPostRequestFormEvidenceReturnedAtX744ccf9eBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2X831b1588) {
                    add(
                        InlineV1IssuingDisputesPostRequestFormEvidenceReturnedAtX744ccf9eBranch.InlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2X831b1588,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1IssuingDisputesPostRequestFormEvidenceReturnedAtX744ccf9e {
            val inspection = inspectInlineV1IssuingDisputesPostRequestFormEvidenceReturnedAtX744ccf9e(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1IssuingDisputesPostRequestFormEvidenceReturnedAtX744ccf9eNoMatchException(
                    "InlineV1IssuingDisputesPostRequestFormEvidenceReturnedAtX744ccf9e matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1IssuingDisputesPostRequestFormEvidenceReturnedAtX744ccf9e> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingDisputesPostRequestFormEvidenceReturnedAtX744ccf9e,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1IssuingDisputesPostRequestFormEvidenceReturnedAtX744ccf9e",
...
private fun inspectInlineV1IssuingDisputesPostRequestFormEvidenceReturnedAtX744ccf9e(
    element: JsonElement,
): InlineV1IssuingDisputesPostRequestFormEvidenceReturnedAtX744ccf9eInspection {
    val matchesBranch1 = element.isJsonDecodable<Int>()
    val matchesInlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2X831b1588 =
        element
            .isJsonDecodable<InlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2X831b1588>()
    return InlineV1IssuingDisputesPostRequestFormEvidenceReturnedAtX744ccf9eInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2X831b1588) {
                    add(
                        "InlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2X831b1588: value does not match InlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2X831b1588",
                    )
                }
            },
    )
