...
public sealed class InlineV1PaymentLinksPostRequestFormSubmitTypeX7702e8f8 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1PaymentLinksPostRequestFormSubmitTypeX7702e8f8 =
            when (value) {
                Auto.value -> Auto
                Book.value -> Book
                Donate.value -> Donate
    ...
    public object Serializer : KSerializer<InlineV1PaymentLinksPostRequestFormSubmitTypeX7702e8f8> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1PaymentLinksPostRequestFormSubmitTypeX7702e8f8",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1PaymentLinksPostRequestFormSubmitTypeX7702e8f8 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentLinksPostRequestFormSubmitTypeX7702e8f8,
        ) {
