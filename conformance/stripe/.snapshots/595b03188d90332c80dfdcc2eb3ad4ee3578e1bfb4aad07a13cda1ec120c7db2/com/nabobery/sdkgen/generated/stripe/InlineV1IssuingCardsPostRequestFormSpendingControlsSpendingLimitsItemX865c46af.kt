...
public class InlineV1IssuingCardsPostRequestFormSpendingControlsSpendingLimitsItemX865c46af(
    ...
    public val categories: List<InlineV1IssuingCardsPostRequestFormSpendingControlsSpendingLimitsItemX9d36ef42>? = null,
) {
    ...
    public object Serializer : KSerializer<InlineV1IssuingCardsPostRequestFormSpendingControlsSpendingLimitsItemX865c46af> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1IssuingCardsPostRequestFormSpendingControlsSpendingLimitsItemX865c46af must be a JSON object",
                    )
            val amount = json.decodeRequired<Int>(rawObject, "amount")
            val interval =
                json.decodeRequired<InlineV1IssuingCardsPostRequestFormSpendingControlsIntervalX7b5464cf>(
                    rawObject,
                    "interval",
                )
            return InlineV1IssuingCardsPostRequestFormSpendingControlsSpendingLimitsItemX865c46af(
                ...
                categories =
                    rawObject["categories"]?.let {
                        json
                            .decodeFromJsonElement<List<InlineV1IssuingCardsPostRequestFormSpendingControlsSpendingLimitsItemX9d36ef42>>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingCardsPostRequestFormSpendingControlsSpendingLimitsItemX865c46af,
        ) {
            val jsonEncoder =
...
public fun inlineV1IssuingCardsPostRequestFormSpendingControlsSpendingLimitsItemX865c46af(
    block: InlineV1IssuingCardsPostRequestFormSpendingControlsSpendingLimitsItemX865c46af.Builder.() -> Unit,
): InlineV1IssuingCardsPostRequestFormSpendingControlsSpendingLimitsItemX865c46af =
    InlineV1IssuingCardsPostRequestFormSpendingControlsSpendingLimitsItemX865c46af.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1IssuingCardsPostRequestFormSpendingControlsSpendingLimitsItemX865c46af is missing required property '" +
                    name +
                    "'",
            )
