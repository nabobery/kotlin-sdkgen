...
public sealed class InlineV1PaymentIntentsConfirmPostRequestFormCollectionMethodXe9255fef {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1PaymentIntentsConfirmPostRequestFormCollectionMethodXe9255fef =
            when (value) {
                Value.value -> Value
                Paper.value -> Paper
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsConfirmPostRequestFormCollectionMethodXe9255fef> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1PaymentIntentsConfirmPostRequestFormCollectionMethodXe9255fef",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1PaymentIntentsConfirmPostRequestFormCollectionMethodXe9255fef = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsConfirmPostRequestFormCollectionMethodXe9255fef,
        ) {
