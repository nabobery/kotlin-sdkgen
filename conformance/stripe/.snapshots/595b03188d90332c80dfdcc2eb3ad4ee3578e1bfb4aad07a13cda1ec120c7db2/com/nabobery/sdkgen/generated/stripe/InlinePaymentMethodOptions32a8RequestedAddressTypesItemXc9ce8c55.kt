...
public sealed class InlinePaymentMethodOptions32a8RequestedAddressTypesItemXc9ce8c55 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentMethodOptions32a8RequestedAddressTypesItemXc9ce8c55 =
            when (value) {
                Aba.value -> Aba
                Iban.value -> Iban
                Sepa.value -> Sepa
    ...
    public object Serializer : KSerializer<InlinePaymentMethodOptions32a8RequestedAddressTypesItemXc9ce8c55> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentMethodOptions32a8RequestedAddressTypesItemXc9ce8c55",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePaymentMethodOptions32a8RequestedAddressTypesItemXc9ce8c55 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentMethodOptions32a8RequestedAddressTypesItemXc9ce8c55,
        ) {
