...
public data class IssuingAuthorizationFleetDataView(
    ...
    public val cardholderPromptData: InlineIssuingAuthorizationFleetDataCardholderPromptDataXa71fed35? = null,
    ...
    public val reportedBreakdown: InlineIssuingAuthorizationFleetDataReportedBreakdownX67cf04e7? = null,
...
public class IssuingAuthorizationFleetData(
    ...
    public class Builder {
        ...
        public fun build(): IssuingAuthorizationFleetData =
    ...
    public object Serializer : KSerializer<IssuingAuthorizationFleetData> {
        ...
        override fun deserialize(decoder: Decoder): IssuingAuthorizationFleetData {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("IssuingAuthorizationFleetData must be a JSON object")
            return IssuingAuthorizationFleetData(
                cardholderPromptData =
                    rawObject["cardholder_prompt_data"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                            ...
                            json
                                .decodeFromJsonElement<InlineIssuingAuthorizationFleetDataCardholderPromptDataXa71fed35?>(
                                    element,
                                )
                        }
                    },
                purchaseType =
                    rawObject["purchase_type"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineIssuingAuthorizationFleetDataPurchaseTypeX0a1b0329?>(
                                element,
                            )
                        }
                    },
                reportedBreakdown =
                    rawObject["reported_breakdown"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineIssuingAuthorizationFleetDataReportedBreakdownX67cf04e7?>(
                                element,
                            )
                        }
                    },
                serviceType =
                    rawObject["service_type"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineIssuingAuthorizationFleetDataServiceTypeX8234a514?>(
                                element,
                            )
                        }
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: IssuingAuthorizationFleetData,
        ) {
...
public fun issuingAuthorizationFleetData(
    block: IssuingAuthorizationFleetData.Builder.() -> Unit,
): IssuingAuthorizationFleetData = IssuingAuthorizationFleetData.build(block)
