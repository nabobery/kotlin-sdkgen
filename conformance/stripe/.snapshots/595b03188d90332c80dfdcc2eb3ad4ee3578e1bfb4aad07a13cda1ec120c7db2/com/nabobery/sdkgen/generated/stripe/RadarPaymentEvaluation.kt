...
public class RadarPaymentEvaluation(
    ...
    public val clientDeviceMetadataDetails: InsightsResourcesPaymentEvaluationClientDeviceMetadata? = null,
        ...
        override fun deserialize(decoder: Decoder): RadarPaymentEvaluation {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("RadarPaymentEvaluation must be a JSON object")
            ...
            val recommendedAction =
                json.decodeRequired<InlineRadarPaymentEvaluationRecommendedActionX5e34086d>(
                    rawObject,
                    "recommended_action",
                )
            ...
            return RadarPaymentEvaluation(
                ...
                clientDeviceMetadataDetails =
                    rawObject["client_device_metadata_details"]?.let {
                        json.decodeFromJsonElement<InsightsResourcesPaymentEvaluationClientDeviceMetadata>(it)
                    },
                customerDetails =
                    rawObject["customer_details"]?.let {
                        json.decodeFromJsonElement<InsightsResourcesPaymentEvaluationCustomerDetails>(it)
                    },
                metadata =
                ...
                outcome =
                    rawObject["outcome"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineRadarPaymentEvaluationOutcomeX6e413009?>(element)
                        }
                    },
                paymentDetails =
                    rawObject["payment_details"]?.let {
                        json.decodeFromJsonElement<InsightsResourcesPaymentEvaluationPaymentDetails>(it)
                    },
            )
        }
...
public fun radarPaymentEvaluation(block: RadarPaymentEvaluation.Builder.() -> Unit): RadarPaymentEvaluation =
    RadarPaymentEvaluation.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("RadarPaymentEvaluation is missing required property '" + name + "'")
