...
public sealed class InlineIssuingAuthorizationFuelDataUnitX94435e5d {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineIssuingAuthorizationFuelDataUnitX94435e5d =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineIssuingAuthorizationFuelDataUnitX94435e5d> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineIssuingAuthorizationFuelDataUnitX94435e5d",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineIssuingAuthorizationFuelDataUnitX94435e5d =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineIssuingAuthorizationFuelDataUnitX94435e5d,
        ) {
