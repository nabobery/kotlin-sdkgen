...
public class BalanceDetailUngated(
    ...
    public object Serializer : KSerializer<BalanceDetailUngated> {
        ...
        override fun deserialize(decoder: Decoder): BalanceDetailUngated {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("BalanceDetailUngated must be a JSON object")
...
public fun balanceDetailUngated(block: BalanceDetailUngated.Builder.() -> Unit): BalanceDetailUngated =
    BalanceDetailUngated.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("BalanceDetailUngated is missing required property '" + name + "'")
