...
public class PaymentPagesCheckoutSessionDiscount(
    ...
    public class Builder {
        ...
        public fun build(): PaymentPagesCheckoutSessionDiscount =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentPagesCheckoutSessionDiscount =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentPagesCheckoutSessionDiscount> {
        ...
        override fun deserialize(decoder: Decoder): PaymentPagesCheckoutSessionDiscount {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentPagesCheckoutSessionDiscount must be a JSON object")
                ...
                coupon =
                    rawObject["coupon"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentPagesCheckoutSessionDiscountCouponX5818db5f?>(
                                element,
                            )
                        }
                    },
                promotionCode =
                    rawObject["promotion_code"]?.let { element ->
                        if (element ==
                            ...
                            json
                                .decodeFromJsonElement<InlinePaymentPagesCheckoutSessionDiscountPromotionCodeX93f0a9f5?>(
                                    element,
                                )
                        }
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentPagesCheckoutSessionDiscount,
        ) {
...
public fun paymentPagesCheckoutSessionDiscount(
    block: PaymentPagesCheckoutSessionDiscount.Builder.() -> Unit,
): PaymentPagesCheckoutSessionDiscount = PaymentPagesCheckoutSessionDiscount.build(block)
