...
public class InlineV1BillingPortalSessionsPostRequestFormFlowDataCouponOfferX0efe861a(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1BillingPortalSessionsPostRequestFormFlowDataCouponOfferX0efe861a = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1BillingPortalSessionsPostRequestFormFlowDataCouponOfferX0efe861a> {
        override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1BillingPortalSessionsPostRequestFormFlowDataCouponOfferX0efe861a {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1BillingPortalSessionsPostRequestFormFlowDataCouponOfferX0efe861a must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1BillingPortalSessionsPostRequestFormFlowDataCouponOfferX0efe861a,
        ) {
            val jsonEncoder =
...
public fun inlineV1BillingPortalSessionsPostRequestFormFlowDataCouponOfferX0efe861a(
    block: InlineV1BillingPortalSessionsPostRequestFormFlowDataCouponOfferX0efe861a.Builder.() -> Unit,
): InlineV1BillingPortalSessionsPostRequestFormFlowDataCouponOfferX0efe861a =
    InlineV1BillingPortalSessionsPostRequestFormFlowDataCouponOfferX0efe861a.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1BillingPortalSessionsPostRequestFormFlowDataCouponOfferX0efe861a is missing required property '" +
                    name +
                    "'",
            )
