...
public sealed class InlineTreasuryReceivedDebitStatusXdf22d6dc {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineTreasuryReceivedDebitStatusXdf22d6dc =
            when (value) {
                Failed.value -> Failed
    ...
    public object Serializer : KSerializer<InlineTreasuryReceivedDebitStatusXdf22d6dc> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineTreasuryReceivedDebitStatusXdf22d6dc",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineTreasuryReceivedDebitStatusXdf22d6dc =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineTreasuryReceivedDebitStatusXdf22d6dc,
        ) {
