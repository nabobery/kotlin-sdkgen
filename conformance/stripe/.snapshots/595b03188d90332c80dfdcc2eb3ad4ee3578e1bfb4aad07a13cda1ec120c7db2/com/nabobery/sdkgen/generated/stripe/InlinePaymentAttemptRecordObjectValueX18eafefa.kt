...
public sealed class InlinePaymentAttemptRecordObjectValueX18eafefa {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentAttemptRecordObjectValueX18eafefa =
            when (value) {
    ...
    public object Serializer : KSerializer<InlinePaymentAttemptRecordObjectValueX18eafefa> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentAttemptRecordObjectValueX18eafefa",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePaymentAttemptRecordObjectValueX18eafefa =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentAttemptRecordObjectValueX18eafefa,
        ) {
