...
public class InlineV1TerminalOnboardingacffPostRequestFormAppleTermsAndConditionsXa09ded50(
    ...
    public object Serializer : KSerializer<InlineV1TerminalOnboardingacffPostRequestFormAppleTermsAndConditionsXa09ded50> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TerminalOnboardingacffPostRequestFormAppleTermsAndConditionsXa09ded50 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TerminalOnboardingacffPostRequestFormAppleTermsAndConditionsXa09ded50,
        ) {
            val jsonEncoder =
...
public fun inlineV1TerminalOnboardingacffPostRequestFormAppleTermsAndConditionsXa09ded50(
    block: InlineV1TerminalOnboardingacffPostRequestFormAppleTermsAndConditionsXa09ded50.Builder.() -> Unit,
): InlineV1TerminalOnboardingacffPostRequestFormAppleTermsAndConditionsXa09ded50 =
    InlineV1TerminalOnboardingacffPostRequestFormAppleTermsAndConditionsXa09ded50.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TerminalOnboardingacffPostRequestFormAppleTermsAndConditionsXa09ded50 is missing required property '" +
                    name +
                    "'",
            )
