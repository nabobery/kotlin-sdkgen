    ...
    public object Serializer : KSerializer<InlineInvoicePaymentMethodOptionsUsBankAccountVerificationMethodX50379ccf> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineInvoicePaymentMethodOptionsUsBankAccountVerificationMethodX50379ccf",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineInvoicePaymentMethodOptionsUsBankAccountVerificationMethodX50379ccf = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineInvoicePaymentMethodOptionsUsBankAccountVerificationMethodX50379ccf,
        ) {
