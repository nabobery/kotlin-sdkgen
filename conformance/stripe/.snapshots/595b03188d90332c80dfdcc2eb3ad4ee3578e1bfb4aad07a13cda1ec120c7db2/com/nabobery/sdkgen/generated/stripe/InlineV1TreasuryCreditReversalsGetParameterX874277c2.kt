...
public sealed class InlineV1TreasuryCreditReversalsGetParameterX874277c2 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1TreasuryCreditReversalsGetParameterX874277c2 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1TreasuryCreditReversalsGetParameterX874277c2> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1TreasuryCreditReversalsGetParameterX874277c2",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1TreasuryCreditReversalsGetParameterX874277c2 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TreasuryCreditReversalsGetParameterX874277c2,
        ) {
