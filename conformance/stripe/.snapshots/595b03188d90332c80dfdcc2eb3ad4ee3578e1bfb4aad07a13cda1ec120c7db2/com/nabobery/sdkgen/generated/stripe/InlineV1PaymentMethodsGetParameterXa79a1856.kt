...
public sealed class InlineV1PaymentMethodsGetParameterXa79a1856 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1PaymentMethodsGetParameterXa79a1856 =
            when (value) {
                Always.value -> Always
    ...
    public object Serializer : KSerializer<InlineV1PaymentMethodsGetParameterXa79a1856> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1PaymentMethodsGetParameterXa79a1856",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1PaymentMethodsGetParameterXa79a1856 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentMethodsGetParameterXa79a1856,
        ) {
