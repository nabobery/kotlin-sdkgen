...
public class FundingInstructionsBankTransferSortCodeRecord(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): FundingInstructionsBankTransferSortCodeRecord =
    ...
    public object Serializer : KSerializer<FundingInstructionsBankTransferSortCodeRecord> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "FundingInstructionsBankTransferSortCodeRecord must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: FundingInstructionsBankTransferSortCodeRecord,
        ) {
...
public fun fundingInstructionsBankTransferSortCodeRecord(
    block: FundingInstructionsBankTransferSortCodeRecord.Builder.() -> Unit,
): FundingInstructionsBankTransferSortCodeRecord = FundingInstructionsBankTransferSortCodeRecord.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "FundingInstructionsBankTransferSortCodeRecord is missing required property '" + name + "'",
            )
