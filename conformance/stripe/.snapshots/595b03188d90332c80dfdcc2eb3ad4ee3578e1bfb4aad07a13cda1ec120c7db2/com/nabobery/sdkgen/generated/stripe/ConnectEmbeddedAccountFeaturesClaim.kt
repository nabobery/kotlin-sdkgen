...
public class ConnectEmbeddedAccountFeaturesClaim(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): ConnectEmbeddedAccountFeaturesClaim =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<ConnectEmbeddedAccountFeaturesClaim> {
        ...
        override fun deserialize(decoder: Decoder): ConnectEmbeddedAccountFeaturesClaim {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("ConnectEmbeddedAccountFeaturesClaim must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: ConnectEmbeddedAccountFeaturesClaim,
        ) {
...
public fun connectEmbeddedAccountFeaturesClaim(
    block: ConnectEmbeddedAccountFeaturesClaim.Builder.() -> Unit,
): ConnectEmbeddedAccountFeaturesClaim = ConnectEmbeddedAccountFeaturesClaim.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "ConnectEmbeddedAccountFeaturesClaim is missing required property '" + name + "'",
            )
