...
public class InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X99f4ca6b(
    public val mandateOptions: InlineV1SubscriptionsPostRequestFormPaymentSettingsMandateOptionsX0e9a89df? = null,
) {
    public class Builder {
        public var mandateOptions:
            InlineV1SubscriptionsPostRequestFormPaymentSettingsMandateOptionsX0e9a89df? = null

        public fun build(): InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X99f4ca6b =
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X99f4ca6b = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X99f4ca6b> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X99f4ca6b must be a JSON object",
                    )
            return InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X99f4ca6b(
                mandateOptions =
                    rawObject["mandate_options"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormPaymentSettingsMandateOptionsX0e9a89df>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X99f4ca6b,
        ) {
            val jsonEncoder =
...
public fun inlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X99f4ca6b(
    block: InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X99f4ca6b.Builder.() -> Unit,
): InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X99f4ca6b =
    InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X99f4ca6b.build(block)
