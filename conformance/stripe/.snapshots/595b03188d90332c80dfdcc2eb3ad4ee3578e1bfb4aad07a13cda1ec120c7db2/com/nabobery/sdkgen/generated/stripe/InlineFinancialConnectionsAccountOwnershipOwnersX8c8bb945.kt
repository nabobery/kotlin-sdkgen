...
public class InlineFinancialConnectionsAccountOwnershipOwnersX8c8bb945(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineFinancialConnectionsAccountOwnershipOwnersX8c8bb945 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineFinancialConnectionsAccountOwnershipOwnersX8c8bb945> {
        ...
        override fun deserialize(decoder: Decoder): InlineFinancialConnectionsAccountOwnershipOwnersX8c8bb945 {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineFinancialConnectionsAccountOwnershipOwnersX8c8bb945 must be a JSON object",
                    )
            ...
            val objectValue =
                json.decodeRequired<InlineFinancialConnectionsAccountOwnershipOwnersObjectValueX581c2112>(
                    rawObject,
                    "object",
                )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineFinancialConnectionsAccountOwnershipOwnersX8c8bb945,
        ) {
...
public fun inlineFinancialConnectionsAccountOwnershipOwnersX8c8bb945(
    block: InlineFinancialConnectionsAccountOwnershipOwnersX8c8bb945.Builder.() -> Unit,
): InlineFinancialConnectionsAccountOwnershipOwnersX8c8bb945 =
    InlineFinancialConnectionsAccountOwnershipOwnersX8c8bb945.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineFinancialConnectionsAccountOwnershipOwnersX8c8bb945 is missing required property '" + name + "'",
            )
