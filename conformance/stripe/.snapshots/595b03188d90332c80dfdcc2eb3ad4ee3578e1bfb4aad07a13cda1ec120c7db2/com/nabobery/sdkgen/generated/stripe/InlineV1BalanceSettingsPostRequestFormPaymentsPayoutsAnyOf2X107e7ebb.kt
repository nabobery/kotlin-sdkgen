...
public sealed class InlineV1BalanceSettingsPostRequestFormPaymentsPayoutsAnyOf2X107e7ebb {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1BalanceSettingsPostRequestFormPaymentsPayoutsAnyOf2X107e7ebb =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1BalanceSettingsPostRequestFormPaymentsPayoutsAnyOf2X107e7ebb> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1BalanceSettingsPostRequestFormPaymentsPayoutsAnyOf2X107e7ebb",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1BalanceSettingsPostRequestFormPaymentsPayoutsAnyOf2X107e7ebb = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1BalanceSettingsPostRequestFormPaymentsPayoutsAnyOf2X107e7ebb,
        ) {
