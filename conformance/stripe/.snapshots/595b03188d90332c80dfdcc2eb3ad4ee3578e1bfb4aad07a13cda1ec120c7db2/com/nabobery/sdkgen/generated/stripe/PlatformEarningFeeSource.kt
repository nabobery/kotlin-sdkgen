...
public class PlatformEarningFeeSource(
    ...
    public object Serializer : KSerializer<PlatformEarningFeeSource> {
        ...
        override fun deserialize(decoder: Decoder): PlatformEarningFeeSource {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PlatformEarningFeeSource must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PlatformEarningFeeSource,
        ) {
...
public fun platformEarningFeeSource(block: PlatformEarningFeeSource.Builder.() -> Unit): PlatformEarningFeeSource =
    PlatformEarningFeeSource.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException("PlatformEarningFeeSource is missing required property '" + name + "'")
