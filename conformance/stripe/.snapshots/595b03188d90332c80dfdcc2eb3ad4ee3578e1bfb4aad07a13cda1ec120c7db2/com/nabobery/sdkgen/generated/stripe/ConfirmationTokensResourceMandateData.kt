...
public class ConfirmationTokensResourceMandateData(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): ConfirmationTokensResourceMandateData =
    ...
    public object Serializer : KSerializer<ConfirmationTokensResourceMandateData> {
        ...
        override fun deserialize(decoder: Decoder): ConfirmationTokensResourceMandateData {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("ConfirmationTokensResourceMandateData must be a JSON object")
            val customerAcceptance =
                json.decodeRequired<ConfirmationTokensResourceMandateDataResourceCustomerAcceptance>(
                    rawObject,
                    "customer_acceptance",
                )
            return ConfirmationTokensResourceMandateData(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: ConfirmationTokensResourceMandateData,
        ) {
...
public fun confirmationTokensResourceMandateData(
    block: ConfirmationTokensResourceMandateData.Builder.() -> Unit,
): ConfirmationTokensResourceMandateData = ConfirmationTokensResourceMandateData.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "ConfirmationTokensResourceMandateData is missing required property '" + name + "'",
            )
