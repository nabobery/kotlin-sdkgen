...
public sealed class InlineV1ShippingRatesPostRequestFormTaxBehaviorX733e1857 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1ShippingRatesPostRequestFormTaxBehaviorX733e1857 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1ShippingRatesPostRequestFormTaxBehaviorX733e1857> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1ShippingRatesPostRequestFormTaxBehaviorX733e1857",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1ShippingRatesPostRequestFormTaxBehaviorX733e1857 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ShippingRatesPostRequestFormTaxBehaviorX733e1857,
        ) {
