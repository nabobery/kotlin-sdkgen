...
public sealed class InlineV1TransfersPostRequestFormSourceTypeX11473d86 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1TransfersPostRequestFormSourceTypeX11473d86 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1TransfersPostRequestFormSourceTypeX11473d86> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1TransfersPostRequestFormSourceTypeX11473d86",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1TransfersPostRequestFormSourceTypeX11473d86 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TransfersPostRequestFormSourceTypeX11473d86,
        ) {
