...
public class InlineV1InvoicesUpdateLinesPostRequestFormLinesItemX780032d3(
    ...
    public val discounts: InlineV1InvoicesUpdateLinesPostRequestFormLinesItemDiscountsXc684a3e7? = null,
    ...
    public val priceData: InlineV1InvoicesUpdateLinesPostRequestFormLinesItemPriceDataX2a66dd7b? = null,
    ...
    public val taxAmounts: InlineV1InvoicesUpdateLinesPostRequestFormLinesItemTaxAmountsX86f74ac5? = null,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1InvoicesUpdateLinesPostRequestFormLinesItemX780032d3 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1InvoicesUpdateLinesPostRequestFormLinesItemX780032d3> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1InvoicesUpdateLinesPostRequestFormLinesItemX780032d3 must be a JSON object",
                    )
            ...
            return InlineV1InvoicesUpdateLinesPostRequestFormLinesItemX780032d3(
                ...
                discounts =
                    rawObject["discounts"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1InvoicesUpdateLinesPostRequestFormLinesItemDiscountsXc684a3e7>(
                                it,
                            )
                    },
                metadata =
                    rawObject["metadata"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1InvoicesUpdateLinesPostRequestFormLinesItemMetadataXbe574ef2>(
                                it,
                            )
                    },
                period =
                    rawObject["period"]?.let {
                        json.decodeFromJsonElement<InlineV1InvoicesUpdateLinesPostRequestFormLinesItemPeriodXc19cfd20>(
                            it,
                        )
                    },
                priceData =
                    rawObject["price_data"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1InvoicesUpdateLinesPostRequestFormLinesItemPriceDataX2a66dd7b>(
                                it,
                            )
                    },
                pricing =
                    rawObject["pricing"]?.let {
                        json.decodeFromJsonElement<InlineV1InvoicesUpdateLinesPostRequestFormLinesItemPricingX89f0268b>(
                            it,
                        )
                    },
                ...
                taxAmounts =
                    rawObject["tax_amounts"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1InvoicesUpdateLinesPostRequestFormLinesItemTaxAmountsX86f74ac5>(
                                it,
                            )
                    },
                taxRates =
                    rawObject["tax_rates"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1InvoicesUpdateLinesPostRequestFormLinesItemTaxRatesX8a160863>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesUpdateLinesPostRequestFormLinesItemX780032d3,
        ) {
...
public fun inlineV1InvoicesUpdateLinesPostRequestFormLinesItemX780032d3(
    block: InlineV1InvoicesUpdateLinesPostRequestFormLinesItemX780032d3.Builder.() -> Unit,
): InlineV1InvoicesUpdateLinesPostRequestFormLinesItemX780032d3 =
    InlineV1InvoicesUpdateLinesPostRequestFormLinesItemX780032d3.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1InvoicesUpdateLinesPostRequestFormLinesItemX780032d3 is missing required property '" + name +
                    "'",
            )
