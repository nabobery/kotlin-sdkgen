...
public class InlineV1CustomerSessionsPostRequestFormComponentsX6c4299e1(
    ...
    public val customerSheet: InlineV1CustomerSessionsPostRequestFormComponentsCustomerSheetX34be08d9? = null,
    public val mobilePaymentElement:
        InlineV1CustomerSessionsPostRequestFormComponentsMobilePaymentElementXb75feb83? = null,
    public val paymentElement: InlineV1CustomerSessionsPostRequestFormComponentsPaymentElementX26fc1db1? = null,
    public val pricingTable: InlineV1CustomerSessionsPostRequestFormComponentsPricingTableX7aec27db? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1CustomerSessionsPostRequestFormComponentsX6c4299e1 =
            InlineV1CustomerSessionsPostRequestFormComponentsX6c4299e1(
                buyButton = buyButton,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1CustomerSessionsPostRequestFormComponentsX6c4299e1 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1CustomerSessionsPostRequestFormComponentsX6c4299e1> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CustomerSessionsPostRequestFormComponentsX6c4299e1 must be a JSON object",
                    )
            return InlineV1CustomerSessionsPostRequestFormComponentsX6c4299e1(
                buyButton =
                    rawObject["buy_button"]?.let {
                        json.decodeFromJsonElement<InlineV1CustomerSessionsPostRequestFormComponentsBuyButtonX59955717>(
                            it,
                        )
                    },
                customerSheet =
                    rawObject["customer_sheet"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CustomerSessionsPostRequestFormComponentsCustomerSheetX34be08d9>(
                                it,
                            )
                    },
                mobilePaymentElement =
                    rawObject["mobile_payment_element"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CustomerSessionsPostRequestFormComponentsMobilePaymentElementXb75feb83>(
                                it,
                            )
                    },
                paymentElement =
                    rawObject["payment_element"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CustomerSessionsPostRequestFormComponentsPaymentElementX26fc1db1>(
                                it,
                            )
                    },
                pricingTable =
                    rawObject["pricing_table"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CustomerSessionsPostRequestFormComponentsPricingTableX7aec27db>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomerSessionsPostRequestFormComponentsX6c4299e1,
        ) {
...
public fun inlineV1CustomerSessionsPostRequestFormComponentsX6c4299e1(
    block: InlineV1CustomerSessionsPostRequestFormComponentsX6c4299e1.Builder.() -> Unit,
): InlineV1CustomerSessionsPostRequestFormComponentsX6c4299e1 =
    InlineV1CustomerSessionsPostRequestFormComponentsX6c4299e1.build(block)
