...
public class PaymentMethodOptionsCustomerBalanceBankTransfer(
     ...
     */
    public val requestedAddressTypes: List<InlinePaymentMethodOptions32a8RequestedAddressTypesItemXc9ce8c55>? = null,
    /**
    ...
    public class Builder {
        ...
        public fun build(): PaymentMethodOptionsCustomerBalanceBankTransfer =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentMethodOptionsCustomerBalanceBankTransfer =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentMethodOptionsCustomerBalanceBankTransfer> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "PaymentMethodOptionsCustomerBalanceBankTransfer must be a JSON object",
                    )
            return PaymentMethodOptionsCustomerBalanceBankTransfer(
                ...
                requestedAddressTypes =
                    rawObject["requested_address_types"]?.let {
                        json
                            .decodeFromJsonElement<List<InlinePaymentMethodOptions32a8RequestedAddressTypesItemXc9ce8c55>>(
                                it,
                            )
                    },
                type =
                    rawObject["type"]?.let { element ->
                        if (element ==
                            ...
                            json
                                .decodeFromJsonElement<InlinePaymentMethodOptionsCustomerBalanceBankTransferTypeX8f1d2f26?>(
                                    element,
                                )
                        }
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentMethodOptionsCustomerBalanceBankTransfer,
        ) {
...
public fun paymentMethodOptionsCustomerBalanceBankTransfer(
    block: PaymentMethodOptionsCustomerBalanceBankTransfer.Builder.() -> Unit,
): PaymentMethodOptionsCustomerBalanceBankTransfer = PaymentMethodOptionsCustomerBalanceBankTransfer.build(block)
