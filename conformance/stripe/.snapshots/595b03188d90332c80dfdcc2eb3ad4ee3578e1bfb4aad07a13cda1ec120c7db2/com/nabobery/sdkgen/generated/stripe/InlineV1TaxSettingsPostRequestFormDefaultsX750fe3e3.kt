...
public class InlineV1TaxSettingsPostRequestFormDefaultsX750fe3e3(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1TaxSettingsPostRequestFormDefaultsX750fe3e3 =
            InlineV1TaxSettingsPostRequestFormDefaultsX750fe3e3(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TaxSettingsPostRequestFormDefaultsX750fe3e3 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TaxSettingsPostRequestFormDefaultsX750fe3e3> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TaxSettingsPostRequestFormDefaultsX750fe3e3 must be a JSON object",
                    )
            return InlineV1TaxSettingsPostRequestFormDefaultsX750fe3e3(
                taxBehavior =
                    rawObject["tax_behavior"]?.let {
                        json.decodeFromJsonElement<InlineV1TaxSettingsPostRequestFormDefaultsTaxBehaviorXe34cddd4>(it)
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TaxSettingsPostRequestFormDefaultsX750fe3e3,
        ) {
...
public fun inlineV1TaxSettingsPostRequestFormDefaultsX750fe3e3(
    block: InlineV1TaxSettingsPostRequestFormDefaultsX750fe3e3.Builder.() -> Unit,
): InlineV1TaxSettingsPostRequestFormDefaultsX750fe3e3 =
    InlineV1TaxSettingsPostRequestFormDefaultsX750fe3e3.build(block)
