...
public sealed class InlineV1IssuingCardsPostRequestFormSpendingControlsIntervalXcf383b90 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1IssuingCardsPostRequestFormSpendingControlsIntervalXcf383b90 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1IssuingCardsPostRequestFormSpendingControlsIntervalXcf383b90> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1IssuingCardsPostRequestFormSpendingControlsIntervalXcf383b90",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1IssuingCardsPostRequestFormSpendingControlsIntervalXcf383b90 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingCardsPostRequestFormSpendingControlsIntervalXcf383b90,
        ) {
