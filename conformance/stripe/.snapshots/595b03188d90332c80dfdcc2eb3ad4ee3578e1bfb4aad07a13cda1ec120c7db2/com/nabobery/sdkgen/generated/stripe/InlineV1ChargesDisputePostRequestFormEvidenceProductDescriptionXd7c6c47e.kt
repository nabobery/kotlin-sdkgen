...
internal data class InlineV1ChargesDisputePostRequestFormEvidenceProductDescriptionXd7c6c47eInspection(
    ...
    public val matchesInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2X8743987e: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2X8743987e,
            ).count {
                it
            }
}
...
public class InlineV1ChargesDisputePostRequestFormEvidenceProductDescriptionXd7c6c47e internal constructor(
    ...
    private val inspection: InlineV1ChargesDisputePostRequestFormEvidenceProductDescriptionXd7c6c47eInspection,
) {
    ...
    public val inlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2X8743987e:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2X8743987e) {
                json
                    .decodeFromJsonElement<InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2X8743987e>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1ChargesDisputePostRequestFormEvidenceProductDescriptionXd7c6c47eBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2X8743987e) {
                    add(
                        InlineV1ChargesDisputePostRequestFormEvidenceProductDescriptionXd7c6c47eBranch.InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2X8743987e,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1ChargesDisputePostRequestFormEvidenceProductDescriptionXd7c6c47e {
            val inspection = inspectInlineV1ChargesDisputePostRequestFormEvidenceProductDescriptionXd7c6c47e(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1ChargesDisputePostRequestFormEvidenceProductDescriptionXd7c6c47eNoMatchException(
                    "InlineV1ChargesDisputePostRequestFormEvidenceProductDescriptionXd7c6c47e matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1ChargesDisputePostRequestFormEvidenceProductDescriptionXd7c6c47e> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ChargesDisputePostRequestFormEvidenceProductDescriptionXd7c6c47e,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1ChargesDisputePostRequestFormEvidenceProductDescriptionXd7c6c47e",
...
private fun inspectInlineV1ChargesDisputePostRequestFormEvidenceProductDescriptionXd7c6c47e(
    element: JsonElement,
): InlineV1ChargesDisputePostRequestFormEvidenceProductDescriptionXd7c6c47eInspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2X8743987e =
        element
            .isJsonDecodable<InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2X8743987e>()
    return InlineV1ChargesDisputePostRequestFormEvidenceProductDescriptionXd7c6c47eInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2X8743987e) {
                    add(
                        "InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2X8743987e: value does not match InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2X8743987e",
                    )
                }
            },
    )
