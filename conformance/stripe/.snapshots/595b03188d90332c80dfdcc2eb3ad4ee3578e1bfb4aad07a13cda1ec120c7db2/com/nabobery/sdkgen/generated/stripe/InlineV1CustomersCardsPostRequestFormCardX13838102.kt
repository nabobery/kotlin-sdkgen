...
public class InlineV1CustomersCardsPostRequestFormCardX13838102 internal constructor(
    ...
    public val inlineV1CustomersCardsPostRequestFormCardAnyOf1X0e7c1476:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1CustomersCardsPostRequestFormCardAnyOf1X0e7c1476) {
                json
                    .decodeFromJsonElement<InlineV1CustomersCardsPostRequestFormCardAnyOf1X0e7c1476>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1CustomersCardsPostRequestFormCardX13838102Branch>
        get() =
            buildSet {
                if (inspection.matchesInlineV1CustomersCardsPostRequestFormCardAnyOf1X0e7c1476) {
                    add(
                        InlineV1CustomersCardsPostRequestFormCardX13838102Branch.InlineV1CustomersCardsPostRequestFormCardAnyOf1X0e7c1476,
                    )
                }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1CustomersCardsPostRequestFormCardX13838102 {
            val inspection = inspectInlineV1CustomersCardsPostRequestFormCardX13838102(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1CustomersCardsPostRequestFormCardX13838102NoMatchException(
                    "InlineV1CustomersCardsPostRequestFormCardX13838102 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1CustomersCardsPostRequestFormCardX13838102> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersCardsPostRequestFormCardX13838102,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1CustomersCardsPostRequestFormCardX13838102",
...
private fun inspectInlineV1CustomersCardsPostRequestFormCardX13838102(
    element: JsonElement,
): InlineV1CustomersCardsPostRequestFormCardX13838102Inspection {
    val matchesInlineV1CustomersCardsPostRequestFormCardAnyOf1X0e7c1476 =
        element
            .isJsonDecodable<InlineV1CustomersCardsPostRequestFormCardAnyOf1X0e7c1476>()
    ...
    return InlineV1CustomersCardsPostRequestFormCardX13838102Inspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1CustomersCardsPostRequestFormCardAnyOf1X0e7c1476) {
                    add(
                        "InlineV1CustomersCardsPostRequestFormCardAnyOf1X0e7c1476: value does not match InlineV1CustomersCardsPostRequestFormCardAnyOf1X0e7c1476",
                    )
                }
