...
internal data class InlineV1CustomersSourcesPostRequestFormMetadataX22211fb4Inspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1CustomersSourcesPostRequestFormMetadataAnyOf2X2fb79299,
            ).count { it }
}
...
public class InlineV1CustomersSourcesPostRequestFormMetadataX22211fb4 internal constructor(
    ...
    public val inlineV1CustomersSourcesPostRequestFormMetadataAnyOf2X2fb79299:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1CustomersSourcesPostRequestFormMetadataAnyOf2X2fb79299) {
                json
                    .decodeFromJsonElement<InlineV1CustomersSourcesPostRequestFormMetadataAnyOf2X2fb79299>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1CustomersSourcesPostRequestFormMetadataX22211fb4Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1CustomersSourcesPostRequestFormMetadataAnyOf2X2fb79299) {
                    add(
                        InlineV1CustomersSourcesPostRequestFormMetadataX22211fb4Branch.InlineV1CustomersSourcesPostRequestFormMetadataAnyOf2X2fb79299,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1CustomersSourcesPostRequestFormMetadataX22211fb4 {
            val inspection = inspectInlineV1CustomersSourcesPostRequestFormMetadataX22211fb4(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1CustomersSourcesPostRequestFormMetadataX22211fb4NoMatchException(
                    "InlineV1CustomersSourcesPostRequestFormMetadataX22211fb4 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1CustomersSourcesPostRequestFormMetadataX22211fb4> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersSourcesPostRequestFormMetadataX22211fb4,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1CustomersSourcesPostRequestFormMetadataX22211fb4",
...
private fun inspectInlineV1CustomersSourcesPostRequestFormMetadataX22211fb4(
    element: JsonElement,
): InlineV1CustomersSourcesPostRequestFormMetadataX22211fb4Inspection {
    val matchesBranch1 = element.isJsonDecodable<JsonObject>()
    val matchesInlineV1CustomersSourcesPostRequestFormMetadataAnyOf2X2fb79299 =
        element
            .isJsonDecodable<InlineV1CustomersSourcesPostRequestFormMetadataAnyOf2X2fb79299>()
    return InlineV1CustomersSourcesPostRequestFormMetadataX22211fb4Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1CustomersSourcesPostRequestFormMetadataAnyOf2X2fb79299) {
                    add(
                        "InlineV1CustomersSourcesPostRequestFormMetadataAnyOf2X2fb79299: value does not match InlineV1CustomersSourcesPostRequestFormMetadataAnyOf2X2fb79299",
                    )
                }
            },
    )
