...
public class TerminalConfigurationConfigurationResourcePersonalPskWifi(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): TerminalConfigurationConfigurationResourcePersonalPskWifi =
    ...
    public object Serializer : KSerializer<TerminalConfigurationConfigurationResourcePersonalPskWifi> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "TerminalConfigurationConfigurationResourcePersonalPskWifi must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: TerminalConfigurationConfigurationResourcePersonalPskWifi,
        ) {
...
public fun terminalConfigurationConfigurationResourcePersonalPskWifi(
    block: TerminalConfigurationConfigurationResourcePersonalPskWifi.Builder.() -> Unit,
): TerminalConfigurationConfigurationResourcePersonalPskWifi =
    TerminalConfigurationConfigurationResourcePersonalPskWifi.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "TerminalConfigurationConfigurationResourcePersonalPskWifi is missing required property '" + name + "'",
            )
