...
public class InlineV1ReviewsGetParameterX513fe451 internal constructor(
    ...
    public val inlineV1ReviewsGetParameterAnyOf1Xa8794d1a: InlineV1ReviewsGetParameterAnyOf1Xa8794d1a?
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1ReviewsGetParameterAnyOf1Xa8794d1a) {
                json
                    .decodeFromJsonElement<InlineV1ReviewsGetParameterAnyOf1Xa8794d1a>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1ReviewsGetParameterX513fe451Branch>
        get() =
            buildSet {
                if (inspection.matchesInlineV1ReviewsGetParameterAnyOf1Xa8794d1a) {
                    add(
                        InlineV1ReviewsGetParameterX513fe451Branch.InlineV1ReviewsGetParameterAnyOf1Xa8794d1a,
                    )
                }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1ReviewsGetParameterX513fe451 {
            val inspection = inspectInlineV1ReviewsGetParameterX513fe451(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1ReviewsGetParameterX513fe451NoMatchException(
                    "InlineV1ReviewsGetParameterX513fe451 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1ReviewsGetParameterX513fe451> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ReviewsGetParameterX513fe451,
        ) {
...
private fun inspectInlineV1ReviewsGetParameterX513fe451(
    element: JsonElement,
): InlineV1ReviewsGetParameterX513fe451Inspection {
    val matchesInlineV1ReviewsGetParameterAnyOf1Xa8794d1a =
        element
            .isJsonDecodable<InlineV1ReviewsGetParameterAnyOf1Xa8794d1a>()
    ...
    return InlineV1ReviewsGetParameterX513fe451Inspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1ReviewsGetParameterAnyOf1Xa8794d1a) {
                    add(
                        "InlineV1ReviewsGetParameterAnyOf1Xa8794d1a: value does not match InlineV1ReviewsGetParameterAnyOf1Xa8794d1a",
                    )
                }
