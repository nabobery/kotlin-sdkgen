...
public class InlineV1AppsSecretsDeletePostRequestFormX830ea2e0(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1AppsSecretsDeletePostRequestFormX830ea2e0 =
    ...
    public object Serializer : KSerializer<InlineV1AppsSecretsDeletePostRequestFormX830ea2e0> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AppsSecretsDeletePostRequestFormX830ea2e0 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AppsSecretsDeletePostRequestFormX830ea2e0,
        ) {
...
public fun inlineV1AppsSecretsDeletePostRequestFormX830ea2e0(
    block: InlineV1AppsSecretsDeletePostRequestFormX830ea2e0.Builder.() -> Unit,
): InlineV1AppsSecretsDeletePostRequestFormX830ea2e0 = InlineV1AppsSecretsDeletePostRequestFormX830ea2e0.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1AppsSecretsDeletePostRequestFormX830ea2e0 is missing required property '" + name + "'",
            )
