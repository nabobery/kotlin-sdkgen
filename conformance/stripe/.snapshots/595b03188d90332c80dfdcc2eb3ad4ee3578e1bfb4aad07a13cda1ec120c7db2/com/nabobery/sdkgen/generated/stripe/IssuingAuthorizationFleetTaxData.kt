...
public class IssuingAuthorizationFleetTaxData(
    ...
    public class Builder {
        ...
        public fun build(): IssuingAuthorizationFleetTaxData =
    ...
    public object Serializer : KSerializer<IssuingAuthorizationFleetTaxData> {
        ...
        override fun deserialize(decoder: Decoder): IssuingAuthorizationFleetTaxData {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("IssuingAuthorizationFleetTaxData must be a JSON object")
            return IssuingAuthorizationFleetTaxData(
                localAmountDecimal =
                    rawObject["local_amount_decimal"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                nationalAmountDecimal =
                    rawObject["national_amount_decimal"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: IssuingAuthorizationFleetTaxData,
        ) {
...
public fun issuingAuthorizationFleetTaxData(
    block: IssuingAuthorizationFleetTaxData.Builder.() -> Unit,
): IssuingAuthorizationFleetTaxData = IssuingAuthorizationFleetTaxData.build(block)
