...
public class InlineV1PaymentMethodsPostRequestFormEpsXf1913613(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1PaymentMethodsPostRequestFormEpsXf1913613 =
            InlineV1PaymentMethodsPostRequestFormEpsXf1913613(
                bank = bank,
            )
    }

    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PaymentMethodsPostRequestFormEpsXf1913613 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentMethodsPostRequestFormEpsXf1913613> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentMethodsPostRequestFormEpsXf1913613 must be a JSON object",
                    )
            return InlineV1PaymentMethodsPostRequestFormEpsXf1913613(
                bank =
                    rawObject["bank"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentMethodsPostRequestFormEpsBankX3483b847>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentMethodsPostRequestFormEpsXf1913613,
        ) {
...
public fun inlineV1PaymentMethodsPostRequestFormEpsXf1913613(
    block: InlineV1PaymentMethodsPostRequestFormEpsXf1913613.Builder.() -> Unit,
): InlineV1PaymentMethodsPostRequestFormEpsXf1913613 = InlineV1PaymentMethodsPostRequestFormEpsXf1913613.build(block)
