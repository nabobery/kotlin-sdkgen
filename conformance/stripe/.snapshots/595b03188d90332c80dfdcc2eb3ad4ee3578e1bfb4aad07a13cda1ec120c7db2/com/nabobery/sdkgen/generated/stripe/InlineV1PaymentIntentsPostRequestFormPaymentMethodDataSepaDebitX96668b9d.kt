...
public class InlineV1PaymentIntentsPostRequestFormPaymentMethodDataSepaDebitX96668b9d(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentIntentsPostRequestFormPaymentMethodDataSepaDebitX96668b9d = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormPaymentMethodDataSepaDebitX96668b9d> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsPostRequestFormPaymentMethodDataSepaDebitX96668b9d must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormPaymentMethodDataSepaDebitX96668b9d,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentIntentsPostRequestFormPaymentMethodDataSepaDebitX96668b9d(
    block: InlineV1PaymentIntentsPostRequestFormPaymentMethodDataSepaDebitX96668b9d.Builder.() -> Unit,
): InlineV1PaymentIntentsPostRequestFormPaymentMethodDataSepaDebitX96668b9d =
    InlineV1PaymentIntentsPostRequestFormPaymentMethodDataSepaDebitX96668b9d.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentIntentsPostRequestFormPaymentMethodDataSepaDebitX96668b9d is missing required property '" +
                    name +
                    "'",
            )
