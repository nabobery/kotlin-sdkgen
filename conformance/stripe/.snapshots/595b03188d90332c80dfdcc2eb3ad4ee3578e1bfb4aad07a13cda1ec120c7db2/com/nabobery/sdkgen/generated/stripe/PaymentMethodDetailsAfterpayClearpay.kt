...
public class PaymentMethodDetailsAfterpayClearpay(
    ...
    public class Builder {
        ...
        public fun build(): PaymentMethodDetailsAfterpayClearpay =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentMethodDetailsAfterpayClearpay =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentMethodDetailsAfterpayClearpay> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodDetailsAfterpayClearpay {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodDetailsAfterpayClearpay must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentMethodDetailsAfterpayClearpay,
        ) {
...
public fun paymentMethodDetailsAfterpayClearpay(
    block: PaymentMethodDetailsAfterpayClearpay.Builder.() -> Unit,
): PaymentMethodDetailsAfterpayClearpay = PaymentMethodDetailsAfterpayClearpay.build(block)
