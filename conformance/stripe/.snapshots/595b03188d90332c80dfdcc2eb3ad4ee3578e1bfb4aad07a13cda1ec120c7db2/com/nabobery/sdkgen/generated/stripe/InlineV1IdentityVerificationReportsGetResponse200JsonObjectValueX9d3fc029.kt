    ...
    public object Serializer : KSerializer<InlineV1IdentityVerificationReportsGetResponse200JsonObjectValueX9d3fc029> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1IdentityVerificationReportsGetResponse200JsonObjectValueX9d3fc029",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1IdentityVerificationReportsGetResponse200JsonObjectValueX9d3fc029 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IdentityVerificationReportsGetResponse200JsonObjectValueX9d3fc029,
        ) {
