...
public class PaymentPagesCheckoutSessionCustomFieldsOption(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentPagesCheckoutSessionCustomFieldsOption =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentPagesCheckoutSessionCustomFieldsOption> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "PaymentPagesCheckoutSessionCustomFieldsOption must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentPagesCheckoutSessionCustomFieldsOption,
        ) {
...
public fun paymentPagesCheckoutSessionCustomFieldsOption(
    block: PaymentPagesCheckoutSessionCustomFieldsOption.Builder.() -> Unit,
): PaymentPagesCheckoutSessionCustomFieldsOption = PaymentPagesCheckoutSessionCustomFieldsOption.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "PaymentPagesCheckoutSessionCustomFieldsOption is missing required property '" + name + "'",
            )
