...
public class InlineV1IssuingDisputesPostRequestFormEvidenceAnyOf1Xce58edc7(
    ...
    public val explanation: InlineV1IssuingDisputesPostRequestFormEvidenceExplanationXa81f0f83? = null,
    public val receivedAt: InlineV1IssuingDisputesPostRequestFormEvidenceReceivedAtX6cdf1759? = null,
    public val returnDescription: InlineV1IssuingDisputesPostRequestFormEvidenceReturnDescriptionX0527b46d? = null,
    public val returnStatus: InlineV1IssuingDisputesPostRequestFormEvidenceReturnStatusX65c23639? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1IssuingDisputesPostRequestFormEvidenceAnyOf1Xce58edc7 =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1IssuingDisputesPostRequestFormEvidenceAnyOf1Xce58edc7 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1IssuingDisputesPostRequestFormEvidenceAnyOf1Xce58edc7> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1IssuingDisputesPostRequestFormEvidenceAnyOf1Xce58edc7 must be a JSON object",
                    )
            return InlineV1IssuingDisputesPostRequestFormEvidenceAnyOf1Xce58edc7(
                additionalDocumentation =
                    rawObject["additional_documentation"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1IssuingDisputesPostRequestFormEvidenceAdditionalDocumentationXb1cfd218>(
                                it,
                            )
                    },
                explanation =
                    rawObject["explanation"]?.let {
                        json.decodeFromJsonElement<InlineV1IssuingDisputesPostRequestFormEvidenceExplanationXa81f0f83>(
                            it,
                        )
                    },
                receivedAt =
                    rawObject["received_at"]?.let {
                        json.decodeFromJsonElement<InlineV1IssuingDisputesPostRequestFormEvidenceReceivedAtX6cdf1759>(
                            it,
                        )
                    },
                returnDescription =
                    rawObject["return_description"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1IssuingDisputesPostRequestFormEvidenceReturnDescriptionX0527b46d>(
                                it,
                            )
                    },
                returnStatus =
                    rawObject["return_status"]?.let {
                        json.decodeFromJsonElement<InlineV1IssuingDisputesPostRequestFormEvidenceReturnStatusX65c23639>(
                            it,
                        )
                    },
                returnedAt =
                    rawObject["returned_at"]?.let {
                        json.decodeFromJsonElement<InlineV1IssuingDisputesPostRequestFormEvidenceReturnedAtX02fa3891>(
                            it,
                        )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingDisputesPostRequestFormEvidenceAnyOf1Xce58edc7,
        ) {
            val jsonEncoder =
...
public fun inlineV1IssuingDisputesPostRequestFormEvidenceAnyOf1Xce58edc7(
    block: InlineV1IssuingDisputesPostRequestFormEvidenceAnyOf1Xce58edc7.Builder.() -> Unit,
): InlineV1IssuingDisputesPostRequestFormEvidenceAnyOf1Xce58edc7 =
    InlineV1IssuingDisputesPostRequestFormEvidenceAnyOf1Xce58edc7.build(block)
