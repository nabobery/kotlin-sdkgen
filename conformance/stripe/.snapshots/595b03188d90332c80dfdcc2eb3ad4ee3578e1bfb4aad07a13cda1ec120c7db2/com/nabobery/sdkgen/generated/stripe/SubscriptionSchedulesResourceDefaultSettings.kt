...
public class SubscriptionSchedulesResourceDefaultSettings(
     ...
     */
    public val billingCycleAnchor: InlineSubscriptionSchedulesResourceDefaultSettingsBillingCycleAnchorXe33112b5,
     ...
     */
    public val billingThresholds: InlineSubscriptionSchedulesResourceDefaultSettingsBillingThresholdsXf52a0ede? = null,
    /**
     ...
     * as `active`.
     */
    public val collectionMethod: InlineSubscriptionSchedulesResourceDefaultSettingsCollectionMethodXede0db53? = null,
    /**
     ...
     */
    public val onBehalfOf: InlineSubscriptionSchedulesResourceDefaultSettingsOnBehalfOfXca035d5a? = null,
    /**
     ...
     */
    public val transferData: InlineSubscriptionSchedulesResourceDefaultSettingsTransferDataX6aa83edf? = null,
) {
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): SubscriptionSchedulesResourceDefaultSettings =
    ...
    public object Serializer : KSerializer<SubscriptionSchedulesResourceDefaultSettings> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "SubscriptionSchedulesResourceDefaultSettings must be a JSON object",
                    )
            val billingCycleAnchor =
                json
                    .decodeRequired<InlineSubscriptionSchedulesResourceDefaultSettingsBillingCycleAnchorXe33112b5>(
                        rawObject,
                        "billing_cycle_anchor",
                    )
            val invoiceSettings =
                json.decodeRequired<InvoiceSettingSubscriptionScheduleSetting>(
                    rawObject,
                    "invoice_settings",
                )
            return SubscriptionSchedulesResourceDefaultSettings(
                ...
                automaticTax =
                    rawObject["automatic_tax"]?.let {
                        json.decodeFromJsonElement<SubscriptionSchedulesResourceDefaultSettingsAutomaticTax>(it)
                    },
                billingThresholds =
                    rawObject["billing_thresholds"]?.let { element ->
                        if (element ==
                            ...
                            json
                                .decodeFromJsonElement<InlineSubscriptionSchedulesResourceDefaultSettingsBillingThresholdsXf52a0ede?>(
                                    element,
                                )
                        }
                    },
                collectionMethod =
                    rawObject["collection_method"]?.let { element ->
                        if (element ==
                            ...
                            json
                                .decodeFromJsonElement<InlineSubscriptionSchedulesResourceDefaultSettingsCollectionMethodXede0db53?>(
                                    element,
                                )
                        }
                    },
                defaultPaymentMethod =
                    rawObject["default_payment_method"]?.let { element ->
                        if (element ==
                            ...
                            json
                                .decodeFromJsonElement<InlineSubscriptionSchedulesResourceDefaultSettingsDefaultPaymentMethodX451617a0?>(
                                    element,
                                )
                        }
                    },
                ...
                onBehalfOf =
                    rawObject["on_behalf_of"]?.let { element ->
                        if (element ==
                            ...
                            json
                                .decodeFromJsonElement<InlineSubscriptionSchedulesResourceDefaultSettingsOnBehalfOfXca035d5a?>(
                                    element,
                                )
                        }
                    },
                transferData =
                    rawObject["transfer_data"]?.let { element ->
                        if (element ==
                            ...
                            json
                                .decodeFromJsonElement<InlineSubscriptionSchedulesResourceDefaultSettingsTransferDataX6aa83edf?>(
                                    element,
                                )
                        }
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: SubscriptionSchedulesResourceDefaultSettings,
        ) {
...
public fun subscriptionSchedulesResourceDefaultSettings(
    block: SubscriptionSchedulesResourceDefaultSettings.Builder.() -> Unit,
): SubscriptionSchedulesResourceDefaultSettings = SubscriptionSchedulesResourceDefaultSettings.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "SubscriptionSchedulesResourceDefaultSettings is missing required property '" + name + "'",
            )
