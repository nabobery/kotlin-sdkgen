...
public class InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsPixXeb917509(
    public val mandateOptions: InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsMandateOptionsX9ec9e3f8? = null,
) {
    public class Builder {
        public var mandateOptions:
            InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsMandateOptionsX9ec9e3f8? = null

        public fun build(): InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsPixXeb917509 =
            InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsPixXeb917509(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsPixXeb917509 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsPixXeb917509> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsPixXeb917509 must be a JSON object",
                    )
            return InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsPixXeb917509(
                mandateOptions =
                    rawObject["mandate_options"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsMandateOptionsX9ec9e3f8>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsPixXeb917509,
        ) {
            val jsonEncoder =
...
public fun inlineV1SetupIntentsPostRequestFormPaymentMethodOptionsPixXeb917509(
    block: InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsPixXeb917509.Builder.() -> Unit,
): InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsPixXeb917509 =
