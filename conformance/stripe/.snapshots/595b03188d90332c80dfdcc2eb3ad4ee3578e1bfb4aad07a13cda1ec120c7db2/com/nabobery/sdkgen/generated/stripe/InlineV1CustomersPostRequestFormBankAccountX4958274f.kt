...
public class InlineV1CustomersPostRequestFormBankAccountX4958274f internal constructor(
    ...
    public val inlineV1CustomersPostRequestFormBankAccountAnyOf1Xe90aabe6:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1CustomersPostRequestFormBankAccountAnyOf1Xe90aabe6) {
                json
                    .decodeFromJsonElement<InlineV1CustomersPostRequestFormBankAccountAnyOf1Xe90aabe6>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1CustomersPostRequestFormBankAccountX4958274fBranch>
        get() =
            buildSet {
                if (inspection.matchesInlineV1CustomersPostRequestFormBankAccountAnyOf1Xe90aabe6) {
                    add(
                        InlineV1CustomersPostRequestFormBankAccountX4958274fBranch.InlineV1CustomersPostRequestFormBankAccountAnyOf1Xe90aabe6,
                    )
                }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1CustomersPostRequestFormBankAccountX4958274f {
            val inspection = inspectInlineV1CustomersPostRequestFormBankAccountX4958274f(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1CustomersPostRequestFormBankAccountX4958274fNoMatchException(
                    "InlineV1CustomersPostRequestFormBankAccountX4958274f matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1CustomersPostRequestFormBankAccountX4958274f> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersPostRequestFormBankAccountX4958274f,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1CustomersPostRequestFormBankAccountX4958274f",
...
private fun inspectInlineV1CustomersPostRequestFormBankAccountX4958274f(
    element: JsonElement,
): InlineV1CustomersPostRequestFormBankAccountX4958274fInspection {
    val matchesInlineV1CustomersPostRequestFormBankAccountAnyOf1Xe90aabe6 =
        element
            .isJsonDecodable<InlineV1CustomersPostRequestFormBankAccountAnyOf1Xe90aabe6>()
    ...
    return InlineV1CustomersPostRequestFormBankAccountX4958274fInspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1CustomersPostRequestFormBankAccountAnyOf1Xe90aabe6) {
                    add(
                        "InlineV1CustomersPostRequestFormBankAccountAnyOf1Xe90aabe6: value does not match InlineV1CustomersPostRequestFormBankAccountAnyOf1Xe90aabe6",
                    )
                }
