...
public class RefundNextAction(
    ...
    public object Serializer : KSerializer<RefundNextAction> {
        ...
        override fun deserialize(decoder: Decoder): RefundNextAction {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("RefundNextAction must be a JSON object")
            val type = json.decodeRequired<String>(rawObject, "type")
            return RefundNextAction(
                type = type,
                displayDetails =
                    rawObject["display_details"]?.let {
                        json.decodeFromJsonElement<RefundNextActionDisplayDetails>(
                            it,
                        )
                    },
            )
...
public fun refundNextAction(block: RefundNextAction.Builder.() -> Unit): RefundNextAction =
    RefundNextAction.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("RefundNextAction is missing required property '" + name + "'")
