...
internal data class InlineV1CustomersBalanceTransactionsPostRequestFormMetadataXdddf617dInspection(
    ...
    public val matchesInlineV1CustomersBalanceTransactionsPostRequestFormMetadataAnyOf2Xa3df9f8e: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1CustomersBalanceTransactionsPostRequestFormMetadataAnyOf2Xa3df9f8e,
            ).count {
                it
            }
}
...
public class InlineV1CustomersBalanceTransactionsPostRequestFormMetadataXdddf617d internal constructor(
    ...
    private val inspection: InlineV1CustomersBalanceTransactionsPostRequestFormMetadataXdddf617dInspection,
) {
    ...
    public val inlineV1CustomersBalanceTransactionsPostRequestFormMetadataAnyOf2Xa3df9f8e:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1CustomersBalanceTransactionsPostRequestFormMetadataAnyOf2Xa3df9f8e) {
                json
                    .decodeFromJsonElement<InlineV1CustomersBalanceTransactionsPostRequestFormMetadataAnyOf2Xa3df9f8e>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1CustomersBalanceTransactionsPostRequestFormMetadataXdddf617dBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1CustomersBalanceTransactionsPostRequestFormMetadataAnyOf2Xa3df9f8e) {
                    add(
                        InlineV1CustomersBalanceTransactionsPostRequestFormMetadataXdddf617dBranch.InlineV1CustomersBalanceTransactionsPostRequestFormMetadataAnyOf2Xa3df9f8e,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1CustomersBalanceTransactionsPostRequestFormMetadataXdddf617d {
            val inspection = inspectInlineV1CustomersBalanceTransactionsPostRequestFormMetadataXdddf617d(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1CustomersBalanceTransactionsPostRequestFormMetadataXdddf617dNoMatchException(
                    "InlineV1CustomersBalanceTransactionsPostRequestFormMetadataXdddf617d matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1CustomersBalanceTransactionsPostRequestFormMetadataXdddf617d> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersBalanceTransactionsPostRequestFormMetadataXdddf617d,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1CustomersBalanceTransactionsPostRequestFormMetadataXdddf617d",
...
private fun inspectInlineV1CustomersBalanceTransactionsPostRequestFormMetadataXdddf617d(
    element: JsonElement,
): InlineV1CustomersBalanceTransactionsPostRequestFormMetadataXdddf617dInspection {
    val matchesBranch1 = element.isJsonDecodable<JsonObject>()
    val matchesInlineV1CustomersBalanceTransactionsPostRequestFormMetadataAnyOf2Xa3df9f8e =
        element
            .isJsonDecodable<InlineV1CustomersBalanceTransactionsPostRequestFormMetadataAnyOf2Xa3df9f8e>()
    return InlineV1CustomersBalanceTransactionsPostRequestFormMetadataXdddf617dInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1CustomersBalanceTransactionsPostRequestFormMetadataAnyOf2Xa3df9f8e) {
                    add(
                        "InlineV1CustomersBalanceTransactionsPostRequestFormMetadataAnyOf2Xa3df9f8e: value does not match InlineV1CustomersBalanceTransactionsPostRequestFormMetadataAnyOf2Xa3df9f8e",
                    )
                }
            },
    )
