...
public class LineItemsAdjustableQuantity(
    ...
    public object Serializer : KSerializer<LineItemsAdjustableQuantity> {
        ...
        override fun deserialize(decoder: Decoder): LineItemsAdjustableQuantity {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("LineItemsAdjustableQuantity must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: LineItemsAdjustableQuantity,
        ) {
...
public fun lineItemsAdjustableQuantity(
    block: LineItemsAdjustableQuantity.Builder.() -> Unit,
): LineItemsAdjustableQuantity = LineItemsAdjustableQuantity.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException("LineItemsAdjustableQuantity is missing required property '" + name + "'")
