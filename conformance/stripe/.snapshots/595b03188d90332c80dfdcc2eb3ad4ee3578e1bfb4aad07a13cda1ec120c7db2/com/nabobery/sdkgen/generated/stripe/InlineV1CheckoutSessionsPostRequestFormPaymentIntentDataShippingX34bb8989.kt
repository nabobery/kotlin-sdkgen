...
public class InlineV1CheckoutSessionsPostRequestFormPaymentIntentDataShippingX34bb8989(
    public val address: InlineV1CheckoutSessionsPostRequestFormPaymentIntentDataShippingAddressXbd0e4634,
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1CheckoutSessionsPostRequestFormPaymentIntentDataShippingX34bb8989 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormPaymentIntentDataShippingX34bb8989> {
        ...
        override fun deserialize(
            decoder: Decoder,
        ): InlineV1CheckoutSessionsPostRequestFormPaymentIntentDataShippingX34bb8989 {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CheckoutSessionsPostRequestFormPaymentIntentDataShippingX34bb8989 must be a JSON object",
                    )
            val address =
                json
                    .decodeRequired<InlineV1CheckoutSessionsPostRequestFormPaymentIntentDataShippingAddressXbd0e4634>(
                        rawObject,
                        "address",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsPostRequestFormPaymentIntentDataShippingX34bb8989,
        ) {
            val jsonEncoder =
...
public fun inlineV1CheckoutSessionsPostRequestFormPaymentIntentDataShippingX34bb8989(
    block: InlineV1CheckoutSessionsPostRequestFormPaymentIntentDataShippingX34bb8989.Builder.() -> Unit,
): InlineV1CheckoutSessionsPostRequestFormPaymentIntentDataShippingX34bb8989 =
    InlineV1CheckoutSessionsPostRequestFormPaymentIntentDataShippingX34bb8989.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1CheckoutSessionsPostRequestFormPaymentIntentDataShippingX34bb8989 is missing required property '" +
                    name +
                    "'",
            )
