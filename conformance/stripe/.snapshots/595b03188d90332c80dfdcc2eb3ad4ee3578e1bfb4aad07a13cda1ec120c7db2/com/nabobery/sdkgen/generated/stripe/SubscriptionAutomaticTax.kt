...
public class SubscriptionAutomaticTax(
    ...
    public object Serializer : KSerializer<SubscriptionAutomaticTax> {
        ...
        override fun deserialize(decoder: Decoder): SubscriptionAutomaticTax {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("SubscriptionAutomaticTax must be a JSON object")
                ...
                disabledReason =
                    rawObject["disabled_reason"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineSubscriptionAutomaticTaxDisabledReasonXda31318a?>(element)
                        }
                    },
                liability =
                    rawObject["liability"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineSubscriptionAutomaticTaxLiabilityX078c8509?>(element)
                        }
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: SubscriptionAutomaticTax,
        ) {
...
public fun subscriptionAutomaticTax(block: SubscriptionAutomaticTax.Builder.() -> Unit): SubscriptionAutomaticTax =
    SubscriptionAutomaticTax.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException("SubscriptionAutomaticTax is missing required property '" + name + "'")
