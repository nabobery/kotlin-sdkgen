...
public sealed class InlineV1PaymentIntentsPostRequestFormAresTransStatusXadd670f0 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1PaymentIntentsPostRequestFormAresTransStatusXadd670f0 =
            when (value) {
                A.value -> A
                C.value -> C
                I.value -> I
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormAresTransStatusXadd670f0> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1PaymentIntentsPostRequestFormAresTransStatusXadd670f0",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1PaymentIntentsPostRequestFormAresTransStatusXadd670f0 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormAresTransStatusXadd670f0,
        ) {
