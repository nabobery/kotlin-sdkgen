...
public class AccountDeclineChargeOn(
    ...
    public object Serializer : KSerializer<AccountDeclineChargeOn> {
        ...
        override fun deserialize(decoder: Decoder): AccountDeclineChargeOn {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("AccountDeclineChargeOn must be a JSON object")
...
public fun accountDeclineChargeOn(block: AccountDeclineChargeOn.Builder.() -> Unit): AccountDeclineChargeOn =
    AccountDeclineChargeOn.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("AccountDeclineChargeOn is missing required property '" + name + "'")
