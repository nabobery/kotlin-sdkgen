...
public class PaymentLinksResourceCustomFieldsDropdown(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentLinksResourceCustomFieldsDropdown =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentLinksResourceCustomFieldsDropdown> {
        ...
        override fun deserialize(decoder: Decoder): PaymentLinksResourceCustomFieldsDropdown {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentLinksResourceCustomFieldsDropdown must be a JSON object")
            val options =
                json.decodeRequired<List<PaymentLinksResourceCustomFieldsDropdownOption>>(
                    rawObject,
                    "options",
                )
            return PaymentLinksResourceCustomFieldsDropdown(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentLinksResourceCustomFieldsDropdown,
        ) {
...
public fun paymentLinksResourceCustomFieldsDropdown(
    block: PaymentLinksResourceCustomFieldsDropdown.Builder.() -> Unit,
): PaymentLinksResourceCustomFieldsDropdown = PaymentLinksResourceCustomFieldsDropdown.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "PaymentLinksResourceCustomFieldsDropdown is missing required property '" + name + "'",
            )
