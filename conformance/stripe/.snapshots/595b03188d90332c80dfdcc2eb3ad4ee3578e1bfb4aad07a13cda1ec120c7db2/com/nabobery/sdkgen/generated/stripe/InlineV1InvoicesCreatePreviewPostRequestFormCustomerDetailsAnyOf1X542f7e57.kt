...
public class InlineV1InvoicesCreatePreviewPostRequestFormCustomerDetailsAnyOf1X542f7e57(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1InvoicesCreatePreviewPostRequestFormCustomerDetailsAnyOf1X542f7e57 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1InvoicesCreatePreviewPostRequestFormCustomerDetailsAnyOf1X542f7e57> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1InvoicesCreatePreviewPostRequestFormCustomerDetailsAnyOf1X542f7e57 must be a JSON object",
                    )
            val address =
                json.decodeRequired<InlineV1InvoicesCreatePreviewPostRequestFormCustomerDetailsAddressX80f77ec8>(
                    rawObject,
                    "address",
                )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesCreatePreviewPostRequestFormCustomerDetailsAnyOf1X542f7e57,
        ) {
            val jsonEncoder =
...
public fun inlineV1InvoicesCreatePreviewPostRequestFormCustomerDetailsAnyOf1X542f7e57(
    block: InlineV1InvoicesCreatePreviewPostRequestFormCustomerDetailsAnyOf1X542f7e57.Builder.() -> Unit,
): InlineV1InvoicesCreatePreviewPostRequestFormCustomerDetailsAnyOf1X542f7e57 =
    InlineV1InvoicesCreatePreviewPostRequestFormCustomerDetailsAnyOf1X542f7e57.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1InvoicesCreatePreviewPostRequestFormCustomerDetailsAnyOf1X542f7e57 is missing required property '" +
                    name +
                    "'",
            )
