...
public class InlineV1CustomersSourcesPostRequestFormX91b8f989(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1CustomersSourcesPostRequestFormX91b8f989 =
            InlineV1CustomersSourcesPostRequestFormX91b8f989(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1CustomersSourcesPostRequestFormX91b8f989 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1CustomersSourcesPostRequestFormX91b8f989> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CustomersSourcesPostRequestFormX91b8f989 must be a JSON object",
                    )
            return InlineV1CustomersSourcesPostRequestFormX91b8f989(
                ...
                bankAccount =
                    rawObject["bank_account"]?.let {
                        json.decodeFromJsonElement<InlineV1CustomersSourcesPostRequestFormBankAccountXfb61e7dc>(it)
                    },
                card =
                    rawObject["card"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CustomersSourcesPostRequestFormCardXaca4ebd8>(
                                it,
                            )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersSourcesPostRequestFormX91b8f989,
        ) {
...
public fun inlineV1CustomersSourcesPostRequestFormX91b8f989(
    block: InlineV1CustomersSourcesPostRequestFormX91b8f989.Builder.() -> Unit,
): InlineV1CustomersSourcesPostRequestFormX91b8f989 = InlineV1CustomersSourcesPostRequestFormX91b8f989.build(block)
