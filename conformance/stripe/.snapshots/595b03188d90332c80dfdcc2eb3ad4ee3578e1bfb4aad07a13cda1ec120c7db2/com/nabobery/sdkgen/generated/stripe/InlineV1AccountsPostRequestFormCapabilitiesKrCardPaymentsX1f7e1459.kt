...
public class InlineV1AccountsPostRequestFormCapabilitiesKrCardPaymentsX1f7e1459(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1AccountsPostRequestFormCapabilitiesKrCardPaymentsX1f7e1459 =
            InlineV1AccountsPostRequestFormCapabilitiesKrCardPaymentsX1f7e1459(
                requested = requested,
            )
    }
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1AccountsPostRequestFormCapabilitiesKrCardPaymentsX1f7e1459 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1AccountsPostRequestFormCapabilitiesKrCardPaymentsX1f7e1459> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountsPostRequestFormCapabilitiesKrCardPaymentsX1f7e1459 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPostRequestFormCapabilitiesKrCardPaymentsX1f7e1459,
        ) {
            val jsonEncoder =
...
public fun inlineV1AccountsPostRequestFormCapabilitiesKrCardPaymentsX1f7e1459(
    block: InlineV1AccountsPostRequestFormCapabilitiesKrCardPaymentsX1f7e1459.Builder.() -> Unit,
): InlineV1AccountsPostRequestFormCapabilitiesKrCardPaymentsX1f7e1459 =
    InlineV1AccountsPostRequestFormCapabilitiesKrCardPaymentsX1f7e1459.build(block)
