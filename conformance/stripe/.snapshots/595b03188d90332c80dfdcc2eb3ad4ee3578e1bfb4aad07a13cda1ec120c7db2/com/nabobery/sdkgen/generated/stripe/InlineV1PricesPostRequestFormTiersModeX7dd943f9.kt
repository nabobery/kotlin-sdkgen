...
public sealed class InlineV1PricesPostRequestFormTiersModeX7dd943f9 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1PricesPostRequestFormTiersModeX7dd943f9 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1PricesPostRequestFormTiersModeX7dd943f9> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1PricesPostRequestFormTiersModeX7dd943f9",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1PricesPostRequestFormTiersModeX7dd943f9 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PricesPostRequestFormTiersModeX7dd943f9,
        ) {
