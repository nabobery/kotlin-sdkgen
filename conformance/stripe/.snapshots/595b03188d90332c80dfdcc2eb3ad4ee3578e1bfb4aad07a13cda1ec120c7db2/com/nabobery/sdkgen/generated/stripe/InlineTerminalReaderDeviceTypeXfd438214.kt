...
public sealed class InlineTerminalReaderDeviceTypeXfd438214 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineTerminalReaderDeviceTypeXfd438214 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineTerminalReaderDeviceTypeXfd438214> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineTerminalReaderDeviceTypeXfd438214",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineTerminalReaderDeviceTypeXfd438214 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineTerminalReaderDeviceTypeXfd438214,
        ) {
