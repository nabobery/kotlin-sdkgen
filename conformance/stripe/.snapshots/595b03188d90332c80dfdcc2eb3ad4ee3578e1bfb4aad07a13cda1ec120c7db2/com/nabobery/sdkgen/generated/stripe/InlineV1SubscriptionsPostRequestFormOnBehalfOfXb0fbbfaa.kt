...
internal data class InlineV1SubscriptionsPostRequestFormOnBehalfOfXb0fbbfaaInspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1SubscriptionsPostRequestFormOnBehalfOfAnyOf2X1b88b464,
            ).count { it }
}
...
public class InlineV1SubscriptionsPostRequestFormOnBehalfOfXb0fbbfaa internal constructor(
    ...
    public val inlineV1SubscriptionsPostRequestFormOnBehalfOfAnyOf2X1b88b464:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1SubscriptionsPostRequestFormOnBehalfOfAnyOf2X1b88b464) {
                json
                    .decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormOnBehalfOfAnyOf2X1b88b464>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1SubscriptionsPostRequestFormOnBehalfOfXb0fbbfaaBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1SubscriptionsPostRequestFormOnBehalfOfAnyOf2X1b88b464) {
                    add(
                        InlineV1SubscriptionsPostRequestFormOnBehalfOfXb0fbbfaaBranch.InlineV1SubscriptionsPostRequestFormOnBehalfOfAnyOf2X1b88b464,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1SubscriptionsPostRequestFormOnBehalfOfXb0fbbfaa {
            val inspection = inspectInlineV1SubscriptionsPostRequestFormOnBehalfOfXb0fbbfaa(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1SubscriptionsPostRequestFormOnBehalfOfXb0fbbfaaNoMatchException(
                    "InlineV1SubscriptionsPostRequestFormOnBehalfOfXb0fbbfaa matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionsPostRequestFormOnBehalfOfXb0fbbfaa> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsPostRequestFormOnBehalfOfXb0fbbfaa,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1SubscriptionsPostRequestFormOnBehalfOfXb0fbbfaa",
...
private fun inspectInlineV1SubscriptionsPostRequestFormOnBehalfOfXb0fbbfaa(
    element: JsonElement,
): InlineV1SubscriptionsPostRequestFormOnBehalfOfXb0fbbfaaInspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1SubscriptionsPostRequestFormOnBehalfOfAnyOf2X1b88b464 =
        element
            .isJsonDecodable<InlineV1SubscriptionsPostRequestFormOnBehalfOfAnyOf2X1b88b464>()
    return InlineV1SubscriptionsPostRequestFormOnBehalfOfXb0fbbfaaInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1SubscriptionsPostRequestFormOnBehalfOfAnyOf2X1b88b464) {
                    add(
                        "InlineV1SubscriptionsPostRequestFormOnBehalfOfAnyOf2X1b88b464: value does not match InlineV1SubscriptionsPostRequestFormOnBehalfOfAnyOf2X1b88b464",
                    )
                }
            },
    )
