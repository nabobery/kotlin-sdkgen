...
public sealed class InlineV1PaymentRecordsRepocb80PostRequestFormMetadataAnyOf2Xf0788f7b {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1PaymentRecordsRepocb80PostRequestFormMetadataAnyOf2Xf0788f7b =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1PaymentRecordsRepocb80PostRequestFormMetadataAnyOf2Xf0788f7b> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1PaymentRecordsRepocb80PostRequestFormMetadataAnyOf2Xf0788f7b",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1PaymentRecordsRepocb80PostRequestFormMetadataAnyOf2Xf0788f7b = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentRecordsRepocb80PostRequestFormMetadataAnyOf2Xf0788f7b,
        ) {
