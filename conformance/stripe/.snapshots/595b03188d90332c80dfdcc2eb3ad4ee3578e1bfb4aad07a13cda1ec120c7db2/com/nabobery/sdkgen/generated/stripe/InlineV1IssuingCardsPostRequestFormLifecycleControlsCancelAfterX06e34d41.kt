...
public class InlineV1IssuingCardsPostRequestFormLifecycleControlsCancelAfterX06e34d41(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1IssuingCardsPostRequestFormLifecycleControlsCancelAfterX06e34d41 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1IssuingCardsPostRequestFormLifecycleControlsCancelAfterX06e34d41> {
        override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1IssuingCardsPostRequestFormLifecycleControlsCancelAfterX06e34d41 {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1IssuingCardsPostRequestFormLifecycleControlsCancelAfterX06e34d41 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingCardsPostRequestFormLifecycleControlsCancelAfterX06e34d41,
        ) {
            val jsonEncoder =
...
public fun inlineV1IssuingCardsPostRequestFormLifecycleControlsCancelAfterX06e34d41(
    block: InlineV1IssuingCardsPostRequestFormLifecycleControlsCancelAfterX06e34d41.Builder.() -> Unit,
): InlineV1IssuingCardsPostRequestFormLifecycleControlsCancelAfterX06e34d41 =
    InlineV1IssuingCardsPostRequestFormLifecycleControlsCancelAfterX06e34d41.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1IssuingCardsPostRequestFormLifecycleControlsCancelAfterX06e34d41 is missing required property '" +
                    name +
                    "'",
            )
