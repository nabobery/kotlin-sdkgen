...
public sealed class InlineSetupIntentCancellationReasonX43ba9b44 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineSetupIntentCancellationReasonX43ba9b44 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineSetupIntentCancellationReasonX43ba9b44> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineSetupIntentCancellationReasonX43ba9b44",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineSetupIntentCancellationReasonX43ba9b44 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineSetupIntentCancellationReasonX43ba9b44,
        ) {
