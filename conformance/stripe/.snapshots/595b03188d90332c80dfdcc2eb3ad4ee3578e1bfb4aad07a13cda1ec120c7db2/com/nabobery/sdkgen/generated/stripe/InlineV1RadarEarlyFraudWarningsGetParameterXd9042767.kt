...
public class InlineV1RadarEarlyFraudWarningsGetParameterXd9042767 internal constructor(
    ...
    public val inlineV1RadarEarlyFraudWarningsGetParameterAnyOf1X47c71b1b:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1RadarEarlyFraudWarningsGetParameterAnyOf1X47c71b1b) {
                json
                    .decodeFromJsonElement<InlineV1RadarEarlyFraudWarningsGetParameterAnyOf1X47c71b1b>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1RadarEarlyFraudWarningsGetParameterXd9042767Branch>
        get() =
            buildSet {
                if (inspection.matchesInlineV1RadarEarlyFraudWarningsGetParameterAnyOf1X47c71b1b) {
                    add(
                        InlineV1RadarEarlyFraudWarningsGetParameterXd9042767Branch.InlineV1RadarEarlyFraudWarningsGetParameterAnyOf1X47c71b1b,
                    )
                }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1RadarEarlyFraudWarningsGetParameterXd9042767 {
            val inspection = inspectInlineV1RadarEarlyFraudWarningsGetParameterXd9042767(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1RadarEarlyFraudWarningsGetParameterXd9042767NoMatchException(
                    "InlineV1RadarEarlyFraudWarningsGetParameterXd9042767 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1RadarEarlyFraudWarningsGetParameterXd9042767> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1RadarEarlyFraudWarningsGetParameterXd9042767,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1RadarEarlyFraudWarningsGetParameterXd9042767",
...
private fun inspectInlineV1RadarEarlyFraudWarningsGetParameterXd9042767(
    element: JsonElement,
): InlineV1RadarEarlyFraudWarningsGetParameterXd9042767Inspection {
    val matchesInlineV1RadarEarlyFraudWarningsGetParameterAnyOf1X47c71b1b =
        element
            .isJsonDecodable<InlineV1RadarEarlyFraudWarningsGetParameterAnyOf1X47c71b1b>()
    ...
    return InlineV1RadarEarlyFraudWarningsGetParameterXd9042767Inspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1RadarEarlyFraudWarningsGetParameterAnyOf1X47c71b1b) {
                    add(
                        "InlineV1RadarEarlyFraudWarningsGetParameterAnyOf1X47c71b1b: value does not match InlineV1RadarEarlyFraudWarningsGetParameterAnyOf1X47c71b1b",
                    )
                }
