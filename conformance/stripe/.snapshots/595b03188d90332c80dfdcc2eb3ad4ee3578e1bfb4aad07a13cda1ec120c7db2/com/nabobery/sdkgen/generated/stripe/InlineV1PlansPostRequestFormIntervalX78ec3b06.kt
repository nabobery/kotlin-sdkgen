...
public sealed class InlineV1PlansPostRequestFormIntervalX78ec3b06 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1PlansPostRequestFormIntervalX78ec3b06 =
            when (value) {
                Day.value -> Day
                Month.value -> Month
                Week.value -> Week
    ...
    public object Serializer : KSerializer<InlineV1PlansPostRequestFormIntervalX78ec3b06> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1PlansPostRequestFormIntervalX78ec3b06",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1PlansPostRequestFormIntervalX78ec3b06 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PlansPostRequestFormIntervalX78ec3b06,
        ) {
