...
public class InlineV1RefundsGetParameterX7638b41e internal constructor(
    ...
    public val inlineV1RefundsGetParameterAnyOf1X55aafa1a: InlineV1RefundsGetParameterAnyOf1X55aafa1a?
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1RefundsGetParameterAnyOf1X55aafa1a) {
                json
                    .decodeFromJsonElement<InlineV1RefundsGetParameterAnyOf1X55aafa1a>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1RefundsGetParameterX7638b41eBranch>
        get() =
            buildSet {
                if (inspection.matchesInlineV1RefundsGetParameterAnyOf1X55aafa1a) {
                    add(
                        InlineV1RefundsGetParameterX7638b41eBranch.InlineV1RefundsGetParameterAnyOf1X55aafa1a,
                    )
                }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1RefundsGetParameterX7638b41e {
            val inspection = inspectInlineV1RefundsGetParameterX7638b41e(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1RefundsGetParameterX7638b41eNoMatchException(
                    "InlineV1RefundsGetParameterX7638b41e matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1RefundsGetParameterX7638b41e> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1RefundsGetParameterX7638b41e,
        ) {
...
private fun inspectInlineV1RefundsGetParameterX7638b41e(
    element: JsonElement,
): InlineV1RefundsGetParameterX7638b41eInspection {
    val matchesInlineV1RefundsGetParameterAnyOf1X55aafa1a =
        element
            .isJsonDecodable<InlineV1RefundsGetParameterAnyOf1X55aafa1a>()
    ...
    return InlineV1RefundsGetParameterX7638b41eInspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1RefundsGetParameterAnyOf1X55aafa1a) {
                    add(
                        "InlineV1RefundsGetParameterAnyOf1X55aafa1a: value does not match InlineV1RefundsGetParameterAnyOf1X55aafa1a",
                    )
                }
