...
public class InlineV1SourcesPostRequestFormX1a757f24(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1SourcesPostRequestFormX1a757f24 =
            InlineV1SourcesPostRequestFormX1a757f24(
                amount = amount,
                currency = currency,
                customer = customer,
                expand = expand,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1SourcesPostRequestFormX1a757f24 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1SourcesPostRequestFormX1a757f24> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1SourcesPostRequestFormX1a757f24 {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("InlineV1SourcesPostRequestFormX1a757f24 must be a JSON object")
            return InlineV1SourcesPostRequestFormX1a757f24(
                ...
                flow =
                    rawObject["flow"]?.let {
                        json.decodeFromJsonElement<InlineV1SourcesPostRequestFormFlowXa6144934>(
                            it,
                        )
                    },
                mandate =
                    rawObject["mandate"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SourcesPostRequestFormMandateX2f4d7dcf>(
                                it,
                            )
                    },
                ...
                owner =
                    rawObject["owner"]?.let {
                        json.decodeFromJsonElement<InlineV1SourcesPostRequestFormOwnerXced83c15>(
                            it,
                        )
                    },
                receiver =
                    rawObject["receiver"]?.let {
                        json.decodeFromJsonElement<InlineV1SourcesPostRequestFormReceiverX0d24f3db>(it)
                    },
                redirect =
                    rawObject["redirect"]?.let {
                        json.decodeFromJsonElement<InlineV1SourcesPostRequestFormRedirectXd9dd931b>(it)
                    },
                sourceOrder =
                    rawObject["source_order"]?.let {
                        json.decodeFromJsonElement<InlineV1SourcesPostRequestFormSourceOrderXbff41e36>(it)
                    },
                statementDescriptor =
                ...
                usage =
                    rawObject["usage"]?.let {
                        json.decodeFromJsonElement<InlineV1SourcesPostRequestFormUsageXb0573f22>(
                            it,
                        )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SourcesPostRequestFormX1a757f24,
        ) {
...
public fun inlineV1SourcesPostRequestFormX1a757f24(
    block: InlineV1SourcesPostRequestFormX1a757f24.Builder.() -> Unit,
): InlineV1SourcesPostRequestFormX1a757f24 = InlineV1SourcesPostRequestFormX1a757f24.build(block)
