...
public class CustomerSessionResourceComponentsResourcePaymentElement(
     ...
     */
    public val features: InlineCustomerSessionResourceComponentsResourcePaymentElementFeaturesXbc5f19a8? = null,
) {
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): CustomerSessionResourceComponentsResourcePaymentElement =
    ...
    public object Serializer : KSerializer<CustomerSessionResourceComponentsResourcePaymentElement> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "CustomerSessionResourceComponentsResourcePaymentElement must be a JSON object",
                    )
                ...
                features =
                    rawObject["features"]?.let { element ->
                        if (element ==
                            ...
                            json
                                .decodeFromJsonElement<InlineCustomerSessionResourceComponentsResourcePaymentElementFeaturesXbc5f19a8?>(
                                    element,
                                )
                        }
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: CustomerSessionResourceComponentsResourcePaymentElement,
        ) {
...
public fun customerSessionResourceComponentsResourcePaymentElement(
    block: CustomerSessionResourceComponentsResourcePaymentElement.Builder.() -> Unit,
): CustomerSessionResourceComponentsResourcePaymentElement =
    CustomerSessionResourceComponentsResourcePaymentElement.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "CustomerSessionResourceComponentsResourcePaymentElement is missing required property '" + name + "'",
            )
