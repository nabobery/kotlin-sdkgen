...
public class SubscriptionsTrialsResourceTrialSettings(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): SubscriptionsTrialsResourceTrialSettings =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<SubscriptionsTrialsResourceTrialSettings> {
        ...
        override fun deserialize(decoder: Decoder): SubscriptionsTrialsResourceTrialSettings {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("SubscriptionsTrialsResourceTrialSettings must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: SubscriptionsTrialsResourceTrialSettings,
        ) {
...
public fun subscriptionsTrialsResourceTrialSettings(
    block: SubscriptionsTrialsResourceTrialSettings.Builder.() -> Unit,
): SubscriptionsTrialsResourceTrialSettings = SubscriptionsTrialsResourceTrialSettings.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "SubscriptionsTrialsResourceTrialSettings is missing required property '" + name + "'",
            )
