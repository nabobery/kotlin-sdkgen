...
public class TreasuryOutboundPaymentsResourceAchTrackingDetails(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): TreasuryOutboundPaymentsResourceAchTrackingDetails =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<TreasuryOutboundPaymentsResourceAchTrackingDetails> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "TreasuryOutboundPaymentsResourceAchTrackingDetails must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: TreasuryOutboundPaymentsResourceAchTrackingDetails,
        ) {
...
public fun treasuryOutboundPaymentsResourceAchTrackingDetails(
    block: TreasuryOutboundPaymentsResourceAchTrackingDetails.Builder.() -> Unit,
): TreasuryOutboundPaymentsResourceAchTrackingDetails = TreasuryOutboundPaymentsResourceAchTrackingDetails.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "TreasuryOutboundPaymentsResourceAchTrackingDetails is missing required property '" + name + "'",
            )
