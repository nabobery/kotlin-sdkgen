...
@Serializable
public data class PaymentLinksResourceSubscriptionDataView(
    ...
    public val trialSettings: InlinePaymentLinksResourceSubscriptionDataTrialSettingsX443c7f30? = null,
)
...
public class PaymentLinksResourceSubscriptionData(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentLinksResourceSubscriptionData =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentLinksResourceSubscriptionData> {
        ...
        override fun deserialize(decoder: Decoder): PaymentLinksResourceSubscriptionData {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentLinksResourceSubscriptionData must be a JSON object")
            val invoiceSettings =
                json.decodeRequired<PaymentLinksResourceSubscriptionDataInvoiceSettings>(
                    rawObject,
                    "invoice_settings",
                )
            ...
            return PaymentLinksResourceSubscriptionData(
                ...
                trialPeriodDays =
                    rawObject["trial_period_days"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                trialSettings =
                    rawObject["trial_settings"]?.let { element ->
                        if (element ==
                            ...
                            json
                                .decodeFromJsonElement<InlinePaymentLinksResourceSubscriptionDataTrialSettingsX443c7f30?>(
                                    element,
                                )
                        }
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentLinksResourceSubscriptionData,
        ) {
...
public fun paymentLinksResourceSubscriptionData(
    block: PaymentLinksResourceSubscriptionData.Builder.() -> Unit,
): PaymentLinksResourceSubscriptionData = PaymentLinksResourceSubscriptionData.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "PaymentLinksResourceSubscriptionData is missing required property '" + name + "'",
            )
