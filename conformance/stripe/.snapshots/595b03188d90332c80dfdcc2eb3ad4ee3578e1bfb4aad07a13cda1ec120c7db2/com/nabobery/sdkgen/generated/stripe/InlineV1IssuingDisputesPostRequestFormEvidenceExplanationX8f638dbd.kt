...
internal data class InlineV1IssuingDisputesPostRequestFormEvidenceExplanationX8f638dbdInspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2X5a5f0a21,
            ).count { it }
}
...
public class InlineV1IssuingDisputesPostRequestFormEvidenceExplanationX8f638dbd internal constructor(
    ...
    private val inspection: InlineV1IssuingDisputesPostRequestFormEvidenceExplanationX8f638dbdInspection,
) {
    ...
    public val inlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2X5a5f0a21:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2X5a5f0a21) {
                json
                    .decodeFromJsonElement<InlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2X5a5f0a21>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1IssuingDisputesPostRequestFormEvidenceExplanationX8f638dbdBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2X5a5f0a21) {
                    add(
                        InlineV1IssuingDisputesPostRequestFormEvidenceExplanationX8f638dbdBranch.InlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2X5a5f0a21,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1IssuingDisputesPostRequestFormEvidenceExplanationX8f638dbd {
            val inspection = inspectInlineV1IssuingDisputesPostRequestFormEvidenceExplanationX8f638dbd(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1IssuingDisputesPostRequestFormEvidenceExplanationX8f638dbdNoMatchException(
                    "InlineV1IssuingDisputesPostRequestFormEvidenceExplanationX8f638dbd matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1IssuingDisputesPostRequestFormEvidenceExplanationX8f638dbd> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingDisputesPostRequestFormEvidenceExplanationX8f638dbd,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1IssuingDisputesPostRequestFormEvidenceExplanationX8f638dbd",
...
private fun inspectInlineV1IssuingDisputesPostRequestFormEvidenceExplanationX8f638dbd(
    element: JsonElement,
): InlineV1IssuingDisputesPostRequestFormEvidenceExplanationX8f638dbdInspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2X5a5f0a21 =
        element
            .isJsonDecodable<InlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2X5a5f0a21>()
    return InlineV1IssuingDisputesPostRequestFormEvidenceExplanationX8f638dbdInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2X5a5f0a21) {
                    add(
                        "InlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2X5a5f0a21: value does not match InlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2X5a5f0a21",
                    )
                }
            },
    )
