...
public class SetupIntentPaymentMethodOptionsPix(
    ...
    public class Builder {
        ...
        public fun build(): SetupIntentPaymentMethodOptionsPix =
    ...
    public object Serializer : KSerializer<SetupIntentPaymentMethodOptionsPix> {
        ...
        override fun deserialize(decoder: Decoder): SetupIntentPaymentMethodOptionsPix {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("SetupIntentPaymentMethodOptionsPix must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: SetupIntentPaymentMethodOptionsPix,
        ) {
...
public fun setupIntentPaymentMethodOptionsPix(
    block: SetupIntentPaymentMethodOptionsPix.Builder.() -> Unit,
): SetupIntentPaymentMethodOptionsPix = SetupIntentPaymentMethodOptionsPix.build(block)
