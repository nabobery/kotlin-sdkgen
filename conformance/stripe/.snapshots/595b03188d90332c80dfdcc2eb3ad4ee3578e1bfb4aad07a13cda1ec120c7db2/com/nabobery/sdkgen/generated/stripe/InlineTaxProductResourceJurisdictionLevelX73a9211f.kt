...
public sealed class InlineTaxProductResourceJurisdictionLevelX73a9211f {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineTaxProductResourceJurisdictionLevelX73a9211f =
            when (value) {
                City.value -> City
    ...
    public object Serializer : KSerializer<InlineTaxProductResourceJurisdictionLevelX73a9211f> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineTaxProductResourceJurisdictionLevelX73a9211f",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineTaxProductResourceJurisdictionLevelX73a9211f =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineTaxProductResourceJurisdictionLevelX73a9211f,
        ) {
