...
public class InlineDiscountsResourceStackableDiscountWithDiscountEndCouponX8a8c7eaa internal constructor(
    ...
    private val inspection: InlineDiscountsResourceStackableDiscountWithDiscountEndCouponX8a8c7eaaInspection,
) {
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineDiscountsResourceStackableDiscountWithDiscountEndCouponX8a8c7eaaBranch.Branch1,
                    )
                }
                if (inspection.matchesCoupon) {
                    add(
                        InlineDiscountsResourceStackableDiscountWithDiscountEndCouponX8a8c7eaaBranch.Coupon,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineDiscountsResourceStackableDiscountWithDiscountEndCouponX8a8c7eaa {
            val inspection = inspectInlineDiscountsResourceStackableDiscountWithDiscountEndCouponX8a8c7eaa(raw)
            if (inspection.matchCount == 0) {
                throw InlineDiscountsResourceStackableDiscountWithDiscountEndCouponX8a8c7eaaNoMatchException(
                    "InlineDiscountsResourceStackableDiscountWithDiscountEndCouponX8a8c7eaa matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineDiscountsResourceStackableDiscountWithDiscountEndCouponX8a8c7eaa> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineDiscountsResourceStackableDiscountWithDiscountEndCouponX8a8c7eaa,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineDiscountsResourceStackableDiscountWithDiscountEndCouponX8a8c7eaa",
...
private fun inspectInlineDiscountsResourceStackableDiscountWithDiscountEndCouponX8a8c7eaa(
    element: JsonElement,
