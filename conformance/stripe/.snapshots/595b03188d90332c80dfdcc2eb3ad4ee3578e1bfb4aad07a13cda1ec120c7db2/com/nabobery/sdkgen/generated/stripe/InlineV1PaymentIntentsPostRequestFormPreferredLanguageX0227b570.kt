...
public sealed class InlineV1PaymentIntentsPostRequestFormPreferredLanguageX0227b570 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1PaymentIntentsPostRequestFormPreferredLanguageX0227b570 =
            when (value) {
                Value.value -> Value
                De.value -> De
                En.value -> En
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormPreferredLanguageX0227b570> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1PaymentIntentsPostRequestFormPreferredLanguageX0227b570",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1PaymentIntentsPostRequestFormPreferredLanguageX0227b570 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormPreferredLanguageX0227b570,
        ) {
