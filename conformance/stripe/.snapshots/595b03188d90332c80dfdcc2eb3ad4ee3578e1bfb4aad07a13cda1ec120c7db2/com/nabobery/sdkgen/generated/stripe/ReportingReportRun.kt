        ...
        override fun deserialize(decoder: Decoder): ReportingReportRun {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("ReportingReportRun must be a JSON object")
            ...
            val parameters =
                json.decodeRequired<FinancialReportingFinanceReportRunRunParameters>(
                    rawObject,
                    "parameters",
                )
                ...
                result =
                    rawObject["result"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineReportingReportRunResultXb663d9c3?>(element)
                        }
                    },
                succeededAt =
...
public fun reportingReportRun(block: ReportingReportRun.Builder.() -> Unit): ReportingReportRun =
    ReportingReportRun.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("ReportingReportRun is missing required property '" + name + "'")
