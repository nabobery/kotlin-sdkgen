...
public class PaymentMethodOptionsGrabpay(
    ...
    public class Builder {
        ...
        public fun build(): PaymentMethodOptionsGrabpay =
    ...
    public object Serializer : KSerializer<PaymentMethodOptionsGrabpay> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodOptionsGrabpay {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodOptionsGrabpay must be a JSON object")
            return PaymentMethodOptionsGrabpay(
                setupFutureUsage =
                    rawObject["setup_future_usage"]?.let {
                        json.decodeFromJsonElement<InlinePaymentMethodOptionsGrabpaySetupFutureUsageX42d99b93>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentMethodOptionsGrabpay,
        ) {
...
public fun paymentMethodOptionsGrabpay(
    block: PaymentMethodOptionsGrabpay.Builder.() -> Unit,
): PaymentMethodOptionsGrabpay = PaymentMethodOptionsGrabpay.build(block)
