...
public sealed class InlineV1CustomersPostRequestFormMetadataAnyOf2Xd3025eaa {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1CustomersPostRequestFormMetadataAnyOf2Xd3025eaa =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1CustomersPostRequestFormMetadataAnyOf2Xd3025eaa> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1CustomersPostRequestFormMetadataAnyOf2Xd3025eaa",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1CustomersPostRequestFormMetadataAnyOf2Xd3025eaa =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersPostRequestFormMetadataAnyOf2Xd3025eaa,
        ) {
