...
public sealed class InlineDeletedInvoiceObjectValueXaf8c3dcd {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineDeletedInvoiceObjectValueXaf8c3dcd =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineDeletedInvoiceObjectValueXaf8c3dcd> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineDeletedInvoiceObjectValueXaf8c3dcd",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineDeletedInvoiceObjectValueXaf8c3dcd =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineDeletedInvoiceObjectValueXaf8c3dcd,
        ) {
