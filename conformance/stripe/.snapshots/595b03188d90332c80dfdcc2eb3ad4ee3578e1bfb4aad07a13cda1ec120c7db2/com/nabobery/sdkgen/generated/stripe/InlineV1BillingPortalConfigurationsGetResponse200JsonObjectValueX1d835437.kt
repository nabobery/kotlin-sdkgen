...
public sealed class InlineV1BillingPortalConfigurationsGetResponse200JsonObjectValueX1d835437 {
    ...
    public object Serializer : KSerializer<InlineV1BillingPortalConfigurationsGetResponse200JsonObjectValueX1d835437> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1BillingPortalConfigurationsGetResponse200JsonObjectValueX1d835437",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1BillingPortalConfigurationsGetResponse200JsonObjectValueX1d835437 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1BillingPortalConfigurationsGetResponse200JsonObjectValueX1d835437,
        ) {
