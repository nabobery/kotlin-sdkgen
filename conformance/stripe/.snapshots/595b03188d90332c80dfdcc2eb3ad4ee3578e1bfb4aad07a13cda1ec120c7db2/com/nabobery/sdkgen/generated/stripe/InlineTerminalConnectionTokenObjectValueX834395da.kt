...
public sealed class InlineTerminalConnectionTokenObjectValueX834395da {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineTerminalConnectionTokenObjectValueX834395da =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineTerminalConnectionTokenObjectValueX834395da> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineTerminalConnectionTokenObjectValueX834395da",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineTerminalConnectionTokenObjectValueX834395da =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineTerminalConnectionTokenObjectValueX834395da,
        ) {
