...
public class GelatoEmailReport(
    ...
    public object Serializer : KSerializer<GelatoEmailReport> {
        ...
        override fun deserialize(decoder: Decoder): GelatoEmailReport {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("GelatoEmailReport must be a JSON object")
                ...
                error =
                    rawObject["error"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineGelatoEmailReportErrorXf7cb69a6?>(element)
                        }
                    },
            )
        }
...
public fun gelatoEmailReport(block: GelatoEmailReport.Builder.() -> Unit): GelatoEmailReport =
    GelatoEmailReport.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("GelatoEmailReport is missing required property '" + name + "'")
