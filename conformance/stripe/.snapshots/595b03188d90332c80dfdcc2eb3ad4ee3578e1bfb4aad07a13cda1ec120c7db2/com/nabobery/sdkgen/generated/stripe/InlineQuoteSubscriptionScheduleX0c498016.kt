...
public class InlineQuoteSubscriptionScheduleX0c498016 internal constructor(
    ...
    public val subscriptionSchedule: SubscriptionSchedule? by
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesSubscriptionSchedule) json.decodeFromJsonElement<SubscriptionSchedule>(raw) else null
        }
    ...
    public val matchedBranches: Set<InlineQuoteSubscriptionScheduleX0c498016Branch>
        get() =
            buildSet {
                ...
                if (inspection.matchesSubscriptionSchedule) {
                    add(
                        InlineQuoteSubscriptionScheduleX0c498016Branch.SubscriptionSchedule,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineQuoteSubscriptionScheduleX0c498016 {
            val inspection = inspectInlineQuoteSubscriptionScheduleX0c498016(raw)
            if (inspection.matchCount == 0) {
                throw InlineQuoteSubscriptionScheduleX0c498016NoMatchException(
                    "InlineQuoteSubscriptionScheduleX0c498016 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineQuoteSubscriptionScheduleX0c498016> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineQuoteSubscriptionScheduleX0c498016,
        ) {
...
private fun inspectInlineQuoteSubscriptionScheduleX0c498016(
    element: JsonElement,
): InlineQuoteSubscriptionScheduleX0c498016Inspection {
