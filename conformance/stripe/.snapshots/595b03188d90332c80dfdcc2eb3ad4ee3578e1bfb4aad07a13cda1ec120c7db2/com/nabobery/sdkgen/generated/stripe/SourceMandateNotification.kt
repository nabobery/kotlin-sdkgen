...
public class SourceMandateNotification(
    ...
    public object Serializer : KSerializer<SourceMandateNotification> {
        ...
        override fun deserialize(decoder: Decoder): SourceMandateNotification {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("SourceMandateNotification must be a JSON object")
            val created = json.decodeRequired<Int>(rawObject, "created")
            val id = json.decodeRequired<String>(rawObject, "id")
            val livemode = json.decodeRequired<Boolean>(rawObject, "livemode")
            val objectValue =
                json.decodeRequired<InlineSourceMandateNotificationObjectValueXf8a847b1>(
                    rawObject,
                    "object",
                )
            ...
            return SourceMandateNotification(
                ...
                acssDebit =
                    rawObject["acss_debit"]?.let {
                        json.decodeFromJsonElement<SourceMandateNotificationAcssDebitData>(
                            it,
                        )
                    },
                amount =
                ...
                bacsDebit =
                    rawObject["bacs_debit"]?.let {
                        json
                            .decodeFromJsonElement<SourceMandateNotificationBacsDebitData>(
                                it,
                            )
                    },
                sepaDebit =
                    rawObject["sepa_debit"]?.let {
                        json.decodeFromJsonElement<SourceMandateNotificationSepaDebitData>(
                            it,
                        )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: SourceMandateNotification,
        ) {
...
public fun sourceMandateNotification(block: SourceMandateNotification.Builder.() -> Unit): SourceMandateNotification =
    SourceMandateNotification.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException("SourceMandateNotification is missing required property '" + name + "'")
