...
public sealed class InlineV1AccountsPostRequestFormMetadataAnyOf2X6609aeec {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1AccountsPostRequestFormMetadataAnyOf2X6609aeec =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1AccountsPostRequestFormMetadataAnyOf2X6609aeec> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1AccountsPostRequestFormMetadataAnyOf2X6609aeec",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1AccountsPostRequestFormMetadataAnyOf2X6609aeec =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPostRequestFormMetadataAnyOf2X6609aeec,
        ) {
