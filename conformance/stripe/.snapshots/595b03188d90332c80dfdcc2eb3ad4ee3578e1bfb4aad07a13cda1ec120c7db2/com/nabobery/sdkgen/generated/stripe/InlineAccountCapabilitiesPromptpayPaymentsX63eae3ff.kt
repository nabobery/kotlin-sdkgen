...
public sealed class InlineAccountCapabilitiesPromptpayPaymentsX63eae3ff {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineAccountCapabilitiesPromptpayPaymentsX63eae3ff =
            when (value) {
                Active.value -> Active
    ...
    public object Serializer : KSerializer<InlineAccountCapabilitiesPromptpayPaymentsX63eae3ff> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineAccountCapabilitiesPromptpayPaymentsX63eae3ff",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineAccountCapabilitiesPromptpayPaymentsX63eae3ff =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineAccountCapabilitiesPromptpayPaymentsX63eae3ff,
        ) {
