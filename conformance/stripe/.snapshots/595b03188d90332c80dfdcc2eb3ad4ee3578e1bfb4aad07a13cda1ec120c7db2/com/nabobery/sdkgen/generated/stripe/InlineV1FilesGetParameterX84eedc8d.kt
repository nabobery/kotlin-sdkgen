...
public class InlineV1FilesGetParameterX84eedc8d internal constructor(
    ...
    public val inlineV1FilesGetParameterAnyOf1X2b9c5e02: InlineV1FilesGetParameterAnyOf1X2b9c5e02? by
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1FilesGetParameterAnyOf1X2b9c5e02) {
                json
                    .decodeFromJsonElement<InlineV1FilesGetParameterAnyOf1X2b9c5e02>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1FilesGetParameterX84eedc8dBranch>
        get() =
            buildSet {
                if (inspection.matchesInlineV1FilesGetParameterAnyOf1X2b9c5e02) {
                    add(
                        InlineV1FilesGetParameterX84eedc8dBranch.InlineV1FilesGetParameterAnyOf1X2b9c5e02,
                    )
                }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1FilesGetParameterX84eedc8d {
            val inspection = inspectInlineV1FilesGetParameterX84eedc8d(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1FilesGetParameterX84eedc8dNoMatchException(
                    "InlineV1FilesGetParameterX84eedc8d matched 0 branches: " + inspection.failures.joinToString("; "),
                )
            }
    ...
    public object Serializer : KSerializer<InlineV1FilesGetParameterX84eedc8d> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1FilesGetParameterX84eedc8d,
        ) {
...
private fun inspectInlineV1FilesGetParameterX84eedc8d(
    element: JsonElement,
): InlineV1FilesGetParameterX84eedc8dInspection {
    val matchesInlineV1FilesGetParameterAnyOf1X2b9c5e02 =
        element
            .isJsonDecodable<InlineV1FilesGetParameterAnyOf1X2b9c5e02>()
    ...
    return InlineV1FilesGetParameterX84eedc8dInspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1FilesGetParameterAnyOf1X2b9c5e02) {
                    add(
                        "InlineV1FilesGetParameterAnyOf1X2b9c5e02: value does not match InlineV1FilesGetParameterAnyOf1X2b9c5e02",
                    )
                }
