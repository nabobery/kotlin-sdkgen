...
public class PortalSubscriptionCancel(
    ...
    public object Serializer : KSerializer<PortalSubscriptionCancel> {
        ...
        override fun deserialize(decoder: Decoder): PortalSubscriptionCancel {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PortalSubscriptionCancel must be a JSON object")
            val cancellationReason =
                json.decodeRequired<PortalSubscriptionCancellationReason>(
                    rawObject,
                    "cancellation_reason",
                )
            ...
            val prorationBehavior =
                json.decodeRequired<InlinePortalSubscriptionCancelProrationBehaviorX1f0eff50>(
                    rawObject,
                    "proration_behavior",
                )
            return PortalSubscriptionCancel(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PortalSubscriptionCancel,
        ) {
...
public fun portalSubscriptionCancel(block: PortalSubscriptionCancel.Builder.() -> Unit): PortalSubscriptionCancel =
    PortalSubscriptionCancel.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException("PortalSubscriptionCancel is missing required property '" + name + "'")
