...
public sealed class InlineV1PaymentIntentsPostRequestFormAllowRedirectsXd0267ccc {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1PaymentIntentsPostRequestFormAllowRedirectsXd0267ccc =
            when (value) {
                Always.value -> Always
                Never.value -> Never
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormAllowRedirectsXd0267ccc> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1PaymentIntentsPostRequestFormAllowRedirectsXd0267ccc",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1PaymentIntentsPostRequestFormAllowRedirectsXd0267ccc =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormAllowRedirectsXd0267ccc,
        ) {
