...
public sealed class InlineV1TestHelpersIssuingc1dfPostRequestFormPurchaseTypeX2d300548 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1TestHelpersIssuingc1dfPostRequestFormPurchaseTypeX2d300548 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1TestHelpersIssuingc1dfPostRequestFormPurchaseTypeX2d300548> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1TestHelpersIssuingc1dfPostRequestFormPurchaseTypeX2d300548",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1TestHelpersIssuingc1dfPostRequestFormPurchaseTypeX2d300548 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TestHelpersIssuingc1dfPostRequestFormPurchaseTypeX2d300548,
        ) {
