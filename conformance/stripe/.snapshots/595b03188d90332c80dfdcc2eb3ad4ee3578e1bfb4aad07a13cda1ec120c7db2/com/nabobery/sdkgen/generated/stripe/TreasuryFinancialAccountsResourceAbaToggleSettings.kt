...
public class TreasuryFinancialAccountsResourceAbaToggleSettings(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): TreasuryFinancialAccountsResourceAbaToggleSettings =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<TreasuryFinancialAccountsResourceAbaToggleSettings> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "TreasuryFinancialAccountsResourceAbaToggleSettings must be a JSON object",
                    )
            val requested = json.decodeRequired<Boolean>(rawObject, "requested")
            val status =
                json.decodeRequired<InlineTreasuryFinancialAccountsResourceAbaToggleSettingsStatusXf80f6c96>(
                    rawObject,
                    "status",
                )
            val statusDetails =
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: TreasuryFinancialAccountsResourceAbaToggleSettings,
        ) {
...
public fun treasuryFinancialAccountsResourceAbaToggleSettings(
    block: TreasuryFinancialAccountsResourceAbaToggleSettings.Builder.() -> Unit,
): TreasuryFinancialAccountsResourceAbaToggleSettings = TreasuryFinancialAccountsResourceAbaToggleSettings.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "TreasuryFinancialAccountsResourceAbaToggleSettings is missing required property '" + name + "'",
            )
