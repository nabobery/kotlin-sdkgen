...
public class InlineQuotesResourceFromQuoteQuoteX29f217fa internal constructor(
    ...
    public val quote: Quote? by
        lazy(
            LazyThreadSafetyMode.NONE,
        ) { if (inspection.matchesQuote) json.decodeFromJsonElement<Quote>(raw) else null }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineQuotesResourceFromQuoteQuoteX29f217fa {
            val inspection = inspectInlineQuotesResourceFromQuoteQuoteX29f217fa(raw)
            if (inspection.matchCount == 0) {
                throw InlineQuotesResourceFromQuoteQuoteX29f217faNoMatchException(
                    "InlineQuotesResourceFromQuoteQuoteX29f217fa matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineQuotesResourceFromQuoteQuoteX29f217fa> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineQuotesResourceFromQuoteQuoteX29f217fa,
        ) {
...
private fun inspectInlineQuotesResourceFromQuoteQuoteX29f217fa(
    element: JsonElement,
): InlineQuotesResourceFromQuoteQuoteX29f217faInspection {
