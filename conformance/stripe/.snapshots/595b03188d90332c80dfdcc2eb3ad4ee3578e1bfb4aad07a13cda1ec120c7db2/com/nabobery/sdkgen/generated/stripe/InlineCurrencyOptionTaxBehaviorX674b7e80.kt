...
public sealed class InlineCurrencyOptionTaxBehaviorX674b7e80 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineCurrencyOptionTaxBehaviorX674b7e80 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineCurrencyOptionTaxBehaviorX674b7e80> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineCurrencyOptionTaxBehaviorX674b7e80",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineCurrencyOptionTaxBehaviorX674b7e80 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineCurrencyOptionTaxBehaviorX674b7e80,
        ) {
