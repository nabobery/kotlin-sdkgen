...
public sealed class InlineGelatoIdNumberReportIdNumberTypeX5d9135a3 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineGelatoIdNumberReportIdNumberTypeX5d9135a3 =
            when (value) {
                BrCpf.value -> BrCpf
                SgNric.value -> SgNric
                UsSsn.value -> UsSsn
    ...
    public object Serializer : KSerializer<InlineGelatoIdNumberReportIdNumberTypeX5d9135a3> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineGelatoIdNumberReportIdNumberTypeX5d9135a3",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineGelatoIdNumberReportIdNumberTypeX5d9135a3 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineGelatoIdNumberReportIdNumberTypeX5d9135a3,
        ) {
