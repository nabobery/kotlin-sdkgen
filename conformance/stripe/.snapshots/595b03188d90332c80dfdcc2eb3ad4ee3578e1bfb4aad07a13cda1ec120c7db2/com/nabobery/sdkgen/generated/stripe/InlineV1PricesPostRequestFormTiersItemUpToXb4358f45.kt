...
public class InlineV1PricesPostRequestFormTiersItemUpToXb4358f45 internal constructor(
    ...
    public val inlineV1PricesPostRequestFormTiersItemUpToAnyOf1X8579de48:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1PricesPostRequestFormTiersItemUpToAnyOf1X8579de48) {
                json
                    .decodeFromJsonElement<InlineV1PricesPostRequestFormTiersItemUpToAnyOf1X8579de48>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1PricesPostRequestFormTiersItemUpToXb4358f45Branch>
        get() =
            buildSet {
                if (inspection.matchesInlineV1PricesPostRequestFormTiersItemUpToAnyOf1X8579de48) {
                    add(
                        InlineV1PricesPostRequestFormTiersItemUpToXb4358f45Branch.InlineV1PricesPostRequestFormTiersItemUpToAnyOf1X8579de48,
                    )
                }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1PricesPostRequestFormTiersItemUpToXb4358f45 {
            val inspection = inspectInlineV1PricesPostRequestFormTiersItemUpToXb4358f45(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1PricesPostRequestFormTiersItemUpToXb4358f45NoMatchException(
                    "InlineV1PricesPostRequestFormTiersItemUpToXb4358f45 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1PricesPostRequestFormTiersItemUpToXb4358f45> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PricesPostRequestFormTiersItemUpToXb4358f45,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1PricesPostRequestFormTiersItemUpToXb4358f45",
...
private fun inspectInlineV1PricesPostRequestFormTiersItemUpToXb4358f45(
    element: JsonElement,
): InlineV1PricesPostRequestFormTiersItemUpToXb4358f45Inspection {
    val matchesInlineV1PricesPostRequestFormTiersItemUpToAnyOf1X8579de48 =
        element
            .isJsonDecodable<InlineV1PricesPostRequestFormTiersItemUpToAnyOf1X8579de48>()
    ...
    return InlineV1PricesPostRequestFormTiersItemUpToXb4358f45Inspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1PricesPostRequestFormTiersItemUpToAnyOf1X8579de48) {
                    add(
                        "InlineV1PricesPostRequestFormTiersItemUpToAnyOf1X8579de48: value does not match InlineV1PricesPostRequestFormTiersItemUpToAnyOf1X8579de48",
                    )
                }
