...
public class InlineBillingBillResourceInvoicingTaxesTaxRateDetailsTaxRateX7af9dd53 internal constructor(
    ...
    private val inspection: InlineBillingBillResourceInvoicingTaxesTaxRateDetailsTaxRateX7af9dd53Inspection,
) {
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineBillingBillResourceInvoicingTaxesTaxRateDetailsTaxRateX7af9dd53Branch.Branch1,
                    )
                }
                if (inspection.matchesTaxRate) {
                    add(
                        InlineBillingBillResourceInvoicingTaxesTaxRateDetailsTaxRateX7af9dd53Branch.TaxRate,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineBillingBillResourceInvoicingTaxesTaxRateDetailsTaxRateX7af9dd53 {
            val inspection = inspectInlineBillingBillResourceInvoicingTaxesTaxRateDetailsTaxRateX7af9dd53(raw)
            if (inspection.matchCount == 0) {
                throw InlineBillingBillResourceInvoicingTaxesTaxRateDetailsTaxRateX7af9dd53NoMatchException(
                    "InlineBillingBillResourceInvoicingTaxesTaxRateDetailsTaxRateX7af9dd53 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineBillingBillResourceInvoicingTaxesTaxRateDetailsTaxRateX7af9dd53> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineBillingBillResourceInvoicingTaxesTaxRateDetailsTaxRateX7af9dd53,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineBillingBillResourceInvoicingTaxesTaxRateDetailsTaxRateX7af9dd53",
...
private fun inspectInlineBillingBillResourceInvoicingTaxesTaxRateDetailsTaxRateX7af9dd53(
    element: JsonElement,
