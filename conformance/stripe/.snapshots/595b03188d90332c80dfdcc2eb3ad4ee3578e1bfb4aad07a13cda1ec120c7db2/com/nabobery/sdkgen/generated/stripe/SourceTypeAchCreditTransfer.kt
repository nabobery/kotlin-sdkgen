...
public class SourceTypeAchCreditTransfer(
    ...
    public class Builder {
        ...
        public fun build(): SourceTypeAchCreditTransfer =
    ...
    public object Serializer : KSerializer<SourceTypeAchCreditTransfer> {
        ...
        override fun deserialize(decoder: Decoder): SourceTypeAchCreditTransfer {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("SourceTypeAchCreditTransfer must be a JSON object")
            return SourceTypeAchCreditTransfer(
                ...
                refundAccountHolderType =
                    rawObject["refund_account_holder_type"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                refundRoutingNumber =
                    rawObject["refund_routing_number"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: SourceTypeAchCreditTransfer,
        ) {
...
public fun sourceTypeAchCreditTransfer(
    block: SourceTypeAchCreditTransfer.Builder.() -> Unit,
): SourceTypeAchCreditTransfer = SourceTypeAchCreditTransfer.build(block)
