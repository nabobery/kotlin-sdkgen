...
public class IssuingCardholderAddress(
    ...
    public object Serializer : KSerializer<IssuingCardholderAddress> {
        ...
        override fun deserialize(decoder: Decoder): IssuingCardholderAddress {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("IssuingCardholderAddress must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: IssuingCardholderAddress,
        ) {
...
public fun issuingCardholderAddress(block: IssuingCardholderAddress.Builder.() -> Unit): IssuingCardholderAddress =
    IssuingCardholderAddress.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException("IssuingCardholderAddress is missing required property '" + name + "'")
