...
public class PersonAdditionalTosAcceptances(
    ...
    public class Builder {
        ...
        public fun build(): PersonAdditionalTosAcceptances =
    ...
    public object Serializer : KSerializer<PersonAdditionalTosAcceptances> {
        ...
        override fun deserialize(decoder: Decoder): PersonAdditionalTosAcceptances {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PersonAdditionalTosAcceptances must be a JSON object")
                ...
                account =
                    rawObject["account"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePersonAdditionalTosAcceptancesAccountX74bb852f?>(element)
                        }
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PersonAdditionalTosAcceptances,
        ) {
...
public fun personAdditionalTosAcceptances(
    block: PersonAdditionalTosAcceptances.Builder.() -> Unit,
): PersonAdditionalTosAcceptances = PersonAdditionalTosAcceptances.build(block)
