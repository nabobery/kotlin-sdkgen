...
public class Balance(
     ...
     */
    public val connectReserved: List<BalanceAmount>? = null,
    /**
     * Funds that you can pay out using Instant Payouts.
     */
    public val instantAvailable: List<BalanceAmountNet>? = null,
    ...
    public class Builder {
        ...
        public var pending: List<BalanceAmount>
            get() = requireNotNull(pendingValue) { "pending is required" }
            set(`value`) {
                pendingValue = value
            }
         ...
         */
        public var connectReserved: List<BalanceAmount>? = null

        /**
         * Funds that you can pay out using Instant Payouts.
         */
        public var instantAvailable: List<BalanceAmountNet>? = null
    ...
    public object Serializer : KSerializer<Balance> {
        ...
        override fun deserialize(decoder: Decoder): Balance {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("Balance must be a JSON object")
            ...
            return Balance(
                ...
                pending = pending,
                connectReserved =
                    rawObject["connect_reserved"]?.let {
                        json.decodeFromJsonElement<List<BalanceAmount>>(
                            it,
                        )
                    },
                instantAvailable =
                    rawObject["instant_available"]?.let {
                        json.decodeFromJsonElement<List<BalanceAmountNet>>(
                            it,
                        )
                    },
                issuing = rawObject["issuing"]?.let { json.decodeFromJsonElement<BalanceDetail>(it) },
                refundAndDisputePrefunding =
                    rawObject["refund_and_dispute_prefunding"]?.let {
                        json.decodeFromJsonElement<BalanceDetailUngated>(it)
                    },
            )
        }
        ...
        override fun serialize(
            ...
            val raw =
                buildJsonObject {
                    ...
                    value.refundAndDisputePrefunding?.let {
                        put(
