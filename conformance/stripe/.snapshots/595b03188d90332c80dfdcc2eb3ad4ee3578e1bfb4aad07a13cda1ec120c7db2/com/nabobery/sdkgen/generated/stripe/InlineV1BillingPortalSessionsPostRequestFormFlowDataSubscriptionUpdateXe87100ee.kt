...
public class InlineV1BillingPortalSessionsPostRequestFormFlowDataSubscriptionUpdateXe87100ee(
    ...
    public object Serializer : KSerializer<InlineV1BillingPortalSessionsPostRequestFormFlowDataSubscriptionUpdateXe87100ee> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1BillingPortalSessionsPostRequestFormFlowDataSubscriptionUpdateXe87100ee must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1BillingPortalSessionsPostRequestFormFlowDataSubscriptionUpdateXe87100ee,
        ) {
            val jsonEncoder =
...
public fun inlineV1BillingPortalSessionsPostRequestFormFlowDataSubscriptionUpdateXe87100ee(
    block: InlineV1BillingPortalSessionsPostRequestFormFlowDataSubscriptionUpdateXe87100ee.Builder.() -> Unit,
): InlineV1BillingPortalSessionsPostRequestFormFlowDataSubscriptionUpdateXe87100ee =
    InlineV1BillingPortalSessionsPostRequestFormFlowDataSubscriptionUpdateXe87100ee.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1BillingPortalSessionsPostRequestFormFlowDataSubscriptionUpdateXe87100ee is missing required property '" +
                    name +
                    "'",
            )
