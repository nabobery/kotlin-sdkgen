...
public class InlineV1PricesPostRequestFormProductDataX52465f20(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PricesPostRequestFormProductDataX52465f20 =
    ...
    public object Serializer : KSerializer<InlineV1PricesPostRequestFormProductDataX52465f20> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PricesPostRequestFormProductDataX52465f20 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PricesPostRequestFormProductDataX52465f20,
        ) {
...
public fun inlineV1PricesPostRequestFormProductDataX52465f20(
    block: InlineV1PricesPostRequestFormProductDataX52465f20.Builder.() -> Unit,
): InlineV1PricesPostRequestFormProductDataX52465f20 = InlineV1PricesPostRequestFormProductDataX52465f20.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PricesPostRequestFormProductDataX52465f20 is missing required property '" + name + "'",
            )
