...
public class LineItemsDiscountAmount(
    ...
    public object Serializer : KSerializer<LineItemsDiscountAmount> {
        ...
        override fun deserialize(decoder: Decoder): LineItemsDiscountAmount {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("LineItemsDiscountAmount must be a JSON object")
...
public fun lineItemsDiscountAmount(block: LineItemsDiscountAmount.Builder.() -> Unit): LineItemsDiscountAmount =
    LineItemsDiscountAmount.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("LineItemsDiscountAmount is missing required property '" + name + "'")
