...
public class InlineV1AccountsPostRequestFormSettingsCardPaymentsDeclineOnX1632b32d(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1AccountsPostRequestFormSettingsCardPaymentsDeclineOnX1632b32d =
            InlineV1AccountsPostRequestFormSettingsCardPaymentsDeclineOnX1632b32d(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1AccountsPostRequestFormSettingsCardPaymentsDeclineOnX1632b32d = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1AccountsPostRequestFormSettingsCardPaymentsDeclineOnX1632b32d> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountsPostRequestFormSettingsCardPaymentsDeclineOnX1632b32d must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPostRequestFormSettingsCardPaymentsDeclineOnX1632b32d,
        ) {
            val jsonEncoder =
...
public fun inlineV1AccountsPostRequestFormSettingsCardPaymentsDeclineOnX1632b32d(
    block: InlineV1AccountsPostRequestFormSettingsCardPaymentsDeclineOnX1632b32d.Builder.() -> Unit,
): InlineV1AccountsPostRequestFormSettingsCardPaymentsDeclineOnX1632b32d =
    InlineV1AccountsPostRequestFormSettingsCardPaymentsDeclineOnX1632b32d.build(block)
