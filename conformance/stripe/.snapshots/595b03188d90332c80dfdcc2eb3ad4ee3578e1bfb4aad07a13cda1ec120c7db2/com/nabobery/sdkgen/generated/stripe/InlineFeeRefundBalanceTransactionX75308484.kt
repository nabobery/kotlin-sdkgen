...
public class InlineFeeRefundBalanceTransactionX75308484 internal constructor(
        ...
        get() =
            buildSet {
                ...
                if (inspection.matchesBalanceTransaction) {
                    add(
                        InlineFeeRefundBalanceTransactionX75308484Branch.BalanceTransaction,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineFeeRefundBalanceTransactionX75308484 {
            val inspection = inspectInlineFeeRefundBalanceTransactionX75308484(raw)
            if (inspection.matchCount == 0) {
                throw InlineFeeRefundBalanceTransactionX75308484NoMatchException(
                    "InlineFeeRefundBalanceTransactionX75308484 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineFeeRefundBalanceTransactionX75308484> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineFeeRefundBalanceTransactionX75308484,
        ) {
...
private fun inspectInlineFeeRefundBalanceTransactionX75308484(
    element: JsonElement,
): InlineFeeRefundBalanceTransactionX75308484Inspection {
