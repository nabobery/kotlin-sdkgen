...
public sealed class InlineV1CouponsPostRequestFormMetadataAnyOf2X286f7252 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1CouponsPostRequestFormMetadataAnyOf2X286f7252 =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1CouponsPostRequestFormMetadataAnyOf2X286f7252> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1CouponsPostRequestFormMetadataAnyOf2X286f7252",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1CouponsPostRequestFormMetadataAnyOf2X286f7252 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CouponsPostRequestFormMetadataAnyOf2X286f7252,
        ) {
