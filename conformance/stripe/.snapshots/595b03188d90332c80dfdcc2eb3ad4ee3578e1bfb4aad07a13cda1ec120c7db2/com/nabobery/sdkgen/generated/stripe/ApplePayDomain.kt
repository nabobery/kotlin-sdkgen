        ...
        override fun deserialize(decoder: Decoder): ApplePayDomain {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("ApplePayDomain must be a JSON object")
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("ApplePayDomain is missing required property '" + name + "'")
