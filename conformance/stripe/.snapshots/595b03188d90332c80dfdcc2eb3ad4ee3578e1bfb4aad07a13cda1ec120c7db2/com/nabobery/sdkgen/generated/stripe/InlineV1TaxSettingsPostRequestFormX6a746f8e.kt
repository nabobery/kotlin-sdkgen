...
public class InlineV1TaxSettingsPostRequestFormX6a746f8e(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1TaxSettingsPostRequestFormX6a746f8e =
            InlineV1TaxSettingsPostRequestFormX6a746f8e(
                defaults = defaults,
                expand = expand,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TaxSettingsPostRequestFormX6a746f8e =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TaxSettingsPostRequestFormX6a746f8e> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1TaxSettingsPostRequestFormX6a746f8e {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("InlineV1TaxSettingsPostRequestFormX6a746f8e must be a JSON object")
            return InlineV1TaxSettingsPostRequestFormX6a746f8e(
                defaults =
                    rawObject["defaults"]?.let {
                        json.decodeFromJsonElement<InlineV1TaxSettingsPostRequestFormDefaultsX750fe3e3>(it)
                    },
                expand = rawObject["expand"]?.let { json.decodeFromJsonElement<List<String>>(it) },
                headOffice =
                    rawObject["head_office"]?.let {
                        json.decodeFromJsonElement<InlineV1TaxSettingsPostRequestFormHeadOfficeXd7eefa39>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TaxSettingsPostRequestFormX6a746f8e,
        ) {
...
public fun inlineV1TaxSettingsPostRequestFormX6a746f8e(
    block: InlineV1TaxSettingsPostRequestFormX6a746f8e.Builder.() -> Unit,
): InlineV1TaxSettingsPostRequestFormX6a746f8e = InlineV1TaxSettingsPostRequestFormX6a746f8e.build(block)
