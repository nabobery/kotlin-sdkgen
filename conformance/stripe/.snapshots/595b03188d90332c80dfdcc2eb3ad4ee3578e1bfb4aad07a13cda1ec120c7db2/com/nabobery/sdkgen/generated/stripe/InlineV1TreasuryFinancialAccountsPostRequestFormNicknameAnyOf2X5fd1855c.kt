...
public sealed class InlineV1TreasuryFinancialAccountsPostRequestFormNicknameAnyOf2X5fd1855c {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1TreasuryFinancialAccountsPostRequestFormNicknameAnyOf2X5fd1855c =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1TreasuryFinancialAccountsPostRequestFormNicknameAnyOf2X5fd1855c> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1TreasuryFinancialAccountsPostRequestFormNicknameAnyOf2X5fd1855c",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1TreasuryFinancialAccountsPostRequestFormNicknameAnyOf2X5fd1855c = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TreasuryFinancialAccountsPostRequestFormNicknameAnyOf2X5fd1855c,
        ) {
