...
public sealed class InlineV1PaymentIntentsConfirmPostRequestFormOffSessionAnyOf2X477c0ad2 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1PaymentIntentsConfirmPostRequestFormOffSessionAnyOf2X477c0ad2 =
            when (value) {
                OneOff.value -> OneOff
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsConfirmPostRequestFormOffSessionAnyOf2X477c0ad2> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1PaymentIntentsConfirmPostRequestFormOffSessionAnyOf2X477c0ad2",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1PaymentIntentsConfirmPostRequestFormOffSessionAnyOf2X477c0ad2 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsConfirmPostRequestFormOffSessionAnyOf2X477c0ad2,
        ) {
