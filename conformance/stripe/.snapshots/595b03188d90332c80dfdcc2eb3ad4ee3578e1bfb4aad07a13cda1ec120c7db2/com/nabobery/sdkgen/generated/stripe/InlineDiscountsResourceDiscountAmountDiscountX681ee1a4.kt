...
public class InlineDiscountsResourceDiscountAmountDiscountX681ee1a4 internal constructor(
        ...
        get() =
            buildSet {
                ...
                if (inspection.matchesDiscount) {
                    add(
                        InlineDiscountsResourceDiscountAmountDiscountX681ee1a4Branch.Discount,
                    )
                }
                if (inspection.matchesDeletedDiscount) {
                    add(
                        InlineDiscountsResourceDiscountAmountDiscountX681ee1a4Branch.DeletedDiscount,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineDiscountsResourceDiscountAmountDiscountX681ee1a4 {
            val inspection = inspectInlineDiscountsResourceDiscountAmountDiscountX681ee1a4(raw)
            if (inspection.matchCount == 0) {
                throw InlineDiscountsResourceDiscountAmountDiscountX681ee1a4NoMatchException(
                    "InlineDiscountsResourceDiscountAmountDiscountX681ee1a4 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineDiscountsResourceDiscountAmountDiscountX681ee1a4> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineDiscountsResourceDiscountAmountDiscountX681ee1a4,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineDiscountsResourceDiscountAmountDiscountX681ee1a4",
...
private fun inspectInlineDiscountsResourceDiscountAmountDiscountX681ee1a4(
    element: JsonElement,
): InlineDiscountsResourceDiscountAmountDiscountX681ee1a4Inspection {
