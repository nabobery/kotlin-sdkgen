...
public sealed class InlineSubscriptionScheduleStatusXa92acafb {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineSubscriptionScheduleStatusXa92acafb =
            when (value) {
                Active.value -> Active
    ...
    public object Serializer : KSerializer<InlineSubscriptionScheduleStatusXa92acafb> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineSubscriptionScheduleStatusXa92acafb",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineSubscriptionScheduleStatusXa92acafb =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineSubscriptionScheduleStatusXa92acafb,
        ) {
