...
public class InlineV1QuotesPostRequestFormLineItemsItemX6f3fab70(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1QuotesPostRequestFormLineItemsItemX6f3fab70 =
            InlineV1QuotesPostRequestFormLineItemsItemX6f3fab70(
                discounts = discounts,
                price = price,
                priceData = priceData,
                quantity = quantity,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1QuotesPostRequestFormLineItemsItemX6f3fab70 =
    ...
    public object Serializer : KSerializer<InlineV1QuotesPostRequestFormLineItemsItemX6f3fab70> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1QuotesPostRequestFormLineItemsItemX6f3fab70 must be a JSON object",
                    )
            return InlineV1QuotesPostRequestFormLineItemsItemX6f3fab70(
                discounts =
                    rawObject["discounts"]?.let {
                        json.decodeFromJsonElement<InlineV1QuotesPostRequestFormLineItemsItemDiscountsXd211b5df>(it)
                    },
                price = rawObject["price"]?.let { json.decodeFromJsonElement<String>(it) },
                priceData =
                    rawObject["price_data"]?.let {
                        json.decodeFromJsonElement<InlineV1QuotesPostRequestFormLineItemsItemPriceDataX9ab56738>(it)
                    },
                quantity = rawObject["quantity"]?.let { json.decodeFromJsonElement<Int>(it) },
                taxRates =
                    rawObject["tax_rates"]?.let {
                        json.decodeFromJsonElement<InlineV1QuotesPostRequestFormLineItemsItemTaxRatesX11a92a68>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1QuotesPostRequestFormLineItemsItemX6f3fab70,
        ) {
...
public fun inlineV1QuotesPostRequestFormLineItemsItemX6f3fab70(
    block: InlineV1QuotesPostRequestFormLineItemsItemX6f3fab70.Builder.() -> Unit,
): InlineV1QuotesPostRequestFormLineItemsItemX6f3fab70 =
    InlineV1QuotesPostRequestFormLineItemsItemX6f3fab70.build(block)
