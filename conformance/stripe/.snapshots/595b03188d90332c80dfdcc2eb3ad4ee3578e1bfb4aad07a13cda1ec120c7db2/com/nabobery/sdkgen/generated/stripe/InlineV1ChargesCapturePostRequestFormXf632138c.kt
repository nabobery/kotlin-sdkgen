...
public class InlineV1ChargesCapturePostRequestFormXf632138c(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1ChargesCapturePostRequestFormXf632138c =
            InlineV1ChargesCapturePostRequestFormXf632138c(
                amount = amount,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1ChargesCapturePostRequestFormXf632138c =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1ChargesCapturePostRequestFormXf632138c> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1ChargesCapturePostRequestFormXf632138c must be a JSON object",
                    )
            return InlineV1ChargesCapturePostRequestFormXf632138c(
                ...
                transferData =
                    rawObject["transfer_data"]?.let {
                        json.decodeFromJsonElement<InlineV1ChargesCapturePostRequestFormTransferDataXfba3c867>(it)
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ChargesCapturePostRequestFormXf632138c,
        ) {
...
public fun inlineV1ChargesCapturePostRequestFormXf632138c(
    block: InlineV1ChargesCapturePostRequestFormXf632138c.Builder.() -> Unit,
): InlineV1ChargesCapturePostRequestFormXf632138c = InlineV1ChargesCapturePostRequestFormXf632138c.build(block)
