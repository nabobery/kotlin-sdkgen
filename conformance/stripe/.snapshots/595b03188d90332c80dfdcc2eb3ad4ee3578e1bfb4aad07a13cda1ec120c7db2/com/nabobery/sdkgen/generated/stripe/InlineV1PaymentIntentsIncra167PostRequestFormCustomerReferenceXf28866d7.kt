...
internal data class InlineV1PaymentIntentsIncra167PostRequestFormCustomerReferenceXf28866d7Inspection(
    ...
    public val matchesInlineV1PaymentIntentsIncra167PostRequestFormPaymentDetailsAnyOf2Xc39f784b: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1PaymentIntentsIncra167PostRequestFormPaymentDetailsAnyOf2Xc39f784b,
            ).count {
                it
            }
}
...
public class InlineV1PaymentIntentsIncra167PostRequestFormCustomerReferenceXf28866d7 internal constructor(
    ...
    private val inspection: InlineV1PaymentIntentsIncra167PostRequestFormCustomerReferenceXf28866d7Inspection,
) {
    ...
    public val inlineV1PaymentIntentsIncra167PostRequestFormPaymentDetailsAnyOf2Xc39f784b:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1PaymentIntentsIncra167PostRequestFormPaymentDetailsAnyOf2Xc39f784b) {
                json
                    .decodeFromJsonElement<InlineV1PaymentIntentsIncra167PostRequestFormPaymentDetailsAnyOf2Xc39f784b>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1PaymentIntentsIncra167PostRequestFormCustomerReferenceXf28866d7Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1PaymentIntentsIncra167PostRequestFormPaymentDetailsAnyOf2Xc39f784b) {
                    add(
                        InlineV1PaymentIntentsIncra167PostRequestFormCustomerReferenceXf28866d7Branch.InlineV1PaymentIntentsIncra167PostRequestFormPaymentDetailsAnyOf2Xc39f784b,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1PaymentIntentsIncra167PostRequestFormCustomerReferenceXf28866d7 {
            val inspection = inspectInlineV1PaymentIntentsIncra167PostRequestFormCustomerReferenceXf28866d7(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1PaymentIntentsIncra167PostRequestFormCustomerReferenceXf28866d7NoMatchException(
                    "InlineV1PaymentIntentsIncra167PostRequestFormCustomerReferenceXf28866d7 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsIncra167PostRequestFormCustomerReferenceXf28866d7> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsIncra167PostRequestFormCustomerReferenceXf28866d7,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1PaymentIntentsIncra167PostRequestFormCustomerReferenceXf28866d7",
...
private fun inspectInlineV1PaymentIntentsIncra167PostRequestFormCustomerReferenceXf28866d7(
    element: JsonElement,
): InlineV1PaymentIntentsIncra167PostRequestFormCustomerReferenceXf28866d7Inspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1PaymentIntentsIncra167PostRequestFormPaymentDetailsAnyOf2Xc39f784b =
        element
            .isJsonDecodable<InlineV1PaymentIntentsIncra167PostRequestFormPaymentDetailsAnyOf2Xc39f784b>()
    return InlineV1PaymentIntentsIncra167PostRequestFormCustomerReferenceXf28866d7Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1PaymentIntentsIncra167PostRequestFormPaymentDetailsAnyOf2Xc39f784b) {
                    add(
                        "InlineV1PaymentIntentsIncra167PostRequestFormPaymentDetailsAnyOf2Xc39f784b: value does not match InlineV1PaymentIntentsIncra167PostRequestFormPaymentDetailsAnyOf2Xc39f784b",
                    )
                }
            },
    )
