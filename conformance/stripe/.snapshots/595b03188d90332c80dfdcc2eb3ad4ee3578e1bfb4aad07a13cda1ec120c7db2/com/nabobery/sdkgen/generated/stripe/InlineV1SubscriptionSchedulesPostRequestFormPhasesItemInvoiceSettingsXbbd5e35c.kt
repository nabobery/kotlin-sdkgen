...
public class InlineV1SubscriptionSchedulesPostRequestFormPhasesItemInvoiceSettingsXbbd5e35c(
    public val accountTaxIds: InlineV1SubscriptionSchedulesPostRequestFormPhasesItemAccountTaxIdsXa126d30f? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1SubscriptionSchedulesPostRequestFormPhasesItemInvoiceSettingsXbbd5e35c =
            InlineV1SubscriptionSchedulesPostRequestFormPhasesItemInvoiceSettingsXbbd5e35c(
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemInvoiceSettingsXbbd5e35c> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SubscriptionSchedulesPostRequestFormPhasesItemInvoiceSettingsXbbd5e35c must be a JSON object",
                    )
            return InlineV1SubscriptionSchedulesPostRequestFormPhasesItemInvoiceSettingsXbbd5e35c(
                accountTaxIds =
                    rawObject["account_tax_ids"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemAccountTaxIdsXa126d30f>(
                                it,
                            )
                    },
                ...
                issuer =
                    rawObject["issuer"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemIssuerX4a911da8>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionSchedulesPostRequestFormPhasesItemInvoiceSettingsXbbd5e35c,
        ) {
            val jsonEncoder =
...
public fun inlineV1SubscriptionSchedulesPostRequestFormPhasesItemInvoiceSettingsXbbd5e35c(
    block: InlineV1SubscriptionSchedulesPostRequestFormPhasesItemInvoiceSettingsXbbd5e35c.Builder.() -> Unit,
): InlineV1SubscriptionSchedulesPostRequestFormPhasesItemInvoiceSettingsXbbd5e35c =
