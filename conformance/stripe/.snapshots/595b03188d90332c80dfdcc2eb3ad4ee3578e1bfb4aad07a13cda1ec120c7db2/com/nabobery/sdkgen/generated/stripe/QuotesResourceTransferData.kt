...
public class QuotesResourceTransferData(
    ...
    public object Serializer : KSerializer<QuotesResourceTransferData> {
        ...
        override fun deserialize(decoder: Decoder): QuotesResourceTransferData {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("QuotesResourceTransferData must be a JSON object")
            val destination =
                json.decodeRequired<InlineQuotesResourceTransferDataDestinationX471ac850>(
                    rawObject,
                    "destination",
                )
            return QuotesResourceTransferData(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: QuotesResourceTransferData,
        ) {
...
public fun quotesResourceTransferData(
    block: QuotesResourceTransferData.Builder.() -> Unit,
): QuotesResourceTransferData = QuotesResourceTransferData.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException("QuotesResourceTransferData is missing required property '" + name + "'")
