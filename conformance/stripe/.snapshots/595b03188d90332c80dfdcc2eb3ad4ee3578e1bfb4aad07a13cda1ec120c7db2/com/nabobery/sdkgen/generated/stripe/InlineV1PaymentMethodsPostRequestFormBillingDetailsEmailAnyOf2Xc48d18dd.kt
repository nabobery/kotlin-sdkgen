...
public sealed class InlineV1PaymentMethodsPostRequestFormBillingDetailsEmailAnyOf2Xc48d18dd {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1PaymentMethodsPostRequestFormBillingDetailsEmailAnyOf2Xc48d18dd =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1PaymentMethodsPostRequestFormBillingDetailsEmailAnyOf2Xc48d18dd> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1PaymentMethodsPostRequestFormBillingDetailsEmailAnyOf2Xc48d18dd",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1PaymentMethodsPostRequestFormBillingDetailsEmailAnyOf2Xc48d18dd = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentMethodsPostRequestFormBillingDetailsEmailAnyOf2Xc48d18dd,
        ) {
