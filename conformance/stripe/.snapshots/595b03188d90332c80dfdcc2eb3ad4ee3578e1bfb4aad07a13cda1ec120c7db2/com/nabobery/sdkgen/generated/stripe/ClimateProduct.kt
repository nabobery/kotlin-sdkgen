...
@Serializable
public data class ClimateProductView(
...
public class ClimateProduct(
    ...
    public class Builder {
        ...
        public var currentPricesPerMetricTon: Map<String, ClimateRemovalsProductsPrice>
            get() = requireNotNull(currentPricesPerMetricTonValue) { "currentPricesPerMetricTon is required" }
            set(`value`) {
                currentPricesPerMetricTonValue = value
            }
        ...
        public var suppliers: List<ClimateSupplier>
            get() = requireNotNull(suppliersValue) { "suppliers is required" }
            set(`value`) {
                suppliersValue = value
            }
        ...
        override fun deserialize(decoder: Decoder): ClimateProduct {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("ClimateProduct must be a JSON object")
            val created = json.decodeRequired<Int>(rawObject, "created")
            val currentPricesPerMetricTon =
                json.decodeRequired<Map<String, ClimateRemovalsProductsPrice>>(
                    rawObject,
            ...
            return ClimateProduct(
                ...
                suppliers = suppliers,
                deliveryYear =
                    rawObject["delivery_year"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("ClimateProduct is missing required property '" + name + "'")
