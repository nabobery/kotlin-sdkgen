...
public class DiscountsResourceDiscountAmount(
    ...
    public object Serializer : KSerializer<DiscountsResourceDiscountAmount> {
        ...
        override fun deserialize(decoder: Decoder): DiscountsResourceDiscountAmount {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("DiscountsResourceDiscountAmount must be a JSON object")
            val amount = json.decodeRequired<Int>(rawObject, "amount")
            val discount =
                json.decodeRequired<InlineDiscountsResourceDiscountAmountDiscountX681ee1a4>(
                    rawObject,
                    "discount",
                )
            return DiscountsResourceDiscountAmount(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: DiscountsResourceDiscountAmount,
        ) {
...
public fun discountsResourceDiscountAmount(
    block: DiscountsResourceDiscountAmount.Builder.() -> Unit,
): DiscountsResourceDiscountAmount = DiscountsResourceDiscountAmount.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "DiscountsResourceDiscountAmount is missing required property '" + name + "'",
            )
