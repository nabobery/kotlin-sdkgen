...
internal data class InlineV1PaymentMethodsPostRequestFormBillingDetailsPhoneX7fd2cf5fInspection(
    ...
    public val matchesInlineV1PaymentMethodsPostRequestFormBillingDetailsPhoneAnyOf2Xaec68279: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1PaymentMethodsPostRequestFormBillingDetailsPhoneAnyOf2Xaec68279,
            ).count {
                it
            }
}
...
public class InlineV1PaymentMethodsPostRequestFormBillingDetailsPhoneX7fd2cf5f internal constructor(
    ...
    private val inspection: InlineV1PaymentMethodsPostRequestFormBillingDetailsPhoneX7fd2cf5fInspection,
) {
    ...
    public val inlineV1PaymentMethodsPostRequestFormBillingDetailsPhoneAnyOf2Xaec68279:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1PaymentMethodsPostRequestFormBillingDetailsPhoneAnyOf2Xaec68279) {
                json
                    .decodeFromJsonElement<InlineV1PaymentMethodsPostRequestFormBillingDetailsPhoneAnyOf2Xaec68279>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1PaymentMethodsPostRequestFormBillingDetailsPhoneX7fd2cf5fBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1PaymentMethodsPostRequestFormBillingDetailsPhoneAnyOf2Xaec68279) {
                    add(
                        InlineV1PaymentMethodsPostRequestFormBillingDetailsPhoneX7fd2cf5fBranch.InlineV1PaymentMethodsPostRequestFormBillingDetailsPhoneAnyOf2Xaec68279,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1PaymentMethodsPostRequestFormBillingDetailsPhoneX7fd2cf5f {
            val inspection = inspectInlineV1PaymentMethodsPostRequestFormBillingDetailsPhoneX7fd2cf5f(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1PaymentMethodsPostRequestFormBillingDetailsPhoneX7fd2cf5fNoMatchException(
                    "InlineV1PaymentMethodsPostRequestFormBillingDetailsPhoneX7fd2cf5f matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1PaymentMethodsPostRequestFormBillingDetailsPhoneX7fd2cf5f> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentMethodsPostRequestFormBillingDetailsPhoneX7fd2cf5f,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1PaymentMethodsPostRequestFormBillingDetailsPhoneX7fd2cf5f",
...
private fun inspectInlineV1PaymentMethodsPostRequestFormBillingDetailsPhoneX7fd2cf5f(
    element: JsonElement,
): InlineV1PaymentMethodsPostRequestFormBillingDetailsPhoneX7fd2cf5fInspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1PaymentMethodsPostRequestFormBillingDetailsPhoneAnyOf2Xaec68279 =
        element
            .isJsonDecodable<InlineV1PaymentMethodsPostRequestFormBillingDetailsPhoneAnyOf2Xaec68279>()
    return InlineV1PaymentMethodsPostRequestFormBillingDetailsPhoneX7fd2cf5fInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1PaymentMethodsPostRequestFormBillingDetailsPhoneAnyOf2Xaec68279) {
                    add(
                        "InlineV1PaymentMethodsPostRequestFormBillingDetailsPhoneAnyOf2Xaec68279: value does not match InlineV1PaymentMethodsPostRequestFormBillingDetailsPhoneAnyOf2Xaec68279",
                    )
                }
            },
    )
