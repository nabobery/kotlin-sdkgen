...
public class SetupIntentNextActionPixDisplayQrCode(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): SetupIntentNextActionPixDisplayQrCode =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<SetupIntentNextActionPixDisplayQrCode> {
        ...
        override fun deserialize(decoder: Decoder): SetupIntentNextActionPixDisplayQrCode {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("SetupIntentNextActionPixDisplayQrCode must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: SetupIntentNextActionPixDisplayQrCode,
        ) {
...
public fun setupIntentNextActionPixDisplayQrCode(
    block: SetupIntentNextActionPixDisplayQrCode.Builder.() -> Unit,
): SetupIntentNextActionPixDisplayQrCode = SetupIntentNextActionPixDisplayQrCode.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "SetupIntentNextActionPixDisplayQrCode is missing required property '" + name + "'",
            )
