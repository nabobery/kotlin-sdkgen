...
public class InlineCheckoutSessionPaymentLinkX45e1bc7c internal constructor(
    ...
    public val paymentLink: PaymentLink? by
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesPaymentLink) json.decodeFromJsonElement<PaymentLink>(raw) else null
        }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineCheckoutSessionPaymentLinkX45e1bc7c {
            val inspection = inspectInlineCheckoutSessionPaymentLinkX45e1bc7c(raw)
            if (inspection.matchCount == 0) {
                throw InlineCheckoutSessionPaymentLinkX45e1bc7cNoMatchException(
                    "InlineCheckoutSessionPaymentLinkX45e1bc7c matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineCheckoutSessionPaymentLinkX45e1bc7c> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineCheckoutSessionPaymentLinkX45e1bc7c,
        ) {
...
private fun inspectInlineCheckoutSessionPaymentLinkX45e1bc7c(
    element: JsonElement,
): InlineCheckoutSessionPaymentLinkX45e1bc7cInspection {
