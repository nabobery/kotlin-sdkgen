...
public sealed class InlineV1TestHelpersIssuing214aPostRequestFormRiskAssessmentLevelXe90f37b0 {
    ...
    public object Serializer : KSerializer<InlineV1TestHelpersIssuing214aPostRequestFormRiskAssessmentLevelXe90f37b0> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1TestHelpersIssuing214aPostRequestFormRiskAssessmentLevelXe90f37b0",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1TestHelpersIssuing214aPostRequestFormRiskAssessmentLevelXe90f37b0 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TestHelpersIssuing214aPostRequestFormRiskAssessmentLevelXe90f37b0,
        ) {
