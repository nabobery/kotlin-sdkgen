...
public class InvoiceLineItemPeriod(
    ...
    public object Serializer : KSerializer<InvoiceLineItemPeriod> {
        ...
        override fun deserialize(decoder: Decoder): InvoiceLineItemPeriod {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("InvoiceLineItemPeriod must be a JSON object")
...
public fun invoiceLineItemPeriod(block: InvoiceLineItemPeriod.Builder.() -> Unit): InvoiceLineItemPeriod =
    InvoiceLineItemPeriod.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("InvoiceLineItemPeriod is missing required property '" + name + "'")
