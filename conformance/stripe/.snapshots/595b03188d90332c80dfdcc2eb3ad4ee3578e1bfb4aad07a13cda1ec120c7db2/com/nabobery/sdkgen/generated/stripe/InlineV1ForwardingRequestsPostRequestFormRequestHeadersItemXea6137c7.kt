...
public class InlineV1ForwardingRequestsPostRequestFormRequestHeadersItemXea6137c7(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1ForwardingRequestsPostRequestFormRequestHeadersItemXea6137c7 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1ForwardingRequestsPostRequestFormRequestHeadersItemXea6137c7> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1ForwardingRequestsPostRequestFormRequestHeadersItemXea6137c7 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ForwardingRequestsPostRequestFormRequestHeadersItemXea6137c7,
        ) {
            val jsonEncoder =
...
public fun inlineV1ForwardingRequestsPostRequestFormRequestHeadersItemXea6137c7(
    block: InlineV1ForwardingRequestsPostRequestFormRequestHeadersItemXea6137c7.Builder.() -> Unit,
): InlineV1ForwardingRequestsPostRequestFormRequestHeadersItemXea6137c7 =
    InlineV1ForwardingRequestsPostRequestFormRequestHeadersItemXea6137c7.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1ForwardingRequestsPostRequestFormRequestHeadersItemXea6137c7 is missing required property '" +
                    name +
                    "'",
            )
