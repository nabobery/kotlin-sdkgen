...
public class PaymentMethodDomainResourcePaymentMethodStatusDetails(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentMethodDomainResourcePaymentMethodStatusDetails =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentMethodDomainResourcePaymentMethodStatusDetails> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "PaymentMethodDomainResourcePaymentMethodStatusDetails must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentMethodDomainResourcePaymentMethodStatusDetails,
        ) {
...
public fun paymentMethodDomainResourcePaymentMethodStatusDetails(
    block: PaymentMethodDomainResourcePaymentMethodStatusDetails.Builder.() -> Unit,
): PaymentMethodDomainResourcePaymentMethodStatusDetails =
    PaymentMethodDomainResourcePaymentMethodStatusDetails.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "PaymentMethodDomainResourcePaymentMethodStatusDetails is missing required property '" + name + "'",
            )
