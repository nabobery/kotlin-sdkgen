...
public class InlineV1PaymentMethodsPostRequestFormCustomX73e90bbd(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PaymentMethodsPostRequestFormCustomX73e90bbd =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentMethodsPostRequestFormCustomX73e90bbd> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentMethodsPostRequestFormCustomX73e90bbd must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentMethodsPostRequestFormCustomX73e90bbd,
        ) {
...
public fun inlineV1PaymentMethodsPostRequestFormCustomX73e90bbd(
    block: InlineV1PaymentMethodsPostRequestFormCustomX73e90bbd.Builder.() -> Unit,
): InlineV1PaymentMethodsPostRequestFormCustomX73e90bbd =
    InlineV1PaymentMethodsPostRequestFormCustomX73e90bbd.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentMethodsPostRequestFormCustomX73e90bbd is missing required property '" + name + "'",
            )
