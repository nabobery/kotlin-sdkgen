...
public sealed class InlineCheckoutAcssDebitPaymentMethodOptionsCurrencyXfb11cf8a {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineCheckoutAcssDebitPaymentMethodOptionsCurrencyXfb11cf8a =
            when (value) {
                Cad.value -> Cad
                Usd.value -> Usd
    ...
    public object Serializer : KSerializer<InlineCheckoutAcssDebitPaymentMethodOptionsCurrencyXfb11cf8a> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineCheckoutAcssDebitPaymentMethodOptionsCurrencyXfb11cf8a",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineCheckoutAcssDebitPaymentMethodOptionsCurrencyXfb11cf8a =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineCheckoutAcssDebitPaymentMethodOptionsCurrencyXfb11cf8a,
        ) {
