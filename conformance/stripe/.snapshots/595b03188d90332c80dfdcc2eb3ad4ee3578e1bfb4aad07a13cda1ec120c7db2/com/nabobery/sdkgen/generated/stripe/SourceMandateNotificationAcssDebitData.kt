...
public class SourceMandateNotificationAcssDebitData(
    ...
    public class Builder {
        ...
        public fun build(): SourceMandateNotificationAcssDebitData =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): SourceMandateNotificationAcssDebitData =
    ...
    public object Serializer : KSerializer<SourceMandateNotificationAcssDebitData> {
        ...
        override fun deserialize(decoder: Decoder): SourceMandateNotificationAcssDebitData {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("SourceMandateNotificationAcssDebitData must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: SourceMandateNotificationAcssDebitData,
        ) {
...
public fun sourceMandateNotificationAcssDebitData(
    block: SourceMandateNotificationAcssDebitData.Builder.() -> Unit,
): SourceMandateNotificationAcssDebitData = SourceMandateNotificationAcssDebitData.build(block)
