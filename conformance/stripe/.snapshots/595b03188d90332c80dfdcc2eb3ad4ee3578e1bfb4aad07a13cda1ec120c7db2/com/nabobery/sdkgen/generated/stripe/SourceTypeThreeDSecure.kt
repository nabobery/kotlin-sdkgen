...
public class SourceTypeThreeDSecure(
    ...
    public class Builder {
        ...
        public fun build(): SourceTypeThreeDSecure =
        ...
        override fun deserialize(decoder: Decoder): SourceTypeThreeDSecure {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("SourceTypeThreeDSecure must be a JSON object")
            return SourceTypeThreeDSecure(
                ...
                authenticated =
                    rawObject["authenticated"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
...
public fun sourceTypeThreeDSecure(block: SourceTypeThreeDSecure.Builder.() -> Unit): SourceTypeThreeDSecure =
    SourceTypeThreeDSecure.build(block)
