...
public sealed class InlineV1PaymentIntentsPostRequestFormCollectionMethodXa5174f59 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1PaymentIntentsPostRequestFormCollectionMethodXa5174f59 =
            when (value) {
                Value.value -> Value
                Paper.value -> Paper
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormCollectionMethodXa5174f59> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1PaymentIntentsPostRequestFormCollectionMethodXa5174f59",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1PaymentIntentsPostRequestFormCollectionMethodXa5174f59 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormCollectionMethodXa5174f59,
        ) {
