...
public class InlineIssuingTokenCardXb1c7c14b internal constructor(
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineIssuingTokenCardXb1c7c14b {
            val inspection = inspectInlineIssuingTokenCardXb1c7c14b(raw)
            if (inspection.matchCount == 0) {
                throw InlineIssuingTokenCardXb1c7c14bNoMatchException(
                    "InlineIssuingTokenCardXb1c7c14b matched 0 branches: " + inspection.failures.joinToString("; "),
                )
            }
    ...
    public object Serializer : KSerializer<InlineIssuingTokenCardXb1c7c14b> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineIssuingTokenCardXb1c7c14b,
        ) {
