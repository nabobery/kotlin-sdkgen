...
public class InlineV1IssuingDisputesPostRequestFormEvidenceDuplicateAnyOf1Xfbe78918(
    ...
    public val cardStatement: InlineV1IssuingDisputesPostRequestFormEvidenceDuplicateCardStatementX465a104b? = null,
    public val cashReceipt: InlineV1IssuingDisputesPostRequestFormEvidenceDuplicateCashReceiptX50a8d06e? = null,
    public val checkImage: InlineV1IssuingDisputesPostRequestFormEvidenceDuplicateAnyOf1CheckImageXb2b43892? = null,
    public val explanation: InlineV1IssuingDisputesPostRequestFormEvidenceDuplicateExplanationX76315089? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1IssuingDisputesPostRequestFormEvidenceDuplicateAnyOf1Xfbe78918 =
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1IssuingDisputesPostRequestFormEvidenceDuplicateAnyOf1Xfbe78918 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1IssuingDisputesPostRequestFormEvidenceDuplicateAnyOf1Xfbe78918> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1IssuingDisputesPostRequestFormEvidenceDuplicateAnyOf1Xfbe78918 must be a JSON object",
                    )
            return InlineV1IssuingDisputesPostRequestFormEvidenceDuplicateAnyOf1Xfbe78918(
                additionalDocumentation =
                    rawObject["additional_documentation"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1IssuingDisputesPostRequestFormEvidenceAdditionalDocumentationXa749d134>(
                                it,
                            )
                    },
                cardStatement =
                    rawObject["card_statement"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1IssuingDisputesPostRequestFormEvidenceDuplicateCardStatementX465a104b>(
                                it,
                            )
                    },
                cashReceipt =
                    rawObject["cash_receipt"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1IssuingDisputesPostRequestFormEvidenceDuplicateCashReceiptX50a8d06e>(
                                it,
                            )
                    },
                checkImage =
                    rawObject["check_image"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1IssuingDisputesPostRequestFormEvidenceDuplicateAnyOf1CheckImageXb2b43892>(
                                it,
                            )
                    },
                explanation =
                    rawObject["explanation"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1IssuingDisputesPostRequestFormEvidenceDuplicateExplanationX76315089>(
                                it,
                            )
                    },
                originalTransaction =
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingDisputesPostRequestFormEvidenceDuplicateAnyOf1Xfbe78918,
        ) {
            val jsonEncoder =
...
public fun inlineV1IssuingDisputesPostRequestFormEvidenceDuplicateAnyOf1Xfbe78918(
    block: InlineV1IssuingDisputesPostRequestFormEvidenceDuplicateAnyOf1Xfbe78918.Builder.() -> Unit,
): InlineV1IssuingDisputesPostRequestFormEvidenceDuplicateAnyOf1Xfbe78918 =
    InlineV1IssuingDisputesPostRequestFormEvidenceDuplicateAnyOf1Xfbe78918.build(block)
