...
internal data class InlineV1PaymentIntentsConfirmPostRequestFormAmountDetailsAnyOf1AmountX0c914aa6Inspection(
    ...
    public val matchesInlineV1PaymentIntentsConfirmPostRequestFormAmountDetailsAnyOf1AnyOf2X2c875a29: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1PaymentIntentsConfirmPostRequestFormAmountDetailsAnyOf1AnyOf2X2c875a29,
            ).count {
                it
            }
}
...
public class InlineV1PaymentIntentsConfirmPostRequestFormAmountDetailsAnyOf1AmountX0c914aa6 internal constructor(
    ...
    private val inspection: InlineV1PaymentIntentsConfirmPostRequestFormAmountDetailsAnyOf1AmountX0c914aa6Inspection,
) {
    ...
    public val inlineV1PaymentIntentsConfirmPostRequestFormAmountDetailsAnyOf1AnyOf2X2c875a29:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1PaymentIntentsConfirmPostRequestFormAmountDetailsAnyOf1AnyOf2X2c875a29) {
                json
                    .decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormAmountDetailsAnyOf1AnyOf2X2c875a29>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1PaymentIntentsConfirmPostRequestFormAmountDetailsAnyOf1AmountX0c914aa6Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1PaymentIntentsConfirmPostRequestFormAmountDetailsAnyOf1AnyOf2X2c875a29) {
                    add(
                        InlineV1PaymentIntentsConfirmPostRequestFormAmountDetailsAnyOf1AmountX0c914aa6Branch.InlineV1PaymentIntentsConfirmPostRequestFormAmountDetailsAnyOf1AnyOf2X2c875a29,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1PaymentIntentsConfirmPostRequestFormAmountDetailsAnyOf1AmountX0c914aa6 {
            val inspection = inspectInlineV1PaymentIntentsConfirmPostRequestFormAmountDetailsAnyOf1AmountX0c914aa6(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1PaymentIntentsConfirmPostRequestFormAmountDetailsAnyOf1AmountX0c914aa6NoMatchException(
                    "InlineV1PaymentIntentsConfirmPostRequestFormAmountDetailsAnyOf1AmountX0c914aa6 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsConfirmPostRequestFormAmountDetailsAnyOf1AmountX0c914aa6> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsConfirmPostRequestFormAmountDetailsAnyOf1AmountX0c914aa6,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1PaymentIntentsConfirmPostRequestFormAmountDetailsAnyOf1AmountX0c914aa6",
...
private fun inspectInlineV1PaymentIntentsConfirmPostRequestFormAmountDetailsAnyOf1AmountX0c914aa6(
    element: JsonElement,
): InlineV1PaymentIntentsConfirmPostRequestFormAmountDetailsAnyOf1AmountX0c914aa6Inspection {
    val matchesBranch1 = element.isJsonDecodable<Int>()
    val matchesInlineV1PaymentIntentsConfirmPostRequestFormAmountDetailsAnyOf1AnyOf2X2c875a29 =
        element
            .isJsonDecodable<InlineV1PaymentIntentsConfirmPostRequestFormAmountDetailsAnyOf1AnyOf2X2c875a29>()
    return InlineV1PaymentIntentsConfirmPostRequestFormAmountDetailsAnyOf1AmountX0c914aa6Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1PaymentIntentsConfirmPostRequestFormAmountDetailsAnyOf1AnyOf2X2c875a29) {
                    add(
                        "InlineV1PaymentIntentsConfirmPostRequestFormAmountDetailsAnyOf1AnyOf2X2c875a29: value does not match InlineV1PaymentIntentsConfirmPostRequestFormAmountDetailsAnyOf1AnyOf2X2c875a29",
                    )
                }
            },
    )
