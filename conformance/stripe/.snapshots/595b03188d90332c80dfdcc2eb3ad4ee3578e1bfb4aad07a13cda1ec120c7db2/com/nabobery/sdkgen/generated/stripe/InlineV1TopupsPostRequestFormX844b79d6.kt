...
public class InlineV1TopupsPostRequestFormX844b79d6(
     ...
     */
    public val paymentMethodOptions: InlineV1TopupsPostRequestFormPaymentMethodOptionsXed765043? = null,
    /**
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TopupsPostRequestFormX844b79d6 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TopupsPostRequestFormX844b79d6> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1TopupsPostRequestFormX844b79d6 {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("InlineV1TopupsPostRequestFormX844b79d6 must be a JSON object")
            ...
            return InlineV1TopupsPostRequestFormX844b79d6(
                ...
                metadata =
                    rawObject["metadata"]?.let {
                        json.decodeFromJsonElement<InlineV1TopupsPostRequestFormMetadataX7aa3f56a>(it)
                    },
                paymentMethod = rawObject["payment_method"]?.let { json.decodeFromJsonElement<String>(it) },
                paymentMethodOptions =
                    rawObject["payment_method_options"]?.let {
                        json.decodeFromJsonElement<InlineV1TopupsPostRequestFormPaymentMethodOptionsXed765043>(it)
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TopupsPostRequestFormX844b79d6,
        ) {
...
public fun inlineV1TopupsPostRequestFormX844b79d6(
    block: InlineV1TopupsPostRequestFormX844b79d6.Builder.() -> Unit,
): InlineV1TopupsPostRequestFormX844b79d6 = InlineV1TopupsPostRequestFormX844b79d6.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TopupsPostRequestFormX844b79d6 is missing required property '" + name + "'",
            )
