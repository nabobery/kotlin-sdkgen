...
public class InlineStackableDiscountWithDiscountSettingsAndDiscountEndDiscountX1c59d240 internal constructor(
    ...
    private val inspection: InlineStackableDiscountWithDiscountSettingsAndDiscountEndDiscountX1c59d240Inspection,
) {
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineStackableDiscountWithDiscountSettingsAndDiscountEndDiscountX1c59d240Branch.Branch1,
                    )
                }
                if (inspection.matchesDiscount) {
                    add(
                        InlineStackableDiscountWithDiscountSettingsAndDiscountEndDiscountX1c59d240Branch.Discount,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineStackableDiscountWithDiscountSettingsAndDiscountEndDiscountX1c59d240 {
            val inspection = inspectInlineStackableDiscountWithDiscountSettingsAndDiscountEndDiscountX1c59d240(raw)
            if (inspection.matchCount == 0) {
                throw InlineStackableDiscountWithDiscountSettingsAndDiscountEndDiscountX1c59d240NoMatchException(
                    "InlineStackableDiscountWithDiscountSettingsAndDiscountEndDiscountX1c59d240 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineStackableDiscountWithDiscountSettingsAndDiscountEndDiscountX1c59d240> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineStackableDiscountWithDiscountSettingsAndDiscountEndDiscountX1c59d240,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineStackableDiscountWithDiscountSettingsAndDiscountEndDiscountX1c59d240",
...
private fun inspectInlineStackableDiscountWithDiscountSettingsAndDiscountEndDiscountX1c59d240(
    element: JsonElement,
