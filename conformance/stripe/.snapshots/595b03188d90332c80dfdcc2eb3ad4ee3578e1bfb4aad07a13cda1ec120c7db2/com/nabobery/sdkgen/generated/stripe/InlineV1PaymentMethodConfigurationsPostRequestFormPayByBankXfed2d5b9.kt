...
public class InlineV1PaymentMethodConfigurationsPostRequestFormPayByBankXfed2d5b9(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1PaymentMethodConfigurationsPostRequestFormPayByBankXfed2d5b9 =
            InlineV1PaymentMethodConfigurationsPostRequestFormPayByBankXfed2d5b9(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentMethodConfigurationsPostRequestFormPayByBankXfed2d5b9 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1PaymentMethodConfigurationsPostRequestFormPayByBankXfed2d5b9> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentMethodConfigurationsPostRequestFormPayByBankXfed2d5b9 must be a JSON object",
                    )
            return InlineV1PaymentMethodConfigurationsPostRequestFormPayByBankXfed2d5b9(
                displayPreference =
                    rawObject["display_preference"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentMethodConfidc49PostRequestFormPayByBankDisplayPreferenceX7c47f7cc>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentMethodConfigurationsPostRequestFormPayByBankXfed2d5b9,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentMethodConfigurationsPostRequestFormPayByBankXfed2d5b9(
    block: InlineV1PaymentMethodConfigurationsPostRequestFormPayByBankXfed2d5b9.Builder.() -> Unit,
): InlineV1PaymentMethodConfigurationsPostRequestFormPayByBankXfed2d5b9 =
    InlineV1PaymentMethodConfigurationsPostRequestFormPayByBankXfed2d5b9.build(block)
