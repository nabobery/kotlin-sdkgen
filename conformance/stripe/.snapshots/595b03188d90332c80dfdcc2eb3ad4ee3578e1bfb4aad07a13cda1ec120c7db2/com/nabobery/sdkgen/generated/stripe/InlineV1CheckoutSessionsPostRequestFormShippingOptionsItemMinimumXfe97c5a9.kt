...
public class InlineV1CheckoutSessionsPostRequestFormShippingOptionsItemMinimumXfe97c5a9(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1CheckoutSessionsPostRequestFormShippingOptionsItemMinimumXfe97c5a9 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormShippingOptionsItemMinimumXfe97c5a9> {
        override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1CheckoutSessionsPostRequestFormShippingOptionsItemMinimumXfe97c5a9 {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CheckoutSessionsPostRequestFormShippingOptionsItemMinimumXfe97c5a9 must be a JSON object",
                    )
            val unit =
                json.decodeRequired<InlineV1CheckoutSessionsPostRequestFormShippingOptionsItemUnitXe8d89e27>(
                    rawObject,
                    "unit",
                )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsPostRequestFormShippingOptionsItemMinimumXfe97c5a9,
        ) {
            val jsonEncoder =
...
public fun inlineV1CheckoutSessionsPostRequestFormShippingOptionsItemMinimumXfe97c5a9(
    block: InlineV1CheckoutSessionsPostRequestFormShippingOptionsItemMinimumXfe97c5a9.Builder.() -> Unit,
): InlineV1CheckoutSessionsPostRequestFormShippingOptionsItemMinimumXfe97c5a9 =
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1CheckoutSessionsPostRequestFormShippingOptionsItemMinimumXfe97c5a9 is missing required property '" +
                    name +
                    "'",
            )
