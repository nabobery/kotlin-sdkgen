...
public sealed class InlineV1AccountsPersonsPostRequestFormMetadataAnyOf2X942c1d6c {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1AccountsPersonsPostRequestFormMetadataAnyOf2X942c1d6c =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1AccountsPersonsPostRequestFormMetadataAnyOf2X942c1d6c> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1AccountsPersonsPostRequestFormMetadataAnyOf2X942c1d6c",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1AccountsPersonsPostRequestFormMetadataAnyOf2X942c1d6c =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPersonsPostRequestFormMetadataAnyOf2X942c1d6c,
        ) {
