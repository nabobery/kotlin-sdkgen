...
public class InlineTreasuryReceivedCreditTransactionXdd1d426d internal constructor(
        ...
        get() =
            buildSet {
                ...
                if (inspection.matchesTreasuryTransaction) {
                    add(
                        InlineTreasuryReceivedCreditTransactionXdd1d426dBranch.TreasuryTransaction,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineTreasuryReceivedCreditTransactionXdd1d426d {
            val inspection = inspectInlineTreasuryReceivedCreditTransactionXdd1d426d(raw)
            if (inspection.matchCount == 0) {
                throw InlineTreasuryReceivedCreditTransactionXdd1d426dNoMatchException(
                    "InlineTreasuryReceivedCreditTransactionXdd1d426d matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineTreasuryReceivedCreditTransactionXdd1d426d> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineTreasuryReceivedCreditTransactionXdd1d426d,
        ) {
...
private fun inspectInlineTreasuryReceivedCreditTransactionXdd1d426d(
    element: JsonElement,
): InlineTreasuryReceivedCreditTransactionXdd1d426dInspection {
