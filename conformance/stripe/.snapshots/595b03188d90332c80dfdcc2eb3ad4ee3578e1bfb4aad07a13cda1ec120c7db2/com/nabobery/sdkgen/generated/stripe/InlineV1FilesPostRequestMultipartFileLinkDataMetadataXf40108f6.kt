...
internal data class InlineV1FilesPostRequestMultipartFileLinkDataMetadataXf40108f6Inspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1FilesPostRequestMultipartFileLinkDataMetadataAnyOf2X446d0d54,
            ).count { it }
}
...
public class InlineV1FilesPostRequestMultipartFileLinkDataMetadataXf40108f6 internal constructor(
    ...
    public val inlineV1FilesPostRequestMultipartFileLinkDataMetadataAnyOf2X446d0d54:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1FilesPostRequestMultipartFileLinkDataMetadataAnyOf2X446d0d54) {
                json
                    .decodeFromJsonElement<InlineV1FilesPostRequestMultipartFileLinkDataMetadataAnyOf2X446d0d54>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1FilesPostRequestMultipartFileLinkDataMetadataXf40108f6Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1FilesPostRequestMultipartFileLinkDataMetadataAnyOf2X446d0d54) {
                    add(
                        InlineV1FilesPostRequestMultipartFileLinkDataMetadataXf40108f6Branch.InlineV1FilesPostRequestMultipartFileLinkDataMetadataAnyOf2X446d0d54,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1FilesPostRequestMultipartFileLinkDataMetadataXf40108f6 {
            val inspection = inspectInlineV1FilesPostRequestMultipartFileLinkDataMetadataXf40108f6(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1FilesPostRequestMultipartFileLinkDataMetadataXf40108f6NoMatchException(
                    "InlineV1FilesPostRequestMultipartFileLinkDataMetadataXf40108f6 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1FilesPostRequestMultipartFileLinkDataMetadataXf40108f6> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1FilesPostRequestMultipartFileLinkDataMetadataXf40108f6,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1FilesPostRequestMultipartFileLinkDataMetadataXf40108f6",
...
private fun inspectInlineV1FilesPostRequestMultipartFileLinkDataMetadataXf40108f6(
    element: JsonElement,
): InlineV1FilesPostRequestMultipartFileLinkDataMetadataXf40108f6Inspection {
    val matchesBranch1 = element.isJsonDecodable<JsonObject>()
    val matchesInlineV1FilesPostRequestMultipartFileLinkDataMetadataAnyOf2X446d0d54 =
        element
            .isJsonDecodable<InlineV1FilesPostRequestMultipartFileLinkDataMetadataAnyOf2X446d0d54>()
    return InlineV1FilesPostRequestMultipartFileLinkDataMetadataXf40108f6Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1FilesPostRequestMultipartFileLinkDataMetadataAnyOf2X446d0d54) {
                    add(
                        "InlineV1FilesPostRequestMultipartFileLinkDataMetadataAnyOf2X446d0d54: value does not match InlineV1FilesPostRequestMultipartFileLinkDataMetadataAnyOf2X446d0d54",
                    )
                }
            },
    )
