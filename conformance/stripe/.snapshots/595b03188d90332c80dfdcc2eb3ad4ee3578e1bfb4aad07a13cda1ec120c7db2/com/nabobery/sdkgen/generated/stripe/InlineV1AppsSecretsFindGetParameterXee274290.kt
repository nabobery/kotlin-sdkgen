...
public class InlineV1AppsSecretsFindGetParameterXee274290(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1AppsSecretsFindGetParameterXee274290 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1AppsSecretsFindGetParameterXee274290> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AppsSecretsFindGetParameterXee274290 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AppsSecretsFindGetParameterXee274290,
        ) {
...
public fun inlineV1AppsSecretsFindGetParameterXee274290(
    block: InlineV1AppsSecretsFindGetParameterXee274290.Builder.() -> Unit,
): InlineV1AppsSecretsFindGetParameterXee274290 = InlineV1AppsSecretsFindGetParameterXee274290.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1AppsSecretsFindGetParameterXee274290 is missing required property '" + name + "'",
            )
