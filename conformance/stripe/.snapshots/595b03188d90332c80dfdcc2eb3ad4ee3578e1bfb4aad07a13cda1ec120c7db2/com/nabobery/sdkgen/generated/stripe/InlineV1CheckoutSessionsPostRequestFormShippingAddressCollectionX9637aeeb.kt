...
public class InlineV1CheckoutSessionsPostRequestFormShippingAddressCollectionX9637aeeb(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1CheckoutSessionsPostRequestFormShippingAddressCollectionX9637aeeb = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormShippingAddressCollectionX9637aeeb> {
        override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1CheckoutSessionsPostRequestFormShippingAddressCollectionX9637aeeb {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CheckoutSessionsPostRequestFormShippingAddressCollectionX9637aeeb must be a JSON object",
                    )
            val allowedCountries =
                json
                    .decodeRequired<List<InlineV1CheckoutSessionsPostRequestFormShippingAddressCollebe84ItemXb8fd1f6e>>(
                        rawObject,
                        "allowed_countries",
                    )
            return InlineV1CheckoutSessionsPostRequestFormShippingAddressCollectionX9637aeeb(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsPostRequestFormShippingAddressCollectionX9637aeeb,
        ) {
            val jsonEncoder =
...
public fun inlineV1CheckoutSessionsPostRequestFormShippingAddressCollectionX9637aeeb(
    block: InlineV1CheckoutSessionsPostRequestFormShippingAddressCollectionX9637aeeb.Builder.() -> Unit,
): InlineV1CheckoutSessionsPostRequestFormShippingAddressCollectionX9637aeeb =
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1CheckoutSessionsPostRequestFormShippingAddressCollectionX9637aeeb is missing required property '" +
                    name +
                    "'",
            )
