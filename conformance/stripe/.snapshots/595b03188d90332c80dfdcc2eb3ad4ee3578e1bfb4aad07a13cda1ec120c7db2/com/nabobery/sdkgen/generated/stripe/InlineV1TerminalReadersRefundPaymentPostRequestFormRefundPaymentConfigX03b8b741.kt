...
public class InlineV1TerminalReadersRefundPaymentPostRequestFormRefundPaymentConfigX03b8b741(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1TerminalReadersRefundPaymentPostRequestFormRefundPaymentConfigX03b8b741 =
            InlineV1TerminalReadersRefundPaymentPostRequestFormRefundPaymentConfigX03b8b741(
    ...
    public object Serializer : KSerializer<InlineV1TerminalReadersRefundPaymentPostRequestFormRefundPaymentConfigX03b8b741> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TerminalReadersRefundPaymentPostRequestFormRefundPaymentConfigX03b8b741 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TerminalReadersRefundPaymentPostRequestFormRefundPaymentConfigX03b8b741,
        ) {
            val jsonEncoder =
...
public fun inlineV1TerminalReadersRefundPaymentPostRequestFormRefundPaymentConfigX03b8b741(
    block: InlineV1TerminalReadersRefundPaymentPostRequestFormRefundPaymentConfigX03b8b741.Builder.() -> Unit,
): InlineV1TerminalReadersRefundPaymentPostRequestFormRefundPaymentConfigX03b8b741 =
