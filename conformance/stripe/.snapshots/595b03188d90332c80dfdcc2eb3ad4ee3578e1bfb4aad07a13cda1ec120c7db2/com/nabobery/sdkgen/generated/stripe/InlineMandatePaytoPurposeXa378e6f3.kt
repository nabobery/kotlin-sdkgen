...
public sealed class InlineMandatePaytoPurposeXa378e6f3 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineMandatePaytoPurposeXa378e6f3 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineMandatePaytoPurposeXa378e6f3> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineMandatePaytoPurposeXa378e6f3",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineMandatePaytoPurposeXa378e6f3 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineMandatePaytoPurposeXa378e6f3,
        ) {
