...
internal data class InlineV1SetupIntentsConfirmPostRequestFormReferencePrefixX3a7d23d2Inspection(
    ...
    public val matchesInlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2Xe037053b: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2Xe037053b,
            ).count {
                it
            }
}
...
public class InlineV1SetupIntentsConfirmPostRequestFormReferencePrefixX3a7d23d2 internal constructor(
    ...
    private val inspection: InlineV1SetupIntentsConfirmPostRequestFormReferencePrefixX3a7d23d2Inspection,
) {
    ...
    public val inlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2Xe037053b:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2Xe037053b) {
                json
                    .decodeFromJsonElement<InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2Xe037053b>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1SetupIntentsConfirmPostRequestFormReferencePrefixX3a7d23d2Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2Xe037053b) {
                    add(
                        InlineV1SetupIntentsConfirmPostRequestFormReferencePrefixX3a7d23d2Branch.InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2Xe037053b,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1SetupIntentsConfirmPostRequestFormReferencePrefixX3a7d23d2 {
            val inspection = inspectInlineV1SetupIntentsConfirmPostRequestFormReferencePrefixX3a7d23d2(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1SetupIntentsConfirmPostRequestFormReferencePrefixX3a7d23d2NoMatchException(
                    "InlineV1SetupIntentsConfirmPostRequestFormReferencePrefixX3a7d23d2 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1SetupIntentsConfirmPostRequestFormReferencePrefixX3a7d23d2> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SetupIntentsConfirmPostRequestFormReferencePrefixX3a7d23d2,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1SetupIntentsConfirmPostRequestFormReferencePrefixX3a7d23d2",
...
private fun inspectInlineV1SetupIntentsConfirmPostRequestFormReferencePrefixX3a7d23d2(
    element: JsonElement,
): InlineV1SetupIntentsConfirmPostRequestFormReferencePrefixX3a7d23d2Inspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2Xe037053b =
        element
            .isJsonDecodable<InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2Xe037053b>()
    return InlineV1SetupIntentsConfirmPostRequestFormReferencePrefixX3a7d23d2Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2Xe037053b) {
                    add(
                        "InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2Xe037053b: value does not match InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2Xe037053b",
                    )
                }
            },
    )
