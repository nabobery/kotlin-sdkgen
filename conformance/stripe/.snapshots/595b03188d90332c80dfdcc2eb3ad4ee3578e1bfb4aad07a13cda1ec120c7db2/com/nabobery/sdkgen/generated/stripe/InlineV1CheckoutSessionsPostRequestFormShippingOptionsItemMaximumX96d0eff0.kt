...
public class InlineV1CheckoutSessionsPostRequestFormShippingOptionsItemMaximumX96d0eff0(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1CheckoutSessionsPostRequestFormShippingOptionsItemMaximumX96d0eff0 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormShippingOptionsItemMaximumX96d0eff0> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CheckoutSessionsPostRequestFormShippingOptionsItemMaximumX96d0eff0 must be a JSON object",
                    )
            val unit =
                json.decodeRequired<InlineV1CheckoutSessionsPostRequestFormShippingOptionsItemUnitX08900d1a>(
                    rawObject,
                    "unit",
                )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsPostRequestFormShippingOptionsItemMaximumX96d0eff0,
        ) {
            val jsonEncoder =
...
public fun inlineV1CheckoutSessionsPostRequestFormShippingOptionsItemMaximumX96d0eff0(
    block: InlineV1CheckoutSessionsPostRequestFormShippingOptionsItemMaximumX96d0eff0.Builder.() -> Unit,
): InlineV1CheckoutSessionsPostRequestFormShippingOptionsItemMaximumX96d0eff0 =
    InlineV1CheckoutSessionsPostRequestFormShippingOptionsItemMaximumX96d0eff0.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1CheckoutSessionsPostRequestFormShippingOptionsItemMaximumX96d0eff0 is missing required property '" +
                    name +
                    "'",
            )
