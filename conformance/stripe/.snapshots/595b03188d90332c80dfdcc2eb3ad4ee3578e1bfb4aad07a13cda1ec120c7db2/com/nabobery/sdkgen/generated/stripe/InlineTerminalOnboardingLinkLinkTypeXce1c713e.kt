...
public sealed class InlineTerminalOnboardingLinkLinkTypeXce1c713e {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineTerminalOnboardingLinkLinkTypeXce1c713e =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineTerminalOnboardingLinkLinkTypeXce1c713e> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineTerminalOnboardingLinkLinkTypeXce1c713e",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineTerminalOnboardingLinkLinkTypeXce1c713e =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineTerminalOnboardingLinkLinkTypeXce1c713e,
        ) {
