...
internal data class InlineV1AccountsPostRequestFormSettingsStatementDescriptorP82b2Xfc390489Inspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1AccountsPostRequestFormSettingsCardPaymentsAnyOf2X73ce1fdd,
            ).count { it }
}
...
public class InlineV1AccountsPostRequestFormSettingsStatementDescriptorP82b2Xfc390489 internal constructor(
    ...
    private val inspection: InlineV1AccountsPostRequestFormSettingsStatementDescriptorP82b2Xfc390489Inspection,
) {
    ...
    public val inlineV1AccountsPostRequestFormSettingsCardPaymentsAnyOf2X73ce1fdd:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1AccountsPostRequestFormSettingsCardPaymentsAnyOf2X73ce1fdd) {
                json
                    .decodeFromJsonElement<InlineV1AccountsPostRequestFormSettingsCardPaymentsAnyOf2X73ce1fdd>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1AccountsPostRequestFormSettingsStatementDescriptorP82b2Xfc390489Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1AccountsPostRequestFormSettingsCardPaymentsAnyOf2X73ce1fdd) {
                    add(
                        InlineV1AccountsPostRequestFormSettingsStatementDescriptorP82b2Xfc390489Branch.InlineV1AccountsPostRequestFormSettingsCardPaymentsAnyOf2X73ce1fdd,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1AccountsPostRequestFormSettingsStatementDescriptorP82b2Xfc390489 {
            val inspection = inspectInlineV1AccountsPostRequestFormSettingsStatementDescriptorP82b2Xfc390489(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1AccountsPostRequestFormSettingsStatementDescriptorP82b2Xfc390489NoMatchException(
                    "InlineV1AccountsPostRequestFormSettingsStatementDescriptorP82b2Xfc390489 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1AccountsPostRequestFormSettingsStatementDescriptorP82b2Xfc390489> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPostRequestFormSettingsStatementDescriptorP82b2Xfc390489,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1AccountsPostRequestFormSettingsStatementDescriptorP82b2Xfc390489",
...
private fun inspectInlineV1AccountsPostRequestFormSettingsStatementDescriptorP82b2Xfc390489(
    element: JsonElement,
): InlineV1AccountsPostRequestFormSettingsStatementDescriptorP82b2Xfc390489Inspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1AccountsPostRequestFormSettingsCardPaymentsAnyOf2X73ce1fdd =
        element
            .isJsonDecodable<InlineV1AccountsPostRequestFormSettingsCardPaymentsAnyOf2X73ce1fdd>()
    return InlineV1AccountsPostRequestFormSettingsStatementDescriptorP82b2Xfc390489Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1AccountsPostRequestFormSettingsCardPaymentsAnyOf2X73ce1fdd) {
                    add(
                        "InlineV1AccountsPostRequestFormSettingsCardPaymentsAnyOf2X73ce1fdd: value does not match InlineV1AccountsPostRequestFormSettingsCardPaymentsAnyOf2X73ce1fdd",
                    )
                }
            },
    )
