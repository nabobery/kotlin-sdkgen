...
public class InlineV1PricesPostRequestFormTransformQuantityXc0c69d44(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PricesPostRequestFormTransformQuantityXc0c69d44 =
    ...
    public object Serializer : KSerializer<InlineV1PricesPostRequestFormTransformQuantityXc0c69d44> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PricesPostRequestFormTransformQuantityXc0c69d44 must be a JSON object",
                    )
            val divideBy = json.decodeRequired<Int>(rawObject, "divide_by")
            val round =
                json.decodeRequired<InlineV1PricesPostRequestFormTransformQuantityRoundXec72de8f>(
                    rawObject,
                    "round",
                )
            return InlineV1PricesPostRequestFormTransformQuantityXc0c69d44(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PricesPostRequestFormTransformQuantityXc0c69d44,
        ) {
...
public fun inlineV1PricesPostRequestFormTransformQuantityXc0c69d44(
    block: InlineV1PricesPostRequestFormTransformQuantityXc0c69d44.Builder.() -> Unit,
): InlineV1PricesPostRequestFormTransformQuantityXc0c69d44 =
    InlineV1PricesPostRequestFormTransformQuantityXc0c69d44.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PricesPostRequestFormTransformQuantityXc0c69d44 is missing required property '" + name + "'",
            )
