...
public class InlineIssuingAuthorizationCardholderXf1408f02 internal constructor(
    ...
    public val issuingCardholder: IssuingCardholder? by
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesIssuingCardholder) json.decodeFromJsonElement<IssuingCardholder>(raw) else null
        }
    ...
    public val matchedBranches: Set<InlineIssuingAuthorizationCardholderXf1408f02Branch>
        get() =
            buildSet {
                ...
                if (inspection.matchesIssuingCardholder) {
                    add(
                        InlineIssuingAuthorizationCardholderXf1408f02Branch.IssuingCardholder,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineIssuingAuthorizationCardholderXf1408f02 {
            val inspection = inspectInlineIssuingAuthorizationCardholderXf1408f02(raw)
            if (inspection.matchCount == 0) {
                throw InlineIssuingAuthorizationCardholderXf1408f02NoMatchException(
                    "InlineIssuingAuthorizationCardholderXf1408f02 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineIssuingAuthorizationCardholderXf1408f02> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineIssuingAuthorizationCardholderXf1408f02,
        ) {
...
private fun inspectInlineIssuingAuthorizationCardholderXf1408f02(
    element: JsonElement,
): InlineIssuingAuthorizationCardholderXf1408f02Inspection {
