...
public class InlineV1InvoicesUpdateLinesPostRequestFormLinesItemTaxRateDataX4acb2a94(
    ...
    public val jurisdictionLevel: InlineV1InvoicesUpdateLinesPostRequestFormLinesItemJurisdictionLevelX8ff93214? = null,
    public val state: String? = null,
    public val taxType: InlineV1InvoicesUpdateLinesPostRequestFormLinesItemTaxAmountsTaxTypeX139a4be7? = null,
) {
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1InvoicesUpdateLinesPostRequestFormLinesItemTaxRateDataX4acb2a94 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1InvoicesUpdateLinesPostRequestFormLinesItemTaxRateDataX4acb2a94> {
        override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1InvoicesUpdateLinesPostRequestFormLinesItemTaxRateDataX4acb2a94 {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1InvoicesUpdateLinesPostRequestFormLinesItemTaxRateDataX4acb2a94 must be a JSON object",
                    )
            ...
            return InlineV1InvoicesUpdateLinesPostRequestFormLinesItemTaxRateDataX4acb2a94(
                ...
                jurisdictionLevel =
                    rawObject["jurisdiction_level"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1InvoicesUpdateLinesPostRequestFormLinesItemJurisdictionLevelX8ff93214>(
                                it,
                            )
                    },
                ...
                taxType =
                    rawObject["tax_type"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1InvoicesUpdateLinesPostRequestFormLinesItemTaxAmountsTaxTypeX139a4be7>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesUpdateLinesPostRequestFormLinesItemTaxRateDataX4acb2a94,
        ) {
            val jsonEncoder =
...
public fun inlineV1InvoicesUpdateLinesPostRequestFormLinesItemTaxRateDataX4acb2a94(
    block: InlineV1InvoicesUpdateLinesPostRequestFormLinesItemTaxRateDataX4acb2a94.Builder.() -> Unit,
): InlineV1InvoicesUpdateLinesPostRequestFormLinesItemTaxRateDataX4acb2a94 =
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1InvoicesUpdateLinesPostRequestFormLinesItemTaxRateDataX4acb2a94 is missing required property '" +
                    name +
                    "'",
            )
