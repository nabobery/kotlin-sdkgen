...
public class InlineV1BalanceTransactionsGetParameterAnyOf1X58908c72(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1BalanceTransactionsGetParameterAnyOf1X58908c72 =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1BalanceTransactionsGetParameterAnyOf1X58908c72 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1BalanceTransactionsGetParameterAnyOf1X58908c72> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1BalanceTransactionsGetParameterAnyOf1X58908c72 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1BalanceTransactionsGetParameterAnyOf1X58908c72,
        ) {
...
public fun inlineV1BalanceTransactionsGetParameterAnyOf1X58908c72(
    block: InlineV1BalanceTransactionsGetParameterAnyOf1X58908c72.Builder.() -> Unit,
): InlineV1BalanceTransactionsGetParameterAnyOf1X58908c72 =
    InlineV1BalanceTransactionsGetParameterAnyOf1X58908c72.build(block)
