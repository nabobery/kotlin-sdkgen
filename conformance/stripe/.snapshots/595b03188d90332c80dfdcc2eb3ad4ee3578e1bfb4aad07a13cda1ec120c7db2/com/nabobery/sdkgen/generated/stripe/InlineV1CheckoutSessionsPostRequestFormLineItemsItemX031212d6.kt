...
public class InlineV1CheckoutSessionsPostRequestFormLineItemsItemX031212d6(
    ...
    public val metadata: InlineV1CheckoutSessionsPostRequestFormLineItemsItemMetadataXbce33241? = null,
    public val price: String? = null,
    public val priceData: InlineV1CheckoutSessionsPostRequestFormLineItemsItemPriceDataX178785a7? = null,
    public val quantity: Int? = null,
    public val taxRates: InlineV1CheckoutSessionsPostRequestFormLineItemsItemTaxRatesX017678bf? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1CheckoutSessionsPostRequestFormLineItemsItemX031212d6 =
            InlineV1CheckoutSessionsPostRequestFormLineItemsItemX031212d6(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1CheckoutSessionsPostRequestFormLineItemsItemX031212d6 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormLineItemsItemX031212d6> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CheckoutSessionsPostRequestFormLineItemsItemX031212d6 must be a JSON object",
                    )
            return InlineV1CheckoutSessionsPostRequestFormLineItemsItemX031212d6(
                adjustableQuantity =
                    rawObject["adjustable_quantity"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormLineItemsItemAdjustableQuantityX2d2b86fe>(
                                it,
                            )
                    },
                ...
                metadata =
                    rawObject["metadata"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormLineItemsItemMetadataXbce33241>(
                                it,
                            )
                    },
                ...
                priceData =
                    rawObject["price_data"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormLineItemsItemPriceDataX178785a7>(
                                it,
                            )
                    },
                ...
                taxRates =
                    rawObject["tax_rates"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormLineItemsItemTaxRatesX017678bf>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsPostRequestFormLineItemsItemX031212d6,
        ) {
            val jsonEncoder =
...
public fun inlineV1CheckoutSessionsPostRequestFormLineItemsItemX031212d6(
    block: InlineV1CheckoutSessionsPostRequestFormLineItemsItemX031212d6.Builder.() -> Unit,
): InlineV1CheckoutSessionsPostRequestFormLineItemsItemX031212d6 =
    InlineV1CheckoutSessionsPostRequestFormLineItemsItemX031212d6.build(block)
