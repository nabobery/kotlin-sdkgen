...
public class InlineV1TestHelpersIssuingTransactionsCreateForceCapturePostRequestFormXba4feab4(
     ...
     */
    public val merchantData: InlineV1TestHelpersIssuing6178PostRequestFormMerchantDataX5d3abc57? = null,
    /**
     * Additional purchase information that is optionally provided by the merchant.
     */
    public val purchaseDetails: InlineV1TestHelpersIssuing6178PostRequestFormPurchaseDetailsX0e102d0d? = null,
) {
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1TestHelpersIssuingTransactionsCreateForceCapturePostRequestFormXba4feab4 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TestHelpersIssuingTransactionsCreateForceCapturePostRequestFormXba4feab4> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TestHelpersIssuingTransactionsCreateForceCapturePostRequestFormXba4feab4 must be a JSON object",
                    )
            ...
            return InlineV1TestHelpersIssuingTransactionsCreateForceCapturePostRequestFormXba4feab4(
                ...
                merchantData =
                    rawObject["merchant_data"]?.let {
                        json.decodeFromJsonElement<InlineV1TestHelpersIssuing6178PostRequestFormMerchantDataX5d3abc57>(
                            it,
                        )
                    },
                purchaseDetails =
                    rawObject["purchase_details"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TestHelpersIssuing6178PostRequestFormPurchaseDetailsX0e102d0d>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TestHelpersIssuingTransactionsCreateForceCapturePostRequestFormXba4feab4,
        ) {
            val jsonEncoder =
...
public fun inlineV1TestHelpersIssuingTransactionsCreateForceCapturePostRequestFormXba4feab4(
    block: InlineV1TestHelpersIssuingTransactionsCreateForceCapturePostRequestFormXba4feab4.Builder.() -> Unit,
): InlineV1TestHelpersIssuingTransactionsCreateForceCapturePostRequestFormXba4feab4 =
    InlineV1TestHelpersIssuingTransactionsCreateForceCapturePostRequestFormXba4feab4.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TestHelpersIssuingTransactionsCreateForceCapturePostRequestFormXba4feab4 is missing required property '" +
                    name +
                    "'",
            )
