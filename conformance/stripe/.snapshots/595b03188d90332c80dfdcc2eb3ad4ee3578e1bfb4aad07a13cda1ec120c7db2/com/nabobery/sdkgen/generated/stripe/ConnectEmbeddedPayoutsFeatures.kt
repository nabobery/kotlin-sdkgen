...
public class ConnectEmbeddedPayoutsFeatures(
    ...
    public object Serializer : KSerializer<ConnectEmbeddedPayoutsFeatures> {
        ...
        override fun deserialize(decoder: Decoder): ConnectEmbeddedPayoutsFeatures {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("ConnectEmbeddedPayoutsFeatures must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: ConnectEmbeddedPayoutsFeatures,
        ) {
...
public fun connectEmbeddedPayoutsFeatures(
    block: ConnectEmbeddedPayoutsFeatures.Builder.() -> Unit,
): ConnectEmbeddedPayoutsFeatures = ConnectEmbeddedPayoutsFeatures.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "ConnectEmbeddedPayoutsFeatures is missing required property '" + name + "'",
            )
