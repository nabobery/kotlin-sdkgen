...
public sealed class InlineTransformUsageRoundX228c2a46 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineTransformUsageRoundX228c2a46 =
            when (value) {
                Down.value -> Down
                Up.value -> Up
    ...
    public object Serializer : KSerializer<InlineTransformUsageRoundX228c2a46> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineTransformUsageRoundX228c2a46",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineTransformUsageRoundX228c2a46 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineTransformUsageRoundX228c2a46,
        ) {
