...
public class InlineV1CustomersCardsDeleteResponse200JsonX5f1f6a06 internal constructor(
        ...
        get() =
            buildSet {
                if (inspection.matchesPaymentSource) {
                    add(
                        InlineV1CustomersCardsDeleteResponse200JsonX5f1f6a06Branch.PaymentSource,
                    )
                }
                if (inspection.matchesDeletedPaymentSource) {
                    add(
                        InlineV1CustomersCardsDeleteResponse200JsonX5f1f6a06Branch.DeletedPaymentSource,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1CustomersCardsDeleteResponse200JsonX5f1f6a06 {
            val inspection = inspectInlineV1CustomersCardsDeleteResponse200JsonX5f1f6a06(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1CustomersCardsDeleteResponse200JsonX5f1f6a06NoMatchException(
                    "InlineV1CustomersCardsDeleteResponse200JsonX5f1f6a06 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1CustomersCardsDeleteResponse200JsonX5f1f6a06> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersCardsDeleteResponse200JsonX5f1f6a06,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1CustomersCardsDeleteResponse200JsonX5f1f6a06",
...
private fun inspectInlineV1CustomersCardsDeleteResponse200JsonX5f1f6a06(
    element: JsonElement,
): InlineV1CustomersCardsDeleteResponse200JsonX5f1f6a06Inspection {
