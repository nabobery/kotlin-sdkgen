...
public class InlineV1AccountSessionsPostRequestFormComponentsBalancesX47ba8513(
    ...
    public val features: InlineV1AccountSessionsPostRequestFormComponentsBalancesFeaturesXe31b83af? = null,
) {
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1AccountSessionsPostRequestFormComponentsBalancesX47ba8513 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1AccountSessionsPostRequestFormComponentsBalancesX47ba8513> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountSessionsPostRequestFormComponentsBalancesX47ba8513 must be a JSON object",
                    )
            ...
            return InlineV1AccountSessionsPostRequestFormComponentsBalancesX47ba8513(
                ...
                features =
                    rawObject["features"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1AccountSessionsPostRequestFormComponentsBalancesFeaturesXe31b83af>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountSessionsPostRequestFormComponentsBalancesX47ba8513,
        ) {
            val jsonEncoder =
...
public fun inlineV1AccountSessionsPostRequestFormComponentsBalancesX47ba8513(
    block: InlineV1AccountSessionsPostRequestFormComponentsBalancesX47ba8513.Builder.() -> Unit,
): InlineV1AccountSessionsPostRequestFormComponentsBalancesX47ba8513 =
    InlineV1AccountSessionsPostRequestFormComponentsBalancesX47ba8513.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1AccountSessionsPostRequestFormComponentsBalancesX47ba8513 is missing required property '" +
                    name +
                    "'",
            )
