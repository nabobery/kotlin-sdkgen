...
public sealed class InlineV1CustomersPostRequestFormBusinessNameAnyOf2X840e21fd {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1CustomersPostRequestFormBusinessNameAnyOf2X840e21fd =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1CustomersPostRequestFormBusinessNameAnyOf2X840e21fd> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1CustomersPostRequestFormBusinessNameAnyOf2X840e21fd",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1CustomersPostRequestFormBusinessNameAnyOf2X840e21fd =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersPostRequestFormBusinessNameAnyOf2X840e21fd,
        ) {
