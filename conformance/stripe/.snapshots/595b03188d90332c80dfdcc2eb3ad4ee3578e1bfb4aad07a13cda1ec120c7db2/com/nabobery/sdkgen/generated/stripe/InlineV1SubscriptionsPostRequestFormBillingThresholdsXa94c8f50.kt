...
internal data class InlineV1SubscriptionsPostRequestFormBillingThresholdsXa94c8f50Inspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesInlineV1SubscriptionsPostRequestFormBillingThresholdsAnyOf1X684ca4a0,
                matchesInlineV1SubscriptionsPostRequestFormBillingThresholdsAnyOf2Xb00c6378,
            ).count {
                it
            }
}
...
public class InlineV1SubscriptionsPostRequestFormBillingThresholdsXa94c8f50 internal constructor(
    ...
    public val inlineV1SubscriptionsPostRequestFormBillingThresholdsAnyOf1X684ca4a0:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1SubscriptionsPostRequestFormBillingThresholdsAnyOf1X684ca4a0) {
                json
                    .decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormBillingThresholdsAnyOf1X684ca4a0>(
                        raw,
                    )
            } else {
                null
    ...
    public val inlineV1SubscriptionsPostRequestFormBillingThresholdsAnyOf2Xb00c6378:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1SubscriptionsPostRequestFormBillingThresholdsAnyOf2Xb00c6378) {
                json
                    .decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormBillingThresholdsAnyOf2Xb00c6378>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches:
        ...
        get() =
            buildSet {
                if (inspection.matchesInlineV1SubscriptionsPostRequestFormBillingThresholdsAnyOf1X684ca4a0) {
                    add(
                        InlineV1SubscriptionsPostRequestFormBillingThresholdsXa94c8f50Branch.InlineV1SubscriptionsPostRequestFormBillingThresholdsAnyOf1X684ca4a0,
                    )
                }
                if (inspection.matchesInlineV1SubscriptionsPostRequestFormBillingThresholdsAnyOf2Xb00c6378) {
                    add(
                        InlineV1SubscriptionsPostRequestFormBillingThresholdsXa94c8f50Branch.InlineV1SubscriptionsPostRequestFormBillingThresholdsAnyOf2Xb00c6378,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1SubscriptionsPostRequestFormBillingThresholdsXa94c8f50 {
            val inspection = inspectInlineV1SubscriptionsPostRequestFormBillingThresholdsXa94c8f50(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1SubscriptionsPostRequestFormBillingThresholdsXa94c8f50NoMatchException(
                    "InlineV1SubscriptionsPostRequestFormBillingThresholdsXa94c8f50 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionsPostRequestFormBillingThresholdsXa94c8f50> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsPostRequestFormBillingThresholdsXa94c8f50,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1SubscriptionsPostRequestFormBillingThresholdsXa94c8f50",
...
private fun inspectInlineV1SubscriptionsPostRequestFormBillingThresholdsXa94c8f50(
    element: JsonElement,
): InlineV1SubscriptionsPostRequestFormBillingThresholdsXa94c8f50Inspection {
    val matchesInlineV1SubscriptionsPostRequestFormBillingThresholdsAnyOf1X684ca4a0 =
        element
            .isJsonDecodable<InlineV1SubscriptionsPostRequestFormBillingThresholdsAnyOf1X684ca4a0>()
    val matchesInlineV1SubscriptionsPostRequestFormBillingThresholdsAnyOf2Xb00c6378 =
        element
            .isJsonDecodable<InlineV1SubscriptionsPostRequestFormBillingThresholdsAnyOf2Xb00c6378>()
    return InlineV1SubscriptionsPostRequestFormBillingThresholdsXa94c8f50Inspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1SubscriptionsPostRequestFormBillingThresholdsAnyOf1X684ca4a0) {
                    add(
                        "InlineV1SubscriptionsPostRequestFormBillingThresholdsAnyOf1X684ca4a0: value does not match InlineV1SubscriptionsPostRequestFormBillingThresholdsAnyOf1X684ca4a0",
                    )
                }
                if (!matchesInlineV1SubscriptionsPostRequestFormBillingThresholdsAnyOf2Xb00c6378) {
                    add(
                        "InlineV1SubscriptionsPostRequestFormBillingThresholdsAnyOf2Xb00c6378: value does not match InlineV1SubscriptionsPostRequestFormBillingThresholdsAnyOf2Xb00c6378",
                    )
                }
            },
    )
