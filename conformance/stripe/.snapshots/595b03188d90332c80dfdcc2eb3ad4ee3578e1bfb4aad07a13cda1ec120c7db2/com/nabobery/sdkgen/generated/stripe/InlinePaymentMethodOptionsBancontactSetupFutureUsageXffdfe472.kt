...
public sealed class InlinePaymentMethodOptionsBancontactSetupFutureUsageXffdfe472 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentMethodOptionsBancontactSetupFutureUsageXffdfe472 =
            when (value) {
                None.value -> None
    ...
    public object Serializer : KSerializer<InlinePaymentMethodOptionsBancontactSetupFutureUsageXffdfe472> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentMethodOptionsBancontactSetupFutureUsageXffdfe472",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePaymentMethodOptionsBancontactSetupFutureUsageXffdfe472 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentMethodOptionsBancontactSetupFutureUsageXffdfe472,
        ) {
