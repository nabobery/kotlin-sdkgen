...
internal data class InlineV1PaymentIntentsPostRequestFormPaymentMethodDataPhoneX279dd8efInspection(
    ...
    public val matchCount: Int
        get() =
            listOf(matchesBranch1, matchesInlineV1PaymentIntentsPostRequestFormPaymentMethodDataAnyOf2X9cc83e05).count {
                it
            }
}
...
public class InlineV1PaymentIntentsPostRequestFormPaymentMethodDataPhoneX279dd8ef internal constructor(
    ...
    private val inspection: InlineV1PaymentIntentsPostRequestFormPaymentMethodDataPhoneX279dd8efInspection,
) {
    ...
    public val inlineV1PaymentIntentsPostRequestFormPaymentMethodDataAnyOf2X9cc83e05:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1PaymentIntentsPostRequestFormPaymentMethodDataAnyOf2X9cc83e05) {
                json
                    .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodDataAnyOf2X9cc83e05>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1PaymentIntentsPostRequestFormPaymentMethodDataPhoneX279dd8efBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1PaymentIntentsPostRequestFormPaymentMethodDataAnyOf2X9cc83e05) {
                    add(
                        InlineV1PaymentIntentsPostRequestFormPaymentMethodDataPhoneX279dd8efBranch.InlineV1PaymentIntentsPostRequestFormPaymentMethodDataAnyOf2X9cc83e05,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1PaymentIntentsPostRequestFormPaymentMethodDataPhoneX279dd8ef {
            val inspection = inspectInlineV1PaymentIntentsPostRequestFormPaymentMethodDataPhoneX279dd8ef(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1PaymentIntentsPostRequestFormPaymentMethodDataPhoneX279dd8efNoMatchException(
                    "InlineV1PaymentIntentsPostRequestFormPaymentMethodDataPhoneX279dd8ef matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormPaymentMethodDataPhoneX279dd8ef> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormPaymentMethodDataPhoneX279dd8ef,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1PaymentIntentsPostRequestFormPaymentMethodDataPhoneX279dd8ef",
...
private fun inspectInlineV1PaymentIntentsPostRequestFormPaymentMethodDataPhoneX279dd8ef(
    element: JsonElement,
): InlineV1PaymentIntentsPostRequestFormPaymentMethodDataPhoneX279dd8efInspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1PaymentIntentsPostRequestFormPaymentMethodDataAnyOf2X9cc83e05 =
        element
            .isJsonDecodable<InlineV1PaymentIntentsPostRequestFormPaymentMethodDataAnyOf2X9cc83e05>()
    return InlineV1PaymentIntentsPostRequestFormPaymentMethodDataPhoneX279dd8efInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1PaymentIntentsPostRequestFormPaymentMethodDataAnyOf2X9cc83e05) {
                    add(
                        "InlineV1PaymentIntentsPostRequestFormPaymentMethodDataAnyOf2X9cc83e05: value does not match InlineV1PaymentIntentsPostRequestFormPaymentMethodDataAnyOf2X9cc83e05",
                    )
                }
            },
    )
