...
public sealed class InlineV1PaymentLinksPostRequestFormAutomaticTaxLiabilityTypeX1f178543 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1PaymentLinksPostRequestFormAutomaticTaxLiabilityTypeX1f178543 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1PaymentLinksPostRequestFormAutomaticTaxLiabilityTypeX1f178543> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1PaymentLinksPostRequestFormAutomaticTaxLiabilityTypeX1f178543",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1PaymentLinksPostRequestFormAutomaticTaxLiabilityTypeX1f178543 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentLinksPostRequestFormAutomaticTaxLiabilityTypeX1f178543,
        ) {
