...
public sealed class InlinePaymentIntentNextActionVerifyWithMicrodepositsMicrodepositTypeXbbf8eb5d {
    ...
    public object Serializer : KSerializer<InlinePaymentIntentNextActionVerifyWithMicrodepositsMicrodepositTypeXbbf8eb5d> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentIntentNextActionVerifyWithMicrodepositsMicrodepositTypeXbbf8eb5d",
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentIntentNextActionVerifyWithMicrodepositsMicrodepositTypeXbbf8eb5d,
        ) {
