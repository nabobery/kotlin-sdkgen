...
public class InlineDisputeEvidenceCustomerSignatureX7f79c66a internal constructor(
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineDisputeEvidenceCustomerSignatureX7f79c66a {
            val inspection = inspectInlineDisputeEvidenceCustomerSignatureX7f79c66a(raw)
            if (inspection.matchCount == 0) {
                throw InlineDisputeEvidenceCustomerSignatureX7f79c66aNoMatchException(
                    "InlineDisputeEvidenceCustomerSignatureX7f79c66a matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineDisputeEvidenceCustomerSignatureX7f79c66a> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineDisputeEvidenceCustomerSignatureX7f79c66a,
        ) {
...
private fun inspectInlineDisputeEvidenceCustomerSignatureX7f79c66a(
    element: JsonElement,
): InlineDisputeEvidenceCustomerSignatureX7f79c66aInspection {
