...
public class InlineV1PromotionCodesPostRequestFormPromotionXe5d514d4(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PromotionCodesPostRequestFormPromotionXe5d514d4 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PromotionCodesPostRequestFormPromotionXe5d514d4> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PromotionCodesPostRequestFormPromotionXe5d514d4 must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineV1PromotionCodesPostRequestFormPromotionTypeXb7e5197c>(
                    rawObject,
                    "type",
                )
            return InlineV1PromotionCodesPostRequestFormPromotionXe5d514d4(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PromotionCodesPostRequestFormPromotionXe5d514d4,
        ) {
...
public fun inlineV1PromotionCodesPostRequestFormPromotionXe5d514d4(
    block: InlineV1PromotionCodesPostRequestFormPromotionXe5d514d4.Builder.() -> Unit,
): InlineV1PromotionCodesPostRequestFormPromotionXe5d514d4 =
    InlineV1PromotionCodesPostRequestFormPromotionXe5d514d4.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PromotionCodesPostRequestFormPromotionXe5d514d4 is missing required property '" + name + "'",
            )
