...
public sealed class InlineV1IssuingAuthorizationsGetParameterX082aa6a5 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1IssuingAuthorizationsGetParameterX082aa6a5 =
            when (value) {
                Closed.value -> Closed
    ...
    public object Serializer : KSerializer<InlineV1IssuingAuthorizationsGetParameterX082aa6a5> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1IssuingAuthorizationsGetParameterX082aa6a5",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1IssuingAuthorizationsGetParameterX082aa6a5 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingAuthorizationsGetParameterX082aa6a5,
        ) {
