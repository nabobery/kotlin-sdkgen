...
public class BankConnectionsResourceAccountholder(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): BankConnectionsResourceAccountholder =
    ...
    public object Serializer : KSerializer<BankConnectionsResourceAccountholder> {
        ...
        override fun deserialize(decoder: Decoder): BankConnectionsResourceAccountholder {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("BankConnectionsResourceAccountholder must be a JSON object")
            val type = json.decodeRequired<InlineBankConnectionsResourceAccountholderTypeX4438d25c>(rawObject, "type")
            return BankConnectionsResourceAccountholder(
                type = type,
                account =
                    rawObject["account"]?.let {
                        json.decodeFromJsonElement<InlineBankConnectionsResourceAccountholderAccountX9870ade7>(it)
                    },
                customer =
                    rawObject["customer"]?.let {
                        json.decodeFromJsonElement<InlineBankConnectionsResourceAccountholderCustomerX6b1e2861>(it)
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: BankConnectionsResourceAccountholder,
        ) {
...
public fun bankConnectionsResourceAccountholder(
    block: BankConnectionsResourceAccountholder.Builder.() -> Unit,
): BankConnectionsResourceAccountholder = BankConnectionsResourceAccountholder.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "BankConnectionsResourceAccountholder is missing required property '" + name + "'",
            )
