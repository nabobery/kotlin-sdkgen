...
public class InlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1Xe73e82cd(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1Xe73e82cd =
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1Xe73e82cd = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1Xe73e82cd> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1Xe73e82cd must be a JSON object",
                    )
            return InlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1Xe73e82cd(
                aed =
                    rawObject["aed"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1AedXdadd99de>(
                                it,
                            )
                    },
                aud =
                    rawObject["aud"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1AudX3fc9e173>(
                                it,
                            )
                    },
                cad =
                    rawObject["cad"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1CadX56412023>(
                                it,
                            )
                    },
                chf =
                    rawObject["chf"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1ChfX955d18c2>(
                                it,
                            )
                    },
                czk =
                    rawObject["czk"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1CzkXa086a156>(
                                it,
                            )
                    },
                dkk =
                    rawObject["dkk"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1DkkXc8f944c7>(
                                it,
                            )
                    },
                eur =
                    rawObject["eur"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1EurX6704c1e5>(
                                it,
                            )
                    },
                gbp =
                    rawObject["gbp"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1GbpX02b10404>(
                                it,
                            )
                    },
                gip =
                    rawObject["gip"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1GipXea6a099f>(
                                it,
                            )
                    },
                hkd =
                    rawObject["hkd"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1HkdXb6390650>(
                                it,
                            )
                    },
                huf =
                    rawObject["huf"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1HufX72796a0c>(
                                it,
                            )
                    },
                jpy =
                    rawObject["jpy"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1JpyXc030b81b>(
                                it,
                            )
                    },
                mxn =
                    rawObject["mxn"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1MxnXe18ef375>(
                                it,
                            )
                    },
                myr =
                    rawObject["myr"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1MyrXeeb16cc0>(
                                it,
                            )
                    },
                nok =
                    rawObject["nok"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1NokX7eecafed>(
                                it,
                            )
                    },
                nzd =
                    rawObject["nzd"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1NzdXf408d8c1>(
                                it,
                            )
                    },
                pln =
                    rawObject["pln"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1PlnX585545f7>(
                                it,
                            )
                    },
                ron =
                    rawObject["ron"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1RonXb06b7086>(
                                it,
                            )
                    },
                sek =
                    rawObject["sek"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1SekX364eb790>(
                                it,
                            )
                    },
                sgd =
                    rawObject["sgd"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1SgdX82b25119>(
                                it,
                            )
                    },
                usd =
                    rawObject["usd"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1UsdX945c1b6b>(
                                    it,
                                )
                        },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1Xe73e82cd,
        ) {
            val jsonEncoder =
...
public fun inlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1Xe73e82cd(
    block: InlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1Xe73e82cd.Builder.() -> Unit,
): InlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1Xe73e82cd =
    InlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1Xe73e82cd.build(block)
