...
public sealed class InlinePaymentMethodUsBankAccountBlockedReasonX9256636c {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentMethodUsBankAccountBlockedReasonX9256636c =
            when (value) {
    ...
    public object Serializer : KSerializer<InlinePaymentMethodUsBankAccountBlockedReasonX9256636c> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentMethodUsBankAccountBlockedReasonX9256636c",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePaymentMethodUsBankAccountBlockedReasonX9256636c =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentMethodUsBankAccountBlockedReasonX9256636c,
        ) {
