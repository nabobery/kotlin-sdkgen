...
public sealed class InlineV1TerminalReadersPostRequestFormMetadataAnyOf2X0025dc50 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1TerminalReadersPostRequestFormMetadataAnyOf2X0025dc50 =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1TerminalReadersPostRequestFormMetadataAnyOf2X0025dc50> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1TerminalReadersPostRequestFormMetadataAnyOf2X0025dc50",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1TerminalReadersPostRequestFormMetadataAnyOf2X0025dc50 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TerminalReadersPostRequestFormMetadataAnyOf2X0025dc50,
        ) {
