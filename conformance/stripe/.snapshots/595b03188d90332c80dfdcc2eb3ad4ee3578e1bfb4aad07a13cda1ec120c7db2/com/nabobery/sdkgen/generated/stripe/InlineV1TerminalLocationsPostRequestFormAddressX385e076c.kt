...
public class InlineV1TerminalLocationsPostRequestFormAddressX385e076c(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TerminalLocationsPostRequestFormAddressX385e076c =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TerminalLocationsPostRequestFormAddressX385e076c> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TerminalLocationsPostRequestFormAddressX385e076c must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TerminalLocationsPostRequestFormAddressX385e076c,
        ) {
...
public fun inlineV1TerminalLocationsPostRequestFormAddressX385e076c(
    block: InlineV1TerminalLocationsPostRequestFormAddressX385e076c.Builder.() -> Unit,
): InlineV1TerminalLocationsPostRequestFormAddressX385e076c =
    InlineV1TerminalLocationsPostRequestFormAddressX385e076c.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TerminalLocationsPostRequestFormAddressX385e076c is missing required property '" + name + "'",
            )
