...
public sealed class InlineTopupObjectValueXef89b750 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineTopupObjectValueXef89b750 =
            when (value) {
                Topup.value -> Topup
    ...
    public object Serializer : KSerializer<InlineTopupObjectValueXef89b750> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineTopupObjectValueXef89b750",
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineTopupObjectValueXef89b750,
        ) {
