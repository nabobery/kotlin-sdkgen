...
public class InlineV1PaymentMethodsPostRequestFormCardAnyOf1X489c1b45(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PaymentMethodsPostRequestFormCardAnyOf1X489c1b45 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentMethodsPostRequestFormCardAnyOf1X489c1b45> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentMethodsPostRequestFormCardAnyOf1X489c1b45 must be a JSON object",
                    )
            ...
            return InlineV1PaymentMethodsPostRequestFormCardAnyOf1X489c1b45(
                ...
                networks =
                    rawObject["networks"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentMethodsPostRequestFormCardAnyOf1NetworksXc385ca6f>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentMethodsPostRequestFormCardAnyOf1X489c1b45,
        ) {
...
public fun inlineV1PaymentMethodsPostRequestFormCardAnyOf1X489c1b45(
    block: InlineV1PaymentMethodsPostRequestFormCardAnyOf1X489c1b45.Builder.() -> Unit,
): InlineV1PaymentMethodsPostRequestFormCardAnyOf1X489c1b45 =
    InlineV1PaymentMethodsPostRequestFormCardAnyOf1X489c1b45.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentMethodsPostRequestFormCardAnyOf1X489c1b45 is missing required property '" + name + "'",
            )
