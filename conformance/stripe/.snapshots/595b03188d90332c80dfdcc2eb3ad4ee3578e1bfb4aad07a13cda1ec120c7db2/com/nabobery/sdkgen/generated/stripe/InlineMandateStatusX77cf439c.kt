...
public sealed class InlineMandateStatusX77cf439c {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineMandateStatusX77cf439c =
            when (value) {
                Active.value -> Active
    ...
    public object Serializer : KSerializer<InlineMandateStatusX77cf439c> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineMandateStatusX77cf439c",
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineMandateStatusX77cf439c,
        ) {
