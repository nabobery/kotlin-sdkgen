...
public class InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X53d1933b(
    public val bankTransfer: InlineV1SubscriptionsPostRequestFormPaymentSettingsBankTransferXebc58406? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X53d1933b =
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X53d1933b = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X53d1933b> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X53d1933b must be a JSON object",
                    )
            return InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X53d1933b(
                bankTransfer =
                    rawObject["bank_transfer"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormPaymentSettingsBankTransferXebc58406>(
                                it,
                            )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X53d1933b,
        ) {
            val jsonEncoder =
...
public fun inlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X53d1933b(
    block: InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X53d1933b.Builder.() -> Unit,
): InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X53d1933b =
    InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X53d1933b.build(block)
