...
public class InlineV1TokensPostRequestFormAccountXe0f6a7b3(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1TokensPostRequestFormAccountXe0f6a7b3 =
            InlineV1TokensPostRequestFormAccountXe0f6a7b3(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TokensPostRequestFormAccountXe0f6a7b3 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TokensPostRequestFormAccountXe0f6a7b3> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TokensPostRequestFormAccountXe0f6a7b3 must be a JSON object",
                    )
            return InlineV1TokensPostRequestFormAccountXe0f6a7b3(
                businessType =
                    rawObject["business_type"]?.let {
                        json.decodeFromJsonElement<InlineV1TokensPostRequestFormAccountBusinessTypeX95563f54>(it)
                    },
                company =
                    rawObject["company"]?.let {
                        json.decodeFromJsonElement<InlineV1TokensPostRequestFormAccountCompanyXed13887c>(it)
                    },
                individual =
                    rawObject["individual"]?.let {
                        json.decodeFromJsonElement<InlineV1TokensPostRequestFormAccountIndividualXe27c278f>(it)
                    },
                tosShownAndAccepted =
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TokensPostRequestFormAccountXe0f6a7b3,
        ) {
...
public fun inlineV1TokensPostRequestFormAccountXe0f6a7b3(
    block: InlineV1TokensPostRequestFormAccountXe0f6a7b3.Builder.() -> Unit,
): InlineV1TokensPostRequestFormAccountXe0f6a7b3 = InlineV1TokensPostRequestFormAccountXe0f6a7b3.build(block)
