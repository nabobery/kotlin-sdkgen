    ...
    public object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormBillingAddressCollectionX37212d9e> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1CheckoutSessionsPostRequestFormBillingAddressCollectionX37212d9e",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1CheckoutSessionsPostRequestFormBillingAddressCollectionX37212d9e = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsPostRequestFormBillingAddressCollectionX37212d9e,
        ) {
