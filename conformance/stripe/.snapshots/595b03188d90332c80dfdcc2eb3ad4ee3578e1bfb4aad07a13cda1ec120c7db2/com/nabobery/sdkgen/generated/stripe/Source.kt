        ...
        override fun deserialize(decoder: Decoder): Source {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("Source must be a JSON object")
            ...
            return Source(
                ...
                achCreditTransfer =
                    rawObject["ach_credit_transfer"]?.let {
                        json.decodeFromJsonElement<SourceTypeAchCreditTransfer>(it)
                    },
                ...
                allowRedisplay =
                    rawObject["allow_redisplay"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineSourceAllowRedisplayX98b1333c?>(element)
                        }
                    },
                amount =
                ...
                codeVerification =
                    rawObject["code_verification"]?.let {
                        json.decodeFromJsonElement<SourceCodeVerificationFlow>(
                            it,
                        )
                    },
                currency =
                ...
                owner =
                    rawObject["owner"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineSourceOwnerXc08c428d?>(element)
                        }
                    },
                ...
                threeDSecure =
                    rawObject["three_d_secure"]?.let {
                        json.decodeFromJsonElement<SourceTypeThreeDSecure>(
                            it,
                        )
                    },
                usage =
                    rawObject["usage"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
