...
public sealed class InlineForwardedRequestDetailsHttpMethodXc5443c41 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineForwardedRequestDetailsHttpMethodXc5443c41 =
            when (value) {
                Post.value -> Post
    ...
    public object Serializer : KSerializer<InlineForwardedRequestDetailsHttpMethodXc5443c41> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineForwardedRequestDetailsHttpMethodXc5443c41",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineForwardedRequestDetailsHttpMethodXc5443c41 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineForwardedRequestDetailsHttpMethodXc5443c41,
        ) {
