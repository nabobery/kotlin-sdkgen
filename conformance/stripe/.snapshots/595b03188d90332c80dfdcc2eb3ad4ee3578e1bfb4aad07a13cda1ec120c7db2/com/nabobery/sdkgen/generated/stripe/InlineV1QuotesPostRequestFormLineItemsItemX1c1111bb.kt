...
public class InlineV1QuotesPostRequestFormLineItemsItemX1c1111bb(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1QuotesPostRequestFormLineItemsItemX1c1111bb =
            InlineV1QuotesPostRequestFormLineItemsItemX1c1111bb(
                discounts = discounts,
                id = id,
                price = price,
                priceData = priceData,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1QuotesPostRequestFormLineItemsItemX1c1111bb =
    ...
    public object Serializer : KSerializer<InlineV1QuotesPostRequestFormLineItemsItemX1c1111bb> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1QuotesPostRequestFormLineItemsItemX1c1111bb must be a JSON object",
                    )
            return InlineV1QuotesPostRequestFormLineItemsItemX1c1111bb(
                discounts =
                    rawObject["discounts"]?.let {
                        json.decodeFromJsonElement<InlineV1QuotesPostRequestFormLineItemsItemDiscountsXd7b55bdc>(it)
                    },
                ...
                priceData =
                    rawObject["price_data"]?.let {
                        json.decodeFromJsonElement<InlineV1QuotesPostRequestFormLineItemsItemPriceDataXc1d2a6f2>(it)
                    },
                quantity = rawObject["quantity"]?.let { json.decodeFromJsonElement<Int>(it) },
                taxRates =
                    rawObject["tax_rates"]?.let {
                        json.decodeFromJsonElement<InlineV1QuotesPostRequestFormLineItemsItemTaxRatesX5f3cd9d7>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1QuotesPostRequestFormLineItemsItemX1c1111bb,
        ) {
...
public fun inlineV1QuotesPostRequestFormLineItemsItemX1c1111bb(
    block: InlineV1QuotesPostRequestFormLineItemsItemX1c1111bb.Builder.() -> Unit,
): InlineV1QuotesPostRequestFormLineItemsItemX1c1111bb =
    InlineV1QuotesPostRequestFormLineItemsItemX1c1111bb.build(block)
