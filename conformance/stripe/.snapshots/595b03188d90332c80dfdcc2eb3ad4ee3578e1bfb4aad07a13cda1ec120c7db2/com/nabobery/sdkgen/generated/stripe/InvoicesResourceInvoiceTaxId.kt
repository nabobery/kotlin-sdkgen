...
public class InvoicesResourceInvoiceTaxId(
    ...
    public object Serializer : KSerializer<InvoicesResourceInvoiceTaxId> {
        ...
        override fun deserialize(decoder: Decoder): InvoicesResourceInvoiceTaxId {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("InvoicesResourceInvoiceTaxId must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InvoicesResourceInvoiceTaxId,
        ) {
...
public fun invoicesResourceInvoiceTaxId(
    block: InvoicesResourceInvoiceTaxId.Builder.() -> Unit,
): InvoicesResourceInvoiceTaxId = InvoicesResourceInvoiceTaxId.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException("InvoicesResourceInvoiceTaxId is missing required property '" + name + "'")
