...
public class TerminalReaderReaderResourceRefundPaymentConfig(
    ...
    public class Builder {
        ...
        public fun build(): TerminalReaderReaderResourceRefundPaymentConfig =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): TerminalReaderReaderResourceRefundPaymentConfig =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<TerminalReaderReaderResourceRefundPaymentConfig> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "TerminalReaderReaderResourceRefundPaymentConfig must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: TerminalReaderReaderResourceRefundPaymentConfig,
        ) {
...
public fun terminalReaderReaderResourceRefundPaymentConfig(
    block: TerminalReaderReaderResourceRefundPaymentConfig.Builder.() -> Unit,
): TerminalReaderReaderResourceRefundPaymentConfig = TerminalReaderReaderResourceRefundPaymentConfig.build(block)
