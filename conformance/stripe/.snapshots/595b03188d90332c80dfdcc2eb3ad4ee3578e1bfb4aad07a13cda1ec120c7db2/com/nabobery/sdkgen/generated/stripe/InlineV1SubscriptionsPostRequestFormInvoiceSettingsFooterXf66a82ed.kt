...
internal data class InlineV1SubscriptionsPostRequestFormInvoiceSettingsFooterXf66a82edInspection(
    ...
    public val matchesInlineV1SubscriptionsPostRequestFormInvoiceSettingsFooterAnyOf2Xcfec1a81: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1SubscriptionsPostRequestFormInvoiceSettingsFooterAnyOf2Xcfec1a81,
            ).count {
                it
            }
}
...
public class InlineV1SubscriptionsPostRequestFormInvoiceSettingsFooterXf66a82ed internal constructor(
    ...
    private val inspection: InlineV1SubscriptionsPostRequestFormInvoiceSettingsFooterXf66a82edInspection,
) {
    ...
    public val inlineV1SubscriptionsPostRequestFormInvoiceSettingsFooterAnyOf2Xcfec1a81:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1SubscriptionsPostRequestFormInvoiceSettingsFooterAnyOf2Xcfec1a81) {
                json
                    .decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormInvoiceSettingsFooterAnyOf2Xcfec1a81>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1SubscriptionsPostRequestFormInvoiceSettingsFooterXf66a82edBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1SubscriptionsPostRequestFormInvoiceSettingsFooterAnyOf2Xcfec1a81) {
                    add(
                        InlineV1SubscriptionsPostRequestFormInvoiceSettingsFooterXf66a82edBranch.InlineV1SubscriptionsPostRequestFormInvoiceSettingsFooterAnyOf2Xcfec1a81,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1SubscriptionsPostRequestFormInvoiceSettingsFooterXf66a82ed {
            val inspection = inspectInlineV1SubscriptionsPostRequestFormInvoiceSettingsFooterXf66a82ed(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1SubscriptionsPostRequestFormInvoiceSettingsFooterXf66a82edNoMatchException(
                    "InlineV1SubscriptionsPostRequestFormInvoiceSettingsFooterXf66a82ed matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionsPostRequestFormInvoiceSettingsFooterXf66a82ed> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsPostRequestFormInvoiceSettingsFooterXf66a82ed,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1SubscriptionsPostRequestFormInvoiceSettingsFooterXf66a82ed",
...
private fun inspectInlineV1SubscriptionsPostRequestFormInvoiceSettingsFooterXf66a82ed(
    element: JsonElement,
): InlineV1SubscriptionsPostRequestFormInvoiceSettingsFooterXf66a82edInspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1SubscriptionsPostRequestFormInvoiceSettingsFooterAnyOf2Xcfec1a81 =
        element
            .isJsonDecodable<InlineV1SubscriptionsPostRequestFormInvoiceSettingsFooterAnyOf2Xcfec1a81>()
    return InlineV1SubscriptionsPostRequestFormInvoiceSettingsFooterXf66a82edInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1SubscriptionsPostRequestFormInvoiceSettingsFooterAnyOf2Xcfec1a81) {
                    add(
                        "InlineV1SubscriptionsPostRequestFormInvoiceSettingsFooterAnyOf2Xcfec1a81: value does not match InlineV1SubscriptionsPostRequestFormInvoiceSettingsFooterAnyOf2Xcfec1a81",
                    )
                }
            },
    )
