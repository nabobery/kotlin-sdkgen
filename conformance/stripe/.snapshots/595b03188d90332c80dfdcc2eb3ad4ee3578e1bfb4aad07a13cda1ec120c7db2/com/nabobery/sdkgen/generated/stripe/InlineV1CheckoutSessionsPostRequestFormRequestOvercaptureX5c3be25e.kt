...
public sealed class InlineV1CheckoutSessionsPostRequestFormRequestOvercaptureX5c3be25e {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1CheckoutSessionsPostRequestFormRequestOvercaptureX5c3be25e =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormRequestOvercaptureX5c3be25e> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1CheckoutSessionsPostRequestFormRequestOvercaptureX5c3be25e",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1CheckoutSessionsPostRequestFormRequestOvercaptureX5c3be25e =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsPostRequestFormRequestOvercaptureX5c3be25e,
        ) {
