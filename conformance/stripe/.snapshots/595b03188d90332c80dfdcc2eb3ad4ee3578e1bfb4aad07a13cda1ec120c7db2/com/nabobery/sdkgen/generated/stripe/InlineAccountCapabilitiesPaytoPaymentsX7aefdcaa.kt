...
public sealed class InlineAccountCapabilitiesPaytoPaymentsX7aefdcaa {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineAccountCapabilitiesPaytoPaymentsX7aefdcaa =
            when (value) {
                Active.value -> Active
    ...
    public object Serializer : KSerializer<InlineAccountCapabilitiesPaytoPaymentsX7aefdcaa> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineAccountCapabilitiesPaytoPaymentsX7aefdcaa",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineAccountCapabilitiesPaytoPaymentsX7aefdcaa =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineAccountCapabilitiesPaytoPaymentsX7aefdcaa,
        ) {
