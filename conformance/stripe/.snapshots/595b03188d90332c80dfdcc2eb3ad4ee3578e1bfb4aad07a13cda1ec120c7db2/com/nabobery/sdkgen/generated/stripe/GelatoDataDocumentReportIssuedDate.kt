...
public class GelatoDataDocumentReportIssuedDate(
    ...
    public class Builder {
        ...
        public fun build(): GelatoDataDocumentReportIssuedDate =
    ...
    public object Serializer : KSerializer<GelatoDataDocumentReportIssuedDate> {
        ...
        override fun deserialize(decoder: Decoder): GelatoDataDocumentReportIssuedDate {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("GelatoDataDocumentReportIssuedDate must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: GelatoDataDocumentReportIssuedDate,
        ) {
...
public fun gelatoDataDocumentReportIssuedDate(
    block: GelatoDataDocumentReportIssuedDate.Builder.() -> Unit,
): GelatoDataDocumentReportIssuedDate = GelatoDataDocumentReportIssuedDate.build(block)
