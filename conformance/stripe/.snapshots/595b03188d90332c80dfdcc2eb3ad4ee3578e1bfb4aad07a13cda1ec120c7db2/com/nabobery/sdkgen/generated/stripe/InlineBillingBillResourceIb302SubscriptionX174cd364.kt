...
public class InlineBillingBillResourceIb302SubscriptionX174cd364 internal constructor(
    ...
    public val matchedBranches: Set<InlineBillingBillResourceIb302SubscriptionX174cd364Branch>
        get() =
            buildSet {
                ...
                if (inspection.matchesSubscription) {
                    add(
                        InlineBillingBillResourceIb302SubscriptionX174cd364Branch.Subscription,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineBillingBillResourceIb302SubscriptionX174cd364 {
            val inspection = inspectInlineBillingBillResourceIb302SubscriptionX174cd364(raw)
            if (inspection.matchCount == 0) {
                throw InlineBillingBillResourceIb302SubscriptionX174cd364NoMatchException(
                    "InlineBillingBillResourceIb302SubscriptionX174cd364 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineBillingBillResourceIb302SubscriptionX174cd364> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineBillingBillResourceIb302SubscriptionX174cd364,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineBillingBillResourceIb302SubscriptionX174cd364",
...
private fun inspectInlineBillingBillResourceIb302SubscriptionX174cd364(
    element: JsonElement,
): InlineBillingBillResourceIb302SubscriptionX174cd364Inspection {
