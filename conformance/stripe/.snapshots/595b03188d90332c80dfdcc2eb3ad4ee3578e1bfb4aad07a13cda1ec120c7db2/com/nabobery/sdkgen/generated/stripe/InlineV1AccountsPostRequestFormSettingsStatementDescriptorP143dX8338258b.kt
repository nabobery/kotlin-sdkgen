...
internal data class InlineV1AccountsPostRequestFormSettingsStatementDescriptorP143dX8338258bInspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1AccountsPostRequestFormSettingsCardPaymentsAnyOf2X9dc78c31,
            ).count { it }
}
...
public class InlineV1AccountsPostRequestFormSettingsStatementDescriptorP143dX8338258b internal constructor(
    ...
    private val inspection: InlineV1AccountsPostRequestFormSettingsStatementDescriptorP143dX8338258bInspection,
) {
    ...
    public val inlineV1AccountsPostRequestFormSettingsCardPaymentsAnyOf2X9dc78c31:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1AccountsPostRequestFormSettingsCardPaymentsAnyOf2X9dc78c31) {
                json
                    .decodeFromJsonElement<InlineV1AccountsPostRequestFormSettingsCardPaymentsAnyOf2X9dc78c31>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1AccountsPostRequestFormSettingsStatementDescriptorP143dX8338258bBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1AccountsPostRequestFormSettingsCardPaymentsAnyOf2X9dc78c31) {
                    add(
                        InlineV1AccountsPostRequestFormSettingsStatementDescriptorP143dX8338258bBranch.InlineV1AccountsPostRequestFormSettingsCardPaymentsAnyOf2X9dc78c31,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1AccountsPostRequestFormSettingsStatementDescriptorP143dX8338258b {
            val inspection = inspectInlineV1AccountsPostRequestFormSettingsStatementDescriptorP143dX8338258b(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1AccountsPostRequestFormSettingsStatementDescriptorP143dX8338258bNoMatchException(
                    "InlineV1AccountsPostRequestFormSettingsStatementDescriptorP143dX8338258b matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1AccountsPostRequestFormSettingsStatementDescriptorP143dX8338258b> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPostRequestFormSettingsStatementDescriptorP143dX8338258b,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1AccountsPostRequestFormSettingsStatementDescriptorP143dX8338258b",
...
private fun inspectInlineV1AccountsPostRequestFormSettingsStatementDescriptorP143dX8338258b(
    element: JsonElement,
): InlineV1AccountsPostRequestFormSettingsStatementDescriptorP143dX8338258bInspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1AccountsPostRequestFormSettingsCardPaymentsAnyOf2X9dc78c31 =
        element
            .isJsonDecodable<InlineV1AccountsPostRequestFormSettingsCardPaymentsAnyOf2X9dc78c31>()
    return InlineV1AccountsPostRequestFormSettingsStatementDescriptorP143dX8338258bInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1AccountsPostRequestFormSettingsCardPaymentsAnyOf2X9dc78c31) {
                    add(
                        "InlineV1AccountsPostRequestFormSettingsCardPaymentsAnyOf2X9dc78c31: value does not match InlineV1AccountsPostRequestFormSettingsCardPaymentsAnyOf2X9dc78c31",
                    )
                }
            },
    )
