...
public sealed class InlinePaymentIntentPaymentMethodOptionsCardRequestMulticaptureXcbbc4e7e {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentIntentPaymentMethodOptionsCardRequestMulticaptureXcbbc4e7e =
            when (value) {
    ...
    public object Serializer : KSerializer<InlinePaymentIntentPaymentMethodOptionsCardRequestMulticaptureXcbbc4e7e> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentIntentPaymentMethodOptionsCardRequestMulticaptureXcbbc4e7e",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlinePaymentIntentPaymentMethodOptionsCardRequestMulticaptureXcbbc4e7e = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentIntentPaymentMethodOptionsCardRequestMulticaptureXcbbc4e7e,
        ) {
