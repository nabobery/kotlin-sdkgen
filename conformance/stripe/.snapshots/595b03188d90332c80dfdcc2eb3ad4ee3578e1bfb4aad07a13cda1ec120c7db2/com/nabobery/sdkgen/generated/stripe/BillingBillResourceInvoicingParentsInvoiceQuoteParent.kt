...
public class BillingBillResourceInvoicingParentsInvoiceQuoteParent(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): BillingBillResourceInvoicingParentsInvoiceQuoteParent =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<BillingBillResourceInvoicingParentsInvoiceQuoteParent> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "BillingBillResourceInvoicingParentsInvoiceQuoteParent must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: BillingBillResourceInvoicingParentsInvoiceQuoteParent,
        ) {
...
public fun billingBillResourceInvoicingParentsInvoiceQuoteParent(
    block: BillingBillResourceInvoicingParentsInvoiceQuoteParent.Builder.() -> Unit,
): BillingBillResourceInvoicingParentsInvoiceQuoteParent =
    BillingBillResourceInvoicingParentsInvoiceQuoteParent.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "BillingBillResourceInvoicingParentsInvoiceQuoteParent is missing required property '" + name + "'",
            )
