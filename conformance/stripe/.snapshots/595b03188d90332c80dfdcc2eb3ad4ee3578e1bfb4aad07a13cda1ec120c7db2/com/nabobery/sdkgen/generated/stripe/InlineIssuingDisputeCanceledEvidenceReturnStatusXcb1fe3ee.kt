...
public sealed class InlineIssuingDisputeCanceledEvidenceReturnStatusXcb1fe3ee {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineIssuingDisputeCanceledEvidenceReturnStatusXcb1fe3ee =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineIssuingDisputeCanceledEvidenceReturnStatusXcb1fe3ee> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineIssuingDisputeCanceledEvidenceReturnStatusXcb1fe3ee",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineIssuingDisputeCanceledEvidenceReturnStatusXcb1fe3ee =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineIssuingDisputeCanceledEvidenceReturnStatusXcb1fe3ee,
        ) {
