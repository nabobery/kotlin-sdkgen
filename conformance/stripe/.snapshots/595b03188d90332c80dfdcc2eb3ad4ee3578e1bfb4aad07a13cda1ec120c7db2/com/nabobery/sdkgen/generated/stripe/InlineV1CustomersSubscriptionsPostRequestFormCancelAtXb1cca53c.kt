...
internal data class InlineV1CustomersSubscriptionsPostRequestFormCancelAtXb1cca53cInspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1CustomersSubscriptionsPostRequestFormCancelAtAnyOf2Xa8dc1ed2,
            ).count { it }
}
...
public class InlineV1CustomersSubscriptionsPostRequestFormCancelAtXb1cca53c internal constructor(
    ...
    public val inlineV1CustomersSubscriptionsPostRequestFormCancelAtAnyOf2Xa8dc1ed2:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1CustomersSubscriptionsPostRequestFormCancelAtAnyOf2Xa8dc1ed2) {
                json
                    .decodeFromJsonElement<InlineV1CustomersSubscriptionsPostRequestFormCancelAtAnyOf2Xa8dc1ed2>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1CustomersSubscriptionsPostRequestFormCancelAtXb1cca53cBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1CustomersSubscriptionsPostRequestFormCancelAtAnyOf2Xa8dc1ed2) {
                    add(
                        InlineV1CustomersSubscriptionsPostRequestFormCancelAtXb1cca53cBranch.InlineV1CustomersSubscriptionsPostRequestFormCancelAtAnyOf2Xa8dc1ed2,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1CustomersSubscriptionsPostRequestFormCancelAtXb1cca53c {
            val inspection = inspectInlineV1CustomersSubscriptionsPostRequestFormCancelAtXb1cca53c(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1CustomersSubscriptionsPostRequestFormCancelAtXb1cca53cNoMatchException(
                    "InlineV1CustomersSubscriptionsPostRequestFormCancelAtXb1cca53c matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1CustomersSubscriptionsPostRequestFormCancelAtXb1cca53c> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersSubscriptionsPostRequestFormCancelAtXb1cca53c,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1CustomersSubscriptionsPostRequestFormCancelAtXb1cca53c",
...
private fun inspectInlineV1CustomersSubscriptionsPostRequestFormCancelAtXb1cca53c(
    element: JsonElement,
): InlineV1CustomersSubscriptionsPostRequestFormCancelAtXb1cca53cInspection {
    val matchesBranch1 = element.isJsonDecodable<Int>()
    val matchesInlineV1CustomersSubscriptionsPostRequestFormCancelAtAnyOf2Xa8dc1ed2 =
        element
            .isJsonDecodable<InlineV1CustomersSubscriptionsPostRequestFormCancelAtAnyOf2Xa8dc1ed2>()
    return InlineV1CustomersSubscriptionsPostRequestFormCancelAtXb1cca53cInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1CustomersSubscriptionsPostRequestFormCancelAtAnyOf2Xa8dc1ed2) {
                    add(
                        "InlineV1CustomersSubscriptionsPostRequestFormCancelAtAnyOf2Xa8dc1ed2: value does not match InlineV1CustomersSubscriptionsPostRequestFormCancelAtAnyOf2Xa8dc1ed2",
                    )
                }
            },
    )
