...
public class InlineV1ChargesPostRequestFormDestinationXa1ddd738 internal constructor(
    ...
    public val inlineV1ChargesPostRequestFormDestinationAnyOf1Xb2aedead:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1ChargesPostRequestFormDestinationAnyOf1Xb2aedead) {
                json
                    .decodeFromJsonElement<InlineV1ChargesPostRequestFormDestinationAnyOf1Xb2aedead>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1ChargesPostRequestFormDestinationXa1ddd738Branch>
        get() =
            buildSet {
                if (inspection.matchesInlineV1ChargesPostRequestFormDestinationAnyOf1Xb2aedead) {
                    add(
                        InlineV1ChargesPostRequestFormDestinationXa1ddd738Branch.InlineV1ChargesPostRequestFormDestinationAnyOf1Xb2aedead,
                    )
                }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1ChargesPostRequestFormDestinationXa1ddd738 {
            val inspection = inspectInlineV1ChargesPostRequestFormDestinationXa1ddd738(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1ChargesPostRequestFormDestinationXa1ddd738NoMatchException(
                    "InlineV1ChargesPostRequestFormDestinationXa1ddd738 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1ChargesPostRequestFormDestinationXa1ddd738> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ChargesPostRequestFormDestinationXa1ddd738,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1ChargesPostRequestFormDestinationXa1ddd738",
...
private fun inspectInlineV1ChargesPostRequestFormDestinationXa1ddd738(
    element: JsonElement,
): InlineV1ChargesPostRequestFormDestinationXa1ddd738Inspection {
    val matchesInlineV1ChargesPostRequestFormDestinationAnyOf1Xb2aedead =
        element
            .isJsonDecodable<InlineV1ChargesPostRequestFormDestinationAnyOf1Xb2aedead>()
    ...
    return InlineV1ChargesPostRequestFormDestinationXa1ddd738Inspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1ChargesPostRequestFormDestinationAnyOf1Xb2aedead) {
                    add(
                        "InlineV1ChargesPostRequestFormDestinationAnyOf1Xb2aedead: value does not match InlineV1ChargesPostRequestFormDestinationAnyOf1Xb2aedead",
                    )
                }
