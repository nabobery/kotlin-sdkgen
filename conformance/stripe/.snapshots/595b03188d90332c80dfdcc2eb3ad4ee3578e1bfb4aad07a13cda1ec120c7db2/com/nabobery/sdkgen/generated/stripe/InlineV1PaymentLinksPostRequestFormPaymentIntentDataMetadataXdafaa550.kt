...
internal data class InlineV1PaymentLinksPostRequestFormPaymentIntentDataMetadataXdafaa550Inspection(
    ...
    public val matchesInlineV1PaymentLinksPostRequestFormPaymentIntentDataMetadataAnyOf2Xcf10fe0d: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1PaymentLinksPostRequestFormPaymentIntentDataMetadataAnyOf2Xcf10fe0d,
            ).count {
                it
            }
}
...
public class InlineV1PaymentLinksPostRequestFormPaymentIntentDataMetadataXdafaa550 internal constructor(
    ...
    private val inspection: InlineV1PaymentLinksPostRequestFormPaymentIntentDataMetadataXdafaa550Inspection,
) {
    ...
    public val inlineV1PaymentLinksPostRequestFormPaymentIntentDataMetadataAnyOf2Xcf10fe0d:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1PaymentLinksPostRequestFormPaymentIntentDataMetadataAnyOf2Xcf10fe0d) {
                json
                    .decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormPaymentIntentDataMetadataAnyOf2Xcf10fe0d>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1PaymentLinksPostRequestFormPaymentIntentDataMetadataXdafaa550Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1PaymentLinksPostRequestFormPaymentIntentDataMetadataAnyOf2Xcf10fe0d) {
                    add(
                        InlineV1PaymentLinksPostRequestFormPaymentIntentDataMetadataXdafaa550Branch.InlineV1PaymentLinksPostRequestFormPaymentIntentDataMetadataAnyOf2Xcf10fe0d,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1PaymentLinksPostRequestFormPaymentIntentDataMetadataXdafaa550 {
            val inspection = inspectInlineV1PaymentLinksPostRequestFormPaymentIntentDataMetadataXdafaa550(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1PaymentLinksPostRequestFormPaymentIntentDataMetadataXdafaa550NoMatchException(
                    "InlineV1PaymentLinksPostRequestFormPaymentIntentDataMetadataXdafaa550 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1PaymentLinksPostRequestFormPaymentIntentDataMetadataXdafaa550> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentLinksPostRequestFormPaymentIntentDataMetadataXdafaa550,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1PaymentLinksPostRequestFormPaymentIntentDataMetadataXdafaa550",
...
private fun inspectInlineV1PaymentLinksPostRequestFormPaymentIntentDataMetadataXdafaa550(
    element: JsonElement,
): InlineV1PaymentLinksPostRequestFormPaymentIntentDataMetadataXdafaa550Inspection {
    val matchesBranch1 = element.isJsonDecodable<JsonObject>()
    val matchesInlineV1PaymentLinksPostRequestFormPaymentIntentDataMetadataAnyOf2Xcf10fe0d =
        element
            .isJsonDecodable<InlineV1PaymentLinksPostRequestFormPaymentIntentDataMetadataAnyOf2Xcf10fe0d>()
    return InlineV1PaymentLinksPostRequestFormPaymentIntentDataMetadataXdafaa550Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1PaymentLinksPostRequestFormPaymentIntentDataMetadataAnyOf2Xcf10fe0d) {
                    add(
                        "InlineV1PaymentLinksPostRequestFormPaymentIntentDataMetadataAnyOf2Xcf10fe0d: value does not match InlineV1PaymentLinksPostRequestFormPaymentIntentDataMetadataAnyOf2Xcf10fe0d",
                    )
                }
            },
    )
