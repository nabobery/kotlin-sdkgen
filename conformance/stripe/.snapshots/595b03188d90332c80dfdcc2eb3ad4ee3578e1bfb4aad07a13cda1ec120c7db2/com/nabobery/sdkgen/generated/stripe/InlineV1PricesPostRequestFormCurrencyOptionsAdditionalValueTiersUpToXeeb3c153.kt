...
internal data class InlineV1PricesPostRequestFormCurrencyOptionsAdditionalValueTiersUpToXeeb3c153Inspection(
    public val matchesInlineV1PricesPostRequestFormCurrencyOptionsAdditionalValueTiersAnyOf1Xe1c066dd: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesInlineV1PricesPostRequestFormCurrencyOptionsAdditionalValueTiersAnyOf1Xe1c066dd,
                matchesBranch2,
            ).count {
                it
            }
...
public class InlineV1PricesPostRequestFormCurrencyOptionsAdditionalValueTiersUpToXeeb3c153 internal constructor(
    ...
    private val inspection: InlineV1PricesPostRequestFormCurrencyOptionsAdditionalValueTiersUpToXeeb3c153Inspection,
) {
    public val inlineV1PricesPostRequestFormCurrencyOptionsAdditionalValueTiersAnyOf1Xe1c066dd:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1PricesPostRequestFormCurrencyOptionsAdditionalValueTiersAnyOf1Xe1c066dd) {
                json
                    .decodeFromJsonElement<InlineV1PricesPostRequestFormCurrencyOptionsAdditionalValueTiersAnyOf1Xe1c066dd>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches:
        ...
        get() =
            buildSet {
                if (inspection.matchesInlineV1PricesPostRequestFormCurrencyOptionsAdditionalValueTiersAnyOf1Xe1c066dd) {
                    add(
                        InlineV1PricesPostRequestFormCurrencyOptionsAdditionalValueTiersUpToXeeb3c153Branch.InlineV1PricesPostRequestFormCurrencyOptionsAdditionalValueTiersAnyOf1Xe1c066dd,
                    )
                }
                if (inspection.matchesBranch2) {
                    add(
                        InlineV1PricesPostRequestFormCurrencyOptionsAdditionalValueTiersUpToXeeb3c153Branch.Branch2,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1PricesPostRequestFormCurrencyOptionsAdditionalValueTiersUpToXeeb3c153 {
            val inspection = inspectInlineV1PricesPostRequestFormCurrencyOptionsAdditionalValueTiersUpToXeeb3c153(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1PricesPostRequestFormCurrencyOptionsAdditionalValueTiersUpToXeeb3c153NoMatchException(
                    "InlineV1PricesPostRequestFormCurrencyOptionsAdditionalValueTiersUpToXeeb3c153 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1PricesPostRequestFormCurrencyOptionsAdditionalValueTiersUpToXeeb3c153> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PricesPostRequestFormCurrencyOptionsAdditionalValueTiersUpToXeeb3c153,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1PricesPostRequestFormCurrencyOptionsAdditionalValueTiersUpToXeeb3c153",
...
private fun inspectInlineV1PricesPostRequestFormCurrencyOptionsAdditionalValueTiersUpToXeeb3c153(
    element: JsonElement,
): InlineV1PricesPostRequestFormCurrencyOptionsAdditionalValueTiersUpToXeeb3c153Inspection {
    val matchesInlineV1PricesPostRequestFormCurrencyOptionsAdditionalValueTiersAnyOf1Xe1c066dd =
        element
            .isJsonDecodable<InlineV1PricesPostRequestFormCurrencyOptionsAdditionalValueTiersAnyOf1Xe1c066dd>()
    ...
    return InlineV1PricesPostRequestFormCurrencyOptionsAdditionalValueTiersUpToXeeb3c153Inspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1PricesPostRequestFormCurrencyOptionsAdditionalValueTiersAnyOf1Xe1c066dd) {
                    add(
                        "InlineV1PricesPostRequestFormCurrencyOptionsAdditionalValueTiersAnyOf1Xe1c066dd: value does not match InlineV1PricesPostRequestFormCurrencyOptionsAdditionalValueTiersAnyOf1Xe1c066dd",
                    )
                }
