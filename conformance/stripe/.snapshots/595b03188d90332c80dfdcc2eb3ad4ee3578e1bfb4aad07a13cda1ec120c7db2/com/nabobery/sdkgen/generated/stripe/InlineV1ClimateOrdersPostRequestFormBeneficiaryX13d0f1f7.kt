...
internal data class InlineV1ClimateOrdersPostRequestFormBeneficiaryX13d0f1f7Inspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesInlineV1ClimateOrdersPostRequestFormBeneficiaryAnyOf1X59335f3f,
                matchesInlineV1ClimateOrdersPostRequestFormBeneficiaryAnyOf2Xce94a6b5,
            ).count {
                it
            }
}
...
public class InlineV1ClimateOrdersPostRequestFormBeneficiaryX13d0f1f7 internal constructor(
    ...
    public val inlineV1ClimateOrdersPostRequestFormBeneficiaryAnyOf1X59335f3f:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1ClimateOrdersPostRequestFormBeneficiaryAnyOf1X59335f3f) {
                json
                    .decodeFromJsonElement<InlineV1ClimateOrdersPostRequestFormBeneficiaryAnyOf1X59335f3f>(
                        raw,
                    )
            } else {
                null
    ...
    public val inlineV1ClimateOrdersPostRequestFormBeneficiaryAnyOf2Xce94a6b5:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1ClimateOrdersPostRequestFormBeneficiaryAnyOf2Xce94a6b5) {
                json
                    .decodeFromJsonElement<InlineV1ClimateOrdersPostRequestFormBeneficiaryAnyOf2Xce94a6b5>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1ClimateOrdersPostRequestFormBeneficiaryX13d0f1f7Branch>
        get() =
            buildSet {
                if (inspection.matchesInlineV1ClimateOrdersPostRequestFormBeneficiaryAnyOf1X59335f3f) {
                    add(
                        InlineV1ClimateOrdersPostRequestFormBeneficiaryX13d0f1f7Branch.InlineV1ClimateOrdersPostRequestFormBeneficiaryAnyOf1X59335f3f,
                    )
                }
                if (inspection.matchesInlineV1ClimateOrdersPostRequestFormBeneficiaryAnyOf2Xce94a6b5) {
                    add(
                        InlineV1ClimateOrdersPostRequestFormBeneficiaryX13d0f1f7Branch.InlineV1ClimateOrdersPostRequestFormBeneficiaryAnyOf2Xce94a6b5,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1ClimateOrdersPostRequestFormBeneficiaryX13d0f1f7 {
            val inspection = inspectInlineV1ClimateOrdersPostRequestFormBeneficiaryX13d0f1f7(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1ClimateOrdersPostRequestFormBeneficiaryX13d0f1f7NoMatchException(
                    "InlineV1ClimateOrdersPostRequestFormBeneficiaryX13d0f1f7 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1ClimateOrdersPostRequestFormBeneficiaryX13d0f1f7> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ClimateOrdersPostRequestFormBeneficiaryX13d0f1f7,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1ClimateOrdersPostRequestFormBeneficiaryX13d0f1f7",
...
private fun inspectInlineV1ClimateOrdersPostRequestFormBeneficiaryX13d0f1f7(
    element: JsonElement,
): InlineV1ClimateOrdersPostRequestFormBeneficiaryX13d0f1f7Inspection {
    val matchesInlineV1ClimateOrdersPostRequestFormBeneficiaryAnyOf1X59335f3f =
        element
            .isJsonDecodable<InlineV1ClimateOrdersPostRequestFormBeneficiaryAnyOf1X59335f3f>()
    val matchesInlineV1ClimateOrdersPostRequestFormBeneficiaryAnyOf2Xce94a6b5 =
        element
            .isJsonDecodable<InlineV1ClimateOrdersPostRequestFormBeneficiaryAnyOf2Xce94a6b5>()
    return InlineV1ClimateOrdersPostRequestFormBeneficiaryX13d0f1f7Inspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1ClimateOrdersPostRequestFormBeneficiaryAnyOf1X59335f3f) {
                    add(
                        "InlineV1ClimateOrdersPostRequestFormBeneficiaryAnyOf1X59335f3f: value does not match InlineV1ClimateOrdersPostRequestFormBeneficiaryAnyOf1X59335f3f",
                    )
                }
                if (!matchesInlineV1ClimateOrdersPostRequestFormBeneficiaryAnyOf2Xce94a6b5) {
                    add(
                        "InlineV1ClimateOrdersPostRequestFormBeneficiaryAnyOf2Xce94a6b5: value does not match InlineV1ClimateOrdersPostRequestFormBeneficiaryAnyOf2Xce94a6b5",
                    )
                }
            },
    )
