...
public sealed class InlineIssuingCardholderStatusX93ea3633 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineIssuingCardholderStatusX93ea3633 =
            when (value) {
                Active.value -> Active
    ...
    public object Serializer : KSerializer<InlineIssuingCardholderStatusX93ea3633> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineIssuingCardholderStatusX93ea3633",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineIssuingCardholderStatusX93ea3633 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineIssuingCardholderStatusX93ea3633,
        ) {
