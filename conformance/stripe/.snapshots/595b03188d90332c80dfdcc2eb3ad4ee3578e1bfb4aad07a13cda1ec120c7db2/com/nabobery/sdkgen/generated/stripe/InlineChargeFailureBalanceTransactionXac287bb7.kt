...
public class InlineChargeFailureBalanceTransactionXac287bb7 internal constructor(
        ...
        get() =
            buildSet {
                ...
                if (inspection.matchesBalanceTransaction) {
                    add(
                        InlineChargeFailureBalanceTransactionXac287bb7Branch.BalanceTransaction,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineChargeFailureBalanceTransactionXac287bb7 {
            val inspection = inspectInlineChargeFailureBalanceTransactionXac287bb7(raw)
            if (inspection.matchCount == 0) {
                throw InlineChargeFailureBalanceTransactionXac287bb7NoMatchException(
                    "InlineChargeFailureBalanceTransactionXac287bb7 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineChargeFailureBalanceTransactionXac287bb7> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineChargeFailureBalanceTransactionXac287bb7,
        ) {
...
private fun inspectInlineChargeFailureBalanceTransactionXac287bb7(
    element: JsonElement,
): InlineChargeFailureBalanceTransactionXac287bb7Inspection {
