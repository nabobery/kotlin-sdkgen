...
public sealed class InlineV1CheckoutSessionsPostRequestFormLocaleXc67a5bfc {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1CheckoutSessionsPostRequestFormLocaleXc67a5bfc =
            when (value) {
                Auto.value -> Auto
                Bg.value -> Bg
                Cs.value -> Cs
    ...
    public object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormLocaleXc67a5bfc> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1CheckoutSessionsPostRequestFormLocaleXc67a5bfc",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1CheckoutSessionsPostRequestFormLocaleXc67a5bfc =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsPostRequestFormLocaleXc67a5bfc,
        ) {
