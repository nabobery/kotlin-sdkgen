...
public class InlineInvoicesPaymentsInvoicePaymentAssociatedPaymentChargeX8b34a4f4 internal constructor(
    ...
    private val inspection: InlineInvoicesPaymentsInvoicePaymentAssociatedPaymentChargeX8b34a4f4Inspection,
) {
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineInvoicesPaymentsInvoicePaymentAssociatedPaymentChargeX8b34a4f4Branch.Branch1,
                    )
                }
                if (inspection.matchesCharge) {
                    add(
                        InlineInvoicesPaymentsInvoicePaymentAssociatedPaymentChargeX8b34a4f4Branch.Charge,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineInvoicesPaymentsInvoicePaymentAssociatedPaymentChargeX8b34a4f4 {
            val inspection = inspectInlineInvoicesPaymentsInvoicePaymentAssociatedPaymentChargeX8b34a4f4(raw)
            if (inspection.matchCount == 0) {
                throw InlineInvoicesPaymentsInvoicePaymentAssociatedPaymentChargeX8b34a4f4NoMatchException(
                    "InlineInvoicesPaymentsInvoicePaymentAssociatedPaymentChargeX8b34a4f4 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineInvoicesPaymentsInvoicePaymentAssociatedPaymentChargeX8b34a4f4> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineInvoicesPaymentsInvoicePaymentAssociatedPaymentChargeX8b34a4f4,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineInvoicesPaymentsInvoicePaymentAssociatedPaymentChargeX8b34a4f4",
...
private fun inspectInlineInvoicesPaymentsInvoicePaymentAssociatedPaymentChargeX8b34a4f4(
    element: JsonElement,
