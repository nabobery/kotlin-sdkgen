...
public class InlineV1PaymentLinksPostRequestFormCustomFieldsItemLabelX2e471dc2(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PaymentLinksPostRequestFormCustomFieldsItemLabelX2e471dc2 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentLinksPostRequestFormCustomFieldsItemLabelX2e471dc2> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1PaymentLinksPostRequestFormCustomFieldsItemLabelX2e471dc2 {
            val jsonDecoder =
                decoder.requireJsonDecoder(
                    "InlineV1PaymentLinksPostRequestFormCustomFieldsItemLabelX2e471dc2",
                )
            val json = jsonDecoder.json
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentLinksPostRequestFormCustomFieldsItemLabelX2e471dc2 must be a JSON object",
                    )
            val custom = json.decodeRequired<String>(rawObject, "custom")
            val type =
                json.decodeRequired<InlineV1PaymentLinksPostRequestFormCustomFieldsItemLabelTypeX0129ff8a>(
                    rawObject,
                    "type",
                )
            return InlineV1PaymentLinksPostRequestFormCustomFieldsItemLabelX2e471dc2(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentLinksPostRequestFormCustomFieldsItemLabelX2e471dc2,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentLinksPostRequestFormCustomFieldsItemLabelX2e471dc2(
    block: InlineV1PaymentLinksPostRequestFormCustomFieldsItemLabelX2e471dc2.Builder.() -> Unit,
): InlineV1PaymentLinksPostRequestFormCustomFieldsItemLabelX2e471dc2 =
    InlineV1PaymentLinksPostRequestFormCustomFieldsItemLabelX2e471dc2.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentLinksPostRequestFormCustomFieldsItemLabelX2e471dc2 is missing required property '" +
                    name +
                    "'",
            )
