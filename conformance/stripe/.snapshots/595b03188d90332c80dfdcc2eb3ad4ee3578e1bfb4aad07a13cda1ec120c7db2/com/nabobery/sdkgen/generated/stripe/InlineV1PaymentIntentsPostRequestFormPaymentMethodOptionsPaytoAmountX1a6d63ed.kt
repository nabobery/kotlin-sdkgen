...
internal data class InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPaytoAmountX1a6d63edInspection(
    ...
    public val matchesInlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPaytoAnyOf2X0f115ab7: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPaytoAnyOf2X0f115ab7,
            ).count {
                it
            }
}
...
public class InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPaytoAmountX1a6d63ed internal constructor(
    ...
    private val inspection: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPaytoAmountX1a6d63edInspection,
) {
    ...
    public val inlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPaytoAnyOf2X0f115ab7:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPaytoAnyOf2X0f115ab7) {
                json
                    .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPaytoAnyOf2X0f115ab7>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPaytoAmountX1a6d63edBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPaytoAnyOf2X0f115ab7) {
                    add(
                        InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPaytoAmountX1a6d63edBranch.InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPaytoAnyOf2X0f115ab7,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPaytoAmountX1a6d63ed {
            val inspection = inspectInlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPaytoAmountX1a6d63ed(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPaytoAmountX1a6d63edNoMatchException(
                    "InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPaytoAmountX1a6d63ed matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPaytoAmountX1a6d63ed> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPaytoAmountX1a6d63ed,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPaytoAmountX1a6d63ed",
...
private fun inspectInlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPaytoAmountX1a6d63ed(
    element: JsonElement,
): InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPaytoAmountX1a6d63edInspection {
    val matchesBranch1 = element.isJsonDecodable<Int>()
    val matchesInlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPaytoAnyOf2X0f115ab7 =
        element
            .isJsonDecodable<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPaytoAnyOf2X0f115ab7>()
    return InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPaytoAmountX1a6d63edInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPaytoAnyOf2X0f115ab7) {
                    add(
                        "InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPaytoAnyOf2X0f115ab7: value does not match InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPaytoAnyOf2X0f115ab7",
                    )
                }
            },
    )
