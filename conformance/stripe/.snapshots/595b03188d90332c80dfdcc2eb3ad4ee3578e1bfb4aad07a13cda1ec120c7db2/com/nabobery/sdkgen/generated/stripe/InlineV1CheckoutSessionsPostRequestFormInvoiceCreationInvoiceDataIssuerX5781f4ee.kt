...
public class InlineV1CheckoutSessionsPostRequestFormInvoiceCreationInvoiceDataIssuerX5781f4ee(
    ...
    public object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormInvoiceCreationInvoiceDataIssuerX5781f4ee> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CheckoutSessionsPostRequestFormInvoiceCreationInvoiceDataIssuerX5781f4ee must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineV1CheckoutSessionsPostRequestFormInvoiceCreationInvoiceDataTypeXa631abb0>(
                    rawObject,
                    "type",
                )
            return InlineV1CheckoutSessionsPostRequestFormInvoiceCreationInvoiceDataIssuerX5781f4ee(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsPostRequestFormInvoiceCreationInvoiceDataIssuerX5781f4ee,
        ) {
            val jsonEncoder =
...
public fun inlineV1CheckoutSessionsPostRequestFormInvoiceCreationInvoiceDataIssuerX5781f4ee(
    block: InlineV1CheckoutSessionsPostRequestFormInvoiceCreationInvoiceDataIssuerX5781f4ee.Builder.() -> Unit,
): InlineV1CheckoutSessionsPostRequestFormInvoiceCreationInvoiceDataIssuerX5781f4ee =
    InlineV1CheckoutSessionsPostRequestFormInvoiceCreationInvoiceDataIssuerX5781f4ee.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1CheckoutSessionsPostRequestFormInvoiceCreationInvoiceDataIssuerX5781f4ee is missing required property '" +
                    name +
                    "'",
            )
