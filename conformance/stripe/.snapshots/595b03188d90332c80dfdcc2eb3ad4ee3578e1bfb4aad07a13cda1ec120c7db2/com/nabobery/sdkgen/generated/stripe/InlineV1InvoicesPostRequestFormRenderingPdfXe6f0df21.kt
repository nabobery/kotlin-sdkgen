...
public class InlineV1InvoicesPostRequestFormRenderingPdfXe6f0df21(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1InvoicesPostRequestFormRenderingPdfXe6f0df21 =
            InlineV1InvoicesPostRequestFormRenderingPdfXe6f0df21(
                pageSize = pageSize,
            )
    }

    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1InvoicesPostRequestFormRenderingPdfXe6f0df21 =
    ...
    public object Serializer : KSerializer<InlineV1InvoicesPostRequestFormRenderingPdfXe6f0df21> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1InvoicesPostRequestFormRenderingPdfXe6f0df21 must be a JSON object",
                    )
            return InlineV1InvoicesPostRequestFormRenderingPdfXe6f0df21(
                pageSize =
                    rawObject["page_size"]?.let {
                        json.decodeFromJsonElement<InlineV1InvoicesPostRequestFormRenderingPdfPageSizeX425f3416>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesPostRequestFormRenderingPdfXe6f0df21,
        ) {
...
public fun inlineV1InvoicesPostRequestFormRenderingPdfXe6f0df21(
    block: InlineV1InvoicesPostRequestFormRenderingPdfXe6f0df21.Builder.() -> Unit,
): InlineV1InvoicesPostRequestFormRenderingPdfXe6f0df21 =
    InlineV1InvoicesPostRequestFormRenderingPdfXe6f0df21.build(block)
