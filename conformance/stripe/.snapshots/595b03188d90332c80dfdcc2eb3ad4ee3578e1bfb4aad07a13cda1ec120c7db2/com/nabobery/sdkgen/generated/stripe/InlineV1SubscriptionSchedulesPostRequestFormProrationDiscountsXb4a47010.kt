...
public sealed class InlineV1SubscriptionSchedulesPostRequestFormProrationDiscountsXb4a47010 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1SubscriptionSchedulesPostRequestFormProrationDiscountsXb4a47010 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionSchedulesPostRequestFormProrationDiscountsXb4a47010> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1SubscriptionSchedulesPostRequestFormProrationDiscountsXb4a47010",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1SubscriptionSchedulesPostRequestFormProrationDiscountsXb4a47010 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionSchedulesPostRequestFormProrationDiscountsXb4a47010,
        ) {
