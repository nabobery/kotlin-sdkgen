...
public class InvoicePaymentMethodOptionsUpi(
    ...
    public class Builder {
        ...
        public fun build(): InvoicePaymentMethodOptionsUpi =
    ...
    public object Serializer : KSerializer<InvoicePaymentMethodOptionsUpi> {
        ...
        override fun deserialize(decoder: Decoder): InvoicePaymentMethodOptionsUpi {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("InvoicePaymentMethodOptionsUpi must be a JSON object")
            return InvoicePaymentMethodOptionsUpi(
                mandateOptions =
                    rawObject["mandate_options"]?.let {
                        json.decodeFromJsonElement<InvoicePaymentMethodOptionsMandateOptionsUpi>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InvoicePaymentMethodOptionsUpi,
        ) {
...
public fun invoicePaymentMethodOptionsUpi(
    block: InvoicePaymentMethodOptionsUpi.Builder.() -> Unit,
): InvoicePaymentMethodOptionsUpi = InvoicePaymentMethodOptionsUpi.build(block)
