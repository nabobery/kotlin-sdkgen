...
public class InlineV1SubscriptionItemsDeleteRequestFormX4fa3c3bc(
     ...
     */
    public val paymentBehavior: InlineV1SubscriptionItemsDeleteRequestFormPaymentBehaviorX2591788d? = null,
    /**
     ...
     */
    public val prorationBehavior: InlineV1SubscriptionItemsDeleteRequestFormProrationBehaviorX881f5c3c? = null,
    /**
    ...
    public class Builder {
        ...
        public fun build(): InlineV1SubscriptionItemsDeleteRequestFormX4fa3c3bc =
            InlineV1SubscriptionItemsDeleteRequestFormX4fa3c3bc(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1SubscriptionItemsDeleteRequestFormX4fa3c3bc =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1SubscriptionItemsDeleteRequestFormX4fa3c3bc> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SubscriptionItemsDeleteRequestFormX4fa3c3bc must be a JSON object",
                    )
            return InlineV1SubscriptionItemsDeleteRequestFormX4fa3c3bc(
                ...
                paymentBehavior =
                    rawObject["payment_behavior"]?.let {
                        json.decodeFromJsonElement<InlineV1SubscriptionItemsDeleteRequestFormPaymentBehaviorX2591788d>(
                            it,
                        )
                    },
                prorationBehavior =
                    rawObject["proration_behavior"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SubscriptionItemsDeleteRequestFormProrationBehaviorX881f5c3c>(
                                it,
                            )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionItemsDeleteRequestFormX4fa3c3bc,
        ) {
...
public fun inlineV1SubscriptionItemsDeleteRequestFormX4fa3c3bc(
    block: InlineV1SubscriptionItemsDeleteRequestFormX4fa3c3bc.Builder.() -> Unit,
): InlineV1SubscriptionItemsDeleteRequestFormX4fa3c3bc =
    InlineV1SubscriptionItemsDeleteRequestFormX4fa3c3bc.build(block)
