...
public class InlineDiscountSourceCouponX03063bd3 internal constructor(
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineDiscountSourceCouponX03063bd3 {
            val inspection = inspectInlineDiscountSourceCouponX03063bd3(raw)
            if (inspection.matchCount == 0) {
                throw InlineDiscountSourceCouponX03063bd3NoMatchException(
                    "InlineDiscountSourceCouponX03063bd3 matched 0 branches: " + inspection.failures.joinToString("; "),
                )
            }
    ...
    public object Serializer : KSerializer<InlineDiscountSourceCouponX03063bd3> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineDiscountSourceCouponX03063bd3,
        ) {
...
private fun inspectInlineDiscountSourceCouponX03063bd3(
    element: JsonElement,
): InlineDiscountSourceCouponX03063bd3Inspection {
