...
@Serializable
public data class TerminalReaderReaderResourceCartView(
...
public class TerminalReaderReaderResourceCart(
    ...
    public object Serializer : KSerializer<TerminalReaderReaderResourceCart> {
        ...
        override fun deserialize(decoder: Decoder): TerminalReaderReaderResourceCart {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("TerminalReaderReaderResourceCart must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: TerminalReaderReaderResourceCart,
        ) {
...
public fun terminalReaderReaderResourceCart(
    block: TerminalReaderReaderResourceCart.Builder.() -> Unit,
): TerminalReaderReaderResourceCart = TerminalReaderReaderResourceCart.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "TerminalReaderReaderResourceCart is missing required property '" + name + "'",
            )
