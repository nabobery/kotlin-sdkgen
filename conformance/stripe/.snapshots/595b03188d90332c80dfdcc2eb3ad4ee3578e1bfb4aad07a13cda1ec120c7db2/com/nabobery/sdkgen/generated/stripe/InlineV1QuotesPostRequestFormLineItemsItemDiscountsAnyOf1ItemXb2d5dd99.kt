...
public class InlineV1QuotesPostRequestFormLineItemsItemDiscountsAnyOf1ItemXb2d5dd99(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1QuotesPostRequestFormLineItemsItemDiscountsAnyOf1ItemXb2d5dd99 =
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1QuotesPostRequestFormLineItemsItemDiscountsAnyOf1ItemXb2d5dd99 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1QuotesPostRequestFormLineItemsItemDiscountsAnyOf1ItemXb2d5dd99> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1QuotesPostRequestFormLineItemsItemDiscountsAnyOf1ItemXb2d5dd99 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1QuotesPostRequestFormLineItemsItemDiscountsAnyOf1ItemXb2d5dd99,
        ) {
            val jsonEncoder =
...
public fun inlineV1QuotesPostRequestFormLineItemsItemDiscountsAnyOf1ItemXb2d5dd99(
    block: InlineV1QuotesPostRequestFormLineItemsItemDiscountsAnyOf1ItemXb2d5dd99.Builder.() -> Unit,
): InlineV1QuotesPostRequestFormLineItemsItemDiscountsAnyOf1ItemXb2d5dd99 =
    InlineV1QuotesPostRequestFormLineItemsItemDiscountsAnyOf1ItemXb2d5dd99.build(block)
