...
public sealed class InlineV1PricesPostRequestFormTiersItemUpToAnyOf1X8579de48 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1PricesPostRequestFormTiersItemUpToAnyOf1X8579de48 =
            when (value) {
                Inf.value -> Inf
    ...
    public object Serializer : KSerializer<InlineV1PricesPostRequestFormTiersItemUpToAnyOf1X8579de48> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1PricesPostRequestFormTiersItemUpToAnyOf1X8579de48",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1PricesPostRequestFormTiersItemUpToAnyOf1X8579de48 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PricesPostRequestFormTiersItemUpToAnyOf1X8579de48,
        ) {
