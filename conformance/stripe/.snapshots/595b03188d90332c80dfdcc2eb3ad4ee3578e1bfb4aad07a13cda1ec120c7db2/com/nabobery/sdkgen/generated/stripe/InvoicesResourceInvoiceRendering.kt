...
public class InvoicesResourceInvoiceRendering(
    ...
    public class Builder {
        ...
        public fun build(): InvoicesResourceInvoiceRendering =
    ...
    public object Serializer : KSerializer<InvoicesResourceInvoiceRendering> {
        ...
        override fun deserialize(decoder: Decoder): InvoicesResourceInvoiceRendering {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("InvoicesResourceInvoiceRendering must be a JSON object")
            return InvoicesResourceInvoiceRendering(
                ...
                pdf =
                    rawObject["pdf"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineInvoicesResourceInvoiceRenderingPdfX02773b89?>(element)
                        }
                    },
                template =
                ...
                templateVersion =
                    rawObject["template_version"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InvoicesResourceInvoiceRendering,
        ) {
...
public fun invoicesResourceInvoiceRendering(
    block: InvoicesResourceInvoiceRendering.Builder.() -> Unit,
): InvoicesResourceInvoiceRendering = InvoicesResourceInvoiceRendering.build(block)
