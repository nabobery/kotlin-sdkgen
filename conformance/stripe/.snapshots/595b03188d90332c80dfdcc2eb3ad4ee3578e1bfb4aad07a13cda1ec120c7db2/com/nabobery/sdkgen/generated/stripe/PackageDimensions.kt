...
public class PackageDimensions(
    ...
    public object Serializer : KSerializer<PackageDimensions> {
        ...
        override fun deserialize(decoder: Decoder): PackageDimensions {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PackageDimensions must be a JSON object")
...
public fun packageDimensions(block: PackageDimensions.Builder.() -> Unit): PackageDimensions =
    PackageDimensions.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("PackageDimensions is missing required property '" + name + "'")
