...
public class InlineChargeApplicationX08556321 internal constructor(
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineChargeApplicationX08556321 {
            val inspection = inspectInlineChargeApplicationX08556321(raw)
            if (inspection.matchCount == 0) {
                throw InlineChargeApplicationX08556321NoMatchException(
                    "InlineChargeApplicationX08556321 matched 0 branches: " + inspection.failures.joinToString("; "),
                )
            }
    ...
    public object Serializer : KSerializer<InlineChargeApplicationX08556321> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineChargeApplicationX08556321,
        ) {
