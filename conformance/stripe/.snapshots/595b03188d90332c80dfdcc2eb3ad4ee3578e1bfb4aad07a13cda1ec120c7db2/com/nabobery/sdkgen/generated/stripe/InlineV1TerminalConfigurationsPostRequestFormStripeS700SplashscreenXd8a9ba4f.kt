...
internal data class InlineV1TerminalConfigurationsPostRequestFormStripeS700SplashscreenXd8a9ba4fInspection(
    ...
    public val matchesInlineV1TerminalConfigurationsPostRequestFormStripeS700AnyOf1AnyOf2X39ae4730: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1TerminalConfigurationsPostRequestFormStripeS700AnyOf1AnyOf2X39ae4730,
            ).count {
                it
            }
}
...
public class InlineV1TerminalConfigurationsPostRequestFormStripeS700SplashscreenXd8a9ba4f internal constructor(
    ...
    private val inspection: InlineV1TerminalConfigurationsPostRequestFormStripeS700SplashscreenXd8a9ba4fInspection,
) {
    ...
    public val inlineV1TerminalConfigurationsPostRequestFormStripeS700AnyOf1AnyOf2X39ae4730:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1TerminalConfigurationsPostRequestFormStripeS700AnyOf1AnyOf2X39ae4730) {
                json
                    .decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormStripeS700AnyOf1AnyOf2X39ae4730>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1TerminalConfigurationsPostRequestFormStripeS700SplashscreenXd8a9ba4fBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1TerminalConfigurationsPostRequestFormStripeS700AnyOf1AnyOf2X39ae4730) {
                    add(
                        InlineV1TerminalConfigurationsPostRequestFormStripeS700SplashscreenXd8a9ba4fBranch.InlineV1TerminalConfigurationsPostRequestFormStripeS700AnyOf1AnyOf2X39ae4730,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1TerminalConfigurationsPostRequestFormStripeS700SplashscreenXd8a9ba4f {
            val inspection = inspectInlineV1TerminalConfigurationsPostRequestFormStripeS700SplashscreenXd8a9ba4f(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1TerminalConfigurationsPostRequestFormStripeS700SplashscreenXd8a9ba4fNoMatchException(
                    "InlineV1TerminalConfigurationsPostRequestFormStripeS700SplashscreenXd8a9ba4f matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1TerminalConfigurationsPostRequestFormStripeS700SplashscreenXd8a9ba4f> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TerminalConfigurationsPostRequestFormStripeS700SplashscreenXd8a9ba4f,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1TerminalConfigurationsPostRequestFormStripeS700SplashscreenXd8a9ba4f",
...
private fun inspectInlineV1TerminalConfigurationsPostRequestFormStripeS700SplashscreenXd8a9ba4f(
    element: JsonElement,
): InlineV1TerminalConfigurationsPostRequestFormStripeS700SplashscreenXd8a9ba4fInspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1TerminalConfigurationsPostRequestFormStripeS700AnyOf1AnyOf2X39ae4730 =
        element
            .isJsonDecodable<InlineV1TerminalConfigurationsPostRequestFormStripeS700AnyOf1AnyOf2X39ae4730>()
    return InlineV1TerminalConfigurationsPostRequestFormStripeS700SplashscreenXd8a9ba4fInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1TerminalConfigurationsPostRequestFormStripeS700AnyOf1AnyOf2X39ae4730) {
                    add(
                        "InlineV1TerminalConfigurationsPostRequestFormStripeS700AnyOf1AnyOf2X39ae4730: value does not match InlineV1TerminalConfigurationsPostRequestFormStripeS700AnyOf1AnyOf2X39ae4730",
                    )
                }
            },
    )
