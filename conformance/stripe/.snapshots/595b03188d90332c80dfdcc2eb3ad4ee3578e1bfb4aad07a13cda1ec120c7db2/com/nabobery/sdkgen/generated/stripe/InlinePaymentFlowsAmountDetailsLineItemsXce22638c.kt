...
public class InlinePaymentFlowsAmountDetailsLineItemsXce22638c(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlinePaymentFlowsAmountDetailsLineItemsXce22638c =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlinePaymentFlowsAmountDetailsLineItemsXce22638c> {
        ...
        override fun deserialize(decoder: Decoder): InlinePaymentFlowsAmountDetailsLineItemsXce22638c {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlinePaymentFlowsAmountDetailsLineItemsXce22638c must be a JSON object",
                    )
            ...
            val objectValue =
                json.decodeRequired<InlinePaymentFlowsAmountDetailsLineItemsObjectValueXc05bd4ef>(
                    rawObject,
                    "object",
                )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentFlowsAmountDetailsLineItemsXce22638c,
        ) {
...
public fun inlinePaymentFlowsAmountDetailsLineItemsXce22638c(
    block: InlinePaymentFlowsAmountDetailsLineItemsXce22638c.Builder.() -> Unit,
): InlinePaymentFlowsAmountDetailsLineItemsXce22638c = InlinePaymentFlowsAmountDetailsLineItemsXce22638c.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlinePaymentFlowsAmountDetailsLineItemsXce22638c is missing required property '" + name + "'",
            )
