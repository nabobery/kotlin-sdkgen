...
internal data class InlineV1PaymentIntentsConfirmPostRequestFormHooksInputsTaxCalculationXa319fc77Inspection(
    ...
    public val matchesInlineV1PaymentIntentsConfirmPostRequestFormHooksInputsTaxAnyOf2Xe708b050: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1PaymentIntentsConfirmPostRequestFormHooksInputsTaxAnyOf2Xe708b050,
            ).count {
                it
            }
}
...
public class InlineV1PaymentIntentsConfirmPostRequestFormHooksInputsTaxCalculationXa319fc77 internal constructor(
    ...
    private val inspection: InlineV1PaymentIntentsConfirmPostRequestFormHooksInputsTaxCalculationXa319fc77Inspection,
) {
    ...
    public val inlineV1PaymentIntentsConfirmPostRequestFormHooksInputsTaxAnyOf2Xe708b050:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1PaymentIntentsConfirmPostRequestFormHooksInputsTaxAnyOf2Xe708b050) {
                json
                    .decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormHooksInputsTaxAnyOf2Xe708b050>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1PaymentIntentsConfirmPostRequestFormHooksInputsTaxCalculationXa319fc77Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1PaymentIntentsConfirmPostRequestFormHooksInputsTaxAnyOf2Xe708b050) {
                    add(
                        InlineV1PaymentIntentsConfirmPostRequestFormHooksInputsTaxCalculationXa319fc77Branch.InlineV1PaymentIntentsConfirmPostRequestFormHooksInputsTaxAnyOf2Xe708b050,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            ...
            if (inspection.matchCount == 0) {
                throw InlineV1PaymentIntentsConfirmPostRequestFormHooksInputsTaxCalculationXa319fc77NoMatchException(
                    "InlineV1PaymentIntentsConfirmPostRequestFormHooksInputsTaxCalculationXa319fc77 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsConfirmPostRequestFormHooksInputsTaxCalculationXa319fc77> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsConfirmPostRequestFormHooksInputsTaxCalculationXa319fc77,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1PaymentIntentsConfirmPostRequestFormHooksInputsTaxCalculationXa319fc77",
...
private fun inspectInlineV1PaymentIntentsConfirmPostRequestFormHooksInputsTaxCalculationXa319fc77(
    element: JsonElement,
): InlineV1PaymentIntentsConfirmPostRequestFormHooksInputsTaxCalculationXa319fc77Inspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1PaymentIntentsConfirmPostRequestFormHooksInputsTaxAnyOf2Xe708b050 =
        element
            .isJsonDecodable<InlineV1PaymentIntentsConfirmPostRequestFormHooksInputsTaxAnyOf2Xe708b050>()
    return InlineV1PaymentIntentsConfirmPostRequestFormHooksInputsTaxCalculationXa319fc77Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1PaymentIntentsConfirmPostRequestFormHooksInputsTaxAnyOf2Xe708b050) {
                    add(
                        "InlineV1PaymentIntentsConfirmPostRequestFormHooksInputsTaxAnyOf2Xe708b050: value does not match InlineV1PaymentIntentsConfirmPostRequestFormHooksInputsTaxAnyOf2Xe708b050",
                    )
                }
            },
    )
