...
public class InlineQuoteTestClockXf70c6291 internal constructor(
        ...
        get() =
            buildSet {
                ...
                if (inspection.matchesTestHelpersTestClock) {
                    add(
                        InlineQuoteTestClockXf70c6291Branch.TestHelpersTestClock,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineQuoteTestClockXf70c6291 {
            val inspection = inspectInlineQuoteTestClockXf70c6291(raw)
            if (inspection.matchCount == 0) {
                throw InlineQuoteTestClockXf70c6291NoMatchException(
                    "InlineQuoteTestClockXf70c6291 matched 0 branches: " + inspection.failures.joinToString("; "),
                )
            }
    ...
    public object Serializer : KSerializer<InlineQuoteTestClockXf70c6291> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineQuoteTestClockXf70c6291,
        ) {
