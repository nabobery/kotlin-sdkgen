...
public class FundingInstructionsBankTransferAbaRecord(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): FundingInstructionsBankTransferAbaRecord =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<FundingInstructionsBankTransferAbaRecord> {
        ...
        override fun deserialize(decoder: Decoder): FundingInstructionsBankTransferAbaRecord {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("FundingInstructionsBankTransferAbaRecord must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: FundingInstructionsBankTransferAbaRecord,
        ) {
...
public fun fundingInstructionsBankTransferAbaRecord(
    block: FundingInstructionsBankTransferAbaRecord.Builder.() -> Unit,
): FundingInstructionsBankTransferAbaRecord = FundingInstructionsBankTransferAbaRecord.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "FundingInstructionsBankTransferAbaRecord is missing required property '" + name + "'",
            )
