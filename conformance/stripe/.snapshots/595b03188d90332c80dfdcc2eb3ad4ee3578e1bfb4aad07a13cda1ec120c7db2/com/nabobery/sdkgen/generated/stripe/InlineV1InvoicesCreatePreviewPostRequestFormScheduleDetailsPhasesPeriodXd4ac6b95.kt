...
public class InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesPeriodXd4ac6b95(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesPeriodXd4ac6b95 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesPeriodXd4ac6b95> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesPeriodXd4ac6b95 must be a JSON object",
                    )
            val end =
                json.decodeRequired<InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesEndXeca801e4>(
                    rawObject,
                    "end",
                )
            val start =
                json.decodeRequired<InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesStartX190a5d6a>(
                    rawObject,
                    "start",
                )
            return InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesPeriodXd4ac6b95(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesPeriodXd4ac6b95,
        ) {
            val jsonEncoder =
...
public fun inlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesPeriodXd4ac6b95(
    block: InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesPeriodXd4ac6b95.Builder.() -> Unit,
): InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesPeriodXd4ac6b95 =
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesPeriodXd4ac6b95 is missing required property '" +
                    name +
                    "'",
            )
