...
public sealed class InlineV1CustomersSubscriptionsPostRequestFormCancelAtAnyOf3X59471a1c {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1CustomersSubscriptionsPostRequestFormCancelAtAnyOf3X59471a1c =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1CustomersSubscriptionsPostRequestFormCancelAtAnyOf3X59471a1c> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1CustomersSubscriptionsPostRequestFormCancelAtAnyOf3X59471a1c",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1CustomersSubscriptionsPostRequestFormCancelAtAnyOf3X59471a1c = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersSubscriptionsPostRequestFormCancelAtAnyOf3X59471a1c,
        ) {
