...
public class InlineV1AccountsPersonsGetParameterX9889ba8f(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1AccountsPersonsGetParameterX9889ba8f =
            InlineV1AccountsPersonsGetParameterX9889ba8f(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1AccountsPersonsGetParameterX9889ba8f =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1AccountsPersonsGetParameterX9889ba8f> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountsPersonsGetParameterX9889ba8f must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPersonsGetParameterX9889ba8f,
        ) {
...
public fun inlineV1AccountsPersonsGetParameterX9889ba8f(
    block: InlineV1AccountsPersonsGetParameterX9889ba8f.Builder.() -> Unit,
): InlineV1AccountsPersonsGetParameterX9889ba8f = InlineV1AccountsPersonsGetParameterX9889ba8f.build(block)
