...
public class InlinePayoutBalanceTransactionX644e86fe internal constructor(
        ...
        get() =
            buildSet {
                ...
                if (inspection.matchesBalanceTransaction) {
                    add(
                        InlinePayoutBalanceTransactionX644e86feBranch.BalanceTransaction,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlinePayoutBalanceTransactionX644e86fe {
            val inspection = inspectInlinePayoutBalanceTransactionX644e86fe(raw)
            if (inspection.matchCount == 0) {
                throw InlinePayoutBalanceTransactionX644e86feNoMatchException(
                    "InlinePayoutBalanceTransactionX644e86fe matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlinePayoutBalanceTransactionX644e86fe> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlinePayoutBalanceTransactionX644e86fe,
        ) {
...
private fun inspectInlinePayoutBalanceTransactionX644e86fe(
    element: JsonElement,
): InlinePayoutBalanceTransactionX644e86feInspection {
