...
public class InlineV1CustomersSubscriptionsPostRequestFormTrialSettingsEndBehaviorXb5ca0bde(
    public val missingPaymentMethod: InlineV1CustomersSubscriptionsPostRequestFormMissingPaymentMethodX2c3ded2b,
) {
    ...
    public object Serializer : KSerializer<InlineV1CustomersSubscriptionsPostRequestFormTrialSettingsEndBehaviorXb5ca0bde> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CustomersSubscriptionsPostRequestFormTrialSettingsEndBehaviorXb5ca0bde must be a JSON object",
                    )
            val missingPaymentMethod =
                json
                    .decodeRequired<InlineV1CustomersSubscriptionsPostRequestFormMissingPaymentMethodX2c3ded2b>(
                        rawObject,
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersSubscriptionsPostRequestFormTrialSettingsEndBehaviorXb5ca0bde,
        ) {
            val jsonEncoder =
...
public fun inlineV1CustomersSubscriptionsPostRequestFormTrialSettingsEndBehaviorXb5ca0bde(
    block: InlineV1CustomersSubscriptionsPostRequestFormTrialSettingsEndBehaviorXb5ca0bde.Builder.() -> Unit,
): InlineV1CustomersSubscriptionsPostRequestFormTrialSettingsEndBehaviorXb5ca0bde =
    InlineV1CustomersSubscriptionsPostRequestFormTrialSettingsEndBehaviorXb5ca0bde.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1CustomersSubscriptionsPostRequestFormTrialSettingsEndBehaviorXb5ca0bde is missing required property '" +
                    name +
                    "'",
            )
