        ...
        override fun deserialize(decoder: Decoder): IssuingCardWallets {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("IssuingCardWallets must be a JSON object")
            ...
            return IssuingCardWallets(
                ...
                primaryAccountIdentifier =
                    rawObject["primary_account_identifier"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
...
public fun issuingCardWallets(block: IssuingCardWallets.Builder.() -> Unit): IssuingCardWallets =
    IssuingCardWallets.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("IssuingCardWallets is missing required property '" + name + "'")
