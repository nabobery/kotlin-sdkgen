...
public sealed class InlinePaymentIntentCaptureMethodX7c24a00f {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentIntentCaptureMethodX7c24a00f =
            when (value) {
    ...
    public object Serializer : KSerializer<InlinePaymentIntentCaptureMethodX7c24a00f> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentIntentCaptureMethodX7c24a00f",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePaymentIntentCaptureMethodX7c24a00f =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentIntentCaptureMethodX7c24a00f,
        ) {
