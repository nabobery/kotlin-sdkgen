...
public class InlineV1AccountsPostRequestFormCapabilitiesSwishPaymentsX45d862be(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1AccountsPostRequestFormCapabilitiesSwishPaymentsX45d862be =
            InlineV1AccountsPostRequestFormCapabilitiesSwishPaymentsX45d862be(
                requested = requested,
            )
    }

    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1AccountsPostRequestFormCapabilitiesSwishPaymentsX45d862be =
    ...
    public object Serializer : KSerializer<InlineV1AccountsPostRequestFormCapabilitiesSwishPaymentsX45d862be> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountsPostRequestFormCapabilitiesSwishPaymentsX45d862be must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPostRequestFormCapabilitiesSwishPaymentsX45d862be,
        ) {
            val jsonEncoder =
...
public fun inlineV1AccountsPostRequestFormCapabilitiesSwishPaymentsX45d862be(
    block: InlineV1AccountsPostRequestFormCapabilitiesSwishPaymentsX45d862be.Builder.() -> Unit,
): InlineV1AccountsPostRequestFormCapabilitiesSwishPaymentsX45d862be =
