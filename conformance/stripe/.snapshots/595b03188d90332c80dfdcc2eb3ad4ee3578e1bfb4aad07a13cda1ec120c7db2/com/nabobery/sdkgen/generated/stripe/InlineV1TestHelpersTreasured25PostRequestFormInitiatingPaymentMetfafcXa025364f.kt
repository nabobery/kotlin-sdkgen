...
public class InlineV1TestHelpersTreasured25PostRequestFormInitiatingPaymentMetfafcXa025364f(
    ...
    public val usBankAccount: InlineV1TestHelpersTreasured25PostRequestFormUsBankAccountX3bc53d43? = null,
) {
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1TestHelpersTreasured25PostRequestFormInitiatingPaymentMetfafcXa025364f =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TestHelpersTreasured25PostRequestFormInitiatingPaymentMetfafcXa025364f> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TestHelpersTreasured25PostRequestFormInitiatingPaymentMetfafcXa025364f must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineV1TestHelpersTreasured25PostRequestFormTypeXebb68e0d>(
                    rawObject,
                    "type",
                )
            return InlineV1TestHelpersTreasured25PostRequestFormInitiatingPaymentMetfafcXa025364f(
                ...
                usBankAccount =
                    rawObject["us_bank_account"]?.let {
                        json.decodeFromJsonElement<InlineV1TestHelpersTreasured25PostRequestFormUsBankAccountX3bc53d43>(
                            it,
                        )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TestHelpersTreasured25PostRequestFormInitiatingPaymentMetfafcXa025364f,
        ) {
            val jsonEncoder =
...
public fun inlineV1TestHelpersTreasured25PostRequestFormInitiatingPaymentMetfafcXa025364f(
    block: InlineV1TestHelpersTreasured25PostRequestFormInitiatingPaymentMetfafcXa025364f.Builder.() -> Unit,
): InlineV1TestHelpersTreasured25PostRequestFormInitiatingPaymentMetfafcXa025364f =
    InlineV1TestHelpersTreasured25PostRequestFormInitiatingPaymentMetfafcXa025364f.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TestHelpersTreasured25PostRequestFormInitiatingPaymentMetfafcXa025364f is missing required property '" +
                    name +
                    "'",
            )
