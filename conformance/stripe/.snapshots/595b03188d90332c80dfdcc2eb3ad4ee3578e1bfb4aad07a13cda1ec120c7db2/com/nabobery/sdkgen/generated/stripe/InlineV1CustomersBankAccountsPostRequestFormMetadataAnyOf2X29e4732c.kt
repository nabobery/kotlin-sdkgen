...
public sealed class InlineV1CustomersBankAccountsPostRequestFormMetadataAnyOf2X29e4732c {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1CustomersBankAccountsPostRequestFormMetadataAnyOf2X29e4732c =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1CustomersBankAccountsPostRequestFormMetadataAnyOf2X29e4732c> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1CustomersBankAccountsPostRequestFormMetadataAnyOf2X29e4732c",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1CustomersBankAccountsPostRequestFormMetadataAnyOf2X29e4732c = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersBankAccountsPostRequestFormMetadataAnyOf2X29e4732c,
        ) {
