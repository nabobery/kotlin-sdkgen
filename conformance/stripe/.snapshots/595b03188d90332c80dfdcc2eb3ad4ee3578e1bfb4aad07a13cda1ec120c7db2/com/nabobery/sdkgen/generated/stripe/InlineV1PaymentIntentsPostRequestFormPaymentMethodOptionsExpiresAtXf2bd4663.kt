...
internal data class InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsExpiresAtXf2bd4663Inspection(
    ...
    public val matchesInlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKonbiniAnyOf2X2728b27e: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKonbiniAnyOf2X2728b27e,
            ).count {
                it
            }
}
...
public class InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsExpiresAtXf2bd4663 internal constructor(
    ...
    private val inspection: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsExpiresAtXf2bd4663Inspection,
) {
    ...
    public val inlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKonbiniAnyOf2X2728b27e:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKonbiniAnyOf2X2728b27e) {
                json
                    .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKonbiniAnyOf2X2728b27e>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsExpiresAtXf2bd4663Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKonbiniAnyOf2X2728b27e) {
                    add(
                        InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsExpiresAtXf2bd4663Branch.InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKonbiniAnyOf2X2728b27e,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsExpiresAtXf2bd4663 {
            val inspection = inspectInlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsExpiresAtXf2bd4663(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsExpiresAtXf2bd4663NoMatchException(
                    "InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsExpiresAtXf2bd4663 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsExpiresAtXf2bd4663> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsExpiresAtXf2bd4663,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsExpiresAtXf2bd4663",
...
private fun inspectInlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsExpiresAtXf2bd4663(
    element: JsonElement,
): InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsExpiresAtXf2bd4663Inspection {
    val matchesBranch1 = element.isJsonDecodable<Int>()
    val matchesInlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKonbiniAnyOf2X2728b27e =
        element
            .isJsonDecodable<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKonbiniAnyOf2X2728b27e>()
    return InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsExpiresAtXf2bd4663Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKonbiniAnyOf2X2728b27e) {
                    add(
                        "InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKonbiniAnyOf2X2728b27e: value does not match InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKonbiniAnyOf2X2728b27e",
                    )
                }
            },
    )
