...
public class InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsKlarnaItemXd11c02fd(
    public val interval: InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsKlarnaIntervalXaaaa801c,
    public val nextBilling: InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsNextBillingXabe3aeb1,
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsKlarnaItemXd11c02fd = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsKlarnaItemXd11c02fd> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsKlarnaItemXd11c02fd must be a JSON object",
                    )
            val interval =
                json
                    .decodeRequired<InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsKlarnaIntervalXaaaa801c>(
                        rawObject,
                        "interval",
                    )
            val nextBilling =
                json
                    .decodeRequired<InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsNextBillingXabe3aeb1>(
                        rawObject,
                        "next_billing",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsKlarnaItemXd11c02fd,
        ) {
            val jsonEncoder =
...
public fun inlineV1SetupIntentsPostRequestFormPaymentMethodOptionsKlarnaItemXd11c02fd(
    block: InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsKlarnaItemXd11c02fd.Builder.() -> Unit,
): InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsKlarnaItemXd11c02fd =
    InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsKlarnaItemXd11c02fd.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsKlarnaItemXd11c02fd is missing required property '" +
                    name +
                    "'",
            )
