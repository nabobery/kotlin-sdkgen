...
public sealed class InlineTreasuryOutboundPaym5d35TypeXf770e912 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineTreasuryOutboundPaym5d35TypeXf770e912 =
            when (value) {
                Ach.value -> Ach
    ...
    public object Serializer : KSerializer<InlineTreasuryOutboundPaym5d35TypeXf770e912> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineTreasuryOutboundPaym5d35TypeXf770e912",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineTreasuryOutboundPaym5d35TypeXf770e912 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineTreasuryOutboundPaym5d35TypeXf770e912,
        ) {
