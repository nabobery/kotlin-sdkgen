...
public sealed class InlineMandateOptionsPaytoAmountTypeX712f80fa {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineMandateOptionsPaytoAmountTypeX712f80fa =
            when (value) {
                Fixed.value -> Fixed
    ...
    public object Serializer : KSerializer<InlineMandateOptionsPaytoAmountTypeX712f80fa> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineMandateOptionsPaytoAmountTypeX712f80fa",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineMandateOptionsPaytoAmountTypeX712f80fa =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineMandateOptionsPaytoAmountTypeX712f80fa,
        ) {
