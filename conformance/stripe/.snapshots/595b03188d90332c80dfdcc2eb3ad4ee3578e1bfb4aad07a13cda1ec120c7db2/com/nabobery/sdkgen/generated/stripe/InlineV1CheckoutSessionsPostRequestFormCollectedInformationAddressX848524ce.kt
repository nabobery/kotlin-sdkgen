...
public class InlineV1CheckoutSessionsPostRequestFormCollectedInformationAddressX848524ce(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1CheckoutSessionsPostRequestFormCollectedInformationAddressX848524ce = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormCollectedInformationAddressX848524ce> {
        override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1CheckoutSessionsPostRequestFormCollectedInformationAddressX848524ce {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CheckoutSessionsPostRequestFormCollectedInformationAddressX848524ce must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsPostRequestFormCollectedInformationAddressX848524ce,
        ) {
            val jsonEncoder =
...
public fun inlineV1CheckoutSessionsPostRequestFormCollectedInformationAddressX848524ce(
    block: InlineV1CheckoutSessionsPostRequestFormCollectedInformationAddressX848524ce.Builder.() -> Unit,
): InlineV1CheckoutSessionsPostRequestFormCollectedInformationAddressX848524ce =
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1CheckoutSessionsPostRequestFormCollectedInformationAddressX848524ce is missing required property '" +
                    name +
                    "'",
            )
