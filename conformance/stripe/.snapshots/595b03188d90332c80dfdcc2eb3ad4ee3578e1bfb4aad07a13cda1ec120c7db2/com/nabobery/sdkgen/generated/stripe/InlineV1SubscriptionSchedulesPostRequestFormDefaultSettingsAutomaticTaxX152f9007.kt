...
public class InlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsAutomaticTaxX152f9007(
    ...
    public val liability: InlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsLiabilityXfbff97c2? = null,
) {
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsAutomaticTaxX152f9007> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsAutomaticTaxX152f9007 must be a JSON object",
                    )
            ...
            return InlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsAutomaticTaxX152f9007(
                ...
                liability =
                    rawObject["liability"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsLiabilityXfbff97c2>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsAutomaticTaxX152f9007,
        ) {
            val jsonEncoder =
...
public fun inlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsAutomaticTaxX152f9007(
    block: InlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsAutomaticTaxX152f9007.Builder.() -> Unit,
): InlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsAutomaticTaxX152f9007 =
    InlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsAutomaticTaxX152f9007.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsAutomaticTaxX152f9007 is missing required property '" +
                    name +
                    "'",
            )
