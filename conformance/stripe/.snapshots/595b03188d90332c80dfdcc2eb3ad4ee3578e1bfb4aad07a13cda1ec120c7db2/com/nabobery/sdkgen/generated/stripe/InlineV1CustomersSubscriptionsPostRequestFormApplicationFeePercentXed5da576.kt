...
public class InlineV1CustomersSubscriptionsPostRequestFormApplicationFeePercentXed5da576 internal constructor(
    ...
    private val inspection: InlineV1CustomersSubscriptionsPostRequestFormApplicationFeePercentXed5da576Inspection,
) {
    ...
    public val inlineV1CustomersSubscriptionsPostRequestFormAnyOf2Xd44b3a22:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1CustomersSubscriptionsPostRequestFormAnyOf2Xd44b3a22) {
                json
                    .decodeFromJsonElement<InlineV1CustomersSubscriptionsPostRequestFormAnyOf2Xd44b3a22>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1CustomersSubscriptionsPostRequestFormApplicationFeePercentXed5da576Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1CustomersSubscriptionsPostRequestFormAnyOf2Xd44b3a22) {
                    add(
                        InlineV1CustomersSubscriptionsPostRequestFormApplicationFeePercentXed5da576Branch.InlineV1CustomersSubscriptionsPostRequestFormAnyOf2Xd44b3a22,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1CustomersSubscriptionsPostRequestFormApplicationFeePercentXed5da576 {
            val inspection = inspectInlineV1CustomersSubscriptionsPostRequestFormApplicationFeePercentXed5da576(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1CustomersSubscriptionsPostRequestFormApplicationFeePercentXed5da576NoMatchException(
                    "InlineV1CustomersSubscriptionsPostRequestFormApplicationFeePercentXed5da576 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1CustomersSubscriptionsPostRequestFormApplicationFeePercentXed5da576> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersSubscriptionsPostRequestFormApplicationFeePercentXed5da576,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1CustomersSubscriptionsPostRequestFormApplicationFeePercentXed5da576",
...
private fun inspectInlineV1CustomersSubscriptionsPostRequestFormApplicationFeePercentXed5da576(
    element: JsonElement,
    ...
    val matchesInlineV1CustomersSubscriptionsPostRequestFormAnyOf2Xd44b3a22 =
        element
            .isJsonDecodable<InlineV1CustomersSubscriptionsPostRequestFormAnyOf2Xd44b3a22>()
    return InlineV1CustomersSubscriptionsPostRequestFormApplicationFeePercentXed5da576Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1CustomersSubscriptionsPostRequestFormAnyOf2Xd44b3a22) {
                    add(
                        "InlineV1CustomersSubscriptionsPostRequestFormAnyOf2Xd44b3a22: value does not match InlineV1CustomersSubscriptionsPostRequestFormAnyOf2Xd44b3a22",
                    )
                }
            },
    )
