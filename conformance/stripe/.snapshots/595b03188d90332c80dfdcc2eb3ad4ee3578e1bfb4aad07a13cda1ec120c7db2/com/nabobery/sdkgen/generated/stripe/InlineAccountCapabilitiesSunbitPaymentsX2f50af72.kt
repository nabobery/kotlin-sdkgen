...
public sealed class InlineAccountCapabilitiesSunbitPaymentsX2f50af72 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineAccountCapabilitiesSunbitPaymentsX2f50af72 =
            when (value) {
                Active.value -> Active
    ...
    public object Serializer : KSerializer<InlineAccountCapabilitiesSunbitPaymentsX2f50af72> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineAccountCapabilitiesSunbitPaymentsX2f50af72",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineAccountCapabilitiesSunbitPaymentsX2f50af72 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineAccountCapabilitiesSunbitPaymentsX2f50af72,
        ) {
