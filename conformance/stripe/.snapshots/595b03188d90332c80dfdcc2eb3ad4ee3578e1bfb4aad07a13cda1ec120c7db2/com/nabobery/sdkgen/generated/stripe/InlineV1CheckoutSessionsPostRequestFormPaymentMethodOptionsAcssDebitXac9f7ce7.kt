...
public class InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsAcssDebitXac9f7ce7(
    public val currency: InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsCurrencyX3fb01c97? = null,
    public val mandateOptions: InlineV1CheckoutSessionsPostRequestFormMandateOptionsXc3032ce8? = null,
    public val setupFutureUsage: InlineV1CheckoutSessionsPostRequestFormSetupFutureUsageX8f2449e3? = null,
    public val targetDate: String? = null,
    public val verificationMethod: InlineV1CheckoutSessionsPostRequestFormVerificationMethodX4c4035c9? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsAcssDebitXac9f7ce7 =
    ...
    public object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsAcssDebitXac9f7ce7> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsAcssDebitXac9f7ce7 must be a JSON object",
                    )
            return InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsAcssDebitXac9f7ce7(
                currency =
                    rawObject["currency"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsCurrencyX3fb01c97>(
                                it,
                            )
                    },
                mandateOptions =
                    rawObject["mandate_options"]?.let {
                        json.decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormMandateOptionsXc3032ce8>(it)
                    },
                setupFutureUsage =
                    rawObject["setup_future_usage"]?.let {
                        json.decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormSetupFutureUsageX8f2449e3>(it)
                    },
                targetDate = rawObject["target_date"]?.let { json.decodeFromJsonElement<String>(it) },
                verificationMethod =
                    rawObject["verification_method"]?.let {
                        json.decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormVerificationMethodX4c4035c9>(
                            it,
                        )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsAcssDebitXac9f7ce7,
        ) {
            val jsonEncoder =
...
public fun inlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsAcssDebitXac9f7ce7(
    block: InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsAcssDebitXac9f7ce7.Builder.() -> Unit,
): InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsAcssDebitXac9f7ce7 =
    InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsAcssDebitXac9f7ce7.build(block)
