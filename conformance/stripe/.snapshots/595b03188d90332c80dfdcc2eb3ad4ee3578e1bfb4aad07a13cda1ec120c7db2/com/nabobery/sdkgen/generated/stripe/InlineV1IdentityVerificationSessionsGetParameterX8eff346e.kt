...
public sealed class InlineV1IdentityVerificationSessionsGetParameterX8eff346e {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1IdentityVerificationSessionsGetParameterX8eff346e =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1IdentityVerificationSessionsGetParameterX8eff346e> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1IdentityVerificationSessionsGetParameterX8eff346e",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1IdentityVerificationSessionsGetParameterX8eff346e =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IdentityVerificationSessionsGetParameterX8eff346e,
        ) {
