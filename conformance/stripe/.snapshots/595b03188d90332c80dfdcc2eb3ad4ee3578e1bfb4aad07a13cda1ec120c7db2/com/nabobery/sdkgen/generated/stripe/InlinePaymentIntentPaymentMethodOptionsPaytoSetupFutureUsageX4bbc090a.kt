...
public sealed class InlinePaymentIntentPaymentMethodOptionsPaytoSetupFutureUsageX4bbc090a {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentIntentPaymentMethodOptionsPaytoSetupFutureUsageX4bbc090a =
            when (value) {
                None.value -> None
    ...
    public object Serializer : KSerializer<InlinePaymentIntentPaymentMethodOptionsPaytoSetupFutureUsageX4bbc090a> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentIntentPaymentMethodOptionsPaytoSetupFutureUsageX4bbc090a",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlinePaymentIntentPaymentMethodOptionsPaytoSetupFutureUsageX4bbc090a = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentIntentPaymentMethodOptionsPaytoSetupFutureUsageX4bbc090a,
        ) {
