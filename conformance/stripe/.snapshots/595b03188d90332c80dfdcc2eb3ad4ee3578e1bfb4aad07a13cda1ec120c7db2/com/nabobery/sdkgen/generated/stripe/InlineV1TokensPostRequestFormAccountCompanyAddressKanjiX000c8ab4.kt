...
public class InlineV1TokensPostRequestFormAccountCompanyAddressKanjiX000c8ab4(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1TokensPostRequestFormAccountCompanyAddressKanjiX000c8ab4 =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TokensPostRequestFormAccountCompanyAddressKanjiX000c8ab4 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TokensPostRequestFormAccountCompanyAddressKanjiX000c8ab4> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TokensPostRequestFormAccountCompanyAddressKanjiX000c8ab4 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TokensPostRequestFormAccountCompanyAddressKanjiX000c8ab4,
        ) {
            val jsonEncoder =
...
public fun inlineV1TokensPostRequestFormAccountCompanyAddressKanjiX000c8ab4(
    block: InlineV1TokensPostRequestFormAccountCompanyAddressKanjiX000c8ab4.Builder.() -> Unit,
): InlineV1TokensPostRequestFormAccountCompanyAddressKanjiX000c8ab4 =
    InlineV1TokensPostRequestFormAccountCompanyAddressKanjiX000c8ab4.build(block)
