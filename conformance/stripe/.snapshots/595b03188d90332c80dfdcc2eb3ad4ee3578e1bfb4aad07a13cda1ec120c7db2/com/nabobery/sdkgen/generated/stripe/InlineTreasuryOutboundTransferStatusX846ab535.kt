...
public sealed class InlineTreasuryOutboundTransferStatusX846ab535 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineTreasuryOutboundTransferStatusX846ab535 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineTreasuryOutboundTransferStatusX846ab535> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineTreasuryOutboundTransferStatusX846ab535",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineTreasuryOutboundTransferStatusX846ab535 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineTreasuryOutboundTransferStatusX846ab535,
        ) {
