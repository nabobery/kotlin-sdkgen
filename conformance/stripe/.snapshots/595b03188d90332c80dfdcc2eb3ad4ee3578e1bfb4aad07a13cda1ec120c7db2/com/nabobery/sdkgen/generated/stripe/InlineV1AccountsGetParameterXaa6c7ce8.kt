...
public class InlineV1AccountsGetParameterXaa6c7ce8 internal constructor(
    ...
    public val inlineV1AccountsGetParameterAnyOf1X8ca202e1:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1AccountsGetParameterAnyOf1X8ca202e1) {
                json
                    .decodeFromJsonElement<InlineV1AccountsGetParameterAnyOf1X8ca202e1>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1AccountsGetParameterXaa6c7ce8Branch>
        get() =
            buildSet {
                if (inspection.matchesInlineV1AccountsGetParameterAnyOf1X8ca202e1) {
                    add(
                        InlineV1AccountsGetParameterXaa6c7ce8Branch.InlineV1AccountsGetParameterAnyOf1X8ca202e1,
                    )
                }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1AccountsGetParameterXaa6c7ce8 {
            val inspection = inspectInlineV1AccountsGetParameterXaa6c7ce8(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1AccountsGetParameterXaa6c7ce8NoMatchException(
                    "InlineV1AccountsGetParameterXaa6c7ce8 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1AccountsGetParameterXaa6c7ce8> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsGetParameterXaa6c7ce8,
        ) {
...
private fun inspectInlineV1AccountsGetParameterXaa6c7ce8(
    element: JsonElement,
): InlineV1AccountsGetParameterXaa6c7ce8Inspection {
    val matchesInlineV1AccountsGetParameterAnyOf1X8ca202e1 =
        element
            .isJsonDecodable<InlineV1AccountsGetParameterAnyOf1X8ca202e1>()
    ...
    return InlineV1AccountsGetParameterXaa6c7ce8Inspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1AccountsGetParameterAnyOf1X8ca202e1) {
                    add(
                        "InlineV1AccountsGetParameterAnyOf1X8ca202e1: value does not match InlineV1AccountsGetParameterAnyOf1X8ca202e1",
                    )
                }
