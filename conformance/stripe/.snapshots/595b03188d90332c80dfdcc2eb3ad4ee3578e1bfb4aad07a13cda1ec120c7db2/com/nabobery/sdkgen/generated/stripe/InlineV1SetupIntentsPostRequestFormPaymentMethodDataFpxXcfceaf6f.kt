...
public class InlineV1SetupIntentsPostRequestFormPaymentMethodDataFpxXcfceaf6f(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1SetupIntentsPostRequestFormPaymentMethodDataFpxXcfceaf6f =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1SetupIntentsPostRequestFormPaymentMethodDataFpxXcfceaf6f> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1SetupIntentsPostRequestFormPaymentMethodDataFpxXcfceaf6f {
            val jsonDecoder =
                decoder.requireJsonDecoder(
                    "InlineV1SetupIntentsPostRequestFormPaymentMethodDataFpxXcfceaf6f",
                )
            val json = jsonDecoder.json
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SetupIntentsPostRequestFormPaymentMethodDataFpxXcfceaf6f must be a JSON object",
                    )
            val bank =
                json.decodeRequired<InlineV1SetupIntentsPostRequestFormPaymentMethodDataFpxBankX650db564>(
                    rawObject,
                    "bank",
                )
            return InlineV1SetupIntentsPostRequestFormPaymentMethodDataFpxXcfceaf6f(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SetupIntentsPostRequestFormPaymentMethodDataFpxXcfceaf6f,
        ) {
            val jsonEncoder =
...
public fun inlineV1SetupIntentsPostRequestFormPaymentMethodDataFpxXcfceaf6f(
    block: InlineV1SetupIntentsPostRequestFormPaymentMethodDataFpxXcfceaf6f.Builder.() -> Unit,
): InlineV1SetupIntentsPostRequestFormPaymentMethodDataFpxXcfceaf6f =
    InlineV1SetupIntentsPostRequestFormPaymentMethodDataFpxXcfceaf6f.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1SetupIntentsPostRequestFormPaymentMethodDataFpxXcfceaf6f is missing required property '" + name +
                    "'",
            )
