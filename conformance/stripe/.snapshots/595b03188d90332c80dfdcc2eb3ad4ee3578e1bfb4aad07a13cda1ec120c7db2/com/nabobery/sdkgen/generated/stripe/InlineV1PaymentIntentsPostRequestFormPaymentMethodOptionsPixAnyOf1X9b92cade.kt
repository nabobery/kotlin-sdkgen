...
public class InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPixAnyOf1X9b92cade(
    public val amountIncludesIof: InlineV1PaymentIntentsPostRequestFormAmountIncludesIofXa14e165d? = null,
    public val expiresAfterSeconds: Int? = null,
    public val expiresAt: Int? = null,
    public val mandateOptions: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsMandateOptionsX0373296a? = null,
    public val setupFutureUsage: InlineV1PaymentIntentsPostRequestFormSetupFutureUsageX628f6906? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPixAnyOf1X9b92cade =
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPixAnyOf1X9b92cade = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPixAnyOf1X9b92cade> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPixAnyOf1X9b92cade must be a JSON object",
                    )
            return InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPixAnyOf1X9b92cade(
                amountIncludesIof =
                    rawObject["amount_includes_iof"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormAmountIncludesIofXa14e165d>(it)
                    },
                expiresAfterSeconds =
                ...
                mandateOptions =
                    rawObject["mandate_options"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsMandateOptionsX0373296a>(
                                it,
                            )
                    },
                setupFutureUsage =
                    rawObject["setup_future_usage"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormSetupFutureUsageX628f6906>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPixAnyOf1X9b92cade,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPixAnyOf1X9b92cade(
    block: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPixAnyOf1X9b92cade.Builder.() -> Unit,
): InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPixAnyOf1X9b92cade =
    InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPixAnyOf1X9b92cade.build(block)
