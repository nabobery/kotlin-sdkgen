...
public class PaymentFlowsAmountDetailsResourceTax(
    ...
    public class Builder {
        ...
        public fun build(): PaymentFlowsAmountDetailsResourceTax =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentFlowsAmountDetailsResourceTax =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentFlowsAmountDetailsResourceTax> {
        ...
        override fun deserialize(decoder: Decoder): PaymentFlowsAmountDetailsResourceTax {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentFlowsAmountDetailsResourceTax must be a JSON object")
            return PaymentFlowsAmountDetailsResourceTax(
                totalTaxAmount =
                    rawObject["total_tax_amount"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentFlowsAmountDetailsResourceTax,
        ) {
...
public fun paymentFlowsAmountDetailsResourceTax(
    block: PaymentFlowsAmountDetailsResourceTax.Builder.() -> Unit,
): PaymentFlowsAmountDetailsResourceTax = PaymentFlowsAmountDetailsResourceTax.build(block)
