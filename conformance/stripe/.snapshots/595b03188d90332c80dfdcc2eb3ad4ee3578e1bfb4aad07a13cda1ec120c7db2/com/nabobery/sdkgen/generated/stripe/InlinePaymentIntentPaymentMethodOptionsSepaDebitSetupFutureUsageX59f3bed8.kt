    ...
    public object Serializer : KSerializer<InlinePaymentIntentPaymentMethodOptionsSepaDebitSetupFutureUsageX59f3bed8> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentIntentPaymentMethodOptionsSepaDebitSetupFutureUsageX59f3bed8",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlinePaymentIntentPaymentMethodOptionsSepaDebitSetupFutureUsageX59f3bed8 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentIntentPaymentMethodOptionsSepaDebitSetupFutureUsageX59f3bed8,
        ) {
