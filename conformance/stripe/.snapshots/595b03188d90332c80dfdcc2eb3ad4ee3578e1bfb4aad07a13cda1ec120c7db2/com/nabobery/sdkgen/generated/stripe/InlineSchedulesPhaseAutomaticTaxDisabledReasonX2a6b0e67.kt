...
public sealed class InlineSchedulesPhaseAutomaticTaxDisabledReasonX2a6b0e67 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineSchedulesPhaseAutomaticTaxDisabledReasonX2a6b0e67 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineSchedulesPhaseAutomaticTaxDisabledReasonX2a6b0e67> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineSchedulesPhaseAutomaticTaxDisabledReasonX2a6b0e67",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineSchedulesPhaseAutomaticTaxDisabledReasonX2a6b0e67 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineSchedulesPhaseAutomaticTaxDisabledReasonX2a6b0e67,
        ) {
