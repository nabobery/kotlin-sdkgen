...
internal data class InlineV1WebhookEndpointsPostRequestFormMetadataXee719122Inspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1WebhookEndpointsPostRequestFormMetadataAnyOf2Xe80cc769,
            ).count { it }
}
...
public class InlineV1WebhookEndpointsPostRequestFormMetadataXee719122 internal constructor(
    ...
    public val inlineV1WebhookEndpointsPostRequestFormMetadataAnyOf2Xe80cc769:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1WebhookEndpointsPostRequestFormMetadataAnyOf2Xe80cc769) {
                json
                    .decodeFromJsonElement<InlineV1WebhookEndpointsPostRequestFormMetadataAnyOf2Xe80cc769>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1WebhookEndpointsPostRequestFormMetadataXee719122Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1WebhookEndpointsPostRequestFormMetadataAnyOf2Xe80cc769) {
                    add(
                        InlineV1WebhookEndpointsPostRequestFormMetadataXee719122Branch.InlineV1WebhookEndpointsPostRequestFormMetadataAnyOf2Xe80cc769,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1WebhookEndpointsPostRequestFormMetadataXee719122 {
            val inspection = inspectInlineV1WebhookEndpointsPostRequestFormMetadataXee719122(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1WebhookEndpointsPostRequestFormMetadataXee719122NoMatchException(
                    "InlineV1WebhookEndpointsPostRequestFormMetadataXee719122 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1WebhookEndpointsPostRequestFormMetadataXee719122> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1WebhookEndpointsPostRequestFormMetadataXee719122,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1WebhookEndpointsPostRequestFormMetadataXee719122",
...
private fun inspectInlineV1WebhookEndpointsPostRequestFormMetadataXee719122(
    element: JsonElement,
): InlineV1WebhookEndpointsPostRequestFormMetadataXee719122Inspection {
    val matchesBranch1 = element.isJsonDecodable<JsonObject>()
    val matchesInlineV1WebhookEndpointsPostRequestFormMetadataAnyOf2Xe80cc769 =
        element
            .isJsonDecodable<InlineV1WebhookEndpointsPostRequestFormMetadataAnyOf2Xe80cc769>()
    return InlineV1WebhookEndpointsPostRequestFormMetadataXee719122Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1WebhookEndpointsPostRequestFormMetadataAnyOf2Xe80cc769) {
                    add(
                        "InlineV1WebhookEndpointsPostRequestFormMetadataAnyOf2Xe80cc769: value does not match InlineV1WebhookEndpointsPostRequestFormMetadataAnyOf2Xe80cc769",
                    )
                }
            },
    )
