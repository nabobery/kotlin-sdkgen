...
public class InlineV1RadarValueListsGetParameterX26d080bd internal constructor(
    ...
    public val inlineV1RadarValueListsGetParameterAnyOf1X0c2edf91:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1RadarValueListsGetParameterAnyOf1X0c2edf91) {
                json
                    .decodeFromJsonElement<InlineV1RadarValueListsGetParameterAnyOf1X0c2edf91>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1RadarValueListsGetParameterX26d080bdBranch>
        get() =
            buildSet {
                if (inspection.matchesInlineV1RadarValueListsGetParameterAnyOf1X0c2edf91) {
                    add(
                        InlineV1RadarValueListsGetParameterX26d080bdBranch.InlineV1RadarValueListsGetParameterAnyOf1X0c2edf91,
                    )
                }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1RadarValueListsGetParameterX26d080bd {
            val inspection = inspectInlineV1RadarValueListsGetParameterX26d080bd(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1RadarValueListsGetParameterX26d080bdNoMatchException(
                    "InlineV1RadarValueListsGetParameterX26d080bd matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1RadarValueListsGetParameterX26d080bd> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1RadarValueListsGetParameterX26d080bd,
        ) {
...
private fun inspectInlineV1RadarValueListsGetParameterX26d080bd(
    element: JsonElement,
): InlineV1RadarValueListsGetParameterX26d080bdInspection {
    val matchesInlineV1RadarValueListsGetParameterAnyOf1X0c2edf91 =
        element
            .isJsonDecodable<InlineV1RadarValueListsGetParameterAnyOf1X0c2edf91>()
    ...
    return InlineV1RadarValueListsGetParameterX26d080bdInspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1RadarValueListsGetParameterAnyOf1X0c2edf91) {
                    add(
                        "InlineV1RadarValueListsGetParameterAnyOf1X0c2edf91: value does not match InlineV1RadarValueListsGetParameterAnyOf1X0c2edf91",
                    )
                }
