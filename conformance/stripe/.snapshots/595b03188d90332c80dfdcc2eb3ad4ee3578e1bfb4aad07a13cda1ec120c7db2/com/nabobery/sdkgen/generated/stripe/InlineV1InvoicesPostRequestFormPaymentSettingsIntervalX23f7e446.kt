...
public sealed class InlineV1InvoicesPostRequestFormPaymentSettingsIntervalX23f7e446 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1InvoicesPostRequestFormPaymentSettingsIntervalX23f7e446 =
            when (value) {
                Month.value -> Month
    ...
    public object Serializer : KSerializer<InlineV1InvoicesPostRequestFormPaymentSettingsIntervalX23f7e446> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1InvoicesPostRequestFormPaymentSettingsIntervalX23f7e446",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1InvoicesPostRequestFormPaymentSettingsIntervalX23f7e446 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesPostRequestFormPaymentSettingsIntervalX23f7e446,
        ) {
