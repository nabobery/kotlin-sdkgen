...
public class InlineIdentityVerificationSessionLastVerificationReportX5959b875 internal constructor(
    ...
    private val inspection: InlineIdentityVerificationSessionLastVerificationReportX5959b875Inspection,
) {
    ...
    public val identityVerificationReport: IdentityVerificationReport? by
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesIdentityVerificationReport) {
                json.decodeFromJsonElement<IdentityVerificationReport>(
                    raw,
                )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineIdentityVerificationSessionLastVerificationReportX5959b875Branch.Branch1,
                    )
                }
                if (inspection.matchesIdentityVerificationReport) {
                    add(
                        InlineIdentityVerificationSessionLastVerificationReportX5959b875Branch.IdentityVerificationReport,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineIdentityVerificationSessionLastVerificationReportX5959b875 {
            val inspection = inspectInlineIdentityVerificationSessionLastVerificationReportX5959b875(raw)
            if (inspection.matchCount == 0) {
                throw InlineIdentityVerificationSessionLastVerificationReportX5959b875NoMatchException(
                    "InlineIdentityVerificationSessionLastVerificationReportX5959b875 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineIdentityVerificationSessionLastVerificationReportX5959b875> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineIdentityVerificationSessionLastVerificationReportX5959b875,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineIdentityVerificationSessionLastVerificationReportX5959b875",
...
private fun inspectInlineIdentityVerificationSessionLastVerificationReportX5959b875(
    element: JsonElement,
    ...
    return InlineIdentityVerificationSessionLastVerificationReportX5959b875Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesIdentityVerificationReport) {
                    add(
                        "IdentityVerificationReport: value does not match IdentityVerificationReport",
                    )
                }
            },
    )
