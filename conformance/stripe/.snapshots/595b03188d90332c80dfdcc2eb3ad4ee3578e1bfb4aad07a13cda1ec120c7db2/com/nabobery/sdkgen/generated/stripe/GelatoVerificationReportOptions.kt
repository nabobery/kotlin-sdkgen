...
public class GelatoVerificationReportOptions(
    ...
    public class Builder {
        ...
        public fun build(): GelatoVerificationReportOptions =
    ...
    public object Serializer : KSerializer<GelatoVerificationReportOptions> {
        ...
        override fun deserialize(decoder: Decoder): GelatoVerificationReportOptions {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("GelatoVerificationReportOptions must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: GelatoVerificationReportOptions,
        ) {
...
public fun gelatoVerificationReportOptions(
    block: GelatoVerificationReportOptions.Builder.() -> Unit,
): GelatoVerificationReportOptions = GelatoVerificationReportOptions.build(block)
