...
public class IssuingCardLifecycleConditions(
    ...
    public object Serializer : KSerializer<IssuingCardLifecycleConditions> {
        ...
        override fun deserialize(decoder: Decoder): IssuingCardLifecycleConditions {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("IssuingCardLifecycleConditions must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: IssuingCardLifecycleConditions,
        ) {
...
public fun issuingCardLifecycleConditions(
    block: IssuingCardLifecycleConditions.Builder.() -> Unit,
): IssuingCardLifecycleConditions = IssuingCardLifecycleConditions.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "IssuingCardLifecycleConditions is missing required property '" + name + "'",
            )
