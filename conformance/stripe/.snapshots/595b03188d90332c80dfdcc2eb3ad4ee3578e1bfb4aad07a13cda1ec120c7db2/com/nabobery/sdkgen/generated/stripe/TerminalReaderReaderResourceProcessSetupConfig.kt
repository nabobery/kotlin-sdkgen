...
public class TerminalReaderReaderResourceProcessSetupConfig(
    ...
    public class Builder {
        ...
        public fun build(): TerminalReaderReaderResourceProcessSetupConfig =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): TerminalReaderReaderResourceProcessSetupConfig =
    ...
    public object Serializer : KSerializer<TerminalReaderReaderResourceProcessSetupConfig> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "TerminalReaderReaderResourceProcessSetupConfig must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: TerminalReaderReaderResourceProcessSetupConfig,
        ) {
...
public fun terminalReaderReaderResourceProcessSetupConfig(
    block: TerminalReaderReaderResourceProcessSetupConfig.Builder.() -> Unit,
): TerminalReaderReaderResourceProcessSetupConfig = TerminalReaderReaderResourceProcessSetupConfig.build(block)
