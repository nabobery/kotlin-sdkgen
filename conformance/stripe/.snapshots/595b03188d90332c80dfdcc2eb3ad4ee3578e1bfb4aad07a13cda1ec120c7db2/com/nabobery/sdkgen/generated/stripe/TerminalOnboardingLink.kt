...
public class TerminalOnboardingLink(
    ...
    public object Serializer : KSerializer<TerminalOnboardingLink> {
        ...
        override fun deserialize(decoder: Decoder): TerminalOnboardingLink {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("TerminalOnboardingLink must be a JSON object")
...
public fun terminalOnboardingLink(block: TerminalOnboardingLink.Builder.() -> Unit): TerminalOnboardingLink =
    TerminalOnboardingLink.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("TerminalOnboardingLink is missing required property '" + name + "'")
