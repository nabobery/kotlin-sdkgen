...
public class InlineV1TreasuryOutboundPab148PostRequestFormDestinationPaymentMec421X96743474(
    ...
    public val billingDetails: InlineV1TreasuryOutboundPab148PostRequestFormBillingDetailsX30f81f31? = null,
    public val financialAccount: String? = null,
    public val metadata: Map<String, String>? = null,
    public val usBankAccount: InlineV1TreasuryOutboundPab148PostRequestFormUsBankAccountXa4a7bfc5? = null,
) {
    ...
    public object Serializer : KSerializer<InlineV1TreasuryOutboundPab148PostRequestFormDestinationPaymentMec421X96743474> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TreasuryOutboundPab148PostRequestFormDestinationPaymentMec421X96743474 must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineV1TreasuryOutboundPab148PostRequestFormTypeX6b8f616e>(
                    rawObject,
                    "type",
                )
            return InlineV1TreasuryOutboundPab148PostRequestFormDestinationPaymentMec421X96743474(
                ...
                billingDetails =
                    rawObject["billing_details"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TreasuryOutboundPab148PostRequestFormBillingDetailsX30f81f31>(
                                it,
                            )
                    },
                ...
                usBankAccount =
                    rawObject["us_bank_account"]?.let {
                        json.decodeFromJsonElement<InlineV1TreasuryOutboundPab148PostRequestFormUsBankAccountXa4a7bfc5>(
                            it,
                        )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TreasuryOutboundPab148PostRequestFormDestinationPaymentMec421X96743474,
        ) {
            val jsonEncoder =
...
public fun inlineV1TreasuryOutboundPab148PostRequestFormDestinationPaymentMec421X96743474(
    block: InlineV1TreasuryOutboundPab148PostRequestFormDestinationPaymentMec421X96743474.Builder.() -> Unit,
): InlineV1TreasuryOutboundPab148PostRequestFormDestinationPaymentMec421X96743474 =
    InlineV1TreasuryOutboundPab148PostRequestFormDestinationPaymentMec421X96743474.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TreasuryOutboundPab148PostRequestFormDestinationPaymentMec421X96743474 is missing required property '" +
                    name +
                    "'",
            )
