...
public class InlineV1SourcesPostRequestFormSourceOrderItemsItemXf6e3b25a(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1SourcesPostRequestFormSourceOrderItemsItemXf6e3b25a =
            InlineV1SourcesPostRequestFormSourceOrderItemsItemXf6e3b25a(
                amount = amount,
                currency = currency,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1SourcesPostRequestFormSourceOrderItemsItemXf6e3b25a =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1SourcesPostRequestFormSourceOrderItemsItemXf6e3b25a> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1SourcesPostRequestFormSourceOrderItemsItemXf6e3b25a {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SourcesPostRequestFormSourceOrderItemsItemXf6e3b25a must be a JSON object",
                    )
            return InlineV1SourcesPostRequestFormSourceOrderItemsItemXf6e3b25a(
                ...
                type =
                    rawObject["type"]?.let {
                        json.decodeFromJsonElement<InlineV1SourcesPostRequestFormSourceOrderItemsItemTypeX2221255e>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SourcesPostRequestFormSourceOrderItemsItemXf6e3b25a,
        ) {
...
public fun inlineV1SourcesPostRequestFormSourceOrderItemsItemXf6e3b25a(
    block: InlineV1SourcesPostRequestFormSourceOrderItemsItemXf6e3b25a.Builder.() -> Unit,
): InlineV1SourcesPostRequestFormSourceOrderItemsItemXf6e3b25a =
    InlineV1SourcesPostRequestFormSourceOrderItemsItemXf6e3b25a.build(block)
