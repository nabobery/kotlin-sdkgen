...
public class PaymentsPrimitivesPaymentRecordsResourceBillingDetails(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentsPrimitivesPaymentRecordsResourceBillingDetails =
    ...
    public object Serializer : KSerializer<PaymentsPrimitivesPaymentRecordsResourceBillingDetails> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "PaymentsPrimitivesPaymentRecordsResourceBillingDetails must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentsPrimitivesPaymentRecordsResourceBillingDetails,
        ) {
...
public fun paymentsPrimitivesPaymentRecordsResourceBillingDetails(
    block: PaymentsPrimitivesPaymentRecordsResourceBillingDetails.Builder.() -> Unit,
): PaymentsPrimitivesPaymentRecordsResourceBillingDetails =
    PaymentsPrimitivesPaymentRecordsResourceBillingDetails.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "PaymentsPrimitivesPaymentRecordsResourceBillingDetails is missing required property '" + name + "'",
            )
