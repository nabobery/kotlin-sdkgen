...
public class InlineV1ChargesCapturePostRequestFormTransferDataXfba3c867(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1ChargesCapturePostRequestFormTransferDataXfba3c867 =
            InlineV1ChargesCapturePostRequestFormTransferDataXfba3c867(
                amount = amount,
            )
    }

    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1ChargesCapturePostRequestFormTransferDataXfba3c867 =
    ...
    public object Serializer : KSerializer<InlineV1ChargesCapturePostRequestFormTransferDataXfba3c867> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1ChargesCapturePostRequestFormTransferDataXfba3c867 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ChargesCapturePostRequestFormTransferDataXfba3c867,
        ) {
...
public fun inlineV1ChargesCapturePostRequestFormTransferDataXfba3c867(
    block: InlineV1ChargesCapturePostRequestFormTransferDataXfba3c867.Builder.() -> Unit,
): InlineV1ChargesCapturePostRequestFormTransferDataXfba3c867 =
    InlineV1ChargesCapturePostRequestFormTransferDataXfba3c867.build(block)
