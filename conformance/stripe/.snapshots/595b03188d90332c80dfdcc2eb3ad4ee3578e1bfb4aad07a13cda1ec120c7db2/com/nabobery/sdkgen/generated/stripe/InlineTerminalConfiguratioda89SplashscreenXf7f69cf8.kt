...
public class InlineTerminalConfiguratioda89SplashscreenXf7f69cf8 internal constructor(
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineTerminalConfiguratioda89SplashscreenXf7f69cf8 {
            val inspection = inspectInlineTerminalConfiguratioda89SplashscreenXf7f69cf8(raw)
            if (inspection.matchCount == 0) {
                throw InlineTerminalConfiguratioda89SplashscreenXf7f69cf8NoMatchException(
                    "InlineTerminalConfiguratioda89SplashscreenXf7f69cf8 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineTerminalConfiguratioda89SplashscreenXf7f69cf8> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineTerminalConfiguratioda89SplashscreenXf7f69cf8,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineTerminalConfiguratioda89SplashscreenXf7f69cf8",
...
private fun inspectInlineTerminalConfiguratioda89SplashscreenXf7f69cf8(
    element: JsonElement,
): InlineTerminalConfiguratioda89SplashscreenXf7f69cf8Inspection {
