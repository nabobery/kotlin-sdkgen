...
public class InlineV1AccountsPostRequestFormCompanyRegistrationDateAnyOf1Xbe74beef(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1AccountsPostRequestFormCompanyRegistrationDateAnyOf1Xbe74beef = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1AccountsPostRequestFormCompanyRegistrationDateAnyOf1Xbe74beef> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountsPostRequestFormCompanyRegistrationDateAnyOf1Xbe74beef must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPostRequestFormCompanyRegistrationDateAnyOf1Xbe74beef,
        ) {
            val jsonEncoder =
...
public fun inlineV1AccountsPostRequestFormCompanyRegistrationDateAnyOf1Xbe74beef(
    block: InlineV1AccountsPostRequestFormCompanyRegistrationDateAnyOf1Xbe74beef.Builder.() -> Unit,
): InlineV1AccountsPostRequestFormCompanyRegistrationDateAnyOf1Xbe74beef =
    InlineV1AccountsPostRequestFormCompanyRegistrationDateAnyOf1Xbe74beef.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1AccountsPostRequestFormCompanyRegistrationDateAnyOf1Xbe74beef is missing required property '" +
                    name +
                    "'",
            )
