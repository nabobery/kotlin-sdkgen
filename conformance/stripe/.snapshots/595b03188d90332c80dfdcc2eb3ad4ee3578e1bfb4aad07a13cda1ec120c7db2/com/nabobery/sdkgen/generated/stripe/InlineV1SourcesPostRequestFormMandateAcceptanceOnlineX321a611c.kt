...
public class InlineV1SourcesPostRequestFormMandateAcceptanceOnlineX321a611c(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1SourcesPostRequestFormMandateAcceptanceOnlineX321a611c =
            InlineV1SourcesPostRequestFormMandateAcceptanceOnlineX321a611c(
                date = date,
                ip = ip,
                userAgent = userAgent,
            )
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1SourcesPostRequestFormMandateAcceptanceOnlineX321a611c =
    ...
    public object Serializer : KSerializer<InlineV1SourcesPostRequestFormMandateAcceptanceOnlineX321a611c> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SourcesPostRequestFormMandateAcceptanceOnlineX321a611c must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SourcesPostRequestFormMandateAcceptanceOnlineX321a611c,
        ) {
            val jsonEncoder =
...
public fun inlineV1SourcesPostRequestFormMandateAcceptanceOnlineX321a611c(
    block: InlineV1SourcesPostRequestFormMandateAcceptanceOnlineX321a611c.Builder.() -> Unit,
): InlineV1SourcesPostRequestFormMandateAcceptanceOnlineX321a611c =
    InlineV1SourcesPostRequestFormMandateAcceptanceOnlineX321a611c.build(block)
