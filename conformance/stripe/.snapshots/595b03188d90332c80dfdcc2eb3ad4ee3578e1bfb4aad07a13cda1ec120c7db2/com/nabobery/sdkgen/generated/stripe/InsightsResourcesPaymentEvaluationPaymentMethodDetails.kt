...
public class InsightsResourcesPaymentEvaluationPaymentMethodDetails(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InsightsResourcesPaymentEvaluationPaymentMethodDetails =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InsightsResourcesPaymentEvaluationPaymentMethodDetails> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InsightsResourcesPaymentEvaluationPaymentMethodDetails must be a JSON object",
                    )
            val paymentMethod =
                json.decodeRequired<InlineInsightsResourcesPayf203PaymentMethodX825d85ed>(
                    rawObject,
                    "payment_method",
                )
            return InsightsResourcesPaymentEvaluationPaymentMethodDetails(
                ...
                billingDetails =
                    rawObject["billing_details"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineInsightsResourcesPayf203BillingDetailsX768b19d3?>(element)
                        }
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InsightsResourcesPaymentEvaluationPaymentMethodDetails,
        ) {
...
public fun insightsResourcesPaymentEvaluationPaymentMethodDetails(
    block: InsightsResourcesPaymentEvaluationPaymentMethodDetails.Builder.() -> Unit,
): InsightsResourcesPaymentEvaluationPaymentMethodDetails =
    InsightsResourcesPaymentEvaluationPaymentMethodDetails.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InsightsResourcesPaymentEvaluationPaymentMethodDetails is missing required property '" + name + "'",
            )
