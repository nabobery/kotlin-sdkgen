...
public class InlineV1BillingCreditGrantsPostRequestFormAmountMonetaryXbe225a3e(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1BillingCreditGrantsPostRequestFormAmountMonetaryXbe225a3e =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1BillingCreditGrantsPostRequestFormAmountMonetaryXbe225a3e> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1BillingCreditGrantsPostRequestFormAmountMonetaryXbe225a3e {
            val jsonDecoder =
                decoder.requireJsonDecoder(
                    "InlineV1BillingCreditGrantsPostRequestFormAmountMonetaryXbe225a3e",
                )
            val json = jsonDecoder.json
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1BillingCreditGrantsPostRequestFormAmountMonetaryXbe225a3e must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1BillingCreditGrantsPostRequestFormAmountMonetaryXbe225a3e,
        ) {
            val jsonEncoder =
...
public fun inlineV1BillingCreditGrantsPostRequestFormAmountMonetaryXbe225a3e(
    block: InlineV1BillingCreditGrantsPostRequestFormAmountMonetaryXbe225a3e.Builder.() -> Unit,
): InlineV1BillingCreditGrantsPostRequestFormAmountMonetaryXbe225a3e =
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1BillingCreditGrantsPostRequestFormAmountMonetaryXbe225a3e is missing required property '" +
                    name +
                    "'",
            )
