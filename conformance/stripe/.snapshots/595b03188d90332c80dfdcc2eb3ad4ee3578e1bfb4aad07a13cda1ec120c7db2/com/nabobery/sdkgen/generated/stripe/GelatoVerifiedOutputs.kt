...
public class GelatoVerifiedOutputs(
    ...
    public class Builder {
        ...
        public fun build(): GelatoVerifiedOutputs =
    ...
    public object Serializer : KSerializer<GelatoVerifiedOutputs> {
        ...
        override fun deserialize(decoder: Decoder): GelatoVerifiedOutputs {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("GelatoVerifiedOutputs must be a JSON object")
            return GelatoVerifiedOutputs(
                address =
                    rawObject["address"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineGelatoVerifiedOutputsAddressXfcb1d786?>(element)
                        }
                    },
                dob =
                    rawObject["dob"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineGelatoVerifiedOutputsDobXfa069c26?>(element)
                        }
                    },
                email =
                ...
                idNumber =
                    rawObject["id_number"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                idNumberType =
                    rawObject["id_number_type"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineGelatoVerifiedOutputsIdNumberTypeX23dd6e9d?>(element)
                        }
                    },
                lastName =
                ...
                sex =
                    rawObject["sex"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineGelatoVerifiedOutputsSexX85a28680?>(element)
                        }
                    },
...
public fun gelatoVerifiedOutputs(block: GelatoVerifiedOutputs.Builder.() -> Unit): GelatoVerifiedOutputs =
    GelatoVerifiedOutputs.build(block)
