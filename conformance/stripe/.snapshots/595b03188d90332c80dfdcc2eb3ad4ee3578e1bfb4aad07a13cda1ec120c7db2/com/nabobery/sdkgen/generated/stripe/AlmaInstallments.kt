...
public class AlmaInstallments(
    ...
    public object Serializer : KSerializer<AlmaInstallments> {
        ...
        override fun deserialize(decoder: Decoder): AlmaInstallments {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("AlmaInstallments must be a JSON object")
...
public fun almaInstallments(block: AlmaInstallments.Builder.() -> Unit): AlmaInstallments =
    AlmaInstallments.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("AlmaInstallments is missing required property '" + name + "'")
