...
internal data class InlineV1InvoicesPostRequestFormPaymentSettingsUsBankAccountXecbb180fInspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X81ca6123,
                matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2X9d9c8082,
            ).count {
                it
            }
}
...
public class InlineV1InvoicesPostRequestFormPaymentSettingsUsBankAccountXecbb180f internal constructor(
    ...
    private val inspection: InlineV1InvoicesPostRequestFormPaymentSettingsUsBankAccountXecbb180fInspection,
) {
    public val inlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X81ca6123:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X81ca6123) {
                json
                    .decodeFromJsonElement<InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X81ca6123>(
                        raw,
                    )
            } else {
                null
    ...
    public val inlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2X9d9c8082:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2X9d9c8082) {
                json
                    .decodeFromJsonElement<InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2X9d9c8082>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches:
        ...
        get() =
            buildSet {
                if (inspection.matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X81ca6123) {
                    add(
                        InlineV1InvoicesPostRequestFormPaymentSettingsUsBankAccountXecbb180fBranch.InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X81ca6123,
                    )
                }
                if (inspection.matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2X9d9c8082) {
                    add(
                        InlineV1InvoicesPostRequestFormPaymentSettingsUsBankAccountXecbb180fBranch.InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2X9d9c8082,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1InvoicesPostRequestFormPaymentSettingsUsBankAccountXecbb180f {
            val inspection = inspectInlineV1InvoicesPostRequestFormPaymentSettingsUsBankAccountXecbb180f(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1InvoicesPostRequestFormPaymentSettingsUsBankAccountXecbb180fNoMatchException(
                    "InlineV1InvoicesPostRequestFormPaymentSettingsUsBankAccountXecbb180f matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1InvoicesPostRequestFormPaymentSettingsUsBankAccountXecbb180f> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesPostRequestFormPaymentSettingsUsBankAccountXecbb180f,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1InvoicesPostRequestFormPaymentSettingsUsBankAccountXecbb180f",
...
private fun inspectInlineV1InvoicesPostRequestFormPaymentSettingsUsBankAccountXecbb180f(
    element: JsonElement,
): InlineV1InvoicesPostRequestFormPaymentSettingsUsBankAccountXecbb180fInspection {
    val matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X81ca6123 =
        element
            .isJsonDecodable<InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X81ca6123>()
    val matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2X9d9c8082 =
        element
            .isJsonDecodable<InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2X9d9c8082>()
    return InlineV1InvoicesPostRequestFormPaymentSettingsUsBankAccountXecbb180fInspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X81ca6123) {
                    add(
                        "InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X81ca6123: value does not match InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X81ca6123",
                    )
                }
                if (!matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2X9d9c8082) {
                    add(
                        "InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2X9d9c8082: value does not match InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2X9d9c8082",
                    )
                }
            },
    )
