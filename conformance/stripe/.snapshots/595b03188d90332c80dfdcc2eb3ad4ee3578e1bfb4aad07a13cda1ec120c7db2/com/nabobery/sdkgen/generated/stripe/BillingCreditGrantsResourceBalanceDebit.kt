...
public data class BillingCreditGrantsResourceBalanceDebitView(
    ...
    public val creditsApplied: InlineBillingCreditGrantsResourceBalanceDebitCreditsAppliedX1c1a9a37? = null,
...
public class BillingCreditGrantsResourceBalanceDebit(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): BillingCreditGrantsResourceBalanceDebit =
    ...
    public object Serializer : KSerializer<BillingCreditGrantsResourceBalanceDebit> {
        ...
        override fun deserialize(decoder: Decoder): BillingCreditGrantsResourceBalanceDebit {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("BillingCreditGrantsResourceBalanceDebit must be a JSON object")
            val amount = json.decodeRequired<BillingCreditGrantsResourceAmount>(rawObject, "amount")
            val type =
                json.decodeRequired<InlineBillingCreditGrantsResourceBalanceDebitTypeX2282ffcc>(
                    rawObject,
                    "type",
                )
            return BillingCreditGrantsResourceBalanceDebit(
                ...
                type = type,
                creditsApplied =
                    rawObject["credits_applied"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                            ...
                            json
                                .decodeFromJsonElement<InlineBillingCreditGrantsResourceBalanceDebitCreditsAppliedX1c1a9a37?>(
                                    element,
                                )
                        }
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: BillingCreditGrantsResourceBalanceDebit,
        ) {
...
public fun billingCreditGrantsResourceBalanceDebit(
    block: BillingCreditGrantsResourceBalanceDebit.Builder.() -> Unit,
): BillingCreditGrantsResourceBalanceDebit = BillingCreditGrantsResourceBalanceDebit.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "BillingCreditGrantsResourceBalanceDebit is missing required property '" + name + "'",
            )
