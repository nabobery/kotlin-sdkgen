...
public sealed class InlineV1CustomersSubscriptionsPostRequestFormPreferredLanguageX0f9a3f6a {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1CustomersSubscriptionsPostRequestFormPreferredLanguageX0f9a3f6a =
            when (value) {
                De.value -> De
                En.value -> En
                Fr.value -> Fr
    ...
    public object Serializer : KSerializer<InlineV1CustomersSubscriptionsPostRequestFormPreferredLanguageX0f9a3f6a> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1CustomersSubscriptionsPostRequestFormPreferredLanguageX0f9a3f6a",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1CustomersSubscriptionsPostRequestFormPreferredLanguageX0f9a3f6a = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersSubscriptionsPostRequestFormPreferredLanguageX0f9a3f6a,
        ) {
