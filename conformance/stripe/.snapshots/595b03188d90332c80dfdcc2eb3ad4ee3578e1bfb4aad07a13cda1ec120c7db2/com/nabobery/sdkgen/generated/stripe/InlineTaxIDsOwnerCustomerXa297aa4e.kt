...
public class InlineTaxIDsOwnerCustomerXa297aa4e internal constructor(
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineTaxIDsOwnerCustomerXa297aa4e {
            val inspection = inspectInlineTaxIDsOwnerCustomerXa297aa4e(raw)
            if (inspection.matchCount == 0) {
                throw InlineTaxIDsOwnerCustomerXa297aa4eNoMatchException(
                    "InlineTaxIDsOwnerCustomerXa297aa4e matched 0 branches: " + inspection.failures.joinToString("; "),
                )
            }
    ...
    public object Serializer : KSerializer<InlineTaxIDsOwnerCustomerXa297aa4e> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineTaxIDsOwnerCustomerXa297aa4e,
        ) {
...
private fun inspectInlineTaxIDsOwnerCustomerXa297aa4e(
    element: JsonElement,
): InlineTaxIDsOwnerCustomerXa297aa4eInspection {
