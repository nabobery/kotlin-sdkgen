...
public class TransformQuantity(
    ...
    public object Serializer : KSerializer<TransformQuantity> {
        ...
        override fun deserialize(decoder: Decoder): TransformQuantity {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("TransformQuantity must be a JSON object")
...
public fun transformQuantity(block: TransformQuantity.Builder.() -> Unit): TransformQuantity =
    TransformQuantity.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("TransformQuantity is missing required property '" + name + "'")
