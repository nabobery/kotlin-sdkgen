...
public class PortalResourceScheduleUpdateAtPeriodEndCondition(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PortalResourceScheduleUpdateAtPeriodEndCondition =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PortalResourceScheduleUpdateAtPeriodEndCondition> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "PortalResourceScheduleUpdateAtPeriodEndCondition must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlinePortalResourceScheduleUpdateAtPeriodEndConditionTypeX562f5972>(
                    rawObject,
                    "type",
                )
            return PortalResourceScheduleUpdateAtPeriodEndCondition(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PortalResourceScheduleUpdateAtPeriodEndCondition,
        ) {
...
public fun portalResourceScheduleUpdateAtPeriodEndCondition(
    block: PortalResourceScheduleUpdateAtPeriodEndCondition.Builder.() -> Unit,
): PortalResourceScheduleUpdateAtPeriodEndCondition = PortalResourceScheduleUpdateAtPeriodEndCondition.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "PortalResourceScheduleUpdateAtPeriodEndCondition is missing required property '" + name + "'",
            )
