...
public class InlineV1PayoutsPostRequestFormMetadataX1f23cef5 internal constructor(
    ...
    public val inlineV1PayoutsPostRequestFormMetadataAnyOf2X8048c142:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1PayoutsPostRequestFormMetadataAnyOf2X8048c142) {
                json
                    .decodeFromJsonElement<InlineV1PayoutsPostRequestFormMetadataAnyOf2X8048c142>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1PayoutsPostRequestFormMetadataX1f23cef5Branch>
        get() =
            buildSet {
                ...
                if (inspection.matchesInlineV1PayoutsPostRequestFormMetadataAnyOf2X8048c142) {
                    add(
                        InlineV1PayoutsPostRequestFormMetadataX1f23cef5Branch.InlineV1PayoutsPostRequestFormMetadataAnyOf2X8048c142,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1PayoutsPostRequestFormMetadataX1f23cef5 {
            val inspection = inspectInlineV1PayoutsPostRequestFormMetadataX1f23cef5(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1PayoutsPostRequestFormMetadataX1f23cef5NoMatchException(
                    "InlineV1PayoutsPostRequestFormMetadataX1f23cef5 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1PayoutsPostRequestFormMetadataX1f23cef5> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PayoutsPostRequestFormMetadataX1f23cef5,
        ) {
...
private fun inspectInlineV1PayoutsPostRequestFormMetadataX1f23cef5(
    element: JsonElement,
): InlineV1PayoutsPostRequestFormMetadataX1f23cef5Inspection {
    val matchesBranch1 = element.isJsonDecodable<JsonObject>()
    val matchesInlineV1PayoutsPostRequestFormMetadataAnyOf2X8048c142 =
        element
            .isJsonDecodable<InlineV1PayoutsPostRequestFormMetadataAnyOf2X8048c142>()
    return InlineV1PayoutsPostRequestFormMetadataX1f23cef5Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1PayoutsPostRequestFormMetadataAnyOf2X8048c142) {
                    add(
                        "InlineV1PayoutsPostRequestFormMetadataAnyOf2X8048c142: value does not match InlineV1PayoutsPostRequestFormMetadataAnyOf2X8048c142",
                    )
                }
            },
    )
