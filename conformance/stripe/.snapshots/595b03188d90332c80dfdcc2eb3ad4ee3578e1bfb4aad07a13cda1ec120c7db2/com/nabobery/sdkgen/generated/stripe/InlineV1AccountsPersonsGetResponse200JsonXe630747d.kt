...
public class InlineV1AccountsPersonsGetResponse200JsonXe630747d(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1AccountsPersonsGetResponse200JsonXe630747d =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1AccountsPersonsGetResponse200JsonXe630747d> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountsPersonsGetResponse200JsonXe630747d must be a JSON object",
                    )
            val data = json.decodeRequired<List<Person>>(rawObject, "data")
            val hasMore = json.decodeRequired<Boolean>(rawObject, "has_more")
            val objectValue =
                json.decodeRequired<InlineV1AccountsPersonsGetResponse200JsonObjectValueX800a9564>(
                    rawObject,
                    "object",
                )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPersonsGetResponse200JsonXe630747d,
        ) {
...
public fun inlineV1AccountsPersonsGetResponse200JsonXe630747d(
    block: InlineV1AccountsPersonsGetResponse200JsonXe630747d.Builder.() -> Unit,
): InlineV1AccountsPersonsGetResponse200JsonXe630747d = InlineV1AccountsPersonsGetResponse200JsonXe630747d.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1AccountsPersonsGetResponse200JsonXe630747d is missing required property '" + name + "'",
            )
