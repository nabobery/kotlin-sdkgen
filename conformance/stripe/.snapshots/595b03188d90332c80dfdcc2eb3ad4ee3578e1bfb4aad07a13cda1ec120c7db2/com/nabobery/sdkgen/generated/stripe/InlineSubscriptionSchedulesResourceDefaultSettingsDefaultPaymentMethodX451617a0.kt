...
public class InlineSubscriptionSchedulesResourceDefaultSettingsDefaultPaymentMethodX451617a0 internal constructor(
    ...
    private val inspection: InlineSubscriptionSchedulesResourceDefaultSettingsDefaultPaymentMethodX451617a0Inspection,
) {
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineSubscriptionSchedulesResourceDefaultSettingsDefaultPaymentMethodX451617a0Branch.Branch1,
                    )
                }
                if (inspection.matchesPaymentMethod) {
                    add(
                        InlineSubscriptionSchedulesResourceDefaultSettingsDefaultPaymentMethodX451617a0Branch.PaymentMethod,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineSubscriptionSchedulesResourceDefaultSettingsDefaultPaymentMethodX451617a0 {
            val inspection = inspectInlineSubscriptionSchedulesResourceDefaultSettingsDefaultPaymentMethodX451617a0(raw)
            if (inspection.matchCount == 0) {
                throw InlineSubscriptionSchedulesResourceDefaultSettingsDefaultPaymentMethodX451617a0NoMatchException(
                    "InlineSubscriptionSchedulesResourceDefaultSettingsDefaultPaymentMethodX451617a0 matched 0 branches: " +
                        inspection.failures.joinToString("; "),
                )
            }
            return InlineSubscriptionSchedulesResourceDefaultSettingsDefaultPaymentMethodX451617a0(
                raw,
                json,
                inspection,
            )
    ...
    public object Serializer : KSerializer<InlineSubscriptionSchedulesResourceDefaultSettingsDefaultPaymentMethodX451617a0> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineSubscriptionSchedulesResourceDefaultSettingsDefaultPaymentMethodX451617a0,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineSubscriptionSchedulesResourceDefaultSettingsDefaultPaymentMethodX451617a0",
...
private fun inspectInlineSubscriptionSchedulesResourceDefaultSettingsDefaultPaymentMethodX451617a0(
    element: JsonElement,
