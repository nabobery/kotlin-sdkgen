...
public class BankConnectionsResourceAccountNumberDetails(
     ...
     */
    public val identifierType: InlineBankConnectionsResourceAccountNumberDetailsIdentifierTypeX848bc84d,
    /**
    ...
    public class Builder {
        ...
        public var supportedNetworks:
            List<InlineBankConnectionsResourceAccountNumberDetailsSupportedNetworksItemX35e7579c>
            get() = requireNotNull(supportedNetworksValue) { "supportedNetworks is required" }
            set(`value`) {
                supportedNetworksValue = value
            }
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): BankConnectionsResourceAccountNumberDetails =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<BankConnectionsResourceAccountNumberDetails> {
        ...
        override fun deserialize(decoder: Decoder): BankConnectionsResourceAccountNumberDetails {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("BankConnectionsResourceAccountNumberDetails must be a JSON object")
            val identifierType =
                json
                    .decodeRequired<InlineBankConnectionsResourceAccountNumberDetailsIdentifierTypeX848bc84d>(
                        rawObject,
                        "identifier_type",
                    )
            val status =
                json.decodeRequired<InlineBankConnectionsResourceAccountNumberDetailsStatusX0a0ad0ea>(
                    rawObject,
                    "status",
                )
            val supportedNetworks =
                json
                    .decodeRequired<List<InlineBankConnectionsResourceAccountNumberDetailsSupportedNetworksItemX35e7579c>>(
                        rawObject,
                        "supported_networks",
                    )
            return BankConnectionsResourceAccountNumberDetails(
                ...
                supportedNetworks = supportedNetworks,
                expectedExpiryDate =
                    rawObject["expected_expiry_date"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: BankConnectionsResourceAccountNumberDetails,
        ) {
...
public fun bankConnectionsResourceAccountNumberDetails(
    block: BankConnectionsResourceAccountNumberDetails.Builder.() -> Unit,
): BankConnectionsResourceAccountNumberDetails = BankConnectionsResourceAccountNumberDetails.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "BankConnectionsResourceAccountNumberDetails is missing required property '" + name + "'",
            )
