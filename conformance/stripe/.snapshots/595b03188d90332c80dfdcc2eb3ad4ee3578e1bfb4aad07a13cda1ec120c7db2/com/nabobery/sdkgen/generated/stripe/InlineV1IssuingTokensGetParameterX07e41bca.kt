...
public class InlineV1IssuingTokensGetParameterX07e41bca internal constructor(
    ...
    public val inlineV1IssuingTokensGetParameterAnyOf1X63f77a2c:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1IssuingTokensGetParameterAnyOf1X63f77a2c) {
                json
                    .decodeFromJsonElement<InlineV1IssuingTokensGetParameterAnyOf1X63f77a2c>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1IssuingTokensGetParameterX07e41bcaBranch>
        get() =
            buildSet {
                if (inspection.matchesInlineV1IssuingTokensGetParameterAnyOf1X63f77a2c) {
                    add(
                        InlineV1IssuingTokensGetParameterX07e41bcaBranch.InlineV1IssuingTokensGetParameterAnyOf1X63f77a2c,
                    )
                }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1IssuingTokensGetParameterX07e41bca {
            val inspection = inspectInlineV1IssuingTokensGetParameterX07e41bca(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1IssuingTokensGetParameterX07e41bcaNoMatchException(
                    "InlineV1IssuingTokensGetParameterX07e41bca matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1IssuingTokensGetParameterX07e41bca> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingTokensGetParameterX07e41bca,
        ) {
...
private fun inspectInlineV1IssuingTokensGetParameterX07e41bca(
    element: JsonElement,
): InlineV1IssuingTokensGetParameterX07e41bcaInspection {
    val matchesInlineV1IssuingTokensGetParameterAnyOf1X63f77a2c =
        element
            .isJsonDecodable<InlineV1IssuingTokensGetParameterAnyOf1X63f77a2c>()
    ...
    return InlineV1IssuingTokensGetParameterX07e41bcaInspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1IssuingTokensGetParameterAnyOf1X63f77a2c) {
                    add(
                        "InlineV1IssuingTokensGetParameterAnyOf1X63f77a2c: value does not match InlineV1IssuingTokensGetParameterAnyOf1X63f77a2c",
                    )
                }
