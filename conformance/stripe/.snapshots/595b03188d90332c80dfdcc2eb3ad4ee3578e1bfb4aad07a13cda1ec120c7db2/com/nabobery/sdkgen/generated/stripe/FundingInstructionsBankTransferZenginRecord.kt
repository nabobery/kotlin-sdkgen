...
public class FundingInstructionsBankTransferZenginRecord(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): FundingInstructionsBankTransferZenginRecord =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<FundingInstructionsBankTransferZenginRecord> {
        ...
        override fun deserialize(decoder: Decoder): FundingInstructionsBankTransferZenginRecord {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("FundingInstructionsBankTransferZenginRecord must be a JSON object")
            ...
            return FundingInstructionsBankTransferZenginRecord(
                ...
                branchName =
                    rawObject["branch_name"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: FundingInstructionsBankTransferZenginRecord,
        ) {
...
public fun fundingInstructionsBankTransferZenginRecord(
    block: FundingInstructionsBankTransferZenginRecord.Builder.() -> Unit,
): FundingInstructionsBankTransferZenginRecord = FundingInstructionsBankTransferZenginRecord.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "FundingInstructionsBankTransferZenginRecord is missing required property '" + name + "'",
            )
