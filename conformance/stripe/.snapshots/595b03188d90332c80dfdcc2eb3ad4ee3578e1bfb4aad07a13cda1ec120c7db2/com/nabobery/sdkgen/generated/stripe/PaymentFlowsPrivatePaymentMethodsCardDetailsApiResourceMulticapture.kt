...
public class PaymentFlowsPrivatePaymentMethodsCardDetailsApiResourceMulticapture(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): PaymentFlowsPrivatePaymentMethodsCardDetailsApiResourceMulticapture = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentFlowsPrivatePaymentMethodsCardDetailsApiResourceMulticapture> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "PaymentFlowsPrivatePaymentMethodsCardDetailsApiResourceMulticapture must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentFlowsPrivatePaymentMethodsCardDetailsApiResourceMulticapture,
        ) {
            val jsonEncoder =
...
public fun paymentFlowsPrivatePaymentMethodsCardDetailsApiResourceMulticapture(
    block: PaymentFlowsPrivatePaymentMethodsCardDetailsApiResourceMulticapture.Builder.() -> Unit,
): PaymentFlowsPrivatePaymentMethodsCardDetailsApiResourceMulticapture =
    PaymentFlowsPrivatePaymentMethodsCardDetailsApiResourceMulticapture.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "PaymentFlowsPrivatePaymentMethodsCardDetailsApiResourceMulticapture is missing required property '" +
                    name +
                    "'",
            )
