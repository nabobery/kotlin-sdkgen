...
public sealed class InlineV1QuotesPostRequestFormLineItemsItemDiscountsAnyOf2Xa74c9f11 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1QuotesPostRequestFormLineItemsItemDiscountsAnyOf2Xa74c9f11 =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1QuotesPostRequestFormLineItemsItemDiscountsAnyOf2Xa74c9f11> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1QuotesPostRequestFormLineItemsItemDiscountsAnyOf2Xa74c9f11",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1QuotesPostRequestFormLineItemsItemDiscountsAnyOf2Xa74c9f11 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1QuotesPostRequestFormLineItemsItemDiscountsAnyOf2Xa74c9f11,
        ) {
