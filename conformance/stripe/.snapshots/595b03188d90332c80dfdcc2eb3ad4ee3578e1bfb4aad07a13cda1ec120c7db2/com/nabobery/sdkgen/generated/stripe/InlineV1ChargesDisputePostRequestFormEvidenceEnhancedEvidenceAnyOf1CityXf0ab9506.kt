...
internal data class InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf1CityXf0ab9506Inspection(
    ...
    public val matchesInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2Xc9f38d4a: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2Xc9f38d4a,
            ).count {
                it
            }
}
...
public class InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf1CityXf0ab9506 internal constructor(
    ...
    private val inspection: InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf1CityXf0ab9506Inspection,
) {
    ...
    public val inlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2Xc9f38d4a:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2Xc9f38d4a) {
                json
                    .decodeFromJsonElement<InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2Xc9f38d4a>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf1CityXf0ab9506Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2Xc9f38d4a) {
                    add(
                        InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf1CityXf0ab9506Branch.InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2Xc9f38d4a,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf1CityXf0ab9506 {
            val inspection =
                inspectInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf1CityXf0ab9506(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf1CityXf0ab9506NoMatchException(
                    "InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf1CityXf0ab9506 matched 0 branches: " +
                        inspection.failures.joinToString("; "),
                )
            }
            return InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf1CityXf0ab9506(
                raw,
                json,
                inspection,
            )
    ...
    public object Serializer : KSerializer<InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf1CityXf0ab9506> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf1CityXf0ab9506,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf1CityXf0ab9506",
...
private fun inspectInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf1CityXf0ab9506(
    element: JsonElement,
): InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf1CityXf0ab9506Inspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2Xc9f38d4a =
        element
            .isJsonDecodable<InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2Xc9f38d4a>()
    return InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf1CityXf0ab9506Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2Xc9f38d4a) {
                    add(
                        "InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2Xc9f38d4a: value does not match InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2Xc9f38d4a",
                    )
                }
            },
    )
