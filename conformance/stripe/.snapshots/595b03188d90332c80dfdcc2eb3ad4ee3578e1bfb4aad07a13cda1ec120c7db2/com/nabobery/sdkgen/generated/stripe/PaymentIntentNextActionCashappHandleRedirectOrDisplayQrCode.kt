...
public class PaymentIntentNextActionCashappHandleRedirectOrDisplayQrCode(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentIntentNextActionCashappHandleRedirectOrDisplayQrCode =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentIntentNextActionCashappHandleRedirectOrDisplayQrCode> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "PaymentIntentNextActionCashappHandleRedirectOrDisplayQrCode must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentIntentNextActionCashappHandleRedirectOrDisplayQrCode,
        ) {
...
public fun paymentIntentNextActionCashappHandleRedirectOrDisplayQrCode(
    block: PaymentIntentNextActionCashappHandleRedirectOrDisplayQrCode.Builder.() -> Unit,
): PaymentIntentNextActionCashappHandleRedirectOrDisplayQrCode =
    PaymentIntentNextActionCashappHandleRedirectOrDisplayQrCode.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "PaymentIntentNextActionCashappHandleRedirectOrDisplayQrCode is missing required property '" + name +
                    "'",
            )
