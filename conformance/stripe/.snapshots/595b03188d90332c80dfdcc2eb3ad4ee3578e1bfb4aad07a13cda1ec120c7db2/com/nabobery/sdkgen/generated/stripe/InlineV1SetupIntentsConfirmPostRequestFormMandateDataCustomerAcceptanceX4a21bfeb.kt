...
public class InlineV1SetupIntentsConfirmPostRequestFormMandateDataCustomerAcceptanceX4a21bfeb(
    ...
    public val online: InlineV1SetupIntentsConfirmPostRequestFormMandateDataAnyOf1OnlineXfe8d164f? = null,
) {
    ...
    public object Serializer : KSerializer<InlineV1SetupIntentsConfirmPostRequestFormMandateDataCustomerAcceptanceX4a21bfeb> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SetupIntentsConfirmPostRequestFormMandateDataCustomerAcceptanceX4a21bfeb must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineV1SetupIntentsConfirmPostRequestFormMandateDataAnyOf1TypeX1b3149cd>(
                    rawObject,
                    "type",
                )
            return InlineV1SetupIntentsConfirmPostRequestFormMandateDataCustomerAcceptanceX4a21bfeb(
                ...
                online =
                    rawObject["online"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SetupIntentsConfirmPostRequestFormMandateDataAnyOf1OnlineXfe8d164f>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SetupIntentsConfirmPostRequestFormMandateDataCustomerAcceptanceX4a21bfeb,
        ) {
            val jsonEncoder =
...
public fun inlineV1SetupIntentsConfirmPostRequestFormMandateDataCustomerAcceptanceX4a21bfeb(
    block: InlineV1SetupIntentsConfirmPostRequestFormMandateDataCustomerAcceptanceX4a21bfeb.Builder.() -> Unit,
): InlineV1SetupIntentsConfirmPostRequestFormMandateDataCustomerAcceptanceX4a21bfeb =
    InlineV1SetupIntentsConfirmPostRequestFormMandateDataCustomerAcceptanceX4a21bfeb.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1SetupIntentsConfirmPostRequestFormMandateDataCustomerAcceptanceX4a21bfeb is missing required property '" +
                    name +
                    "'",
            )
