...
public class SetupAttemptPaymentMethodDetailsPix(
    ...
    public class Builder {
        ...
        public fun build(): SetupAttemptPaymentMethodDetailsPix =
            SetupAttemptPaymentMethodDetailsPix(
                fingerprint = fingerprint,
            )
    }

    public companion object {
        public fun build(block: Builder.() -> Unit): SetupAttemptPaymentMethodDetailsPix =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<SetupAttemptPaymentMethodDetailsPix> {
        ...
        override fun deserialize(decoder: Decoder): SetupAttemptPaymentMethodDetailsPix {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("SetupAttemptPaymentMethodDetailsPix must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: SetupAttemptPaymentMethodDetailsPix,
        ) {
...
public fun setupAttemptPaymentMethodDetailsPix(
    block: SetupAttemptPaymentMethodDetailsPix.Builder.() -> Unit,
): SetupAttemptPaymentMethodDetailsPix = SetupAttemptPaymentMethodDetailsPix.build(block)
