...
public sealed class InlineIssuingSettlementNetworkXcdee1767 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineIssuingSettlementNetworkXcdee1767 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineIssuingSettlementNetworkXcdee1767> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineIssuingSettlementNetworkXcdee1767",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineIssuingSettlementNetworkXcdee1767 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineIssuingSettlementNetworkXcdee1767,
        ) {
