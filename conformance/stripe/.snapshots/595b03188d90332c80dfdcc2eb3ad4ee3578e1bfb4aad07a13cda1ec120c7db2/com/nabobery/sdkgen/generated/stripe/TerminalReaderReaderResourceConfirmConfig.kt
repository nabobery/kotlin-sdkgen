...
public class TerminalReaderReaderResourceConfirmConfig(
    ...
    public class Builder {
        ...
        public fun build(): TerminalReaderReaderResourceConfirmConfig =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): TerminalReaderReaderResourceConfirmConfig =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<TerminalReaderReaderResourceConfirmConfig> {
        ...
        override fun deserialize(decoder: Decoder): TerminalReaderReaderResourceConfirmConfig {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("TerminalReaderReaderResourceConfirmConfig must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: TerminalReaderReaderResourceConfirmConfig,
        ) {
...
public fun terminalReaderReaderResourceConfirmConfig(
    block: TerminalReaderReaderResourceConfirmConfig.Builder.() -> Unit,
): TerminalReaderReaderResourceConfirmConfig = TerminalReaderReaderResourceConfirmConfig.build(block)
