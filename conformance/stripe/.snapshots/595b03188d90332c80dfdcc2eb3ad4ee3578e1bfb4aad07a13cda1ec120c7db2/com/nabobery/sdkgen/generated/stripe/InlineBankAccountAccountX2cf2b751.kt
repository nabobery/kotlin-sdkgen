...
public class InlineBankAccountAccountX2cf2b751 internal constructor(
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineBankAccountAccountX2cf2b751 {
            val inspection = inspectInlineBankAccountAccountX2cf2b751(raw)
            if (inspection.matchCount == 0) {
                throw InlineBankAccountAccountX2cf2b751NoMatchException(
                    "InlineBankAccountAccountX2cf2b751 matched 0 branches: " + inspection.failures.joinToString("; "),
                )
            }
    ...
    public object Serializer : KSerializer<InlineBankAccountAccountX2cf2b751> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineBankAccountAccountX2cf2b751,
        ) {
...
private fun inspectInlineBankAccountAccountX2cf2b751(
    element: JsonElement,
): InlineBankAccountAccountX2cf2b751Inspection {
