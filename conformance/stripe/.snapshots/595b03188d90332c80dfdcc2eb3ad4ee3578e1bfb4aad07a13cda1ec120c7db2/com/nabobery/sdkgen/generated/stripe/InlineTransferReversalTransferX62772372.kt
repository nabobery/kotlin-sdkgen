...
public class InlineTransferReversalTransferX62772372 internal constructor(
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineTransferReversalTransferX62772372 {
            val inspection = inspectInlineTransferReversalTransferX62772372(raw)
            if (inspection.matchCount == 0) {
                throw InlineTransferReversalTransferX62772372NoMatchException(
                    "InlineTransferReversalTransferX62772372 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineTransferReversalTransferX62772372> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineTransferReversalTransferX62772372,
        ) {
...
private fun inspectInlineTransferReversalTransferX62772372(
    element: JsonElement,
): InlineTransferReversalTransferX62772372Inspection {
