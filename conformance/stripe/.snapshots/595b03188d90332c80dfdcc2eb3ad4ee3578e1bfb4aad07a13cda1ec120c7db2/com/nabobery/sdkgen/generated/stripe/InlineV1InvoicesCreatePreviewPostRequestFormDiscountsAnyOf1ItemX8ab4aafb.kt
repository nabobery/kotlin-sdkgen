...
public class InlineV1InvoicesCreatePreviewPostRequestFormDiscountsAnyOf1ItemX8ab4aafb(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1InvoicesCreatePreviewPostRequestFormDiscountsAnyOf1ItemX8ab4aafb =
            InlineV1InvoicesCreatePreviewPostRequestFormDiscountsAnyOf1ItemX8ab4aafb(
                coupon = coupon,
                discount = discount,
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1InvoicesCreatePreviewPostRequestFormDiscountsAnyOf1ItemX8ab4aafb = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1InvoicesCreatePreviewPostRequestFormDiscountsAnyOf1ItemX8ab4aafb> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1InvoicesCreatePreviewPostRequestFormDiscountsAnyOf1ItemX8ab4aafb must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesCreatePreviewPostRequestFormDiscountsAnyOf1ItemX8ab4aafb,
        ) {
            val jsonEncoder =
...
public fun inlineV1InvoicesCreatePreviewPostRequestFormDiscountsAnyOf1ItemX8ab4aafb(
    block: InlineV1InvoicesCreatePreviewPostRequestFormDiscountsAnyOf1ItemX8ab4aafb.Builder.() -> Unit,
): InlineV1InvoicesCreatePreviewPostRequestFormDiscountsAnyOf1ItemX8ab4aafb =
    InlineV1InvoicesCreatePreviewPostRequestFormDiscountsAnyOf1ItemX8ab4aafb.build(block)
