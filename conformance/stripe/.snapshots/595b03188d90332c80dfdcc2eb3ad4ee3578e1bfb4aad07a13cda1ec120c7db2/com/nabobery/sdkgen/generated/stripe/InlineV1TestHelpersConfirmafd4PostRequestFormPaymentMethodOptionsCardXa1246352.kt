...
public class InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodOptionsCardXa1246352(
    public val installments: InlineV1TestHelpersConfirmafd4PostRequestFormInstallmentsX5de87e58? = null,
) {
    public class Builder {
        public var installments: InlineV1TestHelpersConfirmafd4PostRequestFormInstallmentsX5de87e58? =
            null

        public fun build(): InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodOptionsCardXa1246352 =
            InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodOptionsCardXa1246352(
    ...
    public object Serializer : KSerializer<InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodOptionsCardXa1246352> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodOptionsCardXa1246352 must be a JSON object",
                    )
            return InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodOptionsCardXa1246352(
                installments =
                    rawObject["installments"]?.let {
                        json.decodeFromJsonElement<InlineV1TestHelpersConfirmafd4PostRequestFormInstallmentsX5de87e58>(
                            it,
                        )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodOptionsCardXa1246352,
        ) {
            val jsonEncoder =
...
public fun inlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodOptionsCardXa1246352(
    block: InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodOptionsCardXa1246352.Builder.() -> Unit,
): InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodOptionsCardXa1246352 =
