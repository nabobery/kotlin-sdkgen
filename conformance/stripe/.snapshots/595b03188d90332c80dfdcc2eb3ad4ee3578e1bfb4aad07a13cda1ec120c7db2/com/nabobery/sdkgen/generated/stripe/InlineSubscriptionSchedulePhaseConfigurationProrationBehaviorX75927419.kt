...
public sealed class InlineSubscriptionSchedulePhaseConfigurationProrationBehaviorX75927419 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineSubscriptionSchedulePhaseConfigurationProrationBehaviorX75927419 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineSubscriptionSchedulePhaseConfigurationProrationBehaviorX75927419> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineSubscriptionSchedulePhaseConfigurationProrationBehaviorX75927419",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineSubscriptionSchedulePhaseConfigurationProrationBehaviorX75927419 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineSubscriptionSchedulePhaseConfigurationProrationBehaviorX75927419,
        ) {
