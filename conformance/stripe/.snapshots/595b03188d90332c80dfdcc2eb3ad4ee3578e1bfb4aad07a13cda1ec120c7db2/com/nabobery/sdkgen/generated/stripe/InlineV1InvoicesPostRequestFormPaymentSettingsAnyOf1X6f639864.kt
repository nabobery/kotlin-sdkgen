...
public class InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X6f639864(
    public val financialConnections: InlineV1InvoicesPostRequestFormPaymentSettingsFinancialConnectionsXf3d30f7e? = null,
    public val verificationMethod: InlineV1InvoicesPostRequestFormPaymentSettingsVerificationMethodX82a41510? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X6f639864 =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X6f639864 =
    ...
    public object Serializer : KSerializer<InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X6f639864> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X6f639864 must be a JSON object",
                    )
            return InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X6f639864(
                financialConnections =
                    rawObject["financial_connections"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1InvoicesPostRequestFormPaymentSettingsFinancialConnectionsXf3d30f7e>(
                                it,
                            )
                    },
                verificationMethod =
                    rawObject["verification_method"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1InvoicesPostRequestFormPaymentSettingsVerificationMethodX82a41510>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X6f639864,
        ) {
            val jsonEncoder =
...
public fun inlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X6f639864(
    block: InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X6f639864.Builder.() -> Unit,
): InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X6f639864 =
    InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X6f639864.build(block)
