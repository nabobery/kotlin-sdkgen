...
public sealed class InlineV1PayoutsPostRequestFormMethodXb57a053f {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1PayoutsPostRequestFormMethodXb57a053f =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1PayoutsPostRequestFormMethodXb57a053f> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1PayoutsPostRequestFormMethodXb57a053f",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1PayoutsPostRequestFormMethodXb57a053f =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PayoutsPostRequestFormMethodXb57a053f,
        ) {
