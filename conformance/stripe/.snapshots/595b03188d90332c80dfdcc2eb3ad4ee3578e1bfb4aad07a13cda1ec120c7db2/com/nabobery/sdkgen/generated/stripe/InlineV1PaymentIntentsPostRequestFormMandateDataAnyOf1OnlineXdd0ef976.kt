...
public class InlineV1PaymentIntentsPostRequestFormMandateDataAnyOf1OnlineXdd0ef976(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentIntentsPostRequestFormMandateDataAnyOf1OnlineXdd0ef976 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormMandateDataAnyOf1OnlineXdd0ef976> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsPostRequestFormMandateDataAnyOf1OnlineXdd0ef976 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormMandateDataAnyOf1OnlineXdd0ef976,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentIntentsPostRequestFormMandateDataAnyOf1OnlineXdd0ef976(
    block: InlineV1PaymentIntentsPostRequestFormMandateDataAnyOf1OnlineXdd0ef976.Builder.() -> Unit,
): InlineV1PaymentIntentsPostRequestFormMandateDataAnyOf1OnlineXdd0ef976 =
    InlineV1PaymentIntentsPostRequestFormMandateDataAnyOf1OnlineXdd0ef976.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentIntentsPostRequestFormMandateDataAnyOf1OnlineXdd0ef976 is missing required property '" +
                    name +
                    "'",
            )
