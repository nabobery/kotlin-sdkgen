...
public class PaymentMethodDetailsPaymentRecordSunbit(
    ...
    public class Builder {
        ...
        public fun build(): PaymentMethodDetailsPaymentRecordSunbit =
            PaymentMethodDetailsPaymentRecordSunbit(
                transactionId = transactionId,
            )
    }

    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentMethodDetailsPaymentRecordSunbit =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentMethodDetailsPaymentRecordSunbit> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodDetailsPaymentRecordSunbit {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodDetailsPaymentRecordSunbit must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentMethodDetailsPaymentRecordSunbit,
        ) {
...
public fun paymentMethodDetailsPaymentRecordSunbit(
    block: PaymentMethodDetailsPaymentRecordSunbit.Builder.() -> Unit,
): PaymentMethodDetailsPaymentRecordSunbit = PaymentMethodDetailsPaymentRecordSunbit.build(block)
