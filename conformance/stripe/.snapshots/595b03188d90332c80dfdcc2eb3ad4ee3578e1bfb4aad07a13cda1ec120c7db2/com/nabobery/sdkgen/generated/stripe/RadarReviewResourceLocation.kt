...
public class RadarReviewResourceLocation(
    ...
    public class Builder {
        ...
        public fun build(): RadarReviewResourceLocation =
    ...
    public object Serializer : KSerializer<RadarReviewResourceLocation> {
        ...
        override fun deserialize(decoder: Decoder): RadarReviewResourceLocation {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("RadarReviewResourceLocation must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: RadarReviewResourceLocation,
        ) {
...
public fun radarReviewResourceLocation(
    block: RadarReviewResourceLocation.Builder.() -> Unit,
): RadarReviewResourceLocation = RadarReviewResourceLocation.build(block)
