...
public class PersonRelationship(
    ...
    public class Builder {
        ...
        public fun build(): PersonRelationship =
            PersonRelationship(
    ...
    public object Serializer : KSerializer<PersonRelationship> {
        ...
        override fun deserialize(decoder: Decoder): PersonRelationship {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PersonRelationship must be a JSON object")
            return PersonRelationship(
                authorizer =
                    rawObject["authorizer"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                director =
                    rawObject["director"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                executive =
                    rawObject["executive"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                legalGuardian =
                    rawObject["legal_guardian"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                percentOwnership =
                    rawObject["percent_ownership"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                representative =
                    rawObject["representative"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
...
public fun personRelationship(block: PersonRelationship.Builder.() -> Unit): PersonRelationship =
    PersonRelationship.build(block)
