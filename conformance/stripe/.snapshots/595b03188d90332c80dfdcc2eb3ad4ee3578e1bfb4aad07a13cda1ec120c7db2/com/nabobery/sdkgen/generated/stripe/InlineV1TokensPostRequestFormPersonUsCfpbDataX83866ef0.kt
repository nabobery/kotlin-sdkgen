...
public class InlineV1TokensPostRequestFormPersonUsCfpbDataX83866ef0(
    public val ethnicityDetails: InlineV1TokensPostRequestFormPersonUsCfpbDataEthnicityDetailsXbe594f75? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1TokensPostRequestFormPersonUsCfpbDataX83866ef0 =
            InlineV1TokensPostRequestFormPersonUsCfpbDataX83866ef0(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TokensPostRequestFormPersonUsCfpbDataX83866ef0 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TokensPostRequestFormPersonUsCfpbDataX83866ef0> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TokensPostRequestFormPersonUsCfpbDataX83866ef0 must be a JSON object",
                    )
            return InlineV1TokensPostRequestFormPersonUsCfpbDataX83866ef0(
                ethnicityDetails =
                    rawObject["ethnicity_details"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TokensPostRequestFormPersonUsCfpbDataEthnicityDetailsXbe594f75>(
                                it,
                            )
                    },
                raceDetails =
                    rawObject["race_details"]?.let {
                        json.decodeFromJsonElement<InlineV1TokensPostRequestFormPersonUsCfpbDataRaceDetailsXbb944d69>(
                            it,
                        )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TokensPostRequestFormPersonUsCfpbDataX83866ef0,
        ) {
...
public fun inlineV1TokensPostRequestFormPersonUsCfpbDataX83866ef0(
    block: InlineV1TokensPostRequestFormPersonUsCfpbDataX83866ef0.Builder.() -> Unit,
): InlineV1TokensPostRequestFormPersonUsCfpbDataX83866ef0 =
    InlineV1TokensPostRequestFormPersonUsCfpbDataX83866ef0.build(block)
