...
public class InlineV1CustomersSubscriptionsPostRequestFormAddInvoiceItemsItemPeriodXfec0f0bf(
    ...
    public object Serializer : KSerializer<InlineV1CustomersSubscriptionsPostRequestFormAddInvoiceItemsItemPeriodXfec0f0bf> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CustomersSubscriptionsPostRequestFormAddInvoiceItemsItemPeriodXfec0f0bf must be a JSON object",
                    )
            val end =
                json.decodeRequired<InlineV1CustomersSubscriptionsPostRequestFormAddInvoiceItemsItemEndX71518250>(
                    rawObject,
                    "end",
                )
            val start =
                json.decodeRequired<InlineV1CustomersSubscriptionsPostRequestFormAddInvoiceItemsItemStartXd78f9b90>(
                    rawObject,
                    "start",
                )
            return InlineV1CustomersSubscriptionsPostRequestFormAddInvoiceItemsItemPeriodXfec0f0bf(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersSubscriptionsPostRequestFormAddInvoiceItemsItemPeriodXfec0f0bf,
        ) {
            val jsonEncoder =
...
public fun inlineV1CustomersSubscriptionsPostRequestFormAddInvoiceItemsItemPeriodXfec0f0bf(
    block: InlineV1CustomersSubscriptionsPostRequestFormAddInvoiceItemsItemPeriodXfec0f0bf.Builder.() -> Unit,
): InlineV1CustomersSubscriptionsPostRequestFormAddInvoiceItemsItemPeriodXfec0f0bf =
    InlineV1CustomersSubscriptionsPostRequestFormAddInvoiceItemsItemPeriodXfec0f0bf.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1CustomersSubscriptionsPostRequestFormAddInvoiceItemsItemPeriodXfec0f0bf is missing required property '" +
                    name +
                    "'",
            )
