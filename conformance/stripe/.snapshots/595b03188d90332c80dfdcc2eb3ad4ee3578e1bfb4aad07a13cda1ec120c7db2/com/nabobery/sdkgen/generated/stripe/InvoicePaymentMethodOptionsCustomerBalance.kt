...
public data class InvoicePaymentMethodOptionsCustomerBalanceView(
    ...
    public val fundingType: InlineInvoicePaymentMethodOptionsCustomerBalanceFundingTypeX0b3f7b61? = null,
)
...
public class InvoicePaymentMethodOptionsCustomerBalance(
    ...
    public class Builder {
        ...
        public fun build(): InvoicePaymentMethodOptionsCustomerBalance =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InvoicePaymentMethodOptionsCustomerBalance =
    ...
    public object Serializer : KSerializer<InvoicePaymentMethodOptionsCustomerBalance> {
        ...
        override fun deserialize(decoder: Decoder): InvoicePaymentMethodOptionsCustomerBalance {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("InvoicePaymentMethodOptionsCustomerBalance must be a JSON object")
            return InvoicePaymentMethodOptionsCustomerBalance(
                bankTransfer =
                    rawObject["bank_transfer"]?.let {
                        json.decodeFromJsonElement<InvoicePaymentMethodOptionsCustomerBalanceBankTransfer>(it)
                    },
                fundingType =
                    rawObject["funding_type"]?.let { element ->
                        if (element ==
                            ...
                            json
                                .decodeFromJsonElement<InlineInvoicePaymentMethodOptionsCustomerBalanceFundingTypeX0b3f7b61?>(
                                    element,
                                )
                        }
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InvoicePaymentMethodOptionsCustomerBalance,
        ) {
...
public fun invoicePaymentMethodOptionsCustomerBalance(
    block: InvoicePaymentMethodOptionsCustomerBalance.Builder.() -> Unit,
): InvoicePaymentMethodOptionsCustomerBalance = InvoicePaymentMethodOptionsCustomerBalance.build(block)
