...
public class InlineAccountInvoicesSettingsDefaultAccountTaxIdsItemX7a5634e4 internal constructor(
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineAccountInvoicesSettingsDefaultAccountTaxIdsItemX7a5634e4Branch.Branch1,
                    )
                }
                if (inspection.matchesTaxId) {
                    add(
                        InlineAccountInvoicesSettingsDefaultAccountTaxIdsItemX7a5634e4Branch.TaxId,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineAccountInvoicesSettingsDefaultAccountTaxIdsItemX7a5634e4 {
            val inspection = inspectInlineAccountInvoicesSettingsDefaultAccountTaxIdsItemX7a5634e4(raw)
            if (inspection.matchCount == 0) {
                throw InlineAccountInvoicesSettingsDefaultAccountTaxIdsItemX7a5634e4NoMatchException(
                    "InlineAccountInvoicesSettingsDefaultAccountTaxIdsItemX7a5634e4 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineAccountInvoicesSettingsDefaultAccountTaxIdsItemX7a5634e4> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineAccountInvoicesSettingsDefaultAccountTaxIdsItemX7a5634e4,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineAccountInvoicesSettingsDefaultAccountTaxIdsItemX7a5634e4",
...
private fun inspectInlineAccountInvoicesSettingsDefaultAccountTaxIdsItemX7a5634e4(
    element: JsonElement,
): InlineAccountInvoicesSettingsDefaultAccountTaxIdsItemX7a5634e4Inspection {
