...
public sealed class InlineInvoiceMandateOptionsPaytoPurposeX001732ff {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineInvoiceMandateOptionsPaytoPurposeX001732ff =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineInvoiceMandateOptionsPaytoPurposeX001732ff> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineInvoiceMandateOptionsPaytoPurposeX001732ff",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineInvoiceMandateOptionsPaytoPurposeX001732ff =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineInvoiceMandateOptionsPaytoPurposeX001732ff,
        ) {
