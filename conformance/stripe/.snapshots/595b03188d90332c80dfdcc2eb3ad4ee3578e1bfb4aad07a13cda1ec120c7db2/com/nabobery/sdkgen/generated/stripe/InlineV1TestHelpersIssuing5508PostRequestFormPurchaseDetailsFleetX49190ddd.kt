...
public class InlineV1TestHelpersIssuing5508PostRequestFormPurchaseDetailsFleetX49190ddd(
    public val cardholderPromptData: InlineV1TestHelpersIssuing5508PostRequestFormCardholderPromptDataX3259a2f1? = null,
    public val purchaseType: InlineV1TestHelpersIssuing5508PostRequestFormPurchaseTypeXc3447d89? = null,
    public val reportedBreakdown: InlineV1TestHelpersIssuing5508PostRequestFormReportedBreakdownX73c3181c? = null,
    public val serviceType: InlineV1TestHelpersIssuing5508PostRequestFormPurchaseDetailsServiceTypeXd3ee0df3? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1TestHelpersIssuing5508PostRequestFormPurchaseDetailsFleetX49190ddd =
            InlineV1TestHelpersIssuing5508PostRequestFormPurchaseDetailsFleetX49190ddd(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1TestHelpersIssuing5508PostRequestFormPurchaseDetailsFleetX49190ddd = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1TestHelpersIssuing5508PostRequestFormPurchaseDetailsFleetX49190ddd> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TestHelpersIssuing5508PostRequestFormPurchaseDetailsFleetX49190ddd must be a JSON object",
                    )
            return InlineV1TestHelpersIssuing5508PostRequestFormPurchaseDetailsFleetX49190ddd(
                cardholderPromptData =
                    rawObject["cardholder_prompt_data"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TestHelpersIssuing5508PostRequestFormCardholderPromptDataX3259a2f1>(
                                it,
                            )
                    },
                purchaseType =
                    rawObject["purchase_type"]?.let {
                        json.decodeFromJsonElement<InlineV1TestHelpersIssuing5508PostRequestFormPurchaseTypeXc3447d89>(
                            it,
                        )
                    },
                reportedBreakdown =
                    rawObject["reported_breakdown"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TestHelpersIssuing5508PostRequestFormReportedBreakdownX73c3181c>(
                                it,
                            )
                    },
                serviceType =
                    rawObject["service_type"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TestHelpersIssuing5508PostRequestFormPurchaseDetailsServiceTypeXd3ee0df3>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TestHelpersIssuing5508PostRequestFormPurchaseDetailsFleetX49190ddd,
        ) {
            val jsonEncoder =
...
public fun inlineV1TestHelpersIssuing5508PostRequestFormPurchaseDetailsFleetX49190ddd(
    block: InlineV1TestHelpersIssuing5508PostRequestFormPurchaseDetailsFleetX49190ddd.Builder.() -> Unit,
): InlineV1TestHelpersIssuing5508PostRequestFormPurchaseDetailsFleetX49190ddd =
    InlineV1TestHelpersIssuing5508PostRequestFormPurchaseDetailsFleetX49190ddd.build(block)
