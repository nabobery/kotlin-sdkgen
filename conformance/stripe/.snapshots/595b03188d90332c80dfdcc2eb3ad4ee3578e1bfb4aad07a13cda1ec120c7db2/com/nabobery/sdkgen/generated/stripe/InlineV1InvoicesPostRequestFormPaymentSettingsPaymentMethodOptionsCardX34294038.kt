...
internal data class InlineV1InvoicesPostRequestFormPaymentSettingsPaymentMethodOptionsCardX34294038Inspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X105a391b,
                matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2X6de4877a,
            ).count {
                it
            }
}
...
public class InlineV1InvoicesPostRequestFormPaymentSettingsPaymentMethodOptionsCardX34294038 internal constructor(
    ...
    private val inspection: InlineV1InvoicesPostRequestFormPaymentSettingsPaymentMethodOptionsCardX34294038Inspection,
) {
    public val inlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X105a391b:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X105a391b) {
                json
                    .decodeFromJsonElement<InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X105a391b>(
                        raw,
                    )
            } else {
                null
    ...
    public val inlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2X6de4877a:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2X6de4877a) {
                json
                    .decodeFromJsonElement<InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2X6de4877a>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches:
        ...
        get() =
            buildSet {
                if (inspection.matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X105a391b) {
                    add(
                        InlineV1InvoicesPostRequestFormPaymentSettingsPaymentMethodOptionsCardX34294038Branch.InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X105a391b,
                    )
                }
                if (inspection.matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2X6de4877a) {
                    add(
                        InlineV1InvoicesPostRequestFormPaymentSettingsPaymentMethodOptionsCardX34294038Branch.InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2X6de4877a,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1InvoicesPostRequestFormPaymentSettingsPaymentMethodOptionsCardX34294038 {
            val inspection = inspectInlineV1InvoicesPostRequestFormPaymentSettingsPaymentMethodOptionsCardX34294038(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1InvoicesPostRequestFormPaymentSettingsPaymentMethodOptionsCardX34294038NoMatchException(
                    "InlineV1InvoicesPostRequestFormPaymentSettingsPaymentMethodOptionsCardX34294038 matched 0 branches: " +
                        inspection.failures.joinToString("; "),
                )
            }
            return InlineV1InvoicesPostRequestFormPaymentSettingsPaymentMethodOptionsCardX34294038(
                raw,
                json,
                inspection,
            )
    ...
    public object Serializer : KSerializer<InlineV1InvoicesPostRequestFormPaymentSettingsPaymentMethodOptionsCardX34294038> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesPostRequestFormPaymentSettingsPaymentMethodOptionsCardX34294038,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1InvoicesPostRequestFormPaymentSettingsPaymentMethodOptionsCardX34294038",
...
private fun inspectInlineV1InvoicesPostRequestFormPaymentSettingsPaymentMethodOptionsCardX34294038(
    element: JsonElement,
): InlineV1InvoicesPostRequestFormPaymentSettingsPaymentMethodOptionsCardX34294038Inspection {
    val matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X105a391b =
        element
            .isJsonDecodable<InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X105a391b>()
    val matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2X6de4877a =
        element
            .isJsonDecodable<InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2X6de4877a>()
    return InlineV1InvoicesPostRequestFormPaymentSettingsPaymentMethodOptionsCardX34294038Inspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X105a391b) {
                    add(
                        "InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X105a391b: value does not match InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X105a391b",
                    )
                }
                if (!matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2X6de4877a) {
                    add(
                        "InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2X6de4877a: value does not match InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2X6de4877a",
                    )
                }
            },
    )
