...
internal data class InlineV1SubscriptionsPostRequestFormOnBehalfOfX2ca3924dInspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1SubscriptionsPostRequestFormOnBehalfOfAnyOf2Xf08833b6,
            ).count { it }
}
...
public class InlineV1SubscriptionsPostRequestFormOnBehalfOfX2ca3924d internal constructor(
    ...
    public val inlineV1SubscriptionsPostRequestFormOnBehalfOfAnyOf2Xf08833b6:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1SubscriptionsPostRequestFormOnBehalfOfAnyOf2Xf08833b6) {
                json
                    .decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormOnBehalfOfAnyOf2Xf08833b6>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1SubscriptionsPostRequestFormOnBehalfOfX2ca3924dBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1SubscriptionsPostRequestFormOnBehalfOfAnyOf2Xf08833b6) {
                    add(
                        InlineV1SubscriptionsPostRequestFormOnBehalfOfX2ca3924dBranch.InlineV1SubscriptionsPostRequestFormOnBehalfOfAnyOf2Xf08833b6,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1SubscriptionsPostRequestFormOnBehalfOfX2ca3924d {
            val inspection = inspectInlineV1SubscriptionsPostRequestFormOnBehalfOfX2ca3924d(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1SubscriptionsPostRequestFormOnBehalfOfX2ca3924dNoMatchException(
                    "InlineV1SubscriptionsPostRequestFormOnBehalfOfX2ca3924d matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionsPostRequestFormOnBehalfOfX2ca3924d> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsPostRequestFormOnBehalfOfX2ca3924d,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1SubscriptionsPostRequestFormOnBehalfOfX2ca3924d",
...
private fun inspectInlineV1SubscriptionsPostRequestFormOnBehalfOfX2ca3924d(
    element: JsonElement,
): InlineV1SubscriptionsPostRequestFormOnBehalfOfX2ca3924dInspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1SubscriptionsPostRequestFormOnBehalfOfAnyOf2Xf08833b6 =
        element
            .isJsonDecodable<InlineV1SubscriptionsPostRequestFormOnBehalfOfAnyOf2Xf08833b6>()
    return InlineV1SubscriptionsPostRequestFormOnBehalfOfX2ca3924dInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1SubscriptionsPostRequestFormOnBehalfOfAnyOf2Xf08833b6) {
                    add(
                        "InlineV1SubscriptionsPostRequestFormOnBehalfOfAnyOf2Xf08833b6: value does not match InlineV1SubscriptionsPostRequestFormOnBehalfOfAnyOf2Xf08833b6",
                    )
                }
            },
    )
