...
public class InlineV1PaymentIntentsConfirmPostRequestFormNzBankAccountX4d30acf2(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentIntentsConfirmPostRequestFormNzBankAccountX4d30acf2 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsConfirmPostRequestFormNzBankAccountX4d30acf2> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1PaymentIntentsConfirmPostRequestFormNzBankAccountX4d30acf2 {
            val jsonDecoder =
                decoder.requireJsonDecoder(
                    "InlineV1PaymentIntentsConfirmPostRequestFormNzBankAccountX4d30acf2",
                )
            val json = jsonDecoder.json
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsConfirmPostRequestFormNzBankAccountX4d30acf2 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsConfirmPostRequestFormNzBankAccountX4d30acf2,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentIntentsConfirmPostRequestFormNzBankAccountX4d30acf2(
    block: InlineV1PaymentIntentsConfirmPostRequestFormNzBankAccountX4d30acf2.Builder.() -> Unit,
): InlineV1PaymentIntentsConfirmPostRequestFormNzBankAccountX4d30acf2 =
    InlineV1PaymentIntentsConfirmPostRequestFormNzBankAccountX4d30acf2.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentIntentsConfirmPostRequestFormNzBankAccountX4d30acf2 is missing required property '" +
                    name +
                    "'",
            )
