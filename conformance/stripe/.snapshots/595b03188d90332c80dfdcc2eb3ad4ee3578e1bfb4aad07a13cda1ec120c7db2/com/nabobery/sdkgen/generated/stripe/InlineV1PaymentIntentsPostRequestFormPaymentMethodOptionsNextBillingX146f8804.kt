...
public class InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsNextBillingX146f8804(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsNextBillingX146f8804 =
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsNextBillingX146f8804> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsNextBillingX146f8804 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsNextBillingX146f8804,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsNextBillingX146f8804(
    block: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsNextBillingX146f8804.Builder.() -> Unit,
): InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsNextBillingX146f8804 =
    InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsNextBillingX146f8804.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsNextBillingX146f8804 is missing required property '" +
                    name +
                    "'",
            )
