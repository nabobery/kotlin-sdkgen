...
internal data class InlineV1CustomersBankAccountsPostRequestFormCardX6337a169Inspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesInlineV1CustomersBankAccountsPostRequestFormCardAnyOf1Xf394703a,
                matchesBranch2,
            ).count { it }
}
...
public class InlineV1CustomersBankAccountsPostRequestFormCardX6337a169 internal constructor(
    ...
    public val inlineV1CustomersBankAccountsPostRequestFormCardAnyOf1Xf394703a:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1CustomersBankAccountsPostRequestFormCardAnyOf1Xf394703a) {
                json
                    .decodeFromJsonElement<InlineV1CustomersBankAccountsPostRequestFormCardAnyOf1Xf394703a>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1CustomersBankAccountsPostRequestFormCardX6337a169Branch>
        get() =
            buildSet {
                if (inspection.matchesInlineV1CustomersBankAccountsPostRequestFormCardAnyOf1Xf394703a) {
                    add(
                        InlineV1CustomersBankAccountsPostRequestFormCardX6337a169Branch.InlineV1CustomersBankAccountsPostRequestFormCardAnyOf1Xf394703a,
                    )
                }
                if (inspection.matchesBranch2) {
                    add(
                        InlineV1CustomersBankAccountsPostRequestFormCardX6337a169Branch.Branch2,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1CustomersBankAccountsPostRequestFormCardX6337a169 {
            val inspection = inspectInlineV1CustomersBankAccountsPostRequestFormCardX6337a169(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1CustomersBankAccountsPostRequestFormCardX6337a169NoMatchException(
                    "InlineV1CustomersBankAccountsPostRequestFormCardX6337a169 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1CustomersBankAccountsPostRequestFormCardX6337a169> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersBankAccountsPostRequestFormCardX6337a169,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1CustomersBankAccountsPostRequestFormCardX6337a169",
...
private fun inspectInlineV1CustomersBankAccountsPostRequestFormCardX6337a169(
    element: JsonElement,
): InlineV1CustomersBankAccountsPostRequestFormCardX6337a169Inspection {
    val matchesInlineV1CustomersBankAccountsPostRequestFormCardAnyOf1Xf394703a =
        element
            .isJsonDecodable<InlineV1CustomersBankAccountsPostRequestFormCardAnyOf1Xf394703a>()
    ...
    return InlineV1CustomersBankAccountsPostRequestFormCardX6337a169Inspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1CustomersBankAccountsPostRequestFormCardAnyOf1Xf394703a) {
                    add(
                        "InlineV1CustomersBankAccountsPostRequestFormCardAnyOf1Xf394703a: value does not match InlineV1CustomersBankAccountsPostRequestFormCardAnyOf1Xf394703a",
                    )
                }
