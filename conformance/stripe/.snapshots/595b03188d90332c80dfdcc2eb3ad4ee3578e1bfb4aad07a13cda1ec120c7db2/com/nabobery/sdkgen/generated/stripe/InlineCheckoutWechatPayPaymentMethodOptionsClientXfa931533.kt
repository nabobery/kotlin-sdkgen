...
public sealed class InlineCheckoutWechatPayPaymentMethodOptionsClientXfa931533 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineCheckoutWechatPayPaymentMethodOptionsClientXfa931533 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineCheckoutWechatPayPaymentMethodOptionsClientXfa931533> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineCheckoutWechatPayPaymentMethodOptionsClientXfa931533",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineCheckoutWechatPayPaymentMethodOptionsClientXfa931533 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineCheckoutWechatPayPaymentMethodOptionsClientXfa931533,
        ) {
