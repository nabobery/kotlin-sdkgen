...
public class InlineV1PaymentIntentsPostRequestFormHooksX33240745(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1PaymentIntentsPostRequestFormHooksX33240745 =
            InlineV1PaymentIntentsPostRequestFormHooksX33240745(
                inputs = inputs,
            )
    }

    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PaymentIntentsPostRequestFormHooksX33240745 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormHooksX33240745> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsPostRequestFormHooksX33240745 must be a JSON object",
                    )
            return InlineV1PaymentIntentsPostRequestFormHooksX33240745(
                inputs =
                    rawObject["inputs"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormHooksInputsX1741d973>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormHooksX33240745,
        ) {
...
public fun inlineV1PaymentIntentsPostRequestFormHooksX33240745(
    block: InlineV1PaymentIntentsPostRequestFormHooksX33240745.Builder.() -> Unit,
): InlineV1PaymentIntentsPostRequestFormHooksX33240745 =
    InlineV1PaymentIntentsPostRequestFormHooksX33240745.build(block)
