...
public class RefundDestinationDetailsSwish(
    ...
    public class Builder {
        ...
        public fun build(): RefundDestinationDetailsSwish =
    ...
    public object Serializer : KSerializer<RefundDestinationDetailsSwish> {
        ...
        override fun deserialize(decoder: Decoder): RefundDestinationDetailsSwish {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("RefundDestinationDetailsSwish must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: RefundDestinationDetailsSwish,
        ) {
...
public fun refundDestinationDetailsSwish(
    block: RefundDestinationDetailsSwish.Builder.() -> Unit,
): RefundDestinationDetailsSwish = RefundDestinationDetailsSwish.build(block)
