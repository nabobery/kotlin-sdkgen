...
public class PaymentIntentPaymentMethodOptionsMandateOptionsSepaDebit(
    ...
    public class Builder {
        ...
        public fun build(): PaymentIntentPaymentMethodOptionsMandateOptionsSepaDebit =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentIntentPaymentMethodOptionsMandateOptionsSepaDebit =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentIntentPaymentMethodOptionsMandateOptionsSepaDebit> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "PaymentIntentPaymentMethodOptionsMandateOptionsSepaDebit must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentIntentPaymentMethodOptionsMandateOptionsSepaDebit,
        ) {
...
public fun paymentIntentPaymentMethodOptionsMandateOptionsSepaDebit(
    block: PaymentIntentPaymentMethodOptionsMandateOptionsSepaDebit.Builder.() -> Unit,
): PaymentIntentPaymentMethodOptionsMandateOptionsSepaDebit =
    PaymentIntentPaymentMethodOptionsMandateOptionsSepaDebit.build(block)
