...
public class PaymentPagesCheckoutSessionCustomText(
     ...
     */
    public val shippingAddress: InlinePaymentPagesCheckoutSessionCustomTextShippingAddressX3fca2680? = null,
    /**
    ...
    public class Builder {
        ...
        public fun build(): PaymentPagesCheckoutSessionCustomText =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentPagesCheckoutSessionCustomText =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentPagesCheckoutSessionCustomText> {
        ...
        override fun deserialize(decoder: Decoder): PaymentPagesCheckoutSessionCustomText {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentPagesCheckoutSessionCustomText must be a JSON object")
            return PaymentPagesCheckoutSessionCustomText(
                afterSubmit =
                    rawObject["after_submit"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                            ...
                            json
                                .decodeFromJsonElement<InlinePaymentPagesCheckoutSessionCustomTextAfterSubmitX3b97e56b?>(
                                    element,
                                )
                        }
                    },
                shippingAddress =
                    rawObject["shipping_address"]?.let { element ->
                        if (element ==
                            ...
                            json
                                .decodeFromJsonElement<InlinePaymentPagesCheckoutSessionCustomTextShippingAddressX3fca2680?>(
                                    element,
                                )
                        }
                    },
                submit =
                    rawObject["submit"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlinePaymentPagesCheckoutSessionCustomTextSubmitXe5018cd9?>(
                                element,
                            )
                        }
                    },
                termsOfServiceAcceptance =
                    rawObject["terms_of_service_acceptance"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                            ...
                            json
                                .decodeFromJsonElement<InlinePaymentPagesCheckoutSessionCustomTextTermsOfServiceAcceptanceXa831c417?>(
                                    element,
                                )
                        }
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentPagesCheckoutSessionCustomText,
        ) {
...
public fun paymentPagesCheckoutSessionCustomText(
    block: PaymentPagesCheckoutSessionCustomText.Builder.() -> Unit,
): PaymentPagesCheckoutSessionCustomText = PaymentPagesCheckoutSessionCustomText.build(block)
