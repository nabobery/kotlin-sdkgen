...
public class TaxProductResourceTaxBreakdown(
    ...
    public object Serializer : KSerializer<TaxProductResourceTaxBreakdown> {
        ...
        override fun deserialize(decoder: Decoder): TaxProductResourceTaxBreakdown {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("TaxProductResourceTaxBreakdown must be a JSON object")
            ...
            val taxabilityReason =
                json.decodeRequired<InlineTaxProductResourceTaxBreakdownTaxabilityReasonXa4c62c9b>(
                    rawObject,
                    "taxability_reason",
                )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: TaxProductResourceTaxBreakdown,
        ) {
...
public fun taxProductResourceTaxBreakdown(
    block: TaxProductResourceTaxBreakdown.Builder.() -> Unit,
): TaxProductResourceTaxBreakdown = TaxProductResourceTaxBreakdown.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "TaxProductResourceTaxBreakdown is missing required property '" + name + "'",
            )
