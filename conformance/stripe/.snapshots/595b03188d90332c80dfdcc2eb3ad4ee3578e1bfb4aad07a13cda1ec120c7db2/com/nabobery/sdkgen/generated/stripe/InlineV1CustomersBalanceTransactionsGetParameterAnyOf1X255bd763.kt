...
public class InlineV1CustomersBalanceTransactionsGetParameterAnyOf1X255bd763(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1CustomersBalanceTransactionsGetParameterAnyOf1X255bd763 =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1CustomersBalanceTransactionsGetParameterAnyOf1X255bd763 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1CustomersBalanceTransactionsGetParameterAnyOf1X255bd763> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CustomersBalanceTransactionsGetParameterAnyOf1X255bd763 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersBalanceTransactionsGetParameterAnyOf1X255bd763,
        ) {
            val jsonEncoder =
...
public fun inlineV1CustomersBalanceTransactionsGetParameterAnyOf1X255bd763(
    block: InlineV1CustomersBalanceTransactionsGetParameterAnyOf1X255bd763.Builder.() -> Unit,
): InlineV1CustomersBalanceTransactionsGetParameterAnyOf1X255bd763 =
    InlineV1CustomersBalanceTransactionsGetParameterAnyOf1X255bd763.build(block)
