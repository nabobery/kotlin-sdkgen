...
public class InlineV1TokensPostRequestFormPiiX0553cae2(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1TokensPostRequestFormPiiX0553cae2 =
            InlineV1TokensPostRequestFormPiiX0553cae2(
                idNumber = idNumber,
            )
    }

    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TokensPostRequestFormPiiX0553cae2 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TokensPostRequestFormPiiX0553cae2> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1TokensPostRequestFormPiiX0553cae2 {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("InlineV1TokensPostRequestFormPiiX0553cae2 must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TokensPostRequestFormPiiX0553cae2,
        ) {
...
public fun inlineV1TokensPostRequestFormPiiX0553cae2(
    block: InlineV1TokensPostRequestFormPiiX0553cae2.Builder.() -> Unit,
): InlineV1TokensPostRequestFormPiiX0553cae2 = InlineV1TokensPostRequestFormPiiX0553cae2.build(block)
