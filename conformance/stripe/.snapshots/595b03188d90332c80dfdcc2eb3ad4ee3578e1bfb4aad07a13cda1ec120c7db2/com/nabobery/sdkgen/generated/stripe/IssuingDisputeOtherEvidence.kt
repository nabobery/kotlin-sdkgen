...
public class IssuingDisputeOtherEvidence(
     ...
     * dispute.
     */
    public val additionalDocumentation: InlineIssuingDisputeOtherEvidenceAdditionalDocumentationX2ea3e4ba? = null,
    /**
    ...
    public class Builder {
        ...
        public fun build(): IssuingDisputeOtherEvidence =
    ...
    public object Serializer : KSerializer<IssuingDisputeOtherEvidence> {
        ...
        override fun deserialize(decoder: Decoder): IssuingDisputeOtherEvidence {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("IssuingDisputeOtherEvidence must be a JSON object")
                ...
                additionalDocumentation =
                    rawObject["additional_documentation"]?.let { element ->
                        if (element ==
                            ...
                            json
                                .decodeFromJsonElement<InlineIssuingDisputeOtherEvidenceAdditionalDocumentationX2ea3e4ba?>(
                                    element,
                                )
                        }
                    },
                ...
                productType =
                    rawObject["product_type"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineIssuingDisputeOtherEvidenceProductTypeX4c25cae5?>(element)
                        }
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: IssuingDisputeOtherEvidence,
        ) {
...
public fun issuingDisputeOtherEvidence(
    block: IssuingDisputeOtherEvidence.Builder.() -> Unit,
): IssuingDisputeOtherEvidence = IssuingDisputeOtherEvidence.build(block)
