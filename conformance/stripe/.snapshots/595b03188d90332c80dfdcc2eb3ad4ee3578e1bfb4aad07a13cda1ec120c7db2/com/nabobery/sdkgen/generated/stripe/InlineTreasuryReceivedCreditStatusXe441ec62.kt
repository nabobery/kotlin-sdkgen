...
public sealed class InlineTreasuryReceivedCreditStatusXe441ec62 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineTreasuryReceivedCreditStatusXe441ec62 =
            when (value) {
                Failed.value -> Failed
    ...
    public object Serializer : KSerializer<InlineTreasuryReceivedCreditStatusXe441ec62> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineTreasuryReceivedCreditStatusXe441ec62",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineTreasuryReceivedCreditStatusXe441ec62 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineTreasuryReceivedCreditStatusXe441ec62,
        ) {
