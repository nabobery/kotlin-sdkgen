...
public class InlineV1BillingPortalConfiab44PostRequestFormFeaturesItemX1edb0a0b(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1BillingPortalConfiab44PostRequestFormFeaturesItemX1edb0a0b = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1BillingPortalConfiab44PostRequestFormFeaturesItemX1edb0a0b> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1BillingPortalConfiab44PostRequestFormFeaturesItemX1edb0a0b {
            val jsonDecoder =
                decoder.requireJsonDecoder(
                    "InlineV1BillingPortalConfiab44PostRequestFormFeaturesItemX1edb0a0b",
                )
            val json = jsonDecoder.json
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1BillingPortalConfiab44PostRequestFormFeaturesItemX1edb0a0b must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineV1BillingPortalConfiab44PostRequestFormFeaturesTypeX15fbe3bd>(
                    rawObject,
                    "type",
                )
            return InlineV1BillingPortalConfiab44PostRequestFormFeaturesItemX1edb0a0b(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1BillingPortalConfiab44PostRequestFormFeaturesItemX1edb0a0b,
        ) {
            val jsonEncoder =
...
public fun inlineV1BillingPortalConfiab44PostRequestFormFeaturesItemX1edb0a0b(
    block: InlineV1BillingPortalConfiab44PostRequestFormFeaturesItemX1edb0a0b.Builder.() -> Unit,
): InlineV1BillingPortalConfiab44PostRequestFormFeaturesItemX1edb0a0b =
    InlineV1BillingPortalConfiab44PostRequestFormFeaturesItemX1edb0a0b.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1BillingPortalConfiab44PostRequestFormFeaturesItemX1edb0a0b is missing required property '" +
                    name +
                    "'",
            )
