...
public class InlineV1TerminalOnboardingLinksPostRequestFormXcee20784(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TerminalOnboardingLinksPostRequestFormXcee20784 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TerminalOnboardingLinksPostRequestFormXcee20784> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TerminalOnboardingLinksPostRequestFormXcee20784 must be a JSON object",
                    )
            val linkOptions =
                json.decodeRequired<InlineV1TerminalOnboardingLinksPostRequestFormLinkOptionsX87ed1f29>(
                    rawObject,
                    "link_options",
                )
            val linkType =
                json.decodeRequired<InlineV1TerminalOnboardingLinksPostRequestFormLinkTypeX3073ad87>(
                    rawObject,
                    "link_type",
                )
            return InlineV1TerminalOnboardingLinksPostRequestFormXcee20784(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TerminalOnboardingLinksPostRequestFormXcee20784,
        ) {
...
public fun inlineV1TerminalOnboardingLinksPostRequestFormXcee20784(
    block: InlineV1TerminalOnboardingLinksPostRequestFormXcee20784.Builder.() -> Unit,
): InlineV1TerminalOnboardingLinksPostRequestFormXcee20784 =
    InlineV1TerminalOnboardingLinksPostRequestFormXcee20784.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TerminalOnboardingLinksPostRequestFormXcee20784 is missing required property '" + name + "'",
            )
