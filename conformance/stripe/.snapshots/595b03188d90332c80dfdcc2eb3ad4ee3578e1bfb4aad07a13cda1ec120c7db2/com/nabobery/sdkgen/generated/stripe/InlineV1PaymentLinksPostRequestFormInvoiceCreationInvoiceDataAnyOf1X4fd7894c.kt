...
public class InlineV1PaymentLinksPostRequestFormInvoiceCreationInvoiceDataAnyOf1X4fd7894c(
    public val amountTaxDisplay: InlineV1PaymentLinksPostRequestFormInvoiceCreationAmountTaxDisplayXe1f62478? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1PaymentLinksPostRequestFormInvoiceCreationInvoiceDataAnyOf1X4fd7894c =
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentLinksPostRequestFormInvoiceCreationInvoiceDataAnyOf1X4fd7894c = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1PaymentLinksPostRequestFormInvoiceCreationInvoiceDataAnyOf1X4fd7894c> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentLinksPostRequestFormInvoiceCreationInvoiceDataAnyOf1X4fd7894c must be a JSON object",
                    )
            return InlineV1PaymentLinksPostRequestFormInvoiceCreationInvoiceDataAnyOf1X4fd7894c(
                amountTaxDisplay =
                    rawObject["amount_tax_display"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormInvoiceCreationAmountTaxDisplayXe1f62478>(
                                it,
                            )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentLinksPostRequestFormInvoiceCreationInvoiceDataAnyOf1X4fd7894c,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentLinksPostRequestFormInvoiceCreationInvoiceDataAnyOf1X4fd7894c(
    block: InlineV1PaymentLinksPostRequestFormInvoiceCreationInvoiceDataAnyOf1X4fd7894c.Builder.() -> Unit,
): InlineV1PaymentLinksPostRequestFormInvoiceCreationInvoiceDataAnyOf1X4fd7894c =
    InlineV1PaymentLinksPostRequestFormInvoiceCreationInvoiceDataAnyOf1X4fd7894c.build(block)
