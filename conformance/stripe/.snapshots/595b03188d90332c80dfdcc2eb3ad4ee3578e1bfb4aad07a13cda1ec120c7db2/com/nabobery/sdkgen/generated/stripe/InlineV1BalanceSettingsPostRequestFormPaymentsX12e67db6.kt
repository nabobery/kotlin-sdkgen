...
public class InlineV1BalanceSettingsPostRequestFormPaymentsX12e67db6(
    ...
    public val settlementTiming: InlineV1BalanceSettingsPostRequestFormPaymentsSettlementTimingX8c4c446d? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1BalanceSettingsPostRequestFormPaymentsX12e67db6 =
            InlineV1BalanceSettingsPostRequestFormPaymentsX12e67db6(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1BalanceSettingsPostRequestFormPaymentsX12e67db6 =
    ...
    public object Serializer : KSerializer<InlineV1BalanceSettingsPostRequestFormPaymentsX12e67db6> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1BalanceSettingsPostRequestFormPaymentsX12e67db6 must be a JSON object",
                    )
            return InlineV1BalanceSettingsPostRequestFormPaymentsX12e67db6(
                debitNegativeBalances =
                    rawObject["debit_negative_balances"]?.let {
                ...
                payouts =
                    rawObject["payouts"]?.let {
                        json.decodeFromJsonElement<InlineV1BalanceSettingsPostRequestFormPaymentsPayoutsX8d952677>(it)
                    },
                settlementTiming =
                    rawObject["settlement_timing"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1BalanceSettingsPostRequestFormPaymentsSettlementTimingX8c4c446d>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1BalanceSettingsPostRequestFormPaymentsX12e67db6,
        ) {
...
public fun inlineV1BalanceSettingsPostRequestFormPaymentsX12e67db6(
    block: InlineV1BalanceSettingsPostRequestFormPaymentsX12e67db6.Builder.() -> Unit,
): InlineV1BalanceSettingsPostRequestFormPaymentsX12e67db6 =
    InlineV1BalanceSettingsPostRequestFormPaymentsX12e67db6.build(block)
