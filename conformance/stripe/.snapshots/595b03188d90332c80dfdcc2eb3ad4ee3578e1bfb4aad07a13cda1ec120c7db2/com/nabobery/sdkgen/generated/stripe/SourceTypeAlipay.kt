...
public class SourceTypeAlipay(
    ...
    public class Builder {
        ...
        public fun build(): SourceTypeAlipay =
            SourceTypeAlipay(
    ...
    public object Serializer : KSerializer<SourceTypeAlipay> {
        ...
        override fun deserialize(decoder: Decoder): SourceTypeAlipay {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("SourceTypeAlipay must be a JSON object")
            return SourceTypeAlipay(
                dataString =
                    rawObject["data_string"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
...
public fun sourceTypeAlipay(block: SourceTypeAlipay.Builder.() -> Unit): SourceTypeAlipay =
    SourceTypeAlipay.build(block)
