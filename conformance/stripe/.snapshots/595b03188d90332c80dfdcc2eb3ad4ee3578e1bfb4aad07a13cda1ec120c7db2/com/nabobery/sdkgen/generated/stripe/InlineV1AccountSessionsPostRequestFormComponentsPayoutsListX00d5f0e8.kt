...
public class InlineV1AccountSessionsPostRequestFormComponentsPayoutsListX00d5f0e8(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1AccountSessionsPostRequestFormComponentsPayoutsListX00d5f0e8 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1AccountSessionsPostRequestFormComponentsPayoutsListX00d5f0e8> {
        override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1AccountSessionsPostRequestFormComponentsPayoutsListX00d5f0e8 {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountSessionsPostRequestFormComponentsPayoutsListX00d5f0e8 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountSessionsPostRequestFormComponentsPayoutsListX00d5f0e8,
        ) {
            val jsonEncoder =
...
public fun inlineV1AccountSessionsPostRequestFormComponentsPayoutsListX00d5f0e8(
    block: InlineV1AccountSessionsPostRequestFormComponentsPayoutsListX00d5f0e8.Builder.() -> Unit,
): InlineV1AccountSessionsPostRequestFormComponentsPayoutsListX00d5f0e8 =
    InlineV1AccountSessionsPostRequestFormComponentsPayoutsListX00d5f0e8.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1AccountSessionsPostRequestFormComponentsPayoutsListX00d5f0e8 is missing required property '" +
                    name +
                    "'",
            )
