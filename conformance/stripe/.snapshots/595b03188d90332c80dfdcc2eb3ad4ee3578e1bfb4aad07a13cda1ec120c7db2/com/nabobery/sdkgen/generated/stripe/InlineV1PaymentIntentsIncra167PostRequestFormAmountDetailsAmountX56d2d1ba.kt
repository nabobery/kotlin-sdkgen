...
internal data class InlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsAmountX56d2d1baInspection(
    ...
    public val matchesInlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsAnyOf2Xd770059d: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsAnyOf2Xd770059d,
            ).count {
                it
            }
}
...
public class InlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsAmountX56d2d1ba internal constructor(
    ...
    private val inspection: InlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsAmountX56d2d1baInspection,
) {
    ...
    public val inlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsAnyOf2Xd770059d:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsAnyOf2Xd770059d) {
                json
                    .decodeFromJsonElement<InlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsAnyOf2Xd770059d>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsAmountX56d2d1baBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsAnyOf2Xd770059d) {
                    add(
                        InlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsAmountX56d2d1baBranch.InlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsAnyOf2Xd770059d,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsAmountX56d2d1ba {
            val inspection = inspectInlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsAmountX56d2d1ba(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsAmountX56d2d1baNoMatchException(
                    "InlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsAmountX56d2d1ba matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsAmountX56d2d1ba> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsAmountX56d2d1ba,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsAmountX56d2d1ba",
...
private fun inspectInlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsAmountX56d2d1ba(
    element: JsonElement,
): InlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsAmountX56d2d1baInspection {
    val matchesBranch1 = element.isJsonDecodable<Int>()
    val matchesInlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsAnyOf2Xd770059d =
        element
            .isJsonDecodable<InlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsAnyOf2Xd770059d>()
    return InlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsAmountX56d2d1baInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsAnyOf2Xd770059d) {
                    add(
                        "InlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsAnyOf2Xd770059d: value does not match InlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsAnyOf2Xd770059d",
                    )
                }
            },
    )
