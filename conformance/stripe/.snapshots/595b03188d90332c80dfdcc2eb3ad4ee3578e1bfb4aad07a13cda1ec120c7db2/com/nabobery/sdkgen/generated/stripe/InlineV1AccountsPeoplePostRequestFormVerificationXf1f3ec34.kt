...
public class InlineV1AccountsPeoplePostRequestFormVerificationXf1f3ec34(
    public val additionalDocument: InlineV1AccountsPeoplePostRequestFormVerificationAdditionalDocumentX8eb4a138? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1AccountsPeoplePostRequestFormVerificationXf1f3ec34 =
            InlineV1AccountsPeoplePostRequestFormVerificationXf1f3ec34(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1AccountsPeoplePostRequestFormVerificationXf1f3ec34 =
    ...
    public object Serializer : KSerializer<InlineV1AccountsPeoplePostRequestFormVerificationXf1f3ec34> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountsPeoplePostRequestFormVerificationXf1f3ec34 must be a JSON object",
                    )
            return InlineV1AccountsPeoplePostRequestFormVerificationXf1f3ec34(
                additionalDocument =
                    rawObject["additional_document"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1AccountsPeoplePostRequestFormVerificationAdditionalDocumentX8eb4a138>(
                                it,
                            )
                    },
                document =
                    rawObject["document"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPeoplePostRequestFormVerificationDocumentXf8150ce9>(
                            it,
                        )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPeoplePostRequestFormVerificationXf1f3ec34,
        ) {
...
public fun inlineV1AccountsPeoplePostRequestFormVerificationXf1f3ec34(
    block: InlineV1AccountsPeoplePostRequestFormVerificationXf1f3ec34.Builder.() -> Unit,
): InlineV1AccountsPeoplePostRequestFormVerificationXf1f3ec34 =
    InlineV1AccountsPeoplePostRequestFormVerificationXf1f3ec34.build(block)
