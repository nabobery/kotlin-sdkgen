...
public sealed class InlineV1SetupIntentsConfirmPostRequestFormTransactionTypeX1bed45b8 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1SetupIntentsConfirmPostRequestFormTransactionTypeX1bed45b8 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1SetupIntentsConfirmPostRequestFormTransactionTypeX1bed45b8> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1SetupIntentsConfirmPostRequestFormTransactionTypeX1bed45b8",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1SetupIntentsConfirmPostRequestFormTransactionTypeX1bed45b8 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SetupIntentsConfirmPostRequestFormTransactionTypeX1bed45b8,
        ) {
