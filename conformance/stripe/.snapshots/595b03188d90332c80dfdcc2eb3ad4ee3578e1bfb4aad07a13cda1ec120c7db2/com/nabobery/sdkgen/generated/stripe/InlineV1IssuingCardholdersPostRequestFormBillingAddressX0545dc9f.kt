...
public class InlineV1IssuingCardholdersPostRequestFormBillingAddressX0545dc9f(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1IssuingCardholdersPostRequestFormBillingAddressX0545dc9f =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1IssuingCardholdersPostRequestFormBillingAddressX0545dc9f> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1IssuingCardholdersPostRequestFormBillingAddressX0545dc9f must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingCardholdersPostRequestFormBillingAddressX0545dc9f,
        ) {
            val jsonEncoder =
...
public fun inlineV1IssuingCardholdersPostRequestFormBillingAddressX0545dc9f(
    block: InlineV1IssuingCardholdersPostRequestFormBillingAddressX0545dc9f.Builder.() -> Unit,
): InlineV1IssuingCardholdersPostRequestFormBillingAddressX0545dc9f =
    InlineV1IssuingCardholdersPostRequestFormBillingAddressX0545dc9f.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1IssuingCardholdersPostRequestFormBillingAddressX0545dc9f is missing required property '" + name +
                    "'",
            )
