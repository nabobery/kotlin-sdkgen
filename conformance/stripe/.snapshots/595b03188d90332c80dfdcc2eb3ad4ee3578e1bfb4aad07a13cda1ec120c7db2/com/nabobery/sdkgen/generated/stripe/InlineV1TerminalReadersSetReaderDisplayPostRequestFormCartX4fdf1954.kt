...
public class InlineV1TerminalReadersSetReaderDisplayPostRequestFormCartX4fdf1954(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1TerminalReadersSetReaderDisplayPostRequestFormCartX4fdf1954 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TerminalReadersSetReaderDisplayPostRequestFormCartX4fdf1954> {
        override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1TerminalReadersSetReaderDisplayPostRequestFormCartX4fdf1954 {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TerminalReadersSetReaderDisplayPostRequestFormCartX4fdf1954 must be a JSON object",
                    )
            val currency = json.decodeRequired<String>(rawObject, "currency")
            val lineItems =
                json
                    .decodeRequired<List<InlineV1TerminalReadersSetReaderDisplayPostRequestFormCartLineItemsItemX1b9f6507>>(
                        rawObject,
                        "line_items",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TerminalReadersSetReaderDisplayPostRequestFormCartX4fdf1954,
        ) {
            val jsonEncoder =
...
public fun inlineV1TerminalReadersSetReaderDisplayPostRequestFormCartX4fdf1954(
    block: InlineV1TerminalReadersSetReaderDisplayPostRequestFormCartX4fdf1954.Builder.() -> Unit,
): InlineV1TerminalReadersSetReaderDisplayPostRequestFormCartX4fdf1954 =
    InlineV1TerminalReadersSetReaderDisplayPostRequestFormCartX4fdf1954.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TerminalReadersSetReaderDisplayPostRequestFormCartX4fdf1954 is missing required property '" +
                    name +
                    "'",
            )
