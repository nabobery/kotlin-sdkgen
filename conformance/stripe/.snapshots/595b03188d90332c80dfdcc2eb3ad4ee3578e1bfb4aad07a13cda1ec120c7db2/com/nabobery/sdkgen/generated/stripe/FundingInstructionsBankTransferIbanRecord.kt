...
public class FundingInstructionsBankTransferIbanRecord(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): FundingInstructionsBankTransferIbanRecord =
    ...
    public object Serializer : KSerializer<FundingInstructionsBankTransferIbanRecord> {
        ...
        override fun deserialize(decoder: Decoder): FundingInstructionsBankTransferIbanRecord {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("FundingInstructionsBankTransferIbanRecord must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: FundingInstructionsBankTransferIbanRecord,
        ) {
...
public fun fundingInstructionsBankTransferIbanRecord(
    block: FundingInstructionsBankTransferIbanRecord.Builder.() -> Unit,
): FundingInstructionsBankTransferIbanRecord = FundingInstructionsBankTransferIbanRecord.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "FundingInstructionsBankTransferIbanRecord is missing required property '" + name + "'",
            )
