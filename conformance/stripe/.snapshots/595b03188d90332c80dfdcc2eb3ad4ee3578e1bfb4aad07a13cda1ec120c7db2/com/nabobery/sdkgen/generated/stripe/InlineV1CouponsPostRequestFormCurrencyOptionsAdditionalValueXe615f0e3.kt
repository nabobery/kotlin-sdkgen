...
public class InlineV1CouponsPostRequestFormCurrencyOptionsAdditionalValueXe615f0e3(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1CouponsPostRequestFormCurrencyOptionsAdditionalValueXe615f0e3 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1CouponsPostRequestFormCurrencyOptionsAdditionalValueXe615f0e3> {
        override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1CouponsPostRequestFormCurrencyOptionsAdditionalValueXe615f0e3 {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CouponsPostRequestFormCurrencyOptionsAdditionalValueXe615f0e3 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CouponsPostRequestFormCurrencyOptionsAdditionalValueXe615f0e3,
        ) {
            val jsonEncoder =
...
public fun inlineV1CouponsPostRequestFormCurrencyOptionsAdditionalValueXe615f0e3(
    block: InlineV1CouponsPostRequestFormCurrencyOptionsAdditionalValueXe615f0e3.Builder.() -> Unit,
): InlineV1CouponsPostRequestFormCurrencyOptionsAdditionalValueXe615f0e3 =
    InlineV1CouponsPostRequestFormCurrencyOptionsAdditionalValueXe615f0e3.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1CouponsPostRequestFormCurrencyOptionsAdditionalValueXe615f0e3 is missing required property '" +
                    name +
                    "'",
            )
