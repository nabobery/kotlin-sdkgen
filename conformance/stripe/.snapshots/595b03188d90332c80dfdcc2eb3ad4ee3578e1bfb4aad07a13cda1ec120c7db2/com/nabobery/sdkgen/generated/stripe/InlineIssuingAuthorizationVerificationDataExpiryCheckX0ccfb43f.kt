...
public sealed class InlineIssuingAuthorizationVerificationDataExpiryCheckX0ccfb43f {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineIssuingAuthorizationVerificationDataExpiryCheckX0ccfb43f =
            when (value) {
                Match.value -> Match
    ...
    public object Serializer : KSerializer<InlineIssuingAuthorizationVerificationDataExpiryCheckX0ccfb43f> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineIssuingAuthorizationVerificationDataExpiryCheckX0ccfb43f",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineIssuingAuthorizationVerificationDataExpiryCheckX0ccfb43f =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineIssuingAuthorizationVerificationDataExpiryCheckX0ccfb43f,
        ) {
