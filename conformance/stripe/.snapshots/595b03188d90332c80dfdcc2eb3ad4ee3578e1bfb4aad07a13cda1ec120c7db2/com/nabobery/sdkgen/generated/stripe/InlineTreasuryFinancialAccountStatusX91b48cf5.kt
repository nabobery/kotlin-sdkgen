...
public sealed class InlineTreasuryFinancialAccountStatusX91b48cf5 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineTreasuryFinancialAccountStatusX91b48cf5 =
            when (value) {
                Closed.value -> Closed
                Open.value -> Open
    ...
    public object Serializer : KSerializer<InlineTreasuryFinancialAccountStatusX91b48cf5> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineTreasuryFinancialAccountStatusX91b48cf5",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineTreasuryFinancialAccountStatusX91b48cf5 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineTreasuryFinancialAccountStatusX91b48cf5,
        ) {
