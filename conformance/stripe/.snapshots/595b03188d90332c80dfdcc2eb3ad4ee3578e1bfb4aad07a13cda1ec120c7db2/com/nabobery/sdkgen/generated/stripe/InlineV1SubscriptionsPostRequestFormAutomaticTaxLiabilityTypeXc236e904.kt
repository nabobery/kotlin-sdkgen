...
public sealed class InlineV1SubscriptionsPostRequestFormAutomaticTaxLiabilityTypeXc236e904 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1SubscriptionsPostRequestFormAutomaticTaxLiabilityTypeXc236e904 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionsPostRequestFormAutomaticTaxLiabilityTypeXc236e904> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1SubscriptionsPostRequestFormAutomaticTaxLiabilityTypeXc236e904",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1SubscriptionsPostRequestFormAutomaticTaxLiabilityTypeXc236e904 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsPostRequestFormAutomaticTaxLiabilityTypeXc236e904,
        ) {
