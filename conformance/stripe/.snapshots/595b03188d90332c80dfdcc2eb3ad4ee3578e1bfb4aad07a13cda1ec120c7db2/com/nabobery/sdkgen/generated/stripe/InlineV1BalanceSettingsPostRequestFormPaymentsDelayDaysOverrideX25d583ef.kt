...
internal data class InlineV1BalanceSettingsPostRequestFormPaymentsDelayDaysOverrideX25d583efInspection(
    ...
    public val matchesInlineV1BalanceSettingsPostRequestFormPaymentsSettlementTimingAnyOf2X70c04a25: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1BalanceSettingsPostRequestFormPaymentsSettlementTimingAnyOf2X70c04a25,
            ).count {
                it
            }
}
...
public class InlineV1BalanceSettingsPostRequestFormPaymentsDelayDaysOverrideX25d583ef internal constructor(
    ...
    private val inspection: InlineV1BalanceSettingsPostRequestFormPaymentsDelayDaysOverrideX25d583efInspection,
) {
    ...
    public val inlineV1BalanceSettingsPostRequestFormPaymentsSettlementTimingAnyOf2X70c04a25:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1BalanceSettingsPostRequestFormPaymentsSettlementTimingAnyOf2X70c04a25) {
                json
                    .decodeFromJsonElement<InlineV1BalanceSettingsPostRequestFormPaymentsSettlementTimingAnyOf2X70c04a25>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1BalanceSettingsPostRequestFormPaymentsDelayDaysOverrideX25d583efBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1BalanceSettingsPostRequestFormPaymentsSettlementTimingAnyOf2X70c04a25) {
                    add(
                        InlineV1BalanceSettingsPostRequestFormPaymentsDelayDaysOverrideX25d583efBranch.InlineV1BalanceSettingsPostRequestFormPaymentsSettlementTimingAnyOf2X70c04a25,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1BalanceSettingsPostRequestFormPaymentsDelayDaysOverrideX25d583ef {
            val inspection = inspectInlineV1BalanceSettingsPostRequestFormPaymentsDelayDaysOverrideX25d583ef(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1BalanceSettingsPostRequestFormPaymentsDelayDaysOverrideX25d583efNoMatchException(
                    "InlineV1BalanceSettingsPostRequestFormPaymentsDelayDaysOverrideX25d583ef matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1BalanceSettingsPostRequestFormPaymentsDelayDaysOverrideX25d583ef> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1BalanceSettingsPostRequestFormPaymentsDelayDaysOverrideX25d583ef,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1BalanceSettingsPostRequestFormPaymentsDelayDaysOverrideX25d583ef",
...
private fun inspectInlineV1BalanceSettingsPostRequestFormPaymentsDelayDaysOverrideX25d583ef(
    element: JsonElement,
): InlineV1BalanceSettingsPostRequestFormPaymentsDelayDaysOverrideX25d583efInspection {
    val matchesBranch1 = element.isJsonDecodable<Int>()
    val matchesInlineV1BalanceSettingsPostRequestFormPaymentsSettlementTimingAnyOf2X70c04a25 =
        element
            .isJsonDecodable<InlineV1BalanceSettingsPostRequestFormPaymentsSettlementTimingAnyOf2X70c04a25>()
    return InlineV1BalanceSettingsPostRequestFormPaymentsDelayDaysOverrideX25d583efInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1BalanceSettingsPostRequestFormPaymentsSettlementTimingAnyOf2X70c04a25) {
                    add(
                        "InlineV1BalanceSettingsPostRequestFormPaymentsSettlementTimingAnyOf2X70c04a25: value does not match InlineV1BalanceSettingsPostRequestFormPaymentsSettlementTimingAnyOf2X70c04a25",
                    )
                }
            },
    )
