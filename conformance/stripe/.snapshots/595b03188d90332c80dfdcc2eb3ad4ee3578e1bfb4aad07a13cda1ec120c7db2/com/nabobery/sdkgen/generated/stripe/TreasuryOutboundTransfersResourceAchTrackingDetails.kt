...
public class TreasuryOutboundTransfersResourceAchTrackingDetails(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): TreasuryOutboundTransfersResourceAchTrackingDetails =
    ...
    public object Serializer : KSerializer<TreasuryOutboundTransfersResourceAchTrackingDetails> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "TreasuryOutboundTransfersResourceAchTrackingDetails must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: TreasuryOutboundTransfersResourceAchTrackingDetails,
        ) {
...
public fun treasuryOutboundTransfersResourceAchTrackingDetails(
    block: TreasuryOutboundTransfersResourceAchTrackingDetails.Builder.() -> Unit,
): TreasuryOutboundTransfersResourceAchTrackingDetails =
    TreasuryOutboundTransfersResourceAchTrackingDetails.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "TreasuryOutboundTransfersResourceAchTrackingDetails is missing required property '" + name + "'",
            )
