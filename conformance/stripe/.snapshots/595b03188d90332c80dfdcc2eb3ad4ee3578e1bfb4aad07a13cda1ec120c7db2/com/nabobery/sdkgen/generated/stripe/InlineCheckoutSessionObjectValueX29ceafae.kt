...
public sealed class InlineCheckoutSessionObjectValueX29ceafae {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineCheckoutSessionObjectValueX29ceafae =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineCheckoutSessionObjectValueX29ceafae> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineCheckoutSessionObjectValueX29ceafae",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineCheckoutSessionObjectValueX29ceafae =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineCheckoutSessionObjectValueX29ceafae,
        ) {
