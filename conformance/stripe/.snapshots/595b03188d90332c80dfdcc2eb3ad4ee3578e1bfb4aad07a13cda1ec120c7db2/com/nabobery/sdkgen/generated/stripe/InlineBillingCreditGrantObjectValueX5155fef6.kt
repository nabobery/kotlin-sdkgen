...
public sealed class InlineBillingCreditGrantObjectValueX5155fef6 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineBillingCreditGrantObjectValueX5155fef6 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineBillingCreditGrantObjectValueX5155fef6> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineBillingCreditGrantObjectValueX5155fef6",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineBillingCreditGrantObjectValueX5155fef6 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineBillingCreditGrantObjectValueX5155fef6,
        ) {
