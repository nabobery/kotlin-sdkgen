...
public class TreasuryTransactionEntry(
    ...
    public object Serializer : KSerializer<TreasuryTransactionEntry> {
        ...
        override fun deserialize(decoder: Decoder): TreasuryTransactionEntry {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("TreasuryTransactionEntry must be a JSON object")
            val balanceImpact =
            ...
            val objectValue =
                json.decodeRequired<InlineTreasuryTransactionEntryObjectValueX5712b74d>(
                    rawObject,
                    "object",
                )
            val transaction =
                json.decodeRequired<InlineTreasuryTransactionEntryTransactionX0ef108c4>(
                    rawObject,
                    "transaction",
                )
                ...
                flowDetails =
                    rawObject["flow_details"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineTreasuryTransactionEntryFlowDetailsXa78f458e?>(element)
                        }
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: TreasuryTransactionEntry,
        ) {
...
public fun treasuryTransactionEntry(block: TreasuryTransactionEntry.Builder.() -> Unit): TreasuryTransactionEntry =
    TreasuryTransactionEntry.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException("TreasuryTransactionEntry is missing required property '" + name + "'")
