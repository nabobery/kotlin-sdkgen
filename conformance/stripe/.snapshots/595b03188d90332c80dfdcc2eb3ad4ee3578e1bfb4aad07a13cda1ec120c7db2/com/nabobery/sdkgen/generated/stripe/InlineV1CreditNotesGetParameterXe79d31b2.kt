...
public class InlineV1CreditNotesGetParameterXe79d31b2 internal constructor(
    ...
    public val inlineV1CreditNotesGetParameterAnyOf1X9ef7df65:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1CreditNotesGetParameterAnyOf1X9ef7df65) {
                json
                    .decodeFromJsonElement<InlineV1CreditNotesGetParameterAnyOf1X9ef7df65>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1CreditNotesGetParameterXe79d31b2Branch>
        get() =
            buildSet {
                if (inspection.matchesInlineV1CreditNotesGetParameterAnyOf1X9ef7df65) {
                    add(
                        InlineV1CreditNotesGetParameterXe79d31b2Branch.InlineV1CreditNotesGetParameterAnyOf1X9ef7df65,
                    )
                }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1CreditNotesGetParameterXe79d31b2 {
            val inspection = inspectInlineV1CreditNotesGetParameterXe79d31b2(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1CreditNotesGetParameterXe79d31b2NoMatchException(
                    "InlineV1CreditNotesGetParameterXe79d31b2 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1CreditNotesGetParameterXe79d31b2> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CreditNotesGetParameterXe79d31b2,
        ) {
...
private fun inspectInlineV1CreditNotesGetParameterXe79d31b2(
    element: JsonElement,
): InlineV1CreditNotesGetParameterXe79d31b2Inspection {
    val matchesInlineV1CreditNotesGetParameterAnyOf1X9ef7df65 =
        element
            .isJsonDecodable<InlineV1CreditNotesGetParameterAnyOf1X9ef7df65>()
    ...
    return InlineV1CreditNotesGetParameterXe79d31b2Inspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1CreditNotesGetParameterAnyOf1X9ef7df65) {
                    add(
                        "InlineV1CreditNotesGetParameterAnyOf1X9ef7df65: value does not match InlineV1CreditNotesGetParameterAnyOf1X9ef7df65",
                    )
                }
