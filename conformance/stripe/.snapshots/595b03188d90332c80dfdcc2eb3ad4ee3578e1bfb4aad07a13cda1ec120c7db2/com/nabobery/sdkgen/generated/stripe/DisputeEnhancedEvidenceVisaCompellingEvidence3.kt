...
public class DisputeEnhancedEvidenceVisaCompellingEvidence3(
    ...
    public class Builder {
        ...
        public var priorUndisputedTransactions:
            List<DisputeVisaCompellingEvidence3PriorUndisputedTransaction>
            get() = requireNotNull(priorUndisputedTransactionsValue) { "priorUndisputedTransactions is required" }
            set(`value`) {
                priorUndisputedTransactionsValue = value
            }
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): DisputeEnhancedEvidenceVisaCompellingEvidence3 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<DisputeEnhancedEvidenceVisaCompellingEvidence3> {
        ...
        override fun deserialize(decoder: Decoder): DisputeEnhancedEvidenceVisaCompellingEvidence3 {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "DisputeEnhancedEvidenceVisaCompellingEvidence3 must be a JSON object",
                    )
            val priorUndisputedTransactions =
                json
                    .decodeRequired<List<DisputeVisaCompellingEvidence3PriorUndisputedTransaction>>(
                        rawObject,
            ...
            return DisputeEnhancedEvidenceVisaCompellingEvidence3(
                priorUndisputedTransactions = priorUndisputedTransactions,
                disputedTransaction =
                    rawObject["disputed_transaction"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                            ...
                            json
                                .decodeFromJsonElement<InlineDisputeEnhancedEvidenceVisaCompellingEvidence3DisputedTransactionX4a7101f3?>(
                                    element,
                                )
                        }
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: DisputeEnhancedEvidenceVisaCompellingEvidence3,
        ) {
...
public fun disputeEnhancedEvidenceVisaCompellingEvidence3(
    block: DisputeEnhancedEvidenceVisaCompellingEvidence3.Builder.() -> Unit,
): DisputeEnhancedEvidenceVisaCompellingEvidence3 = DisputeEnhancedEvidenceVisaCompellingEvidence3.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "DisputeEnhancedEvidenceVisaCompellingEvidence3 is missing required property '" + name + "'",
            )
