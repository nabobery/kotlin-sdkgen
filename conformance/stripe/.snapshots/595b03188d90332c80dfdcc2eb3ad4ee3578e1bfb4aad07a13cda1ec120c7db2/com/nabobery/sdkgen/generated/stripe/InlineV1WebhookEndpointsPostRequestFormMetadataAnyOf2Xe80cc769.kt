...
public sealed class InlineV1WebhookEndpointsPostRequestFormMetadataAnyOf2Xe80cc769 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1WebhookEndpointsPostRequestFormMetadataAnyOf2Xe80cc769 =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1WebhookEndpointsPostRequestFormMetadataAnyOf2Xe80cc769> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1WebhookEndpointsPostRequestFormMetadataAnyOf2Xe80cc769",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1WebhookEndpointsPostRequestFormMetadataAnyOf2Xe80cc769 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1WebhookEndpointsPostRequestFormMetadataAnyOf2Xe80cc769,
        ) {
