...
public class FinancialConnectionsAccountOwnership(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): FinancialConnectionsAccountOwnership =
    ...
    public object Serializer : KSerializer<FinancialConnectionsAccountOwnership> {
        ...
        override fun deserialize(decoder: Decoder): FinancialConnectionsAccountOwnership {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("FinancialConnectionsAccountOwnership must be a JSON object")
            val created = json.decodeRequired<Int>(rawObject, "created")
            val id = json.decodeRequired<String>(rawObject, "id")
            val objectValue =
                json.decodeRequired<InlineFinancialConnectionsAccountOwnershipObjectValueX047d38c7>(
                    rawObject,
                    "object",
                )
            val owners =
                json.decodeRequired<InlineFinancialConnectionsAccountOwnershipOwnersX8c8bb945>(
                    rawObject,
                    "owners",
                )
            return FinancialConnectionsAccountOwnership(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: FinancialConnectionsAccountOwnership,
        ) {
...
public fun financialConnectionsAccountOwnership(
    block: FinancialConnectionsAccountOwnership.Builder.() -> Unit,
): FinancialConnectionsAccountOwnership = FinancialConnectionsAccountOwnership.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "FinancialConnectionsAccountOwnership is missing required property '" + name + "'",
            )
