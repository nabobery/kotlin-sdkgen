...
internal data class InlineV1IdentityVerificationReportsGetParameterX10661f59Inspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesInlineV1IdentityVerificationReportsGetParameterAnyOf1Xabc6ae9c,
                matchesBranch2,
            ).count { it }
}
...
public class InlineV1IdentityVerificationReportsGetParameterX10661f59 internal constructor(
    ...
    public val inlineV1IdentityVerificationReportsGetParameterAnyOf1Xabc6ae9c:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1IdentityVerificationReportsGetParameterAnyOf1Xabc6ae9c) {
                json
                    .decodeFromJsonElement<InlineV1IdentityVerificationReportsGetParameterAnyOf1Xabc6ae9c>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1IdentityVerificationReportsGetParameterX10661f59Branch>
        get() =
            buildSet {
                if (inspection.matchesInlineV1IdentityVerificationReportsGetParameterAnyOf1Xabc6ae9c) {
                    add(
                        InlineV1IdentityVerificationReportsGetParameterX10661f59Branch.InlineV1IdentityVerificationReportsGetParameterAnyOf1Xabc6ae9c,
                    )
                }
                if (inspection.matchesBranch2) {
                    add(
                        InlineV1IdentityVerificationReportsGetParameterX10661f59Branch.Branch2,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1IdentityVerificationReportsGetParameterX10661f59 {
            val inspection = inspectInlineV1IdentityVerificationReportsGetParameterX10661f59(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1IdentityVerificationReportsGetParameterX10661f59NoMatchException(
                    "InlineV1IdentityVerificationReportsGetParameterX10661f59 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1IdentityVerificationReportsGetParameterX10661f59> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IdentityVerificationReportsGetParameterX10661f59,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1IdentityVerificationReportsGetParameterX10661f59",
...
private fun inspectInlineV1IdentityVerificationReportsGetParameterX10661f59(
    element: JsonElement,
): InlineV1IdentityVerificationReportsGetParameterX10661f59Inspection {
    val matchesInlineV1IdentityVerificationReportsGetParameterAnyOf1Xabc6ae9c =
        element
            .isJsonDecodable<InlineV1IdentityVerificationReportsGetParameterAnyOf1Xabc6ae9c>()
    ...
    return InlineV1IdentityVerificationReportsGetParameterX10661f59Inspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1IdentityVerificationReportsGetParameterAnyOf1Xabc6ae9c) {
                    add(
                        "InlineV1IdentityVerificationReportsGetParameterAnyOf1Xabc6ae9c: value does not match InlineV1IdentityVerificationReportsGetParameterAnyOf1Xabc6ae9c",
                    )
                }
