...
public class InlineV1PaymentIntentsCapturePostRequestFormTransferDataX4040aa28(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1PaymentIntentsCapturePostRequestFormTransferDataX4040aa28 =
            InlineV1PaymentIntentsCapturePostRequestFormTransferDataX4040aa28(
                amount = amount,
            )
    }

    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PaymentIntentsCapturePostRequestFormTransferDataX4040aa28 =
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsCapturePostRequestFormTransferDataX4040aa28> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsCapturePostRequestFormTransferDataX4040aa28 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsCapturePostRequestFormTransferDataX4040aa28,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentIntentsCapturePostRequestFormTransferDataX4040aa28(
    block: InlineV1PaymentIntentsCapturePostRequestFormTransferDataX4040aa28.Builder.() -> Unit,
): InlineV1PaymentIntentsCapturePostRequestFormTransferDataX4040aa28 =
