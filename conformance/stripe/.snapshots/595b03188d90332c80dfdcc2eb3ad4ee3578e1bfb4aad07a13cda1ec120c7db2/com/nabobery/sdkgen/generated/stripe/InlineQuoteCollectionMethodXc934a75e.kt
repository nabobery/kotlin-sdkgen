...
public sealed class InlineQuoteCollectionMethodXc934a75e {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineQuoteCollectionMethodXc934a75e =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineQuoteCollectionMethodXc934a75e> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineQuoteCollectionMethodXc934a75e",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineQuoteCollectionMethodXc934a75e =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineQuoteCollectionMethodXc934a75e,
        ) {
