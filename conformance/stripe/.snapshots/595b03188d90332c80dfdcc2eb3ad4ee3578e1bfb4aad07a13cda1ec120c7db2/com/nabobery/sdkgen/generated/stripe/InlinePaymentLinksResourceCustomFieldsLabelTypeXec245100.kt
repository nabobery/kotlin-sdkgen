...
public sealed class InlinePaymentLinksResourceCustomFieldsLabelTypeXec245100 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentLinksResourceCustomFieldsLabelTypeXec245100 =
            when (value) {
                Custom.value -> Custom
    ...
    public object Serializer : KSerializer<InlinePaymentLinksResourceCustomFieldsLabelTypeXec245100> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentLinksResourceCustomFieldsLabelTypeXec245100",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePaymentLinksResourceCustomFieldsLabelTypeXec245100 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentLinksResourceCustomFieldsLabelTypeXec245100,
        ) {
