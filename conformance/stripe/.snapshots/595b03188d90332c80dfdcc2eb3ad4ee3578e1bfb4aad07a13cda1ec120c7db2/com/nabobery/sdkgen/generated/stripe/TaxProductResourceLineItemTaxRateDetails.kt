...
public class TaxProductResourceLineItemTaxRateDetails(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): TaxProductResourceLineItemTaxRateDetails =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<TaxProductResourceLineItemTaxRateDetails> {
        ...
        override fun deserialize(decoder: Decoder): TaxProductResourceLineItemTaxRateDetails {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("TaxProductResourceLineItemTaxRateDetails must be a JSON object")
            ...
            val taxType =
                json.decodeRequired<InlineTaxProductResourceLineItemTaxRateDetailsTaxTypeX451abf22>(
                    rawObject,
                    "tax_type",
                )
            return TaxProductResourceLineItemTaxRateDetails(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: TaxProductResourceLineItemTaxRateDetails,
        ) {
...
public fun taxProductResourceLineItemTaxRateDetails(
    block: TaxProductResourceLineItemTaxRateDetails.Builder.() -> Unit,
): TaxProductResourceLineItemTaxRateDetails = TaxProductResourceLineItemTaxRateDetails.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "TaxProductResourceLineItemTaxRateDetails is missing required property '" + name + "'",
            )
