...
public sealed class InlineV1SubscriptionsPostRequestFormItemsItemTaxRatesAnyOf2X801cb56b {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1SubscriptionsPostRequestFormItemsItemTaxRatesAnyOf2X801cb56b =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionsPostRequestFormItemsItemTaxRatesAnyOf2X801cb56b> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1SubscriptionsPostRequestFormItemsItemTaxRatesAnyOf2X801cb56b",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1SubscriptionsPostRequestFormItemsItemTaxRatesAnyOf2X801cb56b = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsPostRequestFormItemsItemTaxRatesAnyOf2X801cb56b,
        ) {
