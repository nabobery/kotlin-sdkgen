...
internal data class InlineV1PaymentIntentsCapturePostRequestFormOrderReferenceX58a0ec4cInspection(
    ...
    public val matchesInlineV1PaymentIntentsCapturePostRequestFormPaymentDetailsAnyOf1AnyOf2Xf5e3f82a: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1PaymentIntentsCapturePostRequestFormPaymentDetailsAnyOf1AnyOf2Xf5e3f82a,
            ).count {
                it
            }
}
...
public class InlineV1PaymentIntentsCapturePostRequestFormOrderReferenceX58a0ec4c internal constructor(
    ...
    private val inspection: InlineV1PaymentIntentsCapturePostRequestFormOrderReferenceX58a0ec4cInspection,
) {
    ...
    public val inlineV1PaymentIntentsCapturePostRequestFormPaymentDetailsAnyOf1AnyOf2Xf5e3f82a:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1PaymentIntentsCapturePostRequestFormPaymentDetailsAnyOf1AnyOf2Xf5e3f82a) {
                json
                    .decodeFromJsonElement<InlineV1PaymentIntentsCapturePostRequestFormPaymentDetailsAnyOf1AnyOf2Xf5e3f82a>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1PaymentIntentsCapturePostRequestFormOrderReferenceX58a0ec4cBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1PaymentIntentsCapturePostRequestFormPaymentDetailsAnyOf1AnyOf2Xf5e3f82a) {
                    add(
                        InlineV1PaymentIntentsCapturePostRequestFormOrderReferenceX58a0ec4cBranch.InlineV1PaymentIntentsCapturePostRequestFormPaymentDetailsAnyOf1AnyOf2Xf5e3f82a,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1PaymentIntentsCapturePostRequestFormOrderReferenceX58a0ec4c {
            val inspection = inspectInlineV1PaymentIntentsCapturePostRequestFormOrderReferenceX58a0ec4c(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1PaymentIntentsCapturePostRequestFormOrderReferenceX58a0ec4cNoMatchException(
                    "InlineV1PaymentIntentsCapturePostRequestFormOrderReferenceX58a0ec4c matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsCapturePostRequestFormOrderReferenceX58a0ec4c> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsCapturePostRequestFormOrderReferenceX58a0ec4c,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1PaymentIntentsCapturePostRequestFormOrderReferenceX58a0ec4c",
...
private fun inspectInlineV1PaymentIntentsCapturePostRequestFormOrderReferenceX58a0ec4c(
    element: JsonElement,
): InlineV1PaymentIntentsCapturePostRequestFormOrderReferenceX58a0ec4cInspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1PaymentIntentsCapturePostRequestFormPaymentDetailsAnyOf1AnyOf2Xf5e3f82a =
        element
            .isJsonDecodable<InlineV1PaymentIntentsCapturePostRequestFormPaymentDetailsAnyOf1AnyOf2Xf5e3f82a>()
    return InlineV1PaymentIntentsCapturePostRequestFormOrderReferenceX58a0ec4cInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1PaymentIntentsCapturePostRequestFormPaymentDetailsAnyOf1AnyOf2Xf5e3f82a) {
                    add(
                        "InlineV1PaymentIntentsCapturePostRequestFormPaymentDetailsAnyOf1AnyOf2Xf5e3f82a: value does not match InlineV1PaymentIntentsCapturePostRequestFormPaymentDetailsAnyOf1AnyOf2Xf5e3f82a",
                    )
                }
            },
    )
