...
public class InlineV1BillingMeterEventsPostRequestFormXce007751(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1BillingMeterEventsPostRequestFormXce007751 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1BillingMeterEventsPostRequestFormXce007751> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1BillingMeterEventsPostRequestFormXce007751 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1BillingMeterEventsPostRequestFormXce007751,
        ) {
...
public fun inlineV1BillingMeterEventsPostRequestFormXce007751(
    block: InlineV1BillingMeterEventsPostRequestFormXce007751.Builder.() -> Unit,
): InlineV1BillingMeterEventsPostRequestFormXce007751 = InlineV1BillingMeterEventsPostRequestFormXce007751.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1BillingMeterEventsPostRequestFormXce007751 is missing required property '" + name + "'",
            )
