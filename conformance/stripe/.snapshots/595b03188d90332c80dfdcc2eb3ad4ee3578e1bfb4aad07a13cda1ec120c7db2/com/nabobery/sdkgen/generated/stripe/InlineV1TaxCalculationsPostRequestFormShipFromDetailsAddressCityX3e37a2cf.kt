...
internal data class InlineV1TaxCalculationsPostRequestFormShipFromDetailsAddressCityX3e37a2cfInspection(
    ...
    public val matchesInlineV1TaxCalculationsPostRequestFormShipFromDetailsAddressCityAnyOf2X502c4af0: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1TaxCalculationsPostRequestFormShipFromDetailsAddressCityAnyOf2X502c4af0,
            ).count {
                it
            }
}
...
public class InlineV1TaxCalculationsPostRequestFormShipFromDetailsAddressCityX3e37a2cf internal constructor(
    ...
    private val inspection: InlineV1TaxCalculationsPostRequestFormShipFromDetailsAddressCityX3e37a2cfInspection,
) {
    ...
    public val inlineV1TaxCalculationsPostRequestFormShipFromDetailsAddressCityAnyOf2X502c4af0:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1TaxCalculationsPostRequestFormShipFromDetailsAddressCityAnyOf2X502c4af0) {
                json
                    .decodeFromJsonElement<InlineV1TaxCalculationsPostRequestFormShipFromDetailsAddressCityAnyOf2X502c4af0>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1TaxCalculationsPostRequestFormShipFromDetailsAddressCityX3e37a2cfBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1TaxCalculationsPostRequestFormShipFromDetailsAddressCityAnyOf2X502c4af0) {
                    add(
                        InlineV1TaxCalculationsPostRequestFormShipFromDetailsAddressCityX3e37a2cfBranch.InlineV1TaxCalculationsPostRequestFormShipFromDetailsAddressCityAnyOf2X502c4af0,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1TaxCalculationsPostRequestFormShipFromDetailsAddressCityX3e37a2cf {
            val inspection = inspectInlineV1TaxCalculationsPostRequestFormShipFromDetailsAddressCityX3e37a2cf(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1TaxCalculationsPostRequestFormShipFromDetailsAddressCityX3e37a2cfNoMatchException(
                    "InlineV1TaxCalculationsPostRequestFormShipFromDetailsAddressCityX3e37a2cf matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1TaxCalculationsPostRequestFormShipFromDetailsAddressCityX3e37a2cf> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TaxCalculationsPostRequestFormShipFromDetailsAddressCityX3e37a2cf,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1TaxCalculationsPostRequestFormShipFromDetailsAddressCityX3e37a2cf",
...
private fun inspectInlineV1TaxCalculationsPostRequestFormShipFromDetailsAddressCityX3e37a2cf(
    element: JsonElement,
): InlineV1TaxCalculationsPostRequestFormShipFromDetailsAddressCityX3e37a2cfInspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1TaxCalculationsPostRequestFormShipFromDetailsAddressCityAnyOf2X502c4af0 =
        element
            .isJsonDecodable<InlineV1TaxCalculationsPostRequestFormShipFromDetailsAddressCityAnyOf2X502c4af0>()
    return InlineV1TaxCalculationsPostRequestFormShipFromDetailsAddressCityX3e37a2cfInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1TaxCalculationsPostRequestFormShipFromDetailsAddressCityAnyOf2X502c4af0) {
                    add(
                        "InlineV1TaxCalculationsPostRequestFormShipFromDetailsAddressCityAnyOf2X502c4af0: value does not match InlineV1TaxCalculationsPostRequestFormShipFromDetailsAddressCityAnyOf2X502c4af0",
                    )
                }
            },
    )
