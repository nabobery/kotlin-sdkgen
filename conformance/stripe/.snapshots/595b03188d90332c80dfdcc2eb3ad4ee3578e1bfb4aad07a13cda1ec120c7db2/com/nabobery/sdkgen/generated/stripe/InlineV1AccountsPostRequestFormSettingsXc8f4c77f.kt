...
public class InlineV1AccountsPostRequestFormSettingsXc8f4c77f(
    public val bacsDebitPayments: InlineV1AccountsPostRequestFormSettingsBacsDebitPaymentsX65c6b8f1? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1AccountsPostRequestFormSettingsXc8f4c77f =
            InlineV1AccountsPostRequestFormSettingsXc8f4c77f(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1AccountsPostRequestFormSettingsXc8f4c77f =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1AccountsPostRequestFormSettingsXc8f4c77f> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountsPostRequestFormSettingsXc8f4c77f must be a JSON object",
                    )
            return InlineV1AccountsPostRequestFormSettingsXc8f4c77f(
                bacsDebitPayments =
                    rawObject["bacs_debit_payments"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPostRequestFormSettingsBacsDebitPaymentsX65c6b8f1>(
                            it,
                        )
                    },
                branding =
                    rawObject["branding"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPostRequestFormSettingsBrandingX94f3a8a1>(it)
                    },
                cardIssuing =
                    rawObject["card_issuing"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPostRequestFormSettingsCardIssuingX5bbf26b8>(it)
                    },
                cardPayments =
                    rawObject["card_payments"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPostRequestFormSettingsCardPaymentsXac2b6762>(it)
                    },
                invoices =
                    rawObject["invoices"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPostRequestFormSettingsInvoicesXe923c5e1>(it)
                    },
                payments =
                    rawObject["payments"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPostRequestFormSettingsPaymentsXdc23302b>(it)
                    },
                payouts =
                    rawObject["payouts"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPostRequestFormSettingsPayoutsXd77873f8>(it)
                    },
                treasury =
                    rawObject["treasury"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPostRequestFormSettingsTreasuryXa85fd053>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPostRequestFormSettingsXc8f4c77f,
        ) {
...
public fun inlineV1AccountsPostRequestFormSettingsXc8f4c77f(
    block: InlineV1AccountsPostRequestFormSettingsXc8f4c77f.Builder.() -> Unit,
): InlineV1AccountsPostRequestFormSettingsXc8f4c77f = InlineV1AccountsPostRequestFormSettingsXc8f4c77f.build(block)
