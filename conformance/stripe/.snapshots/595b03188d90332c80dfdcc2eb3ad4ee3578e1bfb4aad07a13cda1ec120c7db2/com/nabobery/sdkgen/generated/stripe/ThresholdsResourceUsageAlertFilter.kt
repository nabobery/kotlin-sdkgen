...
public class ThresholdsResourceUsageAlertFilter(
    ...
    public object Serializer : KSerializer<ThresholdsResourceUsageAlertFilter> {
        ...
        override fun deserialize(decoder: Decoder): ThresholdsResourceUsageAlertFilter {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("ThresholdsResourceUsageAlertFilter must be a JSON object")
                ...
                customer =
                    rawObject["customer"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineThresholdsResourceUsageAlertFilterCustomerX84bc98d0?>(
                                element,
                            )
                        }
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: ThresholdsResourceUsageAlertFilter,
        ) {
...
public fun thresholdsResourceUsageAlertFilter(
    block: ThresholdsResourceUsageAlertFilter.Builder.() -> Unit,
): ThresholdsResourceUsageAlertFilter = ThresholdsResourceUsageAlertFilter.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "ThresholdsResourceUsageAlertFilter is missing required property '" + name + "'",
            )
