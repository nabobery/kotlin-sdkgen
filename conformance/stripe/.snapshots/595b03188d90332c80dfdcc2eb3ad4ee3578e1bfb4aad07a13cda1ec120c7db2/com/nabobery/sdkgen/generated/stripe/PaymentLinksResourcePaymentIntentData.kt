...
@Serializable
public data class PaymentLinksResourcePaymentIntentDataView(
    @SerialName("capture_method")
    public val captureMethod: InlinePaymentLinksResourcePaymentIntentDataCaptureMethodXf179e15d? = null,
    public val description: String? = null,
    public val metadata: Map<String, String>,
    @SerialName("setup_future_usage")
    public val setupFutureUsage: InlinePaymentLinksResourcePaymentIntentDataSetupFutureUsageXf07e6e5f? = null,
...
public class PaymentLinksResourcePaymentIntentData(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentLinksResourcePaymentIntentData =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentLinksResourcePaymentIntentData> {
        ...
        override fun deserialize(decoder: Decoder): PaymentLinksResourcePaymentIntentData {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentLinksResourcePaymentIntentData must be a JSON object")
            val metadata = json.decodeRequired<Map<String, String>>(rawObject, "metadata")
            return PaymentLinksResourcePaymentIntentData(
                metadata = metadata,
                captureMethod =
                    rawObject["capture_method"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                            ...
                            json
                                .decodeFromJsonElement<InlinePaymentLinksResourcePaymentIntentDataCaptureMethodXf179e15d?>(
                                    element,
                                )
                        }
                    },
                ...
                setupFutureUsage =
                    rawObject["setup_future_usage"]?.let { element ->
                        if (element ==
                            ...
                            json
                                .decodeFromJsonElement<InlinePaymentLinksResourcePaymentIntentDataSetupFutureUsageXf07e6e5f?>(
                                    element,
                                )
                        }
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentLinksResourcePaymentIntentData,
        ) {
...
public fun paymentLinksResourcePaymentIntentData(
    block: PaymentLinksResourcePaymentIntentData.Builder.() -> Unit,
): PaymentLinksResourcePaymentIntentData = PaymentLinksResourcePaymentIntentData.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "PaymentLinksResourcePaymentIntentData is missing required property '" + name + "'",
            )
