...
public class InlinePaymentMethodDetailsPaymentRecordUsBankAccountMandateX66eea151 internal constructor(
    ...
    private val inspection: InlinePaymentMethodDetailsPaymentRecordUsBankAccountMandateX66eea151Inspection,
) {
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlinePaymentMethodDetailsPaymentRecordUsBankAccountMandateX66eea151Branch.Branch1,
                    )
                }
                if (inspection.matchesMandate) {
                    add(
                        InlinePaymentMethodDetailsPaymentRecordUsBankAccountMandateX66eea151Branch.Mandate,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlinePaymentMethodDetailsPaymentRecordUsBankAccountMandateX66eea151 {
            val inspection = inspectInlinePaymentMethodDetailsPaymentRecordUsBankAccountMandateX66eea151(raw)
            if (inspection.matchCount == 0) {
                throw InlinePaymentMethodDetailsPaymentRecordUsBankAccountMandateX66eea151NoMatchException(
                    "InlinePaymentMethodDetailsPaymentRecordUsBankAccountMandateX66eea151 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlinePaymentMethodDetailsPaymentRecordUsBankAccountMandateX66eea151> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentMethodDetailsPaymentRecordUsBankAccountMandateX66eea151,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlinePaymentMethodDetailsPaymentRecordUsBankAccountMandateX66eea151",
...
private fun inspectInlinePaymentMethodDetailsPaymentRecordUsBankAccountMandateX66eea151(
    element: JsonElement,
