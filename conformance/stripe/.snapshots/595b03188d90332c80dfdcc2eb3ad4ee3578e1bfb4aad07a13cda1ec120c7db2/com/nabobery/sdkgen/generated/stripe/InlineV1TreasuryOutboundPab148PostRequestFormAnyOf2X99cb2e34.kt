...
public sealed class InlineV1TreasuryOutboundPab148PostRequestFormAnyOf2X99cb2e34 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1TreasuryOutboundPab148PostRequestFormAnyOf2X99cb2e34 =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1TreasuryOutboundPab148PostRequestFormAnyOf2X99cb2e34> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1TreasuryOutboundPab148PostRequestFormAnyOf2X99cb2e34",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1TreasuryOutboundPab148PostRequestFormAnyOf2X99cb2e34 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TreasuryOutboundPab148PostRequestFormAnyOf2X99cb2e34,
        ) {
