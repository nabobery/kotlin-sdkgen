...
public class PaymentMethodNzBankAccount(
    ...
    public object Serializer : KSerializer<PaymentMethodNzBankAccount> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodNzBankAccount {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodNzBankAccount must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentMethodNzBankAccount,
        ) {
...
public fun paymentMethodNzBankAccount(
    block: PaymentMethodNzBankAccount.Builder.() -> Unit,
): PaymentMethodNzBankAccount = PaymentMethodNzBankAccount.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException("PaymentMethodNzBankAccount is missing required property '" + name + "'")
