...
public sealed class InlineV1TaxIdsPostRequestFormTypeX5cbe59b7 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1TaxIdsPostRequestFormTypeX5cbe59b7 =
            when (value) {
                AdNrt.value -> AdNrt
                AeTrn.value -> AeTrn
                AlTin.value -> AlTin
    ...
    public object Serializer : KSerializer<InlineV1TaxIdsPostRequestFormTypeX5cbe59b7> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1TaxIdsPostRequestFormTypeX5cbe59b7",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1TaxIdsPostRequestFormTypeX5cbe59b7 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TaxIdsPostRequestFormTypeX5cbe59b7,
        ) {
