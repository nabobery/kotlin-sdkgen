...
public class InlineV1CheckoutSessionsExpirePostRequestFormX2922777c(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1CheckoutSessionsExpirePostRequestFormX2922777c =
            InlineV1CheckoutSessionsExpirePostRequestFormX2922777c(
                expand = expand,
            )
    }

    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1CheckoutSessionsExpirePostRequestFormX2922777c =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1CheckoutSessionsExpirePostRequestFormX2922777c> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CheckoutSessionsExpirePostRequestFormX2922777c must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsExpirePostRequestFormX2922777c,
        ) {
...
public fun inlineV1CheckoutSessionsExpirePostRequestFormX2922777c(
    block: InlineV1CheckoutSessionsExpirePostRequestFormX2922777c.Builder.() -> Unit,
): InlineV1CheckoutSessionsExpirePostRequestFormX2922777c =
    InlineV1CheckoutSessionsExpirePostRequestFormX2922777c.build(block)
