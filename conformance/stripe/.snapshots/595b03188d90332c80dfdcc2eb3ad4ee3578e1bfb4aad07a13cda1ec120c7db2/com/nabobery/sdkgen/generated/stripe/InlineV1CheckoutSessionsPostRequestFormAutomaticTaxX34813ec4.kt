...
public class InlineV1CheckoutSessionsPostRequestFormAutomaticTaxX34813ec4(
    ...
    public val liability: InlineV1CheckoutSessionsPostRequestFormAutomaticTaxLiabilityXf41c65f7? = null,
) {
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1CheckoutSessionsPostRequestFormAutomaticTaxX34813ec4 =
    ...
    public object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormAutomaticTaxX34813ec4> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CheckoutSessionsPostRequestFormAutomaticTaxX34813ec4 must be a JSON object",
                    )
            ...
            return InlineV1CheckoutSessionsPostRequestFormAutomaticTaxX34813ec4(
                ...
                liability =
                    rawObject["liability"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormAutomaticTaxLiabilityXf41c65f7>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsPostRequestFormAutomaticTaxX34813ec4,
        ) {
...
public fun inlineV1CheckoutSessionsPostRequestFormAutomaticTaxX34813ec4(
    block: InlineV1CheckoutSessionsPostRequestFormAutomaticTaxX34813ec4.Builder.() -> Unit,
): InlineV1CheckoutSessionsPostRequestFormAutomaticTaxX34813ec4 =
    InlineV1CheckoutSessionsPostRequestFormAutomaticTaxX34813ec4.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1CheckoutSessionsPostRequestFormAutomaticTaxX34813ec4 is missing required property '" + name +
                    "'",
            )
