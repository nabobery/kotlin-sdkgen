...
public sealed class InlineMandatePaytoAmountTypeXa993e554 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineMandatePaytoAmountTypeXa993e554 =
            when (value) {
                Fixed.value -> Fixed
    ...
    public object Serializer : KSerializer<InlineMandatePaytoAmountTypeXa993e554> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineMandatePaytoAmountTypeXa993e554",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineMandatePaytoAmountTypeXa993e554 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineMandatePaytoAmountTypeXa993e554,
        ) {
