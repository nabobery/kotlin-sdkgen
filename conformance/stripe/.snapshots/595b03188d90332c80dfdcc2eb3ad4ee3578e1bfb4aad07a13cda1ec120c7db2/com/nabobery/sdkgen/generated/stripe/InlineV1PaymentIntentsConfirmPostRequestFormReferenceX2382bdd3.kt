...
internal data class InlineV1PaymentIntentsConfirmPostRequestFormReferenceX2382bdd3Inspection(
    ...
    public val matchesInlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2X0d6f8cf5: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2X0d6f8cf5,
            ).count {
                it
            }
}
...
public class InlineV1PaymentIntentsConfirmPostRequestFormReferenceX2382bdd3 internal constructor(
    ...
    public val inlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2X0d6f8cf5:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2X0d6f8cf5) {
                json
                    .decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2X0d6f8cf5>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1PaymentIntentsConfirmPostRequestFormReferenceX2382bdd3Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2X0d6f8cf5) {
                    add(
                        InlineV1PaymentIntentsConfirmPostRequestFormReferenceX2382bdd3Branch.InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2X0d6f8cf5,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1PaymentIntentsConfirmPostRequestFormReferenceX2382bdd3 {
            val inspection = inspectInlineV1PaymentIntentsConfirmPostRequestFormReferenceX2382bdd3(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1PaymentIntentsConfirmPostRequestFormReferenceX2382bdd3NoMatchException(
                    "InlineV1PaymentIntentsConfirmPostRequestFormReferenceX2382bdd3 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsConfirmPostRequestFormReferenceX2382bdd3> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsConfirmPostRequestFormReferenceX2382bdd3,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1PaymentIntentsConfirmPostRequestFormReferenceX2382bdd3",
...
private fun inspectInlineV1PaymentIntentsConfirmPostRequestFormReferenceX2382bdd3(
    element: JsonElement,
): InlineV1PaymentIntentsConfirmPostRequestFormReferenceX2382bdd3Inspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2X0d6f8cf5 =
        element
            .isJsonDecodable<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2X0d6f8cf5>()
    return InlineV1PaymentIntentsConfirmPostRequestFormReferenceX2382bdd3Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2X0d6f8cf5) {
                    add(
                        "InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2X0d6f8cf5: value does not match InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2X0d6f8cf5",
                    )
                }
            },
    )
