...
public class InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAnyOf1X1ed37f20(
    public val financialConnections: InlineV1PaymentIntentsPostRequestFormFinancialConnectionsX8f29f0dd? = null,
    public val mandateOptions: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsMandateOptionsXd9513f97? = null,
    public val networks: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsNetworksX0c655b95? = null,
    public val setupFutureUsage: InlineV1PaymentIntentsPostRequestFormSetupFutureUsageXdcaf1d3b? = null,
    public val targetDate: String? = null,
    public val transactionPurpose: InlineV1PaymentIntentsPostRequestFormTransactionPurposeXfb93bf47? = null,
    public val verificationMethod: InlineV1PaymentIntentsPostRequestFormVerificationMethodX6fde7bc7? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAnyOf1X1ed37f20 =
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAnyOf1X1ed37f20 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAnyOf1X1ed37f20> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAnyOf1X1ed37f20 must be a JSON object",
                    )
            return InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAnyOf1X1ed37f20(
                financialConnections =
                    rawObject["financial_connections"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormFinancialConnectionsX8f29f0dd>(
                            it,
                        )
                    },
                mandateOptions =
                    rawObject["mandate_options"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsMandateOptionsXd9513f97>(
                                it,
                            )
                    },
                networks =
                    rawObject["networks"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsNetworksX0c655b95>(
                                it,
                            )
                    },
                setupFutureUsage =
                    rawObject["setup_future_usage"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormSetupFutureUsageXdcaf1d3b>(it)
                    },
                targetDate = rawObject["target_date"]?.let { json.decodeFromJsonElement<String>(it) },
                transactionPurpose =
                    rawObject["transaction_purpose"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormTransactionPurposeXfb93bf47>(it)
                    },
                verificationMethod =
                    rawObject["verification_method"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormVerificationMethodX6fde7bc7>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAnyOf1X1ed37f20,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAnyOf1X1ed37f20(
    block: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAnyOf1X1ed37f20.Builder.() -> Unit,
): InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAnyOf1X1ed37f20 =
    InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAnyOf1X1ed37f20.build(block)
