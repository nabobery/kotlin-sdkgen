...
public sealed class InlineV1QuotesPostRequestFormInvoiceSettingsIssuerTypeX61c3643b {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1QuotesPostRequestFormInvoiceSettingsIssuerTypeX61c3643b =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1QuotesPostRequestFormInvoiceSettingsIssuerTypeX61c3643b> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1QuotesPostRequestFormInvoiceSettingsIssuerTypeX61c3643b",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1QuotesPostRequestFormInvoiceSettingsIssuerTypeX61c3643b =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1QuotesPostRequestFormInvoiceSettingsIssuerTypeX61c3643b,
        ) {
