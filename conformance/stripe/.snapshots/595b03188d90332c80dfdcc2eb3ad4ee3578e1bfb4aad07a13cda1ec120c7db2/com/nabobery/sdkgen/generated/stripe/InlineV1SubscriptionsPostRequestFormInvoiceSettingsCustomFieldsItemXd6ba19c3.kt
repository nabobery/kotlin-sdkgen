...
public class InlineV1SubscriptionsPostRequestFormInvoiceSettingsCustomFieldsItemXd6ba19c3(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1SubscriptionsPostRequestFormInvoiceSettingsCustomFieldsItemXd6ba19c3 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionsPostRequestFormInvoiceSettingsCustomFieldsItemXd6ba19c3> {
        ...
        override fun deserialize(
            decoder: Decoder,
        ): InlineV1SubscriptionsPostRequestFormInvoiceSettingsCustomFieldsItemXd6ba19c3 {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SubscriptionsPostRequestFormInvoiceSettingsCustomFieldsItemXd6ba19c3 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsPostRequestFormInvoiceSettingsCustomFieldsItemXd6ba19c3,
        ) {
            val jsonEncoder =
...
public fun inlineV1SubscriptionsPostRequestFormInvoiceSettingsCustomFieldsItemXd6ba19c3(
    block: InlineV1SubscriptionsPostRequestFormInvoiceSettingsCustomFieldsItemXd6ba19c3.Builder.() -> Unit,
): InlineV1SubscriptionsPostRequestFormInvoiceSettingsCustomFieldsItemXd6ba19c3 =
    InlineV1SubscriptionsPostRequestFormInvoiceSettingsCustomFieldsItemXd6ba19c3.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1SubscriptionsPostRequestFormInvoiceSettingsCustomFieldsItemXd6ba19c3 is missing required property '" +
                    name +
                    "'",
            )
