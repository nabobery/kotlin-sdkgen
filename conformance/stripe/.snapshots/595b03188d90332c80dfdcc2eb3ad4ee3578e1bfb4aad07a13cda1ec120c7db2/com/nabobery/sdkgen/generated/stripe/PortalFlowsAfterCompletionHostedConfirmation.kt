...
public class PortalFlowsAfterCompletionHostedConfirmation(
    ...
    public class Builder {
        ...
        public fun build(): PortalFlowsAfterCompletionHostedConfirmation =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PortalFlowsAfterCompletionHostedConfirmation =
    ...
    public object Serializer : KSerializer<PortalFlowsAfterCompletionHostedConfirmation> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "PortalFlowsAfterCompletionHostedConfirmation must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PortalFlowsAfterCompletionHostedConfirmation,
        ) {
...
public fun portalFlowsAfterCompletionHostedConfirmation(
    block: PortalFlowsAfterCompletionHostedConfirmation.Builder.() -> Unit,
): PortalFlowsAfterCompletionHostedConfirmation = PortalFlowsAfterCompletionHostedConfirmation.build(block)
