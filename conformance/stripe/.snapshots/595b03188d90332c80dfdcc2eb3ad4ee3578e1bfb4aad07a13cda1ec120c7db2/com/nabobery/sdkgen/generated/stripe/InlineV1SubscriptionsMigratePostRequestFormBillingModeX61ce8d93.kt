...
public class InlineV1SubscriptionsMigratePostRequestFormBillingModeX61ce8d93(
    ...
    public val flexible: InlineV1SubscriptionsMigratePostRequestFormBillingModeFlexibleXa67b5a54? = null,
) {
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1SubscriptionsMigratePostRequestFormBillingModeX61ce8d93 =
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionsMigratePostRequestFormBillingModeX61ce8d93> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1SubscriptionsMigratePostRequestFormBillingModeX61ce8d93 {
            val jsonDecoder =
                decoder.requireJsonDecoder(
                    "InlineV1SubscriptionsMigratePostRequestFormBillingModeX61ce8d93",
                )
            val json = jsonDecoder.json
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SubscriptionsMigratePostRequestFormBillingModeX61ce8d93 must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineV1SubscriptionsMigratePostRequestFormBillingModeTypeXa7ac80a2>(
                    rawObject,
                    "type",
                )
            return InlineV1SubscriptionsMigratePostRequestFormBillingModeX61ce8d93(
                ...
                flexible =
                    rawObject["flexible"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SubscriptionsMigratePostRequestFormBillingModeFlexibleXa67b5a54>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsMigratePostRequestFormBillingModeX61ce8d93,
        ) {
            val jsonEncoder =
...
public fun inlineV1SubscriptionsMigratePostRequestFormBillingModeX61ce8d93(
    block: InlineV1SubscriptionsMigratePostRequestFormBillingModeX61ce8d93.Builder.() -> Unit,
): InlineV1SubscriptionsMigratePostRequestFormBillingModeX61ce8d93 =
    InlineV1SubscriptionsMigratePostRequestFormBillingModeX61ce8d93.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1SubscriptionsMigratePostRequestFormBillingModeX61ce8d93 is missing required property '" + name +
                    "'",
            )
