...
public class InlineV1AccountsPostRequestFormXb89aba63(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1AccountsPostRequestFormXb89aba63 =
            InlineV1AccountsPostRequestFormXb89aba63(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1AccountsPostRequestFormXb89aba63 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1AccountsPostRequestFormXb89aba63> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1AccountsPostRequestFormXb89aba63 {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("InlineV1AccountsPostRequestFormXb89aba63 must be a JSON object")
            return InlineV1AccountsPostRequestFormXb89aba63(
                ...
                bankAccount =
                    rawObject["bank_account"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPostRequestFormBankAccountX631136d5>(it)
                    },
                businessProfile =
                    rawObject["business_profile"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPostRequestFormBusinessProfileXb836e1dc>(it)
                    },
                businessType =
                    rawObject["business_type"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPostRequestFormBusinessTypeX724dec40>(it)
                    },
                capabilities =
                    rawObject["capabilities"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesX03ee7d3e>(it)
                    },
                company =
                    rawObject["company"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1AccountsPostRequestFormCompanyXa0d80ea7>(
                                it,
                            )
                    },
                controller =
                    rawObject["controller"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPostRequestFormControllerX9fb1c2f9>(it)
                    },
                ...
                documents =
                    rawObject["documents"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPostRequestFormDocumentsXe7387a38>(it)
                    },
                ...
                groups =
                    rawObject["groups"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPostRequestFormGroupsX5f919c2b>(
                            it,
                        )
                    },
                individual =
                    rawObject["individual"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPostRequestFormIndividualX5383dde5>(it)
                    },
                metadata =
                    rawObject["metadata"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPostRequestFormMetadataX5d8f3c72>(it)
                    },
                settings =
                    rawObject["settings"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPostRequestFormSettingsXbfba4b7f>(it)
                    },
                tosAcceptance =
                    rawObject["tos_acceptance"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPostRequestFormTosAcceptanceX0707d6bc>(it)
                    },
                type =
                    rawObject["type"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1AccountsPostRequestFormTypeXf359fa3d>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPostRequestFormXb89aba63,
        ) {
...
public fun inlineV1AccountsPostRequestFormXb89aba63(
    block: InlineV1AccountsPostRequestFormXb89aba63.Builder.() -> Unit,
): InlineV1AccountsPostRequestFormXb89aba63 = InlineV1AccountsPostRequestFormXb89aba63.build(block)
