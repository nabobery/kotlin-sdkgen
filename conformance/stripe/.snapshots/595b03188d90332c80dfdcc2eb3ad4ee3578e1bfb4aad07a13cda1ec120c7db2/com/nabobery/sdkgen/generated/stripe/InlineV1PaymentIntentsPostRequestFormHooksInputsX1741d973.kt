...
public class InlineV1PaymentIntentsPostRequestFormHooksInputsX1741d973(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1PaymentIntentsPostRequestFormHooksInputsX1741d973 =
            InlineV1PaymentIntentsPostRequestFormHooksInputsX1741d973(
                tax = tax,
            )
    }

    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PaymentIntentsPostRequestFormHooksInputsX1741d973 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormHooksInputsX1741d973> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsPostRequestFormHooksInputsX1741d973 must be a JSON object",
                    )
            return InlineV1PaymentIntentsPostRequestFormHooksInputsX1741d973(
                tax =
                    rawObject["tax"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormHooksInputsTaxX5d6a8358>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormHooksInputsX1741d973,
        ) {
...
public fun inlineV1PaymentIntentsPostRequestFormHooksInputsX1741d973(
    block: InlineV1PaymentIntentsPostRequestFormHooksInputsX1741d973.Builder.() -> Unit,
): InlineV1PaymentIntentsPostRequestFormHooksInputsX1741d973 =
    InlineV1PaymentIntentsPostRequestFormHooksInputsX1741d973.build(block)
