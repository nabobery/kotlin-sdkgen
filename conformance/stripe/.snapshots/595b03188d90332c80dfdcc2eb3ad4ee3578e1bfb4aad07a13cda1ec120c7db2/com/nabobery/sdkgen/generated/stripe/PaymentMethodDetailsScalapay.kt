...
public class PaymentMethodDetailsScalapay(
    ...
    public class Builder {
        ...
        public fun build(): PaymentMethodDetailsScalapay =
            PaymentMethodDetailsScalapay(
    ...
    public object Serializer : KSerializer<PaymentMethodDetailsScalapay> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodDetailsScalapay {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodDetailsScalapay must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentMethodDetailsScalapay,
        ) {
...
public fun paymentMethodDetailsScalapay(
    block: PaymentMethodDetailsScalapay.Builder.() -> Unit,
): PaymentMethodDetailsScalapay = PaymentMethodDetailsScalapay.build(block)
