...
public class InlineV1PaymentLinksPostRequestFormPhoneNumberCollectionXc1a634b3(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PaymentLinksPostRequestFormPhoneNumberCollectionXc1a634b3 =
    ...
    public object Serializer : KSerializer<InlineV1PaymentLinksPostRequestFormPhoneNumberCollectionXc1a634b3> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentLinksPostRequestFormPhoneNumberCollectionXc1a634b3 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentLinksPostRequestFormPhoneNumberCollectionXc1a634b3,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentLinksPostRequestFormPhoneNumberCollectionXc1a634b3(
    block: InlineV1PaymentLinksPostRequestFormPhoneNumberCollectionXc1a634b3.Builder.() -> Unit,
): InlineV1PaymentLinksPostRequestFormPhoneNumberCollectionXc1a634b3 =
    InlineV1PaymentLinksPostRequestFormPhoneNumberCollectionXc1a634b3.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentLinksPostRequestFormPhoneNumberCollectionXc1a634b3 is missing required property '" +
                    name +
                    "'",
            )
