...
public sealed class InlineV1PaymentIntentsConfirmPostRequestFormAresTransStatusX84aa416d {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1PaymentIntentsConfirmPostRequestFormAresTransStatusX84aa416d =
            when (value) {
                A.value -> A
                C.value -> C
                I.value -> I
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsConfirmPostRequestFormAresTransStatusX84aa416d> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1PaymentIntentsConfirmPostRequestFormAresTransStatusX84aa416d",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1PaymentIntentsConfirmPostRequestFormAresTransStatusX84aa416d = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsConfirmPostRequestFormAresTransStatusX84aa416d,
        ) {
