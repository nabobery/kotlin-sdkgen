...
public class InlineRadarEarlyFraudWarningPaymentIntentX11715895 internal constructor(
        ...
        get() =
            buildSet {
                ...
                if (inspection.matchesPaymentIntent) {
                    add(
                        InlineRadarEarlyFraudWarningPaymentIntentX11715895Branch.PaymentIntent,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineRadarEarlyFraudWarningPaymentIntentX11715895 {
            val inspection = inspectInlineRadarEarlyFraudWarningPaymentIntentX11715895(raw)
            if (inspection.matchCount == 0) {
                throw InlineRadarEarlyFraudWarningPaymentIntentX11715895NoMatchException(
                    "InlineRadarEarlyFraudWarningPaymentIntentX11715895 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineRadarEarlyFraudWarningPaymentIntentX11715895> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineRadarEarlyFraudWarningPaymentIntentX11715895,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineRadarEarlyFraudWarningPaymentIntentX11715895",
...
private fun inspectInlineRadarEarlyFraudWarningPaymentIntentX11715895(
    element: JsonElement,
): InlineRadarEarlyFraudWarningPaymentIntentX11715895Inspection {
