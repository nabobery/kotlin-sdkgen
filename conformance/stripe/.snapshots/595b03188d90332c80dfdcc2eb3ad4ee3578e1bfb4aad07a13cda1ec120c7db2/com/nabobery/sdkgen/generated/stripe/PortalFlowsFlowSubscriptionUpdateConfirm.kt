...
@Serializable
public data class PortalFlowsFlowSubscriptionUpdateConfirmView(
...
public class PortalFlowsFlowSubscriptionUpdateConfirm(
    ...
    public class Builder {
         ...
         * The coupon or promotion code to apply to this subscription update.
         */
        public var discounts: List<PortalFlowsSubscriptionUpdateConfirmDiscount>? = null
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PortalFlowsFlowSubscriptionUpdateConfirm =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PortalFlowsFlowSubscriptionUpdateConfirm> {
        ...
        override fun deserialize(decoder: Decoder): PortalFlowsFlowSubscriptionUpdateConfirm {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PortalFlowsFlowSubscriptionUpdateConfirm must be a JSON object")
                ...
                discounts =
                    rawObject["discounts"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<List<PortalFlowsSubscriptionUpdateConfirmDiscount>?>(element)
                        }
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PortalFlowsFlowSubscriptionUpdateConfirm,
        ) {
...
public fun portalFlowsFlowSubscriptionUpdateConfirm(
    block: PortalFlowsFlowSubscriptionUpdateConfirm.Builder.() -> Unit,
): PortalFlowsFlowSubscriptionUpdateConfirm = PortalFlowsFlowSubscriptionUpdateConfirm.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "PortalFlowsFlowSubscriptionUpdateConfirm is missing required property '" + name + "'",
            )
