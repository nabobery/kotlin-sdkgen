...
public class InlineV1AccountsPersonsPostRequestFormVerificationX56400555(
    public val additionalDocument: InlineV1AccountsPersonsPostRequestFormVerificationAdditionalDocumentX8ec7b06d? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1AccountsPersonsPostRequestFormVerificationX56400555 =
            InlineV1AccountsPersonsPostRequestFormVerificationX56400555(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1AccountsPersonsPostRequestFormVerificationX56400555 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1AccountsPersonsPostRequestFormVerificationX56400555> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountsPersonsPostRequestFormVerificationX56400555 must be a JSON object",
                    )
            return InlineV1AccountsPersonsPostRequestFormVerificationX56400555(
                additionalDocument =
                    rawObject["additional_document"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1AccountsPersonsPostRequestFormVerificationAdditionalDocumentX8ec7b06d>(
                                it,
                            )
                    },
                document =
                    rawObject["document"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPersonsPostRequestFormVerificationDocumentX9ab234ad>(
                            it,
                        )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPersonsPostRequestFormVerificationX56400555,
        ) {
...
public fun inlineV1AccountsPersonsPostRequestFormVerificationX56400555(
    block: InlineV1AccountsPersonsPostRequestFormVerificationX56400555.Builder.() -> Unit,
): InlineV1AccountsPersonsPostRequestFormVerificationX56400555 =
    InlineV1AccountsPersonsPostRequestFormVerificationX56400555.build(block)
