...
public sealed class InlineV1ChargesRefundsPostRequestFormMetadataAnyOf2Xb720c67f {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1ChargesRefundsPostRequestFormMetadataAnyOf2Xb720c67f =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1ChargesRefundsPostRequestFormMetadataAnyOf2Xb720c67f> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1ChargesRefundsPostRequestFormMetadataAnyOf2Xb720c67f",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1ChargesRefundsPostRequestFormMetadataAnyOf2Xb720c67f =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ChargesRefundsPostRequestFormMetadataAnyOf2Xb720c67f,
        ) {
