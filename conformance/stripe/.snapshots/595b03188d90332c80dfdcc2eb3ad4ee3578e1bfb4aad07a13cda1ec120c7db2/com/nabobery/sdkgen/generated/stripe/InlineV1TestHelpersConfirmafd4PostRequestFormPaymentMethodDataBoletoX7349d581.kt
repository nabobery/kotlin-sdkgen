...
public class InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataBoletoX7349d581(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataBoletoX7349d581 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataBoletoX7349d581> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataBoletoX7349d581 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataBoletoX7349d581,
        ) {
            val jsonEncoder =
...
public fun inlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataBoletoX7349d581(
    block: InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataBoletoX7349d581.Builder.() -> Unit,
): InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataBoletoX7349d581 =
    InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataBoletoX7349d581.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataBoletoX7349d581 is missing required property '" +
                    name +
                    "'",
            )
