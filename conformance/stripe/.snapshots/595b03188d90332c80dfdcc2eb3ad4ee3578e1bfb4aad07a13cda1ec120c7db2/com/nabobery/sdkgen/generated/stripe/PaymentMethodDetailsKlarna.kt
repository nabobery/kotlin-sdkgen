...
public class PaymentMethodDetailsKlarna(
    ...
    public class Builder {
        ...
        public fun build(): PaymentMethodDetailsKlarna =
    ...
    public object Serializer : KSerializer<PaymentMethodDetailsKlarna> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodDetailsKlarna {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodDetailsKlarna must be a JSON object")
                ...
                payerDetails =
                    rawObject["payer_details"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentMethodDetailsKlarnaPayerDetailsXe373db6d?>(element)
                        }
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentMethodDetailsKlarna,
        ) {
...
public fun paymentMethodDetailsKlarna(
    block: PaymentMethodDetailsKlarna.Builder.() -> Unit,
): PaymentMethodDetailsKlarna = PaymentMethodDetailsKlarna.build(block)
