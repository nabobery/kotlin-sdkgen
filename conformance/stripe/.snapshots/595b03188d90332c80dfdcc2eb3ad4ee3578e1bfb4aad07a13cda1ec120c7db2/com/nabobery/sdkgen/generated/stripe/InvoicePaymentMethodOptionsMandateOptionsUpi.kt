...
public class InvoicePaymentMethodOptionsMandateOptionsUpi(
     ...
     */
    public val amountType: InlineInvoicePaymentMethodOptionsMandateOptionsUpiAmountTypeX82229eb5? = null,
    /**
    ...
    public class Builder {
        ...
        public fun build(): InvoicePaymentMethodOptionsMandateOptionsUpi =
            InvoicePaymentMethodOptionsMandateOptionsUpi(
                amount = amount,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InvoicePaymentMethodOptionsMandateOptionsUpi =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InvoicePaymentMethodOptionsMandateOptionsUpi> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InvoicePaymentMethodOptionsMandateOptionsUpi must be a JSON object",
                    )
                ...
                amountType =
                    rawObject["amount_type"]?.let { element ->
                        if (element ==
                            ...
                            json
                                .decodeFromJsonElement<InlineInvoicePaymentMethodOptionsMandateOptionsUpiAmountTypeX82229eb5?>(
                                    element,
                                )
                        }
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InvoicePaymentMethodOptionsMandateOptionsUpi,
        ) {
...
public fun invoicePaymentMethodOptionsMandateOptionsUpi(
    block: InvoicePaymentMethodOptionsMandateOptionsUpi.Builder.() -> Unit,
): InvoicePaymentMethodOptionsMandateOptionsUpi = InvoicePaymentMethodOptionsMandateOptionsUpi.build(block)
