...
public class TreasuryReceivedCreditsResourceStatusTransitions(
    ...
    public class Builder {
        ...
        public fun build(): TreasuryReceivedCreditsResourceStatusTransitions =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): TreasuryReceivedCreditsResourceStatusTransitions =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<TreasuryReceivedCreditsResourceStatusTransitions> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "TreasuryReceivedCreditsResourceStatusTransitions must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: TreasuryReceivedCreditsResourceStatusTransitions,
        ) {
...
public fun treasuryReceivedCreditsResourceStatusTransitions(
    block: TreasuryReceivedCreditsResourceStatusTransitions.Builder.() -> Unit,
): TreasuryReceivedCreditsResourceStatusTransitions = TreasuryReceivedCreditsResourceStatusTransitions.build(block)
