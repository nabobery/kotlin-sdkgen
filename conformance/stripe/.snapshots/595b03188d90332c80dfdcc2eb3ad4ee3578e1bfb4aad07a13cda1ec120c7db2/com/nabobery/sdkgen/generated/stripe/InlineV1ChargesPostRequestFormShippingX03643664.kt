...
public class InlineV1ChargesPostRequestFormShippingX03643664(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1ChargesPostRequestFormShippingX03643664 =
    ...
    public object Serializer : KSerializer<InlineV1ChargesPostRequestFormShippingX03643664> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1ChargesPostRequestFormShippingX03643664 must be a JSON object",
                    )
            val address =
                json.decodeRequired<InlineV1ChargesPostRequestFormShippingAddressX583a68b7>(
                    rawObject,
                    "address",
                )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ChargesPostRequestFormShippingX03643664,
        ) {
...
public fun inlineV1ChargesPostRequestFormShippingX03643664(
    block: InlineV1ChargesPostRequestFormShippingX03643664.Builder.() -> Unit,
): InlineV1ChargesPostRequestFormShippingX03643664 = InlineV1ChargesPostRequestFormShippingX03643664.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1ChargesPostRequestFormShippingX03643664 is missing required property '" + name + "'",
            )
