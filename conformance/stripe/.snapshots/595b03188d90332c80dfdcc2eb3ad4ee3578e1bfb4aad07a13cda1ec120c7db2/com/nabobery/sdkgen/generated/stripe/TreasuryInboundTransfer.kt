...
public class TreasuryInboundTransfer(
    ...
    public val statusTransitions: TreasuryInboundTransfersResourceInboundTransferResourceStatusTransitions,
    /**
     ...
     */
    public val originPaymentMethodDetails: InlineTreasuryInboundTransferOriginPaymentMethodDetailsX62835ed2? = null,
    /**
    ...
    public object Serializer : KSerializer<TreasuryInboundTransfer> {
        ...
        override fun deserialize(decoder: Decoder): TreasuryInboundTransfer {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("TreasuryInboundTransfer must be a JSON object")
            ...
            val linkedFlows =
                json.decodeRequired<TreasuryInboundTransfersResourceInboundTransferResourceLinkedFlows>(
                    rawObject,
                    "linked_flows",
                )
            ...
            val objectValue =
                json.decodeRequired<InlineTreasuryInboundTransferObjectValueX4f5fbcc4>(
                    rawObject,
                    "object",
                )
            ...
            val statusTransitions =
                json
                    .decodeRequired<TreasuryInboundTransfersResourceInboundTransferResourceStatusTransitions>(
                        rawObject,
                        "status_transitions",
                    )
            return TreasuryInboundTransfer(
                ...
                failureDetails =
                    rawObject["failure_details"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineTreasuryInboundTransferFailureDetailsXd5eb6f42?>(element)
                        }
                    },
                ...
                originPaymentMethod =
                    rawObject["origin_payment_method"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                originPaymentMethodDetails =
                    rawObject["origin_payment_method_details"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                            ...
                            json
                                .decodeFromJsonElement<InlineTreasuryInboundTransferOriginPaymentMethodDetailsX62835ed2?>(
                                    element,
                                )
                        }
                    },
                returned =
                    rawObject["returned"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                transaction =
                    rawObject["transaction"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineTreasuryInboundTransferTransactionX08b12581?>(element)
                        }
                    },
            )
        }
        ...
        override fun serialize(
            ...
            val raw =
                buildJsonObject {
                    ...
                    value.originPaymentMethodDetails?.let {
                        put(
...
public fun treasuryInboundTransfer(block: TreasuryInboundTransfer.Builder.() -> Unit): TreasuryInboundTransfer =
    TreasuryInboundTransfer.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("TreasuryInboundTransfer is missing required property '" + name + "'")
