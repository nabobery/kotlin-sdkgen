...
internal data class InlineV1CustomersPostRequestFormIndividualNameX7e854e90Inspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1CustomersPostRequestFormIndividualNameAnyOf2X041c1d21,
            ).count { it }
}
...
public class InlineV1CustomersPostRequestFormIndividualNameX7e854e90 internal constructor(
    ...
    public val inlineV1CustomersPostRequestFormIndividualNameAnyOf2X041c1d21:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1CustomersPostRequestFormIndividualNameAnyOf2X041c1d21) {
                json
                    .decodeFromJsonElement<InlineV1CustomersPostRequestFormIndividualNameAnyOf2X041c1d21>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1CustomersPostRequestFormIndividualNameX7e854e90Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1CustomersPostRequestFormIndividualNameAnyOf2X041c1d21) {
                    add(
                        InlineV1CustomersPostRequestFormIndividualNameX7e854e90Branch.InlineV1CustomersPostRequestFormIndividualNameAnyOf2X041c1d21,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1CustomersPostRequestFormIndividualNameX7e854e90 {
            val inspection = inspectInlineV1CustomersPostRequestFormIndividualNameX7e854e90(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1CustomersPostRequestFormIndividualNameX7e854e90NoMatchException(
                    "InlineV1CustomersPostRequestFormIndividualNameX7e854e90 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1CustomersPostRequestFormIndividualNameX7e854e90> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersPostRequestFormIndividualNameX7e854e90,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1CustomersPostRequestFormIndividualNameX7e854e90",
...
private fun inspectInlineV1CustomersPostRequestFormIndividualNameX7e854e90(
    element: JsonElement,
): InlineV1CustomersPostRequestFormIndividualNameX7e854e90Inspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1CustomersPostRequestFormIndividualNameAnyOf2X041c1d21 =
        element
            .isJsonDecodable<InlineV1CustomersPostRequestFormIndividualNameAnyOf2X041c1d21>()
    return InlineV1CustomersPostRequestFormIndividualNameX7e854e90Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1CustomersPostRequestFormIndividualNameAnyOf2X041c1d21) {
                    add(
                        "InlineV1CustomersPostRequestFormIndividualNameAnyOf2X041c1d21: value does not match InlineV1CustomersPostRequestFormIndividualNameAnyOf2X041c1d21",
                    )
                }
            },
    )
