...
@Serializable
public data class PaymentLinksResourceShippingAddressCollectionView(
    @SerialName("allowed_countries")
    public val allowedCountries: List<InlinePaymentLinksResourceShippingAddressCollectionAllowedCountriesItemX09a846af>,
)
...
public class PaymentLinksResourceShippingAddressCollection(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentLinksResourceShippingAddressCollection =
    ...
    public object Serializer : KSerializer<PaymentLinksResourceShippingAddressCollection> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "PaymentLinksResourceShippingAddressCollection must be a JSON object",
                    )
            val allowedCountries =
                json
                    .decodeRequired<List<InlinePaymentLinksResourceShippingAddressCollectionAllowedCountriesItemX09a846af>>(
                        rawObject,
                        "allowed_countries",
                    )
            return PaymentLinksResourceShippingAddressCollection(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentLinksResourceShippingAddressCollection,
        ) {
...
public fun paymentLinksResourceShippingAddressCollection(
    block: PaymentLinksResourceShippingAddressCollection.Builder.() -> Unit,
): PaymentLinksResourceShippingAddressCollection = PaymentLinksResourceShippingAddressCollection.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "PaymentLinksResourceShippingAddressCollection is missing required property '" + name + "'",
            )
