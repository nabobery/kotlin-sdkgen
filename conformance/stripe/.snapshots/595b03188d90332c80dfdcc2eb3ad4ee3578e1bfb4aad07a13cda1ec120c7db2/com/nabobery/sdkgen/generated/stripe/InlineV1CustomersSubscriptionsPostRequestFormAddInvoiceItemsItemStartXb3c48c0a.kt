...
public class InlineV1CustomersSubscriptionsPostRequestFormAddInvoiceItemsItemStartXb3c48c0a(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1CustomersSubscriptionsPostRequestFormAddInvoiceItemsItemStartXb3c48c0a =
    ...
    public object Serializer : KSerializer<InlineV1CustomersSubscriptionsPostRequestFormAddInvoiceItemsItemStartXb3c48c0a> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CustomersSubscriptionsPostRequestFormAddInvoiceItemsItemStartXb3c48c0a must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineV1CustomersSubscriptionsPostRequestFormAddInvoiceItemsItemTypeX674f511e>(
                    rawObject,
                    "type",
                )
            return InlineV1CustomersSubscriptionsPostRequestFormAddInvoiceItemsItemStartXb3c48c0a(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersSubscriptionsPostRequestFormAddInvoiceItemsItemStartXb3c48c0a,
        ) {
            val jsonEncoder =
...
public fun inlineV1CustomersSubscriptionsPostRequestFormAddInvoiceItemsItemStartXb3c48c0a(
    block: InlineV1CustomersSubscriptionsPostRequestFormAddInvoiceItemsItemStartXb3c48c0a.Builder.() -> Unit,
): InlineV1CustomersSubscriptionsPostRequestFormAddInvoiceItemsItemStartXb3c48c0a =
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1CustomersSubscriptionsPostRequestFormAddInvoiceItemsItemStartXb3c48c0a is missing required property '" +
                    name +
                    "'",
            )
