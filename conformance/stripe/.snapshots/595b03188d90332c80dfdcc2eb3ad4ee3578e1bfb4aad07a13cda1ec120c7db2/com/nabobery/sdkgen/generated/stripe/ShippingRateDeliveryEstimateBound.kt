...
public class ShippingRateDeliveryEstimateBound(
    ...
    public object Serializer : KSerializer<ShippingRateDeliveryEstimateBound> {
        ...
        override fun deserialize(decoder: Decoder): ShippingRateDeliveryEstimateBound {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("ShippingRateDeliveryEstimateBound must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: ShippingRateDeliveryEstimateBound,
        ) {
...
public fun shippingRateDeliveryEstimateBound(
    block: ShippingRateDeliveryEstimateBound.Builder.() -> Unit,
): ShippingRateDeliveryEstimateBound = ShippingRateDeliveryEstimateBound.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "ShippingRateDeliveryEstimateBound is missing required property '" + name + "'",
            )
