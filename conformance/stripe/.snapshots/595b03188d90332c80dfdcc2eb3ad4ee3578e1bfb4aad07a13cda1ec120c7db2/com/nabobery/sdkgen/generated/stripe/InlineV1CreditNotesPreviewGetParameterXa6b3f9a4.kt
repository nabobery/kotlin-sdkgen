...
public class InlineV1CreditNotesPreviewGetParameterXa6b3f9a4(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1CreditNotesPreviewGetParameterXa6b3f9a4 =
            InlineV1CreditNotesPreviewGetParameterXa6b3f9a4(
                shippingRate = shippingRate,
            )
    }

    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1CreditNotesPreviewGetParameterXa6b3f9a4 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1CreditNotesPreviewGetParameterXa6b3f9a4> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CreditNotesPreviewGetParameterXa6b3f9a4 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CreditNotesPreviewGetParameterXa6b3f9a4,
        ) {
...
public fun inlineV1CreditNotesPreviewGetParameterXa6b3f9a4(
    block: InlineV1CreditNotesPreviewGetParameterXa6b3f9a4.Builder.() -> Unit,
): InlineV1CreditNotesPreviewGetParameterXa6b3f9a4 = InlineV1CreditNotesPreviewGetParameterXa6b3f9a4.build(block)
