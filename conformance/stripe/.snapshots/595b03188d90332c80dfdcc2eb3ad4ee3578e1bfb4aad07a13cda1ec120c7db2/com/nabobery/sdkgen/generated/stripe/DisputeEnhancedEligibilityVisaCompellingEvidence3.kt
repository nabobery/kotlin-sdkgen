...
public class DisputeEnhancedEligibilityVisaCompellingEvidence3(
    ...
    public class Builder {
        ...
        public var requiredActions: List<InlineDisputeEnhancedEligi3879RequiredActionsItemX14f7cb8e>
            get() = requireNotNull(requiredActionsValue) { "requiredActions is required" }
            set(`value`) {
                requiredActionsValue = value
            }
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): DisputeEnhancedEligibilityVisaCompellingEvidence3 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<DisputeEnhancedEligibilityVisaCompellingEvidence3> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "DisputeEnhancedEligibilityVisaCompellingEvidence3 must be a JSON object",
                    )
            val requiredActions =
                json.decodeRequired<List<InlineDisputeEnhancedEligi3879RequiredActionsItemX14f7cb8e>>(
                    rawObject,
                    "required_actions",
                )
            val status =
                json.decodeRequired<InlineDisputeEnhancedEligibilityVisaCompellingEvidence3StatusX17878737>(
                    rawObject,
                    "status",
                )
            return DisputeEnhancedEligibilityVisaCompellingEvidence3(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: DisputeEnhancedEligibilityVisaCompellingEvidence3,
        ) {
...
public fun disputeEnhancedEligibilityVisaCompellingEvidence3(
    block: DisputeEnhancedEligibilityVisaCompellingEvidence3.Builder.() -> Unit,
): DisputeEnhancedEligibilityVisaCompellingEvidence3 = DisputeEnhancedEligibilityVisaCompellingEvidence3.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "DisputeEnhancedEligibilityVisaCompellingEvidence3 is missing required property '" + name + "'",
            )
