...
public class InlineV1SetupIntentsPostRequestFormMandateDataAnyOf1OnlineX0371edbf(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1SetupIntentsPostRequestFormMandateDataAnyOf1OnlineX0371edbf = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1SetupIntentsPostRequestFormMandateDataAnyOf1OnlineX0371edbf> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SetupIntentsPostRequestFormMandateDataAnyOf1OnlineX0371edbf must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SetupIntentsPostRequestFormMandateDataAnyOf1OnlineX0371edbf,
        ) {
            val jsonEncoder =
...
public fun inlineV1SetupIntentsPostRequestFormMandateDataAnyOf1OnlineX0371edbf(
    block: InlineV1SetupIntentsPostRequestFormMandateDataAnyOf1OnlineX0371edbf.Builder.() -> Unit,
): InlineV1SetupIntentsPostRequestFormMandateDataAnyOf1OnlineX0371edbf =
    InlineV1SetupIntentsPostRequestFormMandateDataAnyOf1OnlineX0371edbf.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1SetupIntentsPostRequestFormMandateDataAnyOf1OnlineX0371edbf is missing required property '" +
                    name +
                    "'",
            )
