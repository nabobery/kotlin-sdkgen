...
public class InlineV1IdentityVerificationSessionsPostRequestFormX0c6f0bda(
     ...
     */
    public val providedDetails: InlineV1IdentityVerificationSessionsPostRequestFormProvidedDetailsX4215b0d0? = null,
    /**
     * Customer ID
     */
     ...
     */
    public val relatedPerson: InlineV1IdentityVerificationSessionsPostRequestFormRelatedPersonX361bb9e0? = null,
    /**
    ...
    public class Builder {
        ...
        public fun build(): InlineV1IdentityVerificationSessionsPostRequestFormX0c6f0bda =
            InlineV1IdentityVerificationSessionsPostRequestFormX0c6f0bda(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1IdentityVerificationSessionsPostRequestFormX0c6f0bda =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1IdentityVerificationSessionsPostRequestFormX0c6f0bda> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1IdentityVerificationSessionsPostRequestFormX0c6f0bda {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1IdentityVerificationSessionsPostRequestFormX0c6f0bda must be a JSON object",
                    )
            return InlineV1IdentityVerificationSessionsPostRequestFormX0c6f0bda(
                ...
                options =
                    rawObject["options"]?.let {
                        json.decodeFromJsonElement<InlineV1IdentityVerificationSessionsPostRequestFormOptionsX5cb43707>(
                            it,
                        )
                    },
                providedDetails =
                    rawObject["provided_details"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1IdentityVerificationSessionsPostRequestFormProvidedDetailsX4215b0d0>(
                                it,
                            )
                    },
                relatedCustomer = rawObject["related_customer"]?.let { json.decodeFromJsonElement<String>(it) },
                relatedCustomerAccount =
                    rawObject["related_customer_account"]?.let {
                        json
                ...
                relatedPerson =
                    rawObject["related_person"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1IdentityVerificationSessionsPostRequestFormRelatedPersonX361bb9e0>(
                                it,
                            )
                    },
                ...
                type =
                    rawObject["type"]?.let {
                        json.decodeFromJsonElement<InlineV1IdentityVerificationSessionsPostRequestFormTypeX11225b46>(it)
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IdentityVerificationSessionsPostRequestFormX0c6f0bda,
        ) {
...
public fun inlineV1IdentityVerificationSessionsPostRequestFormX0c6f0bda(
    block: InlineV1IdentityVerificationSessionsPostRequestFormX0c6f0bda.Builder.() -> Unit,
): InlineV1IdentityVerificationSessionsPostRequestFormX0c6f0bda =
    InlineV1IdentityVerificationSessionsPostRequestFormX0c6f0bda.build(block)
