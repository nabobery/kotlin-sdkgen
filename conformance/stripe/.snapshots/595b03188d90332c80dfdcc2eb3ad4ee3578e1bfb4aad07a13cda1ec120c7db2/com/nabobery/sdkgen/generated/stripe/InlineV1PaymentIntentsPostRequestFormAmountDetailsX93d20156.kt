...
internal data class InlineV1PaymentIntentsPostRequestFormAmountDetailsX93d20156Inspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesInlineV1PaymentIntentsPostRequestFormAmountDetailsAnyOf1X4eb31720,
                matchesInlineV1PaymentIntentsPostRequestFormAmountDetailsAnyOf2X6e344e71,
            ).count {
                it
            }
}
...
public class InlineV1PaymentIntentsPostRequestFormAmountDetailsX93d20156 internal constructor(
    ...
    public val inlineV1PaymentIntentsPostRequestFormAmountDetailsAnyOf1X4eb31720:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1PaymentIntentsPostRequestFormAmountDetailsAnyOf1X4eb31720) {
                json
                    .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormAmountDetailsAnyOf1X4eb31720>(
                        raw,
                    )
            } else {
                null
    ...
    public val inlineV1PaymentIntentsPostRequestFormAmountDetailsAnyOf2X6e344e71:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1PaymentIntentsPostRequestFormAmountDetailsAnyOf2X6e344e71) {
                json
                    .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormAmountDetailsAnyOf2X6e344e71>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1PaymentIntentsPostRequestFormAmountDetailsX93d20156Branch>
        get() =
            buildSet {
                if (inspection.matchesInlineV1PaymentIntentsPostRequestFormAmountDetailsAnyOf1X4eb31720) {
                    add(
                        InlineV1PaymentIntentsPostRequestFormAmountDetailsX93d20156Branch.InlineV1PaymentIntentsPostRequestFormAmountDetailsAnyOf1X4eb31720,
                    )
                }
                if (inspection.matchesInlineV1PaymentIntentsPostRequestFormAmountDetailsAnyOf2X6e344e71) {
                    add(
                        InlineV1PaymentIntentsPostRequestFormAmountDetailsX93d20156Branch.InlineV1PaymentIntentsPostRequestFormAmountDetailsAnyOf2X6e344e71,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1PaymentIntentsPostRequestFormAmountDetailsX93d20156 {
            val inspection = inspectInlineV1PaymentIntentsPostRequestFormAmountDetailsX93d20156(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1PaymentIntentsPostRequestFormAmountDetailsX93d20156NoMatchException(
                    "InlineV1PaymentIntentsPostRequestFormAmountDetailsX93d20156 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormAmountDetailsX93d20156> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormAmountDetailsX93d20156,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1PaymentIntentsPostRequestFormAmountDetailsX93d20156",
...
private fun inspectInlineV1PaymentIntentsPostRequestFormAmountDetailsX93d20156(
    element: JsonElement,
): InlineV1PaymentIntentsPostRequestFormAmountDetailsX93d20156Inspection {
    val matchesInlineV1PaymentIntentsPostRequestFormAmountDetailsAnyOf1X4eb31720 =
        element
            .isJsonDecodable<InlineV1PaymentIntentsPostRequestFormAmountDetailsAnyOf1X4eb31720>()
    val matchesInlineV1PaymentIntentsPostRequestFormAmountDetailsAnyOf2X6e344e71 =
        element
            .isJsonDecodable<InlineV1PaymentIntentsPostRequestFormAmountDetailsAnyOf2X6e344e71>()
    return InlineV1PaymentIntentsPostRequestFormAmountDetailsX93d20156Inspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1PaymentIntentsPostRequestFormAmountDetailsAnyOf1X4eb31720) {
                    add(
                        "InlineV1PaymentIntentsPostRequestFormAmountDetailsAnyOf1X4eb31720: value does not match InlineV1PaymentIntentsPostRequestFormAmountDetailsAnyOf1X4eb31720",
                    )
                }
                if (!matchesInlineV1PaymentIntentsPostRequestFormAmountDetailsAnyOf2X6e344e71) {
                    add(
                        "InlineV1PaymentIntentsPostRequestFormAmountDetailsAnyOf2X6e344e71: value does not match InlineV1PaymentIntentsPostRequestFormAmountDetailsAnyOf2X6e344e71",
                    )
                }
            },
    )
