...
public class InlineV1PaymentIntentsCapturePostRequestFormAmountDetailsCardPresentX0e169525(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1PaymentIntentsCapturePostRequestFormAmountDetailsCardPresentX0e169525 =
            InlineV1PaymentIntentsCapturePostRequestFormAmountDetailsCardPresentX0e169525(
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsCapturePostRequestFormAmountDetailsCardPresentX0e169525> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsCapturePostRequestFormAmountDetailsCardPresentX0e169525 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsCapturePostRequestFormAmountDetailsCardPresentX0e169525,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentIntentsCapturePostRequestFormAmountDetailsCardPresentX0e169525(
    block: InlineV1PaymentIntentsCapturePostRequestFormAmountDetailsCardPresentX0e169525.Builder.() -> Unit,
): InlineV1PaymentIntentsCapturePostRequestFormAmountDetailsCardPresentX0e169525 =
