...
public class InlineV1TerminalConfigurationsPostRequestFormWifiAnyOf1EnterpriseEapTlsX6e01ac54(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1TerminalConfigurationsPostRequestFormWifiAnyOf1EnterpriseEapTlsX6e01ac54 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TerminalConfigurationsPostRequestFormWifiAnyOf1EnterpriseEapTlsX6e01ac54> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TerminalConfigurationsPostRequestFormWifiAnyOf1EnterpriseEapTlsX6e01ac54 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TerminalConfigurationsPostRequestFormWifiAnyOf1EnterpriseEapTlsX6e01ac54,
        ) {
            val jsonEncoder =
...
public fun inlineV1TerminalConfigurationsPostRequestFormWifiAnyOf1EnterpriseEapTlsX6e01ac54(
    block: InlineV1TerminalConfigurationsPostRequestFormWifiAnyOf1EnterpriseEapTlsX6e01ac54.Builder.() -> Unit,
): InlineV1TerminalConfigurationsPostRequestFormWifiAnyOf1EnterpriseEapTlsX6e01ac54 =
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TerminalConfigurationsPostRequestFormWifiAnyOf1EnterpriseEapTlsX6e01ac54 is missing required property '" +
                    name +
                    "'",
            )
