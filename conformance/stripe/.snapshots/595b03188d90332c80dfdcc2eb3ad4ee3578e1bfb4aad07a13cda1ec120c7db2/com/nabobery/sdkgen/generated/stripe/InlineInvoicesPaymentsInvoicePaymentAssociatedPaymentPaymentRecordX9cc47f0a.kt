...
public class InlineInvoicesPaymentsInvoicePaymentAssociatedPaymentPaymentRecordX9cc47f0a internal constructor(
    ...
    private val inspection: InlineInvoicesPaymentsInvoicePaymentAssociatedPaymentPaymentRecordX9cc47f0aInspection,
) {
    ...
    public val paymentRecord: PaymentRecord? by
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesPaymentRecord) json.decodeFromJsonElement<PaymentRecord>(raw) else null
        }
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineInvoicesPaymentsInvoicePaymentAssociatedPaymentPaymentRecordX9cc47f0aBranch.Branch1,
                    )
                }
                if (inspection.matchesPaymentRecord) {
                    add(
                        InlineInvoicesPaymentsInvoicePaymentAssociatedPaymentPaymentRecordX9cc47f0aBranch.PaymentRecord,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineInvoicesPaymentsInvoicePaymentAssociatedPaymentPaymentRecordX9cc47f0a {
            val inspection = inspectInlineInvoicesPaymentsInvoicePaymentAssociatedPaymentPaymentRecordX9cc47f0a(raw)
            if (inspection.matchCount == 0) {
                throw InlineInvoicesPaymentsInvoicePaymentAssociatedPaymentPaymentRecordX9cc47f0aNoMatchException(
                    "InlineInvoicesPaymentsInvoicePaymentAssociatedPaymentPaymentRecordX9cc47f0a matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineInvoicesPaymentsInvoicePaymentAssociatedPaymentPaymentRecordX9cc47f0a> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineInvoicesPaymentsInvoicePaymentAssociatedPaymentPaymentRecordX9cc47f0a,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineInvoicesPaymentsInvoicePaymentAssociatedPaymentPaymentRecordX9cc47f0a",
...
private fun inspectInlineInvoicesPaymentsInvoicePaymentAssociatedPaymentPaymentRecordX9cc47f0a(
    element: JsonElement,
