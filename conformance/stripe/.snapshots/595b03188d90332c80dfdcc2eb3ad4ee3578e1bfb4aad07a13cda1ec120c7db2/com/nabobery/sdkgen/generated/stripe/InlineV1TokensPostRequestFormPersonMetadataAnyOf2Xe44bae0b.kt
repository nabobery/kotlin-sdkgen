...
public sealed class InlineV1TokensPostRequestFormPersonMetadataAnyOf2Xe44bae0b {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1TokensPostRequestFormPersonMetadataAnyOf2Xe44bae0b =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1TokensPostRequestFormPersonMetadataAnyOf2Xe44bae0b> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1TokensPostRequestFormPersonMetadataAnyOf2Xe44bae0b",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1TokensPostRequestFormPersonMetadataAnyOf2Xe44bae0b =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TokensPostRequestFormPersonMetadataAnyOf2Xe44bae0b,
        ) {
