...
public class InlineCardAccountX33cfa039 internal constructor(
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineCardAccountX33cfa039 {
            val inspection = inspectInlineCardAccountX33cfa039(raw)
            if (inspection.matchCount == 0) {
                throw InlineCardAccountX33cfa039NoMatchException(
                    "InlineCardAccountX33cfa039 matched 0 branches: " + inspection.failures.joinToString("; "),
                )
            }
    ...
    public object Serializer : KSerializer<InlineCardAccountX33cfa039> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineCardAccountX33cfa039,
        ) {
