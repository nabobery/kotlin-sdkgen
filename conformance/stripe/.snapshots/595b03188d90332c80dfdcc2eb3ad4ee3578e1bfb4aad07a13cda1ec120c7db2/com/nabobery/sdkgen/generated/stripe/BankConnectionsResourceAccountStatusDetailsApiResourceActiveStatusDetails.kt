...
public class BankConnectionsResourceAccountStatusDetailsApiResourceActiveStatusDetails(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): BankConnectionsResourceAccountStatusDetailsApiResourceActiveStatusDetails = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<BankConnectionsResourceAccountStatusDetailsApiResourceActiveStatusDetails> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "BankConnectionsResourceAccountStatusDetailsApiResourceActiveStatusDetails must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: BankConnectionsResourceAccountStatusDetailsApiResourceActiveStatusDetails,
        ) {
            val jsonEncoder =
...
public fun bankConnectionsResourceAccountStatusDetailsApiResourceActiveStatusDetails(
    block: BankConnectionsResourceAccountStatusDetailsApiResourceActiveStatusDetails.Builder.() -> Unit,
): BankConnectionsResourceAccountStatusDetailsApiResourceActiveStatusDetails =
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "BankConnectionsResourceAccountStatusDetailsApiResourceActiveStatusDetails is missing required property '" +
                    name +
                    "'",
            )
