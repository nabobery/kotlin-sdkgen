...
public data class PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCardDetailsResourceChecksView(
    ...
    public val addressPostalCodeCheck: InlinePaymentsPrimitivesPa4682AddressPostalCodeCheckX7dfbb697? = null,
...
public class PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCardDetailsResourceChecks(
    ...
    public class Builder {
        ...
        public fun build(): PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCardDetailsResourceChecks =
    ...
    public object Serializer : KSerializer<PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCardDetailsResourceChecks> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCardDetailsResourceChecks must be a JSON object",
                    )
                ...
                addressLine1Check =
                    rawObject["address_line1_check"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentsPrimitivesPa4682AddressLine1CheckX96e8577e?>(
                                element,
                            )
                        }
                    },
                addressPostalCodeCheck =
                    rawObject["address_postal_code_check"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlinePaymentsPrimitivesPa4682AddressPostalCodeCheckX7dfbb697?>(
                                element,
                            )
                        }
                    },
                cvcCheck =
                    rawObject["cvc_check"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentsPrimitivesPa4682CvcCheckXfaa08edc?>(element)
                        }
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCardDetailsResourceChecks,
        ) {
            val jsonEncoder =
...
public fun paymentsPrimitivesPaymentRecordsResourcePaymentMethodCardDetailsResourceChecks(
    block: PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCardDetailsResourceChecks.Builder.() -> Unit,
): PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCardDetailsResourceChecks =
