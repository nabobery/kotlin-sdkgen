...
public sealed class InlineSetupIntentPaymentMethodOptionsMandateOptionsPaytoPurposeX6b4ee11f {
    ...
    public object Serializer : KSerializer<InlineSetupIntentPaymentMethodOptionsMandateOptionsPaytoPurposeX6b4ee11f> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineSetupIntentPaymentMethodOptionsMandateOptionsPaytoPurposeX6b4ee11f",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineSetupIntentPaymentMethodOptionsMandateOptionsPaytoPurposeX6b4ee11f = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineSetupIntentPaymentMethodOptionsMandateOptionsPaytoPurposeX6b4ee11f,
        ) {
