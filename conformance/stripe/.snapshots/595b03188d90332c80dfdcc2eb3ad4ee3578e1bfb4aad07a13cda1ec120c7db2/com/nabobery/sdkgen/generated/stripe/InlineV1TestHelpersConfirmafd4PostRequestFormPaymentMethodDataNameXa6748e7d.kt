...
internal data class InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataNameXa6748e7dInspection(
    ...
    public val matchesInlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataAnyOf2Xdeed8fd4: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataAnyOf2Xdeed8fd4,
            ).count {
                it
            }
}
...
public class InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataNameXa6748e7d internal constructor(
    ...
    private val inspection: InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataNameXa6748e7dInspection,
) {
    ...
    public val inlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataAnyOf2Xdeed8fd4:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataAnyOf2Xdeed8fd4) {
                json
                    .decodeFromJsonElement<InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataAnyOf2Xdeed8fd4>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataNameXa6748e7dBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataAnyOf2Xdeed8fd4) {
                    add(
                        InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataNameXa6748e7dBranch.InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataAnyOf2Xdeed8fd4,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataNameXa6748e7d {
            val inspection = inspectInlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataNameXa6748e7d(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataNameXa6748e7dNoMatchException(
                    "InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataNameXa6748e7d matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataNameXa6748e7d> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataNameXa6748e7d,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataNameXa6748e7d",
...
private fun inspectInlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataNameXa6748e7d(
    element: JsonElement,
): InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataNameXa6748e7dInspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataAnyOf2Xdeed8fd4 =
        element
            .isJsonDecodable<InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataAnyOf2Xdeed8fd4>()
    return InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataNameXa6748e7dInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataAnyOf2Xdeed8fd4) {
                    add(
                        "InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataAnyOf2Xdeed8fd4: value does not match InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataAnyOf2Xdeed8fd4",
                    )
                }
            },
    )
