...
public class InlineV1SubscriptionsGetResponse200JsonX03ae3f2d(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1SubscriptionsGetResponse200JsonX03ae3f2d =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1SubscriptionsGetResponse200JsonX03ae3f2d> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SubscriptionsGetResponse200JsonX03ae3f2d must be a JSON object",
                    )
            val data = json.decodeRequired<List<Subscription>>(rawObject, "data")
            val hasMore = json.decodeRequired<Boolean>(rawObject, "has_more")
            val objectValue =
                json.decodeRequired<InlineV1SubscriptionsGetResponse200JsonObjectValueX0c789496>(
                    rawObject,
                    "object",
                )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsGetResponse200JsonX03ae3f2d,
        ) {
...
public fun inlineV1SubscriptionsGetResponse200JsonX03ae3f2d(
    block: InlineV1SubscriptionsGetResponse200JsonX03ae3f2d.Builder.() -> Unit,
): InlineV1SubscriptionsGetResponse200JsonX03ae3f2d = InlineV1SubscriptionsGetResponse200JsonX03ae3f2d.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1SubscriptionsGetResponse200JsonX03ae3f2d is missing required property '" + name + "'",
            )
