...
public class InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPriceDataX9ef5a5aa(
    ...
    public val taxBehavior: InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsTaxBehaviorXd8426dce? = null,
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPriceDataX9ef5a5aa =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPriceDataX9ef5a5aa> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPriceDataX9ef5a5aa must be a JSON object",
                    )
            ...
            return InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPriceDataX9ef5a5aa(
                ...
                taxBehavior =
                    rawObject["tax_behavior"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsTaxBehaviorXd8426dce>(
                                it,
                            )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPriceDataX9ef5a5aa,
        ) {
            val jsonEncoder =
...
public fun inlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPriceDataX9ef5a5aa(
    block: InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPriceDataX9ef5a5aa.Builder.() -> Unit,
): InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPriceDataX9ef5a5aa =
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPriceDataX9ef5a5aa is missing required property '" +
                    name +
                    "'",
            )
