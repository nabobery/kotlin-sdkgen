...
public sealed class InlineV1CustomersSubscriptionsPostRequestFormCancelAtAnyOf2Xa8dc1ed2 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1CustomersSubscriptionsPostRequestFormCancelAtAnyOf2Xa8dc1ed2 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1CustomersSubscriptionsPostRequestFormCancelAtAnyOf2Xa8dc1ed2> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1CustomersSubscriptionsPostRequestFormCancelAtAnyOf2Xa8dc1ed2",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1CustomersSubscriptionsPostRequestFormCancelAtAnyOf2Xa8dc1ed2 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersSubscriptionsPostRequestFormCancelAtAnyOf2Xa8dc1ed2,
        ) {
