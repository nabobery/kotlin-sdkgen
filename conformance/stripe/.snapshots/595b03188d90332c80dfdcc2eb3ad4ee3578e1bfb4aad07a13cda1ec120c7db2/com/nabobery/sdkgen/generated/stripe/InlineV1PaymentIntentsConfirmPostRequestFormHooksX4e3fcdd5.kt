...
public class InlineV1PaymentIntentsConfirmPostRequestFormHooksX4e3fcdd5(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1PaymentIntentsConfirmPostRequestFormHooksX4e3fcdd5 =
            InlineV1PaymentIntentsConfirmPostRequestFormHooksX4e3fcdd5(
                inputs = inputs,
            )
    }

    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PaymentIntentsConfirmPostRequestFormHooksX4e3fcdd5 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentIntentsConfirmPostRequestFormHooksX4e3fcdd5> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsConfirmPostRequestFormHooksX4e3fcdd5 must be a JSON object",
                    )
            return InlineV1PaymentIntentsConfirmPostRequestFormHooksX4e3fcdd5(
                inputs =
                    rawObject["inputs"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormHooksInputsXfc33d122>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsConfirmPostRequestFormHooksX4e3fcdd5,
        ) {
...
public fun inlineV1PaymentIntentsConfirmPostRequestFormHooksX4e3fcdd5(
    block: InlineV1PaymentIntentsConfirmPostRequestFormHooksX4e3fcdd5.Builder.() -> Unit,
): InlineV1PaymentIntentsConfirmPostRequestFormHooksX4e3fcdd5 =
    InlineV1PaymentIntentsConfirmPostRequestFormHooksX4e3fcdd5.build(block)
