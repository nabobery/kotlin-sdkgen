...
public class InlineV1SourcesPostRequestFormMandateAcceptanceOnlineXec4393f4(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1SourcesPostRequestFormMandateAcceptanceOnlineXec4393f4 =
            InlineV1SourcesPostRequestFormMandateAcceptanceOnlineXec4393f4(
                date = date,
                ip = ip,
                userAgent = userAgent,
            )
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1SourcesPostRequestFormMandateAcceptanceOnlineXec4393f4 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1SourcesPostRequestFormMandateAcceptanceOnlineXec4393f4> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SourcesPostRequestFormMandateAcceptanceOnlineXec4393f4 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SourcesPostRequestFormMandateAcceptanceOnlineXec4393f4,
        ) {
            val jsonEncoder =
...
public fun inlineV1SourcesPostRequestFormMandateAcceptanceOnlineXec4393f4(
    block: InlineV1SourcesPostRequestFormMandateAcceptanceOnlineXec4393f4.Builder.() -> Unit,
): InlineV1SourcesPostRequestFormMandateAcceptanceOnlineXec4393f4 =
    InlineV1SourcesPostRequestFormMandateAcceptanceOnlineXec4393f4.build(block)
