...
internal data class InlineV1TaxCalculationsPostRequestFormCustomerDetailsAddressStateXc94aafa6Inspection(
    ...
    public val matchesInlineV1TaxCalculationsPostRequestFormCustomerDetailsAddressStateAnyOf2Xae0cb16c: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1TaxCalculationsPostRequestFormCustomerDetailsAddressStateAnyOf2Xae0cb16c,
            ).count {
                it
            }
}
...
public class InlineV1TaxCalculationsPostRequestFormCustomerDetailsAddressStateXc94aafa6 internal constructor(
    ...
    private val inspection: InlineV1TaxCalculationsPostRequestFormCustomerDetailsAddressStateXc94aafa6Inspection,
) {
    ...
    public val inlineV1TaxCalculationsPostRequestFormCustomerDetailsAddressStateAnyOf2Xae0cb16c:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1TaxCalculationsPostRequestFormCustomerDetailsAddressStateAnyOf2Xae0cb16c) {
                json
                    .decodeFromJsonElement<InlineV1TaxCalculationsPostRequestFormCustomerDetailsAddressStateAnyOf2Xae0cb16c>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1TaxCalculationsPostRequestFormCustomerDetailsAddressStateXc94aafa6Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1TaxCalculationsPostRequestFormCustomerDetailsAddressStateAnyOf2Xae0cb16c) {
                    add(
                        InlineV1TaxCalculationsPostRequestFormCustomerDetailsAddressStateXc94aafa6Branch.InlineV1TaxCalculationsPostRequestFormCustomerDetailsAddressStateAnyOf2Xae0cb16c,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1TaxCalculationsPostRequestFormCustomerDetailsAddressStateXc94aafa6 {
            val inspection = inspectInlineV1TaxCalculationsPostRequestFormCustomerDetailsAddressStateXc94aafa6(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1TaxCalculationsPostRequestFormCustomerDetailsAddressStateXc94aafa6NoMatchException(
                    "InlineV1TaxCalculationsPostRequestFormCustomerDetailsAddressStateXc94aafa6 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1TaxCalculationsPostRequestFormCustomerDetailsAddressStateXc94aafa6> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TaxCalculationsPostRequestFormCustomerDetailsAddressStateXc94aafa6,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1TaxCalculationsPostRequestFormCustomerDetailsAddressStateXc94aafa6",
...
private fun inspectInlineV1TaxCalculationsPostRequestFormCustomerDetailsAddressStateXc94aafa6(
    element: JsonElement,
): InlineV1TaxCalculationsPostRequestFormCustomerDetailsAddressStateXc94aafa6Inspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1TaxCalculationsPostRequestFormCustomerDetailsAddressStateAnyOf2Xae0cb16c =
        element
            .isJsonDecodable<InlineV1TaxCalculationsPostRequestFormCustomerDetailsAddressStateAnyOf2Xae0cb16c>()
    return InlineV1TaxCalculationsPostRequestFormCustomerDetailsAddressStateXc94aafa6Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1TaxCalculationsPostRequestFormCustomerDetailsAddressStateAnyOf2Xae0cb16c) {
                    add(
                        "InlineV1TaxCalculationsPostRequestFormCustomerDetailsAddressStateAnyOf2Xae0cb16c: value does not match InlineV1TaxCalculationsPostRequestFormCustomerDetailsAddressStateAnyOf2Xae0cb16c",
                    )
                }
            },
    )
