...
public sealed class InlineV1CustomersSubscriptionsPostRequestFormIntervalX81a3d181 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1CustomersSubscriptionsPostRequestFormIntervalX81a3d181 =
            when (value) {
                Day.value -> Day
                Month.value -> Month
                Week.value -> Week
    ...
    public object Serializer : KSerializer<InlineV1CustomersSubscriptionsPostRequestFormIntervalX81a3d181> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1CustomersSubscriptionsPostRequestFormIntervalX81a3d181",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1CustomersSubscriptionsPostRequestFormIntervalX81a3d181 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersSubscriptionsPostRequestFormIntervalX81a3d181,
        ) {
