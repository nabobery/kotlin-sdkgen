...
public class InlineV1InvoicesFinalizePostRequestFormXef2b05e1(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1InvoicesFinalizePostRequestFormXef2b05e1 =
            InlineV1InvoicesFinalizePostRequestFormXef2b05e1(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1InvoicesFinalizePostRequestFormXef2b05e1 =
    ...
    public object Serializer : KSerializer<InlineV1InvoicesFinalizePostRequestFormXef2b05e1> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1InvoicesFinalizePostRequestFormXef2b05e1 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesFinalizePostRequestFormXef2b05e1,
        ) {
...
public fun inlineV1InvoicesFinalizePostRequestFormXef2b05e1(
    block: InlineV1InvoicesFinalizePostRequestFormXef2b05e1.Builder.() -> Unit,
): InlineV1InvoicesFinalizePostRequestFormXef2b05e1 = InlineV1InvoicesFinalizePostRequestFormXef2b05e1.build(block)
