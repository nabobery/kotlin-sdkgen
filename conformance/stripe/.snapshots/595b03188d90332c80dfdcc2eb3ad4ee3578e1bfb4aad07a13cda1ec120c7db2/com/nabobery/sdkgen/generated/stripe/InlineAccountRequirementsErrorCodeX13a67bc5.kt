...
public sealed class InlineAccountRequirementsErrorCodeX13a67bc5 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineAccountRequirementsErrorCodeX13a67bc5 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineAccountRequirementsErrorCodeX13a67bc5> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineAccountRequirementsErrorCodeX13a67bc5",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineAccountRequirementsErrorCodeX13a67bc5 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineAccountRequirementsErrorCodeX13a67bc5,
        ) {
