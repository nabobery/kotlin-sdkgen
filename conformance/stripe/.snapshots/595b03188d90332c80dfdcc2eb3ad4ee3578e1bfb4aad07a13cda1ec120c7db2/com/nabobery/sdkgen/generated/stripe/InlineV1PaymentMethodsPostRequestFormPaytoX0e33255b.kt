...
public class InlineV1PaymentMethodsPostRequestFormPaytoX0e33255b(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1PaymentMethodsPostRequestFormPaytoX0e33255b =
            InlineV1PaymentMethodsPostRequestFormPaytoX0e33255b(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PaymentMethodsPostRequestFormPaytoX0e33255b =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentMethodsPostRequestFormPaytoX0e33255b> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentMethodsPostRequestFormPaytoX0e33255b must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentMethodsPostRequestFormPaytoX0e33255b,
        ) {
...
public fun inlineV1PaymentMethodsPostRequestFormPaytoX0e33255b(
    block: InlineV1PaymentMethodsPostRequestFormPaytoX0e33255b.Builder.() -> Unit,
): InlineV1PaymentMethodsPostRequestFormPaytoX0e33255b =
    InlineV1PaymentMethodsPostRequestFormPaytoX0e33255b.build(block)
