...
public class InlineV1ChargesPostRequestFormCardAnyOf1X47b2c78d(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1ChargesPostRequestFormCardAnyOf1X47b2c78d =
    ...
    public object Serializer : KSerializer<InlineV1ChargesPostRequestFormCardAnyOf1X47b2c78d> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1ChargesPostRequestFormCardAnyOf1X47b2c78d must be a JSON object",
                    )
            ...
            return InlineV1ChargesPostRequestFormCardAnyOf1X47b2c78d(
                ...
                networkToken =
                    rawObject["network_token"]?.let {
                        json.decodeFromJsonElement<InlineV1ChargesPostRequestFormCardAnyOf1NetworkTokenX5841a88b>(it)
                    },
                objectValue =
                    rawObject["object"]?.let {
                        json.decodeFromJsonElement<InlineV1ChargesPostRequestFormCardAnyOf1ObjectValueXe0421c7e>(it)
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ChargesPostRequestFormCardAnyOf1X47b2c78d,
        ) {
...
public fun inlineV1ChargesPostRequestFormCardAnyOf1X47b2c78d(
    block: InlineV1ChargesPostRequestFormCardAnyOf1X47b2c78d.Builder.() -> Unit,
): InlineV1ChargesPostRequestFormCardAnyOf1X47b2c78d = InlineV1ChargesPostRequestFormCardAnyOf1X47b2c78d.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1ChargesPostRequestFormCardAnyOf1X47b2c78d is missing required property '" + name + "'",
            )
