...
public class PaymentPagesCheckoutSessionTaxId(
    ...
    public object Serializer : KSerializer<PaymentPagesCheckoutSessionTaxId> {
        ...
        override fun deserialize(decoder: Decoder): PaymentPagesCheckoutSessionTaxId {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentPagesCheckoutSessionTaxId must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentPagesCheckoutSessionTaxId,
        ) {
...
public fun paymentPagesCheckoutSessionTaxId(
    block: PaymentPagesCheckoutSessionTaxId.Builder.() -> Unit,
): PaymentPagesCheckoutSessionTaxId = PaymentPagesCheckoutSessionTaxId.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "PaymentPagesCheckoutSessionTaxId is missing required property '" + name + "'",
            )
