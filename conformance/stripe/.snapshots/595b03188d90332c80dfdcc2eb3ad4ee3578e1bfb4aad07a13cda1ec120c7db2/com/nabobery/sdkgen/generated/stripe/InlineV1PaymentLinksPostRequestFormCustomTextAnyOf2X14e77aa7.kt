...
public sealed class InlineV1PaymentLinksPostRequestFormCustomTextAnyOf2X14e77aa7 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1PaymentLinksPostRequestFormCustomTextAnyOf2X14e77aa7 =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1PaymentLinksPostRequestFormCustomTextAnyOf2X14e77aa7> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1PaymentLinksPostRequestFormCustomTextAnyOf2X14e77aa7",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1PaymentLinksPostRequestFormCustomTextAnyOf2X14e77aa7 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentLinksPostRequestFormCustomTextAnyOf2X14e77aa7,
        ) {
