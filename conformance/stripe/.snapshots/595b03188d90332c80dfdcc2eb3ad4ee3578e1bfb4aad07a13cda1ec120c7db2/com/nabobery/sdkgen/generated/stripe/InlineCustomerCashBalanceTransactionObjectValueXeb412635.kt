...
public sealed class InlineCustomerCashBalanceTransactionObjectValueXeb412635 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineCustomerCashBalanceTransactionObjectValueXeb412635 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineCustomerCashBalanceTransactionObjectValueXeb412635> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineCustomerCashBalanceTransactionObjectValueXeb412635",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineCustomerCashBalanceTransactionObjectValueXeb412635 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineCustomerCashBalanceTransactionObjectValueXeb412635,
        ) {
