...
public class PaymentIntentPaymentMethodOptionsMandateOptionsPayto(
     ...
     */
    public val amountType: InlinePaymentIntentPaymentMethodOptionsMandateOptionsPaytoAmountTypeX1f60e6d6? = null,
    /**
     ...
     */
    public val purpose: InlinePaymentIntentPaymentMethodOptionsMandateOptionsPaytoPurposeX0069ff7e? = null,
) {
    public class Builder {
        ...
        public fun build(): PaymentIntentPaymentMethodOptionsMandateOptionsPayto =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentIntentPaymentMethodOptionsMandateOptionsPayto =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentIntentPaymentMethodOptionsMandateOptionsPayto> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "PaymentIntentPaymentMethodOptionsMandateOptionsPayto must be a JSON object",
                    )
                ...
                amountType =
                    rawObject["amount_type"]?.let { element ->
                        if (element ==
                            ...
                            json
                                .decodeFromJsonElement<InlinePaymentIntentPaymentMethodOptionsMandateOptionsPaytoAmountTypeX1f60e6d6?>(
                                    element,
                                )
                        }
                    },
                ...
                paymentSchedule =
                    rawObject["payment_schedule"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentIntentPayment208fPaymentScheduleXb0e371f9?>(element)
                        }
                    },
                paymentsPerPeriod =
                ...
                purpose =
                    rawObject["purpose"]?.let { element ->
                        if (element ==
                            ...
                            json
                                .decodeFromJsonElement<InlinePaymentIntentPaymentMethodOptionsMandateOptionsPaytoPurposeX0069ff7e?>(
                                    element,
                                )
                        }
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentIntentPaymentMethodOptionsMandateOptionsPayto,
        ) {
...
public fun paymentIntentPaymentMethodOptionsMandateOptionsPayto(
    block: PaymentIntentPaymentMethodOptionsMandateOptionsPayto.Builder.() -> Unit,
): PaymentIntentPaymentMethodOptionsMandateOptionsPayto =
    PaymentIntentPaymentMethodOptionsMandateOptionsPayto.build(block)
