...
public class InlineV1CreditNotesPostRequestFormRefundsItemX1217bf2d(
    ...
    public val paymentRecordRefund: InlineV1CreditNotesPostRequestFormRefundsItemPaymentRecordRefundXda8fb51b? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1CreditNotesPostRequestFormRefundsItemX1217bf2d =
            InlineV1CreditNotesPostRequestFormRefundsItemX1217bf2d(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1CreditNotesPostRequestFormRefundsItemX1217bf2d =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1CreditNotesPostRequestFormRefundsItemX1217bf2d> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1CreditNotesPostRequestFormRefundsItemX1217bf2d {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CreditNotesPostRequestFormRefundsItemX1217bf2d must be a JSON object",
                    )
            return InlineV1CreditNotesPostRequestFormRefundsItemX1217bf2d(
                ...
                paymentRecordRefund =
                    rawObject["payment_record_refund"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CreditNotesPostRequestFormRefundsItemPaymentRecordRefundXda8fb51b>(
                                it,
                            )
                    },
                ...
                type =
                    rawObject["type"]?.let {
                        json.decodeFromJsonElement<InlineV1CreditNotesPostRequestFormRefundsItemTypeXdf1f77f4>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CreditNotesPostRequestFormRefundsItemX1217bf2d,
        ) {
...
public fun inlineV1CreditNotesPostRequestFormRefundsItemX1217bf2d(
    block: InlineV1CreditNotesPostRequestFormRefundsItemX1217bf2d.Builder.() -> Unit,
): InlineV1CreditNotesPostRequestFormRefundsItemX1217bf2d =
    InlineV1CreditNotesPostRequestFormRefundsItemX1217bf2d.build(block)
