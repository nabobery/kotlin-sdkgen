...
public class SourceOrder(
     ...
     */
    public val items: List<SourceOrderItem>? = null,
    ...
    public class Builder {
         ...
         * List of items constituting the order.
         */
        public var items: List<SourceOrderItem>? = null
        ...
        override fun deserialize(decoder: Decoder): SourceOrder {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("SourceOrder must be a JSON object")
            ...
            return SourceOrder(
                ...
                items =
                    rawObject["items"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<List<SourceOrderItem>?>(element)
                        }
                    },
