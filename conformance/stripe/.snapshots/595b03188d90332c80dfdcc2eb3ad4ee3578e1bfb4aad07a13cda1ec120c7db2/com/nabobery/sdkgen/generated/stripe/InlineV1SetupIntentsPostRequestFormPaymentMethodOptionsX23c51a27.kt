...
public class InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsX23c51a27(
    public val acssDebit: InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsAcssDebitX18c92550? = null,
    public val amazonPay: JsonObject? = null,
    public val bacsDebit: InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsBacsDebitX2ae3143b? = null,
    ...
    public val sepaDebit: InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsSepaDebitXfa2c9f6c? = null,
    public val upi: InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsUpiXe7418122? = null,
    public val usBankAccount: InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsUsBankAccountXc479df7f? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsX23c51a27 =
            InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsX23c51a27(
                acssDebit = acssDebit,
                amazonPay = amazonPay,
                bacsDebit = bacsDebit,
                bizum = bizum,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsX23c51a27 =
    ...
    public object Serializer : KSerializer<InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsX23c51a27> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsX23c51a27 must be a JSON object",
                    )
            return InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsX23c51a27(
                acssDebit =
                    rawObject["acss_debit"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsAcssDebitX18c92550>(
                                it,
                            )
                    },
                ...
                bacsDebit =
                    rawObject["bacs_debit"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsBacsDebitX2ae3143b>(
                                it,
                            )
                    },
                ...
                card =
                    rawObject["card"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsCardX5a9b8b8e>(
                                it,
                            )
                    },
                ...
                klarna =
                    rawObject["klarna"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsKlarnaXfe74315b>(
                                it,
                            )
                    },
                ...
                paypal =
                    rawObject["paypal"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsPaypalX563c94ee>(
                                it,
                            )
                    },
                payto =
                    rawObject["payto"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsPaytoXe13833dd>(
                                it,
                            )
                    },
                pix =
                    rawObject["pix"]?.let {
                        json.decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsPixXeb917509>(
                            it,
                        )
                    },
                sepaDebit =
                    rawObject["sepa_debit"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsSepaDebitXfa2c9f6c>(
                                it,
                            )
                    },
                upi =
                    rawObject["upi"]?.let {
                        json.decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsUpiXe7418122>(
                            it,
                        )
                    },
                usBankAccount =
                    rawObject["us_bank_account"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsUsBankAccountXc479df7f>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsX23c51a27,
        ) {
            val jsonEncoder =
...
public fun inlineV1SetupIntentsPostRequestFormPaymentMethodOptionsX23c51a27(
    block: InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsX23c51a27.Builder.() -> Unit,
): InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsX23c51a27 =
