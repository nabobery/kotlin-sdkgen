...
public data class IssuingCardholderCardIssuingView(
    ...
    public val userTermsAcceptance: InlineIssuingCardholderCardIssuingUserTermsAcceptanceXc4c75b48? = null,
)
...
public class IssuingCardholderCardIssuing(
    ...
    public class Builder {
        ...
        public fun build(): IssuingCardholderCardIssuing =
    ...
    public object Serializer : KSerializer<IssuingCardholderCardIssuing> {
        ...
        override fun deserialize(decoder: Decoder): IssuingCardholderCardIssuing {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("IssuingCardholderCardIssuing must be a JSON object")
            return IssuingCardholderCardIssuing(
                userTermsAcceptance =
                    rawObject["user_terms_acceptance"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineIssuingCardholderCardIssuingUserTermsAcceptanceXc4c75b48?>(
                                element,
                            )
                        }
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: IssuingCardholderCardIssuing,
        ) {
...
public fun issuingCardholderCardIssuing(
    block: IssuingCardholderCardIssuing.Builder.() -> Unit,
): IssuingCardholderCardIssuing = IssuingCardholderCardIssuing.build(block)
