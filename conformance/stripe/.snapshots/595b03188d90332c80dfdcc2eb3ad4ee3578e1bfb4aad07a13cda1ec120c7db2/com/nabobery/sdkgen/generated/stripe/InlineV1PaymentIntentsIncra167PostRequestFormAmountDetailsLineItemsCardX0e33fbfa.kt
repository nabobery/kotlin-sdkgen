...
public class InlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsLineItemsCardX0e33fbfa(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsLineItemsCardX0e33fbfa =
            InlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsLineItemsCardX0e33fbfa(
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsLineItemsCardX0e33fbfa> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsLineItemsCardX0e33fbfa must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsLineItemsCardX0e33fbfa,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsLineItemsCardX0e33fbfa(
    block: InlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsLineItemsCardX0e33fbfa.Builder.() -> Unit,
): InlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsLineItemsCardX0e33fbfa =
    InlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsLineItemsCardX0e33fbfa.build(block)
