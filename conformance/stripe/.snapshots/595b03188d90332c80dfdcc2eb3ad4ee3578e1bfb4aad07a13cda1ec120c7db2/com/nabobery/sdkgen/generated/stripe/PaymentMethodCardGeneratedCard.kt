...
public data class PaymentMethodCardGeneratedCardView(
    ...
    public val paymentMethodDetails: InlinePaymentMethodCardGeneratedCardPaymentMethodDetailsX44f490d9? = null,
...
public class PaymentMethodCardGeneratedCard(
    ...
    public class Builder {
        ...
        public fun build(): PaymentMethodCardGeneratedCard =
    ...
    public object Serializer : KSerializer<PaymentMethodCardGeneratedCard> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodCardGeneratedCard {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodCardGeneratedCard must be a JSON object")
                ...
                paymentMethodDetails =
                    rawObject["payment_method_details"]?.let { element ->
                        if (element ==
                            ...
                            json
                                .decodeFromJsonElement<InlinePaymentMethodCardGeneratedCardPaymentMethodDetailsX44f490d9?>(
                                    element,
                                )
                        }
                    },
                setupAttempt =
                    rawObject["setup_attempt"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentMethodCardGeneratedCardSetupAttemptX3d2ada0d?>(
                                element,
                            )
                        }
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentMethodCardGeneratedCard,
        ) {
...
public fun paymentMethodCardGeneratedCard(
    block: PaymentMethodCardGeneratedCard.Builder.() -> Unit,
): PaymentMethodCardGeneratedCard = PaymentMethodCardGeneratedCard.build(block)
