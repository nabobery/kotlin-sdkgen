...
public class InlineInvoicePaymentInvoiceXd7bd6515 internal constructor(
    ...
    public val deletedInvoice: DeletedInvoice? by
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesDeletedInvoice) json.decodeFromJsonElement<DeletedInvoice>(raw) else null
        }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineInvoicePaymentInvoiceXd7bd6515 {
            val inspection = inspectInlineInvoicePaymentInvoiceXd7bd6515(raw)
            if (inspection.matchCount == 0) {
                throw InlineInvoicePaymentInvoiceXd7bd6515NoMatchException(
                    "InlineInvoicePaymentInvoiceXd7bd6515 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineInvoicePaymentInvoiceXd7bd6515> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineInvoicePaymentInvoiceXd7bd6515,
        ) {
...
private fun inspectInlineInvoicePaymentInvoiceXd7bd6515(
    element: JsonElement,
): InlineInvoicePaymentInvoiceXd7bd6515Inspection {
