...
public class PaymentLinksResourceAfterCompletion(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentLinksResourceAfterCompletion =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentLinksResourceAfterCompletion> {
        ...
        override fun deserialize(decoder: Decoder): PaymentLinksResourceAfterCompletion {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentLinksResourceAfterCompletion must be a JSON object")
            ...
            return PaymentLinksResourceAfterCompletion(
                ...
                hostedConfirmation =
                    rawObject["hosted_confirmation"]?.let {
                        json.decodeFromJsonElement<PaymentLinksResourceCompletionBehaviorConfirmationPage>(it)
                    },
                redirect =
                    rawObject["redirect"]?.let {
                        json.decodeFromJsonElement<PaymentLinksResourceCompletionBehaviorRedirect>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentLinksResourceAfterCompletion,
        ) {
...
public fun paymentLinksResourceAfterCompletion(
    block: PaymentLinksResourceAfterCompletion.Builder.() -> Unit,
): PaymentLinksResourceAfterCompletion = PaymentLinksResourceAfterCompletion.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "PaymentLinksResourceAfterCompletion is missing required property '" + name + "'",
            )
