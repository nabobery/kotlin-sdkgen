...
public class InlineV1CustomersSourcesDeleteResponse200JsonXf22f4818 internal constructor(
        ...
        get() =
            buildSet {
                if (inspection.matchesPaymentSource) {
                    add(
                        InlineV1CustomersSourcesDeleteResponse200JsonXf22f4818Branch.PaymentSource,
                    )
                }
                if (inspection.matchesDeletedPaymentSource) {
                    add(
                        InlineV1CustomersSourcesDeleteResponse200JsonXf22f4818Branch.DeletedPaymentSource,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1CustomersSourcesDeleteResponse200JsonXf22f4818 {
            val inspection = inspectInlineV1CustomersSourcesDeleteResponse200JsonXf22f4818(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1CustomersSourcesDeleteResponse200JsonXf22f4818NoMatchException(
                    "InlineV1CustomersSourcesDeleteResponse200JsonXf22f4818 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1CustomersSourcesDeleteResponse200JsonXf22f4818> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersSourcesDeleteResponse200JsonXf22f4818,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1CustomersSourcesDeleteResponse200JsonXf22f4818",
...
private fun inspectInlineV1CustomersSourcesDeleteResponse200JsonXf22f4818(
    element: JsonElement,
): InlineV1CustomersSourcesDeleteResponse200JsonXf22f4818Inspection {
