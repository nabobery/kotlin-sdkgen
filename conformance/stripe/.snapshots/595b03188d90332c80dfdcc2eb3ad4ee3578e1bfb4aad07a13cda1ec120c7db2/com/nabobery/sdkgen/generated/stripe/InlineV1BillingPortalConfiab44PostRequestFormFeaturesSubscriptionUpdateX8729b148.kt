...
public class InlineV1BillingPortalConfiab44PostRequestFormFeaturesSubscriptionUpdateX8729b148(
    ...
    public val defaultAllowedUpdates: InlineV1BillingPortalConfiab44PostRequestFormDefaultAllowedUpdatesXb146ab46? = null,
    public val products: InlineV1BillingPortalConfiab44PostRequestFormFeaturesProductsXa0475aee? = null,
    public val prorationBehavior: InlineV1BillingPortalConfiab44PostRequestFormFeaturesProrationBehaviorXacaab4b1? = null,
    public val scheduleAtPeriodEnd: InlineV1BillingPortalConfiab44PostRequestFormScheduleAtPeriodEndX87090e60? = null,
    public val trialUpdateBehavior: InlineV1BillingPortalConfiab44PostRequestFormTrialUpdateBehaviorX7ab893b0? = null,
) {
    ...
    public object Serializer : KSerializer<InlineV1BillingPortalConfiab44PostRequestFormFeaturesSubscriptionUpdateX8729b148> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1BillingPortalConfiab44PostRequestFormFeaturesSubscriptionUpdateX8729b148 must be a JSON object",
                    )
            ...
            return InlineV1BillingPortalConfiab44PostRequestFormFeaturesSubscriptionUpdateX8729b148(
                ...
                billingCycleAnchor =
                    rawObject["billing_cycle_anchor"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1BillingPortalConfiab44PostRequestFormFeaturesBillingCycleAnchorXf481156c>(
                                it,
                            )
                    },
                defaultAllowedUpdates =
                    rawObject["default_allowed_updates"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1BillingPortalConfiab44PostRequestFormDefaultAllowedUpdatesXb146ab46>(
                                it,
                            )
                    },
                products =
                    rawObject["products"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1BillingPortalConfiab44PostRequestFormFeaturesProductsXa0475aee>(
                                it,
                            )
                    },
                prorationBehavior =
                    rawObject["proration_behavior"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1BillingPortalConfiab44PostRequestFormFeaturesProrationBehaviorXacaab4b1>(
                                it,
                            )
                    },
                scheduleAtPeriodEnd =
                    rawObject["schedule_at_period_end"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1BillingPortalConfiab44PostRequestFormScheduleAtPeriodEndX87090e60>(
                                it,
                            )
                    },
                trialUpdateBehavior =
                    rawObject["trial_update_behavior"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1BillingPortalConfiab44PostRequestFormTrialUpdateBehaviorX7ab893b0>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1BillingPortalConfiab44PostRequestFormFeaturesSubscriptionUpdateX8729b148,
        ) {
            val jsonEncoder =
...
public fun inlineV1BillingPortalConfiab44PostRequestFormFeaturesSubscriptionUpdateX8729b148(
    block: InlineV1BillingPortalConfiab44PostRequestFormFeaturesSubscriptionUpdateX8729b148.Builder.() -> Unit,
): InlineV1BillingPortalConfiab44PostRequestFormFeaturesSubscriptionUpdateX8729b148 =
    InlineV1BillingPortalConfiab44PostRequestFormFeaturesSubscriptionUpdateX8729b148.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1BillingPortalConfiab44PostRequestFormFeaturesSubscriptionUpdateX8729b148 is missing required property '" +
                    name +
                    "'",
            )
