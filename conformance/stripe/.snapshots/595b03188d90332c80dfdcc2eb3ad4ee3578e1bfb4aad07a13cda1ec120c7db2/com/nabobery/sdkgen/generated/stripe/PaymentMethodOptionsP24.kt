...
public class PaymentMethodOptionsP24(
    ...
    public class Builder {
        ...
        public fun build(): PaymentMethodOptionsP24 =
    ...
    public object Serializer : KSerializer<PaymentMethodOptionsP24> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodOptionsP24 {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodOptionsP24 must be a JSON object")
            return PaymentMethodOptionsP24(
                setupFutureUsage =
                    rawObject["setup_future_usage"]?.let {
                        json.decodeFromJsonElement<InlinePaymentMethodOptionsP24SetupFutureUsageX16e780a0>(it)
                    },
            )
        }
...
public fun paymentMethodOptionsP24(block: PaymentMethodOptionsP24.Builder.() -> Unit): PaymentMethodOptionsP24 =
    PaymentMethodOptionsP24.build(block)
