...
public class LegalEntityPersonVerificationDocument(
    ...
    public class Builder {
        ...
        public fun build(): LegalEntityPersonVerificationDocument =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): LegalEntityPersonVerificationDocument =
    ...
    public object Serializer : KSerializer<LegalEntityPersonVerificationDocument> {
        ...
        override fun deserialize(decoder: Decoder): LegalEntityPersonVerificationDocument {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("LegalEntityPersonVerificationDocument must be a JSON object")
                ...
                back =
                    rawObject["back"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineLegalEntityPersonVerificationDocumentBackXd6f30a0c?>(
                                element,
                            )
                        }
                    },
                ...
                front =
                    rawObject["front"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineLegalEntityPersonVerificationDocumentFrontX647b8abe?>(
                                element,
                            )
                        }
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: LegalEntityPersonVerificationDocument,
        ) {
...
public fun legalEntityPersonVerificationDocument(
    block: LegalEntityPersonVerificationDocument.Builder.() -> Unit,
): LegalEntityPersonVerificationDocument = LegalEntityPersonVerificationDocument.build(block)
