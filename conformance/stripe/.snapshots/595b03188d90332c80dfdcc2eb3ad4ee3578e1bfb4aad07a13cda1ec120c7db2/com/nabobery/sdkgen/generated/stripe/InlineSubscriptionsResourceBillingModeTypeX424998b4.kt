...
public sealed class InlineSubscriptionsResourceBillingModeTypeX424998b4 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineSubscriptionsResourceBillingModeTypeX424998b4 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineSubscriptionsResourceBillingModeTypeX424998b4> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineSubscriptionsResourceBillingModeTypeX424998b4",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineSubscriptionsResourceBillingModeTypeX424998b4 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineSubscriptionsResourceBillingModeTypeX424998b4,
        ) {
