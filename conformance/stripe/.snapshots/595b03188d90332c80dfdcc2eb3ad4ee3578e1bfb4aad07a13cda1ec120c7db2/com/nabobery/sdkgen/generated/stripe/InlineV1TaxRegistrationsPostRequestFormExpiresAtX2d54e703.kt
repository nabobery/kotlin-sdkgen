...
internal data class InlineV1TaxRegistrationsPostRequestFormExpiresAtX2d54e703Inspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesInlineV1TaxRegistrationsPostRequestFormExpiresAtAnyOf1X5f8edac7,
                matchesBranch2,
                matchesInlineV1TaxRegistrationsPostRequestFormExpiresAtAnyOf3X89e67c28,
            ).count {
                it
            }
}
...
public class InlineV1TaxRegistrationsPostRequestFormExpiresAtX2d54e703 internal constructor(
    ...
    public val inlineV1TaxRegistrationsPostRequestFormExpiresAtAnyOf1X5f8edac7:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1TaxRegistrationsPostRequestFormExpiresAtAnyOf1X5f8edac7) {
                json
                    .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormExpiresAtAnyOf1X5f8edac7>(
                        raw,
                    )
            } else {
                null
    ...
    public val inlineV1TaxRegistrationsPostRequestFormExpiresAtAnyOf3X89e67c28:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1TaxRegistrationsPostRequestFormExpiresAtAnyOf3X89e67c28) {
                json
                    .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormExpiresAtAnyOf3X89e67c28>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1TaxRegistrationsPostRequestFormExpiresAtX2d54e703Branch>
        get() =
            buildSet {
                if (inspection.matchesInlineV1TaxRegistrationsPostRequestFormExpiresAtAnyOf1X5f8edac7) {
                    add(
                        InlineV1TaxRegistrationsPostRequestFormExpiresAtX2d54e703Branch.InlineV1TaxRegistrationsPostRequestFormExpiresAtAnyOf1X5f8edac7,
                    )
                }
                if (inspection.matchesBranch2) {
                    add(
                        InlineV1TaxRegistrationsPostRequestFormExpiresAtX2d54e703Branch.Branch2,
                    )
                }
                if (inspection.matchesInlineV1TaxRegistrationsPostRequestFormExpiresAtAnyOf3X89e67c28) {
                    add(
                        InlineV1TaxRegistrationsPostRequestFormExpiresAtX2d54e703Branch.InlineV1TaxRegistrationsPostRequestFormExpiresAtAnyOf3X89e67c28,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1TaxRegistrationsPostRequestFormExpiresAtX2d54e703 {
            val inspection = inspectInlineV1TaxRegistrationsPostRequestFormExpiresAtX2d54e703(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1TaxRegistrationsPostRequestFormExpiresAtX2d54e703NoMatchException(
                    "InlineV1TaxRegistrationsPostRequestFormExpiresAtX2d54e703 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1TaxRegistrationsPostRequestFormExpiresAtX2d54e703> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TaxRegistrationsPostRequestFormExpiresAtX2d54e703,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1TaxRegistrationsPostRequestFormExpiresAtX2d54e703",
...
private fun inspectInlineV1TaxRegistrationsPostRequestFormExpiresAtX2d54e703(
    element: JsonElement,
): InlineV1TaxRegistrationsPostRequestFormExpiresAtX2d54e703Inspection {
    val matchesInlineV1TaxRegistrationsPostRequestFormExpiresAtAnyOf1X5f8edac7 =
        element
            .isJsonDecodable<InlineV1TaxRegistrationsPostRequestFormExpiresAtAnyOf1X5f8edac7>()
    val matchesBranch2 = element.isJsonDecodable<Int>()
    val matchesInlineV1TaxRegistrationsPostRequestFormExpiresAtAnyOf3X89e67c28 =
        element
            .isJsonDecodable<InlineV1TaxRegistrationsPostRequestFormExpiresAtAnyOf3X89e67c28>()
    return InlineV1TaxRegistrationsPostRequestFormExpiresAtX2d54e703Inspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1TaxRegistrationsPostRequestFormExpiresAtAnyOf1X5f8edac7) {
                    add(
                        "InlineV1TaxRegistrationsPostRequestFormExpiresAtAnyOf1X5f8edac7: value does not match InlineV1TaxRegistrationsPostRequestFormExpiresAtAnyOf1X5f8edac7",
                    )
                }
                if (!matchesBranch2) add("Branch2: value does not match Int")
                if (!matchesInlineV1TaxRegistrationsPostRequestFormExpiresAtAnyOf3X89e67c28) {
                    add(
                        "InlineV1TaxRegistrationsPostRequestFormExpiresAtAnyOf3X89e67c28: value does not match InlineV1TaxRegistrationsPostRequestFormExpiresAtAnyOf3X89e67c28",
                    )
                }
            },
    )
