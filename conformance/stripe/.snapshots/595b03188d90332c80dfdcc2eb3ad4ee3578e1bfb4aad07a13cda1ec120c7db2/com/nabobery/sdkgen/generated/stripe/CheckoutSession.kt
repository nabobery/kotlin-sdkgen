...
@Serializable
public data class CheckoutSessionView(
    ...
    public val billingAddressCollection: InlineCheckoutSessionBillingAddressCollectionXd15fab78? = null,
    ...
    public val paymentMethodConfigurationDetails: InlineCheckoutSessionPaymentMethodConfigurationDetailsXb9b22770? = null,
    ...
    public val savedPaymentMethodOptions: InlineCheckoutSessionSavedPaymentMethodOptionsX80dae6be? = null,
    ...
    public val shippingAddressCollection: InlineCheckoutSessionShippingAddressCollectionX2994b953? = null,
...
public class CheckoutSession(
    ...
    public class Builder {
        ...
        public var customFields: List<PaymentPagesCheckoutSessionCustomFields>
            get() = requireNotNull(customFieldsValue) { "customFields is required" }
            set(`value`) {
        ...
        public var paymentMethodTypes: List<String>
            get() = requireNotNull(paymentMethodTypesValue) { "paymentMethodTypes is required" }
            set(`value`) {
                paymentMethodTypesValue = value
            }
        ...
        public var shippingOptions: List<PaymentPagesCheckoutSessionShippingOption>
            get() = requireNotNull(shippingOptionsValue) { "shippingOptions is required" }
            set(`value`) {
                shippingOptionsValue = value
            }
         ...
         * List of coupons and promotion codes attached to the Checkout Session.
         */
        public var discounts: List<PaymentPagesCheckoutSessionDiscount>? = null
         ...
         * Dashboard](https://dashboard.stripe.com/settings/payment_methods).
         */
        public var excludedPaymentMethodTypes: List<String>? = null
         ...
         * The optional items presented to the customer at checkout.
         */
        public var optionalItems: List<PaymentPagesCheckoutSessionOptionalItem>? = null
    ...
    public object Serializer : KSerializer<CheckoutSession> {
        ...
        override fun deserialize(decoder: Decoder): CheckoutSession {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("CheckoutSession must be a JSON object")
            val automaticTax = json.decodeRequired<PaymentPagesCheckoutSessionAutomaticTax>(rawObject, "automatic_tax")
            val created = json.decodeRequired<Int>(rawObject, "created")
            val customFields =
                json.decodeRequired<List<PaymentPagesCheckoutSessionCustomFields>>(
                    rawObject,
                    "custom_fields",
                )
            ...
            val paymentStatus =
                json.decodeRequired<InlineCheckoutSessionPaymentStatusX0c3c2c7c>(
                    rawObject,
                    "payment_status",
                )
            val shippingOptions =
                json.decodeRequired<List<PaymentPagesCheckoutSessionShippingOption>>(
                    rawObject,
                    "shipping_options",
                )
            return CheckoutSession(
                ...
                shippingOptions = shippingOptions,
                adaptivePricing =
                    rawObject["adaptive_pricing"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineCheckoutSessionAdaptivePricingX9958aa95?>(element)
                        }
                    },
                afterExpiration =
                    rawObject["after_expiration"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineCheckoutSessionAfterExpirationXdb3c322f?>(element)
                        }
                    },
                allowPromotionCodes =
                    rawObject["allow_promotion_codes"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                amountSubtotal =
                    rawObject["amount_subtotal"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                amountTotal =
                    rawObject["amount_total"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                billingAddressCollection =
                    rawObject["billing_address_collection"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineCheckoutSessionBillingAddressCollectionXd15fab78?>(element)
                        }
                    },
                brandingSettings =
                    rawObject["branding_settings"]?.let {
                        json.decodeFromJsonElement<PaymentPagesCheckoutSessionBrandingSettings>(it)
                    },
                cancelUrl =
                    rawObject["cancel_url"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                clientSecret =
                    rawObject["client_secret"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                collectedInformation =
                    rawObject["collected_information"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineCheckoutSessionCollectedInformationXf8be28b1?>(element)
                        }
                    },
                consent =
                    rawObject["consent"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineCheckoutSessionConsentXd40e04a6?>(element)
                        }
                    },
                consentCollection =
                    rawObject["consent_collection"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineCheckoutSessionConsentCollectionX71c17f32?>(element)
                        }
                    },
                currency =
                ...
                currencyConversion =
                    rawObject["currency_conversion"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineCheckoutSessionCurrencyConversionXbada3ad5?>(element)
                        }
                    },
                customer =
                    rawObject["customer"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineCheckoutSessionCustomerXff9e59c9?>(element)
                        }
                    },
                customerAccount =
                ...
                customerCreation =
                    rawObject["customer_creation"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineCheckoutSessionCustomerCreationX45f89ff8?>(element)
                        }
                    },
                customerDetails =
                    rawObject["customer_details"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineCheckoutSessionCustomerDetailsX1b41d011?>(element)
                        }
                    },
                customerEmail =
                    rawObject["customer_email"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                discounts =
                    rawObject["discounts"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<List<PaymentPagesCheckoutSessionDiscount>?>(element)
                        }
                    },
                excludedPaymentMethodTypes =
                    rawObject["excluded_payment_method_types"]
                        ?.let {
                            json.decodeFromJsonElement<List<String>>(it)
                        },
                integrationIdentifier =
                    rawObject["integration_identifier"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                invoice =
                    rawObject["invoice"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineCheckoutSessionInvoiceX33315f78?>(element)
                        }
                    },
                invoiceCreation =
                    rawObject["invoice_creation"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineCheckoutSessionInvoiceCreationX174def90?>(element)
                        }
                    },
                lineItems =
                    rawObject["line_items"]?.let {
                        json
                            .decodeFromJsonElement<InlineCheckoutSessionLineItemsX4b81212f>(
                                it,
                            )
                    },
                locale =
                    rawObject["locale"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineCheckoutSessionLocaleX143da667?>(element)
                        }
                    },
                managedPayments =
                    rawObject["managed_payments"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineCheckoutSessionManagedPaymentsX6579696b?>(element)
                        }
                    },
                metadata =
                ...
                nameCollection =
                    rawObject["name_collection"]?.let {
                        json.decodeFromJsonElement<PaymentPagesCheckoutSessionNameCollection>(it)
                    },
                optionalItems =
                    rawObject["optional_items"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<List<PaymentPagesCheckoutSessionOptionalItem>?>(element)
                        }
                    },
                originContext =
                    rawObject["origin_context"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineCheckoutSessionOriginContextX589615b9?>(element)
                        }
                    },
                paymentIntent =
                    rawObject["payment_intent"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineCheckoutSessionPaymentIntentXd92b065b?>(element)
                        }
                    },
                paymentLink =
                    rawObject["payment_link"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineCheckoutSessionPaymentLinkX45e1bc7c?>(element)
                        }
                    },
                paymentMethodCollection =
                    rawObject["payment_method_collection"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineCheckoutSessionPaymentMethodCollectionX18402ff1?>(element)
                        }
                    },
                paymentMethodConfigurationDetails =
                    rawObject["payment_method_configuration_details"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                            ...
                            json
                                .decodeFromJsonElement<InlineCheckoutSessionPaymentMethodConfigurationDetailsXb9b22770?>(
                                    element,
                                )
                        }
                    },
                paymentMethodOptions =
                    rawObject["payment_method_options"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineCheckoutSessionPaymentMethodOptionsX2a88fe8e?>(element)
                        }
                    },
                permissions =
                    rawObject["permissions"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineCheckoutSessionPermissionsXffe1cf3c?>(element)
                        }
                    },
                phoneNumberCollection =
                    rawObject["phone_number_collection"]?.let {
                        json
                            .decodeFromJsonElement<PaymentPagesCheckoutSessionPhoneNumberCollection>(
                                it,
                            )
                    },
                presentmentDetails =
                    rawObject["presentment_details"]?.let {
                        json.decodeFromJsonElement<PaymentFlowsPaymentIntentPresentmentDetails>(it)
                    },
                recoveredFrom =
                    rawObject["recovered_from"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                redirectOnCompletion =
                    rawObject["redirect_on_completion"]?.let {
                        json.decodeFromJsonElement<InlineCheckoutSessionRedirectOnCompletionX80a8a619>(it)
                    },
                returnUrl = rawObject["return_url"]?.let { json.decodeFromJsonElement<String>(it) },
                savedPaymentMethodOptions =
                    rawObject["saved_payment_method_options"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineCheckoutSessionSavedPaymentMethodOptionsX80dae6be?>(
                                element,
                            )
                        }
                    },
                setupIntent =
                    rawObject["setup_intent"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineCheckoutSessionSetupIntentX831b441e?>(element)
                        }
                    },
                shippingAddressCollection =
                    rawObject["shipping_address_collection"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineCheckoutSessionShippingAddressCollectionX2994b953?>(
                                element,
                            )
                        }
                    },
                shippingCost =
                    rawObject["shipping_cost"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineCheckoutSessionShippingCostXd1d434da?>(element)
                        }
                    },
                status =
                    rawObject["status"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineCheckoutSessionStatusX6a7fc5ac?>(element)
                        }
                    },
                submitType =
                    rawObject["submit_type"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineCheckoutSessionSubmitTypeXfbbcc564?>(element)
                        }
                    },
                subscription =
                    rawObject["subscription"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineCheckoutSessionSubscriptionXd0282245?>(element)
                        }
                    },
                successUrl =
                    rawObject["success_url"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                taxIdCollection =
                    rawObject["tax_id_collection"]?.let {
                        json.decodeFromJsonElement<PaymentPagesCheckoutSessionTaxIdCollection>(it)
                    },
                totalDetails =
                    rawObject["total_details"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineCheckoutSessionTotalDetailsXcd1469e3?>(element)
                        }
                    },
                uiMode =
                    rawObject["ui_mode"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineCheckoutSessionUiModeX63ec77c4?>(element)
                        }
                    },
                url =
                ...
                walletOptions =
                    rawObject["wallet_options"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineCheckoutSessionWalletOptionsX747ecc26?>(element)
                        }
                    },
            )
        }
        ...
        override fun serialize(
            ...
            val raw =
                buildJsonObject {
                    ...
                    value.paymentMethodConfigurationDetails?.let {
                        put("payment_method_configuration_details", json.encodeToJsonElement(it))
                    }
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("CheckoutSession is missing required property '" + name + "'")
