...
public class InlineV1BalanceHistoryGetParameterXc82176db internal constructor(
    ...
    public val inlineV1BalanceHistoryGetParameterAnyOf1X0f8a4c0a:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1BalanceHistoryGetParameterAnyOf1X0f8a4c0a) {
                json
                    .decodeFromJsonElement<InlineV1BalanceHistoryGetParameterAnyOf1X0f8a4c0a>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1BalanceHistoryGetParameterXc82176dbBranch>
        get() =
            buildSet {
                if (inspection.matchesInlineV1BalanceHistoryGetParameterAnyOf1X0f8a4c0a) {
                    add(
                        InlineV1BalanceHistoryGetParameterXc82176dbBranch.InlineV1BalanceHistoryGetParameterAnyOf1X0f8a4c0a,
                    )
                }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1BalanceHistoryGetParameterXc82176db {
            val inspection = inspectInlineV1BalanceHistoryGetParameterXc82176db(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1BalanceHistoryGetParameterXc82176dbNoMatchException(
                    "InlineV1BalanceHistoryGetParameterXc82176db matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1BalanceHistoryGetParameterXc82176db> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1BalanceHistoryGetParameterXc82176db,
        ) {
...
private fun inspectInlineV1BalanceHistoryGetParameterXc82176db(
    element: JsonElement,
): InlineV1BalanceHistoryGetParameterXc82176dbInspection {
    val matchesInlineV1BalanceHistoryGetParameterAnyOf1X0f8a4c0a =
        element
            .isJsonDecodable<InlineV1BalanceHistoryGetParameterAnyOf1X0f8a4c0a>()
    ...
    return InlineV1BalanceHistoryGetParameterXc82176dbInspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1BalanceHistoryGetParameterAnyOf1X0f8a4c0a) {
                    add(
                        "InlineV1BalanceHistoryGetParameterAnyOf1X0f8a4c0a: value does not match InlineV1BalanceHistoryGetParameterAnyOf1X0f8a4c0a",
                    )
                }
