...
public class InlineBillingCreditGrantsR0bf5InvoiceX20ca8d3e internal constructor(
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineBillingCreditGrantsR0bf5InvoiceX20ca8d3e {
            val inspection = inspectInlineBillingCreditGrantsR0bf5InvoiceX20ca8d3e(raw)
            if (inspection.matchCount == 0) {
                throw InlineBillingCreditGrantsR0bf5InvoiceX20ca8d3eNoMatchException(
                    "InlineBillingCreditGrantsR0bf5InvoiceX20ca8d3e matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineBillingCreditGrantsR0bf5InvoiceX20ca8d3e> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineBillingCreditGrantsR0bf5InvoiceX20ca8d3e,
        ) {
...
private fun inspectInlineBillingCreditGrantsR0bf5InvoiceX20ca8d3e(
    element: JsonElement,
): InlineBillingCreditGrantsR0bf5InvoiceX20ca8d3eInspection {
