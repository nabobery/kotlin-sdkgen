...
public class IssuingPersonalizationDesignPreferences(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): IssuingPersonalizationDesignPreferences =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<IssuingPersonalizationDesignPreferences> {
        ...
        override fun deserialize(decoder: Decoder): IssuingPersonalizationDesignPreferences {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("IssuingPersonalizationDesignPreferences must be a JSON object")
            val isDefault = json.decodeRequired<Boolean>(rawObject, "is_default")
            return IssuingPersonalizationDesignPreferences(
                isDefault = isDefault,
                isPlatformDefault =
                    rawObject["is_platform_default"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: IssuingPersonalizationDesignPreferences,
        ) {
...
public fun issuingPersonalizationDesignPreferences(
    block: IssuingPersonalizationDesignPreferences.Builder.() -> Unit,
): IssuingPersonalizationDesignPreferences = IssuingPersonalizationDesignPreferences.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "IssuingPersonalizationDesignPreferences is missing required property '" + name + "'",
            )
