...
internal data class InlineV1DisputesPostRequestFormEvidenceCustomerEmailAddressXc51371f1Inspection(
    ...
    public val matchesInlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2X0822a398: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2X0822a398,
            ).count {
                it
            }
}
...
public class InlineV1DisputesPostRequestFormEvidenceCustomerEmailAddressXc51371f1 internal constructor(
    ...
    private val inspection: InlineV1DisputesPostRequestFormEvidenceCustomerEmailAddressXc51371f1Inspection,
) {
    ...
    public val inlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2X0822a398:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2X0822a398) {
                json
                    .decodeFromJsonElement<InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2X0822a398>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1DisputesPostRequestFormEvidenceCustomerEmailAddressXc51371f1Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2X0822a398) {
                    add(
                        InlineV1DisputesPostRequestFormEvidenceCustomerEmailAddressXc51371f1Branch.InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2X0822a398,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1DisputesPostRequestFormEvidenceCustomerEmailAddressXc51371f1 {
            val inspection = inspectInlineV1DisputesPostRequestFormEvidenceCustomerEmailAddressXc51371f1(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1DisputesPostRequestFormEvidenceCustomerEmailAddressXc51371f1NoMatchException(
                    "InlineV1DisputesPostRequestFormEvidenceCustomerEmailAddressXc51371f1 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1DisputesPostRequestFormEvidenceCustomerEmailAddressXc51371f1> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1DisputesPostRequestFormEvidenceCustomerEmailAddressXc51371f1,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1DisputesPostRequestFormEvidenceCustomerEmailAddressXc51371f1",
...
private fun inspectInlineV1DisputesPostRequestFormEvidenceCustomerEmailAddressXc51371f1(
    element: JsonElement,
): InlineV1DisputesPostRequestFormEvidenceCustomerEmailAddressXc51371f1Inspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2X0822a398 =
        element
            .isJsonDecodable<InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2X0822a398>()
    return InlineV1DisputesPostRequestFormEvidenceCustomerEmailAddressXc51371f1Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2X0822a398) {
                    add(
                        "InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2X0822a398: value does not match InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2X0822a398",
                    )
                }
            },
    )
