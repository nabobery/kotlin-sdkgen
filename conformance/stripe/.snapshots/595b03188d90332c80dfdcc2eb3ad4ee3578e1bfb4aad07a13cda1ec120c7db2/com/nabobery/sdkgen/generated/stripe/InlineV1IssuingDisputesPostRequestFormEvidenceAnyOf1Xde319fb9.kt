...
public class InlineV1IssuingDisputesPostRequestFormEvidenceAnyOf1Xde319fb9(
    ...
    public val explanation: InlineV1IssuingDisputesPostRequestFormEvidenceExplanationX20735f94? = null,
    public val receivedAt: InlineV1IssuingDisputesPostRequestFormEvidenceReceivedAtX892f3000? = null,
    public val returnDescription: InlineV1IssuingDisputesPostRequestFormEvidenceReturnDescriptionX11d85530? = null,
    public val returnStatus: InlineV1IssuingDisputesPostRequestFormEvidenceReturnStatusX33901326? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1IssuingDisputesPostRequestFormEvidenceAnyOf1Xde319fb9 =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1IssuingDisputesPostRequestFormEvidenceAnyOf1Xde319fb9 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1IssuingDisputesPostRequestFormEvidenceAnyOf1Xde319fb9> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1IssuingDisputesPostRequestFormEvidenceAnyOf1Xde319fb9 must be a JSON object",
                    )
            return InlineV1IssuingDisputesPostRequestFormEvidenceAnyOf1Xde319fb9(
                additionalDocumentation =
                    rawObject["additional_documentation"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1IssuingDisputesPostRequestFormEvidenceAdditionalDocumentationX53ac089b>(
                                it,
                            )
                    },
                explanation =
                    rawObject["explanation"]?.let {
                        json.decodeFromJsonElement<InlineV1IssuingDisputesPostRequestFormEvidenceExplanationX20735f94>(
                            it,
                        )
                    },
                receivedAt =
                    rawObject["received_at"]?.let {
                        json.decodeFromJsonElement<InlineV1IssuingDisputesPostRequestFormEvidenceReceivedAtX892f3000>(
                            it,
                        )
                    },
                returnDescription =
                    rawObject["return_description"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1IssuingDisputesPostRequestFormEvidenceReturnDescriptionX11d85530>(
                                it,
                            )
                    },
                returnStatus =
                    rawObject["return_status"]?.let {
                        json.decodeFromJsonElement<InlineV1IssuingDisputesPostRequestFormEvidenceReturnStatusX33901326>(
                            it,
                        )
                    },
                returnedAt =
                    rawObject["returned_at"]?.let {
                        json.decodeFromJsonElement<InlineV1IssuingDisputesPostRequestFormEvidenceReturnedAtX744ccf9e>(
                            it,
                        )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingDisputesPostRequestFormEvidenceAnyOf1Xde319fb9,
        ) {
            val jsonEncoder =
...
public fun inlineV1IssuingDisputesPostRequestFormEvidenceAnyOf1Xde319fb9(
    block: InlineV1IssuingDisputesPostRequestFormEvidenceAnyOf1Xde319fb9.Builder.() -> Unit,
): InlineV1IssuingDisputesPostRequestFormEvidenceAnyOf1Xde319fb9 =
    InlineV1IssuingDisputesPostRequestFormEvidenceAnyOf1Xde319fb9.build(block)
