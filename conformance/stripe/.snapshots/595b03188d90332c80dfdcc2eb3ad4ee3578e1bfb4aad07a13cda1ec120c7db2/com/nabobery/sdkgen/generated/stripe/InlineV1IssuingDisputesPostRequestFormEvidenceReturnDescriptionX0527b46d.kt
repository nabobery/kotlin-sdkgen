...
internal data class InlineV1IssuingDisputesPostRequestFormEvidenceReturnDescriptionX0527b46dInspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2X968e25ff,
            ).count { it }
}
...
public class InlineV1IssuingDisputesPostRequestFormEvidenceReturnDescriptionX0527b46d internal constructor(
    ...
    private val inspection: InlineV1IssuingDisputesPostRequestFormEvidenceReturnDescriptionX0527b46dInspection,
) {
    ...
    public val inlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2X968e25ff:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2X968e25ff) {
                json
                    .decodeFromJsonElement<InlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2X968e25ff>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1IssuingDisputesPostRequestFormEvidenceReturnDescriptionX0527b46dBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2X968e25ff) {
                    add(
                        InlineV1IssuingDisputesPostRequestFormEvidenceReturnDescriptionX0527b46dBranch.InlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2X968e25ff,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1IssuingDisputesPostRequestFormEvidenceReturnDescriptionX0527b46d {
            val inspection = inspectInlineV1IssuingDisputesPostRequestFormEvidenceReturnDescriptionX0527b46d(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1IssuingDisputesPostRequestFormEvidenceReturnDescriptionX0527b46dNoMatchException(
                    "InlineV1IssuingDisputesPostRequestFormEvidenceReturnDescriptionX0527b46d matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1IssuingDisputesPostRequestFormEvidenceReturnDescriptionX0527b46d> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingDisputesPostRequestFormEvidenceReturnDescriptionX0527b46d,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1IssuingDisputesPostRequestFormEvidenceReturnDescriptionX0527b46d",
...
private fun inspectInlineV1IssuingDisputesPostRequestFormEvidenceReturnDescriptionX0527b46d(
    element: JsonElement,
): InlineV1IssuingDisputesPostRequestFormEvidenceReturnDescriptionX0527b46dInspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2X968e25ff =
        element
            .isJsonDecodable<InlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2X968e25ff>()
    return InlineV1IssuingDisputesPostRequestFormEvidenceReturnDescriptionX0527b46dInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2X968e25ff) {
                    add(
                        "InlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2X968e25ff: value does not match InlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2X968e25ff",
                    )
                }
            },
    )
