...
public class PaymentMethodCardChecks(
    ...
    public class Builder {
        ...
        public fun build(): PaymentMethodCardChecks =
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodCardChecks {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodCardChecks must be a JSON object")
...
public fun paymentMethodCardChecks(block: PaymentMethodCardChecks.Builder.() -> Unit): PaymentMethodCardChecks =
    PaymentMethodCardChecks.build(block)
