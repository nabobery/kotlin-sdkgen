...
public class IssuingCardholderIndividualDob(
    ...
    public class Builder {
        ...
        public fun build(): IssuingCardholderIndividualDob =
    ...
    public object Serializer : KSerializer<IssuingCardholderIndividualDob> {
        ...
        override fun deserialize(decoder: Decoder): IssuingCardholderIndividualDob {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("IssuingCardholderIndividualDob must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: IssuingCardholderIndividualDob,
        ) {
...
public fun issuingCardholderIndividualDob(
    block: IssuingCardholderIndividualDob.Builder.() -> Unit,
): IssuingCardholderIndividualDob = IssuingCardholderIndividualDob.build(block)
