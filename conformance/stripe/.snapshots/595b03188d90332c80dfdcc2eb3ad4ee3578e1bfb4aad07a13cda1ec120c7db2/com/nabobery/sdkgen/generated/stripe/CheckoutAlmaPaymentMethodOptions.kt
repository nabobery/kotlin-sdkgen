...
public class CheckoutAlmaPaymentMethodOptions(
    ...
    public class Builder {
        ...
        public fun build(): CheckoutAlmaPaymentMethodOptions =
    ...
    public object Serializer : KSerializer<CheckoutAlmaPaymentMethodOptions> {
        ...
        override fun deserialize(decoder: Decoder): CheckoutAlmaPaymentMethodOptions {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("CheckoutAlmaPaymentMethodOptions must be a JSON object")
            return CheckoutAlmaPaymentMethodOptions(
                captureMethod =
                    rawObject["capture_method"]?.let {
                        json.decodeFromJsonElement<InlineCheckoutAlmaPaymentMethodOptionsCaptureMethodX27facc86>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: CheckoutAlmaPaymentMethodOptions,
        ) {
...
public fun checkoutAlmaPaymentMethodOptions(
    block: CheckoutAlmaPaymentMethodOptions.Builder.() -> Unit,
): CheckoutAlmaPaymentMethodOptions = CheckoutAlmaPaymentMethodOptions.build(block)
