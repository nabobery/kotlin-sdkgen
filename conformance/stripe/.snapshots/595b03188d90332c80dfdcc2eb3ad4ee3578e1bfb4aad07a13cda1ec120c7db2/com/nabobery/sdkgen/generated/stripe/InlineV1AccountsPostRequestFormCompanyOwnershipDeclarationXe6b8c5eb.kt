...
public class InlineV1AccountsPostRequestFormCompanyOwnershipDeclarationXe6b8c5eb(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1AccountsPostRequestFormCompanyOwnershipDeclarationXe6b8c5eb =
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1AccountsPostRequestFormCompanyOwnershipDeclarationXe6b8c5eb = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1AccountsPostRequestFormCompanyOwnershipDeclarationXe6b8c5eb> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountsPostRequestFormCompanyOwnershipDeclarationXe6b8c5eb must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPostRequestFormCompanyOwnershipDeclarationXe6b8c5eb,
        ) {
            val jsonEncoder =
...
public fun inlineV1AccountsPostRequestFormCompanyOwnershipDeclarationXe6b8c5eb(
    block: InlineV1AccountsPostRequestFormCompanyOwnershipDeclarationXe6b8c5eb.Builder.() -> Unit,
): InlineV1AccountsPostRequestFormCompanyOwnershipDeclarationXe6b8c5eb =
    InlineV1AccountsPostRequestFormCompanyOwnershipDeclarationXe6b8c5eb.build(block)
