...
public class InlineV1QuotesComputedUpfrontLineItemsGetResponse200JsonX5c9b58d8(
     ...
     */
    public val objectValue: InlineV1QuotesComputedUpfrontLineItemsGetResponse200JsonObjectValueX0404f7b5,
    /**
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1QuotesComputedUpfrontLineItemsGetResponse200JsonX5c9b58d8 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1QuotesComputedUpfrontLineItemsGetResponse200JsonX5c9b58d8> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1QuotesComputedUpfrontLineItemsGetResponse200JsonX5c9b58d8 must be a JSON object",
                    )
            val data = json.decodeRequired<List<Item>>(rawObject, "data")
            val hasMore = json.decodeRequired<Boolean>(rawObject, "has_more")
            val objectValue =
                json
                    .decodeRequired<InlineV1QuotesComputedUpfrontLineItemsGetResponse200JsonObjectValueX0404f7b5>(
                        rawObject,
                        "object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1QuotesComputedUpfrontLineItemsGetResponse200JsonX5c9b58d8,
        ) {
            val jsonEncoder =
...
public fun inlineV1QuotesComputedUpfrontLineItemsGetResponse200JsonX5c9b58d8(
    block: InlineV1QuotesComputedUpfrontLineItemsGetResponse200JsonX5c9b58d8.Builder.() -> Unit,
): InlineV1QuotesComputedUpfrontLineItemsGetResponse200JsonX5c9b58d8 =
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1QuotesComputedUpfrontLineItemsGetResponse200JsonX5c9b58d8 is missing required property '" +
                    name +
                    "'",
            )
