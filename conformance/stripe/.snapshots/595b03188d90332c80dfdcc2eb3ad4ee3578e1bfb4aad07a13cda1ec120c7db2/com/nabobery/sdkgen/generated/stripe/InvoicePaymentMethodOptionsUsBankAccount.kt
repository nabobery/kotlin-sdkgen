...
public data class InvoicePaymentMethodOptionsUsBankAccountView(
    ...
    public val financialConnections: InvoicePaymentMethodOptionsUsBankAccountLinkedAccountOptions? = null,
    @SerialName("verification_method")
    public val verificationMethod: InlineInvoicePaymentMethodOptionsUsBankAccountVerificationMethodX50379ccf? = null,
)
...
public class InvoicePaymentMethodOptionsUsBankAccount(
    ...
    public class Builder {
        ...
        public fun build(): InvoicePaymentMethodOptionsUsBankAccount =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InvoicePaymentMethodOptionsUsBankAccount =
    ...
    public object Serializer : KSerializer<InvoicePaymentMethodOptionsUsBankAccount> {
        ...
        override fun deserialize(decoder: Decoder): InvoicePaymentMethodOptionsUsBankAccount {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("InvoicePaymentMethodOptionsUsBankAccount must be a JSON object")
            return InvoicePaymentMethodOptionsUsBankAccount(
                financialConnections =
                    rawObject["financial_connections"]?.let {
                        json.decodeFromJsonElement<InvoicePaymentMethodOptionsUsBankAccountLinkedAccountOptions>(it)
                    },
                verificationMethod =
                    rawObject["verification_method"]?.let {
                        json
                            .decodeFromJsonElement<InlineInvoicePaymentMethodOptionsUsBankAccountVerificationMethodX50379ccf>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InvoicePaymentMethodOptionsUsBankAccount,
        ) {
...
public fun invoicePaymentMethodOptionsUsBankAccount(
    block: InvoicePaymentMethodOptionsUsBankAccount.Builder.() -> Unit,
): InvoicePaymentMethodOptionsUsBankAccount = InvoicePaymentMethodOptionsUsBankAccount.build(block)
