...
public class InlineQuoteLineItemsX6064fea4(
    ...
    public object Serializer : KSerializer<InlineQuoteLineItemsX6064fea4> {
        ...
        override fun deserialize(decoder: Decoder): InlineQuoteLineItemsX6064fea4 {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("InlineQuoteLineItemsX6064fea4 must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineQuoteLineItemsX6064fea4,
        ) {
...
public fun inlineQuoteLineItemsX6064fea4(
    block: InlineQuoteLineItemsX6064fea4.Builder.() -> Unit,
): InlineQuoteLineItemsX6064fea4 = InlineQuoteLineItemsX6064fea4.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException("InlineQuoteLineItemsX6064fea4 is missing required property '" + name + "'")
