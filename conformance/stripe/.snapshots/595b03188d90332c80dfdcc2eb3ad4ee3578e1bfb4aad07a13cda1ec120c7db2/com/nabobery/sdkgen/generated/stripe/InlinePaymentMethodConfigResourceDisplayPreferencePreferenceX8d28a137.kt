...
public sealed class InlinePaymentMethodConfigResourceDisplayPreferencePreferenceX8d28a137 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentMethodConfigResourceDisplayPreferencePreferenceX8d28a137 =
            when (value) {
                None.value -> None
                Off.value -> Off
                On.value -> On
    ...
    public object Serializer : KSerializer<InlinePaymentMethodConfigResourceDisplayPreferencePreferenceX8d28a137> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentMethodConfigResourceDisplayPreferencePreferenceX8d28a137",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlinePaymentMethodConfigResourceDisplayPreferencePreferenceX8d28a137 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentMethodConfigResourceDisplayPreferencePreferenceX8d28a137,
        ) {
