...
public class TerminalConfigurationConfigurationResourceCellularConfig(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): TerminalConfigurationConfigurationResourceCellularConfig =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<TerminalConfigurationConfigurationResourceCellularConfig> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "TerminalConfigurationConfigurationResourceCellularConfig must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: TerminalConfigurationConfigurationResourceCellularConfig,
        ) {
...
public fun terminalConfigurationConfigurationResourceCellularConfig(
    block: TerminalConfigurationConfigurationResourceCellularConfig.Builder.() -> Unit,
): TerminalConfigurationConfigurationResourceCellularConfig =
    TerminalConfigurationConfigurationResourceCellularConfig.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "TerminalConfigurationConfigurationResourceCellularConfig is missing required property '" + name + "'",
            )
