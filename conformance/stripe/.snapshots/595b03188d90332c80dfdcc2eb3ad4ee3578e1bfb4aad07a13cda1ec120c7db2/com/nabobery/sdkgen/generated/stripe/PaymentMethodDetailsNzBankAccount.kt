...
public class PaymentMethodDetailsNzBankAccount(
    ...
    public object Serializer : KSerializer<PaymentMethodDetailsNzBankAccount> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodDetailsNzBankAccount {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodDetailsNzBankAccount must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentMethodDetailsNzBankAccount,
        ) {
...
public fun paymentMethodDetailsNzBankAccount(
    block: PaymentMethodDetailsNzBankAccount.Builder.() -> Unit,
): PaymentMethodDetailsNzBankAccount = PaymentMethodDetailsNzBankAccount.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "PaymentMethodDetailsNzBankAccount is missing required property '" + name + "'",
            )
