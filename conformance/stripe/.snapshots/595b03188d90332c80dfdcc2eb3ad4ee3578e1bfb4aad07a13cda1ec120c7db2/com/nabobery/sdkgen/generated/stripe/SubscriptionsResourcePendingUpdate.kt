...
@Serializable
public data class SubscriptionsResourcePendingUpdateView(
    ...
    public val discounts: List<InlineSubscriptionsResourcePendingUpdateDiscountsItemXcaf617ab>? = null,
...
public class SubscriptionsResourcePendingUpdate(
    ...
    public class Builder {
         ...
         * List of subscription items, each with an attached plan, that will be set if the update is applied.
         */
        public var subscriptionItems: List<SubscriptionItem>? = null
    ...
    public object Serializer : KSerializer<SubscriptionsResourcePendingUpdate> {
        ...
        override fun deserialize(decoder: Decoder): SubscriptionsResourcePendingUpdate {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("SubscriptionsResourcePendingUpdate must be a JSON object")
            ...
            return SubscriptionsResourcePendingUpdate(
                ...
                discount =
                    rawObject["discount"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineSubscriptionsResourcePendingUpdateDiscountXe74f41cb?>(
                                element,
                            )
                        }
                    },
                discounts =
                    rawObject["discounts"]?.let { element ->
                        if (element ==
                            ...
                            json
                                .decodeFromJsonElement<List<InlineSubscriptionsResourcePendingUpdateDiscountsItemXcaf617ab>?>(
                                    element,
                                )
                        }
                    },
                ...
                subscriptionItems =
                    rawObject["subscription_items"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<List<SubscriptionItem>?>(element)
                        }
                    },
                trialEnd =
                ...
                trialFromPlan =
                    rawObject["trial_from_plan"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: SubscriptionsResourcePendingUpdate,
        ) {
...
public fun subscriptionsResourcePendingUpdate(
    block: SubscriptionsResourcePendingUpdate.Builder.() -> Unit,
): SubscriptionsResourcePendingUpdate = SubscriptionsResourcePendingUpdate.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "SubscriptionsResourcePendingUpdate is missing required property '" + name + "'",
            )
