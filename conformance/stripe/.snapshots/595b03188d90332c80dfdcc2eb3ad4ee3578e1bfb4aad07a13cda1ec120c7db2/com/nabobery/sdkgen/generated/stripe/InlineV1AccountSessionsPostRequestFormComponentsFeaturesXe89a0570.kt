...
public class InlineV1AccountSessionsPostRequestFormComponentsFeaturesXe89a0570(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1AccountSessionsPostRequestFormComponentsFeaturesXe89a0570 =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1AccountSessionsPostRequestFormComponentsFeaturesXe89a0570 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1AccountSessionsPostRequestFormComponentsFeaturesXe89a0570> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountSessionsPostRequestFormComponentsFeaturesXe89a0570 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountSessionsPostRequestFormComponentsFeaturesXe89a0570,
        ) {
            val jsonEncoder =
...
public fun inlineV1AccountSessionsPostRequestFormComponentsFeaturesXe89a0570(
    block: InlineV1AccountSessionsPostRequestFormComponentsFeaturesXe89a0570.Builder.() -> Unit,
): InlineV1AccountSessionsPostRequestFormComponentsFeaturesXe89a0570 =
    InlineV1AccountSessionsPostRequestFormComponentsFeaturesXe89a0570.build(block)
