...
public sealed class InlinePayoutObjectValueXe5591f79 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePayoutObjectValueXe5591f79 =
            when (value) {
                Payout.value -> Payout
    ...
    public object Serializer : KSerializer<InlinePayoutObjectValueXe5591f79> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePayoutObjectValueXe5591f79",
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlinePayoutObjectValueXe5591f79,
        ) {
