...
internal data class InlineV1BalanceSettingsPostRequestFormPaymentsAutomaticTransferRuldc17X65b5a674Inspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1BalanceSettingsPostRequestFormPaymentsPayoutsAnyOf2X8be783b2,
            ).count { it }
}
...
public class InlineV1BalanceSettingsPostRequestFormPaymentsAutomaticTransferRuldc17X65b5a674 internal constructor(
    ...
    private val inspection: InlineV1BalanceSettingsPostRequestFormPaymentsAutomaticTransferRuldc17X65b5a674Inspection,
) {
    ...
    public val inlineV1BalanceSettingsPostRequestFormPaymentsPayoutsAnyOf2X8be783b2:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1BalanceSettingsPostRequestFormPaymentsPayoutsAnyOf2X8be783b2) {
                json
                    .decodeFromJsonElement<InlineV1BalanceSettingsPostRequestFormPaymentsPayoutsAnyOf2X8be783b2>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1BalanceSettingsPostRequestFormPaymentsAutomaticTransferRuldc17X65b5a674Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1BalanceSettingsPostRequestFormPaymentsPayoutsAnyOf2X8be783b2) {
                    add(
                        InlineV1BalanceSettingsPostRequestFormPaymentsAutomaticTransferRuldc17X65b5a674Branch.InlineV1BalanceSettingsPostRequestFormPaymentsPayoutsAnyOf2X8be783b2,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1BalanceSettingsPostRequestFormPaymentsAutomaticTransferRuldc17X65b5a674 {
            val inspection = inspectInlineV1BalanceSettingsPostRequestFormPaymentsAutomaticTransferRuldc17X65b5a674(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1BalanceSettingsPostRequestFormPaymentsAutomaticTransferRuldc17X65b5a674NoMatchException(
                    "InlineV1BalanceSettingsPostRequestFormPaymentsAutomaticTransferRuldc17X65b5a674 matched 0 branches: " +
                        inspection.failures.joinToString("; "),
                )
            }
            return InlineV1BalanceSettingsPostRequestFormPaymentsAutomaticTransferRuldc17X65b5a674(
                raw,
                json,
                inspection,
            )
    ...
    public object Serializer : KSerializer<InlineV1BalanceSettingsPostRequestFormPaymentsAutomaticTransferRuldc17X65b5a674> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1BalanceSettingsPostRequestFormPaymentsAutomaticTransferRuldc17X65b5a674,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1BalanceSettingsPostRequestFormPaymentsAutomaticTransferRuldc17X65b5a674",
...
private fun inspectInlineV1BalanceSettingsPostRequestFormPaymentsAutomaticTransferRuldc17X65b5a674(
    element: JsonElement,
): InlineV1BalanceSettingsPostRequestFormPaymentsAutomaticTransferRuldc17X65b5a674Inspection {
    val matchesBranch1 = element.isJsonDecodable<JsonObject>()
    val matchesInlineV1BalanceSettingsPostRequestFormPaymentsPayoutsAnyOf2X8be783b2 =
        element
            .isJsonDecodable<InlineV1BalanceSettingsPostRequestFormPaymentsPayoutsAnyOf2X8be783b2>()
    return InlineV1BalanceSettingsPostRequestFormPaymentsAutomaticTransferRuldc17X65b5a674Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1BalanceSettingsPostRequestFormPaymentsPayoutsAnyOf2X8be783b2) {
                    add(
                        "InlineV1BalanceSettingsPostRequestFormPaymentsPayoutsAnyOf2X8be783b2: value does not match InlineV1BalanceSettingsPostRequestFormPaymentsPayoutsAnyOf2X8be783b2",
                    )
                }
            },
    )
