...
public class InlineV1PaymentMethodConfigurationsGetResponse200JsonX684ee732(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PaymentMethodConfigurationsGetResponse200JsonX684ee732 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentMethodConfigurationsGetResponse200JsonX684ee732> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1PaymentMethodConfigurationsGetResponse200JsonX684ee732 {
            val jsonDecoder =
                decoder.requireJsonDecoder(
                    "InlineV1PaymentMethodConfigurationsGetResponse200JsonX684ee732",
                )
            val json = jsonDecoder.json
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentMethodConfigurationsGetResponse200JsonX684ee732 must be a JSON object",
                    )
            ...
            val objectValue =
                json.decodeRequired<InlineV1PaymentMethodConfigurationsGetResponse200JsonObjectValueX54f1f8c6>(
                    rawObject,
                    "object",
                )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentMethodConfigurationsGetResponse200JsonX684ee732,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentMethodConfigurationsGetResponse200JsonX684ee732(
    block: InlineV1PaymentMethodConfigurationsGetResponse200JsonX684ee732.Builder.() -> Unit,
): InlineV1PaymentMethodConfigurationsGetResponse200JsonX684ee732 =
    InlineV1PaymentMethodConfigurationsGetResponse200JsonX684ee732.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentMethodConfigurationsGetResponse200JsonX684ee732 is missing required property '" + name +
                    "'",
            )
