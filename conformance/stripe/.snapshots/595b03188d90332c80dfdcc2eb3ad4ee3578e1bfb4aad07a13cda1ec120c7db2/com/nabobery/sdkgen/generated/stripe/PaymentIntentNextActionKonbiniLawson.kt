...
public class PaymentIntentNextActionKonbiniLawson(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentIntentNextActionKonbiniLawson =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentIntentNextActionKonbiniLawson> {
        ...
        override fun deserialize(decoder: Decoder): PaymentIntentNextActionKonbiniLawson {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentIntentNextActionKonbiniLawson must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentIntentNextActionKonbiniLawson,
        ) {
...
public fun paymentIntentNextActionKonbiniLawson(
    block: PaymentIntentNextActionKonbiniLawson.Builder.() -> Unit,
): PaymentIntentNextActionKonbiniLawson = PaymentIntentNextActionKonbiniLawson.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "PaymentIntentNextActionKonbiniLawson is missing required property '" + name + "'",
            )
