...
public sealed class InlineV1RadarPaymentEvaluacd5dPostRequestFormMoneyMovementTypeXf237e472 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1RadarPaymentEvaluacd5dPostRequestFormMoneyMovementTypeXf237e472 =
            when (value) {
                Card.value -> Card
    ...
    public object Serializer : KSerializer<InlineV1RadarPaymentEvaluacd5dPostRequestFormMoneyMovementTypeXf237e472> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1RadarPaymentEvaluacd5dPostRequestFormMoneyMovementTypeXf237e472",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1RadarPaymentEvaluacd5dPostRequestFormMoneyMovementTypeXf237e472 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1RadarPaymentEvaluacd5dPostRequestFormMoneyMovementTypeXf237e472,
        ) {
