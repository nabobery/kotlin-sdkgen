...
public class CheckoutKlarnaPaymentMethodOptions(
     ...
     */
    public val setupFutureUsage: InlineCheckoutKlarnaPaymentMethodOptionsSetupFutureUsageXa5787560? = null,
) {
    public class Builder {
        ...
        public fun build(): CheckoutKlarnaPaymentMethodOptions =
    ...
    public object Serializer : KSerializer<CheckoutKlarnaPaymentMethodOptions> {
        ...
        override fun deserialize(decoder: Decoder): CheckoutKlarnaPaymentMethodOptions {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("CheckoutKlarnaPaymentMethodOptions must be a JSON object")
            return CheckoutKlarnaPaymentMethodOptions(
                captureMethod =
                    rawObject["capture_method"]?.let {
                        json.decodeFromJsonElement<InlineCheckoutKlarnaPaymentMethodOptionsCaptureMethodXef4d1de5>(it)
                    },
                setupFutureUsage =
                    rawObject["setup_future_usage"]?.let {
                        json.decodeFromJsonElement<InlineCheckoutKlarnaPaymentMethodOptionsSetupFutureUsageXa5787560>(
                            it,
                        )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: CheckoutKlarnaPaymentMethodOptions,
        ) {
...
public fun checkoutKlarnaPaymentMethodOptions(
    block: CheckoutKlarnaPaymentMethodOptions.Builder.() -> Unit,
): CheckoutKlarnaPaymentMethodOptions = CheckoutKlarnaPaymentMethodOptions.build(block)
