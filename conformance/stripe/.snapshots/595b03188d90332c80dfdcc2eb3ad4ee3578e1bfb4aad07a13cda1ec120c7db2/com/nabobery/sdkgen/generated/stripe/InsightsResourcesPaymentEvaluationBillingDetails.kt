...
public class InsightsResourcesPaymentEvaluationBillingDetails(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InsightsResourcesPaymentEvaluationBillingDetails =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InsightsResourcesPaymentEvaluationBillingDetails> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InsightsResourcesPaymentEvaluationBillingDetails must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InsightsResourcesPaymentEvaluationBillingDetails,
        ) {
...
public fun insightsResourcesPaymentEvaluationBillingDetails(
    block: InsightsResourcesPaymentEvaluationBillingDetails.Builder.() -> Unit,
): InsightsResourcesPaymentEvaluationBillingDetails = InsightsResourcesPaymentEvaluationBillingDetails.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InsightsResourcesPaymentEvaluationBillingDetails is missing required property '" + name + "'",
            )
