...
public class InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsMandateOptionsX9ec9e3f8(
    ...
    public val amountIncludesIof: InlineV1SetupIntentsPostRequestFormAmountIncludesIofX556c736b? = null,
    public val amountType: InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsPixAmountTypeX8bae8b7d? = null,
    public val currency: String? = null,
    public val endDate: String? = null,
    public val paymentSchedule: InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsPaymentScheduleX6ab70c14? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsMandateOptionsX9ec9e3f8 =
            InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsMandateOptionsX9ec9e3f8(
                amount = amount,
    ...
    public object Serializer : KSerializer<InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsMandateOptionsX9ec9e3f8> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsMandateOptionsX9ec9e3f8 must be a JSON object",
                    )
            return InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsMandateOptionsX9ec9e3f8(
                ...
                amountIncludesIof =
                    rawObject["amount_includes_iof"]?.let {
                        json.decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormAmountIncludesIofX556c736b>(it)
                    },
                amountType =
                    rawObject["amount_type"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsPixAmountTypeX8bae8b7d>(
                                it,
                            )
                    },
                ...
                paymentSchedule =
                    rawObject["payment_schedule"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsPaymentScheduleX6ab70c14>(
                                it,
                            )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsMandateOptionsX9ec9e3f8,
        ) {
            val jsonEncoder =
...
public fun inlineV1SetupIntentsPostRequestFormPaymentMethodOptionsMandateOptionsX9ec9e3f8(
    block: InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsMandateOptionsX9ec9e3f8.Builder.() -> Unit,
): InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsMandateOptionsX9ec9e3f8 =
    InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsMandateOptionsX9ec9e3f8.build(block)
