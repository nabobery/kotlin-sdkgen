...
public class InlineTreasuryReceivedDebitTransactionX78b9e912 internal constructor(
        ...
        get() =
            buildSet {
                ...
                if (inspection.matchesTreasuryTransaction) {
                    add(
                        InlineTreasuryReceivedDebitTransactionX78b9e912Branch.TreasuryTransaction,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineTreasuryReceivedDebitTransactionX78b9e912 {
            val inspection = inspectInlineTreasuryReceivedDebitTransactionX78b9e912(raw)
            if (inspection.matchCount == 0) {
                throw InlineTreasuryReceivedDebitTransactionX78b9e912NoMatchException(
                    "InlineTreasuryReceivedDebitTransactionX78b9e912 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineTreasuryReceivedDebitTransactionX78b9e912> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineTreasuryReceivedDebitTransactionX78b9e912,
        ) {
...
private fun inspectInlineTreasuryReceivedDebitTransactionX78b9e912(
    element: JsonElement,
): InlineTreasuryReceivedDebitTransactionX78b9e912Inspection {
