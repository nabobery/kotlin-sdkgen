...
public class InlineV1CustomersPostRequestFormInvoiceSettingsX8b4aa88c(
    public val customFields: InlineV1CustomersPostRequestFormInvoiceSettingsCustomFieldsX005b2185? = null,
    public val defaultPaymentMethod: String? = null,
    public val footer: String? = null,
    public val renderingOptions: InlineV1CustomersPostRequestFormInvoiceSettingsRenderingOptionsXb6eff753? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1CustomersPostRequestFormInvoiceSettingsX8b4aa88c =
            InlineV1CustomersPostRequestFormInvoiceSettingsX8b4aa88c(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1CustomersPostRequestFormInvoiceSettingsX8b4aa88c =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1CustomersPostRequestFormInvoiceSettingsX8b4aa88c> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CustomersPostRequestFormInvoiceSettingsX8b4aa88c must be a JSON object",
                    )
            return InlineV1CustomersPostRequestFormInvoiceSettingsX8b4aa88c(
                customFields =
                    rawObject["custom_fields"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CustomersPostRequestFormInvoiceSettingsCustomFieldsX005b2185>(
                                it,
                            )
                    },
                ...
                renderingOptions =
                    rawObject["rendering_options"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CustomersPostRequestFormInvoiceSettingsRenderingOptionsXb6eff753>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersPostRequestFormInvoiceSettingsX8b4aa88c,
        ) {
...
public fun inlineV1CustomersPostRequestFormInvoiceSettingsX8b4aa88c(
    block: InlineV1CustomersPostRequestFormInvoiceSettingsX8b4aa88c.Builder.() -> Unit,
): InlineV1CustomersPostRequestFormInvoiceSettingsX8b4aa88c =
    InlineV1CustomersPostRequestFormInvoiceSettingsX8b4aa88c.build(block)
