...
internal data class InlineV1AccountsBankAccountsPostRequestFormBankAccountX6b45297fInspection(
    ...
    public val matchCount: Int
        get() =
            listOf(matchesInlineV1AccountsBankAccountsPostRequestFormBankAccountAnyOf1X21285d7e, matchesBranch2).count {
                it
            }
}
...
public class InlineV1AccountsBankAccountsPostRequestFormBankAccountX6b45297f internal constructor(
    ...
    public val inlineV1AccountsBankAccountsPostRequestFormBankAccountAnyOf1X21285d7e:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1AccountsBankAccountsPostRequestFormBankAccountAnyOf1X21285d7e) {
                json
                    .decodeFromJsonElement<InlineV1AccountsBankAccountsPostRequestFormBankAccountAnyOf1X21285d7e>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches:
        ...
        get() =
            buildSet {
                if (inspection.matchesInlineV1AccountsBankAccountsPostRequestFormBankAccountAnyOf1X21285d7e) {
                    add(
                        InlineV1AccountsBankAccountsPostRequestFormBankAccountX6b45297fBranch.InlineV1AccountsBankAccountsPostRequestFormBankAccountAnyOf1X21285d7e,
                    )
                }
                if (inspection.matchesBranch2) {
                    add(
                        InlineV1AccountsBankAccountsPostRequestFormBankAccountX6b45297fBranch.Branch2,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1AccountsBankAccountsPostRequestFormBankAccountX6b45297f {
            val inspection = inspectInlineV1AccountsBankAccountsPostRequestFormBankAccountX6b45297f(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1AccountsBankAccountsPostRequestFormBankAccountX6b45297fNoMatchException(
                    "InlineV1AccountsBankAccountsPostRequestFormBankAccountX6b45297f matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1AccountsBankAccountsPostRequestFormBankAccountX6b45297f> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsBankAccountsPostRequestFormBankAccountX6b45297f,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1AccountsBankAccountsPostRequestFormBankAccountX6b45297f",
...
private fun inspectInlineV1AccountsBankAccountsPostRequestFormBankAccountX6b45297f(
    element: JsonElement,
): InlineV1AccountsBankAccountsPostRequestFormBankAccountX6b45297fInspection {
    val matchesInlineV1AccountsBankAccountsPostRequestFormBankAccountAnyOf1X21285d7e =
        element
            .isJsonDecodable<InlineV1AccountsBankAccountsPostRequestFormBankAccountAnyOf1X21285d7e>()
    ...
    return InlineV1AccountsBankAccountsPostRequestFormBankAccountX6b45297fInspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1AccountsBankAccountsPostRequestFormBankAccountAnyOf1X21285d7e) {
                    add(
                        "InlineV1AccountsBankAccountsPostRequestFormBankAccountAnyOf1X21285d7e: value does not match InlineV1AccountsBankAccountsPostRequestFormBankAccountAnyOf1X21285d7e",
                    )
                }
