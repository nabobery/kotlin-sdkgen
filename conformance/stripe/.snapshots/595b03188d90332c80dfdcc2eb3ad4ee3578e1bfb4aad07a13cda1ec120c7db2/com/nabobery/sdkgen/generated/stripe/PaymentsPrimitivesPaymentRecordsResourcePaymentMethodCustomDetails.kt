...
public class PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCustomDetails(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCustomDetails = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCustomDetails> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCustomDetails must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCustomDetails,
        ) {
            val jsonEncoder =
...
public fun paymentsPrimitivesPaymentRecordsResourcePaymentMethodCustomDetails(
    block: PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCustomDetails.Builder.() -> Unit,
): PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCustomDetails =
    PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCustomDetails.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCustomDetails is missing required property '" +
                    name +
                    "'",
            )
