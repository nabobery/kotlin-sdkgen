...
public class InlineV1ApplicationFeesGetResponse200JsonX5afc7f4e(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1ApplicationFeesGetResponse200JsonX5afc7f4e =
    ...
    public object Serializer : KSerializer<InlineV1ApplicationFeesGetResponse200JsonX5afc7f4e> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1ApplicationFeesGetResponse200JsonX5afc7f4e {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1ApplicationFeesGetResponse200JsonX5afc7f4e must be a JSON object",
                    )
            ...
            val objectValue =
                json.decodeRequired<InlineV1ApplicationFeesGetResponse200JsonObjectValueX627ccc61>(
                    rawObject,
                    "object",
                )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ApplicationFeesGetResponse200JsonX5afc7f4e,
        ) {
...
public fun inlineV1ApplicationFeesGetResponse200JsonX5afc7f4e(
    block: InlineV1ApplicationFeesGetResponse200JsonX5afc7f4e.Builder.() -> Unit,
): InlineV1ApplicationFeesGetResponse200JsonX5afc7f4e = InlineV1ApplicationFeesGetResponse200JsonX5afc7f4e.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1ApplicationFeesGetResponse200JsonX5afc7f4e is missing required property '" + name + "'",
            )
