...
public sealed class InlineV1PromotionCodesPostRequestFormMetadataAnyOf2X8ab7a844 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1PromotionCodesPostRequestFormMetadataAnyOf2X8ab7a844 =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1PromotionCodesPostRequestFormMetadataAnyOf2X8ab7a844> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1PromotionCodesPostRequestFormMetadataAnyOf2X8ab7a844",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1PromotionCodesPostRequestFormMetadataAnyOf2X8ab7a844 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PromotionCodesPostRequestFormMetadataAnyOf2X8ab7a844,
        ) {
