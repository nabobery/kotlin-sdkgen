...
public sealed class InlinePaymentPagesCheckoutSessionAutomaticTaxStatusX0e24e6fa {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentPagesCheckoutSessionAutomaticTaxStatusX0e24e6fa =
            when (value) {
    ...
    public object Serializer : KSerializer<InlinePaymentPagesCheckoutSessionAutomaticTaxStatusX0e24e6fa> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentPagesCheckoutSessionAutomaticTaxStatusX0e24e6fa",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePaymentPagesCheckoutSessionAutomaticTaxStatusX0e24e6fa =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentPagesCheckoutSessionAutomaticTaxStatusX0e24e6fa,
        ) {
