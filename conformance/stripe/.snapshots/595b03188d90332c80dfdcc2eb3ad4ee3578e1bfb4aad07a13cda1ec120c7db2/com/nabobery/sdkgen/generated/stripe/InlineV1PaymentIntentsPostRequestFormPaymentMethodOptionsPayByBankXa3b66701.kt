...
internal data class InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPayByBankXa3b66701Inspection(
    ...
    public val matchesInlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAnyOf2X148963ee: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAnyOf2X148963ee,
            ).count {
                it
            }
}
...
public class InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPayByBankXa3b66701 internal constructor(
    ...
    private val inspection: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPayByBankXa3b66701Inspection,
) {
    ...
    public val inlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAnyOf2X148963ee:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAnyOf2X148963ee) {
                json
                    .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAnyOf2X148963ee>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPayByBankXa3b66701Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAnyOf2X148963ee) {
                    add(
                        InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPayByBankXa3b66701Branch.InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAnyOf2X148963ee,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPayByBankXa3b66701 {
            val inspection = inspectInlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPayByBankXa3b66701(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPayByBankXa3b66701NoMatchException(
                    "InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPayByBankXa3b66701 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPayByBankXa3b66701> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPayByBankXa3b66701,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPayByBankXa3b66701",
...
private fun inspectInlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPayByBankXa3b66701(
    element: JsonElement,
): InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPayByBankXa3b66701Inspection {
    val matchesBranch1 = element.isJsonDecodable<JsonObject>()
    val matchesInlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAnyOf2X148963ee =
        element
            .isJsonDecodable<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAnyOf2X148963ee>()
    return InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPayByBankXa3b66701Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAnyOf2X148963ee) {
                    add(
                        "InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAnyOf2X148963ee: value does not match InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAnyOf2X148963ee",
                    )
                }
            },
    )
