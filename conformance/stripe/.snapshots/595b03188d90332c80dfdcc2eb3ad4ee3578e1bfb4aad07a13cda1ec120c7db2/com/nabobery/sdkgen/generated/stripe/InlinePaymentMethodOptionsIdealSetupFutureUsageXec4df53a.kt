...
public sealed class InlinePaymentMethodOptionsIdealSetupFutureUsageXec4df53a {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentMethodOptionsIdealSetupFutureUsageXec4df53a =
            when (value) {
                None.value -> None
    ...
    public object Serializer : KSerializer<InlinePaymentMethodOptionsIdealSetupFutureUsageXec4df53a> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentMethodOptionsIdealSetupFutureUsageXec4df53a",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePaymentMethodOptionsIdealSetupFutureUsageXec4df53a =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentMethodOptionsIdealSetupFutureUsageXec4df53a,
        ) {
