...
public class InlineV1RadarPaymentEvaluacd5dPostRequestFormPaymentMethodDetailsX2dfa835f(
    ...
    public val billingDetails: InlineV1RadarPaymentEvaluacd5dPostRequestFormBillingDetailsX8170e78e? = null,
) {
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1RadarPaymentEvaluacd5dPostRequestFormPaymentMethodDetailsX2dfa835f = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1RadarPaymentEvaluacd5dPostRequestFormPaymentMethodDetailsX2dfa835f> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1RadarPaymentEvaluacd5dPostRequestFormPaymentMethodDetailsX2dfa835f must be a JSON object",
                    )
            ...
            return InlineV1RadarPaymentEvaluacd5dPostRequestFormPaymentMethodDetailsX2dfa835f(
                ...
                billingDetails =
                    rawObject["billing_details"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1RadarPaymentEvaluacd5dPostRequestFormBillingDetailsX8170e78e>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1RadarPaymentEvaluacd5dPostRequestFormPaymentMethodDetailsX2dfa835f,
        ) {
            val jsonEncoder =
...
public fun inlineV1RadarPaymentEvaluacd5dPostRequestFormPaymentMethodDetailsX2dfa835f(
    block: InlineV1RadarPaymentEvaluacd5dPostRequestFormPaymentMethodDetailsX2dfa835f.Builder.() -> Unit,
): InlineV1RadarPaymentEvaluacd5dPostRequestFormPaymentMethodDetailsX2dfa835f =
    InlineV1RadarPaymentEvaluacd5dPostRequestFormPaymentMethodDetailsX2dfa835f.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1RadarPaymentEvaluacd5dPostRequestFormPaymentMethodDetailsX2dfa835f is missing required property '" +
                    name +
                    "'",
            )
