...
public class InlineV1InvoiceitemsPostRequestFormPriceDataXd6200d26(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1InvoiceitemsPostRequestFormPriceDataXd6200d26 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1InvoiceitemsPostRequestFormPriceDataXd6200d26> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1InvoiceitemsPostRequestFormPriceDataXd6200d26 must be a JSON object",
                    )
            ...
            return InlineV1InvoiceitemsPostRequestFormPriceDataXd6200d26(
                ...
                taxBehavior =
                    rawObject["tax_behavior"]?.let {
                        json.decodeFromJsonElement<InlineV1InvoiceitemsPostRequestFormPriceDataTaxBehaviorX5e6b7b1a>(it)
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoiceitemsPostRequestFormPriceDataXd6200d26,
        ) {
...
public fun inlineV1InvoiceitemsPostRequestFormPriceDataXd6200d26(
    block: InlineV1InvoiceitemsPostRequestFormPriceDataXd6200d26.Builder.() -> Unit,
): InlineV1InvoiceitemsPostRequestFormPriceDataXd6200d26 =
    InlineV1InvoiceitemsPostRequestFormPriceDataXd6200d26.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1InvoiceitemsPostRequestFormPriceDataXd6200d26 is missing required property '" + name + "'",
            )
