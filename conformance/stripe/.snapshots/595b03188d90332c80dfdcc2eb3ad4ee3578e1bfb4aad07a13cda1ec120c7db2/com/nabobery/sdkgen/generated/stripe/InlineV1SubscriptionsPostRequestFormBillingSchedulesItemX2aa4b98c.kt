...
public class InlineV1SubscriptionsPostRequestFormBillingSchedulesItemX2aa4b98c(
    ...
    public val appliesTo: List<InlineV1SubscriptionsPostRequestFormBillingSchedulesItemAppliesToItemX89efce48>? = null,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1SubscriptionsPostRequestFormBillingSchedulesItemX2aa4b98c =
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionsPostRequestFormBillingSchedulesItemX2aa4b98c> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1SubscriptionsPostRequestFormBillingSchedulesItemX2aa4b98c {
            val jsonDecoder =
                decoder.requireJsonDecoder(
                    "InlineV1SubscriptionsPostRequestFormBillingSchedulesItemX2aa4b98c",
                )
            val json = jsonDecoder.json
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SubscriptionsPostRequestFormBillingSchedulesItemX2aa4b98c must be a JSON object",
                    )
            val billUntil =
                json.decodeRequired<InlineV1SubscriptionsPostRequestFormBillingSchedulesItemBillUntilX0cdf5e54>(
                    rawObject,
                    "bill_until",
                )
            return InlineV1SubscriptionsPostRequestFormBillingSchedulesItemX2aa4b98c(
                ...
                appliesTo =
                    rawObject["applies_to"]?.let {
                        json
                            .decodeFromJsonElement<List<InlineV1SubscriptionsPostRequestFormBillingSchedulesItemAppliesToItemX89efce48>>(
                                it,
                            )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsPostRequestFormBillingSchedulesItemX2aa4b98c,
        ) {
            val jsonEncoder =
...
public fun inlineV1SubscriptionsPostRequestFormBillingSchedulesItemX2aa4b98c(
    block: InlineV1SubscriptionsPostRequestFormBillingSchedulesItemX2aa4b98c.Builder.() -> Unit,
): InlineV1SubscriptionsPostRequestFormBillingSchedulesItemX2aa4b98c =
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1SubscriptionsPostRequestFormBillingSchedulesItemX2aa4b98c is missing required property '" +
                    name +
                    "'",
            )
