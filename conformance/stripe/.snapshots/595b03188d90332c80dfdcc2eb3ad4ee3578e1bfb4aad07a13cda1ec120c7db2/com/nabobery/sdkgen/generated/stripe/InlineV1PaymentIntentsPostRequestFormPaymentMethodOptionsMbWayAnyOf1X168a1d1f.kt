...
public class InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsMbWayAnyOf1X168a1d1f(
    public val setupFutureUsage: InlineV1PaymentIntentsPostRequestFormSetupFutureUsageX8d3568db? = null,
) {
    public class Builder {
        public var setupFutureUsage: InlineV1PaymentIntentsPostRequestFormSetupFutureUsageX8d3568db? =
            null

        public fun build(): InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsMbWayAnyOf1X168a1d1f =
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsMbWayAnyOf1X168a1d1f> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsMbWayAnyOf1X168a1d1f must be a JSON object",
                    )
            return InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsMbWayAnyOf1X168a1d1f(
                setupFutureUsage =
                    rawObject["setup_future_usage"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormSetupFutureUsageX8d3568db>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsMbWayAnyOf1X168a1d1f,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsMbWayAnyOf1X168a1d1f(
    block: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsMbWayAnyOf1X168a1d1f.Builder.() -> Unit,
): InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsMbWayAnyOf1X168a1d1f =
