...
internal data class InlineV1TerminalConfigurationsPostRequestFormCellularX9644e4daInspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesInlineV1TerminalConfigurationsPostRequestFormCellularAnyOf1X7979e744,
                matchesInlineV1TerminalConfigurationsPostRequestFormCellularAnyOf2X037acac2,
            ).count {
                it
            }
}
...
public class InlineV1TerminalConfigurationsPostRequestFormCellularX9644e4da internal constructor(
    ...
    public val inlineV1TerminalConfigurationsPostRequestFormCellularAnyOf1X7979e744:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1TerminalConfigurationsPostRequestFormCellularAnyOf1X7979e744) {
                json
                    .decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormCellularAnyOf1X7979e744>(
                        raw,
                    )
            } else {
                null
    ...
    public val inlineV1TerminalConfigurationsPostRequestFormCellularAnyOf2X037acac2:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1TerminalConfigurationsPostRequestFormCellularAnyOf2X037acac2) {
                json
                    .decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormCellularAnyOf2X037acac2>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches:
        ...
        get() =
            buildSet {
                if (inspection.matchesInlineV1TerminalConfigurationsPostRequestFormCellularAnyOf1X7979e744) {
                    add(
                        InlineV1TerminalConfigurationsPostRequestFormCellularX9644e4daBranch.InlineV1TerminalConfigurationsPostRequestFormCellularAnyOf1X7979e744,
                    )
                }
                if (inspection.matchesInlineV1TerminalConfigurationsPostRequestFormCellularAnyOf2X037acac2) {
                    add(
                        InlineV1TerminalConfigurationsPostRequestFormCellularX9644e4daBranch.InlineV1TerminalConfigurationsPostRequestFormCellularAnyOf2X037acac2,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1TerminalConfigurationsPostRequestFormCellularX9644e4da {
            val inspection = inspectInlineV1TerminalConfigurationsPostRequestFormCellularX9644e4da(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1TerminalConfigurationsPostRequestFormCellularX9644e4daNoMatchException(
                    "InlineV1TerminalConfigurationsPostRequestFormCellularX9644e4da matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1TerminalConfigurationsPostRequestFormCellularX9644e4da> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TerminalConfigurationsPostRequestFormCellularX9644e4da,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1TerminalConfigurationsPostRequestFormCellularX9644e4da",
...
private fun inspectInlineV1TerminalConfigurationsPostRequestFormCellularX9644e4da(
    element: JsonElement,
): InlineV1TerminalConfigurationsPostRequestFormCellularX9644e4daInspection {
    val matchesInlineV1TerminalConfigurationsPostRequestFormCellularAnyOf1X7979e744 =
        element
            .isJsonDecodable<InlineV1TerminalConfigurationsPostRequestFormCellularAnyOf1X7979e744>()
    val matchesInlineV1TerminalConfigurationsPostRequestFormCellularAnyOf2X037acac2 =
        element
            .isJsonDecodable<InlineV1TerminalConfigurationsPostRequestFormCellularAnyOf2X037acac2>()
    return InlineV1TerminalConfigurationsPostRequestFormCellularX9644e4daInspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1TerminalConfigurationsPostRequestFormCellularAnyOf1X7979e744) {
                    add(
                        "InlineV1TerminalConfigurationsPostRequestFormCellularAnyOf1X7979e744: value does not match InlineV1TerminalConfigurationsPostRequestFormCellularAnyOf1X7979e744",
                    )
                }
                if (!matchesInlineV1TerminalConfigurationsPostRequestFormCellularAnyOf2X037acac2) {
                    add(
                        "InlineV1TerminalConfigurationsPostRequestFormCellularAnyOf2X037acac2: value does not match InlineV1TerminalConfigurationsPostRequestFormCellularAnyOf2X037acac2",
                    )
                }
            },
    )
