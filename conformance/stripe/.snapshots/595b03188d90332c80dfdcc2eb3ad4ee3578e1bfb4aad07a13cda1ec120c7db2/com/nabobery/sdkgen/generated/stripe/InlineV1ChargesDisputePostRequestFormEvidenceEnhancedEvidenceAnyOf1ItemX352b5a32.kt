...
public class InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf1ItemX352b5a32(
    ...
    public val customerAccountId: InlineV1ChargesDisputePostRequestFormEvidenceCustomerAccountIdXda9083ff? = null,
    public val customerDeviceFingerprint:
        InlineV1ChargesDisputePostRequestFormEvidenceCustomerDeviceFinger9c71X3dc81cf4? = null,
    public val customerDeviceId: InlineV1ChargesDisputePostRequestFormEvidenceCustomerDeviceIdX60179376? = null,
    public val customerEmailAddress: InlineV1ChargesDisputePostRequestFormEvidenceCustomerEmailAddressX4a478d96? = null,
    public val customerPurchaseIp: InlineV1ChargesDisputePostRequestFormEvidenceCustomerPurchaseIpX442a34b5? = null,
    public val productDescription: InlineV1ChargesDisputePostRequestFormEvidenceProductDescriptionX734f0e2c? = null,
    public val shippingAddress: InlineV1ChargesDisputePostRequestFormEvidenceShippingAddressX43b7a92f? = null,
) {
    ...
    public object Serializer : KSerializer<InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf1ItemX352b5a32> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf1ItemX352b5a32 must be a JSON object",
                    )
            ...
            return InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf1ItemX352b5a32(
                ...
                customerAccountId =
                    rawObject["customer_account_id"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1ChargesDisputePostRequestFormEvidenceCustomerAccountIdXda9083ff>(
                                it,
                            )
                    },
                customerDeviceFingerprint =
                    rawObject["customer_device_fingerprint"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1ChargesDisputePostRequestFormEvidenceCustomerDeviceFinger9c71X3dc81cf4>(
                                it,
                            )
                    },
                customerDeviceId =
                    rawObject["customer_device_id"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1ChargesDisputePostRequestFormEvidenceCustomerDeviceIdX60179376>(
                                it,
                            )
                    },
                customerEmailAddress =
                    rawObject["customer_email_address"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1ChargesDisputePostRequestFormEvidenceCustomerEmailAddressX4a478d96>(
                                it,
                            )
                    },
                customerPurchaseIp =
                    rawObject["customer_purchase_ip"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1ChargesDisputePostRequestFormEvidenceCustomerPurchaseIpX442a34b5>(
                                it,
                            )
                    },
                productDescription =
                    rawObject["product_description"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1ChargesDisputePostRequestFormEvidenceProductDescriptionX734f0e2c>(
                                it,
                            )
                    },
                shippingAddress =
                    rawObject["shipping_address"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1ChargesDisputePostRequestFormEvidenceShippingAddressX43b7a92f>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf1ItemX352b5a32,
        ) {
            val jsonEncoder =
...
public fun inlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf1ItemX352b5a32(
    block: InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf1ItemX352b5a32.Builder.() -> Unit,
): InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf1ItemX352b5a32 =
    InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf1ItemX352b5a32.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf1ItemX352b5a32 is missing required property '" +
                    name +
                    "'",
            )
