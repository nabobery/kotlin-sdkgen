...
public sealed class InlineV1CustomersSubscriptionsPostRequestFormCollectionMethodXaaab4e43 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1CustomersSubscriptionsPostRequestFormCollectionMethodXaaab4e43 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1CustomersSubscriptionsPostRequestFormCollectionMethodXaaab4e43> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1CustomersSubscriptionsPostRequestFormCollectionMethodXaaab4e43",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1CustomersSubscriptionsPostRequestFormCollectionMethodXaaab4e43 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersSubscriptionsPostRequestFormCollectionMethodXaaab4e43,
        ) {
