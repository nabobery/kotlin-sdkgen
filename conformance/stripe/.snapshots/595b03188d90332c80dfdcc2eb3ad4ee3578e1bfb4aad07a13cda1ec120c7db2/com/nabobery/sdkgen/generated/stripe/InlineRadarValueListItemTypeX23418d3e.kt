...
public sealed class InlineRadarValueListItemTypeX23418d3e {
    ...
    public companion object {
        public fun fromValue(`value`: kotlin.String): InlineRadarValueListItemTypeX23418d3e =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineRadarValueListItemTypeX23418d3e> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineRadarValueListItemTypeX23418d3e",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineRadarValueListItemTypeX23418d3e =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineRadarValueListItemTypeX23418d3e,
        ) {
