...
public class InlineV1IdentityVerificationSessionsPostRequestFormProvidedDetailsX4215b0d0(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1IdentityVerificationSessionsPostRequestFormProvidedDetailsX4215b0d0 =
            InlineV1IdentityVerificationSessionsPostRequestFormProvidedDetailsX4215b0d0(
                email = email,
                phone = phone,
            )
    }
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1IdentityVerificationSessionsPostRequestFormProvidedDetailsX4215b0d0 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1IdentityVerificationSessionsPostRequestFormProvidedDetailsX4215b0d0> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1IdentityVerificationSessionsPostRequestFormProvidedDetailsX4215b0d0 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IdentityVerificationSessionsPostRequestFormProvidedDetailsX4215b0d0,
        ) {
            val jsonEncoder =
...
public fun inlineV1IdentityVerificationSessionsPostRequestFormProvidedDetailsX4215b0d0(
    block: InlineV1IdentityVerificationSessionsPostRequestFormProvidedDetailsX4215b0d0.Builder.() -> Unit,
): InlineV1IdentityVerificationSessionsPostRequestFormProvidedDetailsX4215b0d0 =
    InlineV1IdentityVerificationSessionsPostRequestFormProvidedDetailsX4215b0d0.build(block)
