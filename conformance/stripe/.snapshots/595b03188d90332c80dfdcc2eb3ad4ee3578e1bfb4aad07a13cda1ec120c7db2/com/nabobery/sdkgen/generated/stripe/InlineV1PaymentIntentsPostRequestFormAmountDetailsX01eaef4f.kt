...
public class InlineV1PaymentIntentsPostRequestFormAmountDetailsX01eaef4f(
    public val discountAmount: InlineV1PaymentIntentsPostRequestFormAmountDetailsDiscountAmountXdefc41d6? = null,
    public val enforceArithmeticValidation: Boolean? = null,
    public val lineItems: InlineV1PaymentIntentsPostRequestFormAmountDetailsLineItemsX00138fc5? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1PaymentIntentsPostRequestFormAmountDetailsX01eaef4f =
            InlineV1PaymentIntentsPostRequestFormAmountDetailsX01eaef4f(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PaymentIntentsPostRequestFormAmountDetailsX01eaef4f =
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormAmountDetailsX01eaef4f> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsPostRequestFormAmountDetailsX01eaef4f must be a JSON object",
                    )
            return InlineV1PaymentIntentsPostRequestFormAmountDetailsX01eaef4f(
                discountAmount =
                    rawObject["discount_amount"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormAmountDetailsDiscountAmountXdefc41d6>(
                                it,
                            )
                    },
                ...
                lineItems =
                    rawObject["line_items"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormAmountDetailsLineItemsX00138fc5>(
                                it,
                            )
                    },
                shipping =
                    rawObject["shipping"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormAmountDetailsShippingX4a7f00ba>(
                            it,
                        )
                    },
                tax =
                    rawObject["tax"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormAmountDetailsTaxXd947c943>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormAmountDetailsX01eaef4f,
        ) {
...
public fun inlineV1PaymentIntentsPostRequestFormAmountDetailsX01eaef4f(
    block: InlineV1PaymentIntentsPostRequestFormAmountDetailsX01eaef4f.Builder.() -> Unit,
): InlineV1PaymentIntentsPostRequestFormAmountDetailsX01eaef4f =
    InlineV1PaymentIntentsPostRequestFormAmountDetailsX01eaef4f.build(block)
