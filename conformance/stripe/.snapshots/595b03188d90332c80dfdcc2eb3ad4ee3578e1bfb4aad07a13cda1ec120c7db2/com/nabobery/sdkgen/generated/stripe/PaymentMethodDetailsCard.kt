...
public class PaymentMethodDetailsCard(
    ...
    public val multicapture: PaymentFlowsPrivatePaymentMethodsCardDetailsApiResourceMulticapture? = null,
    /**
    ...
    public object Serializer : KSerializer<PaymentMethodDetailsCard> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodDetailsCard {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodDetailsCard must be a JSON object")
            ...
            return PaymentMethodDetailsCard(
                ...
                checks =
                    rawObject["checks"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentMethodDetailsCardChecksX10867324?>(element)
                        }
                    },
                country =
                ...
                extendedAuthorization =
                    rawObject["extended_authorization"]?.let {
                        json
                            .decodeFromJsonElement<PaymentFlowsPrivatePaymentMethodsCardDetailsApiResourceEnterpriseFeaturesExtendedAuthorizationExtendedAuthorization>(
                                it,
                            )
                    },
                fingerprint =
                ...
                incrementalAuthorization =
                    rawObject["incremental_authorization"]?.let {
                        json
                            .decodeFromJsonElement<PaymentFlowsPrivatePaymentMethodsCardDetailsApiResourceEnterpriseFeaturesIncrementalAuthorizationIncrementalAuthorization>(
                                it,
                            )
                    },
                installments =
                    rawObject["installments"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentMethodDetailsCardInstallmentsXac717376?>(element)
                        }
                    },
                last4 =
                ...
                multicapture =
                    rawObject["multicapture"]?.let {
                        json.decodeFromJsonElement<PaymentFlowsPrivatePaymentMethodsCardDetailsApiResourceMulticapture>(
                            it,
                        )
                    },
                network =
                ...
                networkToken =
                    rawObject["network_token"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlinePaymentMethodDetailsCardNetworkTokenX290e6729?>(element)
                        }
                    },
                ...
                overcapture =
                    rawObject["overcapture"]?.let {
                        json
                            .decodeFromJsonElement<PaymentFlowsPrivatePaymentMethodsCardDetailsApiResourceEnterpriseFeaturesOvercaptureOvercapture>(
                                it,
                            )
                    },
                regulatedStatus =
                    rawObject["regulated_status"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlinePaymentMethodDetailsCardRegulatedStatusX00da7a55?>(element)
                        }
                    },
                threeDSecure =
                    rawObject["three_d_secure"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentMethodDetailsCardThreeDSecureX57531d65?>(element)
                        }
                    },
                transactionLinkId =
                    rawObject["transaction_link_id"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                wallet =
                    rawObject["wallet"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentMethodDetailsCardWalletX3d6951c5?>(element)
                        }
                    },
            )
        }
        ...
        override fun serialize(
            ...
            val raw =
                buildJsonObject {
                    ...
                    value.incrementalAuthorization?.let {
                        put(
...
public fun paymentMethodDetailsCard(block: PaymentMethodDetailsCard.Builder.() -> Unit): PaymentMethodDetailsCard =
    PaymentMethodDetailsCard.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException("PaymentMethodDetailsCard is missing required property '" + name + "'")
