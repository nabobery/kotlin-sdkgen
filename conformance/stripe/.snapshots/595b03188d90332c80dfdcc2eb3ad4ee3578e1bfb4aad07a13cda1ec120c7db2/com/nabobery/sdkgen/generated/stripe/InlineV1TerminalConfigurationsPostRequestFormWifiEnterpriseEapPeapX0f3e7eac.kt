...
public class InlineV1TerminalConfigurationsPostRequestFormWifiEnterpriseEapPeapX0f3e7eac(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1TerminalConfigurationsPostRequestFormWifiEnterpriseEapPeapX0f3e7eac = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TerminalConfigurationsPostRequestFormWifiEnterpriseEapPeapX0f3e7eac> {
        override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1TerminalConfigurationsPostRequestFormWifiEnterpriseEapPeapX0f3e7eac {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TerminalConfigurationsPostRequestFormWifiEnterpriseEapPeapX0f3e7eac must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TerminalConfigurationsPostRequestFormWifiEnterpriseEapPeapX0f3e7eac,
        ) {
            val jsonEncoder =
...
public fun inlineV1TerminalConfigurationsPostRequestFormWifiEnterpriseEapPeapX0f3e7eac(
    block: InlineV1TerminalConfigurationsPostRequestFormWifiEnterpriseEapPeapX0f3e7eac.Builder.() -> Unit,
): InlineV1TerminalConfigurationsPostRequestFormWifiEnterpriseEapPeapX0f3e7eac =
    InlineV1TerminalConfigurationsPostRequestFormWifiEnterpriseEapPeapX0f3e7eac.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TerminalConfigurationsPostRequestFormWifiEnterpriseEapPeapX0f3e7eac is missing required property '" +
                    name +
                    "'",
            )
