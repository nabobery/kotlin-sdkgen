...
public class InlineV1PaymentMethodConfigurationsPostRequestFormCryptoX98319527(
    public val displayPreference: InlineV1PaymentMethodConfidc49PostRequestFormCryptoDisplayPreferenceX3a7c048f? = null,
) {
    public class Builder {
        public var displayPreference:
            InlineV1PaymentMethodConfidc49PostRequestFormCryptoDisplayPreferenceX3a7c048f? = null

        public fun build(): InlineV1PaymentMethodConfigurationsPostRequestFormCryptoX98319527 =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PaymentMethodConfigurationsPostRequestFormCryptoX98319527 =
    ...
    public object Serializer : KSerializer<InlineV1PaymentMethodConfigurationsPostRequestFormCryptoX98319527> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentMethodConfigurationsPostRequestFormCryptoX98319527 must be a JSON object",
                    )
            return InlineV1PaymentMethodConfigurationsPostRequestFormCryptoX98319527(
                displayPreference =
                    rawObject["display_preference"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentMethodConfidc49PostRequestFormCryptoDisplayPreferenceX3a7c048f>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentMethodConfigurationsPostRequestFormCryptoX98319527,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentMethodConfigurationsPostRequestFormCryptoX98319527(
    block: InlineV1PaymentMethodConfigurationsPostRequestFormCryptoX98319527.Builder.() -> Unit,
): InlineV1PaymentMethodConfigurationsPostRequestFormCryptoX98319527 =
    InlineV1PaymentMethodConfigurationsPostRequestFormCryptoX98319527.build(block)
