...
public sealed class InlineInvoiceRenderingTemplateObjectValueXd53d954d {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineInvoiceRenderingTemplateObjectValueXd53d954d =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineInvoiceRenderingTemplateObjectValueXd53d954d> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineInvoiceRenderingTemplateObjectValueXd53d954d",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineInvoiceRenderingTemplateObjectValueXd53d954d =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineInvoiceRenderingTemplateObjectValueXd53d954d,
        ) {
