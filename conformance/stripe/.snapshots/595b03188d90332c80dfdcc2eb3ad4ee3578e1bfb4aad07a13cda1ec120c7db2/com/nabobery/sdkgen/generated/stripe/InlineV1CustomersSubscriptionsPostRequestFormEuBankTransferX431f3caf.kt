...
public class InlineV1CustomersSubscriptionsPostRequestFormEuBankTransferX431f3caf(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1CustomersSubscriptionsPostRequestFormEuBankTransferX431f3caf = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1CustomersSubscriptionsPostRequestFormEuBankTransferX431f3caf> {
        override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1CustomersSubscriptionsPostRequestFormEuBankTransferX431f3caf {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CustomersSubscriptionsPostRequestFormEuBankTransferX431f3caf must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersSubscriptionsPostRequestFormEuBankTransferX431f3caf,
        ) {
            val jsonEncoder =
...
public fun inlineV1CustomersSubscriptionsPostRequestFormEuBankTransferX431f3caf(
    block: InlineV1CustomersSubscriptionsPostRequestFormEuBankTransferX431f3caf.Builder.() -> Unit,
): InlineV1CustomersSubscriptionsPostRequestFormEuBankTransferX431f3caf =
    InlineV1CustomersSubscriptionsPostRequestFormEuBankTransferX431f3caf.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1CustomersSubscriptionsPostRequestFormEuBankTransferX431f3caf is missing required property '" +
                    name +
                    "'",
            )
