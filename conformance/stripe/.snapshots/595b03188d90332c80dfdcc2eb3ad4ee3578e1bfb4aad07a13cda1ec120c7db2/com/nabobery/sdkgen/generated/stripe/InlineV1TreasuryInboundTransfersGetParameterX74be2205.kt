...
public sealed class InlineV1TreasuryInboundTransfersGetParameterX74be2205 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1TreasuryInboundTransfersGetParameterX74be2205 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1TreasuryInboundTransfersGetParameterX74be2205> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1TreasuryInboundTransfersGetParameterX74be2205",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1TreasuryInboundTransfersGetParameterX74be2205 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TreasuryInboundTransfersGetParameterX74be2205,
        ) {
