...
public class InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsNextBillingX9739f2b0(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsNextBillingX9739f2b0 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsNextBillingX9739f2b0> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsNextBillingX9739f2b0 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsNextBillingX9739f2b0,
        ) {
            val jsonEncoder =
...
public fun inlineV1SetupIntentsPostRequestFormPaymentMethodOptionsNextBillingX9739f2b0(
    block: InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsNextBillingX9739f2b0.Builder.() -> Unit,
): InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsNextBillingX9739f2b0 =
    InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsNextBillingX9739f2b0.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsNextBillingX9739f2b0 is missing required property '" +
                    name +
                    "'",
            )
