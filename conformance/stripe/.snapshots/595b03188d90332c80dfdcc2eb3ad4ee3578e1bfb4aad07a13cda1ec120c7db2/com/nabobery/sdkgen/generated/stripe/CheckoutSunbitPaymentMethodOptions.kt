...
public class CheckoutSunbitPaymentMethodOptions(
     ...
     */
    public val setupFutureUsage: InlineCheckoutSunbitPaymentMethodOptionsSetupFutureUsageX5d2df2e9? = null,
) {
    public class Builder {
        ...
        public fun build(): CheckoutSunbitPaymentMethodOptions =
            CheckoutSunbitPaymentMethodOptions(
    ...
    public object Serializer : KSerializer<CheckoutSunbitPaymentMethodOptions> {
        ...
        override fun deserialize(decoder: Decoder): CheckoutSunbitPaymentMethodOptions {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("CheckoutSunbitPaymentMethodOptions must be a JSON object")
            return CheckoutSunbitPaymentMethodOptions(
                captureMethod =
                    rawObject["capture_method"]?.let {
                        json.decodeFromJsonElement<InlineCheckoutSunbitPaymentMethodOptionsCaptureMethodXd54e7609>(it)
                    },
                setupFutureUsage =
                    rawObject["setup_future_usage"]?.let {
                        json.decodeFromJsonElement<InlineCheckoutSunbitPaymentMethodOptionsSetupFutureUsageX5d2df2e9>(
                            it,
                        )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: CheckoutSunbitPaymentMethodOptions,
        ) {
...
public fun checkoutSunbitPaymentMethodOptions(
    block: CheckoutSunbitPaymentMethodOptions.Builder.() -> Unit,
): CheckoutSunbitPaymentMethodOptions = CheckoutSunbitPaymentMethodOptions.build(block)
