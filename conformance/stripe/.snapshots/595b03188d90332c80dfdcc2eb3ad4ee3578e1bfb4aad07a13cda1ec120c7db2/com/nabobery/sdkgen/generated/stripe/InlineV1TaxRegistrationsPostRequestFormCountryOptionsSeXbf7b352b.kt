...
public class InlineV1TaxRegistrationsPostRequestFormCountryOptionsSeXbf7b352b(
    ...
    public val standard: InlineV1TaxRegistrationsPostRequestFormCountryOptionsSeStandardXea71cd0e? = null,
) {
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TaxRegistrationsPostRequestFormCountryOptionsSeXbf7b352b =
    ...
    public object Serializer : KSerializer<InlineV1TaxRegistrationsPostRequestFormCountryOptionsSeXbf7b352b> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TaxRegistrationsPostRequestFormCountryOptionsSeXbf7b352b must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineV1TaxRegistrationsPostRequestFormCountryOptionsSeTypeX200f7f48>(
                    rawObject,
                    "type",
                )
            return InlineV1TaxRegistrationsPostRequestFormCountryOptionsSeXbf7b352b(
                ...
                standard =
                    rawObject["standard"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsSeStandardXea71cd0e>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TaxRegistrationsPostRequestFormCountryOptionsSeXbf7b352b,
        ) {
            val jsonEncoder =
...
public fun inlineV1TaxRegistrationsPostRequestFormCountryOptionsSeXbf7b352b(
    block: InlineV1TaxRegistrationsPostRequestFormCountryOptionsSeXbf7b352b.Builder.() -> Unit,
): InlineV1TaxRegistrationsPostRequestFormCountryOptionsSeXbf7b352b =
    InlineV1TaxRegistrationsPostRequestFormCountryOptionsSeXbf7b352b.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TaxRegistrationsPostRequestFormCountryOptionsSeXbf7b352b is missing required property '" + name +
                    "'",
            )
