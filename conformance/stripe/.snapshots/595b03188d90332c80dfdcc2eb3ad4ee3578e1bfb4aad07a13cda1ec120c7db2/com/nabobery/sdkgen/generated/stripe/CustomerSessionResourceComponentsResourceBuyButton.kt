...
public class CustomerSessionResourceComponentsResourceBuyButton(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): CustomerSessionResourceComponentsResourceBuyButton =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<CustomerSessionResourceComponentsResourceBuyButton> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "CustomerSessionResourceComponentsResourceBuyButton must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: CustomerSessionResourceComponentsResourceBuyButton,
        ) {
...
public fun customerSessionResourceComponentsResourceBuyButton(
    block: CustomerSessionResourceComponentsResourceBuyButton.Builder.() -> Unit,
): CustomerSessionResourceComponentsResourceBuyButton = CustomerSessionResourceComponentsResourceBuyButton.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "CustomerSessionResourceComponentsResourceBuyButton is missing required property '" + name + "'",
            )
