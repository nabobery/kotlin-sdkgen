...
public class InlineV1AccountsPersonsPostRequestFormUsCfpbDataX1bf5a9a3(
    public val ethnicityDetails: InlineV1AccountsPersonsPostRequestFormUsCfpbDataEthnicityDetailsX4b87237a? = null,
    public val raceDetails: InlineV1AccountsPersonsPostRequestFormUsCfpbDataRaceDetailsXdfb6b61b? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1AccountsPersonsPostRequestFormUsCfpbDataX1bf5a9a3 =
            InlineV1AccountsPersonsPostRequestFormUsCfpbDataX1bf5a9a3(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1AccountsPersonsPostRequestFormUsCfpbDataX1bf5a9a3 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1AccountsPersonsPostRequestFormUsCfpbDataX1bf5a9a3> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountsPersonsPostRequestFormUsCfpbDataX1bf5a9a3 must be a JSON object",
                    )
            return InlineV1AccountsPersonsPostRequestFormUsCfpbDataX1bf5a9a3(
                ethnicityDetails =
                    rawObject["ethnicity_details"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1AccountsPersonsPostRequestFormUsCfpbDataEthnicityDetailsX4b87237a>(
                                it,
                            )
                    },
                raceDetails =
                    rawObject["race_details"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1AccountsPersonsPostRequestFormUsCfpbDataRaceDetailsXdfb6b61b>(
                                it,
                            )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPersonsPostRequestFormUsCfpbDataX1bf5a9a3,
        ) {
...
public fun inlineV1AccountsPersonsPostRequestFormUsCfpbDataX1bf5a9a3(
    block: InlineV1AccountsPersonsPostRequestFormUsCfpbDataX1bf5a9a3.Builder.() -> Unit,
): InlineV1AccountsPersonsPostRequestFormUsCfpbDataX1bf5a9a3 =
    InlineV1AccountsPersonsPostRequestFormUsCfpbDataX1bf5a9a3.build(block)
