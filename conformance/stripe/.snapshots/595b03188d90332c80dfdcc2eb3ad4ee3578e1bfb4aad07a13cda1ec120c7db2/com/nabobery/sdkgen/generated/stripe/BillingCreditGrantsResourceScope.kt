...
public class BillingCreditGrantsResourceScope(
     ...
     * with `price_type`.
     */
    public val prices: List<BillingCreditGrantsResourceApplicablePrice>? = null,
) {
    public class Builder {
         ...
         */
        public var prices: List<BillingCreditGrantsResourceApplicablePrice>? = null

        public fun build(): BillingCreditGrantsResourceScope =
    ...
    public object Serializer : KSerializer<BillingCreditGrantsResourceScope> {
        ...
        override fun deserialize(decoder: Decoder): BillingCreditGrantsResourceScope {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("BillingCreditGrantsResourceScope must be a JSON object")
            return BillingCreditGrantsResourceScope(
                priceType =
                    rawObject["price_type"]?.let {
                        json.decodeFromJsonElement<InlineBillingCreditGrantsResourceScopePriceTypeX8ec94b64>(it)
                    },
                prices =
                    rawObject["prices"]?.let {
                        json
                            .decodeFromJsonElement<List<BillingCreditGrantsResourceApplicablePrice>>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: BillingCreditGrantsResourceScope,
        ) {
...
public fun billingCreditGrantsResourceScope(
    block: BillingCreditGrantsResourceScope.Builder.() -> Unit,
): BillingCreditGrantsResourceScope = BillingCreditGrantsResourceScope.build(block)
