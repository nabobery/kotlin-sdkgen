...
public class InlineV1CustomersSubscriptionsPostRequestFormX60a552a8(
     ...
     */
    public val addInvoiceItems: List<InlineV1CustomersSubscriptionsPostRequestFormAddInvoiceItemsItemXf39c2bdc>? = null,
    /**
     ...
     */
    public val applicationFeePercent: InlineV1CustomersSubscriptionsPostRequestFormApplicationFeePercentX4ba4ce73? = null,
    /**
     * Automatic tax settings for this subscription.
     */
    public val automaticTax: InlineV1CustomersSubscriptionsPostRequestFormAutomaticTaxXc4d6e287? = null,
    /**
     ...
     */
    public val billingThresholds: InlineV1CustomersSubscriptionsPostRequestFormBillingThresholdsXa82e51f0? = null,
    /**
     ...
     */
    public val collectionMethod: InlineV1CustomersSubscriptionsPostRequestFormCollectionMethodX94a7ee9d? = null,
    /**
     ...
     */
    public val defaultTaxRates: InlineV1CustomersSubscriptionsPostRequestFormDefaultTaxRatesXbc59da76? = null,
    /**
     ...
     */
    public val invoiceSettings: InlineV1CustomersSubscriptionsPostRequestFormInvoiceSettingsX9f128480? = null,
    /**
     * A list of up to 20 subscription items, each with an attached price.
     */
    public val items: List<InlineV1CustomersSubscriptionsPostRequestFormItemsItemXdfdc9b17>? = null,
    /**
     ...
     */
    public val paymentBehavior: InlineV1CustomersSubscriptionsPostRequestFormPaymentBehaviorX3ca4199a? = null,
    /**
     * Payment settings to pass to invoices created by the subscription.
     */
    public val paymentSettings: InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsXa3c00b6f? = null,
    /**
     ...
     */
    public val prorationBehavior: InlineV1CustomersSubscriptionsPostRequestFormProrationBehaviorX65e3fe26? = null,
    /**
     ...
     */
    public val transferData: InlineV1CustomersSubscriptionsPostRequestFormTransferDataXed439d91? = null,
    /**
     ...
     */
    public val trialSettings: InlineV1CustomersSubscriptionsPostRequestFormTrialSettingsXf9a983f6? = null,
) {
    public class Builder {
         ...
         * A list of up to 20 subscription items, each with an attached price.
         */
        public var items: List<InlineV1CustomersSubscriptionsPostRequestFormItemsItemXdfdc9b17>? = null
        ...
        public fun build(): InlineV1CustomersSubscriptionsPostRequestFormX60a552a8 =
            InlineV1CustomersSubscriptionsPostRequestFormX60a552a8(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1CustomersSubscriptionsPostRequestFormX60a552a8 =
    ...
    public object Serializer : KSerializer<InlineV1CustomersSubscriptionsPostRequestFormX60a552a8> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CustomersSubscriptionsPostRequestFormX60a552a8 must be a JSON object",
                    )
            return InlineV1CustomersSubscriptionsPostRequestFormX60a552a8(
                addInvoiceItems =
                    rawObject["add_invoice_items"]?.let {
                        json
                            .decodeFromJsonElement<List<InlineV1CustomersSubscriptionsPostRequestFormAddInvoiceItemsItemXf39c2bdc>>(
                                it,
                            )
                    },
                applicationFeePercent =
                    rawObject["application_fee_percent"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CustomersSubscriptionsPostRequestFormApplicationFeePercentX4ba4ce73>(
                                it,
                            )
                    },
                automaticTax =
                    rawObject["automatic_tax"]?.let {
                        json.decodeFromJsonElement<InlineV1CustomersSubscriptionsPostRequestFormAutomaticTaxXc4d6e287>(
                            it,
                        )
                    },
                backdateStartDate =
                ...
                billingThresholds =
                    rawObject["billing_thresholds"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CustomersSubscriptionsPostRequestFormBillingThresholdsXa82e51f0>(
                                it,
                            )
                    },
                cancelAt =
                    rawObject["cancel_at"]?.let {
                        json.decodeFromJsonElement<InlineV1CustomersSubscriptionsPostRequestFormCancelAtXb1cca53c>(it)
                    },
                cancelAtPeriodEnd =
                ...
                collectionMethod =
                    rawObject["collection_method"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CustomersSubscriptionsPostRequestFormCollectionMethodX94a7ee9d>(
                                it,
                            )
                    },
                ...
                defaultTaxRates =
                    rawObject["default_tax_rates"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CustomersSubscriptionsPostRequestFormDefaultTaxRatesXbc59da76>(
                                it,
                            )
                    },
                discounts =
                    rawObject["discounts"]?.let {
                        json.decodeFromJsonElement<InlineV1CustomersSubscriptionsPostRequestFormDiscountsXdee99a3f>(it)
                    },
                expand = rawObject["expand"]?.let { json.decodeFromJsonElement<List<String>>(it) },
                invoiceSettings =
                    rawObject["invoice_settings"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CustomersSubscriptionsPostRequestFormInvoiceSettingsX9f128480>(
                                it,
                            )
                    },
                items =
                    rawObject["items"]?.let {
                        json
                            .decodeFromJsonElement<List<InlineV1CustomersSubscriptionsPostRequestFormItemsItemXdfdc9b17>>(
                                it,
                            )
                    },
                metadata =
                    rawObject["metadata"]?.let {
                        json.decodeFromJsonElement<InlineV1CustomersSubscriptionsPostRequestFormMetadataX451c7dd0>(it)
                    },
                offSession = rawObject["off_session"]?.let { json.decodeFromJsonElement<Boolean>(it) },
                paymentBehavior =
                    rawObject["payment_behavior"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CustomersSubscriptionsPostRequestFormPaymentBehaviorX3ca4199a>(
                                it,
                            )
                    },
                paymentSettings =
                    rawObject["payment_settings"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsXa3c00b6f>(
                                it,
                            )
                    },
                pendingInvoiceItemInterval =
                    rawObject["pending_invoice_item_interval"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CustomersSubscriptionsPostRequestFormPendingInvoiceItemIntervalXb4220976>(
                                it,
                            )
                    },
                prorationBehavior =
                    rawObject["proration_behavior"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CustomersSubscriptionsPostRequestFormProrationBehaviorX65e3fe26>(
                                it,
                            )
                    },
                transferData =
                    rawObject["transfer_data"]?.let {
                        json.decodeFromJsonElement<InlineV1CustomersSubscriptionsPostRequestFormTransferDataXed439d91>(
                            it,
                        )
                    },
                trialEnd =
                    rawObject["trial_end"]?.let {
                        json.decodeFromJsonElement<InlineV1CustomersSubscriptionsPostRequestFormTrialEndXcd857a9b>(it)
                    },
                trialFromPlan =
                ...
                trialSettings =
                    rawObject["trial_settings"]?.let {
                        json.decodeFromJsonElement<InlineV1CustomersSubscriptionsPostRequestFormTrialSettingsXf9a983f6>(
                            it,
                        )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersSubscriptionsPostRequestFormX60a552a8,
        ) {
...
public fun inlineV1CustomersSubscriptionsPostRequestFormX60a552a8(
    block: InlineV1CustomersSubscriptionsPostRequestFormX60a552a8.Builder.() -> Unit,
): InlineV1CustomersSubscriptionsPostRequestFormX60a552a8 =
    InlineV1CustomersSubscriptionsPostRequestFormX60a552a8.build(block)
