...
public sealed class InlineV1CustomersCardsPostRequestFormCardAnyOf1ObjectValueX92f6509c {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1CustomersCardsPostRequestFormCardAnyOf1ObjectValueX92f6509c =
            when (value) {
                Card.value -> Card
    ...
    public object Serializer : KSerializer<InlineV1CustomersCardsPostRequestFormCardAnyOf1ObjectValueX92f6509c> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1CustomersCardsPostRequestFormCardAnyOf1ObjectValueX92f6509c",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1CustomersCardsPostRequestFormCardAnyOf1ObjectValueX92f6509c = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersCardsPostRequestFormCardAnyOf1ObjectValueX92f6509c,
        ) {
