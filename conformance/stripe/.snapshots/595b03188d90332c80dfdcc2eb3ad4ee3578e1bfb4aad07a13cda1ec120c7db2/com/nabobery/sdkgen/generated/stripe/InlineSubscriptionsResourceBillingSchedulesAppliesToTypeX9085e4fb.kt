...
public sealed class InlineSubscriptionsResourceBillingSchedulesAppliesToTypeX9085e4fb {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineSubscriptionsResourceBillingSchedulesAppliesToTypeX9085e4fb =
            when (value) {
                Price.value -> Price
    ...
    public object Serializer : KSerializer<InlineSubscriptionsResourceBillingSchedulesAppliesToTypeX9085e4fb> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineSubscriptionsResourceBillingSchedulesAppliesToTypeX9085e4fb",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineSubscriptionsResourceBillingSchedulesAppliesToTypeX9085e4fb =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineSubscriptionsResourceBillingSchedulesAppliesToTypeX9085e4fb,
        ) {
