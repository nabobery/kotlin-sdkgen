...
public sealed class InlineQuotesResourceSubscriptionDataBillingModeTypeX8387d824 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineQuotesResourceSubscriptionDataBillingModeTypeX8387d824 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineQuotesResourceSubscriptionDataBillingModeTypeX8387d824> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineQuotesResourceSubscriptionDataBillingModeTypeX8387d824",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineQuotesResourceSubscriptionDataBillingModeTypeX8387d824 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineQuotesResourceSubscriptionDataBillingModeTypeX8387d824,
        ) {
