...
public class InlineV1CustomersTaxIdsPostRequestFormX03c5a0dc(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1CustomersTaxIdsPostRequestFormX03c5a0dc =
    ...
    public object Serializer : KSerializer<InlineV1CustomersTaxIdsPostRequestFormX03c5a0dc> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CustomersTaxIdsPostRequestFormX03c5a0dc must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersTaxIdsPostRequestFormX03c5a0dc,
        ) {
...
public fun inlineV1CustomersTaxIdsPostRequestFormX03c5a0dc(
    block: InlineV1CustomersTaxIdsPostRequestFormX03c5a0dc.Builder.() -> Unit,
): InlineV1CustomersTaxIdsPostRequestFormX03c5a0dc = InlineV1CustomersTaxIdsPostRequestFormX03c5a0dc.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1CustomersTaxIdsPostRequestFormX03c5a0dc is missing required property '" + name + "'",
            )
