...
public class InlineV1IdentityVerificationSessionsPostRequestFormRelatedPersonX361bb9e0(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1IdentityVerificationSessionsPostRequestFormRelatedPersonX361bb9e0 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1IdentityVerificationSessionsPostRequestFormRelatedPersonX361bb9e0> {
        override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1IdentityVerificationSessionsPostRequestFormRelatedPersonX361bb9e0 {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1IdentityVerificationSessionsPostRequestFormRelatedPersonX361bb9e0 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IdentityVerificationSessionsPostRequestFormRelatedPersonX361bb9e0,
        ) {
            val jsonEncoder =
...
public fun inlineV1IdentityVerificationSessionsPostRequestFormRelatedPersonX361bb9e0(
    block: InlineV1IdentityVerificationSessionsPostRequestFormRelatedPersonX361bb9e0.Builder.() -> Unit,
): InlineV1IdentityVerificationSessionsPostRequestFormRelatedPersonX361bb9e0 =
    InlineV1IdentityVerificationSessionsPostRequestFormRelatedPersonX361bb9e0.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1IdentityVerificationSessionsPostRequestFormRelatedPersonX361bb9e0 is missing required property '" +
                    name +
                    "'",
            )
