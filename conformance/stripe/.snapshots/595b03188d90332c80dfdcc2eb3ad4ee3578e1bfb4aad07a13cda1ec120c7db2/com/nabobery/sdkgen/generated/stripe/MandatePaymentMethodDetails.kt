...
public class MandatePaymentMethodDetails(
    ...
    public object Serializer : KSerializer<MandatePaymentMethodDetails> {
        ...
        override fun deserialize(decoder: Decoder): MandatePaymentMethodDetails {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("MandatePaymentMethodDetails must be a JSON object")
            ...
            return MandatePaymentMethodDetails(
                ...
                usBankAccount =
                    rawObject["us_bank_account"]?.let {
                        json.decodeFromJsonElement<MandateUsBankAccount>(
                            it,
                        )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: MandatePaymentMethodDetails,
        ) {
...
public fun mandatePaymentMethodDetails(
    block: MandatePaymentMethodDetails.Builder.() -> Unit,
): MandatePaymentMethodDetails = MandatePaymentMethodDetails.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException("MandatePaymentMethodDetails is missing required property '" + name + "'")
