...
public sealed class InlinePaymentMethodOptionsCardPresentRoutingRequestedPriorityX0073d63b {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentMethodOptionsCardPresentRoutingRequestedPriorityX0073d63b =
            when (value) {
    ...
    public object Serializer : KSerializer<InlinePaymentMethodOptionsCardPresentRoutingRequestedPriorityX0073d63b> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentMethodOptionsCardPresentRoutingRequestedPriorityX0073d63b",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlinePaymentMethodOptionsCardPresentRoutingRequestedPriorityX0073d63b = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentMethodOptionsCardPresentRoutingRequestedPriorityX0073d63b,
        ) {
