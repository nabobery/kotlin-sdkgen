...
public class InlineV1BillingAlertsArchivePostRequestFormX4a2bef25(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1BillingAlertsArchivePostRequestFormX4a2bef25 =
            InlineV1BillingAlertsArchivePostRequestFormX4a2bef25(
                expand = expand,
            )
    }

    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1BillingAlertsArchivePostRequestFormX4a2bef25 =
    ...
    public object Serializer : KSerializer<InlineV1BillingAlertsArchivePostRequestFormX4a2bef25> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1BillingAlertsArchivePostRequestFormX4a2bef25 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1BillingAlertsArchivePostRequestFormX4a2bef25,
        ) {
...
public fun inlineV1BillingAlertsArchivePostRequestFormX4a2bef25(
    block: InlineV1BillingAlertsArchivePostRequestFormX4a2bef25.Builder.() -> Unit,
): InlineV1BillingAlertsArchivePostRequestFormX4a2bef25 =
    InlineV1BillingAlertsArchivePostRequestFormX4a2bef25.build(block)
