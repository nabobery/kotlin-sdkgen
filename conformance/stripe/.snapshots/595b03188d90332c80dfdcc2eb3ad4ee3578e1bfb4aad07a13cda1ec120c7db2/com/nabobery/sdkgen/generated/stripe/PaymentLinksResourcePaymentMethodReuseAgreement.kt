...
public class PaymentLinksResourcePaymentMethodReuseAgreement(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentLinksResourcePaymentMethodReuseAgreement =
    ...
    public object Serializer : KSerializer<PaymentLinksResourcePaymentMethodReuseAgreement> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "PaymentLinksResourcePaymentMethodReuseAgreement must be a JSON object",
                    )
            val position =
                json.decodeRequired<InlinePaymentLinksResourcePaymentMethodReuseAgreementPositionXc5c0f0fb>(
                    rawObject,
                    "position",
                )
            return PaymentLinksResourcePaymentMethodReuseAgreement(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentLinksResourcePaymentMethodReuseAgreement,
        ) {
...
public fun paymentLinksResourcePaymentMethodReuseAgreement(
    block: PaymentLinksResourcePaymentMethodReuseAgreement.Builder.() -> Unit,
): PaymentLinksResourcePaymentMethodReuseAgreement = PaymentLinksResourcePaymentMethodReuseAgreement.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "PaymentLinksResourcePaymentMethodReuseAgreement is missing required property '" + name + "'",
            )
