...
public class InlineV1CustomersSubscriptionsPostRequestFormItemsItemRecurringX400ceab9(
    public val interval: InlineV1CustomersSubscriptionsPostRequestFormItemsItemPriceDataIntervalX4605205b,
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1CustomersSubscriptionsPostRequestFormItemsItemRecurringX400ceab9 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1CustomersSubscriptionsPostRequestFormItemsItemRecurringX400ceab9> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CustomersSubscriptionsPostRequestFormItemsItemRecurringX400ceab9 must be a JSON object",
                    )
            val interval =
                json
                    .decodeRequired<InlineV1CustomersSubscriptionsPostRequestFormItemsItemPriceDataIntervalX4605205b>(
                        rawObject,
                        "interval",
                    )
            return InlineV1CustomersSubscriptionsPostRequestFormItemsItemRecurringX400ceab9(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersSubscriptionsPostRequestFormItemsItemRecurringX400ceab9,
        ) {
            val jsonEncoder =
...
public fun inlineV1CustomersSubscriptionsPostRequestFormItemsItemRecurringX400ceab9(
    block: InlineV1CustomersSubscriptionsPostRequestFormItemsItemRecurringX400ceab9.Builder.() -> Unit,
): InlineV1CustomersSubscriptionsPostRequestFormItemsItemRecurringX400ceab9 =
    InlineV1CustomersSubscriptionsPostRequestFormItemsItemRecurringX400ceab9.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1CustomersSubscriptionsPostRequestFormItemsItemRecurringX400ceab9 is missing required property '" +
                    name +
                    "'",
            )
