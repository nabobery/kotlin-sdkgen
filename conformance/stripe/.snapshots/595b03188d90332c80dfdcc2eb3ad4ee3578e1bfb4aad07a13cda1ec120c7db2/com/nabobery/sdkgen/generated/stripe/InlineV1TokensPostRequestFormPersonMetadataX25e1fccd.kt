...
public class InlineV1TokensPostRequestFormPersonMetadataX25e1fccd internal constructor(
    ...
    public val inlineV1TokensPostRequestFormPersonMetadataAnyOf2Xe44bae0b:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1TokensPostRequestFormPersonMetadataAnyOf2Xe44bae0b) {
                json
                    .decodeFromJsonElement<InlineV1TokensPostRequestFormPersonMetadataAnyOf2Xe44bae0b>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1TokensPostRequestFormPersonMetadataX25e1fccdBranch>
        get() =
            buildSet {
                ...
                if (inspection.matchesInlineV1TokensPostRequestFormPersonMetadataAnyOf2Xe44bae0b) {
                    add(
                        InlineV1TokensPostRequestFormPersonMetadataX25e1fccdBranch.InlineV1TokensPostRequestFormPersonMetadataAnyOf2Xe44bae0b,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1TokensPostRequestFormPersonMetadataX25e1fccd {
            val inspection = inspectInlineV1TokensPostRequestFormPersonMetadataX25e1fccd(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1TokensPostRequestFormPersonMetadataX25e1fccdNoMatchException(
                    "InlineV1TokensPostRequestFormPersonMetadataX25e1fccd matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1TokensPostRequestFormPersonMetadataX25e1fccd> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TokensPostRequestFormPersonMetadataX25e1fccd,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1TokensPostRequestFormPersonMetadataX25e1fccd",
...
private fun inspectInlineV1TokensPostRequestFormPersonMetadataX25e1fccd(
    element: JsonElement,
): InlineV1TokensPostRequestFormPersonMetadataX25e1fccdInspection {
    val matchesBranch1 = element.isJsonDecodable<JsonObject>()
    val matchesInlineV1TokensPostRequestFormPersonMetadataAnyOf2Xe44bae0b =
        element
            .isJsonDecodable<InlineV1TokensPostRequestFormPersonMetadataAnyOf2Xe44bae0b>()
    return InlineV1TokensPostRequestFormPersonMetadataX25e1fccdInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1TokensPostRequestFormPersonMetadataAnyOf2Xe44bae0b) {
                    add(
                        "InlineV1TokensPostRequestFormPersonMetadataAnyOf2Xe44bae0b: value does not match InlineV1TokensPostRequestFormPersonMetadataAnyOf2Xe44bae0b",
                    )
                }
            },
    )
