...
public class PaymentIntentNextActionPromptpayDisplayQrCode(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentIntentNextActionPromptpayDisplayQrCode =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentIntentNextActionPromptpayDisplayQrCode> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "PaymentIntentNextActionPromptpayDisplayQrCode must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentIntentNextActionPromptpayDisplayQrCode,
        ) {
...
public fun paymentIntentNextActionPromptpayDisplayQrCode(
    block: PaymentIntentNextActionPromptpayDisplayQrCode.Builder.() -> Unit,
): PaymentIntentNextActionPromptpayDisplayQrCode = PaymentIntentNextActionPromptpayDisplayQrCode.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "PaymentIntentNextActionPromptpayDisplayQrCode is missing required property '" + name + "'",
            )
