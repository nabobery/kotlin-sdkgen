...
public class InlineV1IssuingCardsPostRequestFormLifecycleControlsX423db20f(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1IssuingCardsPostRequestFormLifecycleControlsX423db20f =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1IssuingCardsPostRequestFormLifecycleControlsX423db20f> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1IssuingCardsPostRequestFormLifecycleControlsX423db20f {
            val jsonDecoder =
                decoder.requireJsonDecoder(
                    "InlineV1IssuingCardsPostRequestFormLifecycleControlsX423db20f",
                )
            val json = jsonDecoder.json
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1IssuingCardsPostRequestFormLifecycleControlsX423db20f must be a JSON object",
                    )
            val cancelAfter =
                json.decodeRequired<InlineV1IssuingCardsPostRequestFormLifecycleControlsCancelAfterX06e34d41>(
                    rawObject,
                    "cancel_after",
                )
            return InlineV1IssuingCardsPostRequestFormLifecycleControlsX423db20f(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingCardsPostRequestFormLifecycleControlsX423db20f,
        ) {
            val jsonEncoder =
...
public fun inlineV1IssuingCardsPostRequestFormLifecycleControlsX423db20f(
    block: InlineV1IssuingCardsPostRequestFormLifecycleControlsX423db20f.Builder.() -> Unit,
): InlineV1IssuingCardsPostRequestFormLifecycleControlsX423db20f =
    InlineV1IssuingCardsPostRequestFormLifecycleControlsX423db20f.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1IssuingCardsPostRequestFormLifecycleControlsX423db20f is missing required property '" + name +
                    "'",
            )
