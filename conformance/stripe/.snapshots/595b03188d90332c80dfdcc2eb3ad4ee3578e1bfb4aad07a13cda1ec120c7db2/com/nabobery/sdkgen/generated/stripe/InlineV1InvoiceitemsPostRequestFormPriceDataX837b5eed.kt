...
public class InlineV1InvoiceitemsPostRequestFormPriceDataX837b5eed(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1InvoiceitemsPostRequestFormPriceDataX837b5eed =
    ...
    public object Serializer : KSerializer<InlineV1InvoiceitemsPostRequestFormPriceDataX837b5eed> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1InvoiceitemsPostRequestFormPriceDataX837b5eed must be a JSON object",
                    )
            ...
            return InlineV1InvoiceitemsPostRequestFormPriceDataX837b5eed(
                ...
                taxBehavior =
                    rawObject["tax_behavior"]?.let {
                        json.decodeFromJsonElement<InlineV1InvoiceitemsPostRequestFormPriceDataTaxBehaviorX98cb2ae6>(it)
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoiceitemsPostRequestFormPriceDataX837b5eed,
        ) {
...
public fun inlineV1InvoiceitemsPostRequestFormPriceDataX837b5eed(
    block: InlineV1InvoiceitemsPostRequestFormPriceDataX837b5eed.Builder.() -> Unit,
): InlineV1InvoiceitemsPostRequestFormPriceDataX837b5eed =
    InlineV1InvoiceitemsPostRequestFormPriceDataX837b5eed.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1InvoiceitemsPostRequestFormPriceDataX837b5eed is missing required property '" + name + "'",
            )
