...
public class PaymentMethodDetailsCardWalletMasterpass(
     ...
     */
    public val billingAddress: InlinePaymentMethodDetailsCardWalletMasterpassBillingAddressX091a10a3? = null,
    /**
     ...
     */
    public val shippingAddress: InlinePaymentMethodDetailsCardWalletMasterpassShippingAddressXa2825911? = null,
) {
    public class Builder {
        ...
        public fun build(): PaymentMethodDetailsCardWalletMasterpass =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentMethodDetailsCardWalletMasterpass =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentMethodDetailsCardWalletMasterpass> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodDetailsCardWalletMasterpass {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodDetailsCardWalletMasterpass must be a JSON object")
                ...
                billingAddress =
                    rawObject["billing_address"]?.let { element ->
                        if (element ==
                            ...
                            json
                                .decodeFromJsonElement<InlinePaymentMethodDetailsCardWalletMasterpassBillingAddressX091a10a3?>(
                                    element,
                                )
                        }
                    },
                ...
                shippingAddress =
                    rawObject["shipping_address"]?.let { element ->
                        if (element ==
                            ...
                            json
                                .decodeFromJsonElement<InlinePaymentMethodDetailsCardWalletMasterpassShippingAddressXa2825911?>(
                                    element,
                                )
                        }
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentMethodDetailsCardWalletMasterpass,
        ) {
...
public fun paymentMethodDetailsCardWalletMasterpass(
    block: PaymentMethodDetailsCardWalletMasterpass.Builder.() -> Unit,
): PaymentMethodDetailsCardWalletMasterpass = PaymentMethodDetailsCardWalletMasterpass.build(block)
