        ...
        override fun deserialize(decoder: Decoder): DiscountSource {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("DiscountSource must be a JSON object")
                ...
                coupon =
                    rawObject["coupon"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineDiscountSourceCouponX03063bd3?>(element)
                        }
                    },
            )
        }
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("DiscountSource is missing required property '" + name + "'")
