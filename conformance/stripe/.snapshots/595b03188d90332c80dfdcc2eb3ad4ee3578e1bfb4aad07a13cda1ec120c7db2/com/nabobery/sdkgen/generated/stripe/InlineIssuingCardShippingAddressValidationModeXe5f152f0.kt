...
public sealed class InlineIssuingCardShippingAddressValidationModeXe5f152f0 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineIssuingCardShippingAddressValidationModeXe5f152f0 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineIssuingCardShippingAddressValidationModeXe5f152f0> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineIssuingCardShippingAddressValidationModeXe5f152f0",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineIssuingCardShippingAddressValidationModeXe5f152f0 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineIssuingCardShippingAddressValidationModeXe5f152f0,
        ) {
