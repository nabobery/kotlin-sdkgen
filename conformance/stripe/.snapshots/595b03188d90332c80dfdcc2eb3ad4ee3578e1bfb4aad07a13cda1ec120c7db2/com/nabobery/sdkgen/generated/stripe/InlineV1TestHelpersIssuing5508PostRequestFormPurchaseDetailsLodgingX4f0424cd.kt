...
public class InlineV1TestHelpersIssuing5508PostRequestFormPurchaseDetailsLodgingX4f0424cd(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1TestHelpersIssuing5508PostRequestFormPurchaseDetailsLodgingX4f0424cd =
            InlineV1TestHelpersIssuing5508PostRequestFormPurchaseDetailsLodgingX4f0424cd(
                checkInAt = checkInAt,
                nights = nights,
            )
    }
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1TestHelpersIssuing5508PostRequestFormPurchaseDetailsLodgingX4f0424cd = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1TestHelpersIssuing5508PostRequestFormPurchaseDetailsLodgingX4f0424cd> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TestHelpersIssuing5508PostRequestFormPurchaseDetailsLodgingX4f0424cd must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TestHelpersIssuing5508PostRequestFormPurchaseDetailsLodgingX4f0424cd,
        ) {
            val jsonEncoder =
...
public fun inlineV1TestHelpersIssuing5508PostRequestFormPurchaseDetailsLodgingX4f0424cd(
    block: InlineV1TestHelpersIssuing5508PostRequestFormPurchaseDetailsLodgingX4f0424cd.Builder.() -> Unit,
): InlineV1TestHelpersIssuing5508PostRequestFormPurchaseDetailsLodgingX4f0424cd =
    InlineV1TestHelpersIssuing5508PostRequestFormPurchaseDetailsLodgingX4f0424cd.build(block)
