...
public class InlineCustomerBalanceResou4f2cPaymentIntentX0d166ba8 internal constructor(
        ...
        get() =
            buildSet {
                ...
                if (inspection.matchesPaymentIntent) {
                    add(
                        InlineCustomerBalanceResou4f2cPaymentIntentX0d166ba8Branch.PaymentIntent,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineCustomerBalanceResou4f2cPaymentIntentX0d166ba8 {
            val inspection = inspectInlineCustomerBalanceResou4f2cPaymentIntentX0d166ba8(raw)
            if (inspection.matchCount == 0) {
                throw InlineCustomerBalanceResou4f2cPaymentIntentX0d166ba8NoMatchException(
                    "InlineCustomerBalanceResou4f2cPaymentIntentX0d166ba8 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineCustomerBalanceResou4f2cPaymentIntentX0d166ba8> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineCustomerBalanceResou4f2cPaymentIntentX0d166ba8,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineCustomerBalanceResou4f2cPaymentIntentX0d166ba8",
...
private fun inspectInlineCustomerBalanceResou4f2cPaymentIntentX0d166ba8(
    element: JsonElement,
): InlineCustomerBalanceResou4f2cPaymentIntentX0d166ba8Inspection {
