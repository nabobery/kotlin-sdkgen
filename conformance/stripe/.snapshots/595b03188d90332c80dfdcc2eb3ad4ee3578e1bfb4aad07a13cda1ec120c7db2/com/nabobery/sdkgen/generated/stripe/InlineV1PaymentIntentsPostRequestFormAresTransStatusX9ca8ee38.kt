...
public sealed class InlineV1PaymentIntentsPostRequestFormAresTransStatusX9ca8ee38 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1PaymentIntentsPostRequestFormAresTransStatusX9ca8ee38 =
            when (value) {
                A.value -> A
                C.value -> C
                I.value -> I
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormAresTransStatusX9ca8ee38> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1PaymentIntentsPostRequestFormAresTransStatusX9ca8ee38",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1PaymentIntentsPostRequestFormAresTransStatusX9ca8ee38 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormAresTransStatusX9ca8ee38,
        ) {
