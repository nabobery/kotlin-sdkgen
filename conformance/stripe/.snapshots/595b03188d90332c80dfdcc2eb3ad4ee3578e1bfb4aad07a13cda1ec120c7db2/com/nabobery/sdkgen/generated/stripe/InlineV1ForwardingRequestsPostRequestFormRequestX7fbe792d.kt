...
public class InlineV1ForwardingRequestsPostRequestFormRequestX7fbe792d(
    ...
    public val headers: List<InlineV1ForwardingRequestsPostRequestFormRequestHeadersItemXea6137c7>? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1ForwardingRequestsPostRequestFormRequestX7fbe792d =
            InlineV1ForwardingRequestsPostRequestFormRequestX7fbe792d(
                body = body,
                headers = headers,
            )
    }
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1ForwardingRequestsPostRequestFormRequestX7fbe792d =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1ForwardingRequestsPostRequestFormRequestX7fbe792d> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1ForwardingRequestsPostRequestFormRequestX7fbe792d {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1ForwardingRequestsPostRequestFormRequestX7fbe792d must be a JSON object",
                    )
            return InlineV1ForwardingRequestsPostRequestFormRequestX7fbe792d(
                ...
                headers =
                    rawObject["headers"]?.let {
                        json
                            .decodeFromJsonElement<List<InlineV1ForwardingRequestsPostRequestFormRequestHeadersItemXea6137c7>>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ForwardingRequestsPostRequestFormRequestX7fbe792d,
        ) {
...
public fun inlineV1ForwardingRequestsPostRequestFormRequestX7fbe792d(
    block: InlineV1ForwardingRequestsPostRequestFormRequestX7fbe792d.Builder.() -> Unit,
): InlineV1ForwardingRequestsPostRequestFormRequestX7fbe792d =
    InlineV1ForwardingRequestsPostRequestFormRequestX7fbe792d.build(block)
