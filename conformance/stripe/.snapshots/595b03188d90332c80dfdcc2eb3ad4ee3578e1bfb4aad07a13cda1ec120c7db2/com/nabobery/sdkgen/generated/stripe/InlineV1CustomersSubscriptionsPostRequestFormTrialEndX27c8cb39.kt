...
internal data class InlineV1CustomersSubscriptionsPostRequestFormTrialEndX27c8cb39Inspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesInlineV1CustomersSubscriptionsPostRequestFormTrialEndAnyOf1X11b2aee1,
                matchesBranch2,
            ).count { it }
}
...
public class InlineV1CustomersSubscriptionsPostRequestFormTrialEndX27c8cb39 internal constructor(
    ...
    public val inlineV1CustomersSubscriptionsPostRequestFormTrialEndAnyOf1X11b2aee1:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1CustomersSubscriptionsPostRequestFormTrialEndAnyOf1X11b2aee1) {
                json
                    .decodeFromJsonElement<InlineV1CustomersSubscriptionsPostRequestFormTrialEndAnyOf1X11b2aee1>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches:
        ...
        get() =
            buildSet {
                if (inspection.matchesInlineV1CustomersSubscriptionsPostRequestFormTrialEndAnyOf1X11b2aee1) {
                    add(
                        InlineV1CustomersSubscriptionsPostRequestFormTrialEndX27c8cb39Branch.InlineV1CustomersSubscriptionsPostRequestFormTrialEndAnyOf1X11b2aee1,
                    )
                }
                if (inspection.matchesBranch2) {
                    add(
                        InlineV1CustomersSubscriptionsPostRequestFormTrialEndX27c8cb39Branch.Branch2,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1CustomersSubscriptionsPostRequestFormTrialEndX27c8cb39 {
            val inspection = inspectInlineV1CustomersSubscriptionsPostRequestFormTrialEndX27c8cb39(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1CustomersSubscriptionsPostRequestFormTrialEndX27c8cb39NoMatchException(
                    "InlineV1CustomersSubscriptionsPostRequestFormTrialEndX27c8cb39 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1CustomersSubscriptionsPostRequestFormTrialEndX27c8cb39> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersSubscriptionsPostRequestFormTrialEndX27c8cb39,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1CustomersSubscriptionsPostRequestFormTrialEndX27c8cb39",
...
private fun inspectInlineV1CustomersSubscriptionsPostRequestFormTrialEndX27c8cb39(
    element: JsonElement,
): InlineV1CustomersSubscriptionsPostRequestFormTrialEndX27c8cb39Inspection {
    val matchesInlineV1CustomersSubscriptionsPostRequestFormTrialEndAnyOf1X11b2aee1 =
        element
            .isJsonDecodable<InlineV1CustomersSubscriptionsPostRequestFormTrialEndAnyOf1X11b2aee1>()
    ...
    return InlineV1CustomersSubscriptionsPostRequestFormTrialEndX27c8cb39Inspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1CustomersSubscriptionsPostRequestFormTrialEndAnyOf1X11b2aee1) {
                    add(
                        "InlineV1CustomersSubscriptionsPostRequestFormTrialEndAnyOf1X11b2aee1: value does not match InlineV1CustomersSubscriptionsPostRequestFormTrialEndAnyOf1X11b2aee1",
                    )
                }
