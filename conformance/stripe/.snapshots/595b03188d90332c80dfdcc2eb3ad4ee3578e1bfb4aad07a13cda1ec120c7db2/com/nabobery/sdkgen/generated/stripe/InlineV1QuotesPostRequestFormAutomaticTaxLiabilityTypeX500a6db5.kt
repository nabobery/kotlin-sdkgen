...
public sealed class InlineV1QuotesPostRequestFormAutomaticTaxLiabilityTypeX500a6db5 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1QuotesPostRequestFormAutomaticTaxLiabilityTypeX500a6db5 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1QuotesPostRequestFormAutomaticTaxLiabilityTypeX500a6db5> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1QuotesPostRequestFormAutomaticTaxLiabilityTypeX500a6db5",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1QuotesPostRequestFormAutomaticTaxLiabilityTypeX500a6db5 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1QuotesPostRequestFormAutomaticTaxLiabilityTypeX500a6db5,
        ) {
