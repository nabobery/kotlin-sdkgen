...
public class InlineV1DisputesPostRequestFormX35ec3ef6(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1DisputesPostRequestFormX35ec3ef6 =
            InlineV1DisputesPostRequestFormX35ec3ef6(
                evidence = evidence,
                expand = expand,
                metadata = metadata,
                submit = submit,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1DisputesPostRequestFormX35ec3ef6 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1DisputesPostRequestFormX35ec3ef6> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1DisputesPostRequestFormX35ec3ef6 {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("InlineV1DisputesPostRequestFormX35ec3ef6 must be a JSON object")
            return InlineV1DisputesPostRequestFormX35ec3ef6(
                evidence =
                    rawObject["evidence"]?.let {
                        json.decodeFromJsonElement<InlineV1DisputesPostRequestFormEvidenceXb8c791ab>(it)
                    },
                expand = rawObject["expand"]?.let { json.decodeFromJsonElement<List<String>>(it) },
                metadata =
                    rawObject["metadata"]?.let {
                        json.decodeFromJsonElement<InlineV1DisputesPostRequestFormMetadataXf890f822>(it)
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1DisputesPostRequestFormX35ec3ef6,
        ) {
...
public fun inlineV1DisputesPostRequestFormX35ec3ef6(
    block: InlineV1DisputesPostRequestFormX35ec3ef6.Builder.() -> Unit,
): InlineV1DisputesPostRequestFormX35ec3ef6 = InlineV1DisputesPostRequestFormX35ec3ef6.build(block)
