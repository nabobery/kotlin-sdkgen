...
public class AccountPaymentsSettings(
    ...
    public class Builder {
        ...
        public fun build(): AccountPaymentsSettings =
        ...
        override fun deserialize(decoder: Decoder): AccountPaymentsSettings {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("AccountPaymentsSettings must be a JSON object")
            return AccountPaymentsSettings(
                ...
                statementDescriptorKana =
                    rawObject["statement_descriptor_kana"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                statementDescriptorKanji =
                    rawObject["statement_descriptor_kanji"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
...
public fun accountPaymentsSettings(block: AccountPaymentsSettings.Builder.() -> Unit): AccountPaymentsSettings =
    AccountPaymentsSettings.build(block)
