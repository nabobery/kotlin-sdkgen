...
public class InlineV1PricesPostRequestFormCurrencyOptionsCustomUnitAmountX5dc1d270(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PricesPostRequestFormCurrencyOptionsCustomUnitAmountX5dc1d270 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PricesPostRequestFormCurrencyOptionsCustomUnitAmountX5dc1d270> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PricesPostRequestFormCurrencyOptionsCustomUnitAmountX5dc1d270 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PricesPostRequestFormCurrencyOptionsCustomUnitAmountX5dc1d270,
        ) {
            val jsonEncoder =
...
public fun inlineV1PricesPostRequestFormCurrencyOptionsCustomUnitAmountX5dc1d270(
    block: InlineV1PricesPostRequestFormCurrencyOptionsCustomUnitAmountX5dc1d270.Builder.() -> Unit,
): InlineV1PricesPostRequestFormCurrencyOptionsCustomUnitAmountX5dc1d270 =
    InlineV1PricesPostRequestFormCurrencyOptionsCustomUnitAmountX5dc1d270.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PricesPostRequestFormCurrencyOptionsCustomUnitAmountX5dc1d270 is missing required property '" +
                    name +
                    "'",
            )
