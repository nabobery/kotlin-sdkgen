...
public class InlineV1CheckoutSessionsPostRequestFormMandateOptionsXb7111296(
    ...
    public val amountIncludesIof: InlineV1CheckoutSessionsPostRequestFormAmountIncludesIofX3737cb64? = null,
    public val amountType: InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsAmountTypeX382ec7ae? = null,
    public val currency: String? = null,
    public val endDate: String? = null,
    public val paymentSchedule: InlineV1CheckoutSessionsPostRequestFormPaymentScheduleX6d3e76cd? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1CheckoutSessionsPostRequestFormMandateOptionsXb7111296 =
            InlineV1CheckoutSessionsPostRequestFormMandateOptionsXb7111296(
                amount = amount,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1CheckoutSessionsPostRequestFormMandateOptionsXb7111296 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormMandateOptionsXb7111296> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CheckoutSessionsPostRequestFormMandateOptionsXb7111296 must be a JSON object",
                    )
            return InlineV1CheckoutSessionsPostRequestFormMandateOptionsXb7111296(
                amount = rawObject["amount"]?.let { json.decodeFromJsonElement<Int>(it) },
                amountIncludesIof =
                    rawObject["amount_includes_iof"]?.let {
                        json.decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormAmountIncludesIofX3737cb64>(
                            it,
                        )
                    },
                amountType =
                    rawObject["amount_type"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsAmountTypeX382ec7ae>(
                                it,
                            )
                    },
                ...
                paymentSchedule =
                    rawObject["payment_schedule"]?.let {
                        json.decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormPaymentScheduleX6d3e76cd>(it)
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsPostRequestFormMandateOptionsXb7111296,
        ) {
            val jsonEncoder =
...
public fun inlineV1CheckoutSessionsPostRequestFormMandateOptionsXb7111296(
    block: InlineV1CheckoutSessionsPostRequestFormMandateOptionsXb7111296.Builder.() -> Unit,
): InlineV1CheckoutSessionsPostRequestFormMandateOptionsXb7111296 =
    InlineV1CheckoutSessionsPostRequestFormMandateOptionsXb7111296.build(block)
