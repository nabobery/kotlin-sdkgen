...
public class InlineIssuingDisputeServicdc63AdditionalDocumentationXb915dfd4 internal constructor(
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineIssuingDisputeServicdc63AdditionalDocumentationXb915dfd4Branch.Branch1,
                    )
                }
                if (inspection.matchesFile) {
                    add(
                        InlineIssuingDisputeServicdc63AdditionalDocumentationXb915dfd4Branch.File,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineIssuingDisputeServicdc63AdditionalDocumentationXb915dfd4 {
            val inspection = inspectInlineIssuingDisputeServicdc63AdditionalDocumentationXb915dfd4(raw)
            if (inspection.matchCount == 0) {
                throw InlineIssuingDisputeServicdc63AdditionalDocumentationXb915dfd4NoMatchException(
                    "InlineIssuingDisputeServicdc63AdditionalDocumentationXb915dfd4 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineIssuingDisputeServicdc63AdditionalDocumentationXb915dfd4> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineIssuingDisputeServicdc63AdditionalDocumentationXb915dfd4,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineIssuingDisputeServicdc63AdditionalDocumentationXb915dfd4",
...
private fun inspectInlineIssuingDisputeServicdc63AdditionalDocumentationXb915dfd4(
    element: JsonElement,
): InlineIssuingDisputeServicdc63AdditionalDocumentationXb915dfd4Inspection {
