...
public class InlineV1PaymentLinksPostRequestFormSubscriptionDataTrialSettingsXd2edc941(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentLinksPostRequestFormSubscriptionDataTrialSettingsXd2edc941 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentLinksPostRequestFormSubscriptionDataTrialSettingsXd2edc941> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentLinksPostRequestFormSubscriptionDataTrialSettingsXd2edc941 must be a JSON object",
                    )
            val endBehavior =
                json.decodeRequired<InlineV1PaymentLinksPostRequestFormSubscriptionDataEndBehaviorX33b230a2>(
                    rawObject,
                    "end_behavior",
                )
            return InlineV1PaymentLinksPostRequestFormSubscriptionDataTrialSettingsXd2edc941(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentLinksPostRequestFormSubscriptionDataTrialSettingsXd2edc941,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentLinksPostRequestFormSubscriptionDataTrialSettingsXd2edc941(
    block: InlineV1PaymentLinksPostRequestFormSubscriptionDataTrialSettingsXd2edc941.Builder.() -> Unit,
): InlineV1PaymentLinksPostRequestFormSubscriptionDataTrialSettingsXd2edc941 =
    InlineV1PaymentLinksPostRequestFormSubscriptionDataTrialSettingsXd2edc941.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentLinksPostRequestFormSubscriptionDataTrialSettingsXd2edc941 is missing required property '" +
                    name +
                    "'",
            )
