...
public sealed class InlineV1SubscriptionSchedulesPostRequestFormPhasesItemAutomaticTaxTypeX8b1e9bfe {
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemAutomaticTaxTypeX8b1e9bfe> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1SubscriptionSchedulesPostRequestFormPhasesItemAutomaticTaxTypeX8b1e9bfe",
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionSchedulesPostRequestFormPhasesItemAutomaticTaxTypeX8b1e9bfe,
        ) {
