...
public sealed class InlineFeeRefundObjectValueX4e9deb45 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineFeeRefundObjectValueX4e9deb45 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineFeeRefundObjectValueX4e9deb45> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineFeeRefundObjectValueX4e9deb45",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineFeeRefundObjectValueX4e9deb45 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineFeeRefundObjectValueX4e9deb45,
        ) {
