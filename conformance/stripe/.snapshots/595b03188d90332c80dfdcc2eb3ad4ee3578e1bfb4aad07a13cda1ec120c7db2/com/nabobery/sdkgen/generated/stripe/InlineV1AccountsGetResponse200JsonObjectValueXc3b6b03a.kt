...
public sealed class InlineV1AccountsGetResponse200JsonObjectValueXc3b6b03a {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1AccountsGetResponse200JsonObjectValueXc3b6b03a =
            when (value) {
                List.value -> List
    ...
    public object Serializer : KSerializer<InlineV1AccountsGetResponse200JsonObjectValueXc3b6b03a> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1AccountsGetResponse200JsonObjectValueXc3b6b03a",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1AccountsGetResponse200JsonObjectValueXc3b6b03a =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsGetResponse200JsonObjectValueXc3b6b03a,
        ) {
