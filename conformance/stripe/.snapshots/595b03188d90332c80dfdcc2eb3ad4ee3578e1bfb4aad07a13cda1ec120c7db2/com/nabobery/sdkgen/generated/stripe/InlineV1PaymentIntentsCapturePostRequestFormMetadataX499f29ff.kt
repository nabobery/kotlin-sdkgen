...
internal data class InlineV1PaymentIntentsCapturePostRequestFormMetadataX499f29ffInspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1PaymentIntentsCapturePostRequestFormMetadataAnyOf2Xf119eacb,
            ).count { it }
}
...
public class InlineV1PaymentIntentsCapturePostRequestFormMetadataX499f29ff internal constructor(
    ...
    public val inlineV1PaymentIntentsCapturePostRequestFormMetadataAnyOf2Xf119eacb:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1PaymentIntentsCapturePostRequestFormMetadataAnyOf2Xf119eacb) {
                json
                    .decodeFromJsonElement<InlineV1PaymentIntentsCapturePostRequestFormMetadataAnyOf2Xf119eacb>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1PaymentIntentsCapturePostRequestFormMetadataX499f29ffBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1PaymentIntentsCapturePostRequestFormMetadataAnyOf2Xf119eacb) {
                    add(
                        InlineV1PaymentIntentsCapturePostRequestFormMetadataX499f29ffBranch.InlineV1PaymentIntentsCapturePostRequestFormMetadataAnyOf2Xf119eacb,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1PaymentIntentsCapturePostRequestFormMetadataX499f29ff {
            val inspection = inspectInlineV1PaymentIntentsCapturePostRequestFormMetadataX499f29ff(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1PaymentIntentsCapturePostRequestFormMetadataX499f29ffNoMatchException(
                    "InlineV1PaymentIntentsCapturePostRequestFormMetadataX499f29ff matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsCapturePostRequestFormMetadataX499f29ff> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsCapturePostRequestFormMetadataX499f29ff,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1PaymentIntentsCapturePostRequestFormMetadataX499f29ff",
...
private fun inspectInlineV1PaymentIntentsCapturePostRequestFormMetadataX499f29ff(
    element: JsonElement,
): InlineV1PaymentIntentsCapturePostRequestFormMetadataX499f29ffInspection {
    val matchesBranch1 = element.isJsonDecodable<JsonObject>()
    val matchesInlineV1PaymentIntentsCapturePostRequestFormMetadataAnyOf2Xf119eacb =
        element
            .isJsonDecodable<InlineV1PaymentIntentsCapturePostRequestFormMetadataAnyOf2Xf119eacb>()
    return InlineV1PaymentIntentsCapturePostRequestFormMetadataX499f29ffInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1PaymentIntentsCapturePostRequestFormMetadataAnyOf2Xf119eacb) {
                    add(
                        "InlineV1PaymentIntentsCapturePostRequestFormMetadataAnyOf2Xf119eacb: value does not match InlineV1PaymentIntentsCapturePostRequestFormMetadataAnyOf2Xf119eacb",
                    )
                }
            },
    )
