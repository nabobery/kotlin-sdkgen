...
public class InlineLineItemSubscriptionX73f0eb42 internal constructor(
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineLineItemSubscriptionX73f0eb42 {
            val inspection = inspectInlineLineItemSubscriptionX73f0eb42(raw)
            if (inspection.matchCount == 0) {
                throw InlineLineItemSubscriptionX73f0eb42NoMatchException(
                    "InlineLineItemSubscriptionX73f0eb42 matched 0 branches: " + inspection.failures.joinToString("; "),
                )
            }
    ...
    public object Serializer : KSerializer<InlineLineItemSubscriptionX73f0eb42> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineLineItemSubscriptionX73f0eb42,
        ) {
...
private fun inspectInlineLineItemSubscriptionX73f0eb42(
    element: JsonElement,
): InlineLineItemSubscriptionX73f0eb42Inspection {
