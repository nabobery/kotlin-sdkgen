...
public sealed class InlineCapabilityObjectValueX681bd393 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineCapabilityObjectValueX681bd393 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineCapabilityObjectValueX681bd393> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineCapabilityObjectValueX681bd393",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineCapabilityObjectValueX681bd393 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineCapabilityObjectValueX681bd393,
        ) {
