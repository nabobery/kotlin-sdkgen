...
public sealed class InlineAccountCapabilitiesPaynowPaymentsXdce3eda9 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineAccountCapabilitiesPaynowPaymentsXdce3eda9 =
            when (value) {
                Active.value -> Active
    ...
    public object Serializer : KSerializer<InlineAccountCapabilitiesPaynowPaymentsXdce3eda9> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineAccountCapabilitiesPaynowPaymentsXdce3eda9",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineAccountCapabilitiesPaynowPaymentsXdce3eda9 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineAccountCapabilitiesPaynowPaymentsXdce3eda9,
        ) {
