...
public class TerminalReaderReaderResourceConfirmPaymentIntentAction(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): TerminalReaderReaderResourceConfirmPaymentIntentAction =
    ...
    public object Serializer : KSerializer<TerminalReaderReaderResourceConfirmPaymentIntentAction> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "TerminalReaderReaderResourceConfirmPaymentIntentAction must be a JSON object",
                    )
            val paymentIntent =
                json.decodeRequired<InlineTerminalReaderReaderb89cPaymentIntentX02f1bde6>(
                    rawObject,
                    "payment_intent",
                )
            return TerminalReaderReaderResourceConfirmPaymentIntentAction(
                ...
                confirmConfig =
                    rawObject["confirm_config"]?.let {
                        json.decodeFromJsonElement<TerminalReaderReaderResourceConfirmConfig>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: TerminalReaderReaderResourceConfirmPaymentIntentAction,
        ) {
...
public fun terminalReaderReaderResourceConfirmPaymentIntentAction(
    block: TerminalReaderReaderResourceConfirmPaymentIntentAction.Builder.() -> Unit,
): TerminalReaderReaderResourceConfirmPaymentIntentAction =
    TerminalReaderReaderResourceConfirmPaymentIntentAction.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "TerminalReaderReaderResourceConfirmPaymentIntentAction is missing required property '" + name + "'",
            )
