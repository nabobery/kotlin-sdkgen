...
public class InlineV1PaymentMethodConfidc49PostRequestFormBillieDisplayPreferenceXf6e1fbbb(
    public val preference: InlineV1PaymentMethodConfidc49PostRequestFormBilliePreferenceX013aca38? = null,
) {
    public class Builder {
        public var preference: InlineV1PaymentMethodConfidc49PostRequestFormBilliePreferenceX013aca38? =
            null

        public fun build(): InlineV1PaymentMethodConfidc49PostRequestFormBillieDisplayPreferenceXf6e1fbbb =
            InlineV1PaymentMethodConfidc49PostRequestFormBillieDisplayPreferenceXf6e1fbbb(
    ...
    public object Serializer : KSerializer<InlineV1PaymentMethodConfidc49PostRequestFormBillieDisplayPreferenceXf6e1fbbb> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentMethodConfidc49PostRequestFormBillieDisplayPreferenceXf6e1fbbb must be a JSON object",
                    )
            return InlineV1PaymentMethodConfidc49PostRequestFormBillieDisplayPreferenceXf6e1fbbb(
                preference =
                    rawObject["preference"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentMethodConfidc49PostRequestFormBilliePreferenceX013aca38>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentMethodConfidc49PostRequestFormBillieDisplayPreferenceXf6e1fbbb,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentMethodConfidc49PostRequestFormBillieDisplayPreferenceXf6e1fbbb(
    block: InlineV1PaymentMethodConfidc49PostRequestFormBillieDisplayPreferenceXf6e1fbbb.Builder.() -> Unit,
): InlineV1PaymentMethodConfidc49PostRequestFormBillieDisplayPreferenceXf6e1fbbb =
