...
public class RefundDestinationDetailsBrBankTransfer(
    ...
    public class Builder {
        ...
        public fun build(): RefundDestinationDetailsBrBankTransfer =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): RefundDestinationDetailsBrBankTransfer =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<RefundDestinationDetailsBrBankTransfer> {
        ...
        override fun deserialize(decoder: Decoder): RefundDestinationDetailsBrBankTransfer {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("RefundDestinationDetailsBrBankTransfer must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: RefundDestinationDetailsBrBankTransfer,
        ) {
...
public fun refundDestinationDetailsBrBankTransfer(
    block: RefundDestinationDetailsBrBankTransfer.Builder.() -> Unit,
): RefundDestinationDetailsBrBankTransfer = RefundDestinationDetailsBrBankTransfer.build(block)
