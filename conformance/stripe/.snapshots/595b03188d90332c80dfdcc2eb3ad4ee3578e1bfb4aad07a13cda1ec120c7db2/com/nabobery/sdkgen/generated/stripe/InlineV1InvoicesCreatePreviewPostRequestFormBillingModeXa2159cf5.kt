...
public class InlineV1InvoicesCreatePreviewPostRequestFormBillingModeXa2159cf5(
    ...
    public val flexible: InlineV1InvoicesCreatePreviewPostRequestFormSubscriptionDetailsFlexibleX94955cad? = null,
) {
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1InvoicesCreatePreviewPostRequestFormBillingModeXa2159cf5 =
    ...
    public object Serializer : KSerializer<InlineV1InvoicesCreatePreviewPostRequestFormBillingModeXa2159cf5> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1InvoicesCreatePreviewPostRequestFormBillingModeXa2159cf5 {
            val jsonDecoder =
                decoder.requireJsonDecoder(
                    "InlineV1InvoicesCreatePreviewPostRequestFormBillingModeXa2159cf5",
                )
            val json = jsonDecoder.json
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1InvoicesCreatePreviewPostRequestFormBillingModeXa2159cf5 must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineV1InvoicesCreatePreviewPostRequestFormSubscriptionDetailsTypeXb11c3392>(
                    rawObject,
                    "type",
                )
            return InlineV1InvoicesCreatePreviewPostRequestFormBillingModeXa2159cf5(
                ...
                flexible =
                    rawObject["flexible"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1InvoicesCreatePreviewPostRequestFormSubscriptionDetailsFlexibleX94955cad>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesCreatePreviewPostRequestFormBillingModeXa2159cf5,
        ) {
            val jsonEncoder =
...
public fun inlineV1InvoicesCreatePreviewPostRequestFormBillingModeXa2159cf5(
    block: InlineV1InvoicesCreatePreviewPostRequestFormBillingModeXa2159cf5.Builder.() -> Unit,
): InlineV1InvoicesCreatePreviewPostRequestFormBillingModeXa2159cf5 =
    InlineV1InvoicesCreatePreviewPostRequestFormBillingModeXa2159cf5.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1InvoicesCreatePreviewPostRequestFormBillingModeXa2159cf5 is missing required property '" + name +
                    "'",
            )
