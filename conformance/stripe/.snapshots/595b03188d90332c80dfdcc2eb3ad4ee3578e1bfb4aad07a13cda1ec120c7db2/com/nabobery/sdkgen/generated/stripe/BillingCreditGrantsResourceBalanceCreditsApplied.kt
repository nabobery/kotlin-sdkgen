...
public class BillingCreditGrantsResourceBalanceCreditsApplied(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): BillingCreditGrantsResourceBalanceCreditsApplied =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<BillingCreditGrantsResourceBalanceCreditsApplied> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "BillingCreditGrantsResourceBalanceCreditsApplied must be a JSON object",
                    )
            val invoice =
                json.decodeRequired<InlineBillingCreditGrantsResourceBalanceCreditsAppliedInvoiceXb0d637e5>(
                    rawObject,
                    "invoice",
                )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: BillingCreditGrantsResourceBalanceCreditsApplied,
        ) {
...
public fun billingCreditGrantsResourceBalanceCreditsApplied(
    block: BillingCreditGrantsResourceBalanceCreditsApplied.Builder.() -> Unit,
): BillingCreditGrantsResourceBalanceCreditsApplied = BillingCreditGrantsResourceBalanceCreditsApplied.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "BillingCreditGrantsResourceBalanceCreditsApplied is missing required property '" + name + "'",
            )
