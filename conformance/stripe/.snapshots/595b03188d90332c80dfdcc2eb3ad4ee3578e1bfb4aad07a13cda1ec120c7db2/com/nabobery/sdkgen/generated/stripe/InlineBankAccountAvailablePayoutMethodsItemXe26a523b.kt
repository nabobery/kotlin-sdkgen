...
public sealed class InlineBankAccountAvailablePayoutMethodsItemXe26a523b {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineBankAccountAvailablePayoutMethodsItemXe26a523b =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineBankAccountAvailablePayoutMethodsItemXe26a523b> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineBankAccountAvailablePayoutMethodsItemXe26a523b",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineBankAccountAvailablePayoutMethodsItemXe26a523b =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineBankAccountAvailablePayoutMethodsItemXe26a523b,
        ) {
