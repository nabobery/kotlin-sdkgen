...
@Serializable
public data class PaymentLinkView(
...
public class PaymentLink(
    ...
    public class Builder {
         ...
         * The optional items presented to the customer at checkout.
         */
        public var optionalItems: List<PaymentLinksResourceOptionalItem>? = null
         ...
         */
        public var paymentMethodTypes: List<InlinePaymentLinkPaymentMethodTypesItemX5b36364b>? = null
        ...
        override fun deserialize(decoder: Decoder): PaymentLink {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentLink must be a JSON object")
            val active = json.decodeRequired<Boolean>(rawObject, "active")
            val afterCompletion =
                json.decodeRequired<PaymentLinksResourceAfterCompletion>(
                    rawObject,
                    "after_completion",
                )
            ...
            val billingAddressCollection =
                json.decodeRequired<InlinePaymentLinkBillingAddressCollectionX8c0d649d>(
                    rawObject,
            ...
            val customerCreation =
                json.decodeRequired<InlinePaymentLinkCustomerCreationX2f367cb7>(
                    rawObject,
                    "customer_creation",
                )
            ...
            val paymentMethodCollection =
                json.decodeRequired<InlinePaymentLinkPaymentMethodCollectionX19b2f8b5>(
                    rawObject,
                    "payment_method_collection",
                )
            val phoneNumberCollection =
                json.decodeRequired<PaymentLinksResourcePhoneNumberCollection>(
                    rawObject,
                    "phone_number_collection",
                )
            val shippingOptions =
                json.decodeRequired<List<PaymentLinksResourceShippingOption>>(
                    rawObject,
                    "shipping_options",
                )
            val submitType = json.decodeRequired<InlinePaymentLinkSubmitTypeXa03c3bfc>(rawObject, "submit_type")
            val taxIdCollection =
                json.decodeRequired<PaymentLinksResourceTaxIdCollection>(
                    rawObject,
                    "tax_id_collection",
                )
                ...
                application =
                    rawObject["application"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentLinkApplicationX5a0c3952?>(element)
                        }
                    },
                ...
                consentCollection =
                    rawObject["consent_collection"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentLinkConsentCollectionX2d71e575?>(element)
                        }
                    },
                inactiveMessage =
                    rawObject["inactive_message"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                invoiceCreation =
                    rawObject["invoice_creation"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentLinkInvoiceCreationX9a83f095?>(element)
                        }
                    },
                lineItems =
                    rawObject["line_items"]?.let {
                        json
                            .decodeFromJsonElement<InlinePaymentLinkLineItemsX48a608a0>(
                                it,
                            )
                    },
                managedPayments =
                    rawObject["managed_payments"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentLinkManagedPaymentsXfb502a66?>(element)
                        }
                    },
                nameCollection =
                    rawObject["name_collection"]?.let {
                        json.decodeFromJsonElement<PaymentLinksResourceNameCollection>(it)
                    },
                onBehalfOf =
                    rawObject["on_behalf_of"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentLinkOnBehalfOfX640a3de7?>(element)
                        }
                    },
                optionalItems =
                    rawObject["optional_items"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<List<PaymentLinksResourceOptionalItem>?>(element)
                        }
                    },
                paymentIntentData =
                    rawObject["payment_intent_data"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlinePaymentLinkPaymentIntentDataX8866930d?>(element)
                        }
                    },
                paymentMethodOptions =
                    rawObject["payment_method_options"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentLinkPaymentMethodOptionsX4990ce45?>(element)
                        }
                    },
                paymentMethodTypes =
                    rawObject["payment_method_types"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<List<InlinePaymentLinkPaymentMethodTypesItemX5b36364b>?>(element)
                        }
                    },
                restrictions =
                    rawObject["restrictions"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlinePaymentLinkRestrictionsXaf818cc6?>(element)
                        }
                    },
                shippingAddressCollection =
                    rawObject["shipping_address_collection"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentLinkShippingAddressCollectionXeac79dd6?>(element)
                        }
                    },
                subscriptionData =
                    rawObject["subscription_data"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlinePaymentLinkSubscriptionDataXc04bdbec?>(element)
                        }
                    },
                transferData =
                    rawObject["transfer_data"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentLinkTransferDataX31f4137c?>(element)
                        }
                    },
            )
        }
