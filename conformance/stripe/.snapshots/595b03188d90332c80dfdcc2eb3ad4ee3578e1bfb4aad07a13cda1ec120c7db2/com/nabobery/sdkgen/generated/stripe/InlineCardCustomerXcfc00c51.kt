...
public class InlineCardCustomerXcfc00c51 internal constructor(
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineCardCustomerXcfc00c51 {
            val inspection = inspectInlineCardCustomerXcfc00c51(raw)
            if (inspection.matchCount == 0) {
                throw InlineCardCustomerXcfc00c51NoMatchException(
                    "InlineCardCustomerXcfc00c51 matched 0 branches: " + inspection.failures.joinToString("; "),
                )
            }
    ...
    public object Serializer : KSerializer<InlineCardCustomerXcfc00c51> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineCardCustomerXcfc00c51,
        ) {
