...
public sealed class InlineIssuingAuthorizationCardPresenceX536d5448 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineIssuingAuthorizationCardPresenceX536d5448 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineIssuingAuthorizationCardPresenceX536d5448> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineIssuingAuthorizationCardPresenceX536d5448",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineIssuingAuthorizationCardPresenceX536d5448 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineIssuingAuthorizationCardPresenceX536d5448,
        ) {
