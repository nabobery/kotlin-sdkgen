...
public sealed class InlineQuoteStatusX90d749ee {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineQuoteStatusX90d749ee =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineQuoteStatusX90d749ee> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineQuoteStatusX90d749ee",
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineQuoteStatusX90d749ee,
        ) {
