...
public class InlineThresholdsResourceUsageThresholdConfigMeterXe7f01422 internal constructor(
    ...
    public val billingMeter: BillingMeter? by
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesBillingMeter) json.decodeFromJsonElement<BillingMeter>(raw) else null
        }
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineThresholdsResourceUsageThresholdConfigMeterXe7f01422Branch.Branch1,
                    )
                }
                if (inspection.matchesBillingMeter) {
                    add(
                        InlineThresholdsResourceUsageThresholdConfigMeterXe7f01422Branch.BillingMeter,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineThresholdsResourceUsageThresholdConfigMeterXe7f01422 {
            val inspection = inspectInlineThresholdsResourceUsageThresholdConfigMeterXe7f01422(raw)
            if (inspection.matchCount == 0) {
                throw InlineThresholdsResourceUsageThresholdConfigMeterXe7f01422NoMatchException(
                    "InlineThresholdsResourceUsageThresholdConfigMeterXe7f01422 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineThresholdsResourceUsageThresholdConfigMeterXe7f01422> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineThresholdsResourceUsageThresholdConfigMeterXe7f01422,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineThresholdsResourceUsageThresholdConfigMeterXe7f01422",
...
private fun inspectInlineThresholdsResourceUsageThresholdConfigMeterXe7f01422(
    element: JsonElement,
): InlineThresholdsResourceUsageThresholdConfigMeterXe7f01422Inspection {
