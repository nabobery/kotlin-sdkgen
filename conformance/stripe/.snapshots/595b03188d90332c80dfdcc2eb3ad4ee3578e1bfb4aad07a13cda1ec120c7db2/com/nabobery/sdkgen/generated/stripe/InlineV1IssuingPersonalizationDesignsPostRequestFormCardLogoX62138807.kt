...
internal data class InlineV1IssuingPersonalizationDesignsPostRequestFormCardLogoX62138807Inspection(
    ...
    public val matchesInlineV1IssuingPersonalizationDesignsPostRequestFormCardLogoAnyOf2Xf2fea252: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1IssuingPersonalizationDesignsPostRequestFormCardLogoAnyOf2Xf2fea252,
            ).count {
                it
            }
}
...
public class InlineV1IssuingPersonalizationDesignsPostRequestFormCardLogoX62138807 internal constructor(
    ...
    private val inspection: InlineV1IssuingPersonalizationDesignsPostRequestFormCardLogoX62138807Inspection,
) {
    ...
    public val inlineV1IssuingPersonalizationDesignsPostRequestFormCardLogoAnyOf2Xf2fea252:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1IssuingPersonalizationDesignsPostRequestFormCardLogoAnyOf2Xf2fea252) {
                json
                    .decodeFromJsonElement<InlineV1IssuingPersonalizationDesignsPostRequestFormCardLogoAnyOf2Xf2fea252>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1IssuingPersonalizationDesignsPostRequestFormCardLogoX62138807Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1IssuingPersonalizationDesignsPostRequestFormCardLogoAnyOf2Xf2fea252) {
                    add(
                        InlineV1IssuingPersonalizationDesignsPostRequestFormCardLogoX62138807Branch.InlineV1IssuingPersonalizationDesignsPostRequestFormCardLogoAnyOf2Xf2fea252,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1IssuingPersonalizationDesignsPostRequestFormCardLogoX62138807 {
            val inspection = inspectInlineV1IssuingPersonalizationDesignsPostRequestFormCardLogoX62138807(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1IssuingPersonalizationDesignsPostRequestFormCardLogoX62138807NoMatchException(
                    "InlineV1IssuingPersonalizationDesignsPostRequestFormCardLogoX62138807 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1IssuingPersonalizationDesignsPostRequestFormCardLogoX62138807> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingPersonalizationDesignsPostRequestFormCardLogoX62138807,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1IssuingPersonalizationDesignsPostRequestFormCardLogoX62138807",
...
private fun inspectInlineV1IssuingPersonalizationDesignsPostRequestFormCardLogoX62138807(
    element: JsonElement,
): InlineV1IssuingPersonalizationDesignsPostRequestFormCardLogoX62138807Inspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1IssuingPersonalizationDesignsPostRequestFormCardLogoAnyOf2Xf2fea252 =
        element
            .isJsonDecodable<InlineV1IssuingPersonalizationDesignsPostRequestFormCardLogoAnyOf2Xf2fea252>()
    return InlineV1IssuingPersonalizationDesignsPostRequestFormCardLogoX62138807Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1IssuingPersonalizationDesignsPostRequestFormCardLogoAnyOf2Xf2fea252) {
                    add(
                        "InlineV1IssuingPersonalizationDesignsPostRequestFormCardLogoAnyOf2Xf2fea252: value does not match InlineV1IssuingPersonalizationDesignsPostRequestFormCardLogoAnyOf2Xf2fea252",
                    )
                }
            },
    )
