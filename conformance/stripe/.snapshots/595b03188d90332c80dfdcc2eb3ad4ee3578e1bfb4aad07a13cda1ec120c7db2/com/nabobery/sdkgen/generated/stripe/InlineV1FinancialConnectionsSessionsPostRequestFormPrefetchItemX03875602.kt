...
public sealed class InlineV1FinancialConnectionsSessionsPostRequestFormPrefetchItemX03875602 {
    ...
    public object Serializer : KSerializer<InlineV1FinancialConnectionsSessionsPostRequestFormPrefetchItemX03875602> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1FinancialConnectionsSessionsPostRequestFormPrefetchItemX03875602",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1FinancialConnectionsSessionsPostRequestFormPrefetchItemX03875602 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1FinancialConnectionsSessionsPostRequestFormPrefetchItemX03875602,
        ) {
