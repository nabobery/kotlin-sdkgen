...
public class TerminalOnboardingLinkLinkOptions(
     ...
     */
    public val appleTermsAndConditions: InlineTerminalOnboardingLinkLinkOptionsAppleTermsAndConditionsX08bd151f? = null,
) {
    public class Builder {
        ...
        public fun build(): TerminalOnboardingLinkLinkOptions =
    ...
    public object Serializer : KSerializer<TerminalOnboardingLinkLinkOptions> {
        ...
        override fun deserialize(decoder: Decoder): TerminalOnboardingLinkLinkOptions {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("TerminalOnboardingLinkLinkOptions must be a JSON object")
            return TerminalOnboardingLinkLinkOptions(
                appleTermsAndConditions =
                    rawObject["apple_terms_and_conditions"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                            ...
                            json
                                .decodeFromJsonElement<InlineTerminalOnboardingLinkLinkOptionsAppleTermsAndConditionsX08bd151f?>(
                                    element,
                                )
                        }
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: TerminalOnboardingLinkLinkOptions,
        ) {
...
public fun terminalOnboardingLinkLinkOptions(
    block: TerminalOnboardingLinkLinkOptions.Builder.() -> Unit,
): TerminalOnboardingLinkLinkOptions = TerminalOnboardingLinkLinkOptions.build(block)
