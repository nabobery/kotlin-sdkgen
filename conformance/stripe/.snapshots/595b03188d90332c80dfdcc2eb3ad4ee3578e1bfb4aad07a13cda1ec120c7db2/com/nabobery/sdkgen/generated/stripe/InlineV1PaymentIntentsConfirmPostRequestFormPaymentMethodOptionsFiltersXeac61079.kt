...
public class InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsFiltersXeac61079(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsFiltersXeac61079 =
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsFiltersXeac61079> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsFiltersXeac61079 must be a JSON object",
                    )
            return InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsFiltersXeac61079(
                accountSubcategories =
                    rawObject["account_subcategories"]?.let {
                        json
                            .decodeFromJsonElement<List<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsItemX76ac6e40>>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsFiltersXeac61079,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsFiltersXeac61079(
    block: InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsFiltersXeac61079.Builder.() -> Unit,
): InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsFiltersXeac61079 =
    InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsFiltersXeac61079.build(block)
