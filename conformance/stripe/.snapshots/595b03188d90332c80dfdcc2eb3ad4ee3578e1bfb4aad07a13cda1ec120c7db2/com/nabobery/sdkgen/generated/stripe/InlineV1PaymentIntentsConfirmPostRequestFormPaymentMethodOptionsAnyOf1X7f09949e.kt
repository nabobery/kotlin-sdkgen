...
public class InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf1X7f09949e(
    public val financialConnections: InlineV1PaymentIntentsConfirmPostRequestFormFinancialConnectionsX09afc743? = null,
    public val mandateOptions: InlineV1PaymentIntentsConfirmPostRequestFormMandateOptionsXa1c633e7? = null,
    public val networks: InlineV1PaymentIntentsConfirmPostRequestFormNetworksX2d30cfc6? = null,
    public val setupFutureUsage: InlineV1PaymentIntentsConfirmPostRequestFormSetupFutureUsageX7b98b12b? = null,
    public val targetDate: String? = null,
    public val transactionPurpose: InlineV1PaymentIntentsConfirmPostRequestFormTransactionPurposeXe9e10e77? = null,
    public val verificationMethod: InlineV1PaymentIntentsConfirmPostRequestFormVerificationMethodX9b6c9028? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf1X7f09949e =
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf1X7f09949e> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf1X7f09949e must be a JSON object",
                    )
            return InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf1X7f09949e(
                financialConnections =
                    rawObject["financial_connections"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormFinancialConnectionsX09afc743>(
                                it,
                            )
                    },
                mandateOptions =
                    rawObject["mandate_options"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormMandateOptionsXa1c633e7>(
                            it,
                        )
                    },
                networks =
                    rawObject["networks"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormNetworksX2d30cfc6>(it)
                    },
                setupFutureUsage =
                    rawObject["setup_future_usage"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormSetupFutureUsageX7b98b12b>(
                                it,
                            )
                    },
                ...
                transactionPurpose =
                    rawObject["transaction_purpose"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormTransactionPurposeXe9e10e77>(
                                it,
                            )
                    },
                verificationMethod =
                    rawObject["verification_method"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormVerificationMethodX9b6c9028>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf1X7f09949e,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf1X7f09949e(
    block: InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf1X7f09949e.Builder.() -> Unit,
): InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf1X7f09949e =
    InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf1X7f09949e.build(block)
