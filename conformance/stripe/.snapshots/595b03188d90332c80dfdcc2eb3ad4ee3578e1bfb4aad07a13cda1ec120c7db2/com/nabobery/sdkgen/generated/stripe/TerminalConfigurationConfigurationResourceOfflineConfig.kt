...
public class TerminalConfigurationConfigurationResourceOfflineConfig(
    ...
    public class Builder {
        ...
        public fun build(): TerminalConfigurationConfigurationResourceOfflineConfig =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): TerminalConfigurationConfigurationResourceOfflineConfig =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<TerminalConfigurationConfigurationResourceOfflineConfig> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "TerminalConfigurationConfigurationResourceOfflineConfig must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: TerminalConfigurationConfigurationResourceOfflineConfig,
        ) {
...
public fun terminalConfigurationConfigurationResourceOfflineConfig(
    block: TerminalConfigurationConfigurationResourceOfflineConfig.Builder.() -> Unit,
): TerminalConfigurationConfigurationResourceOfflineConfig =
    TerminalConfigurationConfigurationResourceOfflineConfig.build(block)
