...
public class InlineV1BillingPortalSessionsPostRequestFormFlowDataRedirectX2cd00d6c(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1BillingPortalSessionsPostRequestFormFlowDataRedirectX2cd00d6c = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1BillingPortalSessionsPostRequestFormFlowDataRedirectX2cd00d6c> {
        override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1BillingPortalSessionsPostRequestFormFlowDataRedirectX2cd00d6c {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1BillingPortalSessionsPostRequestFormFlowDataRedirectX2cd00d6c must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1BillingPortalSessionsPostRequestFormFlowDataRedirectX2cd00d6c,
        ) {
            val jsonEncoder =
...
public fun inlineV1BillingPortalSessionsPostRequestFormFlowDataRedirectX2cd00d6c(
    block: InlineV1BillingPortalSessionsPostRequestFormFlowDataRedirectX2cd00d6c.Builder.() -> Unit,
): InlineV1BillingPortalSessionsPostRequestFormFlowDataRedirectX2cd00d6c =
    InlineV1BillingPortalSessionsPostRequestFormFlowDataRedirectX2cd00d6c.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1BillingPortalSessionsPostRequestFormFlowDataRedirectX2cd00d6c is missing required property '" +
                    name +
                    "'",
            )
