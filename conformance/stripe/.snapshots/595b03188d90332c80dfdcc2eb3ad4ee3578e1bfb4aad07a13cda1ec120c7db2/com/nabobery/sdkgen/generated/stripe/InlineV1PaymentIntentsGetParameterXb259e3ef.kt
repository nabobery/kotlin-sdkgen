...
public class InlineV1PaymentIntentsGetParameterXb259e3ef internal constructor(
    ...
    public val inlineV1PaymentIntentsGetParameterAnyOf1Xda0bfe8d:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1PaymentIntentsGetParameterAnyOf1Xda0bfe8d) {
                json
                    .decodeFromJsonElement<InlineV1PaymentIntentsGetParameterAnyOf1Xda0bfe8d>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1PaymentIntentsGetParameterXb259e3efBranch>
        get() =
            buildSet {
                if (inspection.matchesInlineV1PaymentIntentsGetParameterAnyOf1Xda0bfe8d) {
                    add(
                        InlineV1PaymentIntentsGetParameterXb259e3efBranch.InlineV1PaymentIntentsGetParameterAnyOf1Xda0bfe8d,
                    )
                }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1PaymentIntentsGetParameterXb259e3ef {
            val inspection = inspectInlineV1PaymentIntentsGetParameterXb259e3ef(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1PaymentIntentsGetParameterXb259e3efNoMatchException(
                    "InlineV1PaymentIntentsGetParameterXb259e3ef matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsGetParameterXb259e3ef> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsGetParameterXb259e3ef,
        ) {
...
private fun inspectInlineV1PaymentIntentsGetParameterXb259e3ef(
    element: JsonElement,
): InlineV1PaymentIntentsGetParameterXb259e3efInspection {
    val matchesInlineV1PaymentIntentsGetParameterAnyOf1Xda0bfe8d =
        element
            .isJsonDecodable<InlineV1PaymentIntentsGetParameterAnyOf1Xda0bfe8d>()
    ...
    return InlineV1PaymentIntentsGetParameterXb259e3efInspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1PaymentIntentsGetParameterAnyOf1Xda0bfe8d) {
                    add(
                        "InlineV1PaymentIntentsGetParameterAnyOf1Xda0bfe8d: value does not match InlineV1PaymentIntentsGetParameterAnyOf1Xda0bfe8d",
                    )
                }
