...
public class SetupAttemptPaymentMethodDetailsCardWallet(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): SetupAttemptPaymentMethodDetailsCardWallet =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<SetupAttemptPaymentMethodDetailsCardWallet> {
        ...
        override fun deserialize(decoder: Decoder): SetupAttemptPaymentMethodDetailsCardWallet {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("SetupAttemptPaymentMethodDetailsCardWallet must be a JSON object")
            val type =
                json.decodeRequired<InlineSetupAttemptPaymentMethodDetailsCardWalletTypeX01f38d3e>(
                    rawObject,
                    "type",
                )
            return SetupAttemptPaymentMethodDetailsCardWallet(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: SetupAttemptPaymentMethodDetailsCardWallet,
        ) {
...
public fun setupAttemptPaymentMethodDetailsCardWallet(
    block: SetupAttemptPaymentMethodDetailsCardWallet.Builder.() -> Unit,
): SetupAttemptPaymentMethodDetailsCardWallet = SetupAttemptPaymentMethodDetailsCardWallet.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "SetupAttemptPaymentMethodDetailsCardWallet is missing required property '" + name + "'",
            )
