...
public class Person(
     ...
     * `stripe`.
     */
    public val fullNameAliases: List<String>? = null,
    ...
    public class Builder {
         ...
         * `stripe`.
         */
        public var fullNameAliases: List<String>? = null
        ...
        override fun deserialize(decoder: Decoder): Person {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("Person must be a JSON object")
            ...
            return Person(
                ...
                additionalTosAcceptances =
                    rawObject["additional_tos_acceptances"]?.let {
                        json.decodeFromJsonElement<PersonAdditionalTosAcceptances>(it)
                    },
                ...
                addressKana =
                    rawObject["address_kana"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePersonAddressKanaX281381e4?>(element)
                        }
                    },
                addressKanji =
                    rawObject["address_kanji"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePersonAddressKanjiXf6c450b8?>(element)
                        }
                    },
                ...
                firstName =
                    rawObject["first_name"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                firstNameKana =
                    rawObject["first_name_kana"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                firstNameKanji =
                    rawObject["first_name_kanji"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                futureRequirements =
                    rawObject["future_requirements"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePersonFutureRequirementsXf1ad3575?>(element)
                        }
                    },
                gender =
                    rawObject["gender"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                idNumberSecondaryProvided =
                    rawObject["id_number_secondary_provided"]?.let {
                        json
                ...
                lastName =
                    rawObject["last_name"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                lastNameKana =
                    rawObject["last_name_kana"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                lastNameKanji =
                    rawObject["last_name_kanji"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                maidenName =
                    rawObject["maiden_name"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                nationality =
                    rawObject["nationality"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                politicalExposure =
                    rawObject["political_exposure"]?.let {
                        json.decodeFromJsonElement<InlinePersonPoliticalExposureX1348f489>(it)
                    },
                registeredAddress =
                ...
                relationship = rawObject["relationship"]?.let {
                    json.decodeFromJsonElement<PersonRelationship>(
                        it,
                    )
                },
                requirements =
                    rawObject["requirements"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePersonRequirementsX4b681054?>(element)
                        }
                    },
                ssnLast4Provided = rawObject["ssn_last_4_provided"]?.let { json.decodeFromJsonElement<Boolean>(it) },
                usCfpbData =
                    rawObject["us_cfpb_data"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlinePersonUsCfpbDataX411ab524?>(element)
                        }
                    },
                verification =
                    rawObject["verification"]?.let {
                        json.decodeFromJsonElement<LegalEntityPersonVerification>(
                            it,
                        )
                    },
            )
        ...
        override fun serialize(
            ...
            val raw =
                buildJsonObject {
                    ...
                    value.idNumberSecondaryProvided?.let {
                        put(
