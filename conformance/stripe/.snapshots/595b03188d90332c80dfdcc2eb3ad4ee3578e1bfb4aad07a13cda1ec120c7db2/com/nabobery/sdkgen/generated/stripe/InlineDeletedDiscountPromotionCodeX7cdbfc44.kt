...
public class InlineDeletedDiscountPromotionCodeX7cdbfc44 internal constructor(
        ...
        get() =
            buildSet {
                ...
                if (inspection.matchesPromotionCode) {
                    add(
                        InlineDeletedDiscountPromotionCodeX7cdbfc44Branch.PromotionCode,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineDeletedDiscountPromotionCodeX7cdbfc44 {
            val inspection = inspectInlineDeletedDiscountPromotionCodeX7cdbfc44(raw)
            if (inspection.matchCount == 0) {
                throw InlineDeletedDiscountPromotionCodeX7cdbfc44NoMatchException(
                    "InlineDeletedDiscountPromotionCodeX7cdbfc44 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineDeletedDiscountPromotionCodeX7cdbfc44> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineDeletedDiscountPromotionCodeX7cdbfc44,
        ) {
...
private fun inspectInlineDeletedDiscountPromotionCodeX7cdbfc44(
    element: JsonElement,
): InlineDeletedDiscountPromotionCodeX7cdbfc44Inspection {
