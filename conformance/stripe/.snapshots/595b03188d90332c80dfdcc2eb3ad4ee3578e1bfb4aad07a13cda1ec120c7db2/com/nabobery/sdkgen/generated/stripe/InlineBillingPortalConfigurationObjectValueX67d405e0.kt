...
public sealed class InlineBillingPortalConfigurationObjectValueX67d405e0 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineBillingPortalConfigurationObjectValueX67d405e0 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineBillingPortalConfigurationObjectValueX67d405e0> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineBillingPortalConfigurationObjectValueX67d405e0",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineBillingPortalConfigurationObjectValueX67d405e0 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineBillingPortalConfigurationObjectValueX67d405e0,
        ) {
