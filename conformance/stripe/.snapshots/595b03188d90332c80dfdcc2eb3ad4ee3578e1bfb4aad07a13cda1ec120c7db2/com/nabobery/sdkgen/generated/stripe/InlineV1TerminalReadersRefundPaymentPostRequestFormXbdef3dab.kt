...
public class InlineV1TerminalReadersRefundPaymentPostRequestFormXbdef3dab(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1TerminalReadersRefundPaymentPostRequestFormXbdef3dab =
            InlineV1TerminalReadersRefundPaymentPostRequestFormXbdef3dab(
                amount = amount,
                charge = charge,
                expand = expand,
                metadata = metadata,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TerminalReadersRefundPaymentPostRequestFormXbdef3dab =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TerminalReadersRefundPaymentPostRequestFormXbdef3dab> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TerminalReadersRefundPaymentPostRequestFormXbdef3dab must be a JSON object",
                    )
            return InlineV1TerminalReadersRefundPaymentPostRequestFormXbdef3dab(
                ...
                refundPaymentConfig =
                    rawObject["refund_payment_config"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TerminalReadersRefundPaymentPostRequestFormRefundPaymentConfigX03b8b741>(
                                it,
                            )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TerminalReadersRefundPaymentPostRequestFormXbdef3dab,
        ) {
...
public fun inlineV1TerminalReadersRefundPaymentPostRequestFormXbdef3dab(
    block: InlineV1TerminalReadersRefundPaymentPostRequestFormXbdef3dab.Builder.() -> Unit,
): InlineV1TerminalReadersRefundPaymentPostRequestFormXbdef3dab =
    InlineV1TerminalReadersRefundPaymentPostRequestFormXbdef3dab.build(block)
