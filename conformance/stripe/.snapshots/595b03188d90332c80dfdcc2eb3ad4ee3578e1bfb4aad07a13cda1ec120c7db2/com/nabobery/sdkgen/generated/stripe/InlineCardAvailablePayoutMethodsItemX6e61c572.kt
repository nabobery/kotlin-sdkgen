...
public sealed class InlineCardAvailablePayoutMethodsItemX6e61c572 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineCardAvailablePayoutMethodsItemX6e61c572 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineCardAvailablePayoutMethodsItemX6e61c572> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineCardAvailablePayoutMethodsItemX6e61c572",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineCardAvailablePayoutMethodsItemX6e61c572 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineCardAvailablePayoutMethodsItemX6e61c572,
        ) {
