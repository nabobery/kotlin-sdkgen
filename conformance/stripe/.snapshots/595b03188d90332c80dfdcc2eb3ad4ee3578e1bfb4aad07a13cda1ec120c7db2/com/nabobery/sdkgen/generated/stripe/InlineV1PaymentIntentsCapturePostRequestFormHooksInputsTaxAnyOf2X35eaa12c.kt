...
public sealed class InlineV1PaymentIntentsCapturePostRequestFormHooksInputsTaxAnyOf2X35eaa12c {
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsCapturePostRequestFormHooksInputsTaxAnyOf2X35eaa12c> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1PaymentIntentsCapturePostRequestFormHooksInputsTaxAnyOf2X35eaa12c",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1PaymentIntentsCapturePostRequestFormHooksInputsTaxAnyOf2X35eaa12c = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsCapturePostRequestFormHooksInputsTaxAnyOf2X35eaa12c,
        ) {
