...
public class InlineV1PricesSearchGetResponse200JsonX5105616d(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PricesSearchGetResponse200JsonX5105616d =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PricesSearchGetResponse200JsonX5105616d> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PricesSearchGetResponse200JsonX5105616d must be a JSON object",
                    )
            val data = json.decodeRequired<List<Price>>(rawObject, "data")
            val hasMore = json.decodeRequired<Boolean>(rawObject, "has_more")
            val objectValue =
                json.decodeRequired<InlineV1PricesSearchGetResponse200JsonObjectValueXc61b33a7>(
                    rawObject,
                    "object",
                )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PricesSearchGetResponse200JsonX5105616d,
        ) {
...
public fun inlineV1PricesSearchGetResponse200JsonX5105616d(
    block: InlineV1PricesSearchGetResponse200JsonX5105616d.Builder.() -> Unit,
): InlineV1PricesSearchGetResponse200JsonX5105616d = InlineV1PricesSearchGetResponse200JsonX5105616d.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PricesSearchGetResponse200JsonX5105616d is missing required property '" + name + "'",
            )
