...
public class InlineV1InvoicesPostRequestFormDefaultSourceX1d88b167 internal constructor(
    ...
    public val inlineV1InvoicesPostRequestFormDefaultSourceAnyOf2Xf2ff13a6:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1InvoicesPostRequestFormDefaultSourceAnyOf2Xf2ff13a6) {
                json
                    .decodeFromJsonElement<InlineV1InvoicesPostRequestFormDefaultSourceAnyOf2Xf2ff13a6>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1InvoicesPostRequestFormDefaultSourceX1d88b167Branch>
        get() =
            buildSet {
                ...
                if (inspection.matchesInlineV1InvoicesPostRequestFormDefaultSourceAnyOf2Xf2ff13a6) {
                    add(
                        InlineV1InvoicesPostRequestFormDefaultSourceX1d88b167Branch.InlineV1InvoicesPostRequestFormDefaultSourceAnyOf2Xf2ff13a6,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1InvoicesPostRequestFormDefaultSourceX1d88b167 {
            val inspection = inspectInlineV1InvoicesPostRequestFormDefaultSourceX1d88b167(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1InvoicesPostRequestFormDefaultSourceX1d88b167NoMatchException(
                    "InlineV1InvoicesPostRequestFormDefaultSourceX1d88b167 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1InvoicesPostRequestFormDefaultSourceX1d88b167> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesPostRequestFormDefaultSourceX1d88b167,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1InvoicesPostRequestFormDefaultSourceX1d88b167",
...
private fun inspectInlineV1InvoicesPostRequestFormDefaultSourceX1d88b167(
    element: JsonElement,
): InlineV1InvoicesPostRequestFormDefaultSourceX1d88b167Inspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1InvoicesPostRequestFormDefaultSourceAnyOf2Xf2ff13a6 =
        element
            .isJsonDecodable<InlineV1InvoicesPostRequestFormDefaultSourceAnyOf2Xf2ff13a6>()
    return InlineV1InvoicesPostRequestFormDefaultSourceX1d88b167Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1InvoicesPostRequestFormDefaultSourceAnyOf2Xf2ff13a6) {
                    add(
                        "InlineV1InvoicesPostRequestFormDefaultSourceAnyOf2Xf2ff13a6: value does not match InlineV1InvoicesPostRequestFormDefaultSourceAnyOf2Xf2ff13a6",
                    )
                }
            },
    )
