...
public class Invoice(
    ...
    public class Builder {
        ...
        public var defaultTaxRates: List<TaxRate>
            get() = requireNotNull(defaultTaxRatesValue) { "defaultTaxRates is required" }
            set(`value`) {
                defaultTaxRatesValue = value
            }
         ...
         * The account tax IDs associated with the invoice. Only editable when the invoice is a draft.
         */
        public var accountTaxIds: List<InlineInvoiceAccountTaxIdsItemX1551760a>? = null
         ...
         * `customer.tax_ids`. Once the invoice is finalized, this field will no longer be updated.
         */
        public var customerTaxIds: List<InvoicesResourceInvoiceTaxId>? = null
         ...
         * The aggregate amounts calculated per discount across all line items.
         */
        public var totalDiscountAmounts: List<DiscountsResourceDiscountAmount>? = null
         ...
         * list of total_pretax_credit_amounts across all invoice line items.
         */
        public var totalPretaxCreditAmounts: List<InvoicesResourcePretaxCreditAmount>? = null

        /**
         * The aggregate tax information of all line items.
         */
        public var totalTaxes: List<BillingBillResourceInvoicingTaxesTax>? = null
        ...
        override fun deserialize(decoder: Decoder): Invoice {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("Invoice must be a JSON object")
            ...
            val collectionMethod =
                json.decodeRequired<InlineInvoiceCollectionMethodX6027ccc9>(
                    rawObject,
                    "collection_method",
                )
            ...
            val statusTransitions =
                json.decodeRequired<InvoicesResourceStatusTransitions>(
                    rawObject,
                    "status_transitions",
                )
            ...
            return Invoice(
                ...
                total = total,
                accountCountry =
                    rawObject["account_country"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                accountName =
                    rawObject["account_name"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                accountTaxIds =
                    rawObject["account_tax_ids"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<List<InlineInvoiceAccountTaxIdsItemX1551760a>?>(element)
                        }
                    },
                application =
                    rawObject["application"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineInvoiceApplicationXa23803cc?>(element)
                        }
                    },
                automaticallyFinalizesAt =
                    rawObject["automatically_finalizes_at"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                billingReason =
                    rawObject["billing_reason"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineInvoiceBillingReasonX80b9bb9a?>(element)
                        }
                    },
                confirmationSecret =
                    rawObject["confirmation_secret"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineInvoiceConfirmationSecretXf5c1d047?>(element)
                        }
                    },
                customFields =
                ...
                customerAddress =
                    rawObject["customer_address"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineInvoiceCustomerAddressXd90d3b3c?>(element)
                        }
                    },
                customerEmail =
                ...
                customerPhone =
                    rawObject["customer_phone"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                customerShipping =
                    rawObject["customer_shipping"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineInvoiceCustomerShippingX637aa4fd?>(element)
                        }
                    },
                customerTaxExempt =
                    rawObject["customer_tax_exempt"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineInvoiceCustomerTaxExemptX99293270?>(element)
                        }
                    },
                customerTaxIds =
                    rawObject["customer_tax_ids"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<List<InvoicesResourceInvoiceTaxId>?>(element)
                        }
                    },
                defaultPaymentMethod =
                    rawObject["default_payment_method"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineInvoiceDefaultPaymentMethodX0987464e?>(element)
                        }
                    },
                defaultSource =
                    rawObject["default_source"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineInvoiceDefaultSourceXee93951e?>(element)
                        }
                    },
                description =
                ...
                dueDate =
                    rawObject["due_date"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                    ...
                    rawObject["from_invoice"]
                        ?.let { element ->
                            if (element ==
                                ...
                                json.decodeFromJsonElement<InlineInvoiceFromInvoiceX9a820e87?>(element)
                            }
                        },
                hostedInvoiceUrl =
                    rawObject["hosted_invoice_url"]
                        ?.let { element ->
                            if (element ==
                                JsonNull
                            ) {
                ...
                lastFinalizationError =
                    rawObject["last_finalization_error"]
                        ?.let { element ->
                            if (element ==
                                JsonNull
                            ) {
                                ...
                                json.decodeFromJsonElement<InlineInvoiceLastFinalizationErrorX40488156?>(element)
                            }
                        },
                latestRevision =
                    rawObject["latest_revision"]
                        ?.let { element ->
                            if (element ==
                                JsonNull
                            ) {
                                ...
                                json.decodeFromJsonElement<InlineInvoiceLatestRevisionX60f0e9cc?>(element)
                            }
                        },
                metadata =
                    rawObject["metadata"]
                ...
                nextPaymentAttempt =
                    rawObject["next_payment_attempt"]
                        ?.let { element ->
                            if (element ==
                                JsonNull
                            ) {
                    ...
                    rawObject["on_behalf_of"]
                        ?.let { element ->
                            if (element ==
                                ...
                                json.decodeFromJsonElement<InlineInvoiceOnBehalfOfX7ed9f131?>(element)
                            }
                        },
                parent =
                    rawObject["parent"]
                        ?.let { element ->
                            if (element ==
                                ...
                                json.decodeFromJsonElement<InlineInvoiceParentX8edc2487?>(element)
                            }
                        },
                payments =
                    rawObject["payments"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineInvoicePaymentsX14523dba>(
                                    it,
                                )
                        },
                receiptNumber =
                    rawObject["receipt_number"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                rendering =
                    rawObject["rendering"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineInvoiceRenderingXdc55f306?>(element)
                        }
                    },
                shippingCost =
                    rawObject["shipping_cost"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineInvoiceShippingCostX6b71ee6d?>(element)
                        }
                    },
                shippingDetails =
                    rawObject["shipping_details"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineInvoiceShippingDetailsX786d6124?>(element)
                        }
                    },
                statementDescriptor =
                ...
                status =
                    rawObject["status"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineInvoiceStatusXe812c730?>(element)
                        }
                    },
                subtotalExcludingTax =
                    rawObject["subtotal_excluding_tax"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                testClock =
                    rawObject["test_clock"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineInvoiceTestClockXd1c185be?>(element)
                        }
                    },
                thresholdReason =
                    rawObject["threshold_reason"]?.let {
                        json
                            .decodeFromJsonElement<InvoiceThresholdReason>(
                                it,
                            )
                    },
                totalDiscountAmounts =
                    rawObject["total_discount_amounts"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<List<DiscountsResourceDiscountAmount>?>(element)
                        }
                    },
                totalExcludingTax =
                    rawObject["total_excluding_tax"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                totalPretaxCreditAmounts =
                    rawObject["total_pretax_credit_amounts"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<List<InvoicesResourcePretaxCreditAmount>?>(element)
                        }
                    },
                totalTaxes =
                    rawObject["total_taxes"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<List<BillingBillResourceInvoicingTaxesTax>?>(element)
                        }
                    },
                webhooksDeliveredAt =
                    rawObject["webhooks_delivered_at"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
            ...
            val raw =
                buildJsonObject {
                    ...
                    put(
                        ...
                        json.encodeToJsonElement(value.postPaymentCreditNotesAmount),
                    )
                    ...
                    value.automaticallyFinalizesAt?.let {
                        put(
                    ...
                    value.totalPretaxCreditAmounts?.let {
                        put(
