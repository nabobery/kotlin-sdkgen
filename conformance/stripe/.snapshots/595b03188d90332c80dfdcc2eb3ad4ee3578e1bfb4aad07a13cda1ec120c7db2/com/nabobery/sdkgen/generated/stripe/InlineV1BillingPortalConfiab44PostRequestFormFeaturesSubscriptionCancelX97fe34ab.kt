...
public class InlineV1BillingPortalConfiab44PostRequestFormFeaturesSubscriptionCancelX97fe34ab(
    ...
    public val prorationBehavior: InlineV1BillingPortalConfiab44PostRequestFormFeaturesProrationBehaviorX6be432ec? = null,
) {
    ...
    public object Serializer : KSerializer<InlineV1BillingPortalConfiab44PostRequestFormFeaturesSubscriptionCancelX97fe34ab> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1BillingPortalConfiab44PostRequestFormFeaturesSubscriptionCancelX97fe34ab must be a JSON object",
                    )
            ...
            return InlineV1BillingPortalConfiab44PostRequestFormFeaturesSubscriptionCancelX97fe34ab(
                ...
                cancellationReason =
                    rawObject["cancellation_reason"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1BillingPortalConfiab44PostRequestFormFeaturesCancellationReasonX2856cff9>(
                                it,
                            )
                    },
                mode =
                    rawObject["mode"]?.let {
                        json.decodeFromJsonElement<InlineV1BillingPortalConfiab44PostRequestFormFeaturesModeX2c690578>(
                            it,
                        )
                    },
                prorationBehavior =
                    rawObject["proration_behavior"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1BillingPortalConfiab44PostRequestFormFeaturesProrationBehaviorX6be432ec>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1BillingPortalConfiab44PostRequestFormFeaturesSubscriptionCancelX97fe34ab,
        ) {
            val jsonEncoder =
...
public fun inlineV1BillingPortalConfiab44PostRequestFormFeaturesSubscriptionCancelX97fe34ab(
    block: InlineV1BillingPortalConfiab44PostRequestFormFeaturesSubscriptionCancelX97fe34ab.Builder.() -> Unit,
): InlineV1BillingPortalConfiab44PostRequestFormFeaturesSubscriptionCancelX97fe34ab =
    InlineV1BillingPortalConfiab44PostRequestFormFeaturesSubscriptionCancelX97fe34ab.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1BillingPortalConfiab44PostRequestFormFeaturesSubscriptionCancelX97fe34ab is missing required property '" +
                    name +
                    "'",
            )
