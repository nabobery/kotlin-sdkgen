...
public class InlineV1SetupIntentsConfirmPostRequestFormCartesBancairesX7477efbe(
    public val cbAvalgo: InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsCbAvalgoX39c9556b,
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1SetupIntentsConfirmPostRequestFormCartesBancairesX7477efbe = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1SetupIntentsConfirmPostRequestFormCartesBancairesX7477efbe> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SetupIntentsConfirmPostRequestFormCartesBancairesX7477efbe must be a JSON object",
                    )
            val cbAvalgo =
                json
                    .decodeRequired<InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsCbAvalgoX39c9556b>(
                        rawObject,
                        "cb_avalgo",
                    )
            return InlineV1SetupIntentsConfirmPostRequestFormCartesBancairesX7477efbe(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SetupIntentsConfirmPostRequestFormCartesBancairesX7477efbe,
        ) {
            val jsonEncoder =
...
public fun inlineV1SetupIntentsConfirmPostRequestFormCartesBancairesX7477efbe(
    block: InlineV1SetupIntentsConfirmPostRequestFormCartesBancairesX7477efbe.Builder.() -> Unit,
): InlineV1SetupIntentsConfirmPostRequestFormCartesBancairesX7477efbe =
    InlineV1SetupIntentsConfirmPostRequestFormCartesBancairesX7477efbe.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1SetupIntentsConfirmPostRequestFormCartesBancairesX7477efbe is missing required property '" +
                    name +
                    "'",
            )
