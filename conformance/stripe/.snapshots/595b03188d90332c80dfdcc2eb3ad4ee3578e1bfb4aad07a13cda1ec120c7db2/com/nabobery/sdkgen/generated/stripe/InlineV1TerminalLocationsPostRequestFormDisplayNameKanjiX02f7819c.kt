...
internal data class InlineV1TerminalLocationsPostRequestFormDisplayNameKanjiX02f7819cInspection(
    ...
    public val matchesInlineV1TerminalLocationsPostRequestFormDisplayNameKanjiAnyOf2Xa4ad03ef: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1TerminalLocationsPostRequestFormDisplayNameKanjiAnyOf2Xa4ad03ef,
            ).count {
                it
            }
}
...
public class InlineV1TerminalLocationsPostRequestFormDisplayNameKanjiX02f7819c internal constructor(
    ...
    private val inspection: InlineV1TerminalLocationsPostRequestFormDisplayNameKanjiX02f7819cInspection,
) {
    ...
    public val inlineV1TerminalLocationsPostRequestFormDisplayNameKanjiAnyOf2Xa4ad03ef:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1TerminalLocationsPostRequestFormDisplayNameKanjiAnyOf2Xa4ad03ef) {
                json
                    .decodeFromJsonElement<InlineV1TerminalLocationsPostRequestFormDisplayNameKanjiAnyOf2Xa4ad03ef>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1TerminalLocationsPostRequestFormDisplayNameKanjiX02f7819cBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1TerminalLocationsPostRequestFormDisplayNameKanjiAnyOf2Xa4ad03ef) {
                    add(
                        InlineV1TerminalLocationsPostRequestFormDisplayNameKanjiX02f7819cBranch.InlineV1TerminalLocationsPostRequestFormDisplayNameKanjiAnyOf2Xa4ad03ef,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1TerminalLocationsPostRequestFormDisplayNameKanjiX02f7819c {
            val inspection = inspectInlineV1TerminalLocationsPostRequestFormDisplayNameKanjiX02f7819c(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1TerminalLocationsPostRequestFormDisplayNameKanjiX02f7819cNoMatchException(
                    "InlineV1TerminalLocationsPostRequestFormDisplayNameKanjiX02f7819c matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1TerminalLocationsPostRequestFormDisplayNameKanjiX02f7819c> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TerminalLocationsPostRequestFormDisplayNameKanjiX02f7819c,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1TerminalLocationsPostRequestFormDisplayNameKanjiX02f7819c",
...
private fun inspectInlineV1TerminalLocationsPostRequestFormDisplayNameKanjiX02f7819c(
    element: JsonElement,
): InlineV1TerminalLocationsPostRequestFormDisplayNameKanjiX02f7819cInspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1TerminalLocationsPostRequestFormDisplayNameKanjiAnyOf2Xa4ad03ef =
        element
            .isJsonDecodable<InlineV1TerminalLocationsPostRequestFormDisplayNameKanjiAnyOf2Xa4ad03ef>()
    return InlineV1TerminalLocationsPostRequestFormDisplayNameKanjiX02f7819cInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1TerminalLocationsPostRequestFormDisplayNameKanjiAnyOf2Xa4ad03ef) {
                    add(
                        "InlineV1TerminalLocationsPostRequestFormDisplayNameKanjiAnyOf2Xa4ad03ef: value does not match InlineV1TerminalLocationsPostRequestFormDisplayNameKanjiAnyOf2Xa4ad03ef",
                    )
                }
            },
    )
