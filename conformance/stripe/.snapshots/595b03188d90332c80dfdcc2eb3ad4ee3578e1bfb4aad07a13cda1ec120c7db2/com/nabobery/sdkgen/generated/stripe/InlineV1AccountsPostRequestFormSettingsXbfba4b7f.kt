...
public class InlineV1AccountsPostRequestFormSettingsXbfba4b7f(
    public val bacsDebitPayments: InlineV1AccountsPostRequestFormSettingsBacsDebitPaymentsXfe12e5ad? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1AccountsPostRequestFormSettingsXbfba4b7f =
            InlineV1AccountsPostRequestFormSettingsXbfba4b7f(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1AccountsPostRequestFormSettingsXbfba4b7f =
    ...
    public object Serializer : KSerializer<InlineV1AccountsPostRequestFormSettingsXbfba4b7f> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountsPostRequestFormSettingsXbfba4b7f must be a JSON object",
                    )
            return InlineV1AccountsPostRequestFormSettingsXbfba4b7f(
                bacsDebitPayments =
                    rawObject["bacs_debit_payments"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPostRequestFormSettingsBacsDebitPaymentsXfe12e5ad>(
                            it,
                        )
                    },
                branding =
                    rawObject["branding"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPostRequestFormSettingsBrandingX3dbde389>(it)
                    },
                cardIssuing =
                    rawObject["card_issuing"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPostRequestFormSettingsCardIssuingXb0cd03a4>(it)
                    },
                cardPayments =
                    rawObject["card_payments"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPostRequestFormSettingsCardPaymentsXf2522e0c>(it)
                    },
                invoices =
                    rawObject["invoices"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPostRequestFormSettingsInvoicesX86304d5e>(it)
                    },
                payments =
                    rawObject["payments"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPostRequestFormSettingsPaymentsXdedc68e4>(it)
                    },
                payouts =
                    rawObject["payouts"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPostRequestFormSettingsPayoutsX491a77ee>(it)
                    },
                treasury =
                    rawObject["treasury"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPostRequestFormSettingsTreasuryXe27e27b2>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPostRequestFormSettingsXbfba4b7f,
        ) {
...
public fun inlineV1AccountsPostRequestFormSettingsXbfba4b7f(
    block: InlineV1AccountsPostRequestFormSettingsXbfba4b7f.Builder.() -> Unit,
): InlineV1AccountsPostRequestFormSettingsXbfba4b7f = InlineV1AccountsPostRequestFormSettingsXbfba4b7f.build(block)
