...
public class InlineV1FinancialConnectionsTransactionsGetParameterXc57500ed(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1FinancialConnectionsTransactionsGetParameterXc57500ed =
    ...
    public object Serializer : KSerializer<InlineV1FinancialConnectionsTransactionsGetParameterXc57500ed> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1FinancialConnectionsTransactionsGetParameterXc57500ed {
            val jsonDecoder =
                decoder.requireJsonDecoder(
                    "InlineV1FinancialConnectionsTransactionsGetParameterXc57500ed",
                )
            val json = jsonDecoder.json
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1FinancialConnectionsTransactionsGetParameterXc57500ed must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1FinancialConnectionsTransactionsGetParameterXc57500ed,
        ) {
            val jsonEncoder =
...
public fun inlineV1FinancialConnectionsTransactionsGetParameterXc57500ed(
    block: InlineV1FinancialConnectionsTransactionsGetParameterXc57500ed.Builder.() -> Unit,
): InlineV1FinancialConnectionsTransactionsGetParameterXc57500ed =
    InlineV1FinancialConnectionsTransactionsGetParameterXc57500ed.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1FinancialConnectionsTransactionsGetParameterXc57500ed is missing required property '" + name +
                    "'",
            )
