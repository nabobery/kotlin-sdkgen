...
public sealed class InlineV1CreditNotesPostRequestFormEmailTypeX85727b78 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1CreditNotesPostRequestFormEmailTypeX85727b78 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1CreditNotesPostRequestFormEmailTypeX85727b78> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1CreditNotesPostRequestFormEmailTypeX85727b78",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1CreditNotesPostRequestFormEmailTypeX85727b78 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CreditNotesPostRequestFormEmailTypeX85727b78,
        ) {
