...
public class PaymentMethodOptionsSunbit(
    ...
    public class Builder {
        ...
        public fun build(): PaymentMethodOptionsSunbit =
    ...
    public object Serializer : KSerializer<PaymentMethodOptionsSunbit> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodOptionsSunbit {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodOptionsSunbit must be a JSON object")
            return PaymentMethodOptionsSunbit(
                captureMethod =
                    rawObject["capture_method"]?.let {
                        json.decodeFromJsonElement<InlinePaymentMethodOptionsSunbitCaptureMethodX29bf68f8>(it)
                    },
                setupFutureUsage =
                    rawObject["setup_future_usage"]?.let {
                        json.decodeFromJsonElement<InlinePaymentMethodOptionsSunbitSetupFutureUsageXd061f968>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentMethodOptionsSunbit,
        ) {
...
public fun paymentMethodOptionsSunbit(
    block: PaymentMethodOptionsSunbit.Builder.() -> Unit,
): PaymentMethodOptionsSunbit = PaymentMethodOptionsSunbit.build(block)
