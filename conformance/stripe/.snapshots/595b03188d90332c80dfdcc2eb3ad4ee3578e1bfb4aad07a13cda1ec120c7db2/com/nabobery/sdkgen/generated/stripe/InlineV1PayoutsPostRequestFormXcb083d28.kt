...
public class InlineV1PayoutsPostRequestFormXcb083d28(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1PayoutsPostRequestFormXcb083d28 =
            InlineV1PayoutsPostRequestFormXcb083d28(
                expand = expand,
                metadata = metadata,
            )
    }
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PayoutsPostRequestFormXcb083d28 =
    ...
    public object Serializer : KSerializer<InlineV1PayoutsPostRequestFormXcb083d28> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1PayoutsPostRequestFormXcb083d28 {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("InlineV1PayoutsPostRequestFormXcb083d28 must be a JSON object")
            return InlineV1PayoutsPostRequestFormXcb083d28(
                expand = rawObject["expand"]?.let { json.decodeFromJsonElement<List<String>>(it) },
                metadata =
                    rawObject["metadata"]?.let {
                        json.decodeFromJsonElement<InlineV1PayoutsPostRequestFormMetadataX1f23cef5>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PayoutsPostRequestFormXcb083d28,
        ) {
...
public fun inlineV1PayoutsPostRequestFormXcb083d28(
    block: InlineV1PayoutsPostRequestFormXcb083d28.Builder.() -> Unit,
): InlineV1PayoutsPostRequestFormXcb083d28 = InlineV1PayoutsPostRequestFormXcb083d28.build(block)
