...
public class InlineV1PaymentLinksPostRequestFormManagedPaymentsXb1167755(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1PaymentLinksPostRequestFormManagedPaymentsXb1167755 =
            InlineV1PaymentLinksPostRequestFormManagedPaymentsXb1167755(
                enabled = enabled,
            )
    }

    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PaymentLinksPostRequestFormManagedPaymentsXb1167755 =
    ...
    public object Serializer : KSerializer<InlineV1PaymentLinksPostRequestFormManagedPaymentsXb1167755> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentLinksPostRequestFormManagedPaymentsXb1167755 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentLinksPostRequestFormManagedPaymentsXb1167755,
        ) {
...
public fun inlineV1PaymentLinksPostRequestFormManagedPaymentsXb1167755(
    block: InlineV1PaymentLinksPostRequestFormManagedPaymentsXb1167755.Builder.() -> Unit,
): InlineV1PaymentLinksPostRequestFormManagedPaymentsXb1167755 =
    InlineV1PaymentLinksPostRequestFormManagedPaymentsXb1167755.build(block)
