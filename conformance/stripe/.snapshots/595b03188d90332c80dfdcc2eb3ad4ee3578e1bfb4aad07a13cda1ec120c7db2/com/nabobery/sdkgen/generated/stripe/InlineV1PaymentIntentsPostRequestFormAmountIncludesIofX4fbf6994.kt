...
public sealed class InlineV1PaymentIntentsPostRequestFormAmountIncludesIofX4fbf6994 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1PaymentIntentsPostRequestFormAmountIncludesIofX4fbf6994 =
            when (value) {
                Always.value -> Always
                Never.value -> Never
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormAmountIncludesIofX4fbf6994> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1PaymentIntentsPostRequestFormAmountIncludesIofX4fbf6994",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1PaymentIntentsPostRequestFormAmountIncludesIofX4fbf6994 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormAmountIncludesIofX4fbf6994,
        ) {
