...
public class InlineV1AccountsPeoplePostRequestFormXdc95d2c6(
     ...
     */
    public val additionalTosAcceptances: InlineV1AccountsPeoplePostRequestFormAdditionalTosAcceptancesXdcdc20f5? = null,
    /**
     ...
     */
    public val politicalExposure: InlineV1AccountsPeoplePostRequestFormPoliticalExposureXdc1040a1? = null,
    /**
     * The person's registered address.
     */
    public val registeredAddress: InlineV1AccountsPeoplePostRequestFormRegisteredAddressXba767cfc? = null,
    /**
    ...
    public class Builder {
        ...
        public fun build(): InlineV1AccountsPeoplePostRequestFormXdc95d2c6 =
            InlineV1AccountsPeoplePostRequestFormXdc95d2c6(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1AccountsPeoplePostRequestFormXdc95d2c6 =
    ...
    public object Serializer : KSerializer<InlineV1AccountsPeoplePostRequestFormXdc95d2c6> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountsPeoplePostRequestFormXdc95d2c6 must be a JSON object",
                    )
            return InlineV1AccountsPeoplePostRequestFormXdc95d2c6(
                additionalTosAcceptances =
                    rawObject["additional_tos_acceptances"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1AccountsPeoplePostRequestFormAdditionalTosAcceptancesXdcdc20f5>(
                                it,
                            )
                    },
                address =
                    rawObject["address"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPeoplePostRequestFormAddressX2f8c38cc>(it)
                    },
                addressKana =
                    rawObject["address_kana"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPeoplePostRequestFormAddressKanaX2de08290>(it)
                    },
                addressKanji =
                    rawObject["address_kanji"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPeoplePostRequestFormAddressKanjiX1c833046>(it)
                    },
                dob =
                    rawObject["dob"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPeoplePostRequestFormDobXbd651902>(
                            it,
                        )
                    },
                documents =
                    rawObject["documents"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPeoplePostRequestFormDocumentsX4c87b407>(it)
                    },
                ...
                fullNameAliases =
                    rawObject["full_name_aliases"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPeoplePostRequestFormFullNameAliasesXfbd9325e>(it)
                    },
                ...
                metadata =
                    rawObject["metadata"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPeoplePostRequestFormMetadataXe5af6fee>(it)
                    },
                ...
                politicalExposure =
                    rawObject["political_exposure"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPeoplePostRequestFormPoliticalExposureXdc1040a1>(it)
                    },
                registeredAddress =
                    rawObject["registered_address"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPeoplePostRequestFormRegisteredAddressXba767cfc>(it)
                    },
                relationship =
                    rawObject["relationship"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPeoplePostRequestFormRelationshipX494ad25f>(it)
                    },
                ssnLast4 = rawObject["ssn_last_4"]?.let { json.decodeFromJsonElement<String>(it) },
                usCfpbData =
                    rawObject["us_cfpb_data"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPeoplePostRequestFormUsCfpbDataX1916267e>(it)
                    },
                verification =
                    rawObject["verification"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPeoplePostRequestFormVerificationXf1f3ec34>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPeoplePostRequestFormXdc95d2c6,
        ) {
...
public fun inlineV1AccountsPeoplePostRequestFormXdc95d2c6(
    block: InlineV1AccountsPeoplePostRequestFormXdc95d2c6.Builder.() -> Unit,
): InlineV1AccountsPeoplePostRequestFormXdc95d2c6 = InlineV1AccountsPeoplePostRequestFormXdc95d2c6.build(block)
