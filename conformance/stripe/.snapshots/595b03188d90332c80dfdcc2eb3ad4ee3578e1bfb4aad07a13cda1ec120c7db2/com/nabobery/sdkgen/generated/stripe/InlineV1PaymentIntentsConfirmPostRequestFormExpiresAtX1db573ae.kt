...
internal data class InlineV1PaymentIntentsConfirmPostRequestFormExpiresAtX1db573aeInspection(
    ...
    public val matchesInlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2Xa7f78eae: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2Xa7f78eae,
            ).count {
                it
            }
}
...
public class InlineV1PaymentIntentsConfirmPostRequestFormExpiresAtX1db573ae internal constructor(
    ...
    public val inlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2Xa7f78eae:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2Xa7f78eae) {
                json
                    .decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2Xa7f78eae>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1PaymentIntentsConfirmPostRequestFormExpiresAtX1db573aeBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2Xa7f78eae) {
                    add(
                        InlineV1PaymentIntentsConfirmPostRequestFormExpiresAtX1db573aeBranch.InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2Xa7f78eae,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1PaymentIntentsConfirmPostRequestFormExpiresAtX1db573ae {
            val inspection = inspectInlineV1PaymentIntentsConfirmPostRequestFormExpiresAtX1db573ae(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1PaymentIntentsConfirmPostRequestFormExpiresAtX1db573aeNoMatchException(
                    "InlineV1PaymentIntentsConfirmPostRequestFormExpiresAtX1db573ae matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsConfirmPostRequestFormExpiresAtX1db573ae> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsConfirmPostRequestFormExpiresAtX1db573ae,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1PaymentIntentsConfirmPostRequestFormExpiresAtX1db573ae",
...
private fun inspectInlineV1PaymentIntentsConfirmPostRequestFormExpiresAtX1db573ae(
    element: JsonElement,
): InlineV1PaymentIntentsConfirmPostRequestFormExpiresAtX1db573aeInspection {
    val matchesBranch1 = element.isJsonDecodable<Int>()
    val matchesInlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2Xa7f78eae =
        element
            .isJsonDecodable<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2Xa7f78eae>()
    return InlineV1PaymentIntentsConfirmPostRequestFormExpiresAtX1db573aeInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2Xa7f78eae) {
                    add(
                        "InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2Xa7f78eae: value does not match InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2Xa7f78eae",
                    )
                }
            },
    )
