...
public class InlineInvoiceSettingSubscriptionScheduleSettingAccountTaxIdsItemX443d440d internal constructor(
    ...
    private val inspection: InlineInvoiceSettingSubscriptionScheduleSettingAccountTaxIdsItemX443d440dInspection,
) {
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineInvoiceSettingSubscriptionScheduleSettingAccountTaxIdsItemX443d440dBranch.Branch1,
                    )
                }
                if (inspection.matchesTaxId) {
                    add(
                        InlineInvoiceSettingSubscriptionScheduleSettingAccountTaxIdsItemX443d440dBranch.TaxId,
                    )
                }
                if (inspection.matchesDeletedTaxId) {
                    add(
                        InlineInvoiceSettingSubscriptionScheduleSettingAccountTaxIdsItemX443d440dBranch.DeletedTaxId,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineInvoiceSettingSubscriptionScheduleSettingAccountTaxIdsItemX443d440d {
            val inspection = inspectInlineInvoiceSettingSubscriptionScheduleSettingAccountTaxIdsItemX443d440d(raw)
            if (inspection.matchCount == 0) {
                throw InlineInvoiceSettingSubscriptionScheduleSettingAccountTaxIdsItemX443d440dNoMatchException(
                    "InlineInvoiceSettingSubscriptionScheduleSettingAccountTaxIdsItemX443d440d matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineInvoiceSettingSubscriptionScheduleSettingAccountTaxIdsItemX443d440d> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineInvoiceSettingSubscriptionScheduleSettingAccountTaxIdsItemX443d440d,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineInvoiceSettingSubscriptionScheduleSettingAccountTaxIdsItemX443d440d",
...
private fun inspectInlineInvoiceSettingSubscriptionScheduleSettingAccountTaxIdsItemX443d440d(
    element: JsonElement,
