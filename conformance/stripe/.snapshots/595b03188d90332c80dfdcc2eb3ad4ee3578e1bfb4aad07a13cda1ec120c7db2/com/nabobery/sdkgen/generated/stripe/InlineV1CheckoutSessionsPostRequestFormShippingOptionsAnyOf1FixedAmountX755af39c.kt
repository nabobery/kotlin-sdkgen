...
public class InlineV1CheckoutSessionsPostRequestFormShippingOptionsAnyOf1FixedAmountX755af39c(
    ...
    public val currencyOptions:
        Map<String, InlineV1CheckoutSessionsPostRequestFormShippingOptionsAdditionalValueX35179d02>? = null,
) {
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1CheckoutSessionsPostRequestFormShippingOptionsAnyOf1FixedAmountX755af39c =
    ...
    public object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormShippingOptionsAnyOf1FixedAmountX755af39c> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CheckoutSessionsPostRequestFormShippingOptionsAnyOf1FixedAmountX755af39c must be a JSON object",
                    )
            ...
            return InlineV1CheckoutSessionsPostRequestFormShippingOptionsAnyOf1FixedAmountX755af39c(
                ...
                currencyOptions =
                    rawObject["currency_options"]?.let {
                        json
                            .decodeFromJsonElement<Map<String, InlineV1CheckoutSessionsPostRequestFormShippingOptionsAdditionalValueX35179d02>>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsPostRequestFormShippingOptionsAnyOf1FixedAmountX755af39c,
        ) {
            val jsonEncoder =
...
public fun inlineV1CheckoutSessionsPostRequestFormShippingOptionsAnyOf1FixedAmountX755af39c(
    block: InlineV1CheckoutSessionsPostRequestFormShippingOptionsAnyOf1FixedAmountX755af39c.Builder.() -> Unit,
): InlineV1CheckoutSessionsPostRequestFormShippingOptionsAnyOf1FixedAmountX755af39c =
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1CheckoutSessionsPostRequestFormShippingOptionsAnyOf1FixedAmountX755af39c is missing required property '" +
                    name +
                    "'",
            )
