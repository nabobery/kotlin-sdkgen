...
public class InlineV1BillingPortalSessionsPostRequestFormFlowDataItemX85cb593c(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1BillingPortalSessionsPostRequestFormFlowDataItemX85cb593c =
            InlineV1BillingPortalSessionsPostRequestFormFlowDataItemX85cb593c(
                coupon = coupon,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1BillingPortalSessionsPostRequestFormFlowDataItemX85cb593c =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1BillingPortalSessionsPostRequestFormFlowDataItemX85cb593c> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1BillingPortalSessionsPostRequestFormFlowDataItemX85cb593c must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1BillingPortalSessionsPostRequestFormFlowDataItemX85cb593c,
        ) {
            val jsonEncoder =
...
public fun inlineV1BillingPortalSessionsPostRequestFormFlowDataItemX85cb593c(
    block: InlineV1BillingPortalSessionsPostRequestFormFlowDataItemX85cb593c.Builder.() -> Unit,
): InlineV1BillingPortalSessionsPostRequestFormFlowDataItemX85cb593c =
    InlineV1BillingPortalSessionsPostRequestFormFlowDataItemX85cb593c.build(block)
