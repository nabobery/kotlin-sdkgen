...
public sealed class InlineInsightsResourcesPayfa19AddressPostalCodeCheckX8169f88a {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineInsightsResourcesPayfa19AddressPostalCodeCheckX8169f88a =
            when (value) {
                Fail.value -> Fail
                Pass.value -> Pass
    ...
    public object Serializer : KSerializer<InlineInsightsResourcesPayfa19AddressPostalCodeCheckX8169f88a> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineInsightsResourcesPayfa19AddressPostalCodeCheckX8169f88a",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineInsightsResourcesPayfa19AddressPostalCodeCheckX8169f88a =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineInsightsResourcesPayfa19AddressPostalCodeCheckX8169f88a,
        ) {
