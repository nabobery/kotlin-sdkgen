...
public class CheckoutMobilepayPaymentMethodOptions(
     ...
     */
    public val captureMethod: InlineCheckoutMobilepayPaymentMethodOptionsCaptureMethodXa98cf228? = null,
    /**
     ...
     */
    public val setupFutureUsage: InlineCheckoutMobilepayPaymentMethodOptionsSetupFutureUsageX2f5ee6f4? = null,
) {
    public class Builder {
        ...
        public fun build(): CheckoutMobilepayPaymentMethodOptions =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): CheckoutMobilepayPaymentMethodOptions =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<CheckoutMobilepayPaymentMethodOptions> {
        ...
        override fun deserialize(decoder: Decoder): CheckoutMobilepayPaymentMethodOptions {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("CheckoutMobilepayPaymentMethodOptions must be a JSON object")
            return CheckoutMobilepayPaymentMethodOptions(
                captureMethod =
                    rawObject["capture_method"]?.let {
                        json.decodeFromJsonElement<InlineCheckoutMobilepayPaymentMethodOptionsCaptureMethodXa98cf228>(
                            it,
                        )
                    },
                setupFutureUsage =
                    rawObject["setup_future_usage"]?.let {
                        json
                            .decodeFromJsonElement<InlineCheckoutMobilepayPaymentMethodOptionsSetupFutureUsageX2f5ee6f4>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: CheckoutMobilepayPaymentMethodOptions,
        ) {
...
public fun checkoutMobilepayPaymentMethodOptions(
    block: CheckoutMobilepayPaymentMethodOptions.Builder.() -> Unit,
): CheckoutMobilepayPaymentMethodOptions = CheckoutMobilepayPaymentMethodOptions.build(block)
