...
public class InsightsResourcesPaymentEvaluationEvent(
    ...
    public val earlyFraudWarningReceived: InsightsResourcesPaymentEvaluationEarlyFraudWarningReceived? = null,
    public val refunded: InsightsResourcesPaymentEvaluationRefunded? = null,
    public val userInterventionRaised: InsightsResourcesPaymentEvaluationUserInterventionRaised? = null,
    public val userInterventionResolved: InsightsResourcesPaymentEvaluationUserInterventionResolved? = null,
) {
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InsightsResourcesPaymentEvaluationEvent =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InsightsResourcesPaymentEvaluationEvent> {
        ...
        override fun deserialize(decoder: Decoder): InsightsResourcesPaymentEvaluationEvent {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("InsightsResourcesPaymentEvaluationEvent must be a JSON object")
            val occurredAt = json.decodeRequired<Int>(rawObject, "occurred_at")
            val type =
                json.decodeRequired<InlineInsightsResourcesPaymentEvaluationEventTypeX223d690d>(
                    rawObject,
                    "type",
                )
            return InsightsResourcesPaymentEvaluationEvent(
                ...
                type = type,
                disputeOpened =
                    rawObject["dispute_opened"]?.let {
                        json.decodeFromJsonElement<InsightsResourcesPaymentEvaluationDisputeOpened>(it)
                    },
                earlyFraudWarningReceived =
                    rawObject["early_fraud_warning_received"]?.let {
                        json.decodeFromJsonElement<InsightsResourcesPaymentEvaluationEarlyFraudWarningReceived>(it)
                    },
                refunded =
                    rawObject["refunded"]?.let {
                        json.decodeFromJsonElement<InsightsResourcesPaymentEvaluationRefunded>(
                            it,
                        )
                    },
                userInterventionRaised =
                    rawObject["user_intervention_raised"]?.let {
                        json.decodeFromJsonElement<InsightsResourcesPaymentEvaluationUserInterventionRaised>(it)
                    },
                userInterventionResolved =
                    rawObject["user_intervention_resolved"]?.let {
                        json.decodeFromJsonElement<InsightsResourcesPaymentEvaluationUserInterventionResolved>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InsightsResourcesPaymentEvaluationEvent,
        ) {
            ...
            val raw =
                buildJsonObject {
                    ...
                    value.earlyFraudWarningReceived?.let {
                        put(
                    ...
                    value.userInterventionResolved?.let {
                        put(
...
public fun insightsResourcesPaymentEvaluationEvent(
    block: InsightsResourcesPaymentEvaluationEvent.Builder.() -> Unit,
): InsightsResourcesPaymentEvaluationEvent = InsightsResourcesPaymentEvaluationEvent.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InsightsResourcesPaymentEvaluationEvent is missing required property '" + name + "'",
            )
