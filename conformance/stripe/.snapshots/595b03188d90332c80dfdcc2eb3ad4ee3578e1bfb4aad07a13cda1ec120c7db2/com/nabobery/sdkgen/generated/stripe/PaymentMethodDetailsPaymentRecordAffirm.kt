...
public class PaymentMethodDetailsPaymentRecordAffirm(
    ...
    public class Builder {
        ...
        public fun build(): PaymentMethodDetailsPaymentRecordAffirm =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentMethodDetailsPaymentRecordAffirm =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentMethodDetailsPaymentRecordAffirm> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodDetailsPaymentRecordAffirm {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodDetailsPaymentRecordAffirm must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentMethodDetailsPaymentRecordAffirm,
        ) {
...
public fun paymentMethodDetailsPaymentRecordAffirm(
    block: PaymentMethodDetailsPaymentRecordAffirm.Builder.() -> Unit,
): PaymentMethodDetailsPaymentRecordAffirm = PaymentMethodDetailsPaymentRecordAffirm.build(block)
