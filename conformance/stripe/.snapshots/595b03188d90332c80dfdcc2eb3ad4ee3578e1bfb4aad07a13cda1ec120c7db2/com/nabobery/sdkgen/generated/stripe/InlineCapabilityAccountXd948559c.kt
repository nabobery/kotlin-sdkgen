...
public class InlineCapabilityAccountXd948559c internal constructor(
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineCapabilityAccountXd948559c {
            val inspection = inspectInlineCapabilityAccountXd948559c(raw)
            if (inspection.matchCount == 0) {
                throw InlineCapabilityAccountXd948559cNoMatchException(
                    "InlineCapabilityAccountXd948559c matched 0 branches: " + inspection.failures.joinToString("; "),
                )
            }
    ...
    public object Serializer : KSerializer<InlineCapabilityAccountXd948559c> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineCapabilityAccountXd948559c,
        ) {
