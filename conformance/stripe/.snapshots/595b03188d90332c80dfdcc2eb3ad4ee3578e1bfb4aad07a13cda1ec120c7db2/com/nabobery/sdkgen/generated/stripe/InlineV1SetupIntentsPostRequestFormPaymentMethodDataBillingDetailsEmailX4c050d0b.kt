...
internal data class InlineV1SetupIntentsPostRequestFormPaymentMethodDataBillingDetailsEmailX4c050d0bInspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1SetupIntentsPostRequestFormPaymentMethodDataAnyOf2X25ed642a,
            ).count { it }
}
...
public class InlineV1SetupIntentsPostRequestFormPaymentMethodDataBillingDetailsEmailX4c050d0b internal constructor(
    ...
    private val inspection: InlineV1SetupIntentsPostRequestFormPaymentMethodDataBillingDetailsEmailX4c050d0bInspection,
) {
    ...
    public val inlineV1SetupIntentsPostRequestFormPaymentMethodDataAnyOf2X25ed642a:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1SetupIntentsPostRequestFormPaymentMethodDataAnyOf2X25ed642a) {
                json
                    .decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodDataAnyOf2X25ed642a>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1SetupIntentsPostRequestFormPaymentMethodDataBillingDetailsEmailX4c050d0bBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1SetupIntentsPostRequestFormPaymentMethodDataAnyOf2X25ed642a) {
                    add(
                        InlineV1SetupIntentsPostRequestFormPaymentMethodDataBillingDetailsEmailX4c050d0bBranch.InlineV1SetupIntentsPostRequestFormPaymentMethodDataAnyOf2X25ed642a,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1SetupIntentsPostRequestFormPaymentMethodDataBillingDetailsEmailX4c050d0b {
            val inspection =
                inspectInlineV1SetupIntentsPostRequestFormPaymentMethodDataBillingDetailsEmailX4c050d0b(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1SetupIntentsPostRequestFormPaymentMethodDataBillingDetailsEmailX4c050d0bNoMatchException(
                    "InlineV1SetupIntentsPostRequestFormPaymentMethodDataBillingDetailsEmailX4c050d0b matched 0 branches: " +
                        inspection.failures.joinToString("; "),
                )
            }
            return InlineV1SetupIntentsPostRequestFormPaymentMethodDataBillingDetailsEmailX4c050d0b(
                raw,
                json,
                inspection,
            )
    ...
    public object Serializer : KSerializer<InlineV1SetupIntentsPostRequestFormPaymentMethodDataBillingDetailsEmailX4c050d0b> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SetupIntentsPostRequestFormPaymentMethodDataBillingDetailsEmailX4c050d0b,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1SetupIntentsPostRequestFormPaymentMethodDataBillingDetailsEmailX4c050d0b",
...
private fun inspectInlineV1SetupIntentsPostRequestFormPaymentMethodDataBillingDetailsEmailX4c050d0b(
    element: JsonElement,
): InlineV1SetupIntentsPostRequestFormPaymentMethodDataBillingDetailsEmailX4c050d0bInspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1SetupIntentsPostRequestFormPaymentMethodDataAnyOf2X25ed642a =
        element
            .isJsonDecodable<InlineV1SetupIntentsPostRequestFormPaymentMethodDataAnyOf2X25ed642a>()
    return InlineV1SetupIntentsPostRequestFormPaymentMethodDataBillingDetailsEmailX4c050d0bInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1SetupIntentsPostRequestFormPaymentMethodDataAnyOf2X25ed642a) {
                    add(
                        "InlineV1SetupIntentsPostRequestFormPaymentMethodDataAnyOf2X25ed642a: value does not match InlineV1SetupIntentsPostRequestFormPaymentMethodDataAnyOf2X25ed642a",
                    )
                }
            },
    )
