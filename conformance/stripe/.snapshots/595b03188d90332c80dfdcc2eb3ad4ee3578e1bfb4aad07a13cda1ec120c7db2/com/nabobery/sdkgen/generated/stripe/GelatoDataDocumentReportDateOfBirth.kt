...
public class GelatoDataDocumentReportDateOfBirth(
    ...
    public class Builder {
        ...
        public fun build(): GelatoDataDocumentReportDateOfBirth =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): GelatoDataDocumentReportDateOfBirth =
    ...
    public object Serializer : KSerializer<GelatoDataDocumentReportDateOfBirth> {
        ...
        override fun deserialize(decoder: Decoder): GelatoDataDocumentReportDateOfBirth {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("GelatoDataDocumentReportDateOfBirth must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: GelatoDataDocumentReportDateOfBirth,
        ) {
...
public fun gelatoDataDocumentReportDateOfBirth(
    block: GelatoDataDocumentReportDateOfBirth.Builder.() -> Unit,
): GelatoDataDocumentReportDateOfBirth = GelatoDataDocumentReportDateOfBirth.build(block)
