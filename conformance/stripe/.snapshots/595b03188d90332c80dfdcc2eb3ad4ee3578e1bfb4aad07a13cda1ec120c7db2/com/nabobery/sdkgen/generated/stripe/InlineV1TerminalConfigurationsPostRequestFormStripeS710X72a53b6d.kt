...
internal data class InlineV1TerminalConfigurationsPostRequestFormStripeS710X72a53b6dInspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesInlineV1TerminalConfigurationsPostRequestFormStripeS710AnyOf1X74d0686a,
                matchesInlineV1TerminalConfigurationsPostRequestFormStripeS710AnyOf2X6e0f7ef1,
            ).count {
                it
            }
}
...
public class InlineV1TerminalConfigurationsPostRequestFormStripeS710X72a53b6d internal constructor(
    ...
    private val inspection: InlineV1TerminalConfigurationsPostRequestFormStripeS710X72a53b6dInspection,
) {
    public val inlineV1TerminalConfigurationsPostRequestFormStripeS710AnyOf1X74d0686a:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1TerminalConfigurationsPostRequestFormStripeS710AnyOf1X74d0686a) {
                json
                    .decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormStripeS710AnyOf1X74d0686a>(
                        raw,
                    )
            } else {
                null
    ...
    public val inlineV1TerminalConfigurationsPostRequestFormStripeS710AnyOf2X6e0f7ef1:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1TerminalConfigurationsPostRequestFormStripeS710AnyOf2X6e0f7ef1) {
                json
                    .decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormStripeS710AnyOf2X6e0f7ef1>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches:
        ...
        get() =
            buildSet {
                if (inspection.matchesInlineV1TerminalConfigurationsPostRequestFormStripeS710AnyOf1X74d0686a) {
                    add(
                        InlineV1TerminalConfigurationsPostRequestFormStripeS710X72a53b6dBranch.InlineV1TerminalConfigurationsPostRequestFormStripeS710AnyOf1X74d0686a,
                    )
                }
                if (inspection.matchesInlineV1TerminalConfigurationsPostRequestFormStripeS710AnyOf2X6e0f7ef1) {
                    add(
                        InlineV1TerminalConfigurationsPostRequestFormStripeS710X72a53b6dBranch.InlineV1TerminalConfigurationsPostRequestFormStripeS710AnyOf2X6e0f7ef1,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1TerminalConfigurationsPostRequestFormStripeS710X72a53b6d {
            val inspection = inspectInlineV1TerminalConfigurationsPostRequestFormStripeS710X72a53b6d(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1TerminalConfigurationsPostRequestFormStripeS710X72a53b6dNoMatchException(
                    "InlineV1TerminalConfigurationsPostRequestFormStripeS710X72a53b6d matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1TerminalConfigurationsPostRequestFormStripeS710X72a53b6d> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TerminalConfigurationsPostRequestFormStripeS710X72a53b6d,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1TerminalConfigurationsPostRequestFormStripeS710X72a53b6d",
...
private fun inspectInlineV1TerminalConfigurationsPostRequestFormStripeS710X72a53b6d(
    element: JsonElement,
): InlineV1TerminalConfigurationsPostRequestFormStripeS710X72a53b6dInspection {
    val matchesInlineV1TerminalConfigurationsPostRequestFormStripeS710AnyOf1X74d0686a =
        element
            .isJsonDecodable<InlineV1TerminalConfigurationsPostRequestFormStripeS710AnyOf1X74d0686a>()
    val matchesInlineV1TerminalConfigurationsPostRequestFormStripeS710AnyOf2X6e0f7ef1 =
        element
            .isJsonDecodable<InlineV1TerminalConfigurationsPostRequestFormStripeS710AnyOf2X6e0f7ef1>()
    return InlineV1TerminalConfigurationsPostRequestFormStripeS710X72a53b6dInspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1TerminalConfigurationsPostRequestFormStripeS710AnyOf1X74d0686a) {
                    add(
                        "InlineV1TerminalConfigurationsPostRequestFormStripeS710AnyOf1X74d0686a: value does not match InlineV1TerminalConfigurationsPostRequestFormStripeS710AnyOf1X74d0686a",
                    )
                }
                if (!matchesInlineV1TerminalConfigurationsPostRequestFormStripeS710AnyOf2X6e0f7ef1) {
                    add(
                        "InlineV1TerminalConfigurationsPostRequestFormStripeS710AnyOf2X6e0f7ef1: value does not match InlineV1TerminalConfigurationsPostRequestFormStripeS710AnyOf2X6e0f7ef1",
                    )
                }
            },
    )
