...
public class InlineV1TestHelpersTreasurbf2dPostRequestFormUsBankAccountXd0b12611(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1TestHelpersTreasurbf2dPostRequestFormUsBankAccountXd0b12611 =
            InlineV1TestHelpersTreasurbf2dPostRequestFormUsBankAccountXd0b12611(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1TestHelpersTreasurbf2dPostRequestFormUsBankAccountXd0b12611 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TestHelpersTreasurbf2dPostRequestFormUsBankAccountXd0b12611> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TestHelpersTreasurbf2dPostRequestFormUsBankAccountXd0b12611 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TestHelpersTreasurbf2dPostRequestFormUsBankAccountXd0b12611,
        ) {
            val jsonEncoder =
...
public fun inlineV1TestHelpersTreasurbf2dPostRequestFormUsBankAccountXd0b12611(
    block: InlineV1TestHelpersTreasurbf2dPostRequestFormUsBankAccountXd0b12611.Builder.() -> Unit,
): InlineV1TestHelpersTreasurbf2dPostRequestFormUsBankAccountXd0b12611 =
