...
internal data class InlineV1InvoicesPostRequestFormPaymentSettingsAcssDebitX18c695d9Inspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X1299cb3c,
                matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2X911f9f53,
            ).count {
                it
            }
}
...
public class InlineV1InvoicesPostRequestFormPaymentSettingsAcssDebitX18c695d9 internal constructor(
    ...
    private val inspection: InlineV1InvoicesPostRequestFormPaymentSettingsAcssDebitX18c695d9Inspection,
) {
    public val inlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X1299cb3c:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X1299cb3c) {
                json
                    .decodeFromJsonElement<InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X1299cb3c>(
                        raw,
                    )
            } else {
                null
    ...
    public val inlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2X911f9f53:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2X911f9f53) {
                json
                    .decodeFromJsonElement<InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2X911f9f53>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches:
        ...
        get() =
            buildSet {
                if (inspection.matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X1299cb3c) {
                    add(
                        InlineV1InvoicesPostRequestFormPaymentSettingsAcssDebitX18c695d9Branch.InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X1299cb3c,
                    )
                }
                if (inspection.matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2X911f9f53) {
                    add(
                        InlineV1InvoicesPostRequestFormPaymentSettingsAcssDebitX18c695d9Branch.InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2X911f9f53,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1InvoicesPostRequestFormPaymentSettingsAcssDebitX18c695d9 {
            val inspection = inspectInlineV1InvoicesPostRequestFormPaymentSettingsAcssDebitX18c695d9(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1InvoicesPostRequestFormPaymentSettingsAcssDebitX18c695d9NoMatchException(
                    "InlineV1InvoicesPostRequestFormPaymentSettingsAcssDebitX18c695d9 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1InvoicesPostRequestFormPaymentSettingsAcssDebitX18c695d9> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesPostRequestFormPaymentSettingsAcssDebitX18c695d9,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1InvoicesPostRequestFormPaymentSettingsAcssDebitX18c695d9",
...
private fun inspectInlineV1InvoicesPostRequestFormPaymentSettingsAcssDebitX18c695d9(
    element: JsonElement,
): InlineV1InvoicesPostRequestFormPaymentSettingsAcssDebitX18c695d9Inspection {
    val matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X1299cb3c =
        element
            .isJsonDecodable<InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X1299cb3c>()
    val matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2X911f9f53 =
        element
            .isJsonDecodable<InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2X911f9f53>()
    return InlineV1InvoicesPostRequestFormPaymentSettingsAcssDebitX18c695d9Inspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X1299cb3c) {
                    add(
                        "InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X1299cb3c: value does not match InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X1299cb3c",
                    )
                }
                if (!matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2X911f9f53) {
                    add(
                        "InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2X911f9f53: value does not match InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2X911f9f53",
                    )
                }
            },
    )
