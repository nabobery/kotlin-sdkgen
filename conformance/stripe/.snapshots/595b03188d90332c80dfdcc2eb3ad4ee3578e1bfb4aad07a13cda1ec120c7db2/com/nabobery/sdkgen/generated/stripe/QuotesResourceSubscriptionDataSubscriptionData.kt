...
public class QuotesResourceSubscriptionDataSubscriptionData(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): QuotesResourceSubscriptionDataSubscriptionData =
    ...
    public object Serializer : KSerializer<QuotesResourceSubscriptionDataSubscriptionData> {
        ...
        override fun deserialize(decoder: Decoder): QuotesResourceSubscriptionDataSubscriptionData {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "QuotesResourceSubscriptionDataSubscriptionData must be a JSON object",
                    )
            ...
            return QuotesResourceSubscriptionDataSubscriptionData(
                ...
                effectiveDate =
                    rawObject["effective_date"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: QuotesResourceSubscriptionDataSubscriptionData,
        ) {
...
public fun quotesResourceSubscriptionDataSubscriptionData(
    block: QuotesResourceSubscriptionDataSubscriptionData.Builder.() -> Unit,
): QuotesResourceSubscriptionDataSubscriptionData = QuotesResourceSubscriptionDataSubscriptionData.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "QuotesResourceSubscriptionDataSubscriptionData is missing required property '" + name + "'",
            )
