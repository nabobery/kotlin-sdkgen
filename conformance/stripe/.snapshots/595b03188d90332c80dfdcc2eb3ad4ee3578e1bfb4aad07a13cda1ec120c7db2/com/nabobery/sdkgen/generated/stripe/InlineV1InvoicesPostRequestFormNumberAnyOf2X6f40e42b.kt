...
public sealed class InlineV1InvoicesPostRequestFormNumberAnyOf2X6f40e42b {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1InvoicesPostRequestFormNumberAnyOf2X6f40e42b =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1InvoicesPostRequestFormNumberAnyOf2X6f40e42b> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1InvoicesPostRequestFormNumberAnyOf2X6f40e42b",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1InvoicesPostRequestFormNumberAnyOf2X6f40e42b =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesPostRequestFormNumberAnyOf2X6f40e42b,
        ) {
