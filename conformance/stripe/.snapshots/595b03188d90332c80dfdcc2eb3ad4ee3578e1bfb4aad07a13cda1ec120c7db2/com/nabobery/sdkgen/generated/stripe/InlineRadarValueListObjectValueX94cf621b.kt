...
public sealed class InlineRadarValueListObjectValueX94cf621b {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineRadarValueListObjectValueX94cf621b =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineRadarValueListObjectValueX94cf621b> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineRadarValueListObjectValueX94cf621b",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineRadarValueListObjectValueX94cf621b =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineRadarValueListObjectValueX94cf621b,
        ) {
