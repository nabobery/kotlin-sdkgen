...
public sealed class InlineFundingInstructionsObjectValueX92154a48 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineFundingInstructionsObjectValueX92154a48 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineFundingInstructionsObjectValueX92154a48> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineFundingInstructionsObjectValueX92154a48",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineFundingInstructionsObjectValueX92154a48 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineFundingInstructionsObjectValueX92154a48,
        ) {
