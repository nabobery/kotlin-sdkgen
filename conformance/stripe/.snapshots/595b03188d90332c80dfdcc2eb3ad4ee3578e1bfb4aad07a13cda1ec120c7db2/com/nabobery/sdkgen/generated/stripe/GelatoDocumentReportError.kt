...
public class GelatoDocumentReportError(
    ...
    public class Builder {
        ...
        public fun build(): GelatoDocumentReportError =
    ...
    public object Serializer : KSerializer<GelatoDocumentReportError> {
        ...
        override fun deserialize(decoder: Decoder): GelatoDocumentReportError {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("GelatoDocumentReportError must be a JSON object")
                ...
                code =
                    rawObject["code"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineGelatoDocumentReportErrorCodeXcc31dbbe?>(element)
                        }
                    },
                reason =
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: GelatoDocumentReportError,
        ) {
...
public fun gelatoDocumentReportError(block: GelatoDocumentReportError.Builder.() -> Unit): GelatoDocumentReportError =
    GelatoDocumentReportError.build(block)
