...
public sealed class InlinePaymentLinkSubmitTypeXa03c3bfc {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentLinkSubmitTypeXa03c3bfc =
            when (value) {
                Auto.value -> Auto
                Book.value -> Book
                Donate.value -> Donate
    ...
    public object Serializer : KSerializer<InlinePaymentLinkSubmitTypeXa03c3bfc> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentLinkSubmitTypeXa03c3bfc",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePaymentLinkSubmitTypeXa03c3bfc =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentLinkSubmitTypeXa03c3bfc,
        ) {
