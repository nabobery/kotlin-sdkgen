...
public class InlineV1TestHelpersIssuingc1dfPostRequestFormPurchaseDetailsFuelXcc61a8f9(
    ...
    public val type: InlineV1TestHelpersIssuingc1dfPostRequestFormPurchaseDetailsFuelTypeXcdfb54c4? = null,
    public val unit: InlineV1TestHelpersIssuingc1dfPostRequestFormPurchaseDetailsFuelUnitXb05f9aa7? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1TestHelpersIssuingc1dfPostRequestFormPurchaseDetailsFuelXcc61a8f9 =
            InlineV1TestHelpersIssuingc1dfPostRequestFormPurchaseDetailsFuelXcc61a8f9(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1TestHelpersIssuingc1dfPostRequestFormPurchaseDetailsFuelXcc61a8f9 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TestHelpersIssuingc1dfPostRequestFormPurchaseDetailsFuelXcc61a8f9> {
        ...
        override fun deserialize(
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TestHelpersIssuingc1dfPostRequestFormPurchaseDetailsFuelXcc61a8f9 must be a JSON object",
                    )
            return InlineV1TestHelpersIssuingc1dfPostRequestFormPurchaseDetailsFuelXcc61a8f9(
                ...
                type =
                    rawObject["type"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TestHelpersIssuingc1dfPostRequestFormPurchaseDetailsFuelTypeXcdfb54c4>(
                                it,
                            )
                    },
                unit =
                    rawObject["unit"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TestHelpersIssuingc1dfPostRequestFormPurchaseDetailsFuelUnitXb05f9aa7>(
                                it,
                            )
                    },
                unitCostDecimal =
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TestHelpersIssuingc1dfPostRequestFormPurchaseDetailsFuelXcc61a8f9,
        ) {
            val jsonEncoder =
...
public fun inlineV1TestHelpersIssuingc1dfPostRequestFormPurchaseDetailsFuelXcc61a8f9(
    block: InlineV1TestHelpersIssuingc1dfPostRequestFormPurchaseDetailsFuelXcc61a8f9.Builder.() -> Unit,
): InlineV1TestHelpersIssuingc1dfPostRequestFormPurchaseDetailsFuelXcc61a8f9 =
    InlineV1TestHelpersIssuingc1dfPostRequestFormPurchaseDetailsFuelXcc61a8f9.build(block)
