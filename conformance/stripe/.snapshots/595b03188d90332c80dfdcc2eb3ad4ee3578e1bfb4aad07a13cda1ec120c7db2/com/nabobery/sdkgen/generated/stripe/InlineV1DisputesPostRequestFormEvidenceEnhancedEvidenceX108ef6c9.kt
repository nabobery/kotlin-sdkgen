...
internal data class InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceX108ef6c9Inspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesInlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1X592f0bf6,
                matchesInlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf2Xd8b448dd,
            ).count {
                it
            }
}
...
public class InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceX108ef6c9 internal constructor(
    ...
    private val inspection: InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceX108ef6c9Inspection,
) {
    public val inlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1X592f0bf6:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1X592f0bf6) {
                json
                    .decodeFromJsonElement<InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1X592f0bf6>(
                        raw,
                    )
            } else {
                null
    ...
    public val inlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf2Xd8b448dd:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf2Xd8b448dd) {
                json
                    .decodeFromJsonElement<InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf2Xd8b448dd>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches:
        ...
        get() =
            buildSet {
                if (inspection.matchesInlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1X592f0bf6) {
                    add(
                        InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceX108ef6c9Branch.InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1X592f0bf6,
                    )
                }
                if (inspection.matchesInlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf2Xd8b448dd) {
                    add(
                        InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceX108ef6c9Branch.InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf2Xd8b448dd,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceX108ef6c9 {
            val inspection = inspectInlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceX108ef6c9(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceX108ef6c9NoMatchException(
                    "InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceX108ef6c9 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceX108ef6c9> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceX108ef6c9,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceX108ef6c9",
...
private fun inspectInlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceX108ef6c9(
    element: JsonElement,
): InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceX108ef6c9Inspection {
    val matchesInlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1X592f0bf6 =
        element
            .isJsonDecodable<InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1X592f0bf6>()
    val matchesInlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf2Xd8b448dd =
        element
            .isJsonDecodable<InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf2Xd8b448dd>()
    return InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceX108ef6c9Inspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1X592f0bf6) {
                    add(
                        "InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1X592f0bf6: value does not match InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1X592f0bf6",
                    )
                }
                if (!matchesInlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf2Xd8b448dd) {
                    add(
                        "InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf2Xd8b448dd: value does not match InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf2Xd8b448dd",
                    )
                }
            },
    )
