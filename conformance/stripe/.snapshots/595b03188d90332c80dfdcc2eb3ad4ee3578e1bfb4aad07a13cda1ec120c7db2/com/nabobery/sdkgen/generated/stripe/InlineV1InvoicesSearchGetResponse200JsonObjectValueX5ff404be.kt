...
public sealed class InlineV1InvoicesSearchGetResponse200JsonObjectValueX5ff404be {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1InvoicesSearchGetResponse200JsonObjectValueX5ff404be =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1InvoicesSearchGetResponse200JsonObjectValueX5ff404be> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1InvoicesSearchGetResponse200JsonObjectValueX5ff404be",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1InvoicesSearchGetResponse200JsonObjectValueX5ff404be =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesSearchGetResponse200JsonObjectValueX5ff404be,
        ) {
