...
internal data class InlineV1CustomersSubscriptionsPostRequestFormItemsItemMetadataX7c14fd51Inspection(
    ...
    public val matchesInlineV1CustomersSubscriptionsPostRequestFormItemsItemMetadataAnyOf2Xeb8fdb50: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1CustomersSubscriptionsPostRequestFormItemsItemMetadataAnyOf2Xeb8fdb50,
            ).count {
                it
            }
}
...
public class InlineV1CustomersSubscriptionsPostRequestFormItemsItemMetadataX7c14fd51 internal constructor(
    ...
    private val inspection: InlineV1CustomersSubscriptionsPostRequestFormItemsItemMetadataX7c14fd51Inspection,
) {
    ...
    public val inlineV1CustomersSubscriptionsPostRequestFormItemsItemMetadataAnyOf2Xeb8fdb50:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1CustomersSubscriptionsPostRequestFormItemsItemMetadataAnyOf2Xeb8fdb50) {
                json
                    .decodeFromJsonElement<InlineV1CustomersSubscriptionsPostRequestFormItemsItemMetadataAnyOf2Xeb8fdb50>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1CustomersSubscriptionsPostRequestFormItemsItemMetadataX7c14fd51Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1CustomersSubscriptionsPostRequestFormItemsItemMetadataAnyOf2Xeb8fdb50) {
                    add(
                        InlineV1CustomersSubscriptionsPostRequestFormItemsItemMetadataX7c14fd51Branch.InlineV1CustomersSubscriptionsPostRequestFormItemsItemMetadataAnyOf2Xeb8fdb50,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1CustomersSubscriptionsPostRequestFormItemsItemMetadataX7c14fd51 {
            val inspection = inspectInlineV1CustomersSubscriptionsPostRequestFormItemsItemMetadataX7c14fd51(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1CustomersSubscriptionsPostRequestFormItemsItemMetadataX7c14fd51NoMatchException(
                    "InlineV1CustomersSubscriptionsPostRequestFormItemsItemMetadataX7c14fd51 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1CustomersSubscriptionsPostRequestFormItemsItemMetadataX7c14fd51> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersSubscriptionsPostRequestFormItemsItemMetadataX7c14fd51,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1CustomersSubscriptionsPostRequestFormItemsItemMetadataX7c14fd51",
...
private fun inspectInlineV1CustomersSubscriptionsPostRequestFormItemsItemMetadataX7c14fd51(
    element: JsonElement,
): InlineV1CustomersSubscriptionsPostRequestFormItemsItemMetadataX7c14fd51Inspection {
    val matchesBranch1 = element.isJsonDecodable<JsonObject>()
    val matchesInlineV1CustomersSubscriptionsPostRequestFormItemsItemMetadataAnyOf2Xeb8fdb50 =
        element
            .isJsonDecodable<InlineV1CustomersSubscriptionsPostRequestFormItemsItemMetadataAnyOf2Xeb8fdb50>()
    return InlineV1CustomersSubscriptionsPostRequestFormItemsItemMetadataX7c14fd51Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1CustomersSubscriptionsPostRequestFormItemsItemMetadataAnyOf2Xeb8fdb50) {
                    add(
                        "InlineV1CustomersSubscriptionsPostRequestFormItemsItemMetadataAnyOf2Xeb8fdb50: value does not match InlineV1CustomersSubscriptionsPostRequestFormItemsItemMetadataAnyOf2Xeb8fdb50",
                    )
                }
            },
    )
