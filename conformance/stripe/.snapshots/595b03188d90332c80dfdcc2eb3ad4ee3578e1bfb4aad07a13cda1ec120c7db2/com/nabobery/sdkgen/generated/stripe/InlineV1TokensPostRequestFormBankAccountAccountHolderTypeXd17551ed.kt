...
public sealed class InlineV1TokensPostRequestFormBankAccountAccountHolderTypeXd17551ed {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1TokensPostRequestFormBankAccountAccountHolderTypeXd17551ed =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1TokensPostRequestFormBankAccountAccountHolderTypeXd17551ed> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1TokensPostRequestFormBankAccountAccountHolderTypeXd17551ed",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1TokensPostRequestFormBankAccountAccountHolderTypeXd17551ed =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TokensPostRequestFormBankAccountAccountHolderTypeXd17551ed,
        ) {
