...
public class InlineStackableDiscountWithDiscountSettingsAndDiscountEndPromotionCodeXa6eea1bf internal constructor(
    ...
    private val inspection: InlineStackableDiscountWithDiscountSettingsAndDiscountEndPromotionCodeXa6eea1bfInspection,
) {
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineStackableDiscountWithDiscountSettingsAndDiscountEndPromotionCodeXa6eea1bfBranch.Branch1,
                    )
                }
                if (inspection.matchesPromotionCode) {
                    add(
                        InlineStackableDiscountWithDiscountSettingsAndDiscountEndPromotionCodeXa6eea1bfBranch.PromotionCode,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineStackableDiscountWithDiscountSettingsAndDiscountEndPromotionCodeXa6eea1bf {
            val inspection = inspectInlineStackableDiscountWithDiscountSettingsAndDiscountEndPromotionCodeXa6eea1bf(raw)
            if (inspection.matchCount == 0) {
                throw InlineStackableDiscountWithDiscountSettingsAndDiscountEndPromotionCodeXa6eea1bfNoMatchException(
                    "InlineStackableDiscountWithDiscountSettingsAndDiscountEndPromotionCodeXa6eea1bf matched 0 branches: " +
                        inspection.failures.joinToString("; "),
                )
            }
            return InlineStackableDiscountWithDiscountSettingsAndDiscountEndPromotionCodeXa6eea1bf(
                raw,
                json,
                inspection,
            )
    ...
    public object Serializer : KSerializer<InlineStackableDiscountWithDiscountSettingsAndDiscountEndPromotionCodeXa6eea1bf> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineStackableDiscountWithDiscountSettingsAndDiscountEndPromotionCodeXa6eea1bf,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineStackableDiscountWithDiscountSettingsAndDiscountEndPromotionCodeXa6eea1bf",
...
private fun inspectInlineStackableDiscountWithDiscountSettingsAndDiscountEndPromotionCodeXa6eea1bf(
    element: JsonElement,
