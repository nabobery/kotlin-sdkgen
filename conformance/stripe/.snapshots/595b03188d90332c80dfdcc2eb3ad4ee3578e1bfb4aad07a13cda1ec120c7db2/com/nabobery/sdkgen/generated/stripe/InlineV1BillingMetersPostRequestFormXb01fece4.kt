...
public class InlineV1BillingMetersPostRequestFormXb01fece4(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1BillingMetersPostRequestFormXb01fece4 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1BillingMetersPostRequestFormXb01fece4> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1BillingMetersPostRequestFormXb01fece4 {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1BillingMetersPostRequestFormXb01fece4 must be a JSON object",
                    )
            val defaultAggregation =
                json.decodeRequired<InlineV1BillingMetersPostRequestFormDefaultAggregationXfb17a4d8>(
                    rawObject,
                    "default_aggregation",
                )
            ...
            return InlineV1BillingMetersPostRequestFormXb01fece4(
                ...
                eventName = eventName,
                customerMapping =
                    rawObject["customer_mapping"]?.let {
                        json.decodeFromJsonElement<InlineV1BillingMetersPostRequestFormCustomerMappingX724ab5c5>(it)
                    },
                eventTimeWindow =
                    rawObject["event_time_window"]?.let {
                        json.decodeFromJsonElement<InlineV1BillingMetersPostRequestFormEventTimeWindowXada513c9>(it)
                    },
                expand = rawObject["expand"]?.let { json.decodeFromJsonElement<List<String>>(it) },
                valueSettings =
                    rawObject["value_settings"]?.let {
                        json.decodeFromJsonElement<InlineV1BillingMetersPostRequestFormValueSettingsXc9016ea3>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1BillingMetersPostRequestFormXb01fece4,
        ) {
...
public fun inlineV1BillingMetersPostRequestFormXb01fece4(
    block: InlineV1BillingMetersPostRequestFormXb01fece4.Builder.() -> Unit,
): InlineV1BillingMetersPostRequestFormXb01fece4 = InlineV1BillingMetersPostRequestFormXb01fece4.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1BillingMetersPostRequestFormXb01fece4 is missing required property '" + name + "'",
            )
