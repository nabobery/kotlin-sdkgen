...
public class InlineV1TerminalReadersSetReaderDisplayPostRequestFormXc9c269bc(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TerminalReadersSetReaderDisplayPostRequestFormXc9c269bc =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TerminalReadersSetReaderDisplayPostRequestFormXc9c269bc> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1TerminalReadersSetReaderDisplayPostRequestFormXc9c269bc {
            val jsonDecoder =
                decoder.requireJsonDecoder(
                    "InlineV1TerminalReadersSetReaderDisplayPostRequestFormXc9c269bc",
                )
            val json = jsonDecoder.json
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TerminalReadersSetReaderDisplayPostRequestFormXc9c269bc must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineV1TerminalReadersSetReaderDisplayPostRequestFormTypeX7d3b2376>(
                    rawObject,
                    "type",
                )
            return InlineV1TerminalReadersSetReaderDisplayPostRequestFormXc9c269bc(
                ...
                cart =
                    rawObject["cart"]?.let {
                        json.decodeFromJsonElement<InlineV1TerminalReadersSetReaderDisplayPostRequestFormCartX4fdf1954>(
                            it,
                        )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TerminalReadersSetReaderDisplayPostRequestFormXc9c269bc,
        ) {
            val jsonEncoder =
...
public fun inlineV1TerminalReadersSetReaderDisplayPostRequestFormXc9c269bc(
    block: InlineV1TerminalReadersSetReaderDisplayPostRequestFormXc9c269bc.Builder.() -> Unit,
): InlineV1TerminalReadersSetReaderDisplayPostRequestFormXc9c269bc =
    InlineV1TerminalReadersSetReaderDisplayPostRequestFormXc9c269bc.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TerminalReadersSetReaderDisplayPostRequestFormXc9c269bc is missing required property '" + name +
                    "'",
            )
