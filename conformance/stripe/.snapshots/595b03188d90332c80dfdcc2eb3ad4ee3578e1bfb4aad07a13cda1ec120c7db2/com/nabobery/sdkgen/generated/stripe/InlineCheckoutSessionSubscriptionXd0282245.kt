...
public class InlineCheckoutSessionSubscriptionXd0282245 internal constructor(
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineCheckoutSessionSubscriptionXd0282245 {
            val inspection = inspectInlineCheckoutSessionSubscriptionXd0282245(raw)
            if (inspection.matchCount == 0) {
                throw InlineCheckoutSessionSubscriptionXd0282245NoMatchException(
                    "InlineCheckoutSessionSubscriptionXd0282245 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineCheckoutSessionSubscriptionXd0282245> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineCheckoutSessionSubscriptionXd0282245,
        ) {
...
private fun inspectInlineCheckoutSessionSubscriptionXd0282245(
    element: JsonElement,
): InlineCheckoutSessionSubscriptionXd0282245Inspection {
