...
public class InlineV1CheckoutSessionsPostRequestFormCustomTextXeef1566c(
    public val afterSubmit: InlineV1CheckoutSessionsPostRequestFormCustomTextAfterSubmitX0bfe958b? = null,
    public val shippingAddress: InlineV1CheckoutSessionsPostRequestFormCustomTextShippingAddressXd69b1085? = null,
    public val submit: InlineV1CheckoutSessionsPostRequestFormCustomTextSubmitX5dd8d00f? = null,
    public val termsOfServiceAcceptance: InlineV1CheckoutSessionsPostRequestFormTermsOfServiceAcceptanceX1848181b? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1CheckoutSessionsPostRequestFormCustomTextXeef1566c =
            InlineV1CheckoutSessionsPostRequestFormCustomTextXeef1566c(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1CheckoutSessionsPostRequestFormCustomTextXeef1566c =
    ...
    public object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormCustomTextXeef1566c> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CheckoutSessionsPostRequestFormCustomTextXeef1566c must be a JSON object",
                    )
            return InlineV1CheckoutSessionsPostRequestFormCustomTextXeef1566c(
                afterSubmit =
                    rawObject["after_submit"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormCustomTextAfterSubmitX0bfe958b>(
                                it,
                            )
                    },
                shippingAddress =
                    rawObject["shipping_address"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormCustomTextShippingAddressXd69b1085>(
                                it,
                            )
                    },
                submit =
                    rawObject["submit"]?.let {
                        json.decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormCustomTextSubmitX5dd8d00f>(it)
                    },
                termsOfServiceAcceptance =
                    rawObject["terms_of_service_acceptance"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormTermsOfServiceAcceptanceX1848181b>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsPostRequestFormCustomTextXeef1566c,
        ) {
            ...
            val raw =
                buildJsonObject {
                    ...
                    value.termsOfServiceAcceptance?.let {
                        put(
...
public fun inlineV1CheckoutSessionsPostRequestFormCustomTextXeef1566c(
    block: InlineV1CheckoutSessionsPostRequestFormCustomTextXeef1566c.Builder.() -> Unit,
): InlineV1CheckoutSessionsPostRequestFormCustomTextXeef1566c =
    InlineV1CheckoutSessionsPostRequestFormCustomTextXeef1566c.build(block)
