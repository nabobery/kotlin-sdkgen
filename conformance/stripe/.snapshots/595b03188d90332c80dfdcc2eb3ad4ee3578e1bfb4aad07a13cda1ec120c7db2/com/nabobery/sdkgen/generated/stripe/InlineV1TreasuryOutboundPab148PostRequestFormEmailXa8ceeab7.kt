...
public class InlineV1TreasuryOutboundPab148PostRequestFormEmailXa8ceeab7 internal constructor(
    ...
    public val inlineV1TreasuryOutboundPab148PostRequestFormAnyOf2X5b8e7701:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1TreasuryOutboundPab148PostRequestFormAnyOf2X5b8e7701) {
                json
                    .decodeFromJsonElement<InlineV1TreasuryOutboundPab148PostRequestFormAnyOf2X5b8e7701>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1TreasuryOutboundPab148PostRequestFormEmailXa8ceeab7Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1TreasuryOutboundPab148PostRequestFormAnyOf2X5b8e7701) {
                    add(
                        InlineV1TreasuryOutboundPab148PostRequestFormEmailXa8ceeab7Branch.InlineV1TreasuryOutboundPab148PostRequestFormAnyOf2X5b8e7701,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1TreasuryOutboundPab148PostRequestFormEmailXa8ceeab7 {
            val inspection = inspectInlineV1TreasuryOutboundPab148PostRequestFormEmailXa8ceeab7(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1TreasuryOutboundPab148PostRequestFormEmailXa8ceeab7NoMatchException(
                    "InlineV1TreasuryOutboundPab148PostRequestFormEmailXa8ceeab7 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1TreasuryOutboundPab148PostRequestFormEmailXa8ceeab7> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TreasuryOutboundPab148PostRequestFormEmailXa8ceeab7,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1TreasuryOutboundPab148PostRequestFormEmailXa8ceeab7",
...
private fun inspectInlineV1TreasuryOutboundPab148PostRequestFormEmailXa8ceeab7(
    element: JsonElement,
): InlineV1TreasuryOutboundPab148PostRequestFormEmailXa8ceeab7Inspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1TreasuryOutboundPab148PostRequestFormAnyOf2X5b8e7701 =
        element
            .isJsonDecodable<InlineV1TreasuryOutboundPab148PostRequestFormAnyOf2X5b8e7701>()
    return InlineV1TreasuryOutboundPab148PostRequestFormEmailXa8ceeab7Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1TreasuryOutboundPab148PostRequestFormAnyOf2X5b8e7701) {
                    add(
                        "InlineV1TreasuryOutboundPab148PostRequestFormAnyOf2X5b8e7701: value does not match InlineV1TreasuryOutboundPab148PostRequestFormAnyOf2X5b8e7701",
                    )
                }
            },
    )
