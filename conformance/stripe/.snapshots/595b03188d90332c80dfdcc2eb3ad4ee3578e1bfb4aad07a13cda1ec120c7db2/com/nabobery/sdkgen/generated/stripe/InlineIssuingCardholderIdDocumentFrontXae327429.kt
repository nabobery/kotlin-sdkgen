...
public class InlineIssuingCardholderIdDocumentFrontXae327429 internal constructor(
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineIssuingCardholderIdDocumentFrontXae327429 {
            val inspection = inspectInlineIssuingCardholderIdDocumentFrontXae327429(raw)
            if (inspection.matchCount == 0) {
                throw InlineIssuingCardholderIdDocumentFrontXae327429NoMatchException(
                    "InlineIssuingCardholderIdDocumentFrontXae327429 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineIssuingCardholderIdDocumentFrontXae327429> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineIssuingCardholderIdDocumentFrontXae327429,
        ) {
...
private fun inspectInlineIssuingCardholderIdDocumentFrontXae327429(
    element: JsonElement,
): InlineIssuingCardholderIdDocumentFrontXae327429Inspection {
