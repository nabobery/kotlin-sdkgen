...
public class InlineV1SetupIntentsPostRequestFormX7fb2d04f(
     ...
     */
    public val excludedPaymentMethodTypes: InlineV1SetupIntentsPostRequestFormExcludedPaymentMethodTypesXda0cd1e3? = null,
    /**
     ...
     */
    public val flowDirections: List<InlineV1SetupIntentsPostRequestFormFlowDirectionsItemXff66ef5c>? = null,
    /**
     ...
     */
    public val paymentMethodData: InlineV1SetupIntentsPostRequestFormPaymentMethodDataX88650dc4? = null,
    /**
     * Payment method-specific configuration for this SetupIntent.
     */
    public val paymentMethodOptions: InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsXef95eb09? = null,
    /**
    ...
    public class Builder {
        ...
        public fun build(): InlineV1SetupIntentsPostRequestFormX7fb2d04f =
            InlineV1SetupIntentsPostRequestFormX7fb2d04f(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1SetupIntentsPostRequestFormX7fb2d04f =
    ...
    public object Serializer : KSerializer<InlineV1SetupIntentsPostRequestFormX7fb2d04f> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SetupIntentsPostRequestFormX7fb2d04f must be a JSON object",
                    )
            return InlineV1SetupIntentsPostRequestFormX7fb2d04f(
                ...
                excludedPaymentMethodTypes =
                    rawObject["excluded_payment_method_types"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormExcludedPaymentMethodTypesXda0cd1e3>(
                                it,
                            )
                    },
                ...
                flowDirections =
                    rawObject["flow_directions"]?.let {
                        json
                            .decodeFromJsonElement<List<InlineV1SetupIntentsPostRequestFormFlowDirectionsItemXff66ef5c>>(
                                it,
                            )
                    },
                metadata =
                    rawObject["metadata"]?.let {
                        json.decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormMetadataX0f37cb54>(it)
                    },
                ...
                paymentMethodData =
                    rawObject["payment_method_data"]?.let {
                        json.decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodDataX88650dc4>(it)
                    },
                paymentMethodOptions =
                    rawObject["payment_method_options"]?.let {
                        json.decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsXef95eb09>(it)
                    },
                paymentMethodTypes =
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SetupIntentsPostRequestFormX7fb2d04f,
        ) {
...
public fun inlineV1SetupIntentsPostRequestFormX7fb2d04f(
    block: InlineV1SetupIntentsPostRequestFormX7fb2d04f.Builder.() -> Unit,
): InlineV1SetupIntentsPostRequestFormX7fb2d04f = InlineV1SetupIntentsPostRequestFormX7fb2d04f.build(block)
