...
public sealed class InlineV1TestHelpersTreasuryReceivedCreditsPostRequestFormNetworkX26503d6c {
    ...
    public object Serializer : KSerializer<InlineV1TestHelpersTreasuryReceivedCreditsPostRequestFormNetworkX26503d6c> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1TestHelpersTreasuryReceivedCreditsPostRequestFormNetworkX26503d6c",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1TestHelpersTreasuryReceivedCreditsPostRequestFormNetworkX26503d6c = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TestHelpersTreasuryReceivedCreditsPostRequestFormNetworkX26503d6c,
        ) {
