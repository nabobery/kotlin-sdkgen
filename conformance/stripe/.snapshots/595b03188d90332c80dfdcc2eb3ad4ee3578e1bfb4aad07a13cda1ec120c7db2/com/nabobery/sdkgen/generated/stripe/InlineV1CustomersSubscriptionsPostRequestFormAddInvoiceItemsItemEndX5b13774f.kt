...
public class InlineV1CustomersSubscriptionsPostRequestFormAddInvoiceItemsItemEndX5b13774f(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1CustomersSubscriptionsPostRequestFormAddInvoiceItemsItemEndX5b13774f = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1CustomersSubscriptionsPostRequestFormAddInvoiceItemsItemEndX5b13774f> {
        override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1CustomersSubscriptionsPostRequestFormAddInvoiceItemsItemEndX5b13774f {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CustomersSubscriptionsPostRequestFormAddInvoiceItemsItemEndX5b13774f must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineV1CustomersSubscriptionsPostRequestFormAddInvoiceItemsItemTypeXca7026da>(
                    rawObject,
                    "type",
                )
            return InlineV1CustomersSubscriptionsPostRequestFormAddInvoiceItemsItemEndX5b13774f(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersSubscriptionsPostRequestFormAddInvoiceItemsItemEndX5b13774f,
        ) {
            val jsonEncoder =
...
public fun inlineV1CustomersSubscriptionsPostRequestFormAddInvoiceItemsItemEndX5b13774f(
    block: InlineV1CustomersSubscriptionsPostRequestFormAddInvoiceItemsItemEndX5b13774f.Builder.() -> Unit,
): InlineV1CustomersSubscriptionsPostRequestFormAddInvoiceItemsItemEndX5b13774f =
    InlineV1CustomersSubscriptionsPostRequestFormAddInvoiceItemsItemEndX5b13774f.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1CustomersSubscriptionsPostRequestFormAddInvoiceItemsItemEndX5b13774f is missing required property '" +
                    name +
                    "'",
            )
