...
public class InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsCardThreeDSecureXcb142d5f(
    public val aresTransStatus: InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsAresTransStatusX42e6a2a3? = null,
    public val cryptogram: String? = null,
    public val electronicCommerceIndicator: InlineV1SetupIntentsPostRequestFormElectronicCommerceIn67d5X84d8ec0f? = null,
    public val networkOptions: InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsNetworkOptionsX6cb4c02f? = null,
    public val requestorChallengeIndicator: String? = null,
    public val transactionId: String? = null,
    public val version: InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsCardVersionXf74100c7? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsCardThreeDSecureXcb142d5f =
            InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsCardThreeDSecureXcb142d5f(
    ...
    public object Serializer : KSerializer<InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsCardThreeDSecureXcb142d5f> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsCardThreeDSecureXcb142d5f must be a JSON object",
                    )
            return InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsCardThreeDSecureXcb142d5f(
                aresTransStatus =
                    rawObject["ares_trans_status"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsAresTransStatusX42e6a2a3>(
                                it,
                            )
                    },
                ...
                electronicCommerceIndicator =
                    rawObject["electronic_commerce_indicator"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormElectronicCommerceIn67d5X84d8ec0f>(
                                it,
                            )
                    },
                networkOptions =
                    rawObject["network_options"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsNetworkOptionsX6cb4c02f>(
                                it,
                            )
                    },
                ...
                version =
                    rawObject["version"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsCardVersionXf74100c7>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsCardThreeDSecureXcb142d5f,
        ) {
            val jsonEncoder =
...
public fun inlineV1SetupIntentsPostRequestFormPaymentMethodOptionsCardThreeDSecureXcb142d5f(
    block: InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsCardThreeDSecureXcb142d5f.Builder.() -> Unit,
): InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsCardThreeDSecureXcb142d5f =
