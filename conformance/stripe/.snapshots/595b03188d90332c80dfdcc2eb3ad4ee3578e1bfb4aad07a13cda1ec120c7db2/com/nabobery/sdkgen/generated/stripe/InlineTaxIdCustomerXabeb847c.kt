...
public class InlineTaxIdCustomerXabeb847c internal constructor(
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineTaxIdCustomerXabeb847c {
            val inspection = inspectInlineTaxIdCustomerXabeb847c(raw)
            if (inspection.matchCount == 0) {
                throw InlineTaxIdCustomerXabeb847cNoMatchException(
                    "InlineTaxIdCustomerXabeb847c matched 0 branches: " + inspection.failures.joinToString("; "),
                )
            }
    ...
    public object Serializer : KSerializer<InlineTaxIdCustomerXabeb847c> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineTaxIdCustomerXabeb847c,
        ) {
