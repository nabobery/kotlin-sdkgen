...
public class InlineV1PaymentIntentsConfirmPostRequestFormUsBankAccountX09ce459b(
    public val accountHolderType: InlineV1PaymentIntentsConfirmPostRequestFormAccountHolderTypeXb9b7a9a7? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1PaymentIntentsConfirmPostRequestFormUsBankAccountX09ce459b =
            InlineV1PaymentIntentsConfirmPostRequestFormUsBankAccountX09ce459b(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentIntentsConfirmPostRequestFormUsBankAccountX09ce459b = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentIntentsConfirmPostRequestFormUsBankAccountX09ce459b> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsConfirmPostRequestFormUsBankAccountX09ce459b must be a JSON object",
                    )
            return InlineV1PaymentIntentsConfirmPostRequestFormUsBankAccountX09ce459b(
                accountHolderType =
                    rawObject["account_holder_type"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormAccountHolderTypeXb9b7a9a7>(
                                it,
                            )
                    },
                ...
                accountType =
                    rawObject["account_type"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormAccountTypeX1284caba>(it)
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsConfirmPostRequestFormUsBankAccountX09ce459b,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentIntentsConfirmPostRequestFormUsBankAccountX09ce459b(
    block: InlineV1PaymentIntentsConfirmPostRequestFormUsBankAccountX09ce459b.Builder.() -> Unit,
): InlineV1PaymentIntentsConfirmPostRequestFormUsBankAccountX09ce459b =
    InlineV1PaymentIntentsConfirmPostRequestFormUsBankAccountX09ce459b.build(block)
