...
public class ReportingReportType(
     ...
     */
    public val defaultColumns: List<String>? = null,
) {
    public class Builder {
         ...
         * support the `columns` parameter, this will be null.)
         */
        public var defaultColumns: List<String>? = null
    ...
    public object Serializer : KSerializer<ReportingReportType> {
        ...
        override fun deserialize(decoder: Decoder): ReportingReportType {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("ReportingReportType must be a JSON object")
            ...
            return ReportingReportType(
                ...
                version = version,
                defaultColumns =
                    rawObject["default_columns"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
...
public fun reportingReportType(block: ReportingReportType.Builder.() -> Unit): ReportingReportType =
    ReportingReportType.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("ReportingReportType is missing required property '" + name + "'")
