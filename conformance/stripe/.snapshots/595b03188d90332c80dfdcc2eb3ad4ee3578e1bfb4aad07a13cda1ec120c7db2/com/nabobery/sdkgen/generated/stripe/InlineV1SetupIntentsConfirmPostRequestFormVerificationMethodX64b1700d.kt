...
public sealed class InlineV1SetupIntentsConfirmPostRequestFormVerificationMethodX64b1700d {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1SetupIntentsConfirmPostRequestFormVerificationMethodX64b1700d =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1SetupIntentsConfirmPostRequestFormVerificationMethodX64b1700d> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1SetupIntentsConfirmPostRequestFormVerificationMethodX64b1700d",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1SetupIntentsConfirmPostRequestFormVerificationMethodX64b1700d = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SetupIntentsConfirmPostRequestFormVerificationMethodX64b1700d,
        ) {
