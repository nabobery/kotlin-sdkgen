...
public class InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPixAnyOf1X99e36980(
    public val amountIncludesIof: InlineV1PaymentIntentsPostRequestFormAmountIncludesIofX80e97983? = null,
    public val expiresAfterSeconds: Int? = null,
    public val expiresAt: Int? = null,
    public val mandateOptions: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsMandateOptionsXd9a35f50? = null,
    public val setupFutureUsage: InlineV1PaymentIntentsPostRequestFormSetupFutureUsageX85a98d28? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPixAnyOf1X99e36980 =
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPixAnyOf1X99e36980 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPixAnyOf1X99e36980> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPixAnyOf1X99e36980 must be a JSON object",
                    )
            return InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPixAnyOf1X99e36980(
                amountIncludesIof =
                    rawObject["amount_includes_iof"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormAmountIncludesIofX80e97983>(it)
                    },
                expiresAfterSeconds =
                ...
                mandateOptions =
                    rawObject["mandate_options"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsMandateOptionsXd9a35f50>(
                                it,
                            )
                    },
                setupFutureUsage =
                    rawObject["setup_future_usage"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormSetupFutureUsageX85a98d28>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPixAnyOf1X99e36980,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPixAnyOf1X99e36980(
    block: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPixAnyOf1X99e36980.Builder.() -> Unit,
): InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPixAnyOf1X99e36980 =
    InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPixAnyOf1X99e36980.build(block)
