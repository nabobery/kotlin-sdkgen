...
public class InlineIssuingTransactionDisputeXddd279da internal constructor(
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineIssuingTransactionDisputeXddd279da {
            val inspection = inspectInlineIssuingTransactionDisputeXddd279da(raw)
            if (inspection.matchCount == 0) {
                throw InlineIssuingTransactionDisputeXddd279daNoMatchException(
                    "InlineIssuingTransactionDisputeXddd279da matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineIssuingTransactionDisputeXddd279da> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineIssuingTransactionDisputeXddd279da,
        ) {
...
private fun inspectInlineIssuingTransactionDisputeXddd279da(
    element: JsonElement,
): InlineIssuingTransactionDisputeXddd279daInspection {
