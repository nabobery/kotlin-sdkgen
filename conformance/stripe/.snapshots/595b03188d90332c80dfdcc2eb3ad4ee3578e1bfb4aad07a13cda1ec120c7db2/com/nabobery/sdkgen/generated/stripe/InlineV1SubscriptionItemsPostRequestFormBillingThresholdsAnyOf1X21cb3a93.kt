...
public class InlineV1SubscriptionItemsPostRequestFormBillingThresholdsAnyOf1X21cb3a93(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1SubscriptionItemsPostRequestFormBillingThresholdsAnyOf1X21cb3a93 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1SubscriptionItemsPostRequestFormBillingThresholdsAnyOf1X21cb3a93> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SubscriptionItemsPostRequestFormBillingThresholdsAnyOf1X21cb3a93 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionItemsPostRequestFormBillingThresholdsAnyOf1X21cb3a93,
        ) {
            val jsonEncoder =
...
public fun inlineV1SubscriptionItemsPostRequestFormBillingThresholdsAnyOf1X21cb3a93(
    block: InlineV1SubscriptionItemsPostRequestFormBillingThresholdsAnyOf1X21cb3a93.Builder.() -> Unit,
): InlineV1SubscriptionItemsPostRequestFormBillingThresholdsAnyOf1X21cb3a93 =
    InlineV1SubscriptionItemsPostRequestFormBillingThresholdsAnyOf1X21cb3a93.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1SubscriptionItemsPostRequestFormBillingThresholdsAnyOf1X21cb3a93 is missing required property '" +
                    name +
                    "'",
            )
