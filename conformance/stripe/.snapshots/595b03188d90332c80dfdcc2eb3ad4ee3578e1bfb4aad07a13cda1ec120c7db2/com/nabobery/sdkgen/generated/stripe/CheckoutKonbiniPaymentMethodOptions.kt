...
public class CheckoutKonbiniPaymentMethodOptions(
     ...
     */
    public val setupFutureUsage: InlineCheckoutKonbiniPaymentMethodOptionsSetupFutureUsageX8787c5f2? = null,
) {
    public class Builder {
        ...
        public fun build(): CheckoutKonbiniPaymentMethodOptions =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): CheckoutKonbiniPaymentMethodOptions =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<CheckoutKonbiniPaymentMethodOptions> {
        ...
        override fun deserialize(decoder: Decoder): CheckoutKonbiniPaymentMethodOptions {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("CheckoutKonbiniPaymentMethodOptions must be a JSON object")
            return CheckoutKonbiniPaymentMethodOptions(
                expiresAfterDays =
                    rawObject["expires_after_days"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                setupFutureUsage =
                    rawObject["setup_future_usage"]?.let {
                        json.decodeFromJsonElement<InlineCheckoutKonbiniPaymentMethodOptionsSetupFutureUsageX8787c5f2>(
                            it,
                        )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: CheckoutKonbiniPaymentMethodOptions,
        ) {
...
public fun checkoutKonbiniPaymentMethodOptions(
    block: CheckoutKonbiniPaymentMethodOptions.Builder.() -> Unit,
): CheckoutKonbiniPaymentMethodOptions = CheckoutKonbiniPaymentMethodOptions.build(block)
