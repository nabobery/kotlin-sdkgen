...
public sealed class InlineInvoicePaymentMethodOptionsPixAmountIncludesIofX23578152 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineInvoicePaymentMethodOptionsPixAmountIncludesIofX23578152 =
            when (value) {
                Always.value -> Always
                Never.value -> Never
    ...
    public object Serializer : KSerializer<InlineInvoicePaymentMethodOptionsPixAmountIncludesIofX23578152> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineInvoicePaymentMethodOptionsPixAmountIncludesIofX23578152",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineInvoicePaymentMethodOptionsPixAmountIncludesIofX23578152 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineInvoicePaymentMethodOptionsPixAmountIncludesIofX23578152,
        ) {
