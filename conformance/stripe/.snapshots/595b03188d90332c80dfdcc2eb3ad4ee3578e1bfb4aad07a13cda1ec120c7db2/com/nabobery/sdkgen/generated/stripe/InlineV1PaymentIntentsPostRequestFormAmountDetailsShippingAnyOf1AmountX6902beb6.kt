...
internal data class InlineV1PaymentIntentsPostRequestFormAmountDetailsShippingAnyOf1AmountX6902beb6Inspection(
    ...
    public val matchesInlineV1PaymentIntentsPostRequestFormAmountDetailsShippingAnyOf1AnyOf2X3588b884: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1PaymentIntentsPostRequestFormAmountDetailsShippingAnyOf1AnyOf2X3588b884,
            ).count {
                it
            }
}
...
public class InlineV1PaymentIntentsPostRequestFormAmountDetailsShippingAnyOf1AmountX6902beb6 internal constructor(
    ...
    private val inspection: InlineV1PaymentIntentsPostRequestFormAmountDetailsShippingAnyOf1AmountX6902beb6Inspection,
) {
    ...
    public val inlineV1PaymentIntentsPostRequestFormAmountDetailsShippingAnyOf1AnyOf2X3588b884:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1PaymentIntentsPostRequestFormAmountDetailsShippingAnyOf1AnyOf2X3588b884) {
                json
                    .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormAmountDetailsShippingAnyOf1AnyOf2X3588b884>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1PaymentIntentsPostRequestFormAmountDetailsShippingAnyOf1AmountX6902beb6Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1PaymentIntentsPostRequestFormAmountDetailsShippingAnyOf1AnyOf2X3588b884) {
                    add(
                        InlineV1PaymentIntentsPostRequestFormAmountDetailsShippingAnyOf1AmountX6902beb6Branch.InlineV1PaymentIntentsPostRequestFormAmountDetailsShippingAnyOf1AnyOf2X3588b884,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1PaymentIntentsPostRequestFormAmountDetailsShippingAnyOf1AmountX6902beb6 {
            val inspection = inspectInlineV1PaymentIntentsPostRequestFormAmountDetailsShippingAnyOf1AmountX6902beb6(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1PaymentIntentsPostRequestFormAmountDetailsShippingAnyOf1AmountX6902beb6NoMatchException(
                    "InlineV1PaymentIntentsPostRequestFormAmountDetailsShippingAnyOf1AmountX6902beb6 matched 0 branches: " +
                        inspection.failures.joinToString("; "),
                )
            }
            return InlineV1PaymentIntentsPostRequestFormAmountDetailsShippingAnyOf1AmountX6902beb6(
                raw,
                json,
                inspection,
            )
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormAmountDetailsShippingAnyOf1AmountX6902beb6> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormAmountDetailsShippingAnyOf1AmountX6902beb6,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1PaymentIntentsPostRequestFormAmountDetailsShippingAnyOf1AmountX6902beb6",
...
private fun inspectInlineV1PaymentIntentsPostRequestFormAmountDetailsShippingAnyOf1AmountX6902beb6(
    element: JsonElement,
): InlineV1PaymentIntentsPostRequestFormAmountDetailsShippingAnyOf1AmountX6902beb6Inspection {
    val matchesBranch1 = element.isJsonDecodable<Int>()
    val matchesInlineV1PaymentIntentsPostRequestFormAmountDetailsShippingAnyOf1AnyOf2X3588b884 =
        element
            .isJsonDecodable<InlineV1PaymentIntentsPostRequestFormAmountDetailsShippingAnyOf1AnyOf2X3588b884>()
    return InlineV1PaymentIntentsPostRequestFormAmountDetailsShippingAnyOf1AmountX6902beb6Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1PaymentIntentsPostRequestFormAmountDetailsShippingAnyOf1AnyOf2X3588b884) {
                    add(
                        "InlineV1PaymentIntentsPostRequestFormAmountDetailsShippingAnyOf1AnyOf2X3588b884: value does not match InlineV1PaymentIntentsPostRequestFormAmountDetailsShippingAnyOf1AnyOf2X3588b884",
                    )
                }
            },
    )
