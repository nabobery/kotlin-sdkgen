...
public class SubscriptionSchedulesResourceInvoiceItemPeriodResourcePeriodEnd(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): SubscriptionSchedulesResourceInvoiceItemPeriodResourcePeriodEnd =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<SubscriptionSchedulesResourceInvoiceItemPeriodResourcePeriodEnd> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "SubscriptionSchedulesResourceInvoiceItemPeriodResourcePeriodEnd must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: SubscriptionSchedulesResourceInvoiceItemPeriodResourcePeriodEnd,
        ) {
            val jsonEncoder =
...
public fun subscriptionSchedulesResourceInvoiceItemPeriodResourcePeriodEnd(
    block: SubscriptionSchedulesResourceInvoiceItemPeriodResourcePeriodEnd.Builder.() -> Unit,
): SubscriptionSchedulesResourceInvoiceItemPeriodResourcePeriodEnd =
    SubscriptionSchedulesResourceInvoiceItemPeriodResourcePeriodEnd.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "SubscriptionSchedulesResourceInvoiceItemPeriodResourcePeriodEnd is missing required property '" + name +
                    "'",
            )
