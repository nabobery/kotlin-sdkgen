...
internal data class InlineV1InvoicesPostRequestFormPaymentSettingsKonbiniX55ca6b41Inspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2X92d4ae2b,
            ).count { it }
}
...
public class InlineV1InvoicesPostRequestFormPaymentSettingsKonbiniX55ca6b41 internal constructor(
    ...
    public val inlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2X92d4ae2b:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2X92d4ae2b) {
                json
                    .decodeFromJsonElement<InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2X92d4ae2b>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1InvoicesPostRequestFormPaymentSettingsKonbiniX55ca6b41Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2X92d4ae2b) {
                    add(
                        InlineV1InvoicesPostRequestFormPaymentSettingsKonbiniX55ca6b41Branch.InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2X92d4ae2b,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1InvoicesPostRequestFormPaymentSettingsKonbiniX55ca6b41 {
            val inspection = inspectInlineV1InvoicesPostRequestFormPaymentSettingsKonbiniX55ca6b41(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1InvoicesPostRequestFormPaymentSettingsKonbiniX55ca6b41NoMatchException(
                    "InlineV1InvoicesPostRequestFormPaymentSettingsKonbiniX55ca6b41 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1InvoicesPostRequestFormPaymentSettingsKonbiniX55ca6b41> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesPostRequestFormPaymentSettingsKonbiniX55ca6b41,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1InvoicesPostRequestFormPaymentSettingsKonbiniX55ca6b41",
...
private fun inspectInlineV1InvoicesPostRequestFormPaymentSettingsKonbiniX55ca6b41(
    element: JsonElement,
): InlineV1InvoicesPostRequestFormPaymentSettingsKonbiniX55ca6b41Inspection {
    val matchesBranch1 = element.isJsonDecodable<JsonObject>()
    val matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2X92d4ae2b =
        element
            .isJsonDecodable<InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2X92d4ae2b>()
    return InlineV1InvoicesPostRequestFormPaymentSettingsKonbiniX55ca6b41Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2X92d4ae2b) {
                    add(
                        "InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2X92d4ae2b: value does not match InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2X92d4ae2b",
                    )
                }
            },
    )
