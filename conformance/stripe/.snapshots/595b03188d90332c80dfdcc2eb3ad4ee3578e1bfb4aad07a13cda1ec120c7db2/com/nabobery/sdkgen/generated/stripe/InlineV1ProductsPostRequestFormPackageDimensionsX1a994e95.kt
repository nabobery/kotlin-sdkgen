...
internal data class InlineV1ProductsPostRequestFormPackageDimensionsX1a994e95Inspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesInlineV1ProductsPostRequestFormPackageDimensionsAnyOf1Xf8bf69d9,
                matchesInlineV1ProductsPostRequestFormPackageDimensionsAnyOf2X0de52144,
            ).count {
                it
            }
}
...
public class InlineV1ProductsPostRequestFormPackageDimensionsX1a994e95 internal constructor(
    ...
    public val inlineV1ProductsPostRequestFormPackageDimensionsAnyOf1Xf8bf69d9:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1ProductsPostRequestFormPackageDimensionsAnyOf1Xf8bf69d9) {
                json
                    .decodeFromJsonElement<InlineV1ProductsPostRequestFormPackageDimensionsAnyOf1Xf8bf69d9>(
                        raw,
                    )
            } else {
                null
    ...
    public val inlineV1ProductsPostRequestFormPackageDimensionsAnyOf2X0de52144:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1ProductsPostRequestFormPackageDimensionsAnyOf2X0de52144) {
                json
                    .decodeFromJsonElement<InlineV1ProductsPostRequestFormPackageDimensionsAnyOf2X0de52144>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1ProductsPostRequestFormPackageDimensionsX1a994e95Branch>
        get() =
            buildSet {
                if (inspection.matchesInlineV1ProductsPostRequestFormPackageDimensionsAnyOf1Xf8bf69d9) {
                    add(
                        InlineV1ProductsPostRequestFormPackageDimensionsX1a994e95Branch.InlineV1ProductsPostRequestFormPackageDimensionsAnyOf1Xf8bf69d9,
                    )
                }
                if (inspection.matchesInlineV1ProductsPostRequestFormPackageDimensionsAnyOf2X0de52144) {
                    add(
                        InlineV1ProductsPostRequestFormPackageDimensionsX1a994e95Branch.InlineV1ProductsPostRequestFormPackageDimensionsAnyOf2X0de52144,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1ProductsPostRequestFormPackageDimensionsX1a994e95 {
            val inspection = inspectInlineV1ProductsPostRequestFormPackageDimensionsX1a994e95(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1ProductsPostRequestFormPackageDimensionsX1a994e95NoMatchException(
                    "InlineV1ProductsPostRequestFormPackageDimensionsX1a994e95 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1ProductsPostRequestFormPackageDimensionsX1a994e95> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ProductsPostRequestFormPackageDimensionsX1a994e95,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1ProductsPostRequestFormPackageDimensionsX1a994e95",
...
private fun inspectInlineV1ProductsPostRequestFormPackageDimensionsX1a994e95(
    element: JsonElement,
): InlineV1ProductsPostRequestFormPackageDimensionsX1a994e95Inspection {
    val matchesInlineV1ProductsPostRequestFormPackageDimensionsAnyOf1Xf8bf69d9 =
        element
            .isJsonDecodable<InlineV1ProductsPostRequestFormPackageDimensionsAnyOf1Xf8bf69d9>()
    val matchesInlineV1ProductsPostRequestFormPackageDimensionsAnyOf2X0de52144 =
        element
            .isJsonDecodable<InlineV1ProductsPostRequestFormPackageDimensionsAnyOf2X0de52144>()
    return InlineV1ProductsPostRequestFormPackageDimensionsX1a994e95Inspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1ProductsPostRequestFormPackageDimensionsAnyOf1Xf8bf69d9) {
                    add(
                        "InlineV1ProductsPostRequestFormPackageDimensionsAnyOf1Xf8bf69d9: value does not match InlineV1ProductsPostRequestFormPackageDimensionsAnyOf1Xf8bf69d9",
                    )
                }
                if (!matchesInlineV1ProductsPostRequestFormPackageDimensionsAnyOf2X0de52144) {
                    add(
                        "InlineV1ProductsPostRequestFormPackageDimensionsAnyOf2X0de52144: value does not match InlineV1ProductsPostRequestFormPackageDimensionsAnyOf2X0de52144",
                    )
                }
            },
    )
