...
public class InlineV1InvoicesPayPostRequestFormXa80f3da3(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1InvoicesPayPostRequestFormXa80f3da3 =
            InlineV1InvoicesPayPostRequestFormXa80f3da3(
                expand = expand,
                forgive = forgive,
                mandate = mandate,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1InvoicesPayPostRequestFormXa80f3da3 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1InvoicesPayPostRequestFormXa80f3da3> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1InvoicesPayPostRequestFormXa80f3da3 {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("InlineV1InvoicesPayPostRequestFormXa80f3da3 must be a JSON object")
            return InlineV1InvoicesPayPostRequestFormXa80f3da3(
                ...
                mandate =
                    rawObject["mandate"]?.let {
                        json.decodeFromJsonElement<InlineV1InvoicesPayPostRequestFormMandateXb092602a>(it)
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesPayPostRequestFormXa80f3da3,
        ) {
...
public fun inlineV1InvoicesPayPostRequestFormXa80f3da3(
    block: InlineV1InvoicesPayPostRequestFormXa80f3da3.Builder.() -> Unit,
): InlineV1InvoicesPayPostRequestFormXa80f3da3 = InlineV1InvoicesPayPostRequestFormXa80f3da3.build(block)
