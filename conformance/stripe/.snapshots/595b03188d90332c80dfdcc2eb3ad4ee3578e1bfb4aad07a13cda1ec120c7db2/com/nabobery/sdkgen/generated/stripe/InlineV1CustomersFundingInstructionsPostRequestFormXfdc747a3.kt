...
public class InlineV1CustomersFundingInstructionsPostRequestFormXfdc747a3(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1CustomersFundingInstructionsPostRequestFormXfdc747a3 =
    ...
    public object Serializer : KSerializer<InlineV1CustomersFundingInstructionsPostRequestFormXfdc747a3> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CustomersFundingInstructionsPostRequestFormXfdc747a3 must be a JSON object",
                    )
            val bankTransfer =
                json.decodeRequired<InlineV1CustomersFundingInstructionsPostRequestFormBankTransferXf6edde40>(
                    rawObject,
                    "bank_transfer",
                )
            val currency = json.decodeRequired<String>(rawObject, "currency")
            val fundingType =
                json.decodeRequired<InlineV1CustomersFundingInstructionsPostRequestFormFundingTypeXb2d2a487>(
                    rawObject,
                    "funding_type",
                )
            return InlineV1CustomersFundingInstructionsPostRequestFormXfdc747a3(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersFundingInstructionsPostRequestFormXfdc747a3,
        ) {
...
public fun inlineV1CustomersFundingInstructionsPostRequestFormXfdc747a3(
    block: InlineV1CustomersFundingInstructionsPostRequestFormXfdc747a3.Builder.() -> Unit,
): InlineV1CustomersFundingInstructionsPostRequestFormXfdc747a3 =
    InlineV1CustomersFundingInstructionsPostRequestFormXfdc747a3.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1CustomersFundingInstructionsPostRequestFormXfdc747a3 is missing required property '" + name +
                    "'",
            )
