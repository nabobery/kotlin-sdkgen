...
public class InlineV1SubscriptionSchedulesPostRequestFormPhasesItemX8e3ffe4e(
    ...
    public val addInvoiceItems: List<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemXd9f3d629>? = null,
    public val applicationFeePercent: Double? = null,
    public val automaticTax: InlineV1SubscriptionSchedulesPostRequestFormPhasesItemAutomaticTaxX34087348? = null,
    public val billingCycleAnchor: InlineV1SubscriptionSchedulesPostRequestFormPhasesBillingCycleAnchorXcf0fdea9? = null,
    public val billingThresholds:
        InlineV1SubscriptionSchedulesPostRequestFormPhasesItemBillingThresholdsX7ffe534a? = null,
    public val collectionMethod: InlineV1SubscriptionSchedulesPostRequestFormPhasesItemCollectionMethodX02b84968? = null,
    public val defaultPaymentMethod: String? = null,
    public val defaultTaxRates: InlineV1SubscriptionSchedulesPostRequestFormPhasesItemDefaultTaxRatesXe886c7c0? = null,
    public val description: InlineV1SubscriptionSchedulesPostRequestFormPhasesItemDescriptionXc48b234c? = null,
    public val discounts: InlineV1SubscriptionSchedulesPostRequestFormPhasesItemDiscountsX594a2a09? = null,
    public val duration: InlineV1SubscriptionSchedulesPostRequestFormPhasesItemDurationXd0942da4? = null,
    public val endDate: InlineV1SubscriptionSchedulesPostRequestFormPhasesItemEndDateXa02e08c4? = null,
    public val invoiceSettings: InlineV1SubscriptionSchedulesPostRequestFormPhasesItemInvoiceSettingsX2181c43e? = null,
    ...
    public val startDate: InlineV1SubscriptionSchedulesPostRequestFormPhasesItemStartDateX1bc3509e? = null,
    public val transferData: InlineV1SubscriptionSchedulesPostRequestFormPhasesItemTransferDataXe7b42f13? = null,
    public val trial: Boolean? = null,
    public val trialEnd: InlineV1SubscriptionSchedulesPostRequestFormPhasesItemTrialEndXcd12e5ca? = null,
) {
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1SubscriptionSchedulesPostRequestFormPhasesItemX8e3ffe4e =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemX8e3ffe4e> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1SubscriptionSchedulesPostRequestFormPhasesItemX8e3ffe4e {
            val jsonDecoder =
                decoder.requireJsonDecoder(
                    "InlineV1SubscriptionSchedulesPostRequestFormPhasesItemX8e3ffe4e",
                )
            val json = jsonDecoder.json
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SubscriptionSchedulesPostRequestFormPhasesItemX8e3ffe4e must be a JSON object",
                    )
            val items =
                json.decodeRequired<List<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemsItemXf5921ae2>>(
                    rawObject,
                    "items",
                )
            return InlineV1SubscriptionSchedulesPostRequestFormPhasesItemX8e3ffe4e(
                ...
                addInvoiceItems =
                    rawObject["add_invoice_items"]?.let {
                        json
                            .decodeFromJsonElement<List<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemXd9f3d629>>(
                                it,
                            )
                    },
                ...
                automaticTax =
                    rawObject["automatic_tax"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemAutomaticTaxX34087348>(
                                it,
                            )
                    },
                billingCycleAnchor =
                    rawObject["billing_cycle_anchor"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SubscriptionSchedulesPostRequestFormPhasesBillingCycleAnchorXcf0fdea9>(
                                it,
                            )
                    },
                billingThresholds =
                    rawObject["billing_thresholds"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemBillingThresholdsX7ffe534a>(
                                it,
                            )
                    },
                collectionMethod =
                    rawObject["collection_method"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemCollectionMethodX02b84968>(
                                it,
                            )
                    },
                ...
                defaultTaxRates =
                    rawObject["default_tax_rates"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemDefaultTaxRatesXe886c7c0>(
                                it,
                            )
                    },
                description =
                    rawObject["description"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemDescriptionXc48b234c>(
                                it,
                            )
                    },
                discounts =
                    rawObject["discounts"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemDiscountsX594a2a09>(
                                it,
                            )
                    },
                duration =
                    rawObject["duration"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemDurationXd0942da4>(
                                it,
                            )
                    },
                endDate =
                    rawObject["end_date"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemEndDateXa02e08c4>(
                                it,
                            )
                    },
                invoiceSettings =
                    rawObject["invoice_settings"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemInvoiceSettingsX2181c43e>(
                                it,
                            )
                    },
                metadata =
                ...
                prorationBehavior =
                    rawObject["proration_behavior"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemProrationBehaviorXa341370f>(
                                it,
                            )
                    },
                startDate =
                    rawObject["start_date"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemStartDateX1bc3509e>(
                                it,
                            )
                    },
                transferData =
                    rawObject["transfer_data"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemTransferDataXe7b42f13>(
                                it,
                            )
                    },
                ...
                trialEnd =
                    rawObject["trial_end"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemTrialEndXcd12e5ca>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionSchedulesPostRequestFormPhasesItemX8e3ffe4e,
        ) {
            val jsonEncoder =
...
public fun inlineV1SubscriptionSchedulesPostRequestFormPhasesItemX8e3ffe4e(
    block: InlineV1SubscriptionSchedulesPostRequestFormPhasesItemX8e3ffe4e.Builder.() -> Unit,
): InlineV1SubscriptionSchedulesPostRequestFormPhasesItemX8e3ffe4e =
    InlineV1SubscriptionSchedulesPostRequestFormPhasesItemX8e3ffe4e.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1SubscriptionSchedulesPostRequestFormPhasesItemX8e3ffe4e is missing required property '" + name +
                    "'",
            )
