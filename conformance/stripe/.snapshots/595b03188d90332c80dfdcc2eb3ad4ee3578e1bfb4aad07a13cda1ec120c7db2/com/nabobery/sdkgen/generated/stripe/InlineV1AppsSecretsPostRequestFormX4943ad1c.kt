...
public class InlineV1AppsSecretsPostRequestFormX4943ad1c(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1AppsSecretsPostRequestFormX4943ad1c =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1AppsSecretsPostRequestFormX4943ad1c> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1AppsSecretsPostRequestFormX4943ad1c {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("InlineV1AppsSecretsPostRequestFormX4943ad1c must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AppsSecretsPostRequestFormX4943ad1c,
        ) {
...
public fun inlineV1AppsSecretsPostRequestFormX4943ad1c(
    block: InlineV1AppsSecretsPostRequestFormX4943ad1c.Builder.() -> Unit,
): InlineV1AppsSecretsPostRequestFormX4943ad1c = InlineV1AppsSecretsPostRequestFormX4943ad1c.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1AppsSecretsPostRequestFormX4943ad1c is missing required property '" + name + "'",
            )
