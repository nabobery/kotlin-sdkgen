...
public class InlineV1InvoicesPostRequestFormX8121be00(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1InvoicesPostRequestFormX8121be00 =
            InlineV1InvoicesPostRequestFormX8121be00(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1InvoicesPostRequestFormX8121be00 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1InvoicesPostRequestFormX8121be00> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1InvoicesPostRequestFormX8121be00 {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("InlineV1InvoicesPostRequestFormX8121be00 must be a JSON object")
            return InlineV1InvoicesPostRequestFormX8121be00(
                accountTaxIds =
                    rawObject["account_tax_ids"]?.let {
                        json.decodeFromJsonElement<InlineV1InvoicesPostRequestFormAccountTaxIdsX217855ec>(it)
                    },
                ...
                automaticTax =
                    rawObject["automatic_tax"]?.let {
                        json.decodeFromJsonElement<InlineV1InvoicesPostRequestFormAutomaticTaxX3e4475da>(it)
                    },
                automaticallyFinalizesAt =
                    rawObject["automatically_finalizes_at"]?.let {
                        json
                            .decodeFromJsonElement<Int>(
                                it,
                            )
                    },
                collectionMethod =
                    rawObject["collection_method"]?.let {
                        json.decodeFromJsonElement<InlineV1InvoicesPostRequestFormCollectionMethodX8a25856c>(it)
                    },
                customFields =
                    rawObject["custom_fields"]?.let {
                        json.decodeFromJsonElement<InlineV1InvoicesPostRequestFormCustomFieldsXdbc056f3>(it)
                    },
                ...
                defaultSource =
                    rawObject["default_source"]?.let {
                        json.decodeFromJsonElement<InlineV1InvoicesPostRequestFormDefaultSourceX1d88b167>(it)
                    },
                defaultTaxRates =
                    rawObject["default_tax_rates"]?.let {
                        json.decodeFromJsonElement<InlineV1InvoicesPostRequestFormDefaultTaxRatesX322b90af>(it)
                    },
                description = rawObject["description"]?.let { json.decodeFromJsonElement<String>(it) },
                discounts =
                    rawObject["discounts"]?.let {
                        json.decodeFromJsonElement<InlineV1InvoicesPostRequestFormDiscountsX67d747e8>(it)
                    },
                dueDate = rawObject["due_date"]?.let { json.decodeFromJsonElement<Int>(it) },
                effectiveAt =
                    rawObject["effective_at"]?.let {
                        json.decodeFromJsonElement<InlineV1InvoicesPostRequestFormEffectiveAtX2b7c3a8a>(it)
                    },
                expand = rawObject["expand"]?.let { json.decodeFromJsonElement<List<String>>(it) },
                footer = rawObject["footer"]?.let { json.decodeFromJsonElement<String>(it) },
                issuer =
                    rawObject["issuer"]?.let {
                        json.decodeFromJsonElement<InlineV1InvoicesPostRequestFormIssuerX2300e4e9>(
                            it,
                        )
                    },
                metadata =
                    rawObject["metadata"]?.let {
                        json.decodeFromJsonElement<InlineV1InvoicesPostRequestFormMetadataX518c174b>(it)
                    },
                number =
                    rawObject["number"]?.let {
                        json.decodeFromJsonElement<InlineV1InvoicesPostRequestFormNumberXbadb140d>(
                            it,
                        )
                    },
                onBehalfOf =
                    rawObject["on_behalf_of"]?.let {
                        json.decodeFromJsonElement<InlineV1InvoicesPostRequestFormOnBehalfOfX1772b039>(it)
                    },
                paymentSettings =
                    rawObject["payment_settings"]?.let {
                        json.decodeFromJsonElement<InlineV1InvoicesPostRequestFormPaymentSettingsX16586dde>(it)
                    },
                rendering =
                    rawObject["rendering"]?.let {
                        json.decodeFromJsonElement<InlineV1InvoicesPostRequestFormRenderingXf3022a61>(it)
                    },
                shippingCost =
                    rawObject["shipping_cost"]?.let {
                        json.decodeFromJsonElement<InlineV1InvoicesPostRequestFormShippingCostX10650005>(it)
                    },
                shippingDetails =
                    rawObject["shipping_details"]?.let {
                        json.decodeFromJsonElement<InlineV1InvoicesPostRequestFormShippingDetailsX130e758a>(it)
                    },
                statementDescriptor =
                ...
                transferData =
                    rawObject["transfer_data"]?.let {
                        json.decodeFromJsonElement<InlineV1InvoicesPostRequestFormTransferDataXbe331fcc>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesPostRequestFormX8121be00,
        ) {
...
public fun inlineV1InvoicesPostRequestFormX8121be00(
    block: InlineV1InvoicesPostRequestFormX8121be00.Builder.() -> Unit,
): InlineV1InvoicesPostRequestFormX8121be00 = InlineV1InvoicesPostRequestFormX8121be00.build(block)
