...
public sealed class InlineV1TreasuryFinancialAccountsGetResponse200JsonObjectValueXb1064f3f {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1TreasuryFinancialAccountsGetResponse200JsonObjectValueXb1064f3f =
            when (value) {
                List.value -> List
    ...
    public object Serializer : KSerializer<InlineV1TreasuryFinancialAccountsGetResponse200JsonObjectValueXb1064f3f> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1TreasuryFinancialAccountsGetResponse200JsonObjectValueXb1064f3f",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1TreasuryFinancialAccountsGetResponse200JsonObjectValueXb1064f3f = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TreasuryFinancialAccountsGetResponse200JsonObjectValueXb1064f3f,
        ) {
