...
public class InlineBillingCreditGrantsResourceBalanceCreditsAppliedInvoiceXb0d637e5 internal constructor(
    ...
    private val inspection: InlineBillingCreditGrantsResourceBalanceCreditsAppliedInvoiceXb0d637e5Inspection,
) {
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineBillingCreditGrantsResourceBalanceCreditsAppliedInvoiceXb0d637e5Branch.Branch1,
                    )
                }
                if (inspection.matchesInvoice) {
                    add(
                        InlineBillingCreditGrantsResourceBalanceCreditsAppliedInvoiceXb0d637e5Branch.Invoice,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineBillingCreditGrantsResourceBalanceCreditsAppliedInvoiceXb0d637e5 {
            val inspection = inspectInlineBillingCreditGrantsResourceBalanceCreditsAppliedInvoiceXb0d637e5(raw)
            if (inspection.matchCount == 0) {
                throw InlineBillingCreditGrantsResourceBalanceCreditsAppliedInvoiceXb0d637e5NoMatchException(
                    "InlineBillingCreditGrantsResourceBalanceCreditsAppliedInvoiceXb0d637e5 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineBillingCreditGrantsResourceBalanceCreditsAppliedInvoiceXb0d637e5> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineBillingCreditGrantsResourceBalanceCreditsAppliedInvoiceXb0d637e5,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineBillingCreditGrantsResourceBalanceCreditsAppliedInvoiceXb0d637e5",
...
private fun inspectInlineBillingCreditGrantsResourceBalanceCreditsAppliedInvoiceXb0d637e5(
    element: JsonElement,
