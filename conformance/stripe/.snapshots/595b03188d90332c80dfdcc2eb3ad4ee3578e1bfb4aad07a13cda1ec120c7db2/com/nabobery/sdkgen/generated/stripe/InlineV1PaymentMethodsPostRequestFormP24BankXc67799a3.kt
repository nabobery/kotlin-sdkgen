...
public sealed class InlineV1PaymentMethodsPostRequestFormP24BankXc67799a3 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1PaymentMethodsPostRequestFormP24BankXc67799a3 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1PaymentMethodsPostRequestFormP24BankXc67799a3> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1PaymentMethodsPostRequestFormP24BankXc67799a3",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1PaymentMethodsPostRequestFormP24BankXc67799a3 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentMethodsPostRequestFormP24BankXc67799a3,
        ) {
