...
public class InlineV1CheckoutSessionsPostRequestFormPaymentMethodDataX3301b232(
    public val allowRedisplay: InlineV1CheckoutSessionsPostRequestFormPaymentMethodDataAllowRedisplayX5139e16f? = null,
) {
    public class Builder {
        public var allowRedisplay:
            InlineV1CheckoutSessionsPostRequestFormPaymentMethodDataAllowRedisplayX5139e16f? = null

        public fun build(): InlineV1CheckoutSessionsPostRequestFormPaymentMethodDataX3301b232 =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1CheckoutSessionsPostRequestFormPaymentMethodDataX3301b232 =
    ...
    public object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormPaymentMethodDataX3301b232> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CheckoutSessionsPostRequestFormPaymentMethodDataX3301b232 must be a JSON object",
                    )
            return InlineV1CheckoutSessionsPostRequestFormPaymentMethodDataX3301b232(
                allowRedisplay =
                    rawObject["allow_redisplay"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormPaymentMethodDataAllowRedisplayX5139e16f>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsPostRequestFormPaymentMethodDataX3301b232,
        ) {
            val jsonEncoder =
...
public fun inlineV1CheckoutSessionsPostRequestFormPaymentMethodDataX3301b232(
    block: InlineV1CheckoutSessionsPostRequestFormPaymentMethodDataX3301b232.Builder.() -> Unit,
): InlineV1CheckoutSessionsPostRequestFormPaymentMethodDataX3301b232 =
    InlineV1CheckoutSessionsPostRequestFormPaymentMethodDataX3301b232.build(block)
