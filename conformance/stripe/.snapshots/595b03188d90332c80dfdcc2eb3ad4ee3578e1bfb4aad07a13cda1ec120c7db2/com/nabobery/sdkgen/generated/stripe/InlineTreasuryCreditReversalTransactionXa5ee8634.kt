...
public class InlineTreasuryCreditReversalTransactionXa5ee8634 internal constructor(
        ...
        get() =
            buildSet {
                ...
                if (inspection.matchesTreasuryTransaction) {
                    add(
                        InlineTreasuryCreditReversalTransactionXa5ee8634Branch.TreasuryTransaction,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineTreasuryCreditReversalTransactionXa5ee8634 {
            val inspection = inspectInlineTreasuryCreditReversalTransactionXa5ee8634(raw)
            if (inspection.matchCount == 0) {
                throw InlineTreasuryCreditReversalTransactionXa5ee8634NoMatchException(
                    "InlineTreasuryCreditReversalTransactionXa5ee8634 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineTreasuryCreditReversalTransactionXa5ee8634> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineTreasuryCreditReversalTransactionXa5ee8634,
        ) {
...
private fun inspectInlineTreasuryCreditReversalTransactionXa5ee8634(
    element: JsonElement,
): InlineTreasuryCreditReversalTransactionXa5ee8634Inspection {
