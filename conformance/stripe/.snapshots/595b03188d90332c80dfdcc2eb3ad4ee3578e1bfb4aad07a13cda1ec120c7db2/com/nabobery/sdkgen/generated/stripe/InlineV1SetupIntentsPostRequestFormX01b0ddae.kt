...
public class InlineV1SetupIntentsPostRequestFormX01b0ddae(
     ...
     */
    public val automaticPaymentMethods: InlineV1SetupIntentsPostRequestFormAutomaticPaymentMethodsX305652f7? = null,
    /**
     ...
     */
    public val flowDirections: List<InlineV1SetupIntentsPostRequestFormFlowDirectionsItemXc9a9a21e>? = null,
    /**
     ...
     */
    public val paymentMethodData: InlineV1SetupIntentsPostRequestFormPaymentMethodDataX076e36a5? = null,
    /**
     * Payment method-specific configuration for this SetupIntent.
     */
    public val paymentMethodOptions: InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsX23c51a27? = null,
    /**
    ...
    public class Builder {
        ...
        public fun build(): InlineV1SetupIntentsPostRequestFormX01b0ddae =
            InlineV1SetupIntentsPostRequestFormX01b0ddae(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1SetupIntentsPostRequestFormX01b0ddae =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1SetupIntentsPostRequestFormX01b0ddae> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SetupIntentsPostRequestFormX01b0ddae must be a JSON object",
                    )
            return InlineV1SetupIntentsPostRequestFormX01b0ddae(
                ...
                automaticPaymentMethods =
                    rawObject["automatic_payment_methods"]?.let {
                        json.decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormAutomaticPaymentMethodsX305652f7>(
                            it,
                        )
                    },
                ...
                excludedPaymentMethodTypes =
                    rawObject["excluded_payment_method_types"]?.let {
                        json
                            .decodeFromJsonElement<List<InlineV1SetupIntentsPostRequestFormExcludedPaymentMethodTypesItemX8f0651f5>>(
                                it,
                            )
                    },
                expand = rawObject["expand"]?.let { json.decodeFromJsonElement<List<String>>(it) },
                flowDirections =
                    rawObject["flow_directions"]?.let {
                        json
                            .decodeFromJsonElement<List<InlineV1SetupIntentsPostRequestFormFlowDirectionsItemXc9a9a21e>>(
                                it,
                            )
                    },
                mandateData =
                    rawObject["mandate_data"]?.let {
                        json.decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormMandateDataXcb5ac5a1>(it)
                    },
                ...
                paymentMethodData =
                    rawObject["payment_method_data"]?.let {
                        json.decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodDataX076e36a5>(it)
                    },
                paymentMethodOptions =
                    rawObject["payment_method_options"]?.let {
                        json.decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsX23c51a27>(it)
                    },
                paymentMethodTypes =
                ...
                singleUse =
                    rawObject["single_use"]?.let {
                        json.decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormSingleUseX4e6759b9>(it)
                    },
                usage =
                    rawObject["usage"]?.let {
                        json.decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormUsageX4eb54f8c>(
                            it,
                        )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SetupIntentsPostRequestFormX01b0ddae,
        ) {
...
public fun inlineV1SetupIntentsPostRequestFormX01b0ddae(
    block: InlineV1SetupIntentsPostRequestFormX01b0ddae.Builder.() -> Unit,
): InlineV1SetupIntentsPostRequestFormX01b0ddae = InlineV1SetupIntentsPostRequestFormX01b0ddae.build(block)
