...
public class ConnectEmbeddedInstantPayoutsPromotionFeatures(
    ...
    public class Builder {
        ...
        public var disableStripeUserAuthentication: Boolean
            get() =
                requireNotNull(
                    disableStripeUserAuthenticationValue,
                ) { "disableStripeUserAuthentication is required" }
            set(`value`) {
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): ConnectEmbeddedInstantPayoutsPromotionFeatures =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<ConnectEmbeddedInstantPayoutsPromotionFeatures> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "ConnectEmbeddedInstantPayoutsPromotionFeatures must be a JSON object",
                    )
            val disableStripeUserAuthentication =
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: ConnectEmbeddedInstantPayoutsPromotionFeatures,
        ) {
            ...
            val raw =
                buildJsonObject {
                    put(
                        "disable_stripe_user_authentication",
                        json.encodeToJsonElement(value.disableStripeUserAuthentication),
                    )
...
public fun connectEmbeddedInstantPayoutsPromotionFeatures(
    block: ConnectEmbeddedInstantPayoutsPromotionFeatures.Builder.() -> Unit,
): ConnectEmbeddedInstantPayoutsPromotionFeatures = ConnectEmbeddedInstantPayoutsPromotionFeatures.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "ConnectEmbeddedInstantPayoutsPromotionFeatures is missing required property '" + name + "'",
            )
