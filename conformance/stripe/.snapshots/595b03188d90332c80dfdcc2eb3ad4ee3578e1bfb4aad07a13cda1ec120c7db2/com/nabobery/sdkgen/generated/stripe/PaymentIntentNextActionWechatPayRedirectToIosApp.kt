...
public class PaymentIntentNextActionWechatPayRedirectToIosApp(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentIntentNextActionWechatPayRedirectToIosApp =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentIntentNextActionWechatPayRedirectToIosApp> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "PaymentIntentNextActionWechatPayRedirectToIosApp must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentIntentNextActionWechatPayRedirectToIosApp,
        ) {
...
public fun paymentIntentNextActionWechatPayRedirectToIosApp(
    block: PaymentIntentNextActionWechatPayRedirectToIosApp.Builder.() -> Unit,
): PaymentIntentNextActionWechatPayRedirectToIosApp = PaymentIntentNextActionWechatPayRedirectToIosApp.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "PaymentIntentNextActionWechatPayRedirectToIosApp is missing required property '" + name + "'",
            )
