...
public sealed class InlineSubscriptionsResourcePauseCollectionBehaviorX60bc805d {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineSubscriptionsResourcePauseCollectionBehaviorX60bc805d =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineSubscriptionsResourcePauseCollectionBehaviorX60bc805d> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineSubscriptionsResourcePauseCollectionBehaviorX60bc805d",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineSubscriptionsResourcePauseCollectionBehaviorX60bc805d =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineSubscriptionsResourcePauseCollectionBehaviorX60bc805d,
        ) {
