...
public class InlineV1TaxCalculationsPostRequestFormX0a91eb27(
     ...
     */
    public val customerDetails: InlineV1TaxCalculationsPostRequestFormCustomerDetailsXb18941af? = null,
    /**
     ...
     */
    public val shipFromDetails: InlineV1TaxCalculationsPostRequestFormShipFromDetailsX9aca7f91? = null,
    /**
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TaxCalculationsPostRequestFormX0a91eb27 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TaxCalculationsPostRequestFormX0a91eb27> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TaxCalculationsPostRequestFormX0a91eb27 must be a JSON object",
                    )
            val currency = json.decodeRequired<String>(rawObject, "currency")
            val lineItems =
                json.decodeRequired<List<InlineV1TaxCalculationsPostRequestFormLineItemsItemXb2c24cce>>(
                    rawObject,
                    "line_items",
                )
            return InlineV1TaxCalculationsPostRequestFormX0a91eb27(
                ...
                customerDetails =
                    rawObject["customer_details"]?.let {
                        json.decodeFromJsonElement<InlineV1TaxCalculationsPostRequestFormCustomerDetailsXb18941af>(it)
                    },
                expand = rawObject["expand"]?.let { json.decodeFromJsonElement<List<String>>(it) },
                shipFromDetails =
                    rawObject["ship_from_details"]?.let {
                        json.decodeFromJsonElement<InlineV1TaxCalculationsPostRequestFormShipFromDetailsX9aca7f91>(it)
                    },
                shippingCost =
                    rawObject["shipping_cost"]?.let {
                        json.decodeFromJsonElement<InlineV1TaxCalculationsPostRequestFormShippingCostXca28ce41>(it)
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TaxCalculationsPostRequestFormX0a91eb27,
        ) {
...
public fun inlineV1TaxCalculationsPostRequestFormX0a91eb27(
    block: InlineV1TaxCalculationsPostRequestFormX0a91eb27.Builder.() -> Unit,
): InlineV1TaxCalculationsPostRequestFormX0a91eb27 = InlineV1TaxCalculationsPostRequestFormX0a91eb27.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TaxCalculationsPostRequestFormX0a91eb27 is missing required property '" + name + "'",
            )
