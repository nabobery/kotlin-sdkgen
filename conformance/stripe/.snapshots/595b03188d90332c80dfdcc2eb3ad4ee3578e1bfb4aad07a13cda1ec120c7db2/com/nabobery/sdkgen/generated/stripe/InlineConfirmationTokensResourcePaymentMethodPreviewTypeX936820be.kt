...
public sealed class InlineConfirmationTokensResourcePaymentMethodPreviewTypeX936820be {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineConfirmationTokensResourcePaymentMethodPreviewTypeX936820be =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineConfirmationTokensResourcePaymentMethodPreviewTypeX936820be> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineConfirmationTokensResourcePaymentMethodPreviewTypeX936820be",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineConfirmationTokensResourcePaymentMethodPreviewTypeX936820be =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineConfirmationTokensResourcePaymentMethodPreviewTypeX936820be,
        ) {
