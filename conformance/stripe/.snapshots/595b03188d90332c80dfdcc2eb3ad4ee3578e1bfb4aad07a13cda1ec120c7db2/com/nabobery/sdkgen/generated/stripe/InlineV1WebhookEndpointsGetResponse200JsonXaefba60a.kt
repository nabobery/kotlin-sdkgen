...
public class InlineV1WebhookEndpointsGetResponse200JsonXaefba60a(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1WebhookEndpointsGetResponse200JsonXaefba60a =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1WebhookEndpointsGetResponse200JsonXaefba60a> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1WebhookEndpointsGetResponse200JsonXaefba60a {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1WebhookEndpointsGetResponse200JsonXaefba60a must be a JSON object",
                    )
            ...
            val objectValue =
                json.decodeRequired<InlineV1WebhookEndpointsGetResponse200JsonObjectValueX7a2fd96c>(
                    rawObject,
                    "object",
                )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1WebhookEndpointsGetResponse200JsonXaefba60a,
        ) {
...
public fun inlineV1WebhookEndpointsGetResponse200JsonXaefba60a(
    block: InlineV1WebhookEndpointsGetResponse200JsonXaefba60a.Builder.() -> Unit,
): InlineV1WebhookEndpointsGetResponse200JsonXaefba60a =
    InlineV1WebhookEndpointsGetResponse200JsonXaefba60a.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1WebhookEndpointsGetResponse200JsonXaefba60a is missing required property '" + name + "'",
            )
