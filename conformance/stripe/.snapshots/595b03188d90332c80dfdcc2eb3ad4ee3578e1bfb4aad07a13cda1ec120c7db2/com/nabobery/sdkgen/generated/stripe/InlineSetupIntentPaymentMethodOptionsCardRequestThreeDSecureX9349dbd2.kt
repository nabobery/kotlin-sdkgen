...
public sealed class InlineSetupIntentPaymentMethodOptionsCardRequestThreeDSecureX9349dbd2 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineSetupIntentPaymentMethodOptionsCardRequestThreeDSecureX9349dbd2 =
            when (value) {
                Any.value -> Any
    ...
    public object Serializer : KSerializer<InlineSetupIntentPaymentMethodOptionsCardRequestThreeDSecureX9349dbd2> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineSetupIntentPaymentMethodOptionsCardRequestThreeDSecureX9349dbd2",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineSetupIntentPaymentMethodOptionsCardRequestThreeDSecureX9349dbd2 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineSetupIntentPaymentMethodOptionsCardRequestThreeDSecureX9349dbd2,
        ) {
