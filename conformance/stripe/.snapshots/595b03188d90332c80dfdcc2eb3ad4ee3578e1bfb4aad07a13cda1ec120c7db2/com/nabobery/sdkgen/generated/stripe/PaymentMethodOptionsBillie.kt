...
public class PaymentMethodOptionsBillie(
    ...
    public class Builder {
        ...
        public fun build(): PaymentMethodOptionsBillie =
    ...
    public object Serializer : KSerializer<PaymentMethodOptionsBillie> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodOptionsBillie {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodOptionsBillie must be a JSON object")
            return PaymentMethodOptionsBillie(
                captureMethod =
                    rawObject["capture_method"]?.let {
                        json.decodeFromJsonElement<InlinePaymentMethodOptionsBillieCaptureMethodX4f9e40c6>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentMethodOptionsBillie,
        ) {
...
public fun paymentMethodOptionsBillie(
    block: PaymentMethodOptionsBillie.Builder.() -> Unit,
): PaymentMethodOptionsBillie = PaymentMethodOptionsBillie.build(block)
