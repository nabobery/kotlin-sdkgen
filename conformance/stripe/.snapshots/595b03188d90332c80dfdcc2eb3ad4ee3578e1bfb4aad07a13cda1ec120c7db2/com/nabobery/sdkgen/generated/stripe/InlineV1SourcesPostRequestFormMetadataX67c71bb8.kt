...
public class InlineV1SourcesPostRequestFormMetadataX67c71bb8 internal constructor(
    ...
    public val inlineV1SourcesPostRequestFormMetadataAnyOf2X7f5863e9:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1SourcesPostRequestFormMetadataAnyOf2X7f5863e9) {
                json
                    .decodeFromJsonElement<InlineV1SourcesPostRequestFormMetadataAnyOf2X7f5863e9>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1SourcesPostRequestFormMetadataX67c71bb8Branch>
        get() =
            buildSet {
                ...
                if (inspection.matchesInlineV1SourcesPostRequestFormMetadataAnyOf2X7f5863e9) {
                    add(
                        InlineV1SourcesPostRequestFormMetadataX67c71bb8Branch.InlineV1SourcesPostRequestFormMetadataAnyOf2X7f5863e9,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1SourcesPostRequestFormMetadataX67c71bb8 {
            val inspection = inspectInlineV1SourcesPostRequestFormMetadataX67c71bb8(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1SourcesPostRequestFormMetadataX67c71bb8NoMatchException(
                    "InlineV1SourcesPostRequestFormMetadataX67c71bb8 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1SourcesPostRequestFormMetadataX67c71bb8> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SourcesPostRequestFormMetadataX67c71bb8,
        ) {
...
private fun inspectInlineV1SourcesPostRequestFormMetadataX67c71bb8(
    element: JsonElement,
): InlineV1SourcesPostRequestFormMetadataX67c71bb8Inspection {
    val matchesBranch1 = element.isJsonDecodable<JsonObject>()
    val matchesInlineV1SourcesPostRequestFormMetadataAnyOf2X7f5863e9 =
        element
            .isJsonDecodable<InlineV1SourcesPostRequestFormMetadataAnyOf2X7f5863e9>()
    return InlineV1SourcesPostRequestFormMetadataX67c71bb8Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1SourcesPostRequestFormMetadataAnyOf2X7f5863e9) {
                    add(
                        "InlineV1SourcesPostRequestFormMetadataAnyOf2X7f5863e9: value does not match InlineV1SourcesPostRequestFormMetadataAnyOf2X7f5863e9",
                    )
                }
            },
    )
