...
public class BillingMeterResourceCustomerMappingSettings(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): BillingMeterResourceCustomerMappingSettings =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<BillingMeterResourceCustomerMappingSettings> {
        ...
        override fun deserialize(decoder: Decoder): BillingMeterResourceCustomerMappingSettings {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("BillingMeterResourceCustomerMappingSettings must be a JSON object")
            val eventPayloadKey = json.decodeRequired<String>(rawObject, "event_payload_key")
            val type =
                json.decodeRequired<InlineBillingMeterResourceCustomerMappingSettingsTypeX23cc2b38>(
                    rawObject,
                    "type",
                )
            return BillingMeterResourceCustomerMappingSettings(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: BillingMeterResourceCustomerMappingSettings,
        ) {
...
public fun billingMeterResourceCustomerMappingSettings(
    block: BillingMeterResourceCustomerMappingSettings.Builder.() -> Unit,
): BillingMeterResourceCustomerMappingSettings = BillingMeterResourceCustomerMappingSettings.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "BillingMeterResourceCustomerMappingSettings is missing required property '" + name + "'",
            )
