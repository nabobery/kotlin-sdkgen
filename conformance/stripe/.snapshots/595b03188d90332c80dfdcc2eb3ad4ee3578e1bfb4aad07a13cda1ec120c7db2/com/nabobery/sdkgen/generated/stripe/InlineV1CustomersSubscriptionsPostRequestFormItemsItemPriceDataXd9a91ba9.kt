...
public class InlineV1CustomersSubscriptionsPostRequestFormItemsItemPriceDataXd9a91ba9(
    ...
    public val taxBehavior: InlineV1CustomersSubscriptionsPostRequestFormItemsItemTaxBehaviorXc12102ec? = null,
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1CustomersSubscriptionsPostRequestFormItemsItemPriceDataXd9a91ba9 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1CustomersSubscriptionsPostRequestFormItemsItemPriceDataXd9a91ba9> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CustomersSubscriptionsPostRequestFormItemsItemPriceDataXd9a91ba9 must be a JSON object",
                    )
            val currency = json.decodeRequired<String>(rawObject, "currency")
            val product = json.decodeRequired<String>(rawObject, "product")
            val recurring =
                json.decodeRequired<InlineV1CustomersSubscriptionsPostRequestFormItemsItemRecurringX400ceab9>(
                    rawObject,
                    "recurring",
                )
            return InlineV1CustomersSubscriptionsPostRequestFormItemsItemPriceDataXd9a91ba9(
                ...
                taxBehavior =
                    rawObject["tax_behavior"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CustomersSubscriptionsPostRequestFormItemsItemTaxBehaviorXc12102ec>(
                                it,
                            )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersSubscriptionsPostRequestFormItemsItemPriceDataXd9a91ba9,
        ) {
            val jsonEncoder =
...
public fun inlineV1CustomersSubscriptionsPostRequestFormItemsItemPriceDataXd9a91ba9(
    block: InlineV1CustomersSubscriptionsPostRequestFormItemsItemPriceDataXd9a91ba9.Builder.() -> Unit,
): InlineV1CustomersSubscriptionsPostRequestFormItemsItemPriceDataXd9a91ba9 =
    InlineV1CustomersSubscriptionsPostRequestFormItemsItemPriceDataXd9a91ba9.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1CustomersSubscriptionsPostRequestFormItemsItemPriceDataXd9a91ba9 is missing required property '" +
                    name +
                    "'",
            )
