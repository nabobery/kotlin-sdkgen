...
public class InlineSubscriptionDefaultPaymentMethodX14c25b83 internal constructor(
        ...
        get() =
            buildSet {
                ...
                if (inspection.matchesPaymentMethod) {
                    add(
                        InlineSubscriptionDefaultPaymentMethodX14c25b83Branch.PaymentMethod,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineSubscriptionDefaultPaymentMethodX14c25b83 {
            val inspection = inspectInlineSubscriptionDefaultPaymentMethodX14c25b83(raw)
            if (inspection.matchCount == 0) {
                throw InlineSubscriptionDefaultPaymentMethodX14c25b83NoMatchException(
                    "InlineSubscriptionDefaultPaymentMethodX14c25b83 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineSubscriptionDefaultPaymentMethodX14c25b83> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineSubscriptionDefaultPaymentMethodX14c25b83,
        ) {
...
private fun inspectInlineSubscriptionDefaultPaymentMethodX14c25b83(
    element: JsonElement,
): InlineSubscriptionDefaultPaymentMethodX14c25b83Inspection {
