...
public class InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKlarnaItemXe0bb0450(
    public val interval: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKlarnaIntervalX52f30be5,
    public val reference: String,
    public val intervalCount: Int? = null,
    public val name: String? = null,
    public val nextBilling: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsNextBillingXde086aa6? = null,
) {
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKlarnaItemXe0bb0450 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKlarnaItemXe0bb0450> {
        ...
        override fun deserialize(
            decoder: Decoder,
        ): InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKlarnaItemXe0bb0450 {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKlarnaItemXe0bb0450 must be a JSON object",
                    )
            val interval =
                json
                    .decodeRequired<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKlarnaIntervalX52f30be5>(
                        rawObject,
                        "interval",
                    )
            ...
            return InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKlarnaItemXe0bb0450(
                ...
                nextBilling =
                    rawObject["next_billing"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsNextBillingXde086aa6>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKlarnaItemXe0bb0450,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKlarnaItemXe0bb0450(
    block: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKlarnaItemXe0bb0450.Builder.() -> Unit,
): InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKlarnaItemXe0bb0450 =
    InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKlarnaItemXe0bb0450.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKlarnaItemXe0bb0450 is missing required property '" +
                    name +
                    "'",
            )
