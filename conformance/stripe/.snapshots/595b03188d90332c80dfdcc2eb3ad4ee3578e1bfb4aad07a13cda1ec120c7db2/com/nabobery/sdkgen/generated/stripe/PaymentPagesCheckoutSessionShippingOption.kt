...
public class PaymentPagesCheckoutSessionShippingOption(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentPagesCheckoutSessionShippingOption =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentPagesCheckoutSessionShippingOption> {
        ...
        override fun deserialize(decoder: Decoder): PaymentPagesCheckoutSessionShippingOption {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentPagesCheckoutSessionShippingOption must be a JSON object")
            val shippingAmount = json.decodeRequired<Int>(rawObject, "shipping_amount")
            val shippingRate =
                json.decodeRequired<InlinePaymentPagesCheckoutSessionShippingOptionShippingRateX8ed48003>(
                    rawObject,
                    "shipping_rate",
                )
            return PaymentPagesCheckoutSessionShippingOption(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentPagesCheckoutSessionShippingOption,
        ) {
...
public fun paymentPagesCheckoutSessionShippingOption(
    block: PaymentPagesCheckoutSessionShippingOption.Builder.() -> Unit,
): PaymentPagesCheckoutSessionShippingOption = PaymentPagesCheckoutSessionShippingOption.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "PaymentPagesCheckoutSessionShippingOption is missing required property '" + name + "'",
            )
