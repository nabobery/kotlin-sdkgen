...
public class InlineV1FilesGetResponse200JsonX77e9a67a(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1FilesGetResponse200JsonX77e9a67a =
    ...
    public object Serializer : KSerializer<InlineV1FilesGetResponse200JsonX77e9a67a> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1FilesGetResponse200JsonX77e9a67a {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("InlineV1FilesGetResponse200JsonX77e9a67a must be a JSON object")
            val data = json.decodeRequired<List<File>>(rawObject, "data")
            val hasMore = json.decodeRequired<Boolean>(rawObject, "has_more")
            val objectValue =
                json.decodeRequired<InlineV1FilesGetResponse200JsonObjectValueXe3c01060>(
                    rawObject,
                    "object",
                )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1FilesGetResponse200JsonX77e9a67a,
        ) {
...
public fun inlineV1FilesGetResponse200JsonX77e9a67a(
    block: InlineV1FilesGetResponse200JsonX77e9a67a.Builder.() -> Unit,
): InlineV1FilesGetResponse200JsonX77e9a67a = InlineV1FilesGetResponse200JsonX77e9a67a.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1FilesGetResponse200JsonX77e9a67a is missing required property '" + name + "'",
            )
