...
public class InlineV1CheckoutSessionsPostRequestFormLineItemsItemPriceDataX178785a7(
    ...
    public val productData: InlineV1CheckoutSessionsPostRequestFormLineItemsItemProductDataX19375235? = null,
    public val recurring: InlineV1CheckoutSessionsPostRequestFormLineItemsItemPriceDataRecurringX22505c68? = null,
    public val taxBehavior: InlineV1CheckoutSessionsPostRequestFormLineItemsItemTaxBehaviorX61c4428f? = null,
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1CheckoutSessionsPostRequestFormLineItemsItemPriceDataX178785a7 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormLineItemsItemPriceDataX178785a7> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CheckoutSessionsPostRequestFormLineItemsItemPriceDataX178785a7 must be a JSON object",
                    )
            ...
            return InlineV1CheckoutSessionsPostRequestFormLineItemsItemPriceDataX178785a7(
                ...
                productData =
                    rawObject["product_data"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormLineItemsItemProductDataX19375235>(
                                it,
                            )
                    },
                recurring =
                    rawObject["recurring"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormLineItemsItemPriceDataRecurringX22505c68>(
                                it,
                            )
                    },
                taxBehavior =
                    rawObject["tax_behavior"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormLineItemsItemTaxBehaviorX61c4428f>(
                                it,
                            )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsPostRequestFormLineItemsItemPriceDataX178785a7,
        ) {
            val jsonEncoder =
...
public fun inlineV1CheckoutSessionsPostRequestFormLineItemsItemPriceDataX178785a7(
    block: InlineV1CheckoutSessionsPostRequestFormLineItemsItemPriceDataX178785a7.Builder.() -> Unit,
): InlineV1CheckoutSessionsPostRequestFormLineItemsItemPriceDataX178785a7 =
    InlineV1CheckoutSessionsPostRequestFormLineItemsItemPriceDataX178785a7.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1CheckoutSessionsPostRequestFormLineItemsItemPriceDataX178785a7 is missing required property '" +
                    name +
                    "'",
            )
