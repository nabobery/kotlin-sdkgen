...
public sealed class InlineV1TestHelpersConfirmafd4PostRequestFormIntervalX9d460ce1 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1TestHelpersConfirmafd4PostRequestFormIntervalX9d460ce1 =
            when (value) {
                Month.value -> Month
    ...
    public object Serializer : KSerializer<InlineV1TestHelpersConfirmafd4PostRequestFormIntervalX9d460ce1> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1TestHelpersConfirmafd4PostRequestFormIntervalX9d460ce1",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1TestHelpersConfirmafd4PostRequestFormIntervalX9d460ce1 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TestHelpersConfirmafd4PostRequestFormIntervalX9d460ce1,
        ) {
