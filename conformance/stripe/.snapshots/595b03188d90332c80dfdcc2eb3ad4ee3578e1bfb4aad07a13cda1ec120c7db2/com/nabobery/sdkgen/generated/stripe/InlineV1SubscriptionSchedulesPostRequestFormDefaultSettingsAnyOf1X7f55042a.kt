...
public class InlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsAnyOf1X7f55042a(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsAnyOf1X7f55042a = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsAnyOf1X7f55042a> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsAnyOf1X7f55042a must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsAnyOf1X7f55042a,
        ) {
            val jsonEncoder =
...
public fun inlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsAnyOf1X7f55042a(
    block: InlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsAnyOf1X7f55042a.Builder.() -> Unit,
): InlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsAnyOf1X7f55042a =
    InlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsAnyOf1X7f55042a.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsAnyOf1X7f55042a is missing required property '" +
                    name +
                    "'",
            )
