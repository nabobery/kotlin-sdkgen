...
public class InlineV1ChargesRefundsPostRequestFormXa55fb322(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1ChargesRefundsPostRequestFormXa55fb322 =
            InlineV1ChargesRefundsPostRequestFormXa55fb322(
                expand = expand,
                metadata = metadata,
            )
    }
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1ChargesRefundsPostRequestFormXa55fb322 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1ChargesRefundsPostRequestFormXa55fb322> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1ChargesRefundsPostRequestFormXa55fb322 must be a JSON object",
                    )
            return InlineV1ChargesRefundsPostRequestFormXa55fb322(
                expand = rawObject["expand"]?.let { json.decodeFromJsonElement<List<String>>(it) },
                metadata =
                    rawObject["metadata"]?.let {
                        json.decodeFromJsonElement<InlineV1ChargesRefundsPostRequestFormMetadataX5c502965>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ChargesRefundsPostRequestFormXa55fb322,
        ) {
...
public fun inlineV1ChargesRefundsPostRequestFormXa55fb322(
    block: InlineV1ChargesRefundsPostRequestFormXa55fb322.Builder.() -> Unit,
): InlineV1ChargesRefundsPostRequestFormXa55fb322 = InlineV1ChargesRefundsPostRequestFormXa55fb322.build(block)
