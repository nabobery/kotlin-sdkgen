...
public class AccountBrandingSettings(
    ...
    public class Builder {
        ...
        public fun build(): AccountBrandingSettings =
    ...
    public object Serializer : KSerializer<AccountBrandingSettings> {
        ...
        override fun deserialize(decoder: Decoder): AccountBrandingSettings {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("AccountBrandingSettings must be a JSON object")
            return AccountBrandingSettings(
                icon =
                    rawObject["icon"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineAccountBrandingSettingsIconXa97b7c89?>(element)
                        }
                    },
                logo =
                    rawObject["logo"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineAccountBrandingSettingsLogoX1ec3b721?>(element)
                        }
                    },
                primaryColor =
                    rawObject["primary_color"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                secondaryColor =
                    rawObject["secondary_color"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
...
public fun accountBrandingSettings(block: AccountBrandingSettings.Builder.() -> Unit): AccountBrandingSettings =
    AccountBrandingSettings.build(block)
