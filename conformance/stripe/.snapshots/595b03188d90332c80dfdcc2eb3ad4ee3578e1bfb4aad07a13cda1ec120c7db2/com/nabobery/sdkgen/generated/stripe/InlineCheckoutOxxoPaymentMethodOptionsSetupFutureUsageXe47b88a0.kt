...
public sealed class InlineCheckoutOxxoPaymentMethodOptionsSetupFutureUsageXe47b88a0 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineCheckoutOxxoPaymentMethodOptionsSetupFutureUsageXe47b88a0 =
            when (value) {
                None.value -> None
    ...
    public object Serializer : KSerializer<InlineCheckoutOxxoPaymentMethodOptionsSetupFutureUsageXe47b88a0> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineCheckoutOxxoPaymentMethodOptionsSetupFutureUsageXe47b88a0",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineCheckoutOxxoPaymentMethodOptionsSetupFutureUsageXe47b88a0 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineCheckoutOxxoPaymentMethodOptionsSetupFutureUsageXe47b88a0,
        ) {
