...
internal data class InlineV1IssuingDisputesPostRequestFormEvidenceOtherX627ee1ccInspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesInlineV1IssuingDisputesPostRequestFormEvidenceOtherAnyOf1Xe727b6c8,
                matchesInlineV1IssuingDisputesPostRequestFormEvidenceOtherAnyOf2X581862f3,
            ).count {
                it
            }
}
...
public class InlineV1IssuingDisputesPostRequestFormEvidenceOtherX627ee1cc internal constructor(
    ...
    public val inlineV1IssuingDisputesPostRequestFormEvidenceOtherAnyOf1Xe727b6c8:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1IssuingDisputesPostRequestFormEvidenceOtherAnyOf1Xe727b6c8) {
                json
                    .decodeFromJsonElement<InlineV1IssuingDisputesPostRequestFormEvidenceOtherAnyOf1Xe727b6c8>(
                        raw,
                    )
            } else {
                null
    ...
    public val inlineV1IssuingDisputesPostRequestFormEvidenceOtherAnyOf2X581862f3:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1IssuingDisputesPostRequestFormEvidenceOtherAnyOf2X581862f3) {
                json
                    .decodeFromJsonElement<InlineV1IssuingDisputesPostRequestFormEvidenceOtherAnyOf2X581862f3>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches:
        ...
        get() =
            buildSet {
                if (inspection.matchesInlineV1IssuingDisputesPostRequestFormEvidenceOtherAnyOf1Xe727b6c8) {
                    add(
                        InlineV1IssuingDisputesPostRequestFormEvidenceOtherX627ee1ccBranch.InlineV1IssuingDisputesPostRequestFormEvidenceOtherAnyOf1Xe727b6c8,
                    )
                }
                if (inspection.matchesInlineV1IssuingDisputesPostRequestFormEvidenceOtherAnyOf2X581862f3) {
                    add(
                        InlineV1IssuingDisputesPostRequestFormEvidenceOtherX627ee1ccBranch.InlineV1IssuingDisputesPostRequestFormEvidenceOtherAnyOf2X581862f3,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1IssuingDisputesPostRequestFormEvidenceOtherX627ee1cc {
            val inspection = inspectInlineV1IssuingDisputesPostRequestFormEvidenceOtherX627ee1cc(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1IssuingDisputesPostRequestFormEvidenceOtherX627ee1ccNoMatchException(
                    "InlineV1IssuingDisputesPostRequestFormEvidenceOtherX627ee1cc matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1IssuingDisputesPostRequestFormEvidenceOtherX627ee1cc> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingDisputesPostRequestFormEvidenceOtherX627ee1cc,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1IssuingDisputesPostRequestFormEvidenceOtherX627ee1cc",
...
private fun inspectInlineV1IssuingDisputesPostRequestFormEvidenceOtherX627ee1cc(
    element: JsonElement,
): InlineV1IssuingDisputesPostRequestFormEvidenceOtherX627ee1ccInspection {
    val matchesInlineV1IssuingDisputesPostRequestFormEvidenceOtherAnyOf1Xe727b6c8 =
        element
            .isJsonDecodable<InlineV1IssuingDisputesPostRequestFormEvidenceOtherAnyOf1Xe727b6c8>()
    val matchesInlineV1IssuingDisputesPostRequestFormEvidenceOtherAnyOf2X581862f3 =
        element
            .isJsonDecodable<InlineV1IssuingDisputesPostRequestFormEvidenceOtherAnyOf2X581862f3>()
    return InlineV1IssuingDisputesPostRequestFormEvidenceOtherX627ee1ccInspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1IssuingDisputesPostRequestFormEvidenceOtherAnyOf1Xe727b6c8) {
                    add(
                        "InlineV1IssuingDisputesPostRequestFormEvidenceOtherAnyOf1Xe727b6c8: value does not match InlineV1IssuingDisputesPostRequestFormEvidenceOtherAnyOf1Xe727b6c8",
                    )
                }
                if (!matchesInlineV1IssuingDisputesPostRequestFormEvidenceOtherAnyOf2X581862f3) {
                    add(
                        "InlineV1IssuingDisputesPostRequestFormEvidenceOtherAnyOf2X581862f3: value does not match InlineV1IssuingDisputesPostRequestFormEvidenceOtherAnyOf2X581862f3",
                    )
                }
            },
    )
