...
public class SubscriptionItem(
    ...
    public object Serializer : KSerializer<SubscriptionItem> {
        ...
        override fun deserialize(decoder: Decoder): SubscriptionItem {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("SubscriptionItem must be a JSON object")
            ...
            val discounts =
                json.decodeRequired<List<InlineSubscriptionItemDiscountsItemX172b5224>>(
                    rawObject,
                    "discounts",
                )
                ...
                billingThresholds =
                    rawObject["billing_thresholds"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineSubscriptionItemBillingThresholdsXf7b51752?>(element)
                        }
                    },
...
public fun subscriptionItem(block: SubscriptionItem.Builder.() -> Unit): SubscriptionItem =
    SubscriptionItem.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("SubscriptionItem is missing required property '" + name + "'")
