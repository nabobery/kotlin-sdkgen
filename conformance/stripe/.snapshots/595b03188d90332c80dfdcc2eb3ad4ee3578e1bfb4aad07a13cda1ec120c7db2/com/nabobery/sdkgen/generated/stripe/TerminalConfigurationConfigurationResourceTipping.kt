...
public class TerminalConfigurationConfigurationResourceTipping(
    ...
    public class Builder {
        ...
        public fun build(): TerminalConfigurationConfigurationResourceTipping =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): TerminalConfigurationConfigurationResourceTipping =
    ...
    public object Serializer : KSerializer<TerminalConfigurationConfigurationResourceTipping> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "TerminalConfigurationConfigurationResourceTipping must be a JSON object",
                    )
            return TerminalConfigurationConfigurationResourceTipping(
                aed =
                    rawObject["aed"]?.let {
                        json.decodeFromJsonElement<TerminalConfigurationConfigurationResourceCurrencySpecificConfig>(it)
                    },
                aud =
                    rawObject["aud"]?.let {
                        json.decodeFromJsonElement<TerminalConfigurationConfigurationResourceCurrencySpecificConfig>(it)
                ...
                usd =
                    rawObject["usd"]
                        ?.let {
                            json
                                .decodeFromJsonElement<TerminalConfigurationConfigurationResourceCurrencySpecificConfig>(
                                    it,
                                )
                        },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: TerminalConfigurationConfigurationResourceTipping,
        ) {
...
public fun terminalConfigurationConfigurationResourceTipping(
    block: TerminalConfigurationConfigurationResourceTipping.Builder.() -> Unit,
): TerminalConfigurationConfigurationResourceTipping = TerminalConfigurationConfigurationResourceTipping.build(block)
