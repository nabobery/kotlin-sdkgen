        ...
        override fun deserialize(decoder: Decoder): ChargeTransferData {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("ChargeTransferData must be a JSON object")
            val destination =
                json.decodeRequired<InlineChargeTransferDataDestinationX0d1b68b9>(
                    rawObject,
                    "destination",
                )
            return ChargeTransferData(
...
public fun chargeTransferData(block: ChargeTransferData.Builder.() -> Unit): ChargeTransferData =
    ChargeTransferData.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("ChargeTransferData is missing required property '" + name + "'")
