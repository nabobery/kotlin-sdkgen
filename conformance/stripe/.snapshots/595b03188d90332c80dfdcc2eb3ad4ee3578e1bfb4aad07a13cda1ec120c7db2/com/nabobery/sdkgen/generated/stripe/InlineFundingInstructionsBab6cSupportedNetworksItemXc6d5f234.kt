...
public sealed class InlineFundingInstructionsBab6cSupportedNetworksItemXc6d5f234 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineFundingInstructionsBab6cSupportedNetworksItemXc6d5f234 =
            when (value) {
                Ach.value -> Ach
                Bacs.value -> Bacs
    ...
    public object Serializer : KSerializer<InlineFundingInstructionsBab6cSupportedNetworksItemXc6d5f234> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineFundingInstructionsBab6cSupportedNetworksItemXc6d5f234",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineFundingInstructionsBab6cSupportedNetworksItemXc6d5f234 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineFundingInstructionsBab6cSupportedNetworksItemXc6d5f234,
        ) {
