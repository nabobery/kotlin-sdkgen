...
public sealed class InlinePaymentMethodDetailsBancontactPreferredLanguageXf9137086 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentMethodDetailsBancontactPreferredLanguageXf9137086 =
            when (value) {
                De.value -> De
                En.value -> En
                Fr.value -> Fr
    ...
    public object Serializer : KSerializer<InlinePaymentMethodDetailsBancontactPreferredLanguageXf9137086> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentMethodDetailsBancontactPreferredLanguageXf9137086",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePaymentMethodDetailsBancontactPreferredLanguageXf9137086 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentMethodDetailsBancontactPreferredLanguageXf9137086,
        ) {
