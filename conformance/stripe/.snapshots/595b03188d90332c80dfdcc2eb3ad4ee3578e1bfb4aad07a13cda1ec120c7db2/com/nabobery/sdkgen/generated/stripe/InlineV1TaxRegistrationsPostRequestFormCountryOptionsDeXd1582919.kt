...
public class InlineV1TaxRegistrationsPostRequestFormCountryOptionsDeXd1582919(
    ...
    public val standard: InlineV1TaxRegistrationsPostRequestFormCountryOptionsDeStandardX05d16b52? = null,
) {
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TaxRegistrationsPostRequestFormCountryOptionsDeXd1582919 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TaxRegistrationsPostRequestFormCountryOptionsDeXd1582919> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TaxRegistrationsPostRequestFormCountryOptionsDeXd1582919 must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineV1TaxRegistrationsPostRequestFormCountryOptionsDeTypeXa448142c>(
                    rawObject,
                    "type",
                )
            return InlineV1TaxRegistrationsPostRequestFormCountryOptionsDeXd1582919(
                ...
                standard =
                    rawObject["standard"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsDeStandardX05d16b52>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TaxRegistrationsPostRequestFormCountryOptionsDeXd1582919,
        ) {
            val jsonEncoder =
...
public fun inlineV1TaxRegistrationsPostRequestFormCountryOptionsDeXd1582919(
    block: InlineV1TaxRegistrationsPostRequestFormCountryOptionsDeXd1582919.Builder.() -> Unit,
): InlineV1TaxRegistrationsPostRequestFormCountryOptionsDeXd1582919 =
    InlineV1TaxRegistrationsPostRequestFormCountryOptionsDeXd1582919.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TaxRegistrationsPostRequestFormCountryOptionsDeXd1582919 is missing required property '" + name +
                    "'",
            )
