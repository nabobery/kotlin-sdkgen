...
public sealed class InlineV1SetupIntentsConfirmPostRequestFormAllowRedisplayXaf0b2669 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1SetupIntentsConfirmPostRequestFormAllowRedisplayXaf0b2669 =
            when (value) {
                Always.value -> Always
    ...
    public object Serializer : KSerializer<InlineV1SetupIntentsConfirmPostRequestFormAllowRedisplayXaf0b2669> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1SetupIntentsConfirmPostRequestFormAllowRedisplayXaf0b2669",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1SetupIntentsConfirmPostRequestFormAllowRedisplayXaf0b2669 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SetupIntentsConfirmPostRequestFormAllowRedisplayXaf0b2669,
        ) {
