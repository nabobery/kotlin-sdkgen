...
public class PaymentsPrimitivesPaymentRecordsResourceCustomerDetails(
    ...
    public class Builder {
        ...
        public fun build(): PaymentsPrimitivesPaymentRecordsResourceCustomerDetails =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentsPrimitivesPaymentRecordsResourceCustomerDetails =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentsPrimitivesPaymentRecordsResourceCustomerDetails> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "PaymentsPrimitivesPaymentRecordsResourceCustomerDetails must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentsPrimitivesPaymentRecordsResourceCustomerDetails,
        ) {
...
public fun paymentsPrimitivesPaymentRecordsResourceCustomerDetails(
    block: PaymentsPrimitivesPaymentRecordsResourceCustomerDetails.Builder.() -> Unit,
): PaymentsPrimitivesPaymentRecordsResourceCustomerDetails =
    PaymentsPrimitivesPaymentRecordsResourceCustomerDetails.build(block)
