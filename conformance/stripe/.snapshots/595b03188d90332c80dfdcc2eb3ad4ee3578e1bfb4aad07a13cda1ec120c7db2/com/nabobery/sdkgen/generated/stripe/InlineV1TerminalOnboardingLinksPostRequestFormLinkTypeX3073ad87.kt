...
public sealed class InlineV1TerminalOnboardingLinksPostRequestFormLinkTypeX3073ad87 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1TerminalOnboardingLinksPostRequestFormLinkTypeX3073ad87 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1TerminalOnboardingLinksPostRequestFormLinkTypeX3073ad87> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1TerminalOnboardingLinksPostRequestFormLinkTypeX3073ad87",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1TerminalOnboardingLinksPostRequestFormLinkTypeX3073ad87 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TerminalOnboardingLinksPostRequestFormLinkTypeX3073ad87,
        ) {
