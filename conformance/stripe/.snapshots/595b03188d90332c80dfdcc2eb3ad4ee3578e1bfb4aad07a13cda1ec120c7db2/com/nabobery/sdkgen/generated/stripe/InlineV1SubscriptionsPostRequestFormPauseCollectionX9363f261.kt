...
internal data class InlineV1SubscriptionsPostRequestFormPauseCollectionX9363f261Inspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesInlineV1SubscriptionsPostRequestFormPauseCollectionAnyOf1Xa44f1c3f,
                matchesInlineV1SubscriptionsPostRequestFormPauseCollectionAnyOf2Xccf086d5,
            ).count {
                it
            }
}
...
public class InlineV1SubscriptionsPostRequestFormPauseCollectionX9363f261 internal constructor(
    ...
    public val inlineV1SubscriptionsPostRequestFormPauseCollectionAnyOf1Xa44f1c3f:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1SubscriptionsPostRequestFormPauseCollectionAnyOf1Xa44f1c3f) {
                json
                    .decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormPauseCollectionAnyOf1Xa44f1c3f>(
                        raw,
                    )
            } else {
                null
    ...
    public val inlineV1SubscriptionsPostRequestFormPauseCollectionAnyOf2Xccf086d5:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1SubscriptionsPostRequestFormPauseCollectionAnyOf2Xccf086d5) {
                json
                    .decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormPauseCollectionAnyOf2Xccf086d5>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches:
        ...
        get() =
            buildSet {
                if (inspection.matchesInlineV1SubscriptionsPostRequestFormPauseCollectionAnyOf1Xa44f1c3f) {
                    add(
                        InlineV1SubscriptionsPostRequestFormPauseCollectionX9363f261Branch.InlineV1SubscriptionsPostRequestFormPauseCollectionAnyOf1Xa44f1c3f,
                    )
                }
                if (inspection.matchesInlineV1SubscriptionsPostRequestFormPauseCollectionAnyOf2Xccf086d5) {
                    add(
                        InlineV1SubscriptionsPostRequestFormPauseCollectionX9363f261Branch.InlineV1SubscriptionsPostRequestFormPauseCollectionAnyOf2Xccf086d5,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1SubscriptionsPostRequestFormPauseCollectionX9363f261 {
            val inspection = inspectInlineV1SubscriptionsPostRequestFormPauseCollectionX9363f261(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1SubscriptionsPostRequestFormPauseCollectionX9363f261NoMatchException(
                    "InlineV1SubscriptionsPostRequestFormPauseCollectionX9363f261 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionsPostRequestFormPauseCollectionX9363f261> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsPostRequestFormPauseCollectionX9363f261,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1SubscriptionsPostRequestFormPauseCollectionX9363f261",
...
private fun inspectInlineV1SubscriptionsPostRequestFormPauseCollectionX9363f261(
    element: JsonElement,
): InlineV1SubscriptionsPostRequestFormPauseCollectionX9363f261Inspection {
    val matchesInlineV1SubscriptionsPostRequestFormPauseCollectionAnyOf1Xa44f1c3f =
        element
            .isJsonDecodable<InlineV1SubscriptionsPostRequestFormPauseCollectionAnyOf1Xa44f1c3f>()
    val matchesInlineV1SubscriptionsPostRequestFormPauseCollectionAnyOf2Xccf086d5 =
        element
            .isJsonDecodable<InlineV1SubscriptionsPostRequestFormPauseCollectionAnyOf2Xccf086d5>()
    return InlineV1SubscriptionsPostRequestFormPauseCollectionX9363f261Inspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1SubscriptionsPostRequestFormPauseCollectionAnyOf1Xa44f1c3f) {
                    add(
                        "InlineV1SubscriptionsPostRequestFormPauseCollectionAnyOf1Xa44f1c3f: value does not match InlineV1SubscriptionsPostRequestFormPauseCollectionAnyOf1Xa44f1c3f",
                    )
                }
                if (!matchesInlineV1SubscriptionsPostRequestFormPauseCollectionAnyOf2Xccf086d5) {
                    add(
                        "InlineV1SubscriptionsPostRequestFormPauseCollectionAnyOf2Xccf086d5: value does not match InlineV1SubscriptionsPostRequestFormPauseCollectionAnyOf2Xccf086d5",
                    )
                }
            },
    )
