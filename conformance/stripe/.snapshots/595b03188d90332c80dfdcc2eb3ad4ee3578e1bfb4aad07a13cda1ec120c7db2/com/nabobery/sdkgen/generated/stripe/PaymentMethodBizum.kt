...
public class PaymentMethodBizum(
    ...
    public class Builder {
        ...
        public fun build(): PaymentMethodBizum =
            PaymentMethodBizum(
                buyerId = buyerId,
            )
    }
    ...
    public object Serializer : KSerializer<PaymentMethodBizum> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodBizum {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodBizum must be a JSON object")
...
public fun paymentMethodBizum(block: PaymentMethodBizum.Builder.() -> Unit): PaymentMethodBizum =
    PaymentMethodBizum.build(block)
