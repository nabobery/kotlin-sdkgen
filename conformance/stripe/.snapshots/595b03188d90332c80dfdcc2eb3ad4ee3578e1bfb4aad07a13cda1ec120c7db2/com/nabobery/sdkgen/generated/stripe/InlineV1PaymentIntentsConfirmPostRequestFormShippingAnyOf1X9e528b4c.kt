...
public class InlineV1PaymentIntentsConfirmPostRequestFormShippingAnyOf1X9e528b4c(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentIntentsConfirmPostRequestFormShippingAnyOf1X9e528b4c = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsConfirmPostRequestFormShippingAnyOf1X9e528b4c> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsConfirmPostRequestFormShippingAnyOf1X9e528b4c must be a JSON object",
                    )
            val address =
                json.decodeRequired<InlineV1PaymentIntentsConfirmPostRequestFormShippingAnyOf1AddressXf3039ed5>(
                    rawObject,
                    "address",
                )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsConfirmPostRequestFormShippingAnyOf1X9e528b4c,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentIntentsConfirmPostRequestFormShippingAnyOf1X9e528b4c(
    block: InlineV1PaymentIntentsConfirmPostRequestFormShippingAnyOf1X9e528b4c.Builder.() -> Unit,
): InlineV1PaymentIntentsConfirmPostRequestFormShippingAnyOf1X9e528b4c =
    InlineV1PaymentIntentsConfirmPostRequestFormShippingAnyOf1X9e528b4c.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentIntentsConfirmPostRequestFormShippingAnyOf1X9e528b4c is missing required property '" +
                    name +
                    "'",
            )
