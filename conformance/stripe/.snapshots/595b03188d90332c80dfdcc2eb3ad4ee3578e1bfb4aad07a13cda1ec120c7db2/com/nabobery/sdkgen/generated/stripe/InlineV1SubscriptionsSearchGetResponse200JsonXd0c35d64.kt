...
public class InlineV1SubscriptionsSearchGetResponse200JsonXd0c35d64(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1SubscriptionsSearchGetResponse200JsonXd0c35d64 =
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionsSearchGetResponse200JsonXd0c35d64> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SubscriptionsSearchGetResponse200JsonXd0c35d64 must be a JSON object",
                    )
            val data = json.decodeRequired<List<Subscription>>(rawObject, "data")
            val hasMore = json.decodeRequired<Boolean>(rawObject, "has_more")
            val objectValue =
                json.decodeRequired<InlineV1SubscriptionsSearchGetResponse200JsonObjectValueX526ebb25>(
                    rawObject,
                    "object",
                )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsSearchGetResponse200JsonXd0c35d64,
        ) {
...
public fun inlineV1SubscriptionsSearchGetResponse200JsonXd0c35d64(
    block: InlineV1SubscriptionsSearchGetResponse200JsonXd0c35d64.Builder.() -> Unit,
): InlineV1SubscriptionsSearchGetResponse200JsonXd0c35d64 =
    InlineV1SubscriptionsSearchGetResponse200JsonXd0c35d64.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1SubscriptionsSearchGetResponse200JsonXd0c35d64 is missing required property '" + name + "'",
            )
