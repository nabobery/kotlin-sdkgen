...
public class SubscriptionSchedulesResourceInvoiceItemPeriodResourcePeriodStart(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): SubscriptionSchedulesResourceInvoiceItemPeriodResourcePeriodStart =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<SubscriptionSchedulesResourceInvoiceItemPeriodResourcePeriodStart> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "SubscriptionSchedulesResourceInvoiceItemPeriodResourcePeriodStart must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: SubscriptionSchedulesResourceInvoiceItemPeriodResourcePeriodStart,
        ) {
            val jsonEncoder =
...
public fun subscriptionSchedulesResourceInvoiceItemPeriodResourcePeriodStart(
    block: SubscriptionSchedulesResourceInvoiceItemPeriodResourcePeriodStart.Builder.() -> Unit,
): SubscriptionSchedulesResourceInvoiceItemPeriodResourcePeriodStart =
    SubscriptionSchedulesResourceInvoiceItemPeriodResourcePeriodStart.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "SubscriptionSchedulesResourceInvoiceItemPeriodResourcePeriodStart is missing required property '" +
                    name +
                    "'",
            )
