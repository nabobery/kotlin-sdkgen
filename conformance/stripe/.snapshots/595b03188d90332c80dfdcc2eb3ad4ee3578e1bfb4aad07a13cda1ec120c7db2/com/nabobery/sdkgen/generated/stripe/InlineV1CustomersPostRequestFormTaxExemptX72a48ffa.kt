...
public sealed class InlineV1CustomersPostRequestFormTaxExemptX72a48ffa {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1CustomersPostRequestFormTaxExemptX72a48ffa =
            when (value) {
                Value.value -> Value
                Exempt.value -> Exempt
                None.value -> None
    ...
    public object Serializer : KSerializer<InlineV1CustomersPostRequestFormTaxExemptX72a48ffa> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1CustomersPostRequestFormTaxExemptX72a48ffa",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1CustomersPostRequestFormTaxExemptX72a48ffa =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersPostRequestFormTaxExemptX72a48ffa,
        ) {
