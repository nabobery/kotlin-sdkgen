...
public class InlineSubscriptionSchedulesResourceDefaultSettingsOnBehalfOfXca035d5a internal constructor(
    ...
    private val inspection: InlineSubscriptionSchedulesResourceDefaultSettingsOnBehalfOfXca035d5aInspection,
) {
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineSubscriptionSchedulesResourceDefaultSettingsOnBehalfOfXca035d5aBranch.Branch1,
                    )
                }
                if (inspection.matchesAccount) {
                    add(
                        InlineSubscriptionSchedulesResourceDefaultSettingsOnBehalfOfXca035d5aBranch.Account,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineSubscriptionSchedulesResourceDefaultSettingsOnBehalfOfXca035d5a {
            val inspection = inspectInlineSubscriptionSchedulesResourceDefaultSettingsOnBehalfOfXca035d5a(raw)
            if (inspection.matchCount == 0) {
                throw InlineSubscriptionSchedulesResourceDefaultSettingsOnBehalfOfXca035d5aNoMatchException(
                    "InlineSubscriptionSchedulesResourceDefaultSettingsOnBehalfOfXca035d5a matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineSubscriptionSchedulesResourceDefaultSettingsOnBehalfOfXca035d5a> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineSubscriptionSchedulesResourceDefaultSettingsOnBehalfOfXca035d5a,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineSubscriptionSchedulesResourceDefaultSettingsOnBehalfOfXca035d5a",
...
private fun inspectInlineSubscriptionSchedulesResourceDefaultSettingsOnBehalfOfXca035d5a(
    element: JsonElement,
