...
public class InlineV1AccountSessionsPostRequestFormFinancialAccountTrane127X4bf4b8a7(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1AccountSessionsPostRequestFormFinancialAccountTrane127X4bf4b8a7 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1AccountSessionsPostRequestFormFinancialAccountTrane127X4bf4b8a7> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountSessionsPostRequestFormFinancialAccountTrane127X4bf4b8a7 must be a JSON object",
                    )
            ...
            return InlineV1AccountSessionsPostRequestFormFinancialAccountTrane127X4bf4b8a7(
                ...
                features =
                    rawObject["features"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountSessionsPostRequestFormComponentsFeaturesX8ece1cb8>(
                            it,
                        )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountSessionsPostRequestFormFinancialAccountTrane127X4bf4b8a7,
        ) {
            val jsonEncoder =
...
public fun inlineV1AccountSessionsPostRequestFormFinancialAccountTrane127X4bf4b8a7(
    block: InlineV1AccountSessionsPostRequestFormFinancialAccountTrane127X4bf4b8a7.Builder.() -> Unit,
): InlineV1AccountSessionsPostRequestFormFinancialAccountTrane127X4bf4b8a7 =
    InlineV1AccountSessionsPostRequestFormFinancialAccountTrane127X4bf4b8a7.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1AccountSessionsPostRequestFormFinancialAccountTrane127X4bf4b8a7 is missing required property '" +
                    name +
                    "'",
            )
