...
public class InlineV1FileLinksPostRequestFormMetadataXaddcdec0 internal constructor(
    ...
    public val inlineV1FileLinksPostRequestFormMetadataAnyOf2X44894b18:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1FileLinksPostRequestFormMetadataAnyOf2X44894b18) {
                json
                    .decodeFromJsonElement<InlineV1FileLinksPostRequestFormMetadataAnyOf2X44894b18>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1FileLinksPostRequestFormMetadataXaddcdec0Branch>
        get() =
            buildSet {
                ...
                if (inspection.matchesInlineV1FileLinksPostRequestFormMetadataAnyOf2X44894b18) {
                    add(
                        InlineV1FileLinksPostRequestFormMetadataXaddcdec0Branch.InlineV1FileLinksPostRequestFormMetadataAnyOf2X44894b18,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1FileLinksPostRequestFormMetadataXaddcdec0 {
            val inspection = inspectInlineV1FileLinksPostRequestFormMetadataXaddcdec0(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1FileLinksPostRequestFormMetadataXaddcdec0NoMatchException(
                    "InlineV1FileLinksPostRequestFormMetadataXaddcdec0 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1FileLinksPostRequestFormMetadataXaddcdec0> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1FileLinksPostRequestFormMetadataXaddcdec0,
        ) {
...
private fun inspectInlineV1FileLinksPostRequestFormMetadataXaddcdec0(
    element: JsonElement,
): InlineV1FileLinksPostRequestFormMetadataXaddcdec0Inspection {
    val matchesBranch1 = element.isJsonDecodable<JsonObject>()
    val matchesInlineV1FileLinksPostRequestFormMetadataAnyOf2X44894b18 =
        element
            .isJsonDecodable<InlineV1FileLinksPostRequestFormMetadataAnyOf2X44894b18>()
    return InlineV1FileLinksPostRequestFormMetadataXaddcdec0Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1FileLinksPostRequestFormMetadataAnyOf2X44894b18) {
                    add(
                        "InlineV1FileLinksPostRequestFormMetadataAnyOf2X44894b18: value does not match InlineV1FileLinksPostRequestFormMetadataAnyOf2X44894b18",
                    )
                }
            },
    )
