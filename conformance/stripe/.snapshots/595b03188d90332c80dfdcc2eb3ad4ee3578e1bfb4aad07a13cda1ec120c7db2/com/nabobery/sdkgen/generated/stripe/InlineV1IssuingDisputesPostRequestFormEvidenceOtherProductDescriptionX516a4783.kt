...
internal data class InlineV1IssuingDisputesPostRequestFormEvidenceOtherProductDescriptionX516a4783Inspection(
    ...
    public val matchesInlineV1IssuingDisputesPostRequestFormEvidenceOtherAnyOf1AnyOf2X6378a431: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1IssuingDisputesPostRequestFormEvidenceOtherAnyOf1AnyOf2X6378a431,
            ).count {
                it
            }
}
...
public class InlineV1IssuingDisputesPostRequestFormEvidenceOtherProductDescriptionX516a4783 internal constructor(
    ...
    private val inspection: InlineV1IssuingDisputesPostRequestFormEvidenceOtherProductDescriptionX516a4783Inspection,
) {
    ...
    public val inlineV1IssuingDisputesPostRequestFormEvidenceOtherAnyOf1AnyOf2X6378a431:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1IssuingDisputesPostRequestFormEvidenceOtherAnyOf1AnyOf2X6378a431) {
                json
                    .decodeFromJsonElement<InlineV1IssuingDisputesPostRequestFormEvidenceOtherAnyOf1AnyOf2X6378a431>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1IssuingDisputesPostRequestFormEvidenceOtherProductDescriptionX516a4783Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1IssuingDisputesPostRequestFormEvidenceOtherAnyOf1AnyOf2X6378a431) {
                    add(
                        InlineV1IssuingDisputesPostRequestFormEvidenceOtherProductDescriptionX516a4783Branch.InlineV1IssuingDisputesPostRequestFormEvidenceOtherAnyOf1AnyOf2X6378a431,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1IssuingDisputesPostRequestFormEvidenceOtherProductDescriptionX516a4783 {
            val inspection = inspectInlineV1IssuingDisputesPostRequestFormEvidenceOtherProductDescriptionX516a4783(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1IssuingDisputesPostRequestFormEvidenceOtherProductDescriptionX516a4783NoMatchException(
                    "InlineV1IssuingDisputesPostRequestFormEvidenceOtherProductDescriptionX516a4783 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1IssuingDisputesPostRequestFormEvidenceOtherProductDescriptionX516a4783> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingDisputesPostRequestFormEvidenceOtherProductDescriptionX516a4783,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1IssuingDisputesPostRequestFormEvidenceOtherProductDescriptionX516a4783",
...
private fun inspectInlineV1IssuingDisputesPostRequestFormEvidenceOtherProductDescriptionX516a4783(
    element: JsonElement,
): InlineV1IssuingDisputesPostRequestFormEvidenceOtherProductDescriptionX516a4783Inspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1IssuingDisputesPostRequestFormEvidenceOtherAnyOf1AnyOf2X6378a431 =
        element
            .isJsonDecodable<InlineV1IssuingDisputesPostRequestFormEvidenceOtherAnyOf1AnyOf2X6378a431>()
    return InlineV1IssuingDisputesPostRequestFormEvidenceOtherProductDescriptionX516a4783Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1IssuingDisputesPostRequestFormEvidenceOtherAnyOf1AnyOf2X6378a431) {
                    add(
                        "InlineV1IssuingDisputesPostRequestFormEvidenceOtherAnyOf1AnyOf2X6378a431: value does not match InlineV1IssuingDisputesPostRequestFormEvidenceOtherAnyOf1AnyOf2X6378a431",
                    )
                }
            },
    )
