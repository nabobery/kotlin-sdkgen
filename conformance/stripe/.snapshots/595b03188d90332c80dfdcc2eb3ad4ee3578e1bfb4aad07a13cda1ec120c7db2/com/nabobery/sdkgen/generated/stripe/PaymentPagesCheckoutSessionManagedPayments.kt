...
public class PaymentPagesCheckoutSessionManagedPayments(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentPagesCheckoutSessionManagedPayments =
    ...
    public object Serializer : KSerializer<PaymentPagesCheckoutSessionManagedPayments> {
        ...
        override fun deserialize(decoder: Decoder): PaymentPagesCheckoutSessionManagedPayments {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentPagesCheckoutSessionManagedPayments must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentPagesCheckoutSessionManagedPayments,
        ) {
...
public fun paymentPagesCheckoutSessionManagedPayments(
    block: PaymentPagesCheckoutSessionManagedPayments.Builder.() -> Unit,
): PaymentPagesCheckoutSessionManagedPayments = PaymentPagesCheckoutSessionManagedPayments.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "PaymentPagesCheckoutSessionManagedPayments is missing required property '" + name + "'",
            )
