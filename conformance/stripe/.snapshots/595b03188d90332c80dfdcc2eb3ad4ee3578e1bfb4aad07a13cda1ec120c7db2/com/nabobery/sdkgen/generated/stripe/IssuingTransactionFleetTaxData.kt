...
public class IssuingTransactionFleetTaxData(
    ...
    public class Builder {
        ...
        public fun build(): IssuingTransactionFleetTaxData =
    ...
    public object Serializer : KSerializer<IssuingTransactionFleetTaxData> {
        ...
        override fun deserialize(decoder: Decoder): IssuingTransactionFleetTaxData {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("IssuingTransactionFleetTaxData must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: IssuingTransactionFleetTaxData,
        ) {
...
public fun issuingTransactionFleetTaxData(
    block: IssuingTransactionFleetTaxData.Builder.() -> Unit,
): IssuingTransactionFleetTaxData = IssuingTransactionFleetTaxData.build(block)
