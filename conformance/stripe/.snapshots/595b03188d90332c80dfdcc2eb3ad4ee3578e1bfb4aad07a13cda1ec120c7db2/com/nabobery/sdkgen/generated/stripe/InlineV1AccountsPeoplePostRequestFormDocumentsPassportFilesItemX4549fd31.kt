...
internal data class InlineV1AccountsPeoplePostRequestFormDocumentsPassportFilesItemX4549fd31Inspection(
    ...
    public val matchesInlineV1AccountsPeoplePostRequestFormDocumentsPassportFilesItemAnyOf2X7e67feb8: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1AccountsPeoplePostRequestFormDocumentsPassportFilesItemAnyOf2X7e67feb8,
            ).count {
                it
            }
}
...
public class InlineV1AccountsPeoplePostRequestFormDocumentsPassportFilesItemX4549fd31 internal constructor(
    ...
    private val inspection: InlineV1AccountsPeoplePostRequestFormDocumentsPassportFilesItemX4549fd31Inspection,
) {
    ...
    public val inlineV1AccountsPeoplePostRequestFormDocumentsPassportFilesItemAnyOf2X7e67feb8:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1AccountsPeoplePostRequestFormDocumentsPassportFilesItemAnyOf2X7e67feb8) {
                json
                    .decodeFromJsonElement<InlineV1AccountsPeoplePostRequestFormDocumentsPassportFilesItemAnyOf2X7e67feb8>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1AccountsPeoplePostRequestFormDocumentsPassportFilesItemX4549fd31Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1AccountsPeoplePostRequestFormDocumentsPassportFilesItemAnyOf2X7e67feb8) {
                    add(
                        InlineV1AccountsPeoplePostRequestFormDocumentsPassportFilesItemX4549fd31Branch.InlineV1AccountsPeoplePostRequestFormDocumentsPassportFilesItemAnyOf2X7e67feb8,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1AccountsPeoplePostRequestFormDocumentsPassportFilesItemX4549fd31 {
            val inspection = inspectInlineV1AccountsPeoplePostRequestFormDocumentsPassportFilesItemX4549fd31(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1AccountsPeoplePostRequestFormDocumentsPassportFilesItemX4549fd31NoMatchException(
                    "InlineV1AccountsPeoplePostRequestFormDocumentsPassportFilesItemX4549fd31 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1AccountsPeoplePostRequestFormDocumentsPassportFilesItemX4549fd31> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPeoplePostRequestFormDocumentsPassportFilesItemX4549fd31,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1AccountsPeoplePostRequestFormDocumentsPassportFilesItemX4549fd31",
...
private fun inspectInlineV1AccountsPeoplePostRequestFormDocumentsPassportFilesItemX4549fd31(
    element: JsonElement,
): InlineV1AccountsPeoplePostRequestFormDocumentsPassportFilesItemX4549fd31Inspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1AccountsPeoplePostRequestFormDocumentsPassportFilesItemAnyOf2X7e67feb8 =
        element
            .isJsonDecodable<InlineV1AccountsPeoplePostRequestFormDocumentsPassportFilesItemAnyOf2X7e67feb8>()
    return InlineV1AccountsPeoplePostRequestFormDocumentsPassportFilesItemX4549fd31Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1AccountsPeoplePostRequestFormDocumentsPassportFilesItemAnyOf2X7e67feb8) {
                    add(
                        "InlineV1AccountsPeoplePostRequestFormDocumentsPassportFilesItemAnyOf2X7e67feb8: value does not match InlineV1AccountsPeoplePostRequestFormDocumentsPassportFilesItemAnyOf2X7e67feb8",
                    )
                }
            },
    )
