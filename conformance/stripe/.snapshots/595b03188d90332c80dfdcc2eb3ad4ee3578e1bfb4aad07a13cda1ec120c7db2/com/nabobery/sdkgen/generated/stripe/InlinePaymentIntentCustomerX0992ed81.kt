...
public class InlinePaymentIntentCustomerX0992ed81 internal constructor(
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlinePaymentIntentCustomerX0992ed81 {
            val inspection = inspectInlinePaymentIntentCustomerX0992ed81(raw)
            if (inspection.matchCount == 0) {
                throw InlinePaymentIntentCustomerX0992ed81NoMatchException(
                    "InlinePaymentIntentCustomerX0992ed81 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlinePaymentIntentCustomerX0992ed81> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentIntentCustomerX0992ed81,
        ) {
...
private fun inspectInlinePaymentIntentCustomerX0992ed81(
    element: JsonElement,
): InlinePaymentIntentCustomerX0992ed81Inspection {
