...
internal data class InlineV1QuotesPostRequestFormSubscriptionDataTrialPeriodDaysXc8000420Inspection(
    ...
    public val matchesInlineV1QuotesPostRequestFormSubscriptionDataTrialPeriodDaysAnyOf2X48a8e632: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1QuotesPostRequestFormSubscriptionDataTrialPeriodDaysAnyOf2X48a8e632,
            ).count {
                it
            }
}
...
public class InlineV1QuotesPostRequestFormSubscriptionDataTrialPeriodDaysXc8000420 internal constructor(
    ...
    private val inspection: InlineV1QuotesPostRequestFormSubscriptionDataTrialPeriodDaysXc8000420Inspection,
) {
    ...
    public val inlineV1QuotesPostRequestFormSubscriptionDataTrialPeriodDaysAnyOf2X48a8e632:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1QuotesPostRequestFormSubscriptionDataTrialPeriodDaysAnyOf2X48a8e632) {
                json
                    .decodeFromJsonElement<InlineV1QuotesPostRequestFormSubscriptionDataTrialPeriodDaysAnyOf2X48a8e632>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1QuotesPostRequestFormSubscriptionDataTrialPeriodDaysXc8000420Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1QuotesPostRequestFormSubscriptionDataTrialPeriodDaysAnyOf2X48a8e632) {
                    add(
                        InlineV1QuotesPostRequestFormSubscriptionDataTrialPeriodDaysXc8000420Branch.InlineV1QuotesPostRequestFormSubscriptionDataTrialPeriodDaysAnyOf2X48a8e632,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1QuotesPostRequestFormSubscriptionDataTrialPeriodDaysXc8000420 {
            val inspection = inspectInlineV1QuotesPostRequestFormSubscriptionDataTrialPeriodDaysXc8000420(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1QuotesPostRequestFormSubscriptionDataTrialPeriodDaysXc8000420NoMatchException(
                    "InlineV1QuotesPostRequestFormSubscriptionDataTrialPeriodDaysXc8000420 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1QuotesPostRequestFormSubscriptionDataTrialPeriodDaysXc8000420> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1QuotesPostRequestFormSubscriptionDataTrialPeriodDaysXc8000420,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1QuotesPostRequestFormSubscriptionDataTrialPeriodDaysXc8000420",
...
private fun inspectInlineV1QuotesPostRequestFormSubscriptionDataTrialPeriodDaysXc8000420(
    element: JsonElement,
): InlineV1QuotesPostRequestFormSubscriptionDataTrialPeriodDaysXc8000420Inspection {
    val matchesBranch1 = element.isJsonDecodable<Int>()
    val matchesInlineV1QuotesPostRequestFormSubscriptionDataTrialPeriodDaysAnyOf2X48a8e632 =
        element
            .isJsonDecodable<InlineV1QuotesPostRequestFormSubscriptionDataTrialPeriodDaysAnyOf2X48a8e632>()
    return InlineV1QuotesPostRequestFormSubscriptionDataTrialPeriodDaysXc8000420Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1QuotesPostRequestFormSubscriptionDataTrialPeriodDaysAnyOf2X48a8e632) {
                    add(
                        "InlineV1QuotesPostRequestFormSubscriptionDataTrialPeriodDaysAnyOf2X48a8e632: value does not match InlineV1QuotesPostRequestFormSubscriptionDataTrialPeriodDaysAnyOf2X48a8e632",
                    )
                }
            },
    )
