...
public sealed class InlineInvoicesPaymentsInvoicePaymentAssociatedPaymentTypeX71d5b3e0 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineInvoicesPaymentsInvoicePaymentAssociatedPaymentTypeX71d5b3e0 =
            when (value) {
                Charge.value -> Charge
    ...
    public object Serializer : KSerializer<InlineInvoicesPaymentsInvoicePaymentAssociatedPaymentTypeX71d5b3e0> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineInvoicesPaymentsInvoicePaymentAssociatedPaymentTypeX71d5b3e0",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineInvoicesPaymentsInvoicePaymentAssociatedPaymentTypeX71d5b3e0 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineInvoicesPaymentsInvoicePaymentAssociatedPaymentTypeX71d5b3e0,
        ) {
