...
public sealed class InlineV1PaymentIntentsPostRequestFormPreferredLocaleXafc786e6 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1PaymentIntentsPostRequestFormPreferredLocaleXafc786e6 =
            when (value) {
                CsCz.value -> CsCz
                DaDk.value -> DaDk
                DeAt.value -> DeAt
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormPreferredLocaleXafc786e6> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1PaymentIntentsPostRequestFormPreferredLocaleXafc786e6",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1PaymentIntentsPostRequestFormPreferredLocaleXafc786e6 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormPreferredLocaleXafc786e6,
        ) {
