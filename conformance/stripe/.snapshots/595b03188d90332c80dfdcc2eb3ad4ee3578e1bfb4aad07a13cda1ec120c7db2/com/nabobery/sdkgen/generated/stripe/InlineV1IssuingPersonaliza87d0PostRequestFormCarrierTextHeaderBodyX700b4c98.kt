...
internal data class InlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextHeaderBodyX700b4c98Inspection(
    ...
    public val matchesInlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextAnyOf1AnyOf2X05daa425: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextAnyOf1AnyOf2X05daa425,
            ).count {
                it
            }
}
...
public class InlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextHeaderBodyX700b4c98 internal constructor(
    ...
    private val inspection: InlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextHeaderBodyX700b4c98Inspection,
) {
    ...
    public val inlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextAnyOf1AnyOf2X05daa425:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextAnyOf1AnyOf2X05daa425) {
                json
                    .decodeFromJsonElement<InlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextAnyOf1AnyOf2X05daa425>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextHeaderBodyX700b4c98Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextAnyOf1AnyOf2X05daa425) {
                    add(
                        InlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextHeaderBodyX700b4c98Branch.InlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextAnyOf1AnyOf2X05daa425,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextHeaderBodyX700b4c98 {
            val inspection = inspectInlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextHeaderBodyX700b4c98(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextHeaderBodyX700b4c98NoMatchException(
                    "InlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextHeaderBodyX700b4c98 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextHeaderBodyX700b4c98> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextHeaderBodyX700b4c98,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextHeaderBodyX700b4c98",
...
private fun inspectInlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextHeaderBodyX700b4c98(
    element: JsonElement,
): InlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextHeaderBodyX700b4c98Inspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextAnyOf1AnyOf2X05daa425 =
        element
            .isJsonDecodable<InlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextAnyOf1AnyOf2X05daa425>()
    return InlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextHeaderBodyX700b4c98Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextAnyOf1AnyOf2X05daa425) {
                    add(
                        "InlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextAnyOf1AnyOf2X05daa425: value does not match InlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextAnyOf1AnyOf2X05daa425",
                    )
                }
            },
    )
