...
public class InlineV1TestHelpersIssuing214aPostRequestFormMerchantDisputeRiskXb00c758c(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1TestHelpersIssuing214aPostRequestFormMerchantDisputeRiskXb00c758c = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TestHelpersIssuing214aPostRequestFormMerchantDisputeRiskXb00c758c> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TestHelpersIssuing214aPostRequestFormMerchantDisputeRiskXb00c758c must be a JSON object",
                    )
            val level =
                json.decodeRequired<InlineV1TestHelpersIssuing214aPostRequestFormRiskAssessmentLevelX9b108321>(
                    rawObject,
                    "level",
                )
            return InlineV1TestHelpersIssuing214aPostRequestFormMerchantDisputeRiskXb00c758c(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TestHelpersIssuing214aPostRequestFormMerchantDisputeRiskXb00c758c,
        ) {
            val jsonEncoder =
...
public fun inlineV1TestHelpersIssuing214aPostRequestFormMerchantDisputeRiskXb00c758c(
    block: InlineV1TestHelpersIssuing214aPostRequestFormMerchantDisputeRiskXb00c758c.Builder.() -> Unit,
): InlineV1TestHelpersIssuing214aPostRequestFormMerchantDisputeRiskXb00c758c =
    InlineV1TestHelpersIssuing214aPostRequestFormMerchantDisputeRiskXb00c758c.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TestHelpersIssuing214aPostRequestFormMerchantDisputeRiskXb00c758c is missing required property '" +
                    name +
                    "'",
            )
