...
public class InlineCustomerSubscriptionsX194943c7(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineCustomerSubscriptionsX194943c7 =
    ...
    public object Serializer : KSerializer<InlineCustomerSubscriptionsX194943c7> {
        ...
        override fun deserialize(decoder: Decoder): InlineCustomerSubscriptionsX194943c7 {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("InlineCustomerSubscriptionsX194943c7 must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineCustomerSubscriptionsX194943c7,
        ) {
...
public fun inlineCustomerSubscriptionsX194943c7(
    block: InlineCustomerSubscriptionsX194943c7.Builder.() -> Unit,
): InlineCustomerSubscriptionsX194943c7 = InlineCustomerSubscriptionsX194943c7.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineCustomerSubscriptionsX194943c7 is missing required property '" + name + "'",
            )
