...
public class InsightsResourcesPaymentEvaluationOutcome(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InsightsResourcesPaymentEvaluationOutcome =
    ...
    public object Serializer : KSerializer<InsightsResourcesPaymentEvaluationOutcome> {
        ...
        override fun deserialize(decoder: Decoder): InsightsResourcesPaymentEvaluationOutcome {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("InsightsResourcesPaymentEvaluationOutcome must be a JSON object")
            val type =
                json.decodeRequired<InlineInsightsResourcesPaymentEvaluationOutcomeTypeXdeb70113>(
                    rawObject,
                    "type",
                )
            return InsightsResourcesPaymentEvaluationOutcome(
                type = type,
                merchantBlocked =
                    rawObject["merchant_blocked"]?.let {
                        json.decodeFromJsonElement<InsightsResourcesPaymentEvaluationMerchantBlocked>(it)
                    },
                paymentIntentId = rawObject["payment_intent_id"]?.let { json.decodeFromJsonElement<String>(it) },
                rejected =
                    rawObject["rejected"]?.let {
                        json.decodeFromJsonElement<InsightsResourcesPaymentEvaluationRejected>(
                            it,
                        )
                    },
                succeeded =
                    rawObject["succeeded"]?.let {
                        json
                            .decodeFromJsonElement<InsightsResourcesPaymentEvaluationSucceeded>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InsightsResourcesPaymentEvaluationOutcome,
        ) {
...
public fun insightsResourcesPaymentEvaluationOutcome(
    block: InsightsResourcesPaymentEvaluationOutcome.Builder.() -> Unit,
): InsightsResourcesPaymentEvaluationOutcome = InsightsResourcesPaymentEvaluationOutcome.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InsightsResourcesPaymentEvaluationOutcome is missing required property '" + name + "'",
            )
