...
public class InlineV1CustomersBankAccountsPostRequestFormBankAccountAnyOf1X8ded6596(
    ...
    public val accountHolderType: InlineV1CustomersBankAccountsPostRequestFormAccountHolderTypeXd8298fcb? = null,
    public val currency: String? = null,
    public val objectValue: InlineV1CustomersBankAccountsPostRequestFormBankAccountObjectValueX41f830a9? = null,
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1CustomersBankAccountsPostRequestFormBankAccountAnyOf1X8ded6596 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1CustomersBankAccountsPostRequestFormBankAccountAnyOf1X8ded6596> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CustomersBankAccountsPostRequestFormBankAccountAnyOf1X8ded6596 must be a JSON object",
                    )
            ...
            return InlineV1CustomersBankAccountsPostRequestFormBankAccountAnyOf1X8ded6596(
                ...
                accountHolderType =
                    rawObject["account_holder_type"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CustomersBankAccountsPostRequestFormAccountHolderTypeXd8298fcb>(
                                it,
                            )
                    },
                ...
                objectValue =
                    rawObject["object"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CustomersBankAccountsPostRequestFormBankAccountObjectValueX41f830a9>(
                                it,
                            )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersBankAccountsPostRequestFormBankAccountAnyOf1X8ded6596,
        ) {
            val jsonEncoder =
...
public fun inlineV1CustomersBankAccountsPostRequestFormBankAccountAnyOf1X8ded6596(
    block: InlineV1CustomersBankAccountsPostRequestFormBankAccountAnyOf1X8ded6596.Builder.() -> Unit,
): InlineV1CustomersBankAccountsPostRequestFormBankAccountAnyOf1X8ded6596 =
    InlineV1CustomersBankAccountsPostRequestFormBankAccountAnyOf1X8ded6596.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1CustomersBankAccountsPostRequestFormBankAccountAnyOf1X8ded6596 is missing required property '" +
                    name +
                    "'",
            )
