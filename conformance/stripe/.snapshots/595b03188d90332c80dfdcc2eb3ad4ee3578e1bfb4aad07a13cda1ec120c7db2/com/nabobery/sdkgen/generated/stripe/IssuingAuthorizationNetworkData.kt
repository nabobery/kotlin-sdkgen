...
public class IssuingAuthorizationNetworkData(
    ...
    public class Builder {
        ...
        public fun build(): IssuingAuthorizationNetworkData =
    ...
    public object Serializer : KSerializer<IssuingAuthorizationNetworkData> {
        ...
        override fun deserialize(decoder: Decoder): IssuingAuthorizationNetworkData {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("IssuingAuthorizationNetworkData must be a JSON object")
            return IssuingAuthorizationNetworkData(
                acquiringInstitutionId =
                    rawObject["acquiring_institution_id"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                systemTraceAuditNumber =
                    rawObject["system_trace_audit_number"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: IssuingAuthorizationNetworkData,
        ) {
...
public fun issuingAuthorizationNetworkData(
    block: IssuingAuthorizationNetworkData.Builder.() -> Unit,
): IssuingAuthorizationNetworkData = IssuingAuthorizationNetworkData.build(block)
