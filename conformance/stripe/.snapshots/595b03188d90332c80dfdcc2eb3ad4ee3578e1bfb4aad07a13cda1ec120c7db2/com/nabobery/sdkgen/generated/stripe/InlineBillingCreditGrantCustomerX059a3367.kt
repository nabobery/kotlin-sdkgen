...
public class InlineBillingCreditGrantCustomerX059a3367 internal constructor(
        ...
        get() =
            buildSet {
                ...
                if (inspection.matchesDeletedCustomer) {
                    add(
                        InlineBillingCreditGrantCustomerX059a3367Branch.DeletedCustomer,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineBillingCreditGrantCustomerX059a3367 {
            val inspection = inspectInlineBillingCreditGrantCustomerX059a3367(raw)
            if (inspection.matchCount == 0) {
                throw InlineBillingCreditGrantCustomerX059a3367NoMatchException(
                    "InlineBillingCreditGrantCustomerX059a3367 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineBillingCreditGrantCustomerX059a3367> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineBillingCreditGrantCustomerX059a3367,
        ) {
...
private fun inspectInlineBillingCreditGrantCustomerX059a3367(
    element: JsonElement,
): InlineBillingCreditGrantCustomerX059a3367Inspection {
