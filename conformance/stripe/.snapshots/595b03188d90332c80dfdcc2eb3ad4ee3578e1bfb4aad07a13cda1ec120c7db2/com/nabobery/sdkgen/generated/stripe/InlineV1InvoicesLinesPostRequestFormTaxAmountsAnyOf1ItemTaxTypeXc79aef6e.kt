...
public sealed class InlineV1InvoicesLinesPostRequestFormTaxAmountsAnyOf1ItemTaxTypeXc79aef6e {
    ...
    public object Serializer : KSerializer<InlineV1InvoicesLinesPostRequestFormTaxAmountsAnyOf1ItemTaxTypeXc79aef6e> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1InvoicesLinesPostRequestFormTaxAmountsAnyOf1ItemTaxTypeXc79aef6e",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1InvoicesLinesPostRequestFormTaxAmountsAnyOf1ItemTaxTypeXc79aef6e = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesLinesPostRequestFormTaxAmountsAnyOf1ItemTaxTypeXc79aef6e,
        ) {
