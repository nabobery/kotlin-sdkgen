...
public sealed class InlineV1InvoicesPostRequestFormCollectionMethodX6930c6ee {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1InvoicesPostRequestFormCollectionMethodX6930c6ee =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1InvoicesPostRequestFormCollectionMethodX6930c6ee> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1InvoicesPostRequestFormCollectionMethodX6930c6ee",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1InvoicesPostRequestFormCollectionMethodX6930c6ee =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesPostRequestFormCollectionMethodX6930c6ee,
        ) {
