...
public sealed class InlineV1PaymentIntentsPostRequestFormPreferredLanguageXf2a88b83 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1PaymentIntentsPostRequestFormPreferredLanguageXf2a88b83 =
            when (value) {
                Value.value -> Value
                De.value -> De
                En.value -> En
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormPreferredLanguageXf2a88b83> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1PaymentIntentsPostRequestFormPreferredLanguageXf2a88b83",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1PaymentIntentsPostRequestFormPreferredLanguageXf2a88b83 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormPreferredLanguageXf2a88b83,
        ) {
