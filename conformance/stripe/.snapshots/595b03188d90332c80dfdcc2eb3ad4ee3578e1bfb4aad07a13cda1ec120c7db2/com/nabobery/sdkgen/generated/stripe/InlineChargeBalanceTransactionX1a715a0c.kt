...
public class InlineChargeBalanceTransactionX1a715a0c internal constructor(
        ...
        get() =
            buildSet {
                ...
                if (inspection.matchesBalanceTransaction) {
                    add(
                        InlineChargeBalanceTransactionX1a715a0cBranch.BalanceTransaction,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineChargeBalanceTransactionX1a715a0c {
            val inspection = inspectInlineChargeBalanceTransactionX1a715a0c(raw)
            if (inspection.matchCount == 0) {
                throw InlineChargeBalanceTransactionX1a715a0cNoMatchException(
                    "InlineChargeBalanceTransactionX1a715a0c matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineChargeBalanceTransactionX1a715a0c> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineChargeBalanceTransactionX1a715a0c,
        ) {
...
private fun inspectInlineChargeBalanceTransactionX1a715a0c(
    element: JsonElement,
): InlineChargeBalanceTransactionX1a715a0cInspection {
