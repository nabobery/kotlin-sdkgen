...
public class PaymentIntentProcessing(
    ...
    public object Serializer : KSerializer<PaymentIntentProcessing> {
        ...
        override fun deserialize(decoder: Decoder): PaymentIntentProcessing {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentIntentProcessing must be a JSON object")
...
public fun paymentIntentProcessing(block: PaymentIntentProcessing.Builder.() -> Unit): PaymentIntentProcessing =
    PaymentIntentProcessing.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("PaymentIntentProcessing is missing required property '" + name + "'")
