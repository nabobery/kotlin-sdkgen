...
public sealed class InlineDisputeVisaCompellinb4beMerchandiseOrServicesX2426c79d {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineDisputeVisaCompellinb4beMerchandiseOrServicesX2426c79d =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineDisputeVisaCompellinb4beMerchandiseOrServicesX2426c79d> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineDisputeVisaCompellinb4beMerchandiseOrServicesX2426c79d",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineDisputeVisaCompellinb4beMerchandiseOrServicesX2426c79d =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineDisputeVisaCompellinb4beMerchandiseOrServicesX2426c79d,
        ) {
