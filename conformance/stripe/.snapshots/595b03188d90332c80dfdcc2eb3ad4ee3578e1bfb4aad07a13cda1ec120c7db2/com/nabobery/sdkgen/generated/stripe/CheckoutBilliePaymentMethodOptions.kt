...
public class CheckoutBilliePaymentMethodOptions(
    ...
    public class Builder {
        ...
        public fun build(): CheckoutBilliePaymentMethodOptions =
    ...
    public object Serializer : KSerializer<CheckoutBilliePaymentMethodOptions> {
        ...
        override fun deserialize(decoder: Decoder): CheckoutBilliePaymentMethodOptions {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("CheckoutBilliePaymentMethodOptions must be a JSON object")
            return CheckoutBilliePaymentMethodOptions(
                captureMethod =
                    rawObject["capture_method"]?.let {
                        json.decodeFromJsonElement<InlineCheckoutBilliePaymentMethodOptionsCaptureMethodXfbb7eb44>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: CheckoutBilliePaymentMethodOptions,
        ) {
...
public fun checkoutBilliePaymentMethodOptions(
    block: CheckoutBilliePaymentMethodOptions.Builder.() -> Unit,
): CheckoutBilliePaymentMethodOptions = CheckoutBilliePaymentMethodOptions.build(block)
