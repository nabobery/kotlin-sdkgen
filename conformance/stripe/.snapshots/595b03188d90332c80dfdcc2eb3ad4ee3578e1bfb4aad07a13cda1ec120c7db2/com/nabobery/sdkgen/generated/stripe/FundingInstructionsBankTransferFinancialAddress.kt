...
public class FundingInstructionsBankTransferFinancialAddress(
     ...
     */
    public val supportedNetworks: List<InlineFundingInstructionsBab6cSupportedNetworksItemXc6d5f234>? = null,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): FundingInstructionsBankTransferFinancialAddress =
    ...
    public object Serializer : KSerializer<FundingInstructionsBankTransferFinancialAddress> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "FundingInstructionsBankTransferFinancialAddress must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineFundingInstructionsBankTransferFinancialAddressTypeX08176dec>(
                    rawObject,
                    "type",
                )
            return FundingInstructionsBankTransferFinancialAddress(
                ...
                aba =
                    rawObject["aba"]?.let {
                        json.decodeFromJsonElement<FundingInstructionsBankTransferAbaRecord>(
                            it,
                        )
                    },
                iban =
                    rawObject["iban"]?.let {
                        json.decodeFromJsonElement<FundingInstructionsBankTransferIbanRecord>(
                            it,
                        )
                    },
                sortCode =
                    rawObject["sort_code"]?.let {
                        json.decodeFromJsonElement<FundingInstructionsBankTransferSortCodeRecord>(it)
                    },
                spei =
                    rawObject["spei"]?.let {
                        json
                            .decodeFromJsonElement<FundingInstructionsBankTransferSpeiRecord>(
                                it,
                            )
                    },
                supportedNetworks =
                    rawObject["supported_networks"]?.let {
                        json.decodeFromJsonElement<List<InlineFundingInstructionsBab6cSupportedNetworksItemXc6d5f234>>(
                            it,
                        )
                    },
                swift =
                    rawObject["swift"]?.let {
                        json
                            .decodeFromJsonElement<FundingInstructionsBankTransferSwiftRecord>(
                                it,
                            )
                    },
                zengin =
                    rawObject["zengin"]?.let {
                        json.decodeFromJsonElement<FundingInstructionsBankTransferZenginRecord>(
                            it,
                        )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: FundingInstructionsBankTransferFinancialAddress,
        ) {
...
public fun fundingInstructionsBankTransferFinancialAddress(
    block: FundingInstructionsBankTransferFinancialAddress.Builder.() -> Unit,
): FundingInstructionsBankTransferFinancialAddress = FundingInstructionsBankTransferFinancialAddress.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "FundingInstructionsBankTransferFinancialAddress is missing required property '" + name + "'",
            )
