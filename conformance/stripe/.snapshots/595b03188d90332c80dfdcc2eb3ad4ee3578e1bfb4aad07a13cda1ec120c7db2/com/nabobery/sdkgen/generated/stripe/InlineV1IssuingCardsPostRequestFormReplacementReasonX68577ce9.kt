...
public sealed class InlineV1IssuingCardsPostRequestFormReplacementReasonX68577ce9 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1IssuingCardsPostRequestFormReplacementReasonX68577ce9 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1IssuingCardsPostRequestFormReplacementReasonX68577ce9> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1IssuingCardsPostRequestFormReplacementReasonX68577ce9",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1IssuingCardsPostRequestFormReplacementReasonX68577ce9 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingCardsPostRequestFormReplacementReasonX68577ce9,
        ) {
