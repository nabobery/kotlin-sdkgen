...
public class SetupIntentPaymentMethodOptions(
    ...
    public class Builder {
        ...
        public fun build(): SetupIntentPaymentMethodOptions =
    ...
    public object Serializer : KSerializer<SetupIntentPaymentMethodOptions> {
        ...
        override fun deserialize(decoder: Decoder): SetupIntentPaymentMethodOptions {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("SetupIntentPaymentMethodOptions must be a JSON object")
            return SetupIntentPaymentMethodOptions(
                acssDebit =
                    rawObject["acss_debit"]?.let {
                        json.decodeFromJsonElement<InlineSetupIntentPaymentMethodOptionsAcssDebitXf3d899ff>(it)
                    },
                amazonPay =
                    rawObject["amazon_pay"]?.let {
                        json.decodeFromJsonElement<InlineSetupIntentPaymentMethodOptionsAmazonPayXa8ec01bc>(it)
                    },
                bacsDebit =
                    rawObject["bacs_debit"]?.let {
                        json.decodeFromJsonElement<InlineSetupIntentPaymentMethodOptionsBacsDebitX38d2e5ee>(it)
                    },
                bizum =
                    rawObject["bizum"]?.let {
                        json
                            .decodeFromJsonElement<InlineSetupIntentPaymentMethodOptionsBizumXc2426f62>(
                                it,
                            )
                    },
                card =
                    rawObject["card"]?.let {
                        json.decodeFromJsonElement<InlineSetupIntentPaymentMethodOptionsCardX1bde7ae7>(
                            it,
                        )
                    },
                cardPresent =
                    rawObject["card_present"]?.let {
                        json.decodeFromJsonElement<InlineSetupIntentPaymentMethodOptionsCardPresentX4f7f4732>(it)
                    },
                klarna =
                    rawObject["klarna"]?.let {
                        json.decodeFromJsonElement<InlineSetupIntentPaymentMethodOptionsKlarnaX26380683>(it)
                    },
                link =
                    rawObject["link"]?.let {
                        json.decodeFromJsonElement<InlineSetupIntentPaymentMethodOptionsLinkXfe65c0b1>(
                            it,
                        )
                    },
                paypal =
                    rawObject["paypal"]?.let {
                        json.decodeFromJsonElement<InlineSetupIntentPaymentMethodOptionsPaypalX322a769b>(it)
                    },
                payto =
                    rawObject["payto"]?.let {
                        json
                            .decodeFromJsonElement<InlineSetupIntentPaymentMethodOptionsPaytoXcf06bc91>(
                                it,
                            )
                    },
                pix =
                    rawObject["pix"]?.let {
                        json.decodeFromJsonElement<InlineSetupIntentPaymentMethodOptionsPixXc852d205>(
                            it,
                        )
                    },
                sepaDebit =
                    rawObject["sepa_debit"]?.let {
                        json.decodeFromJsonElement<InlineSetupIntentPaymentMethodOptionsSepaDebitXc6bc6829>(it)
                    },
                upi =
                    rawObject["upi"]?.let {
                        json.decodeFromJsonElement<InlineSetupIntentPaymentMethodOptionsUpiXc80d642e>(
                            it,
                        )
                    },
                usBankAccount =
                    rawObject["us_bank_account"]?.let {
                        json.decodeFromJsonElement<InlineSetupIntentPaymentMethodOptionsUsBankAccountXf393a554>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: SetupIntentPaymentMethodOptions,
        ) {
...
public fun setupIntentPaymentMethodOptions(
    block: SetupIntentPaymentMethodOptions.Builder.() -> Unit,
): SetupIntentPaymentMethodOptions = SetupIntentPaymentMethodOptions.build(block)
