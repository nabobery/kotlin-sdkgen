...
public class InlineV1TreasuryFinancialAc862PostRequestFormFeaturesOutboundPaymentsX4fad88c8(
    ...
    public val usDomesticWire: InlineV1TreasuryFinancialAc862PostRequestFormFeaturesUsDomesticWireX38db6b72? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1TreasuryFinancialAc862PostRequestFormFeaturesOutboundPaymentsX4fad88c8 =
            InlineV1TreasuryFinancialAc862PostRequestFormFeaturesOutboundPaymentsX4fad88c8(
                ach = ach,
    ...
    public object Serializer : KSerializer<InlineV1TreasuryFinancialAc862PostRequestFormFeaturesOutboundPaymentsX4fad88c8> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TreasuryFinancialAc862PostRequestFormFeaturesOutboundPaymentsX4fad88c8 must be a JSON object",
                    )
            return InlineV1TreasuryFinancialAc862PostRequestFormFeaturesOutboundPaymentsX4fad88c8(
                ach =
                    rawObject["ach"]?.let {
                        json.decodeFromJsonElement<InlineV1TreasuryFinancialAc862PostRequestFormFeaturesAchXf7ae6f5e>(
                            it,
                        )
                    },
                usDomesticWire =
                    rawObject["us_domestic_wire"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TreasuryFinancialAc862PostRequestFormFeaturesUsDomesticWireX38db6b72>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TreasuryFinancialAc862PostRequestFormFeaturesOutboundPaymentsX4fad88c8,
        ) {
            val jsonEncoder =
...
public fun inlineV1TreasuryFinancialAc862PostRequestFormFeaturesOutboundPaymentsX4fad88c8(
    block: InlineV1TreasuryFinancialAc862PostRequestFormFeaturesOutboundPaymentsX4fad88c8.Builder.() -> Unit,
): InlineV1TreasuryFinancialAc862PostRequestFormFeaturesOutboundPaymentsX4fad88c8 =
