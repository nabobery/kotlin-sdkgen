...
public sealed class InlineMandateAcssDebitTransactionTypeXaf9f9ebd {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineMandateAcssDebitTransactionTypeXaf9f9ebd =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineMandateAcssDebitTransactionTypeXaf9f9ebd> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineMandateAcssDebitTransactionTypeXaf9f9ebd",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineMandateAcssDebitTransactionTypeXaf9f9ebd =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineMandateAcssDebitTransactionTypeXaf9f9ebd,
        ) {
