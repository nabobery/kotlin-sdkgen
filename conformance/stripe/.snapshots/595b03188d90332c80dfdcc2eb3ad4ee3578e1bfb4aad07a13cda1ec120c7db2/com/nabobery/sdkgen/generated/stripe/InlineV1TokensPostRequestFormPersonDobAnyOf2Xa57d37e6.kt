...
public sealed class InlineV1TokensPostRequestFormPersonDobAnyOf2Xa57d37e6 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1TokensPostRequestFormPersonDobAnyOf2Xa57d37e6 =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1TokensPostRequestFormPersonDobAnyOf2Xa57d37e6> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1TokensPostRequestFormPersonDobAnyOf2Xa57d37e6",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1TokensPostRequestFormPersonDobAnyOf2Xa57d37e6 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TokensPostRequestFormPersonDobAnyOf2Xa57d37e6,
        ) {
