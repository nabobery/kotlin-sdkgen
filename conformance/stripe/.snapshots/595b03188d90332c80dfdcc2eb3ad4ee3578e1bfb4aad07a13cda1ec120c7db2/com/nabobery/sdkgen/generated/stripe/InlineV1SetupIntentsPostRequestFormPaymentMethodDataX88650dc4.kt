...
public class InlineV1SetupIntentsPostRequestFormPaymentMethodDataX88650dc4(
    ...
    public val acssDebit: InlineV1SetupIntentsPostRequestFormPaymentMethodDataAcssDebitXa150e135? = null,
    public val affirm: JsonObject? = null,
    public val afterpayClearpay: JsonObject? = null,
    public val alipay: JsonObject? = null,
    public val allowRedisplay: InlineV1SetupIntentsPostRequestFormPaymentMethodDataAllowRedisplayXbc4a53d1? = null,
    public val alma: JsonObject? = null,
    public val amazonPay: JsonObject? = null,
    public val auBecsDebit: InlineV1SetupIntentsPostRequestFormPaymentMethodDataAuBecsDebitXba3e0e67? = null,
    public val bacsDebit: InlineV1SetupIntentsPostRequestFormPaymentMethodDataBacsDebitXd0cf9854? = null,
    public val bancontact: JsonObject? = null,
    public val billie: JsonObject? = null,
    public val billingDetails: InlineV1SetupIntentsPostRequestFormPaymentMethodDataBillingDetailsX6d3a4332? = null,
    ...
    public val naverPay: InlineV1SetupIntentsPostRequestFormPaymentMethodDataNaverPayX00c78b3a? = null,
    public val nzBankAccount: InlineV1SetupIntentsPostRequestFormPaymentMethodDataNzBankAccountX3be81a6a? = null,
    ...
    public val radarOptions: InlineV1SetupIntentsPostRequestFormPaymentMethodDataRadarOptionsX17f4f941? = null,
    ...
    public val sepaDebit: InlineV1SetupIntentsPostRequestFormPaymentMethodDataSepaDebitX91d1265b? = null,
    ...
    public val usBankAccount: InlineV1SetupIntentsPostRequestFormPaymentMethodDataUsBankAccountX0a0824d0? = null,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1SetupIntentsPostRequestFormPaymentMethodDataX88650dc4 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1SetupIntentsPostRequestFormPaymentMethodDataX88650dc4> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1SetupIntentsPostRequestFormPaymentMethodDataX88650dc4 {
            val jsonDecoder =
                decoder.requireJsonDecoder(
                    "InlineV1SetupIntentsPostRequestFormPaymentMethodDataX88650dc4",
                )
            val json = jsonDecoder.json
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SetupIntentsPostRequestFormPaymentMethodDataX88650dc4 must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineV1SetupIntentsPostRequestFormPaymentMethodDataTypeXab1c7293>(
                    rawObject,
                    "type",
                )
            return InlineV1SetupIntentsPostRequestFormPaymentMethodDataX88650dc4(
                ...
                acssDebit =
                    rawObject["acss_debit"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodDataAcssDebitXa150e135>(
                                it,
                            )
                    },
                ...
                allowRedisplay =
                    rawObject["allow_redisplay"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodDataAllowRedisplayXbc4a53d1>(
                                it,
                            )
                    },
                ...
                auBecsDebit =
                    rawObject["au_becs_debit"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodDataAuBecsDebitXba3e0e67>(
                                it,
                            )
                    },
                bacsDebit =
                    rawObject["bacs_debit"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodDataBacsDebitXd0cf9854>(
                                it,
                            )
                    },
                ...
                billingDetails =
                    rawObject["billing_details"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodDataBillingDetailsX6d3a4332>(
                                it,
                            )
                    },
                ...
                boleto =
                    rawObject["boleto"]?.let {
                        json.decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodDataBoletoX727514d7>(
                            it,
                        )
                    },
                ...
                eps =
                    rawObject["eps"]?.let {
                        json.decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodDataEpsX43356294>(it)
                    },
                fpx =
                    rawObject["fpx"]?.let {
                        json.decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodDataFpxXcfceaf6f>(it)
                    },
                ...
                ideal =
                    rawObject["ideal"]?.let {
                        json.decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodDataIdealXc006f781>(
                            it,
                        )
                    },
                ...
                klarna =
                    rawObject["klarna"]?.let {
                        json.decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodDataKlarnaX6ac53435>(
                            it,
                        )
                    },
                ...
                naverPay =
                    rawObject["naver_pay"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodDataNaverPayX00c78b3a>(
                                it,
                            )
                    },
                nzBankAccount =
                    rawObject["nz_bank_account"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodDataNzBankAccountX3be81a6a>(
                                it,
                            )
                    },
                ...
                p24 =
                    rawObject["p24"]?.let {
                        json.decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodDataP24X3106d2d3>(it)
                    },
                ...
                payto =
                    rawObject["payto"]?.let {
                        json.decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodDataPaytoX4c7bd026>(
                            it,
                        )
                    },
                ...
                radarOptions =
                    rawObject["radar_options"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodDataRadarOptionsX17f4f941>(
                                it,
                            )
                    },
                ...
                sepaDebit =
                    rawObject["sepa_debit"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodDataSepaDebitX91d1265b>(
                                it,
                            )
                    },
                sofort =
                    rawObject["sofort"]?.let {
                        json.decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodDataSofortX6b17c117>(
                            it,
                        )
                    },
                ...
                upi =
                    rawObject["upi"]?.let {
                        json.decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodDataUpiXee1ce1c6>(it)
                    },
                usBankAccount =
                    rawObject["us_bank_account"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodDataUsBankAccountX0a0824d0>(
                                it,
                            )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SetupIntentsPostRequestFormPaymentMethodDataX88650dc4,
        ) {
            val jsonEncoder =
...
public fun inlineV1SetupIntentsPostRequestFormPaymentMethodDataX88650dc4(
    block: InlineV1SetupIntentsPostRequestFormPaymentMethodDataX88650dc4.Builder.() -> Unit,
): InlineV1SetupIntentsPostRequestFormPaymentMethodDataX88650dc4 =
    InlineV1SetupIntentsPostRequestFormPaymentMethodDataX88650dc4.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1SetupIntentsPostRequestFormPaymentMethodDataX88650dc4 is missing required property '" + name +
                    "'",
            )
