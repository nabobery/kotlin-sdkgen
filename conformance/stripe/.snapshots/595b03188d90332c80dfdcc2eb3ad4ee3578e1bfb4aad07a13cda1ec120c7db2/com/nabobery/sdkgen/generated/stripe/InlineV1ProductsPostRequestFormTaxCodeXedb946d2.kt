...
public class InlineV1ProductsPostRequestFormTaxCodeXedb946d2 internal constructor(
    ...
    public val inlineV1ProductsPostRequestFormTaxCodeAnyOf2X53ab3bde:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1ProductsPostRequestFormTaxCodeAnyOf2X53ab3bde) {
                json
                    .decodeFromJsonElement<InlineV1ProductsPostRequestFormTaxCodeAnyOf2X53ab3bde>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1ProductsPostRequestFormTaxCodeXedb946d2Branch>
        get() =
            buildSet {
                ...
                if (inspection.matchesInlineV1ProductsPostRequestFormTaxCodeAnyOf2X53ab3bde) {
                    add(
                        InlineV1ProductsPostRequestFormTaxCodeXedb946d2Branch.InlineV1ProductsPostRequestFormTaxCodeAnyOf2X53ab3bde,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1ProductsPostRequestFormTaxCodeXedb946d2 {
            val inspection = inspectInlineV1ProductsPostRequestFormTaxCodeXedb946d2(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1ProductsPostRequestFormTaxCodeXedb946d2NoMatchException(
                    "InlineV1ProductsPostRequestFormTaxCodeXedb946d2 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1ProductsPostRequestFormTaxCodeXedb946d2> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ProductsPostRequestFormTaxCodeXedb946d2,
        ) {
...
private fun inspectInlineV1ProductsPostRequestFormTaxCodeXedb946d2(
    element: JsonElement,
): InlineV1ProductsPostRequestFormTaxCodeXedb946d2Inspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1ProductsPostRequestFormTaxCodeAnyOf2X53ab3bde =
        element
            .isJsonDecodable<InlineV1ProductsPostRequestFormTaxCodeAnyOf2X53ab3bde>()
    return InlineV1ProductsPostRequestFormTaxCodeXedb946d2Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1ProductsPostRequestFormTaxCodeAnyOf2X53ab3bde) {
                    add(
                        "InlineV1ProductsPostRequestFormTaxCodeAnyOf2X53ab3bde: value does not match InlineV1ProductsPostRequestFormTaxCodeAnyOf2X53ab3bde",
                    )
                }
            },
    )
