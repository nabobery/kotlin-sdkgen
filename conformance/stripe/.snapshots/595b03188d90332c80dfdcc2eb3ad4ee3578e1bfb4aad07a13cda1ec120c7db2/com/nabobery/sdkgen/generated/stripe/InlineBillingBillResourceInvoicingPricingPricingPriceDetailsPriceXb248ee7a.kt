...
public class InlineBillingBillResourceInvoicingPricingPricingPriceDetailsPriceXb248ee7a internal constructor(
    ...
    private val inspection: InlineBillingBillResourceInvoicingPricingPricingPriceDetailsPriceXb248ee7aInspection,
) {
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineBillingBillResourceInvoicingPricingPricingPriceDetailsPriceXb248ee7aBranch.Branch1,
                    )
                }
                if (inspection.matchesPrice) {
                    add(
                        InlineBillingBillResourceInvoicingPricingPricingPriceDetailsPriceXb248ee7aBranch.Price,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineBillingBillResourceInvoicingPricingPricingPriceDetailsPriceXb248ee7a {
            val inspection = inspectInlineBillingBillResourceInvoicingPricingPricingPriceDetailsPriceXb248ee7a(raw)
            if (inspection.matchCount == 0) {
                throw InlineBillingBillResourceInvoicingPricingPricingPriceDetailsPriceXb248ee7aNoMatchException(
                    "InlineBillingBillResourceInvoicingPricingPricingPriceDetailsPriceXb248ee7a matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineBillingBillResourceInvoicingPricingPricingPriceDetailsPriceXb248ee7a> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineBillingBillResourceInvoicingPricingPricingPriceDetailsPriceXb248ee7a,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineBillingBillResourceInvoicingPricingPricingPriceDetailsPriceXb248ee7a",
...
private fun inspectInlineBillingBillResourceInvoicingPricingPricingPriceDetailsPriceXb248ee7a(
    element: JsonElement,
