...
public class PaymentIntentNextActionKonbiniSeicomart(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentIntentNextActionKonbiniSeicomart =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentIntentNextActionKonbiniSeicomart> {
        ...
        override fun deserialize(decoder: Decoder): PaymentIntentNextActionKonbiniSeicomart {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentIntentNextActionKonbiniSeicomart must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentIntentNextActionKonbiniSeicomart,
        ) {
...
public fun paymentIntentNextActionKonbiniSeicomart(
    block: PaymentIntentNextActionKonbiniSeicomart.Builder.() -> Unit,
): PaymentIntentNextActionKonbiniSeicomart = PaymentIntentNextActionKonbiniSeicomart.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "PaymentIntentNextActionKonbiniSeicomart is missing required property '" + name + "'",
            )
