...
public class InlineV1AccountsPeoplePostRequestFormRelationshipX494ad25f(
    ...
    public val percentOwnership: InlineV1AccountsPeoplePostRequestFormRelationshipPercentOwnershipXe014d5b4? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1AccountsPeoplePostRequestFormRelationshipX494ad25f =
            InlineV1AccountsPeoplePostRequestFormRelationshipX494ad25f(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1AccountsPeoplePostRequestFormRelationshipX494ad25f =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1AccountsPeoplePostRequestFormRelationshipX494ad25f> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountsPeoplePostRequestFormRelationshipX494ad25f must be a JSON object",
                    )
            return InlineV1AccountsPeoplePostRequestFormRelationshipX494ad25f(
                ...
                percentOwnership =
                    rawObject["percent_ownership"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1AccountsPeoplePostRequestFormRelationshipPercentOwnershipXe014d5b4>(
                                it,
                            )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPeoplePostRequestFormRelationshipX494ad25f,
        ) {
...
public fun inlineV1AccountsPeoplePostRequestFormRelationshipX494ad25f(
    block: InlineV1AccountsPeoplePostRequestFormRelationshipX494ad25f.Builder.() -> Unit,
): InlineV1AccountsPeoplePostRequestFormRelationshipX494ad25f =
    InlineV1AccountsPeoplePostRequestFormRelationshipX494ad25f.build(block)
