...
public sealed class InlinePaymentMethodOptionsCardMandateOptionsAmountTypeX8e5d3777 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentMethodOptionsCardMandateOptionsAmountTypeX8e5d3777 =
            when (value) {
                Fixed.value -> Fixed
    ...
    public object Serializer : KSerializer<InlinePaymentMethodOptionsCardMandateOptionsAmountTypeX8e5d3777> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentMethodOptionsCardMandateOptionsAmountTypeX8e5d3777",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePaymentMethodOptionsCardMandateOptionsAmountTypeX8e5d3777 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentMethodOptionsCardMandateOptionsAmountTypeX8e5d3777,
        ) {
