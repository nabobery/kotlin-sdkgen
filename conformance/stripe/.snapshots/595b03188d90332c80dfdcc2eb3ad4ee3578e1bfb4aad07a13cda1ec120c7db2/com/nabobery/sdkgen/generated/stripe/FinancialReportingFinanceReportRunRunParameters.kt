...
public class FinancialReportingFinanceReportRunRunParameters(
    ...
    public class Builder {
        ...
        public fun build(): FinancialReportingFinanceReportRunRunParameters =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): FinancialReportingFinanceReportRunRunParameters =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<FinancialReportingFinanceReportRunRunParameters> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "FinancialReportingFinanceReportRunRunParameters must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: FinancialReportingFinanceReportRunRunParameters,
        ) {
...
public fun financialReportingFinanceReportRunRunParameters(
    block: FinancialReportingFinanceReportRunRunParameters.Builder.() -> Unit,
): FinancialReportingFinanceReportRunRunParameters = FinancialReportingFinanceReportRunRunParameters.build(block)
