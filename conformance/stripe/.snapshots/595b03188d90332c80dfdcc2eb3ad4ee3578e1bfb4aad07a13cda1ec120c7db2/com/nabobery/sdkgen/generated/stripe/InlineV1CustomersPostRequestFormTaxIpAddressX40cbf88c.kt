...
public class InlineV1CustomersPostRequestFormTaxIpAddressX40cbf88c internal constructor(
    ...
    public val inlineV1CustomersPostRequestFormTaxIpAddressAnyOf2X49c68947:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1CustomersPostRequestFormTaxIpAddressAnyOf2X49c68947) {
                json
                    .decodeFromJsonElement<InlineV1CustomersPostRequestFormTaxIpAddressAnyOf2X49c68947>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1CustomersPostRequestFormTaxIpAddressX40cbf88cBranch>
        get() =
            buildSet {
                ...
                if (inspection.matchesInlineV1CustomersPostRequestFormTaxIpAddressAnyOf2X49c68947) {
                    add(
                        InlineV1CustomersPostRequestFormTaxIpAddressX40cbf88cBranch.InlineV1CustomersPostRequestFormTaxIpAddressAnyOf2X49c68947,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1CustomersPostRequestFormTaxIpAddressX40cbf88c {
            val inspection = inspectInlineV1CustomersPostRequestFormTaxIpAddressX40cbf88c(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1CustomersPostRequestFormTaxIpAddressX40cbf88cNoMatchException(
                    "InlineV1CustomersPostRequestFormTaxIpAddressX40cbf88c matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1CustomersPostRequestFormTaxIpAddressX40cbf88c> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersPostRequestFormTaxIpAddressX40cbf88c,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1CustomersPostRequestFormTaxIpAddressX40cbf88c",
...
private fun inspectInlineV1CustomersPostRequestFormTaxIpAddressX40cbf88c(
    element: JsonElement,
): InlineV1CustomersPostRequestFormTaxIpAddressX40cbf88cInspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1CustomersPostRequestFormTaxIpAddressAnyOf2X49c68947 =
        element
            .isJsonDecodable<InlineV1CustomersPostRequestFormTaxIpAddressAnyOf2X49c68947>()
    return InlineV1CustomersPostRequestFormTaxIpAddressX40cbf88cInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1CustomersPostRequestFormTaxIpAddressAnyOf2X49c68947) {
                    add(
                        "InlineV1CustomersPostRequestFormTaxIpAddressAnyOf2X49c68947: value does not match InlineV1CustomersPostRequestFormTaxIpAddressAnyOf2X49c68947",
                    )
                }
            },
    )
