...
public class TaxProductRegistrationsResourceCountryOptionsDefaultStandard(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): TaxProductRegistrationsResourceCountryOptionsDefaultStandard =
    ...
    public object Serializer : KSerializer<TaxProductRegistrationsResourceCountryOptionsDefaultStandard> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "TaxProductRegistrationsResourceCountryOptionsDefaultStandard must be a JSON object",
                    )
            val placeOfSupplyScheme =
                json.decodeRequired<InlineTaxProductRegistratibf50PlaceOfSupplySchemeX6d54e1f0>(
                    rawObject,
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: TaxProductRegistrationsResourceCountryOptionsDefaultStandard,
        ) {
...
public fun taxProductRegistrationsResourceCountryOptionsDefaultStandard(
    block: TaxProductRegistrationsResourceCountryOptionsDefaultStandard.Builder.() -> Unit,
): TaxProductRegistrationsResourceCountryOptionsDefaultStandard =
    TaxProductRegistrationsResourceCountryOptionsDefaultStandard.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "TaxProductRegistrationsResourceCountryOptionsDefaultStandard is missing required property '" + name +
                    "'",
            )
