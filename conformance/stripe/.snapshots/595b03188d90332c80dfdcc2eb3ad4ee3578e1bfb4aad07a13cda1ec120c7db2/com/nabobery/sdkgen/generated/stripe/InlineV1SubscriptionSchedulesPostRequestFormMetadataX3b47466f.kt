...
internal data class InlineV1SubscriptionSchedulesPostRequestFormMetadataX3b47466fInspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1SubscriptionSchedulesPostRequestFormMetadataAnyOf2X7370dc8e,
            ).count { it }
}
...
public class InlineV1SubscriptionSchedulesPostRequestFormMetadataX3b47466f internal constructor(
    ...
    public val inlineV1SubscriptionSchedulesPostRequestFormMetadataAnyOf2X7370dc8e:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1SubscriptionSchedulesPostRequestFormMetadataAnyOf2X7370dc8e) {
                json
                    .decodeFromJsonElement<InlineV1SubscriptionSchedulesPostRequestFormMetadataAnyOf2X7370dc8e>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1SubscriptionSchedulesPostRequestFormMetadataX3b47466fBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1SubscriptionSchedulesPostRequestFormMetadataAnyOf2X7370dc8e) {
                    add(
                        InlineV1SubscriptionSchedulesPostRequestFormMetadataX3b47466fBranch.InlineV1SubscriptionSchedulesPostRequestFormMetadataAnyOf2X7370dc8e,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1SubscriptionSchedulesPostRequestFormMetadataX3b47466f {
            val inspection = inspectInlineV1SubscriptionSchedulesPostRequestFormMetadataX3b47466f(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1SubscriptionSchedulesPostRequestFormMetadataX3b47466fNoMatchException(
                    "InlineV1SubscriptionSchedulesPostRequestFormMetadataX3b47466f matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionSchedulesPostRequestFormMetadataX3b47466f> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionSchedulesPostRequestFormMetadataX3b47466f,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1SubscriptionSchedulesPostRequestFormMetadataX3b47466f",
...
private fun inspectInlineV1SubscriptionSchedulesPostRequestFormMetadataX3b47466f(
    element: JsonElement,
): InlineV1SubscriptionSchedulesPostRequestFormMetadataX3b47466fInspection {
    val matchesBranch1 = element.isJsonDecodable<JsonObject>()
    val matchesInlineV1SubscriptionSchedulesPostRequestFormMetadataAnyOf2X7370dc8e =
        element
            .isJsonDecodable<InlineV1SubscriptionSchedulesPostRequestFormMetadataAnyOf2X7370dc8e>()
    return InlineV1SubscriptionSchedulesPostRequestFormMetadataX3b47466fInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1SubscriptionSchedulesPostRequestFormMetadataAnyOf2X7370dc8e) {
                    add(
                        "InlineV1SubscriptionSchedulesPostRequestFormMetadataAnyOf2X7370dc8e: value does not match InlineV1SubscriptionSchedulesPostRequestFormMetadataAnyOf2X7370dc8e",
                    )
                }
            },
    )
