...
public class InlineV1InvoicesCreatePreviewPostRequestFormSubscriptionDetailsItemX9f704663(
    public val appliesTo: List<InlineV1InvoicesCreatePreviewPostRequestFormSubscriptionDetailsItemXa7ffdc1d>? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1InvoicesCreatePreviewPostRequestFormSubscriptionDetailsItemX9f704663 =
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1InvoicesCreatePreviewPostRequestFormSubscriptionDetailsItemX9f704663 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1InvoicesCreatePreviewPostRequestFormSubscriptionDetailsItemX9f704663> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1InvoicesCreatePreviewPostRequestFormSubscriptionDetailsItemX9f704663 must be a JSON object",
                    )
            return InlineV1InvoicesCreatePreviewPostRequestFormSubscriptionDetailsItemX9f704663(
                appliesTo =
                    rawObject["applies_to"]?.let {
                        json
                            .decodeFromJsonElement<List<InlineV1InvoicesCreatePreviewPostRequestFormSubscriptionDetailsItemXa7ffdc1d>>(
                                it,
                            )
                    },
                billUntil =
                    rawObject["bill_until"]?.let {
                        json.decodeFromJsonElement<InlineV1InvoicesCreatePreviewPostRequestFormBillUntilX7a36859d>(it)
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesCreatePreviewPostRequestFormSubscriptionDetailsItemX9f704663,
        ) {
            val jsonEncoder =
...
public fun inlineV1InvoicesCreatePreviewPostRequestFormSubscriptionDetailsItemX9f704663(
    block: InlineV1InvoicesCreatePreviewPostRequestFormSubscriptionDetailsItemX9f704663.Builder.() -> Unit,
): InlineV1InvoicesCreatePreviewPostRequestFormSubscriptionDetailsItemX9f704663 =
    InlineV1InvoicesCreatePreviewPostRequestFormSubscriptionDetailsItemX9f704663.build(block)
