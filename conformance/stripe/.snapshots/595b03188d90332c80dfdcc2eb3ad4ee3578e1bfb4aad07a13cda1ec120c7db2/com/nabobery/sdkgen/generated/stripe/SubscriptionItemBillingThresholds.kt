...
public class SubscriptionItemBillingThresholds(
    ...
    public class Builder {
        ...
        public fun build(): SubscriptionItemBillingThresholds =
    ...
    public object Serializer : KSerializer<SubscriptionItemBillingThresholds> {
        ...
        override fun deserialize(decoder: Decoder): SubscriptionItemBillingThresholds {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("SubscriptionItemBillingThresholds must be a JSON object")
            return SubscriptionItemBillingThresholds(
                usageGte =
                    rawObject["usage_gte"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: SubscriptionItemBillingThresholds,
        ) {
...
public fun subscriptionItemBillingThresholds(
    block: SubscriptionItemBillingThresholds.Builder.() -> Unit,
): SubscriptionItemBillingThresholds = SubscriptionItemBillingThresholds.build(block)
