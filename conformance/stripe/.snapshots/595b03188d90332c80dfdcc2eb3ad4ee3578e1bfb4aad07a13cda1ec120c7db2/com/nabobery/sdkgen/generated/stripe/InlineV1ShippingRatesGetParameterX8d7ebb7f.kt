...
public class InlineV1ShippingRatesGetParameterX8d7ebb7f internal constructor(
    ...
    public val inlineV1ShippingRatesGetParameterAnyOf1Xa6f280df:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1ShippingRatesGetParameterAnyOf1Xa6f280df) {
                json
                    .decodeFromJsonElement<InlineV1ShippingRatesGetParameterAnyOf1Xa6f280df>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1ShippingRatesGetParameterX8d7ebb7fBranch>
        get() =
            buildSet {
                if (inspection.matchesInlineV1ShippingRatesGetParameterAnyOf1Xa6f280df) {
                    add(
                        InlineV1ShippingRatesGetParameterX8d7ebb7fBranch.InlineV1ShippingRatesGetParameterAnyOf1Xa6f280df,
                    )
                }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1ShippingRatesGetParameterX8d7ebb7f {
            val inspection = inspectInlineV1ShippingRatesGetParameterX8d7ebb7f(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1ShippingRatesGetParameterX8d7ebb7fNoMatchException(
                    "InlineV1ShippingRatesGetParameterX8d7ebb7f matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1ShippingRatesGetParameterX8d7ebb7f> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ShippingRatesGetParameterX8d7ebb7f,
        ) {
...
private fun inspectInlineV1ShippingRatesGetParameterX8d7ebb7f(
    element: JsonElement,
): InlineV1ShippingRatesGetParameterX8d7ebb7fInspection {
    val matchesInlineV1ShippingRatesGetParameterAnyOf1Xa6f280df =
        element
            .isJsonDecodable<InlineV1ShippingRatesGetParameterAnyOf1Xa6f280df>()
    ...
    return InlineV1ShippingRatesGetParameterX8d7ebb7fInspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1ShippingRatesGetParameterAnyOf1Xa6f280df) {
                    add(
                        "InlineV1ShippingRatesGetParameterAnyOf1Xa6f280df: value does not match InlineV1ShippingRatesGetParameterAnyOf1Xa6f280df",
                    )
                }
