...
public class InlineV1PaymentLinksPostRequestFormInvoiceCreationInvoiceDataXcd3dae65(
    public val accountTaxIds: InlineV1PaymentLinksPostRequestFormInvoiceCreationAccountTaxIdsX5302e013? = null,
    public val customFields: InlineV1PaymentLinksPostRequestFormInvoiceCreationCustomFieldsX0e1c55eb? = null,
    public val description: String? = null,
    public val footer: String? = null,
    public val issuer: InlineV1PaymentLinksPostRequestFormInvoiceCreationInvoiceDataIssuerX87ca4017? = null,
    public val metadata: InlineV1PaymentLinksPostRequestFormInvoiceCreationInvoiceDataMetadataXcebe60b1? = null,
    public val renderingOptions: InlineV1PaymentLinksPostRequestFormInvoiceCreationRenderingOptionsX689589e0? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1PaymentLinksPostRequestFormInvoiceCreationInvoiceDataXcd3dae65 =
            InlineV1PaymentLinksPostRequestFormInvoiceCreationInvoiceDataXcd3dae65(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentLinksPostRequestFormInvoiceCreationInvoiceDataXcd3dae65 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1PaymentLinksPostRequestFormInvoiceCreationInvoiceDataXcd3dae65> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentLinksPostRequestFormInvoiceCreationInvoiceDataXcd3dae65 must be a JSON object",
                    )
            return InlineV1PaymentLinksPostRequestFormInvoiceCreationInvoiceDataXcd3dae65(
                accountTaxIds =
                    rawObject["account_tax_ids"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormInvoiceCreationAccountTaxIdsX5302e013>(
                                it,
                            )
                    },
                customFields =
                    rawObject["custom_fields"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormInvoiceCreationCustomFieldsX0e1c55eb>(
                                it,
                            )
                    },
                ...
                issuer =
                    rawObject["issuer"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormInvoiceCreationInvoiceDataIssuerX87ca4017>(
                                it,
                            )
                    },
                metadata =
                    rawObject["metadata"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormInvoiceCreationInvoiceDataMetadataXcebe60b1>(
                                it,
                            )
                    },
                renderingOptions =
                    rawObject["rendering_options"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormInvoiceCreationRenderingOptionsX689589e0>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentLinksPostRequestFormInvoiceCreationInvoiceDataXcd3dae65,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentLinksPostRequestFormInvoiceCreationInvoiceDataXcd3dae65(
    block: InlineV1PaymentLinksPostRequestFormInvoiceCreationInvoiceDataXcd3dae65.Builder.() -> Unit,
): InlineV1PaymentLinksPostRequestFormInvoiceCreationInvoiceDataXcd3dae65 =
