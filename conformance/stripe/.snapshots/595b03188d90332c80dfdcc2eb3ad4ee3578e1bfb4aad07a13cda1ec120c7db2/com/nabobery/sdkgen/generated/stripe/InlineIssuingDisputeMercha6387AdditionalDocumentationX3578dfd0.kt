...
public class InlineIssuingDisputeMercha6387AdditionalDocumentationX3578dfd0 internal constructor(
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineIssuingDisputeMercha6387AdditionalDocumentationX3578dfd0Branch.Branch1,
                    )
                }
                if (inspection.matchesFile) {
                    add(
                        InlineIssuingDisputeMercha6387AdditionalDocumentationX3578dfd0Branch.File,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineIssuingDisputeMercha6387AdditionalDocumentationX3578dfd0 {
            val inspection = inspectInlineIssuingDisputeMercha6387AdditionalDocumentationX3578dfd0(raw)
            if (inspection.matchCount == 0) {
                throw InlineIssuingDisputeMercha6387AdditionalDocumentationX3578dfd0NoMatchException(
                    "InlineIssuingDisputeMercha6387AdditionalDocumentationX3578dfd0 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineIssuingDisputeMercha6387AdditionalDocumentationX3578dfd0> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineIssuingDisputeMercha6387AdditionalDocumentationX3578dfd0,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineIssuingDisputeMercha6387AdditionalDocumentationX3578dfd0",
...
private fun inspectInlineIssuingDisputeMercha6387AdditionalDocumentationX3578dfd0(
    element: JsonElement,
): InlineIssuingDisputeMercha6387AdditionalDocumentationX3578dfd0Inspection {
