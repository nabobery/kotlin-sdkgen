...
internal data class InlineV1PaymentIntentsCapturePostRequestFormAmountDetailsToPostalCodeXfc13a995Inspection(
    ...
    public val matchesInlineV1PaymentIntentsCapturePostRequestFormAmountDetailsShippingAnyOf2Xa4a6ca6c: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1PaymentIntentsCapturePostRequestFormAmountDetailsShippingAnyOf2Xa4a6ca6c,
            ).count {
                it
            }
}
...
public class InlineV1PaymentIntentsCapturePostRequestFormAmountDetailsToPostalCodeXfc13a995 internal constructor(
    ...
    private val inspection: InlineV1PaymentIntentsCapturePostRequestFormAmountDetailsToPostalCodeXfc13a995Inspection,
) {
    ...
    public val inlineV1PaymentIntentsCapturePostRequestFormAmountDetailsShippingAnyOf2Xa4a6ca6c:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1PaymentIntentsCapturePostRequestFormAmountDetailsShippingAnyOf2Xa4a6ca6c) {
                json
                    .decodeFromJsonElement<InlineV1PaymentIntentsCapturePostRequestFormAmountDetailsShippingAnyOf2Xa4a6ca6c>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1PaymentIntentsCapturePostRequestFormAmountDetailsToPostalCodeXfc13a995Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1PaymentIntentsCapturePostRequestFormAmountDetailsShippingAnyOf2Xa4a6ca6c) {
                    add(
                        InlineV1PaymentIntentsCapturePostRequestFormAmountDetailsToPostalCodeXfc13a995Branch.InlineV1PaymentIntentsCapturePostRequestFormAmountDetailsShippingAnyOf2Xa4a6ca6c,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1PaymentIntentsCapturePostRequestFormAmountDetailsToPostalCodeXfc13a995 {
            val inspection = inspectInlineV1PaymentIntentsCapturePostRequestFormAmountDetailsToPostalCodeXfc13a995(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1PaymentIntentsCapturePostRequestFormAmountDetailsToPostalCodeXfc13a995NoMatchException(
                    "InlineV1PaymentIntentsCapturePostRequestFormAmountDetailsToPostalCodeXfc13a995 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsCapturePostRequestFormAmountDetailsToPostalCodeXfc13a995> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsCapturePostRequestFormAmountDetailsToPostalCodeXfc13a995,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1PaymentIntentsCapturePostRequestFormAmountDetailsToPostalCodeXfc13a995",
...
private fun inspectInlineV1PaymentIntentsCapturePostRequestFormAmountDetailsToPostalCodeXfc13a995(
    element: JsonElement,
): InlineV1PaymentIntentsCapturePostRequestFormAmountDetailsToPostalCodeXfc13a995Inspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1PaymentIntentsCapturePostRequestFormAmountDetailsShippingAnyOf2Xa4a6ca6c =
        element
            .isJsonDecodable<InlineV1PaymentIntentsCapturePostRequestFormAmountDetailsShippingAnyOf2Xa4a6ca6c>()
    return InlineV1PaymentIntentsCapturePostRequestFormAmountDetailsToPostalCodeXfc13a995Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1PaymentIntentsCapturePostRequestFormAmountDetailsShippingAnyOf2Xa4a6ca6c) {
                    add(
                        "InlineV1PaymentIntentsCapturePostRequestFormAmountDetailsShippingAnyOf2Xa4a6ca6c: value does not match InlineV1PaymentIntentsCapturePostRequestFormAmountDetailsShippingAnyOf2Xa4a6ca6c",
                    )
                }
            },
    )
