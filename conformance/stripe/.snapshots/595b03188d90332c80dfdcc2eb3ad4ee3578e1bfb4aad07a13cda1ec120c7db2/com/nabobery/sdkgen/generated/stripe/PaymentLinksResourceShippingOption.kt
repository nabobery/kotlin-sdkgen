...
public class PaymentLinksResourceShippingOption(
    ...
    public object Serializer : KSerializer<PaymentLinksResourceShippingOption> {
        ...
        override fun deserialize(decoder: Decoder): PaymentLinksResourceShippingOption {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentLinksResourceShippingOption must be a JSON object")
            val shippingAmount = json.decodeRequired<Int>(rawObject, "shipping_amount")
            val shippingRate =
                json.decodeRequired<InlinePaymentLinksResourceShippingOptionShippingRateX25fa606a>(
                    rawObject,
                    "shipping_rate",
                )
            return PaymentLinksResourceShippingOption(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentLinksResourceShippingOption,
        ) {
...
public fun paymentLinksResourceShippingOption(
    block: PaymentLinksResourceShippingOption.Builder.() -> Unit,
): PaymentLinksResourceShippingOption = PaymentLinksResourceShippingOption.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "PaymentLinksResourceShippingOption is missing required property '" + name + "'",
            )
