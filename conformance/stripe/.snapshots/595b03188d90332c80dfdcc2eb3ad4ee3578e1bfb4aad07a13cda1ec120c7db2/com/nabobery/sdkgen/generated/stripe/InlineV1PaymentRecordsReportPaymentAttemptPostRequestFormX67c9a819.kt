...
public class InlineV1PaymentRecordsReportPaymentAttemptPostRequestFormX67c9a819(
     ...
     */
    public val failed: InlineV1PaymentRecordsReportPaymentAttemptPostRequestFormFailedX060677f3? = null,
    /**
     * Information about the payment attempt guarantee.
     */
    public val guaranteed: InlineV1PaymentRecordsReportPaymentAttemptPostRequestFormGuaranteedX78f865ee? = null,
    /**
     * Set of [key-value pairs](https://docs.stripe.com/api/metadata) that you can attach to an object. This can be useful
     * for storing additional information about the object in a structured format. Individual keys can be unset by posting
     * an empty value to them. All keys can be unset by posting an empty value to `metadata`.
     */
    public val metadata: InlineV1PaymentRecordsReportPaymentAttemptPostRequestFormMetadataXbd0aafe0? = null,
    /**
     * The outcome of the reported payment.
     */
    public val outcome: InlineV1PaymentRecordsReportPaymentAttemptPostRequestFormOutcomeXc9310fab? = null,
    /**
     * Information about the Payment Method debited for this payment.
     */
    public val paymentMethodDetails: InlineV1PaymentRecordsRepob3f9PostRequestFormPaymentMethodDetailsX55715b8b? = null,
    /**
     * Shipping information for this payment.
     */
    public val shippingDetails: InlineV1PaymentRecordsRepob3f9PostRequestFormShippingDetailsX6f22cc30? = null,
) {
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentRecordsReportPaymentAttemptPostRequestFormX67c9a819 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentRecordsReportPaymentAttemptPostRequestFormX67c9a819> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1PaymentRecordsReportPaymentAttemptPostRequestFormX67c9a819 {
            val jsonDecoder =
                decoder.requireJsonDecoder(
                    "InlineV1PaymentRecordsReportPaymentAttemptPostRequestFormX67c9a819",
                )
            val json = jsonDecoder.json
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentRecordsReportPaymentAttemptPostRequestFormX67c9a819 must be a JSON object",
                    )
            ...
            return InlineV1PaymentRecordsReportPaymentAttemptPostRequestFormX67c9a819(
                ...
                failed =
                    rawObject["failed"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentRecordsReportPaymentAttemptPostRequestFormFailedX060677f3>(
                                it,
                            )
                    },
                guaranteed =
                    rawObject["guaranteed"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentRecordsReportPaymentAttemptPostRequestFormGuaranteedX78f865ee>(
                                it,
                            )
                    },
                metadata =
                    rawObject["metadata"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentRecordsReportPaymentAttemptPostRequestFormMetadataXbd0aafe0>(
                                it,
                            )
                    },
                outcome =
                    rawObject["outcome"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentRecordsReportPaymentAttemptPostRequestFormOutcomeXc9310fab>(
                                it,
                            )
                    },
                paymentMethodDetails =
                    rawObject["payment_method_details"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentRecordsRepob3f9PostRequestFormPaymentMethodDetailsX55715b8b>(
                                it,
                            )
                    },
                shippingDetails =
                    rawObject["shipping_details"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentRecordsRepob3f9PostRequestFormShippingDetailsX6f22cc30>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentRecordsReportPaymentAttemptPostRequestFormX67c9a819,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentRecordsReportPaymentAttemptPostRequestFormX67c9a819(
    block: InlineV1PaymentRecordsReportPaymentAttemptPostRequestFormX67c9a819.Builder.() -> Unit,
): InlineV1PaymentRecordsReportPaymentAttemptPostRequestFormX67c9a819 =
    InlineV1PaymentRecordsReportPaymentAttemptPostRequestFormX67c9a819.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentRecordsReportPaymentAttemptPostRequestFormX67c9a819 is missing required property '" +
                    name +
                    "'",
            )
