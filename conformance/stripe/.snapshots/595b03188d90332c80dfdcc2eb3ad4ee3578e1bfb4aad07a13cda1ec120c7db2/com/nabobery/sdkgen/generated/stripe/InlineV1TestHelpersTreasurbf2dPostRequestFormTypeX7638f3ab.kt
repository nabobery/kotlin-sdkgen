...
public sealed class InlineV1TestHelpersTreasurbf2dPostRequestFormTypeX7638f3ab {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1TestHelpersTreasurbf2dPostRequestFormTypeX7638f3ab =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1TestHelpersTreasurbf2dPostRequestFormTypeX7638f3ab> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1TestHelpersTreasurbf2dPostRequestFormTypeX7638f3ab",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1TestHelpersTreasurbf2dPostRequestFormTypeX7638f3ab =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TestHelpersTreasurbf2dPostRequestFormTypeX7638f3ab,
        ) {
