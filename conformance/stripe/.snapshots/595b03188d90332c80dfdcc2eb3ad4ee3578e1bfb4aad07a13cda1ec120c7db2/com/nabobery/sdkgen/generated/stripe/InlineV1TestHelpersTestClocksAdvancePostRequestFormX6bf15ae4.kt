...
public class InlineV1TestHelpersTestClocksAdvancePostRequestFormX6bf15ae4(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TestHelpersTestClocksAdvancePostRequestFormX6bf15ae4 =
    ...
    public object Serializer : KSerializer<InlineV1TestHelpersTestClocksAdvancePostRequestFormX6bf15ae4> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TestHelpersTestClocksAdvancePostRequestFormX6bf15ae4 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TestHelpersTestClocksAdvancePostRequestFormX6bf15ae4,
        ) {
...
public fun inlineV1TestHelpersTestClocksAdvancePostRequestFormX6bf15ae4(
    block: InlineV1TestHelpersTestClocksAdvancePostRequestFormX6bf15ae4.Builder.() -> Unit,
): InlineV1TestHelpersTestClocksAdvancePostRequestFormX6bf15ae4 =
    InlineV1TestHelpersTestClocksAdvancePostRequestFormX6bf15ae4.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TestHelpersTestClocksAdvancePostRequestFormX6bf15ae4 is missing required property '" + name +
                    "'",
            )
