...
public sealed class InlineAccountCapabilitiesNzBankAccountBecsDebitPaymentsX3e997848 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineAccountCapabilitiesNzBankAccountBecsDebitPaymentsX3e997848 =
            when (value) {
                Active.value -> Active
    ...
    public object Serializer : KSerializer<InlineAccountCapabilitiesNzBankAccountBecsDebitPaymentsX3e997848> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineAccountCapabilitiesNzBankAccountBecsDebitPaymentsX3e997848",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineAccountCapabilitiesNzBankAccountBecsDebitPaymentsX3e997848 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineAccountCapabilitiesNzBankAccountBecsDebitPaymentsX3e997848,
        ) {
