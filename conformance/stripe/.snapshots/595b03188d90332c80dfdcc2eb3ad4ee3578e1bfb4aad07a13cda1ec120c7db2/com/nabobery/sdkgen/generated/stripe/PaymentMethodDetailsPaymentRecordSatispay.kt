...
public class PaymentMethodDetailsPaymentRecordSatispay(
    ...
    public class Builder {
        ...
        public fun build(): PaymentMethodDetailsPaymentRecordSatispay =
            PaymentMethodDetailsPaymentRecordSatispay(
                transactionId = transactionId,
            )
    }

    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentMethodDetailsPaymentRecordSatispay =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentMethodDetailsPaymentRecordSatispay> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodDetailsPaymentRecordSatispay {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodDetailsPaymentRecordSatispay must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentMethodDetailsPaymentRecordSatispay,
        ) {
...
public fun paymentMethodDetailsPaymentRecordSatispay(
    block: PaymentMethodDetailsPaymentRecordSatispay.Builder.() -> Unit,
): PaymentMethodDetailsPaymentRecordSatispay = PaymentMethodDetailsPaymentRecordSatispay.build(block)
