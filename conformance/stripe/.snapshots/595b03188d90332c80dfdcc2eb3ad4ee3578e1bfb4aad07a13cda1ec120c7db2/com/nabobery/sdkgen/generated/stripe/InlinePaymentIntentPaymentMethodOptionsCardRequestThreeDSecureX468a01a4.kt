...
public sealed class InlinePaymentIntentPaymentMethodOptionsCardRequestThreeDSecureX468a01a4 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentIntentPaymentMethodOptionsCardRequestThreeDSecureX468a01a4 =
            when (value) {
                Any.value -> Any
    ...
    public object Serializer : KSerializer<InlinePaymentIntentPaymentMethodOptionsCardRequestThreeDSecureX468a01a4> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentIntentPaymentMethodOptionsCardRequestThreeDSecureX468a01a4",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlinePaymentIntentPaymentMethodOptionsCardRequestThreeDSecureX468a01a4 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentIntentPaymentMethodOptionsCardRequestThreeDSecureX468a01a4,
        ) {
