...
public sealed class InlinePaymentMethodUsBankAccountBlockedNetworkCodeX0a662ce1 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentMethodUsBankAccountBlockedNetworkCodeX0a662ce1 =
            when (value) {
                R02.value -> R02
                R03.value -> R03
                R04.value -> R04
    ...
    public object Serializer : KSerializer<InlinePaymentMethodUsBankAccountBlockedNetworkCodeX0a662ce1> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentMethodUsBankAccountBlockedNetworkCodeX0a662ce1",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePaymentMethodUsBankAccountBlockedNetworkCodeX0a662ce1 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentMethodUsBankAccountBlockedNetworkCodeX0a662ce1,
        ) {
