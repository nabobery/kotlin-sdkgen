...
public class PaymentPagesCheckoutSessionTaxIdCollection(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentPagesCheckoutSessionTaxIdCollection =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentPagesCheckoutSessionTaxIdCollection> {
        ...
        override fun deserialize(decoder: Decoder): PaymentPagesCheckoutSessionTaxIdCollection {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentPagesCheckoutSessionTaxIdCollection must be a JSON object")
            val enabled = json.decodeRequired<Boolean>(rawObject, "enabled")
            val required =
                json.decodeRequired<InlinePaymentPagesCheckoutSessionTaxIdCollectionRequiredX90344866>(
                    rawObject,
                    "required",
                )
            return PaymentPagesCheckoutSessionTaxIdCollection(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentPagesCheckoutSessionTaxIdCollection,
        ) {
...
public fun paymentPagesCheckoutSessionTaxIdCollection(
    block: PaymentPagesCheckoutSessionTaxIdCollection.Builder.() -> Unit,
): PaymentPagesCheckoutSessionTaxIdCollection = PaymentPagesCheckoutSessionTaxIdCollection.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "PaymentPagesCheckoutSessionTaxIdCollection is missing required property '" + name + "'",
            )
