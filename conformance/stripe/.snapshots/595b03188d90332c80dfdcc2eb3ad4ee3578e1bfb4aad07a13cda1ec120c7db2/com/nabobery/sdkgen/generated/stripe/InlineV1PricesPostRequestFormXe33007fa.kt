...
public class InlineV1PricesPostRequestFormXe33007fa(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1PricesPostRequestFormXe33007fa =
            InlineV1PricesPostRequestFormXe33007fa(
                active = active,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PricesPostRequestFormXe33007fa =
    ...
    public object Serializer : KSerializer<InlineV1PricesPostRequestFormXe33007fa> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1PricesPostRequestFormXe33007fa {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("InlineV1PricesPostRequestFormXe33007fa must be a JSON object")
            return InlineV1PricesPostRequestFormXe33007fa(
                ...
                currencyOptions =
                    rawObject["currency_options"]?.let {
                        json.decodeFromJsonElement<InlineV1PricesPostRequestFormCurrencyOptionsX22fe6a54>(it)
                    },
                expand = rawObject["expand"]?.let { json.decodeFromJsonElement<List<String>>(it) },
                lookupKey = rawObject["lookup_key"]?.let { json.decodeFromJsonElement<String>(it) },
                metadata =
                    rawObject["metadata"]?.let {
                        json.decodeFromJsonElement<InlineV1PricesPostRequestFormMetadataXea1f6a49>(it)
                    },
                nickname = rawObject["nickname"]?.let { json.decodeFromJsonElement<String>(it) },
                taxBehavior =
                    rawObject["tax_behavior"]?.let {
                        json.decodeFromJsonElement<InlineV1PricesPostRequestFormTaxBehaviorX568b489a>(it)
                    },
                transferLookupKey =
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PricesPostRequestFormXe33007fa,
        ) {
...
public fun inlineV1PricesPostRequestFormXe33007fa(
    block: InlineV1PricesPostRequestFormXe33007fa.Builder.() -> Unit,
): InlineV1PricesPostRequestFormXe33007fa = InlineV1PricesPostRequestFormXe33007fa.build(block)
