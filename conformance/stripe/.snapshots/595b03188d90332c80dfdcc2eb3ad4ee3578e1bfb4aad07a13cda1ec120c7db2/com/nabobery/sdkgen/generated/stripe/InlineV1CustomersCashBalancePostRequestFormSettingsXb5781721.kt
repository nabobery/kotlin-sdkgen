...
public class InlineV1CustomersCashBalancePostRequestFormSettingsXb5781721(
    public val reconciliationMode: InlineV1CustomersCashBalancePostRequestFormSettingsReconciliationModeX3799c038? = null,
) {
    public class Builder {
        public var reconciliationMode:
            InlineV1CustomersCashBalancePostRequestFormSettingsReconciliationModeX3799c038? = null

        public fun build(): InlineV1CustomersCashBalancePostRequestFormSettingsXb5781721 =
            InlineV1CustomersCashBalancePostRequestFormSettingsXb5781721(
                reconciliationMode = reconciliationMode,
            )
    }

    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1CustomersCashBalancePostRequestFormSettingsXb5781721 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1CustomersCashBalancePostRequestFormSettingsXb5781721> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CustomersCashBalancePostRequestFormSettingsXb5781721 must be a JSON object",
                    )
            return InlineV1CustomersCashBalancePostRequestFormSettingsXb5781721(
                reconciliationMode =
                    rawObject["reconciliation_mode"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CustomersCashBalancePostRequestFormSettingsReconciliationModeX3799c038>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersCashBalancePostRequestFormSettingsXb5781721,
        ) {
...
public fun inlineV1CustomersCashBalancePostRequestFormSettingsXb5781721(
    block: InlineV1CustomersCashBalancePostRequestFormSettingsXb5781721.Builder.() -> Unit,
): InlineV1CustomersCashBalancePostRequestFormSettingsXb5781721 =
    InlineV1CustomersCashBalancePostRequestFormSettingsXb5781721.build(block)
