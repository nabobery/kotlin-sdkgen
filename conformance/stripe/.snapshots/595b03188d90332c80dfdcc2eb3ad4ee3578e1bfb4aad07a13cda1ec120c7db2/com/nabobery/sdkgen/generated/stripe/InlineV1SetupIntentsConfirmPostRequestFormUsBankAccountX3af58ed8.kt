...
public class InlineV1SetupIntentsConfirmPostRequestFormUsBankAccountX3af58ed8(
    public val accountHolderType: InlineV1SetupIntentsConfirmPostRequestFormAccountHolderTypeXbe3243b9? = null,
    public val accountNumber: String? = null,
    public val accountType: InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodDataAccountTypeX176b93d2? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1SetupIntentsConfirmPostRequestFormUsBankAccountX3af58ed8 =
            InlineV1SetupIntentsConfirmPostRequestFormUsBankAccountX3af58ed8(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1SetupIntentsConfirmPostRequestFormUsBankAccountX3af58ed8 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1SetupIntentsConfirmPostRequestFormUsBankAccountX3af58ed8> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SetupIntentsConfirmPostRequestFormUsBankAccountX3af58ed8 must be a JSON object",
                    )
            return InlineV1SetupIntentsConfirmPostRequestFormUsBankAccountX3af58ed8(
                accountHolderType =
                    rawObject["account_holder_type"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SetupIntentsConfirmPostRequestFormAccountHolderTypeXbe3243b9>(
                                it,
                            )
                    },
                ...
                accountType =
                    rawObject["account_type"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodDataAccountTypeX176b93d2>(
                                it,
                            )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SetupIntentsConfirmPostRequestFormUsBankAccountX3af58ed8,
        ) {
            val jsonEncoder =
...
public fun inlineV1SetupIntentsConfirmPostRequestFormUsBankAccountX3af58ed8(
    block: InlineV1SetupIntentsConfirmPostRequestFormUsBankAccountX3af58ed8.Builder.() -> Unit,
): InlineV1SetupIntentsConfirmPostRequestFormUsBankAccountX3af58ed8 =
    InlineV1SetupIntentsConfirmPostRequestFormUsBankAccountX3af58ed8.build(block)
