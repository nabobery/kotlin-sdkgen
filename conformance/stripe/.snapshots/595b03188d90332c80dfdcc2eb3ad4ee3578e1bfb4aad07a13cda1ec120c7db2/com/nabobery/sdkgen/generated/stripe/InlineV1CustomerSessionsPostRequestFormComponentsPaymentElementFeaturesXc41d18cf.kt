...
public class InlineV1CustomerSessionsPostRequestFormComponentsPaymentElementFeaturesXc41d18cf(
    ...
    public val paymentMethodRemove: InlineV1CustomerSessionsPostRequestFormComponentsPaymentMethodRemoveX8c4d8d30? = null,
    public val paymentMethodSave: InlineV1CustomerSessionsPostRequestFormComponentsPaymentMethodSaveX15f29594? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1CustomerSessionsPostRequestFormComponentsPaymentElementFeaturesXc41d18cf =
            InlineV1CustomerSessionsPostRequestFormComponentsPaymentElementFeaturesXc41d18cf(
    ...
    public object Serializer : KSerializer<InlineV1CustomerSessionsPostRequestFormComponentsPaymentElementFeaturesXc41d18cf> {
        ...
        override fun deserialize(
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CustomerSessionsPostRequestFormComponentsPaymentElementFeaturesXc41d18cf must be a JSON object",
                    )
            return InlineV1CustomerSessionsPostRequestFormComponentsPaymentElementFeaturesXc41d18cf(
                paymentMethodAllowRedisplayFilters =
                    rawObject["payment_method_allow_redisplay_filters"]?.let {
                        json
                            .decodeFromJsonElement<List<InlineV1CustomerSessionsPostRequestFormComponentsPaymentElementItemX22662702>>(
                                it,
                            )
                    },
                paymentMethodRedisplay =
                    rawObject["payment_method_redisplay"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CustomerSessionsPostRequestFormComponentsPaymentMethodRedisplayXac417733>(
                                it,
                            )
                    },
                paymentMethodRedisplayLimit =
                    rawObject["payment_method_redisplay_limit"]?.let {
                        json
                ...
                paymentMethodRemove =
                    rawObject["payment_method_remove"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CustomerSessionsPostRequestFormComponentsPaymentMethodRemoveX8c4d8d30>(
                                it,
                            )
                    },
                paymentMethodSave =
                    rawObject["payment_method_save"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CustomerSessionsPostRequestFormComponentsPaymentMethodSaveX15f29594>(
                                it,
                            )
                    },
                paymentMethodSaveUsage =
                    rawObject["payment_method_save_usage"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CustomerSessionsPostRequestFormComponentsPaymentMethodSaveUsageX680cbfbd>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomerSessionsPostRequestFormComponentsPaymentElementFeaturesXc41d18cf,
        ) {
            val jsonEncoder =
            ...
            val raw =
                buildJsonObject {
                    ...
                    value.paymentMethodRedisplayLimit?.let {
                        put(
...
public fun inlineV1CustomerSessionsPostRequestFormComponentsPaymentElementFeaturesXc41d18cf(
    block: InlineV1CustomerSessionsPostRequestFormComponentsPaymentElementFeaturesXc41d18cf.Builder.() -> Unit,
): InlineV1CustomerSessionsPostRequestFormComponentsPaymentElementFeaturesXc41d18cf =
    InlineV1CustomerSessionsPostRequestFormComponentsPaymentElementFeaturesXc41d18cf.build(block)
