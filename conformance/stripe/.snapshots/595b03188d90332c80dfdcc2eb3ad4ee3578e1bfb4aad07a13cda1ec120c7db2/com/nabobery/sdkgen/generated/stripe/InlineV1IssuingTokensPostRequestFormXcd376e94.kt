...
public class InlineV1IssuingTokensPostRequestFormXcd376e94(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1IssuingTokensPostRequestFormXcd376e94 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1IssuingTokensPostRequestFormXcd376e94> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1IssuingTokensPostRequestFormXcd376e94 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingTokensPostRequestFormXcd376e94,
        ) {
...
public fun inlineV1IssuingTokensPostRequestFormXcd376e94(
    block: InlineV1IssuingTokensPostRequestFormXcd376e94.Builder.() -> Unit,
): InlineV1IssuingTokensPostRequestFormXcd376e94 = InlineV1IssuingTokensPostRequestFormXcd376e94.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1IssuingTokensPostRequestFormXcd376e94 is missing required property '" + name + "'",
            )
