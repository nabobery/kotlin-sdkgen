...
public class InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X238c3fcf(
    public val mandateOptions: InlineV1SubscriptionsPostRequestFormPaymentSettingsMandateOptionsXb846a9bd? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X238c3fcf =
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X238c3fcf = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X238c3fcf> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X238c3fcf must be a JSON object",
                    )
            return InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X238c3fcf(
                mandateOptions =
                    rawObject["mandate_options"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormPaymentSettingsMandateOptionsXb846a9bd>(
                                it,
                            )
                    },
                network =
                    rawObject["network"]?.let {
                        json.decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormPaymentSettingsNetworkXc68f05b0>(
                            it,
                        )
                    },
                requestThreeDSecure =
                    rawObject["request_three_d_secure"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormPaymentSettingsRequestThreeDSecureX83960604>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X238c3fcf,
        ) {
            val jsonEncoder =
...
public fun inlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X238c3fcf(
    block: InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X238c3fcf.Builder.() -> Unit,
): InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X238c3fcf =
    InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X238c3fcf.build(block)
