...
public class InlineV1QuotesPostRequestFormInvoiceSettingsIssuerX644e86c0(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1QuotesPostRequestFormInvoiceSettingsIssuerX644e86c0 =
    ...
    public object Serializer : KSerializer<InlineV1QuotesPostRequestFormInvoiceSettingsIssuerX644e86c0> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1QuotesPostRequestFormInvoiceSettingsIssuerX644e86c0 must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineV1QuotesPostRequestFormInvoiceSettingsIssuerTypeX9d61a5e5>(
                    rawObject,
                    "type",
                )
            return InlineV1QuotesPostRequestFormInvoiceSettingsIssuerX644e86c0(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1QuotesPostRequestFormInvoiceSettingsIssuerX644e86c0,
        ) {
...
public fun inlineV1QuotesPostRequestFormInvoiceSettingsIssuerX644e86c0(
    block: InlineV1QuotesPostRequestFormInvoiceSettingsIssuerX644e86c0.Builder.() -> Unit,
): InlineV1QuotesPostRequestFormInvoiceSettingsIssuerX644e86c0 =
    InlineV1QuotesPostRequestFormInvoiceSettingsIssuerX644e86c0.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1QuotesPostRequestFormInvoiceSettingsIssuerX644e86c0 is missing required property '" + name +
                    "'",
            )
