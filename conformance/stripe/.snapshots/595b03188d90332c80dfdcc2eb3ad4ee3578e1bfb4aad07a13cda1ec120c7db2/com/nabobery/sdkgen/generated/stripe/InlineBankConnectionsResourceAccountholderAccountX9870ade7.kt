...
public class InlineBankConnectionsResourceAccountholderAccountX9870ade7 internal constructor(
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineBankConnectionsResourceAccountholderAccountX9870ade7Branch.Branch1,
                    )
                }
                if (inspection.matchesAccount) {
                    add(
                        InlineBankConnectionsResourceAccountholderAccountX9870ade7Branch.Account,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineBankConnectionsResourceAccountholderAccountX9870ade7 {
            val inspection = inspectInlineBankConnectionsResourceAccountholderAccountX9870ade7(raw)
            if (inspection.matchCount == 0) {
                throw InlineBankConnectionsResourceAccountholderAccountX9870ade7NoMatchException(
                    "InlineBankConnectionsResourceAccountholderAccountX9870ade7 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineBankConnectionsResourceAccountholderAccountX9870ade7> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineBankConnectionsResourceAccountholderAccountX9870ade7,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineBankConnectionsResourceAccountholderAccountX9870ade7",
...
private fun inspectInlineBankConnectionsResourceAccountholderAccountX9870ade7(
    element: JsonElement,
): InlineBankConnectionsResourceAccountholderAccountX9870ade7Inspection {
