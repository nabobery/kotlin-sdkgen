...
public class InlineV1PaymentLinksPostRequestFormShippingAddressCollectionX247f9cc2(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentLinksPostRequestFormShippingAddressCollectionX247f9cc2 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentLinksPostRequestFormShippingAddressCollectionX247f9cc2> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentLinksPostRequestFormShippingAddressCollectionX247f9cc2 must be a JSON object",
                    )
            val allowedCountries =
                json
                    .decodeRequired<List<InlineV1PaymentLinksPostRequestFormShippingAddressCollebe84ItemX30ef8e72>>(
                        rawObject,
                        "allowed_countries",
                    )
            return InlineV1PaymentLinksPostRequestFormShippingAddressCollectionX247f9cc2(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentLinksPostRequestFormShippingAddressCollectionX247f9cc2,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentLinksPostRequestFormShippingAddressCollectionX247f9cc2(
    block: InlineV1PaymentLinksPostRequestFormShippingAddressCollectionX247f9cc2.Builder.() -> Unit,
): InlineV1PaymentLinksPostRequestFormShippingAddressCollectionX247f9cc2 =
    InlineV1PaymentLinksPostRequestFormShippingAddressCollectionX247f9cc2.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentLinksPostRequestFormShippingAddressCollectionX247f9cc2 is missing required property '" +
                    name +
                    "'",
            )
