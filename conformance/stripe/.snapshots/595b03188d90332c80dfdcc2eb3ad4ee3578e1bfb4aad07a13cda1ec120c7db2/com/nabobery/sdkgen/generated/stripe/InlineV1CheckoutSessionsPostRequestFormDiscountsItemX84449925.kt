...
public class InlineV1CheckoutSessionsPostRequestFormDiscountsItemX84449925(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1CheckoutSessionsPostRequestFormDiscountsItemX84449925 =
            InlineV1CheckoutSessionsPostRequestFormDiscountsItemX84449925(
                coupon = coupon,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1CheckoutSessionsPostRequestFormDiscountsItemX84449925 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormDiscountsItemX84449925> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CheckoutSessionsPostRequestFormDiscountsItemX84449925 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsPostRequestFormDiscountsItemX84449925,
        ) {
            val jsonEncoder =
...
public fun inlineV1CheckoutSessionsPostRequestFormDiscountsItemX84449925(
    block: InlineV1CheckoutSessionsPostRequestFormDiscountsItemX84449925.Builder.() -> Unit,
): InlineV1CheckoutSessionsPostRequestFormDiscountsItemX84449925 =
    InlineV1CheckoutSessionsPostRequestFormDiscountsItemX84449925.build(block)
