...
public sealed class InlineV1SubscriptionsPostRequestFormItemsItemTaxRatesAnyOf2X41a8a4fb {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1SubscriptionsPostRequestFormItemsItemTaxRatesAnyOf2X41a8a4fb =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionsPostRequestFormItemsItemTaxRatesAnyOf2X41a8a4fb> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1SubscriptionsPostRequestFormItemsItemTaxRatesAnyOf2X41a8a4fb",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1SubscriptionsPostRequestFormItemsItemTaxRatesAnyOf2X41a8a4fb = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsPostRequestFormItemsItemTaxRatesAnyOf2X41a8a4fb,
        ) {
