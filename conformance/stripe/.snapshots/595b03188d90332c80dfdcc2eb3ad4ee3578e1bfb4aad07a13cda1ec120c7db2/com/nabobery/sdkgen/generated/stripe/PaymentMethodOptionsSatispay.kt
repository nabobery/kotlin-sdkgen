...
public class PaymentMethodOptionsSatispay(
    ...
    public class Builder {
        ...
        public fun build(): PaymentMethodOptionsSatispay =
    ...
    public object Serializer : KSerializer<PaymentMethodOptionsSatispay> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodOptionsSatispay {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodOptionsSatispay must be a JSON object")
            return PaymentMethodOptionsSatispay(
                captureMethod =
                    rawObject["capture_method"]?.let {
                        json.decodeFromJsonElement<InlinePaymentMethodOptionsSatispayCaptureMethodX50de9761>(it)
                    },
                setupFutureUsage =
                    rawObject["setup_future_usage"]?.let {
                        json.decodeFromJsonElement<InlinePaymentMethodOptionsSatispaySetupFutureUsageX77908be0>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentMethodOptionsSatispay,
        ) {
...
public fun paymentMethodOptionsSatispay(
    block: PaymentMethodOptionsSatispay.Builder.() -> Unit,
): PaymentMethodOptionsSatispay = PaymentMethodOptionsSatispay.build(block)
