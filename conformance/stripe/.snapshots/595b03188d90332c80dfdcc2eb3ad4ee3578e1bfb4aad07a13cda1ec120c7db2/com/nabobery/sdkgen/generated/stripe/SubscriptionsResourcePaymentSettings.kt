...
@Serializable
public data class SubscriptionsResourcePaymentSettingsView(
    @SerialName("payment_method_options")
    public val paymentMethodOptions: InlineSubscriptionsResourcePaymentSettingsPaymentMethodOptionsX5727ff7d? = null,
...
public class SubscriptionsResourcePaymentSettings(
    ...
    public class Builder {
        ...
        public fun build(): SubscriptionsResourcePaymentSettings =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): SubscriptionsResourcePaymentSettings =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<SubscriptionsResourcePaymentSettings> {
        ...
        override fun deserialize(decoder: Decoder): SubscriptionsResourcePaymentSettings {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("SubscriptionsResourcePaymentSettings must be a JSON object")
                ...
                paymentMethodOptions =
                    rawObject["payment_method_options"]?.let { element ->
                        if (element ==
                            ...
                            json
                                .decodeFromJsonElement<InlineSubscriptionsResourcePaymentSettingsPaymentMethodOptionsX5727ff7d?>(
                                    element,
                                )
                        }
                    },
                paymentMethodTypes =
                    rawObject["payment_method_types"]?.let { element ->
                        if (element ==
                            ...
                            json
                                .decodeFromJsonElement<List<InlineSubscriptionsResourcePaymentSettingsPaymentMethodTypesItemXb8e13a76>?>(
                                    element,
                                )
                        }
                    },
                saveDefaultPaymentMethod =
                    rawObject["save_default_payment_method"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                            ...
                            json
                                .decodeFromJsonElement<InlineSubscriptionsResourcePaymentSettingsSaveDefaultPaymentMethodX8bd52f4b?>(
                                    element,
                                )
                        }
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: SubscriptionsResourcePaymentSettings,
        ) {
...
public fun subscriptionsResourcePaymentSettings(
    block: SubscriptionsResourcePaymentSettings.Builder.() -> Unit,
): SubscriptionsResourcePaymentSettings = SubscriptionsResourcePaymentSettings.build(block)
