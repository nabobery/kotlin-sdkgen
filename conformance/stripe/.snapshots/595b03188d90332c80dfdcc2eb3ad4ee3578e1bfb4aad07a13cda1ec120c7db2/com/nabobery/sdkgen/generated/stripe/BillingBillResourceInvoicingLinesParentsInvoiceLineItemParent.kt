...
public data class BillingBillResourceInvoicingLinesParentsInvoiceLineItemParentView(
    ...
    public val subscriptionItemDetails: InlineBillingBillResourceId011SubscriptionItemDetailsXc7f77d48? = null,
...
public class BillingBillResourceInvoicingLinesParentsInvoiceLineItemParent(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): BillingBillResourceInvoicingLinesParentsInvoiceLineItemParent =
    ...
    public object Serializer : KSerializer<BillingBillResourceInvoicingLinesParentsInvoiceLineItemParent> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "BillingBillResourceInvoicingLinesParentsInvoiceLineItemParent must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineBillingBillResourceInvoicingLinesParentsInvoiceLineItemParentTypeXfb5edb03>(
                    rawObject,
                    "type",
                )
            return BillingBillResourceInvoicingLinesParentsInvoiceLineItemParent(
                type = type,
                invoiceItemDetails =
                    rawObject["invoice_item_details"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineBillingBillResourceId011InvoiceItemDetailsX9fadf1d9?>(
                                element,
                            )
                        }
                    },
                subscriptionItemDetails =
                    rawObject["subscription_item_details"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineBillingBillResourceId011SubscriptionItemDetailsXc7f77d48?>(
                                element,
                            )
                        }
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: BillingBillResourceInvoicingLinesParentsInvoiceLineItemParent,
        ) {
            val jsonEncoder =
            ...
            val raw =
                buildJsonObject {
                    ...
                    value.subscriptionItemDetails?.let {
                        put(
...
public fun billingBillResourceInvoicingLinesParentsInvoiceLineItemParent(
    block: BillingBillResourceInvoicingLinesParentsInvoiceLineItemParent.Builder.() -> Unit,
): BillingBillResourceInvoicingLinesParentsInvoiceLineItemParent =
    BillingBillResourceInvoicingLinesParentsInvoiceLineItemParent.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "BillingBillResourceInvoicingLinesParentsInvoiceLineItemParent is missing required property '" + name +
                    "'",
            )
