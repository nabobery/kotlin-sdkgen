...
public class InlineV1ChargesRefundPostRequestFormMetadataXa66ffa22 internal constructor(
    ...
    public val inlineV1ChargesRefundPostRequestFormMetadataAnyOf2X8c4e9b2d:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1ChargesRefundPostRequestFormMetadataAnyOf2X8c4e9b2d) {
                json
                    .decodeFromJsonElement<InlineV1ChargesRefundPostRequestFormMetadataAnyOf2X8c4e9b2d>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1ChargesRefundPostRequestFormMetadataXa66ffa22Branch>
        get() =
            buildSet {
                ...
                if (inspection.matchesInlineV1ChargesRefundPostRequestFormMetadataAnyOf2X8c4e9b2d) {
                    add(
                        InlineV1ChargesRefundPostRequestFormMetadataXa66ffa22Branch.InlineV1ChargesRefundPostRequestFormMetadataAnyOf2X8c4e9b2d,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1ChargesRefundPostRequestFormMetadataXa66ffa22 {
            val inspection = inspectInlineV1ChargesRefundPostRequestFormMetadataXa66ffa22(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1ChargesRefundPostRequestFormMetadataXa66ffa22NoMatchException(
                    "InlineV1ChargesRefundPostRequestFormMetadataXa66ffa22 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1ChargesRefundPostRequestFormMetadataXa66ffa22> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ChargesRefundPostRequestFormMetadataXa66ffa22,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1ChargesRefundPostRequestFormMetadataXa66ffa22",
...
private fun inspectInlineV1ChargesRefundPostRequestFormMetadataXa66ffa22(
    element: JsonElement,
): InlineV1ChargesRefundPostRequestFormMetadataXa66ffa22Inspection {
    val matchesBranch1 = element.isJsonDecodable<JsonObject>()
    val matchesInlineV1ChargesRefundPostRequestFormMetadataAnyOf2X8c4e9b2d =
        element
            .isJsonDecodable<InlineV1ChargesRefundPostRequestFormMetadataAnyOf2X8c4e9b2d>()
    return InlineV1ChargesRefundPostRequestFormMetadataXa66ffa22Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1ChargesRefundPostRequestFormMetadataAnyOf2X8c4e9b2d) {
                    add(
                        "InlineV1ChargesRefundPostRequestFormMetadataAnyOf2X8c4e9b2d: value does not match InlineV1ChargesRefundPostRequestFormMetadataAnyOf2X8c4e9b2d",
                    )
                }
            },
    )
