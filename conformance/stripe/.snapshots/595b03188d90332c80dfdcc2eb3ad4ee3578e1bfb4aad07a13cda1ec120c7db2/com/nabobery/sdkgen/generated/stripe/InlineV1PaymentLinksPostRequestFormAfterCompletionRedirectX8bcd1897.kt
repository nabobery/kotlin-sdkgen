...
public class InlineV1PaymentLinksPostRequestFormAfterCompletionRedirectX8bcd1897(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentLinksPostRequestFormAfterCompletionRedirectX8bcd1897 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1PaymentLinksPostRequestFormAfterCompletionRedirectX8bcd1897> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentLinksPostRequestFormAfterCompletionRedirectX8bcd1897 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentLinksPostRequestFormAfterCompletionRedirectX8bcd1897,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentLinksPostRequestFormAfterCompletionRedirectX8bcd1897(
    block: InlineV1PaymentLinksPostRequestFormAfterCompletionRedirectX8bcd1897.Builder.() -> Unit,
): InlineV1PaymentLinksPostRequestFormAfterCompletionRedirectX8bcd1897 =
    InlineV1PaymentLinksPostRequestFormAfterCompletionRedirectX8bcd1897.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentLinksPostRequestFormAfterCompletionRedirectX8bcd1897 is missing required property '" +
                    name +
                    "'",
            )
