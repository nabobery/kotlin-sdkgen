...
public class InlineV1PaymentMethodsPostRequestFormXd220c0be(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1PaymentMethodsPostRequestFormXd220c0be =
            InlineV1PaymentMethodsPostRequestFormXd220c0be(
                acssDebit = acssDebit,
                affirm = affirm,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PaymentMethodsPostRequestFormXd220c0be =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentMethodsPostRequestFormXd220c0be> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentMethodsPostRequestFormXd220c0be must be a JSON object",
                    )
            return InlineV1PaymentMethodsPostRequestFormXd220c0be(
                acssDebit =
                    rawObject["acss_debit"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentMethodsPostRequestFormAcssDebitX9cb3cc2f>(it)
                    },
                ...
                allowRedisplay =
                    rawObject["allow_redisplay"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentMethodsPostRequestFormAllowRedisplayXb1e5a64d>(it)
                    },
                ...
                auBecsDebit =
                    rawObject["au_becs_debit"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentMethodsPostRequestFormAuBecsDebitX9e169e4d>(it)
                    },
                bacsDebit =
                    rawObject["bacs_debit"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentMethodsPostRequestFormBacsDebitX3bb09b39>(it)
                    },
                ...
                billingDetails =
                    rawObject["billing_details"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentMethodsPostRequestFormBillingDetailsXab324975>(it)
                    },
                ...
                boleto =
                    rawObject["boleto"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentMethodsPostRequestFormBoletoX9bbbad6b>(it)
                    },
                card =
                    rawObject["card"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentMethodsPostRequestFormCardXb44ab44c>(
                            it,
                        )
                    },
                ...
                custom =
                    rawObject["custom"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentMethodsPostRequestFormCustomX73e90bbd>(it)
                    },
                ...
                eps =
                    rawObject["eps"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentMethodsPostRequestFormEpsXf1913613>(
                            it,
                        )
                    },
                ...
                fpx =
                    rawObject["fpx"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentMethodsPostRequestFormFpxXb8e6acfd>(
                            it,
                        )
                    },
                ...
                ideal =
                    rawObject["ideal"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentMethodsPostRequestFormIdealX0958d761>(
                                it,
                            )
                    },
                ...
                klarna =
                    rawObject["klarna"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentMethodsPostRequestFormKlarnaX73a2ab15>(it)
                    },
                ...
                naverPay =
                    rawObject["naver_pay"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentMethodsPostRequestFormNaverPayX82f49041>(it)
                    },
                nzBankAccount =
                    rawObject["nz_bank_account"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentMethodsPostRequestFormNzBankAccountX261d52f6>(it)
                    },
                oxxo = rawObject["oxxo"]?.let { json.decodeFromJsonElement<JsonObject>(it) },
                p24 =
                    rawObject["p24"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentMethodsPostRequestFormP24X1456d1cc>(
                            it,
                        )
                    },
                ...
                payto =
                    rawObject["payto"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentMethodsPostRequestFormPaytoX4cef6806>(
                                it,
                            )
                    },
                ...
                radarOptions =
                    rawObject["radar_options"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentMethodsPostRequestFormRadarOptionsX0857dd01>(it)
                    },
                ...
                sepaDebit =
                    rawObject["sepa_debit"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentMethodsPostRequestFormSepaDebitXb60dc83a>(it)
                    },
                sofort =
                    rawObject["sofort"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentMethodsPostRequestFormSofortXeb3d6e76>(it)
                    },
                ...
                type =
                    rawObject["type"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentMethodsPostRequestFormTypeXcd37f93b>(
                            it,
                        )
                    },
                upi =
                    rawObject["upi"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentMethodsPostRequestFormUpiX90d92384>(
                            it,
                        )
                    },
                usBankAccount =
                    rawObject["us_bank_account"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentMethodsPostRequestFormUsBankAccountX76c2a511>(it)
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentMethodsPostRequestFormXd220c0be,
        ) {
...
public fun inlineV1PaymentMethodsPostRequestFormXd220c0be(
    block: InlineV1PaymentMethodsPostRequestFormXd220c0be.Builder.() -> Unit,
): InlineV1PaymentMethodsPostRequestFormXd220c0be = InlineV1PaymentMethodsPostRequestFormXd220c0be.build(block)
