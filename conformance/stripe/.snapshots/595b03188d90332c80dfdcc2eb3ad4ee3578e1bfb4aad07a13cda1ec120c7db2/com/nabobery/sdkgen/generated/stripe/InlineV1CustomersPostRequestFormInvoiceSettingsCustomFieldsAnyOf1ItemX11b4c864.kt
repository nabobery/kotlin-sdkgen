...
public class InlineV1CustomersPostRequestFormInvoiceSettingsCustomFieldsAnyOf1ItemX11b4c864(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1CustomersPostRequestFormInvoiceSettingsCustomFieldsAnyOf1ItemX11b4c864 =
    ...
    public object Serializer : KSerializer<InlineV1CustomersPostRequestFormInvoiceSettingsCustomFieldsAnyOf1ItemX11b4c864> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CustomersPostRequestFormInvoiceSettingsCustomFieldsAnyOf1ItemX11b4c864 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersPostRequestFormInvoiceSettingsCustomFieldsAnyOf1ItemX11b4c864,
        ) {
            val jsonEncoder =
...
public fun inlineV1CustomersPostRequestFormInvoiceSettingsCustomFieldsAnyOf1ItemX11b4c864(
    block: InlineV1CustomersPostRequestFormInvoiceSettingsCustomFieldsAnyOf1ItemX11b4c864.Builder.() -> Unit,
): InlineV1CustomersPostRequestFormInvoiceSettingsCustomFieldsAnyOf1ItemX11b4c864 =
    InlineV1CustomersPostRequestFormInvoiceSettingsCustomFieldsAnyOf1ItemX11b4c864.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1CustomersPostRequestFormInvoiceSettingsCustomFieldsAnyOf1ItemX11b4c864 is missing required property '" +
                    name +
                    "'",
            )
