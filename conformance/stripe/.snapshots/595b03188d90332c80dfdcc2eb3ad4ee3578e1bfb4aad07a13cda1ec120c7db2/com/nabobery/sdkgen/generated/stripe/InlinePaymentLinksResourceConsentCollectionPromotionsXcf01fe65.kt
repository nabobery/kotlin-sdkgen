...
public sealed class InlinePaymentLinksResourceConsentCollectionPromotionsXcf01fe65 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentLinksResourceConsentCollectionPromotionsXcf01fe65 =
            when (value) {
                Auto.value -> Auto
                None.value -> None
    ...
    public object Serializer : KSerializer<InlinePaymentLinksResourceConsentCollectionPromotionsXcf01fe65> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentLinksResourceConsentCollectionPromotionsXcf01fe65",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePaymentLinksResourceConsentCollectionPromotionsXcf01fe65 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentLinksResourceConsentCollectionPromotionsXcf01fe65,
        ) {
