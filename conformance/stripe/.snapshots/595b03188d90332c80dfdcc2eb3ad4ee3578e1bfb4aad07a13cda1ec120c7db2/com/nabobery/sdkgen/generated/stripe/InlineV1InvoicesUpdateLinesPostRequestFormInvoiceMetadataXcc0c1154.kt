...
internal data class InlineV1InvoicesUpdateLinesPostRequestFormInvoiceMetadataXcc0c1154Inspection(
    ...
    public val matchesInlineV1InvoicesUpdateLinesPostRequestFormInvoiceMetadataAnyOf2X2cda2b70: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1InvoicesUpdateLinesPostRequestFormInvoiceMetadataAnyOf2X2cda2b70,
            ).count {
                it
            }
}
...
public class InlineV1InvoicesUpdateLinesPostRequestFormInvoiceMetadataXcc0c1154 internal constructor(
    ...
    private val inspection: InlineV1InvoicesUpdateLinesPostRequestFormInvoiceMetadataXcc0c1154Inspection,
) {
    ...
    public val inlineV1InvoicesUpdateLinesPostRequestFormInvoiceMetadataAnyOf2X2cda2b70:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1InvoicesUpdateLinesPostRequestFormInvoiceMetadataAnyOf2X2cda2b70) {
                json
                    .decodeFromJsonElement<InlineV1InvoicesUpdateLinesPostRequestFormInvoiceMetadataAnyOf2X2cda2b70>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1InvoicesUpdateLinesPostRequestFormInvoiceMetadataXcc0c1154Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1InvoicesUpdateLinesPostRequestFormInvoiceMetadataAnyOf2X2cda2b70) {
                    add(
                        InlineV1InvoicesUpdateLinesPostRequestFormInvoiceMetadataXcc0c1154Branch.InlineV1InvoicesUpdateLinesPostRequestFormInvoiceMetadataAnyOf2X2cda2b70,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1InvoicesUpdateLinesPostRequestFormInvoiceMetadataXcc0c1154 {
            val inspection = inspectInlineV1InvoicesUpdateLinesPostRequestFormInvoiceMetadataXcc0c1154(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1InvoicesUpdateLinesPostRequestFormInvoiceMetadataXcc0c1154NoMatchException(
                    "InlineV1InvoicesUpdateLinesPostRequestFormInvoiceMetadataXcc0c1154 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1InvoicesUpdateLinesPostRequestFormInvoiceMetadataXcc0c1154> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesUpdateLinesPostRequestFormInvoiceMetadataXcc0c1154,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1InvoicesUpdateLinesPostRequestFormInvoiceMetadataXcc0c1154",
...
private fun inspectInlineV1InvoicesUpdateLinesPostRequestFormInvoiceMetadataXcc0c1154(
    element: JsonElement,
): InlineV1InvoicesUpdateLinesPostRequestFormInvoiceMetadataXcc0c1154Inspection {
    val matchesBranch1 = element.isJsonDecodable<JsonObject>()
    val matchesInlineV1InvoicesUpdateLinesPostRequestFormInvoiceMetadataAnyOf2X2cda2b70 =
        element
            .isJsonDecodable<InlineV1InvoicesUpdateLinesPostRequestFormInvoiceMetadataAnyOf2X2cda2b70>()
    return InlineV1InvoicesUpdateLinesPostRequestFormInvoiceMetadataXcc0c1154Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1InvoicesUpdateLinesPostRequestFormInvoiceMetadataAnyOf2X2cda2b70) {
                    add(
                        "InlineV1InvoicesUpdateLinesPostRequestFormInvoiceMetadataAnyOf2X2cda2b70: value does not match InlineV1InvoicesUpdateLinesPostRequestFormInvoiceMetadataAnyOf2X2cda2b70",
                    )
                }
            },
    )
