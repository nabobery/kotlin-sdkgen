...
public sealed class InlineTreasuryFinancialAccountsResourceTogglesSettingStatusDetailsCodeXbc4381be {
    ...
    public object Serializer : KSerializer<InlineTreasuryFinancialAccountsResourceTogglesSettingStatusDetailsCodeXbc4381be> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineTreasuryFinancialAccountsResourceTogglesSettingStatusDetailsCodeXbc4381be",
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineTreasuryFinancialAccountsResourceTogglesSettingStatusDetailsCodeXbc4381be,
        ) {
