...
public class InlineV1ChargesPostRequestFormDestinationAnyOf1Xb2aedead(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1ChargesPostRequestFormDestinationAnyOf1Xb2aedead =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1ChargesPostRequestFormDestinationAnyOf1Xb2aedead> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1ChargesPostRequestFormDestinationAnyOf1Xb2aedead must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ChargesPostRequestFormDestinationAnyOf1Xb2aedead,
        ) {
...
public fun inlineV1ChargesPostRequestFormDestinationAnyOf1Xb2aedead(
    block: InlineV1ChargesPostRequestFormDestinationAnyOf1Xb2aedead.Builder.() -> Unit,
): InlineV1ChargesPostRequestFormDestinationAnyOf1Xb2aedead =
    InlineV1ChargesPostRequestFormDestinationAnyOf1Xb2aedead.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1ChargesPostRequestFormDestinationAnyOf1Xb2aedead is missing required property '" + name + "'",
            )
