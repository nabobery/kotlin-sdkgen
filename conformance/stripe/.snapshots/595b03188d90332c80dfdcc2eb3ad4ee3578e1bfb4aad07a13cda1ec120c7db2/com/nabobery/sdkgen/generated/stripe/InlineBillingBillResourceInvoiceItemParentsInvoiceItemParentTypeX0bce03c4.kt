...
public sealed class InlineBillingBillResourceInvoiceItemParentsInvoiceItemParentTypeX0bce03c4 {
    ...
    public object Serializer : KSerializer<InlineBillingBillResourceInvoiceItemParentsInvoiceItemParentTypeX0bce03c4> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineBillingBillResourceInvoiceItemParentsInvoiceItemParentTypeX0bce03c4",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineBillingBillResourceInvoiceItemParentsInvoiceItemParentTypeX0bce03c4 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineBillingBillResourceInvoiceItemParentsInvoiceItemParentTypeX0bce03c4,
        ) {
