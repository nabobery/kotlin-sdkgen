...
public class InlineV1IssuingCardsPostRequestFormSecondLineX9917f825 internal constructor(
    ...
    public val inlineV1IssuingCardsPostRequestFormSecondLineAnyOf2X37963e5d:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1IssuingCardsPostRequestFormSecondLineAnyOf2X37963e5d) {
                json
                    .decodeFromJsonElement<InlineV1IssuingCardsPostRequestFormSecondLineAnyOf2X37963e5d>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1IssuingCardsPostRequestFormSecondLineX9917f825Branch>
        get() =
            buildSet {
                ...
                if (inspection.matchesInlineV1IssuingCardsPostRequestFormSecondLineAnyOf2X37963e5d) {
                    add(
                        InlineV1IssuingCardsPostRequestFormSecondLineX9917f825Branch.InlineV1IssuingCardsPostRequestFormSecondLineAnyOf2X37963e5d,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1IssuingCardsPostRequestFormSecondLineX9917f825 {
            val inspection = inspectInlineV1IssuingCardsPostRequestFormSecondLineX9917f825(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1IssuingCardsPostRequestFormSecondLineX9917f825NoMatchException(
                    "InlineV1IssuingCardsPostRequestFormSecondLineX9917f825 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1IssuingCardsPostRequestFormSecondLineX9917f825> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingCardsPostRequestFormSecondLineX9917f825,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1IssuingCardsPostRequestFormSecondLineX9917f825",
...
private fun inspectInlineV1IssuingCardsPostRequestFormSecondLineX9917f825(
    element: JsonElement,
): InlineV1IssuingCardsPostRequestFormSecondLineX9917f825Inspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1IssuingCardsPostRequestFormSecondLineAnyOf2X37963e5d =
        element
            .isJsonDecodable<InlineV1IssuingCardsPostRequestFormSecondLineAnyOf2X37963e5d>()
    return InlineV1IssuingCardsPostRequestFormSecondLineX9917f825Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1IssuingCardsPostRequestFormSecondLineAnyOf2X37963e5d) {
                    add(
                        "InlineV1IssuingCardsPostRequestFormSecondLineAnyOf2X37963e5d: value does not match InlineV1IssuingCardsPostRequestFormSecondLineAnyOf2X37963e5d",
                    )
                }
            },
    )
