...
public class InlineV1InvoicesPostRequestFormPaymentSettingsBankTransferX2686873f(
    public val euBankTransfer: InlineV1InvoicesPostRequestFormPaymentSettingsEuBankTransferXe1315bd8? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1InvoicesPostRequestFormPaymentSettingsBankTransferX2686873f =
            InlineV1InvoicesPostRequestFormPaymentSettingsBankTransferX2686873f(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1InvoicesPostRequestFormPaymentSettingsBankTransferX2686873f = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1InvoicesPostRequestFormPaymentSettingsBankTransferX2686873f> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1InvoicesPostRequestFormPaymentSettingsBankTransferX2686873f must be a JSON object",
                    )
            return InlineV1InvoicesPostRequestFormPaymentSettingsBankTransferX2686873f(
                euBankTransfer =
                    rawObject["eu_bank_transfer"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1InvoicesPostRequestFormPaymentSettingsEuBankTransferXe1315bd8>(
                                it,
                            )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesPostRequestFormPaymentSettingsBankTransferX2686873f,
        ) {
            val jsonEncoder =
...
public fun inlineV1InvoicesPostRequestFormPaymentSettingsBankTransferX2686873f(
    block: InlineV1InvoicesPostRequestFormPaymentSettingsBankTransferX2686873f.Builder.() -> Unit,
): InlineV1InvoicesPostRequestFormPaymentSettingsBankTransferX2686873f =
