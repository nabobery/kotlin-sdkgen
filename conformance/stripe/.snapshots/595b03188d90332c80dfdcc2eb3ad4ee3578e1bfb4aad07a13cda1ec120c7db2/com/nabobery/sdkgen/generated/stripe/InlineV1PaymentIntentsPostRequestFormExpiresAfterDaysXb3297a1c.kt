...
internal data class InlineV1PaymentIntentsPostRequestFormExpiresAfterDaysXb3297a1cInspection(
    ...
    public val matchesInlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKonbiniAnyOf2X15b8120f: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKonbiniAnyOf2X15b8120f,
            ).count {
                it
            }
}
...
public class InlineV1PaymentIntentsPostRequestFormExpiresAfterDaysXb3297a1c internal constructor(
    ...
    public val inlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKonbiniAnyOf2X15b8120f:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKonbiniAnyOf2X15b8120f) {
                json
                    .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKonbiniAnyOf2X15b8120f>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1PaymentIntentsPostRequestFormExpiresAfterDaysXb3297a1cBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKonbiniAnyOf2X15b8120f) {
                    add(
                        InlineV1PaymentIntentsPostRequestFormExpiresAfterDaysXb3297a1cBranch.InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKonbiniAnyOf2X15b8120f,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1PaymentIntentsPostRequestFormExpiresAfterDaysXb3297a1c {
            val inspection = inspectInlineV1PaymentIntentsPostRequestFormExpiresAfterDaysXb3297a1c(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1PaymentIntentsPostRequestFormExpiresAfterDaysXb3297a1cNoMatchException(
                    "InlineV1PaymentIntentsPostRequestFormExpiresAfterDaysXb3297a1c matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormExpiresAfterDaysXb3297a1c> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormExpiresAfterDaysXb3297a1c,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1PaymentIntentsPostRequestFormExpiresAfterDaysXb3297a1c",
...
private fun inspectInlineV1PaymentIntentsPostRequestFormExpiresAfterDaysXb3297a1c(
    element: JsonElement,
): InlineV1PaymentIntentsPostRequestFormExpiresAfterDaysXb3297a1cInspection {
    val matchesBranch1 = element.isJsonDecodable<Int>()
    val matchesInlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKonbiniAnyOf2X15b8120f =
        element
            .isJsonDecodable<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKonbiniAnyOf2X15b8120f>()
    return InlineV1PaymentIntentsPostRequestFormExpiresAfterDaysXb3297a1cInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKonbiniAnyOf2X15b8120f) {
                    add(
                        "InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKonbiniAnyOf2X15b8120f: value does not match InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKonbiniAnyOf2X15b8120f",
                    )
                }
            },
    )
