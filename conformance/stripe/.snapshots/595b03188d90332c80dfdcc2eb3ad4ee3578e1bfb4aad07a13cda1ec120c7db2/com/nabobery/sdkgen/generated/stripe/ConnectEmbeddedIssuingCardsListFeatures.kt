...
public class ConnectEmbeddedIssuingCardsListFeatures(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): ConnectEmbeddedIssuingCardsListFeatures =
    ...
    public object Serializer : KSerializer<ConnectEmbeddedIssuingCardsListFeatures> {
        ...
        override fun deserialize(decoder: Decoder): ConnectEmbeddedIssuingCardsListFeatures {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("ConnectEmbeddedIssuingCardsListFeatures must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: ConnectEmbeddedIssuingCardsListFeatures,
        ) {
...
public fun connectEmbeddedIssuingCardsListFeatures(
    block: ConnectEmbeddedIssuingCardsListFeatures.Builder.() -> Unit,
): ConnectEmbeddedIssuingCardsListFeatures = ConnectEmbeddedIssuingCardsListFeatures.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "ConnectEmbeddedIssuingCardsListFeatures is missing required property '" + name + "'",
            )
