...
public class InlineV1PaymentIntentsPostRequestFormPaymentMethodDataFpxX9dfbb5c8(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentIntentsPostRequestFormPaymentMethodDataFpxX9dfbb5c8 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormPaymentMethodDataFpxX9dfbb5c8> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1PaymentIntentsPostRequestFormPaymentMethodDataFpxX9dfbb5c8 {
            val jsonDecoder =
                decoder.requireJsonDecoder(
                    "InlineV1PaymentIntentsPostRequestFormPaymentMethodDataFpxX9dfbb5c8",
                )
            val json = jsonDecoder.json
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsPostRequestFormPaymentMethodDataFpxX9dfbb5c8 must be a JSON object",
                    )
            val bank =
                json.decodeRequired<InlineV1PaymentIntentsPostRequestFormPaymentMethodDataFpxBankX4ac1807d>(
                    rawObject,
                    "bank",
                )
            return InlineV1PaymentIntentsPostRequestFormPaymentMethodDataFpxX9dfbb5c8(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormPaymentMethodDataFpxX9dfbb5c8,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentIntentsPostRequestFormPaymentMethodDataFpxX9dfbb5c8(
    block: InlineV1PaymentIntentsPostRequestFormPaymentMethodDataFpxX9dfbb5c8.Builder.() -> Unit,
): InlineV1PaymentIntentsPostRequestFormPaymentMethodDataFpxX9dfbb5c8 =
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentIntentsPostRequestFormPaymentMethodDataFpxX9dfbb5c8 is missing required property '" +
                    name +
                    "'",
            )
