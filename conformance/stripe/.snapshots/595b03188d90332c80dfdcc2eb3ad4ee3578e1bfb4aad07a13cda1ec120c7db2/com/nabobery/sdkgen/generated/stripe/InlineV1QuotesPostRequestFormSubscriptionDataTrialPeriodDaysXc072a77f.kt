...
internal data class InlineV1QuotesPostRequestFormSubscriptionDataTrialPeriodDaysXc072a77fInspection(
    ...
    public val matchesInlineV1QuotesPostRequestFormSubscriptionDataTrialPeriodDaysAnyOf2X8805a44e: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1QuotesPostRequestFormSubscriptionDataTrialPeriodDaysAnyOf2X8805a44e,
            ).count {
                it
            }
}
...
public class InlineV1QuotesPostRequestFormSubscriptionDataTrialPeriodDaysXc072a77f internal constructor(
    ...
    private val inspection: InlineV1QuotesPostRequestFormSubscriptionDataTrialPeriodDaysXc072a77fInspection,
) {
    ...
    public val inlineV1QuotesPostRequestFormSubscriptionDataTrialPeriodDaysAnyOf2X8805a44e:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1QuotesPostRequestFormSubscriptionDataTrialPeriodDaysAnyOf2X8805a44e) {
                json
                    .decodeFromJsonElement<InlineV1QuotesPostRequestFormSubscriptionDataTrialPeriodDaysAnyOf2X8805a44e>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1QuotesPostRequestFormSubscriptionDataTrialPeriodDaysXc072a77fBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1QuotesPostRequestFormSubscriptionDataTrialPeriodDaysAnyOf2X8805a44e) {
                    add(
                        InlineV1QuotesPostRequestFormSubscriptionDataTrialPeriodDaysXc072a77fBranch.InlineV1QuotesPostRequestFormSubscriptionDataTrialPeriodDaysAnyOf2X8805a44e,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1QuotesPostRequestFormSubscriptionDataTrialPeriodDaysXc072a77f {
            val inspection = inspectInlineV1QuotesPostRequestFormSubscriptionDataTrialPeriodDaysXc072a77f(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1QuotesPostRequestFormSubscriptionDataTrialPeriodDaysXc072a77fNoMatchException(
                    "InlineV1QuotesPostRequestFormSubscriptionDataTrialPeriodDaysXc072a77f matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1QuotesPostRequestFormSubscriptionDataTrialPeriodDaysXc072a77f> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1QuotesPostRequestFormSubscriptionDataTrialPeriodDaysXc072a77f,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1QuotesPostRequestFormSubscriptionDataTrialPeriodDaysXc072a77f",
...
private fun inspectInlineV1QuotesPostRequestFormSubscriptionDataTrialPeriodDaysXc072a77f(
    element: JsonElement,
): InlineV1QuotesPostRequestFormSubscriptionDataTrialPeriodDaysXc072a77fInspection {
    val matchesBranch1 = element.isJsonDecodable<Int>()
    val matchesInlineV1QuotesPostRequestFormSubscriptionDataTrialPeriodDaysAnyOf2X8805a44e =
        element
            .isJsonDecodable<InlineV1QuotesPostRequestFormSubscriptionDataTrialPeriodDaysAnyOf2X8805a44e>()
    return InlineV1QuotesPostRequestFormSubscriptionDataTrialPeriodDaysXc072a77fInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1QuotesPostRequestFormSubscriptionDataTrialPeriodDaysAnyOf2X8805a44e) {
                    add(
                        "InlineV1QuotesPostRequestFormSubscriptionDataTrialPeriodDaysAnyOf2X8805a44e: value does not match InlineV1QuotesPostRequestFormSubscriptionDataTrialPeriodDaysAnyOf2X8805a44e",
                    )
                }
            },
    )
