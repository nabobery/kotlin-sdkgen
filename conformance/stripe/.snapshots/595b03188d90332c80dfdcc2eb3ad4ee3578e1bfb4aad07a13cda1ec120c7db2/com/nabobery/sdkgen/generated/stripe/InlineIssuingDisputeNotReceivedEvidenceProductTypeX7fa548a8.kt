...
public sealed class InlineIssuingDisputeNotReceivedEvidenceProductTypeX7fa548a8 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineIssuingDisputeNotReceivedEvidenceProductTypeX7fa548a8 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineIssuingDisputeNotReceivedEvidenceProductTypeX7fa548a8> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineIssuingDisputeNotReceivedEvidenceProductTypeX7fa548a8",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineIssuingDisputeNotReceivedEvidenceProductTypeX7fa548a8 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineIssuingDisputeNotReceivedEvidenceProductTypeX7fa548a8,
        ) {
