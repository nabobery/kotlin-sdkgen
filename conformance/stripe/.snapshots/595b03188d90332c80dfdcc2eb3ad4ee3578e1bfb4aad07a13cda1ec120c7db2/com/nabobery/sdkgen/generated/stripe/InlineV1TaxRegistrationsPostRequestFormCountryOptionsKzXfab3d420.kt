...
public class InlineV1TaxRegistrationsPostRequestFormCountryOptionsKzXfab3d420(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TaxRegistrationsPostRequestFormCountryOptionsKzXfab3d420 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TaxRegistrationsPostRequestFormCountryOptionsKzXfab3d420> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1TaxRegistrationsPostRequestFormCountryOptionsKzXfab3d420 {
            val jsonDecoder =
                decoder.requireJsonDecoder(
                    "InlineV1TaxRegistrationsPostRequestFormCountryOptionsKzXfab3d420",
                )
            val json = jsonDecoder.json
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TaxRegistrationsPostRequestFormCountryOptionsKzXfab3d420 must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineV1TaxRegistrationsPostRequestFormCountryOptionsKzTypeX33cee197>(
                    rawObject,
                    "type",
                )
            return InlineV1TaxRegistrationsPostRequestFormCountryOptionsKzXfab3d420(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TaxRegistrationsPostRequestFormCountryOptionsKzXfab3d420,
        ) {
            val jsonEncoder =
...
public fun inlineV1TaxRegistrationsPostRequestFormCountryOptionsKzXfab3d420(
    block: InlineV1TaxRegistrationsPostRequestFormCountryOptionsKzXfab3d420.Builder.() -> Unit,
): InlineV1TaxRegistrationsPostRequestFormCountryOptionsKzXfab3d420 =
    InlineV1TaxRegistrationsPostRequestFormCountryOptionsKzXfab3d420.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TaxRegistrationsPostRequestFormCountryOptionsKzXfab3d420 is missing required property '" + name +
                    "'",
            )
