...
public class InlineV1TaxIdsPostRequestFormX1022e8c3(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TaxIdsPostRequestFormX1022e8c3 =
    ...
    public object Serializer : KSerializer<InlineV1TaxIdsPostRequestFormX1022e8c3> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1TaxIdsPostRequestFormX1022e8c3 {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("InlineV1TaxIdsPostRequestFormX1022e8c3 must be a JSON object")
            ...
            return InlineV1TaxIdsPostRequestFormX1022e8c3(
                ...
                owner =
                    rawObject["owner"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TaxIdsPostRequestFormOwnerXb78c8ac1>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TaxIdsPostRequestFormX1022e8c3,
        ) {
...
public fun inlineV1TaxIdsPostRequestFormX1022e8c3(
    block: InlineV1TaxIdsPostRequestFormX1022e8c3.Builder.() -> Unit,
): InlineV1TaxIdsPostRequestFormX1022e8c3 = InlineV1TaxIdsPostRequestFormX1022e8c3.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TaxIdsPostRequestFormX1022e8c3 is missing required property '" + name + "'",
            )
