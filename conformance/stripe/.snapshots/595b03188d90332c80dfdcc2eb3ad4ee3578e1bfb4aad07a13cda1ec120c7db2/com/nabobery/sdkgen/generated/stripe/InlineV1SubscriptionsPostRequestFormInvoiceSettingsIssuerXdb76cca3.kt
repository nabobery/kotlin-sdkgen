...
public class InlineV1SubscriptionsPostRequestFormInvoiceSettingsIssuerXdb76cca3(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1SubscriptionsPostRequestFormInvoiceSettingsIssuerXdb76cca3 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionsPostRequestFormInvoiceSettingsIssuerXdb76cca3> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1SubscriptionsPostRequestFormInvoiceSettingsIssuerXdb76cca3 {
            val jsonDecoder =
                decoder.requireJsonDecoder(
                    "InlineV1SubscriptionsPostRequestFormInvoiceSettingsIssuerXdb76cca3",
                )
            val json = jsonDecoder.json
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SubscriptionsPostRequestFormInvoiceSettingsIssuerXdb76cca3 must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineV1SubscriptionsPostRequestFormInvoiceSettingsIssuerTypeXcdfd72f4>(
                    rawObject,
                    "type",
                )
            return InlineV1SubscriptionsPostRequestFormInvoiceSettingsIssuerXdb76cca3(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsPostRequestFormInvoiceSettingsIssuerXdb76cca3,
        ) {
            val jsonEncoder =
...
public fun inlineV1SubscriptionsPostRequestFormInvoiceSettingsIssuerXdb76cca3(
    block: InlineV1SubscriptionsPostRequestFormInvoiceSettingsIssuerXdb76cca3.Builder.() -> Unit,
): InlineV1SubscriptionsPostRequestFormInvoiceSettingsIssuerXdb76cca3 =
    InlineV1SubscriptionsPostRequestFormInvoiceSettingsIssuerXdb76cca3.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1SubscriptionsPostRequestFormInvoiceSettingsIssuerXdb76cca3 is missing required property '" +
                    name +
                    "'",
            )
