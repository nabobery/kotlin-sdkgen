...
public sealed class InlineV1RadarPaymentEvaluacd5dPostRequestFormCustomerPresenceX2bcc20f8 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1RadarPaymentEvaluacd5dPostRequestFormCustomerPresenceX2bcc20f8 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1RadarPaymentEvaluacd5dPostRequestFormCustomerPresenceX2bcc20f8> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1RadarPaymentEvaluacd5dPostRequestFormCustomerPresenceX2bcc20f8",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1RadarPaymentEvaluacd5dPostRequestFormCustomerPresenceX2bcc20f8 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1RadarPaymentEvaluacd5dPostRequestFormCustomerPresenceX2bcc20f8,
        ) {
