...
public class InlineV1PaymentIntentsPostRequestFormPaymentMethodDataSepaDebitXb3187e7d(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentIntentsPostRequestFormPaymentMethodDataSepaDebitXb3187e7d = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormPaymentMethodDataSepaDebitXb3187e7d> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsPostRequestFormPaymentMethodDataSepaDebitXb3187e7d must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormPaymentMethodDataSepaDebitXb3187e7d,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentIntentsPostRequestFormPaymentMethodDataSepaDebitXb3187e7d(
    block: InlineV1PaymentIntentsPostRequestFormPaymentMethodDataSepaDebitXb3187e7d.Builder.() -> Unit,
): InlineV1PaymentIntentsPostRequestFormPaymentMethodDataSepaDebitXb3187e7d =
    InlineV1PaymentIntentsPostRequestFormPaymentMethodDataSepaDebitXb3187e7d.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentIntentsPostRequestFormPaymentMethodDataSepaDebitXb3187e7d is missing required property '" +
                    name +
                    "'",
            )
