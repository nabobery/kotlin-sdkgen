...
public class InlineV1CustomersSourcesVerifyPostRequestFormX329337c2(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1CustomersSourcesVerifyPostRequestFormX329337c2 =
            InlineV1CustomersSourcesVerifyPostRequestFormX329337c2(
                amounts = amounts,
                expand = expand,
            )
    }
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1CustomersSourcesVerifyPostRequestFormX329337c2 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1CustomersSourcesVerifyPostRequestFormX329337c2> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CustomersSourcesVerifyPostRequestFormX329337c2 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersSourcesVerifyPostRequestFormX329337c2,
        ) {
...
public fun inlineV1CustomersSourcesVerifyPostRequestFormX329337c2(
    block: InlineV1CustomersSourcesVerifyPostRequestFormX329337c2.Builder.() -> Unit,
): InlineV1CustomersSourcesVerifyPostRequestFormX329337c2 =
    InlineV1CustomersSourcesVerifyPostRequestFormX329337c2.build(block)
