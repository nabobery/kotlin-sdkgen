...
public class InlineV1AccountsPostRequestFormSettingsCardIssuingTosAcceptanceXf06ccaf9(
    ...
    public val userAgent: InlineV1AccountsPostRequestFormSettingsCardIssuingUserAgentX3867a965? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1AccountsPostRequestFormSettingsCardIssuingTosAcceptanceXf06ccaf9 =
            InlineV1AccountsPostRequestFormSettingsCardIssuingTosAcceptanceXf06ccaf9(
                date = date,
                ip = ip,
                userAgent = userAgent,
            )
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1AccountsPostRequestFormSettingsCardIssuingTosAcceptanceXf06ccaf9 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1AccountsPostRequestFormSettingsCardIssuingTosAcceptanceXf06ccaf9> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountsPostRequestFormSettingsCardIssuingTosAcceptanceXf06ccaf9 must be a JSON object",
                    )
            return InlineV1AccountsPostRequestFormSettingsCardIssuingTosAcceptanceXf06ccaf9(
                ...
                userAgent =
                    rawObject["user_agent"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1AccountsPostRequestFormSettingsCardIssuingUserAgentX3867a965>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPostRequestFormSettingsCardIssuingTosAcceptanceXf06ccaf9,
        ) {
            val jsonEncoder =
...
public fun inlineV1AccountsPostRequestFormSettingsCardIssuingTosAcceptanceXf06ccaf9(
    block: InlineV1AccountsPostRequestFormSettingsCardIssuingTosAcceptanceXf06ccaf9.Builder.() -> Unit,
): InlineV1AccountsPostRequestFormSettingsCardIssuingTosAcceptanceXf06ccaf9 =
    InlineV1AccountsPostRequestFormSettingsCardIssuingTosAcceptanceXf06ccaf9.build(block)
