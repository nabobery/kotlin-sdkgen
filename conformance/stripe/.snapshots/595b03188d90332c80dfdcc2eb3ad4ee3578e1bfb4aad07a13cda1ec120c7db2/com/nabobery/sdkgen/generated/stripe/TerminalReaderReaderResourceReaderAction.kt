...
public class TerminalReaderReaderResourceReaderAction(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): TerminalReaderReaderResourceReaderAction =
    ...
    public object Serializer : KSerializer<TerminalReaderReaderResourceReaderAction> {
        ...
        override fun deserialize(decoder: Decoder): TerminalReaderReaderResourceReaderAction {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("TerminalReaderReaderResourceReaderAction must be a JSON object")
            val status =
                json.decodeRequired<InlineTerminalReaderReaderResourceReaderActionStatusX32065a9f>(
                    rawObject,
                    "status",
                )
            val type =
                json.decodeRequired<InlineTerminalReaderReaderResourceReaderActionTypeXdb26de8a>(
                    rawObject,
                    "type",
                )
            return TerminalReaderReaderResourceReaderAction(
                ...
                type = type,
                apiError =
                    rawObject["api_error"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                            ...
                            json
                                .decodeFromJsonElement<InlineTerminalReaderReaderResourceReaderActionApiErrorXadd9eadd?>(
                                    element,
                                )
                        }
                    },
                collectInputs =
                    rawObject["collect_inputs"]?.let {
                        json.decodeFromJsonElement<TerminalReaderReaderResourceCollectInputsAction>(it)
                    },
                collectPaymentMethod =
                    rawObject["collect_payment_method"]?.let {
                        json.decodeFromJsonElement<TerminalReaderReaderResourceCollectPaymentMethodAction>(it)
                    },
                confirmPaymentIntent =
                    rawObject["confirm_payment_intent"]?.let {
                        json.decodeFromJsonElement<TerminalReaderReaderResourceConfirmPaymentIntentAction>(it)
                    },
                failureCode =
                ...
                printContent =
                    rawObject["print_content"]?.let {
                        json.decodeFromJsonElement<TerminalReaderReaderResourcePrintContent>(it)
                    },
                processPaymentIntent =
                    rawObject["process_payment_intent"]?.let {
                        json.decodeFromJsonElement<TerminalReaderReaderResourceProcessPaymentIntentAction>(it)
                    },
                processSetupIntent =
                    rawObject["process_setup_intent"]?.let {
                        json.decodeFromJsonElement<TerminalReaderReaderResourceProcessSetupIntentAction>(it)
                    },
                refundPayment =
                    rawObject["refund_payment"]?.let {
                        json.decodeFromJsonElement<TerminalReaderReaderResourceRefundPaymentAction>(it)
                    },
                setReaderDisplay =
                    rawObject["set_reader_display"]?.let {
                        json.decodeFromJsonElement<TerminalReaderReaderResourceSetReaderDisplayAction>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: TerminalReaderReaderResourceReaderAction,
        ) {
...
public fun terminalReaderReaderResourceReaderAction(
    block: TerminalReaderReaderResourceReaderAction.Builder.() -> Unit,
): TerminalReaderReaderResourceReaderAction = TerminalReaderReaderResourceReaderAction.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "TerminalReaderReaderResourceReaderAction is missing required property '" + name + "'",
            )
