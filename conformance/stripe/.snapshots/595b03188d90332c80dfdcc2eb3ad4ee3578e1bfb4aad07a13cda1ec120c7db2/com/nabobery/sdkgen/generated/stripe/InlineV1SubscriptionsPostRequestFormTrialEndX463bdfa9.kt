...
public class InlineV1SubscriptionsPostRequestFormTrialEndX463bdfa9 internal constructor(
    ...
    public val inlineV1SubscriptionsPostRequestFormTrialEndAnyOf1Xb56dd88a:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1SubscriptionsPostRequestFormTrialEndAnyOf1Xb56dd88a) {
                json
                    .decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormTrialEndAnyOf1Xb56dd88a>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1SubscriptionsPostRequestFormTrialEndX463bdfa9Branch>
        get() =
            buildSet {
                if (inspection.matchesInlineV1SubscriptionsPostRequestFormTrialEndAnyOf1Xb56dd88a) {
                    add(
                        InlineV1SubscriptionsPostRequestFormTrialEndX463bdfa9Branch.InlineV1SubscriptionsPostRequestFormTrialEndAnyOf1Xb56dd88a,
                    )
                }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1SubscriptionsPostRequestFormTrialEndX463bdfa9 {
            val inspection = inspectInlineV1SubscriptionsPostRequestFormTrialEndX463bdfa9(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1SubscriptionsPostRequestFormTrialEndX463bdfa9NoMatchException(
                    "InlineV1SubscriptionsPostRequestFormTrialEndX463bdfa9 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionsPostRequestFormTrialEndX463bdfa9> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsPostRequestFormTrialEndX463bdfa9,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1SubscriptionsPostRequestFormTrialEndX463bdfa9",
...
private fun inspectInlineV1SubscriptionsPostRequestFormTrialEndX463bdfa9(
    element: JsonElement,
): InlineV1SubscriptionsPostRequestFormTrialEndX463bdfa9Inspection {
    val matchesInlineV1SubscriptionsPostRequestFormTrialEndAnyOf1Xb56dd88a =
        element
            .isJsonDecodable<InlineV1SubscriptionsPostRequestFormTrialEndAnyOf1Xb56dd88a>()
    ...
    return InlineV1SubscriptionsPostRequestFormTrialEndX463bdfa9Inspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1SubscriptionsPostRequestFormTrialEndAnyOf1Xb56dd88a) {
                    add(
                        "InlineV1SubscriptionsPostRequestFormTrialEndAnyOf1Xb56dd88a: value does not match InlineV1SubscriptionsPostRequestFormTrialEndAnyOf1Xb56dd88a",
                    )
                }
