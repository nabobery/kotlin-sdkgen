...
public class TreasuryReceivedCreditsResourceLinkedFlows(
     ...
     */
    public val sourceFlowDetails: InlineTreasuryReceivedCreditsResourceLinkedFlowsSourceFlowDetailsX3225982f? = null,
    /**
    ...
    public class Builder {
        ...
        public fun build(): TreasuryReceivedCreditsResourceLinkedFlows =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): TreasuryReceivedCreditsResourceLinkedFlows =
    ...
    public object Serializer : KSerializer<TreasuryReceivedCreditsResourceLinkedFlows> {
        ...
        override fun deserialize(decoder: Decoder): TreasuryReceivedCreditsResourceLinkedFlows {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("TreasuryReceivedCreditsResourceLinkedFlows must be a JSON object")
            return TreasuryReceivedCreditsResourceLinkedFlows(
                creditReversal =
                    rawObject["credit_reversal"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                issuingAuthorization =
                    rawObject["issuing_authorization"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                issuingTransaction =
                    rawObject["issuing_transaction"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                sourceFlow =
                    rawObject["source_flow"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                sourceFlowDetails =
                    rawObject["source_flow_details"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                            ...
                            json
                                .decodeFromJsonElement<InlineTreasuryReceivedCreditsResourceLinkedFlowsSourceFlowDetailsX3225982f?>(
                                    element,
                                )
                        }
                    },
                sourceFlowType =
                    rawObject["source_flow_type"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: TreasuryReceivedCreditsResourceLinkedFlows,
        ) {
...
public fun treasuryReceivedCreditsResourceLinkedFlows(
    block: TreasuryReceivedCreditsResourceLinkedFlows.Builder.() -> Unit,
): TreasuryReceivedCreditsResourceLinkedFlows = TreasuryReceivedCreditsResourceLinkedFlows.build(block)
