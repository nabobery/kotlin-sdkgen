...
internal data class InlineV1InvoicesCreatePreviewPostRequestFormBillingCycleAnchorX07cb041cInspection(
    public val matchesInlineV1InvoicesCreatePreviewPostRequestFormSubscriptionDetailsAnyOf1X23847308: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesInlineV1InvoicesCreatePreviewPostRequestFormSubscriptionDetailsAnyOf1X23847308,
                matchesBranch2,
            ).count {
                it
            }
...
public class InlineV1InvoicesCreatePreviewPostRequestFormBillingCycleAnchorX07cb041c internal constructor(
    ...
    private val inspection: InlineV1InvoicesCreatePreviewPostRequestFormBillingCycleAnchorX07cb041cInspection,
) {
    public val inlineV1InvoicesCreatePreviewPostRequestFormSubscriptionDetailsAnyOf1X23847308:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1InvoicesCreatePreviewPostRequestFormSubscriptionDetailsAnyOf1X23847308) {
                json
                    .decodeFromJsonElement<InlineV1InvoicesCreatePreviewPostRequestFormSubscriptionDetailsAnyOf1X23847308>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches:
        ...
        get() =
            buildSet {
                if (inspection.matchesInlineV1InvoicesCreatePreviewPostRequestFormSubscriptionDetailsAnyOf1X23847308) {
                    add(
                        InlineV1InvoicesCreatePreviewPostRequestFormBillingCycleAnchorX07cb041cBranch.InlineV1InvoicesCreatePreviewPostRequestFormSubscriptionDetailsAnyOf1X23847308,
                    )
                }
                if (inspection.matchesBranch2) {
                    add(
                        InlineV1InvoicesCreatePreviewPostRequestFormBillingCycleAnchorX07cb041cBranch.Branch2,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1InvoicesCreatePreviewPostRequestFormBillingCycleAnchorX07cb041c {
            val inspection = inspectInlineV1InvoicesCreatePreviewPostRequestFormBillingCycleAnchorX07cb041c(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1InvoicesCreatePreviewPostRequestFormBillingCycleAnchorX07cb041cNoMatchException(
                    "InlineV1InvoicesCreatePreviewPostRequestFormBillingCycleAnchorX07cb041c matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1InvoicesCreatePreviewPostRequestFormBillingCycleAnchorX07cb041c> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesCreatePreviewPostRequestFormBillingCycleAnchorX07cb041c,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1InvoicesCreatePreviewPostRequestFormBillingCycleAnchorX07cb041c",
...
private fun inspectInlineV1InvoicesCreatePreviewPostRequestFormBillingCycleAnchorX07cb041c(
    element: JsonElement,
): InlineV1InvoicesCreatePreviewPostRequestFormBillingCycleAnchorX07cb041cInspection {
    val matchesInlineV1InvoicesCreatePreviewPostRequestFormSubscriptionDetailsAnyOf1X23847308 =
        element
            .isJsonDecodable<InlineV1InvoicesCreatePreviewPostRequestFormSubscriptionDetailsAnyOf1X23847308>()
    ...
    return InlineV1InvoicesCreatePreviewPostRequestFormBillingCycleAnchorX07cb041cInspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1InvoicesCreatePreviewPostRequestFormSubscriptionDetailsAnyOf1X23847308) {
                    add(
                        "InlineV1InvoicesCreatePreviewPostRequestFormSubscriptionDetailsAnyOf1X23847308: value does not match InlineV1InvoicesCreatePreviewPostRequestFormSubscriptionDetailsAnyOf1X23847308",
                    )
                }
