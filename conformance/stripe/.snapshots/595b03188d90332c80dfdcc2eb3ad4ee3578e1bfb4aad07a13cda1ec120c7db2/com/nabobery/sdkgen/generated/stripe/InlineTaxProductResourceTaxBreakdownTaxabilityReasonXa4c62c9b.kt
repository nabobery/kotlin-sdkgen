...
public sealed class InlineTaxProductResourceTaxBreakdownTaxabilityReasonXa4c62c9b {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineTaxProductResourceTaxBreakdownTaxabilityReasonXa4c62c9b =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineTaxProductResourceTaxBreakdownTaxabilityReasonXa4c62c9b> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineTaxProductResourceTaxBreakdownTaxabilityReasonXa4c62c9b",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineTaxProductResourceTaxBreakdownTaxabilityReasonXa4c62c9b =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineTaxProductResourceTaxBreakdownTaxabilityReasonXa4c62c9b,
        ) {
