...
public class InlineV1CheckoutSessionsPostRequestFormAfterExpirationRecoveryXb0ff6903(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1CheckoutSessionsPostRequestFormAfterExpirationRecoveryXb0ff6903 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormAfterExpirationRecoveryXb0ff6903> {
        ...
        override fun deserialize(
            decoder: Decoder,
        ): InlineV1CheckoutSessionsPostRequestFormAfterExpirationRecoveryXb0ff6903 {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CheckoutSessionsPostRequestFormAfterExpirationRecoveryXb0ff6903 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsPostRequestFormAfterExpirationRecoveryXb0ff6903,
        ) {
            val jsonEncoder =
...
public fun inlineV1CheckoutSessionsPostRequestFormAfterExpirationRecoveryXb0ff6903(
    block: InlineV1CheckoutSessionsPostRequestFormAfterExpirationRecoveryXb0ff6903.Builder.() -> Unit,
): InlineV1CheckoutSessionsPostRequestFormAfterExpirationRecoveryXb0ff6903 =
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1CheckoutSessionsPostRequestFormAfterExpirationRecoveryXb0ff6903 is missing required property '" +
                    name +
                    "'",
            )
