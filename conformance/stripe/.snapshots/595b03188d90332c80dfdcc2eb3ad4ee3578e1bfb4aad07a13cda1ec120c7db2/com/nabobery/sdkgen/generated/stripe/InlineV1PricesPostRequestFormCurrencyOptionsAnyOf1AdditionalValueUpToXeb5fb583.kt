...
internal data class InlineV1PricesPostRequestFormCurrencyOptionsAnyOf1AdditionalValueUpToXeb5fb583Inspection(
    public val matchesInlineV1PricesPostRequestFormCurrencyOptionsAnyOf1AdditionalValueAnyOf1X07bf582d: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesInlineV1PricesPostRequestFormCurrencyOptionsAnyOf1AdditionalValueAnyOf1X07bf582d,
                matchesBranch2,
            ).count {
                it
            }
...
public class InlineV1PricesPostRequestFormCurrencyOptionsAnyOf1AdditionalValueUpToXeb5fb583 internal constructor(
    ...
    private val inspection: InlineV1PricesPostRequestFormCurrencyOptionsAnyOf1AdditionalValueUpToXeb5fb583Inspection,
) {
    public val inlineV1PricesPostRequestFormCurrencyOptionsAnyOf1AdditionalValueAnyOf1X07bf582d:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1PricesPostRequestFormCurrencyOptionsAnyOf1AdditionalValueAnyOf1X07bf582d) {
                json
                    .decodeFromJsonElement<InlineV1PricesPostRequestFormCurrencyOptionsAnyOf1AdditionalValueAnyOf1X07bf582d>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches:
        ...
        get() =
            buildSet {
                if (inspection.matchesInlineV1PricesPostRequestFormCurrencyOptionsAnyOf1AdditionalValueAnyOf1X07bf582d) {
                    add(
                        InlineV1PricesPostRequestFormCurrencyOptionsAnyOf1AdditionalValueUpToXeb5fb583Branch.InlineV1PricesPostRequestFormCurrencyOptionsAnyOf1AdditionalValueAnyOf1X07bf582d,
                    )
                }
                if (inspection.matchesBranch2) {
                    add(
                        InlineV1PricesPostRequestFormCurrencyOptionsAnyOf1AdditionalValueUpToXeb5fb583Branch.Branch2,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1PricesPostRequestFormCurrencyOptionsAnyOf1AdditionalValueUpToXeb5fb583 {
            val inspection = inspectInlineV1PricesPostRequestFormCurrencyOptionsAnyOf1AdditionalValueUpToXeb5fb583(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1PricesPostRequestFormCurrencyOptionsAnyOf1AdditionalValueUpToXeb5fb583NoMatchException(
                    "InlineV1PricesPostRequestFormCurrencyOptionsAnyOf1AdditionalValueUpToXeb5fb583 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1PricesPostRequestFormCurrencyOptionsAnyOf1AdditionalValueUpToXeb5fb583> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PricesPostRequestFormCurrencyOptionsAnyOf1AdditionalValueUpToXeb5fb583,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1PricesPostRequestFormCurrencyOptionsAnyOf1AdditionalValueUpToXeb5fb583",
...
private fun inspectInlineV1PricesPostRequestFormCurrencyOptionsAnyOf1AdditionalValueUpToXeb5fb583(
    element: JsonElement,
): InlineV1PricesPostRequestFormCurrencyOptionsAnyOf1AdditionalValueUpToXeb5fb583Inspection {
    val matchesInlineV1PricesPostRequestFormCurrencyOptionsAnyOf1AdditionalValueAnyOf1X07bf582d =
        element
            .isJsonDecodable<InlineV1PricesPostRequestFormCurrencyOptionsAnyOf1AdditionalValueAnyOf1X07bf582d>()
    ...
    return InlineV1PricesPostRequestFormCurrencyOptionsAnyOf1AdditionalValueUpToXeb5fb583Inspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1PricesPostRequestFormCurrencyOptionsAnyOf1AdditionalValueAnyOf1X07bf582d) {
                    add(
                        "InlineV1PricesPostRequestFormCurrencyOptionsAnyOf1AdditionalValueAnyOf1X07bf582d: value does not match InlineV1PricesPostRequestFormCurrencyOptionsAnyOf1AdditionalValueAnyOf1X07bf582d",
                    )
                }
