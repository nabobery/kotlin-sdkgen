...
public class InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsLiabilityX4f338ec4(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsLiabilityX4f338ec4 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsLiabilityX4f338ec4> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsLiabilityX4f338ec4 must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesTypeXc7ee9e5b>(
                    rawObject,
                    "type",
                )
            return InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsLiabilityX4f338ec4(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsLiabilityX4f338ec4,
        ) {
            val jsonEncoder =
...
public fun inlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsLiabilityX4f338ec4(
    block: InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsLiabilityX4f338ec4.Builder.() -> Unit,
): InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsLiabilityX4f338ec4 =
    InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsLiabilityX4f338ec4.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsLiabilityX4f338ec4 is missing required property '" +
                    name +
                    "'",
            )
