...
public class InlineV1InvoiceitemsPostRequestFormTaxCodeX2112798c internal constructor(
    ...
    public val inlineV1InvoiceitemsPostRequestFormTaxCodeAnyOf2X63260f49:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1InvoiceitemsPostRequestFormTaxCodeAnyOf2X63260f49) {
                json
                    .decodeFromJsonElement<InlineV1InvoiceitemsPostRequestFormTaxCodeAnyOf2X63260f49>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1InvoiceitemsPostRequestFormTaxCodeX2112798cBranch>
        get() =
            buildSet {
                ...
                if (inspection.matchesInlineV1InvoiceitemsPostRequestFormTaxCodeAnyOf2X63260f49) {
                    add(
                        InlineV1InvoiceitemsPostRequestFormTaxCodeX2112798cBranch.InlineV1InvoiceitemsPostRequestFormTaxCodeAnyOf2X63260f49,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1InvoiceitemsPostRequestFormTaxCodeX2112798c {
            val inspection = inspectInlineV1InvoiceitemsPostRequestFormTaxCodeX2112798c(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1InvoiceitemsPostRequestFormTaxCodeX2112798cNoMatchException(
                    "InlineV1InvoiceitemsPostRequestFormTaxCodeX2112798c matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1InvoiceitemsPostRequestFormTaxCodeX2112798c> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoiceitemsPostRequestFormTaxCodeX2112798c,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1InvoiceitemsPostRequestFormTaxCodeX2112798c",
...
private fun inspectInlineV1InvoiceitemsPostRequestFormTaxCodeX2112798c(
    element: JsonElement,
): InlineV1InvoiceitemsPostRequestFormTaxCodeX2112798cInspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1InvoiceitemsPostRequestFormTaxCodeAnyOf2X63260f49 =
        element
            .isJsonDecodable<InlineV1InvoiceitemsPostRequestFormTaxCodeAnyOf2X63260f49>()
    return InlineV1InvoiceitemsPostRequestFormTaxCodeX2112798cInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1InvoiceitemsPostRequestFormTaxCodeAnyOf2X63260f49) {
                    add(
                        "InlineV1InvoiceitemsPostRequestFormTaxCodeAnyOf2X63260f49: value does not match InlineV1InvoiceitemsPostRequestFormTaxCodeAnyOf2X63260f49",
                    )
                }
            },
    )
