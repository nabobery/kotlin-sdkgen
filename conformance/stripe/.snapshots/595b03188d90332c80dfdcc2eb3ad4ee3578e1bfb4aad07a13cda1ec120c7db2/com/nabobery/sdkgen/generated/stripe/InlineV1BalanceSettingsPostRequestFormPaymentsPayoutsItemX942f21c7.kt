...
public class InlineV1BalanceSettingsPostRequestFormPaymentsPayoutsItemX942f21c7(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1BalanceSettingsPostRequestFormPaymentsPayoutsItemX942f21c7 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1BalanceSettingsPostRequestFormPaymentsPayoutsItemX942f21c7> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1BalanceSettingsPostRequestFormPaymentsPayoutsItemX942f21c7 must be a JSON object",
                    )
            val payoutMethod = json.decodeRequired<String>(rawObject, "payout_method")
            val type =
                json.decodeRequired<InlineV1BalanceSettingsPostRequestFormPaymentsPayoutsTypeX81f8b754>(
                    rawObject,
                    "type",
                )
            return InlineV1BalanceSettingsPostRequestFormPaymentsPayoutsItemX942f21c7(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1BalanceSettingsPostRequestFormPaymentsPayoutsItemX942f21c7,
        ) {
            val jsonEncoder =
...
public fun inlineV1BalanceSettingsPostRequestFormPaymentsPayoutsItemX942f21c7(
    block: InlineV1BalanceSettingsPostRequestFormPaymentsPayoutsItemX942f21c7.Builder.() -> Unit,
): InlineV1BalanceSettingsPostRequestFormPaymentsPayoutsItemX942f21c7 =
    InlineV1BalanceSettingsPostRequestFormPaymentsPayoutsItemX942f21c7.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1BalanceSettingsPostRequestFormPaymentsPayoutsItemX942f21c7 is missing required property '" +
                    name +
                    "'",
            )
