...
public class InlineV1PaymentIntentsPostRequestFormXef9c8e87(
     ...
     */
    public val automaticPaymentMethods: InlineV1PaymentIntentsPostRequestFormAutomaticPaymentMethodsX4e38aeaa? = null,
    /**
     ...
     * payment.
     */
    public val confirmationMethod: InlineV1PaymentIntentsPostRequestFormConfirmationMethodX256e3eb9? = null,
    /**
     ...
     */
    public val paymentMethodData: InlineV1PaymentIntentsPostRequestFormPaymentMethodDataXe0bd76ba? = null,
    /**
     * Payment method-specific configuration for this PaymentIntent.
     */
    public val paymentMethodOptions: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsX2fea4737? = null,
    /**
     ...
     */
    public val setupFutureUsage: InlineV1PaymentIntentsPostRequestFormSetupFutureUsageXa88d9e73? = null,
    /**
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PaymentIntentsPostRequestFormXef9c8e87 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormXef9c8e87> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsPostRequestFormXef9c8e87 must be a JSON object",
                    )
            ...
            return InlineV1PaymentIntentsPostRequestFormXef9c8e87(
                ...
                amountDetails =
                    rawObject["amount_details"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormAmountDetailsX01eaef4f>(it)
                    },
                ...
                automaticPaymentMethods =
                    rawObject["automatic_payment_methods"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormAutomaticPaymentMethodsX4e38aeaa>(
                                it,
                            )
                    },
                captureMethod =
                    rawObject["capture_method"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormCaptureMethodX7c453bdb>(it)
                    },
                confirm = rawObject["confirm"]?.let { json.decodeFromJsonElement<Boolean>(it) },
                confirmationMethod =
                    rawObject["confirmation_method"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormConfirmationMethodX256e3eb9>(it)
                    },
                ...
                excludedPaymentMethodTypes =
                    rawObject["excluded_payment_method_types"]?.let {
                        json
                            .decodeFromJsonElement<List<InlineV1PaymentIntentsPostRequestFormExcludedPaymentMethodTypesItemXf1ab07e0>>(
                                it,
                            )
                    },
                ...
                hooks =
                    rawObject["hooks"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormHooksXfe0c1a5e>(
                                it,
                            )
                    },
                ...
                mandateData =
                    rawObject["mandate_data"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormMandateDataX6a9982e0>(it)
                    },
                metadata = rawObject["metadata"]?.let { json.decodeFromJsonElement<Map<String, String>>(it) },
                offSession =
                    rawObject["off_session"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormOffSessionXa86bacec>(it)
                    },
                onBehalfOf = rawObject["on_behalf_of"]?.let { json.decodeFromJsonElement<String>(it) },
                paymentDetails =
                    rawObject["payment_details"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentDetailsX2575962e>(it)
                    },
                ...
                paymentMethodData =
                    rawObject["payment_method_data"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodDataXe0bd76ba>(it)
                    },
                paymentMethodOptions =
                    rawObject["payment_method_options"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsX2fea4737>(
                            it,
                        )
                    },
                paymentMethodTypes =
                ...
                radarOptions =
                    rawObject["radar_options"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormRadarOptionsX70579f0c>(it)
                    },
                ...
                setupFutureUsage =
                    rawObject["setup_future_usage"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormSetupFutureUsageXa88d9e73>(it)
                    },
                shipping =
                    rawObject["shipping"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormShippingXbf0817a6>(it)
                    },
                statementDescriptor =
                ...
                transferData =
                    rawObject["transfer_data"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormTransferDataXb1202e5d>(it)
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormXef9c8e87,
        ) {
...
public fun inlineV1PaymentIntentsPostRequestFormXef9c8e87(
    block: InlineV1PaymentIntentsPostRequestFormXef9c8e87.Builder.() -> Unit,
): InlineV1PaymentIntentsPostRequestFormXef9c8e87 = InlineV1PaymentIntentsPostRequestFormXef9c8e87.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentIntentsPostRequestFormXef9c8e87 is missing required property '" + name + "'",
            )
