...
public sealed class InlineSubscriptionSchedulePhaseConfigurationBillingCycleAnchorXdc0a44cb {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineSubscriptionSchedulePhaseConfigurationBillingCycleAnchorXdc0a44cb =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineSubscriptionSchedulePhaseConfigurationBillingCycleAnchorXdc0a44cb> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineSubscriptionSchedulePhaseConfigurationBillingCycleAnchorXdc0a44cb",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineSubscriptionSchedulePhaseConfigurationBillingCycleAnchorXdc0a44cb = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineSubscriptionSchedulePhaseConfigurationBillingCycleAnchorXdc0a44cb,
        ) {
