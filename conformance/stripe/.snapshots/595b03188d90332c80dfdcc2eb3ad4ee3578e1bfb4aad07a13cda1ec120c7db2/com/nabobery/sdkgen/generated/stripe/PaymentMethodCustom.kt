...
public class PaymentMethodCustom(
    ...
    public object Serializer : KSerializer<PaymentMethodCustom> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodCustom {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodCustom must be a JSON object")
                ...
                logo =
                    rawObject["logo"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentMethodCustomLogoX97938b2e?>(element)
                        }
                    },
            )
        }
...
public fun paymentMethodCustom(block: PaymentMethodCustom.Builder.() -> Unit): PaymentMethodCustom =
    PaymentMethodCustom.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("PaymentMethodCustom is missing required property '" + name + "'")
