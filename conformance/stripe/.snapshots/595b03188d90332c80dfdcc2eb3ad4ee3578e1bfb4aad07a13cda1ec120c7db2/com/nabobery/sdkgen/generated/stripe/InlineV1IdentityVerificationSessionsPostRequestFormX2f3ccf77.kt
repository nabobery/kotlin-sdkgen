...
public class InlineV1IdentityVerificationSessionsPostRequestFormX2f3ccf77(
     ...
     */
    public val providedDetails: InlineV1IdentityVerificationSessionsPostRequestFormProvidedDetailsXaeebff70? = null,
    /**
    ...
    public class Builder {
        ...
        public fun build(): InlineV1IdentityVerificationSessionsPostRequestFormX2f3ccf77 =
            InlineV1IdentityVerificationSessionsPostRequestFormX2f3ccf77(
                expand = expand,
                metadata = metadata,
                options = options,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1IdentityVerificationSessionsPostRequestFormX2f3ccf77 =
    ...
    public object Serializer : KSerializer<InlineV1IdentityVerificationSessionsPostRequestFormX2f3ccf77> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1IdentityVerificationSessionsPostRequestFormX2f3ccf77 must be a JSON object",
                    )
            return InlineV1IdentityVerificationSessionsPostRequestFormX2f3ccf77(
                ...
                options =
                    rawObject["options"]?.let {
                        json.decodeFromJsonElement<InlineV1IdentityVerificationSessionsPostRequestFormOptionsX1126d492>(
                            it,
                        )
                    },
                providedDetails =
                    rawObject["provided_details"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1IdentityVerificationSessionsPostRequestFormProvidedDetailsXaeebff70>(
                                it,
                            )
                    },
                type =
                    rawObject["type"]?.let {
                        json.decodeFromJsonElement<InlineV1IdentityVerificationSessionsPostRequestFormTypeX37feb123>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IdentityVerificationSessionsPostRequestFormX2f3ccf77,
        ) {
...
public fun inlineV1IdentityVerificationSessionsPostRequestFormX2f3ccf77(
    block: InlineV1IdentityVerificationSessionsPostRequestFormX2f3ccf77.Builder.() -> Unit,
): InlineV1IdentityVerificationSessionsPostRequestFormX2f3ccf77 =
    InlineV1IdentityVerificationSessionsPostRequestFormX2f3ccf77.build(block)
