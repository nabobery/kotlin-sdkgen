...
internal data class InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsBizumXede2a279Inspection(
    ...
    public val matchesInlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsBizumAnyOf2X024593f5: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsBizumAnyOf2X024593f5,
            ).count {
                it
            }
}
...
public class InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsBizumXede2a279 internal constructor(
    ...
    private val inspection: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsBizumXede2a279Inspection,
) {
    ...
    public val inlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsBizumAnyOf2X024593f5:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsBizumAnyOf2X024593f5) {
                json
                    .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsBizumAnyOf2X024593f5>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsBizumXede2a279Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsBizumAnyOf2X024593f5) {
                    add(
                        InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsBizumXede2a279Branch.InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsBizumAnyOf2X024593f5,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsBizumXede2a279 {
            val inspection = inspectInlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsBizumXede2a279(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsBizumXede2a279NoMatchException(
                    "InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsBizumXede2a279 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsBizumXede2a279> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsBizumXede2a279,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsBizumXede2a279",
...
private fun inspectInlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsBizumXede2a279(
    element: JsonElement,
): InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsBizumXede2a279Inspection {
    val matchesBranch1 = element.isJsonDecodable<JsonObject>()
    val matchesInlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsBizumAnyOf2X024593f5 =
        element
            .isJsonDecodable<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsBizumAnyOf2X024593f5>()
    return InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsBizumXede2a279Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsBizumAnyOf2X024593f5) {
                    add(
                        "InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsBizumAnyOf2X024593f5: value does not match InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsBizumAnyOf2X024593f5",
                    )
                }
            },
    )
