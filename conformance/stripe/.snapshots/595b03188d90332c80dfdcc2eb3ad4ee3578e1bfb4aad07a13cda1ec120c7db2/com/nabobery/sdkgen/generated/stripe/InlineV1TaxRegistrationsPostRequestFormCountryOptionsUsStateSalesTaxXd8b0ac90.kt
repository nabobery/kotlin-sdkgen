...
public class InlineV1TaxRegistrationsPostRequestFormCountryOptionsUsStateSalesTaxXd8b0ac90(
    ...
    public class Builder {
        ...
        public var elections: List<InlineV1TaxRegistrationsPostRequestFormCountryOptionsUsItemX764492cf>
            get() = requireNotNull(electionsValue) { "elections is required" }
            set(`value`) {
                electionsValue = value
            }
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1TaxRegistrationsPostRequestFormCountryOptionsUsStateSalesTaxXd8b0ac90 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TaxRegistrationsPostRequestFormCountryOptionsUsStateSalesTaxXd8b0ac90> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TaxRegistrationsPostRequestFormCountryOptionsUsStateSalesTaxXd8b0ac90 must be a JSON object",
                    )
            val elections =
                json.decodeRequired<List<InlineV1TaxRegistrationsPostRequestFormCountryOptionsUsItemX764492cf>>(
                    rawObject,
                    "elections",
                )
            return InlineV1TaxRegistrationsPostRequestFormCountryOptionsUsStateSalesTaxXd8b0ac90(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TaxRegistrationsPostRequestFormCountryOptionsUsStateSalesTaxXd8b0ac90,
        ) {
            val jsonEncoder =
...
public fun inlineV1TaxRegistrationsPostRequestFormCountryOptionsUsStateSalesTaxXd8b0ac90(
    block: InlineV1TaxRegistrationsPostRequestFormCountryOptionsUsStateSalesTaxXd8b0ac90.Builder.() -> Unit,
): InlineV1TaxRegistrationsPostRequestFormCountryOptionsUsStateSalesTaxXd8b0ac90 =
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TaxRegistrationsPostRequestFormCountryOptionsUsStateSalesTaxXd8b0ac90 is missing required property '" +
                    name +
                    "'",
            )
