...
public sealed class InlinePlanBillingSchemeX6d8a7e86 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePlanBillingSchemeX6d8a7e86 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlinePlanBillingSchemeX6d8a7e86> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePlanBillingSchemeX6d8a7e86",
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlinePlanBillingSchemeX6d8a7e86,
        ) {
