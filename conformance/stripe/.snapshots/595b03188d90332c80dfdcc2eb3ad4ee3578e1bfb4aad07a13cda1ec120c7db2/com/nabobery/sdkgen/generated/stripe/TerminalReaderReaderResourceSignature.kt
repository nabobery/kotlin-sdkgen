...
public class TerminalReaderReaderResourceSignature(
    ...
    public class Builder {
        ...
        public fun build(): TerminalReaderReaderResourceSignature =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): TerminalReaderReaderResourceSignature =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<TerminalReaderReaderResourceSignature> {
        ...
        override fun deserialize(decoder: Decoder): TerminalReaderReaderResourceSignature {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("TerminalReaderReaderResourceSignature must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: TerminalReaderReaderResourceSignature,
        ) {
...
public fun terminalReaderReaderResourceSignature(
    block: TerminalReaderReaderResourceSignature.Builder.() -> Unit,
): TerminalReaderReaderResourceSignature = TerminalReaderReaderResourceSignature.build(block)
