...
public sealed class InlineAccountInvoicesSettingsHostedPaymentMethodSaveXdc5ae523 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineAccountInvoicesSettingsHostedPaymentMethodSaveXdc5ae523 =
            when (value) {
                Always.value -> Always
                Never.value -> Never
                Offer.value -> Offer
    ...
    public object Serializer : KSerializer<InlineAccountInvoicesSettingsHostedPaymentMethodSaveXdc5ae523> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineAccountInvoicesSettingsHostedPaymentMethodSaveXdc5ae523",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineAccountInvoicesSettingsHostedPaymentMethodSaveXdc5ae523 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineAccountInvoicesSettingsHostedPaymentMethodSaveXdc5ae523,
        ) {
