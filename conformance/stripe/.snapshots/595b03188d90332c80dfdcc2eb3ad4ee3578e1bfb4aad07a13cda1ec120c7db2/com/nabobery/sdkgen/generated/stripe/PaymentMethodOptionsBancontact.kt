...
public data class PaymentMethodOptionsBancontactView(
    ...
    public val setupFutureUsage: InlinePaymentMethodOptionsBancontactSetupFutureUsageXffdfe472? = null,
)
...
public class PaymentMethodOptionsBancontact(
    ...
    public object Serializer : KSerializer<PaymentMethodOptionsBancontact> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodOptionsBancontact {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodOptionsBancontact must be a JSON object")
            val preferredLanguage =
                json.decodeRequired<InlinePaymentMethodOptionsBancontactPreferredLanguageXd2c8b7fc>(
                    rawObject,
                    "preferred_language",
                )
            return PaymentMethodOptionsBancontact(
                ...
                setupFutureUsage =
                    rawObject["setup_future_usage"]?.let {
                        json.decodeFromJsonElement<InlinePaymentMethodOptionsBancontactSetupFutureUsageXffdfe472>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentMethodOptionsBancontact,
        ) {
...
public fun paymentMethodOptionsBancontact(
    block: PaymentMethodOptionsBancontact.Builder.() -> Unit,
): PaymentMethodOptionsBancontact = PaymentMethodOptionsBancontact.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "PaymentMethodOptionsBancontact is missing required property '" + name + "'",
            )
