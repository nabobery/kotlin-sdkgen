...
public sealed class InlineTaxProductResourceLineItemTaxBreakdownTaxabilityReasonX2de45fc8 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineTaxProductResourceLineItemTaxBreakdownTaxabilityReasonX2de45fc8 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineTaxProductResourceLineItemTaxBreakdownTaxabilityReasonX2de45fc8> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineTaxProductResourceLineItemTaxBreakdownTaxabilityReasonX2de45fc8",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineTaxProductResourceLineItemTaxBreakdownTaxabilityReasonX2de45fc8 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineTaxProductResourceLineItemTaxBreakdownTaxabilityReasonX2de45fc8,
        ) {
