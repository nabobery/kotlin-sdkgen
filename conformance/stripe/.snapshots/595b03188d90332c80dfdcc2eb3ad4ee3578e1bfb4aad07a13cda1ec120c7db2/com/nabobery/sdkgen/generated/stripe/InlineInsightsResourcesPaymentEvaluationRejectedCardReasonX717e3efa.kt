...
public sealed class InlineInsightsResourcesPaymentEvaluationRejectedCardReasonX717e3efa {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineInsightsResourcesPaymentEvaluationRejectedCardReasonX717e3efa =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineInsightsResourcesPaymentEvaluationRejectedCardReasonX717e3efa> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineInsightsResourcesPaymentEvaluationRejectedCardReasonX717e3efa",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineInsightsResourcesPaymentEvaluationRejectedCardReasonX717e3efa = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineInsightsResourcesPaymentEvaluationRejectedCardReasonX717e3efa,
        ) {
