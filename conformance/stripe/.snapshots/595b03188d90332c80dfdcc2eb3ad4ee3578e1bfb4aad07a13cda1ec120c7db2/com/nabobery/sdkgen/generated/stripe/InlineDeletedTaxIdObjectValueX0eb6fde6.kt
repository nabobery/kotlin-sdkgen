...
public sealed class InlineDeletedTaxIdObjectValueX0eb6fde6 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineDeletedTaxIdObjectValueX0eb6fde6 =
            when (value) {
                TaxId.value -> TaxId
    ...
    public object Serializer : KSerializer<InlineDeletedTaxIdObjectValueX0eb6fde6> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineDeletedTaxIdObjectValueX0eb6fde6",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineDeletedTaxIdObjectValueX0eb6fde6 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineDeletedTaxIdObjectValueX0eb6fde6,
        ) {
