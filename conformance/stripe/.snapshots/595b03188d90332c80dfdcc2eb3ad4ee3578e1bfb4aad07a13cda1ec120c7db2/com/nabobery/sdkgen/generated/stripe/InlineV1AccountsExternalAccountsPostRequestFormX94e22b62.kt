...
public class InlineV1AccountsExternalAccountsPostRequestFormX94e22b62(
     ...
     */
    public val accountHolderType: InlineV1AccountsExternalAccountsPostRequestFormAccountHolderTypeX8ff22307? = null,
    /**
     * The bank account type. This can only be `checking` or `savings` in most countries. In Japan, this can only be
     * `futsu` or `toza`.
     */
    public val accountType: InlineV1AccountsExternalAccountsPostRequestFormAccountTypeX6c44583d? = null,
    /**
    ...
    public class Builder {
        ...
        public fun build(): InlineV1AccountsExternalAccountsPostRequestFormX94e22b62 =
            InlineV1AccountsExternalAccountsPostRequestFormX94e22b62(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1AccountsExternalAccountsPostRequestFormX94e22b62 =
    ...
    public object Serializer : KSerializer<InlineV1AccountsExternalAccountsPostRequestFormX94e22b62> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountsExternalAccountsPostRequestFormX94e22b62 must be a JSON object",
                    )
            return InlineV1AccountsExternalAccountsPostRequestFormX94e22b62(
                ...
                accountHolderType =
                    rawObject["account_holder_type"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1AccountsExternalAccountsPostRequestFormAccountHolderTypeX8ff22307>(
                                it,
                            )
                    },
                accountType =
                    rawObject["account_type"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsExternalAccountsPostRequestFormAccountTypeX6c44583d>(
                            it,
                        )
                    },
                ...
                documents =
                    rawObject["documents"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsExternalAccountsPostRequestFormDocumentsXd2b4cfad>(
                            it,
                        )
                    },
                ...
                metadata =
                    rawObject["metadata"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsExternalAccountsPostRequestFormMetadataX8bd568b3>(it)
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsExternalAccountsPostRequestFormX94e22b62,
        ) {
...
public fun inlineV1AccountsExternalAccountsPostRequestFormX94e22b62(
    block: InlineV1AccountsExternalAccountsPostRequestFormX94e22b62.Builder.() -> Unit,
): InlineV1AccountsExternalAccountsPostRequestFormX94e22b62 =
    InlineV1AccountsExternalAccountsPostRequestFormX94e22b62.build(block)
