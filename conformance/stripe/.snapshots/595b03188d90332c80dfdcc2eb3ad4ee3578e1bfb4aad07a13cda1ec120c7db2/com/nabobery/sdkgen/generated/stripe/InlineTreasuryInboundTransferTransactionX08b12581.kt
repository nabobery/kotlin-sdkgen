...
public class InlineTreasuryInboundTransferTransactionX08b12581 internal constructor(
        ...
        get() =
            buildSet {
                ...
                if (inspection.matchesTreasuryTransaction) {
                    add(
                        InlineTreasuryInboundTransferTransactionX08b12581Branch.TreasuryTransaction,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineTreasuryInboundTransferTransactionX08b12581 {
            val inspection = inspectInlineTreasuryInboundTransferTransactionX08b12581(raw)
            if (inspection.matchCount == 0) {
                throw InlineTreasuryInboundTransferTransactionX08b12581NoMatchException(
                    "InlineTreasuryInboundTransferTransactionX08b12581 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineTreasuryInboundTransferTransactionX08b12581> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineTreasuryInboundTransferTransactionX08b12581,
        ) {
...
private fun inspectInlineTreasuryInboundTransferTransactionX08b12581(
    element: JsonElement,
): InlineTreasuryInboundTransferTransactionX08b12581Inspection {
