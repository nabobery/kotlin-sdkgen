...
public sealed class InlinePaymentIntentStatusX12dfd3e5 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentIntentStatusX12dfd3e5 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlinePaymentIntentStatusX12dfd3e5> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentIntentStatusX12dfd3e5",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePaymentIntentStatusX12dfd3e5 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentIntentStatusX12dfd3e5,
        ) {
