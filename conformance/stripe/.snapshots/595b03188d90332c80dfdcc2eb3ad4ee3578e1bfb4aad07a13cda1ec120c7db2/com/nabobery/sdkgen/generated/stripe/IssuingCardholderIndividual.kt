...
public class IssuingCardholderIndividual(
    ...
    public class Builder {
        ...
        public fun build(): IssuingCardholderIndividual =
    ...
    public object Serializer : KSerializer<IssuingCardholderIndividual> {
        ...
        override fun deserialize(decoder: Decoder): IssuingCardholderIndividual {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("IssuingCardholderIndividual must be a JSON object")
            return IssuingCardholderIndividual(
                cardIssuing =
                    rawObject["card_issuing"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineIssuingCardholderIndividualCardIssuingX688395c8?>(element)
                        }
                    },
                dob =
                    rawObject["dob"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineIssuingCardholderIndividualDobX7050b088?>(element)
                        }
                    },
                firstName =
                ...
                verification =
                    rawObject["verification"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineIssuingCardholderIndividualVerificationX227614f2?>(element)
                        }
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: IssuingCardholderIndividual,
        ) {
...
public fun issuingCardholderIndividual(
    block: IssuingCardholderIndividual.Builder.() -> Unit,
): IssuingCardholderIndividual = IssuingCardholderIndividual.build(block)
