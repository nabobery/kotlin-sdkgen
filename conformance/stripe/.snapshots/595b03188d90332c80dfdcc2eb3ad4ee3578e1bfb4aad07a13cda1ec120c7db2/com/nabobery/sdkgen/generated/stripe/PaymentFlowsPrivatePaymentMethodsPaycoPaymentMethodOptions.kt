...
public class PaymentFlowsPrivatePaymentMethodsPaycoPaymentMethodOptions(
    ...
    public class Builder {
        ...
        public fun build(): PaymentFlowsPrivatePaymentMethodsPaycoPaymentMethodOptions =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentFlowsPrivatePaymentMethodsPaycoPaymentMethodOptions =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentFlowsPrivatePaymentMethodsPaycoPaymentMethodOptions> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "PaymentFlowsPrivatePaymentMethodsPaycoPaymentMethodOptions must be a JSON object",
                    )
            return PaymentFlowsPrivatePaymentMethodsPaycoPaymentMethodOptions(
                captureMethod =
                    rawObject["capture_method"]?.let {
                        json.decodeFromJsonElement<InlinePaymentFlowsPrivateP7edaCaptureMethodX48504f4b>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentFlowsPrivatePaymentMethodsPaycoPaymentMethodOptions,
        ) {
...
public fun paymentFlowsPrivatePaymentMethodsPaycoPaymentMethodOptions(
    block: PaymentFlowsPrivatePaymentMethodsPaycoPaymentMethodOptions.Builder.() -> Unit,
): PaymentFlowsPrivatePaymentMethodsPaycoPaymentMethodOptions =
    PaymentFlowsPrivatePaymentMethodsPaycoPaymentMethodOptions.build(block)
