...
public class InlineV1SubscriptionItemsPostRequestFormPriceDataRecurringX305daf21(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1SubscriptionItemsPostRequestFormPriceDataRecurringX305daf21 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1SubscriptionItemsPostRequestFormPriceDataRecurringX305daf21> {
        override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1SubscriptionItemsPostRequestFormPriceDataRecurringX305daf21 {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SubscriptionItemsPostRequestFormPriceDataRecurringX305daf21 must be a JSON object",
                    )
            val interval =
                json.decodeRequired<InlineV1SubscriptionItemsPostRequestFormPriceDataRecurringIntervalXd69f31ce>(
                    rawObject,
                    "interval",
                )
            return InlineV1SubscriptionItemsPostRequestFormPriceDataRecurringX305daf21(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionItemsPostRequestFormPriceDataRecurringX305daf21,
        ) {
            val jsonEncoder =
...
public fun inlineV1SubscriptionItemsPostRequestFormPriceDataRecurringX305daf21(
    block: InlineV1SubscriptionItemsPostRequestFormPriceDataRecurringX305daf21.Builder.() -> Unit,
): InlineV1SubscriptionItemsPostRequestFormPriceDataRecurringX305daf21 =
    InlineV1SubscriptionItemsPostRequestFormPriceDataRecurringX305daf21.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1SubscriptionItemsPostRequestFormPriceDataRecurringX305daf21 is missing required property '" +
                    name +
                    "'",
            )
