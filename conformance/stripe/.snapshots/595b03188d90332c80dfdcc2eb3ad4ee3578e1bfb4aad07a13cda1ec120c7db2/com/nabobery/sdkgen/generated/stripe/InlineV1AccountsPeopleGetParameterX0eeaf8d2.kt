...
public class InlineV1AccountsPeopleGetParameterX0eeaf8d2(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1AccountsPeopleGetParameterX0eeaf8d2 =
            InlineV1AccountsPeopleGetParameterX0eeaf8d2(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1AccountsPeopleGetParameterX0eeaf8d2 =
    ...
    public object Serializer : KSerializer<InlineV1AccountsPeopleGetParameterX0eeaf8d2> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1AccountsPeopleGetParameterX0eeaf8d2 {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("InlineV1AccountsPeopleGetParameterX0eeaf8d2 must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPeopleGetParameterX0eeaf8d2,
        ) {
...
public fun inlineV1AccountsPeopleGetParameterX0eeaf8d2(
    block: InlineV1AccountsPeopleGetParameterX0eeaf8d2.Builder.() -> Unit,
): InlineV1AccountsPeopleGetParameterX0eeaf8d2 = InlineV1AccountsPeopleGetParameterX0eeaf8d2.build(block)
