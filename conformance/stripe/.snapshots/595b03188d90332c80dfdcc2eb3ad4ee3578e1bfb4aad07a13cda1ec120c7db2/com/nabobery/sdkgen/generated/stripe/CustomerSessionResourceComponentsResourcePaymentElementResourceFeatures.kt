...
@Serializable
public data class CustomerSessionResourceComponentsResourcePaymentElementResourceFeaturesView(
    ...
    public val paymentMethodSaveUsage: InlineCustomerSessionResoud9dcPaymentMethodSaveUsageX5f27063d? = null,
)
...
public class CustomerSessionResourceComponentsResourcePaymentElementResourceFeatures(
    ...
    public class Builder {
        ...
        public var paymentMethodAllowRedisplayFilters:
            ...
            get() =
                requireNotNull(
                    paymentMethodAllowRedisplayFiltersValue,
                ) { "paymentMethodAllowRedisplayFilters is required" }
            set(`value`) {
                paymentMethodAllowRedisplayFiltersValue = value
            }
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): CustomerSessionResourceComponentsResourcePaymentElementResourceFeatures = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<CustomerSessionResourceComponentsResourcePaymentElementResourceFeatures> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "CustomerSessionResourceComponentsResourcePaymentElementResourceFeatures must be a JSON object",
                    )
            val paymentMethodAllowRedisplayFilters =
                json
                    .decodeRequired<List<InlineCustomerSessionResoud9dcPaymentMethodAllowRea1fdItemXc4071aaf>>(
                        rawObject,
                        "payment_method_allow_redisplay_filters",
                    )
            val paymentMethodRedisplay =
                json.decodeRequired<InlineCustomerSessionResoud9dcPaymentMethodRedisplayXce8c845e>(
                    rawObject,
                    "payment_method_redisplay",
                )
            val paymentMethodRemove =
                json.decodeRequired<InlineCustomerSessionResoud9dcPaymentMethodRemoveXbc038ecf>(
                    rawObject,
                    "payment_method_remove",
                )
            val paymentMethodSave =
                json.decodeRequired<InlineCustomerSessionResoud9dcPaymentMethodSaveX66d7ccdf>(
                    rawObject,
                    "payment_method_save",
                )
            return CustomerSessionResourceComponentsResourcePaymentElementResourceFeatures(
                ...
                paymentMethodRedisplayLimit =
                    rawObject["payment_method_redisplay_limit"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                paymentMethodSaveUsage =
                    rawObject["payment_method_save_usage"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineCustomerSessionResoud9dcPaymentMethodSaveUsageX5f27063d?>(
                                element,
                            )
                        }
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: CustomerSessionResourceComponentsResourcePaymentElementResourceFeatures,
        ) {
            val jsonEncoder =
            ...
            val raw =
                buildJsonObject {
                    put(
                        "payment_method_allow_redisplay_filters",
                        json.encodeToJsonElement(value.paymentMethodAllowRedisplayFilters),
                    )
...
public fun customerSessionResourceComponentsResourcePaymentElementResourceFeatures(
    block: CustomerSessionResourceComponentsResourcePaymentElementResourceFeatures.Builder.() -> Unit,
): CustomerSessionResourceComponentsResourcePaymentElementResourceFeatures =
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "CustomerSessionResourceComponentsResourcePaymentElementResourceFeatures is missing required property '" +
                    name +
                    "'",
            )
