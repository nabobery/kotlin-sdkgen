...
public class InlineV1ChargesDisputePostRequestFormEvidenceDisputedTransactionX1acee5d1(
    public val customerAccountId: InlineV1ChargesDisputePostRequestFormEvidenceCustomerAccountIdXb6ce63d4? = null,
    public val customerDeviceFingerprint:
        InlineV1ChargesDisputePostRequestFormEvidenceCustomerDeviceFinger9c71X9d81d65b? = null,
    public val customerDeviceId: InlineV1ChargesDisputePostRequestFormEvidenceCustomerDeviceIdXda416c4e? = null,
    public val customerEmailAddress: InlineV1ChargesDisputePostRequestFormEvidenceCustomerEmailAddressXe78a3141? = null,
    public val customerPurchaseIp: InlineV1ChargesDisputePostRequestFormEvidenceCustomerPurchaseIpX1ac28fd9? = null,
    public val merchandiseOrServices: InlineV1ChargesDisputePostRequestFormEvidenceMerchandiseOrServicesX775d0252? = null,
    public val productDescription: InlineV1ChargesDisputePostRequestFormEvidenceProductDescriptionXd7c6c47e? = null,
    public val shippingAddress: InlineV1ChargesDisputePostRequestFormEvidenceShippingAddressX1b701802? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1ChargesDisputePostRequestFormEvidenceDisputedTransactionX1acee5d1 =
            InlineV1ChargesDisputePostRequestFormEvidenceDisputedTransactionX1acee5d1(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1ChargesDisputePostRequestFormEvidenceDisputedTransactionX1acee5d1 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1ChargesDisputePostRequestFormEvidenceDisputedTransactionX1acee5d1> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1ChargesDisputePostRequestFormEvidenceDisputedTransactionX1acee5d1 must be a JSON object",
                    )
            return InlineV1ChargesDisputePostRequestFormEvidenceDisputedTransactionX1acee5d1(
                customerAccountId =
                    rawObject["customer_account_id"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1ChargesDisputePostRequestFormEvidenceCustomerAccountIdXb6ce63d4>(
                                it,
                            )
                    },
                customerDeviceFingerprint =
                    rawObject["customer_device_fingerprint"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1ChargesDisputePostRequestFormEvidenceCustomerDeviceFinger9c71X9d81d65b>(
                                it,
                            )
                    },
                customerDeviceId =
                    rawObject["customer_device_id"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1ChargesDisputePostRequestFormEvidenceCustomerDeviceIdXda416c4e>(
                                it,
                            )
                    },
                customerEmailAddress =
                    rawObject["customer_email_address"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1ChargesDisputePostRequestFormEvidenceCustomerEmailAddressXe78a3141>(
                                it,
                            )
                    },
                customerPurchaseIp =
                    rawObject["customer_purchase_ip"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1ChargesDisputePostRequestFormEvidenceCustomerPurchaseIpX1ac28fd9>(
                                it,
                            )
                    },
                merchandiseOrServices =
                    rawObject["merchandise_or_services"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1ChargesDisputePostRequestFormEvidenceMerchandiseOrServicesX775d0252>(
                                it,
                            )
                    },
                productDescription =
                    rawObject["product_description"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1ChargesDisputePostRequestFormEvidenceProductDescriptionXd7c6c47e>(
                                it,
                            )
                    },
                shippingAddress =
                    rawObject["shipping_address"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1ChargesDisputePostRequestFormEvidenceShippingAddressX1b701802>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ChargesDisputePostRequestFormEvidenceDisputedTransactionX1acee5d1,
        ) {
            val jsonEncoder =
...
public fun inlineV1ChargesDisputePostRequestFormEvidenceDisputedTransactionX1acee5d1(
    block: InlineV1ChargesDisputePostRequestFormEvidenceDisputedTransactionX1acee5d1.Builder.() -> Unit,
): InlineV1ChargesDisputePostRequestFormEvidenceDisputedTransactionX1acee5d1 =
    InlineV1ChargesDisputePostRequestFormEvidenceDisputedTransactionX1acee5d1.build(block)
