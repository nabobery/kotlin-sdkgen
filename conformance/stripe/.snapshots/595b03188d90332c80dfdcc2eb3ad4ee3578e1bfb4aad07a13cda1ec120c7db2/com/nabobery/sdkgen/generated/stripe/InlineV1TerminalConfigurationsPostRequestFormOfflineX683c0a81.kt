...
internal data class InlineV1TerminalConfigurationsPostRequestFormOfflineX683c0a81Inspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesInlineV1TerminalConfigurationsPostRequestFormOfflineAnyOf1X7380da03,
                matchesInlineV1TerminalConfigurationsPostRequestFormOfflineAnyOf2Xaa3941fe,
            ).count {
                it
            }
}
...
public class InlineV1TerminalConfigurationsPostRequestFormOfflineX683c0a81 internal constructor(
    ...
    public val inlineV1TerminalConfigurationsPostRequestFormOfflineAnyOf1X7380da03:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1TerminalConfigurationsPostRequestFormOfflineAnyOf1X7380da03) {
                json
                    .decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormOfflineAnyOf1X7380da03>(
                        raw,
                    )
            } else {
                null
    ...
    public val inlineV1TerminalConfigurationsPostRequestFormOfflineAnyOf2Xaa3941fe:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1TerminalConfigurationsPostRequestFormOfflineAnyOf2Xaa3941fe) {
                json
                    .decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormOfflineAnyOf2Xaa3941fe>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches:
        ...
        get() =
            buildSet {
                if (inspection.matchesInlineV1TerminalConfigurationsPostRequestFormOfflineAnyOf1X7380da03) {
                    add(
                        InlineV1TerminalConfigurationsPostRequestFormOfflineX683c0a81Branch.InlineV1TerminalConfigurationsPostRequestFormOfflineAnyOf1X7380da03,
                    )
                }
                if (inspection.matchesInlineV1TerminalConfigurationsPostRequestFormOfflineAnyOf2Xaa3941fe) {
                    add(
                        InlineV1TerminalConfigurationsPostRequestFormOfflineX683c0a81Branch.InlineV1TerminalConfigurationsPostRequestFormOfflineAnyOf2Xaa3941fe,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1TerminalConfigurationsPostRequestFormOfflineX683c0a81 {
            val inspection = inspectInlineV1TerminalConfigurationsPostRequestFormOfflineX683c0a81(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1TerminalConfigurationsPostRequestFormOfflineX683c0a81NoMatchException(
                    "InlineV1TerminalConfigurationsPostRequestFormOfflineX683c0a81 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1TerminalConfigurationsPostRequestFormOfflineX683c0a81> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TerminalConfigurationsPostRequestFormOfflineX683c0a81,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1TerminalConfigurationsPostRequestFormOfflineX683c0a81",
...
private fun inspectInlineV1TerminalConfigurationsPostRequestFormOfflineX683c0a81(
    element: JsonElement,
): InlineV1TerminalConfigurationsPostRequestFormOfflineX683c0a81Inspection {
    val matchesInlineV1TerminalConfigurationsPostRequestFormOfflineAnyOf1X7380da03 =
        element
            .isJsonDecodable<InlineV1TerminalConfigurationsPostRequestFormOfflineAnyOf1X7380da03>()
    val matchesInlineV1TerminalConfigurationsPostRequestFormOfflineAnyOf2Xaa3941fe =
        element
            .isJsonDecodable<InlineV1TerminalConfigurationsPostRequestFormOfflineAnyOf2Xaa3941fe>()
    return InlineV1TerminalConfigurationsPostRequestFormOfflineX683c0a81Inspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1TerminalConfigurationsPostRequestFormOfflineAnyOf1X7380da03) {
                    add(
                        "InlineV1TerminalConfigurationsPostRequestFormOfflineAnyOf1X7380da03: value does not match InlineV1TerminalConfigurationsPostRequestFormOfflineAnyOf1X7380da03",
                    )
                }
                if (!matchesInlineV1TerminalConfigurationsPostRequestFormOfflineAnyOf2Xaa3941fe) {
                    add(
                        "InlineV1TerminalConfigurationsPostRequestFormOfflineAnyOf2Xaa3941fe: value does not match InlineV1TerminalConfigurationsPostRequestFormOfflineAnyOf2Xaa3941fe",
                    )
                }
            },
    )
