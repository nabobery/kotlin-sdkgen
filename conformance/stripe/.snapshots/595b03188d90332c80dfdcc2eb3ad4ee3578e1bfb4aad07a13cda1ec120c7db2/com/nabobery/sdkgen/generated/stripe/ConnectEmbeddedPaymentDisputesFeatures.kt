...
public class ConnectEmbeddedPaymentDisputesFeatures(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): ConnectEmbeddedPaymentDisputesFeatures =
    ...
    public object Serializer : KSerializer<ConnectEmbeddedPaymentDisputesFeatures> {
        ...
        override fun deserialize(decoder: Decoder): ConnectEmbeddedPaymentDisputesFeatures {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("ConnectEmbeddedPaymentDisputesFeatures must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: ConnectEmbeddedPaymentDisputesFeatures,
        ) {
...
public fun connectEmbeddedPaymentDisputesFeatures(
    block: ConnectEmbeddedPaymentDisputesFeatures.Builder.() -> Unit,
): ConnectEmbeddedPaymentDisputesFeatures = ConnectEmbeddedPaymentDisputesFeatures.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "ConnectEmbeddedPaymentDisputesFeatures is missing required property '" + name + "'",
            )
