...
public sealed class InlineBalanceSettingsResourcePayoutScheduleIntervalX89eadcc3 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineBalanceSettingsResourcePayoutScheduleIntervalX89eadcc3 =
            when (value) {
                Daily.value -> Daily
                Manual.value -> Manual
    ...
    public object Serializer : KSerializer<InlineBalanceSettingsResourcePayoutScheduleIntervalX89eadcc3> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineBalanceSettingsResourcePayoutScheduleIntervalX89eadcc3",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineBalanceSettingsResourcePayoutScheduleIntervalX89eadcc3 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineBalanceSettingsResourcePayoutScheduleIntervalX89eadcc3,
        ) {
