...
public class InlineV1PaymentLinksPostRequestFormCustomFieldsAnyOf1ItemLabelX4d4c6ea8(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentLinksPostRequestFormCustomFieldsAnyOf1ItemLabelX4d4c6ea8 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentLinksPostRequestFormCustomFieldsAnyOf1ItemLabelX4d4c6ea8> {
        override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1PaymentLinksPostRequestFormCustomFieldsAnyOf1ItemLabelX4d4c6ea8 {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentLinksPostRequestFormCustomFieldsAnyOf1ItemLabelX4d4c6ea8 must be a JSON object",
                    )
            val custom = json.decodeRequired<String>(rawObject, "custom")
            val type =
                json.decodeRequired<InlineV1PaymentLinksPostRequestFormCustomFieldsAnyOf1ItemLabelTypeXd21eaf3e>(
                    rawObject,
                    "type",
                )
            return InlineV1PaymentLinksPostRequestFormCustomFieldsAnyOf1ItemLabelX4d4c6ea8(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentLinksPostRequestFormCustomFieldsAnyOf1ItemLabelX4d4c6ea8,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentLinksPostRequestFormCustomFieldsAnyOf1ItemLabelX4d4c6ea8(
    block: InlineV1PaymentLinksPostRequestFormCustomFieldsAnyOf1ItemLabelX4d4c6ea8.Builder.() -> Unit,
): InlineV1PaymentLinksPostRequestFormCustomFieldsAnyOf1ItemLabelX4d4c6ea8 =
    InlineV1PaymentLinksPostRequestFormCustomFieldsAnyOf1ItemLabelX4d4c6ea8.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentLinksPostRequestFormCustomFieldsAnyOf1ItemLabelX4d4c6ea8 is missing required property '" +
                    name +
                    "'",
            )
