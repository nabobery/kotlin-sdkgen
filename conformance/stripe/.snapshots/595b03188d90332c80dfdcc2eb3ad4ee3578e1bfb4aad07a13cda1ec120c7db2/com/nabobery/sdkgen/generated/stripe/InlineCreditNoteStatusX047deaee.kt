...
public sealed class InlineCreditNoteStatusX047deaee {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineCreditNoteStatusX047deaee =
            when (value) {
                Issued.value -> Issued
                Void.value -> Void
    ...
    public object Serializer : KSerializer<InlineCreditNoteStatusX047deaee> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineCreditNoteStatusX047deaee",
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineCreditNoteStatusX047deaee,
        ) {
