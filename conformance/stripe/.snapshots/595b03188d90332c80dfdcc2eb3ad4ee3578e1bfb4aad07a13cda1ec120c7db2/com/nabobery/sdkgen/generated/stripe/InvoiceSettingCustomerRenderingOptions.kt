...
public class InvoiceSettingCustomerRenderingOptions(
    ...
    public class Builder {
        ...
        public fun build(): InvoiceSettingCustomerRenderingOptions =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InvoiceSettingCustomerRenderingOptions =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InvoiceSettingCustomerRenderingOptions> {
        ...
        override fun deserialize(decoder: Decoder): InvoiceSettingCustomerRenderingOptions {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("InvoiceSettingCustomerRenderingOptions must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InvoiceSettingCustomerRenderingOptions,
        ) {
...
public fun invoiceSettingCustomerRenderingOptions(
    block: InvoiceSettingCustomerRenderingOptions.Builder.() -> Unit,
): InvoiceSettingCustomerRenderingOptions = InvoiceSettingCustomerRenderingOptions.build(block)
