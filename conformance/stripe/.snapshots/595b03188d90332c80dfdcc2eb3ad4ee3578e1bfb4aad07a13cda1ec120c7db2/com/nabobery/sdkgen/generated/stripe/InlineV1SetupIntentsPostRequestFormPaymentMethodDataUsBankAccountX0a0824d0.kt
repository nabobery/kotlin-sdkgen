...
public class InlineV1SetupIntentsPostRequestFormPaymentMethodDataUsBankAccountX0a0824d0(
    public val accountHolderType: InlineV1SetupIntentsPostRequestFormPaymentMethodDataAccountHolderTypeXe426b69f? = null,
    public val accountNumber: String? = null,
    public val accountType: InlineV1SetupIntentsPostRequestFormPaymentMethodDataAccountTypeX7459691d? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1SetupIntentsPostRequestFormPaymentMethodDataUsBankAccountX0a0824d0 =
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1SetupIntentsPostRequestFormPaymentMethodDataUsBankAccountX0a0824d0 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1SetupIntentsPostRequestFormPaymentMethodDataUsBankAccountX0a0824d0> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SetupIntentsPostRequestFormPaymentMethodDataUsBankAccountX0a0824d0 must be a JSON object",
                    )
            return InlineV1SetupIntentsPostRequestFormPaymentMethodDataUsBankAccountX0a0824d0(
                accountHolderType =
                    rawObject["account_holder_type"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodDataAccountHolderTypeXe426b69f>(
                                it,
                            )
                    },
                ...
                accountType =
                    rawObject["account_type"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodDataAccountTypeX7459691d>(
                                it,
                            )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SetupIntentsPostRequestFormPaymentMethodDataUsBankAccountX0a0824d0,
        ) {
            val jsonEncoder =
...
public fun inlineV1SetupIntentsPostRequestFormPaymentMethodDataUsBankAccountX0a0824d0(
    block: InlineV1SetupIntentsPostRequestFormPaymentMethodDataUsBankAccountX0a0824d0.Builder.() -> Unit,
): InlineV1SetupIntentsPostRequestFormPaymentMethodDataUsBankAccountX0a0824d0 =
    InlineV1SetupIntentsPostRequestFormPaymentMethodDataUsBankAccountX0a0824d0.build(block)
