...
internal data class InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1Line1X9e521b40Inspection(
    ...
    public val matchesInlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2Xe9da5ee7: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2Xe9da5ee7,
            ).count {
                it
            }
}
...
public class InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1Line1X9e521b40 internal constructor(
    ...
    private val inspection: InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1Line1X9e521b40Inspection,
) {
    ...
    public val inlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2Xe9da5ee7:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2Xe9da5ee7) {
                json
                    .decodeFromJsonElement<InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2Xe9da5ee7>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1Line1X9e521b40Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2Xe9da5ee7) {
                    add(
                        InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1Line1X9e521b40Branch.InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2Xe9da5ee7,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1Line1X9e521b40 {
            val inspection = inspectInlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1Line1X9e521b40(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1Line1X9e521b40NoMatchException(
                    "InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1Line1X9e521b40 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1Line1X9e521b40> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1Line1X9e521b40,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1Line1X9e521b40",
...
private fun inspectInlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1Line1X9e521b40(
    element: JsonElement,
): InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1Line1X9e521b40Inspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2Xe9da5ee7 =
        element
            .isJsonDecodable<InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2Xe9da5ee7>()
    return InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1Line1X9e521b40Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2Xe9da5ee7) {
                    add(
                        "InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2Xe9da5ee7: value does not match InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2Xe9da5ee7",
                    )
                }
            },
    )
