...
public class InlineV1CheckoutSessionsPostRequestFormCustomTextAnyOf1Xf5625044(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1CheckoutSessionsPostRequestFormCustomTextAnyOf1Xf5625044 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormCustomTextAnyOf1Xf5625044> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CheckoutSessionsPostRequestFormCustomTextAnyOf1Xf5625044 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsPostRequestFormCustomTextAnyOf1Xf5625044,
        ) {
            val jsonEncoder =
...
public fun inlineV1CheckoutSessionsPostRequestFormCustomTextAnyOf1Xf5625044(
    block: InlineV1CheckoutSessionsPostRequestFormCustomTextAnyOf1Xf5625044.Builder.() -> Unit,
): InlineV1CheckoutSessionsPostRequestFormCustomTextAnyOf1Xf5625044 =
    InlineV1CheckoutSessionsPostRequestFormCustomTextAnyOf1Xf5625044.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1CheckoutSessionsPostRequestFormCustomTextAnyOf1Xf5625044 is missing required property '" + name +
                    "'",
            )
