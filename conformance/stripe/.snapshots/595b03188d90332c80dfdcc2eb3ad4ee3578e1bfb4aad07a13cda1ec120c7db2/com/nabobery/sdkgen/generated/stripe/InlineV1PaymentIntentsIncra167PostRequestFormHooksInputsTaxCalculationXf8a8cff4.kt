...
internal data class InlineV1PaymentIntentsIncra167PostRequestFormHooksInputsTaxCalculationXf8a8cff4Inspection(
    ...
    public val matchesInlineV1PaymentIntentsIncra167PostRequestFormHooksInputsTaxAnyOf2Xbf771f74: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1PaymentIntentsIncra167PostRequestFormHooksInputsTaxAnyOf2Xbf771f74,
            ).count {
                it
            }
}
...
public class InlineV1PaymentIntentsIncra167PostRequestFormHooksInputsTaxCalculationXf8a8cff4 internal constructor(
    ...
    private val inspection: InlineV1PaymentIntentsIncra167PostRequestFormHooksInputsTaxCalculationXf8a8cff4Inspection,
) {
    ...
    public val inlineV1PaymentIntentsIncra167PostRequestFormHooksInputsTaxAnyOf2Xbf771f74:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1PaymentIntentsIncra167PostRequestFormHooksInputsTaxAnyOf2Xbf771f74) {
                json
                    .decodeFromJsonElement<InlineV1PaymentIntentsIncra167PostRequestFormHooksInputsTaxAnyOf2Xbf771f74>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1PaymentIntentsIncra167PostRequestFormHooksInputsTaxCalculationXf8a8cff4Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1PaymentIntentsIncra167PostRequestFormHooksInputsTaxAnyOf2Xbf771f74) {
                    add(
                        InlineV1PaymentIntentsIncra167PostRequestFormHooksInputsTaxCalculationXf8a8cff4Branch.InlineV1PaymentIntentsIncra167PostRequestFormHooksInputsTaxAnyOf2Xbf771f74,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            ...
            if (inspection.matchCount == 0) {
                throw InlineV1PaymentIntentsIncra167PostRequestFormHooksInputsTaxCalculationXf8a8cff4NoMatchException(
                    "InlineV1PaymentIntentsIncra167PostRequestFormHooksInputsTaxCalculationXf8a8cff4 matched 0 branches: " +
                        inspection.failures.joinToString("; "),
                )
            }
            return InlineV1PaymentIntentsIncra167PostRequestFormHooksInputsTaxCalculationXf8a8cff4(
                raw,
                json,
                inspection,
            )
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsIncra167PostRequestFormHooksInputsTaxCalculationXf8a8cff4> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsIncra167PostRequestFormHooksInputsTaxCalculationXf8a8cff4,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1PaymentIntentsIncra167PostRequestFormHooksInputsTaxCalculationXf8a8cff4",
...
private fun inspectInlineV1PaymentIntentsIncra167PostRequestFormHooksInputsTaxCalculationXf8a8cff4(
    element: JsonElement,
): InlineV1PaymentIntentsIncra167PostRequestFormHooksInputsTaxCalculationXf8a8cff4Inspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1PaymentIntentsIncra167PostRequestFormHooksInputsTaxAnyOf2Xbf771f74 =
        element
            .isJsonDecodable<InlineV1PaymentIntentsIncra167PostRequestFormHooksInputsTaxAnyOf2Xbf771f74>()
    return InlineV1PaymentIntentsIncra167PostRequestFormHooksInputsTaxCalculationXf8a8cff4Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1PaymentIntentsIncra167PostRequestFormHooksInputsTaxAnyOf2Xbf771f74) {
                    add(
                        "InlineV1PaymentIntentsIncra167PostRequestFormHooksInputsTaxAnyOf2Xbf771f74: value does not match InlineV1PaymentIntentsIncra167PostRequestFormHooksInputsTaxAnyOf2Xbf771f74",
                    )
                }
            },
    )
