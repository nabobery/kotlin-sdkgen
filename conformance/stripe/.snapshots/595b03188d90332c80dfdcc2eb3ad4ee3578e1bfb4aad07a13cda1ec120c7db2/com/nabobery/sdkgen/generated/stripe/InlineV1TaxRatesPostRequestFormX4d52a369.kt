...
public class InlineV1TaxRatesPostRequestFormX4d52a369(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1TaxRatesPostRequestFormX4d52a369 =
            InlineV1TaxRatesPostRequestFormX4d52a369(
                active = active,
                country = country,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TaxRatesPostRequestFormX4d52a369 =
    ...
    public object Serializer : KSerializer<InlineV1TaxRatesPostRequestFormX4d52a369> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1TaxRatesPostRequestFormX4d52a369 {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("InlineV1TaxRatesPostRequestFormX4d52a369 must be a JSON object")
            return InlineV1TaxRatesPostRequestFormX4d52a369(
                ...
                metadata =
                    rawObject["metadata"]?.let {
                        json.decodeFromJsonElement<InlineV1TaxRatesPostRequestFormMetadataX8ae6ab0e>(it)
                    },
                state = rawObject["state"]?.let { json.decodeFromJsonElement<String>(it) },
                taxType =
                    rawObject["tax_type"]?.let {
                        json.decodeFromJsonElement<InlineV1TaxRatesPostRequestFormTaxTypeX4d1ebbe5>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TaxRatesPostRequestFormX4d52a369,
        ) {
...
public fun inlineV1TaxRatesPostRequestFormX4d52a369(
    block: InlineV1TaxRatesPostRequestFormX4d52a369.Builder.() -> Unit,
): InlineV1TaxRatesPostRequestFormX4d52a369 = InlineV1TaxRatesPostRequestFormX4d52a369.build(block)
