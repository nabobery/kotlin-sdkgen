...
public class LegalEntityRepresentativeDeclaration(
    ...
    public class Builder {
        ...
        public fun build(): LegalEntityRepresentativeDeclaration =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): LegalEntityRepresentativeDeclaration =
    ...
    public object Serializer : KSerializer<LegalEntityRepresentativeDeclaration> {
        ...
        override fun deserialize(decoder: Decoder): LegalEntityRepresentativeDeclaration {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("LegalEntityRepresentativeDeclaration must be a JSON object")
            return LegalEntityRepresentativeDeclaration(
                date =
                    rawObject["date"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: LegalEntityRepresentativeDeclaration,
        ) {
...
public fun legalEntityRepresentativeDeclaration(
    block: LegalEntityRepresentativeDeclaration.Builder.() -> Unit,
): LegalEntityRepresentativeDeclaration = LegalEntityRepresentativeDeclaration.build(block)
