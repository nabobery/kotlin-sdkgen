...
public class PaymentMethodIdeal(
    ...
    public class Builder {
        ...
        public fun build(): PaymentMethodIdeal =
            PaymentMethodIdeal(
                bank = bank,
                bic = bic,
            )
    ...
    public object Serializer : KSerializer<PaymentMethodIdeal> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodIdeal {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodIdeal must be a JSON object")
                ...
                bank =
                    rawObject["bank"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentMethodIdealBankXa5f90098?>(element)
                        }
                    },
                bic =
                    rawObject["bic"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentMethodIdealBicX5b98b2a6?>(element)
                        }
                    },
            )
        }
...
public fun paymentMethodIdeal(block: PaymentMethodIdeal.Builder.() -> Unit): PaymentMethodIdeal =
    PaymentMethodIdeal.build(block)
