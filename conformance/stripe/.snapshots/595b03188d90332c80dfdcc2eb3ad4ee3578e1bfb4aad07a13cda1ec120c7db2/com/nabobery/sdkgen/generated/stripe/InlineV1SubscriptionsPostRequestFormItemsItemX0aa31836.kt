...
public class InlineV1SubscriptionsPostRequestFormItemsItemX0aa31836(
    public val billingThresholds: InlineV1SubscriptionsPostRequestFormItemsItemBillingThresholdsX527d8145? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1SubscriptionsPostRequestFormItemsItemX0aa31836 =
            InlineV1SubscriptionsPostRequestFormItemsItemX0aa31836(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1SubscriptionsPostRequestFormItemsItemX0aa31836 =
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionsPostRequestFormItemsItemX0aa31836> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SubscriptionsPostRequestFormItemsItemX0aa31836 must be a JSON object",
                    )
            return InlineV1SubscriptionsPostRequestFormItemsItemX0aa31836(
                billingThresholds =
                    rawObject["billing_thresholds"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormItemsItemBillingThresholdsX527d8145>(
                                it,
                            )
                    },
                discounts =
                    rawObject["discounts"]?.let {
                        json.decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormItemsItemDiscountsX964ac1a3>(it)
                    },
                metadata = rawObject["metadata"]?.let { json.decodeFromJsonElement<Map<String, String>>(it) },
                price = rawObject["price"]?.let { json.decodeFromJsonElement<String>(it) },
                priceData =
                    rawObject["price_data"]?.let {
                        json.decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormItemsItemPriceDataX3932288c>(it)
                    },
                quantity = rawObject["quantity"]?.let { json.decodeFromJsonElement<Int>(it) },
                taxRates =
                    rawObject["tax_rates"]?.let {
                        json.decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormItemsItemTaxRatesX0727b13e>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsPostRequestFormItemsItemX0aa31836,
        ) {
...
public fun inlineV1SubscriptionsPostRequestFormItemsItemX0aa31836(
    block: InlineV1SubscriptionsPostRequestFormItemsItemX0aa31836.Builder.() -> Unit,
): InlineV1SubscriptionsPostRequestFormItemsItemX0aa31836 =
    InlineV1SubscriptionsPostRequestFormItemsItemX0aa31836.build(block)
