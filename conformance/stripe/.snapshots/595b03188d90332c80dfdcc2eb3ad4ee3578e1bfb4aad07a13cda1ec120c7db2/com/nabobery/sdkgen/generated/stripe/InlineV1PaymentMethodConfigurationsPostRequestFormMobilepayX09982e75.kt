...
public class InlineV1PaymentMethodConfigurationsPostRequestFormMobilepayX09982e75(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1PaymentMethodConfigurationsPostRequestFormMobilepayX09982e75 =
            InlineV1PaymentMethodConfigurationsPostRequestFormMobilepayX09982e75(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentMethodConfigurationsPostRequestFormMobilepayX09982e75 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1PaymentMethodConfigurationsPostRequestFormMobilepayX09982e75> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentMethodConfigurationsPostRequestFormMobilepayX09982e75 must be a JSON object",
                    )
            return InlineV1PaymentMethodConfigurationsPostRequestFormMobilepayX09982e75(
                displayPreference =
                    rawObject["display_preference"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentMethodConfidc49PostRequestFormMobilepayDisplayPreferenceXfc37769e>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentMethodConfigurationsPostRequestFormMobilepayX09982e75,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentMethodConfigurationsPostRequestFormMobilepayX09982e75(
    block: InlineV1PaymentMethodConfigurationsPostRequestFormMobilepayX09982e75.Builder.() -> Unit,
): InlineV1PaymentMethodConfigurationsPostRequestFormMobilepayX09982e75 =
    InlineV1PaymentMethodConfigurationsPostRequestFormMobilepayX09982e75.build(block)
