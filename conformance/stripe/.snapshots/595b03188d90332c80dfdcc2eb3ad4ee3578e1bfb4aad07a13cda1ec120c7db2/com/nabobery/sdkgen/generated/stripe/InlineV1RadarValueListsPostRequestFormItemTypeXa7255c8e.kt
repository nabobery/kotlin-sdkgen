...
public sealed class InlineV1RadarValueListsPostRequestFormItemTypeXa7255c8e {
    ...
    public companion object {
        public fun fromValue(`value`: kotlin.String): InlineV1RadarValueListsPostRequestFormItemTypeXa7255c8e =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1RadarValueListsPostRequestFormItemTypeXa7255c8e> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1RadarValueListsPostRequestFormItemTypeXa7255c8e",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1RadarValueListsPostRequestFormItemTypeXa7255c8e =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1RadarValueListsPostRequestFormItemTypeXa7255c8e,
        ) {
