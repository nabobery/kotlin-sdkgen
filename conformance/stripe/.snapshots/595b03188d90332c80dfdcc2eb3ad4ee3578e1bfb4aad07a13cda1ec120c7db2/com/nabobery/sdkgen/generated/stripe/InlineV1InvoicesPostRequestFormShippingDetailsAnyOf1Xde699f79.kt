...
public class InlineV1InvoicesPostRequestFormShippingDetailsAnyOf1Xde699f79(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1InvoicesPostRequestFormShippingDetailsAnyOf1Xde699f79 =
    ...
    public object Serializer : KSerializer<InlineV1InvoicesPostRequestFormShippingDetailsAnyOf1Xde699f79> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1InvoicesPostRequestFormShippingDetailsAnyOf1Xde699f79 {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1InvoicesPostRequestFormShippingDetailsAnyOf1Xde699f79 must be a JSON object",
                    )
            val address =
                json.decodeRequired<InlineV1InvoicesPostRequestFormShippingDetailsAnyOf1AddressX782bd5ef>(
                    rawObject,
                    "address",
                )
            ...
            return InlineV1InvoicesPostRequestFormShippingDetailsAnyOf1Xde699f79(
                ...
                phone =
                    rawObject["phone"]?.let {
                        json.decodeFromJsonElement<InlineV1InvoicesPostRequestFormShippingDetailsAnyOf1PhoneX9e04fbf9>(
                            it,
                        )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesPostRequestFormShippingDetailsAnyOf1Xde699f79,
        ) {
            val jsonEncoder =
...
public fun inlineV1InvoicesPostRequestFormShippingDetailsAnyOf1Xde699f79(
    block: InlineV1InvoicesPostRequestFormShippingDetailsAnyOf1Xde699f79.Builder.() -> Unit,
): InlineV1InvoicesPostRequestFormShippingDetailsAnyOf1Xde699f79 =
    InlineV1InvoicesPostRequestFormShippingDetailsAnyOf1Xde699f79.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1InvoicesPostRequestFormShippingDetailsAnyOf1Xde699f79 is missing required property '" + name +
                    "'",
            )
