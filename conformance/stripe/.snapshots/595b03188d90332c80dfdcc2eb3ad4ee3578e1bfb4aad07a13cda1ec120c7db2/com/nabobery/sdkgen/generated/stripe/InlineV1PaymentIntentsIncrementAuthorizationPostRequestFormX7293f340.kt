...
public class InlineV1PaymentIntentsIncrementAuthorizationPostRequestFormX7293f340(
     ...
     */
    public val amountDetails: InlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsXc4e74fe8? = null,
    /**
     ...
     */
    public val hooks: InlineV1PaymentIntentsIncrementAuthorizationPostRequestFormHooksX56cd1318? = null,
    /**
     ...
     */
    public val paymentDetails: InlineV1PaymentIntentsIncra167PostRequestFormPaymentDetailsX78b8483b? = null,
    /**
     ...
     */
    public val transferData: InlineV1PaymentIntentsIncrementAuthorizationPostRequestFormTransferDataX9a57b9e7? = null,
) {
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentIntentsIncrementAuthorizationPostRequestFormX7293f340 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentIntentsIncrementAuthorizationPostRequestFormX7293f340> {
        override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1PaymentIntentsIncrementAuthorizationPostRequestFormX7293f340 {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsIncrementAuthorizationPostRequestFormX7293f340 must be a JSON object",
                    )
            ...
            return InlineV1PaymentIntentsIncrementAuthorizationPostRequestFormX7293f340(
                ...
                amountDetails =
                    rawObject["amount_details"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsXc4e74fe8>(
                            it,
                        )
                    },
                ...
                hooks =
                    rawObject["hooks"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsIncrementAuthorizationPostRequestFormHooksX56cd1318>(
                                it,
                            )
                    },
                ...
                paymentDetails =
                    rawObject["payment_details"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsIncra167PostRequestFormPaymentDetailsX78b8483b>(
                                it,
                            )
                    },
                statementDescriptor =
                ...
                transferData =
                    rawObject["transfer_data"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsIncrementAuthorizationPostRequestFormTransferDataX9a57b9e7>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsIncrementAuthorizationPostRequestFormX7293f340,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentIntentsIncrementAuthorizationPostRequestFormX7293f340(
    block: InlineV1PaymentIntentsIncrementAuthorizationPostRequestFormX7293f340.Builder.() -> Unit,
): InlineV1PaymentIntentsIncrementAuthorizationPostRequestFormX7293f340 =
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentIntentsIncrementAuthorizationPostRequestFormX7293f340 is missing required property '" +
                    name +
                    "'",
            )
