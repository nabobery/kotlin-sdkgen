...
public class TerminalReaderReaderResourceCollectPaymentMethodAction(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): TerminalReaderReaderResourceCollectPaymentMethodAction =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<TerminalReaderReaderResourceCollectPaymentMethodAction> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "TerminalReaderReaderResourceCollectPaymentMethodAction must be a JSON object",
                    )
            val paymentIntent =
                json.decodeRequired<InlineTerminalReaderReaderd071PaymentIntentX8b0bb902>(
                    rawObject,
                    "payment_intent",
                )
            return TerminalReaderReaderResourceCollectPaymentMethodAction(
                ...
                collectConfig =
                    rawObject["collect_config"]?.let {
                        json.decodeFromJsonElement<TerminalReaderReaderResourceCollectConfig>(it)
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: TerminalReaderReaderResourceCollectPaymentMethodAction,
        ) {
...
public fun terminalReaderReaderResourceCollectPaymentMethodAction(
    block: TerminalReaderReaderResourceCollectPaymentMethodAction.Builder.() -> Unit,
): TerminalReaderReaderResourceCollectPaymentMethodAction =
    TerminalReaderReaderResourceCollectPaymentMethodAction.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "TerminalReaderReaderResourceCollectPaymentMethodAction is missing required property '" + name + "'",
            )
