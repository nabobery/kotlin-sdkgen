...
public class InlineTaxIDsOwnerAccountX1491eced internal constructor(
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineTaxIDsOwnerAccountX1491eced {
            val inspection = inspectInlineTaxIDsOwnerAccountX1491eced(raw)
            if (inspection.matchCount == 0) {
                throw InlineTaxIDsOwnerAccountX1491ecedNoMatchException(
                    "InlineTaxIDsOwnerAccountX1491eced matched 0 branches: " + inspection.failures.joinToString("; "),
                )
            }
    ...
    public object Serializer : KSerializer<InlineTaxIDsOwnerAccountX1491eced> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineTaxIDsOwnerAccountX1491eced,
        ) {
...
private fun inspectInlineTaxIDsOwnerAccountX1491eced(
    element: JsonElement,
): InlineTaxIDsOwnerAccountX1491ecedInspection {
