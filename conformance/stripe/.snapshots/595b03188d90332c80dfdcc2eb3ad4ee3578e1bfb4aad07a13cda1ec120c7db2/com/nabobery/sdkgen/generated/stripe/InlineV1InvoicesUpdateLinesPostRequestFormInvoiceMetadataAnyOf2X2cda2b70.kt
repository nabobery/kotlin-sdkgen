...
public sealed class InlineV1InvoicesUpdateLinesPostRequestFormInvoiceMetadataAnyOf2X2cda2b70 {
    ...
    public object Serializer : KSerializer<InlineV1InvoicesUpdateLinesPostRequestFormInvoiceMetadataAnyOf2X2cda2b70> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1InvoicesUpdateLinesPostRequestFormInvoiceMetadataAnyOf2X2cda2b70",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1InvoicesUpdateLinesPostRequestFormInvoiceMetadataAnyOf2X2cda2b70 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesUpdateLinesPostRequestFormInvoiceMetadataAnyOf2X2cda2b70,
        ) {
