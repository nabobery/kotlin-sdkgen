...
public sealed class InlineCheckoutSessionPaymentMethodCollectionX18402ff1 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineCheckoutSessionPaymentMethodCollectionX18402ff1 =
            when (value) {
                Always.value -> Always
    ...
    public object Serializer : KSerializer<InlineCheckoutSessionPaymentMethodCollectionX18402ff1> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineCheckoutSessionPaymentMethodCollectionX18402ff1",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineCheckoutSessionPaymentMethodCollectionX18402ff1 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineCheckoutSessionPaymentMethodCollectionX18402ff1,
        ) {
