...
public class TreasuryInboundTransfersResourceFailureDetails(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): TreasuryInboundTransfersResourceFailureDetails =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<TreasuryInboundTransfersResourceFailureDetails> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "TreasuryInboundTransfersResourceFailureDetails must be a JSON object",
                    )
            val code =
                json.decodeRequired<InlineTreasuryInboundTransfersResourceFailureDetailsCodeX56a507b5>(
                    rawObject,
                    "code",
                )
            return TreasuryInboundTransfersResourceFailureDetails(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: TreasuryInboundTransfersResourceFailureDetails,
        ) {
...
public fun treasuryInboundTransfersResourceFailureDetails(
    block: TreasuryInboundTransfersResourceFailureDetails.Builder.() -> Unit,
): TreasuryInboundTransfersResourceFailureDetails = TreasuryInboundTransfersResourceFailureDetails.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "TreasuryInboundTransfersResourceFailureDetails is missing required property '" + name + "'",
            )
