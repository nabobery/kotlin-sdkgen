...
public class PaymentMethodDetailsPaymentRecordKonbini(
    ...
    public class Builder {
        ...
        public fun build(): PaymentMethodDetailsPaymentRecordKonbini =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentMethodDetailsPaymentRecordKonbini =
    ...
    public object Serializer : KSerializer<PaymentMethodDetailsPaymentRecordKonbini> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodDetailsPaymentRecordKonbini {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodDetailsPaymentRecordKonbini must be a JSON object")
            return PaymentMethodDetailsPaymentRecordKonbini(
                store =
                    rawObject["store"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlinePaymentMethodDetailsPaymentRecordKonbiniStoreX1a54041b?>(
                                element,
                            )
                        }
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentMethodDetailsPaymentRecordKonbini,
        ) {
...
public fun paymentMethodDetailsPaymentRecordKonbini(
    block: PaymentMethodDetailsPaymentRecordKonbini.Builder.() -> Unit,
): PaymentMethodDetailsPaymentRecordKonbini = PaymentMethodDetailsPaymentRecordKonbini.build(block)
