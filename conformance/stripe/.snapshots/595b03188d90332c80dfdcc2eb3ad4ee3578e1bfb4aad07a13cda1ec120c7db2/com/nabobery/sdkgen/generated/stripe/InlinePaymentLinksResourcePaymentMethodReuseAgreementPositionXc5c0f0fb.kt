...
public sealed class InlinePaymentLinksResourcePaymentMethodReuseAgreementPositionXc5c0f0fb {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentLinksResourcePaymentMethodReuseAgreementPositionXc5c0f0fb =
            when (value) {
                Auto.value -> Auto
                Hidden.value -> Hidden
    ...
    public object Serializer : KSerializer<InlinePaymentLinksResourcePaymentMethodReuseAgreementPositionXc5c0f0fb> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentLinksResourcePaymentMethodReuseAgreementPositionXc5c0f0fb",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlinePaymentLinksResourcePaymentMethodReuseAgreementPositionXc5c0f0fb = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentLinksResourcePaymentMethodReuseAgreementPositionXc5c0f0fb,
        ) {
