...
public sealed class InlineV1TaxRegistrationsPostRequestFormExpiresAtAnyOf3X89e67c28 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1TaxRegistrationsPostRequestFormExpiresAtAnyOf3X89e67c28 =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1TaxRegistrationsPostRequestFormExpiresAtAnyOf3X89e67c28> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1TaxRegistrationsPostRequestFormExpiresAtAnyOf3X89e67c28",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1TaxRegistrationsPostRequestFormExpiresAtAnyOf3X89e67c28 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TaxRegistrationsPostRequestFormExpiresAtAnyOf3X89e67c28,
        ) {
