...
public sealed class InlineV1PaymentLinksPostRequestFormSubmitTypeXdb2280b9 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1PaymentLinksPostRequestFormSubmitTypeXdb2280b9 =
            when (value) {
                Auto.value -> Auto
                Book.value -> Book
                Donate.value -> Donate
    ...
    public object Serializer : KSerializer<InlineV1PaymentLinksPostRequestFormSubmitTypeXdb2280b9> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1PaymentLinksPostRequestFormSubmitTypeXdb2280b9",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1PaymentLinksPostRequestFormSubmitTypeXdb2280b9 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentLinksPostRequestFormSubmitTypeXdb2280b9,
        ) {
