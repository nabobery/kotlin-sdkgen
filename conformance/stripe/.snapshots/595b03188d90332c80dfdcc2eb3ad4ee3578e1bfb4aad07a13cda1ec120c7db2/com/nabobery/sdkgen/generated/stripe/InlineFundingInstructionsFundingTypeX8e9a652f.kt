...
public sealed class InlineFundingInstructionsFundingTypeX8e9a652f {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineFundingInstructionsFundingTypeX8e9a652f =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineFundingInstructionsFundingTypeX8e9a652f> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineFundingInstructionsFundingTypeX8e9a652f",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineFundingInstructionsFundingTypeX8e9a652f =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineFundingInstructionsFundingTypeX8e9a652f,
        ) {
