...
public class InlineV1ProductsPostRequestFormX10c55a15(
     ...
     */
    public val marketingFeatures: List<InlineV1ProductsPostRequestFormMarketingFeaturesItemX4b4c8555>? = null,
    /**
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1ProductsPostRequestFormX10c55a15 =
    ...
    public object Serializer : KSerializer<InlineV1ProductsPostRequestFormX10c55a15> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1ProductsPostRequestFormX10c55a15 {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("InlineV1ProductsPostRequestFormX10c55a15 must be a JSON object")
            val name = json.decodeRequired<String>(rawObject, "name")
            return InlineV1ProductsPostRequestFormX10c55a15(
                name = name,
                active = rawObject["active"]?.let { json.decodeFromJsonElement<Boolean>(it) },
                defaultPriceData =
                    rawObject["default_price_data"]?.let {
                        json.decodeFromJsonElement<InlineV1ProductsPostRequestFormDefaultPriceDataXc35fa89f>(it)
                    },
                ...
                marketingFeatures =
                    rawObject["marketing_features"]?.let {
                        json.decodeFromJsonElement<List<InlineV1ProductsPostRequestFormMarketingFeaturesItemX4b4c8555>>(
                            it,
                        )
                    },
                ...
                packageDimensions =
                    rawObject["package_dimensions"]?.let {
                        json.decodeFromJsonElement<InlineV1ProductsPostRequestFormPackageDimensionsX5af8d9e3>(it)
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ProductsPostRequestFormX10c55a15,
        ) {
...
public fun inlineV1ProductsPostRequestFormX10c55a15(
    block: InlineV1ProductsPostRequestFormX10c55a15.Builder.() -> Unit,
): InlineV1ProductsPostRequestFormX10c55a15 = InlineV1ProductsPostRequestFormX10c55a15.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1ProductsPostRequestFormX10c55a15 is missing required property '" + name + "'",
            )
