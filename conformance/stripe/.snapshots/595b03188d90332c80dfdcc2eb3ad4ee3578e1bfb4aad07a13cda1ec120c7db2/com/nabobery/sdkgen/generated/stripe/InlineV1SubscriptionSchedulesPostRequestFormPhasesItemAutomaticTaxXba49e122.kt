...
public class InlineV1SubscriptionSchedulesPostRequestFormPhasesItemAutomaticTaxXba49e122(
    ...
    public val liability: InlineV1SubscriptionSchedulesPostRequestFormPhasesItemLiabilityXce20ae2f? = null,
) {
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1SubscriptionSchedulesPostRequestFormPhasesItemAutomaticTaxXba49e122 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemAutomaticTaxXba49e122> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SubscriptionSchedulesPostRequestFormPhasesItemAutomaticTaxXba49e122 must be a JSON object",
                    )
            ...
            return InlineV1SubscriptionSchedulesPostRequestFormPhasesItemAutomaticTaxXba49e122(
                ...
                liability =
                    rawObject["liability"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemLiabilityXce20ae2f>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionSchedulesPostRequestFormPhasesItemAutomaticTaxXba49e122,
        ) {
            val jsonEncoder =
...
public fun inlineV1SubscriptionSchedulesPostRequestFormPhasesItemAutomaticTaxXba49e122(
    block: InlineV1SubscriptionSchedulesPostRequestFormPhasesItemAutomaticTaxXba49e122.Builder.() -> Unit,
): InlineV1SubscriptionSchedulesPostRequestFormPhasesItemAutomaticTaxXba49e122 =
    InlineV1SubscriptionSchedulesPostRequestFormPhasesItemAutomaticTaxXba49e122.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1SubscriptionSchedulesPostRequestFormPhasesItemAutomaticTaxXba49e122 is missing required property '" +
                    name +
                    "'",
            )
