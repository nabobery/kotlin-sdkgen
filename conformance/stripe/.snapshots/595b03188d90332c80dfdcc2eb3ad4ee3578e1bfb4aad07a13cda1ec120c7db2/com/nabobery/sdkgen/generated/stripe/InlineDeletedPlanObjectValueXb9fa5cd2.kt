...
public sealed class InlineDeletedPlanObjectValueXb9fa5cd2 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineDeletedPlanObjectValueXb9fa5cd2 =
            when (value) {
                Plan.value -> Plan
    ...
    public object Serializer : KSerializer<InlineDeletedPlanObjectValueXb9fa5cd2> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineDeletedPlanObjectValueXb9fa5cd2",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineDeletedPlanObjectValueXb9fa5cd2 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineDeletedPlanObjectValueXb9fa5cd2,
        ) {
