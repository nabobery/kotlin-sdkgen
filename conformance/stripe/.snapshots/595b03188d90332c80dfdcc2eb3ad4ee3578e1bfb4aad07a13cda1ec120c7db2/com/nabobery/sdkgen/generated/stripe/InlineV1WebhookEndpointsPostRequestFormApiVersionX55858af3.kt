...
public sealed class InlineV1WebhookEndpointsPostRequestFormApiVersionX55858af3 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1WebhookEndpointsPostRequestFormApiVersionX55858af3 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1WebhookEndpointsPostRequestFormApiVersionX55858af3> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1WebhookEndpointsPostRequestFormApiVersionX55858af3",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1WebhookEndpointsPostRequestFormApiVersionX55858af3 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1WebhookEndpointsPostRequestFormApiVersionX55858af3,
        ) {
