...
public class InlineV1PaymentRecordsRepo134dPostRequestFormBillingDetailsX39bbed07(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1PaymentRecordsRepo134dPostRequestFormBillingDetailsX39bbed07 =
            InlineV1PaymentRecordsRepo134dPostRequestFormBillingDetailsX39bbed07(
                address = address,
                email = email,
                name = name,
                phone = phone,
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentRecordsRepo134dPostRequestFormBillingDetailsX39bbed07 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentRecordsRepo134dPostRequestFormBillingDetailsX39bbed07> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentRecordsRepo134dPostRequestFormBillingDetailsX39bbed07 must be a JSON object",
                    )
            return InlineV1PaymentRecordsRepo134dPostRequestFormBillingDetailsX39bbed07(
                address =
                    rawObject["address"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentRecordsRepo134dPostRequestFormAddressX12a2d4e1>(it)
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentRecordsRepo134dPostRequestFormBillingDetailsX39bbed07,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentRecordsRepo134dPostRequestFormBillingDetailsX39bbed07(
    block: InlineV1PaymentRecordsRepo134dPostRequestFormBillingDetailsX39bbed07.Builder.() -> Unit,
): InlineV1PaymentRecordsRepo134dPostRequestFormBillingDetailsX39bbed07 =
    InlineV1PaymentRecordsRepo134dPostRequestFormBillingDetailsX39bbed07.build(block)
