...
public sealed class InlinePaymentMethodDetailsSofortPreferredLanguageX6c742254 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentMethodDetailsSofortPreferredLanguageX6c742254 =
            when (value) {
                De.value -> De
                En.value -> En
                Es.value -> Es
    ...
    public object Serializer : KSerializer<InlinePaymentMethodDetailsSofortPreferredLanguageX6c742254> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentMethodDetailsSofortPreferredLanguageX6c742254",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePaymentMethodDetailsSofortPreferredLanguageX6c742254 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentMethodDetailsSofortPreferredLanguageX6c742254,
        ) {
