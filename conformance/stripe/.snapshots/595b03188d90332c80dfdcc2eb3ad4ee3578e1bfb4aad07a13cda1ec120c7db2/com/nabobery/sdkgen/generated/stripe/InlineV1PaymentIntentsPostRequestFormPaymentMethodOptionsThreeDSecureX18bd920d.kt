...
public class InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsThreeDSecureX18bd920d(
    ...
    public val exemptionIndicator: InlineV1PaymentIntentsPostRequestFormExemptionIndicatorXa4228990? = null,
    public val networkOptions: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsNetworkOptionsX77539485? = null,
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsThreeDSecureX18bd920d =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsThreeDSecureX18bd920d> {
        ...
        override fun deserialize(
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsThreeDSecureX18bd920d must be a JSON object",
                    )
            ...
            val version =
                json.decodeRequired<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsCardVersionXffec19d6>(
                    rawObject,
                    "version",
                )
            return InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsThreeDSecureX18bd920d(
                ...
                aresTransStatus =
                    rawObject["ares_trans_status"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormAresTransStatusX9ca8ee38>(it)
                    },
                electronicCommerceIndicator =
                    rawObject["electronic_commerce_indicator"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormElectronicCommerceIn67d5Xce5437a7>(
                                it,
                            )
                    },
                exemptionIndicator =
                    rawObject["exemption_indicator"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormExemptionIndicatorXa4228990>(it)
                    },
                networkOptions =
                    rawObject["network_options"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsNetworkOptionsX77539485>(
                                it,
                            )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsThreeDSecureX18bd920d,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsThreeDSecureX18bd920d(
    block: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsThreeDSecureX18bd920d.Builder.() -> Unit,
): InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsThreeDSecureX18bd920d =
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsThreeDSecureX18bd920d is missing required property '" +
                    name +
                    "'",
            )
