...
public class InlineV1CustomersPostRequestFormShippingAnyOf1X028a55f8(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1CustomersPostRequestFormShippingAnyOf1X028a55f8 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1CustomersPostRequestFormShippingAnyOf1X028a55f8> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CustomersPostRequestFormShippingAnyOf1X028a55f8 must be a JSON object",
                    )
            val address =
                json.decodeRequired<InlineV1CustomersPostRequestFormShippingAnyOf1AddressX65c1c06e>(
                    rawObject,
                    "address",
                )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersPostRequestFormShippingAnyOf1X028a55f8,
        ) {
...
public fun inlineV1CustomersPostRequestFormShippingAnyOf1X028a55f8(
    block: InlineV1CustomersPostRequestFormShippingAnyOf1X028a55f8.Builder.() -> Unit,
): InlineV1CustomersPostRequestFormShippingAnyOf1X028a55f8 =
    InlineV1CustomersPostRequestFormShippingAnyOf1X028a55f8.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1CustomersPostRequestFormShippingAnyOf1X028a55f8 is missing required property '" + name + "'",
            )
