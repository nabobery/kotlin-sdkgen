...
public class InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsKlarnaXe99e1cdd(
    ...
    public val onDemand: InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsOnDemandX9078cf4e? = null,
    public val preferredLocale: InlineV1SetupIntentsConfirmPostRequestFormPreferredLocaleXb031fe53? = null,
    public val subscriptions: InlineV1SetupIntentsConfirmPostRequestFormSubscriptionsX9095d02a? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsKlarnaXe99e1cdd =
    ...
    public object Serializer : KSerializer<InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsKlarnaXe99e1cdd> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsKlarnaXe99e1cdd must be a JSON object",
                    )
            return InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsKlarnaXe99e1cdd(
                ...
                onDemand =
                    rawObject["on_demand"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsOnDemandX9078cf4e>(
                                it,
                            )
                    },
                preferredLocale =
                    rawObject["preferred_locale"]?.let {
                        json.decodeFromJsonElement<InlineV1SetupIntentsConfirmPostRequestFormPreferredLocaleXb031fe53>(
                            it,
                        )
                    },
                subscriptions =
                    rawObject["subscriptions"]?.let {
                        json.decodeFromJsonElement<InlineV1SetupIntentsConfirmPostRequestFormSubscriptionsX9095d02a>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsKlarnaXe99e1cdd,
        ) {
            val jsonEncoder =
...
public fun inlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsKlarnaXe99e1cdd(
    block: InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsKlarnaXe99e1cdd.Builder.() -> Unit,
): InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsKlarnaXe99e1cdd =
    InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsKlarnaXe99e1cdd.build(block)
