...
public class RadarRadarOptions(
    ...
    public class Builder {
        ...
        public fun build(): RadarRadarOptions =
            RadarRadarOptions(
                session = session,
            )
    }
        ...
        override fun deserialize(decoder: Decoder): RadarRadarOptions {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("RadarRadarOptions must be a JSON object")
...
public fun radarRadarOptions(block: RadarRadarOptions.Builder.() -> Unit): RadarRadarOptions =
    RadarRadarOptions.build(block)
