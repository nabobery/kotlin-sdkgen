...
public class InlineV1SubscriptionSchedulesPostRequestFormX09f3d58b(
     ...
     */
    public val defaultSettings: InlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsXb5a49a7a? = null,
    /**
     ...
     * the next phase.
     */
    public val phases: List<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemX0f47ab06>? = null,
    /**
    ...
    public class Builder {
         ...
         * of the next phase.
         */
        public var phases: List<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemX0f47ab06>? = null
        ...
        public fun build(): InlineV1SubscriptionSchedulesPostRequestFormX09f3d58b =
            InlineV1SubscriptionSchedulesPostRequestFormX09f3d58b(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1SubscriptionSchedulesPostRequestFormX09f3d58b =
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionSchedulesPostRequestFormX09f3d58b> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SubscriptionSchedulesPostRequestFormX09f3d58b must be a JSON object",
                    )
            return InlineV1SubscriptionSchedulesPostRequestFormX09f3d58b(
                billingMode =
                    rawObject["billing_mode"]?.let {
                        json.decodeFromJsonElement<InlineV1SubscriptionSchedulesPostRequestFormBillingModeXd1fd61ba>(it)
                    },
                ...
                defaultSettings =
                    rawObject["default_settings"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsXb5a49a7a>(
                                it,
                            )
                    },
                endBehavior =
                    rawObject["end_behavior"]?.let {
                        json.decodeFromJsonElement<InlineV1SubscriptionSchedulesPostRequestFormEndBehaviorXe2268f44>(it)
                    },
                expand = rawObject["expand"]?.let { json.decodeFromJsonElement<List<String>>(it) },
                fromSubscription = rawObject["from_subscription"]?.let { json.decodeFromJsonElement<String>(it) },
                metadata =
                    rawObject["metadata"]?.let {
                        json.decodeFromJsonElement<InlineV1SubscriptionSchedulesPostRequestFormMetadataXfae7d157>(it)
                    },
                phases =
                    rawObject["phases"]?.let {
                        json
                            .decodeFromJsonElement<List<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemX0f47ab06>>(
                                it,
                            )
                    },
                startDate =
                    rawObject["start_date"]?.let {
                        json.decodeFromJsonElement<InlineV1SubscriptionSchedulesPostRequestFormStartDateXd5ca9c73>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionSchedulesPostRequestFormX09f3d58b,
        ) {
...
public fun inlineV1SubscriptionSchedulesPostRequestFormX09f3d58b(
    block: InlineV1SubscriptionSchedulesPostRequestFormX09f3d58b.Builder.() -> Unit,
): InlineV1SubscriptionSchedulesPostRequestFormX09f3d58b =
    InlineV1SubscriptionSchedulesPostRequestFormX09f3d58b.build(block)
