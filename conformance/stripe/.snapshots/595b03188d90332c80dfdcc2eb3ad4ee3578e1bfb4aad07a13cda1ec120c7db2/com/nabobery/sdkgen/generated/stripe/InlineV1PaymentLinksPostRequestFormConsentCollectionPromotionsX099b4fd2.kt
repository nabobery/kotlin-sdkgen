...
public sealed class InlineV1PaymentLinksPostRequestFormConsentCollectionPromotionsX099b4fd2 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1PaymentLinksPostRequestFormConsentCollectionPromotionsX099b4fd2 =
            when (value) {
                Auto.value -> Auto
                None.value -> None
    ...
    public object Serializer : KSerializer<InlineV1PaymentLinksPostRequestFormConsentCollectionPromotionsX099b4fd2> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1PaymentLinksPostRequestFormConsentCollectionPromotionsX099b4fd2",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1PaymentLinksPostRequestFormConsentCollectionPromotionsX099b4fd2 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentLinksPostRequestFormConsentCollectionPromotionsX099b4fd2,
        ) {
