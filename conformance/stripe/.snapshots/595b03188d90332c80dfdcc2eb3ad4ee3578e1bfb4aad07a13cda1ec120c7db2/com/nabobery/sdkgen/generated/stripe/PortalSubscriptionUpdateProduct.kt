...
public class PortalSubscriptionUpdateProduct(
    ...
    public object Serializer : KSerializer<PortalSubscriptionUpdateProduct> {
        ...
        override fun deserialize(decoder: Decoder): PortalSubscriptionUpdateProduct {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PortalSubscriptionUpdateProduct must be a JSON object")
            val adjustableQuantity =
                json.decodeRequired<PortalSubscriptionUpdateProductAdjustableQuantity>(
                    rawObject,
                    "adjustable_quantity",
                )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PortalSubscriptionUpdateProduct,
        ) {
...
public fun portalSubscriptionUpdateProduct(
    block: PortalSubscriptionUpdateProduct.Builder.() -> Unit,
): PortalSubscriptionUpdateProduct = PortalSubscriptionUpdateProduct.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "PortalSubscriptionUpdateProduct is missing required property '" + name + "'",
            )
