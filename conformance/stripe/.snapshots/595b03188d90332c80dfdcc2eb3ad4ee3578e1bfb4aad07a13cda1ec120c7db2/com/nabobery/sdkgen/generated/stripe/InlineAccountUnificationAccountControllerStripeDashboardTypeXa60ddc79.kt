...
public sealed class InlineAccountUnificationAccountControllerStripeDashboardTypeXa60ddc79 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineAccountUnificationAccountControllerStripeDashboardTypeXa60ddc79 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineAccountUnificationAccountControllerStripeDashboardTypeXa60ddc79> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineAccountUnificationAccountControllerStripeDashboardTypeXa60ddc79",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineAccountUnificationAccountControllerStripeDashboardTypeXa60ddc79 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineAccountUnificationAccountControllerStripeDashboardTypeXa60ddc79,
        ) {
