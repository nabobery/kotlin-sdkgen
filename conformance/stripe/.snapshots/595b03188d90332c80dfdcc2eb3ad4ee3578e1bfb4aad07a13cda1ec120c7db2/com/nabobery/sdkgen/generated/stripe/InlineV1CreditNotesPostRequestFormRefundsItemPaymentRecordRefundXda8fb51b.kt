...
public class InlineV1CreditNotesPostRequestFormRefundsItemPaymentRecordRefundXda8fb51b(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1CreditNotesPostRequestFormRefundsItemPaymentRecordRefundXda8fb51b = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1CreditNotesPostRequestFormRefundsItemPaymentRecordRefundXda8fb51b> {
        ...
        override fun deserialize(
            decoder: Decoder,
        ): InlineV1CreditNotesPostRequestFormRefundsItemPaymentRecordRefundXda8fb51b {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CreditNotesPostRequestFormRefundsItemPaymentRecordRefundXda8fb51b must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CreditNotesPostRequestFormRefundsItemPaymentRecordRefundXda8fb51b,
        ) {
            val jsonEncoder =
...
public fun inlineV1CreditNotesPostRequestFormRefundsItemPaymentRecordRefundXda8fb51b(
    block: InlineV1CreditNotesPostRequestFormRefundsItemPaymentRecordRefundXda8fb51b.Builder.() -> Unit,
): InlineV1CreditNotesPostRequestFormRefundsItemPaymentRecordRefundXda8fb51b =
    InlineV1CreditNotesPostRequestFormRefundsItemPaymentRecordRefundXda8fb51b.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1CreditNotesPostRequestFormRefundsItemPaymentRecordRefundXda8fb51b is missing required property '" +
                    name +
                    "'",
            )
