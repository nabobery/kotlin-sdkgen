...
public sealed class InlineV1InvoiceRenderingTemplatesGetResponse200JsonObjectValueXff003a9d {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1InvoiceRenderingTemplatesGetResponse200JsonObjectValueXff003a9d =
            when (value) {
                List.value -> List
    ...
    public object Serializer : KSerializer<InlineV1InvoiceRenderingTemplatesGetResponse200JsonObjectValueXff003a9d> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1InvoiceRenderingTemplatesGetResponse200JsonObjectValueXff003a9d",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1InvoiceRenderingTemplatesGetResponse200JsonObjectValueXff003a9d = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoiceRenderingTemplatesGetResponse200JsonObjectValueXff003a9d,
        ) {
