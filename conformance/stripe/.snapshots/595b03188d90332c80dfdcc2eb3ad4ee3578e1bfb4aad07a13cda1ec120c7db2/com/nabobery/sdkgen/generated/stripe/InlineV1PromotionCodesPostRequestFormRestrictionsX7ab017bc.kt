...
public class InlineV1PromotionCodesPostRequestFormRestrictionsX7ab017bc(
    public val currencyOptions:
        Map<String, InlineV1PromotionCodesPostRequestFormRestrictionsAdditionalValueX5a327e06>? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1PromotionCodesPostRequestFormRestrictionsX7ab017bc =
            InlineV1PromotionCodesPostRequestFormRestrictionsX7ab017bc(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PromotionCodesPostRequestFormRestrictionsX7ab017bc =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PromotionCodesPostRequestFormRestrictionsX7ab017bc> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PromotionCodesPostRequestFormRestrictionsX7ab017bc must be a JSON object",
                    )
            return InlineV1PromotionCodesPostRequestFormRestrictionsX7ab017bc(
                currencyOptions =
                    rawObject["currency_options"]?.let {
                        json
                            .decodeFromJsonElement<Map<String, InlineV1PromotionCodesPostRequestFormRestrictionsAdditionalValueX5a327e06>>(
                                it,
                            )
                    },
                firstTimeTransaction =
                    rawObject["first_time_transaction"]?.let {
                        json
                ...
                minimumAmountCurrency =
                    rawObject["minimum_amount_currency"]?.let {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PromotionCodesPostRequestFormRestrictionsX7ab017bc,
        ) {
...
public fun inlineV1PromotionCodesPostRequestFormRestrictionsX7ab017bc(
    block: InlineV1PromotionCodesPostRequestFormRestrictionsX7ab017bc.Builder.() -> Unit,
): InlineV1PromotionCodesPostRequestFormRestrictionsX7ab017bc =
    InlineV1PromotionCodesPostRequestFormRestrictionsX7ab017bc.build(block)
