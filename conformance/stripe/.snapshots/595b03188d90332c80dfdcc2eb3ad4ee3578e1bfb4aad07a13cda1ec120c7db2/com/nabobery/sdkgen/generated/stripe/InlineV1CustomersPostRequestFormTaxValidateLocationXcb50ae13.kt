...
public sealed class InlineV1CustomersPostRequestFormTaxValidateLocationXcb50ae13 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1CustomersPostRequestFormTaxValidateLocationXcb50ae13 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1CustomersPostRequestFormTaxValidateLocationXcb50ae13> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1CustomersPostRequestFormTaxValidateLocationXcb50ae13",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1CustomersPostRequestFormTaxValidateLocationXcb50ae13 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersPostRequestFormTaxValidateLocationXcb50ae13,
        ) {
