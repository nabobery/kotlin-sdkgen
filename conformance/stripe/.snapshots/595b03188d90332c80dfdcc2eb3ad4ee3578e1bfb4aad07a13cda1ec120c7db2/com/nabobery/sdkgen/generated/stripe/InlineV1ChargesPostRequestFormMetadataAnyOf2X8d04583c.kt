...
public sealed class InlineV1ChargesPostRequestFormMetadataAnyOf2X8d04583c {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1ChargesPostRequestFormMetadataAnyOf2X8d04583c =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1ChargesPostRequestFormMetadataAnyOf2X8d04583c> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1ChargesPostRequestFormMetadataAnyOf2X8d04583c",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1ChargesPostRequestFormMetadataAnyOf2X8d04583c =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ChargesPostRequestFormMetadataAnyOf2X8d04583c,
        ) {
