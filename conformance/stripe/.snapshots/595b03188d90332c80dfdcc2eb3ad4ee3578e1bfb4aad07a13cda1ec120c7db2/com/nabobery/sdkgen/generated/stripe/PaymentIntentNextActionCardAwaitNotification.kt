...
public class PaymentIntentNextActionCardAwaitNotification(
    ...
    public class Builder {
        ...
        public fun build(): PaymentIntentNextActionCardAwaitNotification =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentIntentNextActionCardAwaitNotification =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentIntentNextActionCardAwaitNotification> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "PaymentIntentNextActionCardAwaitNotification must be a JSON object",
                    )
            return PaymentIntentNextActionCardAwaitNotification(
                chargeAttemptAt =
                    rawObject["charge_attempt_at"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                customerApprovalRequired =
                    rawObject["customer_approval_required"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentIntentNextActionCardAwaitNotification,
        ) {
            ...
            val raw =
                buildJsonObject {
                    ...
                    value.customerApprovalRequired?.let {
                        put(
...
public fun paymentIntentNextActionCardAwaitNotification(
    block: PaymentIntentNextActionCardAwaitNotification.Builder.() -> Unit,
): PaymentIntentNextActionCardAwaitNotification = PaymentIntentNextActionCardAwaitNotification.build(block)
