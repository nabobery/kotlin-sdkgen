...
public sealed class InlineTreasuryCreditReversalNetworkX36ea954e {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineTreasuryCreditReversalNetworkX36ea954e =
            when (value) {
                Ach.value -> Ach
                Stripe.value -> Stripe
    ...
    public object Serializer : KSerializer<InlineTreasuryCreditReversalNetworkX36ea954e> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineTreasuryCreditReversalNetworkX36ea954e",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineTreasuryCreditReversalNetworkX36ea954e =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineTreasuryCreditReversalNetworkX36ea954e,
        ) {
