...
public class InlineIssuingTransactionCardholderX282f1566 internal constructor(
        ...
        get() =
            buildSet {
                ...
                if (inspection.matchesIssuingCardholder) {
                    add(
                        InlineIssuingTransactionCardholderX282f1566Branch.IssuingCardholder,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineIssuingTransactionCardholderX282f1566 {
            val inspection = inspectInlineIssuingTransactionCardholderX282f1566(raw)
            if (inspection.matchCount == 0) {
                throw InlineIssuingTransactionCardholderX282f1566NoMatchException(
                    "InlineIssuingTransactionCardholderX282f1566 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineIssuingTransactionCardholderX282f1566> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineIssuingTransactionCardholderX282f1566,
        ) {
...
private fun inspectInlineIssuingTransactionCardholderX282f1566(
    element: JsonElement,
): InlineIssuingTransactionCardholderX282f1566Inspection {
