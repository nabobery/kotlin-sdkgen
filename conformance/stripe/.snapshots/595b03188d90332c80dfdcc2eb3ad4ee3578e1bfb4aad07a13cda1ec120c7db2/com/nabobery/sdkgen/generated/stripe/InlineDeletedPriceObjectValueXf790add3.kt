...
public sealed class InlineDeletedPriceObjectValueXf790add3 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineDeletedPriceObjectValueXf790add3 =
            when (value) {
                Price.value -> Price
    ...
    public object Serializer : KSerializer<InlineDeletedPriceObjectValueXf790add3> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineDeletedPriceObjectValueXf790add3",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineDeletedPriceObjectValueXf790add3 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineDeletedPriceObjectValueXf790add3,
        ) {
