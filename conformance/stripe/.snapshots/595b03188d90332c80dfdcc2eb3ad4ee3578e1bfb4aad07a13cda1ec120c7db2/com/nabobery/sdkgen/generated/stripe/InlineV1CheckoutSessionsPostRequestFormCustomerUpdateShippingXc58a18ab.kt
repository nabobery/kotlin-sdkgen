...
public sealed class InlineV1CheckoutSessionsPostRequestFormCustomerUpdateShippingXc58a18ab {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1CheckoutSessionsPostRequestFormCustomerUpdateShippingXc58a18ab =
            when (value) {
                Auto.value -> Auto
                Never.value -> Never
    ...
    public object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormCustomerUpdateShippingXc58a18ab> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1CheckoutSessionsPostRequestFormCustomerUpdateShippingXc58a18ab",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1CheckoutSessionsPostRequestFormCustomerUpdateShippingXc58a18ab = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsPostRequestFormCustomerUpdateShippingXc58a18ab,
        ) {
