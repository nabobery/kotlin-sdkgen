...
internal data class InlineV1PaymentMethodConfigurationsGetParameterXf4c00b1aInspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1PaymentMethodConfigurationsGetParameterAnyOf2Xef4fa125,
            ).count { it }
}
...
public class InlineV1PaymentMethodConfigurationsGetParameterXf4c00b1a internal constructor(
    ...
    public val inlineV1PaymentMethodConfigurationsGetParameterAnyOf2Xef4fa125:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1PaymentMethodConfigurationsGetParameterAnyOf2Xef4fa125) {
                json
                    .decodeFromJsonElement<InlineV1PaymentMethodConfigurationsGetParameterAnyOf2Xef4fa125>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1PaymentMethodConfigurationsGetParameterXf4c00b1aBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1PaymentMethodConfigurationsGetParameterAnyOf2Xef4fa125) {
                    add(
                        InlineV1PaymentMethodConfigurationsGetParameterXf4c00b1aBranch.InlineV1PaymentMethodConfigurationsGetParameterAnyOf2Xef4fa125,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1PaymentMethodConfigurationsGetParameterXf4c00b1a {
            val inspection = inspectInlineV1PaymentMethodConfigurationsGetParameterXf4c00b1a(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1PaymentMethodConfigurationsGetParameterXf4c00b1aNoMatchException(
                    "InlineV1PaymentMethodConfigurationsGetParameterXf4c00b1a matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1PaymentMethodConfigurationsGetParameterXf4c00b1a> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentMethodConfigurationsGetParameterXf4c00b1a,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1PaymentMethodConfigurationsGetParameterXf4c00b1a",
...
private fun inspectInlineV1PaymentMethodConfigurationsGetParameterXf4c00b1a(
    element: JsonElement,
): InlineV1PaymentMethodConfigurationsGetParameterXf4c00b1aInspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1PaymentMethodConfigurationsGetParameterAnyOf2Xef4fa125 =
        element
            .isJsonDecodable<InlineV1PaymentMethodConfigurationsGetParameterAnyOf2Xef4fa125>()
    return InlineV1PaymentMethodConfigurationsGetParameterXf4c00b1aInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1PaymentMethodConfigurationsGetParameterAnyOf2Xef4fa125) {
                    add(
                        "InlineV1PaymentMethodConfigurationsGetParameterAnyOf2Xef4fa125: value does not match InlineV1PaymentMethodConfigurationsGetParameterAnyOf2Xef4fa125",
                    )
                }
            },
    )
