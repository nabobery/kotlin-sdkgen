...
internal data class InlineV1AccountsPostRequestFormBusinessProfileSupportUrlX08b5f7bdInspection(
    ...
    public val matchesInlineV1AccountsPostRequestFormBusinessProfileSupportUrlAnyOf2X31aa990a: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1AccountsPostRequestFormBusinessProfileSupportUrlAnyOf2X31aa990a,
            ).count {
                it
            }
}
...
public class InlineV1AccountsPostRequestFormBusinessProfileSupportUrlX08b5f7bd internal constructor(
    ...
    private val inspection: InlineV1AccountsPostRequestFormBusinessProfileSupportUrlX08b5f7bdInspection,
) {
    ...
    public val inlineV1AccountsPostRequestFormBusinessProfileSupportUrlAnyOf2X31aa990a:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1AccountsPostRequestFormBusinessProfileSupportUrlAnyOf2X31aa990a) {
                json
                    .decodeFromJsonElement<InlineV1AccountsPostRequestFormBusinessProfileSupportUrlAnyOf2X31aa990a>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1AccountsPostRequestFormBusinessProfileSupportUrlX08b5f7bdBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1AccountsPostRequestFormBusinessProfileSupportUrlAnyOf2X31aa990a) {
                    add(
                        InlineV1AccountsPostRequestFormBusinessProfileSupportUrlX08b5f7bdBranch.InlineV1AccountsPostRequestFormBusinessProfileSupportUrlAnyOf2X31aa990a,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1AccountsPostRequestFormBusinessProfileSupportUrlX08b5f7bd {
            val inspection = inspectInlineV1AccountsPostRequestFormBusinessProfileSupportUrlX08b5f7bd(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1AccountsPostRequestFormBusinessProfileSupportUrlX08b5f7bdNoMatchException(
                    "InlineV1AccountsPostRequestFormBusinessProfileSupportUrlX08b5f7bd matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1AccountsPostRequestFormBusinessProfileSupportUrlX08b5f7bd> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPostRequestFormBusinessProfileSupportUrlX08b5f7bd,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1AccountsPostRequestFormBusinessProfileSupportUrlX08b5f7bd",
...
private fun inspectInlineV1AccountsPostRequestFormBusinessProfileSupportUrlX08b5f7bd(
    element: JsonElement,
): InlineV1AccountsPostRequestFormBusinessProfileSupportUrlX08b5f7bdInspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1AccountsPostRequestFormBusinessProfileSupportUrlAnyOf2X31aa990a =
        element
            .isJsonDecodable<InlineV1AccountsPostRequestFormBusinessProfileSupportUrlAnyOf2X31aa990a>()
    return InlineV1AccountsPostRequestFormBusinessProfileSupportUrlX08b5f7bdInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1AccountsPostRequestFormBusinessProfileSupportUrlAnyOf2X31aa990a) {
                    add(
                        "InlineV1AccountsPostRequestFormBusinessProfileSupportUrlAnyOf2X31aa990a: value does not match InlineV1AccountsPostRequestFormBusinessProfileSupportUrlAnyOf2X31aa990a",
                    )
                }
            },
    )
