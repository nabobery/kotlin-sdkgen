...
public sealed class InlineAccountUnificationAccountControllerLossesPaymentsX6a854391 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineAccountUnificationAccountControllerLossesPaymentsX6a854391 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineAccountUnificationAccountControllerLossesPaymentsX6a854391> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineAccountUnificationAccountControllerLossesPaymentsX6a854391",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineAccountUnificationAccountControllerLossesPaymentsX6a854391 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineAccountUnificationAccountControllerLossesPaymentsX6a854391,
        ) {
