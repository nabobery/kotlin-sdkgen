...
internal data class InlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextFooterTitleXd3e389e8Inspection(
    ...
    public val matchesInlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextAnyOf2X9e6b0ed8: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextAnyOf2X9e6b0ed8,
            ).count {
                it
            }
}
...
public class InlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextFooterTitleXd3e389e8 internal constructor(
    ...
    private val inspection: InlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextFooterTitleXd3e389e8Inspection,
) {
    ...
    public val inlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextAnyOf2X9e6b0ed8:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextAnyOf2X9e6b0ed8) {
                json
                    .decodeFromJsonElement<InlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextAnyOf2X9e6b0ed8>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextFooterTitleXd3e389e8Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextAnyOf2X9e6b0ed8) {
                    add(
                        InlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextFooterTitleXd3e389e8Branch.InlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextAnyOf2X9e6b0ed8,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextFooterTitleXd3e389e8 {
            val inspection = inspectInlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextFooterTitleXd3e389e8(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextFooterTitleXd3e389e8NoMatchException(
                    "InlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextFooterTitleXd3e389e8 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextFooterTitleXd3e389e8> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextFooterTitleXd3e389e8,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextFooterTitleXd3e389e8",
...
private fun inspectInlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextFooterTitleXd3e389e8(
    element: JsonElement,
): InlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextFooterTitleXd3e389e8Inspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextAnyOf2X9e6b0ed8 =
        element
            .isJsonDecodable<InlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextAnyOf2X9e6b0ed8>()
    return InlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextFooterTitleXd3e389e8Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextAnyOf2X9e6b0ed8) {
                    add(
                        "InlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextAnyOf2X9e6b0ed8: value does not match InlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextAnyOf2X9e6b0ed8",
                    )
                }
            },
    )
