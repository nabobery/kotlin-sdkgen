...
public class InlineV1TaxRegistrationsPostRequestFormCountryOptionsSiXcaafcd68(
    ...
    public val standard: InlineV1TaxRegistrationsPostRequestFormCountryOptionsSiStandardXdcfeed47? = null,
) {
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TaxRegistrationsPostRequestFormCountryOptionsSiXcaafcd68 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TaxRegistrationsPostRequestFormCountryOptionsSiXcaafcd68> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TaxRegistrationsPostRequestFormCountryOptionsSiXcaafcd68 must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineV1TaxRegistrationsPostRequestFormCountryOptionsSiTypeXaf5d0c47>(
                    rawObject,
                    "type",
                )
            return InlineV1TaxRegistrationsPostRequestFormCountryOptionsSiXcaafcd68(
                ...
                standard =
                    rawObject["standard"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsSiStandardXdcfeed47>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TaxRegistrationsPostRequestFormCountryOptionsSiXcaafcd68,
        ) {
            val jsonEncoder =
...
public fun inlineV1TaxRegistrationsPostRequestFormCountryOptionsSiXcaafcd68(
    block: InlineV1TaxRegistrationsPostRequestFormCountryOptionsSiXcaafcd68.Builder.() -> Unit,
): InlineV1TaxRegistrationsPostRequestFormCountryOptionsSiXcaafcd68 =
    InlineV1TaxRegistrationsPostRequestFormCountryOptionsSiXcaafcd68.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TaxRegistrationsPostRequestFormCountryOptionsSiXcaafcd68 is missing required property '" + name +
                    "'",
            )
