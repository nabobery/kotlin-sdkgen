...
public data class TerminalConfigurationView(
    ...
    public val bbposWisepad3: TerminalConfigurationConfigurationResourceDeviceTypeSpecificConfig? = null,
    @SerialName("bbpos_wisepos_e")
    public val bbposWiseposE: TerminalConfigurationConfigurationResourceDeviceTypeSpecificConfig? = null,
    ...
    public val verifoneM425: TerminalConfigurationConfigurationResourceDeviceTypeSpecificConfig? = null,
    @SerialName("verifone_p400")
    public val verifoneP400: TerminalConfigurationConfigurationResourceDeviceTypeSpecificConfig? = null,
    @SerialName("verifone_p630")
    public val verifoneP630: TerminalConfigurationConfigurationResourceDeviceTypeSpecificConfig? = null,
    @SerialName("verifone_ux700")
    public val verifoneUx700: TerminalConfigurationConfigurationResourceDeviceTypeSpecificConfig? = null,
    @SerialName("verifone_v660p")
    public val verifoneV660p: TerminalConfigurationConfigurationResourceDeviceTypeSpecificConfig? = null,
        ...
        override fun deserialize(decoder: Decoder): TerminalConfiguration {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("TerminalConfiguration must be a JSON object")
            ...
            return TerminalConfiguration(
                ...
                bbposWisepad3 =
                    rawObject["bbpos_wisepad3"]?.let {
                        json.decodeFromJsonElement<TerminalConfigurationConfigurationResourceDeviceTypeSpecificConfig>(
                            it,
                        )
                    },
                bbposWiseposE =
                ...
                cellular =
                    rawObject["cellular"]?.let {
                        json.decodeFromJsonElement<TerminalConfigurationConfigurationResourceCellularConfig>(it)
                    },
                isAccountDefault =
                    rawObject["is_account_default"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                offline =
                    rawObject["offline"]?.let {
                        json.decodeFromJsonElement<TerminalConfigurationConfigurationResourceOfflineConfig>(it)
                    },
                rebootWindow =
                    rawObject["reboot_window"]?.let {
                        json.decodeFromJsonElement<TerminalConfigurationConfigurationResourceRebootWindow>(it)
                    },
                stripeS700 =
                ...
                tipping =
                    rawObject["tipping"]?.let {
                        json.decodeFromJsonElement<TerminalConfigurationConfigurationResourceTipping>(it)
                    },
                verifoneM425 =
                ...
                wifi =
                    rawObject["wifi"]?.let {
                        json
                            .decodeFromJsonElement<TerminalConfigurationConfigurationResourceWifiConfig>(
                                it,
                            )
                    },
            )
...
public fun terminalConfiguration(block: TerminalConfiguration.Builder.() -> Unit): TerminalConfiguration =
    TerminalConfiguration.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("TerminalConfiguration is missing required property '" + name + "'")
