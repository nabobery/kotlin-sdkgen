...
public sealed class InlineTreasuryOutboundTranad51TypeX21128110 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineTreasuryOutboundTranad51TypeX21128110 =
            when (value) {
                Ach.value -> Ach
    ...
    public object Serializer : KSerializer<InlineTreasuryOutboundTranad51TypeX21128110> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineTreasuryOutboundTranad51TypeX21128110",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineTreasuryOutboundTranad51TypeX21128110 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineTreasuryOutboundTranad51TypeX21128110,
        ) {
