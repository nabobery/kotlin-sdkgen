...
public class ConnectEmbeddedIssuingCardsListConfigClaim(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): ConnectEmbeddedIssuingCardsListConfigClaim =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<ConnectEmbeddedIssuingCardsListConfigClaim> {
        ...
        override fun deserialize(decoder: Decoder): ConnectEmbeddedIssuingCardsListConfigClaim {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("ConnectEmbeddedIssuingCardsListConfigClaim must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: ConnectEmbeddedIssuingCardsListConfigClaim,
        ) {
...
public fun connectEmbeddedIssuingCardsListConfigClaim(
    block: ConnectEmbeddedIssuingCardsListConfigClaim.Builder.() -> Unit,
): ConnectEmbeddedIssuingCardsListConfigClaim = ConnectEmbeddedIssuingCardsListConfigClaim.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "ConnectEmbeddedIssuingCardsListConfigClaim is missing required property '" + name + "'",
            )
