...
public class InlineV1BillingCreditGrantsPostRequestFormApplicabilityConfigX8078051e(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1BillingCreditGrantsPostRequestFormApplicabilityConfigX8078051e = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1BillingCreditGrantsPostRequestFormApplicabilityConfigX8078051e> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1BillingCreditGrantsPostRequestFormApplicabilityConfigX8078051e must be a JSON object",
                    )
            val scope =
                json.decodeRequired<InlineV1BillingCreditGrantsPostRequestFormApplicabilityConfigScopeXdcc927f3>(
                    rawObject,
                    "scope",
                )
            return InlineV1BillingCreditGrantsPostRequestFormApplicabilityConfigX8078051e(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1BillingCreditGrantsPostRequestFormApplicabilityConfigX8078051e,
        ) {
            val jsonEncoder =
...
public fun inlineV1BillingCreditGrantsPostRequestFormApplicabilityConfigX8078051e(
    block: InlineV1BillingCreditGrantsPostRequestFormApplicabilityConfigX8078051e.Builder.() -> Unit,
): InlineV1BillingCreditGrantsPostRequestFormApplicabilityConfigX8078051e =
    InlineV1BillingCreditGrantsPostRequestFormApplicabilityConfigX8078051e.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1BillingCreditGrantsPostRequestFormApplicabilityConfigX8078051e is missing required property '" +
                    name +
                    "'",
            )
