...
public class InlineInvoiceDefaultSourceXee93951e internal constructor(
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineInvoiceDefaultSourceXee93951e {
            val inspection = inspectInlineInvoiceDefaultSourceXee93951e(raw)
            if (inspection.matchCount == 0) {
                throw InlineInvoiceDefaultSourceXee93951eNoMatchException(
                    "InlineInvoiceDefaultSourceXee93951e matched 0 branches: " + inspection.failures.joinToString("; "),
                )
            }
    ...
    public object Serializer : KSerializer<InlineInvoiceDefaultSourceXee93951e> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineInvoiceDefaultSourceXee93951e,
        ) {
...
private fun inspectInlineInvoiceDefaultSourceXee93951e(
    element: JsonElement,
): InlineInvoiceDefaultSourceXee93951eInspection {
