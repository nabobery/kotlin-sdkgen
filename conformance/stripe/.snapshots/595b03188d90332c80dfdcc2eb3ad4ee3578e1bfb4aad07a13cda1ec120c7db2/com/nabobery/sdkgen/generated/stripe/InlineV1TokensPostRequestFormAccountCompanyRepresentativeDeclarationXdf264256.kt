...
public class InlineV1TokensPostRequestFormAccountCompanyRepresentativeDeclarationXdf264256(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1TokensPostRequestFormAccountCompanyRepresentativeDeclarationXdf264256 =
            InlineV1TokensPostRequestFormAccountCompanyRepresentativeDeclarationXdf264256(
                date = date,
                ip = ip,
                userAgent = userAgent,
            )
    ...
    public object Serializer : KSerializer<InlineV1TokensPostRequestFormAccountCompanyRepresentativeDeclarationXdf264256> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TokensPostRequestFormAccountCompanyRepresentativeDeclarationXdf264256 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TokensPostRequestFormAccountCompanyRepresentativeDeclarationXdf264256,
        ) {
            val jsonEncoder =
...
public fun inlineV1TokensPostRequestFormAccountCompanyRepresentativeDeclarationXdf264256(
    block: InlineV1TokensPostRequestFormAccountCompanyRepresentativeDeclarationXdf264256.Builder.() -> Unit,
): InlineV1TokensPostRequestFormAccountCompanyRepresentativeDeclarationXdf264256 =
    InlineV1TokensPostRequestFormAccountCompanyRepresentativeDeclarationXdf264256.build(block)
