...
public class InlineRefundBalanceTransactionX2601d96f internal constructor(
        ...
        get() =
            buildSet {
                ...
                if (inspection.matchesBalanceTransaction) {
                    add(
                        InlineRefundBalanceTransactionX2601d96fBranch.BalanceTransaction,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineRefundBalanceTransactionX2601d96f {
            val inspection = inspectInlineRefundBalanceTransactionX2601d96f(raw)
            if (inspection.matchCount == 0) {
                throw InlineRefundBalanceTransactionX2601d96fNoMatchException(
                    "InlineRefundBalanceTransactionX2601d96f matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineRefundBalanceTransactionX2601d96f> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineRefundBalanceTransactionX2601d96f,
        ) {
...
private fun inspectInlineRefundBalanceTransactionX2601d96f(
    element: JsonElement,
): InlineRefundBalanceTransactionX2601d96fInspection {
