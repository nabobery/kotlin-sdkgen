...
public class InlineV1PaymentLinksPostRequestFormXa7410106(
     ...
     */
    public val billingAddressCollection: InlineV1PaymentLinksPostRequestFormBillingAddressCollectionX582cdf31? = null,
    /**
     * Configure fields to gather active consent from customers.
     */
    public val consentCollection: InlineV1PaymentLinksPostRequestFormConsentCollectionXcd7e867e? = null,
    /**
     ...
     */
    public val customFields: List<InlineV1PaymentLinksPostRequestFormCustomFieldsItemX30e6a174>? = null,
    /**
     ...
     */
    public val optionalItems: List<InlineV1PaymentLinksPostRequestFormOptionalItemsItemXda6a0f48>? = null,
    /**
     * A subset of parameters to be passed to PaymentIntent creation for Checkout Sessions in `payment` mode.
     */
    public val paymentIntentData: InlineV1PaymentLinksPostRequestFormPaymentIntentDataXfc20e1b7? = null,
    /**
     ...
     */
    public val paymentMethodCollection: InlineV1PaymentLinksPostRequestFormPaymentMethodCollectionXecd22be6? = null,
    /**
     * Payment-method-specific configuration.
     */
    public val paymentMethodOptions: InlineV1PaymentLinksPostRequestFormPaymentMethodOptionsX46c17a30? = null,
    /**
     ...
     */
    public val paymentMethodTypes: List<InlineV1PaymentLinksPostRequestFormPaymentMethodTypesItemX9cf40edc>? = null,
    /**
     * Controls phone number collection settings during checkout.
     *
     * We recommend that you review your privacy policy and check with your legal contacts.
     */
    public val phoneNumberCollection: InlineV1PaymentLinksPostRequestFormPhoneNumberCollectionXc1a634b3? = null,
    /**
     ...
     */
    public val shippingAddressCollection: InlineV1PaymentLinksPostRequestFormShippingAddressCollectionX247f9cc2? = null,
    /**
     * The shipping rate options to apply to [checkout sessions](https://docs.stripe.com/api/checkout/sessions) created by
     * this payment link.
     */
    public val shippingOptions: List<InlineV1PaymentLinksPostRequestFormShippingOptionsItemX093d17e6>? = null,
    /**
    ...
    public class Builder {
        ...
        public var lineItems: List<InlineV1PaymentLinksPostRequestFormLineItemsItemX40b508bb>
            get() = requireNotNull(lineItemsValue) { "lineItems is required" }
            set(`value`) {
                lineItemsValue = value
            }
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PaymentLinksPostRequestFormXa7410106 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentLinksPostRequestFormXa7410106> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentLinksPostRequestFormXa7410106 must be a JSON object",
                    )
            val lineItems =
                json.decodeRequired<List<InlineV1PaymentLinksPostRequestFormLineItemsItemX40b508bb>>(
                    rawObject,
                    "line_items",
                )
            return InlineV1PaymentLinksPostRequestFormXa7410106(
                lineItems = lineItems,
                afterCompletion =
                    rawObject["after_completion"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormAfterCompletionX204f7da4>(it)
                    },
                allowPromotionCodes =
                ...
                applicationFeeAmount = rawObject["application_fee_amount"]?.let {
                ...
                automaticTax =
                    rawObject["automatic_tax"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormAutomaticTaxXb1487bd2>(it)
                    },
                billingAddressCollection =
                    rawObject["billing_address_collection"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormBillingAddressCollectionX582cdf31>(
                                it,
                            )
                    },
                consentCollection =
                    rawObject["consent_collection"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormConsentCollectionXcd7e867e>(it)
                    },
                currency = rawObject["currency"]?.let { json.decodeFromJsonElement<String>(it) },
                customFields =
                    rawObject["custom_fields"]?.let {
                        json.decodeFromJsonElement<List<InlineV1PaymentLinksPostRequestFormCustomFieldsItemX30e6a174>>(
                            it,
                        )
                    },
                customText =
                    rawObject["custom_text"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormCustomTextXfb010c93>(it)
                    },
                customerCreation =
                    rawObject["customer_creation"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormCustomerCreationX9b9731af>(it)
                    },
                ...
                invoiceCreation =
                    rawObject["invoice_creation"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormInvoiceCreationX7108721b>(it)
                    },
                managedPayments =
                    rawObject["managed_payments"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormManagedPaymentsXb1167755>(it)
                    },
                metadata = rawObject["metadata"]?.let { json.decodeFromJsonElement<Map<String, String>>(it) },
                nameCollection =
                    rawObject["name_collection"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormNameCollectionXbc988fe5>(it)
                    },
                onBehalfOf = rawObject["on_behalf_of"]?.let { json.decodeFromJsonElement<String>(it) },
                optionalItems =
                    rawObject["optional_items"]?.let {
                        json.decodeFromJsonElement<List<InlineV1PaymentLinksPostRequestFormOptionalItemsItemXda6a0f48>>(
                            it,
                        )
                    },
                paymentIntentData =
                    rawObject["payment_intent_data"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormPaymentIntentDataXfc20e1b7>(it)
                    },
                paymentMethodCollection =
                    rawObject["payment_method_collection"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormPaymentMethodCollectionXecd22be6>(
                            it,
                        )
                    },
                paymentMethodOptions =
                    rawObject["payment_method_options"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormPaymentMethodOptionsX46c17a30>(it)
                    },
                paymentMethodTypes =
                    rawObject["payment_method_types"]?.let {
                        json
                            .decodeFromJsonElement<List<InlineV1PaymentLinksPostRequestFormPaymentMethodTypesItemX9cf40edc>>(
                                it,
                            )
                    },
                phoneNumberCollection =
                    rawObject["phone_number_collection"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormPhoneNumberCollectionXc1a634b3>(
                            it,
                        )
                    },
                restrictions =
                    rawObject["restrictions"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormRestrictionsX5f21586b>(it)
                    },
                shippingAddressCollection =
                    rawObject["shipping_address_collection"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormShippingAddressCollectionX247f9cc2>(
                                it,
                            )
                    },
                shippingOptions =
                    rawObject["shipping_options"]?.let {
                        json
                            .decodeFromJsonElement<List<InlineV1PaymentLinksPostRequestFormShippingOptionsItemX093d17e6>>(
                                it,
                            )
                    },
                submitType =
                    rawObject["submit_type"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormSubmitTypeXdb2280b9>(it)
                    },
                subscriptionData =
                    rawObject["subscription_data"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormSubscriptionDataX3e396383>(it)
                    },
                taxIdCollection =
                    rawObject["tax_id_collection"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormTaxIdCollectionXf2411c91>(it)
                    },
                transferData =
                    rawObject["transfer_data"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormTransferDataXa5942deb>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentLinksPostRequestFormXa7410106,
        ) {
...
public fun inlineV1PaymentLinksPostRequestFormXa7410106(
    block: InlineV1PaymentLinksPostRequestFormXa7410106.Builder.() -> Unit,
): InlineV1PaymentLinksPostRequestFormXa7410106 = InlineV1PaymentLinksPostRequestFormXa7410106.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentLinksPostRequestFormXa7410106 is missing required property '" + name + "'",
            )
