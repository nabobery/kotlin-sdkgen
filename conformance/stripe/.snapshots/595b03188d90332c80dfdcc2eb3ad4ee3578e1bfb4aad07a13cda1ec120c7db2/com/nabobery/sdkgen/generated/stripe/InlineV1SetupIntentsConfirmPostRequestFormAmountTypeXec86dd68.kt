...
public sealed class InlineV1SetupIntentsConfirmPostRequestFormAmountTypeXec86dd68 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1SetupIntentsConfirmPostRequestFormAmountTypeXec86dd68 =
            when (value) {
                Fixed.value -> Fixed
    ...
    public object Serializer : KSerializer<InlineV1SetupIntentsConfirmPostRequestFormAmountTypeXec86dd68> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1SetupIntentsConfirmPostRequestFormAmountTypeXec86dd68",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1SetupIntentsConfirmPostRequestFormAmountTypeXec86dd68 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SetupIntentsConfirmPostRequestFormAmountTypeXec86dd68,
        ) {
