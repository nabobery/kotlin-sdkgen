...
public class InlineV1PaymentMethodsPostRequestFormKlarnaX73a2ab15(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1PaymentMethodsPostRequestFormKlarnaX73a2ab15 =
            InlineV1PaymentMethodsPostRequestFormKlarnaX73a2ab15(
                dob = dob,
            )
    }

    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PaymentMethodsPostRequestFormKlarnaX73a2ab15 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentMethodsPostRequestFormKlarnaX73a2ab15> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentMethodsPostRequestFormKlarnaX73a2ab15 must be a JSON object",
                    )
            return InlineV1PaymentMethodsPostRequestFormKlarnaX73a2ab15(
                dob =
                    rawObject["dob"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentMethodsPostRequestFormKlarnaDobX27f1cd8d>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentMethodsPostRequestFormKlarnaX73a2ab15,
        ) {
...
public fun inlineV1PaymentMethodsPostRequestFormKlarnaX73a2ab15(
    block: InlineV1PaymentMethodsPostRequestFormKlarnaX73a2ab15.Builder.() -> Unit,
): InlineV1PaymentMethodsPostRequestFormKlarnaX73a2ab15 =
    InlineV1PaymentMethodsPostRequestFormKlarnaX73a2ab15.build(block)
