...
public class InlineV1TerminalReadersCollectPaymentMethodPostRequestFormCollectConfigXadf48dd2(
    public val allowRedisplay: InlineV1TerminalReadersCol3061PostRequestFormAllowRedisplayX097cdad4? = null,
    public val enableCustomerCancellation: Boolean? = null,
    public val skipTipping: Boolean? = null,
    public val tipping: InlineV1TerminalReadersCol3061PostRequestFormCollectConfigTippingXf21b9e80? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1TerminalReadersCollectPaymentMethodPostRequestFormCollectConfigXadf48dd2 =
    ...
    public object Serializer : KSerializer<InlineV1TerminalReadersCollectPaymentMethodPostRequestFormCollectConfigXadf48dd2> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TerminalReadersCollectPaymentMethodPostRequestFormCollectConfigXadf48dd2 must be a JSON object",
                    )
            return InlineV1TerminalReadersCollectPaymentMethodPostRequestFormCollectConfigXadf48dd2(
                allowRedisplay =
                    rawObject["allow_redisplay"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TerminalReadersCol3061PostRequestFormAllowRedisplayX097cdad4>(
                                it,
                            )
                    },
                ...
                tipping =
                    rawObject["tipping"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TerminalReadersCol3061PostRequestFormCollectConfigTippingXf21b9e80>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TerminalReadersCollectPaymentMethodPostRequestFormCollectConfigXadf48dd2,
        ) {
            val jsonEncoder =
...
public fun inlineV1TerminalReadersCollectPaymentMethodPostRequestFormCollectConfigXadf48dd2(
    block: InlineV1TerminalReadersCollectPaymentMethodPostRequestFormCollectConfigXadf48dd2.Builder.() -> Unit,
): InlineV1TerminalReadersCollectPaymentMethodPostRequestFormCollectConfigXadf48dd2 =
    InlineV1TerminalReadersCollectPaymentMethodPostRequestFormCollectConfigXadf48dd2.build(block)
