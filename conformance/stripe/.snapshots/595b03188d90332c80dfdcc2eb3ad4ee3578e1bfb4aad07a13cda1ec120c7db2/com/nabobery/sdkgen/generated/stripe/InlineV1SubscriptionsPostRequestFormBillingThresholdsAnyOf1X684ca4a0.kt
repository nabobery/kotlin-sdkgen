...
public class InlineV1SubscriptionsPostRequestFormBillingThresholdsAnyOf1X684ca4a0(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1SubscriptionsPostRequestFormBillingThresholdsAnyOf1X684ca4a0 =
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1SubscriptionsPostRequestFormBillingThresholdsAnyOf1X684ca4a0 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1SubscriptionsPostRequestFormBillingThresholdsAnyOf1X684ca4a0> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SubscriptionsPostRequestFormBillingThresholdsAnyOf1X684ca4a0 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsPostRequestFormBillingThresholdsAnyOf1X684ca4a0,
        ) {
            val jsonEncoder =
...
public fun inlineV1SubscriptionsPostRequestFormBillingThresholdsAnyOf1X684ca4a0(
    block: InlineV1SubscriptionsPostRequestFormBillingThresholdsAnyOf1X684ca4a0.Builder.() -> Unit,
): InlineV1SubscriptionsPostRequestFormBillingThresholdsAnyOf1X684ca4a0 =
