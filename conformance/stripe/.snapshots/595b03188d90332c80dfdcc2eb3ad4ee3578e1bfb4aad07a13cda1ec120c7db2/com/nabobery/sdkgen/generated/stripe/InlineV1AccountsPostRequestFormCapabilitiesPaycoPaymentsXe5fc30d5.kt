...
public class InlineV1AccountsPostRequestFormCapabilitiesPaycoPaymentsXe5fc30d5(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1AccountsPostRequestFormCapabilitiesPaycoPaymentsXe5fc30d5 =
            InlineV1AccountsPostRequestFormCapabilitiesPaycoPaymentsXe5fc30d5(
                requested = requested,
            )
    }

    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1AccountsPostRequestFormCapabilitiesPaycoPaymentsXe5fc30d5 =
    ...
    public object Serializer : KSerializer<InlineV1AccountsPostRequestFormCapabilitiesPaycoPaymentsXe5fc30d5> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountsPostRequestFormCapabilitiesPaycoPaymentsXe5fc30d5 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPostRequestFormCapabilitiesPaycoPaymentsXe5fc30d5,
        ) {
            val jsonEncoder =
...
public fun inlineV1AccountsPostRequestFormCapabilitiesPaycoPaymentsXe5fc30d5(
    block: InlineV1AccountsPostRequestFormCapabilitiesPaycoPaymentsXe5fc30d5.Builder.() -> Unit,
): InlineV1AccountsPostRequestFormCapabilitiesPaycoPaymentsXe5fc30d5 =
    InlineV1AccountsPostRequestFormCapabilitiesPaycoPaymentsXe5fc30d5.build(block)
