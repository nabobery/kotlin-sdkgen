...
public class InlineV1PaymentMethodConfigurationsPostRequestFormIdealXe3c934d8(
    public val displayPreference: InlineV1PaymentMethodConfidc49PostRequestFormIdealDisplayPreferenceXfad24265? = null,
) {
    public class Builder {
        public var displayPreference:
            InlineV1PaymentMethodConfidc49PostRequestFormIdealDisplayPreferenceXfad24265? = null

        public fun build(): InlineV1PaymentMethodConfigurationsPostRequestFormIdealXe3c934d8 =
            InlineV1PaymentMethodConfigurationsPostRequestFormIdealXe3c934d8(
                displayPreference = displayPreference,
            )
    }

    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PaymentMethodConfigurationsPostRequestFormIdealXe3c934d8 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentMethodConfigurationsPostRequestFormIdealXe3c934d8> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentMethodConfigurationsPostRequestFormIdealXe3c934d8 must be a JSON object",
                    )
            return InlineV1PaymentMethodConfigurationsPostRequestFormIdealXe3c934d8(
                displayPreference =
                    rawObject["display_preference"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentMethodConfidc49PostRequestFormIdealDisplayPreferenceXfad24265>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentMethodConfigurationsPostRequestFormIdealXe3c934d8,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentMethodConfigurationsPostRequestFormIdealXe3c934d8(
    block: InlineV1PaymentMethodConfigurationsPostRequestFormIdealXe3c934d8.Builder.() -> Unit,
): InlineV1PaymentMethodConfigurationsPostRequestFormIdealXe3c934d8 =
    InlineV1PaymentMethodConfigurationsPostRequestFormIdealXe3c934d8.build(block)
