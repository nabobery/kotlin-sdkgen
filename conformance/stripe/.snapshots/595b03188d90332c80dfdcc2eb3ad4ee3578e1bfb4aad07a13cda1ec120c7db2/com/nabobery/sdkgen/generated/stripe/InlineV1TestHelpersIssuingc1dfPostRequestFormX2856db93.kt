...
public class InlineV1TestHelpersIssuingc1dfPostRequestFormX2856db93(
     ...
     */
    public val merchantData: InlineV1TestHelpersIssuingc1dfPostRequestFormMerchantDataXb587c735? = null,
    /**
     * Additional purchase information that is optionally provided by the merchant.
     */
    public val purchaseDetails: InlineV1TestHelpersIssuingc1dfPostRequestFormPurchaseDetailsX5ebd19dd? = null,
) {
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TestHelpersIssuingc1dfPostRequestFormX2856db93 =
    ...
    public object Serializer : KSerializer<InlineV1TestHelpersIssuingc1dfPostRequestFormX2856db93> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TestHelpersIssuingc1dfPostRequestFormX2856db93 must be a JSON object",
                    )
            ...
            return InlineV1TestHelpersIssuingc1dfPostRequestFormX2856db93(
                ...
                merchantData =
                    rawObject["merchant_data"]?.let {
                        json.decodeFromJsonElement<InlineV1TestHelpersIssuingc1dfPostRequestFormMerchantDataXb587c735>(
                            it,
                        )
                    },
                purchaseDetails =
                    rawObject["purchase_details"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TestHelpersIssuingc1dfPostRequestFormPurchaseDetailsX5ebd19dd>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TestHelpersIssuingc1dfPostRequestFormX2856db93,
        ) {
...
public fun inlineV1TestHelpersIssuingc1dfPostRequestFormX2856db93(
    block: InlineV1TestHelpersIssuingc1dfPostRequestFormX2856db93.Builder.() -> Unit,
): InlineV1TestHelpersIssuingc1dfPostRequestFormX2856db93 =
    InlineV1TestHelpersIssuingc1dfPostRequestFormX2856db93.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TestHelpersIssuingc1dfPostRequestFormX2856db93 is missing required property '" + name + "'",
            )
