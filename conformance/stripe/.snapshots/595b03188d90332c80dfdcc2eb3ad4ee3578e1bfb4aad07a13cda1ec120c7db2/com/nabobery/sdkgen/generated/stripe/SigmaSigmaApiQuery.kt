...
public class SigmaSigmaApiQuery(
    ...
    public object Serializer : KSerializer<SigmaSigmaApiQuery> {
        ...
        override fun deserialize(decoder: Decoder): SigmaSigmaApiQuery {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("SigmaSigmaApiQuery must be a JSON object")
...
public fun sigmaSigmaApiQuery(block: SigmaSigmaApiQuery.Builder.() -> Unit): SigmaSigmaApiQuery =
    SigmaSigmaApiQuery.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("SigmaSigmaApiQuery is missing required property '" + name + "'")
