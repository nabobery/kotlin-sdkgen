...
public sealed class InlineBillingCreditGrantCategoryXda8e84e5 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineBillingCreditGrantCategoryXda8e84e5 =
            when (value) {
                Paid.value -> Paid
    ...
    public object Serializer : KSerializer<InlineBillingCreditGrantCategoryXda8e84e5> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineBillingCreditGrantCategoryXda8e84e5",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineBillingCreditGrantCategoryXda8e84e5 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineBillingCreditGrantCategoryXda8e84e5,
        ) {
