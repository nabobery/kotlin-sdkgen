...
public class InlineV1CustomersSubscriptionsPostRequestFormPauseCollectionAnyOf1X42b75df5(
    public val behavior: InlineV1CustomersSubscriptionsPostRequestFormPauseCollectionBehaviorXdf428e23,
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1CustomersSubscriptionsPostRequestFormPauseCollectionAnyOf1X42b75df5 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1CustomersSubscriptionsPostRequestFormPauseCollectionAnyOf1X42b75df5> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CustomersSubscriptionsPostRequestFormPauseCollectionAnyOf1X42b75df5 must be a JSON object",
                    )
            val behavior =
                json.decodeRequired<InlineV1CustomersSubscriptionsPostRequestFormPauseCollectionBehaviorXdf428e23>(
                    rawObject,
                    "behavior",
                )
            return InlineV1CustomersSubscriptionsPostRequestFormPauseCollectionAnyOf1X42b75df5(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersSubscriptionsPostRequestFormPauseCollectionAnyOf1X42b75df5,
        ) {
            val jsonEncoder =
...
public fun inlineV1CustomersSubscriptionsPostRequestFormPauseCollectionAnyOf1X42b75df5(
    block: InlineV1CustomersSubscriptionsPostRequestFormPauseCollectionAnyOf1X42b75df5.Builder.() -> Unit,
): InlineV1CustomersSubscriptionsPostRequestFormPauseCollectionAnyOf1X42b75df5 =
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1CustomersSubscriptionsPostRequestFormPauseCollectionAnyOf1X42b75df5 is missing required property '" +
                    name +
                    "'",
            )
