...
internal data class InlineV1AccountsPostRequestFormSettingsPayoutsScheduleDelayDaysX5e3d3674Inspection(
    public val matchesInlineV1AccountsPostRequestFormSettingsPayoutsScheduleDelayDaysAnyOf1Xf7a486dc: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesInlineV1AccountsPostRequestFormSettingsPayoutsScheduleDelayDaysAnyOf1Xf7a486dc,
                matchesBranch2,
            ).count {
                it
            }
...
public class InlineV1AccountsPostRequestFormSettingsPayoutsScheduleDelayDaysX5e3d3674 internal constructor(
    ...
    private val inspection: InlineV1AccountsPostRequestFormSettingsPayoutsScheduleDelayDaysX5e3d3674Inspection,
) {
    public val inlineV1AccountsPostRequestFormSettingsPayoutsScheduleDelayDaysAnyOf1Xf7a486dc:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1AccountsPostRequestFormSettingsPayoutsScheduleDelayDaysAnyOf1Xf7a486dc) {
                json
                    .decodeFromJsonElement<InlineV1AccountsPostRequestFormSettingsPayoutsScheduleDelayDaysAnyOf1Xf7a486dc>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches:
        ...
        get() =
            buildSet {
                if (inspection.matchesInlineV1AccountsPostRequestFormSettingsPayoutsScheduleDelayDaysAnyOf1Xf7a486dc) {
                    add(
                        InlineV1AccountsPostRequestFormSettingsPayoutsScheduleDelayDaysX5e3d3674Branch.InlineV1AccountsPostRequestFormSettingsPayoutsScheduleDelayDaysAnyOf1Xf7a486dc,
                    )
                }
                if (inspection.matchesBranch2) {
                    add(
                        InlineV1AccountsPostRequestFormSettingsPayoutsScheduleDelayDaysX5e3d3674Branch.Branch2,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1AccountsPostRequestFormSettingsPayoutsScheduleDelayDaysX5e3d3674 {
            val inspection = inspectInlineV1AccountsPostRequestFormSettingsPayoutsScheduleDelayDaysX5e3d3674(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1AccountsPostRequestFormSettingsPayoutsScheduleDelayDaysX5e3d3674NoMatchException(
                    "InlineV1AccountsPostRequestFormSettingsPayoutsScheduleDelayDaysX5e3d3674 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1AccountsPostRequestFormSettingsPayoutsScheduleDelayDaysX5e3d3674> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPostRequestFormSettingsPayoutsScheduleDelayDaysX5e3d3674,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1AccountsPostRequestFormSettingsPayoutsScheduleDelayDaysX5e3d3674",
...
private fun inspectInlineV1AccountsPostRequestFormSettingsPayoutsScheduleDelayDaysX5e3d3674(
    element: JsonElement,
): InlineV1AccountsPostRequestFormSettingsPayoutsScheduleDelayDaysX5e3d3674Inspection {
    val matchesInlineV1AccountsPostRequestFormSettingsPayoutsScheduleDelayDaysAnyOf1Xf7a486dc =
        element
            .isJsonDecodable<InlineV1AccountsPostRequestFormSettingsPayoutsScheduleDelayDaysAnyOf1Xf7a486dc>()
    ...
    return InlineV1AccountsPostRequestFormSettingsPayoutsScheduleDelayDaysX5e3d3674Inspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1AccountsPostRequestFormSettingsPayoutsScheduleDelayDaysAnyOf1Xf7a486dc) {
                    add(
                        "InlineV1AccountsPostRequestFormSettingsPayoutsScheduleDelayDaysAnyOf1Xf7a486dc: value does not match InlineV1AccountsPostRequestFormSettingsPayoutsScheduleDelayDaysAnyOf1Xf7a486dc",
                    )
                }
