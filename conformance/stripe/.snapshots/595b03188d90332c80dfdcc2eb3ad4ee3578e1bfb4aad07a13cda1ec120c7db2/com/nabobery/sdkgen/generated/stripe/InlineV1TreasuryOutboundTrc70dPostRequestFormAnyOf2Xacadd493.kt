...
public sealed class InlineV1TreasuryOutboundTrc70dPostRequestFormAnyOf2Xacadd493 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1TreasuryOutboundTrc70dPostRequestFormAnyOf2Xacadd493 =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1TreasuryOutboundTrc70dPostRequestFormAnyOf2Xacadd493> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1TreasuryOutboundTrc70dPostRequestFormAnyOf2Xacadd493",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1TreasuryOutboundTrc70dPostRequestFormAnyOf2Xacadd493 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TreasuryOutboundTrc70dPostRequestFormAnyOf2Xacadd493,
        ) {
