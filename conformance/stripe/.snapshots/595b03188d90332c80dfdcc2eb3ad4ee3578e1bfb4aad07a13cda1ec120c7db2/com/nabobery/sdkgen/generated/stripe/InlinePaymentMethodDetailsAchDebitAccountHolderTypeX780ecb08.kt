...
public sealed class InlinePaymentMethodDetailsAchDebitAccountHolderTypeX780ecb08 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentMethodDetailsAchDebitAccountHolderTypeX780ecb08 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlinePaymentMethodDetailsAchDebitAccountHolderTypeX780ecb08> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentMethodDetailsAchDebitAccountHolderTypeX780ecb08",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePaymentMethodDetailsAchDebitAccountHolderTypeX780ecb08 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentMethodDetailsAchDebitAccountHolderTypeX780ecb08,
        ) {
