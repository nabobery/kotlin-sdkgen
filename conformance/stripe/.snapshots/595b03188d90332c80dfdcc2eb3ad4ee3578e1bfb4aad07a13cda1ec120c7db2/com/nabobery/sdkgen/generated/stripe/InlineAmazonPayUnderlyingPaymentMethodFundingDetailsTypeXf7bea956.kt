...
public sealed class InlineAmazonPayUnderlyingPaymentMethodFundingDetailsTypeXf7bea956 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineAmazonPayUnderlyingPaymentMethodFundingDetailsTypeXf7bea956 =
            when (value) {
                Card.value -> Card
    ...
    public object Serializer : KSerializer<InlineAmazonPayUnderlyingPaymentMethodFundingDetailsTypeXf7bea956> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineAmazonPayUnderlyingPaymentMethodFundingDetailsTypeXf7bea956",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineAmazonPayUnderlyingPaymentMethodFundingDetailsTypeXf7bea956 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineAmazonPayUnderlyingPaymentMethodFundingDetailsTypeXf7bea956,
        ) {
