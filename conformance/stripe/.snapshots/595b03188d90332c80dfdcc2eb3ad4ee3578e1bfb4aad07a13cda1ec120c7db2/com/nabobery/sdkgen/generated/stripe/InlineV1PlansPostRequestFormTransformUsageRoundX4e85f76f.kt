...
public sealed class InlineV1PlansPostRequestFormTransformUsageRoundX4e85f76f {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1PlansPostRequestFormTransformUsageRoundX4e85f76f =
            when (value) {
                Down.value -> Down
                Up.value -> Up
    ...
    public object Serializer : KSerializer<InlineV1PlansPostRequestFormTransformUsageRoundX4e85f76f> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1PlansPostRequestFormTransformUsageRoundX4e85f76f",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1PlansPostRequestFormTransformUsageRoundX4e85f76f =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PlansPostRequestFormTransformUsageRoundX4e85f76f,
        ) {
