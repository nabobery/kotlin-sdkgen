...
public sealed class InlineV1TestHelpersTerminad724PostRequestFormTypeX03de22b0 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1TestHelpersTerminad724PostRequestFormTypeX03de22b0 =
            when (value) {
                Card.value -> Card
    ...
    public object Serializer : KSerializer<InlineV1TestHelpersTerminad724PostRequestFormTypeX03de22b0> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1TestHelpersTerminad724PostRequestFormTypeX03de22b0",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1TestHelpersTerminad724PostRequestFormTypeX03de22b0 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TestHelpersTerminad724PostRequestFormTypeX03de22b0,
        ) {
