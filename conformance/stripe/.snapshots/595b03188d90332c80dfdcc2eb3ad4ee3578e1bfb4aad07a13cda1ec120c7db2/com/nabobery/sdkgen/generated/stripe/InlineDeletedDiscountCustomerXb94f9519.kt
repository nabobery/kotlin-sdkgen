...
public class InlineDeletedDiscountCustomerXb94f9519 internal constructor(
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineDeletedDiscountCustomerXb94f9519 {
            val inspection = inspectInlineDeletedDiscountCustomerXb94f9519(raw)
            if (inspection.matchCount == 0) {
                throw InlineDeletedDiscountCustomerXb94f9519NoMatchException(
                    "InlineDeletedDiscountCustomerXb94f9519 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineDeletedDiscountCustomerXb94f9519> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineDeletedDiscountCustomerXb94f9519,
        ) {
...
private fun inspectInlineDeletedDiscountCustomerXb94f9519(
    element: JsonElement,
): InlineDeletedDiscountCustomerXb94f9519Inspection {
