...
public class InlineSetupAttemptCustomerX4f3b3f84 internal constructor(
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineSetupAttemptCustomerX4f3b3f84 {
            val inspection = inspectInlineSetupAttemptCustomerX4f3b3f84(raw)
            if (inspection.matchCount == 0) {
                throw InlineSetupAttemptCustomerX4f3b3f84NoMatchException(
                    "InlineSetupAttemptCustomerX4f3b3f84 matched 0 branches: " + inspection.failures.joinToString("; "),
                )
            }
    ...
    public object Serializer : KSerializer<InlineSetupAttemptCustomerX4f3b3f84> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineSetupAttemptCustomerX4f3b3f84,
        ) {
...
private fun inspectInlineSetupAttemptCustomerX4f3b3f84(
    element: JsonElement,
): InlineSetupAttemptCustomerX4f3b3f84Inspection {
