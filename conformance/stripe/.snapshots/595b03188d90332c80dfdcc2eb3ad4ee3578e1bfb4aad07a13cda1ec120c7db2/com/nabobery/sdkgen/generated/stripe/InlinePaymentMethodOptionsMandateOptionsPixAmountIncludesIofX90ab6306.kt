...
public sealed class InlinePaymentMethodOptionsMandateOptionsPixAmountIncludesIofX90ab6306 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentMethodOptionsMandateOptionsPixAmountIncludesIofX90ab6306 =
            when (value) {
                Always.value -> Always
                Never.value -> Never
    ...
    public object Serializer : KSerializer<InlinePaymentMethodOptionsMandateOptionsPixAmountIncludesIofX90ab6306> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentMethodOptionsMandateOptionsPixAmountIncludesIofX90ab6306",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlinePaymentMethodOptionsMandateOptionsPixAmountIncludesIofX90ab6306 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentMethodOptionsMandateOptionsPixAmountIncludesIofX90ab6306,
        ) {
