...
public class IssuingCardShippingCustoms(
    ...
    public class Builder {
        ...
        public fun build(): IssuingCardShippingCustoms =
    ...
    public object Serializer : KSerializer<IssuingCardShippingCustoms> {
        ...
        override fun deserialize(decoder: Decoder): IssuingCardShippingCustoms {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("IssuingCardShippingCustoms must be a JSON object")
            return IssuingCardShippingCustoms(
                eoriNumber =
                    rawObject["eori_number"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: IssuingCardShippingCustoms,
        ) {
...
public fun issuingCardShippingCustoms(
    block: IssuingCardShippingCustoms.Builder.() -> Unit,
): IssuingCardShippingCustoms = IssuingCardShippingCustoms.build(block)
