...
public class InlineV1TopupsGetParameterX36610912 internal constructor(
    ...
    public val inlineV1TopupsGetParameterAnyOf1Xfd3d51f0: InlineV1TopupsGetParameterAnyOf1Xfd3d51f0?
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1TopupsGetParameterAnyOf1Xfd3d51f0) {
                json
                    .decodeFromJsonElement<InlineV1TopupsGetParameterAnyOf1Xfd3d51f0>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1TopupsGetParameterX36610912Branch>
        get() =
            buildSet {
                if (inspection.matchesInlineV1TopupsGetParameterAnyOf1Xfd3d51f0) {
                    add(
                        InlineV1TopupsGetParameterX36610912Branch.InlineV1TopupsGetParameterAnyOf1Xfd3d51f0,
                    )
                }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1TopupsGetParameterX36610912 {
            val inspection = inspectInlineV1TopupsGetParameterX36610912(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1TopupsGetParameterX36610912NoMatchException(
                    "InlineV1TopupsGetParameterX36610912 matched 0 branches: " + inspection.failures.joinToString("; "),
                )
            }
    ...
    public object Serializer : KSerializer<InlineV1TopupsGetParameterX36610912> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TopupsGetParameterX36610912,
        ) {
...
private fun inspectInlineV1TopupsGetParameterX36610912(
    element: JsonElement,
): InlineV1TopupsGetParameterX36610912Inspection {
    val matchesInlineV1TopupsGetParameterAnyOf1Xfd3d51f0 =
        element
            .isJsonDecodable<InlineV1TopupsGetParameterAnyOf1Xfd3d51f0>()
    ...
    return InlineV1TopupsGetParameterX36610912Inspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1TopupsGetParameterAnyOf1Xfd3d51f0) {
                    add(
                        "InlineV1TopupsGetParameterAnyOf1Xfd3d51f0: value does not match InlineV1TopupsGetParameterAnyOf1Xfd3d51f0",
                    )
                }
