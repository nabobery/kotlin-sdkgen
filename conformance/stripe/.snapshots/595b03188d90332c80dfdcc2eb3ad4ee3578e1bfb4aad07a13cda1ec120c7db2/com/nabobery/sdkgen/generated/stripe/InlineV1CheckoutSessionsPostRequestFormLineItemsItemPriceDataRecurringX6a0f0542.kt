...
public class InlineV1CheckoutSessionsPostRequestFormLineItemsItemPriceDataRecurringX6a0f0542(
    public val interval: InlineV1CheckoutSessionsPostRequestFormLineItemsItemPriceDataIntervalXd47390b3,
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1CheckoutSessionsPostRequestFormLineItemsItemPriceDataRecurringX6a0f0542 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormLineItemsItemPriceDataRecurringX6a0f0542> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CheckoutSessionsPostRequestFormLineItemsItemPriceDataRecurringX6a0f0542 must be a JSON object",
                    )
            val interval =
                json
                    .decodeRequired<InlineV1CheckoutSessionsPostRequestFormLineItemsItemPriceDataIntervalXd47390b3>(
                        rawObject,
                        "interval",
                    )
            return InlineV1CheckoutSessionsPostRequestFormLineItemsItemPriceDataRecurringX6a0f0542(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsPostRequestFormLineItemsItemPriceDataRecurringX6a0f0542,
        ) {
            val jsonEncoder =
...
public fun inlineV1CheckoutSessionsPostRequestFormLineItemsItemPriceDataRecurringX6a0f0542(
    block: InlineV1CheckoutSessionsPostRequestFormLineItemsItemPriceDataRecurringX6a0f0542.Builder.() -> Unit,
): InlineV1CheckoutSessionsPostRequestFormLineItemsItemPriceDataRecurringX6a0f0542 =
    InlineV1CheckoutSessionsPostRequestFormLineItemsItemPriceDataRecurringX6a0f0542.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1CheckoutSessionsPostRequestFormLineItemsItemPriceDataRecurringX6a0f0542 is missing required property '" +
                    name +
                    "'",
            )
