...
public class IssuingAuthorizationVerificationData(
     ...
     */
    public val addressLine1Check: InlineIssuingAuthorizationVerificationDataAddressLine1CheckX57911368,
    /**
     * Whether the cardholder provided a postal code and if it matched the cardholder’s `billing.address.postal_code`.
     */
    public val addressPostalCodeCheck: InlineIssuingAuthorizationVerificationDataAddressPostalCodeCheckX7628f69b,
    /**
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): IssuingAuthorizationVerificationData =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<IssuingAuthorizationVerificationData> {
        ...
        override fun deserialize(decoder: Decoder): IssuingAuthorizationVerificationData {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("IssuingAuthorizationVerificationData must be a JSON object")
            val addressLine1Check =
                json.decodeRequired<InlineIssuingAuthorizationVerificationDataAddressLine1CheckX57911368>(
                    rawObject,
                    "address_line1_check",
                )
            val addressPostalCodeCheck =
                json
                    .decodeRequired<InlineIssuingAuthorizationVerificationDataAddressPostalCodeCheckX7628f69b>(
                        rawObject,
                        "address_postal_code_check",
                    )
            val cvcCheck =
                json.decodeRequired<InlineIssuingAuthorizationVerificationDataCvcCheckX82d5aa7d>(
                    rawObject,
                    "cvc_check",
                )
            val expiryCheck =
                json.decodeRequired<InlineIssuingAuthorizationVerificationDataExpiryCheckX0ccfb43f>(
                    rawObject,
                    "expiry_check",
                )
            return IssuingAuthorizationVerificationData(
                ...
                authenticationExemption =
                    rawObject["authentication_exemption"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                            ...
                            json
                                .decodeFromJsonElement<InlineIssuingAuthorizationVerificationDataAuthenticationExemptionXe26ff133?>(
                                    element,
                                )
                        }
                    },
                ...
                threeDSecure =
                    rawObject["three_d_secure"]?.let { element ->
                        if (element ==
                            ...
                            json
                                .decodeFromJsonElement<InlineIssuingAuthorizationVerificationDataThreeDSecureX2581b6da?>(
                                    element,
                                )
                        }
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: IssuingAuthorizationVerificationData,
        ) {
...
public fun issuingAuthorizationVerificationData(
    block: IssuingAuthorizationVerificationData.Builder.() -> Unit,
): IssuingAuthorizationVerificationData = IssuingAuthorizationVerificationData.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "IssuingAuthorizationVerificationData is missing required property '" + name + "'",
            )
