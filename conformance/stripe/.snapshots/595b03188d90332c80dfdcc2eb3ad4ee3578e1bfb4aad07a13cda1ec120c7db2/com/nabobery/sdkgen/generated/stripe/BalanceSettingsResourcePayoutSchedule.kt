...
@Serializable
public data class BalanceSettingsResourcePayoutScheduleView(
    ...
    public val weeklyPayoutDays: List<InlineBalanceSettingsResourcePayoutScheduleWeeklyPayoutDaysItemX16a25354>? = null,
)
...
public class BalanceSettingsResourcePayoutSchedule(
    ...
    public class Builder {
        ...
        public fun build(): BalanceSettingsResourcePayoutSchedule =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): BalanceSettingsResourcePayoutSchedule =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<BalanceSettingsResourcePayoutSchedule> {
        ...
        override fun deserialize(decoder: Decoder): BalanceSettingsResourcePayoutSchedule {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("BalanceSettingsResourcePayoutSchedule must be a JSON object")
            return BalanceSettingsResourcePayoutSchedule(
                interval =
                    rawObject["interval"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineBalanceSettingsResourcePayoutScheduleIntervalX89eadcc3?>(
                                element,
                            )
                        }
                    },
                ...
                weeklyPayoutDays =
                    rawObject["weekly_payout_days"]?.let {
                        json
                            .decodeFromJsonElement<List<InlineBalanceSettingsResourcePayoutScheduleWeeklyPayoutDaysItemX16a25354>>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: BalanceSettingsResourcePayoutSchedule,
        ) {
...
public fun balanceSettingsResourcePayoutSchedule(
    block: BalanceSettingsResourcePayoutSchedule.Builder.() -> Unit,
): BalanceSettingsResourcePayoutSchedule = BalanceSettingsResourcePayoutSchedule.build(block)
