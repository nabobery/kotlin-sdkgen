...
public sealed class InlineTreasuryTransactionsResourceFlowDetailsTypeX471eba71 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineTreasuryTransactionsResourceFlowDetailsTypeX471eba71 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineTreasuryTransactionsResourceFlowDetailsTypeX471eba71> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineTreasuryTransactionsResourceFlowDetailsTypeX471eba71",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineTreasuryTransactionsResourceFlowDetailsTypeX471eba71 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineTreasuryTransactionsResourceFlowDetailsTypeX471eba71,
        ) {
