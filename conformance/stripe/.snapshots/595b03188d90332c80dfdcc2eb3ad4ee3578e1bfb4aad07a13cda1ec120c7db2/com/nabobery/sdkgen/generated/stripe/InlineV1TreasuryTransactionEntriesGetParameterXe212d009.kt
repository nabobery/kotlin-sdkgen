...
public sealed class InlineV1TreasuryTransactionEntriesGetParameterXe212d009 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1TreasuryTransactionEntriesGetParameterXe212d009 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1TreasuryTransactionEntriesGetParameterXe212d009> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1TreasuryTransactionEntriesGetParameterXe212d009",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1TreasuryTransactionEntriesGetParameterXe212d009 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TreasuryTransactionEntriesGetParameterXe212d009,
        ) {
