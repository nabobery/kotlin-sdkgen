...
public data class PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCardDetailsResourceThreeDSecureView(
    ...
    public val electronicCommerceIndicator: InlinePaymentsPrimitivesPabc9bElectronicCommerceIn67d5X155cc56a? = null,
 ...
 */
@Serializable(
    with = PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCardDetailsResourceThreeDSecure.Serializer::class,
)
public class PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCardDetailsResourceThreeDSecure(
    ...
    public class Builder {
        ...
        public fun build(): PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCardDetailsResourceThreeDSecure =
    ...
    public object Serializer : KSerializer<PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCardDetailsResourceThreeDSecure> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCardDetailsResourceThreeDSecure must be a JSON object",
                    )
            return PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCardDetailsResourceThreeDSecure(
                authenticationFlow =
                    rawObject["authentication_flow"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlinePaymentsPrimitivesPabc9bAuthenticationFlowX5a9c550c?>(
                                element,
                            )
                        }
                    },
                cryptogram =
                    rawObject["cryptogram"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                electronicCommerceIndicator =
                    rawObject["electronic_commerce_indicator"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                            ...
                            json
                                .decodeFromJsonElement<InlinePaymentsPrimitivesPabc9bElectronicCommerceIn67d5X155cc56a?>(
                                    element,
                                )
                        }
                    },
                exemptionIndicator =
                    rawObject["exemption_indicator"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlinePaymentsPrimitivesPabc9bExemptionIndicatorX00cd1440?>(
                                element,
                            )
                        }
                    },
                exemptionIndicatorApplied =
                    rawObject["exemption_indicator_applied"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                result =
                    rawObject["result"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentsPrimitivesPabc9bResultX842ca21e?>(element)
                        }
                    },
                resultReason =
                    rawObject["result_reason"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlinePaymentsPrimitivesPabc9bResultReasonXf8760e38?>(element)
                        }
                    },
                version =
                    rawObject["version"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlinePaymentsPrimitivesPabc9bVersionXa265e284?>(element)
                        }
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCardDetailsResourceThreeDSecure,
        ) {
            val jsonEncoder =
            ...
            val raw =
                buildJsonObject {
                    ...
                    value.exemptionIndicatorApplied?.let {
                        put(
...
public fun paymentsPrimitivesPaymentRecordsResourcePaymentMethodCardDetailsResourceThreeDSecure(
    block: PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCardDetailsResourceThreeDSecure.Builder.() -> Unit,
): PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCardDetailsResourceThreeDSecure =
    PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCardDetailsResourceThreeDSecure.build(block)
