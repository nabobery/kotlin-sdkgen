...
public sealed class InlineV1CheckoutSessionsPostRequestFormPaymentScheduleX3481c32f {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1CheckoutSessionsPostRequestFormPaymentScheduleX3481c32f =
            when (value) {
                Value.value -> Value
                Adhoc.value -> Adhoc
                Annual.value -> Annual
    ...
    public object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormPaymentScheduleX3481c32f> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1CheckoutSessionsPostRequestFormPaymentScheduleX3481c32f",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1CheckoutSessionsPostRequestFormPaymentScheduleX3481c32f =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsPostRequestFormPaymentScheduleX3481c32f,
        ) {
