...
public class InlineV1CustomersPostRequestFormX8983249a(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1CustomersPostRequestFormX8983249a =
            InlineV1CustomersPostRequestFormX8983249a(
                address = address,
                balance = balance,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1CustomersPostRequestFormX8983249a =
    ...
    public object Serializer : KSerializer<InlineV1CustomersPostRequestFormX8983249a> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1CustomersPostRequestFormX8983249a {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("InlineV1CustomersPostRequestFormX8983249a must be a JSON object")
            return InlineV1CustomersPostRequestFormX8983249a(
                address =
                    rawObject["address"]?.let {
                        json.decodeFromJsonElement<InlineV1CustomersPostRequestFormAddressXea1a2b6f>(it)
                    },
                balance = rawObject["balance"]?.let { json.decodeFromJsonElement<Int>(it) },
                bankAccount =
                    rawObject["bank_account"]?.let {
                        json.decodeFromJsonElement<InlineV1CustomersPostRequestFormBankAccountX4958274f>(it)
                    },
                businessName =
                    rawObject["business_name"]?.let {
                        json.decodeFromJsonElement<InlineV1CustomersPostRequestFormBusinessNameX3abf1513>(it)
                    },
                card =
                    rawObject["card"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CustomersPostRequestFormCardXe833a08a>(
                                it,
                            )
                    },
                cashBalance =
                    rawObject["cash_balance"]?.let {
                        json.decodeFromJsonElement<InlineV1CustomersPostRequestFormCashBalanceX43728c16>(it)
                    },
                defaultAlipayAccount =
                    rawObject["default_alipay_account"]?.let {
                        json
                            .decodeFromJsonElement<String>(
                                it,
                            )
                    },
                defaultBankAccount = rawObject["default_bank_account"]?.let {
                ...
                individualName =
                    rawObject["individual_name"]?.let {
                        json.decodeFromJsonElement<InlineV1CustomersPostRequestFormIndividualNameXec453fc2>(it)
                    },
                invoicePrefix = rawObject["invoice_prefix"]?.let { json.decodeFromJsonElement<String>(it) },
                invoiceSettings =
                    rawObject["invoice_settings"]?.let {
                        json.decodeFromJsonElement<InlineV1CustomersPostRequestFormInvoiceSettingsX8b4aa88c>(it)
                    },
                metadata =
                    rawObject["metadata"]?.let {
                        json.decodeFromJsonElement<InlineV1CustomersPostRequestFormMetadataX4ae4881c>(it)
                    },
                ...
                shipping =
                    rawObject["shipping"]?.let {
                        json.decodeFromJsonElement<InlineV1CustomersPostRequestFormShippingX0292b6b4>(it)
                    },
                source = rawObject["source"]?.let { json.decodeFromJsonElement<String>(it) },
                tax =
                    rawObject["tax"]?.let {
                        json.decodeFromJsonElement<InlineV1CustomersPostRequestFormTaxX76fca852>(
                            it,
                        )
                    },
                taxExempt =
                    rawObject["tax_exempt"]?.let {
                        json.decodeFromJsonElement<InlineV1CustomersPostRequestFormTaxExemptX70f74070>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersPostRequestFormX8983249a,
        ) {
...
public fun inlineV1CustomersPostRequestFormX8983249a(
    block: InlineV1CustomersPostRequestFormX8983249a.Builder.() -> Unit,
): InlineV1CustomersPostRequestFormX8983249a = InlineV1CustomersPostRequestFormX8983249a.build(block)
