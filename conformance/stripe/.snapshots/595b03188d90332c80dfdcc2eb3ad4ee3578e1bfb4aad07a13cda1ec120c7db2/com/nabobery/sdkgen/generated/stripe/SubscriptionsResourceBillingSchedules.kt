...
public class SubscriptionsResourceBillingSchedules(
     ...
     */
    public val appliesTo: List<SubscriptionsResourceBillingSchedulesAppliesTo>? = null,
) {
    public class Builder {
         ...
         * Specifies which subscription items the billing schedule applies to.
         */
        public var appliesTo: List<SubscriptionsResourceBillingSchedulesAppliesTo>? = null
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): SubscriptionsResourceBillingSchedules =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<SubscriptionsResourceBillingSchedules> {
        ...
        override fun deserialize(decoder: Decoder): SubscriptionsResourceBillingSchedules {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("SubscriptionsResourceBillingSchedules must be a JSON object")
            ...
            return SubscriptionsResourceBillingSchedules(
                ...
                key = key,
                appliesTo =
                    rawObject["applies_to"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<List<SubscriptionsResourceBillingSchedulesAppliesTo>?>(element)
                        }
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: SubscriptionsResourceBillingSchedules,
        ) {
...
public fun subscriptionsResourceBillingSchedules(
    block: SubscriptionsResourceBillingSchedules.Builder.() -> Unit,
): SubscriptionsResourceBillingSchedules = SubscriptionsResourceBillingSchedules.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "SubscriptionsResourceBillingSchedules is missing required property '" + name + "'",
            )
