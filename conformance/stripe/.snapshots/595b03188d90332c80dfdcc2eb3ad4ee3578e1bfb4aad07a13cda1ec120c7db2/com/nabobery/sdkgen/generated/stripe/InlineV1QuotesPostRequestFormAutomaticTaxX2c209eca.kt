...
public class InlineV1QuotesPostRequestFormAutomaticTaxX2c209eca(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1QuotesPostRequestFormAutomaticTaxX2c209eca =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1QuotesPostRequestFormAutomaticTaxX2c209eca> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1QuotesPostRequestFormAutomaticTaxX2c209eca must be a JSON object",
                    )
            ...
            return InlineV1QuotesPostRequestFormAutomaticTaxX2c209eca(
                ...
                liability =
                    rawObject["liability"]?.let {
                        json.decodeFromJsonElement<InlineV1QuotesPostRequestFormAutomaticTaxLiabilityX82563363>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1QuotesPostRequestFormAutomaticTaxX2c209eca,
        ) {
...
public fun inlineV1QuotesPostRequestFormAutomaticTaxX2c209eca(
    block: InlineV1QuotesPostRequestFormAutomaticTaxX2c209eca.Builder.() -> Unit,
): InlineV1QuotesPostRequestFormAutomaticTaxX2c209eca = InlineV1QuotesPostRequestFormAutomaticTaxX2c209eca.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1QuotesPostRequestFormAutomaticTaxX2c209eca is missing required property '" + name + "'",
            )
