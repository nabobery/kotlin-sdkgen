...
public sealed class InlineInboundTransfersPaymaf43AccountHolderTypeXc7c6f01f {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineInboundTransfersPaymaf43AccountHolderTypeXc7c6f01f =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineInboundTransfersPaymaf43AccountHolderTypeXc7c6f01f> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineInboundTransfersPaymaf43AccountHolderTypeXc7c6f01f",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineInboundTransfersPaymaf43AccountHolderTypeXc7c6f01f =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineInboundTransfersPaymaf43AccountHolderTypeXc7c6f01f,
        ) {
