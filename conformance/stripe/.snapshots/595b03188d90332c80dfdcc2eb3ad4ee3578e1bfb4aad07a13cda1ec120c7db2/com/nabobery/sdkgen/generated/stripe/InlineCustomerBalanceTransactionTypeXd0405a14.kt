...
public sealed class InlineCustomerBalanceTransactionTypeXd0405a14 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineCustomerBalanceTransactionTypeXd0405a14 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineCustomerBalanceTransactionTypeXd0405a14> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineCustomerBalanceTransactionTypeXd0405a14",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineCustomerBalanceTransactionTypeXd0405a14 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineCustomerBalanceTransactionTypeXd0405a14,
        ) {
