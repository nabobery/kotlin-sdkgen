...
public class InlineV1CustomersPostRequestFormTaxIdDataItemXa5c9f532(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1CustomersPostRequestFormTaxIdDataItemXa5c9f532 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1CustomersPostRequestFormTaxIdDataItemXa5c9f532> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CustomersPostRequestFormTaxIdDataItemXa5c9f532 must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineV1CustomersPostRequestFormTaxIdDataItemTypeXa7e534b2>(
                    rawObject,
                    "type",
                )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersPostRequestFormTaxIdDataItemXa5c9f532,
        ) {
...
public fun inlineV1CustomersPostRequestFormTaxIdDataItemXa5c9f532(
    block: InlineV1CustomersPostRequestFormTaxIdDataItemXa5c9f532.Builder.() -> Unit,
): InlineV1CustomersPostRequestFormTaxIdDataItemXa5c9f532 =
    InlineV1CustomersPostRequestFormTaxIdDataItemXa5c9f532.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1CustomersPostRequestFormTaxIdDataItemXa5c9f532 is missing required property '" + name + "'",
            )
