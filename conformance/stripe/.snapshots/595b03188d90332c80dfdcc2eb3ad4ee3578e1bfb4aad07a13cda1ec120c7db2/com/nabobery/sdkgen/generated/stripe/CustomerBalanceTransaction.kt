...
@Serializable
public data class CustomerBalanceTransactionView(
...
public class CustomerBalanceTransaction(
    ...
    public object Serializer : KSerializer<CustomerBalanceTransaction> {
        ...
        override fun deserialize(decoder: Decoder): CustomerBalanceTransaction {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("CustomerBalanceTransaction must be a JSON object")
            ...
            val objectValue =
                json.decodeRequired<InlineCustomerBalanceTransactionObjectValueXfd80c0ef>(
                    rawObject,
                    "object",
                )
            ...
            return CustomerBalanceTransaction(
                ...
                type = type,
                checkoutSession =
                    rawObject["checkout_session"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineCustomerBalanceTransactionCheckoutSessionX2b2ae84c?>(
                                element,
                            )
                        }
                    },
                creditNote =
                    rawObject["credit_note"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineCustomerBalanceTransactionCreditNoteX36733346?>(element)
                        }
                    },
                customerAccount =
                ...
                invoice =
                    rawObject["invoice"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineCustomerBalanceTransactionInvoiceXa74b01e8?>(element)
                        }
                    },
                metadata =
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: CustomerBalanceTransaction,
        ) {
...
public fun customerBalanceTransaction(
    block: CustomerBalanceTransaction.Builder.() -> Unit,
): CustomerBalanceTransaction = CustomerBalanceTransaction.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException("CustomerBalanceTransaction is missing required property '" + name + "'")
