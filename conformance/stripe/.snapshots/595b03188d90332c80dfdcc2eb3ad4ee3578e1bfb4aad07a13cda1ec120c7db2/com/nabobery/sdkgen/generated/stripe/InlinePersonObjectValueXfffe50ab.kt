...
public sealed class InlinePersonObjectValueXfffe50ab {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePersonObjectValueXfffe50ab =
            when (value) {
                Person.value -> Person
    ...
    public object Serializer : KSerializer<InlinePersonObjectValueXfffe50ab> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePersonObjectValueXfffe50ab",
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlinePersonObjectValueXfffe50ab,
        ) {
