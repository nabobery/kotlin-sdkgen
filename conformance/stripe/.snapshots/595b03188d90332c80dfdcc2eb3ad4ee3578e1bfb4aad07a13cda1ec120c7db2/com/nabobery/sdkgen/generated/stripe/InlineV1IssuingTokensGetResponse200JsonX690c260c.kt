...
public class InlineV1IssuingTokensGetResponse200JsonX690c260c(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1IssuingTokensGetResponse200JsonX690c260c =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1IssuingTokensGetResponse200JsonX690c260c> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1IssuingTokensGetResponse200JsonX690c260c must be a JSON object",
                    )
            val data = json.decodeRequired<List<IssuingToken>>(rawObject, "data")
            val hasMore = json.decodeRequired<Boolean>(rawObject, "has_more")
            val objectValue =
                json.decodeRequired<InlineV1IssuingTokensGetResponse200JsonObjectValueX1a31cd53>(
                    rawObject,
                    "object",
                )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingTokensGetResponse200JsonX690c260c,
        ) {
...
public fun inlineV1IssuingTokensGetResponse200JsonX690c260c(
    block: InlineV1IssuingTokensGetResponse200JsonX690c260c.Builder.() -> Unit,
): InlineV1IssuingTokensGetResponse200JsonX690c260c = InlineV1IssuingTokensGetResponse200JsonX690c260c.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1IssuingTokensGetResponse200JsonX690c260c is missing required property '" + name + "'",
            )
