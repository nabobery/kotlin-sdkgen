...
public class InlineV1TestHelpersIssuingAuthorizationsPostRequestFormMerchantDataX6d8b8b89(
    public val category: InlineV1TestHelpersIssuing214aPostRequestFormMerchantDataCategoryXe79c2a8d? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1TestHelpersIssuingAuthorizationsPostRequestFormMerchantDataX6d8b8b89 =
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1TestHelpersIssuingAuthorizationsPostRequestFormMerchantDataX6d8b8b89 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1TestHelpersIssuingAuthorizationsPostRequestFormMerchantDataX6d8b8b89> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TestHelpersIssuingAuthorizationsPostRequestFormMerchantDataX6d8b8b89 must be a JSON object",
                    )
            return InlineV1TestHelpersIssuingAuthorizationsPostRequestFormMerchantDataX6d8b8b89(
                category =
                    rawObject["category"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TestHelpersIssuing214aPostRequestFormMerchantDataCategoryXe79c2a8d>(
                                it,
                            )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TestHelpersIssuingAuthorizationsPostRequestFormMerchantDataX6d8b8b89,
        ) {
            val jsonEncoder =
...
public fun inlineV1TestHelpersIssuingAuthorizationsPostRequestFormMerchantDataX6d8b8b89(
    block: InlineV1TestHelpersIssuingAuthorizationsPostRequestFormMerchantDataX6d8b8b89.Builder.() -> Unit,
): InlineV1TestHelpersIssuingAuthorizationsPostRequestFormMerchantDataX6d8b8b89 =
    InlineV1TestHelpersIssuingAuthorizationsPostRequestFormMerchantDataX6d8b8b89.build(block)
