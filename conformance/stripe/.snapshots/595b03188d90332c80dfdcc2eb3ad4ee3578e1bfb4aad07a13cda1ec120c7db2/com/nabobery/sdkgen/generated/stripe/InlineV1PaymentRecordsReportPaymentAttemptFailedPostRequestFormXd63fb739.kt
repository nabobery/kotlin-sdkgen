...
public class InlineV1PaymentRecordsReportPaymentAttemptFailedPostRequestFormXd63fb739(
     ...
     */
    public val metadata: InlineV1PaymentRecordsReportPaymentAttemptFailedPostRequestFormMetadataX6b2ecfb7? = null,
) {
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentRecordsReportPaymentAttemptFailedPostRequestFormXd63fb739 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentRecordsReportPaymentAttemptFailedPostRequestFormXd63fb739> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentRecordsReportPaymentAttemptFailedPostRequestFormXd63fb739 must be a JSON object",
                    )
            ...
            return InlineV1PaymentRecordsReportPaymentAttemptFailedPostRequestFormXd63fb739(
                ...
                metadata =
                    rawObject["metadata"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentRecordsReportPaymentAttemptFailedPostRequestFormMetadataX6b2ecfb7>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentRecordsReportPaymentAttemptFailedPostRequestFormXd63fb739,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentRecordsReportPaymentAttemptFailedPostRequestFormXd63fb739(
    block: InlineV1PaymentRecordsReportPaymentAttemptFailedPostRequestFormXd63fb739.Builder.() -> Unit,
): InlineV1PaymentRecordsReportPaymentAttemptFailedPostRequestFormXd63fb739 =
    InlineV1PaymentRecordsReportPaymentAttemptFailedPostRequestFormXd63fb739.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentRecordsReportPaymentAttemptFailedPostRequestFormXd63fb739 is missing required property '" +
                    name +
                    "'",
            )
