...
public class TransformUsage(
    ...
    public object Serializer : KSerializer<TransformUsage> {
        ...
        override fun deserialize(decoder: Decoder): TransformUsage {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("TransformUsage must be a JSON object")
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("TransformUsage is missing required property '" + name + "'")
