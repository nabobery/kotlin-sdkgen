...
public class InlinePaymentIntentLatestChargeXddbf3551 internal constructor(
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlinePaymentIntentLatestChargeXddbf3551 {
            val inspection = inspectInlinePaymentIntentLatestChargeXddbf3551(raw)
            if (inspection.matchCount == 0) {
                throw InlinePaymentIntentLatestChargeXddbf3551NoMatchException(
                    "InlinePaymentIntentLatestChargeXddbf3551 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlinePaymentIntentLatestChargeXddbf3551> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentIntentLatestChargeXddbf3551,
        ) {
...
private fun inspectInlinePaymentIntentLatestChargeXddbf3551(
    element: JsonElement,
): InlinePaymentIntentLatestChargeXddbf3551Inspection {
