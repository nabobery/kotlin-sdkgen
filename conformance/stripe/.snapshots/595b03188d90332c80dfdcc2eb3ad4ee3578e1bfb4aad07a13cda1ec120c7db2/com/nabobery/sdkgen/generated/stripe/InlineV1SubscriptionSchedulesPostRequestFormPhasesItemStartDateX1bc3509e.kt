...
internal data class InlineV1SubscriptionSchedulesPostRequestFormPhasesItemStartDateX1bc3509eInspection(
    ...
    public val matchesInlineV1SubscriptionSchedulesPostRequestFormPhasesItemStartDateAnyOf2X5a812f8e: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1SubscriptionSchedulesPostRequestFormPhasesItemStartDateAnyOf2X5a812f8e,
            ).count {
                it
            }
}
...
public class InlineV1SubscriptionSchedulesPostRequestFormPhasesItemStartDateX1bc3509e internal constructor(
    ...
    private val inspection: InlineV1SubscriptionSchedulesPostRequestFormPhasesItemStartDateX1bc3509eInspection,
) {
    ...
    public val inlineV1SubscriptionSchedulesPostRequestFormPhasesItemStartDateAnyOf2X5a812f8e:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1SubscriptionSchedulesPostRequestFormPhasesItemStartDateAnyOf2X5a812f8e) {
                json
                    .decodeFromJsonElement<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemStartDateAnyOf2X5a812f8e>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1SubscriptionSchedulesPostRequestFormPhasesItemStartDateX1bc3509eBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1SubscriptionSchedulesPostRequestFormPhasesItemStartDateAnyOf2X5a812f8e) {
                    add(
                        InlineV1SubscriptionSchedulesPostRequestFormPhasesItemStartDateX1bc3509eBranch.InlineV1SubscriptionSchedulesPostRequestFormPhasesItemStartDateAnyOf2X5a812f8e,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1SubscriptionSchedulesPostRequestFormPhasesItemStartDateX1bc3509e {
            val inspection = inspectInlineV1SubscriptionSchedulesPostRequestFormPhasesItemStartDateX1bc3509e(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1SubscriptionSchedulesPostRequestFormPhasesItemStartDateX1bc3509eNoMatchException(
                    "InlineV1SubscriptionSchedulesPostRequestFormPhasesItemStartDateX1bc3509e matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemStartDateX1bc3509e> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionSchedulesPostRequestFormPhasesItemStartDateX1bc3509e,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1SubscriptionSchedulesPostRequestFormPhasesItemStartDateX1bc3509e",
...
private fun inspectInlineV1SubscriptionSchedulesPostRequestFormPhasesItemStartDateX1bc3509e(
    element: JsonElement,
): InlineV1SubscriptionSchedulesPostRequestFormPhasesItemStartDateX1bc3509eInspection {
    val matchesBranch1 = element.isJsonDecodable<Int>()
    val matchesInlineV1SubscriptionSchedulesPostRequestFormPhasesItemStartDateAnyOf2X5a812f8e =
        element
            .isJsonDecodable<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemStartDateAnyOf2X5a812f8e>()
    return InlineV1SubscriptionSchedulesPostRequestFormPhasesItemStartDateX1bc3509eInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1SubscriptionSchedulesPostRequestFormPhasesItemStartDateAnyOf2X5a812f8e) {
                    add(
                        "InlineV1SubscriptionSchedulesPostRequestFormPhasesItemStartDateAnyOf2X5a812f8e: value does not match InlineV1SubscriptionSchedulesPostRequestFormPhasesItemStartDateAnyOf2X5a812f8e",
                    )
                }
            },
    )
