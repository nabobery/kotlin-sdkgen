...
public class BillingBillResourceInvoicingLinesParentsInvoiceLineItemInvoiceItemParent(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): BillingBillResourceInvoicingLinesParentsInvoiceLineItemInvoiceItemParent = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<BillingBillResourceInvoicingLinesParentsInvoiceLineItemInvoiceItemParent> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "BillingBillResourceInvoicingLinesParentsInvoiceLineItemInvoiceItemParent must be a JSON object",
                    )
                ...
                prorationDetails =
                    rawObject["proration_details"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineBillingBillResourceI03fcProrationDetailsX7d0edd12?>(
                                element,
                            )
                        }
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: BillingBillResourceInvoicingLinesParentsInvoiceLineItemInvoiceItemParent,
        ) {
            val jsonEncoder =
...
public fun billingBillResourceInvoicingLinesParentsInvoiceLineItemInvoiceItemParent(
    block: BillingBillResourceInvoicingLinesParentsInvoiceLineItemInvoiceItemParent.Builder.() -> Unit,
): BillingBillResourceInvoicingLinesParentsInvoiceLineItemInvoiceItemParent =
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "BillingBillResourceInvoicingLinesParentsInvoiceLineItemInvoiceItemParent is missing required property '" +
                    name +
                    "'",
            )
