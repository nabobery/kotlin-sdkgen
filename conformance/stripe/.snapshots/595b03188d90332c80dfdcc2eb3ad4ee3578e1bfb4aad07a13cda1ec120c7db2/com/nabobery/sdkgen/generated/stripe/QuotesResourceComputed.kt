...
public class QuotesResourceComputed(
    ...
    public object Serializer : KSerializer<QuotesResourceComputed> {
        ...
        override fun deserialize(decoder: Decoder): QuotesResourceComputed {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("QuotesResourceComputed must be a JSON object")
                ...
                recurring =
                    rawObject["recurring"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineQuotesResourceComputedRecurringXbed52f4d?>(element)
                        }
                    },
            )
        }
...
public fun quotesResourceComputed(block: QuotesResourceComputed.Builder.() -> Unit): QuotesResourceComputed =
    QuotesResourceComputed.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("QuotesResourceComputed is missing required property '" + name + "'")
