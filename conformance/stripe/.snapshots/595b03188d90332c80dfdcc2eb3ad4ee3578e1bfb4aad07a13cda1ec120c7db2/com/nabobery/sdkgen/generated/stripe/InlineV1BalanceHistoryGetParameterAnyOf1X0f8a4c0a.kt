...
public class InlineV1BalanceHistoryGetParameterAnyOf1X0f8a4c0a(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1BalanceHistoryGetParameterAnyOf1X0f8a4c0a =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1BalanceHistoryGetParameterAnyOf1X0f8a4c0a =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1BalanceHistoryGetParameterAnyOf1X0f8a4c0a> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1BalanceHistoryGetParameterAnyOf1X0f8a4c0a must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1BalanceHistoryGetParameterAnyOf1X0f8a4c0a,
        ) {
...
public fun inlineV1BalanceHistoryGetParameterAnyOf1X0f8a4c0a(
    block: InlineV1BalanceHistoryGetParameterAnyOf1X0f8a4c0a.Builder.() -> Unit,
): InlineV1BalanceHistoryGetParameterAnyOf1X0f8a4c0a = InlineV1BalanceHistoryGetParameterAnyOf1X0f8a4c0a.build(block)
