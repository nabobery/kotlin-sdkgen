...
public class InlineV1TreasuryFinancialAc862PostRequestFormFeaturesAchXf7ae6f5e(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TreasuryFinancialAc862PostRequestFormFeaturesAchXf7ae6f5e =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TreasuryFinancialAc862PostRequestFormFeaturesAchXf7ae6f5e> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1TreasuryFinancialAc862PostRequestFormFeaturesAchXf7ae6f5e {
            val jsonDecoder =
                decoder.requireJsonDecoder(
                    "InlineV1TreasuryFinancialAc862PostRequestFormFeaturesAchXf7ae6f5e",
                )
            val json = jsonDecoder.json
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TreasuryFinancialAc862PostRequestFormFeaturesAchXf7ae6f5e must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TreasuryFinancialAc862PostRequestFormFeaturesAchXf7ae6f5e,
        ) {
            val jsonEncoder =
...
public fun inlineV1TreasuryFinancialAc862PostRequestFormFeaturesAchXf7ae6f5e(
    block: InlineV1TreasuryFinancialAc862PostRequestFormFeaturesAchXf7ae6f5e.Builder.() -> Unit,
): InlineV1TreasuryFinancialAc862PostRequestFormFeaturesAchXf7ae6f5e =
    InlineV1TreasuryFinancialAc862PostRequestFormFeaturesAchXf7ae6f5e.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TreasuryFinancialAc862PostRequestFormFeaturesAchXf7ae6f5e is missing required property '" +
                    name +
                    "'",
            )
