...
public sealed class InlineAccountCapabilitiesNaverPayPaymentsX4d152196 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineAccountCapabilitiesNaverPayPaymentsX4d152196 =
            when (value) {
                Active.value -> Active
    ...
    public object Serializer : KSerializer<InlineAccountCapabilitiesNaverPayPaymentsX4d152196> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineAccountCapabilitiesNaverPayPaymentsX4d152196",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineAccountCapabilitiesNaverPayPaymentsX4d152196 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineAccountCapabilitiesNaverPayPaymentsX4d152196,
        ) {
