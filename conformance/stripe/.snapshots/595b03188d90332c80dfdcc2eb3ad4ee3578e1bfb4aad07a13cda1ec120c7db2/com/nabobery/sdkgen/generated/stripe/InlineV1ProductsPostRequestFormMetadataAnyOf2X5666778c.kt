...
public sealed class InlineV1ProductsPostRequestFormMetadataAnyOf2X5666778c {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1ProductsPostRequestFormMetadataAnyOf2X5666778c =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1ProductsPostRequestFormMetadataAnyOf2X5666778c> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1ProductsPostRequestFormMetadataAnyOf2X5666778c",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1ProductsPostRequestFormMetadataAnyOf2X5666778c =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ProductsPostRequestFormMetadataAnyOf2X5666778c,
        ) {
