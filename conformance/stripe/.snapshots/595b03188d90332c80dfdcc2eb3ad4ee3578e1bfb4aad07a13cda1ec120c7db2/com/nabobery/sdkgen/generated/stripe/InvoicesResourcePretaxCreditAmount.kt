...
public class InvoicesResourcePretaxCreditAmount(
    ...
    public object Serializer : KSerializer<InvoicesResourcePretaxCreditAmount> {
        ...
        override fun deserialize(decoder: Decoder): InvoicesResourcePretaxCreditAmount {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("InvoicesResourcePretaxCreditAmount must be a JSON object")
            ...
            return InvoicesResourcePretaxCreditAmount(
                ...
                creditBalanceTransaction =
                    rawObject["credit_balance_transaction"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                            ...
                            json
                                .decodeFromJsonElement<InlineInvoicesResourcePretaxCreditAmountCreditBalanceTransactionX4cc7eb2d?>(
                                    element,
                                )
                        }
                    },
                discount =
                    rawObject["discount"]?.let {
                        json.decodeFromJsonElement<InlineInvoicesResourcePretaxCreditAmountDiscountX4b97c12c>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InvoicesResourcePretaxCreditAmount,
        ) {
...
public fun invoicesResourcePretaxCreditAmount(
    block: InvoicesResourcePretaxCreditAmount.Builder.() -> Unit,
): InvoicesResourcePretaxCreditAmount = InvoicesResourcePretaxCreditAmount.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InvoicesResourcePretaxCreditAmount is missing required property '" + name + "'",
            )
