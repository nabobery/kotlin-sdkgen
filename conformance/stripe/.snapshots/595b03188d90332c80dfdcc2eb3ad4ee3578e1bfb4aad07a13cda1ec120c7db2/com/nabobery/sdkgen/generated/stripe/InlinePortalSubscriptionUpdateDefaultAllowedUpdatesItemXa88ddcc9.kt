...
public sealed class InlinePortalSubscriptionUpdateDefaultAllowedUpdatesItemXa88ddcc9 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePortalSubscriptionUpdateDefaultAllowedUpdatesItemXa88ddcc9 =
            when (value) {
                Price.value -> Price
    ...
    public object Serializer : KSerializer<InlinePortalSubscriptionUpdateDefaultAllowedUpdatesItemXa88ddcc9> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePortalSubscriptionUpdateDefaultAllowedUpdatesItemXa88ddcc9",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePortalSubscriptionUpdateDefaultAllowedUpdatesItemXa88ddcc9 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePortalSubscriptionUpdateDefaultAllowedUpdatesItemXa88ddcc9,
        ) {
