...
public sealed class InlineV1TaxCalculationsLineItemsGetResponse200JsonObjectValueX746a89cc {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1TaxCalculationsLineItemsGetResponse200JsonObjectValueX746a89cc =
            when (value) {
                List.value -> List
    ...
    public object Serializer : KSerializer<InlineV1TaxCalculationsLineItemsGetResponse200JsonObjectValueX746a89cc> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1TaxCalculationsLineItemsGetResponse200JsonObjectValueX746a89cc",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1TaxCalculationsLineItemsGetResponse200JsonObjectValueX746a89cc = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TaxCalculationsLineItemsGetResponse200JsonObjectValueX746a89cc,
        ) {
