...
public class DeletedTerminalConfiguration(
    ...
    public object Serializer : KSerializer<DeletedTerminalConfiguration> {
        ...
        override fun deserialize(decoder: Decoder): DeletedTerminalConfiguration {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("DeletedTerminalConfiguration must be a JSON object")
            val deleted = json.decodeRequired<Boolean>(rawObject, "deleted")
            val id = json.decodeRequired<String>(rawObject, "id")
            val objectValue =
                json.decodeRequired<InlineDeletedTerminalConfigurationObjectValueX91125db2>(
                    rawObject,
                    "object",
                )
            return DeletedTerminalConfiguration(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: DeletedTerminalConfiguration,
        ) {
...
public fun deletedTerminalConfiguration(
    block: DeletedTerminalConfiguration.Builder.() -> Unit,
): DeletedTerminalConfiguration = DeletedTerminalConfiguration.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException("DeletedTerminalConfiguration is missing required property '" + name + "'")
