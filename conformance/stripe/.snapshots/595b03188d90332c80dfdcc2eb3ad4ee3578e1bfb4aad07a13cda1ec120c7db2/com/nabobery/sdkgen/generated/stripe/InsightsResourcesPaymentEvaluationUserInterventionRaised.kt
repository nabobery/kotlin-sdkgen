...
public class InsightsResourcesPaymentEvaluationUserInterventionRaised(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InsightsResourcesPaymentEvaluationUserInterventionRaised =
    ...
    public object Serializer : KSerializer<InsightsResourcesPaymentEvaluationUserInterventionRaised> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InsightsResourcesPaymentEvaluationUserInterventionRaised must be a JSON object",
                    )
            val key = json.decodeRequired<String>(rawObject, "key")
            val type =
                json.decodeRequired<InlineInsightsResourcesPaymentEvaluationUserInterventionRaisedTypeXe03c7f0a>(
                    rawObject,
                    "type",
                )
            return InsightsResourcesPaymentEvaluationUserInterventionRaised(
                ...
                custom =
                    rawObject["custom"]?.let {
                        json.decodeFromJsonElement<InsightsResourcesPaymentEvaluationUserInterventionRaisedCustom>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InsightsResourcesPaymentEvaluationUserInterventionRaised,
        ) {
...
public fun insightsResourcesPaymentEvaluationUserInterventionRaised(
    block: InsightsResourcesPaymentEvaluationUserInterventionRaised.Builder.() -> Unit,
): InsightsResourcesPaymentEvaluationUserInterventionRaised =
    InsightsResourcesPaymentEvaluationUserInterventionRaised.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InsightsResourcesPaymentEvaluationUserInterventionRaised is missing required property '" + name + "'",
            )
