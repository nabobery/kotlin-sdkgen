...
public class InlineV1BillingPortalConfigurationsPostRequestFormXf0055dd4(
     ...
     */
    public val businessProfile: InlineV1BillingPortalConfigurationsPostRequestFormBusinessProfileX568fb2ea? = null,
    /**
     ...
     */
    public val defaultReturnUrl: InlineV1BillingPortalConfigurationsPostRequestFormDefaultReturnUrlX3d8ade07? = null,
    /**
     ...
     */
    public val loginPage: InlineV1BillingPortalConfigurationsPostRequestFormLoginPageX87537f05? = null,
    /**
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1BillingPortalConfigurationsPostRequestFormXf0055dd4 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1BillingPortalConfigurationsPostRequestFormXf0055dd4> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1BillingPortalConfigurationsPostRequestFormXf0055dd4 must be a JSON object",
                    )
            val features =
                json.decodeRequired<InlineV1BillingPortalConfigurationsPostRequestFormFeaturesXc522b9f7>(
                    rawObject,
                    "features",
                )
            return InlineV1BillingPortalConfigurationsPostRequestFormXf0055dd4(
                ...
                businessProfile =
                    rawObject["business_profile"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1BillingPortalConfigurationsPostRequestFormBusinessProfileX568fb2ea>(
                                it,
                            )
                    },
                defaultReturnUrl =
                    rawObject["default_return_url"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1BillingPortalConfigurationsPostRequestFormDefaultReturnUrlX3d8ade07>(
                                it,
                            )
                    },
                ...
                loginPage =
                    rawObject["login_page"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1BillingPortalConfigurationsPostRequestFormLoginPageX87537f05>(
                                it,
                            )
                    },
                ...
                name =
                    rawObject["name"]?.let {
                        json.decodeFromJsonElement<InlineV1BillingPortalConfigurationsPostRequestFormNameXc37497bf>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1BillingPortalConfigurationsPostRequestFormXf0055dd4,
        ) {
...
public fun inlineV1BillingPortalConfigurationsPostRequestFormXf0055dd4(
    block: InlineV1BillingPortalConfigurationsPostRequestFormXf0055dd4.Builder.() -> Unit,
): InlineV1BillingPortalConfigurationsPostRequestFormXf0055dd4 =
    InlineV1BillingPortalConfigurationsPostRequestFormXf0055dd4.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1BillingPortalConfigurationsPostRequestFormXf0055dd4 is missing required property '" + name +
                    "'",
            )
