...
public sealed class InlinePaymentsPrimitivesPa0ad7BrandX2897e15d {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentsPrimitivesPa0ad7BrandX2897e15d =
            when (value) {
                Amex.value -> Amex
    ...
    public object Serializer : KSerializer<InlinePaymentsPrimitivesPa0ad7BrandX2897e15d> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentsPrimitivesPa0ad7BrandX2897e15d",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePaymentsPrimitivesPa0ad7BrandX2897e15d =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentsPrimitivesPa0ad7BrandX2897e15d,
        ) {
