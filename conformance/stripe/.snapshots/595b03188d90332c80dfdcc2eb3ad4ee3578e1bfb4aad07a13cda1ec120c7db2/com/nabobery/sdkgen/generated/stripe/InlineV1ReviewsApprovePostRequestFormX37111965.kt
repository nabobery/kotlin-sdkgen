...
public class InlineV1ReviewsApprovePostRequestFormX37111965(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1ReviewsApprovePostRequestFormX37111965 =
            InlineV1ReviewsApprovePostRequestFormX37111965(
                expand = expand,
            )
    }

    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1ReviewsApprovePostRequestFormX37111965 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1ReviewsApprovePostRequestFormX37111965> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1ReviewsApprovePostRequestFormX37111965 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ReviewsApprovePostRequestFormX37111965,
        ) {
...
public fun inlineV1ReviewsApprovePostRequestFormX37111965(
    block: InlineV1ReviewsApprovePostRequestFormX37111965.Builder.() -> Unit,
): InlineV1ReviewsApprovePostRequestFormX37111965 = InlineV1ReviewsApprovePostRequestFormX37111965.build(block)
