...
internal data class InlineV1PaymentLinksPostRequestFormNameCollectionXc76d0ec6Inspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesInlineV1PaymentLinksPostRequestFormNameCollectionAnyOf1Xa592a179,
                matchesInlineV1PaymentLinksPostRequestFormNameCollectionAnyOf2X2d03bdba,
            ).count {
                it
            }
}
...
public class InlineV1PaymentLinksPostRequestFormNameCollectionXc76d0ec6 internal constructor(
    ...
    public val inlineV1PaymentLinksPostRequestFormNameCollectionAnyOf1Xa592a179:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1PaymentLinksPostRequestFormNameCollectionAnyOf1Xa592a179) {
                json
                    .decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormNameCollectionAnyOf1Xa592a179>(
                        raw,
                    )
            } else {
                null
    ...
    public val inlineV1PaymentLinksPostRequestFormNameCollectionAnyOf2X2d03bdba:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1PaymentLinksPostRequestFormNameCollectionAnyOf2X2d03bdba) {
                json
                    .decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormNameCollectionAnyOf2X2d03bdba>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1PaymentLinksPostRequestFormNameCollectionXc76d0ec6Branch>
        get() =
            buildSet {
                if (inspection.matchesInlineV1PaymentLinksPostRequestFormNameCollectionAnyOf1Xa592a179) {
                    add(
                        InlineV1PaymentLinksPostRequestFormNameCollectionXc76d0ec6Branch.InlineV1PaymentLinksPostRequestFormNameCollectionAnyOf1Xa592a179,
                    )
                }
                if (inspection.matchesInlineV1PaymentLinksPostRequestFormNameCollectionAnyOf2X2d03bdba) {
                    add(
                        InlineV1PaymentLinksPostRequestFormNameCollectionXc76d0ec6Branch.InlineV1PaymentLinksPostRequestFormNameCollectionAnyOf2X2d03bdba,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1PaymentLinksPostRequestFormNameCollectionXc76d0ec6 {
            val inspection = inspectInlineV1PaymentLinksPostRequestFormNameCollectionXc76d0ec6(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1PaymentLinksPostRequestFormNameCollectionXc76d0ec6NoMatchException(
                    "InlineV1PaymentLinksPostRequestFormNameCollectionXc76d0ec6 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1PaymentLinksPostRequestFormNameCollectionXc76d0ec6> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentLinksPostRequestFormNameCollectionXc76d0ec6,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1PaymentLinksPostRequestFormNameCollectionXc76d0ec6",
...
private fun inspectInlineV1PaymentLinksPostRequestFormNameCollectionXc76d0ec6(
    element: JsonElement,
): InlineV1PaymentLinksPostRequestFormNameCollectionXc76d0ec6Inspection {
    val matchesInlineV1PaymentLinksPostRequestFormNameCollectionAnyOf1Xa592a179 =
        element
            .isJsonDecodable<InlineV1PaymentLinksPostRequestFormNameCollectionAnyOf1Xa592a179>()
    val matchesInlineV1PaymentLinksPostRequestFormNameCollectionAnyOf2X2d03bdba =
        element
            .isJsonDecodable<InlineV1PaymentLinksPostRequestFormNameCollectionAnyOf2X2d03bdba>()
    return InlineV1PaymentLinksPostRequestFormNameCollectionXc76d0ec6Inspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1PaymentLinksPostRequestFormNameCollectionAnyOf1Xa592a179) {
                    add(
                        "InlineV1PaymentLinksPostRequestFormNameCollectionAnyOf1Xa592a179: value does not match InlineV1PaymentLinksPostRequestFormNameCollectionAnyOf1Xa592a179",
                    )
                }
                if (!matchesInlineV1PaymentLinksPostRequestFormNameCollectionAnyOf2X2d03bdba) {
                    add(
                        "InlineV1PaymentLinksPostRequestFormNameCollectionAnyOf2X2d03bdba: value does not match InlineV1PaymentLinksPostRequestFormNameCollectionAnyOf2X2d03bdba",
                    )
                }
            },
    )
