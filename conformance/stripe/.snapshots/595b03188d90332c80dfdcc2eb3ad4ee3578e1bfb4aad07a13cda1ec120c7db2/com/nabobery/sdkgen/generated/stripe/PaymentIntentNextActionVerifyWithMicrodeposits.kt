...
public class PaymentIntentNextActionVerifyWithMicrodeposits(
     ...
     */
    public val microdepositType: InlinePaymentIntentNextActionVerifyWithMicrodepositsMicrodepositTypeXbbf8eb5d? = null,
) {
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentIntentNextActionVerifyWithMicrodeposits =
    ...
    public object Serializer : KSerializer<PaymentIntentNextActionVerifyWithMicrodeposits> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "PaymentIntentNextActionVerifyWithMicrodeposits must be a JSON object",
                    )
                ...
                microdepositType =
                    rawObject["microdeposit_type"]?.let { element ->
                        if (element ==
                            ...
                            json
                                .decodeFromJsonElement<InlinePaymentIntentNextActionVerifyWithMicrodepositsMicrodepositTypeXbbf8eb5d?>(
                                    element,
                                )
                        }
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentIntentNextActionVerifyWithMicrodeposits,
        ) {
...
public fun paymentIntentNextActionVerifyWithMicrodeposits(
    block: PaymentIntentNextActionVerifyWithMicrodeposits.Builder.() -> Unit,
): PaymentIntentNextActionVerifyWithMicrodeposits = PaymentIntentNextActionVerifyWithMicrodeposits.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "PaymentIntentNextActionVerifyWithMicrodeposits is missing required property '" + name + "'",
            )
