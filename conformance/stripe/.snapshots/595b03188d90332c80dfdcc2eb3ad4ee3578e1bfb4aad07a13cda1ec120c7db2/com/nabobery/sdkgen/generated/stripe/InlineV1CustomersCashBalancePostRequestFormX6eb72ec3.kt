...
public class InlineV1CustomersCashBalancePostRequestFormX6eb72ec3(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1CustomersCashBalancePostRequestFormX6eb72ec3 =
            InlineV1CustomersCashBalancePostRequestFormX6eb72ec3(
                expand = expand,
                settings = settings,
            )
    }
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1CustomersCashBalancePostRequestFormX6eb72ec3 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1CustomersCashBalancePostRequestFormX6eb72ec3> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CustomersCashBalancePostRequestFormX6eb72ec3 must be a JSON object",
                    )
            return InlineV1CustomersCashBalancePostRequestFormX6eb72ec3(
                expand = rawObject["expand"]?.let { json.decodeFromJsonElement<List<String>>(it) },
                settings =
                    rawObject["settings"]?.let {
                        json.decodeFromJsonElement<InlineV1CustomersCashBalancePostRequestFormSettingsXb5781721>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersCashBalancePostRequestFormX6eb72ec3,
        ) {
...
public fun inlineV1CustomersCashBalancePostRequestFormX6eb72ec3(
    block: InlineV1CustomersCashBalancePostRequestFormX6eb72ec3.Builder.() -> Unit,
): InlineV1CustomersCashBalancePostRequestFormX6eb72ec3 =
    InlineV1CustomersCashBalancePostRequestFormX6eb72ec3.build(block)
