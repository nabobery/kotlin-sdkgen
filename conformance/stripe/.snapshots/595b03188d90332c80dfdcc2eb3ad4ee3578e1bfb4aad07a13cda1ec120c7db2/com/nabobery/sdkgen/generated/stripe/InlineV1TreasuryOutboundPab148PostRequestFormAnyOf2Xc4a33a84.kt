...
public sealed class InlineV1TreasuryOutboundPab148PostRequestFormAnyOf2Xc4a33a84 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1TreasuryOutboundPab148PostRequestFormAnyOf2Xc4a33a84 =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1TreasuryOutboundPab148PostRequestFormAnyOf2Xc4a33a84> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1TreasuryOutboundPab148PostRequestFormAnyOf2Xc4a33a84",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1TreasuryOutboundPab148PostRequestFormAnyOf2Xc4a33a84 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TreasuryOutboundPab148PostRequestFormAnyOf2Xc4a33a84,
        ) {
