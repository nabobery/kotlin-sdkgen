...
internal data class InlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextFooterTitleX04087b81Inspection(
    ...
    public val matchesInlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextAnyOf1AnyOf2X2712d240: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextAnyOf1AnyOf2X2712d240,
            ).count {
                it
            }
}
...
public class InlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextFooterTitleX04087b81 internal constructor(
    ...
    private val inspection: InlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextFooterTitleX04087b81Inspection,
) {
    ...
    public val inlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextAnyOf1AnyOf2X2712d240:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextAnyOf1AnyOf2X2712d240) {
                json
                    .decodeFromJsonElement<InlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextAnyOf1AnyOf2X2712d240>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextFooterTitleX04087b81Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextAnyOf1AnyOf2X2712d240) {
                    add(
                        InlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextFooterTitleX04087b81Branch.InlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextAnyOf1AnyOf2X2712d240,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextFooterTitleX04087b81 {
            val inspection = inspectInlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextFooterTitleX04087b81(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextFooterTitleX04087b81NoMatchException(
                    "InlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextFooterTitleX04087b81 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextFooterTitleX04087b81> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextFooterTitleX04087b81,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextFooterTitleX04087b81",
...
private fun inspectInlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextFooterTitleX04087b81(
    element: JsonElement,
): InlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextFooterTitleX04087b81Inspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextAnyOf1AnyOf2X2712d240 =
        element
            .isJsonDecodable<InlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextAnyOf1AnyOf2X2712d240>()
    return InlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextFooterTitleX04087b81Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextAnyOf1AnyOf2X2712d240) {
                    add(
                        "InlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextAnyOf1AnyOf2X2712d240: value does not match InlineV1IssuingPersonaliza87d0PostRequestFormCarrierTextAnyOf1AnyOf2X2712d240",
                    )
                }
            },
    )
