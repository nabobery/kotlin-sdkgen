...
public class InlineV1PaymentLinksPostRequestFormCustomFieldsItemX30e6a174(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PaymentLinksPostRequestFormCustomFieldsItemX30e6a174 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentLinksPostRequestFormCustomFieldsItemX30e6a174> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentLinksPostRequestFormCustomFieldsItemX30e6a174 must be a JSON object",
                    )
            val key = json.decodeRequired<String>(rawObject, "key")
            val label =
                json.decodeRequired<InlineV1PaymentLinksPostRequestFormCustomFieldsItemLabelX2e471dc2>(
                    rawObject,
                    "label",
                )
            val type =
                json.decodeRequired<InlineV1PaymentLinksPostRequestFormCustomFieldsItemTypeX307d86e8>(
                    rawObject,
                    "type",
                )
            return InlineV1PaymentLinksPostRequestFormCustomFieldsItemX30e6a174(
                ...
                dropdown =
                    rawObject["dropdown"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormCustomFieldsItemDropdownX347f2e2c>(
                                it,
                            )
                    },
                numeric =
                    rawObject["numeric"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormCustomFieldsItemNumericXb47f2ddd>(
                            it,
                        )
                    },
                ...
                text =
                    rawObject["text"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormCustomFieldsItemTextX81d62375>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentLinksPostRequestFormCustomFieldsItemX30e6a174,
        ) {
...
public fun inlineV1PaymentLinksPostRequestFormCustomFieldsItemX30e6a174(
    block: InlineV1PaymentLinksPostRequestFormCustomFieldsItemX30e6a174.Builder.() -> Unit,
): InlineV1PaymentLinksPostRequestFormCustomFieldsItemX30e6a174 =
    InlineV1PaymentLinksPostRequestFormCustomFieldsItemX30e6a174.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentLinksPostRequestFormCustomFieldsItemX30e6a174 is missing required property '" + name +
                    "'",
            )
