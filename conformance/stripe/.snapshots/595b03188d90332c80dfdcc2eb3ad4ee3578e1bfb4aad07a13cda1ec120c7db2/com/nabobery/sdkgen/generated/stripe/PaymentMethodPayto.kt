...
public class PaymentMethodPayto(
    ...
    public class Builder {
        ...
        public fun build(): PaymentMethodPayto =
            PaymentMethodPayto(
                bsbNumber = bsbNumber,
                last4 = last4,
                payId = payId,
    ...
    public object Serializer : KSerializer<PaymentMethodPayto> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodPayto {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodPayto must be a JSON object")
...
public fun paymentMethodPayto(block: PaymentMethodPayto.Builder.() -> Unit): PaymentMethodPayto =
    PaymentMethodPayto.build(block)
