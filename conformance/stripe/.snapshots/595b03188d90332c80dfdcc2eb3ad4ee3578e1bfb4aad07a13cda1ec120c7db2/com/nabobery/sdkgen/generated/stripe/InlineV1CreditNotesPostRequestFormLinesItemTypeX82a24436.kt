...
public sealed class InlineV1CreditNotesPostRequestFormLinesItemTypeX82a24436 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1CreditNotesPostRequestFormLinesItemTypeX82a24436 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1CreditNotesPostRequestFormLinesItemTypeX82a24436> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1CreditNotesPostRequestFormLinesItemTypeX82a24436",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1CreditNotesPostRequestFormLinesItemTypeX82a24436 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CreditNotesPostRequestFormLinesItemTypeX82a24436,
        ) {
