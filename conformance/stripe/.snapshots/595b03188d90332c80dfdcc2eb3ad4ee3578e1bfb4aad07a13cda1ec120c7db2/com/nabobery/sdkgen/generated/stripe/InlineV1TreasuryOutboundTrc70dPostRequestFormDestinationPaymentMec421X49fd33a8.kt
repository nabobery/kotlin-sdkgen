...
public class InlineV1TreasuryOutboundTrc70dPostRequestFormDestinationPaymentMec421X49fd33a8(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1TreasuryOutboundTrc70dPostRequestFormDestinationPaymentMec421X49fd33a8 =
    ...
    public object Serializer : KSerializer<InlineV1TreasuryOutboundTrc70dPostRequestFormDestinationPaymentMec421X49fd33a8> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TreasuryOutboundTrc70dPostRequestFormDestinationPaymentMec421X49fd33a8 must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineV1TreasuryOutboundTrc70dPostRequestFormTypeX63a048a1>(
                    rawObject,
                    "type",
                )
            return InlineV1TreasuryOutboundTrc70dPostRequestFormDestinationPaymentMec421X49fd33a8(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TreasuryOutboundTrc70dPostRequestFormDestinationPaymentMec421X49fd33a8,
        ) {
            val jsonEncoder =
...
public fun inlineV1TreasuryOutboundTrc70dPostRequestFormDestinationPaymentMec421X49fd33a8(
    block: InlineV1TreasuryOutboundTrc70dPostRequestFormDestinationPaymentMec421X49fd33a8.Builder.() -> Unit,
): InlineV1TreasuryOutboundTrc70dPostRequestFormDestinationPaymentMec421X49fd33a8 =
    InlineV1TreasuryOutboundTrc70dPostRequestFormDestinationPaymentMec421X49fd33a8.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TreasuryOutboundTrc70dPostRequestFormDestinationPaymentMec421X49fd33a8 is missing required property '" +
                    name +
                    "'",
            )
