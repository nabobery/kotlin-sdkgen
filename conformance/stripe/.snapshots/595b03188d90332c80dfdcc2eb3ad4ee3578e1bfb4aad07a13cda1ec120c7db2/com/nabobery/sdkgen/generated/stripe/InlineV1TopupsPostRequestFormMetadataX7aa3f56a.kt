...
public class InlineV1TopupsPostRequestFormMetadataX7aa3f56a internal constructor(
    ...
    public val inlineV1TopupsPostRequestFormMetadataAnyOf2X21f5a0e5:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1TopupsPostRequestFormMetadataAnyOf2X21f5a0e5) {
                json
                    .decodeFromJsonElement<InlineV1TopupsPostRequestFormMetadataAnyOf2X21f5a0e5>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1TopupsPostRequestFormMetadataX7aa3f56aBranch>
        get() =
            buildSet {
                ...
                if (inspection.matchesInlineV1TopupsPostRequestFormMetadataAnyOf2X21f5a0e5) {
                    add(
                        InlineV1TopupsPostRequestFormMetadataX7aa3f56aBranch.InlineV1TopupsPostRequestFormMetadataAnyOf2X21f5a0e5,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1TopupsPostRequestFormMetadataX7aa3f56a {
            val inspection = inspectInlineV1TopupsPostRequestFormMetadataX7aa3f56a(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1TopupsPostRequestFormMetadataX7aa3f56aNoMatchException(
                    "InlineV1TopupsPostRequestFormMetadataX7aa3f56a matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1TopupsPostRequestFormMetadataX7aa3f56a> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TopupsPostRequestFormMetadataX7aa3f56a,
        ) {
...
private fun inspectInlineV1TopupsPostRequestFormMetadataX7aa3f56a(
    element: JsonElement,
): InlineV1TopupsPostRequestFormMetadataX7aa3f56aInspection {
    val matchesBranch1 = element.isJsonDecodable<JsonObject>()
    val matchesInlineV1TopupsPostRequestFormMetadataAnyOf2X21f5a0e5 =
        element
            .isJsonDecodable<InlineV1TopupsPostRequestFormMetadataAnyOf2X21f5a0e5>()
    return InlineV1TopupsPostRequestFormMetadataX7aa3f56aInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1TopupsPostRequestFormMetadataAnyOf2X21f5a0e5) {
                    add(
                        "InlineV1TopupsPostRequestFormMetadataAnyOf2X21f5a0e5: value does not match InlineV1TopupsPostRequestFormMetadataAnyOf2X21f5a0e5",
                    )
                }
            },
    )
