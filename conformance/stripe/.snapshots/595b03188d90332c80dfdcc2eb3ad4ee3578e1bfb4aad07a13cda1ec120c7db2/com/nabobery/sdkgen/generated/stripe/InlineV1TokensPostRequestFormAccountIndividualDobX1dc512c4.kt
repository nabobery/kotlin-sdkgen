...
internal data class InlineV1TokensPostRequestFormAccountIndividualDobX1dc512c4Inspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesInlineV1TokensPostRequestFormAccountIndividualDobAnyOf1Xb9f24223,
                matchesInlineV1TokensPostRequestFormAccountIndividualDobAnyOf2X7f409b24,
            ).count {
                it
            }
}
...
public class InlineV1TokensPostRequestFormAccountIndividualDobX1dc512c4 internal constructor(
    ...
    public val inlineV1TokensPostRequestFormAccountIndividualDobAnyOf1Xb9f24223:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1TokensPostRequestFormAccountIndividualDobAnyOf1Xb9f24223) {
                json
                    .decodeFromJsonElement<InlineV1TokensPostRequestFormAccountIndividualDobAnyOf1Xb9f24223>(
                        raw,
                    )
            } else {
                null
    ...
    public val inlineV1TokensPostRequestFormAccountIndividualDobAnyOf2X7f409b24:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1TokensPostRequestFormAccountIndividualDobAnyOf2X7f409b24) {
                json
                    .decodeFromJsonElement<InlineV1TokensPostRequestFormAccountIndividualDobAnyOf2X7f409b24>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1TokensPostRequestFormAccountIndividualDobX1dc512c4Branch>
        get() =
            buildSet {
                if (inspection.matchesInlineV1TokensPostRequestFormAccountIndividualDobAnyOf1Xb9f24223) {
                    add(
                        InlineV1TokensPostRequestFormAccountIndividualDobX1dc512c4Branch.InlineV1TokensPostRequestFormAccountIndividualDobAnyOf1Xb9f24223,
                    )
                }
                if (inspection.matchesInlineV1TokensPostRequestFormAccountIndividualDobAnyOf2X7f409b24) {
                    add(
                        InlineV1TokensPostRequestFormAccountIndividualDobX1dc512c4Branch.InlineV1TokensPostRequestFormAccountIndividualDobAnyOf2X7f409b24,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1TokensPostRequestFormAccountIndividualDobX1dc512c4 {
            val inspection = inspectInlineV1TokensPostRequestFormAccountIndividualDobX1dc512c4(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1TokensPostRequestFormAccountIndividualDobX1dc512c4NoMatchException(
                    "InlineV1TokensPostRequestFormAccountIndividualDobX1dc512c4 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1TokensPostRequestFormAccountIndividualDobX1dc512c4> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TokensPostRequestFormAccountIndividualDobX1dc512c4,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1TokensPostRequestFormAccountIndividualDobX1dc512c4",
...
private fun inspectInlineV1TokensPostRequestFormAccountIndividualDobX1dc512c4(
    element: JsonElement,
): InlineV1TokensPostRequestFormAccountIndividualDobX1dc512c4Inspection {
    val matchesInlineV1TokensPostRequestFormAccountIndividualDobAnyOf1Xb9f24223 =
        element
            .isJsonDecodable<InlineV1TokensPostRequestFormAccountIndividualDobAnyOf1Xb9f24223>()
    val matchesInlineV1TokensPostRequestFormAccountIndividualDobAnyOf2X7f409b24 =
        element
            .isJsonDecodable<InlineV1TokensPostRequestFormAccountIndividualDobAnyOf2X7f409b24>()
    return InlineV1TokensPostRequestFormAccountIndividualDobX1dc512c4Inspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1TokensPostRequestFormAccountIndividualDobAnyOf1Xb9f24223) {
                    add(
                        "InlineV1TokensPostRequestFormAccountIndividualDobAnyOf1Xb9f24223: value does not match InlineV1TokensPostRequestFormAccountIndividualDobAnyOf1Xb9f24223",
                    )
                }
                if (!matchesInlineV1TokensPostRequestFormAccountIndividualDobAnyOf2X7f409b24) {
                    add(
                        "InlineV1TokensPostRequestFormAccountIndividualDobAnyOf2X7f409b24: value does not match InlineV1TokensPostRequestFormAccountIndividualDobAnyOf2X7f409b24",
                    )
                }
            },
    )
