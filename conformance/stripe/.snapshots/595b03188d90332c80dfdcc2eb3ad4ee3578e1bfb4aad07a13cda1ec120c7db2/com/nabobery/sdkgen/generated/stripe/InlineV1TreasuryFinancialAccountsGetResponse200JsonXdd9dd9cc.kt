...
public class InlineV1TreasuryFinancialAccountsGetResponse200JsonXdd9dd9cc(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TreasuryFinancialAccountsGetResponse200JsonXdd9dd9cc =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TreasuryFinancialAccountsGetResponse200JsonXdd9dd9cc> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1TreasuryFinancialAccountsGetResponse200JsonXdd9dd9cc {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TreasuryFinancialAccountsGetResponse200JsonXdd9dd9cc must be a JSON object",
                    )
            ...
            val objectValue =
                json.decodeRequired<InlineV1TreasuryFinancialAccountsGetResponse200JsonObjectValueXb1064f3f>(
                    rawObject,
                    "object",
                )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TreasuryFinancialAccountsGetResponse200JsonXdd9dd9cc,
        ) {
...
public fun inlineV1TreasuryFinancialAccountsGetResponse200JsonXdd9dd9cc(
    block: InlineV1TreasuryFinancialAccountsGetResponse200JsonXdd9dd9cc.Builder.() -> Unit,
): InlineV1TreasuryFinancialAccountsGetResponse200JsonXdd9dd9cc =
    InlineV1TreasuryFinancialAccountsGetResponse200JsonXdd9dd9cc.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TreasuryFinancialAccountsGetResponse200JsonXdd9dd9cc is missing required property '" + name +
                    "'",
            )
