...
public class PayoutsTraceId(
    ...
    public object Serializer : KSerializer<PayoutsTraceId> {
        ...
        override fun deserialize(decoder: Decoder): PayoutsTraceId {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PayoutsTraceId must be a JSON object")
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("PayoutsTraceId is missing required property '" + name + "'")
