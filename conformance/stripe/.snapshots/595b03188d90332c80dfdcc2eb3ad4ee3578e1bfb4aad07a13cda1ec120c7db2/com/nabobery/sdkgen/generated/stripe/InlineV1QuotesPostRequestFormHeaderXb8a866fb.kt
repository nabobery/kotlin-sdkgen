...
public class InlineV1QuotesPostRequestFormHeaderXb8a866fb internal constructor(
    ...
    public val inlineV1QuotesPostRequestFormHeaderAnyOf2X8440b9a4:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1QuotesPostRequestFormHeaderAnyOf2X8440b9a4) {
                json
                    .decodeFromJsonElement<InlineV1QuotesPostRequestFormHeaderAnyOf2X8440b9a4>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1QuotesPostRequestFormHeaderXb8a866fbBranch>
        get() =
            buildSet {
                ...
                if (inspection.matchesInlineV1QuotesPostRequestFormHeaderAnyOf2X8440b9a4) {
                    add(
                        InlineV1QuotesPostRequestFormHeaderXb8a866fbBranch.InlineV1QuotesPostRequestFormHeaderAnyOf2X8440b9a4,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1QuotesPostRequestFormHeaderXb8a866fb {
            val inspection = inspectInlineV1QuotesPostRequestFormHeaderXb8a866fb(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1QuotesPostRequestFormHeaderXb8a866fbNoMatchException(
                    "InlineV1QuotesPostRequestFormHeaderXb8a866fb matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1QuotesPostRequestFormHeaderXb8a866fb> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1QuotesPostRequestFormHeaderXb8a866fb,
        ) {
...
private fun inspectInlineV1QuotesPostRequestFormHeaderXb8a866fb(
    element: JsonElement,
): InlineV1QuotesPostRequestFormHeaderXb8a866fbInspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1QuotesPostRequestFormHeaderAnyOf2X8440b9a4 =
        element
            .isJsonDecodable<InlineV1QuotesPostRequestFormHeaderAnyOf2X8440b9a4>()
    return InlineV1QuotesPostRequestFormHeaderXb8a866fbInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1QuotesPostRequestFormHeaderAnyOf2X8440b9a4) {
                    add(
                        "InlineV1QuotesPostRequestFormHeaderAnyOf2X8440b9a4: value does not match InlineV1QuotesPostRequestFormHeaderAnyOf2X8440b9a4",
                    )
                }
            },
    )
