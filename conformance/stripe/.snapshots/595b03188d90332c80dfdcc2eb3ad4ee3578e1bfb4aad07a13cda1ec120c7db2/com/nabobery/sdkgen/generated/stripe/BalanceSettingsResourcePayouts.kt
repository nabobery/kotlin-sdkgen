...
@Serializable
public data class BalanceSettingsResourcePayoutsView(
    @SerialName("automatic_transfer_rules_by_currency")
    public val automaticTransferRulesByCurrency: Map<String, List<BalanceSettingsResourceAutomaticTransferRule>>? = null,
...
public class BalanceSettingsResourcePayouts(
    ...
    public class Builder {
         ...
         * payouts](/payouts/minimum-balances-for-automatic-payouts).
         */
        public var minimumBalanceByCurrency: Map<String, Int>? = null
    ...
    public object Serializer : KSerializer<BalanceSettingsResourcePayouts> {
        ...
        override fun deserialize(decoder: Decoder): BalanceSettingsResourcePayouts {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("BalanceSettingsResourcePayouts must be a JSON object")
            ...
            return BalanceSettingsResourcePayouts(
                ...
                automaticTransferRulesByCurrency =
                    rawObject["automatic_transfer_rules_by_currency"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                            ...
                            json
                                .decodeFromJsonElement<Map<String, List<BalanceSettingsResourceAutomaticTransferRule>>?>(
                                    element,
                                )
                        }
                    },
                minimumBalanceByCurrency =
                    rawObject["minimum_balance_by_currency"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                schedule =
                    rawObject["schedule"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineBalanceSettingsResourcePayoutsScheduleX201b5df2?>(element)
                        }
                    },
                statementDescriptor =
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: BalanceSettingsResourcePayouts,
        ) {
...
public fun balanceSettingsResourcePayouts(
    block: BalanceSettingsResourcePayouts.Builder.() -> Unit,
): BalanceSettingsResourcePayouts = BalanceSettingsResourcePayouts.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "BalanceSettingsResourcePayouts is missing required property '" + name + "'",
            )
