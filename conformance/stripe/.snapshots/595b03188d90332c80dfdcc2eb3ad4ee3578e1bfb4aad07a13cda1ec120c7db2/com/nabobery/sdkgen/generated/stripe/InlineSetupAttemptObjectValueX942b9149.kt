...
public sealed class InlineSetupAttemptObjectValueX942b9149 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineSetupAttemptObjectValueX942b9149 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineSetupAttemptObjectValueX942b9149> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineSetupAttemptObjectValueX942b9149",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineSetupAttemptObjectValueX942b9149 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineSetupAttemptObjectValueX942b9149,
        ) {
