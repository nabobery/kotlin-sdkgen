...
public sealed class InlineOutboundTransfersPaymentMethodDetailsUsBankAccountNetworkXd1e3ae2b {
    ...
    public object Serializer : KSerializer<InlineOutboundTransfersPaymentMethodDetailsUsBankAccountNetworkXd1e3ae2b> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineOutboundTransfersPaymentMethodDetailsUsBankAccountNetworkXd1e3ae2b",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineOutboundTransfersPaymentMethodDetailsUsBankAccountNetworkXd1e3ae2b = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineOutboundTransfersPaymentMethodDetailsUsBankAccountNetworkXd1e3ae2b,
        ) {
