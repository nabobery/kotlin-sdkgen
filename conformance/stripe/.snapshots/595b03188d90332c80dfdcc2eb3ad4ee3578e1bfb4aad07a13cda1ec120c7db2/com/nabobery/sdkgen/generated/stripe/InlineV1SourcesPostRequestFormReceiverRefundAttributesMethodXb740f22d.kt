...
public sealed class InlineV1SourcesPostRequestFormReceiverRefundAttributesMethodXb740f22d {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1SourcesPostRequestFormReceiverRefundAttributesMethodXb740f22d =
            when (value) {
                Email.value -> Email
                Manual.value -> Manual
                None.value -> None
    ...
    public object Serializer : KSerializer<InlineV1SourcesPostRequestFormReceiverRefundAttributesMethodXb740f22d> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1SourcesPostRequestFormReceiverRefundAttributesMethodXb740f22d",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1SourcesPostRequestFormReceiverRefundAttributesMethodXb740f22d = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SourcesPostRequestFormReceiverRefundAttributesMethodXb740f22d,
        ) {
