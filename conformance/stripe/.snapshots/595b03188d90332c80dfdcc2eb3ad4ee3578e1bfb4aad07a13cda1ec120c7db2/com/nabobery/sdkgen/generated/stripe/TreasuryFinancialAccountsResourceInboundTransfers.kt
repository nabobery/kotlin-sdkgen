...
public class TreasuryFinancialAccountsResourceInboundTransfers(
    ...
    public class Builder {
        ...
        public fun build(): TreasuryFinancialAccountsResourceInboundTransfers =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): TreasuryFinancialAccountsResourceInboundTransfers =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<TreasuryFinancialAccountsResourceInboundTransfers> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "TreasuryFinancialAccountsResourceInboundTransfers must be a JSON object",
                    )
            return TreasuryFinancialAccountsResourceInboundTransfers(
                ach =
                    rawObject["ach"]?.let {
                        json.decodeFromJsonElement<TreasuryFinancialAccountsResourceInboundAchToggleSettings>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: TreasuryFinancialAccountsResourceInboundTransfers,
        ) {
...
public fun treasuryFinancialAccountsResourceInboundTransfers(
    block: TreasuryFinancialAccountsResourceInboundTransfers.Builder.() -> Unit,
): TreasuryFinancialAccountsResourceInboundTransfers = TreasuryFinancialAccountsResourceInboundTransfers.build(block)
