...
public sealed class InlineV1PromotionCodesPostRequestFormPromotionTypeXb7e5197c {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1PromotionCodesPostRequestFormPromotionTypeXb7e5197c =
            when (value) {
                Coupon.value -> Coupon
    ...
    public object Serializer : KSerializer<InlineV1PromotionCodesPostRequestFormPromotionTypeXb7e5197c> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1PromotionCodesPostRequestFormPromotionTypeXb7e5197c",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1PromotionCodesPostRequestFormPromotionTypeXb7e5197c =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PromotionCodesPostRequestFormPromotionTypeXb7e5197c,
        ) {
