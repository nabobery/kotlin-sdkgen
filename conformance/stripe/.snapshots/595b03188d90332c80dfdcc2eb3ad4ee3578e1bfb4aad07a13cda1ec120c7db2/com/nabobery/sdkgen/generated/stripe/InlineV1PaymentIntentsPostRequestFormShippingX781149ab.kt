...
internal data class InlineV1PaymentIntentsPostRequestFormShippingX781149abInspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesInlineV1PaymentIntentsPostRequestFormShippingAnyOf1X16d9814d,
                matchesInlineV1PaymentIntentsPostRequestFormShippingAnyOf2X0bafd7fa,
            ).count {
                it
            }
}
...
public class InlineV1PaymentIntentsPostRequestFormShippingX781149ab internal constructor(
    ...
    public val inlineV1PaymentIntentsPostRequestFormShippingAnyOf1X16d9814d:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1PaymentIntentsPostRequestFormShippingAnyOf1X16d9814d) {
                json
                    .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormShippingAnyOf1X16d9814d>(
                        raw,
                    )
            } else {
                null
    ...
    public val inlineV1PaymentIntentsPostRequestFormShippingAnyOf2X0bafd7fa:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1PaymentIntentsPostRequestFormShippingAnyOf2X0bafd7fa) {
                json
                    .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormShippingAnyOf2X0bafd7fa>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1PaymentIntentsPostRequestFormShippingX781149abBranch>
        get() =
            buildSet {
                if (inspection.matchesInlineV1PaymentIntentsPostRequestFormShippingAnyOf1X16d9814d) {
                    add(
                        InlineV1PaymentIntentsPostRequestFormShippingX781149abBranch.InlineV1PaymentIntentsPostRequestFormShippingAnyOf1X16d9814d,
                    )
                }
                if (inspection.matchesInlineV1PaymentIntentsPostRequestFormShippingAnyOf2X0bafd7fa) {
                    add(
                        InlineV1PaymentIntentsPostRequestFormShippingX781149abBranch.InlineV1PaymentIntentsPostRequestFormShippingAnyOf2X0bafd7fa,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1PaymentIntentsPostRequestFormShippingX781149ab {
            val inspection = inspectInlineV1PaymentIntentsPostRequestFormShippingX781149ab(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1PaymentIntentsPostRequestFormShippingX781149abNoMatchException(
                    "InlineV1PaymentIntentsPostRequestFormShippingX781149ab matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormShippingX781149ab> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormShippingX781149ab,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1PaymentIntentsPostRequestFormShippingX781149ab",
...
private fun inspectInlineV1PaymentIntentsPostRequestFormShippingX781149ab(
    element: JsonElement,
): InlineV1PaymentIntentsPostRequestFormShippingX781149abInspection {
    val matchesInlineV1PaymentIntentsPostRequestFormShippingAnyOf1X16d9814d =
        element
            .isJsonDecodable<InlineV1PaymentIntentsPostRequestFormShippingAnyOf1X16d9814d>()
    val matchesInlineV1PaymentIntentsPostRequestFormShippingAnyOf2X0bafd7fa =
        element
            .isJsonDecodable<InlineV1PaymentIntentsPostRequestFormShippingAnyOf2X0bafd7fa>()
    return InlineV1PaymentIntentsPostRequestFormShippingX781149abInspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1PaymentIntentsPostRequestFormShippingAnyOf1X16d9814d) {
                    add(
                        "InlineV1PaymentIntentsPostRequestFormShippingAnyOf1X16d9814d: value does not match InlineV1PaymentIntentsPostRequestFormShippingAnyOf1X16d9814d",
                    )
                }
                if (!matchesInlineV1PaymentIntentsPostRequestFormShippingAnyOf2X0bafd7fa) {
                    add(
                        "InlineV1PaymentIntentsPostRequestFormShippingAnyOf2X0bafd7fa: value does not match InlineV1PaymentIntentsPostRequestFormShippingAnyOf2X0bafd7fa",
                    )
                }
            },
    )
