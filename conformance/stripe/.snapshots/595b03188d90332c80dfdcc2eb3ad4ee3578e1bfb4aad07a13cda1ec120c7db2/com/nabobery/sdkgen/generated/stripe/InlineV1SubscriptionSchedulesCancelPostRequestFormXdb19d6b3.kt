...
public class InlineV1SubscriptionSchedulesCancelPostRequestFormXdb19d6b3(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1SubscriptionSchedulesCancelPostRequestFormXdb19d6b3 =
            InlineV1SubscriptionSchedulesCancelPostRequestFormXdb19d6b3(
                expand = expand,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1SubscriptionSchedulesCancelPostRequestFormXdb19d6b3 =
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionSchedulesCancelPostRequestFormXdb19d6b3> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SubscriptionSchedulesCancelPostRequestFormXdb19d6b3 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionSchedulesCancelPostRequestFormXdb19d6b3,
        ) {
...
public fun inlineV1SubscriptionSchedulesCancelPostRequestFormXdb19d6b3(
    block: InlineV1SubscriptionSchedulesCancelPostRequestFormXdb19d6b3.Builder.() -> Unit,
): InlineV1SubscriptionSchedulesCancelPostRequestFormXdb19d6b3 =
    InlineV1SubscriptionSchedulesCancelPostRequestFormXdb19d6b3.build(block)
