...
public class SigmaScheduledQueryRunError(
    ...
    public object Serializer : KSerializer<SigmaScheduledQueryRunError> {
        ...
        override fun deserialize(decoder: Decoder): SigmaScheduledQueryRunError {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("SigmaScheduledQueryRunError must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: SigmaScheduledQueryRunError,
        ) {
...
public fun sigmaScheduledQueryRunError(
    block: SigmaScheduledQueryRunError.Builder.() -> Unit,
): SigmaScheduledQueryRunError = SigmaScheduledQueryRunError.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException("SigmaScheduledQueryRunError is missing required property '" + name + "'")
