...
public class CheckoutUpiPaymentMethodOptions(
     ...
     */
    public val setupFutureUsage: InlineCheckoutUpiPaymentMethodOptionsSetupFutureUsageX58198e2e? = null,
) {
    public class Builder {
        ...
        public fun build(): CheckoutUpiPaymentMethodOptions =
    ...
    public object Serializer : KSerializer<CheckoutUpiPaymentMethodOptions> {
        ...
        override fun deserialize(decoder: Decoder): CheckoutUpiPaymentMethodOptions {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("CheckoutUpiPaymentMethodOptions must be a JSON object")
            return CheckoutUpiPaymentMethodOptions(
                mandateOptions =
                    rawObject["mandate_options"]?.let {
                        json.decodeFromJsonElement<MandateOptionsUpi>(
                            it,
                        )
                    },
                setupFutureUsage =
                    rawObject["setup_future_usage"]?.let {
                        json.decodeFromJsonElement<InlineCheckoutUpiPaymentMethodOptionsSetupFutureUsageX58198e2e>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: CheckoutUpiPaymentMethodOptions,
        ) {
...
public fun checkoutUpiPaymentMethodOptions(
    block: CheckoutUpiPaymentMethodOptions.Builder.() -> Unit,
): CheckoutUpiPaymentMethodOptions = CheckoutUpiPaymentMethodOptions.build(block)
