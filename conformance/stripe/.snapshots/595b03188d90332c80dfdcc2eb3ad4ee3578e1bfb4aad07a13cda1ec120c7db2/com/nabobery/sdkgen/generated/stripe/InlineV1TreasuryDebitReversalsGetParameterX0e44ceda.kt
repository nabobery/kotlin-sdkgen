...
public sealed class InlineV1TreasuryDebitReversalsGetParameterX0e44ceda {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1TreasuryDebitReversalsGetParameterX0e44ceda =
            when (value) {
                Lost.value -> Lost
                Won.value -> Won
    ...
    public object Serializer : KSerializer<InlineV1TreasuryDebitReversalsGetParameterX0e44ceda> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1TreasuryDebitReversalsGetParameterX0e44ceda",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1TreasuryDebitReversalsGetParameterX0e44ceda =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TreasuryDebitReversalsGetParameterX0e44ceda,
        ) {
