...
internal data class InlineV1IssuingAuthorizationsApprovePostRequestFormMetadataXbd7902bfInspection(
    ...
    public val matchesInlineV1IssuingAuthorizationsApprovePostRequestFormMetadataAnyOf2Xa79e56fa: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1IssuingAuthorizationsApprovePostRequestFormMetadataAnyOf2Xa79e56fa,
            ).count {
                it
            }
}
...
public class InlineV1IssuingAuthorizationsApprovePostRequestFormMetadataXbd7902bf internal constructor(
    ...
    private val inspection: InlineV1IssuingAuthorizationsApprovePostRequestFormMetadataXbd7902bfInspection,
) {
    ...
    public val inlineV1IssuingAuthorizationsApprovePostRequestFormMetadataAnyOf2Xa79e56fa:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1IssuingAuthorizationsApprovePostRequestFormMetadataAnyOf2Xa79e56fa) {
                json
                    .decodeFromJsonElement<InlineV1IssuingAuthorizationsApprovePostRequestFormMetadataAnyOf2Xa79e56fa>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1IssuingAuthorizationsApprovePostRequestFormMetadataXbd7902bfBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1IssuingAuthorizationsApprovePostRequestFormMetadataAnyOf2Xa79e56fa) {
                    add(
                        InlineV1IssuingAuthorizationsApprovePostRequestFormMetadataXbd7902bfBranch.InlineV1IssuingAuthorizationsApprovePostRequestFormMetadataAnyOf2Xa79e56fa,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1IssuingAuthorizationsApprovePostRequestFormMetadataXbd7902bf {
            val inspection = inspectInlineV1IssuingAuthorizationsApprovePostRequestFormMetadataXbd7902bf(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1IssuingAuthorizationsApprovePostRequestFormMetadataXbd7902bfNoMatchException(
                    "InlineV1IssuingAuthorizationsApprovePostRequestFormMetadataXbd7902bf matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1IssuingAuthorizationsApprovePostRequestFormMetadataXbd7902bf> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingAuthorizationsApprovePostRequestFormMetadataXbd7902bf,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1IssuingAuthorizationsApprovePostRequestFormMetadataXbd7902bf",
...
private fun inspectInlineV1IssuingAuthorizationsApprovePostRequestFormMetadataXbd7902bf(
    element: JsonElement,
): InlineV1IssuingAuthorizationsApprovePostRequestFormMetadataXbd7902bfInspection {
    val matchesBranch1 = element.isJsonDecodable<JsonObject>()
    val matchesInlineV1IssuingAuthorizationsApprovePostRequestFormMetadataAnyOf2Xa79e56fa =
        element
            .isJsonDecodable<InlineV1IssuingAuthorizationsApprovePostRequestFormMetadataAnyOf2Xa79e56fa>()
    return InlineV1IssuingAuthorizationsApprovePostRequestFormMetadataXbd7902bfInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1IssuingAuthorizationsApprovePostRequestFormMetadataAnyOf2Xa79e56fa) {
                    add(
                        "InlineV1IssuingAuthorizationsApprovePostRequestFormMetadataAnyOf2Xa79e56fa: value does not match InlineV1IssuingAuthorizationsApprovePostRequestFormMetadataAnyOf2Xa79e56fa",
                    )
                }
            },
    )
