...
public class InlineV1SetupIntentsConfirmPostRequestFormMandateOptionsXfd7824f6(
    ...
    public val amountIncludesIof: InlineV1SetupIntentsConfirmPostRequestFormAmountIncludesIofX5589d8f2? = null,
    ...
    public val paymentSchedule: InlineV1SetupIntentsConfirmPostRequestFormPaymentScheduleX5ee9385c? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1SetupIntentsConfirmPostRequestFormMandateOptionsXfd7824f6 =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1SetupIntentsConfirmPostRequestFormMandateOptionsXfd7824f6 =
    ...
    public object Serializer : KSerializer<InlineV1SetupIntentsConfirmPostRequestFormMandateOptionsXfd7824f6> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SetupIntentsConfirmPostRequestFormMandateOptionsXfd7824f6 must be a JSON object",
                    )
            return InlineV1SetupIntentsConfirmPostRequestFormMandateOptionsXfd7824f6(
                ...
                amountIncludesIof =
                    rawObject["amount_includes_iof"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SetupIntentsConfirmPostRequestFormAmountIncludesIofX5589d8f2>(
                                it,
                            )
                    },
                amountType =
                    rawObject["amount_type"]?.let {
                        json.decodeFromJsonElement<InlineV1SetupIntentsConfirmPostRequestFormAmountTypeXec86dd68>(it)
                    },
                ...
                paymentSchedule =
                    rawObject["payment_schedule"]?.let {
                        json.decodeFromJsonElement<InlineV1SetupIntentsConfirmPostRequestFormPaymentScheduleX5ee9385c>(
                            it,
                        )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SetupIntentsConfirmPostRequestFormMandateOptionsXfd7824f6,
        ) {
            val jsonEncoder =
...
public fun inlineV1SetupIntentsConfirmPostRequestFormMandateOptionsXfd7824f6(
    block: InlineV1SetupIntentsConfirmPostRequestFormMandateOptionsXfd7824f6.Builder.() -> Unit,
): InlineV1SetupIntentsConfirmPostRequestFormMandateOptionsXfd7824f6 =
    InlineV1SetupIntentsConfirmPostRequestFormMandateOptionsXfd7824f6.build(block)
