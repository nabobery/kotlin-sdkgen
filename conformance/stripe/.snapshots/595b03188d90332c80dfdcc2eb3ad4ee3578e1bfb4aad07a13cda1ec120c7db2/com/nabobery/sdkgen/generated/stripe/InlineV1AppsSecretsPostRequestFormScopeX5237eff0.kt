...
public class InlineV1AppsSecretsPostRequestFormScopeX5237eff0(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1AppsSecretsPostRequestFormScopeX5237eff0 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1AppsSecretsPostRequestFormScopeX5237eff0> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AppsSecretsPostRequestFormScopeX5237eff0 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AppsSecretsPostRequestFormScopeX5237eff0,
        ) {
...
public fun inlineV1AppsSecretsPostRequestFormScopeX5237eff0(
    block: InlineV1AppsSecretsPostRequestFormScopeX5237eff0.Builder.() -> Unit,
): InlineV1AppsSecretsPostRequestFormScopeX5237eff0 = InlineV1AppsSecretsPostRequestFormScopeX5237eff0.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1AppsSecretsPostRequestFormScopeX5237eff0 is missing required property '" + name + "'",
            )
