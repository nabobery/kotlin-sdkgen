...
public class InlineV1InvoicesAddLinesPostRequestFormLinesItemTaxAmountsAnyOf1ItemX7f5b2e72(
    ...
    public val taxRateData: InlineV1InvoicesAddLinesPostRequestFormLinesItemTaxAmountsTaxRateDataXf12f9150,
    public val taxableAmount: Int,
    public val taxabilityReason: InlineV1InvoicesAddLinesPostRequestFormLinesItemTaxabilityReasonX3cc94160? = null,
) {
    ...
    public object Serializer : KSerializer<InlineV1InvoicesAddLinesPostRequestFormLinesItemTaxAmountsAnyOf1ItemX7f5b2e72> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1InvoicesAddLinesPostRequestFormLinesItemTaxAmountsAnyOf1ItemX7f5b2e72 must be a JSON object",
                    )
            val amount = json.decodeRequired<Int>(rawObject, "amount")
            val taxRateData =
                json
                    .decodeRequired<InlineV1InvoicesAddLinesPostRequestFormLinesItemTaxAmountsTaxRateDataXf12f9150>(
                        rawObject,
                        "tax_rate_data",
                    )
            ...
            return InlineV1InvoicesAddLinesPostRequestFormLinesItemTaxAmountsAnyOf1ItemX7f5b2e72(
                ...
                taxabilityReason =
                    rawObject["taxability_reason"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1InvoicesAddLinesPostRequestFormLinesItemTaxabilityReasonX3cc94160>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesAddLinesPostRequestFormLinesItemTaxAmountsAnyOf1ItemX7f5b2e72,
        ) {
            val jsonEncoder =
...
public fun inlineV1InvoicesAddLinesPostRequestFormLinesItemTaxAmountsAnyOf1ItemX7f5b2e72(
    block: InlineV1InvoicesAddLinesPostRequestFormLinesItemTaxAmountsAnyOf1ItemX7f5b2e72.Builder.() -> Unit,
): InlineV1InvoicesAddLinesPostRequestFormLinesItemTaxAmountsAnyOf1ItemX7f5b2e72 =
    InlineV1InvoicesAddLinesPostRequestFormLinesItemTaxAmountsAnyOf1ItemX7f5b2e72.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1InvoicesAddLinesPostRequestFormLinesItemTaxAmountsAnyOf1ItemX7f5b2e72 is missing required property '" +
                    name +
                    "'",
            )
