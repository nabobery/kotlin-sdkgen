...
public class InlineV1PaymentMethodConfigurationsPostRequestFormZipDisplayPreferenceX0b820848(
    public val preference: InlineV1PaymentMethodConfidc49PostRequestFormZipPreferenceXcc4657de? = null,
) {
    public class Builder {
        public var preference: InlineV1PaymentMethodConfidc49PostRequestFormZipPreferenceXcc4657de? =
            null

        public fun build(): InlineV1PaymentMethodConfigurationsPostRequestFormZipDisplayPreferenceX0b820848 =
            InlineV1PaymentMethodConfigurationsPostRequestFormZipDisplayPreferenceX0b820848(
    ...
    public object Serializer : KSerializer<InlineV1PaymentMethodConfigurationsPostRequestFormZipDisplayPreferenceX0b820848> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentMethodConfigurationsPostRequestFormZipDisplayPreferenceX0b820848 must be a JSON object",
                    )
            return InlineV1PaymentMethodConfigurationsPostRequestFormZipDisplayPreferenceX0b820848(
                preference =
                    rawObject["preference"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentMethodConfidc49PostRequestFormZipPreferenceXcc4657de>(
                            it,
                        )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentMethodConfigurationsPostRequestFormZipDisplayPreferenceX0b820848,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentMethodConfigurationsPostRequestFormZipDisplayPreferenceX0b820848(
    block: InlineV1PaymentMethodConfigurationsPostRequestFormZipDisplayPreferenceX0b820848.Builder.() -> Unit,
): InlineV1PaymentMethodConfigurationsPostRequestFormZipDisplayPreferenceX0b820848 =
    InlineV1PaymentMethodConfigurationsPostRequestFormZipDisplayPreferenceX0b820848.build(block)
