...
public class TaxProductResourceShipFromDetails(
    ...
    public object Serializer : KSerializer<TaxProductResourceShipFromDetails> {
        ...
        override fun deserialize(decoder: Decoder): TaxProductResourceShipFromDetails {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("TaxProductResourceShipFromDetails must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: TaxProductResourceShipFromDetails,
        ) {
...
public fun taxProductResourceShipFromDetails(
    block: TaxProductResourceShipFromDetails.Builder.() -> Unit,
): TaxProductResourceShipFromDetails = TaxProductResourceShipFromDetails.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "TaxProductResourceShipFromDetails is missing required property '" + name + "'",
            )
