...
public sealed class InlineForwardingRequestReplacementsItemXe1b219c9 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineForwardingRequestReplacementsItemXe1b219c9 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineForwardingRequestReplacementsItemXe1b219c9> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineForwardingRequestReplacementsItemXe1b219c9",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineForwardingRequestReplacementsItemXe1b219c9 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineForwardingRequestReplacementsItemXe1b219c9,
        ) {
