...
public class InlineV1CustomersSubscriptionsPostRequestFormAnyOf1Xe0d3f90e(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1CustomersSubscriptionsPostRequestFormAnyOf1Xe0d3f90e =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1CustomersSubscriptionsPostRequestFormAnyOf1Xe0d3f90e> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CustomersSubscriptionsPostRequestFormAnyOf1Xe0d3f90e must be a JSON object",
                    )
            val interval =
                json.decodeRequired<InlineV1CustomersSubscriptionsPostRequestFormIntervalX6333e3ae>(
                    rawObject,
                    "interval",
                )
            return InlineV1CustomersSubscriptionsPostRequestFormAnyOf1Xe0d3f90e(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersSubscriptionsPostRequestFormAnyOf1Xe0d3f90e,
        ) {
...
public fun inlineV1CustomersSubscriptionsPostRequestFormAnyOf1Xe0d3f90e(
    block: InlineV1CustomersSubscriptionsPostRequestFormAnyOf1Xe0d3f90e.Builder.() -> Unit,
): InlineV1CustomersSubscriptionsPostRequestFormAnyOf1Xe0d3f90e =
    InlineV1CustomersSubscriptionsPostRequestFormAnyOf1Xe0d3f90e.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1CustomersSubscriptionsPostRequestFormAnyOf1Xe0d3f90e is missing required property '" + name +
                    "'",
            )
