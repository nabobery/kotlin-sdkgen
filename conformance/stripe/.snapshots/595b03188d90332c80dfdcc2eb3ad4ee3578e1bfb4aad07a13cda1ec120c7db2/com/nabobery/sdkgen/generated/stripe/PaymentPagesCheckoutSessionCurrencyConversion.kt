...
public class PaymentPagesCheckoutSessionCurrencyConversion(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentPagesCheckoutSessionCurrencyConversion =
    ...
    public object Serializer : KSerializer<PaymentPagesCheckoutSessionCurrencyConversion> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "PaymentPagesCheckoutSessionCurrencyConversion must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentPagesCheckoutSessionCurrencyConversion,
        ) {
...
public fun paymentPagesCheckoutSessionCurrencyConversion(
    block: PaymentPagesCheckoutSessionCurrencyConversion.Builder.() -> Unit,
): PaymentPagesCheckoutSessionCurrencyConversion = PaymentPagesCheckoutSessionCurrencyConversion.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "PaymentPagesCheckoutSessionCurrencyConversion is missing required property '" + name + "'",
            )
