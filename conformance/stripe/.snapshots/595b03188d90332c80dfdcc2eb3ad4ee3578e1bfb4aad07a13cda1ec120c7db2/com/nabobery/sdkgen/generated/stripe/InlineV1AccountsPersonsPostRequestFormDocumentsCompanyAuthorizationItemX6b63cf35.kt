...
internal data class InlineV1AccountsPersonsPostRequestFormDocumentsCompanyAuthorizationItemX6b63cf35Inspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1AccountsPersonsPostRequestFormDocumentsAnyOf2Xdc664011,
            ).count { it }
}
...
public class InlineV1AccountsPersonsPostRequestFormDocumentsCompanyAuthorizationItemX6b63cf35 internal constructor(
    ...
    private val inspection: InlineV1AccountsPersonsPostRequestFormDocumentsCompanyAuthorizationItemX6b63cf35Inspection,
) {
    ...
    public val inlineV1AccountsPersonsPostRequestFormDocumentsAnyOf2Xdc664011:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1AccountsPersonsPostRequestFormDocumentsAnyOf2Xdc664011) {
                json
                    .decodeFromJsonElement<InlineV1AccountsPersonsPostRequestFormDocumentsAnyOf2Xdc664011>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1AccountsPersonsPostRequestFormDocumentsCompanyAuthorizationItemX6b63cf35Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1AccountsPersonsPostRequestFormDocumentsAnyOf2Xdc664011) {
                    add(
                        InlineV1AccountsPersonsPostRequestFormDocumentsCompanyAuthorizationItemX6b63cf35Branch.InlineV1AccountsPersonsPostRequestFormDocumentsAnyOf2Xdc664011,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1AccountsPersonsPostRequestFormDocumentsCompanyAuthorizationItemX6b63cf35 {
            val inspection =
                inspectInlineV1AccountsPersonsPostRequestFormDocumentsCompanyAuthorizationItemX6b63cf35(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1AccountsPersonsPostRequestFormDocumentsCompanyAuthorizationItemX6b63cf35NoMatchException(
                    "InlineV1AccountsPersonsPostRequestFormDocumentsCompanyAuthorizationItemX6b63cf35 matched 0 branches: " +
                        inspection.failures.joinToString("; "),
                )
            }
            return InlineV1AccountsPersonsPostRequestFormDocumentsCompanyAuthorizationItemX6b63cf35(
                raw,
                json,
                inspection,
            )
    ...
    public object Serializer : KSerializer<InlineV1AccountsPersonsPostRequestFormDocumentsCompanyAuthorizationItemX6b63cf35> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPersonsPostRequestFormDocumentsCompanyAuthorizationItemX6b63cf35,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1AccountsPersonsPostRequestFormDocumentsCompanyAuthorizationItemX6b63cf35",
...
private fun inspectInlineV1AccountsPersonsPostRequestFormDocumentsCompanyAuthorizationItemX6b63cf35(
    element: JsonElement,
): InlineV1AccountsPersonsPostRequestFormDocumentsCompanyAuthorizationItemX6b63cf35Inspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1AccountsPersonsPostRequestFormDocumentsAnyOf2Xdc664011 =
        element
            .isJsonDecodable<InlineV1AccountsPersonsPostRequestFormDocumentsAnyOf2Xdc664011>()
    return InlineV1AccountsPersonsPostRequestFormDocumentsCompanyAuthorizationItemX6b63cf35Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1AccountsPersonsPostRequestFormDocumentsAnyOf2Xdc664011) {
                    add(
                        "InlineV1AccountsPersonsPostRequestFormDocumentsAnyOf2Xdc664011: value does not match InlineV1AccountsPersonsPostRequestFormDocumentsAnyOf2Xdc664011",
                    )
                }
            },
    )
