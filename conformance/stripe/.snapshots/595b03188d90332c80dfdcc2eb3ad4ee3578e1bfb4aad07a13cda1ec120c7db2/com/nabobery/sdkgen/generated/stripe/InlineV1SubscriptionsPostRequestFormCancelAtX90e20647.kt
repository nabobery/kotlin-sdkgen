...
public class InlineV1SubscriptionsPostRequestFormCancelAtX90e20647 internal constructor(
    ...
    public val inlineV1SubscriptionsPostRequestFormCancelAtAnyOf2X5949f271:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1SubscriptionsPostRequestFormCancelAtAnyOf2X5949f271) {
                json
                    .decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormCancelAtAnyOf2X5949f271>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1SubscriptionsPostRequestFormCancelAtX90e20647Branch>
        get() =
            buildSet {
                ...
                if (inspection.matchesInlineV1SubscriptionsPostRequestFormCancelAtAnyOf2X5949f271) {
                    add(
                        InlineV1SubscriptionsPostRequestFormCancelAtX90e20647Branch.InlineV1SubscriptionsPostRequestFormCancelAtAnyOf2X5949f271,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1SubscriptionsPostRequestFormCancelAtX90e20647 {
            val inspection = inspectInlineV1SubscriptionsPostRequestFormCancelAtX90e20647(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1SubscriptionsPostRequestFormCancelAtX90e20647NoMatchException(
                    "InlineV1SubscriptionsPostRequestFormCancelAtX90e20647 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionsPostRequestFormCancelAtX90e20647> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsPostRequestFormCancelAtX90e20647,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1SubscriptionsPostRequestFormCancelAtX90e20647",
...
private fun inspectInlineV1SubscriptionsPostRequestFormCancelAtX90e20647(
    element: JsonElement,
): InlineV1SubscriptionsPostRequestFormCancelAtX90e20647Inspection {
    val matchesBranch1 = element.isJsonDecodable<Int>()
    val matchesInlineV1SubscriptionsPostRequestFormCancelAtAnyOf2X5949f271 =
        element
            .isJsonDecodable<InlineV1SubscriptionsPostRequestFormCancelAtAnyOf2X5949f271>()
    return InlineV1SubscriptionsPostRequestFormCancelAtX90e20647Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1SubscriptionsPostRequestFormCancelAtAnyOf2X5949f271) {
                    add(
                        "InlineV1SubscriptionsPostRequestFormCancelAtAnyOf2X5949f271: value does not match InlineV1SubscriptionsPostRequestFormCancelAtAnyOf2X5949f271",
                    )
                }
            },
    )
