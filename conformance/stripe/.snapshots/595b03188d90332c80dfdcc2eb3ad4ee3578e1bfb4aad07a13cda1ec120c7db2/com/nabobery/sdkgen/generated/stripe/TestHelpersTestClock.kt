...
public class TestHelpersTestClock(
    ...
    public object Serializer : KSerializer<TestHelpersTestClock> {
        ...
        override fun deserialize(decoder: Decoder): TestHelpersTestClock {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("TestHelpersTestClock must be a JSON object")
            ...
            val statusDetails =
                json.decodeRequired<BillingClocksResourceStatusDetailsStatusDetails>(
                    rawObject,
                    "status_details",
                )
            return TestHelpersTestClock(
...
public fun testHelpersTestClock(block: TestHelpersTestClock.Builder.() -> Unit): TestHelpersTestClock =
    TestHelpersTestClock.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("TestHelpersTestClock is missing required property '" + name + "'")
