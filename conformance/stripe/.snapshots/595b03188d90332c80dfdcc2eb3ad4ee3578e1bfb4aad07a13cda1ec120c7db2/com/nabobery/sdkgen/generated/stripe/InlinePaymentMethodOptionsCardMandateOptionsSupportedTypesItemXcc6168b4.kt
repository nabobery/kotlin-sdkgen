...
public sealed class InlinePaymentMethodOptionsCardMandateOptionsSupportedTypesItemXcc6168b4 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentMethodOptionsCardMandateOptionsSupportedTypesItemXcc6168b4 =
            when (value) {
                India.value -> India
    ...
    public object Serializer : KSerializer<InlinePaymentMethodOptionsCardMandateOptionsSupportedTypesItemXcc6168b4> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentMethodOptionsCardMandateOptionsSupportedTypesItemXcc6168b4",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlinePaymentMethodOptionsCardMandateOptionsSupportedTypesItemXcc6168b4 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentMethodOptionsCardMandateOptionsSupportedTypesItemXcc6168b4,
        ) {
