...
internal data class InlineV1TerminalConfigurationsPostRequestFormWifiX5e52b0baInspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesInlineV1TerminalConfigurationsPostRequestFormWifiAnyOf1Xc5b14eb2,
                matchesInlineV1TerminalConfigurationsPostRequestFormWifiAnyOf2Xfa1b35fa,
            ).count {
                it
            }
}
...
public class InlineV1TerminalConfigurationsPostRequestFormWifiX5e52b0ba internal constructor(
    ...
    public val inlineV1TerminalConfigurationsPostRequestFormWifiAnyOf1Xc5b14eb2:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1TerminalConfigurationsPostRequestFormWifiAnyOf1Xc5b14eb2) {
                json
                    .decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormWifiAnyOf1Xc5b14eb2>(
                        raw,
                    )
            } else {
                null
    ...
    public val inlineV1TerminalConfigurationsPostRequestFormWifiAnyOf2Xfa1b35fa:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1TerminalConfigurationsPostRequestFormWifiAnyOf2Xfa1b35fa) {
                json
                    .decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormWifiAnyOf2Xfa1b35fa>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1TerminalConfigurationsPostRequestFormWifiX5e52b0baBranch>
        get() =
            buildSet {
                if (inspection.matchesInlineV1TerminalConfigurationsPostRequestFormWifiAnyOf1Xc5b14eb2) {
                    add(
                        InlineV1TerminalConfigurationsPostRequestFormWifiX5e52b0baBranch.InlineV1TerminalConfigurationsPostRequestFormWifiAnyOf1Xc5b14eb2,
                    )
                }
                if (inspection.matchesInlineV1TerminalConfigurationsPostRequestFormWifiAnyOf2Xfa1b35fa) {
                    add(
                        InlineV1TerminalConfigurationsPostRequestFormWifiX5e52b0baBranch.InlineV1TerminalConfigurationsPostRequestFormWifiAnyOf2Xfa1b35fa,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1TerminalConfigurationsPostRequestFormWifiX5e52b0ba {
            val inspection = inspectInlineV1TerminalConfigurationsPostRequestFormWifiX5e52b0ba(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1TerminalConfigurationsPostRequestFormWifiX5e52b0baNoMatchException(
                    "InlineV1TerminalConfigurationsPostRequestFormWifiX5e52b0ba matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1TerminalConfigurationsPostRequestFormWifiX5e52b0ba> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TerminalConfigurationsPostRequestFormWifiX5e52b0ba,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1TerminalConfigurationsPostRequestFormWifiX5e52b0ba",
...
private fun inspectInlineV1TerminalConfigurationsPostRequestFormWifiX5e52b0ba(
    element: JsonElement,
): InlineV1TerminalConfigurationsPostRequestFormWifiX5e52b0baInspection {
    val matchesInlineV1TerminalConfigurationsPostRequestFormWifiAnyOf1Xc5b14eb2 =
        element
            .isJsonDecodable<InlineV1TerminalConfigurationsPostRequestFormWifiAnyOf1Xc5b14eb2>()
    val matchesInlineV1TerminalConfigurationsPostRequestFormWifiAnyOf2Xfa1b35fa =
        element
            .isJsonDecodable<InlineV1TerminalConfigurationsPostRequestFormWifiAnyOf2Xfa1b35fa>()
    return InlineV1TerminalConfigurationsPostRequestFormWifiX5e52b0baInspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1TerminalConfigurationsPostRequestFormWifiAnyOf1Xc5b14eb2) {
                    add(
                        "InlineV1TerminalConfigurationsPostRequestFormWifiAnyOf1Xc5b14eb2: value does not match InlineV1TerminalConfigurationsPostRequestFormWifiAnyOf1Xc5b14eb2",
                    )
                }
                if (!matchesInlineV1TerminalConfigurationsPostRequestFormWifiAnyOf2Xfa1b35fa) {
                    add(
                        "InlineV1TerminalConfigurationsPostRequestFormWifiAnyOf2Xfa1b35fa: value does not match InlineV1TerminalConfigurationsPostRequestFormWifiAnyOf2Xfa1b35fa",
                    )
                }
            },
    )
