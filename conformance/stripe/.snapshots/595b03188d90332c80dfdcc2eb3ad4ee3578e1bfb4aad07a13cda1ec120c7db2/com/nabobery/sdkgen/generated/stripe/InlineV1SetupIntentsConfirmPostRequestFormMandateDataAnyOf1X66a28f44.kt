...
public class InlineV1SetupIntentsConfirmPostRequestFormMandateDataAnyOf1X66a28f44(
    public val customerAcceptance: InlineV1SetupIntentsConfirmPostRequestFormMandateDataCustomerAcceptanceX4a21bfeb,
) {
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1SetupIntentsConfirmPostRequestFormMandateDataAnyOf1X66a28f44 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1SetupIntentsConfirmPostRequestFormMandateDataAnyOf1X66a28f44> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SetupIntentsConfirmPostRequestFormMandateDataAnyOf1X66a28f44 must be a JSON object",
                    )
            val customerAcceptance =
                json
                    .decodeRequired<InlineV1SetupIntentsConfirmPostRequestFormMandateDataCustomerAcceptanceX4a21bfeb>(
                        rawObject,
                        "customer_acceptance",
                    )
            return InlineV1SetupIntentsConfirmPostRequestFormMandateDataAnyOf1X66a28f44(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SetupIntentsConfirmPostRequestFormMandateDataAnyOf1X66a28f44,
        ) {
            val jsonEncoder =
...
public fun inlineV1SetupIntentsConfirmPostRequestFormMandateDataAnyOf1X66a28f44(
    block: InlineV1SetupIntentsConfirmPostRequestFormMandateDataAnyOf1X66a28f44.Builder.() -> Unit,
): InlineV1SetupIntentsConfirmPostRequestFormMandateDataAnyOf1X66a28f44 =
    InlineV1SetupIntentsConfirmPostRequestFormMandateDataAnyOf1X66a28f44.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1SetupIntentsConfirmPostRequestFormMandateDataAnyOf1X66a28f44 is missing required property '" +
                    name +
                    "'",
            )
