...
public class InlineV1BillingPortalSessionsPostRequestFormFlowDataSubscriptionCancelXe06b101e(
    ...
    public val retention: InlineV1BillingPortalSessionsPostRequestFormFlowDataRetentionXf3ca2ebd? = null,
) {
    ...
    public object Serializer : KSerializer<InlineV1BillingPortalSessionsPostRequestFormFlowDataSubscriptionCancelXe06b101e> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1BillingPortalSessionsPostRequestFormFlowDataSubscriptionCancelXe06b101e must be a JSON object",
                    )
            val subscription = json.decodeRequired<String>(rawObject, "subscription")
            return InlineV1BillingPortalSessionsPostRequestFormFlowDataSubscriptionCancelXe06b101e(
                subscription = subscription,
                retention =
                    rawObject["retention"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1BillingPortalSessionsPostRequestFormFlowDataRetentionXf3ca2ebd>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1BillingPortalSessionsPostRequestFormFlowDataSubscriptionCancelXe06b101e,
        ) {
            val jsonEncoder =
...
public fun inlineV1BillingPortalSessionsPostRequestFormFlowDataSubscriptionCancelXe06b101e(
    block: InlineV1BillingPortalSessionsPostRequestFormFlowDataSubscriptionCancelXe06b101e.Builder.() -> Unit,
): InlineV1BillingPortalSessionsPostRequestFormFlowDataSubscriptionCancelXe06b101e =
    InlineV1BillingPortalSessionsPostRequestFormFlowDataSubscriptionCancelXe06b101e.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1BillingPortalSessionsPostRequestFormFlowDataSubscriptionCancelXe06b101e is missing required property '" +
                    name +
                    "'",
            )
