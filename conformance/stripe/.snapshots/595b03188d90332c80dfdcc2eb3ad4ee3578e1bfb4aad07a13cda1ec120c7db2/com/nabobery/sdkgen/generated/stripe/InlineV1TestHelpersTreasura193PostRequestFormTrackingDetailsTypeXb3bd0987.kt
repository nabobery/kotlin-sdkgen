    ...
    public object Serializer : KSerializer<InlineV1TestHelpersTreasura193PostRequestFormTrackingDetailsTypeXb3bd0987> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1TestHelpersTreasura193PostRequestFormTrackingDetailsTypeXb3bd0987",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1TestHelpersTreasura193PostRequestFormTrackingDetailsTypeXb3bd0987 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TestHelpersTreasura193PostRequestFormTrackingDetailsTypeXb3bd0987,
        ) {
