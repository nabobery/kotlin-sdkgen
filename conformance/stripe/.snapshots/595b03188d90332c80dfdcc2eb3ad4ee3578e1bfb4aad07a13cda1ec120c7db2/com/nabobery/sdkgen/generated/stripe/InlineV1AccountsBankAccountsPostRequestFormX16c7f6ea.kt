...
public class InlineV1AccountsBankAccountsPostRequestFormX16c7f6ea(
     ...
     */
    public val accountHolderType: InlineV1AccountsBankAccountsPostRequestFormAccountHolderTypeX8942b3ac? = null,
    /**
    ...
    public class Builder {
        ...
        public fun build(): InlineV1AccountsBankAccountsPostRequestFormX16c7f6ea =
            InlineV1AccountsBankAccountsPostRequestFormX16c7f6ea(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1AccountsBankAccountsPostRequestFormX16c7f6ea =
    ...
    public object Serializer : KSerializer<InlineV1AccountsBankAccountsPostRequestFormX16c7f6ea> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountsBankAccountsPostRequestFormX16c7f6ea must be a JSON object",
                    )
            return InlineV1AccountsBankAccountsPostRequestFormX16c7f6ea(
                ...
                accountHolderType =
                    rawObject["account_holder_type"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1AccountsBankAccountsPostRequestFormAccountHolderTypeX8942b3ac>(
                                it,
                            )
                    },
                accountType =
                    rawObject["account_type"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsBankAccountsPostRequestFormAccountTypeXd767bebb>(it)
                    },
                ...
                documents =
                    rawObject["documents"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsBankAccountsPostRequestFormDocumentsX39fc0d37>(it)
                    },
                ...
                metadata =
                    rawObject["metadata"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsBankAccountsPostRequestFormMetadataXb01c85c9>(it)
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsBankAccountsPostRequestFormX16c7f6ea,
        ) {
...
public fun inlineV1AccountsBankAccountsPostRequestFormX16c7f6ea(
    block: InlineV1AccountsBankAccountsPostRequestFormX16c7f6ea.Builder.() -> Unit,
): InlineV1AccountsBankAccountsPostRequestFormX16c7f6ea =
    InlineV1AccountsBankAccountsPostRequestFormX16c7f6ea.build(block)
