...
public class InlineV1TestHelpersIssuing5508PostRequestFormPurchaseDetailsFuelX95e3e8a4(
    ...
    public val type: InlineV1TestHelpersIssuing5508PostRequestFormPurchaseDetailsFuelTypeX439d7949? = null,
    public val unit: InlineV1TestHelpersIssuing5508PostRequestFormPurchaseDetailsFuelUnitX54079258? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1TestHelpersIssuing5508PostRequestFormPurchaseDetailsFuelX95e3e8a4 =
            InlineV1TestHelpersIssuing5508PostRequestFormPurchaseDetailsFuelX95e3e8a4(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1TestHelpersIssuing5508PostRequestFormPurchaseDetailsFuelX95e3e8a4 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TestHelpersIssuing5508PostRequestFormPurchaseDetailsFuelX95e3e8a4> {
        ...
        override fun deserialize(
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TestHelpersIssuing5508PostRequestFormPurchaseDetailsFuelX95e3e8a4 must be a JSON object",
                    )
            return InlineV1TestHelpersIssuing5508PostRequestFormPurchaseDetailsFuelX95e3e8a4(
                ...
                type =
                    rawObject["type"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TestHelpersIssuing5508PostRequestFormPurchaseDetailsFuelTypeX439d7949>(
                                it,
                            )
                    },
                unit =
                    rawObject["unit"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TestHelpersIssuing5508PostRequestFormPurchaseDetailsFuelUnitX54079258>(
                                it,
                            )
                    },
                unitCostDecimal =
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TestHelpersIssuing5508PostRequestFormPurchaseDetailsFuelX95e3e8a4,
        ) {
            val jsonEncoder =
...
public fun inlineV1TestHelpersIssuing5508PostRequestFormPurchaseDetailsFuelX95e3e8a4(
    block: InlineV1TestHelpersIssuing5508PostRequestFormPurchaseDetailsFuelX95e3e8a4.Builder.() -> Unit,
): InlineV1TestHelpersIssuing5508PostRequestFormPurchaseDetailsFuelX95e3e8a4 =
