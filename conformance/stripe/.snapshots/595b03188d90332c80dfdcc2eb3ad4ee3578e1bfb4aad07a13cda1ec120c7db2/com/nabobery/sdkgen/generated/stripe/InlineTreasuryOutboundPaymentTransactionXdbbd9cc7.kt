...
public class InlineTreasuryOutboundPaymentTransactionXdbbd9cc7 internal constructor(
        ...
        get() =
            buildSet {
                ...
                if (inspection.matchesTreasuryTransaction) {
                    add(
                        InlineTreasuryOutboundPaymentTransactionXdbbd9cc7Branch.TreasuryTransaction,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineTreasuryOutboundPaymentTransactionXdbbd9cc7 {
            val inspection = inspectInlineTreasuryOutboundPaymentTransactionXdbbd9cc7(raw)
            if (inspection.matchCount == 0) {
                throw InlineTreasuryOutboundPaymentTransactionXdbbd9cc7NoMatchException(
                    "InlineTreasuryOutboundPaymentTransactionXdbbd9cc7 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineTreasuryOutboundPaymentTransactionXdbbd9cc7> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineTreasuryOutboundPaymentTransactionXdbbd9cc7,
        ) {
...
private fun inspectInlineTreasuryOutboundPaymentTransactionXdbbd9cc7(
    element: JsonElement,
): InlineTreasuryOutboundPaymentTransactionXdbbd9cc7Inspection {
