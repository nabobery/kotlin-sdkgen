...
public class NotificationEventRequest(
    ...
    public class Builder {
        ...
        public fun build(): NotificationEventRequest =
    ...
    public object Serializer : KSerializer<NotificationEventRequest> {
        ...
        override fun deserialize(decoder: Decoder): NotificationEventRequest {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("NotificationEventRequest must be a JSON object")
            return NotificationEventRequest(
                ...
                idempotencyKey =
                    rawObject["idempotency_key"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: NotificationEventRequest,
        ) {
...
public fun notificationEventRequest(block: NotificationEventRequest.Builder.() -> Unit): NotificationEventRequest =
    NotificationEventRequest.build(block)
