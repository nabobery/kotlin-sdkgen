...
public sealed class InlineV1InvoicesAddLinesPostRequestFormLinesItemMetadataAnyOf2X6e0c32a6 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1InvoicesAddLinesPostRequestFormLinesItemMetadataAnyOf2X6e0c32a6 =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1InvoicesAddLinesPostRequestFormLinesItemMetadataAnyOf2X6e0c32a6> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1InvoicesAddLinesPostRequestFormLinesItemMetadataAnyOf2X6e0c32a6",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1InvoicesAddLinesPostRequestFormLinesItemMetadataAnyOf2X6e0c32a6 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesAddLinesPostRequestFormLinesItemMetadataAnyOf2X6e0c32a6,
        ) {
