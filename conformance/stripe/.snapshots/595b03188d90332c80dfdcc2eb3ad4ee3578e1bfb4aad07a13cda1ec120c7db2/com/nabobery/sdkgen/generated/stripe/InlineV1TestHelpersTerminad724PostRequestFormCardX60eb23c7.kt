...
public class InlineV1TestHelpersTerminad724PostRequestFormCardX60eb23c7(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TestHelpersTerminad724PostRequestFormCardX60eb23c7 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TestHelpersTerminad724PostRequestFormCardX60eb23c7> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TestHelpersTerminad724PostRequestFormCardX60eb23c7 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TestHelpersTerminad724PostRequestFormCardX60eb23c7,
        ) {
...
public fun inlineV1TestHelpersTerminad724PostRequestFormCardX60eb23c7(
    block: InlineV1TestHelpersTerminad724PostRequestFormCardX60eb23c7.Builder.() -> Unit,
): InlineV1TestHelpersTerminad724PostRequestFormCardX60eb23c7 =
    InlineV1TestHelpersTerminad724PostRequestFormCardX60eb23c7.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TestHelpersTerminad724PostRequestFormCardX60eb23c7 is missing required property '" + name + "'",
            )
