...
public class InlineV1PaymentLinksPostRequestFormSubscriptionDataTrialSettingsAnyOf1Xb0094855(
    ...
    public object Serializer : KSerializer<InlineV1PaymentLinksPostRequestFormSubscriptionDataTrialSettingsAnyOf1Xb0094855> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentLinksPostRequestFormSubscriptionDataTrialSettingsAnyOf1Xb0094855 must be a JSON object",
                    )
            val endBehavior =
                json.decodeRequired<InlineV1PaymentLinksPostRequestFormSubscriptionDataEndBehaviorX3c769197>(
                    rawObject,
                    "end_behavior",
                )
            return InlineV1PaymentLinksPostRequestFormSubscriptionDataTrialSettingsAnyOf1Xb0094855(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentLinksPostRequestFormSubscriptionDataTrialSettingsAnyOf1Xb0094855,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentLinksPostRequestFormSubscriptionDataTrialSettingsAnyOf1Xb0094855(
    block: InlineV1PaymentLinksPostRequestFormSubscriptionDataTrialSettingsAnyOf1Xb0094855.Builder.() -> Unit,
): InlineV1PaymentLinksPostRequestFormSubscriptionDataTrialSettingsAnyOf1Xb0094855 =
    InlineV1PaymentLinksPostRequestFormSubscriptionDataTrialSettingsAnyOf1Xb0094855.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentLinksPostRequestFormSubscriptionDataTrialSettingsAnyOf1Xb0094855 is missing required property '" +
                    name +
                    "'",
            )
