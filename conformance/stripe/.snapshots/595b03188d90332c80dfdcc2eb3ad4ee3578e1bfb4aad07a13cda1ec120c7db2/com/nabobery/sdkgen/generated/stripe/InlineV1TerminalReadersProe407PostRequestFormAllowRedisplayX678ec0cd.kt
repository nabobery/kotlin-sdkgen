...
public sealed class InlineV1TerminalReadersProe407PostRequestFormAllowRedisplayX678ec0cd {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1TerminalReadersProe407PostRequestFormAllowRedisplayX678ec0cd =
            when (value) {
                Always.value -> Always
    ...
    public object Serializer : KSerializer<InlineV1TerminalReadersProe407PostRequestFormAllowRedisplayX678ec0cd> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1TerminalReadersProe407PostRequestFormAllowRedisplayX678ec0cd",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1TerminalReadersProe407PostRequestFormAllowRedisplayX678ec0cd = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TerminalReadersProe407PostRequestFormAllowRedisplayX678ec0cd,
        ) {
