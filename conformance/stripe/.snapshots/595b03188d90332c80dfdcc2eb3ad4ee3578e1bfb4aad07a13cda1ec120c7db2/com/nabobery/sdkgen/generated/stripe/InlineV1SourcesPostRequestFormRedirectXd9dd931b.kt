...
public class InlineV1SourcesPostRequestFormRedirectXd9dd931b(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1SourcesPostRequestFormRedirectXd9dd931b =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1SourcesPostRequestFormRedirectXd9dd931b> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SourcesPostRequestFormRedirectXd9dd931b must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SourcesPostRequestFormRedirectXd9dd931b,
        ) {
...
public fun inlineV1SourcesPostRequestFormRedirectXd9dd931b(
    block: InlineV1SourcesPostRequestFormRedirectXd9dd931b.Builder.() -> Unit,
): InlineV1SourcesPostRequestFormRedirectXd9dd931b = InlineV1SourcesPostRequestFormRedirectXd9dd931b.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1SourcesPostRequestFormRedirectXd9dd931b is missing required property '" + name + "'",
            )
