...
internal data class InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsKonbiniX4040a930Inspection(
    ...
    public val matchesInlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsAnyOf2X1d8bd05d: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsAnyOf2X1d8bd05d,
            ).count {
                it
            }
}
...
public class InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsKonbiniX4040a930 internal constructor(
    ...
    private val inspection: InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsKonbiniX4040a930Inspection,
) {
    ...
    public val inlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsAnyOf2X1d8bd05d:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsAnyOf2X1d8bd05d) {
                json
                    .decodeFromJsonElement<InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsAnyOf2X1d8bd05d>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsKonbiniX4040a930Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsAnyOf2X1d8bd05d) {
                    add(
                        InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsKonbiniX4040a930Branch.InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsAnyOf2X1d8bd05d,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsKonbiniX4040a930 {
            val inspection = inspectInlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsKonbiniX4040a930(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsKonbiniX4040a930NoMatchException(
                    "InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsKonbiniX4040a930 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsKonbiniX4040a930> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsKonbiniX4040a930,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsKonbiniX4040a930",
...
private fun inspectInlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsKonbiniX4040a930(
    element: JsonElement,
): InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsKonbiniX4040a930Inspection {
    val matchesBranch1 = element.isJsonDecodable<JsonObject>()
    val matchesInlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsAnyOf2X1d8bd05d =
        element
            .isJsonDecodable<InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsAnyOf2X1d8bd05d>()
    return InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsKonbiniX4040a930Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsAnyOf2X1d8bd05d) {
                    add(
                        "InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsAnyOf2X1d8bd05d: value does not match InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsAnyOf2X1d8bd05d",
                    )
                }
            },
    )
