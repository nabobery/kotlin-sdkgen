...
public class TerminalReaderReaderResourcePrintContent(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): TerminalReaderReaderResourcePrintContent =
    ...
    public object Serializer : KSerializer<TerminalReaderReaderResourcePrintContent> {
        ...
        override fun deserialize(decoder: Decoder): TerminalReaderReaderResourcePrintContent {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("TerminalReaderReaderResourcePrintContent must be a JSON object")
            val type =
                json.decodeRequired<InlineTerminalReaderReaderResourcePrintContentTypeX8c315c36>(
                    rawObject,
                    "type",
                )
            return TerminalReaderReaderResourcePrintContent(
                ...
                image =
                    rawObject["image"]?.let {
                        json.decodeFromJsonElement<TerminalReaderReaderResourceFileMetadata>(
                            it,
                        )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: TerminalReaderReaderResourcePrintContent,
        ) {
...
public fun terminalReaderReaderResourcePrintContent(
    block: TerminalReaderReaderResourcePrintContent.Builder.() -> Unit,
): TerminalReaderReaderResourcePrintContent = TerminalReaderReaderResourcePrintContent.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "TerminalReaderReaderResourcePrintContent is missing required property '" + name + "'",
            )
