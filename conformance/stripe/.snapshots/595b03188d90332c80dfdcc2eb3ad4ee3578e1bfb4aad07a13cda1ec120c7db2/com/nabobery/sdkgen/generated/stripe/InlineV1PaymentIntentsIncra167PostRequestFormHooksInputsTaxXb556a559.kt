...
public class InlineV1PaymentIntentsIncra167PostRequestFormHooksInputsTaxXb556a559(
    public val calculation: InlineV1PaymentIntentsIncra167PostRequestFormHooksInputsTaxCalculationXf8a8cff4,
) {
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentIntentsIncra167PostRequestFormHooksInputsTaxXb556a559 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentIntentsIncra167PostRequestFormHooksInputsTaxXb556a559> {
        override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1PaymentIntentsIncra167PostRequestFormHooksInputsTaxXb556a559 {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsIncra167PostRequestFormHooksInputsTaxXb556a559 must be a JSON object",
                    )
            val calculation =
                json
                    .decodeRequired<InlineV1PaymentIntentsIncra167PostRequestFormHooksInputsTaxCalculationXf8a8cff4>(
                        rawObject,
                        "calculation",
                    )
            return InlineV1PaymentIntentsIncra167PostRequestFormHooksInputsTaxXb556a559(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsIncra167PostRequestFormHooksInputsTaxXb556a559,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentIntentsIncra167PostRequestFormHooksInputsTaxXb556a559(
    block: InlineV1PaymentIntentsIncra167PostRequestFormHooksInputsTaxXb556a559.Builder.() -> Unit,
): InlineV1PaymentIntentsIncra167PostRequestFormHooksInputsTaxXb556a559 =
    InlineV1PaymentIntentsIncra167PostRequestFormHooksInputsTaxXb556a559.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentIntentsIncra167PostRequestFormHooksInputsTaxXb556a559 is missing required property '" +
                    name +
                    "'",
            )
