...
public class InlineV1TerminalConfigurationsPostRequestFormVerifoneP630Xbfb55acf(
    public val splashscreen: InlineV1TerminalConfigurationsPostRequestFormVerifoneP630SplashscreenX1504be6f? = null,
) {
    public class Builder {
        public var splashscreen:
            InlineV1TerminalConfigurationsPostRequestFormVerifoneP630SplashscreenX1504be6f? = null

        public fun build(): InlineV1TerminalConfigurationsPostRequestFormVerifoneP630Xbfb55acf =
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1TerminalConfigurationsPostRequestFormVerifoneP630Xbfb55acf = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TerminalConfigurationsPostRequestFormVerifoneP630Xbfb55acf> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TerminalConfigurationsPostRequestFormVerifoneP630Xbfb55acf must be a JSON object",
                    )
            return InlineV1TerminalConfigurationsPostRequestFormVerifoneP630Xbfb55acf(
                splashscreen =
                    rawObject["splashscreen"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormVerifoneP630SplashscreenX1504be6f>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TerminalConfigurationsPostRequestFormVerifoneP630Xbfb55acf,
        ) {
            val jsonEncoder =
...
public fun inlineV1TerminalConfigurationsPostRequestFormVerifoneP630Xbfb55acf(
    block: InlineV1TerminalConfigurationsPostRequestFormVerifoneP630Xbfb55acf.Builder.() -> Unit,
): InlineV1TerminalConfigurationsPostRequestFormVerifoneP630Xbfb55acf =
    InlineV1TerminalConfigurationsPostRequestFormVerifoneP630Xbfb55acf.build(block)
