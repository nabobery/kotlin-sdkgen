...
public class InlineV1AccountsRejectPostRequestFormXdb22fec1(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1AccountsRejectPostRequestFormXdb22fec1 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1AccountsRejectPostRequestFormXdb22fec1> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountsRejectPostRequestFormXdb22fec1 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsRejectPostRequestFormXdb22fec1,
        ) {
...
public fun inlineV1AccountsRejectPostRequestFormXdb22fec1(
    block: InlineV1AccountsRejectPostRequestFormXdb22fec1.Builder.() -> Unit,
): InlineV1AccountsRejectPostRequestFormXdb22fec1 = InlineV1AccountsRejectPostRequestFormXdb22fec1.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1AccountsRejectPostRequestFormXdb22fec1 is missing required property '" + name + "'",
            )
