...
public class InlineV1AccountsPostRequestFormCapabilitiesCashappPaymentsXe9ac134b(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1AccountsPostRequestFormCapabilitiesCashappPaymentsXe9ac134b =
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1AccountsPostRequestFormCapabilitiesCashappPaymentsXe9ac134b = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1AccountsPostRequestFormCapabilitiesCashappPaymentsXe9ac134b> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountsPostRequestFormCapabilitiesCashappPaymentsXe9ac134b must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPostRequestFormCapabilitiesCashappPaymentsXe9ac134b,
        ) {
            val jsonEncoder =
...
public fun inlineV1AccountsPostRequestFormCapabilitiesCashappPaymentsXe9ac134b(
    block: InlineV1AccountsPostRequestFormCapabilitiesCashappPaymentsXe9ac134b.Builder.() -> Unit,
): InlineV1AccountsPostRequestFormCapabilitiesCashappPaymentsXe9ac134b =
    InlineV1AccountsPostRequestFormCapabilitiesCashappPaymentsXe9ac134b.build(block)
