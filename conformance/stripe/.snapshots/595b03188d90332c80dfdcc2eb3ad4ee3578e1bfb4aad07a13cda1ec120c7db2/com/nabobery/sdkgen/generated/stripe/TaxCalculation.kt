...
public class TaxCalculation(
    ...
    public class Builder {
        ...
        public var taxBreakdown: List<TaxProductResourceTaxBreakdown>
            get() = requireNotNull(taxBreakdownValue) { "taxBreakdown is required" }
            set(`value`) {
                taxBreakdownValue = value
            }
        ...
        override fun deserialize(decoder: Decoder): TaxCalculation {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("TaxCalculation must be a JSON object")
                ...
                lineItems =
                    rawObject["line_items"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineTaxCalculationLineItemsX2767aa54?>(element)
                        }
                    },
                shipFromDetails =
                    rawObject["ship_from_details"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineTaxCalculationShipFromDetailsX621a3c3e?>(element)
                        }
                    },
                shippingCost =
                    rawObject["shipping_cost"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineTaxCalculationShippingCostXdd462a1a?>(element)
                        }
                    },
            )
        }
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("TaxCalculation is missing required property '" + name + "'")
