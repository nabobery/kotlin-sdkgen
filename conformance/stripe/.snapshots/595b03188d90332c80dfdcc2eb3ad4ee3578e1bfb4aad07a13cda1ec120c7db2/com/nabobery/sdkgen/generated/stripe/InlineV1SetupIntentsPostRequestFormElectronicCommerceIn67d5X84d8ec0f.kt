...
public sealed class InlineV1SetupIntentsPostRequestFormElectronicCommerceIn67d5X84d8ec0f {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1SetupIntentsPostRequestFormElectronicCommerceIn67d5X84d8ec0f =
            when (value) {
                _01.value -> _01
                _02.value -> _02
                _05.value -> _05
    ...
    public object Serializer : KSerializer<InlineV1SetupIntentsPostRequestFormElectronicCommerceIn67d5X84d8ec0f> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1SetupIntentsPostRequestFormElectronicCommerceIn67d5X84d8ec0f",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1SetupIntentsPostRequestFormElectronicCommerceIn67d5X84d8ec0f = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SetupIntentsPostRequestFormElectronicCommerceIn67d5X84d8ec0f,
        ) {
