...
public class InlineV1BillingAlertsGetResponse200JsonX685d5281(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1BillingAlertsGetResponse200JsonX685d5281 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1BillingAlertsGetResponse200JsonX685d5281> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1BillingAlertsGetResponse200JsonX685d5281 must be a JSON object",
                    )
            val data = json.decodeRequired<List<BillingAlert>>(rawObject, "data")
            val hasMore = json.decodeRequired<Boolean>(rawObject, "has_more")
            val objectValue =
                json.decodeRequired<InlineV1BillingAlertsGetResponse200JsonObjectValueXb64926df>(
                    rawObject,
                    "object",
                )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1BillingAlertsGetResponse200JsonX685d5281,
        ) {
...
public fun inlineV1BillingAlertsGetResponse200JsonX685d5281(
    block: InlineV1BillingAlertsGetResponse200JsonX685d5281.Builder.() -> Unit,
): InlineV1BillingAlertsGetResponse200JsonX685d5281 = InlineV1BillingAlertsGetResponse200JsonX685d5281.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1BillingAlertsGetResponse200JsonX685d5281 is missing required property '" + name + "'",
            )
