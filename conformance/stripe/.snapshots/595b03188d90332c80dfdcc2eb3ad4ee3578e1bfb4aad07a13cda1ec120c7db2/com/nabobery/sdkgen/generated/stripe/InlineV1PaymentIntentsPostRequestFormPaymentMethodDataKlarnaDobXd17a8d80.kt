...
public class InlineV1PaymentIntentsPostRequestFormPaymentMethodDataKlarnaDobXd17a8d80(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentIntentsPostRequestFormPaymentMethodDataKlarnaDobXd17a8d80 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormPaymentMethodDataKlarnaDobXd17a8d80> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsPostRequestFormPaymentMethodDataKlarnaDobXd17a8d80 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormPaymentMethodDataKlarnaDobXd17a8d80,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentIntentsPostRequestFormPaymentMethodDataKlarnaDobXd17a8d80(
    block: InlineV1PaymentIntentsPostRequestFormPaymentMethodDataKlarnaDobXd17a8d80.Builder.() -> Unit,
): InlineV1PaymentIntentsPostRequestFormPaymentMethodDataKlarnaDobXd17a8d80 =
    InlineV1PaymentIntentsPostRequestFormPaymentMethodDataKlarnaDobXd17a8d80.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentIntentsPostRequestFormPaymentMethodDataKlarnaDobXd17a8d80 is missing required property '" +
                    name +
                    "'",
            )
