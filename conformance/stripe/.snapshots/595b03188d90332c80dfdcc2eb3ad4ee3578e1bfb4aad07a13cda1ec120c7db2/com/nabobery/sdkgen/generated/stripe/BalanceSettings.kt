...
public class BalanceSettings(
    ...
    public object Serializer : KSerializer<BalanceSettings> {
        ...
        override fun deserialize(decoder: Decoder): BalanceSettings {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("BalanceSettings must be a JSON object")
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("BalanceSettings is missing required property '" + name + "'")
