...
public class SetupIntentNextActionRedirectToUrl(
    ...
    public class Builder {
        ...
        public fun build(): SetupIntentNextActionRedirectToUrl =
    ...
    public object Serializer : KSerializer<SetupIntentNextActionRedirectToUrl> {
        ...
        override fun deserialize(decoder: Decoder): SetupIntentNextActionRedirectToUrl {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("SetupIntentNextActionRedirectToUrl must be a JSON object")
...
public fun setupIntentNextActionRedirectToUrl(
    block: SetupIntentNextActionRedirectToUrl.Builder.() -> Unit,
): SetupIntentNextActionRedirectToUrl = SetupIntentNextActionRedirectToUrl.build(block)
