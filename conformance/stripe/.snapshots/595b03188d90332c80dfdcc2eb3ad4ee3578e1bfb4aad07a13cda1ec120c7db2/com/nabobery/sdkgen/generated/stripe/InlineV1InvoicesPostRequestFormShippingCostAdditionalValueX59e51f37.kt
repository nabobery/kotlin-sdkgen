...
public class InlineV1InvoicesPostRequestFormShippingCostAdditionalValueX59e51f37(
    ...
    public val taxBehavior: InlineV1InvoicesPostRequestFormShippingCostShippingRateDataTaxBehaviorXd38659b5? = null,
) {
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1InvoicesPostRequestFormShippingCostAdditionalValueX59e51f37 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1InvoicesPostRequestFormShippingCostAdditionalValueX59e51f37> {
        ...
        override fun deserialize(
            decoder: Decoder,
        ): InlineV1InvoicesPostRequestFormShippingCostAdditionalValueX59e51f37 {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1InvoicesPostRequestFormShippingCostAdditionalValueX59e51f37 must be a JSON object",
                    )
            ...
            return InlineV1InvoicesPostRequestFormShippingCostAdditionalValueX59e51f37(
                ...
                taxBehavior =
                    rawObject["tax_behavior"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1InvoicesPostRequestFormShippingCostShippingRateDataTaxBehaviorXd38659b5>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesPostRequestFormShippingCostAdditionalValueX59e51f37,
        ) {
            val jsonEncoder =
...
public fun inlineV1InvoicesPostRequestFormShippingCostAdditionalValueX59e51f37(
    block: InlineV1InvoicesPostRequestFormShippingCostAdditionalValueX59e51f37.Builder.() -> Unit,
): InlineV1InvoicesPostRequestFormShippingCostAdditionalValueX59e51f37 =
    InlineV1InvoicesPostRequestFormShippingCostAdditionalValueX59e51f37.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1InvoicesPostRequestFormShippingCostAdditionalValueX59e51f37 is missing required property '" +
                    name +
                    "'",
            )
