...
public class PaymentIntentNextActionKlarnaDisplayQrCode(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentIntentNextActionKlarnaDisplayQrCode =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentIntentNextActionKlarnaDisplayQrCode> {
        ...
        override fun deserialize(decoder: Decoder): PaymentIntentNextActionKlarnaDisplayQrCode {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentIntentNextActionKlarnaDisplayQrCode must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentIntentNextActionKlarnaDisplayQrCode,
        ) {
...
public fun paymentIntentNextActionKlarnaDisplayQrCode(
    block: PaymentIntentNextActionKlarnaDisplayQrCode.Builder.() -> Unit,
): PaymentIntentNextActionKlarnaDisplayQrCode = PaymentIntentNextActionKlarnaDisplayQrCode.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "PaymentIntentNextActionKlarnaDisplayQrCode is missing required property '" + name + "'",
            )
