...
public class InlineV1CheckoutSessionsPostRequestFormCustomFieldsItemX590b8a05(
    ...
    public val dropdown: InlineV1CheckoutSessionsPostRequestFormCustomFieldsItemDropdownXf75035fc? = null,
    public val numeric: InlineV1CheckoutSessionsPostRequestFormCustomFieldsItemNumericX33747b50? = null,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1CheckoutSessionsPostRequestFormCustomFieldsItemX590b8a05 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormCustomFieldsItemX590b8a05> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CheckoutSessionsPostRequestFormCustomFieldsItemX590b8a05 must be a JSON object",
                    )
            val key = json.decodeRequired<String>(rawObject, "key")
            val label =
                json.decodeRequired<InlineV1CheckoutSessionsPostRequestFormCustomFieldsItemLabelXb5ab84e8>(
                    rawObject,
                    "label",
                )
            val type =
                json.decodeRequired<InlineV1CheckoutSessionsPostRequestFormCustomFieldsItemTypeX276e342c>(
                    rawObject,
                    "type",
                )
            return InlineV1CheckoutSessionsPostRequestFormCustomFieldsItemX590b8a05(
                ...
                dropdown =
                    rawObject["dropdown"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormCustomFieldsItemDropdownXf75035fc>(
                                it,
                            )
                    },
                numeric =
                    rawObject["numeric"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormCustomFieldsItemNumericX33747b50>(
                                it,
                            )
                    },
                ...
                text =
                    rawObject["text"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormCustomFieldsItemTextXf813b141>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsPostRequestFormCustomFieldsItemX590b8a05,
        ) {
            val jsonEncoder =
...
public fun inlineV1CheckoutSessionsPostRequestFormCustomFieldsItemX590b8a05(
    block: InlineV1CheckoutSessionsPostRequestFormCustomFieldsItemX590b8a05.Builder.() -> Unit,
): InlineV1CheckoutSessionsPostRequestFormCustomFieldsItemX590b8a05 =
    InlineV1CheckoutSessionsPostRequestFormCustomFieldsItemX590b8a05.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1CheckoutSessionsPostRequestFormCustomFieldsItemX590b8a05 is missing required property '" + name +
                    "'",
            )
