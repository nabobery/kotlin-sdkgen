...
public sealed class InlineTaxTransactionObjectValueX5d2bf11d {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineTaxTransactionObjectValueX5d2bf11d =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineTaxTransactionObjectValueX5d2bf11d> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineTaxTransactionObjectValueX5d2bf11d",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineTaxTransactionObjectValueX5d2bf11d =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineTaxTransactionObjectValueX5d2bf11d,
        ) {
