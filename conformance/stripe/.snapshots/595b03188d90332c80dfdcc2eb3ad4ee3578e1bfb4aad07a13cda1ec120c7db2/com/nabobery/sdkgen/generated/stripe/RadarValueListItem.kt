        ...
        override fun deserialize(decoder: Decoder): RadarValueListItem {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("RadarValueListItem must be a JSON object")
...
public fun radarValueListItem(block: RadarValueListItem.Builder.() -> Unit): RadarValueListItem =
    RadarValueListItem.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("RadarValueListItem is missing required property '" + name + "'")
