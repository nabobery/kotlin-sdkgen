...
public class InlineV1TaxIdsPostRequestFormOwnerXb78c8ac1(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TaxIdsPostRequestFormOwnerXb78c8ac1 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TaxIdsPostRequestFormOwnerXb78c8ac1> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1TaxIdsPostRequestFormOwnerXb78c8ac1 {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("InlineV1TaxIdsPostRequestFormOwnerXb78c8ac1 must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TaxIdsPostRequestFormOwnerXb78c8ac1,
        ) {
...
public fun inlineV1TaxIdsPostRequestFormOwnerXb78c8ac1(
    block: InlineV1TaxIdsPostRequestFormOwnerXb78c8ac1.Builder.() -> Unit,
): InlineV1TaxIdsPostRequestFormOwnerXb78c8ac1 = InlineV1TaxIdsPostRequestFormOwnerXb78c8ac1.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TaxIdsPostRequestFormOwnerXb78c8ac1 is missing required property '" + name + "'",
            )
