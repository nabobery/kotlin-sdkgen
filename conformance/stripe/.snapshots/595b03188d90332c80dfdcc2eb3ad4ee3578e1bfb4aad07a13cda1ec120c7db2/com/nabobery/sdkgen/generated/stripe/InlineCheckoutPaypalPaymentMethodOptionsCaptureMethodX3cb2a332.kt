...
public sealed class InlineCheckoutPaypalPaymentMethodOptionsCaptureMethodX3cb2a332 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineCheckoutPaypalPaymentMethodOptionsCaptureMethodX3cb2a332 =
            when (value) {
                Manual.value -> Manual
    ...
    public object Serializer : KSerializer<InlineCheckoutPaypalPaymentMethodOptionsCaptureMethodX3cb2a332> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineCheckoutPaypalPaymentMethodOptionsCaptureMethodX3cb2a332",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineCheckoutPaypalPaymentMethodOptionsCaptureMethodX3cb2a332 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineCheckoutPaypalPaymentMethodOptionsCaptureMethodX3cb2a332,
        ) {
