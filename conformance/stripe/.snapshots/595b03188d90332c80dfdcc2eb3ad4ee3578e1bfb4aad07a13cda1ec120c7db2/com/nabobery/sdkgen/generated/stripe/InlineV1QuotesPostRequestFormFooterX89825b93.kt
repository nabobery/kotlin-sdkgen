...
public class InlineV1QuotesPostRequestFormFooterX89825b93 internal constructor(
    ...
    public val inlineV1QuotesPostRequestFormFooterAnyOf2X16942521:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1QuotesPostRequestFormFooterAnyOf2X16942521) {
                json
                    .decodeFromJsonElement<InlineV1QuotesPostRequestFormFooterAnyOf2X16942521>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1QuotesPostRequestFormFooterX89825b93Branch>
        get() =
            buildSet {
                ...
                if (inspection.matchesInlineV1QuotesPostRequestFormFooterAnyOf2X16942521) {
                    add(
                        InlineV1QuotesPostRequestFormFooterX89825b93Branch.InlineV1QuotesPostRequestFormFooterAnyOf2X16942521,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1QuotesPostRequestFormFooterX89825b93 {
            val inspection = inspectInlineV1QuotesPostRequestFormFooterX89825b93(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1QuotesPostRequestFormFooterX89825b93NoMatchException(
                    "InlineV1QuotesPostRequestFormFooterX89825b93 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1QuotesPostRequestFormFooterX89825b93> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1QuotesPostRequestFormFooterX89825b93,
        ) {
...
private fun inspectInlineV1QuotesPostRequestFormFooterX89825b93(
    element: JsonElement,
): InlineV1QuotesPostRequestFormFooterX89825b93Inspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1QuotesPostRequestFormFooterAnyOf2X16942521 =
        element
            .isJsonDecodable<InlineV1QuotesPostRequestFormFooterAnyOf2X16942521>()
    return InlineV1QuotesPostRequestFormFooterX89825b93Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1QuotesPostRequestFormFooterAnyOf2X16942521) {
                    add(
                        "InlineV1QuotesPostRequestFormFooterAnyOf2X16942521: value does not match InlineV1QuotesPostRequestFormFooterAnyOf2X16942521",
                    )
                }
            },
    )
