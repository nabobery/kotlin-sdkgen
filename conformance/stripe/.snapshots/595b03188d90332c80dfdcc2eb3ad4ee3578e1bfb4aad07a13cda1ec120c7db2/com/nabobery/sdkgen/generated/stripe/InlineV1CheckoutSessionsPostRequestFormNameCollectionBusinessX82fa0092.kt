...
public class InlineV1CheckoutSessionsPostRequestFormNameCollectionBusinessX82fa0092(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1CheckoutSessionsPostRequestFormNameCollectionBusinessX82fa0092 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormNameCollectionBusinessX82fa0092> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CheckoutSessionsPostRequestFormNameCollectionBusinessX82fa0092 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsPostRequestFormNameCollectionBusinessX82fa0092,
        ) {
            val jsonEncoder =
...
public fun inlineV1CheckoutSessionsPostRequestFormNameCollectionBusinessX82fa0092(
    block: InlineV1CheckoutSessionsPostRequestFormNameCollectionBusinessX82fa0092.Builder.() -> Unit,
): InlineV1CheckoutSessionsPostRequestFormNameCollectionBusinessX82fa0092 =
    InlineV1CheckoutSessionsPostRequestFormNameCollectionBusinessX82fa0092.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1CheckoutSessionsPostRequestFormNameCollectionBusinessX82fa0092 is missing required property '" +
                    name +
                    "'",
            )
