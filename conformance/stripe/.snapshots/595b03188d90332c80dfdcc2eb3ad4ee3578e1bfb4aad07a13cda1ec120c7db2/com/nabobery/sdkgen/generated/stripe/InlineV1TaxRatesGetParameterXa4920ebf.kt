...
public class InlineV1TaxRatesGetParameterXa4920ebf internal constructor(
    ...
    public val inlineV1TaxRatesGetParameterAnyOf1Xa63913ea:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1TaxRatesGetParameterAnyOf1Xa63913ea) {
                json
                    .decodeFromJsonElement<InlineV1TaxRatesGetParameterAnyOf1Xa63913ea>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1TaxRatesGetParameterXa4920ebfBranch>
        get() =
            buildSet {
                if (inspection.matchesInlineV1TaxRatesGetParameterAnyOf1Xa63913ea) {
                    add(
                        InlineV1TaxRatesGetParameterXa4920ebfBranch.InlineV1TaxRatesGetParameterAnyOf1Xa63913ea,
                    )
                }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1TaxRatesGetParameterXa4920ebf {
            val inspection = inspectInlineV1TaxRatesGetParameterXa4920ebf(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1TaxRatesGetParameterXa4920ebfNoMatchException(
                    "InlineV1TaxRatesGetParameterXa4920ebf matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1TaxRatesGetParameterXa4920ebf> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TaxRatesGetParameterXa4920ebf,
        ) {
...
private fun inspectInlineV1TaxRatesGetParameterXa4920ebf(
    element: JsonElement,
): InlineV1TaxRatesGetParameterXa4920ebfInspection {
    val matchesInlineV1TaxRatesGetParameterAnyOf1Xa63913ea =
        element
            .isJsonDecodable<InlineV1TaxRatesGetParameterAnyOf1Xa63913ea>()
    ...
    return InlineV1TaxRatesGetParameterXa4920ebfInspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1TaxRatesGetParameterAnyOf1Xa63913ea) {
                    add(
                        "InlineV1TaxRatesGetParameterAnyOf1Xa63913ea: value does not match InlineV1TaxRatesGetParameterAnyOf1Xa63913ea",
                    )
                }
