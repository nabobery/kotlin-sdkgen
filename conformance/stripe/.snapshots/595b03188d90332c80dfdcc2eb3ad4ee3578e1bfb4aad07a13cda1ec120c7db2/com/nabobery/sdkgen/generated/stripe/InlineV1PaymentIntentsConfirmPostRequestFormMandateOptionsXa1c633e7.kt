...
public class InlineV1PaymentIntentsConfirmPostRequestFormMandateOptionsXa1c633e7(
    public val collectionMethod: InlineV1PaymentIntentsConfirmPostRequestFormCollectionMethodXe9255fef? = null,
) {
    public class Builder {
        public var collectionMethod:
            InlineV1PaymentIntentsConfirmPostRequestFormCollectionMethodXe9255fef? = null

        public fun build(): InlineV1PaymentIntentsConfirmPostRequestFormMandateOptionsXa1c633e7 =
            InlineV1PaymentIntentsConfirmPostRequestFormMandateOptionsXa1c633e7(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentIntentsConfirmPostRequestFormMandateOptionsXa1c633e7 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsConfirmPostRequestFormMandateOptionsXa1c633e7> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsConfirmPostRequestFormMandateOptionsXa1c633e7 must be a JSON object",
                    )
            return InlineV1PaymentIntentsConfirmPostRequestFormMandateOptionsXa1c633e7(
                collectionMethod =
                    rawObject["collection_method"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormCollectionMethodXe9255fef>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsConfirmPostRequestFormMandateOptionsXa1c633e7,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentIntentsConfirmPostRequestFormMandateOptionsXa1c633e7(
    block: InlineV1PaymentIntentsConfirmPostRequestFormMandateOptionsXa1c633e7.Builder.() -> Unit,
): InlineV1PaymentIntentsConfirmPostRequestFormMandateOptionsXa1c633e7 =
