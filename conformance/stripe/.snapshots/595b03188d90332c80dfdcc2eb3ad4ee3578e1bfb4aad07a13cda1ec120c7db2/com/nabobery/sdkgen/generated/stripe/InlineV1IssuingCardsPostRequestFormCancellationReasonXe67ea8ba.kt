...
public sealed class InlineV1IssuingCardsPostRequestFormCancellationReasonXe67ea8ba {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1IssuingCardsPostRequestFormCancellationReasonXe67ea8ba =
            when (value) {
                Lost.value -> Lost
                Stolen.value -> Stolen
    ...
    public object Serializer : KSerializer<InlineV1IssuingCardsPostRequestFormCancellationReasonXe67ea8ba> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1IssuingCardsPostRequestFormCancellationReasonXe67ea8ba",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1IssuingCardsPostRequestFormCancellationReasonXe67ea8ba =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingCardsPostRequestFormCancellationReasonXe67ea8ba,
        ) {
