...
public sealed class InlineV1InvoiceitemsPostRequestFormTaxBehaviorX161ea3df {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1InvoiceitemsPostRequestFormTaxBehaviorX161ea3df =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1InvoiceitemsPostRequestFormTaxBehaviorX161ea3df> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1InvoiceitemsPostRequestFormTaxBehaviorX161ea3df",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1InvoiceitemsPostRequestFormTaxBehaviorX161ea3df =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoiceitemsPostRequestFormTaxBehaviorX161ea3df,
        ) {
