...
public class InlineV1PaymentIntentsConfirmPostRequestFormCustomerAcceptanceX4236445d(
    ...
    public val online: InlineV1PaymentIntentsConfirmPostRequestFormMandateDataAnyOf1OnlineX6de4c84c? = null,
) {
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentIntentsConfirmPostRequestFormCustomerAcceptanceX4236445d = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentIntentsConfirmPostRequestFormCustomerAcceptanceX4236445d> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsConfirmPostRequestFormCustomerAcceptanceX4236445d must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineV1PaymentIntentsConfirmPostRequestFormMandateDataAnyOf1TypeX348da1db>(
                    rawObject,
                    "type",
                )
            return InlineV1PaymentIntentsConfirmPostRequestFormCustomerAcceptanceX4236445d(
                ...
                online =
                    rawObject["online"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormMandateDataAnyOf1OnlineX6de4c84c>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsConfirmPostRequestFormCustomerAcceptanceX4236445d,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentIntentsConfirmPostRequestFormCustomerAcceptanceX4236445d(
    block: InlineV1PaymentIntentsConfirmPostRequestFormCustomerAcceptanceX4236445d.Builder.() -> Unit,
): InlineV1PaymentIntentsConfirmPostRequestFormCustomerAcceptanceX4236445d =
    InlineV1PaymentIntentsConfirmPostRequestFormCustomerAcceptanceX4236445d.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentIntentsConfirmPostRequestFormCustomerAcceptanceX4236445d is missing required property '" +
                    name +
                    "'",
            )
