...
@Serializable
public data class BankConnectionsResourceBalanceView(
    @SerialName("as_of")
    public val asOf: Int,
...
public class BankConnectionsResourceBalance(
    ...
    public class Builder {
        ...
        public var current: Map<String, Int>
            get() = requireNotNull(currentValue) { "current is required" }
            set(`value`) {
                currentValue = value
            }
    ...
    public object Serializer : KSerializer<BankConnectionsResourceBalance> {
        ...
        override fun deserialize(decoder: Decoder): BankConnectionsResourceBalance {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("BankConnectionsResourceBalance must be a JSON object")
            ...
            return BankConnectionsResourceBalance(
                ...
                cash =
                    rawObject["cash"]?.let {
                        json
                            .decodeFromJsonElement<BankConnectionsResourceBalanceApiResourceCashBalance>(
                                it,
                            )
                    },
                credit =
                    rawObject["credit"]?.let {
                        json.decodeFromJsonElement<BankConnectionsResourceBalanceApiResourceCreditBalance>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: BankConnectionsResourceBalance,
        ) {
...
public fun bankConnectionsResourceBalance(
    block: BankConnectionsResourceBalance.Builder.() -> Unit,
): BankConnectionsResourceBalance = BankConnectionsResourceBalance.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "BankConnectionsResourceBalance is missing required property '" + name + "'",
            )
