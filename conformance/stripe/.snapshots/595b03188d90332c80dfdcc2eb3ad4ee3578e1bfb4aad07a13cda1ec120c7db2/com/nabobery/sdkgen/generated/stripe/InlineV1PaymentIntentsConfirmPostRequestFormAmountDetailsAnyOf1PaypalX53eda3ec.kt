...
public class InlineV1PaymentIntentsConfirmPostRequestFormAmountDetailsAnyOf1PaypalX53eda3ec(
    public val category: InlineV1PaymentIntentsConfirmPostRequestFormAmountDetailsAnyOf1CategoryX9afe92c1? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1PaymentIntentsConfirmPostRequestFormAmountDetailsAnyOf1PaypalX53eda3ec =
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsConfirmPostRequestFormAmountDetailsAnyOf1PaypalX53eda3ec> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsConfirmPostRequestFormAmountDetailsAnyOf1PaypalX53eda3ec must be a JSON object",
                    )
            return InlineV1PaymentIntentsConfirmPostRequestFormAmountDetailsAnyOf1PaypalX53eda3ec(
                category =
                    rawObject["category"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormAmountDetailsAnyOf1CategoryX9afe92c1>(
                                it,
                            )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsConfirmPostRequestFormAmountDetailsAnyOf1PaypalX53eda3ec,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentIntentsConfirmPostRequestFormAmountDetailsAnyOf1PaypalX53eda3ec(
    block: InlineV1PaymentIntentsConfirmPostRequestFormAmountDetailsAnyOf1PaypalX53eda3ec.Builder.() -> Unit,
): InlineV1PaymentIntentsConfirmPostRequestFormAmountDetailsAnyOf1PaypalX53eda3ec =
    InlineV1PaymentIntentsConfirmPostRequestFormAmountDetailsAnyOf1PaypalX53eda3ec.build(block)
