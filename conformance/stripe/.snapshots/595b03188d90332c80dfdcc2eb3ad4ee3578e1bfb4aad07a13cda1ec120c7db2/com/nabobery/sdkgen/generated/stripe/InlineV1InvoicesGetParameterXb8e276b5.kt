...
public class InlineV1InvoicesGetParameterXb8e276b5 internal constructor(
    ...
    public val inlineV1InvoicesGetParameterAnyOf1Xec7dd6cb:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1InvoicesGetParameterAnyOf1Xec7dd6cb) {
                json
                    .decodeFromJsonElement<InlineV1InvoicesGetParameterAnyOf1Xec7dd6cb>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1InvoicesGetParameterXb8e276b5Branch>
        get() =
            buildSet {
                if (inspection.matchesInlineV1InvoicesGetParameterAnyOf1Xec7dd6cb) {
                    add(
                        InlineV1InvoicesGetParameterXb8e276b5Branch.InlineV1InvoicesGetParameterAnyOf1Xec7dd6cb,
                    )
                }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1InvoicesGetParameterXb8e276b5 {
            val inspection = inspectInlineV1InvoicesGetParameterXb8e276b5(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1InvoicesGetParameterXb8e276b5NoMatchException(
                    "InlineV1InvoicesGetParameterXb8e276b5 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1InvoicesGetParameterXb8e276b5> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesGetParameterXb8e276b5,
        ) {
...
private fun inspectInlineV1InvoicesGetParameterXb8e276b5(
    element: JsonElement,
): InlineV1InvoicesGetParameterXb8e276b5Inspection {
    val matchesInlineV1InvoicesGetParameterAnyOf1Xec7dd6cb =
        element
            .isJsonDecodable<InlineV1InvoicesGetParameterAnyOf1Xec7dd6cb>()
    ...
    return InlineV1InvoicesGetParameterXb8e276b5Inspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1InvoicesGetParameterAnyOf1Xec7dd6cb) {
                    add(
                        "InlineV1InvoicesGetParameterAnyOf1Xec7dd6cb: value does not match InlineV1InvoicesGetParameterAnyOf1Xec7dd6cb",
                    )
                }
