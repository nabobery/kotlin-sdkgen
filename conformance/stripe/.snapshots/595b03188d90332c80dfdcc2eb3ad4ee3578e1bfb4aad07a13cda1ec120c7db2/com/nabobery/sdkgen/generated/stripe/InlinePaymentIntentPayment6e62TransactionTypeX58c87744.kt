...
public sealed class InlinePaymentIntentPayment6e62TransactionTypeX58c87744 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentIntentPayment6e62TransactionTypeX58c87744 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlinePaymentIntentPayment6e62TransactionTypeX58c87744> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentIntentPayment6e62TransactionTypeX58c87744",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePaymentIntentPayment6e62TransactionTypeX58c87744 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentIntentPayment6e62TransactionTypeX58c87744,
        ) {
