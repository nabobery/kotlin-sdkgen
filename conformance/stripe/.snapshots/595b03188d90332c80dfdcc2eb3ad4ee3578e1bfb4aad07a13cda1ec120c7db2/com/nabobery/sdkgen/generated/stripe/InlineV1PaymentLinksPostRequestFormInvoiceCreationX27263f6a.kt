...
public class InlineV1PaymentLinksPostRequestFormInvoiceCreationX27263f6a(
    ...
    public val invoiceData: InlineV1PaymentLinksPostRequestFormInvoiceCreationInvoiceDataX055d3350? = null,
) {
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PaymentLinksPostRequestFormInvoiceCreationX27263f6a =
    ...
    public object Serializer : KSerializer<InlineV1PaymentLinksPostRequestFormInvoiceCreationX27263f6a> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentLinksPostRequestFormInvoiceCreationX27263f6a must be a JSON object",
                    )
            ...
            return InlineV1PaymentLinksPostRequestFormInvoiceCreationX27263f6a(
                ...
                invoiceData =
                    rawObject["invoice_data"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormInvoiceCreationInvoiceDataX055d3350>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentLinksPostRequestFormInvoiceCreationX27263f6a,
        ) {
...
public fun inlineV1PaymentLinksPostRequestFormInvoiceCreationX27263f6a(
    block: InlineV1PaymentLinksPostRequestFormInvoiceCreationX27263f6a.Builder.() -> Unit,
): InlineV1PaymentLinksPostRequestFormInvoiceCreationX27263f6a =
    InlineV1PaymentLinksPostRequestFormInvoiceCreationX27263f6a.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentLinksPostRequestFormInvoiceCreationX27263f6a is missing required property '" + name +
                    "'",
            )
