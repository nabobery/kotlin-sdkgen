...
public class SourceTransactionSepaCreditTransferData(
    ...
    public class Builder {
        ...
        public fun build(): SourceTransactionSepaCreditTransferData =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): SourceTransactionSepaCreditTransferData =
    ...
    public object Serializer : KSerializer<SourceTransactionSepaCreditTransferData> {
        ...
        override fun deserialize(decoder: Decoder): SourceTransactionSepaCreditTransferData {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("SourceTransactionSepaCreditTransferData must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: SourceTransactionSepaCreditTransferData,
        ) {
...
public fun sourceTransactionSepaCreditTransferData(
    block: SourceTransactionSepaCreditTransferData.Builder.() -> Unit,
): SourceTransactionSepaCreditTransferData = SourceTransactionSepaCreditTransferData.build(block)
