...
public class InlineV1QuotesPostRequestFormSubscriptionDataXf3ca95d4(
    ...
    public val effectiveDate: InlineV1QuotesPostRequestFormSubscriptionDataEffectiveDateX8945a94c? = null,
    public val metadata: Map<String, String>? = null,
    public val trialPeriodDays: InlineV1QuotesPostRequestFormSubscriptionDataTrialPeriodDaysXc8000420? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1QuotesPostRequestFormSubscriptionDataXf3ca95d4 =
            InlineV1QuotesPostRequestFormSubscriptionDataXf3ca95d4(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1QuotesPostRequestFormSubscriptionDataXf3ca95d4 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1QuotesPostRequestFormSubscriptionDataXf3ca95d4> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1QuotesPostRequestFormSubscriptionDataXf3ca95d4 must be a JSON object",
                    )
            return InlineV1QuotesPostRequestFormSubscriptionDataXf3ca95d4(
                billingMode =
                    rawObject["billing_mode"]?.let {
                        json.decodeFromJsonElement<InlineV1QuotesPostRequestFormSubscriptionDataBillingModeXb046cd04>(
                            it,
                        )
                    },
                description = rawObject["description"]?.let { json.decodeFromJsonElement<String>(it) },
                effectiveDate =
                    rawObject["effective_date"]?.let {
                        json.decodeFromJsonElement<InlineV1QuotesPostRequestFormSubscriptionDataEffectiveDateX8945a94c>(
                            it,
                        )
                    },
                ...
                trialPeriodDays =
                    rawObject["trial_period_days"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1QuotesPostRequestFormSubscriptionDataTrialPeriodDaysXc8000420>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1QuotesPostRequestFormSubscriptionDataXf3ca95d4,
        ) {
...
public fun inlineV1QuotesPostRequestFormSubscriptionDataXf3ca95d4(
    block: InlineV1QuotesPostRequestFormSubscriptionDataXf3ca95d4.Builder.() -> Unit,
): InlineV1QuotesPostRequestFormSubscriptionDataXf3ca95d4 =
    InlineV1QuotesPostRequestFormSubscriptionDataXf3ca95d4.build(block)
