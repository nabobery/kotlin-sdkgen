...
internal data class InlineV1ChargesDisputePostRequestFormEvidenceCustomerDeviceFinger9c71X9d81d65bInspection(
    ...
    public val matchesInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2Xd731d96b: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2Xd731d96b,
            ).count {
                it
            }
}
...
public class InlineV1ChargesDisputePostRequestFormEvidenceCustomerDeviceFinger9c71X9d81d65b internal constructor(
    ...
    private val inspection: InlineV1ChargesDisputePostRequestFormEvidenceCustomerDeviceFinger9c71X9d81d65bInspection,
) {
    ...
    public val inlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2Xd731d96b:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2Xd731d96b) {
                json
                    .decodeFromJsonElement<InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2Xd731d96b>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1ChargesDisputePostRequestFormEvidenceCustomerDeviceFinger9c71X9d81d65bBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2Xd731d96b) {
                    add(
                        InlineV1ChargesDisputePostRequestFormEvidenceCustomerDeviceFinger9c71X9d81d65bBranch.InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2Xd731d96b,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1ChargesDisputePostRequestFormEvidenceCustomerDeviceFinger9c71X9d81d65b {
            val inspection = inspectInlineV1ChargesDisputePostRequestFormEvidenceCustomerDeviceFinger9c71X9d81d65b(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1ChargesDisputePostRequestFormEvidenceCustomerDeviceFinger9c71X9d81d65bNoMatchException(
                    "InlineV1ChargesDisputePostRequestFormEvidenceCustomerDeviceFinger9c71X9d81d65b matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1ChargesDisputePostRequestFormEvidenceCustomerDeviceFinger9c71X9d81d65b> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ChargesDisputePostRequestFormEvidenceCustomerDeviceFinger9c71X9d81d65b,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1ChargesDisputePostRequestFormEvidenceCustomerDeviceFinger9c71X9d81d65b",
...
private fun inspectInlineV1ChargesDisputePostRequestFormEvidenceCustomerDeviceFinger9c71X9d81d65b(
    element: JsonElement,
): InlineV1ChargesDisputePostRequestFormEvidenceCustomerDeviceFinger9c71X9d81d65bInspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2Xd731d96b =
        element
            .isJsonDecodable<InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2Xd731d96b>()
    return InlineV1ChargesDisputePostRequestFormEvidenceCustomerDeviceFinger9c71X9d81d65bInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2Xd731d96b) {
                    add(
                        "InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2Xd731d96b: value does not match InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2Xd731d96b",
                    )
                }
            },
    )
