...
public sealed class InlineV1BillingCreditGrantsPostRequestFormExpiresAtAnyOf2Xb368985a {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1BillingCreditGrantsPostRequestFormExpiresAtAnyOf2Xb368985a =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1BillingCreditGrantsPostRequestFormExpiresAtAnyOf2Xb368985a> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1BillingCreditGrantsPostRequestFormExpiresAtAnyOf2Xb368985a",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1BillingCreditGrantsPostRequestFormExpiresAtAnyOf2Xb368985a =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1BillingCreditGrantsPostRequestFormExpiresAtAnyOf2Xb368985a,
        ) {
