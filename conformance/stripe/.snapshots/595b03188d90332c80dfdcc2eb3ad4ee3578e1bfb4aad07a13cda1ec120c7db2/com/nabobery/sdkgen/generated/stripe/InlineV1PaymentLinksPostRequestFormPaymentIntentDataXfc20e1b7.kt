...
public class InlineV1PaymentLinksPostRequestFormPaymentIntentDataXfc20e1b7(
    public val captureMethod: InlineV1PaymentLinksPostRequestFormPaymentIntentDataCaptureMethodX1d36c194? = null,
    public val description: String? = null,
    public val metadata: Map<String, String>? = null,
    public val setupFutureUsage: InlineV1PaymentLinksPostRequestFormPaymentIntentDataSetupFutureUsageXbcfd52b4? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1PaymentLinksPostRequestFormPaymentIntentDataXfc20e1b7 =
            InlineV1PaymentLinksPostRequestFormPaymentIntentDataXfc20e1b7(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PaymentLinksPostRequestFormPaymentIntentDataXfc20e1b7 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentLinksPostRequestFormPaymentIntentDataXfc20e1b7> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentLinksPostRequestFormPaymentIntentDataXfc20e1b7 must be a JSON object",
                    )
            return InlineV1PaymentLinksPostRequestFormPaymentIntentDataXfc20e1b7(
                captureMethod =
                    rawObject["capture_method"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormPaymentIntentDataCaptureMethodX1d36c194>(
                                it,
                            )
                    },
                ...
                setupFutureUsage =
                    rawObject["setup_future_usage"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormPaymentIntentDataSetupFutureUsageXbcfd52b4>(
                                it,
                            )
                    },
                statementDescriptor =
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentLinksPostRequestFormPaymentIntentDataXfc20e1b7,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentLinksPostRequestFormPaymentIntentDataXfc20e1b7(
    block: InlineV1PaymentLinksPostRequestFormPaymentIntentDataXfc20e1b7.Builder.() -> Unit,
): InlineV1PaymentLinksPostRequestFormPaymentIntentDataXfc20e1b7 =
    InlineV1PaymentLinksPostRequestFormPaymentIntentDataXfc20e1b7.build(block)
