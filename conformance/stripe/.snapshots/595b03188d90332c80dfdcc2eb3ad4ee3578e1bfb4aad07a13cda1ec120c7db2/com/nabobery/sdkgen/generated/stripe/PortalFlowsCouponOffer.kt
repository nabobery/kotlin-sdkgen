        ...
        override fun deserialize(decoder: Decoder): PortalFlowsCouponOffer {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PortalFlowsCouponOffer must be a JSON object")
...
public fun portalFlowsCouponOffer(block: PortalFlowsCouponOffer.Builder.() -> Unit): PortalFlowsCouponOffer =
    PortalFlowsCouponOffer.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("PortalFlowsCouponOffer is missing required property '" + name + "'")
