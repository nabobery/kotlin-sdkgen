...
internal data class InlineV1IssuingDisputesPostRequestFormEvidenceNotReceivedExpectedAtXf0c083dfInspection(
    ...
    public val matchesInlineV1IssuingDisputesPostRequestFormEvidenceNotReceivedAnyOf1AnyOf2X2c611cb2: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1IssuingDisputesPostRequestFormEvidenceNotReceivedAnyOf1AnyOf2X2c611cb2,
            ).count {
                it
            }
}
...
public class InlineV1IssuingDisputesPostRequestFormEvidenceNotReceivedExpectedAtXf0c083df internal constructor(
    ...
    private val inspection: InlineV1IssuingDisputesPostRequestFormEvidenceNotReceivedExpectedAtXf0c083dfInspection,
) {
    ...
    public val inlineV1IssuingDisputesPostRequestFormEvidenceNotReceivedAnyOf1AnyOf2X2c611cb2:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1IssuingDisputesPostRequestFormEvidenceNotReceivedAnyOf1AnyOf2X2c611cb2) {
                json
                    .decodeFromJsonElement<InlineV1IssuingDisputesPostRequestFormEvidenceNotReceivedAnyOf1AnyOf2X2c611cb2>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1IssuingDisputesPostRequestFormEvidenceNotReceivedExpectedAtXf0c083dfBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1IssuingDisputesPostRequestFormEvidenceNotReceivedAnyOf1AnyOf2X2c611cb2) {
                    add(
                        InlineV1IssuingDisputesPostRequestFormEvidenceNotReceivedExpectedAtXf0c083dfBranch.InlineV1IssuingDisputesPostRequestFormEvidenceNotReceivedAnyOf1AnyOf2X2c611cb2,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1IssuingDisputesPostRequestFormEvidenceNotReceivedExpectedAtXf0c083df {
            val inspection = inspectInlineV1IssuingDisputesPostRequestFormEvidenceNotReceivedExpectedAtXf0c083df(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1IssuingDisputesPostRequestFormEvidenceNotReceivedExpectedAtXf0c083dfNoMatchException(
                    "InlineV1IssuingDisputesPostRequestFormEvidenceNotReceivedExpectedAtXf0c083df matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1IssuingDisputesPostRequestFormEvidenceNotReceivedExpectedAtXf0c083df> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingDisputesPostRequestFormEvidenceNotReceivedExpectedAtXf0c083df,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1IssuingDisputesPostRequestFormEvidenceNotReceivedExpectedAtXf0c083df",
...
private fun inspectInlineV1IssuingDisputesPostRequestFormEvidenceNotReceivedExpectedAtXf0c083df(
    element: JsonElement,
): InlineV1IssuingDisputesPostRequestFormEvidenceNotReceivedExpectedAtXf0c083dfInspection {
    val matchesBranch1 = element.isJsonDecodable<Int>()
    val matchesInlineV1IssuingDisputesPostRequestFormEvidenceNotReceivedAnyOf1AnyOf2X2c611cb2 =
        element
            .isJsonDecodable<InlineV1IssuingDisputesPostRequestFormEvidenceNotReceivedAnyOf1AnyOf2X2c611cb2>()
    return InlineV1IssuingDisputesPostRequestFormEvidenceNotReceivedExpectedAtXf0c083dfInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1IssuingDisputesPostRequestFormEvidenceNotReceivedAnyOf1AnyOf2X2c611cb2) {
                    add(
                        "InlineV1IssuingDisputesPostRequestFormEvidenceNotReceivedAnyOf1AnyOf2X2c611cb2: value does not match InlineV1IssuingDisputesPostRequestFormEvidenceNotReceivedAnyOf1AnyOf2X2c611cb2",
                    )
                }
            },
    )
