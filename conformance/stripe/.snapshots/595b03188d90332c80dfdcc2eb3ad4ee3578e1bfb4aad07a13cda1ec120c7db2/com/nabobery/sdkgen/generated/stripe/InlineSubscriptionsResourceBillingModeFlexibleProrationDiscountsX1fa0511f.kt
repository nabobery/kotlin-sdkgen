    ...
    public object Serializer : KSerializer<InlineSubscriptionsResourceBillingModeFlexibleProrationDiscountsX1fa0511f> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineSubscriptionsResourceBillingModeFlexibleProrationDiscountsX1fa0511f",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineSubscriptionsResourceBillingModeFlexibleProrationDiscountsX1fa0511f = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineSubscriptionsResourceBillingModeFlexibleProrationDiscountsX1fa0511f,
        ) {
