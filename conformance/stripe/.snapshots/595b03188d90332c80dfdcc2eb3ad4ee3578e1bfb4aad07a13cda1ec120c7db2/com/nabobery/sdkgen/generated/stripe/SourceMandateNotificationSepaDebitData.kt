...
public class SourceMandateNotificationSepaDebitData(
    ...
    public class Builder {
        ...
        public fun build(): SourceMandateNotificationSepaDebitData =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): SourceMandateNotificationSepaDebitData =
    ...
    public object Serializer : KSerializer<SourceMandateNotificationSepaDebitData> {
        ...
        override fun deserialize(decoder: Decoder): SourceMandateNotificationSepaDebitData {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("SourceMandateNotificationSepaDebitData must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: SourceMandateNotificationSepaDebitData,
        ) {
...
public fun sourceMandateNotificationSepaDebitData(
    block: SourceMandateNotificationSepaDebitData.Builder.() -> Unit,
): SourceMandateNotificationSepaDebitData = SourceMandateNotificationSepaDebitData.build(block)
