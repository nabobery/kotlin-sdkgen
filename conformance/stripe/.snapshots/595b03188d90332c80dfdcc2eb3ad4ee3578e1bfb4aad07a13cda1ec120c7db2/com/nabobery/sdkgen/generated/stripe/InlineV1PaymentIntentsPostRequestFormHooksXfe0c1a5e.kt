...
public class InlineV1PaymentIntentsPostRequestFormHooksXfe0c1a5e(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1PaymentIntentsPostRequestFormHooksXfe0c1a5e =
            InlineV1PaymentIntentsPostRequestFormHooksXfe0c1a5e(
                inputs = inputs,
            )
    }

    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PaymentIntentsPostRequestFormHooksXfe0c1a5e =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormHooksXfe0c1a5e> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsPostRequestFormHooksXfe0c1a5e must be a JSON object",
                    )
            return InlineV1PaymentIntentsPostRequestFormHooksXfe0c1a5e(
                inputs =
                    rawObject["inputs"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormHooksInputsX74f1718a>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormHooksXfe0c1a5e,
        ) {
...
public fun inlineV1PaymentIntentsPostRequestFormHooksXfe0c1a5e(
    block: InlineV1PaymentIntentsPostRequestFormHooksXfe0c1a5e.Builder.() -> Unit,
): InlineV1PaymentIntentsPostRequestFormHooksXfe0c1a5e =
    InlineV1PaymentIntentsPostRequestFormHooksXfe0c1a5e.build(block)
