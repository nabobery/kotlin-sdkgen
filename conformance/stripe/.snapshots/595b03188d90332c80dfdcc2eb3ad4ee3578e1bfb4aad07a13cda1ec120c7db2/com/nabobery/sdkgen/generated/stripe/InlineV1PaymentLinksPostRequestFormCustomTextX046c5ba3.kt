...
public class InlineV1PaymentLinksPostRequestFormCustomTextX046c5ba3(
    ...
    public val shippingAddress: InlineV1PaymentLinksPostRequestFormCustomTextShippingAddressXaa09608d? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1PaymentLinksPostRequestFormCustomTextX046c5ba3 =
            InlineV1PaymentLinksPostRequestFormCustomTextX046c5ba3(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PaymentLinksPostRequestFormCustomTextX046c5ba3 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentLinksPostRequestFormCustomTextX046c5ba3> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentLinksPostRequestFormCustomTextX046c5ba3 must be a JSON object",
                    )
            return InlineV1PaymentLinksPostRequestFormCustomTextX046c5ba3(
                afterSubmit =
                    rawObject["after_submit"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormCustomTextAfterSubmitXa12c14c2>(
                            it,
                        )
                    },
                shippingAddress =
                    rawObject["shipping_address"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormCustomTextShippingAddressXaa09608d>(
                                it,
                            )
                    },
                submit =
                    rawObject["submit"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormCustomTextSubmitX2b15c8c6>(it)
                    },
                termsOfServiceAcceptance =
                    rawObject["terms_of_service_acceptance"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormCustomTextTermsOfServiceAcceptanceX4fe3a184>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentLinksPostRequestFormCustomTextX046c5ba3,
        ) {
...
public fun inlineV1PaymentLinksPostRequestFormCustomTextX046c5ba3(
    block: InlineV1PaymentLinksPostRequestFormCustomTextX046c5ba3.Builder.() -> Unit,
): InlineV1PaymentLinksPostRequestFormCustomTextX046c5ba3 =
    InlineV1PaymentLinksPostRequestFormCustomTextX046c5ba3.build(block)
