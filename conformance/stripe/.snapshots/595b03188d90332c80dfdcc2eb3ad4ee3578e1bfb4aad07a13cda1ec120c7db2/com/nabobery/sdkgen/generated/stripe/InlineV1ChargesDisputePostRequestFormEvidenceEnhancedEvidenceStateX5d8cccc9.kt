...
internal data class InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceStateX5d8cccc9Inspection(
    ...
    public val matchesInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2X1ddda8ac: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2X1ddda8ac,
            ).count {
                it
            }
}
...
public class InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceStateX5d8cccc9 internal constructor(
    ...
    private val inspection: InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceStateX5d8cccc9Inspection,
) {
    ...
    public val inlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2X1ddda8ac:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2X1ddda8ac) {
                json
                    .decodeFromJsonElement<InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2X1ddda8ac>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceStateX5d8cccc9Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2X1ddda8ac) {
                    add(
                        InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceStateX5d8cccc9Branch.InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2X1ddda8ac,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceStateX5d8cccc9 {
            val inspection = inspectInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceStateX5d8cccc9(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceStateX5d8cccc9NoMatchException(
                    "InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceStateX5d8cccc9 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceStateX5d8cccc9> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceStateX5d8cccc9,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceStateX5d8cccc9",
...
private fun inspectInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceStateX5d8cccc9(
    element: JsonElement,
): InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceStateX5d8cccc9Inspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2X1ddda8ac =
        element
            .isJsonDecodable<InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2X1ddda8ac>()
    return InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceStateX5d8cccc9Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2X1ddda8ac) {
                    add(
                        "InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2X1ddda8ac: value does not match InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2X1ddda8ac",
                    )
                }
            },
    )
