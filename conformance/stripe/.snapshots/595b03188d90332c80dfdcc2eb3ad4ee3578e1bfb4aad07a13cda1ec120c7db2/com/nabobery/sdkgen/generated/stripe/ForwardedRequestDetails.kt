...
@Serializable
public data class ForwardedRequestDetailsView(
...
public class ForwardedRequestDetails(
    ...
    public class Builder {
        ...
        public var headers: List<ForwardedRequestHeader>
            get() = requireNotNull(headersValue) { "headers is required" }
            set(`value`) {
                headersValue = value
            }
        ...
        override fun deserialize(decoder: Decoder): ForwardedRequestDetails {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("ForwardedRequestDetails must be a JSON object")
            ...
            val httpMethod =
                json.decodeRequired<InlineForwardedRequestDetailsHttpMethodXc5443c41>(
                    rawObject,
                    "http_method",
                )
            return ForwardedRequestDetails(
...
public fun forwardedRequestDetails(block: ForwardedRequestDetails.Builder.() -> Unit): ForwardedRequestDetails =
    ForwardedRequestDetails.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("ForwardedRequestDetails is missing required property '" + name + "'")
