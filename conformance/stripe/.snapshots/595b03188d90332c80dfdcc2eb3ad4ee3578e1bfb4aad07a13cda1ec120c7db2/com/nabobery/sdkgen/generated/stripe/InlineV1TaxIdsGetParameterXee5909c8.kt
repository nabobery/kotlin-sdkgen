...
public class InlineV1TaxIdsGetParameterXee5909c8(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TaxIdsGetParameterXee5909c8 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TaxIdsGetParameterXee5909c8> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1TaxIdsGetParameterXee5909c8 {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("InlineV1TaxIdsGetParameterXee5909c8 must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TaxIdsGetParameterXee5909c8,
        ) {
...
public fun inlineV1TaxIdsGetParameterXee5909c8(
    block: InlineV1TaxIdsGetParameterXee5909c8.Builder.() -> Unit,
): InlineV1TaxIdsGetParameterXee5909c8 = InlineV1TaxIdsGetParameterXee5909c8.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TaxIdsGetParameterXee5909c8 is missing required property '" + name + "'",
            )
