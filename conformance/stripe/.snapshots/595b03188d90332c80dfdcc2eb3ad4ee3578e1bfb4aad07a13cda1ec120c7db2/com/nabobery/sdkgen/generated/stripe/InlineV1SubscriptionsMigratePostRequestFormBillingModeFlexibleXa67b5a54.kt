...
public class InlineV1SubscriptionsMigratePostRequestFormBillingModeFlexibleXa67b5a54(
    public val prorationDiscounts: InlineV1SubscriptionsMigratePostRequestFormProrationDiscountsX3783d0cc? = null,
) {
    public class Builder {
        public var prorationDiscounts:
            InlineV1SubscriptionsMigratePostRequestFormProrationDiscountsX3783d0cc? = null

        public fun build(): InlineV1SubscriptionsMigratePostRequestFormBillingModeFlexibleXa67b5a54 =
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1SubscriptionsMigratePostRequestFormBillingModeFlexibleXa67b5a54 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1SubscriptionsMigratePostRequestFormBillingModeFlexibleXa67b5a54> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SubscriptionsMigratePostRequestFormBillingModeFlexibleXa67b5a54 must be a JSON object",
                    )
            return InlineV1SubscriptionsMigratePostRequestFormBillingModeFlexibleXa67b5a54(
                prorationDiscounts =
                    rawObject["proration_discounts"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SubscriptionsMigratePostRequestFormProrationDiscountsX3783d0cc>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsMigratePostRequestFormBillingModeFlexibleXa67b5a54,
        ) {
            val jsonEncoder =
...
public fun inlineV1SubscriptionsMigratePostRequestFormBillingModeFlexibleXa67b5a54(
    block: InlineV1SubscriptionsMigratePostRequestFormBillingModeFlexibleXa67b5a54.Builder.() -> Unit,
): InlineV1SubscriptionsMigratePostRequestFormBillingModeFlexibleXa67b5a54 =
    InlineV1SubscriptionsMigratePostRequestFormBillingModeFlexibleXa67b5a54.build(block)
