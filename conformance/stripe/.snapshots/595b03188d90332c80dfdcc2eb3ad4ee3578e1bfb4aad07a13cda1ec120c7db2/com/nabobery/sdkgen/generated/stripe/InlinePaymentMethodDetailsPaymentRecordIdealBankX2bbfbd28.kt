...
public sealed class InlinePaymentMethodDetailsPaymentRecordIdealBankX2bbfbd28 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentMethodDetailsPaymentRecordIdealBankX2bbfbd28 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlinePaymentMethodDetailsPaymentRecordIdealBankX2bbfbd28> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentMethodDetailsPaymentRecordIdealBankX2bbfbd28",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePaymentMethodDetailsPaymentRecordIdealBankX2bbfbd28 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentMethodDetailsPaymentRecordIdealBankX2bbfbd28,
        ) {
