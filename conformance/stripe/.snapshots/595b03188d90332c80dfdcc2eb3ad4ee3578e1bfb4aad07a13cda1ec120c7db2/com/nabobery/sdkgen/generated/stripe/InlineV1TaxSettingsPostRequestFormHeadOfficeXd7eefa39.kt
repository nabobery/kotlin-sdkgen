...
public class InlineV1TaxSettingsPostRequestFormHeadOfficeXd7eefa39(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TaxSettingsPostRequestFormHeadOfficeXd7eefa39 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TaxSettingsPostRequestFormHeadOfficeXd7eefa39> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TaxSettingsPostRequestFormHeadOfficeXd7eefa39 must be a JSON object",
                    )
            val address =
                json.decodeRequired<InlineV1TaxSettingsPostRequestFormHeadOfficeAddressXd0a4442d>(
                    rawObject,
                    "address",
                )
            return InlineV1TaxSettingsPostRequestFormHeadOfficeXd7eefa39(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TaxSettingsPostRequestFormHeadOfficeXd7eefa39,
        ) {
...
public fun inlineV1TaxSettingsPostRequestFormHeadOfficeXd7eefa39(
    block: InlineV1TaxSettingsPostRequestFormHeadOfficeXd7eefa39.Builder.() -> Unit,
): InlineV1TaxSettingsPostRequestFormHeadOfficeXd7eefa39 =
    InlineV1TaxSettingsPostRequestFormHeadOfficeXd7eefa39.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TaxSettingsPostRequestFormHeadOfficeXd7eefa39 is missing required property '" + name + "'",
            )
