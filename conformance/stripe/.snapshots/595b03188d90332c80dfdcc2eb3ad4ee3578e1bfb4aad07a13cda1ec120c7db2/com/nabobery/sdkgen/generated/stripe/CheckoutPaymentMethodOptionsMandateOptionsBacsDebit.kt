...
public class CheckoutPaymentMethodOptionsMandateOptionsBacsDebit(
    ...
    public class Builder {
        ...
        public fun build(): CheckoutPaymentMethodOptionsMandateOptionsBacsDebit =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): CheckoutPaymentMethodOptionsMandateOptionsBacsDebit =
    ...
    public object Serializer : KSerializer<CheckoutPaymentMethodOptionsMandateOptionsBacsDebit> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "CheckoutPaymentMethodOptionsMandateOptionsBacsDebit must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: CheckoutPaymentMethodOptionsMandateOptionsBacsDebit,
        ) {
...
public fun checkoutPaymentMethodOptionsMandateOptionsBacsDebit(
    block: CheckoutPaymentMethodOptionsMandateOptionsBacsDebit.Builder.() -> Unit,
): CheckoutPaymentMethodOptionsMandateOptionsBacsDebit =
    CheckoutPaymentMethodOptionsMandateOptionsBacsDebit.build(block)
