...
public class InlineV1PaymentMethodConfigurationsPostRequestFormPaytoX431cc369(
    public val displayPreference: InlineV1PaymentMethodConfidc49PostRequestFormPaytoDisplayPreferenceX77c70bb5? = null,
) {
    public class Builder {
        public var displayPreference:
            InlineV1PaymentMethodConfidc49PostRequestFormPaytoDisplayPreferenceX77c70bb5? = null

        public fun build(): InlineV1PaymentMethodConfigurationsPostRequestFormPaytoX431cc369 =
            InlineV1PaymentMethodConfigurationsPostRequestFormPaytoX431cc369(
                displayPreference = displayPreference,
            )
    }

    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PaymentMethodConfigurationsPostRequestFormPaytoX431cc369 =
    ...
    public object Serializer : KSerializer<InlineV1PaymentMethodConfigurationsPostRequestFormPaytoX431cc369> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentMethodConfigurationsPostRequestFormPaytoX431cc369 must be a JSON object",
                    )
            return InlineV1PaymentMethodConfigurationsPostRequestFormPaytoX431cc369(
                displayPreference =
                    rawObject["display_preference"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentMethodConfidc49PostRequestFormPaytoDisplayPreferenceX77c70bb5>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentMethodConfigurationsPostRequestFormPaytoX431cc369,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentMethodConfigurationsPostRequestFormPaytoX431cc369(
    block: InlineV1PaymentMethodConfigurationsPostRequestFormPaytoX431cc369.Builder.() -> Unit,
): InlineV1PaymentMethodConfigurationsPostRequestFormPaytoX431cc369 =
