...
public class InlineV1IssuingCardsGetParameterX6e0c501a internal constructor(
    ...
    public val inlineV1IssuingCardsGetParameterAnyOf1X591815e9:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1IssuingCardsGetParameterAnyOf1X591815e9) {
                json
                    .decodeFromJsonElement<InlineV1IssuingCardsGetParameterAnyOf1X591815e9>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1IssuingCardsGetParameterX6e0c501aBranch>
        get() =
            buildSet {
                if (inspection.matchesInlineV1IssuingCardsGetParameterAnyOf1X591815e9) {
                    add(
                        InlineV1IssuingCardsGetParameterX6e0c501aBranch.InlineV1IssuingCardsGetParameterAnyOf1X591815e9,
                    )
                }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1IssuingCardsGetParameterX6e0c501a {
            val inspection = inspectInlineV1IssuingCardsGetParameterX6e0c501a(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1IssuingCardsGetParameterX6e0c501aNoMatchException(
                    "InlineV1IssuingCardsGetParameterX6e0c501a matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1IssuingCardsGetParameterX6e0c501a> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingCardsGetParameterX6e0c501a,
        ) {
...
private fun inspectInlineV1IssuingCardsGetParameterX6e0c501a(
    element: JsonElement,
): InlineV1IssuingCardsGetParameterX6e0c501aInspection {
    val matchesInlineV1IssuingCardsGetParameterAnyOf1X591815e9 =
        element
            .isJsonDecodable<InlineV1IssuingCardsGetParameterAnyOf1X591815e9>()
    ...
    return InlineV1IssuingCardsGetParameterX6e0c501aInspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1IssuingCardsGetParameterAnyOf1X591815e9) {
                    add(
                        "InlineV1IssuingCardsGetParameterAnyOf1X591815e9: value does not match InlineV1IssuingCardsGetParameterAnyOf1X591815e9",
                    )
                }
