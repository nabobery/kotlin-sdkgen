...
public sealed class InlineMandatePaytoPaymentScheduleX3b38629b {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineMandatePaytoPaymentScheduleX3b38629b =
            when (value) {
                Adhoc.value -> Adhoc
                Annual.value -> Annual
                Daily.value -> Daily
    ...
    public object Serializer : KSerializer<InlineMandatePaytoPaymentScheduleX3b38629b> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineMandatePaytoPaymentScheduleX3b38629b",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineMandatePaytoPaymentScheduleX3b38629b =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineMandatePaytoPaymentScheduleX3b38629b,
        ) {
