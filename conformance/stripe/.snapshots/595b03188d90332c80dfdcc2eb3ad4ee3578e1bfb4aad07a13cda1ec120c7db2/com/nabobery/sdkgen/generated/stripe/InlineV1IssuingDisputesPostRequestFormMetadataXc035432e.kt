...
internal data class InlineV1IssuingDisputesPostRequestFormMetadataXc035432eInspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1IssuingDisputesPostRequestFormMetadataAnyOf2X37ef5172,
            ).count { it }
}
...
public class InlineV1IssuingDisputesPostRequestFormMetadataXc035432e internal constructor(
    ...
    public val inlineV1IssuingDisputesPostRequestFormMetadataAnyOf2X37ef5172:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1IssuingDisputesPostRequestFormMetadataAnyOf2X37ef5172) {
                json
                    .decodeFromJsonElement<InlineV1IssuingDisputesPostRequestFormMetadataAnyOf2X37ef5172>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1IssuingDisputesPostRequestFormMetadataXc035432eBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1IssuingDisputesPostRequestFormMetadataAnyOf2X37ef5172) {
                    add(
                        InlineV1IssuingDisputesPostRequestFormMetadataXc035432eBranch.InlineV1IssuingDisputesPostRequestFormMetadataAnyOf2X37ef5172,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1IssuingDisputesPostRequestFormMetadataXc035432e {
            val inspection = inspectInlineV1IssuingDisputesPostRequestFormMetadataXc035432e(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1IssuingDisputesPostRequestFormMetadataXc035432eNoMatchException(
                    "InlineV1IssuingDisputesPostRequestFormMetadataXc035432e matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1IssuingDisputesPostRequestFormMetadataXc035432e> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingDisputesPostRequestFormMetadataXc035432e,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1IssuingDisputesPostRequestFormMetadataXc035432e",
...
private fun inspectInlineV1IssuingDisputesPostRequestFormMetadataXc035432e(
    element: JsonElement,
): InlineV1IssuingDisputesPostRequestFormMetadataXc035432eInspection {
    val matchesBranch1 = element.isJsonDecodable<JsonObject>()
    val matchesInlineV1IssuingDisputesPostRequestFormMetadataAnyOf2X37ef5172 =
        element
            .isJsonDecodable<InlineV1IssuingDisputesPostRequestFormMetadataAnyOf2X37ef5172>()
    return InlineV1IssuingDisputesPostRequestFormMetadataXc035432eInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1IssuingDisputesPostRequestFormMetadataAnyOf2X37ef5172) {
                    add(
                        "InlineV1IssuingDisputesPostRequestFormMetadataAnyOf2X37ef5172: value does not match InlineV1IssuingDisputesPostRequestFormMetadataAnyOf2X37ef5172",
                    )
                }
            },
    )
