...
public class SetupAttemptPaymentMethodDetailsCardChecks(
    ...
    public class Builder {
        ...
        public fun build(): SetupAttemptPaymentMethodDetailsCardChecks =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): SetupAttemptPaymentMethodDetailsCardChecks =
    ...
    public object Serializer : KSerializer<SetupAttemptPaymentMethodDetailsCardChecks> {
        ...
        override fun deserialize(decoder: Decoder): SetupAttemptPaymentMethodDetailsCardChecks {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("SetupAttemptPaymentMethodDetailsCardChecks must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: SetupAttemptPaymentMethodDetailsCardChecks,
        ) {
...
public fun setupAttemptPaymentMethodDetailsCardChecks(
    block: SetupAttemptPaymentMethodDetailsCardChecks.Builder.() -> Unit,
): SetupAttemptPaymentMethodDetailsCardChecks = SetupAttemptPaymentMethodDetailsCardChecks.build(block)
