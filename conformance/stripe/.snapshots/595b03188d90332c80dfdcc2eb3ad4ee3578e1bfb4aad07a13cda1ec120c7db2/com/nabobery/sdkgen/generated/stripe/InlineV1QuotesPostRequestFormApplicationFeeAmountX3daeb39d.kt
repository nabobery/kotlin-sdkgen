...
internal data class InlineV1QuotesPostRequestFormApplicationFeeAmountX3daeb39dInspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1QuotesPostRequestFormApplicationFeeAmountAnyOf2X1b412b86,
            ).count { it }
}
...
public class InlineV1QuotesPostRequestFormApplicationFeeAmountX3daeb39d internal constructor(
    ...
    public val inlineV1QuotesPostRequestFormApplicationFeeAmountAnyOf2X1b412b86:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1QuotesPostRequestFormApplicationFeeAmountAnyOf2X1b412b86) {
                json
                    .decodeFromJsonElement<InlineV1QuotesPostRequestFormApplicationFeeAmountAnyOf2X1b412b86>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1QuotesPostRequestFormApplicationFeeAmountX3daeb39dBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1QuotesPostRequestFormApplicationFeeAmountAnyOf2X1b412b86) {
                    add(
                        InlineV1QuotesPostRequestFormApplicationFeeAmountX3daeb39dBranch.InlineV1QuotesPostRequestFormApplicationFeeAmountAnyOf2X1b412b86,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1QuotesPostRequestFormApplicationFeeAmountX3daeb39d {
            val inspection = inspectInlineV1QuotesPostRequestFormApplicationFeeAmountX3daeb39d(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1QuotesPostRequestFormApplicationFeeAmountX3daeb39dNoMatchException(
                    "InlineV1QuotesPostRequestFormApplicationFeeAmountX3daeb39d matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1QuotesPostRequestFormApplicationFeeAmountX3daeb39d> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1QuotesPostRequestFormApplicationFeeAmountX3daeb39d,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1QuotesPostRequestFormApplicationFeeAmountX3daeb39d",
...
private fun inspectInlineV1QuotesPostRequestFormApplicationFeeAmountX3daeb39d(
    element: JsonElement,
): InlineV1QuotesPostRequestFormApplicationFeeAmountX3daeb39dInspection {
    val matchesBranch1 = element.isJsonDecodable<Int>()
    val matchesInlineV1QuotesPostRequestFormApplicationFeeAmountAnyOf2X1b412b86 =
        element
            .isJsonDecodable<InlineV1QuotesPostRequestFormApplicationFeeAmountAnyOf2X1b412b86>()
    return InlineV1QuotesPostRequestFormApplicationFeeAmountX3daeb39dInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1QuotesPostRequestFormApplicationFeeAmountAnyOf2X1b412b86) {
                    add(
                        "InlineV1QuotesPostRequestFormApplicationFeeAmountAnyOf2X1b412b86: value does not match InlineV1QuotesPostRequestFormApplicationFeeAmountAnyOf2X1b412b86",
                    )
                }
            },
    )
