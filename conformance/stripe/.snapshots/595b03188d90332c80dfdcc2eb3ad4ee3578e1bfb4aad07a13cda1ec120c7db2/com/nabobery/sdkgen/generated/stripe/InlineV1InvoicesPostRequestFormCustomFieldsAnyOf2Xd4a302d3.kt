...
public sealed class InlineV1InvoicesPostRequestFormCustomFieldsAnyOf2Xd4a302d3 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1InvoicesPostRequestFormCustomFieldsAnyOf2Xd4a302d3 =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1InvoicesPostRequestFormCustomFieldsAnyOf2Xd4a302d3> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1InvoicesPostRequestFormCustomFieldsAnyOf2Xd4a302d3",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1InvoicesPostRequestFormCustomFieldsAnyOf2Xd4a302d3 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesPostRequestFormCustomFieldsAnyOf2Xd4a302d3,
        ) {
