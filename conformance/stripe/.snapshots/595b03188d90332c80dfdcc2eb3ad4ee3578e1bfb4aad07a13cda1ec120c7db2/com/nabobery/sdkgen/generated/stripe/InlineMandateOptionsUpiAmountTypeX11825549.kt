...
public sealed class InlineMandateOptionsUpiAmountTypeX11825549 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineMandateOptionsUpiAmountTypeX11825549 =
            when (value) {
                Fixed.value -> Fixed
    ...
    public object Serializer : KSerializer<InlineMandateOptionsUpiAmountTypeX11825549> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineMandateOptionsUpiAmountTypeX11825549",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineMandateOptionsUpiAmountTypeX11825549 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineMandateOptionsUpiAmountTypeX11825549,
        ) {
