...
public class TerminalConfigurationConfigurationResourceRebootWindow(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): TerminalConfigurationConfigurationResourceRebootWindow =
    ...
    public object Serializer : KSerializer<TerminalConfigurationConfigurationResourceRebootWindow> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "TerminalConfigurationConfigurationResourceRebootWindow must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: TerminalConfigurationConfigurationResourceRebootWindow,
        ) {
...
public fun terminalConfigurationConfigurationResourceRebootWindow(
    block: TerminalConfigurationConfigurationResourceRebootWindow.Builder.() -> Unit,
): TerminalConfigurationConfigurationResourceRebootWindow =
    TerminalConfigurationConfigurationResourceRebootWindow.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "TerminalConfigurationConfigurationResourceRebootWindow is missing required property '" + name + "'",
            )
