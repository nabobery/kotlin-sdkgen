...
public class InlineShippingRateTaxCodeX5b0a4373 internal constructor(
    ...
    public val taxCode: TaxCode? by
        lazy(
            LazyThreadSafetyMode.NONE,
        ) { if (inspection.matchesTaxCode) json.decodeFromJsonElement<TaxCode>(raw) else null }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineShippingRateTaxCodeX5b0a4373 {
            val inspection = inspectInlineShippingRateTaxCodeX5b0a4373(raw)
            if (inspection.matchCount == 0) {
                throw InlineShippingRateTaxCodeX5b0a4373NoMatchException(
                    "InlineShippingRateTaxCodeX5b0a4373 matched 0 branches: " + inspection.failures.joinToString("; "),
                )
            }
    ...
    public object Serializer : KSerializer<InlineShippingRateTaxCodeX5b0a4373> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineShippingRateTaxCodeX5b0a4373,
        ) {
...
private fun inspectInlineShippingRateTaxCodeX5b0a4373(
    element: JsonElement,
): InlineShippingRateTaxCodeX5b0a4373Inspection {
