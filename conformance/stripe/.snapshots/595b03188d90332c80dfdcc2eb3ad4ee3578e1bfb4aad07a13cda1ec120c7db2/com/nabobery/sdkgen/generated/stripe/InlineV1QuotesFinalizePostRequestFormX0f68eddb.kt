...
public class InlineV1QuotesFinalizePostRequestFormX0f68eddb(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1QuotesFinalizePostRequestFormX0f68eddb =
            InlineV1QuotesFinalizePostRequestFormX0f68eddb(
                expand = expand,
                expiresAt = expiresAt,
            )
    }
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1QuotesFinalizePostRequestFormX0f68eddb =
    ...
    public object Serializer : KSerializer<InlineV1QuotesFinalizePostRequestFormX0f68eddb> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1QuotesFinalizePostRequestFormX0f68eddb must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1QuotesFinalizePostRequestFormX0f68eddb,
        ) {
...
public fun inlineV1QuotesFinalizePostRequestFormX0f68eddb(
    block: InlineV1QuotesFinalizePostRequestFormX0f68eddb.Builder.() -> Unit,
): InlineV1QuotesFinalizePostRequestFormX0f68eddb = InlineV1QuotesFinalizePostRequestFormX0f68eddb.build(block)
