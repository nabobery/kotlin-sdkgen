...
public class InlineV1PaymentLinksPostRequestFormSubscriptionDataX3e396383(
    ...
    public val invoiceSettings: InlineV1PaymentLinksPostRequestFormSubscriptionDataInvoiceSettingsX227f812f? = null,
    public val metadata: Map<String, String>? = null,
    public val trialPeriodDays: Int? = null,
    public val trialSettings: InlineV1PaymentLinksPostRequestFormSubscriptionDataTrialSettingsXd2edc941? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1PaymentLinksPostRequestFormSubscriptionDataX3e396383 =
            InlineV1PaymentLinksPostRequestFormSubscriptionDataX3e396383(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PaymentLinksPostRequestFormSubscriptionDataX3e396383 =
    ...
    public object Serializer : KSerializer<InlineV1PaymentLinksPostRequestFormSubscriptionDataX3e396383> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentLinksPostRequestFormSubscriptionDataX3e396383 must be a JSON object",
                    )
            return InlineV1PaymentLinksPostRequestFormSubscriptionDataX3e396383(
                ...
                invoiceSettings =
                    rawObject["invoice_settings"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormSubscriptionDataInvoiceSettingsX227f812f>(
                                it,
                            )
                    },
                ...
                trialSettings =
                    rawObject["trial_settings"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormSubscriptionDataTrialSettingsXd2edc941>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentLinksPostRequestFormSubscriptionDataX3e396383,
        ) {
...
public fun inlineV1PaymentLinksPostRequestFormSubscriptionDataX3e396383(
    block: InlineV1PaymentLinksPostRequestFormSubscriptionDataX3e396383.Builder.() -> Unit,
): InlineV1PaymentLinksPostRequestFormSubscriptionDataX3e396383 =
    InlineV1PaymentLinksPostRequestFormSubscriptionDataX3e396383.build(block)
