...
public class InlineV1AccountSessionsPostRequestFormComponentsFinancialAccountX16c37f4a(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1AccountSessionsPostRequestFormComponentsFinancialAccountX16c37f4a = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1AccountSessionsPostRequestFormComponentsFinancialAccountX16c37f4a> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountSessionsPostRequestFormComponentsFinancialAccountX16c37f4a must be a JSON object",
                    )
            ...
            return InlineV1AccountSessionsPostRequestFormComponentsFinancialAccountX16c37f4a(
                ...
                features =
                    rawObject["features"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountSessionsPostRequestFormComponentsFeaturesX7fe3718a>(
                            it,
                        )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountSessionsPostRequestFormComponentsFinancialAccountX16c37f4a,
        ) {
            val jsonEncoder =
...
public fun inlineV1AccountSessionsPostRequestFormComponentsFinancialAccountX16c37f4a(
    block: InlineV1AccountSessionsPostRequestFormComponentsFinancialAccountX16c37f4a.Builder.() -> Unit,
): InlineV1AccountSessionsPostRequestFormComponentsFinancialAccountX16c37f4a =
    InlineV1AccountSessionsPostRequestFormComponentsFinancialAccountX16c37f4a.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1AccountSessionsPostRequestFormComponentsFinancialAccountX16c37f4a is missing required property '" +
                    name +
                    "'",
            )
