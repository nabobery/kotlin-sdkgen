...
public sealed class InlineV1ShippingRatesPostRequestFormDeliveryEstimateMinimumUnitXf22af00c {
    ...
    public object Serializer : KSerializer<InlineV1ShippingRatesPostRequestFormDeliveryEstimateMinimumUnitXf22af00c> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1ShippingRatesPostRequestFormDeliveryEstimateMinimumUnitXf22af00c",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1ShippingRatesPostRequestFormDeliveryEstimateMinimumUnitXf22af00c = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ShippingRatesPostRequestFormDeliveryEstimateMinimumUnitXf22af00c,
        ) {
