...
public class InlineV1ReportingReportRunsPostRequestFormParametersX2d2199bf(
    ...
    public val reportingCategory: InlineV1ReportingReportRunsPostRequestFormParametersReportingCategoryXea6b9172? = null,
    public val timezone: InlineV1ReportingReportRunsPostRequestFormParametersTimezoneXca3d8ed1? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1ReportingReportRunsPostRequestFormParametersX2d2199bf =
            InlineV1ReportingReportRunsPostRequestFormParametersX2d2199bf(
                columns = columns,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1ReportingReportRunsPostRequestFormParametersX2d2199bf =
    ...
    public object Serializer : KSerializer<InlineV1ReportingReportRunsPostRequestFormParametersX2d2199bf> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1ReportingReportRunsPostRequestFormParametersX2d2199bf {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1ReportingReportRunsPostRequestFormParametersX2d2199bf must be a JSON object",
                    )
            return InlineV1ReportingReportRunsPostRequestFormParametersX2d2199bf(
                ...
                reportingCategory =
                    rawObject["reporting_category"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1ReportingReportRunsPostRequestFormParametersReportingCategoryXea6b9172>(
                                it,
                            )
                    },
                timezone =
                    rawObject["timezone"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1ReportingReportRunsPostRequestFormParametersTimezoneXca3d8ed1>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ReportingReportRunsPostRequestFormParametersX2d2199bf,
        ) {
            val jsonEncoder =
...
public fun inlineV1ReportingReportRunsPostRequestFormParametersX2d2199bf(
    block: InlineV1ReportingReportRunsPostRequestFormParametersX2d2199bf.Builder.() -> Unit,
): InlineV1ReportingReportRunsPostRequestFormParametersX2d2199bf =
    InlineV1ReportingReportRunsPostRequestFormParametersX2d2199bf.build(block)
