...
public sealed class InlineDisputeObjectValueX8c08bfde {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineDisputeObjectValueX8c08bfde =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineDisputeObjectValueX8c08bfde> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineDisputeObjectValueX8c08bfde",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineDisputeObjectValueX8c08bfde =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineDisputeObjectValueX8c08bfde,
        ) {
