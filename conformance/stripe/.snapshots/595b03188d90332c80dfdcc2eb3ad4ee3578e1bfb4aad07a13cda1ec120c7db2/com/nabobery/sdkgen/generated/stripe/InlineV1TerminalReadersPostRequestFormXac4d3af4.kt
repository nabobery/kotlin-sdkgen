...
public class InlineV1TerminalReadersPostRequestFormXac4d3af4(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1TerminalReadersPostRequestFormXac4d3af4 =
            InlineV1TerminalReadersPostRequestFormXac4d3af4(
                expand = expand,
                label = label,
                metadata = metadata,
            )
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TerminalReadersPostRequestFormXac4d3af4 =
    ...
    public object Serializer : KSerializer<InlineV1TerminalReadersPostRequestFormXac4d3af4> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TerminalReadersPostRequestFormXac4d3af4 must be a JSON object",
                    )
            return InlineV1TerminalReadersPostRequestFormXac4d3af4(
                expand = rawObject["expand"]?.let { json.decodeFromJsonElement<List<String>>(it) },
                label =
                    rawObject["label"]?.let {
                        json.decodeFromJsonElement<InlineV1TerminalReadersPostRequestFormLabelX28f772fd>(it)
                    },
                metadata =
                    rawObject["metadata"]?.let {
                        json.decodeFromJsonElement<InlineV1TerminalReadersPostRequestFormMetadataXe4eddccb>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TerminalReadersPostRequestFormXac4d3af4,
        ) {
...
public fun inlineV1TerminalReadersPostRequestFormXac4d3af4(
    block: InlineV1TerminalReadersPostRequestFormXac4d3af4.Builder.() -> Unit,
): InlineV1TerminalReadersPostRequestFormXac4d3af4 = InlineV1TerminalReadersPostRequestFormXac4d3af4.build(block)
