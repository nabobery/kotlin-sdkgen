...
internal data class InlineV1SetupIntentsPostRequestFormPaymentsPerPeriodX3a9d7005Inspection(
    ...
    public val matchesInlineV1SetupIntentsPostRequestFormPaymentMethodOptionsPaytoAnyOf2X1a4ef782: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1SetupIntentsPostRequestFormPaymentMethodOptionsPaytoAnyOf2X1a4ef782,
            ).count {
                it
            }
}
...
public class InlineV1SetupIntentsPostRequestFormPaymentsPerPeriodX3a9d7005 internal constructor(
    ...
    public val inlineV1SetupIntentsPostRequestFormPaymentMethodOptionsPaytoAnyOf2X1a4ef782:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1SetupIntentsPostRequestFormPaymentMethodOptionsPaytoAnyOf2X1a4ef782) {
                json
                    .decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsPaytoAnyOf2X1a4ef782>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1SetupIntentsPostRequestFormPaymentsPerPeriodX3a9d7005Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1SetupIntentsPostRequestFormPaymentMethodOptionsPaytoAnyOf2X1a4ef782) {
                    add(
                        InlineV1SetupIntentsPostRequestFormPaymentsPerPeriodX3a9d7005Branch.InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsPaytoAnyOf2X1a4ef782,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1SetupIntentsPostRequestFormPaymentsPerPeriodX3a9d7005 {
            val inspection = inspectInlineV1SetupIntentsPostRequestFormPaymentsPerPeriodX3a9d7005(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1SetupIntentsPostRequestFormPaymentsPerPeriodX3a9d7005NoMatchException(
                    "InlineV1SetupIntentsPostRequestFormPaymentsPerPeriodX3a9d7005 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1SetupIntentsPostRequestFormPaymentsPerPeriodX3a9d7005> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SetupIntentsPostRequestFormPaymentsPerPeriodX3a9d7005,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1SetupIntentsPostRequestFormPaymentsPerPeriodX3a9d7005",
...
private fun inspectInlineV1SetupIntentsPostRequestFormPaymentsPerPeriodX3a9d7005(
    element: JsonElement,
): InlineV1SetupIntentsPostRequestFormPaymentsPerPeriodX3a9d7005Inspection {
    val matchesBranch1 = element.isJsonDecodable<Int>()
    val matchesInlineV1SetupIntentsPostRequestFormPaymentMethodOptionsPaytoAnyOf2X1a4ef782 =
        element
            .isJsonDecodable<InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsPaytoAnyOf2X1a4ef782>()
    return InlineV1SetupIntentsPostRequestFormPaymentsPerPeriodX3a9d7005Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1SetupIntentsPostRequestFormPaymentMethodOptionsPaytoAnyOf2X1a4ef782) {
                    add(
                        "InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsPaytoAnyOf2X1a4ef782: value does not match InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsPaytoAnyOf2X1a4ef782",
                    )
                }
            },
    )
