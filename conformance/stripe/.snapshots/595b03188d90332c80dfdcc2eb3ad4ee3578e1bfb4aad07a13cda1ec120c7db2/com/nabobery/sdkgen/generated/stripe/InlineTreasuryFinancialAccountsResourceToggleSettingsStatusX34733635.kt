...
public sealed class InlineTreasuryFinancialAccountsResourceToggleSettingsStatusX34733635 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineTreasuryFinancialAccountsResourceToggleSettingsStatusX34733635 =
            when (value) {
                Active.value -> Active
    ...
    public object Serializer : KSerializer<InlineTreasuryFinancialAccountsResourceToggleSettingsStatusX34733635> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineTreasuryFinancialAccountsResourceToggleSettingsStatusX34733635",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineTreasuryFinancialAccountsResourceToggleSettingsStatusX34733635 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineTreasuryFinancialAccountsResourceToggleSettingsStatusX34733635,
        ) {
