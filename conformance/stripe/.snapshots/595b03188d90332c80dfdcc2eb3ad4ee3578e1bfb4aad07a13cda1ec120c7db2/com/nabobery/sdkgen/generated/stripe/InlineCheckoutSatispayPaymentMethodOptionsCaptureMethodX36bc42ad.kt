...
public sealed class InlineCheckoutSatispayPaymentMethodOptionsCaptureMethodX36bc42ad {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineCheckoutSatispayPaymentMethodOptionsCaptureMethodX36bc42ad =
            when (value) {
                Manual.value -> Manual
    ...
    public object Serializer : KSerializer<InlineCheckoutSatispayPaymentMethodOptionsCaptureMethodX36bc42ad> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineCheckoutSatispayPaymentMethodOptionsCaptureMethodX36bc42ad",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineCheckoutSatispayPaymentMethodOptionsCaptureMethodX36bc42ad =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineCheckoutSatispayPaymentMethodOptionsCaptureMethodX36bc42ad,
        ) {
