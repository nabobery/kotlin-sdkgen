...
public sealed class InlineRecurringIntervalX408cd922 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineRecurringIntervalX408cd922 =
            when (value) {
                Day.value -> Day
                Month.value -> Month
                Week.value -> Week
    ...
    public object Serializer : KSerializer<InlineRecurringIntervalX408cd922> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineRecurringIntervalX408cd922",
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineRecurringIntervalX408cd922,
        ) {
