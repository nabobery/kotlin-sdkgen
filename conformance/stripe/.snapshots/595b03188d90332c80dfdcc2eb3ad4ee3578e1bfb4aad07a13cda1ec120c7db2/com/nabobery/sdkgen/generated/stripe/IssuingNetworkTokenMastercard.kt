...
public class IssuingNetworkTokenMastercard(
    ...
    public object Serializer : KSerializer<IssuingNetworkTokenMastercard> {
        ...
        override fun deserialize(decoder: Decoder): IssuingNetworkTokenMastercard {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("IssuingNetworkTokenMastercard must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: IssuingNetworkTokenMastercard,
        ) {
...
public fun issuingNetworkTokenMastercard(
    block: IssuingNetworkTokenMastercard.Builder.() -> Unit,
): IssuingNetworkTokenMastercard = IssuingNetworkTokenMastercard.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException("IssuingNetworkTokenMastercard is missing required property '" + name + "'")
