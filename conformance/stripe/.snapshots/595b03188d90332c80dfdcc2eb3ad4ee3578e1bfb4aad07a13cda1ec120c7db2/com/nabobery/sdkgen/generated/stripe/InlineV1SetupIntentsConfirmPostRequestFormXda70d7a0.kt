...
public class InlineV1SetupIntentsConfirmPostRequestFormXda70d7a0(
     ...
     */
    public val paymentMethodData: InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodDataX5f0fda72? = null,
    /**
     * Payment method-specific configuration for this SetupIntent.
     */
    public val paymentMethodOptions: InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsXeaa3e292? = null,
    /**
    ...
    public class Builder {
        ...
        public fun build(): InlineV1SetupIntentsConfirmPostRequestFormXda70d7a0 =
            InlineV1SetupIntentsConfirmPostRequestFormXda70d7a0(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1SetupIntentsConfirmPostRequestFormXda70d7a0 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1SetupIntentsConfirmPostRequestFormXda70d7a0> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SetupIntentsConfirmPostRequestFormXda70d7a0 must be a JSON object",
                    )
            return InlineV1SetupIntentsConfirmPostRequestFormXda70d7a0(
                ...
                mandateData =
                    rawObject["mandate_data"]?.let {
                        json.decodeFromJsonElement<InlineV1SetupIntentsConfirmPostRequestFormMandateDataX56a54597>(it)
                    },
                paymentMethod = rawObject["payment_method"]?.let { json.decodeFromJsonElement<String>(it) },
                paymentMethodData =
                    rawObject["payment_method_data"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodDataX5f0fda72>(
                                it,
                            )
                    },
                paymentMethodOptions =
                    rawObject["payment_method_options"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsXeaa3e292>(
                                it,
                            )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SetupIntentsConfirmPostRequestFormXda70d7a0,
        ) {
...
public fun inlineV1SetupIntentsConfirmPostRequestFormXda70d7a0(
    block: InlineV1SetupIntentsConfirmPostRequestFormXda70d7a0.Builder.() -> Unit,
): InlineV1SetupIntentsConfirmPostRequestFormXda70d7a0 =
    InlineV1SetupIntentsConfirmPostRequestFormXda70d7a0.build(block)
