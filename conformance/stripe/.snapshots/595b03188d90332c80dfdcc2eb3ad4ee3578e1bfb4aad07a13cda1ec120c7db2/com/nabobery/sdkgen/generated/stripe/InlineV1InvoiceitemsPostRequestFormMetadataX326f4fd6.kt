...
public class InlineV1InvoiceitemsPostRequestFormMetadataX326f4fd6 internal constructor(
    ...
    public val inlineV1InvoiceitemsPostRequestFormMetadataAnyOf2X73255d4e:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1InvoiceitemsPostRequestFormMetadataAnyOf2X73255d4e) {
                json
                    .decodeFromJsonElement<InlineV1InvoiceitemsPostRequestFormMetadataAnyOf2X73255d4e>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1InvoiceitemsPostRequestFormMetadataX326f4fd6Branch>
        get() =
            buildSet {
                ...
                if (inspection.matchesInlineV1InvoiceitemsPostRequestFormMetadataAnyOf2X73255d4e) {
                    add(
                        InlineV1InvoiceitemsPostRequestFormMetadataX326f4fd6Branch.InlineV1InvoiceitemsPostRequestFormMetadataAnyOf2X73255d4e,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1InvoiceitemsPostRequestFormMetadataX326f4fd6 {
            val inspection = inspectInlineV1InvoiceitemsPostRequestFormMetadataX326f4fd6(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1InvoiceitemsPostRequestFormMetadataX326f4fd6NoMatchException(
                    "InlineV1InvoiceitemsPostRequestFormMetadataX326f4fd6 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1InvoiceitemsPostRequestFormMetadataX326f4fd6> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoiceitemsPostRequestFormMetadataX326f4fd6,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1InvoiceitemsPostRequestFormMetadataX326f4fd6",
...
private fun inspectInlineV1InvoiceitemsPostRequestFormMetadataX326f4fd6(
    element: JsonElement,
): InlineV1InvoiceitemsPostRequestFormMetadataX326f4fd6Inspection {
    val matchesBranch1 = element.isJsonDecodable<JsonObject>()
    val matchesInlineV1InvoiceitemsPostRequestFormMetadataAnyOf2X73255d4e =
        element
            .isJsonDecodable<InlineV1InvoiceitemsPostRequestFormMetadataAnyOf2X73255d4e>()
    return InlineV1InvoiceitemsPostRequestFormMetadataX326f4fd6Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1InvoiceitemsPostRequestFormMetadataAnyOf2X73255d4e) {
                    add(
                        "InlineV1InvoiceitemsPostRequestFormMetadataAnyOf2X73255d4e: value does not match InlineV1InvoiceitemsPostRequestFormMetadataAnyOf2X73255d4e",
                    )
                }
            },
    )
