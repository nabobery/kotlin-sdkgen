...
public sealed class InlinePayoutTypeX1e2cc1d0 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePayoutTypeX1e2cc1d0 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlinePayoutTypeX1e2cc1d0> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePayoutTypeX1e2cc1d0",
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlinePayoutTypeX1e2cc1d0,
        ) {
