...
public sealed class InlineV1TerminalLocationsPostRequestFormDisplayNameKanjiAnyOf2Xa4ad03ef {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1TerminalLocationsPostRequestFormDisplayNameKanjiAnyOf2Xa4ad03ef =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1TerminalLocationsPostRequestFormDisplayNameKanjiAnyOf2Xa4ad03ef> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1TerminalLocationsPostRequestFormDisplayNameKanjiAnyOf2Xa4ad03ef",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1TerminalLocationsPostRequestFormDisplayNameKanjiAnyOf2Xa4ad03ef = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TerminalLocationsPostRequestFormDisplayNameKanjiAnyOf2Xa4ad03ef,
        ) {
