...
public class InlineV1CheckoutSessionsGetParameterX224caacf internal constructor(
    ...
    public val inlineV1CheckoutSessionsGetParameterAnyOf1X5f6716b0:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1CheckoutSessionsGetParameterAnyOf1X5f6716b0) {
                json
                    .decodeFromJsonElement<InlineV1CheckoutSessionsGetParameterAnyOf1X5f6716b0>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1CheckoutSessionsGetParameterX224caacfBranch>
        get() =
            buildSet {
                if (inspection.matchesInlineV1CheckoutSessionsGetParameterAnyOf1X5f6716b0) {
                    add(
                        InlineV1CheckoutSessionsGetParameterX224caacfBranch.InlineV1CheckoutSessionsGetParameterAnyOf1X5f6716b0,
                    )
                }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1CheckoutSessionsGetParameterX224caacf {
            val inspection = inspectInlineV1CheckoutSessionsGetParameterX224caacf(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1CheckoutSessionsGetParameterX224caacfNoMatchException(
                    "InlineV1CheckoutSessionsGetParameterX224caacf matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1CheckoutSessionsGetParameterX224caacf> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsGetParameterX224caacf,
        ) {
...
private fun inspectInlineV1CheckoutSessionsGetParameterX224caacf(
    element: JsonElement,
): InlineV1CheckoutSessionsGetParameterX224caacfInspection {
    val matchesInlineV1CheckoutSessionsGetParameterAnyOf1X5f6716b0 =
        element
            .isJsonDecodable<InlineV1CheckoutSessionsGetParameterAnyOf1X5f6716b0>()
    ...
    return InlineV1CheckoutSessionsGetParameterX224caacfInspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1CheckoutSessionsGetParameterAnyOf1X5f6716b0) {
                    add(
                        "InlineV1CheckoutSessionsGetParameterAnyOf1X5f6716b0: value does not match InlineV1CheckoutSessionsGetParameterAnyOf1X5f6716b0",
                    )
                }
