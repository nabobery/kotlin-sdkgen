...
public class InlineV1BillingCreditGrantsPostRequestFormApplicabilityConfigScopeItemXf9106dc8(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1BillingCreditGrantsPostRequestFormApplicabilityConfigScopeItemXf9106dc8 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1BillingCreditGrantsPostRequestFormApplicabilityConfigScopeItemXf9106dc8> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1BillingCreditGrantsPostRequestFormApplicabilityConfigScopeItemXf9106dc8 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1BillingCreditGrantsPostRequestFormApplicabilityConfigScopeItemXf9106dc8,
        ) {
            val jsonEncoder =
...
public fun inlineV1BillingCreditGrantsPostRequestFormApplicabilityConfigScopeItemXf9106dc8(
    block: InlineV1BillingCreditGrantsPostRequestFormApplicabilityConfigScopeItemXf9106dc8.Builder.() -> Unit,
): InlineV1BillingCreditGrantsPostRequestFormApplicabilityConfigScopeItemXf9106dc8 =
    InlineV1BillingCreditGrantsPostRequestFormApplicabilityConfigScopeItemXf9106dc8.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1BillingCreditGrantsPostRequestFormApplicabilityConfigScopeItemXf9106dc8 is missing required property '" +
                    name +
                    "'",
            )
