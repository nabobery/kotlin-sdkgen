...
internal data class InlineV1InvoicesPostRequestFormPaymentSettingsPaymentMethodOptionsUpiX74f0e331Inspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1Xb5405e6e,
                matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2Xc75f25a9,
            ).count {
                it
            }
}
...
public class InlineV1InvoicesPostRequestFormPaymentSettingsPaymentMethodOptionsUpiX74f0e331 internal constructor(
    ...
    private val inspection: InlineV1InvoicesPostRequestFormPaymentSettingsPaymentMethodOptionsUpiX74f0e331Inspection,
) {
    public val inlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1Xb5405e6e:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1Xb5405e6e) {
                json
                    .decodeFromJsonElement<InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1Xb5405e6e>(
                        raw,
                    )
            } else {
                null
    ...
    public val inlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2Xc75f25a9:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2Xc75f25a9) {
                json
                    .decodeFromJsonElement<InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2Xc75f25a9>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches:
        ...
        get() =
            buildSet {
                if (inspection.matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1Xb5405e6e) {
                    add(
                        InlineV1InvoicesPostRequestFormPaymentSettingsPaymentMethodOptionsUpiX74f0e331Branch.InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1Xb5405e6e,
                    )
                }
                if (inspection.matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2Xc75f25a9) {
                    add(
                        InlineV1InvoicesPostRequestFormPaymentSettingsPaymentMethodOptionsUpiX74f0e331Branch.InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2Xc75f25a9,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1InvoicesPostRequestFormPaymentSettingsPaymentMethodOptionsUpiX74f0e331 {
            val inspection = inspectInlineV1InvoicesPostRequestFormPaymentSettingsPaymentMethodOptionsUpiX74f0e331(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1InvoicesPostRequestFormPaymentSettingsPaymentMethodOptionsUpiX74f0e331NoMatchException(
                    "InlineV1InvoicesPostRequestFormPaymentSettingsPaymentMethodOptionsUpiX74f0e331 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1InvoicesPostRequestFormPaymentSettingsPaymentMethodOptionsUpiX74f0e331> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesPostRequestFormPaymentSettingsPaymentMethodOptionsUpiX74f0e331,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1InvoicesPostRequestFormPaymentSettingsPaymentMethodOptionsUpiX74f0e331",
...
private fun inspectInlineV1InvoicesPostRequestFormPaymentSettingsPaymentMethodOptionsUpiX74f0e331(
    element: JsonElement,
): InlineV1InvoicesPostRequestFormPaymentSettingsPaymentMethodOptionsUpiX74f0e331Inspection {
    val matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1Xb5405e6e =
        element
            .isJsonDecodable<InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1Xb5405e6e>()
    val matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2Xc75f25a9 =
        element
            .isJsonDecodable<InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2Xc75f25a9>()
    return InlineV1InvoicesPostRequestFormPaymentSettingsPaymentMethodOptionsUpiX74f0e331Inspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1Xb5405e6e) {
                    add(
                        "InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1Xb5405e6e: value does not match InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1Xb5405e6e",
                    )
                }
                if (!matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2Xc75f25a9) {
                    add(
                        "InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2Xc75f25a9: value does not match InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2Xc75f25a9",
                    )
                }
            },
    )
