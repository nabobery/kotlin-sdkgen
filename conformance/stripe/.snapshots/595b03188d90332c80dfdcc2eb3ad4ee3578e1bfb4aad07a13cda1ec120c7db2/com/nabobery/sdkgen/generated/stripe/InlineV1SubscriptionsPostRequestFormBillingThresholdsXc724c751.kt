...
internal data class InlineV1SubscriptionsPostRequestFormBillingThresholdsXc724c751Inspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesInlineV1SubscriptionsPostRequestFormBillingThresholdsAnyOf1Xe583e323,
                matchesInlineV1SubscriptionsPostRequestFormBillingThresholdsAnyOf2X21ace90b,
            ).count {
                it
            }
}
...
public class InlineV1SubscriptionsPostRequestFormBillingThresholdsXc724c751 internal constructor(
    ...
    public val inlineV1SubscriptionsPostRequestFormBillingThresholdsAnyOf1Xe583e323:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1SubscriptionsPostRequestFormBillingThresholdsAnyOf1Xe583e323) {
                json
                    .decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormBillingThresholdsAnyOf1Xe583e323>(
                        raw,
                    )
            } else {
                null
    ...
    public val inlineV1SubscriptionsPostRequestFormBillingThresholdsAnyOf2X21ace90b:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1SubscriptionsPostRequestFormBillingThresholdsAnyOf2X21ace90b) {
                json
                    .decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormBillingThresholdsAnyOf2X21ace90b>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches:
        ...
        get() =
            buildSet {
                if (inspection.matchesInlineV1SubscriptionsPostRequestFormBillingThresholdsAnyOf1Xe583e323) {
                    add(
                        InlineV1SubscriptionsPostRequestFormBillingThresholdsXc724c751Branch.InlineV1SubscriptionsPostRequestFormBillingThresholdsAnyOf1Xe583e323,
                    )
                }
                if (inspection.matchesInlineV1SubscriptionsPostRequestFormBillingThresholdsAnyOf2X21ace90b) {
                    add(
                        InlineV1SubscriptionsPostRequestFormBillingThresholdsXc724c751Branch.InlineV1SubscriptionsPostRequestFormBillingThresholdsAnyOf2X21ace90b,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1SubscriptionsPostRequestFormBillingThresholdsXc724c751 {
            val inspection = inspectInlineV1SubscriptionsPostRequestFormBillingThresholdsXc724c751(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1SubscriptionsPostRequestFormBillingThresholdsXc724c751NoMatchException(
                    "InlineV1SubscriptionsPostRequestFormBillingThresholdsXc724c751 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionsPostRequestFormBillingThresholdsXc724c751> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsPostRequestFormBillingThresholdsXc724c751,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1SubscriptionsPostRequestFormBillingThresholdsXc724c751",
...
private fun inspectInlineV1SubscriptionsPostRequestFormBillingThresholdsXc724c751(
    element: JsonElement,
): InlineV1SubscriptionsPostRequestFormBillingThresholdsXc724c751Inspection {
    val matchesInlineV1SubscriptionsPostRequestFormBillingThresholdsAnyOf1Xe583e323 =
        element
            .isJsonDecodable<InlineV1SubscriptionsPostRequestFormBillingThresholdsAnyOf1Xe583e323>()
    val matchesInlineV1SubscriptionsPostRequestFormBillingThresholdsAnyOf2X21ace90b =
        element
            .isJsonDecodable<InlineV1SubscriptionsPostRequestFormBillingThresholdsAnyOf2X21ace90b>()
    return InlineV1SubscriptionsPostRequestFormBillingThresholdsXc724c751Inspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1SubscriptionsPostRequestFormBillingThresholdsAnyOf1Xe583e323) {
                    add(
                        "InlineV1SubscriptionsPostRequestFormBillingThresholdsAnyOf1Xe583e323: value does not match InlineV1SubscriptionsPostRequestFormBillingThresholdsAnyOf1Xe583e323",
                    )
                }
                if (!matchesInlineV1SubscriptionsPostRequestFormBillingThresholdsAnyOf2X21ace90b) {
                    add(
                        "InlineV1SubscriptionsPostRequestFormBillingThresholdsAnyOf2X21ace90b: value does not match InlineV1SubscriptionsPostRequestFormBillingThresholdsAnyOf2X21ace90b",
                    )
                }
            },
    )
