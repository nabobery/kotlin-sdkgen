...
public class AccountRequirements(
    ...
    public class Builder {
        ...
        public fun build(): AccountRequirements =
            AccountRequirements(
        ...
        override fun deserialize(decoder: Decoder): AccountRequirements {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("AccountRequirements must be a JSON object")
                ...
                disabledReason =
                    rawObject["disabled_reason"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineAccountRequirementsDisabledReasonX6c89d1f6?>(element)
                        }
                    },
                errors =
...
public fun accountRequirements(block: AccountRequirements.Builder.() -> Unit): AccountRequirements =
    AccountRequirements.build(block)
