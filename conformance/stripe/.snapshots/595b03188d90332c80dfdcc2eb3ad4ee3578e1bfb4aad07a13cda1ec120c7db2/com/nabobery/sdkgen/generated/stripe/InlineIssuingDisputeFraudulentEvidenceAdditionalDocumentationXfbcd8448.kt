...
public class InlineIssuingDisputeFraudulentEvidenceAdditionalDocumentationXfbcd8448 internal constructor(
    ...
    private val inspection: InlineIssuingDisputeFraudulentEvidenceAdditionalDocumentationXfbcd8448Inspection,
) {
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineIssuingDisputeFraudulentEvidenceAdditionalDocumentationXfbcd8448Branch.Branch1,
                    )
                }
                if (inspection.matchesFile) {
                    add(
                        InlineIssuingDisputeFraudulentEvidenceAdditionalDocumentationXfbcd8448Branch.File,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineIssuingDisputeFraudulentEvidenceAdditionalDocumentationXfbcd8448 {
            val inspection = inspectInlineIssuingDisputeFraudulentEvidenceAdditionalDocumentationXfbcd8448(raw)
            if (inspection.matchCount == 0) {
                throw InlineIssuingDisputeFraudulentEvidenceAdditionalDocumentationXfbcd8448NoMatchException(
                    "InlineIssuingDisputeFraudulentEvidenceAdditionalDocumentationXfbcd8448 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineIssuingDisputeFraudulentEvidenceAdditionalDocumentationXfbcd8448> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineIssuingDisputeFraudulentEvidenceAdditionalDocumentationXfbcd8448,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineIssuingDisputeFraudulentEvidenceAdditionalDocumentationXfbcd8448",
...
private fun inspectInlineIssuingDisputeFraudulentEvidenceAdditionalDocumentationXfbcd8448(
    element: JsonElement,
