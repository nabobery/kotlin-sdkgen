...
internal data class InlineV1IssuingDisputesPostRequestFormEvidenceNoValidAuthorizationX7d333ec9Inspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesInlineV1IssuingDisputesPostRequestFormEvidenceAnyOf1X6c1c6c2c,
                matchesInlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2Xe572b9c0,
            ).count {
                it
            }
}
...
public class InlineV1IssuingDisputesPostRequestFormEvidenceNoValidAuthorizationX7d333ec9 internal constructor(
    ...
    private val inspection: InlineV1IssuingDisputesPostRequestFormEvidenceNoValidAuthorizationX7d333ec9Inspection,
) {
    public val inlineV1IssuingDisputesPostRequestFormEvidenceAnyOf1X6c1c6c2c:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1IssuingDisputesPostRequestFormEvidenceAnyOf1X6c1c6c2c) {
                json
                    .decodeFromJsonElement<InlineV1IssuingDisputesPostRequestFormEvidenceAnyOf1X6c1c6c2c>(
                        raw,
                    )
            } else {
                null
    ...
    public val inlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2Xe572b9c0:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2Xe572b9c0) {
                json
                    .decodeFromJsonElement<InlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2Xe572b9c0>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches:
        ...
        get() =
            buildSet {
                if (inspection.matchesInlineV1IssuingDisputesPostRequestFormEvidenceAnyOf1X6c1c6c2c) {
                    add(
                        InlineV1IssuingDisputesPostRequestFormEvidenceNoValidAuthorizationX7d333ec9Branch.InlineV1IssuingDisputesPostRequestFormEvidenceAnyOf1X6c1c6c2c,
                    )
                }
                if (inspection.matchesInlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2Xe572b9c0) {
                    add(
                        InlineV1IssuingDisputesPostRequestFormEvidenceNoValidAuthorizationX7d333ec9Branch.InlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2Xe572b9c0,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1IssuingDisputesPostRequestFormEvidenceNoValidAuthorizationX7d333ec9 {
            val inspection = inspectInlineV1IssuingDisputesPostRequestFormEvidenceNoValidAuthorizationX7d333ec9(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1IssuingDisputesPostRequestFormEvidenceNoValidAuthorizationX7d333ec9NoMatchException(
                    "InlineV1IssuingDisputesPostRequestFormEvidenceNoValidAuthorizationX7d333ec9 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1IssuingDisputesPostRequestFormEvidenceNoValidAuthorizationX7d333ec9> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingDisputesPostRequestFormEvidenceNoValidAuthorizationX7d333ec9,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1IssuingDisputesPostRequestFormEvidenceNoValidAuthorizationX7d333ec9",
...
private fun inspectInlineV1IssuingDisputesPostRequestFormEvidenceNoValidAuthorizationX7d333ec9(
    element: JsonElement,
): InlineV1IssuingDisputesPostRequestFormEvidenceNoValidAuthorizationX7d333ec9Inspection {
    val matchesInlineV1IssuingDisputesPostRequestFormEvidenceAnyOf1X6c1c6c2c =
        element
            .isJsonDecodable<InlineV1IssuingDisputesPostRequestFormEvidenceAnyOf1X6c1c6c2c>()
    val matchesInlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2Xe572b9c0 =
        element
            .isJsonDecodable<InlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2Xe572b9c0>()
    return InlineV1IssuingDisputesPostRequestFormEvidenceNoValidAuthorizationX7d333ec9Inspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1IssuingDisputesPostRequestFormEvidenceAnyOf1X6c1c6c2c) {
                    add(
                        "InlineV1IssuingDisputesPostRequestFormEvidenceAnyOf1X6c1c6c2c: value does not match InlineV1IssuingDisputesPostRequestFormEvidenceAnyOf1X6c1c6c2c",
                    )
                }
                if (!matchesInlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2Xe572b9c0) {
                    add(
                        "InlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2Xe572b9c0: value does not match InlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2Xe572b9c0",
                    )
                }
            },
    )
