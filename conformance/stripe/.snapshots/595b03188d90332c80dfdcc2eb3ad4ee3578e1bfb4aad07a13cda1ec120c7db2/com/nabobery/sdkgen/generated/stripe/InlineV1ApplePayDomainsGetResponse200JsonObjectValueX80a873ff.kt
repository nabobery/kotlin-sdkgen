...
public sealed class InlineV1ApplePayDomainsGetResponse200JsonObjectValueX80a873ff {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1ApplePayDomainsGetResponse200JsonObjectValueX80a873ff =
            when (value) {
                List.value -> List
    ...
    public object Serializer : KSerializer<InlineV1ApplePayDomainsGetResponse200JsonObjectValueX80a873ff> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1ApplePayDomainsGetResponse200JsonObjectValueX80a873ff",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1ApplePayDomainsGetResponse200JsonObjectValueX80a873ff =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ApplePayDomainsGetResponse200JsonObjectValueX80a873ff,
        ) {
