...
public sealed class InlineV1RefundsPostRequestFormMetadataAnyOf2X8684f3e2 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1RefundsPostRequestFormMetadataAnyOf2X8684f3e2 =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1RefundsPostRequestFormMetadataAnyOf2X8684f3e2> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1RefundsPostRequestFormMetadataAnyOf2X8684f3e2",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1RefundsPostRequestFormMetadataAnyOf2X8684f3e2 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1RefundsPostRequestFormMetadataAnyOf2X8684f3e2,
        ) {
