...
internal data class InlineV1PaymentIntentsPostRequestFormReferencePrefixXfb449ab2Inspection(
    ...
    public val matchesInlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAnyOf2Xee2c9b8b: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAnyOf2Xee2c9b8b,
            ).count {
                it
            }
}
...
public class InlineV1PaymentIntentsPostRequestFormReferencePrefixXfb449ab2 internal constructor(
    ...
    public val inlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAnyOf2Xee2c9b8b:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAnyOf2Xee2c9b8b) {
                json
                    .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAnyOf2Xee2c9b8b>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1PaymentIntentsPostRequestFormReferencePrefixXfb449ab2Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAnyOf2Xee2c9b8b) {
                    add(
                        InlineV1PaymentIntentsPostRequestFormReferencePrefixXfb449ab2Branch.InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAnyOf2Xee2c9b8b,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1PaymentIntentsPostRequestFormReferencePrefixXfb449ab2 {
            val inspection = inspectInlineV1PaymentIntentsPostRequestFormReferencePrefixXfb449ab2(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1PaymentIntentsPostRequestFormReferencePrefixXfb449ab2NoMatchException(
                    "InlineV1PaymentIntentsPostRequestFormReferencePrefixXfb449ab2 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormReferencePrefixXfb449ab2> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormReferencePrefixXfb449ab2,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1PaymentIntentsPostRequestFormReferencePrefixXfb449ab2",
...
private fun inspectInlineV1PaymentIntentsPostRequestFormReferencePrefixXfb449ab2(
    element: JsonElement,
): InlineV1PaymentIntentsPostRequestFormReferencePrefixXfb449ab2Inspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAnyOf2Xee2c9b8b =
        element
            .isJsonDecodable<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAnyOf2Xee2c9b8b>()
    return InlineV1PaymentIntentsPostRequestFormReferencePrefixXfb449ab2Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAnyOf2Xee2c9b8b) {
                    add(
                        "InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAnyOf2Xee2c9b8b: value does not match InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAnyOf2Xee2c9b8b",
                    )
                }
            },
    )
