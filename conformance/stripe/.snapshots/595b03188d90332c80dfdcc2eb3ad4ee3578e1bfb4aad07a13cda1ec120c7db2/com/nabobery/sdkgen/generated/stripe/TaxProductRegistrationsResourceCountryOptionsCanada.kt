...
public class TaxProductRegistrationsResourceCountryOptionsCanada(
    ...
    public val provinceStandard: TaxProductRegistrationsResourceCountryOptionsCaProvinceStandard? = null,
) {
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): TaxProductRegistrationsResourceCountryOptionsCanada =
    ...
    public object Serializer : KSerializer<TaxProductRegistrationsResourceCountryOptionsCanada> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "TaxProductRegistrationsResourceCountryOptionsCanada must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineTaxProductRegistrationsResourceCountryOptionsCanadaTypeX916e1e7b>(
                    rawObject,
                    "type",
                )
            return TaxProductRegistrationsResourceCountryOptionsCanada(
                ...
                provinceStandard =
                    rawObject["province_standard"]?.let {
                        json.decodeFromJsonElement<TaxProductRegistrationsResourceCountryOptionsCaProvinceStandard>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: TaxProductRegistrationsResourceCountryOptionsCanada,
        ) {
...
public fun taxProductRegistrationsResourceCountryOptionsCanada(
    block: TaxProductRegistrationsResourceCountryOptionsCanada.Builder.() -> Unit,
): TaxProductRegistrationsResourceCountryOptionsCanada =
    TaxProductRegistrationsResourceCountryOptionsCanada.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "TaxProductRegistrationsResourceCountryOptionsCanada is missing required property '" + name + "'",
            )
