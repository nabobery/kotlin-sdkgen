...
public sealed class InlineV1AccountsPostRequestFormIndividualPoliticalExposureX1cdcc72c {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1AccountsPostRequestFormIndividualPoliticalExposureX1cdcc72c =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1AccountsPostRequestFormIndividualPoliticalExposureX1cdcc72c> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1AccountsPostRequestFormIndividualPoliticalExposureX1cdcc72c",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1AccountsPostRequestFormIndividualPoliticalExposureX1cdcc72c = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPostRequestFormIndividualPoliticalExposureX1cdcc72c,
        ) {
