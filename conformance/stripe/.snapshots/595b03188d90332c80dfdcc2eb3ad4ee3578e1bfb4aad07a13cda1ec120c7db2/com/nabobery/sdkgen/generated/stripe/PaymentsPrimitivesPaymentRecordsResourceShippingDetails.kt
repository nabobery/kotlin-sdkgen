...
public class PaymentsPrimitivesPaymentRecordsResourceShippingDetails(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentsPrimitivesPaymentRecordsResourceShippingDetails =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentsPrimitivesPaymentRecordsResourceShippingDetails> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "PaymentsPrimitivesPaymentRecordsResourceShippingDetails must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentsPrimitivesPaymentRecordsResourceShippingDetails,
        ) {
...
public fun paymentsPrimitivesPaymentRecordsResourceShippingDetails(
    block: PaymentsPrimitivesPaymentRecordsResourceShippingDetails.Builder.() -> Unit,
): PaymentsPrimitivesPaymentRecordsResourceShippingDetails =
    PaymentsPrimitivesPaymentRecordsResourceShippingDetails.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "PaymentsPrimitivesPaymentRecordsResourceShippingDetails is missing required property '" + name + "'",
            )
