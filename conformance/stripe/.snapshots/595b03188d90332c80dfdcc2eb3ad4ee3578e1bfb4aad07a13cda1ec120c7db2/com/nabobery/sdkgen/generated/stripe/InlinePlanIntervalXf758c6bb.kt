...
public sealed class InlinePlanIntervalXf758c6bb {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePlanIntervalXf758c6bb =
            when (value) {
                Day.value -> Day
                Month.value -> Month
                Week.value -> Week
    ...
    public object Serializer : KSerializer<InlinePlanIntervalXf758c6bb> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePlanIntervalXf758c6bb",
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlinePlanIntervalXf758c6bb,
        ) {
