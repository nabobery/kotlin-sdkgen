...
public sealed class InlineV1IssuingCardholdersPostRequestFormPreferredLocalesItemX6c603048 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1IssuingCardholdersPostRequestFormPreferredLocalesItemX6c603048 =
            when (value) {
                De.value -> De
                En.value -> En
                Es.value -> Es
    ...
    public object Serializer : KSerializer<InlineV1IssuingCardholdersPostRequestFormPreferredLocalesItemX6c603048> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1IssuingCardholdersPostRequestFormPreferredLocalesItemX6c603048",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1IssuingCardholdersPostRequestFormPreferredLocalesItemX6c603048 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingCardholdersPostRequestFormPreferredLocalesItemX6c603048,
        ) {
