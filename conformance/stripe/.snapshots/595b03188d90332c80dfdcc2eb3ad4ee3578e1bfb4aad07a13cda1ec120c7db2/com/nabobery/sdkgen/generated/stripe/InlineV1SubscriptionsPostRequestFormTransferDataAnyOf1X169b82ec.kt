...
public class InlineV1SubscriptionsPostRequestFormTransferDataAnyOf1X169b82ec(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1SubscriptionsPostRequestFormTransferDataAnyOf1X169b82ec =
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionsPostRequestFormTransferDataAnyOf1X169b82ec> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SubscriptionsPostRequestFormTransferDataAnyOf1X169b82ec must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsPostRequestFormTransferDataAnyOf1X169b82ec,
        ) {
            val jsonEncoder =
...
public fun inlineV1SubscriptionsPostRequestFormTransferDataAnyOf1X169b82ec(
    block: InlineV1SubscriptionsPostRequestFormTransferDataAnyOf1X169b82ec.Builder.() -> Unit,
): InlineV1SubscriptionsPostRequestFormTransferDataAnyOf1X169b82ec =
    InlineV1SubscriptionsPostRequestFormTransferDataAnyOf1X169b82ec.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1SubscriptionsPostRequestFormTransferDataAnyOf1X169b82ec is missing required property '" + name +
                    "'",
            )
