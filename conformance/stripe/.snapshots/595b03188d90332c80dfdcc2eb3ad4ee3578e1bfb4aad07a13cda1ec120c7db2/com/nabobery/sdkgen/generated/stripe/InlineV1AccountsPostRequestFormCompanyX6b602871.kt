...
public class InlineV1AccountsPostRequestFormCompanyX6b602871(
    ...
    public val directorshipDeclaration: InlineV1AccountsPostRequestFormCompanyDirectorshipDeclarationXac597549? = null,
    ...
    public val ownershipDeclaration: InlineV1AccountsPostRequestFormCompanyOwnershipDeclarationXe6b8c5eb? = null,
    public val ownershipExemptionReason: InlineV1AccountsPostRequestFormCompanyOwnershipExemptionReasonXc9319ed7? = null,
    public val phone: String? = null,
    public val registrationDate: InlineV1AccountsPostRequestFormCompanyRegistrationDateXeaab0085? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1AccountsPostRequestFormCompanyX6b602871 =
            InlineV1AccountsPostRequestFormCompanyX6b602871(
                address = address,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1AccountsPostRequestFormCompanyX6b602871 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1AccountsPostRequestFormCompanyX6b602871> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountsPostRequestFormCompanyX6b602871 must be a JSON object",
                    )
            return InlineV1AccountsPostRequestFormCompanyX6b602871(
                address =
                    rawObject["address"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCompanyAddressX79a66a56>(it)
                    },
                addressKana =
                    rawObject["address_kana"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCompanyAddressKanaXfce82637>(it)
                    },
                addressKanji =
                    rawObject["address_kanji"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCompanyAddressKanjiXae2bd8ab>(it)
                    },
                directorsProvided =
                    rawObject["directors_provided"]?.let {
                        json
                ...
                directorshipDeclaration =
                    rawObject["directorship_declaration"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1AccountsPostRequestFormCompanyDirectorshipDeclarationXac597549>(
                                it,
                            )
                    },
                executivesProvided =
                    rawObject["executives_provided"]?.let {
                ...
                ownershipDeclaration =
                    rawObject["ownership_declaration"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCompanyOwnershipDeclarationXe6b8c5eb>(
                            it,
                        )
                    },
                ownershipExemptionReason =
                    rawObject["ownership_exemption_reason"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1AccountsPostRequestFormCompanyOwnershipExemptionReasonXc9319ed7>(
                                it,
                            )
                    },
                phone = rawObject["phone"]?.let { json.decodeFromJsonElement<String>(it) },
                registrationDate =
                    rawObject["registration_date"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCompanyRegistrationDateXeaab0085>(it)
                    },
                registrationNumber =
                    rawObject["registration_number"]?.let {
                        json.decodeFromJsonElement<String>(
                            it,
                        )
                    },
                representativeDeclaration =
                    rawObject["representative_declaration"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1AccountsPostRequestFormCompanyRepresentativeDeclarationX7a4a6c1e>(
                                it,
                            )
                    },
                structure =
                    rawObject["structure"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCompanyStructureX5dfb9a32>(it)
                    },
                ...
                verification =
                    rawObject["verification"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCompanyVerificationX2caadd95>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPostRequestFormCompanyX6b602871,
        ) {
            ...
            val raw =
                buildJsonObject {
                    ...
                    value.ownershipExemptionReason?.let {
                        put(
                    ...
                    value.representativeDeclaration?.let {
                        put(
...
public fun inlineV1AccountsPostRequestFormCompanyX6b602871(
    block: InlineV1AccountsPostRequestFormCompanyX6b602871.Builder.() -> Unit,
): InlineV1AccountsPostRequestFormCompanyX6b602871 = InlineV1AccountsPostRequestFormCompanyX6b602871.build(block)
