...
@Serializable
public data class ForwardedResponseDetailsView(
...
public class ForwardedResponseDetails(
    ...
    public object Serializer : KSerializer<ForwardedResponseDetails> {
        ...
        override fun deserialize(decoder: Decoder): ForwardedResponseDetails {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("ForwardedResponseDetails must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: ForwardedResponseDetails,
        ) {
...
public fun forwardedResponseDetails(block: ForwardedResponseDetails.Builder.() -> Unit): ForwardedResponseDetails =
    ForwardedResponseDetails.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException("ForwardedResponseDetails is missing required property '" + name + "'")
