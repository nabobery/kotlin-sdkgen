...
public sealed class InlineV1QuotesPostRequestFormCollectionMethodXf5619bcc {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1QuotesPostRequestFormCollectionMethodXf5619bcc =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1QuotesPostRequestFormCollectionMethodXf5619bcc> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1QuotesPostRequestFormCollectionMethodXf5619bcc",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1QuotesPostRequestFormCollectionMethodXf5619bcc =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1QuotesPostRequestFormCollectionMethodXf5619bcc,
        ) {
