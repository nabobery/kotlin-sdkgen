...
public sealed class InlineV1PricesPostRequestFormTransformQuantityRoundXec72de8f {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1PricesPostRequestFormTransformQuantityRoundXec72de8f =
            when (value) {
                Down.value -> Down
                Up.value -> Up
    ...
    public object Serializer : KSerializer<InlineV1PricesPostRequestFormTransformQuantityRoundXec72de8f> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1PricesPostRequestFormTransformQuantityRoundXec72de8f",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1PricesPostRequestFormTransformQuantityRoundXec72de8f =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PricesPostRequestFormTransformQuantityRoundXec72de8f,
        ) {
