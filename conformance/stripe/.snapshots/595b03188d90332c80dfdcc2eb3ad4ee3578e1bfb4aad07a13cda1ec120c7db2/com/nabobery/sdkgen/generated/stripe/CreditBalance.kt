...
public class CreditBalance(
    ...
    public object Serializer : KSerializer<CreditBalance> {
        ...
        override fun deserialize(decoder: Decoder): CreditBalance {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("CreditBalance must be a JSON object")
            val availableBalance =
                json.decodeRequired<BillingCreditGrantsResourceAmount>(
                    rawObject,
                    "available_balance",
                )
