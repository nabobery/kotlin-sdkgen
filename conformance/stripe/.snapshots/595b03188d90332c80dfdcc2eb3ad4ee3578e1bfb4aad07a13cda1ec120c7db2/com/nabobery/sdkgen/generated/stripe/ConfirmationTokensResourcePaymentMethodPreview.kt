...
public data class ConfirmationTokensResourcePaymentMethodPreviewView(
    ...
    public val allowRedisplay: InlineConfirmationTokensResourcePaymentMethodPreviewAllowRedisplayX2508abd4? = null,
    ...
    public val customer: InlineConfirmationTokensResourcePaymentMethodPreviewCustomerXd20b1b25? = null,
...
public class ConfirmationTokensResourcePaymentMethodPreview(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): ConfirmationTokensResourcePaymentMethodPreview =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<ConfirmationTokensResourcePaymentMethodPreview> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "ConfirmationTokensResourcePaymentMethodPreview must be a JSON object",
                    )
            val billingDetails = json.decodeRequired<BillingDetails>(rawObject, "billing_details")
            val type =
                json.decodeRequired<InlineConfirmationTokensResourcePaymentMethodPreviewTypeX936820be>(
                    rawObject,
                    "type",
                )
            return ConfirmationTokensResourcePaymentMethodPreview(
                ...
                allowRedisplay =
                    rawObject["allow_redisplay"]?.let {
                        json
                            .decodeFromJsonElement<InlineConfirmationTokensResourcePaymentMethodPreviewAllowRedisplayX2508abd4>(
                                it,
                            )
                    },
                ...
                auBecsDebit =
                    rawObject["au_becs_debit"]?.let {
                        json.decodeFromJsonElement<PaymentMethodAuBecsDebit>(
                            it,
                        )
                    },
                ...
                cardPresent =
                    rawObject["card_present"]?.let {
                        json.decodeFromJsonElement<PaymentMethodCardPresent>(
                            it,
                        )
                    },
                ...
                customer =
                    rawObject["customer"]?.let { element ->
                        if (element ==
                            ...
                            json
                                .decodeFromJsonElement<InlineConfirmationTokensResourcePaymentMethodPreviewCustomerXd20b1b25?>(
                                    element,
                                )
                        }
                    },
                ...
                interacPresent =
                    rawObject["interac_present"]?.let {
                        json.decodeFromJsonElement<PaymentMethodInteracPresent>(
                            it,
                        )
                    },
                ...
                nzBankAccount =
                    rawObject["nz_bank_account"]?.let {
                        json.decodeFromJsonElement<PaymentMethodNzBankAccount>(
                            it,
                        )
                    },
                ...
                usBankAccount =
                    rawObject["us_bank_account"]?.let {
                        json.decodeFromJsonElement<PaymentMethodUsBankAccount>(
                            it,
                        )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: ConfirmationTokensResourcePaymentMethodPreview,
        ) {
...
public fun confirmationTokensResourcePaymentMethodPreview(
    block: ConfirmationTokensResourcePaymentMethodPreview.Builder.() -> Unit,
): ConfirmationTokensResourcePaymentMethodPreview = ConfirmationTokensResourcePaymentMethodPreview.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "ConfirmationTokensResourcePaymentMethodPreview is missing required property '" + name + "'",
            )
