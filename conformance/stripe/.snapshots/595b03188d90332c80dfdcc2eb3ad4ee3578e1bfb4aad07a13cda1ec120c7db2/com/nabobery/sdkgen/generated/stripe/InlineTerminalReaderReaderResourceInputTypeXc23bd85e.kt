...
public sealed class InlineTerminalReaderReaderResourceInputTypeXc23bd85e {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineTerminalReaderReaderResourceInputTypeXc23bd85e =
            when (value) {
                Email.value -> Email
    ...
    public object Serializer : KSerializer<InlineTerminalReaderReaderResourceInputTypeXc23bd85e> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineTerminalReaderReaderResourceInputTypeXc23bd85e",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineTerminalReaderReaderResourceInputTypeXc23bd85e =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineTerminalReaderReaderResourceInputTypeXc23bd85e,
        ) {
