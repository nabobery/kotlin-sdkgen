...
public class InlineV1SubscriptionsPostRequestFormBillingModeX933573e8(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1SubscriptionsPostRequestFormBillingModeX933573e8 =
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionsPostRequestFormBillingModeX933573e8> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SubscriptionsPostRequestFormBillingModeX933573e8 must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineV1SubscriptionsPostRequestFormBillingModeTypeX221cec6e>(
                    rawObject,
                    "type",
                )
            return InlineV1SubscriptionsPostRequestFormBillingModeX933573e8(
                ...
                flexible =
                    rawObject["flexible"]?.let {
                        json.decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormBillingModeFlexibleX179c2e6e>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsPostRequestFormBillingModeX933573e8,
        ) {
...
public fun inlineV1SubscriptionsPostRequestFormBillingModeX933573e8(
    block: InlineV1SubscriptionsPostRequestFormBillingModeX933573e8.Builder.() -> Unit,
): InlineV1SubscriptionsPostRequestFormBillingModeX933573e8 =
    InlineV1SubscriptionsPostRequestFormBillingModeX933573e8.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1SubscriptionsPostRequestFormBillingModeX933573e8 is missing required property '" + name + "'",
            )
