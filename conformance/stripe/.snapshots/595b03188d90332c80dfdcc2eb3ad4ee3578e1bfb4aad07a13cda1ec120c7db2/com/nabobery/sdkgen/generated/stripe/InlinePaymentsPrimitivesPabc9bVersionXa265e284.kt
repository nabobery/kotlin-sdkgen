...
public sealed class InlinePaymentsPrimitivesPabc9bVersionXa265e284 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentsPrimitivesPabc9bVersionXa265e284 =
            when (value) {
                _102.value -> _102
                _210.value -> _210
                _220.value -> _220
    ...
    public object Serializer : KSerializer<InlinePaymentsPrimitivesPabc9bVersionXa265e284> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentsPrimitivesPabc9bVersionXa265e284",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePaymentsPrimitivesPabc9bVersionXa265e284 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentsPrimitivesPabc9bVersionXa265e284,
        ) {
