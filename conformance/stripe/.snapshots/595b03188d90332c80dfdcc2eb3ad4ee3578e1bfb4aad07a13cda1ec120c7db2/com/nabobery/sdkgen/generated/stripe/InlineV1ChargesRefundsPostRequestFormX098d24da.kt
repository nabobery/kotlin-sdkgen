...
public class InlineV1ChargesRefundsPostRequestFormX098d24da(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1ChargesRefundsPostRequestFormX098d24da =
            InlineV1ChargesRefundsPostRequestFormX098d24da(
                amount = amount,
                currency = currency,
                customer = customer,
                expand = expand,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1ChargesRefundsPostRequestFormX098d24da =
    ...
    public object Serializer : KSerializer<InlineV1ChargesRefundsPostRequestFormX098d24da> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1ChargesRefundsPostRequestFormX098d24da must be a JSON object",
                    )
            return InlineV1ChargesRefundsPostRequestFormX098d24da(
                ...
                metadata =
                    rawObject["metadata"]?.let {
                        json.decodeFromJsonElement<InlineV1ChargesRefundsPostRequestFormMetadataX2be9a45c>(it)
                    },
                origin =
                    rawObject["origin"]?.let {
                        json.decodeFromJsonElement<InlineV1ChargesRefundsPostRequestFormOriginX4a79114c>(it)
                    },
                paymentIntent = rawObject["payment_intent"]?.let { json.decodeFromJsonElement<String>(it) },
                reason =
                    rawObject["reason"]?.let {
                        json.decodeFromJsonElement<InlineV1ChargesRefundsPostRequestFormReasonX896929c9>(it)
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ChargesRefundsPostRequestFormX098d24da,
        ) {
...
public fun inlineV1ChargesRefundsPostRequestFormX098d24da(
    block: InlineV1ChargesRefundsPostRequestFormX098d24da.Builder.() -> Unit,
): InlineV1ChargesRefundsPostRequestFormX098d24da = InlineV1ChargesRefundsPostRequestFormX098d24da.build(block)
