...
public sealed class InlineV1PaymentRecordsRepo6f4dPostRequestFormMetadataAnyOf2X43c0153c {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1PaymentRecordsRepo6f4dPostRequestFormMetadataAnyOf2X43c0153c =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1PaymentRecordsRepo6f4dPostRequestFormMetadataAnyOf2X43c0153c> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1PaymentRecordsRepo6f4dPostRequestFormMetadataAnyOf2X43c0153c",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1PaymentRecordsRepo6f4dPostRequestFormMetadataAnyOf2X43c0153c = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentRecordsRepo6f4dPostRequestFormMetadataAnyOf2X43c0153c,
        ) {
