...
public class InlineSubscriptionScheduleX6d170f2a internal constructor(
        ...
        get() =
            buildSet {
                ...
                if (inspection.matchesSubscriptionSchedule) {
                    add(
                        InlineSubscriptionScheduleX6d170f2aBranch.SubscriptionSchedule,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineSubscriptionScheduleX6d170f2a {
            val inspection = inspectInlineSubscriptionScheduleX6d170f2a(raw)
            if (inspection.matchCount == 0) {
                throw InlineSubscriptionScheduleX6d170f2aNoMatchException(
                    "InlineSubscriptionScheduleX6d170f2a matched 0 branches: " + inspection.failures.joinToString("; "),
                )
            }
    ...
    public object Serializer : KSerializer<InlineSubscriptionScheduleX6d170f2a> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineSubscriptionScheduleX6d170f2a,
        ) {
...
private fun inspectInlineSubscriptionScheduleX6d170f2a(
    element: JsonElement,
): InlineSubscriptionScheduleX6d170f2aInspection {
