...
public class InlineV1PaymentIntentsConfirmPostRequestFormAmountDetailsAnyOf1ItemX49200604(
    ...
    public val paymentMethodOptions: InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsXe50c70d3? = null,
    public val productCode: String? = null,
    public val tax: InlineV1PaymentIntentsConfirmPostRequestFormAmountDetailsAnyOf1TaxXc5277cd6? = null,
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentIntentsConfirmPostRequestFormAmountDetailsAnyOf1ItemX49200604 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsConfirmPostRequestFormAmountDetailsAnyOf1ItemX49200604> {
        ...
        override fun deserialize(
            decoder: Decoder,
        ): InlineV1PaymentIntentsConfirmPostRequestFormAmountDetailsAnyOf1ItemX49200604 {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsConfirmPostRequestFormAmountDetailsAnyOf1ItemX49200604 must be a JSON object",
                    )
            ...
            return InlineV1PaymentIntentsConfirmPostRequestFormAmountDetailsAnyOf1ItemX49200604(
                ...
                paymentMethodOptions =
                    rawObject["payment_method_options"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsXe50c70d3>(
                                it,
                            )
                    },
                ...
                tax =
                    rawObject["tax"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormAmountDetailsAnyOf1TaxXc5277cd6>(
                                it,
                            )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsConfirmPostRequestFormAmountDetailsAnyOf1ItemX49200604,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentIntentsConfirmPostRequestFormAmountDetailsAnyOf1ItemX49200604(
    block: InlineV1PaymentIntentsConfirmPostRequestFormAmountDetailsAnyOf1ItemX49200604.Builder.() -> Unit,
): InlineV1PaymentIntentsConfirmPostRequestFormAmountDetailsAnyOf1ItemX49200604 =
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentIntentsConfirmPostRequestFormAmountDetailsAnyOf1ItemX49200604 is missing required property '" +
                    name +
                    "'",
            )
