...
public data class PaymentFlowsAutomaticPaymentMethodsPaymentIntentView(
    ...
    public val allowRedirects: InlinePaymentFlowsAutomaticPaymentMethodsPaymentIntentAllowRedirectsX4b260eab? = null,
...
public class PaymentFlowsAutomaticPaymentMethodsPaymentIntent(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentFlowsAutomaticPaymentMethodsPaymentIntent =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentFlowsAutomaticPaymentMethodsPaymentIntent> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "PaymentFlowsAutomaticPaymentMethodsPaymentIntent must be a JSON object",
                    )
            ...
            return PaymentFlowsAutomaticPaymentMethodsPaymentIntent(
                ...
                allowRedirects =
                    rawObject["allow_redirects"]?.let {
                        json
                            .decodeFromJsonElement<InlinePaymentFlowsAutomaticPaymentMethodsPaymentIntentAllowRedirectsX4b260eab>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentFlowsAutomaticPaymentMethodsPaymentIntent,
        ) {
...
public fun paymentFlowsAutomaticPaymentMethodsPaymentIntent(
    block: PaymentFlowsAutomaticPaymentMethodsPaymentIntent.Builder.() -> Unit,
): PaymentFlowsAutomaticPaymentMethodsPaymentIntent = PaymentFlowsAutomaticPaymentMethodsPaymentIntent.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "PaymentFlowsAutomaticPaymentMethodsPaymentIntent is missing required property '" + name + "'",
            )
