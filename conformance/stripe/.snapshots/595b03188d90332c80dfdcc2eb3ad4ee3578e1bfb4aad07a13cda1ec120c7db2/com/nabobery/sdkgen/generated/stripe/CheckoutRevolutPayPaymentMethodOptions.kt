...
public class CheckoutRevolutPayPaymentMethodOptions(
     ...
     */
    public val captureMethod: InlineCheckoutRevolutPayPaymentMethodOptionsCaptureMethodXc60b0b31? = null,
    /**
     ...
     */
    public val setupFutureUsage: InlineCheckoutRevolutPayPaymentMethodOptionsSetupFutureUsageX5d22c693? = null,
) {
    public class Builder {
        ...
        public fun build(): CheckoutRevolutPayPaymentMethodOptions =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): CheckoutRevolutPayPaymentMethodOptions =
    ...
    public object Serializer : KSerializer<CheckoutRevolutPayPaymentMethodOptions> {
        ...
        override fun deserialize(decoder: Decoder): CheckoutRevolutPayPaymentMethodOptions {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("CheckoutRevolutPayPaymentMethodOptions must be a JSON object")
            return CheckoutRevolutPayPaymentMethodOptions(
                captureMethod =
                    rawObject["capture_method"]?.let {
                        json.decodeFromJsonElement<InlineCheckoutRevolutPayPaymentMethodOptionsCaptureMethodXc60b0b31>(
                            it,
                        )
                    },
                setupFutureUsage =
                    rawObject["setup_future_usage"]?.let {
                        json
                            .decodeFromJsonElement<InlineCheckoutRevolutPayPaymentMethodOptionsSetupFutureUsageX5d22c693>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: CheckoutRevolutPayPaymentMethodOptions,
        ) {
...
public fun checkoutRevolutPayPaymentMethodOptions(
    block: CheckoutRevolutPayPaymentMethodOptions.Builder.() -> Unit,
): CheckoutRevolutPayPaymentMethodOptions = CheckoutRevolutPayPaymentMethodOptions.build(block)
