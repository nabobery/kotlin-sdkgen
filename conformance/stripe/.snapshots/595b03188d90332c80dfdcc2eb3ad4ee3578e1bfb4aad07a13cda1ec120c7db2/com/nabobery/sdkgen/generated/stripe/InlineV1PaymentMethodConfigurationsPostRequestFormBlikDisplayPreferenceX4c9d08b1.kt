...
public class InlineV1PaymentMethodConfigurationsPostRequestFormBlikDisplayPreferenceX4c9d08b1(
    public val preference: InlineV1PaymentMethodConfidc49PostRequestFormBlikPreferenceX2e2df19c? = null,
) {
    public class Builder {
        public var preference: InlineV1PaymentMethodConfidc49PostRequestFormBlikPreferenceX2e2df19c? =
            null

        public fun build(): InlineV1PaymentMethodConfigurationsPostRequestFormBlikDisplayPreferenceX4c9d08b1 =
            InlineV1PaymentMethodConfigurationsPostRequestFormBlikDisplayPreferenceX4c9d08b1(
    ...
    public object Serializer : KSerializer<InlineV1PaymentMethodConfigurationsPostRequestFormBlikDisplayPreferenceX4c9d08b1> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentMethodConfigurationsPostRequestFormBlikDisplayPreferenceX4c9d08b1 must be a JSON object",
                    )
            return InlineV1PaymentMethodConfigurationsPostRequestFormBlikDisplayPreferenceX4c9d08b1(
                preference =
                    rawObject["preference"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentMethodConfidc49PostRequestFormBlikPreferenceX2e2df19c>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentMethodConfigurationsPostRequestFormBlikDisplayPreferenceX4c9d08b1,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentMethodConfigurationsPostRequestFormBlikDisplayPreferenceX4c9d08b1(
    block: InlineV1PaymentMethodConfigurationsPostRequestFormBlikDisplayPreferenceX4c9d08b1.Builder.() -> Unit,
): InlineV1PaymentMethodConfigurationsPostRequestFormBlikDisplayPreferenceX4c9d08b1 =
