...
public class InlineV1CustomersSubscriptionsPostRequestFormTransferDataXed439d91(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1CustomersSubscriptionsPostRequestFormTransferDataXed439d91 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1CustomersSubscriptionsPostRequestFormTransferDataXed439d91> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1CustomersSubscriptionsPostRequestFormTransferDataXed439d91 {
            val jsonDecoder =
                decoder.requireJsonDecoder(
                    "InlineV1CustomersSubscriptionsPostRequestFormTransferDataXed439d91",
                )
            val json = jsonDecoder.json
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CustomersSubscriptionsPostRequestFormTransferDataXed439d91 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersSubscriptionsPostRequestFormTransferDataXed439d91,
        ) {
            val jsonEncoder =
...
public fun inlineV1CustomersSubscriptionsPostRequestFormTransferDataXed439d91(
    block: InlineV1CustomersSubscriptionsPostRequestFormTransferDataXed439d91.Builder.() -> Unit,
): InlineV1CustomersSubscriptionsPostRequestFormTransferDataXed439d91 =
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1CustomersSubscriptionsPostRequestFormTransferDataXed439d91 is missing required property '" +
                    name +
                    "'",
            )
