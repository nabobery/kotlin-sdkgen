...
public sealed class InlineV1BillingAlertsGetParameterX18b42878 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1BillingAlertsGetParameterX18b42878 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1BillingAlertsGetParameterX18b42878> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1BillingAlertsGetParameterX18b42878",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1BillingAlertsGetParameterX18b42878 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1BillingAlertsGetParameterX18b42878,
        ) {
