...
public sealed class InlineIssuingAuthorizationFraudChallengeChannelX05ae2a0f {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineIssuingAuthorizationFraudChallengeChannelX05ae2a0f =
            when (value) {
                Sms.value -> Sms
    ...
    public object Serializer : KSerializer<InlineIssuingAuthorizationFraudChallengeChannelX05ae2a0f> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineIssuingAuthorizationFraudChallengeChannelX05ae2a0f",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineIssuingAuthorizationFraudChallengeChannelX05ae2a0f =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineIssuingAuthorizationFraudChallengeChannelX05ae2a0f,
        ) {
