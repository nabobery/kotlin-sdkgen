...
public class TerminalReaderReaderResourceSetReaderDisplayAction(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): TerminalReaderReaderResourceSetReaderDisplayAction =
    ...
    public object Serializer : KSerializer<TerminalReaderReaderResourceSetReaderDisplayAction> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "TerminalReaderReaderResourceSetReaderDisplayAction must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineTerminalReaderReaderResourceSetReaderDisplayActionTypeXd0d02bb3>(
                    rawObject,
                    "type",
                )
            return TerminalReaderReaderResourceSetReaderDisplayAction(
                ...
                cart =
                    rawObject["cart"]?.let { element ->
                        if (element ==
                            ...
                            json
                                .decodeFromJsonElement<InlineTerminalReaderReaderResourceSetReaderDisplayActionCartXcada7ad8?>(
                                    element,
                                )
                        }
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: TerminalReaderReaderResourceSetReaderDisplayAction,
        ) {
...
public fun terminalReaderReaderResourceSetReaderDisplayAction(
    block: TerminalReaderReaderResourceSetReaderDisplayAction.Builder.() -> Unit,
): TerminalReaderReaderResourceSetReaderDisplayAction = TerminalReaderReaderResourceSetReaderDisplayAction.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "TerminalReaderReaderResourceSetReaderDisplayAction is missing required property '" + name + "'",
            )
