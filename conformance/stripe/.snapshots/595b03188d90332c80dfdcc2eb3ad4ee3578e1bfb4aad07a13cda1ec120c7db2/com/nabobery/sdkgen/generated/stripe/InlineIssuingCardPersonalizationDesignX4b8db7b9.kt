...
public class InlineIssuingCardPersonalizationDesignX4b8db7b9 internal constructor(
    ...
    public val issuingPersonalizationDesign: IssuingPersonalizationDesign? by
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesIssuingPersonalizationDesign) {
                json.decodeFromJsonElement<IssuingPersonalizationDesign>(
                    raw,
                )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineIssuingCardPersonalizationDesignX4b8db7b9Branch>
        get() =
            buildSet {
                ...
                if (inspection.matchesIssuingPersonalizationDesign) {
                    add(
                        InlineIssuingCardPersonalizationDesignX4b8db7b9Branch.IssuingPersonalizationDesign,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineIssuingCardPersonalizationDesignX4b8db7b9 {
            val inspection = inspectInlineIssuingCardPersonalizationDesignX4b8db7b9(raw)
            if (inspection.matchCount == 0) {
                throw InlineIssuingCardPersonalizationDesignX4b8db7b9NoMatchException(
                    "InlineIssuingCardPersonalizationDesignX4b8db7b9 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineIssuingCardPersonalizationDesignX4b8db7b9> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineIssuingCardPersonalizationDesignX4b8db7b9,
        ) {
...
private fun inspectInlineIssuingCardPersonalizationDesignX4b8db7b9(
    element: JsonElement,
): InlineIssuingCardPersonalizationDesignX4b8db7b9Inspection {
    ...
    return InlineIssuingCardPersonalizationDesignX4b8db7b9Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesIssuingPersonalizationDesign) {
                    add(
                        "IssuingPersonalizationDesign: value does not match IssuingPersonalizationDesign",
                    )
                }
            },
    )
