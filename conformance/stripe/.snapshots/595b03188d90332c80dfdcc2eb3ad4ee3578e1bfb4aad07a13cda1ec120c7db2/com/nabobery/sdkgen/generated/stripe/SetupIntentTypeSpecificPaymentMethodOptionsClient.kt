...
public class SetupIntentTypeSpecificPaymentMethodOptionsClient(
    ...
    public class Builder {
        ...
        public fun build(): SetupIntentTypeSpecificPaymentMethodOptionsClient =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): SetupIntentTypeSpecificPaymentMethodOptionsClient =
    ...
    public object Serializer : KSerializer<SetupIntentTypeSpecificPaymentMethodOptionsClient> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "SetupIntentTypeSpecificPaymentMethodOptionsClient must be a JSON object",
                    )
            return SetupIntentTypeSpecificPaymentMethodOptionsClient(
                mandateOptions =
                    rawObject["mandate_options"]?.let {
                        json.decodeFromJsonElement<SetupIntentPaymentMethodOptionsMandateOptionsPayto>(it)
                    },
                verificationMethod =
                    rawObject["verification_method"]?.let {
                        json.decodeFromJsonElement<InlineSetupIntentTypeSpeci142bVerificationMethodX806b0bbe>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: SetupIntentTypeSpecificPaymentMethodOptionsClient,
        ) {
...
public fun setupIntentTypeSpecificPaymentMethodOptionsClient(
    block: SetupIntentTypeSpecificPaymentMethodOptionsClient.Builder.() -> Unit,
): SetupIntentTypeSpecificPaymentMethodOptionsClient = SetupIntentTypeSpecificPaymentMethodOptionsClient.build(block)
