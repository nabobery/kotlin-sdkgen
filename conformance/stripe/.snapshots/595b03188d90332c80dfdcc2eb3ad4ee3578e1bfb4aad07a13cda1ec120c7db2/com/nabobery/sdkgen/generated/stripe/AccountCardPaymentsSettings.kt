...
public class AccountCardPaymentsSettings(
    ...
    public class Builder {
        ...
        public fun build(): AccountCardPaymentsSettings =
    ...
    public object Serializer : KSerializer<AccountCardPaymentsSettings> {
        ...
        override fun deserialize(decoder: Decoder): AccountCardPaymentsSettings {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("AccountCardPaymentsSettings must be a JSON object")
            return AccountCardPaymentsSettings(
                ...
                statementDescriptorPrefix =
                    rawObject["statement_descriptor_prefix"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                statementDescriptorPrefixKana =
                    rawObject["statement_descriptor_prefix_kana"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                statementDescriptorPrefixKanji =
                    rawObject["statement_descriptor_prefix_kanji"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: AccountCardPaymentsSettings,
        ) {
...
public fun accountCardPaymentsSettings(
    block: AccountCardPaymentsSettings.Builder.() -> Unit,
): AccountCardPaymentsSettings = AccountCardPaymentsSettings.build(block)
