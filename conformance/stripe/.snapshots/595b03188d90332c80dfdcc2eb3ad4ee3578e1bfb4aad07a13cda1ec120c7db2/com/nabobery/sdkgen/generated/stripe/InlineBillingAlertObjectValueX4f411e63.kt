...
public sealed class InlineBillingAlertObjectValueX4f411e63 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineBillingAlertObjectValueX4f411e63 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineBillingAlertObjectValueX4f411e63> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineBillingAlertObjectValueX4f411e63",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineBillingAlertObjectValueX4f411e63 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineBillingAlertObjectValueX4f411e63,
        ) {
