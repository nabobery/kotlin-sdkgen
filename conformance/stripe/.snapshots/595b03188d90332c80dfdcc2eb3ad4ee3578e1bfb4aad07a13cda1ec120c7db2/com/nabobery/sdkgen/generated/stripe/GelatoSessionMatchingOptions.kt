...
public class GelatoSessionMatchingOptions(
    ...
    public class Builder {
        ...
        public fun build(): GelatoSessionMatchingOptions =
    ...
    public object Serializer : KSerializer<GelatoSessionMatchingOptions> {
        ...
        override fun deserialize(decoder: Decoder): GelatoSessionMatchingOptions {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("GelatoSessionMatchingOptions must be a JSON object")
            return GelatoSessionMatchingOptions(
                dob =
                    rawObject["dob"]?.let {
                        json
                            .decodeFromJsonElement<InlineGelatoSessionMatchingOptionsDobX124eab30>(
                                it,
                            )
                    },
                name =
                    rawObject["name"]?.let {
                        json.decodeFromJsonElement<InlineGelatoSessionMatchingOptionsNameX7cc1dac6>(
                            it,
                        )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: GelatoSessionMatchingOptions,
        ) {
...
public fun gelatoSessionMatchingOptions(
    block: GelatoSessionMatchingOptions.Builder.() -> Unit,
): GelatoSessionMatchingOptions = GelatoSessionMatchingOptions.build(block)
