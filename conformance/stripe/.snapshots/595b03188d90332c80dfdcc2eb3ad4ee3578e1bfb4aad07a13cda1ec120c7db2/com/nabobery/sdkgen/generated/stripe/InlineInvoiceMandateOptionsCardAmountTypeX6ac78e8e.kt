...
public sealed class InlineInvoiceMandateOptionsCardAmountTypeX6ac78e8e {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineInvoiceMandateOptionsCardAmountTypeX6ac78e8e =
            when (value) {
                Fixed.value -> Fixed
    ...
    public object Serializer : KSerializer<InlineInvoiceMandateOptionsCardAmountTypeX6ac78e8e> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineInvoiceMandateOptionsCardAmountTypeX6ac78e8e",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineInvoiceMandateOptionsCardAmountTypeX6ac78e8e =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineInvoiceMandateOptionsCardAmountTypeX6ac78e8e,
        ) {
