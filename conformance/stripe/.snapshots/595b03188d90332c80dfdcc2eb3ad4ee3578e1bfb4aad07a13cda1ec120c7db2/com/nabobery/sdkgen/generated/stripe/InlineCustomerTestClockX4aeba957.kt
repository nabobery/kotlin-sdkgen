...
public class InlineCustomerTestClockX4aeba957 internal constructor(
        ...
        get() =
            buildSet {
                ...
                if (inspection.matchesTestHelpersTestClock) {
                    add(
                        InlineCustomerTestClockX4aeba957Branch.TestHelpersTestClock,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineCustomerTestClockX4aeba957 {
            val inspection = inspectInlineCustomerTestClockX4aeba957(raw)
            if (inspection.matchCount == 0) {
                throw InlineCustomerTestClockX4aeba957NoMatchException(
                    "InlineCustomerTestClockX4aeba957 matched 0 branches: " + inspection.failures.joinToString("; "),
                )
            }
    ...
    public object Serializer : KSerializer<InlineCustomerTestClockX4aeba957> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineCustomerTestClockX4aeba957,
        ) {
