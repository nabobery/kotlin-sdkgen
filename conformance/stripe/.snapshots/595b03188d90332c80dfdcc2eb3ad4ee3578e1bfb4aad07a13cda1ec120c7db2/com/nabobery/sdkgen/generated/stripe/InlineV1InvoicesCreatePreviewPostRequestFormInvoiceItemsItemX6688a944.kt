...
public class InlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemX6688a944(
    ...
    public val discounts: InlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemDiscountsX0e559a97? = null,
    public val invoiceitem: String? = null,
    public val metadata: InlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemMetadataXaa288796? = null,
    public val period: InlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemPeriodXcf27e94f? = null,
    public val price: String? = null,
    public val priceData: InlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemPriceDataXb2fabe99? = null,
    public val quantity: Int? = null,
    public val quantityDecimal: String? = null,
    public val taxBehavior: InlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemTaxBehaviorXcdc0a597? = null,
    public val taxCode: InlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemTaxCodeX61ac50e2? = null,
    public val taxRates: InlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemTaxRatesX590a7ef6? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemX6688a944 =
            InlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemX6688a944(
                amount = amount,
                currency = currency,
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemX6688a944 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemX6688a944> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemX6688a944 must be a JSON object",
                    )
            return InlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemX6688a944(
                ...
                discounts =
                    rawObject["discounts"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemDiscountsX0e559a97>(
                                it,
                            )
                    },
                ...
                metadata =
                    rawObject["metadata"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemMetadataXaa288796>(
                                it,
                            )
                    },
                period =
                    rawObject["period"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemPeriodXcf27e94f>(
                                it,
                            )
                    },
                ...
                priceData =
                    rawObject["price_data"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemPriceDataXb2fabe99>(
                                it,
                            )
                    },
                ...
                taxBehavior =
                    rawObject["tax_behavior"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemTaxBehaviorXcdc0a597>(
                                it,
                            )
                    },
                taxCode =
                    rawObject["tax_code"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemTaxCodeX61ac50e2>(
                                it,
                            )
                    },
                taxRates =
                    rawObject["tax_rates"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemTaxRatesX590a7ef6>(
                                it,
                            )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemX6688a944,
        ) {
            val jsonEncoder =
...
public fun inlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemX6688a944(
    block: InlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemX6688a944.Builder.() -> Unit,
): InlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemX6688a944 =
