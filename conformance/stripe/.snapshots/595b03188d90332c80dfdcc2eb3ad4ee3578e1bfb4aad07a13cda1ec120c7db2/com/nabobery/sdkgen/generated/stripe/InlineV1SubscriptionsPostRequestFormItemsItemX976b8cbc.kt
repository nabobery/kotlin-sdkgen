...
public class InlineV1SubscriptionsPostRequestFormItemsItemX976b8cbc(
    public val billingThresholds: InlineV1SubscriptionsPostRequestFormItemsItemBillingThresholdsXc768c06f? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1SubscriptionsPostRequestFormItemsItemX976b8cbc =
            InlineV1SubscriptionsPostRequestFormItemsItemX976b8cbc(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1SubscriptionsPostRequestFormItemsItemX976b8cbc =
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionsPostRequestFormItemsItemX976b8cbc> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SubscriptionsPostRequestFormItemsItemX976b8cbc must be a JSON object",
                    )
            return InlineV1SubscriptionsPostRequestFormItemsItemX976b8cbc(
                billingThresholds =
                    rawObject["billing_thresholds"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormItemsItemBillingThresholdsXc768c06f>(
                                it,
                            )
                    },
                ...
                discounts =
                    rawObject["discounts"]?.let {
                        json.decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormItemsItemDiscountsX155b0ce2>(it)
                    },
                id = rawObject["id"]?.let { json.decodeFromJsonElement<String>(it) },
                metadata =
                    rawObject["metadata"]?.let {
                        json.decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormItemsItemMetadataX51509d98>(it)
                    },
                price = rawObject["price"]?.let { json.decodeFromJsonElement<String>(it) },
                priceData =
                    rawObject["price_data"]?.let {
                        json.decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormItemsItemPriceDataXc4828e3e>(it)
                    },
                quantity = rawObject["quantity"]?.let { json.decodeFromJsonElement<Int>(it) },
                taxRates =
                    rawObject["tax_rates"]?.let {
                        json.decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormItemsItemTaxRatesXd9e2bf4f>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsPostRequestFormItemsItemX976b8cbc,
        ) {
...
public fun inlineV1SubscriptionsPostRequestFormItemsItemX976b8cbc(
    block: InlineV1SubscriptionsPostRequestFormItemsItemX976b8cbc.Builder.() -> Unit,
): InlineV1SubscriptionsPostRequestFormItemsItemX976b8cbc =
    InlineV1SubscriptionsPostRequestFormItemsItemX976b8cbc.build(block)
