...
public sealed class InlinePaymentLinkBillingAddressCollectionX8c0d649d {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentLinkBillingAddressCollectionX8c0d649d =
            when (value) {
                Auto.value -> Auto
    ...
    public object Serializer : KSerializer<InlinePaymentLinkBillingAddressCollectionX8c0d649d> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentLinkBillingAddressCollectionX8c0d649d",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePaymentLinkBillingAddressCollectionX8c0d649d =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentLinkBillingAddressCollectionX8c0d649d,
        ) {
