...
public sealed class InlineV1InvoiceitemsPostRequestFormMetadataAnyOf2X73255d4e {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1InvoiceitemsPostRequestFormMetadataAnyOf2X73255d4e =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1InvoiceitemsPostRequestFormMetadataAnyOf2X73255d4e> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1InvoiceitemsPostRequestFormMetadataAnyOf2X73255d4e",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1InvoiceitemsPostRequestFormMetadataAnyOf2X73255d4e =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoiceitemsPostRequestFormMetadataAnyOf2X73255d4e,
        ) {
