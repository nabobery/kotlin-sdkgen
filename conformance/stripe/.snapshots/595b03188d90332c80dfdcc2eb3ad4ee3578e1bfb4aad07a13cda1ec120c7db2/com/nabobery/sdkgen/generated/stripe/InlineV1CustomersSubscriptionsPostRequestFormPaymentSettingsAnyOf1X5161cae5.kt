...
public class InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsAnyOf1X5161cae5(
    ...
    public val mandateOptions: InlineV1CustomersSubscriptionsPostRequestFormMandateOptionsX12e3563d? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsAnyOf1X5161cae5 =
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsAnyOf1X5161cae5 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsAnyOf1X5161cae5> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsAnyOf1X5161cae5 must be a JSON object",
                    )
            return InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsAnyOf1X5161cae5(
                ...
                mandateOptions =
                    rawObject["mandate_options"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CustomersSubscriptionsPostRequestFormMandateOptionsX12e3563d>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsAnyOf1X5161cae5,
        ) {
            val jsonEncoder =
...
public fun inlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsAnyOf1X5161cae5(
    block: InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsAnyOf1X5161cae5.Builder.() -> Unit,
): InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsAnyOf1X5161cae5 =
