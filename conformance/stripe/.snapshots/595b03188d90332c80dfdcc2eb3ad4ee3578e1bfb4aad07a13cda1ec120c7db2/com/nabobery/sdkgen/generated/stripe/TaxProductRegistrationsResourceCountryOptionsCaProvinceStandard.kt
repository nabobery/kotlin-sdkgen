...
public class TaxProductRegistrationsResourceCountryOptionsCaProvinceStandard(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): TaxProductRegistrationsResourceCountryOptionsCaProvinceStandard =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<TaxProductRegistrationsResourceCountryOptionsCaProvinceStandard> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "TaxProductRegistrationsResourceCountryOptionsCaProvinceStandard must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: TaxProductRegistrationsResourceCountryOptionsCaProvinceStandard,
        ) {
            val jsonEncoder =
...
public fun taxProductRegistrationsResourceCountryOptionsCaProvinceStandard(
    block: TaxProductRegistrationsResourceCountryOptionsCaProvinceStandard.Builder.() -> Unit,
): TaxProductRegistrationsResourceCountryOptionsCaProvinceStandard =
    TaxProductRegistrationsResourceCountryOptionsCaProvinceStandard.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "TaxProductRegistrationsResourceCountryOptionsCaProvinceStandard is missing required property '" + name +
                    "'",
            )
