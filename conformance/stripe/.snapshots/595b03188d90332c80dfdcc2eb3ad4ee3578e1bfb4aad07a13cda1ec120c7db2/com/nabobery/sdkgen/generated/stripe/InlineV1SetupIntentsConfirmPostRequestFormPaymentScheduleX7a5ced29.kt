...
public sealed class InlineV1SetupIntentsConfirmPostRequestFormPaymentScheduleX7a5ced29 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1SetupIntentsConfirmPostRequestFormPaymentScheduleX7a5ced29 =
            when (value) {
                Value.value -> Value
                Adhoc.value -> Adhoc
                Annual.value -> Annual
    ...
    public object Serializer : KSerializer<InlineV1SetupIntentsConfirmPostRequestFormPaymentScheduleX7a5ced29> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1SetupIntentsConfirmPostRequestFormPaymentScheduleX7a5ced29",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1SetupIntentsConfirmPostRequestFormPaymentScheduleX7a5ced29 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SetupIntentsConfirmPostRequestFormPaymentScheduleX7a5ced29,
        ) {
