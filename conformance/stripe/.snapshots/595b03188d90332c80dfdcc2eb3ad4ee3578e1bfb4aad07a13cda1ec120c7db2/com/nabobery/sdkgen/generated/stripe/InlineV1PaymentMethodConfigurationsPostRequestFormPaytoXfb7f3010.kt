...
public class InlineV1PaymentMethodConfigurationsPostRequestFormPaytoXfb7f3010(
    public val displayPreference: InlineV1PaymentMethodConfidc49PostRequestFormPaytoDisplayPreferenceX7f2529bd? = null,
) {
    public class Builder {
        public var displayPreference:
            InlineV1PaymentMethodConfidc49PostRequestFormPaytoDisplayPreferenceX7f2529bd? = null

        public fun build(): InlineV1PaymentMethodConfigurationsPostRequestFormPaytoXfb7f3010 =
            InlineV1PaymentMethodConfigurationsPostRequestFormPaytoXfb7f3010(
                displayPreference = displayPreference,
            )
    }

    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PaymentMethodConfigurationsPostRequestFormPaytoXfb7f3010 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentMethodConfigurationsPostRequestFormPaytoXfb7f3010> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentMethodConfigurationsPostRequestFormPaytoXfb7f3010 must be a JSON object",
                    )
            return InlineV1PaymentMethodConfigurationsPostRequestFormPaytoXfb7f3010(
                displayPreference =
                    rawObject["display_preference"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentMethodConfidc49PostRequestFormPaytoDisplayPreferenceX7f2529bd>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentMethodConfigurationsPostRequestFormPaytoXfb7f3010,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentMethodConfigurationsPostRequestFormPaytoXfb7f3010(
    block: InlineV1PaymentMethodConfigurationsPostRequestFormPaytoXfb7f3010.Builder.() -> Unit,
): InlineV1PaymentMethodConfigurationsPostRequestFormPaytoXfb7f3010 =
    InlineV1PaymentMethodConfigurationsPostRequestFormPaytoXfb7f3010.build(block)
