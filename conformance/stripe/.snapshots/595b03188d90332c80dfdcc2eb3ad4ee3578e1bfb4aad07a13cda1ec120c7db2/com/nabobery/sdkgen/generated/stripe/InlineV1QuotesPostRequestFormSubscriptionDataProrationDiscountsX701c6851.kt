...
public sealed class InlineV1QuotesPostRequestFormSubscriptionDataProrationDiscountsX701c6851 {
    ...
    public object Serializer : KSerializer<InlineV1QuotesPostRequestFormSubscriptionDataProrationDiscountsX701c6851> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1QuotesPostRequestFormSubscriptionDataProrationDiscountsX701c6851",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1QuotesPostRequestFormSubscriptionDataProrationDiscountsX701c6851 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1QuotesPostRequestFormSubscriptionDataProrationDiscountsX701c6851,
        ) {
