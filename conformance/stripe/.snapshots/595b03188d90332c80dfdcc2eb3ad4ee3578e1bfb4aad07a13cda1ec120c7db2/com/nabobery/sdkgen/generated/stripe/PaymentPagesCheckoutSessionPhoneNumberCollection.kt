...
public class PaymentPagesCheckoutSessionPhoneNumberCollection(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentPagesCheckoutSessionPhoneNumberCollection =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentPagesCheckoutSessionPhoneNumberCollection> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "PaymentPagesCheckoutSessionPhoneNumberCollection must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentPagesCheckoutSessionPhoneNumberCollection,
        ) {
...
public fun paymentPagesCheckoutSessionPhoneNumberCollection(
    block: PaymentPagesCheckoutSessionPhoneNumberCollection.Builder.() -> Unit,
): PaymentPagesCheckoutSessionPhoneNumberCollection = PaymentPagesCheckoutSessionPhoneNumberCollection.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "PaymentPagesCheckoutSessionPhoneNumberCollection is missing required property '" + name + "'",
            )
