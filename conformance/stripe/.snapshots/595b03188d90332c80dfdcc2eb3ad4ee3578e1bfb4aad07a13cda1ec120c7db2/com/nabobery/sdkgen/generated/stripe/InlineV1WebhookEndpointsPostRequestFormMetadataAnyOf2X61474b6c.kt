...
public sealed class InlineV1WebhookEndpointsPostRequestFormMetadataAnyOf2X61474b6c {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1WebhookEndpointsPostRequestFormMetadataAnyOf2X61474b6c =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1WebhookEndpointsPostRequestFormMetadataAnyOf2X61474b6c> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1WebhookEndpointsPostRequestFormMetadataAnyOf2X61474b6c",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1WebhookEndpointsPostRequestFormMetadataAnyOf2X61474b6c =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1WebhookEndpointsPostRequestFormMetadataAnyOf2X61474b6c,
        ) {
