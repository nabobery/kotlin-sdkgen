...
public class GelatoIdNumberReportError(
    ...
    public class Builder {
        ...
        public fun build(): GelatoIdNumberReportError =
    ...
    public object Serializer : KSerializer<GelatoIdNumberReportError> {
        ...
        override fun deserialize(decoder: Decoder): GelatoIdNumberReportError {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("GelatoIdNumberReportError must be a JSON object")
                ...
                code =
                    rawObject["code"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineGelatoIdNumberReportErrorCodeXa1b434dd?>(element)
                        }
                    },
                reason =
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: GelatoIdNumberReportError,
        ) {
...
public fun gelatoIdNumberReportError(block: GelatoIdNumberReportError.Builder.() -> Unit): GelatoIdNumberReportError =
    GelatoIdNumberReportError.build(block)
