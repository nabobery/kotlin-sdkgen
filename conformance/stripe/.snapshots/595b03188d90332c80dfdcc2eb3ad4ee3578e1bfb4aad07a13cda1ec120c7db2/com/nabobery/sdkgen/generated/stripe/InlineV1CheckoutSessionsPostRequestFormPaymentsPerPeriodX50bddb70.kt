...
internal data class InlineV1CheckoutSessionsPostRequestFormPaymentsPerPeriodX50bddb70Inspection(
    ...
    public val matchesInlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsPaytoAnyOf2X2b715b1f: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsPaytoAnyOf2X2b715b1f,
            ).count {
                it
            }
}
...
public class InlineV1CheckoutSessionsPostRequestFormPaymentsPerPeriodX50bddb70 internal constructor(
    ...
    private val inspection: InlineV1CheckoutSessionsPostRequestFormPaymentsPerPeriodX50bddb70Inspection,
) {
    ...
    public val inlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsPaytoAnyOf2X2b715b1f:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsPaytoAnyOf2X2b715b1f) {
                json
                    .decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsPaytoAnyOf2X2b715b1f>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1CheckoutSessionsPostRequestFormPaymentsPerPeriodX50bddb70Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsPaytoAnyOf2X2b715b1f) {
                    add(
                        InlineV1CheckoutSessionsPostRequestFormPaymentsPerPeriodX50bddb70Branch.InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsPaytoAnyOf2X2b715b1f,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1CheckoutSessionsPostRequestFormPaymentsPerPeriodX50bddb70 {
            val inspection = inspectInlineV1CheckoutSessionsPostRequestFormPaymentsPerPeriodX50bddb70(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1CheckoutSessionsPostRequestFormPaymentsPerPeriodX50bddb70NoMatchException(
                    "InlineV1CheckoutSessionsPostRequestFormPaymentsPerPeriodX50bddb70 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormPaymentsPerPeriodX50bddb70> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsPostRequestFormPaymentsPerPeriodX50bddb70,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1CheckoutSessionsPostRequestFormPaymentsPerPeriodX50bddb70",
...
private fun inspectInlineV1CheckoutSessionsPostRequestFormPaymentsPerPeriodX50bddb70(
    element: JsonElement,
): InlineV1CheckoutSessionsPostRequestFormPaymentsPerPeriodX50bddb70Inspection {
    val matchesBranch1 = element.isJsonDecodable<Int>()
    val matchesInlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsPaytoAnyOf2X2b715b1f =
        element
            .isJsonDecodable<InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsPaytoAnyOf2X2b715b1f>()
    return InlineV1CheckoutSessionsPostRequestFormPaymentsPerPeriodX50bddb70Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsPaytoAnyOf2X2b715b1f) {
                    add(
                        "InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsPaytoAnyOf2X2b715b1f: value does not match InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsPaytoAnyOf2X2b715b1f",
                    )
                }
            },
    )
