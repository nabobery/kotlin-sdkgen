...
public sealed class InlineV1InvoicesCreatePreviewPostRequestFormPreviewModeXcb77da30 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1InvoicesCreatePreviewPostRequestFormPreviewModeXcb77da30 =
            when (value) {
                Next.value -> Next
    ...
    public object Serializer : KSerializer<InlineV1InvoicesCreatePreviewPostRequestFormPreviewModeXcb77da30> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1InvoicesCreatePreviewPostRequestFormPreviewModeXcb77da30",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1InvoicesCreatePreviewPostRequestFormPreviewModeXcb77da30 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesCreatePreviewPostRequestFormPreviewModeXcb77da30,
        ) {
