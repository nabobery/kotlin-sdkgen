...
public class InlineV1IssuingDisputesPostRequestFormEvidenceAnyOf1X42642162(
    ...
    public val cancellationReason: InlineV1IssuingDisputesPostRequestFormEvidenceCancellationReasonX85bed7e8? = null,
    public val explanation: InlineV1IssuingDisputesPostRequestFormEvidenceExplanationX1f3c00ed? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1IssuingDisputesPostRequestFormEvidenceAnyOf1X42642162 =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1IssuingDisputesPostRequestFormEvidenceAnyOf1X42642162 =
    ...
    public object Serializer : KSerializer<InlineV1IssuingDisputesPostRequestFormEvidenceAnyOf1X42642162> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1IssuingDisputesPostRequestFormEvidenceAnyOf1X42642162 must be a JSON object",
                    )
            return InlineV1IssuingDisputesPostRequestFormEvidenceAnyOf1X42642162(
                additionalDocumentation =
                    rawObject["additional_documentation"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1IssuingDisputesPostRequestFormEvidenceAdditionalDocumentationX9ff55b1f>(
                                it,
                            )
                    },
                canceledAt =
                    rawObject["canceled_at"]?.let {
                        json.decodeFromJsonElement<InlineV1IssuingDisputesPostRequestFormEvidenceCanceledAtX45bd3060>(
                            it,
                        )
                    },
                cancellationReason =
                    rawObject["cancellation_reason"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1IssuingDisputesPostRequestFormEvidenceCancellationReasonX85bed7e8>(
                                it,
                            )
                    },
                explanation =
                    rawObject["explanation"]?.let {
                        json.decodeFromJsonElement<InlineV1IssuingDisputesPostRequestFormEvidenceExplanationX1f3c00ed>(
                            it,
                        )
                    },
                receivedAt =
                    rawObject["received_at"]?.let {
                        json.decodeFromJsonElement<InlineV1IssuingDisputesPostRequestFormEvidenceReceivedAtXc5f1169b>(
                            it,
                        )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingDisputesPostRequestFormEvidenceAnyOf1X42642162,
        ) {
            val jsonEncoder =
...
public fun inlineV1IssuingDisputesPostRequestFormEvidenceAnyOf1X42642162(
    block: InlineV1IssuingDisputesPostRequestFormEvidenceAnyOf1X42642162.Builder.() -> Unit,
): InlineV1IssuingDisputesPostRequestFormEvidenceAnyOf1X42642162 =
    InlineV1IssuingDisputesPostRequestFormEvidenceAnyOf1X42642162.build(block)
