...
internal data class InlineV1IssuingAuthorizationsDeclinePostRequestFormMetadataX10fdf7caInspection(
    ...
    public val matchesInlineV1IssuingAuthorizationsDeclinePostRequestFormMetadataAnyOf2Xcd0baea7: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1IssuingAuthorizationsDeclinePostRequestFormMetadataAnyOf2Xcd0baea7,
            ).count {
                it
            }
}
...
public class InlineV1IssuingAuthorizationsDeclinePostRequestFormMetadataX10fdf7ca internal constructor(
    ...
    private val inspection: InlineV1IssuingAuthorizationsDeclinePostRequestFormMetadataX10fdf7caInspection,
) {
    ...
    public val inlineV1IssuingAuthorizationsDeclinePostRequestFormMetadataAnyOf2Xcd0baea7:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1IssuingAuthorizationsDeclinePostRequestFormMetadataAnyOf2Xcd0baea7) {
                json
                    .decodeFromJsonElement<InlineV1IssuingAuthorizationsDeclinePostRequestFormMetadataAnyOf2Xcd0baea7>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1IssuingAuthorizationsDeclinePostRequestFormMetadataX10fdf7caBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1IssuingAuthorizationsDeclinePostRequestFormMetadataAnyOf2Xcd0baea7) {
                    add(
                        InlineV1IssuingAuthorizationsDeclinePostRequestFormMetadataX10fdf7caBranch.InlineV1IssuingAuthorizationsDeclinePostRequestFormMetadataAnyOf2Xcd0baea7,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1IssuingAuthorizationsDeclinePostRequestFormMetadataX10fdf7ca {
            val inspection = inspectInlineV1IssuingAuthorizationsDeclinePostRequestFormMetadataX10fdf7ca(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1IssuingAuthorizationsDeclinePostRequestFormMetadataX10fdf7caNoMatchException(
                    "InlineV1IssuingAuthorizationsDeclinePostRequestFormMetadataX10fdf7ca matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1IssuingAuthorizationsDeclinePostRequestFormMetadataX10fdf7ca> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingAuthorizationsDeclinePostRequestFormMetadataX10fdf7ca,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1IssuingAuthorizationsDeclinePostRequestFormMetadataX10fdf7ca",
...
private fun inspectInlineV1IssuingAuthorizationsDeclinePostRequestFormMetadataX10fdf7ca(
    element: JsonElement,
): InlineV1IssuingAuthorizationsDeclinePostRequestFormMetadataX10fdf7caInspection {
    val matchesBranch1 = element.isJsonDecodable<JsonObject>()
    val matchesInlineV1IssuingAuthorizationsDeclinePostRequestFormMetadataAnyOf2Xcd0baea7 =
        element
            .isJsonDecodable<InlineV1IssuingAuthorizationsDeclinePostRequestFormMetadataAnyOf2Xcd0baea7>()
    return InlineV1IssuingAuthorizationsDeclinePostRequestFormMetadataX10fdf7caInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1IssuingAuthorizationsDeclinePostRequestFormMetadataAnyOf2Xcd0baea7) {
                    add(
                        "InlineV1IssuingAuthorizationsDeclinePostRequestFormMetadataAnyOf2Xcd0baea7: value does not match InlineV1IssuingAuthorizationsDeclinePostRequestFormMetadataAnyOf2Xcd0baea7",
                    )
                }
            },
    )
