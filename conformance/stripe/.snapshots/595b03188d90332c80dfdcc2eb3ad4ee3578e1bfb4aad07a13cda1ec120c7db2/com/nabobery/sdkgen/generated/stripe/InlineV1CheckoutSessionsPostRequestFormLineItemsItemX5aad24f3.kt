...
public class InlineV1CheckoutSessionsPostRequestFormLineItemsItemX5aad24f3(
    ...
    public val dynamicTaxRates: List<String>? = null,
    public val metadata: Map<String, String>? = null,
    public val price: String? = null,
    public val priceData: InlineV1CheckoutSessionsPostRequestFormLineItemsItemPriceDataX9cb4c560? = null,
    public val quantity: Int? = null,
    public val taxRates: List<String>? = null,
) {
    public class Builder {
        public var adjustableQuantity:
            InlineV1CheckoutSessionsPostRequestFormLineItemsItemAdjustableQuantityX5f0bbed0? = null

        public var dynamicTaxRates: List<String>? = null
        ...
        public var taxRates: List<String>? = null

        public fun build(): InlineV1CheckoutSessionsPostRequestFormLineItemsItemX5aad24f3 =
            InlineV1CheckoutSessionsPostRequestFormLineItemsItemX5aad24f3(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1CheckoutSessionsPostRequestFormLineItemsItemX5aad24f3 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormLineItemsItemX5aad24f3> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CheckoutSessionsPostRequestFormLineItemsItemX5aad24f3 must be a JSON object",
                    )
            return InlineV1CheckoutSessionsPostRequestFormLineItemsItemX5aad24f3(
                adjustableQuantity =
                    rawObject["adjustable_quantity"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormLineItemsItemAdjustableQuantityX5f0bbed0>(
                                it,
                            )
                    },
                dynamicTaxRates =
                    rawObject["dynamic_tax_rates"]?.let {
                ...
                priceData =
                    rawObject["price_data"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormLineItemsItemPriceDataX9cb4c560>(
                                it,
                            )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsPostRequestFormLineItemsItemX5aad24f3,
        ) {
            val jsonEncoder =
...
public fun inlineV1CheckoutSessionsPostRequestFormLineItemsItemX5aad24f3(
    block: InlineV1CheckoutSessionsPostRequestFormLineItemsItemX5aad24f3.Builder.() -> Unit,
): InlineV1CheckoutSessionsPostRequestFormLineItemsItemX5aad24f3 =
    InlineV1CheckoutSessionsPostRequestFormLineItemsItemX5aad24f3.build(block)
