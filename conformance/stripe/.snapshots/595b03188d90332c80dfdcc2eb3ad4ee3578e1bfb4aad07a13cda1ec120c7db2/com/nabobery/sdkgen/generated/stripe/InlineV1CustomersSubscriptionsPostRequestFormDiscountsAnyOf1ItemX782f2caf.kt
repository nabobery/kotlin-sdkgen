...
public class InlineV1CustomersSubscriptionsPostRequestFormDiscountsAnyOf1ItemX782f2caf(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1CustomersSubscriptionsPostRequestFormDiscountsAnyOf1ItemX782f2caf =
            InlineV1CustomersSubscriptionsPostRequestFormDiscountsAnyOf1ItemX782f2caf(
                coupon = coupon,
                discount = discount,
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1CustomersSubscriptionsPostRequestFormDiscountsAnyOf1ItemX782f2caf = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1CustomersSubscriptionsPostRequestFormDiscountsAnyOf1ItemX782f2caf> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CustomersSubscriptionsPostRequestFormDiscountsAnyOf1ItemX782f2caf must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersSubscriptionsPostRequestFormDiscountsAnyOf1ItemX782f2caf,
        ) {
            val jsonEncoder =
...
public fun inlineV1CustomersSubscriptionsPostRequestFormDiscountsAnyOf1ItemX782f2caf(
    block: InlineV1CustomersSubscriptionsPostRequestFormDiscountsAnyOf1ItemX782f2caf.Builder.() -> Unit,
): InlineV1CustomersSubscriptionsPostRequestFormDiscountsAnyOf1ItemX782f2caf =
