...
public class InlineV1IssuingCardsPostRequestFormShippingXd723d6b8(
    ...
    public val addressValidation: InlineV1IssuingCardsPostRequestFormShippingAddressValidationX3c6f65d9? = null,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1IssuingCardsPostRequestFormShippingXd723d6b8 =
    ...
    public object Serializer : KSerializer<InlineV1IssuingCardsPostRequestFormShippingXd723d6b8> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1IssuingCardsPostRequestFormShippingXd723d6b8 must be a JSON object",
                    )
            val address =
                json.decodeRequired<InlineV1IssuingCardsPostRequestFormShippingAddressXce0bfa5b>(
                    rawObject,
                    "address",
                )
            ...
            return InlineV1IssuingCardsPostRequestFormShippingXd723d6b8(
                ...
                addressValidation =
                    rawObject["address_validation"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1IssuingCardsPostRequestFormShippingAddressValidationX3c6f65d9>(
                                it,
                            )
                    },
                customs =
                    rawObject["customs"]?.let {
                        json.decodeFromJsonElement<InlineV1IssuingCardsPostRequestFormShippingCustomsXf34d40d2>(it)
                    },
                ...
                service =
                    rawObject["service"]?.let {
                        json.decodeFromJsonElement<InlineV1IssuingCardsPostRequestFormShippingServiceX4b8d197b>(it)
                    },
                type =
                    rawObject["type"]?.let {
                        json.decodeFromJsonElement<InlineV1IssuingCardsPostRequestFormShippingTypeXa511430d>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingCardsPostRequestFormShippingXd723d6b8,
        ) {
...
public fun inlineV1IssuingCardsPostRequestFormShippingXd723d6b8(
    block: InlineV1IssuingCardsPostRequestFormShippingXd723d6b8.Builder.() -> Unit,
): InlineV1IssuingCardsPostRequestFormShippingXd723d6b8 =
    InlineV1IssuingCardsPostRequestFormShippingXd723d6b8.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1IssuingCardsPostRequestFormShippingXd723d6b8 is missing required property '" + name + "'",
            )
