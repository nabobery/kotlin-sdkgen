...
public sealed class InlineCheckoutSofortPaymentMethodOptionsSetupFutureUsageX06c15030 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineCheckoutSofortPaymentMethodOptionsSetupFutureUsageX06c15030 =
            when (value) {
                None.value -> None
    ...
    public object Serializer : KSerializer<InlineCheckoutSofortPaymentMethodOptionsSetupFutureUsageX06c15030> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineCheckoutSofortPaymentMethodOptionsSetupFutureUsageX06c15030",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineCheckoutSofortPaymentMethodOptionsSetupFutureUsageX06c15030 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineCheckoutSofortPaymentMethodOptionsSetupFutureUsageX06c15030,
        ) {
