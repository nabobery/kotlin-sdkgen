...
public sealed class InlineV1TaxSettingsPostRequestFormDefaultsTaxBehaviorXe34cddd4 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1TaxSettingsPostRequestFormDefaultsTaxBehaviorXe34cddd4 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1TaxSettingsPostRequestFormDefaultsTaxBehaviorXe34cddd4> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1TaxSettingsPostRequestFormDefaultsTaxBehaviorXe34cddd4",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1TaxSettingsPostRequestFormDefaultsTaxBehaviorXe34cddd4 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TaxSettingsPostRequestFormDefaultsTaxBehaviorXe34cddd4,
        ) {
