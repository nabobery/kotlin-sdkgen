...
public class SubscriptionScheduleConfigurationItem(
     ...
     */
    public val billingThresholds: InlineSubscriptionScheduleConfigurationItemBillingThresholdsX55f2ab3a? = null,
    /**
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): SubscriptionScheduleConfigurationItem =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<SubscriptionScheduleConfigurationItem> {
        ...
        override fun deserialize(decoder: Decoder): SubscriptionScheduleConfigurationItem {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("SubscriptionScheduleConfigurationItem must be a JSON object")
            val discounts = json.decodeRequired<List<StackableDiscountWithDiscountSettings>>(rawObject, "discounts")
            val price =
                json.decodeRequired<InlineSubscriptionScheduleConfigurationItemPriceXebf3c02c>(
                    rawObject,
                    "price",
                )
            return SubscriptionScheduleConfigurationItem(
                ...
                billingThresholds =
                    rawObject["billing_thresholds"]?.let { element ->
                        if (element ==
                            ...
                            json
                                .decodeFromJsonElement<InlineSubscriptionScheduleConfigurationItemBillingThresholdsX55f2ab3a?>(
                                    element,
                                )
                        }
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: SubscriptionScheduleConfigurationItem,
        ) {
...
public fun subscriptionScheduleConfigurationItem(
    block: SubscriptionScheduleConfigurationItem.Builder.() -> Unit,
): SubscriptionScheduleConfigurationItem = SubscriptionScheduleConfigurationItem.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "SubscriptionScheduleConfigurationItem is missing required property '" + name + "'",
            )
