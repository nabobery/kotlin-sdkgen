...
public sealed class InlineV1AccountsPersonsPostRequestFormDobAnyOf2X5a6c2dfe {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1AccountsPersonsPostRequestFormDobAnyOf2X5a6c2dfe =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1AccountsPersonsPostRequestFormDobAnyOf2X5a6c2dfe> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1AccountsPersonsPostRequestFormDobAnyOf2X5a6c2dfe",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1AccountsPersonsPostRequestFormDobAnyOf2X5a6c2dfe =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPersonsPostRequestFormDobAnyOf2X5a6c2dfe,
        ) {
