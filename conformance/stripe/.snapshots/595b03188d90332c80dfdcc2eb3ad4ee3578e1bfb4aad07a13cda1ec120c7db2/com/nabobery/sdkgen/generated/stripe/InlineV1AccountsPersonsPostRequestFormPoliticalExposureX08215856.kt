...
public sealed class InlineV1AccountsPersonsPostRequestFormPoliticalExposureX08215856 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1AccountsPersonsPostRequestFormPoliticalExposureX08215856 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1AccountsPersonsPostRequestFormPoliticalExposureX08215856> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1AccountsPersonsPostRequestFormPoliticalExposureX08215856",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1AccountsPersonsPostRequestFormPoliticalExposureX08215856 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPersonsPostRequestFormPoliticalExposureX08215856,
        ) {
