...
public class InlineV1AccountsPostRequestFormGroupsX165c6212(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1AccountsPostRequestFormGroupsX165c6212 =
            InlineV1AccountsPostRequestFormGroupsX165c6212(
                paymentsPricing = paymentsPricing,
            )
    }

    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1AccountsPostRequestFormGroupsX165c6212 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1AccountsPostRequestFormGroupsX165c6212> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountsPostRequestFormGroupsX165c6212 must be a JSON object",
                    )
            return InlineV1AccountsPostRequestFormGroupsX165c6212(
                paymentsPricing =
                    rawObject["payments_pricing"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPostRequestFormGroupsPaymentsPricingX8830e40e>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPostRequestFormGroupsX165c6212,
        ) {
...
public fun inlineV1AccountsPostRequestFormGroupsX165c6212(
    block: InlineV1AccountsPostRequestFormGroupsX165c6212.Builder.() -> Unit,
): InlineV1AccountsPostRequestFormGroupsX165c6212 = InlineV1AccountsPostRequestFormGroupsX165c6212.build(block)
