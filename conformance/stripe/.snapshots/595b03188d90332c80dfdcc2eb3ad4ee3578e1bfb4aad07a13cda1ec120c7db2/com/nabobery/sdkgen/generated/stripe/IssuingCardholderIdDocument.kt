...
public class IssuingCardholderIdDocument(
    ...
    public class Builder {
        ...
        public fun build(): IssuingCardholderIdDocument =
    ...
    public object Serializer : KSerializer<IssuingCardholderIdDocument> {
        ...
        override fun deserialize(decoder: Decoder): IssuingCardholderIdDocument {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("IssuingCardholderIdDocument must be a JSON object")
                ...
                back =
                    rawObject["back"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineIssuingCardholderIdDocumentBackX7c37f4b6?>(element)
                        }
                    },
                front =
                    rawObject["front"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineIssuingCardholderIdDocumentFrontXae327429?>(element)
                        }
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: IssuingCardholderIdDocument,
        ) {
...
public fun issuingCardholderIdDocument(
    block: IssuingCardholderIdDocument.Builder.() -> Unit,
): IssuingCardholderIdDocument = IssuingCardholderIdDocument.build(block)
