...
internal data class InlineV1CheckoutSessionsPostRequestFormMetadataXea1d646fInspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1CheckoutSessionsPostRequestFormMetadataAnyOf2X99f48c69,
            ).count { it }
}
...
public class InlineV1CheckoutSessionsPostRequestFormMetadataXea1d646f internal constructor(
    ...
    public val inlineV1CheckoutSessionsPostRequestFormMetadataAnyOf2X99f48c69:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1CheckoutSessionsPostRequestFormMetadataAnyOf2X99f48c69) {
                json
                    .decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormMetadataAnyOf2X99f48c69>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1CheckoutSessionsPostRequestFormMetadataXea1d646fBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1CheckoutSessionsPostRequestFormMetadataAnyOf2X99f48c69) {
                    add(
                        InlineV1CheckoutSessionsPostRequestFormMetadataXea1d646fBranch.InlineV1CheckoutSessionsPostRequestFormMetadataAnyOf2X99f48c69,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1CheckoutSessionsPostRequestFormMetadataXea1d646f {
            val inspection = inspectInlineV1CheckoutSessionsPostRequestFormMetadataXea1d646f(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1CheckoutSessionsPostRequestFormMetadataXea1d646fNoMatchException(
                    "InlineV1CheckoutSessionsPostRequestFormMetadataXea1d646f matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormMetadataXea1d646f> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsPostRequestFormMetadataXea1d646f,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1CheckoutSessionsPostRequestFormMetadataXea1d646f",
...
private fun inspectInlineV1CheckoutSessionsPostRequestFormMetadataXea1d646f(
    element: JsonElement,
): InlineV1CheckoutSessionsPostRequestFormMetadataXea1d646fInspection {
    val matchesBranch1 = element.isJsonDecodable<JsonObject>()
    val matchesInlineV1CheckoutSessionsPostRequestFormMetadataAnyOf2X99f48c69 =
        element
            .isJsonDecodable<InlineV1CheckoutSessionsPostRequestFormMetadataAnyOf2X99f48c69>()
    return InlineV1CheckoutSessionsPostRequestFormMetadataXea1d646fInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1CheckoutSessionsPostRequestFormMetadataAnyOf2X99f48c69) {
                    add(
                        "InlineV1CheckoutSessionsPostRequestFormMetadataAnyOf2X99f48c69: value does not match InlineV1CheckoutSessionsPostRequestFormMetadataAnyOf2X99f48c69",
                    )
                }
            },
    )
