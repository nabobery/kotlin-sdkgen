...
internal data class InlineV1QuotesPostRequestFormApplicationFeeAmountX2e2ac96fInspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1QuotesPostRequestFormApplicationFeeAmountAnyOf2X9acea27a,
            ).count { it }
}
...
public class InlineV1QuotesPostRequestFormApplicationFeeAmountX2e2ac96f internal constructor(
    ...
    public val inlineV1QuotesPostRequestFormApplicationFeeAmountAnyOf2X9acea27a:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1QuotesPostRequestFormApplicationFeeAmountAnyOf2X9acea27a) {
                json
                    .decodeFromJsonElement<InlineV1QuotesPostRequestFormApplicationFeeAmountAnyOf2X9acea27a>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1QuotesPostRequestFormApplicationFeeAmountX2e2ac96fBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1QuotesPostRequestFormApplicationFeeAmountAnyOf2X9acea27a) {
                    add(
                        InlineV1QuotesPostRequestFormApplicationFeeAmountX2e2ac96fBranch.InlineV1QuotesPostRequestFormApplicationFeeAmountAnyOf2X9acea27a,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1QuotesPostRequestFormApplicationFeeAmountX2e2ac96f {
            val inspection = inspectInlineV1QuotesPostRequestFormApplicationFeeAmountX2e2ac96f(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1QuotesPostRequestFormApplicationFeeAmountX2e2ac96fNoMatchException(
                    "InlineV1QuotesPostRequestFormApplicationFeeAmountX2e2ac96f matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1QuotesPostRequestFormApplicationFeeAmountX2e2ac96f> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1QuotesPostRequestFormApplicationFeeAmountX2e2ac96f,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1QuotesPostRequestFormApplicationFeeAmountX2e2ac96f",
...
private fun inspectInlineV1QuotesPostRequestFormApplicationFeeAmountX2e2ac96f(
    element: JsonElement,
): InlineV1QuotesPostRequestFormApplicationFeeAmountX2e2ac96fInspection {
    val matchesBranch1 = element.isJsonDecodable<Int>()
    val matchesInlineV1QuotesPostRequestFormApplicationFeeAmountAnyOf2X9acea27a =
        element
            .isJsonDecodable<InlineV1QuotesPostRequestFormApplicationFeeAmountAnyOf2X9acea27a>()
    return InlineV1QuotesPostRequestFormApplicationFeeAmountX2e2ac96fInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1QuotesPostRequestFormApplicationFeeAmountAnyOf2X9acea27a) {
                    add(
                        "InlineV1QuotesPostRequestFormApplicationFeeAmountAnyOf2X9acea27a: value does not match InlineV1QuotesPostRequestFormApplicationFeeAmountAnyOf2X9acea27a",
                    )
                }
            },
    )
