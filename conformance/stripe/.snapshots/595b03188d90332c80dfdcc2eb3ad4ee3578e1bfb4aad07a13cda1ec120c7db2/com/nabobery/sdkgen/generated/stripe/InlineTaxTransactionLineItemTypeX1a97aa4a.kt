...
public sealed class InlineTaxTransactionLineItemTypeX1a97aa4a {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineTaxTransactionLineItemTypeX1a97aa4a =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineTaxTransactionLineItemTypeX1a97aa4a> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineTaxTransactionLineItemTypeX1a97aa4a",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineTaxTransactionLineItemTypeX1a97aa4a =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineTaxTransactionLineItemTypeX1a97aa4a,
        ) {
