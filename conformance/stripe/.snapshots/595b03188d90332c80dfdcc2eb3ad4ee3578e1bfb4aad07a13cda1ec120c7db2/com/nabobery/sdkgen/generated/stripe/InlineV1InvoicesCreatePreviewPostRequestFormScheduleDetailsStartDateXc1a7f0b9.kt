...
internal data class InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsStartDateXc1a7f0b9Inspection(
    ...
    public val matchesInlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesAnyOf2X04239579: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesAnyOf2X04239579,
            ).count {
                it
            }
}
...
public class InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsStartDateXc1a7f0b9 internal constructor(
    ...
    private val inspection: InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsStartDateXc1a7f0b9Inspection,
) {
    ...
    public val inlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesAnyOf2X04239579:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesAnyOf2X04239579) {
                json
                    .decodeFromJsonElement<InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesAnyOf2X04239579>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsStartDateXc1a7f0b9Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesAnyOf2X04239579) {
                    add(
                        InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsStartDateXc1a7f0b9Branch.InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesAnyOf2X04239579,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsStartDateXc1a7f0b9 {
            val inspection = inspectInlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsStartDateXc1a7f0b9(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsStartDateXc1a7f0b9NoMatchException(
                    "InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsStartDateXc1a7f0b9 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsStartDateXc1a7f0b9> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsStartDateXc1a7f0b9,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsStartDateXc1a7f0b9",
...
private fun inspectInlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsStartDateXc1a7f0b9(
    element: JsonElement,
): InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsStartDateXc1a7f0b9Inspection {
    val matchesBranch1 = element.isJsonDecodable<Int>()
    val matchesInlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesAnyOf2X04239579 =
        element
            .isJsonDecodable<InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesAnyOf2X04239579>()
    return InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsStartDateXc1a7f0b9Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesAnyOf2X04239579) {
                    add(
                        "InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesAnyOf2X04239579: value does not match InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesAnyOf2X04239579",
                    )
                }
            },
    )
