...
public sealed class InlineAccountCapabilitiesIdealPaymentsXbb683bd9 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineAccountCapabilitiesIdealPaymentsXbb683bd9 =
            when (value) {
                Active.value -> Active
    ...
    public object Serializer : KSerializer<InlineAccountCapabilitiesIdealPaymentsXbb683bd9> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineAccountCapabilitiesIdealPaymentsXbb683bd9",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineAccountCapabilitiesIdealPaymentsXbb683bd9 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineAccountCapabilitiesIdealPaymentsXbb683bd9,
        ) {
