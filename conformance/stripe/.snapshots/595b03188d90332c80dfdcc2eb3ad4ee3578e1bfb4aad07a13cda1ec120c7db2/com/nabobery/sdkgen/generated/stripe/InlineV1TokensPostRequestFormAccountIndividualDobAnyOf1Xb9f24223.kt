...
public class InlineV1TokensPostRequestFormAccountIndividualDobAnyOf1Xb9f24223(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TokensPostRequestFormAccountIndividualDobAnyOf1Xb9f24223 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TokensPostRequestFormAccountIndividualDobAnyOf1Xb9f24223> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TokensPostRequestFormAccountIndividualDobAnyOf1Xb9f24223 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TokensPostRequestFormAccountIndividualDobAnyOf1Xb9f24223,
        ) {
            val jsonEncoder =
...
public fun inlineV1TokensPostRequestFormAccountIndividualDobAnyOf1Xb9f24223(
    block: InlineV1TokensPostRequestFormAccountIndividualDobAnyOf1Xb9f24223.Builder.() -> Unit,
): InlineV1TokensPostRequestFormAccountIndividualDobAnyOf1Xb9f24223 =
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TokensPostRequestFormAccountIndividualDobAnyOf1Xb9f24223 is missing required property '" + name +
                    "'",
            )
