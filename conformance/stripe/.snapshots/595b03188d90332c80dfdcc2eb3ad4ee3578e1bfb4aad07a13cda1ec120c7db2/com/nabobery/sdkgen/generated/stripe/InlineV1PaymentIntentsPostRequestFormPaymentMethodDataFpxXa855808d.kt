...
public class InlineV1PaymentIntentsPostRequestFormPaymentMethodDataFpxXa855808d(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentIntentsPostRequestFormPaymentMethodDataFpxXa855808d = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormPaymentMethodDataFpxXa855808d> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsPostRequestFormPaymentMethodDataFpxXa855808d must be a JSON object",
                    )
            val bank =
                json.decodeRequired<InlineV1PaymentIntentsPostRequestFormPaymentMethodDataFpxBankX05d4db2a>(
                    rawObject,
                    "bank",
                )
            return InlineV1PaymentIntentsPostRequestFormPaymentMethodDataFpxXa855808d(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormPaymentMethodDataFpxXa855808d,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentIntentsPostRequestFormPaymentMethodDataFpxXa855808d(
    block: InlineV1PaymentIntentsPostRequestFormPaymentMethodDataFpxXa855808d.Builder.() -> Unit,
): InlineV1PaymentIntentsPostRequestFormPaymentMethodDataFpxXa855808d =
    InlineV1PaymentIntentsPostRequestFormPaymentMethodDataFpxXa855808d.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentIntentsPostRequestFormPaymentMethodDataFpxXa855808d is missing required property '" +
                    name +
                    "'",
            )
