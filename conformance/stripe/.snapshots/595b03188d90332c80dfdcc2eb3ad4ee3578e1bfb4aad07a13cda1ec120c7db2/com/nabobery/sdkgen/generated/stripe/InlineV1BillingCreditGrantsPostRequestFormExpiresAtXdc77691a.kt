...
internal data class InlineV1BillingCreditGrantsPostRequestFormExpiresAtXdc77691aInspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1BillingCreditGrantsPostRequestFormExpiresAtAnyOf2Xb368985a,
            ).count { it }
}
...
public class InlineV1BillingCreditGrantsPostRequestFormExpiresAtXdc77691a internal constructor(
    ...
    public val inlineV1BillingCreditGrantsPostRequestFormExpiresAtAnyOf2Xb368985a:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1BillingCreditGrantsPostRequestFormExpiresAtAnyOf2Xb368985a) {
                json
                    .decodeFromJsonElement<InlineV1BillingCreditGrantsPostRequestFormExpiresAtAnyOf2Xb368985a>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1BillingCreditGrantsPostRequestFormExpiresAtXdc77691aBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1BillingCreditGrantsPostRequestFormExpiresAtAnyOf2Xb368985a) {
                    add(
                        InlineV1BillingCreditGrantsPostRequestFormExpiresAtXdc77691aBranch.InlineV1BillingCreditGrantsPostRequestFormExpiresAtAnyOf2Xb368985a,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1BillingCreditGrantsPostRequestFormExpiresAtXdc77691a {
            val inspection = inspectInlineV1BillingCreditGrantsPostRequestFormExpiresAtXdc77691a(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1BillingCreditGrantsPostRequestFormExpiresAtXdc77691aNoMatchException(
                    "InlineV1BillingCreditGrantsPostRequestFormExpiresAtXdc77691a matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1BillingCreditGrantsPostRequestFormExpiresAtXdc77691a> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1BillingCreditGrantsPostRequestFormExpiresAtXdc77691a,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1BillingCreditGrantsPostRequestFormExpiresAtXdc77691a",
...
private fun inspectInlineV1BillingCreditGrantsPostRequestFormExpiresAtXdc77691a(
    element: JsonElement,
): InlineV1BillingCreditGrantsPostRequestFormExpiresAtXdc77691aInspection {
    val matchesBranch1 = element.isJsonDecodable<Int>()
    val matchesInlineV1BillingCreditGrantsPostRequestFormExpiresAtAnyOf2Xb368985a =
        element
            .isJsonDecodable<InlineV1BillingCreditGrantsPostRequestFormExpiresAtAnyOf2Xb368985a>()
    return InlineV1BillingCreditGrantsPostRequestFormExpiresAtXdc77691aInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1BillingCreditGrantsPostRequestFormExpiresAtAnyOf2Xb368985a) {
                    add(
                        "InlineV1BillingCreditGrantsPostRequestFormExpiresAtAnyOf2Xb368985a: value does not match InlineV1BillingCreditGrantsPostRequestFormExpiresAtAnyOf2Xb368985a",
                    )
                }
            },
    )
