...
public sealed class InlinePaymentFlowsPrivateP67a2StatusX2dda32c1 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentFlowsPrivateP67a2StatusX2dda32c1 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlinePaymentFlowsPrivateP67a2StatusX2dda32c1> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentFlowsPrivateP67a2StatusX2dda32c1",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePaymentFlowsPrivateP67a2StatusX2dda32c1 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentFlowsPrivateP67a2StatusX2dda32c1,
        ) {
