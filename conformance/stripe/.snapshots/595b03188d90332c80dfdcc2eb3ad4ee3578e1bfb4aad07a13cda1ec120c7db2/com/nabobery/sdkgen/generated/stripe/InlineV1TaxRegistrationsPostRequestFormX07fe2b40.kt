...
public class InlineV1TaxRegistrationsPostRequestFormX07fe2b40(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1TaxRegistrationsPostRequestFormX07fe2b40 =
            InlineV1TaxRegistrationsPostRequestFormX07fe2b40(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TaxRegistrationsPostRequestFormX07fe2b40 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TaxRegistrationsPostRequestFormX07fe2b40> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TaxRegistrationsPostRequestFormX07fe2b40 must be a JSON object",
                    )
            return InlineV1TaxRegistrationsPostRequestFormX07fe2b40(
                activeFrom =
                    rawObject["active_from"]?.let {
                        json.decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormActiveFromXf72e779b>(it)
                    },
                expand = rawObject["expand"]?.let { json.decodeFromJsonElement<List<String>>(it) },
                expiresAt =
                    rawObject["expires_at"]?.let {
                        json.decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormExpiresAtX2d54e703>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TaxRegistrationsPostRequestFormX07fe2b40,
        ) {
...
public fun inlineV1TaxRegistrationsPostRequestFormX07fe2b40(
    block: InlineV1TaxRegistrationsPostRequestFormX07fe2b40.Builder.() -> Unit,
): InlineV1TaxRegistrationsPostRequestFormX07fe2b40 = InlineV1TaxRegistrationsPostRequestFormX07fe2b40.build(block)
