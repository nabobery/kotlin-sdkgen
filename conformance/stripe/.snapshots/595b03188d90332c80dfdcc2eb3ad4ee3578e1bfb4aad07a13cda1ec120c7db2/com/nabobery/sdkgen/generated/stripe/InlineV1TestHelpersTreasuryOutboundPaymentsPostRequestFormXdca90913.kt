...
public class InlineV1TestHelpersTreasuryOutboundPaymentsPostRequestFormXdca90913(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1TestHelpersTreasuryOutboundPaymentsPostRequestFormXdca90913 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TestHelpersTreasuryOutboundPaymentsPostRequestFormXdca90913> {
        override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1TestHelpersTreasuryOutboundPaymentsPostRequestFormXdca90913 {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TestHelpersTreasuryOutboundPaymentsPostRequestFormXdca90913 must be a JSON object",
                    )
            val trackingDetails =
                json.decodeRequired<InlineV1TestHelpersTreasura193PostRequestFormTrackingDetailsXab87068d>(
                    rawObject,
                    "tracking_details",
                )
            return InlineV1TestHelpersTreasuryOutboundPaymentsPostRequestFormXdca90913(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TestHelpersTreasuryOutboundPaymentsPostRequestFormXdca90913,
        ) {
            val jsonEncoder =
...
public fun inlineV1TestHelpersTreasuryOutboundPaymentsPostRequestFormXdca90913(
    block: InlineV1TestHelpersTreasuryOutboundPaymentsPostRequestFormXdca90913.Builder.() -> Unit,
): InlineV1TestHelpersTreasuryOutboundPaymentsPostRequestFormXdca90913 =
    InlineV1TestHelpersTreasuryOutboundPaymentsPostRequestFormXdca90913.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TestHelpersTreasuryOutboundPaymentsPostRequestFormXdca90913 is missing required property '" +
                    name +
                    "'",
            )
