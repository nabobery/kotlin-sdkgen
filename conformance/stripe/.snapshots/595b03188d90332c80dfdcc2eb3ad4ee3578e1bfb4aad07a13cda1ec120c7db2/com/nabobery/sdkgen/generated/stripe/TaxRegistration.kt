        ...
        override fun deserialize(decoder: Decoder): TaxRegistration {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("TaxRegistration must be a JSON object")
            val activeFrom = json.decodeRequired<Int>(rawObject, "active_from")
            val country = json.decodeRequired<String>(rawObject, "country")
            val countryOptions =
                json.decodeRequired<TaxProductRegistrationsResourceCountryOptions>(
                    rawObject,
                    "country_options",
                )
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("TaxRegistration is missing required property '" + name + "'")
