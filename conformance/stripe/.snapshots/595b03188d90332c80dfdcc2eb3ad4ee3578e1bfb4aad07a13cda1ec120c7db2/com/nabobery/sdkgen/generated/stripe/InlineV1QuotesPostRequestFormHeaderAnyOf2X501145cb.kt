...
public sealed class InlineV1QuotesPostRequestFormHeaderAnyOf2X501145cb {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1QuotesPostRequestFormHeaderAnyOf2X501145cb =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1QuotesPostRequestFormHeaderAnyOf2X501145cb> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1QuotesPostRequestFormHeaderAnyOf2X501145cb",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1QuotesPostRequestFormHeaderAnyOf2X501145cb =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1QuotesPostRequestFormHeaderAnyOf2X501145cb,
        ) {
