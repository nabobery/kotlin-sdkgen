...
internal data class InlineV1PaymentIntentsPostRequestFormReferencePrefixXce68483aInspection(
    ...
    public val matchesInlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAnyOf2X0834bd4e: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAnyOf2X0834bd4e,
            ).count {
                it
            }
}
...
public class InlineV1PaymentIntentsPostRequestFormReferencePrefixXce68483a internal constructor(
    ...
    public val inlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAnyOf2X0834bd4e:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAnyOf2X0834bd4e) {
                json
                    .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAnyOf2X0834bd4e>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1PaymentIntentsPostRequestFormReferencePrefixXce68483aBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAnyOf2X0834bd4e) {
                    add(
                        InlineV1PaymentIntentsPostRequestFormReferencePrefixXce68483aBranch.InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAnyOf2X0834bd4e,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1PaymentIntentsPostRequestFormReferencePrefixXce68483a {
            val inspection = inspectInlineV1PaymentIntentsPostRequestFormReferencePrefixXce68483a(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1PaymentIntentsPostRequestFormReferencePrefixXce68483aNoMatchException(
                    "InlineV1PaymentIntentsPostRequestFormReferencePrefixXce68483a matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormReferencePrefixXce68483a> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormReferencePrefixXce68483a,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1PaymentIntentsPostRequestFormReferencePrefixXce68483a",
...
private fun inspectInlineV1PaymentIntentsPostRequestFormReferencePrefixXce68483a(
    element: JsonElement,
): InlineV1PaymentIntentsPostRequestFormReferencePrefixXce68483aInspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAnyOf2X0834bd4e =
        element
            .isJsonDecodable<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAnyOf2X0834bd4e>()
    return InlineV1PaymentIntentsPostRequestFormReferencePrefixXce68483aInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAnyOf2X0834bd4e) {
                    add(
                        "InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAnyOf2X0834bd4e: value does not match InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAnyOf2X0834bd4e",
                    )
                }
            },
    )
