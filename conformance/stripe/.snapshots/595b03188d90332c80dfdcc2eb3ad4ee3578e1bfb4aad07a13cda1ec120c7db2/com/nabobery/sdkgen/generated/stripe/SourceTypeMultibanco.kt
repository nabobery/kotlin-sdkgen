...
public class SourceTypeMultibanco(
    ...
    public class Builder {
        ...
        public fun build(): SourceTypeMultibanco =
    ...
    public object Serializer : KSerializer<SourceTypeMultibanco> {
        ...
        override fun deserialize(decoder: Decoder): SourceTypeMultibanco {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("SourceTypeMultibanco must be a JSON object")
            return SourceTypeMultibanco(
                ...
                refundAccountHolderAddressCity =
                    rawObject["refund_account_holder_address_city"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                refundAccountHolderAddressCountry =
                    rawObject["refund_account_holder_address_country"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                refundAccountHolderAddressLine1 =
                    rawObject["refund_account_holder_address_line1"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                refundAccountHolderAddressLine2 =
                    rawObject["refund_account_holder_address_line2"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                refundAccountHolderAddressPostalCode =
                    rawObject["refund_account_holder_address_postal_code"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                refundAccountHolderAddressState =
                    rawObject["refund_account_holder_address_state"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                refundAccountHolderName =
                    rawObject["refund_account_holder_name"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                refundIban =
                    rawObject["refund_iban"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
        ...
        override fun serialize(
            ...
            val raw =
                buildJsonObject {
                    ...
                    value.refundAccountHolderAddressPostalCode?.let {
                        put(
...
public fun sourceTypeMultibanco(block: SourceTypeMultibanco.Builder.() -> Unit): SourceTypeMultibanco =
    SourceTypeMultibanco.build(block)
