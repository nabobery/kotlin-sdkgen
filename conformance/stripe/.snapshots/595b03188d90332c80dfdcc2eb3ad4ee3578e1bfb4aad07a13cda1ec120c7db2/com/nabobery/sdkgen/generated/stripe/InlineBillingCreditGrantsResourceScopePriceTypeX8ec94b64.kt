...
public sealed class InlineBillingCreditGrantsResourceScopePriceTypeX8ec94b64 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineBillingCreditGrantsResourceScopePriceTypeX8ec94b64 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineBillingCreditGrantsResourceScopePriceTypeX8ec94b64> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineBillingCreditGrantsResourceScopePriceTypeX8ec94b64",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineBillingCreditGrantsResourceScopePriceTypeX8ec94b64 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineBillingCreditGrantsResourceScopePriceTypeX8ec94b64,
        ) {
