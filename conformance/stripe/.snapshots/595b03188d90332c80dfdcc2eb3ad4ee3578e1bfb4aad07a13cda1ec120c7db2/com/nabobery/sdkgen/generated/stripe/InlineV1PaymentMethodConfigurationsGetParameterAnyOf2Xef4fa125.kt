...
public sealed class InlineV1PaymentMethodConfigurationsGetParameterAnyOf2Xef4fa125 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1PaymentMethodConfigurationsGetParameterAnyOf2Xef4fa125 =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1PaymentMethodConfigurationsGetParameterAnyOf2Xef4fa125> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1PaymentMethodConfigurationsGetParameterAnyOf2Xef4fa125",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1PaymentMethodConfigurationsGetParameterAnyOf2Xef4fa125 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentMethodConfigurationsGetParameterAnyOf2Xef4fa125,
        ) {
