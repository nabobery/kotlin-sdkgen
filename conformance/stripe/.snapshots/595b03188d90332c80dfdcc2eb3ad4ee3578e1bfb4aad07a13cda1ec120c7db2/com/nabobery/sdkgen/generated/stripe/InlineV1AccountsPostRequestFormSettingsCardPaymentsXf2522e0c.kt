...
public class InlineV1AccountsPostRequestFormSettingsCardPaymentsXf2522e0c(
    public val declineOn: InlineV1AccountsPostRequestFormSettingsCardPaymentsDeclineOnX1632b32d? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1AccountsPostRequestFormSettingsCardPaymentsXf2522e0c =
            InlineV1AccountsPostRequestFormSettingsCardPaymentsXf2522e0c(
                declineOn = declineOn,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1AccountsPostRequestFormSettingsCardPaymentsXf2522e0c =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1AccountsPostRequestFormSettingsCardPaymentsXf2522e0c> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountsPostRequestFormSettingsCardPaymentsXf2522e0c must be a JSON object",
                    )
            return InlineV1AccountsPostRequestFormSettingsCardPaymentsXf2522e0c(
                declineOn =
                    rawObject["decline_on"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1AccountsPostRequestFormSettingsCardPaymentsDeclineOnX1632b32d>(
                                it,
                            )
                    },
                ...
                statementDescriptorPrefixKana =
                    rawObject["statement_descriptor_prefix_kana"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1AccountsPostRequestFormSettingsStatementDescriptorP82b2Xfc390489>(
                                it,
                            )
                    },
                statementDescriptorPrefixKanji =
                    rawObject["statement_descriptor_prefix_kanji"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1AccountsPostRequestFormSettingsStatementDescriptorP143dX8338258b>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPostRequestFormSettingsCardPaymentsXf2522e0c,
        ) {
...
public fun inlineV1AccountsPostRequestFormSettingsCardPaymentsXf2522e0c(
    block: InlineV1AccountsPostRequestFormSettingsCardPaymentsXf2522e0c.Builder.() -> Unit,
): InlineV1AccountsPostRequestFormSettingsCardPaymentsXf2522e0c =
    InlineV1AccountsPostRequestFormSettingsCardPaymentsXf2522e0c.build(block)
