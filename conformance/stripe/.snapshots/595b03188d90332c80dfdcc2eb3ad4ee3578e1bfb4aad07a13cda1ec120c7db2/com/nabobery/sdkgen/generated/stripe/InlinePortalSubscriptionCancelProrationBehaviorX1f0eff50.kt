...
public sealed class InlinePortalSubscriptionCancelProrationBehaviorX1f0eff50 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePortalSubscriptionCancelProrationBehaviorX1f0eff50 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlinePortalSubscriptionCancelProrationBehaviorX1f0eff50> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePortalSubscriptionCancelProrationBehaviorX1f0eff50",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePortalSubscriptionCancelProrationBehaviorX1f0eff50 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePortalSubscriptionCancelProrationBehaviorX1f0eff50,
        ) {
