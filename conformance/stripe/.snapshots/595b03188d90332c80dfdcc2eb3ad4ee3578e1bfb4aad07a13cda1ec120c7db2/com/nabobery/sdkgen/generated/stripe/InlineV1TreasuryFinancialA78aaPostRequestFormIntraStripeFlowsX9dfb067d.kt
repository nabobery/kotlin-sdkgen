...
public class InlineV1TreasuryFinancialA78aaPostRequestFormIntraStripeFlowsX9dfb067d(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1TreasuryFinancialA78aaPostRequestFormIntraStripeFlowsX9dfb067d = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TreasuryFinancialA78aaPostRequestFormIntraStripeFlowsX9dfb067d> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TreasuryFinancialA78aaPostRequestFormIntraStripeFlowsX9dfb067d must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TreasuryFinancialA78aaPostRequestFormIntraStripeFlowsX9dfb067d,
        ) {
            val jsonEncoder =
...
public fun inlineV1TreasuryFinancialA78aaPostRequestFormIntraStripeFlowsX9dfb067d(
    block: InlineV1TreasuryFinancialA78aaPostRequestFormIntraStripeFlowsX9dfb067d.Builder.() -> Unit,
): InlineV1TreasuryFinancialA78aaPostRequestFormIntraStripeFlowsX9dfb067d =
    InlineV1TreasuryFinancialA78aaPostRequestFormIntraStripeFlowsX9dfb067d.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TreasuryFinancialA78aaPostRequestFormIntraStripeFlowsX9dfb067d is missing required property '" +
                    name +
                    "'",
            )
