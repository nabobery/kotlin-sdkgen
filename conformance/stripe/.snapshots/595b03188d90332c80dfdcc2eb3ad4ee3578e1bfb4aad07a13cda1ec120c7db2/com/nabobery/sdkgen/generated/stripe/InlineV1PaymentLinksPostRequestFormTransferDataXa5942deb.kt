...
public class InlineV1PaymentLinksPostRequestFormTransferDataXa5942deb(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PaymentLinksPostRequestFormTransferDataXa5942deb =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentLinksPostRequestFormTransferDataXa5942deb> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentLinksPostRequestFormTransferDataXa5942deb must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentLinksPostRequestFormTransferDataXa5942deb,
        ) {
...
public fun inlineV1PaymentLinksPostRequestFormTransferDataXa5942deb(
    block: InlineV1PaymentLinksPostRequestFormTransferDataXa5942deb.Builder.() -> Unit,
): InlineV1PaymentLinksPostRequestFormTransferDataXa5942deb =
    InlineV1PaymentLinksPostRequestFormTransferDataXa5942deb.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentLinksPostRequestFormTransferDataXa5942deb is missing required property '" + name + "'",
            )
