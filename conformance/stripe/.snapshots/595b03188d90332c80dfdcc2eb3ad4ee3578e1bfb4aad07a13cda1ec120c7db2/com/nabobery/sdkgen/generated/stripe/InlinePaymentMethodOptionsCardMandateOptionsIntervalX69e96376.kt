...
public sealed class InlinePaymentMethodOptionsCardMandateOptionsIntervalX69e96376 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentMethodOptionsCardMandateOptionsIntervalX69e96376 =
            when (value) {
                Day.value -> Day
                Month.value -> Month
    ...
    public object Serializer : KSerializer<InlinePaymentMethodOptionsCardMandateOptionsIntervalX69e96376> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentMethodOptionsCardMandateOptionsIntervalX69e96376",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePaymentMethodOptionsCardMandateOptionsIntervalX69e96376 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentMethodOptionsCardMandateOptionsIntervalX69e96376,
        ) {
