...
public class InlineV1InvoicesPostRequestFormNumberXbadb140d internal constructor(
    ...
    public val inlineV1InvoicesPostRequestFormNumberAnyOf2X6f40e42b:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1InvoicesPostRequestFormNumberAnyOf2X6f40e42b) {
                json
                    .decodeFromJsonElement<InlineV1InvoicesPostRequestFormNumberAnyOf2X6f40e42b>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1InvoicesPostRequestFormNumberXbadb140dBranch>
        get() =
            buildSet {
                ...
                if (inspection.matchesInlineV1InvoicesPostRequestFormNumberAnyOf2X6f40e42b) {
                    add(
                        InlineV1InvoicesPostRequestFormNumberXbadb140dBranch.InlineV1InvoicesPostRequestFormNumberAnyOf2X6f40e42b,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1InvoicesPostRequestFormNumberXbadb140d {
            val inspection = inspectInlineV1InvoicesPostRequestFormNumberXbadb140d(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1InvoicesPostRequestFormNumberXbadb140dNoMatchException(
                    "InlineV1InvoicesPostRequestFormNumberXbadb140d matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1InvoicesPostRequestFormNumberXbadb140d> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesPostRequestFormNumberXbadb140d,
        ) {
...
private fun inspectInlineV1InvoicesPostRequestFormNumberXbadb140d(
    element: JsonElement,
): InlineV1InvoicesPostRequestFormNumberXbadb140dInspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1InvoicesPostRequestFormNumberAnyOf2X6f40e42b =
        element
            .isJsonDecodable<InlineV1InvoicesPostRequestFormNumberAnyOf2X6f40e42b>()
    return InlineV1InvoicesPostRequestFormNumberXbadb140dInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1InvoicesPostRequestFormNumberAnyOf2X6f40e42b) {
                    add(
                        "InlineV1InvoicesPostRequestFormNumberAnyOf2X6f40e42b: value does not match InlineV1InvoicesPostRequestFormNumberAnyOf2X6f40e42b",
                    )
                }
            },
    )
