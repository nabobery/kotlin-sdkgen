...
public class InlineV1BillingMetersPostRequestFormDefaultAggregationXfb17a4d8(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1BillingMetersPostRequestFormDefaultAggregationXfb17a4d8 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1BillingMetersPostRequestFormDefaultAggregationXfb17a4d8> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1BillingMetersPostRequestFormDefaultAggregationXfb17a4d8 {
            val jsonDecoder =
                decoder.requireJsonDecoder(
                    "InlineV1BillingMetersPostRequestFormDefaultAggregationXfb17a4d8",
                )
            val json = jsonDecoder.json
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1BillingMetersPostRequestFormDefaultAggregationXfb17a4d8 must be a JSON object",
                    )
            val formula =
                json.decodeRequired<InlineV1BillingMetersPostRequestFormDefaultAggregationFormulaX793833c0>(
                    rawObject,
                    "formula",
                )
            return InlineV1BillingMetersPostRequestFormDefaultAggregationXfb17a4d8(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1BillingMetersPostRequestFormDefaultAggregationXfb17a4d8,
        ) {
            val jsonEncoder =
...
public fun inlineV1BillingMetersPostRequestFormDefaultAggregationXfb17a4d8(
    block: InlineV1BillingMetersPostRequestFormDefaultAggregationXfb17a4d8.Builder.() -> Unit,
): InlineV1BillingMetersPostRequestFormDefaultAggregationXfb17a4d8 =
    InlineV1BillingMetersPostRequestFormDefaultAggregationXfb17a4d8.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1BillingMetersPostRequestFormDefaultAggregationXfb17a4d8 is missing required property '" + name +
                    "'",
            )
