...
public class GelatoReportDocumentOptions(
     ...
     */
    public val allowedTypes: List<InlineGelatoReportDocumentOptionsAllowedTypesItemXa20213d0>? = null,
    /**
    ...
    public class Builder {
        ...
        public fun build(): GelatoReportDocumentOptions =
    ...
    public object Serializer : KSerializer<GelatoReportDocumentOptions> {
        ...
        override fun deserialize(decoder: Decoder): GelatoReportDocumentOptions {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("GelatoReportDocumentOptions must be a JSON object")
            return GelatoReportDocumentOptions(
                allowedTypes =
                    rawObject["allowed_types"]?.let {
                        json.decodeFromJsonElement<List<InlineGelatoReportDocumentOptionsAllowedTypesItemXa20213d0>>(it)
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: GelatoReportDocumentOptions,
        ) {
...
public fun gelatoReportDocumentOptions(
    block: GelatoReportDocumentOptions.Builder.() -> Unit,
): GelatoReportDocumentOptions = GelatoReportDocumentOptions.build(block)
