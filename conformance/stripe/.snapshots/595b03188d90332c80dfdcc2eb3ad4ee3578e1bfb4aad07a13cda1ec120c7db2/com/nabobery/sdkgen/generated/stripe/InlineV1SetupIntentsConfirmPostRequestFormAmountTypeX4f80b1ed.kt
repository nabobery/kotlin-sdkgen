...
public sealed class InlineV1SetupIntentsConfirmPostRequestFormAmountTypeX4f80b1ed {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1SetupIntentsConfirmPostRequestFormAmountTypeX4f80b1ed =
            when (value) {
                Fixed.value -> Fixed
    ...
    public object Serializer : KSerializer<InlineV1SetupIntentsConfirmPostRequestFormAmountTypeX4f80b1ed> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1SetupIntentsConfirmPostRequestFormAmountTypeX4f80b1ed",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1SetupIntentsConfirmPostRequestFormAmountTypeX4f80b1ed =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SetupIntentsConfirmPostRequestFormAmountTypeX4f80b1ed,
        ) {
