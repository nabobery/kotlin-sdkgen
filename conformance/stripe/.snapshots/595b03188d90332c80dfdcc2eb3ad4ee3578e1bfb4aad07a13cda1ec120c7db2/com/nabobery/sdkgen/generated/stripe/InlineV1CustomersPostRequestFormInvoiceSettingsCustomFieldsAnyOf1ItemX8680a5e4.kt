...
public class InlineV1CustomersPostRequestFormInvoiceSettingsCustomFieldsAnyOf1ItemX8680a5e4(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1CustomersPostRequestFormInvoiceSettingsCustomFieldsAnyOf1ItemX8680a5e4 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1CustomersPostRequestFormInvoiceSettingsCustomFieldsAnyOf1ItemX8680a5e4> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CustomersPostRequestFormInvoiceSettingsCustomFieldsAnyOf1ItemX8680a5e4 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersPostRequestFormInvoiceSettingsCustomFieldsAnyOf1ItemX8680a5e4,
        ) {
            val jsonEncoder =
...
public fun inlineV1CustomersPostRequestFormInvoiceSettingsCustomFieldsAnyOf1ItemX8680a5e4(
    block: InlineV1CustomersPostRequestFormInvoiceSettingsCustomFieldsAnyOf1ItemX8680a5e4.Builder.() -> Unit,
): InlineV1CustomersPostRequestFormInvoiceSettingsCustomFieldsAnyOf1ItemX8680a5e4 =
    InlineV1CustomersPostRequestFormInvoiceSettingsCustomFieldsAnyOf1ItemX8680a5e4.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1CustomersPostRequestFormInvoiceSettingsCustomFieldsAnyOf1ItemX8680a5e4 is missing required property '" +
                    name +
                    "'",
            )
