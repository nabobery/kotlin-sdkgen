...
public sealed class InlineShippingRateDeliveryEstimateBoundUnitX84ce7044 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineShippingRateDeliveryEstimateBoundUnitX84ce7044 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineShippingRateDeliveryEstimateBoundUnitX84ce7044> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineShippingRateDeliveryEstimateBoundUnitX84ce7044",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineShippingRateDeliveryEstimateBoundUnitX84ce7044 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineShippingRateDeliveryEstimateBoundUnitX84ce7044,
        ) {
