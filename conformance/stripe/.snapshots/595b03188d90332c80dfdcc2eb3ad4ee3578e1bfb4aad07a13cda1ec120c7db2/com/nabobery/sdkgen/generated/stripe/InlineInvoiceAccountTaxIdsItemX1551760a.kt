...
public class InlineInvoiceAccountTaxIdsItemX1551760a internal constructor(
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineInvoiceAccountTaxIdsItemX1551760a {
            val inspection = inspectInlineInvoiceAccountTaxIdsItemX1551760a(raw)
            if (inspection.matchCount == 0) {
                throw InlineInvoiceAccountTaxIdsItemX1551760aNoMatchException(
                    "InlineInvoiceAccountTaxIdsItemX1551760a matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineInvoiceAccountTaxIdsItemX1551760a> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineInvoiceAccountTaxIdsItemX1551760a,
        ) {
...
private fun inspectInlineInvoiceAccountTaxIdsItemX1551760a(
    element: JsonElement,
): InlineInvoiceAccountTaxIdsItemX1551760aInspection {
