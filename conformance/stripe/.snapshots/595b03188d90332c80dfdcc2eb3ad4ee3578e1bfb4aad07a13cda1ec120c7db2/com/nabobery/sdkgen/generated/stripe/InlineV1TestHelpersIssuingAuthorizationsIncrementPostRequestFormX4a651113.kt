...
public class InlineV1TestHelpersIssuingAuthorizationsIncrementPostRequestFormX4a651113(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1TestHelpersIssuingAuthorizationsIncrementPostRequestFormX4a651113 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TestHelpersIssuingAuthorizationsIncrementPostRequestFormX4a651113> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TestHelpersIssuingAuthorizationsIncrementPostRequestFormX4a651113 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TestHelpersIssuingAuthorizationsIncrementPostRequestFormX4a651113,
        ) {
            val jsonEncoder =
...
public fun inlineV1TestHelpersIssuingAuthorizationsIncrementPostRequestFormX4a651113(
    block: InlineV1TestHelpersIssuingAuthorizationsIncrementPostRequestFormX4a651113.Builder.() -> Unit,
): InlineV1TestHelpersIssuingAuthorizationsIncrementPostRequestFormX4a651113 =
    InlineV1TestHelpersIssuingAuthorizationsIncrementPostRequestFormX4a651113.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TestHelpersIssuingAuthorizationsIncrementPostRequestFormX4a651113 is missing required property '" +
                    name +
                    "'",
            )
