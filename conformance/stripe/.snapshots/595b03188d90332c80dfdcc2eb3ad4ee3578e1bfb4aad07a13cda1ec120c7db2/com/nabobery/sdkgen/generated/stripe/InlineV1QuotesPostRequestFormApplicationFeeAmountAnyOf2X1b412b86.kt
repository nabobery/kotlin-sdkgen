...
public sealed class InlineV1QuotesPostRequestFormApplicationFeeAmountAnyOf2X1b412b86 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1QuotesPostRequestFormApplicationFeeAmountAnyOf2X1b412b86 =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1QuotesPostRequestFormApplicationFeeAmountAnyOf2X1b412b86> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1QuotesPostRequestFormApplicationFeeAmountAnyOf2X1b412b86",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1QuotesPostRequestFormApplicationFeeAmountAnyOf2X1b412b86 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1QuotesPostRequestFormApplicationFeeAmountAnyOf2X1b412b86,
        ) {
