...
public class InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPaypalAnyOf1Xd4392d10(
    public val captureMethod: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsCaptureMethodXf064a34d? = null,
    ...
    public val setupFutureUsage: InlineV1PaymentIntentsPostRequestFormSetupFutureUsageX56bb3b44? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPaypalAnyOf1Xd4392d10 =
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPaypalAnyOf1Xd4392d10> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPaypalAnyOf1Xd4392d10 must be a JSON object",
                    )
            return InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPaypalAnyOf1Xd4392d10(
                captureMethod =
                    rawObject["capture_method"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsCaptureMethodXf064a34d>(
                                it,
                            )
                    },
                preferredLocale =
                    rawObject["preferred_locale"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPreferredLocaleX2990cf2f>(it)
                    },
                ...
                setupFutureUsage =
                    rawObject["setup_future_usage"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormSetupFutureUsageX56bb3b44>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPaypalAnyOf1Xd4392d10,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPaypalAnyOf1Xd4392d10(
    block: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPaypalAnyOf1Xd4392d10.Builder.() -> Unit,
): InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPaypalAnyOf1Xd4392d10 =
