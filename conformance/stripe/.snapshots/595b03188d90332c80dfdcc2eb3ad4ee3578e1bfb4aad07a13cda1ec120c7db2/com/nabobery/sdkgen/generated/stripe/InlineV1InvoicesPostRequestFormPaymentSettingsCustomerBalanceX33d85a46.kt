...
internal data class InlineV1InvoicesPostRequestFormPaymentSettingsCustomerBalanceX33d85a46Inspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1Xe8b48ee2,
                matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2Xf0a88453,
            ).count {
                it
            }
}
...
public class InlineV1InvoicesPostRequestFormPaymentSettingsCustomerBalanceX33d85a46 internal constructor(
    ...
    private val inspection: InlineV1InvoicesPostRequestFormPaymentSettingsCustomerBalanceX33d85a46Inspection,
) {
    public val inlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1Xe8b48ee2:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1Xe8b48ee2) {
                json
                    .decodeFromJsonElement<InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1Xe8b48ee2>(
                        raw,
                    )
            } else {
                null
    ...
    public val inlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2Xf0a88453:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2Xf0a88453) {
                json
                    .decodeFromJsonElement<InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2Xf0a88453>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches:
        ...
        get() =
            buildSet {
                if (inspection.matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1Xe8b48ee2) {
                    add(
                        InlineV1InvoicesPostRequestFormPaymentSettingsCustomerBalanceX33d85a46Branch.InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1Xe8b48ee2,
                    )
                }
                if (inspection.matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2Xf0a88453) {
                    add(
                        InlineV1InvoicesPostRequestFormPaymentSettingsCustomerBalanceX33d85a46Branch.InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2Xf0a88453,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1InvoicesPostRequestFormPaymentSettingsCustomerBalanceX33d85a46 {
            val inspection = inspectInlineV1InvoicesPostRequestFormPaymentSettingsCustomerBalanceX33d85a46(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1InvoicesPostRequestFormPaymentSettingsCustomerBalanceX33d85a46NoMatchException(
                    "InlineV1InvoicesPostRequestFormPaymentSettingsCustomerBalanceX33d85a46 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1InvoicesPostRequestFormPaymentSettingsCustomerBalanceX33d85a46> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesPostRequestFormPaymentSettingsCustomerBalanceX33d85a46,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1InvoicesPostRequestFormPaymentSettingsCustomerBalanceX33d85a46",
...
private fun inspectInlineV1InvoicesPostRequestFormPaymentSettingsCustomerBalanceX33d85a46(
    element: JsonElement,
): InlineV1InvoicesPostRequestFormPaymentSettingsCustomerBalanceX33d85a46Inspection {
    val matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1Xe8b48ee2 =
        element
            .isJsonDecodable<InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1Xe8b48ee2>()
    val matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2Xf0a88453 =
        element
            .isJsonDecodable<InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2Xf0a88453>()
    return InlineV1InvoicesPostRequestFormPaymentSettingsCustomerBalanceX33d85a46Inspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1Xe8b48ee2) {
                    add(
                        "InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1Xe8b48ee2: value does not match InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1Xe8b48ee2",
                    )
                }
                if (!matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2Xf0a88453) {
                    add(
                        "InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2Xf0a88453: value does not match InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2Xf0a88453",
                    )
                }
            },
    )
