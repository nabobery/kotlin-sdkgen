...
public sealed class InlineQuotesResourceAutomaticTaxStatusX5a0812d5 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineQuotesResourceAutomaticTaxStatusX5a0812d5 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineQuotesResourceAutomaticTaxStatusX5a0812d5> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineQuotesResourceAutomaticTaxStatusX5a0812d5",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineQuotesResourceAutomaticTaxStatusX5a0812d5 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineQuotesResourceAutomaticTaxStatusX5a0812d5,
        ) {
