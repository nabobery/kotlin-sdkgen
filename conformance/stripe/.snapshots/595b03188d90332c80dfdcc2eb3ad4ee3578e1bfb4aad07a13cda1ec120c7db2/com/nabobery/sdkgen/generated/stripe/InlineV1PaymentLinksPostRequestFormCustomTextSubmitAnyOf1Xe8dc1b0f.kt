...
public class InlineV1PaymentLinksPostRequestFormCustomTextSubmitAnyOf1Xe8dc1b0f(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentLinksPostRequestFormCustomTextSubmitAnyOf1Xe8dc1b0f = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentLinksPostRequestFormCustomTextSubmitAnyOf1Xe8dc1b0f> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentLinksPostRequestFormCustomTextSubmitAnyOf1Xe8dc1b0f must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentLinksPostRequestFormCustomTextSubmitAnyOf1Xe8dc1b0f,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentLinksPostRequestFormCustomTextSubmitAnyOf1Xe8dc1b0f(
    block: InlineV1PaymentLinksPostRequestFormCustomTextSubmitAnyOf1Xe8dc1b0f.Builder.() -> Unit,
): InlineV1PaymentLinksPostRequestFormCustomTextSubmitAnyOf1Xe8dc1b0f =
    InlineV1PaymentLinksPostRequestFormCustomTextSubmitAnyOf1Xe8dc1b0f.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentLinksPostRequestFormCustomTextSubmitAnyOf1Xe8dc1b0f is missing required property '" +
                    name +
                    "'",
            )
