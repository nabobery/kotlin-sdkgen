...
public class InlineV1EphemeralKeysPostRequestFormX0d4b063f(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1EphemeralKeysPostRequestFormX0d4b063f =
            InlineV1EphemeralKeysPostRequestFormX0d4b063f(
                customer = customer,
                expand = expand,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1EphemeralKeysPostRequestFormX0d4b063f =
    ...
    public object Serializer : KSerializer<InlineV1EphemeralKeysPostRequestFormX0d4b063f> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1EphemeralKeysPostRequestFormX0d4b063f must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1EphemeralKeysPostRequestFormX0d4b063f,
        ) {
...
public fun inlineV1EphemeralKeysPostRequestFormX0d4b063f(
    block: InlineV1EphemeralKeysPostRequestFormX0d4b063f.Builder.() -> Unit,
): InlineV1EphemeralKeysPostRequestFormX0d4b063f = InlineV1EphemeralKeysPostRequestFormX0d4b063f.build(block)
