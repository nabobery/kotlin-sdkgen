...
public sealed class InlineShippingRateTypeXbe49c0e0 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineShippingRateTypeXbe49c0e0 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineShippingRateTypeXbe49c0e0> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineShippingRateTypeXbe49c0e0",
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineShippingRateTypeXbe49c0e0,
        ) {
