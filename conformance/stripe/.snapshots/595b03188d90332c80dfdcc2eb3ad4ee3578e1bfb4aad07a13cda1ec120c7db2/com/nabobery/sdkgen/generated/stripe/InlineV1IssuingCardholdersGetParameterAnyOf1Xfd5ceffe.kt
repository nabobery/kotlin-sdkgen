...
public class InlineV1IssuingCardholdersGetParameterAnyOf1Xfd5ceffe(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1IssuingCardholdersGetParameterAnyOf1Xfd5ceffe =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1IssuingCardholdersGetParameterAnyOf1Xfd5ceffe =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1IssuingCardholdersGetParameterAnyOf1Xfd5ceffe> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1IssuingCardholdersGetParameterAnyOf1Xfd5ceffe must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingCardholdersGetParameterAnyOf1Xfd5ceffe,
        ) {
...
public fun inlineV1IssuingCardholdersGetParameterAnyOf1Xfd5ceffe(
    block: InlineV1IssuingCardholdersGetParameterAnyOf1Xfd5ceffe.Builder.() -> Unit,
): InlineV1IssuingCardholdersGetParameterAnyOf1Xfd5ceffe =
    InlineV1IssuingCardholdersGetParameterAnyOf1Xfd5ceffe.build(block)
