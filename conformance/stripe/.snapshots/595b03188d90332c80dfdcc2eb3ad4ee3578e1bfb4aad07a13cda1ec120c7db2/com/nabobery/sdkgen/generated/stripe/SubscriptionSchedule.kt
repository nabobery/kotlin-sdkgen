...
@Serializable
public data class SubscriptionScheduleView(
...
public class SubscriptionSchedule(
    ...
    public class Builder {
        ...
        public var phases: List<SubscriptionSchedulePhaseConfiguration>
            get() = requireNotNull(phasesValue) { "phases is required" }
            set(`value`) {
                phasesValue = value
            }
    ...
    public object Serializer : KSerializer<SubscriptionSchedule> {
        ...
        override fun deserialize(decoder: Decoder): SubscriptionSchedule {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("SubscriptionSchedule must be a JSON object")
            ...
            val defaultSettings =
                json.decodeRequired<SubscriptionSchedulesResourceDefaultSettings>(
                    rawObject,
                    "default_settings",
                )
            val endBehavior =
                json.decodeRequired<InlineSubscriptionScheduleEndBehaviorXf40f838d>(
                    rawObject,
                    "end_behavior",
                )
            ...
            return SubscriptionSchedule(
                ...
                application =
                    rawObject["application"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineSubscriptionScheduleApplicationX4a2180ae?>(element)
                        }
                    },
                canceledAt =
                ...
                currentPhase =
                    rawObject["current_phase"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineSubscriptionScheduleCurrentPhaseX57fffd12?>(element)
                        }
                    },
                customerAccount =
                ...
                releasedAt =
                    rawObject["released_at"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                releasedSubscription =
                    rawObject["released_subscription"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                subscription =
                    rawObject["subscription"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineSubscriptionScheduleSubscriptionX1f6afdc9?>(element)
                        }
                    },
                testClock =
                    rawObject["test_clock"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineSubscriptionScheduleTestClockX22d9a61a?>(element)
                        }
                    },
            )
        }
...
public fun subscriptionSchedule(block: SubscriptionSchedule.Builder.() -> Unit): SubscriptionSchedule =
    SubscriptionSchedule.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("SubscriptionSchedule is missing required property '" + name + "'")
