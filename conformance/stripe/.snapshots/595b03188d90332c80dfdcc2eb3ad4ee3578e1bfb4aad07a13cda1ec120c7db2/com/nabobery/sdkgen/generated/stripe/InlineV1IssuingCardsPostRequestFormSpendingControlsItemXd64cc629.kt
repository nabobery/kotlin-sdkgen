...
public sealed class InlineV1IssuingCardsPostRequestFormSpendingControlsItemXd64cc629 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1IssuingCardsPostRequestFormSpendingControlsItemXd64cc629 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1IssuingCardsPostRequestFormSpendingControlsItemXd64cc629> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1IssuingCardsPostRequestFormSpendingControlsItemXd64cc629",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1IssuingCardsPostRequestFormSpendingControlsItemXd64cc629 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingCardsPostRequestFormSpendingControlsItemXd64cc629,
        ) {
