...
public class InlineLegalEntityPersonVerificationDocumentFrontX647b8abe internal constructor(
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineLegalEntityPersonVerificationDocumentFrontX647b8abeBranch.Branch1,
                    )
                }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineLegalEntityPersonVerificationDocumentFrontX647b8abe {
            val inspection = inspectInlineLegalEntityPersonVerificationDocumentFrontX647b8abe(raw)
            if (inspection.matchCount == 0) {
                throw InlineLegalEntityPersonVerificationDocumentFrontX647b8abeNoMatchException(
                    "InlineLegalEntityPersonVerificationDocumentFrontX647b8abe matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineLegalEntityPersonVerificationDocumentFrontX647b8abe> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineLegalEntityPersonVerificationDocumentFrontX647b8abe,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineLegalEntityPersonVerificationDocumentFrontX647b8abe",
...
private fun inspectInlineLegalEntityPersonVerificationDocumentFrontX647b8abe(
    element: JsonElement,
): InlineLegalEntityPersonVerificationDocumentFrontX647b8abeInspection {
