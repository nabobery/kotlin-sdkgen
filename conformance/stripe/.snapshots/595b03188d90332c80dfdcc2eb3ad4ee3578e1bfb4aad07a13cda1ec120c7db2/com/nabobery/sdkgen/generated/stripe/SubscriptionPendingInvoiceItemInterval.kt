...
public class SubscriptionPendingInvoiceItemInterval(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): SubscriptionPendingInvoiceItemInterval =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<SubscriptionPendingInvoiceItemInterval> {
        ...
        override fun deserialize(decoder: Decoder): SubscriptionPendingInvoiceItemInterval {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("SubscriptionPendingInvoiceItemInterval must be a JSON object")
            val interval =
                json.decodeRequired<InlineSubscriptionPendingInvoiceItemIntervalIntervalX4842f3a5>(
                    rawObject,
                    "interval",
                )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: SubscriptionPendingInvoiceItemInterval,
        ) {
...
public fun subscriptionPendingInvoiceItemInterval(
    block: SubscriptionPendingInvoiceItemInterval.Builder.() -> Unit,
): SubscriptionPendingInvoiceItemInterval = SubscriptionPendingInvoiceItemInterval.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "SubscriptionPendingInvoiceItemInterval is missing required property '" + name + "'",
            )
