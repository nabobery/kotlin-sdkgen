...
public class InlineV1PaymentLinksPostRequestFormX5678d692(
     ...
     */
    public val billingAddressCollection: InlineV1PaymentLinksPostRequestFormBillingAddressCollectionX7432c0af? = null,
    /**
     ...
     * are supported.
     */
    public val lineItems: List<InlineV1PaymentLinksPostRequestFormLineItemsItemX363558c4>? = null,
    /**
     ...
     */
    public val paymentIntentData: InlineV1PaymentLinksPostRequestFormPaymentIntentDataXd5fe0d4d? = null,
    /**
     ...
     */
    public val paymentMethodCollection: InlineV1PaymentLinksPostRequestFormPaymentMethodCollectionX2b3fa1bc? = null,
    /**
     * Payment-method-specific configuration.
     */
    public val paymentMethodOptions: InlineV1PaymentLinksPostRequestFormPaymentMethodOptionsXcbb7398d? = null,
    /**
     ...
     */
    public val paymentMethodTypes: InlineV1PaymentLinksPostRequestFormPaymentMethodTypesX8c0dc4e8? = null,
    /**
     * Controls phone number collection settings during checkout.
     *
     * We recommend that you review your privacy policy and check with your legal contacts.
     */
    public val phoneNumberCollection: InlineV1PaymentLinksPostRequestFormPhoneNumberCollectionX2eaaa01c? = null,
    /**
     ...
     */
    public val shippingAddressCollection: InlineV1PaymentLinksPostRequestFormShippingAddressCollectionX4d7087bf? = null,
    /**
    ...
    public class Builder {
         ...
         * are supported.
         */
        public var lineItems: List<InlineV1PaymentLinksPostRequestFormLineItemsItemX363558c4>? = null
        ...
        public fun build(): InlineV1PaymentLinksPostRequestFormX5678d692 =
            InlineV1PaymentLinksPostRequestFormX5678d692(
                active = active,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PaymentLinksPostRequestFormX5678d692 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentLinksPostRequestFormX5678d692> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentLinksPostRequestFormX5678d692 must be a JSON object",
                    )
            return InlineV1PaymentLinksPostRequestFormX5678d692(
                ...
                afterCompletion =
                    rawObject["after_completion"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormAfterCompletionXc1602789>(it)
                    },
                allowPromotionCodes =
                ...
                automaticTax =
                    rawObject["automatic_tax"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormAutomaticTaxXbeeab661>(it)
                    },
                billingAddressCollection =
                    rawObject["billing_address_collection"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormBillingAddressCollectionX7432c0af>(
                                it,
                            )
                    },
                customFields =
                    rawObject["custom_fields"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormCustomFieldsX82b559cf>(it)
                    },
                customText =
                    rawObject["custom_text"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormCustomTextX046c5ba3>(it)
                    },
                customerCreation =
                    rawObject["customer_creation"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormCustomerCreationX4cdc4cda>(it)
                    },
                expand = rawObject["expand"]?.let { json.decodeFromJsonElement<List<String>>(it) },
                inactiveMessage =
                    rawObject["inactive_message"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormInactiveMessageX3e4cb4a8>(it)
                    },
                invoiceCreation =
                    rawObject["invoice_creation"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormInvoiceCreationX27263f6a>(it)
                    },
                lineItems =
                    rawObject["line_items"]?.let {
                        json.decodeFromJsonElement<List<InlineV1PaymentLinksPostRequestFormLineItemsItemX363558c4>>(it)
                    },
                metadata =
                ...
                nameCollection =
                    rawObject["name_collection"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormNameCollectionXc76d0ec6>(it)
                    },
                optionalItems =
                    rawObject["optional_items"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormOptionalItemsX45712294>(it)
                    },
                paymentIntentData =
                    rawObject["payment_intent_data"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormPaymentIntentDataXd5fe0d4d>(it)
                    },
                paymentMethodCollection =
                    rawObject["payment_method_collection"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormPaymentMethodCollectionX2b3fa1bc>(
                            it,
                        )
                    },
                paymentMethodOptions =
                    rawObject["payment_method_options"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormPaymentMethodOptionsXcbb7398d>(it)
                    },
                paymentMethodTypes =
                    rawObject["payment_method_types"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormPaymentMethodTypesX8c0dc4e8>(it)
                    },
                phoneNumberCollection =
                    rawObject["phone_number_collection"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormPhoneNumberCollectionX2eaaa01c>(
                            it,
                        )
                    },
                restrictions =
                    rawObject["restrictions"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormRestrictionsX46016f8f>(it)
                    },
                shippingAddressCollection =
                    rawObject["shipping_address_collection"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormShippingAddressCollectionX4d7087bf>(
                                it,
                            )
                    },
                submitType =
                    rawObject["submit_type"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormSubmitTypeX7702e8f8>(it)
                    },
                subscriptionData =
                    rawObject["subscription_data"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormSubscriptionDataX7c983df0>(it)
                    },
                taxIdCollection =
                    rawObject["tax_id_collection"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormTaxIdCollectionX1eb15a5e>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentLinksPostRequestFormX5678d692,
        ) {
...
public fun inlineV1PaymentLinksPostRequestFormX5678d692(
    block: InlineV1PaymentLinksPostRequestFormX5678d692.Builder.() -> Unit,
): InlineV1PaymentLinksPostRequestFormX5678d692 = InlineV1PaymentLinksPostRequestFormX5678d692.build(block)
