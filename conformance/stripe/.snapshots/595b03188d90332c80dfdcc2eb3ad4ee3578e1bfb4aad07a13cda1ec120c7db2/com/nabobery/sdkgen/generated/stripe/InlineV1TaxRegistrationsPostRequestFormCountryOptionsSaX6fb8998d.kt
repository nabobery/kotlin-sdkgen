...
public class InlineV1TaxRegistrationsPostRequestFormCountryOptionsSaX6fb8998d(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TaxRegistrationsPostRequestFormCountryOptionsSaX6fb8998d =
    ...
    public object Serializer : KSerializer<InlineV1TaxRegistrationsPostRequestFormCountryOptionsSaX6fb8998d> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1TaxRegistrationsPostRequestFormCountryOptionsSaX6fb8998d {
            val jsonDecoder =
                decoder.requireJsonDecoder(
                    "InlineV1TaxRegistrationsPostRequestFormCountryOptionsSaX6fb8998d",
                )
            val json = jsonDecoder.json
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TaxRegistrationsPostRequestFormCountryOptionsSaX6fb8998d must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineV1TaxRegistrationsPostRequestFormCountryOptionsSaTypeX0006ce81>(
                    rawObject,
                    "type",
                )
            return InlineV1TaxRegistrationsPostRequestFormCountryOptionsSaX6fb8998d(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TaxRegistrationsPostRequestFormCountryOptionsSaX6fb8998d,
        ) {
            val jsonEncoder =
...
public fun inlineV1TaxRegistrationsPostRequestFormCountryOptionsSaX6fb8998d(
    block: InlineV1TaxRegistrationsPostRequestFormCountryOptionsSaX6fb8998d.Builder.() -> Unit,
): InlineV1TaxRegistrationsPostRequestFormCountryOptionsSaX6fb8998d =
    InlineV1TaxRegistrationsPostRequestFormCountryOptionsSaX6fb8998d.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TaxRegistrationsPostRequestFormCountryOptionsSaX6fb8998d is missing required property '" + name +
                    "'",
            )
