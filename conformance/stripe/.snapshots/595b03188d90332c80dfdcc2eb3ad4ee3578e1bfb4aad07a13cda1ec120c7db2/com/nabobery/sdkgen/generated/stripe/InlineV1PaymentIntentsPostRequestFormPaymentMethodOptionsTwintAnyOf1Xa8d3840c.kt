...
public class InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsTwintAnyOf1Xa8d3840c(
    public val setupFutureUsage: InlineV1PaymentIntentsPostRequestFormSetupFutureUsageXbd531e3c? = null,
) {
    public class Builder {
        public var setupFutureUsage: InlineV1PaymentIntentsPostRequestFormSetupFutureUsageXbd531e3c? =
            null

        public fun build(): InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsTwintAnyOf1Xa8d3840c =
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsTwintAnyOf1Xa8d3840c> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsTwintAnyOf1Xa8d3840c must be a JSON object",
                    )
            return InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsTwintAnyOf1Xa8d3840c(
                setupFutureUsage =
                    rawObject["setup_future_usage"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormSetupFutureUsageXbd531e3c>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsTwintAnyOf1Xa8d3840c,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsTwintAnyOf1Xa8d3840c(
    block: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsTwintAnyOf1Xa8d3840c.Builder.() -> Unit,
): InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsTwintAnyOf1Xa8d3840c =
