...
public class InlineV1CouponsPostRequestFormMetadataX75f28b84 internal constructor(
    ...
    public val inlineV1CouponsPostRequestFormMetadataAnyOf2X286f7252:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1CouponsPostRequestFormMetadataAnyOf2X286f7252) {
                json
                    .decodeFromJsonElement<InlineV1CouponsPostRequestFormMetadataAnyOf2X286f7252>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1CouponsPostRequestFormMetadataX75f28b84Branch>
        get() =
            buildSet {
                ...
                if (inspection.matchesInlineV1CouponsPostRequestFormMetadataAnyOf2X286f7252) {
                    add(
                        InlineV1CouponsPostRequestFormMetadataX75f28b84Branch.InlineV1CouponsPostRequestFormMetadataAnyOf2X286f7252,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1CouponsPostRequestFormMetadataX75f28b84 {
            val inspection = inspectInlineV1CouponsPostRequestFormMetadataX75f28b84(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1CouponsPostRequestFormMetadataX75f28b84NoMatchException(
                    "InlineV1CouponsPostRequestFormMetadataX75f28b84 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1CouponsPostRequestFormMetadataX75f28b84> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CouponsPostRequestFormMetadataX75f28b84,
        ) {
...
private fun inspectInlineV1CouponsPostRequestFormMetadataX75f28b84(
    element: JsonElement,
): InlineV1CouponsPostRequestFormMetadataX75f28b84Inspection {
    val matchesBranch1 = element.isJsonDecodable<JsonObject>()
    val matchesInlineV1CouponsPostRequestFormMetadataAnyOf2X286f7252 =
        element
            .isJsonDecodable<InlineV1CouponsPostRequestFormMetadataAnyOf2X286f7252>()
    return InlineV1CouponsPostRequestFormMetadataX75f28b84Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1CouponsPostRequestFormMetadataAnyOf2X286f7252) {
                    add(
                        "InlineV1CouponsPostRequestFormMetadataAnyOf2X286f7252: value does not match InlineV1CouponsPostRequestFormMetadataAnyOf2X286f7252",
                    )
                }
            },
    )
