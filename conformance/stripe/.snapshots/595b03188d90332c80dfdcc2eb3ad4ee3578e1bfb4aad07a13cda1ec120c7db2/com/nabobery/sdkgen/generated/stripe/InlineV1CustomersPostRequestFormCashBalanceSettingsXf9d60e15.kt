...
public class InlineV1CustomersPostRequestFormCashBalanceSettingsXf9d60e15(
    public val reconciliationMode: InlineV1CustomersPostRequestFormCashBalanceSettingsReconciliationModeXa59f10fa? = null,
) {
    public class Builder {
        public var reconciliationMode:
            InlineV1CustomersPostRequestFormCashBalanceSettingsReconciliationModeXa59f10fa? = null

        public fun build(): InlineV1CustomersPostRequestFormCashBalanceSettingsXf9d60e15 =
            InlineV1CustomersPostRequestFormCashBalanceSettingsXf9d60e15(
                reconciliationMode = reconciliationMode,
            )
    }

    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1CustomersPostRequestFormCashBalanceSettingsXf9d60e15 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1CustomersPostRequestFormCashBalanceSettingsXf9d60e15> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CustomersPostRequestFormCashBalanceSettingsXf9d60e15 must be a JSON object",
                    )
            return InlineV1CustomersPostRequestFormCashBalanceSettingsXf9d60e15(
                reconciliationMode =
                    rawObject["reconciliation_mode"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CustomersPostRequestFormCashBalanceSettingsReconciliationModeXa59f10fa>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersPostRequestFormCashBalanceSettingsXf9d60e15,
        ) {
...
public fun inlineV1CustomersPostRequestFormCashBalanceSettingsXf9d60e15(
    block: InlineV1CustomersPostRequestFormCashBalanceSettingsXf9d60e15.Builder.() -> Unit,
): InlineV1CustomersPostRequestFormCashBalanceSettingsXf9d60e15 =
    InlineV1CustomersPostRequestFormCashBalanceSettingsXf9d60e15.build(block)
