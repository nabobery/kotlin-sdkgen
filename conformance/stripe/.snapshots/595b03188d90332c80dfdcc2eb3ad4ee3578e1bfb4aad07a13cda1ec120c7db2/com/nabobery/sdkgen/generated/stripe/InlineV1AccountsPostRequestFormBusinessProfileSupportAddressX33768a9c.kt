...
public class InlineV1AccountsPostRequestFormBusinessProfileSupportAddressX33768a9c(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1AccountsPostRequestFormBusinessProfileSupportAddressX33768a9c =
            InlineV1AccountsPostRequestFormBusinessProfileSupportAddressX33768a9c(
                city = city,
                country = country,
                line1 = line1,
                line2 = line2,
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1AccountsPostRequestFormBusinessProfileSupportAddressX33768a9c = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1AccountsPostRequestFormBusinessProfileSupportAddressX33768a9c> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountsPostRequestFormBusinessProfileSupportAddressX33768a9c must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPostRequestFormBusinessProfileSupportAddressX33768a9c,
        ) {
            val jsonEncoder =
...
public fun inlineV1AccountsPostRequestFormBusinessProfileSupportAddressX33768a9c(
    block: InlineV1AccountsPostRequestFormBusinessProfileSupportAddressX33768a9c.Builder.() -> Unit,
): InlineV1AccountsPostRequestFormBusinessProfileSupportAddressX33768a9c =
    InlineV1AccountsPostRequestFormBusinessProfileSupportAddressX33768a9c.build(block)
