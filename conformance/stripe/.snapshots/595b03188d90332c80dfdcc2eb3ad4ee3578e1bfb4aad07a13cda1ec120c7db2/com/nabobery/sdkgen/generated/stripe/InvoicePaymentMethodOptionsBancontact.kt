...
public data class InvoicePaymentMethodOptionsBancontactView(
    ...
    public val preferredLanguage: InlineInvoicePaymentMethodOptionsBancontactPreferredLanguageXee830518,
)
...
public class InvoicePaymentMethodOptionsBancontact(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InvoicePaymentMethodOptionsBancontact =
    ...
    public object Serializer : KSerializer<InvoicePaymentMethodOptionsBancontact> {
        ...
        override fun deserialize(decoder: Decoder): InvoicePaymentMethodOptionsBancontact {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("InvoicePaymentMethodOptionsBancontact must be a JSON object")
            val preferredLanguage =
                json
                    .decodeRequired<InlineInvoicePaymentMethodOptionsBancontactPreferredLanguageXee830518>(
                        rawObject,
                        "preferred_language",
                    )
            return InvoicePaymentMethodOptionsBancontact(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InvoicePaymentMethodOptionsBancontact,
        ) {
...
public fun invoicePaymentMethodOptionsBancontact(
    block: InvoicePaymentMethodOptionsBancontact.Builder.() -> Unit,
): InvoicePaymentMethodOptionsBancontact = InvoicePaymentMethodOptionsBancontact.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InvoicePaymentMethodOptionsBancontact is missing required property '" + name + "'",
            )
