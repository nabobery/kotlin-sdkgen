...
public class InlineV1AccountsPeoplePostRequestFormDocumentsXd121043a(
    public val companyAuthorization: InlineV1AccountsPeoplePostRequestFormDocumentsCompanyAuthorizationX450ee8a9? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1AccountsPeoplePostRequestFormDocumentsXd121043a =
            InlineV1AccountsPeoplePostRequestFormDocumentsXd121043a(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1AccountsPeoplePostRequestFormDocumentsXd121043a =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1AccountsPeoplePostRequestFormDocumentsXd121043a> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountsPeoplePostRequestFormDocumentsXd121043a must be a JSON object",
                    )
            return InlineV1AccountsPeoplePostRequestFormDocumentsXd121043a(
                companyAuthorization =
                    rawObject["company_authorization"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1AccountsPeoplePostRequestFormDocumentsCompanyAuthorizationX450ee8a9>(
                                it,
                            )
                    },
                passport =
                    rawObject["passport"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPeoplePostRequestFormDocumentsPassportX83ea8ee0>(it)
                    },
                visa =
                    rawObject["visa"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPeoplePostRequestFormDocumentsVisaXd7a11109>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPeoplePostRequestFormDocumentsXd121043a,
        ) {
...
public fun inlineV1AccountsPeoplePostRequestFormDocumentsXd121043a(
    block: InlineV1AccountsPeoplePostRequestFormDocumentsXd121043a.Builder.() -> Unit,
): InlineV1AccountsPeoplePostRequestFormDocumentsXd121043a =
    InlineV1AccountsPeoplePostRequestFormDocumentsXd121043a.build(block)
