...
public class CouponCurrencyOption(
    ...
    public object Serializer : KSerializer<CouponCurrencyOption> {
        ...
        override fun deserialize(decoder: Decoder): CouponCurrencyOption {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("CouponCurrencyOption must be a JSON object")
...
public fun couponCurrencyOption(block: CouponCurrencyOption.Builder.() -> Unit): CouponCurrencyOption =
    CouponCurrencyOption.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("CouponCurrencyOption is missing required property '" + name + "'")
