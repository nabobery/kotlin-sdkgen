...
public class InlineChargeTransferX1843c71d internal constructor(
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineChargeTransferX1843c71d {
            val inspection = inspectInlineChargeTransferX1843c71d(raw)
            if (inspection.matchCount == 0) {
                throw InlineChargeTransferX1843c71dNoMatchException(
                    "InlineChargeTransferX1843c71d matched 0 branches: " + inspection.failures.joinToString("; "),
                )
            }
    ...
    public object Serializer : KSerializer<InlineChargeTransferX1843c71d> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineChargeTransferX1843c71d,
        ) {
