...
public class TreasuryFinancialAccountsResourceTogglesSettingStatusDetails(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): TreasuryFinancialAccountsResourceTogglesSettingStatusDetails =
    ...
    public object Serializer : KSerializer<TreasuryFinancialAccountsResourceTogglesSettingStatusDetails> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "TreasuryFinancialAccountsResourceTogglesSettingStatusDetails must be a JSON object",
                    )
            val code =
                json.decodeRequired<InlineTreasuryFinancialAccountsResourceTogglesSettingStatusDetailsCodeXbc4381be>(
                    rawObject,
                    "code",
                )
            return TreasuryFinancialAccountsResourceTogglesSettingStatusDetails(
                code = code,
                resolution =
                    rawObject["resolution"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineTreasuryFinancialAccee56ResolutionX94fe9ba9?>(element)
                        }
                    },
                restriction =
                    rawObject["restriction"]?.let {
                        json.decodeFromJsonElement<InlineTreasuryFinancialAccee56RestrictionX20aa7a76>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: TreasuryFinancialAccountsResourceTogglesSettingStatusDetails,
        ) {
...
public fun treasuryFinancialAccountsResourceTogglesSettingStatusDetails(
    block: TreasuryFinancialAccountsResourceTogglesSettingStatusDetails.Builder.() -> Unit,
): TreasuryFinancialAccountsResourceTogglesSettingStatusDetails =
    TreasuryFinancialAccountsResourceTogglesSettingStatusDetails.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "TreasuryFinancialAccountsResourceTogglesSettingStatusDetails is missing required property '" + name +
                    "'",
            )
