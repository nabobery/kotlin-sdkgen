...
public class InlineV1TokensPostRequestFormBankAccountX662538df(
    ...
    public val accountHolderType: InlineV1TokensPostRequestFormBankAccountAccountHolderTypeXd17551ed? = null,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TokensPostRequestFormBankAccountX662538df =
    ...
    public object Serializer : KSerializer<InlineV1TokensPostRequestFormBankAccountX662538df> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TokensPostRequestFormBankAccountX662538df must be a JSON object",
                    )
            ...
            return InlineV1TokensPostRequestFormBankAccountX662538df(
                ...
                accountHolderType =
                    rawObject["account_holder_type"]?.let {
                        json.decodeFromJsonElement<InlineV1TokensPostRequestFormBankAccountAccountHolderTypeXd17551ed>(
                            it,
                        )
                    },
                accountType =
                    rawObject["account_type"]?.let {
                        json.decodeFromJsonElement<InlineV1TokensPostRequestFormBankAccountAccountTypeX2066f168>(it)
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TokensPostRequestFormBankAccountX662538df,
        ) {
...
public fun inlineV1TokensPostRequestFormBankAccountX662538df(
    block: InlineV1TokensPostRequestFormBankAccountX662538df.Builder.() -> Unit,
): InlineV1TokensPostRequestFormBankAccountX662538df = InlineV1TokensPostRequestFormBankAccountX662538df.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TokensPostRequestFormBankAccountX662538df is missing required property '" + name + "'",
            )
