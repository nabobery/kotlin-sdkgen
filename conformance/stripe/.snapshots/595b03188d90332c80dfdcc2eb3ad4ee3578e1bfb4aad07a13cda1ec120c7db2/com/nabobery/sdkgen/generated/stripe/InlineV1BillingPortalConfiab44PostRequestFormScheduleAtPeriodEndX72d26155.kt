...
public class InlineV1BillingPortalConfiab44PostRequestFormScheduleAtPeriodEndX72d26155(
    public val conditions: InlineV1BillingPortalConfiab44PostRequestFormFeaturesConditionsXd770a1b0? = null,
) {
    public class Builder {
        public var conditions: InlineV1BillingPortalConfiab44PostRequestFormFeaturesConditionsXd770a1b0? =
            null

        public fun build(): InlineV1BillingPortalConfiab44PostRequestFormScheduleAtPeriodEndX72d26155 =
            InlineV1BillingPortalConfiab44PostRequestFormScheduleAtPeriodEndX72d26155(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1BillingPortalConfiab44PostRequestFormScheduleAtPeriodEndX72d26155 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1BillingPortalConfiab44PostRequestFormScheduleAtPeriodEndX72d26155> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1BillingPortalConfiab44PostRequestFormScheduleAtPeriodEndX72d26155 must be a JSON object",
                    )
            return InlineV1BillingPortalConfiab44PostRequestFormScheduleAtPeriodEndX72d26155(
                conditions =
                    rawObject["conditions"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1BillingPortalConfiab44PostRequestFormFeaturesConditionsXd770a1b0>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1BillingPortalConfiab44PostRequestFormScheduleAtPeriodEndX72d26155,
        ) {
            val jsonEncoder =
...
public fun inlineV1BillingPortalConfiab44PostRequestFormScheduleAtPeriodEndX72d26155(
    block: InlineV1BillingPortalConfiab44PostRequestFormScheduleAtPeriodEndX72d26155.Builder.() -> Unit,
): InlineV1BillingPortalConfiab44PostRequestFormScheduleAtPeriodEndX72d26155 =
    InlineV1BillingPortalConfiab44PostRequestFormScheduleAtPeriodEndX72d26155.build(block)
