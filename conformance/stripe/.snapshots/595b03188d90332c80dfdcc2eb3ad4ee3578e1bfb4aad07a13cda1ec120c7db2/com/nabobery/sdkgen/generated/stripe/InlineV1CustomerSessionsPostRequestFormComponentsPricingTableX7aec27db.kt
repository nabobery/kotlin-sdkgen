...
public class InlineV1CustomerSessionsPostRequestFormComponentsPricingTableX7aec27db(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1CustomerSessionsPostRequestFormComponentsPricingTableX7aec27db = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1CustomerSessionsPostRequestFormComponentsPricingTableX7aec27db> {
        ...
        override fun deserialize(
            decoder: Decoder,
        ): InlineV1CustomerSessionsPostRequestFormComponentsPricingTableX7aec27db {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CustomerSessionsPostRequestFormComponentsPricingTableX7aec27db must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomerSessionsPostRequestFormComponentsPricingTableX7aec27db,
        ) {
            val jsonEncoder =
...
public fun inlineV1CustomerSessionsPostRequestFormComponentsPricingTableX7aec27db(
    block: InlineV1CustomerSessionsPostRequestFormComponentsPricingTableX7aec27db.Builder.() -> Unit,
): InlineV1CustomerSessionsPostRequestFormComponentsPricingTableX7aec27db =
    InlineV1CustomerSessionsPostRequestFormComponentsPricingTableX7aec27db.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1CustomerSessionsPostRequestFormComponentsPricingTableX7aec27db is missing required property '" +
                    name +
                    "'",
            )
