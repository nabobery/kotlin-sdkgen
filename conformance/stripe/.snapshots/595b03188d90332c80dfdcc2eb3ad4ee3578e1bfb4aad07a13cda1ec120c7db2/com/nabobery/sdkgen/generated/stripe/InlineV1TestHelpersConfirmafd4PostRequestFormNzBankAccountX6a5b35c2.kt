...
public class InlineV1TestHelpersConfirmafd4PostRequestFormNzBankAccountX6a5b35c2(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1TestHelpersConfirmafd4PostRequestFormNzBankAccountX6a5b35c2 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1TestHelpersConfirmafd4PostRequestFormNzBankAccountX6a5b35c2> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TestHelpersConfirmafd4PostRequestFormNzBankAccountX6a5b35c2 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TestHelpersConfirmafd4PostRequestFormNzBankAccountX6a5b35c2,
        ) {
            val jsonEncoder =
...
public fun inlineV1TestHelpersConfirmafd4PostRequestFormNzBankAccountX6a5b35c2(
    block: InlineV1TestHelpersConfirmafd4PostRequestFormNzBankAccountX6a5b35c2.Builder.() -> Unit,
): InlineV1TestHelpersConfirmafd4PostRequestFormNzBankAccountX6a5b35c2 =
    InlineV1TestHelpersConfirmafd4PostRequestFormNzBankAccountX6a5b35c2.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TestHelpersConfirmafd4PostRequestFormNzBankAccountX6a5b35c2 is missing required property '" +
                    name +
                    "'",
            )
