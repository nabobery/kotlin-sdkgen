...
public class InlineV1InvoicesPostRequestFormTransferDataXea589c39(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1InvoicesPostRequestFormTransferDataXea589c39 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1InvoicesPostRequestFormTransferDataXea589c39> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1InvoicesPostRequestFormTransferDataXea589c39 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesPostRequestFormTransferDataXea589c39,
        ) {
...
public fun inlineV1InvoicesPostRequestFormTransferDataXea589c39(
    block: InlineV1InvoicesPostRequestFormTransferDataXea589c39.Builder.() -> Unit,
): InlineV1InvoicesPostRequestFormTransferDataXea589c39 =
    InlineV1InvoicesPostRequestFormTransferDataXea589c39.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1InvoicesPostRequestFormTransferDataXea589c39 is missing required property '" + name + "'",
            )
