...
public class InlineV1InvoicesUpdateLinesPostRequestFormXf374c0fb(
     ...
     */
    public val invoiceMetadata: InlineV1InvoicesUpdateLinesPostRequestFormInvoiceMetadataXcc0c1154? = null,
) {
    /**
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1InvoicesUpdateLinesPostRequestFormXf374c0fb =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1InvoicesUpdateLinesPostRequestFormXf374c0fb> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1InvoicesUpdateLinesPostRequestFormXf374c0fb must be a JSON object",
                    )
            val lines =
                json.decodeRequired<List<InlineV1InvoicesUpdateLinesPostRequestFormLinesItemX780032d3>>(
                    rawObject,
                    "lines",
                )
            return InlineV1InvoicesUpdateLinesPostRequestFormXf374c0fb(
                ...
                invoiceMetadata =
                    rawObject["invoice_metadata"]?.let {
                        json.decodeFromJsonElement<InlineV1InvoicesUpdateLinesPostRequestFormInvoiceMetadataXcc0c1154>(
                            it,
                        )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesUpdateLinesPostRequestFormXf374c0fb,
        ) {
...
public fun inlineV1InvoicesUpdateLinesPostRequestFormXf374c0fb(
    block: InlineV1InvoicesUpdateLinesPostRequestFormXf374c0fb.Builder.() -> Unit,
): InlineV1InvoicesUpdateLinesPostRequestFormXf374c0fb =
    InlineV1InvoicesUpdateLinesPostRequestFormXf374c0fb.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1InvoicesUpdateLinesPostRequestFormXf374c0fb is missing required property '" + name + "'",
            )
