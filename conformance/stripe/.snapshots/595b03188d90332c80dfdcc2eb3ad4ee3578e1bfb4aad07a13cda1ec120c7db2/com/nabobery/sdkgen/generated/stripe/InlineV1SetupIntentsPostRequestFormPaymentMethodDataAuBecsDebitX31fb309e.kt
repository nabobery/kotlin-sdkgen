...
public class InlineV1SetupIntentsPostRequestFormPaymentMethodDataAuBecsDebitX31fb309e(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1SetupIntentsPostRequestFormPaymentMethodDataAuBecsDebitX31fb309e = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1SetupIntentsPostRequestFormPaymentMethodDataAuBecsDebitX31fb309e> {
        ...
        override fun deserialize(
            decoder: Decoder,
        ): InlineV1SetupIntentsPostRequestFormPaymentMethodDataAuBecsDebitX31fb309e {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SetupIntentsPostRequestFormPaymentMethodDataAuBecsDebitX31fb309e must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SetupIntentsPostRequestFormPaymentMethodDataAuBecsDebitX31fb309e,
        ) {
            val jsonEncoder =
...
public fun inlineV1SetupIntentsPostRequestFormPaymentMethodDataAuBecsDebitX31fb309e(
    block: InlineV1SetupIntentsPostRequestFormPaymentMethodDataAuBecsDebitX31fb309e.Builder.() -> Unit,
): InlineV1SetupIntentsPostRequestFormPaymentMethodDataAuBecsDebitX31fb309e =
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1SetupIntentsPostRequestFormPaymentMethodDataAuBecsDebitX31fb309e is missing required property '" +
                    name +
                    "'",
            )
