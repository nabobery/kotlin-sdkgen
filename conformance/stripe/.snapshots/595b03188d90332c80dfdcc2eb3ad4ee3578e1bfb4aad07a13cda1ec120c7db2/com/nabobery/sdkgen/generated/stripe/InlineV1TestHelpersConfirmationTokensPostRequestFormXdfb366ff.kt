...
public class InlineV1TestHelpersConfirmationTokensPostRequestFormXdfb366ff(
     ...
     */
    public val paymentMethodData: InlineV1TestHelpersConfirmationTokensPostRequestFormPaymentMethodDataX9823133d? = null,
    /**
     * Payment-method-specific configuration for this ConfirmationToken.
     */
    public val paymentMethodOptions: InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodOptionsXe1c12396? = null,
    /**
     ...
     */
    public val setupFutureUsage: InlineV1TestHelpersConfirmationTokensPostRequestFormSetupFutureUsageX081fa35d? = null,
    /**
     * Shipping information for this ConfirmationToken.
     */
    public val shipping: InlineV1TestHelpersConfirmationTokensPostRequestFormShippingXaed2fc20? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1TestHelpersConfirmationTokensPostRequestFormXdfb366ff =
            InlineV1TestHelpersConfirmationTokensPostRequestFormXdfb366ff(
                expand = expand,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TestHelpersConfirmationTokensPostRequestFormXdfb366ff =
    ...
    public object Serializer : KSerializer<InlineV1TestHelpersConfirmationTokensPostRequestFormXdfb366ff> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TestHelpersConfirmationTokensPostRequestFormXdfb366ff must be a JSON object",
                    )
            return InlineV1TestHelpersConfirmationTokensPostRequestFormXdfb366ff(
                ...
                paymentMethodData =
                    rawObject["payment_method_data"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TestHelpersConfirmationTokensPostRequestFormPaymentMethodDataX9823133d>(
                                it,
                            )
                    },
                paymentMethodOptions =
                    rawObject["payment_method_options"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodOptionsXe1c12396>(
                                it,
                            )
                    },
                ...
                setupFutureUsage =
                    rawObject["setup_future_usage"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TestHelpersConfirmationTokensPostRequestFormSetupFutureUsageX081fa35d>(
                                it,
                            )
                    },
                shipping =
                    rawObject["shipping"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TestHelpersConfirmationTokensPostRequestFormShippingXaed2fc20>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TestHelpersConfirmationTokensPostRequestFormXdfb366ff,
        ) {
            val jsonEncoder =
...
public fun inlineV1TestHelpersConfirmationTokensPostRequestFormXdfb366ff(
    block: InlineV1TestHelpersConfirmationTokensPostRequestFormXdfb366ff.Builder.() -> Unit,
): InlineV1TestHelpersConfirmationTokensPostRequestFormXdfb366ff =
    InlineV1TestHelpersConfirmationTokensPostRequestFormXdfb366ff.build(block)
