...
public sealed class InlineIssuingCardholderRequirementsPastDueItemX2eb847cc {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineIssuingCardholderRequirementsPastDueItemX2eb847cc =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineIssuingCardholderRequirementsPastDueItemX2eb847cc> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineIssuingCardholderRequirementsPastDueItemX2eb847cc",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineIssuingCardholderRequirementsPastDueItemX2eb847cc =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineIssuingCardholderRequirementsPastDueItemX2eb847cc,
        ) {
