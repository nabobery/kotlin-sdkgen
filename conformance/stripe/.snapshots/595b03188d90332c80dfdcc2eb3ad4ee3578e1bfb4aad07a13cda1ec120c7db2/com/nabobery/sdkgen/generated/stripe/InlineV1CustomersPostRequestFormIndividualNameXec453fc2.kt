...
internal data class InlineV1CustomersPostRequestFormIndividualNameXec453fc2Inspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1CustomersPostRequestFormIndividualNameAnyOf2Xbbe292ff,
            ).count { it }
}
...
public class InlineV1CustomersPostRequestFormIndividualNameXec453fc2 internal constructor(
    ...
    public val inlineV1CustomersPostRequestFormIndividualNameAnyOf2Xbbe292ff:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1CustomersPostRequestFormIndividualNameAnyOf2Xbbe292ff) {
                json
                    .decodeFromJsonElement<InlineV1CustomersPostRequestFormIndividualNameAnyOf2Xbbe292ff>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1CustomersPostRequestFormIndividualNameXec453fc2Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1CustomersPostRequestFormIndividualNameAnyOf2Xbbe292ff) {
                    add(
                        InlineV1CustomersPostRequestFormIndividualNameXec453fc2Branch.InlineV1CustomersPostRequestFormIndividualNameAnyOf2Xbbe292ff,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1CustomersPostRequestFormIndividualNameXec453fc2 {
            val inspection = inspectInlineV1CustomersPostRequestFormIndividualNameXec453fc2(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1CustomersPostRequestFormIndividualNameXec453fc2NoMatchException(
                    "InlineV1CustomersPostRequestFormIndividualNameXec453fc2 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1CustomersPostRequestFormIndividualNameXec453fc2> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersPostRequestFormIndividualNameXec453fc2,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1CustomersPostRequestFormIndividualNameXec453fc2",
...
private fun inspectInlineV1CustomersPostRequestFormIndividualNameXec453fc2(
    element: JsonElement,
): InlineV1CustomersPostRequestFormIndividualNameXec453fc2Inspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1CustomersPostRequestFormIndividualNameAnyOf2Xbbe292ff =
        element
            .isJsonDecodable<InlineV1CustomersPostRequestFormIndividualNameAnyOf2Xbbe292ff>()
    return InlineV1CustomersPostRequestFormIndividualNameXec453fc2Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1CustomersPostRequestFormIndividualNameAnyOf2Xbbe292ff) {
                    add(
                        "InlineV1CustomersPostRequestFormIndividualNameAnyOf2Xbbe292ff: value does not match InlineV1CustomersPostRequestFormIndividualNameAnyOf2Xbbe292ff",
                    )
                }
            },
    )
