        ...
        override fun deserialize(decoder: Decoder): SetupIntentNextAction {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("SetupIntentNextAction must be a JSON object")
            ...
            return SetupIntentNextAction(
                ...
                pixDisplayQrCode =
                    rawObject["pix_display_qr_code"]?.let {
                        json.decodeFromJsonElement<SetupIntentNextActionPixDisplayQrCode>(it)
                    },
                redirectToUrl =
                    rawObject["redirect_to_url"]?.let {
                        json.decodeFromJsonElement<SetupIntentNextActionRedirectToUrl>(it)
                    },
                upiHandleRedirectOrDisplayQrCode =
                    rawObject["upi_handle_redirect_or_display_qr_code"]?.let {
                ...
                verifyWithMicrodeposits =
                    rawObject["verify_with_microdeposits"]?.let {
                        json.decodeFromJsonElement<SetupIntentNextActionVerifyWithMicrodeposits>(it)
                    },
            )
        }
...
public fun setupIntentNextAction(block: SetupIntentNextAction.Builder.() -> Unit): SetupIntentNextAction =
    SetupIntentNextAction.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("SetupIntentNextAction is missing required property '" + name + "'")
