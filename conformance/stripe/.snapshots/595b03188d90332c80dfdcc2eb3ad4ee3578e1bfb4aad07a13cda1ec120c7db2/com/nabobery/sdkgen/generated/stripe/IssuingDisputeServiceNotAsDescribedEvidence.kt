...
public class IssuingDisputeServiceNotAsDescribedEvidence(
     ...
     * dispute.
     */
    public val additionalDocumentation: InlineIssuingDisputeServicdc63AdditionalDocumentationXb915dfd4? = null,
    /**
    ...
    public class Builder {
        ...
        public fun build(): IssuingDisputeServiceNotAsDescribedEvidence =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): IssuingDisputeServiceNotAsDescribedEvidence =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<IssuingDisputeServiceNotAsDescribedEvidence> {
        ...
        override fun deserialize(decoder: Decoder): IssuingDisputeServiceNotAsDescribedEvidence {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("IssuingDisputeServiceNotAsDescribedEvidence must be a JSON object")
                ...
                additionalDocumentation =
                    rawObject["additional_documentation"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineIssuingDisputeServicdc63AdditionalDocumentationXb915dfd4?>(
                                element,
                            )
                        }
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: IssuingDisputeServiceNotAsDescribedEvidence,
        ) {
...
public fun issuingDisputeServiceNotAsDescribedEvidence(
    block: IssuingDisputeServiceNotAsDescribedEvidence.Builder.() -> Unit,
): IssuingDisputeServiceNotAsDescribedEvidence = IssuingDisputeServiceNotAsDescribedEvidence.build(block)
