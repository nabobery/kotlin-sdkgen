...
public class InlineV1InvoicesRemoveLinesPostRequestFormLinesItemXe21b4f55(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1InvoicesRemoveLinesPostRequestFormLinesItemXe21b4f55 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1InvoicesRemoveLinesPostRequestFormLinesItemXe21b4f55> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1InvoicesRemoveLinesPostRequestFormLinesItemXe21b4f55 must be a JSON object",
                    )
            val behavior =
                json.decodeRequired<InlineV1InvoicesRemoveLinesPostRequestFormLinesItemBehaviorX8288b839>(
                    rawObject,
                    "behavior",
                )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesRemoveLinesPostRequestFormLinesItemXe21b4f55,
        ) {
...
public fun inlineV1InvoicesRemoveLinesPostRequestFormLinesItemXe21b4f55(
    block: InlineV1InvoicesRemoveLinesPostRequestFormLinesItemXe21b4f55.Builder.() -> Unit,
): InlineV1InvoicesRemoveLinesPostRequestFormLinesItemXe21b4f55 =
    InlineV1InvoicesRemoveLinesPostRequestFormLinesItemXe21b4f55.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1InvoicesRemoveLinesPostRequestFormLinesItemXe21b4f55 is missing required property '" + name +
                    "'",
            )
