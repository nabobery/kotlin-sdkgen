...
public class DeletedProduct(
    ...
    public object Serializer : KSerializer<DeletedProduct> {
        ...
        override fun deserialize(decoder: Decoder): DeletedProduct {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("DeletedProduct must be a JSON object")
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("DeletedProduct is missing required property '" + name + "'")
