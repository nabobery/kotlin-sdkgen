...
public class InlineConnectAccountReferenceAccountXebc59099 internal constructor(
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineConnectAccountReferenceAccountXebc59099 {
            val inspection = inspectInlineConnectAccountReferenceAccountXebc59099(raw)
            if (inspection.matchCount == 0) {
                throw InlineConnectAccountReferenceAccountXebc59099NoMatchException(
                    "InlineConnectAccountReferenceAccountXebc59099 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineConnectAccountReferenceAccountXebc59099> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineConnectAccountReferenceAccountXebc59099,
        ) {
...
private fun inspectInlineConnectAccountReferenceAccountXebc59099(
    element: JsonElement,
): InlineConnectAccountReferenceAccountXebc59099Inspection {
