...
public class InlineV1TaxTransactionsCreateReversalPostRequestFormShippingCostXf7eccb3f(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1TaxTransactionsCreateReversalPostRequestFormShippingCostXf7eccb3f = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1TaxTransactionsCreateReversalPostRequestFormShippingCostXf7eccb3f> {
        ...
        override fun deserialize(
            decoder: Decoder,
        ): InlineV1TaxTransactionsCreateReversalPostRequestFormShippingCostXf7eccb3f {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TaxTransactionsCreateReversalPostRequestFormShippingCostXf7eccb3f must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TaxTransactionsCreateReversalPostRequestFormShippingCostXf7eccb3f,
        ) {
            val jsonEncoder =
...
public fun inlineV1TaxTransactionsCreateReversalPostRequestFormShippingCostXf7eccb3f(
    block: InlineV1TaxTransactionsCreateReversalPostRequestFormShippingCostXf7eccb3f.Builder.() -> Unit,
): InlineV1TaxTransactionsCreateReversalPostRequestFormShippingCostXf7eccb3f =
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TaxTransactionsCreateReversalPostRequestFormShippingCostXf7eccb3f is missing required property '" +
                    name +
                    "'",
            )
