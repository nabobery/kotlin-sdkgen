...
public class InlineV1IdentityVerificatid8e1PostRequestFormOptionsDocumentAnyOf1Xce121586(
    public val allowedTypes:
        List<InlineV1IdentityVerificatid8e1PostRequestFormOptionsDocumentAnyOf1ItemXab00bbeb>? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1IdentityVerificatid8e1PostRequestFormOptionsDocumentAnyOf1Xce121586 =
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1IdentityVerificatid8e1PostRequestFormOptionsDocumentAnyOf1Xce121586 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1IdentityVerificatid8e1PostRequestFormOptionsDocumentAnyOf1Xce121586> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1IdentityVerificatid8e1PostRequestFormOptionsDocumentAnyOf1Xce121586 must be a JSON object",
                    )
            return InlineV1IdentityVerificatid8e1PostRequestFormOptionsDocumentAnyOf1Xce121586(
                allowedTypes =
                    rawObject["allowed_types"]?.let {
                        json
                            .decodeFromJsonElement<List<InlineV1IdentityVerificatid8e1PostRequestFormOptionsDocumentAnyOf1ItemXab00bbeb>>(
                                it,
                            )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IdentityVerificatid8e1PostRequestFormOptionsDocumentAnyOf1Xce121586,
        ) {
            val jsonEncoder =
...
public fun inlineV1IdentityVerificatid8e1PostRequestFormOptionsDocumentAnyOf1Xce121586(
    block: InlineV1IdentityVerificatid8e1PostRequestFormOptionsDocumentAnyOf1Xce121586.Builder.() -> Unit,
): InlineV1IdentityVerificatid8e1PostRequestFormOptionsDocumentAnyOf1Xce121586 =
    InlineV1IdentityVerificatid8e1PostRequestFormOptionsDocumentAnyOf1Xce121586.build(block)
