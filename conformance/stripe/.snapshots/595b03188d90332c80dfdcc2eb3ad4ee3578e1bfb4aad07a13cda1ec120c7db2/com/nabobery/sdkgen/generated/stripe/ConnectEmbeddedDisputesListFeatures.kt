...
public class ConnectEmbeddedDisputesListFeatures(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): ConnectEmbeddedDisputesListFeatures =
    ...
    public object Serializer : KSerializer<ConnectEmbeddedDisputesListFeatures> {
        ...
        override fun deserialize(decoder: Decoder): ConnectEmbeddedDisputesListFeatures {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("ConnectEmbeddedDisputesListFeatures must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: ConnectEmbeddedDisputesListFeatures,
        ) {
...
public fun connectEmbeddedDisputesListFeatures(
    block: ConnectEmbeddedDisputesListFeatures.Builder.() -> Unit,
): ConnectEmbeddedDisputesListFeatures = ConnectEmbeddedDisputesListFeatures.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "ConnectEmbeddedDisputesListFeatures is missing required property '" + name + "'",
            )
