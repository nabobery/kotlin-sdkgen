...
public class InlineV1PlansGetParameterX8261943e internal constructor(
    ...
    public val inlineV1PlansGetParameterAnyOf1X9b127349: InlineV1PlansGetParameterAnyOf1X9b127349? by
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1PlansGetParameterAnyOf1X9b127349) {
                json
                    .decodeFromJsonElement<InlineV1PlansGetParameterAnyOf1X9b127349>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1PlansGetParameterX8261943eBranch>
        get() =
            buildSet {
                if (inspection.matchesInlineV1PlansGetParameterAnyOf1X9b127349) {
                    add(
                        InlineV1PlansGetParameterX8261943eBranch.InlineV1PlansGetParameterAnyOf1X9b127349,
                    )
                }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1PlansGetParameterX8261943e {
            val inspection = inspectInlineV1PlansGetParameterX8261943e(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1PlansGetParameterX8261943eNoMatchException(
                    "InlineV1PlansGetParameterX8261943e matched 0 branches: " + inspection.failures.joinToString("; "),
                )
            }
    ...
    public object Serializer : KSerializer<InlineV1PlansGetParameterX8261943e> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PlansGetParameterX8261943e,
        ) {
...
private fun inspectInlineV1PlansGetParameterX8261943e(
    element: JsonElement,
): InlineV1PlansGetParameterX8261943eInspection {
    val matchesInlineV1PlansGetParameterAnyOf1X9b127349 =
        element
            .isJsonDecodable<InlineV1PlansGetParameterAnyOf1X9b127349>()
    ...
    return InlineV1PlansGetParameterX8261943eInspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1PlansGetParameterAnyOf1X9b127349) {
                    add(
                        "InlineV1PlansGetParameterAnyOf1X9b127349: value does not match InlineV1PlansGetParameterAnyOf1X9b127349",
                    )
                }
