...
public class InlineV1ChargesPostRequestFormMetadataX62aa1606 internal constructor(
    ...
    public val inlineV1ChargesPostRequestFormMetadataAnyOf2X7b3438b8:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1ChargesPostRequestFormMetadataAnyOf2X7b3438b8) {
                json
                    .decodeFromJsonElement<InlineV1ChargesPostRequestFormMetadataAnyOf2X7b3438b8>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1ChargesPostRequestFormMetadataX62aa1606Branch>
        get() =
            buildSet {
                ...
                if (inspection.matchesInlineV1ChargesPostRequestFormMetadataAnyOf2X7b3438b8) {
                    add(
                        InlineV1ChargesPostRequestFormMetadataX62aa1606Branch.InlineV1ChargesPostRequestFormMetadataAnyOf2X7b3438b8,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1ChargesPostRequestFormMetadataX62aa1606 {
            val inspection = inspectInlineV1ChargesPostRequestFormMetadataX62aa1606(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1ChargesPostRequestFormMetadataX62aa1606NoMatchException(
                    "InlineV1ChargesPostRequestFormMetadataX62aa1606 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1ChargesPostRequestFormMetadataX62aa1606> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ChargesPostRequestFormMetadataX62aa1606,
        ) {
...
private fun inspectInlineV1ChargesPostRequestFormMetadataX62aa1606(
    element: JsonElement,
): InlineV1ChargesPostRequestFormMetadataX62aa1606Inspection {
    val matchesBranch1 = element.isJsonDecodable<JsonObject>()
    val matchesInlineV1ChargesPostRequestFormMetadataAnyOf2X7b3438b8 =
        element
            .isJsonDecodable<InlineV1ChargesPostRequestFormMetadataAnyOf2X7b3438b8>()
    return InlineV1ChargesPostRequestFormMetadataX62aa1606Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1ChargesPostRequestFormMetadataAnyOf2X7b3438b8) {
                    add(
                        "InlineV1ChargesPostRequestFormMetadataAnyOf2X7b3438b8: value does not match InlineV1ChargesPostRequestFormMetadataAnyOf2X7b3438b8",
                    )
                }
            },
    )
