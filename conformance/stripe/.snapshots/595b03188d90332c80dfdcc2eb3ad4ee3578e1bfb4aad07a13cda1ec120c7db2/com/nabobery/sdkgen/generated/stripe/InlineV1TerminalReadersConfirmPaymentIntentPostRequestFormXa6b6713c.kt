...
public class InlineV1TerminalReadersConfirmPaymentIntentPostRequestFormXa6b6713c(
     ...
     */
    public val confirmConfig: InlineV1TerminalReadersConfirmPaymentIntentPostRequestFormConfirmConfigXead464ac? = null,
    /**
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1TerminalReadersConfirmPaymentIntentPostRequestFormXa6b6713c = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1TerminalReadersConfirmPaymentIntentPostRequestFormXa6b6713c> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TerminalReadersConfirmPaymentIntentPostRequestFormXa6b6713c must be a JSON object",
                    )
            val paymentIntent = json.decodeRequired<String>(rawObject, "payment_intent")
            return InlineV1TerminalReadersConfirmPaymentIntentPostRequestFormXa6b6713c(
                paymentIntent = paymentIntent,
                confirmConfig =
                    rawObject["confirm_config"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TerminalReadersConfirmPaymentIntentPostRequestFormConfirmConfigXead464ac>(
                                it,
                            )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TerminalReadersConfirmPaymentIntentPostRequestFormXa6b6713c,
        ) {
            val jsonEncoder =
...
public fun inlineV1TerminalReadersConfirmPaymentIntentPostRequestFormXa6b6713c(
    block: InlineV1TerminalReadersConfirmPaymentIntentPostRequestFormXa6b6713c.Builder.() -> Unit,
): InlineV1TerminalReadersConfirmPaymentIntentPostRequestFormXa6b6713c =
    InlineV1TerminalReadersConfirmPaymentIntentPostRequestFormXa6b6713c.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TerminalReadersConfirmPaymentIntentPostRequestFormXa6b6713c is missing required property '" +
                    name +
                    "'",
            )
