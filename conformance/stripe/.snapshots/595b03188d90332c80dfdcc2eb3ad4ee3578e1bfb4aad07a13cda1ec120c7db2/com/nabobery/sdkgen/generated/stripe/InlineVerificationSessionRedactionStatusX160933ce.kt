...
public sealed class InlineVerificationSessionRedactionStatusX160933ce {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineVerificationSessionRedactionStatusX160933ce =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineVerificationSessionRedactionStatusX160933ce> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineVerificationSessionRedactionStatusX160933ce",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineVerificationSessionRedactionStatusX160933ce =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineVerificationSessionRedactionStatusX160933ce,
        ) {
