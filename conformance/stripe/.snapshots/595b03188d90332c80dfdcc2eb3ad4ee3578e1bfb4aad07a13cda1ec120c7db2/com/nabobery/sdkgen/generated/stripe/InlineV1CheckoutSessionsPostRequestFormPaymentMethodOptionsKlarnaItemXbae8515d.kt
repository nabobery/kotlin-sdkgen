...
public class InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsKlarnaItemXbae8515d(
    ...
    public val nextBilling: InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsNextBillingXeeb216ca,
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsKlarnaItemXbae8515d =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsKlarnaItemXbae8515d> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsKlarnaItemXbae8515d must be a JSON object",
                    )
            val interval =
                json.decodeRequired<InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsIntervalXdc8ec107>(
                    rawObject,
                    "interval",
                )
            val nextBilling =
                json
                    .decodeRequired<InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsNextBillingXeeb216ca>(
                        rawObject,
                        "next_billing",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsKlarnaItemXbae8515d,
        ) {
            val jsonEncoder =
...
public fun inlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsKlarnaItemXbae8515d(
    block: InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsKlarnaItemXbae8515d.Builder.() -> Unit,
): InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsKlarnaItemXbae8515d =
    InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsKlarnaItemXbae8515d.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsKlarnaItemXbae8515d is missing required property '" +
                    name +
                    "'",
            )
