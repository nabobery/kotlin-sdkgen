...
internal data class InlineV1TreasuryTransactionEntriesGetParameterXced22640Inspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesInlineV1TreasuryTransactionEntriesGetParameterAnyOf1Xa06f97c2,
                matchesBranch2,
            ).count { it }
}
...
public class InlineV1TreasuryTransactionEntriesGetParameterXced22640 internal constructor(
    ...
    public val inlineV1TreasuryTransactionEntriesGetParameterAnyOf1Xa06f97c2:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1TreasuryTransactionEntriesGetParameterAnyOf1Xa06f97c2) {
                json
                    .decodeFromJsonElement<InlineV1TreasuryTransactionEntriesGetParameterAnyOf1Xa06f97c2>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1TreasuryTransactionEntriesGetParameterXced22640Branch>
        get() =
            buildSet {
                if (inspection.matchesInlineV1TreasuryTransactionEntriesGetParameterAnyOf1Xa06f97c2) {
                    add(
                        InlineV1TreasuryTransactionEntriesGetParameterXced22640Branch.InlineV1TreasuryTransactionEntriesGetParameterAnyOf1Xa06f97c2,
                    )
                }
                if (inspection.matchesBranch2) {
                    add(
                        InlineV1TreasuryTransactionEntriesGetParameterXced22640Branch.Branch2,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1TreasuryTransactionEntriesGetParameterXced22640 {
            val inspection = inspectInlineV1TreasuryTransactionEntriesGetParameterXced22640(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1TreasuryTransactionEntriesGetParameterXced22640NoMatchException(
                    "InlineV1TreasuryTransactionEntriesGetParameterXced22640 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1TreasuryTransactionEntriesGetParameterXced22640> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TreasuryTransactionEntriesGetParameterXced22640,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1TreasuryTransactionEntriesGetParameterXced22640",
...
private fun inspectInlineV1TreasuryTransactionEntriesGetParameterXced22640(
    element: JsonElement,
): InlineV1TreasuryTransactionEntriesGetParameterXced22640Inspection {
    val matchesInlineV1TreasuryTransactionEntriesGetParameterAnyOf1Xa06f97c2 =
        element
            .isJsonDecodable<InlineV1TreasuryTransactionEntriesGetParameterAnyOf1Xa06f97c2>()
    ...
    return InlineV1TreasuryTransactionEntriesGetParameterXced22640Inspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1TreasuryTransactionEntriesGetParameterAnyOf1Xa06f97c2) {
                    add(
                        "InlineV1TreasuryTransactionEntriesGetParameterAnyOf1Xa06f97c2: value does not match InlineV1TreasuryTransactionEntriesGetParameterAnyOf1Xa06f97c2",
                    )
                }
