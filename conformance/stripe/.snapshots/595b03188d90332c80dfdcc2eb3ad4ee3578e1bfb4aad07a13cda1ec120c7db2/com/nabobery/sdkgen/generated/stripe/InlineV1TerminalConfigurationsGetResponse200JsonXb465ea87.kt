...
public class InlineV1TerminalConfigurationsGetResponse200JsonXb465ea87(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TerminalConfigurationsGetResponse200JsonXb465ea87 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TerminalConfigurationsGetResponse200JsonXb465ea87> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1TerminalConfigurationsGetResponse200JsonXb465ea87 {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TerminalConfigurationsGetResponse200JsonXb465ea87 must be a JSON object",
                    )
            ...
            val objectValue =
                json.decodeRequired<InlineV1TerminalConfigurationsGetResponse200JsonObjectValueX321a823a>(
                    rawObject,
                    "object",
                )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TerminalConfigurationsGetResponse200JsonXb465ea87,
        ) {
...
public fun inlineV1TerminalConfigurationsGetResponse200JsonXb465ea87(
    block: InlineV1TerminalConfigurationsGetResponse200JsonXb465ea87.Builder.() -> Unit,
): InlineV1TerminalConfigurationsGetResponse200JsonXb465ea87 =
    InlineV1TerminalConfigurationsGetResponse200JsonXb465ea87.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TerminalConfigurationsGetResponse200JsonXb465ea87 is missing required property '" + name + "'",
            )
