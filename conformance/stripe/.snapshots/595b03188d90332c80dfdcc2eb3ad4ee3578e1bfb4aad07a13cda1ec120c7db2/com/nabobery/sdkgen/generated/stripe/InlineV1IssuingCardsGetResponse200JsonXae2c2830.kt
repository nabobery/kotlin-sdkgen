...
public class InlineV1IssuingCardsGetResponse200JsonXae2c2830(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1IssuingCardsGetResponse200JsonXae2c2830 =
    ...
    public object Serializer : KSerializer<InlineV1IssuingCardsGetResponse200JsonXae2c2830> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1IssuingCardsGetResponse200JsonXae2c2830 must be a JSON object",
                    )
            val data = json.decodeRequired<List<IssuingCard>>(rawObject, "data")
            val hasMore = json.decodeRequired<Boolean>(rawObject, "has_more")
            val objectValue =
                json.decodeRequired<InlineV1IssuingCardsGetResponse200JsonObjectValueX8eb013b7>(
                    rawObject,
                    "object",
                )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingCardsGetResponse200JsonXae2c2830,
        ) {
...
public fun inlineV1IssuingCardsGetResponse200JsonXae2c2830(
    block: InlineV1IssuingCardsGetResponse200JsonXae2c2830.Builder.() -> Unit,
): InlineV1IssuingCardsGetResponse200JsonXae2c2830 = InlineV1IssuingCardsGetResponse200JsonXae2c2830.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1IssuingCardsGetResponse200JsonXae2c2830 is missing required property '" + name + "'",
            )
