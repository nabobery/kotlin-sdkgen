...
public class InlineV1TestHelpersIssuingAuthorizationsPostRequestFormNetworkDataX2f17c458(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1TestHelpersIssuingAuthorizationsPostRequestFormNetworkDataX2f17c458 =
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1TestHelpersIssuingAuthorizationsPostRequestFormNetworkDataX2f17c458 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TestHelpersIssuingAuthorizationsPostRequestFormNetworkDataX2f17c458> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TestHelpersIssuingAuthorizationsPostRequestFormNetworkDataX2f17c458 must be a JSON object",
                    )
            return InlineV1TestHelpersIssuingAuthorizationsPostRequestFormNetworkDataX2f17c458(
                acquiringInstitutionId =
                    rawObject["acquiring_institution_id"]?.let {
                        json
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TestHelpersIssuingAuthorizationsPostRequestFormNetworkDataX2f17c458,
        ) {
            val jsonEncoder =
...
public fun inlineV1TestHelpersIssuingAuthorizationsPostRequestFormNetworkDataX2f17c458(
    block: InlineV1TestHelpersIssuingAuthorizationsPostRequestFormNetworkDataX2f17c458.Builder.() -> Unit,
): InlineV1TestHelpersIssuingAuthorizationsPostRequestFormNetworkDataX2f17c458 =
    InlineV1TestHelpersIssuingAuthorizationsPostRequestFormNetworkDataX2f17c458.build(block)
