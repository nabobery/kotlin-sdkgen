...
public class PaymentMethodSepaDebit(
    ...
    public class Builder {
        ...
        public fun build(): PaymentMethodSepaDebit =
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodSepaDebit {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodSepaDebit must be a JSON object")
                ...
                generatedFrom =
                    rawObject["generated_from"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentMethodSepaDebitGeneratedFromX94640171?>(element)
                        }
                    },
                last4 =
...
public fun paymentMethodSepaDebit(block: PaymentMethodSepaDebit.Builder.() -> Unit): PaymentMethodSepaDebit =
    PaymentMethodSepaDebit.build(block)
