...
public sealed class InlineInvoicePaymentsObjectValueXbf417d0f {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineInvoicePaymentsObjectValueXbf417d0f =
            when (value) {
                List.value -> List
    ...
    public object Serializer : KSerializer<InlineInvoicePaymentsObjectValueXbf417d0f> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineInvoicePaymentsObjectValueXbf417d0f",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineInvoicePaymentsObjectValueXbf417d0f =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineInvoicePaymentsObjectValueXbf417d0f,
        ) {
