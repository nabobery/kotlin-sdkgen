...
public class PaymentFlowsPrivatePaymentMethodsKlarnaDob(
    ...
    public class Builder {
        ...
        public fun build(): PaymentFlowsPrivatePaymentMethodsKlarnaDob =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentFlowsPrivatePaymentMethodsKlarnaDob =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentFlowsPrivatePaymentMethodsKlarnaDob> {
        ...
        override fun deserialize(decoder: Decoder): PaymentFlowsPrivatePaymentMethodsKlarnaDob {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentFlowsPrivatePaymentMethodsKlarnaDob must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentFlowsPrivatePaymentMethodsKlarnaDob,
        ) {
...
public fun paymentFlowsPrivatePaymentMethodsKlarnaDob(
    block: PaymentFlowsPrivatePaymentMethodsKlarnaDob.Builder.() -> Unit,
): PaymentFlowsPrivatePaymentMethodsKlarnaDob = PaymentFlowsPrivatePaymentMethodsKlarnaDob.build(block)
