...
public class InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsCardAnyOf1X8c54292c(
    public val captureMethod: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsCaptureMethodXa734875b? = null,
    public val cvcToken: String? = null,
    public val installments: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsInstallmentsX57eb4fe9? = null,
    public val mandateOptions: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsMandateOptionsX09008e3e? = null,
    public val network: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsCardNetworkX1ba5df73? = null,
    ...
    public val requestMulticapture: InlineV1PaymentIntentsPostRequestFormRequestMulticaptureXdde2b42b? = null,
    public val requestOvercapture: InlineV1PaymentIntentsPostRequestFormRequestOvercaptureX03538a4a? = null,
    public val requestThreeDSecure: InlineV1PaymentIntentsPostRequestFormRequestThreeDSecureX2f01196e? = null,
    public val requireCvcRecollection: Boolean? = null,
    public val setupFutureUsage: InlineV1PaymentIntentsPostRequestFormSetupFutureUsageX7811a597? = null,
    ...
    public val threeDSecure: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsThreeDSecureX5f003b8a? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsCardAnyOf1X8c54292c =
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsCardAnyOf1X8c54292c = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsCardAnyOf1X8c54292c> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsCardAnyOf1X8c54292c must be a JSON object",
                    )
            return InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsCardAnyOf1X8c54292c(
                captureMethod =
                    rawObject["capture_method"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsCaptureMethodXa734875b>(
                                it,
                            )
                    },
                ...
                installments =
                    rawObject["installments"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsInstallmentsX57eb4fe9>(
                                it,
                            )
                    },
                mandateOptions =
                    rawObject["mandate_options"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsMandateOptionsX09008e3e>(
                                it,
                            )
                    },
                network =
                    rawObject["network"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsCardNetworkX1ba5df73>(
                                it,
                            )
                    },
                requestExtendedAuthorization =
                    rawObject["request_extended_authorization"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormRequestExtendedAutho403fXa8743159>(
                                it,
                            )
                    },
                requestIncrementalAuthorization =
                    rawObject["request_incremental_authorization"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormRequestIncrementalAu57cdX9748b958>(
                                it,
                            )
                    },
                requestMulticapture =
                    rawObject["request_multicapture"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormRequestMulticaptureXdde2b42b>(
                            it,
                        )
                    },
                requestOvercapture =
                    rawObject["request_overcapture"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormRequestOvercaptureX03538a4a>(it)
                    },
                requestThreeDSecure =
                    rawObject["request_three_d_secure"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormRequestThreeDSecureX2f01196e>(
                            it,
                        )
                    },
                requireCvcRecollection =
                    rawObject["require_cvc_recollection"]?.let {
                        json
                ...
                setupFutureUsage =
                    rawObject["setup_future_usage"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormSetupFutureUsageX7811a597>(it)
                    },
                statementDescriptorSuffixKana =
                    rawObject["statement_descriptor_suffix_kana"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormStatementDescriptorS583fXedd1b2c3>(
                                it,
                            )
                    },
                statementDescriptorSuffixKanji =
                    rawObject["statement_descriptor_suffix_kanji"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormStatementDescriptorSb1afX1973e3fd>(
                                it,
                            )
                    },
                threeDSecure =
                    rawObject["three_d_secure"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsThreeDSecureX5f003b8a>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsCardAnyOf1X8c54292c,
        ) {
            val jsonEncoder =
            ...
            val raw =
                buildJsonObject {
                    ...
                    value.requestIncrementalAuthorization?.let {
                        put(
                    ...
                    value.statementDescriptorSuffixKana?.let {
                        put(
                            "statement_descriptor_suffix_kana",
                            json.encodeToJsonElement(it),
                        )
                    }
                    value.statementDescriptorSuffixKanji?.let {
                        put(
...
public fun inlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsCardAnyOf1X8c54292c(
    block: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsCardAnyOf1X8c54292c.Builder.() -> Unit,
): InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsCardAnyOf1X8c54292c =
    InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsCardAnyOf1X8c54292c.build(block)
