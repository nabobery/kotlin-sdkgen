...
public class InlineV1IssuingCardsPostRequestFormShippingX07abe3a2(
    ...
    public val addressValidation: InlineV1IssuingCardsPostRequestFormShippingAddressValidationX3040c1e4? = null,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1IssuingCardsPostRequestFormShippingX07abe3a2 =
    ...
    public object Serializer : KSerializer<InlineV1IssuingCardsPostRequestFormShippingX07abe3a2> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1IssuingCardsPostRequestFormShippingX07abe3a2 {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1IssuingCardsPostRequestFormShippingX07abe3a2 must be a JSON object",
                    )
            val address =
                json.decodeRequired<InlineV1IssuingCardsPostRequestFormShippingAddressX4f1278b9>(
                    rawObject,
                    "address",
                )
            ...
            return InlineV1IssuingCardsPostRequestFormShippingX07abe3a2(
                ...
                name = name,
                addressValidation =
                    rawObject["address_validation"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1IssuingCardsPostRequestFormShippingAddressValidationX3040c1e4>(
                                it,
                            )
                    },
                customs =
                    rawObject["customs"]?.let {
                        json.decodeFromJsonElement<InlineV1IssuingCardsPostRequestFormShippingCustomsX08817e46>(it)
                    },
                ...
                service =
                    rawObject["service"]?.let {
                        json.decodeFromJsonElement<InlineV1IssuingCardsPostRequestFormShippingServiceXd9aa284d>(it)
                    },
                type =
                    rawObject["type"]?.let {
                        json.decodeFromJsonElement<InlineV1IssuingCardsPostRequestFormShippingTypeXa94242c3>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingCardsPostRequestFormShippingX07abe3a2,
        ) {
...
public fun inlineV1IssuingCardsPostRequestFormShippingX07abe3a2(
    block: InlineV1IssuingCardsPostRequestFormShippingX07abe3a2.Builder.() -> Unit,
): InlineV1IssuingCardsPostRequestFormShippingX07abe3a2 =
    InlineV1IssuingCardsPostRequestFormShippingX07abe3a2.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1IssuingCardsPostRequestFormShippingX07abe3a2 is missing required property '" + name + "'",
            )
