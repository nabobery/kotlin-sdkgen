...
@Serializable
public data class PaymentPagesCheckoutSessionSavedPaymentMethodOptionsView(
    @SerialName("allow_redisplay_filters")
    public val allowRedisplayFilters: List<InlinePaymentPagesCheckoutca5aAllowRedisplayFiltersItemXf1cd964d>? = null,
    @SerialName("payment_method_remove")
    public val paymentMethodRemove: InlinePaymentPagesCheckoutca5aPaymentMethodRemoveX91464a78? = null,
...
public class PaymentPagesCheckoutSessionSavedPaymentMethodOptions(
    ...
    public class Builder {
        ...
        public fun build(): PaymentPagesCheckoutSessionSavedPaymentMethodOptions =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentPagesCheckoutSessionSavedPaymentMethodOptions =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentPagesCheckoutSessionSavedPaymentMethodOptions> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "PaymentPagesCheckoutSessionSavedPaymentMethodOptions must be a JSON object",
                    )
            return PaymentPagesCheckoutSessionSavedPaymentMethodOptions(
                allowRedisplayFilters =
                    rawObject["allow_redisplay_filters"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                            ...
                            json
                                .decodeFromJsonElement<List<InlinePaymentPagesCheckoutca5aAllowRedisplayFiltersItemXf1cd964d>?>(
                                    element,
                                )
                        }
                    },
                paymentMethodRemove =
                    rawObject["payment_method_remove"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentPagesCheckoutca5aPaymentMethodRemoveX91464a78?>(
                                element,
                            )
                        }
                    },
                paymentMethodSave =
                    rawObject["payment_method_save"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentPagesCheckoutca5aPaymentMethodSaveX1b3c9d08?>(
                                element,
                            )
                        }
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentPagesCheckoutSessionSavedPaymentMethodOptions,
        ) {
...
public fun paymentPagesCheckoutSessionSavedPaymentMethodOptions(
    block: PaymentPagesCheckoutSessionSavedPaymentMethodOptions.Builder.() -> Unit,
): PaymentPagesCheckoutSessionSavedPaymentMethodOptions =
    PaymentPagesCheckoutSessionSavedPaymentMethodOptions.build(block)
