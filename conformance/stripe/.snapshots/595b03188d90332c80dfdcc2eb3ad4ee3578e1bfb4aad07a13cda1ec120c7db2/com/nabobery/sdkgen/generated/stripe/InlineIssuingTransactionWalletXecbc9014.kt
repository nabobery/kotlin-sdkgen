...
public sealed class InlineIssuingTransactionWalletXecbc9014 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineIssuingTransactionWalletXecbc9014 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineIssuingTransactionWalletXecbc9014> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineIssuingTransactionWalletXecbc9014",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineIssuingTransactionWalletXecbc9014 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineIssuingTransactionWalletXecbc9014,
        ) {
