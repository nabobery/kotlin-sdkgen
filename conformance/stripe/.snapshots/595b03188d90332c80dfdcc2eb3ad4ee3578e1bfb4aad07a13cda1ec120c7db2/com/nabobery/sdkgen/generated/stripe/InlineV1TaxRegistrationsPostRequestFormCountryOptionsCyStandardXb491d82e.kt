...
public class InlineV1TaxRegistrationsPostRequestFormCountryOptionsCyStandardXb491d82e(
    public val placeOfSupplyScheme: InlineV1TaxRegistrationsPostRequestFormPlaceOfSupplySchemeXc1a7c771,
) {
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1TaxRegistrationsPostRequestFormCountryOptionsCyStandardXb491d82e = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TaxRegistrationsPostRequestFormCountryOptionsCyStandardXb491d82e> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TaxRegistrationsPostRequestFormCountryOptionsCyStandardXb491d82e must be a JSON object",
                    )
            val placeOfSupplyScheme =
                json
                    .decodeRequired<InlineV1TaxRegistrationsPostRequestFormPlaceOfSupplySchemeXc1a7c771>(
                        rawObject,
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TaxRegistrationsPostRequestFormCountryOptionsCyStandardXb491d82e,
        ) {
            val jsonEncoder =
...
public fun inlineV1TaxRegistrationsPostRequestFormCountryOptionsCyStandardXb491d82e(
    block: InlineV1TaxRegistrationsPostRequestFormCountryOptionsCyStandardXb491d82e.Builder.() -> Unit,
): InlineV1TaxRegistrationsPostRequestFormCountryOptionsCyStandardXb491d82e =
    InlineV1TaxRegistrationsPostRequestFormCountryOptionsCyStandardXb491d82e.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TaxRegistrationsPostRequestFormCountryOptionsCyStandardXb491d82e is missing required property '" +
                    name +
                    "'",
            )
