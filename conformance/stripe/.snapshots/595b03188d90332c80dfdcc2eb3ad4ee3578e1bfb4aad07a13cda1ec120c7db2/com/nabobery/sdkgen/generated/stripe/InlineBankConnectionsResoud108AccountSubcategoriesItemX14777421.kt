...
public sealed class InlineBankConnectionsResoud108AccountSubcategoriesItemX14777421 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineBankConnectionsResoud108AccountSubcategoriesItemX14777421 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineBankConnectionsResoud108AccountSubcategoriesItemX14777421> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineBankConnectionsResoud108AccountSubcategoriesItemX14777421",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineBankConnectionsResoud108AccountSubcategoriesItemX14777421 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineBankConnectionsResoud108AccountSubcategoriesItemX14777421,
        ) {
