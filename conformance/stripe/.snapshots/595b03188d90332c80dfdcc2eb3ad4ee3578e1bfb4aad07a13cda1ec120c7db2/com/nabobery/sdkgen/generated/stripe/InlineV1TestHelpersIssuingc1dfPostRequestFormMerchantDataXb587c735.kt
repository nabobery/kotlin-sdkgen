...
public class InlineV1TestHelpersIssuingc1dfPostRequestFormMerchantDataXb587c735(
    public val category: InlineV1TestHelpersIssuingc1dfPostRequestFormMerchantDataCategoryXeccfbc60? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1TestHelpersIssuingc1dfPostRequestFormMerchantDataXb587c735 =
            InlineV1TestHelpersIssuingc1dfPostRequestFormMerchantDataXb587c735(
                category = category,
                city = city,
                country = country,
                name = name,
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1TestHelpersIssuingc1dfPostRequestFormMerchantDataXb587c735 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TestHelpersIssuingc1dfPostRequestFormMerchantDataXb587c735> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TestHelpersIssuingc1dfPostRequestFormMerchantDataXb587c735 must be a JSON object",
                    )
            return InlineV1TestHelpersIssuingc1dfPostRequestFormMerchantDataXb587c735(
                category =
                    rawObject["category"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TestHelpersIssuingc1dfPostRequestFormMerchantDataCategoryXeccfbc60>(
                                it,
                            )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TestHelpersIssuingc1dfPostRequestFormMerchantDataXb587c735,
        ) {
            val jsonEncoder =
...
public fun inlineV1TestHelpersIssuingc1dfPostRequestFormMerchantDataXb587c735(
    block: InlineV1TestHelpersIssuingc1dfPostRequestFormMerchantDataXb587c735.Builder.() -> Unit,
): InlineV1TestHelpersIssuingc1dfPostRequestFormMerchantDataXb587c735 =
    InlineV1TestHelpersIssuingc1dfPostRequestFormMerchantDataXb587c735.build(block)
