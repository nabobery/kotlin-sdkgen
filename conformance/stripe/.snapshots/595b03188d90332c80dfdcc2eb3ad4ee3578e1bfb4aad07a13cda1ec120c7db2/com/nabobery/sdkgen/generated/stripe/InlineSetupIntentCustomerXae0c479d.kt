...
public class InlineSetupIntentCustomerXae0c479d internal constructor(
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineSetupIntentCustomerXae0c479d {
            val inspection = inspectInlineSetupIntentCustomerXae0c479d(raw)
            if (inspection.matchCount == 0) {
                throw InlineSetupIntentCustomerXae0c479dNoMatchException(
                    "InlineSetupIntentCustomerXae0c479d matched 0 branches: " + inspection.failures.joinToString("; "),
                )
            }
    ...
    public object Serializer : KSerializer<InlineSetupIntentCustomerXae0c479d> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineSetupIntentCustomerXae0c479d,
        ) {
...
private fun inspectInlineSetupIntentCustomerXae0c479d(
    element: JsonElement,
): InlineSetupIntentCustomerXae0c479dInspection {
