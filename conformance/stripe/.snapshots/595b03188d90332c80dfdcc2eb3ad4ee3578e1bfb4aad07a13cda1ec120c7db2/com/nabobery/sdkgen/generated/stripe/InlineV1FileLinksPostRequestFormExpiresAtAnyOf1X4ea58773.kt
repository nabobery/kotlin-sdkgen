...
public sealed class InlineV1FileLinksPostRequestFormExpiresAtAnyOf1X4ea58773 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1FileLinksPostRequestFormExpiresAtAnyOf1X4ea58773 =
            when (value) {
                Now.value -> Now
    ...
    public object Serializer : KSerializer<InlineV1FileLinksPostRequestFormExpiresAtAnyOf1X4ea58773> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1FileLinksPostRequestFormExpiresAtAnyOf1X4ea58773",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1FileLinksPostRequestFormExpiresAtAnyOf1X4ea58773 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1FileLinksPostRequestFormExpiresAtAnyOf1X4ea58773,
        ) {
