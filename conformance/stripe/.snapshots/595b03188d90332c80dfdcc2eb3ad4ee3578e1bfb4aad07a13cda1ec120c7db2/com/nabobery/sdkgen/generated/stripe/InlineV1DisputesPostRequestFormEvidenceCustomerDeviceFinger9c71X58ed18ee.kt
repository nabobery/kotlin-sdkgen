...
internal data class InlineV1DisputesPostRequestFormEvidenceCustomerDeviceFinger9c71X58ed18eeInspection(
    ...
    public val matchesInlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2X56de6f49: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2X56de6f49,
            ).count {
                it
            }
}
...
public class InlineV1DisputesPostRequestFormEvidenceCustomerDeviceFinger9c71X58ed18ee internal constructor(
    ...
    private val inspection: InlineV1DisputesPostRequestFormEvidenceCustomerDeviceFinger9c71X58ed18eeInspection,
) {
    ...
    public val inlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2X56de6f49:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2X56de6f49) {
                json
                    .decodeFromJsonElement<InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2X56de6f49>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1DisputesPostRequestFormEvidenceCustomerDeviceFinger9c71X58ed18eeBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2X56de6f49) {
                    add(
                        InlineV1DisputesPostRequestFormEvidenceCustomerDeviceFinger9c71X58ed18eeBranch.InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2X56de6f49,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1DisputesPostRequestFormEvidenceCustomerDeviceFinger9c71X58ed18ee {
            val inspection = inspectInlineV1DisputesPostRequestFormEvidenceCustomerDeviceFinger9c71X58ed18ee(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1DisputesPostRequestFormEvidenceCustomerDeviceFinger9c71X58ed18eeNoMatchException(
                    "InlineV1DisputesPostRequestFormEvidenceCustomerDeviceFinger9c71X58ed18ee matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1DisputesPostRequestFormEvidenceCustomerDeviceFinger9c71X58ed18ee> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1DisputesPostRequestFormEvidenceCustomerDeviceFinger9c71X58ed18ee,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1DisputesPostRequestFormEvidenceCustomerDeviceFinger9c71X58ed18ee",
...
private fun inspectInlineV1DisputesPostRequestFormEvidenceCustomerDeviceFinger9c71X58ed18ee(
    element: JsonElement,
): InlineV1DisputesPostRequestFormEvidenceCustomerDeviceFinger9c71X58ed18eeInspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2X56de6f49 =
        element
            .isJsonDecodable<InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2X56de6f49>()
    return InlineV1DisputesPostRequestFormEvidenceCustomerDeviceFinger9c71X58ed18eeInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2X56de6f49) {
                    add(
                        "InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2X56de6f49: value does not match InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2X56de6f49",
                    )
                }
            },
    )
