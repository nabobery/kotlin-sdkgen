...
public class InlineV1CreditNotesPreviewGetParameterItemTaxAmountsAnyOf1ItemX867cec5e(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1CreditNotesPreviewGetParameterItemTaxAmountsAnyOf1ItemX867cec5e = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1CreditNotesPreviewGetParameterItemTaxAmountsAnyOf1ItemX867cec5e> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CreditNotesPreviewGetParameterItemTaxAmountsAnyOf1ItemX867cec5e must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CreditNotesPreviewGetParameterItemTaxAmountsAnyOf1ItemX867cec5e,
        ) {
            val jsonEncoder =
...
public fun inlineV1CreditNotesPreviewGetParameterItemTaxAmountsAnyOf1ItemX867cec5e(
    block: InlineV1CreditNotesPreviewGetParameterItemTaxAmountsAnyOf1ItemX867cec5e.Builder.() -> Unit,
): InlineV1CreditNotesPreviewGetParameterItemTaxAmountsAnyOf1ItemX867cec5e =
    InlineV1CreditNotesPreviewGetParameterItemTaxAmountsAnyOf1ItemX867cec5e.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1CreditNotesPreviewGetParameterItemTaxAmountsAnyOf1ItemX867cec5e is missing required property '" +
                    name +
                    "'",
            )
