...
internal data class InlineV1QuotesPostRequestFormApplicationFeePercentXb102a83eInspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1QuotesPostRequestFormApplicationFeePercentAnyOf2X50339a20,
            ).count { it }
}
...
public class InlineV1QuotesPostRequestFormApplicationFeePercentXb102a83e internal constructor(
    ...
    public val inlineV1QuotesPostRequestFormApplicationFeePercentAnyOf2X50339a20:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1QuotesPostRequestFormApplicationFeePercentAnyOf2X50339a20) {
                json
                    .decodeFromJsonElement<InlineV1QuotesPostRequestFormApplicationFeePercentAnyOf2X50339a20>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1QuotesPostRequestFormApplicationFeePercentXb102a83eBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1QuotesPostRequestFormApplicationFeePercentAnyOf2X50339a20) {
                    add(
                        InlineV1QuotesPostRequestFormApplicationFeePercentXb102a83eBranch.InlineV1QuotesPostRequestFormApplicationFeePercentAnyOf2X50339a20,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1QuotesPostRequestFormApplicationFeePercentXb102a83e {
            val inspection = inspectInlineV1QuotesPostRequestFormApplicationFeePercentXb102a83e(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1QuotesPostRequestFormApplicationFeePercentXb102a83eNoMatchException(
                    "InlineV1QuotesPostRequestFormApplicationFeePercentXb102a83e matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1QuotesPostRequestFormApplicationFeePercentXb102a83e> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1QuotesPostRequestFormApplicationFeePercentXb102a83e,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1QuotesPostRequestFormApplicationFeePercentXb102a83e",
...
private fun inspectInlineV1QuotesPostRequestFormApplicationFeePercentXb102a83e(
    element: JsonElement,
): InlineV1QuotesPostRequestFormApplicationFeePercentXb102a83eInspection {
    val matchesBranch1 = element.isJsonDecodable<Double>()
    val matchesInlineV1QuotesPostRequestFormApplicationFeePercentAnyOf2X50339a20 =
        element
            .isJsonDecodable<InlineV1QuotesPostRequestFormApplicationFeePercentAnyOf2X50339a20>()
    return InlineV1QuotesPostRequestFormApplicationFeePercentXb102a83eInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1QuotesPostRequestFormApplicationFeePercentAnyOf2X50339a20) {
                    add(
                        "InlineV1QuotesPostRequestFormApplicationFeePercentAnyOf2X50339a20: value does not match InlineV1QuotesPostRequestFormApplicationFeePercentAnyOf2X50339a20",
                    )
                }
            },
    )
