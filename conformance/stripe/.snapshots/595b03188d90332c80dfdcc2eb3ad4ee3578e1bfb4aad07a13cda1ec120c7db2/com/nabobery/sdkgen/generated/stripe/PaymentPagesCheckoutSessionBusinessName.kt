...
public class PaymentPagesCheckoutSessionBusinessName(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentPagesCheckoutSessionBusinessName =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentPagesCheckoutSessionBusinessName> {
        ...
        override fun deserialize(decoder: Decoder): PaymentPagesCheckoutSessionBusinessName {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentPagesCheckoutSessionBusinessName must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentPagesCheckoutSessionBusinessName,
        ) {
...
public fun paymentPagesCheckoutSessionBusinessName(
    block: PaymentPagesCheckoutSessionBusinessName.Builder.() -> Unit,
): PaymentPagesCheckoutSessionBusinessName = PaymentPagesCheckoutSessionBusinessName.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "PaymentPagesCheckoutSessionBusinessName is missing required property '" + name + "'",
            )
