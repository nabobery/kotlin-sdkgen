...
public class InlineStackableDiscountWithDiscountSettingsDiscountX14344739 internal constructor(
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineStackableDiscountWithDiscountSettingsDiscountX14344739Branch.Branch1,
                    )
                }
                if (inspection.matchesDiscount) {
                    add(
                        InlineStackableDiscountWithDiscountSettingsDiscountX14344739Branch.Discount,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineStackableDiscountWithDiscountSettingsDiscountX14344739 {
            val inspection = inspectInlineStackableDiscountWithDiscountSettingsDiscountX14344739(raw)
            if (inspection.matchCount == 0) {
                throw InlineStackableDiscountWithDiscountSettingsDiscountX14344739NoMatchException(
                    "InlineStackableDiscountWithDiscountSettingsDiscountX14344739 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineStackableDiscountWithDiscountSettingsDiscountX14344739> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineStackableDiscountWithDiscountSettingsDiscountX14344739,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineStackableDiscountWithDiscountSettingsDiscountX14344739",
...
private fun inspectInlineStackableDiscountWithDiscountSettingsDiscountX14344739(
    element: JsonElement,
): InlineStackableDiscountWithDiscountSettingsDiscountX14344739Inspection {
