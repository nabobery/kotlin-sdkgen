...
public sealed class InlineV1PaymentMethodConfidc49PostRequestFormBlikPreferenceX2e2df19c {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1PaymentMethodConfidc49PostRequestFormBlikPreferenceX2e2df19c =
            when (value) {
                None.value -> None
                Off.value -> Off
                On.value -> On
    ...
    public object Serializer : KSerializer<InlineV1PaymentMethodConfidc49PostRequestFormBlikPreferenceX2e2df19c> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1PaymentMethodConfidc49PostRequestFormBlikPreferenceX2e2df19c",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1PaymentMethodConfidc49PostRequestFormBlikPreferenceX2e2df19c = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentMethodConfidc49PostRequestFormBlikPreferenceX2e2df19c,
        ) {
