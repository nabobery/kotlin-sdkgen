...
public class InlineV1CheckoutSessionsPostRequestFormBillingCycleAnchorConfigX06b36629(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1CheckoutSessionsPostRequestFormBillingCycleAnchorConfigX06b36629 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormBillingCycleAnchorConfigX06b36629> {
        ...
        override fun deserialize(
            decoder: Decoder,
        ): InlineV1CheckoutSessionsPostRequestFormBillingCycleAnchorConfigX06b36629 {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CheckoutSessionsPostRequestFormBillingCycleAnchorConfigX06b36629 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsPostRequestFormBillingCycleAnchorConfigX06b36629,
        ) {
            val jsonEncoder =
...
public fun inlineV1CheckoutSessionsPostRequestFormBillingCycleAnchorConfigX06b36629(
    block: InlineV1CheckoutSessionsPostRequestFormBillingCycleAnchorConfigX06b36629.Builder.() -> Unit,
): InlineV1CheckoutSessionsPostRequestFormBillingCycleAnchorConfigX06b36629 =
    InlineV1CheckoutSessionsPostRequestFormBillingCycleAnchorConfigX06b36629.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1CheckoutSessionsPostRequestFormBillingCycleAnchorConfigX06b36629 is missing required property '" +
                    name +
                    "'",
            )
