...
public class InlineSubscriptionPendingSetupIntentXec0dee4e internal constructor(
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineSubscriptionPendingSetupIntentXec0dee4e {
            val inspection = inspectInlineSubscriptionPendingSetupIntentXec0dee4e(raw)
            if (inspection.matchCount == 0) {
                throw InlineSubscriptionPendingSetupIntentXec0dee4eNoMatchException(
                    "InlineSubscriptionPendingSetupIntentXec0dee4e matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineSubscriptionPendingSetupIntentXec0dee4e> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineSubscriptionPendingSetupIntentXec0dee4e,
        ) {
...
private fun inspectInlineSubscriptionPendingSetupIntentXec0dee4e(
    element: JsonElement,
): InlineSubscriptionPendingSetupIntentXec0dee4eInspection {
