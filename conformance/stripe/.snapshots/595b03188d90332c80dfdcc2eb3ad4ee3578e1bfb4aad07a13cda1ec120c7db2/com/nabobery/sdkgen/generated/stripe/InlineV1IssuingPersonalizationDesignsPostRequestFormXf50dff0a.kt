...
public class InlineV1IssuingPersonalizationDesignsPostRequestFormXf50dff0a(
     ...
     * `issuing_logo`.
     */
    public val cardLogo: InlineV1IssuingPersonalizationDesignsPostRequestFormCardLogoX62138807? = null,
    /**
     * Hash containing carrier text, for use with physical bundles that support carrier text.
     */
    public val carrierText: InlineV1IssuingPersonalizationDesignsPostRequestFormCarrierTextX9bb7bce1? = null,
    /**
     ...
     * characters.
     */
    public val lookupKey: InlineV1IssuingPersonalizationDesignsPostRequestFormLookupKeyX4aa6a7b7? = null,
    /**
     ...
     */
    public val preferences: InlineV1IssuingPersonalizationDesignsPostRequestFormPreferencesX547769ab? = null,
    /**
    ...
    public class Builder {
        ...
        public fun build(): InlineV1IssuingPersonalizationDesignsPostRequestFormXf50dff0a =
            InlineV1IssuingPersonalizationDesignsPostRequestFormXf50dff0a(
                cardLogo = cardLogo,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1IssuingPersonalizationDesignsPostRequestFormXf50dff0a =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1IssuingPersonalizationDesignsPostRequestFormXf50dff0a> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1IssuingPersonalizationDesignsPostRequestFormXf50dff0a must be a JSON object",
                    )
            return InlineV1IssuingPersonalizationDesignsPostRequestFormXf50dff0a(
                cardLogo =
                    rawObject["card_logo"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1IssuingPersonalizationDesignsPostRequestFormCardLogoX62138807>(
                                it,
                            )
                    },
                carrierText =
                    rawObject["carrier_text"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1IssuingPersonalizationDesignsPostRequestFormCarrierTextX9bb7bce1>(
                                it,
                            )
                    },
                expand = rawObject["expand"]?.let { json.decodeFromJsonElement<List<String>>(it) },
                lookupKey =
                    rawObject["lookup_key"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1IssuingPersonalizationDesignsPostRequestFormLookupKeyX4aa6a7b7>(
                                it,
                            )
                    },
                ...
                name =
                    rawObject["name"]?.let {
                        json.decodeFromJsonElement<InlineV1IssuingPersonalizationDesignsPostRequestFormNameX8857536b>(
                            it,
                        )
                    },
                ...
                preferences =
                    rawObject["preferences"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1IssuingPersonalizationDesignsPostRequestFormPreferencesX547769ab>(
                                it,
                            )
                    },
                transferLookupKey =
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingPersonalizationDesignsPostRequestFormXf50dff0a,
        ) {
            val jsonEncoder =
...
public fun inlineV1IssuingPersonalizationDesignsPostRequestFormXf50dff0a(
    block: InlineV1IssuingPersonalizationDesignsPostRequestFormXf50dff0a.Builder.() -> Unit,
): InlineV1IssuingPersonalizationDesignsPostRequestFormXf50dff0a =
    InlineV1IssuingPersonalizationDesignsPostRequestFormXf50dff0a.build(block)
