...
public class InlineCreditNoteCustomerBalanceTransactionX7d3546fb internal constructor(
    ...
    public val customerBalanceTransaction: CustomerBalanceTransaction? by
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesCustomerBalanceTransaction) {
                json.decodeFromJsonElement<CustomerBalanceTransaction>(
                    raw,
                )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineCreditNoteCustomerBalanceTransactionX7d3546fbBranch>
        get() =
            buildSet {
                ...
                if (inspection.matchesCustomerBalanceTransaction) {
                    add(
                        InlineCreditNoteCustomerBalanceTransactionX7d3546fbBranch.CustomerBalanceTransaction,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineCreditNoteCustomerBalanceTransactionX7d3546fb {
            val inspection = inspectInlineCreditNoteCustomerBalanceTransactionX7d3546fb(raw)
            if (inspection.matchCount == 0) {
                throw InlineCreditNoteCustomerBalanceTransactionX7d3546fbNoMatchException(
                    "InlineCreditNoteCustomerBalanceTransactionX7d3546fb matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineCreditNoteCustomerBalanceTransactionX7d3546fb> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineCreditNoteCustomerBalanceTransactionX7d3546fb,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineCreditNoteCustomerBalanceTransactionX7d3546fb",
...
private fun inspectInlineCreditNoteCustomerBalanceTransactionX7d3546fb(
    element: JsonElement,
): InlineCreditNoteCustomerBalanceTransactionX7d3546fbInspection {
    ...
    return InlineCreditNoteCustomerBalanceTransactionX7d3546fbInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesCustomerBalanceTransaction) {
                    add(
                        "CustomerBalanceTransaction: value does not match CustomerBalanceTransaction",
                    )
                }
            },
    )
