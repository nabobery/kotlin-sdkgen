...
internal data class InlineV1AccountsPostRequestFormGroupsPaymentsPricingX8830e40eInspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1AccountsPostRequestFormGroupsPaymentsPricingAnyOf2X59d54aba,
            ).count { it }
}
...
public class InlineV1AccountsPostRequestFormGroupsPaymentsPricingX8830e40e internal constructor(
    ...
    public val inlineV1AccountsPostRequestFormGroupsPaymentsPricingAnyOf2X59d54aba:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1AccountsPostRequestFormGroupsPaymentsPricingAnyOf2X59d54aba) {
                json
                    .decodeFromJsonElement<InlineV1AccountsPostRequestFormGroupsPaymentsPricingAnyOf2X59d54aba>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1AccountsPostRequestFormGroupsPaymentsPricingX8830e40eBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1AccountsPostRequestFormGroupsPaymentsPricingAnyOf2X59d54aba) {
                    add(
                        InlineV1AccountsPostRequestFormGroupsPaymentsPricingX8830e40eBranch.InlineV1AccountsPostRequestFormGroupsPaymentsPricingAnyOf2X59d54aba,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1AccountsPostRequestFormGroupsPaymentsPricingX8830e40e {
            val inspection = inspectInlineV1AccountsPostRequestFormGroupsPaymentsPricingX8830e40e(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1AccountsPostRequestFormGroupsPaymentsPricingX8830e40eNoMatchException(
                    "InlineV1AccountsPostRequestFormGroupsPaymentsPricingX8830e40e matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1AccountsPostRequestFormGroupsPaymentsPricingX8830e40e> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPostRequestFormGroupsPaymentsPricingX8830e40e,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1AccountsPostRequestFormGroupsPaymentsPricingX8830e40e",
...
private fun inspectInlineV1AccountsPostRequestFormGroupsPaymentsPricingX8830e40e(
    element: JsonElement,
): InlineV1AccountsPostRequestFormGroupsPaymentsPricingX8830e40eInspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1AccountsPostRequestFormGroupsPaymentsPricingAnyOf2X59d54aba =
        element
            .isJsonDecodable<InlineV1AccountsPostRequestFormGroupsPaymentsPricingAnyOf2X59d54aba>()
    return InlineV1AccountsPostRequestFormGroupsPaymentsPricingX8830e40eInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1AccountsPostRequestFormGroupsPaymentsPricingAnyOf2X59d54aba) {
                    add(
                        "InlineV1AccountsPostRequestFormGroupsPaymentsPricingAnyOf2X59d54aba: value does not match InlineV1AccountsPostRequestFormGroupsPaymentsPricingAnyOf2X59d54aba",
                    )
                }
            },
    )
