...
public class TreasuryFinancialAccount(
     ...
     */
    public val activeFeatures: List<InlineTreasuryFinancialAccountActiveFeaturesItemXace1f2bf>? = null,
     ...
     */
    public val pendingFeatures: List<InlineTreasuryFinancialAccountPendingFeaturesItemXf9eb56f9>? = null,
    /**
     * The set of functionalities that the platform can restrict on the FinancialAccount.
     */
    public val platformRestrictions: InlineTreasuryFinancialAccountPlatformRestrictionsXaa010d7e? = null,
    /**
     * The array of paths to restricted Features in the Features hash.
     */
    public val restrictedFeatures: List<InlineTreasuryFinancialAccountRestrictedFeaturesItemX253bcc21>? = null,
) {
    /**
    ...
    public object Serializer : KSerializer<TreasuryFinancialAccount> {
        ...
        override fun deserialize(decoder: Decoder): TreasuryFinancialAccount {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("TreasuryFinancialAccount must be a JSON object")
            ...
            val financialAddresses =
                json.decodeRequired<List<TreasuryFinancialAccountsResourceFinancialAddress>>(
                    rawObject,
                    "financial_addresses",
                )
            ...
            val objectValue =
                json.decodeRequired<InlineTreasuryFinancialAccountObjectValueX02ce063d>(
                    rawObject,
                    "object",
                )
            val status = json.decodeRequired<InlineTreasuryFinancialAccountStatusX91b48cf5>(rawObject, "status")
            val statusDetails =
                json.decodeRequired<TreasuryFinancialAccountsResourceStatusDetails>(
                    rawObject,
                    "status_details",
                )
            ...
            return TreasuryFinancialAccount(
                ...
                supportedCurrencies = supportedCurrencies,
                activeFeatures =
                    rawObject["active_features"]?.let {
                        json.decodeFromJsonElement<List<InlineTreasuryFinancialAccountActiveFeaturesItemXace1f2bf>>(it)
                    },
                features =
                    rawObject["features"]?.let {
                        json
                            .decodeFromJsonElement<TreasuryFinancialAccountFeatures>(
                                it,
                            )
                    },
                ...
                nickname =
                    rawObject["nickname"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                pendingFeatures =
                    rawObject["pending_features"]?.let {
                        json.decodeFromJsonElement<List<InlineTreasuryFinancialAccountPendingFeaturesItemXf9eb56f9>>(it)
                    },
                platformRestrictions =
                    rawObject["platform_restrictions"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineTreasuryFinancialAccountPlatformRestrictionsXaa010d7e?>(
                                element,
                            )
                        }
                    },
                restrictedFeatures =
                    rawObject["restricted_features"]?.let {
                        json.decodeFromJsonElement<List<InlineTreasuryFinancialAccountRestrictedFeaturesItemX253bcc21>>(
                            it,
                        )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: TreasuryFinancialAccount,
        ) {
...
public fun treasuryFinancialAccount(block: TreasuryFinancialAccount.Builder.() -> Unit): TreasuryFinancialAccount =
    TreasuryFinancialAccount.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException("TreasuryFinancialAccount is missing required property '" + name + "'")
