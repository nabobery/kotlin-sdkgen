...
public class InlineV1BillingCreditGrantsPostRequestFormAmountXadaed654(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1BillingCreditGrantsPostRequestFormAmountXadaed654 =
    ...
    public object Serializer : KSerializer<InlineV1BillingCreditGrantsPostRequestFormAmountXadaed654> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1BillingCreditGrantsPostRequestFormAmountXadaed654 must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineV1BillingCreditGrantsPostRequestFormAmountTypeXc982cfc0>(
                    rawObject,
                    "type",
                )
            return InlineV1BillingCreditGrantsPostRequestFormAmountXadaed654(
                type = type,
                monetary =
                    rawObject["monetary"]?.let {
                        json.decodeFromJsonElement<InlineV1BillingCreditGrantsPostRequestFormAmountMonetaryXbe225a3e>(
                            it,
                        )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1BillingCreditGrantsPostRequestFormAmountXadaed654,
        ) {
...
public fun inlineV1BillingCreditGrantsPostRequestFormAmountXadaed654(
    block: InlineV1BillingCreditGrantsPostRequestFormAmountXadaed654.Builder.() -> Unit,
): InlineV1BillingCreditGrantsPostRequestFormAmountXadaed654 =
    InlineV1BillingCreditGrantsPostRequestFormAmountXadaed654.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1BillingCreditGrantsPostRequestFormAmountXadaed654 is missing required property '" + name + "'",
            )
