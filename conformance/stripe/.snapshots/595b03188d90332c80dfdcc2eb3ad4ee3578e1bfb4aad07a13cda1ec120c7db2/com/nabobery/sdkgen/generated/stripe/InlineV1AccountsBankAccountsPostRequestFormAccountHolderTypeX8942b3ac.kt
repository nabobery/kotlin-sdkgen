...
public sealed class InlineV1AccountsBankAccountsPostRequestFormAccountHolderTypeX8942b3ac {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1AccountsBankAccountsPostRequestFormAccountHolderTypeX8942b3ac =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1AccountsBankAccountsPostRequestFormAccountHolderTypeX8942b3ac> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1AccountsBankAccountsPostRequestFormAccountHolderTypeX8942b3ac",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1AccountsBankAccountsPostRequestFormAccountHolderTypeX8942b3ac = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsBankAccountsPostRequestFormAccountHolderTypeX8942b3ac,
        ) {
