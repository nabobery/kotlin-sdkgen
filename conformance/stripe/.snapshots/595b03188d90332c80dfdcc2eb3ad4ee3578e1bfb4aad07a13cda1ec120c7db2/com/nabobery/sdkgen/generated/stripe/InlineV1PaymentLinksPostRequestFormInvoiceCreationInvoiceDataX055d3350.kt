...
public class InlineV1PaymentLinksPostRequestFormInvoiceCreationInvoiceDataX055d3350(
    public val accountTaxIds: InlineV1PaymentLinksPostRequestFormInvoiceCreationAccountTaxIdsX009d863a? = null,
    public val customFields: InlineV1PaymentLinksPostRequestFormInvoiceCreationCustomFieldsX660b36ec? = null,
    public val description: String? = null,
    public val footer: String? = null,
    public val issuer: InlineV1PaymentLinksPostRequestFormInvoiceCreationInvoiceDataIssuerX61ba7d6f? = null,
    public val metadata: InlineV1PaymentLinksPostRequestFormInvoiceCreationInvoiceDataMetadataX4aee9872? = null,
    public val renderingOptions: InlineV1PaymentLinksPostRequestFormInvoiceCreationRenderingOptionsX72601b56? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1PaymentLinksPostRequestFormInvoiceCreationInvoiceDataX055d3350 =
            InlineV1PaymentLinksPostRequestFormInvoiceCreationInvoiceDataX055d3350(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentLinksPostRequestFormInvoiceCreationInvoiceDataX055d3350 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1PaymentLinksPostRequestFormInvoiceCreationInvoiceDataX055d3350> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentLinksPostRequestFormInvoiceCreationInvoiceDataX055d3350 must be a JSON object",
                    )
            return InlineV1PaymentLinksPostRequestFormInvoiceCreationInvoiceDataX055d3350(
                accountTaxIds =
                    rawObject["account_tax_ids"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormInvoiceCreationAccountTaxIdsX009d863a>(
                                it,
                            )
                    },
                customFields =
                    rawObject["custom_fields"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormInvoiceCreationCustomFieldsX660b36ec>(
                                it,
                            )
                    },
                ...
                issuer =
                    rawObject["issuer"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormInvoiceCreationInvoiceDataIssuerX61ba7d6f>(
                                it,
                            )
                    },
                metadata =
                    rawObject["metadata"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormInvoiceCreationInvoiceDataMetadataX4aee9872>(
                                it,
                            )
                    },
                renderingOptions =
                    rawObject["rendering_options"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormInvoiceCreationRenderingOptionsX72601b56>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentLinksPostRequestFormInvoiceCreationInvoiceDataX055d3350,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentLinksPostRequestFormInvoiceCreationInvoiceDataX055d3350(
    block: InlineV1PaymentLinksPostRequestFormInvoiceCreationInvoiceDataX055d3350.Builder.() -> Unit,
): InlineV1PaymentLinksPostRequestFormInvoiceCreationInvoiceDataX055d3350 =
    InlineV1PaymentLinksPostRequestFormInvoiceCreationInvoiceDataX055d3350.build(block)
