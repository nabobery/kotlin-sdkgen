...
public class PaymentMethodDetailsCardPresentOffline(
    ...
    public class Builder {
        ...
        public fun build(): PaymentMethodDetailsCardPresentOffline =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentMethodDetailsCardPresentOffline =
    ...
    public object Serializer : KSerializer<PaymentMethodDetailsCardPresentOffline> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodDetailsCardPresentOffline {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodDetailsCardPresentOffline must be a JSON object")
            return PaymentMethodDetailsCardPresentOffline(
                storedAt =
                    rawObject["stored_at"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                type =
                    rawObject["type"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentMethodDetailsCardPresentOfflineTypeX41dcb4b8?>(
                                element,
                            )
                        }
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentMethodDetailsCardPresentOffline,
        ) {
...
public fun paymentMethodDetailsCardPresentOffline(
    block: PaymentMethodDetailsCardPresentOffline.Builder.() -> Unit,
): PaymentMethodDetailsCardPresentOffline = PaymentMethodDetailsCardPresentOffline.build(block)
