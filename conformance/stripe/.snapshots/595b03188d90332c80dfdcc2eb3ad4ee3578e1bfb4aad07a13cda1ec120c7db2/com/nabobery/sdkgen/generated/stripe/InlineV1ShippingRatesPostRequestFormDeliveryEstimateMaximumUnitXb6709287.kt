...
public sealed class InlineV1ShippingRatesPostRequestFormDeliveryEstimateMaximumUnitXb6709287 {
    ...
    public object Serializer : KSerializer<InlineV1ShippingRatesPostRequestFormDeliveryEstimateMaximumUnitXb6709287> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1ShippingRatesPostRequestFormDeliveryEstimateMaximumUnitXb6709287",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1ShippingRatesPostRequestFormDeliveryEstimateMaximumUnitXb6709287 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ShippingRatesPostRequestFormDeliveryEstimateMaximumUnitXb6709287,
        ) {
