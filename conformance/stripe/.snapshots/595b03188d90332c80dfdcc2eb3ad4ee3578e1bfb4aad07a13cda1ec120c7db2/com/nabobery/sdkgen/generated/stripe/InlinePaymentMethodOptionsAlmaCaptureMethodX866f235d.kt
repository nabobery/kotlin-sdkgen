...
public sealed class InlinePaymentMethodOptionsAlmaCaptureMethodX866f235d {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentMethodOptionsAlmaCaptureMethodX866f235d =
            when (value) {
                Manual.value -> Manual
    ...
    public object Serializer : KSerializer<InlinePaymentMethodOptionsAlmaCaptureMethodX866f235d> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentMethodOptionsAlmaCaptureMethodX866f235d",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePaymentMethodOptionsAlmaCaptureMethodX866f235d =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentMethodOptionsAlmaCaptureMethodX866f235d,
        ) {
