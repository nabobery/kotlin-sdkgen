...
public class Card(
    ...
    public class Builder {
         ...
         * creating a payout.
         */
        public var availablePayoutMethods: List<InlineCardAvailablePayoutMethodsItemX6e61c572>? = null
        ...
        override fun deserialize(decoder: Decoder): Card {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("Card must be a JSON object")
            ...
            return Card(
                ...
                account =
                    rawObject["account"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineCardAccountX33cfa039?>(element)
                        }
                    },
                addressCity =
                    rawObject["address_city"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                addressCountry =
                    rawObject["address_country"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                addressLine1 =
                    rawObject["address_line1"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                addressLine1Check =
                    rawObject["address_line1_check"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                addressLine2 =
                    rawObject["address_line2"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                addressState =
                    rawObject["address_state"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                addressZip =
                    rawObject["address_zip"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                addressZipCheck =
                    rawObject["address_zip_check"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                allowRedisplay =
                    rawObject["allow_redisplay"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineCardAllowRedisplayXd3d09a26?>(element)
                        }
                    },
                availablePayoutMethods =
                    rawObject["available_payout_methods"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<List<InlineCardAvailablePayoutMethodsItemX6e61c572>?>(element)
                        }
                    },
                country =
                ...
                customer =
                    rawObject["customer"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineCardCustomerXcfc00c51?>(element)
                        }
                    },
                cvcCheck =
                    rawObject["cvc_check"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                regulatedStatus =
                    rawObject["regulated_status"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineCardRegulatedStatusX7571d715?>(element)
                        }
                    },
                status =
                ...
                tokenizationMethod =
                    rawObject["tokenization_method"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
