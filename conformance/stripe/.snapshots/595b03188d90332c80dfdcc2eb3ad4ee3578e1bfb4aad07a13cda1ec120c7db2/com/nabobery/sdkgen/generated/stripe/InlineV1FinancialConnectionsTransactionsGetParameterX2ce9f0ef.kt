...
internal data class InlineV1FinancialConnectionsTransactionsGetParameterX2ce9f0efInspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesInlineV1FinancialConnectionsTransactionsGetParameterAnyOf1X3a34dfc8,
                matchesBranch2,
            ).count { it }
}
...
public class InlineV1FinancialConnectionsTransactionsGetParameterX2ce9f0ef internal constructor(
    ...
    public val inlineV1FinancialConnectionsTransactionsGetParameterAnyOf1X3a34dfc8:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1FinancialConnectionsTransactionsGetParameterAnyOf1X3a34dfc8) {
                json
                    .decodeFromJsonElement<InlineV1FinancialConnectionsTransactionsGetParameterAnyOf1X3a34dfc8>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches:
        ...
        get() =
            buildSet {
                if (inspection.matchesInlineV1FinancialConnectionsTransactionsGetParameterAnyOf1X3a34dfc8) {
                    add(
                        InlineV1FinancialConnectionsTransactionsGetParameterX2ce9f0efBranch.InlineV1FinancialConnectionsTransactionsGetParameterAnyOf1X3a34dfc8,
                    )
                }
                if (inspection.matchesBranch2) {
                    add(
                        InlineV1FinancialConnectionsTransactionsGetParameterX2ce9f0efBranch.Branch2,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1FinancialConnectionsTransactionsGetParameterX2ce9f0ef {
            val inspection = inspectInlineV1FinancialConnectionsTransactionsGetParameterX2ce9f0ef(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1FinancialConnectionsTransactionsGetParameterX2ce9f0efNoMatchException(
                    "InlineV1FinancialConnectionsTransactionsGetParameterX2ce9f0ef matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1FinancialConnectionsTransactionsGetParameterX2ce9f0ef> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1FinancialConnectionsTransactionsGetParameterX2ce9f0ef,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1FinancialConnectionsTransactionsGetParameterX2ce9f0ef",
...
private fun inspectInlineV1FinancialConnectionsTransactionsGetParameterX2ce9f0ef(
    element: JsonElement,
): InlineV1FinancialConnectionsTransactionsGetParameterX2ce9f0efInspection {
    val matchesInlineV1FinancialConnectionsTransactionsGetParameterAnyOf1X3a34dfc8 =
        element
            .isJsonDecodable<InlineV1FinancialConnectionsTransactionsGetParameterAnyOf1X3a34dfc8>()
    ...
    return InlineV1FinancialConnectionsTransactionsGetParameterX2ce9f0efInspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1FinancialConnectionsTransactionsGetParameterAnyOf1X3a34dfc8) {
                    add(
                        "InlineV1FinancialConnectionsTransactionsGetParameterAnyOf1X3a34dfc8: value does not match InlineV1FinancialConnectionsTransactionsGetParameterAnyOf1X3a34dfc8",
                    )
                }
