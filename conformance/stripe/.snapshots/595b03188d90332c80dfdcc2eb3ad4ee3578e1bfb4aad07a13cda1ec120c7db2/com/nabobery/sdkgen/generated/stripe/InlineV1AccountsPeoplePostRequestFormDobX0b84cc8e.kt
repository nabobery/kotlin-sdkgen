...
internal data class InlineV1AccountsPeoplePostRequestFormDobX0b84cc8eInspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesInlineV1AccountsPeoplePostRequestFormDobAnyOf1Xfb635ae2,
                matchesInlineV1AccountsPeoplePostRequestFormDobAnyOf2Xb3a12dca,
            ).count {
                it
            }
}
...
public class InlineV1AccountsPeoplePostRequestFormDobX0b84cc8e internal constructor(
    ...
    public val inlineV1AccountsPeoplePostRequestFormDobAnyOf1Xfb635ae2:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1AccountsPeoplePostRequestFormDobAnyOf1Xfb635ae2) {
                json
                    .decodeFromJsonElement<InlineV1AccountsPeoplePostRequestFormDobAnyOf1Xfb635ae2>(
                        raw,
                    )
            } else {
                null
    ...
    public val inlineV1AccountsPeoplePostRequestFormDobAnyOf2Xb3a12dca:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1AccountsPeoplePostRequestFormDobAnyOf2Xb3a12dca) {
                json
                    .decodeFromJsonElement<InlineV1AccountsPeoplePostRequestFormDobAnyOf2Xb3a12dca>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1AccountsPeoplePostRequestFormDobX0b84cc8eBranch>
        get() =
            buildSet {
                if (inspection.matchesInlineV1AccountsPeoplePostRequestFormDobAnyOf1Xfb635ae2) {
                    add(
                        InlineV1AccountsPeoplePostRequestFormDobX0b84cc8eBranch.InlineV1AccountsPeoplePostRequestFormDobAnyOf1Xfb635ae2,
                    )
                }
                if (inspection.matchesInlineV1AccountsPeoplePostRequestFormDobAnyOf2Xb3a12dca) {
                    add(
                        InlineV1AccountsPeoplePostRequestFormDobX0b84cc8eBranch.InlineV1AccountsPeoplePostRequestFormDobAnyOf2Xb3a12dca,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1AccountsPeoplePostRequestFormDobX0b84cc8e {
            val inspection = inspectInlineV1AccountsPeoplePostRequestFormDobX0b84cc8e(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1AccountsPeoplePostRequestFormDobX0b84cc8eNoMatchException(
                    "InlineV1AccountsPeoplePostRequestFormDobX0b84cc8e matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1AccountsPeoplePostRequestFormDobX0b84cc8e> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPeoplePostRequestFormDobX0b84cc8e,
        ) {
...
private fun inspectInlineV1AccountsPeoplePostRequestFormDobX0b84cc8e(
    element: JsonElement,
): InlineV1AccountsPeoplePostRequestFormDobX0b84cc8eInspection {
    val matchesInlineV1AccountsPeoplePostRequestFormDobAnyOf1Xfb635ae2 =
        element
            .isJsonDecodable<InlineV1AccountsPeoplePostRequestFormDobAnyOf1Xfb635ae2>()
    val matchesInlineV1AccountsPeoplePostRequestFormDobAnyOf2Xb3a12dca =
        element
            .isJsonDecodable<InlineV1AccountsPeoplePostRequestFormDobAnyOf2Xb3a12dca>()
    return InlineV1AccountsPeoplePostRequestFormDobX0b84cc8eInspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1AccountsPeoplePostRequestFormDobAnyOf1Xfb635ae2) {
                    add(
                        "InlineV1AccountsPeoplePostRequestFormDobAnyOf1Xfb635ae2: value does not match InlineV1AccountsPeoplePostRequestFormDobAnyOf1Xfb635ae2",
                    )
                }
                if (!matchesInlineV1AccountsPeoplePostRequestFormDobAnyOf2Xb3a12dca) {
                    add(
                        "InlineV1AccountsPeoplePostRequestFormDobAnyOf2Xb3a12dca: value does not match InlineV1AccountsPeoplePostRequestFormDobAnyOf2Xb3a12dca",
                    )
                }
            },
    )
