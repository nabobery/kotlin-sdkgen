...
public class InlineV1TransfersPostRequestFormMetadataXaaa4058b internal constructor(
    ...
    public val inlineV1TransfersPostRequestFormMetadataAnyOf2X76d5e619:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1TransfersPostRequestFormMetadataAnyOf2X76d5e619) {
                json
                    .decodeFromJsonElement<InlineV1TransfersPostRequestFormMetadataAnyOf2X76d5e619>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1TransfersPostRequestFormMetadataXaaa4058bBranch>
        get() =
            buildSet {
                ...
                if (inspection.matchesInlineV1TransfersPostRequestFormMetadataAnyOf2X76d5e619) {
                    add(
                        InlineV1TransfersPostRequestFormMetadataXaaa4058bBranch.InlineV1TransfersPostRequestFormMetadataAnyOf2X76d5e619,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1TransfersPostRequestFormMetadataXaaa4058b {
            val inspection = inspectInlineV1TransfersPostRequestFormMetadataXaaa4058b(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1TransfersPostRequestFormMetadataXaaa4058bNoMatchException(
                    "InlineV1TransfersPostRequestFormMetadataXaaa4058b matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1TransfersPostRequestFormMetadataXaaa4058b> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TransfersPostRequestFormMetadataXaaa4058b,
        ) {
...
private fun inspectInlineV1TransfersPostRequestFormMetadataXaaa4058b(
    element: JsonElement,
): InlineV1TransfersPostRequestFormMetadataXaaa4058bInspection {
    val matchesBranch1 = element.isJsonDecodable<JsonObject>()
    val matchesInlineV1TransfersPostRequestFormMetadataAnyOf2X76d5e619 =
        element
            .isJsonDecodable<InlineV1TransfersPostRequestFormMetadataAnyOf2X76d5e619>()
    return InlineV1TransfersPostRequestFormMetadataXaaa4058bInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1TransfersPostRequestFormMetadataAnyOf2X76d5e619) {
                    add(
                        "InlineV1TransfersPostRequestFormMetadataAnyOf2X76d5e619: value does not match InlineV1TransfersPostRequestFormMetadataAnyOf2X76d5e619",
                    )
                }
            },
    )
