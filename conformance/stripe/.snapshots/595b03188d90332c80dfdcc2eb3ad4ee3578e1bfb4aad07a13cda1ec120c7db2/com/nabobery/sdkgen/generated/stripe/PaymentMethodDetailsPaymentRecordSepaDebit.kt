...
public class PaymentMethodDetailsPaymentRecordSepaDebit(
    ...
    public class Builder {
        ...
        public fun build(): PaymentMethodDetailsPaymentRecordSepaDebit =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentMethodDetailsPaymentRecordSepaDebit =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentMethodDetailsPaymentRecordSepaDebit> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodDetailsPaymentRecordSepaDebit {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodDetailsPaymentRecordSepaDebit must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentMethodDetailsPaymentRecordSepaDebit,
        ) {
...
public fun paymentMethodDetailsPaymentRecordSepaDebit(
    block: PaymentMethodDetailsPaymentRecordSepaDebit.Builder.() -> Unit,
): PaymentMethodDetailsPaymentRecordSepaDebit = PaymentMethodDetailsPaymentRecordSepaDebit.build(block)
