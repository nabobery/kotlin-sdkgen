...
public class InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsMandateOptionsX0373296a(
    ...
    public val amountIncludesIof: InlineV1PaymentIntentsPostRequestFormAmountIncludesIofXba2e4b5e? = null,
    public val amountType: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPixAmountTypeX5e5ac69e? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsMandateOptionsX0373296a =
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsMandateOptionsX0373296a> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsMandateOptionsX0373296a must be a JSON object",
                    )
            return InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsMandateOptionsX0373296a(
                ...
                amountIncludesIof =
                    rawObject["amount_includes_iof"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormAmountIncludesIofXba2e4b5e>(it)
                    },
                amountType =
                    rawObject["amount_type"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPixAmountTypeX5e5ac69e>(
                                it,
                            )
                    },
                ...
                paymentSchedule =
                    rawObject["payment_schedule"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentScheduleX43407eeb>(it)
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsMandateOptionsX0373296a,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsMandateOptionsX0373296a(
    block: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsMandateOptionsX0373296a.Builder.() -> Unit,
): InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsMandateOptionsX0373296a =
    InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsMandateOptionsX0373296a.build(block)
