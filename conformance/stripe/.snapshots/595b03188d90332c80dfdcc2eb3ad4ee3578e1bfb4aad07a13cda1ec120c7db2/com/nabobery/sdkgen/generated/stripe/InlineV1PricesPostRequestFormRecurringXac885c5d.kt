...
public class InlineV1PricesPostRequestFormRecurringXac885c5d(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PricesPostRequestFormRecurringXac885c5d =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PricesPostRequestFormRecurringXac885c5d> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PricesPostRequestFormRecurringXac885c5d must be a JSON object",
                    )
            val interval =
                json.decodeRequired<InlineV1PricesPostRequestFormRecurringIntervalX60c57f03>(
                    rawObject,
                    "interval",
                )
            return InlineV1PricesPostRequestFormRecurringXac885c5d(
                ...
                usageType =
                    rawObject["usage_type"]?.let {
                        json.decodeFromJsonElement<InlineV1PricesPostRequestFormRecurringUsageTypeX9603cce3>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PricesPostRequestFormRecurringXac885c5d,
        ) {
...
public fun inlineV1PricesPostRequestFormRecurringXac885c5d(
    block: InlineV1PricesPostRequestFormRecurringXac885c5d.Builder.() -> Unit,
): InlineV1PricesPostRequestFormRecurringXac885c5d = InlineV1PricesPostRequestFormRecurringXac885c5d.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PricesPostRequestFormRecurringXac885c5d is missing required property '" + name + "'",
            )
