...
public class PaymentMethodOptionsKrCard(
    ...
    public class Builder {
        ...
        public fun build(): PaymentMethodOptionsKrCard =
    ...
    public object Serializer : KSerializer<PaymentMethodOptionsKrCard> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodOptionsKrCard {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodOptionsKrCard must be a JSON object")
            return PaymentMethodOptionsKrCard(
                captureMethod =
                    rawObject["capture_method"]?.let {
                        json.decodeFromJsonElement<InlinePaymentMethodOptionsKrCardCaptureMethodX17e718bc>(it)
                    },
                setupFutureUsage =
                    rawObject["setup_future_usage"]?.let {
                        json.decodeFromJsonElement<InlinePaymentMethodOptionsKrCardSetupFutureUsageX997f5f3a>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentMethodOptionsKrCard,
        ) {
...
public fun paymentMethodOptionsKrCard(
    block: PaymentMethodOptionsKrCard.Builder.() -> Unit,
): PaymentMethodOptionsKrCard = PaymentMethodOptionsKrCard.build(block)
