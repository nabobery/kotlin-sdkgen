...
public class TaxProductRegistrationsResourceCountryOptionsDefaultInboundGoods(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): TaxProductRegistrationsResourceCountryOptionsDefaultInboundGoods =
    ...
    public object Serializer : KSerializer<TaxProductRegistrationsResourceCountryOptionsDefaultInboundGoods> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "TaxProductRegistrationsResourceCountryOptionsDefaultInboundGoods must be a JSON object",
                    )
            ...
            return TaxProductRegistrationsResourceCountryOptionsDefaultInboundGoods(
                ...
                standard =
                    rawObject["standard"]?.let {
                        json.decodeFromJsonElement<TaxProductRegistrationsResourceCountryOptionsDefaultStandard>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: TaxProductRegistrationsResourceCountryOptionsDefaultInboundGoods,
        ) {
            val jsonEncoder =
...
public fun taxProductRegistrationsResourceCountryOptionsDefaultInboundGoods(
    block: TaxProductRegistrationsResourceCountryOptionsDefaultInboundGoods.Builder.() -> Unit,
): TaxProductRegistrationsResourceCountryOptionsDefaultInboundGoods =
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "TaxProductRegistrationsResourceCountryOptionsDefaultInboundGoods is missing required property '" + name +
                    "'",
            )
