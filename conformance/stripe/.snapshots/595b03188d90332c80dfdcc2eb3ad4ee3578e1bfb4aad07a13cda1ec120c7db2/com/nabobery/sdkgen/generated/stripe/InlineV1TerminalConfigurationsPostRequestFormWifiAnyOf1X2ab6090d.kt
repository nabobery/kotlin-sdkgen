...
public class InlineV1TerminalConfigurationsPostRequestFormWifiAnyOf1X2ab6090d(
    ...
    public val enterpriseEapPeap: InlineV1TerminalConfigurationsPostRequestFormWifiEnterpriseEapPeapX7d53e38e? = null,
    public val enterpriseEapTls: InlineV1TerminalConfigurationsPostRequestFormWifiAnyOf1EnterpriseEapTlsX6e01ac54? = null,
    public val personalPsk: InlineV1TerminalConfigurationsPostRequestFormWifiAnyOf1PersonalPskXa64e96c8? = null,
) {
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TerminalConfigurationsPostRequestFormWifiAnyOf1X2ab6090d =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TerminalConfigurationsPostRequestFormWifiAnyOf1X2ab6090d> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TerminalConfigurationsPostRequestFormWifiAnyOf1X2ab6090d must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineV1TerminalConfigurationsPostRequestFormWifiAnyOf1TypeXee52254e>(
                    rawObject,
                    "type",
                )
            return InlineV1TerminalConfigurationsPostRequestFormWifiAnyOf1X2ab6090d(
                ...
                enterpriseEapPeap =
                    rawObject["enterprise_eap_peap"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormWifiEnterpriseEapPeapX7d53e38e>(
                                it,
                            )
                    },
                enterpriseEapTls =
                    rawObject["enterprise_eap_tls"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormWifiAnyOf1EnterpriseEapTlsX6e01ac54>(
                                it,
                            )
                    },
                personalPsk =
                    rawObject["personal_psk"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormWifiAnyOf1PersonalPskXa64e96c8>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TerminalConfigurationsPostRequestFormWifiAnyOf1X2ab6090d,
        ) {
            val jsonEncoder =
...
public fun inlineV1TerminalConfigurationsPostRequestFormWifiAnyOf1X2ab6090d(
    block: InlineV1TerminalConfigurationsPostRequestFormWifiAnyOf1X2ab6090d.Builder.() -> Unit,
): InlineV1TerminalConfigurationsPostRequestFormWifiAnyOf1X2ab6090d =
    InlineV1TerminalConfigurationsPostRequestFormWifiAnyOf1X2ab6090d.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TerminalConfigurationsPostRequestFormWifiAnyOf1X2ab6090d is missing required property '" + name +
                    "'",
            )
