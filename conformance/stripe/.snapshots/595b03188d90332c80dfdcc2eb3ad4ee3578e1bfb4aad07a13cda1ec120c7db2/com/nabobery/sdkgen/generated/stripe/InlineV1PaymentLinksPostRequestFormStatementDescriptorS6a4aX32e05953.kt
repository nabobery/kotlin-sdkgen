...
internal data class InlineV1PaymentLinksPostRequestFormStatementDescriptorS6a4aX32e05953Inspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1PaymentLinksPostRequestFormPaymentIntentDataAnyOf2Xe7076a00,
            ).count { it }
}
...
public class InlineV1PaymentLinksPostRequestFormStatementDescriptorS6a4aX32e05953 internal constructor(
    ...
    private val inspection: InlineV1PaymentLinksPostRequestFormStatementDescriptorS6a4aX32e05953Inspection,
) {
    ...
    public val inlineV1PaymentLinksPostRequestFormPaymentIntentDataAnyOf2Xe7076a00:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1PaymentLinksPostRequestFormPaymentIntentDataAnyOf2Xe7076a00) {
                json
                    .decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormPaymentIntentDataAnyOf2Xe7076a00>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1PaymentLinksPostRequestFormStatementDescriptorS6a4aX32e05953Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1PaymentLinksPostRequestFormPaymentIntentDataAnyOf2Xe7076a00) {
                    add(
                        InlineV1PaymentLinksPostRequestFormStatementDescriptorS6a4aX32e05953Branch.InlineV1PaymentLinksPostRequestFormPaymentIntentDataAnyOf2Xe7076a00,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1PaymentLinksPostRequestFormStatementDescriptorS6a4aX32e05953 {
            val inspection = inspectInlineV1PaymentLinksPostRequestFormStatementDescriptorS6a4aX32e05953(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1PaymentLinksPostRequestFormStatementDescriptorS6a4aX32e05953NoMatchException(
                    "InlineV1PaymentLinksPostRequestFormStatementDescriptorS6a4aX32e05953 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1PaymentLinksPostRequestFormStatementDescriptorS6a4aX32e05953> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentLinksPostRequestFormStatementDescriptorS6a4aX32e05953,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1PaymentLinksPostRequestFormStatementDescriptorS6a4aX32e05953",
...
private fun inspectInlineV1PaymentLinksPostRequestFormStatementDescriptorS6a4aX32e05953(
    element: JsonElement,
): InlineV1PaymentLinksPostRequestFormStatementDescriptorS6a4aX32e05953Inspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1PaymentLinksPostRequestFormPaymentIntentDataAnyOf2Xe7076a00 =
        element
            .isJsonDecodable<InlineV1PaymentLinksPostRequestFormPaymentIntentDataAnyOf2Xe7076a00>()
    return InlineV1PaymentLinksPostRequestFormStatementDescriptorS6a4aX32e05953Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1PaymentLinksPostRequestFormPaymentIntentDataAnyOf2Xe7076a00) {
                    add(
                        "InlineV1PaymentLinksPostRequestFormPaymentIntentDataAnyOf2Xe7076a00: value does not match InlineV1PaymentLinksPostRequestFormPaymentIntentDataAnyOf2Xe7076a00",
                    )
                }
            },
    )
