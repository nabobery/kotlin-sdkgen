...
public class InlineV1CustomersPostRequestFormInvoiceSettingsRenderingOptionsAnyOf1X0a61648e(
    public val amountTaxDisplay: InlineV1CustomersPostRequestFormInvoiceSettingsAmountTaxDisplayX1cac9922? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1CustomersPostRequestFormInvoiceSettingsRenderingOptionsAnyOf1X0a61648e =
    ...
    public object Serializer : KSerializer<InlineV1CustomersPostRequestFormInvoiceSettingsRenderingOptionsAnyOf1X0a61648e> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CustomersPostRequestFormInvoiceSettingsRenderingOptionsAnyOf1X0a61648e must be a JSON object",
                    )
            return InlineV1CustomersPostRequestFormInvoiceSettingsRenderingOptionsAnyOf1X0a61648e(
                amountTaxDisplay =
                    rawObject["amount_tax_display"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CustomersPostRequestFormInvoiceSettingsAmountTaxDisplayX1cac9922>(
                                it,
                            )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersPostRequestFormInvoiceSettingsRenderingOptionsAnyOf1X0a61648e,
        ) {
            val jsonEncoder =
...
public fun inlineV1CustomersPostRequestFormInvoiceSettingsRenderingOptionsAnyOf1X0a61648e(
    block: InlineV1CustomersPostRequestFormInvoiceSettingsRenderingOptionsAnyOf1X0a61648e.Builder.() -> Unit,
): InlineV1CustomersPostRequestFormInvoiceSettingsRenderingOptionsAnyOf1X0a61648e =
    InlineV1CustomersPostRequestFormInvoiceSettingsRenderingOptionsAnyOf1X0a61648e.build(block)
