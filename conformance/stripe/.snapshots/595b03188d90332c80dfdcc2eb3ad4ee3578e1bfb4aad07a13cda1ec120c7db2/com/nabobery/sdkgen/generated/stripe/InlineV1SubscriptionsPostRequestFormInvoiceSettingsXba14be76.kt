...
public class InlineV1SubscriptionsPostRequestFormInvoiceSettingsXba14be76(
    public val accountTaxIds: InlineV1SubscriptionsPostRequestFormInvoiceSettingsAccountTaxIdsX8196e633? = null,
    public val customFields: InlineV1SubscriptionsPostRequestFormInvoiceSettingsCustomFieldsXbf17de34? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1SubscriptionsPostRequestFormInvoiceSettingsXba14be76 =
            InlineV1SubscriptionsPostRequestFormInvoiceSettingsXba14be76(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1SubscriptionsPostRequestFormInvoiceSettingsXba14be76 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1SubscriptionsPostRequestFormInvoiceSettingsXba14be76> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SubscriptionsPostRequestFormInvoiceSettingsXba14be76 must be a JSON object",
                    )
            return InlineV1SubscriptionsPostRequestFormInvoiceSettingsXba14be76(
                accountTaxIds =
                    rawObject["account_tax_ids"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormInvoiceSettingsAccountTaxIdsX8196e633>(
                                it,
                            )
                    },
                customFields =
                    rawObject["custom_fields"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormInvoiceSettingsCustomFieldsXbf17de34>(
                                it,
                            )
                    },
                ...
                issuer =
                    rawObject["issuer"]?.let {
                        json.decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormInvoiceSettingsIssuerXdb76cca3>(
                            it,
                        )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsPostRequestFormInvoiceSettingsXba14be76,
        ) {
...
public fun inlineV1SubscriptionsPostRequestFormInvoiceSettingsXba14be76(
    block: InlineV1SubscriptionsPostRequestFormInvoiceSettingsXba14be76.Builder.() -> Unit,
): InlineV1SubscriptionsPostRequestFormInvoiceSettingsXba14be76 =
    InlineV1SubscriptionsPostRequestFormInvoiceSettingsXba14be76.build(block)
