...
public class InlineV1RadarPaymentEvaluacd5dPostRequestFormMoneyMovementDetailsX1bb0eda7(
    public val moneyMovementType: InlineV1RadarPaymentEvaluacd5dPostRequestFormMoneyMovementTypeXf237e472,
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1RadarPaymentEvaluacd5dPostRequestFormMoneyMovementDetailsX1bb0eda7 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1RadarPaymentEvaluacd5dPostRequestFormMoneyMovementDetailsX1bb0eda7> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1RadarPaymentEvaluacd5dPostRequestFormMoneyMovementDetailsX1bb0eda7 must be a JSON object",
                    )
            val moneyMovementType =
                json
                    .decodeRequired<InlineV1RadarPaymentEvaluacd5dPostRequestFormMoneyMovementTypeXf237e472>(
                        rawObject,
                        "money_movement_type",
                    )
            return InlineV1RadarPaymentEvaluacd5dPostRequestFormMoneyMovementDetailsX1bb0eda7(
                ...
                card =
                    rawObject["card"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1RadarPaymentEvaluacd5dPostRequestFormPaymentDetailsCardX4245796a>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1RadarPaymentEvaluacd5dPostRequestFormMoneyMovementDetailsX1bb0eda7,
        ) {
            val jsonEncoder =
...
public fun inlineV1RadarPaymentEvaluacd5dPostRequestFormMoneyMovementDetailsX1bb0eda7(
    block: InlineV1RadarPaymentEvaluacd5dPostRequestFormMoneyMovementDetailsX1bb0eda7.Builder.() -> Unit,
): InlineV1RadarPaymentEvaluacd5dPostRequestFormMoneyMovementDetailsX1bb0eda7 =
    InlineV1RadarPaymentEvaluacd5dPostRequestFormMoneyMovementDetailsX1bb0eda7.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1RadarPaymentEvaluacd5dPostRequestFormMoneyMovementDetailsX1bb0eda7 is missing required property '" +
                    name +
                    "'",
            )
