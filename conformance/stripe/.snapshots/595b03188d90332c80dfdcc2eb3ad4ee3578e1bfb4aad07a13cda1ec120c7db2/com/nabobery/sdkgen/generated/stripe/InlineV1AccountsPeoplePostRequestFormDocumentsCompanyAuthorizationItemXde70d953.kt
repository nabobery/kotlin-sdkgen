...
internal data class InlineV1AccountsPeoplePostRequestFormDocumentsCompanyAuthorizationItemXde70d953Inspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1AccountsPeoplePostRequestFormDocumentsAnyOf2X5ad1f544,
            ).count { it }
}
...
public class InlineV1AccountsPeoplePostRequestFormDocumentsCompanyAuthorizationItemXde70d953 internal constructor(
    ...
    private val inspection: InlineV1AccountsPeoplePostRequestFormDocumentsCompanyAuthorizationItemXde70d953Inspection,
) {
    ...
    public val inlineV1AccountsPeoplePostRequestFormDocumentsAnyOf2X5ad1f544:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1AccountsPeoplePostRequestFormDocumentsAnyOf2X5ad1f544) {
                json
                    .decodeFromJsonElement<InlineV1AccountsPeoplePostRequestFormDocumentsAnyOf2X5ad1f544>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1AccountsPeoplePostRequestFormDocumentsCompanyAuthorizationItemXde70d953Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1AccountsPeoplePostRequestFormDocumentsAnyOf2X5ad1f544) {
                    add(
                        InlineV1AccountsPeoplePostRequestFormDocumentsCompanyAuthorizationItemXde70d953Branch.InlineV1AccountsPeoplePostRequestFormDocumentsAnyOf2X5ad1f544,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1AccountsPeoplePostRequestFormDocumentsCompanyAuthorizationItemXde70d953 {
            val inspection = inspectInlineV1AccountsPeoplePostRequestFormDocumentsCompanyAuthorizationItemXde70d953(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1AccountsPeoplePostRequestFormDocumentsCompanyAuthorizationItemXde70d953NoMatchException(
                    "InlineV1AccountsPeoplePostRequestFormDocumentsCompanyAuthorizationItemXde70d953 matched 0 branches: " +
                        inspection.failures.joinToString("; "),
                )
            }
            return InlineV1AccountsPeoplePostRequestFormDocumentsCompanyAuthorizationItemXde70d953(
                raw,
                json,
                inspection,
            )
    ...
    public object Serializer : KSerializer<InlineV1AccountsPeoplePostRequestFormDocumentsCompanyAuthorizationItemXde70d953> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPeoplePostRequestFormDocumentsCompanyAuthorizationItemXde70d953,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1AccountsPeoplePostRequestFormDocumentsCompanyAuthorizationItemXde70d953",
...
private fun inspectInlineV1AccountsPeoplePostRequestFormDocumentsCompanyAuthorizationItemXde70d953(
    element: JsonElement,
): InlineV1AccountsPeoplePostRequestFormDocumentsCompanyAuthorizationItemXde70d953Inspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1AccountsPeoplePostRequestFormDocumentsAnyOf2X5ad1f544 =
        element
            .isJsonDecodable<InlineV1AccountsPeoplePostRequestFormDocumentsAnyOf2X5ad1f544>()
    return InlineV1AccountsPeoplePostRequestFormDocumentsCompanyAuthorizationItemXde70d953Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1AccountsPeoplePostRequestFormDocumentsAnyOf2X5ad1f544) {
                    add(
                        "InlineV1AccountsPeoplePostRequestFormDocumentsAnyOf2X5ad1f544: value does not match InlineV1AccountsPeoplePostRequestFormDocumentsAnyOf2X5ad1f544",
                    )
                }
            },
    )
