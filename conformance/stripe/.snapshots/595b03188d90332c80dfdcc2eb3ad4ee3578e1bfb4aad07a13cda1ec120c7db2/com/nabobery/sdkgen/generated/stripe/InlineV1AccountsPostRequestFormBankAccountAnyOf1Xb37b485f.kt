...
public class InlineV1AccountsPostRequestFormBankAccountAnyOf1Xb37b485f(
    ...
    public val accountHolderType: InlineV1AccountsPostRequestFormBankAccountAnyOf1AccountHolderTypeX2ebc0871? = null,
    public val accountType: InlineV1AccountsPostRequestFormBankAccountAnyOf1AccountTypeX8978eca7? = null,
    public val currency: String? = null,
    public val documents: InlineV1AccountsPostRequestFormBankAccountAnyOf1DocumentsXf33cf7db? = null,
    public val objectValue: InlineV1AccountsPostRequestFormBankAccountAnyOf1ObjectValueX5db18046? = null,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1AccountsPostRequestFormBankAccountAnyOf1Xb37b485f =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1AccountsPostRequestFormBankAccountAnyOf1Xb37b485f> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountsPostRequestFormBankAccountAnyOf1Xb37b485f must be a JSON object",
                    )
            ...
            return InlineV1AccountsPostRequestFormBankAccountAnyOf1Xb37b485f(
                ...
                accountHolderType =
                    rawObject["account_holder_type"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1AccountsPostRequestFormBankAccountAnyOf1AccountHolderTypeX2ebc0871>(
                                it,
                            )
                    },
                accountType =
                    rawObject["account_type"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1AccountsPostRequestFormBankAccountAnyOf1AccountTypeX8978eca7>(
                                it,
                            )
                    },
                ...
                documents =
                    rawObject["documents"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPostRequestFormBankAccountAnyOf1DocumentsXf33cf7db>(
                            it,
                        )
                    },
                objectValue =
                    rawObject["object"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1AccountsPostRequestFormBankAccountAnyOf1ObjectValueX5db18046>(
                                it,
                            )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPostRequestFormBankAccountAnyOf1Xb37b485f,
        ) {
...
public fun inlineV1AccountsPostRequestFormBankAccountAnyOf1Xb37b485f(
    block: InlineV1AccountsPostRequestFormBankAccountAnyOf1Xb37b485f.Builder.() -> Unit,
): InlineV1AccountsPostRequestFormBankAccountAnyOf1Xb37b485f =
    InlineV1AccountsPostRequestFormBankAccountAnyOf1Xb37b485f.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1AccountsPostRequestFormBankAccountAnyOf1Xb37b485f is missing required property '" + name + "'",
            )
