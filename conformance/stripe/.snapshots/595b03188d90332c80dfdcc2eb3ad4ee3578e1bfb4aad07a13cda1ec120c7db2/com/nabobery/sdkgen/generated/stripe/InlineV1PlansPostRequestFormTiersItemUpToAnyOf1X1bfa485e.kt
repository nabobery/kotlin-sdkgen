...
public sealed class InlineV1PlansPostRequestFormTiersItemUpToAnyOf1X1bfa485e {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1PlansPostRequestFormTiersItemUpToAnyOf1X1bfa485e =
            when (value) {
                Inf.value -> Inf
    ...
    public object Serializer : KSerializer<InlineV1PlansPostRequestFormTiersItemUpToAnyOf1X1bfa485e> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1PlansPostRequestFormTiersItemUpToAnyOf1X1bfa485e",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1PlansPostRequestFormTiersItemUpToAnyOf1X1bfa485e =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PlansPostRequestFormTiersItemUpToAnyOf1X1bfa485e,
        ) {
