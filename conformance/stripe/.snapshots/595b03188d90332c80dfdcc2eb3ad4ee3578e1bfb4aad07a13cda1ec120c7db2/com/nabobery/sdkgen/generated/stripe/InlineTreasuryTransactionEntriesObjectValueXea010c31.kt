...
public sealed class InlineTreasuryTransactionEntriesObjectValueXea010c31 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineTreasuryTransactionEntriesObjectValueXea010c31 =
            when (value) {
                List.value -> List
    ...
    public object Serializer : KSerializer<InlineTreasuryTransactionEntriesObjectValueXea010c31> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineTreasuryTransactionEntriesObjectValueXea010c31",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineTreasuryTransactionEntriesObjectValueXea010c31 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineTreasuryTransactionEntriesObjectValueXea010c31,
        ) {
