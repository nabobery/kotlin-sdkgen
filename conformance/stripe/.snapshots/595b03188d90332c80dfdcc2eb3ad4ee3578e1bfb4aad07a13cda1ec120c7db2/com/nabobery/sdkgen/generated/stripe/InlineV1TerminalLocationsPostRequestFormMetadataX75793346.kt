...
internal data class InlineV1TerminalLocationsPostRequestFormMetadataX75793346Inspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1TerminalLocationsPostRequestFormMetadataAnyOf2X0bdef11b,
            ).count { it }
}
...
public class InlineV1TerminalLocationsPostRequestFormMetadataX75793346 internal constructor(
    ...
    public val inlineV1TerminalLocationsPostRequestFormMetadataAnyOf2X0bdef11b:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1TerminalLocationsPostRequestFormMetadataAnyOf2X0bdef11b) {
                json
                    .decodeFromJsonElement<InlineV1TerminalLocationsPostRequestFormMetadataAnyOf2X0bdef11b>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1TerminalLocationsPostRequestFormMetadataX75793346Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1TerminalLocationsPostRequestFormMetadataAnyOf2X0bdef11b) {
                    add(
                        InlineV1TerminalLocationsPostRequestFormMetadataX75793346Branch.InlineV1TerminalLocationsPostRequestFormMetadataAnyOf2X0bdef11b,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1TerminalLocationsPostRequestFormMetadataX75793346 {
            val inspection = inspectInlineV1TerminalLocationsPostRequestFormMetadataX75793346(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1TerminalLocationsPostRequestFormMetadataX75793346NoMatchException(
                    "InlineV1TerminalLocationsPostRequestFormMetadataX75793346 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1TerminalLocationsPostRequestFormMetadataX75793346> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TerminalLocationsPostRequestFormMetadataX75793346,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1TerminalLocationsPostRequestFormMetadataX75793346",
...
private fun inspectInlineV1TerminalLocationsPostRequestFormMetadataX75793346(
    element: JsonElement,
): InlineV1TerminalLocationsPostRequestFormMetadataX75793346Inspection {
    val matchesBranch1 = element.isJsonDecodable<JsonObject>()
    val matchesInlineV1TerminalLocationsPostRequestFormMetadataAnyOf2X0bdef11b =
        element
            .isJsonDecodable<InlineV1TerminalLocationsPostRequestFormMetadataAnyOf2X0bdef11b>()
    return InlineV1TerminalLocationsPostRequestFormMetadataX75793346Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1TerminalLocationsPostRequestFormMetadataAnyOf2X0bdef11b) {
                    add(
                        "InlineV1TerminalLocationsPostRequestFormMetadataAnyOf2X0bdef11b: value does not match InlineV1TerminalLocationsPostRequestFormMetadataAnyOf2X0bdef11b",
                    )
                }
            },
    )
