...
public class IssuingCardholderUserTermsAcceptance(
    ...
    public class Builder {
        ...
        public fun build(): IssuingCardholderUserTermsAcceptance =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): IssuingCardholderUserTermsAcceptance =
    ...
    public object Serializer : KSerializer<IssuingCardholderUserTermsAcceptance> {
        ...
        override fun deserialize(decoder: Decoder): IssuingCardholderUserTermsAcceptance {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("IssuingCardholderUserTermsAcceptance must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: IssuingCardholderUserTermsAcceptance,
        ) {
...
public fun issuingCardholderUserTermsAcceptance(
    block: IssuingCardholderUserTermsAcceptance.Builder.() -> Unit,
): IssuingCardholderUserTermsAcceptance = IssuingCardholderUserTermsAcceptance.build(block)
