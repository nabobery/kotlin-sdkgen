...
public class InlineV1IssuingTransactionsPostRequestFormX560cbf35(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1IssuingTransactionsPostRequestFormX560cbf35 =
            InlineV1IssuingTransactionsPostRequestFormX560cbf35(
                expand = expand,
                metadata = metadata,
            )
    }
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1IssuingTransactionsPostRequestFormX560cbf35 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1IssuingTransactionsPostRequestFormX560cbf35> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1IssuingTransactionsPostRequestFormX560cbf35 must be a JSON object",
                    )
            return InlineV1IssuingTransactionsPostRequestFormX560cbf35(
                expand = rawObject["expand"]?.let { json.decodeFromJsonElement<List<String>>(it) },
                metadata =
                    rawObject["metadata"]?.let {
                        json.decodeFromJsonElement<InlineV1IssuingTransactionsPostRequestFormMetadataX51b8c14d>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingTransactionsPostRequestFormX560cbf35,
        ) {
...
public fun inlineV1IssuingTransactionsPostRequestFormX560cbf35(
    block: InlineV1IssuingTransactionsPostRequestFormX560cbf35.Builder.() -> Unit,
): InlineV1IssuingTransactionsPostRequestFormX560cbf35 =
    InlineV1IssuingTransactionsPostRequestFormX560cbf35.build(block)
