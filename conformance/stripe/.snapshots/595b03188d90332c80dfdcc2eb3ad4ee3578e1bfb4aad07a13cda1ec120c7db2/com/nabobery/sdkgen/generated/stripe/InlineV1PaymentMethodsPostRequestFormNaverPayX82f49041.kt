...
public class InlineV1PaymentMethodsPostRequestFormNaverPayX82f49041(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1PaymentMethodsPostRequestFormNaverPayX82f49041 =
            InlineV1PaymentMethodsPostRequestFormNaverPayX82f49041(
                funding = funding,
            )
    }

    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PaymentMethodsPostRequestFormNaverPayX82f49041 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentMethodsPostRequestFormNaverPayX82f49041> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentMethodsPostRequestFormNaverPayX82f49041 must be a JSON object",
                    )
            return InlineV1PaymentMethodsPostRequestFormNaverPayX82f49041(
                funding =
                    rawObject["funding"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentMethodsPostRequestFormNaverPayFundingXf4381218>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentMethodsPostRequestFormNaverPayX82f49041,
        ) {
...
public fun inlineV1PaymentMethodsPostRequestFormNaverPayX82f49041(
    block: InlineV1PaymentMethodsPostRequestFormNaverPayX82f49041.Builder.() -> Unit,
): InlineV1PaymentMethodsPostRequestFormNaverPayX82f49041 =
    InlineV1PaymentMethodsPostRequestFormNaverPayX82f49041.build(block)
