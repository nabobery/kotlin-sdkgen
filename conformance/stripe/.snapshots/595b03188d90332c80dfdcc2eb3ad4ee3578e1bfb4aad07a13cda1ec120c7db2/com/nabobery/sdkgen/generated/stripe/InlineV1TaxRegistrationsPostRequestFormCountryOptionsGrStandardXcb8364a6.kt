...
public class InlineV1TaxRegistrationsPostRequestFormCountryOptionsGrStandardXcb8364a6(
    public val placeOfSupplyScheme: InlineV1TaxRegistrationsPostRequestFormPlaceOfSupplySchemeX08a992c5,
) {
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1TaxRegistrationsPostRequestFormCountryOptionsGrStandardXcb8364a6 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TaxRegistrationsPostRequestFormCountryOptionsGrStandardXcb8364a6> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TaxRegistrationsPostRequestFormCountryOptionsGrStandardXcb8364a6 must be a JSON object",
                    )
            val placeOfSupplyScheme =
                json
                    .decodeRequired<InlineV1TaxRegistrationsPostRequestFormPlaceOfSupplySchemeX08a992c5>(
                        rawObject,
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TaxRegistrationsPostRequestFormCountryOptionsGrStandardXcb8364a6,
        ) {
            val jsonEncoder =
...
public fun inlineV1TaxRegistrationsPostRequestFormCountryOptionsGrStandardXcb8364a6(
    block: InlineV1TaxRegistrationsPostRequestFormCountryOptionsGrStandardXcb8364a6.Builder.() -> Unit,
): InlineV1TaxRegistrationsPostRequestFormCountryOptionsGrStandardXcb8364a6 =
    InlineV1TaxRegistrationsPostRequestFormCountryOptionsGrStandardXcb8364a6.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TaxRegistrationsPostRequestFormCountryOptionsGrStandardXcb8364a6 is missing required property '" +
                    name +
                    "'",
            )
