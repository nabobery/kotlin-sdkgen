...
public class PaymentMethodOptionsKlarna(
    ...
    public class Builder {
        ...
        public fun build(): PaymentMethodOptionsKlarna =
    ...
    public object Serializer : KSerializer<PaymentMethodOptionsKlarna> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodOptionsKlarna {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodOptionsKlarna must be a JSON object")
            return PaymentMethodOptionsKlarna(
                captureMethod =
                    rawObject["capture_method"]?.let {
                        json.decodeFromJsonElement<InlinePaymentMethodOptionsKlarnaCaptureMethodX1694c60a>(it)
                    },
                preferredLocale =
                ...
                setupFutureUsage =
                    rawObject["setup_future_usage"]?.let {
                        json.decodeFromJsonElement<InlinePaymentMethodOptionsKlarnaSetupFutureUsageX4dd59568>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentMethodOptionsKlarna,
        ) {
...
public fun paymentMethodOptionsKlarna(
    block: PaymentMethodOptionsKlarna.Builder.() -> Unit,
): PaymentMethodOptionsKlarna = PaymentMethodOptionsKlarna.build(block)
