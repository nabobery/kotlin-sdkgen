...
public class PaymentIntentPaymentMethodOptionsMandateOptionsAcssDebit(
    ...
    public class Builder {
        ...
        public fun build(): PaymentIntentPaymentMethodOptionsMandateOptionsAcssDebit =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentIntentPaymentMethodOptionsMandateOptionsAcssDebit =
    ...
    public object Serializer : KSerializer<PaymentIntentPaymentMethodOptionsMandateOptionsAcssDebit> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "PaymentIntentPaymentMethodOptionsMandateOptionsAcssDebit must be a JSON object",
                    )
                ...
                paymentSchedule =
                    rawObject["payment_schedule"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentIntentPayment6e62PaymentScheduleX9087db06?>(element)
                        }
                    },
                transactionType =
                    rawObject["transaction_type"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentIntentPayment6e62TransactionTypeX58c87744?>(element)
                        }
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentIntentPaymentMethodOptionsMandateOptionsAcssDebit,
        ) {
...
public fun paymentIntentPaymentMethodOptionsMandateOptionsAcssDebit(
    block: PaymentIntentPaymentMethodOptionsMandateOptionsAcssDebit.Builder.() -> Unit,
): PaymentIntentPaymentMethodOptionsMandateOptionsAcssDebit =
    PaymentIntentPaymentMethodOptionsMandateOptionsAcssDebit.build(block)
