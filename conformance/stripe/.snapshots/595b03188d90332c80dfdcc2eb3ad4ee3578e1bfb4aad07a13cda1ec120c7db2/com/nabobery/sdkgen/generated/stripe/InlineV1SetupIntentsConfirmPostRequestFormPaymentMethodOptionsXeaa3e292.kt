...
public class InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsXeaa3e292(
    public val acssDebit: InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsAcssDebitX8bf7378b? = null,
    public val amazonPay: JsonObject? = null,
    public val bacsDebit: InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsBacsDebitX8306070a? = null,
    public val bizum: JsonObject? = null,
    public val card: InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsCardXf7411bae? = null,
    public val cardPresent: JsonObject? = null,
    public val klarna: InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsKlarnaXe99e1cdd? = null,
    public val link: JsonObject? = null,
    public val paypal: InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsPaypalXa6ffb8a4? = null,
    public val payto: InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsPaytoX25621288? = null,
    public val pix: InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsPixXd9ba9bad? = null,
    public val sepaDebit: InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsSepaDebitX776132b5? = null,
    public val upi: InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsUpiX3787f934? = null,
    public val usBankAccount: InlineV1SetupIntentsConfirmPostRequestFormUsBankAccountX86ed8f4d? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsXeaa3e292 =
            InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsXeaa3e292(
                acssDebit = acssDebit,
                amazonPay = amazonPay,
                bacsDebit = bacsDebit,
                bizum = bizum,
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsXeaa3e292 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsXeaa3e292> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsXeaa3e292 must be a JSON object",
                    )
            return InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsXeaa3e292(
                acssDebit =
                    rawObject["acss_debit"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsAcssDebitX8bf7378b>(
                                it,
                            )
                    },
                ...
                bacsDebit =
                    rawObject["bacs_debit"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsBacsDebitX8306070a>(
                                it,
                            )
                    },
                ...
                card =
                    rawObject["card"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsCardXf7411bae>(
                                it,
                            )
                    },
                ...
                klarna =
                    rawObject["klarna"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsKlarnaXe99e1cdd>(
                                it,
                            )
                    },
                ...
                paypal =
                    rawObject["paypal"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsPaypalXa6ffb8a4>(
                                it,
                            )
                    },
                payto =
                    rawObject["payto"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsPaytoX25621288>(
                                it,
                            )
                    },
                pix =
                    rawObject["pix"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsPixXd9ba9bad>(
                                it,
                            )
                    },
                sepaDebit =
                    rawObject["sepa_debit"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsSepaDebitX776132b5>(
                                it,
                            )
                    },
                upi =
                    rawObject["upi"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsUpiX3787f934>(
                                it,
                            )
                    },
                usBankAccount =
                    rawObject["us_bank_account"]?.let {
                        json.decodeFromJsonElement<InlineV1SetupIntentsConfirmPostRequestFormUsBankAccountX86ed8f4d>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsXeaa3e292,
        ) {
            val jsonEncoder =
...
public fun inlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsXeaa3e292(
    block: InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsXeaa3e292.Builder.() -> Unit,
): InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsXeaa3e292 =
    InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsXeaa3e292.build(block)
