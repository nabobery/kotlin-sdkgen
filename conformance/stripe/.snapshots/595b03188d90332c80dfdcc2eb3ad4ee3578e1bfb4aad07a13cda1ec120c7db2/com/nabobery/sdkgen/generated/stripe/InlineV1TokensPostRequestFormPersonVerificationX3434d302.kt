...
public class InlineV1TokensPostRequestFormPersonVerificationX3434d302(
    public val additionalDocument: InlineV1TokensPostRequestFormPersonVerificationAdditionalDocumentXa7053964? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1TokensPostRequestFormPersonVerificationX3434d302 =
            InlineV1TokensPostRequestFormPersonVerificationX3434d302(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TokensPostRequestFormPersonVerificationX3434d302 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TokensPostRequestFormPersonVerificationX3434d302> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TokensPostRequestFormPersonVerificationX3434d302 must be a JSON object",
                    )
            return InlineV1TokensPostRequestFormPersonVerificationX3434d302(
                additionalDocument =
                    rawObject["additional_document"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TokensPostRequestFormPersonVerificationAdditionalDocumentXa7053964>(
                                it,
                            )
                    },
                document =
                    rawObject["document"]?.let {
                        json.decodeFromJsonElement<InlineV1TokensPostRequestFormPersonVerificationDocumentX1a908000>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TokensPostRequestFormPersonVerificationX3434d302,
        ) {
...
public fun inlineV1TokensPostRequestFormPersonVerificationX3434d302(
    block: InlineV1TokensPostRequestFormPersonVerificationX3434d302.Builder.() -> Unit,
): InlineV1TokensPostRequestFormPersonVerificationX3434d302 =
    InlineV1TokensPostRequestFormPersonVerificationX3434d302.build(block)
