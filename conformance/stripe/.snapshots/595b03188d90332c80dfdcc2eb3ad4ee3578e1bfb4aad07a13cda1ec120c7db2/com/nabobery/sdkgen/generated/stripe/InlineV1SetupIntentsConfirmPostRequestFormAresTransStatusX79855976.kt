...
public sealed class InlineV1SetupIntentsConfirmPostRequestFormAresTransStatusX79855976 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1SetupIntentsConfirmPostRequestFormAresTransStatusX79855976 =
            when (value) {
                A.value -> A
                C.value -> C
                I.value -> I
    ...
    public object Serializer : KSerializer<InlineV1SetupIntentsConfirmPostRequestFormAresTransStatusX79855976> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1SetupIntentsConfirmPostRequestFormAresTransStatusX79855976",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1SetupIntentsConfirmPostRequestFormAresTransStatusX79855976 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SetupIntentsConfirmPostRequestFormAresTransStatusX79855976,
        ) {
