...
public sealed class InlinePaymentsPrimitivesPabc9bExemptionIndicatorX00cd1440 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentsPrimitivesPabc9bExemptionIndicatorX00cd1440 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlinePaymentsPrimitivesPabc9bExemptionIndicatorX00cd1440> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentsPrimitivesPabc9bExemptionIndicatorX00cd1440",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePaymentsPrimitivesPabc9bExemptionIndicatorX00cd1440 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentsPrimitivesPabc9bExemptionIndicatorX00cd1440,
        ) {
