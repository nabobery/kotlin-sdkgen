...
public class InlineV1PaymentRecordsReportPaymentPostRequestFormGuaranteedXba30823c(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentRecordsReportPaymentPostRequestFormGuaranteedXba30823c = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1PaymentRecordsReportPaymentPostRequestFormGuaranteedXba30823c> {
        ...
        override fun deserialize(
            decoder: Decoder,
        ): InlineV1PaymentRecordsReportPaymentPostRequestFormGuaranteedXba30823c {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentRecordsReportPaymentPostRequestFormGuaranteedXba30823c must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentRecordsReportPaymentPostRequestFormGuaranteedXba30823c,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentRecordsReportPaymentPostRequestFormGuaranteedXba30823c(
    block: InlineV1PaymentRecordsReportPaymentPostRequestFormGuaranteedXba30823c.Builder.() -> Unit,
): InlineV1PaymentRecordsReportPaymentPostRequestFormGuaranteedXba30823c =
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentRecordsReportPaymentPostRequestFormGuaranteedXba30823c is missing required property '" +
                    name +
                    "'",
            )
