...
public class PaymentMethodDetailsAchDebit(
     ...
     */
    public val accountHolderType: InlinePaymentMethodDetailsAchDebitAccountHolderTypeX780ecb08? = null,
    /**
    ...
    public class Builder {
        ...
        public fun build(): PaymentMethodDetailsAchDebit =
    ...
    public object Serializer : KSerializer<PaymentMethodDetailsAchDebit> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodDetailsAchDebit {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodDetailsAchDebit must be a JSON object")
                ...
                accountHolderType =
                    rawObject["account_holder_type"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentMethodDetailsAchDebitAccountHolderTypeX780ecb08?>(
                                element,
                            )
                        }
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentMethodDetailsAchDebit,
        ) {
...
public fun paymentMethodDetailsAchDebit(
    block: PaymentMethodDetailsAchDebit.Builder.() -> Unit,
): PaymentMethodDetailsAchDebit = PaymentMethodDetailsAchDebit.build(block)
