...
public sealed class InlinePaymentPagesCheckoutSessionCustomFieldsTypeX75cd9bad {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentPagesCheckoutSessionCustomFieldsTypeX75cd9bad =
            when (value) {
    ...
    public object Serializer : KSerializer<InlinePaymentPagesCheckoutSessionCustomFieldsTypeX75cd9bad> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentPagesCheckoutSessionCustomFieldsTypeX75cd9bad",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePaymentPagesCheckoutSessionCustomFieldsTypeX75cd9bad =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentPagesCheckoutSessionCustomFieldsTypeX75cd9bad,
        ) {
