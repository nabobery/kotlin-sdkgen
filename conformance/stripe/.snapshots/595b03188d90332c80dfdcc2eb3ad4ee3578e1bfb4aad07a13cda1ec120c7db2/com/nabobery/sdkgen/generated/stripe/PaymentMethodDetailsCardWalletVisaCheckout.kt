...
public class PaymentMethodDetailsCardWalletVisaCheckout(
     ...
     */
    public val billingAddress: InlinePaymentMethodDetailsCardWalletVisaCheckoutBillingAddressX8f71f813? = null,
    /**
     ...
     */
    public val shippingAddress: InlinePaymentMethodDetailsCardWalletVisaCheckoutShippingAddressX9161e640? = null,
) {
    public class Builder {
        ...
        public fun build(): PaymentMethodDetailsCardWalletVisaCheckout =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentMethodDetailsCardWalletVisaCheckout =
    ...
    public object Serializer : KSerializer<PaymentMethodDetailsCardWalletVisaCheckout> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodDetailsCardWalletVisaCheckout {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodDetailsCardWalletVisaCheckout must be a JSON object")
                ...
                billingAddress =
                    rawObject["billing_address"]?.let { element ->
                        if (element ==
                            ...
                            json
                                .decodeFromJsonElement<InlinePaymentMethodDetailsCardWalletVisaCheckoutBillingAddressX8f71f813?>(
                                    element,
                                )
                        }
                    },
                ...
                shippingAddress =
                    rawObject["shipping_address"]?.let { element ->
                        if (element ==
                            ...
                            json
                                .decodeFromJsonElement<InlinePaymentMethodDetailsCardWalletVisaCheckoutShippingAddressX9161e640?>(
                                    element,
                                )
                        }
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentMethodDetailsCardWalletVisaCheckout,
        ) {
...
public fun paymentMethodDetailsCardWalletVisaCheckout(
    block: PaymentMethodDetailsCardWalletVisaCheckout.Builder.() -> Unit,
): PaymentMethodDetailsCardWalletVisaCheckout = PaymentMethodDetailsCardWalletVisaCheckout.build(block)
