...
public class InlineV1CheckoutSessionsPostRequestFormSubscriptionDataEndBehaviorX414fd5e3(
    public val missingPaymentMethod: InlineV1CheckoutSessionsPostRequestFormMissingPaymentMethodX2ce1d29e,
) {
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1CheckoutSessionsPostRequestFormSubscriptionDataEndBehaviorX414fd5e3 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormSubscriptionDataEndBehaviorX414fd5e3> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CheckoutSessionsPostRequestFormSubscriptionDataEndBehaviorX414fd5e3 must be a JSON object",
                    )
            val missingPaymentMethod =
                json
                    .decodeRequired<InlineV1CheckoutSessionsPostRequestFormMissingPaymentMethodX2ce1d29e>(
                        rawObject,
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsPostRequestFormSubscriptionDataEndBehaviorX414fd5e3,
        ) {
            val jsonEncoder =
...
public fun inlineV1CheckoutSessionsPostRequestFormSubscriptionDataEndBehaviorX414fd5e3(
    block: InlineV1CheckoutSessionsPostRequestFormSubscriptionDataEndBehaviorX414fd5e3.Builder.() -> Unit,
): InlineV1CheckoutSessionsPostRequestFormSubscriptionDataEndBehaviorX414fd5e3 =
    InlineV1CheckoutSessionsPostRequestFormSubscriptionDataEndBehaviorX414fd5e3.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1CheckoutSessionsPostRequestFormSubscriptionDataEndBehaviorX414fd5e3 is missing required property '" +
                    name +
                    "'",
            )
