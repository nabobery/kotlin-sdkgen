    ...
    public object Serializer : KSerializer<InlineV1PaymentMethodConfigurationsGetResponse200JsonObjectValueX54f1f8c6> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1PaymentMethodConfigurationsGetResponse200JsonObjectValueX54f1f8c6",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1PaymentMethodConfigurationsGetResponse200JsonObjectValueX54f1f8c6 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentMethodConfigurationsGetResponse200JsonObjectValueX54f1f8c6,
        ) {
