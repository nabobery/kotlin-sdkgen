...
public class TaxProductResourceTaxTransactionResourceReversal(
    ...
    public class Builder {
        ...
        public fun build(): TaxProductResourceTaxTransactionResourceReversal =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): TaxProductResourceTaxTransactionResourceReversal =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<TaxProductResourceTaxTransactionResourceReversal> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "TaxProductResourceTaxTransactionResourceReversal must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: TaxProductResourceTaxTransactionResourceReversal,
        ) {
...
public fun taxProductResourceTaxTransactionResourceReversal(
    block: TaxProductResourceTaxTransactionResourceReversal.Builder.() -> Unit,
): TaxProductResourceTaxTransactionResourceReversal = TaxProductResourceTaxTransactionResourceReversal.build(block)
