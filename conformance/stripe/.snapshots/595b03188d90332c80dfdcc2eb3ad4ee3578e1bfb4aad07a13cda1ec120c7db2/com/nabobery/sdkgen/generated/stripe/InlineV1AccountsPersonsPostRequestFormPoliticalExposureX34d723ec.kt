...
public sealed class InlineV1AccountsPersonsPostRequestFormPoliticalExposureX34d723ec {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1AccountsPersonsPostRequestFormPoliticalExposureX34d723ec =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1AccountsPersonsPostRequestFormPoliticalExposureX34d723ec> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1AccountsPersonsPostRequestFormPoliticalExposureX34d723ec",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1AccountsPersonsPostRequestFormPoliticalExposureX34d723ec =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPersonsPostRequestFormPoliticalExposureX34d723ec,
        ) {
