...
public data class PaymentIntentPaymentMethodOptionsBlikView(
    ...
    public val setupFutureUsage: InlinePaymentIntentPaymentMethodOptionsBlikSetupFutureUsageX2d711941? = null,
)
...
public class PaymentIntentPaymentMethodOptionsBlik(
    ...
    public class Builder {
        ...
        public fun build(): PaymentIntentPaymentMethodOptionsBlik =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentIntentPaymentMethodOptionsBlik =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentIntentPaymentMethodOptionsBlik> {
        ...
        override fun deserialize(decoder: Decoder): PaymentIntentPaymentMethodOptionsBlik {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentIntentPaymentMethodOptionsBlik must be a JSON object")
            return PaymentIntentPaymentMethodOptionsBlik(
                setupFutureUsage =
                    rawObject["setup_future_usage"]?.let {
                        json
                            .decodeFromJsonElement<InlinePaymentIntentPaymentMethodOptionsBlikSetupFutureUsageX2d711941>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentIntentPaymentMethodOptionsBlik,
        ) {
...
public fun paymentIntentPaymentMethodOptionsBlik(
    block: PaymentIntentPaymentMethodOptionsBlik.Builder.() -> Unit,
): PaymentIntentPaymentMethodOptionsBlik = PaymentIntentPaymentMethodOptionsBlik.build(block)
