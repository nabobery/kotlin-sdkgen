...
public class ConnectEmbeddedPayoutsConfig(
    ...
    public object Serializer : KSerializer<ConnectEmbeddedPayoutsConfig> {
        ...
        override fun deserialize(decoder: Decoder): ConnectEmbeddedPayoutsConfig {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("ConnectEmbeddedPayoutsConfig must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: ConnectEmbeddedPayoutsConfig,
        ) {
...
public fun connectEmbeddedPayoutsConfig(
    block: ConnectEmbeddedPayoutsConfig.Builder.() -> Unit,
): ConnectEmbeddedPayoutsConfig = ConnectEmbeddedPayoutsConfig.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException("ConnectEmbeddedPayoutsConfig is missing required property '" + name + "'")
