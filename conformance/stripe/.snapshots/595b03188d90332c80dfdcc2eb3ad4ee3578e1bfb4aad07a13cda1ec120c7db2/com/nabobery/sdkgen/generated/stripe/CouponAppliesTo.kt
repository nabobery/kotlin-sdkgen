...
public class CouponAppliesTo(
    ...
    public class Builder {
        ...
        public var products: List<String>
            get() = requireNotNull(productsValue) { "products is required" }
            set(`value`) {
                productsValue = value
            }
    ...
    public object Serializer : KSerializer<CouponAppliesTo> {
        ...
        override fun deserialize(decoder: Decoder): CouponAppliesTo {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("CouponAppliesTo must be a JSON object")
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("CouponAppliesTo is missing required property '" + name + "'")
