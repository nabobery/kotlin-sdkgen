...
internal data class InlineV1PaymentIntentsIncra167PostRequestFormOrderReferenceX4c40a871Inspection(
    ...
    public val matchesInlineV1PaymentIntentsIncra167PostRequestFormPaymentDetailsAnyOf2Xd93c752f: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1PaymentIntentsIncra167PostRequestFormPaymentDetailsAnyOf2Xd93c752f,
            ).count {
                it
            }
}
...
public class InlineV1PaymentIntentsIncra167PostRequestFormOrderReferenceX4c40a871 internal constructor(
    ...
    private val inspection: InlineV1PaymentIntentsIncra167PostRequestFormOrderReferenceX4c40a871Inspection,
) {
    ...
    public val inlineV1PaymentIntentsIncra167PostRequestFormPaymentDetailsAnyOf2Xd93c752f:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1PaymentIntentsIncra167PostRequestFormPaymentDetailsAnyOf2Xd93c752f) {
                json
                    .decodeFromJsonElement<InlineV1PaymentIntentsIncra167PostRequestFormPaymentDetailsAnyOf2Xd93c752f>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1PaymentIntentsIncra167PostRequestFormOrderReferenceX4c40a871Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1PaymentIntentsIncra167PostRequestFormPaymentDetailsAnyOf2Xd93c752f) {
                    add(
                        InlineV1PaymentIntentsIncra167PostRequestFormOrderReferenceX4c40a871Branch.InlineV1PaymentIntentsIncra167PostRequestFormPaymentDetailsAnyOf2Xd93c752f,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1PaymentIntentsIncra167PostRequestFormOrderReferenceX4c40a871 {
            val inspection = inspectInlineV1PaymentIntentsIncra167PostRequestFormOrderReferenceX4c40a871(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1PaymentIntentsIncra167PostRequestFormOrderReferenceX4c40a871NoMatchException(
                    "InlineV1PaymentIntentsIncra167PostRequestFormOrderReferenceX4c40a871 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsIncra167PostRequestFormOrderReferenceX4c40a871> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsIncra167PostRequestFormOrderReferenceX4c40a871,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1PaymentIntentsIncra167PostRequestFormOrderReferenceX4c40a871",
...
private fun inspectInlineV1PaymentIntentsIncra167PostRequestFormOrderReferenceX4c40a871(
    element: JsonElement,
): InlineV1PaymentIntentsIncra167PostRequestFormOrderReferenceX4c40a871Inspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1PaymentIntentsIncra167PostRequestFormPaymentDetailsAnyOf2Xd93c752f =
        element
            .isJsonDecodable<InlineV1PaymentIntentsIncra167PostRequestFormPaymentDetailsAnyOf2Xd93c752f>()
    return InlineV1PaymentIntentsIncra167PostRequestFormOrderReferenceX4c40a871Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1PaymentIntentsIncra167PostRequestFormPaymentDetailsAnyOf2Xd93c752f) {
                    add(
                        "InlineV1PaymentIntentsIncra167PostRequestFormPaymentDetailsAnyOf2Xd93c752f: value does not match InlineV1PaymentIntentsIncra167PostRequestFormPaymentDetailsAnyOf2Xd93c752f",
                    )
                }
            },
    )
