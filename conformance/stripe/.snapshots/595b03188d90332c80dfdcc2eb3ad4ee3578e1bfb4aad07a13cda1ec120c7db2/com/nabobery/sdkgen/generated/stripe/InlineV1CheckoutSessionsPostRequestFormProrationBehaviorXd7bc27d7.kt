...
public sealed class InlineV1CheckoutSessionsPostRequestFormProrationBehaviorXd7bc27d7 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1CheckoutSessionsPostRequestFormProrationBehaviorXd7bc27d7 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormProrationBehaviorXd7bc27d7> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1CheckoutSessionsPostRequestFormProrationBehaviorXd7bc27d7",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1CheckoutSessionsPostRequestFormProrationBehaviorXd7bc27d7 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsPostRequestFormProrationBehaviorXd7bc27d7,
        ) {
