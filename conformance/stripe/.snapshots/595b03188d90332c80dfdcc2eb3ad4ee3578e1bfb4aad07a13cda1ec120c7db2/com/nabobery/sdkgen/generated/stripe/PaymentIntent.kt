...
@Serializable
public data class PaymentIntentView(
    ...
    public val excludedPaymentMethodTypes: List<InlinePaymentIntentExcludedPaymentMethodTypesItemX2ad3d6e8>? = null,
    ...
    public val paymentMethodConfigurationDetails: InlinePaymentIntentPaymentMethodConfigurationDetailsXa9c290a1? = null,
        ...
        override fun deserialize(decoder: Decoder): PaymentIntent {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentIntent must be a JSON object")
            ...
            return PaymentIntent(
                ...
                amountDetails =
                    rawObject["amount_details"]?.let {
                        json.decodeFromJsonElement<InlinePaymentIntentAmountDetailsX0fe9fd24>(it)
                    },
                ...
                application =
                    rawObject["application"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentIntentApplicationX852c1de7?>(element)
                        }
                    },
                applicationFeeAmount =
                    rawObject["application_fee_amount"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                automaticPaymentMethods =
                    rawObject["automatic_payment_methods"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlinePaymentIntentAutomaticPaymentMethodsX68be6956?>(element)
                        }
                    },
                canceledAt =
                ...
                cancellationReason =
                    rawObject["cancellation_reason"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentIntentCancellationReasonXa99846ea?>(element)
                        }
                    },
                captureMethod =
                    rawObject["capture_method"]?.let {
                        json.decodeFromJsonElement<InlinePaymentIntentCaptureMethodX7c24a00f>(it)
                    },
                clientSecret =
                ...
                confirmationMethod =
                    rawObject["confirmation_method"]?.let {
                        json.decodeFromJsonElement<InlinePaymentIntentConfirmationMethodX048d5232>(it)
                    },
                ...
                customer =
                    rawObject["customer"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentIntentCustomerX0992ed81?>(element)
                        }
                    },
                customerAccount =
                ...
                excludedPaymentMethodTypes =
                    rawObject["excluded_payment_method_types"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                            ...
                            json
                                .decodeFromJsonElement<List<InlinePaymentIntentExcludedPaymentMethodTypesItemX2ad3d6e8>?>(
                                    element,
                                )
                        }
                    },
                hooks =
                    rawObject["hooks"]?.let {
                        json
                            .decodeFromJsonElement<PaymentFlowsPaymentIntentAsyncWorkflows>(
                                it,
                            )
                    },
                lastPaymentError =
                    rawObject["last_payment_error"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlinePaymentIntentLastPaymentErrorXae7d80fa?>(element)
                        }
                    },
                latestCharge =
                    rawObject["latest_charge"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlinePaymentIntentLatestChargeXddbf3551?>(element)
                        }
                    },
                managedPayments =
                    rawObject["managed_payments"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentIntentManagedPaymentsX593f2137?>(element)
                        }
                    },
                metadata = rawObject["metadata"]?.let { json.decodeFromJsonElement<Map<String, String>>(it) },
                nextAction =
                    rawObject["next_action"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlinePaymentIntentNextActionXf46d948f?>(element)
                        }
                    },
                onBehalfOf =
                    rawObject["on_behalf_of"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentIntentOnBehalfOfXf11f3a8f?>(element)
                        }
                    },
                paymentDetails =
                    rawObject["payment_details"]?.let {
                        json
                            .decodeFromJsonElement<PaymentFlowsPaymentDetails>(
                                it,
                            )
                    },
                paymentMethod =
                    rawObject["payment_method"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentIntentPaymentMethodX9670d419?>(element)
                        }
                    },
                paymentMethodConfigurationDetails =
                    rawObject["payment_method_configuration_details"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentIntentPaymentMethodConfigurationDetailsXa9c290a1?>(
                                element,
                            )
                        }
                    },
                paymentMethodOptions =
                    rawObject["payment_method_options"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentIntentPaymentMethodOptionsX8c4198d2?>(element)
                        }
                    },
                paymentMethodTypes =
                ...
                processing =
                    rawObject["processing"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlinePaymentIntentProcessingX5a7361cd?>(element)
                        }
                    },
                receiptEmail =
                    rawObject["receipt_email"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                review =
                    rawObject["review"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlinePaymentIntentReviewX626eb3f1?>(element)
                        }
                    },
                setupFutureUsage =
                    rawObject["setup_future_usage"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentIntentSetupFutureUsageX44bafcda?>(element)
                        }
                    },
                shipping =
                    rawObject["shipping"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentIntentShippingXd9b79a0a?>(element)
                        }
                    },
                statementDescriptor =
                ...
                statementDescriptorSuffix =
                    rawObject["statement_descriptor_suffix"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                transferData =
                    rawObject["transfer_data"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentIntentTransferDataX3979a94c?>(element)
                        }
                    },
                transferGroup =
        ...
        override fun serialize(
            ...
            val raw =
                buildJsonObject {
                    ...
                    value.automaticPaymentMethods?.let {
                        put(
