...
public sealed class InlinePortalFlowsFlowTypeX27d83801 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePortalFlowsFlowTypeX27d83801 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlinePortalFlowsFlowTypeX27d83801> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePortalFlowsFlowTypeX27d83801",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePortalFlowsFlowTypeX27d83801 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePortalFlowsFlowTypeX27d83801,
        ) {
