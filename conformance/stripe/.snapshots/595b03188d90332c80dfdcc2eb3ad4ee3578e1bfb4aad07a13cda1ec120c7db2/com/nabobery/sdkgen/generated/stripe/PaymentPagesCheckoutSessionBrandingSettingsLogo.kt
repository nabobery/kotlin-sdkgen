...
public class PaymentPagesCheckoutSessionBrandingSettingsLogo(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentPagesCheckoutSessionBrandingSettingsLogo =
    ...
    public object Serializer : KSerializer<PaymentPagesCheckoutSessionBrandingSettingsLogo> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "PaymentPagesCheckoutSessionBrandingSettingsLogo must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlinePaymentPagesCheckoutSessionBrandingSettingsLogoTypeXb1f8ecdc>(
                    rawObject,
                    "type",
                )
            return PaymentPagesCheckoutSessionBrandingSettingsLogo(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentPagesCheckoutSessionBrandingSettingsLogo,
        ) {
...
public fun paymentPagesCheckoutSessionBrandingSettingsLogo(
    block: PaymentPagesCheckoutSessionBrandingSettingsLogo.Builder.() -> Unit,
): PaymentPagesCheckoutSessionBrandingSettingsLogo = PaymentPagesCheckoutSessionBrandingSettingsLogo.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "PaymentPagesCheckoutSessionBrandingSettingsLogo is missing required property '" + name + "'",
            )
