...
public sealed class InlineIssuingPhysicalBundleFeaturesSecondLineX6cb11ac2 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineIssuingPhysicalBundleFeaturesSecondLineX6cb11ac2 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineIssuingPhysicalBundleFeaturesSecondLineX6cb11ac2> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineIssuingPhysicalBundleFeaturesSecondLineX6cb11ac2",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineIssuingPhysicalBundleFeaturesSecondLineX6cb11ac2 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineIssuingPhysicalBundleFeaturesSecondLineX6cb11ac2,
        ) {
