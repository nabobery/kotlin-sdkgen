...
public class InlineV1PayoutsGetParameterX00f01c31 internal constructor(
    ...
    public val inlineV1PayoutsGetParameterAnyOf1Xe34a804d: InlineV1PayoutsGetParameterAnyOf1Xe34a804d?
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1PayoutsGetParameterAnyOf1Xe34a804d) {
                json
                    .decodeFromJsonElement<InlineV1PayoutsGetParameterAnyOf1Xe34a804d>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1PayoutsGetParameterX00f01c31Branch>
        get() =
            buildSet {
                if (inspection.matchesInlineV1PayoutsGetParameterAnyOf1Xe34a804d) {
                    add(
                        InlineV1PayoutsGetParameterX00f01c31Branch.InlineV1PayoutsGetParameterAnyOf1Xe34a804d,
                    )
                }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1PayoutsGetParameterX00f01c31 {
            val inspection = inspectInlineV1PayoutsGetParameterX00f01c31(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1PayoutsGetParameterX00f01c31NoMatchException(
                    "InlineV1PayoutsGetParameterX00f01c31 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1PayoutsGetParameterX00f01c31> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PayoutsGetParameterX00f01c31,
        ) {
...
private fun inspectInlineV1PayoutsGetParameterX00f01c31(
    element: JsonElement,
): InlineV1PayoutsGetParameterX00f01c31Inspection {
    val matchesInlineV1PayoutsGetParameterAnyOf1Xe34a804d =
        element
            .isJsonDecodable<InlineV1PayoutsGetParameterAnyOf1Xe34a804d>()
    ...
    return InlineV1PayoutsGetParameterX00f01c31Inspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1PayoutsGetParameterAnyOf1Xe34a804d) {
                    add(
                        "InlineV1PayoutsGetParameterAnyOf1Xe34a804d: value does not match InlineV1PayoutsGetParameterAnyOf1Xe34a804d",
                    )
                }
