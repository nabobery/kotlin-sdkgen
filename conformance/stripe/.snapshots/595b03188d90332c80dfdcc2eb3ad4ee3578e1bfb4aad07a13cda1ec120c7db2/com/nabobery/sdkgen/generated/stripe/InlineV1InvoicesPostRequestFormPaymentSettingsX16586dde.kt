...
public class InlineV1InvoicesPostRequestFormPaymentSettingsX16586dde(
    public val defaultMandate: InlineV1InvoicesPostRequestFormPaymentSettingsDefaultMandateX5cf8ed96? = null,
    public val paymentMethodOptions: InlineV1InvoicesPostRequestFormPaymentSettingsPaymentMethodOptionsXd05ced23? = null,
    public val paymentMethodTypes: InlineV1InvoicesPostRequestFormPaymentSettingsPaymentMethodTypesXb9bf1472? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1InvoicesPostRequestFormPaymentSettingsX16586dde =
            InlineV1InvoicesPostRequestFormPaymentSettingsX16586dde(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1InvoicesPostRequestFormPaymentSettingsX16586dde =
    ...
    public object Serializer : KSerializer<InlineV1InvoicesPostRequestFormPaymentSettingsX16586dde> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1InvoicesPostRequestFormPaymentSettingsX16586dde must be a JSON object",
                    )
            return InlineV1InvoicesPostRequestFormPaymentSettingsX16586dde(
                defaultMandate =
                    rawObject["default_mandate"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1InvoicesPostRequestFormPaymentSettingsDefaultMandateX5cf8ed96>(
                                it,
                            )
                    },
                paymentMethodOptions =
                    rawObject["payment_method_options"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1InvoicesPostRequestFormPaymentSettingsPaymentMethodOptionsXd05ced23>(
                                it,
                            )
                    },
                paymentMethodTypes =
                    rawObject["payment_method_types"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1InvoicesPostRequestFormPaymentSettingsPaymentMethodTypesXb9bf1472>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesPostRequestFormPaymentSettingsX16586dde,
        ) {
...
public fun inlineV1InvoicesPostRequestFormPaymentSettingsX16586dde(
    block: InlineV1InvoicesPostRequestFormPaymentSettingsX16586dde.Builder.() -> Unit,
): InlineV1InvoicesPostRequestFormPaymentSettingsX16586dde =
    InlineV1InvoicesPostRequestFormPaymentSettingsX16586dde.build(block)
