...
public class InlineIssuingDisputeDuplicateEvidenceAdditionalDocumentationXe7af1f67 internal constructor(
    ...
    private val inspection: InlineIssuingDisputeDuplicateEvidenceAdditionalDocumentationXe7af1f67Inspection,
) {
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineIssuingDisputeDuplicateEvidenceAdditionalDocumentationXe7af1f67Branch.Branch1,
                    )
                }
                if (inspection.matchesFile) {
                    add(
                        InlineIssuingDisputeDuplicateEvidenceAdditionalDocumentationXe7af1f67Branch.File,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineIssuingDisputeDuplicateEvidenceAdditionalDocumentationXe7af1f67 {
            val inspection = inspectInlineIssuingDisputeDuplicateEvidenceAdditionalDocumentationXe7af1f67(raw)
            if (inspection.matchCount == 0) {
                throw InlineIssuingDisputeDuplicateEvidenceAdditionalDocumentationXe7af1f67NoMatchException(
                    "InlineIssuingDisputeDuplicateEvidenceAdditionalDocumentationXe7af1f67 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineIssuingDisputeDuplicateEvidenceAdditionalDocumentationXe7af1f67> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineIssuingDisputeDuplicateEvidenceAdditionalDocumentationXe7af1f67,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineIssuingDisputeDuplicateEvidenceAdditionalDocumentationXe7af1f67",
...
private fun inspectInlineIssuingDisputeDuplicateEvidenceAdditionalDocumentationXe7af1f67(
    element: JsonElement,
