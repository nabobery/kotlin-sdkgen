...
public sealed class InlineBillingMeterResourceCustomerMappingSettingsTypeX23cc2b38 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineBillingMeterResourceCustomerMappingSettingsTypeX23cc2b38 =
            when (value) {
                ById.value -> ById
    ...
    public object Serializer : KSerializer<InlineBillingMeterResourceCustomerMappingSettingsTypeX23cc2b38> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineBillingMeterResourceCustomerMappingSettingsTypeX23cc2b38",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineBillingMeterResourceCustomerMappingSettingsTypeX23cc2b38 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineBillingMeterResourceCustomerMappingSettingsTypeX23cc2b38,
        ) {
