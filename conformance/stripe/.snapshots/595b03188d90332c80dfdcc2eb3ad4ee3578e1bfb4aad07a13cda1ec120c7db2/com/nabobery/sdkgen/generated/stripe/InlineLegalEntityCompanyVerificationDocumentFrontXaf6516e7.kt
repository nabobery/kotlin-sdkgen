...
public class InlineLegalEntityCompanyVerificationDocumentFrontXaf6516e7 internal constructor(
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineLegalEntityCompanyVerificationDocumentFrontXaf6516e7Branch.Branch1,
                    )
                }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineLegalEntityCompanyVerificationDocumentFrontXaf6516e7 {
            val inspection = inspectInlineLegalEntityCompanyVerificationDocumentFrontXaf6516e7(raw)
            if (inspection.matchCount == 0) {
                throw InlineLegalEntityCompanyVerificationDocumentFrontXaf6516e7NoMatchException(
                    "InlineLegalEntityCompanyVerificationDocumentFrontXaf6516e7 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineLegalEntityCompanyVerificationDocumentFrontXaf6516e7> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineLegalEntityCompanyVerificationDocumentFrontXaf6516e7,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineLegalEntityCompanyVerificationDocumentFrontXaf6516e7",
...
private fun inspectInlineLegalEntityCompanyVerificationDocumentFrontXaf6516e7(
    element: JsonElement,
): InlineLegalEntityCompanyVerificationDocumentFrontXaf6516e7Inspection {
