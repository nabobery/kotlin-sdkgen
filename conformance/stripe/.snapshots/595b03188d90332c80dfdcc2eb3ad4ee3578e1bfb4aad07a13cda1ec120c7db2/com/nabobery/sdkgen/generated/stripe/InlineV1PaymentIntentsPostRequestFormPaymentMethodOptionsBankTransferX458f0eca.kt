...
public class InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsBankTransferX458f0eca(
    ...
    public val euBankTransfer: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsEuBankTransferXf1cfb8fd? = null,
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsBankTransferX458f0eca =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsBankTransferX458f0eca> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsBankTransferX458f0eca must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsTypeX41e55988>(
                    rawObject,
                    "type",
                )
            return InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsBankTransferX458f0eca(
                ...
                euBankTransfer =
                    rawObject["eu_bank_transfer"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsEuBankTransferXf1cfb8fd>(
                                it,
                            )
                    },
                requestedAddressTypes =
                    rawObject["requested_address_types"]?.let {
                        json
                            .decodeFromJsonElement<List<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsItemX69b79ed7>>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsBankTransferX458f0eca,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsBankTransferX458f0eca(
    block: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsBankTransferX458f0eca.Builder.() -> Unit,
): InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsBankTransferX458f0eca =
    InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsBankTransferX458f0eca.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsBankTransferX458f0eca is missing required property '" +
                    name +
                    "'",
            )
