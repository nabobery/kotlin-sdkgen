...
public sealed class InlineFileObjectValueX810b8265 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineFileObjectValueX810b8265 =
            when (value) {
                File.value -> File
    ...
    public object Serializer : KSerializer<InlineFileObjectValueX810b8265> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineFileObjectValueX810b8265",
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineFileObjectValueX810b8265,
        ) {
