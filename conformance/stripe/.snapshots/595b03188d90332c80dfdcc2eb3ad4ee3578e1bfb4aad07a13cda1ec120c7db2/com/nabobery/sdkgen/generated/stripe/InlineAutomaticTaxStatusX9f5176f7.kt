...
public sealed class InlineAutomaticTaxStatusX9f5176f7 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineAutomaticTaxStatusX9f5176f7 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineAutomaticTaxStatusX9f5176f7> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineAutomaticTaxStatusX9f5176f7",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineAutomaticTaxStatusX9f5176f7 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineAutomaticTaxStatusX9f5176f7,
        ) {
