...
public class PortalResourceScheduleUpdateAtPeriodEnd(
    ...
    public class Builder {
        ...
        public var conditions: List<PortalResourceScheduleUpdateAtPeriodEndCondition>
            get() = requireNotNull(conditionsValue) { "conditions is required" }
            set(`value`) {
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PortalResourceScheduleUpdateAtPeriodEnd =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PortalResourceScheduleUpdateAtPeriodEnd> {
        ...
        override fun deserialize(decoder: Decoder): PortalResourceScheduleUpdateAtPeriodEnd {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PortalResourceScheduleUpdateAtPeriodEnd must be a JSON object")
            val conditions =
                json.decodeRequired<List<PortalResourceScheduleUpdateAtPeriodEndCondition>>(
                    rawObject,
                    "conditions",
                )
            return PortalResourceScheduleUpdateAtPeriodEnd(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PortalResourceScheduleUpdateAtPeriodEnd,
        ) {
...
public fun portalResourceScheduleUpdateAtPeriodEnd(
    block: PortalResourceScheduleUpdateAtPeriodEnd.Builder.() -> Unit,
): PortalResourceScheduleUpdateAtPeriodEnd = PortalResourceScheduleUpdateAtPeriodEnd.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "PortalResourceScheduleUpdateAtPeriodEnd is missing required property '" + name + "'",
            )
