...
public class InlineV1CustomersBalanceTransactionsPostRequestFormX635abb1d(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1CustomersBalanceTransactionsPostRequestFormX635abb1d =
    ...
    public object Serializer : KSerializer<InlineV1CustomersBalanceTransactionsPostRequestFormX635abb1d> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CustomersBalanceTransactionsPostRequestFormX635abb1d must be a JSON object",
                    )
            ...
            return InlineV1CustomersBalanceTransactionsPostRequestFormX635abb1d(
                ...
                metadata =
                    rawObject["metadata"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CustomersBalanceTransactionsPostRequestFormMetadataXdddf617d>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersBalanceTransactionsPostRequestFormX635abb1d,
        ) {
...
public fun inlineV1CustomersBalanceTransactionsPostRequestFormX635abb1d(
    block: InlineV1CustomersBalanceTransactionsPostRequestFormX635abb1d.Builder.() -> Unit,
): InlineV1CustomersBalanceTransactionsPostRequestFormX635abb1d =
    InlineV1CustomersBalanceTransactionsPostRequestFormX635abb1d.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1CustomersBalanceTransactionsPostRequestFormX635abb1d is missing required property '" + name +
                    "'",
            )
