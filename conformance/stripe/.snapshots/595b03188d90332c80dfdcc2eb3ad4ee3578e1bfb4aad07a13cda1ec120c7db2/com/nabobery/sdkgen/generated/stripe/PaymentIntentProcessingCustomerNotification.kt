...
public class PaymentIntentProcessingCustomerNotification(
    ...
    public class Builder {
        ...
        public fun build(): PaymentIntentProcessingCustomerNotification =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentIntentProcessingCustomerNotification =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentIntentProcessingCustomerNotification> {
        ...
        override fun deserialize(decoder: Decoder): PaymentIntentProcessingCustomerNotification {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentIntentProcessingCustomerNotification must be a JSON object")
            return PaymentIntentProcessingCustomerNotification(
                approvalRequested =
                    rawObject["approval_requested"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                completesAt =
                    rawObject["completes_at"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentIntentProcessingCustomerNotification,
        ) {
...
public fun paymentIntentProcessingCustomerNotification(
    block: PaymentIntentProcessingCustomerNotification.Builder.() -> Unit,
): PaymentIntentProcessingCustomerNotification = PaymentIntentProcessingCustomerNotification.build(block)
