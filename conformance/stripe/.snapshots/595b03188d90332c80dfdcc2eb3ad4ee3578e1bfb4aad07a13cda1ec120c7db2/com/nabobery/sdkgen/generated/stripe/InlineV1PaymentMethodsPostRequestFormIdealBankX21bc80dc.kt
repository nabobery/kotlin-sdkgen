...
public sealed class InlineV1PaymentMethodsPostRequestFormIdealBankX21bc80dc {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1PaymentMethodsPostRequestFormIdealBankX21bc80dc =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1PaymentMethodsPostRequestFormIdealBankX21bc80dc> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1PaymentMethodsPostRequestFormIdealBankX21bc80dc",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1PaymentMethodsPostRequestFormIdealBankX21bc80dc =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentMethodsPostRequestFormIdealBankX21bc80dc,
        ) {
