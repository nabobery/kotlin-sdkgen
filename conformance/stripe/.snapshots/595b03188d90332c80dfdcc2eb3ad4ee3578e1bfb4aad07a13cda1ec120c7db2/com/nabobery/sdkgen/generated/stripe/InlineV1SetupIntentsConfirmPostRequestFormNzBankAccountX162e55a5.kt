...
public class InlineV1SetupIntentsConfirmPostRequestFormNzBankAccountX162e55a5(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1SetupIntentsConfirmPostRequestFormNzBankAccountX162e55a5 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1SetupIntentsConfirmPostRequestFormNzBankAccountX162e55a5> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1SetupIntentsConfirmPostRequestFormNzBankAccountX162e55a5 {
            val jsonDecoder =
                decoder.requireJsonDecoder(
                    "InlineV1SetupIntentsConfirmPostRequestFormNzBankAccountX162e55a5",
                )
            val json = jsonDecoder.json
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SetupIntentsConfirmPostRequestFormNzBankAccountX162e55a5 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SetupIntentsConfirmPostRequestFormNzBankAccountX162e55a5,
        ) {
            val jsonEncoder =
...
public fun inlineV1SetupIntentsConfirmPostRequestFormNzBankAccountX162e55a5(
    block: InlineV1SetupIntentsConfirmPostRequestFormNzBankAccountX162e55a5.Builder.() -> Unit,
): InlineV1SetupIntentsConfirmPostRequestFormNzBankAccountX162e55a5 =
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1SetupIntentsConfirmPostRequestFormNzBankAccountX162e55a5 is missing required property '" + name +
                    "'",
            )
