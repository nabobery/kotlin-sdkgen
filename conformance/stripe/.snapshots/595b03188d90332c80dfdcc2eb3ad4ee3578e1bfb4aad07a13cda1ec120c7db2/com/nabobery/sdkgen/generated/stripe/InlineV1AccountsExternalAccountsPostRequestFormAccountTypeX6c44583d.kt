...
public sealed class InlineV1AccountsExternalAccountsPostRequestFormAccountTypeX6c44583d {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1AccountsExternalAccountsPostRequestFormAccountTypeX6c44583d =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1AccountsExternalAccountsPostRequestFormAccountTypeX6c44583d> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1AccountsExternalAccountsPostRequestFormAccountTypeX6c44583d",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1AccountsExternalAccountsPostRequestFormAccountTypeX6c44583d = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsExternalAccountsPostRequestFormAccountTypeX6c44583d,
        ) {
