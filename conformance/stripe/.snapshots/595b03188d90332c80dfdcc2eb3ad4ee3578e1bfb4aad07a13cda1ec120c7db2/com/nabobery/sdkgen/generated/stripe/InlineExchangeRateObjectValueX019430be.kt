...
public sealed class InlineExchangeRateObjectValueX019430be {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineExchangeRateObjectValueX019430be =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineExchangeRateObjectValueX019430be> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineExchangeRateObjectValueX019430be",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineExchangeRateObjectValueX019430be =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineExchangeRateObjectValueX019430be,
        ) {
