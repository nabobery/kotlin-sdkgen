...
public sealed class InlineIssuingNetworkTokenDeviceTypeX0d97c801 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineIssuingNetworkTokenDeviceTypeX0d97c801 =
            when (value) {
                Other.value -> Other
                Phone.value -> Phone
                Watch.value -> Watch
    ...
    public object Serializer : KSerializer<InlineIssuingNetworkTokenDeviceTypeX0d97c801> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineIssuingNetworkTokenDeviceTypeX0d97c801",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineIssuingNetworkTokenDeviceTypeX0d97c801 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineIssuingNetworkTokenDeviceTypeX0d97c801,
        ) {
