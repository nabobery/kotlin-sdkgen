...
internal data class InlineV1CustomersBankAccountsPostRequestFormBankAccountX4187b37aInspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesInlineV1CustomersBankAccountsPostRequestFormBankAccountAnyOf1X8ded6596,
                matchesBranch2,
            ).count {
                it
            }
...
public class InlineV1CustomersBankAccountsPostRequestFormBankAccountX4187b37a internal constructor(
    ...
    private val inspection: InlineV1CustomersBankAccountsPostRequestFormBankAccountX4187b37aInspection,
) {
    public val inlineV1CustomersBankAccountsPostRequestFormBankAccountAnyOf1X8ded6596:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1CustomersBankAccountsPostRequestFormBankAccountAnyOf1X8ded6596) {
                json
                    .decodeFromJsonElement<InlineV1CustomersBankAccountsPostRequestFormBankAccountAnyOf1X8ded6596>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches:
        ...
        get() =
            buildSet {
                if (inspection.matchesInlineV1CustomersBankAccountsPostRequestFormBankAccountAnyOf1X8ded6596) {
                    add(
                        InlineV1CustomersBankAccountsPostRequestFormBankAccountX4187b37aBranch.InlineV1CustomersBankAccountsPostRequestFormBankAccountAnyOf1X8ded6596,
                    )
                }
                if (inspection.matchesBranch2) {
                    add(
                        InlineV1CustomersBankAccountsPostRequestFormBankAccountX4187b37aBranch.Branch2,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1CustomersBankAccountsPostRequestFormBankAccountX4187b37a {
            val inspection = inspectInlineV1CustomersBankAccountsPostRequestFormBankAccountX4187b37a(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1CustomersBankAccountsPostRequestFormBankAccountX4187b37aNoMatchException(
                    "InlineV1CustomersBankAccountsPostRequestFormBankAccountX4187b37a matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1CustomersBankAccountsPostRequestFormBankAccountX4187b37a> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersBankAccountsPostRequestFormBankAccountX4187b37a,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1CustomersBankAccountsPostRequestFormBankAccountX4187b37a",
...
private fun inspectInlineV1CustomersBankAccountsPostRequestFormBankAccountX4187b37a(
    element: JsonElement,
): InlineV1CustomersBankAccountsPostRequestFormBankAccountX4187b37aInspection {
    val matchesInlineV1CustomersBankAccountsPostRequestFormBankAccountAnyOf1X8ded6596 =
        element
            .isJsonDecodable<InlineV1CustomersBankAccountsPostRequestFormBankAccountAnyOf1X8ded6596>()
    ...
    return InlineV1CustomersBankAccountsPostRequestFormBankAccountX4187b37aInspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1CustomersBankAccountsPostRequestFormBankAccountAnyOf1X8ded6596) {
                    add(
                        "InlineV1CustomersBankAccountsPostRequestFormBankAccountAnyOf1X8ded6596: value does not match InlineV1CustomersBankAccountsPostRequestFormBankAccountAnyOf1X8ded6596",
                    )
                }
