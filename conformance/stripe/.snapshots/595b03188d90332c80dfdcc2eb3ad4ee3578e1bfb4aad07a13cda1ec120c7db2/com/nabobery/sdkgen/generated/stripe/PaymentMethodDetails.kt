...
public class PaymentMethodDetails(
    ...
    public object Serializer : KSerializer<PaymentMethodDetails> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodDetails {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodDetails must be a JSON object")
            ...
            return PaymentMethodDetails(
                ...
                acssDebit =
                    rawObject["acss_debit"]?.let {
                        json.decodeFromJsonElement<PaymentMethodDetailsAcssDebit>(
                            it,
                        )
                    },
                affirm = rawObject["affirm"]?.let {
                    json.decodeFromJsonElement<PaymentMethodDetailsAffirm>(
                        it,
                    )
                },
                afterpayClearpay =
                    rawObject["afterpay_clearpay"]?.let {
                        json.decodeFromJsonElement<PaymentMethodDetailsAfterpayClearpay>(it)
                    },
                alipay =
                ...
                amazonPay =
                    rawObject["amazon_pay"]?.let {
                        json.decodeFromJsonElement<PaymentMethodDetailsAmazonPay>(
                            it,
                        )
                    },
                auBecsDebit =
                ...
                bancontact =
                    rawObject["bancontact"]?.let {
                        json.decodeFromJsonElement<PaymentMethodDetailsBancontact>(
                            it,
                        )
                    },
                billie = rawObject["billie"]?.let {
                    json.decodeFromJsonElement<PaymentMethodDetailsBillie>(
                        it,
                    )
                },
                ...
                kakaoPay =
                    rawObject["kakao_pay"]?.let {
                        json.decodeFromJsonElement<PaymentMethodDetailsKakaoPay>(
                            it,
                        )
                    },
                ...
                mobilepay =
                    rawObject["mobilepay"]?.let {
                        json.decodeFromJsonElement<PaymentMethodDetailsMobilepay>(
                            it,
                        )
                    },
                multibanco =
                    rawObject["multibanco"]?.let {
                        json.decodeFromJsonElement<PaymentMethodDetailsMultibanco>(
                            it,
                        )
                    },
                naverPay = rawObject["naver_pay"]?.let {
                    json
                        .decodeFromJsonElement<PaymentMethodDetailsNaverPay>(
                            it,
                        )
                },
                nzBankAccount =
                ...
                promptpay =
                    rawObject["promptpay"]?.let {
                        json.decodeFromJsonElement<PaymentMethodDetailsPromptpay>(
                            it,
                        )
                    },
                revolutPay =
                    rawObject["revolut_pay"]?.let {
                        json.decodeFromJsonElement<PaymentMethodDetailsRevolutPay>(
                            it,
                        )
                    },
                samsungPay =
                    rawObject["samsung_pay"]?.let {
                        json.decodeFromJsonElement<PaymentMethodDetailsSamsungPay>(
                            it,
                        )
                    },
                satispay = rawObject["satispay"]?.let {
                    json
                        .decodeFromJsonElement<PaymentMethodDetailsSatispay>(
                            it,
                        )
                },
                ...
                sepaDebit =
                    rawObject["sepa_debit"]?.let {
                        json.decodeFromJsonElement<PaymentMethodDetailsSepaDebit>(
                            it,
                        )
                    },
                ...
                usBankAccount =
                    rawObject["us_bank_account"]?.let {
                        json
                            .decodeFromJsonElement<PaymentMethodDetailsUsBankAccount>(
                                it,
                            )
                    },
                ...
                wechatPay =
                    rawObject["wechat_pay"]?.let {
                        json.decodeFromJsonElement<PaymentMethodDetailsWechatPay>(
                            it,
                        )
                    },
...
public fun paymentMethodDetails(block: PaymentMethodDetails.Builder.() -> Unit): PaymentMethodDetails =
    PaymentMethodDetails.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("PaymentMethodDetails is missing required property '" + name + "'")
