...
@Serializable
public data class CustomerSessionResourceComponentsResourceCustomerSheetResourceFeaturesView(
    ...
    public val paymentMethodRemove: InlineCustomerSessionResou1a5dPaymentMethodRemoveXdde9e2a1? = null,
)
...
public class CustomerSessionResourceComponentsResourceCustomerSheetResourceFeatures(
    ...
    public class Builder {
        ...
        public fun build(): CustomerSessionResourceComponentsResourceCustomerSheetResourceFeatures =
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): CustomerSessionResourceComponentsResourceCustomerSheetResourceFeatures = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<CustomerSessionResourceComponentsResourceCustomerSheetResourceFeatures> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "CustomerSessionResourceComponentsResourceCustomerSheetResourceFeatures must be a JSON object",
                    )
                ...
                paymentMethodAllowRedisplayFilters =
                    rawObject["payment_method_allow_redisplay_filters"]?.let { element ->
                        if (element ==
                            ...
                            json
                                .decodeFromJsonElement<List<InlineCustomerSessionResou1a5dPaymentMethodAllowRea1fdItemX950ca000>?>(
                                    element,
                                )
                        }
                    },
                paymentMethodRemove =
                    rawObject["payment_method_remove"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineCustomerSessionResou1a5dPaymentMethodRemoveXdde9e2a1?>(
                                element,
                            )
                        }
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: CustomerSessionResourceComponentsResourceCustomerSheetResourceFeatures,
        ) {
            val jsonEncoder =
...
public fun customerSessionResourceComponentsResourceCustomerSheetResourceFeatures(
    block: CustomerSessionResourceComponentsResourceCustomerSheetResourceFeatures.Builder.() -> Unit,
): CustomerSessionResourceComponentsResourceCustomerSheetResourceFeatures =
    CustomerSessionResourceComponentsResourceCustomerSheetResourceFeatures.build(block)
