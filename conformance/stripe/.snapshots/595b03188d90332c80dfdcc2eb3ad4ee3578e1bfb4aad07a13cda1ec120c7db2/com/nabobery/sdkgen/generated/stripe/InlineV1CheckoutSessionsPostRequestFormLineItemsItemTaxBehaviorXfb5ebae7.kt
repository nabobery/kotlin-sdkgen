...
public sealed class InlineV1CheckoutSessionsPostRequestFormLineItemsItemTaxBehaviorXfb5ebae7 {
    ...
    public object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormLineItemsItemTaxBehaviorXfb5ebae7> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1CheckoutSessionsPostRequestFormLineItemsItemTaxBehaviorXfb5ebae7",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1CheckoutSessionsPostRequestFormLineItemsItemTaxBehaviorXfb5ebae7 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsPostRequestFormLineItemsItemTaxBehaviorXfb5ebae7,
        ) {
