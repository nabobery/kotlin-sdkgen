...
public class PaymentMethodDetailsPaymentRecordNaverPay(
    ...
    public class Builder {
        ...
        public fun build(): PaymentMethodDetailsPaymentRecordNaverPay =
            PaymentMethodDetailsPaymentRecordNaverPay(
                buyerId = buyerId,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentMethodDetailsPaymentRecordNaverPay =
    ...
    public object Serializer : KSerializer<PaymentMethodDetailsPaymentRecordNaverPay> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodDetailsPaymentRecordNaverPay {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodDetailsPaymentRecordNaverPay must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentMethodDetailsPaymentRecordNaverPay,
        ) {
...
public fun paymentMethodDetailsPaymentRecordNaverPay(
    block: PaymentMethodDetailsPaymentRecordNaverPay.Builder.() -> Unit,
): PaymentMethodDetailsPaymentRecordNaverPay = PaymentMethodDetailsPaymentRecordNaverPay.build(block)
