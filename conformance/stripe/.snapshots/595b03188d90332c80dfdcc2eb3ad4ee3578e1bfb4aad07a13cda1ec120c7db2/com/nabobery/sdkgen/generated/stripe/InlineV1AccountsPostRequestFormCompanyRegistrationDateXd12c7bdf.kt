...
internal data class InlineV1AccountsPostRequestFormCompanyRegistrationDateXd12c7bdfInspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesInlineV1AccountsPostRequestFormCompanyRegistrationDateAnyOf1X73ea318a,
                matchesInlineV1AccountsPostRequestFormCompanyRegistrationDateAnyOf2X2ab90b12,
            ).count {
                it
            }
}
...
public class InlineV1AccountsPostRequestFormCompanyRegistrationDateXd12c7bdf internal constructor(
    ...
    public val inlineV1AccountsPostRequestFormCompanyRegistrationDateAnyOf1X73ea318a:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1AccountsPostRequestFormCompanyRegistrationDateAnyOf1X73ea318a) {
                json
                    .decodeFromJsonElement<InlineV1AccountsPostRequestFormCompanyRegistrationDateAnyOf1X73ea318a>(
                        raw,
                    )
            } else {
                null
    ...
    public val inlineV1AccountsPostRequestFormCompanyRegistrationDateAnyOf2X2ab90b12:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1AccountsPostRequestFormCompanyRegistrationDateAnyOf2X2ab90b12) {
                json
                    .decodeFromJsonElement<InlineV1AccountsPostRequestFormCompanyRegistrationDateAnyOf2X2ab90b12>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches:
        ...
        get() =
            buildSet {
                if (inspection.matchesInlineV1AccountsPostRequestFormCompanyRegistrationDateAnyOf1X73ea318a) {
                    add(
                        InlineV1AccountsPostRequestFormCompanyRegistrationDateXd12c7bdfBranch.InlineV1AccountsPostRequestFormCompanyRegistrationDateAnyOf1X73ea318a,
                    )
                }
                if (inspection.matchesInlineV1AccountsPostRequestFormCompanyRegistrationDateAnyOf2X2ab90b12) {
                    add(
                        InlineV1AccountsPostRequestFormCompanyRegistrationDateXd12c7bdfBranch.InlineV1AccountsPostRequestFormCompanyRegistrationDateAnyOf2X2ab90b12,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1AccountsPostRequestFormCompanyRegistrationDateXd12c7bdf {
            val inspection = inspectInlineV1AccountsPostRequestFormCompanyRegistrationDateXd12c7bdf(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1AccountsPostRequestFormCompanyRegistrationDateXd12c7bdfNoMatchException(
                    "InlineV1AccountsPostRequestFormCompanyRegistrationDateXd12c7bdf matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1AccountsPostRequestFormCompanyRegistrationDateXd12c7bdf> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPostRequestFormCompanyRegistrationDateXd12c7bdf,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1AccountsPostRequestFormCompanyRegistrationDateXd12c7bdf",
...
private fun inspectInlineV1AccountsPostRequestFormCompanyRegistrationDateXd12c7bdf(
    element: JsonElement,
): InlineV1AccountsPostRequestFormCompanyRegistrationDateXd12c7bdfInspection {
    val matchesInlineV1AccountsPostRequestFormCompanyRegistrationDateAnyOf1X73ea318a =
        element
            .isJsonDecodable<InlineV1AccountsPostRequestFormCompanyRegistrationDateAnyOf1X73ea318a>()
    val matchesInlineV1AccountsPostRequestFormCompanyRegistrationDateAnyOf2X2ab90b12 =
        element
            .isJsonDecodable<InlineV1AccountsPostRequestFormCompanyRegistrationDateAnyOf2X2ab90b12>()
    return InlineV1AccountsPostRequestFormCompanyRegistrationDateXd12c7bdfInspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1AccountsPostRequestFormCompanyRegistrationDateAnyOf1X73ea318a) {
                    add(
                        "InlineV1AccountsPostRequestFormCompanyRegistrationDateAnyOf1X73ea318a: value does not match InlineV1AccountsPostRequestFormCompanyRegistrationDateAnyOf1X73ea318a",
                    )
                }
                if (!matchesInlineV1AccountsPostRequestFormCompanyRegistrationDateAnyOf2X2ab90b12) {
                    add(
                        "InlineV1AccountsPostRequestFormCompanyRegistrationDateAnyOf2X2ab90b12: value does not match InlineV1AccountsPostRequestFormCompanyRegistrationDateAnyOf2X2ab90b12",
                    )
                }
            },
    )
