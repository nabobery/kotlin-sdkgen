...
public class InlineV1ProductsFeaturesPostRequestFormXa8a76f9a(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1ProductsFeaturesPostRequestFormXa8a76f9a =
    ...
    public object Serializer : KSerializer<InlineV1ProductsFeaturesPostRequestFormXa8a76f9a> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1ProductsFeaturesPostRequestFormXa8a76f9a must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ProductsFeaturesPostRequestFormXa8a76f9a,
        ) {
...
public fun inlineV1ProductsFeaturesPostRequestFormXa8a76f9a(
    block: InlineV1ProductsFeaturesPostRequestFormXa8a76f9a.Builder.() -> Unit,
): InlineV1ProductsFeaturesPostRequestFormXa8a76f9a = InlineV1ProductsFeaturesPostRequestFormXa8a76f9a.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1ProductsFeaturesPostRequestFormXa8a76f9a is missing required property '" + name + "'",
            )
