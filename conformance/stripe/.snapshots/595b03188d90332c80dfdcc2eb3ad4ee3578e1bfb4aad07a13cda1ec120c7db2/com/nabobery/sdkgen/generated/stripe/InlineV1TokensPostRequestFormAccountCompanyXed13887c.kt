...
public class InlineV1TokensPostRequestFormAccountCompanyXed13887c(
    ...
    public val ownershipDeclaration: InlineV1TokensPostRequestFormAccountCompanyOwnershipDeclarationX626d044c? = null,
    ...
    public val registrationDate: InlineV1TokensPostRequestFormAccountCompanyRegistrationDateX9134620b? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1TokensPostRequestFormAccountCompanyXed13887c =
            InlineV1TokensPostRequestFormAccountCompanyXed13887c(
                address = address,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TokensPostRequestFormAccountCompanyXed13887c =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TokensPostRequestFormAccountCompanyXed13887c> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TokensPostRequestFormAccountCompanyXed13887c must be a JSON object",
                    )
            return InlineV1TokensPostRequestFormAccountCompanyXed13887c(
                address =
                    rawObject["address"]?.let {
                        json.decodeFromJsonElement<InlineV1TokensPostRequestFormAccountCompanyAddressX1110443c>(it)
                    },
                addressKana =
                    rawObject["address_kana"]?.let {
                        json.decodeFromJsonElement<InlineV1TokensPostRequestFormAccountCompanyAddressKanaXc691bf16>(it)
                    },
                addressKanji =
                    rawObject["address_kanji"]?.let {
                        json.decodeFromJsonElement<InlineV1TokensPostRequestFormAccountCompanyAddressKanjiX000c8ab4>(it)
                    },
                directorsProvided =
                ...
                directorshipDeclaration =
                    rawObject["directorship_declaration"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TokensPostRequestFormAccountCompanyDirectorshipDeclarationX1b280f45>(
                                it,
                            )
                    },
                executivesProvided =
                ...
                ownershipDeclaration =
                    rawObject["ownership_declaration"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TokensPostRequestFormAccountCompanyOwnershipDeclarationX626d044c>(
                                it,
                            )
                    },
                ownershipDeclarationShownAndSigned =
                    rawObject["ownership_declaration_shown_and_signed"]?.let {
                        json.decodeFromJsonElement<Boolean>(it)
                    },
                ownershipExemptionReason =
                    rawObject["ownership_exemption_reason"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TokensPostRequestFormAccountCompanyOwnershipExemptionReasonX9abd2988>(
                                it,
                            )
                    },
                ...
                registrationDate =
                    rawObject["registration_date"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TokensPostRequestFormAccountCompanyRegistrationDateX9134620b>(
                                it,
                            )
                    },
                registrationNumber =
                ...
                representativeDeclaration =
                    rawObject["representative_declaration"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TokensPostRequestFormAccountCompanyRepresentativeDeclarationXdf264256>(
                                it,
                            )
                    },
                structure =
                    rawObject["structure"]?.let {
                        json.decodeFromJsonElement<InlineV1TokensPostRequestFormAccountCompanyStructureXdcad5343>(it)
                    },
                ...
                verification =
                    rawObject["verification"]?.let {
                        json.decodeFromJsonElement<InlineV1TokensPostRequestFormAccountCompanyVerificationX23f97bec>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TokensPostRequestFormAccountCompanyXed13887c,
        ) {
            ...
            val raw =
                buildJsonObject {
                    ...
                    value.ownershipDeclarationShownAndSigned?.let {
                        put("ownership_declaration_shown_and_signed", json.encodeToJsonElement(it))
                    }
...
public fun inlineV1TokensPostRequestFormAccountCompanyXed13887c(
    block: InlineV1TokensPostRequestFormAccountCompanyXed13887c.Builder.() -> Unit,
): InlineV1TokensPostRequestFormAccountCompanyXed13887c =
    InlineV1TokensPostRequestFormAccountCompanyXed13887c.build(block)
