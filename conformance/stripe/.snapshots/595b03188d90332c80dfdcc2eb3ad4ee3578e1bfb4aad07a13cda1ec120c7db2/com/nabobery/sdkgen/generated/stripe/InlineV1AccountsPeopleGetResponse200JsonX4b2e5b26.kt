...
public class InlineV1AccountsPeopleGetResponse200JsonX4b2e5b26(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1AccountsPeopleGetResponse200JsonX4b2e5b26 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1AccountsPeopleGetResponse200JsonX4b2e5b26> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountsPeopleGetResponse200JsonX4b2e5b26 must be a JSON object",
                    )
            val data = json.decodeRequired<List<Person>>(rawObject, "data")
            val hasMore = json.decodeRequired<Boolean>(rawObject, "has_more")
            val objectValue =
                json.decodeRequired<InlineV1AccountsPeopleGetResponse200JsonObjectValueX4fe2c942>(
                    rawObject,
                    "object",
                )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPeopleGetResponse200JsonX4b2e5b26,
        ) {
...
public fun inlineV1AccountsPeopleGetResponse200JsonX4b2e5b26(
    block: InlineV1AccountsPeopleGetResponse200JsonX4b2e5b26.Builder.() -> Unit,
): InlineV1AccountsPeopleGetResponse200JsonX4b2e5b26 = InlineV1AccountsPeopleGetResponse200JsonX4b2e5b26.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1AccountsPeopleGetResponse200JsonX4b2e5b26 is missing required property '" + name + "'",
            )
