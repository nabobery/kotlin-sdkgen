...
public class InlineV1SubscriptionSchedulesPostRequestFormPhasesItemStartXf9c77616(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1SubscriptionSchedulesPostRequestFormPhasesItemStartXf9c77616 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemStartXf9c77616> {
        override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1SubscriptionSchedulesPostRequestFormPhasesItemStartXf9c77616 {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SubscriptionSchedulesPostRequestFormPhasesItemStartXf9c77616 must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemTypeX299b76a6>(
                    rawObject,
                    "type",
                )
            return InlineV1SubscriptionSchedulesPostRequestFormPhasesItemStartXf9c77616(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionSchedulesPostRequestFormPhasesItemStartXf9c77616,
        ) {
            val jsonEncoder =
...
public fun inlineV1SubscriptionSchedulesPostRequestFormPhasesItemStartXf9c77616(
    block: InlineV1SubscriptionSchedulesPostRequestFormPhasesItemStartXf9c77616.Builder.() -> Unit,
): InlineV1SubscriptionSchedulesPostRequestFormPhasesItemStartXf9c77616 =
    InlineV1SubscriptionSchedulesPostRequestFormPhasesItemStartXf9c77616.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1SubscriptionSchedulesPostRequestFormPhasesItemStartXf9c77616 is missing required property '" +
                    name +
                    "'",
            )
