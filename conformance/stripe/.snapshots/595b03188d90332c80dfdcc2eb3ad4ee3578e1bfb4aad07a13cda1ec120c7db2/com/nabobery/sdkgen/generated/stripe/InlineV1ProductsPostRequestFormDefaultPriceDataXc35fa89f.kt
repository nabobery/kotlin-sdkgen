...
public class InlineV1ProductsPostRequestFormDefaultPriceDataXc35fa89f(
    ...
    public val customUnitAmount: InlineV1ProductsPostRequestFormDefaultPriceDataCustomUnitAmountX8862e626? = null,
    public val metadata: Map<String, String>? = null,
    public val recurring: InlineV1ProductsPostRequestFormDefaultPriceDataRecurringX5a8b0783? = null,
    public val taxBehavior: InlineV1ProductsPostRequestFormDefaultPriceDataTaxBehaviorX82b5e45a? = null,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1ProductsPostRequestFormDefaultPriceDataXc35fa89f =
    ...
    public object Serializer : KSerializer<InlineV1ProductsPostRequestFormDefaultPriceDataXc35fa89f> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1ProductsPostRequestFormDefaultPriceDataXc35fa89f must be a JSON object",
                    )
            ...
            return InlineV1ProductsPostRequestFormDefaultPriceDataXc35fa89f(
                ...
                currencyOptions =
                    rawObject["currency_options"]?.let {
                        json
                            .decodeFromJsonElement<Map<String, InlineV1ProductsPostRequestFormDefaultPriceDataAdditionalValueX31f90766>>(
                                it,
                            )
                    },
                customUnitAmount =
                    rawObject["custom_unit_amount"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1ProductsPostRequestFormDefaultPriceDataCustomUnitAmountX8862e626>(
                                it,
                            )
                    },
                ...
                recurring =
                    rawObject["recurring"]?.let {
                        json.decodeFromJsonElement<InlineV1ProductsPostRequestFormDefaultPriceDataRecurringX5a8b0783>(
                            it,
                        )
                    },
                taxBehavior =
                    rawObject["tax_behavior"]?.let {
                        json.decodeFromJsonElement<InlineV1ProductsPostRequestFormDefaultPriceDataTaxBehaviorX82b5e45a>(
                            it,
                        )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ProductsPostRequestFormDefaultPriceDataXc35fa89f,
        ) {
...
public fun inlineV1ProductsPostRequestFormDefaultPriceDataXc35fa89f(
    block: InlineV1ProductsPostRequestFormDefaultPriceDataXc35fa89f.Builder.() -> Unit,
): InlineV1ProductsPostRequestFormDefaultPriceDataXc35fa89f =
    InlineV1ProductsPostRequestFormDefaultPriceDataXc35fa89f.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1ProductsPostRequestFormDefaultPriceDataXc35fa89f is missing required property '" + name + "'",
            )
