...
public data class PaymentIntentPaymentMethodOptionsAcssDebitView(
    ...
    public val setupFutureUsage: InlinePaymentIntentPaymentMethodOptionsAcssDebitSetupFutureUsageX63d4bf2a? = null,
    @SerialName("target_date")
    public val targetDate: String? = null,
    @SerialName("verification_method")
    public val verificationMethod: InlinePaymentIntentPaymentMethodOptionsAcssDebitVerificationMethodX54db9487? = null,
)
...
public class PaymentIntentPaymentMethodOptionsAcssDebit(
    ...
    public class Builder {
        ...
        public fun build(): PaymentIntentPaymentMethodOptionsAcssDebit =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentIntentPaymentMethodOptionsAcssDebit =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentIntentPaymentMethodOptionsAcssDebit> {
        ...
        override fun deserialize(decoder: Decoder): PaymentIntentPaymentMethodOptionsAcssDebit {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentIntentPaymentMethodOptionsAcssDebit must be a JSON object")
            return PaymentIntentPaymentMethodOptionsAcssDebit(
                mandateOptions =
                    rawObject["mandate_options"]?.let {
                        json.decodeFromJsonElement<PaymentIntentPaymentMethodOptionsMandateOptionsAcssDebit>(it)
                    },
                setupFutureUsage =
                    rawObject["setup_future_usage"]?.let {
                        json
                            .decodeFromJsonElement<InlinePaymentIntentPaymentMethodOptionsAcssDebitSetupFutureUsageX63d4bf2a>(
                                it,
                            )
                    },
                ...
                verificationMethod =
                    rawObject["verification_method"]?.let {
                        json
                            .decodeFromJsonElement<InlinePaymentIntentPaymentMethodOptionsAcssDebitVerificationMethodX54db9487>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentIntentPaymentMethodOptionsAcssDebit,
        ) {
...
public fun paymentIntentPaymentMethodOptionsAcssDebit(
    block: PaymentIntentPaymentMethodOptionsAcssDebit.Builder.() -> Unit,
): PaymentIntentPaymentMethodOptionsAcssDebit = PaymentIntentPaymentMethodOptionsAcssDebit.build(block)
