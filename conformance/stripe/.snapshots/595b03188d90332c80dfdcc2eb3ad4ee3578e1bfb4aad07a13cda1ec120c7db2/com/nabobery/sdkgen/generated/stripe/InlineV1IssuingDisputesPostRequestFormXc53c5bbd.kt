...
public class InlineV1IssuingDisputesPostRequestFormXc53c5bbd(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1IssuingDisputesPostRequestFormXc53c5bbd =
            InlineV1IssuingDisputesPostRequestFormXc53c5bbd(
                amount = amount,
                evidence = evidence,
                expand = expand,
                metadata = metadata,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1IssuingDisputesPostRequestFormXc53c5bbd =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1IssuingDisputesPostRequestFormXc53c5bbd> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1IssuingDisputesPostRequestFormXc53c5bbd must be a JSON object",
                    )
            return InlineV1IssuingDisputesPostRequestFormXc53c5bbd(
                amount = rawObject["amount"]?.let { json.decodeFromJsonElement<Int>(it) },
                evidence =
                    rawObject["evidence"]?.let {
                        json.decodeFromJsonElement<InlineV1IssuingDisputesPostRequestFormEvidenceXc37b39e9>(it)
                    },
                ...
                treasury =
                    rawObject["treasury"]?.let {
                        json.decodeFromJsonElement<InlineV1IssuingDisputesPostRequestFormTreasuryX0bce0b29>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingDisputesPostRequestFormXc53c5bbd,
        ) {
...
public fun inlineV1IssuingDisputesPostRequestFormXc53c5bbd(
    block: InlineV1IssuingDisputesPostRequestFormXc53c5bbd.Builder.() -> Unit,
): InlineV1IssuingDisputesPostRequestFormXc53c5bbd = InlineV1IssuingDisputesPostRequestFormXc53c5bbd.build(block)
