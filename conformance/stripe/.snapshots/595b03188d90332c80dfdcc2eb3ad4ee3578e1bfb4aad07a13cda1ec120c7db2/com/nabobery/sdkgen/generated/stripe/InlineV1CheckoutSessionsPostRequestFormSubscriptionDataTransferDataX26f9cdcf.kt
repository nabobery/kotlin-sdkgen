...
public class InlineV1CheckoutSessionsPostRequestFormSubscriptionDataTransferDataX26f9cdcf(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1CheckoutSessionsPostRequestFormSubscriptionDataTransferDataX26f9cdcf = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormSubscriptionDataTransferDataX26f9cdcf> {
        ...
        override fun deserialize(
            decoder: Decoder,
        ): InlineV1CheckoutSessionsPostRequestFormSubscriptionDataTransferDataX26f9cdcf {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CheckoutSessionsPostRequestFormSubscriptionDataTransferDataX26f9cdcf must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsPostRequestFormSubscriptionDataTransferDataX26f9cdcf,
        ) {
            val jsonEncoder =
...
public fun inlineV1CheckoutSessionsPostRequestFormSubscriptionDataTransferDataX26f9cdcf(
    block: InlineV1CheckoutSessionsPostRequestFormSubscriptionDataTransferDataX26f9cdcf.Builder.() -> Unit,
): InlineV1CheckoutSessionsPostRequestFormSubscriptionDataTransferDataX26f9cdcf =
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1CheckoutSessionsPostRequestFormSubscriptionDataTransferDataX26f9cdcf is missing required property '" +
                    name +
                    "'",
            )
