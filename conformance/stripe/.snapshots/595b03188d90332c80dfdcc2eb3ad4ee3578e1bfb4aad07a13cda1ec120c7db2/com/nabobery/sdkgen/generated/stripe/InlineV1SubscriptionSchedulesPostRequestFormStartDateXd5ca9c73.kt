...
internal data class InlineV1SubscriptionSchedulesPostRequestFormStartDateXd5ca9c73Inspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1SubscriptionSchedulesPostRequestFormStartDateAnyOf2Xfee5bce1,
            ).count { it }
}
...
public class InlineV1SubscriptionSchedulesPostRequestFormStartDateXd5ca9c73 internal constructor(
    ...
    public val inlineV1SubscriptionSchedulesPostRequestFormStartDateAnyOf2Xfee5bce1:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1SubscriptionSchedulesPostRequestFormStartDateAnyOf2Xfee5bce1) {
                json
                    .decodeFromJsonElement<InlineV1SubscriptionSchedulesPostRequestFormStartDateAnyOf2Xfee5bce1>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1SubscriptionSchedulesPostRequestFormStartDateXd5ca9c73Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1SubscriptionSchedulesPostRequestFormStartDateAnyOf2Xfee5bce1) {
                    add(
                        InlineV1SubscriptionSchedulesPostRequestFormStartDateXd5ca9c73Branch.InlineV1SubscriptionSchedulesPostRequestFormStartDateAnyOf2Xfee5bce1,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1SubscriptionSchedulesPostRequestFormStartDateXd5ca9c73 {
            val inspection = inspectInlineV1SubscriptionSchedulesPostRequestFormStartDateXd5ca9c73(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1SubscriptionSchedulesPostRequestFormStartDateXd5ca9c73NoMatchException(
                    "InlineV1SubscriptionSchedulesPostRequestFormStartDateXd5ca9c73 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionSchedulesPostRequestFormStartDateXd5ca9c73> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionSchedulesPostRequestFormStartDateXd5ca9c73,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1SubscriptionSchedulesPostRequestFormStartDateXd5ca9c73",
...
private fun inspectInlineV1SubscriptionSchedulesPostRequestFormStartDateXd5ca9c73(
    element: JsonElement,
): InlineV1SubscriptionSchedulesPostRequestFormStartDateXd5ca9c73Inspection {
    val matchesBranch1 = element.isJsonDecodable<Int>()
    val matchesInlineV1SubscriptionSchedulesPostRequestFormStartDateAnyOf2Xfee5bce1 =
        element
            .isJsonDecodable<InlineV1SubscriptionSchedulesPostRequestFormStartDateAnyOf2Xfee5bce1>()
    return InlineV1SubscriptionSchedulesPostRequestFormStartDateXd5ca9c73Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1SubscriptionSchedulesPostRequestFormStartDateAnyOf2Xfee5bce1) {
                    add(
                        "InlineV1SubscriptionSchedulesPostRequestFormStartDateAnyOf2Xfee5bce1: value does not match InlineV1SubscriptionSchedulesPostRequestFormStartDateAnyOf2Xfee5bce1",
                    )
                }
            },
    )
