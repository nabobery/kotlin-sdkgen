...
public class InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPaypalAnyOf1X63b97d53(
    public val captureMethod: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsCaptureMethodXed9be9e1? = null,
    ...
    public val setupFutureUsage: InlineV1PaymentIntentsPostRequestFormSetupFutureUsageX190a1824? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPaypalAnyOf1X63b97d53 =
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPaypalAnyOf1X63b97d53> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPaypalAnyOf1X63b97d53 must be a JSON object",
                    )
            return InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPaypalAnyOf1X63b97d53(
                captureMethod =
                    rawObject["capture_method"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsCaptureMethodXed9be9e1>(
                                it,
                            )
                    },
                preferredLocale =
                    rawObject["preferred_locale"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPreferredLocaleXafc786e6>(it)
                    },
                ...
                setupFutureUsage =
                    rawObject["setup_future_usage"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormSetupFutureUsageX190a1824>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPaypalAnyOf1X63b97d53,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPaypalAnyOf1X63b97d53(
    block: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPaypalAnyOf1X63b97d53.Builder.() -> Unit,
): InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPaypalAnyOf1X63b97d53 =
    InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPaypalAnyOf1X63b97d53.build(block)
