...
public class InlineV1PaymentIntentsConfirmPostRequestFormCustomerAcceptanceXe7c2e6ff(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentIntentsConfirmPostRequestFormCustomerAcceptanceXe7c2e6ff = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentIntentsConfirmPostRequestFormCustomerAcceptanceXe7c2e6ff> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsConfirmPostRequestFormCustomerAcceptanceXe7c2e6ff must be a JSON object",
                    )
            val online =
                json.decodeRequired<InlineV1PaymentIntentsConfirmPostRequestFormMandateDataAnyOf3OnlineX216eccb1>(
                    rawObject,
                    "online",
                )
            val type =
                json.decodeRequired<InlineV1PaymentIntentsConfirmPostRequestFormMandateDataAnyOf3TypeX61de4ad5>(
                    rawObject,
                    "type",
                )
            return InlineV1PaymentIntentsConfirmPostRequestFormCustomerAcceptanceXe7c2e6ff(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsConfirmPostRequestFormCustomerAcceptanceXe7c2e6ff,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentIntentsConfirmPostRequestFormCustomerAcceptanceXe7c2e6ff(
    block: InlineV1PaymentIntentsConfirmPostRequestFormCustomerAcceptanceXe7c2e6ff.Builder.() -> Unit,
): InlineV1PaymentIntentsConfirmPostRequestFormCustomerAcceptanceXe7c2e6ff =
    InlineV1PaymentIntentsConfirmPostRequestFormCustomerAcceptanceXe7c2e6ff.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentIntentsConfirmPostRequestFormCustomerAcceptanceXe7c2e6ff is missing required property '" +
                    name +
                    "'",
            )
