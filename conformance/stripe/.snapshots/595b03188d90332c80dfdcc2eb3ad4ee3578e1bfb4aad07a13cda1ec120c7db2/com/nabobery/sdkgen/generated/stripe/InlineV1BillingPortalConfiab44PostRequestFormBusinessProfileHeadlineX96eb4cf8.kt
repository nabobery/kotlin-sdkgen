...
internal data class InlineV1BillingPortalConfiab44PostRequestFormBusinessProfileHeadlineX96eb4cf8Inspection(
    ...
    public val matchesInlineV1BillingPortalConfiab44PostRequestFormBusinessProfileAnyOf2X9a287f94: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1BillingPortalConfiab44PostRequestFormBusinessProfileAnyOf2X9a287f94,
            ).count {
                it
            }
}
...
public class InlineV1BillingPortalConfiab44PostRequestFormBusinessProfileHeadlineX96eb4cf8 internal constructor(
    ...
    private val inspection: InlineV1BillingPortalConfiab44PostRequestFormBusinessProfileHeadlineX96eb4cf8Inspection,
) {
    ...
    public val inlineV1BillingPortalConfiab44PostRequestFormBusinessProfileAnyOf2X9a287f94:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1BillingPortalConfiab44PostRequestFormBusinessProfileAnyOf2X9a287f94) {
                json
                    .decodeFromJsonElement<InlineV1BillingPortalConfiab44PostRequestFormBusinessProfileAnyOf2X9a287f94>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1BillingPortalConfiab44PostRequestFormBusinessProfileHeadlineX96eb4cf8Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1BillingPortalConfiab44PostRequestFormBusinessProfileAnyOf2X9a287f94) {
                    add(
                        InlineV1BillingPortalConfiab44PostRequestFormBusinessProfileHeadlineX96eb4cf8Branch.InlineV1BillingPortalConfiab44PostRequestFormBusinessProfileAnyOf2X9a287f94,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1BillingPortalConfiab44PostRequestFormBusinessProfileHeadlineX96eb4cf8 {
            val inspection = inspectInlineV1BillingPortalConfiab44PostRequestFormBusinessProfileHeadlineX96eb4cf8(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1BillingPortalConfiab44PostRequestFormBusinessProfileHeadlineX96eb4cf8NoMatchException(
                    "InlineV1BillingPortalConfiab44PostRequestFormBusinessProfileHeadlineX96eb4cf8 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1BillingPortalConfiab44PostRequestFormBusinessProfileHeadlineX96eb4cf8> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1BillingPortalConfiab44PostRequestFormBusinessProfileHeadlineX96eb4cf8,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1BillingPortalConfiab44PostRequestFormBusinessProfileHeadlineX96eb4cf8",
...
private fun inspectInlineV1BillingPortalConfiab44PostRequestFormBusinessProfileHeadlineX96eb4cf8(
    element: JsonElement,
): InlineV1BillingPortalConfiab44PostRequestFormBusinessProfileHeadlineX96eb4cf8Inspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1BillingPortalConfiab44PostRequestFormBusinessProfileAnyOf2X9a287f94 =
        element
            .isJsonDecodable<InlineV1BillingPortalConfiab44PostRequestFormBusinessProfileAnyOf2X9a287f94>()
    return InlineV1BillingPortalConfiab44PostRequestFormBusinessProfileHeadlineX96eb4cf8Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1BillingPortalConfiab44PostRequestFormBusinessProfileAnyOf2X9a287f94) {
                    add(
                        "InlineV1BillingPortalConfiab44PostRequestFormBusinessProfileAnyOf2X9a287f94: value does not match InlineV1BillingPortalConfiab44PostRequestFormBusinessProfileAnyOf2X9a287f94",
                    )
                }
            },
    )
