...
public sealed class InlineV1SetupIntentsPostRequestFormVerificationMethodX8e8b6da3 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1SetupIntentsPostRequestFormVerificationMethodX8e8b6da3 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1SetupIntentsPostRequestFormVerificationMethodX8e8b6da3> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1SetupIntentsPostRequestFormVerificationMethodX8e8b6da3",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1SetupIntentsPostRequestFormVerificationMethodX8e8b6da3 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SetupIntentsPostRequestFormVerificationMethodX8e8b6da3,
        ) {
