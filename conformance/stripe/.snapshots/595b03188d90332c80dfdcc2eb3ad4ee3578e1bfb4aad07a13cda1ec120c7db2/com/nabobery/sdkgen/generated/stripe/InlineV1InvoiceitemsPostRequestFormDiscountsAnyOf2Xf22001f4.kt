...
public sealed class InlineV1InvoiceitemsPostRequestFormDiscountsAnyOf2Xf22001f4 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1InvoiceitemsPostRequestFormDiscountsAnyOf2Xf22001f4 =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1InvoiceitemsPostRequestFormDiscountsAnyOf2Xf22001f4> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1InvoiceitemsPostRequestFormDiscountsAnyOf2Xf22001f4",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1InvoiceitemsPostRequestFormDiscountsAnyOf2Xf22001f4 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoiceitemsPostRequestFormDiscountsAnyOf2Xf22001f4,
        ) {
