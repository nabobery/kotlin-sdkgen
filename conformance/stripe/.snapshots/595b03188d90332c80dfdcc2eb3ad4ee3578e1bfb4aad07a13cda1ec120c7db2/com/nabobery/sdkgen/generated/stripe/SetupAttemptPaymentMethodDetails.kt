...
public class SetupAttemptPaymentMethodDetails(
    ...
    public object Serializer : KSerializer<SetupAttemptPaymentMethodDetails> {
        ...
        override fun deserialize(decoder: Decoder): SetupAttemptPaymentMethodDetails {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("SetupAttemptPaymentMethodDetails must be a JSON object")
            ...
            return SetupAttemptPaymentMethodDetails(
                ...
                bancontact =
                    rawObject["bancontact"]?.let {
                        json.decodeFromJsonElement<SetupAttemptPaymentMethodDetailsBancontact>(it)
                    },
                ...
                cardPresent =
                    rawObject["card_present"]?.let {
                        json.decodeFromJsonElement<SetupAttemptPaymentMethodDetailsCardPresent>(it)
                    },
                cashapp = rawObject["cashapp"]?.let { json.decodeFromJsonElement<JsonObject>(it) },
                ideal =
                    rawObject["ideal"]?.let {
                        json.decodeFromJsonElement<SetupAttemptPaymentMethodDetailsIdeal>(
                            it,
                        )
                    },
                ...
                naverPay =
                    rawObject["naver_pay"]?.let {
                        json.decodeFromJsonElement<SetupAttemptPaymentMethodDetailsNaverPay>(
                            it,
                        )
                    },
                ...
                sofort =
                    rawObject["sofort"]?.let {
                        json.decodeFromJsonElement<SetupAttemptPaymentMethodDetailsSofort>(
                            it,
                        )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: SetupAttemptPaymentMethodDetails,
        ) {
...
public fun setupAttemptPaymentMethodDetails(
    block: SetupAttemptPaymentMethodDetails.Builder.() -> Unit,
): SetupAttemptPaymentMethodDetails = SetupAttemptPaymentMethodDetails.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "SetupAttemptPaymentMethodDetails is missing required property '" + name + "'",
            )
