        ...
        override fun deserialize(decoder: Decoder): DeletedApplication {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("DeletedApplication must be a JSON object")
...
public fun deletedApplication(block: DeletedApplication.Builder.() -> Unit): DeletedApplication =
    DeletedApplication.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("DeletedApplication is missing required property '" + name + "'")
