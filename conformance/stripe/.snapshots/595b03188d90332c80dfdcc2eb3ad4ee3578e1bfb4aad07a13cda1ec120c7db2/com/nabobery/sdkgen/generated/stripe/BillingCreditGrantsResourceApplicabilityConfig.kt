...
public class BillingCreditGrantsResourceApplicabilityConfig(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): BillingCreditGrantsResourceApplicabilityConfig =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<BillingCreditGrantsResourceApplicabilityConfig> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "BillingCreditGrantsResourceApplicabilityConfig must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: BillingCreditGrantsResourceApplicabilityConfig,
        ) {
...
public fun billingCreditGrantsResourceApplicabilityConfig(
    block: BillingCreditGrantsResourceApplicabilityConfig.Builder.() -> Unit,
): BillingCreditGrantsResourceApplicabilityConfig = BillingCreditGrantsResourceApplicabilityConfig.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "BillingCreditGrantsResourceApplicabilityConfig is missing required property '" + name + "'",
            )
