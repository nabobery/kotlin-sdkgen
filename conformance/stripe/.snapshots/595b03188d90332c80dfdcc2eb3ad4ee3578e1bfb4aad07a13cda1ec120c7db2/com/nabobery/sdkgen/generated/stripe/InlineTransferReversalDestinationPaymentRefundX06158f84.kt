...
public class InlineTransferReversalDestinationPaymentRefundX06158f84 internal constructor(
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineTransferReversalDestinationPaymentRefundX06158f84Branch.Branch1,
                    )
                }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineTransferReversalDestinationPaymentRefundX06158f84 {
            val inspection = inspectInlineTransferReversalDestinationPaymentRefundX06158f84(raw)
            if (inspection.matchCount == 0) {
                throw InlineTransferReversalDestinationPaymentRefundX06158f84NoMatchException(
                    "InlineTransferReversalDestinationPaymentRefundX06158f84 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineTransferReversalDestinationPaymentRefundX06158f84> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineTransferReversalDestinationPaymentRefundX06158f84,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineTransferReversalDestinationPaymentRefundX06158f84",
...
private fun inspectInlineTransferReversalDestinationPaymentRefundX06158f84(
    element: JsonElement,
): InlineTransferReversalDestinationPaymentRefundX06158f84Inspection {
