...
public class InlineSetupIntentLatestAttemptXa0b1ef17 internal constructor(
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineSetupIntentLatestAttemptXa0b1ef17 {
            val inspection = inspectInlineSetupIntentLatestAttemptXa0b1ef17(raw)
            if (inspection.matchCount == 0) {
                throw InlineSetupIntentLatestAttemptXa0b1ef17NoMatchException(
                    "InlineSetupIntentLatestAttemptXa0b1ef17 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineSetupIntentLatestAttemptXa0b1ef17> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineSetupIntentLatestAttemptXa0b1ef17,
        ) {
...
private fun inspectInlineSetupIntentLatestAttemptXa0b1ef17(
    element: JsonElement,
): InlineSetupIntentLatestAttemptXa0b1ef17Inspection {
