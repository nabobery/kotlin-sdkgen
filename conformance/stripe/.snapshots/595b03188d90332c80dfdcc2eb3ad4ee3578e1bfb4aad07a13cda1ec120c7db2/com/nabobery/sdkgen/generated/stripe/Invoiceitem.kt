...
public class Invoiceitem(
     ...
     */
    public val discounts: List<InlineInvoiceitemDiscountsItemXc729a9a7>? = null,
    /**
    ...
    public class Builder {
         ...
         * `expand[]=discounts` to expand each discount.
         */
        public var discounts: List<InlineInvoiceitemDiscountsItemXc729a9a7>? = null
    ...
    public object Serializer : KSerializer<Invoiceitem> {
        ...
        override fun deserialize(decoder: Decoder): Invoiceitem {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("Invoiceitem must be a JSON object")
                ...
                discounts =
                    rawObject["discounts"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<List<InlineInvoiceitemDiscountsItemXc729a9a7>?>(element)
                        }
                    },
                invoice =
                    rawObject["invoice"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineInvoiceitemInvoiceX2a82d179?>(element)
                        }
                    },
                metadata =
                ...
                parent =
                    rawObject["parent"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineInvoiceitemParentX5d8eb470?>(element)
                        }
                    },
                pricing =
                    rawObject["pricing"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineInvoiceitemPricingXc20095ad?>(element)
                        }
                    },
                prorationDetails =
                    rawObject["proration_details"]?.let {
                        json.decodeFromJsonElement<ProrationDetails>(
                            it,
                        )
                    },
                taxRates =
                ...
                testClock =
                    rawObject["test_clock"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineInvoiceitemTestClockXdd357cbe?>(element)
                        }
                    },
            )
        }
