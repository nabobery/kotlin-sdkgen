...
public class InlineV1ProductsGetParameterXca1d8d3d internal constructor(
    ...
    public val inlineV1ProductsGetParameterAnyOf1X448cc4a9:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1ProductsGetParameterAnyOf1X448cc4a9) {
                json
                    .decodeFromJsonElement<InlineV1ProductsGetParameterAnyOf1X448cc4a9>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1ProductsGetParameterXca1d8d3dBranch>
        get() =
            buildSet {
                if (inspection.matchesInlineV1ProductsGetParameterAnyOf1X448cc4a9) {
                    add(
                        InlineV1ProductsGetParameterXca1d8d3dBranch.InlineV1ProductsGetParameterAnyOf1X448cc4a9,
                    )
                }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1ProductsGetParameterXca1d8d3d {
            val inspection = inspectInlineV1ProductsGetParameterXca1d8d3d(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1ProductsGetParameterXca1d8d3dNoMatchException(
                    "InlineV1ProductsGetParameterXca1d8d3d matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1ProductsGetParameterXca1d8d3d> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ProductsGetParameterXca1d8d3d,
        ) {
...
private fun inspectInlineV1ProductsGetParameterXca1d8d3d(
    element: JsonElement,
): InlineV1ProductsGetParameterXca1d8d3dInspection {
    val matchesInlineV1ProductsGetParameterAnyOf1X448cc4a9 =
        element
            .isJsonDecodable<InlineV1ProductsGetParameterAnyOf1X448cc4a9>()
    ...
    return InlineV1ProductsGetParameterXca1d8d3dInspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1ProductsGetParameterAnyOf1X448cc4a9) {
                    add(
                        "InlineV1ProductsGetParameterAnyOf1X448cc4a9: value does not match InlineV1ProductsGetParameterAnyOf1X448cc4a9",
                    )
                }
