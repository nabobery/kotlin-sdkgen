...
public class InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemX6fa88330(
    ...
    public val discounts: List<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemX100aef5b>? = null,
    ...
    public val priceData: InlineV1SubscriptionSchedulesPostRequestFormPhasesItemPriceDataX16f9e99f? = null,
    public val quantity: Int? = null,
    public val taxRates: InlineV1SubscriptionSchedulesPostRequestFormPhasesItemTaxRatesXa9cb6083? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemX6fa88330 =
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemX6fa88330 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemX6fa88330> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemX6fa88330 must be a JSON object",
                    )
            return InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemX6fa88330(
                ...
                discounts =
                    rawObject["discounts"]?.let {
                        json
                            .decodeFromJsonElement<List<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemX100aef5b>>(
                                it,
                            )
                    },
                ...
                period =
                    rawObject["period"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemPeriodXa89fd4f1>(
                                it,
                            )
                    },
                ...
                priceData =
                    rawObject["price_data"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemPriceDataX16f9e99f>(
                                it,
                            )
                    },
                ...
                taxRates =
                    rawObject["tax_rates"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemTaxRatesXa9cb6083>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemX6fa88330,
        ) {
            val jsonEncoder =
...
public fun inlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemX6fa88330(
    block: InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemX6fa88330.Builder.() -> Unit,
): InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemX6fa88330 =
    InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemX6fa88330.build(block)
