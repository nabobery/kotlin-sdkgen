...
public class AccountBacsDebitPaymentsSettings(
    ...
    public class Builder {
        ...
        public fun build(): AccountBacsDebitPaymentsSettings =
    ...
    public object Serializer : KSerializer<AccountBacsDebitPaymentsSettings> {
        ...
        override fun deserialize(decoder: Decoder): AccountBacsDebitPaymentsSettings {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("AccountBacsDebitPaymentsSettings must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: AccountBacsDebitPaymentsSettings,
        ) {
...
public fun accountBacsDebitPaymentsSettings(
    block: AccountBacsDebitPaymentsSettings.Builder.() -> Unit,
): AccountBacsDebitPaymentsSettings = AccountBacsDebitPaymentsSettings.build(block)
