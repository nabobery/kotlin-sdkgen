...
public data class InsightsResourcesPaymentEvaluationMoneyMovementCardView(
    ...
    public val paymentType: InlineInsightsResourcesPaymentEvaluationMoneyMovementCardPaymentTypeX8c235b7f? = null,
)
...
public class InsightsResourcesPaymentEvaluationMoneyMovementCard(
    ...
    public class Builder {
        ...
        public fun build(): InsightsResourcesPaymentEvaluationMoneyMovementCard =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InsightsResourcesPaymentEvaluationMoneyMovementCard =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InsightsResourcesPaymentEvaluationMoneyMovementCard> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InsightsResourcesPaymentEvaluationMoneyMovementCard must be a JSON object",
                    )
                ...
                customerPresence =
                    rawObject["customer_presence"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineInsightsResourcesPay7e0fCustomerPresenceXdbcd2d55?>(
                                element,
                            )
                        }
                    },
                paymentType =
                    rawObject["payment_type"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                            ...
                            json
                                .decodeFromJsonElement<InlineInsightsResourcesPaymentEvaluationMoneyMovementCardPaymentTypeX8c235b7f?>(
                                    element,
                                )
                        }
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InsightsResourcesPaymentEvaluationMoneyMovementCard,
        ) {
...
public fun insightsResourcesPaymentEvaluationMoneyMovementCard(
    block: InsightsResourcesPaymentEvaluationMoneyMovementCard.Builder.() -> Unit,
): InsightsResourcesPaymentEvaluationMoneyMovementCard =
    InsightsResourcesPaymentEvaluationMoneyMovementCard.build(block)
