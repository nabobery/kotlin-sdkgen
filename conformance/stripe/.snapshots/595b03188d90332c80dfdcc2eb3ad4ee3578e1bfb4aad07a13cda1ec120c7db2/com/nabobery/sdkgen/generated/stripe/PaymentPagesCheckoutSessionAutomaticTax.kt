...
public class PaymentPagesCheckoutSessionAutomaticTax(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentPagesCheckoutSessionAutomaticTax =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentPagesCheckoutSessionAutomaticTax> {
        ...
        override fun deserialize(decoder: Decoder): PaymentPagesCheckoutSessionAutomaticTax {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentPagesCheckoutSessionAutomaticTax must be a JSON object")
                ...
                liability =
                    rawObject["liability"]?.let { element ->
                        if (element ==
                            ...
                            json
                                .decodeFromJsonElement<InlinePaymentPagesCheckoutSessionAutomaticTaxLiabilityXd9cd2da0?>(
                                    element,
                                )
                        }
                    },
                ...
                status =
                    rawObject["status"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentPagesCheckoutSessionAutomaticTaxStatusX0e24e6fa?>(
                                element,
                            )
                        }
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentPagesCheckoutSessionAutomaticTax,
        ) {
...
public fun paymentPagesCheckoutSessionAutomaticTax(
    block: PaymentPagesCheckoutSessionAutomaticTax.Builder.() -> Unit,
): PaymentPagesCheckoutSessionAutomaticTax = PaymentPagesCheckoutSessionAutomaticTax.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "PaymentPagesCheckoutSessionAutomaticTax is missing required property '" + name + "'",
            )
