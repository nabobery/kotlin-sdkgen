...
public sealed class InlineV1PaymentMethodsPostRequestFormBillingDetailsAddressAnyOf2Xeacb975b {
    ...
    public object Serializer : KSerializer<InlineV1PaymentMethodsPostRequestFormBillingDetailsAddressAnyOf2Xeacb975b> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1PaymentMethodsPostRequestFormBillingDetailsAddressAnyOf2Xeacb975b",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1PaymentMethodsPostRequestFormBillingDetailsAddressAnyOf2Xeacb975b = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentMethodsPostRequestFormBillingDetailsAddressAnyOf2Xeacb975b,
        ) {
