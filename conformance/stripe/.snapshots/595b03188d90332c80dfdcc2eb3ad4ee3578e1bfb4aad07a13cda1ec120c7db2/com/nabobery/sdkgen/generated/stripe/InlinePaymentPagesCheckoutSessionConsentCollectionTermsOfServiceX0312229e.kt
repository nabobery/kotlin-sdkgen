...
public sealed class InlinePaymentPagesCheckoutSessionConsentCollectionTermsOfServiceX0312229e {
    ...
    public object Serializer : KSerializer<InlinePaymentPagesCheckoutSessionConsentCollectionTermsOfServiceX0312229e> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentPagesCheckoutSessionConsentCollectionTermsOfServiceX0312229e",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlinePaymentPagesCheckoutSessionConsentCollectionTermsOfServiceX0312229e = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentPagesCheckoutSessionConsentCollectionTermsOfServiceX0312229e,
        ) {
