...
public class InlineV1BillingPortalConfiab44PostRequestFormFeaturesCancellationReasonX2856cff9(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1BillingPortalConfiab44PostRequestFormFeaturesCancellationReasonX2856cff9 =
    ...
    public object Serializer : KSerializer<InlineV1BillingPortalConfiab44PostRequestFormFeaturesCancellationReasonX2856cff9> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1BillingPortalConfiab44PostRequestFormFeaturesCancellationReasonX2856cff9 must be a JSON object",
                    )
            val enabled = json.decodeRequired<Boolean>(rawObject, "enabled")
            val options =
                json.decodeRequired<InlineV1BillingPortalConfiab44PostRequestFormFeaturesOptionsX04276304>(
                    rawObject,
                    "options",
                )
            return InlineV1BillingPortalConfiab44PostRequestFormFeaturesCancellationReasonX2856cff9(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1BillingPortalConfiab44PostRequestFormFeaturesCancellationReasonX2856cff9,
        ) {
            val jsonEncoder =
...
public fun inlineV1BillingPortalConfiab44PostRequestFormFeaturesCancellationReasonX2856cff9(
    block: InlineV1BillingPortalConfiab44PostRequestFormFeaturesCancellationReasonX2856cff9.Builder.() -> Unit,
): InlineV1BillingPortalConfiab44PostRequestFormFeaturesCancellationReasonX2856cff9 =
    InlineV1BillingPortalConfiab44PostRequestFormFeaturesCancellationReasonX2856cff9.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1BillingPortalConfiab44PostRequestFormFeaturesCancellationReasonX2856cff9 is missing required property '" +
                    name +
                    "'",
            )
