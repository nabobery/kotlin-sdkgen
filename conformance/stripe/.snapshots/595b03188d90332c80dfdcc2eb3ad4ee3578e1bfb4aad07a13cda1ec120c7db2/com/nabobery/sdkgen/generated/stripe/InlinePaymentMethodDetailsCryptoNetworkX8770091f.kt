...
public sealed class InlinePaymentMethodDetailsCryptoNetworkX8770091f {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentMethodDetailsCryptoNetworkX8770091f =
            when (value) {
                Base.value -> Base
    ...
    public object Serializer : KSerializer<InlinePaymentMethodDetailsCryptoNetworkX8770091f> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentMethodDetailsCryptoNetworkX8770091f",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePaymentMethodDetailsCryptoNetworkX8770091f =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentMethodDetailsCryptoNetworkX8770091f,
        ) {
