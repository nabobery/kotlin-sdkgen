...
public class TreasuryOutboundPaymentsResourceReturnedStatus(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): TreasuryOutboundPaymentsResourceReturnedStatus =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<TreasuryOutboundPaymentsResourceReturnedStatus> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "TreasuryOutboundPaymentsResourceReturnedStatus must be a JSON object",
                    )
            val code =
                json.decodeRequired<InlineTreasuryOutboundPaymentsResourceReturnedStatusCodeX0c1c9292>(
                    rawObject,
                    "code",
                )
            val transaction =
                json.decodeRequired<InlineTreasuryOutboundPaymentsResourceReturnedStatusTransactionXcd71370e>(
                    rawObject,
                    "transaction",
                )
            return TreasuryOutboundPaymentsResourceReturnedStatus(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: TreasuryOutboundPaymentsResourceReturnedStatus,
        ) {
...
public fun treasuryOutboundPaymentsResourceReturnedStatus(
    block: TreasuryOutboundPaymentsResourceReturnedStatus.Builder.() -> Unit,
): TreasuryOutboundPaymentsResourceReturnedStatus = TreasuryOutboundPaymentsResourceReturnedStatus.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "TreasuryOutboundPaymentsResourceReturnedStatus is missing required property '" + name + "'",
            )
