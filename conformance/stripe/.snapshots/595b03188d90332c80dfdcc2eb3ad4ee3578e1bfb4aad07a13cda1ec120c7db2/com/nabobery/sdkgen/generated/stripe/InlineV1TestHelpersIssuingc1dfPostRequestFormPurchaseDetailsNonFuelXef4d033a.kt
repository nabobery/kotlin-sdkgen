...
public class InlineV1TestHelpersIssuingc1dfPostRequestFormPurchaseDetailsNonFuelXef4d033a(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1TestHelpersIssuingc1dfPostRequestFormPurchaseDetailsNonFuelXef4d033a =
            InlineV1TestHelpersIssuingc1dfPostRequestFormPurchaseDetailsNonFuelXef4d033a(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1TestHelpersIssuingc1dfPostRequestFormPurchaseDetailsNonFuelXef4d033a = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1TestHelpersIssuingc1dfPostRequestFormPurchaseDetailsNonFuelXef4d033a> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TestHelpersIssuingc1dfPostRequestFormPurchaseDetailsNonFuelXef4d033a must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TestHelpersIssuingc1dfPostRequestFormPurchaseDetailsNonFuelXef4d033a,
        ) {
            val jsonEncoder =
...
public fun inlineV1TestHelpersIssuingc1dfPostRequestFormPurchaseDetailsNonFuelXef4d033a(
    block: InlineV1TestHelpersIssuingc1dfPostRequestFormPurchaseDetailsNonFuelXef4d033a.Builder.() -> Unit,
): InlineV1TestHelpersIssuingc1dfPostRequestFormPurchaseDetailsNonFuelXef4d033a =
    InlineV1TestHelpersIssuingc1dfPostRequestFormPurchaseDetailsNonFuelXef4d033a.build(block)
