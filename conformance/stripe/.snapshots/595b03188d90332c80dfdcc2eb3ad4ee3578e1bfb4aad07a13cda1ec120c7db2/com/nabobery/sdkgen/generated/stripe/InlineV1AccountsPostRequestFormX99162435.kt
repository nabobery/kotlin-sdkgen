...
public class InlineV1AccountsPostRequestFormX99162435(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1AccountsPostRequestFormX99162435 =
            InlineV1AccountsPostRequestFormX99162435(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1AccountsPostRequestFormX99162435 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1AccountsPostRequestFormX99162435> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1AccountsPostRequestFormX99162435 {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("InlineV1AccountsPostRequestFormX99162435 must be a JSON object")
            return InlineV1AccountsPostRequestFormX99162435(
                ...
                businessProfile =
                    rawObject["business_profile"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPostRequestFormBusinessProfileX1919c55c>(it)
                    },
                businessType =
                    rawObject["business_type"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPostRequestFormBusinessTypeX9db4a925>(it)
                    },
                capabilities =
                    rawObject["capabilities"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesXf340f39e>(it)
                    },
                company =
                    rawObject["company"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1AccountsPostRequestFormCompanyX6b602871>(
                                it,
                            )
                    },
                defaultCurrency =
                    rawObject["default_currency"]?.let {
                        json
                ...
                documents =
                    rawObject["documents"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPostRequestFormDocumentsX9ce2e389>(it)
                    },
                ...
                groups =
                    rawObject["groups"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPostRequestFormGroupsX165c6212>(
                            it,
                        )
                    },
                individual =
                    rawObject["individual"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPostRequestFormIndividualX0a2dcd83>(it)
                    },
                metadata =
                    rawObject["metadata"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPostRequestFormMetadataXece72a14>(it)
                    },
                settings =
                    rawObject["settings"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPostRequestFormSettingsXc8f4c77f>(it)
                    },
                tosAcceptance =
                    rawObject["tos_acceptance"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPostRequestFormTosAcceptanceX7b5ec89e>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPostRequestFormX99162435,
        ) {
...
public fun inlineV1AccountsPostRequestFormX99162435(
    block: InlineV1AccountsPostRequestFormX99162435.Builder.() -> Unit,
): InlineV1AccountsPostRequestFormX99162435 = InlineV1AccountsPostRequestFormX99162435.build(block)
