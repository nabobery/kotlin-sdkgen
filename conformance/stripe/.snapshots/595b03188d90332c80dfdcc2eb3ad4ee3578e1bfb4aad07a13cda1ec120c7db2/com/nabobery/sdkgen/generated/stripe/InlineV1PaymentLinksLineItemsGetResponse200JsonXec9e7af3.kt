...
public class InlineV1PaymentLinksLineItemsGetResponse200JsonXec9e7af3(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PaymentLinksLineItemsGetResponse200JsonXec9e7af3 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentLinksLineItemsGetResponse200JsonXec9e7af3> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentLinksLineItemsGetResponse200JsonXec9e7af3 must be a JSON object",
                    )
            val data = json.decodeRequired<List<Item>>(rawObject, "data")
            val hasMore = json.decodeRequired<Boolean>(rawObject, "has_more")
            val objectValue =
                json.decodeRequired<InlineV1PaymentLinksLineItemsGetResponse200JsonObjectValueX0bfd65a2>(
                    rawObject,
                    "object",
                )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentLinksLineItemsGetResponse200JsonXec9e7af3,
        ) {
...
public fun inlineV1PaymentLinksLineItemsGetResponse200JsonXec9e7af3(
    block: InlineV1PaymentLinksLineItemsGetResponse200JsonXec9e7af3.Builder.() -> Unit,
): InlineV1PaymentLinksLineItemsGetResponse200JsonXec9e7af3 =
    InlineV1PaymentLinksLineItemsGetResponse200JsonXec9e7af3.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentLinksLineItemsGetResponse200JsonXec9e7af3 is missing required property '" + name + "'",
            )
