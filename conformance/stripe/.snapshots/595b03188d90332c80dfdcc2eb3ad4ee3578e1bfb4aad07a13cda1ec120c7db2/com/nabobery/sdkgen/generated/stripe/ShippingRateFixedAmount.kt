...
public class ShippingRateFixedAmount(
     ...
     */
    public val currencyOptions: Map<String, ShippingRateCurrencyOption>? = null,
) {
    public class Builder {
         ...
         * currency](https://stripe.com/docs/currencies).
         */
        public var currencyOptions: Map<String, ShippingRateCurrencyOption>? = null
    ...
    public object Serializer : KSerializer<ShippingRateFixedAmount> {
        ...
        override fun deserialize(decoder: Decoder): ShippingRateFixedAmount {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("ShippingRateFixedAmount must be a JSON object")
            ...
            return ShippingRateFixedAmount(
                ...
                currencyOptions =
                    rawObject["currency_options"]?.let {
                        json.decodeFromJsonElement<Map<String, ShippingRateCurrencyOption>>(it)
                    },
            )
        }
...
public fun shippingRateFixedAmount(block: ShippingRateFixedAmount.Builder.() -> Unit): ShippingRateFixedAmount =
    ShippingRateFixedAmount.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("ShippingRateFixedAmount is missing required property '" + name + "'")
