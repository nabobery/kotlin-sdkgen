...
public sealed class InlinePersonRaceDetailsRaceItemXef94ddcc {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePersonRaceDetailsRaceItemXef94ddcc =
            when (value) {
    ...
    public object Serializer : KSerializer<InlinePersonRaceDetailsRaceItemXef94ddcc> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePersonRaceDetailsRaceItemXef94ddcc",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePersonRaceDetailsRaceItemXef94ddcc =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePersonRaceDetailsRaceItemXef94ddcc,
        ) {
