...
public sealed class InlinePaymentMethodUsBankAccountAccountTypeX72df841c {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentMethodUsBankAccountAccountTypeX72df841c =
            when (value) {
    ...
    public object Serializer : KSerializer<InlinePaymentMethodUsBankAccountAccountTypeX72df841c> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentMethodUsBankAccountAccountTypeX72df841c",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePaymentMethodUsBankAccountAccountTypeX72df841c =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentMethodUsBankAccountAccountTypeX72df841c,
        ) {
