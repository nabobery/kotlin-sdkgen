...
public sealed class InlineCheckoutAffirmPaymentMethodOptionsSetupFutureUsageX8507a2c1 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineCheckoutAffirmPaymentMethodOptionsSetupFutureUsageX8507a2c1 =
            when (value) {
                None.value -> None
    ...
    public object Serializer : KSerializer<InlineCheckoutAffirmPaymentMethodOptionsSetupFutureUsageX8507a2c1> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineCheckoutAffirmPaymentMethodOptionsSetupFutureUsageX8507a2c1",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineCheckoutAffirmPaymentMethodOptionsSetupFutureUsageX8507a2c1 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineCheckoutAffirmPaymentMethodOptionsSetupFutureUsageX8507a2c1,
        ) {
