...
public sealed class InlineItemObjectValueX7a9b1e2e {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineItemObjectValueX7a9b1e2e =
            when (value) {
                Item.value -> Item
    ...
    public object Serializer : KSerializer<InlineItemObjectValueX7a9b1e2e> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineItemObjectValueX7a9b1e2e",
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineItemObjectValueX7a9b1e2e,
        ) {
