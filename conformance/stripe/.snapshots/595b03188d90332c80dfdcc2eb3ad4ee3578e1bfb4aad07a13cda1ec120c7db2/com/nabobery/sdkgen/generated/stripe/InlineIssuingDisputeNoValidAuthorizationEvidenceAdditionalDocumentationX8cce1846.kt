...
public class InlineIssuingDisputeNoValidAuthorizationEvidenceAdditionalDocumentationX8cce1846 internal constructor(
    ...
    private val inspection: InlineIssuingDisputeNoValidAuthorizationEvidenceAdditionalDocumentationX8cce1846Inspection,
) {
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineIssuingDisputeNoValidAuthorizationEvidenceAdditionalDocumentationX8cce1846Branch.Branch1,
                    )
                }
                if (inspection.matchesFile) {
                    add(
                        InlineIssuingDisputeNoValidAuthorizationEvidenceAdditionalDocumentationX8cce1846Branch.File,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineIssuingDisputeNoValidAuthorizationEvidenceAdditionalDocumentationX8cce1846 {
            val inspection =
                inspectInlineIssuingDisputeNoValidAuthorizationEvidenceAdditionalDocumentationX8cce1846(raw)
            if (inspection.matchCount == 0) {
                throw InlineIssuingDisputeNoValidAuthorizationEvidenceAdditionalDocumentationX8cce1846NoMatchException(
                    "InlineIssuingDisputeNoValidAuthorizationEvidenceAdditionalDocumentationX8cce1846 matched 0 branches: " +
                        inspection.failures.joinToString("; "),
                )
            }
            return InlineIssuingDisputeNoValidAuthorizationEvidenceAdditionalDocumentationX8cce1846(
                raw,
                json,
                inspection,
            )
    ...
    public object Serializer : KSerializer<InlineIssuingDisputeNoValidAuthorizationEvidenceAdditionalDocumentationX8cce1846> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineIssuingDisputeNoValidAuthorizationEvidenceAdditionalDocumentationX8cce1846,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineIssuingDisputeNoValidAuthorizationEvidenceAdditionalDocumentationX8cce1846",
...
private fun inspectInlineIssuingDisputeNoValidAuthorizationEvidenceAdditionalDocumentationX8cce1846(
    element: JsonElement,
