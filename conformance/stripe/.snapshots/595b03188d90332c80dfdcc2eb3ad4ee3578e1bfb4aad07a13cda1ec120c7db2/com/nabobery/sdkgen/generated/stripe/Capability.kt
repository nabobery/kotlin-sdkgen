        ...
        override fun deserialize(decoder: Decoder): Capability {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("Capability must be a JSON object")
            ...
            return Capability(
                ...
                futureRequirements =
                    rawObject["future_requirements"]?.let {
                        json.decodeFromJsonElement<AccountCapabilityFutureRequirements>(it)
                    },
                requestedAt =
                ...
                requirements =
                    rawObject["requirements"]?.let {
                        json.decodeFromJsonElement<AccountCapabilityRequirements>(
                            it,
                        )
                    },
            )
