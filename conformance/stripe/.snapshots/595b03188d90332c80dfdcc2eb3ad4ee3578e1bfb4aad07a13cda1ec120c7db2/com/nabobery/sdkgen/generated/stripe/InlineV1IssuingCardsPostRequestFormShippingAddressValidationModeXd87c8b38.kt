...
public sealed class InlineV1IssuingCardsPostRequestFormShippingAddressValidationModeXd87c8b38 {
    ...
    public object Serializer : KSerializer<InlineV1IssuingCardsPostRequestFormShippingAddressValidationModeXd87c8b38> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1IssuingCardsPostRequestFormShippingAddressValidationModeXd87c8b38",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1IssuingCardsPostRequestFormShippingAddressValidationModeXd87c8b38 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingCardsPostRequestFormShippingAddressValidationModeXd87c8b38,
        ) {
