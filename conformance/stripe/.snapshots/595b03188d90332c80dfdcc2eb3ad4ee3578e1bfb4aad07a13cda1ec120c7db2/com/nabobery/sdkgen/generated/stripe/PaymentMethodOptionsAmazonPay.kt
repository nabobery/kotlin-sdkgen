...
public class PaymentMethodOptionsAmazonPay(
    ...
    public class Builder {
        ...
        public fun build(): PaymentMethodOptionsAmazonPay =
    ...
    public object Serializer : KSerializer<PaymentMethodOptionsAmazonPay> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodOptionsAmazonPay {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodOptionsAmazonPay must be a JSON object")
            return PaymentMethodOptionsAmazonPay(
                captureMethod =
                    rawObject["capture_method"]?.let {
                        json.decodeFromJsonElement<InlinePaymentMethodOptionsAmazonPayCaptureMethodXa7eeee3a>(it)
                    },
                setupFutureUsage =
                    rawObject["setup_future_usage"]?.let {
                        json.decodeFromJsonElement<InlinePaymentMethodOptionsAmazonPaySetupFutureUsageX2212ad8d>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentMethodOptionsAmazonPay,
        ) {
...
public fun paymentMethodOptionsAmazonPay(
    block: PaymentMethodOptionsAmazonPay.Builder.() -> Unit,
): PaymentMethodOptionsAmazonPay = PaymentMethodOptionsAmazonPay.build(block)
