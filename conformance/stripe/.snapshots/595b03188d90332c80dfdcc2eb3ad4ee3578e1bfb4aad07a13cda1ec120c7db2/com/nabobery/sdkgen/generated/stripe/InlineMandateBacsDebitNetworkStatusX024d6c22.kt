...
public sealed class InlineMandateBacsDebitNetworkStatusX024d6c22 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineMandateBacsDebitNetworkStatusX024d6c22 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineMandateBacsDebitNetworkStatusX024d6c22> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineMandateBacsDebitNetworkStatusX024d6c22",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineMandateBacsDebitNetworkStatusX024d6c22 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineMandateBacsDebitNetworkStatusX024d6c22,
        ) {
