...
public class PaymentMethodUpi(
    ...
    public class Builder {
        ...
        public fun build(): PaymentMethodUpi =
            PaymentMethodUpi(
                vpa = vpa,
            )
    }
    ...
    public object Serializer : KSerializer<PaymentMethodUpi> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodUpi {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodUpi must be a JSON object")
...
public fun paymentMethodUpi(block: PaymentMethodUpi.Builder.() -> Unit): PaymentMethodUpi =
    PaymentMethodUpi.build(block)
