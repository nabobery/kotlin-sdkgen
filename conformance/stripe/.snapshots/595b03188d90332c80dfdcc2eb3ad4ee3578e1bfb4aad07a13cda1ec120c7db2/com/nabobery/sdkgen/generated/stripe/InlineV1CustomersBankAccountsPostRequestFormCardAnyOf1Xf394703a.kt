...
public class InlineV1CustomersBankAccountsPostRequestFormCardAnyOf1Xf394703a(
    ...
    public val networkToken: InlineV1CustomersBankAccountsPostRequestFormCardAnyOf1NetworkTokenXec223d99? = null,
    public val objectValue: InlineV1CustomersBankAccountsPostRequestFormCardAnyOf1ObjectValueX77f605da? = null,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1CustomersBankAccountsPostRequestFormCardAnyOf1Xf394703a =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1CustomersBankAccountsPostRequestFormCardAnyOf1Xf394703a> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CustomersBankAccountsPostRequestFormCardAnyOf1Xf394703a must be a JSON object",
                    )
            ...
            return InlineV1CustomersBankAccountsPostRequestFormCardAnyOf1Xf394703a(
                ...
                networkToken =
                    rawObject["network_token"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CustomersBankAccountsPostRequestFormCardAnyOf1NetworkTokenXec223d99>(
                                it,
                            )
                    },
                objectValue =
                    rawObject["object"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CustomersBankAccountsPostRequestFormCardAnyOf1ObjectValueX77f605da>(
                                it,
                            )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersBankAccountsPostRequestFormCardAnyOf1Xf394703a,
        ) {
            val jsonEncoder =
...
public fun inlineV1CustomersBankAccountsPostRequestFormCardAnyOf1Xf394703a(
    block: InlineV1CustomersBankAccountsPostRequestFormCardAnyOf1Xf394703a.Builder.() -> Unit,
): InlineV1CustomersBankAccountsPostRequestFormCardAnyOf1Xf394703a =
    InlineV1CustomersBankAccountsPostRequestFormCardAnyOf1Xf394703a.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1CustomersBankAccountsPostRequestFormCardAnyOf1Xf394703a is missing required property '" + name +
                    "'",
            )
