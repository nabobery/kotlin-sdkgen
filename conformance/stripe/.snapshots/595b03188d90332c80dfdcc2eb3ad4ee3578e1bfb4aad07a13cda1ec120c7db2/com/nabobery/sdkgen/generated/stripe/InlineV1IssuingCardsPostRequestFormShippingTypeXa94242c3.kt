...
public sealed class InlineV1IssuingCardsPostRequestFormShippingTypeXa94242c3 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1IssuingCardsPostRequestFormShippingTypeXa94242c3 =
            when (value) {
                Bulk.value -> Bulk
    ...
    public object Serializer : KSerializer<InlineV1IssuingCardsPostRequestFormShippingTypeXa94242c3> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1IssuingCardsPostRequestFormShippingTypeXa94242c3",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1IssuingCardsPostRequestFormShippingTypeXa94242c3 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingCardsPostRequestFormShippingTypeXa94242c3,
        ) {
