...
internal data class InlineV1PaymentLinksPostRequestFormSubscriptionDataTrialPeriodDaysX6b24bc2aInspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1PaymentLinksPostRequestFormSubscriptionDataAnyOf2X6970009c,
            ).count { it }
}
...
public class InlineV1PaymentLinksPostRequestFormSubscriptionDataTrialPeriodDaysX6b24bc2a internal constructor(
    ...
    private val inspection: InlineV1PaymentLinksPostRequestFormSubscriptionDataTrialPeriodDaysX6b24bc2aInspection,
) {
    ...
    public val inlineV1PaymentLinksPostRequestFormSubscriptionDataAnyOf2X6970009c:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1PaymentLinksPostRequestFormSubscriptionDataAnyOf2X6970009c) {
                json
                    .decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormSubscriptionDataAnyOf2X6970009c>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1PaymentLinksPostRequestFormSubscriptionDataTrialPeriodDaysX6b24bc2aBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1PaymentLinksPostRequestFormSubscriptionDataAnyOf2X6970009c) {
                    add(
                        InlineV1PaymentLinksPostRequestFormSubscriptionDataTrialPeriodDaysX6b24bc2aBranch.InlineV1PaymentLinksPostRequestFormSubscriptionDataAnyOf2X6970009c,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1PaymentLinksPostRequestFormSubscriptionDataTrialPeriodDaysX6b24bc2a {
            val inspection = inspectInlineV1PaymentLinksPostRequestFormSubscriptionDataTrialPeriodDaysX6b24bc2a(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1PaymentLinksPostRequestFormSubscriptionDataTrialPeriodDaysX6b24bc2aNoMatchException(
                    "InlineV1PaymentLinksPostRequestFormSubscriptionDataTrialPeriodDaysX6b24bc2a matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1PaymentLinksPostRequestFormSubscriptionDataTrialPeriodDaysX6b24bc2a> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentLinksPostRequestFormSubscriptionDataTrialPeriodDaysX6b24bc2a,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1PaymentLinksPostRequestFormSubscriptionDataTrialPeriodDaysX6b24bc2a",
...
private fun inspectInlineV1PaymentLinksPostRequestFormSubscriptionDataTrialPeriodDaysX6b24bc2a(
    element: JsonElement,
): InlineV1PaymentLinksPostRequestFormSubscriptionDataTrialPeriodDaysX6b24bc2aInspection {
    val matchesBranch1 = element.isJsonDecodable<Int>()
    val matchesInlineV1PaymentLinksPostRequestFormSubscriptionDataAnyOf2X6970009c =
        element
            .isJsonDecodable<InlineV1PaymentLinksPostRequestFormSubscriptionDataAnyOf2X6970009c>()
    return InlineV1PaymentLinksPostRequestFormSubscriptionDataTrialPeriodDaysX6b24bc2aInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1PaymentLinksPostRequestFormSubscriptionDataAnyOf2X6970009c) {
                    add(
                        "InlineV1PaymentLinksPostRequestFormSubscriptionDataAnyOf2X6970009c: value does not match InlineV1PaymentLinksPostRequestFormSubscriptionDataAnyOf2X6970009c",
                    )
                }
            },
    )
