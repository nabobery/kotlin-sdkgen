...
public class InlineV1PaymentLinksPostRequestFormLineItemsItemPriceDataRecurringX359a0eca(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentLinksPostRequestFormLineItemsItemPriceDataRecurringX359a0eca = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentLinksPostRequestFormLineItemsItemPriceDataRecurringX359a0eca> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentLinksPostRequestFormLineItemsItemPriceDataRecurringX359a0eca must be a JSON object",
                    )
            val interval =
                json.decodeRequired<InlineV1PaymentLinksPostRequestFormLineItemsItemPriceDataIntervalXd995328b>(
                    rawObject,
                    "interval",
                )
            return InlineV1PaymentLinksPostRequestFormLineItemsItemPriceDataRecurringX359a0eca(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentLinksPostRequestFormLineItemsItemPriceDataRecurringX359a0eca,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentLinksPostRequestFormLineItemsItemPriceDataRecurringX359a0eca(
    block: InlineV1PaymentLinksPostRequestFormLineItemsItemPriceDataRecurringX359a0eca.Builder.() -> Unit,
): InlineV1PaymentLinksPostRequestFormLineItemsItemPriceDataRecurringX359a0eca =
    InlineV1PaymentLinksPostRequestFormLineItemsItemPriceDataRecurringX359a0eca.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentLinksPostRequestFormLineItemsItemPriceDataRecurringX359a0eca is missing required property '" +
                    name +
                    "'",
            )
