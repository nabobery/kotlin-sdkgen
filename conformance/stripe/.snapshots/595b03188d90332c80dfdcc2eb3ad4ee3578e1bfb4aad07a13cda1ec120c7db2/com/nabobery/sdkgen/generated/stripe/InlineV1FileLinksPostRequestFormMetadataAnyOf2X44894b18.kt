...
public sealed class InlineV1FileLinksPostRequestFormMetadataAnyOf2X44894b18 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1FileLinksPostRequestFormMetadataAnyOf2X44894b18 =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1FileLinksPostRequestFormMetadataAnyOf2X44894b18> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1FileLinksPostRequestFormMetadataAnyOf2X44894b18",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1FileLinksPostRequestFormMetadataAnyOf2X44894b18 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1FileLinksPostRequestFormMetadataAnyOf2X44894b18,
        ) {
