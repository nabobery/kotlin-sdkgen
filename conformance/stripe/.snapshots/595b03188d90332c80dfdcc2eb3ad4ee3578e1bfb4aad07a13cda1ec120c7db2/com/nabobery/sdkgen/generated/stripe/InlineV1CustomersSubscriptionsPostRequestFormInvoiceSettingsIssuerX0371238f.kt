...
public class InlineV1CustomersSubscriptionsPostRequestFormInvoiceSettingsIssuerX0371238f(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1CustomersSubscriptionsPostRequestFormInvoiceSettingsIssuerX0371238f = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1CustomersSubscriptionsPostRequestFormInvoiceSettingsIssuerX0371238f> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CustomersSubscriptionsPostRequestFormInvoiceSettingsIssuerX0371238f must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineV1CustomersSubscriptionsPostRequestFormInvoiceSettingsIssuerTypeX1d179de3>(
                    rawObject,
                    "type",
                )
            return InlineV1CustomersSubscriptionsPostRequestFormInvoiceSettingsIssuerX0371238f(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersSubscriptionsPostRequestFormInvoiceSettingsIssuerX0371238f,
        ) {
            val jsonEncoder =
...
public fun inlineV1CustomersSubscriptionsPostRequestFormInvoiceSettingsIssuerX0371238f(
    block: InlineV1CustomersSubscriptionsPostRequestFormInvoiceSettingsIssuerX0371238f.Builder.() -> Unit,
): InlineV1CustomersSubscriptionsPostRequestFormInvoiceSettingsIssuerX0371238f =
    InlineV1CustomersSubscriptionsPostRequestFormInvoiceSettingsIssuerX0371238f.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1CustomersSubscriptionsPostRequestFormInvoiceSettingsIssuerX0371238f is missing required property '" +
                    name +
                    "'",
            )
