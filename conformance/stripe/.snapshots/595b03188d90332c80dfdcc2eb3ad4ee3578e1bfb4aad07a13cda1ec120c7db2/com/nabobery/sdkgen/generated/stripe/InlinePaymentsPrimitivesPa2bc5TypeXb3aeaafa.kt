...
public sealed class InlinePaymentsPrimitivesPa2bc5TypeXb3aeaafa {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentsPrimitivesPa2bc5TypeXb3aeaafa =
            when (value) {
                Bonus.value -> Bonus
    ...
    public object Serializer : KSerializer<InlinePaymentsPrimitivesPa2bc5TypeXb3aeaafa> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentsPrimitivesPa2bc5TypeXb3aeaafa",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePaymentsPrimitivesPa2bc5TypeXb3aeaafa =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentsPrimitivesPa2bc5TypeXb3aeaafa,
        ) {
