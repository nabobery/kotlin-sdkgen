...
public sealed class InlineCouponObjectValueX72b6b420 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineCouponObjectValueX72b6b420 =
            when (value) {
                Coupon.value -> Coupon
    ...
    public object Serializer : KSerializer<InlineCouponObjectValueX72b6b420> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineCouponObjectValueX72b6b420",
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineCouponObjectValueX72b6b420,
        ) {
