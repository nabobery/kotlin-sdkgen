...
internal data class InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidencePostalCodeXb86ba1ccInspection(
    ...
    public val matchesInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2X6a5fe9c1: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2X6a5fe9c1,
            ).count {
                it
            }
}
...
public class InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidencePostalCodeXb86ba1cc internal constructor(
    ...
    private val inspection: InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidencePostalCodeXb86ba1ccInspection,
) {
    ...
    public val inlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2X6a5fe9c1:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2X6a5fe9c1) {
                json
                    .decodeFromJsonElement<InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2X6a5fe9c1>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidencePostalCodeXb86ba1ccBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2X6a5fe9c1) {
                    add(
                        InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidencePostalCodeXb86ba1ccBranch.InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2X6a5fe9c1,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidencePostalCodeXb86ba1cc {
            val inspection =
                inspectInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidencePostalCodeXb86ba1cc(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidencePostalCodeXb86ba1ccNoMatchException(
                    "InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidencePostalCodeXb86ba1cc matched 0 branches: " +
                        inspection.failures.joinToString("; "),
                )
            }
            return InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidencePostalCodeXb86ba1cc(
                raw,
                json,
                inspection,
            )
    ...
    public object Serializer : KSerializer<InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidencePostalCodeXb86ba1cc> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidencePostalCodeXb86ba1cc,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidencePostalCodeXb86ba1cc",
...
private fun inspectInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidencePostalCodeXb86ba1cc(
    element: JsonElement,
): InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidencePostalCodeXb86ba1ccInspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2X6a5fe9c1 =
        element
            .isJsonDecodable<InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2X6a5fe9c1>()
    return InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidencePostalCodeXb86ba1ccInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2X6a5fe9c1) {
                    add(
                        "InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2X6a5fe9c1: value does not match InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2X6a5fe9c1",
                    )
                }
            },
    )
