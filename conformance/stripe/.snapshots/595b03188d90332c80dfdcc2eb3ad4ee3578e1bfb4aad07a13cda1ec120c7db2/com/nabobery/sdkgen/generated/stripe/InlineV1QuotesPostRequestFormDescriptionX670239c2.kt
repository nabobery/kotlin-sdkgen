...
public class InlineV1QuotesPostRequestFormDescriptionX670239c2 internal constructor(
    ...
    public val inlineV1QuotesPostRequestFormDescriptionAnyOf2X934c45ee:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1QuotesPostRequestFormDescriptionAnyOf2X934c45ee) {
                json
                    .decodeFromJsonElement<InlineV1QuotesPostRequestFormDescriptionAnyOf2X934c45ee>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1QuotesPostRequestFormDescriptionX670239c2Branch>
        get() =
            buildSet {
                ...
                if (inspection.matchesInlineV1QuotesPostRequestFormDescriptionAnyOf2X934c45ee) {
                    add(
                        InlineV1QuotesPostRequestFormDescriptionX670239c2Branch.InlineV1QuotesPostRequestFormDescriptionAnyOf2X934c45ee,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1QuotesPostRequestFormDescriptionX670239c2 {
            val inspection = inspectInlineV1QuotesPostRequestFormDescriptionX670239c2(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1QuotesPostRequestFormDescriptionX670239c2NoMatchException(
                    "InlineV1QuotesPostRequestFormDescriptionX670239c2 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1QuotesPostRequestFormDescriptionX670239c2> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1QuotesPostRequestFormDescriptionX670239c2,
        ) {
...
private fun inspectInlineV1QuotesPostRequestFormDescriptionX670239c2(
    element: JsonElement,
): InlineV1QuotesPostRequestFormDescriptionX670239c2Inspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1QuotesPostRequestFormDescriptionAnyOf2X934c45ee =
        element
            .isJsonDecodable<InlineV1QuotesPostRequestFormDescriptionAnyOf2X934c45ee>()
    return InlineV1QuotesPostRequestFormDescriptionX670239c2Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1QuotesPostRequestFormDescriptionAnyOf2X934c45ee) {
                    add(
                        "InlineV1QuotesPostRequestFormDescriptionAnyOf2X934c45ee: value does not match InlineV1QuotesPostRequestFormDescriptionAnyOf2X934c45ee",
                    )
                }
            },
    )
