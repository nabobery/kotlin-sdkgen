...
public class InlineV1TestHelpersIssuing6a15PostRequestFormFleetXf18649be(
    ...
    public val purchaseType: InlineV1TestHelpersIssuing6a15PostRequestFormFleetPurchaseTypeXcfc78d3c? = null,
    public val reportedBreakdown: InlineV1TestHelpersIssuing6a15PostRequestFormFleetReportedBreakdownXcb6587e3? = null,
    public val serviceType: InlineV1TestHelpersIssuing6a15PostRequestFormFleetServiceTypeX618dfafe? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1TestHelpersIssuing6a15PostRequestFormFleetXf18649be =
            InlineV1TestHelpersIssuing6a15PostRequestFormFleetXf18649be(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TestHelpersIssuing6a15PostRequestFormFleetXf18649be =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TestHelpersIssuing6a15PostRequestFormFleetXf18649be> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TestHelpersIssuing6a15PostRequestFormFleetXf18649be must be a JSON object",
                    )
            return InlineV1TestHelpersIssuing6a15PostRequestFormFleetXf18649be(
                cardholderPromptData =
                    rawObject["cardholder_prompt_data"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TestHelpersIssuing6a15PostRequestFormFleetCardholderPromptDataXaf379396>(
                                it,
                            )
                    },
                purchaseType =
                    rawObject["purchase_type"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TestHelpersIssuing6a15PostRequestFormFleetPurchaseTypeXcfc78d3c>(
                                it,
                            )
                    },
                reportedBreakdown =
                    rawObject["reported_breakdown"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TestHelpersIssuing6a15PostRequestFormFleetReportedBreakdownXcb6587e3>(
                                it,
                            )
                    },
                serviceType =
                    rawObject["service_type"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TestHelpersIssuing6a15PostRequestFormFleetServiceTypeX618dfafe>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TestHelpersIssuing6a15PostRequestFormFleetXf18649be,
        ) {
...
public fun inlineV1TestHelpersIssuing6a15PostRequestFormFleetXf18649be(
    block: InlineV1TestHelpersIssuing6a15PostRequestFormFleetXf18649be.Builder.() -> Unit,
): InlineV1TestHelpersIssuing6a15PostRequestFormFleetXf18649be =
    InlineV1TestHelpersIssuing6a15PostRequestFormFleetXf18649be.build(block)
