...
public data class IssuingTransactionFleetDataView(
    ...
    public val cardholderPromptData: InlineIssuingTransactionFleetDataCardholderPromptDataX2224655b? = null,
...
public class IssuingTransactionFleetData(
    ...
    public class Builder {
        ...
        public fun build(): IssuingTransactionFleetData =
    ...
    public object Serializer : KSerializer<IssuingTransactionFleetData> {
        ...
        override fun deserialize(decoder: Decoder): IssuingTransactionFleetData {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("IssuingTransactionFleetData must be a JSON object")
                ...
                cardholderPromptData =
                    rawObject["cardholder_prompt_data"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineIssuingTransactionFleetDataCardholderPromptDataX2224655b?>(
                                element,
                            )
                        }
                    },
                ...
                reportedBreakdown =
                    rawObject["reported_breakdown"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineIssuingTransactionFleetDataReportedBreakdownX14d2b9dd?>(
                                element,
                            )
                        }
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: IssuingTransactionFleetData,
        ) {
...
public fun issuingTransactionFleetData(
    block: IssuingTransactionFleetData.Builder.() -> Unit,
): IssuingTransactionFleetData = IssuingTransactionFleetData.build(block)
