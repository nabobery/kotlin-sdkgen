...
public sealed class InlineV1SubscriptionsPostRequestFormAutomaticTaxLiabilityTypeX726d18d2 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1SubscriptionsPostRequestFormAutomaticTaxLiabilityTypeX726d18d2 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionsPostRequestFormAutomaticTaxLiabilityTypeX726d18d2> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1SubscriptionsPostRequestFormAutomaticTaxLiabilityTypeX726d18d2",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1SubscriptionsPostRequestFormAutomaticTaxLiabilityTypeX726d18d2 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsPostRequestFormAutomaticTaxLiabilityTypeX726d18d2,
        ) {
