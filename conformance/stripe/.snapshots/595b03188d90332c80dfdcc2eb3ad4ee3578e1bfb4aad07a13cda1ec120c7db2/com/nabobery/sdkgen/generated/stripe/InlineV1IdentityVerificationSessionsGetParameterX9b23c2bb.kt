...
internal data class InlineV1IdentityVerificationSessionsGetParameterX9b23c2bbInspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesInlineV1IdentityVerificationSessionsGetParameterAnyOf1X5101d401,
                matchesBranch2,
            ).count { it }
}
...
public class InlineV1IdentityVerificationSessionsGetParameterX9b23c2bb internal constructor(
    ...
    public val inlineV1IdentityVerificationSessionsGetParameterAnyOf1X5101d401:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1IdentityVerificationSessionsGetParameterAnyOf1X5101d401) {
                json
                    .decodeFromJsonElement<InlineV1IdentityVerificationSessionsGetParameterAnyOf1X5101d401>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1IdentityVerificationSessionsGetParameterX9b23c2bbBranch>
        get() =
            buildSet {
                if (inspection.matchesInlineV1IdentityVerificationSessionsGetParameterAnyOf1X5101d401) {
                    add(
                        InlineV1IdentityVerificationSessionsGetParameterX9b23c2bbBranch.InlineV1IdentityVerificationSessionsGetParameterAnyOf1X5101d401,
                    )
                }
                if (inspection.matchesBranch2) {
                    add(
                        InlineV1IdentityVerificationSessionsGetParameterX9b23c2bbBranch.Branch2,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1IdentityVerificationSessionsGetParameterX9b23c2bb {
            val inspection = inspectInlineV1IdentityVerificationSessionsGetParameterX9b23c2bb(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1IdentityVerificationSessionsGetParameterX9b23c2bbNoMatchException(
                    "InlineV1IdentityVerificationSessionsGetParameterX9b23c2bb matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1IdentityVerificationSessionsGetParameterX9b23c2bb> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IdentityVerificationSessionsGetParameterX9b23c2bb,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1IdentityVerificationSessionsGetParameterX9b23c2bb",
...
private fun inspectInlineV1IdentityVerificationSessionsGetParameterX9b23c2bb(
    element: JsonElement,
): InlineV1IdentityVerificationSessionsGetParameterX9b23c2bbInspection {
    val matchesInlineV1IdentityVerificationSessionsGetParameterAnyOf1X5101d401 =
        element
            .isJsonDecodable<InlineV1IdentityVerificationSessionsGetParameterAnyOf1X5101d401>()
    ...
    return InlineV1IdentityVerificationSessionsGetParameterX9b23c2bbInspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1IdentityVerificationSessionsGetParameterAnyOf1X5101d401) {
                    add(
                        "InlineV1IdentityVerificationSessionsGetParameterAnyOf1X5101d401: value does not match InlineV1IdentityVerificationSessionsGetParameterAnyOf1X5101d401",
                    )
                }
