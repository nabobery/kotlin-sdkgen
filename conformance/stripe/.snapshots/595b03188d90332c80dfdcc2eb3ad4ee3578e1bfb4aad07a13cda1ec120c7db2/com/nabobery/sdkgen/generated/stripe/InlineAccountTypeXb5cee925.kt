...
public sealed class InlineAccountTypeXb5cee925 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineAccountTypeXb5cee925 =
            when (value) {
                Custom.value -> Custom
    ...
    public object Serializer : KSerializer<InlineAccountTypeXb5cee925> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineAccountTypeXb5cee925",
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineAccountTypeXb5cee925,
        ) {
