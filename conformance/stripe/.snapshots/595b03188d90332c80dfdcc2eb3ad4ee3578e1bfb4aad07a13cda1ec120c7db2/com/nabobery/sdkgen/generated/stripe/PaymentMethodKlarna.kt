...
public class PaymentMethodKlarna(
    ...
    public class Builder {
        ...
        public fun build(): PaymentMethodKlarna =
            PaymentMethodKlarna(
                dob = dob,
            )
    }
    ...
    public object Serializer : KSerializer<PaymentMethodKlarna> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodKlarna {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodKlarna must be a JSON object")
                ...
                dob =
                    rawObject["dob"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentMethodKlarnaDobX06112cf7?>(element)
                        }
                    },
            )
        }
...
public fun paymentMethodKlarna(block: PaymentMethodKlarna.Builder.() -> Unit): PaymentMethodKlarna =
    PaymentMethodKlarna.build(block)
