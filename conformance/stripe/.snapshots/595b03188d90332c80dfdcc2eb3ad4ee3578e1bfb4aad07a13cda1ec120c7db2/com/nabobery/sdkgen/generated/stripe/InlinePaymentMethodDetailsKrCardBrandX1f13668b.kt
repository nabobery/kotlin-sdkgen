...
public sealed class InlinePaymentMethodDetailsKrCardBrandX1f13668b {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentMethodDetailsKrCardBrandX1f13668b =
            when (value) {
                Bc.value -> Bc
                Citi.value -> Citi
                Hana.value -> Hana
    ...
    public object Serializer : KSerializer<InlinePaymentMethodDetailsKrCardBrandX1f13668b> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentMethodDetailsKrCardBrandX1f13668b",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePaymentMethodDetailsKrCardBrandX1f13668b =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentMethodDetailsKrCardBrandX1f13668b,
        ) {
