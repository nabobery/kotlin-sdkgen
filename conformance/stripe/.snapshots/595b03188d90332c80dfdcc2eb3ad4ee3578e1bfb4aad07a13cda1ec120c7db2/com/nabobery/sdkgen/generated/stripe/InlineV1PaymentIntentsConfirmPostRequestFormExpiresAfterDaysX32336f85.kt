...
internal data class InlineV1PaymentIntentsConfirmPostRequestFormExpiresAfterDaysX32336f85Inspection(
    ...
    public val matchesInlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2X4d0f3a83: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2X4d0f3a83,
            ).count {
                it
            }
}
...
public class InlineV1PaymentIntentsConfirmPostRequestFormExpiresAfterDaysX32336f85 internal constructor(
    ...
    private val inspection: InlineV1PaymentIntentsConfirmPostRequestFormExpiresAfterDaysX32336f85Inspection,
) {
    ...
    public val inlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2X4d0f3a83:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2X4d0f3a83) {
                json
                    .decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2X4d0f3a83>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1PaymentIntentsConfirmPostRequestFormExpiresAfterDaysX32336f85Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2X4d0f3a83) {
                    add(
                        InlineV1PaymentIntentsConfirmPostRequestFormExpiresAfterDaysX32336f85Branch.InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2X4d0f3a83,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1PaymentIntentsConfirmPostRequestFormExpiresAfterDaysX32336f85 {
            val inspection = inspectInlineV1PaymentIntentsConfirmPostRequestFormExpiresAfterDaysX32336f85(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1PaymentIntentsConfirmPostRequestFormExpiresAfterDaysX32336f85NoMatchException(
                    "InlineV1PaymentIntentsConfirmPostRequestFormExpiresAfterDaysX32336f85 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsConfirmPostRequestFormExpiresAfterDaysX32336f85> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsConfirmPostRequestFormExpiresAfterDaysX32336f85,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1PaymentIntentsConfirmPostRequestFormExpiresAfterDaysX32336f85",
...
private fun inspectInlineV1PaymentIntentsConfirmPostRequestFormExpiresAfterDaysX32336f85(
    element: JsonElement,
): InlineV1PaymentIntentsConfirmPostRequestFormExpiresAfterDaysX32336f85Inspection {
    val matchesBranch1 = element.isJsonDecodable<Int>()
    val matchesInlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2X4d0f3a83 =
        element
            .isJsonDecodable<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2X4d0f3a83>()
    return InlineV1PaymentIntentsConfirmPostRequestFormExpiresAfterDaysX32336f85Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2X4d0f3a83) {
                    add(
                        "InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2X4d0f3a83: value does not match InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2X4d0f3a83",
                    )
                }
            },
    )
