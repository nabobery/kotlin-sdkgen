...
public class InlineV1SourcesPostRequestFormSourceOrderShippingAddressX31adecda(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1SourcesPostRequestFormSourceOrderShippingAddressX31adecda =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1SourcesPostRequestFormSourceOrderShippingAddressX31adecda> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1SourcesPostRequestFormSourceOrderShippingAddressX31adecda {
            val jsonDecoder =
                decoder.requireJsonDecoder(
                    "InlineV1SourcesPostRequestFormSourceOrderShippingAddressX31adecda",
                )
            val json = jsonDecoder.json
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SourcesPostRequestFormSourceOrderShippingAddressX31adecda must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SourcesPostRequestFormSourceOrderShippingAddressX31adecda,
        ) {
            val jsonEncoder =
...
public fun inlineV1SourcesPostRequestFormSourceOrderShippingAddressX31adecda(
    block: InlineV1SourcesPostRequestFormSourceOrderShippingAddressX31adecda.Builder.() -> Unit,
): InlineV1SourcesPostRequestFormSourceOrderShippingAddressX31adecda =
    InlineV1SourcesPostRequestFormSourceOrderShippingAddressX31adecda.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1SourcesPostRequestFormSourceOrderShippingAddressX31adecda is missing required property '" +
                    name +
                    "'",
            )
