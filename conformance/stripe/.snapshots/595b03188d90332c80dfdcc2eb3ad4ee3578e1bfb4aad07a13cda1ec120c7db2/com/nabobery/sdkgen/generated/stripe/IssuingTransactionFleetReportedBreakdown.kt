...
public class IssuingTransactionFleetReportedBreakdown(
    ...
    public class Builder {
        ...
        public fun build(): IssuingTransactionFleetReportedBreakdown =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): IssuingTransactionFleetReportedBreakdown =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<IssuingTransactionFleetReportedBreakdown> {
        ...
        override fun deserialize(decoder: Decoder): IssuingTransactionFleetReportedBreakdown {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("IssuingTransactionFleetReportedBreakdown must be a JSON object")
                ...
                fuel =
                    rawObject["fuel"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineIssuingTransactionFleetReportedBreakdownFuelXa1eac614?>(
                                element,
                            )
                        }
                    },
                nonFuel =
                    rawObject["non_fuel"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineIssuingTransactionFleetReportedBreakdownNonFuelX564913e3?>(
                                element,
                            )
                        }
                    },
                tax =
                    rawObject["tax"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineIssuingTransactionFleetReportedBreakdownTaxX83b5fa87?>(
                                element,
                            )
                        }
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: IssuingTransactionFleetReportedBreakdown,
        ) {
...
public fun issuingTransactionFleetReportedBreakdown(
    block: IssuingTransactionFleetReportedBreakdown.Builder.() -> Unit,
): IssuingTransactionFleetReportedBreakdown = IssuingTransactionFleetReportedBreakdown.build(block)
