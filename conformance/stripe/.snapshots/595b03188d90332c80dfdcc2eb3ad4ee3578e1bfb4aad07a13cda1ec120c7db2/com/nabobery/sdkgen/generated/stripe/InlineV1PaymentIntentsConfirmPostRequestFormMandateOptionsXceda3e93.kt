...
public class InlineV1PaymentIntentsConfirmPostRequestFormMandateOptionsXceda3e93(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1PaymentIntentsConfirmPostRequestFormMandateOptionsXceda3e93 =
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentIntentsConfirmPostRequestFormMandateOptionsXceda3e93 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentIntentsConfirmPostRequestFormMandateOptionsXceda3e93> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsConfirmPostRequestFormMandateOptionsXceda3e93 must be a JSON object",
                    )
            return InlineV1PaymentIntentsConfirmPostRequestFormMandateOptionsXceda3e93(
                amount = rawObject["amount"]?.let { json.decodeFromJsonElement<Int>(it) },
                amountType =
                    rawObject["amount_type"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormAmountTypeX4d68164f>(it)
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsConfirmPostRequestFormMandateOptionsXceda3e93,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentIntentsConfirmPostRequestFormMandateOptionsXceda3e93(
    block: InlineV1PaymentIntentsConfirmPostRequestFormMandateOptionsXceda3e93.Builder.() -> Unit,
): InlineV1PaymentIntentsConfirmPostRequestFormMandateOptionsXceda3e93 =
    InlineV1PaymentIntentsConfirmPostRequestFormMandateOptionsXceda3e93.build(block)
