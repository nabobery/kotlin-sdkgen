...
internal data class InlineV1AccountsPostRequestFormCompanyRegistrationDateXeaab0085Inspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesInlineV1AccountsPostRequestFormCompanyRegistrationDateAnyOf1Xbe74beef,
                matchesInlineV1AccountsPostRequestFormCompanyRegistrationDateAnyOf2X5f0d56ff,
            ).count {
                it
            }
}
...
public class InlineV1AccountsPostRequestFormCompanyRegistrationDateXeaab0085 internal constructor(
    ...
    public val inlineV1AccountsPostRequestFormCompanyRegistrationDateAnyOf1Xbe74beef:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1AccountsPostRequestFormCompanyRegistrationDateAnyOf1Xbe74beef) {
                json
                    .decodeFromJsonElement<InlineV1AccountsPostRequestFormCompanyRegistrationDateAnyOf1Xbe74beef>(
                        raw,
                    )
            } else {
                null
    ...
    public val inlineV1AccountsPostRequestFormCompanyRegistrationDateAnyOf2X5f0d56ff:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1AccountsPostRequestFormCompanyRegistrationDateAnyOf2X5f0d56ff) {
                json
                    .decodeFromJsonElement<InlineV1AccountsPostRequestFormCompanyRegistrationDateAnyOf2X5f0d56ff>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches:
        ...
        get() =
            buildSet {
                if (inspection.matchesInlineV1AccountsPostRequestFormCompanyRegistrationDateAnyOf1Xbe74beef) {
                    add(
                        InlineV1AccountsPostRequestFormCompanyRegistrationDateXeaab0085Branch.InlineV1AccountsPostRequestFormCompanyRegistrationDateAnyOf1Xbe74beef,
                    )
                }
                if (inspection.matchesInlineV1AccountsPostRequestFormCompanyRegistrationDateAnyOf2X5f0d56ff) {
                    add(
                        InlineV1AccountsPostRequestFormCompanyRegistrationDateXeaab0085Branch.InlineV1AccountsPostRequestFormCompanyRegistrationDateAnyOf2X5f0d56ff,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1AccountsPostRequestFormCompanyRegistrationDateXeaab0085 {
            val inspection = inspectInlineV1AccountsPostRequestFormCompanyRegistrationDateXeaab0085(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1AccountsPostRequestFormCompanyRegistrationDateXeaab0085NoMatchException(
                    "InlineV1AccountsPostRequestFormCompanyRegistrationDateXeaab0085 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1AccountsPostRequestFormCompanyRegistrationDateXeaab0085> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPostRequestFormCompanyRegistrationDateXeaab0085,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1AccountsPostRequestFormCompanyRegistrationDateXeaab0085",
...
private fun inspectInlineV1AccountsPostRequestFormCompanyRegistrationDateXeaab0085(
    element: JsonElement,
): InlineV1AccountsPostRequestFormCompanyRegistrationDateXeaab0085Inspection {
    val matchesInlineV1AccountsPostRequestFormCompanyRegistrationDateAnyOf1Xbe74beef =
        element
            .isJsonDecodable<InlineV1AccountsPostRequestFormCompanyRegistrationDateAnyOf1Xbe74beef>()
    val matchesInlineV1AccountsPostRequestFormCompanyRegistrationDateAnyOf2X5f0d56ff =
        element
            .isJsonDecodable<InlineV1AccountsPostRequestFormCompanyRegistrationDateAnyOf2X5f0d56ff>()
    return InlineV1AccountsPostRequestFormCompanyRegistrationDateXeaab0085Inspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1AccountsPostRequestFormCompanyRegistrationDateAnyOf1Xbe74beef) {
                    add(
                        "InlineV1AccountsPostRequestFormCompanyRegistrationDateAnyOf1Xbe74beef: value does not match InlineV1AccountsPostRequestFormCompanyRegistrationDateAnyOf1Xbe74beef",
                    )
                }
                if (!matchesInlineV1AccountsPostRequestFormCompanyRegistrationDateAnyOf2X5f0d56ff) {
                    add(
                        "InlineV1AccountsPostRequestFormCompanyRegistrationDateAnyOf2X5f0d56ff: value does not match InlineV1AccountsPostRequestFormCompanyRegistrationDateAnyOf2X5f0d56ff",
                    )
                }
            },
    )
