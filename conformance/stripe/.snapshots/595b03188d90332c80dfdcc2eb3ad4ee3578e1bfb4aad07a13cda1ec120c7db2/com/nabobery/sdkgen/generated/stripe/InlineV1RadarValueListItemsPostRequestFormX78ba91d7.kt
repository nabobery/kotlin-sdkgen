...
public class InlineV1RadarValueListItemsPostRequestFormX78ba91d7(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1RadarValueListItemsPostRequestFormX78ba91d7 =
    ...
    public object Serializer : KSerializer<InlineV1RadarValueListItemsPostRequestFormX78ba91d7> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1RadarValueListItemsPostRequestFormX78ba91d7 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1RadarValueListItemsPostRequestFormX78ba91d7,
        ) {
...
public fun inlineV1RadarValueListItemsPostRequestFormX78ba91d7(
    block: InlineV1RadarValueListItemsPostRequestFormX78ba91d7.Builder.() -> Unit,
): InlineV1RadarValueListItemsPostRequestFormX78ba91d7 =
    InlineV1RadarValueListItemsPostRequestFormX78ba91d7.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1RadarValueListItemsPostRequestFormX78ba91d7 is missing required property '" + name + "'",
            )
