...
public sealed class InlineSubscriptionScheduleEndBehaviorXf40f838d {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineSubscriptionScheduleEndBehaviorXf40f838d =
            when (value) {
                Cancel.value -> Cancel
                None.value -> None
    ...
    public object Serializer : KSerializer<InlineSubscriptionScheduleEndBehaviorXf40f838d> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineSubscriptionScheduleEndBehaviorXf40f838d",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineSubscriptionScheduleEndBehaviorXf40f838d =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineSubscriptionScheduleEndBehaviorXf40f838d,
        ) {
