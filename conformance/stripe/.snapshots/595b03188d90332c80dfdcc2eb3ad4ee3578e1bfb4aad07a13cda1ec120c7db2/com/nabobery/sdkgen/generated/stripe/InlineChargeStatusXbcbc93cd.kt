...
public sealed class InlineChargeStatusXbcbc93cd {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineChargeStatusXbcbc93cd =
            when (value) {
                Failed.value -> Failed
    ...
    public object Serializer : KSerializer<InlineChargeStatusXbcbc93cd> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineChargeStatusXbcbc93cd",
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineChargeStatusXbcbc93cd,
        ) {
