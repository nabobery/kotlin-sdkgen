...
public class InlineV1SubscriptionsGetParameterXa8e001c1 internal constructor(
    ...
    public val inlineV1SubscriptionsGetParameterAnyOf1Xc3c860aa:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1SubscriptionsGetParameterAnyOf1Xc3c860aa) {
                json
                    .decodeFromJsonElement<InlineV1SubscriptionsGetParameterAnyOf1Xc3c860aa>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1SubscriptionsGetParameterXa8e001c1Branch>
        get() =
            buildSet {
                if (inspection.matchesInlineV1SubscriptionsGetParameterAnyOf1Xc3c860aa) {
                    add(
                        InlineV1SubscriptionsGetParameterXa8e001c1Branch.InlineV1SubscriptionsGetParameterAnyOf1Xc3c860aa,
                    )
                }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1SubscriptionsGetParameterXa8e001c1 {
            val inspection = inspectInlineV1SubscriptionsGetParameterXa8e001c1(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1SubscriptionsGetParameterXa8e001c1NoMatchException(
                    "InlineV1SubscriptionsGetParameterXa8e001c1 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionsGetParameterXa8e001c1> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsGetParameterXa8e001c1,
        ) {
...
private fun inspectInlineV1SubscriptionsGetParameterXa8e001c1(
    element: JsonElement,
): InlineV1SubscriptionsGetParameterXa8e001c1Inspection {
    val matchesInlineV1SubscriptionsGetParameterAnyOf1Xc3c860aa =
        element
            .isJsonDecodable<InlineV1SubscriptionsGetParameterAnyOf1Xc3c860aa>()
    ...
    return InlineV1SubscriptionsGetParameterXa8e001c1Inspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1SubscriptionsGetParameterAnyOf1Xc3c860aa) {
                    add(
                        "InlineV1SubscriptionsGetParameterAnyOf1Xc3c860aa: value does not match InlineV1SubscriptionsGetParameterAnyOf1Xc3c860aa",
                    )
                }
