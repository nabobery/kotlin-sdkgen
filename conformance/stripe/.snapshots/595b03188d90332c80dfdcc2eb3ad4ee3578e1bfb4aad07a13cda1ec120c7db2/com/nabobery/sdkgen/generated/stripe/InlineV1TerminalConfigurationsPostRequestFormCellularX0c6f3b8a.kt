...
internal data class InlineV1TerminalConfigurationsPostRequestFormCellularX0c6f3b8aInspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesInlineV1TerminalConfigurationsPostRequestFormCellularAnyOf1X0eb0e20b,
                matchesInlineV1TerminalConfigurationsPostRequestFormCellularAnyOf2Xbd3c09fe,
            ).count {
                it
            }
}
...
public class InlineV1TerminalConfigurationsPostRequestFormCellularX0c6f3b8a internal constructor(
    ...
    public val inlineV1TerminalConfigurationsPostRequestFormCellularAnyOf1X0eb0e20b:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1TerminalConfigurationsPostRequestFormCellularAnyOf1X0eb0e20b) {
                json
                    .decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormCellularAnyOf1X0eb0e20b>(
                        raw,
                    )
            } else {
                null
    ...
    public val inlineV1TerminalConfigurationsPostRequestFormCellularAnyOf2Xbd3c09fe:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1TerminalConfigurationsPostRequestFormCellularAnyOf2Xbd3c09fe) {
                json
                    .decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormCellularAnyOf2Xbd3c09fe>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches:
        ...
        get() =
            buildSet {
                if (inspection.matchesInlineV1TerminalConfigurationsPostRequestFormCellularAnyOf1X0eb0e20b) {
                    add(
                        InlineV1TerminalConfigurationsPostRequestFormCellularX0c6f3b8aBranch.InlineV1TerminalConfigurationsPostRequestFormCellularAnyOf1X0eb0e20b,
                    )
                }
                if (inspection.matchesInlineV1TerminalConfigurationsPostRequestFormCellularAnyOf2Xbd3c09fe) {
                    add(
                        InlineV1TerminalConfigurationsPostRequestFormCellularX0c6f3b8aBranch.InlineV1TerminalConfigurationsPostRequestFormCellularAnyOf2Xbd3c09fe,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1TerminalConfigurationsPostRequestFormCellularX0c6f3b8a {
            val inspection = inspectInlineV1TerminalConfigurationsPostRequestFormCellularX0c6f3b8a(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1TerminalConfigurationsPostRequestFormCellularX0c6f3b8aNoMatchException(
                    "InlineV1TerminalConfigurationsPostRequestFormCellularX0c6f3b8a matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1TerminalConfigurationsPostRequestFormCellularX0c6f3b8a> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TerminalConfigurationsPostRequestFormCellularX0c6f3b8a,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1TerminalConfigurationsPostRequestFormCellularX0c6f3b8a",
...
private fun inspectInlineV1TerminalConfigurationsPostRequestFormCellularX0c6f3b8a(
    element: JsonElement,
): InlineV1TerminalConfigurationsPostRequestFormCellularX0c6f3b8aInspection {
    val matchesInlineV1TerminalConfigurationsPostRequestFormCellularAnyOf1X0eb0e20b =
        element
            .isJsonDecodable<InlineV1TerminalConfigurationsPostRequestFormCellularAnyOf1X0eb0e20b>()
    val matchesInlineV1TerminalConfigurationsPostRequestFormCellularAnyOf2Xbd3c09fe =
        element
            .isJsonDecodable<InlineV1TerminalConfigurationsPostRequestFormCellularAnyOf2Xbd3c09fe>()
    return InlineV1TerminalConfigurationsPostRequestFormCellularX0c6f3b8aInspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1TerminalConfigurationsPostRequestFormCellularAnyOf1X0eb0e20b) {
                    add(
                        "InlineV1TerminalConfigurationsPostRequestFormCellularAnyOf1X0eb0e20b: value does not match InlineV1TerminalConfigurationsPostRequestFormCellularAnyOf1X0eb0e20b",
                    )
                }
                if (!matchesInlineV1TerminalConfigurationsPostRequestFormCellularAnyOf2Xbd3c09fe) {
                    add(
                        "InlineV1TerminalConfigurationsPostRequestFormCellularAnyOf2Xbd3c09fe: value does not match InlineV1TerminalConfigurationsPostRequestFormCellularAnyOf2Xbd3c09fe",
                    )
                }
            },
    )
