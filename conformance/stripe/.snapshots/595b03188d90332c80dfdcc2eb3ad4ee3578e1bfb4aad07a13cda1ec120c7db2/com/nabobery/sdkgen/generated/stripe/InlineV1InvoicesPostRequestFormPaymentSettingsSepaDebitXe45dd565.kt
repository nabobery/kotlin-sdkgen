...
internal data class InlineV1InvoicesPostRequestFormPaymentSettingsSepaDebitXe45dd565Inspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2Xe6e4af37,
            ).count { it }
}
...
public class InlineV1InvoicesPostRequestFormPaymentSettingsSepaDebitXe45dd565 internal constructor(
    ...
    private val inspection: InlineV1InvoicesPostRequestFormPaymentSettingsSepaDebitXe45dd565Inspection,
) {
    ...
    public val inlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2Xe6e4af37:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2Xe6e4af37) {
                json
                    .decodeFromJsonElement<InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2Xe6e4af37>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1InvoicesPostRequestFormPaymentSettingsSepaDebitXe45dd565Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2Xe6e4af37) {
                    add(
                        InlineV1InvoicesPostRequestFormPaymentSettingsSepaDebitXe45dd565Branch.InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2Xe6e4af37,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1InvoicesPostRequestFormPaymentSettingsSepaDebitXe45dd565 {
            val inspection = inspectInlineV1InvoicesPostRequestFormPaymentSettingsSepaDebitXe45dd565(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1InvoicesPostRequestFormPaymentSettingsSepaDebitXe45dd565NoMatchException(
                    "InlineV1InvoicesPostRequestFormPaymentSettingsSepaDebitXe45dd565 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1InvoicesPostRequestFormPaymentSettingsSepaDebitXe45dd565> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesPostRequestFormPaymentSettingsSepaDebitXe45dd565,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1InvoicesPostRequestFormPaymentSettingsSepaDebitXe45dd565",
...
private fun inspectInlineV1InvoicesPostRequestFormPaymentSettingsSepaDebitXe45dd565(
    element: JsonElement,
): InlineV1InvoicesPostRequestFormPaymentSettingsSepaDebitXe45dd565Inspection {
    val matchesBranch1 = element.isJsonDecodable<JsonObject>()
    val matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2Xe6e4af37 =
        element
            .isJsonDecodable<InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2Xe6e4af37>()
    return InlineV1InvoicesPostRequestFormPaymentSettingsSepaDebitXe45dd565Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2Xe6e4af37) {
                    add(
                        "InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2Xe6e4af37: value does not match InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2Xe6e4af37",
                    )
                }
            },
    )
