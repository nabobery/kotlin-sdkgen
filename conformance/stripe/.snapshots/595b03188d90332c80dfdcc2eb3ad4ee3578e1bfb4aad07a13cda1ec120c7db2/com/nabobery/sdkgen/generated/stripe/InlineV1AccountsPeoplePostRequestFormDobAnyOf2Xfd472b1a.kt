...
public sealed class InlineV1AccountsPeoplePostRequestFormDobAnyOf2Xfd472b1a {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1AccountsPeoplePostRequestFormDobAnyOf2Xfd472b1a =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1AccountsPeoplePostRequestFormDobAnyOf2Xfd472b1a> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1AccountsPeoplePostRequestFormDobAnyOf2Xfd472b1a",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1AccountsPeoplePostRequestFormDobAnyOf2Xfd472b1a =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPeoplePostRequestFormDobAnyOf2Xfd472b1a,
        ) {
