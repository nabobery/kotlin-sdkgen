...
public class InlineV1SourcesPostRequestFormOwnerXced83c15(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1SourcesPostRequestFormOwnerXced83c15 =
            InlineV1SourcesPostRequestFormOwnerXced83c15(
                address = address,
                email = email,
                name = name,
                phone = phone,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1SourcesPostRequestFormOwnerXced83c15 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1SourcesPostRequestFormOwnerXced83c15> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SourcesPostRequestFormOwnerXced83c15 must be a JSON object",
                    )
            return InlineV1SourcesPostRequestFormOwnerXced83c15(
                address =
                    rawObject["address"]?.let {
                        json.decodeFromJsonElement<InlineV1SourcesPostRequestFormOwnerAddressX330f3c87>(it)
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SourcesPostRequestFormOwnerXced83c15,
        ) {
...
public fun inlineV1SourcesPostRequestFormOwnerXced83c15(
    block: InlineV1SourcesPostRequestFormOwnerXced83c15.Builder.() -> Unit,
): InlineV1SourcesPostRequestFormOwnerXced83c15 = InlineV1SourcesPostRequestFormOwnerXced83c15.build(block)
