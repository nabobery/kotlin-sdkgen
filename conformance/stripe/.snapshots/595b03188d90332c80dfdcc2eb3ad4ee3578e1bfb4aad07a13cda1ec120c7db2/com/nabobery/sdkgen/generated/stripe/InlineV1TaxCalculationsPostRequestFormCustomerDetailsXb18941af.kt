...
public class InlineV1TaxCalculationsPostRequestFormCustomerDetailsXb18941af(
    ...
    public val addressSource: InlineV1TaxCalculationsPostRequestFormCustomerDetailsAddressSourceX43e24cf2? = null,
    public val ipAddress: String? = null,
    public val taxIds: List<InlineV1TaxCalculationsPostRequestFormCustomerDetailsTaxIdsItemXd01ce175>? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1TaxCalculationsPostRequestFormCustomerDetailsXb18941af =
            InlineV1TaxCalculationsPostRequestFormCustomerDetailsXb18941af(
                address = address,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TaxCalculationsPostRequestFormCustomerDetailsXb18941af =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TaxCalculationsPostRequestFormCustomerDetailsXb18941af> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TaxCalculationsPostRequestFormCustomerDetailsXb18941af must be a JSON object",
                    )
            return InlineV1TaxCalculationsPostRequestFormCustomerDetailsXb18941af(
                address =
                    rawObject["address"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TaxCalculationsPostRequestFormCustomerDetailsAddressX2a6a22db>(
                                it,
                            )
                    },
                addressSource =
                    rawObject["address_source"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TaxCalculationsPostRequestFormCustomerDetailsAddressSourceX43e24cf2>(
                                it,
                            )
                    },
                ...
                taxIds =
                    rawObject["tax_ids"]?.let {
                        json
                            .decodeFromJsonElement<List<InlineV1TaxCalculationsPostRequestFormCustomerDetailsTaxIdsItemXd01ce175>>(
                                it,
                            )
                    },
                taxabilityOverride =
                    rawObject["taxability_override"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TaxCalculationsPostRequestFormCustomerDetailsTaxabilityOverrideXe2a65a8f>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TaxCalculationsPostRequestFormCustomerDetailsXb18941af,
        ) {
            val jsonEncoder =
...
public fun inlineV1TaxCalculationsPostRequestFormCustomerDetailsXb18941af(
    block: InlineV1TaxCalculationsPostRequestFormCustomerDetailsXb18941af.Builder.() -> Unit,
): InlineV1TaxCalculationsPostRequestFormCustomerDetailsXb18941af =
    InlineV1TaxCalculationsPostRequestFormCustomerDetailsXb18941af.build(block)
