...
public class ConnectEmbeddedAccountSessionCreateComponents(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): ConnectEmbeddedAccountSessionCreateComponents =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<ConnectEmbeddedAccountSessionCreateComponents> {
        ...
        override fun deserialize(decoder: Decoder): ConnectEmbeddedAccountSessionCreateComponents {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "ConnectEmbeddedAccountSessionCreateComponents must be a JSON object",
                    )
            val accountManagement =
                json.decodeRequired<ConnectEmbeddedAccountConfigClaim>(
                    rawObject,
                    "account_management",
                )
            val accountOnboarding =
                json.decodeRequired<ConnectEmbeddedAccountConfigClaim>(
                    rawObject,
                    "account_onboarding",
                )
            ...
            val financialAccount =
                json.decodeRequired<ConnectEmbeddedFinancialAccountConfigClaim>(
                    rawObject,
                    "financial_account",
                )
            val financialAccountTransactions =
                json.decodeRequired<ConnectEmbeddedFinancialAccountTransactionsConfigClaim>(
                    rawObject,
                    "financial_account_transactions",
                )
            val instantPayoutsPromotion =
                json.decodeRequired<ConnectEmbeddedInstantPayoutsPromotionConfig>(
                    rawObject,
            ...
            val issuingCardsList =
                json.decodeRequired<ConnectEmbeddedIssuingCardsListConfigClaim>(
                    rawObject,
                    "issuing_cards_list",
                )
            ...
            val paymentDisputes =
                json.decodeRequired<ConnectEmbeddedPaymentDisputesConfig>(
                    rawObject,
                    "payment_disputes",
                )
            ...
            val payoutReconciliationReport =
                json.decodeRequired<ConnectEmbeddedBaseConfigClaim>(
                    rawObject,
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: ConnectEmbeddedAccountSessionCreateComponents,
        ) {
...
public fun connectEmbeddedAccountSessionCreateComponents(
    block: ConnectEmbeddedAccountSessionCreateComponents.Builder.() -> Unit,
): ConnectEmbeddedAccountSessionCreateComponents = ConnectEmbeddedAccountSessionCreateComponents.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "ConnectEmbeddedAccountSessionCreateComponents is missing required property '" + name + "'",
            )
