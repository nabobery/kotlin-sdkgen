...
public class InlineDiscountCustomerX0a3ac123 internal constructor(
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineDiscountCustomerX0a3ac123 {
            val inspection = inspectInlineDiscountCustomerX0a3ac123(raw)
            if (inspection.matchCount == 0) {
                throw InlineDiscountCustomerX0a3ac123NoMatchException(
                    "InlineDiscountCustomerX0a3ac123 matched 0 branches: " + inspection.failures.joinToString("; "),
                )
            }
    ...
    public object Serializer : KSerializer<InlineDiscountCustomerX0a3ac123> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineDiscountCustomerX0a3ac123,
        ) {
