...
public class InlineV1BillingMeterEventAdjustmentsPostRequestFormCancelX5b9a3417(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1BillingMeterEventAdjustmentsPostRequestFormCancelX5b9a3417 =
            InlineV1BillingMeterEventAdjustmentsPostRequestFormCancelX5b9a3417(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1BillingMeterEventAdjustmentsPostRequestFormCancelX5b9a3417 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1BillingMeterEventAdjustmentsPostRequestFormCancelX5b9a3417> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1BillingMeterEventAdjustmentsPostRequestFormCancelX5b9a3417 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1BillingMeterEventAdjustmentsPostRequestFormCancelX5b9a3417,
        ) {
            val jsonEncoder =
...
public fun inlineV1BillingMeterEventAdjustmentsPostRequestFormCancelX5b9a3417(
    block: InlineV1BillingMeterEventAdjustmentsPostRequestFormCancelX5b9a3417.Builder.() -> Unit,
): InlineV1BillingMeterEventAdjustmentsPostRequestFormCancelX5b9a3417 =
    InlineV1BillingMeterEventAdjustmentsPostRequestFormCancelX5b9a3417.build(block)
