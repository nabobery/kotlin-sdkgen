...
public class PaymentMethodSofort(
    ...
    public class Builder {
        ...
        public fun build(): PaymentMethodSofort =
            PaymentMethodSofort(
                country = country,
            )
    }
    ...
    public object Serializer : KSerializer<PaymentMethodSofort> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodSofort {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodSofort must be a JSON object")
...
public fun paymentMethodSofort(block: PaymentMethodSofort.Builder.() -> Unit): PaymentMethodSofort =
    PaymentMethodSofort.build(block)
