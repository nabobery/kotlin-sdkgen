...
public sealed class InlineIssuingCardholderRequirementsDisabledReasonXb22ed862 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineIssuingCardholderRequirementsDisabledReasonXb22ed862 =
            when (value) {
                Listed.value -> Listed
    ...
    public object Serializer : KSerializer<InlineIssuingCardholderRequirementsDisabledReasonXb22ed862> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineIssuingCardholderRequirementsDisabledReasonXb22ed862",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineIssuingCardholderRequirementsDisabledReasonXb22ed862 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineIssuingCardholderRequirementsDisabledReasonXb22ed862,
        ) {
