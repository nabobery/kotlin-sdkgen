...
@Serializable
public data class PaymentMethodOptionsCardMandateOptionsView(
    ...
    public val supportedTypes: List<InlinePaymentMethodOptionsCardMandateOptionsSupportedTypesItemXcc6168b4>? = null,
)
...
public class PaymentMethodOptionsCardMandateOptions(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentMethodOptionsCardMandateOptions =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentMethodOptionsCardMandateOptions> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodOptionsCardMandateOptions {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodOptionsCardMandateOptions must be a JSON object")
            val amount = json.decodeRequired<Int>(rawObject, "amount")
            val amountType =
                json.decodeRequired<InlinePaymentMethodOptionsCardMandateOptionsAmountTypeX8e5d3777>(
                    rawObject,
                    "amount_type",
                )
            val interval =
                json.decodeRequired<InlinePaymentMethodOptionsCardMandateOptionsIntervalX69e96376>(
                    rawObject,
                    "interval",
                )
                ...
                supportedTypes =
                    rawObject["supported_types"]?.let { element ->
                        if (element ==
                            ...
                            json
                                .decodeFromJsonElement<List<InlinePaymentMethodOptionsCardMandateOptionsSupportedTypesItemXcc6168b4>?>(
                                    element,
                                )
                        }
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentMethodOptionsCardMandateOptions,
        ) {
...
public fun paymentMethodOptionsCardMandateOptions(
    block: PaymentMethodOptionsCardMandateOptions.Builder.() -> Unit,
): PaymentMethodOptionsCardMandateOptions = PaymentMethodOptionsCardMandateOptions.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "PaymentMethodOptionsCardMandateOptions is missing required property '" + name + "'",
            )
