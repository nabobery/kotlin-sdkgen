...
public class InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsMandateOptionsXa13a19b4(
    public val customMandateUrl: InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsCustomMandateUrlX3837b0ae? = null,
    public val defaultFor: List<InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsAcssDebitItemXf16657aa>? = null,
    public val intervalDescription: String? = null,
    public val paymentSchedule: InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsPaymentScheduleXdba62053? = null,
    public val transactionType: InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsTransactionTypeX1413cfd1? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsMandateOptionsXa13a19b4 =
    ...
    public object Serializer : KSerializer<InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsMandateOptionsXa13a19b4> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsMandateOptionsXa13a19b4 must be a JSON object",
                    )
            return InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsMandateOptionsXa13a19b4(
                customMandateUrl =
                    rawObject["custom_mandate_url"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsCustomMandateUrlX3837b0ae>(
                                it,
                            )
                    },
                defaultFor =
                    rawObject["default_for"]?.let {
                        json
                            .decodeFromJsonElement<List<InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsAcssDebitItemXf16657aa>>(
                                it,
                            )
                    },
                intervalDescription =
                ...
                paymentSchedule =
                    rawObject["payment_schedule"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsPaymentScheduleXdba62053>(
                                it,
                            )
                    },
                transactionType =
                    rawObject["transaction_type"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsTransactionTypeX1413cfd1>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsMandateOptionsXa13a19b4,
        ) {
            val jsonEncoder =
...
public fun inlineV1SetupIntentsPostRequestFormPaymentMethodOptionsMandateOptionsXa13a19b4(
    block: InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsMandateOptionsXa13a19b4.Builder.() -> Unit,
): InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsMandateOptionsXa13a19b4 =
    InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsMandateOptionsXa13a19b4.build(block)
