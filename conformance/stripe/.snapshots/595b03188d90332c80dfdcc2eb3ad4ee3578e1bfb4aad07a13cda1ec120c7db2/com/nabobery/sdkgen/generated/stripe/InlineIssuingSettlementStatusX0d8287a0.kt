...
public sealed class InlineIssuingSettlementStatusX0d8287a0 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineIssuingSettlementStatusX0d8287a0 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineIssuingSettlementStatusX0d8287a0> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineIssuingSettlementStatusX0d8287a0",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineIssuingSettlementStatusX0d8287a0 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineIssuingSettlementStatusX0d8287a0,
        ) {
