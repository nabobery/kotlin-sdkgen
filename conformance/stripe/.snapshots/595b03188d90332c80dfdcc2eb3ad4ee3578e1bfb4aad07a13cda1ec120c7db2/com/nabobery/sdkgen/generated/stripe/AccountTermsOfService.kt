...
public class AccountTermsOfService(
    ...
    public class Builder {
        ...
        public fun build(): AccountTermsOfService =
    ...
    public object Serializer : KSerializer<AccountTermsOfService> {
        ...
        override fun deserialize(decoder: Decoder): AccountTermsOfService {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("AccountTermsOfService must be a JSON object")
...
public fun accountTermsOfService(block: AccountTermsOfService.Builder.() -> Unit): AccountTermsOfService =
    AccountTermsOfService.build(block)
