...
public class InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemsItemXf5921ae2(
    ...
    public val discounts: InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemsDiscountsXc5e8fd19? = null,
    public val metadata: Map<String, String>? = null,
    public val price: String? = null,
    public val priceData: InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemsPriceDataX0085aebe? = null,
    public val quantity: Int? = null,
    public val taxRates: InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemsItemTaxRatesX06a02a0b? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemsItemXf5921ae2 =
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemsItemXf5921ae2 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemsItemXf5921ae2> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemsItemXf5921ae2 must be a JSON object",
                    )
            return InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemsItemXf5921ae2(
                billingThresholds =
                    rawObject["billing_thresholds"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemBillingThresholdsXe664861a>(
                                it,
                            )
                    },
                discounts =
                    rawObject["discounts"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemsDiscountsXc5e8fd19>(
                                it,
                            )
                    },
                ...
                priceData =
                    rawObject["price_data"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemsPriceDataX0085aebe>(
                                it,
                            )
                    },
                ...
                taxRates =
                    rawObject["tax_rates"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemsItemTaxRatesX06a02a0b>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemsItemXf5921ae2,
        ) {
            val jsonEncoder =
...
public fun inlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemsItemXf5921ae2(
    block: InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemsItemXf5921ae2.Builder.() -> Unit,
): InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemsItemXf5921ae2 =
    InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemsItemXf5921ae2.build(block)
