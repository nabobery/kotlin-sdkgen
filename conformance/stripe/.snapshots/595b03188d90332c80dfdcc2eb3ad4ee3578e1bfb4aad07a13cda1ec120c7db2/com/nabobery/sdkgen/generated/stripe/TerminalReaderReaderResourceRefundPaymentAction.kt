...
public class TerminalReaderReaderResourceRefundPaymentAction(
     ...
     */
    public val paymentIntent: InlineTerminalReaderReaderResourceRefundPaymentActionPaymentIntentXff759917? = null,
    /**
    ...
    public class Builder {
        ...
        public fun build(): TerminalReaderReaderResourceRefundPaymentAction =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): TerminalReaderReaderResourceRefundPaymentAction =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<TerminalReaderReaderResourceRefundPaymentAction> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "TerminalReaderReaderResourceRefundPaymentAction must be a JSON object",
                    )
            return TerminalReaderReaderResourceRefundPaymentAction(
                amount = rawObject["amount"]?.let { json.decodeFromJsonElement<Int>(it) },
                charge =
                    rawObject["charge"]?.let {
                        json
                            .decodeFromJsonElement<InlineTerminalReaderReaderResourceRefundPaymentActionChargeXfab6da75>(
                                it,
                            )
                    },
                ...
                paymentIntent =
                    rawObject["payment_intent"]?.let {
                        json
                            .decodeFromJsonElement<InlineTerminalReaderReaderResourceRefundPaymentActionPaymentIntentXff759917>(
                                it,
                            )
                    },
                reason =
                    rawObject["reason"]?.let {
                        json
                            .decodeFromJsonElement<InlineTerminalReaderReaderResourceRefundPaymentActionReasonXb6a79c1f>(
                                it,
                            )
                    },
                refund =
                    rawObject["refund"]?.let {
                        json
                            .decodeFromJsonElement<InlineTerminalReaderReaderResourceRefundPaymentActionRefundX0671899e>(
                                it,
                            )
                    },
                ...
                refundPaymentConfig =
                    rawObject["refund_payment_config"]?.let {
                        json.decodeFromJsonElement<TerminalReaderReaderResourceRefundPaymentConfig>(it)
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: TerminalReaderReaderResourceRefundPaymentAction,
        ) {
...
public fun terminalReaderReaderResourceRefundPaymentAction(
    block: TerminalReaderReaderResourceRefundPaymentAction.Builder.() -> Unit,
): TerminalReaderReaderResourceRefundPaymentAction = TerminalReaderReaderResourceRefundPaymentAction.build(block)
