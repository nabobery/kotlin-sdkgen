...
public class InlineV1SubscriptionsPostRequestFormMetadataX303ca204 internal constructor(
    ...
    public val inlineV1SubscriptionsPostRequestFormMetadataAnyOf2X1d1f3148:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1SubscriptionsPostRequestFormMetadataAnyOf2X1d1f3148) {
                json
                    .decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormMetadataAnyOf2X1d1f3148>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1SubscriptionsPostRequestFormMetadataX303ca204Branch>
        get() =
            buildSet {
                ...
                if (inspection.matchesInlineV1SubscriptionsPostRequestFormMetadataAnyOf2X1d1f3148) {
                    add(
                        InlineV1SubscriptionsPostRequestFormMetadataX303ca204Branch.InlineV1SubscriptionsPostRequestFormMetadataAnyOf2X1d1f3148,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1SubscriptionsPostRequestFormMetadataX303ca204 {
            val inspection = inspectInlineV1SubscriptionsPostRequestFormMetadataX303ca204(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1SubscriptionsPostRequestFormMetadataX303ca204NoMatchException(
                    "InlineV1SubscriptionsPostRequestFormMetadataX303ca204 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionsPostRequestFormMetadataX303ca204> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsPostRequestFormMetadataX303ca204,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1SubscriptionsPostRequestFormMetadataX303ca204",
...
private fun inspectInlineV1SubscriptionsPostRequestFormMetadataX303ca204(
    element: JsonElement,
): InlineV1SubscriptionsPostRequestFormMetadataX303ca204Inspection {
    val matchesBranch1 = element.isJsonDecodable<JsonObject>()
    val matchesInlineV1SubscriptionsPostRequestFormMetadataAnyOf2X1d1f3148 =
        element
            .isJsonDecodable<InlineV1SubscriptionsPostRequestFormMetadataAnyOf2X1d1f3148>()
    return InlineV1SubscriptionsPostRequestFormMetadataX303ca204Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1SubscriptionsPostRequestFormMetadataAnyOf2X1d1f3148) {
                    add(
                        "InlineV1SubscriptionsPostRequestFormMetadataAnyOf2X1d1f3148: value does not match InlineV1SubscriptionsPostRequestFormMetadataAnyOf2X1d1f3148",
                    )
                }
            },
    )
