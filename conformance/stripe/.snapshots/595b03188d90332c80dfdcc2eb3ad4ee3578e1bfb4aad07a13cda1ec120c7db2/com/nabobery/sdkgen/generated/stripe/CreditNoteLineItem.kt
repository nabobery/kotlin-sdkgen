...
public class CreditNoteLineItem(
    ...
    public class Builder {
        ...
        public var taxRates: List<TaxRate>
            get() = requireNotNull(taxRatesValue) { "taxRates is required" }
            set(`value`) {
                taxRatesValue = value
            }
    ...
    public object Serializer : KSerializer<CreditNoteLineItem> {
        ...
        override fun deserialize(decoder: Decoder): CreditNoteLineItem {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("CreditNoteLineItem must be a JSON object")
...
public fun creditNoteLineItem(block: CreditNoteLineItem.Builder.() -> Unit): CreditNoteLineItem =
    CreditNoteLineItem.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("CreditNoteLineItem is missing required property '" + name + "'")
