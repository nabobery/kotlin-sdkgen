...
public class InlineV1PaymentMethodsPostRequestFormCardAnyOf2X3788286a(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PaymentMethodsPostRequestFormCardAnyOf2X3788286a =
    ...
    public object Serializer : KSerializer<InlineV1PaymentMethodsPostRequestFormCardAnyOf2X3788286a> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentMethodsPostRequestFormCardAnyOf2X3788286a must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentMethodsPostRequestFormCardAnyOf2X3788286a,
        ) {
...
public fun inlineV1PaymentMethodsPostRequestFormCardAnyOf2X3788286a(
    block: InlineV1PaymentMethodsPostRequestFormCardAnyOf2X3788286a.Builder.() -> Unit,
): InlineV1PaymentMethodsPostRequestFormCardAnyOf2X3788286a =
    InlineV1PaymentMethodsPostRequestFormCardAnyOf2X3788286a.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentMethodsPostRequestFormCardAnyOf2X3788286a is missing required property '" + name + "'",
            )
