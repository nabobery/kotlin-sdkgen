...
public sealed class InlinePaymentMethodDetailsCardInstallmentsPlanTypeX7b8fbc7a {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentMethodDetailsCardInstallmentsPlanTypeX7b8fbc7a =
            when (value) {
                Bonus.value -> Bonus
    ...
    public object Serializer : KSerializer<InlinePaymentMethodDetailsCardInstallmentsPlanTypeX7b8fbc7a> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentMethodDetailsCardInstallmentsPlanTypeX7b8fbc7a",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePaymentMethodDetailsCardInstallmentsPlanTypeX7b8fbc7a =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentMethodDetailsCardInstallmentsPlanTypeX7b8fbc7a,
        ) {
