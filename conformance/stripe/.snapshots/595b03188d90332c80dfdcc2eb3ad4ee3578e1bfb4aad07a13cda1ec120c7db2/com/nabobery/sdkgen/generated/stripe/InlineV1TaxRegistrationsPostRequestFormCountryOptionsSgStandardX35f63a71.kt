...
public class InlineV1TaxRegistrationsPostRequestFormCountryOptionsSgStandardX35f63a71(
    public val placeOfSupplyScheme: InlineV1TaxRegistrationsPostRequestFormPlaceOfSupplySchemeXe6c4a2ec? = null,
) {
    public class Builder {
        public var placeOfSupplyScheme:
            InlineV1TaxRegistrationsPostRequestFormPlaceOfSupplySchemeXe6c4a2ec? = null

        public fun build(): InlineV1TaxRegistrationsPostRequestFormCountryOptionsSgStandardX35f63a71 =
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1TaxRegistrationsPostRequestFormCountryOptionsSgStandardX35f63a71 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1TaxRegistrationsPostRequestFormCountryOptionsSgStandardX35f63a71> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TaxRegistrationsPostRequestFormCountryOptionsSgStandardX35f63a71 must be a JSON object",
                    )
            return InlineV1TaxRegistrationsPostRequestFormCountryOptionsSgStandardX35f63a71(
                placeOfSupplyScheme =
                    rawObject["place_of_supply_scheme"]?.let {
                        json.decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormPlaceOfSupplySchemeXe6c4a2ec>(
                            it,
                        )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TaxRegistrationsPostRequestFormCountryOptionsSgStandardX35f63a71,
        ) {
            val jsonEncoder =
...
public fun inlineV1TaxRegistrationsPostRequestFormCountryOptionsSgStandardX35f63a71(
    block: InlineV1TaxRegistrationsPostRequestFormCountryOptionsSgStandardX35f63a71.Builder.() -> Unit,
): InlineV1TaxRegistrationsPostRequestFormCountryOptionsSgStandardX35f63a71 =
    InlineV1TaxRegistrationsPostRequestFormCountryOptionsSgStandardX35f63a71.build(block)
