...
public sealed class InlineV1TaxIdsPostRequestFormOwnerTypeX096cbc27 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1TaxIdsPostRequestFormOwnerTypeX096cbc27 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1TaxIdsPostRequestFormOwnerTypeX096cbc27> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1TaxIdsPostRequestFormOwnerTypeX096cbc27",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1TaxIdsPostRequestFormOwnerTypeX096cbc27 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TaxIdsPostRequestFormOwnerTypeX096cbc27,
        ) {
