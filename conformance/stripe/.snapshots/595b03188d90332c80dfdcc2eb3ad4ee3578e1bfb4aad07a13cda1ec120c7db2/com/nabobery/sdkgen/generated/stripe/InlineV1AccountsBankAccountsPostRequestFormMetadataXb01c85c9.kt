...
internal data class InlineV1AccountsBankAccountsPostRequestFormMetadataXb01c85c9Inspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1AccountsBankAccountsPostRequestFormMetadataAnyOf2Xa97b0a49,
            ).count { it }
}
...
public class InlineV1AccountsBankAccountsPostRequestFormMetadataXb01c85c9 internal constructor(
    ...
    public val inlineV1AccountsBankAccountsPostRequestFormMetadataAnyOf2Xa97b0a49:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1AccountsBankAccountsPostRequestFormMetadataAnyOf2Xa97b0a49) {
                json
                    .decodeFromJsonElement<InlineV1AccountsBankAccountsPostRequestFormMetadataAnyOf2Xa97b0a49>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1AccountsBankAccountsPostRequestFormMetadataXb01c85c9Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1AccountsBankAccountsPostRequestFormMetadataAnyOf2Xa97b0a49) {
                    add(
                        InlineV1AccountsBankAccountsPostRequestFormMetadataXb01c85c9Branch.InlineV1AccountsBankAccountsPostRequestFormMetadataAnyOf2Xa97b0a49,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1AccountsBankAccountsPostRequestFormMetadataXb01c85c9 {
            val inspection = inspectInlineV1AccountsBankAccountsPostRequestFormMetadataXb01c85c9(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1AccountsBankAccountsPostRequestFormMetadataXb01c85c9NoMatchException(
                    "InlineV1AccountsBankAccountsPostRequestFormMetadataXb01c85c9 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1AccountsBankAccountsPostRequestFormMetadataXb01c85c9> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsBankAccountsPostRequestFormMetadataXb01c85c9,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1AccountsBankAccountsPostRequestFormMetadataXb01c85c9",
...
private fun inspectInlineV1AccountsBankAccountsPostRequestFormMetadataXb01c85c9(
    element: JsonElement,
): InlineV1AccountsBankAccountsPostRequestFormMetadataXb01c85c9Inspection {
    val matchesBranch1 = element.isJsonDecodable<JsonObject>()
    val matchesInlineV1AccountsBankAccountsPostRequestFormMetadataAnyOf2Xa97b0a49 =
        element
            .isJsonDecodable<InlineV1AccountsBankAccountsPostRequestFormMetadataAnyOf2Xa97b0a49>()
    return InlineV1AccountsBankAccountsPostRequestFormMetadataXb01c85c9Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1AccountsBankAccountsPostRequestFormMetadataAnyOf2Xa97b0a49) {
                    add(
                        "InlineV1AccountsBankAccountsPostRequestFormMetadataAnyOf2Xa97b0a49: value does not match InlineV1AccountsBankAccountsPostRequestFormMetadataAnyOf2Xa97b0a49",
                    )
                }
            },
    )
