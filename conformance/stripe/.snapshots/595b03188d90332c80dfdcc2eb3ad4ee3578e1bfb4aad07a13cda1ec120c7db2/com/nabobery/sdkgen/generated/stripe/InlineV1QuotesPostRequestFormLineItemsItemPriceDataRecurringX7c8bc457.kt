...
public class InlineV1QuotesPostRequestFormLineItemsItemPriceDataRecurringX7c8bc457(
    public val interval: InlineV1QuotesPostRequestFormLineItemsItemPriceDataRecurringIntervalX785e72ab,
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1QuotesPostRequestFormLineItemsItemPriceDataRecurringX7c8bc457 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1QuotesPostRequestFormLineItemsItemPriceDataRecurringX7c8bc457> {
        ...
        override fun deserialize(
            decoder: Decoder,
        ): InlineV1QuotesPostRequestFormLineItemsItemPriceDataRecurringX7c8bc457 {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1QuotesPostRequestFormLineItemsItemPriceDataRecurringX7c8bc457 must be a JSON object",
                    )
            val interval =
                json.decodeRequired<InlineV1QuotesPostRequestFormLineItemsItemPriceDataRecurringIntervalX785e72ab>(
                    rawObject,
                    "interval",
                )
            return InlineV1QuotesPostRequestFormLineItemsItemPriceDataRecurringX7c8bc457(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1QuotesPostRequestFormLineItemsItemPriceDataRecurringX7c8bc457,
        ) {
            val jsonEncoder =
...
public fun inlineV1QuotesPostRequestFormLineItemsItemPriceDataRecurringX7c8bc457(
    block: InlineV1QuotesPostRequestFormLineItemsItemPriceDataRecurringX7c8bc457.Builder.() -> Unit,
): InlineV1QuotesPostRequestFormLineItemsItemPriceDataRecurringX7c8bc457 =
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1QuotesPostRequestFormLineItemsItemPriceDataRecurringX7c8bc457 is missing required property '" +
                    name +
                    "'",
            )
