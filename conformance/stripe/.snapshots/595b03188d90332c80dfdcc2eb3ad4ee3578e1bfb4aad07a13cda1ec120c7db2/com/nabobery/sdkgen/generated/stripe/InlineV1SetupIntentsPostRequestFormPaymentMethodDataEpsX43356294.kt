...
public class InlineV1SetupIntentsPostRequestFormPaymentMethodDataEpsX43356294(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1SetupIntentsPostRequestFormPaymentMethodDataEpsX43356294 =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1SetupIntentsPostRequestFormPaymentMethodDataEpsX43356294 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1SetupIntentsPostRequestFormPaymentMethodDataEpsX43356294> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SetupIntentsPostRequestFormPaymentMethodDataEpsX43356294 must be a JSON object",
                    )
            return InlineV1SetupIntentsPostRequestFormPaymentMethodDataEpsX43356294(
                bank =
                    rawObject["bank"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodDataEpsBankX11cd3eb6>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SetupIntentsPostRequestFormPaymentMethodDataEpsX43356294,
        ) {
            val jsonEncoder =
...
public fun inlineV1SetupIntentsPostRequestFormPaymentMethodDataEpsX43356294(
    block: InlineV1SetupIntentsPostRequestFormPaymentMethodDataEpsX43356294.Builder.() -> Unit,
): InlineV1SetupIntentsPostRequestFormPaymentMethodDataEpsX43356294 =
    InlineV1SetupIntentsPostRequestFormPaymentMethodDataEpsX43356294.build(block)
