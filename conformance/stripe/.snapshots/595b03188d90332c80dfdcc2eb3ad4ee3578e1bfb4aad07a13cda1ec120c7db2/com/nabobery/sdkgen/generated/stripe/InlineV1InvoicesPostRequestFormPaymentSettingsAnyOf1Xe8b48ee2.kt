...
public class InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1Xe8b48ee2(
    public val bankTransfer: InlineV1InvoicesPostRequestFormPaymentSettingsBankTransferX21346e73? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1Xe8b48ee2 =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1Xe8b48ee2 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1Xe8b48ee2> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1Xe8b48ee2 must be a JSON object",
                    )
            return InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1Xe8b48ee2(
                bankTransfer =
                    rawObject["bank_transfer"]?.let {
                        json.decodeFromJsonElement<InlineV1InvoicesPostRequestFormPaymentSettingsBankTransferX21346e73>(
                            it,
                        )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1Xe8b48ee2,
        ) {
            val jsonEncoder =
...
public fun inlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1Xe8b48ee2(
    block: InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1Xe8b48ee2.Builder.() -> Unit,
): InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1Xe8b48ee2 =
    InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1Xe8b48ee2.build(block)
