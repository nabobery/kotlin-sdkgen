...
public class SourceTransactionGbpCreditTransferData(
    ...
    public class Builder {
        ...
        public fun build(): SourceTransactionGbpCreditTransferData =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): SourceTransactionGbpCreditTransferData =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<SourceTransactionGbpCreditTransferData> {
        ...
        override fun deserialize(decoder: Decoder): SourceTransactionGbpCreditTransferData {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("SourceTransactionGbpCreditTransferData must be a JSON object")
            return SourceTransactionGbpCreditTransferData(
                ...
                senderAccountNumber =
                    rawObject["sender_account_number"]?.let {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: SourceTransactionGbpCreditTransferData,
        ) {
...
public fun sourceTransactionGbpCreditTransferData(
    block: SourceTransactionGbpCreditTransferData.Builder.() -> Unit,
): SourceTransactionGbpCreditTransferData = SourceTransactionGbpCreditTransferData.build(block)
