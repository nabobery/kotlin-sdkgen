...
public class InlineV1TaxRegistrationsPostRequestFormCountryOptionsSiStandardXdcfeed47(
    public val placeOfSupplyScheme: InlineV1TaxRegistrationsPostRequestFormPlaceOfSupplySchemeXa64a9ac4,
) {
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1TaxRegistrationsPostRequestFormCountryOptionsSiStandardXdcfeed47 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TaxRegistrationsPostRequestFormCountryOptionsSiStandardXdcfeed47> {
        override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1TaxRegistrationsPostRequestFormCountryOptionsSiStandardXdcfeed47 {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TaxRegistrationsPostRequestFormCountryOptionsSiStandardXdcfeed47 must be a JSON object",
                    )
            val placeOfSupplyScheme =
                json
                    .decodeRequired<InlineV1TaxRegistrationsPostRequestFormPlaceOfSupplySchemeXa64a9ac4>(
                        rawObject,
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TaxRegistrationsPostRequestFormCountryOptionsSiStandardXdcfeed47,
        ) {
            val jsonEncoder =
...
public fun inlineV1TaxRegistrationsPostRequestFormCountryOptionsSiStandardXdcfeed47(
    block: InlineV1TaxRegistrationsPostRequestFormCountryOptionsSiStandardXdcfeed47.Builder.() -> Unit,
): InlineV1TaxRegistrationsPostRequestFormCountryOptionsSiStandardXdcfeed47 =
    InlineV1TaxRegistrationsPostRequestFormCountryOptionsSiStandardXdcfeed47.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TaxRegistrationsPostRequestFormCountryOptionsSiStandardXdcfeed47 is missing required property '" +
                    name +
                    "'",
            )
