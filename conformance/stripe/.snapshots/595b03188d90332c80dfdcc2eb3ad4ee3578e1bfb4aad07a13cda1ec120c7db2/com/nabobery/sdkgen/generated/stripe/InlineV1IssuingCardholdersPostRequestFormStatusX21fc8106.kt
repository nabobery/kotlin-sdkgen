...
public sealed class InlineV1IssuingCardholdersPostRequestFormStatusX21fc8106 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1IssuingCardholdersPostRequestFormStatusX21fc8106 =
            when (value) {
                Active.value -> Active
    ...
    public object Serializer : KSerializer<InlineV1IssuingCardholdersPostRequestFormStatusX21fc8106> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1IssuingCardholdersPostRequestFormStatusX21fc8106",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1IssuingCardholdersPostRequestFormStatusX21fc8106 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingCardholdersPostRequestFormStatusX21fc8106,
        ) {
