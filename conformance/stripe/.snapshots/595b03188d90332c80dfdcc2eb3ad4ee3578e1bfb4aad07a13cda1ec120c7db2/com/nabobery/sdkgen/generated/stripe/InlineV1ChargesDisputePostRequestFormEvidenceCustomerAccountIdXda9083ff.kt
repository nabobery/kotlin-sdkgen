...
internal data class InlineV1ChargesDisputePostRequestFormEvidenceCustomerAccountIdXda9083ffInspection(
    ...
    public val matchesInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2Xfc031be1: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2Xfc031be1,
            ).count {
                it
            }
}
...
public class InlineV1ChargesDisputePostRequestFormEvidenceCustomerAccountIdXda9083ff internal constructor(
    ...
    private val inspection: InlineV1ChargesDisputePostRequestFormEvidenceCustomerAccountIdXda9083ffInspection,
) {
    ...
    public val inlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2Xfc031be1:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2Xfc031be1) {
                json
                    .decodeFromJsonElement<InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2Xfc031be1>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1ChargesDisputePostRequestFormEvidenceCustomerAccountIdXda9083ffBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2Xfc031be1) {
                    add(
                        InlineV1ChargesDisputePostRequestFormEvidenceCustomerAccountIdXda9083ffBranch.InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2Xfc031be1,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1ChargesDisputePostRequestFormEvidenceCustomerAccountIdXda9083ff {
            val inspection = inspectInlineV1ChargesDisputePostRequestFormEvidenceCustomerAccountIdXda9083ff(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1ChargesDisputePostRequestFormEvidenceCustomerAccountIdXda9083ffNoMatchException(
                    "InlineV1ChargesDisputePostRequestFormEvidenceCustomerAccountIdXda9083ff matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1ChargesDisputePostRequestFormEvidenceCustomerAccountIdXda9083ff> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ChargesDisputePostRequestFormEvidenceCustomerAccountIdXda9083ff,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1ChargesDisputePostRequestFormEvidenceCustomerAccountIdXda9083ff",
...
private fun inspectInlineV1ChargesDisputePostRequestFormEvidenceCustomerAccountIdXda9083ff(
    element: JsonElement,
): InlineV1ChargesDisputePostRequestFormEvidenceCustomerAccountIdXda9083ffInspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2Xfc031be1 =
        element
            .isJsonDecodable<InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2Xfc031be1>()
    return InlineV1ChargesDisputePostRequestFormEvidenceCustomerAccountIdXda9083ffInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2Xfc031be1) {
                    add(
                        "InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2Xfc031be1: value does not match InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2Xfc031be1",
                    )
                }
            },
    )
