...
public class InlineV1SubscriptionsPostRequestFormPaymentSettingsMandateOptionsX4e503711(
    ...
    public val amountIncludesIof: InlineV1SubscriptionsPostRequestFormPaymentSettingsAmountIncludesIofXc99767e8? = null,
    public val endDate: String? = null,
    public val paymentSchedule: InlineV1SubscriptionsPostRequestFormPaymentSettingsPaymentScheduleXb139cb86? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1SubscriptionsPostRequestFormPaymentSettingsMandateOptionsX4e503711 =
            InlineV1SubscriptionsPostRequestFormPaymentSettingsMandateOptionsX4e503711(
                amount = amount,
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1SubscriptionsPostRequestFormPaymentSettingsMandateOptionsX4e503711 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionsPostRequestFormPaymentSettingsMandateOptionsX4e503711> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SubscriptionsPostRequestFormPaymentSettingsMandateOptionsX4e503711 must be a JSON object",
                    )
            return InlineV1SubscriptionsPostRequestFormPaymentSettingsMandateOptionsX4e503711(
                ...
                amountIncludesIof =
                    rawObject["amount_includes_iof"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormPaymentSettingsAmountIncludesIofXc99767e8>(
                                it,
                            )
                    },
                ...
                paymentSchedule =
                    rawObject["payment_schedule"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormPaymentSettingsPaymentScheduleXb139cb86>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsPostRequestFormPaymentSettingsMandateOptionsX4e503711,
        ) {
            val jsonEncoder =
...
public fun inlineV1SubscriptionsPostRequestFormPaymentSettingsMandateOptionsX4e503711(
    block: InlineV1SubscriptionsPostRequestFormPaymentSettingsMandateOptionsX4e503711.Builder.() -> Unit,
): InlineV1SubscriptionsPostRequestFormPaymentSettingsMandateOptionsX4e503711 =
