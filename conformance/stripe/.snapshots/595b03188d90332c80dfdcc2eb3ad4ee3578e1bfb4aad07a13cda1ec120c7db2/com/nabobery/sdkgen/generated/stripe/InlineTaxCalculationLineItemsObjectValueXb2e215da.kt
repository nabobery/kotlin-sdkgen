...
public sealed class InlineTaxCalculationLineItemsObjectValueXb2e215da {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineTaxCalculationLineItemsObjectValueXb2e215da =
            when (value) {
                List.value -> List
    ...
    public object Serializer : KSerializer<InlineTaxCalculationLineItemsObjectValueXb2e215da> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineTaxCalculationLineItemsObjectValueXb2e215da",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineTaxCalculationLineItemsObjectValueXb2e215da =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineTaxCalculationLineItemsObjectValueXb2e215da,
        ) {
