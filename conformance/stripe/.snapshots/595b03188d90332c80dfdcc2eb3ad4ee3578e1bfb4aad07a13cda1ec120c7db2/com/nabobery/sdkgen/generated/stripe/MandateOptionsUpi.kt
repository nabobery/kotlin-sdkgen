...
public class MandateOptionsUpi(
    ...
    public class Builder {
        ...
        public fun build(): MandateOptionsUpi =
            MandateOptionsUpi(
                amount = amount,
    ...
    public object Serializer : KSerializer<MandateOptionsUpi> {
        ...
        override fun deserialize(decoder: Decoder): MandateOptionsUpi {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("MandateOptionsUpi must be a JSON object")
                ...
                amountType =
                    rawObject["amount_type"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineMandateOptionsUpiAmountTypeX11825549?>(element)
                        }
                    },
                description =
...
public fun mandateOptionsUpi(block: MandateOptionsUpi.Builder.() -> Unit): MandateOptionsUpi =
    MandateOptionsUpi.build(block)
