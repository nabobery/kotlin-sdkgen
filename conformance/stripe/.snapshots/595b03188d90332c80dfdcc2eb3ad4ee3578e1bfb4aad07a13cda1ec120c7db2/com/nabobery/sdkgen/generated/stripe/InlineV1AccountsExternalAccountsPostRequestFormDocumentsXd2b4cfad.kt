...
public class InlineV1AccountsExternalAccountsPostRequestFormDocumentsXd2b4cfad(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1AccountsExternalAccountsPostRequestFormDocumentsXd2b4cfad =
            InlineV1AccountsExternalAccountsPostRequestFormDocumentsXd2b4cfad(
                bankAccountOwnershipVerification = bankAccountOwnershipVerification,
            )
    }

    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1AccountsExternalAccountsPostRequestFormDocumentsXd2b4cfad =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1AccountsExternalAccountsPostRequestFormDocumentsXd2b4cfad> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountsExternalAccountsPostRequestFormDocumentsXd2b4cfad must be a JSON object",
                    )
            return InlineV1AccountsExternalAccountsPostRequestFormDocumentsXd2b4cfad(
                bankAccountOwnershipVerification =
                    rawObject["bank_account_ownership_verification"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1AccountsExternalAcd662PostRequestFormBankAccountOwnership2a7eX701c65ea>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsExternalAccountsPostRequestFormDocumentsXd2b4cfad,
        ) {
            val jsonEncoder =
...
public fun inlineV1AccountsExternalAccountsPostRequestFormDocumentsXd2b4cfad(
    block: InlineV1AccountsExternalAccountsPostRequestFormDocumentsXd2b4cfad.Builder.() -> Unit,
): InlineV1AccountsExternalAccountsPostRequestFormDocumentsXd2b4cfad =
    InlineV1AccountsExternalAccountsPostRequestFormDocumentsXd2b4cfad.build(block)
