...
public class PortalFlowsSubscriptionUpdateConfirmDiscount(
    ...
    public class Builder {
        ...
        public fun build(): PortalFlowsSubscriptionUpdateConfirmDiscount =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PortalFlowsSubscriptionUpdateConfirmDiscount =
    ...
    public object Serializer : KSerializer<PortalFlowsSubscriptionUpdateConfirmDiscount> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "PortalFlowsSubscriptionUpdateConfirmDiscount must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PortalFlowsSubscriptionUpdateConfirmDiscount,
        ) {
...
public fun portalFlowsSubscriptionUpdateConfirmDiscount(
    block: PortalFlowsSubscriptionUpdateConfirmDiscount.Builder.() -> Unit,
): PortalFlowsSubscriptionUpdateConfirmDiscount = PortalFlowsSubscriptionUpdateConfirmDiscount.build(block)
