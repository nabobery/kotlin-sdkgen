...
public class InlineV1PricesGetParameterX903af275 internal constructor(
    ...
    public val inlineV1PricesGetParameterAnyOf1X0dfb8bec: InlineV1PricesGetParameterAnyOf1X0dfb8bec?
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1PricesGetParameterAnyOf1X0dfb8bec) {
                json
                    .decodeFromJsonElement<InlineV1PricesGetParameterAnyOf1X0dfb8bec>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1PricesGetParameterX903af275Branch>
        get() =
            buildSet {
                if (inspection.matchesInlineV1PricesGetParameterAnyOf1X0dfb8bec) {
                    add(
                        InlineV1PricesGetParameterX903af275Branch.InlineV1PricesGetParameterAnyOf1X0dfb8bec,
                    )
                }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1PricesGetParameterX903af275 {
            val inspection = inspectInlineV1PricesGetParameterX903af275(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1PricesGetParameterX903af275NoMatchException(
                    "InlineV1PricesGetParameterX903af275 matched 0 branches: " + inspection.failures.joinToString("; "),
                )
            }
    ...
    public object Serializer : KSerializer<InlineV1PricesGetParameterX903af275> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PricesGetParameterX903af275,
        ) {
...
private fun inspectInlineV1PricesGetParameterX903af275(
    element: JsonElement,
): InlineV1PricesGetParameterX903af275Inspection {
    val matchesInlineV1PricesGetParameterAnyOf1X0dfb8bec =
        element
            .isJsonDecodable<InlineV1PricesGetParameterAnyOf1X0dfb8bec>()
    ...
    return InlineV1PricesGetParameterX903af275Inspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1PricesGetParameterAnyOf1X0dfb8bec) {
                    add(
                        "InlineV1PricesGetParameterAnyOf1X0dfb8bec: value does not match InlineV1PricesGetParameterAnyOf1X0dfb8bec",
                    )
                }
