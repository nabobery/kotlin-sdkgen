...
internal data class InlineV1PaymentLinksPostRequestFormPaymentIntentDataDescriptionXadb7d892Inspection(
    ...
    public val matchesInlineV1PaymentLinksPostRequestFormPaymentIntentDataDescriptionAnyOf2Xdee3ab23: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1PaymentLinksPostRequestFormPaymentIntentDataDescriptionAnyOf2Xdee3ab23,
            ).count {
                it
            }
}
...
public class InlineV1PaymentLinksPostRequestFormPaymentIntentDataDescriptionXadb7d892 internal constructor(
    ...
    private val inspection: InlineV1PaymentLinksPostRequestFormPaymentIntentDataDescriptionXadb7d892Inspection,
) {
    ...
    public val inlineV1PaymentLinksPostRequestFormPaymentIntentDataDescriptionAnyOf2Xdee3ab23:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1PaymentLinksPostRequestFormPaymentIntentDataDescriptionAnyOf2Xdee3ab23) {
                json
                    .decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormPaymentIntentDataDescriptionAnyOf2Xdee3ab23>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1PaymentLinksPostRequestFormPaymentIntentDataDescriptionXadb7d892Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1PaymentLinksPostRequestFormPaymentIntentDataDescriptionAnyOf2Xdee3ab23) {
                    add(
                        InlineV1PaymentLinksPostRequestFormPaymentIntentDataDescriptionXadb7d892Branch.InlineV1PaymentLinksPostRequestFormPaymentIntentDataDescriptionAnyOf2Xdee3ab23,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1PaymentLinksPostRequestFormPaymentIntentDataDescriptionXadb7d892 {
            val inspection = inspectInlineV1PaymentLinksPostRequestFormPaymentIntentDataDescriptionXadb7d892(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1PaymentLinksPostRequestFormPaymentIntentDataDescriptionXadb7d892NoMatchException(
                    "InlineV1PaymentLinksPostRequestFormPaymentIntentDataDescriptionXadb7d892 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1PaymentLinksPostRequestFormPaymentIntentDataDescriptionXadb7d892> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentLinksPostRequestFormPaymentIntentDataDescriptionXadb7d892,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1PaymentLinksPostRequestFormPaymentIntentDataDescriptionXadb7d892",
...
private fun inspectInlineV1PaymentLinksPostRequestFormPaymentIntentDataDescriptionXadb7d892(
    element: JsonElement,
): InlineV1PaymentLinksPostRequestFormPaymentIntentDataDescriptionXadb7d892Inspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1PaymentLinksPostRequestFormPaymentIntentDataDescriptionAnyOf2Xdee3ab23 =
        element
            .isJsonDecodable<InlineV1PaymentLinksPostRequestFormPaymentIntentDataDescriptionAnyOf2Xdee3ab23>()
    return InlineV1PaymentLinksPostRequestFormPaymentIntentDataDescriptionXadb7d892Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1PaymentLinksPostRequestFormPaymentIntentDataDescriptionAnyOf2Xdee3ab23) {
                    add(
                        "InlineV1PaymentLinksPostRequestFormPaymentIntentDataDescriptionAnyOf2Xdee3ab23: value does not match InlineV1PaymentLinksPostRequestFormPaymentIntentDataDescriptionAnyOf2Xdee3ab23",
                    )
                }
            },
    )
