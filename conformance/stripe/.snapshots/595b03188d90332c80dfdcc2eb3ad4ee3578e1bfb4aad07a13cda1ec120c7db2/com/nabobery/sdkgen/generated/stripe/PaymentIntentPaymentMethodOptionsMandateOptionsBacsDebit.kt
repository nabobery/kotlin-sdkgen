...
public class PaymentIntentPaymentMethodOptionsMandateOptionsBacsDebit(
    ...
    public class Builder {
        ...
        public fun build(): PaymentIntentPaymentMethodOptionsMandateOptionsBacsDebit =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentIntentPaymentMethodOptionsMandateOptionsBacsDebit =
    ...
    public object Serializer : KSerializer<PaymentIntentPaymentMethodOptionsMandateOptionsBacsDebit> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "PaymentIntentPaymentMethodOptionsMandateOptionsBacsDebit must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentIntentPaymentMethodOptionsMandateOptionsBacsDebit,
        ) {
...
public fun paymentIntentPaymentMethodOptionsMandateOptionsBacsDebit(
    block: PaymentIntentPaymentMethodOptionsMandateOptionsBacsDebit.Builder.() -> Unit,
): PaymentIntentPaymentMethodOptionsMandateOptionsBacsDebit =
    PaymentIntentPaymentMethodOptionsMandateOptionsBacsDebit.build(block)
