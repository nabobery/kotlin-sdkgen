...
public sealed class InlinePortalSubscriptionUpdateBillingCycleAnchorXb8f51ecd {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePortalSubscriptionUpdateBillingCycleAnchorXb8f51ecd =
            when (value) {
                Now.value -> Now
    ...
    public object Serializer : KSerializer<InlinePortalSubscriptionUpdateBillingCycleAnchorXb8f51ecd> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePortalSubscriptionUpdateBillingCycleAnchorXb8f51ecd",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePortalSubscriptionUpdateBillingCycleAnchorXb8f51ecd =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePortalSubscriptionUpdateBillingCycleAnchorXb8f51ecd,
        ) {
