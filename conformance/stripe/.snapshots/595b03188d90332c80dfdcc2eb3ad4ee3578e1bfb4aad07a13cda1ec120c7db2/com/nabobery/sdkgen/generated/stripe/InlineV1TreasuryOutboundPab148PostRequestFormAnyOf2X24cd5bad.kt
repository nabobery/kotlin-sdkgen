...
public sealed class InlineV1TreasuryOutboundPab148PostRequestFormAnyOf2X24cd5bad {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1TreasuryOutboundPab148PostRequestFormAnyOf2X24cd5bad =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1TreasuryOutboundPab148PostRequestFormAnyOf2X24cd5bad> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1TreasuryOutboundPab148PostRequestFormAnyOf2X24cd5bad",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1TreasuryOutboundPab148PostRequestFormAnyOf2X24cd5bad =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TreasuryOutboundPab148PostRequestFormAnyOf2X24cd5bad,
        ) {
