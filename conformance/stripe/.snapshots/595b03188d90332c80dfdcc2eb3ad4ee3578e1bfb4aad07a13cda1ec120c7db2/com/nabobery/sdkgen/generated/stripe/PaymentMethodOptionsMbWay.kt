...
public class PaymentMethodOptionsMbWay(
    ...
    public class Builder {
        ...
        public fun build(): PaymentMethodOptionsMbWay =
    ...
    public object Serializer : KSerializer<PaymentMethodOptionsMbWay> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodOptionsMbWay {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodOptionsMbWay must be a JSON object")
            return PaymentMethodOptionsMbWay(
                setupFutureUsage =
                    rawObject["setup_future_usage"]?.let {
                        json.decodeFromJsonElement<InlinePaymentMethodOptionsMbWaySetupFutureUsageXd75b8bb1>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentMethodOptionsMbWay,
        ) {
...
public fun paymentMethodOptionsMbWay(block: PaymentMethodOptionsMbWay.Builder.() -> Unit): PaymentMethodOptionsMbWay =
    PaymentMethodOptionsMbWay.build(block)
