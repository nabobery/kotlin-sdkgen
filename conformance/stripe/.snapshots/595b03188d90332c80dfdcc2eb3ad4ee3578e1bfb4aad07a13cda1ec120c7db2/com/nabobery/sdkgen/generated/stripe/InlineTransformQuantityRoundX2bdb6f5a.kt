...
public sealed class InlineTransformQuantityRoundX2bdb6f5a {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineTransformQuantityRoundX2bdb6f5a =
            when (value) {
                Down.value -> Down
                Up.value -> Up
    ...
    public object Serializer : KSerializer<InlineTransformQuantityRoundX2bdb6f5a> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineTransformQuantityRoundX2bdb6f5a",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineTransformQuantityRoundX2bdb6f5a =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineTransformQuantityRoundX2bdb6f5a,
        ) {
