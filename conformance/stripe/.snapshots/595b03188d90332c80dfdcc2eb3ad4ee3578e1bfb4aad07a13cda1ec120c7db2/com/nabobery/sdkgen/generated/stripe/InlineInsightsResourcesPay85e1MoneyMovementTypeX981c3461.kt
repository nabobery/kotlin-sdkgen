...
public sealed class InlineInsightsResourcesPay85e1MoneyMovementTypeX981c3461 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineInsightsResourcesPay85e1MoneyMovementTypeX981c3461 =
            when (value) {
                Card.value -> Card
    ...
    public object Serializer : KSerializer<InlineInsightsResourcesPay85e1MoneyMovementTypeX981c3461> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineInsightsResourcesPay85e1MoneyMovementTypeX981c3461",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineInsightsResourcesPay85e1MoneyMovementTypeX981c3461 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineInsightsResourcesPay85e1MoneyMovementTypeX981c3461,
        ) {
