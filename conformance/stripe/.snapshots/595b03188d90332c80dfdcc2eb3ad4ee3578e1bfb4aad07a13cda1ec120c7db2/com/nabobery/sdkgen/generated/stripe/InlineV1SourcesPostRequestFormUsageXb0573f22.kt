...
public sealed class InlineV1SourcesPostRequestFormUsageXb0573f22 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1SourcesPostRequestFormUsageXb0573f22 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1SourcesPostRequestFormUsageXb0573f22> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1SourcesPostRequestFormUsageXb0573f22",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1SourcesPostRequestFormUsageXb0573f22 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SourcesPostRequestFormUsageXb0573f22,
        ) {
