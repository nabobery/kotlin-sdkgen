...
public sealed class InlineV1TestHelpersIssuingAuthorizationsPostRequestFormWalletXee995495 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1TestHelpersIssuingAuthorizationsPostRequestFormWalletXee995495 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1TestHelpersIssuingAuthorizationsPostRequestFormWalletXee995495> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1TestHelpersIssuingAuthorizationsPostRequestFormWalletXee995495",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1TestHelpersIssuingAuthorizationsPostRequestFormWalletXee995495 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TestHelpersIssuingAuthorizationsPostRequestFormWalletXee995495,
        ) {
