...
public class TerminalReaderReaderResourceFileMetadata(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): TerminalReaderReaderResourceFileMetadata =
    ...
    public object Serializer : KSerializer<TerminalReaderReaderResourceFileMetadata> {
        ...
        override fun deserialize(decoder: Decoder): TerminalReaderReaderResourceFileMetadata {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("TerminalReaderReaderResourceFileMetadata must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: TerminalReaderReaderResourceFileMetadata,
        ) {
...
public fun terminalReaderReaderResourceFileMetadata(
    block: TerminalReaderReaderResourceFileMetadata.Builder.() -> Unit,
): TerminalReaderReaderResourceFileMetadata = TerminalReaderReaderResourceFileMetadata.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "TerminalReaderReaderResourceFileMetadata is missing required property '" + name + "'",
            )
