...
public class AccountPayoutSettings(
    ...
    public object Serializer : KSerializer<AccountPayoutSettings> {
        ...
        override fun deserialize(decoder: Decoder): AccountPayoutSettings {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("AccountPayoutSettings must be a JSON object")
...
public fun accountPayoutSettings(block: AccountPayoutSettings.Builder.() -> Unit): AccountPayoutSettings =
    AccountPayoutSettings.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("AccountPayoutSettings is missing required property '" + name + "'")
