...
@Serializable
public data class BillingPortalConfigurationView(
...
public class BillingPortalConfiguration(
    ...
    public object Serializer : KSerializer<BillingPortalConfiguration> {
        ...
        override fun deserialize(decoder: Decoder): BillingPortalConfiguration {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("BillingPortalConfiguration must be a JSON object")
            ...
            val objectValue =
                json.decodeRequired<InlineBillingPortalConfigurationObjectValueX67d405e0>(
                    rawObject,
                    "object",
                )
                ...
                application =
                    rawObject["application"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineBillingPortalConfigurationApplicationXa56c0eb7?>(element)
                        }
                    },
                defaultReturnUrl =
                    rawObject["default_return_url"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: BillingPortalConfiguration,
        ) {
...
public fun billingPortalConfiguration(
    block: BillingPortalConfiguration.Builder.() -> Unit,
): BillingPortalConfiguration = BillingPortalConfiguration.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException("BillingPortalConfiguration is missing required property '" + name + "'")
