...
public sealed class InlineTreasuryFinancialAccf6dfSupportedNetworksItemX379394bf {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineTreasuryFinancialAccf6dfSupportedNetworksItemX379394bf =
            when (value) {
                Ach.value -> Ach
    ...
    public object Serializer : KSerializer<InlineTreasuryFinancialAccf6dfSupportedNetworksItemX379394bf> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineTreasuryFinancialAccf6dfSupportedNetworksItemX379394bf",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineTreasuryFinancialAccf6dfSupportedNetworksItemX379394bf =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineTreasuryFinancialAccf6dfSupportedNetworksItemX379394bf,
        ) {
