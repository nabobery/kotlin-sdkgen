...
public class InlineV1BalanceSettingsPostRequestFormPaymentsPayoutsX8d952677(
    ...
    public val schedule: InlineV1BalanceSettingsPostRequestFormPaymentsPayoutsScheduleX6017e5c2? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1BalanceSettingsPostRequestFormPaymentsPayoutsX8d952677 =
            InlineV1BalanceSettingsPostRequestFormPaymentsPayoutsX8d952677(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1BalanceSettingsPostRequestFormPaymentsPayoutsX8d952677 =
    ...
    public object Serializer : KSerializer<InlineV1BalanceSettingsPostRequestFormPaymentsPayoutsX8d952677> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1BalanceSettingsPostRequestFormPaymentsPayoutsX8d952677 must be a JSON object",
                    )
            return InlineV1BalanceSettingsPostRequestFormPaymentsPayoutsX8d952677(
                automaticTransferRulesByCurrency =
                    rawObject["automatic_transfer_rules_by_currency"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1BalanceSettingsPostRequestFormPaymentsAutomaticTransferRuldc17X65b5a674>(
                                it,
                            )
                    },
                minimumBalanceByCurrency =
                    rawObject["minimum_balance_by_currency"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1BalanceSettingsPostRequestFormPaymentsMinimumBalanceByCurrencyX57974978>(
                                it,
                            )
                    },
                schedule =
                    rawObject["schedule"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1BalanceSettingsPostRequestFormPaymentsPayoutsScheduleX6017e5c2>(
                                it,
                            )
                    },
                statementDescriptor =
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1BalanceSettingsPostRequestFormPaymentsPayoutsX8d952677,
        ) {
            val jsonEncoder =
            ...
            val raw =
                buildJsonObject {
                    value.automaticTransferRulesByCurrency?.let {
                        put("automatic_transfer_rules_by_currency", json.encodeToJsonElement(it))
                    }
                    value.minimumBalanceByCurrency?.let {
                        put(
...
public fun inlineV1BalanceSettingsPostRequestFormPaymentsPayoutsX8d952677(
    block: InlineV1BalanceSettingsPostRequestFormPaymentsPayoutsX8d952677.Builder.() -> Unit,
): InlineV1BalanceSettingsPostRequestFormPaymentsPayoutsX8d952677 =
    InlineV1BalanceSettingsPostRequestFormPaymentsPayoutsX8d952677.build(block)
