...
public class InlineV1SubscriptionsPostRequestFormAddInvoiceItemsItemX14b4e13f(
    ...
    public val discounts: List<InlineV1SubscriptionsPostRequestFormAddInvoiceItemsItemDiscountsItemXd785da4a>? = null,
    ...
    public val priceData: InlineV1SubscriptionsPostRequestFormAddInvoiceItemsItemPriceDataX5692eb9b? = null,
    public val quantity: Int? = null,
    public val taxRates: InlineV1SubscriptionsPostRequestFormAddInvoiceItemsItemTaxRatesXa2ce4aad? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1SubscriptionsPostRequestFormAddInvoiceItemsItemX14b4e13f =
            InlineV1SubscriptionsPostRequestFormAddInvoiceItemsItemX14b4e13f(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1SubscriptionsPostRequestFormAddInvoiceItemsItemX14b4e13f =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1SubscriptionsPostRequestFormAddInvoiceItemsItemX14b4e13f> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SubscriptionsPostRequestFormAddInvoiceItemsItemX14b4e13f must be a JSON object",
                    )
            return InlineV1SubscriptionsPostRequestFormAddInvoiceItemsItemX14b4e13f(
                ...
                discounts =
                    rawObject["discounts"]?.let {
                        json
                            .decodeFromJsonElement<List<InlineV1SubscriptionsPostRequestFormAddInvoiceItemsItemDiscountsItemXd785da4a>>(
                                it,
                            )
                    },
                ...
                period =
                    rawObject["period"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormAddInvoiceItemsItemPeriodX690cb9a9>(
                                it,
                            )
                    },
                ...
                priceData =
                    rawObject["price_data"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormAddInvoiceItemsItemPriceDataX5692eb9b>(
                                it,
                            )
                    },
                ...
                taxRates =
                    rawObject["tax_rates"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormAddInvoiceItemsItemTaxRatesXa2ce4aad>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsPostRequestFormAddInvoiceItemsItemX14b4e13f,
        ) {
            val jsonEncoder =
...
public fun inlineV1SubscriptionsPostRequestFormAddInvoiceItemsItemX14b4e13f(
    block: InlineV1SubscriptionsPostRequestFormAddInvoiceItemsItemX14b4e13f.Builder.() -> Unit,
): InlineV1SubscriptionsPostRequestFormAddInvoiceItemsItemX14b4e13f =
    InlineV1SubscriptionsPostRequestFormAddInvoiceItemsItemX14b4e13f.build(block)
