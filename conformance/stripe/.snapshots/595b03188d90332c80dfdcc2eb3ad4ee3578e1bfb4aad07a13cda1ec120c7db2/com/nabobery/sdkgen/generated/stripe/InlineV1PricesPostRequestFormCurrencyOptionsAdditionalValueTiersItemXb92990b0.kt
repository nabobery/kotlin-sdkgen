...
public class InlineV1PricesPostRequestFormCurrencyOptionsAdditionalValueTiersItemXb92990b0(
    ...
    public object Serializer : KSerializer<InlineV1PricesPostRequestFormCurrencyOptionsAdditionalValueTiersItemXb92990b0> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PricesPostRequestFormCurrencyOptionsAdditionalValueTiersItemXb92990b0 must be a JSON object",
                    )
            val upTo =
                json.decodeRequired<InlineV1PricesPostRequestFormCurrencyOptionsAdditionalValueTiersUpToXeeb3c153>(
                    rawObject,
                    "up_to",
                )
            return InlineV1PricesPostRequestFormCurrencyOptionsAdditionalValueTiersItemXb92990b0(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PricesPostRequestFormCurrencyOptionsAdditionalValueTiersItemXb92990b0,
        ) {
            val jsonEncoder =
...
public fun inlineV1PricesPostRequestFormCurrencyOptionsAdditionalValueTiersItemXb92990b0(
    block: InlineV1PricesPostRequestFormCurrencyOptionsAdditionalValueTiersItemXb92990b0.Builder.() -> Unit,
): InlineV1PricesPostRequestFormCurrencyOptionsAdditionalValueTiersItemXb92990b0 =
    InlineV1PricesPostRequestFormCurrencyOptionsAdditionalValueTiersItemXb92990b0.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PricesPostRequestFormCurrencyOptionsAdditionalValueTiersItemXb92990b0 is missing required property '" +
                    name +
                    "'",
            )
