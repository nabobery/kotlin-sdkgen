...
public class QuotesResourceStatusTransitions(
    ...
    public class Builder {
        ...
        public fun build(): QuotesResourceStatusTransitions =
    ...
    public object Serializer : KSerializer<QuotesResourceStatusTransitions> {
        ...
        override fun deserialize(decoder: Decoder): QuotesResourceStatusTransitions {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("QuotesResourceStatusTransitions must be a JSON object")
            return QuotesResourceStatusTransitions(
                acceptedAt =
                    rawObject["accepted_at"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: QuotesResourceStatusTransitions,
        ) {
...
public fun quotesResourceStatusTransitions(
    block: QuotesResourceStatusTransitions.Builder.() -> Unit,
): QuotesResourceStatusTransitions = QuotesResourceStatusTransitions.build(block)
