...
@Serializable
public data class IssuingTransactionView(
...
public class IssuingTransaction(
    ...
    public object Serializer : KSerializer<IssuingTransaction> {
        ...
        override fun deserialize(decoder: Decoder): IssuingTransaction {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("IssuingTransaction must be a JSON object")
                ...
                amountDetails =
                    rawObject["amount_details"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineIssuingTransactionAmountDetailsX1f1f12ca?>(element)
                        }
                    },
                authorization =
                    rawObject["authorization"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineIssuingTransactionAuthorizationX61b3c552?>(element)
                        }
                    },
                balanceTransaction =
                    rawObject["balance_transaction"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineIssuingTransactionBalanceTransactionX8a6bb6b9?>(element)
                        }
                    },
                cardholder =
                    rawObject["cardholder"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineIssuingTransactionCardholderX282f1566?>(element)
                        }
                    },
                dispute =
                    rawObject["dispute"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineIssuingTransactionDisputeXddd279da?>(element)
                        }
                    },
                networkData =
                    rawObject["network_data"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineIssuingTransactionNetworkDataXb43544fa?>(element)
                        }
                    },
                purchaseDetails =
                    rawObject["purchase_details"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineIssuingTransactionPurchaseDetailsXd6983dca?>(element)
                        }
                    },
                token =
                    rawObject["token"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineIssuingTransactionTokenX8b0d36f2?>(element)
                        }
                    },
                treasury =
                    rawObject["treasury"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineIssuingTransactionTreasuryX3d6b5c21?>(element)
                        }
                    },
                wallet =
                    rawObject["wallet"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineIssuingTransactionWalletXecbc9014?>(element)
                        }
                    },
            )
        }
...
public fun issuingTransaction(block: IssuingTransaction.Builder.() -> Unit): IssuingTransaction =
    IssuingTransaction.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("IssuingTransaction is missing required property '" + name + "'")
