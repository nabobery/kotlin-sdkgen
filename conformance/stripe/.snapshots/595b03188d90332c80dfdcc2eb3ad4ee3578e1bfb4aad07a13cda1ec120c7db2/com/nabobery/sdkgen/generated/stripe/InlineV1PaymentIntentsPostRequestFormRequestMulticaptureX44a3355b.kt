...
public sealed class InlineV1PaymentIntentsPostRequestFormRequestMulticaptureX44a3355b {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1PaymentIntentsPostRequestFormRequestMulticaptureX44a3355b =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormRequestMulticaptureX44a3355b> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1PaymentIntentsPostRequestFormRequestMulticaptureX44a3355b",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1PaymentIntentsPostRequestFormRequestMulticaptureX44a3355b =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormRequestMulticaptureX44a3355b,
        ) {
