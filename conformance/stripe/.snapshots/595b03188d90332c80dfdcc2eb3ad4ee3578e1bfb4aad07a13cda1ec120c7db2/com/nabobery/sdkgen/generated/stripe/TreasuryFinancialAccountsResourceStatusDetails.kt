...
public class TreasuryFinancialAccountsResourceStatusDetails(
    ...
    public class Builder {
        ...
        public fun build(): TreasuryFinancialAccountsResourceStatusDetails =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): TreasuryFinancialAccountsResourceStatusDetails =
    ...
    public object Serializer : KSerializer<TreasuryFinancialAccountsResourceStatusDetails> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "TreasuryFinancialAccountsResourceStatusDetails must be a JSON object",
                    )
            return TreasuryFinancialAccountsResourceStatusDetails(
                closed =
                    rawObject["closed"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                            ...
                            json
                                .decodeFromJsonElement<InlineTreasuryFinancialAccountsResourceStatusDetailsClosedX5dd8936d?>(
                                    element,
                                )
                        }
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: TreasuryFinancialAccountsResourceStatusDetails,
        ) {
...
public fun treasuryFinancialAccountsResourceStatusDetails(
    block: TreasuryFinancialAccountsResourceStatusDetails.Builder.() -> Unit,
): TreasuryFinancialAccountsResourceStatusDetails = TreasuryFinancialAccountsResourceStatusDetails.build(block)
