...
public sealed class InlineV1CustomersSourcesPostRequestFormMetadataAnyOf2X2fb79299 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1CustomersSourcesPostRequestFormMetadataAnyOf2X2fb79299 =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1CustomersSourcesPostRequestFormMetadataAnyOf2X2fb79299> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1CustomersSourcesPostRequestFormMetadataAnyOf2X2fb79299",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1CustomersSourcesPostRequestFormMetadataAnyOf2X2fb79299 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersSourcesPostRequestFormMetadataAnyOf2X2fb79299,
        ) {
