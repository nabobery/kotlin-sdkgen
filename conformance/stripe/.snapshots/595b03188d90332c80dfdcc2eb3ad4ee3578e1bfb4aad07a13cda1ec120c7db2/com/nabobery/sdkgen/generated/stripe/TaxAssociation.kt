...
public class TaxAssociation(
     ...
     */
    public val taxTransactionAttempts: List<TaxProductResourceTaxAssociationTransactionAttempts>? = null,
) {
    ...
    public object Serializer : KSerializer<TaxAssociation> {
        ...
        override fun deserialize(decoder: Decoder): TaxAssociation {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("TaxAssociation must be a JSON object")
            ...
            return TaxAssociation(
                ...
                taxTransactionAttempts =
                    rawObject["tax_transaction_attempts"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<List<TaxProductResourceTaxAssociationTransactionAttempts>?>(
                                element,
                            )
                        }
                    },
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("TaxAssociation is missing required property '" + name + "'")
