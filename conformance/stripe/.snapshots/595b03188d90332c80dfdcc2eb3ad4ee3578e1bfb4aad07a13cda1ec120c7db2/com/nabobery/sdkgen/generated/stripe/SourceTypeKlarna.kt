...
public class SourceTypeKlarna(
    ...
    public class Builder {
        ...
        public fun build(): SourceTypeKlarna =
            SourceTypeKlarna(
    ...
    public object Serializer : KSerializer<SourceTypeKlarna> {
        ...
        override fun deserialize(decoder: Decoder): SourceTypeKlarna {
            ...
            return SourceTypeKlarna(
                ...
                payLaterAssetUrlsDescriptive =
                    rawObject["pay_later_asset_urls_descriptive"]?.let {
                        json.decodeFromJsonElement<String>(it)
                    },
                payLaterAssetUrlsStandard =
                    rawObject["pay_later_asset_urls_standard"]?.let {
                        json
                ...
                payLaterRedirectUrl =
                    rawObject["pay_later_redirect_url"]?.let {
                        json.decodeFromJsonElement<String>(
                            it,
                        )
                    },
                payNowAssetUrlsDescriptive =
                    rawObject["pay_now_asset_urls_descriptive"]?.let {
                        json.decodeFromJsonElement<String>(it)
                    },
                payNowAssetUrlsStandard =
                    rawObject["pay_now_asset_urls_standard"]?.let {
                        json.decodeFromJsonElement<String>(
                            it,
                        )
                    },
                ...
                payOverTimeAssetUrlsDescriptive =
                    rawObject["pay_over_time_asset_urls_descriptive"]?.let {
                        json.decodeFromJsonElement<String>(it)
                    },
                payOverTimeAssetUrlsStandard =
                    rawObject["pay_over_time_asset_urls_standard"]?.let {
                        json.decodeFromJsonElement<String>(it)
                    },
                payOverTimeName =
                    rawObject["pay_over_time_name"]?.let {
                        json.decodeFromJsonElement<String>(
                            it,
                        )
                    },
                payOverTimeRedirectUrl =
                    rawObject["pay_over_time_redirect_url"]?.let {
                        json.decodeFromJsonElement<String>(
                            it,
                        )
                    },
                paymentMethodCategories =
                    rawObject["payment_method_categories"]?.let {
                        json.decodeFromJsonElement<String>(
                            it,
                        )
                    },
...
public fun sourceTypeKlarna(block: SourceTypeKlarna.Builder.() -> Unit): SourceTypeKlarna =
    SourceTypeKlarna.build(block)
