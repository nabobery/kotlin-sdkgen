...
public class InlineV1ChargesRefundsPostRequestFormMetadataX5c502965 internal constructor(
    ...
    public val inlineV1ChargesRefundsPostRequestFormMetadataAnyOf2X770daa10:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1ChargesRefundsPostRequestFormMetadataAnyOf2X770daa10) {
                json
                    .decodeFromJsonElement<InlineV1ChargesRefundsPostRequestFormMetadataAnyOf2X770daa10>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1ChargesRefundsPostRequestFormMetadataX5c502965Branch>
        get() =
            buildSet {
                ...
                if (inspection.matchesInlineV1ChargesRefundsPostRequestFormMetadataAnyOf2X770daa10) {
                    add(
                        InlineV1ChargesRefundsPostRequestFormMetadataX5c502965Branch.InlineV1ChargesRefundsPostRequestFormMetadataAnyOf2X770daa10,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1ChargesRefundsPostRequestFormMetadataX5c502965 {
            val inspection = inspectInlineV1ChargesRefundsPostRequestFormMetadataX5c502965(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1ChargesRefundsPostRequestFormMetadataX5c502965NoMatchException(
                    "InlineV1ChargesRefundsPostRequestFormMetadataX5c502965 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1ChargesRefundsPostRequestFormMetadataX5c502965> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ChargesRefundsPostRequestFormMetadataX5c502965,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1ChargesRefundsPostRequestFormMetadataX5c502965",
...
private fun inspectInlineV1ChargesRefundsPostRequestFormMetadataX5c502965(
    element: JsonElement,
): InlineV1ChargesRefundsPostRequestFormMetadataX5c502965Inspection {
    val matchesBranch1 = element.isJsonDecodable<JsonObject>()
    val matchesInlineV1ChargesRefundsPostRequestFormMetadataAnyOf2X770daa10 =
        element
            .isJsonDecodable<InlineV1ChargesRefundsPostRequestFormMetadataAnyOf2X770daa10>()
    return InlineV1ChargesRefundsPostRequestFormMetadataX5c502965Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1ChargesRefundsPostRequestFormMetadataAnyOf2X770daa10) {
                    add(
                        "InlineV1ChargesRefundsPostRequestFormMetadataAnyOf2X770daa10: value does not match InlineV1ChargesRefundsPostRequestFormMetadataAnyOf2X770daa10",
                    )
                }
            },
    )
