...
public class InlineCustomerBalanceResou25beRefundX4da2b70c internal constructor(
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineCustomerBalanceResou25beRefundX4da2b70c {
            val inspection = inspectInlineCustomerBalanceResou25beRefundX4da2b70c(raw)
            if (inspection.matchCount == 0) {
                throw InlineCustomerBalanceResou25beRefundX4da2b70cNoMatchException(
                    "InlineCustomerBalanceResou25beRefundX4da2b70c matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineCustomerBalanceResou25beRefundX4da2b70c> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineCustomerBalanceResou25beRefundX4da2b70c,
        ) {
...
private fun inspectInlineCustomerBalanceResou25beRefundX4da2b70c(
    element: JsonElement,
): InlineCustomerBalanceResou25beRefundX4da2b70cInspection {
