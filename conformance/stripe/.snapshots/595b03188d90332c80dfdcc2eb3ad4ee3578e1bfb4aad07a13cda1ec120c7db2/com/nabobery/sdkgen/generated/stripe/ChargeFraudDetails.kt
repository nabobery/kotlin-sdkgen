...
public class ChargeFraudDetails(
    ...
    public class Builder {
        ...
        public fun build(): ChargeFraudDetails =
            ChargeFraudDetails(
    ...
    public object Serializer : KSerializer<ChargeFraudDetails> {
        ...
        override fun deserialize(decoder: Decoder): ChargeFraudDetails {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("ChargeFraudDetails must be a JSON object")
...
public fun chargeFraudDetails(block: ChargeFraudDetails.Builder.() -> Unit): ChargeFraudDetails =
    ChargeFraudDetails.build(block)
