...
public sealed class InlineV1InvoicesCreatePreviewPostRequestFormOnBehalfOfAnyOf2Xa7a31c0f {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1InvoicesCreatePreviewPostRequestFormOnBehalfOfAnyOf2Xa7a31c0f =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1InvoicesCreatePreviewPostRequestFormOnBehalfOfAnyOf2Xa7a31c0f> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1InvoicesCreatePreviewPostRequestFormOnBehalfOfAnyOf2Xa7a31c0f",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1InvoicesCreatePreviewPostRequestFormOnBehalfOfAnyOf2Xa7a31c0f = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesCreatePreviewPostRequestFormOnBehalfOfAnyOf2Xa7a31c0f,
        ) {
