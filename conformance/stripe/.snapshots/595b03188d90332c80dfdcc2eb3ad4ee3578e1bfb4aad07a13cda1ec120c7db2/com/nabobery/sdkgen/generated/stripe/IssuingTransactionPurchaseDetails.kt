...
@Serializable
public data class IssuingTransactionPurchaseDetailsView(
...
public class IssuingTransactionPurchaseDetails(
    ...
    public class Builder {
         ...
         * The line items in the purchase.
         */
        public var receipt: List<IssuingTransactionReceiptData>? = null
        ...
        public fun build(): IssuingTransactionPurchaseDetails =
    ...
    public object Serializer : KSerializer<IssuingTransactionPurchaseDetails> {
        ...
        override fun deserialize(decoder: Decoder): IssuingTransactionPurchaseDetails {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("IssuingTransactionPurchaseDetails must be a JSON object")
                ...
                fleet =
                    rawObject["fleet"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineIssuingTransactionPurchaseDetailsFleetXf3299b90?>(element)
                        }
                    },
                flight =
                    rawObject["flight"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineIssuingTransactionPurchaseDetailsFlightX759b7297?>(element)
                        }
                    },
                fuel =
                    rawObject["fuel"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineIssuingTransactionPurchaseDetailsFuelXd57e2b8b?>(element)
                        }
                    },
                lodging =
                    rawObject["lodging"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineIssuingTransactionPurchaseDetailsLodgingX4e97eca5?>(
                                element,
                            )
                        }
                    },
                receipt =
                    rawObject["receipt"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<List<IssuingTransactionReceiptData>?>(element)
                        }
                    },
                reference =
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: IssuingTransactionPurchaseDetails,
        ) {
...
public fun issuingTransactionPurchaseDetails(
    block: IssuingTransactionPurchaseDetails.Builder.() -> Unit,
): IssuingTransactionPurchaseDetails = IssuingTransactionPurchaseDetails.build(block)
