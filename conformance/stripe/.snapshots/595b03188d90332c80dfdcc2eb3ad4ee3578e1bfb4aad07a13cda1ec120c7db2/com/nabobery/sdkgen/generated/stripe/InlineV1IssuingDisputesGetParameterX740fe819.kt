...
public sealed class InlineV1IssuingDisputesGetParameterX740fe819 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1IssuingDisputesGetParameterX740fe819 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1IssuingDisputesGetParameterX740fe819> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1IssuingDisputesGetParameterX740fe819",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1IssuingDisputesGetParameterX740fe819 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingDisputesGetParameterX740fe819,
        ) {
