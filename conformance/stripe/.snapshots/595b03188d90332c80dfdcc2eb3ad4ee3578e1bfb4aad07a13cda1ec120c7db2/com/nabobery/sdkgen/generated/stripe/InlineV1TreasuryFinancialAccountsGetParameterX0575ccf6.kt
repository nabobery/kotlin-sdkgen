...
public sealed class InlineV1TreasuryFinancialAccountsGetParameterX0575ccf6 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1TreasuryFinancialAccountsGetParameterX0575ccf6 =
            when (value) {
                Closed.value -> Closed
                Open.value -> Open
    ...
    public object Serializer : KSerializer<InlineV1TreasuryFinancialAccountsGetParameterX0575ccf6> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1TreasuryFinancialAccountsGetParameterX0575ccf6",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1TreasuryFinancialAccountsGetParameterX0575ccf6 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TreasuryFinancialAccountsGetParameterX0575ccf6,
        ) {
