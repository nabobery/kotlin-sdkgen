...
public sealed class InlineV1TerminalReadersCol3061PostRequestFormAllowRedisplayX097cdad4 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1TerminalReadersCol3061PostRequestFormAllowRedisplayX097cdad4 =
            when (value) {
                Always.value -> Always
    ...
    public object Serializer : KSerializer<InlineV1TerminalReadersCol3061PostRequestFormAllowRedisplayX097cdad4> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1TerminalReadersCol3061PostRequestFormAllowRedisplayX097cdad4",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1TerminalReadersCol3061PostRequestFormAllowRedisplayX097cdad4 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TerminalReadersCol3061PostRequestFormAllowRedisplayX097cdad4,
        ) {
