...
public sealed class InlineIssuingPhysicalBundleFeaturesCardLogoX39f3dc2e {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineIssuingPhysicalBundleFeaturesCardLogoX39f3dc2e =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineIssuingPhysicalBundleFeaturesCardLogoX39f3dc2e> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineIssuingPhysicalBundleFeaturesCardLogoX39f3dc2e",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineIssuingPhysicalBundleFeaturesCardLogoX39f3dc2e =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineIssuingPhysicalBundleFeaturesCardLogoX39f3dc2e,
        ) {
