...
public class PaymentMethodDetailsAchCreditTransfer(
    ...
    public class Builder {
        ...
        public fun build(): PaymentMethodDetailsAchCreditTransfer =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentMethodDetailsAchCreditTransfer =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentMethodDetailsAchCreditTransfer> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodDetailsAchCreditTransfer {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodDetailsAchCreditTransfer must be a JSON object")
            return PaymentMethodDetailsAchCreditTransfer(
                ...
                swiftCode =
                    rawObject["swift_code"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentMethodDetailsAchCreditTransfer,
        ) {
...
public fun paymentMethodDetailsAchCreditTransfer(
    block: PaymentMethodDetailsAchCreditTransfer.Builder.() -> Unit,
): PaymentMethodDetailsAchCreditTransfer = PaymentMethodDetailsAchCreditTransfer.build(block)
