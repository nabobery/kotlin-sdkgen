...
public class PaymentMethodBoleto(
    ...
    public object Serializer : KSerializer<PaymentMethodBoleto> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodBoleto {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodBoleto must be a JSON object")
...
public fun paymentMethodBoleto(block: PaymentMethodBoleto.Builder.() -> Unit): PaymentMethodBoleto =
    PaymentMethodBoleto.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("PaymentMethodBoleto is missing required property '" + name + "'")
