...
public class InlineV1SubscriptionItemsPostRequestFormPriceDataRecurringXbe93028d(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1SubscriptionItemsPostRequestFormPriceDataRecurringXbe93028d = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionItemsPostRequestFormPriceDataRecurringXbe93028d> {
        ...
        override fun deserialize(
            decoder: Decoder,
        ): InlineV1SubscriptionItemsPostRequestFormPriceDataRecurringXbe93028d {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SubscriptionItemsPostRequestFormPriceDataRecurringXbe93028d must be a JSON object",
                    )
            val interval =
                json.decodeRequired<InlineV1SubscriptionItemsPostRequestFormPriceDataRecurringIntervalX082704a8>(
                    rawObject,
                    "interval",
                )
            return InlineV1SubscriptionItemsPostRequestFormPriceDataRecurringXbe93028d(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionItemsPostRequestFormPriceDataRecurringXbe93028d,
        ) {
            val jsonEncoder =
...
public fun inlineV1SubscriptionItemsPostRequestFormPriceDataRecurringXbe93028d(
    block: InlineV1SubscriptionItemsPostRequestFormPriceDataRecurringXbe93028d.Builder.() -> Unit,
): InlineV1SubscriptionItemsPostRequestFormPriceDataRecurringXbe93028d =
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1SubscriptionItemsPostRequestFormPriceDataRecurringXbe93028d is missing required property '" +
                    name +
                    "'",
            )
