...
public sealed class InlineV1PaymentMethodsPostRequestFormAllowRedisplayXb1e5a64d {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1PaymentMethodsPostRequestFormAllowRedisplayXb1e5a64d =
            when (value) {
                Always.value -> Always
    ...
    public object Serializer : KSerializer<InlineV1PaymentMethodsPostRequestFormAllowRedisplayXb1e5a64d> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1PaymentMethodsPostRequestFormAllowRedisplayXb1e5a64d",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1PaymentMethodsPostRequestFormAllowRedisplayXb1e5a64d =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentMethodsPostRequestFormAllowRedisplayXb1e5a64d,
        ) {
