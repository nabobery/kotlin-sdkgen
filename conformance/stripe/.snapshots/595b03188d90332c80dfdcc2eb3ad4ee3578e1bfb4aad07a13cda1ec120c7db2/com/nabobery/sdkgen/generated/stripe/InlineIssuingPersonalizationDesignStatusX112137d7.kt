...
public sealed class InlineIssuingPersonalizationDesignStatusX112137d7 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineIssuingPersonalizationDesignStatusX112137d7 =
            when (value) {
                Active.value -> Active
    ...
    public object Serializer : KSerializer<InlineIssuingPersonalizationDesignStatusX112137d7> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineIssuingPersonalizationDesignStatusX112137d7",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineIssuingPersonalizationDesignStatusX112137d7 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineIssuingPersonalizationDesignStatusX112137d7,
        ) {
