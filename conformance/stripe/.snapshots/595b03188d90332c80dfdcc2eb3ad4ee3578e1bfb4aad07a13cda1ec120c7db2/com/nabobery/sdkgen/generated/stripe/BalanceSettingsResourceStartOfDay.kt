...
public class BalanceSettingsResourceStartOfDay(
    ...
    public object Serializer : KSerializer<BalanceSettingsResourceStartOfDay> {
        ...
        override fun deserialize(decoder: Decoder): BalanceSettingsResourceStartOfDay {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("BalanceSettingsResourceStartOfDay must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: BalanceSettingsResourceStartOfDay,
        ) {
...
public fun balanceSettingsResourceStartOfDay(
    block: BalanceSettingsResourceStartOfDay.Builder.() -> Unit,
): BalanceSettingsResourceStartOfDay = BalanceSettingsResourceStartOfDay.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "BalanceSettingsResourceStartOfDay is missing required property '" + name + "'",
            )
