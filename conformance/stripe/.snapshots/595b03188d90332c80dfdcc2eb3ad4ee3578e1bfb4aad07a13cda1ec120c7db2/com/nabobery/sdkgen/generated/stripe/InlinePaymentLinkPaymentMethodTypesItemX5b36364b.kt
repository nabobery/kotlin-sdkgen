...
public sealed class InlinePaymentLinkPaymentMethodTypesItemX5b36364b {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentLinkPaymentMethodTypesItemX5b36364b =
            when (value) {
                Affirm.value -> Affirm
    ...
    public object Serializer : KSerializer<InlinePaymentLinkPaymentMethodTypesItemX5b36364b> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentLinkPaymentMethodTypesItemX5b36364b",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePaymentLinkPaymentMethodTypesItemX5b36364b =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentLinkPaymentMethodTypesItemX5b36364b,
        ) {
