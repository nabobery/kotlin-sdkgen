...
public data class BillingCreditGrantsResourceBalanceCreditView(
    ...
    public val creditsApplicationInvoiceVoided: InlineBillingCreditGrantsR5d5dCreditsApplicationIn9a4aX1a3dcb22? = null,
...
public class BillingCreditGrantsResourceBalanceCredit(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): BillingCreditGrantsResourceBalanceCredit =
    ...
    public object Serializer : KSerializer<BillingCreditGrantsResourceBalanceCredit> {
        ...
        override fun deserialize(decoder: Decoder): BillingCreditGrantsResourceBalanceCredit {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("BillingCreditGrantsResourceBalanceCredit must be a JSON object")
            val amount = json.decodeRequired<BillingCreditGrantsResourceAmount>(rawObject, "amount")
            val type =
                json.decodeRequired<InlineBillingCreditGrantsResourceBalanceCreditTypeX5ab06d44>(
                    rawObject,
                    "type",
                )
            return BillingCreditGrantsResourceBalanceCredit(
                ...
                creditsApplicationInvoiceVoided =
                    rawObject["credits_application_invoice_voided"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                            ...
                            json
                                .decodeFromJsonElement<InlineBillingCreditGrantsR5d5dCreditsApplicationIn9a4aX1a3dcb22?>(
                                    element,
                                )
                        }
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: BillingCreditGrantsResourceBalanceCredit,
        ) {
            ...
            val raw =
                buildJsonObject {
                    ...
                    value.creditsApplicationInvoiceVoided?.let {
                        put(
                            "credits_application_invoice_voided",
...
public fun billingCreditGrantsResourceBalanceCredit(
    block: BillingCreditGrantsResourceBalanceCredit.Builder.() -> Unit,
): BillingCreditGrantsResourceBalanceCredit = BillingCreditGrantsResourceBalanceCredit.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "BillingCreditGrantsResourceBalanceCredit is missing required property '" + name + "'",
            )
