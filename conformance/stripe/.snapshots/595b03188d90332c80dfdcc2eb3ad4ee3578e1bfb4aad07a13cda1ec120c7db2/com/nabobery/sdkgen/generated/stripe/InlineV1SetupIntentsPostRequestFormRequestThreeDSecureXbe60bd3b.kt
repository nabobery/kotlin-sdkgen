...
public sealed class InlineV1SetupIntentsPostRequestFormRequestThreeDSecureXbe60bd3b {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1SetupIntentsPostRequestFormRequestThreeDSecureXbe60bd3b =
            when (value) {
                Any.value -> Any
    ...
    public object Serializer : KSerializer<InlineV1SetupIntentsPostRequestFormRequestThreeDSecureXbe60bd3b> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1SetupIntentsPostRequestFormRequestThreeDSecureXbe60bd3b",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1SetupIntentsPostRequestFormRequestThreeDSecureXbe60bd3b =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SetupIntentsPostRequestFormRequestThreeDSecureXbe60bd3b,
        ) {
