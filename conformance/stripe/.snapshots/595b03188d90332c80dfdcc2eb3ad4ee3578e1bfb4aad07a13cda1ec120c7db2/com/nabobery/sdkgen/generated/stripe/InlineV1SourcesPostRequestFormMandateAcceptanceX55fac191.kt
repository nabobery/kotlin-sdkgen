...
public class InlineV1SourcesPostRequestFormMandateAcceptanceX55fac191(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1SourcesPostRequestFormMandateAcceptanceX55fac191 =
    ...
    public object Serializer : KSerializer<InlineV1SourcesPostRequestFormMandateAcceptanceX55fac191> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SourcesPostRequestFormMandateAcceptanceX55fac191 must be a JSON object",
                    )
            val status =
                json.decodeRequired<InlineV1SourcesPostRequestFormMandateAcceptanceStatusX915cd527>(
                    rawObject,
                    "status",
                )
            return InlineV1SourcesPostRequestFormMandateAcceptanceX55fac191(
                ...
                offline =
                    rawObject["offline"]?.let {
                        json.decodeFromJsonElement<InlineV1SourcesPostRequestFormMandateAcceptanceOfflineX42651fa1>(it)
                    },
                online =
                    rawObject["online"]?.let {
                        json.decodeFromJsonElement<InlineV1SourcesPostRequestFormMandateAcceptanceOnlineXec4393f4>(it)
                    },
                type =
                    rawObject["type"]?.let {
                        json.decodeFromJsonElement<InlineV1SourcesPostRequestFormMandateAcceptanceTypeXed46ca87>(it)
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SourcesPostRequestFormMandateAcceptanceX55fac191,
        ) {
...
public fun inlineV1SourcesPostRequestFormMandateAcceptanceX55fac191(
    block: InlineV1SourcesPostRequestFormMandateAcceptanceX55fac191.Builder.() -> Unit,
): InlineV1SourcesPostRequestFormMandateAcceptanceX55fac191 =
    InlineV1SourcesPostRequestFormMandateAcceptanceX55fac191.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1SourcesPostRequestFormMandateAcceptanceX55fac191 is missing required property '" + name + "'",
            )
