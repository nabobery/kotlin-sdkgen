...
public class RadarReviewResourceSession(
    ...
    public class Builder {
        ...
        public fun build(): RadarReviewResourceSession =
    ...
    public object Serializer : KSerializer<RadarReviewResourceSession> {
        ...
        override fun deserialize(decoder: Decoder): RadarReviewResourceSession {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("RadarReviewResourceSession must be a JSON object")
            return RadarReviewResourceSession(
                browser =
                    rawObject["browser"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                platform =
                    rawObject["platform"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: RadarReviewResourceSession,
        ) {
...
public fun radarReviewResourceSession(
    block: RadarReviewResourceSession.Builder.() -> Unit,
): RadarReviewResourceSession = RadarReviewResourceSession.build(block)
