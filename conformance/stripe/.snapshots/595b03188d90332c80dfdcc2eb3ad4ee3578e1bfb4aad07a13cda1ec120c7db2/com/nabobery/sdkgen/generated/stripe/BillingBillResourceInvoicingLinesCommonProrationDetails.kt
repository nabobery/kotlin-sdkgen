...
public class BillingBillResourceInvoicingLinesCommonProrationDetails(
    ...
    public class Builder {
        ...
        public fun build(): BillingBillResourceInvoicingLinesCommonProrationDetails =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): BillingBillResourceInvoicingLinesCommonProrationDetails =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<BillingBillResourceInvoicingLinesCommonProrationDetails> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "BillingBillResourceInvoicingLinesCommonProrationDetails must be a JSON object",
                    )
            return BillingBillResourceInvoicingLinesCommonProrationDetails(
                creditedItems =
                    rawObject["credited_items"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineBillingBillResourceI2ab7CreditedItemsX25e33ab9?>(element)
                        }
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: BillingBillResourceInvoicingLinesCommonProrationDetails,
        ) {
...
public fun billingBillResourceInvoicingLinesCommonProrationDetails(
    block: BillingBillResourceInvoicingLinesCommonProrationDetails.Builder.() -> Unit,
): BillingBillResourceInvoicingLinesCommonProrationDetails =
    BillingBillResourceInvoicingLinesCommonProrationDetails.build(block)
