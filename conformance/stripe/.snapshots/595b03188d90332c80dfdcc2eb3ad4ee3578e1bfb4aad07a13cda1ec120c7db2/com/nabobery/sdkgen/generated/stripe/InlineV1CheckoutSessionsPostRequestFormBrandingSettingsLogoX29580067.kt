...
public class InlineV1CheckoutSessionsPostRequestFormBrandingSettingsLogoX29580067(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1CheckoutSessionsPostRequestFormBrandingSettingsLogoX29580067 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormBrandingSettingsLogoX29580067> {
        override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1CheckoutSessionsPostRequestFormBrandingSettingsLogoX29580067 {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CheckoutSessionsPostRequestFormBrandingSettingsLogoX29580067 must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineV1CheckoutSessionsPostRequestFormBrandingSettingsLogoTypeXc22dceef>(
                    rawObject,
                    "type",
                )
            return InlineV1CheckoutSessionsPostRequestFormBrandingSettingsLogoX29580067(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsPostRequestFormBrandingSettingsLogoX29580067,
        ) {
            val jsonEncoder =
...
public fun inlineV1CheckoutSessionsPostRequestFormBrandingSettingsLogoX29580067(
    block: InlineV1CheckoutSessionsPostRequestFormBrandingSettingsLogoX29580067.Builder.() -> Unit,
): InlineV1CheckoutSessionsPostRequestFormBrandingSettingsLogoX29580067 =
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1CheckoutSessionsPostRequestFormBrandingSettingsLogoX29580067 is missing required property '" +
                    name +
                    "'",
            )
