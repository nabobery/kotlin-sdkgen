...
public sealed class InlineV1CreditNotesPreviewGetParameterItemTypeX6d20630b {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1CreditNotesPreviewGetParameterItemTypeX6d20630b =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1CreditNotesPreviewGetParameterItemTypeX6d20630b> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1CreditNotesPreviewGetParameterItemTypeX6d20630b",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1CreditNotesPreviewGetParameterItemTypeX6d20630b =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CreditNotesPreviewGetParameterItemTypeX6d20630b,
        ) {
