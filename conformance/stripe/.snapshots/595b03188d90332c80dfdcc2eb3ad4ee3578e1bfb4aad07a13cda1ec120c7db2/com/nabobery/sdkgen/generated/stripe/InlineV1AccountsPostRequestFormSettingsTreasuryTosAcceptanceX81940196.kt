...
public class InlineV1AccountsPostRequestFormSettingsTreasuryTosAcceptanceX81940196(
    ...
    public val userAgent: InlineV1AccountsPostRequestFormSettingsTreasuryTosAcceptanceUserAgentXed5c6b70? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1AccountsPostRequestFormSettingsTreasuryTosAcceptanceX81940196 =
            InlineV1AccountsPostRequestFormSettingsTreasuryTosAcceptanceX81940196(
                date = date,
                ip = ip,
                userAgent = userAgent,
            )
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1AccountsPostRequestFormSettingsTreasuryTosAcceptanceX81940196 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1AccountsPostRequestFormSettingsTreasuryTosAcceptanceX81940196> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountsPostRequestFormSettingsTreasuryTosAcceptanceX81940196 must be a JSON object",
                    )
            return InlineV1AccountsPostRequestFormSettingsTreasuryTosAcceptanceX81940196(
                ...
                userAgent =
                    rawObject["user_agent"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1AccountsPostRequestFormSettingsTreasuryTosAcceptanceUserAgentXed5c6b70>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPostRequestFormSettingsTreasuryTosAcceptanceX81940196,
        ) {
            val jsonEncoder =
...
public fun inlineV1AccountsPostRequestFormSettingsTreasuryTosAcceptanceX81940196(
    block: InlineV1AccountsPostRequestFormSettingsTreasuryTosAcceptanceX81940196.Builder.() -> Unit,
): InlineV1AccountsPostRequestFormSettingsTreasuryTosAcceptanceX81940196 =
    InlineV1AccountsPostRequestFormSettingsTreasuryTosAcceptanceX81940196.build(block)
