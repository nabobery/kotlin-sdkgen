...
public class InlineV1AccountsPersonsPostRequestFormUsCfpbDataEthnicityDetailsX4b87237a(
    public val ethnicity: List<InlineV1AccountsPersonsPostRequestFormUsCfpbDataEthnicityDetailsItemXd2ab04ab>? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1AccountsPersonsPostRequestFormUsCfpbDataEthnicityDetailsX4b87237a =
            InlineV1AccountsPersonsPostRequestFormUsCfpbDataEthnicityDetailsX4b87237a(
                ethnicity = ethnicity,
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1AccountsPersonsPostRequestFormUsCfpbDataEthnicityDetailsX4b87237a = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1AccountsPersonsPostRequestFormUsCfpbDataEthnicityDetailsX4b87237a> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountsPersonsPostRequestFormUsCfpbDataEthnicityDetailsX4b87237a must be a JSON object",
                    )
            return InlineV1AccountsPersonsPostRequestFormUsCfpbDataEthnicityDetailsX4b87237a(
                ethnicity =
                    rawObject["ethnicity"]?.let {
                        json
                            .decodeFromJsonElement<List<InlineV1AccountsPersonsPostRequestFormUsCfpbDataEthnicityDetailsItemXd2ab04ab>>(
                                it,
                            )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPersonsPostRequestFormUsCfpbDataEthnicityDetailsX4b87237a,
        ) {
            val jsonEncoder =
...
public fun inlineV1AccountsPersonsPostRequestFormUsCfpbDataEthnicityDetailsX4b87237a(
    block: InlineV1AccountsPersonsPostRequestFormUsCfpbDataEthnicityDetailsX4b87237a.Builder.() -> Unit,
): InlineV1AccountsPersonsPostRequestFormUsCfpbDataEthnicityDetailsX4b87237a =
    InlineV1AccountsPersonsPostRequestFormUsCfpbDataEthnicityDetailsX4b87237a.build(block)
