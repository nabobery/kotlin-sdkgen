...
public class InlineV1TaxCalculationsPostRequestFormLineItemsItemXb2c24cce(
    ...
    public val taxBehavior: InlineV1TaxCalculationsPostRequestFormLineItemsItemTaxBehaviorXdb098a44? = null,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TaxCalculationsPostRequestFormLineItemsItemXb2c24cce =
    ...
    public object Serializer : KSerializer<InlineV1TaxCalculationsPostRequestFormLineItemsItemXb2c24cce> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TaxCalculationsPostRequestFormLineItemsItemXb2c24cce must be a JSON object",
                    )
            ...
            return InlineV1TaxCalculationsPostRequestFormLineItemsItemXb2c24cce(
                ...
                taxBehavior =
                    rawObject["tax_behavior"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TaxCalculationsPostRequestFormLineItemsItemTaxBehaviorXdb098a44>(
                                it,
                            )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TaxCalculationsPostRequestFormLineItemsItemXb2c24cce,
        ) {
...
public fun inlineV1TaxCalculationsPostRequestFormLineItemsItemXb2c24cce(
    block: InlineV1TaxCalculationsPostRequestFormLineItemsItemXb2c24cce.Builder.() -> Unit,
): InlineV1TaxCalculationsPostRequestFormLineItemsItemXb2c24cce =
    InlineV1TaxCalculationsPostRequestFormLineItemsItemXb2c24cce.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TaxCalculationsPostRequestFormLineItemsItemXb2c24cce is missing required property '" + name +
                    "'",
            )
