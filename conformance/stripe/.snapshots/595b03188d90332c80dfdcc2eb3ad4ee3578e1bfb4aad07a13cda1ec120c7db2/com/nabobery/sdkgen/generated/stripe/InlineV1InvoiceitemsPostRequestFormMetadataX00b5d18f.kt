...
public class InlineV1InvoiceitemsPostRequestFormMetadataX00b5d18f internal constructor(
    ...
    public val inlineV1InvoiceitemsPostRequestFormMetadataAnyOf2X28e7aec6:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1InvoiceitemsPostRequestFormMetadataAnyOf2X28e7aec6) {
                json
                    .decodeFromJsonElement<InlineV1InvoiceitemsPostRequestFormMetadataAnyOf2X28e7aec6>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1InvoiceitemsPostRequestFormMetadataX00b5d18fBranch>
        get() =
            buildSet {
                ...
                if (inspection.matchesInlineV1InvoiceitemsPostRequestFormMetadataAnyOf2X28e7aec6) {
                    add(
                        InlineV1InvoiceitemsPostRequestFormMetadataX00b5d18fBranch.InlineV1InvoiceitemsPostRequestFormMetadataAnyOf2X28e7aec6,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1InvoiceitemsPostRequestFormMetadataX00b5d18f {
            val inspection = inspectInlineV1InvoiceitemsPostRequestFormMetadataX00b5d18f(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1InvoiceitemsPostRequestFormMetadataX00b5d18fNoMatchException(
                    "InlineV1InvoiceitemsPostRequestFormMetadataX00b5d18f matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1InvoiceitemsPostRequestFormMetadataX00b5d18f> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoiceitemsPostRequestFormMetadataX00b5d18f,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1InvoiceitemsPostRequestFormMetadataX00b5d18f",
...
private fun inspectInlineV1InvoiceitemsPostRequestFormMetadataX00b5d18f(
    element: JsonElement,
): InlineV1InvoiceitemsPostRequestFormMetadataX00b5d18fInspection {
    val matchesBranch1 = element.isJsonDecodable<JsonObject>()
    val matchesInlineV1InvoiceitemsPostRequestFormMetadataAnyOf2X28e7aec6 =
        element
            .isJsonDecodable<InlineV1InvoiceitemsPostRequestFormMetadataAnyOf2X28e7aec6>()
    return InlineV1InvoiceitemsPostRequestFormMetadataX00b5d18fInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1InvoiceitemsPostRequestFormMetadataAnyOf2X28e7aec6) {
                    add(
                        "InlineV1InvoiceitemsPostRequestFormMetadataAnyOf2X28e7aec6: value does not match InlineV1InvoiceitemsPostRequestFormMetadataAnyOf2X28e7aec6",
                    )
                }
            },
    )
