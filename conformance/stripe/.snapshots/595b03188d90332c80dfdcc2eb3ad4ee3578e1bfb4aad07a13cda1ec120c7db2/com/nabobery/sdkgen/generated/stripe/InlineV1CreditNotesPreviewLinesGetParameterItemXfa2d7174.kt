...
public class InlineV1CreditNotesPreviewLinesGetParameterItemXfa2d7174(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1CreditNotesPreviewLinesGetParameterItemXfa2d7174 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1CreditNotesPreviewLinesGetParameterItemXfa2d7174> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CreditNotesPreviewLinesGetParameterItemXfa2d7174 must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineV1CreditNotesPreviewLinesGetParameterItemTypeX0a0bcf3c>(
                    rawObject,
                    "type",
                )
            return InlineV1CreditNotesPreviewLinesGetParameterItemXfa2d7174(
                ...
                taxAmounts =
                    rawObject["tax_amounts"]?.let {
                        json.decodeFromJsonElement<InlineV1CreditNotesPreviewLinesGetParameterItemTaxAmountsX472a93fc>(
                            it,
                        )
                    },
                taxRates =
                    rawObject["tax_rates"]?.let {
                        json.decodeFromJsonElement<InlineV1CreditNotesPreviewLinesGetParameterItemTaxRatesX5c880810>(it)
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CreditNotesPreviewLinesGetParameterItemXfa2d7174,
        ) {
...
public fun inlineV1CreditNotesPreviewLinesGetParameterItemXfa2d7174(
    block: InlineV1CreditNotesPreviewLinesGetParameterItemXfa2d7174.Builder.() -> Unit,
): InlineV1CreditNotesPreviewLinesGetParameterItemXfa2d7174 =
    InlineV1CreditNotesPreviewLinesGetParameterItemXfa2d7174.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1CreditNotesPreviewLinesGetParameterItemXfa2d7174 is missing required property '" + name + "'",
            )
