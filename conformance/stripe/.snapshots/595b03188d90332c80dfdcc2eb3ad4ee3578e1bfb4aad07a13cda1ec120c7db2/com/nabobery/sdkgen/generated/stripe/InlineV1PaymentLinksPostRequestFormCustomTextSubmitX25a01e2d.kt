...
internal data class InlineV1PaymentLinksPostRequestFormCustomTextSubmitX25a01e2dInspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesInlineV1PaymentLinksPostRequestFormCustomTextSubmitAnyOf1Xe8dc1b0f,
                matchesInlineV1PaymentLinksPostRequestFormCustomTextSubmitAnyOf2X89717e7a,
            ).count {
                it
            }
}
...
public class InlineV1PaymentLinksPostRequestFormCustomTextSubmitX25a01e2d internal constructor(
    ...
    public val inlineV1PaymentLinksPostRequestFormCustomTextSubmitAnyOf1Xe8dc1b0f:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1PaymentLinksPostRequestFormCustomTextSubmitAnyOf1Xe8dc1b0f) {
                json
                    .decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormCustomTextSubmitAnyOf1Xe8dc1b0f>(
                        raw,
                    )
            } else {
                null
    ...
    public val inlineV1PaymentLinksPostRequestFormCustomTextSubmitAnyOf2X89717e7a:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1PaymentLinksPostRequestFormCustomTextSubmitAnyOf2X89717e7a) {
                json
                    .decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormCustomTextSubmitAnyOf2X89717e7a>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches:
        ...
        get() =
            buildSet {
                if (inspection.matchesInlineV1PaymentLinksPostRequestFormCustomTextSubmitAnyOf1Xe8dc1b0f) {
                    add(
                        InlineV1PaymentLinksPostRequestFormCustomTextSubmitX25a01e2dBranch.InlineV1PaymentLinksPostRequestFormCustomTextSubmitAnyOf1Xe8dc1b0f,
                    )
                }
                if (inspection.matchesInlineV1PaymentLinksPostRequestFormCustomTextSubmitAnyOf2X89717e7a) {
                    add(
                        InlineV1PaymentLinksPostRequestFormCustomTextSubmitX25a01e2dBranch.InlineV1PaymentLinksPostRequestFormCustomTextSubmitAnyOf2X89717e7a,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1PaymentLinksPostRequestFormCustomTextSubmitX25a01e2d {
            val inspection = inspectInlineV1PaymentLinksPostRequestFormCustomTextSubmitX25a01e2d(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1PaymentLinksPostRequestFormCustomTextSubmitX25a01e2dNoMatchException(
                    "InlineV1PaymentLinksPostRequestFormCustomTextSubmitX25a01e2d matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1PaymentLinksPostRequestFormCustomTextSubmitX25a01e2d> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentLinksPostRequestFormCustomTextSubmitX25a01e2d,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1PaymentLinksPostRequestFormCustomTextSubmitX25a01e2d",
...
private fun inspectInlineV1PaymentLinksPostRequestFormCustomTextSubmitX25a01e2d(
    element: JsonElement,
): InlineV1PaymentLinksPostRequestFormCustomTextSubmitX25a01e2dInspection {
    val matchesInlineV1PaymentLinksPostRequestFormCustomTextSubmitAnyOf1Xe8dc1b0f =
        element
            .isJsonDecodable<InlineV1PaymentLinksPostRequestFormCustomTextSubmitAnyOf1Xe8dc1b0f>()
    val matchesInlineV1PaymentLinksPostRequestFormCustomTextSubmitAnyOf2X89717e7a =
        element
            .isJsonDecodable<InlineV1PaymentLinksPostRequestFormCustomTextSubmitAnyOf2X89717e7a>()
    return InlineV1PaymentLinksPostRequestFormCustomTextSubmitX25a01e2dInspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1PaymentLinksPostRequestFormCustomTextSubmitAnyOf1Xe8dc1b0f) {
                    add(
                        "InlineV1PaymentLinksPostRequestFormCustomTextSubmitAnyOf1Xe8dc1b0f: value does not match InlineV1PaymentLinksPostRequestFormCustomTextSubmitAnyOf1Xe8dc1b0f",
                    )
                }
                if (!matchesInlineV1PaymentLinksPostRequestFormCustomTextSubmitAnyOf2X89717e7a) {
                    add(
                        "InlineV1PaymentLinksPostRequestFormCustomTextSubmitAnyOf2X89717e7a: value does not match InlineV1PaymentLinksPostRequestFormCustomTextSubmitAnyOf2X89717e7a",
                    )
                }
            },
    )
