...
public sealed class InlinePaymentIntentPaymentMethodOptionsMobilepayCaptureMethodX6a16f03c {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentIntentPaymentMethodOptionsMobilepayCaptureMethodX6a16f03c =
            when (value) {
                Manual.value -> Manual
    ...
    public object Serializer : KSerializer<InlinePaymentIntentPaymentMethodOptionsMobilepayCaptureMethodX6a16f03c> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentIntentPaymentMethodOptionsMobilepayCaptureMethodX6a16f03c",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlinePaymentIntentPaymentMethodOptionsMobilepayCaptureMethodX6a16f03c = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentIntentPaymentMethodOptionsMobilepayCaptureMethodX6a16f03c,
        ) {
