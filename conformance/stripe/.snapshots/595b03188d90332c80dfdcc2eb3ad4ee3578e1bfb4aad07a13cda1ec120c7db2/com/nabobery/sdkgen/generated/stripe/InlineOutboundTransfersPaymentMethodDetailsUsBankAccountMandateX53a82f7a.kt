...
public class InlineOutboundTransfersPaymentMethodDetailsUsBankAccountMandateX53a82f7a internal constructor(
    ...
    private val inspection: InlineOutboundTransfersPaymentMethodDetailsUsBankAccountMandateX53a82f7aInspection,
) {
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineOutboundTransfersPaymentMethodDetailsUsBankAccountMandateX53a82f7aBranch.Branch1,
                    )
                }
                if (inspection.matchesMandate) {
                    add(
                        InlineOutboundTransfersPaymentMethodDetailsUsBankAccountMandateX53a82f7aBranch.Mandate,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineOutboundTransfersPaymentMethodDetailsUsBankAccountMandateX53a82f7a {
            val inspection = inspectInlineOutboundTransfersPaymentMethodDetailsUsBankAccountMandateX53a82f7a(raw)
            if (inspection.matchCount == 0) {
                throw InlineOutboundTransfersPaymentMethodDetailsUsBankAccountMandateX53a82f7aNoMatchException(
                    "InlineOutboundTransfersPaymentMethodDetailsUsBankAccountMandateX53a82f7a matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineOutboundTransfersPaymentMethodDetailsUsBankAccountMandateX53a82f7a> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineOutboundTransfersPaymentMethodDetailsUsBankAccountMandateX53a82f7a,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineOutboundTransfersPaymentMethodDetailsUsBankAccountMandateX53a82f7a",
...
private fun inspectInlineOutboundTransfersPaymentMethodDetailsUsBankAccountMandateX53a82f7a(
    element: JsonElement,
