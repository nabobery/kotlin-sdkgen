...
public class PaymentIntentNextActionAlipayHandleRedirect(
    ...
    public class Builder {
        ...
        public fun build(): PaymentIntentNextActionAlipayHandleRedirect =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentIntentNextActionAlipayHandleRedirect =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentIntentNextActionAlipayHandleRedirect> {
        ...
        override fun deserialize(decoder: Decoder): PaymentIntentNextActionAlipayHandleRedirect {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentIntentNextActionAlipayHandleRedirect must be a JSON object")
            return PaymentIntentNextActionAlipayHandleRedirect(
                nativeData =
                    rawObject["native_data"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                nativeUrl =
                    rawObject["native_url"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentIntentNextActionAlipayHandleRedirect,
        ) {
...
public fun paymentIntentNextActionAlipayHandleRedirect(
    block: PaymentIntentNextActionAlipayHandleRedirect.Builder.() -> Unit,
): PaymentIntentNextActionAlipayHandleRedirect = PaymentIntentNextActionAlipayHandleRedirect.build(block)
