...
public class InlineV1AccountsPeoplePostRequestFormDocumentsX4c87b407(
    public val companyAuthorization: InlineV1AccountsPeoplePostRequestFormDocumentsCompanyAuthorizationX5c920d3e? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1AccountsPeoplePostRequestFormDocumentsX4c87b407 =
            InlineV1AccountsPeoplePostRequestFormDocumentsX4c87b407(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1AccountsPeoplePostRequestFormDocumentsX4c87b407 =
    ...
    public object Serializer : KSerializer<InlineV1AccountsPeoplePostRequestFormDocumentsX4c87b407> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountsPeoplePostRequestFormDocumentsX4c87b407 must be a JSON object",
                    )
            return InlineV1AccountsPeoplePostRequestFormDocumentsX4c87b407(
                companyAuthorization =
                    rawObject["company_authorization"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1AccountsPeoplePostRequestFormDocumentsCompanyAuthorizationX5c920d3e>(
                                it,
                            )
                    },
                passport =
                    rawObject["passport"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPeoplePostRequestFormDocumentsPassportX2ea63e2d>(it)
                    },
                visa =
                    rawObject["visa"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPeoplePostRequestFormDocumentsVisaX84d9b912>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPeoplePostRequestFormDocumentsX4c87b407,
        ) {
...
public fun inlineV1AccountsPeoplePostRequestFormDocumentsX4c87b407(
    block: InlineV1AccountsPeoplePostRequestFormDocumentsX4c87b407.Builder.() -> Unit,
): InlineV1AccountsPeoplePostRequestFormDocumentsX4c87b407 =
    InlineV1AccountsPeoplePostRequestFormDocumentsX4c87b407.build(block)
