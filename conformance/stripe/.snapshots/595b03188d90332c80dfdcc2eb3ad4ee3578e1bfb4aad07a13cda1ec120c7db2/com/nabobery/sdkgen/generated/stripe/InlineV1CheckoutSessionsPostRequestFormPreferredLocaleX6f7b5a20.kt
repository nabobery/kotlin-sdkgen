...
public sealed class InlineV1CheckoutSessionsPostRequestFormPreferredLocaleX6f7b5a20 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1CheckoutSessionsPostRequestFormPreferredLocaleX6f7b5a20 =
            when (value) {
                CsCz.value -> CsCz
                DaDk.value -> DaDk
                DeAt.value -> DeAt
    ...
    public object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormPreferredLocaleX6f7b5a20> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1CheckoutSessionsPostRequestFormPreferredLocaleX6f7b5a20",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1CheckoutSessionsPostRequestFormPreferredLocaleX6f7b5a20 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsPostRequestFormPreferredLocaleX6f7b5a20,
        ) {
