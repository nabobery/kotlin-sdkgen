...
public class InvoiceThresholdReason(
    ...
    public class Builder {
        ...
        public var itemReasons: List<InvoiceItemThresholdReason>
            get() = requireNotNull(itemReasonsValue) { "itemReasons is required" }
            set(`value`) {
                itemReasonsValue = value
            }
    ...
    public object Serializer : KSerializer<InvoiceThresholdReason> {
        ...
        override fun deserialize(decoder: Decoder): InvoiceThresholdReason {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("InvoiceThresholdReason must be a JSON object")
...
public fun invoiceThresholdReason(block: InvoiceThresholdReason.Builder.() -> Unit): InvoiceThresholdReason =
    InvoiceThresholdReason.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("InvoiceThresholdReason is missing required property '" + name + "'")
