...
public class TreasuryReceivedDebitsResourceLinkedFlows(
    ...
    public class Builder {
        ...
        public fun build(): TreasuryReceivedDebitsResourceLinkedFlows =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): TreasuryReceivedDebitsResourceLinkedFlows =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<TreasuryReceivedDebitsResourceLinkedFlows> {
        ...
        override fun deserialize(decoder: Decoder): TreasuryReceivedDebitsResourceLinkedFlows {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("TreasuryReceivedDebitsResourceLinkedFlows must be a JSON object")
            return TreasuryReceivedDebitsResourceLinkedFlows(
                ...
                inboundTransfer =
                    rawObject["inbound_transfer"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: TreasuryReceivedDebitsResourceLinkedFlows,
        ) {
...
public fun treasuryReceivedDebitsResourceLinkedFlows(
    block: TreasuryReceivedDebitsResourceLinkedFlows.Builder.() -> Unit,
): TreasuryReceivedDebitsResourceLinkedFlows = TreasuryReceivedDebitsResourceLinkedFlows.build(block)
