...
public sealed class InlineFundingInstructionsBankTransferFinancialAddressTypeX08176dec {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineFundingInstructionsBankTransferFinancialAddressTypeX08176dec =
            when (value) {
                Aba.value -> Aba
                Iban.value -> Iban
    ...
    public object Serializer : KSerializer<InlineFundingInstructionsBankTransferFinancialAddressTypeX08176dec> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineFundingInstructionsBankTransferFinancialAddressTypeX08176dec",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineFundingInstructionsBankTransferFinancialAddressTypeX08176dec =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineFundingInstructionsBankTransferFinancialAddressTypeX08176dec,
        ) {
