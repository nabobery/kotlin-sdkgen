...
public sealed class InlineV1InvoicesLinesPostRequestFormDiscountsAnyOf2X713103e5 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1InvoicesLinesPostRequestFormDiscountsAnyOf2X713103e5 =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1InvoicesLinesPostRequestFormDiscountsAnyOf2X713103e5> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1InvoicesLinesPostRequestFormDiscountsAnyOf2X713103e5",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1InvoicesLinesPostRequestFormDiscountsAnyOf2X713103e5 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesLinesPostRequestFormDiscountsAnyOf2X713103e5,
        ) {
