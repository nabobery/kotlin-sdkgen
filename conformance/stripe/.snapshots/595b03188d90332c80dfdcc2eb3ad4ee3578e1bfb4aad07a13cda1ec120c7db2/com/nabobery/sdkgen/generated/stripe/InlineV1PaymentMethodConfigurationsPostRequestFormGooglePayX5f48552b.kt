...
public class InlineV1PaymentMethodConfigurationsPostRequestFormGooglePayX5f48552b(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1PaymentMethodConfigurationsPostRequestFormGooglePayX5f48552b =
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentMethodConfigurationsPostRequestFormGooglePayX5f48552b = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentMethodConfigurationsPostRequestFormGooglePayX5f48552b> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentMethodConfigurationsPostRequestFormGooglePayX5f48552b must be a JSON object",
                    )
            return InlineV1PaymentMethodConfigurationsPostRequestFormGooglePayX5f48552b(
                displayPreference =
                    rawObject["display_preference"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentMethodConfidc49PostRequestFormGooglePayDisplayPreferenceXe2009e3c>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentMethodConfigurationsPostRequestFormGooglePayX5f48552b,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentMethodConfigurationsPostRequestFormGooglePayX5f48552b(
    block: InlineV1PaymentMethodConfigurationsPostRequestFormGooglePayX5f48552b.Builder.() -> Unit,
): InlineV1PaymentMethodConfigurationsPostRequestFormGooglePayX5f48552b =
    InlineV1PaymentMethodConfigurationsPostRequestFormGooglePayX5f48552b.build(block)
