...
public sealed class InlineV1IdentityVerificationReportsGetParameterXb3ffcb97 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1IdentityVerificationReportsGetParameterXb3ffcb97 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1IdentityVerificationReportsGetParameterXb3ffcb97> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1IdentityVerificationReportsGetParameterXb3ffcb97",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1IdentityVerificationReportsGetParameterXb3ffcb97 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IdentityVerificationReportsGetParameterXb3ffcb97,
        ) {
