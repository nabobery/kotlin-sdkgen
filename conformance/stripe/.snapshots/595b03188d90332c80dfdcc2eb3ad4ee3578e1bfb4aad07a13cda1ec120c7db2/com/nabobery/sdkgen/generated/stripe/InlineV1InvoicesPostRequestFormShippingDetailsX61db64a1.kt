...
public class InlineV1InvoicesPostRequestFormShippingDetailsX61db64a1(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1InvoicesPostRequestFormShippingDetailsX61db64a1 =
    ...
    public object Serializer : KSerializer<InlineV1InvoicesPostRequestFormShippingDetailsX61db64a1> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1InvoicesPostRequestFormShippingDetailsX61db64a1 {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1InvoicesPostRequestFormShippingDetailsX61db64a1 must be a JSON object",
                    )
            val address =
                json.decodeRequired<InlineV1InvoicesPostRequestFormShippingDetailsAddressXe572a539>(
                    rawObject,
                    "address",
                )
            ...
            return InlineV1InvoicesPostRequestFormShippingDetailsX61db64a1(
                ...
                phone =
                    rawObject["phone"]?.let {
                        json.decodeFromJsonElement<InlineV1InvoicesPostRequestFormShippingDetailsPhoneXa271da88>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesPostRequestFormShippingDetailsX61db64a1,
        ) {
...
public fun inlineV1InvoicesPostRequestFormShippingDetailsX61db64a1(
    block: InlineV1InvoicesPostRequestFormShippingDetailsX61db64a1.Builder.() -> Unit,
): InlineV1InvoicesPostRequestFormShippingDetailsX61db64a1 =
    InlineV1InvoicesPostRequestFormShippingDetailsX61db64a1.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1InvoicesPostRequestFormShippingDetailsX61db64a1 is missing required property '" + name + "'",
            )
