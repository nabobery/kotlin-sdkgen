...
public class InlineV1InvoiceitemsPostRequestFormTaxCodeX8962e651 internal constructor(
    ...
    public val inlineV1InvoiceitemsPostRequestFormTaxCodeAnyOf2X83b47ec2:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1InvoiceitemsPostRequestFormTaxCodeAnyOf2X83b47ec2) {
                json
                    .decodeFromJsonElement<InlineV1InvoiceitemsPostRequestFormTaxCodeAnyOf2X83b47ec2>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1InvoiceitemsPostRequestFormTaxCodeX8962e651Branch>
        get() =
            buildSet {
                ...
                if (inspection.matchesInlineV1InvoiceitemsPostRequestFormTaxCodeAnyOf2X83b47ec2) {
                    add(
                        InlineV1InvoiceitemsPostRequestFormTaxCodeX8962e651Branch.InlineV1InvoiceitemsPostRequestFormTaxCodeAnyOf2X83b47ec2,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1InvoiceitemsPostRequestFormTaxCodeX8962e651 {
            val inspection = inspectInlineV1InvoiceitemsPostRequestFormTaxCodeX8962e651(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1InvoiceitemsPostRequestFormTaxCodeX8962e651NoMatchException(
                    "InlineV1InvoiceitemsPostRequestFormTaxCodeX8962e651 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1InvoiceitemsPostRequestFormTaxCodeX8962e651> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoiceitemsPostRequestFormTaxCodeX8962e651,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1InvoiceitemsPostRequestFormTaxCodeX8962e651",
...
private fun inspectInlineV1InvoiceitemsPostRequestFormTaxCodeX8962e651(
    element: JsonElement,
): InlineV1InvoiceitemsPostRequestFormTaxCodeX8962e651Inspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1InvoiceitemsPostRequestFormTaxCodeAnyOf2X83b47ec2 =
        element
            .isJsonDecodable<InlineV1InvoiceitemsPostRequestFormTaxCodeAnyOf2X83b47ec2>()
    return InlineV1InvoiceitemsPostRequestFormTaxCodeX8962e651Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1InvoiceitemsPostRequestFormTaxCodeAnyOf2X83b47ec2) {
                    add(
                        "InlineV1InvoiceitemsPostRequestFormTaxCodeAnyOf2X83b47ec2: value does not match InlineV1InvoiceitemsPostRequestFormTaxCodeAnyOf2X83b47ec2",
                    )
                }
            },
    )
