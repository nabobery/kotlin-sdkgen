...
public class TaxProductRegistrationsResourceCountryOptions(
    ...
    public class Builder {
        ...
        public fun build(): TaxProductRegistrationsResourceCountryOptions =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): TaxProductRegistrationsResourceCountryOptions =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<TaxProductRegistrationsResourceCountryOptions> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "TaxProductRegistrationsResourceCountryOptions must be a JSON object",
                    )
            return TaxProductRegistrationsResourceCountryOptions(
                ae =
                    rawObject["ae"]?.let {
                        json.decodeFromJsonElement<TaxProductRegistrationsResourceCountryOptionsDefaultInboundGoods>(it)
                    },
                al =
                    rawObject["al"]?.let {
                        json.decodeFromJsonElement<TaxProductRegistrationsResourceCountryOptionsDefault>(
                            it,
                        )
                    },
                am =
                    rawObject["am"]?.let {
                        json.decodeFromJsonElement<TaxProductRegistrationsResourceCountryOptionsSimplified>(
                            it,
                        )
                    },
                ao =
                ...
                at =
                    rawObject["at"]?.let {
                        json.decodeFromJsonElement<TaxProductRegistrationsResourceCountryOptionsEurope>(
                            it,
                        )
                    },
                au =
                ...
                ca =
                    rawObject["ca"]?.let {
                        json.decodeFromJsonElement<TaxProductRegistrationsResourceCountryOptionsCanada>(
                            it,
                        )
                    },
                cd =
                ...
                ch =
                    rawObject["ch"]
                        ?.let {
                            json
                                .decodeFromJsonElement<TaxProductRegistrationsResourceCountryOptionsDefaultInboundGoods>(
                                    it,
                                )
                        },
                cl =
                ...
                inValue =
                    rawObject["in"]
                        ?.let {
                            json.decodeFromJsonElement<TaxProductRegistrationsResourceCountryOptionsSimplified>(it)
                        },
                isValue =
                    rawObject["is"]
                        ?.let {
                            json
                                .decodeFromJsonElement<TaxProductRegistrationsResourceCountryOptionsDefault>(
                                    it,
                                )
                        },
                it =
                ...
                th =
                    rawObject["th"]
                        ?.let {
                            json.decodeFromJsonElement<TaxProductRegistrationsResourceCountryOptionsThailand>(
                                it,
                            )
                        },
                tj =
                ...
                us =
                    rawObject["us"]
                        ?.let {
                            json
                                .decodeFromJsonElement<TaxProductRegistrationsResourceCountryOptionsUnitedStates>(
                                    it,
                                )
                        },
                uy =
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: TaxProductRegistrationsResourceCountryOptions,
        ) {
...
public fun taxProductRegistrationsResourceCountryOptions(
    block: TaxProductRegistrationsResourceCountryOptions.Builder.() -> Unit,
): TaxProductRegistrationsResourceCountryOptions = TaxProductRegistrationsResourceCountryOptions.build(block)
