...
public class DeletedRadarValueListItem(
    ...
    public object Serializer : KSerializer<DeletedRadarValueListItem> {
        ...
        override fun deserialize(decoder: Decoder): DeletedRadarValueListItem {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("DeletedRadarValueListItem must be a JSON object")
            val deleted = json.decodeRequired<Boolean>(rawObject, "deleted")
            val id = json.decodeRequired<String>(rawObject, "id")
            val objectValue =
                json.decodeRequired<InlineDeletedRadarValueListItemObjectValueXf57fcf1e>(
                    rawObject,
                    "object",
                )
            return DeletedRadarValueListItem(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: DeletedRadarValueListItem,
        ) {
...
public fun deletedRadarValueListItem(block: DeletedRadarValueListItem.Builder.() -> Unit): DeletedRadarValueListItem =
    DeletedRadarValueListItem.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException("DeletedRadarValueListItem is missing required property '" + name + "'")
