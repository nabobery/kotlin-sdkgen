...
internal data class InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsTrialEndX2b7a8305Inspection(
    ...
    public val matchesInlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesAnyOf2Xd47b16bc: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesAnyOf2Xd47b16bc,
            ).count {
                it
            }
}
...
public class InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsTrialEndX2b7a8305 internal constructor(
    ...
    private val inspection: InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsTrialEndX2b7a8305Inspection,
) {
    ...
    public val inlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesAnyOf2Xd47b16bc:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesAnyOf2Xd47b16bc) {
                json
                    .decodeFromJsonElement<InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesAnyOf2Xd47b16bc>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsTrialEndX2b7a8305Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesAnyOf2Xd47b16bc) {
                    add(
                        InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsTrialEndX2b7a8305Branch.InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesAnyOf2Xd47b16bc,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsTrialEndX2b7a8305 {
            val inspection = inspectInlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsTrialEndX2b7a8305(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsTrialEndX2b7a8305NoMatchException(
                    "InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsTrialEndX2b7a8305 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsTrialEndX2b7a8305> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsTrialEndX2b7a8305,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsTrialEndX2b7a8305",
...
private fun inspectInlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsTrialEndX2b7a8305(
    element: JsonElement,
): InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsTrialEndX2b7a8305Inspection {
    val matchesBranch1 = element.isJsonDecodable<Int>()
    val matchesInlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesAnyOf2Xd47b16bc =
        element
            .isJsonDecodable<InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesAnyOf2Xd47b16bc>()
    return InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsTrialEndX2b7a8305Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesAnyOf2Xd47b16bc) {
                    add(
                        "InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesAnyOf2Xd47b16bc: value does not match InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesAnyOf2Xd47b16bc",
                    )
                }
            },
    )
