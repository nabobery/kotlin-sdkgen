...
public class InvoicePaymentMethodOptionsCustomerBalanceBankTransfer(
    public val euBankTransfer: InvoicePaymentMethodOptionsCustomerBalanceBankTransferEuBankTransfer? = null,
    /**
    ...
    public class Builder {
        ...
        public fun build(): InvoicePaymentMethodOptionsCustomerBalanceBankTransfer =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InvoicePaymentMethodOptionsCustomerBalanceBankTransfer =
    ...
    public object Serializer : KSerializer<InvoicePaymentMethodOptionsCustomerBalanceBankTransfer> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InvoicePaymentMethodOptionsCustomerBalanceBankTransfer must be a JSON object",
                    )
            return InvoicePaymentMethodOptionsCustomerBalanceBankTransfer(
                euBankTransfer =
                    rawObject["eu_bank_transfer"]?.let {
                        json
                            .decodeFromJsonElement<InvoicePaymentMethodOptionsCustomerBalanceBankTransferEuBankTransfer>(
                                it,
                            )
                    },
                type =
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InvoicePaymentMethodOptionsCustomerBalanceBankTransfer,
        ) {
...
public fun invoicePaymentMethodOptionsCustomerBalanceBankTransfer(
    block: InvoicePaymentMethodOptionsCustomerBalanceBankTransfer.Builder.() -> Unit,
): InvoicePaymentMethodOptionsCustomerBalanceBankTransfer =
    InvoicePaymentMethodOptionsCustomerBalanceBankTransfer.build(block)
