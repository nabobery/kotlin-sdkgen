...
public class InlineV1TokensPostRequestFormAccountIndividualRelationshipXa70a21f8(
    ...
    public val percentOwnership: InlineV1TokensPostRequestFormAccountIndividualPercentOwnershipX14bde57b? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1TokensPostRequestFormAccountIndividualRelationshipXa70a21f8 =
            InlineV1TokensPostRequestFormAccountIndividualRelationshipXa70a21f8(
                director = director,
                executive = executive,
                owner = owner,
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1TokensPostRequestFormAccountIndividualRelationshipXa70a21f8 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TokensPostRequestFormAccountIndividualRelationshipXa70a21f8> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TokensPostRequestFormAccountIndividualRelationshipXa70a21f8 must be a JSON object",
                    )
            return InlineV1TokensPostRequestFormAccountIndividualRelationshipXa70a21f8(
                ...
                percentOwnership =
                    rawObject["percent_ownership"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TokensPostRequestFormAccountIndividualPercentOwnershipX14bde57b>(
                                it,
                            )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TokensPostRequestFormAccountIndividualRelationshipXa70a21f8,
        ) {
            val jsonEncoder =
...
public fun inlineV1TokensPostRequestFormAccountIndividualRelationshipXa70a21f8(
    block: InlineV1TokensPostRequestFormAccountIndividualRelationshipXa70a21f8.Builder.() -> Unit,
): InlineV1TokensPostRequestFormAccountIndividualRelationshipXa70a21f8 =
    InlineV1TokensPostRequestFormAccountIndividualRelationshipXa70a21f8.build(block)
