...
public sealed class InlineBillingAlertStatusX73f6a8ea {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineBillingAlertStatusX73f6a8ea =
            when (value) {
                Active.value -> Active
    ...
    public object Serializer : KSerializer<InlineBillingAlertStatusX73f6a8ea> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineBillingAlertStatusX73f6a8ea",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineBillingAlertStatusX73f6a8ea =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineBillingAlertStatusX73f6a8ea,
        ) {
