...
public class InlineV1PaymentLinksPostRequestFormRestrictionsAnyOf1CompletedSessionsX64d038e1(
    ...
    public object Serializer : KSerializer<InlineV1PaymentLinksPostRequestFormRestrictionsAnyOf1CompletedSessionsX64d038e1> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentLinksPostRequestFormRestrictionsAnyOf1CompletedSessionsX64d038e1 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentLinksPostRequestFormRestrictionsAnyOf1CompletedSessionsX64d038e1,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentLinksPostRequestFormRestrictionsAnyOf1CompletedSessionsX64d038e1(
    block: InlineV1PaymentLinksPostRequestFormRestrictionsAnyOf1CompletedSessionsX64d038e1.Builder.() -> Unit,
): InlineV1PaymentLinksPostRequestFormRestrictionsAnyOf1CompletedSessionsX64d038e1 =
    InlineV1PaymentLinksPostRequestFormRestrictionsAnyOf1CompletedSessionsX64d038e1.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentLinksPostRequestFormRestrictionsAnyOf1CompletedSessionsX64d038e1 is missing required property '" +
                    name +
                    "'",
            )
