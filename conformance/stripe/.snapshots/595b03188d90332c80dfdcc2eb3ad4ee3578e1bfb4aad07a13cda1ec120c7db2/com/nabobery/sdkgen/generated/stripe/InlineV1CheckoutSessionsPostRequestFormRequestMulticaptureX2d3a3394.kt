...
public sealed class InlineV1CheckoutSessionsPostRequestFormRequestMulticaptureX2d3a3394 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1CheckoutSessionsPostRequestFormRequestMulticaptureX2d3a3394 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormRequestMulticaptureX2d3a3394> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1CheckoutSessionsPostRequestFormRequestMulticaptureX2d3a3394",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1CheckoutSessionsPostRequestFormRequestMulticaptureX2d3a3394 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsPostRequestFormRequestMulticaptureX2d3a3394,
        ) {
