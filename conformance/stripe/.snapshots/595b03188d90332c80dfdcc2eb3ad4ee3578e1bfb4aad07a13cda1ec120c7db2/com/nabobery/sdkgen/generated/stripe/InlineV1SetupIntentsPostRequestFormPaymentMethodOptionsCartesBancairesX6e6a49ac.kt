...
public class InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsCartesBancairesX6e6a49ac(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsCartesBancairesX6e6a49ac =
    ...
    public object Serializer : KSerializer<InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsCartesBancairesX6e6a49ac> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsCartesBancairesX6e6a49ac must be a JSON object",
                    )
            val cbAvalgo =
                json.decodeRequired<InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsCardCbAvalgoX4f591f93>(
                    rawObject,
                    "cb_avalgo",
                )
            return InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsCartesBancairesX6e6a49ac(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsCartesBancairesX6e6a49ac,
        ) {
            val jsonEncoder =
...
public fun inlineV1SetupIntentsPostRequestFormPaymentMethodOptionsCartesBancairesX6e6a49ac(
    block: InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsCartesBancairesX6e6a49ac.Builder.() -> Unit,
): InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsCartesBancairesX6e6a49ac =
    InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsCartesBancairesX6e6a49ac.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsCartesBancairesX6e6a49ac is missing required property '" +
                    name +
                    "'",
            )
