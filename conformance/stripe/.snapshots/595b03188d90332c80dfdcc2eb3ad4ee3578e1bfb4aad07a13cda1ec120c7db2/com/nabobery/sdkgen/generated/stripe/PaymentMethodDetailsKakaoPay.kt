...
public class PaymentMethodDetailsKakaoPay(
    ...
    public class Builder {
        ...
        public fun build(): PaymentMethodDetailsKakaoPay =
    ...
    public object Serializer : KSerializer<PaymentMethodDetailsKakaoPay> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodDetailsKakaoPay {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodDetailsKakaoPay must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentMethodDetailsKakaoPay,
        ) {
...
public fun paymentMethodDetailsKakaoPay(
    block: PaymentMethodDetailsKakaoPay.Builder.() -> Unit,
): PaymentMethodDetailsKakaoPay = PaymentMethodDetailsKakaoPay.build(block)
