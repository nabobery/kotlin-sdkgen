...
public class InlineV1TestHelpersIssuingAuthorizationsPostRequestFormXc6cf0481(
     ...
     */
    public val amountDetails: InlineV1TestHelpersIssuingAuthorizationsPostRequestFormAmountDetailsX2414de05? = null,
    /**
     * How the card details were provided. Defaults to online.
     */
    public val authorizationMethod: InlineV1TestHelpersIssuing214aPostRequestFormAuthorizationMethodX2692193a? = null,
    /**
     ...
     */
    public val merchantData: InlineV1TestHelpersIssuingAuthorizationsPostRequestFormMerchantDataX6d8b8b89? = null,
    /**
     * Details about the authorization, such as identifiers, set by the card network.
     */
    public val networkData: InlineV1TestHelpersIssuingAuthorizationsPostRequestFormNetworkDataX2f17c458? = null,
    /**
     * Stripe’s assessment of the fraud risk for this authorization.
     */
    public val riskAssessment: InlineV1TestHelpersIssuingAuthorizationsPostRequestFormRiskAssessmentX0e063598? = null,
    /**
     * Verifications that Stripe performed on information that the cardholder provided to the merchant.
     */
    public val verificationData: InlineV1TestHelpersIssuingAuthorizationsPostRequestFormVerificationDataX9cb5dbd5? = null,
    /**
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TestHelpersIssuingAuthorizationsPostRequestFormXc6cf0481 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TestHelpersIssuingAuthorizationsPostRequestFormXc6cf0481> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1TestHelpersIssuingAuthorizationsPostRequestFormXc6cf0481 {
            val jsonDecoder =
                decoder.requireJsonDecoder(
                    "InlineV1TestHelpersIssuingAuthorizationsPostRequestFormXc6cf0481",
                )
            val json = jsonDecoder.json
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TestHelpersIssuingAuthorizationsPostRequestFormXc6cf0481 must be a JSON object",
                    )
            ...
            return InlineV1TestHelpersIssuingAuthorizationsPostRequestFormXc6cf0481(
                ...
                amountDetails =
                    rawObject["amount_details"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TestHelpersIssuingAuthorizationsPostRequestFormAmountDetailsX2414de05>(
                                it,
                            )
                    },
                authorizationMethod =
                    rawObject["authorization_method"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TestHelpersIssuing214aPostRequestFormAuthorizationMethodX2692193a>(
                                it,
                            )
                    },
                ...
                fleet =
                    rawObject["fleet"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TestHelpersIssuingAuthorizationsPostRequestFormFleetXd434de5e>(
                                it,
                            )
                    },
                fraudDisputabilityLikelihood =
                    rawObject["fraud_disputability_likelihood"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TestHelpersIssuing214aPostRequestFormFraudDisputabilityLif498X30ca872a>(
                                it,
                            )
                    },
                fuel =
                    rawObject["fuel"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TestHelpersIssuingAuthorizationsPostRequestFormFuelX766df20a>(
                                it,
                            )
                    },
                isAmountControllable =
                    rawObject["is_amount_controllable"]?.let {
                        json
                ...
                merchantData =
                    rawObject["merchant_data"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TestHelpersIssuingAuthorizationsPostRequestFormMerchantDataX6d8b8b89>(
                                it,
                            )
                    },
                networkData =
                    rawObject["network_data"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TestHelpersIssuingAuthorizationsPostRequestFormNetworkDataX2f17c458>(
                                it,
                            )
                    },
                riskAssessment =
                    rawObject["risk_assessment"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TestHelpersIssuingAuthorizationsPostRequestFormRiskAssessmentX0e063598>(
                                it,
                            )
                    },
                verificationData =
                    rawObject["verification_data"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TestHelpersIssuingAuthorizationsPostRequestFormVerificationDataX9cb5dbd5>(
                                it,
                            )
                    },
                wallet =
                    rawObject["wallet"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TestHelpersIssuingAuthorizationsPostRequestFormWalletXee995495>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TestHelpersIssuingAuthorizationsPostRequestFormXc6cf0481,
        ) {
            val jsonEncoder =
            ...
            val raw =
                buildJsonObject {
                    ...
                    value.fraudDisputabilityLikelihood?.let {
                        put(
...
public fun inlineV1TestHelpersIssuingAuthorizationsPostRequestFormXc6cf0481(
    block: InlineV1TestHelpersIssuingAuthorizationsPostRequestFormXc6cf0481.Builder.() -> Unit,
): InlineV1TestHelpersIssuingAuthorizationsPostRequestFormXc6cf0481 =
    InlineV1TestHelpersIssuingAuthorizationsPostRequestFormXc6cf0481.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TestHelpersIssuingAuthorizationsPostRequestFormXc6cf0481 is missing required property '" + name +
                    "'",
            )
