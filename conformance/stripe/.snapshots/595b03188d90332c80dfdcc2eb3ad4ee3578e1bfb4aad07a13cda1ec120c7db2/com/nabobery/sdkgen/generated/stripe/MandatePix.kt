...
public class MandatePix(
    ...
    public object Serializer : KSerializer<MandatePix> {
        ...
        override fun deserialize(decoder: Decoder): MandatePix {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("MandatePix must be a JSON object")
            return MandatePix(
                amountIncludesIof =
                    rawObject["amount_includes_iof"]?.let {
                        json.decodeFromJsonElement<InlineMandatePixAmountIncludesIofXd4d6fdc7>(it)
                    },
                amountType =
                    rawObject["amount_type"]?.let {
                        json.decodeFromJsonElement<InlineMandatePixAmountTypeXa2eae642>(
                            it,
                        )
                    },
                ...
                paymentSchedule =
                    rawObject["payment_schedule"]?.let {
                        json.decodeFromJsonElement<InlineMandatePixPaymentScheduleX3970c16e>(it)
                    },
