...
public class BalanceAmountBySourceType(
    ...
    public class Builder {
        ...
        public fun build(): BalanceAmountBySourceType =
    ...
    public object Serializer : KSerializer<BalanceAmountBySourceType> {
        ...
        override fun deserialize(decoder: Decoder): BalanceAmountBySourceType {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("BalanceAmountBySourceType must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: BalanceAmountBySourceType,
        ) {
...
public fun balanceAmountBySourceType(block: BalanceAmountBySourceType.Builder.() -> Unit): BalanceAmountBySourceType =
    BalanceAmountBySourceType.build(block)
