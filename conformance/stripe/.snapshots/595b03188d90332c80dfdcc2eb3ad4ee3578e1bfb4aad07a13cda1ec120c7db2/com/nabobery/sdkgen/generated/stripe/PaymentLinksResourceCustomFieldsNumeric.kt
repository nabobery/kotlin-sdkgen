...
public class PaymentLinksResourceCustomFieldsNumeric(
    ...
    public class Builder {
        ...
        public fun build(): PaymentLinksResourceCustomFieldsNumeric =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentLinksResourceCustomFieldsNumeric =
    ...
    public object Serializer : KSerializer<PaymentLinksResourceCustomFieldsNumeric> {
        ...
        override fun deserialize(decoder: Decoder): PaymentLinksResourceCustomFieldsNumeric {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentLinksResourceCustomFieldsNumeric must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentLinksResourceCustomFieldsNumeric,
        ) {
...
public fun paymentLinksResourceCustomFieldsNumeric(
    block: PaymentLinksResourceCustomFieldsNumeric.Builder.() -> Unit,
): PaymentLinksResourceCustomFieldsNumeric = PaymentLinksResourceCustomFieldsNumeric.build(block)
