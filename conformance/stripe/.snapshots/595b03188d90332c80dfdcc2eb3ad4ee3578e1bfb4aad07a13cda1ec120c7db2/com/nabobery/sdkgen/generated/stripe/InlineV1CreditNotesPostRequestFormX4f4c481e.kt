...
public class InlineV1CreditNotesPostRequestFormX4f4c481e(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1CreditNotesPostRequestFormX4f4c481e =
            InlineV1CreditNotesPostRequestFormX4f4c481e(
                expand = expand,
                memo = memo,
                metadata = metadata,
            )
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1CreditNotesPostRequestFormX4f4c481e =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1CreditNotesPostRequestFormX4f4c481e> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1CreditNotesPostRequestFormX4f4c481e {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("InlineV1CreditNotesPostRequestFormX4f4c481e must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CreditNotesPostRequestFormX4f4c481e,
        ) {
...
public fun inlineV1CreditNotesPostRequestFormX4f4c481e(
    block: InlineV1CreditNotesPostRequestFormX4f4c481e.Builder.() -> Unit,
): InlineV1CreditNotesPostRequestFormX4f4c481e = InlineV1CreditNotesPostRequestFormX4f4c481e.build(block)
