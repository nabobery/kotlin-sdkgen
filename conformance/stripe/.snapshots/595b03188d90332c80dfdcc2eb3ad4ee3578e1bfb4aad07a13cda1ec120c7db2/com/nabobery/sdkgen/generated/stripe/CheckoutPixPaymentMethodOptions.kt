...
public class CheckoutPixPaymentMethodOptions(
     ...
     */
    public val amountIncludesIof: InlineCheckoutPixPaymentMethodOptionsAmountIncludesIofX21a3a40c? = null,
    /**
     ...
     */
    public val setupFutureUsage: InlineCheckoutPixPaymentMethodOptionsSetupFutureUsageX1e94208d? = null,
) {
    public class Builder {
        ...
        public fun build(): CheckoutPixPaymentMethodOptions =
    ...
    public object Serializer : KSerializer<CheckoutPixPaymentMethodOptions> {
        ...
        override fun deserialize(decoder: Decoder): CheckoutPixPaymentMethodOptions {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("CheckoutPixPaymentMethodOptions must be a JSON object")
            return CheckoutPixPaymentMethodOptions(
                amountIncludesIof =
                    rawObject["amount_includes_iof"]?.let {
                        json.decodeFromJsonElement<InlineCheckoutPixPaymentMethodOptionsAmountIncludesIofX21a3a40c>(it)
                    },
                expiresAfterSeconds =
                ...
                setupFutureUsage =
                    rawObject["setup_future_usage"]?.let {
                        json.decodeFromJsonElement<InlineCheckoutPixPaymentMethodOptionsSetupFutureUsageX1e94208d>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: CheckoutPixPaymentMethodOptions,
        ) {
...
public fun checkoutPixPaymentMethodOptions(
    block: CheckoutPixPaymentMethodOptions.Builder.() -> Unit,
): CheckoutPixPaymentMethodOptions = CheckoutPixPaymentMethodOptions.build(block)
