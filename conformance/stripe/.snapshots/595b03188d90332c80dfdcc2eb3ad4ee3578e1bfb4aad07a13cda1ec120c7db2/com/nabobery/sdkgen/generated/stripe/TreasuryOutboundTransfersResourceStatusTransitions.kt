...
public class TreasuryOutboundTransfersResourceStatusTransitions(
    ...
    public class Builder {
        ...
        public fun build(): TreasuryOutboundTransfersResourceStatusTransitions =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): TreasuryOutboundTransfersResourceStatusTransitions =
    ...
    public object Serializer : KSerializer<TreasuryOutboundTransfersResourceStatusTransitions> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "TreasuryOutboundTransfersResourceStatusTransitions must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: TreasuryOutboundTransfersResourceStatusTransitions,
        ) {
...
public fun treasuryOutboundTransfersResourceStatusTransitions(
    block: TreasuryOutboundTransfersResourceStatusTransitions.Builder.() -> Unit,
): TreasuryOutboundTransfersResourceStatusTransitions = TreasuryOutboundTransfersResourceStatusTransitions.build(block)
