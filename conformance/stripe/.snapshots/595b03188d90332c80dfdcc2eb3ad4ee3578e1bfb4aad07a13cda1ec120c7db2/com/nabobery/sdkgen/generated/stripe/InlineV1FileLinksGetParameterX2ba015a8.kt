...
public class InlineV1FileLinksGetParameterX2ba015a8 internal constructor(
    ...
    public val inlineV1FileLinksGetParameterAnyOf1Xa444c3db:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1FileLinksGetParameterAnyOf1Xa444c3db) {
                json
                    .decodeFromJsonElement<InlineV1FileLinksGetParameterAnyOf1Xa444c3db>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1FileLinksGetParameterX2ba015a8Branch>
        get() =
            buildSet {
                if (inspection.matchesInlineV1FileLinksGetParameterAnyOf1Xa444c3db) {
                    add(
                        InlineV1FileLinksGetParameterX2ba015a8Branch.InlineV1FileLinksGetParameterAnyOf1Xa444c3db,
                    )
                }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1FileLinksGetParameterX2ba015a8 {
            val inspection = inspectInlineV1FileLinksGetParameterX2ba015a8(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1FileLinksGetParameterX2ba015a8NoMatchException(
                    "InlineV1FileLinksGetParameterX2ba015a8 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1FileLinksGetParameterX2ba015a8> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1FileLinksGetParameterX2ba015a8,
        ) {
...
private fun inspectInlineV1FileLinksGetParameterX2ba015a8(
    element: JsonElement,
): InlineV1FileLinksGetParameterX2ba015a8Inspection {
    val matchesInlineV1FileLinksGetParameterAnyOf1Xa444c3db =
        element
            .isJsonDecodable<InlineV1FileLinksGetParameterAnyOf1Xa444c3db>()
    ...
    return InlineV1FileLinksGetParameterX2ba015a8Inspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1FileLinksGetParameterAnyOf1Xa444c3db) {
                    add(
                        "InlineV1FileLinksGetParameterAnyOf1Xa444c3db: value does not match InlineV1FileLinksGetParameterAnyOf1Xa444c3db",
                    )
                }
