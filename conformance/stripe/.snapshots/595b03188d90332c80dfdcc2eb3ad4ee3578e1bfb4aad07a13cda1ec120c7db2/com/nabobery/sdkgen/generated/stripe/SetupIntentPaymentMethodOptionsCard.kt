...
public data class SetupIntentPaymentMethodOptionsCardView(
    ...
    public val mandateOptions: InlineSetupIntentPaymentMethodOptionsCardMandateOptionsX641d401a? = null,
    public val network: InlineSetupIntentPaymentMethodOptionsCardNetworkX741ae9df? = null,
    @SerialName("request_three_d_secure")
    public val requestThreeDSecure: InlineSetupIntentPaymentMethodOptionsCardRequestThreeDSecureX9349dbd2? = null,
)
...
public class SetupIntentPaymentMethodOptionsCard(
    ...
    public class Builder {
        ...
        public fun build(): SetupIntentPaymentMethodOptionsCard =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): SetupIntentPaymentMethodOptionsCard =
    ...
    public object Serializer : KSerializer<SetupIntentPaymentMethodOptionsCard> {
        ...
        override fun deserialize(decoder: Decoder): SetupIntentPaymentMethodOptionsCard {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("SetupIntentPaymentMethodOptionsCard must be a JSON object")
                ...
                mandateOptions =
                    rawObject["mandate_options"]?.let { element ->
                        if (element ==
                            ...
                            json
                                .decodeFromJsonElement<InlineSetupIntentPaymentMethodOptionsCardMandateOptionsX641d401a?>(
                                    element,
                                )
                        }
                    },
                network =
                    rawObject["network"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineSetupIntentPaymentMethodOptionsCardNetworkX741ae9df?>(
                                element,
                            )
                        }
                    },
                requestThreeDSecure =
                    rawObject["request_three_d_secure"]?.let { element ->
                        if (element ==
                            ...
                            json
                                .decodeFromJsonElement<InlineSetupIntentPaymentMethodOptionsCardRequestThreeDSecureX9349dbd2?>(
                                    element,
                                )
                        }
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: SetupIntentPaymentMethodOptionsCard,
        ) {
...
public fun setupIntentPaymentMethodOptionsCard(
    block: SetupIntentPaymentMethodOptionsCard.Builder.() -> Unit,
): SetupIntentPaymentMethodOptionsCard = SetupIntentPaymentMethodOptionsCard.build(block)
