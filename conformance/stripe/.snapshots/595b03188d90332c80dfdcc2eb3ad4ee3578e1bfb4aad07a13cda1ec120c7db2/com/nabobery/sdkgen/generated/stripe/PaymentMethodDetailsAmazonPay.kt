...
public class PaymentMethodDetailsAmazonPay(
    ...
    public class Builder {
        ...
        public fun build(): PaymentMethodDetailsAmazonPay =
    ...
    public object Serializer : KSerializer<PaymentMethodDetailsAmazonPay> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodDetailsAmazonPay {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodDetailsAmazonPay must be a JSON object")
            return PaymentMethodDetailsAmazonPay(
                funding =
                    rawObject["funding"]?.let {
                        json
                            .decodeFromJsonElement<AmazonPayUnderlyingPaymentMethodFundingDetails>(
                                it,
                            )
                    },
                transactionId =
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentMethodDetailsAmazonPay,
        ) {
...
public fun paymentMethodDetailsAmazonPay(
    block: PaymentMethodDetailsAmazonPay.Builder.() -> Unit,
): PaymentMethodDetailsAmazonPay = PaymentMethodDetailsAmazonPay.build(block)
