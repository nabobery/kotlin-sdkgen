...
public class BillingClocksResourceStatusDetailsAdvancingStatusDetails(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): BillingClocksResourceStatusDetailsAdvancingStatusDetails =
    ...
    public object Serializer : KSerializer<BillingClocksResourceStatusDetailsAdvancingStatusDetails> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "BillingClocksResourceStatusDetailsAdvancingStatusDetails must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: BillingClocksResourceStatusDetailsAdvancingStatusDetails,
        ) {
...
public fun billingClocksResourceStatusDetailsAdvancingStatusDetails(
    block: BillingClocksResourceStatusDetailsAdvancingStatusDetails.Builder.() -> Unit,
): BillingClocksResourceStatusDetailsAdvancingStatusDetails =
    BillingClocksResourceStatusDetailsAdvancingStatusDetails.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "BillingClocksResourceStatusDetailsAdvancingStatusDetails is missing required property '" + name + "'",
            )
