...
public class InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsBankTransferXfbe332bf(
    ...
    public val euBankTransfer: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsEuBankTransferXb61285ea? = null,
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsBankTransferXfbe332bf> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsBankTransferXfbe332bf must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsTypeXb93dc9db>(
                    rawObject,
                    "type",
                )
            return InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsBankTransferXfbe332bf(
                ...
                euBankTransfer =
                    rawObject["eu_bank_transfer"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsEuBankTransferXb61285ea>(
                                it,
                            )
                    },
                requestedAddressTypes =
                    rawObject["requested_address_types"]?.let {
                        json
                            .decodeFromJsonElement<List<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsItemXd59feb99>>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsBankTransferXfbe332bf,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsBankTransferXfbe332bf(
    block: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsBankTransferXfbe332bf.Builder.() -> Unit,
): InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsBankTransferXfbe332bf =
    InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsBankTransferXfbe332bf.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsBankTransferXfbe332bf is missing required property '" +
                    name +
                    "'",
            )
