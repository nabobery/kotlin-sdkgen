...
public sealed class InlineCheckoutPixPaymentMethodOptionsAmountIncludesIofX21a3a40c {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineCheckoutPixPaymentMethodOptionsAmountIncludesIofX21a3a40c =
            when (value) {
                Always.value -> Always
                Never.value -> Never
    ...
    public object Serializer : KSerializer<InlineCheckoutPixPaymentMethodOptionsAmountIncludesIofX21a3a40c> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineCheckoutPixPaymentMethodOptionsAmountIncludesIofX21a3a40c",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineCheckoutPixPaymentMethodOptionsAmountIncludesIofX21a3a40c =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineCheckoutPixPaymentMethodOptionsAmountIncludesIofX21a3a40c,
        ) {
