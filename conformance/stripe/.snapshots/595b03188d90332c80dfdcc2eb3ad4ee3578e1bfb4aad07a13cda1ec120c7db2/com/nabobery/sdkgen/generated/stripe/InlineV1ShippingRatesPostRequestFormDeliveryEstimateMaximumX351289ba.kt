...
public class InlineV1ShippingRatesPostRequestFormDeliveryEstimateMaximumX351289ba(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1ShippingRatesPostRequestFormDeliveryEstimateMaximumX351289ba = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1ShippingRatesPostRequestFormDeliveryEstimateMaximumX351289ba> {
        ...
        override fun deserialize(
            decoder: Decoder,
        ): InlineV1ShippingRatesPostRequestFormDeliveryEstimateMaximumX351289ba {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1ShippingRatesPostRequestFormDeliveryEstimateMaximumX351289ba must be a JSON object",
                    )
            val unit =
                json.decodeRequired<InlineV1ShippingRatesPostRequestFormDeliveryEstimateMaximumUnitXb6709287>(
                    rawObject,
                    "unit",
                )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ShippingRatesPostRequestFormDeliveryEstimateMaximumX351289ba,
        ) {
            val jsonEncoder =
...
public fun inlineV1ShippingRatesPostRequestFormDeliveryEstimateMaximumX351289ba(
    block: InlineV1ShippingRatesPostRequestFormDeliveryEstimateMaximumX351289ba.Builder.() -> Unit,
): InlineV1ShippingRatesPostRequestFormDeliveryEstimateMaximumX351289ba =
    InlineV1ShippingRatesPostRequestFormDeliveryEstimateMaximumX351289ba.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1ShippingRatesPostRequestFormDeliveryEstimateMaximumX351289ba is missing required property '" +
                    name +
                    "'",
            )
