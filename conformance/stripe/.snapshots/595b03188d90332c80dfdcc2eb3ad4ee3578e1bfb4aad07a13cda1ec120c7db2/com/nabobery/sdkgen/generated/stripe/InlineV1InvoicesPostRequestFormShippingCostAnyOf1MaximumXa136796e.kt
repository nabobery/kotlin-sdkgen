...
public class InlineV1InvoicesPostRequestFormShippingCostAnyOf1MaximumXa136796e(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1InvoicesPostRequestFormShippingCostAnyOf1MaximumXa136796e =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1InvoicesPostRequestFormShippingCostAnyOf1MaximumXa136796e> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1InvoicesPostRequestFormShippingCostAnyOf1MaximumXa136796e {
            val jsonDecoder =
                decoder.requireJsonDecoder(
                    "InlineV1InvoicesPostRequestFormShippingCostAnyOf1MaximumXa136796e",
                )
            val json = jsonDecoder.json
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1InvoicesPostRequestFormShippingCostAnyOf1MaximumXa136796e must be a JSON object",
                    )
            val unit =
                json.decodeRequired<InlineV1InvoicesPostRequestFormShippingCostAnyOf1ShippingRateDataUnitX594e6a99>(
                    rawObject,
                    "unit",
                )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesPostRequestFormShippingCostAnyOf1MaximumXa136796e,
        ) {
            val jsonEncoder =
...
public fun inlineV1InvoicesPostRequestFormShippingCostAnyOf1MaximumXa136796e(
    block: InlineV1InvoicesPostRequestFormShippingCostAnyOf1MaximumXa136796e.Builder.() -> Unit,
): InlineV1InvoicesPostRequestFormShippingCostAnyOf1MaximumXa136796e =
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1InvoicesPostRequestFormShippingCostAnyOf1MaximumXa136796e is missing required property '" +
                    name +
                    "'",
            )
