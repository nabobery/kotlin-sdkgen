...
public sealed class InlinePaymentMethodDetailsCardInstallmentsPlanIntervalXe0ba3ec2 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentMethodDetailsCardInstallmentsPlanIntervalXe0ba3ec2 =
            when (value) {
                Month.value -> Month
    ...
    public object Serializer : KSerializer<InlinePaymentMethodDetailsCardInstallmentsPlanIntervalXe0ba3ec2> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentMethodDetailsCardInstallmentsPlanIntervalXe0ba3ec2",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePaymentMethodDetailsCardInstallmentsPlanIntervalXe0ba3ec2 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentMethodDetailsCardInstallmentsPlanIntervalXe0ba3ec2,
        ) {
