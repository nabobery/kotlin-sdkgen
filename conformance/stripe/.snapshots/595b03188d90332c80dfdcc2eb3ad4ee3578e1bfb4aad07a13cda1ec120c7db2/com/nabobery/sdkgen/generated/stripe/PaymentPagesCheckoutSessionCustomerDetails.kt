...
@Serializable
public data class PaymentPagesCheckoutSessionCustomerDetailsView(
...
public class PaymentPagesCheckoutSessionCustomerDetails(
    ...
    public class Builder {
         ...
         * The customer’s tax IDs after a completed Checkout Session.
         */
        public var taxIds: List<PaymentPagesCheckoutSessionTaxId>? = null

        public fun build(): PaymentPagesCheckoutSessionCustomerDetails =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentPagesCheckoutSessionCustomerDetails =
    ...
    public object Serializer : KSerializer<PaymentPagesCheckoutSessionCustomerDetails> {
        ...
        override fun deserialize(decoder: Decoder): PaymentPagesCheckoutSessionCustomerDetails {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentPagesCheckoutSessionCustomerDetails must be a JSON object")
            return PaymentPagesCheckoutSessionCustomerDetails(
                address =
                    rawObject["address"]?.let { element ->
                        if (element ==
                            ...
                            json
                                .decodeFromJsonElement<InlinePaymentPagesCheckoutSessionCustomerDetailsAddressXe5b91771?>(
                                    element,
                                )
                        }
                    },
                businessName =
                    rawObject["business_name"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                individualName =
                    rawObject["individual_name"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                taxExempt =
                    rawObject["tax_exempt"]?.let { element ->
                        if (element ==
                            ...
                            json
                                .decodeFromJsonElement<InlinePaymentPagesCheckoutSessionCustomerDetailsTaxExemptX0d80dad5?>(
                                    element,
                                )
                        }
                    },
                taxIds =
                    rawObject["tax_ids"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<List<PaymentPagesCheckoutSessionTaxId>?>(element)
                        }
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentPagesCheckoutSessionCustomerDetails,
        ) {
...
public fun paymentPagesCheckoutSessionCustomerDetails(
    block: PaymentPagesCheckoutSessionCustomerDetails.Builder.() -> Unit,
): PaymentPagesCheckoutSessionCustomerDetails = PaymentPagesCheckoutSessionCustomerDetails.build(block)
