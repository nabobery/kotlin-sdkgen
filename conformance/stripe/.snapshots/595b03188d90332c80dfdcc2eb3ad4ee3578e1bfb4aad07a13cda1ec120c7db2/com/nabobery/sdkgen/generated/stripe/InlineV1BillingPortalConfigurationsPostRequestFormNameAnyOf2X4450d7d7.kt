...
public sealed class InlineV1BillingPortalConfigurationsPostRequestFormNameAnyOf2X4450d7d7 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1BillingPortalConfigurationsPostRequestFormNameAnyOf2X4450d7d7 =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1BillingPortalConfigurationsPostRequestFormNameAnyOf2X4450d7d7> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1BillingPortalConfigurationsPostRequestFormNameAnyOf2X4450d7d7",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1BillingPortalConfigurationsPostRequestFormNameAnyOf2X4450d7d7 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1BillingPortalConfigurationsPostRequestFormNameAnyOf2X4450d7d7,
        ) {
