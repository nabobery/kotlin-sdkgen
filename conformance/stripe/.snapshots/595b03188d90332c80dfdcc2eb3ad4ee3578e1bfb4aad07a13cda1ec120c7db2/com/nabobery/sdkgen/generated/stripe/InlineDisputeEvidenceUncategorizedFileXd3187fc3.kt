...
public class InlineDisputeEvidenceUncategorizedFileXd3187fc3 internal constructor(
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineDisputeEvidenceUncategorizedFileXd3187fc3 {
            val inspection = inspectInlineDisputeEvidenceUncategorizedFileXd3187fc3(raw)
            if (inspection.matchCount == 0) {
                throw InlineDisputeEvidenceUncategorizedFileXd3187fc3NoMatchException(
                    "InlineDisputeEvidenceUncategorizedFileXd3187fc3 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineDisputeEvidenceUncategorizedFileXd3187fc3> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineDisputeEvidenceUncategorizedFileXd3187fc3,
        ) {
...
private fun inspectInlineDisputeEvidenceUncategorizedFileXd3187fc3(
    element: JsonElement,
): InlineDisputeEvidenceUncategorizedFileXd3187fc3Inspection {
