...
internal data class InlineV1CustomersSubscriptionsPostRequestFormTrialEndXcd857a9bInspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesInlineV1CustomersSubscriptionsPostRequestFormTrialEndAnyOf1X9c29495e,
                matchesBranch2,
            ).count { it }
}
...
public class InlineV1CustomersSubscriptionsPostRequestFormTrialEndXcd857a9b internal constructor(
    ...
    public val inlineV1CustomersSubscriptionsPostRequestFormTrialEndAnyOf1X9c29495e:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1CustomersSubscriptionsPostRequestFormTrialEndAnyOf1X9c29495e) {
                json
                    .decodeFromJsonElement<InlineV1CustomersSubscriptionsPostRequestFormTrialEndAnyOf1X9c29495e>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches:
        ...
        get() =
            buildSet {
                if (inspection.matchesInlineV1CustomersSubscriptionsPostRequestFormTrialEndAnyOf1X9c29495e) {
                    add(
                        InlineV1CustomersSubscriptionsPostRequestFormTrialEndXcd857a9bBranch.InlineV1CustomersSubscriptionsPostRequestFormTrialEndAnyOf1X9c29495e,
                    )
                }
                if (inspection.matchesBranch2) {
                    add(
                        InlineV1CustomersSubscriptionsPostRequestFormTrialEndXcd857a9bBranch.Branch2,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1CustomersSubscriptionsPostRequestFormTrialEndXcd857a9b {
            val inspection = inspectInlineV1CustomersSubscriptionsPostRequestFormTrialEndXcd857a9b(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1CustomersSubscriptionsPostRequestFormTrialEndXcd857a9bNoMatchException(
                    "InlineV1CustomersSubscriptionsPostRequestFormTrialEndXcd857a9b matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1CustomersSubscriptionsPostRequestFormTrialEndXcd857a9b> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersSubscriptionsPostRequestFormTrialEndXcd857a9b,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1CustomersSubscriptionsPostRequestFormTrialEndXcd857a9b",
...
private fun inspectInlineV1CustomersSubscriptionsPostRequestFormTrialEndXcd857a9b(
    element: JsonElement,
): InlineV1CustomersSubscriptionsPostRequestFormTrialEndXcd857a9bInspection {
    val matchesInlineV1CustomersSubscriptionsPostRequestFormTrialEndAnyOf1X9c29495e =
        element
            .isJsonDecodable<InlineV1CustomersSubscriptionsPostRequestFormTrialEndAnyOf1X9c29495e>()
    ...
    return InlineV1CustomersSubscriptionsPostRequestFormTrialEndXcd857a9bInspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1CustomersSubscriptionsPostRequestFormTrialEndAnyOf1X9c29495e) {
                    add(
                        "InlineV1CustomersSubscriptionsPostRequestFormTrialEndAnyOf1X9c29495e: value does not match InlineV1CustomersSubscriptionsPostRequestFormTrialEndAnyOf1X9c29495e",
                    )
                }
