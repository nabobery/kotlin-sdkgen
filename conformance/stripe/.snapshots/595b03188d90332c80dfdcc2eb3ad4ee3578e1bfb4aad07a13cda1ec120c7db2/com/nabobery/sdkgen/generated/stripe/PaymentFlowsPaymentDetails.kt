...
public class PaymentFlowsPaymentDetails(
    ...
    public class Builder {
        ...
        public fun build(): PaymentFlowsPaymentDetails =
    ...
    public object Serializer : KSerializer<PaymentFlowsPaymentDetails> {
        ...
        override fun deserialize(decoder: Decoder): PaymentFlowsPaymentDetails {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentFlowsPaymentDetails must be a JSON object")
            return PaymentFlowsPaymentDetails(
                customerReference =
                    rawObject["customer_reference"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                orderReference =
                    rawObject["order_reference"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentFlowsPaymentDetails,
        ) {
...
public fun paymentFlowsPaymentDetails(
    block: PaymentFlowsPaymentDetails.Builder.() -> Unit,
): PaymentFlowsPaymentDetails = PaymentFlowsPaymentDetails.build(block)
