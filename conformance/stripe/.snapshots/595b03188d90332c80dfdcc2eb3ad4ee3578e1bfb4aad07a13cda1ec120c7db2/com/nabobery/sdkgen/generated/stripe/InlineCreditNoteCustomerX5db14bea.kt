...
public class InlineCreditNoteCustomerX5db14bea internal constructor(
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineCreditNoteCustomerX5db14bea {
            val inspection = inspectInlineCreditNoteCustomerX5db14bea(raw)
            if (inspection.matchCount == 0) {
                throw InlineCreditNoteCustomerX5db14beaNoMatchException(
                    "InlineCreditNoteCustomerX5db14bea matched 0 branches: " + inspection.failures.joinToString("; "),
                )
            }
    ...
    public object Serializer : KSerializer<InlineCreditNoteCustomerX5db14bea> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineCreditNoteCustomerX5db14bea,
        ) {
...
private fun inspectInlineCreditNoteCustomerX5db14bea(
    element: JsonElement,
): InlineCreditNoteCustomerX5db14beaInspection {
