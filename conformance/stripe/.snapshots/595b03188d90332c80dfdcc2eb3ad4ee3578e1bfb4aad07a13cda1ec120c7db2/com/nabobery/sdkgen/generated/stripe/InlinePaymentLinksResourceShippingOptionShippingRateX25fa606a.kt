...
public class InlinePaymentLinksResourceShippingOptionShippingRateX25fa606a internal constructor(
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlinePaymentLinksResourceShippingOptionShippingRateX25fa606aBranch.Branch1,
                    )
                }
                if (inspection.matchesShippingRate) {
                    add(
                        InlinePaymentLinksResourceShippingOptionShippingRateX25fa606aBranch.ShippingRate,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlinePaymentLinksResourceShippingOptionShippingRateX25fa606a {
            val inspection = inspectInlinePaymentLinksResourceShippingOptionShippingRateX25fa606a(raw)
            if (inspection.matchCount == 0) {
                throw InlinePaymentLinksResourceShippingOptionShippingRateX25fa606aNoMatchException(
                    "InlinePaymentLinksResourceShippingOptionShippingRateX25fa606a matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlinePaymentLinksResourceShippingOptionShippingRateX25fa606a> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentLinksResourceShippingOptionShippingRateX25fa606a,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlinePaymentLinksResourceShippingOptionShippingRateX25fa606a",
...
private fun inspectInlinePaymentLinksResourceShippingOptionShippingRateX25fa606a(
    element: JsonElement,
): InlinePaymentLinksResourceShippingOptionShippingRateX25fa606aInspection {
