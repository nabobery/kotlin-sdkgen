...
public class PaymentIntentNextActionDisplayOxxoDetails(
    ...
    public class Builder {
        ...
        public fun build(): PaymentIntentNextActionDisplayOxxoDetails =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentIntentNextActionDisplayOxxoDetails =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentIntentNextActionDisplayOxxoDetails> {
        ...
        override fun deserialize(decoder: Decoder): PaymentIntentNextActionDisplayOxxoDetails {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentIntentNextActionDisplayOxxoDetails must be a JSON object")
            return PaymentIntentNextActionDisplayOxxoDetails(
                expiresAfter =
                    rawObject["expires_after"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentIntentNextActionDisplayOxxoDetails,
        ) {
...
public fun paymentIntentNextActionDisplayOxxoDetails(
    block: PaymentIntentNextActionDisplayOxxoDetails.Builder.() -> Unit,
): PaymentIntentNextActionDisplayOxxoDetails = PaymentIntentNextActionDisplayOxxoDetails.build(block)
