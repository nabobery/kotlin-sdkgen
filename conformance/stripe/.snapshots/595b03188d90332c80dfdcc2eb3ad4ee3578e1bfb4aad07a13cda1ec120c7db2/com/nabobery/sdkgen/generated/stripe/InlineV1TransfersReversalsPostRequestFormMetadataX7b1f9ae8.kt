...
internal data class InlineV1TransfersReversalsPostRequestFormMetadataX7b1f9ae8Inspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1TransfersReversalsPostRequestFormMetadataAnyOf2X4ca854a2,
            ).count { it }
}
...
public class InlineV1TransfersReversalsPostRequestFormMetadataX7b1f9ae8 internal constructor(
    ...
    public val inlineV1TransfersReversalsPostRequestFormMetadataAnyOf2X4ca854a2:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1TransfersReversalsPostRequestFormMetadataAnyOf2X4ca854a2) {
                json
                    .decodeFromJsonElement<InlineV1TransfersReversalsPostRequestFormMetadataAnyOf2X4ca854a2>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1TransfersReversalsPostRequestFormMetadataX7b1f9ae8Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1TransfersReversalsPostRequestFormMetadataAnyOf2X4ca854a2) {
                    add(
                        InlineV1TransfersReversalsPostRequestFormMetadataX7b1f9ae8Branch.InlineV1TransfersReversalsPostRequestFormMetadataAnyOf2X4ca854a2,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1TransfersReversalsPostRequestFormMetadataX7b1f9ae8 {
            val inspection = inspectInlineV1TransfersReversalsPostRequestFormMetadataX7b1f9ae8(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1TransfersReversalsPostRequestFormMetadataX7b1f9ae8NoMatchException(
                    "InlineV1TransfersReversalsPostRequestFormMetadataX7b1f9ae8 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1TransfersReversalsPostRequestFormMetadataX7b1f9ae8> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TransfersReversalsPostRequestFormMetadataX7b1f9ae8,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1TransfersReversalsPostRequestFormMetadataX7b1f9ae8",
...
private fun inspectInlineV1TransfersReversalsPostRequestFormMetadataX7b1f9ae8(
    element: JsonElement,
): InlineV1TransfersReversalsPostRequestFormMetadataX7b1f9ae8Inspection {
    val matchesBranch1 = element.isJsonDecodable<JsonObject>()
    val matchesInlineV1TransfersReversalsPostRequestFormMetadataAnyOf2X4ca854a2 =
        element
            .isJsonDecodable<InlineV1TransfersReversalsPostRequestFormMetadataAnyOf2X4ca854a2>()
    return InlineV1TransfersReversalsPostRequestFormMetadataX7b1f9ae8Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1TransfersReversalsPostRequestFormMetadataAnyOf2X4ca854a2) {
                    add(
                        "InlineV1TransfersReversalsPostRequestFormMetadataAnyOf2X4ca854a2: value does not match InlineV1TransfersReversalsPostRequestFormMetadataAnyOf2X4ca854a2",
                    )
                }
            },
    )
