...
public class InlineInboundTransfersPaymentMethodDetailsUsBankAccountMandateX5ef0400d internal constructor(
    ...
    private val inspection: InlineInboundTransfersPaymentMethodDetailsUsBankAccountMandateX5ef0400dInspection,
) {
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineInboundTransfersPaymentMethodDetailsUsBankAccountMandateX5ef0400dBranch.Branch1,
                    )
                }
                if (inspection.matchesMandate) {
                    add(
                        InlineInboundTransfersPaymentMethodDetailsUsBankAccountMandateX5ef0400dBranch.Mandate,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineInboundTransfersPaymentMethodDetailsUsBankAccountMandateX5ef0400d {
            val inspection = inspectInlineInboundTransfersPaymentMethodDetailsUsBankAccountMandateX5ef0400d(raw)
            if (inspection.matchCount == 0) {
                throw InlineInboundTransfersPaymentMethodDetailsUsBankAccountMandateX5ef0400dNoMatchException(
                    "InlineInboundTransfersPaymentMethodDetailsUsBankAccountMandateX5ef0400d matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineInboundTransfersPaymentMethodDetailsUsBankAccountMandateX5ef0400d> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineInboundTransfersPaymentMethodDetailsUsBankAccountMandateX5ef0400d,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineInboundTransfersPaymentMethodDetailsUsBankAccountMandateX5ef0400d",
...
private fun inspectInlineInboundTransfersPaymentMethodDetailsUsBankAccountMandateX5ef0400d(
    element: JsonElement,
