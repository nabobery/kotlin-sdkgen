...
public class InlineV1InvoiceRenderingTemplatesGetResponse200JsonX6f23f981(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1InvoiceRenderingTemplatesGetResponse200JsonX6f23f981 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1InvoiceRenderingTemplatesGetResponse200JsonX6f23f981> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1InvoiceRenderingTemplatesGetResponse200JsonX6f23f981 {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1InvoiceRenderingTemplatesGetResponse200JsonX6f23f981 must be a JSON object",
                    )
            ...
            val objectValue =
                json.decodeRequired<InlineV1InvoiceRenderingTemplatesGetResponse200JsonObjectValueXff003a9d>(
                    rawObject,
                    "object",
                )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoiceRenderingTemplatesGetResponse200JsonX6f23f981,
        ) {
...
public fun inlineV1InvoiceRenderingTemplatesGetResponse200JsonX6f23f981(
    block: InlineV1InvoiceRenderingTemplatesGetResponse200JsonX6f23f981.Builder.() -> Unit,
): InlineV1InvoiceRenderingTemplatesGetResponse200JsonX6f23f981 =
    InlineV1InvoiceRenderingTemplatesGetResponse200JsonX6f23f981.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1InvoiceRenderingTemplatesGetResponse200JsonX6f23f981 is missing required property '" + name +
                    "'",
            )
