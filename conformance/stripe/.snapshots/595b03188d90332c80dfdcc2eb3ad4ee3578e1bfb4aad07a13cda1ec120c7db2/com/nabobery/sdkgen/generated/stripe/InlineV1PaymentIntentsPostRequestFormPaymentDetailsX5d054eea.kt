...
internal data class InlineV1PaymentIntentsPostRequestFormPaymentDetailsX5d054eeaInspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesInlineV1PaymentIntentsPostRequestFormPaymentDetailsAnyOf1X8561e548,
                matchesInlineV1PaymentIntentsPostRequestFormPaymentDetailsAnyOf2X6857f80a,
            ).count {
                it
            }
}
...
public class InlineV1PaymentIntentsPostRequestFormPaymentDetailsX5d054eea internal constructor(
    ...
    public val inlineV1PaymentIntentsPostRequestFormPaymentDetailsAnyOf1X8561e548:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1PaymentIntentsPostRequestFormPaymentDetailsAnyOf1X8561e548) {
                json
                    .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentDetailsAnyOf1X8561e548>(
                        raw,
                    )
            } else {
                null
    ...
    public val inlineV1PaymentIntentsPostRequestFormPaymentDetailsAnyOf2X6857f80a:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1PaymentIntentsPostRequestFormPaymentDetailsAnyOf2X6857f80a) {
                json
                    .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentDetailsAnyOf2X6857f80a>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches:
        ...
        get() =
            buildSet {
                if (inspection.matchesInlineV1PaymentIntentsPostRequestFormPaymentDetailsAnyOf1X8561e548) {
                    add(
                        InlineV1PaymentIntentsPostRequestFormPaymentDetailsX5d054eeaBranch.InlineV1PaymentIntentsPostRequestFormPaymentDetailsAnyOf1X8561e548,
                    )
                }
                if (inspection.matchesInlineV1PaymentIntentsPostRequestFormPaymentDetailsAnyOf2X6857f80a) {
                    add(
                        InlineV1PaymentIntentsPostRequestFormPaymentDetailsX5d054eeaBranch.InlineV1PaymentIntentsPostRequestFormPaymentDetailsAnyOf2X6857f80a,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1PaymentIntentsPostRequestFormPaymentDetailsX5d054eea {
            val inspection = inspectInlineV1PaymentIntentsPostRequestFormPaymentDetailsX5d054eea(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1PaymentIntentsPostRequestFormPaymentDetailsX5d054eeaNoMatchException(
                    "InlineV1PaymentIntentsPostRequestFormPaymentDetailsX5d054eea matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormPaymentDetailsX5d054eea> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormPaymentDetailsX5d054eea,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1PaymentIntentsPostRequestFormPaymentDetailsX5d054eea",
...
private fun inspectInlineV1PaymentIntentsPostRequestFormPaymentDetailsX5d054eea(
    element: JsonElement,
): InlineV1PaymentIntentsPostRequestFormPaymentDetailsX5d054eeaInspection {
    val matchesInlineV1PaymentIntentsPostRequestFormPaymentDetailsAnyOf1X8561e548 =
        element
            .isJsonDecodable<InlineV1PaymentIntentsPostRequestFormPaymentDetailsAnyOf1X8561e548>()
    val matchesInlineV1PaymentIntentsPostRequestFormPaymentDetailsAnyOf2X6857f80a =
        element
            .isJsonDecodable<InlineV1PaymentIntentsPostRequestFormPaymentDetailsAnyOf2X6857f80a>()
    return InlineV1PaymentIntentsPostRequestFormPaymentDetailsX5d054eeaInspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1PaymentIntentsPostRequestFormPaymentDetailsAnyOf1X8561e548) {
                    add(
                        "InlineV1PaymentIntentsPostRequestFormPaymentDetailsAnyOf1X8561e548: value does not match InlineV1PaymentIntentsPostRequestFormPaymentDetailsAnyOf1X8561e548",
                    )
                }
                if (!matchesInlineV1PaymentIntentsPostRequestFormPaymentDetailsAnyOf2X6857f80a) {
                    add(
                        "InlineV1PaymentIntentsPostRequestFormPaymentDetailsAnyOf2X6857f80a: value does not match InlineV1PaymentIntentsPostRequestFormPaymentDetailsAnyOf2X6857f80a",
                    )
                }
            },
    )
