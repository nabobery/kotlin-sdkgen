...
public sealed class InlineIssuingAuthorizationVerificationDataAddressLine1CheckX57911368 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineIssuingAuthorizationVerificationDataAddressLine1CheckX57911368 =
            when (value) {
                Match.value -> Match
    ...
    public object Serializer : KSerializer<InlineIssuingAuthorizationVerificationDataAddressLine1CheckX57911368> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineIssuingAuthorizationVerificationDataAddressLine1CheckX57911368",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineIssuingAuthorizationVerificationDataAddressLine1CheckX57911368 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineIssuingAuthorizationVerificationDataAddressLine1CheckX57911368,
        ) {
