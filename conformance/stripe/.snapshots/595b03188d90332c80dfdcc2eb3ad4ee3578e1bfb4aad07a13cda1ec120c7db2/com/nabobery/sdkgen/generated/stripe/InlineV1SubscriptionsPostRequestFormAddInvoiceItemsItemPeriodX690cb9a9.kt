...
public class InlineV1SubscriptionsPostRequestFormAddInvoiceItemsItemPeriodX690cb9a9(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1SubscriptionsPostRequestFormAddInvoiceItemsItemPeriodX690cb9a9 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1SubscriptionsPostRequestFormAddInvoiceItemsItemPeriodX690cb9a9> {
        override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1SubscriptionsPostRequestFormAddInvoiceItemsItemPeriodX690cb9a9 {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SubscriptionsPostRequestFormAddInvoiceItemsItemPeriodX690cb9a9 must be a JSON object",
                    )
            val end =
                json.decodeRequired<InlineV1SubscriptionsPostRequestFormAddInvoiceItemsItemPeriodEndX164dc3c3>(
                    rawObject,
                    "end",
                )
            val start =
                json.decodeRequired<InlineV1SubscriptionsPostRequestFormAddInvoiceItemsItemPeriodStartXb25e9b7c>(
                    rawObject,
                    "start",
                )
            return InlineV1SubscriptionsPostRequestFormAddInvoiceItemsItemPeriodX690cb9a9(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsPostRequestFormAddInvoiceItemsItemPeriodX690cb9a9,
        ) {
            val jsonEncoder =
...
public fun inlineV1SubscriptionsPostRequestFormAddInvoiceItemsItemPeriodX690cb9a9(
    block: InlineV1SubscriptionsPostRequestFormAddInvoiceItemsItemPeriodX690cb9a9.Builder.() -> Unit,
): InlineV1SubscriptionsPostRequestFormAddInvoiceItemsItemPeriodX690cb9a9 =
    InlineV1SubscriptionsPostRequestFormAddInvoiceItemsItemPeriodX690cb9a9.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1SubscriptionsPostRequestFormAddInvoiceItemsItemPeriodX690cb9a9 is missing required property '" +
                    name +
                    "'",
            )
