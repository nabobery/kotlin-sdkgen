...
public sealed class InlineV1SourcesPostRequestFormMandateIntervalX63e53acc {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1SourcesPostRequestFormMandateIntervalX63e53acc =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1SourcesPostRequestFormMandateIntervalX63e53acc> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1SourcesPostRequestFormMandateIntervalX63e53acc",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1SourcesPostRequestFormMandateIntervalX63e53acc =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SourcesPostRequestFormMandateIntervalX63e53acc,
        ) {
