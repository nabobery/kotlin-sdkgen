...
public class InlineTreasuryOutboundTransfersResourceReturnedDetailsTransactionX427e24ee internal constructor(
    ...
    private val inspection: InlineTreasuryOutboundTransfersResourceReturnedDetailsTransactionX427e24eeInspection,
) {
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineTreasuryOutboundTransfersResourceReturnedDetailsTransactionX427e24eeBranch.Branch1,
                    )
                }
                if (inspection.matchesTreasuryTransaction) {
                    add(
                        InlineTreasuryOutboundTransfersResourceReturnedDetailsTransactionX427e24eeBranch.TreasuryTransaction,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            ...
            if (inspection.matchCount == 0) {
                throw InlineTreasuryOutboundTransfersResourceReturnedDetailsTransactionX427e24eeNoMatchException(
                    "InlineTreasuryOutboundTransfersResourceReturnedDetailsTransactionX427e24ee matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineTreasuryOutboundTransfersResourceReturnedDetailsTransactionX427e24ee> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineTreasuryOutboundTransfersResourceReturnedDetailsTransactionX427e24ee,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineTreasuryOutboundTransfersResourceReturnedDetailsTransactionX427e24ee",
...
private fun inspectInlineTreasuryOutboundTransfersResourceReturnedDetailsTransactionX427e24ee(
    element: JsonElement,
