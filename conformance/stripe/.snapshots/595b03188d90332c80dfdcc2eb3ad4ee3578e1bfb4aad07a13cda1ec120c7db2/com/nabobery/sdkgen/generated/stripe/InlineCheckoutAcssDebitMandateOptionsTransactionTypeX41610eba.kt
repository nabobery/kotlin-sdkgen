...
public sealed class InlineCheckoutAcssDebitMandateOptionsTransactionTypeX41610eba {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineCheckoutAcssDebitMandateOptionsTransactionTypeX41610eba =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineCheckoutAcssDebitMandateOptionsTransactionTypeX41610eba> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineCheckoutAcssDebitMandateOptionsTransactionTypeX41610eba",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineCheckoutAcssDebitMandateOptionsTransactionTypeX41610eba =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineCheckoutAcssDebitMandateOptionsTransactionTypeX41610eba,
        ) {
