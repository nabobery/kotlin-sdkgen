...
public class InlineTerminalReaderReaderResourceRefundPaymentActionRefundX0671899e internal constructor(
    ...
    private val inspection: InlineTerminalReaderReaderResourceRefundPaymentActionRefundX0671899eInspection,
) {
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineTerminalReaderReaderResourceRefundPaymentActionRefundX0671899eBranch.Branch1,
                    )
                }
                if (inspection.matchesRefund) {
                    add(
                        InlineTerminalReaderReaderResourceRefundPaymentActionRefundX0671899eBranch.Refund,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineTerminalReaderReaderResourceRefundPaymentActionRefundX0671899e {
            val inspection = inspectInlineTerminalReaderReaderResourceRefundPaymentActionRefundX0671899e(raw)
            if (inspection.matchCount == 0) {
                throw InlineTerminalReaderReaderResourceRefundPaymentActionRefundX0671899eNoMatchException(
                    "InlineTerminalReaderReaderResourceRefundPaymentActionRefundX0671899e matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineTerminalReaderReaderResourceRefundPaymentActionRefundX0671899e> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineTerminalReaderReaderResourceRefundPaymentActionRefundX0671899e,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineTerminalReaderReaderResourceRefundPaymentActionRefundX0671899e",
...
private fun inspectInlineTerminalReaderReaderResourceRefundPaymentActionRefundX0671899e(
    element: JsonElement,
