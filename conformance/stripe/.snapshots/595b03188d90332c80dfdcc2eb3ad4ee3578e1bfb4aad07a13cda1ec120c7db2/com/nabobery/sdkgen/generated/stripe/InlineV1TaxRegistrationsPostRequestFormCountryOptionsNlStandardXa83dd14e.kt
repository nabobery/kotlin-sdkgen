...
public class InlineV1TaxRegistrationsPostRequestFormCountryOptionsNlStandardXa83dd14e(
    public val placeOfSupplyScheme: InlineV1TaxRegistrationsPostRequestFormPlaceOfSupplySchemeX7bd280fc,
) {
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1TaxRegistrationsPostRequestFormCountryOptionsNlStandardXa83dd14e = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1TaxRegistrationsPostRequestFormCountryOptionsNlStandardXa83dd14e> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TaxRegistrationsPostRequestFormCountryOptionsNlStandardXa83dd14e must be a JSON object",
                    )
            val placeOfSupplyScheme =
                json
                    .decodeRequired<InlineV1TaxRegistrationsPostRequestFormPlaceOfSupplySchemeX7bd280fc>(
                        rawObject,
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TaxRegistrationsPostRequestFormCountryOptionsNlStandardXa83dd14e,
        ) {
            val jsonEncoder =
...
public fun inlineV1TaxRegistrationsPostRequestFormCountryOptionsNlStandardXa83dd14e(
    block: InlineV1TaxRegistrationsPostRequestFormCountryOptionsNlStandardXa83dd14e.Builder.() -> Unit,
): InlineV1TaxRegistrationsPostRequestFormCountryOptionsNlStandardXa83dd14e =
    InlineV1TaxRegistrationsPostRequestFormCountryOptionsNlStandardXa83dd14e.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TaxRegistrationsPostRequestFormCountryOptionsNlStandardXa83dd14e is missing required property '" +
                    name +
                    "'",
            )
