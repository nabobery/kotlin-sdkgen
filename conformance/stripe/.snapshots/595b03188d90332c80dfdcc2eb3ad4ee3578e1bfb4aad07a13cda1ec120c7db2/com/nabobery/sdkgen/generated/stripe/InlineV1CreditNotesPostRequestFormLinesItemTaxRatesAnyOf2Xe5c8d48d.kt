...
public sealed class InlineV1CreditNotesPostRequestFormLinesItemTaxRatesAnyOf2Xe5c8d48d {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1CreditNotesPostRequestFormLinesItemTaxRatesAnyOf2Xe5c8d48d =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1CreditNotesPostRequestFormLinesItemTaxRatesAnyOf2Xe5c8d48d> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1CreditNotesPostRequestFormLinesItemTaxRatesAnyOf2Xe5c8d48d",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1CreditNotesPostRequestFormLinesItemTaxRatesAnyOf2Xe5c8d48d =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CreditNotesPostRequestFormLinesItemTaxRatesAnyOf2Xe5c8d48d,
        ) {
