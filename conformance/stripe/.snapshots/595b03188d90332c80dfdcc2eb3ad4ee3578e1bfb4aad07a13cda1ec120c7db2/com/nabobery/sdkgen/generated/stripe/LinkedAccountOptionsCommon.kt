...
public class LinkedAccountOptionsCommon(
    public val filters: PaymentFlowsPrivatePaymentMethodsFinancialConnectionsCommonLinkedAccountOptionsFilters? = null,
    /**
     * The list of permissions to request. The `payment_method` permission must be included.
     */
    public val permissions: List<InlineLinkedAccountOptionsCommonPermissionsItemX23a646ba>? = null,
    /**
     * Data features requested to be retrieved upon account creation.
     */
    public val prefetch: List<InlineLinkedAccountOptionsCommonPrefetchItemX42e66787>? = null,
    /**
    ...
    public class Builder {
         ...
         * The list of permissions to request. The `payment_method` permission must be included.
         */
        public var permissions: List<InlineLinkedAccountOptionsCommonPermissionsItemX23a646ba>? = null

        /**
         * Data features requested to be retrieved upon account creation.
         */
        public var prefetch: List<InlineLinkedAccountOptionsCommonPrefetchItemX42e66787>? = null
        ...
        public fun build(): LinkedAccountOptionsCommon =
    ...
    public object Serializer : KSerializer<LinkedAccountOptionsCommon> {
        ...
        override fun deserialize(decoder: Decoder): LinkedAccountOptionsCommon {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("LinkedAccountOptionsCommon must be a JSON object")
            return LinkedAccountOptionsCommon(
                filters =
                    rawObject["filters"]?.let {
                        json
                            .decodeFromJsonElement<PaymentFlowsPrivatePaymentMethodsFinancialConnectionsCommonLinkedAccountOptionsFilters>(
                                it,
                            )
                    },
                permissions =
                    rawObject["permissions"]?.let {
                        json.decodeFromJsonElement<List<InlineLinkedAccountOptionsCommonPermissionsItemX23a646ba>>(it)
                    },
                prefetch =
                    rawObject["prefetch"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<List<InlineLinkedAccountOptionsCommonPrefetchItemX42e66787>?>(
                                element,
                            )
                        }
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: LinkedAccountOptionsCommon,
        ) {
...
public fun linkedAccountOptionsCommon(
    block: LinkedAccountOptionsCommon.Builder.() -> Unit,
): LinkedAccountOptionsCommon = LinkedAccountOptionsCommon.build(block)
