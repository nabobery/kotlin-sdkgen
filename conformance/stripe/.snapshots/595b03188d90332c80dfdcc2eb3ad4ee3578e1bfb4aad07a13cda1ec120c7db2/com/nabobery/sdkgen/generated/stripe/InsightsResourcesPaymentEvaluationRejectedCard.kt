...
public class InsightsResourcesPaymentEvaluationRejectedCard(
     ...
     */
    public val addressLine1Check: InlineInsightsResourcesPaymentEvaluationRejectedCardAddressLine1CheckXf806d275,
    /**
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InsightsResourcesPaymentEvaluationRejectedCard =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InsightsResourcesPaymentEvaluationRejectedCard> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InsightsResourcesPaymentEvaluationRejectedCard must be a JSON object",
                    )
            val addressLine1Check =
                json
                    .decodeRequired<InlineInsightsResourcesPaymentEvaluationRejectedCardAddressLine1CheckXf806d275>(
                        rawObject,
                        "address_line1_check",
                    )
            val addressPostalCodeCheck =
                json.decodeRequired<InlineInsightsResourcesPayd3e6AddressPostalCodeCheckXc9bbccff>(
                    rawObject,
                    "address_postal_code_check",
                )
            val cvcCheck =
                json.decodeRequired<InlineInsightsResourcesPaymentEvaluationRejectedCardCvcCheckX24884422>(
                    rawObject,
                    "cvc_check",
                )
            val reason =
                json.decodeRequired<InlineInsightsResourcesPaymentEvaluationRejectedCardReasonX717e3efa>(
                    rawObject,
                    "reason",
                )
            return InsightsResourcesPaymentEvaluationRejectedCard(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InsightsResourcesPaymentEvaluationRejectedCard,
        ) {
...
public fun insightsResourcesPaymentEvaluationRejectedCard(
    block: InsightsResourcesPaymentEvaluationRejectedCard.Builder.() -> Unit,
): InsightsResourcesPaymentEvaluationRejectedCard = InsightsResourcesPaymentEvaluationRejectedCard.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InsightsResourcesPaymentEvaluationRejectedCard is missing required property '" + name + "'",
            )
