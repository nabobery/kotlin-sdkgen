...
public sealed class InlineIssuingTokenNetworkXbda36374 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineIssuingTokenNetworkXbda36374 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineIssuingTokenNetworkXbda36374> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineIssuingTokenNetworkXbda36374",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineIssuingTokenNetworkXbda36374 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineIssuingTokenNetworkXbda36374,
        ) {
