...
internal data class InlineV1DisputesPostRequestFormEvidenceProductDescriptionX5804eebaInspection(
    ...
    public val matchesInlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2X802f997c: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2X802f997c,
            ).count {
                it
            }
}
...
public class InlineV1DisputesPostRequestFormEvidenceProductDescriptionX5804eeba internal constructor(
    ...
    private val inspection: InlineV1DisputesPostRequestFormEvidenceProductDescriptionX5804eebaInspection,
) {
    ...
    public val inlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2X802f997c:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2X802f997c) {
                json
                    .decodeFromJsonElement<InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2X802f997c>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1DisputesPostRequestFormEvidenceProductDescriptionX5804eebaBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2X802f997c) {
                    add(
                        InlineV1DisputesPostRequestFormEvidenceProductDescriptionX5804eebaBranch.InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2X802f997c,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1DisputesPostRequestFormEvidenceProductDescriptionX5804eeba {
            val inspection = inspectInlineV1DisputesPostRequestFormEvidenceProductDescriptionX5804eeba(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1DisputesPostRequestFormEvidenceProductDescriptionX5804eebaNoMatchException(
                    "InlineV1DisputesPostRequestFormEvidenceProductDescriptionX5804eeba matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1DisputesPostRequestFormEvidenceProductDescriptionX5804eeba> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1DisputesPostRequestFormEvidenceProductDescriptionX5804eeba,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1DisputesPostRequestFormEvidenceProductDescriptionX5804eeba",
...
private fun inspectInlineV1DisputesPostRequestFormEvidenceProductDescriptionX5804eeba(
    element: JsonElement,
): InlineV1DisputesPostRequestFormEvidenceProductDescriptionX5804eebaInspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2X802f997c =
        element
            .isJsonDecodable<InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2X802f997c>()
    return InlineV1DisputesPostRequestFormEvidenceProductDescriptionX5804eebaInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2X802f997c) {
                    add(
                        "InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2X802f997c: value does not match InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2X802f997c",
                    )
                }
            },
    )
