...
public sealed class InlinePersonEthnicityDetailsEthnicityItemXc712579b {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePersonEthnicityDetailsEthnicityItemXc712579b =
            when (value) {
                Cuban.value -> Cuban
    ...
    public object Serializer : KSerializer<InlinePersonEthnicityDetailsEthnicityItemXc712579b> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePersonEthnicityDetailsEthnicityItemXc712579b",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePersonEthnicityDetailsEthnicityItemXc712579b =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePersonEthnicityDetailsEthnicityItemXc712579b,
        ) {
