...
public class InlineV1TaxRegistrationsPostRequestFormCountryOptionsFiX473f840a(
    ...
    public val standard: InlineV1TaxRegistrationsPostRequestFormCountryOptionsFiStandardX71598615? = null,
) {
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TaxRegistrationsPostRequestFormCountryOptionsFiX473f840a =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TaxRegistrationsPostRequestFormCountryOptionsFiX473f840a> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1TaxRegistrationsPostRequestFormCountryOptionsFiX473f840a {
            val jsonDecoder =
                decoder.requireJsonDecoder(
                    "InlineV1TaxRegistrationsPostRequestFormCountryOptionsFiX473f840a",
                )
            val json = jsonDecoder.json
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TaxRegistrationsPostRequestFormCountryOptionsFiX473f840a must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineV1TaxRegistrationsPostRequestFormCountryOptionsFiTypeXd8667167>(
                    rawObject,
                    "type",
                )
            return InlineV1TaxRegistrationsPostRequestFormCountryOptionsFiX473f840a(
                ...
                standard =
                    rawObject["standard"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsFiStandardX71598615>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TaxRegistrationsPostRequestFormCountryOptionsFiX473f840a,
        ) {
            val jsonEncoder =
...
public fun inlineV1TaxRegistrationsPostRequestFormCountryOptionsFiX473f840a(
    block: InlineV1TaxRegistrationsPostRequestFormCountryOptionsFiX473f840a.Builder.() -> Unit,
): InlineV1TaxRegistrationsPostRequestFormCountryOptionsFiX473f840a =
    InlineV1TaxRegistrationsPostRequestFormCountryOptionsFiX473f840a.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TaxRegistrationsPostRequestFormCountryOptionsFiX473f840a is missing required property '" + name +
                    "'",
            )
