...
public class TerminalOnboardingLinkAppleTermsAndConditions(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): TerminalOnboardingLinkAppleTermsAndConditions =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<TerminalOnboardingLinkAppleTermsAndConditions> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "TerminalOnboardingLinkAppleTermsAndConditions must be a JSON object",
                    )
            val merchantDisplayName = json.decodeRequired<String>(rawObject, "merchant_display_name")
            return TerminalOnboardingLinkAppleTermsAndConditions(
                merchantDisplayName = merchantDisplayName,
                allowRelinking =
                    rawObject["allow_relinking"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: TerminalOnboardingLinkAppleTermsAndConditions,
        ) {
...
public fun terminalOnboardingLinkAppleTermsAndConditions(
    block: TerminalOnboardingLinkAppleTermsAndConditions.Builder.() -> Unit,
): TerminalOnboardingLinkAppleTermsAndConditions = TerminalOnboardingLinkAppleTermsAndConditions.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "TerminalOnboardingLinkAppleTermsAndConditions is missing required property '" + name + "'",
            )
