...
public sealed class InlineV1InvoicesPostRequestFormRenderingPdfPageSizeX08fb3390 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1InvoicesPostRequestFormRenderingPdfPageSizeX08fb3390 =
            when (value) {
                A4.value -> A4
                Auto.value -> Auto
                Letter.value -> Letter
    ...
    public object Serializer : KSerializer<InlineV1InvoicesPostRequestFormRenderingPdfPageSizeX08fb3390> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1InvoicesPostRequestFormRenderingPdfPageSizeX08fb3390",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1InvoicesPostRequestFormRenderingPdfPageSizeX08fb3390 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesPostRequestFormRenderingPdfPageSizeX08fb3390,
        ) {
