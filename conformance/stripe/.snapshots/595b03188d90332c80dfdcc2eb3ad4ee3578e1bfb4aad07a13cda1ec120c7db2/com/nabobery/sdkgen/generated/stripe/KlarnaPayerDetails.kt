...
public class KlarnaPayerDetails(
    ...
    public class Builder {
        ...
        public fun build(): KlarnaPayerDetails =
            KlarnaPayerDetails(
                address = address,
            )
    }
    ...
    public object Serializer : KSerializer<KlarnaPayerDetails> {
        ...
        override fun deserialize(decoder: Decoder): KlarnaPayerDetails {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("KlarnaPayerDetails must be a JSON object")
                ...
                address =
                    rawObject["address"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineKlarnaPayerDetailsAddressXf6d978be?>(element)
                        }
                    },
            )
        }
...
public fun klarnaPayerDetails(block: KlarnaPayerDetails.Builder.() -> Unit): KlarnaPayerDetails =
    KlarnaPayerDetails.build(block)
