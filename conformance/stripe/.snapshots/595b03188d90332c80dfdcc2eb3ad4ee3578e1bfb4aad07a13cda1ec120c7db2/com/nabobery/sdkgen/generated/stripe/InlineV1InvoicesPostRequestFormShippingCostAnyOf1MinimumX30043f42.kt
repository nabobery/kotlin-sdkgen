...
public class InlineV1InvoicesPostRequestFormShippingCostAnyOf1MinimumX30043f42(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1InvoicesPostRequestFormShippingCostAnyOf1MinimumX30043f42 =
    ...
    public object Serializer : KSerializer<InlineV1InvoicesPostRequestFormShippingCostAnyOf1MinimumX30043f42> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1InvoicesPostRequestFormShippingCostAnyOf1MinimumX30043f42 {
            val jsonDecoder =
                decoder.requireJsonDecoder(
                    "InlineV1InvoicesPostRequestFormShippingCostAnyOf1MinimumX30043f42",
                )
            val json = jsonDecoder.json
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1InvoicesPostRequestFormShippingCostAnyOf1MinimumX30043f42 must be a JSON object",
                    )
            val unit =
                json.decodeRequired<InlineV1InvoicesPostRequestFormShippingCostAnyOf1ShippingRateDataUnitXb4dc372c>(
                    rawObject,
                    "unit",
                )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesPostRequestFormShippingCostAnyOf1MinimumX30043f42,
        ) {
            val jsonEncoder =
...
public fun inlineV1InvoicesPostRequestFormShippingCostAnyOf1MinimumX30043f42(
    block: InlineV1InvoicesPostRequestFormShippingCostAnyOf1MinimumX30043f42.Builder.() -> Unit,
): InlineV1InvoicesPostRequestFormShippingCostAnyOf1MinimumX30043f42 =
    InlineV1InvoicesPostRequestFormShippingCostAnyOf1MinimumX30043f42.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1InvoicesPostRequestFormShippingCostAnyOf1MinimumX30043f42 is missing required property '" +
                    name +
                    "'",
            )
