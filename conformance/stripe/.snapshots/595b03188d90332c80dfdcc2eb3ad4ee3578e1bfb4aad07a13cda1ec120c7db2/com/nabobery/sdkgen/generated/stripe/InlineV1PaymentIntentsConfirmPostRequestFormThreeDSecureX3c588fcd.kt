...
public class InlineV1PaymentIntentsConfirmPostRequestFormThreeDSecureX3c588fcd(
    ...
    public val version: InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsVersionX714e6190,
    public val aresTransStatus: InlineV1PaymentIntentsConfirmPostRequestFormAresTransStatusX84aa416d? = null,
    public val electronicCommerceIndicator:
        InlineV1PaymentIntentsConfirmPostRequestFormElectronicCommerceIn67d5X85ce330a? = null,
    public val exemptionIndicator: InlineV1PaymentIntentsConfirmPostRequestFormExemptionIndicatorX526276b1? = null,
    public val networkOptions: InlineV1PaymentIntentsConfirmPostRequestFormNetworkOptionsX207460ac? = null,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PaymentIntentsConfirmPostRequestFormThreeDSecureX3c588fcd =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentIntentsConfirmPostRequestFormThreeDSecureX3c588fcd> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1PaymentIntentsConfirmPostRequestFormThreeDSecureX3c588fcd {
            val jsonDecoder =
                decoder.requireJsonDecoder(
                    "InlineV1PaymentIntentsConfirmPostRequestFormThreeDSecureX3c588fcd",
                )
            val json = jsonDecoder.json
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsConfirmPostRequestFormThreeDSecureX3c588fcd must be a JSON object",
                    )
            ...
            val version =
                json
                    .decodeRequired<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsVersionX714e6190>(
                        rawObject,
                        "version",
                    )
            return InlineV1PaymentIntentsConfirmPostRequestFormThreeDSecureX3c588fcd(
                ...
                aresTransStatus =
                    rawObject["ares_trans_status"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormAresTransStatusX84aa416d>(
                                it,
                            )
                    },
                electronicCommerceIndicator =
                    rawObject["electronic_commerce_indicator"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormElectronicCommerceIn67d5X85ce330a>(
                                it,
                            )
                    },
                exemptionIndicator =
                    rawObject["exemption_indicator"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormExemptionIndicatorX526276b1>(
                                it,
                            )
                    },
                networkOptions =
                    rawObject["network_options"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormNetworkOptionsX207460ac>(
                            it,
                        )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsConfirmPostRequestFormThreeDSecureX3c588fcd,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentIntentsConfirmPostRequestFormThreeDSecureX3c588fcd(
    block: InlineV1PaymentIntentsConfirmPostRequestFormThreeDSecureX3c588fcd.Builder.() -> Unit,
): InlineV1PaymentIntentsConfirmPostRequestFormThreeDSecureX3c588fcd =
    InlineV1PaymentIntentsConfirmPostRequestFormThreeDSecureX3c588fcd.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentIntentsConfirmPostRequestFormThreeDSecureX3c588fcd is missing required property '" +
                    name +
                    "'",
            )
