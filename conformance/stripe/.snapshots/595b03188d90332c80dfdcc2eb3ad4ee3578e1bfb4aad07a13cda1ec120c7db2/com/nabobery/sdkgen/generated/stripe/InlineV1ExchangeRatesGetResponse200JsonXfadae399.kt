...
public class InlineV1ExchangeRatesGetResponse200JsonXfadae399(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1ExchangeRatesGetResponse200JsonXfadae399 =
    ...
    public object Serializer : KSerializer<InlineV1ExchangeRatesGetResponse200JsonXfadae399> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1ExchangeRatesGetResponse200JsonXfadae399 must be a JSON object",
                    )
            val data = json.decodeRequired<List<ExchangeRate>>(rawObject, "data")
            val hasMore = json.decodeRequired<Boolean>(rawObject, "has_more")
            val objectValue =
                json.decodeRequired<InlineV1ExchangeRatesGetResponse200JsonObjectValueX3e9589d1>(
                    rawObject,
                    "object",
                )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ExchangeRatesGetResponse200JsonXfadae399,
        ) {
...
public fun inlineV1ExchangeRatesGetResponse200JsonXfadae399(
    block: InlineV1ExchangeRatesGetResponse200JsonXfadae399.Builder.() -> Unit,
): InlineV1ExchangeRatesGetResponse200JsonXfadae399 = InlineV1ExchangeRatesGetResponse200JsonXfadae399.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1ExchangeRatesGetResponse200JsonXfadae399 is missing required property '" + name + "'",
            )
