...
internal data class InlineV1SubscriptionsPostRequestFormPaymentSettingsKonbiniXd7207a32Inspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2X58a25e4c,
            ).count { it }
}
...
public class InlineV1SubscriptionsPostRequestFormPaymentSettingsKonbiniXd7207a32 internal constructor(
    ...
    private val inspection: InlineV1SubscriptionsPostRequestFormPaymentSettingsKonbiniXd7207a32Inspection,
) {
    ...
    public val inlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2X58a25e4c:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2X58a25e4c) {
                json
                    .decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2X58a25e4c>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1SubscriptionsPostRequestFormPaymentSettingsKonbiniXd7207a32Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2X58a25e4c) {
                    add(
                        InlineV1SubscriptionsPostRequestFormPaymentSettingsKonbiniXd7207a32Branch.InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2X58a25e4c,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1SubscriptionsPostRequestFormPaymentSettingsKonbiniXd7207a32 {
            val inspection = inspectInlineV1SubscriptionsPostRequestFormPaymentSettingsKonbiniXd7207a32(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1SubscriptionsPostRequestFormPaymentSettingsKonbiniXd7207a32NoMatchException(
                    "InlineV1SubscriptionsPostRequestFormPaymentSettingsKonbiniXd7207a32 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionsPostRequestFormPaymentSettingsKonbiniXd7207a32> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsPostRequestFormPaymentSettingsKonbiniXd7207a32,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1SubscriptionsPostRequestFormPaymentSettingsKonbiniXd7207a32",
...
private fun inspectInlineV1SubscriptionsPostRequestFormPaymentSettingsKonbiniXd7207a32(
    element: JsonElement,
): InlineV1SubscriptionsPostRequestFormPaymentSettingsKonbiniXd7207a32Inspection {
    val matchesBranch1 = element.isJsonDecodable<JsonObject>()
    val matchesInlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2X58a25e4c =
        element
            .isJsonDecodable<InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2X58a25e4c>()
    return InlineV1SubscriptionsPostRequestFormPaymentSettingsKonbiniXd7207a32Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2X58a25e4c) {
                    add(
                        "InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2X58a25e4c: value does not match InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2X58a25e4c",
                    )
                }
            },
    )
