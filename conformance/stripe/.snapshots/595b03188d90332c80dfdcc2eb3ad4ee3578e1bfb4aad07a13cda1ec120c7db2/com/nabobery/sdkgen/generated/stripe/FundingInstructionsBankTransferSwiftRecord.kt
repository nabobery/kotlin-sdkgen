...
public class FundingInstructionsBankTransferSwiftRecord(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): FundingInstructionsBankTransferSwiftRecord =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<FundingInstructionsBankTransferSwiftRecord> {
        ...
        override fun deserialize(decoder: Decoder): FundingInstructionsBankTransferSwiftRecord {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("FundingInstructionsBankTransferSwiftRecord must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: FundingInstructionsBankTransferSwiftRecord,
        ) {
...
public fun fundingInstructionsBankTransferSwiftRecord(
    block: FundingInstructionsBankTransferSwiftRecord.Builder.() -> Unit,
): FundingInstructionsBankTransferSwiftRecord = FundingInstructionsBankTransferSwiftRecord.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "FundingInstructionsBankTransferSwiftRecord is missing required property '" + name + "'",
            )
