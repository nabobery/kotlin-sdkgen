...
public class InlineV1SubscriptionSchedulesPostRequestFormPhasesItemAutomaticTaxX34087348(
    ...
    public val liability: InlineV1SubscriptionSchedulesPostRequestFormPhasesItemLiabilityXc3764f5f? = null,
) {
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1SubscriptionSchedulesPostRequestFormPhasesItemAutomaticTaxX34087348 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemAutomaticTaxX34087348> {
        ...
        override fun deserialize(
            decoder: Decoder,
        ): InlineV1SubscriptionSchedulesPostRequestFormPhasesItemAutomaticTaxX34087348 {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SubscriptionSchedulesPostRequestFormPhasesItemAutomaticTaxX34087348 must be a JSON object",
                    )
            ...
            return InlineV1SubscriptionSchedulesPostRequestFormPhasesItemAutomaticTaxX34087348(
                ...
                liability =
                    rawObject["liability"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemLiabilityXc3764f5f>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionSchedulesPostRequestFormPhasesItemAutomaticTaxX34087348,
        ) {
            val jsonEncoder =
...
public fun inlineV1SubscriptionSchedulesPostRequestFormPhasesItemAutomaticTaxX34087348(
    block: InlineV1SubscriptionSchedulesPostRequestFormPhasesItemAutomaticTaxX34087348.Builder.() -> Unit,
): InlineV1SubscriptionSchedulesPostRequestFormPhasesItemAutomaticTaxX34087348 =
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1SubscriptionSchedulesPostRequestFormPhasesItemAutomaticTaxX34087348 is missing required property '" +
                    name +
                    "'",
            )
