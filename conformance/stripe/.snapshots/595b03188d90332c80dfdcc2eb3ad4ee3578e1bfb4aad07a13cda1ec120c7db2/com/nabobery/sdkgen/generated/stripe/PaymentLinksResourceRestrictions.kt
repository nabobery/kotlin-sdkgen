...
public class PaymentLinksResourceRestrictions(
    ...
    public object Serializer : KSerializer<PaymentLinksResourceRestrictions> {
        ...
        override fun deserialize(decoder: Decoder): PaymentLinksResourceRestrictions {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentLinksResourceRestrictions must be a JSON object")
            val completedSessions =
                json.decodeRequired<PaymentLinksResourceCompletedSessions>(
                    rawObject,
                    "completed_sessions",
                )
            return PaymentLinksResourceRestrictions(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentLinksResourceRestrictions,
        ) {
...
public fun paymentLinksResourceRestrictions(
    block: PaymentLinksResourceRestrictions.Builder.() -> Unit,
): PaymentLinksResourceRestrictions = PaymentLinksResourceRestrictions.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "PaymentLinksResourceRestrictions is missing required property '" + name + "'",
            )
