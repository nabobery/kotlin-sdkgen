...
public class InlineV1InvoicesCreatePreviewPostRequestFormCustomerDetailsXf8694a9b(
    public val address: InlineV1InvoicesCreatePreviewPostRequestFormCustomerDetailsAddressXe64e5ac6? = null,
    public val shipping: InlineV1InvoicesCreatePreviewPostRequestFormCustomerDetailsShippingX02e8e1e9? = null,
    public val tax: InlineV1InvoicesCreatePreviewPostRequestFormCustomerDetailsTaxX88055a93? = null,
    public val taxExempt: InlineV1InvoicesCreatePreviewPostRequestFormCustomerDetailsTaxExemptXa6f80dde? = null,
    public val taxIds: List<InlineV1InvoicesCreatePreviewPostRequestFormCustomerDetailsTaxIdsItemXd5e36ad3>? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1InvoicesCreatePreviewPostRequestFormCustomerDetailsXf8694a9b =
            InlineV1InvoicesCreatePreviewPostRequestFormCustomerDetailsXf8694a9b(
                address = address,
                shipping = shipping,
                tax = tax,
                taxExempt = taxExempt,
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1InvoicesCreatePreviewPostRequestFormCustomerDetailsXf8694a9b = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1InvoicesCreatePreviewPostRequestFormCustomerDetailsXf8694a9b> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1InvoicesCreatePreviewPostRequestFormCustomerDetailsXf8694a9b must be a JSON object",
                    )
            return InlineV1InvoicesCreatePreviewPostRequestFormCustomerDetailsXf8694a9b(
                address =
                    rawObject["address"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1InvoicesCreatePreviewPostRequestFormCustomerDetailsAddressXe64e5ac6>(
                                it,
                            )
                    },
                shipping =
                    rawObject["shipping"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1InvoicesCreatePreviewPostRequestFormCustomerDetailsShippingX02e8e1e9>(
                                it,
                            )
                    },
                tax =
                    rawObject["tax"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1InvoicesCreatePreviewPostRequestFormCustomerDetailsTaxX88055a93>(
                                it,
                            )
                    },
                taxExempt =
                    rawObject["tax_exempt"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1InvoicesCreatePreviewPostRequestFormCustomerDetailsTaxExemptXa6f80dde>(
                                it,
                            )
                    },
                taxIds =
                    rawObject["tax_ids"]?.let {
                        json
                            .decodeFromJsonElement<List<InlineV1InvoicesCreatePreviewPostRequestFormCustomerDetailsTaxIdsItemXd5e36ad3>>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesCreatePreviewPostRequestFormCustomerDetailsXf8694a9b,
        ) {
            val jsonEncoder =
...
public fun inlineV1InvoicesCreatePreviewPostRequestFormCustomerDetailsXf8694a9b(
    block: InlineV1InvoicesCreatePreviewPostRequestFormCustomerDetailsXf8694a9b.Builder.() -> Unit,
): InlineV1InvoicesCreatePreviewPostRequestFormCustomerDetailsXf8694a9b =
    InlineV1InvoicesCreatePreviewPostRequestFormCustomerDetailsXf8694a9b.build(block)
