...
public class InlinePlanProductXfe94cf9a internal constructor(
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlinePlanProductXfe94cf9a {
            val inspection = inspectInlinePlanProductXfe94cf9a(raw)
            if (inspection.matchCount == 0) {
                throw InlinePlanProductXfe94cf9aNoMatchException(
                    "InlinePlanProductXfe94cf9a matched 0 branches: " + inspection.failures.joinToString("; "),
                )
            }
    ...
    public object Serializer : KSerializer<InlinePlanProductXfe94cf9a> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlinePlanProductXfe94cf9a,
        ) {
