...
public class InlineV1SetupIntentsPostRequestFormPaymentMethodDataBoletoX727514d7(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1SetupIntentsPostRequestFormPaymentMethodDataBoletoX727514d7 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1SetupIntentsPostRequestFormPaymentMethodDataBoletoX727514d7> {
        ...
        override fun deserialize(
            decoder: Decoder,
        ): InlineV1SetupIntentsPostRequestFormPaymentMethodDataBoletoX727514d7 {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SetupIntentsPostRequestFormPaymentMethodDataBoletoX727514d7 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SetupIntentsPostRequestFormPaymentMethodDataBoletoX727514d7,
        ) {
            val jsonEncoder =
...
public fun inlineV1SetupIntentsPostRequestFormPaymentMethodDataBoletoX727514d7(
    block: InlineV1SetupIntentsPostRequestFormPaymentMethodDataBoletoX727514d7.Builder.() -> Unit,
): InlineV1SetupIntentsPostRequestFormPaymentMethodDataBoletoX727514d7 =
    InlineV1SetupIntentsPostRequestFormPaymentMethodDataBoletoX727514d7.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1SetupIntentsPostRequestFormPaymentMethodDataBoletoX727514d7 is missing required property '" +
                    name +
                    "'",
            )
