...
public class InlineRefundPaymentIntentX781629cd internal constructor(
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineRefundPaymentIntentX781629cd {
            val inspection = inspectInlineRefundPaymentIntentX781629cd(raw)
            if (inspection.matchCount == 0) {
                throw InlineRefundPaymentIntentX781629cdNoMatchException(
                    "InlineRefundPaymentIntentX781629cd matched 0 branches: " + inspection.failures.joinToString("; "),
                )
            }
    ...
    public object Serializer : KSerializer<InlineRefundPaymentIntentX781629cd> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineRefundPaymentIntentX781629cd,
        ) {
...
private fun inspectInlineRefundPaymentIntentX781629cd(
    element: JsonElement,
): InlineRefundPaymentIntentX781629cdInspection {
