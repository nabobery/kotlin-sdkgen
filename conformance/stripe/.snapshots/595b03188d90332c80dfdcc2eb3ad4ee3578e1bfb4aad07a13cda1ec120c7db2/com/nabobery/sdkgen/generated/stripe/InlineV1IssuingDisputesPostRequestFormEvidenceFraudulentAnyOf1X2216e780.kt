...
public class InlineV1IssuingDisputesPostRequestFormEvidenceFraudulentAnyOf1X2216e780(
    ...
    public val explanation: InlineV1IssuingDisputesPostRequestFormEvidenceFraudulentExplanationX1937664d? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1IssuingDisputesPostRequestFormEvidenceFraudulentAnyOf1X2216e780 =
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1IssuingDisputesPostRequestFormEvidenceFraudulentAnyOf1X2216e780 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1IssuingDisputesPostRequestFormEvidenceFraudulentAnyOf1X2216e780> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1IssuingDisputesPostRequestFormEvidenceFraudulentAnyOf1X2216e780 must be a JSON object",
                    )
            return InlineV1IssuingDisputesPostRequestFormEvidenceFraudulentAnyOf1X2216e780(
                additionalDocumentation =
                    rawObject["additional_documentation"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1IssuingDisputesPostRequestFormEvidenceAdditionalDocumentationXc5960901>(
                                it,
                            )
                    },
                explanation =
                    rawObject["explanation"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1IssuingDisputesPostRequestFormEvidenceFraudulentExplanationX1937664d>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingDisputesPostRequestFormEvidenceFraudulentAnyOf1X2216e780,
        ) {
            val jsonEncoder =
...
public fun inlineV1IssuingDisputesPostRequestFormEvidenceFraudulentAnyOf1X2216e780(
    block: InlineV1IssuingDisputesPostRequestFormEvidenceFraudulentAnyOf1X2216e780.Builder.() -> Unit,
): InlineV1IssuingDisputesPostRequestFormEvidenceFraudulentAnyOf1X2216e780 =
    InlineV1IssuingDisputesPostRequestFormEvidenceFraudulentAnyOf1X2216e780.build(block)
