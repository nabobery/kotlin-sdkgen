...
public class PaymentMethodDetailsInteracPresent(
    ...
    public object Serializer : KSerializer<PaymentMethodDetailsInteracPresent> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodDetailsInteracPresent {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodDetailsInteracPresent must be a JSON object")
                ...
                readMethod =
                    rawObject["read_method"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentMethodDetailsInteracPresentReadMethodX79c13c3e?>(
                                element,
                            )
                        }
                    },
                ...
                receipt =
                    rawObject["receipt"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentMethodDetailsInteracPresentReceiptX19411264?>(
                                element,
                            )
                        }
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentMethodDetailsInteracPresent,
        ) {
...
public fun paymentMethodDetailsInteracPresent(
    block: PaymentMethodDetailsInteracPresent.Builder.() -> Unit,
): PaymentMethodDetailsInteracPresent = PaymentMethodDetailsInteracPresent.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "PaymentMethodDetailsInteracPresent is missing required property '" + name + "'",
            )
