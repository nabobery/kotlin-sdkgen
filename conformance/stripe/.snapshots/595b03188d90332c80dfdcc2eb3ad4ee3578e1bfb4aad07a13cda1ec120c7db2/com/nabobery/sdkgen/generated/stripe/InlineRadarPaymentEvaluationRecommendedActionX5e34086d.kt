...
public sealed class InlineRadarPaymentEvaluationRecommendedActionX5e34086d {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineRadarPaymentEvaluationRecommendedActionX5e34086d =
            when (value) {
                Block.value -> Block
    ...
    public object Serializer : KSerializer<InlineRadarPaymentEvaluationRecommendedActionX5e34086d> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineRadarPaymentEvaluationRecommendedActionX5e34086d",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineRadarPaymentEvaluationRecommendedActionX5e34086d =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineRadarPaymentEvaluationRecommendedActionX5e34086d,
        ) {
