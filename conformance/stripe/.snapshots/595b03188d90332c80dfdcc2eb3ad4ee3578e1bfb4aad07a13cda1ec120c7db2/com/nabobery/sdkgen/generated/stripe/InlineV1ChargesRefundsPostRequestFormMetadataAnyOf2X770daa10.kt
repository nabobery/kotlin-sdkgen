...
public sealed class InlineV1ChargesRefundsPostRequestFormMetadataAnyOf2X770daa10 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1ChargesRefundsPostRequestFormMetadataAnyOf2X770daa10 =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1ChargesRefundsPostRequestFormMetadataAnyOf2X770daa10> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1ChargesRefundsPostRequestFormMetadataAnyOf2X770daa10",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1ChargesRefundsPostRequestFormMetadataAnyOf2X770daa10 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ChargesRefundsPostRequestFormMetadataAnyOf2X770daa10,
        ) {
