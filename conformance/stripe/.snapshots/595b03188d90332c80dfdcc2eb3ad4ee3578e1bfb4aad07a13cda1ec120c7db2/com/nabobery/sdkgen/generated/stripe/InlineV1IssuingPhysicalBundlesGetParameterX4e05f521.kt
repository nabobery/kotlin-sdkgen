...
public sealed class InlineV1IssuingPhysicalBundlesGetParameterX4e05f521 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1IssuingPhysicalBundlesGetParameterX4e05f521 =
            when (value) {
                Active.value -> Active
    ...
    public object Serializer : KSerializer<InlineV1IssuingPhysicalBundlesGetParameterX4e05f521> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1IssuingPhysicalBundlesGetParameterX4e05f521",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1IssuingPhysicalBundlesGetParameterX4e05f521 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingPhysicalBundlesGetParameterX4e05f521,
        ) {
