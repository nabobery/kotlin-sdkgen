...
public class InlineV1SourcesPostRequestFormMandateAcceptanceX8b67948c(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1SourcesPostRequestFormMandateAcceptanceX8b67948c =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1SourcesPostRequestFormMandateAcceptanceX8b67948c> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SourcesPostRequestFormMandateAcceptanceX8b67948c must be a JSON object",
                    )
            val status =
                json.decodeRequired<InlineV1SourcesPostRequestFormMandateAcceptanceStatusXd05b4351>(
                    rawObject,
                    "status",
                )
            return InlineV1SourcesPostRequestFormMandateAcceptanceX8b67948c(
                ...
                offline =
                    rawObject["offline"]?.let {
                        json.decodeFromJsonElement<InlineV1SourcesPostRequestFormMandateAcceptanceOfflineXe73a3afb>(it)
                    },
                online =
                    rawObject["online"]?.let {
                        json.decodeFromJsonElement<InlineV1SourcesPostRequestFormMandateAcceptanceOnlineX321a611c>(it)
                    },
                type =
                    rawObject["type"]?.let {
                        json.decodeFromJsonElement<InlineV1SourcesPostRequestFormMandateAcceptanceTypeX87b1a1d0>(it)
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SourcesPostRequestFormMandateAcceptanceX8b67948c,
        ) {
...
public fun inlineV1SourcesPostRequestFormMandateAcceptanceX8b67948c(
    block: InlineV1SourcesPostRequestFormMandateAcceptanceX8b67948c.Builder.() -> Unit,
): InlineV1SourcesPostRequestFormMandateAcceptanceX8b67948c =
    InlineV1SourcesPostRequestFormMandateAcceptanceX8b67948c.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1SourcesPostRequestFormMandateAcceptanceX8b67948c is missing required property '" + name + "'",
            )
