...
@Serializable
public data class ShippingRateView(
...
public class ShippingRate(
    ...
    public object Serializer : KSerializer<ShippingRate> {
        ...
        override fun deserialize(decoder: Decoder): ShippingRate {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("ShippingRate must be a JSON object")
            ...
            return ShippingRate(
                ...
                type = type,
                deliveryEstimate =
                    rawObject["delivery_estimate"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineShippingRateDeliveryEstimateX7e05df42?>(element)
                        }
                    },
                displayName =
                ...
                fixedAmount =
                    rawObject["fixed_amount"]?.let {
                        json.decodeFromJsonElement<ShippingRateFixedAmount>(
                            it,
                        )
                    },
                taxBehavior =
                    rawObject["tax_behavior"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineShippingRateTaxBehaviorX98ec2e75?>(element)
                        }
                    },
                taxCode =
                    rawObject["tax_code"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineShippingRateTaxCodeX5b0a4373?>(element)
                        }
                    },
            )
        }
