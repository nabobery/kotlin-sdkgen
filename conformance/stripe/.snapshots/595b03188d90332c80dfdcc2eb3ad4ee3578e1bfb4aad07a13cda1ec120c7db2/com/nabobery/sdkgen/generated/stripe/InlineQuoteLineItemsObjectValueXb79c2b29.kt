...
public sealed class InlineQuoteLineItemsObjectValueXb79c2b29 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineQuoteLineItemsObjectValueXb79c2b29 =
            when (value) {
                List.value -> List
    ...
    public object Serializer : KSerializer<InlineQuoteLineItemsObjectValueXb79c2b29> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineQuoteLineItemsObjectValueXb79c2b29",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineQuoteLineItemsObjectValueXb79c2b29 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineQuoteLineItemsObjectValueXb79c2b29,
        ) {
