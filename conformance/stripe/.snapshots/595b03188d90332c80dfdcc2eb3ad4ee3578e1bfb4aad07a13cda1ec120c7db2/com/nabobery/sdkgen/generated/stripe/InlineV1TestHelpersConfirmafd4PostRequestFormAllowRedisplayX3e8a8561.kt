...
public sealed class InlineV1TestHelpersConfirmafd4PostRequestFormAllowRedisplayX3e8a8561 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1TestHelpersConfirmafd4PostRequestFormAllowRedisplayX3e8a8561 =
            when (value) {
                Always.value -> Always
    ...
    public object Serializer : KSerializer<InlineV1TestHelpersConfirmafd4PostRequestFormAllowRedisplayX3e8a8561> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1TestHelpersConfirmafd4PostRequestFormAllowRedisplayX3e8a8561",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1TestHelpersConfirmafd4PostRequestFormAllowRedisplayX3e8a8561 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TestHelpersConfirmafd4PostRequestFormAllowRedisplayX3e8a8561,
        ) {
