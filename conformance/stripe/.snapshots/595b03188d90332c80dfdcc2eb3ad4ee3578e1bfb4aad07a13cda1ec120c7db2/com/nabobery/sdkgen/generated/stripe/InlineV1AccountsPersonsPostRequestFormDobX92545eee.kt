...
internal data class InlineV1AccountsPersonsPostRequestFormDobX92545eeeInspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesInlineV1AccountsPersonsPostRequestFormDobAnyOf1X41202171,
                matchesInlineV1AccountsPersonsPostRequestFormDobAnyOf2X5a6c2dfe,
            ).count {
                it
            }
}
...
public class InlineV1AccountsPersonsPostRequestFormDobX92545eee internal constructor(
    ...
    public val inlineV1AccountsPersonsPostRequestFormDobAnyOf1X41202171:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1AccountsPersonsPostRequestFormDobAnyOf1X41202171) {
                json
                    .decodeFromJsonElement<InlineV1AccountsPersonsPostRequestFormDobAnyOf1X41202171>(
                        raw,
                    )
            } else {
                null
    ...
    public val inlineV1AccountsPersonsPostRequestFormDobAnyOf2X5a6c2dfe:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1AccountsPersonsPostRequestFormDobAnyOf2X5a6c2dfe) {
                json
                    .decodeFromJsonElement<InlineV1AccountsPersonsPostRequestFormDobAnyOf2X5a6c2dfe>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1AccountsPersonsPostRequestFormDobX92545eeeBranch>
        get() =
            buildSet {
                if (inspection.matchesInlineV1AccountsPersonsPostRequestFormDobAnyOf1X41202171) {
                    add(
                        InlineV1AccountsPersonsPostRequestFormDobX92545eeeBranch.InlineV1AccountsPersonsPostRequestFormDobAnyOf1X41202171,
                    )
                }
                if (inspection.matchesInlineV1AccountsPersonsPostRequestFormDobAnyOf2X5a6c2dfe) {
                    add(
                        InlineV1AccountsPersonsPostRequestFormDobX92545eeeBranch.InlineV1AccountsPersonsPostRequestFormDobAnyOf2X5a6c2dfe,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1AccountsPersonsPostRequestFormDobX92545eee {
            val inspection = inspectInlineV1AccountsPersonsPostRequestFormDobX92545eee(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1AccountsPersonsPostRequestFormDobX92545eeeNoMatchException(
                    "InlineV1AccountsPersonsPostRequestFormDobX92545eee matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1AccountsPersonsPostRequestFormDobX92545eee> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPersonsPostRequestFormDobX92545eee,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1AccountsPersonsPostRequestFormDobX92545eee",
...
private fun inspectInlineV1AccountsPersonsPostRequestFormDobX92545eee(
    element: JsonElement,
): InlineV1AccountsPersonsPostRequestFormDobX92545eeeInspection {
    val matchesInlineV1AccountsPersonsPostRequestFormDobAnyOf1X41202171 =
        element
            .isJsonDecodable<InlineV1AccountsPersonsPostRequestFormDobAnyOf1X41202171>()
    val matchesInlineV1AccountsPersonsPostRequestFormDobAnyOf2X5a6c2dfe =
        element
            .isJsonDecodable<InlineV1AccountsPersonsPostRequestFormDobAnyOf2X5a6c2dfe>()
    return InlineV1AccountsPersonsPostRequestFormDobX92545eeeInspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1AccountsPersonsPostRequestFormDobAnyOf1X41202171) {
                    add(
                        "InlineV1AccountsPersonsPostRequestFormDobAnyOf1X41202171: value does not match InlineV1AccountsPersonsPostRequestFormDobAnyOf1X41202171",
                    )
                }
                if (!matchesInlineV1AccountsPersonsPostRequestFormDobAnyOf2X5a6c2dfe) {
                    add(
                        "InlineV1AccountsPersonsPostRequestFormDobAnyOf2X5a6c2dfe: value does not match InlineV1AccountsPersonsPostRequestFormDobAnyOf2X5a6c2dfe",
                    )
                }
            },
    )
