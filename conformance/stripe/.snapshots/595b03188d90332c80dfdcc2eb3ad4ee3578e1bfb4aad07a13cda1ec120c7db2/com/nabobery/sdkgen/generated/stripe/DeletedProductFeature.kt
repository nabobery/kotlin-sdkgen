...
public class DeletedProductFeature(
    ...
    public object Serializer : KSerializer<DeletedProductFeature> {
        ...
        override fun deserialize(decoder: Decoder): DeletedProductFeature {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("DeletedProductFeature must be a JSON object")
...
public fun deletedProductFeature(block: DeletedProductFeature.Builder.() -> Unit): DeletedProductFeature =
    DeletedProductFeature.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("DeletedProductFeature is missing required property '" + name + "'")
