...
public sealed class InlinePaymentsPrimitivesPabc9bElectronicCommerceIn67d5X155cc56a {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentsPrimitivesPabc9bElectronicCommerceIn67d5X155cc56a =
            when (value) {
                _01.value -> _01
                _02.value -> _02
                _03.value -> _03
    ...
    public object Serializer : KSerializer<InlinePaymentsPrimitivesPabc9bElectronicCommerceIn67d5X155cc56a> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentsPrimitivesPabc9bElectronicCommerceIn67d5X155cc56a",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePaymentsPrimitivesPabc9bElectronicCommerceIn67d5X155cc56a =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentsPrimitivesPabc9bElectronicCommerceIn67d5X155cc56a,
        ) {
