...
public sealed class InlineDisputePaymentMethodDetailsCardCaseTypeX14cff061 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineDisputePaymentMethodDetailsCardCaseTypeX14cff061 =
            when (value) {
                Block.value -> Block
    ...
    public object Serializer : KSerializer<InlineDisputePaymentMethodDetailsCardCaseTypeX14cff061> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineDisputePaymentMethodDetailsCardCaseTypeX14cff061",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineDisputePaymentMethodDetailsCardCaseTypeX14cff061 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineDisputePaymentMethodDetailsCardCaseTypeX14cff061,
        ) {
