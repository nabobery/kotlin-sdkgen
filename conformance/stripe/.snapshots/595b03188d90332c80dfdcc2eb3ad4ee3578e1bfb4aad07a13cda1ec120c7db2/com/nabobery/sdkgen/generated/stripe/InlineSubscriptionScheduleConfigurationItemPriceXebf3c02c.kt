...
public class InlineSubscriptionScheduleConfigurationItemPriceXebf3c02c internal constructor(
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineSubscriptionScheduleConfigurationItemPriceXebf3c02cBranch.Branch1,
                    )
                }
                ...
                if (inspection.matchesDeletedPrice) {
                    add(
                        InlineSubscriptionScheduleConfigurationItemPriceXebf3c02cBranch.DeletedPrice,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineSubscriptionScheduleConfigurationItemPriceXebf3c02c {
            val inspection = inspectInlineSubscriptionScheduleConfigurationItemPriceXebf3c02c(raw)
            if (inspection.matchCount == 0) {
                throw InlineSubscriptionScheduleConfigurationItemPriceXebf3c02cNoMatchException(
                    "InlineSubscriptionScheduleConfigurationItemPriceXebf3c02c matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineSubscriptionScheduleConfigurationItemPriceXebf3c02c> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineSubscriptionScheduleConfigurationItemPriceXebf3c02c,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineSubscriptionScheduleConfigurationItemPriceXebf3c02c",
...
private fun inspectInlineSubscriptionScheduleConfigurationItemPriceXebf3c02c(
    element: JsonElement,
): InlineSubscriptionScheduleConfigurationItemPriceXebf3c02cInspection {
