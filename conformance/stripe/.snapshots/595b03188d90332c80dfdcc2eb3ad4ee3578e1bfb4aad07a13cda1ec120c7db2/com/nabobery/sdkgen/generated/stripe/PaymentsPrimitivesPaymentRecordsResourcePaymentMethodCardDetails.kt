...
public class PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCardDetails(
    ...
    public class Builder {
        ...
        public fun build(): PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCardDetails =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCardDetails =
    ...
    public object Serializer : KSerializer<PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCardDetails> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCardDetails must be a JSON object",
                    )
                ...
                brand =
                    rawObject["brand"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentsPrimitivesPa0ad7BrandX2897e15d?>(element)
                        }
                    },
                ...
                checks =
                    rawObject["checks"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentsPrimitivesPa0ad7ChecksX56edce12?>(element)
                        }
                    },
                country =
                ...
                funding =
                    rawObject["funding"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentsPrimitivesPa0ad7FundingX5fc3e805?>(element)
                        }
                    },
                installments =
                    rawObject["installments"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentsPrimitivesPa0ad7InstallmentsXb8cfad2c?>(element)
                        }
                    },
                last4 =
                ...
                network =
                    rawObject["network"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentsPrimitivesPa0ad7NetworkX4ca57c84?>(element)
                        }
                    },
                networkAdviceCode =
                    rawObject["network_advice_code"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                networkToken =
                    rawObject["network_token"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentsPrimitivesPa0ad7NetworkTokenXf89594bb?>(element)
                        }
                    },
                ...
                threeDSecure =
                    rawObject["three_d_secure"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentsPrimitivesPa0ad7ThreeDSecureX99a92399?>(element)
                        }
                    },
                wallet =
                    rawObject["wallet"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentsPrimitivesPa0ad7WalletXaf6e97ba?>(element)
                        }
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCardDetails,
        ) {
            val jsonEncoder =
...
public fun paymentsPrimitivesPaymentRecordsResourcePaymentMethodCardDetails(
    block: PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCardDetails.Builder.() -> Unit,
): PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCardDetails =
    PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCardDetails.build(block)
