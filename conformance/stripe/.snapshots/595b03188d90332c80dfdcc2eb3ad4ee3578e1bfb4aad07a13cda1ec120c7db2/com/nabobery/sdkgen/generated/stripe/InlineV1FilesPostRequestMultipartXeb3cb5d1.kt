...
public class InlineV1FilesPostRequestMultipartXeb3cb5d1(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1FilesPostRequestMultipartXeb3cb5d1 =
    ...
    public object Serializer : KSerializer<InlineV1FilesPostRequestMultipartXeb3cb5d1> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1FilesPostRequestMultipartXeb3cb5d1 {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("InlineV1FilesPostRequestMultipartXeb3cb5d1 must be a JSON object")
            ...
            return InlineV1FilesPostRequestMultipartXeb3cb5d1(
                ...
                fileLinkData =
                    rawObject["file_link_data"]?.let {
                        json.decodeFromJsonElement<InlineV1FilesPostRequestMultipartFileLinkDataXa48d4cf9>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1FilesPostRequestMultipartXeb3cb5d1,
        ) {
...
public fun inlineV1FilesPostRequestMultipartXeb3cb5d1(
    block: InlineV1FilesPostRequestMultipartXeb3cb5d1.Builder.() -> Unit,
): InlineV1FilesPostRequestMultipartXeb3cb5d1 = InlineV1FilesPostRequestMultipartXeb3cb5d1.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1FilesPostRequestMultipartXeb3cb5d1 is missing required property '" + name + "'",
            )
