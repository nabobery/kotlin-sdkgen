...
public class InlineV1SubscriptionItemsPostRequestFormPriceDataX022e42bd(
    ...
    public val taxBehavior: InlineV1SubscriptionItemsPostRequestFormPriceDataTaxBehaviorXa5406aa1? = null,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1SubscriptionItemsPostRequestFormPriceDataX022e42bd =
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionItemsPostRequestFormPriceDataX022e42bd> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SubscriptionItemsPostRequestFormPriceDataX022e42bd must be a JSON object",
                    )
            val currency = json.decodeRequired<String>(rawObject, "currency")
            val product = json.decodeRequired<String>(rawObject, "product")
            val recurring =
                json.decodeRequired<InlineV1SubscriptionItemsPostRequestFormPriceDataRecurringX305daf21>(
                    rawObject,
                    "recurring",
                )
            return InlineV1SubscriptionItemsPostRequestFormPriceDataX022e42bd(
                ...
                taxBehavior =
                    rawObject["tax_behavior"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SubscriptionItemsPostRequestFormPriceDataTaxBehaviorXa5406aa1>(
                                it,
                            )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionItemsPostRequestFormPriceDataX022e42bd,
        ) {
...
public fun inlineV1SubscriptionItemsPostRequestFormPriceDataX022e42bd(
    block: InlineV1SubscriptionItemsPostRequestFormPriceDataX022e42bd.Builder.() -> Unit,
): InlineV1SubscriptionItemsPostRequestFormPriceDataX022e42bd =
    InlineV1SubscriptionItemsPostRequestFormPriceDataX022e42bd.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1SubscriptionItemsPostRequestFormPriceDataX022e42bd is missing required property '" + name + "'",
            )
