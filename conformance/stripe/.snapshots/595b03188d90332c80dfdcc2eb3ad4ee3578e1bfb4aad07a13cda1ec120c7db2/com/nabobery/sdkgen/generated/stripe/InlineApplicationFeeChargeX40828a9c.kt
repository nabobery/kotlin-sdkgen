...
public class InlineApplicationFeeChargeX40828a9c internal constructor(
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineApplicationFeeChargeX40828a9c {
            val inspection = inspectInlineApplicationFeeChargeX40828a9c(raw)
            if (inspection.matchCount == 0) {
                throw InlineApplicationFeeChargeX40828a9cNoMatchException(
                    "InlineApplicationFeeChargeX40828a9c matched 0 branches: " + inspection.failures.joinToString("; "),
                )
            }
    ...
    public object Serializer : KSerializer<InlineApplicationFeeChargeX40828a9c> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineApplicationFeeChargeX40828a9c,
        ) {
...
private fun inspectInlineApplicationFeeChargeX40828a9c(
    element: JsonElement,
): InlineApplicationFeeChargeX40828a9cInspection {
