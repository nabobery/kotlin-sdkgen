...
public class InlineV1PaymentIntentsPostRequestFormHooksInputsTaxX5d6a8358(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PaymentIntentsPostRequestFormHooksInputsTaxX5d6a8358 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormHooksInputsTaxX5d6a8358> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsPostRequestFormHooksInputsTaxX5d6a8358 must be a JSON object",
                    )
            val calculation =
                json.decodeRequired<InlineV1PaymentIntentsPostRequestFormHooksInputsTaxCalculationX052355fd>(
                    rawObject,
                    "calculation",
                )
            return InlineV1PaymentIntentsPostRequestFormHooksInputsTaxX5d6a8358(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormHooksInputsTaxX5d6a8358,
        ) {
...
public fun inlineV1PaymentIntentsPostRequestFormHooksInputsTaxX5d6a8358(
    block: InlineV1PaymentIntentsPostRequestFormHooksInputsTaxX5d6a8358.Builder.() -> Unit,
): InlineV1PaymentIntentsPostRequestFormHooksInputsTaxX5d6a8358 =
    InlineV1PaymentIntentsPostRequestFormHooksInputsTaxX5d6a8358.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentIntentsPostRequestFormHooksInputsTaxX5d6a8358 is missing required property '" + name +
                    "'",
            )
