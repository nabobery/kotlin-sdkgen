...
internal data class InlineV1SubscriptionsPostRequestFormPaymentSettingsAcssDebitX5a31f0d1Inspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesInlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X316ba7ad,
                matchesInlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2X208bff3f,
            ).count {
                it
            }
}
...
public class InlineV1SubscriptionsPostRequestFormPaymentSettingsAcssDebitX5a31f0d1 internal constructor(
    ...
    private val inspection: InlineV1SubscriptionsPostRequestFormPaymentSettingsAcssDebitX5a31f0d1Inspection,
) {
    public val inlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X316ba7ad:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X316ba7ad) {
                json
                    .decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X316ba7ad>(
                        raw,
                    )
            } else {
                null
    ...
    public val inlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2X208bff3f:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2X208bff3f) {
                json
                    .decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2X208bff3f>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches:
        ...
        get() =
            buildSet {
                if (inspection.matchesInlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X316ba7ad) {
                    add(
                        InlineV1SubscriptionsPostRequestFormPaymentSettingsAcssDebitX5a31f0d1Branch.InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X316ba7ad,
                    )
                }
                if (inspection.matchesInlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2X208bff3f) {
                    add(
                        InlineV1SubscriptionsPostRequestFormPaymentSettingsAcssDebitX5a31f0d1Branch.InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2X208bff3f,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1SubscriptionsPostRequestFormPaymentSettingsAcssDebitX5a31f0d1 {
            val inspection = inspectInlineV1SubscriptionsPostRequestFormPaymentSettingsAcssDebitX5a31f0d1(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1SubscriptionsPostRequestFormPaymentSettingsAcssDebitX5a31f0d1NoMatchException(
                    "InlineV1SubscriptionsPostRequestFormPaymentSettingsAcssDebitX5a31f0d1 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionsPostRequestFormPaymentSettingsAcssDebitX5a31f0d1> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsPostRequestFormPaymentSettingsAcssDebitX5a31f0d1,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1SubscriptionsPostRequestFormPaymentSettingsAcssDebitX5a31f0d1",
...
private fun inspectInlineV1SubscriptionsPostRequestFormPaymentSettingsAcssDebitX5a31f0d1(
    element: JsonElement,
): InlineV1SubscriptionsPostRequestFormPaymentSettingsAcssDebitX5a31f0d1Inspection {
    val matchesInlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X316ba7ad =
        element
            .isJsonDecodable<InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X316ba7ad>()
    val matchesInlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2X208bff3f =
        element
            .isJsonDecodable<InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2X208bff3f>()
    return InlineV1SubscriptionsPostRequestFormPaymentSettingsAcssDebitX5a31f0d1Inspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X316ba7ad) {
                    add(
                        "InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X316ba7ad: value does not match InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X316ba7ad",
                    )
                }
                if (!matchesInlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2X208bff3f) {
                    add(
                        "InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2X208bff3f: value does not match InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2X208bff3f",
                    )
                }
            },
    )
