...
public class TreasuryInboundTransfersResourceInboundTransferResourceStatusTransitions(
    ...
    public class Builder {
        ...
        public fun build(): TreasuryInboundTransfersResourceInboundTransferResourceStatusTransitions =
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): TreasuryInboundTransfersResourceInboundTransferResourceStatusTransitions = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<TreasuryInboundTransfersResourceInboundTransferResourceStatusTransitions> {
        ...
        override fun deserialize(
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "TreasuryInboundTransfersResourceInboundTransferResourceStatusTransitions must be a JSON object",
                    )
            return TreasuryInboundTransfersResourceInboundTransferResourceStatusTransitions(
                ...
                succeededAt =
                    rawObject["succeeded_at"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: TreasuryInboundTransfersResourceInboundTransferResourceStatusTransitions,
        ) {
            val jsonEncoder =
...
public fun treasuryInboundTransfersResourceInboundTransferResourceStatusTransitions(
    block: TreasuryInboundTransfersResourceInboundTransferResourceStatusTransitions.Builder.() -> Unit,
): TreasuryInboundTransfersResourceInboundTransferResourceStatusTransitions =
    TreasuryInboundTransfersResourceInboundTransferResourceStatusTransitions.build(block)
