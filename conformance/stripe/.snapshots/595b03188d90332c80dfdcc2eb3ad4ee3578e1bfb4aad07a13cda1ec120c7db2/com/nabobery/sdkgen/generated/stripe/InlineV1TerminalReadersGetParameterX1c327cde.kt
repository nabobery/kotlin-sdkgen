...
public sealed class InlineV1TerminalReadersGetParameterX1c327cde {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1TerminalReadersGetParameterX1c327cde =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1TerminalReadersGetParameterX1c327cde> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1TerminalReadersGetParameterX1c327cde",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1TerminalReadersGetParameterX1c327cde =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TerminalReadersGetParameterX1c327cde,
        ) {
