...
public class InlineDisputeEvidenceRefundPolicyX42bbd64a internal constructor(
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineDisputeEvidenceRefundPolicyX42bbd64a {
            val inspection = inspectInlineDisputeEvidenceRefundPolicyX42bbd64a(raw)
            if (inspection.matchCount == 0) {
                throw InlineDisputeEvidenceRefundPolicyX42bbd64aNoMatchException(
                    "InlineDisputeEvidenceRefundPolicyX42bbd64a matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineDisputeEvidenceRefundPolicyX42bbd64a> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineDisputeEvidenceRefundPolicyX42bbd64a,
        ) {
...
private fun inspectInlineDisputeEvidenceRefundPolicyX42bbd64a(
    element: JsonElement,
): InlineDisputeEvidenceRefundPolicyX42bbd64aInspection {
