        ...
        override fun deserialize(decoder: Decoder): Discount {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("Discount must be a JSON object")
                ...
                customer =
                    rawObject["customer"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineDiscountCustomerX0a3ac123?>(element)
                        }
                    },
                customerAccount =
                ...
                promotionCode =
                    rawObject["promotion_code"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineDiscountPromotionCodeX7807fc74?>(element)
                        }
                    },
                subscription =
