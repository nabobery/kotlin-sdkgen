...
internal data class InlineV1PaymentLinksPostRequestFormCustomTextTermsOfServiceAcceptanceX4fe3a184Inspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesInlineV1PaymentLinksPostRequestFormCustomTextAnyOf1X22bc8fff,
                matchesInlineV1PaymentLinksPostRequestFormCustomTextAnyOf2X14e77aa7,
            ).count {
                it
            }
}
...
public class InlineV1PaymentLinksPostRequestFormCustomTextTermsOfServiceAcceptanceX4fe3a184 internal constructor(
    ...
    private val inspection: InlineV1PaymentLinksPostRequestFormCustomTextTermsOfServiceAcceptanceX4fe3a184Inspection,
) {
    public val inlineV1PaymentLinksPostRequestFormCustomTextAnyOf1X22bc8fff:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1PaymentLinksPostRequestFormCustomTextAnyOf1X22bc8fff) {
                json
                    .decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormCustomTextAnyOf1X22bc8fff>(
                        raw,
                    )
            } else {
                null
    ...
    public val inlineV1PaymentLinksPostRequestFormCustomTextAnyOf2X14e77aa7:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1PaymentLinksPostRequestFormCustomTextAnyOf2X14e77aa7) {
                json
                    .decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormCustomTextAnyOf2X14e77aa7>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches:
        ...
        get() =
            buildSet {
                if (inspection.matchesInlineV1PaymentLinksPostRequestFormCustomTextAnyOf1X22bc8fff) {
                    add(
                        InlineV1PaymentLinksPostRequestFormCustomTextTermsOfServiceAcceptanceX4fe3a184Branch.InlineV1PaymentLinksPostRequestFormCustomTextAnyOf1X22bc8fff,
                    )
                }
                if (inspection.matchesInlineV1PaymentLinksPostRequestFormCustomTextAnyOf2X14e77aa7) {
                    add(
                        InlineV1PaymentLinksPostRequestFormCustomTextTermsOfServiceAcceptanceX4fe3a184Branch.InlineV1PaymentLinksPostRequestFormCustomTextAnyOf2X14e77aa7,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1PaymentLinksPostRequestFormCustomTextTermsOfServiceAcceptanceX4fe3a184 {
            val inspection = inspectInlineV1PaymentLinksPostRequestFormCustomTextTermsOfServiceAcceptanceX4fe3a184(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1PaymentLinksPostRequestFormCustomTextTermsOfServiceAcceptanceX4fe3a184NoMatchException(
                    "InlineV1PaymentLinksPostRequestFormCustomTextTermsOfServiceAcceptanceX4fe3a184 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1PaymentLinksPostRequestFormCustomTextTermsOfServiceAcceptanceX4fe3a184> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentLinksPostRequestFormCustomTextTermsOfServiceAcceptanceX4fe3a184,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1PaymentLinksPostRequestFormCustomTextTermsOfServiceAcceptanceX4fe3a184",
...
private fun inspectInlineV1PaymentLinksPostRequestFormCustomTextTermsOfServiceAcceptanceX4fe3a184(
    element: JsonElement,
): InlineV1PaymentLinksPostRequestFormCustomTextTermsOfServiceAcceptanceX4fe3a184Inspection {
    val matchesInlineV1PaymentLinksPostRequestFormCustomTextAnyOf1X22bc8fff =
        element
            .isJsonDecodable<InlineV1PaymentLinksPostRequestFormCustomTextAnyOf1X22bc8fff>()
    val matchesInlineV1PaymentLinksPostRequestFormCustomTextAnyOf2X14e77aa7 =
        element
            .isJsonDecodable<InlineV1PaymentLinksPostRequestFormCustomTextAnyOf2X14e77aa7>()
    return InlineV1PaymentLinksPostRequestFormCustomTextTermsOfServiceAcceptanceX4fe3a184Inspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1PaymentLinksPostRequestFormCustomTextAnyOf1X22bc8fff) {
                    add(
                        "InlineV1PaymentLinksPostRequestFormCustomTextAnyOf1X22bc8fff: value does not match InlineV1PaymentLinksPostRequestFormCustomTextAnyOf1X22bc8fff",
                    )
                }
                if (!matchesInlineV1PaymentLinksPostRequestFormCustomTextAnyOf2X14e77aa7) {
                    add(
                        "InlineV1PaymentLinksPostRequestFormCustomTextAnyOf2X14e77aa7: value does not match InlineV1PaymentLinksPostRequestFormCustomTextAnyOf2X14e77aa7",
                    )
                }
            },
    )
