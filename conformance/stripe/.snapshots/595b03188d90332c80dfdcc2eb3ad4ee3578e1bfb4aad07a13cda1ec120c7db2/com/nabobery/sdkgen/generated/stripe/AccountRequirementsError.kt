...
public class AccountRequirementsError(
    ...
    public object Serializer : KSerializer<AccountRequirementsError> {
        ...
        override fun deserialize(decoder: Decoder): AccountRequirementsError {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("AccountRequirementsError must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: AccountRequirementsError,
        ) {
...
public fun accountRequirementsError(block: AccountRequirementsError.Builder.() -> Unit): AccountRequirementsError =
    AccountRequirementsError.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException("AccountRequirementsError is missing required property '" + name + "'")
