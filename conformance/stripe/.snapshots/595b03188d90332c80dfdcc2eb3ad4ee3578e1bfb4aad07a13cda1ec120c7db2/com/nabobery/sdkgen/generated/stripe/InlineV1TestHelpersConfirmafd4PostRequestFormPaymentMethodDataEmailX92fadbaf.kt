...
internal data class InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataEmailX92fadbafInspection(
    ...
    public val matchesInlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataAnyOf2X80cba9d9: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataAnyOf2X80cba9d9,
            ).count {
                it
            }
}
...
public class InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataEmailX92fadbaf internal constructor(
    ...
    private val inspection: InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataEmailX92fadbafInspection,
) {
    ...
    public val inlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataAnyOf2X80cba9d9:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataAnyOf2X80cba9d9) {
                json
                    .decodeFromJsonElement<InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataAnyOf2X80cba9d9>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataEmailX92fadbafBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataAnyOf2X80cba9d9) {
                    add(
                        InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataEmailX92fadbafBranch.InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataAnyOf2X80cba9d9,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataEmailX92fadbaf {
            val inspection = inspectInlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataEmailX92fadbaf(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataEmailX92fadbafNoMatchException(
                    "InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataEmailX92fadbaf matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataEmailX92fadbaf> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataEmailX92fadbaf,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataEmailX92fadbaf",
...
private fun inspectInlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataEmailX92fadbaf(
    element: JsonElement,
): InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataEmailX92fadbafInspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataAnyOf2X80cba9d9 =
        element
            .isJsonDecodable<InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataAnyOf2X80cba9d9>()
    return InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataEmailX92fadbafInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataAnyOf2X80cba9d9) {
                    add(
                        "InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataAnyOf2X80cba9d9: value does not match InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataAnyOf2X80cba9d9",
                    )
                }
            },
    )
