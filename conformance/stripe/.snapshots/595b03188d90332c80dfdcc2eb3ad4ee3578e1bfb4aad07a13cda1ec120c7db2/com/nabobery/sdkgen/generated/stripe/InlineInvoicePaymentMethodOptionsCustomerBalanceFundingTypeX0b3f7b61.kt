...
public sealed class InlineInvoicePaymentMethodOptionsCustomerBalanceFundingTypeX0b3f7b61 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineInvoicePaymentMethodOptionsCustomerBalanceFundingTypeX0b3f7b61 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineInvoicePaymentMethodOptionsCustomerBalanceFundingTypeX0b3f7b61> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineInvoicePaymentMethodOptionsCustomerBalanceFundingTypeX0b3f7b61",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineInvoicePaymentMethodOptionsCustomerBalanceFundingTypeX0b3f7b61 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineInvoicePaymentMethodOptionsCustomerBalanceFundingTypeX0b3f7b61,
        ) {
