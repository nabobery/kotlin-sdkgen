...
public class InlineV1SetupIntentsConfirmPostRequestFormMandateOptionsX5d2b2a00(
    ...
    public val interval: InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsIntervalX72a36c13,
    ...
    public val supportedTypes:
        List<InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsCardItemX2bfe1f3e>? = null,
) {
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1SetupIntentsConfirmPostRequestFormMandateOptionsX5d2b2a00 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1SetupIntentsConfirmPostRequestFormMandateOptionsX5d2b2a00> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1SetupIntentsConfirmPostRequestFormMandateOptionsX5d2b2a00 {
            val jsonDecoder =
                decoder.requireJsonDecoder(
                    "InlineV1SetupIntentsConfirmPostRequestFormMandateOptionsX5d2b2a00",
                )
            val json = jsonDecoder.json
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SetupIntentsConfirmPostRequestFormMandateOptionsX5d2b2a00 must be a JSON object",
                    )
            val amount = json.decodeRequired<Int>(rawObject, "amount")
            val amountType =
                json.decodeRequired<InlineV1SetupIntentsConfirmPostRequestFormAmountTypeX7e60476d>(
                    rawObject,
                    "amount_type",
                )
            ...
            val interval =
                json
                    .decodeRequired<InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsIntervalX72a36c13>(
                        rawObject,
                        "interval",
                    )
            ...
            return InlineV1SetupIntentsConfirmPostRequestFormMandateOptionsX5d2b2a00(
                ...
                supportedTypes =
                    rawObject["supported_types"]?.let {
                        json
                            .decodeFromJsonElement<List<InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsCardItemX2bfe1f3e>>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SetupIntentsConfirmPostRequestFormMandateOptionsX5d2b2a00,
        ) {
            val jsonEncoder =
...
public fun inlineV1SetupIntentsConfirmPostRequestFormMandateOptionsX5d2b2a00(
    block: InlineV1SetupIntentsConfirmPostRequestFormMandateOptionsX5d2b2a00.Builder.() -> Unit,
): InlineV1SetupIntentsConfirmPostRequestFormMandateOptionsX5d2b2a00 =
    InlineV1SetupIntentsConfirmPostRequestFormMandateOptionsX5d2b2a00.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1SetupIntentsConfirmPostRequestFormMandateOptionsX5d2b2a00 is missing required property '" +
                    name +
                    "'",
            )
