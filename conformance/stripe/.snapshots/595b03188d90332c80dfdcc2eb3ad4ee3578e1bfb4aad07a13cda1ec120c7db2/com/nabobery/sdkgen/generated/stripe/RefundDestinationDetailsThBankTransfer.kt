...
public class RefundDestinationDetailsThBankTransfer(
    ...
    public class Builder {
        ...
        public fun build(): RefundDestinationDetailsThBankTransfer =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): RefundDestinationDetailsThBankTransfer =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<RefundDestinationDetailsThBankTransfer> {
        ...
        override fun deserialize(decoder: Decoder): RefundDestinationDetailsThBankTransfer {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("RefundDestinationDetailsThBankTransfer must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: RefundDestinationDetailsThBankTransfer,
        ) {
...
public fun refundDestinationDetailsThBankTransfer(
    block: RefundDestinationDetailsThBankTransfer.Builder.() -> Unit,
): RefundDestinationDetailsThBankTransfer = RefundDestinationDetailsThBankTransfer.build(block)
