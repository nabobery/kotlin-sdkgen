...
public class InlineV1TreasuryFinancialAccountsFeaturesPostRequestFormXa6be32c2(
     ...
     */
    public val cardIssuing: InlineV1TreasuryFinancialAccountsFeaturesPostRequestFormCardIssuingX66029009? = null,
    /**
     * Represents whether this FinancialAccount is eligible for deposit insurance. Various factors determine the insurance
     * amount.
     */
    public val depositInsurance: InlineV1TreasuryFinancialA78aaPostRequestFormDepositInsuranceX81dc4708? = null,
    /**
     ...
     */
    public val financialAddresses: InlineV1TreasuryFinancialA78aaPostRequestFormFinancialAddressesXa08234aa? = null,
    /**
     * Contains settings related to adding funds to a FinancialAccount from another Account with the same owner.
     */
    public val inboundTransfers: InlineV1TreasuryFinancialA78aaPostRequestFormInboundTransfersX202312e7? = null,
    /**
     ...
     */
    public val intraStripeFlows: InlineV1TreasuryFinancialA78aaPostRequestFormIntraStripeFlowsX9dfb067d? = null,
    /**
     * Includes Features related to initiating money movement out of the FinancialAccount to someone else's bucket of
     * money.
     */
    public val outboundPayments: InlineV1TreasuryFinancialA78aaPostRequestFormOutboundPaymentsXe1c23404? = null,
    /**
     * Contains a Feature and settings related to moving money out of the FinancialAccount into another Account with the
     * same owner.
     */
    public val outboundTransfers: InlineV1TreasuryFinancialA78aaPostRequestFormOutboundTransfersX968c6733? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1TreasuryFinancialAccountsFeaturesPostRequestFormXa6be32c2 =
            InlineV1TreasuryFinancialAccountsFeaturesPostRequestFormXa6be32c2(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TreasuryFinancialAccountsFeaturesPostRequestFormXa6be32c2 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TreasuryFinancialAccountsFeaturesPostRequestFormXa6be32c2> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TreasuryFinancialAccountsFeaturesPostRequestFormXa6be32c2 must be a JSON object",
                    )
            return InlineV1TreasuryFinancialAccountsFeaturesPostRequestFormXa6be32c2(
                cardIssuing =
                    rawObject["card_issuing"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TreasuryFinancialAccountsFeaturesPostRequestFormCardIssuingX66029009>(
                                it,
                            )
                    },
                depositInsurance =
                    rawObject["deposit_insurance"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TreasuryFinancialA78aaPostRequestFormDepositInsuranceX81dc4708>(
                                it,
                            )
                    },
                ...
                financialAddresses =
                    rawObject["financial_addresses"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TreasuryFinancialA78aaPostRequestFormFinancialAddressesXa08234aa>(
                                it,
                            )
                    },
                inboundTransfers =
                    rawObject["inbound_transfers"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TreasuryFinancialA78aaPostRequestFormInboundTransfersX202312e7>(
                                it,
                            )
                    },
                intraStripeFlows =
                    rawObject["intra_stripe_flows"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TreasuryFinancialA78aaPostRequestFormIntraStripeFlowsX9dfb067d>(
                                it,
                            )
                    },
                outboundPayments =
                    rawObject["outbound_payments"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TreasuryFinancialA78aaPostRequestFormOutboundPaymentsXe1c23404>(
                                it,
                            )
                    },
                outboundTransfers =
                    rawObject["outbound_transfers"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TreasuryFinancialA78aaPostRequestFormOutboundTransfersX968c6733>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TreasuryFinancialAccountsFeaturesPostRequestFormXa6be32c2,
        ) {
            val jsonEncoder =
...
public fun inlineV1TreasuryFinancialAccountsFeaturesPostRequestFormXa6be32c2(
    block: InlineV1TreasuryFinancialAccountsFeaturesPostRequestFormXa6be32c2.Builder.() -> Unit,
): InlineV1TreasuryFinancialAccountsFeaturesPostRequestFormXa6be32c2 =
    InlineV1TreasuryFinancialAccountsFeaturesPostRequestFormXa6be32c2.build(block)
