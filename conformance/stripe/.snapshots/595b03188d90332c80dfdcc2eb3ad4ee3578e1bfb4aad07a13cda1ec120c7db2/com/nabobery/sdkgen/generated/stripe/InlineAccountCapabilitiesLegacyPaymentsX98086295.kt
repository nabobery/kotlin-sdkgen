...
public sealed class InlineAccountCapabilitiesLegacyPaymentsX98086295 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineAccountCapabilitiesLegacyPaymentsX98086295 =
            when (value) {
                Active.value -> Active
    ...
    public object Serializer : KSerializer<InlineAccountCapabilitiesLegacyPaymentsX98086295> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineAccountCapabilitiesLegacyPaymentsX98086295",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineAccountCapabilitiesLegacyPaymentsX98086295 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineAccountCapabilitiesLegacyPaymentsX98086295,
        ) {
