...
public sealed class InlineBankConnectionsResourceAccountNumberDetailsIdentifierTypeX848bc84d {
    ...
    public object Serializer : KSerializer<InlineBankConnectionsResourceAccountNumberDetailsIdentifierTypeX848bc84d> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineBankConnectionsResourceAccountNumberDetailsIdentifierTypeX848bc84d",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineBankConnectionsResourceAccountNumberDetailsIdentifierTypeX848bc84d = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineBankConnectionsResourceAccountNumberDetailsIdentifierTypeX848bc84d,
        ) {
