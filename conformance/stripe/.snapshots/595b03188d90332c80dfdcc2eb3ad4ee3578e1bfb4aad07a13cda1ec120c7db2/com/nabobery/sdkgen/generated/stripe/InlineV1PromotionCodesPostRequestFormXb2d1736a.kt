...
public class InlineV1PromotionCodesPostRequestFormXb2d1736a(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PromotionCodesPostRequestFormXb2d1736a =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PromotionCodesPostRequestFormXb2d1736a> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PromotionCodesPostRequestFormXb2d1736a must be a JSON object",
                    )
            val promotion =
                json.decodeRequired<InlineV1PromotionCodesPostRequestFormPromotionXe5d514d4>(
                    rawObject,
                    "promotion",
                )
            return InlineV1PromotionCodesPostRequestFormXb2d1736a(
                ...
                restrictions =
                    rawObject["restrictions"]?.let {
                        json.decodeFromJsonElement<InlineV1PromotionCodesPostRequestFormRestrictionsX7ab017bc>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PromotionCodesPostRequestFormXb2d1736a,
        ) {
...
public fun inlineV1PromotionCodesPostRequestFormXb2d1736a(
    block: InlineV1PromotionCodesPostRequestFormXb2d1736a.Builder.() -> Unit,
): InlineV1PromotionCodesPostRequestFormXb2d1736a = InlineV1PromotionCodesPostRequestFormXb2d1736a.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PromotionCodesPostRequestFormXb2d1736a is missing required property '" + name + "'",
            )
