...
public class PaymentMethodDetailsPaymentRecordUpi(
    ...
    public class Builder {
        ...
        public fun build(): PaymentMethodDetailsPaymentRecordUpi =
            PaymentMethodDetailsPaymentRecordUpi(
                vpa = vpa,
            )
    }

    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentMethodDetailsPaymentRecordUpi =
    ...
    public object Serializer : KSerializer<PaymentMethodDetailsPaymentRecordUpi> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodDetailsPaymentRecordUpi {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodDetailsPaymentRecordUpi must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentMethodDetailsPaymentRecordUpi,
        ) {
...
public fun paymentMethodDetailsPaymentRecordUpi(
    block: PaymentMethodDetailsPaymentRecordUpi.Builder.() -> Unit,
): PaymentMethodDetailsPaymentRecordUpi = PaymentMethodDetailsPaymentRecordUpi.build(block)
