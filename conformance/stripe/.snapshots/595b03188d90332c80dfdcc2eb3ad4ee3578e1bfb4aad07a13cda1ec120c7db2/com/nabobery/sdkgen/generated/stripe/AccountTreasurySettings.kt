...
public class AccountTreasurySettings(
    ...
    public class Builder {
        ...
        public fun build(): AccountTreasurySettings =
        ...
        override fun deserialize(decoder: Decoder): AccountTreasurySettings {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("AccountTreasurySettings must be a JSON object")
            return AccountTreasurySettings(
                tosAcceptance =
                    rawObject["tos_acceptance"]?.let {
                        json.decodeFromJsonElement<AccountTermsOfService>(
                            it,
                        )
                    },
            )
...
public fun accountTreasurySettings(block: AccountTreasurySettings.Builder.() -> Unit): AccountTreasurySettings =
    AccountTreasurySettings.build(block)
