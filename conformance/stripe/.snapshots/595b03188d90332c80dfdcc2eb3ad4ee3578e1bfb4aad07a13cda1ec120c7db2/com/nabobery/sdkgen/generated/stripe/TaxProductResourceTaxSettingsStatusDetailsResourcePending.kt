...
public class TaxProductResourceTaxSettingsStatusDetailsResourcePending(
     ...
     */
    public val missingFields: List<String>? = null,
) {
    public class Builder {
         ...
         * calculating taxes. Calculations can fail if missing fields aren't explicitly provided on every call.
         */
        public var missingFields: List<String>? = null

        public fun build(): TaxProductResourceTaxSettingsStatusDetailsResourcePending =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): TaxProductResourceTaxSettingsStatusDetailsResourcePending =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<TaxProductResourceTaxSettingsStatusDetailsResourcePending> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "TaxProductResourceTaxSettingsStatusDetailsResourcePending must be a JSON object",
                    )
            return TaxProductResourceTaxSettingsStatusDetailsResourcePending(
                missingFields =
                    rawObject["missing_fields"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: TaxProductResourceTaxSettingsStatusDetailsResourcePending,
        ) {
...
public fun taxProductResourceTaxSettingsStatusDetailsResourcePending(
    block: TaxProductResourceTaxSettingsStatusDetailsResourcePending.Builder.() -> Unit,
): TaxProductResourceTaxSettingsStatusDetailsResourcePending =
    TaxProductResourceTaxSettingsStatusDetailsResourcePending.build(block)
