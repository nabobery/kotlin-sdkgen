...
internal data class InlineV1TestHelpersConfirmationTokensPostRequestFormShippingPhoneX9a0c4b3dInspection(
    ...
    public val matchesInlineV1TestHelpersConfirmationTokensPostRequestFormShippingPhoneAnyOf2X9fed5efe: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1TestHelpersConfirmationTokensPostRequestFormShippingPhoneAnyOf2X9fed5efe,
            ).count {
                it
            }
}
...
public class InlineV1TestHelpersConfirmationTokensPostRequestFormShippingPhoneX9a0c4b3d internal constructor(
    ...
    private val inspection: InlineV1TestHelpersConfirmationTokensPostRequestFormShippingPhoneX9a0c4b3dInspection,
) {
    ...
    public val inlineV1TestHelpersConfirmationTokensPostRequestFormShippingPhoneAnyOf2X9fed5efe:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1TestHelpersConfirmationTokensPostRequestFormShippingPhoneAnyOf2X9fed5efe) {
                json
                    .decodeFromJsonElement<InlineV1TestHelpersConfirmationTokensPostRequestFormShippingPhoneAnyOf2X9fed5efe>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1TestHelpersConfirmationTokensPostRequestFormShippingPhoneX9a0c4b3dBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1TestHelpersConfirmationTokensPostRequestFormShippingPhoneAnyOf2X9fed5efe) {
                    add(
                        InlineV1TestHelpersConfirmationTokensPostRequestFormShippingPhoneX9a0c4b3dBranch.InlineV1TestHelpersConfirmationTokensPostRequestFormShippingPhoneAnyOf2X9fed5efe,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1TestHelpersConfirmationTokensPostRequestFormShippingPhoneX9a0c4b3d {
            val inspection = inspectInlineV1TestHelpersConfirmationTokensPostRequestFormShippingPhoneX9a0c4b3d(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1TestHelpersConfirmationTokensPostRequestFormShippingPhoneX9a0c4b3dNoMatchException(
                    "InlineV1TestHelpersConfirmationTokensPostRequestFormShippingPhoneX9a0c4b3d matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1TestHelpersConfirmationTokensPostRequestFormShippingPhoneX9a0c4b3d> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TestHelpersConfirmationTokensPostRequestFormShippingPhoneX9a0c4b3d,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1TestHelpersConfirmationTokensPostRequestFormShippingPhoneX9a0c4b3d",
...
private fun inspectInlineV1TestHelpersConfirmationTokensPostRequestFormShippingPhoneX9a0c4b3d(
    element: JsonElement,
): InlineV1TestHelpersConfirmationTokensPostRequestFormShippingPhoneX9a0c4b3dInspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1TestHelpersConfirmationTokensPostRequestFormShippingPhoneAnyOf2X9fed5efe =
        element
            .isJsonDecodable<InlineV1TestHelpersConfirmationTokensPostRequestFormShippingPhoneAnyOf2X9fed5efe>()
    return InlineV1TestHelpersConfirmationTokensPostRequestFormShippingPhoneX9a0c4b3dInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1TestHelpersConfirmationTokensPostRequestFormShippingPhoneAnyOf2X9fed5efe) {
                    add(
                        "InlineV1TestHelpersConfirmationTokensPostRequestFormShippingPhoneAnyOf2X9fed5efe: value does not match InlineV1TestHelpersConfirmationTokensPostRequestFormShippingPhoneAnyOf2X9fed5efe",
                    )
                }
            },
    )
