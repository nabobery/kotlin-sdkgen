...
public sealed class InlineCheckoutCardPaymentMethodOptionsRequestMulticaptureX494ec730 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineCheckoutCardPaymentMethodOptionsRequestMulticaptureX494ec730 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineCheckoutCardPaymentMethodOptionsRequestMulticaptureX494ec730> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineCheckoutCardPaymentMethodOptionsRequestMulticaptureX494ec730",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineCheckoutCardPaymentMethodOptionsRequestMulticaptureX494ec730 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineCheckoutCardPaymentMethodOptionsRequestMulticaptureX494ec730,
        ) {
