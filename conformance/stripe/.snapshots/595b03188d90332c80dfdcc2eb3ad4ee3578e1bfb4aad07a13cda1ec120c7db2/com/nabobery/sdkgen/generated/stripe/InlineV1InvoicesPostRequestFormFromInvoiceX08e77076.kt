...
public class InlineV1InvoicesPostRequestFormFromInvoiceX08e77076(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1InvoicesPostRequestFormFromInvoiceX08e77076 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1InvoicesPostRequestFormFromInvoiceX08e77076> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1InvoicesPostRequestFormFromInvoiceX08e77076 must be a JSON object",
                    )
            val action =
                json.decodeRequired<InlineV1InvoicesPostRequestFormFromInvoiceActionX46ac8805>(
                    rawObject,
                    "action",
                )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesPostRequestFormFromInvoiceX08e77076,
        ) {
...
public fun inlineV1InvoicesPostRequestFormFromInvoiceX08e77076(
    block: InlineV1InvoicesPostRequestFormFromInvoiceX08e77076.Builder.() -> Unit,
): InlineV1InvoicesPostRequestFormFromInvoiceX08e77076 =
    InlineV1InvoicesPostRequestFormFromInvoiceX08e77076.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1InvoicesPostRequestFormFromInvoiceX08e77076 is missing required property '" + name + "'",
            )
