...
public class InlineV1AccountsPostRequestFormCompanyXa0d80ea7(
    ...
    public val directorshipDeclaration: InlineV1AccountsPostRequestFormCompanyDirectorshipDeclarationX283f0f23? = null,
    ...
    public val ownershipDeclaration: InlineV1AccountsPostRequestFormCompanyOwnershipDeclarationX2961bcc2? = null,
    public val ownershipExemptionReason: InlineV1AccountsPostRequestFormCompanyOwnershipExemptionReasonX853ea372? = null,
    public val phone: String? = null,
    public val registrationDate: InlineV1AccountsPostRequestFormCompanyRegistrationDateXd12c7bdf? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1AccountsPostRequestFormCompanyXa0d80ea7 =
            InlineV1AccountsPostRequestFormCompanyXa0d80ea7(
                address = address,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1AccountsPostRequestFormCompanyXa0d80ea7 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1AccountsPostRequestFormCompanyXa0d80ea7> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountsPostRequestFormCompanyXa0d80ea7 must be a JSON object",
                    )
            return InlineV1AccountsPostRequestFormCompanyXa0d80ea7(
                address =
                    rawObject["address"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCompanyAddressX82dc9803>(it)
                    },
                addressKana =
                    rawObject["address_kana"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCompanyAddressKanaX48a5d4fb>(it)
                    },
                addressKanji =
                    rawObject["address_kanji"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCompanyAddressKanjiX7feb192a>(it)
                    },
                directorsProvided =
                ...
                directorshipDeclaration =
                    rawObject["directorship_declaration"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1AccountsPostRequestFormCompanyDirectorshipDeclarationX283f0f23>(
                                it,
                            )
                    },
                executivesProvided =
                ...
                ownershipDeclaration =
                    rawObject["ownership_declaration"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCompanyOwnershipDeclarationX2961bcc2>(
                            it,
                        )
                    },
                ownershipExemptionReason =
                    rawObject["ownership_exemption_reason"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1AccountsPostRequestFormCompanyOwnershipExemptionReasonX853ea372>(
                                it,
                            )
                    },
                ...
                registrationDate =
                    rawObject["registration_date"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCompanyRegistrationDateXd12c7bdf>(it)
                    },
                registrationNumber =
                ...
                representativeDeclaration =
                    rawObject["representative_declaration"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1AccountsPostRequestFormCompanyRepresentativeDeclarationXfb9255a1>(
                                it,
                            )
                    },
                structure =
                    rawObject["structure"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCompanyStructureXcf7a7919>(it)
                    },
                ...
                verification =
                    rawObject["verification"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCompanyVerificationXb377cb04>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPostRequestFormCompanyXa0d80ea7,
        ) {
...
public fun inlineV1AccountsPostRequestFormCompanyXa0d80ea7(
    block: InlineV1AccountsPostRequestFormCompanyXa0d80ea7.Builder.() -> Unit,
): InlineV1AccountsPostRequestFormCompanyXa0d80ea7 = InlineV1AccountsPostRequestFormCompanyXa0d80ea7.build(block)
