...
public class CheckoutAuBecsDebitPaymentMethodOptions(
     ...
     */
    public val setupFutureUsage: InlineCheckoutAuBecsDebitPaymentMethodOptionsSetupFutureUsageX66bb4396? = null,
    /**
    ...
    public class Builder {
        ...
        public fun build(): CheckoutAuBecsDebitPaymentMethodOptions =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): CheckoutAuBecsDebitPaymentMethodOptions =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<CheckoutAuBecsDebitPaymentMethodOptions> {
        ...
        override fun deserialize(decoder: Decoder): CheckoutAuBecsDebitPaymentMethodOptions {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("CheckoutAuBecsDebitPaymentMethodOptions must be a JSON object")
            return CheckoutAuBecsDebitPaymentMethodOptions(
                setupFutureUsage =
                    rawObject["setup_future_usage"]?.let {
                        json
                            .decodeFromJsonElement<InlineCheckoutAuBecsDebitPaymentMethodOptionsSetupFutureUsageX66bb4396>(
                                it,
                            )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: CheckoutAuBecsDebitPaymentMethodOptions,
        ) {
...
public fun checkoutAuBecsDebitPaymentMethodOptions(
    block: CheckoutAuBecsDebitPaymentMethodOptions.Builder.() -> Unit,
): CheckoutAuBecsDebitPaymentMethodOptions = CheckoutAuBecsDebitPaymentMethodOptions.build(block)
