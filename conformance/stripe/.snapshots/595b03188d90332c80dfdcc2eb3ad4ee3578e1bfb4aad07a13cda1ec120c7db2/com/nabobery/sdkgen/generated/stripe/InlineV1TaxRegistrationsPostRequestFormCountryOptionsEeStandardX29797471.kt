...
public class InlineV1TaxRegistrationsPostRequestFormCountryOptionsEeStandardX29797471(
    public val placeOfSupplyScheme: InlineV1TaxRegistrationsPostRequestFormPlaceOfSupplySchemeX5baafc1a,
) {
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1TaxRegistrationsPostRequestFormCountryOptionsEeStandardX29797471 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TaxRegistrationsPostRequestFormCountryOptionsEeStandardX29797471> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TaxRegistrationsPostRequestFormCountryOptionsEeStandardX29797471 must be a JSON object",
                    )
            val placeOfSupplyScheme =
                json
                    .decodeRequired<InlineV1TaxRegistrationsPostRequestFormPlaceOfSupplySchemeX5baafc1a>(
                        rawObject,
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TaxRegistrationsPostRequestFormCountryOptionsEeStandardX29797471,
        ) {
            val jsonEncoder =
...
public fun inlineV1TaxRegistrationsPostRequestFormCountryOptionsEeStandardX29797471(
    block: InlineV1TaxRegistrationsPostRequestFormCountryOptionsEeStandardX29797471.Builder.() -> Unit,
): InlineV1TaxRegistrationsPostRequestFormCountryOptionsEeStandardX29797471 =
    InlineV1TaxRegistrationsPostRequestFormCountryOptionsEeStandardX29797471.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TaxRegistrationsPostRequestFormCountryOptionsEeStandardX29797471 is missing required property '" +
                    name +
                    "'",
            )
