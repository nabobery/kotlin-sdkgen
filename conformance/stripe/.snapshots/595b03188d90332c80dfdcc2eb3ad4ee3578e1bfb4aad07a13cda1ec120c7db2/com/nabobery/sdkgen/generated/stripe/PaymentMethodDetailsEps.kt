...
public class PaymentMethodDetailsEps(
    ...
    public class Builder {
        ...
        public fun build(): PaymentMethodDetailsEps =
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodDetailsEps {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodDetailsEps must be a JSON object")
                ...
                bank =
                    rawObject["bank"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentMethodDetailsEpsBankX60368e1f?>(element)
                        }
                    },
                verifiedName =
...
public fun paymentMethodDetailsEps(block: PaymentMethodDetailsEps.Builder.() -> Unit): PaymentMethodDetailsEps =
    PaymentMethodDetailsEps.build(block)
