...
public sealed class InlineGelatoSessionLastErrorCodeX68f6f737 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineGelatoSessionLastErrorCodeX68f6f737 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineGelatoSessionLastErrorCodeX68f6f737> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineGelatoSessionLastErrorCodeX68f6f737",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineGelatoSessionLastErrorCodeX68f6f737 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineGelatoSessionLastErrorCodeX68f6f737,
        ) {
