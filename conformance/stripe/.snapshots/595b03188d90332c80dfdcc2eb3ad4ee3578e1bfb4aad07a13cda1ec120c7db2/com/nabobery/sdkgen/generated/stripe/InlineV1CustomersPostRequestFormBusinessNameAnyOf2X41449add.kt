...
public sealed class InlineV1CustomersPostRequestFormBusinessNameAnyOf2X41449add {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1CustomersPostRequestFormBusinessNameAnyOf2X41449add =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1CustomersPostRequestFormBusinessNameAnyOf2X41449add> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1CustomersPostRequestFormBusinessNameAnyOf2X41449add",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1CustomersPostRequestFormBusinessNameAnyOf2X41449add =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersPostRequestFormBusinessNameAnyOf2X41449add,
        ) {
