...
public class InlineV1BillingCreditGrantsPostRequestFormX39da8216(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1BillingCreditGrantsPostRequestFormX39da8216 =
            InlineV1BillingCreditGrantsPostRequestFormX39da8216(
                expand = expand,
                expiresAt = expiresAt,
                metadata = metadata,
            )
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1BillingCreditGrantsPostRequestFormX39da8216 =
    ...
    public object Serializer : KSerializer<InlineV1BillingCreditGrantsPostRequestFormX39da8216> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1BillingCreditGrantsPostRequestFormX39da8216 must be a JSON object",
                    )
            return InlineV1BillingCreditGrantsPostRequestFormX39da8216(
                expand = rawObject["expand"]?.let { json.decodeFromJsonElement<List<String>>(it) },
                expiresAt =
                    rawObject["expires_at"]?.let {
                        json.decodeFromJsonElement<InlineV1BillingCreditGrantsPostRequestFormExpiresAtXdc77691a>(it)
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1BillingCreditGrantsPostRequestFormX39da8216,
        ) {
...
public fun inlineV1BillingCreditGrantsPostRequestFormX39da8216(
    block: InlineV1BillingCreditGrantsPostRequestFormX39da8216.Builder.() -> Unit,
): InlineV1BillingCreditGrantsPostRequestFormX39da8216 =
    InlineV1BillingCreditGrantsPostRequestFormX39da8216.build(block)
