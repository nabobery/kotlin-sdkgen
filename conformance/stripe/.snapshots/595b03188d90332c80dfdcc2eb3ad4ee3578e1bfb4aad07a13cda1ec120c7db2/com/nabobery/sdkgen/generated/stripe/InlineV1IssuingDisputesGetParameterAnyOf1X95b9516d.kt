...
public class InlineV1IssuingDisputesGetParameterAnyOf1X95b9516d(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1IssuingDisputesGetParameterAnyOf1X95b9516d =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1IssuingDisputesGetParameterAnyOf1X95b9516d =
    ...
    public object Serializer : KSerializer<InlineV1IssuingDisputesGetParameterAnyOf1X95b9516d> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1IssuingDisputesGetParameterAnyOf1X95b9516d must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingDisputesGetParameterAnyOf1X95b9516d,
        ) {
...
public fun inlineV1IssuingDisputesGetParameterAnyOf1X95b9516d(
    block: InlineV1IssuingDisputesGetParameterAnyOf1X95b9516d.Builder.() -> Unit,
): InlineV1IssuingDisputesGetParameterAnyOf1X95b9516d = InlineV1IssuingDisputesGetParameterAnyOf1X95b9516d.build(block)
