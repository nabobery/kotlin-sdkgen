...
public class InlineV1BillingAlertsPostRequestFormUsageThresholdFiltersItemXae51d03c(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1BillingAlertsPostRequestFormUsageThresholdFiltersItemXae51d03c = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1BillingAlertsPostRequestFormUsageThresholdFiltersItemXae51d03c> {
        ...
        override fun deserialize(
            decoder: Decoder,
        ): InlineV1BillingAlertsPostRequestFormUsageThresholdFiltersItemXae51d03c {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1BillingAlertsPostRequestFormUsageThresholdFiltersItemXae51d03c must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineV1BillingAlertsPostRequestFormUsageThresholdFiltersItemTypeXe83ae77c>(
                    rawObject,
                    "type",
                )
            return InlineV1BillingAlertsPostRequestFormUsageThresholdFiltersItemXae51d03c(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1BillingAlertsPostRequestFormUsageThresholdFiltersItemXae51d03c,
        ) {
            val jsonEncoder =
...
public fun inlineV1BillingAlertsPostRequestFormUsageThresholdFiltersItemXae51d03c(
    block: InlineV1BillingAlertsPostRequestFormUsageThresholdFiltersItemXae51d03c.Builder.() -> Unit,
): InlineV1BillingAlertsPostRequestFormUsageThresholdFiltersItemXae51d03c =
    InlineV1BillingAlertsPostRequestFormUsageThresholdFiltersItemXae51d03c.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1BillingAlertsPostRequestFormUsageThresholdFiltersItemXae51d03c is missing required property '" +
                    name +
                    "'",
            )
