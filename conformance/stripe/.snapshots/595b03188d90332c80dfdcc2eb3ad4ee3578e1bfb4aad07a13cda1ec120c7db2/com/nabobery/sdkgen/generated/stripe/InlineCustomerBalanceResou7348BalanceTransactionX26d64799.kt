...
public class InlineCustomerBalanceResou7348BalanceTransactionX26d64799 internal constructor(
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineCustomerBalanceResou7348BalanceTransactionX26d64799Branch.Branch1,
                    )
                }
                if (inspection.matchesBalanceTransaction) {
                    add(
                        InlineCustomerBalanceResou7348BalanceTransactionX26d64799Branch.BalanceTransaction,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineCustomerBalanceResou7348BalanceTransactionX26d64799 {
            val inspection = inspectInlineCustomerBalanceResou7348BalanceTransactionX26d64799(raw)
            if (inspection.matchCount == 0) {
                throw InlineCustomerBalanceResou7348BalanceTransactionX26d64799NoMatchException(
                    "InlineCustomerBalanceResou7348BalanceTransactionX26d64799 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineCustomerBalanceResou7348BalanceTransactionX26d64799> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineCustomerBalanceResou7348BalanceTransactionX26d64799,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineCustomerBalanceResou7348BalanceTransactionX26d64799",
...
private fun inspectInlineCustomerBalanceResou7348BalanceTransactionX26d64799(
    element: JsonElement,
): InlineCustomerBalanceResou7348BalanceTransactionX26d64799Inspection {
