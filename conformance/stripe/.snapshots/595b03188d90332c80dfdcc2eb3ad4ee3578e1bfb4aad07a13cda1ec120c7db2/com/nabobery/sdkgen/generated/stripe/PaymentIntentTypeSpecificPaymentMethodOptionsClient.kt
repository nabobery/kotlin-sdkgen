...
public data class PaymentIntentTypeSpecificPaymentMethodOptionsClientView(
    ...
    public val captureMethod: InlinePaymentIntentTypeSpecificPaymentMethodOptionsClientCaptureMethodX008df07d? = null,
...
public class PaymentIntentTypeSpecificPaymentMethodOptionsClient(
    ...
    public class Builder {
        ...
        public fun build(): PaymentIntentTypeSpecificPaymentMethodOptionsClient =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentIntentTypeSpecificPaymentMethodOptionsClient =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentIntentTypeSpecificPaymentMethodOptionsClient> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "PaymentIntentTypeSpecificPaymentMethodOptionsClient must be a JSON object",
                    )
            return PaymentIntentTypeSpecificPaymentMethodOptionsClient(
                captureMethod =
                    rawObject["capture_method"]?.let {
                        json
                            .decodeFromJsonElement<InlinePaymentIntentTypeSpecificPaymentMethodOptionsClientCaptureMethodX008df07d>(
                                it,
                            )
                    },
                installments =
                    rawObject["installments"]?.let {
                        json.decodeFromJsonElement<PaymentFlowsInstallmentOptions>(
                            it,
                        )
                    },
                mandateOptions =
                ...
                routing =
                    rawObject["routing"]?.let {
                        json
                            .decodeFromJsonElement<PaymentMethodOptionsCardPresentRouting>(
                                it,
                            )
                    },
                setupFutureUsage =
                    rawObject["setup_future_usage"]?.let {
                        json.decodeFromJsonElement<InlinePaymentIntentTypeSpefa40SetupFutureUsageX579b72d6>(it)
                    },
                verificationMethod =
                    rawObject["verification_method"]?.let {
                        json.decodeFromJsonElement<InlinePaymentIntentTypeSpefa40VerificationMethodXb3165e1a>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentIntentTypeSpecificPaymentMethodOptionsClient,
        ) {
...
public fun paymentIntentTypeSpecificPaymentMethodOptionsClient(
    block: PaymentIntentTypeSpecificPaymentMethodOptionsClient.Builder.() -> Unit,
): PaymentIntentTypeSpecificPaymentMethodOptionsClient =
    PaymentIntentTypeSpecificPaymentMethodOptionsClient.build(block)
