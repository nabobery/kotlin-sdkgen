...
public class InlineV1InvoicesGetParameterX5346dfcd internal constructor(
    ...
    public val inlineV1InvoicesGetParameterAnyOf1Xaad724f8:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1InvoicesGetParameterAnyOf1Xaad724f8) {
                json
                    .decodeFromJsonElement<InlineV1InvoicesGetParameterAnyOf1Xaad724f8>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1InvoicesGetParameterX5346dfcdBranch>
        get() =
            buildSet {
                if (inspection.matchesInlineV1InvoicesGetParameterAnyOf1Xaad724f8) {
                    add(
                        InlineV1InvoicesGetParameterX5346dfcdBranch.InlineV1InvoicesGetParameterAnyOf1Xaad724f8,
                    )
                }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1InvoicesGetParameterX5346dfcd {
            val inspection = inspectInlineV1InvoicesGetParameterX5346dfcd(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1InvoicesGetParameterX5346dfcdNoMatchException(
                    "InlineV1InvoicesGetParameterX5346dfcd matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1InvoicesGetParameterX5346dfcd> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesGetParameterX5346dfcd,
        ) {
...
private fun inspectInlineV1InvoicesGetParameterX5346dfcd(
    element: JsonElement,
): InlineV1InvoicesGetParameterX5346dfcdInspection {
    val matchesInlineV1InvoicesGetParameterAnyOf1Xaad724f8 =
        element
            .isJsonDecodable<InlineV1InvoicesGetParameterAnyOf1Xaad724f8>()
    ...
    return InlineV1InvoicesGetParameterX5346dfcdInspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1InvoicesGetParameterAnyOf1Xaad724f8) {
                    add(
                        "InlineV1InvoicesGetParameterAnyOf1Xaad724f8: value does not match InlineV1InvoicesGetParameterAnyOf1Xaad724f8",
                    )
                }
