...
public class InlineV1BillingAlertsActivatePostRequestFormX225f3a0e(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1BillingAlertsActivatePostRequestFormX225f3a0e =
            InlineV1BillingAlertsActivatePostRequestFormX225f3a0e(
                expand = expand,
            )
    }

    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1BillingAlertsActivatePostRequestFormX225f3a0e =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1BillingAlertsActivatePostRequestFormX225f3a0e> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1BillingAlertsActivatePostRequestFormX225f3a0e must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1BillingAlertsActivatePostRequestFormX225f3a0e,
        ) {
...
public fun inlineV1BillingAlertsActivatePostRequestFormX225f3a0e(
    block: InlineV1BillingAlertsActivatePostRequestFormX225f3a0e.Builder.() -> Unit,
): InlineV1BillingAlertsActivatePostRequestFormX225f3a0e =
    InlineV1BillingAlertsActivatePostRequestFormX225f3a0e.build(block)
