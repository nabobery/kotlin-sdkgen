...
internal data class InlineV1SubscriptionsPostRequestFormPaymentSettingsPaytoX3b4ac4beInspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesInlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X7c7c6893,
                matchesInlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2X42589e8c,
            ).count {
                it
            }
}
...
public class InlineV1SubscriptionsPostRequestFormPaymentSettingsPaytoX3b4ac4be internal constructor(
    ...
    private val inspection: InlineV1SubscriptionsPostRequestFormPaymentSettingsPaytoX3b4ac4beInspection,
) {
    public val inlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X7c7c6893:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X7c7c6893) {
                json
                    .decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X7c7c6893>(
                        raw,
                    )
            } else {
                null
    ...
    public val inlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2X42589e8c:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2X42589e8c) {
                json
                    .decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2X42589e8c>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches:
        ...
        get() =
            buildSet {
                if (inspection.matchesInlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X7c7c6893) {
                    add(
                        InlineV1SubscriptionsPostRequestFormPaymentSettingsPaytoX3b4ac4beBranch.InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X7c7c6893,
                    )
                }
                if (inspection.matchesInlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2X42589e8c) {
                    add(
                        InlineV1SubscriptionsPostRequestFormPaymentSettingsPaytoX3b4ac4beBranch.InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2X42589e8c,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1SubscriptionsPostRequestFormPaymentSettingsPaytoX3b4ac4be {
            val inspection = inspectInlineV1SubscriptionsPostRequestFormPaymentSettingsPaytoX3b4ac4be(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1SubscriptionsPostRequestFormPaymentSettingsPaytoX3b4ac4beNoMatchException(
                    "InlineV1SubscriptionsPostRequestFormPaymentSettingsPaytoX3b4ac4be matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionsPostRequestFormPaymentSettingsPaytoX3b4ac4be> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsPostRequestFormPaymentSettingsPaytoX3b4ac4be,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1SubscriptionsPostRequestFormPaymentSettingsPaytoX3b4ac4be",
...
private fun inspectInlineV1SubscriptionsPostRequestFormPaymentSettingsPaytoX3b4ac4be(
    element: JsonElement,
): InlineV1SubscriptionsPostRequestFormPaymentSettingsPaytoX3b4ac4beInspection {
    val matchesInlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X7c7c6893 =
        element
            .isJsonDecodable<InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X7c7c6893>()
    val matchesInlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2X42589e8c =
        element
            .isJsonDecodable<InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2X42589e8c>()
    return InlineV1SubscriptionsPostRequestFormPaymentSettingsPaytoX3b4ac4beInspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X7c7c6893) {
                    add(
                        "InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X7c7c6893: value does not match InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X7c7c6893",
                    )
                }
                if (!matchesInlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2X42589e8c) {
                    add(
                        "InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2X42589e8c: value does not match InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2X42589e8c",
                    )
                }
            },
    )
