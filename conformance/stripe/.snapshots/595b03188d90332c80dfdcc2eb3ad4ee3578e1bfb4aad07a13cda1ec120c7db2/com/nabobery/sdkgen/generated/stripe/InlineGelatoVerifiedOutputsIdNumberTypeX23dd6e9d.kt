...
public sealed class InlineGelatoVerifiedOutputsIdNumberTypeX23dd6e9d {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineGelatoVerifiedOutputsIdNumberTypeX23dd6e9d =
            when (value) {
                BrCpf.value -> BrCpf
                SgNric.value -> SgNric
                UsSsn.value -> UsSsn
    ...
    public object Serializer : KSerializer<InlineGelatoVerifiedOutputsIdNumberTypeX23dd6e9d> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineGelatoVerifiedOutputsIdNumberTypeX23dd6e9d",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineGelatoVerifiedOutputsIdNumberTypeX23dd6e9d =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineGelatoVerifiedOutputsIdNumberTypeX23dd6e9d,
        ) {
