...
public class RefundDestinationDetailsCard(
    ...
    public object Serializer : KSerializer<RefundDestinationDetailsCard> {
        ...
        override fun deserialize(decoder: Decoder): RefundDestinationDetailsCard {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("RefundDestinationDetailsCard must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: RefundDestinationDetailsCard,
        ) {
...
public fun refundDestinationDetailsCard(
    block: RefundDestinationDetailsCard.Builder.() -> Unit,
): RefundDestinationDetailsCard = RefundDestinationDetailsCard.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException("RefundDestinationDetailsCard is missing required property '" + name + "'")
