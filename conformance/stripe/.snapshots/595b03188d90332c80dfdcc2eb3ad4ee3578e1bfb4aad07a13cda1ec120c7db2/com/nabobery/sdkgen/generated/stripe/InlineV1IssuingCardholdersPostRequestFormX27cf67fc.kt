...
public class InlineV1IssuingCardholdersPostRequestFormX27cf67fc(
     ...
     */
    public val preferredLocales: List<InlineV1IssuingCardholdersPostRequestFormPreferredLocalesItemX4b6a958a>? = null,
    /**
     ...
     */
    public val spendingControls: InlineV1IssuingCardholdersPostRequestFormSpendingControlsXf32ac1c8? = null,
    /**
    ...
    public class Builder {
        ...
        public fun build(): InlineV1IssuingCardholdersPostRequestFormX27cf67fc =
            InlineV1IssuingCardholdersPostRequestFormX27cf67fc(
                billing = billing,
                company = company,
                email = email,
                expand = expand,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1IssuingCardholdersPostRequestFormX27cf67fc =
    ...
    public object Serializer : KSerializer<InlineV1IssuingCardholdersPostRequestFormX27cf67fc> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1IssuingCardholdersPostRequestFormX27cf67fc must be a JSON object",
                    )
            return InlineV1IssuingCardholdersPostRequestFormX27cf67fc(
                billing =
                    rawObject["billing"]?.let {
                        json.decodeFromJsonElement<InlineV1IssuingCardholdersPostRequestFormBillingX75c3beb0>(it)
                    },
                company =
                    rawObject["company"]?.let {
                        json.decodeFromJsonElement<InlineV1IssuingCardholdersPostRequestFormCompanyX64c1f031>(it)
                    },
                email = rawObject["email"]?.let { json.decodeFromJsonElement<String>(it) },
                expand = rawObject["expand"]?.let { json.decodeFromJsonElement<List<String>>(it) },
                individual =
                    rawObject["individual"]?.let {
                        json.decodeFromJsonElement<InlineV1IssuingCardholdersPostRequestFormIndividualXc6e742e0>(it)
                    },
                ...
                preferredLocales =
                    rawObject["preferred_locales"]?.let {
                        json
                            .decodeFromJsonElement<List<InlineV1IssuingCardholdersPostRequestFormPreferredLocalesItemX4b6a958a>>(
                                it,
                            )
                    },
                spendingControls =
                    rawObject["spending_controls"]?.let {
                        json.decodeFromJsonElement<InlineV1IssuingCardholdersPostRequestFormSpendingControlsXf32ac1c8>(
                            it,
                        )
                    },
                status =
                    rawObject["status"]?.let {
                        json.decodeFromJsonElement<InlineV1IssuingCardholdersPostRequestFormStatusX21fc8106>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingCardholdersPostRequestFormX27cf67fc,
        ) {
...
public fun inlineV1IssuingCardholdersPostRequestFormX27cf67fc(
    block: InlineV1IssuingCardholdersPostRequestFormX27cf67fc.Builder.() -> Unit,
): InlineV1IssuingCardholdersPostRequestFormX27cf67fc = InlineV1IssuingCardholdersPostRequestFormX27cf67fc.build(block)
