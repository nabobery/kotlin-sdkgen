...
public class InlineV1CheckoutSessionsGetParameterXa5b062a4(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1CheckoutSessionsGetParameterXa5b062a4 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1CheckoutSessionsGetParameterXa5b062a4> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CheckoutSessionsGetParameterXa5b062a4 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsGetParameterXa5b062a4,
        ) {
...
public fun inlineV1CheckoutSessionsGetParameterXa5b062a4(
    block: InlineV1CheckoutSessionsGetParameterXa5b062a4.Builder.() -> Unit,
): InlineV1CheckoutSessionsGetParameterXa5b062a4 = InlineV1CheckoutSessionsGetParameterXa5b062a4.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1CheckoutSessionsGetParameterXa5b062a4 is missing required property '" + name + "'",
            )
