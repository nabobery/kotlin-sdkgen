...
public class InlineRefundSourceTransferReversalX9b844182 internal constructor(
        ...
        get() =
            buildSet {
                ...
                if (inspection.matchesTransferReversal) {
                    add(
                        InlineRefundSourceTransferReversalX9b844182Branch.TransferReversal,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineRefundSourceTransferReversalX9b844182 {
            val inspection = inspectInlineRefundSourceTransferReversalX9b844182(raw)
            if (inspection.matchCount == 0) {
                throw InlineRefundSourceTransferReversalX9b844182NoMatchException(
                    "InlineRefundSourceTransferReversalX9b844182 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineRefundSourceTransferReversalX9b844182> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineRefundSourceTransferReversalX9b844182,
        ) {
...
private fun inspectInlineRefundSourceTransferReversalX9b844182(
    element: JsonElement,
): InlineRefundSourceTransferReversalX9b844182Inspection {
