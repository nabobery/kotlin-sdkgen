...
public class InlineIssuingDisputeDuplicateEvidenceCashReceiptX56eae54c internal constructor(
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineIssuingDisputeDuplicateEvidenceCashReceiptX56eae54cBranch.Branch1,
                    )
                }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineIssuingDisputeDuplicateEvidenceCashReceiptX56eae54c {
            val inspection = inspectInlineIssuingDisputeDuplicateEvidenceCashReceiptX56eae54c(raw)
            if (inspection.matchCount == 0) {
                throw InlineIssuingDisputeDuplicateEvidenceCashReceiptX56eae54cNoMatchException(
                    "InlineIssuingDisputeDuplicateEvidenceCashReceiptX56eae54c matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineIssuingDisputeDuplicateEvidenceCashReceiptX56eae54c> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineIssuingDisputeDuplicateEvidenceCashReceiptX56eae54c,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineIssuingDisputeDuplicateEvidenceCashReceiptX56eae54c",
...
private fun inspectInlineIssuingDisputeDuplicateEvidenceCashReceiptX56eae54c(
    element: JsonElement,
): InlineIssuingDisputeDuplicateEvidenceCashReceiptX56eae54cInspection {
