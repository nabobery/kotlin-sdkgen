...
public class InlineV1AccountsPersonsPostRequestFormDocumentsVisaX2fb8b73c(
    public val files: List<InlineV1AccountsPersonsPostRequestFormDocumentsVisaFilesItemX9b1fb9b0>? = null,
) {
    public class Builder {
        public var files: List<InlineV1AccountsPersonsPostRequestFormDocumentsVisaFilesItemX9b1fb9b0>? =
            null

        public fun build(): InlineV1AccountsPersonsPostRequestFormDocumentsVisaX2fb8b73c =
            InlineV1AccountsPersonsPostRequestFormDocumentsVisaX2fb8b73c(
                files = files,
            )
    }

    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1AccountsPersonsPostRequestFormDocumentsVisaX2fb8b73c =
    ...
    public object Serializer : KSerializer<InlineV1AccountsPersonsPostRequestFormDocumentsVisaX2fb8b73c> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountsPersonsPostRequestFormDocumentsVisaX2fb8b73c must be a JSON object",
                    )
            return InlineV1AccountsPersonsPostRequestFormDocumentsVisaX2fb8b73c(
                files =
                    rawObject["files"]?.let {
                        json
                            .decodeFromJsonElement<List<InlineV1AccountsPersonsPostRequestFormDocumentsVisaFilesItemX9b1fb9b0>>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPersonsPostRequestFormDocumentsVisaX2fb8b73c,
        ) {
...
public fun inlineV1AccountsPersonsPostRequestFormDocumentsVisaX2fb8b73c(
    block: InlineV1AccountsPersonsPostRequestFormDocumentsVisaX2fb8b73c.Builder.() -> Unit,
): InlineV1AccountsPersonsPostRequestFormDocumentsVisaX2fb8b73c =
    InlineV1AccountsPersonsPostRequestFormDocumentsVisaX2fb8b73c.build(block)
