...
public sealed class InlineV1SubscriptionsPostRequestFormPaymentSettingsItemX28f4e986 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1SubscriptionsPostRequestFormPaymentSettingsItemX28f4e986 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionsPostRequestFormPaymentSettingsItemX28f4e986> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1SubscriptionsPostRequestFormPaymentSettingsItemX28f4e986",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1SubscriptionsPostRequestFormPaymentSettingsItemX28f4e986 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsPostRequestFormPaymentSettingsItemX28f4e986,
        ) {
