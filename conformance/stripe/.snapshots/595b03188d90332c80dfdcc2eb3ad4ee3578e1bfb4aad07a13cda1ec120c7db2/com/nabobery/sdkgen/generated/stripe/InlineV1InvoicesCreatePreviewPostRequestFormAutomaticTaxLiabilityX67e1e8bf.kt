...
public class InlineV1InvoicesCreatePreviewPostRequestFormAutomaticTaxLiabilityX67e1e8bf(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1InvoicesCreatePreviewPostRequestFormAutomaticTaxLiabilityX67e1e8bf = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1InvoicesCreatePreviewPostRequestFormAutomaticTaxLiabilityX67e1e8bf> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1InvoicesCreatePreviewPostRequestFormAutomaticTaxLiabilityX67e1e8bf must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineV1InvoicesCreatePreviewPostRequestFormAutomaticTaxLiabilityTypeXb2fad998>(
                    rawObject,
                    "type",
                )
            return InlineV1InvoicesCreatePreviewPostRequestFormAutomaticTaxLiabilityX67e1e8bf(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesCreatePreviewPostRequestFormAutomaticTaxLiabilityX67e1e8bf,
        ) {
            val jsonEncoder =
...
public fun inlineV1InvoicesCreatePreviewPostRequestFormAutomaticTaxLiabilityX67e1e8bf(
    block: InlineV1InvoicesCreatePreviewPostRequestFormAutomaticTaxLiabilityX67e1e8bf.Builder.() -> Unit,
): InlineV1InvoicesCreatePreviewPostRequestFormAutomaticTaxLiabilityX67e1e8bf =
    InlineV1InvoicesCreatePreviewPostRequestFormAutomaticTaxLiabilityX67e1e8bf.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1InvoicesCreatePreviewPostRequestFormAutomaticTaxLiabilityX67e1e8bf is missing required property '" +
                    name +
                    "'",
            )
