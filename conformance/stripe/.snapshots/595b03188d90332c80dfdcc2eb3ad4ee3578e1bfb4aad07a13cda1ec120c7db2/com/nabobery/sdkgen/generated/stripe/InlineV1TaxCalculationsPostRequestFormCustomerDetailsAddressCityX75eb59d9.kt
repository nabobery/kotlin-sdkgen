...
internal data class InlineV1TaxCalculationsPostRequestFormCustomerDetailsAddressCityX75eb59d9Inspection(
    ...
    public val matchesInlineV1TaxCalculationsPostRequestFormCustomerDetailsAddressCityAnyOf2X1b3863a9: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1TaxCalculationsPostRequestFormCustomerDetailsAddressCityAnyOf2X1b3863a9,
            ).count {
                it
            }
}
...
public class InlineV1TaxCalculationsPostRequestFormCustomerDetailsAddressCityX75eb59d9 internal constructor(
    ...
    private val inspection: InlineV1TaxCalculationsPostRequestFormCustomerDetailsAddressCityX75eb59d9Inspection,
) {
    ...
    public val inlineV1TaxCalculationsPostRequestFormCustomerDetailsAddressCityAnyOf2X1b3863a9:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1TaxCalculationsPostRequestFormCustomerDetailsAddressCityAnyOf2X1b3863a9) {
                json
                    .decodeFromJsonElement<InlineV1TaxCalculationsPostRequestFormCustomerDetailsAddressCityAnyOf2X1b3863a9>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1TaxCalculationsPostRequestFormCustomerDetailsAddressCityX75eb59d9Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1TaxCalculationsPostRequestFormCustomerDetailsAddressCityAnyOf2X1b3863a9) {
                    add(
                        InlineV1TaxCalculationsPostRequestFormCustomerDetailsAddressCityX75eb59d9Branch.InlineV1TaxCalculationsPostRequestFormCustomerDetailsAddressCityAnyOf2X1b3863a9,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1TaxCalculationsPostRequestFormCustomerDetailsAddressCityX75eb59d9 {
            val inspection = inspectInlineV1TaxCalculationsPostRequestFormCustomerDetailsAddressCityX75eb59d9(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1TaxCalculationsPostRequestFormCustomerDetailsAddressCityX75eb59d9NoMatchException(
                    "InlineV1TaxCalculationsPostRequestFormCustomerDetailsAddressCityX75eb59d9 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1TaxCalculationsPostRequestFormCustomerDetailsAddressCityX75eb59d9> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TaxCalculationsPostRequestFormCustomerDetailsAddressCityX75eb59d9,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1TaxCalculationsPostRequestFormCustomerDetailsAddressCityX75eb59d9",
...
private fun inspectInlineV1TaxCalculationsPostRequestFormCustomerDetailsAddressCityX75eb59d9(
    element: JsonElement,
): InlineV1TaxCalculationsPostRequestFormCustomerDetailsAddressCityX75eb59d9Inspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1TaxCalculationsPostRequestFormCustomerDetailsAddressCityAnyOf2X1b3863a9 =
        element
            .isJsonDecodable<InlineV1TaxCalculationsPostRequestFormCustomerDetailsAddressCityAnyOf2X1b3863a9>()
    return InlineV1TaxCalculationsPostRequestFormCustomerDetailsAddressCityX75eb59d9Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1TaxCalculationsPostRequestFormCustomerDetailsAddressCityAnyOf2X1b3863a9) {
                    add(
                        "InlineV1TaxCalculationsPostRequestFormCustomerDetailsAddressCityAnyOf2X1b3863a9: value does not match InlineV1TaxCalculationsPostRequestFormCustomerDetailsAddressCityAnyOf2X1b3863a9",
                    )
                }
            },
    )
