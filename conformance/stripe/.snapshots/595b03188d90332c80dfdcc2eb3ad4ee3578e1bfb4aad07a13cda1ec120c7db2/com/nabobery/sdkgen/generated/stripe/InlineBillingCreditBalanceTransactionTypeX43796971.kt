...
public sealed class InlineBillingCreditBalanceTransactionTypeX43796971 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineBillingCreditBalanceTransactionTypeX43796971 =
            when (value) {
                Credit.value -> Credit
                Debit.value -> Debit
    ...
    public object Serializer : KSerializer<InlineBillingCreditBalanceTransactionTypeX43796971> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineBillingCreditBalanceTransactionTypeX43796971",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineBillingCreditBalanceTransactionTypeX43796971 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineBillingCreditBalanceTransactionTypeX43796971,
        ) {
