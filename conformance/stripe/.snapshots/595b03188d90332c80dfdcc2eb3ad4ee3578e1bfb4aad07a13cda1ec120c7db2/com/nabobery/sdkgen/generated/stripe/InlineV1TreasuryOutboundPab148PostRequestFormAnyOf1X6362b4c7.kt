...
public class InlineV1TreasuryOutboundPab148PostRequestFormAnyOf1X6362b4c7(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1TreasuryOutboundPab148PostRequestFormAnyOf1X6362b4c7 =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TreasuryOutboundPab148PostRequestFormAnyOf1X6362b4c7 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TreasuryOutboundPab148PostRequestFormAnyOf1X6362b4c7> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TreasuryOutboundPab148PostRequestFormAnyOf1X6362b4c7 must be a JSON object",
                    )
            return InlineV1TreasuryOutboundPab148PostRequestFormAnyOf1X6362b4c7(
                network =
                    rawObject["network"]?.let {
                        json.decodeFromJsonElement<InlineV1TreasuryOutboundPab148PostRequestFormNetworkXf857f5ed>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TreasuryOutboundPab148PostRequestFormAnyOf1X6362b4c7,
        ) {
...
public fun inlineV1TreasuryOutboundPab148PostRequestFormAnyOf1X6362b4c7(
    block: InlineV1TreasuryOutboundPab148PostRequestFormAnyOf1X6362b4c7.Builder.() -> Unit,
): InlineV1TreasuryOutboundPab148PostRequestFormAnyOf1X6362b4c7 =
    InlineV1TreasuryOutboundPab148PostRequestFormAnyOf1X6362b4c7.build(block)
