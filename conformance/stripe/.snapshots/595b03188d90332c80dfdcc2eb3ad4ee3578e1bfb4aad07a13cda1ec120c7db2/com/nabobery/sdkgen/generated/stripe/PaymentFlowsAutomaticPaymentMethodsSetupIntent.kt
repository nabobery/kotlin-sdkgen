...
public data class PaymentFlowsAutomaticPaymentMethodsSetupIntentView(
    ...
    public val allowRedirects: InlinePaymentFlowsAutomaticPaymentMethodsSetupIntentAllowRedirectsXdba377fb? = null,
...
public class PaymentFlowsAutomaticPaymentMethodsSetupIntent(
    ...
    public class Builder {
        ...
        public fun build(): PaymentFlowsAutomaticPaymentMethodsSetupIntent =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentFlowsAutomaticPaymentMethodsSetupIntent =
    ...
    public object Serializer : KSerializer<PaymentFlowsAutomaticPaymentMethodsSetupIntent> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "PaymentFlowsAutomaticPaymentMethodsSetupIntent must be a JSON object",
                    )
            return PaymentFlowsAutomaticPaymentMethodsSetupIntent(
                allowRedirects =
                    rawObject["allow_redirects"]?.let {
                        json
                            .decodeFromJsonElement<InlinePaymentFlowsAutomaticPaymentMethodsSetupIntentAllowRedirectsXdba377fb>(
                                it,
                            )
                    },
                enabled =
                    rawObject["enabled"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentFlowsAutomaticPaymentMethodsSetupIntent,
        ) {
...
public fun paymentFlowsAutomaticPaymentMethodsSetupIntent(
    block: PaymentFlowsAutomaticPaymentMethodsSetupIntent.Builder.() -> Unit,
): PaymentFlowsAutomaticPaymentMethodsSetupIntent = PaymentFlowsAutomaticPaymentMethodsSetupIntent.build(block)
