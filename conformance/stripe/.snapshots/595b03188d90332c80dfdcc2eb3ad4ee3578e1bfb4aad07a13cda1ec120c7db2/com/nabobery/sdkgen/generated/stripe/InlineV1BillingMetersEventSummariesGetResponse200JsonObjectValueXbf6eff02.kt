    ...
    public object Serializer : KSerializer<InlineV1BillingMetersEventSummariesGetResponse200JsonObjectValueXbf6eff02> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1BillingMetersEventSummariesGetResponse200JsonObjectValueXbf6eff02",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1BillingMetersEventSummariesGetResponse200JsonObjectValueXbf6eff02 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1BillingMetersEventSummariesGetResponse200JsonObjectValueXbf6eff02,
        ) {
