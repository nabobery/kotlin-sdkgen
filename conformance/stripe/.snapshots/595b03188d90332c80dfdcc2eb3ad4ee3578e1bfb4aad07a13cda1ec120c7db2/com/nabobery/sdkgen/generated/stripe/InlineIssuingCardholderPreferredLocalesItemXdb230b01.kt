...
public sealed class InlineIssuingCardholderPreferredLocalesItemXdb230b01 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineIssuingCardholderPreferredLocalesItemXdb230b01 =
            when (value) {
                De.value -> De
                En.value -> En
                Es.value -> Es
    ...
    public object Serializer : KSerializer<InlineIssuingCardholderPreferredLocalesItemXdb230b01> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineIssuingCardholderPreferredLocalesItemXdb230b01",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineIssuingCardholderPreferredLocalesItemXdb230b01 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineIssuingCardholderPreferredLocalesItemXdb230b01,
        ) {
