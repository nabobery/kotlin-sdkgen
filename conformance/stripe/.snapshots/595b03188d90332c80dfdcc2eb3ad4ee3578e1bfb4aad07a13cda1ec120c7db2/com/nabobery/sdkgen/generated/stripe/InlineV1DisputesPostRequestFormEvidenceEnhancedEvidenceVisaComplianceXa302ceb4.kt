...
public class InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceVisaComplianceXa302ceb4(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceVisaComplianceXa302ceb4 =
    ...
    public object Serializer : KSerializer<InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceVisaComplianceXa302ceb4> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceVisaComplianceXa302ceb4 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceVisaComplianceXa302ceb4,
        ) {
            val jsonEncoder =
...
public fun inlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceVisaComplianceXa302ceb4(
    block: InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceVisaComplianceXa302ceb4.Builder.() -> Unit,
): InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceVisaComplianceXa302ceb4 =
    InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceVisaComplianceXa302ceb4.build(block)
