...
public sealed class InlineV1TreasuryFinancialAc862PostRequestFormInboundFlowsX8e707fce {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1TreasuryFinancialAc862PostRequestFormInboundFlowsX8e707fce =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1TreasuryFinancialAc862PostRequestFormInboundFlowsX8e707fce> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1TreasuryFinancialAc862PostRequestFormInboundFlowsX8e707fce",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1TreasuryFinancialAc862PostRequestFormInboundFlowsX8e707fce =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TreasuryFinancialAc862PostRequestFormInboundFlowsX8e707fce,
        ) {
