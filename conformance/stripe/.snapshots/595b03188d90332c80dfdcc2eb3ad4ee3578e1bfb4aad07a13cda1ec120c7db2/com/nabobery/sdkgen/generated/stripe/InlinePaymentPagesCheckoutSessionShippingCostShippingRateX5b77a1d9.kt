...
public class InlinePaymentPagesCheckoutSessionShippingCostShippingRateX5b77a1d9 internal constructor(
    ...
    private val inspection: InlinePaymentPagesCheckoutSessionShippingCostShippingRateX5b77a1d9Inspection,
) {
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlinePaymentPagesCheckoutSessionShippingCostShippingRateX5b77a1d9Branch.Branch1,
                    )
                }
                if (inspection.matchesShippingRate) {
                    add(
                        InlinePaymentPagesCheckoutSessionShippingCostShippingRateX5b77a1d9Branch.ShippingRate,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlinePaymentPagesCheckoutSessionShippingCostShippingRateX5b77a1d9 {
            val inspection = inspectInlinePaymentPagesCheckoutSessionShippingCostShippingRateX5b77a1d9(raw)
            if (inspection.matchCount == 0) {
                throw InlinePaymentPagesCheckoutSessionShippingCostShippingRateX5b77a1d9NoMatchException(
                    "InlinePaymentPagesCheckoutSessionShippingCostShippingRateX5b77a1d9 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlinePaymentPagesCheckoutSessionShippingCostShippingRateX5b77a1d9> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentPagesCheckoutSessionShippingCostShippingRateX5b77a1d9,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlinePaymentPagesCheckoutSessionShippingCostShippingRateX5b77a1d9",
...
private fun inspectInlinePaymentPagesCheckoutSessionShippingCostShippingRateX5b77a1d9(
    element: JsonElement,
