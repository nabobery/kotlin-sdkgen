...
public class LegalEntityRegistrationDate(
    ...
    public class Builder {
        ...
        public fun build(): LegalEntityRegistrationDate =
    ...
    public object Serializer : KSerializer<LegalEntityRegistrationDate> {
        ...
        override fun deserialize(decoder: Decoder): LegalEntityRegistrationDate {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("LegalEntityRegistrationDate must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: LegalEntityRegistrationDate,
        ) {
...
public fun legalEntityRegistrationDate(
    block: LegalEntityRegistrationDate.Builder.() -> Unit,
): LegalEntityRegistrationDate = LegalEntityRegistrationDate.build(block)
