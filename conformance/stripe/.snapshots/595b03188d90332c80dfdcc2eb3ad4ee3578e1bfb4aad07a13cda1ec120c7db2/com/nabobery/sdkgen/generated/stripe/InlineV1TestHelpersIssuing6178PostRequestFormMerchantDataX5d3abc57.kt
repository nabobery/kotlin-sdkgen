...
public class InlineV1TestHelpersIssuing6178PostRequestFormMerchantDataX5d3abc57(
    public val category: InlineV1TestHelpersIssuing6178PostRequestFormMerchantDataCategoryX9c92121a? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1TestHelpersIssuing6178PostRequestFormMerchantDataX5d3abc57 =
            InlineV1TestHelpersIssuing6178PostRequestFormMerchantDataX5d3abc57(
                category = category,
                city = city,
                country = country,
                name = name,
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1TestHelpersIssuing6178PostRequestFormMerchantDataX5d3abc57 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TestHelpersIssuing6178PostRequestFormMerchantDataX5d3abc57> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TestHelpersIssuing6178PostRequestFormMerchantDataX5d3abc57 must be a JSON object",
                    )
            return InlineV1TestHelpersIssuing6178PostRequestFormMerchantDataX5d3abc57(
                category =
                    rawObject["category"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TestHelpersIssuing6178PostRequestFormMerchantDataCategoryX9c92121a>(
                                it,
                            )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TestHelpersIssuing6178PostRequestFormMerchantDataX5d3abc57,
        ) {
            val jsonEncoder =
...
public fun inlineV1TestHelpersIssuing6178PostRequestFormMerchantDataX5d3abc57(
    block: InlineV1TestHelpersIssuing6178PostRequestFormMerchantDataX5d3abc57.Builder.() -> Unit,
): InlineV1TestHelpersIssuing6178PostRequestFormMerchantDataX5d3abc57 =
    InlineV1TestHelpersIssuing6178PostRequestFormMerchantDataX5d3abc57.build(block)
