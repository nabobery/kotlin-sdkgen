...
internal data class InlineV1SubscriptionsPostRequestFormPaymentSettingsCustomerBalanceX4de1fde1Inspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesInlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X53d1933b,
                matchesInlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2X5a9029bf,
            ).count {
                it
            }
}
...
public class InlineV1SubscriptionsPostRequestFormPaymentSettingsCustomerBalanceX4de1fde1 internal constructor(
    ...
    private val inspection: InlineV1SubscriptionsPostRequestFormPaymentSettingsCustomerBalanceX4de1fde1Inspection,
) {
    public val inlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X53d1933b:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X53d1933b) {
                json
                    .decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X53d1933b>(
                        raw,
                    )
            } else {
                null
    ...
    public val inlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2X5a9029bf:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2X5a9029bf) {
                json
                    .decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2X5a9029bf>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches:
        ...
        get() =
            buildSet {
                if (inspection.matchesInlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X53d1933b) {
                    add(
                        InlineV1SubscriptionsPostRequestFormPaymentSettingsCustomerBalanceX4de1fde1Branch.InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X53d1933b,
                    )
                }
                if (inspection.matchesInlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2X5a9029bf) {
                    add(
                        InlineV1SubscriptionsPostRequestFormPaymentSettingsCustomerBalanceX4de1fde1Branch.InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2X5a9029bf,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1SubscriptionsPostRequestFormPaymentSettingsCustomerBalanceX4de1fde1 {
            val inspection = inspectInlineV1SubscriptionsPostRequestFormPaymentSettingsCustomerBalanceX4de1fde1(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1SubscriptionsPostRequestFormPaymentSettingsCustomerBalanceX4de1fde1NoMatchException(
                    "InlineV1SubscriptionsPostRequestFormPaymentSettingsCustomerBalanceX4de1fde1 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionsPostRequestFormPaymentSettingsCustomerBalanceX4de1fde1> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsPostRequestFormPaymentSettingsCustomerBalanceX4de1fde1,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1SubscriptionsPostRequestFormPaymentSettingsCustomerBalanceX4de1fde1",
...
private fun inspectInlineV1SubscriptionsPostRequestFormPaymentSettingsCustomerBalanceX4de1fde1(
    element: JsonElement,
): InlineV1SubscriptionsPostRequestFormPaymentSettingsCustomerBalanceX4de1fde1Inspection {
    val matchesInlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X53d1933b =
        element
            .isJsonDecodable<InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X53d1933b>()
    val matchesInlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2X5a9029bf =
        element
            .isJsonDecodable<InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2X5a9029bf>()
    return InlineV1SubscriptionsPostRequestFormPaymentSettingsCustomerBalanceX4de1fde1Inspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X53d1933b) {
                    add(
                        "InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X53d1933b: value does not match InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X53d1933b",
                    )
                }
                if (!matchesInlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2X5a9029bf) {
                    add(
                        "InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2X5a9029bf: value does not match InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2X5a9029bf",
                    )
                }
            },
    )
