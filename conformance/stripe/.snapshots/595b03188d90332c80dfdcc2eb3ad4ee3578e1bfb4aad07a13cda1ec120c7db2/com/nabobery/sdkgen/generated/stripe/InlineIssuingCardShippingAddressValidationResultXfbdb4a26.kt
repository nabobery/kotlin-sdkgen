...
public sealed class InlineIssuingCardShippingAddressValidationResultXfbdb4a26 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineIssuingCardShippingAddressValidationResultXfbdb4a26 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineIssuingCardShippingAddressValidationResultXfbdb4a26> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineIssuingCardShippingAddressValidationResultXfbdb4a26",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineIssuingCardShippingAddressValidationResultXfbdb4a26 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineIssuingCardShippingAddressValidationResultXfbdb4a26,
        ) {
