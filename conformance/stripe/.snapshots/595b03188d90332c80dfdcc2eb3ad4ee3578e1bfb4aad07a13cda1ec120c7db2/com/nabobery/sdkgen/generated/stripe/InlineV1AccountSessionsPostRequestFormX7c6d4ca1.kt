...
public class InlineV1AccountSessionsPostRequestFormX7c6d4ca1(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1AccountSessionsPostRequestFormX7c6d4ca1 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1AccountSessionsPostRequestFormX7c6d4ca1> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountSessionsPostRequestFormX7c6d4ca1 must be a JSON object",
                    )
            val account = json.decodeRequired<String>(rawObject, "account")
            val components =
                json.decodeRequired<InlineV1AccountSessionsPostRequestFormComponentsX621e47a3>(
                    rawObject,
                    "components",
                )
            return InlineV1AccountSessionsPostRequestFormX7c6d4ca1(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountSessionsPostRequestFormX7c6d4ca1,
        ) {
...
public fun inlineV1AccountSessionsPostRequestFormX7c6d4ca1(
    block: InlineV1AccountSessionsPostRequestFormX7c6d4ca1.Builder.() -> Unit,
): InlineV1AccountSessionsPostRequestFormX7c6d4ca1 = InlineV1AccountSessionsPostRequestFormX7c6d4ca1.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1AccountSessionsPostRequestFormX7c6d4ca1 is missing required property '" + name + "'",
            )
