...
public class SourceTransactionAchCreditTransferData(
    ...
    public class Builder {
        ...
        public fun build(): SourceTransactionAchCreditTransferData =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): SourceTransactionAchCreditTransferData =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<SourceTransactionAchCreditTransferData> {
        ...
        override fun deserialize(decoder: Decoder): SourceTransactionAchCreditTransferData {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("SourceTransactionAchCreditTransferData must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: SourceTransactionAchCreditTransferData,
        ) {
...
public fun sourceTransactionAchCreditTransferData(
    block: SourceTransactionAchCreditTransferData.Builder.() -> Unit,
): SourceTransactionAchCreditTransferData = SourceTransactionAchCreditTransferData.build(block)
