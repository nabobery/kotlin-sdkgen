...
internal data class InlineV1AccountsPostRequestFormSettingsStatementDescriptorP143dXce21b6d2Inspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1AccountsPostRequestFormSettingsCardPaymentsAnyOf2X42cf5631,
            ).count { it }
}
...
public class InlineV1AccountsPostRequestFormSettingsStatementDescriptorP143dXce21b6d2 internal constructor(
    ...
    private val inspection: InlineV1AccountsPostRequestFormSettingsStatementDescriptorP143dXce21b6d2Inspection,
) {
    ...
    public val inlineV1AccountsPostRequestFormSettingsCardPaymentsAnyOf2X42cf5631:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1AccountsPostRequestFormSettingsCardPaymentsAnyOf2X42cf5631) {
                json
                    .decodeFromJsonElement<InlineV1AccountsPostRequestFormSettingsCardPaymentsAnyOf2X42cf5631>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1AccountsPostRequestFormSettingsStatementDescriptorP143dXce21b6d2Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1AccountsPostRequestFormSettingsCardPaymentsAnyOf2X42cf5631) {
                    add(
                        InlineV1AccountsPostRequestFormSettingsStatementDescriptorP143dXce21b6d2Branch.InlineV1AccountsPostRequestFormSettingsCardPaymentsAnyOf2X42cf5631,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1AccountsPostRequestFormSettingsStatementDescriptorP143dXce21b6d2 {
            val inspection = inspectInlineV1AccountsPostRequestFormSettingsStatementDescriptorP143dXce21b6d2(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1AccountsPostRequestFormSettingsStatementDescriptorP143dXce21b6d2NoMatchException(
                    "InlineV1AccountsPostRequestFormSettingsStatementDescriptorP143dXce21b6d2 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1AccountsPostRequestFormSettingsStatementDescriptorP143dXce21b6d2> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPostRequestFormSettingsStatementDescriptorP143dXce21b6d2,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1AccountsPostRequestFormSettingsStatementDescriptorP143dXce21b6d2",
...
private fun inspectInlineV1AccountsPostRequestFormSettingsStatementDescriptorP143dXce21b6d2(
    element: JsonElement,
): InlineV1AccountsPostRequestFormSettingsStatementDescriptorP143dXce21b6d2Inspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1AccountsPostRequestFormSettingsCardPaymentsAnyOf2X42cf5631 =
        element
            .isJsonDecodable<InlineV1AccountsPostRequestFormSettingsCardPaymentsAnyOf2X42cf5631>()
    return InlineV1AccountsPostRequestFormSettingsStatementDescriptorP143dXce21b6d2Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1AccountsPostRequestFormSettingsCardPaymentsAnyOf2X42cf5631) {
                    add(
                        "InlineV1AccountsPostRequestFormSettingsCardPaymentsAnyOf2X42cf5631: value does not match InlineV1AccountsPostRequestFormSettingsCardPaymentsAnyOf2X42cf5631",
                    )
                }
            },
    )
