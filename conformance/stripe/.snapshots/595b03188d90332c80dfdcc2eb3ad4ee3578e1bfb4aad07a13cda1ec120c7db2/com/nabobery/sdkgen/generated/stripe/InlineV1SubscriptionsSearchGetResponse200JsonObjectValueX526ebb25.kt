...
public sealed class InlineV1SubscriptionsSearchGetResponse200JsonObjectValueX526ebb25 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1SubscriptionsSearchGetResponse200JsonObjectValueX526ebb25 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionsSearchGetResponse200JsonObjectValueX526ebb25> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1SubscriptionsSearchGetResponse200JsonObjectValueX526ebb25",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1SubscriptionsSearchGetResponse200JsonObjectValueX526ebb25 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsSearchGetResponse200JsonObjectValueX526ebb25,
        ) {
