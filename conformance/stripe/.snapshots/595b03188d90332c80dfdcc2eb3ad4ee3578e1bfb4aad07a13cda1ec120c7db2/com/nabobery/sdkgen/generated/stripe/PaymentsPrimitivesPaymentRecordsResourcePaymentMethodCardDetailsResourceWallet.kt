...
public class PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCardDetailsResourceWallet(
    ...
    public object Serializer : KSerializer<PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCardDetailsResourceWallet> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCardDetailsResourceWallet must be a JSON object",
                    )
            ...
            return PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCardDetailsResourceWallet(
                ...
                applePay =
                    rawObject["apple_pay"]?.let {
                        json
                            .decodeFromJsonElement<PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCardDetailsResourceWalletResourceApplePay>(
                                it,
                            )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCardDetailsResourceWallet,
        ) {
            val jsonEncoder =
...
public fun paymentsPrimitivesPaymentRecordsResourcePaymentMethodCardDetailsResourceWallet(
    block: PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCardDetailsResourceWallet.Builder.() -> Unit,
): PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCardDetailsResourceWallet =
    PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCardDetailsResourceWallet.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCardDetailsResourceWallet is missing required property '" +
                    name +
                    "'",
            )
