...
public class InlineV1TerminalLocationsPostRequestFormX2fb2d15d(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1TerminalLocationsPostRequestFormX2fb2d15d =
            InlineV1TerminalLocationsPostRequestFormX2fb2d15d(
                address = address,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TerminalLocationsPostRequestFormX2fb2d15d =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TerminalLocationsPostRequestFormX2fb2d15d> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TerminalLocationsPostRequestFormX2fb2d15d must be a JSON object",
                    )
            return InlineV1TerminalLocationsPostRequestFormX2fb2d15d(
                address =
                    rawObject["address"]?.let {
                        json.decodeFromJsonElement<InlineV1TerminalLocationsPostRequestFormAddressX385e076c>(it)
                    },
                addressKana =
                    rawObject["address_kana"]?.let {
                        json.decodeFromJsonElement<InlineV1TerminalLocationsPostRequestFormAddressKanaX64cba42d>(it)
                    },
                addressKanji =
                    rawObject["address_kanji"]?.let {
                        json.decodeFromJsonElement<InlineV1TerminalLocationsPostRequestFormAddressKanjiXf6d62bb2>(it)
                    },
                ...
                metadata =
                    rawObject["metadata"]?.let {
                        json.decodeFromJsonElement<InlineV1TerminalLocationsPostRequestFormMetadataX75793346>(it)
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TerminalLocationsPostRequestFormX2fb2d15d,
        ) {
...
public fun inlineV1TerminalLocationsPostRequestFormX2fb2d15d(
    block: InlineV1TerminalLocationsPostRequestFormX2fb2d15d.Builder.() -> Unit,
): InlineV1TerminalLocationsPostRequestFormX2fb2d15d = InlineV1TerminalLocationsPostRequestFormX2fb2d15d.build(block)
