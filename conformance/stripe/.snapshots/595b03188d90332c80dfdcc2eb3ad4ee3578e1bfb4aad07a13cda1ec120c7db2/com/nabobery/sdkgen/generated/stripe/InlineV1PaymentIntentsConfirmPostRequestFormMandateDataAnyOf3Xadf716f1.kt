...
public class InlineV1PaymentIntentsConfirmPostRequestFormMandateDataAnyOf3Xadf716f1(
    public val customerAcceptance: InlineV1PaymentIntentsConfirmPostRequestFormCustomerAcceptanceXe7c2e6ff,
) {
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentIntentsConfirmPostRequestFormMandateDataAnyOf3Xadf716f1 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsConfirmPostRequestFormMandateDataAnyOf3Xadf716f1> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsConfirmPostRequestFormMandateDataAnyOf3Xadf716f1 must be a JSON object",
                    )
            val customerAcceptance =
                json
                    .decodeRequired<InlineV1PaymentIntentsConfirmPostRequestFormCustomerAcceptanceXe7c2e6ff>(
                        rawObject,
                        "customer_acceptance",
                    )
            return InlineV1PaymentIntentsConfirmPostRequestFormMandateDataAnyOf3Xadf716f1(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsConfirmPostRequestFormMandateDataAnyOf3Xadf716f1,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentIntentsConfirmPostRequestFormMandateDataAnyOf3Xadf716f1(
    block: InlineV1PaymentIntentsConfirmPostRequestFormMandateDataAnyOf3Xadf716f1.Builder.() -> Unit,
): InlineV1PaymentIntentsConfirmPostRequestFormMandateDataAnyOf3Xadf716f1 =
    InlineV1PaymentIntentsConfirmPostRequestFormMandateDataAnyOf3Xadf716f1.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentIntentsConfirmPostRequestFormMandateDataAnyOf3Xadf716f1 is missing required property '" +
                    name +
                    "'",
            )
