...
public sealed class InlineV1ApplicationFeesRefundsPostRequestFormMetadataAnyOf2Xe97b3b66 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1ApplicationFeesRefundsPostRequestFormMetadataAnyOf2Xe97b3b66 =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1ApplicationFeesRefundsPostRequestFormMetadataAnyOf2Xe97b3b66> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1ApplicationFeesRefundsPostRequestFormMetadataAnyOf2Xe97b3b66",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1ApplicationFeesRefundsPostRequestFormMetadataAnyOf2Xe97b3b66 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ApplicationFeesRefundsPostRequestFormMetadataAnyOf2Xe97b3b66,
        ) {
