...
public class InlineV1AccountsPostRequestFormBusinessProfileMonthlyEstimatedRevenueX6918608c(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1AccountsPostRequestFormBusinessProfileMonthlyEstimatedRevenueX6918608c =
    ...
    public object Serializer : KSerializer<InlineV1AccountsPostRequestFormBusinessProfileMonthlyEstimatedRevenueX6918608c> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountsPostRequestFormBusinessProfileMonthlyEstimatedRevenueX6918608c must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPostRequestFormBusinessProfileMonthlyEstimatedRevenueX6918608c,
        ) {
            val jsonEncoder =
...
public fun inlineV1AccountsPostRequestFormBusinessProfileMonthlyEstimatedRevenueX6918608c(
    block: InlineV1AccountsPostRequestFormBusinessProfileMonthlyEstimatedRevenueX6918608c.Builder.() -> Unit,
): InlineV1AccountsPostRequestFormBusinessProfileMonthlyEstimatedRevenueX6918608c =
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1AccountsPostRequestFormBusinessProfileMonthlyEstimatedRevenueX6918608c is missing required property '" +
                    name +
                    "'",
            )
