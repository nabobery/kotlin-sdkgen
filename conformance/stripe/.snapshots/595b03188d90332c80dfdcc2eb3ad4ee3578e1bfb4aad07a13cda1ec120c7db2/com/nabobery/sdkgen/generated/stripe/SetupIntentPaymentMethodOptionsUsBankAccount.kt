...
public data class SetupIntentPaymentMethodOptionsUsBankAccountView(
    ...
    public val verificationMethod: InlineSetupIntentPaymentMethodOptionsUsBankAccountVerificationMethodX8221aaf5? = null,
)
...
public class SetupIntentPaymentMethodOptionsUsBankAccount(
    ...
    public class Builder {
        ...
        public fun build(): SetupIntentPaymentMethodOptionsUsBankAccount =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): SetupIntentPaymentMethodOptionsUsBankAccount =
    ...
    public object Serializer : KSerializer<SetupIntentPaymentMethodOptionsUsBankAccount> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "SetupIntentPaymentMethodOptionsUsBankAccount must be a JSON object",
                    )
            return SetupIntentPaymentMethodOptionsUsBankAccount(
                ...
                verificationMethod =
                    rawObject["verification_method"]?.let {
                        json
                            .decodeFromJsonElement<InlineSetupIntentPaymentMethodOptionsUsBankAccountVerificationMethodX8221aaf5>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: SetupIntentPaymentMethodOptionsUsBankAccount,
        ) {
...
public fun setupIntentPaymentMethodOptionsUsBankAccount(
    block: SetupIntentPaymentMethodOptionsUsBankAccount.Builder.() -> Unit,
): SetupIntentPaymentMethodOptionsUsBankAccount = SetupIntentPaymentMethodOptionsUsBankAccount.build(block)
