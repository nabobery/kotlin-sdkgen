...
public class InlineV1IssuingPersonalizationDesignsPostRequestFormPreferencesX547769ab(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1IssuingPersonalizationDesignsPostRequestFormPreferencesX547769ab = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1IssuingPersonalizationDesignsPostRequestFormPreferencesX547769ab> {
        ...
        override fun deserialize(
            decoder: Decoder,
        ): InlineV1IssuingPersonalizationDesignsPostRequestFormPreferencesX547769ab {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1IssuingPersonalizationDesignsPostRequestFormPreferencesX547769ab must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingPersonalizationDesignsPostRequestFormPreferencesX547769ab,
        ) {
            val jsonEncoder =
...
public fun inlineV1IssuingPersonalizationDesignsPostRequestFormPreferencesX547769ab(
    block: InlineV1IssuingPersonalizationDesignsPostRequestFormPreferencesX547769ab.Builder.() -> Unit,
): InlineV1IssuingPersonalizationDesignsPostRequestFormPreferencesX547769ab =
    InlineV1IssuingPersonalizationDesignsPostRequestFormPreferencesX547769ab.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1IssuingPersonalizationDesignsPostRequestFormPreferencesX547769ab is missing required property '" +
                    name +
                    "'",
            )
