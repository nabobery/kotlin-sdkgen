        ...
        override fun deserialize(decoder: Decoder): Charge {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("Charge must be a JSON object")
            ...
            return Charge(
                ...
                application =
                    rawObject["application"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineChargeApplicationX08556321?>(element)
                        }
                    },
                applicationFee =
                    rawObject["application_fee"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineChargeApplicationFeeX9fc79449?>(element)
                        }
                    },
                ...
                balanceTransaction =
                    rawObject["balance_transaction"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineChargeBalanceTransactionX1a715a0c?>(element)
                        }
                    },
                calculatedStatementDescriptor =
                    rawObject["calculated_statement_descriptor"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                customer =
                    rawObject["customer"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineChargeCustomerXaca36065?>(element)
                        }
                    },
                description =
                ...
                failureBalanceTransaction =
                    rawObject["failure_balance_transaction"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineChargeFailureBalanceTransactionXac287bb7?>(element)
                        }
                    },
                failureCode =
                ...
                fraudDetails =
                    rawObject["fraud_details"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineChargeFraudDetailsX7b862bff?>(element)
                        }
                    },
                onBehalfOf =
                    rawObject["on_behalf_of"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineChargeOnBehalfOfXa14b2bb1?>(element)
                        }
                    },
                outcome =
                    rawObject["outcome"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineChargeOutcomeXd5852e19?>(element)
                        }
                    },
                paymentIntent =
                    rawObject["payment_intent"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineChargePaymentIntentX8b049512?>(element)
                        }
                    },
                paymentMethod =
                ...
                paymentMethodDetails =
                    rawObject["payment_method_details"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineChargePaymentMethodDetailsXaabd978e?>(element)
                        }
                    },
                presentmentDetails =
                    rawObject["presentment_details"]
                        ?.let {
                            json
                                .decodeFromJsonElement<PaymentFlowsPaymentIntentPresentmentDetails>(
                                    it,
                                )
                        },
                radarOptions =
                    rawObject["radar_options"]?.let {
                        json.decodeFromJsonElement<RadarRadarOptions>(
                            it,
                        )
                    },
                receiptEmail =
                ...
                receiptUrl =
                    rawObject["receipt_url"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                refunds =
                    rawObject["refunds"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineChargeRefundsX8d7dd526?>(element)
                        }
                    },
                review =
                    rawObject["review"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineChargeReviewXd3d4b3a3?>(element)
                        }
                    },
                shipping =
                    rawObject["shipping"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineChargeShippingX04f101e2?>(element)
                        }
                    },
                sourceTransfer =
                    rawObject["source_transfer"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineChargeSourceTransferX8ea76f8f?>(element)
                        }
                    },
                statementDescriptor =
                ...
                transfer =
                    rawObject["transfer"]?.let {
                        json
                            .decodeFromJsonElement<InlineChargeTransferX1843c71d>(
                                it,
                            )
                    },
                transferData =
                    rawObject["transfer_data"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineChargeTransferDataX5f87055e?>(element)
                        }
                    },
                transferGroup =
        ...
        override fun serialize(
            ...
            val raw =
                buildJsonObject {
                    ...
                    value.failureBalanceTransaction?.let {
                        put(
