...
public class TaxProductRegistrationsResourceCountryOptionsUsLocalAmusementTax(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): TaxProductRegistrationsResourceCountryOptionsUsLocalAmusementTax =
    ...
    public object Serializer : KSerializer<TaxProductRegistrationsResourceCountryOptionsUsLocalAmusementTax> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "TaxProductRegistrationsResourceCountryOptionsUsLocalAmusementTax must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: TaxProductRegistrationsResourceCountryOptionsUsLocalAmusementTax,
        ) {
            val jsonEncoder =
...
public fun taxProductRegistrationsResourceCountryOptionsUsLocalAmusementTax(
    block: TaxProductRegistrationsResourceCountryOptionsUsLocalAmusementTax.Builder.() -> Unit,
): TaxProductRegistrationsResourceCountryOptionsUsLocalAmusementTax =
    TaxProductRegistrationsResourceCountryOptionsUsLocalAmusementTax.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "TaxProductRegistrationsResourceCountryOptionsUsLocalAmusementTax is missing required property '" + name +
                    "'",
            )
