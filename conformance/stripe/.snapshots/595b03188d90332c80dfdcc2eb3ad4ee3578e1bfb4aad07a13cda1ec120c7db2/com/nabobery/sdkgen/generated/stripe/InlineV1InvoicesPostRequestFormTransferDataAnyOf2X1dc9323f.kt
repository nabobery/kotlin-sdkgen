...
public sealed class InlineV1InvoicesPostRequestFormTransferDataAnyOf2X1dc9323f {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1InvoicesPostRequestFormTransferDataAnyOf2X1dc9323f =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1InvoicesPostRequestFormTransferDataAnyOf2X1dc9323f> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1InvoicesPostRequestFormTransferDataAnyOf2X1dc9323f",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1InvoicesPostRequestFormTransferDataAnyOf2X1dc9323f =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesPostRequestFormTransferDataAnyOf2X1dc9323f,
        ) {
