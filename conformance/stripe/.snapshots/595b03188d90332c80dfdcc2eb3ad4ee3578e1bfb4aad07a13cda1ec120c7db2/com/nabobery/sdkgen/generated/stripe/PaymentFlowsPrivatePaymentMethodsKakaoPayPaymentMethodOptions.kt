...
public class PaymentFlowsPrivatePaymentMethodsKakaoPayPaymentMethodOptions(
    ...
    public class Builder {
        ...
        public fun build(): PaymentFlowsPrivatePaymentMethodsKakaoPayPaymentMethodOptions =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentFlowsPrivatePaymentMethodsKakaoPayPaymentMethodOptions =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentFlowsPrivatePaymentMethodsKakaoPayPaymentMethodOptions> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "PaymentFlowsPrivatePaymentMethodsKakaoPayPaymentMethodOptions must be a JSON object",
                    )
            return PaymentFlowsPrivatePaymentMethodsKakaoPayPaymentMethodOptions(
                captureMethod =
                    rawObject["capture_method"]?.let {
                        json.decodeFromJsonElement<InlinePaymentFlowsPrivateP9f6bCaptureMethodX669a801b>(it)
                    },
                setupFutureUsage =
                    rawObject["setup_future_usage"]?.let {
                        json.decodeFromJsonElement<InlinePaymentFlowsPrivateP9f6bSetupFutureUsageX804059ac>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentFlowsPrivatePaymentMethodsKakaoPayPaymentMethodOptions,
        ) {
            val jsonEncoder =
...
public fun paymentFlowsPrivatePaymentMethodsKakaoPayPaymentMethodOptions(
    block: PaymentFlowsPrivatePaymentMethodsKakaoPayPaymentMethodOptions.Builder.() -> Unit,
): PaymentFlowsPrivatePaymentMethodsKakaoPayPaymentMethodOptions =
    PaymentFlowsPrivatePaymentMethodsKakaoPayPaymentMethodOptions.build(block)
