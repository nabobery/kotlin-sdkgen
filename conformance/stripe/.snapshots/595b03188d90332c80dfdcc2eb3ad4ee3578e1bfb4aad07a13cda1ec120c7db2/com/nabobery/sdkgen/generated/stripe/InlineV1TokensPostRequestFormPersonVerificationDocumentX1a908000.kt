...
public class InlineV1TokensPostRequestFormPersonVerificationDocumentX1a908000(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1TokensPostRequestFormPersonVerificationDocumentX1a908000 =
            InlineV1TokensPostRequestFormPersonVerificationDocumentX1a908000(
                back = back,
                front = front,
            )
    }
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TokensPostRequestFormPersonVerificationDocumentX1a908000 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TokensPostRequestFormPersonVerificationDocumentX1a908000> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TokensPostRequestFormPersonVerificationDocumentX1a908000 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TokensPostRequestFormPersonVerificationDocumentX1a908000,
        ) {
            val jsonEncoder =
...
public fun inlineV1TokensPostRequestFormPersonVerificationDocumentX1a908000(
    block: InlineV1TokensPostRequestFormPersonVerificationDocumentX1a908000.Builder.() -> Unit,
): InlineV1TokensPostRequestFormPersonVerificationDocumentX1a908000 =
    InlineV1TokensPostRequestFormPersonVerificationDocumentX1a908000.build(block)
