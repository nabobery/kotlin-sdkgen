...
public class CustomerBalanceResourceCashBalanceTransactionResourceAppliedToPaymentTransaction(
    ...
    public object Serializer : KSerializer<CustomerBalanceResourceCashBalanceTransactionResourceAppliedToPaymentTransaction> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "CustomerBalanceResourceCashBalanceTransactionResourceAppliedToPaymentTransaction must be a JSON object",
                    )
            val paymentIntent =
                json.decodeRequired<InlineCustomerBalanceResou9e8cPaymentIntentX4b2cc7d8>(
                    rawObject,
                    "payment_intent",
                )
            return CustomerBalanceResourceCashBalanceTransactionResourceAppliedToPaymentTransaction(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: CustomerBalanceResourceCashBalanceTransactionResourceAppliedToPaymentTransaction,
        ) {
            val jsonEncoder =
...
public fun customerBalanceResourceCashBalanceTransactionResourceAppliedToPaymentTransaction(
    block: CustomerBalanceResourceCashBalanceTransactionResourceAppliedToPaymentTransaction.Builder.() -> Unit,
): CustomerBalanceResourceCashBalanceTransactionResourceAppliedToPaymentTransaction =
    CustomerBalanceResourceCashBalanceTransactionResourceAppliedToPaymentTransaction.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "CustomerBalanceResourceCashBalanceTransactionResourceAppliedToPaymentTransaction is missing required property '" +
                    name +
                    "'",
            )
