...
public class ShippingRateDeliveryEstimate(
    ...
    public class Builder {
        ...
        public fun build(): ShippingRateDeliveryEstimate =
    ...
    public object Serializer : KSerializer<ShippingRateDeliveryEstimate> {
        ...
        override fun deserialize(decoder: Decoder): ShippingRateDeliveryEstimate {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("ShippingRateDeliveryEstimate must be a JSON object")
                ...
                maximum =
                    rawObject["maximum"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineShippingRateDeliveryEstimateMaximumXeb077f32?>(element)
                        }
                    },
                minimum =
                    rawObject["minimum"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineShippingRateDeliveryEstimateMinimumX4d9cece9?>(element)
                        }
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: ShippingRateDeliveryEstimate,
        ) {
...
public fun shippingRateDeliveryEstimate(
    block: ShippingRateDeliveryEstimate.Builder.() -> Unit,
): ShippingRateDeliveryEstimate = ShippingRateDeliveryEstimate.build(block)
