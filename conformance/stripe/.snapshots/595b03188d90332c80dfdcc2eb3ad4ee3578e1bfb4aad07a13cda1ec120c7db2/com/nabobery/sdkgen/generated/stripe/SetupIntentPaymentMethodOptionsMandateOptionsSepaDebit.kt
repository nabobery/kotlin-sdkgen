...
public class SetupIntentPaymentMethodOptionsMandateOptionsSepaDebit(
    ...
    public class Builder {
        ...
        public fun build(): SetupIntentPaymentMethodOptionsMandateOptionsSepaDebit =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): SetupIntentPaymentMethodOptionsMandateOptionsSepaDebit =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<SetupIntentPaymentMethodOptionsMandateOptionsSepaDebit> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "SetupIntentPaymentMethodOptionsMandateOptionsSepaDebit must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: SetupIntentPaymentMethodOptionsMandateOptionsSepaDebit,
        ) {
...
public fun setupIntentPaymentMethodOptionsMandateOptionsSepaDebit(
    block: SetupIntentPaymentMethodOptionsMandateOptionsSepaDebit.Builder.() -> Unit,
): SetupIntentPaymentMethodOptionsMandateOptionsSepaDebit =
    SetupIntentPaymentMethodOptionsMandateOptionsSepaDebit.build(block)
