...
public sealed class InlineV1IssuingPhysicalBundlesGetParameterX9515a673 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1IssuingPhysicalBundlesGetParameterX9515a673 =
            when (value) {
                Custom.value -> Custom
    ...
    public object Serializer : KSerializer<InlineV1IssuingPhysicalBundlesGetParameterX9515a673> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1IssuingPhysicalBundlesGetParameterX9515a673",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1IssuingPhysicalBundlesGetParameterX9515a673 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingPhysicalBundlesGetParameterX9515a673,
        ) {
