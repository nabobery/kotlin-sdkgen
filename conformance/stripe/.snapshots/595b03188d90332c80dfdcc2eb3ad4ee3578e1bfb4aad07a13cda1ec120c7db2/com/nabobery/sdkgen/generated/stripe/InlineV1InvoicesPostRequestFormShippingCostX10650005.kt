...
internal data class InlineV1InvoicesPostRequestFormShippingCostX10650005Inspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesInlineV1InvoicesPostRequestFormShippingCostAnyOf1Xcc788bed,
                matchesInlineV1InvoicesPostRequestFormShippingCostAnyOf2X1e639276,
            ).count {
                it
            }
}
...
public class InlineV1InvoicesPostRequestFormShippingCostX10650005 internal constructor(
    ...
    public val inlineV1InvoicesPostRequestFormShippingCostAnyOf1Xcc788bed:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1InvoicesPostRequestFormShippingCostAnyOf1Xcc788bed) {
                json
                    .decodeFromJsonElement<InlineV1InvoicesPostRequestFormShippingCostAnyOf1Xcc788bed>(
                        raw,
                    )
            } else {
                null
    ...
    public val inlineV1InvoicesPostRequestFormShippingCostAnyOf2X1e639276:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1InvoicesPostRequestFormShippingCostAnyOf2X1e639276) {
                json
                    .decodeFromJsonElement<InlineV1InvoicesPostRequestFormShippingCostAnyOf2X1e639276>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1InvoicesPostRequestFormShippingCostX10650005Branch>
        get() =
            buildSet {
                if (inspection.matchesInlineV1InvoicesPostRequestFormShippingCostAnyOf1Xcc788bed) {
                    add(
                        InlineV1InvoicesPostRequestFormShippingCostX10650005Branch.InlineV1InvoicesPostRequestFormShippingCostAnyOf1Xcc788bed,
                    )
                }
                if (inspection.matchesInlineV1InvoicesPostRequestFormShippingCostAnyOf2X1e639276) {
                    add(
                        InlineV1InvoicesPostRequestFormShippingCostX10650005Branch.InlineV1InvoicesPostRequestFormShippingCostAnyOf2X1e639276,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1InvoicesPostRequestFormShippingCostX10650005 {
            val inspection = inspectInlineV1InvoicesPostRequestFormShippingCostX10650005(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1InvoicesPostRequestFormShippingCostX10650005NoMatchException(
                    "InlineV1InvoicesPostRequestFormShippingCostX10650005 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1InvoicesPostRequestFormShippingCostX10650005> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesPostRequestFormShippingCostX10650005,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1InvoicesPostRequestFormShippingCostX10650005",
...
private fun inspectInlineV1InvoicesPostRequestFormShippingCostX10650005(
    element: JsonElement,
): InlineV1InvoicesPostRequestFormShippingCostX10650005Inspection {
    val matchesInlineV1InvoicesPostRequestFormShippingCostAnyOf1Xcc788bed =
        element
            .isJsonDecodable<InlineV1InvoicesPostRequestFormShippingCostAnyOf1Xcc788bed>()
    val matchesInlineV1InvoicesPostRequestFormShippingCostAnyOf2X1e639276 =
        element
            .isJsonDecodable<InlineV1InvoicesPostRequestFormShippingCostAnyOf2X1e639276>()
    return InlineV1InvoicesPostRequestFormShippingCostX10650005Inspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1InvoicesPostRequestFormShippingCostAnyOf1Xcc788bed) {
                    add(
                        "InlineV1InvoicesPostRequestFormShippingCostAnyOf1Xcc788bed: value does not match InlineV1InvoicesPostRequestFormShippingCostAnyOf1Xcc788bed",
                    )
                }
                if (!matchesInlineV1InvoicesPostRequestFormShippingCostAnyOf2X1e639276) {
                    add(
                        "InlineV1InvoicesPostRequestFormShippingCostAnyOf2X1e639276: value does not match InlineV1InvoicesPostRequestFormShippingCostAnyOf2X1e639276",
                    )
                }
            },
    )
