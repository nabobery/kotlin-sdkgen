...
public class InlineV1TestHelpersIssuing214aPostRequestFormCardTestingRiskX361646a9(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1TestHelpersIssuing214aPostRequestFormCardTestingRiskX361646a9 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1TestHelpersIssuing214aPostRequestFormCardTestingRiskX361646a9> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TestHelpersIssuing214aPostRequestFormCardTestingRiskX361646a9 must be a JSON object",
                    )
            val level =
                json.decodeRequired<InlineV1TestHelpersIssuing214aPostRequestFormRiskAssessmentLevelX3ba9bd81>(
                    rawObject,
                    "level",
                )
            return InlineV1TestHelpersIssuing214aPostRequestFormCardTestingRiskX361646a9(
                ...
                invalidAccountNumberDeclineRatePastHour =
                    rawObject["invalid_account_number_decline_rate_past_hour"]?.let {
                        json.decodeFromJsonElement<Int>(it)
                    },
                invalidCredentialsDeclineRatePastHour =
                    rawObject["invalid_credentials_decline_rate_past_hour"]?.let {
                        json.decodeFromJsonElement<Int>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TestHelpersIssuing214aPostRequestFormCardTestingRiskX361646a9,
        ) {
            val jsonEncoder =
            ...
            val raw =
                buildJsonObject {
                    ...
                    value.invalidAccountNumberDeclineRatePastHour?.let {
                        put("invalid_account_number_decline_rate_past_hour", json.encodeToJsonElement(it))
                    }
                    value.invalidCredentialsDeclineRatePastHour?.let {
                        put("invalid_credentials_decline_rate_past_hour", json.encodeToJsonElement(it))
                    }
                }
...
public fun inlineV1TestHelpersIssuing214aPostRequestFormCardTestingRiskX361646a9(
    block: InlineV1TestHelpersIssuing214aPostRequestFormCardTestingRiskX361646a9.Builder.() -> Unit,
): InlineV1TestHelpersIssuing214aPostRequestFormCardTestingRiskX361646a9 =
    InlineV1TestHelpersIssuing214aPostRequestFormCardTestingRiskX361646a9.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TestHelpersIssuing214aPostRequestFormCardTestingRiskX361646a9 is missing required property '" +
                    name +
                    "'",
            )
