...
public class InlineV1TreasuryOutboundPab148PostRequestFormPhoneXd6b64e7e internal constructor(
    ...
    public val inlineV1TreasuryOutboundPab148PostRequestFormAnyOf2X99cb2e34:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1TreasuryOutboundPab148PostRequestFormAnyOf2X99cb2e34) {
                json
                    .decodeFromJsonElement<InlineV1TreasuryOutboundPab148PostRequestFormAnyOf2X99cb2e34>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1TreasuryOutboundPab148PostRequestFormPhoneXd6b64e7eBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1TreasuryOutboundPab148PostRequestFormAnyOf2X99cb2e34) {
                    add(
                        InlineV1TreasuryOutboundPab148PostRequestFormPhoneXd6b64e7eBranch.InlineV1TreasuryOutboundPab148PostRequestFormAnyOf2X99cb2e34,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1TreasuryOutboundPab148PostRequestFormPhoneXd6b64e7e {
            val inspection = inspectInlineV1TreasuryOutboundPab148PostRequestFormPhoneXd6b64e7e(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1TreasuryOutboundPab148PostRequestFormPhoneXd6b64e7eNoMatchException(
                    "InlineV1TreasuryOutboundPab148PostRequestFormPhoneXd6b64e7e matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1TreasuryOutboundPab148PostRequestFormPhoneXd6b64e7e> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TreasuryOutboundPab148PostRequestFormPhoneXd6b64e7e,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1TreasuryOutboundPab148PostRequestFormPhoneXd6b64e7e",
...
private fun inspectInlineV1TreasuryOutboundPab148PostRequestFormPhoneXd6b64e7e(
    element: JsonElement,
): InlineV1TreasuryOutboundPab148PostRequestFormPhoneXd6b64e7eInspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1TreasuryOutboundPab148PostRequestFormAnyOf2X99cb2e34 =
        element
            .isJsonDecodable<InlineV1TreasuryOutboundPab148PostRequestFormAnyOf2X99cb2e34>()
    return InlineV1TreasuryOutboundPab148PostRequestFormPhoneXd6b64e7eInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1TreasuryOutboundPab148PostRequestFormAnyOf2X99cb2e34) {
                    add(
                        "InlineV1TreasuryOutboundPab148PostRequestFormAnyOf2X99cb2e34: value does not match InlineV1TreasuryOutboundPab148PostRequestFormAnyOf2X99cb2e34",
                    )
                }
            },
    )
