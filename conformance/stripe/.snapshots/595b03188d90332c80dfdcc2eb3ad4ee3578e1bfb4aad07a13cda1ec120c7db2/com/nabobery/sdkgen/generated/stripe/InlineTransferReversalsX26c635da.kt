...
public class InlineTransferReversalsX26c635da(
    ...
    public object Serializer : KSerializer<InlineTransferReversalsX26c635da> {
        ...
        override fun deserialize(decoder: Decoder): InlineTransferReversalsX26c635da {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("InlineTransferReversalsX26c635da must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineTransferReversalsX26c635da,
        ) {
...
public fun inlineTransferReversalsX26c635da(
    block: InlineTransferReversalsX26c635da.Builder.() -> Unit,
): InlineTransferReversalsX26c635da = InlineTransferReversalsX26c635da.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineTransferReversalsX26c635da is missing required property '" + name + "'",
            )
