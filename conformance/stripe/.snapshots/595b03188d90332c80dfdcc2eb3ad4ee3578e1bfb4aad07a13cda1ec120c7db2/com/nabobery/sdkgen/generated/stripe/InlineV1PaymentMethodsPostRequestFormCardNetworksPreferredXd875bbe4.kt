...
public sealed class InlineV1PaymentMethodsPostRequestFormCardNetworksPreferredXd875bbe4 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1PaymentMethodsPostRequestFormCardNetworksPreferredXd875bbe4 =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1PaymentMethodsPostRequestFormCardNetworksPreferredXd875bbe4> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1PaymentMethodsPostRequestFormCardNetworksPreferredXd875bbe4",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1PaymentMethodsPostRequestFormCardNetworksPreferredXd875bbe4 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentMethodsPostRequestFormCardNetworksPreferredXd875bbe4,
        ) {
