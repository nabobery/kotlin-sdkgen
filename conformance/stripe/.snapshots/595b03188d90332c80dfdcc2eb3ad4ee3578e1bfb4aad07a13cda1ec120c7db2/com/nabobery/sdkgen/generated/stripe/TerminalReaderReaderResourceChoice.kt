...
public class TerminalReaderReaderResourceChoice(
    ...
    public object Serializer : KSerializer<TerminalReaderReaderResourceChoice> {
        ...
        override fun deserialize(decoder: Decoder): TerminalReaderReaderResourceChoice {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("TerminalReaderReaderResourceChoice must be a JSON object")
            ...
            return TerminalReaderReaderResourceChoice(
                ...
                style =
                    rawObject["style"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineTerminalReaderReaderResourceChoiceStyleX04084fe4?>(element)
                        }
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: TerminalReaderReaderResourceChoice,
        ) {
...
public fun terminalReaderReaderResourceChoice(
    block: TerminalReaderReaderResourceChoice.Builder.() -> Unit,
): TerminalReaderReaderResourceChoice = TerminalReaderReaderResourceChoice.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "TerminalReaderReaderResourceChoice is missing required property '" + name + "'",
            )
