...
public class InlineV1ForwardingRequestsPostRequestFormXe4abb4a8(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1ForwardingRequestsPostRequestFormXe4abb4a8 =
    ...
    public object Serializer : KSerializer<InlineV1ForwardingRequestsPostRequestFormXe4abb4a8> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1ForwardingRequestsPostRequestFormXe4abb4a8 {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1ForwardingRequestsPostRequestFormXe4abb4a8 must be a JSON object",
                    )
            val paymentMethod = json.decodeRequired<String>(rawObject, "payment_method")
            val replacements =
                json.decodeRequired<List<InlineV1ForwardingRequestsPostRequestFormReplacementsItemXbf70f2da>>(
                    rawObject,
                    "replacements",
                )
            ...
            return InlineV1ForwardingRequestsPostRequestFormXe4abb4a8(
                ...
                request =
                    rawObject["request"]?.let {
                        json.decodeFromJsonElement<InlineV1ForwardingRequestsPostRequestFormRequestX7fbe792d>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ForwardingRequestsPostRequestFormXe4abb4a8,
        ) {
...
public fun inlineV1ForwardingRequestsPostRequestFormXe4abb4a8(
    block: InlineV1ForwardingRequestsPostRequestFormXe4abb4a8.Builder.() -> Unit,
): InlineV1ForwardingRequestsPostRequestFormXe4abb4a8 = InlineV1ForwardingRequestsPostRequestFormXe4abb4a8.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1ForwardingRequestsPostRequestFormXe4abb4a8 is missing required property '" + name + "'",
            )
