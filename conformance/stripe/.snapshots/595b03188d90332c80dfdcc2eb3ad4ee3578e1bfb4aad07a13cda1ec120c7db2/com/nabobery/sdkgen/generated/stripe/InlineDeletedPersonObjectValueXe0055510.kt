...
public sealed class InlineDeletedPersonObjectValueXe0055510 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineDeletedPersonObjectValueXe0055510 =
            when (value) {
                Person.value -> Person
    ...
    public object Serializer : KSerializer<InlineDeletedPersonObjectValueXe0055510> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineDeletedPersonObjectValueXe0055510",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineDeletedPersonObjectValueXe0055510 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineDeletedPersonObjectValueXe0055510,
        ) {
