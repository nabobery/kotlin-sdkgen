...
public class InlineV1AccountsCapabilitiesGetResponse200JsonX87f9b592(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1AccountsCapabilitiesGetResponse200JsonX87f9b592 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1AccountsCapabilitiesGetResponse200JsonX87f9b592> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountsCapabilitiesGetResponse200JsonX87f9b592 must be a JSON object",
                    )
            val data = json.decodeRequired<List<Capability>>(rawObject, "data")
            val hasMore = json.decodeRequired<Boolean>(rawObject, "has_more")
            val objectValue =
                json.decodeRequired<InlineV1AccountsCapabilitiesGetResponse200JsonObjectValueX5eb6c961>(
                    rawObject,
                    "object",
                )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsCapabilitiesGetResponse200JsonX87f9b592,
        ) {
...
public fun inlineV1AccountsCapabilitiesGetResponse200JsonX87f9b592(
    block: InlineV1AccountsCapabilitiesGetResponse200JsonX87f9b592.Builder.() -> Unit,
): InlineV1AccountsCapabilitiesGetResponse200JsonX87f9b592 =
    InlineV1AccountsCapabilitiesGetResponse200JsonX87f9b592.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1AccountsCapabilitiesGetResponse200JsonX87f9b592 is missing required property '" + name + "'",
            )
