...
public class InlineV1AccountsPeoplePostRequestFormUsCfpbDataX1916267e(
    public val ethnicityDetails: InlineV1AccountsPeoplePostRequestFormUsCfpbDataEthnicityDetailsX611f925d? = null,
    public val raceDetails: InlineV1AccountsPeoplePostRequestFormUsCfpbDataRaceDetailsX4ba811b8? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1AccountsPeoplePostRequestFormUsCfpbDataX1916267e =
            InlineV1AccountsPeoplePostRequestFormUsCfpbDataX1916267e(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1AccountsPeoplePostRequestFormUsCfpbDataX1916267e =
    ...
    public object Serializer : KSerializer<InlineV1AccountsPeoplePostRequestFormUsCfpbDataX1916267e> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountsPeoplePostRequestFormUsCfpbDataX1916267e must be a JSON object",
                    )
            return InlineV1AccountsPeoplePostRequestFormUsCfpbDataX1916267e(
                ethnicityDetails =
                    rawObject["ethnicity_details"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1AccountsPeoplePostRequestFormUsCfpbDataEthnicityDetailsX611f925d>(
                                it,
                            )
                    },
                raceDetails =
                    rawObject["race_details"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPeoplePostRequestFormUsCfpbDataRaceDetailsX4ba811b8>(
                            it,
                        )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPeoplePostRequestFormUsCfpbDataX1916267e,
        ) {
...
public fun inlineV1AccountsPeoplePostRequestFormUsCfpbDataX1916267e(
    block: InlineV1AccountsPeoplePostRequestFormUsCfpbDataX1916267e.Builder.() -> Unit,
): InlineV1AccountsPeoplePostRequestFormUsCfpbDataX1916267e =
    InlineV1AccountsPeoplePostRequestFormUsCfpbDataX1916267e.build(block)
