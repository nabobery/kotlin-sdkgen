...
public class InlineV1AccountsPostRequestFormIndividualRelationshipX7feb9466(
    ...
    public val percentOwnership: InlineV1AccountsPostRequestFormIndividualRelationshipPercentOwnershipXabc36ce9? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1AccountsPostRequestFormIndividualRelationshipX7feb9466 =
            InlineV1AccountsPostRequestFormIndividualRelationshipX7feb9466(
                director = director,
                executive = executive,
                owner = owner,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1AccountsPostRequestFormIndividualRelationshipX7feb9466 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1AccountsPostRequestFormIndividualRelationshipX7feb9466> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountsPostRequestFormIndividualRelationshipX7feb9466 must be a JSON object",
                    )
            return InlineV1AccountsPostRequestFormIndividualRelationshipX7feb9466(
                ...
                percentOwnership =
                    rawObject["percent_ownership"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1AccountsPostRequestFormIndividualRelationshipPercentOwnershipXabc36ce9>(
                                it,
                            )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPostRequestFormIndividualRelationshipX7feb9466,
        ) {
            val jsonEncoder =
...
public fun inlineV1AccountsPostRequestFormIndividualRelationshipX7feb9466(
    block: InlineV1AccountsPostRequestFormIndividualRelationshipX7feb9466.Builder.() -> Unit,
): InlineV1AccountsPostRequestFormIndividualRelationshipX7feb9466 =
    InlineV1AccountsPostRequestFormIndividualRelationshipX7feb9466.build(block)
