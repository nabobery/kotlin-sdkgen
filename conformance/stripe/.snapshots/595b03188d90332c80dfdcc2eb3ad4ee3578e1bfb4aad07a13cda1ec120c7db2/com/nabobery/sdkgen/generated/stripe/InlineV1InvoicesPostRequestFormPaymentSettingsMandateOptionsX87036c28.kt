...
public class InlineV1InvoicesPostRequestFormPaymentSettingsMandateOptionsX87036c28(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1InvoicesPostRequestFormPaymentSettingsMandateOptionsX87036c28 =
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1InvoicesPostRequestFormPaymentSettingsMandateOptionsX87036c28 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1InvoicesPostRequestFormPaymentSettingsMandateOptionsX87036c28> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1InvoicesPostRequestFormPaymentSettingsMandateOptionsX87036c28 must be a JSON object",
                    )
            return InlineV1InvoicesPostRequestFormPaymentSettingsMandateOptionsX87036c28(
                amount = rawObject["amount"]?.let { json.decodeFromJsonElement<Int>(it) },
                purpose =
                    rawObject["purpose"]?.let {
                        json.decodeFromJsonElement<InlineV1InvoicesPostRequestFormPaymentSettingsPurposeXbbf36ac4>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesPostRequestFormPaymentSettingsMandateOptionsX87036c28,
        ) {
            val jsonEncoder =
...
public fun inlineV1InvoicesPostRequestFormPaymentSettingsMandateOptionsX87036c28(
    block: InlineV1InvoicesPostRequestFormPaymentSettingsMandateOptionsX87036c28.Builder.() -> Unit,
): InlineV1InvoicesPostRequestFormPaymentSettingsMandateOptionsX87036c28 =
    InlineV1InvoicesPostRequestFormPaymentSettingsMandateOptionsX87036c28.build(block)
