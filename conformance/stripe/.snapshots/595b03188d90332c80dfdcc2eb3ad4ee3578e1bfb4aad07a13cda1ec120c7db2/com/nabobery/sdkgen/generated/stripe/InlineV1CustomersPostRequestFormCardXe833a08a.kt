...
public class InlineV1CustomersPostRequestFormCardXe833a08a internal constructor(
    ...
    public val inlineV1CustomersPostRequestFormCardAnyOf1X55954ea0:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1CustomersPostRequestFormCardAnyOf1X55954ea0) {
                json
                    .decodeFromJsonElement<InlineV1CustomersPostRequestFormCardAnyOf1X55954ea0>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1CustomersPostRequestFormCardXe833a08aBranch>
        get() =
            buildSet {
                if (inspection.matchesInlineV1CustomersPostRequestFormCardAnyOf1X55954ea0) {
                    add(
                        InlineV1CustomersPostRequestFormCardXe833a08aBranch.InlineV1CustomersPostRequestFormCardAnyOf1X55954ea0,
                    )
                }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1CustomersPostRequestFormCardXe833a08a {
            val inspection = inspectInlineV1CustomersPostRequestFormCardXe833a08a(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1CustomersPostRequestFormCardXe833a08aNoMatchException(
                    "InlineV1CustomersPostRequestFormCardXe833a08a matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1CustomersPostRequestFormCardXe833a08a> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersPostRequestFormCardXe833a08a,
        ) {
...
private fun inspectInlineV1CustomersPostRequestFormCardXe833a08a(
    element: JsonElement,
): InlineV1CustomersPostRequestFormCardXe833a08aInspection {
    val matchesInlineV1CustomersPostRequestFormCardAnyOf1X55954ea0 =
        element
            .isJsonDecodable<InlineV1CustomersPostRequestFormCardAnyOf1X55954ea0>()
    ...
    return InlineV1CustomersPostRequestFormCardXe833a08aInspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1CustomersPostRequestFormCardAnyOf1X55954ea0) {
                    add(
                        "InlineV1CustomersPostRequestFormCardAnyOf1X55954ea0: value does not match InlineV1CustomersPostRequestFormCardAnyOf1X55954ea0",
                    )
                }
