...
public sealed class InlineV1TestHelpersTreasuryReceivedDebitsPostRequestFormNetworkXbdad12c0 {
    ...
    public object Serializer : KSerializer<InlineV1TestHelpersTreasuryReceivedDebitsPostRequestFormNetworkXbdad12c0> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1TestHelpersTreasuryReceivedDebitsPostRequestFormNetworkXbdad12c0",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1TestHelpersTreasuryReceivedDebitsPostRequestFormNetworkXbdad12c0 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TestHelpersTreasuryReceivedDebitsPostRequestFormNetworkXbdad12c0,
        ) {
