...
public sealed class InlineV1AppsSecretsPostRequestFormScopeTypeX784d7beb {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1AppsSecretsPostRequestFormScopeTypeX784d7beb =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1AppsSecretsPostRequestFormScopeTypeX784d7beb> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1AppsSecretsPostRequestFormScopeTypeX784d7beb",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1AppsSecretsPostRequestFormScopeTypeX784d7beb =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AppsSecretsPostRequestFormScopeTypeX784d7beb,
        ) {
