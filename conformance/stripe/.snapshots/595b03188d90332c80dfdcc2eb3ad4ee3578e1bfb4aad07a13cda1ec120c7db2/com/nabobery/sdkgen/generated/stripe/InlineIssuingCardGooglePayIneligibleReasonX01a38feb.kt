...
public sealed class InlineIssuingCardGooglePayIneligibleReasonX01a38feb {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineIssuingCardGooglePayIneligibleReasonX01a38feb =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineIssuingCardGooglePayIneligibleReasonX01a38feb> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineIssuingCardGooglePayIneligibleReasonX01a38feb",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineIssuingCardGooglePayIneligibleReasonX01a38feb =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineIssuingCardGooglePayIneligibleReasonX01a38feb,
        ) {
