...
public class InlineV1TaxRegistrationsPostRequestFormCountryOptionsAuStandardX3dd82652(
    public val placeOfSupplyScheme: InlineV1TaxRegistrationsPostRequestFormPlaceOfSupplySchemeX21401b22? = null,
) {
    public class Builder {
        public var placeOfSupplyScheme:
            InlineV1TaxRegistrationsPostRequestFormPlaceOfSupplySchemeX21401b22? = null

        public fun build(): InlineV1TaxRegistrationsPostRequestFormCountryOptionsAuStandardX3dd82652 =
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1TaxRegistrationsPostRequestFormCountryOptionsAuStandardX3dd82652 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1TaxRegistrationsPostRequestFormCountryOptionsAuStandardX3dd82652> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TaxRegistrationsPostRequestFormCountryOptionsAuStandardX3dd82652 must be a JSON object",
                    )
            return InlineV1TaxRegistrationsPostRequestFormCountryOptionsAuStandardX3dd82652(
                placeOfSupplyScheme =
                    rawObject["place_of_supply_scheme"]?.let {
                        json.decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormPlaceOfSupplySchemeX21401b22>(
                            it,
                        )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TaxRegistrationsPostRequestFormCountryOptionsAuStandardX3dd82652,
        ) {
            val jsonEncoder =
...
public fun inlineV1TaxRegistrationsPostRequestFormCountryOptionsAuStandardX3dd82652(
    block: InlineV1TaxRegistrationsPostRequestFormCountryOptionsAuStandardX3dd82652.Builder.() -> Unit,
): InlineV1TaxRegistrationsPostRequestFormCountryOptionsAuStandardX3dd82652 =
    InlineV1TaxRegistrationsPostRequestFormCountryOptionsAuStandardX3dd82652.build(block)
