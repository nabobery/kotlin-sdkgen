...
public sealed class InlineV1BillingCreditGrantsPostRequestFormCategoryXfd62be7a {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1BillingCreditGrantsPostRequestFormCategoryXfd62be7a =
            when (value) {
                Paid.value -> Paid
    ...
    public object Serializer : KSerializer<InlineV1BillingCreditGrantsPostRequestFormCategoryXfd62be7a> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1BillingCreditGrantsPostRequestFormCategoryXfd62be7a",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1BillingCreditGrantsPostRequestFormCategoryXfd62be7a =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1BillingCreditGrantsPostRequestFormCategoryXfd62be7a,
        ) {
