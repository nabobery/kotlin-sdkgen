...
public class SubscriptionsResourceBillingSchedulesBillUntil(
     ...
     */
    public val duration: InlineSubscriptionsResourceBillingSchedulesBillUntilDurationX2e054bf8? = null,
    /**
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): SubscriptionsResourceBillingSchedulesBillUntil =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<SubscriptionsResourceBillingSchedulesBillUntil> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "SubscriptionsResourceBillingSchedulesBillUntil must be a JSON object",
                    )
            val computedTimestamp = json.decodeRequired<Int>(rawObject, "computed_timestamp")
            val type =
                json.decodeRequired<InlineSubscriptionsResourceBillingSchedulesBillUntilTypeX20894bbb>(
                    rawObject,
                    "type",
                )
            return SubscriptionsResourceBillingSchedulesBillUntil(
                ...
                type = type,
                duration =
                    rawObject["duration"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                            ...
                            json
                                .decodeFromJsonElement<InlineSubscriptionsResourceBillingSchedulesBillUntilDurationX2e054bf8?>(
                                    element,
                                )
                        }
                    },
                timestamp =
                    rawObject["timestamp"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: SubscriptionsResourceBillingSchedulesBillUntil,
        ) {
...
public fun subscriptionsResourceBillingSchedulesBillUntil(
    block: SubscriptionsResourceBillingSchedulesBillUntil.Builder.() -> Unit,
): SubscriptionsResourceBillingSchedulesBillUntil = SubscriptionsResourceBillingSchedulesBillUntil.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "SubscriptionsResourceBillingSchedulesBillUntil is missing required property '" + name + "'",
            )
