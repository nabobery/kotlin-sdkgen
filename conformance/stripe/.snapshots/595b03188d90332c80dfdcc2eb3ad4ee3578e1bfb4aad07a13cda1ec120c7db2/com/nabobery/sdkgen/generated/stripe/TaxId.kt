...
public class TaxId(
    ...
    public object Serializer : KSerializer<TaxId> {
        ...
        override fun deserialize(decoder: Decoder): TaxId {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("TaxId must be a JSON object")
                ...
                customer =
                    rawObject["customer"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineTaxIdCustomerXabeb847c?>(element)
                        }
                    },
                customerAccount =
                ...
                owner =
                    rawObject["owner"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineTaxIdOwnerXad3865dd?>(element)
                        }
                    },
                verification =
                    rawObject["verification"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineTaxIdVerificationX8fc6b9d2?>(element)
                        }
                    },
            )
        }
