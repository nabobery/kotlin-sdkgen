...
public class InlineV1AccountsPostRequestFormSettingsCardPaymentsDeclineOnX2a15c6d4(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1AccountsPostRequestFormSettingsCardPaymentsDeclineOnX2a15c6d4 =
            InlineV1AccountsPostRequestFormSettingsCardPaymentsDeclineOnX2a15c6d4(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1AccountsPostRequestFormSettingsCardPaymentsDeclineOnX2a15c6d4 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1AccountsPostRequestFormSettingsCardPaymentsDeclineOnX2a15c6d4> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountsPostRequestFormSettingsCardPaymentsDeclineOnX2a15c6d4 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPostRequestFormSettingsCardPaymentsDeclineOnX2a15c6d4,
        ) {
            val jsonEncoder =
...
public fun inlineV1AccountsPostRequestFormSettingsCardPaymentsDeclineOnX2a15c6d4(
    block: InlineV1AccountsPostRequestFormSettingsCardPaymentsDeclineOnX2a15c6d4.Builder.() -> Unit,
): InlineV1AccountsPostRequestFormSettingsCardPaymentsDeclineOnX2a15c6d4 =
    InlineV1AccountsPostRequestFormSettingsCardPaymentsDeclineOnX2a15c6d4.build(block)
