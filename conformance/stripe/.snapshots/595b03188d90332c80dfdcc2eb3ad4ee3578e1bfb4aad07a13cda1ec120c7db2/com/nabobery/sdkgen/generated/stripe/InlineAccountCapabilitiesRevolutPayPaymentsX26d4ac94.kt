...
public sealed class InlineAccountCapabilitiesRevolutPayPaymentsX26d4ac94 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineAccountCapabilitiesRevolutPayPaymentsX26d4ac94 =
            when (value) {
                Active.value -> Active
    ...
    public object Serializer : KSerializer<InlineAccountCapabilitiesRevolutPayPaymentsX26d4ac94> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineAccountCapabilitiesRevolutPayPaymentsX26d4ac94",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineAccountCapabilitiesRevolutPayPaymentsX26d4ac94 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineAccountCapabilitiesRevolutPayPaymentsX26d4ac94,
        ) {
