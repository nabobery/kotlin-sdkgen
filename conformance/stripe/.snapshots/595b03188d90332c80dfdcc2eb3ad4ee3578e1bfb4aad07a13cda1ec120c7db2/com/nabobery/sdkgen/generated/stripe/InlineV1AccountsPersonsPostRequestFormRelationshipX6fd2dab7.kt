...
public class InlineV1AccountsPersonsPostRequestFormRelationshipX6fd2dab7(
    ...
    public val percentOwnership: InlineV1AccountsPersonsPostRequestFormRelationshipPercentOwnershipXeddc122d? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1AccountsPersonsPostRequestFormRelationshipX6fd2dab7 =
            InlineV1AccountsPersonsPostRequestFormRelationshipX6fd2dab7(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1AccountsPersonsPostRequestFormRelationshipX6fd2dab7 =
    ...
    public object Serializer : KSerializer<InlineV1AccountsPersonsPostRequestFormRelationshipX6fd2dab7> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountsPersonsPostRequestFormRelationshipX6fd2dab7 must be a JSON object",
                    )
            return InlineV1AccountsPersonsPostRequestFormRelationshipX6fd2dab7(
                ...
                percentOwnership =
                    rawObject["percent_ownership"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1AccountsPersonsPostRequestFormRelationshipPercentOwnershipXeddc122d>(
                                it,
                            )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPersonsPostRequestFormRelationshipX6fd2dab7,
        ) {
...
public fun inlineV1AccountsPersonsPostRequestFormRelationshipX6fd2dab7(
    block: InlineV1AccountsPersonsPostRequestFormRelationshipX6fd2dab7.Builder.() -> Unit,
): InlineV1AccountsPersonsPostRequestFormRelationshipX6fd2dab7 =
    InlineV1AccountsPersonsPostRequestFormRelationshipX6fd2dab7.build(block)
