...
public class CardIssuingAccountTermsOfService(
    ...
    public class Builder {
        ...
        public fun build(): CardIssuingAccountTermsOfService =
    ...
    public object Serializer : KSerializer<CardIssuingAccountTermsOfService> {
        ...
        override fun deserialize(decoder: Decoder): CardIssuingAccountTermsOfService {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("CardIssuingAccountTermsOfService must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: CardIssuingAccountTermsOfService,
        ) {
...
public fun cardIssuingAccountTermsOfService(
    block: CardIssuingAccountTermsOfService.Builder.() -> Unit,
): CardIssuingAccountTermsOfService = CardIssuingAccountTermsOfService.build(block)
