...
public sealed class InlinePaymentMethodDetailsPaymentRecordSofortPreferredLanguageXb5e07cc7 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentMethodDetailsPaymentRecordSofortPreferredLanguageXb5e07cc7 =
            when (value) {
                De.value -> De
                En.value -> En
                Es.value -> Es
    ...
    public object Serializer : KSerializer<InlinePaymentMethodDetailsPaymentRecordSofortPreferredLanguageXb5e07cc7> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentMethodDetailsPaymentRecordSofortPreferredLanguageXb5e07cc7",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlinePaymentMethodDetailsPaymentRecordSofortPreferredLanguageXb5e07cc7 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentMethodDetailsPaymentRecordSofortPreferredLanguageXb5e07cc7,
        ) {
