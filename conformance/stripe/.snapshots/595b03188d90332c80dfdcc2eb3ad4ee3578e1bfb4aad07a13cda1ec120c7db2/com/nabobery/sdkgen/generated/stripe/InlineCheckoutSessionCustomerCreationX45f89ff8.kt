...
public sealed class InlineCheckoutSessionCustomerCreationX45f89ff8 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineCheckoutSessionCustomerCreationX45f89ff8 =
            when (value) {
                Always.value -> Always
    ...
    public object Serializer : KSerializer<InlineCheckoutSessionCustomerCreationX45f89ff8> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineCheckoutSessionCustomerCreationX45f89ff8",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineCheckoutSessionCustomerCreationX45f89ff8 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineCheckoutSessionCustomerCreationX45f89ff8,
        ) {
