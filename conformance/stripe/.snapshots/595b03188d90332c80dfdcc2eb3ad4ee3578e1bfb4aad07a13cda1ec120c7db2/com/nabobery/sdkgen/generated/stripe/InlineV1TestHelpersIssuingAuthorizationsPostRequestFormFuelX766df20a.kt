...
public class InlineV1TestHelpersIssuingAuthorizationsPostRequestFormFuelX766df20a(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1TestHelpersIssuingAuthorizationsPostRequestFormFuelX766df20a =
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1TestHelpersIssuingAuthorizationsPostRequestFormFuelX766df20a = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TestHelpersIssuingAuthorizationsPostRequestFormFuelX766df20a> {
        ...
        override fun deserialize(
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TestHelpersIssuingAuthorizationsPostRequestFormFuelX766df20a must be a JSON object",
                    )
            return InlineV1TestHelpersIssuingAuthorizationsPostRequestFormFuelX766df20a(
                ...
                type =
                    rawObject["type"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TestHelpersIssuingAuthorizationsPostRequestFormFuelTypeXf1ddaa25>(
                                it,
                            )
                    },
                unit =
                    rawObject["unit"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TestHelpersIssuingAuthorizationsPostRequestFormFuelUnitXe42791ef>(
                                it,
                            )
                    },
                unitCostDecimal =
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TestHelpersIssuingAuthorizationsPostRequestFormFuelX766df20a,
        ) {
            val jsonEncoder =
...
public fun inlineV1TestHelpersIssuingAuthorizationsPostRequestFormFuelX766df20a(
    block: InlineV1TestHelpersIssuingAuthorizationsPostRequestFormFuelX766df20a.Builder.() -> Unit,
): InlineV1TestHelpersIssuingAuthorizationsPostRequestFormFuelX766df20a =
    InlineV1TestHelpersIssuingAuthorizationsPostRequestFormFuelX766df20a.build(block)
