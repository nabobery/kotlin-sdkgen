...
@Serializable
public data class BillingBillResourceInvoicingParentsInvoiceSubscriptionParentView(
...
public class BillingBillResourceInvoicingParentsInvoiceSubscriptionParent(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): BillingBillResourceInvoicingParentsInvoiceSubscriptionParent =
    ...
    public object Serializer : KSerializer<BillingBillResourceInvoicingParentsInvoiceSubscriptionParent> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "BillingBillResourceInvoicingParentsInvoiceSubscriptionParent must be a JSON object",
                    )
            val subscription =
                json.decodeRequired<InlineBillingBillResourceIb302SubscriptionX174cd364>(
                    rawObject,
                    "subscription",
                )
            return BillingBillResourceInvoicingParentsInvoiceSubscriptionParent(
                ...
                subscriptionProrationDate =
                    rawObject["subscription_proration_date"]?.let {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: BillingBillResourceInvoicingParentsInvoiceSubscriptionParent,
        ) {
            ...
            val raw =
                buildJsonObject {
                    ...
                    value.subscriptionProrationDate?.let {
                        put(
...
public fun billingBillResourceInvoicingParentsInvoiceSubscriptionParent(
    block: BillingBillResourceInvoicingParentsInvoiceSubscriptionParent.Builder.() -> Unit,
): BillingBillResourceInvoicingParentsInvoiceSubscriptionParent =
    BillingBillResourceInvoicingParentsInvoiceSubscriptionParent.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "BillingBillResourceInvoicingParentsInvoiceSubscriptionParent is missing required property '" + name +
                    "'",
            )
