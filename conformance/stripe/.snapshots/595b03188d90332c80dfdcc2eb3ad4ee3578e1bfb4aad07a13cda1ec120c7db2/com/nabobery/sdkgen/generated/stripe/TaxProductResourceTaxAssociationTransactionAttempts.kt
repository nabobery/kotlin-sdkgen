...
public class TaxProductResourceTaxAssociationTransactionAttempts(
    ...
    public val committed: TaxProductResourceTaxAssociationTransactionAttemptsResourceCommitted? = null,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): TaxProductResourceTaxAssociationTransactionAttempts =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<TaxProductResourceTaxAssociationTransactionAttempts> {
        ...
        override fun deserialize(decoder: Decoder): TaxProductResourceTaxAssociationTransactionAttempts {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "TaxProductResourceTaxAssociationTransactionAttempts must be a JSON object",
                    )
            ...
            return TaxProductResourceTaxAssociationTransactionAttempts(
                ...
                status = status,
                committed =
                    rawObject["committed"]?.let {
                        json
                            .decodeFromJsonElement<TaxProductResourceTaxAssociationTransactionAttemptsResourceCommitted>(
                                it,
                            )
                    },
                errored =
                    rawObject["errored"]?.let {
                        json.decodeFromJsonElement<TaxProductResourceTaxAssociationTransactionAttemptsResourceErrored>(
                            it,
                        )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: TaxProductResourceTaxAssociationTransactionAttempts,
        ) {
...
public fun taxProductResourceTaxAssociationTransactionAttempts(
    block: TaxProductResourceTaxAssociationTransactionAttempts.Builder.() -> Unit,
): TaxProductResourceTaxAssociationTransactionAttempts =
    TaxProductResourceTaxAssociationTransactionAttempts.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "TaxProductResourceTaxAssociationTransactionAttempts is missing required property '" + name + "'",
            )
