...
public data class PaymentPagesCheckoutSessionConsentCollectionView(
    ...
    public val paymentMethodReuseAgreement: InlinePaymentPagesCheckout09ddPaymentMethodReuseAgcb24X6e2377f9? = null,
    public val promotions: InlinePaymentPagesCheckoutSessionConsentCollectionPromotionsX48634417? = null,
    @SerialName("terms_of_service")
    public val termsOfService: InlinePaymentPagesCheckoutSessionConsentCollectionTermsOfServiceX0312229e? = null,
)
...
public class PaymentPagesCheckoutSessionConsentCollection(
    ...
    public class Builder {
        ...
        public fun build(): PaymentPagesCheckoutSessionConsentCollection =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentPagesCheckoutSessionConsentCollection =
    ...
    public object Serializer : KSerializer<PaymentPagesCheckoutSessionConsentCollection> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "PaymentPagesCheckoutSessionConsentCollection must be a JSON object",
                    )
            return PaymentPagesCheckoutSessionConsentCollection(
                paymentMethodReuseAgreement =
                    rawObject["payment_method_reuse_agreement"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                            ...
                            json
                                .decodeFromJsonElement<InlinePaymentPagesCheckout09ddPaymentMethodReuseAgcb24X6e2377f9?>(
                                    element,
                                )
                        }
                    },
                promotions =
                    rawObject["promotions"]?.let { element ->
                        if (element ==
                            ...
                            json
                                .decodeFromJsonElement<InlinePaymentPagesCheckoutSessionConsentCollectionPromotionsX48634417?>(
                                    element,
                                )
                        }
                    },
                termsOfService =
                    rawObject["terms_of_service"]?.let { element ->
                        if (element ==
                            ...
                            json
                                .decodeFromJsonElement<InlinePaymentPagesCheckoutSessionConsentCollectionTermsOfServiceX0312229e?>(
                                    element,
                                )
                        }
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentPagesCheckoutSessionConsentCollection,
        ) {
...
public fun paymentPagesCheckoutSessionConsentCollection(
    block: PaymentPagesCheckoutSessionConsentCollection.Builder.() -> Unit,
): PaymentPagesCheckoutSessionConsentCollection = PaymentPagesCheckoutSessionConsentCollection.build(block)
