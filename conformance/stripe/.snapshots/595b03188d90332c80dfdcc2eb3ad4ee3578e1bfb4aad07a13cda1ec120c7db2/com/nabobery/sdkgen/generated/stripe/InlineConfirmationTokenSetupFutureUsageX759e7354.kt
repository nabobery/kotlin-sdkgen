...
public sealed class InlineConfirmationTokenSetupFutureUsageX759e7354 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineConfirmationTokenSetupFutureUsageX759e7354 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineConfirmationTokenSetupFutureUsageX759e7354> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineConfirmationTokenSetupFutureUsageX759e7354",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineConfirmationTokenSetupFutureUsageX759e7354 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineConfirmationTokenSetupFutureUsageX759e7354,
        ) {
