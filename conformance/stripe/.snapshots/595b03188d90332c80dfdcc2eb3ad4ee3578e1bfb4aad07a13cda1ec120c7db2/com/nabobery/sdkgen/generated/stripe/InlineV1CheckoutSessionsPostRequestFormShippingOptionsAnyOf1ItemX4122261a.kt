...
public class InlineV1CheckoutSessionsPostRequestFormShippingOptionsAnyOf1ItemX4122261a(
    ...
    public val shippingRateData: InlineV1CheckoutSessionsPostRequestFormShippingOptionsShippingRateDataXd411a357? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1CheckoutSessionsPostRequestFormShippingOptionsAnyOf1ItemX4122261a =
            InlineV1CheckoutSessionsPostRequestFormShippingOptionsAnyOf1ItemX4122261a(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1CheckoutSessionsPostRequestFormShippingOptionsAnyOf1ItemX4122261a = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormShippingOptionsAnyOf1ItemX4122261a> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CheckoutSessionsPostRequestFormShippingOptionsAnyOf1ItemX4122261a must be a JSON object",
                    )
            return InlineV1CheckoutSessionsPostRequestFormShippingOptionsAnyOf1ItemX4122261a(
                ...
                shippingRateData =
                    rawObject["shipping_rate_data"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormShippingOptionsShippingRateDataXd411a357>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsPostRequestFormShippingOptionsAnyOf1ItemX4122261a,
        ) {
            val jsonEncoder =
...
public fun inlineV1CheckoutSessionsPostRequestFormShippingOptionsAnyOf1ItemX4122261a(
    block: InlineV1CheckoutSessionsPostRequestFormShippingOptionsAnyOf1ItemX4122261a.Builder.() -> Unit,
): InlineV1CheckoutSessionsPostRequestFormShippingOptionsAnyOf1ItemX4122261a =
    InlineV1CheckoutSessionsPostRequestFormShippingOptionsAnyOf1ItemX4122261a.build(block)
