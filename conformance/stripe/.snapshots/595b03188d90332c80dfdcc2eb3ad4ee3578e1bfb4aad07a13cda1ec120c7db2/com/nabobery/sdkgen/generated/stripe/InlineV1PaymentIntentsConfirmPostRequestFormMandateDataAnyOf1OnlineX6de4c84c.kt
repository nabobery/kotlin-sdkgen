...
public class InlineV1PaymentIntentsConfirmPostRequestFormMandateDataAnyOf1OnlineX6de4c84c(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentIntentsConfirmPostRequestFormMandateDataAnyOf1OnlineX6de4c84c = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentIntentsConfirmPostRequestFormMandateDataAnyOf1OnlineX6de4c84c> {
        override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1PaymentIntentsConfirmPostRequestFormMandateDataAnyOf1OnlineX6de4c84c {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsConfirmPostRequestFormMandateDataAnyOf1OnlineX6de4c84c must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsConfirmPostRequestFormMandateDataAnyOf1OnlineX6de4c84c,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentIntentsConfirmPostRequestFormMandateDataAnyOf1OnlineX6de4c84c(
    block: InlineV1PaymentIntentsConfirmPostRequestFormMandateDataAnyOf1OnlineX6de4c84c.Builder.() -> Unit,
): InlineV1PaymentIntentsConfirmPostRequestFormMandateDataAnyOf1OnlineX6de4c84c =
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentIntentsConfirmPostRequestFormMandateDataAnyOf1OnlineX6de4c84c is missing required property '" +
                    name +
                    "'",
            )
