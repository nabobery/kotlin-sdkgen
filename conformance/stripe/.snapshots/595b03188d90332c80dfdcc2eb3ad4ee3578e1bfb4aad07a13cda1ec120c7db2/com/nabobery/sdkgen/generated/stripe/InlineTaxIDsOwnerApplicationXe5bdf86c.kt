...
public class InlineTaxIDsOwnerApplicationXe5bdf86c internal constructor(
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineTaxIDsOwnerApplicationXe5bdf86c {
            val inspection = inspectInlineTaxIDsOwnerApplicationXe5bdf86c(raw)
            if (inspection.matchCount == 0) {
                throw InlineTaxIDsOwnerApplicationXe5bdf86cNoMatchException(
                    "InlineTaxIDsOwnerApplicationXe5bdf86c matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineTaxIDsOwnerApplicationXe5bdf86c> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineTaxIDsOwnerApplicationXe5bdf86c,
        ) {
...
private fun inspectInlineTaxIDsOwnerApplicationXe5bdf86c(
    element: JsonElement,
): InlineTaxIDsOwnerApplicationXe5bdf86cInspection {
