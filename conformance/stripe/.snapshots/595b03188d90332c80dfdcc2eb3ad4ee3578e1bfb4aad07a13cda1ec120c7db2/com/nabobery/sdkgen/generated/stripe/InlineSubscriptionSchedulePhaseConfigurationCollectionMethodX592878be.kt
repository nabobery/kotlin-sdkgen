...
public sealed class InlineSubscriptionSchedulePhaseConfigurationCollectionMethodX592878be {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineSubscriptionSchedulePhaseConfigurationCollectionMethodX592878be =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineSubscriptionSchedulePhaseConfigurationCollectionMethodX592878be> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineSubscriptionSchedulePhaseConfigurationCollectionMethodX592878be",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineSubscriptionSchedulePhaseConfigurationCollectionMethodX592878be = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineSubscriptionSchedulePhaseConfigurationCollectionMethodX592878be,
        ) {
