...
public class InlineChargeApplicationFeeX9fc79449 internal constructor(
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineChargeApplicationFeeX9fc79449 {
            val inspection = inspectInlineChargeApplicationFeeX9fc79449(raw)
            if (inspection.matchCount == 0) {
                throw InlineChargeApplicationFeeX9fc79449NoMatchException(
                    "InlineChargeApplicationFeeX9fc79449 matched 0 branches: " + inspection.failures.joinToString("; "),
                )
            }
    ...
    public object Serializer : KSerializer<InlineChargeApplicationFeeX9fc79449> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineChargeApplicationFeeX9fc79449,
        ) {
...
private fun inspectInlineChargeApplicationFeeX9fc79449(
    element: JsonElement,
): InlineChargeApplicationFeeX9fc79449Inspection {
