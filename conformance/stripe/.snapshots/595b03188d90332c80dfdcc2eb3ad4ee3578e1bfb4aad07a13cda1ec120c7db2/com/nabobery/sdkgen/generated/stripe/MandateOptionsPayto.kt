...
public class MandateOptionsPayto(
    ...
    public class Builder {
        ...
        public fun build(): MandateOptionsPayto =
            MandateOptionsPayto(
                amount = amount,
    ...
    public object Serializer : KSerializer<MandateOptionsPayto> {
        ...
        override fun deserialize(decoder: Decoder): MandateOptionsPayto {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("MandateOptionsPayto must be a JSON object")
                ...
                amountType =
                    rawObject["amount_type"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineMandateOptionsPaytoAmountTypeX712f80fa?>(element)
                        }
                    },
                endDate =
                ...
                paymentSchedule =
                    rawObject["payment_schedule"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineMandateOptionsPaytoPaymentScheduleXba8750dc?>(element)
                        }
                    },
                paymentsPerPeriod =
                ...
                purpose =
                    rawObject["purpose"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineMandateOptionsPaytoPurposeX3f3845f0?>(element)
                        }
                    },
                startDate =
...
public fun mandateOptionsPayto(block: MandateOptionsPayto.Builder.() -> Unit): MandateOptionsPayto =
    MandateOptionsPayto.build(block)
