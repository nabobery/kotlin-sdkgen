...
internal data class InlineV1CustomersPostRequestFormAddressXea1a2b6fInspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesInlineV1CustomersPostRequestFormAddressAnyOf1X4193daf3,
                matchesInlineV1CustomersPostRequestFormAddressAnyOf2X9272aed1,
            ).count {
                it
            }
}
...
public class InlineV1CustomersPostRequestFormAddressXea1a2b6f internal constructor(
    ...
    public val inlineV1CustomersPostRequestFormAddressAnyOf1X4193daf3:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1CustomersPostRequestFormAddressAnyOf1X4193daf3) {
                json
                    .decodeFromJsonElement<InlineV1CustomersPostRequestFormAddressAnyOf1X4193daf3>(
                        raw,
                    )
            } else {
                null
    ...
    public val inlineV1CustomersPostRequestFormAddressAnyOf2X9272aed1:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1CustomersPostRequestFormAddressAnyOf2X9272aed1) {
                json
                    .decodeFromJsonElement<InlineV1CustomersPostRequestFormAddressAnyOf2X9272aed1>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1CustomersPostRequestFormAddressXea1a2b6fBranch>
        get() =
            buildSet {
                if (inspection.matchesInlineV1CustomersPostRequestFormAddressAnyOf1X4193daf3) {
                    add(
                        InlineV1CustomersPostRequestFormAddressXea1a2b6fBranch.InlineV1CustomersPostRequestFormAddressAnyOf1X4193daf3,
                    )
                }
                if (inspection.matchesInlineV1CustomersPostRequestFormAddressAnyOf2X9272aed1) {
                    add(
                        InlineV1CustomersPostRequestFormAddressXea1a2b6fBranch.InlineV1CustomersPostRequestFormAddressAnyOf2X9272aed1,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1CustomersPostRequestFormAddressXea1a2b6f {
            val inspection = inspectInlineV1CustomersPostRequestFormAddressXea1a2b6f(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1CustomersPostRequestFormAddressXea1a2b6fNoMatchException(
                    "InlineV1CustomersPostRequestFormAddressXea1a2b6f matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1CustomersPostRequestFormAddressXea1a2b6f> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersPostRequestFormAddressXea1a2b6f,
        ) {
...
private fun inspectInlineV1CustomersPostRequestFormAddressXea1a2b6f(
    element: JsonElement,
): InlineV1CustomersPostRequestFormAddressXea1a2b6fInspection {
    val matchesInlineV1CustomersPostRequestFormAddressAnyOf1X4193daf3 =
        element
            .isJsonDecodable<InlineV1CustomersPostRequestFormAddressAnyOf1X4193daf3>()
    val matchesInlineV1CustomersPostRequestFormAddressAnyOf2X9272aed1 =
        element
            .isJsonDecodable<InlineV1CustomersPostRequestFormAddressAnyOf2X9272aed1>()
    return InlineV1CustomersPostRequestFormAddressXea1a2b6fInspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1CustomersPostRequestFormAddressAnyOf1X4193daf3) {
                    add(
                        "InlineV1CustomersPostRequestFormAddressAnyOf1X4193daf3: value does not match InlineV1CustomersPostRequestFormAddressAnyOf1X4193daf3",
                    )
                }
                if (!matchesInlineV1CustomersPostRequestFormAddressAnyOf2X9272aed1) {
                    add(
                        "InlineV1CustomersPostRequestFormAddressAnyOf2X9272aed1: value does not match InlineV1CustomersPostRequestFormAddressAnyOf2X9272aed1",
                    )
                }
            },
    )
