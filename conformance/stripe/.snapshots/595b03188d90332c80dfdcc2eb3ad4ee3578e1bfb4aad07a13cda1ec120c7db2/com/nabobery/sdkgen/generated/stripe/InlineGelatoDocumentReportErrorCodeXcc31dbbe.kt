...
public sealed class InlineGelatoDocumentReportErrorCodeXcc31dbbe {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineGelatoDocumentReportErrorCodeXcc31dbbe =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineGelatoDocumentReportErrorCodeXcc31dbbe> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineGelatoDocumentReportErrorCodeXcc31dbbe",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineGelatoDocumentReportErrorCodeXcc31dbbe =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineGelatoDocumentReportErrorCodeXcc31dbbe,
        ) {
