...
public class InlineInvoiceCustomerX09737939 internal constructor(
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineInvoiceCustomerX09737939 {
            val inspection = inspectInlineInvoiceCustomerX09737939(raw)
            if (inspection.matchCount == 0) {
                throw InlineInvoiceCustomerX09737939NoMatchException(
                    "InlineInvoiceCustomerX09737939 matched 0 branches: " + inspection.failures.joinToString("; "),
                )
            }
    ...
    public object Serializer : KSerializer<InlineInvoiceCustomerX09737939> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineInvoiceCustomerX09737939,
        ) {
