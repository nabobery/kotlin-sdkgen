...
public class InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsCartesBancairesXc9d93ab4(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsCartesBancairesXc9d93ab4 =
    ...
    public object Serializer : KSerializer<InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsCartesBancairesXc9d93ab4> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsCartesBancairesXc9d93ab4 must be a JSON object",
                    )
            val cbAvalgo =
                json.decodeRequired<InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsCardCbAvalgoXa215cd6b>(
                    rawObject,
                    "cb_avalgo",
                )
            return InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsCartesBancairesXc9d93ab4(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsCartesBancairesXc9d93ab4,
        ) {
            val jsonEncoder =
...
public fun inlineV1SetupIntentsPostRequestFormPaymentMethodOptionsCartesBancairesXc9d93ab4(
    block: InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsCartesBancairesXc9d93ab4.Builder.() -> Unit,
): InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsCartesBancairesXc9d93ab4 =
    InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsCartesBancairesXc9d93ab4.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsCartesBancairesXc9d93ab4 is missing required property '" +
                    name +
                    "'",
            )
