...
public class CheckoutP24PaymentMethodOptions(
     ...
     */
    public val setupFutureUsage: InlineCheckoutP24PaymentMethodOptionsSetupFutureUsageXa2e2ed52? = null,
) {
    public class Builder {
        ...
        public fun build(): CheckoutP24PaymentMethodOptions =
    ...
    public object Serializer : KSerializer<CheckoutP24PaymentMethodOptions> {
        ...
        override fun deserialize(decoder: Decoder): CheckoutP24PaymentMethodOptions {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("CheckoutP24PaymentMethodOptions must be a JSON object")
            return CheckoutP24PaymentMethodOptions(
                setupFutureUsage =
                    rawObject["setup_future_usage"]?.let {
                        json.decodeFromJsonElement<InlineCheckoutP24PaymentMethodOptionsSetupFutureUsageXa2e2ed52>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: CheckoutP24PaymentMethodOptions,
        ) {
...
public fun checkoutP24PaymentMethodOptions(
    block: CheckoutP24PaymentMethodOptions.Builder.() -> Unit,
): CheckoutP24PaymentMethodOptions = CheckoutP24PaymentMethodOptions.build(block)
