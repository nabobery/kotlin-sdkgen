...
public sealed class InlineSourceTransactionTypeX56896a84 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineSourceTransactionTypeX56896a84 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineSourceTransactionTypeX56896a84> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineSourceTransactionTypeX56896a84",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineSourceTransactionTypeX56896a84 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineSourceTransactionTypeX56896a84,
        ) {
