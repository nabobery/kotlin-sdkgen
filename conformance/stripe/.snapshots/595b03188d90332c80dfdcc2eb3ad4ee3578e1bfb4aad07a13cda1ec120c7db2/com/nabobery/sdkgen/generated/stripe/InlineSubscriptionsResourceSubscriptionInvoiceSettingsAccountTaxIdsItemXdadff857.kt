...
public class InlineSubscriptionsResourceSubscriptionInvoiceSettingsAccountTaxIdsItemXdadff857 internal constructor(
    ...
    private val inspection: InlineSubscriptionsResourceSubscriptionInvoiceSettingsAccountTaxIdsItemXdadff857Inspection,
) {
    ...
    public val taxId: TaxId? by
        lazy(
            LazyThreadSafetyMode.NONE,
        ) { if (inspection.matchesTaxId) json.decodeFromJsonElement<TaxId>(raw) else null }

    public val deletedTaxId: DeletedTaxId? by
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesDeletedTaxId) json.decodeFromJsonElement<DeletedTaxId>(raw) else null
        }
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineSubscriptionsResourceSubscriptionInvoiceSettingsAccountTaxIdsItemXdadff857Branch.Branch1,
                    )
                }
                if (inspection.matchesTaxId) {
                    add(
                        InlineSubscriptionsResourceSubscriptionInvoiceSettingsAccountTaxIdsItemXdadff857Branch.TaxId,
                    )
                }
                if (inspection.matchesDeletedTaxId) {
                    add(
                        InlineSubscriptionsResourceSubscriptionInvoiceSettingsAccountTaxIdsItemXdadff857Branch.DeletedTaxId,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineSubscriptionsResourceSubscriptionInvoiceSettingsAccountTaxIdsItemXdadff857 {
            val inspection =
                inspectInlineSubscriptionsResourceSubscriptionInvoiceSettingsAccountTaxIdsItemXdadff857(raw)
            if (inspection.matchCount == 0) {
                throw InlineSubscriptionsResourceSubscriptionInvoiceSettingsAccountTaxIdsItemXdadff857NoMatchException(
                    "InlineSubscriptionsResourceSubscriptionInvoiceSettingsAccountTaxIdsItemXdadff857 matched 0 branches: " +
                        inspection.failures.joinToString("; "),
                )
            }
            return InlineSubscriptionsResourceSubscriptionInvoiceSettingsAccountTaxIdsItemXdadff857(
                raw,
                json,
                inspection,
            )
    ...
    public object Serializer : KSerializer<InlineSubscriptionsResourceSubscriptionInvoiceSettingsAccountTaxIdsItemXdadff857> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineSubscriptionsResourceSubscriptionInvoiceSettingsAccountTaxIdsItemXdadff857,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineSubscriptionsResourceSubscriptionInvoiceSettingsAccountTaxIdsItemXdadff857",
...
private fun inspectInlineSubscriptionsResourceSubscriptionInvoiceSettingsAccountTaxIdsItemXdadff857(
    element: JsonElement,
