...
public class InlineInvoiceitemInvoiceX2a82d179 internal constructor(
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineInvoiceitemInvoiceX2a82d179 {
            val inspection = inspectInlineInvoiceitemInvoiceX2a82d179(raw)
            if (inspection.matchCount == 0) {
                throw InlineInvoiceitemInvoiceX2a82d179NoMatchException(
                    "InlineInvoiceitemInvoiceX2a82d179 matched 0 branches: " + inspection.failures.joinToString("; "),
                )
            }
    ...
    public object Serializer : KSerializer<InlineInvoiceitemInvoiceX2a82d179> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineInvoiceitemInvoiceX2a82d179,
        ) {
...
private fun inspectInlineInvoiceitemInvoiceX2a82d179(
    element: JsonElement,
): InlineInvoiceitemInvoiceX2a82d179Inspection {
