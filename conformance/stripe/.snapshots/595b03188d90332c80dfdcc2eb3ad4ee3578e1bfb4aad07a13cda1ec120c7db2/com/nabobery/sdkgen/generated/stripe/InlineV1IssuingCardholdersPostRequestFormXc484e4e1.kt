...
public class InlineV1IssuingCardholdersPostRequestFormXc484e4e1(
     ...
     */
    public val preferredLocales: List<InlineV1IssuingCardholdersPostRequestFormPreferredLocalesItemX6c603048>? = null,
    /**
     ...
     */
    public val spendingControls: InlineV1IssuingCardholdersPostRequestFormSpendingControlsX3def989b? = null,
    /**
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1IssuingCardholdersPostRequestFormXc484e4e1 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1IssuingCardholdersPostRequestFormXc484e4e1> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1IssuingCardholdersPostRequestFormXc484e4e1 must be a JSON object",
                    )
            val billing =
                json.decodeRequired<InlineV1IssuingCardholdersPostRequestFormBillingXb94c2a99>(
                    rawObject,
                    "billing",
                )
            ...
            return InlineV1IssuingCardholdersPostRequestFormXc484e4e1(
                ...
                company =
                    rawObject["company"]?.let {
                        json.decodeFromJsonElement<InlineV1IssuingCardholdersPostRequestFormCompanyX1198b1b8>(it)
                    },
                email = rawObject["email"]?.let { json.decodeFromJsonElement<String>(it) },
                expand = rawObject["expand"]?.let { json.decodeFromJsonElement<List<String>>(it) },
                individual =
                    rawObject["individual"]?.let {
                        json.decodeFromJsonElement<InlineV1IssuingCardholdersPostRequestFormIndividualXf02fa7f1>(it)
                    },
                metadata = rawObject["metadata"]?.let { json.decodeFromJsonElement<Map<String, String>>(it) },
                phoneNumber = rawObject["phone_number"]?.let { json.decodeFromJsonElement<String>(it) },
                preferredLocales =
                    rawObject["preferred_locales"]?.let {
                        json
                            .decodeFromJsonElement<List<InlineV1IssuingCardholdersPostRequestFormPreferredLocalesItemX6c603048>>(
                                it,
                            )
                    },
                spendingControls =
                    rawObject["spending_controls"]?.let {
                        json.decodeFromJsonElement<InlineV1IssuingCardholdersPostRequestFormSpendingControlsX3def989b>(
                            it,
                        )
                    },
                status =
                    rawObject["status"]?.let {
                        json.decodeFromJsonElement<InlineV1IssuingCardholdersPostRequestFormStatusX9f3c57b9>(it)
                    },
                type =
                    rawObject["type"]?.let {
                        json.decodeFromJsonElement<InlineV1IssuingCardholdersPostRequestFormTypeX27fc71e0>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingCardholdersPostRequestFormXc484e4e1,
        ) {
...
public fun inlineV1IssuingCardholdersPostRequestFormXc484e4e1(
    block: InlineV1IssuingCardholdersPostRequestFormXc484e4e1.Builder.() -> Unit,
): InlineV1IssuingCardholdersPostRequestFormXc484e4e1 = InlineV1IssuingCardholdersPostRequestFormXc484e4e1.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1IssuingCardholdersPostRequestFormXc484e4e1 is missing required property '" + name + "'",
            )
