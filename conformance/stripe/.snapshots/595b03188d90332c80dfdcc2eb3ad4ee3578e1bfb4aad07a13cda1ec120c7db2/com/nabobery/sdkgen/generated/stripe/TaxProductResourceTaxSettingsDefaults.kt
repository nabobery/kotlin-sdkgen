...
public class TaxProductResourceTaxSettingsDefaults(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): TaxProductResourceTaxSettingsDefaults =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<TaxProductResourceTaxSettingsDefaults> {
        ...
        override fun deserialize(decoder: Decoder): TaxProductResourceTaxSettingsDefaults {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("TaxProductResourceTaxSettingsDefaults must be a JSON object")
            val provider =
                json.decodeRequired<InlineTaxProductResourceTaxSettingsDefaultsProviderX202ce9a1>(
                    rawObject,
                    "provider",
                )
            return TaxProductResourceTaxSettingsDefaults(
                ...
                taxBehavior =
                    rawObject["tax_behavior"]?.let { element ->
                        if (element ==
                            ...
                            json
                                .decodeFromJsonElement<InlineTaxProductResourceTaxSettingsDefaultsTaxBehaviorX5e15d3cb?>(
                                    element,
                                )
                        }
                    },
                taxCode =
                    rawObject["tax_code"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: TaxProductResourceTaxSettingsDefaults,
        ) {
...
public fun taxProductResourceTaxSettingsDefaults(
    block: TaxProductResourceTaxSettingsDefaults.Builder.() -> Unit,
): TaxProductResourceTaxSettingsDefaults = TaxProductResourceTaxSettingsDefaults.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "TaxProductResourceTaxSettingsDefaults is missing required property '" + name + "'",
            )
