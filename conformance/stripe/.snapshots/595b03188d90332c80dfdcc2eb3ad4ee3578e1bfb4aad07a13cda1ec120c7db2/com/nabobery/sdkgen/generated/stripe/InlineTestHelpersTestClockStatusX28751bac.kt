...
public sealed class InlineTestHelpersTestClockStatusX28751bac {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineTestHelpersTestClockStatusX28751bac =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineTestHelpersTestClockStatusX28751bac> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineTestHelpersTestClockStatusX28751bac",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineTestHelpersTestClockStatusX28751bac =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineTestHelpersTestClockStatusX28751bac,
        ) {
