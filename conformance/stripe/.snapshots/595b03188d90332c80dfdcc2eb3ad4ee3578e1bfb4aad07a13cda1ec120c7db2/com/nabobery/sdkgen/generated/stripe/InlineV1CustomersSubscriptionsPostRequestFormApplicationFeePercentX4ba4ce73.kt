...
public class InlineV1CustomersSubscriptionsPostRequestFormApplicationFeePercentX4ba4ce73 internal constructor(
    ...
    private val inspection: InlineV1CustomersSubscriptionsPostRequestFormApplicationFeePercentX4ba4ce73Inspection,
) {
    ...
    public val inlineV1CustomersSubscriptionsPostRequestFormAnyOf2X94f37301:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1CustomersSubscriptionsPostRequestFormAnyOf2X94f37301) {
                json
                    .decodeFromJsonElement<InlineV1CustomersSubscriptionsPostRequestFormAnyOf2X94f37301>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1CustomersSubscriptionsPostRequestFormApplicationFeePercentX4ba4ce73Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1CustomersSubscriptionsPostRequestFormAnyOf2X94f37301) {
                    add(
                        InlineV1CustomersSubscriptionsPostRequestFormApplicationFeePercentX4ba4ce73Branch.InlineV1CustomersSubscriptionsPostRequestFormAnyOf2X94f37301,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1CustomersSubscriptionsPostRequestFormApplicationFeePercentX4ba4ce73 {
            val inspection = inspectInlineV1CustomersSubscriptionsPostRequestFormApplicationFeePercentX4ba4ce73(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1CustomersSubscriptionsPostRequestFormApplicationFeePercentX4ba4ce73NoMatchException(
                    "InlineV1CustomersSubscriptionsPostRequestFormApplicationFeePercentX4ba4ce73 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1CustomersSubscriptionsPostRequestFormApplicationFeePercentX4ba4ce73> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersSubscriptionsPostRequestFormApplicationFeePercentX4ba4ce73,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1CustomersSubscriptionsPostRequestFormApplicationFeePercentX4ba4ce73",
...
private fun inspectInlineV1CustomersSubscriptionsPostRequestFormApplicationFeePercentX4ba4ce73(
    element: JsonElement,
    ...
    val matchesInlineV1CustomersSubscriptionsPostRequestFormAnyOf2X94f37301 =
        element
            .isJsonDecodable<InlineV1CustomersSubscriptionsPostRequestFormAnyOf2X94f37301>()
    return InlineV1CustomersSubscriptionsPostRequestFormApplicationFeePercentX4ba4ce73Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1CustomersSubscriptionsPostRequestFormAnyOf2X94f37301) {
                    add(
                        "InlineV1CustomersSubscriptionsPostRequestFormAnyOf2X94f37301: value does not match InlineV1CustomersSubscriptionsPostRequestFormAnyOf2X94f37301",
                    )
                }
            },
    )
