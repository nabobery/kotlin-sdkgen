...
@Serializable
public data class TreasuryFinancialAccountsResourceClosedStatusDetailsView(
    public val reasons: List<InlineTreasuryFinancialAccountsResourceClosedStatusDetailsReasonsItemX8c5d4334>,
)
...
public class TreasuryFinancialAccountsResourceClosedStatusDetails(
    ...
    public class Builder {
        ...
        public var reasons:
            List<InlineTreasuryFinancialAccountsResourceClosedStatusDetailsReasonsItemX8c5d4334>
            get() = requireNotNull(reasonsValue) { "reasons is required" }
            set(`value`) {
                reasonsValue = value
            }
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): TreasuryFinancialAccountsResourceClosedStatusDetails =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<TreasuryFinancialAccountsResourceClosedStatusDetails> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "TreasuryFinancialAccountsResourceClosedStatusDetails must be a JSON object",
                    )
            val reasons =
                json
                    .decodeRequired<List<InlineTreasuryFinancialAccountsResourceClosedStatusDetailsReasonsItemX8c5d4334>>(
                        rawObject,
                        "reasons",
                    )
            return TreasuryFinancialAccountsResourceClosedStatusDetails(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: TreasuryFinancialAccountsResourceClosedStatusDetails,
        ) {
...
public fun treasuryFinancialAccountsResourceClosedStatusDetails(
    block: TreasuryFinancialAccountsResourceClosedStatusDetails.Builder.() -> Unit,
): TreasuryFinancialAccountsResourceClosedStatusDetails =
    TreasuryFinancialAccountsResourceClosedStatusDetails.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "TreasuryFinancialAccountsResourceClosedStatusDetails is missing required property '" + name + "'",
            )
