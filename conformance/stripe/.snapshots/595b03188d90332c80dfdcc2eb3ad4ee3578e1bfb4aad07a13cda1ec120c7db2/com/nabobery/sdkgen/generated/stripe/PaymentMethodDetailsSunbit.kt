...
public class PaymentMethodDetailsSunbit(
    ...
    public class Builder {
        ...
        public fun build(): PaymentMethodDetailsSunbit =
            PaymentMethodDetailsSunbit(
    ...
    public object Serializer : KSerializer<PaymentMethodDetailsSunbit> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodDetailsSunbit {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodDetailsSunbit must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentMethodDetailsSunbit,
        ) {
...
public fun paymentMethodDetailsSunbit(
    block: PaymentMethodDetailsSunbit.Builder.() -> Unit,
): PaymentMethodDetailsSunbit = PaymentMethodDetailsSunbit.build(block)
