...
public class InlinePayoutFailureBalanceTransactionX38dfbc94 internal constructor(
        ...
        get() =
            buildSet {
                ...
                if (inspection.matchesBalanceTransaction) {
                    add(
                        InlinePayoutFailureBalanceTransactionX38dfbc94Branch.BalanceTransaction,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlinePayoutFailureBalanceTransactionX38dfbc94 {
            val inspection = inspectInlinePayoutFailureBalanceTransactionX38dfbc94(raw)
            if (inspection.matchCount == 0) {
                throw InlinePayoutFailureBalanceTransactionX38dfbc94NoMatchException(
                    "InlinePayoutFailureBalanceTransactionX38dfbc94 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlinePayoutFailureBalanceTransactionX38dfbc94> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlinePayoutFailureBalanceTransactionX38dfbc94,
        ) {
...
private fun inspectInlinePayoutFailureBalanceTransactionX38dfbc94(
    element: JsonElement,
): InlinePayoutFailureBalanceTransactionX38dfbc94Inspection {
