...
public class SetupIntentPaymentMethodOptionsKlarna(
    ...
    public class Builder {
        ...
        public fun build(): SetupIntentPaymentMethodOptionsKlarna =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): SetupIntentPaymentMethodOptionsKlarna =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<SetupIntentPaymentMethodOptionsKlarna> {
        ...
        override fun deserialize(decoder: Decoder): SetupIntentPaymentMethodOptionsKlarna {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("SetupIntentPaymentMethodOptionsKlarna must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: SetupIntentPaymentMethodOptionsKlarna,
        ) {
...
public fun setupIntentPaymentMethodOptionsKlarna(
    block: SetupIntentPaymentMethodOptionsKlarna.Builder.() -> Unit,
): SetupIntentPaymentMethodOptionsKlarna = SetupIntentPaymentMethodOptionsKlarna.build(block)
