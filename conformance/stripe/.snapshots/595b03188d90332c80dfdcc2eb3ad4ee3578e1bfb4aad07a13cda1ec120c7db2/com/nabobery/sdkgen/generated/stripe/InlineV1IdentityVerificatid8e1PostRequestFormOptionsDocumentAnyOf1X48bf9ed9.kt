...
public class InlineV1IdentityVerificatid8e1PostRequestFormOptionsDocumentAnyOf1X48bf9ed9(
    public val allowedTypes:
        List<InlineV1IdentityVerificatid8e1PostRequestFormOptionsDocumentAnyOf1ItemX165d8da4>? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1IdentityVerificatid8e1PostRequestFormOptionsDocumentAnyOf1X48bf9ed9 =
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1IdentityVerificatid8e1PostRequestFormOptionsDocumentAnyOf1X48bf9ed9 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1IdentityVerificatid8e1PostRequestFormOptionsDocumentAnyOf1X48bf9ed9> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1IdentityVerificatid8e1PostRequestFormOptionsDocumentAnyOf1X48bf9ed9 must be a JSON object",
                    )
            return InlineV1IdentityVerificatid8e1PostRequestFormOptionsDocumentAnyOf1X48bf9ed9(
                allowedTypes =
                    rawObject["allowed_types"]?.let {
                        json
                            .decodeFromJsonElement<List<InlineV1IdentityVerificatid8e1PostRequestFormOptionsDocumentAnyOf1ItemX165d8da4>>(
                                it,
                            )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IdentityVerificatid8e1PostRequestFormOptionsDocumentAnyOf1X48bf9ed9,
        ) {
            val jsonEncoder =
...
public fun inlineV1IdentityVerificatid8e1PostRequestFormOptionsDocumentAnyOf1X48bf9ed9(
    block: InlineV1IdentityVerificatid8e1PostRequestFormOptionsDocumentAnyOf1X48bf9ed9.Builder.() -> Unit,
): InlineV1IdentityVerificatid8e1PostRequestFormOptionsDocumentAnyOf1X48bf9ed9 =
