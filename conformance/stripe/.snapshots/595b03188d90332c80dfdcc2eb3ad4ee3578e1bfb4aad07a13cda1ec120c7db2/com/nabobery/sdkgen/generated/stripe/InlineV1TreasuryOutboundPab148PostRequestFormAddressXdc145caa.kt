...
internal data class InlineV1TreasuryOutboundPab148PostRequestFormAddressXdc145caaInspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesInlineV1TreasuryOutboundPab148PostRequestFormAnyOf1X9eee653b,
                matchesInlineV1TreasuryOutboundPab148PostRequestFormAnyOf2Xc4a33a84,
            ).count {
                it
            }
}
...
public class InlineV1TreasuryOutboundPab148PostRequestFormAddressXdc145caa internal constructor(
    ...
    public val inlineV1TreasuryOutboundPab148PostRequestFormAnyOf1X9eee653b:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1TreasuryOutboundPab148PostRequestFormAnyOf1X9eee653b) {
                json
                    .decodeFromJsonElement<InlineV1TreasuryOutboundPab148PostRequestFormAnyOf1X9eee653b>(
                        raw,
                    )
            } else {
                null
    ...
    public val inlineV1TreasuryOutboundPab148PostRequestFormAnyOf2Xc4a33a84:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1TreasuryOutboundPab148PostRequestFormAnyOf2Xc4a33a84) {
                json
                    .decodeFromJsonElement<InlineV1TreasuryOutboundPab148PostRequestFormAnyOf2Xc4a33a84>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches:
        ...
        get() =
            buildSet {
                if (inspection.matchesInlineV1TreasuryOutboundPab148PostRequestFormAnyOf1X9eee653b) {
                    add(
                        InlineV1TreasuryOutboundPab148PostRequestFormAddressXdc145caaBranch.InlineV1TreasuryOutboundPab148PostRequestFormAnyOf1X9eee653b,
                    )
                }
                if (inspection.matchesInlineV1TreasuryOutboundPab148PostRequestFormAnyOf2Xc4a33a84) {
                    add(
                        InlineV1TreasuryOutboundPab148PostRequestFormAddressXdc145caaBranch.InlineV1TreasuryOutboundPab148PostRequestFormAnyOf2Xc4a33a84,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1TreasuryOutboundPab148PostRequestFormAddressXdc145caa {
            val inspection = inspectInlineV1TreasuryOutboundPab148PostRequestFormAddressXdc145caa(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1TreasuryOutboundPab148PostRequestFormAddressXdc145caaNoMatchException(
                    "InlineV1TreasuryOutboundPab148PostRequestFormAddressXdc145caa matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1TreasuryOutboundPab148PostRequestFormAddressXdc145caa> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TreasuryOutboundPab148PostRequestFormAddressXdc145caa,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1TreasuryOutboundPab148PostRequestFormAddressXdc145caa",
...
private fun inspectInlineV1TreasuryOutboundPab148PostRequestFormAddressXdc145caa(
    element: JsonElement,
): InlineV1TreasuryOutboundPab148PostRequestFormAddressXdc145caaInspection {
    val matchesInlineV1TreasuryOutboundPab148PostRequestFormAnyOf1X9eee653b =
        element
            .isJsonDecodable<InlineV1TreasuryOutboundPab148PostRequestFormAnyOf1X9eee653b>()
    val matchesInlineV1TreasuryOutboundPab148PostRequestFormAnyOf2Xc4a33a84 =
        element
            .isJsonDecodable<InlineV1TreasuryOutboundPab148PostRequestFormAnyOf2Xc4a33a84>()
    return InlineV1TreasuryOutboundPab148PostRequestFormAddressXdc145caaInspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1TreasuryOutboundPab148PostRequestFormAnyOf1X9eee653b) {
                    add(
                        "InlineV1TreasuryOutboundPab148PostRequestFormAnyOf1X9eee653b: value does not match InlineV1TreasuryOutboundPab148PostRequestFormAnyOf1X9eee653b",
                    )
                }
                if (!matchesInlineV1TreasuryOutboundPab148PostRequestFormAnyOf2Xc4a33a84) {
                    add(
                        "InlineV1TreasuryOutboundPab148PostRequestFormAnyOf2Xc4a33a84: value does not match InlineV1TreasuryOutboundPab148PostRequestFormAnyOf2Xc4a33a84",
                    )
                }
            },
    )
