...
public class InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsAnyOf1X0196eaf9(
    ...
    public val mandateOptions: InlineV1CustomersSubscriptionsPostRequestFormMandateOptionsX93035423? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsAnyOf1X0196eaf9 =
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsAnyOf1X0196eaf9 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsAnyOf1X0196eaf9> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsAnyOf1X0196eaf9 must be a JSON object",
                    )
            return InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsAnyOf1X0196eaf9(
                ...
                mandateOptions =
                    rawObject["mandate_options"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CustomersSubscriptionsPostRequestFormMandateOptionsX93035423>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsAnyOf1X0196eaf9,
        ) {
            val jsonEncoder =
...
public fun inlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsAnyOf1X0196eaf9(
    block: InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsAnyOf1X0196eaf9.Builder.() -> Unit,
): InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsAnyOf1X0196eaf9 =
    InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsAnyOf1X0196eaf9.build(block)
