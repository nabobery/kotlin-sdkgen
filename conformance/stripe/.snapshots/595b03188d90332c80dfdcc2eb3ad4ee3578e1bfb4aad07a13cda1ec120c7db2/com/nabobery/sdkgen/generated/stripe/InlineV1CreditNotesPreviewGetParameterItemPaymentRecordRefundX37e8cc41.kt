...
public class InlineV1CreditNotesPreviewGetParameterItemPaymentRecordRefundX37e8cc41(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1CreditNotesPreviewGetParameterItemPaymentRecordRefundX37e8cc41 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1CreditNotesPreviewGetParameterItemPaymentRecordRefundX37e8cc41> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CreditNotesPreviewGetParameterItemPaymentRecordRefundX37e8cc41 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CreditNotesPreviewGetParameterItemPaymentRecordRefundX37e8cc41,
        ) {
            val jsonEncoder =
...
public fun inlineV1CreditNotesPreviewGetParameterItemPaymentRecordRefundX37e8cc41(
    block: InlineV1CreditNotesPreviewGetParameterItemPaymentRecordRefundX37e8cc41.Builder.() -> Unit,
): InlineV1CreditNotesPreviewGetParameterItemPaymentRecordRefundX37e8cc41 =
    InlineV1CreditNotesPreviewGetParameterItemPaymentRecordRefundX37e8cc41.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1CreditNotesPreviewGetParameterItemPaymentRecordRefundX37e8cc41 is missing required property '" +
                    name +
                    "'",
            )
