...
public class InlineV1SourcesPostRequestFormOwnerX482307eb(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1SourcesPostRequestFormOwnerX482307eb =
            InlineV1SourcesPostRequestFormOwnerX482307eb(
                address = address,
                email = email,
                name = name,
                phone = phone,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1SourcesPostRequestFormOwnerX482307eb =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1SourcesPostRequestFormOwnerX482307eb> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SourcesPostRequestFormOwnerX482307eb must be a JSON object",
                    )
            return InlineV1SourcesPostRequestFormOwnerX482307eb(
                address =
                    rawObject["address"]?.let {
                        json.decodeFromJsonElement<InlineV1SourcesPostRequestFormOwnerAddressX3d8b0cb9>(it)
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SourcesPostRequestFormOwnerX482307eb,
        ) {
...
public fun inlineV1SourcesPostRequestFormOwnerX482307eb(
    block: InlineV1SourcesPostRequestFormOwnerX482307eb.Builder.() -> Unit,
): InlineV1SourcesPostRequestFormOwnerX482307eb = InlineV1SourcesPostRequestFormOwnerX482307eb.build(block)
