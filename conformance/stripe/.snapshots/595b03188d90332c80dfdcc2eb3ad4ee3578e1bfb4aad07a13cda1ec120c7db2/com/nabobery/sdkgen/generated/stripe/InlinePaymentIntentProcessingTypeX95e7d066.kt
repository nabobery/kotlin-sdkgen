...
public sealed class InlinePaymentIntentProcessingTypeX95e7d066 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentIntentProcessingTypeX95e7d066 =
            when (value) {
                Card.value -> Card
    ...
    public object Serializer : KSerializer<InlinePaymentIntentProcessingTypeX95e7d066> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentIntentProcessingTypeX95e7d066",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePaymentIntentProcessingTypeX95e7d066 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentIntentProcessingTypeX95e7d066,
        ) {
