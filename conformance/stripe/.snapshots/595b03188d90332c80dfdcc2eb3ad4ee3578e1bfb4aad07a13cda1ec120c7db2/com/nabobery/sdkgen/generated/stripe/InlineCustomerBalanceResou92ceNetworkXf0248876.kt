...
public sealed class InlineCustomerBalanceResou92ceNetworkXf0248876 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineCustomerBalanceResou92ceNetworkXf0248876 =
            when (value) {
                Ach.value -> Ach
    ...
    public object Serializer : KSerializer<InlineCustomerBalanceResou92ceNetworkXf0248876> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineCustomerBalanceResou92ceNetworkXf0248876",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineCustomerBalanceResou92ceNetworkXf0248876 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineCustomerBalanceResou92ceNetworkXf0248876,
        ) {
