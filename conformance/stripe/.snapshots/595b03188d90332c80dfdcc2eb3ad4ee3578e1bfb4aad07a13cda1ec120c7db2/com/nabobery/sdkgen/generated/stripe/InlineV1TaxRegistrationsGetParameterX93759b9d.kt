...
public sealed class InlineV1TaxRegistrationsGetParameterX93759b9d {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1TaxRegistrationsGetParameterX93759b9d =
            when (value) {
                Active.value -> Active
                All.value -> All
    ...
    public object Serializer : KSerializer<InlineV1TaxRegistrationsGetParameterX93759b9d> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1TaxRegistrationsGetParameterX93759b9d",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1TaxRegistrationsGetParameterX93759b9d =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TaxRegistrationsGetParameterX93759b9d,
        ) {
