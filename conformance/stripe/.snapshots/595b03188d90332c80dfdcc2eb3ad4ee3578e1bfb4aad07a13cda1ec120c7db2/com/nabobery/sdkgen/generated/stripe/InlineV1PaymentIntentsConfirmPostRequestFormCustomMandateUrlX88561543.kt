...
internal data class InlineV1PaymentIntentsConfirmPostRequestFormCustomMandateUrlX88561543Inspection(
    ...
    public val matchesInlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2X72f7dece: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2X72f7dece,
            ).count {
                it
            }
}
...
public class InlineV1PaymentIntentsConfirmPostRequestFormCustomMandateUrlX88561543 internal constructor(
    ...
    private val inspection: InlineV1PaymentIntentsConfirmPostRequestFormCustomMandateUrlX88561543Inspection,
) {
    ...
    public val inlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2X72f7dece:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2X72f7dece) {
                json
                    .decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2X72f7dece>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1PaymentIntentsConfirmPostRequestFormCustomMandateUrlX88561543Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2X72f7dece) {
                    add(
                        InlineV1PaymentIntentsConfirmPostRequestFormCustomMandateUrlX88561543Branch.InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2X72f7dece,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1PaymentIntentsConfirmPostRequestFormCustomMandateUrlX88561543 {
            val inspection = inspectInlineV1PaymentIntentsConfirmPostRequestFormCustomMandateUrlX88561543(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1PaymentIntentsConfirmPostRequestFormCustomMandateUrlX88561543NoMatchException(
                    "InlineV1PaymentIntentsConfirmPostRequestFormCustomMandateUrlX88561543 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsConfirmPostRequestFormCustomMandateUrlX88561543> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsConfirmPostRequestFormCustomMandateUrlX88561543,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1PaymentIntentsConfirmPostRequestFormCustomMandateUrlX88561543",
...
private fun inspectInlineV1PaymentIntentsConfirmPostRequestFormCustomMandateUrlX88561543(
    element: JsonElement,
): InlineV1PaymentIntentsConfirmPostRequestFormCustomMandateUrlX88561543Inspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2X72f7dece =
        element
            .isJsonDecodable<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2X72f7dece>()
    return InlineV1PaymentIntentsConfirmPostRequestFormCustomMandateUrlX88561543Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2X72f7dece) {
                    add(
                        "InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2X72f7dece: value does not match InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2X72f7dece",
                    )
                }
            },
    )
