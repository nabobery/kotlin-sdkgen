...
public class PaymentsPrimitivesPaymentRecordsResourcePaymentMethodDetails(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentsPrimitivesPaymentRecordsResourcePaymentMethodDetails =
    ...
    public object Serializer : KSerializer<PaymentsPrimitivesPaymentRecordsResourcePaymentMethodDetails> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "PaymentsPrimitivesPaymentRecordsResourcePaymentMethodDetails must be a JSON object",
                    )
            val type = json.decodeRequired<String>(rawObject, "type")
            return PaymentsPrimitivesPaymentRecordsResourcePaymentMethodDetails(
                type = type,
                achCreditTransfer =
                    rawObject["ach_credit_transfer"]?.let {
                        json.decodeFromJsonElement<PaymentMethodDetailsAchCreditTransfer>(it)
                    },
                achDebit =
                    rawObject["ach_debit"]?.let {
                        json.decodeFromJsonElement<PaymentMethodDetailsAchDebit>(
                            it,
                        )
                    },
                acssDebit =
                    rawObject["acss_debit"]?.let {
                        json
                            .decodeFromJsonElement<PaymentMethodDetailsPaymentRecordAcssDebit>(
                                it,
                            )
                    },
                affirm =
                    rawObject["affirm"]?.let {
                        json
                            .decodeFromJsonElement<PaymentMethodDetailsPaymentRecordAffirm>(
                                it,
                            )
                    },
                afterpayClearpay =
                    rawObject["afterpay_clearpay"]?.let {
                        json.decodeFromJsonElement<PaymentMethodDetailsPaymentRecordAfterpayClearpay>(it)
                    },
                alipay =
                    rawObject["alipay"]?.let {
                        json.decodeFromJsonElement<PaymentFlowsPrivatePaymentMethodsAlipayDetails>(
                            it,
                        )
                    },
                alma =
                    rawObject["alma"]?.let {
                        json
                            .decodeFromJsonElement<PaymentMethodDetailsPaymentRecordAlma>(
                                it,
                            )
                    },
                amazonPay =
                    rawObject["amazon_pay"]?.let {
                        json
                            .decodeFromJsonElement<PaymentMethodDetailsPaymentRecordAmazonPay>(
                                it,
                            )
                    },
                auBecsDebit =
                    rawObject["au_becs_debit"]?.let {
                        json.decodeFromJsonElement<PaymentMethodDetailsAuBecsDebit>(
                            it,
                        )
                    },
                bacsDebit =
                    rawObject["bacs_debit"]?.let {
                        json
                            .decodeFromJsonElement<PaymentMethodDetailsBacsDebit>(
                                it,
                            )
                    },
                bancontact =
                    rawObject["bancontact"]?.let {
                        json.decodeFromJsonElement<PaymentMethodDetailsPaymentRecordBancontact>(it)
                    },
                billie =
                    rawObject["billie"]?.let {
                        json
                            .decodeFromJsonElement<PaymentMethodDetailsPaymentRecordBillie>(
                                it,
                            )
                    },
                billingDetails =
                    rawObject["billing_details"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlinePaymentsPrimitivesPa1a22BillingDetailsX93fd2d12?>(element)
                        }
                    },
                bizum =
                    rawObject["bizum"]?.let {
                        json.decodeFromJsonElement<PaymentMethodDetailsPaymentRecordBizum>(
                            it,
                        )
                    },
                blik = rawObject["blik"]?.let {
                    json.decodeFromJsonElement<PaymentMethodDetailsPaymentRecordBlik>(
                        it,
                    )
                },
                boleto =
                    rawObject["boleto"]?.let {
                        json.decodeFromJsonElement<PaymentMethodDetailsPaymentRecordBoleto>(
                            it,
                        )
                    },
                card =
                    rawObject["card"]?.let {
                        json.decodeFromJsonElement<PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCardDetails>(it)
                    },
                cardPresent =
                    rawObject["card_present"]?.let {
                        json.decodeFromJsonElement<PaymentMethodDetailsCardPresent>(
                            it,
                        )
                    },
                cashapp =
                    rawObject["cashapp"]?.let {
                        json.decodeFromJsonElement<PaymentMethodDetailsPaymentRecordCashapp>(
                            it,
                        )
                    },
                crypto =
                    rawObject["crypto"]?.let {
                        json.decodeFromJsonElement<PaymentMethodDetailsCrypto>(
                            it,
                        )
                    },
                custom =
                    rawObject["custom"]?.let {
                        json.decodeFromJsonElement<PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCustomDetails>(
                            it,
                        )
                    },
                ...
                giropay =
                    rawObject["giropay"]?.let {
                        json.decodeFromJsonElement<PaymentMethodDetailsPaymentRecordGiropay>(
                            it,
                        )
                    },
                ...
                ideal =
                    rawObject["ideal"]?.let {
                        json.decodeFromJsonElement<PaymentMethodDetailsPaymentRecordIdeal>(
                            it,
                        )
                    },
                interacPresent =
                    rawObject["interac_present"]?.let {
                        json.decodeFromJsonElement<PaymentMethodDetailsInteracPresent>(it)
                    },
                kakaoPay =
                    rawObject["kakao_pay"]?.let {
                        json.decodeFromJsonElement<PaymentMethodDetailsPaymentRecordKakaoPay>(
                            it,
                        )
                    },
                klarna =
                    rawObject["klarna"]?.let {
                        json
                            .decodeFromJsonElement<PaymentMethodDetailsPaymentRecordKlarna>(
                                it,
                            )
                    },
                konbini =
                    rawObject["konbini"]?.let {
                        json.decodeFromJsonElement<PaymentMethodDetailsPaymentRecordKonbini>(
                            it,
                        )
                    },
                ...
                mobilepay =
                    rawObject["mobilepay"]?.let {
                        json
                            .decodeFromJsonElement<PaymentMethodDetailsPaymentRecordMobilepay>(
                                it,
                            )
                    },
                multibanco =
                    rawObject["multibanco"]?.let {
                        json.decodeFromJsonElement<PaymentMethodDetailsPaymentRecordMultibanco>(it)
                    },
                naverPay =
                    rawObject["naver_pay"]?.let {
                        json.decodeFromJsonElement<PaymentMethodDetailsPaymentRecordNaverPay>(
                            it,
                        )
                    },
                nzBankAccount =
                    rawObject["nz_bank_account"]?.let {
                        json
                            .decodeFromJsonElement<PaymentMethodDetailsNzBankAccount>(
                                it,
                            )
                    },
                oxxo =
                    rawObject["oxxo"]?.let {
                        json
                            .decodeFromJsonElement<PaymentMethodDetailsPaymentRecordOxxo>(
                                it,
                            )
                    },
                p24 = rawObject["p24"]?.let {
                    json.decodeFromJsonElement<PaymentMethodDetailsPaymentRecordP24>(
                        it,
                    )
                },
                ...
                payco =
                    rawObject["payco"]?.let {
                        json.decodeFromJsonElement<PaymentMethodDetailsPaymentRecordPayco>(
                            it,
                        )
                    },
                paymentMethod =
                    rawObject["payment_method"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                paynow =
                    rawObject["paynow"]?.let {
                        json.decodeFromJsonElement<PaymentMethodDetailsPaymentRecordPaynow>(
                            it,
                        )
                    },
                ...
                payto =
                    rawObject["payto"]?.let {
                        json.decodeFromJsonElement<PaymentMethodDetailsPaymentRecordPayto>(
                            it,
                        )
                    },
                pix = rawObject["pix"]?.let {
                    json.decodeFromJsonElement<PaymentMethodDetailsPaymentRecordPix>(
                        it,
                    )
                },
                promptpay =
                    rawObject["promptpay"]?.let {
                        json
                            .decodeFromJsonElement<PaymentMethodDetailsPaymentRecordPromptpay>(
                                it,
                            )
                    },
                revolutPay =
                    rawObject["revolut_pay"]?.let {
                        json.decodeFromJsonElement<PaymentMethodDetailsPaymentRecordRevolutPay>(it)
                    },
                samsungPay =
                    rawObject["samsung_pay"]?.let {
                        json.decodeFromJsonElement<PaymentMethodDetailsPaymentRecordSamsungPay>(it)
                    },
                satispay =
                    rawObject["satispay"]?.let {
                        json.decodeFromJsonElement<PaymentMethodDetailsPaymentRecordSatispay>(
                            it,
                        )
                    },
                scalapay =
                    rawObject["scalapay"]?.let {
                        json.decodeFromJsonElement<PaymentMethodDetailsPaymentRecordScalapay>(
                            it,
                        )
                    },
                sepaDebit =
                    rawObject["sepa_debit"]?.let {
                        json
                            .decodeFromJsonElement<PaymentMethodDetailsPaymentRecordSepaDebit>(
                                it,
                            )
                    },
                sofort =
                    rawObject["sofort"]?.let {
                        json
                            .decodeFromJsonElement<PaymentMethodDetailsPaymentRecordSofort>(
                                it,
                            )
                    },
                ...
                sunbit =
                    rawObject["sunbit"]?.let {
                        json.decodeFromJsonElement<PaymentMethodDetailsPaymentRecordSunbit>(
                            it,
                        )
                    },
                swish =
                    rawObject["swish"]?.let {
                        json.decodeFromJsonElement<PaymentMethodDetailsPaymentRecordSwish>(
                            it,
                        )
                    },
                twint =
                    rawObject["twint"]?.let {
                        json.decodeFromJsonElement<PaymentMethodDetailsPaymentRecordTwint>(
                            it,
                        )
                    },
                upi = rawObject["upi"]?.let {
                    json
                        .decodeFromJsonElement<PaymentMethodDetailsPaymentRecordUpi>(
                            it,
                        )
                },
                usBankAccount =
                    rawObject["us_bank_account"]?.let {
                        json.decodeFromJsonElement<PaymentMethodDetailsPaymentRecordUsBankAccount>(it)
                    },
                wechat = rawObject["wechat"]?.let { json.decodeFromJsonElement<JsonObject>(it) },
                wechatPay =
                    rawObject["wechat_pay"]?.let {
                        json
                            .decodeFromJsonElement<PaymentMethodDetailsPaymentRecordWechatPay>(
                                it,
                            )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentsPrimitivesPaymentRecordsResourcePaymentMethodDetails,
        ) {
...
public fun paymentsPrimitivesPaymentRecordsResourcePaymentMethodDetails(
    block: PaymentsPrimitivesPaymentRecordsResourcePaymentMethodDetails.Builder.() -> Unit,
): PaymentsPrimitivesPaymentRecordsResourcePaymentMethodDetails =
    PaymentsPrimitivesPaymentRecordsResourcePaymentMethodDetails.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "PaymentsPrimitivesPaymentRecordsResourcePaymentMethodDetails is missing required property '" + name +
                    "'",
            )
