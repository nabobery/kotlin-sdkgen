...
public class PaymentLinksResourceAutomaticTax(
    ...
    public object Serializer : KSerializer<PaymentLinksResourceAutomaticTax> {
        ...
        override fun deserialize(decoder: Decoder): PaymentLinksResourceAutomaticTax {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentLinksResourceAutomaticTax must be a JSON object")
                ...
                liability =
                    rawObject["liability"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentLinksResourceAutomaticTaxLiabilityXa5e53176?>(
                                element,
                            )
                        }
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentLinksResourceAutomaticTax,
        ) {
...
public fun paymentLinksResourceAutomaticTax(
    block: PaymentLinksResourceAutomaticTax.Builder.() -> Unit,
): PaymentLinksResourceAutomaticTax = PaymentLinksResourceAutomaticTax.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "PaymentLinksResourceAutomaticTax is missing required property '" + name + "'",
            )
