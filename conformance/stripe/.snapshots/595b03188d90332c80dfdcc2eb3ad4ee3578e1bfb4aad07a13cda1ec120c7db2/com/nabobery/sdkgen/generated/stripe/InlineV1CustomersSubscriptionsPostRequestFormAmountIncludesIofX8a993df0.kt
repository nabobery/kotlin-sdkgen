...
public sealed class InlineV1CustomersSubscriptionsPostRequestFormAmountIncludesIofX8a993df0 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1CustomersSubscriptionsPostRequestFormAmountIncludesIofX8a993df0 =
            when (value) {
                Always.value -> Always
                Never.value -> Never
    ...
    public object Serializer : KSerializer<InlineV1CustomersSubscriptionsPostRequestFormAmountIncludesIofX8a993df0> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1CustomersSubscriptionsPostRequestFormAmountIncludesIofX8a993df0",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1CustomersSubscriptionsPostRequestFormAmountIncludesIofX8a993df0 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersSubscriptionsPostRequestFormAmountIncludesIofX8a993df0,
        ) {
