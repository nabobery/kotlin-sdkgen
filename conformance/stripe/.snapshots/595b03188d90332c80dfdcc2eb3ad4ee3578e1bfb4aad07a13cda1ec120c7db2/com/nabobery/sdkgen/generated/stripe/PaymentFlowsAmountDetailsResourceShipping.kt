...
public class PaymentFlowsAmountDetailsResourceShipping(
    ...
    public class Builder {
        ...
        public fun build(): PaymentFlowsAmountDetailsResourceShipping =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentFlowsAmountDetailsResourceShipping =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentFlowsAmountDetailsResourceShipping> {
        ...
        override fun deserialize(decoder: Decoder): PaymentFlowsAmountDetailsResourceShipping {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentFlowsAmountDetailsResourceShipping must be a JSON object")
            return PaymentFlowsAmountDetailsResourceShipping(
                ...
                fromPostalCode =
                    rawObject["from_postal_code"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                toPostalCode =
                    rawObject["to_postal_code"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentFlowsAmountDetailsResourceShipping,
        ) {
...
public fun paymentFlowsAmountDetailsResourceShipping(
    block: PaymentFlowsAmountDetailsResourceShipping.Builder.() -> Unit,
): PaymentFlowsAmountDetailsResourceShipping = PaymentFlowsAmountDetailsResourceShipping.build(block)
