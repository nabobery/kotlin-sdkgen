...
public class InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsGrabpayXc45c1cfd(
    public val setupFutureUsage: InlineV1CheckoutSessionsPostRequestFormSetupFutureUsageX7c8c5015? = null,
) {
    public class Builder {
        public var setupFutureUsage: InlineV1CheckoutSessionsPostRequestFormSetupFutureUsageX7c8c5015? =
            null

        public fun build(): InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsGrabpayXc45c1cfd =
            InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsGrabpayXc45c1cfd(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsGrabpayXc45c1cfd = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsGrabpayXc45c1cfd> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsGrabpayXc45c1cfd must be a JSON object",
                    )
            return InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsGrabpayXc45c1cfd(
                setupFutureUsage =
                    rawObject["setup_future_usage"]?.let {
                        json.decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormSetupFutureUsageX7c8c5015>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsGrabpayXc45c1cfd,
        ) {
            val jsonEncoder =
...
public fun inlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsGrabpayXc45c1cfd(
    block: InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsGrabpayXc45c1cfd.Builder.() -> Unit,
): InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsGrabpayXc45c1cfd =
