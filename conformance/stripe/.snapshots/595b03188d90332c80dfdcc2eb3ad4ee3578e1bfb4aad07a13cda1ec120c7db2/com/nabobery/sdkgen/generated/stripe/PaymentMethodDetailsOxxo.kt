...
public class PaymentMethodDetailsOxxo(
    ...
    public class Builder {
        ...
        public fun build(): PaymentMethodDetailsOxxo =
    ...
    public object Serializer : KSerializer<PaymentMethodDetailsOxxo> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodDetailsOxxo {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodDetailsOxxo must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentMethodDetailsOxxo,
        ) {
...
public fun paymentMethodDetailsOxxo(block: PaymentMethodDetailsOxxo.Builder.() -> Unit): PaymentMethodDetailsOxxo =
    PaymentMethodDetailsOxxo.build(block)
