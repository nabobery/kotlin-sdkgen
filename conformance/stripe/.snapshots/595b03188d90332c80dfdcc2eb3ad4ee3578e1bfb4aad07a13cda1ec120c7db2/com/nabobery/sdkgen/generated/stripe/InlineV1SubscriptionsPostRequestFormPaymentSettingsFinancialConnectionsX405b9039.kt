...
public class InlineV1SubscriptionsPostRequestFormPaymentSettingsFinancialConnectionsX405b9039(
    ...
    public val permissions: List<InlineV1SubscriptionsPostRequestFormPaymentSettingsItemX883af773>? = null,
    public val prefetch: List<InlineV1SubscriptionsPostRequestFormPaymentSettingsItemX24f386c6>? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1SubscriptionsPostRequestFormPaymentSettingsFinancialConnectionsX405b9039 =
            InlineV1SubscriptionsPostRequestFormPaymentSettingsFinancialConnectionsX405b9039(
                filters = filters,
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionsPostRequestFormPaymentSettingsFinancialConnectionsX405b9039> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SubscriptionsPostRequestFormPaymentSettingsFinancialConnectionsX405b9039 must be a JSON object",
                    )
            return InlineV1SubscriptionsPostRequestFormPaymentSettingsFinancialConnectionsX405b9039(
                filters =
                    rawObject["filters"]?.let {
                        json.decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormPaymentSettingsFiltersX8f956230>(
                            it,
                        )
                    },
                permissions =
                    rawObject["permissions"]?.let {
                        json
                            .decodeFromJsonElement<List<InlineV1SubscriptionsPostRequestFormPaymentSettingsItemX883af773>>(
                                it,
                            )
                    },
                prefetch =
                    rawObject["prefetch"]?.let {
                        json
                            .decodeFromJsonElement<List<InlineV1SubscriptionsPostRequestFormPaymentSettingsItemX24f386c6>>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsPostRequestFormPaymentSettingsFinancialConnectionsX405b9039,
        ) {
            val jsonEncoder =
...
public fun inlineV1SubscriptionsPostRequestFormPaymentSettingsFinancialConnectionsX405b9039(
    block: InlineV1SubscriptionsPostRequestFormPaymentSettingsFinancialConnectionsX405b9039.Builder.() -> Unit,
): InlineV1SubscriptionsPostRequestFormPaymentSettingsFinancialConnectionsX405b9039 =
    InlineV1SubscriptionsPostRequestFormPaymentSettingsFinancialConnectionsX405b9039.build(block)
