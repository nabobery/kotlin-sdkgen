...
public class InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsItemX24692a83(
    public val interval: InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsIntervalX860e5761,
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsItemX24692a83 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsItemX24692a83> {
        ...
        override fun deserialize(
            decoder: Decoder,
        ): InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsItemX24692a83 {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsItemX24692a83 must be a JSON object",
                    )
            val interval =
                json
                    .decodeRequired<InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsIntervalX860e5761>(
                        rawObject,
                        "interval",
                    )
            val nextBilling =
                json.decodeRequired<InlineV1SetupIntentsConfirmPostRequestFormNextBillingXe2a00f06>(
                    rawObject,
                    "next_billing",
                )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsItemX24692a83,
        ) {
            val jsonEncoder =
...
public fun inlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsItemX24692a83(
    block: InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsItemX24692a83.Builder.() -> Unit,
): InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsItemX24692a83 =
    InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsItemX24692a83.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsItemX24692a83 is missing required property '" +
                    name +
                    "'",
            )
