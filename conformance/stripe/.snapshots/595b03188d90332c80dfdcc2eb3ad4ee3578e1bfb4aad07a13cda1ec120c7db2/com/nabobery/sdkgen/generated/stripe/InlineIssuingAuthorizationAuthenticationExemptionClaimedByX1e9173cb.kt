...
public sealed class InlineIssuingAuthorizationAuthenticationExemptionClaimedByX1e9173cb {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineIssuingAuthorizationAuthenticationExemptionClaimedByX1e9173cb =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineIssuingAuthorizationAuthenticationExemptionClaimedByX1e9173cb> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineIssuingAuthorizationAuthenticationExemptionClaimedByX1e9173cb",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineIssuingAuthorizationAuthenticationExemptionClaimedByX1e9173cb = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineIssuingAuthorizationAuthenticationExemptionClaimedByX1e9173cb,
        ) {
