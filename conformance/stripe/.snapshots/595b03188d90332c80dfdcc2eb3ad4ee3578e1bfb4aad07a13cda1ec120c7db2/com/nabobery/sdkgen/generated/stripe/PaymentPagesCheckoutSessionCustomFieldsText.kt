...
public class PaymentPagesCheckoutSessionCustomFieldsText(
    ...
    public class Builder {
        ...
        public fun build(): PaymentPagesCheckoutSessionCustomFieldsText =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentPagesCheckoutSessionCustomFieldsText =
    ...
    public object Serializer : KSerializer<PaymentPagesCheckoutSessionCustomFieldsText> {
        ...
        override fun deserialize(decoder: Decoder): PaymentPagesCheckoutSessionCustomFieldsText {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentPagesCheckoutSessionCustomFieldsText must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentPagesCheckoutSessionCustomFieldsText,
        ) {
...
public fun paymentPagesCheckoutSessionCustomFieldsText(
    block: PaymentPagesCheckoutSessionCustomFieldsText.Builder.() -> Unit,
): PaymentPagesCheckoutSessionCustomFieldsText = PaymentPagesCheckoutSessionCustomFieldsText.build(block)
