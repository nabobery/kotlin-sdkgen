...
public class InlineFinancialConnectionsAccountOwnershipX0d638327 internal constructor(
    ...
    public val financialConnectionsAccountOwnership: FinancialConnectionsAccountOwnership? by
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesFinancialConnectionsAccountOwnership) {
                json
                    .decodeFromJsonElement<FinancialConnectionsAccountOwnership>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineFinancialConnectionsAccountOwnershipX0d638327Branch>
        get() =
            buildSet {
                ...
                if (inspection.matchesFinancialConnectionsAccountOwnership) {
                    add(
                        InlineFinancialConnectionsAccountOwnershipX0d638327Branch.FinancialConnectionsAccountOwnership,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineFinancialConnectionsAccountOwnershipX0d638327 {
            val inspection = inspectInlineFinancialConnectionsAccountOwnershipX0d638327(raw)
            if (inspection.matchCount == 0) {
                throw InlineFinancialConnectionsAccountOwnershipX0d638327NoMatchException(
                    "InlineFinancialConnectionsAccountOwnershipX0d638327 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineFinancialConnectionsAccountOwnershipX0d638327> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineFinancialConnectionsAccountOwnershipX0d638327,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineFinancialConnectionsAccountOwnershipX0d638327",
...
private fun inspectInlineFinancialConnectionsAccountOwnershipX0d638327(
    element: JsonElement,
): InlineFinancialConnectionsAccountOwnershipX0d638327Inspection {
    ...
    return InlineFinancialConnectionsAccountOwnershipX0d638327Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesFinancialConnectionsAccountOwnership) {
                    add(
                        "FinancialConnectionsAccountOwnership: value does not match FinancialConnectionsAccountOwnership",
                    )
                }
            },
    )
