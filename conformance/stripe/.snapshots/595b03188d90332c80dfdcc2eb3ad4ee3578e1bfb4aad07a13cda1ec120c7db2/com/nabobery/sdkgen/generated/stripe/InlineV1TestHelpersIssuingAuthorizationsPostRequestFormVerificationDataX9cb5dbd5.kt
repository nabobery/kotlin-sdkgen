...
public class InlineV1TestHelpersIssuingAuthorizationsPostRequestFormVerificationDataX9cb5dbd5(
    public val addressLine1Check: InlineV1TestHelpersIssuing214aPostRequestFormAddressLine1CheckX9dffe9a0? = null,
    ...
    public val cvcCheck: InlineV1TestHelpersIssuing214aPostRequestFormVerificationDataCvcCheckX8d89be6d? = null,
    public val expiryCheck: InlineV1TestHelpersIssuing214aPostRequestFormExpiryCheckXf06ee4a7? = null,
    public val threeDSecure: InlineV1TestHelpersIssuing214aPostRequestFormThreeDSecureXd4b82376? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1TestHelpersIssuingAuthorizationsPostRequestFormVerificationDataX9cb5dbd5 =
            InlineV1TestHelpersIssuingAuthorizationsPostRequestFormVerificationDataX9cb5dbd5(
    ...
    public object Serializer : KSerializer<InlineV1TestHelpersIssuingAuthorizationsPostRequestFormVerificationDataX9cb5dbd5> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TestHelpersIssuingAuthorizationsPostRequestFormVerificationDataX9cb5dbd5 must be a JSON object",
                    )
            return InlineV1TestHelpersIssuingAuthorizationsPostRequestFormVerificationDataX9cb5dbd5(
                addressLine1Check =
                    rawObject["address_line1_check"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TestHelpersIssuing214aPostRequestFormAddressLine1CheckX9dffe9a0>(
                                it,
                            )
                    },
                addressPostalCodeCheck =
                    rawObject["address_postal_code_check"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TestHelpersIssuing214aPostRequestFormAddressPostalCodeCheckXbfcaca27>(
                                it,
                            )
                    },
                authenticationExemption =
                    rawObject["authentication_exemption"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TestHelpersIssuing214aPostRequestFormAuthenticationExemptionXc9b11235>(
                                it,
                            )
                    },
                cvcCheck =
                    rawObject["cvc_check"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TestHelpersIssuing214aPostRequestFormVerificationDataCvcCheckX8d89be6d>(
                                it,
                            )
                    },
                expiryCheck =
                    rawObject["expiry_check"]?.let {
                        json.decodeFromJsonElement<InlineV1TestHelpersIssuing214aPostRequestFormExpiryCheckXf06ee4a7>(
                            it,
                        )
                    },
                threeDSecure =
                    rawObject["three_d_secure"]?.let {
                        json.decodeFromJsonElement<InlineV1TestHelpersIssuing214aPostRequestFormThreeDSecureXd4b82376>(
                            it,
                        )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TestHelpersIssuingAuthorizationsPostRequestFormVerificationDataX9cb5dbd5,
        ) {
            val jsonEncoder =
...
public fun inlineV1TestHelpersIssuingAuthorizationsPostRequestFormVerificationDataX9cb5dbd5(
    block: InlineV1TestHelpersIssuingAuthorizationsPostRequestFormVerificationDataX9cb5dbd5.Builder.() -> Unit,
): InlineV1TestHelpersIssuingAuthorizationsPostRequestFormVerificationDataX9cb5dbd5 =
