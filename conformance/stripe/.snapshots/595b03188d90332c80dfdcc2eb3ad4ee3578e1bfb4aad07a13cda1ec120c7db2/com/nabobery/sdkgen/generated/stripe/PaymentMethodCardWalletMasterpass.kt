...
public class PaymentMethodCardWalletMasterpass(
     ...
     */
    public val shippingAddress: InlinePaymentMethodCardWalletMasterpassShippingAddressX553d4b27? = null,
) {
    public class Builder {
        ...
        public fun build(): PaymentMethodCardWalletMasterpass =
    ...
    public object Serializer : KSerializer<PaymentMethodCardWalletMasterpass> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodCardWalletMasterpass {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodCardWalletMasterpass must be a JSON object")
                ...
                billingAddress =
                    rawObject["billing_address"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentMethodCardWalletMasterpassBillingAddressX9cc916fb?>(
                                element,
                            )
                        }
                    },
                ...
                shippingAddress =
                    rawObject["shipping_address"]?.let { element ->
                        if (element ==
                            ...
                            json
                                .decodeFromJsonElement<InlinePaymentMethodCardWalletMasterpassShippingAddressX553d4b27?>(
                                    element,
                                )
                        }
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentMethodCardWalletMasterpass,
        ) {
...
public fun paymentMethodCardWalletMasterpass(
    block: PaymentMethodCardWalletMasterpass.Builder.() -> Unit,
): PaymentMethodCardWalletMasterpass = PaymentMethodCardWalletMasterpass.build(block)
