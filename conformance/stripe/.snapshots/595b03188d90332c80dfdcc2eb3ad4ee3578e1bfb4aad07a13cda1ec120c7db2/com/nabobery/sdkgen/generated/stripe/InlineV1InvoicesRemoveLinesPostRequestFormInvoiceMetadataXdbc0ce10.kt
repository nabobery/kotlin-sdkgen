...
internal data class InlineV1InvoicesRemoveLinesPostRequestFormInvoiceMetadataXdbc0ce10Inspection(
    ...
    public val matchesInlineV1InvoicesRemoveLinesPostRequestFormInvoiceMetadataAnyOf2X0a804ddf: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1InvoicesRemoveLinesPostRequestFormInvoiceMetadataAnyOf2X0a804ddf,
            ).count {
                it
            }
}
...
public class InlineV1InvoicesRemoveLinesPostRequestFormInvoiceMetadataXdbc0ce10 internal constructor(
    ...
    private val inspection: InlineV1InvoicesRemoveLinesPostRequestFormInvoiceMetadataXdbc0ce10Inspection,
) {
    ...
    public val inlineV1InvoicesRemoveLinesPostRequestFormInvoiceMetadataAnyOf2X0a804ddf:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1InvoicesRemoveLinesPostRequestFormInvoiceMetadataAnyOf2X0a804ddf) {
                json
                    .decodeFromJsonElement<InlineV1InvoicesRemoveLinesPostRequestFormInvoiceMetadataAnyOf2X0a804ddf>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1InvoicesRemoveLinesPostRequestFormInvoiceMetadataXdbc0ce10Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1InvoicesRemoveLinesPostRequestFormInvoiceMetadataAnyOf2X0a804ddf) {
                    add(
                        InlineV1InvoicesRemoveLinesPostRequestFormInvoiceMetadataXdbc0ce10Branch.InlineV1InvoicesRemoveLinesPostRequestFormInvoiceMetadataAnyOf2X0a804ddf,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1InvoicesRemoveLinesPostRequestFormInvoiceMetadataXdbc0ce10 {
            val inspection = inspectInlineV1InvoicesRemoveLinesPostRequestFormInvoiceMetadataXdbc0ce10(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1InvoicesRemoveLinesPostRequestFormInvoiceMetadataXdbc0ce10NoMatchException(
                    "InlineV1InvoicesRemoveLinesPostRequestFormInvoiceMetadataXdbc0ce10 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1InvoicesRemoveLinesPostRequestFormInvoiceMetadataXdbc0ce10> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesRemoveLinesPostRequestFormInvoiceMetadataXdbc0ce10,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1InvoicesRemoveLinesPostRequestFormInvoiceMetadataXdbc0ce10",
...
private fun inspectInlineV1InvoicesRemoveLinesPostRequestFormInvoiceMetadataXdbc0ce10(
    element: JsonElement,
): InlineV1InvoicesRemoveLinesPostRequestFormInvoiceMetadataXdbc0ce10Inspection {
    val matchesBranch1 = element.isJsonDecodable<JsonObject>()
    val matchesInlineV1InvoicesRemoveLinesPostRequestFormInvoiceMetadataAnyOf2X0a804ddf =
        element
            .isJsonDecodable<InlineV1InvoicesRemoveLinesPostRequestFormInvoiceMetadataAnyOf2X0a804ddf>()
    return InlineV1InvoicesRemoveLinesPostRequestFormInvoiceMetadataXdbc0ce10Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1InvoicesRemoveLinesPostRequestFormInvoiceMetadataAnyOf2X0a804ddf) {
                    add(
                        "InlineV1InvoicesRemoveLinesPostRequestFormInvoiceMetadataAnyOf2X0a804ddf: value does not match InlineV1InvoicesRemoveLinesPostRequestFormInvoiceMetadataAnyOf2X0a804ddf",
                    )
                }
            },
    )
