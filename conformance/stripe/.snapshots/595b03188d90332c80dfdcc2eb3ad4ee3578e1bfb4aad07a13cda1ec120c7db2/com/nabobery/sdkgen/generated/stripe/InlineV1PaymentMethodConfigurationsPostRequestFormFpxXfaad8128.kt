...
public class InlineV1PaymentMethodConfigurationsPostRequestFormFpxXfaad8128(
    public val displayPreference: InlineV1PaymentMethodConfigurationsPostRequestFormFpxDisplayPreferenceXce094fc4? = null,
) {
    public class Builder {
        public var displayPreference:
            InlineV1PaymentMethodConfigurationsPostRequestFormFpxDisplayPreferenceXce094fc4? = null

        public fun build(): InlineV1PaymentMethodConfigurationsPostRequestFormFpxXfaad8128 =
            InlineV1PaymentMethodConfigurationsPostRequestFormFpxXfaad8128(
                displayPreference = displayPreference,
            )
    }

    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PaymentMethodConfigurationsPostRequestFormFpxXfaad8128 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentMethodConfigurationsPostRequestFormFpxXfaad8128> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentMethodConfigurationsPostRequestFormFpxXfaad8128 must be a JSON object",
                    )
            return InlineV1PaymentMethodConfigurationsPostRequestFormFpxXfaad8128(
                displayPreference =
                    rawObject["display_preference"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentMethodConfigurationsPostRequestFormFpxDisplayPreferenceXce094fc4>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentMethodConfigurationsPostRequestFormFpxXfaad8128,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentMethodConfigurationsPostRequestFormFpxXfaad8128(
    block: InlineV1PaymentMethodConfigurationsPostRequestFormFpxXfaad8128.Builder.() -> Unit,
): InlineV1PaymentMethodConfigurationsPostRequestFormFpxXfaad8128 =
    InlineV1PaymentMethodConfigurationsPostRequestFormFpxXfaad8128.build(block)
