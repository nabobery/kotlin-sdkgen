...
public class PaymentLinksResourceCompletionBehaviorConfirmationPage(
    ...
    public class Builder {
        ...
        public fun build(): PaymentLinksResourceCompletionBehaviorConfirmationPage =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentLinksResourceCompletionBehaviorConfirmationPage =
    ...
    public object Serializer : KSerializer<PaymentLinksResourceCompletionBehaviorConfirmationPage> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "PaymentLinksResourceCompletionBehaviorConfirmationPage must be a JSON object",
                    )
            return PaymentLinksResourceCompletionBehaviorConfirmationPage(
                customMessage =
                    rawObject["custom_message"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentLinksResourceCompletionBehaviorConfirmationPage,
        ) {
...
public fun paymentLinksResourceCompletionBehaviorConfirmationPage(
    block: PaymentLinksResourceCompletionBehaviorConfirmationPage.Builder.() -> Unit,
): PaymentLinksResourceCompletionBehaviorConfirmationPage =
    PaymentLinksResourceCompletionBehaviorConfirmationPage.build(block)
