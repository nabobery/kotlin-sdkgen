...
internal data class InlineV1SetupIntentsPostRequestFormPaymentMethodDataBillingDetailsNameX69a3849aInspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1SetupIntentsPostRequestFormPaymentMethodDataAnyOf2X9d951d0d,
            ).count { it }
}
...
public class InlineV1SetupIntentsPostRequestFormPaymentMethodDataBillingDetailsNameX69a3849a internal constructor(
    ...
    private val inspection: InlineV1SetupIntentsPostRequestFormPaymentMethodDataBillingDetailsNameX69a3849aInspection,
) {
    ...
    public val inlineV1SetupIntentsPostRequestFormPaymentMethodDataAnyOf2X9d951d0d:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1SetupIntentsPostRequestFormPaymentMethodDataAnyOf2X9d951d0d) {
                json
                    .decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodDataAnyOf2X9d951d0d>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1SetupIntentsPostRequestFormPaymentMethodDataBillingDetailsNameX69a3849aBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1SetupIntentsPostRequestFormPaymentMethodDataAnyOf2X9d951d0d) {
                    add(
                        InlineV1SetupIntentsPostRequestFormPaymentMethodDataBillingDetailsNameX69a3849aBranch.InlineV1SetupIntentsPostRequestFormPaymentMethodDataAnyOf2X9d951d0d,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1SetupIntentsPostRequestFormPaymentMethodDataBillingDetailsNameX69a3849a {
            val inspection = inspectInlineV1SetupIntentsPostRequestFormPaymentMethodDataBillingDetailsNameX69a3849a(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1SetupIntentsPostRequestFormPaymentMethodDataBillingDetailsNameX69a3849aNoMatchException(
                    "InlineV1SetupIntentsPostRequestFormPaymentMethodDataBillingDetailsNameX69a3849a matched 0 branches: " +
                        inspection.failures.joinToString("; "),
                )
            }
            return InlineV1SetupIntentsPostRequestFormPaymentMethodDataBillingDetailsNameX69a3849a(
                raw,
                json,
                inspection,
            )
    ...
    public object Serializer : KSerializer<InlineV1SetupIntentsPostRequestFormPaymentMethodDataBillingDetailsNameX69a3849a> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SetupIntentsPostRequestFormPaymentMethodDataBillingDetailsNameX69a3849a,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1SetupIntentsPostRequestFormPaymentMethodDataBillingDetailsNameX69a3849a",
...
private fun inspectInlineV1SetupIntentsPostRequestFormPaymentMethodDataBillingDetailsNameX69a3849a(
    element: JsonElement,
): InlineV1SetupIntentsPostRequestFormPaymentMethodDataBillingDetailsNameX69a3849aInspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1SetupIntentsPostRequestFormPaymentMethodDataAnyOf2X9d951d0d =
        element
            .isJsonDecodable<InlineV1SetupIntentsPostRequestFormPaymentMethodDataAnyOf2X9d951d0d>()
    return InlineV1SetupIntentsPostRequestFormPaymentMethodDataBillingDetailsNameX69a3849aInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1SetupIntentsPostRequestFormPaymentMethodDataAnyOf2X9d951d0d) {
                    add(
                        "InlineV1SetupIntentsPostRequestFormPaymentMethodDataAnyOf2X9d951d0d: value does not match InlineV1SetupIntentsPostRequestFormPaymentMethodDataAnyOf2X9d951d0d",
                    )
                }
            },
    )
