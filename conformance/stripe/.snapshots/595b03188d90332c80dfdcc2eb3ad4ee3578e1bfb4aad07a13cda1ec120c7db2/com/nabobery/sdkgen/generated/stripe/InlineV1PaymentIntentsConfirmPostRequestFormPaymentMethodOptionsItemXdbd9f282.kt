...
public class InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsItemXdbd9f282(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsItemXdbd9f282 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsItemXdbd9f282> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsItemXdbd9f282 must be a JSON object",
                    )
            val interval =
                json.decodeRequired<InlineV1PaymentIntentsConfirmPostRequestFormIntervalX3cd35787>(
                    rawObject,
                    "interval",
                )
            ...
            return InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsItemXdbd9f282(
                ...
                nextBilling =
                    rawObject["next_billing"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormNextBillingX1f27d7ec>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsItemXdbd9f282,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsItemXdbd9f282(
    block: InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsItemXdbd9f282.Builder.() -> Unit,
): InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsItemXdbd9f282 =
    InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsItemXdbd9f282.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsItemXdbd9f282 is missing required property '" +
                    name +
                    "'",
            )
