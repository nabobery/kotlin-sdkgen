...
public class PortalCustomerUpdate(
    ...
    public class Builder {
        ...
        public var allowedUpdates: List<InlinePortalCustomerUpdateAllowedUpdatesItemXc0dd315a>
            get() = requireNotNull(allowedUpdatesValue) { "allowedUpdates is required" }
            set(`value`) {
                allowedUpdatesValue = value
            }
    ...
    public object Serializer : KSerializer<PortalCustomerUpdate> {
        ...
        override fun deserialize(decoder: Decoder): PortalCustomerUpdate {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PortalCustomerUpdate must be a JSON object")
            val allowedUpdates =
                json.decodeRequired<List<InlinePortalCustomerUpdateAllowedUpdatesItemXc0dd315a>>(
                    rawObject,
                    "allowed_updates",
                )
...
public fun portalCustomerUpdate(block: PortalCustomerUpdate.Builder.() -> Unit): PortalCustomerUpdate =
    PortalCustomerUpdate.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("PortalCustomerUpdate is missing required property '" + name + "'")
