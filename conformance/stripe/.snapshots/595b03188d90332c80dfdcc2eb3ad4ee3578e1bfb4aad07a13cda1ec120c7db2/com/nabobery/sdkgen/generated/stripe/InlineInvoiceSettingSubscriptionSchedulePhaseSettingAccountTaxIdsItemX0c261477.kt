...
public class InlineInvoiceSettingSubscriptionSchedulePhaseSettingAccountTaxIdsItemX0c261477 internal constructor(
    ...
    private val inspection: InlineInvoiceSettingSubscriptionSchedulePhaseSettingAccountTaxIdsItemX0c261477Inspection,
) {
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineInvoiceSettingSubscriptionSchedulePhaseSettingAccountTaxIdsItemX0c261477Branch.Branch1,
                    )
                }
                if (inspection.matchesTaxId) {
                    add(
                        InlineInvoiceSettingSubscriptionSchedulePhaseSettingAccountTaxIdsItemX0c261477Branch.TaxId,
                    )
                }
                if (inspection.matchesDeletedTaxId) {
                    add(
                        InlineInvoiceSettingSubscriptionSchedulePhaseSettingAccountTaxIdsItemX0c261477Branch.DeletedTaxId,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineInvoiceSettingSubscriptionSchedulePhaseSettingAccountTaxIdsItemX0c261477 {
            val inspection = inspectInlineInvoiceSettingSubscriptionSchedulePhaseSettingAccountTaxIdsItemX0c261477(raw)
            if (inspection.matchCount == 0) {
                throw InlineInvoiceSettingSubscriptionSchedulePhaseSettingAccountTaxIdsItemX0c261477NoMatchException(
                    "InlineInvoiceSettingSubscriptionSchedulePhaseSettingAccountTaxIdsItemX0c261477 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineInvoiceSettingSubscriptionSchedulePhaseSettingAccountTaxIdsItemX0c261477> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineInvoiceSettingSubscriptionSchedulePhaseSettingAccountTaxIdsItemX0c261477,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineInvoiceSettingSubscriptionSchedulePhaseSettingAccountTaxIdsItemX0c261477",
...
private fun inspectInlineInvoiceSettingSubscriptionSchedulePhaseSettingAccountTaxIdsItemX0c261477(
    element: JsonElement,
