...
public class InlineV1TestHelpersIssuingAuthorizationsPostRequestFormFleetXd434de5e(
    ...
    public val purchaseType: InlineV1TestHelpersIssuing214aPostRequestFormFleetPurchaseTypeX29a03281? = null,
    public val reportedBreakdown: InlineV1TestHelpersIssuing214aPostRequestFormFleetReportedBreakdownXac5f1cb8? = null,
    public val serviceType: InlineV1TestHelpersIssuingAuthorizationsPostRequestFormFleetServiceTypeXd02bd97f? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1TestHelpersIssuingAuthorizationsPostRequestFormFleetXd434de5e =
            InlineV1TestHelpersIssuingAuthorizationsPostRequestFormFleetXd434de5e(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1TestHelpersIssuingAuthorizationsPostRequestFormFleetXd434de5e = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1TestHelpersIssuingAuthorizationsPostRequestFormFleetXd434de5e> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TestHelpersIssuingAuthorizationsPostRequestFormFleetXd434de5e must be a JSON object",
                    )
            return InlineV1TestHelpersIssuingAuthorizationsPostRequestFormFleetXd434de5e(
                cardholderPromptData =
                    rawObject["cardholder_prompt_data"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TestHelpersIssuing214aPostRequestFormFleetCardholderPromptDataXa3badd42>(
                                it,
                            )
                    },
                purchaseType =
                    rawObject["purchase_type"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TestHelpersIssuing214aPostRequestFormFleetPurchaseTypeX29a03281>(
                                it,
                            )
                    },
                reportedBreakdown =
                    rawObject["reported_breakdown"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TestHelpersIssuing214aPostRequestFormFleetReportedBreakdownXac5f1cb8>(
                                it,
                            )
                    },
                serviceType =
                    rawObject["service_type"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TestHelpersIssuingAuthorizationsPostRequestFormFleetServiceTypeXd02bd97f>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TestHelpersIssuingAuthorizationsPostRequestFormFleetXd434de5e,
        ) {
            val jsonEncoder =
...
public fun inlineV1TestHelpersIssuingAuthorizationsPostRequestFormFleetXd434de5e(
    block: InlineV1TestHelpersIssuingAuthorizationsPostRequestFormFleetXd434de5e.Builder.() -> Unit,
): InlineV1TestHelpersIssuingAuthorizationsPostRequestFormFleetXd434de5e =
    InlineV1TestHelpersIssuingAuthorizationsPostRequestFormFleetXd434de5e.build(block)
