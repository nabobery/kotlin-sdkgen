...
public class CountrySpecVerificationFields(
    ...
    public object Serializer : KSerializer<CountrySpecVerificationFields> {
        ...
        override fun deserialize(decoder: Decoder): CountrySpecVerificationFields {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("CountrySpecVerificationFields must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: CountrySpecVerificationFields,
        ) {
...
public fun countrySpecVerificationFields(
    block: CountrySpecVerificationFields.Builder.() -> Unit,
): CountrySpecVerificationFields = CountrySpecVerificationFields.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException("CountrySpecVerificationFields is missing required property '" + name + "'")
