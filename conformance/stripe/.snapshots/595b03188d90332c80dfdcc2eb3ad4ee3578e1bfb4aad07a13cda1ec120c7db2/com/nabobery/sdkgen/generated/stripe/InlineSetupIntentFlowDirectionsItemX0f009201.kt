...
public sealed class InlineSetupIntentFlowDirectionsItemX0f009201 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineSetupIntentFlowDirectionsItemX0f009201 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineSetupIntentFlowDirectionsItemX0f009201> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineSetupIntentFlowDirectionsItemX0f009201",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineSetupIntentFlowDirectionsItemX0f009201 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineSetupIntentFlowDirectionsItemX0f009201,
        ) {
