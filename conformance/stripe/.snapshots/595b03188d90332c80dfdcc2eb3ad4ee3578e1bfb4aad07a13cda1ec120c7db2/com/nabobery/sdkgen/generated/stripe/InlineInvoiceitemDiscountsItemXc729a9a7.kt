...
public class InlineInvoiceitemDiscountsItemXc729a9a7 internal constructor(
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineInvoiceitemDiscountsItemXc729a9a7 {
            val inspection = inspectInlineInvoiceitemDiscountsItemXc729a9a7(raw)
            if (inspection.matchCount == 0) {
                throw InlineInvoiceitemDiscountsItemXc729a9a7NoMatchException(
                    "InlineInvoiceitemDiscountsItemXc729a9a7 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineInvoiceitemDiscountsItemXc729a9a7> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineInvoiceitemDiscountsItemXc729a9a7,
        ) {
...
private fun inspectInlineInvoiceitemDiscountsItemXc729a9a7(
    element: JsonElement,
): InlineInvoiceitemDiscountsItemXc729a9a7Inspection {
