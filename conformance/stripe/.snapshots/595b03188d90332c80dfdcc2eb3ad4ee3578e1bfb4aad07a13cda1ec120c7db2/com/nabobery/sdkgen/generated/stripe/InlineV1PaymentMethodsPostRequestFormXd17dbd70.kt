...
public class InlineV1PaymentMethodsPostRequestFormXd17dbd70(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1PaymentMethodsPostRequestFormXd17dbd70 =
            InlineV1PaymentMethodsPostRequestFormXd17dbd70(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PaymentMethodsPostRequestFormXd17dbd70 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentMethodsPostRequestFormXd17dbd70> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentMethodsPostRequestFormXd17dbd70 must be a JSON object",
                    )
            return InlineV1PaymentMethodsPostRequestFormXd17dbd70(
                allowRedisplay =
                    rawObject["allow_redisplay"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentMethodsPostRequestFormAllowRedisplayX8bf925cf>(it)
                    },
                billingDetails =
                    rawObject["billing_details"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentMethodsPostRequestFormBillingDetailsXc7835d4d>(it)
                    },
                card =
                    rawObject["card"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentMethodsPostRequestFormCardX090df98d>(
                            it,
                        )
                    },
                ...
                metadata =
                    rawObject["metadata"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentMethodsPostRequestFormMetadataXf5766fae>(it)
                    },
                payto =
                    rawObject["payto"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentMethodsPostRequestFormPaytoX0e33255b>(
                                it,
                            )
                    },
                usBankAccount =
                    rawObject["us_bank_account"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentMethodsPostRequestFormUsBankAccountX4cb94015>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentMethodsPostRequestFormXd17dbd70,
        ) {
...
public fun inlineV1PaymentMethodsPostRequestFormXd17dbd70(
    block: InlineV1PaymentMethodsPostRequestFormXd17dbd70.Builder.() -> Unit,
): InlineV1PaymentMethodsPostRequestFormXd17dbd70 = InlineV1PaymentMethodsPostRequestFormXd17dbd70.build(block)
