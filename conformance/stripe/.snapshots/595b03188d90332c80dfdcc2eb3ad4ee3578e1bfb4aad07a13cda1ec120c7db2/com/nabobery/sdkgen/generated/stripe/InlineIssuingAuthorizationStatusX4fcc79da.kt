...
public sealed class InlineIssuingAuthorizationStatusX4fcc79da {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineIssuingAuthorizationStatusX4fcc79da =
            when (value) {
                Closed.value -> Closed
    ...
    public object Serializer : KSerializer<InlineIssuingAuthorizationStatusX4fcc79da> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineIssuingAuthorizationStatusX4fcc79da",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineIssuingAuthorizationStatusX4fcc79da =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineIssuingAuthorizationStatusX4fcc79da,
        ) {
