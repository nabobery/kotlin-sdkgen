...
public class InlineV1SetupIntentsVerifyMicrodepositsPostRequestFormX01f1f47d(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1SetupIntentsVerifyMicrodepositsPostRequestFormX01f1f47d =
            InlineV1SetupIntentsVerifyMicrodepositsPostRequestFormX01f1f47d(
                amounts = amounts,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1SetupIntentsVerifyMicrodepositsPostRequestFormX01f1f47d =
    ...
    public object Serializer : KSerializer<InlineV1SetupIntentsVerifyMicrodepositsPostRequestFormX01f1f47d> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SetupIntentsVerifyMicrodepositsPostRequestFormX01f1f47d must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SetupIntentsVerifyMicrodepositsPostRequestFormX01f1f47d,
        ) {
            val jsonEncoder =
...
public fun inlineV1SetupIntentsVerifyMicrodepositsPostRequestFormX01f1f47d(
    block: InlineV1SetupIntentsVerifyMicrodepositsPostRequestFormX01f1f47d.Builder.() -> Unit,
): InlineV1SetupIntentsVerifyMicrodepositsPostRequestFormX01f1f47d =
    InlineV1SetupIntentsVerifyMicrodepositsPostRequestFormX01f1f47d.build(block)
