...
public class TreasuryFinancialAccountsResourceInboundAchToggleSettings(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): TreasuryFinancialAccountsResourceInboundAchToggleSettings =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<TreasuryFinancialAccountsResourceInboundAchToggleSettings> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "TreasuryFinancialAccountsResourceInboundAchToggleSettings must be a JSON object",
                    )
            val requested = json.decodeRequired<Boolean>(rawObject, "requested")
            val status =
                json.decodeRequired<InlineTreasuryFinancialAccountsResourceInboundAchToggleSettingsStatusX3d8f8ab2>(
                    rawObject,
                    "status",
                )
            val statusDetails =
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: TreasuryFinancialAccountsResourceInboundAchToggleSettings,
        ) {
...
public fun treasuryFinancialAccountsResourceInboundAchToggleSettings(
    block: TreasuryFinancialAccountsResourceInboundAchToggleSettings.Builder.() -> Unit,
): TreasuryFinancialAccountsResourceInboundAchToggleSettings =
    TreasuryFinancialAccountsResourceInboundAchToggleSettings.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "TreasuryFinancialAccountsResourceInboundAchToggleSettings is missing required property '" + name + "'",
            )
