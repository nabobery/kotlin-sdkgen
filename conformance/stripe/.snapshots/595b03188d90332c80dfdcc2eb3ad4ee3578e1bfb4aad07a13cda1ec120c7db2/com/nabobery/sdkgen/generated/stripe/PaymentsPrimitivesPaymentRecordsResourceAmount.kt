...
public class PaymentsPrimitivesPaymentRecordsResourceAmount(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentsPrimitivesPaymentRecordsResourceAmount =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentsPrimitivesPaymentRecordsResourceAmount> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "PaymentsPrimitivesPaymentRecordsResourceAmount must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentsPrimitivesPaymentRecordsResourceAmount,
        ) {
...
public fun paymentsPrimitivesPaymentRecordsResourceAmount(
    block: PaymentsPrimitivesPaymentRecordsResourceAmount.Builder.() -> Unit,
): PaymentsPrimitivesPaymentRecordsResourceAmount = PaymentsPrimitivesPaymentRecordsResourceAmount.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "PaymentsPrimitivesPaymentRecordsResourceAmount is missing required property '" + name + "'",
            )
