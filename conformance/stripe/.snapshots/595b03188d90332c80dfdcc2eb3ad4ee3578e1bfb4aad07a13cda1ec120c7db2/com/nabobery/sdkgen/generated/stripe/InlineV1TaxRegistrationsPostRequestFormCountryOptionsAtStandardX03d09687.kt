...
public class InlineV1TaxRegistrationsPostRequestFormCountryOptionsAtStandardX03d09687(
    public val placeOfSupplyScheme: InlineV1TaxRegistrationsPostRequestFormPlaceOfSupplySchemeXa4f1ea0b,
) {
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1TaxRegistrationsPostRequestFormCountryOptionsAtStandardX03d09687 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1TaxRegistrationsPostRequestFormCountryOptionsAtStandardX03d09687> {
        ...
        override fun deserialize(
            decoder: Decoder,
        ): InlineV1TaxRegistrationsPostRequestFormCountryOptionsAtStandardX03d09687 {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TaxRegistrationsPostRequestFormCountryOptionsAtStandardX03d09687 must be a JSON object",
                    )
            val placeOfSupplyScheme =
                json
                    .decodeRequired<InlineV1TaxRegistrationsPostRequestFormPlaceOfSupplySchemeXa4f1ea0b>(
                        rawObject,
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TaxRegistrationsPostRequestFormCountryOptionsAtStandardX03d09687,
        ) {
            val jsonEncoder =
...
public fun inlineV1TaxRegistrationsPostRequestFormCountryOptionsAtStandardX03d09687(
    block: InlineV1TaxRegistrationsPostRequestFormCountryOptionsAtStandardX03d09687.Builder.() -> Unit,
): InlineV1TaxRegistrationsPostRequestFormCountryOptionsAtStandardX03d09687 =
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TaxRegistrationsPostRequestFormCountryOptionsAtStandardX03d09687 is missing required property '" +
                    name +
                    "'",
            )
