...
public sealed class InlineV1PaymentLinksPostRequestFormBillingAddressCollectionX7432c0af {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1PaymentLinksPostRequestFormBillingAddressCollectionX7432c0af =
            when (value) {
                Auto.value -> Auto
    ...
    public object Serializer : KSerializer<InlineV1PaymentLinksPostRequestFormBillingAddressCollectionX7432c0af> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1PaymentLinksPostRequestFormBillingAddressCollectionX7432c0af",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1PaymentLinksPostRequestFormBillingAddressCollectionX7432c0af = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentLinksPostRequestFormBillingAddressCollectionX7432c0af,
        ) {
