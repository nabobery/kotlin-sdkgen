...
public class InlineV1InvoicesLinesPostRequestFormXeff471a0(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1InvoicesLinesPostRequestFormXeff471a0 =
            InlineV1InvoicesLinesPostRequestFormXeff471a0(
                amount = amount,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1InvoicesLinesPostRequestFormXeff471a0 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1InvoicesLinesPostRequestFormXeff471a0> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1InvoicesLinesPostRequestFormXeff471a0 must be a JSON object",
                    )
            return InlineV1InvoicesLinesPostRequestFormXeff471a0(
                ...
                discounts =
                    rawObject["discounts"]?.let {
                        json.decodeFromJsonElement<InlineV1InvoicesLinesPostRequestFormDiscountsXc325813e>(it)
                    },
                expand = rawObject["expand"]?.let { json.decodeFromJsonElement<List<String>>(it) },
                metadata =
                    rawObject["metadata"]?.let {
                        json.decodeFromJsonElement<InlineV1InvoicesLinesPostRequestFormMetadataXe52ff15d>(it)
                    },
                period =
                    rawObject["period"]?.let {
                        json.decodeFromJsonElement<InlineV1InvoicesLinesPostRequestFormPeriodXad9d6069>(it)
                    },
                priceData =
                    rawObject["price_data"]?.let {
                        json.decodeFromJsonElement<InlineV1InvoicesLinesPostRequestFormPriceDataX155e7265>(it)
                    },
                pricing =
                    rawObject["pricing"]?.let {
                        json.decodeFromJsonElement<InlineV1InvoicesLinesPostRequestFormPricingXf532832b>(it)
                    },
                ...
                taxAmounts =
                    rawObject["tax_amounts"]?.let {
                        json.decodeFromJsonElement<InlineV1InvoicesLinesPostRequestFormTaxAmountsX248c846d>(it)
                    },
                taxRates =
                    rawObject["tax_rates"]?.let {
                        json.decodeFromJsonElement<InlineV1InvoicesLinesPostRequestFormTaxRatesX07874146>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesLinesPostRequestFormXeff471a0,
        ) {
...
public fun inlineV1InvoicesLinesPostRequestFormXeff471a0(
    block: InlineV1InvoicesLinesPostRequestFormXeff471a0.Builder.() -> Unit,
): InlineV1InvoicesLinesPostRequestFormXeff471a0 = InlineV1InvoicesLinesPostRequestFormXeff471a0.build(block)
