...
public class InlineV1IssuingDisputesPostRequestFormTreasuryX0bce0b29(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1IssuingDisputesPostRequestFormTreasuryX0bce0b29 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1IssuingDisputesPostRequestFormTreasuryX0bce0b29> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1IssuingDisputesPostRequestFormTreasuryX0bce0b29 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingDisputesPostRequestFormTreasuryX0bce0b29,
        ) {
...
public fun inlineV1IssuingDisputesPostRequestFormTreasuryX0bce0b29(
    block: InlineV1IssuingDisputesPostRequestFormTreasuryX0bce0b29.Builder.() -> Unit,
): InlineV1IssuingDisputesPostRequestFormTreasuryX0bce0b29 =
    InlineV1IssuingDisputesPostRequestFormTreasuryX0bce0b29.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1IssuingDisputesPostRequestFormTreasuryX0bce0b29 is missing required property '" + name + "'",
            )
