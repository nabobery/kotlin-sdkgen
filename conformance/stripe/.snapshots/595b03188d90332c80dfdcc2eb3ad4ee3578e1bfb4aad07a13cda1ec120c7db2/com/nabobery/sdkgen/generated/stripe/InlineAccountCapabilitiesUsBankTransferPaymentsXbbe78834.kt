...
public sealed class InlineAccountCapabilitiesUsBankTransferPaymentsXbbe78834 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineAccountCapabilitiesUsBankTransferPaymentsXbbe78834 =
            when (value) {
                Active.value -> Active
    ...
    public object Serializer : KSerializer<InlineAccountCapabilitiesUsBankTransferPaymentsXbbe78834> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineAccountCapabilitiesUsBankTransferPaymentsXbbe78834",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineAccountCapabilitiesUsBankTransferPaymentsXbbe78834 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineAccountCapabilitiesUsBankTransferPaymentsXbbe78834,
        ) {
