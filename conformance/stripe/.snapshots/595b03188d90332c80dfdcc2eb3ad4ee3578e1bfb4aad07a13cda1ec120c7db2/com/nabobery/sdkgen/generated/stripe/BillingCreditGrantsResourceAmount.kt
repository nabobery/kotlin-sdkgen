...
public class BillingCreditGrantsResourceAmount(
    ...
    public object Serializer : KSerializer<BillingCreditGrantsResourceAmount> {
        ...
        override fun deserialize(decoder: Decoder): BillingCreditGrantsResourceAmount {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("BillingCreditGrantsResourceAmount must be a JSON object")
            val type = json.decodeRequired<InlineBillingCreditGrantsResourceAmountTypeX1624a5a5>(rawObject, "type")
            return BillingCreditGrantsResourceAmount(
                type = type,
                monetary =
                    rawObject["monetary"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineBillingCreditGrantsResourceAmountMonetaryXfbaca205?>(
                                element,
                            )
                        }
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: BillingCreditGrantsResourceAmount,
        ) {
...
public fun billingCreditGrantsResourceAmount(
    block: BillingCreditGrantsResourceAmount.Builder.() -> Unit,
): BillingCreditGrantsResourceAmount = BillingCreditGrantsResourceAmount.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "BillingCreditGrantsResourceAmount is missing required property '" + name + "'",
            )
