...
public sealed class InlineIssuingCardStatusXfe6e0a8e {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineIssuingCardStatusXfe6e0a8e =
            when (value) {
                Active.value -> Active
    ...
    public object Serializer : KSerializer<InlineIssuingCardStatusXfe6e0a8e> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineIssuingCardStatusXfe6e0a8e",
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineIssuingCardStatusXfe6e0a8e,
        ) {
