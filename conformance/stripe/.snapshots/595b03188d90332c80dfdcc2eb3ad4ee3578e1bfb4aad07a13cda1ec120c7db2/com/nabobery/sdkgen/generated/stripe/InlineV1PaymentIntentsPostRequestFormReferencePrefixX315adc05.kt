...
internal data class InlineV1PaymentIntentsPostRequestFormReferencePrefixX315adc05Inspection(
    ...
    public val matchesInlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAnyOf2X3437cc8a: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAnyOf2X3437cc8a,
            ).count {
                it
            }
}
...
public class InlineV1PaymentIntentsPostRequestFormReferencePrefixX315adc05 internal constructor(
    ...
    public val inlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAnyOf2X3437cc8a:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAnyOf2X3437cc8a) {
                json
                    .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAnyOf2X3437cc8a>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1PaymentIntentsPostRequestFormReferencePrefixX315adc05Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAnyOf2X3437cc8a) {
                    add(
                        InlineV1PaymentIntentsPostRequestFormReferencePrefixX315adc05Branch.InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAnyOf2X3437cc8a,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1PaymentIntentsPostRequestFormReferencePrefixX315adc05 {
            val inspection = inspectInlineV1PaymentIntentsPostRequestFormReferencePrefixX315adc05(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1PaymentIntentsPostRequestFormReferencePrefixX315adc05NoMatchException(
                    "InlineV1PaymentIntentsPostRequestFormReferencePrefixX315adc05 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormReferencePrefixX315adc05> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormReferencePrefixX315adc05,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1PaymentIntentsPostRequestFormReferencePrefixX315adc05",
...
private fun inspectInlineV1PaymentIntentsPostRequestFormReferencePrefixX315adc05(
    element: JsonElement,
): InlineV1PaymentIntentsPostRequestFormReferencePrefixX315adc05Inspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAnyOf2X3437cc8a =
        element
            .isJsonDecodable<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAnyOf2X3437cc8a>()
    return InlineV1PaymentIntentsPostRequestFormReferencePrefixX315adc05Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAnyOf2X3437cc8a) {
                    add(
                        "InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAnyOf2X3437cc8a: value does not match InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAnyOf2X3437cc8a",
                    )
                }
            },
    )
