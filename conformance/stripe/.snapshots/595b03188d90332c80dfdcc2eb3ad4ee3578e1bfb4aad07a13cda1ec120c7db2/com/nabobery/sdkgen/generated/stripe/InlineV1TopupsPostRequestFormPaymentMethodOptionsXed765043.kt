...
public class InlineV1TopupsPostRequestFormPaymentMethodOptionsXed765043(
    public val usBankAccount: InlineV1TopupsPostRequestFormPaymentMethodOptionsUsBankAccountX1fb92c06? = null,
) {
    public class Builder {
        public var usBankAccount:
            InlineV1TopupsPostRequestFormPaymentMethodOptionsUsBankAccountX1fb92c06? = null

        public fun build(): InlineV1TopupsPostRequestFormPaymentMethodOptionsXed765043 =
            InlineV1TopupsPostRequestFormPaymentMethodOptionsXed765043(
                usBankAccount = usBankAccount,
            )
    }

    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TopupsPostRequestFormPaymentMethodOptionsXed765043 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TopupsPostRequestFormPaymentMethodOptionsXed765043> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TopupsPostRequestFormPaymentMethodOptionsXed765043 must be a JSON object",
                    )
            return InlineV1TopupsPostRequestFormPaymentMethodOptionsXed765043(
                usBankAccount =
                    rawObject["us_bank_account"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TopupsPostRequestFormPaymentMethodOptionsUsBankAccountX1fb92c06>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TopupsPostRequestFormPaymentMethodOptionsXed765043,
        ) {
...
public fun inlineV1TopupsPostRequestFormPaymentMethodOptionsXed765043(
    block: InlineV1TopupsPostRequestFormPaymentMethodOptionsXed765043.Builder.() -> Unit,
): InlineV1TopupsPostRequestFormPaymentMethodOptionsXed765043 =
    InlineV1TopupsPostRequestFormPaymentMethodOptionsXed765043.build(block)
