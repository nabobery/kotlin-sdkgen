...
public class InlineV1InvoiceitemsPostRequestFormPeriodXcae985a7(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1InvoiceitemsPostRequestFormPeriodXcae985a7 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1InvoiceitemsPostRequestFormPeriodXcae985a7> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1InvoiceitemsPostRequestFormPeriodXcae985a7 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoiceitemsPostRequestFormPeriodXcae985a7,
        ) {
...
public fun inlineV1InvoiceitemsPostRequestFormPeriodXcae985a7(
    block: InlineV1InvoiceitemsPostRequestFormPeriodXcae985a7.Builder.() -> Unit,
): InlineV1InvoiceitemsPostRequestFormPeriodXcae985a7 = InlineV1InvoiceitemsPostRequestFormPeriodXcae985a7.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1InvoiceitemsPostRequestFormPeriodXcae985a7 is missing required property '" + name + "'",
            )
