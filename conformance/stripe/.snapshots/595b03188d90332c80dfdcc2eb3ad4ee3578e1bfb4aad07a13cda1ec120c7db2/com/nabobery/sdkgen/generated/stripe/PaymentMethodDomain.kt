        ...
        override fun deserialize(decoder: Decoder): PaymentMethodDomain {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodDomain must be a JSON object")
...
public fun paymentMethodDomain(block: PaymentMethodDomain.Builder.() -> Unit): PaymentMethodDomain =
    PaymentMethodDomain.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("PaymentMethodDomain is missing required property '" + name + "'")
