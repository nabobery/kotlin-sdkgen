...
public class TerminalReaderReaderResourcePhone(
    ...
    public class Builder {
        ...
        public fun build(): TerminalReaderReaderResourcePhone =
    ...
    public object Serializer : KSerializer<TerminalReaderReaderResourcePhone> {
        ...
        override fun deserialize(decoder: Decoder): TerminalReaderReaderResourcePhone {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("TerminalReaderReaderResourcePhone must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: TerminalReaderReaderResourcePhone,
        ) {
...
public fun terminalReaderReaderResourcePhone(
    block: TerminalReaderReaderResourcePhone.Builder.() -> Unit,
): TerminalReaderReaderResourcePhone = TerminalReaderReaderResourcePhone.build(block)
