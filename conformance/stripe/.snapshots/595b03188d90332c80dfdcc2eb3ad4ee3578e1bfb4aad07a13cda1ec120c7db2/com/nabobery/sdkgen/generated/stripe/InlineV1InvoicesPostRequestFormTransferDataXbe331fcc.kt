...
internal data class InlineV1InvoicesPostRequestFormTransferDataXbe331fccInspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesInlineV1InvoicesPostRequestFormTransferDataAnyOf1X605738cf,
                matchesInlineV1InvoicesPostRequestFormTransferDataAnyOf2X1dc9323f,
            ).count {
                it
            }
}
...
public class InlineV1InvoicesPostRequestFormTransferDataXbe331fcc internal constructor(
    ...
    public val inlineV1InvoicesPostRequestFormTransferDataAnyOf1X605738cf:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1InvoicesPostRequestFormTransferDataAnyOf1X605738cf) {
                json
                    .decodeFromJsonElement<InlineV1InvoicesPostRequestFormTransferDataAnyOf1X605738cf>(
                        raw,
                    )
            } else {
                null
    ...
    public val inlineV1InvoicesPostRequestFormTransferDataAnyOf2X1dc9323f:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1InvoicesPostRequestFormTransferDataAnyOf2X1dc9323f) {
                json
                    .decodeFromJsonElement<InlineV1InvoicesPostRequestFormTransferDataAnyOf2X1dc9323f>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1InvoicesPostRequestFormTransferDataXbe331fccBranch>
        get() =
            buildSet {
                if (inspection.matchesInlineV1InvoicesPostRequestFormTransferDataAnyOf1X605738cf) {
                    add(
                        InlineV1InvoicesPostRequestFormTransferDataXbe331fccBranch.InlineV1InvoicesPostRequestFormTransferDataAnyOf1X605738cf,
                    )
                }
                if (inspection.matchesInlineV1InvoicesPostRequestFormTransferDataAnyOf2X1dc9323f) {
                    add(
                        InlineV1InvoicesPostRequestFormTransferDataXbe331fccBranch.InlineV1InvoicesPostRequestFormTransferDataAnyOf2X1dc9323f,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1InvoicesPostRequestFormTransferDataXbe331fcc {
            val inspection = inspectInlineV1InvoicesPostRequestFormTransferDataXbe331fcc(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1InvoicesPostRequestFormTransferDataXbe331fccNoMatchException(
                    "InlineV1InvoicesPostRequestFormTransferDataXbe331fcc matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1InvoicesPostRequestFormTransferDataXbe331fcc> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesPostRequestFormTransferDataXbe331fcc,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1InvoicesPostRequestFormTransferDataXbe331fcc",
...
private fun inspectInlineV1InvoicesPostRequestFormTransferDataXbe331fcc(
    element: JsonElement,
): InlineV1InvoicesPostRequestFormTransferDataXbe331fccInspection {
    val matchesInlineV1InvoicesPostRequestFormTransferDataAnyOf1X605738cf =
        element
            .isJsonDecodable<InlineV1InvoicesPostRequestFormTransferDataAnyOf1X605738cf>()
    val matchesInlineV1InvoicesPostRequestFormTransferDataAnyOf2X1dc9323f =
        element
            .isJsonDecodable<InlineV1InvoicesPostRequestFormTransferDataAnyOf2X1dc9323f>()
    return InlineV1InvoicesPostRequestFormTransferDataXbe331fccInspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1InvoicesPostRequestFormTransferDataAnyOf1X605738cf) {
                    add(
                        "InlineV1InvoicesPostRequestFormTransferDataAnyOf1X605738cf: value does not match InlineV1InvoicesPostRequestFormTransferDataAnyOf1X605738cf",
                    )
                }
                if (!matchesInlineV1InvoicesPostRequestFormTransferDataAnyOf2X1dc9323f) {
                    add(
                        "InlineV1InvoicesPostRequestFormTransferDataAnyOf2X1dc9323f: value does not match InlineV1InvoicesPostRequestFormTransferDataAnyOf2X1dc9323f",
                    )
                }
            },
    )
