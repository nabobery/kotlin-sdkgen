...
public sealed class InlinePaymentFlowsAmountDetailsResourceErrorCodeXaf7724eb {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentFlowsAmountDetailsResourceErrorCodeXaf7724eb =
            when (value) {
    ...
    public object Serializer : KSerializer<InlinePaymentFlowsAmountDetailsResourceErrorCodeXaf7724eb> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentFlowsAmountDetailsResourceErrorCodeXaf7724eb",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePaymentFlowsAmountDetailsResourceErrorCodeXaf7724eb =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentFlowsAmountDetailsResourceErrorCodeXaf7724eb,
        ) {
