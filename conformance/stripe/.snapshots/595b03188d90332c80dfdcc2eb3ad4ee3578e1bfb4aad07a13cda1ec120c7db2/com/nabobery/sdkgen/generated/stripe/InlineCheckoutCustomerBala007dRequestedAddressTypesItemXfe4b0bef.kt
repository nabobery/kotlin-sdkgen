...
public sealed class InlineCheckoutCustomerBala007dRequestedAddressTypesItemXfe4b0bef {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineCheckoutCustomerBala007dRequestedAddressTypesItemXfe4b0bef =
            when (value) {
                Aba.value -> Aba
                Iban.value -> Iban
                Sepa.value -> Sepa
    ...
    public object Serializer : KSerializer<InlineCheckoutCustomerBala007dRequestedAddressTypesItemXfe4b0bef> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineCheckoutCustomerBala007dRequestedAddressTypesItemXfe4b0bef",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineCheckoutCustomerBala007dRequestedAddressTypesItemXfe4b0bef =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineCheckoutCustomerBala007dRequestedAddressTypesItemXfe4b0bef,
        ) {
