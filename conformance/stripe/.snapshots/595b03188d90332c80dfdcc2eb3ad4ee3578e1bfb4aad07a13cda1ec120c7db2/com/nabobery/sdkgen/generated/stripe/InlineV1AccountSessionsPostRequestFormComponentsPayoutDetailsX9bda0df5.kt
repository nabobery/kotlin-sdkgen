...
public class InlineV1AccountSessionsPostRequestFormComponentsPayoutDetailsX9bda0df5(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1AccountSessionsPostRequestFormComponentsPayoutDetailsX9bda0df5 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1AccountSessionsPostRequestFormComponentsPayoutDetailsX9bda0df5> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountSessionsPostRequestFormComponentsPayoutDetailsX9bda0df5 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountSessionsPostRequestFormComponentsPayoutDetailsX9bda0df5,
        ) {
            val jsonEncoder =
...
public fun inlineV1AccountSessionsPostRequestFormComponentsPayoutDetailsX9bda0df5(
    block: InlineV1AccountSessionsPostRequestFormComponentsPayoutDetailsX9bda0df5.Builder.() -> Unit,
): InlineV1AccountSessionsPostRequestFormComponentsPayoutDetailsX9bda0df5 =
    InlineV1AccountSessionsPostRequestFormComponentsPayoutDetailsX9bda0df5.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1AccountSessionsPostRequestFormComponentsPayoutDetailsX9bda0df5 is missing required property '" +
                    name +
                    "'",
            )
