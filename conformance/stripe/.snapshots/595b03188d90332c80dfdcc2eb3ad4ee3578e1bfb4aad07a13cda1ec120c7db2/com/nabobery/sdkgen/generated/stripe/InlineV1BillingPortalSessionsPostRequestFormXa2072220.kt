...
public class InlineV1BillingPortalSessionsPostRequestFormXa2072220(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1BillingPortalSessionsPostRequestFormXa2072220 =
            InlineV1BillingPortalSessionsPostRequestFormXa2072220(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1BillingPortalSessionsPostRequestFormXa2072220 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1BillingPortalSessionsPostRequestFormXa2072220> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1BillingPortalSessionsPostRequestFormXa2072220 {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1BillingPortalSessionsPostRequestFormXa2072220 must be a JSON object",
                    )
            return InlineV1BillingPortalSessionsPostRequestFormXa2072220(
                ...
                flowData =
                    rawObject["flow_data"]?.let {
                        json.decodeFromJsonElement<InlineV1BillingPortalSessionsPostRequestFormFlowDataX3ab0e83c>(it)
                    },
                locale =
                    rawObject["locale"]?.let {
                        json.decodeFromJsonElement<InlineV1BillingPortalSessionsPostRequestFormLocaleX6afe2d84>(it)
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1BillingPortalSessionsPostRequestFormXa2072220,
        ) {
...
public fun inlineV1BillingPortalSessionsPostRequestFormXa2072220(
    block: InlineV1BillingPortalSessionsPostRequestFormXa2072220.Builder.() -> Unit,
): InlineV1BillingPortalSessionsPostRequestFormXa2072220 =
    InlineV1BillingPortalSessionsPostRequestFormXa2072220.build(block)
