...
public class InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsCardX201c881c(
    ...
    public val installments: InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsInstallmentsXad30400b? = null,
    ...
    public val requestMulticapture: InlineV1CheckoutSessionsPostRequestFormRequestMulticaptureX2d3a3394? = null,
    public val requestOvercapture: InlineV1CheckoutSessionsPostRequestFormRequestOvercaptureX5c3be25e? = null,
    public val requestThreeDSecure: InlineV1CheckoutSessionsPostRequestFormRequestThreeDSecureX87c29717? = null,
    public val restrictions: InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsRestrictionsXa728c548? = null,
    public val setupFutureUsage: InlineV1CheckoutSessionsPostRequestFormSetupFutureUsageX395df094? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsCardX201c881c =
            InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsCardX201c881c(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsCardX201c881c = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsCardX201c881c> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsCardX201c881c must be a JSON object",
                    )
            return InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsCardX201c881c(
                captureMethod =
                    rawObject["capture_method"]?.let {
                        json.decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormCaptureMethodX5cd560d0>(it)
                    },
                installments =
                    rawObject["installments"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsInstallmentsXad30400b>(
                                it,
                            )
                    },
                requestExtendedAuthorization =
                    rawObject["request_extended_authorization"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormRequestExtendedAutho403fXaf19650f>(
                                it,
                            )
                    },
                requestIncrementalAuthorization =
                    rawObject["request_incremental_authorization"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormRequestIncrementalAu57cdX55c99bef>(
                                it,
                            )
                    },
                requestMulticapture =
                    rawObject["request_multicapture"]?.let {
                        json.decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormRequestMulticaptureX2d3a3394>(
                            it,
                        )
                    },
                requestOvercapture =
                    rawObject["request_overcapture"]?.let {
                        json.decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormRequestOvercaptureX5c3be25e>(
                            it,
                        )
                    },
                requestThreeDSecure =
                    rawObject["request_three_d_secure"]?.let {
                        json.decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormRequestThreeDSecureX87c29717>(
                            it,
                        )
                    },
                restrictions =
                    rawObject["restrictions"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsRestrictionsXa728c548>(
                                it,
                            )
                    },
                setupFutureUsage =
                    rawObject["setup_future_usage"]?.let {
                        json.decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormSetupFutureUsageX395df094>(it)
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsCardX201c881c,
        ) {
            val jsonEncoder =
...
public fun inlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsCardX201c881c(
    block: InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsCardX201c881c.Builder.() -> Unit,
): InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsCardX201c881c =
