...
public class InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsMandateOptionsXab7daf8a(
    public val customMandateUrl: InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsCustomMandateUrlX9581a6a5? = null,
    public val defaultFor: List<InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsAcssDebitItemX5bf47ce4>? = null,
    public val intervalDescription: String? = null,
    public val paymentSchedule: InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsPaymentScheduleX7221206f? = null,
    public val transactionType: InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsTransactionTypeX5cb9d8cb? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsMandateOptionsXab7daf8a =
            InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsMandateOptionsXab7daf8a(
    ...
    public object Serializer : KSerializer<InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsMandateOptionsXab7daf8a> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsMandateOptionsXab7daf8a must be a JSON object",
                    )
            return InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsMandateOptionsXab7daf8a(
                customMandateUrl =
                    rawObject["custom_mandate_url"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsCustomMandateUrlX9581a6a5>(
                                it,
                            )
                    },
                defaultFor =
                    rawObject["default_for"]?.let {
                        json
                            .decodeFromJsonElement<List<InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsAcssDebitItemX5bf47ce4>>(
                                it,
                            )
                    },
                intervalDescription =
                ...
                paymentSchedule =
                    rawObject["payment_schedule"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsPaymentScheduleX7221206f>(
                                it,
                            )
                    },
                transactionType =
                    rawObject["transaction_type"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsTransactionTypeX5cb9d8cb>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsMandateOptionsXab7daf8a,
        ) {
            val jsonEncoder =
...
public fun inlineV1SetupIntentsPostRequestFormPaymentMethodOptionsMandateOptionsXab7daf8a(
    block: InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsMandateOptionsXab7daf8a.Builder.() -> Unit,
): InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsMandateOptionsXab7daf8a =
    InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsMandateOptionsXab7daf8a.build(block)
