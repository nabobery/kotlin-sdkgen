...
public sealed class InlineV1SetupIntentsConfirmPostRequestFormAmountTypeX2a957681 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1SetupIntentsConfirmPostRequestFormAmountTypeX2a957681 =
            when (value) {
                Value.value -> Value
                Fixed.value -> Fixed
    ...
    public object Serializer : KSerializer<InlineV1SetupIntentsConfirmPostRequestFormAmountTypeX2a957681> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1SetupIntentsConfirmPostRequestFormAmountTypeX2a957681",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1SetupIntentsConfirmPostRequestFormAmountTypeX2a957681 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SetupIntentsConfirmPostRequestFormAmountTypeX2a957681,
        ) {
