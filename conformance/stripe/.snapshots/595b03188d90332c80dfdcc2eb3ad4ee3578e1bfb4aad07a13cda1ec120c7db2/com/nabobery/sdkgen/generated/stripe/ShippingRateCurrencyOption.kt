...
public class ShippingRateCurrencyOption(
    ...
    public object Serializer : KSerializer<ShippingRateCurrencyOption> {
        ...
        override fun deserialize(decoder: Decoder): ShippingRateCurrencyOption {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("ShippingRateCurrencyOption must be a JSON object")
            val amount = json.decodeRequired<Int>(rawObject, "amount")
            val taxBehavior =
                json.decodeRequired<InlineShippingRateCurrencyOptionTaxBehaviorX65a6eb58>(
                    rawObject,
                    "tax_behavior",
                )
            return ShippingRateCurrencyOption(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: ShippingRateCurrencyOption,
        ) {
...
public fun shippingRateCurrencyOption(
    block: ShippingRateCurrencyOption.Builder.() -> Unit,
): ShippingRateCurrencyOption = ShippingRateCurrencyOption.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException("ShippingRateCurrencyOption is missing required property '" + name + "'")
