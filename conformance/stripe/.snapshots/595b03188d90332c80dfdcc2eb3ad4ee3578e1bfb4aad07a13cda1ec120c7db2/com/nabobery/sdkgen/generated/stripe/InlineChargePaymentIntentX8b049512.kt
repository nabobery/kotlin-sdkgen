...
public class InlineChargePaymentIntentX8b049512 internal constructor(
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineChargePaymentIntentX8b049512 {
            val inspection = inspectInlineChargePaymentIntentX8b049512(raw)
            if (inspection.matchCount == 0) {
                throw InlineChargePaymentIntentX8b049512NoMatchException(
                    "InlineChargePaymentIntentX8b049512 matched 0 branches: " + inspection.failures.joinToString("; "),
                )
            }
    ...
    public object Serializer : KSerializer<InlineChargePaymentIntentX8b049512> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineChargePaymentIntentX8b049512,
        ) {
...
private fun inspectInlineChargePaymentIntentX8b049512(
    element: JsonElement,
): InlineChargePaymentIntentX8b049512Inspection {
