...
public class InlineV1TaxRegistrationsPostRequestFormCountryOptionsInValueX6f675bd2(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1TaxRegistrationsPostRequestFormCountryOptionsInValueX6f675bd2 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1TaxRegistrationsPostRequestFormCountryOptionsInValueX6f675bd2> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TaxRegistrationsPostRequestFormCountryOptionsInValueX6f675bd2 must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineV1TaxRegistrationsPostRequestFormCountryOptionsInValueTypeXbd5adbc2>(
                    rawObject,
                    "type",
                )
            return InlineV1TaxRegistrationsPostRequestFormCountryOptionsInValueX6f675bd2(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TaxRegistrationsPostRequestFormCountryOptionsInValueX6f675bd2,
        ) {
            val jsonEncoder =
...
public fun inlineV1TaxRegistrationsPostRequestFormCountryOptionsInValueX6f675bd2(
    block: InlineV1TaxRegistrationsPostRequestFormCountryOptionsInValueX6f675bd2.Builder.() -> Unit,
): InlineV1TaxRegistrationsPostRequestFormCountryOptionsInValueX6f675bd2 =
    InlineV1TaxRegistrationsPostRequestFormCountryOptionsInValueX6f675bd2.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TaxRegistrationsPostRequestFormCountryOptionsInValueX6f675bd2 is missing required property '" +
                    name +
                    "'",
            )
