...
public class InlineV1TestHelpersCustomersFundCashBalancePostRequestFormX455b73c8(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1TestHelpersCustomersFundCashBalancePostRequestFormX455b73c8 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TestHelpersCustomersFundCashBalancePostRequestFormX455b73c8> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TestHelpersCustomersFundCashBalancePostRequestFormX455b73c8 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TestHelpersCustomersFundCashBalancePostRequestFormX455b73c8,
        ) {
            val jsonEncoder =
...
public fun inlineV1TestHelpersCustomersFundCashBalancePostRequestFormX455b73c8(
    block: InlineV1TestHelpersCustomersFundCashBalancePostRequestFormX455b73c8.Builder.() -> Unit,
): InlineV1TestHelpersCustomersFundCashBalancePostRequestFormX455b73c8 =
    InlineV1TestHelpersCustomersFundCashBalancePostRequestFormX455b73c8.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TestHelpersCustomersFundCashBalancePostRequestFormX455b73c8 is missing required property '" +
                    name +
                    "'",
            )
