...
public class InlineV1InvoicesLinesPostRequestFormPriceDataX155e7265(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1InvoicesLinesPostRequestFormPriceDataX155e7265 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1InvoicesLinesPostRequestFormPriceDataX155e7265> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1InvoicesLinesPostRequestFormPriceDataX155e7265 must be a JSON object",
                    )
            ...
            return InlineV1InvoicesLinesPostRequestFormPriceDataX155e7265(
                ...
                productData =
                    rawObject["product_data"]?.let {
                        json.decodeFromJsonElement<InlineV1InvoicesLinesPostRequestFormPriceDataProductDataX0beab3a6>(
                            it,
                        )
                    },
                taxBehavior =
                    rawObject["tax_behavior"]?.let {
                        json.decodeFromJsonElement<InlineV1InvoicesLinesPostRequestFormPriceDataTaxBehaviorX80b183b6>(
                            it,
                        )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesLinesPostRequestFormPriceDataX155e7265,
        ) {
...
public fun inlineV1InvoicesLinesPostRequestFormPriceDataX155e7265(
    block: InlineV1InvoicesLinesPostRequestFormPriceDataX155e7265.Builder.() -> Unit,
): InlineV1InvoicesLinesPostRequestFormPriceDataX155e7265 =
    InlineV1InvoicesLinesPostRequestFormPriceDataX155e7265.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1InvoicesLinesPostRequestFormPriceDataX155e7265 is missing required property '" + name + "'",
            )
