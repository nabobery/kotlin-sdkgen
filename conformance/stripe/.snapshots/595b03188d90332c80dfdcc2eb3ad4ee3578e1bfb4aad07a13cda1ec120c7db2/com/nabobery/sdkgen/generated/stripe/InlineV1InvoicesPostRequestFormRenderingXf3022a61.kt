...
public class InlineV1InvoicesPostRequestFormRenderingXf3022a61(
    public val amountTaxDisplay: InlineV1InvoicesPostRequestFormRenderingAmountTaxDisplayX6bd45bbf? = null,
    public val pdf: InlineV1InvoicesPostRequestFormRenderingPdfXe6f0df21? = null,
    public val template: String? = null,
    public val templateVersion: InlineV1InvoicesPostRequestFormRenderingTemplateVersionX0dd4facd? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1InvoicesPostRequestFormRenderingXf3022a61 =
            InlineV1InvoicesPostRequestFormRenderingXf3022a61(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1InvoicesPostRequestFormRenderingXf3022a61 =
    ...
    public object Serializer : KSerializer<InlineV1InvoicesPostRequestFormRenderingXf3022a61> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1InvoicesPostRequestFormRenderingXf3022a61 must be a JSON object",
                    )
            return InlineV1InvoicesPostRequestFormRenderingXf3022a61(
                amountTaxDisplay =
                    rawObject["amount_tax_display"]?.let {
                        json.decodeFromJsonElement<InlineV1InvoicesPostRequestFormRenderingAmountTaxDisplayX6bd45bbf>(
                            it,
                        )
                    },
                pdf =
                    rawObject["pdf"]?.let {
                        json.decodeFromJsonElement<InlineV1InvoicesPostRequestFormRenderingPdfXe6f0df21>(
                            it,
                        )
                    },
                template = rawObject["template"]?.let { json.decodeFromJsonElement<String>(it) },
                templateVersion =
                    rawObject["template_version"]?.let {
                        json.decodeFromJsonElement<InlineV1InvoicesPostRequestFormRenderingTemplateVersionX0dd4facd>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesPostRequestFormRenderingXf3022a61,
        ) {
...
public fun inlineV1InvoicesPostRequestFormRenderingXf3022a61(
    block: InlineV1InvoicesPostRequestFormRenderingXf3022a61.Builder.() -> Unit,
): InlineV1InvoicesPostRequestFormRenderingXf3022a61 = InlineV1InvoicesPostRequestFormRenderingXf3022a61.build(block)
