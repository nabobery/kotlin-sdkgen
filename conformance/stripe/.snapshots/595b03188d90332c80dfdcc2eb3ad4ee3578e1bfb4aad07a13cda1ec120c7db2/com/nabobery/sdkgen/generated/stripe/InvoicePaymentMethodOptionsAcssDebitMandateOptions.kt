...
public class InvoicePaymentMethodOptionsAcssDebitMandateOptions(
     ...
     */
    public val transactionType: InlineInvoicePaymentMethodOptionsAcssDebitMandateOptionsTransactionTypeX4aa9edc9? = null,
) {
    public class Builder {
        ...
        public fun build(): InvoicePaymentMethodOptionsAcssDebitMandateOptions =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InvoicePaymentMethodOptionsAcssDebitMandateOptions =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InvoicePaymentMethodOptionsAcssDebitMandateOptions> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InvoicePaymentMethodOptionsAcssDebitMandateOptions must be a JSON object",
                    )
                ...
                transactionType =
                    rawObject["transaction_type"]?.let { element ->
                        if (element ==
                            ...
                            json
                                .decodeFromJsonElement<InlineInvoicePaymentMethodOptionsAcssDebitMandateOptionsTransactionTypeX4aa9edc9?>(
                                    element,
                                )
                        }
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InvoicePaymentMethodOptionsAcssDebitMandateOptions,
        ) {
...
public fun invoicePaymentMethodOptionsAcssDebitMandateOptions(
    block: InvoicePaymentMethodOptionsAcssDebitMandateOptions.Builder.() -> Unit,
): InvoicePaymentMethodOptionsAcssDebitMandateOptions = InvoicePaymentMethodOptionsAcssDebitMandateOptions.build(block)
