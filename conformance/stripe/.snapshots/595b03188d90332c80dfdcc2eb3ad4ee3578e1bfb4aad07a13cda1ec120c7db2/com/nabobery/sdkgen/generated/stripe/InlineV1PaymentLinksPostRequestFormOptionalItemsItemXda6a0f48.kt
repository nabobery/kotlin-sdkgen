...
public class InlineV1PaymentLinksPostRequestFormOptionalItemsItemXda6a0f48(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PaymentLinksPostRequestFormOptionalItemsItemXda6a0f48 =
    ...
    public object Serializer : KSerializer<InlineV1PaymentLinksPostRequestFormOptionalItemsItemXda6a0f48> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1PaymentLinksPostRequestFormOptionalItemsItemXda6a0f48 {
            val jsonDecoder =
                decoder.requireJsonDecoder(
                    "InlineV1PaymentLinksPostRequestFormOptionalItemsItemXda6a0f48",
                )
            val json = jsonDecoder.json
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentLinksPostRequestFormOptionalItemsItemXda6a0f48 must be a JSON object",
                    )
            ...
            return InlineV1PaymentLinksPostRequestFormOptionalItemsItemXda6a0f48(
                ...
                adjustableQuantity =
                    rawObject["adjustable_quantity"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormOptionalItemsItemAdjustableQuantityX3c657fb0>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentLinksPostRequestFormOptionalItemsItemXda6a0f48,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentLinksPostRequestFormOptionalItemsItemXda6a0f48(
    block: InlineV1PaymentLinksPostRequestFormOptionalItemsItemXda6a0f48.Builder.() -> Unit,
): InlineV1PaymentLinksPostRequestFormOptionalItemsItemXda6a0f48 =
    InlineV1PaymentLinksPostRequestFormOptionalItemsItemXda6a0f48.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentLinksPostRequestFormOptionalItemsItemXda6a0f48 is missing required property '" + name +
                    "'",
            )
