...
public class InlineV1TreasuryFinancialAccountsClosePostRequestFormForwardingSettingsX83fc6e93(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1TreasuryFinancialAccountsClosePostRequestFormForwardingSettingsX83fc6e93 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TreasuryFinancialAccountsClosePostRequestFormForwardingSettingsX83fc6e93> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TreasuryFinancialAccountsClosePostRequestFormForwardingSettingsX83fc6e93 must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineV1TreasuryFinancialAad8dPostRequestFormForwardingSettingsTypeXfa44714e>(
                    rawObject,
                    "type",
                )
            return InlineV1TreasuryFinancialAccountsClosePostRequestFormForwardingSettingsX83fc6e93(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TreasuryFinancialAccountsClosePostRequestFormForwardingSettingsX83fc6e93,
        ) {
            val jsonEncoder =
...
public fun inlineV1TreasuryFinancialAccountsClosePostRequestFormForwardingSettingsX83fc6e93(
    block: InlineV1TreasuryFinancialAccountsClosePostRequestFormForwardingSettingsX83fc6e93.Builder.() -> Unit,
): InlineV1TreasuryFinancialAccountsClosePostRequestFormForwardingSettingsX83fc6e93 =
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TreasuryFinancialAccountsClosePostRequestFormForwardingSettingsX83fc6e93 is missing required property '" +
                    name +
                    "'",
            )
