...
public class PaymentMethodOptionsIdeal(
    ...
    public class Builder {
        ...
        public fun build(): PaymentMethodOptionsIdeal =
    ...
    public object Serializer : KSerializer<PaymentMethodOptionsIdeal> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodOptionsIdeal {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodOptionsIdeal must be a JSON object")
            return PaymentMethodOptionsIdeal(
                setupFutureUsage =
                    rawObject["setup_future_usage"]?.let {
                        json.decodeFromJsonElement<InlinePaymentMethodOptionsIdealSetupFutureUsageXec4df53a>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentMethodOptionsIdeal,
        ) {
...
public fun paymentMethodOptionsIdeal(block: PaymentMethodOptionsIdeal.Builder.() -> Unit): PaymentMethodOptionsIdeal =
    PaymentMethodOptionsIdeal.build(block)
