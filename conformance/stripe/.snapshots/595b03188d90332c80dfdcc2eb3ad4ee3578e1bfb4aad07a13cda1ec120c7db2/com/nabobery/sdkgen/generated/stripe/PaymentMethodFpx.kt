...
public class PaymentMethodFpx(
    ...
    public object Serializer : KSerializer<PaymentMethodFpx> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodFpx {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodFpx must be a JSON object")
...
public fun paymentMethodFpx(block: PaymentMethodFpx.Builder.() -> Unit): PaymentMethodFpx =
    PaymentMethodFpx.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("PaymentMethodFpx is missing required property '" + name + "'")
