...
public sealed class InlineDisputeStatusXfc9cfb04 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineDisputeStatusXfc9cfb04 =
            when (value) {
                Lost.value -> Lost
    ...
    public object Serializer : KSerializer<InlineDisputeStatusXfc9cfb04> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineDisputeStatusXfc9cfb04",
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineDisputeStatusXfc9cfb04,
        ) {
