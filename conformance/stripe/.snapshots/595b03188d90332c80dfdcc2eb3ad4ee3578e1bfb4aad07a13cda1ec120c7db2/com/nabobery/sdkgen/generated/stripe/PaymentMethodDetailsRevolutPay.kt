...
public class PaymentMethodDetailsRevolutPay(
    ...
    public class Builder {
        ...
        public fun build(): PaymentMethodDetailsRevolutPay =
    ...
    public object Serializer : KSerializer<PaymentMethodDetailsRevolutPay> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodDetailsRevolutPay {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodDetailsRevolutPay must be a JSON object")
            return PaymentMethodDetailsRevolutPay(
                funding =
                    rawObject["funding"]?.let {
                        json
                            .decodeFromJsonElement<RevolutPayUnderlyingPaymentMethodFundingDetails>(
                                it,
                            )
                    },
                transactionId =
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentMethodDetailsRevolutPay,
        ) {
...
public fun paymentMethodDetailsRevolutPay(
    block: PaymentMethodDetailsRevolutPay.Builder.() -> Unit,
): PaymentMethodDetailsRevolutPay = PaymentMethodDetailsRevolutPay.build(block)
