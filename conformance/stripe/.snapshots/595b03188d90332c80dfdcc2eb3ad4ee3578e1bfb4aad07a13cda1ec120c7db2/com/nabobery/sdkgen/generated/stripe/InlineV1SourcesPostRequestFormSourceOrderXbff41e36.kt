...
public class InlineV1SourcesPostRequestFormSourceOrderXbff41e36(
    public val items: List<InlineV1SourcesPostRequestFormSourceOrderItemsItemXf6e3b25a>? = null,
    public val shipping: InlineV1SourcesPostRequestFormSourceOrderShippingXaceed685? = null,
) {
    public class Builder {
        public var items: List<InlineV1SourcesPostRequestFormSourceOrderItemsItemXf6e3b25a>? = null

        public var shipping: InlineV1SourcesPostRequestFormSourceOrderShippingXaceed685? = null

        public fun build(): InlineV1SourcesPostRequestFormSourceOrderXbff41e36 =
            InlineV1SourcesPostRequestFormSourceOrderXbff41e36(
                items = items,
                shipping = shipping,
            )
    }
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1SourcesPostRequestFormSourceOrderXbff41e36 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1SourcesPostRequestFormSourceOrderXbff41e36> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SourcesPostRequestFormSourceOrderXbff41e36 must be a JSON object",
                    )
            return InlineV1SourcesPostRequestFormSourceOrderXbff41e36(
                items =
                    rawObject["items"]?.let {
                        json.decodeFromJsonElement<List<InlineV1SourcesPostRequestFormSourceOrderItemsItemXf6e3b25a>>(
                            it,
                        )
                    },
                shipping =
                    rawObject["shipping"]?.let {
                        json.decodeFromJsonElement<InlineV1SourcesPostRequestFormSourceOrderShippingXaceed685>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SourcesPostRequestFormSourceOrderXbff41e36,
        ) {
...
public fun inlineV1SourcesPostRequestFormSourceOrderXbff41e36(
    block: InlineV1SourcesPostRequestFormSourceOrderXbff41e36.Builder.() -> Unit,
): InlineV1SourcesPostRequestFormSourceOrderXbff41e36 = InlineV1SourcesPostRequestFormSourceOrderXbff41e36.build(block)
