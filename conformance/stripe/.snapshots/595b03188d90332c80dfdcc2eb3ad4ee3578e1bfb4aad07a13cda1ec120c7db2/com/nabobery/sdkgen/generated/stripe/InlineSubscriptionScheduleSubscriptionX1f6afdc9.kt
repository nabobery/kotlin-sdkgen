...
public class InlineSubscriptionScheduleSubscriptionX1f6afdc9 internal constructor(
        ...
        get() =
            buildSet {
                ...
                if (inspection.matchesSubscription) {
                    add(
                        InlineSubscriptionScheduleSubscriptionX1f6afdc9Branch.Subscription,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineSubscriptionScheduleSubscriptionX1f6afdc9 {
            val inspection = inspectInlineSubscriptionScheduleSubscriptionX1f6afdc9(raw)
            if (inspection.matchCount == 0) {
                throw InlineSubscriptionScheduleSubscriptionX1f6afdc9NoMatchException(
                    "InlineSubscriptionScheduleSubscriptionX1f6afdc9 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineSubscriptionScheduleSubscriptionX1f6afdc9> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineSubscriptionScheduleSubscriptionX1f6afdc9,
        ) {
...
private fun inspectInlineSubscriptionScheduleSubscriptionX1f6afdc9(
    element: JsonElement,
): InlineSubscriptionScheduleSubscriptionX1f6afdc9Inspection {
