...
public class InlineV1IssuingCardsPostRequestFormPinX79b8e620(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1IssuingCardsPostRequestFormPinX79b8e620 =
            InlineV1IssuingCardsPostRequestFormPinX79b8e620(
                encryptedNumber = encryptedNumber,
            )
    }

    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1IssuingCardsPostRequestFormPinX79b8e620 =
    ...
    public object Serializer : KSerializer<InlineV1IssuingCardsPostRequestFormPinX79b8e620> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1IssuingCardsPostRequestFormPinX79b8e620 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingCardsPostRequestFormPinX79b8e620,
        ) {
...
public fun inlineV1IssuingCardsPostRequestFormPinX79b8e620(
    block: InlineV1IssuingCardsPostRequestFormPinX79b8e620.Builder.() -> Unit,
): InlineV1IssuingCardsPostRequestFormPinX79b8e620 = InlineV1IssuingCardsPostRequestFormPinX79b8e620.build(block)
