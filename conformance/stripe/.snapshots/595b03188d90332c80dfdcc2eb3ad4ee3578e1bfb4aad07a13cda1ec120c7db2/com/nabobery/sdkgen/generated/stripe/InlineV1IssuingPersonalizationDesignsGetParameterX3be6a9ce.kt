...
public sealed class InlineV1IssuingPersonalizationDesignsGetParameterX3be6a9ce {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1IssuingPersonalizationDesignsGetParameterX3be6a9ce =
            when (value) {
                Active.value -> Active
    ...
    public object Serializer : KSerializer<InlineV1IssuingPersonalizationDesignsGetParameterX3be6a9ce> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1IssuingPersonalizationDesignsGetParameterX3be6a9ce",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1IssuingPersonalizationDesignsGetParameterX3be6a9ce =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingPersonalizationDesignsGetParameterX3be6a9ce,
        ) {
