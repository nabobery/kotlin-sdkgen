...
public class InlineV1SetupAttemptsGetParameterAnyOf1Xa963d6de(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1SetupAttemptsGetParameterAnyOf1Xa963d6de =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1SetupAttemptsGetParameterAnyOf1Xa963d6de =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1SetupAttemptsGetParameterAnyOf1Xa963d6de> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SetupAttemptsGetParameterAnyOf1Xa963d6de must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SetupAttemptsGetParameterAnyOf1Xa963d6de,
        ) {
...
public fun inlineV1SetupAttemptsGetParameterAnyOf1Xa963d6de(
    block: InlineV1SetupAttemptsGetParameterAnyOf1Xa963d6de.Builder.() -> Unit,
): InlineV1SetupAttemptsGetParameterAnyOf1Xa963d6de = InlineV1SetupAttemptsGetParameterAnyOf1Xa963d6de.build(block)
