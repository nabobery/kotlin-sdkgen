...
public class InvoicesPaymentsInvoicePaymentStatusTransitions(
    ...
    public class Builder {
        ...
        public fun build(): InvoicesPaymentsInvoicePaymentStatusTransitions =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InvoicesPaymentsInvoicePaymentStatusTransitions =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InvoicesPaymentsInvoicePaymentStatusTransitions> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InvoicesPaymentsInvoicePaymentStatusTransitions must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InvoicesPaymentsInvoicePaymentStatusTransitions,
        ) {
...
public fun invoicesPaymentsInvoicePaymentStatusTransitions(
    block: InvoicesPaymentsInvoicePaymentStatusTransitions.Builder.() -> Unit,
): InvoicesPaymentsInvoicePaymentStatusTransitions = InvoicesPaymentsInvoicePaymentStatusTransitions.build(block)
