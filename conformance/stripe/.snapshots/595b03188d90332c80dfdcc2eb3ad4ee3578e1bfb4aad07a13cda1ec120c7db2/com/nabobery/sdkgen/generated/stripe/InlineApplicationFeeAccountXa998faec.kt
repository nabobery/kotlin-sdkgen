...
public class InlineApplicationFeeAccountXa998faec internal constructor(
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineApplicationFeeAccountXa998faec {
            val inspection = inspectInlineApplicationFeeAccountXa998faec(raw)
            if (inspection.matchCount == 0) {
                throw InlineApplicationFeeAccountXa998faecNoMatchException(
                    "InlineApplicationFeeAccountXa998faec matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineApplicationFeeAccountXa998faec> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineApplicationFeeAccountXa998faec,
        ) {
...
private fun inspectInlineApplicationFeeAccountXa998faec(
    element: JsonElement,
): InlineApplicationFeeAccountXa998faecInspection {
