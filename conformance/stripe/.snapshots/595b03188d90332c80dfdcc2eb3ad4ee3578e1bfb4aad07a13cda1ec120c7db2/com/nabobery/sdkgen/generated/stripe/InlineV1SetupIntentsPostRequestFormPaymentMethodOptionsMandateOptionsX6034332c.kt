...
public class InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsMandateOptionsX6034332c(
    ...
    public val amountType: InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsCardAmountTypeXb7c8aaff,
    ...
    public val supportedTypes: List<InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsCardItemXd995f0ac>? = null,
) {
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsMandateOptionsX6034332c =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsMandateOptionsX6034332c> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsMandateOptionsX6034332c must be a JSON object",
                    )
            val amount = json.decodeRequired<Int>(rawObject, "amount")
            val amountType =
                json
                    .decodeRequired<InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsCardAmountTypeXb7c8aaff>(
                        rawObject,
                        "amount_type",
                    )
            val currency = json.decodeRequired<String>(rawObject, "currency")
            val interval =
                json.decodeRequired<InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsCardIntervalXb26db952>(
                    rawObject,
                    "interval",
                )
            ...
            return InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsMandateOptionsX6034332c(
                ...
                supportedTypes =
                    rawObject["supported_types"]?.let {
                        json
                            .decodeFromJsonElement<List<InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsCardItemXd995f0ac>>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsMandateOptionsX6034332c,
        ) {
            val jsonEncoder =
...
public fun inlineV1SetupIntentsPostRequestFormPaymentMethodOptionsMandateOptionsX6034332c(
    block: InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsMandateOptionsX6034332c.Builder.() -> Unit,
): InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsMandateOptionsX6034332c =
    InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsMandateOptionsX6034332c.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsMandateOptionsX6034332c is missing required property '" +
                    name +
                    "'",
            )
