...
public class InlineV1SubscriptionSchedulesPostRequestFormBillingModeXd1fd61ba(
    ...
    public val flexible: InlineV1SubscriptionSchedulesPostRequestFormBillingModeFlexibleXc680c9d8? = null,
) {
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1SubscriptionSchedulesPostRequestFormBillingModeXd1fd61ba =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1SubscriptionSchedulesPostRequestFormBillingModeXd1fd61ba> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SubscriptionSchedulesPostRequestFormBillingModeXd1fd61ba must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineV1SubscriptionSchedulesPostRequestFormBillingModeTypeX63b10d77>(
                    rawObject,
                    "type",
                )
            return InlineV1SubscriptionSchedulesPostRequestFormBillingModeXd1fd61ba(
                ...
                flexible =
                    rawObject["flexible"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SubscriptionSchedulesPostRequestFormBillingModeFlexibleXc680c9d8>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionSchedulesPostRequestFormBillingModeXd1fd61ba,
        ) {
            val jsonEncoder =
...
public fun inlineV1SubscriptionSchedulesPostRequestFormBillingModeXd1fd61ba(
    block: InlineV1SubscriptionSchedulesPostRequestFormBillingModeXd1fd61ba.Builder.() -> Unit,
): InlineV1SubscriptionSchedulesPostRequestFormBillingModeXd1fd61ba =
    InlineV1SubscriptionSchedulesPostRequestFormBillingModeXd1fd61ba.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1SubscriptionSchedulesPostRequestFormBillingModeXd1fd61ba is missing required property '" + name +
                    "'",
            )
