...
internal data class InlineV1PaymentRecordsReportPaymentPostRequestFormMetadataX8a93bdedInspection(
    ...
    public val matchesInlineV1PaymentRecordsReportPaymentPostRequestFormMetadataAnyOf2X98e40c79: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1PaymentRecordsReportPaymentPostRequestFormMetadataAnyOf2X98e40c79,
            ).count {
                it
            }
}
...
public class InlineV1PaymentRecordsReportPaymentPostRequestFormMetadataX8a93bded internal constructor(
    ...
    private val inspection: InlineV1PaymentRecordsReportPaymentPostRequestFormMetadataX8a93bdedInspection,
) {
    ...
    public val inlineV1PaymentRecordsReportPaymentPostRequestFormMetadataAnyOf2X98e40c79:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1PaymentRecordsReportPaymentPostRequestFormMetadataAnyOf2X98e40c79) {
                json
                    .decodeFromJsonElement<InlineV1PaymentRecordsReportPaymentPostRequestFormMetadataAnyOf2X98e40c79>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1PaymentRecordsReportPaymentPostRequestFormMetadataX8a93bdedBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1PaymentRecordsReportPaymentPostRequestFormMetadataAnyOf2X98e40c79) {
                    add(
                        InlineV1PaymentRecordsReportPaymentPostRequestFormMetadataX8a93bdedBranch.InlineV1PaymentRecordsReportPaymentPostRequestFormMetadataAnyOf2X98e40c79,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1PaymentRecordsReportPaymentPostRequestFormMetadataX8a93bded {
            val inspection = inspectInlineV1PaymentRecordsReportPaymentPostRequestFormMetadataX8a93bded(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1PaymentRecordsReportPaymentPostRequestFormMetadataX8a93bdedNoMatchException(
                    "InlineV1PaymentRecordsReportPaymentPostRequestFormMetadataX8a93bded matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1PaymentRecordsReportPaymentPostRequestFormMetadataX8a93bded> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentRecordsReportPaymentPostRequestFormMetadataX8a93bded,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1PaymentRecordsReportPaymentPostRequestFormMetadataX8a93bded",
...
private fun inspectInlineV1PaymentRecordsReportPaymentPostRequestFormMetadataX8a93bded(
    element: JsonElement,
): InlineV1PaymentRecordsReportPaymentPostRequestFormMetadataX8a93bdedInspection {
    val matchesBranch1 = element.isJsonDecodable<JsonObject>()
    val matchesInlineV1PaymentRecordsReportPaymentPostRequestFormMetadataAnyOf2X98e40c79 =
        element
            .isJsonDecodable<InlineV1PaymentRecordsReportPaymentPostRequestFormMetadataAnyOf2X98e40c79>()
    return InlineV1PaymentRecordsReportPaymentPostRequestFormMetadataX8a93bdedInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1PaymentRecordsReportPaymentPostRequestFormMetadataAnyOf2X98e40c79) {
                    add(
                        "InlineV1PaymentRecordsReportPaymentPostRequestFormMetadataAnyOf2X98e40c79: value does not match InlineV1PaymentRecordsReportPaymentPostRequestFormMetadataAnyOf2X98e40c79",
                    )
                }
            },
    )
