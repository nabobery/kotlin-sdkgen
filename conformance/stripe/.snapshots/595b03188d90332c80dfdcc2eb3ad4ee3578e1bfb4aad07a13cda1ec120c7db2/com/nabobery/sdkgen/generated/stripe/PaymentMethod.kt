...
@Serializable
public data class PaymentMethodView(
...
public class PaymentMethod(
    ...
    public object Serializer : KSerializer<PaymentMethod> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethod {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethod must be a JSON object")
            ...
            return PaymentMethod(
                ...
                allowRedisplay =
                    rawObject["allow_redisplay"]?.let {
                        json.decodeFromJsonElement<InlinePaymentMethodAllowRedisplayX1787c685>(it)
                    },
                ...
                customer =
                    rawObject["customer"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentMethodCustomerX819912bc?>(element)
                        }
                    },
                customerAccount =
