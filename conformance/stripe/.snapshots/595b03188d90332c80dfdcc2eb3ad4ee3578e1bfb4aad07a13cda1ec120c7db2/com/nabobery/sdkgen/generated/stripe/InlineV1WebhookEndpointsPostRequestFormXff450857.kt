...
public class InlineV1WebhookEndpointsPostRequestFormXff450857(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1WebhookEndpointsPostRequestFormXff450857 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1WebhookEndpointsPostRequestFormXff450857> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1WebhookEndpointsPostRequestFormXff450857 {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1WebhookEndpointsPostRequestFormXff450857 must be a JSON object",
                    )
            val enabledEvents =
                json.decodeRequired<List<InlineV1WebhookEndpointsPostRequestFormEnabledEventsItemXc13d542b>>(
                    rawObject,
                    "enabled_events",
                )
            ...
            return InlineV1WebhookEndpointsPostRequestFormXff450857(
                ...
                url = url,
                apiVersion =
                    rawObject["api_version"]?.let {
                        json.decodeFromJsonElement<InlineV1WebhookEndpointsPostRequestFormApiVersionX55858af3>(it)
                    },
                connect = rawObject["connect"]?.let { json.decodeFromJsonElement<Boolean>(it) },
                description =
                    rawObject["description"]?.let {
                        json.decodeFromJsonElement<InlineV1WebhookEndpointsPostRequestFormDescriptionXb6001f6f>(it)
                    },
                expand = rawObject["expand"]?.let { json.decodeFromJsonElement<List<String>>(it) },
                metadata =
                    rawObject["metadata"]?.let {
                        json.decodeFromJsonElement<InlineV1WebhookEndpointsPostRequestFormMetadataXbc2d937e>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1WebhookEndpointsPostRequestFormXff450857,
        ) {
...
public fun inlineV1WebhookEndpointsPostRequestFormXff450857(
    block: InlineV1WebhookEndpointsPostRequestFormXff450857.Builder.() -> Unit,
): InlineV1WebhookEndpointsPostRequestFormXff450857 = InlineV1WebhookEndpointsPostRequestFormXff450857.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1WebhookEndpointsPostRequestFormXff450857 is missing required property '" + name + "'",
            )
