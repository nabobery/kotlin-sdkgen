...
public class InlineV1PaymentIntentsPostRequestFormPaymentMethodDataSofortXcba2a77c(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentIntentsPostRequestFormPaymentMethodDataSofortXcba2a77c = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormPaymentMethodDataSofortXcba2a77c> {
        ...
        override fun deserialize(
            decoder: Decoder,
        ): InlineV1PaymentIntentsPostRequestFormPaymentMethodDataSofortXcba2a77c {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsPostRequestFormPaymentMethodDataSofortXcba2a77c must be a JSON object",
                    )
            val country =
                json.decodeRequired<InlineV1PaymentIntentsPostRequestFormPaymentMethodDataSofortCountryX89d7b2bc>(
                    rawObject,
                    "country",
                )
            return InlineV1PaymentIntentsPostRequestFormPaymentMethodDataSofortXcba2a77c(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormPaymentMethodDataSofortXcba2a77c,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentIntentsPostRequestFormPaymentMethodDataSofortXcba2a77c(
    block: InlineV1PaymentIntentsPostRequestFormPaymentMethodDataSofortXcba2a77c.Builder.() -> Unit,
): InlineV1PaymentIntentsPostRequestFormPaymentMethodDataSofortXcba2a77c =
    InlineV1PaymentIntentsPostRequestFormPaymentMethodDataSofortXcba2a77c.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentIntentsPostRequestFormPaymentMethodDataSofortXcba2a77c is missing required property '" +
                    name +
                    "'",
            )
