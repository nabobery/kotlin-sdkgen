...
internal data class InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceCountryXaa4bec02Inspection(
    ...
    public val matchesInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2Xad5d084d: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2Xad5d084d,
            ).count {
                it
            }
}
...
public class InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceCountryXaa4bec02 internal constructor(
    ...
    private val inspection: InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceCountryXaa4bec02Inspection,
) {
    ...
    public val inlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2Xad5d084d:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2Xad5d084d) {
                json
                    .decodeFromJsonElement<InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2Xad5d084d>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceCountryXaa4bec02Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2Xad5d084d) {
                    add(
                        InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceCountryXaa4bec02Branch.InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2Xad5d084d,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceCountryXaa4bec02 {
            val inspection = inspectInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceCountryXaa4bec02(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceCountryXaa4bec02NoMatchException(
                    "InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceCountryXaa4bec02 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceCountryXaa4bec02> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceCountryXaa4bec02,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceCountryXaa4bec02",
...
private fun inspectInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceCountryXaa4bec02(
    element: JsonElement,
): InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceCountryXaa4bec02Inspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2Xad5d084d =
        element
            .isJsonDecodable<InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2Xad5d084d>()
    return InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceCountryXaa4bec02Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2Xad5d084d) {
                    add(
                        "InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2Xad5d084d: value does not match InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2Xad5d084d",
                    )
                }
            },
    )
