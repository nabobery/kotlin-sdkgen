...
public sealed class InlinePaymentLinksResourcePaymentIntentDataCaptureMethodXf179e15d {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentLinksResourcePaymentIntentDataCaptureMethodXf179e15d =
            when (value) {
    ...
    public object Serializer : KSerializer<InlinePaymentLinksResourcePaymentIntentDataCaptureMethodXf179e15d> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentLinksResourcePaymentIntentDataCaptureMethodXf179e15d",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePaymentLinksResourcePaymentIntentDataCaptureMethodXf179e15d =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentLinksResourcePaymentIntentDataCaptureMethodXf179e15d,
        ) {
