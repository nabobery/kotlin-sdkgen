...
public sealed class InlineV1SubscriptionsPostRequestFormCancelAtAnyOf3X5d3ea8a1 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1SubscriptionsPostRequestFormCancelAtAnyOf3X5d3ea8a1 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionsPostRequestFormCancelAtAnyOf3X5d3ea8a1> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1SubscriptionsPostRequestFormCancelAtAnyOf3X5d3ea8a1",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1SubscriptionsPostRequestFormCancelAtAnyOf3X5d3ea8a1 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsPostRequestFormCancelAtAnyOf3X5d3ea8a1,
        ) {
