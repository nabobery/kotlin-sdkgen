...
public class InlineV1BillingPortalSessionsPostRequestFormFlowDataItemXea2b2884(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1BillingPortalSessionsPostRequestFormFlowDataItemXea2b2884 =
    ...
    public object Serializer : KSerializer<InlineV1BillingPortalSessionsPostRequestFormFlowDataItemXea2b2884> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1BillingPortalSessionsPostRequestFormFlowDataItemXea2b2884 {
            val jsonDecoder =
                decoder.requireJsonDecoder(
                    "InlineV1BillingPortalSessionsPostRequestFormFlowDataItemXea2b2884",
                )
            val json = jsonDecoder.json
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1BillingPortalSessionsPostRequestFormFlowDataItemXea2b2884 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1BillingPortalSessionsPostRequestFormFlowDataItemXea2b2884,
        ) {
            val jsonEncoder =
...
public fun inlineV1BillingPortalSessionsPostRequestFormFlowDataItemXea2b2884(
    block: InlineV1BillingPortalSessionsPostRequestFormFlowDataItemXea2b2884.Builder.() -> Unit,
): InlineV1BillingPortalSessionsPostRequestFormFlowDataItemXea2b2884 =
    InlineV1BillingPortalSessionsPostRequestFormFlowDataItemXea2b2884.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1BillingPortalSessionsPostRequestFormFlowDataItemXea2b2884 is missing required property '" +
                    name +
                    "'",
            )
