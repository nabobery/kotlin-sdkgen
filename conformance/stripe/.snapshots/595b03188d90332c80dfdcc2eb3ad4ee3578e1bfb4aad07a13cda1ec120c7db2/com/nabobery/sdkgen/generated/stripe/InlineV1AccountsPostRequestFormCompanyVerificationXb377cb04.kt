...
public class InlineV1AccountsPostRequestFormCompanyVerificationXb377cb04(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1AccountsPostRequestFormCompanyVerificationXb377cb04 =
            InlineV1AccountsPostRequestFormCompanyVerificationXb377cb04(
                document = document,
            )
    }

    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1AccountsPostRequestFormCompanyVerificationXb377cb04 =
    ...
    public object Serializer : KSerializer<InlineV1AccountsPostRequestFormCompanyVerificationXb377cb04> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountsPostRequestFormCompanyVerificationXb377cb04 must be a JSON object",
                    )
            return InlineV1AccountsPostRequestFormCompanyVerificationXb377cb04(
                document =
                    rawObject["document"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCompanyVerificationDocumentX2af09bbd>(
                            it,
                        )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPostRequestFormCompanyVerificationXb377cb04,
        ) {
...
public fun inlineV1AccountsPostRequestFormCompanyVerificationXb377cb04(
    block: InlineV1AccountsPostRequestFormCompanyVerificationXb377cb04.Builder.() -> Unit,
): InlineV1AccountsPostRequestFormCompanyVerificationXb377cb04 =
    InlineV1AccountsPostRequestFormCompanyVerificationXb377cb04.build(block)
