...
public sealed class InlineV1CustomersSubscriptionsGetResponse200JsonObjectValueX315a74f9 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1CustomersSubscriptionsGetResponse200JsonObjectValueX315a74f9 =
            when (value) {
                List.value -> List
    ...
    public object Serializer : KSerializer<InlineV1CustomersSubscriptionsGetResponse200JsonObjectValueX315a74f9> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1CustomersSubscriptionsGetResponse200JsonObjectValueX315a74f9",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1CustomersSubscriptionsGetResponse200JsonObjectValueX315a74f9 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersSubscriptionsGetResponse200JsonObjectValueX315a74f9,
        ) {
