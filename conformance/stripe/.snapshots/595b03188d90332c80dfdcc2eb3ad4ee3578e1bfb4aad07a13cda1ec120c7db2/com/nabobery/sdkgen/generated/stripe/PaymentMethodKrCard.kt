...
public class PaymentMethodKrCard(
    ...
    public class Builder {
        ...
        public fun build(): PaymentMethodKrCard =
            PaymentMethodKrCard(
                brand = brand,
                last4 = last4,
            )
    ...
    public object Serializer : KSerializer<PaymentMethodKrCard> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodKrCard {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodKrCard must be a JSON object")
                ...
                brand =
                    rawObject["brand"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentMethodKrCardBrandXc47ee754?>(element)
                        }
                    },
                last4 =
...
public fun paymentMethodKrCard(block: PaymentMethodKrCard.Builder.() -> Unit): PaymentMethodKrCard =
    PaymentMethodKrCard.build(block)
