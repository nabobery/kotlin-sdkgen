...
public sealed class InlineV1BillingMetersEventSummariesGetParameterXc43685d8 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1BillingMetersEventSummariesGetParameterXc43685d8 =
            when (value) {
                Day.value -> Day
                Hour.value -> Hour
    ...
    public object Serializer : KSerializer<InlineV1BillingMetersEventSummariesGetParameterXc43685d8> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1BillingMetersEventSummariesGetParameterXc43685d8",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1BillingMetersEventSummariesGetParameterXc43685d8 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1BillingMetersEventSummariesGetParameterXc43685d8,
        ) {
