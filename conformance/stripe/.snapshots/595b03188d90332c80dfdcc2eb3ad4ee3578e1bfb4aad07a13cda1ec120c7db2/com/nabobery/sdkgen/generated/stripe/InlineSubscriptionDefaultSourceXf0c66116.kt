...
public class InlineSubscriptionDefaultSourceXf0c66116 internal constructor(
    ...
    public val bankAccount: BankAccount? by
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesBankAccount) json.decodeFromJsonElement<BankAccount>(raw) else null
        }
    ...
    public val source: Source? by
        lazy(
            LazyThreadSafetyMode.NONE,
        ) { if (inspection.matchesSource) json.decodeFromJsonElement<Source>(raw) else null }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineSubscriptionDefaultSourceXf0c66116 {
            val inspection = inspectInlineSubscriptionDefaultSourceXf0c66116(raw)
            if (inspection.matchCount == 0) {
                throw InlineSubscriptionDefaultSourceXf0c66116NoMatchException(
                    "InlineSubscriptionDefaultSourceXf0c66116 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineSubscriptionDefaultSourceXf0c66116> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineSubscriptionDefaultSourceXf0c66116,
        ) {
...
private fun inspectInlineSubscriptionDefaultSourceXf0c66116(
    element: JsonElement,
): InlineSubscriptionDefaultSourceXf0c66116Inspection {
