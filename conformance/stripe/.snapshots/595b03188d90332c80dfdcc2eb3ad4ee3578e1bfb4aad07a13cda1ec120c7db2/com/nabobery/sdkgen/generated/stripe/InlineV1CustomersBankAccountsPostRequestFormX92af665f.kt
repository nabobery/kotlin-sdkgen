...
public class InlineV1CustomersBankAccountsPostRequestFormX92af665f(
     ...
     */
    public val accountHolderType: InlineV1CustomersBankAccountsPostRequestFormAccountHolderTypeX940a31c8? = null,
    /**
    ...
    public class Builder {
        ...
        public fun build(): InlineV1CustomersBankAccountsPostRequestFormX92af665f =
            InlineV1CustomersBankAccountsPostRequestFormX92af665f(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1CustomersBankAccountsPostRequestFormX92af665f =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1CustomersBankAccountsPostRequestFormX92af665f> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CustomersBankAccountsPostRequestFormX92af665f must be a JSON object",
                    )
            return InlineV1CustomersBankAccountsPostRequestFormX92af665f(
                ...
                accountHolderType =
                    rawObject["account_holder_type"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CustomersBankAccountsPostRequestFormAccountHolderTypeX940a31c8>(
                                it,
                            )
                    },
                ...
                metadata =
                    rawObject["metadata"]?.let {
                        json.decodeFromJsonElement<InlineV1CustomersBankAccountsPostRequestFormMetadataXe6ec7f7b>(it)
                    },
                name = rawObject["name"]?.let { json.decodeFromJsonElement<String>(it) },
                owner =
                    rawObject["owner"]?.let {
                        json.decodeFromJsonElement<InlineV1CustomersBankAccountsPostRequestFormOwnerX3768c64d>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersBankAccountsPostRequestFormX92af665f,
        ) {
...
public fun inlineV1CustomersBankAccountsPostRequestFormX92af665f(
    block: InlineV1CustomersBankAccountsPostRequestFormX92af665f.Builder.() -> Unit,
): InlineV1CustomersBankAccountsPostRequestFormX92af665f =
    InlineV1CustomersBankAccountsPostRequestFormX92af665f.build(block)
