...
public class PaymentMethodDetailsGiropay(
    ...
    public class Builder {
        ...
        public fun build(): PaymentMethodDetailsGiropay =
    ...
    public object Serializer : KSerializer<PaymentMethodDetailsGiropay> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodDetailsGiropay {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodDetailsGiropay must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentMethodDetailsGiropay,
        ) {
...
public fun paymentMethodDetailsGiropay(
    block: PaymentMethodDetailsGiropay.Builder.() -> Unit,
): PaymentMethodDetailsGiropay = PaymentMethodDetailsGiropay.build(block)
