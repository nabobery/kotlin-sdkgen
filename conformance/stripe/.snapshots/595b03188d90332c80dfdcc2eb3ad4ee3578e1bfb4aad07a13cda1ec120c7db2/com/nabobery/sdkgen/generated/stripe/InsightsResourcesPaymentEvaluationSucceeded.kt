...
public class InsightsResourcesPaymentEvaluationSucceeded(
    ...
    public class Builder {
        ...
        public fun build(): InsightsResourcesPaymentEvaluationSucceeded =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InsightsResourcesPaymentEvaluationSucceeded =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InsightsResourcesPaymentEvaluationSucceeded> {
        ...
        override fun deserialize(decoder: Decoder): InsightsResourcesPaymentEvaluationSucceeded {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("InsightsResourcesPaymentEvaluationSucceeded must be a JSON object")
            return InsightsResourcesPaymentEvaluationSucceeded(
                card =
                    rawObject["card"]?.let {
                        json.decodeFromJsonElement<InsightsResourcesPaymentEvaluationSucceededCard>(
                            it,
                        )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InsightsResourcesPaymentEvaluationSucceeded,
        ) {
...
public fun insightsResourcesPaymentEvaluationSucceeded(
    block: InsightsResourcesPaymentEvaluationSucceeded.Builder.() -> Unit,
): InsightsResourcesPaymentEvaluationSucceeded = InsightsResourcesPaymentEvaluationSucceeded.build(block)
