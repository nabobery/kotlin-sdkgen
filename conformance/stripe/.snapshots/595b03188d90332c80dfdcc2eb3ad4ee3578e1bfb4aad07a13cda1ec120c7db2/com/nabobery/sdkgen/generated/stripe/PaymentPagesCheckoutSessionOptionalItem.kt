...
public class PaymentPagesCheckoutSessionOptionalItem(
    ...
    public val adjustableQuantity: InlinePaymentPagesCheckoutSessionOptionalItemAdjustableQuantityX23657d01? = null,
) {
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentPagesCheckoutSessionOptionalItem =
    ...
    public object Serializer : KSerializer<PaymentPagesCheckoutSessionOptionalItem> {
        ...
        override fun deserialize(decoder: Decoder): PaymentPagesCheckoutSessionOptionalItem {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentPagesCheckoutSessionOptionalItem must be a JSON object")
                ...
                adjustableQuantity =
                    rawObject["adjustable_quantity"]?.let { element ->
                        if (element ==
                            ...
                            json
                                .decodeFromJsonElement<InlinePaymentPagesCheckoutSessionOptionalItemAdjustableQuantityX23657d01?>(
                                    element,
                                )
                        }
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentPagesCheckoutSessionOptionalItem,
        ) {
...
public fun paymentPagesCheckoutSessionOptionalItem(
    block: PaymentPagesCheckoutSessionOptionalItem.Builder.() -> Unit,
): PaymentPagesCheckoutSessionOptionalItem = PaymentPagesCheckoutSessionOptionalItem.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "PaymentPagesCheckoutSessionOptionalItem is missing required property '" + name + "'",
            )
