...
public class InlineV1AccountsPostRequestFormCapabilitiesIdealPaymentsXa6d85acc(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1AccountsPostRequestFormCapabilitiesIdealPaymentsXa6d85acc =
            InlineV1AccountsPostRequestFormCapabilitiesIdealPaymentsXa6d85acc(
                requested = requested,
            )
    }

    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1AccountsPostRequestFormCapabilitiesIdealPaymentsXa6d85acc =
    ...
    public object Serializer : KSerializer<InlineV1AccountsPostRequestFormCapabilitiesIdealPaymentsXa6d85acc> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountsPostRequestFormCapabilitiesIdealPaymentsXa6d85acc must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPostRequestFormCapabilitiesIdealPaymentsXa6d85acc,
        ) {
            val jsonEncoder =
...
public fun inlineV1AccountsPostRequestFormCapabilitiesIdealPaymentsXa6d85acc(
    block: InlineV1AccountsPostRequestFormCapabilitiesIdealPaymentsXa6d85acc.Builder.() -> Unit,
): InlineV1AccountsPostRequestFormCapabilitiesIdealPaymentsXa6d85acc =
    InlineV1AccountsPostRequestFormCapabilitiesIdealPaymentsXa6d85acc.build(block)
