...
public class InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsBacsDebitXb013bd54(
    ...
    public val setupFutureUsage: InlineV1CheckoutSessionsPostRequestFormSetupFutureUsageXc8943ba3? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsBacsDebitXb013bd54 =
            InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsBacsDebitXb013bd54(
    ...
    public object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsBacsDebitXb013bd54> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsBacsDebitXb013bd54 must be a JSON object",
                    )
            return InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsBacsDebitXb013bd54(
                mandateOptions =
                    rawObject["mandate_options"]?.let {
                        json.decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormMandateOptionsXbe2a64e9>(it)
                    },
                setupFutureUsage =
                    rawObject["setup_future_usage"]?.let {
                        json.decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormSetupFutureUsageXc8943ba3>(it)
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsBacsDebitXb013bd54,
        ) {
            val jsonEncoder =
...
public fun inlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsBacsDebitXb013bd54(
    block: InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsBacsDebitXb013bd54.Builder.() -> Unit,
): InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsBacsDebitXb013bd54 =
