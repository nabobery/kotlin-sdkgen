...
public sealed class InlineBankConnectionsResourceTransactionRefreshStatusX0b9d5432 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineBankConnectionsResourceTransactionRefreshStatusX0b9d5432 =
            when (value) {
                Failed.value -> Failed
    ...
    public object Serializer : KSerializer<InlineBankConnectionsResourceTransactionRefreshStatusX0b9d5432> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineBankConnectionsResourceTransactionRefreshStatusX0b9d5432",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineBankConnectionsResourceTransactionRefreshStatusX0b9d5432 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineBankConnectionsResourceTransactionRefreshStatusX0b9d5432,
        ) {
