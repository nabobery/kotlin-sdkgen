...
public class InlineV1TopupsCancelPostRequestFormX8018f503(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1TopupsCancelPostRequestFormX8018f503 =
            InlineV1TopupsCancelPostRequestFormX8018f503(
                expand = expand,
            )
    }

    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TopupsCancelPostRequestFormX8018f503 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TopupsCancelPostRequestFormX8018f503> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TopupsCancelPostRequestFormX8018f503 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TopupsCancelPostRequestFormX8018f503,
        ) {
...
public fun inlineV1TopupsCancelPostRequestFormX8018f503(
    block: InlineV1TopupsCancelPostRequestFormX8018f503.Builder.() -> Unit,
): InlineV1TopupsCancelPostRequestFormX8018f503 = InlineV1TopupsCancelPostRequestFormX8018f503.build(block)
