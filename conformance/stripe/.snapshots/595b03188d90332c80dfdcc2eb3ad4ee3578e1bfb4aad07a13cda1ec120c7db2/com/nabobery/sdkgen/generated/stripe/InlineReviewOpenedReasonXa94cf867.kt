...
public sealed class InlineReviewOpenedReasonXa94cf867 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineReviewOpenedReasonXa94cf867 =
            when (value) {
                Manual.value -> Manual
                Rule.value -> Rule
    ...
    public object Serializer : KSerializer<InlineReviewOpenedReasonXa94cf867> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineReviewOpenedReasonXa94cf867",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineReviewOpenedReasonXa94cf867 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineReviewOpenedReasonXa94cf867,
        ) {
