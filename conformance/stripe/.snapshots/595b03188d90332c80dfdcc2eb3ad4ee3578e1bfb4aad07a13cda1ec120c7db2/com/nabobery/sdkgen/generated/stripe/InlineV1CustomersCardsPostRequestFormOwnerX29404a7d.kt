...
public class InlineV1CustomersCardsPostRequestFormOwnerX29404a7d(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1CustomersCardsPostRequestFormOwnerX29404a7d =
            InlineV1CustomersCardsPostRequestFormOwnerX29404a7d(
                address = address,
                email = email,
                name = name,
                phone = phone,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1CustomersCardsPostRequestFormOwnerX29404a7d =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1CustomersCardsPostRequestFormOwnerX29404a7d> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CustomersCardsPostRequestFormOwnerX29404a7d must be a JSON object",
                    )
            return InlineV1CustomersCardsPostRequestFormOwnerX29404a7d(
                address =
                    rawObject["address"]?.let {
                        json.decodeFromJsonElement<InlineV1CustomersCardsPostRequestFormOwnerAddressXe107f8b9>(it)
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersCardsPostRequestFormOwnerX29404a7d,
        ) {
...
public fun inlineV1CustomersCardsPostRequestFormOwnerX29404a7d(
    block: InlineV1CustomersCardsPostRequestFormOwnerX29404a7d.Builder.() -> Unit,
): InlineV1CustomersCardsPostRequestFormOwnerX29404a7d =
    InlineV1CustomersCardsPostRequestFormOwnerX29404a7d.build(block)
