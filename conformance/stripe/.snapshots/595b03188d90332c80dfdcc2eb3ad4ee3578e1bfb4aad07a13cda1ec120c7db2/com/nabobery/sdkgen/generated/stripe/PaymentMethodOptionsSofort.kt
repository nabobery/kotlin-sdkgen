...
public class PaymentMethodOptionsSofort(
    ...
    public class Builder {
        ...
        public fun build(): PaymentMethodOptionsSofort =
    ...
    public object Serializer : KSerializer<PaymentMethodOptionsSofort> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodOptionsSofort {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodOptionsSofort must be a JSON object")
            return PaymentMethodOptionsSofort(
                preferredLanguage =
                    rawObject["preferred_language"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentMethodOptionsSofortPreferredLanguageX71f24d9d?>(
                                element,
                            )
                        }
                    },
                setupFutureUsage =
                    rawObject["setup_future_usage"]?.let {
                        json.decodeFromJsonElement<InlinePaymentMethodOptionsSofortSetupFutureUsageXd4013f6c>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentMethodOptionsSofort,
        ) {
...
public fun paymentMethodOptionsSofort(
    block: PaymentMethodOptionsSofort.Builder.() -> Unit,
): PaymentMethodOptionsSofort = PaymentMethodOptionsSofort.build(block)
