...
public sealed class InlineAccountCapabilitiesSatispayPaymentsXdb5d9f80 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineAccountCapabilitiesSatispayPaymentsXdb5d9f80 =
            when (value) {
                Active.value -> Active
    ...
    public object Serializer : KSerializer<InlineAccountCapabilitiesSatispayPaymentsXdb5d9f80> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineAccountCapabilitiesSatispayPaymentsXdb5d9f80",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineAccountCapabilitiesSatispayPaymentsXdb5d9f80 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineAccountCapabilitiesSatispayPaymentsXdb5d9f80,
        ) {
