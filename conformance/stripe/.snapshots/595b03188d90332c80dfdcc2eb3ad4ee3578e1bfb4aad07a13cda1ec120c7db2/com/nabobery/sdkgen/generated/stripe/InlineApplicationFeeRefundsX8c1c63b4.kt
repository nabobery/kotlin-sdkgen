...
public class InlineApplicationFeeRefundsX8c1c63b4(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineApplicationFeeRefundsX8c1c63b4 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineApplicationFeeRefundsX8c1c63b4> {
        ...
        override fun deserialize(decoder: Decoder): InlineApplicationFeeRefundsX8c1c63b4 {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("InlineApplicationFeeRefundsX8c1c63b4 must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineApplicationFeeRefundsX8c1c63b4,
        ) {
...
public fun inlineApplicationFeeRefundsX8c1c63b4(
    block: InlineApplicationFeeRefundsX8c1c63b4.Builder.() -> Unit,
): InlineApplicationFeeRefundsX8c1c63b4 = InlineApplicationFeeRefundsX8c1c63b4.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineApplicationFeeRefundsX8c1c63b4 is missing required property '" + name + "'",
            )
