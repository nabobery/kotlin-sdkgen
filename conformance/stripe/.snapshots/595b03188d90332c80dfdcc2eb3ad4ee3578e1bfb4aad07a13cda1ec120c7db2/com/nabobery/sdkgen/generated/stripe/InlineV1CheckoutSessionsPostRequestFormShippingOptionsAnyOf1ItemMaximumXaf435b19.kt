...
public class InlineV1CheckoutSessionsPostRequestFormShippingOptionsAnyOf1ItemMaximumXaf435b19(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1CheckoutSessionsPostRequestFormShippingOptionsAnyOf1ItemMaximumXaf435b19 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormShippingOptionsAnyOf1ItemMaximumXaf435b19> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CheckoutSessionsPostRequestFormShippingOptionsAnyOf1ItemMaximumXaf435b19 must be a JSON object",
                    )
            val unit =
                json.decodeRequired<InlineV1CheckoutSessionsPostRequestFormShippingOptionsAnyOf1ItemUnitX79dcb7ec>(
                    rawObject,
                    "unit",
                )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsPostRequestFormShippingOptionsAnyOf1ItemMaximumXaf435b19,
        ) {
            val jsonEncoder =
...
public fun inlineV1CheckoutSessionsPostRequestFormShippingOptionsAnyOf1ItemMaximumXaf435b19(
    block: InlineV1CheckoutSessionsPostRequestFormShippingOptionsAnyOf1ItemMaximumXaf435b19.Builder.() -> Unit,
): InlineV1CheckoutSessionsPostRequestFormShippingOptionsAnyOf1ItemMaximumXaf435b19 =
    InlineV1CheckoutSessionsPostRequestFormShippingOptionsAnyOf1ItemMaximumXaf435b19.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1CheckoutSessionsPostRequestFormShippingOptionsAnyOf1ItemMaximumXaf435b19 is missing required property '" +
                    name +
                    "'",
            )
