...
public class InlineCheckoutSessionPaymentIntentXd92b065b internal constructor(
        ...
        get() =
            buildSet {
                ...
                if (inspection.matchesPaymentIntent) {
                    add(
                        InlineCheckoutSessionPaymentIntentXd92b065bBranch.PaymentIntent,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineCheckoutSessionPaymentIntentXd92b065b {
            val inspection = inspectInlineCheckoutSessionPaymentIntentXd92b065b(raw)
            if (inspection.matchCount == 0) {
                throw InlineCheckoutSessionPaymentIntentXd92b065bNoMatchException(
                    "InlineCheckoutSessionPaymentIntentXd92b065b matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineCheckoutSessionPaymentIntentXd92b065b> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineCheckoutSessionPaymentIntentXd92b065b,
        ) {
...
private fun inspectInlineCheckoutSessionPaymentIntentXd92b065b(
    element: JsonElement,
): InlineCheckoutSessionPaymentIntentXd92b065bInspection {
