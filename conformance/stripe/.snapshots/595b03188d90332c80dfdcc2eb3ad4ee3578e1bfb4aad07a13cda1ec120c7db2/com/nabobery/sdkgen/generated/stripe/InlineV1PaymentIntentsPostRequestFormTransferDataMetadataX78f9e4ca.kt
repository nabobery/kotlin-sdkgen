...
internal data class InlineV1PaymentIntentsPostRequestFormTransferDataMetadataX78f9e4caInspection(
    ...
    public val matchesInlineV1PaymentIntentsPostRequestFormTransferDataMetadataAnyOf2Xbb048468: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1PaymentIntentsPostRequestFormTransferDataMetadataAnyOf2Xbb048468,
            ).count {
                it
            }
}
...
public class InlineV1PaymentIntentsPostRequestFormTransferDataMetadataX78f9e4ca internal constructor(
    ...
    private val inspection: InlineV1PaymentIntentsPostRequestFormTransferDataMetadataX78f9e4caInspection,
) {
    ...
    public val inlineV1PaymentIntentsPostRequestFormTransferDataMetadataAnyOf2Xbb048468:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1PaymentIntentsPostRequestFormTransferDataMetadataAnyOf2Xbb048468) {
                json
                    .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormTransferDataMetadataAnyOf2Xbb048468>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1PaymentIntentsPostRequestFormTransferDataMetadataX78f9e4caBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1PaymentIntentsPostRequestFormTransferDataMetadataAnyOf2Xbb048468) {
                    add(
                        InlineV1PaymentIntentsPostRequestFormTransferDataMetadataX78f9e4caBranch.InlineV1PaymentIntentsPostRequestFormTransferDataMetadataAnyOf2Xbb048468,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1PaymentIntentsPostRequestFormTransferDataMetadataX78f9e4ca {
            val inspection = inspectInlineV1PaymentIntentsPostRequestFormTransferDataMetadataX78f9e4ca(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1PaymentIntentsPostRequestFormTransferDataMetadataX78f9e4caNoMatchException(
                    "InlineV1PaymentIntentsPostRequestFormTransferDataMetadataX78f9e4ca matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormTransferDataMetadataX78f9e4ca> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormTransferDataMetadataX78f9e4ca,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1PaymentIntentsPostRequestFormTransferDataMetadataX78f9e4ca",
...
private fun inspectInlineV1PaymentIntentsPostRequestFormTransferDataMetadataX78f9e4ca(
    element: JsonElement,
): InlineV1PaymentIntentsPostRequestFormTransferDataMetadataX78f9e4caInspection {
    val matchesBranch1 = element.isJsonDecodable<JsonObject>()
    val matchesInlineV1PaymentIntentsPostRequestFormTransferDataMetadataAnyOf2Xbb048468 =
        element
            .isJsonDecodable<InlineV1PaymentIntentsPostRequestFormTransferDataMetadataAnyOf2Xbb048468>()
    return InlineV1PaymentIntentsPostRequestFormTransferDataMetadataX78f9e4caInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1PaymentIntentsPostRequestFormTransferDataMetadataAnyOf2Xbb048468) {
                    add(
                        "InlineV1PaymentIntentsPostRequestFormTransferDataMetadataAnyOf2Xbb048468: value does not match InlineV1PaymentIntentsPostRequestFormTransferDataMetadataAnyOf2Xbb048468",
                    )
                }
            },
    )
