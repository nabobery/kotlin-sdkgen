...
public data class InsightsResourcesPaymentEvaluationMoneyMovementDetailsView(
    public val card: InlineInsightsResourcesPaymentEvaluationMoneyMovementDetailsCardX52562496? = null,
...
public class InsightsResourcesPaymentEvaluationMoneyMovementDetails(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InsightsResourcesPaymentEvaluationMoneyMovementDetails =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InsightsResourcesPaymentEvaluationMoneyMovementDetails> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InsightsResourcesPaymentEvaluationMoneyMovementDetails must be a JSON object",
                    )
            val moneyMovementType =
                json.decodeRequired<InlineInsightsResourcesPay85e1MoneyMovementTypeX981c3461>(
                    rawObject,
                    "money_movement_type",
                )
            return InsightsResourcesPaymentEvaluationMoneyMovementDetails(
                ...
                card =
                    rawObject["card"]?.let { element ->
                        if (element ==
                            ...
                            json
                                .decodeFromJsonElement<InlineInsightsResourcesPaymentEvaluationMoneyMovementDetailsCardX52562496?>(
                                    element,
                                )
                        }
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InsightsResourcesPaymentEvaluationMoneyMovementDetails,
        ) {
...
public fun insightsResourcesPaymentEvaluationMoneyMovementDetails(
    block: InsightsResourcesPaymentEvaluationMoneyMovementDetails.Builder.() -> Unit,
): InsightsResourcesPaymentEvaluationMoneyMovementDetails =
    InsightsResourcesPaymentEvaluationMoneyMovementDetails.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InsightsResourcesPaymentEvaluationMoneyMovementDetails is missing required property '" + name + "'",
            )
