...
public class InlineV1ForwardingRequestsGetResponse200JsonX84c350c4(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1ForwardingRequestsGetResponse200JsonX84c350c4 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1ForwardingRequestsGetResponse200JsonX84c350c4> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1ForwardingRequestsGetResponse200JsonX84c350c4 {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1ForwardingRequestsGetResponse200JsonX84c350c4 must be a JSON object",
                    )
            ...
            val objectValue =
                json.decodeRequired<InlineV1ForwardingRequestsGetResponse200JsonObjectValueX820ade2d>(
                    rawObject,
                    "object",
                )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ForwardingRequestsGetResponse200JsonX84c350c4,
        ) {
...
public fun inlineV1ForwardingRequestsGetResponse200JsonX84c350c4(
    block: InlineV1ForwardingRequestsGetResponse200JsonX84c350c4.Builder.() -> Unit,
): InlineV1ForwardingRequestsGetResponse200JsonX84c350c4 =
    InlineV1ForwardingRequestsGetResponse200JsonX84c350c4.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1ForwardingRequestsGetResponse200JsonX84c350c4 is missing required property '" + name + "'",
            )
