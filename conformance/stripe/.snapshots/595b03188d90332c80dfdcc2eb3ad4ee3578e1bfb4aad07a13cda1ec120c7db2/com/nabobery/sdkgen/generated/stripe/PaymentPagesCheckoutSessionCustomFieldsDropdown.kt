...
public class PaymentPagesCheckoutSessionCustomFieldsDropdown(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentPagesCheckoutSessionCustomFieldsDropdown =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentPagesCheckoutSessionCustomFieldsDropdown> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "PaymentPagesCheckoutSessionCustomFieldsDropdown must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentPagesCheckoutSessionCustomFieldsDropdown,
        ) {
...
public fun paymentPagesCheckoutSessionCustomFieldsDropdown(
    block: PaymentPagesCheckoutSessionCustomFieldsDropdown.Builder.() -> Unit,
): PaymentPagesCheckoutSessionCustomFieldsDropdown = PaymentPagesCheckoutSessionCustomFieldsDropdown.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "PaymentPagesCheckoutSessionCustomFieldsDropdown is missing required property '" + name + "'",
            )
