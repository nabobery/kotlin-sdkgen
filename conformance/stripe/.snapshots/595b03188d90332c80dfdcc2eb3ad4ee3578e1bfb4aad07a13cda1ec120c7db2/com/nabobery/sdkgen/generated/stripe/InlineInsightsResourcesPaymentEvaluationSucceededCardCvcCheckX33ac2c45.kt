...
public sealed class InlineInsightsResourcesPaymentEvaluationSucceededCardCvcCheckX33ac2c45 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineInsightsResourcesPaymentEvaluationSucceededCardCvcCheckX33ac2c45 =
            when (value) {
                Fail.value -> Fail
                Pass.value -> Pass
    ...
    public object Serializer : KSerializer<InlineInsightsResourcesPaymentEvaluationSucceededCardCvcCheckX33ac2c45> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineInsightsResourcesPaymentEvaluationSucceededCardCvcCheckX33ac2c45",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineInsightsResourcesPaymentEvaluationSucceededCardCvcCheckX33ac2c45 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineInsightsResourcesPaymentEvaluationSucceededCardCvcCheckX33ac2c45,
        ) {
