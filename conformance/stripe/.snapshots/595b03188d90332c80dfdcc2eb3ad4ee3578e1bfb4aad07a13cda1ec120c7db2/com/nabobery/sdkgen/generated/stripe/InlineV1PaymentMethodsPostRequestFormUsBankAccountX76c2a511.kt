...
public class InlineV1PaymentMethodsPostRequestFormUsBankAccountX76c2a511(
    public val accountHolderType: InlineV1PaymentMethodsPostRequestFormUsBankAccountAccountHolderTypeXa1ef9ea1? = null,
    public val accountNumber: String? = null,
    public val accountType: InlineV1PaymentMethodsPostRequestFormUsBankAccountAccountTypeXc43a52fe? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1PaymentMethodsPostRequestFormUsBankAccountX76c2a511 =
            InlineV1PaymentMethodsPostRequestFormUsBankAccountX76c2a511(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PaymentMethodsPostRequestFormUsBankAccountX76c2a511 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentMethodsPostRequestFormUsBankAccountX76c2a511> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentMethodsPostRequestFormUsBankAccountX76c2a511 must be a JSON object",
                    )
            return InlineV1PaymentMethodsPostRequestFormUsBankAccountX76c2a511(
                accountHolderType =
                    rawObject["account_holder_type"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentMethodsPostRequestFormUsBankAccountAccountHolderTypeXa1ef9ea1>(
                                it,
                            )
                    },
                ...
                accountType =
                    rawObject["account_type"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentMethodsPostRequestFormUsBankAccountAccountTypeXc43a52fe>(
                                it,
                            )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentMethodsPostRequestFormUsBankAccountX76c2a511,
        ) {
...
public fun inlineV1PaymentMethodsPostRequestFormUsBankAccountX76c2a511(
    block: InlineV1PaymentMethodsPostRequestFormUsBankAccountX76c2a511.Builder.() -> Unit,
): InlineV1PaymentMethodsPostRequestFormUsBankAccountX76c2a511 =
    InlineV1PaymentMethodsPostRequestFormUsBankAccountX76c2a511.build(block)
