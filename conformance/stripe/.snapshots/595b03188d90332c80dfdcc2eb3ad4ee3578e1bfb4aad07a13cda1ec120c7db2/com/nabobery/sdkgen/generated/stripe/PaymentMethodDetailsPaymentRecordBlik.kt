...
public class PaymentMethodDetailsPaymentRecordBlik(
    ...
    public class Builder {
        ...
        public fun build(): PaymentMethodDetailsPaymentRecordBlik =
            PaymentMethodDetailsPaymentRecordBlik(
                buyerId = buyerId,
            )
    }

    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentMethodDetailsPaymentRecordBlik =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentMethodDetailsPaymentRecordBlik> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodDetailsPaymentRecordBlik {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodDetailsPaymentRecordBlik must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentMethodDetailsPaymentRecordBlik,
        ) {
...
public fun paymentMethodDetailsPaymentRecordBlik(
    block: PaymentMethodDetailsPaymentRecordBlik.Builder.() -> Unit,
): PaymentMethodDetailsPaymentRecordBlik = PaymentMethodDetailsPaymentRecordBlik.build(block)
