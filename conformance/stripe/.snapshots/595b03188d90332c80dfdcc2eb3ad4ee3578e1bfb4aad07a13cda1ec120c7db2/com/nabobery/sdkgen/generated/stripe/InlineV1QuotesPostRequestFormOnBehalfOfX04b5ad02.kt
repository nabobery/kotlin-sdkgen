...
public class InlineV1QuotesPostRequestFormOnBehalfOfX04b5ad02 internal constructor(
    ...
    public val inlineV1QuotesPostRequestFormOnBehalfOfAnyOf2X323ed212:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1QuotesPostRequestFormOnBehalfOfAnyOf2X323ed212) {
                json
                    .decodeFromJsonElement<InlineV1QuotesPostRequestFormOnBehalfOfAnyOf2X323ed212>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1QuotesPostRequestFormOnBehalfOfX04b5ad02Branch>
        get() =
            buildSet {
                ...
                if (inspection.matchesInlineV1QuotesPostRequestFormOnBehalfOfAnyOf2X323ed212) {
                    add(
                        InlineV1QuotesPostRequestFormOnBehalfOfX04b5ad02Branch.InlineV1QuotesPostRequestFormOnBehalfOfAnyOf2X323ed212,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1QuotesPostRequestFormOnBehalfOfX04b5ad02 {
            val inspection = inspectInlineV1QuotesPostRequestFormOnBehalfOfX04b5ad02(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1QuotesPostRequestFormOnBehalfOfX04b5ad02NoMatchException(
                    "InlineV1QuotesPostRequestFormOnBehalfOfX04b5ad02 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1QuotesPostRequestFormOnBehalfOfX04b5ad02> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1QuotesPostRequestFormOnBehalfOfX04b5ad02,
        ) {
...
private fun inspectInlineV1QuotesPostRequestFormOnBehalfOfX04b5ad02(
    element: JsonElement,
): InlineV1QuotesPostRequestFormOnBehalfOfX04b5ad02Inspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1QuotesPostRequestFormOnBehalfOfAnyOf2X323ed212 =
        element
            .isJsonDecodable<InlineV1QuotesPostRequestFormOnBehalfOfAnyOf2X323ed212>()
    return InlineV1QuotesPostRequestFormOnBehalfOfX04b5ad02Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1QuotesPostRequestFormOnBehalfOfAnyOf2X323ed212) {
                    add(
                        "InlineV1QuotesPostRequestFormOnBehalfOfAnyOf2X323ed212: value does not match InlineV1QuotesPostRequestFormOnBehalfOfAnyOf2X323ed212",
                    )
                }
            },
    )
