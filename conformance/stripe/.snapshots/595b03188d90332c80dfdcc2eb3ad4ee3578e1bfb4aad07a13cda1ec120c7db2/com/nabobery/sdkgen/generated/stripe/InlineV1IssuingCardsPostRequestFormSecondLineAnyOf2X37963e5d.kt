...
public sealed class InlineV1IssuingCardsPostRequestFormSecondLineAnyOf2X37963e5d {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1IssuingCardsPostRequestFormSecondLineAnyOf2X37963e5d =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1IssuingCardsPostRequestFormSecondLineAnyOf2X37963e5d> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1IssuingCardsPostRequestFormSecondLineAnyOf2X37963e5d",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1IssuingCardsPostRequestFormSecondLineAnyOf2X37963e5d =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingCardsPostRequestFormSecondLineAnyOf2X37963e5d,
        ) {
