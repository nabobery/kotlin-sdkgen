...
public class InlineV1TreasuryFinancialAc862PostRequestFormFeaturesAchXff39d1aa(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TreasuryFinancialAc862PostRequestFormFeaturesAchXff39d1aa =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TreasuryFinancialAc862PostRequestFormFeaturesAchXff39d1aa> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TreasuryFinancialAc862PostRequestFormFeaturesAchXff39d1aa must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TreasuryFinancialAc862PostRequestFormFeaturesAchXff39d1aa,
        ) {
            val jsonEncoder =
...
public fun inlineV1TreasuryFinancialAc862PostRequestFormFeaturesAchXff39d1aa(
    block: InlineV1TreasuryFinancialAc862PostRequestFormFeaturesAchXff39d1aa.Builder.() -> Unit,
): InlineV1TreasuryFinancialAc862PostRequestFormFeaturesAchXff39d1aa =
    InlineV1TreasuryFinancialAc862PostRequestFormFeaturesAchXff39d1aa.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TreasuryFinancialAc862PostRequestFormFeaturesAchXff39d1aa is missing required property '" +
                    name +
                    "'",
            )
