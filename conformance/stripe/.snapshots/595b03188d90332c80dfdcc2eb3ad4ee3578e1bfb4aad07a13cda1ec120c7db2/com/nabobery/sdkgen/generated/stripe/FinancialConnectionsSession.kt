...
public class FinancialConnectionsSession(
     ...
     */
    public val prefetch: List<InlineFinancialConnectionsSessionPrefetchItemX92ddd832>? = null,
    /**
    ...
    public class Builder {
         ...
         * Data features requested to be retrieved upon account creation.
         */
        public var prefetch: List<InlineFinancialConnectionsSessionPrefetchItemX92ddd832>? = null
    ...
    public object Serializer : KSerializer<FinancialConnectionsSession> {
        ...
        override fun deserialize(decoder: Decoder): FinancialConnectionsSession {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("FinancialConnectionsSession must be a JSON object")
            val accounts =
                json.decodeRequired<InlineFinancialConnectionsSessionAccountsX3c0c189f>(
                    rawObject,
                    "accounts",
                )
            ...
            val objectValue =
                json.decodeRequired<InlineFinancialConnectionsSessionObjectValueX4c21bf02>(
                    rawObject,
                    "object",
                )
            val permissions =
                json.decodeRequired<List<InlineFinancialConnectionsSessionPermissionsItemX32c905bb>>(
                    rawObject,
                    "permissions",
                )
            return FinancialConnectionsSession(
                ...
                accountHolder =
                    rawObject["account_holder"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineFinancialConnectionsSessionAccountHolderX5c02a6a9?>(
                                element,
                            )
                        }
                    },
                ...
                filters =
                    rawObject["filters"]?.let {
                        json.decodeFromJsonElement<BankConnectionsResourceLinkAccountSessionFilters>(it)
                    },
                prefetch =
                    rawObject["prefetch"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<List<InlineFinancialConnectionsSessionPrefetchItemX92ddd832>?>(
                                element,
                            )
                        }
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: FinancialConnectionsSession,
        ) {
...
public fun financialConnectionsSession(
    block: FinancialConnectionsSession.Builder.() -> Unit,
): FinancialConnectionsSession = FinancialConnectionsSession.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException("FinancialConnectionsSession is missing required property '" + name + "'")
