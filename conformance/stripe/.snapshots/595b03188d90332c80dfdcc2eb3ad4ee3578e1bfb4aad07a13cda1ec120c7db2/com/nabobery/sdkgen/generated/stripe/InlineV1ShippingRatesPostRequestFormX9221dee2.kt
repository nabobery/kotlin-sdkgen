...
public class InlineV1ShippingRatesPostRequestFormX9221dee2(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1ShippingRatesPostRequestFormX9221dee2 =
            InlineV1ShippingRatesPostRequestFormX9221dee2(
                active = active,
                expand = expand,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1ShippingRatesPostRequestFormX9221dee2 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1ShippingRatesPostRequestFormX9221dee2> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1ShippingRatesPostRequestFormX9221dee2 must be a JSON object",
                    )
            return InlineV1ShippingRatesPostRequestFormX9221dee2(
                ...
                fixedAmount =
                    rawObject["fixed_amount"]?.let {
                        json.decodeFromJsonElement<InlineV1ShippingRatesPostRequestFormFixedAmountX419a059a>(it)
                    },
                metadata =
                    rawObject["metadata"]?.let {
                        json.decodeFromJsonElement<InlineV1ShippingRatesPostRequestFormMetadataX4f9f06a5>(it)
                    },
                taxBehavior =
                    rawObject["tax_behavior"]?.let {
                        json.decodeFromJsonElement<InlineV1ShippingRatesPostRequestFormTaxBehaviorX733e1857>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ShippingRatesPostRequestFormX9221dee2,
        ) {
...
public fun inlineV1ShippingRatesPostRequestFormX9221dee2(
    block: InlineV1ShippingRatesPostRequestFormX9221dee2.Builder.() -> Unit,
): InlineV1ShippingRatesPostRequestFormX9221dee2 = InlineV1ShippingRatesPostRequestFormX9221dee2.build(block)
