...
public sealed class InlineV1InvoicesPostRequestFormPaymentSettingsTransactionTypeX5dd26622 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1InvoicesPostRequestFormPaymentSettingsTransactionTypeX5dd26622 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1InvoicesPostRequestFormPaymentSettingsTransactionTypeX5dd26622> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1InvoicesPostRequestFormPaymentSettingsTransactionTypeX5dd26622",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1InvoicesPostRequestFormPaymentSettingsTransactionTypeX5dd26622 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesPostRequestFormPaymentSettingsTransactionTypeX5dd26622,
        ) {
