...
@Serializable
public data class IssuingDisputeView(
...
public class IssuingDispute(
    ...
    public class Builder {
         ...
         * List of balance transactions associated with the dispute.
         */
        public var balanceTransactions: List<BalanceTransaction>? = null
    ...
    public object Serializer : KSerializer<IssuingDispute> {
        ...
        override fun deserialize(decoder: Decoder): IssuingDispute {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("IssuingDispute must be a JSON object")
            ...
            return IssuingDispute(
                ...
                transaction = transaction,
                balanceTransactions =
                    rawObject["balance_transactions"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<List<BalanceTransaction>?>(element)
                        }
                    },
                lossReason =
                    rawObject["loss_reason"]?.let {
                        json
                            .decodeFromJsonElement<InlineIssuingDisputeLossReasonXaa48fc42>(
                                it,
                            )
                    },
                treasury =
                    rawObject["treasury"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineIssuingDisputeTreasuryXcbdcc676?>(element)
                        }
                    },
            )
        }
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("IssuingDispute is missing required property '" + name + "'")
