...
public class InlineV1AccountsPostRequestFormIndividualVerificationDocumentX62c31ac0(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1AccountsPostRequestFormIndividualVerificationDocumentX62c31ac0 =
            InlineV1AccountsPostRequestFormIndividualVerificationDocumentX62c31ac0(
                back = back,
                front = front,
            )
    }
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1AccountsPostRequestFormIndividualVerificationDocumentX62c31ac0 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1AccountsPostRequestFormIndividualVerificationDocumentX62c31ac0> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountsPostRequestFormIndividualVerificationDocumentX62c31ac0 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPostRequestFormIndividualVerificationDocumentX62c31ac0,
        ) {
            val jsonEncoder =
...
public fun inlineV1AccountsPostRequestFormIndividualVerificationDocumentX62c31ac0(
    block: InlineV1AccountsPostRequestFormIndividualVerificationDocumentX62c31ac0.Builder.() -> Unit,
): InlineV1AccountsPostRequestFormIndividualVerificationDocumentX62c31ac0 =
