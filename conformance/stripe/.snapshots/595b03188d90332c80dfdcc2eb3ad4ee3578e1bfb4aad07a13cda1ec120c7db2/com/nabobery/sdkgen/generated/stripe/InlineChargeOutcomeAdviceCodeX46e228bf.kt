...
public sealed class InlineChargeOutcomeAdviceCodeX46e228bf {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineChargeOutcomeAdviceCodeX46e228bf =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineChargeOutcomeAdviceCodeX46e228bf> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineChargeOutcomeAdviceCodeX46e228bf",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineChargeOutcomeAdviceCodeX46e228bf =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineChargeOutcomeAdviceCodeX46e228bf,
        ) {
