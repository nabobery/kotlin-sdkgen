...
public sealed class InlinePaymentPagesCheckoutSessionTaxIdCollectionRequiredX90344866 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentPagesCheckoutSessionTaxIdCollectionRequiredX90344866 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlinePaymentPagesCheckoutSessionTaxIdCollectionRequiredX90344866> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentPagesCheckoutSessionTaxIdCollectionRequiredX90344866",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePaymentPagesCheckoutSessionTaxIdCollectionRequiredX90344866 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentPagesCheckoutSessionTaxIdCollectionRequiredX90344866,
        ) {
