...
public sealed class InlinePaymentsPrimitivesPaebdbTypeX7b145df9 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentsPrimitivesPaebdbTypeX7b145df9 =
            when (value) {
                Card.value -> Card
    ...
    public object Serializer : KSerializer<InlinePaymentsPrimitivesPaebdbTypeX7b145df9> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentsPrimitivesPaebdbTypeX7b145df9",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePaymentsPrimitivesPaebdbTypeX7b145df9 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentsPrimitivesPaebdbTypeX7b145df9,
        ) {
