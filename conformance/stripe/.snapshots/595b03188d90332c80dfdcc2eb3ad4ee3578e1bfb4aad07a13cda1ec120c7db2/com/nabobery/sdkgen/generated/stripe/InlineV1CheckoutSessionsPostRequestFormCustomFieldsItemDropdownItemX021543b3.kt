...
public class InlineV1CheckoutSessionsPostRequestFormCustomFieldsItemDropdownItemX021543b3(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1CheckoutSessionsPostRequestFormCustomFieldsItemDropdownItemX021543b3 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormCustomFieldsItemDropdownItemX021543b3> {
        override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1CheckoutSessionsPostRequestFormCustomFieldsItemDropdownItemX021543b3 {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CheckoutSessionsPostRequestFormCustomFieldsItemDropdownItemX021543b3 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsPostRequestFormCustomFieldsItemDropdownItemX021543b3,
        ) {
            val jsonEncoder =
...
public fun inlineV1CheckoutSessionsPostRequestFormCustomFieldsItemDropdownItemX021543b3(
    block: InlineV1CheckoutSessionsPostRequestFormCustomFieldsItemDropdownItemX021543b3.Builder.() -> Unit,
): InlineV1CheckoutSessionsPostRequestFormCustomFieldsItemDropdownItemX021543b3 =
    InlineV1CheckoutSessionsPostRequestFormCustomFieldsItemDropdownItemX021543b3.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1CheckoutSessionsPostRequestFormCustomFieldsItemDropdownItemX021543b3 is missing required property '" +
                    name +
                    "'",
            )
