...
public class SourceTransactionPaperCheckData(
    ...
    public class Builder {
        ...
        public fun build(): SourceTransactionPaperCheckData =
    ...
    public object Serializer : KSerializer<SourceTransactionPaperCheckData> {
        ...
        override fun deserialize(decoder: Decoder): SourceTransactionPaperCheckData {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("SourceTransactionPaperCheckData must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: SourceTransactionPaperCheckData,
        ) {
...
public fun sourceTransactionPaperCheckData(
    block: SourceTransactionPaperCheckData.Builder.() -> Unit,
): SourceTransactionPaperCheckData = SourceTransactionPaperCheckData.build(block)
