...
public class Payout(
    ...
    public object Serializer : KSerializer<Payout> {
        ...
        override fun deserialize(decoder: Decoder): Payout {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("Payout must be a JSON object")
            ...
            val reconciliationStatus =
                json.decodeRequired<InlinePayoutReconciliationStatusX2b08164f>(
                    rawObject,
            ...
            return Payout(
                ...
                applicationFee =
                    rawObject["application_fee"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePayoutApplicationFeeX54ffd315?>(element)
                        }
                    },
                ...
                balanceTransaction =
                    rawObject["balance_transaction"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePayoutBalanceTransactionX644e86fe?>(element)
                        }
                    },
                description =
                ...
                destination =
                    rawObject["destination"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlinePayoutDestinationXa1b3c2cf?>(element)
                        }
                    },
                failureBalanceTransaction =
                    rawObject["failure_balance_transaction"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePayoutFailureBalanceTransactionX38dfbc94?>(element)
                        }
                    },
                failureCode =
                ...
                originalPayout =
                    rawObject["original_payout"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlinePayoutOriginalPayoutX84c88c4d?>(element)
                        }
                    },
                payoutMethod =
                    rawObject["payout_method"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                reversedBy =
                    rawObject["reversed_by"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlinePayoutReversedByX25442278?>(element)
                        }
                    },
                statementDescriptor =
                ...
                traceId =
                    rawObject["trace_id"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlinePayoutTraceIdXd4dacdb0?>(element)
                        }
                    },
            )
        }
