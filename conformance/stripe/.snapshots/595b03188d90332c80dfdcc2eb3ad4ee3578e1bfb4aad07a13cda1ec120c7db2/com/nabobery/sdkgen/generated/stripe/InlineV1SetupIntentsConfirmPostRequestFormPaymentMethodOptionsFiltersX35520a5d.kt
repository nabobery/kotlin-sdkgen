...
public class InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsFiltersX35520a5d(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsFiltersX35520a5d =
    ...
    public object Serializer : KSerializer<InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsFiltersX35520a5d> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsFiltersX35520a5d must be a JSON object",
                    )
            return InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsFiltersX35520a5d(
                accountSubcategories =
                    rawObject["account_subcategories"]?.let {
                        json
                            .decodeFromJsonElement<List<InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsItemXaf5eee67>>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsFiltersX35520a5d,
        ) {
            val jsonEncoder =
...
public fun inlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsFiltersX35520a5d(
    block: InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsFiltersX35520a5d.Builder.() -> Unit,
): InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsFiltersX35520a5d =
    InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsFiltersX35520a5d.build(block)
