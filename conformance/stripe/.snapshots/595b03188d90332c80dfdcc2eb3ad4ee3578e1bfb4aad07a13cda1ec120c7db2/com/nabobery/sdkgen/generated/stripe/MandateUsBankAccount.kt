...
public class MandateUsBankAccount(
    ...
    public class Builder {
        ...
        public fun build(): MandateUsBankAccount =
        ...
        override fun deserialize(decoder: Decoder): MandateUsBankAccount {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("MandateUsBankAccount must be a JSON object")
            return MandateUsBankAccount(
                collectionMethod =
                    rawObject["collection_method"]?.let {
                        json.decodeFromJsonElement<InlineMandateUsBankAccountCollectionMethodXad379101>(it)
                    },
            )
        }
...
public fun mandateUsBankAccount(block: MandateUsBankAccount.Builder.() -> Unit): MandateUsBankAccount =
    MandateUsBankAccount.build(block)
