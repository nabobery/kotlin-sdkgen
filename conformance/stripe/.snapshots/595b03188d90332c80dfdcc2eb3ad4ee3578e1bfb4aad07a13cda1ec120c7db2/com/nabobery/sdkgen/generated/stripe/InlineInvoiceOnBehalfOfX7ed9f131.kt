...
public class InlineInvoiceOnBehalfOfX7ed9f131 internal constructor(
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineInvoiceOnBehalfOfX7ed9f131 {
            val inspection = inspectInlineInvoiceOnBehalfOfX7ed9f131(raw)
            if (inspection.matchCount == 0) {
                throw InlineInvoiceOnBehalfOfX7ed9f131NoMatchException(
                    "InlineInvoiceOnBehalfOfX7ed9f131 matched 0 branches: " + inspection.failures.joinToString("; "),
                )
            }
    ...
    public object Serializer : KSerializer<InlineInvoiceOnBehalfOfX7ed9f131> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineInvoiceOnBehalfOfX7ed9f131,
        ) {
