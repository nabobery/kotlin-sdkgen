...
public class InlineV1PaymentMethodConfigurationsPostRequestFormSepaDebitX2f37b4da(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1PaymentMethodConfigurationsPostRequestFormSepaDebitX2f37b4da =
            InlineV1PaymentMethodConfigurationsPostRequestFormSepaDebitX2f37b4da(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentMethodConfigurationsPostRequestFormSepaDebitX2f37b4da = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentMethodConfigurationsPostRequestFormSepaDebitX2f37b4da> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentMethodConfigurationsPostRequestFormSepaDebitX2f37b4da must be a JSON object",
                    )
            return InlineV1PaymentMethodConfigurationsPostRequestFormSepaDebitX2f37b4da(
                displayPreference =
                    rawObject["display_preference"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentMethodConfidc49PostRequestFormSepaDebitDisplayPreferenceX7b7125b2>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentMethodConfigurationsPostRequestFormSepaDebitX2f37b4da,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentMethodConfigurationsPostRequestFormSepaDebitX2f37b4da(
    block: InlineV1PaymentMethodConfigurationsPostRequestFormSepaDebitX2f37b4da.Builder.() -> Unit,
): InlineV1PaymentMethodConfigurationsPostRequestFormSepaDebitX2f37b4da =
    InlineV1PaymentMethodConfigurationsPostRequestFormSepaDebitX2f37b4da.build(block)
