...
public sealed class InlineV1SetupIntentsConfirmPostRequestFormAmountIncludesIofX5589d8f2 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1SetupIntentsConfirmPostRequestFormAmountIncludesIofX5589d8f2 =
            when (value) {
                Always.value -> Always
                Never.value -> Never
    ...
    public object Serializer : KSerializer<InlineV1SetupIntentsConfirmPostRequestFormAmountIncludesIofX5589d8f2> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1SetupIntentsConfirmPostRequestFormAmountIncludesIofX5589d8f2",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1SetupIntentsConfirmPostRequestFormAmountIncludesIofX5589d8f2 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SetupIntentsConfirmPostRequestFormAmountIncludesIofX5589d8f2,
        ) {
