...
public sealed class InlineV1BalanceSettingsPostRequestFormPaymentsPayoutsAnyOf2X0bfb8f34 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1BalanceSettingsPostRequestFormPaymentsPayoutsAnyOf2X0bfb8f34 =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1BalanceSettingsPostRequestFormPaymentsPayoutsAnyOf2X0bfb8f34> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1BalanceSettingsPostRequestFormPaymentsPayoutsAnyOf2X0bfb8f34",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1BalanceSettingsPostRequestFormPaymentsPayoutsAnyOf2X0bfb8f34 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1BalanceSettingsPostRequestFormPaymentsPayoutsAnyOf2X0bfb8f34,
        ) {
