...
public class InlineV1InvoicesCreatePreviewPostRequestFormBillUntilX7a36859d(
    ...
    public val duration: InlineV1InvoicesCreatePreviewPostRequestFormSubscriptionDetailsDurationXc349d5eb? = null,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1InvoicesCreatePreviewPostRequestFormBillUntilX7a36859d =
    ...
    public object Serializer : KSerializer<InlineV1InvoicesCreatePreviewPostRequestFormBillUntilX7a36859d> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1InvoicesCreatePreviewPostRequestFormBillUntilX7a36859d {
            val jsonDecoder =
                decoder.requireJsonDecoder(
                    "InlineV1InvoicesCreatePreviewPostRequestFormBillUntilX7a36859d",
                )
            val json = jsonDecoder.json
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1InvoicesCreatePreviewPostRequestFormBillUntilX7a36859d must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineV1InvoicesCreatePreviewPostRequestFormSubscriptionDetailsTypeX73616917>(
                    rawObject,
                    "type",
                )
            return InlineV1InvoicesCreatePreviewPostRequestFormBillUntilX7a36859d(
                ...
                duration =
                    rawObject["duration"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1InvoicesCreatePreviewPostRequestFormSubscriptionDetailsDurationXc349d5eb>(
                                it,
                            )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesCreatePreviewPostRequestFormBillUntilX7a36859d,
        ) {
            val jsonEncoder =
...
public fun inlineV1InvoicesCreatePreviewPostRequestFormBillUntilX7a36859d(
    block: InlineV1InvoicesCreatePreviewPostRequestFormBillUntilX7a36859d.Builder.() -> Unit,
): InlineV1InvoicesCreatePreviewPostRequestFormBillUntilX7a36859d =
    InlineV1InvoicesCreatePreviewPostRequestFormBillUntilX7a36859d.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1InvoicesCreatePreviewPostRequestFormBillUntilX7a36859d is missing required property '" + name +
                    "'",
            )
