...
public class SourceTypeAuBecsDebit(
    ...
    public class Builder {
        ...
        public fun build(): SourceTypeAuBecsDebit =
        ...
        override fun deserialize(decoder: Decoder): SourceTypeAuBecsDebit {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("SourceTypeAuBecsDebit must be a JSON object")
...
public fun sourceTypeAuBecsDebit(block: SourceTypeAuBecsDebit.Builder.() -> Unit): SourceTypeAuBecsDebit =
    SourceTypeAuBecsDebit.build(block)
