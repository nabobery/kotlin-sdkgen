...
public sealed class InlineTreasuryFinancialAccountPendingFeaturesItemXf9eb56f9 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineTreasuryFinancialAccountPendingFeaturesItemXf9eb56f9 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineTreasuryFinancialAccountPendingFeaturesItemXf9eb56f9> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineTreasuryFinancialAccountPendingFeaturesItemXf9eb56f9",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineTreasuryFinancialAccountPendingFeaturesItemXf9eb56f9 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineTreasuryFinancialAccountPendingFeaturesItemXf9eb56f9,
        ) {
