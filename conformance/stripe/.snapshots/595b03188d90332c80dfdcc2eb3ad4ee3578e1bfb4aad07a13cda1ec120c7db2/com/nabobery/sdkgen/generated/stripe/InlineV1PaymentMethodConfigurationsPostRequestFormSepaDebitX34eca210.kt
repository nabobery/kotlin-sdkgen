...
public class InlineV1PaymentMethodConfigurationsPostRequestFormSepaDebitX34eca210(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1PaymentMethodConfigurationsPostRequestFormSepaDebitX34eca210 =
            InlineV1PaymentMethodConfigurationsPostRequestFormSepaDebitX34eca210(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentMethodConfigurationsPostRequestFormSepaDebitX34eca210 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentMethodConfigurationsPostRequestFormSepaDebitX34eca210> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentMethodConfigurationsPostRequestFormSepaDebitX34eca210 must be a JSON object",
                    )
            return InlineV1PaymentMethodConfigurationsPostRequestFormSepaDebitX34eca210(
                displayPreference =
                    rawObject["display_preference"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentMethodConfidc49PostRequestFormSepaDebitDisplayPreferenceX182c5666>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentMethodConfigurationsPostRequestFormSepaDebitX34eca210,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentMethodConfigurationsPostRequestFormSepaDebitX34eca210(
    block: InlineV1PaymentMethodConfigurationsPostRequestFormSepaDebitX34eca210.Builder.() -> Unit,
): InlineV1PaymentMethodConfigurationsPostRequestFormSepaDebitX34eca210 =
