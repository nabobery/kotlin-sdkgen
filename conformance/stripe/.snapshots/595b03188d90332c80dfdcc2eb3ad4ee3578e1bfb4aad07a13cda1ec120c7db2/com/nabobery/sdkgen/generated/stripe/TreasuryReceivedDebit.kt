...
public class TreasuryReceivedDebit(
    ...
    public object Serializer : KSerializer<TreasuryReceivedDebit> {
        ...
        override fun deserialize(decoder: Decoder): TreasuryReceivedDebit {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("TreasuryReceivedDebit must be a JSON object")
            ...
            return TreasuryReceivedDebit(
                ...
                failureCode =
                    rawObject["failure_code"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineTreasuryReceivedDebitFailureCodeXd516aadd?>(element)
                        }
                    },
                financialAccount =
                ...
                initiatingPaymentMethodDetails =
                    rawObject["initiating_payment_method_details"]?.let {
                        json
                            .decodeFromJsonElement<TreasurySharedResourceInitiatingPaymentMethodDetailsInitiatingPaymentMethodDetails>(
                                it,
                            )
                    },
                reversalDetails =
                    rawObject["reversal_details"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineTreasuryReceivedDebitReversalDetailsX208cee01?>(element)
                        }
                    },
                transaction =
                    rawObject["transaction"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineTreasuryReceivedDebitTransactionX78b9e912?>(element)
                        }
                    },
            )
        }
...
public fun treasuryReceivedDebit(block: TreasuryReceivedDebit.Builder.() -> Unit): TreasuryReceivedDebit =
    TreasuryReceivedDebit.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("TreasuryReceivedDebit is missing required property '" + name + "'")
