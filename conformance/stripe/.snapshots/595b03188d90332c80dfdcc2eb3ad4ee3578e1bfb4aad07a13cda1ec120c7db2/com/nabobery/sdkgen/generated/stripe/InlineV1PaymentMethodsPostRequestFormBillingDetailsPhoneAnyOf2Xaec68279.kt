...
public sealed class InlineV1PaymentMethodsPostRequestFormBillingDetailsPhoneAnyOf2Xaec68279 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1PaymentMethodsPostRequestFormBillingDetailsPhoneAnyOf2Xaec68279 =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1PaymentMethodsPostRequestFormBillingDetailsPhoneAnyOf2Xaec68279> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1PaymentMethodsPostRequestFormBillingDetailsPhoneAnyOf2Xaec68279",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1PaymentMethodsPostRequestFormBillingDetailsPhoneAnyOf2Xaec68279 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentMethodsPostRequestFormBillingDetailsPhoneAnyOf2Xaec68279,
        ) {
