...
public class InlineIssuingTransactionCardXb7a677c1 internal constructor(
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineIssuingTransactionCardXb7a677c1 {
            val inspection = inspectInlineIssuingTransactionCardXb7a677c1(raw)
            if (inspection.matchCount == 0) {
                throw InlineIssuingTransactionCardXb7a677c1NoMatchException(
                    "InlineIssuingTransactionCardXb7a677c1 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineIssuingTransactionCardXb7a677c1> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineIssuingTransactionCardXb7a677c1,
        ) {
...
private fun inspectInlineIssuingTransactionCardXb7a677c1(
    element: JsonElement,
): InlineIssuingTransactionCardXb7a677c1Inspection {
