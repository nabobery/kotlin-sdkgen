...
public class InlineV1CheckoutSessionsPostRequestFormSubscriptionDataX72b0f8c5(
    ...
    public val billingCycleAnchorConfig: InlineV1CheckoutSessionsPostRequestFormBillingCycleAnchorConfigX06b36629? = null,
    public val billingMode: InlineV1CheckoutSessionsPostRequestFormSubscriptionDataBillingModeXd60ebc66? = null,
    public val defaultTaxRates: List<String>? = null,
    public val description: String? = null,
    public val invoiceSettings: InlineV1CheckoutSessionsPostRequestFormSubscriptionDataInvoiceSettingsX1a0222bd? = null,
    ...
    public val prorationBehavior: InlineV1CheckoutSessionsPostRequestFormProrationBehaviorXd7bc27d7? = null,
    public val transferData: InlineV1CheckoutSessionsPostRequestFormSubscriptionDataTransferDataX26f9cdcf? = null,
    public val trialEnd: Int? = null,
    public val trialPeriodDays: Int? = null,
    public val trialSettings: InlineV1CheckoutSessionsPostRequestFormSubscriptionDataTrialSettingsX3ed2fa0f? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1CheckoutSessionsPostRequestFormSubscriptionDataX72b0f8c5 =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1CheckoutSessionsPostRequestFormSubscriptionDataX72b0f8c5 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormSubscriptionDataX72b0f8c5> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CheckoutSessionsPostRequestFormSubscriptionDataX72b0f8c5 must be a JSON object",
                    )
            return InlineV1CheckoutSessionsPostRequestFormSubscriptionDataX72b0f8c5(
                ...
                billingCycleAnchorConfig =
                    rawObject["billing_cycle_anchor_config"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormBillingCycleAnchorConfigX06b36629>(
                                it,
                            )
                    },
                billingMode =
                    rawObject["billing_mode"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormSubscriptionDataBillingModeXd60ebc66>(
                                it,
                            )
                    },
                defaultTaxRates =
                ...
                invoiceSettings =
                    rawObject["invoice_settings"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormSubscriptionDataInvoiceSettingsX1a0222bd>(
                                it,
                            )
                    },
                ...
                pendingInvoiceItemInterval =
                    rawObject["pending_invoice_item_interval"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormPendingInvoiceItemIne05dX50036124>(
                                it,
                            )
                    },
                prorationBehavior =
                    rawObject["proration_behavior"]?.let {
                        json.decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormProrationBehaviorXd7bc27d7>(
                            it,
                        )
                    },
                transferData =
                    rawObject["transfer_data"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormSubscriptionDataTransferDataX26f9cdcf>(
                                it,
                            )
                    },
                ...
                trialSettings =
                    rawObject["trial_settings"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormSubscriptionDataTrialSettingsX3ed2fa0f>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsPostRequestFormSubscriptionDataX72b0f8c5,
        ) {
            val jsonEncoder =
...
public fun inlineV1CheckoutSessionsPostRequestFormSubscriptionDataX72b0f8c5(
    block: InlineV1CheckoutSessionsPostRequestFormSubscriptionDataX72b0f8c5.Builder.() -> Unit,
): InlineV1CheckoutSessionsPostRequestFormSubscriptionDataX72b0f8c5 =
