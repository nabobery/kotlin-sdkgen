...
public class InlineLegalEntityPersonVerificationDocumentBackXd6f30a0c internal constructor(
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineLegalEntityPersonVerificationDocumentBackXd6f30a0cBranch.Branch1,
                    )
                }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineLegalEntityPersonVerificationDocumentBackXd6f30a0c {
            val inspection = inspectInlineLegalEntityPersonVerificationDocumentBackXd6f30a0c(raw)
            if (inspection.matchCount == 0) {
                throw InlineLegalEntityPersonVerificationDocumentBackXd6f30a0cNoMatchException(
                    "InlineLegalEntityPersonVerificationDocumentBackXd6f30a0c matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineLegalEntityPersonVerificationDocumentBackXd6f30a0c> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineLegalEntityPersonVerificationDocumentBackXd6f30a0c,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineLegalEntityPersonVerificationDocumentBackXd6f30a0c",
...
private fun inspectInlineLegalEntityPersonVerificationDocumentBackXd6f30a0c(
    element: JsonElement,
): InlineLegalEntityPersonVerificationDocumentBackXd6f30a0cInspection {
