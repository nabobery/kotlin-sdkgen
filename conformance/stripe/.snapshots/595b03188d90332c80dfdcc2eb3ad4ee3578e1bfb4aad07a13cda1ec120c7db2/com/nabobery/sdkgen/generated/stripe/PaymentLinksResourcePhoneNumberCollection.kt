...
public class PaymentLinksResourcePhoneNumberCollection(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentLinksResourcePhoneNumberCollection =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentLinksResourcePhoneNumberCollection> {
        ...
        override fun deserialize(decoder: Decoder): PaymentLinksResourcePhoneNumberCollection {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentLinksResourcePhoneNumberCollection must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentLinksResourcePhoneNumberCollection,
        ) {
...
public fun paymentLinksResourcePhoneNumberCollection(
    block: PaymentLinksResourcePhoneNumberCollection.Builder.() -> Unit,
): PaymentLinksResourcePhoneNumberCollection = PaymentLinksResourcePhoneNumberCollection.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "PaymentLinksResourcePhoneNumberCollection is missing required property '" + name + "'",
            )
