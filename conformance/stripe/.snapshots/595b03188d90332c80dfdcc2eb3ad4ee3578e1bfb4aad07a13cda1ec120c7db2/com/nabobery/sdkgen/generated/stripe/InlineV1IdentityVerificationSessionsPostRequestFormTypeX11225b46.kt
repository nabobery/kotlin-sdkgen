...
public sealed class InlineV1IdentityVerificationSessionsPostRequestFormTypeX11225b46 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1IdentityVerificationSessionsPostRequestFormTypeX11225b46 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1IdentityVerificationSessionsPostRequestFormTypeX11225b46> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1IdentityVerificationSessionsPostRequestFormTypeX11225b46",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1IdentityVerificationSessionsPostRequestFormTypeX11225b46 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IdentityVerificationSessionsPostRequestFormTypeX11225b46,
        ) {
