...
public sealed class InlinePaymentPagesCheckoutSessionBrandingSettingsIconTypeXcf20a31b {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentPagesCheckoutSessionBrandingSettingsIconTypeXcf20a31b =
            when (value) {
                File.value -> File
                Url.value -> Url
    ...
    public object Serializer : KSerializer<InlinePaymentPagesCheckoutSessionBrandingSettingsIconTypeXcf20a31b> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentPagesCheckoutSessionBrandingSettingsIconTypeXcf20a31b",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePaymentPagesCheckoutSessionBrandingSettingsIconTypeXcf20a31b =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentPagesCheckoutSessionBrandingSettingsIconTypeXcf20a31b,
        ) {
