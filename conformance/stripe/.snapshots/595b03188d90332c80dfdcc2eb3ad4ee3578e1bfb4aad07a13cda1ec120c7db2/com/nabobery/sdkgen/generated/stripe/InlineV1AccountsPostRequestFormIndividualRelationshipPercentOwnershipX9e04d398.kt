...
internal data class InlineV1AccountsPostRequestFormIndividualRelationshipPercentOwnershipX9e04d398Inspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1AccountsPostRequestFormIndividualRelationshipAnyOf2X6916a03f,
            ).count { it }
}
...
public class InlineV1AccountsPostRequestFormIndividualRelationshipPercentOwnershipX9e04d398 internal constructor(
    ...
    private val inspection: InlineV1AccountsPostRequestFormIndividualRelationshipPercentOwnershipX9e04d398Inspection,
) {
    ...
    public val inlineV1AccountsPostRequestFormIndividualRelationshipAnyOf2X6916a03f:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1AccountsPostRequestFormIndividualRelationshipAnyOf2X6916a03f) {
                json
                    .decodeFromJsonElement<InlineV1AccountsPostRequestFormIndividualRelationshipAnyOf2X6916a03f>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1AccountsPostRequestFormIndividualRelationshipPercentOwnershipX9e04d398Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1AccountsPostRequestFormIndividualRelationshipAnyOf2X6916a03f) {
                    add(
                        InlineV1AccountsPostRequestFormIndividualRelationshipPercentOwnershipX9e04d398Branch.InlineV1AccountsPostRequestFormIndividualRelationshipAnyOf2X6916a03f,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1AccountsPostRequestFormIndividualRelationshipPercentOwnershipX9e04d398 {
            val inspection = inspectInlineV1AccountsPostRequestFormIndividualRelationshipPercentOwnershipX9e04d398(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1AccountsPostRequestFormIndividualRelationshipPercentOwnershipX9e04d398NoMatchException(
                    "InlineV1AccountsPostRequestFormIndividualRelationshipPercentOwnershipX9e04d398 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1AccountsPostRequestFormIndividualRelationshipPercentOwnershipX9e04d398> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPostRequestFormIndividualRelationshipPercentOwnershipX9e04d398,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1AccountsPostRequestFormIndividualRelationshipPercentOwnershipX9e04d398",
...
private fun inspectInlineV1AccountsPostRequestFormIndividualRelationshipPercentOwnershipX9e04d398(
    element: JsonElement,
    ...
    val matchesInlineV1AccountsPostRequestFormIndividualRelationshipAnyOf2X6916a03f =
        element
            .isJsonDecodable<InlineV1AccountsPostRequestFormIndividualRelationshipAnyOf2X6916a03f>()
    return InlineV1AccountsPostRequestFormIndividualRelationshipPercentOwnershipX9e04d398Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1AccountsPostRequestFormIndividualRelationshipAnyOf2X6916a03f) {
                    add(
                        "InlineV1AccountsPostRequestFormIndividualRelationshipAnyOf2X6916a03f: value does not match InlineV1AccountsPostRequestFormIndividualRelationshipAnyOf2X6916a03f",
                    )
                }
            },
    )
