...
public sealed class InlineIssuingTokenStatusXc4e959df {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineIssuingTokenStatusXc4e959df =
            when (value) {
                Active.value -> Active
    ...
    public object Serializer : KSerializer<InlineIssuingTokenStatusXc4e959df> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineIssuingTokenStatusXc4e959df",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineIssuingTokenStatusXc4e959df =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineIssuingTokenStatusXc4e959df,
        ) {
