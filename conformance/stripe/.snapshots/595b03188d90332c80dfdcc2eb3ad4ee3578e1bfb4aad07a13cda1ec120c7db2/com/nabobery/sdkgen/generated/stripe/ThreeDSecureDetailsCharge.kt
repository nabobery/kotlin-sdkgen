...
public data class ThreeDSecureDetailsChargeView(
    ...
    public val electronicCommerceIndicator: InlineThreeDSecureDetailsChargeElectronicCommerceIndicatorXfc9e735a? = null,
...
public class ThreeDSecureDetailsCharge(
    ...
    public class Builder {
        ...
        public fun build(): ThreeDSecureDetailsCharge =
    ...
    public object Serializer : KSerializer<ThreeDSecureDetailsCharge> {
        ...
        override fun deserialize(decoder: Decoder): ThreeDSecureDetailsCharge {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("ThreeDSecureDetailsCharge must be a JSON object")
                ...
                authenticationFlow =
                    rawObject["authentication_flow"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineThreeDSecureDetailsChargeAuthenticationFlowX33b6c32f?>(
                                element,
                            )
                        }
                    },
                electronicCommerceIndicator =
                    rawObject["electronic_commerce_indicator"]?.let { element ->
                        if (element ==
                            ...
                            json
                                .decodeFromJsonElement<InlineThreeDSecureDetailsChargeElectronicCommerceIndicatorXfc9e735a?>(
                                    element,
                                )
                        }
                    },
                exemptionIndicator =
                    rawObject["exemption_indicator"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineThreeDSecureDetailsChargeExemptionIndicatorX4cc808da?>(
                                element,
                            )
                        }
                    },
                exemptionIndicatorApplied =
                    rawObject["exemption_indicator_applied"]?.let {
                        json
                ...
                result =
                    rawObject["result"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineThreeDSecureDetailsChargeResultX2295bf98?>(element)
                        }
                    },
                resultReason =
                    rawObject["result_reason"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineThreeDSecureDetailsChargeResultReasonX694e3302?>(element)
                        }
                    },
                transactionId =
                ...
                version =
                    rawObject["version"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineThreeDSecureDetailsChargeVersionX5b322869?>(element)
                        }
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: ThreeDSecureDetailsCharge,
        ) {
...
public fun threeDSecureDetailsCharge(block: ThreeDSecureDetailsCharge.Builder.() -> Unit): ThreeDSecureDetailsCharge =
    ThreeDSecureDetailsCharge.build(block)
