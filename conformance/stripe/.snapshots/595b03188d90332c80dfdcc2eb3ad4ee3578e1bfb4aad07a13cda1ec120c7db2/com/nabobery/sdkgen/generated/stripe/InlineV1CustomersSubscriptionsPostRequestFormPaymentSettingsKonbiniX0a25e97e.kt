...
internal data class InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsKonbiniX0a25e97eInspection(
    ...
    public val matchesInlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsAnyOf2Xd056d128: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsAnyOf2Xd056d128,
            ).count {
                it
            }
}
...
public class InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsKonbiniX0a25e97e internal constructor(
    ...
    private val inspection: InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsKonbiniX0a25e97eInspection,
) {
    ...
    public val inlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsAnyOf2Xd056d128:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsAnyOf2Xd056d128) {
                json
                    .decodeFromJsonElement<InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsAnyOf2Xd056d128>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsKonbiniX0a25e97eBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsAnyOf2Xd056d128) {
                    add(
                        InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsKonbiniX0a25e97eBranch.InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsAnyOf2Xd056d128,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsKonbiniX0a25e97e {
            val inspection = inspectInlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsKonbiniX0a25e97e(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsKonbiniX0a25e97eNoMatchException(
                    "InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsKonbiniX0a25e97e matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsKonbiniX0a25e97e> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsKonbiniX0a25e97e,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsKonbiniX0a25e97e",
...
private fun inspectInlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsKonbiniX0a25e97e(
    element: JsonElement,
): InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsKonbiniX0a25e97eInspection {
    val matchesBranch1 = element.isJsonDecodable<JsonObject>()
    val matchesInlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsAnyOf2Xd056d128 =
        element
            .isJsonDecodable<InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsAnyOf2Xd056d128>()
    return InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsKonbiniX0a25e97eInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsAnyOf2Xd056d128) {
                    add(
                        "InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsAnyOf2Xd056d128: value does not match InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsAnyOf2Xd056d128",
                    )
                }
            },
    )
