...
public sealed class InlineRevolutPayUnderlyingPaymentMethodFundingDetailsTypeX7f0cf853 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineRevolutPayUnderlyingPaymentMethodFundingDetailsTypeX7f0cf853 =
            when (value) {
                Card.value -> Card
    ...
    public object Serializer : KSerializer<InlineRevolutPayUnderlyingPaymentMethodFundingDetailsTypeX7f0cf853> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineRevolutPayUnderlyingPaymentMethodFundingDetailsTypeX7f0cf853",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineRevolutPayUnderlyingPaymentMethodFundingDetailsTypeX7f0cf853 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineRevolutPayUnderlyingPaymentMethodFundingDetailsTypeX7f0cf853,
        ) {
