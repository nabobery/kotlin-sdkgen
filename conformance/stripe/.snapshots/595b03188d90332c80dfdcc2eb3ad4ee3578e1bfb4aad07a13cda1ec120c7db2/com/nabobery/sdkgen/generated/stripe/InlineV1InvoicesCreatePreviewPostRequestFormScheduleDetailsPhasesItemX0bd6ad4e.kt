...
public class InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesItemX0bd6ad4e(
    ...
    public val automaticTax: InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsAutomaticTaxX0eb98988? = null,
    public val billingCycleAnchor: InlineV1InvoicesCreatePreviewPostRequestFormBillingCycleAnchorX57f0df0d? = null,
    public val billingThresholds: InlineV1InvoicesCreatePreviewPostRequestFormBillingThresholdsXdd3516ec? = null,
    public val collectionMethod: InlineV1InvoicesCreatePreviewPostRequestFormCollectionMethodX4a6e76ea? = null,
    public val defaultPaymentMethod: String? = null,
    public val defaultTaxRates: InlineV1InvoicesCreatePreviewPostRequestFormDefaultTaxRatesX58684e98? = null,
    public val description: InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsDescriptionX7a0440a8? = null,
    public val discounts: InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsDiscountsX0522b826? = null,
    public val duration: InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsDurationX9d9dc670? = null,
    public val endDate: InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsEndDateX467b95e3? = null,
    public val invoiceSettings: InlineV1InvoicesCreatePreviewPostRequestFormInvoiceSettingsXfdd1b9d9? = null,
    public val metadata: Map<String, String>? = null,
    public val onBehalfOf: String? = null,
    public val prorationBehavior: InlineV1InvoicesCreatePreviewPostRequestFormProrationBehaviorX5d5993e1? = null,
    public val startDate: InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsStartDateXc1a7f0b9? = null,
    public val transferData: InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsTransferDataXa0b383da? = null,
    public val trial: Boolean? = null,
    public val trialEnd: InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsTrialEndX2b7a8305? = null,
) {
    public val items:
    ...
    public object Serializer : KSerializer<InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesItemX0bd6ad4e> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesItemX0bd6ad4e must be a JSON object",
                    )
            val items =
                json
                    .decodeRequired<List<InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesItemX73822a73>>(
                        rawObject,
                        "items",
                    )
            return InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesItemX0bd6ad4e(
                ...
                addInvoiceItems =
                    rawObject["add_invoice_items"]?.let {
                        json
                            .decodeFromJsonElement<List<InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesItemXf5e68c73>>(
                                it,
                            )
                    },
                ...
                automaticTax =
                    rawObject["automatic_tax"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsAutomaticTaxX0eb98988>(
                                it,
                            )
                    },
                billingCycleAnchor =
                    rawObject["billing_cycle_anchor"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1InvoicesCreatePreviewPostRequestFormBillingCycleAnchorX57f0df0d>(
                                it,
                            )
                    },
                billingThresholds =
                    rawObject["billing_thresholds"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1InvoicesCreatePreviewPostRequestFormBillingThresholdsXdd3516ec>(
                                it,
                            )
                    },
                collectionMethod =
                    rawObject["collection_method"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1InvoicesCreatePreviewPostRequestFormCollectionMethodX4a6e76ea>(
                                it,
                            )
                    },
                ...
                defaultTaxRates =
                    rawObject["default_tax_rates"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1InvoicesCreatePreviewPostRequestFormDefaultTaxRatesX58684e98>(
                                it,
                            )
                    },
                description =
                    rawObject["description"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsDescriptionX7a0440a8>(
                                it,
                            )
                    },
                discounts =
                    rawObject["discounts"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsDiscountsX0522b826>(
                                it,
                            )
                    },
                duration =
                    rawObject["duration"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsDurationX9d9dc670>(
                                it,
                            )
                    },
                endDate =
                    rawObject["end_date"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsEndDateX467b95e3>(
                                it,
                            )
                    },
                invoiceSettings =
                    rawObject["invoice_settings"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1InvoicesCreatePreviewPostRequestFormInvoiceSettingsXfdd1b9d9>(
                                it,
                            )
                    },
                metadata =
                ...
                prorationBehavior =
                    rawObject["proration_behavior"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1InvoicesCreatePreviewPostRequestFormProrationBehaviorX5d5993e1>(
                                it,
                            )
                    },
                startDate =
                    rawObject["start_date"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsStartDateXc1a7f0b9>(
                                it,
                            )
                    },
                transferData =
                    rawObject["transfer_data"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsTransferDataXa0b383da>(
                                it,
                            )
                    },
                ...
                trialEnd =
                    rawObject["trial_end"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsTrialEndX2b7a8305>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesItemX0bd6ad4e,
        ) {
            val jsonEncoder =
...
public fun inlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesItemX0bd6ad4e(
    block: InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesItemX0bd6ad4e.Builder.() -> Unit,
): InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesItemX0bd6ad4e =
    InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesItemX0bd6ad4e.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPhasesItemX0bd6ad4e is missing required property '" +
                    name +
                    "'",
            )
