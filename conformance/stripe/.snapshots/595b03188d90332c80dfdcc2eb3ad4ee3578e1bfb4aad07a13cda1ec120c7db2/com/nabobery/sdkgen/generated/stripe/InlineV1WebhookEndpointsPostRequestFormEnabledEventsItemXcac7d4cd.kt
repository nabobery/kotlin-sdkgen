...
public sealed class InlineV1WebhookEndpointsPostRequestFormEnabledEventsItemXcac7d4cd {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1WebhookEndpointsPostRequestFormEnabledEventsItemXcac7d4cd =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1WebhookEndpointsPostRequestFormEnabledEventsItemXcac7d4cd> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1WebhookEndpointsPostRequestFormEnabledEventsItemXcac7d4cd",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1WebhookEndpointsPostRequestFormEnabledEventsItemXcac7d4cd =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1WebhookEndpointsPostRequestFormEnabledEventsItemXcac7d4cd,
        ) {
