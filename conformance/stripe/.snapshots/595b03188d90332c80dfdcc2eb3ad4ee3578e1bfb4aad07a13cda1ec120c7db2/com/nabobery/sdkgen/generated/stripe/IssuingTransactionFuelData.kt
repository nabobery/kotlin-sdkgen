...
public class IssuingTransactionFuelData(
    ...
    public object Serializer : KSerializer<IssuingTransactionFuelData> {
        ...
        override fun deserialize(decoder: Decoder): IssuingTransactionFuelData {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("IssuingTransactionFuelData must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: IssuingTransactionFuelData,
        ) {
...
public fun issuingTransactionFuelData(
    block: IssuingTransactionFuelData.Builder.() -> Unit,
): IssuingTransactionFuelData = IssuingTransactionFuelData.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException("IssuingTransactionFuelData is missing required property '" + name + "'")
