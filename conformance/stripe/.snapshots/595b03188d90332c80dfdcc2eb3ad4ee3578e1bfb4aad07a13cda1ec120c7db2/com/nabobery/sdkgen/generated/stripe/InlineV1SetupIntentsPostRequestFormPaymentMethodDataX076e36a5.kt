...
public class InlineV1SetupIntentsPostRequestFormPaymentMethodDataX076e36a5(
    ...
    public val acssDebit: InlineV1SetupIntentsPostRequestFormPaymentMethodDataAcssDebitXd5c92856? = null,
    public val affirm: JsonObject? = null,
    public val afterpayClearpay: JsonObject? = null,
    public val alipay: JsonObject? = null,
    public val allowRedisplay: InlineV1SetupIntentsPostRequestFormPaymentMethodDataAllowRedisplayX6ba4c1e4? = null,
    public val alma: JsonObject? = null,
    public val amazonPay: JsonObject? = null,
    public val auBecsDebit: InlineV1SetupIntentsPostRequestFormPaymentMethodDataAuBecsDebitX31fb309e? = null,
    public val bacsDebit: InlineV1SetupIntentsPostRequestFormPaymentMethodDataBacsDebitX6f66f016? = null,
    public val bancontact: JsonObject? = null,
    public val billie: JsonObject? = null,
    public val billingDetails: InlineV1SetupIntentsPostRequestFormPaymentMethodDataBillingDetailsX5bed1b10? = null,
    ...
    public val naverPay: InlineV1SetupIntentsPostRequestFormPaymentMethodDataNaverPayXd7447413? = null,
    public val nzBankAccount: InlineV1SetupIntentsPostRequestFormPaymentMethodDataNzBankAccountX9dd1448a? = null,
    ...
    public val radarOptions: InlineV1SetupIntentsPostRequestFormPaymentMethodDataRadarOptionsX47674bd4? = null,
    ...
    public val sepaDebit: InlineV1SetupIntentsPostRequestFormPaymentMethodDataSepaDebitX9dae8053? = null,
    ...
    public val usBankAccount: InlineV1SetupIntentsPostRequestFormPaymentMethodDataUsBankAccountX8f9302d2? = null,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1SetupIntentsPostRequestFormPaymentMethodDataX076e36a5 =
    ...
    public object Serializer : KSerializer<InlineV1SetupIntentsPostRequestFormPaymentMethodDataX076e36a5> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1SetupIntentsPostRequestFormPaymentMethodDataX076e36a5 {
            val jsonDecoder =
                decoder.requireJsonDecoder(
                    "InlineV1SetupIntentsPostRequestFormPaymentMethodDataX076e36a5",
                )
            val json = jsonDecoder.json
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SetupIntentsPostRequestFormPaymentMethodDataX076e36a5 must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineV1SetupIntentsPostRequestFormPaymentMethodDataTypeX50cdba8a>(
                    rawObject,
                    "type",
                )
            return InlineV1SetupIntentsPostRequestFormPaymentMethodDataX076e36a5(
                ...
                acssDebit =
                    rawObject["acss_debit"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodDataAcssDebitXd5c92856>(
                                it,
                            )
                    },
                ...
                allowRedisplay =
                    rawObject["allow_redisplay"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodDataAllowRedisplayX6ba4c1e4>(
                                it,
                            )
                    },
                ...
                auBecsDebit =
                    rawObject["au_becs_debit"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodDataAuBecsDebitX31fb309e>(
                                it,
                            )
                    },
                bacsDebit =
                    rawObject["bacs_debit"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodDataBacsDebitX6f66f016>(
                                it,
                            )
                    },
                ...
                billingDetails =
                    rawObject["billing_details"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodDataBillingDetailsX5bed1b10>(
                                it,
                            )
                    },
                ...
                boleto =
                    rawObject["boleto"]?.let {
                        json.decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodDataBoletoX414ff3df>(
                            it,
                        )
                    },
                ...
                eps =
                    rawObject["eps"]?.let {
                        json.decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodDataEpsX1ad348c4>(it)
                    },
                fpx =
                    rawObject["fpx"]?.let {
                        json.decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodDataFpxX7a735eb2>(it)
                    },
                ...
                ideal =
                    rawObject["ideal"]?.let {
                        json.decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodDataIdealX9f2238fe>(
                            it,
                        )
                    },
                ...
                klarna =
                    rawObject["klarna"]?.let {
                        json.decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodDataKlarnaX79b52604>(
                            it,
                        )
                    },
                ...
                naverPay =
                    rawObject["naver_pay"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodDataNaverPayXd7447413>(
                                it,
                            )
                    },
                nzBankAccount =
                    rawObject["nz_bank_account"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodDataNzBankAccountX9dd1448a>(
                                it,
                            )
                    },
                ...
                p24 =
                    rawObject["p24"]?.let {
                        json.decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodDataP24X4324f131>(it)
                    },
                ...
                payto =
                    rawObject["payto"]?.let {
                        json.decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodDataPaytoXde12c38f>(
                            it,
                        )
                    },
                ...
                radarOptions =
                    rawObject["radar_options"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodDataRadarOptionsX47674bd4>(
                                it,
                            )
                    },
                ...
                sepaDebit =
                    rawObject["sepa_debit"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodDataSepaDebitX9dae8053>(
                                it,
                            )
                    },
                sofort =
                    rawObject["sofort"]?.let {
                        json.decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodDataSofortXbac840ce>(
                            it,
                        )
                    },
                ...
                upi =
                    rawObject["upi"]?.let {
                        json.decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodDataUpiX177b1f7b>(it)
                    },
                usBankAccount =
                    rawObject["us_bank_account"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodDataUsBankAccountX8f9302d2>(
                                it,
                            )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SetupIntentsPostRequestFormPaymentMethodDataX076e36a5,
        ) {
            val jsonEncoder =
...
public fun inlineV1SetupIntentsPostRequestFormPaymentMethodDataX076e36a5(
    block: InlineV1SetupIntentsPostRequestFormPaymentMethodDataX076e36a5.Builder.() -> Unit,
): InlineV1SetupIntentsPostRequestFormPaymentMethodDataX076e36a5 =
    InlineV1SetupIntentsPostRequestFormPaymentMethodDataX076e36a5.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1SetupIntentsPostRequestFormPaymentMethodDataX076e36a5 is missing required property '" + name +
                    "'",
            )
