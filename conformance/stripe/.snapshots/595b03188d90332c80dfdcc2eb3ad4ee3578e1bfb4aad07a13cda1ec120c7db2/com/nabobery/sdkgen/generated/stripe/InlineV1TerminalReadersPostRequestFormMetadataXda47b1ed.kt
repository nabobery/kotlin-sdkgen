...
internal data class InlineV1TerminalReadersPostRequestFormMetadataXda47b1edInspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1TerminalReadersPostRequestFormMetadataAnyOf2X0025dc50,
            ).count { it }
}
...
public class InlineV1TerminalReadersPostRequestFormMetadataXda47b1ed internal constructor(
    ...
    public val inlineV1TerminalReadersPostRequestFormMetadataAnyOf2X0025dc50:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1TerminalReadersPostRequestFormMetadataAnyOf2X0025dc50) {
                json
                    .decodeFromJsonElement<InlineV1TerminalReadersPostRequestFormMetadataAnyOf2X0025dc50>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1TerminalReadersPostRequestFormMetadataXda47b1edBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1TerminalReadersPostRequestFormMetadataAnyOf2X0025dc50) {
                    add(
                        InlineV1TerminalReadersPostRequestFormMetadataXda47b1edBranch.InlineV1TerminalReadersPostRequestFormMetadataAnyOf2X0025dc50,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1TerminalReadersPostRequestFormMetadataXda47b1ed {
            val inspection = inspectInlineV1TerminalReadersPostRequestFormMetadataXda47b1ed(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1TerminalReadersPostRequestFormMetadataXda47b1edNoMatchException(
                    "InlineV1TerminalReadersPostRequestFormMetadataXda47b1ed matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1TerminalReadersPostRequestFormMetadataXda47b1ed> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TerminalReadersPostRequestFormMetadataXda47b1ed,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1TerminalReadersPostRequestFormMetadataXda47b1ed",
...
private fun inspectInlineV1TerminalReadersPostRequestFormMetadataXda47b1ed(
    element: JsonElement,
): InlineV1TerminalReadersPostRequestFormMetadataXda47b1edInspection {
    val matchesBranch1 = element.isJsonDecodable<JsonObject>()
    val matchesInlineV1TerminalReadersPostRequestFormMetadataAnyOf2X0025dc50 =
        element
            .isJsonDecodable<InlineV1TerminalReadersPostRequestFormMetadataAnyOf2X0025dc50>()
    return InlineV1TerminalReadersPostRequestFormMetadataXda47b1edInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1TerminalReadersPostRequestFormMetadataAnyOf2X0025dc50) {
                    add(
                        "InlineV1TerminalReadersPostRequestFormMetadataAnyOf2X0025dc50: value does not match InlineV1TerminalReadersPostRequestFormMetadataAnyOf2X0025dc50",
                    )
                }
            },
    )
