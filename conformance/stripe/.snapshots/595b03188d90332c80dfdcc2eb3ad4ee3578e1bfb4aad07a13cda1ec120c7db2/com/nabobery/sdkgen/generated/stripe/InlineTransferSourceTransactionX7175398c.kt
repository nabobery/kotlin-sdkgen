...
public class InlineTransferSourceTransactionX7175398c internal constructor(
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineTransferSourceTransactionX7175398c {
            val inspection = inspectInlineTransferSourceTransactionX7175398c(raw)
            if (inspection.matchCount == 0) {
                throw InlineTransferSourceTransactionX7175398cNoMatchException(
                    "InlineTransferSourceTransactionX7175398c matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineTransferSourceTransactionX7175398c> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineTransferSourceTransactionX7175398c,
        ) {
...
private fun inspectInlineTransferSourceTransactionX7175398c(
    element: JsonElement,
): InlineTransferSourceTransactionX7175398cInspection {
