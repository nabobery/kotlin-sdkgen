...
public class InlineV1InvoiceitemsPostRequestFormDiscountsAnyOf1ItemX0a4f0e2d(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1InvoiceitemsPostRequestFormDiscountsAnyOf1ItemX0a4f0e2d =
            InlineV1InvoiceitemsPostRequestFormDiscountsAnyOf1ItemX0a4f0e2d(
                coupon = coupon,
                discount = discount,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1InvoiceitemsPostRequestFormDiscountsAnyOf1ItemX0a4f0e2d =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1InvoiceitemsPostRequestFormDiscountsAnyOf1ItemX0a4f0e2d> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1InvoiceitemsPostRequestFormDiscountsAnyOf1ItemX0a4f0e2d must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoiceitemsPostRequestFormDiscountsAnyOf1ItemX0a4f0e2d,
        ) {
            val jsonEncoder =
...
public fun inlineV1InvoiceitemsPostRequestFormDiscountsAnyOf1ItemX0a4f0e2d(
    block: InlineV1InvoiceitemsPostRequestFormDiscountsAnyOf1ItemX0a4f0e2d.Builder.() -> Unit,
): InlineV1InvoiceitemsPostRequestFormDiscountsAnyOf1ItemX0a4f0e2d =
    InlineV1InvoiceitemsPostRequestFormDiscountsAnyOf1ItemX0a4f0e2d.build(block)
