...
public class SetupAttemptPaymentMethodDetailsNaverPay(
    ...
    public class Builder {
        ...
        public fun build(): SetupAttemptPaymentMethodDetailsNaverPay =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): SetupAttemptPaymentMethodDetailsNaverPay =
    ...
    public object Serializer : KSerializer<SetupAttemptPaymentMethodDetailsNaverPay> {
        ...
        override fun deserialize(decoder: Decoder): SetupAttemptPaymentMethodDetailsNaverPay {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("SetupAttemptPaymentMethodDetailsNaverPay must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: SetupAttemptPaymentMethodDetailsNaverPay,
        ) {
...
public fun setupAttemptPaymentMethodDetailsNaverPay(
    block: SetupAttemptPaymentMethodDetailsNaverPay.Builder.() -> Unit,
): SetupAttemptPaymentMethodDetailsNaverPay = SetupAttemptPaymentMethodDetailsNaverPay.build(block)
