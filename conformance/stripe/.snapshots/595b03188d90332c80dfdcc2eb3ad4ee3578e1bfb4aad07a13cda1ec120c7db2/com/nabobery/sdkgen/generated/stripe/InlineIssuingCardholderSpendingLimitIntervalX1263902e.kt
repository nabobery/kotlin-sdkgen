...
public sealed class InlineIssuingCardholderSpendingLimitIntervalX1263902e {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineIssuingCardholderSpendingLimitIntervalX1263902e =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineIssuingCardholderSpendingLimitIntervalX1263902e> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineIssuingCardholderSpendingLimitIntervalX1263902e",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineIssuingCardholderSpendingLimitIntervalX1263902e =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineIssuingCardholderSpendingLimitIntervalX1263902e,
        ) {
