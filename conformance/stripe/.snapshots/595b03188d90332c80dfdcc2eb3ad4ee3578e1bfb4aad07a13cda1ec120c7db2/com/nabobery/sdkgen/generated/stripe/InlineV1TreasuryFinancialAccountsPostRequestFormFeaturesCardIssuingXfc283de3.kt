...
public class InlineV1TreasuryFinancialAccountsPostRequestFormFeaturesCardIssuingXfc283de3(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1TreasuryFinancialAccountsPostRequestFormFeaturesCardIssuingXfc283de3 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TreasuryFinancialAccountsPostRequestFormFeaturesCardIssuingXfc283de3> {
        override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1TreasuryFinancialAccountsPostRequestFormFeaturesCardIssuingXfc283de3 {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TreasuryFinancialAccountsPostRequestFormFeaturesCardIssuingXfc283de3 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TreasuryFinancialAccountsPostRequestFormFeaturesCardIssuingXfc283de3,
        ) {
            val jsonEncoder =
...
public fun inlineV1TreasuryFinancialAccountsPostRequestFormFeaturesCardIssuingXfc283de3(
    block: InlineV1TreasuryFinancialAccountsPostRequestFormFeaturesCardIssuingXfc283de3.Builder.() -> Unit,
): InlineV1TreasuryFinancialAccountsPostRequestFormFeaturesCardIssuingXfc283de3 =
    InlineV1TreasuryFinancialAccountsPostRequestFormFeaturesCardIssuingXfc283de3.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TreasuryFinancialAccountsPostRequestFormFeaturesCardIssuingXfc283de3 is missing required property '" +
                    name +
                    "'",
            )
