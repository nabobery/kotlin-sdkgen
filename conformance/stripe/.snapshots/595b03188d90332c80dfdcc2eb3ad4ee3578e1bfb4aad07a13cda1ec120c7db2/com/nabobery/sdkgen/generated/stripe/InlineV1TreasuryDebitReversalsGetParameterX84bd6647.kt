...
public sealed class InlineV1TreasuryDebitReversalsGetParameterX84bd6647 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1TreasuryDebitReversalsGetParameterX84bd6647 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1TreasuryDebitReversalsGetParameterX84bd6647> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1TreasuryDebitReversalsGetParameterX84bd6647",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1TreasuryDebitReversalsGetParameterX84bd6647 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TreasuryDebitReversalsGetParameterX84bd6647,
        ) {
