...
public class PaymentPagesCheckoutSessionCustomTextPosition(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentPagesCheckoutSessionCustomTextPosition =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentPagesCheckoutSessionCustomTextPosition> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "PaymentPagesCheckoutSessionCustomTextPosition must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentPagesCheckoutSessionCustomTextPosition,
        ) {
...
public fun paymentPagesCheckoutSessionCustomTextPosition(
    block: PaymentPagesCheckoutSessionCustomTextPosition.Builder.() -> Unit,
): PaymentPagesCheckoutSessionCustomTextPosition = PaymentPagesCheckoutSessionCustomTextPosition.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "PaymentPagesCheckoutSessionCustomTextPosition is missing required property '" + name + "'",
            )
