...
public sealed class InlineV1PaymentIntentsCapturePostRequestFormPaymentDetailsAnyOf2X9560517d {
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsCapturePostRequestFormPaymentDetailsAnyOf2X9560517d> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1PaymentIntentsCapturePostRequestFormPaymentDetailsAnyOf2X9560517d",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1PaymentIntentsCapturePostRequestFormPaymentDetailsAnyOf2X9560517d = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsCapturePostRequestFormPaymentDetailsAnyOf2X9560517d,
        ) {
