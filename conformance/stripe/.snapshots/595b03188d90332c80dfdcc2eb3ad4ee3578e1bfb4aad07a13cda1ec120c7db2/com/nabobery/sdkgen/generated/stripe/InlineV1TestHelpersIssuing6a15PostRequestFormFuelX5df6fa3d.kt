...
public class InlineV1TestHelpersIssuing6a15PostRequestFormFuelX5df6fa3d(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1TestHelpersIssuing6a15PostRequestFormFuelX5df6fa3d =
            InlineV1TestHelpersIssuing6a15PostRequestFormFuelX5df6fa3d(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TestHelpersIssuing6a15PostRequestFormFuelX5df6fa3d =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TestHelpersIssuing6a15PostRequestFormFuelX5df6fa3d> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1TestHelpersIssuing6a15PostRequestFormFuelX5df6fa3d {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TestHelpersIssuing6a15PostRequestFormFuelX5df6fa3d must be a JSON object",
                    )
            return InlineV1TestHelpersIssuing6a15PostRequestFormFuelX5df6fa3d(
                ...
                type =
                    rawObject["type"]?.let {
                        json.decodeFromJsonElement<InlineV1TestHelpersIssuing6a15PostRequestFormFuelTypeXb6cd6ccb>(it)
                    },
                unit =
                    rawObject["unit"]?.let {
                        json.decodeFromJsonElement<InlineV1TestHelpersIssuing6a15PostRequestFormFuelUnitXc3f89e76>(it)
                    },
                unitCostDecimal =
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TestHelpersIssuing6a15PostRequestFormFuelX5df6fa3d,
        ) {
...
public fun inlineV1TestHelpersIssuing6a15PostRequestFormFuelX5df6fa3d(
    block: InlineV1TestHelpersIssuing6a15PostRequestFormFuelX5df6fa3d.Builder.() -> Unit,
): InlineV1TestHelpersIssuing6a15PostRequestFormFuelX5df6fa3d =
    InlineV1TestHelpersIssuing6a15PostRequestFormFuelX5df6fa3d.build(block)
