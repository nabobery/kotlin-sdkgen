...
public class BillingCreditGrantsResourceApplicablePrice(
    ...
    public class Builder {
        ...
        public fun build(): BillingCreditGrantsResourceApplicablePrice =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): BillingCreditGrantsResourceApplicablePrice =
    ...
    public object Serializer : KSerializer<BillingCreditGrantsResourceApplicablePrice> {
        ...
        override fun deserialize(decoder: Decoder): BillingCreditGrantsResourceApplicablePrice {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("BillingCreditGrantsResourceApplicablePrice must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: BillingCreditGrantsResourceApplicablePrice,
        ) {
...
public fun billingCreditGrantsResourceApplicablePrice(
    block: BillingCreditGrantsResourceApplicablePrice.Builder.() -> Unit,
): BillingCreditGrantsResourceApplicablePrice = BillingCreditGrantsResourceApplicablePrice.build(block)
