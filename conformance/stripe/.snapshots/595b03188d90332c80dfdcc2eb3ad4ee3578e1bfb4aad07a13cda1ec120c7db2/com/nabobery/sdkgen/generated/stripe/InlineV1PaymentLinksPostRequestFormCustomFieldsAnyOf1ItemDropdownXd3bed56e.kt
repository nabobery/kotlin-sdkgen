...
public class InlineV1PaymentLinksPostRequestFormCustomFieldsAnyOf1ItemDropdownXd3bed56e(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentLinksPostRequestFormCustomFieldsAnyOf1ItemDropdownXd3bed56e = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1PaymentLinksPostRequestFormCustomFieldsAnyOf1ItemDropdownXd3bed56e> {
        ...
        override fun deserialize(
            decoder: Decoder,
        ): InlineV1PaymentLinksPostRequestFormCustomFieldsAnyOf1ItemDropdownXd3bed56e {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentLinksPostRequestFormCustomFieldsAnyOf1ItemDropdownXd3bed56e must be a JSON object",
                    )
            val options =
                json
                    .decodeRequired<List<InlineV1PaymentLinksPostRequestFormCustomFieldsAnyOf1ItemDropdownItemX4dcd4288>>(
                        rawObject,
                        "options",
                    )
            return InlineV1PaymentLinksPostRequestFormCustomFieldsAnyOf1ItemDropdownXd3bed56e(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentLinksPostRequestFormCustomFieldsAnyOf1ItemDropdownXd3bed56e,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentLinksPostRequestFormCustomFieldsAnyOf1ItemDropdownXd3bed56e(
    block: InlineV1PaymentLinksPostRequestFormCustomFieldsAnyOf1ItemDropdownXd3bed56e.Builder.() -> Unit,
): InlineV1PaymentLinksPostRequestFormCustomFieldsAnyOf1ItemDropdownXd3bed56e =
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentLinksPostRequestFormCustomFieldsAnyOf1ItemDropdownXd3bed56e is missing required property '" +
                    name +
                    "'",
            )
