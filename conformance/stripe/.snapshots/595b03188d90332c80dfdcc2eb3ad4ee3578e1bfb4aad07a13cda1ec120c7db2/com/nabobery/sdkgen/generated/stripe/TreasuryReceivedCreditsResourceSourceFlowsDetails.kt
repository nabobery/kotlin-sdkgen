...
public class TreasuryReceivedCreditsResourceSourceFlowsDetails(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): TreasuryReceivedCreditsResourceSourceFlowsDetails =
    ...
    public object Serializer : KSerializer<TreasuryReceivedCreditsResourceSourceFlowsDetails> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "TreasuryReceivedCreditsResourceSourceFlowsDetails must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineTreasuryReceivedCreditsResourceSourceFlowsDetailsTypeXe0b21b90>(
                    rawObject,
                    "type",
                )
            return TreasuryReceivedCreditsResourceSourceFlowsDetails(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: TreasuryReceivedCreditsResourceSourceFlowsDetails,
        ) {
...
public fun treasuryReceivedCreditsResourceSourceFlowsDetails(
    block: TreasuryReceivedCreditsResourceSourceFlowsDetails.Builder.() -> Unit,
): TreasuryReceivedCreditsResourceSourceFlowsDetails = TreasuryReceivedCreditsResourceSourceFlowsDetails.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "TreasuryReceivedCreditsResourceSourceFlowsDetails is missing required property '" + name + "'",
            )
