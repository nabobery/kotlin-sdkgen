...
public class PaymentPagesCheckoutSessionCustomFieldsLabel(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentPagesCheckoutSessionCustomFieldsLabel =
    ...
    public object Serializer : KSerializer<PaymentPagesCheckoutSessionCustomFieldsLabel> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "PaymentPagesCheckoutSessionCustomFieldsLabel must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlinePaymentPagesCheckoutSessionCustomFieldsLabelTypeX04c14251>(
                    rawObject,
                    "type",
                )
            return PaymentPagesCheckoutSessionCustomFieldsLabel(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentPagesCheckoutSessionCustomFieldsLabel,
        ) {
...
public fun paymentPagesCheckoutSessionCustomFieldsLabel(
    block: PaymentPagesCheckoutSessionCustomFieldsLabel.Builder.() -> Unit,
): PaymentPagesCheckoutSessionCustomFieldsLabel = PaymentPagesCheckoutSessionCustomFieldsLabel.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "PaymentPagesCheckoutSessionCustomFieldsLabel is missing required property '" + name + "'",
            )
