...
public class InlineTreasuryTransactionEntryTransactionX0ef108c4 internal constructor(
        ...
        get() =
            buildSet {
                ...
                if (inspection.matchesTreasuryTransaction) {
                    add(
                        InlineTreasuryTransactionEntryTransactionX0ef108c4Branch.TreasuryTransaction,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineTreasuryTransactionEntryTransactionX0ef108c4 {
            val inspection = inspectInlineTreasuryTransactionEntryTransactionX0ef108c4(raw)
            if (inspection.matchCount == 0) {
                throw InlineTreasuryTransactionEntryTransactionX0ef108c4NoMatchException(
                    "InlineTreasuryTransactionEntryTransactionX0ef108c4 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineTreasuryTransactionEntryTransactionX0ef108c4> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineTreasuryTransactionEntryTransactionX0ef108c4,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineTreasuryTransactionEntryTransactionX0ef108c4",
...
private fun inspectInlineTreasuryTransactionEntryTransactionX0ef108c4(
    element: JsonElement,
): InlineTreasuryTransactionEntryTransactionX0ef108c4Inspection {
