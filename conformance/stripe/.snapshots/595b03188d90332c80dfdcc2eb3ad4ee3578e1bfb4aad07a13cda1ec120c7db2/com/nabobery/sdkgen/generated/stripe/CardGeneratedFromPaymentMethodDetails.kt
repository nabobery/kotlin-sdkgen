...
public class CardGeneratedFromPaymentMethodDetails(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): CardGeneratedFromPaymentMethodDetails =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<CardGeneratedFromPaymentMethodDetails> {
        ...
        override fun deserialize(decoder: Decoder): CardGeneratedFromPaymentMethodDetails {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("CardGeneratedFromPaymentMethodDetails must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: CardGeneratedFromPaymentMethodDetails,
        ) {
...
public fun cardGeneratedFromPaymentMethodDetails(
    block: CardGeneratedFromPaymentMethodDetails.Builder.() -> Unit,
): CardGeneratedFromPaymentMethodDetails = CardGeneratedFromPaymentMethodDetails.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "CardGeneratedFromPaymentMethodDetails is missing required property '" + name + "'",
            )
