...
public sealed class InlineV1FileLinksPostRequestFormMetadataAnyOf2Xf4d0177f {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1FileLinksPostRequestFormMetadataAnyOf2Xf4d0177f =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1FileLinksPostRequestFormMetadataAnyOf2Xf4d0177f> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1FileLinksPostRequestFormMetadataAnyOf2Xf4d0177f",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1FileLinksPostRequestFormMetadataAnyOf2Xf4d0177f =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1FileLinksPostRequestFormMetadataAnyOf2Xf4d0177f,
        ) {
