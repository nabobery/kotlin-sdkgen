...
public class SourceRedirectFlow(
    ...
    public object Serializer : KSerializer<SourceRedirectFlow> {
        ...
        override fun deserialize(decoder: Decoder): SourceRedirectFlow {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("SourceRedirectFlow must be a JSON object")
            ...
            return SourceRedirectFlow(
                ...
                url = url,
                failureReason =
                    rawObject["failure_reason"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
...
public fun sourceRedirectFlow(block: SourceRedirectFlow.Builder.() -> Unit): SourceRedirectFlow =
    SourceRedirectFlow.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("SourceRedirectFlow is missing required property '" + name + "'")
