...
public class InlineV1SubscriptionsPostRequestFormTrialSettingsXe20b5ab9(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1SubscriptionsPostRequestFormTrialSettingsXe20b5ab9 =
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionsPostRequestFormTrialSettingsXe20b5ab9> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SubscriptionsPostRequestFormTrialSettingsXe20b5ab9 must be a JSON object",
                    )
            val endBehavior =
                json.decodeRequired<InlineV1SubscriptionsPostRequestFormTrialSettingsEndBehaviorX2373f412>(
                    rawObject,
                    "end_behavior",
                )
            return InlineV1SubscriptionsPostRequestFormTrialSettingsXe20b5ab9(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsPostRequestFormTrialSettingsXe20b5ab9,
        ) {
...
public fun inlineV1SubscriptionsPostRequestFormTrialSettingsXe20b5ab9(
    block: InlineV1SubscriptionsPostRequestFormTrialSettingsXe20b5ab9.Builder.() -> Unit,
): InlineV1SubscriptionsPostRequestFormTrialSettingsXe20b5ab9 =
    InlineV1SubscriptionsPostRequestFormTrialSettingsXe20b5ab9.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1SubscriptionsPostRequestFormTrialSettingsXe20b5ab9 is missing required property '" + name + "'",
            )
