...
public class InlineV1TestHelpersIssuingPersonalizationDesignsRejectPostRequestFormX2a2b7bf6(
     ...
     */
    public val rejectionReasons: InlineV1TestHelpersIssuing78bcPostRequestFormRejectionReasonsX09132784,
    /**
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1TestHelpersIssuingPersonalizationDesignsRejectPostRequestFormX2a2b7bf6 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TestHelpersIssuingPersonalizationDesignsRejectPostRequestFormX2a2b7bf6> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TestHelpersIssuingPersonalizationDesignsRejectPostRequestFormX2a2b7bf6 must be a JSON object",
                    )
            val rejectionReasons =
                json
                    .decodeRequired<InlineV1TestHelpersIssuing78bcPostRequestFormRejectionReasonsX09132784>(
                        rawObject,
                        "rejection_reasons",
                    )
            return InlineV1TestHelpersIssuingPersonalizationDesignsRejectPostRequestFormX2a2b7bf6(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TestHelpersIssuingPersonalizationDesignsRejectPostRequestFormX2a2b7bf6,
        ) {
            val jsonEncoder =
...
public fun inlineV1TestHelpersIssuingPersonalizationDesignsRejectPostRequestFormX2a2b7bf6(
    block: InlineV1TestHelpersIssuingPersonalizationDesignsRejectPostRequestFormX2a2b7bf6.Builder.() -> Unit,
): InlineV1TestHelpersIssuingPersonalizationDesignsRejectPostRequestFormX2a2b7bf6 =
    InlineV1TestHelpersIssuingPersonalizationDesignsRejectPostRequestFormX2a2b7bf6.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TestHelpersIssuingPersonalizationDesignsRejectPostRequestFormX2a2b7bf6 is missing required property '" +
                    name +
                    "'",
            )
