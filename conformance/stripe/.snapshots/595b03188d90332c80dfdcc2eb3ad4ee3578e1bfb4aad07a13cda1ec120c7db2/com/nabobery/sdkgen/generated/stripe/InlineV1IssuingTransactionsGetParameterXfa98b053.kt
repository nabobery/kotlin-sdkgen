...
public sealed class InlineV1IssuingTransactionsGetParameterXfa98b053 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1IssuingTransactionsGetParameterXfa98b053 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1IssuingTransactionsGetParameterXfa98b053> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1IssuingTransactionsGetParameterXfa98b053",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1IssuingTransactionsGetParameterXfa98b053 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingTransactionsGetParameterXfa98b053,
        ) {
