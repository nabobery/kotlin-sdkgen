...
public class PaymentFlowsPaymentIntentAsyncWorkflowsResourceInputs(
    ...
    public class Builder {
        ...
        public fun build(): PaymentFlowsPaymentIntentAsyncWorkflowsResourceInputs =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentFlowsPaymentIntentAsyncWorkflowsResourceInputs =
    ...
    public object Serializer : KSerializer<PaymentFlowsPaymentIntentAsyncWorkflowsResourceInputs> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "PaymentFlowsPaymentIntentAsyncWorkflowsResourceInputs must be a JSON object",
                    )
            return PaymentFlowsPaymentIntentAsyncWorkflowsResourceInputs(
                tax =
                    rawObject["tax"]?.let {
                        json.decodeFromJsonElement<PaymentFlowsPaymentIntentAsyncWorkflowsResourceInputsResourceTax>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentFlowsPaymentIntentAsyncWorkflowsResourceInputs,
        ) {
...
public fun paymentFlowsPaymentIntentAsyncWorkflowsResourceInputs(
    block: PaymentFlowsPaymentIntentAsyncWorkflowsResourceInputs.Builder.() -> Unit,
): PaymentFlowsPaymentIntentAsyncWorkflowsResourceInputs =
    PaymentFlowsPaymentIntentAsyncWorkflowsResourceInputs.build(block)
