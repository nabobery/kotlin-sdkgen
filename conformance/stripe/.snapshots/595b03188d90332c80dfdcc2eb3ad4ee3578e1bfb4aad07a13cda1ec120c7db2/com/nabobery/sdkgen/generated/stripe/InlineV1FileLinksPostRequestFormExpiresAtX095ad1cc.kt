...
internal data class InlineV1FileLinksPostRequestFormExpiresAtX095ad1ccInspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesInlineV1FileLinksPostRequestFormExpiresAtAnyOf1X4ea58773,
                matchesBranch2,
                matchesInlineV1FileLinksPostRequestFormExpiresAtAnyOf3X8e622adb,
            ).count {
                it
            }
}
...
public class InlineV1FileLinksPostRequestFormExpiresAtX095ad1cc internal constructor(
    ...
    public val inlineV1FileLinksPostRequestFormExpiresAtAnyOf1X4ea58773:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1FileLinksPostRequestFormExpiresAtAnyOf1X4ea58773) {
                json
                    .decodeFromJsonElement<InlineV1FileLinksPostRequestFormExpiresAtAnyOf1X4ea58773>(
                        raw,
                    )
            } else {
                null
    ...
    public val inlineV1FileLinksPostRequestFormExpiresAtAnyOf3X8e622adb:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1FileLinksPostRequestFormExpiresAtAnyOf3X8e622adb) {
                json
                    .decodeFromJsonElement<InlineV1FileLinksPostRequestFormExpiresAtAnyOf3X8e622adb>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1FileLinksPostRequestFormExpiresAtX095ad1ccBranch>
        get() =
            buildSet {
                if (inspection.matchesInlineV1FileLinksPostRequestFormExpiresAtAnyOf1X4ea58773) {
                    add(
                        InlineV1FileLinksPostRequestFormExpiresAtX095ad1ccBranch.InlineV1FileLinksPostRequestFormExpiresAtAnyOf1X4ea58773,
                    )
                }
                if (inspection.matchesBranch2) add(InlineV1FileLinksPostRequestFormExpiresAtX095ad1ccBranch.Branch2)
                if (inspection.matchesInlineV1FileLinksPostRequestFormExpiresAtAnyOf3X8e622adb) {
                    add(
                        InlineV1FileLinksPostRequestFormExpiresAtX095ad1ccBranch.InlineV1FileLinksPostRequestFormExpiresAtAnyOf3X8e622adb,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1FileLinksPostRequestFormExpiresAtX095ad1cc {
            val inspection = inspectInlineV1FileLinksPostRequestFormExpiresAtX095ad1cc(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1FileLinksPostRequestFormExpiresAtX095ad1ccNoMatchException(
                    "InlineV1FileLinksPostRequestFormExpiresAtX095ad1cc matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1FileLinksPostRequestFormExpiresAtX095ad1cc> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1FileLinksPostRequestFormExpiresAtX095ad1cc,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1FileLinksPostRequestFormExpiresAtX095ad1cc",
...
private fun inspectInlineV1FileLinksPostRequestFormExpiresAtX095ad1cc(
    element: JsonElement,
): InlineV1FileLinksPostRequestFormExpiresAtX095ad1ccInspection {
    val matchesInlineV1FileLinksPostRequestFormExpiresAtAnyOf1X4ea58773 =
        element
            .isJsonDecodable<InlineV1FileLinksPostRequestFormExpiresAtAnyOf1X4ea58773>()
    val matchesBranch2 = element.isJsonDecodable<Int>()
    val matchesInlineV1FileLinksPostRequestFormExpiresAtAnyOf3X8e622adb =
        element
            .isJsonDecodable<InlineV1FileLinksPostRequestFormExpiresAtAnyOf3X8e622adb>()
    return InlineV1FileLinksPostRequestFormExpiresAtX095ad1ccInspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1FileLinksPostRequestFormExpiresAtAnyOf1X4ea58773) {
                    add(
                        "InlineV1FileLinksPostRequestFormExpiresAtAnyOf1X4ea58773: value does not match InlineV1FileLinksPostRequestFormExpiresAtAnyOf1X4ea58773",
                    )
                }
                if (!matchesBranch2) add("Branch2: value does not match Int")
                if (!matchesInlineV1FileLinksPostRequestFormExpiresAtAnyOf3X8e622adb) {
                    add(
                        "InlineV1FileLinksPostRequestFormExpiresAtAnyOf3X8e622adb: value does not match InlineV1FileLinksPostRequestFormExpiresAtAnyOf3X8e622adb",
                    )
                }
            },
    )
