...
public class InlineV1TopupsGetParameterXf8186291 internal constructor(
    ...
    public val inlineV1TopupsGetParameterAnyOf1X6f1fa7e2: InlineV1TopupsGetParameterAnyOf1X6f1fa7e2?
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1TopupsGetParameterAnyOf1X6f1fa7e2) {
                json
                    .decodeFromJsonElement<InlineV1TopupsGetParameterAnyOf1X6f1fa7e2>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1TopupsGetParameterXf8186291Branch>
        get() =
            buildSet {
                if (inspection.matchesInlineV1TopupsGetParameterAnyOf1X6f1fa7e2) {
                    add(
                        InlineV1TopupsGetParameterXf8186291Branch.InlineV1TopupsGetParameterAnyOf1X6f1fa7e2,
                    )
                }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1TopupsGetParameterXf8186291 {
            val inspection = inspectInlineV1TopupsGetParameterXf8186291(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1TopupsGetParameterXf8186291NoMatchException(
                    "InlineV1TopupsGetParameterXf8186291 matched 0 branches: " + inspection.failures.joinToString("; "),
                )
            }
    ...
    public object Serializer : KSerializer<InlineV1TopupsGetParameterXf8186291> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TopupsGetParameterXf8186291,
        ) {
...
private fun inspectInlineV1TopupsGetParameterXf8186291(
    element: JsonElement,
): InlineV1TopupsGetParameterXf8186291Inspection {
    val matchesInlineV1TopupsGetParameterAnyOf1X6f1fa7e2 =
        element
            .isJsonDecodable<InlineV1TopupsGetParameterAnyOf1X6f1fa7e2>()
    ...
    return InlineV1TopupsGetParameterXf8186291Inspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1TopupsGetParameterAnyOf1X6f1fa7e2) {
                    add(
                        "InlineV1TopupsGetParameterAnyOf1X6f1fa7e2: value does not match InlineV1TopupsGetParameterAnyOf1X6f1fa7e2",
                    )
                }
