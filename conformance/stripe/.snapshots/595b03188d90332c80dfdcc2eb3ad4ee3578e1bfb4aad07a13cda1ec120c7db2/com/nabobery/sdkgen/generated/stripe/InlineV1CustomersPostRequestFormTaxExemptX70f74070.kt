...
public sealed class InlineV1CustomersPostRequestFormTaxExemptX70f74070 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1CustomersPostRequestFormTaxExemptX70f74070 =
            when (value) {
                Value.value -> Value
                Exempt.value -> Exempt
                None.value -> None
    ...
    public object Serializer : KSerializer<InlineV1CustomersPostRequestFormTaxExemptX70f74070> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1CustomersPostRequestFormTaxExemptX70f74070",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1CustomersPostRequestFormTaxExemptX70f74070 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersPostRequestFormTaxExemptX70f74070,
        ) {
