...
internal data class InlineV1InvoicesAddLinesPostRequestFormInvoiceMetadataXf359f669Inspection(
    ...
    public val matchCount: Int
        get() =
            listOf(matchesBranch1, matchesInlineV1InvoicesAddLinesPostRequestFormInvoiceMetadataAnyOf2X3290de5b).count {
                it
            }
}
...
public class InlineV1InvoicesAddLinesPostRequestFormInvoiceMetadataXf359f669 internal constructor(
    ...
    public val inlineV1InvoicesAddLinesPostRequestFormInvoiceMetadataAnyOf2X3290de5b:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1InvoicesAddLinesPostRequestFormInvoiceMetadataAnyOf2X3290de5b) {
                json
                    .decodeFromJsonElement<InlineV1InvoicesAddLinesPostRequestFormInvoiceMetadataAnyOf2X3290de5b>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1InvoicesAddLinesPostRequestFormInvoiceMetadataXf359f669Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1InvoicesAddLinesPostRequestFormInvoiceMetadataAnyOf2X3290de5b) {
                    add(
                        InlineV1InvoicesAddLinesPostRequestFormInvoiceMetadataXf359f669Branch.InlineV1InvoicesAddLinesPostRequestFormInvoiceMetadataAnyOf2X3290de5b,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1InvoicesAddLinesPostRequestFormInvoiceMetadataXf359f669 {
            val inspection = inspectInlineV1InvoicesAddLinesPostRequestFormInvoiceMetadataXf359f669(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1InvoicesAddLinesPostRequestFormInvoiceMetadataXf359f669NoMatchException(
                    "InlineV1InvoicesAddLinesPostRequestFormInvoiceMetadataXf359f669 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1InvoicesAddLinesPostRequestFormInvoiceMetadataXf359f669> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesAddLinesPostRequestFormInvoiceMetadataXf359f669,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1InvoicesAddLinesPostRequestFormInvoiceMetadataXf359f669",
...
private fun inspectInlineV1InvoicesAddLinesPostRequestFormInvoiceMetadataXf359f669(
    element: JsonElement,
): InlineV1InvoicesAddLinesPostRequestFormInvoiceMetadataXf359f669Inspection {
    val matchesBranch1 = element.isJsonDecodable<JsonObject>()
    val matchesInlineV1InvoicesAddLinesPostRequestFormInvoiceMetadataAnyOf2X3290de5b =
        element
            .isJsonDecodable<InlineV1InvoicesAddLinesPostRequestFormInvoiceMetadataAnyOf2X3290de5b>()
    return InlineV1InvoicesAddLinesPostRequestFormInvoiceMetadataXf359f669Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1InvoicesAddLinesPostRequestFormInvoiceMetadataAnyOf2X3290de5b) {
                    add(
                        "InlineV1InvoicesAddLinesPostRequestFormInvoiceMetadataAnyOf2X3290de5b: value does not match InlineV1InvoicesAddLinesPostRequestFormInvoiceMetadataAnyOf2X3290de5b",
                    )
                }
            },
    )
