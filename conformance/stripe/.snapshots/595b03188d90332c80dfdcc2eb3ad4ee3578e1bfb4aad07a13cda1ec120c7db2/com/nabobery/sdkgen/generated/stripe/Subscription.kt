...
@Serializable
public data class SubscriptionView(
    ...
    public val pendingInvoiceItemInterval: InlineSubscriptionPendingInvoiceItemIntervalXe65def85? = null,
...
public class Subscription(
    ...
    public class Builder {
        ...
        public var billingSchedules: List<SubscriptionsResourceBillingSchedules>
            get() = requireNotNull(billingSchedulesValue) { "billingSchedules is required" }
            set(`value`) {
                billingSchedulesValue = value
            }
         ...
         * have their `default_tax_rates` populated from the subscription.
         */
        public var defaultTaxRates: List<TaxRate>? = null
    ...
    public object Serializer : KSerializer<Subscription> {
        ...
        override fun deserialize(decoder: Decoder): Subscription {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("Subscription must be a JSON object")
            ...
            val billingSchedules =
                json.decodeRequired<List<SubscriptionsResourceBillingSchedules>>(
                    rawObject,
                    "billing_schedules",
                )
            val cancelAtPeriodEnd = json.decodeRequired<Boolean>(rawObject, "cancel_at_period_end")
            val collectionMethod =
                json.decodeRequired<InlineSubscriptionCollectionMethodX68775f71>(
                    rawObject,
                    "collection_method",
                )
            ...
            val invoiceSettings =
                json.decodeRequired<SubscriptionsResourceSubscriptionInvoiceSettings>(
                    rawObject,
                    "invoice_settings",
                )
            ...
            return Subscription(
                ...
                application =
                    rawObject["application"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineSubscriptionApplicationX28439c61?>(element)
                        }
                    },
                applicationFeePercent =
                    rawObject["application_fee_percent"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                billingCycleAnchorConfig =
                    rawObject["billing_cycle_anchor_config"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineSubscriptionBillingCycleAnchorConfigXea24da68?>(element)
                        }
                    },
                billingThresholds =
                    rawObject["billing_thresholds"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineSubscriptionBillingThresholdsX6e690ced?>(element)
                        }
                    },
                cancelAt =
                    rawObject["cancel_at"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                cancellationDetails =
                    rawObject["cancellation_details"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineSubscriptionCancellationDetailsX0e11eeaf?>(element)
                        }
                    },
                customerAccount =
                ...
                defaultPaymentMethod =
                    rawObject["default_payment_method"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineSubscriptionDefaultPaymentMethodX14c25b83?>(element)
                        }
                    },
                defaultSource =
                    rawObject["default_source"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineSubscriptionDefaultSourceXf0c66116?>(element)
                        }
                    },
                defaultTaxRates =
                    rawObject["default_tax_rates"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                endedAt =
                    rawObject["ended_at"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                latestInvoice =
                    rawObject["latest_invoice"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineSubscriptionLatestInvoiceX182fda92?>(element)
                        }
                    },
                managedPayments =
                    rawObject["managed_payments"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineSubscriptionManagedPaymentsX33f1992e?>(element)
                        }
                    },
                nextPendingInvoiceItemInvoice =
                    rawObject["next_pending_invoice_item_invoice"]
                        ?.let { element ->
                            if (element ==
                                JsonNull
                            ) {
                ...
                onBehalfOf =
                    rawObject["on_behalf_of"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineSubscriptionOnBehalfOfXc7863d56?>(element)
                        }
                    },
                pauseCollection =
                    rawObject["pause_collection"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineSubscriptionPauseCollectionXf3d09645?>(element)
                        }
                    },
                paymentSettings =
                    rawObject["payment_settings"]
                        ?.let { element ->
                            if (element ==
                                JsonNull
                            ) {
                                ...
                                json.decodeFromJsonElement<InlineSubscriptionPaymentSettingsXcb421fa6?>(element)
                            }
                        },
                pendingInvoiceItemInterval =
                    rawObject["pending_invoice_item_interval"]
                        ?.let { element ->
                            if (element ==
                                JsonNull
                            ) {
                                ...
                                json.decodeFromJsonElement<InlineSubscriptionPendingInvoiceItemIntervalXe65def85?>(
                                    element,
                                )
                            }
                        },
                pendingSetupIntent =
                    rawObject["pending_setup_intent"]
                        ?.let { element ->
                            if (element ==
                                JsonNull
                            ) {
                                ...
                                json.decodeFromJsonElement<InlineSubscriptionPendingSetupIntentXec0dee4e?>(element)
                            }
                        },
                pendingUpdate =
                    rawObject["pending_update"]
                        ?.let { element ->
                            if (element ==
                                JsonNull
                            ) {
                                ...
                                json.decodeFromJsonElement<InlineSubscriptionPendingUpdateXa60c9b03?>(element)
                            }
                        },
                presentmentDetails =
                    rawObject["presentment_details"]
                        ?.let {
                            json
                                .decodeFromJsonElement<SubscriptionsResourceSubscriptionPresentmentDetails>(
                                    it,
                                )
                        },
                schedule =
                    rawObject["schedule"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineSubscriptionScheduleX6d170f2a?>(element)
                        }
                    },
                testClock =
                    rawObject["test_clock"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineSubscriptionTestClockXbc391647?>(element)
                        }
                    },
                transferData =
                    rawObject["transfer_data"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineSubscriptionTransferDataX382db867?>(element)
                        }
                    },
                trialEnd =
                    rawObject["trial_end"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                trialSettings =
                    rawObject["trial_settings"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineSubscriptionTrialSettingsXb02f1582?>(element)
                        }
                    },
                trialStart =
                    rawObject["trial_start"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
        ...
        override fun serialize(
            ...
            val raw =
                buildJsonObject {
                    ...
                    value.nextPendingInvoiceItemInvoice?.let {
                        put(
