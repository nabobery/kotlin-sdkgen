...
public class InlineV1EphemeralKeysDeleteRequestFormX85408ebf(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1EphemeralKeysDeleteRequestFormX85408ebf =
            InlineV1EphemeralKeysDeleteRequestFormX85408ebf(
                expand = expand,
            )
    }

    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1EphemeralKeysDeleteRequestFormX85408ebf =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1EphemeralKeysDeleteRequestFormX85408ebf> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1EphemeralKeysDeleteRequestFormX85408ebf must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1EphemeralKeysDeleteRequestFormX85408ebf,
        ) {
...
public fun inlineV1EphemeralKeysDeleteRequestFormX85408ebf(
    block: InlineV1EphemeralKeysDeleteRequestFormX85408ebf.Builder.() -> Unit,
): InlineV1EphemeralKeysDeleteRequestFormX85408ebf = InlineV1EphemeralKeysDeleteRequestFormX85408ebf.build(block)
