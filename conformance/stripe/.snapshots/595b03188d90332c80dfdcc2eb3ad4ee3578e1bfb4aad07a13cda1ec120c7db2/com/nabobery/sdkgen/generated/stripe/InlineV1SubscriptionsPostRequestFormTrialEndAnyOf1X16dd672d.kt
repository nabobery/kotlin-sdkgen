...
public sealed class InlineV1SubscriptionsPostRequestFormTrialEndAnyOf1X16dd672d {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1SubscriptionsPostRequestFormTrialEndAnyOf1X16dd672d =
            when (value) {
                Now.value -> Now
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionsPostRequestFormTrialEndAnyOf1X16dd672d> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1SubscriptionsPostRequestFormTrialEndAnyOf1X16dd672d",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1SubscriptionsPostRequestFormTrialEndAnyOf1X16dd672d =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsPostRequestFormTrialEndAnyOf1X16dd672d,
        ) {
