...
public class PortalSubscriptionUpdateProductAdjustableQuantity(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PortalSubscriptionUpdateProductAdjustableQuantity =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PortalSubscriptionUpdateProductAdjustableQuantity> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "PortalSubscriptionUpdateProductAdjustableQuantity must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PortalSubscriptionUpdateProductAdjustableQuantity,
        ) {
...
public fun portalSubscriptionUpdateProductAdjustableQuantity(
    block: PortalSubscriptionUpdateProductAdjustableQuantity.Builder.() -> Unit,
): PortalSubscriptionUpdateProductAdjustableQuantity = PortalSubscriptionUpdateProductAdjustableQuantity.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "PortalSubscriptionUpdateProductAdjustableQuantity is missing required property '" + name + "'",
            )
