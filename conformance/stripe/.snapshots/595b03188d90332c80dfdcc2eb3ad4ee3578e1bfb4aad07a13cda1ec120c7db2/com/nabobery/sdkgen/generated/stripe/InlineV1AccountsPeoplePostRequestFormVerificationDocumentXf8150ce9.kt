...
public class InlineV1AccountsPeoplePostRequestFormVerificationDocumentXf8150ce9(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1AccountsPeoplePostRequestFormVerificationDocumentXf8150ce9 =
            InlineV1AccountsPeoplePostRequestFormVerificationDocumentXf8150ce9(
                back = back,
                front = front,
            )
    }
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1AccountsPeoplePostRequestFormVerificationDocumentXf8150ce9 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1AccountsPeoplePostRequestFormVerificationDocumentXf8150ce9> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountsPeoplePostRequestFormVerificationDocumentXf8150ce9 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPeoplePostRequestFormVerificationDocumentXf8150ce9,
        ) {
            val jsonEncoder =
...
public fun inlineV1AccountsPeoplePostRequestFormVerificationDocumentXf8150ce9(
    block: InlineV1AccountsPeoplePostRequestFormVerificationDocumentXf8150ce9.Builder.() -> Unit,
): InlineV1AccountsPeoplePostRequestFormVerificationDocumentXf8150ce9 =
    InlineV1AccountsPeoplePostRequestFormVerificationDocumentXf8150ce9.build(block)
