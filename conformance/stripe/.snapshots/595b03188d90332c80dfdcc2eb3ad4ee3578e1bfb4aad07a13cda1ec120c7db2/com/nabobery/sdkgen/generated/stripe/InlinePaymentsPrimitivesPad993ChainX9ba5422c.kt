...
public sealed class InlinePaymentsPrimitivesPad993ChainX9ba5422c {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentsPrimitivesPad993ChainX9ba5422c =
            when (value) {
    ...
    public object Serializer : KSerializer<InlinePaymentsPrimitivesPad993ChainX9ba5422c> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentsPrimitivesPad993ChainX9ba5422c",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePaymentsPrimitivesPad993ChainX9ba5422c =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentsPrimitivesPad993ChainX9ba5422c,
        ) {
