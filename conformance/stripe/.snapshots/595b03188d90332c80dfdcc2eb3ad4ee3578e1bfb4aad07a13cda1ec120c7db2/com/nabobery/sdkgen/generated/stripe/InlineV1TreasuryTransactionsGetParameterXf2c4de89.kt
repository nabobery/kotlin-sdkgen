...
public sealed class InlineV1TreasuryTransactionsGetParameterXf2c4de89 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1TreasuryTransactionsGetParameterXf2c4de89 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1TreasuryTransactionsGetParameterXf2c4de89> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1TreasuryTransactionsGetParameterXf2c4de89",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1TreasuryTransactionsGetParameterXf2c4de89 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TreasuryTransactionsGetParameterXf2c4de89,
        ) {
