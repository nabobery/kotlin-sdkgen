...
public class InlineV1ProductsPostRequestFormDefaultPriceDataCustomUnitAmountX8862e626(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1ProductsPostRequestFormDefaultPriceDataCustomUnitAmountX8862e626 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1ProductsPostRequestFormDefaultPriceDataCustomUnitAmountX8862e626> {
        override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1ProductsPostRequestFormDefaultPriceDataCustomUnitAmountX8862e626 {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1ProductsPostRequestFormDefaultPriceDataCustomUnitAmountX8862e626 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ProductsPostRequestFormDefaultPriceDataCustomUnitAmountX8862e626,
        ) {
            val jsonEncoder =
...
public fun inlineV1ProductsPostRequestFormDefaultPriceDataCustomUnitAmountX8862e626(
    block: InlineV1ProductsPostRequestFormDefaultPriceDataCustomUnitAmountX8862e626.Builder.() -> Unit,
): InlineV1ProductsPostRequestFormDefaultPriceDataCustomUnitAmountX8862e626 =
    InlineV1ProductsPostRequestFormDefaultPriceDataCustomUnitAmountX8862e626.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1ProductsPostRequestFormDefaultPriceDataCustomUnitAmountX8862e626 is missing required property '" +
                    name +
                    "'",
            )
