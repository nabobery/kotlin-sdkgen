...
public sealed class InlineV1SubscriptionSchedulesPostRequestFormEndBehaviorXe2268f44 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1SubscriptionSchedulesPostRequestFormEndBehaviorXe2268f44 =
            when (value) {
                Cancel.value -> Cancel
                None.value -> None
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionSchedulesPostRequestFormEndBehaviorXe2268f44> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1SubscriptionSchedulesPostRequestFormEndBehaviorXe2268f44",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1SubscriptionSchedulesPostRequestFormEndBehaviorXe2268f44 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionSchedulesPostRequestFormEndBehaviorXe2268f44,
        ) {
