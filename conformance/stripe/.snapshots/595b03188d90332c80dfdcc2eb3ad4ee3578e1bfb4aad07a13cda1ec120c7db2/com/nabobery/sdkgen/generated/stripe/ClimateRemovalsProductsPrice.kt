...
public class ClimateRemovalsProductsPrice(
    ...
    public object Serializer : KSerializer<ClimateRemovalsProductsPrice> {
        ...
        override fun deserialize(decoder: Decoder): ClimateRemovalsProductsPrice {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("ClimateRemovalsProductsPrice must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: ClimateRemovalsProductsPrice,
        ) {
...
public fun climateRemovalsProductsPrice(
    block: ClimateRemovalsProductsPrice.Builder.() -> Unit,
): ClimateRemovalsProductsPrice = ClimateRemovalsProductsPrice.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException("ClimateRemovalsProductsPrice is missing required property '" + name + "'")
