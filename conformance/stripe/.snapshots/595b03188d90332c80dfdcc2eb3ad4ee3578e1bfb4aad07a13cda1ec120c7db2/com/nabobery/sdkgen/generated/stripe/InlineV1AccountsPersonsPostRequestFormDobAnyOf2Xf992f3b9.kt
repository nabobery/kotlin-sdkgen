...
public sealed class InlineV1AccountsPersonsPostRequestFormDobAnyOf2Xf992f3b9 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1AccountsPersonsPostRequestFormDobAnyOf2Xf992f3b9 =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1AccountsPersonsPostRequestFormDobAnyOf2Xf992f3b9> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1AccountsPersonsPostRequestFormDobAnyOf2Xf992f3b9",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1AccountsPersonsPostRequestFormDobAnyOf2Xf992f3b9 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPersonsPostRequestFormDobAnyOf2Xf992f3b9,
        ) {
