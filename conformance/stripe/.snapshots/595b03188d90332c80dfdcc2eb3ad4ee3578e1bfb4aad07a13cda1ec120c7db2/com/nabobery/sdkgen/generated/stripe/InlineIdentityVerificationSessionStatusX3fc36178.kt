...
public sealed class InlineIdentityVerificationSessionStatusX3fc36178 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineIdentityVerificationSessionStatusX3fc36178 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineIdentityVerificationSessionStatusX3fc36178> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineIdentityVerificationSessionStatusX3fc36178",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineIdentityVerificationSessionStatusX3fc36178 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineIdentityVerificationSessionStatusX3fc36178,
        ) {
