...
internal data class InlineV1PaymentRecordsReportPaymentAttemptPostRequestFormMetadataXbd0aafe0Inspection(
    ...
    public val matchesInlineV1PaymentRecordsReportPaymentAttemptPostRequestFormMetadataAnyOf2X8e4c6373: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1PaymentRecordsReportPaymentAttemptPostRequestFormMetadataAnyOf2X8e4c6373,
            ).count {
                it
            }
}
...
public class InlineV1PaymentRecordsReportPaymentAttemptPostRequestFormMetadataXbd0aafe0 internal constructor(
    ...
    private val inspection: InlineV1PaymentRecordsReportPaymentAttemptPostRequestFormMetadataXbd0aafe0Inspection,
) {
    ...
    public val inlineV1PaymentRecordsReportPaymentAttemptPostRequestFormMetadataAnyOf2X8e4c6373:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1PaymentRecordsReportPaymentAttemptPostRequestFormMetadataAnyOf2X8e4c6373) {
                json
                    .decodeFromJsonElement<InlineV1PaymentRecordsReportPaymentAttemptPostRequestFormMetadataAnyOf2X8e4c6373>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1PaymentRecordsReportPaymentAttemptPostRequestFormMetadataXbd0aafe0Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1PaymentRecordsReportPaymentAttemptPostRequestFormMetadataAnyOf2X8e4c6373) {
                    add(
                        InlineV1PaymentRecordsReportPaymentAttemptPostRequestFormMetadataXbd0aafe0Branch.InlineV1PaymentRecordsReportPaymentAttemptPostRequestFormMetadataAnyOf2X8e4c6373,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1PaymentRecordsReportPaymentAttemptPostRequestFormMetadataXbd0aafe0 {
            val inspection = inspectInlineV1PaymentRecordsReportPaymentAttemptPostRequestFormMetadataXbd0aafe0(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1PaymentRecordsReportPaymentAttemptPostRequestFormMetadataXbd0aafe0NoMatchException(
                    "InlineV1PaymentRecordsReportPaymentAttemptPostRequestFormMetadataXbd0aafe0 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1PaymentRecordsReportPaymentAttemptPostRequestFormMetadataXbd0aafe0> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentRecordsReportPaymentAttemptPostRequestFormMetadataXbd0aafe0,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1PaymentRecordsReportPaymentAttemptPostRequestFormMetadataXbd0aafe0",
...
private fun inspectInlineV1PaymentRecordsReportPaymentAttemptPostRequestFormMetadataXbd0aafe0(
    element: JsonElement,
): InlineV1PaymentRecordsReportPaymentAttemptPostRequestFormMetadataXbd0aafe0Inspection {
    val matchesBranch1 = element.isJsonDecodable<JsonObject>()
    val matchesInlineV1PaymentRecordsReportPaymentAttemptPostRequestFormMetadataAnyOf2X8e4c6373 =
        element
            .isJsonDecodable<InlineV1PaymentRecordsReportPaymentAttemptPostRequestFormMetadataAnyOf2X8e4c6373>()
    return InlineV1PaymentRecordsReportPaymentAttemptPostRequestFormMetadataXbd0aafe0Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1PaymentRecordsReportPaymentAttemptPostRequestFormMetadataAnyOf2X8e4c6373) {
                    add(
                        "InlineV1PaymentRecordsReportPaymentAttemptPostRequestFormMetadataAnyOf2X8e4c6373: value does not match InlineV1PaymentRecordsReportPaymentAttemptPostRequestFormMetadataAnyOf2X8e4c6373",
                    )
                }
            },
    )
