...
public class InlineAccountExternalAccountsXace51fb0(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineAccountExternalAccountsXace51fb0 =
    ...
    public object Serializer : KSerializer<InlineAccountExternalAccountsXace51fb0> {
        ...
        override fun deserialize(decoder: Decoder): InlineAccountExternalAccountsXace51fb0 {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("InlineAccountExternalAccountsXace51fb0 must be a JSON object")
            ...
            val objectValue =
                json.decodeRequired<InlineAccountExternalAccountsObjectValueXc19f2a88>(
                    rawObject,
                    "object",
                )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineAccountExternalAccountsXace51fb0,
        ) {
...
public fun inlineAccountExternalAccountsXace51fb0(
    block: InlineAccountExternalAccountsXace51fb0.Builder.() -> Unit,
): InlineAccountExternalAccountsXace51fb0 = InlineAccountExternalAccountsXace51fb0.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineAccountExternalAccountsXace51fb0 is missing required property '" + name + "'",
            )
