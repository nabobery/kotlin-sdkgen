...
public class InlineV1PaymentRecordsReportRefundPostRequestFormX9bb75843(
     ...
     */
    public val processorDetails: InlineV1PaymentRecordsReportRefundPostRequestFormProcessorDetailsXfdf9bdf2,
    /**
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PaymentRecordsReportRefundPostRequestFormX9bb75843 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentRecordsReportRefundPostRequestFormX9bb75843> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentRecordsReportRefundPostRequestFormX9bb75843 must be a JSON object",
                    )
            val outcome =
                json.decodeRequired<InlineV1PaymentRecordsReportRefundPostRequestFormOutcomeX91ed38c5>(
                    rawObject,
                    "outcome",
                )
            val processorDetails =
                json
                    .decodeRequired<InlineV1PaymentRecordsReportRefundPostRequestFormProcessorDetailsXfdf9bdf2>(
                        rawObject,
                        "processor_details",
                    )
            return InlineV1PaymentRecordsReportRefundPostRequestFormX9bb75843(
                ...
                amount =
                    rawObject["amount"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentRecordsReportRefundPostRequestFormAmountXc6fcaaaf>(it)
                    },
                expand = rawObject["expand"]?.let { json.decodeFromJsonElement<List<String>>(it) },
                initiatedAt = rawObject["initiated_at"]?.let { json.decodeFromJsonElement<Int>(it) },
                metadata =
                    rawObject["metadata"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentRecordsReportRefundPostRequestFormMetadataXa3eabd80>(
                            it,
                        )
                    },
                refunded =
                    rawObject["refunded"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentRecordsReportRefundPostRequestFormRefundedX8664755a>(
                            it,
                        )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentRecordsReportRefundPostRequestFormX9bb75843,
        ) {
...
public fun inlineV1PaymentRecordsReportRefundPostRequestFormX9bb75843(
    block: InlineV1PaymentRecordsReportRefundPostRequestFormX9bb75843.Builder.() -> Unit,
): InlineV1PaymentRecordsReportRefundPostRequestFormX9bb75843 =
    InlineV1PaymentRecordsReportRefundPostRequestFormX9bb75843.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentRecordsReportRefundPostRequestFormX9bb75843 is missing required property '" + name + "'",
            )
