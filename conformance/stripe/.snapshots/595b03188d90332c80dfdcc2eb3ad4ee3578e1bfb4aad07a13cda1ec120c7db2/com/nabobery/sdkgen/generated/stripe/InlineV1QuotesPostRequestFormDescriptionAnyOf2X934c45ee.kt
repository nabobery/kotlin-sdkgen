...
public sealed class InlineV1QuotesPostRequestFormDescriptionAnyOf2X934c45ee {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1QuotesPostRequestFormDescriptionAnyOf2X934c45ee =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1QuotesPostRequestFormDescriptionAnyOf2X934c45ee> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1QuotesPostRequestFormDescriptionAnyOf2X934c45ee",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1QuotesPostRequestFormDescriptionAnyOf2X934c45ee =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1QuotesPostRequestFormDescriptionAnyOf2X934c45ee,
        ) {
