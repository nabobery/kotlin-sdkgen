...
public data class BillingBillResourceInvoicingParentsInvoiceParentView(
    ...
    public val quoteDetails: InlineBillingBillResourceInvoicingParentsInvoiceParentQuoteDetailsX2f177d36? = null,
    @SerialName("subscription_details")
    public val subscriptionDetails: InlineBillingBillResourceI0765SubscriptionDetailsXc39ddbdd? = null,
...
public class BillingBillResourceInvoicingParentsInvoiceParent(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): BillingBillResourceInvoicingParentsInvoiceParent =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<BillingBillResourceInvoicingParentsInvoiceParent> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "BillingBillResourceInvoicingParentsInvoiceParent must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineBillingBillResourceInvoicingParentsInvoiceParentTypeXf9027e83>(
                    rawObject,
                    "type",
                )
            return BillingBillResourceInvoicingParentsInvoiceParent(
                type = type,
                quoteDetails =
                    rawObject["quote_details"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                            ...
                            json
                                .decodeFromJsonElement<InlineBillingBillResourceInvoicingParentsInvoiceParentQuoteDetailsX2f177d36?>(
                                    element,
                                )
                        }
                    },
                subscriptionDetails =
                    rawObject["subscription_details"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineBillingBillResourceI0765SubscriptionDetailsXc39ddbdd?>(
                                element,
                            )
                        }
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: BillingBillResourceInvoicingParentsInvoiceParent,
        ) {
...
public fun billingBillResourceInvoicingParentsInvoiceParent(
    block: BillingBillResourceInvoicingParentsInvoiceParent.Builder.() -> Unit,
): BillingBillResourceInvoicingParentsInvoiceParent = BillingBillResourceInvoicingParentsInvoiceParent.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "BillingBillResourceInvoicingParentsInvoiceParent is missing required property '" + name + "'",
            )
