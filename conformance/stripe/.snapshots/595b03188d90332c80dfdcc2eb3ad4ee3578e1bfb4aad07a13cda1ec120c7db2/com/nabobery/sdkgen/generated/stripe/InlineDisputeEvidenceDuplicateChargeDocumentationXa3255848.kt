...
public class InlineDisputeEvidenceDuplicateChargeDocumentationXa3255848 internal constructor(
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineDisputeEvidenceDuplicateChargeDocumentationXa3255848Branch.Branch1,
                    )
                }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineDisputeEvidenceDuplicateChargeDocumentationXa3255848 {
            val inspection = inspectInlineDisputeEvidenceDuplicateChargeDocumentationXa3255848(raw)
            if (inspection.matchCount == 0) {
                throw InlineDisputeEvidenceDuplicateChargeDocumentationXa3255848NoMatchException(
                    "InlineDisputeEvidenceDuplicateChargeDocumentationXa3255848 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineDisputeEvidenceDuplicateChargeDocumentationXa3255848> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineDisputeEvidenceDuplicateChargeDocumentationXa3255848,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineDisputeEvidenceDuplicateChargeDocumentationXa3255848",
...
private fun inspectInlineDisputeEvidenceDuplicateChargeDocumentationXa3255848(
    element: JsonElement,
): InlineDisputeEvidenceDuplicateChargeDocumentationXa3255848Inspection {
