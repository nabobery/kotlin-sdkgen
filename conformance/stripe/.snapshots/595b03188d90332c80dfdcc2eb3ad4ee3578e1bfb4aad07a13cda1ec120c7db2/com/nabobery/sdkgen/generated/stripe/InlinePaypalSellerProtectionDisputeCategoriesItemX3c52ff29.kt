...
public sealed class InlinePaypalSellerProtectionDisputeCategoriesItemX3c52ff29 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaypalSellerProtectionDisputeCategoriesItemX3c52ff29 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlinePaypalSellerProtectionDisputeCategoriesItemX3c52ff29> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaypalSellerProtectionDisputeCategoriesItemX3c52ff29",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePaypalSellerProtectionDisputeCategoriesItemX3c52ff29 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaypalSellerProtectionDisputeCategoriesItemX3c52ff29,
        ) {
