...
public sealed class InlinePortalFlowsFlowAfterCompletionTypeX05eee8d4 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePortalFlowsFlowAfterCompletionTypeX05eee8d4 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlinePortalFlowsFlowAfterCompletionTypeX05eee8d4> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePortalFlowsFlowAfterCompletionTypeX05eee8d4",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePortalFlowsFlowAfterCompletionTypeX05eee8d4 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePortalFlowsFlowAfterCompletionTypeX05eee8d4,
        ) {
