...
public sealed class InlineTerminalReaderStatusX06729bfe {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineTerminalReaderStatusX06729bfe =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineTerminalReaderStatusX06729bfe> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineTerminalReaderStatusX06729bfe",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineTerminalReaderStatusX06729bfe =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineTerminalReaderStatusX06729bfe,
        ) {
