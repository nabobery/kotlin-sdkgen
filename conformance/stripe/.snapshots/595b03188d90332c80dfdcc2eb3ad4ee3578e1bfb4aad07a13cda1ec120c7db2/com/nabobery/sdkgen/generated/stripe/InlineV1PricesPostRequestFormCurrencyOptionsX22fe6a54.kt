...
public class InlineV1PricesPostRequestFormCurrencyOptionsX22fe6a54 internal constructor(
    ...
    public val inlineV1PricesPostRequestFormCurrencyOptionsAnyOf2X76b5e6c3:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1PricesPostRequestFormCurrencyOptionsAnyOf2X76b5e6c3) {
                json
                    .decodeFromJsonElement<InlineV1PricesPostRequestFormCurrencyOptionsAnyOf2X76b5e6c3>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1PricesPostRequestFormCurrencyOptionsX22fe6a54Branch>
        get() =
            buildSet {
                ...
                if (inspection.matchesInlineV1PricesPostRequestFormCurrencyOptionsAnyOf2X76b5e6c3) {
                    add(
                        InlineV1PricesPostRequestFormCurrencyOptionsX22fe6a54Branch.InlineV1PricesPostRequestFormCurrencyOptionsAnyOf2X76b5e6c3,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1PricesPostRequestFormCurrencyOptionsX22fe6a54 {
            val inspection = inspectInlineV1PricesPostRequestFormCurrencyOptionsX22fe6a54(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1PricesPostRequestFormCurrencyOptionsX22fe6a54NoMatchException(
                    "InlineV1PricesPostRequestFormCurrencyOptionsX22fe6a54 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1PricesPostRequestFormCurrencyOptionsX22fe6a54> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PricesPostRequestFormCurrencyOptionsX22fe6a54,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1PricesPostRequestFormCurrencyOptionsX22fe6a54",
...
private fun inspectInlineV1PricesPostRequestFormCurrencyOptionsX22fe6a54(
    element: JsonElement,
): InlineV1PricesPostRequestFormCurrencyOptionsX22fe6a54Inspection {
    val matchesBranch1 = element.isJsonDecodable<JsonObject>()
    val matchesInlineV1PricesPostRequestFormCurrencyOptionsAnyOf2X76b5e6c3 =
        element
            .isJsonDecodable<InlineV1PricesPostRequestFormCurrencyOptionsAnyOf2X76b5e6c3>()
    return InlineV1PricesPostRequestFormCurrencyOptionsX22fe6a54Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1PricesPostRequestFormCurrencyOptionsAnyOf2X76b5e6c3) {
                    add(
                        "InlineV1PricesPostRequestFormCurrencyOptionsAnyOf2X76b5e6c3: value does not match InlineV1PricesPostRequestFormCurrencyOptionsAnyOf2X76b5e6c3",
                    )
                }
            },
    )
