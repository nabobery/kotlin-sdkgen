...
public class InlineV1TreasuryOutboundPab148PostRequestFormNameX91ba4e7e internal constructor(
    ...
    public val inlineV1TreasuryOutboundPab148PostRequestFormAnyOf2X24cd5bad:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1TreasuryOutboundPab148PostRequestFormAnyOf2X24cd5bad) {
                json
                    .decodeFromJsonElement<InlineV1TreasuryOutboundPab148PostRequestFormAnyOf2X24cd5bad>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1TreasuryOutboundPab148PostRequestFormNameX91ba4e7eBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1TreasuryOutboundPab148PostRequestFormAnyOf2X24cd5bad) {
                    add(
                        InlineV1TreasuryOutboundPab148PostRequestFormNameX91ba4e7eBranch.InlineV1TreasuryOutboundPab148PostRequestFormAnyOf2X24cd5bad,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1TreasuryOutboundPab148PostRequestFormNameX91ba4e7e {
            val inspection = inspectInlineV1TreasuryOutboundPab148PostRequestFormNameX91ba4e7e(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1TreasuryOutboundPab148PostRequestFormNameX91ba4e7eNoMatchException(
                    "InlineV1TreasuryOutboundPab148PostRequestFormNameX91ba4e7e matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1TreasuryOutboundPab148PostRequestFormNameX91ba4e7e> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TreasuryOutboundPab148PostRequestFormNameX91ba4e7e,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1TreasuryOutboundPab148PostRequestFormNameX91ba4e7e",
...
private fun inspectInlineV1TreasuryOutboundPab148PostRequestFormNameX91ba4e7e(
    element: JsonElement,
): InlineV1TreasuryOutboundPab148PostRequestFormNameX91ba4e7eInspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1TreasuryOutboundPab148PostRequestFormAnyOf2X24cd5bad =
        element
            .isJsonDecodable<InlineV1TreasuryOutboundPab148PostRequestFormAnyOf2X24cd5bad>()
    return InlineV1TreasuryOutboundPab148PostRequestFormNameX91ba4e7eInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1TreasuryOutboundPab148PostRequestFormAnyOf2X24cd5bad) {
                    add(
                        "InlineV1TreasuryOutboundPab148PostRequestFormAnyOf2X24cd5bad: value does not match InlineV1TreasuryOutboundPab148PostRequestFormAnyOf2X24cd5bad",
                    )
                }
            },
    )
