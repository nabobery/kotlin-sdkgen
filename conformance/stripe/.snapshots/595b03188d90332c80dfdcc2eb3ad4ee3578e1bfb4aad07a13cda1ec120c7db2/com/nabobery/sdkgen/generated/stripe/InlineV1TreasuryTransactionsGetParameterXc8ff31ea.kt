...
public class InlineV1TreasuryTransactionsGetParameterXc8ff31ea internal constructor(
    ...
    public val inlineV1TreasuryTransactionsGetParameterAnyOf1X4d368418:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1TreasuryTransactionsGetParameterAnyOf1X4d368418) {
                json
                    .decodeFromJsonElement<InlineV1TreasuryTransactionsGetParameterAnyOf1X4d368418>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1TreasuryTransactionsGetParameterXc8ff31eaBranch>
        get() =
            buildSet {
                if (inspection.matchesInlineV1TreasuryTransactionsGetParameterAnyOf1X4d368418) {
                    add(
                        InlineV1TreasuryTransactionsGetParameterXc8ff31eaBranch.InlineV1TreasuryTransactionsGetParameterAnyOf1X4d368418,
                    )
                }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1TreasuryTransactionsGetParameterXc8ff31ea {
            val inspection = inspectInlineV1TreasuryTransactionsGetParameterXc8ff31ea(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1TreasuryTransactionsGetParameterXc8ff31eaNoMatchException(
                    "InlineV1TreasuryTransactionsGetParameterXc8ff31ea matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1TreasuryTransactionsGetParameterXc8ff31ea> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TreasuryTransactionsGetParameterXc8ff31ea,
        ) {
...
private fun inspectInlineV1TreasuryTransactionsGetParameterXc8ff31ea(
    element: JsonElement,
): InlineV1TreasuryTransactionsGetParameterXc8ff31eaInspection {
    val matchesInlineV1TreasuryTransactionsGetParameterAnyOf1X4d368418 =
        element
            .isJsonDecodable<InlineV1TreasuryTransactionsGetParameterAnyOf1X4d368418>()
    ...
    return InlineV1TreasuryTransactionsGetParameterXc8ff31eaInspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1TreasuryTransactionsGetParameterAnyOf1X4d368418) {
                    add(
                        "InlineV1TreasuryTransactionsGetParameterAnyOf1X4d368418: value does not match InlineV1TreasuryTransactionsGetParameterAnyOf1X4d368418",
                    )
                }
