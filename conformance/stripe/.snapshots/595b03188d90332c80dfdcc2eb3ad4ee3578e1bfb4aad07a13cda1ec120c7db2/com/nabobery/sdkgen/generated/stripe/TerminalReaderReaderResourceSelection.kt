...
public class TerminalReaderReaderResourceSelection(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): TerminalReaderReaderResourceSelection =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<TerminalReaderReaderResourceSelection> {
        ...
        override fun deserialize(decoder: Decoder): TerminalReaderReaderResourceSelection {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("TerminalReaderReaderResourceSelection must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: TerminalReaderReaderResourceSelection,
        ) {
...
public fun terminalReaderReaderResourceSelection(
    block: TerminalReaderReaderResourceSelection.Builder.() -> Unit,
): TerminalReaderReaderResourceSelection = TerminalReaderReaderResourceSelection.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "TerminalReaderReaderResourceSelection is missing required property '" + name + "'",
            )
