...
public class InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsAnyOf1X1e856771(
    public val financialConnections: InlineV1CustomersSubscriptionsPostRequestFormFinancialConnectionsXa9508bc6? = null,
    public val verificationMethod: InlineV1CustomersSubscriptionsPostRequestFormVerificationMethodXf9ed943e? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsAnyOf1X1e856771 =
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsAnyOf1X1e856771 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsAnyOf1X1e856771> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsAnyOf1X1e856771 must be a JSON object",
                    )
            return InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsAnyOf1X1e856771(
                financialConnections =
                    rawObject["financial_connections"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CustomersSubscriptionsPostRequestFormFinancialConnectionsXa9508bc6>(
                                it,
                            )
                    },
                verificationMethod =
                    rawObject["verification_method"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CustomersSubscriptionsPostRequestFormVerificationMethodXf9ed943e>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsAnyOf1X1e856771,
        ) {
            val jsonEncoder =
...
public fun inlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsAnyOf1X1e856771(
    block: InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsAnyOf1X1e856771.Builder.() -> Unit,
): InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsAnyOf1X1e856771 =
    InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsAnyOf1X1e856771.build(block)
