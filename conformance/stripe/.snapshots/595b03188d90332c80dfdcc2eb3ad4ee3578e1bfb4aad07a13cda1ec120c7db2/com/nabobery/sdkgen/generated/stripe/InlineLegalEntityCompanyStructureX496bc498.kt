...
public sealed class InlineLegalEntityCompanyStructureX496bc498 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineLegalEntityCompanyStructureX496bc498 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineLegalEntityCompanyStructureX496bc498> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineLegalEntityCompanyStructureX496bc498",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineLegalEntityCompanyStructureX496bc498 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineLegalEntityCompanyStructureX496bc498,
        ) {
