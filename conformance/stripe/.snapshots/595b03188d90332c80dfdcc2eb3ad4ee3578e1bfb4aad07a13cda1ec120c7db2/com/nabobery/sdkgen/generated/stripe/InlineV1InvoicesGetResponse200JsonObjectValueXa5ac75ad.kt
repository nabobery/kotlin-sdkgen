...
public sealed class InlineV1InvoicesGetResponse200JsonObjectValueXa5ac75ad {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1InvoicesGetResponse200JsonObjectValueXa5ac75ad =
            when (value) {
                List.value -> List
    ...
    public object Serializer : KSerializer<InlineV1InvoicesGetResponse200JsonObjectValueXa5ac75ad> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1InvoicesGetResponse200JsonObjectValueXa5ac75ad",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1InvoicesGetResponse200JsonObjectValueXa5ac75ad =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesGetResponse200JsonObjectValueXa5ac75ad,
        ) {
