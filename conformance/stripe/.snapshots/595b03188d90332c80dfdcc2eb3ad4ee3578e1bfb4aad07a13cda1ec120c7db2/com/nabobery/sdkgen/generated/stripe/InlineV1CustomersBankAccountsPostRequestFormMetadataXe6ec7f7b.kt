...
internal data class InlineV1CustomersBankAccountsPostRequestFormMetadataXe6ec7f7bInspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1CustomersBankAccountsPostRequestFormMetadataAnyOf2X29e4732c,
            ).count { it }
}
...
public class InlineV1CustomersBankAccountsPostRequestFormMetadataXe6ec7f7b internal constructor(
    ...
    public val inlineV1CustomersBankAccountsPostRequestFormMetadataAnyOf2X29e4732c:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1CustomersBankAccountsPostRequestFormMetadataAnyOf2X29e4732c) {
                json
                    .decodeFromJsonElement<InlineV1CustomersBankAccountsPostRequestFormMetadataAnyOf2X29e4732c>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1CustomersBankAccountsPostRequestFormMetadataXe6ec7f7bBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1CustomersBankAccountsPostRequestFormMetadataAnyOf2X29e4732c) {
                    add(
                        InlineV1CustomersBankAccountsPostRequestFormMetadataXe6ec7f7bBranch.InlineV1CustomersBankAccountsPostRequestFormMetadataAnyOf2X29e4732c,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1CustomersBankAccountsPostRequestFormMetadataXe6ec7f7b {
            val inspection = inspectInlineV1CustomersBankAccountsPostRequestFormMetadataXe6ec7f7b(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1CustomersBankAccountsPostRequestFormMetadataXe6ec7f7bNoMatchException(
                    "InlineV1CustomersBankAccountsPostRequestFormMetadataXe6ec7f7b matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1CustomersBankAccountsPostRequestFormMetadataXe6ec7f7b> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersBankAccountsPostRequestFormMetadataXe6ec7f7b,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1CustomersBankAccountsPostRequestFormMetadataXe6ec7f7b",
...
private fun inspectInlineV1CustomersBankAccountsPostRequestFormMetadataXe6ec7f7b(
    element: JsonElement,
): InlineV1CustomersBankAccountsPostRequestFormMetadataXe6ec7f7bInspection {
    val matchesBranch1 = element.isJsonDecodable<JsonObject>()
    val matchesInlineV1CustomersBankAccountsPostRequestFormMetadataAnyOf2X29e4732c =
        element
            .isJsonDecodable<InlineV1CustomersBankAccountsPostRequestFormMetadataAnyOf2X29e4732c>()
    return InlineV1CustomersBankAccountsPostRequestFormMetadataXe6ec7f7bInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1CustomersBankAccountsPostRequestFormMetadataAnyOf2X29e4732c) {
                    add(
                        "InlineV1CustomersBankAccountsPostRequestFormMetadataAnyOf2X29e4732c: value does not match InlineV1CustomersBankAccountsPostRequestFormMetadataAnyOf2X29e4732c",
                    )
                }
            },
    )
