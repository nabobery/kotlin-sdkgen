...
public class InlineIssuingDisputeOtherEvidenceAdditionalDocumentationX2ea3e4ba internal constructor(
    ...
    private val inspection: InlineIssuingDisputeOtherEvidenceAdditionalDocumentationX2ea3e4baInspection,
) {
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineIssuingDisputeOtherEvidenceAdditionalDocumentationX2ea3e4baBranch.Branch1,
                    )
                }
                if (inspection.matchesFile) {
                    add(
                        InlineIssuingDisputeOtherEvidenceAdditionalDocumentationX2ea3e4baBranch.File,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineIssuingDisputeOtherEvidenceAdditionalDocumentationX2ea3e4ba {
            val inspection = inspectInlineIssuingDisputeOtherEvidenceAdditionalDocumentationX2ea3e4ba(raw)
            if (inspection.matchCount == 0) {
                throw InlineIssuingDisputeOtherEvidenceAdditionalDocumentationX2ea3e4baNoMatchException(
                    "InlineIssuingDisputeOtherEvidenceAdditionalDocumentationX2ea3e4ba matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineIssuingDisputeOtherEvidenceAdditionalDocumentationX2ea3e4ba> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineIssuingDisputeOtherEvidenceAdditionalDocumentationX2ea3e4ba,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineIssuingDisputeOtherEvidenceAdditionalDocumentationX2ea3e4ba",
...
private fun inspectInlineIssuingDisputeOtherEvidenceAdditionalDocumentationX2ea3e4ba(
    element: JsonElement,
