...
public class InlineV1PaymentIntentsPostRequestFormPaymentMethodDataX1234bded(
    ...
    public val acssDebit: InlineV1PaymentIntentsPostRequestFormPaymentMethodDataAcssDebitXc5a0a90f? = null,
    public val affirm: JsonObject? = null,
    public val afterpayClearpay: JsonObject? = null,
    public val alipay: JsonObject? = null,
    public val allowRedisplay: InlineV1PaymentIntentsPostRequestFormPaymentMethodDataAllowRedisplayX536e68e0? = null,
    public val alma: JsonObject? = null,
    public val amazonPay: JsonObject? = null,
    public val auBecsDebit: InlineV1PaymentIntentsPostRequestFormPaymentMethodDataAuBecsDebitXeb7275a1? = null,
    public val bacsDebit: InlineV1PaymentIntentsPostRequestFormPaymentMethodDataBacsDebitXd9516127? = null,
    public val bancontact: JsonObject? = null,
    public val billie: JsonObject? = null,
    public val billingDetails: InlineV1PaymentIntentsPostRequestFormPaymentMethodDataBillingDetailsX66645f30? = null,
    ...
    public val naverPay: InlineV1PaymentIntentsPostRequestFormPaymentMethodDataNaverPayX7d9d99f0? = null,
    public val nzBankAccount: InlineV1PaymentIntentsPostRequestFormPaymentMethodDataNzBankAccountXbd115775? = null,
    ...
    public val radarOptions: InlineV1PaymentIntentsPostRequestFormPaymentMethodDataRadarOptionsX5baa0fe8? = null,
    ...
    public val sepaDebit: InlineV1PaymentIntentsPostRequestFormPaymentMethodDataSepaDebitX96668b9d? = null,
    ...
    public val usBankAccount: InlineV1PaymentIntentsPostRequestFormPaymentMethodDataUsBankAccountX478e5733? = null,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PaymentIntentsPostRequestFormPaymentMethodDataX1234bded =
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormPaymentMethodDataX1234bded> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1PaymentIntentsPostRequestFormPaymentMethodDataX1234bded {
            val jsonDecoder =
                decoder.requireJsonDecoder(
                    "InlineV1PaymentIntentsPostRequestFormPaymentMethodDataX1234bded",
                )
            val json = jsonDecoder.json
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsPostRequestFormPaymentMethodDataX1234bded must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineV1PaymentIntentsPostRequestFormPaymentMethodDataTypeXf621df36>(
                    rawObject,
                    "type",
                )
            return InlineV1PaymentIntentsPostRequestFormPaymentMethodDataX1234bded(
                ...
                acssDebit =
                    rawObject["acss_debit"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodDataAcssDebitXc5a0a90f>(
                                it,
                            )
                    },
                ...
                allowRedisplay =
                    rawObject["allow_redisplay"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodDataAllowRedisplayX536e68e0>(
                                it,
                            )
                    },
                ...
                auBecsDebit =
                    rawObject["au_becs_debit"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodDataAuBecsDebitXeb7275a1>(
                                it,
                            )
                    },
                bacsDebit =
                    rawObject["bacs_debit"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodDataBacsDebitXd9516127>(
                                it,
                            )
                    },
                ...
                billingDetails =
                    rawObject["billing_details"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodDataBillingDetailsX66645f30>(
                                it,
                            )
                    },
                ...
                boleto =
                    rawObject["boleto"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodDataBoletoXfaeb5952>(
                                it,
                            )
                    },
                ...
                eps =
                    rawObject["eps"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodDataEpsXa73d13cf>(
                            it,
                        )
                    },
                fpx =
                    rawObject["fpx"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodDataFpxX9dfbb5c8>(
                            it,
                        )
                    },
                ...
                ideal =
                    rawObject["ideal"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodDataIdealX4e5eb650>(
                                it,
                            )
                    },
                ...
                klarna =
                    rawObject["klarna"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodDataKlarnaX9ce8f5c1>(
                                it,
                            )
                    },
                ...
                naverPay =
                    rawObject["naver_pay"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodDataNaverPayX7d9d99f0>(
                                it,
                            )
                    },
                nzBankAccount =
                    rawObject["nz_bank_account"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodDataNzBankAccountXbd115775>(
                                it,
                            )
                    },
                ...
                p24 =
                    rawObject["p24"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodDataP24Xe85c7e95>(
                            it,
                        )
                    },
                ...
                payto =
                    rawObject["payto"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodDataPaytoXf7b79a29>(
                                it,
                            )
                    },
                ...
                radarOptions =
                    rawObject["radar_options"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodDataRadarOptionsX5baa0fe8>(
                                it,
                            )
                    },
                ...
                sepaDebit =
                    rawObject["sepa_debit"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodDataSepaDebitX96668b9d>(
                                it,
                            )
                    },
                sofort =
                    rawObject["sofort"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodDataSofortXcba2a77c>(
                                it,
                            )
                    },
                ...
                upi =
                    rawObject["upi"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodDataUpiXe85ce12d>(
                            it,
                        )
                    },
                usBankAccount =
                    rawObject["us_bank_account"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodDataUsBankAccountX478e5733>(
                                it,
                            )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormPaymentMethodDataX1234bded,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentIntentsPostRequestFormPaymentMethodDataX1234bded(
    block: InlineV1PaymentIntentsPostRequestFormPaymentMethodDataX1234bded.Builder.() -> Unit,
): InlineV1PaymentIntentsPostRequestFormPaymentMethodDataX1234bded =
    InlineV1PaymentIntentsPostRequestFormPaymentMethodDataX1234bded.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentIntentsPostRequestFormPaymentMethodDataX1234bded is missing required property '" + name +
                    "'",
            )
