...
public class InlineV1EntitlementsFeaturesPostRequestFormX3fbc6c94(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1EntitlementsFeaturesPostRequestFormX3fbc6c94 =
            InlineV1EntitlementsFeaturesPostRequestFormX3fbc6c94(
                active = active,
                expand = expand,
                metadata = metadata,
                name = name,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1EntitlementsFeaturesPostRequestFormX3fbc6c94 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1EntitlementsFeaturesPostRequestFormX3fbc6c94> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1EntitlementsFeaturesPostRequestFormX3fbc6c94 must be a JSON object",
                    )
            return InlineV1EntitlementsFeaturesPostRequestFormX3fbc6c94(
                ...
                metadata =
                    rawObject["metadata"]?.let {
                        json.decodeFromJsonElement<InlineV1EntitlementsFeaturesPostRequestFormMetadataXacbde597>(it)
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1EntitlementsFeaturesPostRequestFormX3fbc6c94,
        ) {
...
public fun inlineV1EntitlementsFeaturesPostRequestFormX3fbc6c94(
    block: InlineV1EntitlementsFeaturesPostRequestFormX3fbc6c94.Builder.() -> Unit,
): InlineV1EntitlementsFeaturesPostRequestFormX3fbc6c94 =
    InlineV1EntitlementsFeaturesPostRequestFormX3fbc6c94.build(block)
