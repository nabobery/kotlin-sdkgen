...
public class InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataPaytoX1ee22b9c(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataPaytoX1ee22b9c =
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataPaytoX1ee22b9c = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataPaytoX1ee22b9c> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataPaytoX1ee22b9c must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataPaytoX1ee22b9c,
        ) {
            val jsonEncoder =
...
public fun inlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataPaytoX1ee22b9c(
    block: InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataPaytoX1ee22b9c.Builder.() -> Unit,
): InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataPaytoX1ee22b9c =
    InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataPaytoX1ee22b9c.build(block)
