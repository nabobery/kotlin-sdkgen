...
public class PaymentMethodConfiguration(
    ...
    public object Serializer : KSerializer<PaymentMethodConfiguration> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodConfiguration {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodConfiguration must be a JSON object")
            ...
            val objectValue =
                json.decodeRequired<InlinePaymentMethodConfigurationObjectValueX814d04d2>(
                    rawObject,
                    "object",
                )
            return PaymentMethodConfiguration(
                ...
                acssDebit =
                    rawObject["acss_debit"]?.let {
                        json.decodeFromJsonElement<PaymentMethodConfigResourcePaymentMethodProperties>(it)
                    },
                affirm =
                ...
                alma =
                    rawObject["alma"]?.let {
                        json.decodeFromJsonElement<PaymentMethodConfigResourcePaymentMethodProperties>(
                            it,
                        )
                    },
                amazonPay =
                ...
                bizum =
                    rawObject["bizum"]?.let {
                        json
                            .decodeFromJsonElement<PaymentMethodConfigResourcePaymentMethodProperties>(
                                it,
                            )
                    },
                blik =
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentMethodConfiguration,
        ) {
...
public fun paymentMethodConfiguration(
    block: PaymentMethodConfiguration.Builder.() -> Unit,
): PaymentMethodConfiguration = PaymentMethodConfiguration.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException("PaymentMethodConfiguration is missing required property '" + name + "'")
