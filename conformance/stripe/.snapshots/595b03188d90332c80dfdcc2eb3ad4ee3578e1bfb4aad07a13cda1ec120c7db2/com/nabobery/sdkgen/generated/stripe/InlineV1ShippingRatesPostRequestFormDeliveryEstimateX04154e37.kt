...
public class InlineV1ShippingRatesPostRequestFormDeliveryEstimateX04154e37(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1ShippingRatesPostRequestFormDeliveryEstimateX04154e37 =
            InlineV1ShippingRatesPostRequestFormDeliveryEstimateX04154e37(
                maximum = maximum,
                minimum = minimum,
            )
    }
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1ShippingRatesPostRequestFormDeliveryEstimateX04154e37 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1ShippingRatesPostRequestFormDeliveryEstimateX04154e37> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1ShippingRatesPostRequestFormDeliveryEstimateX04154e37 must be a JSON object",
                    )
            return InlineV1ShippingRatesPostRequestFormDeliveryEstimateX04154e37(
                maximum =
                    rawObject["maximum"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1ShippingRatesPostRequestFormDeliveryEstimateMaximumX351289ba>(
                                it,
                            )
                    },
                minimum =
                    rawObject["minimum"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1ShippingRatesPostRequestFormDeliveryEstimateMinimumXe7e0a3f9>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ShippingRatesPostRequestFormDeliveryEstimateX04154e37,
        ) {
            val jsonEncoder =
...
public fun inlineV1ShippingRatesPostRequestFormDeliveryEstimateX04154e37(
    block: InlineV1ShippingRatesPostRequestFormDeliveryEstimateX04154e37.Builder.() -> Unit,
): InlineV1ShippingRatesPostRequestFormDeliveryEstimateX04154e37 =
    InlineV1ShippingRatesPostRequestFormDeliveryEstimateX04154e37.build(block)
