...
public class InvoicesPaymentMethodOptions(
    ...
    public class Builder {
        ...
        public fun build(): InvoicesPaymentMethodOptions =
    ...
    public object Serializer : KSerializer<InvoicesPaymentMethodOptions> {
        ...
        override fun deserialize(decoder: Decoder): InvoicesPaymentMethodOptions {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("InvoicesPaymentMethodOptions must be a JSON object")
                ...
                acssDebit =
                    rawObject["acss_debit"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineInvoicesPaymentMethodOptionsAcssDebitX7d97dfe0?>(element)
                        }
                    },
                bancontact =
                    rawObject["bancontact"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineInvoicesPaymentMethodOptionsBancontactXb30f7363?>(element)
                        }
                    },
                card =
                    rawObject["card"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineInvoicesPaymentMethodOptionsCardX7732c642?>(element)
                        }
                    },
                customerBalance =
                    rawObject["customer_balance"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineInvoicesPaymentMethodOptionsCustomerBalanceXeb891be3?>(
                                element,
                            )
                        }
                    },
                konbini =
                    rawObject["konbini"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineInvoicesPaymentMethodOptionsKonbiniX054be988?>(element)
                        }
                    },
                payto =
                    rawObject["payto"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineInvoicesPaymentMethodOptionsPaytoXf4457f9a?>(element)
                        }
                    },
                pix =
                    rawObject["pix"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineInvoicesPaymentMethodOptionsPixX100a30a5?>(element)
                        }
                    },
                sepaDebit =
                    rawObject["sepa_debit"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineInvoicesPaymentMethodOptionsSepaDebitX88a99be3?>(element)
                        }
                    },
                upi =
                    rawObject["upi"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineInvoicesPaymentMethodOptionsUpiX81b96e1e?>(element)
                        }
                    },
                usBankAccount =
                    rawObject["us_bank_account"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineInvoicesPaymentMethodOptionsUsBankAccountX1db9b4bd?>(
                                element,
                            )
                        }
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InvoicesPaymentMethodOptions,
        ) {
...
public fun invoicesPaymentMethodOptions(
    block: InvoicesPaymentMethodOptions.Builder.() -> Unit,
): InvoicesPaymentMethodOptions = InvoicesPaymentMethodOptions.build(block)
