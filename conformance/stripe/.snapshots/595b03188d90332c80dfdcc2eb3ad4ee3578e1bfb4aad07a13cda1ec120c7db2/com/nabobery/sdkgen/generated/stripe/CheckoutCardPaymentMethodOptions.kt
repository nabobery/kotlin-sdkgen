...
public class CheckoutCardPaymentMethodOptions(
     ...
     */
    public val requestThreeDSecure: InlineCheckoutCardPaymentMethodOptionsRequestThreeDSecureXc282dfdb,
    /**
     ...
     */
    public val requestMulticapture: InlineCheckoutCardPaymentMethodOptionsRequestMulticaptureX494ec730? = null,
    /**
     * Request ability to [overcapture](/payments/overcapture) for this CheckoutSession.
     */
    public val requestOvercapture: InlineCheckoutCardPaymentMethodOptionsRequestOvercaptureXbeaffb72? = null,
     ...
     */
    public val setupFutureUsage: InlineCheckoutCardPaymentMethodOptionsSetupFutureUsageX86d67e78? = null,
    /**
    ...
    public object Serializer : KSerializer<CheckoutCardPaymentMethodOptions> {
        ...
        override fun deserialize(decoder: Decoder): CheckoutCardPaymentMethodOptions {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("CheckoutCardPaymentMethodOptions must be a JSON object")
            val requestThreeDSecure =
                json.decodeRequired<InlineCheckoutCardPaymentMethodOptionsRequestThreeDSecureXc282dfdb>(
                    rawObject,
            ...
            return CheckoutCardPaymentMethodOptions(
                ...
                captureMethod =
                    rawObject["capture_method"]?.let {
                        json.decodeFromJsonElement<InlineCheckoutCardPaymentMethodOptionsCaptureMethodXffcd4137>(it)
                    },
                installments =
                    rawObject["installments"]?.let {
                        json.decodeFromJsonElement<CheckoutCardInstallmentsOptions>(
                            it,
                        )
                    },
                requestExtendedAuthorization =
                    rawObject["request_extended_authorization"]?.let {
                        json
                            .decodeFromJsonElement<InlineCheckoutCardPaymentMethodOptionsRequestExtendedAuthorizationX9adf265a>(
                                it,
                            )
                    },
                requestIncrementalAuthorization =
                    rawObject["request_incremental_authorization"]?.let {
                        json
                            .decodeFromJsonElement<InlineCheckoutCardPaymentMethodOptionsRequestIncrementalAuthorizationXdd14a51a>(
                                it,
                            )
                    },
                requestMulticapture =
                    rawObject["request_multicapture"]?.let {
                        json.decodeFromJsonElement<InlineCheckoutCardPaymentMethodOptionsRequestMulticaptureX494ec730>(
                            it,
                        )
                    },
                requestOvercapture =
                    rawObject["request_overcapture"]?.let {
                        json.decodeFromJsonElement<InlineCheckoutCardPaymentMethodOptionsRequestOvercaptureXbeaffb72>(
                            it,
                        )
                    },
                restrictions =
                    rawObject["restrictions"]?.let {
                        json.decodeFromJsonElement<PaymentPagesPrivateCardPaymentMethodOptionsResourceRestrictions>(it)
                    },
                setupFutureUsage =
                    rawObject["setup_future_usage"]?.let {
                        json.decodeFromJsonElement<InlineCheckoutCardPaymentMethodOptionsSetupFutureUsageX86d67e78>(it)
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: CheckoutCardPaymentMethodOptions,
        ) {
...
public fun checkoutCardPaymentMethodOptions(
    block: CheckoutCardPaymentMethodOptions.Builder.() -> Unit,
): CheckoutCardPaymentMethodOptions = CheckoutCardPaymentMethodOptions.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "CheckoutCardPaymentMethodOptions is missing required property '" + name + "'",
            )
