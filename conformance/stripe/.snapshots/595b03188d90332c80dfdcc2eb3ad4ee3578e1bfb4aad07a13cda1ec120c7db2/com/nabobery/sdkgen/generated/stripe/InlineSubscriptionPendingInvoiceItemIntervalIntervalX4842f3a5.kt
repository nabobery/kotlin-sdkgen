...
public sealed class InlineSubscriptionPendingInvoiceItemIntervalIntervalX4842f3a5 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineSubscriptionPendingInvoiceItemIntervalIntervalX4842f3a5 =
            when (value) {
                Day.value -> Day
                Month.value -> Month
                Week.value -> Week
    ...
    public object Serializer : KSerializer<InlineSubscriptionPendingInvoiceItemIntervalIntervalX4842f3a5> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineSubscriptionPendingInvoiceItemIntervalIntervalX4842f3a5",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineSubscriptionPendingInvoiceItemIntervalIntervalX4842f3a5 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineSubscriptionPendingInvoiceItemIntervalIntervalX4842f3a5,
        ) {
