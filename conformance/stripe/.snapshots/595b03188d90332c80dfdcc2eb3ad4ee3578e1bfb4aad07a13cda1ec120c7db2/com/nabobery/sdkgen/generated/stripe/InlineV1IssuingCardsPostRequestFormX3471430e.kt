...
public class InlineV1IssuingCardsPostRequestFormX3471430e(
     ...
     */
    public val cancellationReason: InlineV1IssuingCardsPostRequestFormCancellationReasonXe67ea8ba? = null,
    /**
    ...
    public class Builder {
        ...
        public fun build(): InlineV1IssuingCardsPostRequestFormX3471430e =
            InlineV1IssuingCardsPostRequestFormX3471430e(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1IssuingCardsPostRequestFormX3471430e =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1IssuingCardsPostRequestFormX3471430e> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1IssuingCardsPostRequestFormX3471430e must be a JSON object",
                    )
            return InlineV1IssuingCardsPostRequestFormX3471430e(
                cancellationReason =
                    rawObject["cancellation_reason"]?.let {
                        json.decodeFromJsonElement<InlineV1IssuingCardsPostRequestFormCancellationReasonXe67ea8ba>(it)
                    },
                expand = rawObject["expand"]?.let { json.decodeFromJsonElement<List<String>>(it) },
                metadata =
                    rawObject["metadata"]?.let {
                        json.decodeFromJsonElement<InlineV1IssuingCardsPostRequestFormMetadataX6dc5840c>(it)
                    },
                ...
                pin =
                    rawObject["pin"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1IssuingCardsPostRequestFormPinX79b8e620>(
                                it,
                            )
                    },
                shipping =
                    rawObject["shipping"]?.let {
                        json.decodeFromJsonElement<InlineV1IssuingCardsPostRequestFormShippingX07abe3a2>(it)
                    },
                spendingControls =
                    rawObject["spending_controls"]?.let {
                        json.decodeFromJsonElement<InlineV1IssuingCardsPostRequestFormSpendingControlsXfd59c836>(it)
                    },
                status =
                    rawObject["status"]?.let {
                        json.decodeFromJsonElement<InlineV1IssuingCardsPostRequestFormStatusX2c1e045b>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingCardsPostRequestFormX3471430e,
        ) {
...
public fun inlineV1IssuingCardsPostRequestFormX3471430e(
    block: InlineV1IssuingCardsPostRequestFormX3471430e.Builder.() -> Unit,
): InlineV1IssuingCardsPostRequestFormX3471430e = InlineV1IssuingCardsPostRequestFormX3471430e.build(block)
