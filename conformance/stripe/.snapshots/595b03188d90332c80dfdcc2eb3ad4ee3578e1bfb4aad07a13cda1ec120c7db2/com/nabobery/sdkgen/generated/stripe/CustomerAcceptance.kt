...
public class CustomerAcceptance(
    ...
    public object Serializer : KSerializer<CustomerAcceptance> {
        ...
        override fun deserialize(decoder: Decoder): CustomerAcceptance {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("CustomerAcceptance must be a JSON object")
...
public fun customerAcceptance(block: CustomerAcceptance.Builder.() -> Unit): CustomerAcceptance =
    CustomerAcceptance.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("CustomerAcceptance is missing required property '" + name + "'")
