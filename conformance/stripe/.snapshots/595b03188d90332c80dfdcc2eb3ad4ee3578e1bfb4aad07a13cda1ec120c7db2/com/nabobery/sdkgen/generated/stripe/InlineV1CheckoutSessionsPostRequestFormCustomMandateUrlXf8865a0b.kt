...
internal data class InlineV1CheckoutSessionsPostRequestFormCustomMandateUrlXf8865a0bInspection(
    ...
    public val matchesInlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsAnyOf2Xd2a7dbc0: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsAnyOf2Xd2a7dbc0,
            ).count {
                it
            }
}
...
public class InlineV1CheckoutSessionsPostRequestFormCustomMandateUrlXf8865a0b internal constructor(
    ...
    private val inspection: InlineV1CheckoutSessionsPostRequestFormCustomMandateUrlXf8865a0bInspection,
) {
    ...
    public val inlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsAnyOf2Xd2a7dbc0:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsAnyOf2Xd2a7dbc0) {
                json
                    .decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsAnyOf2Xd2a7dbc0>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1CheckoutSessionsPostRequestFormCustomMandateUrlXf8865a0bBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsAnyOf2Xd2a7dbc0) {
                    add(
                        InlineV1CheckoutSessionsPostRequestFormCustomMandateUrlXf8865a0bBranch.InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsAnyOf2Xd2a7dbc0,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1CheckoutSessionsPostRequestFormCustomMandateUrlXf8865a0b {
            val inspection = inspectInlineV1CheckoutSessionsPostRequestFormCustomMandateUrlXf8865a0b(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1CheckoutSessionsPostRequestFormCustomMandateUrlXf8865a0bNoMatchException(
                    "InlineV1CheckoutSessionsPostRequestFormCustomMandateUrlXf8865a0b matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormCustomMandateUrlXf8865a0b> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsPostRequestFormCustomMandateUrlXf8865a0b,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1CheckoutSessionsPostRequestFormCustomMandateUrlXf8865a0b",
...
private fun inspectInlineV1CheckoutSessionsPostRequestFormCustomMandateUrlXf8865a0b(
    element: JsonElement,
): InlineV1CheckoutSessionsPostRequestFormCustomMandateUrlXf8865a0bInspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsAnyOf2Xd2a7dbc0 =
        element
            .isJsonDecodable<InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsAnyOf2Xd2a7dbc0>()
    return InlineV1CheckoutSessionsPostRequestFormCustomMandateUrlXf8865a0bInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsAnyOf2Xd2a7dbc0) {
                    add(
                        "InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsAnyOf2Xd2a7dbc0: value does not match InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsAnyOf2Xd2a7dbc0",
                    )
                }
            },
    )
