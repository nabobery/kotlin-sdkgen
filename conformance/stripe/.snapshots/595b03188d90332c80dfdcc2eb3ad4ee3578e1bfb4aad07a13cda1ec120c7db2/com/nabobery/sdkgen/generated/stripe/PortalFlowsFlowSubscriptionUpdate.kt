...
public class PortalFlowsFlowSubscriptionUpdate(
    ...
    public object Serializer : KSerializer<PortalFlowsFlowSubscriptionUpdate> {
        ...
        override fun deserialize(decoder: Decoder): PortalFlowsFlowSubscriptionUpdate {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PortalFlowsFlowSubscriptionUpdate must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PortalFlowsFlowSubscriptionUpdate,
        ) {
...
public fun portalFlowsFlowSubscriptionUpdate(
    block: PortalFlowsFlowSubscriptionUpdate.Builder.() -> Unit,
): PortalFlowsFlowSubscriptionUpdate = PortalFlowsFlowSubscriptionUpdate.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "PortalFlowsFlowSubscriptionUpdate is missing required property '" + name + "'",
            )
