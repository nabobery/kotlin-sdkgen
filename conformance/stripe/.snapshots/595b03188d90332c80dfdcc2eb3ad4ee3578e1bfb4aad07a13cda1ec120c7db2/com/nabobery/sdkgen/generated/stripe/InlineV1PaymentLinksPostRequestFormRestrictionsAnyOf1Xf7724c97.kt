...
public class InlineV1PaymentLinksPostRequestFormRestrictionsAnyOf1Xf7724c97(
    public val completedSessions: InlineV1PaymentLinksPostRequestFormRestrictionsAnyOf1CompletedSessionsX64d038e1,
) {
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PaymentLinksPostRequestFormRestrictionsAnyOf1Xf7724c97 =
    ...
    public object Serializer : KSerializer<InlineV1PaymentLinksPostRequestFormRestrictionsAnyOf1Xf7724c97> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentLinksPostRequestFormRestrictionsAnyOf1Xf7724c97 must be a JSON object",
                    )
            val completedSessions =
                json
                    .decodeRequired<InlineV1PaymentLinksPostRequestFormRestrictionsAnyOf1CompletedSessionsX64d038e1>(
                        rawObject,
                        "completed_sessions",
                    )
            return InlineV1PaymentLinksPostRequestFormRestrictionsAnyOf1Xf7724c97(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentLinksPostRequestFormRestrictionsAnyOf1Xf7724c97,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentLinksPostRequestFormRestrictionsAnyOf1Xf7724c97(
    block: InlineV1PaymentLinksPostRequestFormRestrictionsAnyOf1Xf7724c97.Builder.() -> Unit,
): InlineV1PaymentLinksPostRequestFormRestrictionsAnyOf1Xf7724c97 =
    InlineV1PaymentLinksPostRequestFormRestrictionsAnyOf1Xf7724c97.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentLinksPostRequestFormRestrictionsAnyOf1Xf7724c97 is missing required property '" + name +
                    "'",
            )
