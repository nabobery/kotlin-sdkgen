...
public class InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataAcssDebitX8d5f67d1(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataAcssDebitX8d5f67d1 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataAcssDebitX8d5f67d1> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataAcssDebitX8d5f67d1 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataAcssDebitX8d5f67d1,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataAcssDebitX8d5f67d1(
    block: InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataAcssDebitX8d5f67d1.Builder.() -> Unit,
): InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataAcssDebitX8d5f67d1 =
    InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataAcssDebitX8d5f67d1.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataAcssDebitX8d5f67d1 is missing required property '" +
                    name +
                    "'",
            )
