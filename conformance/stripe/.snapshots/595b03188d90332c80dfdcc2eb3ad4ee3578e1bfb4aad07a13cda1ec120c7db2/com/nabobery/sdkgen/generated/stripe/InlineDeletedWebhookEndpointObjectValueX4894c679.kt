...
public sealed class InlineDeletedWebhookEndpointObjectValueX4894c679 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineDeletedWebhookEndpointObjectValueX4894c679 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineDeletedWebhookEndpointObjectValueX4894c679> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineDeletedWebhookEndpointObjectValueX4894c679",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineDeletedWebhookEndpointObjectValueX4894c679 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineDeletedWebhookEndpointObjectValueX4894c679,
        ) {
