...
public data class PaymentIntentPaymentMethodOptionsCardView(
    ...
    public val captureMethod: InlinePaymentIntentPaymentMethodOptionsCardCaptureMethodXfca17306? = null,
    public val installments: InlinePaymentIntentPaymentMethodOptionsCardInstallmentsX59a01bf9? = null,
    @SerialName("mandate_options")
    public val mandateOptions: InlinePaymentIntentPaymentMethodOptionsCardMandateOptionsX0b4df26f? = null,
    ...
    public val requestIncrementalAuthorization: InlinePaymentIntentPayment42bfRequestIncrementalAu57cdX0331026a? = null,
    @SerialName("request_multicapture")
    public val requestMulticapture: InlinePaymentIntentPaymentMethodOptionsCardRequestMulticaptureXcbbc4e7e? = null,
    @SerialName("request_overcapture")
    public val requestOvercapture: InlinePaymentIntentPaymentMethodOptionsCardRequestOvercaptureXcd6cdbce? = null,
    @SerialName("request_three_d_secure")
    public val requestThreeDSecure: InlinePaymentIntentPaymentMethodOptionsCardRequestThreeDSecureX468a01a4? = null,
    @SerialName("require_cvc_recollection")
    public val requireCvcRecollection: Boolean? = null,
    @SerialName("setup_future_usage")
    public val setupFutureUsage: InlinePaymentIntentPaymentMethodOptionsCardSetupFutureUsageX4dda0f45? = null,
...
public class PaymentIntentPaymentMethodOptionsCard(
    ...
    public class Builder {
        ...
        public fun build(): PaymentIntentPaymentMethodOptionsCard =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentIntentPaymentMethodOptionsCard =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentIntentPaymentMethodOptionsCard> {
        ...
        override fun deserialize(decoder: Decoder): PaymentIntentPaymentMethodOptionsCard {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentIntentPaymentMethodOptionsCard must be a JSON object")
            return PaymentIntentPaymentMethodOptionsCard(
                captureMethod =
                    rawObject["capture_method"]?.let {
                        json.decodeFromJsonElement<InlinePaymentIntentPaymentMethodOptionsCardCaptureMethodXfca17306>(
                            it,
                        )
                    },
                installments =
                    rawObject["installments"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                            ...
                            json
                                .decodeFromJsonElement<InlinePaymentIntentPaymentMethodOptionsCardInstallmentsX59a01bf9?>(
                                    element,
                                )
                        }
                    },
                mandateOptions =
                    rawObject["mandate_options"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                            ...
                            json
                                .decodeFromJsonElement<InlinePaymentIntentPaymentMethodOptionsCardMandateOptionsX0b4df26f?>(
                                    element,
                                )
                        }
                    },
                network =
                    rawObject["network"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentIntentPaymentMethodOptionsCardNetworkX0acd3a60?>(
                                element,
                            )
                        }
                    },
                requestExtendedAuthorization =
                    rawObject["request_extended_authorization"]?.let {
                        json
                            .decodeFromJsonElement<InlinePaymentIntentPaymentMethodOptionsCardRequestExtendedAuthorizationXf3b5b57d>(
                                it,
                            )
                    },
                requestIncrementalAuthorization =
                    rawObject["request_incremental_authorization"]?.let {
                        json.decodeFromJsonElement<InlinePaymentIntentPayment42bfRequestIncrementalAu57cdX0331026a>(it)
                    },
                requestMulticapture =
                    rawObject["request_multicapture"]?.let {
                        json
                            .decodeFromJsonElement<InlinePaymentIntentPaymentMethodOptionsCardRequestMulticaptureXcbbc4e7e>(
                                it,
                            )
                    },
                requestOvercapture =
                    rawObject["request_overcapture"]?.let {
                        json
                            .decodeFromJsonElement<InlinePaymentIntentPaymentMethodOptionsCardRequestOvercaptureXcd6cdbce>(
                                it,
                            )
                    },
                requestThreeDSecure =
                    rawObject["request_three_d_secure"]?.let { element ->
                        if (element ==
                            ...
                            json
                                .decodeFromJsonElement<InlinePaymentIntentPaymentMethodOptionsCardRequestThreeDSecureX468a01a4?>(
                                    element,
                                )
                        }
                    },
                ...
                setupFutureUsage =
                    rawObject["setup_future_usage"]?.let {
                        json
                            .decodeFromJsonElement<InlinePaymentIntentPaymentMethodOptionsCardSetupFutureUsageX4dda0f45>(
                                it,
                            )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentIntentPaymentMethodOptionsCard,
        ) {
...
public fun paymentIntentPaymentMethodOptionsCard(
    block: PaymentIntentPaymentMethodOptionsCard.Builder.() -> Unit,
): PaymentIntentPaymentMethodOptionsCard = PaymentIntentPaymentMethodOptionsCard.build(block)
