...
internal data class InlineV1TokensPostRequestFormPersonDocumentsCompanyAuthorizationItemX2edc7f31Inspection(
    ...
    public val matchesInlineV1TokensPostRequestFormPersonDocumentsCompanyAuthorizationAnyOf2Xcf354dc7: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1TokensPostRequestFormPersonDocumentsCompanyAuthorizationAnyOf2Xcf354dc7,
            ).count {
                it
            }
}
...
public class InlineV1TokensPostRequestFormPersonDocumentsCompanyAuthorizationItemX2edc7f31 internal constructor(
    ...
    private val inspection: InlineV1TokensPostRequestFormPersonDocumentsCompanyAuthorizationItemX2edc7f31Inspection,
) {
    ...
    public val inlineV1TokensPostRequestFormPersonDocumentsCompanyAuthorizationAnyOf2Xcf354dc7:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1TokensPostRequestFormPersonDocumentsCompanyAuthorizationAnyOf2Xcf354dc7) {
                json
                    .decodeFromJsonElement<InlineV1TokensPostRequestFormPersonDocumentsCompanyAuthorizationAnyOf2Xcf354dc7>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1TokensPostRequestFormPersonDocumentsCompanyAuthorizationItemX2edc7f31Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1TokensPostRequestFormPersonDocumentsCompanyAuthorizationAnyOf2Xcf354dc7) {
                    add(
                        InlineV1TokensPostRequestFormPersonDocumentsCompanyAuthorizationItemX2edc7f31Branch.InlineV1TokensPostRequestFormPersonDocumentsCompanyAuthorizationAnyOf2Xcf354dc7,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1TokensPostRequestFormPersonDocumentsCompanyAuthorizationItemX2edc7f31 {
            val inspection = inspectInlineV1TokensPostRequestFormPersonDocumentsCompanyAuthorizationItemX2edc7f31(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1TokensPostRequestFormPersonDocumentsCompanyAuthorizationItemX2edc7f31NoMatchException(
                    "InlineV1TokensPostRequestFormPersonDocumentsCompanyAuthorizationItemX2edc7f31 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1TokensPostRequestFormPersonDocumentsCompanyAuthorizationItemX2edc7f31> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TokensPostRequestFormPersonDocumentsCompanyAuthorizationItemX2edc7f31,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1TokensPostRequestFormPersonDocumentsCompanyAuthorizationItemX2edc7f31",
...
private fun inspectInlineV1TokensPostRequestFormPersonDocumentsCompanyAuthorizationItemX2edc7f31(
    element: JsonElement,
): InlineV1TokensPostRequestFormPersonDocumentsCompanyAuthorizationItemX2edc7f31Inspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1TokensPostRequestFormPersonDocumentsCompanyAuthorizationAnyOf2Xcf354dc7 =
        element
            .isJsonDecodable<InlineV1TokensPostRequestFormPersonDocumentsCompanyAuthorizationAnyOf2Xcf354dc7>()
    return InlineV1TokensPostRequestFormPersonDocumentsCompanyAuthorizationItemX2edc7f31Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1TokensPostRequestFormPersonDocumentsCompanyAuthorizationAnyOf2Xcf354dc7) {
                    add(
                        "InlineV1TokensPostRequestFormPersonDocumentsCompanyAuthorizationAnyOf2Xcf354dc7: value does not match InlineV1TokensPostRequestFormPersonDocumentsCompanyAuthorizationAnyOf2Xcf354dc7",
                    )
                }
            },
    )
