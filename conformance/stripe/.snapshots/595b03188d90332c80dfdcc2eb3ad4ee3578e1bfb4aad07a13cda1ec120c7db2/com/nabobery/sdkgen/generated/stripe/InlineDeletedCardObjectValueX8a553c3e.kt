...
public sealed class InlineDeletedCardObjectValueX8a553c3e {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineDeletedCardObjectValueX8a553c3e =
            when (value) {
                Card.value -> Card
    ...
    public object Serializer : KSerializer<InlineDeletedCardObjectValueX8a553c3e> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineDeletedCardObjectValueX8a553c3e",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineDeletedCardObjectValueX8a553c3e =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineDeletedCardObjectValueX8a553c3e,
        ) {
