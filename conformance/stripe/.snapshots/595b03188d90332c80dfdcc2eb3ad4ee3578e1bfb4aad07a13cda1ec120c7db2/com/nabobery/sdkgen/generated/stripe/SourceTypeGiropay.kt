...
public class SourceTypeGiropay(
    ...
    public class Builder {
        ...
        public fun build(): SourceTypeGiropay =
            SourceTypeGiropay(
                bankCode = bankCode,
                bankName = bankName,
                bic = bic,
        ...
        override fun deserialize(decoder: Decoder): SourceTypeGiropay {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("SourceTypeGiropay must be a JSON object")
...
public fun sourceTypeGiropay(block: SourceTypeGiropay.Builder.() -> Unit): SourceTypeGiropay =
    SourceTypeGiropay.build(block)
