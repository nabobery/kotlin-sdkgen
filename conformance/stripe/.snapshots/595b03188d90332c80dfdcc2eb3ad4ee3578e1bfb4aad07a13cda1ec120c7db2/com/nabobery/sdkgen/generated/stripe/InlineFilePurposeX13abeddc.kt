...
public sealed class InlineFilePurposeX13abeddc {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineFilePurposeX13abeddc =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineFilePurposeX13abeddc> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineFilePurposeX13abeddc",
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineFilePurposeX13abeddc,
        ) {
