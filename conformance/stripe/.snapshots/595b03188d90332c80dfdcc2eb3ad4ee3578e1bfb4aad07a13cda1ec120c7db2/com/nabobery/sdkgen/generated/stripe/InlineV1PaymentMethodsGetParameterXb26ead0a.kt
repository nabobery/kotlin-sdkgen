...
public sealed class InlineV1PaymentMethodsGetParameterXb26ead0a {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1PaymentMethodsGetParameterXb26ead0a =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1PaymentMethodsGetParameterXb26ead0a> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1PaymentMethodsGetParameterXb26ead0a",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1PaymentMethodsGetParameterXb26ead0a =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentMethodsGetParameterXb26ead0a,
        ) {
