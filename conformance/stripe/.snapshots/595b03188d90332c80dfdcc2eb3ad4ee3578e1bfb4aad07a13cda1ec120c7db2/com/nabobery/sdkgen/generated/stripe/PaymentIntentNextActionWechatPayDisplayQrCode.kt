...
public class PaymentIntentNextActionWechatPayDisplayQrCode(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentIntentNextActionWechatPayDisplayQrCode =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentIntentNextActionWechatPayDisplayQrCode> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "PaymentIntentNextActionWechatPayDisplayQrCode must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentIntentNextActionWechatPayDisplayQrCode,
        ) {
...
public fun paymentIntentNextActionWechatPayDisplayQrCode(
    block: PaymentIntentNextActionWechatPayDisplayQrCode.Builder.() -> Unit,
): PaymentIntentNextActionWechatPayDisplayQrCode = PaymentIntentNextActionWechatPayDisplayQrCode.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "PaymentIntentNextActionWechatPayDisplayQrCode is missing required property '" + name + "'",
            )
