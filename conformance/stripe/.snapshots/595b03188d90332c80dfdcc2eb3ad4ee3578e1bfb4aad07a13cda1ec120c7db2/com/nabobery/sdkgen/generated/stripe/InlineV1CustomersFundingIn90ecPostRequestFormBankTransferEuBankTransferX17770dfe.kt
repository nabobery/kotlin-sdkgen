...
public class InlineV1CustomersFundingIn90ecPostRequestFormBankTransferEuBankTransferX17770dfe(
    ...
    public object Serializer : KSerializer<InlineV1CustomersFundingIn90ecPostRequestFormBankTransferEuBankTransferX17770dfe> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CustomersFundingIn90ecPostRequestFormBankTransferEuBankTransferX17770dfe must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersFundingIn90ecPostRequestFormBankTransferEuBankTransferX17770dfe,
        ) {
            val jsonEncoder =
...
public fun inlineV1CustomersFundingIn90ecPostRequestFormBankTransferEuBankTransferX17770dfe(
    block: InlineV1CustomersFundingIn90ecPostRequestFormBankTransferEuBankTransferX17770dfe.Builder.() -> Unit,
): InlineV1CustomersFundingIn90ecPostRequestFormBankTransferEuBankTransferX17770dfe =
    InlineV1CustomersFundingIn90ecPostRequestFormBankTransferEuBankTransferX17770dfe.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1CustomersFundingIn90ecPostRequestFormBankTransferEuBankTransferX17770dfe is missing required property '" +
                    name +
                    "'",
            )
