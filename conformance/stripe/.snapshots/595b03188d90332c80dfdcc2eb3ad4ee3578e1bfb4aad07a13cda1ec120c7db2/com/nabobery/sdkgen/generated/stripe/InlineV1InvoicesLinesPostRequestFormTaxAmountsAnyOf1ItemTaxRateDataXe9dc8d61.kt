...
public class InlineV1InvoicesLinesPostRequestFormTaxAmountsAnyOf1ItemTaxRateDataXe9dc8d61(
    ...
    public val jurisdictionLevel: InlineV1InvoicesLinesPostRequestFormTaxAmountsAnyOf1JurisdictionLevelXd6b8b729? = null,
    public val state: String? = null,
    public val taxType: InlineV1InvoicesLinesPostRequestFormTaxAmountsAnyOf1ItemTaxTypeXc79aef6e? = null,
) {
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1InvoicesLinesPostRequestFormTaxAmountsAnyOf1ItemTaxRateDataXe9dc8d61 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1InvoicesLinesPostRequestFormTaxAmountsAnyOf1ItemTaxRateDataXe9dc8d61> {
        ...
        override fun deserialize(
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1InvoicesLinesPostRequestFormTaxAmountsAnyOf1ItemTaxRateDataXe9dc8d61 must be a JSON object",
                    )
            ...
            return InlineV1InvoicesLinesPostRequestFormTaxAmountsAnyOf1ItemTaxRateDataXe9dc8d61(
                ...
                jurisdictionLevel =
                    rawObject["jurisdiction_level"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1InvoicesLinesPostRequestFormTaxAmountsAnyOf1JurisdictionLevelXd6b8b729>(
                                it,
                            )
                    },
                ...
                taxType =
                    rawObject["tax_type"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1InvoicesLinesPostRequestFormTaxAmountsAnyOf1ItemTaxTypeXc79aef6e>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesLinesPostRequestFormTaxAmountsAnyOf1ItemTaxRateDataXe9dc8d61,
        ) {
            val jsonEncoder =
...
public fun inlineV1InvoicesLinesPostRequestFormTaxAmountsAnyOf1ItemTaxRateDataXe9dc8d61(
    block: InlineV1InvoicesLinesPostRequestFormTaxAmountsAnyOf1ItemTaxRateDataXe9dc8d61.Builder.() -> Unit,
): InlineV1InvoicesLinesPostRequestFormTaxAmountsAnyOf1ItemTaxRateDataXe9dc8d61 =
    InlineV1InvoicesLinesPostRequestFormTaxAmountsAnyOf1ItemTaxRateDataXe9dc8d61.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1InvoicesLinesPostRequestFormTaxAmountsAnyOf1ItemTaxRateDataXe9dc8d61 is missing required property '" +
                    name +
                    "'",
            )
