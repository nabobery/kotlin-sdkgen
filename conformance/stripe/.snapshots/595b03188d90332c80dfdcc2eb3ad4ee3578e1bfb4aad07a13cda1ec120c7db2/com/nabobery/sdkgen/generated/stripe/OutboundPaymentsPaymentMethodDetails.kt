...
public class OutboundPaymentsPaymentMethodDetails(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): OutboundPaymentsPaymentMethodDetails =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<OutboundPaymentsPaymentMethodDetails> {
        ...
        override fun deserialize(decoder: Decoder): OutboundPaymentsPaymentMethodDetails {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("OutboundPaymentsPaymentMethodDetails must be a JSON object")
            ...
            return OutboundPaymentsPaymentMethodDetails(
                ...
                financialAccount =
                    rawObject["financial_account"]?.let {
                        json.decodeFromJsonElement<OutboundPaymentsPaymentMethodDetailsFinancialAccount>(it)
                    },
                usBankAccount =
                    rawObject["us_bank_account"]?.let {
                        json.decodeFromJsonElement<OutboundPaymentsPaymentMethodDetailsUsBankAccount>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: OutboundPaymentsPaymentMethodDetails,
        ) {
...
public fun outboundPaymentsPaymentMethodDetails(
    block: OutboundPaymentsPaymentMethodDetails.Builder.() -> Unit,
): OutboundPaymentsPaymentMethodDetails = OutboundPaymentsPaymentMethodDetails.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "OutboundPaymentsPaymentMethodDetails is missing required property '" + name + "'",
            )
