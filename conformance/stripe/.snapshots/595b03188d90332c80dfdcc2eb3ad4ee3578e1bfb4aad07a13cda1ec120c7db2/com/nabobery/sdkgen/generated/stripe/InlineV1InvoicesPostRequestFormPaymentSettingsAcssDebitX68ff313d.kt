...
internal data class InlineV1InvoicesPostRequestFormPaymentSettingsAcssDebitX68ff313dInspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X13d37131,
                matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2X00f4c274,
            ).count {
                it
            }
}
...
public class InlineV1InvoicesPostRequestFormPaymentSettingsAcssDebitX68ff313d internal constructor(
    ...
    private val inspection: InlineV1InvoicesPostRequestFormPaymentSettingsAcssDebitX68ff313dInspection,
) {
    public val inlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X13d37131:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X13d37131) {
                json
                    .decodeFromJsonElement<InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X13d37131>(
                        raw,
                    )
            } else {
                null
    ...
    public val inlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2X00f4c274:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2X00f4c274) {
                json
                    .decodeFromJsonElement<InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2X00f4c274>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches:
        ...
        get() =
            buildSet {
                if (inspection.matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X13d37131) {
                    add(
                        InlineV1InvoicesPostRequestFormPaymentSettingsAcssDebitX68ff313dBranch.InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X13d37131,
                    )
                }
                if (inspection.matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2X00f4c274) {
                    add(
                        InlineV1InvoicesPostRequestFormPaymentSettingsAcssDebitX68ff313dBranch.InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2X00f4c274,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1InvoicesPostRequestFormPaymentSettingsAcssDebitX68ff313d {
            val inspection = inspectInlineV1InvoicesPostRequestFormPaymentSettingsAcssDebitX68ff313d(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1InvoicesPostRequestFormPaymentSettingsAcssDebitX68ff313dNoMatchException(
                    "InlineV1InvoicesPostRequestFormPaymentSettingsAcssDebitX68ff313d matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1InvoicesPostRequestFormPaymentSettingsAcssDebitX68ff313d> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesPostRequestFormPaymentSettingsAcssDebitX68ff313d,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1InvoicesPostRequestFormPaymentSettingsAcssDebitX68ff313d",
...
private fun inspectInlineV1InvoicesPostRequestFormPaymentSettingsAcssDebitX68ff313d(
    element: JsonElement,
): InlineV1InvoicesPostRequestFormPaymentSettingsAcssDebitX68ff313dInspection {
    val matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X13d37131 =
        element
            .isJsonDecodable<InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X13d37131>()
    val matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2X00f4c274 =
        element
            .isJsonDecodable<InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2X00f4c274>()
    return InlineV1InvoicesPostRequestFormPaymentSettingsAcssDebitX68ff313dInspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X13d37131) {
                    add(
                        "InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X13d37131: value does not match InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X13d37131",
                    )
                }
                if (!matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2X00f4c274) {
                    add(
                        "InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2X00f4c274: value does not match InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2X00f4c274",
                    )
                }
            },
    )
