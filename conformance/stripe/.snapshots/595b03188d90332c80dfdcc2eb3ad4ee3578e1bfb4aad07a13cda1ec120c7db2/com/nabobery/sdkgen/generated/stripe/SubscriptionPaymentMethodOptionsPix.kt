...
public class SubscriptionPaymentMethodOptionsPix(
    ...
    public class Builder {
        ...
        public fun build(): SubscriptionPaymentMethodOptionsPix =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): SubscriptionPaymentMethodOptionsPix =
    ...
    public object Serializer : KSerializer<SubscriptionPaymentMethodOptionsPix> {
        ...
        override fun deserialize(decoder: Decoder): SubscriptionPaymentMethodOptionsPix {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("SubscriptionPaymentMethodOptionsPix must be a JSON object")
            return SubscriptionPaymentMethodOptionsPix(
                ...
                mandateOptions =
                    rawObject["mandate_options"]?.let {
                        json.decodeFromJsonElement<SubscriptionPaymentMethodOptionsMandateOptionsPix>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: SubscriptionPaymentMethodOptionsPix,
        ) {
...
public fun subscriptionPaymentMethodOptionsPix(
    block: SubscriptionPaymentMethodOptionsPix.Builder.() -> Unit,
): SubscriptionPaymentMethodOptionsPix = SubscriptionPaymentMethodOptionsPix.build(block)
