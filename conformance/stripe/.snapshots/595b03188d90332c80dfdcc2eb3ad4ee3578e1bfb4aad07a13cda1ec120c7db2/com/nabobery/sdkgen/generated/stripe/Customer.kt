...
@Serializable
public data class CustomerView(
...
public class Customer(
    ...
    public class Builder {
         ...
         * finalizes.
         */
        public var invoiceCreditBalance: Map<String, Int>? = null
    ...
    public object Serializer : KSerializer<Customer> {
        ...
        override fun deserialize(decoder: Decoder): Customer {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("Customer must be a JSON object")
            ...
            return Customer(
                ...
                address =
                    rawObject["address"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineCustomerAddressX3f7817b0?>(element)
                        }
                    },
                ...
                cashBalance =
                    rawObject["cash_balance"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineCustomerCashBalanceXe45dcf30?>(element)
                        }
                    },
                currency =
                ...
                defaultSource =
                    rawObject["default_source"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineCustomerDefaultSourceXa03c4ae9?>(element)
                        }
                    },
                delinquent =
                    rawObject["delinquent"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                discount =
                    rawObject["discount"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineCustomerDiscountXa4928a5b?>(element)
                        }
                    },
                email =
                ...
                invoiceCreditBalance =
                    rawObject["invoice_credit_balance"]?.let {
                        json.decodeFromJsonElement<Map<String, Int>>(
                            it,
                        )
                    },
                invoicePrefix =
                    rawObject["invoice_prefix"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                invoiceSettings =
                    rawObject["invoice_settings"]?.let {
                        json
                            .decodeFromJsonElement<InvoiceSettingCustomerSetting>(
                                it,
                            )
                    },
                ...
                shipping =
                    rawObject["shipping"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineCustomerShippingXa88b4f3f?>(element)
                        }
                    },
                sources =
                    rawObject["sources"]?.let {
                        json.decodeFromJsonElement<InlineCustomerSourcesX68a9816b>(
                            it,
                        )
                    },
                subscriptions =
                    rawObject["subscriptions"]?.let {
                        json.decodeFromJsonElement<InlineCustomerSubscriptionsX194943c7>(it)
                    },
                tax = rawObject["tax"]?.let { json.decodeFromJsonElement<CustomerTax>(it) },
                taxExempt =
                    rawObject["tax_exempt"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineCustomerTaxExemptX8cad7368?>(element)
                        }
                    },
                ...
                testClock =
                    rawObject["test_clock"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineCustomerTestClockX4aeba957?>(element)
                        }
                    },
            )
        }
