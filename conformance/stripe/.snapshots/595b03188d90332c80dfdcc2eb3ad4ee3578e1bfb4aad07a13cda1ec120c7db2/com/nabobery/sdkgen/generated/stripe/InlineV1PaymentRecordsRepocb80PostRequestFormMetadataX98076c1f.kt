...
internal data class InlineV1PaymentRecordsRepocb80PostRequestFormMetadataX98076c1fInspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1PaymentRecordsRepocb80PostRequestFormMetadataAnyOf2Xf0788f7b,
            ).count { it }
}
...
public class InlineV1PaymentRecordsRepocb80PostRequestFormMetadataX98076c1f internal constructor(
    ...
    public val inlineV1PaymentRecordsRepocb80PostRequestFormMetadataAnyOf2Xf0788f7b:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1PaymentRecordsRepocb80PostRequestFormMetadataAnyOf2Xf0788f7b) {
                json
                    .decodeFromJsonElement<InlineV1PaymentRecordsRepocb80PostRequestFormMetadataAnyOf2Xf0788f7b>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1PaymentRecordsRepocb80PostRequestFormMetadataX98076c1fBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1PaymentRecordsRepocb80PostRequestFormMetadataAnyOf2Xf0788f7b) {
                    add(
                        InlineV1PaymentRecordsRepocb80PostRequestFormMetadataX98076c1fBranch.InlineV1PaymentRecordsRepocb80PostRequestFormMetadataAnyOf2Xf0788f7b,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1PaymentRecordsRepocb80PostRequestFormMetadataX98076c1f {
            val inspection = inspectInlineV1PaymentRecordsRepocb80PostRequestFormMetadataX98076c1f(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1PaymentRecordsRepocb80PostRequestFormMetadataX98076c1fNoMatchException(
                    "InlineV1PaymentRecordsRepocb80PostRequestFormMetadataX98076c1f matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1PaymentRecordsRepocb80PostRequestFormMetadataX98076c1f> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentRecordsRepocb80PostRequestFormMetadataX98076c1f,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1PaymentRecordsRepocb80PostRequestFormMetadataX98076c1f",
...
private fun inspectInlineV1PaymentRecordsRepocb80PostRequestFormMetadataX98076c1f(
    element: JsonElement,
): InlineV1PaymentRecordsRepocb80PostRequestFormMetadataX98076c1fInspection {
    val matchesBranch1 = element.isJsonDecodable<JsonObject>()
    val matchesInlineV1PaymentRecordsRepocb80PostRequestFormMetadataAnyOf2Xf0788f7b =
        element
            .isJsonDecodable<InlineV1PaymentRecordsRepocb80PostRequestFormMetadataAnyOf2Xf0788f7b>()
    return InlineV1PaymentRecordsRepocb80PostRequestFormMetadataX98076c1fInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1PaymentRecordsRepocb80PostRequestFormMetadataAnyOf2Xf0788f7b) {
                    add(
                        "InlineV1PaymentRecordsRepocb80PostRequestFormMetadataAnyOf2Xf0788f7b: value does not match InlineV1PaymentRecordsRepocb80PostRequestFormMetadataAnyOf2Xf0788f7b",
                    )
                }
            },
    )
