...
public class InlineProductTaxCodeXef95fe7f internal constructor(
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineProductTaxCodeXef95fe7f {
            val inspection = inspectInlineProductTaxCodeXef95fe7f(raw)
            if (inspection.matchCount == 0) {
                throw InlineProductTaxCodeXef95fe7fNoMatchException(
                    "InlineProductTaxCodeXef95fe7f matched 0 branches: " + inspection.failures.joinToString("; "),
                )
            }
    ...
    public object Serializer : KSerializer<InlineProductTaxCodeXef95fe7f> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineProductTaxCodeXef95fe7f,
        ) {
