...
public class InlineCustomerBalanceTransactionCustomerX6a99f473 internal constructor(
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineCustomerBalanceTransactionCustomerX6a99f473 {
            val inspection = inspectInlineCustomerBalanceTransactionCustomerX6a99f473(raw)
            if (inspection.matchCount == 0) {
                throw InlineCustomerBalanceTransactionCustomerX6a99f473NoMatchException(
                    "InlineCustomerBalanceTransactionCustomerX6a99f473 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineCustomerBalanceTransactionCustomerX6a99f473> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineCustomerBalanceTransactionCustomerX6a99f473,
        ) {
...
private fun inspectInlineCustomerBalanceTransactionCustomerX6a99f473(
    element: JsonElement,
): InlineCustomerBalanceTransactionCustomerX6a99f473Inspection {
