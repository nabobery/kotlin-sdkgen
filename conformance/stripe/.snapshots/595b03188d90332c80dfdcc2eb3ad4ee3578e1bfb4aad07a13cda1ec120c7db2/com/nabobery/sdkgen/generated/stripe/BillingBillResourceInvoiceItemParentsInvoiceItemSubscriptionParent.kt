...
public class BillingBillResourceInvoiceItemParentsInvoiceItemSubscriptionParent(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): BillingBillResourceInvoiceItemParentsInvoiceItemSubscriptionParent = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<BillingBillResourceInvoiceItemParentsInvoiceItemSubscriptionParent> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "BillingBillResourceInvoiceItemParentsInvoiceItemSubscriptionParent must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: BillingBillResourceInvoiceItemParentsInvoiceItemSubscriptionParent,
        ) {
            val jsonEncoder =
...
public fun billingBillResourceInvoiceItemParentsInvoiceItemSubscriptionParent(
    block: BillingBillResourceInvoiceItemParentsInvoiceItemSubscriptionParent.Builder.() -> Unit,
): BillingBillResourceInvoiceItemParentsInvoiceItemSubscriptionParent =
    BillingBillResourceInvoiceItemParentsInvoiceItemSubscriptionParent.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "BillingBillResourceInvoiceItemParentsInvoiceItemSubscriptionParent is missing required property '" +
                    name +
                    "'",
            )
