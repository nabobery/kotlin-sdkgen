...
public class InlineV1PaymentIntentsConfirmPostRequestFormX344a5cd6(
     ...
     */
    public val amountDetails: InlineV1PaymentIntentsConfirmPostRequestFormAmountDetailsX7bf357ab? = null,
    /**
     ...
     */
    public val captureMethod: InlineV1PaymentIntentsConfirmPostRequestFormCaptureMethodX5c4aa7af? = null,
    /**
     ...
     */
    public val paymentDetails: InlineV1PaymentIntentsConfirmPostRequestFormPaymentDetailsXa51d66fb? = null,
    /**
     ...
     */
    public val paymentMethodData: InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataX34ae9b07? = null,
    /**
     * Payment method-specific configuration for this PaymentIntent.
     */
    public val paymentMethodOptions: InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsX6c469682? = null,
    /**
     ...
     */
    public val radarOptions: InlineV1PaymentIntentsConfirmPostRequestFormRadarOptionsXe78ea4d8? = null,
    /**
     ...
     */
    public val receiptEmail: InlineV1PaymentIntentsConfirmPostRequestFormReceiptEmailX03df02bb? = null,
    /**
     ...
     */
    public val setupFutureUsage: InlineV1PaymentIntentsConfirmPostRequestFormSetupFutureUsageXd1fd8261? = null,
    /**
    ...
    public class Builder {
        ...
        public fun build(): InlineV1PaymentIntentsConfirmPostRequestFormX344a5cd6 =
            InlineV1PaymentIntentsConfirmPostRequestFormX344a5cd6(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PaymentIntentsConfirmPostRequestFormX344a5cd6 =
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsConfirmPostRequestFormX344a5cd6> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsConfirmPostRequestFormX344a5cd6 must be a JSON object",
                    )
            return InlineV1PaymentIntentsConfirmPostRequestFormX344a5cd6(
                amountDetails =
                    rawObject["amount_details"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormAmountDetailsX7bf357ab>(
                            it,
                        )
                    },
                ...
                captureMethod =
                    rawObject["capture_method"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormCaptureMethodX5c4aa7af>(
                            it,
                        )
                    },
                ...
                errorOnRequiresAction =
                    rawObject["error_on_requires_action"]?.let {
                        json
                ...
                excludedPaymentMethodTypes =
                    rawObject["excluded_payment_method_types"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormExcludedPaymentMethodTypesXe9ef34f8>(
                                it,
                            )
                    },
                ...
                hooks =
                    rawObject["hooks"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormHooksX4e3fcdd5>(it)
                    },
                mandate = rawObject["mandate"]?.let { json.decodeFromJsonElement<String>(it) },
                mandateData =
                    rawObject["mandate_data"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormMandateDataX78d487a8>(it)
                    },
                offSession =
                    rawObject["off_session"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormOffSessionX26a94eab>(it)
                    },
                paymentDetails =
                    rawObject["payment_details"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormPaymentDetailsXa51d66fb>(
                            it,
                        )
                    },
                ...
                paymentMethodData =
                    rawObject["payment_method_data"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataX34ae9b07>(
                                it,
                            )
                    },
                paymentMethodOptions =
                    rawObject["payment_method_options"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsX6c469682>(
                                it,
                            )
                    },
                paymentMethodTypes =
                ...
                radarOptions =
                    rawObject["radar_options"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormRadarOptionsXe78ea4d8>(
                            it,
                        )
                    },
                receiptEmail =
                    rawObject["receipt_email"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormReceiptEmailX03df02bb>(
                            it,
                        )
                    },
                ...
                setupFutureUsage =
                    rawObject["setup_future_usage"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormSetupFutureUsageXd1fd8261>(
                                it,
                            )
                    },
                shipping =
                    rawObject["shipping"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormShippingXa4cb0fdf>(it)
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsConfirmPostRequestFormX344a5cd6,
        ) {
...
public fun inlineV1PaymentIntentsConfirmPostRequestFormX344a5cd6(
    block: InlineV1PaymentIntentsConfirmPostRequestFormX344a5cd6.Builder.() -> Unit,
): InlineV1PaymentIntentsConfirmPostRequestFormX344a5cd6 =
    InlineV1PaymentIntentsConfirmPostRequestFormX344a5cd6.build(block)
