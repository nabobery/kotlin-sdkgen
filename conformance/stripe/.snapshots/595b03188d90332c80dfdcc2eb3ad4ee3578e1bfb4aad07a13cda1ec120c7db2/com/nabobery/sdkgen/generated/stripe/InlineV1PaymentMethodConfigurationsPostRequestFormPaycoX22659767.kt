...
public class InlineV1PaymentMethodConfigurationsPostRequestFormPaycoX22659767(
    public val displayPreference: InlineV1PaymentMethodConfidc49PostRequestFormPaycoDisplayPreferenceX8e935dc0? = null,
) {
    public class Builder {
        public var displayPreference:
            InlineV1PaymentMethodConfidc49PostRequestFormPaycoDisplayPreferenceX8e935dc0? = null

        public fun build(): InlineV1PaymentMethodConfigurationsPostRequestFormPaycoX22659767 =
            InlineV1PaymentMethodConfigurationsPostRequestFormPaycoX22659767(
                displayPreference = displayPreference,
            )
    }

    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PaymentMethodConfigurationsPostRequestFormPaycoX22659767 =
    ...
    public object Serializer : KSerializer<InlineV1PaymentMethodConfigurationsPostRequestFormPaycoX22659767> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentMethodConfigurationsPostRequestFormPaycoX22659767 must be a JSON object",
                    )
            return InlineV1PaymentMethodConfigurationsPostRequestFormPaycoX22659767(
                displayPreference =
                    rawObject["display_preference"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentMethodConfidc49PostRequestFormPaycoDisplayPreferenceX8e935dc0>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentMethodConfigurationsPostRequestFormPaycoX22659767,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentMethodConfigurationsPostRequestFormPaycoX22659767(
    block: InlineV1PaymentMethodConfigurationsPostRequestFormPaycoX22659767.Builder.() -> Unit,
): InlineV1PaymentMethodConfigurationsPostRequestFormPaycoX22659767 =
