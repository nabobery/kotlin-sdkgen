...
public sealed class InlineV1PaymentMethodConfidc49PostRequestFormUpiPreferenceX8eb42b81 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1PaymentMethodConfidc49PostRequestFormUpiPreferenceX8eb42b81 =
            when (value) {
                None.value -> None
                Off.value -> Off
                On.value -> On
    ...
    public object Serializer : KSerializer<InlineV1PaymentMethodConfidc49PostRequestFormUpiPreferenceX8eb42b81> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1PaymentMethodConfidc49PostRequestFormUpiPreferenceX8eb42b81",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1PaymentMethodConfidc49PostRequestFormUpiPreferenceX8eb42b81 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentMethodConfidc49PostRequestFormUpiPreferenceX8eb42b81,
        ) {
