...
public class TaxProductResourceJurisdiction(
    ...
    public object Serializer : KSerializer<TaxProductResourceJurisdiction> {
        ...
        override fun deserialize(decoder: Decoder): TaxProductResourceJurisdiction {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("TaxProductResourceJurisdiction must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: TaxProductResourceJurisdiction,
        ) {
...
public fun taxProductResourceJurisdiction(
    block: TaxProductResourceJurisdiction.Builder.() -> Unit,
): TaxProductResourceJurisdiction = TaxProductResourceJurisdiction.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "TaxProductResourceJurisdiction is missing required property '" + name + "'",
            )
