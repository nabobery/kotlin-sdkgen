...
internal data class InlineV1QuotesPostRequestFormTransferDataXa5f9394fInspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesInlineV1QuotesPostRequestFormTransferDataAnyOf1Xaf14f9ba,
                matchesInlineV1QuotesPostRequestFormTransferDataAnyOf2Xd7044e71,
            ).count {
                it
            }
}
...
public class InlineV1QuotesPostRequestFormTransferDataXa5f9394f internal constructor(
    ...
    public val inlineV1QuotesPostRequestFormTransferDataAnyOf1Xaf14f9ba:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1QuotesPostRequestFormTransferDataAnyOf1Xaf14f9ba) {
                json
                    .decodeFromJsonElement<InlineV1QuotesPostRequestFormTransferDataAnyOf1Xaf14f9ba>(
                        raw,
                    )
            } else {
                null
    ...
    public val inlineV1QuotesPostRequestFormTransferDataAnyOf2Xd7044e71:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1QuotesPostRequestFormTransferDataAnyOf2Xd7044e71) {
                json
                    .decodeFromJsonElement<InlineV1QuotesPostRequestFormTransferDataAnyOf2Xd7044e71>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1QuotesPostRequestFormTransferDataXa5f9394fBranch>
        get() =
            buildSet {
                if (inspection.matchesInlineV1QuotesPostRequestFormTransferDataAnyOf1Xaf14f9ba) {
                    add(
                        InlineV1QuotesPostRequestFormTransferDataXa5f9394fBranch.InlineV1QuotesPostRequestFormTransferDataAnyOf1Xaf14f9ba,
                    )
                }
                if (inspection.matchesInlineV1QuotesPostRequestFormTransferDataAnyOf2Xd7044e71) {
                    add(
                        InlineV1QuotesPostRequestFormTransferDataXa5f9394fBranch.InlineV1QuotesPostRequestFormTransferDataAnyOf2Xd7044e71,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1QuotesPostRequestFormTransferDataXa5f9394f {
            val inspection = inspectInlineV1QuotesPostRequestFormTransferDataXa5f9394f(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1QuotesPostRequestFormTransferDataXa5f9394fNoMatchException(
                    "InlineV1QuotesPostRequestFormTransferDataXa5f9394f matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1QuotesPostRequestFormTransferDataXa5f9394f> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1QuotesPostRequestFormTransferDataXa5f9394f,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1QuotesPostRequestFormTransferDataXa5f9394f",
...
private fun inspectInlineV1QuotesPostRequestFormTransferDataXa5f9394f(
    element: JsonElement,
): InlineV1QuotesPostRequestFormTransferDataXa5f9394fInspection {
    val matchesInlineV1QuotesPostRequestFormTransferDataAnyOf1Xaf14f9ba =
        element
            .isJsonDecodable<InlineV1QuotesPostRequestFormTransferDataAnyOf1Xaf14f9ba>()
    val matchesInlineV1QuotesPostRequestFormTransferDataAnyOf2Xd7044e71 =
        element
            .isJsonDecodable<InlineV1QuotesPostRequestFormTransferDataAnyOf2Xd7044e71>()
    return InlineV1QuotesPostRequestFormTransferDataXa5f9394fInspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1QuotesPostRequestFormTransferDataAnyOf1Xaf14f9ba) {
                    add(
                        "InlineV1QuotesPostRequestFormTransferDataAnyOf1Xaf14f9ba: value does not match InlineV1QuotesPostRequestFormTransferDataAnyOf1Xaf14f9ba",
                    )
                }
                if (!matchesInlineV1QuotesPostRequestFormTransferDataAnyOf2Xd7044e71) {
                    add(
                        "InlineV1QuotesPostRequestFormTransferDataAnyOf2Xd7044e71: value does not match InlineV1QuotesPostRequestFormTransferDataAnyOf2Xd7044e71",
                    )
                }
            },
    )
