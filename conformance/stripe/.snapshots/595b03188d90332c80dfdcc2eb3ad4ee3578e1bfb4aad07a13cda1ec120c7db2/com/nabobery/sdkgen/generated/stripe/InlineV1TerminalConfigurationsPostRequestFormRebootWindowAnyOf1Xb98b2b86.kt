...
public class InlineV1TerminalConfigurationsPostRequestFormRebootWindowAnyOf1Xb98b2b86(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1TerminalConfigurationsPostRequestFormRebootWindowAnyOf1Xb98b2b86 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1TerminalConfigurationsPostRequestFormRebootWindowAnyOf1Xb98b2b86> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TerminalConfigurationsPostRequestFormRebootWindowAnyOf1Xb98b2b86 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TerminalConfigurationsPostRequestFormRebootWindowAnyOf1Xb98b2b86,
        ) {
            val jsonEncoder =
...
public fun inlineV1TerminalConfigurationsPostRequestFormRebootWindowAnyOf1Xb98b2b86(
    block: InlineV1TerminalConfigurationsPostRequestFormRebootWindowAnyOf1Xb98b2b86.Builder.() -> Unit,
): InlineV1TerminalConfigurationsPostRequestFormRebootWindowAnyOf1Xb98b2b86 =
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TerminalConfigurationsPostRequestFormRebootWindowAnyOf1Xb98b2b86 is missing required property '" +
                    name +
                    "'",
            )
