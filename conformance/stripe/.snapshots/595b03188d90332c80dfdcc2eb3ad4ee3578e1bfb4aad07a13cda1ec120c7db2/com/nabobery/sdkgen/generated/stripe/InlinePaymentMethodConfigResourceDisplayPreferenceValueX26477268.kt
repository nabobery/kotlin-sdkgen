...
public sealed class InlinePaymentMethodConfigResourceDisplayPreferenceValueX26477268 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentMethodConfigResourceDisplayPreferenceValueX26477268 =
            when (value) {
                Off.value -> Off
                On.value -> On
    ...
    public object Serializer : KSerializer<InlinePaymentMethodConfigResourceDisplayPreferenceValueX26477268> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentMethodConfigResourceDisplayPreferenceValueX26477268",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePaymentMethodConfigResourceDisplayPreferenceValueX26477268 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentMethodConfigResourceDisplayPreferenceValueX26477268,
        ) {
