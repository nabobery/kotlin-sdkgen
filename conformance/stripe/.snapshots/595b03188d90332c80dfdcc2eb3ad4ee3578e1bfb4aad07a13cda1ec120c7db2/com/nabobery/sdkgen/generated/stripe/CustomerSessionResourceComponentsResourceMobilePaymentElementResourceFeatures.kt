...
@Serializable
public data class CustomerSessionResourceComponentsResourceMobilePaymentElementResourceFeaturesView(
    ...
    public val paymentMethodRedisplay: InlineCustomerSessionResou7afdPaymentMethodRedisplayX8594df68? = null,
    @SerialName("payment_method_remove")
    public val paymentMethodRemove: InlineCustomerSessionResou7afdPaymentMethodRemoveX98f4a683? = null,
...
public class CustomerSessionResourceComponentsResourceMobilePaymentElementResourceFeatures(
    ...
    public class Builder {
        ...
        public fun build(): CustomerSessionResourceComponentsResourceMobilePaymentElementResourceFeatures =
    ...
    public object Serializer : KSerializer<CustomerSessionResourceComponentsResourceMobilePaymentElementResourceFeatures> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "CustomerSessionResourceComponentsResourceMobilePaymentElementResourceFeatures must be a JSON object",
                    )
            return CustomerSessionResourceComponentsResourceMobilePaymentElementResourceFeatures(
                paymentMethodAllowRedisplayFilters =
                    rawObject["payment_method_allow_redisplay_filters"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                            ...
                            json
                                .decodeFromJsonElement<List<InlineCustomerSessionResou7afdPaymentMethodAllowRea1fdItemX59f3e40f>?>(
                                    element,
                                )
                        }
                    },
                paymentMethodRedisplay =
                    rawObject["payment_method_redisplay"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineCustomerSessionResou7afdPaymentMethodRedisplayX8594df68?>(
                                element,
                            )
                        }
                    },
                paymentMethodRemove =
                    rawObject["payment_method_remove"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineCustomerSessionResou7afdPaymentMethodRemoveX98f4a683?>(
                                element,
                            )
                        }
                    },
                paymentMethodSave =
                    rawObject["payment_method_save"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineCustomerSessionResou7afdPaymentMethodSaveXf008e2fa?>(
                                element,
                            )
                        }
                    },
                paymentMethodSaveAllowRedisplayOverride =
                    rawObject["payment_method_save_allow_redisplay_override"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                            ...
                            json
                                .decodeFromJsonElement<InlineCustomerSessionResou7afdPaymentMethodSaveAll7d2cXd2d7d648?>(
                                    element,
                                )
                        }
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: CustomerSessionResourceComponentsResourceMobilePaymentElementResourceFeatures,
        ) {
            val jsonEncoder =
            ...
            val raw =
                buildJsonObject {
                    value.paymentMethodAllowRedisplayFilters?.let {
                        put("payment_method_allow_redisplay_filters", json.encodeToJsonElement(it))
                    }
                    ...
                    value.paymentMethodSaveAllowRedisplayOverride?.let {
                        put("payment_method_save_allow_redisplay_override", json.encodeToJsonElement(it))
                    }
                }
...
public fun customerSessionResourceComponentsResourceMobilePaymentElementResourceFeatures(
    block: CustomerSessionResourceComponentsResourceMobilePaymentElementResourceFeatures.Builder.() -> Unit,
): CustomerSessionResourceComponentsResourceMobilePaymentElementResourceFeatures =
    CustomerSessionResourceComponentsResourceMobilePaymentElementResourceFeatures.build(block)
