...
public sealed class InlineMandateOptionsPaytoPurposeX3f3845f0 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineMandateOptionsPaytoPurposeX3f3845f0 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineMandateOptionsPaytoPurposeX3f3845f0> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineMandateOptionsPaytoPurposeX3f3845f0",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineMandateOptionsPaytoPurposeX3f3845f0 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineMandateOptionsPaytoPurposeX3f3845f0,
        ) {
