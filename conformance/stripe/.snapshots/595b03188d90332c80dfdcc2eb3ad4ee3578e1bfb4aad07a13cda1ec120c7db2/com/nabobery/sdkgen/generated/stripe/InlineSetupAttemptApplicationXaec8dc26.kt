...
public class InlineSetupAttemptApplicationXaec8dc26 internal constructor(
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineSetupAttemptApplicationXaec8dc26 {
            val inspection = inspectInlineSetupAttemptApplicationXaec8dc26(raw)
            if (inspection.matchCount == 0) {
                throw InlineSetupAttemptApplicationXaec8dc26NoMatchException(
                    "InlineSetupAttemptApplicationXaec8dc26 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineSetupAttemptApplicationXaec8dc26> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineSetupAttemptApplicationXaec8dc26,
        ) {
...
private fun inspectInlineSetupAttemptApplicationXaec8dc26(
    element: JsonElement,
): InlineSetupAttemptApplicationXaec8dc26Inspection {
