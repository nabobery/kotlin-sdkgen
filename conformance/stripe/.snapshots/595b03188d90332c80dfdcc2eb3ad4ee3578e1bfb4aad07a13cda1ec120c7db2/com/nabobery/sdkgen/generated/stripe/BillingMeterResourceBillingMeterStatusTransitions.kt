...
public class BillingMeterResourceBillingMeterStatusTransitions(
    ...
    public class Builder {
        ...
        public fun build(): BillingMeterResourceBillingMeterStatusTransitions =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): BillingMeterResourceBillingMeterStatusTransitions =
    ...
    public object Serializer : KSerializer<BillingMeterResourceBillingMeterStatusTransitions> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "BillingMeterResourceBillingMeterStatusTransitions must be a JSON object",
                    )
            return BillingMeterResourceBillingMeterStatusTransitions(
                deactivatedAt =
                    rawObject["deactivated_at"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: BillingMeterResourceBillingMeterStatusTransitions,
        ) {
...
public fun billingMeterResourceBillingMeterStatusTransitions(
    block: BillingMeterResourceBillingMeterStatusTransitions.Builder.() -> Unit,
): BillingMeterResourceBillingMeterStatusTransitions = BillingMeterResourceBillingMeterStatusTransitions.build(block)
