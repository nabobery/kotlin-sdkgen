...
public class TreasuryFinancialAccountsResourceFinancialAddress(
     ...
     */
    public val supportedNetworks: List<InlineTreasuryFinancialAccf6dfSupportedNetworksItemX379394bf>? = null,
) {
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): TreasuryFinancialAccountsResourceFinancialAddress =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<TreasuryFinancialAccountsResourceFinancialAddress> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "TreasuryFinancialAccountsResourceFinancialAddress must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineTreasuryFinancialAccountsResourceFinancialAddressTypeX6816c6a8>(
                    rawObject,
                    "type",
                )
            return TreasuryFinancialAccountsResourceFinancialAddress(
                ...
                aba =
                    rawObject["aba"]?.let {
                        json.decodeFromJsonElement<TreasuryFinancialAccountsResourceAbaRecord>(
                            it,
                        )
                    },
                supportedNetworks =
                    rawObject["supported_networks"]?.let {
                        json.decodeFromJsonElement<List<InlineTreasuryFinancialAccf6dfSupportedNetworksItemX379394bf>>(
                            it,
                        )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: TreasuryFinancialAccountsResourceFinancialAddress,
        ) {
...
public fun treasuryFinancialAccountsResourceFinancialAddress(
    block: TreasuryFinancialAccountsResourceFinancialAddress.Builder.() -> Unit,
): TreasuryFinancialAccountsResourceFinancialAddress = TreasuryFinancialAccountsResourceFinancialAddress.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "TreasuryFinancialAccountsResourceFinancialAddress is missing required property '" + name + "'",
            )
