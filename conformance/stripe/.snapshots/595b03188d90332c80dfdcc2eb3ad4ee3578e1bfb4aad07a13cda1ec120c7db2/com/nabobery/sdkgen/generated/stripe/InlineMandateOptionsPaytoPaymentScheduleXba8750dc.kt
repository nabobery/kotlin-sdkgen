...
public sealed class InlineMandateOptionsPaytoPaymentScheduleXba8750dc {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineMandateOptionsPaytoPaymentScheduleXba8750dc =
            when (value) {
                Adhoc.value -> Adhoc
                Annual.value -> Annual
                Daily.value -> Daily
    ...
    public object Serializer : KSerializer<InlineMandateOptionsPaytoPaymentScheduleXba8750dc> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineMandateOptionsPaytoPaymentScheduleXba8750dc",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineMandateOptionsPaytoPaymentScheduleXba8750dc =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineMandateOptionsPaytoPaymentScheduleXba8750dc,
        ) {
