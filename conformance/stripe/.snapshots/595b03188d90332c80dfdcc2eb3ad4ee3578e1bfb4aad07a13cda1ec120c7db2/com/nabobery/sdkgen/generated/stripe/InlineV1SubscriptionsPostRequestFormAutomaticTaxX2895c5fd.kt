...
public class InlineV1SubscriptionsPostRequestFormAutomaticTaxX2895c5fd(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1SubscriptionsPostRequestFormAutomaticTaxX2895c5fd =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1SubscriptionsPostRequestFormAutomaticTaxX2895c5fd> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SubscriptionsPostRequestFormAutomaticTaxX2895c5fd must be a JSON object",
                    )
            ...
            return InlineV1SubscriptionsPostRequestFormAutomaticTaxX2895c5fd(
                ...
                liability =
                    rawObject["liability"]?.let {
                        json.decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormAutomaticTaxLiabilityXaf737901>(
                            it,
                        )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsPostRequestFormAutomaticTaxX2895c5fd,
        ) {
...
public fun inlineV1SubscriptionsPostRequestFormAutomaticTaxX2895c5fd(
    block: InlineV1SubscriptionsPostRequestFormAutomaticTaxX2895c5fd.Builder.() -> Unit,
): InlineV1SubscriptionsPostRequestFormAutomaticTaxX2895c5fd =
    InlineV1SubscriptionsPostRequestFormAutomaticTaxX2895c5fd.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1SubscriptionsPostRequestFormAutomaticTaxX2895c5fd is missing required property '" + name + "'",
            )
