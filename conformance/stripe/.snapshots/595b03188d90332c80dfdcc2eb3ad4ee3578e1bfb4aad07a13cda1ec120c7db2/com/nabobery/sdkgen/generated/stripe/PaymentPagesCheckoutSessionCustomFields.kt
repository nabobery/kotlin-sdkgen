...
public class PaymentPagesCheckoutSessionCustomFields(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentPagesCheckoutSessionCustomFields =
    ...
    public object Serializer : KSerializer<PaymentPagesCheckoutSessionCustomFields> {
        ...
        override fun deserialize(decoder: Decoder): PaymentPagesCheckoutSessionCustomFields {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentPagesCheckoutSessionCustomFields must be a JSON object")
            ...
            val type =
                json.decodeRequired<InlinePaymentPagesCheckoutSessionCustomFieldsTypeX75cd9bad>(
                    rawObject,
                    "type",
                )
            return PaymentPagesCheckoutSessionCustomFields(
                ...
                dropdown =
                    rawObject["dropdown"]?.let {
                        json.decodeFromJsonElement<PaymentPagesCheckoutSessionCustomFieldsDropdown>(it)
                    },
                numeric =
                    rawObject["numeric"]?.let {
                        json
                            .decodeFromJsonElement<PaymentPagesCheckoutSessionCustomFieldsNumeric>(
                                it,
                            )
                    },
                text =
                    rawObject["text"]?.let {
                        json
                            .decodeFromJsonElement<PaymentPagesCheckoutSessionCustomFieldsText>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentPagesCheckoutSessionCustomFields,
        ) {
...
public fun paymentPagesCheckoutSessionCustomFields(
    block: PaymentPagesCheckoutSessionCustomFields.Builder.() -> Unit,
): PaymentPagesCheckoutSessionCustomFields = PaymentPagesCheckoutSessionCustomFields.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "PaymentPagesCheckoutSessionCustomFields is missing required property '" + name + "'",
            )
