...
public class InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemsItemX457be849(
    ...
    public val discounts: InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemsDiscountsX43b055a7? = null,
    public val metadata: Map<String, String>? = null,
    public val price: String? = null,
    public val priceData: InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemsPriceDataXebe80254? = null,
    public val quantity: Int? = null,
    public val taxRates: InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemsItemTaxRatesX5aa95b6b? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemsItemX457be849 =
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemsItemX457be849 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemsItemX457be849> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemsItemX457be849 must be a JSON object",
                    )
            return InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemsItemX457be849(
                billingThresholds =
                    rawObject["billing_thresholds"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemBillingThresholdsX1843dca1>(
                                it,
                            )
                    },
                discounts =
                    rawObject["discounts"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemsDiscountsX43b055a7>(
                                it,
                            )
                    },
                ...
                priceData =
                    rawObject["price_data"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemsPriceDataXebe80254>(
                                it,
                            )
                    },
                ...
                taxRates =
                    rawObject["tax_rates"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemsItemTaxRatesX5aa95b6b>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemsItemX457be849,
        ) {
            val jsonEncoder =
...
public fun inlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemsItemX457be849(
    block: InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemsItemX457be849.Builder.() -> Unit,
): InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemsItemX457be849 =
    InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemsItemX457be849.build(block)
