...
public class InlineV1AccountSessionsPostRequestFormComponentsIssuingCardX085614aa(
    ...
    public val features: InlineV1AccountSessionsPostRequestFormComponentsIssuingCardFeaturesX11adaa6e? = null,
) {
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1AccountSessionsPostRequestFormComponentsIssuingCardX085614aa = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1AccountSessionsPostRequestFormComponentsIssuingCardX085614aa> {
        ...
        override fun deserialize(
            decoder: Decoder,
        ): InlineV1AccountSessionsPostRequestFormComponentsIssuingCardX085614aa {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountSessionsPostRequestFormComponentsIssuingCardX085614aa must be a JSON object",
                    )
            ...
            return InlineV1AccountSessionsPostRequestFormComponentsIssuingCardX085614aa(
                ...
                features =
                    rawObject["features"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1AccountSessionsPostRequestFormComponentsIssuingCardFeaturesX11adaa6e>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountSessionsPostRequestFormComponentsIssuingCardX085614aa,
        ) {
            val jsonEncoder =
...
public fun inlineV1AccountSessionsPostRequestFormComponentsIssuingCardX085614aa(
    block: InlineV1AccountSessionsPostRequestFormComponentsIssuingCardX085614aa.Builder.() -> Unit,
): InlineV1AccountSessionsPostRequestFormComponentsIssuingCardX085614aa =
    InlineV1AccountSessionsPostRequestFormComponentsIssuingCardX085614aa.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1AccountSessionsPostRequestFormComponentsIssuingCardX085614aa is missing required property '" +
                    name +
                    "'",
            )
