...
public class InlineV1TerminalReadersCollectInputsPostRequestFormInputsItemSelectionXc58f8be2(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1TerminalReadersCollectInputsPostRequestFormInputsItemSelectionXc58f8be2 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TerminalReadersCollectInputsPostRequestFormInputsItemSelectionXc58f8be2> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TerminalReadersCollectInputsPostRequestFormInputsItemSelectionXc58f8be2 must be a JSON object",
                    )
            val choices =
                json
                    .decodeRequired<List<InlineV1TerminalReadersCol2891PostRequestFormInputsItemSelectionItemX6ee6b065>>(
                        rawObject,
                        "choices",
                    )
            return InlineV1TerminalReadersCollectInputsPostRequestFormInputsItemSelectionXc58f8be2(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TerminalReadersCollectInputsPostRequestFormInputsItemSelectionXc58f8be2,
        ) {
            val jsonEncoder =
...
public fun inlineV1TerminalReadersCollectInputsPostRequestFormInputsItemSelectionXc58f8be2(
    block: InlineV1TerminalReadersCollectInputsPostRequestFormInputsItemSelectionXc58f8be2.Builder.() -> Unit,
): InlineV1TerminalReadersCollectInputsPostRequestFormInputsItemSelectionXc58f8be2 =
    InlineV1TerminalReadersCollectInputsPostRequestFormInputsItemSelectionXc58f8be2.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TerminalReadersCollectInputsPostRequestFormInputsItemSelectionXc58f8be2 is missing required property '" +
                    name +
                    "'",
            )
