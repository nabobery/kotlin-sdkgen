...
public sealed class InlineV1SetupIntentsPostRequestFormMandateDataAnyOf2X3822ccc3 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1SetupIntentsPostRequestFormMandateDataAnyOf2X3822ccc3 =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1SetupIntentsPostRequestFormMandateDataAnyOf2X3822ccc3> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1SetupIntentsPostRequestFormMandateDataAnyOf2X3822ccc3",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1SetupIntentsPostRequestFormMandateDataAnyOf2X3822ccc3 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SetupIntentsPostRequestFormMandateDataAnyOf2X3822ccc3,
        ) {
