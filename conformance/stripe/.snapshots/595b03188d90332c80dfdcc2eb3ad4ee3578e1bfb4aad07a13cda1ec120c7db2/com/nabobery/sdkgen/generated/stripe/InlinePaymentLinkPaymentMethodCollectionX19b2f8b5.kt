...
public sealed class InlinePaymentLinkPaymentMethodCollectionX19b2f8b5 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentLinkPaymentMethodCollectionX19b2f8b5 =
            when (value) {
                Always.value -> Always
    ...
    public object Serializer : KSerializer<InlinePaymentLinkPaymentMethodCollectionX19b2f8b5> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentLinkPaymentMethodCollectionX19b2f8b5",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePaymentLinkPaymentMethodCollectionX19b2f8b5 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentLinkPaymentMethodCollectionX19b2f8b5,
        ) {
