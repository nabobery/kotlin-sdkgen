...
public class AccountTosAcceptance(
    ...
    public class Builder {
        ...
        public fun build(): AccountTosAcceptance =
    ...
    public object Serializer : KSerializer<AccountTosAcceptance> {
        ...
        override fun deserialize(decoder: Decoder): AccountTosAcceptance {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("AccountTosAcceptance must be a JSON object")
...
public fun accountTosAcceptance(block: AccountTosAcceptance.Builder.() -> Unit): AccountTosAcceptance =
    AccountTosAcceptance.build(block)
