...
public sealed class InlineV1FileLinksPostRequestFormExpiresAtAnyOf3X8e622adb {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1FileLinksPostRequestFormExpiresAtAnyOf3X8e622adb =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1FileLinksPostRequestFormExpiresAtAnyOf3X8e622adb> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1FileLinksPostRequestFormExpiresAtAnyOf3X8e622adb",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1FileLinksPostRequestFormExpiresAtAnyOf3X8e622adb =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1FileLinksPostRequestFormExpiresAtAnyOf3X8e622adb,
        ) {
