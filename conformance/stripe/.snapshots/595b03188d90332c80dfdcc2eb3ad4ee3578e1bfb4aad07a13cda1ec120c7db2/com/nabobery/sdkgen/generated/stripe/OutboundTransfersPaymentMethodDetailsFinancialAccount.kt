...
public class OutboundTransfersPaymentMethodDetailsFinancialAccount(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): OutboundTransfersPaymentMethodDetailsFinancialAccount =
    ...
    public object Serializer : KSerializer<OutboundTransfersPaymentMethodDetailsFinancialAccount> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "OutboundTransfersPaymentMethodDetailsFinancialAccount must be a JSON object",
                    )
            val id = json.decodeRequired<String>(rawObject, "id")
            val network =
                json.decodeRequired<InlineOutboundTransfersPaymentMethodDetailsFinancialAccountNetworkX4de06dce>(
                    rawObject,
                    "network",
                )
            return OutboundTransfersPaymentMethodDetailsFinancialAccount(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: OutboundTransfersPaymentMethodDetailsFinancialAccount,
        ) {
...
public fun outboundTransfersPaymentMethodDetailsFinancialAccount(
    block: OutboundTransfersPaymentMethodDetailsFinancialAccount.Builder.() -> Unit,
): OutboundTransfersPaymentMethodDetailsFinancialAccount =
    OutboundTransfersPaymentMethodDetailsFinancialAccount.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "OutboundTransfersPaymentMethodDetailsFinancialAccount is missing required property '" + name + "'",
            )
