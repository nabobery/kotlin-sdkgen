...
public sealed class InlineV1PaymentMethodsPostRequestFormNaverPayFundingXf4381218 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1PaymentMethodsPostRequestFormNaverPayFundingXf4381218 =
            when (value) {
                Card.value -> Card
                Points.value -> Points
    ...
    public object Serializer : KSerializer<InlineV1PaymentMethodsPostRequestFormNaverPayFundingXf4381218> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1PaymentMethodsPostRequestFormNaverPayFundingXf4381218",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1PaymentMethodsPostRequestFormNaverPayFundingXf4381218 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentMethodsPostRequestFormNaverPayFundingXf4381218,
        ) {
