...
public class InlineV1RefundsPostRequestFormX3e77f244(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1RefundsPostRequestFormX3e77f244 =
            InlineV1RefundsPostRequestFormX3e77f244(
                amount = amount,
                charge = charge,
                currency = currency,
                customer = customer,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1RefundsPostRequestFormX3e77f244 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1RefundsPostRequestFormX3e77f244> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1RefundsPostRequestFormX3e77f244 {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("InlineV1RefundsPostRequestFormX3e77f244 must be a JSON object")
            return InlineV1RefundsPostRequestFormX3e77f244(
                ...
                metadata =
                    rawObject["metadata"]?.let {
                        json.decodeFromJsonElement<InlineV1RefundsPostRequestFormMetadataX0b919f39>(it)
                    },
                origin =
                    rawObject["origin"]?.let {
                        json.decodeFromJsonElement<InlineV1RefundsPostRequestFormOriginX66fb951a>(
                            it,
                        )
                    },
                ...
                reason =
                    rawObject["reason"]?.let {
                        json.decodeFromJsonElement<InlineV1RefundsPostRequestFormReasonX6845834e>(
                            it,
                        )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1RefundsPostRequestFormX3e77f244,
        ) {
...
public fun inlineV1RefundsPostRequestFormX3e77f244(
    block: InlineV1RefundsPostRequestFormX3e77f244.Builder.() -> Unit,
): InlineV1RefundsPostRequestFormX3e77f244 = InlineV1RefundsPostRequestFormX3e77f244.build(block)
