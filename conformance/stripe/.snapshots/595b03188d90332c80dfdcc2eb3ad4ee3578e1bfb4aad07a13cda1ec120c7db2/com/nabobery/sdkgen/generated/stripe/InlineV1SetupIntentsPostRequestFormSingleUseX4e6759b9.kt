...
public class InlineV1SetupIntentsPostRequestFormSingleUseX4e6759b9(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1SetupIntentsPostRequestFormSingleUseX4e6759b9 =
    ...
    public object Serializer : KSerializer<InlineV1SetupIntentsPostRequestFormSingleUseX4e6759b9> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SetupIntentsPostRequestFormSingleUseX4e6759b9 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SetupIntentsPostRequestFormSingleUseX4e6759b9,
        ) {
...
public fun inlineV1SetupIntentsPostRequestFormSingleUseX4e6759b9(
    block: InlineV1SetupIntentsPostRequestFormSingleUseX4e6759b9.Builder.() -> Unit,
): InlineV1SetupIntentsPostRequestFormSingleUseX4e6759b9 =
    InlineV1SetupIntentsPostRequestFormSingleUseX4e6759b9.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1SetupIntentsPostRequestFormSingleUseX4e6759b9 is missing required property '" + name + "'",
            )
