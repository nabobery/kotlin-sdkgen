...
public class CheckoutLinkPaymentMethodOptions(
     ...
     */
    public val setupFutureUsage: InlineCheckoutLinkPaymentMethodOptionsSetupFutureUsageXe61da0be? = null,
) {
    public class Builder {
        ...
        public fun build(): CheckoutLinkPaymentMethodOptions =
    ...
    public object Serializer : KSerializer<CheckoutLinkPaymentMethodOptions> {
        ...
        override fun deserialize(decoder: Decoder): CheckoutLinkPaymentMethodOptions {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("CheckoutLinkPaymentMethodOptions must be a JSON object")
            return CheckoutLinkPaymentMethodOptions(
                captureMethod =
                    rawObject["capture_method"]?.let {
                        json.decodeFromJsonElement<InlineCheckoutLinkPaymentMethodOptionsCaptureMethodXff9c5b04>(it)
                    },
                setupFutureUsage =
                    rawObject["setup_future_usage"]?.let {
                        json.decodeFromJsonElement<InlineCheckoutLinkPaymentMethodOptionsSetupFutureUsageXe61da0be>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: CheckoutLinkPaymentMethodOptions,
        ) {
...
public fun checkoutLinkPaymentMethodOptions(
    block: CheckoutLinkPaymentMethodOptions.Builder.() -> Unit,
): CheckoutLinkPaymentMethodOptions = CheckoutLinkPaymentMethodOptions.build(block)
