...
public class InlineV1TreasuryFinancialAccountsPostRequestFormForwardingSettingsX7c5f67f7(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1TreasuryFinancialAccountsPostRequestFormForwardingSettingsX7c5f67f7 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1TreasuryFinancialAccountsPostRequestFormForwardingSettingsX7c5f67f7> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TreasuryFinancialAccountsPostRequestFormForwardingSettingsX7c5f67f7 must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineV1TreasuryFinancialAccountsPostRequestFormForwardingSettingsTypeXd4f8a866>(
                    rawObject,
                    "type",
                )
            return InlineV1TreasuryFinancialAccountsPostRequestFormForwardingSettingsX7c5f67f7(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TreasuryFinancialAccountsPostRequestFormForwardingSettingsX7c5f67f7,
        ) {
            val jsonEncoder =
...
public fun inlineV1TreasuryFinancialAccountsPostRequestFormForwardingSettingsX7c5f67f7(
    block: InlineV1TreasuryFinancialAccountsPostRequestFormForwardingSettingsX7c5f67f7.Builder.() -> Unit,
): InlineV1TreasuryFinancialAccountsPostRequestFormForwardingSettingsX7c5f67f7 =
    InlineV1TreasuryFinancialAccountsPostRequestFormForwardingSettingsX7c5f67f7.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TreasuryFinancialAccountsPostRequestFormForwardingSettingsX7c5f67f7 is missing required property '" +
                    name +
                    "'",
            )
