...
public sealed class InlineV1ProductsPostRequestFormDefaultPriceDataRecurringIntervalXd41db45b {
    ...
    public object Serializer : KSerializer<InlineV1ProductsPostRequestFormDefaultPriceDataRecurringIntervalXd41db45b> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1ProductsPostRequestFormDefaultPriceDataRecurringIntervalXd41db45b",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1ProductsPostRequestFormDefaultPriceDataRecurringIntervalXd41db45b = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ProductsPostRequestFormDefaultPriceDataRecurringIntervalXd41db45b,
        ) {
