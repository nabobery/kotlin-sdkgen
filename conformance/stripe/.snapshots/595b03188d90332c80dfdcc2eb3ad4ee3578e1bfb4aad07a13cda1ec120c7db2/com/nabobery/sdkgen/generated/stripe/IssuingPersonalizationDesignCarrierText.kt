...
public class IssuingPersonalizationDesignCarrierText(
    ...
    public class Builder {
        ...
        public fun build(): IssuingPersonalizationDesignCarrierText =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): IssuingPersonalizationDesignCarrierText =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<IssuingPersonalizationDesignCarrierText> {
        ...
        override fun deserialize(decoder: Decoder): IssuingPersonalizationDesignCarrierText {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("IssuingPersonalizationDesignCarrierText must be a JSON object")
            return IssuingPersonalizationDesignCarrierText(
                footerBody =
                    rawObject["footer_body"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                footerTitle =
                    rawObject["footer_title"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                headerBody =
                    rawObject["header_body"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                headerTitle =
                    rawObject["header_title"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: IssuingPersonalizationDesignCarrierText,
        ) {
...
public fun issuingPersonalizationDesignCarrierText(
    block: IssuingPersonalizationDesignCarrierText.Builder.() -> Unit,
): IssuingPersonalizationDesignCarrierText = IssuingPersonalizationDesignCarrierText.build(block)
