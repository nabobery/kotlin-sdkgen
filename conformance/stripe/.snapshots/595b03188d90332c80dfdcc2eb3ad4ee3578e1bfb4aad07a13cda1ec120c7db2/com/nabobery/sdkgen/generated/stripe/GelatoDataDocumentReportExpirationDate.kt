...
public class GelatoDataDocumentReportExpirationDate(
    ...
    public class Builder {
        ...
        public fun build(): GelatoDataDocumentReportExpirationDate =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): GelatoDataDocumentReportExpirationDate =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<GelatoDataDocumentReportExpirationDate> {
        ...
        override fun deserialize(decoder: Decoder): GelatoDataDocumentReportExpirationDate {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("GelatoDataDocumentReportExpirationDate must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: GelatoDataDocumentReportExpirationDate,
        ) {
...
public fun gelatoDataDocumentReportExpirationDate(
    block: GelatoDataDocumentReportExpirationDate.Builder.() -> Unit,
): GelatoDataDocumentReportExpirationDate = GelatoDataDocumentReportExpirationDate.build(block)
