...
public class InlineV1RadarValueListsPostRequestFormXd6e26112(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1RadarValueListsPostRequestFormXd6e26112 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1RadarValueListsPostRequestFormXd6e26112> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1RadarValueListsPostRequestFormXd6e26112 {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1RadarValueListsPostRequestFormXd6e26112 must be a JSON object",
                    )
            ...
            return InlineV1RadarValueListsPostRequestFormXd6e26112(
                ...
                itemType =
                    rawObject["item_type"]?.let {
                        json.decodeFromJsonElement<InlineV1RadarValueListsPostRequestFormItemTypeXa7255c8e>(it)
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1RadarValueListsPostRequestFormXd6e26112,
        ) {
...
public fun inlineV1RadarValueListsPostRequestFormXd6e26112(
    block: InlineV1RadarValueListsPostRequestFormXd6e26112.Builder.() -> Unit,
): InlineV1RadarValueListsPostRequestFormXd6e26112 = InlineV1RadarValueListsPostRequestFormXd6e26112.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1RadarValueListsPostRequestFormXd6e26112 is missing required property '" + name + "'",
            )
