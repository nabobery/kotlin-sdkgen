...
public sealed class InlineV1ExternalAccountsPostRequestFormAccountTypeX39c8b49f {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1ExternalAccountsPostRequestFormAccountTypeX39c8b49f =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1ExternalAccountsPostRequestFormAccountTypeX39c8b49f> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1ExternalAccountsPostRequestFormAccountTypeX39c8b49f",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1ExternalAccountsPostRequestFormAccountTypeX39c8b49f =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ExternalAccountsPostRequestFormAccountTypeX39c8b49f,
        ) {
