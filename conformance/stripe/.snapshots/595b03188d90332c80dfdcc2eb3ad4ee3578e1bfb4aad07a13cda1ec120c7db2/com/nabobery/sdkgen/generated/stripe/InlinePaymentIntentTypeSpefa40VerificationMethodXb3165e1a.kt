...
public sealed class InlinePaymentIntentTypeSpefa40VerificationMethodXb3165e1a {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentIntentTypeSpefa40VerificationMethodXb3165e1a =
            when (value) {
    ...
    public object Serializer : KSerializer<InlinePaymentIntentTypeSpefa40VerificationMethodXb3165e1a> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentIntentTypeSpefa40VerificationMethodXb3165e1a",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePaymentIntentTypeSpefa40VerificationMethodXb3165e1a =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentIntentTypeSpefa40VerificationMethodXb3165e1a,
        ) {
