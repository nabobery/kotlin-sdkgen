...
public class InlineV1PaymentIntentsConfirmPostRequestFormAmountDetailsAnyOf1AnyOf1X7120589a(
    public val amount: InlineV1PaymentIntentsConfirmPostRequestFormAmountDetailsAnyOf1AmountX0c914aa6? = null,
    public val fromPostalCode: InlineV1PaymentIntentsConfirmPostRequestFormAmountDetailsFromPostalCodeX948aa199? = null,
    public val toPostalCode: InlineV1PaymentIntentsConfirmPostRequestFormAmountDetailsToPostalCodeXa7b1dd82? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1PaymentIntentsConfirmPostRequestFormAmountDetailsAnyOf1AnyOf1X7120589a =
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsConfirmPostRequestFormAmountDetailsAnyOf1AnyOf1X7120589a> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsConfirmPostRequestFormAmountDetailsAnyOf1AnyOf1X7120589a must be a JSON object",
                    )
            return InlineV1PaymentIntentsConfirmPostRequestFormAmountDetailsAnyOf1AnyOf1X7120589a(
                amount =
                    rawObject["amount"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormAmountDetailsAnyOf1AmountX0c914aa6>(
                                it,
                            )
                    },
                fromPostalCode =
                    rawObject["from_postal_code"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormAmountDetailsFromPostalCodeX948aa199>(
                                it,
                            )
                    },
                toPostalCode =
                    rawObject["to_postal_code"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormAmountDetailsToPostalCodeXa7b1dd82>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsConfirmPostRequestFormAmountDetailsAnyOf1AnyOf1X7120589a,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentIntentsConfirmPostRequestFormAmountDetailsAnyOf1AnyOf1X7120589a(
    block: InlineV1PaymentIntentsConfirmPostRequestFormAmountDetailsAnyOf1AnyOf1X7120589a.Builder.() -> Unit,
): InlineV1PaymentIntentsConfirmPostRequestFormAmountDetailsAnyOf1AnyOf1X7120589a =
    InlineV1PaymentIntentsConfirmPostRequestFormAmountDetailsAnyOf1AnyOf1X7120589a.build(block)
