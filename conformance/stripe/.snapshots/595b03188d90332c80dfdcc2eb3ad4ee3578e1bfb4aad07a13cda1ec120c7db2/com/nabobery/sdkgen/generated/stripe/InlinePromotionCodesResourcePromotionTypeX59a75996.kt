...
public sealed class InlinePromotionCodesResourcePromotionTypeX59a75996 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePromotionCodesResourcePromotionTypeX59a75996 =
            when (value) {
                Coupon.value -> Coupon
    ...
    public object Serializer : KSerializer<InlinePromotionCodesResourcePromotionTypeX59a75996> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePromotionCodesResourcePromotionTypeX59a75996",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePromotionCodesResourcePromotionTypeX59a75996 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePromotionCodesResourcePromotionTypeX59a75996,
        ) {
