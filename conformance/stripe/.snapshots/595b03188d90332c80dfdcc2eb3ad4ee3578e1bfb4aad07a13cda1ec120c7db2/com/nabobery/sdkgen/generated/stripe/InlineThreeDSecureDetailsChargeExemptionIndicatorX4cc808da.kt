...
public sealed class InlineThreeDSecureDetailsChargeExemptionIndicatorX4cc808da {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineThreeDSecureDetailsChargeExemptionIndicatorX4cc808da =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineThreeDSecureDetailsChargeExemptionIndicatorX4cc808da> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineThreeDSecureDetailsChargeExemptionIndicatorX4cc808da",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineThreeDSecureDetailsChargeExemptionIndicatorX4cc808da =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineThreeDSecureDetailsChargeExemptionIndicatorX4cc808da,
        ) {
