...
public class InlineV1InvoiceitemsGetParameterX80f313b4 internal constructor(
    ...
    public val inlineV1InvoiceitemsGetParameterAnyOf1X473e4023:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1InvoiceitemsGetParameterAnyOf1X473e4023) {
                json
                    .decodeFromJsonElement<InlineV1InvoiceitemsGetParameterAnyOf1X473e4023>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1InvoiceitemsGetParameterX80f313b4Branch>
        get() =
            buildSet {
                if (inspection.matchesInlineV1InvoiceitemsGetParameterAnyOf1X473e4023) {
                    add(
                        InlineV1InvoiceitemsGetParameterX80f313b4Branch.InlineV1InvoiceitemsGetParameterAnyOf1X473e4023,
                    )
                }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1InvoiceitemsGetParameterX80f313b4 {
            val inspection = inspectInlineV1InvoiceitemsGetParameterX80f313b4(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1InvoiceitemsGetParameterX80f313b4NoMatchException(
                    "InlineV1InvoiceitemsGetParameterX80f313b4 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1InvoiceitemsGetParameterX80f313b4> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoiceitemsGetParameterX80f313b4,
        ) {
...
private fun inspectInlineV1InvoiceitemsGetParameterX80f313b4(
    element: JsonElement,
): InlineV1InvoiceitemsGetParameterX80f313b4Inspection {
    val matchesInlineV1InvoiceitemsGetParameterAnyOf1X473e4023 =
        element
            .isJsonDecodable<InlineV1InvoiceitemsGetParameterAnyOf1X473e4023>()
    ...
    return InlineV1InvoiceitemsGetParameterX80f313b4Inspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1InvoiceitemsGetParameterAnyOf1X473e4023) {
                    add(
                        "InlineV1InvoiceitemsGetParameterAnyOf1X473e4023: value does not match InlineV1InvoiceitemsGetParameterAnyOf1X473e4023",
                    )
                }
