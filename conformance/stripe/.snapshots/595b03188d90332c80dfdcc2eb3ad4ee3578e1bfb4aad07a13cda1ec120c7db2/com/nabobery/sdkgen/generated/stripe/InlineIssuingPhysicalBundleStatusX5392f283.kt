...
public sealed class InlineIssuingPhysicalBundleStatusX5392f283 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineIssuingPhysicalBundleStatusX5392f283 =
            when (value) {
                Active.value -> Active
    ...
    public object Serializer : KSerializer<InlineIssuingPhysicalBundleStatusX5392f283> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineIssuingPhysicalBundleStatusX5392f283",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineIssuingPhysicalBundleStatusX5392f283 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineIssuingPhysicalBundleStatusX5392f283,
        ) {
