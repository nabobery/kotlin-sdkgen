...
internal data class InlineV1InvoicesAddLinesPostRequestFormLinesItemMetadataX5b202459Inspection(
    ...
    public val matchesInlineV1InvoicesAddLinesPostRequestFormLinesItemMetadataAnyOf2X6e0c32a6: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1InvoicesAddLinesPostRequestFormLinesItemMetadataAnyOf2X6e0c32a6,
            ).count {
                it
            }
}
...
public class InlineV1InvoicesAddLinesPostRequestFormLinesItemMetadataX5b202459 internal constructor(
    ...
    private val inspection: InlineV1InvoicesAddLinesPostRequestFormLinesItemMetadataX5b202459Inspection,
) {
    ...
    public val inlineV1InvoicesAddLinesPostRequestFormLinesItemMetadataAnyOf2X6e0c32a6:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1InvoicesAddLinesPostRequestFormLinesItemMetadataAnyOf2X6e0c32a6) {
                json
                    .decodeFromJsonElement<InlineV1InvoicesAddLinesPostRequestFormLinesItemMetadataAnyOf2X6e0c32a6>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1InvoicesAddLinesPostRequestFormLinesItemMetadataX5b202459Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1InvoicesAddLinesPostRequestFormLinesItemMetadataAnyOf2X6e0c32a6) {
                    add(
                        InlineV1InvoicesAddLinesPostRequestFormLinesItemMetadataX5b202459Branch.InlineV1InvoicesAddLinesPostRequestFormLinesItemMetadataAnyOf2X6e0c32a6,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1InvoicesAddLinesPostRequestFormLinesItemMetadataX5b202459 {
            val inspection = inspectInlineV1InvoicesAddLinesPostRequestFormLinesItemMetadataX5b202459(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1InvoicesAddLinesPostRequestFormLinesItemMetadataX5b202459NoMatchException(
                    "InlineV1InvoicesAddLinesPostRequestFormLinesItemMetadataX5b202459 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1InvoicesAddLinesPostRequestFormLinesItemMetadataX5b202459> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesAddLinesPostRequestFormLinesItemMetadataX5b202459,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1InvoicesAddLinesPostRequestFormLinesItemMetadataX5b202459",
...
private fun inspectInlineV1InvoicesAddLinesPostRequestFormLinesItemMetadataX5b202459(
    element: JsonElement,
): InlineV1InvoicesAddLinesPostRequestFormLinesItemMetadataX5b202459Inspection {
    val matchesBranch1 = element.isJsonDecodable<JsonObject>()
    val matchesInlineV1InvoicesAddLinesPostRequestFormLinesItemMetadataAnyOf2X6e0c32a6 =
        element
            .isJsonDecodable<InlineV1InvoicesAddLinesPostRequestFormLinesItemMetadataAnyOf2X6e0c32a6>()
    return InlineV1InvoicesAddLinesPostRequestFormLinesItemMetadataX5b202459Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1InvoicesAddLinesPostRequestFormLinesItemMetadataAnyOf2X6e0c32a6) {
                    add(
                        "InlineV1InvoicesAddLinesPostRequestFormLinesItemMetadataAnyOf2X6e0c32a6: value does not match InlineV1InvoicesAddLinesPostRequestFormLinesItemMetadataAnyOf2X6e0c32a6",
                    )
                }
            },
    )
