...
public class InlineV1InvoicesUpdateLinesPostRequestFormLinesItemTaxAmountsAnyOf1ItemX54a21e4f(
    ...
    public val taxabilityReason: InlineV1InvoicesUpdateLinesPostRequestFormLinesItemTaxabilityReasonXda193a2e? = null,
) {
    ...
    public object Serializer : KSerializer<InlineV1InvoicesUpdateLinesPostRequestFormLinesItemTaxAmountsAnyOf1ItemX54a21e4f> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1InvoicesUpdateLinesPostRequestFormLinesItemTaxAmountsAnyOf1ItemX54a21e4f must be a JSON object",
                    )
            val amount = json.decodeRequired<Int>(rawObject, "amount")
            val taxRateData =
                json.decodeRequired<InlineV1InvoicesUpdateLinesPostRequestFormLinesItemTaxRateDataX4acb2a94>(
                    rawObject,
                    "tax_rate_data",
                )
            ...
            return InlineV1InvoicesUpdateLinesPostRequestFormLinesItemTaxAmountsAnyOf1ItemX54a21e4f(
                ...
                taxabilityReason =
                    rawObject["taxability_reason"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1InvoicesUpdateLinesPostRequestFormLinesItemTaxabilityReasonXda193a2e>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesUpdateLinesPostRequestFormLinesItemTaxAmountsAnyOf1ItemX54a21e4f,
        ) {
            val jsonEncoder =
...
public fun inlineV1InvoicesUpdateLinesPostRequestFormLinesItemTaxAmountsAnyOf1ItemX54a21e4f(
    block: InlineV1InvoicesUpdateLinesPostRequestFormLinesItemTaxAmountsAnyOf1ItemX54a21e4f.Builder.() -> Unit,
): InlineV1InvoicesUpdateLinesPostRequestFormLinesItemTaxAmountsAnyOf1ItemX54a21e4f =
    InlineV1InvoicesUpdateLinesPostRequestFormLinesItemTaxAmountsAnyOf1ItemX54a21e4f.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1InvoicesUpdateLinesPostRequestFormLinesItemTaxAmountsAnyOf1ItemX54a21e4f is missing required property '" +
                    name +
                    "'",
            )
