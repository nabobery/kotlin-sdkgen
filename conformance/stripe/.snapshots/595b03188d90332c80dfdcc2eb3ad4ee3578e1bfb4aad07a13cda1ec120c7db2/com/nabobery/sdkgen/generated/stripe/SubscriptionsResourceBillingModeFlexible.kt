...
public data class SubscriptionsResourceBillingModeFlexibleView(
    ...
    public val prorationDiscounts: InlineSubscriptionsResourceBillingModeFlexibleProrationDiscountsX1fa0511f? = null,
)
...
public class SubscriptionsResourceBillingModeFlexible(
    ...
    public class Builder {
        ...
        public fun build(): SubscriptionsResourceBillingModeFlexible =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): SubscriptionsResourceBillingModeFlexible =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<SubscriptionsResourceBillingModeFlexible> {
        ...
        override fun deserialize(decoder: Decoder): SubscriptionsResourceBillingModeFlexible {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("SubscriptionsResourceBillingModeFlexible must be a JSON object")
            return SubscriptionsResourceBillingModeFlexible(
                prorationDiscounts =
                    rawObject["proration_discounts"]?.let {
                        json
                            .decodeFromJsonElement<InlineSubscriptionsResourceBillingModeFlexibleProrationDiscountsX1fa0511f>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: SubscriptionsResourceBillingModeFlexible,
        ) {
...
public fun subscriptionsResourceBillingModeFlexible(
    block: SubscriptionsResourceBillingModeFlexible.Builder.() -> Unit,
): SubscriptionsResourceBillingModeFlexible = SubscriptionsResourceBillingModeFlexible.build(block)
