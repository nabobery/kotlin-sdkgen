...
public sealed class InlineInvoiceRenderingPdfPageSizeXa324d13f {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineInvoiceRenderingPdfPageSizeXa324d13f =
            when (value) {
                A4.value -> A4
                Auto.value -> Auto
                Letter.value -> Letter
    ...
    public object Serializer : KSerializer<InlineInvoiceRenderingPdfPageSizeXa324d13f> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineInvoiceRenderingPdfPageSizeXa324d13f",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineInvoiceRenderingPdfPageSizeXa324d13f =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineInvoiceRenderingPdfPageSizeXa324d13f,
        ) {
