...
public class InlineV1CheckoutSessionsPostRequestFormShippingOptionsItemFixedAmountX4b990741(
    ...
    public val currencyOptions:
        Map<String, InlineV1CheckoutSessionsPostRequestFormShippingOptionsAdditionalValueX3d05d8d0>? = null,
) {
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1CheckoutSessionsPostRequestFormShippingOptionsItemFixedAmountX4b990741 =
    ...
    public object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormShippingOptionsItemFixedAmountX4b990741> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CheckoutSessionsPostRequestFormShippingOptionsItemFixedAmountX4b990741 must be a JSON object",
                    )
            ...
            return InlineV1CheckoutSessionsPostRequestFormShippingOptionsItemFixedAmountX4b990741(
                ...
                currencyOptions =
                    rawObject["currency_options"]?.let {
                        json
                            .decodeFromJsonElement<Map<String, InlineV1CheckoutSessionsPostRequestFormShippingOptionsAdditionalValueX3d05d8d0>>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsPostRequestFormShippingOptionsItemFixedAmountX4b990741,
        ) {
            val jsonEncoder =
...
public fun inlineV1CheckoutSessionsPostRequestFormShippingOptionsItemFixedAmountX4b990741(
    block: InlineV1CheckoutSessionsPostRequestFormShippingOptionsItemFixedAmountX4b990741.Builder.() -> Unit,
): InlineV1CheckoutSessionsPostRequestFormShippingOptionsItemFixedAmountX4b990741 =
    InlineV1CheckoutSessionsPostRequestFormShippingOptionsItemFixedAmountX4b990741.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1CheckoutSessionsPostRequestFormShippingOptionsItemFixedAmountX4b990741 is missing required property '" +
                    name +
                    "'",
            )
