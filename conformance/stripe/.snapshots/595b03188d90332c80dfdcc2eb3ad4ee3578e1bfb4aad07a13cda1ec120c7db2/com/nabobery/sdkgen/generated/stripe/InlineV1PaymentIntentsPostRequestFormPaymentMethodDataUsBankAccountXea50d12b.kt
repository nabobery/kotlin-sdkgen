...
public class InlineV1PaymentIntentsPostRequestFormPaymentMethodDataUsBankAccountXea50d12b(
    ...
    public val accountType: InlineV1PaymentIntentsPostRequestFormPaymentMethodDataAccountTypeX32cde6b2? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1PaymentIntentsPostRequestFormPaymentMethodDataUsBankAccountXea50d12b =
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentIntentsPostRequestFormPaymentMethodDataUsBankAccountXea50d12b = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormPaymentMethodDataUsBankAccountXea50d12b> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsPostRequestFormPaymentMethodDataUsBankAccountXea50d12b must be a JSON object",
                    )
            return InlineV1PaymentIntentsPostRequestFormPaymentMethodDataUsBankAccountXea50d12b(
                accountHolderType =
                    rawObject["account_holder_type"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodDataAccountHolderTypeX00915c67>(
                                it,
                            )
                    },
                ...
                accountType =
                    rawObject["account_type"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodDataAccountTypeX32cde6b2>(
                                it,
                            )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormPaymentMethodDataUsBankAccountXea50d12b,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentIntentsPostRequestFormPaymentMethodDataUsBankAccountXea50d12b(
    block: InlineV1PaymentIntentsPostRequestFormPaymentMethodDataUsBankAccountXea50d12b.Builder.() -> Unit,
): InlineV1PaymentIntentsPostRequestFormPaymentMethodDataUsBankAccountXea50d12b =
    InlineV1PaymentIntentsPostRequestFormPaymentMethodDataUsBankAccountXea50d12b.build(block)
