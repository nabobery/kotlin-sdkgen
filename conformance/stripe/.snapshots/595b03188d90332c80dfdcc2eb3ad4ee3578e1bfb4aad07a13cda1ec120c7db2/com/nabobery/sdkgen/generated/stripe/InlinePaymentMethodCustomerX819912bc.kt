...
public class InlinePaymentMethodCustomerX819912bc internal constructor(
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlinePaymentMethodCustomerX819912bc {
            val inspection = inspectInlinePaymentMethodCustomerX819912bc(raw)
            if (inspection.matchCount == 0) {
                throw InlinePaymentMethodCustomerX819912bcNoMatchException(
                    "InlinePaymentMethodCustomerX819912bc matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlinePaymentMethodCustomerX819912bc> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentMethodCustomerX819912bc,
        ) {
...
private fun inspectInlinePaymentMethodCustomerX819912bc(
    element: JsonElement,
): InlinePaymentMethodCustomerX819912bcInspection {
