...
public class InlineV1PaymentMethodsPostRequestFormBillingDetailsXab324975(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1PaymentMethodsPostRequestFormBillingDetailsXab324975 =
            InlineV1PaymentMethodsPostRequestFormBillingDetailsXab324975(
                address = address,
                email = email,
                name = name,
                phone = phone,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PaymentMethodsPostRequestFormBillingDetailsXab324975 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentMethodsPostRequestFormBillingDetailsXab324975> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentMethodsPostRequestFormBillingDetailsXab324975 must be a JSON object",
                    )
            return InlineV1PaymentMethodsPostRequestFormBillingDetailsXab324975(
                address =
                    rawObject["address"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentMethodsPostRequestFormBillingDetailsAddressXc7f1bfd9>(
                            it,
                        )
                    },
                email =
                    rawObject["email"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentMethodsPostRequestFormBillingDetailsEmailX15c9d09b>(
                            it,
                        )
                    },
                name =
                    rawObject["name"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentMethodsPostRequestFormBillingDetailsNameX82ec7fed>(it)
                    },
                phone =
                    rawObject["phone"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentMethodsPostRequestFormBillingDetailsPhoneX83105b17>(
                            it,
                        )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentMethodsPostRequestFormBillingDetailsXab324975,
        ) {
...
public fun inlineV1PaymentMethodsPostRequestFormBillingDetailsXab324975(
    block: InlineV1PaymentMethodsPostRequestFormBillingDetailsXab324975.Builder.() -> Unit,
): InlineV1PaymentMethodsPostRequestFormBillingDetailsXab324975 =
    InlineV1PaymentMethodsPostRequestFormBillingDetailsXab324975.build(block)
