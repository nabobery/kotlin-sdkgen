...
public sealed class InlineV1AccountsPostRequestFormBusinessProfileSupportUrlAnyOf2X8ec962e5 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1AccountsPostRequestFormBusinessProfileSupportUrlAnyOf2X8ec962e5 =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1AccountsPostRequestFormBusinessProfileSupportUrlAnyOf2X8ec962e5> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1AccountsPostRequestFormBusinessProfileSupportUrlAnyOf2X8ec962e5",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1AccountsPostRequestFormBusinessProfileSupportUrlAnyOf2X8ec962e5 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPostRequestFormBusinessProfileSupportUrlAnyOf2X8ec962e5,
        ) {
