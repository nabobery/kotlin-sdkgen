...
public sealed class InlineGelatoSessionMatchingOptionsDobX124eab30 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineGelatoSessionMatchingOptionsDobX124eab30 =
            when (value) {
                None.value -> None
    ...
    public object Serializer : KSerializer<InlineGelatoSessionMatchingOptionsDobX124eab30> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineGelatoSessionMatchingOptionsDobX124eab30",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineGelatoSessionMatchingOptionsDobX124eab30 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineGelatoSessionMatchingOptionsDobX124eab30,
        ) {
