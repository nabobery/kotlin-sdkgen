...
public class PaymentLinksResourceCompletedSessions(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentLinksResourceCompletedSessions =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentLinksResourceCompletedSessions> {
        ...
        override fun deserialize(decoder: Decoder): PaymentLinksResourceCompletedSessions {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentLinksResourceCompletedSessions must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentLinksResourceCompletedSessions,
        ) {
...
public fun paymentLinksResourceCompletedSessions(
    block: PaymentLinksResourceCompletedSessions.Builder.() -> Unit,
): PaymentLinksResourceCompletedSessions = PaymentLinksResourceCompletedSessions.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "PaymentLinksResourceCompletedSessions is missing required property '" + name + "'",
            )
