...
public class InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsMandateOptionsX263adc7d(
    ...
    public val amountType: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsUpiAmountTypeXc258f5ac? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsMandateOptionsX263adc7d =
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsMandateOptionsX263adc7d> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsMandateOptionsX263adc7d must be a JSON object",
                    )
            return InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsMandateOptionsX263adc7d(
                ...
                amountType =
                    rawObject["amount_type"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsUpiAmountTypeXc258f5ac>(
                                it,
                            )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsMandateOptionsX263adc7d,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsMandateOptionsX263adc7d(
    block: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsMandateOptionsX263adc7d.Builder.() -> Unit,
): InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsMandateOptionsX263adc7d =
    InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsMandateOptionsX263adc7d.build(block)
