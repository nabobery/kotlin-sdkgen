...
public class InlineV1SubscriptionsPostRequestFormItemsItemPriceDataRecurringX54769f3e(
    public val interval: InlineV1SubscriptionsPostRequestFormItemsItemPriceDataRecurringIntervalXed555c2c,
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1SubscriptionsPostRequestFormItemsItemPriceDataRecurringX54769f3e = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionsPostRequestFormItemsItemPriceDataRecurringX54769f3e> {
        ...
        override fun deserialize(
            decoder: Decoder,
        ): InlineV1SubscriptionsPostRequestFormItemsItemPriceDataRecurringX54769f3e {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SubscriptionsPostRequestFormItemsItemPriceDataRecurringX54769f3e must be a JSON object",
                    )
            val interval =
                json
                    .decodeRequired<InlineV1SubscriptionsPostRequestFormItemsItemPriceDataRecurringIntervalXed555c2c>(
                        rawObject,
                        "interval",
                    )
            return InlineV1SubscriptionsPostRequestFormItemsItemPriceDataRecurringX54769f3e(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsPostRequestFormItemsItemPriceDataRecurringX54769f3e,
        ) {
            val jsonEncoder =
...
public fun inlineV1SubscriptionsPostRequestFormItemsItemPriceDataRecurringX54769f3e(
    block: InlineV1SubscriptionsPostRequestFormItemsItemPriceDataRecurringX54769f3e.Builder.() -> Unit,
): InlineV1SubscriptionsPostRequestFormItemsItemPriceDataRecurringX54769f3e =
    InlineV1SubscriptionsPostRequestFormItemsItemPriceDataRecurringX54769f3e.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1SubscriptionsPostRequestFormItemsItemPriceDataRecurringX54769f3e is missing required property '" +
                    name +
                    "'",
            )
