...
public class InlineV1AccountLinksPostRequestFormCollectionOptionsXb477fac8(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1AccountLinksPostRequestFormCollectionOptionsXb477fac8 =
            InlineV1AccountLinksPostRequestFormCollectionOptionsXb477fac8(
                fields = fields,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1AccountLinksPostRequestFormCollectionOptionsXb477fac8 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1AccountLinksPostRequestFormCollectionOptionsXb477fac8> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountLinksPostRequestFormCollectionOptionsXb477fac8 must be a JSON object",
                    )
            return InlineV1AccountLinksPostRequestFormCollectionOptionsXb477fac8(
                fields =
                    rawObject["fields"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountLinksPostRequestFormCollectionOptionsFieldsX4e558698>(
                            it,
                        )
                    },
                futureRequirements =
                    rawObject["future_requirements"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1AccountLinksPostRequestFormCollectionOptionsFutureRequirementsX777e43ca>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountLinksPostRequestFormCollectionOptionsXb477fac8,
        ) {
            val jsonEncoder =
...
public fun inlineV1AccountLinksPostRequestFormCollectionOptionsXb477fac8(
    block: InlineV1AccountLinksPostRequestFormCollectionOptionsXb477fac8.Builder.() -> Unit,
): InlineV1AccountLinksPostRequestFormCollectionOptionsXb477fac8 =
    InlineV1AccountLinksPostRequestFormCollectionOptionsXb477fac8.build(block)
