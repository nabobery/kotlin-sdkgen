...
public class InlineV1InvoicesMarkUncollectiblePostRequestFormX5f3ee136(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1InvoicesMarkUncollectiblePostRequestFormX5f3ee136 =
            InlineV1InvoicesMarkUncollectiblePostRequestFormX5f3ee136(
                expand = expand,
            )
    }

    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1InvoicesMarkUncollectiblePostRequestFormX5f3ee136 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1InvoicesMarkUncollectiblePostRequestFormX5f3ee136> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1InvoicesMarkUncollectiblePostRequestFormX5f3ee136 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesMarkUncollectiblePostRequestFormX5f3ee136,
        ) {
...
public fun inlineV1InvoicesMarkUncollectiblePostRequestFormX5f3ee136(
    block: InlineV1InvoicesMarkUncollectiblePostRequestFormX5f3ee136.Builder.() -> Unit,
): InlineV1InvoicesMarkUncollectiblePostRequestFormX5f3ee136 =
    InlineV1InvoicesMarkUncollectiblePostRequestFormX5f3ee136.build(block)
