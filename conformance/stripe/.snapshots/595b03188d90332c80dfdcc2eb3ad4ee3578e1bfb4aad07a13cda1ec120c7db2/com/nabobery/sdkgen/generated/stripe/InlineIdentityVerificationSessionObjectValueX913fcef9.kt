...
public sealed class InlineIdentityVerificationSessionObjectValueX913fcef9 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineIdentityVerificationSessionObjectValueX913fcef9 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineIdentityVerificationSessionObjectValueX913fcef9> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineIdentityVerificationSessionObjectValueX913fcef9",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineIdentityVerificationSessionObjectValueX913fcef9 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineIdentityVerificationSessionObjectValueX913fcef9,
        ) {
