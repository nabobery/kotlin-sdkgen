...
public class SourceTypeSepaDebit(
    ...
    public class Builder {
        ...
        public fun build(): SourceTypeSepaDebit =
            SourceTypeSepaDebit(
                bankCode = bankCode,
    ...
    public object Serializer : KSerializer<SourceTypeSepaDebit> {
        ...
        override fun deserialize(decoder: Decoder): SourceTypeSepaDebit {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("SourceTypeSepaDebit must be a JSON object")
            return SourceTypeSepaDebit(
                ...
                mandateReference =
                    rawObject["mandate_reference"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                mandateUrl =
                    rawObject["mandate_url"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
...
public fun sourceTypeSepaDebit(block: SourceTypeSepaDebit.Builder.() -> Unit): SourceTypeSepaDebit =
    SourceTypeSepaDebit.build(block)
