...
public sealed class InlineV1CheckoutSessionsPostRequestFormCustomFieldsItemLabelTypeX0aff2239 {
    ...
    public object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormCustomFieldsItemLabelTypeX0aff2239> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1CheckoutSessionsPostRequestFormCustomFieldsItemLabelTypeX0aff2239",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1CheckoutSessionsPostRequestFormCustomFieldsItemLabelTypeX0aff2239 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsPostRequestFormCustomFieldsItemLabelTypeX0aff2239,
        ) {
