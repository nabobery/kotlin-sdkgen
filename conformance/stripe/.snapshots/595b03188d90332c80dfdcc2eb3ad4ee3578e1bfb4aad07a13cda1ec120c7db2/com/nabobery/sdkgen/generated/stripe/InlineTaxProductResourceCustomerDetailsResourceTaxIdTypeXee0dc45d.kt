...
public sealed class InlineTaxProductResourceCustomerDetailsResourceTaxIdTypeXee0dc45d {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineTaxProductResourceCustomerDetailsResourceTaxIdTypeXee0dc45d =
            when (value) {
                AdNrt.value -> AdNrt
                AeTrn.value -> AeTrn
                AlTin.value -> AlTin
    ...
    public object Serializer : KSerializer<InlineTaxProductResourceCustomerDetailsResourceTaxIdTypeXee0dc45d> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineTaxProductResourceCustomerDetailsResourceTaxIdTypeXee0dc45d",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineTaxProductResourceCustomerDetailsResourceTaxIdTypeXee0dc45d =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineTaxProductResourceCustomerDetailsResourceTaxIdTypeXee0dc45d,
        ) {
