...
public sealed class InlineAccountCapabilitiesUsBankAccountAchPaymentsXe23b6dee {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineAccountCapabilitiesUsBankAccountAchPaymentsXe23b6dee =
            when (value) {
                Active.value -> Active
    ...
    public object Serializer : KSerializer<InlineAccountCapabilitiesUsBankAccountAchPaymentsXe23b6dee> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineAccountCapabilitiesUsBankAccountAchPaymentsXe23b6dee",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineAccountCapabilitiesUsBankAccountAchPaymentsXe23b6dee =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineAccountCapabilitiesUsBankAccountAchPaymentsXe23b6dee,
        ) {
