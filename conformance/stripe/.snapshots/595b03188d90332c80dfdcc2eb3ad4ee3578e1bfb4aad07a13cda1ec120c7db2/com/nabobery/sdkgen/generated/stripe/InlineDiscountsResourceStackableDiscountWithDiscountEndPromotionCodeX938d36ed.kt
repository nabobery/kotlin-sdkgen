...
public class InlineDiscountsResourceStackableDiscountWithDiscountEndPromotionCodeX938d36ed internal constructor(
    ...
    private val inspection: InlineDiscountsResourceStackableDiscountWithDiscountEndPromotionCodeX938d36edInspection,
) {
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineDiscountsResourceStackableDiscountWithDiscountEndPromotionCodeX938d36edBranch.Branch1,
                    )
                }
                if (inspection.matchesPromotionCode) {
                    add(
                        InlineDiscountsResourceStackableDiscountWithDiscountEndPromotionCodeX938d36edBranch.PromotionCode,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineDiscountsResourceStackableDiscountWithDiscountEndPromotionCodeX938d36ed {
            val inspection = inspectInlineDiscountsResourceStackableDiscountWithDiscountEndPromotionCodeX938d36ed(raw)
            if (inspection.matchCount == 0) {
                throw InlineDiscountsResourceStackableDiscountWithDiscountEndPromotionCodeX938d36edNoMatchException(
                    "InlineDiscountsResourceStackableDiscountWithDiscountEndPromotionCodeX938d36ed matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineDiscountsResourceStackableDiscountWithDiscountEndPromotionCodeX938d36ed> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineDiscountsResourceStackableDiscountWithDiscountEndPromotionCodeX938d36ed,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineDiscountsResourceStackableDiscountWithDiscountEndPromotionCodeX938d36ed",
...
private fun inspectInlineDiscountsResourceStackableDiscountWithDiscountEndPromotionCodeX938d36ed(
    element: JsonElement,
