...
internal data class InlineV1PaymentLinksPostRequestFormSubscriptionDataMetadataXee471759Inspection(
    ...
    public val matchesInlineV1PaymentLinksPostRequestFormSubscriptionDataMetadataAnyOf2Xd39714f8: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1PaymentLinksPostRequestFormSubscriptionDataMetadataAnyOf2Xd39714f8,
            ).count {
                it
            }
}
...
public class InlineV1PaymentLinksPostRequestFormSubscriptionDataMetadataXee471759 internal constructor(
    ...
    private val inspection: InlineV1PaymentLinksPostRequestFormSubscriptionDataMetadataXee471759Inspection,
) {
    ...
    public val inlineV1PaymentLinksPostRequestFormSubscriptionDataMetadataAnyOf2Xd39714f8:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1PaymentLinksPostRequestFormSubscriptionDataMetadataAnyOf2Xd39714f8) {
                json
                    .decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormSubscriptionDataMetadataAnyOf2Xd39714f8>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1PaymentLinksPostRequestFormSubscriptionDataMetadataXee471759Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1PaymentLinksPostRequestFormSubscriptionDataMetadataAnyOf2Xd39714f8) {
                    add(
                        InlineV1PaymentLinksPostRequestFormSubscriptionDataMetadataXee471759Branch.InlineV1PaymentLinksPostRequestFormSubscriptionDataMetadataAnyOf2Xd39714f8,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1PaymentLinksPostRequestFormSubscriptionDataMetadataXee471759 {
            val inspection = inspectInlineV1PaymentLinksPostRequestFormSubscriptionDataMetadataXee471759(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1PaymentLinksPostRequestFormSubscriptionDataMetadataXee471759NoMatchException(
                    "InlineV1PaymentLinksPostRequestFormSubscriptionDataMetadataXee471759 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1PaymentLinksPostRequestFormSubscriptionDataMetadataXee471759> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentLinksPostRequestFormSubscriptionDataMetadataXee471759,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1PaymentLinksPostRequestFormSubscriptionDataMetadataXee471759",
...
private fun inspectInlineV1PaymentLinksPostRequestFormSubscriptionDataMetadataXee471759(
    element: JsonElement,
): InlineV1PaymentLinksPostRequestFormSubscriptionDataMetadataXee471759Inspection {
    val matchesBranch1 = element.isJsonDecodable<JsonObject>()
    val matchesInlineV1PaymentLinksPostRequestFormSubscriptionDataMetadataAnyOf2Xd39714f8 =
        element
            .isJsonDecodable<InlineV1PaymentLinksPostRequestFormSubscriptionDataMetadataAnyOf2Xd39714f8>()
    return InlineV1PaymentLinksPostRequestFormSubscriptionDataMetadataXee471759Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1PaymentLinksPostRequestFormSubscriptionDataMetadataAnyOf2Xd39714f8) {
                    add(
                        "InlineV1PaymentLinksPostRequestFormSubscriptionDataMetadataAnyOf2Xd39714f8: value does not match InlineV1PaymentLinksPostRequestFormSubscriptionDataMetadataAnyOf2Xd39714f8",
                    )
                }
            },
    )
