...
public class InlineV1PromotionCodesPostRequestFormMetadataX1f097777 internal constructor(
    ...
    public val inlineV1PromotionCodesPostRequestFormMetadataAnyOf2X8ab7a844:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1PromotionCodesPostRequestFormMetadataAnyOf2X8ab7a844) {
                json
                    .decodeFromJsonElement<InlineV1PromotionCodesPostRequestFormMetadataAnyOf2X8ab7a844>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1PromotionCodesPostRequestFormMetadataX1f097777Branch>
        get() =
            buildSet {
                ...
                if (inspection.matchesInlineV1PromotionCodesPostRequestFormMetadataAnyOf2X8ab7a844) {
                    add(
                        InlineV1PromotionCodesPostRequestFormMetadataX1f097777Branch.InlineV1PromotionCodesPostRequestFormMetadataAnyOf2X8ab7a844,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1PromotionCodesPostRequestFormMetadataX1f097777 {
            val inspection = inspectInlineV1PromotionCodesPostRequestFormMetadataX1f097777(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1PromotionCodesPostRequestFormMetadataX1f097777NoMatchException(
                    "InlineV1PromotionCodesPostRequestFormMetadataX1f097777 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1PromotionCodesPostRequestFormMetadataX1f097777> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PromotionCodesPostRequestFormMetadataX1f097777,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1PromotionCodesPostRequestFormMetadataX1f097777",
...
private fun inspectInlineV1PromotionCodesPostRequestFormMetadataX1f097777(
    element: JsonElement,
): InlineV1PromotionCodesPostRequestFormMetadataX1f097777Inspection {
    val matchesBranch1 = element.isJsonDecodable<JsonObject>()
    val matchesInlineV1PromotionCodesPostRequestFormMetadataAnyOf2X8ab7a844 =
        element
            .isJsonDecodable<InlineV1PromotionCodesPostRequestFormMetadataAnyOf2X8ab7a844>()
    return InlineV1PromotionCodesPostRequestFormMetadataX1f097777Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1PromotionCodesPostRequestFormMetadataAnyOf2X8ab7a844) {
                    add(
                        "InlineV1PromotionCodesPostRequestFormMetadataAnyOf2X8ab7a844: value does not match InlineV1PromotionCodesPostRequestFormMetadataAnyOf2X8ab7a844",
                    )
                }
            },
    )
