...
public class InlineV1RadarPaymentEvaluationsPostRequestFormCustomerDetailsX7bb26d9f(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1RadarPaymentEvaluationsPostRequestFormCustomerDetailsX7bb26d9f =
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1RadarPaymentEvaluationsPostRequestFormCustomerDetailsX7bb26d9f = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1RadarPaymentEvaluationsPostRequestFormCustomerDetailsX7bb26d9f> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1RadarPaymentEvaluationsPostRequestFormCustomerDetailsX7bb26d9f must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1RadarPaymentEvaluationsPostRequestFormCustomerDetailsX7bb26d9f,
        ) {
            val jsonEncoder =
...
public fun inlineV1RadarPaymentEvaluationsPostRequestFormCustomerDetailsX7bb26d9f(
    block: InlineV1RadarPaymentEvaluationsPostRequestFormCustomerDetailsX7bb26d9f.Builder.() -> Unit,
): InlineV1RadarPaymentEvaluationsPostRequestFormCustomerDetailsX7bb26d9f =
    InlineV1RadarPaymentEvaluationsPostRequestFormCustomerDetailsX7bb26d9f.build(block)
