...
public class InlineV1FinancialConnectionsAccountsSubscribePostRequestFormX6fca75e5(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1FinancialConnectionsAccountsSubscribePostRequestFormX6fca75e5 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1FinancialConnectionsAccountsSubscribePostRequestFormX6fca75e5> {
        override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1FinancialConnectionsAccountsSubscribePostRequestFormX6fca75e5 {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1FinancialConnectionsAccountsSubscribePostRequestFormX6fca75e5 must be a JSON object",
                    )
            val features =
                json.decodeRequired<List<InlineV1FinancialConnectio3ed8PostRequestFormFeaturesItemX53a5688e>>(
                    rawObject,
                    "features",
                )
            return InlineV1FinancialConnectionsAccountsSubscribePostRequestFormX6fca75e5(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1FinancialConnectionsAccountsSubscribePostRequestFormX6fca75e5,
        ) {
            val jsonEncoder =
...
public fun inlineV1FinancialConnectionsAccountsSubscribePostRequestFormX6fca75e5(
    block: InlineV1FinancialConnectionsAccountsSubscribePostRequestFormX6fca75e5.Builder.() -> Unit,
): InlineV1FinancialConnectionsAccountsSubscribePostRequestFormX6fca75e5 =
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1FinancialConnectionsAccountsSubscribePostRequestFormX6fca75e5 is missing required property '" +
                    name +
                    "'",
            )
