...
public class InlineV1TerminalLocationsPostRequestFormAddressX18dbb007(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1TerminalLocationsPostRequestFormAddressX18dbb007 =
            InlineV1TerminalLocationsPostRequestFormAddressX18dbb007(
                city = city,
                country = country,
                line1 = line1,
                line2 = line2,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TerminalLocationsPostRequestFormAddressX18dbb007 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TerminalLocationsPostRequestFormAddressX18dbb007> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TerminalLocationsPostRequestFormAddressX18dbb007 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TerminalLocationsPostRequestFormAddressX18dbb007,
        ) {
...
public fun inlineV1TerminalLocationsPostRequestFormAddressX18dbb007(
    block: InlineV1TerminalLocationsPostRequestFormAddressX18dbb007.Builder.() -> Unit,
): InlineV1TerminalLocationsPostRequestFormAddressX18dbb007 =
    InlineV1TerminalLocationsPostRequestFormAddressX18dbb007.build(block)
