...
internal data class InlineV1TerminalLocationsPostRequestFormMetadataXfd4c4a0aInspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1TerminalLocationsPostRequestFormMetadataAnyOf2X64647784,
            ).count { it }
}
...
public class InlineV1TerminalLocationsPostRequestFormMetadataXfd4c4a0a internal constructor(
    ...
    public val inlineV1TerminalLocationsPostRequestFormMetadataAnyOf2X64647784:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1TerminalLocationsPostRequestFormMetadataAnyOf2X64647784) {
                json
                    .decodeFromJsonElement<InlineV1TerminalLocationsPostRequestFormMetadataAnyOf2X64647784>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1TerminalLocationsPostRequestFormMetadataXfd4c4a0aBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1TerminalLocationsPostRequestFormMetadataAnyOf2X64647784) {
                    add(
                        InlineV1TerminalLocationsPostRequestFormMetadataXfd4c4a0aBranch.InlineV1TerminalLocationsPostRequestFormMetadataAnyOf2X64647784,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1TerminalLocationsPostRequestFormMetadataXfd4c4a0a {
            val inspection = inspectInlineV1TerminalLocationsPostRequestFormMetadataXfd4c4a0a(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1TerminalLocationsPostRequestFormMetadataXfd4c4a0aNoMatchException(
                    "InlineV1TerminalLocationsPostRequestFormMetadataXfd4c4a0a matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1TerminalLocationsPostRequestFormMetadataXfd4c4a0a> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TerminalLocationsPostRequestFormMetadataXfd4c4a0a,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1TerminalLocationsPostRequestFormMetadataXfd4c4a0a",
...
private fun inspectInlineV1TerminalLocationsPostRequestFormMetadataXfd4c4a0a(
    element: JsonElement,
): InlineV1TerminalLocationsPostRequestFormMetadataXfd4c4a0aInspection {
    val matchesBranch1 = element.isJsonDecodable<JsonObject>()
    val matchesInlineV1TerminalLocationsPostRequestFormMetadataAnyOf2X64647784 =
        element
            .isJsonDecodable<InlineV1TerminalLocationsPostRequestFormMetadataAnyOf2X64647784>()
    return InlineV1TerminalLocationsPostRequestFormMetadataXfd4c4a0aInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1TerminalLocationsPostRequestFormMetadataAnyOf2X64647784) {
                    add(
                        "InlineV1TerminalLocationsPostRequestFormMetadataAnyOf2X64647784: value does not match InlineV1TerminalLocationsPostRequestFormMetadataAnyOf2X64647784",
                    )
                }
            },
    )
