...
public class InlineV1PaymentIntentsConfirmPostRequestFormHooksInputsXfc33d122(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1PaymentIntentsConfirmPostRequestFormHooksInputsXfc33d122 =
            InlineV1PaymentIntentsConfirmPostRequestFormHooksInputsXfc33d122(
                tax = tax,
            )
    }

    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PaymentIntentsConfirmPostRequestFormHooksInputsXfc33d122 =
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsConfirmPostRequestFormHooksInputsXfc33d122> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsConfirmPostRequestFormHooksInputsXfc33d122 must be a JSON object",
                    )
            return InlineV1PaymentIntentsConfirmPostRequestFormHooksInputsXfc33d122(
                tax =
                    rawObject["tax"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormHooksInputsTaxX47ce7ec9>(
                            it,
                        )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsConfirmPostRequestFormHooksInputsXfc33d122,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentIntentsConfirmPostRequestFormHooksInputsXfc33d122(
    block: InlineV1PaymentIntentsConfirmPostRequestFormHooksInputsXfc33d122.Builder.() -> Unit,
): InlineV1PaymentIntentsConfirmPostRequestFormHooksInputsXfc33d122 =
    InlineV1PaymentIntentsConfirmPostRequestFormHooksInputsXfc33d122.build(block)
