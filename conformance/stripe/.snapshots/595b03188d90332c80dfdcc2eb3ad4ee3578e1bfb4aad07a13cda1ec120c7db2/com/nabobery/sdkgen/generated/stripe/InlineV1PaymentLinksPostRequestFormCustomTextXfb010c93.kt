...
public class InlineV1PaymentLinksPostRequestFormCustomTextXfb010c93(
    ...
    public val shippingAddress: InlineV1PaymentLinksPostRequestFormCustomTextShippingAddressXc8eae20e? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1PaymentLinksPostRequestFormCustomTextXfb010c93 =
            InlineV1PaymentLinksPostRequestFormCustomTextXfb010c93(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PaymentLinksPostRequestFormCustomTextXfb010c93 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentLinksPostRequestFormCustomTextXfb010c93> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentLinksPostRequestFormCustomTextXfb010c93 must be a JSON object",
                    )
            return InlineV1PaymentLinksPostRequestFormCustomTextXfb010c93(
                afterSubmit =
                    rawObject["after_submit"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormCustomTextAfterSubmitXa0b9682e>(
                            it,
                        )
                    },
                shippingAddress =
                    rawObject["shipping_address"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormCustomTextShippingAddressXc8eae20e>(
                                it,
                            )
                    },
                submit =
                    rawObject["submit"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormCustomTextSubmitX25a01e2d>(it)
                    },
                termsOfServiceAcceptance =
                    rawObject["terms_of_service_acceptance"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormCustomTextTermsOfServiceAcceptanceXac2bcc1d>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentLinksPostRequestFormCustomTextXfb010c93,
        ) {
...
public fun inlineV1PaymentLinksPostRequestFormCustomTextXfb010c93(
    block: InlineV1PaymentLinksPostRequestFormCustomTextXfb010c93.Builder.() -> Unit,
): InlineV1PaymentLinksPostRequestFormCustomTextXfb010c93 =
    InlineV1PaymentLinksPostRequestFormCustomTextXfb010c93.build(block)
