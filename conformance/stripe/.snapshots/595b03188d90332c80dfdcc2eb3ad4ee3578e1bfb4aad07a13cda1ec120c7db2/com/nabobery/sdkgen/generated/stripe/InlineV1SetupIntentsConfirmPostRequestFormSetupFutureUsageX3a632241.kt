...
public sealed class InlineV1SetupIntentsConfirmPostRequestFormSetupFutureUsageX3a632241 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1SetupIntentsConfirmPostRequestFormSetupFutureUsageX3a632241 =
            when (value) {
                Value.value -> Value
                None.value -> None
    ...
    public object Serializer : KSerializer<InlineV1SetupIntentsConfirmPostRequestFormSetupFutureUsageX3a632241> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1SetupIntentsConfirmPostRequestFormSetupFutureUsageX3a632241",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1SetupIntentsConfirmPostRequestFormSetupFutureUsageX3a632241 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SetupIntentsConfirmPostRequestFormSetupFutureUsageX3a632241,
        ) {
