...
public class CheckoutLinkWalletOptions(
    ...
    public class Builder {
        ...
        public fun build(): CheckoutLinkWalletOptions =
    ...
    public object Serializer : KSerializer<CheckoutLinkWalletOptions> {
        ...
        override fun deserialize(decoder: Decoder): CheckoutLinkWalletOptions {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("CheckoutLinkWalletOptions must be a JSON object")
            return CheckoutLinkWalletOptions(
                display =
                    rawObject["display"]?.let {
                        json
                            .decodeFromJsonElement<InlineCheckoutLinkWalletOptionsDisplayXdd4f6193>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: CheckoutLinkWalletOptions,
        ) {
...
public fun checkoutLinkWalletOptions(block: CheckoutLinkWalletOptions.Builder.() -> Unit): CheckoutLinkWalletOptions =
    CheckoutLinkWalletOptions.build(block)
