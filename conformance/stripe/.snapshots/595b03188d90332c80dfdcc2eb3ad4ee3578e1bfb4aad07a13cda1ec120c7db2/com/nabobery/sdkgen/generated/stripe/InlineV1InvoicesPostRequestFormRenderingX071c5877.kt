...
public class InlineV1InvoicesPostRequestFormRenderingX071c5877(
    public val amountTaxDisplay: InlineV1InvoicesPostRequestFormRenderingAmountTaxDisplayX43329d16? = null,
    public val pdf: InlineV1InvoicesPostRequestFormRenderingPdfX0cd1a3c9? = null,
    public val template: String? = null,
    public val templateVersion: InlineV1InvoicesPostRequestFormRenderingTemplateVersionX1f9b9450? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1InvoicesPostRequestFormRenderingX071c5877 =
            InlineV1InvoicesPostRequestFormRenderingX071c5877(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1InvoicesPostRequestFormRenderingX071c5877 =
    ...
    public object Serializer : KSerializer<InlineV1InvoicesPostRequestFormRenderingX071c5877> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1InvoicesPostRequestFormRenderingX071c5877 must be a JSON object",
                    )
            return InlineV1InvoicesPostRequestFormRenderingX071c5877(
                amountTaxDisplay =
                    rawObject["amount_tax_display"]?.let {
                        json.decodeFromJsonElement<InlineV1InvoicesPostRequestFormRenderingAmountTaxDisplayX43329d16>(
                            it,
                        )
                    },
                pdf =
                    rawObject["pdf"]?.let {
                        json.decodeFromJsonElement<InlineV1InvoicesPostRequestFormRenderingPdfX0cd1a3c9>(
                            it,
                        )
                    },
                ...
                templateVersion =
                    rawObject["template_version"]?.let {
                        json.decodeFromJsonElement<InlineV1InvoicesPostRequestFormRenderingTemplateVersionX1f9b9450>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesPostRequestFormRenderingX071c5877,
        ) {
...
public fun inlineV1InvoicesPostRequestFormRenderingX071c5877(
    block: InlineV1InvoicesPostRequestFormRenderingX071c5877.Builder.() -> Unit,
): InlineV1InvoicesPostRequestFormRenderingX071c5877 = InlineV1InvoicesPostRequestFormRenderingX071c5877.build(block)
