...
public sealed class InlineV1PayoutsGetResponse200JsonObjectValueXabae117b {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1PayoutsGetResponse200JsonObjectValueXabae117b =
            when (value) {
                List.value -> List
    ...
    public object Serializer : KSerializer<InlineV1PayoutsGetResponse200JsonObjectValueXabae117b> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1PayoutsGetResponse200JsonObjectValueXabae117b",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1PayoutsGetResponse200JsonObjectValueXabae117b =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PayoutsGetResponse200JsonObjectValueXabae117b,
        ) {
