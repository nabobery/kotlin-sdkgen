...
internal data class InlineV1PaymentIntentsPostRequestFormAmountDetailsTaxXd947c943Inspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesInlineV1PaymentIntentsPostRequestFormAmountDetailsTaxAnyOf1Xf1e39861,
                matchesInlineV1PaymentIntentsPostRequestFormAmountDetailsTaxAnyOf2Xcf4f3b1b,
            ).count {
                it
            }
}
...
public class InlineV1PaymentIntentsPostRequestFormAmountDetailsTaxXd947c943 internal constructor(
    ...
    public val inlineV1PaymentIntentsPostRequestFormAmountDetailsTaxAnyOf1Xf1e39861:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1PaymentIntentsPostRequestFormAmountDetailsTaxAnyOf1Xf1e39861) {
                json
                    .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormAmountDetailsTaxAnyOf1Xf1e39861>(
                        raw,
                    )
            } else {
                null
    ...
    public val inlineV1PaymentIntentsPostRequestFormAmountDetailsTaxAnyOf2Xcf4f3b1b:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1PaymentIntentsPostRequestFormAmountDetailsTaxAnyOf2Xcf4f3b1b) {
                json
                    .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormAmountDetailsTaxAnyOf2Xcf4f3b1b>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches:
        ...
        get() =
            buildSet {
                if (inspection.matchesInlineV1PaymentIntentsPostRequestFormAmountDetailsTaxAnyOf1Xf1e39861) {
                    add(
                        InlineV1PaymentIntentsPostRequestFormAmountDetailsTaxXd947c943Branch.InlineV1PaymentIntentsPostRequestFormAmountDetailsTaxAnyOf1Xf1e39861,
                    )
                }
                if (inspection.matchesInlineV1PaymentIntentsPostRequestFormAmountDetailsTaxAnyOf2Xcf4f3b1b) {
                    add(
                        InlineV1PaymentIntentsPostRequestFormAmountDetailsTaxXd947c943Branch.InlineV1PaymentIntentsPostRequestFormAmountDetailsTaxAnyOf2Xcf4f3b1b,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1PaymentIntentsPostRequestFormAmountDetailsTaxXd947c943 {
            val inspection = inspectInlineV1PaymentIntentsPostRequestFormAmountDetailsTaxXd947c943(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1PaymentIntentsPostRequestFormAmountDetailsTaxXd947c943NoMatchException(
                    "InlineV1PaymentIntentsPostRequestFormAmountDetailsTaxXd947c943 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormAmountDetailsTaxXd947c943> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormAmountDetailsTaxXd947c943,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1PaymentIntentsPostRequestFormAmountDetailsTaxXd947c943",
...
private fun inspectInlineV1PaymentIntentsPostRequestFormAmountDetailsTaxXd947c943(
    element: JsonElement,
): InlineV1PaymentIntentsPostRequestFormAmountDetailsTaxXd947c943Inspection {
    val matchesInlineV1PaymentIntentsPostRequestFormAmountDetailsTaxAnyOf1Xf1e39861 =
        element
            .isJsonDecodable<InlineV1PaymentIntentsPostRequestFormAmountDetailsTaxAnyOf1Xf1e39861>()
    val matchesInlineV1PaymentIntentsPostRequestFormAmountDetailsTaxAnyOf2Xcf4f3b1b =
        element
            .isJsonDecodable<InlineV1PaymentIntentsPostRequestFormAmountDetailsTaxAnyOf2Xcf4f3b1b>()
    return InlineV1PaymentIntentsPostRequestFormAmountDetailsTaxXd947c943Inspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1PaymentIntentsPostRequestFormAmountDetailsTaxAnyOf1Xf1e39861) {
                    add(
                        "InlineV1PaymentIntentsPostRequestFormAmountDetailsTaxAnyOf1Xf1e39861: value does not match InlineV1PaymentIntentsPostRequestFormAmountDetailsTaxAnyOf1Xf1e39861",
                    )
                }
                if (!matchesInlineV1PaymentIntentsPostRequestFormAmountDetailsTaxAnyOf2Xcf4f3b1b) {
                    add(
                        "InlineV1PaymentIntentsPostRequestFormAmountDetailsTaxAnyOf2Xcf4f3b1b: value does not match InlineV1PaymentIntentsPostRequestFormAmountDetailsTaxAnyOf2Xcf4f3b1b",
                    )
                }
            },
    )
