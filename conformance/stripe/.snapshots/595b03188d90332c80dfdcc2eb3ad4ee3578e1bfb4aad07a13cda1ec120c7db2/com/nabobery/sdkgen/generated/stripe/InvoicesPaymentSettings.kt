...
public class InvoicesPaymentSettings(
     ...
     */
    public val paymentMethodOptions: InlineInvoicesPaymentSettingsPaymentMethodOptionsXd97a36d8? = null,
    /**
     ...
     */
    public val paymentMethodTypes: List<InlineInvoicesPaymentSettingsPaymentMethodTypesItemX5a488e4d>? = null,
) {
    public class Builder {
        ...
        public fun build(): InvoicesPaymentSettings =
    ...
    public object Serializer : KSerializer<InvoicesPaymentSettings> {
        ...
        override fun deserialize(decoder: Decoder): InvoicesPaymentSettings {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("InvoicesPaymentSettings must be a JSON object")
            return InvoicesPaymentSettings(
                defaultMandate =
                    rawObject["default_mandate"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                paymentMethodOptions =
                    rawObject["payment_method_options"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineInvoicesPaymentSettingsPaymentMethodOptionsXd97a36d8?>(
                                element,
                            )
                        }
                    },
                paymentMethodTypes =
                    rawObject["payment_method_types"]?.let { element ->
                        if (element ==
                            ...
                            json
                                .decodeFromJsonElement<List<InlineInvoicesPaymentSettingsPaymentMethodTypesItemX5a488e4d>?>(
                                    element,
                                )
                        }
                    },
...
public fun invoicesPaymentSettings(block: InvoicesPaymentSettings.Builder.() -> Unit): InvoicesPaymentSettings =
    InvoicesPaymentSettings.build(block)
