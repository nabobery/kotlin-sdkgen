...
public class SetupIntentPaymentMethodOptionsPayto(
    ...
    public class Builder {
        ...
        public fun build(): SetupIntentPaymentMethodOptionsPayto =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): SetupIntentPaymentMethodOptionsPayto =
    ...
    public object Serializer : KSerializer<SetupIntentPaymentMethodOptionsPayto> {
        ...
        override fun deserialize(decoder: Decoder): SetupIntentPaymentMethodOptionsPayto {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("SetupIntentPaymentMethodOptionsPayto must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: SetupIntentPaymentMethodOptionsPayto,
        ) {
...
public fun setupIntentPaymentMethodOptionsPayto(
    block: SetupIntentPaymentMethodOptionsPayto.Builder.() -> Unit,
): SetupIntentPaymentMethodOptionsPayto = SetupIntentPaymentMethodOptionsPayto.build(block)
