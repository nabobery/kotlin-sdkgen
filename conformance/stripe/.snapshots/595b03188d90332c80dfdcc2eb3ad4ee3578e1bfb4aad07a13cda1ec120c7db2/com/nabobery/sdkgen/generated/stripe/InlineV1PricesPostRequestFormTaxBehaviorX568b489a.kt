...
public sealed class InlineV1PricesPostRequestFormTaxBehaviorX568b489a {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1PricesPostRequestFormTaxBehaviorX568b489a =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1PricesPostRequestFormTaxBehaviorX568b489a> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1PricesPostRequestFormTaxBehaviorX568b489a",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1PricesPostRequestFormTaxBehaviorX568b489a =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PricesPostRequestFormTaxBehaviorX568b489a,
        ) {
