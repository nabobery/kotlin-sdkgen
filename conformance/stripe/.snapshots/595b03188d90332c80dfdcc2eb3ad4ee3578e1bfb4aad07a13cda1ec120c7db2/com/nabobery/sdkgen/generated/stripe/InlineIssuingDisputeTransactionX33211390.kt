...
public class InlineIssuingDisputeTransactionX33211390 internal constructor(
        ...
        get() =
            buildSet {
                ...
                if (inspection.matchesIssuingTransaction) {
                    add(
                        InlineIssuingDisputeTransactionX33211390Branch.IssuingTransaction,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineIssuingDisputeTransactionX33211390 {
            val inspection = inspectInlineIssuingDisputeTransactionX33211390(raw)
            if (inspection.matchCount == 0) {
                throw InlineIssuingDisputeTransactionX33211390NoMatchException(
                    "InlineIssuingDisputeTransactionX33211390 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineIssuingDisputeTransactionX33211390> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineIssuingDisputeTransactionX33211390,
        ) {
...
private fun inspectInlineIssuingDisputeTransactionX33211390(
    element: JsonElement,
): InlineIssuingDisputeTransactionX33211390Inspection {
