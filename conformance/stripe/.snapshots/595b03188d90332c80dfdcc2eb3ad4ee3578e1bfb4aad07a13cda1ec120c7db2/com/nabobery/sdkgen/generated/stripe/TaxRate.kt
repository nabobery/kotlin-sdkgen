        ...
        override fun deserialize(decoder: Decoder): TaxRate {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("TaxRate must be a JSON object")
            ...
            return TaxRate(
                ...
                effectivePercentage =
                    rawObject["effective_percentage"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                flatAmount =
                    rawObject["flat_amount"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineTaxRateFlatAmountXa35356a0?>(element)
                        }
                    },
                jurisdiction =
                    rawObject["jurisdiction"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                jurisdictionLevel =
                    rawObject["jurisdiction_level"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineTaxRateJurisdictionLevelX63ce8669?>(element)
                        }
                    },
                metadata =
                ...
                rateType =
                    rawObject["rate_type"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineTaxRateRateTypeX81463d4b?>(element)
                        }
                    },
                state =
                ...
                taxType =
                    rawObject["tax_type"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineTaxRateTaxTypeX73e4c6cd?>(element)
                        }
                    },
            )
        }
