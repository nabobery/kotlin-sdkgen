...
public class InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAffirmAnyOf1X2a78db83(
    public val captureMethod: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsCaptureMethodX8f4dfee5? = null,
    public val preferredLocale: String? = null,
    public val setupFutureUsage: InlineV1PaymentIntentsPostRequestFormSetupFutureUsageX52144e8d? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAffirmAnyOf1X2a78db83 =
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAffirmAnyOf1X2a78db83> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAffirmAnyOf1X2a78db83 must be a JSON object",
                    )
            return InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAffirmAnyOf1X2a78db83(
                captureMethod =
                    rawObject["capture_method"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsCaptureMethodX8f4dfee5>(
                                it,
                            )
                    },
                ...
                setupFutureUsage =
                    rawObject["setup_future_usage"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormSetupFutureUsageX52144e8d>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAffirmAnyOf1X2a78db83,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAffirmAnyOf1X2a78db83(
    block: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAffirmAnyOf1X2a78db83.Builder.() -> Unit,
): InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAffirmAnyOf1X2a78db83 =
    InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAffirmAnyOf1X2a78db83.build(block)
