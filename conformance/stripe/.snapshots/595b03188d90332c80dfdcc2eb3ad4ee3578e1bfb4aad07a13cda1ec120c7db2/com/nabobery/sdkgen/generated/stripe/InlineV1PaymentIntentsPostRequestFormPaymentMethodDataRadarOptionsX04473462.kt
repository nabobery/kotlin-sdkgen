...
public class InlineV1PaymentIntentsPostRequestFormPaymentMethodDataRadarOptionsX04473462(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1PaymentIntentsPostRequestFormPaymentMethodDataRadarOptionsX04473462 =
            InlineV1PaymentIntentsPostRequestFormPaymentMethodDataRadarOptionsX04473462(
                session = session,
            )
    }
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentIntentsPostRequestFormPaymentMethodDataRadarOptionsX04473462 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormPaymentMethodDataRadarOptionsX04473462> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsPostRequestFormPaymentMethodDataRadarOptionsX04473462 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormPaymentMethodDataRadarOptionsX04473462,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentIntentsPostRequestFormPaymentMethodDataRadarOptionsX04473462(
    block: InlineV1PaymentIntentsPostRequestFormPaymentMethodDataRadarOptionsX04473462.Builder.() -> Unit,
): InlineV1PaymentIntentsPostRequestFormPaymentMethodDataRadarOptionsX04473462 =
