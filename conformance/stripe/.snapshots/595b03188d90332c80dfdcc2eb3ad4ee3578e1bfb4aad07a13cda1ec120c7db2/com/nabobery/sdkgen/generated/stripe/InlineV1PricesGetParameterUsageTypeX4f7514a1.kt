...
public sealed class InlineV1PricesGetParameterUsageTypeX4f7514a1 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1PricesGetParameterUsageTypeX4f7514a1 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1PricesGetParameterUsageTypeX4f7514a1> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1PricesGetParameterUsageTypeX4f7514a1",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1PricesGetParameterUsageTypeX4f7514a1 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PricesGetParameterUsageTypeX4f7514a1,
        ) {
