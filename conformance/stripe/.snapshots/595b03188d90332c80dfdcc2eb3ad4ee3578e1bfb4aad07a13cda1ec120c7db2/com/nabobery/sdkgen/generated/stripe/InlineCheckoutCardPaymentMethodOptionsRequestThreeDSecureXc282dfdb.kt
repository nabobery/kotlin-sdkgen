...
public sealed class InlineCheckoutCardPaymentMethodOptionsRequestThreeDSecureXc282dfdb {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineCheckoutCardPaymentMethodOptionsRequestThreeDSecureXc282dfdb =
            when (value) {
                Any.value -> Any
    ...
    public object Serializer : KSerializer<InlineCheckoutCardPaymentMethodOptionsRequestThreeDSecureXc282dfdb> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineCheckoutCardPaymentMethodOptionsRequestThreeDSecureXc282dfdb",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineCheckoutCardPaymentMethodOptionsRequestThreeDSecureXc282dfdb =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineCheckoutCardPaymentMethodOptionsRequestThreeDSecureXc282dfdb,
        ) {
