...
public class InlineV1CreditNotesPreviewGetParameterItemXb542d951(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1CreditNotesPreviewGetParameterItemXb542d951 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1CreditNotesPreviewGetParameterItemXb542d951> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CreditNotesPreviewGetParameterItemXb542d951 must be a JSON object",
                    )
            ...
            return InlineV1CreditNotesPreviewGetParameterItemXb542d951(
                ...
                taxAmounts =
                    rawObject["tax_amounts"]?.let {
                        json.decodeFromJsonElement<InlineV1CreditNotesPreviewGetParameterItemTaxAmountsX6bac37f9>(it)
                    },
                taxRates =
                    rawObject["tax_rates"]?.let {
                        json.decodeFromJsonElement<InlineV1CreditNotesPreviewGetParameterItemTaxRatesXa47ff29f>(it)
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CreditNotesPreviewGetParameterItemXb542d951,
        ) {
...
public fun inlineV1CreditNotesPreviewGetParameterItemXb542d951(
    block: InlineV1CreditNotesPreviewGetParameterItemXb542d951.Builder.() -> Unit,
): InlineV1CreditNotesPreviewGetParameterItemXb542d951 =
    InlineV1CreditNotesPreviewGetParameterItemXb542d951.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1CreditNotesPreviewGetParameterItemXb542d951 is missing required property '" + name + "'",
            )
