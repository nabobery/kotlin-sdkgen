...
public class InlineV1SourcesPostRequestFormSourceOrderItemsItemX5728b31a(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1SourcesPostRequestFormSourceOrderItemsItemX5728b31a =
            InlineV1SourcesPostRequestFormSourceOrderItemsItemX5728b31a(
                amount = amount,
                currency = currency,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1SourcesPostRequestFormSourceOrderItemsItemX5728b31a =
    ...
    public object Serializer : KSerializer<InlineV1SourcesPostRequestFormSourceOrderItemsItemX5728b31a> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1SourcesPostRequestFormSourceOrderItemsItemX5728b31a {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SourcesPostRequestFormSourceOrderItemsItemX5728b31a must be a JSON object",
                    )
            return InlineV1SourcesPostRequestFormSourceOrderItemsItemX5728b31a(
                ...
                type =
                    rawObject["type"]?.let {
                        json.decodeFromJsonElement<InlineV1SourcesPostRequestFormSourceOrderItemsItemTypeX1129cf6e>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SourcesPostRequestFormSourceOrderItemsItemX5728b31a,
        ) {
...
public fun inlineV1SourcesPostRequestFormSourceOrderItemsItemX5728b31a(
    block: InlineV1SourcesPostRequestFormSourceOrderItemsItemX5728b31a.Builder.() -> Unit,
): InlineV1SourcesPostRequestFormSourceOrderItemsItemX5728b31a =
    InlineV1SourcesPostRequestFormSourceOrderItemsItemX5728b31a.build(block)
