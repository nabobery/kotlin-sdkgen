...
public class InlineV1TerminalConfigurationsPostRequestFormX88496195(
     ...
     */
    public val bbposWisepad3: InlineV1TerminalConfigurationsPostRequestFormBbposWisepad3Xac3389d6? = null,
    /**
     * An object containing device type specific settings for BBPOS WisePOS E readers.
     */
    public val bbposWiseposE: InlineV1TerminalConfigurationsPostRequestFormBbposWiseposEX915c2570? = null,
    /**
     ...
     */
    public val rebootWindow: InlineV1TerminalConfigurationsPostRequestFormRebootWindowX6c8ebca3? = null,
    /**
     ...
     */
    public val verifoneM425: InlineV1TerminalConfigurationsPostRequestFormVerifoneM425Xbf878631? = null,
    /**
     * An object containing device type specific settings for Verifone P400 readers.
     */
    public val verifoneP400: InlineV1TerminalConfigurationsPostRequestFormVerifoneP400Xb36fbaf2? = null,
    /**
     * An object containing device type specific settings for Verifone P630 readers.
     */
    public val verifoneP630: InlineV1TerminalConfigurationsPostRequestFormVerifoneP630Xbfb55acf? = null,
    /**
     * An object containing device type specific settings for Verifone UX700 readers.
     */
    public val verifoneUx700: InlineV1TerminalConfigurationsPostRequestFormVerifoneUx700X4d4c5e1a? = null,
    /**
     * An object containing device type specific settings for Verifone V660p readers.
     */
    public val verifoneV660p: InlineV1TerminalConfigurationsPostRequestFormVerifoneV660pX20fb1fae? = null,
    /**
    ...
    public class Builder {
        ...
        public fun build(): InlineV1TerminalConfigurationsPostRequestFormX88496195 =
            InlineV1TerminalConfigurationsPostRequestFormX88496195(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TerminalConfigurationsPostRequestFormX88496195 =
    ...
    public object Serializer : KSerializer<InlineV1TerminalConfigurationsPostRequestFormX88496195> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TerminalConfigurationsPostRequestFormX88496195 must be a JSON object",
                    )
            return InlineV1TerminalConfigurationsPostRequestFormX88496195(
                bbposWisepad3 =
                    rawObject["bbpos_wisepad3"]?.let {
                        json.decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormBbposWisepad3Xac3389d6>(
                            it,
                        )
                    },
                bbposWiseposE =
                    rawObject["bbpos_wisepos_e"]?.let {
                        json.decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormBbposWiseposEX915c2570>(
                            it,
                        )
                    },
                cellular =
                    rawObject["cellular"]?.let {
                        json.decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormCellularX0c6f3b8a>(it)
                    },
                expand = rawObject["expand"]?.let { json.decodeFromJsonElement<List<String>>(it) },
                name = rawObject["name"]?.let { json.decodeFromJsonElement<String>(it) },
                offline =
                    rawObject["offline"]?.let {
                        json.decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormOfflineX95371ff2>(it)
                    },
                rebootWindow =
                    rawObject["reboot_window"]?.let {
                        json.decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormRebootWindowX6c8ebca3>(
                            it,
                        )
                    },
                stripeS700 =
                    rawObject["stripe_s700"]?.let {
                        json.decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormStripeS700Xc99df5cb>(it)
                    },
                stripeS710 =
                    rawObject["stripe_s710"]?.let {
                        json.decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormStripeS710Xf0a54d19>(it)
                    },
                tipping =
                    rawObject["tipping"]?.let {
                        json.decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormTippingXda42fbcf>(it)
                    },
                verifoneM425 =
                    rawObject["verifone_m425"]?.let {
                        json.decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormVerifoneM425Xbf878631>(
                            it,
                        )
                    },
                verifoneP400 =
                    rawObject["verifone_p400"]?.let {
                        json.decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormVerifoneP400Xb36fbaf2>(
                            it,
                        )
                    },
                verifoneP630 =
                    rawObject["verifone_p630"]?.let {
                        json.decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormVerifoneP630Xbfb55acf>(
                            it,
                        )
                    },
                verifoneUx700 =
                    rawObject["verifone_ux700"]?.let {
                        json.decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormVerifoneUx700X4d4c5e1a>(
                            it,
                        )
                    },
                verifoneV660p =
                    rawObject["verifone_v660p"]?.let {
                        json.decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormVerifoneV660pX20fb1fae>(
                            it,
                        )
                    },
                wifi =
                    rawObject["wifi"]?.let {
                        json.decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormWifiX160be9ac>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TerminalConfigurationsPostRequestFormX88496195,
        ) {
...
public fun inlineV1TerminalConfigurationsPostRequestFormX88496195(
    block: InlineV1TerminalConfigurationsPostRequestFormX88496195.Builder.() -> Unit,
): InlineV1TerminalConfigurationsPostRequestFormX88496195 =
    InlineV1TerminalConfigurationsPostRequestFormX88496195.build(block)
