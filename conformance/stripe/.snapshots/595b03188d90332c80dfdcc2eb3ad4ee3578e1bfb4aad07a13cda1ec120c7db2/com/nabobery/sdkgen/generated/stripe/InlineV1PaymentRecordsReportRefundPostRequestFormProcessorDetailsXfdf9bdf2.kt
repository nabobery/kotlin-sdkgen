...
public class InlineV1PaymentRecordsReportRefundPostRequestFormProcessorDetailsXfdf9bdf2(
    ...
    public val custom: InlineV1PaymentRecordsReportRefundPostRequestFormProcessorDetailsCustomXd2830381? = null,
) {
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentRecordsReportRefundPostRequestFormProcessorDetailsXfdf9bdf2 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentRecordsReportRefundPostRequestFormProcessorDetailsXfdf9bdf2> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentRecordsReportRefundPostRequestFormProcessorDetailsXfdf9bdf2 must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineV1PaymentRecordsReportRefundPostRequestFormProcessorDetailsTypeXb7422839>(
                    rawObject,
                    "type",
                )
            return InlineV1PaymentRecordsReportRefundPostRequestFormProcessorDetailsXfdf9bdf2(
                ...
                custom =
                    rawObject["custom"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentRecordsReportRefundPostRequestFormProcessorDetailsCustomXd2830381>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentRecordsReportRefundPostRequestFormProcessorDetailsXfdf9bdf2,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentRecordsReportRefundPostRequestFormProcessorDetailsXfdf9bdf2(
    block: InlineV1PaymentRecordsReportRefundPostRequestFormProcessorDetailsXfdf9bdf2.Builder.() -> Unit,
): InlineV1PaymentRecordsReportRefundPostRequestFormProcessorDetailsXfdf9bdf2 =
    InlineV1PaymentRecordsReportRefundPostRequestFormProcessorDetailsXfdf9bdf2.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentRecordsReportRefundPostRequestFormProcessorDetailsXfdf9bdf2 is missing required property '" +
                    name +
                    "'",
            )
