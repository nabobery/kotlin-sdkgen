...
public sealed class InlineV1PaymentMethodsPostRequestFormSofortCountryX83678afa {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1PaymentMethodsPostRequestFormSofortCountryX83678afa =
            when (value) {
                At.value -> At
                Be.value -> Be
                De.value -> De
    ...
    public object Serializer : KSerializer<InlineV1PaymentMethodsPostRequestFormSofortCountryX83678afa> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1PaymentMethodsPostRequestFormSofortCountryX83678afa",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1PaymentMethodsPostRequestFormSofortCountryX83678afa =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentMethodsPostRequestFormSofortCountryX83678afa,
        ) {
