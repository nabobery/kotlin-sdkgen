...
public class InlineV1SubscriptionsPostRequestFormPaymentSettingsPaymentMethodOptionsX6c2cb372(
    public val acssDebit: InlineV1SubscriptionsPostRequestFormPaymentSettingsAcssDebitXc76e6733? = null,
    public val bancontact: InlineV1SubscriptionsPostRequestFormPaymentSettingsBancontactXe53aac44? = null,
    public val card: InlineV1SubscriptionsPostRequestFormPaymentSettingsCardX54b1b8aa? = null,
    public val customerBalance: InlineV1SubscriptionsPostRequestFormPaymentSettingsCustomerBalanceX4de1fde1? = null,
    ...
    public val sepaDebit: InlineV1SubscriptionsPostRequestFormPaymentSettingsSepaDebitX080f54d9? = null,
    public val upi: InlineV1SubscriptionsPostRequestFormPaymentSettingsUpiX46a4767d? = null,
    public val usBankAccount: InlineV1SubscriptionsPostRequestFormPaymentSettingsUsBankAccountX3b5e39ea? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1SubscriptionsPostRequestFormPaymentSettingsPaymentMethodOptionsX6c2cb372 =
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionsPostRequestFormPaymentSettingsPaymentMethodOptionsX6c2cb372> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SubscriptionsPostRequestFormPaymentSettingsPaymentMethodOptionsX6c2cb372 must be a JSON object",
                    )
            return InlineV1SubscriptionsPostRequestFormPaymentSettingsPaymentMethodOptionsX6c2cb372(
                acssDebit =
                    rawObject["acss_debit"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormPaymentSettingsAcssDebitXc76e6733>(
                                it,
                            )
                    },
                bancontact =
                    rawObject["bancontact"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormPaymentSettingsBancontactXe53aac44>(
                                it,
                            )
                    },
                card =
                    rawObject["card"]?.let {
                        json.decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormPaymentSettingsCardX54b1b8aa>(it)
                    },
                customerBalance =
                    rawObject["customer_balance"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormPaymentSettingsCustomerBalanceX4de1fde1>(
                                it,
                            )
                    },
                konbini =
                    rawObject["konbini"]?.let {
                        json.decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormPaymentSettingsKonbiniXd7207a32>(
                            it,
                        )
                    },
                payto =
                    rawObject["payto"]?.let {
                        json.decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormPaymentSettingsPaytoX3b4ac4be>(
                            it,
                        )
                    },
                pix =
                    rawObject["pix"]?.let {
                        json.decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormPaymentSettingsPixX96b74d2b>(it)
                    },
                sepaDebit =
                    rawObject["sepa_debit"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormPaymentSettingsSepaDebitX080f54d9>(
                                it,
                            )
                    },
                upi =
                    rawObject["upi"]?.let {
                        json.decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormPaymentSettingsUpiX46a4767d>(it)
                    },
                usBankAccount =
                    rawObject["us_bank_account"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormPaymentSettingsUsBankAccountX3b5e39ea>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsPostRequestFormPaymentSettingsPaymentMethodOptionsX6c2cb372,
        ) {
            val jsonEncoder =
...
public fun inlineV1SubscriptionsPostRequestFormPaymentSettingsPaymentMethodOptionsX6c2cb372(
    block: InlineV1SubscriptionsPostRequestFormPaymentSettingsPaymentMethodOptionsX6c2cb372.Builder.() -> Unit,
): InlineV1SubscriptionsPostRequestFormPaymentSettingsPaymentMethodOptionsX6c2cb372 =
    InlineV1SubscriptionsPostRequestFormPaymentSettingsPaymentMethodOptionsX6c2cb372.build(block)
