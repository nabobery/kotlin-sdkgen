...
public class InlineV1TestHelpersIssuingTransactionsRefundPostRequestFormXdc61b83a(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1TestHelpersIssuingTransactionsRefundPostRequestFormXdc61b83a =
            InlineV1TestHelpersIssuingTransactionsRefundPostRequestFormXdc61b83a(
                expand = expand,
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1TestHelpersIssuingTransactionsRefundPostRequestFormXdc61b83a = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1TestHelpersIssuingTransactionsRefundPostRequestFormXdc61b83a> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TestHelpersIssuingTransactionsRefundPostRequestFormXdc61b83a must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TestHelpersIssuingTransactionsRefundPostRequestFormXdc61b83a,
        ) {
            val jsonEncoder =
...
public fun inlineV1TestHelpersIssuingTransactionsRefundPostRequestFormXdc61b83a(
    block: InlineV1TestHelpersIssuingTransactionsRefundPostRequestFormXdc61b83a.Builder.() -> Unit,
): InlineV1TestHelpersIssuingTransactionsRefundPostRequestFormXdc61b83a =
