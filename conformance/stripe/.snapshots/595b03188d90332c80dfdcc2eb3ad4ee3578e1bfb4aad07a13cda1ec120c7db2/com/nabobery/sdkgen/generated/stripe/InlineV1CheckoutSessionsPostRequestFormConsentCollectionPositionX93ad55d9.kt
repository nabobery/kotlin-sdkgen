...
public sealed class InlineV1CheckoutSessionsPostRequestFormConsentCollectionPositionX93ad55d9 {
    ...
    public object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormConsentCollectionPositionX93ad55d9> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1CheckoutSessionsPostRequestFormConsentCollectionPositionX93ad55d9",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1CheckoutSessionsPostRequestFormConsentCollectionPositionX93ad55d9 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsPostRequestFormConsentCollectionPositionX93ad55d9,
        ) {
