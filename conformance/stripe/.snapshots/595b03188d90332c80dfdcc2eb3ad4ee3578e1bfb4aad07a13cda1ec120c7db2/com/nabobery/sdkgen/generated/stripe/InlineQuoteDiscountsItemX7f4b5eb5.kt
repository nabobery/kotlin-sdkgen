...
public class InlineQuoteDiscountsItemX7f4b5eb5 internal constructor(
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineQuoteDiscountsItemX7f4b5eb5 {
            val inspection = inspectInlineQuoteDiscountsItemX7f4b5eb5(raw)
            if (inspection.matchCount == 0) {
                throw InlineQuoteDiscountsItemX7f4b5eb5NoMatchException(
                    "InlineQuoteDiscountsItemX7f4b5eb5 matched 0 branches: " + inspection.failures.joinToString("; "),
                )
            }
    ...
    public object Serializer : KSerializer<InlineQuoteDiscountsItemX7f4b5eb5> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineQuoteDiscountsItemX7f4b5eb5,
        ) {
...
private fun inspectInlineQuoteDiscountsItemX7f4b5eb5(
    element: JsonElement,
): InlineQuoteDiscountsItemX7f4b5eb5Inspection {
