...
public class InlineTerminalReaderReaderResourceRefundPaymentActionPaymentIntentXff759917 internal constructor(
    ...
    private val inspection: InlineTerminalReaderReaderResourceRefundPaymentActionPaymentIntentXff759917Inspection,
) {
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineTerminalReaderReaderResourceRefundPaymentActionPaymentIntentXff759917Branch.Branch1,
                    )
                }
                if (inspection.matchesPaymentIntent) {
                    add(
                        InlineTerminalReaderReaderResourceRefundPaymentActionPaymentIntentXff759917Branch.PaymentIntent,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineTerminalReaderReaderResourceRefundPaymentActionPaymentIntentXff759917 {
            val inspection = inspectInlineTerminalReaderReaderResourceRefundPaymentActionPaymentIntentXff759917(raw)
            if (inspection.matchCount == 0) {
                throw InlineTerminalReaderReaderResourceRefundPaymentActionPaymentIntentXff759917NoMatchException(
                    "InlineTerminalReaderReaderResourceRefundPaymentActionPaymentIntentXff759917 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineTerminalReaderReaderResourceRefundPaymentActionPaymentIntentXff759917> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineTerminalReaderReaderResourceRefundPaymentActionPaymentIntentXff759917,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineTerminalReaderReaderResourceRefundPaymentActionPaymentIntentXff759917",
...
private fun inspectInlineTerminalReaderReaderResourceRefundPaymentActionPaymentIntentXff759917(
    element: JsonElement,
