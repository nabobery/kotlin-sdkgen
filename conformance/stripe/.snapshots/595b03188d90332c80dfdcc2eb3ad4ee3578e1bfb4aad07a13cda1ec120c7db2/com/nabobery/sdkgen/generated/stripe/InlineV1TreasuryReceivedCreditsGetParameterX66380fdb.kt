...
public sealed class InlineV1TreasuryReceivedCreditsGetParameterX66380fdb {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1TreasuryReceivedCreditsGetParameterX66380fdb =
            when (value) {
                Failed.value -> Failed
    ...
    public object Serializer : KSerializer<InlineV1TreasuryReceivedCreditsGetParameterX66380fdb> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1TreasuryReceivedCreditsGetParameterX66380fdb",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1TreasuryReceivedCreditsGetParameterX66380fdb =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TreasuryReceivedCreditsGetParameterX66380fdb,
        ) {
