...
public class DisputeEnhancedEligibility(
    ...
    public class Builder {
        ...
        public fun build(): DisputeEnhancedEligibility =
    ...
    public object Serializer : KSerializer<DisputeEnhancedEligibility> {
        ...
        override fun deserialize(decoder: Decoder): DisputeEnhancedEligibility {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("DisputeEnhancedEligibility must be a JSON object")
            return DisputeEnhancedEligibility(
                mastercardCompliance =
                    rawObject["mastercard_compliance"]?.let {
                        json.decodeFromJsonElement<DisputeEnhancedEligibilityMastercardCompliance>(it)
                    },
                visaCompellingEvidence3 =
                    rawObject["visa_compelling_evidence_3"]?.let {
                        json.decodeFromJsonElement<DisputeEnhancedEligibilityVisaCompellingEvidence3>(it)
                    },
                visaCompliance =
                    rawObject["visa_compliance"]?.let {
                        json.decodeFromJsonElement<DisputeEnhancedEligibilityVisaCompliance>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: DisputeEnhancedEligibility,
        ) {
...
public fun disputeEnhancedEligibility(
    block: DisputeEnhancedEligibility.Builder.() -> Unit,
): DisputeEnhancedEligibility = DisputeEnhancedEligibility.build(block)
