...
public class InlineV1PricesPostRequestFormCurrencyOptionsAnyOf1CustomUnitAmountXfa527c22(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PricesPostRequestFormCurrencyOptionsAnyOf1CustomUnitAmountXfa527c22 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1PricesPostRequestFormCurrencyOptionsAnyOf1CustomUnitAmountXfa527c22> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PricesPostRequestFormCurrencyOptionsAnyOf1CustomUnitAmountXfa527c22 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PricesPostRequestFormCurrencyOptionsAnyOf1CustomUnitAmountXfa527c22,
        ) {
            val jsonEncoder =
...
public fun inlineV1PricesPostRequestFormCurrencyOptionsAnyOf1CustomUnitAmountXfa527c22(
    block: InlineV1PricesPostRequestFormCurrencyOptionsAnyOf1CustomUnitAmountXfa527c22.Builder.() -> Unit,
): InlineV1PricesPostRequestFormCurrencyOptionsAnyOf1CustomUnitAmountXfa527c22 =
    InlineV1PricesPostRequestFormCurrencyOptionsAnyOf1CustomUnitAmountXfa527c22.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PricesPostRequestFormCurrencyOptionsAnyOf1CustomUnitAmountXfa527c22 is missing required property '" +
                    name +
                    "'",
            )
