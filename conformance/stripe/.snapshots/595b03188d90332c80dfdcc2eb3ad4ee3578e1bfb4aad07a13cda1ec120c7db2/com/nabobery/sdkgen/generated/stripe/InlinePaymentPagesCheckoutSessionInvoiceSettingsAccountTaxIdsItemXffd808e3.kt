...
public class InlinePaymentPagesCheckoutSessionInvoiceSettingsAccountTaxIdsItemXffd808e3 internal constructor(
    ...
    private val inspection: InlinePaymentPagesCheckoutSessionInvoiceSettingsAccountTaxIdsItemXffd808e3Inspection,
) {
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlinePaymentPagesCheckoutSessionInvoiceSettingsAccountTaxIdsItemXffd808e3Branch.Branch1,
                    )
                }
                if (inspection.matchesTaxId) {
                    add(
                        InlinePaymentPagesCheckoutSessionInvoiceSettingsAccountTaxIdsItemXffd808e3Branch.TaxId,
                    )
                }
                if (inspection.matchesDeletedTaxId) {
                    add(
                        InlinePaymentPagesCheckoutSessionInvoiceSettingsAccountTaxIdsItemXffd808e3Branch.DeletedTaxId,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlinePaymentPagesCheckoutSessionInvoiceSettingsAccountTaxIdsItemXffd808e3 {
            val inspection = inspectInlinePaymentPagesCheckoutSessionInvoiceSettingsAccountTaxIdsItemXffd808e3(raw)
            if (inspection.matchCount == 0) {
                throw InlinePaymentPagesCheckoutSessionInvoiceSettingsAccountTaxIdsItemXffd808e3NoMatchException(
                    "InlinePaymentPagesCheckoutSessionInvoiceSettingsAccountTaxIdsItemXffd808e3 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlinePaymentPagesCheckoutSessionInvoiceSettingsAccountTaxIdsItemXffd808e3> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentPagesCheckoutSessionInvoiceSettingsAccountTaxIdsItemXffd808e3,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlinePaymentPagesCheckoutSessionInvoiceSettingsAccountTaxIdsItemXffd808e3",
...
private fun inspectInlinePaymentPagesCheckoutSessionInvoiceSettingsAccountTaxIdsItemXffd808e3(
    element: JsonElement,
