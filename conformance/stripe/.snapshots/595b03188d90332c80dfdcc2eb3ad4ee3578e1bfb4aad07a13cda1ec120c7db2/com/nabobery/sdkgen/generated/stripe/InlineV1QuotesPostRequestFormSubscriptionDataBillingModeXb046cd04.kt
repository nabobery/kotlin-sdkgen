...
public class InlineV1QuotesPostRequestFormSubscriptionDataBillingModeXb046cd04(
    ...
    public val flexible: InlineV1QuotesPostRequestFormSubscriptionDataBillingModeFlexibleXa2ea0e06? = null,
) {
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1QuotesPostRequestFormSubscriptionDataBillingModeXb046cd04 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1QuotesPostRequestFormSubscriptionDataBillingModeXb046cd04> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1QuotesPostRequestFormSubscriptionDataBillingModeXb046cd04 {
            val jsonDecoder =
                decoder.requireJsonDecoder(
                    "InlineV1QuotesPostRequestFormSubscriptionDataBillingModeXb046cd04",
                )
            val json = jsonDecoder.json
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1QuotesPostRequestFormSubscriptionDataBillingModeXb046cd04 must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineV1QuotesPostRequestFormSubscriptionDataBillingModeTypeXc9d0ae5c>(
                    rawObject,
                    "type",
                )
            return InlineV1QuotesPostRequestFormSubscriptionDataBillingModeXb046cd04(
                ...
                flexible =
                    rawObject["flexible"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1QuotesPostRequestFormSubscriptionDataBillingModeFlexibleXa2ea0e06>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1QuotesPostRequestFormSubscriptionDataBillingModeXb046cd04,
        ) {
            val jsonEncoder =
...
public fun inlineV1QuotesPostRequestFormSubscriptionDataBillingModeXb046cd04(
    block: InlineV1QuotesPostRequestFormSubscriptionDataBillingModeXb046cd04.Builder.() -> Unit,
): InlineV1QuotesPostRequestFormSubscriptionDataBillingModeXb046cd04 =
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1QuotesPostRequestFormSubscriptionDataBillingModeXb046cd04 is missing required property '" +
                    name +
                    "'",
            )
