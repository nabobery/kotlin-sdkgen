...
public class InlineV1TerminalConfigurationsPostRequestFormVerifoneM425Xbf878631(
    public val splashscreen: InlineV1TerminalConfigurationsPostRequestFormVerifoneM425SplashscreenX9e1a69e8? = null,
) {
    public class Builder {
        public var splashscreen:
            InlineV1TerminalConfigurationsPostRequestFormVerifoneM425SplashscreenX9e1a69e8? = null

        public fun build(): InlineV1TerminalConfigurationsPostRequestFormVerifoneM425Xbf878631 =
            InlineV1TerminalConfigurationsPostRequestFormVerifoneM425Xbf878631(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1TerminalConfigurationsPostRequestFormVerifoneM425Xbf878631 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1TerminalConfigurationsPostRequestFormVerifoneM425Xbf878631> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TerminalConfigurationsPostRequestFormVerifoneM425Xbf878631 must be a JSON object",
                    )
            return InlineV1TerminalConfigurationsPostRequestFormVerifoneM425Xbf878631(
                splashscreen =
                    rawObject["splashscreen"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormVerifoneM425SplashscreenX9e1a69e8>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TerminalConfigurationsPostRequestFormVerifoneM425Xbf878631,
        ) {
            val jsonEncoder =
...
public fun inlineV1TerminalConfigurationsPostRequestFormVerifoneM425Xbf878631(
    block: InlineV1TerminalConfigurationsPostRequestFormVerifoneM425Xbf878631.Builder.() -> Unit,
): InlineV1TerminalConfigurationsPostRequestFormVerifoneM425Xbf878631 =
    InlineV1TerminalConfigurationsPostRequestFormVerifoneM425Xbf878631.build(block)
