...
public class InlineV1InvoicePaymentsGetParameterXca144f7d internal constructor(
    ...
    public val inlineV1InvoicePaymentsGetParameterAnyOf1X8182f68e:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1InvoicePaymentsGetParameterAnyOf1X8182f68e) {
                json
                    .decodeFromJsonElement<InlineV1InvoicePaymentsGetParameterAnyOf1X8182f68e>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1InvoicePaymentsGetParameterXca144f7dBranch>
        get() =
            buildSet {
                if (inspection.matchesInlineV1InvoicePaymentsGetParameterAnyOf1X8182f68e) {
                    add(
                        InlineV1InvoicePaymentsGetParameterXca144f7dBranch.InlineV1InvoicePaymentsGetParameterAnyOf1X8182f68e,
                    )
                }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1InvoicePaymentsGetParameterXca144f7d {
            val inspection = inspectInlineV1InvoicePaymentsGetParameterXca144f7d(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1InvoicePaymentsGetParameterXca144f7dNoMatchException(
                    "InlineV1InvoicePaymentsGetParameterXca144f7d matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1InvoicePaymentsGetParameterXca144f7d> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicePaymentsGetParameterXca144f7d,
        ) {
...
private fun inspectInlineV1InvoicePaymentsGetParameterXca144f7d(
    element: JsonElement,
): InlineV1InvoicePaymentsGetParameterXca144f7dInspection {
    val matchesInlineV1InvoicePaymentsGetParameterAnyOf1X8182f68e =
        element
            .isJsonDecodable<InlineV1InvoicePaymentsGetParameterAnyOf1X8182f68e>()
    ...
    return InlineV1InvoicePaymentsGetParameterXca144f7dInspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1InvoicePaymentsGetParameterAnyOf1X8182f68e) {
                    add(
                        "InlineV1InvoicePaymentsGetParameterAnyOf1X8182f68e: value does not match InlineV1InvoicePaymentsGetParameterAnyOf1X8182f68e",
                    )
                }
