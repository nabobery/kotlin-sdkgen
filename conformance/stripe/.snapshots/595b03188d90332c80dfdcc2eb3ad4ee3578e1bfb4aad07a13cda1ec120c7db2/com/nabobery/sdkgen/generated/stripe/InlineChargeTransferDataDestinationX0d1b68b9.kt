...
public class InlineChargeTransferDataDestinationX0d1b68b9 internal constructor(
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineChargeTransferDataDestinationX0d1b68b9 {
            val inspection = inspectInlineChargeTransferDataDestinationX0d1b68b9(raw)
            if (inspection.matchCount == 0) {
                throw InlineChargeTransferDataDestinationX0d1b68b9NoMatchException(
                    "InlineChargeTransferDataDestinationX0d1b68b9 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineChargeTransferDataDestinationX0d1b68b9> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineChargeTransferDataDestinationX0d1b68b9,
        ) {
...
private fun inspectInlineChargeTransferDataDestinationX0d1b68b9(
    element: JsonElement,
): InlineChargeTransferDataDestinationX0d1b68b9Inspection {
