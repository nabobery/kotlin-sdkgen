...
public class InlineV1TaxRegistrationsPostRequestFormCountryOptionsMtStandardXddb7fcfd(
    public val placeOfSupplyScheme: InlineV1TaxRegistrationsPostRequestFormPlaceOfSupplySchemeX57436546,
) {
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1TaxRegistrationsPostRequestFormCountryOptionsMtStandardXddb7fcfd = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TaxRegistrationsPostRequestFormCountryOptionsMtStandardXddb7fcfd> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TaxRegistrationsPostRequestFormCountryOptionsMtStandardXddb7fcfd must be a JSON object",
                    )
            val placeOfSupplyScheme =
                json
                    .decodeRequired<InlineV1TaxRegistrationsPostRequestFormPlaceOfSupplySchemeX57436546>(
                        rawObject,
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TaxRegistrationsPostRequestFormCountryOptionsMtStandardXddb7fcfd,
        ) {
            val jsonEncoder =
...
public fun inlineV1TaxRegistrationsPostRequestFormCountryOptionsMtStandardXddb7fcfd(
    block: InlineV1TaxRegistrationsPostRequestFormCountryOptionsMtStandardXddb7fcfd.Builder.() -> Unit,
): InlineV1TaxRegistrationsPostRequestFormCountryOptionsMtStandardXddb7fcfd =
    InlineV1TaxRegistrationsPostRequestFormCountryOptionsMtStandardXddb7fcfd.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TaxRegistrationsPostRequestFormCountryOptionsMtStandardXddb7fcfd is missing required property '" +
                    name +
                    "'",
            )
