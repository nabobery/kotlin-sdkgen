...
public class ProductFeature(
    ...
    public object Serializer : KSerializer<ProductFeature> {
        ...
        override fun deserialize(decoder: Decoder): ProductFeature {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("ProductFeature must be a JSON object")
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("ProductFeature is missing required property '" + name + "'")
