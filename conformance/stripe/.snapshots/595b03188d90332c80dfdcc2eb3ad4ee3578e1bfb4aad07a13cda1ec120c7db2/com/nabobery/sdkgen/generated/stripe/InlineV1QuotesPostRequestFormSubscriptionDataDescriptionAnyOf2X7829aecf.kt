...
public sealed class InlineV1QuotesPostRequestFormSubscriptionDataDescriptionAnyOf2X7829aecf {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1QuotesPostRequestFormSubscriptionDataDescriptionAnyOf2X7829aecf =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1QuotesPostRequestFormSubscriptionDataDescriptionAnyOf2X7829aecf> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1QuotesPostRequestFormSubscriptionDataDescriptionAnyOf2X7829aecf",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1QuotesPostRequestFormSubscriptionDataDescriptionAnyOf2X7829aecf = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1QuotesPostRequestFormSubscriptionDataDescriptionAnyOf2X7829aecf,
        ) {
