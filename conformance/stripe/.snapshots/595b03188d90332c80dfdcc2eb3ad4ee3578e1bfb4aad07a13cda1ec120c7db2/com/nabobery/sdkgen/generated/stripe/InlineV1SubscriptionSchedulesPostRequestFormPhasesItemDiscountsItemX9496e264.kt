...
public class InlineV1SubscriptionSchedulesPostRequestFormPhasesItemDiscountsItemX9496e264(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1SubscriptionSchedulesPostRequestFormPhasesItemDiscountsItemX9496e264 =
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1SubscriptionSchedulesPostRequestFormPhasesItemDiscountsItemX9496e264 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemDiscountsItemX9496e264> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SubscriptionSchedulesPostRequestFormPhasesItemDiscountsItemX9496e264 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionSchedulesPostRequestFormPhasesItemDiscountsItemX9496e264,
        ) {
            val jsonEncoder =
...
public fun inlineV1SubscriptionSchedulesPostRequestFormPhasesItemDiscountsItemX9496e264(
    block: InlineV1SubscriptionSchedulesPostRequestFormPhasesItemDiscountsItemX9496e264.Builder.() -> Unit,
): InlineV1SubscriptionSchedulesPostRequestFormPhasesItemDiscountsItemX9496e264 =
    InlineV1SubscriptionSchedulesPostRequestFormPhasesItemDiscountsItemX9496e264.build(block)
