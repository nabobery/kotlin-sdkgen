...
internal data class InlineV1ChargesDisputePostRequestFormEvidenceCustomerAccountIdXb6ce63d4Inspection(
    ...
    public val matchesInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2Xbc57fe7e: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2Xbc57fe7e,
            ).count {
                it
            }
}
...
public class InlineV1ChargesDisputePostRequestFormEvidenceCustomerAccountIdXb6ce63d4 internal constructor(
    ...
    private val inspection: InlineV1ChargesDisputePostRequestFormEvidenceCustomerAccountIdXb6ce63d4Inspection,
) {
    ...
    public val inlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2Xbc57fe7e:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2Xbc57fe7e) {
                json
                    .decodeFromJsonElement<InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2Xbc57fe7e>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1ChargesDisputePostRequestFormEvidenceCustomerAccountIdXb6ce63d4Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2Xbc57fe7e) {
                    add(
                        InlineV1ChargesDisputePostRequestFormEvidenceCustomerAccountIdXb6ce63d4Branch.InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2Xbc57fe7e,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1ChargesDisputePostRequestFormEvidenceCustomerAccountIdXb6ce63d4 {
            val inspection = inspectInlineV1ChargesDisputePostRequestFormEvidenceCustomerAccountIdXb6ce63d4(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1ChargesDisputePostRequestFormEvidenceCustomerAccountIdXb6ce63d4NoMatchException(
                    "InlineV1ChargesDisputePostRequestFormEvidenceCustomerAccountIdXb6ce63d4 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1ChargesDisputePostRequestFormEvidenceCustomerAccountIdXb6ce63d4> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ChargesDisputePostRequestFormEvidenceCustomerAccountIdXb6ce63d4,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1ChargesDisputePostRequestFormEvidenceCustomerAccountIdXb6ce63d4",
...
private fun inspectInlineV1ChargesDisputePostRequestFormEvidenceCustomerAccountIdXb6ce63d4(
    element: JsonElement,
): InlineV1ChargesDisputePostRequestFormEvidenceCustomerAccountIdXb6ce63d4Inspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2Xbc57fe7e =
        element
            .isJsonDecodable<InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2Xbc57fe7e>()
    return InlineV1ChargesDisputePostRequestFormEvidenceCustomerAccountIdXb6ce63d4Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2Xbc57fe7e) {
                    add(
                        "InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2Xbc57fe7e: value does not match InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2Xbc57fe7e",
                    )
                }
            },
    )
