...
public class InlineV1CustomersSubscriptionsPostRequestFormTransferDataAnyOf1Xcd4e1c88(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1CustomersSubscriptionsPostRequestFormTransferDataAnyOf1Xcd4e1c88 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1CustomersSubscriptionsPostRequestFormTransferDataAnyOf1Xcd4e1c88> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CustomersSubscriptionsPostRequestFormTransferDataAnyOf1Xcd4e1c88 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersSubscriptionsPostRequestFormTransferDataAnyOf1Xcd4e1c88,
        ) {
            val jsonEncoder =
...
public fun inlineV1CustomersSubscriptionsPostRequestFormTransferDataAnyOf1Xcd4e1c88(
    block: InlineV1CustomersSubscriptionsPostRequestFormTransferDataAnyOf1Xcd4e1c88.Builder.() -> Unit,
): InlineV1CustomersSubscriptionsPostRequestFormTransferDataAnyOf1Xcd4e1c88 =
    InlineV1CustomersSubscriptionsPostRequestFormTransferDataAnyOf1Xcd4e1c88.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1CustomersSubscriptionsPostRequestFormTransferDataAnyOf1Xcd4e1c88 is missing required property '" +
                    name +
                    "'",
            )
