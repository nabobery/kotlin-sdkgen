...
public sealed class InlineAccountCapabilityFutureRequirementsDisabledReasonXa9b2ab06 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineAccountCapabilityFutureRequirementsDisabledReasonXa9b2ab06 =
            when (value) {
                Other.value -> Other
    ...
    public object Serializer : KSerializer<InlineAccountCapabilityFutureRequirementsDisabledReasonXa9b2ab06> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineAccountCapabilityFutureRequirementsDisabledReasonXa9b2ab06",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineAccountCapabilityFutureRequirementsDisabledReasonXa9b2ab06 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineAccountCapabilityFutureRequirementsDisabledReasonXa9b2ab06,
        ) {
