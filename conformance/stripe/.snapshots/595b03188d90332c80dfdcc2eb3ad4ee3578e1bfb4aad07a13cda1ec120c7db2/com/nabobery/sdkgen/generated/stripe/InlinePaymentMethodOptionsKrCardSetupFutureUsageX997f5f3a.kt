...
public sealed class InlinePaymentMethodOptionsKrCardSetupFutureUsageX997f5f3a {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentMethodOptionsKrCardSetupFutureUsageX997f5f3a =
            when (value) {
                None.value -> None
    ...
    public object Serializer : KSerializer<InlinePaymentMethodOptionsKrCardSetupFutureUsageX997f5f3a> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentMethodOptionsKrCardSetupFutureUsageX997f5f3a",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePaymentMethodOptionsKrCardSetupFutureUsageX997f5f3a =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentMethodOptionsKrCardSetupFutureUsageX997f5f3a,
        ) {
