...
public class InlineV1QuotesPostRequestFormXad338ec6(
     ...
     */
    public val applicationFeeAmount: InlineV1QuotesPostRequestFormApplicationFeeAmountX2e2ac96f? = null,
    /**
     ...
     */
    public val applicationFeePercent: InlineV1QuotesPostRequestFormApplicationFeePercentXc14ccae9? = null,
    /**
     ...
     */
    public val lineItems: List<InlineV1QuotesPostRequestFormLineItemsItemX1c1111bb>? = null,
    /**
    ...
    public class Builder {
         ...
         * quantity, and the resulting cost.
         */
        public var lineItems: List<InlineV1QuotesPostRequestFormLineItemsItemX1c1111bb>? = null
        ...
        public fun build(): InlineV1QuotesPostRequestFormXad338ec6 =
            InlineV1QuotesPostRequestFormXad338ec6(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1QuotesPostRequestFormXad338ec6 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1QuotesPostRequestFormXad338ec6> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1QuotesPostRequestFormXad338ec6 {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("InlineV1QuotesPostRequestFormXad338ec6 must be a JSON object")
            return InlineV1QuotesPostRequestFormXad338ec6(
                applicationFeeAmount =
                    rawObject["application_fee_amount"]?.let {
                        json.decodeFromJsonElement<InlineV1QuotesPostRequestFormApplicationFeeAmountX2e2ac96f>(it)
                    },
                applicationFeePercent =
                    rawObject["application_fee_percent"]?.let {
                        json.decodeFromJsonElement<InlineV1QuotesPostRequestFormApplicationFeePercentXc14ccae9>(it)
                    },
                automaticTax =
                    rawObject["automatic_tax"]?.let {
                        json.decodeFromJsonElement<InlineV1QuotesPostRequestFormAutomaticTaxX8aae679e>(it)
                    },
                collectionMethod =
                    rawObject["collection_method"]?.let {
                        json.decodeFromJsonElement<InlineV1QuotesPostRequestFormCollectionMethodX4ace09d8>(it)
                    },
                ...
                defaultTaxRates =
                    rawObject["default_tax_rates"]?.let {
                        json.decodeFromJsonElement<InlineV1QuotesPostRequestFormDefaultTaxRatesX59ccf9f3>(it)
                    },
                description =
                    rawObject["description"]?.let {
                        json.decodeFromJsonElement<InlineV1QuotesPostRequestFormDescriptionX33a47f56>(it)
                    },
                discounts =
                    rawObject["discounts"]?.let {
                        json.decodeFromJsonElement<InlineV1QuotesPostRequestFormDiscountsX5b9be60d>(it)
                    },
                expand = rawObject["expand"]?.let { json.decodeFromJsonElement<List<String>>(it) },
                expiresAt = rawObject["expires_at"]?.let { json.decodeFromJsonElement<Int>(it) },
                footer =
                    rawObject["footer"]?.let {
                        json.decodeFromJsonElement<InlineV1QuotesPostRequestFormFooterX89825b93>(
                            it,
                        )
                    },
                header =
                    rawObject["header"]?.let {
                        json.decodeFromJsonElement<InlineV1QuotesPostRequestFormHeaderXb8a866fb>(
                            it,
                        )
                    },
                invoiceSettings =
                    rawObject["invoice_settings"]?.let {
                        json.decodeFromJsonElement<InlineV1QuotesPostRequestFormInvoiceSettingsX5c5f38e8>(it)
                    },
                lineItems =
                    rawObject["line_items"]?.let {
                        json.decodeFromJsonElement<List<InlineV1QuotesPostRequestFormLineItemsItemX1c1111bb>>(it)
                    },
                metadata =
                ...
                onBehalfOf =
                    rawObject["on_behalf_of"]?.let {
                        json.decodeFromJsonElement<InlineV1QuotesPostRequestFormOnBehalfOfXd94a4d50>(it)
                    },
                subscriptionData =
                    rawObject["subscription_data"]?.let {
                        json.decodeFromJsonElement<InlineV1QuotesPostRequestFormSubscriptionDataXafbc88df>(it)
                    },
                transferData =
                    rawObject["transfer_data"]?.let {
                        json.decodeFromJsonElement<InlineV1QuotesPostRequestFormTransferDataXa5f9394f>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1QuotesPostRequestFormXad338ec6,
        ) {
...
public fun inlineV1QuotesPostRequestFormXad338ec6(
    block: InlineV1QuotesPostRequestFormXad338ec6.Builder.() -> Unit,
): InlineV1QuotesPostRequestFormXad338ec6 = InlineV1QuotesPostRequestFormXad338ec6.build(block)
