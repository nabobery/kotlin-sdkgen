        ...
        override fun deserialize(decoder: Decoder): NotificationEventData {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("NotificationEventData must be a JSON object")
            val objectValue = json.decodeRequired<JsonObject>(rawObject, "object")
            return NotificationEventData(
                objectValue = objectValue,
                previousAttributes =
                    rawObject["previous_attributes"]?.let {
...
public fun notificationEventData(block: NotificationEventData.Builder.() -> Unit): NotificationEventData =
    NotificationEventData.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("NotificationEventData is missing required property '" + name + "'")
