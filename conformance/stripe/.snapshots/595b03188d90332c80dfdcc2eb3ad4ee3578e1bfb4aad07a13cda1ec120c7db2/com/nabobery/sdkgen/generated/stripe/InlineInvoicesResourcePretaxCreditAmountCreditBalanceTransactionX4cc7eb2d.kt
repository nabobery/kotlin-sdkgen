...
public class InlineInvoicesResourcePretaxCreditAmountCreditBalanceTransactionX4cc7eb2d internal constructor(
    ...
    private val inspection: InlineInvoicesResourcePretaxCreditAmountCreditBalanceTransactionX4cc7eb2dInspection,
) {
    ...
    public val billingCreditBalanceTransaction: BillingCreditBalanceTransaction? by
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesBillingCreditBalanceTransaction) {
                json
                    .decodeFromJsonElement<BillingCreditBalanceTransaction>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineInvoicesResourcePretaxCreditAmountCreditBalanceTransactionX4cc7eb2dBranch.Branch1,
                    )
                }
                if (inspection.matchesBillingCreditBalanceTransaction) {
                    add(
                        InlineInvoicesResourcePretaxCreditAmountCreditBalanceTransactionX4cc7eb2dBranch.BillingCreditBalanceTransaction,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineInvoicesResourcePretaxCreditAmountCreditBalanceTransactionX4cc7eb2d {
            val inspection = inspectInlineInvoicesResourcePretaxCreditAmountCreditBalanceTransactionX4cc7eb2d(raw)
            if (inspection.matchCount == 0) {
                throw InlineInvoicesResourcePretaxCreditAmountCreditBalanceTransactionX4cc7eb2dNoMatchException(
                    "InlineInvoicesResourcePretaxCreditAmountCreditBalanceTransactionX4cc7eb2d matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineInvoicesResourcePretaxCreditAmountCreditBalanceTransactionX4cc7eb2d> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineInvoicesResourcePretaxCreditAmountCreditBalanceTransactionX4cc7eb2d,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineInvoicesResourcePretaxCreditAmountCreditBalanceTransactionX4cc7eb2d",
...
private fun inspectInlineInvoicesResourcePretaxCreditAmountCreditBalanceTransactionX4cc7eb2d(
    element: JsonElement,
    ...
    return InlineInvoicesResourcePretaxCreditAmountCreditBalanceTransactionX4cc7eb2dInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesBillingCreditBalanceTransaction) {
                    add(
                        "BillingCreditBalanceTransaction: value does not match BillingCreditBalanceTransaction",
                    )
                }
            },
    )
