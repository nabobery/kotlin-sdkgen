...
internal data class InlineV1AccountsPeoplePostRequestFormRelationshipPercentOwnershipX718103ceInspection(
    ...
    public val matchesInlineV1AccountsPeoplePostRequestFormRelationshipPercentOwnershipAnyOf2X9e433f0f: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1AccountsPeoplePostRequestFormRelationshipPercentOwnershipAnyOf2X9e433f0f,
            ).count {
                it
            }
}
...
public class InlineV1AccountsPeoplePostRequestFormRelationshipPercentOwnershipX718103ce internal constructor(
    ...
    private val inspection: InlineV1AccountsPeoplePostRequestFormRelationshipPercentOwnershipX718103ceInspection,
) {
    ...
    public val inlineV1AccountsPeoplePostRequestFormRelationshipPercentOwnershipAnyOf2X9e433f0f:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1AccountsPeoplePostRequestFormRelationshipPercentOwnershipAnyOf2X9e433f0f) {
                json
                    .decodeFromJsonElement<InlineV1AccountsPeoplePostRequestFormRelationshipPercentOwnershipAnyOf2X9e433f0f>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1AccountsPeoplePostRequestFormRelationshipPercentOwnershipX718103ceBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1AccountsPeoplePostRequestFormRelationshipPercentOwnershipAnyOf2X9e433f0f) {
                    add(
                        InlineV1AccountsPeoplePostRequestFormRelationshipPercentOwnershipX718103ceBranch.InlineV1AccountsPeoplePostRequestFormRelationshipPercentOwnershipAnyOf2X9e433f0f,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1AccountsPeoplePostRequestFormRelationshipPercentOwnershipX718103ce {
            val inspection = inspectInlineV1AccountsPeoplePostRequestFormRelationshipPercentOwnershipX718103ce(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1AccountsPeoplePostRequestFormRelationshipPercentOwnershipX718103ceNoMatchException(
                    "InlineV1AccountsPeoplePostRequestFormRelationshipPercentOwnershipX718103ce matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1AccountsPeoplePostRequestFormRelationshipPercentOwnershipX718103ce> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPeoplePostRequestFormRelationshipPercentOwnershipX718103ce,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1AccountsPeoplePostRequestFormRelationshipPercentOwnershipX718103ce",
...
private fun inspectInlineV1AccountsPeoplePostRequestFormRelationshipPercentOwnershipX718103ce(
    element: JsonElement,
    ...
    val matchesInlineV1AccountsPeoplePostRequestFormRelationshipPercentOwnershipAnyOf2X9e433f0f =
        element
            .isJsonDecodable<InlineV1AccountsPeoplePostRequestFormRelationshipPercentOwnershipAnyOf2X9e433f0f>()
    return InlineV1AccountsPeoplePostRequestFormRelationshipPercentOwnershipX718103ceInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1AccountsPeoplePostRequestFormRelationshipPercentOwnershipAnyOf2X9e433f0f) {
                    add(
                        "InlineV1AccountsPeoplePostRequestFormRelationshipPercentOwnershipAnyOf2X9e433f0f: value does not match InlineV1AccountsPeoplePostRequestFormRelationshipPercentOwnershipAnyOf2X9e433f0f",
                    )
                }
            },
    )
