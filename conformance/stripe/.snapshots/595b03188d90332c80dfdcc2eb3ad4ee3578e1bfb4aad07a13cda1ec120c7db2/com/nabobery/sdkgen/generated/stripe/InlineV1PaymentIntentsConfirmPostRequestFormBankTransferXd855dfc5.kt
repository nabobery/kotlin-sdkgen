...
public class InlineV1PaymentIntentsConfirmPostRequestFormBankTransferXd855dfc5(
    ...
    public val euBankTransfer: InlineV1PaymentIntentsConfirmPostRequestFormEuBankTransferX51f5a3dc? = null,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PaymentIntentsConfirmPostRequestFormBankTransferXd855dfc5 =
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsConfirmPostRequestFormBankTransferXd855dfc5> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1PaymentIntentsConfirmPostRequestFormBankTransferXd855dfc5 {
            val jsonDecoder =
                decoder.requireJsonDecoder(
                    "InlineV1PaymentIntentsConfirmPostRequestFormBankTransferXd855dfc5",
                )
            val json = jsonDecoder.json
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsConfirmPostRequestFormBankTransferXd855dfc5 must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsTypeXcd50f0c1>(
                    rawObject,
                    "type",
                )
            return InlineV1PaymentIntentsConfirmPostRequestFormBankTransferXd855dfc5(
                ...
                euBankTransfer =
                    rawObject["eu_bank_transfer"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormEuBankTransferX51f5a3dc>(
                            it,
                        )
                    },
                requestedAddressTypes =
                    rawObject["requested_address_types"]?.let {
                        json
                            .decodeFromJsonElement<List<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsItemXde9261ce>>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsConfirmPostRequestFormBankTransferXd855dfc5,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentIntentsConfirmPostRequestFormBankTransferXd855dfc5(
    block: InlineV1PaymentIntentsConfirmPostRequestFormBankTransferXd855dfc5.Builder.() -> Unit,
): InlineV1PaymentIntentsConfirmPostRequestFormBankTransferXd855dfc5 =
    InlineV1PaymentIntentsConfirmPostRequestFormBankTransferXd855dfc5.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentIntentsConfirmPostRequestFormBankTransferXd855dfc5 is missing required property '" +
                    name +
                    "'",
            )
