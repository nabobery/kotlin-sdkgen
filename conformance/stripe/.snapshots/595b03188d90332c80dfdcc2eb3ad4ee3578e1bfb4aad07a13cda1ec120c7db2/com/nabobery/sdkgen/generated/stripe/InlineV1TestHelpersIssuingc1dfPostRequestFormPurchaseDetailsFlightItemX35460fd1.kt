...
public class InlineV1TestHelpersIssuingc1dfPostRequestFormPurchaseDetailsFlightItemX35460fd1(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1TestHelpersIssuingc1dfPostRequestFormPurchaseDetailsFlightItemX35460fd1 =
            InlineV1TestHelpersIssuingc1dfPostRequestFormPurchaseDetailsFlightItemX35460fd1(
    ...
    public object Serializer : KSerializer<InlineV1TestHelpersIssuingc1dfPostRequestFormPurchaseDetailsFlightItemX35460fd1> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TestHelpersIssuingc1dfPostRequestFormPurchaseDetailsFlightItemX35460fd1 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TestHelpersIssuingc1dfPostRequestFormPurchaseDetailsFlightItemX35460fd1,
        ) {
            val jsonEncoder =
...
public fun inlineV1TestHelpersIssuingc1dfPostRequestFormPurchaseDetailsFlightItemX35460fd1(
    block: InlineV1TestHelpersIssuingc1dfPostRequestFormPurchaseDetailsFlightItemX35460fd1.Builder.() -> Unit,
): InlineV1TestHelpersIssuingc1dfPostRequestFormPurchaseDetailsFlightItemX35460fd1 =
    InlineV1TestHelpersIssuingc1dfPostRequestFormPurchaseDetailsFlightItemX35460fd1.build(block)
