...
public sealed class InlineV1PaymentAttemptRecordsGetResponse200JsonObjectValueX2811878c {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1PaymentAttemptRecordsGetResponse200JsonObjectValueX2811878c =
            when (value) {
                List.value -> List
    ...
    public object Serializer : KSerializer<InlineV1PaymentAttemptRecordsGetResponse200JsonObjectValueX2811878c> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1PaymentAttemptRecordsGetResponse200JsonObjectValueX2811878c",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1PaymentAttemptRecordsGetResponse200JsonObjectValueX2811878c = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentAttemptRecordsGetResponse200JsonObjectValueX2811878c,
        ) {
