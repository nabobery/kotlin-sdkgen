...
public sealed class InlineSubscriptionPaymentMethodOptionsCardNetworkXe9bf37aa {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineSubscriptionPaymentMethodOptionsCardNetworkXe9bf37aa =
            when (value) {
                Amex.value -> Amex
    ...
    public object Serializer : KSerializer<InlineSubscriptionPaymentMethodOptionsCardNetworkXe9bf37aa> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineSubscriptionPaymentMethodOptionsCardNetworkXe9bf37aa",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineSubscriptionPaymentMethodOptionsCardNetworkXe9bf37aa =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineSubscriptionPaymentMethodOptionsCardNetworkXe9bf37aa,
        ) {
