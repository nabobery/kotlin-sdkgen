...
public class InlineV1InvoicesCreatePreviewPostRequestFormSubscriptionDetailsDurationXc349d5eb(
    public val interval: InlineV1InvoicesCreatePreviewPostRequestFormSubscriptionDetailsIntervalX67fc9dfa,
    ...
    public object Serializer : KSerializer<InlineV1InvoicesCreatePreviewPostRequestFormSubscriptionDetailsDurationXc349d5eb> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1InvoicesCreatePreviewPostRequestFormSubscriptionDetailsDurationXc349d5eb must be a JSON object",
                    )
            val interval =
                json
                    .decodeRequired<InlineV1InvoicesCreatePreviewPostRequestFormSubscriptionDetailsIntervalX67fc9dfa>(
                        rawObject,
                        "interval",
                    )
            return InlineV1InvoicesCreatePreviewPostRequestFormSubscriptionDetailsDurationXc349d5eb(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesCreatePreviewPostRequestFormSubscriptionDetailsDurationXc349d5eb,
        ) {
            val jsonEncoder =
...
public fun inlineV1InvoicesCreatePreviewPostRequestFormSubscriptionDetailsDurationXc349d5eb(
    block: InlineV1InvoicesCreatePreviewPostRequestFormSubscriptionDetailsDurationXc349d5eb.Builder.() -> Unit,
): InlineV1InvoicesCreatePreviewPostRequestFormSubscriptionDetailsDurationXc349d5eb =
    InlineV1InvoicesCreatePreviewPostRequestFormSubscriptionDetailsDurationXc349d5eb.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1InvoicesCreatePreviewPostRequestFormSubscriptionDetailsDurationXc349d5eb is missing required property '" +
                    name +
                    "'",
            )
