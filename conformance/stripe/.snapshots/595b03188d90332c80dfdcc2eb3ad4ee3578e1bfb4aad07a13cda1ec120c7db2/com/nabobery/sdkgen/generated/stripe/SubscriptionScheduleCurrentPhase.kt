        ...
        override fun deserialize(decoder: Decoder): SubscriptionScheduleCurrentPhase {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("SubscriptionScheduleCurrentPhase must be a JSON object")
...
public fun subscriptionScheduleCurrentPhase(
    block: SubscriptionScheduleCurrentPhase.Builder.() -> Unit,
): SubscriptionScheduleCurrentPhase = SubscriptionScheduleCurrentPhase.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "SubscriptionScheduleCurrentPhase is missing required property '" + name + "'",
            )
