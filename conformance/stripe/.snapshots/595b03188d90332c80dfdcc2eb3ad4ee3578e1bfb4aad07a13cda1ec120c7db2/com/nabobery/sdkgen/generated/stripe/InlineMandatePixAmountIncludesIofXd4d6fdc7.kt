...
public sealed class InlineMandatePixAmountIncludesIofXd4d6fdc7 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineMandatePixAmountIncludesIofXd4d6fdc7 =
            when (value) {
                Always.value -> Always
                Never.value -> Never
    ...
    public object Serializer : KSerializer<InlineMandatePixAmountIncludesIofXd4d6fdc7> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineMandatePixAmountIncludesIofXd4d6fdc7",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineMandatePixAmountIncludesIofXd4d6fdc7 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineMandatePixAmountIncludesIofXd4d6fdc7,
        ) {
