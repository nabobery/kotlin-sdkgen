...
public class IssuingTransactionFleetNonFuelPriceData(
    ...
    public class Builder {
        ...
        public fun build(): IssuingTransactionFleetNonFuelPriceData =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): IssuingTransactionFleetNonFuelPriceData =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<IssuingTransactionFleetNonFuelPriceData> {
        ...
        override fun deserialize(decoder: Decoder): IssuingTransactionFleetNonFuelPriceData {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("IssuingTransactionFleetNonFuelPriceData must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: IssuingTransactionFleetNonFuelPriceData,
        ) {
...
public fun issuingTransactionFleetNonFuelPriceData(
    block: IssuingTransactionFleetNonFuelPriceData.Builder.() -> Unit,
): IssuingTransactionFleetNonFuelPriceData = IssuingTransactionFleetNonFuelPriceData.build(block)
