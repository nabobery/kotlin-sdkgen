...
public class TreasuryOutboundPaymentsResourceOutboundPaymentResourceTrackingDetails(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): TreasuryOutboundPaymentsResourceOutboundPaymentResourceTrackingDetails = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<TreasuryOutboundPaymentsResourceOutboundPaymentResourceTrackingDetails> {
        ...
        override fun deserialize(
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "TreasuryOutboundPaymentsResourceOutboundPaymentResourceTrackingDetails must be a JSON object",
                    )
            ...
            return TreasuryOutboundPaymentsResourceOutboundPaymentResourceTrackingDetails(
                ...
                ach =
                    rawObject["ach"]?.let {
                        json.decodeFromJsonElement<TreasuryOutboundPaymentsResourceAchTrackingDetails>(
                            it,
                        )
                    },
                usDomesticWire =
                    rawObject["us_domestic_wire"]?.let {
                        json.decodeFromJsonElement<TreasuryOutboundPaymentsResourceUsDomesticWireTrackingDetails>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: TreasuryOutboundPaymentsResourceOutboundPaymentResourceTrackingDetails,
        ) {
            val jsonEncoder =
...
public fun treasuryOutboundPaymentsResourceOutboundPaymentResourceTrackingDetails(
    block: TreasuryOutboundPaymentsResourceOutboundPaymentResourceTrackingDetails.Builder.() -> Unit,
): TreasuryOutboundPaymentsResourceOutboundPaymentResourceTrackingDetails =
    TreasuryOutboundPaymentsResourceOutboundPaymentResourceTrackingDetails.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "TreasuryOutboundPaymentsResourceOutboundPaymentResourceTrackingDetails is missing required property '" +
                    name +
                    "'",
            )
