...
public class CreditNotesPretaxCreditAmount(
     ...
     */
    public val creditBalanceTransaction: InlineCreditNotesPretaxCreditAmountCreditBalanceTransactionX1303623d? = null,
    /**
    ...
    public object Serializer : KSerializer<CreditNotesPretaxCreditAmount> {
        ...
        override fun deserialize(decoder: Decoder): CreditNotesPretaxCreditAmount {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("CreditNotesPretaxCreditAmount must be a JSON object")
            ...
            return CreditNotesPretaxCreditAmount(
                ...
                creditBalanceTransaction =
                    rawObject["credit_balance_transaction"]?.let {
                        json
                            .decodeFromJsonElement<InlineCreditNotesPretaxCreditAmountCreditBalanceTransactionX1303623d>(
                                it,
                            )
                    },
                discount =
                    rawObject["discount"]?.let {
                        json.decodeFromJsonElement<InlineCreditNotesPretaxCreditAmountDiscountX67821026>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: CreditNotesPretaxCreditAmount,
        ) {
            ...
            val raw =
                buildJsonObject {
                    ...
                    value.creditBalanceTransaction?.let {
                        put(
...
public fun creditNotesPretaxCreditAmount(
    block: CreditNotesPretaxCreditAmount.Builder.() -> Unit,
): CreditNotesPretaxCreditAmount = CreditNotesPretaxCreditAmount.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException("CreditNotesPretaxCreditAmount is missing required property '" + name + "'")
