...
public class InlineBillingCreditBalanceSummaryCustomerXd7a27b43 internal constructor(
        ...
        get() =
            buildSet {
                ...
                if (inspection.matchesDeletedCustomer) {
                    add(
                        InlineBillingCreditBalanceSummaryCustomerXd7a27b43Branch.DeletedCustomer,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineBillingCreditBalanceSummaryCustomerXd7a27b43 {
            val inspection = inspectInlineBillingCreditBalanceSummaryCustomerXd7a27b43(raw)
            if (inspection.matchCount == 0) {
                throw InlineBillingCreditBalanceSummaryCustomerXd7a27b43NoMatchException(
                    "InlineBillingCreditBalanceSummaryCustomerXd7a27b43 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineBillingCreditBalanceSummaryCustomerXd7a27b43> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineBillingCreditBalanceSummaryCustomerXd7a27b43,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineBillingCreditBalanceSummaryCustomerXd7a27b43",
...
private fun inspectInlineBillingCreditBalanceSummaryCustomerXd7a27b43(
    element: JsonElement,
): InlineBillingCreditBalanceSummaryCustomerXd7a27b43Inspection {
