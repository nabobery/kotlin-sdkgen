...
public class CheckoutSessionPaymentMethodOptions(
    ...
    public class Builder {
        ...
        public fun build(): CheckoutSessionPaymentMethodOptions =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): CheckoutSessionPaymentMethodOptions =
        ...
        override fun deserialize(decoder: Decoder): CheckoutSessionPaymentMethodOptions {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("CheckoutSessionPaymentMethodOptions must be a JSON object")
            return CheckoutSessionPaymentMethodOptions(
                acssDebit =
                    rawObject["acss_debit"]?.let {
                        json.decodeFromJsonElement<CheckoutAcssDebitPaymentMethodOptions>(
                            it,
                        )
                    },
                affirm =
                    rawObject["affirm"]?.let {
                        json.decodeFromJsonElement<CheckoutAffirmPaymentMethodOptions>(
                            it,
                        )
                    },
                afterpayClearpay =
                    rawObject["afterpay_clearpay"]?.let {
                        json.decodeFromJsonElement<CheckoutAfterpayClearpayPaymentMethodOptions>(it)
                    },
                alipay =
                    rawObject["alipay"]?.let {
                        json.decodeFromJsonElement<CheckoutAlipayPaymentMethodOptions>(
                            it,
                        )
                    },
                ...
                amazonPay =
                    rawObject["amazon_pay"]?.let {
                        json.decodeFromJsonElement<CheckoutAmazonPayPaymentMethodOptions>(
                            it,
                        )
                    },
                auBecsDebit =
                    rawObject["au_becs_debit"]?.let {
                        json.decodeFromJsonElement<CheckoutAuBecsDebitPaymentMethodOptions>(it)
                    },
                bacsDebit =
                    rawObject["bacs_debit"]?.let {
                        json.decodeFromJsonElement<CheckoutBacsDebitPaymentMethodOptions>(
                            it,
                        )
                    },
                bancontact =
                    rawObject["bancontact"]?.let {
                        json.decodeFromJsonElement<CheckoutBancontactPaymentMethodOptions>(
                            it,
                        )
                    },
                billie =
                    rawObject["billie"]?.let {
                        json
                            .decodeFromJsonElement<CheckoutBilliePaymentMethodOptions>(
                                it,
                            )
                    },
                boleto =
                    rawObject["boleto"]?.let {
                        json.decodeFromJsonElement<CheckoutBoletoPaymentMethodOptions>(
                            it,
                        )
                    },
                card = rawObject["card"]?.let {
                    json.decodeFromJsonElement<CheckoutCardPaymentMethodOptions>(
                        it,
                    )
                },
                cashapp =
                    rawObject["cashapp"]?.let {
                        json.decodeFromJsonElement<CheckoutCashappPaymentMethodOptions>(
                            it,
                        )
                    },
                customerBalance =
                    rawObject["customer_balance"]?.let {
                        json.decodeFromJsonElement<CheckoutCustomerBalancePaymentMethodOptions>(it)
                    },
                ...
                giropay =
                    rawObject["giropay"]?.let {
                        json.decodeFromJsonElement<CheckoutGiropayPaymentMethodOptions>(
                            it,
                        )
                    },
                grabpay =
                    rawObject["grabpay"]?.let {
                        json.decodeFromJsonElement<CheckoutGrabPayPaymentMethodOptions>(
                            it,
                        )
                    },
                ideal = rawObject["ideal"]?.let {
                    json.decodeFromJsonElement<CheckoutIdealPaymentMethodOptions>(
                        it,
                    )
                },
                kakaoPay =
                    rawObject["kakao_pay"]?.let {
                        json
                            .decodeFromJsonElement<CheckoutKakaoPayPaymentMethodOptions>(
                                it,
                            )
                    },
                klarna =
                    rawObject["klarna"]?.let {
                        json.decodeFromJsonElement<CheckoutKlarnaPaymentMethodOptions>(
                            it,
                        )
                    },
                konbini =
                    rawObject["konbini"]?.let {
                        json.decodeFromJsonElement<CheckoutKonbiniPaymentMethodOptions>(
                            it,
                        )
                    },
                krCard =
                    rawObject["kr_card"]?.let {
                        json.decodeFromJsonElement<CheckoutKrCardPaymentMethodOptions>(
                            it,
                        )
                    },
                link = rawObject["link"]?.let {
                    json
                        .decodeFromJsonElement<CheckoutLinkPaymentMethodOptions>(
                            it,
                        )
                },
                mobilepay =
                    rawObject["mobilepay"]?.let {
                        json.decodeFromJsonElement<CheckoutMobilepayPaymentMethodOptions>(
                            it,
                        )
                    },
                multibanco =
                    rawObject["multibanco"]?.let {
                        json.decodeFromJsonElement<CheckoutMultibancoPaymentMethodOptions>(
                            it,
                        )
                    },
                naverPay =
                    rawObject["naver_pay"]?.let {
                        json
                            .decodeFromJsonElement<CheckoutNaverPayPaymentMethodOptions>(
                                it,
                            )
                    },
                ...
                paynow =
                    rawObject["paynow"]?.let {
                        json.decodeFromJsonElement<CheckoutPaynowPaymentMethodOptions>(
                            it,
                        )
                    },
                paypal =
                    rawObject["paypal"]?.let {
                        json.decodeFromJsonElement<CheckoutPaypalPaymentMethodOptions>(
                            it,
                        )
                    },
                payto = rawObject["payto"]?.let {
                    json.decodeFromJsonElement<CheckoutPaytoPaymentMethodOptions>(
                        it,
                    )
                },
                ...
                revolutPay =
                    rawObject["revolut_pay"]?.let {
                        json.decodeFromJsonElement<CheckoutRevolutPayPaymentMethodOptions>(
                            it,
                        )
                    },
                samsungPay =
                    rawObject["samsung_pay"]?.let {
                        json.decodeFromJsonElement<CheckoutSamsungPayPaymentMethodOptions>(
                            it,
                        )
                    },
                satispay =
                    rawObject["satispay"]?.let {
                        json
                            .decodeFromJsonElement<CheckoutSatispayPaymentMethodOptions>(
                                it,
                            )
                    },
                scalapay =
                    rawObject["scalapay"]?.let {
                        json
                            .decodeFromJsonElement<CheckoutScalapayPaymentMethodOptions>(
                                it,
                            )
                    },
                sepaDebit =
                    rawObject["sepa_debit"]?.let {
                        json.decodeFromJsonElement<CheckoutSepaDebitPaymentMethodOptions>(
                            it,
                        )
                    },
                sofort =
                    rawObject["sofort"]?.let {
                        json.decodeFromJsonElement<CheckoutSofortPaymentMethodOptions>(
                            it,
                        )
                    },
                sunbit =
                    rawObject["sunbit"]?.let {
                        json.decodeFromJsonElement<CheckoutSunbitPaymentMethodOptions>(
                            it,
                        )
                    },
                swish = rawObject["swish"]?.let {
                    json.decodeFromJsonElement<CheckoutSwishPaymentMethodOptions>(
                        it,
                    )
                },
                ...
                usBankAccount =
                    rawObject["us_bank_account"]?.let {
                        json.decodeFromJsonElement<CheckoutUsBankAccountPaymentMethodOptions>(it)
                    },
                wechatPay =
                    rawObject["wechat_pay"]?.let {
                        json.decodeFromJsonElement<CheckoutWechatPayPaymentMethodOptions>(
                            it,
                        )
                    },
            )
...
public fun checkoutSessionPaymentMethodOptions(
    block: CheckoutSessionPaymentMethodOptions.Builder.() -> Unit,
): CheckoutSessionPaymentMethodOptions = CheckoutSessionPaymentMethodOptions.build(block)
