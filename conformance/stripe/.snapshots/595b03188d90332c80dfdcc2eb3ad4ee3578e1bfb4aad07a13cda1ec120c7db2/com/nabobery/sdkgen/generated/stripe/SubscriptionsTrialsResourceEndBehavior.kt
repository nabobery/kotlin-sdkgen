...
public class SubscriptionsTrialsResourceEndBehavior(
     ...
     */
    public val missingPaymentMethod: InlineSubscriptionsTrialsResourceEndBehaviorMissingPaymentMethodX58fdd33b,
) {
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): SubscriptionsTrialsResourceEndBehavior =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<SubscriptionsTrialsResourceEndBehavior> {
        ...
        override fun deserialize(decoder: Decoder): SubscriptionsTrialsResourceEndBehavior {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("SubscriptionsTrialsResourceEndBehavior must be a JSON object")
            val missingPaymentMethod =
                json
                    .decodeRequired<InlineSubscriptionsTrialsResourceEndBehaviorMissingPaymentMethodX58fdd33b>(
                        rawObject,
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: SubscriptionsTrialsResourceEndBehavior,
        ) {
...
public fun subscriptionsTrialsResourceEndBehavior(
    block: SubscriptionsTrialsResourceEndBehavior.Builder.() -> Unit,
): SubscriptionsTrialsResourceEndBehavior = SubscriptionsTrialsResourceEndBehavior.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "SubscriptionsTrialsResourceEndBehavior is missing required property '" + name + "'",
            )
