...
public class SetupIntentPaymentMethodOptionsMandateOptionsBacsDebit(
    ...
    public class Builder {
        ...
        public fun build(): SetupIntentPaymentMethodOptionsMandateOptionsBacsDebit =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): SetupIntentPaymentMethodOptionsMandateOptionsBacsDebit =
    ...
    public object Serializer : KSerializer<SetupIntentPaymentMethodOptionsMandateOptionsBacsDebit> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "SetupIntentPaymentMethodOptionsMandateOptionsBacsDebit must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: SetupIntentPaymentMethodOptionsMandateOptionsBacsDebit,
        ) {
...
public fun setupIntentPaymentMethodOptionsMandateOptionsBacsDebit(
    block: SetupIntentPaymentMethodOptionsMandateOptionsBacsDebit.Builder.() -> Unit,
): SetupIntentPaymentMethodOptionsMandateOptionsBacsDebit =
    SetupIntentPaymentMethodOptionsMandateOptionsBacsDebit.build(block)
