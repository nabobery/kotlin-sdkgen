...
public class InlineV1SubscriptionsPostRequestFormAddInvoiceItemsItemPriceDataX3d872e09(
    ...
    public val taxBehavior: InlineV1SubscriptionsPostRequestFormAddInvoiceItemsItemTaxBehaviorX3bcf7206? = null,
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1SubscriptionsPostRequestFormAddInvoiceItemsItemPriceDataX3d872e09 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1SubscriptionsPostRequestFormAddInvoiceItemsItemPriceDataX3d872e09> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SubscriptionsPostRequestFormAddInvoiceItemsItemPriceDataX3d872e09 must be a JSON object",
                    )
            ...
            return InlineV1SubscriptionsPostRequestFormAddInvoiceItemsItemPriceDataX3d872e09(
                ...
                taxBehavior =
                    rawObject["tax_behavior"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormAddInvoiceItemsItemTaxBehaviorX3bcf7206>(
                                it,
                            )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsPostRequestFormAddInvoiceItemsItemPriceDataX3d872e09,
        ) {
            val jsonEncoder =
...
public fun inlineV1SubscriptionsPostRequestFormAddInvoiceItemsItemPriceDataX3d872e09(
    block: InlineV1SubscriptionsPostRequestFormAddInvoiceItemsItemPriceDataX3d872e09.Builder.() -> Unit,
): InlineV1SubscriptionsPostRequestFormAddInvoiceItemsItemPriceDataX3d872e09 =
    InlineV1SubscriptionsPostRequestFormAddInvoiceItemsItemPriceDataX3d872e09.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1SubscriptionsPostRequestFormAddInvoiceItemsItemPriceDataX3d872e09 is missing required property '" +
                    name +
                    "'",
            )
