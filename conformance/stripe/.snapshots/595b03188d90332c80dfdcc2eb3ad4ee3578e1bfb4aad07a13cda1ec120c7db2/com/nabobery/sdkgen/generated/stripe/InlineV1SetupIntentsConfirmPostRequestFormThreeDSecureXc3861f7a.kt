...
public class InlineV1SetupIntentsConfirmPostRequestFormThreeDSecureXc3861f7a(
    public val aresTransStatus: InlineV1SetupIntentsConfirmPostRequestFormAresTransStatusX79855976? = null,
    ...
    public val networkOptions: InlineV1SetupIntentsConfirmPostRequestFormNetworkOptionsX2b50fdba? = null,
    public val requestorChallengeIndicator: String? = null,
    public val transactionId: String? = null,
    public val version: InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsVersionX53938e7e? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1SetupIntentsConfirmPostRequestFormThreeDSecureXc3861f7a =
            InlineV1SetupIntentsConfirmPostRequestFormThreeDSecureXc3861f7a(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1SetupIntentsConfirmPostRequestFormThreeDSecureXc3861f7a =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1SetupIntentsConfirmPostRequestFormThreeDSecureXc3861f7a> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SetupIntentsConfirmPostRequestFormThreeDSecureXc3861f7a must be a JSON object",
                    )
            return InlineV1SetupIntentsConfirmPostRequestFormThreeDSecureXc3861f7a(
                aresTransStatus =
                    rawObject["ares_trans_status"]?.let {
                        json.decodeFromJsonElement<InlineV1SetupIntentsConfirmPostRequestFormAresTransStatusX79855976>(
                            it,
                        )
                    },
                ...
                electronicCommerceIndicator =
                    rawObject["electronic_commerce_indicator"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SetupIntentsConfirmPostRequestFormElectronicCommerceIn67d5X546aa3b0>(
                                it,
                            )
                    },
                networkOptions =
                    rawObject["network_options"]?.let {
                        json.decodeFromJsonElement<InlineV1SetupIntentsConfirmPostRequestFormNetworkOptionsX2b50fdba>(
                            it,
                        )
                    },
                ...
                version =
                    rawObject["version"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsVersionX53938e7e>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SetupIntentsConfirmPostRequestFormThreeDSecureXc3861f7a,
        ) {
            val jsonEncoder =
...
public fun inlineV1SetupIntentsConfirmPostRequestFormThreeDSecureXc3861f7a(
    block: InlineV1SetupIntentsConfirmPostRequestFormThreeDSecureXc3861f7a.Builder.() -> Unit,
): InlineV1SetupIntentsConfirmPostRequestFormThreeDSecureXc3861f7a =
    InlineV1SetupIntentsConfirmPostRequestFormThreeDSecureXc3861f7a.build(block)
