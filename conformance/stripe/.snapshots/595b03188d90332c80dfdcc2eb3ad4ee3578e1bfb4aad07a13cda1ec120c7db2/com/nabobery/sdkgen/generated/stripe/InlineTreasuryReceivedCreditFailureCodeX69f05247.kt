...
public sealed class InlineTreasuryReceivedCreditFailureCodeX69f05247 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineTreasuryReceivedCreditFailureCodeX69f05247 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineTreasuryReceivedCreditFailureCodeX69f05247> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineTreasuryReceivedCreditFailureCodeX69f05247",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineTreasuryReceivedCreditFailureCodeX69f05247 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineTreasuryReceivedCreditFailureCodeX69f05247,
        ) {
