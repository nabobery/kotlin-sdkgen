...
internal data class InlineV1ClimateOrdersPostRequestFormBeneficiaryAnyOf1PublicNameX123f1a1aInspection(
    ...
    public val matchesInlineV1ClimateOrdersPostRequestFormBeneficiaryAnyOf1PublicNameAnyOf2Xdfc60eae: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1ClimateOrdersPostRequestFormBeneficiaryAnyOf1PublicNameAnyOf2Xdfc60eae,
            ).count {
                it
            }
}
...
public class InlineV1ClimateOrdersPostRequestFormBeneficiaryAnyOf1PublicNameX123f1a1a internal constructor(
    ...
    private val inspection: InlineV1ClimateOrdersPostRequestFormBeneficiaryAnyOf1PublicNameX123f1a1aInspection,
) {
    ...
    public val inlineV1ClimateOrdersPostRequestFormBeneficiaryAnyOf1PublicNameAnyOf2Xdfc60eae:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1ClimateOrdersPostRequestFormBeneficiaryAnyOf1PublicNameAnyOf2Xdfc60eae) {
                json
                    .decodeFromJsonElement<InlineV1ClimateOrdersPostRequestFormBeneficiaryAnyOf1PublicNameAnyOf2Xdfc60eae>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1ClimateOrdersPostRequestFormBeneficiaryAnyOf1PublicNameX123f1a1aBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1ClimateOrdersPostRequestFormBeneficiaryAnyOf1PublicNameAnyOf2Xdfc60eae) {
                    add(
                        InlineV1ClimateOrdersPostRequestFormBeneficiaryAnyOf1PublicNameX123f1a1aBranch.InlineV1ClimateOrdersPostRequestFormBeneficiaryAnyOf1PublicNameAnyOf2Xdfc60eae,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1ClimateOrdersPostRequestFormBeneficiaryAnyOf1PublicNameX123f1a1a {
            val inspection = inspectInlineV1ClimateOrdersPostRequestFormBeneficiaryAnyOf1PublicNameX123f1a1a(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1ClimateOrdersPostRequestFormBeneficiaryAnyOf1PublicNameX123f1a1aNoMatchException(
                    "InlineV1ClimateOrdersPostRequestFormBeneficiaryAnyOf1PublicNameX123f1a1a matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1ClimateOrdersPostRequestFormBeneficiaryAnyOf1PublicNameX123f1a1a> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ClimateOrdersPostRequestFormBeneficiaryAnyOf1PublicNameX123f1a1a,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1ClimateOrdersPostRequestFormBeneficiaryAnyOf1PublicNameX123f1a1a",
...
private fun inspectInlineV1ClimateOrdersPostRequestFormBeneficiaryAnyOf1PublicNameX123f1a1a(
    element: JsonElement,
): InlineV1ClimateOrdersPostRequestFormBeneficiaryAnyOf1PublicNameX123f1a1aInspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1ClimateOrdersPostRequestFormBeneficiaryAnyOf1PublicNameAnyOf2Xdfc60eae =
        element
            .isJsonDecodable<InlineV1ClimateOrdersPostRequestFormBeneficiaryAnyOf1PublicNameAnyOf2Xdfc60eae>()
    return InlineV1ClimateOrdersPostRequestFormBeneficiaryAnyOf1PublicNameX123f1a1aInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1ClimateOrdersPostRequestFormBeneficiaryAnyOf1PublicNameAnyOf2Xdfc60eae) {
                    add(
                        "InlineV1ClimateOrdersPostRequestFormBeneficiaryAnyOf1PublicNameAnyOf2Xdfc60eae: value does not match InlineV1ClimateOrdersPostRequestFormBeneficiaryAnyOf1PublicNameAnyOf2Xdfc60eae",
                    )
                }
            },
    )
