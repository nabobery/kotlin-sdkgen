...
public class AccountGroupMembership(
    ...
    public class Builder {
        ...
        public fun build(): AccountGroupMembership =
        ...
        override fun deserialize(decoder: Decoder): AccountGroupMembership {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("AccountGroupMembership must be a JSON object")
            return AccountGroupMembership(
                paymentsPricing =
                    rawObject["payments_pricing"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
...
public fun accountGroupMembership(block: AccountGroupMembership.Builder.() -> Unit): AccountGroupMembership =
    AccountGroupMembership.build(block)
