...
public class InlineV1QuotesPostRequestFormAutomaticTaxLiabilityX774f8108(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1QuotesPostRequestFormAutomaticTaxLiabilityX774f8108 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1QuotesPostRequestFormAutomaticTaxLiabilityX774f8108> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1QuotesPostRequestFormAutomaticTaxLiabilityX774f8108 must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineV1QuotesPostRequestFormAutomaticTaxLiabilityTypeX1b9e4d3d>(
                    rawObject,
                    "type",
                )
            return InlineV1QuotesPostRequestFormAutomaticTaxLiabilityX774f8108(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1QuotesPostRequestFormAutomaticTaxLiabilityX774f8108,
        ) {
...
public fun inlineV1QuotesPostRequestFormAutomaticTaxLiabilityX774f8108(
    block: InlineV1QuotesPostRequestFormAutomaticTaxLiabilityX774f8108.Builder.() -> Unit,
): InlineV1QuotesPostRequestFormAutomaticTaxLiabilityX774f8108 =
    InlineV1QuotesPostRequestFormAutomaticTaxLiabilityX774f8108.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1QuotesPostRequestFormAutomaticTaxLiabilityX774f8108 is missing required property '" + name +
                    "'",
            )
