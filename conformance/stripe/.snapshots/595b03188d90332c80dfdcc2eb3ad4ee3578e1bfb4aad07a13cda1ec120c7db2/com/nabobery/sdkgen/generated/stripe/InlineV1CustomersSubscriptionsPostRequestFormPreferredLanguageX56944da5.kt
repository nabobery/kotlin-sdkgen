...
public sealed class InlineV1CustomersSubscriptionsPostRequestFormPreferredLanguageX56944da5 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1CustomersSubscriptionsPostRequestFormPreferredLanguageX56944da5 =
            when (value) {
                De.value -> De
                En.value -> En
                Fr.value -> Fr
    ...
    public object Serializer : KSerializer<InlineV1CustomersSubscriptionsPostRequestFormPreferredLanguageX56944da5> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1CustomersSubscriptionsPostRequestFormPreferredLanguageX56944da5",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1CustomersSubscriptionsPostRequestFormPreferredLanguageX56944da5 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersSubscriptionsPostRequestFormPreferredLanguageX56944da5,
        ) {
