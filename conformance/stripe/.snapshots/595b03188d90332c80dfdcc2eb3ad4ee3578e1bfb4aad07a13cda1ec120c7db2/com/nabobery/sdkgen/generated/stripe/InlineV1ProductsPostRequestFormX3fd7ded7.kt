...
public class InlineV1ProductsPostRequestFormX3fd7ded7(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1ProductsPostRequestFormX3fd7ded7 =
            InlineV1ProductsPostRequestFormX3fd7ded7(
                active = active,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1ProductsPostRequestFormX3fd7ded7 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1ProductsPostRequestFormX3fd7ded7> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1ProductsPostRequestFormX3fd7ded7 {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("InlineV1ProductsPostRequestFormX3fd7ded7 must be a JSON object")
            return InlineV1ProductsPostRequestFormX3fd7ded7(
                ...
                description =
                    rawObject["description"]?.let {
                        json.decodeFromJsonElement<InlineV1ProductsPostRequestFormDescriptionX1695ae95>(it)
                    },
                expand = rawObject["expand"]?.let { json.decodeFromJsonElement<List<String>>(it) },
                images =
                    rawObject["images"]?.let {
                        json.decodeFromJsonElement<InlineV1ProductsPostRequestFormImagesX81d5d48f>(
                            it,
                        )
                    },
                marketingFeatures =
                    rawObject["marketing_features"]?.let {
                        json.decodeFromJsonElement<InlineV1ProductsPostRequestFormMarketingFeaturesXe09c3b1f>(it)
                    },
                metadata =
                    rawObject["metadata"]?.let {
                        json.decodeFromJsonElement<InlineV1ProductsPostRequestFormMetadataXa7c50b95>(it)
                    },
                name = rawObject["name"]?.let { json.decodeFromJsonElement<String>(it) },
                packageDimensions =
                    rawObject["package_dimensions"]?.let {
                        json.decodeFromJsonElement<InlineV1ProductsPostRequestFormPackageDimensionsX1a994e95>(it)
                    },
                ...
                taxCode =
                    rawObject["tax_code"]?.let {
                        json.decodeFromJsonElement<InlineV1ProductsPostRequestFormTaxCodeXedb946d2>(it)
                    },
                unitLabel =
                    rawObject["unit_label"]?.let {
                        json.decodeFromJsonElement<InlineV1ProductsPostRequestFormUnitLabelX6c533a49>(it)
                    },
                url =
                    rawObject["url"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1ProductsPostRequestFormUrlX9c1340a7>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ProductsPostRequestFormX3fd7ded7,
        ) {
...
public fun inlineV1ProductsPostRequestFormX3fd7ded7(
    block: InlineV1ProductsPostRequestFormX3fd7ded7.Builder.() -> Unit,
): InlineV1ProductsPostRequestFormX3fd7ded7 = InlineV1ProductsPostRequestFormX3fd7ded7.build(block)
