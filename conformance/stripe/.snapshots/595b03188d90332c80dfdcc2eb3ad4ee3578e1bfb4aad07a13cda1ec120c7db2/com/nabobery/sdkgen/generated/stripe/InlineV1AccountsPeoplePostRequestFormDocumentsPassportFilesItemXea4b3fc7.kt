...
internal data class InlineV1AccountsPeoplePostRequestFormDocumentsPassportFilesItemXea4b3fc7Inspection(
    ...
    public val matchesInlineV1AccountsPeoplePostRequestFormDocumentsPassportFilesItemAnyOf2X1884c8ce: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1AccountsPeoplePostRequestFormDocumentsPassportFilesItemAnyOf2X1884c8ce,
            ).count {
                it
            }
}
...
public class InlineV1AccountsPeoplePostRequestFormDocumentsPassportFilesItemXea4b3fc7 internal constructor(
    ...
    private val inspection: InlineV1AccountsPeoplePostRequestFormDocumentsPassportFilesItemXea4b3fc7Inspection,
) {
    ...
    public val inlineV1AccountsPeoplePostRequestFormDocumentsPassportFilesItemAnyOf2X1884c8ce:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1AccountsPeoplePostRequestFormDocumentsPassportFilesItemAnyOf2X1884c8ce) {
                json
                    .decodeFromJsonElement<InlineV1AccountsPeoplePostRequestFormDocumentsPassportFilesItemAnyOf2X1884c8ce>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1AccountsPeoplePostRequestFormDocumentsPassportFilesItemXea4b3fc7Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1AccountsPeoplePostRequestFormDocumentsPassportFilesItemAnyOf2X1884c8ce) {
                    add(
                        InlineV1AccountsPeoplePostRequestFormDocumentsPassportFilesItemXea4b3fc7Branch.InlineV1AccountsPeoplePostRequestFormDocumentsPassportFilesItemAnyOf2X1884c8ce,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1AccountsPeoplePostRequestFormDocumentsPassportFilesItemXea4b3fc7 {
            val inspection = inspectInlineV1AccountsPeoplePostRequestFormDocumentsPassportFilesItemXea4b3fc7(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1AccountsPeoplePostRequestFormDocumentsPassportFilesItemXea4b3fc7NoMatchException(
                    "InlineV1AccountsPeoplePostRequestFormDocumentsPassportFilesItemXea4b3fc7 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1AccountsPeoplePostRequestFormDocumentsPassportFilesItemXea4b3fc7> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPeoplePostRequestFormDocumentsPassportFilesItemXea4b3fc7,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1AccountsPeoplePostRequestFormDocumentsPassportFilesItemXea4b3fc7",
...
private fun inspectInlineV1AccountsPeoplePostRequestFormDocumentsPassportFilesItemXea4b3fc7(
    element: JsonElement,
): InlineV1AccountsPeoplePostRequestFormDocumentsPassportFilesItemXea4b3fc7Inspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1AccountsPeoplePostRequestFormDocumentsPassportFilesItemAnyOf2X1884c8ce =
        element
            .isJsonDecodable<InlineV1AccountsPeoplePostRequestFormDocumentsPassportFilesItemAnyOf2X1884c8ce>()
    return InlineV1AccountsPeoplePostRequestFormDocumentsPassportFilesItemXea4b3fc7Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1AccountsPeoplePostRequestFormDocumentsPassportFilesItemAnyOf2X1884c8ce) {
                    add(
                        "InlineV1AccountsPeoplePostRequestFormDocumentsPassportFilesItemAnyOf2X1884c8ce: value does not match InlineV1AccountsPeoplePostRequestFormDocumentsPassportFilesItemAnyOf2X1884c8ce",
                    )
                }
            },
    )
