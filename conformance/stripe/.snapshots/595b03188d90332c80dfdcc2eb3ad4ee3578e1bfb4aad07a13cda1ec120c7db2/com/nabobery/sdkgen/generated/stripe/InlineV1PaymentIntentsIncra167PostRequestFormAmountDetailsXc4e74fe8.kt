...
public class InlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsXc4e74fe8(
    public val discountAmount: InlineV1PaymentIntentsIncra167PostRequestFormDiscountAmountXbfb60a4f? = null,
    public val enforceArithmeticValidation: Boolean? = null,
    public val lineItems: InlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsLineItemsXd10d2b1e? = null,
    public val shipping: InlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsShippingX6706ac2e? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsXc4e74fe8 =
            InlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsXc4e74fe8(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsXc4e74fe8 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsXc4e74fe8> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsXc4e74fe8 must be a JSON object",
                    )
            return InlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsXc4e74fe8(
                discountAmount =
                    rawObject["discount_amount"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsIncra167PostRequestFormDiscountAmountXbfb60a4f>(
                                it,
                            )
                    },
                ...
                lineItems =
                    rawObject["line_items"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsLineItemsXd10d2b1e>(
                                it,
                            )
                    },
                shipping =
                    rawObject["shipping"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsShippingX6706ac2e>(
                                it,
                            )
                    },
                tax =
                    rawObject["tax"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsTaxXab1f187f>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsXc4e74fe8,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsXc4e74fe8(
    block: InlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsXc4e74fe8.Builder.() -> Unit,
): InlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsXc4e74fe8 =
