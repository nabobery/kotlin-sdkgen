...
public sealed class InlineSetupIntentPaymentMethodOptionsAcssDebitCurrencyX5103e97c {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineSetupIntentPaymentMethodOptionsAcssDebitCurrencyX5103e97c =
            when (value) {
                Cad.value -> Cad
                Usd.value -> Usd
    ...
    public object Serializer : KSerializer<InlineSetupIntentPaymentMethodOptionsAcssDebitCurrencyX5103e97c> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineSetupIntentPaymentMethodOptionsAcssDebitCurrencyX5103e97c",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineSetupIntentPaymentMethodOptionsAcssDebitCurrencyX5103e97c =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineSetupIntentPaymentMethodOptionsAcssDebitCurrencyX5103e97c,
        ) {
