    ...
    public object Serializer : KSerializer<BillingBillResourceInvoicingLinesParentsInvoiceLineItemSubscriptionItemParent> {
        ...
        override fun deserialize(
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "BillingBillResourceInvoicingLinesParentsInvoiceLineItemSubscriptionItemParent must be a JSON object",
                    )
            ...
            return BillingBillResourceInvoicingLinesParentsInvoiceLineItemSubscriptionItemParent(
                ...
                subscriptionItem = subscriptionItem,
                invoiceItem =
                    rawObject["invoice_item"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                prorationDetails =
                    rawObject["proration_details"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineBillingBillResourceIe69bProrationDetailsX714c269c?>(
                                element,
                            )
                        }
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: BillingBillResourceInvoicingLinesParentsInvoiceLineItemSubscriptionItemParent,
        ) {
            val jsonEncoder =
...
public fun billingBillResourceInvoicingLinesParentsInvoiceLineItemSubscriptionItemParent(
    block: BillingBillResourceInvoicingLinesParentsInvoiceLineItemSubscriptionItemParent.Builder.() -> Unit,
): BillingBillResourceInvoicingLinesParentsInvoiceLineItemSubscriptionItemParent =
    BillingBillResourceInvoicingLinesParentsInvoiceLineItemSubscriptionItemParent.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "BillingBillResourceInvoicingLinesParentsInvoiceLineItemSubscriptionItemParent is missing required property '" +
                    name +
                    "'",
            )
