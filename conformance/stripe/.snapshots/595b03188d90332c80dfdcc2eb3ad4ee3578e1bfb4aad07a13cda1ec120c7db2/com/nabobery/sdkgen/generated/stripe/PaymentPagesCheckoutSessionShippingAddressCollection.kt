...
@Serializable
public data class PaymentPagesCheckoutSessionShippingAddressCollectionView(
...
public class PaymentPagesCheckoutSessionShippingAddressCollection(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentPagesCheckoutSessionShippingAddressCollection =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentPagesCheckoutSessionShippingAddressCollection> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "PaymentPagesCheckoutSessionShippingAddressCollection must be a JSON object",
                    )
            val allowedCountries =
                json.decodeRequired<List<InlinePaymentPagesCheckout32bcAllowedCountriesItemX19abb46f>>(
                    rawObject,
                    "allowed_countries",
                )
            return PaymentPagesCheckoutSessionShippingAddressCollection(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentPagesCheckoutSessionShippingAddressCollection,
        ) {
...
public fun paymentPagesCheckoutSessionShippingAddressCollection(
    block: PaymentPagesCheckoutSessionShippingAddressCollection.Builder.() -> Unit,
): PaymentPagesCheckoutSessionShippingAddressCollection =
    PaymentPagesCheckoutSessionShippingAddressCollection.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "PaymentPagesCheckoutSessionShippingAddressCollection is missing required property '" + name + "'",
            )
