...
public class InlineV1CustomersSubscriptionsPostRequestFormItemsItemPriceDataX814be096(
    ...
    public val taxBehavior: InlineV1CustomersSubscriptionsPostRequestFormItemsItemTaxBehaviorXf442fcef? = null,
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1CustomersSubscriptionsPostRequestFormItemsItemPriceDataX814be096 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1CustomersSubscriptionsPostRequestFormItemsItemPriceDataX814be096> {
        override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1CustomersSubscriptionsPostRequestFormItemsItemPriceDataX814be096 {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CustomersSubscriptionsPostRequestFormItemsItemPriceDataX814be096 must be a JSON object",
                    )
            val currency = json.decodeRequired<String>(rawObject, "currency")
            val product = json.decodeRequired<String>(rawObject, "product")
            val recurring =
                json.decodeRequired<InlineV1CustomersSubscriptionsPostRequestFormItemsItemRecurringX259a09ea>(
                    rawObject,
                    "recurring",
                )
            return InlineV1CustomersSubscriptionsPostRequestFormItemsItemPriceDataX814be096(
                ...
                taxBehavior =
                    rawObject["tax_behavior"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CustomersSubscriptionsPostRequestFormItemsItemTaxBehaviorXf442fcef>(
                                it,
                            )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersSubscriptionsPostRequestFormItemsItemPriceDataX814be096,
        ) {
            val jsonEncoder =
...
public fun inlineV1CustomersSubscriptionsPostRequestFormItemsItemPriceDataX814be096(
    block: InlineV1CustomersSubscriptionsPostRequestFormItemsItemPriceDataX814be096.Builder.() -> Unit,
): InlineV1CustomersSubscriptionsPostRequestFormItemsItemPriceDataX814be096 =
    InlineV1CustomersSubscriptionsPostRequestFormItemsItemPriceDataX814be096.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1CustomersSubscriptionsPostRequestFormItemsItemPriceDataX814be096 is missing required property '" +
                    name +
                    "'",
            )
