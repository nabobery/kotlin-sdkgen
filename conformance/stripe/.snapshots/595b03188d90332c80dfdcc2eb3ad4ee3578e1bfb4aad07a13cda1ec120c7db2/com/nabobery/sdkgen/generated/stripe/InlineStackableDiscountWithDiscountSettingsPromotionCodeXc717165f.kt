...
public class InlineStackableDiscountWithDiscountSettingsPromotionCodeXc717165f internal constructor(
    ...
    private val inspection: InlineStackableDiscountWithDiscountSettingsPromotionCodeXc717165fInspection,
) {
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineStackableDiscountWithDiscountSettingsPromotionCodeXc717165fBranch.Branch1,
                    )
                }
                if (inspection.matchesPromotionCode) {
                    add(
                        InlineStackableDiscountWithDiscountSettingsPromotionCodeXc717165fBranch.PromotionCode,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineStackableDiscountWithDiscountSettingsPromotionCodeXc717165f {
            val inspection = inspectInlineStackableDiscountWithDiscountSettingsPromotionCodeXc717165f(raw)
            if (inspection.matchCount == 0) {
                throw InlineStackableDiscountWithDiscountSettingsPromotionCodeXc717165fNoMatchException(
                    "InlineStackableDiscountWithDiscountSettingsPromotionCodeXc717165f matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineStackableDiscountWithDiscountSettingsPromotionCodeXc717165f> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineStackableDiscountWithDiscountSettingsPromotionCodeXc717165f,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineStackableDiscountWithDiscountSettingsPromotionCodeXc717165f",
...
private fun inspectInlineStackableDiscountWithDiscountSettingsPromotionCodeXc717165f(
    element: JsonElement,
