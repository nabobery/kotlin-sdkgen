...
public sealed class InlineCustomerTaxAutomaticTaxXf3aec264 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineCustomerTaxAutomaticTaxXf3aec264 =
            when (value) {
                Failed.value -> Failed
    ...
    public object Serializer : KSerializer<InlineCustomerTaxAutomaticTaxXf3aec264> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineCustomerTaxAutomaticTaxXf3aec264",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineCustomerTaxAutomaticTaxXf3aec264 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineCustomerTaxAutomaticTaxXf3aec264,
        ) {
