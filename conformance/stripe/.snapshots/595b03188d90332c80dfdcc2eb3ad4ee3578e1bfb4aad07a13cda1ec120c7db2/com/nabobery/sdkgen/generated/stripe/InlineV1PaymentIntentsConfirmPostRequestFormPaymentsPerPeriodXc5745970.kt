...
internal data class InlineV1PaymentIntentsConfirmPostRequestFormPaymentsPerPeriodXc5745970Inspection(
    ...
    public val matchesInlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2Xdde8cc73: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2Xdde8cc73,
            ).count {
                it
            }
}
...
public class InlineV1PaymentIntentsConfirmPostRequestFormPaymentsPerPeriodXc5745970 internal constructor(
    ...
    private val inspection: InlineV1PaymentIntentsConfirmPostRequestFormPaymentsPerPeriodXc5745970Inspection,
) {
    ...
    public val inlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2Xdde8cc73:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2Xdde8cc73) {
                json
                    .decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2Xdde8cc73>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1PaymentIntentsConfirmPostRequestFormPaymentsPerPeriodXc5745970Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2Xdde8cc73) {
                    add(
                        InlineV1PaymentIntentsConfirmPostRequestFormPaymentsPerPeriodXc5745970Branch.InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2Xdde8cc73,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1PaymentIntentsConfirmPostRequestFormPaymentsPerPeriodXc5745970 {
            val inspection = inspectInlineV1PaymentIntentsConfirmPostRequestFormPaymentsPerPeriodXc5745970(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1PaymentIntentsConfirmPostRequestFormPaymentsPerPeriodXc5745970NoMatchException(
                    "InlineV1PaymentIntentsConfirmPostRequestFormPaymentsPerPeriodXc5745970 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsConfirmPostRequestFormPaymentsPerPeriodXc5745970> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsConfirmPostRequestFormPaymentsPerPeriodXc5745970,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1PaymentIntentsConfirmPostRequestFormPaymentsPerPeriodXc5745970",
...
private fun inspectInlineV1PaymentIntentsConfirmPostRequestFormPaymentsPerPeriodXc5745970(
    element: JsonElement,
): InlineV1PaymentIntentsConfirmPostRequestFormPaymentsPerPeriodXc5745970Inspection {
    val matchesBranch1 = element.isJsonDecodable<Int>()
    val matchesInlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2Xdde8cc73 =
        element
            .isJsonDecodable<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2Xdde8cc73>()
    return InlineV1PaymentIntentsConfirmPostRequestFormPaymentsPerPeriodXc5745970Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2Xdde8cc73) {
                    add(
                        "InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2Xdde8cc73: value does not match InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2Xdde8cc73",
                    )
                }
            },
    )
