...
public class InlineV1BillingCreditBalanceSummaryGetParameterX60ba0d7a(
    ...
    public val applicabilityScope: InlineV1BillingCreditBalanceSummaryGetParameterApplicabilityScopeXb4505030? = null,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1BillingCreditBalanceSummaryGetParameterX60ba0d7a =
    ...
    public object Serializer : KSerializer<InlineV1BillingCreditBalanceSummaryGetParameterX60ba0d7a> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1BillingCreditBalanceSummaryGetParameterX60ba0d7a must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineV1BillingCreditBalanceSummaryGetParameterTypeX3dbbbde3>(
                    rawObject,
                    "type",
                )
            return InlineV1BillingCreditBalanceSummaryGetParameterX60ba0d7a(
                type = type,
                applicabilityScope =
                    rawObject["applicability_scope"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1BillingCreditBalanceSummaryGetParameterApplicabilityScopeXb4505030>(
                                it,
                            )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1BillingCreditBalanceSummaryGetParameterX60ba0d7a,
        ) {
...
public fun inlineV1BillingCreditBalanceSummaryGetParameterX60ba0d7a(
    block: InlineV1BillingCreditBalanceSummaryGetParameterX60ba0d7a.Builder.() -> Unit,
): InlineV1BillingCreditBalanceSummaryGetParameterX60ba0d7a =
    InlineV1BillingCreditBalanceSummaryGetParameterX60ba0d7a.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1BillingCreditBalanceSummaryGetParameterX60ba0d7a is missing required property '" + name + "'",
            )
