...
internal data class InlineV1TerminalConfigurationsPostRequestFormVerifoneP630SplashscreenX79af0e46Inspection(
    ...
    public val matchesInlineV1TerminalConfigurationsPostRequestFormVerifoneP630AnyOf1AnyOf2Xfd133b67: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1TerminalConfigurationsPostRequestFormVerifoneP630AnyOf1AnyOf2Xfd133b67,
            ).count {
                it
            }
}
...
public class InlineV1TerminalConfigurationsPostRequestFormVerifoneP630SplashscreenX79af0e46 internal constructor(
    ...
    private val inspection: InlineV1TerminalConfigurationsPostRequestFormVerifoneP630SplashscreenX79af0e46Inspection,
) {
    ...
    public val inlineV1TerminalConfigurationsPostRequestFormVerifoneP630AnyOf1AnyOf2Xfd133b67:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1TerminalConfigurationsPostRequestFormVerifoneP630AnyOf1AnyOf2Xfd133b67) {
                json
                    .decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormVerifoneP630AnyOf1AnyOf2Xfd133b67>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1TerminalConfigurationsPostRequestFormVerifoneP630SplashscreenX79af0e46Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1TerminalConfigurationsPostRequestFormVerifoneP630AnyOf1AnyOf2Xfd133b67) {
                    add(
                        InlineV1TerminalConfigurationsPostRequestFormVerifoneP630SplashscreenX79af0e46Branch.InlineV1TerminalConfigurationsPostRequestFormVerifoneP630AnyOf1AnyOf2Xfd133b67,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1TerminalConfigurationsPostRequestFormVerifoneP630SplashscreenX79af0e46 {
            val inspection = inspectInlineV1TerminalConfigurationsPostRequestFormVerifoneP630SplashscreenX79af0e46(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1TerminalConfigurationsPostRequestFormVerifoneP630SplashscreenX79af0e46NoMatchException(
                    "InlineV1TerminalConfigurationsPostRequestFormVerifoneP630SplashscreenX79af0e46 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1TerminalConfigurationsPostRequestFormVerifoneP630SplashscreenX79af0e46> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TerminalConfigurationsPostRequestFormVerifoneP630SplashscreenX79af0e46,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1TerminalConfigurationsPostRequestFormVerifoneP630SplashscreenX79af0e46",
...
private fun inspectInlineV1TerminalConfigurationsPostRequestFormVerifoneP630SplashscreenX79af0e46(
    element: JsonElement,
): InlineV1TerminalConfigurationsPostRequestFormVerifoneP630SplashscreenX79af0e46Inspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1TerminalConfigurationsPostRequestFormVerifoneP630AnyOf1AnyOf2Xfd133b67 =
        element
            .isJsonDecodable<InlineV1TerminalConfigurationsPostRequestFormVerifoneP630AnyOf1AnyOf2Xfd133b67>()
    return InlineV1TerminalConfigurationsPostRequestFormVerifoneP630SplashscreenX79af0e46Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1TerminalConfigurationsPostRequestFormVerifoneP630AnyOf1AnyOf2Xfd133b67) {
                    add(
                        "InlineV1TerminalConfigurationsPostRequestFormVerifoneP630AnyOf1AnyOf2Xfd133b67: value does not match InlineV1TerminalConfigurationsPostRequestFormVerifoneP630AnyOf1AnyOf2Xfd133b67",
                    )
                }
            },
    )
