...
public sealed class InlineV1AccountsPostRequestFormBusinessTypeX724dec40 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1AccountsPostRequestFormBusinessTypeX724dec40 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1AccountsPostRequestFormBusinessTypeX724dec40> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1AccountsPostRequestFormBusinessTypeX724dec40",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1AccountsPostRequestFormBusinessTypeX724dec40 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPostRequestFormBusinessTypeX724dec40,
        ) {
