...
public sealed class InlinePlatformEarningFeeSourceTypeXfde0079c {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePlatformEarningFeeSourceTypeXfde0079c =
            when (value) {
                Charge.value -> Charge
                Payout.value -> Payout
    ...
    public object Serializer : KSerializer<InlinePlatformEarningFeeSourceTypeXfde0079c> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePlatformEarningFeeSourceTypeXfde0079c",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePlatformEarningFeeSourceTypeXfde0079c =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePlatformEarningFeeSourceTypeXfde0079c,
        ) {
