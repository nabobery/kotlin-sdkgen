...
public class CurrencyOption(
    ...
    public class Builder {
        ...
        public fun build(): CurrencyOption =
            CurrencyOption(
    ...
    public object Serializer : KSerializer<CurrencyOption> {
        ...
        override fun deserialize(decoder: Decoder): CurrencyOption {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("CurrencyOption must be a JSON object")
                ...
                customUnitAmount =
                    rawObject["custom_unit_amount"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineCurrencyOptionCustomUnitAmountXb002e49e?>(element)
                        }
                    },
                taxBehavior =
                    rawObject["tax_behavior"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineCurrencyOptionTaxBehaviorX674b7e80?>(element)
                        }
                    },
