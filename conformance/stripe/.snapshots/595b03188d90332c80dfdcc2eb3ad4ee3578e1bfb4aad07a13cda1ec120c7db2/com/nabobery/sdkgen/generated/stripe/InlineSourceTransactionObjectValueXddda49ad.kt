...
public sealed class InlineSourceTransactionObjectValueXddda49ad {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineSourceTransactionObjectValueXddda49ad =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineSourceTransactionObjectValueXddda49ad> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineSourceTransactionObjectValueXddda49ad",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineSourceTransactionObjectValueXddda49ad =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineSourceTransactionObjectValueXddda49ad,
        ) {
