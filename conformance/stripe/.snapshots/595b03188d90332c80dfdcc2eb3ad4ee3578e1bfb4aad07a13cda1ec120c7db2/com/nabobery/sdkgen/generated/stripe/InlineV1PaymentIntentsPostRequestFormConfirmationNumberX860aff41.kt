...
internal data class InlineV1PaymentIntentsPostRequestFormConfirmationNumberX860aff41Inspection(
    ...
    public val matchesInlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKonbiniAnyOf2Xaa744b08: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKonbiniAnyOf2Xaa744b08,
            ).count {
                it
            }
}
...
public class InlineV1PaymentIntentsPostRequestFormConfirmationNumberX860aff41 internal constructor(
    ...
    private val inspection: InlineV1PaymentIntentsPostRequestFormConfirmationNumberX860aff41Inspection,
) {
    ...
    public val inlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKonbiniAnyOf2Xaa744b08:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKonbiniAnyOf2Xaa744b08) {
                json
                    .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKonbiniAnyOf2Xaa744b08>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1PaymentIntentsPostRequestFormConfirmationNumberX860aff41Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKonbiniAnyOf2Xaa744b08) {
                    add(
                        InlineV1PaymentIntentsPostRequestFormConfirmationNumberX860aff41Branch.InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKonbiniAnyOf2Xaa744b08,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1PaymentIntentsPostRequestFormConfirmationNumberX860aff41 {
            val inspection = inspectInlineV1PaymentIntentsPostRequestFormConfirmationNumberX860aff41(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1PaymentIntentsPostRequestFormConfirmationNumberX860aff41NoMatchException(
                    "InlineV1PaymentIntentsPostRequestFormConfirmationNumberX860aff41 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormConfirmationNumberX860aff41> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormConfirmationNumberX860aff41,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1PaymentIntentsPostRequestFormConfirmationNumberX860aff41",
...
private fun inspectInlineV1PaymentIntentsPostRequestFormConfirmationNumberX860aff41(
    element: JsonElement,
): InlineV1PaymentIntentsPostRequestFormConfirmationNumberX860aff41Inspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKonbiniAnyOf2Xaa744b08 =
        element
            .isJsonDecodable<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKonbiniAnyOf2Xaa744b08>()
    return InlineV1PaymentIntentsPostRequestFormConfirmationNumberX860aff41Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKonbiniAnyOf2Xaa744b08) {
                    add(
                        "InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKonbiniAnyOf2Xaa744b08: value does not match InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKonbiniAnyOf2Xaa744b08",
                    )
                }
            },
    )
