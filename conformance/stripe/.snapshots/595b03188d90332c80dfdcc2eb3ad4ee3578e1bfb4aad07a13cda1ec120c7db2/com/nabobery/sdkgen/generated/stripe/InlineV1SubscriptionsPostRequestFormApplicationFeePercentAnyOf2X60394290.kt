...
public sealed class InlineV1SubscriptionsPostRequestFormApplicationFeePercentAnyOf2X60394290 {
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionsPostRequestFormApplicationFeePercentAnyOf2X60394290> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1SubscriptionsPostRequestFormApplicationFeePercentAnyOf2X60394290",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1SubscriptionsPostRequestFormApplicationFeePercentAnyOf2X60394290 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsPostRequestFormApplicationFeePercentAnyOf2X60394290,
        ) {
