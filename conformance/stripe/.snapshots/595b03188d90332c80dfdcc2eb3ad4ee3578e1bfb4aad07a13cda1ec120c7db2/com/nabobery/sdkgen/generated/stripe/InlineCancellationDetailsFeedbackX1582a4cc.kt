...
public sealed class InlineCancellationDetailsFeedbackX1582a4cc {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineCancellationDetailsFeedbackX1582a4cc =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineCancellationDetailsFeedbackX1582a4cc> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineCancellationDetailsFeedbackX1582a4cc",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineCancellationDetailsFeedbackX1582a4cc =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineCancellationDetailsFeedbackX1582a4cc,
        ) {
