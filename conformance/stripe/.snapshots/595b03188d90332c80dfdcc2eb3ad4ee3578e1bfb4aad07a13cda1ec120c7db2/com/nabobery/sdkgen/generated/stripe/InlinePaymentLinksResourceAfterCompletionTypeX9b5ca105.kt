...
public sealed class InlinePaymentLinksResourceAfterCompletionTypeX9b5ca105 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentLinksResourceAfterCompletionTypeX9b5ca105 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlinePaymentLinksResourceAfterCompletionTypeX9b5ca105> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentLinksResourceAfterCompletionTypeX9b5ca105",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePaymentLinksResourceAfterCompletionTypeX9b5ca105 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentLinksResourceAfterCompletionTypeX9b5ca105,
        ) {
