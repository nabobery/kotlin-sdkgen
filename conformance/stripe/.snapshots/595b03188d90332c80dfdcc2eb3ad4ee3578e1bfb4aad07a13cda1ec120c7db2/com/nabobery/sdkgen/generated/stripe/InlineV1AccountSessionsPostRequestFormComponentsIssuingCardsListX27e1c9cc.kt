...
public class InlineV1AccountSessionsPostRequestFormComponentsIssuingCardsListX27e1c9cc(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1AccountSessionsPostRequestFormComponentsIssuingCardsListX27e1c9cc = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1AccountSessionsPostRequestFormComponentsIssuingCardsListX27e1c9cc> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountSessionsPostRequestFormComponentsIssuingCardsListX27e1c9cc must be a JSON object",
                    )
            ...
            return InlineV1AccountSessionsPostRequestFormComponentsIssuingCardsListX27e1c9cc(
                ...
                features =
                    rawObject["features"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountSessionsPostRequestFormComponentsFeaturesX62de23c2>(
                            it,
                        )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountSessionsPostRequestFormComponentsIssuingCardsListX27e1c9cc,
        ) {
            val jsonEncoder =
...
public fun inlineV1AccountSessionsPostRequestFormComponentsIssuingCardsListX27e1c9cc(
    block: InlineV1AccountSessionsPostRequestFormComponentsIssuingCardsListX27e1c9cc.Builder.() -> Unit,
): InlineV1AccountSessionsPostRequestFormComponentsIssuingCardsListX27e1c9cc =
    InlineV1AccountSessionsPostRequestFormComponentsIssuingCardsListX27e1c9cc.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1AccountSessionsPostRequestFormComponentsIssuingCardsListX27e1c9cc is missing required property '" +
                    name +
                    "'",
            )
