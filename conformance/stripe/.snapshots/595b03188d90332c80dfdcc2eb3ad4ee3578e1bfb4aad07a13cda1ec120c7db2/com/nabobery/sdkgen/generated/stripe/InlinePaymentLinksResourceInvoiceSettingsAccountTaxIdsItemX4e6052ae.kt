...
public class InlinePaymentLinksResourceInvoiceSettingsAccountTaxIdsItemX4e6052ae internal constructor(
    ...
    private val inspection: InlinePaymentLinksResourceInvoiceSettingsAccountTaxIdsItemX4e6052aeInspection,
) {
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlinePaymentLinksResourceInvoiceSettingsAccountTaxIdsItemX4e6052aeBranch.Branch1,
                    )
                }
                if (inspection.matchesTaxId) {
                    add(
                        InlinePaymentLinksResourceInvoiceSettingsAccountTaxIdsItemX4e6052aeBranch.TaxId,
                    )
                }
                if (inspection.matchesDeletedTaxId) {
                    add(
                        InlinePaymentLinksResourceInvoiceSettingsAccountTaxIdsItemX4e6052aeBranch.DeletedTaxId,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlinePaymentLinksResourceInvoiceSettingsAccountTaxIdsItemX4e6052ae {
            val inspection = inspectInlinePaymentLinksResourceInvoiceSettingsAccountTaxIdsItemX4e6052ae(raw)
            if (inspection.matchCount == 0) {
                throw InlinePaymentLinksResourceInvoiceSettingsAccountTaxIdsItemX4e6052aeNoMatchException(
                    "InlinePaymentLinksResourceInvoiceSettingsAccountTaxIdsItemX4e6052ae matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlinePaymentLinksResourceInvoiceSettingsAccountTaxIdsItemX4e6052ae> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentLinksResourceInvoiceSettingsAccountTaxIdsItemX4e6052ae,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlinePaymentLinksResourceInvoiceSettingsAccountTaxIdsItemX4e6052ae",
...
private fun inspectInlinePaymentLinksResourceInvoiceSettingsAccountTaxIdsItemX4e6052ae(
    element: JsonElement,
