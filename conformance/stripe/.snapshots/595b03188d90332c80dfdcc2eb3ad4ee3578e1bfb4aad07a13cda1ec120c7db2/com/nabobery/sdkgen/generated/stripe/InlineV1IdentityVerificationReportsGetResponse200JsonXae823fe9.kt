...
public class InlineV1IdentityVerificationReportsGetResponse200JsonXae823fe9(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1IdentityVerificationReportsGetResponse200JsonXae823fe9 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1IdentityVerificationReportsGetResponse200JsonXae823fe9> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1IdentityVerificationReportsGetResponse200JsonXae823fe9 {
            val jsonDecoder =
                decoder.requireJsonDecoder(
                    "InlineV1IdentityVerificationReportsGetResponse200JsonXae823fe9",
                )
            val json = jsonDecoder.json
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1IdentityVerificationReportsGetResponse200JsonXae823fe9 must be a JSON object",
                    )
            ...
            val objectValue =
                json.decodeRequired<InlineV1IdentityVerificationReportsGetResponse200JsonObjectValueX9d3fc029>(
                    rawObject,
                    "object",
                )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IdentityVerificationReportsGetResponse200JsonXae823fe9,
        ) {
            val jsonEncoder =
...
public fun inlineV1IdentityVerificationReportsGetResponse200JsonXae823fe9(
    block: InlineV1IdentityVerificationReportsGetResponse200JsonXae823fe9.Builder.() -> Unit,
): InlineV1IdentityVerificationReportsGetResponse200JsonXae823fe9 =
    InlineV1IdentityVerificationReportsGetResponse200JsonXae823fe9.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1IdentityVerificationReportsGetResponse200JsonXae823fe9 is missing required property '" + name +
                    "'",
            )
