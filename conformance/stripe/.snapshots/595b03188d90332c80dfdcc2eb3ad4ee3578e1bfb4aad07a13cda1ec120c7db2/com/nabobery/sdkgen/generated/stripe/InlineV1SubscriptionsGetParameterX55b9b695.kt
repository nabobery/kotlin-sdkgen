...
public class InlineV1SubscriptionsGetParameterX55b9b695 internal constructor(
    ...
    public val inlineV1SubscriptionsGetParameterAnyOf1Xd468d51c:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1SubscriptionsGetParameterAnyOf1Xd468d51c) {
                json
                    .decodeFromJsonElement<InlineV1SubscriptionsGetParameterAnyOf1Xd468d51c>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1SubscriptionsGetParameterX55b9b695Branch>
        get() =
            buildSet {
                if (inspection.matchesInlineV1SubscriptionsGetParameterAnyOf1Xd468d51c) {
                    add(
                        InlineV1SubscriptionsGetParameterX55b9b695Branch.InlineV1SubscriptionsGetParameterAnyOf1Xd468d51c,
                    )
                }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1SubscriptionsGetParameterX55b9b695 {
            val inspection = inspectInlineV1SubscriptionsGetParameterX55b9b695(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1SubscriptionsGetParameterX55b9b695NoMatchException(
                    "InlineV1SubscriptionsGetParameterX55b9b695 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionsGetParameterX55b9b695> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsGetParameterX55b9b695,
        ) {
...
private fun inspectInlineV1SubscriptionsGetParameterX55b9b695(
    element: JsonElement,
): InlineV1SubscriptionsGetParameterX55b9b695Inspection {
    val matchesInlineV1SubscriptionsGetParameterAnyOf1Xd468d51c =
        element
            .isJsonDecodable<InlineV1SubscriptionsGetParameterAnyOf1Xd468d51c>()
    ...
    return InlineV1SubscriptionsGetParameterX55b9b695Inspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1SubscriptionsGetParameterAnyOf1Xd468d51c) {
                    add(
                        "InlineV1SubscriptionsGetParameterAnyOf1Xd468d51c: value does not match InlineV1SubscriptionsGetParameterAnyOf1Xd468d51c",
                    )
                }
