...
public class InlineQuotesResourceUpfrontLineItemsX66509c0b(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineQuotesResourceUpfrontLineItemsX66509c0b =
    ...
    public object Serializer : KSerializer<InlineQuotesResourceUpfrontLineItemsX66509c0b> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineQuotesResourceUpfrontLineItemsX66509c0b must be a JSON object",
                    )
            val data = json.decodeRequired<List<Item>>(rawObject, "data")
            val hasMore = json.decodeRequired<Boolean>(rawObject, "has_more")
            val objectValue =
                json.decodeRequired<InlineQuotesResourceUpfrontLineItemsObjectValueXa78ccfd7>(
                    rawObject,
                    "object",
                )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineQuotesResourceUpfrontLineItemsX66509c0b,
        ) {
...
public fun inlineQuotesResourceUpfrontLineItemsX66509c0b(
    block: InlineQuotesResourceUpfrontLineItemsX66509c0b.Builder.() -> Unit,
): InlineQuotesResourceUpfrontLineItemsX66509c0b = InlineQuotesResourceUpfrontLineItemsX66509c0b.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineQuotesResourceUpfrontLineItemsX66509c0b is missing required property '" + name + "'",
            )
