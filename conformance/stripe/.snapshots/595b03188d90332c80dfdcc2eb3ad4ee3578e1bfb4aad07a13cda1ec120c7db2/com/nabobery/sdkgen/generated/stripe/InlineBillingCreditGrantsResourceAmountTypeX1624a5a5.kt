...
public sealed class InlineBillingCreditGrantsResourceAmountTypeX1624a5a5 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineBillingCreditGrantsResourceAmountTypeX1624a5a5 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineBillingCreditGrantsResourceAmountTypeX1624a5a5> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineBillingCreditGrantsResourceAmountTypeX1624a5a5",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineBillingCreditGrantsResourceAmountTypeX1624a5a5 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineBillingCreditGrantsResourceAmountTypeX1624a5a5,
        ) {
