...
public class InlineV1PaymentMethodConfidc49PostRequestFormDisplayPreferenceX0f56f24f(
    public val preference: InlineV1PaymentMethodConfidc49PostRequestFormAuBecsDebitPreferenceXe1f6c7f5? = null,
) {
    public class Builder {
        public var preference:
            InlineV1PaymentMethodConfidc49PostRequestFormAuBecsDebitPreferenceXe1f6c7f5? = null

        public fun build(): InlineV1PaymentMethodConfidc49PostRequestFormDisplayPreferenceX0f56f24f =
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentMethodConfidc49PostRequestFormDisplayPreferenceX0f56f24f = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1PaymentMethodConfidc49PostRequestFormDisplayPreferenceX0f56f24f> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentMethodConfidc49PostRequestFormDisplayPreferenceX0f56f24f must be a JSON object",
                    )
            return InlineV1PaymentMethodConfidc49PostRequestFormDisplayPreferenceX0f56f24f(
                preference =
                    rawObject["preference"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentMethodConfidc49PostRequestFormAuBecsDebitPreferenceXe1f6c7f5>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentMethodConfidc49PostRequestFormDisplayPreferenceX0f56f24f,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentMethodConfidc49PostRequestFormDisplayPreferenceX0f56f24f(
    block: InlineV1PaymentMethodConfidc49PostRequestFormDisplayPreferenceX0f56f24f.Builder.() -> Unit,
): InlineV1PaymentMethodConfidc49PostRequestFormDisplayPreferenceX0f56f24f =
    InlineV1PaymentMethodConfidc49PostRequestFormDisplayPreferenceX0f56f24f.build(block)
