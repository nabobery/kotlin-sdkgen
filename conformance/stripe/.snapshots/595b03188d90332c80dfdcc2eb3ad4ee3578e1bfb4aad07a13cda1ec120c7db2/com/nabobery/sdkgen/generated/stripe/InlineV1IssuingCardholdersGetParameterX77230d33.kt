...
public sealed class InlineV1IssuingCardholdersGetParameterX77230d33 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1IssuingCardholdersGetParameterX77230d33 =
            when (value) {
                Active.value -> Active
    ...
    public object Serializer : KSerializer<InlineV1IssuingCardholdersGetParameterX77230d33> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1IssuingCardholdersGetParameterX77230d33",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1IssuingCardholdersGetParameterX77230d33 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingCardholdersGetParameterX77230d33,
        ) {
