...
public sealed class InlineV1PaymentIntentsConfirmPostRequestFormPurchaseIntervalX0f0f48e2 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1PaymentIntentsConfirmPostRequestFormPurchaseIntervalX0f0f48e2 =
            when (value) {
                Day.value -> Day
                Month.value -> Month
                Week.value -> Week
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsConfirmPostRequestFormPurchaseIntervalX0f0f48e2> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1PaymentIntentsConfirmPostRequestFormPurchaseIntervalX0f0f48e2",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1PaymentIntentsConfirmPostRequestFormPurchaseIntervalX0f0f48e2 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsConfirmPostRequestFormPurchaseIntervalX0f0f48e2,
        ) {
