...
public class IssuingAuthorizationFleetCardholderPromptData(
    ...
    public class Builder {
        ...
        public fun build(): IssuingAuthorizationFleetCardholderPromptData =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): IssuingAuthorizationFleetCardholderPromptData =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<IssuingAuthorizationFleetCardholderPromptData> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "IssuingAuthorizationFleetCardholderPromptData must be a JSON object",
                    )
            return IssuingAuthorizationFleetCardholderPromptData(
                alphanumericId =
                    rawObject["alphanumeric_id"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: IssuingAuthorizationFleetCardholderPromptData,
        ) {
...
public fun issuingAuthorizationFleetCardholderPromptData(
    block: IssuingAuthorizationFleetCardholderPromptData.Builder.() -> Unit,
): IssuingAuthorizationFleetCardholderPromptData = IssuingAuthorizationFleetCardholderPromptData.build(block)
