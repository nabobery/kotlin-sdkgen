...
internal data class InlineV1PaymentIntentsIncra167PostRequestFormFromPostalCodeX4147c65eInspection(
    ...
    public val matchesInlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsAnyOf2X8b5ce614: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsAnyOf2X8b5ce614,
            ).count {
                it
            }
}
...
public class InlineV1PaymentIntentsIncra167PostRequestFormFromPostalCodeX4147c65e internal constructor(
    ...
    private val inspection: InlineV1PaymentIntentsIncra167PostRequestFormFromPostalCodeX4147c65eInspection,
) {
    ...
    public val inlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsAnyOf2X8b5ce614:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsAnyOf2X8b5ce614) {
                json
                    .decodeFromJsonElement<InlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsAnyOf2X8b5ce614>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1PaymentIntentsIncra167PostRequestFormFromPostalCodeX4147c65eBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsAnyOf2X8b5ce614) {
                    add(
                        InlineV1PaymentIntentsIncra167PostRequestFormFromPostalCodeX4147c65eBranch.InlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsAnyOf2X8b5ce614,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1PaymentIntentsIncra167PostRequestFormFromPostalCodeX4147c65e {
            val inspection = inspectInlineV1PaymentIntentsIncra167PostRequestFormFromPostalCodeX4147c65e(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1PaymentIntentsIncra167PostRequestFormFromPostalCodeX4147c65eNoMatchException(
                    "InlineV1PaymentIntentsIncra167PostRequestFormFromPostalCodeX4147c65e matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsIncra167PostRequestFormFromPostalCodeX4147c65e> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsIncra167PostRequestFormFromPostalCodeX4147c65e,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1PaymentIntentsIncra167PostRequestFormFromPostalCodeX4147c65e",
...
private fun inspectInlineV1PaymentIntentsIncra167PostRequestFormFromPostalCodeX4147c65e(
    element: JsonElement,
): InlineV1PaymentIntentsIncra167PostRequestFormFromPostalCodeX4147c65eInspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsAnyOf2X8b5ce614 =
        element
            .isJsonDecodable<InlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsAnyOf2X8b5ce614>()
    return InlineV1PaymentIntentsIncra167PostRequestFormFromPostalCodeX4147c65eInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsAnyOf2X8b5ce614) {
                    add(
                        "InlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsAnyOf2X8b5ce614: value does not match InlineV1PaymentIntentsIncra167PostRequestFormAmountDetailsAnyOf2X8b5ce614",
                    )
                }
            },
    )
