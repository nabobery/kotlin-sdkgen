...
public class InlineV1TestHelpersConfirmafd4PostRequestFormRadarOptionsX6f32a450(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1TestHelpersConfirmafd4PostRequestFormRadarOptionsX6f32a450 =
            InlineV1TestHelpersConfirmafd4PostRequestFormRadarOptionsX6f32a450(
                session = session,
            )
    }
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1TestHelpersConfirmafd4PostRequestFormRadarOptionsX6f32a450 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1TestHelpersConfirmafd4PostRequestFormRadarOptionsX6f32a450> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TestHelpersConfirmafd4PostRequestFormRadarOptionsX6f32a450 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TestHelpersConfirmafd4PostRequestFormRadarOptionsX6f32a450,
        ) {
            val jsonEncoder =
...
public fun inlineV1TestHelpersConfirmafd4PostRequestFormRadarOptionsX6f32a450(
    block: InlineV1TestHelpersConfirmafd4PostRequestFormRadarOptionsX6f32a450.Builder.() -> Unit,
): InlineV1TestHelpersConfirmafd4PostRequestFormRadarOptionsX6f32a450 =
    InlineV1TestHelpersConfirmafd4PostRequestFormRadarOptionsX6f32a450.build(block)
