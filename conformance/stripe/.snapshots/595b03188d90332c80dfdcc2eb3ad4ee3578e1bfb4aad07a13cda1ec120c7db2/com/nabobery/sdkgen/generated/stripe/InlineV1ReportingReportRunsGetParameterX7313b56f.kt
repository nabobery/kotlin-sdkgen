...
public class InlineV1ReportingReportRunsGetParameterX7313b56f internal constructor(
    ...
    public val inlineV1ReportingReportRunsGetParameterAnyOf1X5ee8caf9:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1ReportingReportRunsGetParameterAnyOf1X5ee8caf9) {
                json
                    .decodeFromJsonElement<InlineV1ReportingReportRunsGetParameterAnyOf1X5ee8caf9>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1ReportingReportRunsGetParameterX7313b56fBranch>
        get() =
            buildSet {
                if (inspection.matchesInlineV1ReportingReportRunsGetParameterAnyOf1X5ee8caf9) {
                    add(
                        InlineV1ReportingReportRunsGetParameterX7313b56fBranch.InlineV1ReportingReportRunsGetParameterAnyOf1X5ee8caf9,
                    )
                }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1ReportingReportRunsGetParameterX7313b56f {
            val inspection = inspectInlineV1ReportingReportRunsGetParameterX7313b56f(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1ReportingReportRunsGetParameterX7313b56fNoMatchException(
                    "InlineV1ReportingReportRunsGetParameterX7313b56f matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1ReportingReportRunsGetParameterX7313b56f> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ReportingReportRunsGetParameterX7313b56f,
        ) {
...
private fun inspectInlineV1ReportingReportRunsGetParameterX7313b56f(
    element: JsonElement,
): InlineV1ReportingReportRunsGetParameterX7313b56fInspection {
    val matchesInlineV1ReportingReportRunsGetParameterAnyOf1X5ee8caf9 =
        element
            .isJsonDecodable<InlineV1ReportingReportRunsGetParameterAnyOf1X5ee8caf9>()
    ...
    return InlineV1ReportingReportRunsGetParameterX7313b56fInspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1ReportingReportRunsGetParameterAnyOf1X5ee8caf9) {
                    add(
                        "InlineV1ReportingReportRunsGetParameterAnyOf1X5ee8caf9: value does not match InlineV1ReportingReportRunsGetParameterAnyOf1X5ee8caf9",
                    )
                }
