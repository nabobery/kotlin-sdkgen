...
public class InlineConnectCollectionTransferDestinationX80ef6bc4 internal constructor(
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineConnectCollectionTransferDestinationX80ef6bc4 {
            val inspection = inspectInlineConnectCollectionTransferDestinationX80ef6bc4(raw)
            if (inspection.matchCount == 0) {
                throw InlineConnectCollectionTransferDestinationX80ef6bc4NoMatchException(
                    "InlineConnectCollectionTransferDestinationX80ef6bc4 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineConnectCollectionTransferDestinationX80ef6bc4> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineConnectCollectionTransferDestinationX80ef6bc4,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineConnectCollectionTransferDestinationX80ef6bc4",
...
private fun inspectInlineConnectCollectionTransferDestinationX80ef6bc4(
    element: JsonElement,
): InlineConnectCollectionTransferDestinationX80ef6bc4Inspection {
