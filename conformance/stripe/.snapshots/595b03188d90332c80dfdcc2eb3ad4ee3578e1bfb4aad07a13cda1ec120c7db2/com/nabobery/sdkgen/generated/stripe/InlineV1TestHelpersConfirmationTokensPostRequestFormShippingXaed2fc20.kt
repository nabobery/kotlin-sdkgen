...
public class InlineV1TestHelpersConfirmationTokensPostRequestFormShippingXaed2fc20(
    ...
    public val phone: InlineV1TestHelpersConfirmationTokensPostRequestFormShippingPhoneX9a0c4b3d? = null,
) {
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1TestHelpersConfirmationTokensPostRequestFormShippingXaed2fc20 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TestHelpersConfirmationTokensPostRequestFormShippingXaed2fc20> {
        override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1TestHelpersConfirmationTokensPostRequestFormShippingXaed2fc20 {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TestHelpersConfirmationTokensPostRequestFormShippingXaed2fc20 must be a JSON object",
                    )
            val address =
                json.decodeRequired<InlineV1TestHelpersConfirmationTokensPostRequestFormShippingAddressX7e882ad4>(
                    rawObject,
                    "address",
                )
            ...
            return InlineV1TestHelpersConfirmationTokensPostRequestFormShippingXaed2fc20(
                ...
                phone =
                    rawObject["phone"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TestHelpersConfirmationTokensPostRequestFormShippingPhoneX9a0c4b3d>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TestHelpersConfirmationTokensPostRequestFormShippingXaed2fc20,
        ) {
            val jsonEncoder =
...
public fun inlineV1TestHelpersConfirmationTokensPostRequestFormShippingXaed2fc20(
    block: InlineV1TestHelpersConfirmationTokensPostRequestFormShippingXaed2fc20.Builder.() -> Unit,
): InlineV1TestHelpersConfirmationTokensPostRequestFormShippingXaed2fc20 =
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TestHelpersConfirmationTokensPostRequestFormShippingXaed2fc20 is missing required property '" +
                    name +
                    "'",
            )
