...
public sealed class InlineV1PaymentIntentsPostRequestFormShippingAnyOf2X0bafd7fa {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1PaymentIntentsPostRequestFormShippingAnyOf2X0bafd7fa =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormShippingAnyOf2X0bafd7fa> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1PaymentIntentsPostRequestFormShippingAnyOf2X0bafd7fa",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1PaymentIntentsPostRequestFormShippingAnyOf2X0bafd7fa =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormShippingAnyOf2X0bafd7fa,
        ) {
