...
public class TerminalReaderReaderResourceTippingConfig(
    ...
    public class Builder {
        ...
        public fun build(): TerminalReaderReaderResourceTippingConfig =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): TerminalReaderReaderResourceTippingConfig =
    ...
    public object Serializer : KSerializer<TerminalReaderReaderResourceTippingConfig> {
        ...
        override fun deserialize(decoder: Decoder): TerminalReaderReaderResourceTippingConfig {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("TerminalReaderReaderResourceTippingConfig must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: TerminalReaderReaderResourceTippingConfig,
        ) {
...
public fun terminalReaderReaderResourceTippingConfig(
    block: TerminalReaderReaderResourceTippingConfig.Builder.() -> Unit,
): TerminalReaderReaderResourceTippingConfig = TerminalReaderReaderResourceTippingConfig.build(block)
