...
public class InlineV1TreasuryCreditReversalsPostRequestFormX88c5efff(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TreasuryCreditReversalsPostRequestFormX88c5efff =
    ...
    public object Serializer : KSerializer<InlineV1TreasuryCreditReversalsPostRequestFormX88c5efff> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TreasuryCreditReversalsPostRequestFormX88c5efff must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TreasuryCreditReversalsPostRequestFormX88c5efff,
        ) {
...
public fun inlineV1TreasuryCreditReversalsPostRequestFormX88c5efff(
    block: InlineV1TreasuryCreditReversalsPostRequestFormX88c5efff.Builder.() -> Unit,
): InlineV1TreasuryCreditReversalsPostRequestFormX88c5efff =
    InlineV1TreasuryCreditReversalsPostRequestFormX88c5efff.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TreasuryCreditReversalsPostRequestFormX88c5efff is missing required property '" + name + "'",
            )
