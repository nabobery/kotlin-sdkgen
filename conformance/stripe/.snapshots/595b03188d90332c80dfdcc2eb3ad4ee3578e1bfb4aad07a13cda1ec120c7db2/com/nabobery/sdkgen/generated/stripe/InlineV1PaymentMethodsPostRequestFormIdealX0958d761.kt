...
public class InlineV1PaymentMethodsPostRequestFormIdealX0958d761(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1PaymentMethodsPostRequestFormIdealX0958d761 =
            InlineV1PaymentMethodsPostRequestFormIdealX0958d761(
                bank = bank,
            )
    }

    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PaymentMethodsPostRequestFormIdealX0958d761 =
    ...
    public object Serializer : KSerializer<InlineV1PaymentMethodsPostRequestFormIdealX0958d761> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentMethodsPostRequestFormIdealX0958d761 must be a JSON object",
                    )
            return InlineV1PaymentMethodsPostRequestFormIdealX0958d761(
                bank =
                    rawObject["bank"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentMethodsPostRequestFormIdealBankX21bc80dc>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentMethodsPostRequestFormIdealX0958d761,
        ) {
...
public fun inlineV1PaymentMethodsPostRequestFormIdealX0958d761(
    block: InlineV1PaymentMethodsPostRequestFormIdealX0958d761.Builder.() -> Unit,
): InlineV1PaymentMethodsPostRequestFormIdealX0958d761 =
    InlineV1PaymentMethodsPostRequestFormIdealX0958d761.build(block)
