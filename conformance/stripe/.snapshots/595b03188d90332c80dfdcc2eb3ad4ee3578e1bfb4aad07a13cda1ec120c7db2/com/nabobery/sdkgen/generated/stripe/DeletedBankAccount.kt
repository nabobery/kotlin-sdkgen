        ...
        override fun deserialize(decoder: Decoder): DeletedBankAccount {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("DeletedBankAccount must be a JSON object")
...
public fun deletedBankAccount(block: DeletedBankAccount.Builder.() -> Unit): DeletedBankAccount =
    DeletedBankAccount.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("DeletedBankAccount is missing required property '" + name + "'")
