...
public class InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1X592f0bf6(
    public val mastercardCompliance: InlineV1DisputesPostRequestFormEvidenceMastercardComplianceX37cd8536? = null,
    public val visaCompellingEvidence3: InlineV1DisputesPostRequestFormEvidenceVisaCompellingEvidence3Xdfec3109? = null,
    public val visaCompliance: InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceVisaComplianceXa302ceb4? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1X592f0bf6 =
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1X592f0bf6 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1X592f0bf6> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1X592f0bf6 must be a JSON object",
                    )
            return InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1X592f0bf6(
                mastercardCompliance =
                    rawObject["mastercard_compliance"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1DisputesPostRequestFormEvidenceMastercardComplianceX37cd8536>(
                                it,
                            )
                    },
                visaCompellingEvidence3 =
                    rawObject["visa_compelling_evidence_3"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1DisputesPostRequestFormEvidenceVisaCompellingEvidence3Xdfec3109>(
                                it,
                            )
                    },
                visaCompliance =
                    rawObject["visa_compliance"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceVisaComplianceXa302ceb4>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1X592f0bf6,
        ) {
            val jsonEncoder =
...
public fun inlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1X592f0bf6(
    block: InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1X592f0bf6.Builder.() -> Unit,
): InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1X592f0bf6 =
    InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1X592f0bf6.build(block)
