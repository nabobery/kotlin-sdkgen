...
internal data class InlineV1AccountsPersonsPostRequestFormRelationshipPercentOwnershipXeddc122dInspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1AccountsPersonsPostRequestFormRelationshipAnyOf2X66b480a3,
            ).count { it }
}
...
public class InlineV1AccountsPersonsPostRequestFormRelationshipPercentOwnershipXeddc122d internal constructor(
    ...
    private val inspection: InlineV1AccountsPersonsPostRequestFormRelationshipPercentOwnershipXeddc122dInspection,
) {
    ...
    public val inlineV1AccountsPersonsPostRequestFormRelationshipAnyOf2X66b480a3:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1AccountsPersonsPostRequestFormRelationshipAnyOf2X66b480a3) {
                json
                    .decodeFromJsonElement<InlineV1AccountsPersonsPostRequestFormRelationshipAnyOf2X66b480a3>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1AccountsPersonsPostRequestFormRelationshipPercentOwnershipXeddc122dBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1AccountsPersonsPostRequestFormRelationshipAnyOf2X66b480a3) {
                    add(
                        InlineV1AccountsPersonsPostRequestFormRelationshipPercentOwnershipXeddc122dBranch.InlineV1AccountsPersonsPostRequestFormRelationshipAnyOf2X66b480a3,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1AccountsPersonsPostRequestFormRelationshipPercentOwnershipXeddc122d {
            val inspection = inspectInlineV1AccountsPersonsPostRequestFormRelationshipPercentOwnershipXeddc122d(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1AccountsPersonsPostRequestFormRelationshipPercentOwnershipXeddc122dNoMatchException(
                    "InlineV1AccountsPersonsPostRequestFormRelationshipPercentOwnershipXeddc122d matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1AccountsPersonsPostRequestFormRelationshipPercentOwnershipXeddc122d> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPersonsPostRequestFormRelationshipPercentOwnershipXeddc122d,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1AccountsPersonsPostRequestFormRelationshipPercentOwnershipXeddc122d",
...
private fun inspectInlineV1AccountsPersonsPostRequestFormRelationshipPercentOwnershipXeddc122d(
    element: JsonElement,
    ...
    val matchesInlineV1AccountsPersonsPostRequestFormRelationshipAnyOf2X66b480a3 =
        element
            .isJsonDecodable<InlineV1AccountsPersonsPostRequestFormRelationshipAnyOf2X66b480a3>()
    return InlineV1AccountsPersonsPostRequestFormRelationshipPercentOwnershipXeddc122dInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1AccountsPersonsPostRequestFormRelationshipAnyOf2X66b480a3) {
                    add(
                        "InlineV1AccountsPersonsPostRequestFormRelationshipAnyOf2X66b480a3: value does not match InlineV1AccountsPersonsPostRequestFormRelationshipAnyOf2X66b480a3",
                    )
                }
            },
    )
