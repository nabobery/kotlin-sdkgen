...
public sealed class InlineCreditNoteRefundTypeXc2c9b186 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineCreditNoteRefundTypeXc2c9b186 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineCreditNoteRefundTypeXc2c9b186> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineCreditNoteRefundTypeXc2c9b186",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineCreditNoteRefundTypeXc2c9b186 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineCreditNoteRefundTypeXc2c9b186,
        ) {
