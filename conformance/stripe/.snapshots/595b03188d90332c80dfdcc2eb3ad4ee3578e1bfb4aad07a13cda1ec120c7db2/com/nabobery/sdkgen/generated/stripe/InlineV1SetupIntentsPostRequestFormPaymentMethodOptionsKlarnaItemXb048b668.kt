...
public class InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsKlarnaItemXb048b668(
    public val interval: InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsKlarnaIntervalXaf08ea67,
    public val nextBilling: InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsNextBillingX9739f2b0,
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsKlarnaItemXb048b668 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsKlarnaItemXb048b668> {
        override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsKlarnaItemXb048b668 {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsKlarnaItemXb048b668 must be a JSON object",
                    )
            val interval =
                json
                    .decodeRequired<InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsKlarnaIntervalXaf08ea67>(
                        rawObject,
                        "interval",
                    )
            val nextBilling =
                json
                    .decodeRequired<InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsNextBillingX9739f2b0>(
                        rawObject,
                        "next_billing",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsKlarnaItemXb048b668,
        ) {
            val jsonEncoder =
...
public fun inlineV1SetupIntentsPostRequestFormPaymentMethodOptionsKlarnaItemXb048b668(
    block: InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsKlarnaItemXb048b668.Builder.() -> Unit,
): InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsKlarnaItemXb048b668 =
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsKlarnaItemXb048b668 is missing required property '" +
                    name +
                    "'",
            )
