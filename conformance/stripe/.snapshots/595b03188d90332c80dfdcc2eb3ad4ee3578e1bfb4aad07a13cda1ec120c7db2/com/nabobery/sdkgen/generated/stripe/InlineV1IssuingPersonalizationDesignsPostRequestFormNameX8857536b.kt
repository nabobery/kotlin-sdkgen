...
internal data class InlineV1IssuingPersonalizationDesignsPostRequestFormNameX8857536bInspection(
    ...
    public val matchesInlineV1IssuingPersonalizationDesignsPostRequestFormNameAnyOf2Xcf754b84: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1IssuingPersonalizationDesignsPostRequestFormNameAnyOf2Xcf754b84,
            ).count {
                it
            }
}
...
public class InlineV1IssuingPersonalizationDesignsPostRequestFormNameX8857536b internal constructor(
    ...
    private val inspection: InlineV1IssuingPersonalizationDesignsPostRequestFormNameX8857536bInspection,
) {
    ...
    public val inlineV1IssuingPersonalizationDesignsPostRequestFormNameAnyOf2Xcf754b84:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1IssuingPersonalizationDesignsPostRequestFormNameAnyOf2Xcf754b84) {
                json
                    .decodeFromJsonElement<InlineV1IssuingPersonalizationDesignsPostRequestFormNameAnyOf2Xcf754b84>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1IssuingPersonalizationDesignsPostRequestFormNameX8857536bBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1IssuingPersonalizationDesignsPostRequestFormNameAnyOf2Xcf754b84) {
                    add(
                        InlineV1IssuingPersonalizationDesignsPostRequestFormNameX8857536bBranch.InlineV1IssuingPersonalizationDesignsPostRequestFormNameAnyOf2Xcf754b84,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1IssuingPersonalizationDesignsPostRequestFormNameX8857536b {
            val inspection = inspectInlineV1IssuingPersonalizationDesignsPostRequestFormNameX8857536b(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1IssuingPersonalizationDesignsPostRequestFormNameX8857536bNoMatchException(
                    "InlineV1IssuingPersonalizationDesignsPostRequestFormNameX8857536b matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1IssuingPersonalizationDesignsPostRequestFormNameX8857536b> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingPersonalizationDesignsPostRequestFormNameX8857536b,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1IssuingPersonalizationDesignsPostRequestFormNameX8857536b",
...
private fun inspectInlineV1IssuingPersonalizationDesignsPostRequestFormNameX8857536b(
    element: JsonElement,
): InlineV1IssuingPersonalizationDesignsPostRequestFormNameX8857536bInspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1IssuingPersonalizationDesignsPostRequestFormNameAnyOf2Xcf754b84 =
        element
            .isJsonDecodable<InlineV1IssuingPersonalizationDesignsPostRequestFormNameAnyOf2Xcf754b84>()
    return InlineV1IssuingPersonalizationDesignsPostRequestFormNameX8857536bInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1IssuingPersonalizationDesignsPostRequestFormNameAnyOf2Xcf754b84) {
                    add(
                        "InlineV1IssuingPersonalizationDesignsPostRequestFormNameAnyOf2Xcf754b84: value does not match InlineV1IssuingPersonalizationDesignsPostRequestFormNameAnyOf2Xcf754b84",
                    )
                }
            },
    )
