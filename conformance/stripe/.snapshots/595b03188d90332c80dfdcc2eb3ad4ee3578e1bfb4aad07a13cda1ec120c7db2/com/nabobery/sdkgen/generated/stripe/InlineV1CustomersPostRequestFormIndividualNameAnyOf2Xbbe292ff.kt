...
public sealed class InlineV1CustomersPostRequestFormIndividualNameAnyOf2Xbbe292ff {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1CustomersPostRequestFormIndividualNameAnyOf2Xbbe292ff =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1CustomersPostRequestFormIndividualNameAnyOf2Xbbe292ff> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1CustomersPostRequestFormIndividualNameAnyOf2Xbbe292ff",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1CustomersPostRequestFormIndividualNameAnyOf2Xbbe292ff =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersPostRequestFormIndividualNameAnyOf2Xbbe292ff,
        ) {
