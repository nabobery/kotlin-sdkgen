...
public class GelatoProvidedDetails(
    ...
    public class Builder {
        ...
        public fun build(): GelatoProvidedDetails =
        ...
        override fun deserialize(decoder: Decoder): GelatoProvidedDetails {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("GelatoProvidedDetails must be a JSON object")
...
public fun gelatoProvidedDetails(block: GelatoProvidedDetails.Builder.() -> Unit): GelatoProvidedDetails =
    GelatoProvidedDetails.build(block)
