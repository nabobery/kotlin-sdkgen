...
public class InlineV1AccountSessionsPostRequestFormComponentsIssuingCardFeaturesX11adaa6e(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1AccountSessionsPostRequestFormComponentsIssuingCardFeaturesX11adaa6e =
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1AccountSessionsPostRequestFormComponentsIssuingCardFeaturesX11adaa6e = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1AccountSessionsPostRequestFormComponentsIssuingCardFeaturesX11adaa6e> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountSessionsPostRequestFormComponentsIssuingCardFeaturesX11adaa6e must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountSessionsPostRequestFormComponentsIssuingCardFeaturesX11adaa6e,
        ) {
            val jsonEncoder =
...
public fun inlineV1AccountSessionsPostRequestFormComponentsIssuingCardFeaturesX11adaa6e(
    block: InlineV1AccountSessionsPostRequestFormComponentsIssuingCardFeaturesX11adaa6e.Builder.() -> Unit,
): InlineV1AccountSessionsPostRequestFormComponentsIssuingCardFeaturesX11adaa6e =
    InlineV1AccountSessionsPostRequestFormComponentsIssuingCardFeaturesX11adaa6e.build(block)
