...
public class LineItem(
     ...
     */
    public val discountAmounts: List<DiscountsResourceDiscountAmount>? = null,
    /**
     ...
     */
    public val pretaxCreditAmounts: List<InvoicesResourcePretaxCreditAmount>? = null,
    /**
     ...
     */
    public val taxes: List<BillingBillResourceInvoicingTaxesTax>? = null,
) {
    /**
    ...
    public class Builder {
         ...
         * The amount of discount calculated per discount for this line item.
         */
        public var discountAmounts: List<DiscountsResourceDiscountAmount>? = null
         ...
         * Contains pretax credit amounts (ex: discount, credit grants, etc) that apply to this line item.
         */
        public var pretaxCreditAmounts: List<InvoicesResourcePretaxCreditAmount>? = null
         ...
         * The tax information of the line item.
         */
        public var taxes: List<BillingBillResourceInvoicingTaxesTax>? = null
    ...
    public object Serializer : KSerializer<LineItem> {
        ...
        override fun deserialize(decoder: Decoder): LineItem {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("LineItem must be a JSON object")
            ...
            return LineItem(
                ...
                discountAmounts =
                    rawObject["discount_amounts"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                parent =
                    rawObject["parent"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineLineItemParentX36380c91?>(element)
                        }
                    },
                pretaxCreditAmounts =
                    rawObject["pretax_credit_amounts"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                pricing =
                    rawObject["pricing"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineLineItemPricingX2cc3399a?>(element)
                        }
                    },
                quantity =
                ...
                quantityDecimal =
                    rawObject["quantity_decimal"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                subscription =
                    rawObject["subscription"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineLineItemSubscriptionX73f0eb42?>(element)
                        }
                    },
                taxes =
                    rawObject["taxes"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
