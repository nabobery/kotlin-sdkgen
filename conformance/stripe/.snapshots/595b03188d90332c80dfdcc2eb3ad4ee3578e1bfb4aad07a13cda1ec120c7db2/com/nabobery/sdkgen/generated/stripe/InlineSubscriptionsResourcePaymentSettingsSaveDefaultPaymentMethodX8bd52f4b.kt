...
public sealed class InlineSubscriptionsResourcePaymentSettingsSaveDefaultPaymentMethodX8bd52f4b {
    ...
    public object Serializer : KSerializer<InlineSubscriptionsResourcePaymentSettingsSaveDefaultPaymentMethodX8bd52f4b> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineSubscriptionsResourcePaymentSettingsSaveDefaultPaymentMethodX8bd52f4b",
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineSubscriptionsResourcePaymentSettingsSaveDefaultPaymentMethodX8bd52f4b,
        ) {
