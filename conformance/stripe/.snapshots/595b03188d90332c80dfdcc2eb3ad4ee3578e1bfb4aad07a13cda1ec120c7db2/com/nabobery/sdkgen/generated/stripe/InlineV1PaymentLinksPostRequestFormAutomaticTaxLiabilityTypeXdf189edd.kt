...
public sealed class InlineV1PaymentLinksPostRequestFormAutomaticTaxLiabilityTypeXdf189edd {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1PaymentLinksPostRequestFormAutomaticTaxLiabilityTypeXdf189edd =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1PaymentLinksPostRequestFormAutomaticTaxLiabilityTypeXdf189edd> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1PaymentLinksPostRequestFormAutomaticTaxLiabilityTypeXdf189edd",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1PaymentLinksPostRequestFormAutomaticTaxLiabilityTypeXdf189edd = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentLinksPostRequestFormAutomaticTaxLiabilityTypeXdf189edd,
        ) {
