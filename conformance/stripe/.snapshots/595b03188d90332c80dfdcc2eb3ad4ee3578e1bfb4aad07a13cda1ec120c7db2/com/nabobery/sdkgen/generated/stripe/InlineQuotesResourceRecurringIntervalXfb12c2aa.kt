...
public sealed class InlineQuotesResourceRecurringIntervalXfb12c2aa {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineQuotesResourceRecurringIntervalXfb12c2aa =
            when (value) {
                Day.value -> Day
                Month.value -> Month
                Week.value -> Week
    ...
    public object Serializer : KSerializer<InlineQuotesResourceRecurringIntervalXfb12c2aa> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineQuotesResourceRecurringIntervalXfb12c2aa",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineQuotesResourceRecurringIntervalXfb12c2aa =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineQuotesResourceRecurringIntervalXfb12c2aa,
        ) {
