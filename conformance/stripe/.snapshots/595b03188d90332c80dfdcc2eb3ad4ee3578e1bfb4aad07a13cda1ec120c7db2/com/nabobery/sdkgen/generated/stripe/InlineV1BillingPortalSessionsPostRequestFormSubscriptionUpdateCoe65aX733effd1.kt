...
public class InlineV1BillingPortalSessionsPostRequestFormSubscriptionUpdateCoe65aX733effd1(
    ...
    public val discounts: List<InlineV1BillingPortalSessionsPostRequestFormFlowDataItemX85cb593c>? = null,
) {
    ...
    public object Serializer : KSerializer<InlineV1BillingPortalSessionsPostRequestFormSubscriptionUpdateCoe65aX733effd1> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1BillingPortalSessionsPostRequestFormSubscriptionUpdateCoe65aX733effd1 must be a JSON object",
                    )
            val items =
                json.decodeRequired<List<InlineV1BillingPortalSessionsPostRequestFormFlowDataItemXea2b2884>>(
                    rawObject,
                    "items",
                )
            ...
            return InlineV1BillingPortalSessionsPostRequestFormSubscriptionUpdateCoe65aX733effd1(
                ...
                discounts =
                    rawObject["discounts"]?.let {
                        json
                            .decodeFromJsonElement<List<InlineV1BillingPortalSessionsPostRequestFormFlowDataItemX85cb593c>>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1BillingPortalSessionsPostRequestFormSubscriptionUpdateCoe65aX733effd1,
        ) {
            val jsonEncoder =
...
public fun inlineV1BillingPortalSessionsPostRequestFormSubscriptionUpdateCoe65aX733effd1(
    block: InlineV1BillingPortalSessionsPostRequestFormSubscriptionUpdateCoe65aX733effd1.Builder.() -> Unit,
): InlineV1BillingPortalSessionsPostRequestFormSubscriptionUpdateCoe65aX733effd1 =
    InlineV1BillingPortalSessionsPostRequestFormSubscriptionUpdateCoe65aX733effd1.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1BillingPortalSessionsPostRequestFormSubscriptionUpdateCoe65aX733effd1 is missing required property '" +
                    name +
                    "'",
            )
