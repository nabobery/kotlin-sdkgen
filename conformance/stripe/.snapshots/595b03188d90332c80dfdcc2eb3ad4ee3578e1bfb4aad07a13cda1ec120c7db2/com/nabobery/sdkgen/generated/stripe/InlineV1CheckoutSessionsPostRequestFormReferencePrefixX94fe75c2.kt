...
internal data class InlineV1CheckoutSessionsPostRequestFormReferencePrefixX94fe75c2Inspection(
    ...
    public val matchesInlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsAnyOf2Xc07fc167: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsAnyOf2Xc07fc167,
            ).count {
                it
            }
}
...
public class InlineV1CheckoutSessionsPostRequestFormReferencePrefixX94fe75c2 internal constructor(
    ...
    public val inlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsAnyOf2Xc07fc167:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsAnyOf2Xc07fc167) {
                json
                    .decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsAnyOf2Xc07fc167>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1CheckoutSessionsPostRequestFormReferencePrefixX94fe75c2Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsAnyOf2Xc07fc167) {
                    add(
                        InlineV1CheckoutSessionsPostRequestFormReferencePrefixX94fe75c2Branch.InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsAnyOf2Xc07fc167,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1CheckoutSessionsPostRequestFormReferencePrefixX94fe75c2 {
            val inspection = inspectInlineV1CheckoutSessionsPostRequestFormReferencePrefixX94fe75c2(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1CheckoutSessionsPostRequestFormReferencePrefixX94fe75c2NoMatchException(
                    "InlineV1CheckoutSessionsPostRequestFormReferencePrefixX94fe75c2 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormReferencePrefixX94fe75c2> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsPostRequestFormReferencePrefixX94fe75c2,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1CheckoutSessionsPostRequestFormReferencePrefixX94fe75c2",
...
private fun inspectInlineV1CheckoutSessionsPostRequestFormReferencePrefixX94fe75c2(
    element: JsonElement,
): InlineV1CheckoutSessionsPostRequestFormReferencePrefixX94fe75c2Inspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsAnyOf2Xc07fc167 =
        element
            .isJsonDecodable<InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsAnyOf2Xc07fc167>()
    return InlineV1CheckoutSessionsPostRequestFormReferencePrefixX94fe75c2Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsAnyOf2Xc07fc167) {
                    add(
                        "InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsAnyOf2Xc07fc167: value does not match InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsAnyOf2Xc07fc167",
                    )
                }
            },
    )
