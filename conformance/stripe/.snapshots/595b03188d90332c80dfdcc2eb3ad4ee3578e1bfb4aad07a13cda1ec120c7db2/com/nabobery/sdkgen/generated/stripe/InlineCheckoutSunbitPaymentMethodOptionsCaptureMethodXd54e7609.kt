...
public sealed class InlineCheckoutSunbitPaymentMethodOptionsCaptureMethodXd54e7609 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineCheckoutSunbitPaymentMethodOptionsCaptureMethodXd54e7609 =
            when (value) {
                Manual.value -> Manual
    ...
    public object Serializer : KSerializer<InlineCheckoutSunbitPaymentMethodOptionsCaptureMethodXd54e7609> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineCheckoutSunbitPaymentMethodOptionsCaptureMethodXd54e7609",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineCheckoutSunbitPaymentMethodOptionsCaptureMethodXd54e7609 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineCheckoutSunbitPaymentMethodOptionsCaptureMethodXd54e7609,
        ) {
