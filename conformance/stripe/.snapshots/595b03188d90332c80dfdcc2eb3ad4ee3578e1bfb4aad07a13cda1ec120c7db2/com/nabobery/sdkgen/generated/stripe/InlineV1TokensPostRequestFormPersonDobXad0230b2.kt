...
internal data class InlineV1TokensPostRequestFormPersonDobXad0230b2Inspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesInlineV1TokensPostRequestFormPersonDobAnyOf1X0f55a961,
                matchesInlineV1TokensPostRequestFormPersonDobAnyOf2Xa57d37e6,
            ).count {
                it
            }
}
...
public class InlineV1TokensPostRequestFormPersonDobXad0230b2 internal constructor(
    ...
    public val inlineV1TokensPostRequestFormPersonDobAnyOf1X0f55a961:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1TokensPostRequestFormPersonDobAnyOf1X0f55a961) {
                json
                    .decodeFromJsonElement<InlineV1TokensPostRequestFormPersonDobAnyOf1X0f55a961>(
                        raw,
                    )
            } else {
                null
    ...
    public val inlineV1TokensPostRequestFormPersonDobAnyOf2Xa57d37e6:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1TokensPostRequestFormPersonDobAnyOf2Xa57d37e6) {
                json
                    .decodeFromJsonElement<InlineV1TokensPostRequestFormPersonDobAnyOf2Xa57d37e6>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1TokensPostRequestFormPersonDobXad0230b2Branch>
        get() =
            buildSet {
                if (inspection.matchesInlineV1TokensPostRequestFormPersonDobAnyOf1X0f55a961) {
                    add(
                        InlineV1TokensPostRequestFormPersonDobXad0230b2Branch.InlineV1TokensPostRequestFormPersonDobAnyOf1X0f55a961,
                    )
                }
                if (inspection.matchesInlineV1TokensPostRequestFormPersonDobAnyOf2Xa57d37e6) {
                    add(
                        InlineV1TokensPostRequestFormPersonDobXad0230b2Branch.InlineV1TokensPostRequestFormPersonDobAnyOf2Xa57d37e6,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1TokensPostRequestFormPersonDobXad0230b2 {
            val inspection = inspectInlineV1TokensPostRequestFormPersonDobXad0230b2(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1TokensPostRequestFormPersonDobXad0230b2NoMatchException(
                    "InlineV1TokensPostRequestFormPersonDobXad0230b2 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1TokensPostRequestFormPersonDobXad0230b2> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TokensPostRequestFormPersonDobXad0230b2,
        ) {
...
private fun inspectInlineV1TokensPostRequestFormPersonDobXad0230b2(
    element: JsonElement,
): InlineV1TokensPostRequestFormPersonDobXad0230b2Inspection {
    val matchesInlineV1TokensPostRequestFormPersonDobAnyOf1X0f55a961 =
        element
            .isJsonDecodable<InlineV1TokensPostRequestFormPersonDobAnyOf1X0f55a961>()
    val matchesInlineV1TokensPostRequestFormPersonDobAnyOf2Xa57d37e6 =
        element
            .isJsonDecodable<InlineV1TokensPostRequestFormPersonDobAnyOf2Xa57d37e6>()
    return InlineV1TokensPostRequestFormPersonDobXad0230b2Inspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1TokensPostRequestFormPersonDobAnyOf1X0f55a961) {
                    add(
                        "InlineV1TokensPostRequestFormPersonDobAnyOf1X0f55a961: value does not match InlineV1TokensPostRequestFormPersonDobAnyOf1X0f55a961",
                    )
                }
                if (!matchesInlineV1TokensPostRequestFormPersonDobAnyOf2Xa57d37e6) {
                    add(
                        "InlineV1TokensPostRequestFormPersonDobAnyOf2Xa57d37e6: value does not match InlineV1TokensPostRequestFormPersonDobAnyOf2Xa57d37e6",
                    )
                }
            },
    )
