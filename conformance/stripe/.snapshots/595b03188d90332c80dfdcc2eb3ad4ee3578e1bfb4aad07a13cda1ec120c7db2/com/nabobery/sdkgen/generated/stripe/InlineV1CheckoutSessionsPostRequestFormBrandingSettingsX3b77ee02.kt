...
public class InlineV1CheckoutSessionsPostRequestFormBrandingSettingsX3b77ee02(
    public val backgroundColor: InlineV1CheckoutSessionsPostRequestFormBrandingSettingsBackgroundColorXe6c9854b? = null,
    public val borderStyle: InlineV1CheckoutSessionsPostRequestFormBrandingSettingsBorderStyleXca1f0360? = null,
    public val buttonColor: InlineV1CheckoutSessionsPostRequestFormBrandingSettingsButtonColorXf250f03b? = null,
    public val displayName: String? = null,
    public val fontFamily: InlineV1CheckoutSessionsPostRequestFormBrandingSettingsFontFamilyX01aef6a2? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1CheckoutSessionsPostRequestFormBrandingSettingsX3b77ee02 =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1CheckoutSessionsPostRequestFormBrandingSettingsX3b77ee02 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormBrandingSettingsX3b77ee02> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CheckoutSessionsPostRequestFormBrandingSettingsX3b77ee02 must be a JSON object",
                    )
            return InlineV1CheckoutSessionsPostRequestFormBrandingSettingsX3b77ee02(
                backgroundColor =
                    rawObject["background_color"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormBrandingSettingsBackgroundColorXe6c9854b>(
                                it,
                            )
                    },
                borderStyle =
                    rawObject["border_style"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormBrandingSettingsBorderStyleXca1f0360>(
                                it,
                            )
                    },
                buttonColor =
                    rawObject["button_color"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormBrandingSettingsButtonColorXf250f03b>(
                                it,
                            )
                    },
                displayName = rawObject["display_name"]?.let { json.decodeFromJsonElement<String>(it) },
                fontFamily =
                    rawObject["font_family"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormBrandingSettingsFontFamilyX01aef6a2>(
                                it,
                            )
                    },
                icon =
                    rawObject["icon"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormBrandingSettingsIconX14815c80>(
                                it,
                            )
                    },
                logo =
                    rawObject["logo"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormBrandingSettingsLogoX29580067>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsPostRequestFormBrandingSettingsX3b77ee02,
        ) {
            val jsonEncoder =
...
public fun inlineV1CheckoutSessionsPostRequestFormBrandingSettingsX3b77ee02(
    block: InlineV1CheckoutSessionsPostRequestFormBrandingSettingsX3b77ee02.Builder.() -> Unit,
): InlineV1CheckoutSessionsPostRequestFormBrandingSettingsX3b77ee02 =
    InlineV1CheckoutSessionsPostRequestFormBrandingSettingsX3b77ee02.build(block)
