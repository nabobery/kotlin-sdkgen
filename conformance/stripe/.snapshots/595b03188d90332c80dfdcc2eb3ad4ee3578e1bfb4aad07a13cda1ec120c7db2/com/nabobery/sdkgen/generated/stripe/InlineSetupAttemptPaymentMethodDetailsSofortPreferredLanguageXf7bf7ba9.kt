...
public sealed class InlineSetupAttemptPaymentMethodDetailsSofortPreferredLanguageXf7bf7ba9 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineSetupAttemptPaymentMethodDetailsSofortPreferredLanguageXf7bf7ba9 =
            when (value) {
                De.value -> De
                En.value -> En
                Fr.value -> Fr
    ...
    public object Serializer : KSerializer<InlineSetupAttemptPaymentMethodDetailsSofortPreferredLanguageXf7bf7ba9> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineSetupAttemptPaymentMethodDetailsSofortPreferredLanguageXf7bf7ba9",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineSetupAttemptPaymentMethodDetailsSofortPreferredLanguageXf7bf7ba9 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineSetupAttemptPaymentMethodDetailsSofortPreferredLanguageXf7bf7ba9,
        ) {
