...
public sealed class InlineGelatoPhoneReportStatusX57a0ae0c {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineGelatoPhoneReportStatusX57a0ae0c =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineGelatoPhoneReportStatusX57a0ae0c> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineGelatoPhoneReportStatusX57a0ae0c",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineGelatoPhoneReportStatusX57a0ae0c =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineGelatoPhoneReportStatusX57a0ae0c,
        ) {
