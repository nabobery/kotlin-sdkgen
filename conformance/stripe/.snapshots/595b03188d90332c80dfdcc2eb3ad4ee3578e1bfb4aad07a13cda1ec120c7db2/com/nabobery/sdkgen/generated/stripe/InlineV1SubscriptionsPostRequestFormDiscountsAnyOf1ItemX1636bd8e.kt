...
public class InlineV1SubscriptionsPostRequestFormDiscountsAnyOf1ItemX1636bd8e(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1SubscriptionsPostRequestFormDiscountsAnyOf1ItemX1636bd8e =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1SubscriptionsPostRequestFormDiscountsAnyOf1ItemX1636bd8e =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1SubscriptionsPostRequestFormDiscountsAnyOf1ItemX1636bd8e> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SubscriptionsPostRequestFormDiscountsAnyOf1ItemX1636bd8e must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsPostRequestFormDiscountsAnyOf1ItemX1636bd8e,
        ) {
            val jsonEncoder =
...
public fun inlineV1SubscriptionsPostRequestFormDiscountsAnyOf1ItemX1636bd8e(
    block: InlineV1SubscriptionsPostRequestFormDiscountsAnyOf1ItemX1636bd8e.Builder.() -> Unit,
): InlineV1SubscriptionsPostRequestFormDiscountsAnyOf1ItemX1636bd8e =
    InlineV1SubscriptionsPostRequestFormDiscountsAnyOf1ItemX1636bd8e.build(block)
