...
public class InlineV1CheckoutSessionsPostRequestFormSubscriptionDataInvoiceSettingsX1a0222bd(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1CheckoutSessionsPostRequestFormSubscriptionDataInvoiceSettingsX1a0222bd =
            InlineV1CheckoutSessionsPostRequestFormSubscriptionDataInvoiceSettingsX1a0222bd(
                issuer = issuer,
            )
    }
    ...
    public object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormSubscriptionDataInvoiceSettingsX1a0222bd> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CheckoutSessionsPostRequestFormSubscriptionDataInvoiceSettingsX1a0222bd must be a JSON object",
                    )
            return InlineV1CheckoutSessionsPostRequestFormSubscriptionDataInvoiceSettingsX1a0222bd(
                issuer =
                    rawObject["issuer"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormSubscriptionDataIssuerX7945e170>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsPostRequestFormSubscriptionDataInvoiceSettingsX1a0222bd,
        ) {
            val jsonEncoder =
...
public fun inlineV1CheckoutSessionsPostRequestFormSubscriptionDataInvoiceSettingsX1a0222bd(
    block: InlineV1CheckoutSessionsPostRequestFormSubscriptionDataInvoiceSettingsX1a0222bd.Builder.() -> Unit,
): InlineV1CheckoutSessionsPostRequestFormSubscriptionDataInvoiceSettingsX1a0222bd =
