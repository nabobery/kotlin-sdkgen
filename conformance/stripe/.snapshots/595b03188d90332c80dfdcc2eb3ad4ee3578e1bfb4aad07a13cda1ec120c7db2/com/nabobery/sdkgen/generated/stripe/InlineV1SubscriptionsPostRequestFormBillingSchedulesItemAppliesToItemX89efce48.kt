...
public class InlineV1SubscriptionsPostRequestFormBillingSchedulesItemAppliesToItemX89efce48(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1SubscriptionsPostRequestFormBillingSchedulesItemAppliesToItemX89efce48 =
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionsPostRequestFormBillingSchedulesItemAppliesToItemX89efce48> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SubscriptionsPostRequestFormBillingSchedulesItemAppliesToItemX89efce48 must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineV1SubscriptionsPostRequestFormBillingSchedulesItemAppliesToTypeX1bb63529>(
                    rawObject,
                    "type",
                )
            return InlineV1SubscriptionsPostRequestFormBillingSchedulesItemAppliesToItemX89efce48(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsPostRequestFormBillingSchedulesItemAppliesToItemX89efce48,
        ) {
            val jsonEncoder =
...
public fun inlineV1SubscriptionsPostRequestFormBillingSchedulesItemAppliesToItemX89efce48(
    block: InlineV1SubscriptionsPostRequestFormBillingSchedulesItemAppliesToItemX89efce48.Builder.() -> Unit,
): InlineV1SubscriptionsPostRequestFormBillingSchedulesItemAppliesToItemX89efce48 =
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1SubscriptionsPostRequestFormBillingSchedulesItemAppliesToItemX89efce48 is missing required property '" +
                    name +
                    "'",
            )
