...
internal data class InlineV1TokensPostRequestFormPersonAdditionalTosAcceptancesUserAgentX941a863eInspection(
    ...
    public val matchesInlineV1TokensPostRequestFormPersonAdditionalTosAcceptancesAnyOf2X66cdb681: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1TokensPostRequestFormPersonAdditionalTosAcceptancesAnyOf2X66cdb681,
            ).count {
                it
            }
}
...
public class InlineV1TokensPostRequestFormPersonAdditionalTosAcceptancesUserAgentX941a863e internal constructor(
    ...
    private val inspection: InlineV1TokensPostRequestFormPersonAdditionalTosAcceptancesUserAgentX941a863eInspection,
) {
    ...
    public val inlineV1TokensPostRequestFormPersonAdditionalTosAcceptancesAnyOf2X66cdb681:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1TokensPostRequestFormPersonAdditionalTosAcceptancesAnyOf2X66cdb681) {
                json
                    .decodeFromJsonElement<InlineV1TokensPostRequestFormPersonAdditionalTosAcceptancesAnyOf2X66cdb681>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1TokensPostRequestFormPersonAdditionalTosAcceptancesUserAgentX941a863eBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1TokensPostRequestFormPersonAdditionalTosAcceptancesAnyOf2X66cdb681) {
                    add(
                        InlineV1TokensPostRequestFormPersonAdditionalTosAcceptancesUserAgentX941a863eBranch.InlineV1TokensPostRequestFormPersonAdditionalTosAcceptancesAnyOf2X66cdb681,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1TokensPostRequestFormPersonAdditionalTosAcceptancesUserAgentX941a863e {
            val inspection = inspectInlineV1TokensPostRequestFormPersonAdditionalTosAcceptancesUserAgentX941a863e(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1TokensPostRequestFormPersonAdditionalTosAcceptancesUserAgentX941a863eNoMatchException(
                    "InlineV1TokensPostRequestFormPersonAdditionalTosAcceptancesUserAgentX941a863e matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1TokensPostRequestFormPersonAdditionalTosAcceptancesUserAgentX941a863e> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TokensPostRequestFormPersonAdditionalTosAcceptancesUserAgentX941a863e,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1TokensPostRequestFormPersonAdditionalTosAcceptancesUserAgentX941a863e",
...
private fun inspectInlineV1TokensPostRequestFormPersonAdditionalTosAcceptancesUserAgentX941a863e(
    element: JsonElement,
): InlineV1TokensPostRequestFormPersonAdditionalTosAcceptancesUserAgentX941a863eInspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1TokensPostRequestFormPersonAdditionalTosAcceptancesAnyOf2X66cdb681 =
        element
            .isJsonDecodable<InlineV1TokensPostRequestFormPersonAdditionalTosAcceptancesAnyOf2X66cdb681>()
    return InlineV1TokensPostRequestFormPersonAdditionalTosAcceptancesUserAgentX941a863eInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1TokensPostRequestFormPersonAdditionalTosAcceptancesAnyOf2X66cdb681) {
                    add(
                        "InlineV1TokensPostRequestFormPersonAdditionalTosAcceptancesAnyOf2X66cdb681: value does not match InlineV1TokensPostRequestFormPersonAdditionalTosAcceptancesAnyOf2X66cdb681",
                    )
                }
            },
    )
