...
public sealed class InlinePaypalSellerProtectionStatusX8b3cff4a {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaypalSellerProtectionStatusX8b3cff4a =
            when (value) {
    ...
    public object Serializer : KSerializer<InlinePaypalSellerProtectionStatusX8b3cff4a> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaypalSellerProtectionStatusX8b3cff4a",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePaypalSellerProtectionStatusX8b3cff4a =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaypalSellerProtectionStatusX8b3cff4a,
        ) {
