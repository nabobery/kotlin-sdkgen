...
public class InlineV1TestHelpersTestClocksPostRequestFormX1ecbd05f(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TestHelpersTestClocksPostRequestFormX1ecbd05f =
    ...
    public object Serializer : KSerializer<InlineV1TestHelpersTestClocksPostRequestFormX1ecbd05f> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TestHelpersTestClocksPostRequestFormX1ecbd05f must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TestHelpersTestClocksPostRequestFormX1ecbd05f,
        ) {
...
public fun inlineV1TestHelpersTestClocksPostRequestFormX1ecbd05f(
    block: InlineV1TestHelpersTestClocksPostRequestFormX1ecbd05f.Builder.() -> Unit,
): InlineV1TestHelpersTestClocksPostRequestFormX1ecbd05f =
    InlineV1TestHelpersTestClocksPostRequestFormX1ecbd05f.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TestHelpersTestClocksPostRequestFormX1ecbd05f is missing required property '" + name + "'",
            )
