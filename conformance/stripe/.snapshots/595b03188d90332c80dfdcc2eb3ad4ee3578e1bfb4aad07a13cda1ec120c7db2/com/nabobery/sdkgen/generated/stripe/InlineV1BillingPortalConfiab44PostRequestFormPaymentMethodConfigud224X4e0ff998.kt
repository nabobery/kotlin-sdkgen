...
internal data class InlineV1BillingPortalConfiab44PostRequestFormPaymentMethodConfigud224X4e0ff998Inspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1BillingPortalConfiab44PostRequestFormFeaturesAnyOf2X2dcd45ff,
            ).count { it }
}
...
public class InlineV1BillingPortalConfiab44PostRequestFormPaymentMethodConfigud224X4e0ff998 internal constructor(
    ...
    private val inspection: InlineV1BillingPortalConfiab44PostRequestFormPaymentMethodConfigud224X4e0ff998Inspection,
) {
    ...
    public val inlineV1BillingPortalConfiab44PostRequestFormFeaturesAnyOf2X2dcd45ff:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1BillingPortalConfiab44PostRequestFormFeaturesAnyOf2X2dcd45ff) {
                json
                    .decodeFromJsonElement<InlineV1BillingPortalConfiab44PostRequestFormFeaturesAnyOf2X2dcd45ff>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1BillingPortalConfiab44PostRequestFormPaymentMethodConfigud224X4e0ff998Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1BillingPortalConfiab44PostRequestFormFeaturesAnyOf2X2dcd45ff) {
                    add(
                        InlineV1BillingPortalConfiab44PostRequestFormPaymentMethodConfigud224X4e0ff998Branch.InlineV1BillingPortalConfiab44PostRequestFormFeaturesAnyOf2X2dcd45ff,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1BillingPortalConfiab44PostRequestFormPaymentMethodConfigud224X4e0ff998 {
            val inspection = inspectInlineV1BillingPortalConfiab44PostRequestFormPaymentMethodConfigud224X4e0ff998(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1BillingPortalConfiab44PostRequestFormPaymentMethodConfigud224X4e0ff998NoMatchException(
                    "InlineV1BillingPortalConfiab44PostRequestFormPaymentMethodConfigud224X4e0ff998 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1BillingPortalConfiab44PostRequestFormPaymentMethodConfigud224X4e0ff998> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1BillingPortalConfiab44PostRequestFormPaymentMethodConfigud224X4e0ff998,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1BillingPortalConfiab44PostRequestFormPaymentMethodConfigud224X4e0ff998",
...
private fun inspectInlineV1BillingPortalConfiab44PostRequestFormPaymentMethodConfigud224X4e0ff998(
    element: JsonElement,
): InlineV1BillingPortalConfiab44PostRequestFormPaymentMethodConfigud224X4e0ff998Inspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1BillingPortalConfiab44PostRequestFormFeaturesAnyOf2X2dcd45ff =
        element
            .isJsonDecodable<InlineV1BillingPortalConfiab44PostRequestFormFeaturesAnyOf2X2dcd45ff>()
    return InlineV1BillingPortalConfiab44PostRequestFormPaymentMethodConfigud224X4e0ff998Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1BillingPortalConfiab44PostRequestFormFeaturesAnyOf2X2dcd45ff) {
                    add(
                        "InlineV1BillingPortalConfiab44PostRequestFormFeaturesAnyOf2X2dcd45ff: value does not match InlineV1BillingPortalConfiab44PostRequestFormFeaturesAnyOf2X2dcd45ff",
                    )
                }
            },
    )
