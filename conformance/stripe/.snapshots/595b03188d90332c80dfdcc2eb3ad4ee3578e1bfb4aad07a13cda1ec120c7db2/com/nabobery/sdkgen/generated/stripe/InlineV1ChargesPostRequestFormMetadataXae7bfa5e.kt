...
public class InlineV1ChargesPostRequestFormMetadataXae7bfa5e internal constructor(
    ...
    public val inlineV1ChargesPostRequestFormMetadataAnyOf2X8d04583c:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1ChargesPostRequestFormMetadataAnyOf2X8d04583c) {
                json
                    .decodeFromJsonElement<InlineV1ChargesPostRequestFormMetadataAnyOf2X8d04583c>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1ChargesPostRequestFormMetadataXae7bfa5eBranch>
        get() =
            buildSet {
                ...
                if (inspection.matchesInlineV1ChargesPostRequestFormMetadataAnyOf2X8d04583c) {
                    add(
                        InlineV1ChargesPostRequestFormMetadataXae7bfa5eBranch.InlineV1ChargesPostRequestFormMetadataAnyOf2X8d04583c,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1ChargesPostRequestFormMetadataXae7bfa5e {
            val inspection = inspectInlineV1ChargesPostRequestFormMetadataXae7bfa5e(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1ChargesPostRequestFormMetadataXae7bfa5eNoMatchException(
                    "InlineV1ChargesPostRequestFormMetadataXae7bfa5e matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1ChargesPostRequestFormMetadataXae7bfa5e> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ChargesPostRequestFormMetadataXae7bfa5e,
        ) {
...
private fun inspectInlineV1ChargesPostRequestFormMetadataXae7bfa5e(
    element: JsonElement,
): InlineV1ChargesPostRequestFormMetadataXae7bfa5eInspection {
    val matchesBranch1 = element.isJsonDecodable<JsonObject>()
    val matchesInlineV1ChargesPostRequestFormMetadataAnyOf2X8d04583c =
        element
            .isJsonDecodable<InlineV1ChargesPostRequestFormMetadataAnyOf2X8d04583c>()
    return InlineV1ChargesPostRequestFormMetadataXae7bfa5eInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1ChargesPostRequestFormMetadataAnyOf2X8d04583c) {
                    add(
                        "InlineV1ChargesPostRequestFormMetadataAnyOf2X8d04583c: value does not match InlineV1ChargesPostRequestFormMetadataAnyOf2X8d04583c",
                    )
                }
            },
    )
