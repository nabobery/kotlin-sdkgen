...
internal data class InlineV1AccountsPersonsPostRequestFormMetadataX57922428Inspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1AccountsPersonsPostRequestFormMetadataAnyOf2X942c1d6c,
            ).count { it }
}
...
public class InlineV1AccountsPersonsPostRequestFormMetadataX57922428 internal constructor(
    ...
    public val inlineV1AccountsPersonsPostRequestFormMetadataAnyOf2X942c1d6c:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1AccountsPersonsPostRequestFormMetadataAnyOf2X942c1d6c) {
                json
                    .decodeFromJsonElement<InlineV1AccountsPersonsPostRequestFormMetadataAnyOf2X942c1d6c>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1AccountsPersonsPostRequestFormMetadataX57922428Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1AccountsPersonsPostRequestFormMetadataAnyOf2X942c1d6c) {
                    add(
                        InlineV1AccountsPersonsPostRequestFormMetadataX57922428Branch.InlineV1AccountsPersonsPostRequestFormMetadataAnyOf2X942c1d6c,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1AccountsPersonsPostRequestFormMetadataX57922428 {
            val inspection = inspectInlineV1AccountsPersonsPostRequestFormMetadataX57922428(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1AccountsPersonsPostRequestFormMetadataX57922428NoMatchException(
                    "InlineV1AccountsPersonsPostRequestFormMetadataX57922428 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1AccountsPersonsPostRequestFormMetadataX57922428> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPersonsPostRequestFormMetadataX57922428,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1AccountsPersonsPostRequestFormMetadataX57922428",
...
private fun inspectInlineV1AccountsPersonsPostRequestFormMetadataX57922428(
    element: JsonElement,
): InlineV1AccountsPersonsPostRequestFormMetadataX57922428Inspection {
    val matchesBranch1 = element.isJsonDecodable<JsonObject>()
    val matchesInlineV1AccountsPersonsPostRequestFormMetadataAnyOf2X942c1d6c =
        element
            .isJsonDecodable<InlineV1AccountsPersonsPostRequestFormMetadataAnyOf2X942c1d6c>()
    return InlineV1AccountsPersonsPostRequestFormMetadataX57922428Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1AccountsPersonsPostRequestFormMetadataAnyOf2X942c1d6c) {
                    add(
                        "InlineV1AccountsPersonsPostRequestFormMetadataAnyOf2X942c1d6c: value does not match InlineV1AccountsPersonsPostRequestFormMetadataAnyOf2X942c1d6c",
                    )
                }
            },
    )
