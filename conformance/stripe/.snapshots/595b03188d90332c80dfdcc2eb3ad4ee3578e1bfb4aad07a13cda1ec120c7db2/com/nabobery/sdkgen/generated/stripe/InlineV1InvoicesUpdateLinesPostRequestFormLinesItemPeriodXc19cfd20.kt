...
public class InlineV1InvoicesUpdateLinesPostRequestFormLinesItemPeriodXc19cfd20(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1InvoicesUpdateLinesPostRequestFormLinesItemPeriodXc19cfd20 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1InvoicesUpdateLinesPostRequestFormLinesItemPeriodXc19cfd20> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1InvoicesUpdateLinesPostRequestFormLinesItemPeriodXc19cfd20 {
            val jsonDecoder =
                decoder.requireJsonDecoder(
                    "InlineV1InvoicesUpdateLinesPostRequestFormLinesItemPeriodXc19cfd20",
                )
            val json = jsonDecoder.json
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1InvoicesUpdateLinesPostRequestFormLinesItemPeriodXc19cfd20 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesUpdateLinesPostRequestFormLinesItemPeriodXc19cfd20,
        ) {
            val jsonEncoder =
...
public fun inlineV1InvoicesUpdateLinesPostRequestFormLinesItemPeriodXc19cfd20(
    block: InlineV1InvoicesUpdateLinesPostRequestFormLinesItemPeriodXc19cfd20.Builder.() -> Unit,
): InlineV1InvoicesUpdateLinesPostRequestFormLinesItemPeriodXc19cfd20 =
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1InvoicesUpdateLinesPostRequestFormLinesItemPeriodXc19cfd20 is missing required property '" +
                    name +
                    "'",
            )
