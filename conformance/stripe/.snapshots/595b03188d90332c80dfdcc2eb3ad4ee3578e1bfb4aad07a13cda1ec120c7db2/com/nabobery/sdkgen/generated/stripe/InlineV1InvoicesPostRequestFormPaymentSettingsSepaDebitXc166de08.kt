...
internal data class InlineV1InvoicesPostRequestFormPaymentSettingsSepaDebitXc166de08Inspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2X4eace1f4,
            ).count { it }
}
...
public class InlineV1InvoicesPostRequestFormPaymentSettingsSepaDebitXc166de08 internal constructor(
    ...
    private val inspection: InlineV1InvoicesPostRequestFormPaymentSettingsSepaDebitXc166de08Inspection,
) {
    ...
    public val inlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2X4eace1f4:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2X4eace1f4) {
                json
                    .decodeFromJsonElement<InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2X4eace1f4>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1InvoicesPostRequestFormPaymentSettingsSepaDebitXc166de08Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2X4eace1f4) {
                    add(
                        InlineV1InvoicesPostRequestFormPaymentSettingsSepaDebitXc166de08Branch.InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2X4eace1f4,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1InvoicesPostRequestFormPaymentSettingsSepaDebitXc166de08 {
            val inspection = inspectInlineV1InvoicesPostRequestFormPaymentSettingsSepaDebitXc166de08(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1InvoicesPostRequestFormPaymentSettingsSepaDebitXc166de08NoMatchException(
                    "InlineV1InvoicesPostRequestFormPaymentSettingsSepaDebitXc166de08 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1InvoicesPostRequestFormPaymentSettingsSepaDebitXc166de08> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesPostRequestFormPaymentSettingsSepaDebitXc166de08,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1InvoicesPostRequestFormPaymentSettingsSepaDebitXc166de08",
...
private fun inspectInlineV1InvoicesPostRequestFormPaymentSettingsSepaDebitXc166de08(
    element: JsonElement,
): InlineV1InvoicesPostRequestFormPaymentSettingsSepaDebitXc166de08Inspection {
    val matchesBranch1 = element.isJsonDecodable<JsonObject>()
    val matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2X4eace1f4 =
        element
            .isJsonDecodable<InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2X4eace1f4>()
    return InlineV1InvoicesPostRequestFormPaymentSettingsSepaDebitXc166de08Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2X4eace1f4) {
                    add(
                        "InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2X4eace1f4: value does not match InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2X4eace1f4",
                    )
                }
            },
    )
