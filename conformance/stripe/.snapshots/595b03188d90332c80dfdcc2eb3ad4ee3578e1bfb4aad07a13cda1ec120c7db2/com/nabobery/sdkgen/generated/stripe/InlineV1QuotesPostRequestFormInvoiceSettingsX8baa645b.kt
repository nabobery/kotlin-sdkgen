...
public class InlineV1QuotesPostRequestFormInvoiceSettingsX8baa645b(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1QuotesPostRequestFormInvoiceSettingsX8baa645b =
            InlineV1QuotesPostRequestFormInvoiceSettingsX8baa645b(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1QuotesPostRequestFormInvoiceSettingsX8baa645b =
    ...
    public object Serializer : KSerializer<InlineV1QuotesPostRequestFormInvoiceSettingsX8baa645b> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1QuotesPostRequestFormInvoiceSettingsX8baa645b must be a JSON object",
                    )
            return InlineV1QuotesPostRequestFormInvoiceSettingsX8baa645b(
                ...
                issuer =
                    rawObject["issuer"]?.let {
                        json.decodeFromJsonElement<InlineV1QuotesPostRequestFormInvoiceSettingsIssuerX75f72c4c>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1QuotesPostRequestFormInvoiceSettingsX8baa645b,
        ) {
...
public fun inlineV1QuotesPostRequestFormInvoiceSettingsX8baa645b(
    block: InlineV1QuotesPostRequestFormInvoiceSettingsX8baa645b.Builder.() -> Unit,
): InlineV1QuotesPostRequestFormInvoiceSettingsX8baa645b =
    InlineV1QuotesPostRequestFormInvoiceSettingsX8baa645b.build(block)
