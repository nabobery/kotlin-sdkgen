...
internal data class InlineV1SetupIntentsPostRequestFormMandateDataXcb5ac5a1Inspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesInlineV1SetupIntentsPostRequestFormMandateDataAnyOf1X7529a085,
                matchesInlineV1SetupIntentsPostRequestFormMandateDataAnyOf2X3822ccc3,
            ).count {
                it
            }
}
...
public class InlineV1SetupIntentsPostRequestFormMandateDataXcb5ac5a1 internal constructor(
    ...
    public val inlineV1SetupIntentsPostRequestFormMandateDataAnyOf1X7529a085:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1SetupIntentsPostRequestFormMandateDataAnyOf1X7529a085) {
                json
                    .decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormMandateDataAnyOf1X7529a085>(
                        raw,
                    )
            } else {
                null
    ...
    public val inlineV1SetupIntentsPostRequestFormMandateDataAnyOf2X3822ccc3:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1SetupIntentsPostRequestFormMandateDataAnyOf2X3822ccc3) {
                json
                    .decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormMandateDataAnyOf2X3822ccc3>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1SetupIntentsPostRequestFormMandateDataXcb5ac5a1Branch>
        get() =
            buildSet {
                if (inspection.matchesInlineV1SetupIntentsPostRequestFormMandateDataAnyOf1X7529a085) {
                    add(
                        InlineV1SetupIntentsPostRequestFormMandateDataXcb5ac5a1Branch.InlineV1SetupIntentsPostRequestFormMandateDataAnyOf1X7529a085,
                    )
                }
                if (inspection.matchesInlineV1SetupIntentsPostRequestFormMandateDataAnyOf2X3822ccc3) {
                    add(
                        InlineV1SetupIntentsPostRequestFormMandateDataXcb5ac5a1Branch.InlineV1SetupIntentsPostRequestFormMandateDataAnyOf2X3822ccc3,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1SetupIntentsPostRequestFormMandateDataXcb5ac5a1 {
            val inspection = inspectInlineV1SetupIntentsPostRequestFormMandateDataXcb5ac5a1(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1SetupIntentsPostRequestFormMandateDataXcb5ac5a1NoMatchException(
                    "InlineV1SetupIntentsPostRequestFormMandateDataXcb5ac5a1 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1SetupIntentsPostRequestFormMandateDataXcb5ac5a1> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SetupIntentsPostRequestFormMandateDataXcb5ac5a1,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1SetupIntentsPostRequestFormMandateDataXcb5ac5a1",
...
private fun inspectInlineV1SetupIntentsPostRequestFormMandateDataXcb5ac5a1(
    element: JsonElement,
): InlineV1SetupIntentsPostRequestFormMandateDataXcb5ac5a1Inspection {
    val matchesInlineV1SetupIntentsPostRequestFormMandateDataAnyOf1X7529a085 =
        element
            .isJsonDecodable<InlineV1SetupIntentsPostRequestFormMandateDataAnyOf1X7529a085>()
    val matchesInlineV1SetupIntentsPostRequestFormMandateDataAnyOf2X3822ccc3 =
        element
            .isJsonDecodable<InlineV1SetupIntentsPostRequestFormMandateDataAnyOf2X3822ccc3>()
    return InlineV1SetupIntentsPostRequestFormMandateDataXcb5ac5a1Inspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1SetupIntentsPostRequestFormMandateDataAnyOf1X7529a085) {
                    add(
                        "InlineV1SetupIntentsPostRequestFormMandateDataAnyOf1X7529a085: value does not match InlineV1SetupIntentsPostRequestFormMandateDataAnyOf1X7529a085",
                    )
                }
                if (!matchesInlineV1SetupIntentsPostRequestFormMandateDataAnyOf2X3822ccc3) {
                    add(
                        "InlineV1SetupIntentsPostRequestFormMandateDataAnyOf2X3822ccc3: value does not match InlineV1SetupIntentsPostRequestFormMandateDataAnyOf2X3822ccc3",
                    )
                }
            },
    )
