...
public sealed class InlineV1SubscriptionsPostRequestFormCollectionMethodX000dc0ad {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1SubscriptionsPostRequestFormCollectionMethodX000dc0ad =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionsPostRequestFormCollectionMethodX000dc0ad> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1SubscriptionsPostRequestFormCollectionMethodX000dc0ad",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1SubscriptionsPostRequestFormCollectionMethodX000dc0ad =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsPostRequestFormCollectionMethodX000dc0ad,
        ) {
