...
internal data class InlineV1AccountsPostRequestFormIndividualMetadataXbb2c33b3Inspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1AccountsPostRequestFormIndividualMetadataAnyOf2X81410a8c,
            ).count { it }
}
...
public class InlineV1AccountsPostRequestFormIndividualMetadataXbb2c33b3 internal constructor(
    ...
    public val inlineV1AccountsPostRequestFormIndividualMetadataAnyOf2X81410a8c:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1AccountsPostRequestFormIndividualMetadataAnyOf2X81410a8c) {
                json
                    .decodeFromJsonElement<InlineV1AccountsPostRequestFormIndividualMetadataAnyOf2X81410a8c>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1AccountsPostRequestFormIndividualMetadataXbb2c33b3Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1AccountsPostRequestFormIndividualMetadataAnyOf2X81410a8c) {
                    add(
                        InlineV1AccountsPostRequestFormIndividualMetadataXbb2c33b3Branch.InlineV1AccountsPostRequestFormIndividualMetadataAnyOf2X81410a8c,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1AccountsPostRequestFormIndividualMetadataXbb2c33b3 {
            val inspection = inspectInlineV1AccountsPostRequestFormIndividualMetadataXbb2c33b3(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1AccountsPostRequestFormIndividualMetadataXbb2c33b3NoMatchException(
                    "InlineV1AccountsPostRequestFormIndividualMetadataXbb2c33b3 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1AccountsPostRequestFormIndividualMetadataXbb2c33b3> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPostRequestFormIndividualMetadataXbb2c33b3,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1AccountsPostRequestFormIndividualMetadataXbb2c33b3",
...
private fun inspectInlineV1AccountsPostRequestFormIndividualMetadataXbb2c33b3(
    element: JsonElement,
): InlineV1AccountsPostRequestFormIndividualMetadataXbb2c33b3Inspection {
    val matchesBranch1 = element.isJsonDecodable<JsonObject>()
    val matchesInlineV1AccountsPostRequestFormIndividualMetadataAnyOf2X81410a8c =
        element
            .isJsonDecodable<InlineV1AccountsPostRequestFormIndividualMetadataAnyOf2X81410a8c>()
    return InlineV1AccountsPostRequestFormIndividualMetadataXbb2c33b3Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1AccountsPostRequestFormIndividualMetadataAnyOf2X81410a8c) {
                    add(
                        "InlineV1AccountsPostRequestFormIndividualMetadataAnyOf2X81410a8c: value does not match InlineV1AccountsPostRequestFormIndividualMetadataAnyOf2X81410a8c",
                    )
                }
            },
    )
