...
public class PaymentLinksResourceCustomFields(
    ...
    public object Serializer : KSerializer<PaymentLinksResourceCustomFields> {
        ...
        override fun deserialize(decoder: Decoder): PaymentLinksResourceCustomFields {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentLinksResourceCustomFields must be a JSON object")
            ...
            return PaymentLinksResourceCustomFields(
                ...
                dropdown =
                    rawObject["dropdown"]?.let {
                        json.decodeFromJsonElement<PaymentLinksResourceCustomFieldsDropdown>(
                            it,
                        )
                    },
                numeric =
                    rawObject["numeric"]?.let {
                        json
                            .decodeFromJsonElement<PaymentLinksResourceCustomFieldsNumeric>(
                                it,
                            )
                    },
                text = rawObject["text"]?.let {
                    json.decodeFromJsonElement<PaymentLinksResourceCustomFieldsText>(
                        it,
                    )
                },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentLinksResourceCustomFields,
        ) {
...
public fun paymentLinksResourceCustomFields(
    block: PaymentLinksResourceCustomFields.Builder.() -> Unit,
): PaymentLinksResourceCustomFields = PaymentLinksResourceCustomFields.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "PaymentLinksResourceCustomFields is missing required property '" + name + "'",
            )
