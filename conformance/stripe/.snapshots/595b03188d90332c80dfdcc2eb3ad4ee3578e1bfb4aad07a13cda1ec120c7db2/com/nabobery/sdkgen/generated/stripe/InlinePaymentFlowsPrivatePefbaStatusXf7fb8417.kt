...
public sealed class InlinePaymentFlowsPrivatePefbaStatusXf7fb8417 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentFlowsPrivatePefbaStatusXf7fb8417 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlinePaymentFlowsPrivatePefbaStatusXf7fb8417> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentFlowsPrivatePefbaStatusXf7fb8417",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePaymentFlowsPrivatePefbaStatusXf7fb8417 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentFlowsPrivatePefbaStatusXf7fb8417,
        ) {
