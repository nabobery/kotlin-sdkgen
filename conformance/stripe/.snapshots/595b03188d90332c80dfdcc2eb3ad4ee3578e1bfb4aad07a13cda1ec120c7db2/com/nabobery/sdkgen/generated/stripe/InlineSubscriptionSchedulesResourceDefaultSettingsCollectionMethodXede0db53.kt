...
public sealed class InlineSubscriptionSchedulesResourceDefaultSettingsCollectionMethodXede0db53 {
    ...
    public object Serializer : KSerializer<InlineSubscriptionSchedulesResourceDefaultSettingsCollectionMethodXede0db53> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineSubscriptionSchedulesResourceDefaultSettingsCollectionMethodXede0db53",
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineSubscriptionSchedulesResourceDefaultSettingsCollectionMethodXede0db53,
        ) {
