...
public data class PaymentPagesCheckoutSessionCollectedInformationView(
    ...
    public val shippingDetails: InlinePaymentPagesCheckoutSessionCollectedInformationShippingDetailsXd759f8a5? = null,
)
...
public class PaymentPagesCheckoutSessionCollectedInformation(
    ...
    public class Builder {
        ...
        public fun build(): PaymentPagesCheckoutSessionCollectedInformation =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentPagesCheckoutSessionCollectedInformation =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentPagesCheckoutSessionCollectedInformation> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "PaymentPagesCheckoutSessionCollectedInformation must be a JSON object",
                    )
                ...
                shippingDetails =
                    rawObject["shipping_details"]?.let { element ->
                        if (element ==
                            ...
                            json
                                .decodeFromJsonElement<InlinePaymentPagesCheckoutSessionCollectedInformationShippingDetailsXd759f8a5?>(
                                    element,
                                )
                        }
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentPagesCheckoutSessionCollectedInformation,
        ) {
...
public fun paymentPagesCheckoutSessionCollectedInformation(
    block: PaymentPagesCheckoutSessionCollectedInformation.Builder.() -> Unit,
): PaymentPagesCheckoutSessionCollectedInformation = PaymentPagesCheckoutSessionCollectedInformation.build(block)
