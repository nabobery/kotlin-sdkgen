...
public class InlinePayoutOriginalPayoutX84c88c4d internal constructor(
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlinePayoutOriginalPayoutX84c88c4d {
            val inspection = inspectInlinePayoutOriginalPayoutX84c88c4d(raw)
            if (inspection.matchCount == 0) {
                throw InlinePayoutOriginalPayoutX84c88c4dNoMatchException(
                    "InlinePayoutOriginalPayoutX84c88c4d matched 0 branches: " + inspection.failures.joinToString("; "),
                )
            }
    ...
    public object Serializer : KSerializer<InlinePayoutOriginalPayoutX84c88c4d> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlinePayoutOriginalPayoutX84c88c4d,
        ) {
...
private fun inspectInlinePayoutOriginalPayoutX84c88c4d(
    element: JsonElement,
): InlinePayoutOriginalPayoutX84c88c4dInspection {
