...
public class InlineTransferDataDestinationX26c08a9a internal constructor(
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineTransferDataDestinationX26c08a9a {
            val inspection = inspectInlineTransferDataDestinationX26c08a9a(raw)
            if (inspection.matchCount == 0) {
                throw InlineTransferDataDestinationX26c08a9aNoMatchException(
                    "InlineTransferDataDestinationX26c08a9a matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineTransferDataDestinationX26c08a9a> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineTransferDataDestinationX26c08a9a,
        ) {
...
private fun inspectInlineTransferDataDestinationX26c08a9a(
    element: JsonElement,
): InlineTransferDataDestinationX26c08a9aInspection {
