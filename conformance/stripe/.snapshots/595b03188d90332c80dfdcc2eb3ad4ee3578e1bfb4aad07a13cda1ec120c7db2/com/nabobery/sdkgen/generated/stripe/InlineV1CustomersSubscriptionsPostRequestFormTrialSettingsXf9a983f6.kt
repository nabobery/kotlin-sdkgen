...
public class InlineV1CustomersSubscriptionsPostRequestFormTrialSettingsXf9a983f6(
    public val endBehavior: InlineV1CustomersSubscriptionsPostRequestFormTrialSettingsEndBehaviorXb5ca0bde,
) {
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1CustomersSubscriptionsPostRequestFormTrialSettingsXf9a983f6 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1CustomersSubscriptionsPostRequestFormTrialSettingsXf9a983f6> {
        override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1CustomersSubscriptionsPostRequestFormTrialSettingsXf9a983f6 {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CustomersSubscriptionsPostRequestFormTrialSettingsXf9a983f6 must be a JSON object",
                    )
            val endBehavior =
                json
                    .decodeRequired<InlineV1CustomersSubscriptionsPostRequestFormTrialSettingsEndBehaviorXb5ca0bde>(
                        rawObject,
                        "end_behavior",
                    )
            return InlineV1CustomersSubscriptionsPostRequestFormTrialSettingsXf9a983f6(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersSubscriptionsPostRequestFormTrialSettingsXf9a983f6,
        ) {
            val jsonEncoder =
...
public fun inlineV1CustomersSubscriptionsPostRequestFormTrialSettingsXf9a983f6(
    block: InlineV1CustomersSubscriptionsPostRequestFormTrialSettingsXf9a983f6.Builder.() -> Unit,
): InlineV1CustomersSubscriptionsPostRequestFormTrialSettingsXf9a983f6 =
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1CustomersSubscriptionsPostRequestFormTrialSettingsXf9a983f6 is missing required property '" +
                    name +
                    "'",
            )
