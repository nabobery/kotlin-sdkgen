...
public class InlineV1CustomersCardsPostRequestFormX9790010b(
     ...
     */
    public val accountHolderType: InlineV1CustomersCardsPostRequestFormAccountHolderTypeXc989bc7b? = null,
    /**
    ...
    public class Builder {
        ...
        public fun build(): InlineV1CustomersCardsPostRequestFormX9790010b =
            InlineV1CustomersCardsPostRequestFormX9790010b(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1CustomersCardsPostRequestFormX9790010b =
    ...
    public object Serializer : KSerializer<InlineV1CustomersCardsPostRequestFormX9790010b> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CustomersCardsPostRequestFormX9790010b must be a JSON object",
                    )
            return InlineV1CustomersCardsPostRequestFormX9790010b(
                ...
                accountHolderType =
                    rawObject["account_holder_type"]?.let {
                        json.decodeFromJsonElement<InlineV1CustomersCardsPostRequestFormAccountHolderTypeXc989bc7b>(it)
                    },
                ...
                metadata =
                    rawObject["metadata"]?.let {
                        json.decodeFromJsonElement<InlineV1CustomersCardsPostRequestFormMetadataXa1d07878>(it)
                    },
                name = rawObject["name"]?.let { json.decodeFromJsonElement<String>(it) },
                owner =
                    rawObject["owner"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CustomersCardsPostRequestFormOwnerX29404a7d>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersCardsPostRequestFormX9790010b,
        ) {
...
public fun inlineV1CustomersCardsPostRequestFormX9790010b(
    block: InlineV1CustomersCardsPostRequestFormX9790010b.Builder.() -> Unit,
): InlineV1CustomersCardsPostRequestFormX9790010b = InlineV1CustomersCardsPostRequestFormX9790010b.build(block)
