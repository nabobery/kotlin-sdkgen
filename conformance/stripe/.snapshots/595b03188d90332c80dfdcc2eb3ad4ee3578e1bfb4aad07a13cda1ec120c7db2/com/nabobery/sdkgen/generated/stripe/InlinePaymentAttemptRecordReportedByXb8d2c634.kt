...
public sealed class InlinePaymentAttemptRecordReportedByXb8d2c634 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentAttemptRecordReportedByXb8d2c634 =
            when (value) {
                Self.value -> Self
                Stripe.value -> Stripe
    ...
    public object Serializer : KSerializer<InlinePaymentAttemptRecordReportedByXb8d2c634> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentAttemptRecordReportedByXb8d2c634",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePaymentAttemptRecordReportedByXb8d2c634 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentAttemptRecordReportedByXb8d2c634,
        ) {
