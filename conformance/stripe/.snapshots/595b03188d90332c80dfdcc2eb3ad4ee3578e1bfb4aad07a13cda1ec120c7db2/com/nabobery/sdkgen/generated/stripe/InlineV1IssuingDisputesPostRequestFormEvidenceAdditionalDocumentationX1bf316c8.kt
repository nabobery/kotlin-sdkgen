...
internal data class InlineV1IssuingDisputesPostRequestFormEvidenceAdditionalDocumentationX1bf316c8Inspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2Xb5de5b68,
            ).count { it }
}
...
public class InlineV1IssuingDisputesPostRequestFormEvidenceAdditionalDocumentationX1bf316c8 internal constructor(
    ...
    private val inspection: InlineV1IssuingDisputesPostRequestFormEvidenceAdditionalDocumentationX1bf316c8Inspection,
) {
    ...
    public val inlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2Xb5de5b68:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2Xb5de5b68) {
                json
                    .decodeFromJsonElement<InlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2Xb5de5b68>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1IssuingDisputesPostRequestFormEvidenceAdditionalDocumentationX1bf316c8Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2Xb5de5b68) {
                    add(
                        InlineV1IssuingDisputesPostRequestFormEvidenceAdditionalDocumentationX1bf316c8Branch.InlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2Xb5de5b68,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1IssuingDisputesPostRequestFormEvidenceAdditionalDocumentationX1bf316c8 {
            val inspection = inspectInlineV1IssuingDisputesPostRequestFormEvidenceAdditionalDocumentationX1bf316c8(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1IssuingDisputesPostRequestFormEvidenceAdditionalDocumentationX1bf316c8NoMatchException(
                    "InlineV1IssuingDisputesPostRequestFormEvidenceAdditionalDocumentationX1bf316c8 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1IssuingDisputesPostRequestFormEvidenceAdditionalDocumentationX1bf316c8> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingDisputesPostRequestFormEvidenceAdditionalDocumentationX1bf316c8,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1IssuingDisputesPostRequestFormEvidenceAdditionalDocumentationX1bf316c8",
...
private fun inspectInlineV1IssuingDisputesPostRequestFormEvidenceAdditionalDocumentationX1bf316c8(
    element: JsonElement,
): InlineV1IssuingDisputesPostRequestFormEvidenceAdditionalDocumentationX1bf316c8Inspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2Xb5de5b68 =
        element
            .isJsonDecodable<InlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2Xb5de5b68>()
    return InlineV1IssuingDisputesPostRequestFormEvidenceAdditionalDocumentationX1bf316c8Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2Xb5de5b68) {
                    add(
                        "InlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2Xb5de5b68: value does not match InlineV1IssuingDisputesPostRequestFormEvidenceAnyOf2Xb5de5b68",
                    )
                }
            },
    )
