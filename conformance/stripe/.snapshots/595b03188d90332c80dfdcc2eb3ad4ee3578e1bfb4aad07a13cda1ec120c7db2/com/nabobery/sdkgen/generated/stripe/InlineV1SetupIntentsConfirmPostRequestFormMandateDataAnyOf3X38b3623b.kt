...
public class InlineV1SetupIntentsConfirmPostRequestFormMandateDataAnyOf3X38b3623b(
    public val customerAcceptance: InlineV1SetupIntentsConfirmPostRequestFormMandateDataCustomerAcceptanceXcda42448,
) {
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1SetupIntentsConfirmPostRequestFormMandateDataAnyOf3X38b3623b = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1SetupIntentsConfirmPostRequestFormMandateDataAnyOf3X38b3623b> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SetupIntentsConfirmPostRequestFormMandateDataAnyOf3X38b3623b must be a JSON object",
                    )
            val customerAcceptance =
                json
                    .decodeRequired<InlineV1SetupIntentsConfirmPostRequestFormMandateDataCustomerAcceptanceXcda42448>(
                        rawObject,
                        "customer_acceptance",
                    )
            return InlineV1SetupIntentsConfirmPostRequestFormMandateDataAnyOf3X38b3623b(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SetupIntentsConfirmPostRequestFormMandateDataAnyOf3X38b3623b,
        ) {
            val jsonEncoder =
...
public fun inlineV1SetupIntentsConfirmPostRequestFormMandateDataAnyOf3X38b3623b(
    block: InlineV1SetupIntentsConfirmPostRequestFormMandateDataAnyOf3X38b3623b.Builder.() -> Unit,
): InlineV1SetupIntentsConfirmPostRequestFormMandateDataAnyOf3X38b3623b =
    InlineV1SetupIntentsConfirmPostRequestFormMandateDataAnyOf3X38b3623b.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1SetupIntentsConfirmPostRequestFormMandateDataAnyOf3X38b3623b is missing required property '" +
                    name +
                    "'",
            )
