...
public class InlineV1SourcesPostRequestFormSourceOrderShippingXaceed685(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1SourcesPostRequestFormSourceOrderShippingXaceed685 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1SourcesPostRequestFormSourceOrderShippingXaceed685> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SourcesPostRequestFormSourceOrderShippingXaceed685 must be a JSON object",
                    )
            val address =
                json.decodeRequired<InlineV1SourcesPostRequestFormSourceOrderShippingAddressX31adecda>(
                    rawObject,
                    "address",
                )
            return InlineV1SourcesPostRequestFormSourceOrderShippingXaceed685(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SourcesPostRequestFormSourceOrderShippingXaceed685,
        ) {
...
public fun inlineV1SourcesPostRequestFormSourceOrderShippingXaceed685(
    block: InlineV1SourcesPostRequestFormSourceOrderShippingXaceed685.Builder.() -> Unit,
): InlineV1SourcesPostRequestFormSourceOrderShippingXaceed685 =
    InlineV1SourcesPostRequestFormSourceOrderShippingXaceed685.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1SourcesPostRequestFormSourceOrderShippingXaceed685 is missing required property '" + name + "'",
            )
