...
@Serializable
public data class IssuingCardView(
...
public class IssuingCard(
    ...
    public object Serializer : KSerializer<IssuingCard> {
        ...
        override fun deserialize(decoder: Decoder): IssuingCard {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("IssuingCard must be a JSON object")
            ...
            return IssuingCard(
                ...
                cancellationReason =
                    rawObject["cancellation_reason"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineIssuingCardCancellationReasonX67172c82?>(element)
                        }
                    },
                ...
                latestFraudWarning =
                    rawObject["latest_fraud_warning"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineIssuingCardLatestFraudWarningX9f724afd?>(element)
                        }
                    },
                lifecycleControls =
                    rawObject["lifecycle_controls"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineIssuingCardLifecycleControlsX2974d4a1?>(element)
                        }
                    },
                number = rawObject["number"]?.let { json.decodeFromJsonElement<String>(it) },
                personalizationDesign =
                    rawObject["personalization_design"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineIssuingCardPersonalizationDesignX4b8db7b9?>(element)
                        }
                    },
                replacedBy =
                    rawObject["replaced_by"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineIssuingCardReplacedByX506774f9?>(element)
                        }
                    },
                replacementFor =
                    rawObject["replacement_for"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineIssuingCardReplacementForX2e82d369?>(element)
                        }
                    },
                replacementReason =
                    rawObject["replacement_reason"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineIssuingCardReplacementReasonX5511bc87?>(element)
                        }
                    },
                secondLine =
                    rawObject["second_line"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                ...
                shipping =
                    rawObject["shipping"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineIssuingCardShippingX3a68ab2f?>(element)
                        }
                    },
                wallets =
                    rawObject["wallets"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineIssuingCardWalletsX02783822?>(element)
                        }
                    },
            )
        }
