...
internal data class InlineV1SubscriptionsPostRequestFormPaymentSettingsPixXffd425d6Inspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesInlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1Xe3fbfb12,
                matchesInlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2Xad250b9b,
            ).count {
                it
            }
}
...
public class InlineV1SubscriptionsPostRequestFormPaymentSettingsPixXffd425d6 internal constructor(
    ...
    public val inlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1Xe3fbfb12:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1Xe3fbfb12) {
                json
                    .decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1Xe3fbfb12>(
                        raw,
                    )
            } else {
                null
    ...
    public val inlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2Xad250b9b:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2Xad250b9b) {
                json
                    .decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2Xad250b9b>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches:
        ...
        get() =
            buildSet {
                if (inspection.matchesInlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1Xe3fbfb12) {
                    add(
                        InlineV1SubscriptionsPostRequestFormPaymentSettingsPixXffd425d6Branch.InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1Xe3fbfb12,
                    )
                }
                if (inspection.matchesInlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2Xad250b9b) {
                    add(
                        InlineV1SubscriptionsPostRequestFormPaymentSettingsPixXffd425d6Branch.InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2Xad250b9b,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1SubscriptionsPostRequestFormPaymentSettingsPixXffd425d6 {
            val inspection = inspectInlineV1SubscriptionsPostRequestFormPaymentSettingsPixXffd425d6(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1SubscriptionsPostRequestFormPaymentSettingsPixXffd425d6NoMatchException(
                    "InlineV1SubscriptionsPostRequestFormPaymentSettingsPixXffd425d6 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionsPostRequestFormPaymentSettingsPixXffd425d6> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsPostRequestFormPaymentSettingsPixXffd425d6,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1SubscriptionsPostRequestFormPaymentSettingsPixXffd425d6",
...
private fun inspectInlineV1SubscriptionsPostRequestFormPaymentSettingsPixXffd425d6(
    element: JsonElement,
): InlineV1SubscriptionsPostRequestFormPaymentSettingsPixXffd425d6Inspection {
    val matchesInlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1Xe3fbfb12 =
        element
            .isJsonDecodable<InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1Xe3fbfb12>()
    val matchesInlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2Xad250b9b =
        element
            .isJsonDecodable<InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2Xad250b9b>()
    return InlineV1SubscriptionsPostRequestFormPaymentSettingsPixXffd425d6Inspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1Xe3fbfb12) {
                    add(
                        "InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1Xe3fbfb12: value does not match InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1Xe3fbfb12",
                    )
                }
                if (!matchesInlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2Xad250b9b) {
                    add(
                        "InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2Xad250b9b: value does not match InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2Xad250b9b",
                    )
                }
            },
    )
