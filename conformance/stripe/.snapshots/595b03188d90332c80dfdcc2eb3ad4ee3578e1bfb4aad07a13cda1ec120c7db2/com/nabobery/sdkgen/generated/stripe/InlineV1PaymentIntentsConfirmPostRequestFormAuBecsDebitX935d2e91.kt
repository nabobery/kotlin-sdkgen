...
public class InlineV1PaymentIntentsConfirmPostRequestFormAuBecsDebitX935d2e91(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PaymentIntentsConfirmPostRequestFormAuBecsDebitX935d2e91 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentIntentsConfirmPostRequestFormAuBecsDebitX935d2e91> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsConfirmPostRequestFormAuBecsDebitX935d2e91 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsConfirmPostRequestFormAuBecsDebitX935d2e91,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentIntentsConfirmPostRequestFormAuBecsDebitX935d2e91(
    block: InlineV1PaymentIntentsConfirmPostRequestFormAuBecsDebitX935d2e91.Builder.() -> Unit,
): InlineV1PaymentIntentsConfirmPostRequestFormAuBecsDebitX935d2e91 =
    InlineV1PaymentIntentsConfirmPostRequestFormAuBecsDebitX935d2e91.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentIntentsConfirmPostRequestFormAuBecsDebitX935d2e91 is missing required property '" + name +
                    "'",
            )
