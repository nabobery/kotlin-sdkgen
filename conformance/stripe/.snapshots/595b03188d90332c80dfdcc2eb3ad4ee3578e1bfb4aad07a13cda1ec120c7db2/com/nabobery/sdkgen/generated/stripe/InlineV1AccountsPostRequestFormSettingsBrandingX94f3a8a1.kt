...
public class InlineV1AccountsPostRequestFormSettingsBrandingX94f3a8a1(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1AccountsPostRequestFormSettingsBrandingX94f3a8a1 =
            InlineV1AccountsPostRequestFormSettingsBrandingX94f3a8a1(
                icon = icon,
                logo = logo,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1AccountsPostRequestFormSettingsBrandingX94f3a8a1 =
    ...
    public object Serializer : KSerializer<InlineV1AccountsPostRequestFormSettingsBrandingX94f3a8a1> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountsPostRequestFormSettingsBrandingX94f3a8a1 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPostRequestFormSettingsBrandingX94f3a8a1,
        ) {
...
public fun inlineV1AccountsPostRequestFormSettingsBrandingX94f3a8a1(
    block: InlineV1AccountsPostRequestFormSettingsBrandingX94f3a8a1.Builder.() -> Unit,
): InlineV1AccountsPostRequestFormSettingsBrandingX94f3a8a1 =
    InlineV1AccountsPostRequestFormSettingsBrandingX94f3a8a1.build(block)
