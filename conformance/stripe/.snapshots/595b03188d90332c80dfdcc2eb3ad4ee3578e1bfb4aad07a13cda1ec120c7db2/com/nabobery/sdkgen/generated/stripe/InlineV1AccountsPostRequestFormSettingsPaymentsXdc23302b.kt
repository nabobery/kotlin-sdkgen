...
public class InlineV1AccountsPostRequestFormSettingsPaymentsXdc23302b(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1AccountsPostRequestFormSettingsPaymentsXdc23302b =
            InlineV1AccountsPostRequestFormSettingsPaymentsXdc23302b(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1AccountsPostRequestFormSettingsPaymentsXdc23302b =
    ...
    public object Serializer : KSerializer<InlineV1AccountsPostRequestFormSettingsPaymentsXdc23302b> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountsPostRequestFormSettingsPaymentsXdc23302b must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPostRequestFormSettingsPaymentsXdc23302b,
        ) {
...
public fun inlineV1AccountsPostRequestFormSettingsPaymentsXdc23302b(
    block: InlineV1AccountsPostRequestFormSettingsPaymentsXdc23302b.Builder.() -> Unit,
): InlineV1AccountsPostRequestFormSettingsPaymentsXdc23302b =
    InlineV1AccountsPostRequestFormSettingsPaymentsXdc23302b.build(block)
