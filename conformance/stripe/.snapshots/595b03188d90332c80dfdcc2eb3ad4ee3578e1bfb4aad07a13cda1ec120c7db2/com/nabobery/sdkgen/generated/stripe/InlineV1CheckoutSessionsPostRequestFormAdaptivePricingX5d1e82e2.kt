...
public class InlineV1CheckoutSessionsPostRequestFormAdaptivePricingX5d1e82e2(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1CheckoutSessionsPostRequestFormAdaptivePricingX5d1e82e2 =
            InlineV1CheckoutSessionsPostRequestFormAdaptivePricingX5d1e82e2(
                enabled = enabled,
            )
    }

    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1CheckoutSessionsPostRequestFormAdaptivePricingX5d1e82e2 =
    ...
    public object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormAdaptivePricingX5d1e82e2> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CheckoutSessionsPostRequestFormAdaptivePricingX5d1e82e2 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsPostRequestFormAdaptivePricingX5d1e82e2,
        ) {
            val jsonEncoder =
...
public fun inlineV1CheckoutSessionsPostRequestFormAdaptivePricingX5d1e82e2(
    block: InlineV1CheckoutSessionsPostRequestFormAdaptivePricingX5d1e82e2.Builder.() -> Unit,
): InlineV1CheckoutSessionsPostRequestFormAdaptivePricingX5d1e82e2 =
    InlineV1CheckoutSessionsPostRequestFormAdaptivePricingX5d1e82e2.build(block)
