...
public class InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemsRecurringXc672758b(
    public val interval: InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemsItemIntervalX97c20f44,
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemsRecurringXc672758b> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemsRecurringXc672758b must be a JSON object",
                    )
            val interval =
                json
                    .decodeRequired<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemsItemIntervalX97c20f44>(
                        rawObject,
                        "interval",
                    )
            return InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemsRecurringXc672758b(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemsRecurringXc672758b,
        ) {
            val jsonEncoder =
...
public fun inlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemsRecurringXc672758b(
    block: InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemsRecurringXc672758b.Builder.() -> Unit,
): InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemsRecurringXc672758b =
    InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemsRecurringXc672758b.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemsRecurringXc672758b is missing required property '" +
                    name +
                    "'",
            )
