...
public sealed class InlineV1TokensPostRequestFormPersonPoliticalExposureXc153bfec {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1TokensPostRequestFormPersonPoliticalExposureXc153bfec =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1TokensPostRequestFormPersonPoliticalExposureXc153bfec> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1TokensPostRequestFormPersonPoliticalExposureXc153bfec",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1TokensPostRequestFormPersonPoliticalExposureXc153bfec =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TokensPostRequestFormPersonPoliticalExposureXc153bfec,
        ) {
