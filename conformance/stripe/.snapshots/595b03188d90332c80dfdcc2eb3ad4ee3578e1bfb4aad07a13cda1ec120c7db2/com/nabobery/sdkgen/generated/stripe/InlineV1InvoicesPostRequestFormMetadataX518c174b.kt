...
public class InlineV1InvoicesPostRequestFormMetadataX518c174b internal constructor(
    ...
    public val inlineV1InvoicesPostRequestFormMetadataAnyOf2X9ceb1237:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1InvoicesPostRequestFormMetadataAnyOf2X9ceb1237) {
                json
                    .decodeFromJsonElement<InlineV1InvoicesPostRequestFormMetadataAnyOf2X9ceb1237>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1InvoicesPostRequestFormMetadataX518c174bBranch>
        get() =
            buildSet {
                ...
                if (inspection.matchesInlineV1InvoicesPostRequestFormMetadataAnyOf2X9ceb1237) {
                    add(
                        InlineV1InvoicesPostRequestFormMetadataX518c174bBranch.InlineV1InvoicesPostRequestFormMetadataAnyOf2X9ceb1237,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1InvoicesPostRequestFormMetadataX518c174b {
            val inspection = inspectInlineV1InvoicesPostRequestFormMetadataX518c174b(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1InvoicesPostRequestFormMetadataX518c174bNoMatchException(
                    "InlineV1InvoicesPostRequestFormMetadataX518c174b matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1InvoicesPostRequestFormMetadataX518c174b> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesPostRequestFormMetadataX518c174b,
        ) {
...
private fun inspectInlineV1InvoicesPostRequestFormMetadataX518c174b(
    element: JsonElement,
): InlineV1InvoicesPostRequestFormMetadataX518c174bInspection {
    val matchesBranch1 = element.isJsonDecodable<JsonObject>()
    val matchesInlineV1InvoicesPostRequestFormMetadataAnyOf2X9ceb1237 =
        element
            .isJsonDecodable<InlineV1InvoicesPostRequestFormMetadataAnyOf2X9ceb1237>()
    return InlineV1InvoicesPostRequestFormMetadataX518c174bInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1InvoicesPostRequestFormMetadataAnyOf2X9ceb1237) {
                    add(
                        "InlineV1InvoicesPostRequestFormMetadataAnyOf2X9ceb1237: value does not match InlineV1InvoicesPostRequestFormMetadataAnyOf2X9ceb1237",
                    )
                }
            },
    )
