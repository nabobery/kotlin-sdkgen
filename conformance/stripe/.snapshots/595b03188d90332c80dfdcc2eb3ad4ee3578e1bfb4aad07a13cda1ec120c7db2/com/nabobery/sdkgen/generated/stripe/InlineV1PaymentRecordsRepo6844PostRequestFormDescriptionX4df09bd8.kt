...
internal data class InlineV1PaymentRecordsRepo6844PostRequestFormDescriptionX4df09bd8Inspection(
    ...
    public val matchesInlineV1PaymentRecordsRepo6844PostRequestFormDescriptionAnyOf2X9342c259: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1PaymentRecordsRepo6844PostRequestFormDescriptionAnyOf2X9342c259,
            ).count {
                it
            }
}
...
public class InlineV1PaymentRecordsRepo6844PostRequestFormDescriptionX4df09bd8 internal constructor(
    ...
    private val inspection: InlineV1PaymentRecordsRepo6844PostRequestFormDescriptionX4df09bd8Inspection,
) {
    ...
    public val inlineV1PaymentRecordsRepo6844PostRequestFormDescriptionAnyOf2X9342c259:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1PaymentRecordsRepo6844PostRequestFormDescriptionAnyOf2X9342c259) {
                json
                    .decodeFromJsonElement<InlineV1PaymentRecordsRepo6844PostRequestFormDescriptionAnyOf2X9342c259>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1PaymentRecordsRepo6844PostRequestFormDescriptionX4df09bd8Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1PaymentRecordsRepo6844PostRequestFormDescriptionAnyOf2X9342c259) {
                    add(
                        InlineV1PaymentRecordsRepo6844PostRequestFormDescriptionX4df09bd8Branch.InlineV1PaymentRecordsRepo6844PostRequestFormDescriptionAnyOf2X9342c259,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1PaymentRecordsRepo6844PostRequestFormDescriptionX4df09bd8 {
            val inspection = inspectInlineV1PaymentRecordsRepo6844PostRequestFormDescriptionX4df09bd8(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1PaymentRecordsRepo6844PostRequestFormDescriptionX4df09bd8NoMatchException(
                    "InlineV1PaymentRecordsRepo6844PostRequestFormDescriptionX4df09bd8 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1PaymentRecordsRepo6844PostRequestFormDescriptionX4df09bd8> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentRecordsRepo6844PostRequestFormDescriptionX4df09bd8,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1PaymentRecordsRepo6844PostRequestFormDescriptionX4df09bd8",
...
private fun inspectInlineV1PaymentRecordsRepo6844PostRequestFormDescriptionX4df09bd8(
    element: JsonElement,
): InlineV1PaymentRecordsRepo6844PostRequestFormDescriptionX4df09bd8Inspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1PaymentRecordsRepo6844PostRequestFormDescriptionAnyOf2X9342c259 =
        element
            .isJsonDecodable<InlineV1PaymentRecordsRepo6844PostRequestFormDescriptionAnyOf2X9342c259>()
    return InlineV1PaymentRecordsRepo6844PostRequestFormDescriptionX4df09bd8Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1PaymentRecordsRepo6844PostRequestFormDescriptionAnyOf2X9342c259) {
                    add(
                        "InlineV1PaymentRecordsRepo6844PostRequestFormDescriptionAnyOf2X9342c259: value does not match InlineV1PaymentRecordsRepo6844PostRequestFormDescriptionAnyOf2X9342c259",
                    )
                }
            },
    )
