...
public sealed class InlineV1InvoicesLinesPostRequestFormTaxRatesAnyOf2Xd95bc7ed {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1InvoicesLinesPostRequestFormTaxRatesAnyOf2Xd95bc7ed =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1InvoicesLinesPostRequestFormTaxRatesAnyOf2Xd95bc7ed> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1InvoicesLinesPostRequestFormTaxRatesAnyOf2Xd95bc7ed",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1InvoicesLinesPostRequestFormTaxRatesAnyOf2Xd95bc7ed =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesLinesPostRequestFormTaxRatesAnyOf2Xd95bc7ed,
        ) {
