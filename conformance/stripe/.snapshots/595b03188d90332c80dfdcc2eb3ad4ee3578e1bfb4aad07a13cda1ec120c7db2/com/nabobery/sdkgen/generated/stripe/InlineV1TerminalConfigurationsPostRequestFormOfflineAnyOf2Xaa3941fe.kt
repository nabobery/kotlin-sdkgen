...
public sealed class InlineV1TerminalConfigurationsPostRequestFormOfflineAnyOf2Xaa3941fe {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1TerminalConfigurationsPostRequestFormOfflineAnyOf2Xaa3941fe =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1TerminalConfigurationsPostRequestFormOfflineAnyOf2Xaa3941fe> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1TerminalConfigurationsPostRequestFormOfflineAnyOf2Xaa3941fe",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1TerminalConfigurationsPostRequestFormOfflineAnyOf2Xaa3941fe = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TerminalConfigurationsPostRequestFormOfflineAnyOf2Xaa3941fe,
        ) {
