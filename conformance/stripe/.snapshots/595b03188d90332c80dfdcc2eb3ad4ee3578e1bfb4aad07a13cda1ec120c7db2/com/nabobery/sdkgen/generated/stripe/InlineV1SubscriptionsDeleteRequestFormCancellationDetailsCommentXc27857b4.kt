...
internal data class InlineV1SubscriptionsDeleteRequestFormCancellationDetailsCommentXc27857b4Inspection(
    ...
    public val matchesInlineV1SubscriptionsDeleteRequestFormCancellationDetailsCommentAnyOf2X0b30f887: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1SubscriptionsDeleteRequestFormCancellationDetailsCommentAnyOf2X0b30f887,
            ).count {
                it
            }
}
...
public class InlineV1SubscriptionsDeleteRequestFormCancellationDetailsCommentXc27857b4 internal constructor(
    ...
    private val inspection: InlineV1SubscriptionsDeleteRequestFormCancellationDetailsCommentXc27857b4Inspection,
) {
    ...
    public val inlineV1SubscriptionsDeleteRequestFormCancellationDetailsCommentAnyOf2X0b30f887:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1SubscriptionsDeleteRequestFormCancellationDetailsCommentAnyOf2X0b30f887) {
                json
                    .decodeFromJsonElement<InlineV1SubscriptionsDeleteRequestFormCancellationDetailsCommentAnyOf2X0b30f887>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1SubscriptionsDeleteRequestFormCancellationDetailsCommentXc27857b4Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1SubscriptionsDeleteRequestFormCancellationDetailsCommentAnyOf2X0b30f887) {
                    add(
                        InlineV1SubscriptionsDeleteRequestFormCancellationDetailsCommentXc27857b4Branch.InlineV1SubscriptionsDeleteRequestFormCancellationDetailsCommentAnyOf2X0b30f887,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1SubscriptionsDeleteRequestFormCancellationDetailsCommentXc27857b4 {
            val inspection = inspectInlineV1SubscriptionsDeleteRequestFormCancellationDetailsCommentXc27857b4(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1SubscriptionsDeleteRequestFormCancellationDetailsCommentXc27857b4NoMatchException(
                    "InlineV1SubscriptionsDeleteRequestFormCancellationDetailsCommentXc27857b4 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionsDeleteRequestFormCancellationDetailsCommentXc27857b4> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsDeleteRequestFormCancellationDetailsCommentXc27857b4,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1SubscriptionsDeleteRequestFormCancellationDetailsCommentXc27857b4",
...
private fun inspectInlineV1SubscriptionsDeleteRequestFormCancellationDetailsCommentXc27857b4(
    element: JsonElement,
): InlineV1SubscriptionsDeleteRequestFormCancellationDetailsCommentXc27857b4Inspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1SubscriptionsDeleteRequestFormCancellationDetailsCommentAnyOf2X0b30f887 =
        element
            .isJsonDecodable<InlineV1SubscriptionsDeleteRequestFormCancellationDetailsCommentAnyOf2X0b30f887>()
    return InlineV1SubscriptionsDeleteRequestFormCancellationDetailsCommentXc27857b4Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1SubscriptionsDeleteRequestFormCancellationDetailsCommentAnyOf2X0b30f887) {
                    add(
                        "InlineV1SubscriptionsDeleteRequestFormCancellationDetailsCommentAnyOf2X0b30f887: value does not match InlineV1SubscriptionsDeleteRequestFormCancellationDetailsCommentAnyOf2X0b30f887",
                    )
                }
            },
    )
