...
public class AccountDashboardSettings(
    ...
    public class Builder {
        ...
        public fun build(): AccountDashboardSettings =
    ...
    public object Serializer : KSerializer<AccountDashboardSettings> {
        ...
        override fun deserialize(decoder: Decoder): AccountDashboardSettings {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("AccountDashboardSettings must be a JSON object")
            return AccountDashboardSettings(
                ...
                timezone =
                    rawObject["timezone"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: AccountDashboardSettings,
        ) {
...
public fun accountDashboardSettings(block: AccountDashboardSettings.Builder.() -> Unit): AccountDashboardSettings =
    AccountDashboardSettings.build(block)
