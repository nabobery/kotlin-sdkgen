...
public class InlineV1PaymentMethodConfigurationsPostRequestFormPixDisplayPreferenceX07bc12d6(
    public val preference: InlineV1PaymentMethodConfidc49PostRequestFormPixPreferenceX5f0ccfab? = null,
) {
    public class Builder {
        public var preference: InlineV1PaymentMethodConfidc49PostRequestFormPixPreferenceX5f0ccfab? =
            null

        public fun build(): InlineV1PaymentMethodConfigurationsPostRequestFormPixDisplayPreferenceX07bc12d6 =
            InlineV1PaymentMethodConfigurationsPostRequestFormPixDisplayPreferenceX07bc12d6(
    ...
    public object Serializer : KSerializer<InlineV1PaymentMethodConfigurationsPostRequestFormPixDisplayPreferenceX07bc12d6> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentMethodConfigurationsPostRequestFormPixDisplayPreferenceX07bc12d6 must be a JSON object",
                    )
            return InlineV1PaymentMethodConfigurationsPostRequestFormPixDisplayPreferenceX07bc12d6(
                preference =
                    rawObject["preference"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentMethodConfidc49PostRequestFormPixPreferenceX5f0ccfab>(
                            it,
                        )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentMethodConfigurationsPostRequestFormPixDisplayPreferenceX07bc12d6,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentMethodConfigurationsPostRequestFormPixDisplayPreferenceX07bc12d6(
    block: InlineV1PaymentMethodConfigurationsPostRequestFormPixDisplayPreferenceX07bc12d6.Builder.() -> Unit,
): InlineV1PaymentMethodConfigurationsPostRequestFormPixDisplayPreferenceX07bc12d6 =
    InlineV1PaymentMethodConfigurationsPostRequestFormPixDisplayPreferenceX07bc12d6.build(block)
