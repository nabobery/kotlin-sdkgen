...
public class InlineV1PaymentMethodsPostRequestFormMetadataXf5766fae internal constructor(
    ...
    public val inlineV1PaymentMethodsPostRequestFormMetadataAnyOf2Xbdc8a83c:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1PaymentMethodsPostRequestFormMetadataAnyOf2Xbdc8a83c) {
                json
                    .decodeFromJsonElement<InlineV1PaymentMethodsPostRequestFormMetadataAnyOf2Xbdc8a83c>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1PaymentMethodsPostRequestFormMetadataXf5766faeBranch>
        get() =
            buildSet {
                ...
                if (inspection.matchesInlineV1PaymentMethodsPostRequestFormMetadataAnyOf2Xbdc8a83c) {
                    add(
                        InlineV1PaymentMethodsPostRequestFormMetadataXf5766faeBranch.InlineV1PaymentMethodsPostRequestFormMetadataAnyOf2Xbdc8a83c,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1PaymentMethodsPostRequestFormMetadataXf5766fae {
            val inspection = inspectInlineV1PaymentMethodsPostRequestFormMetadataXf5766fae(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1PaymentMethodsPostRequestFormMetadataXf5766faeNoMatchException(
                    "InlineV1PaymentMethodsPostRequestFormMetadataXf5766fae matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1PaymentMethodsPostRequestFormMetadataXf5766fae> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentMethodsPostRequestFormMetadataXf5766fae,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1PaymentMethodsPostRequestFormMetadataXf5766fae",
...
private fun inspectInlineV1PaymentMethodsPostRequestFormMetadataXf5766fae(
    element: JsonElement,
): InlineV1PaymentMethodsPostRequestFormMetadataXf5766faeInspection {
    val matchesBranch1 = element.isJsonDecodable<JsonObject>()
    val matchesInlineV1PaymentMethodsPostRequestFormMetadataAnyOf2Xbdc8a83c =
        element
            .isJsonDecodable<InlineV1PaymentMethodsPostRequestFormMetadataAnyOf2Xbdc8a83c>()
    return InlineV1PaymentMethodsPostRequestFormMetadataXf5766faeInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1PaymentMethodsPostRequestFormMetadataAnyOf2Xbdc8a83c) {
                    add(
                        "InlineV1PaymentMethodsPostRequestFormMetadataAnyOf2Xbdc8a83c: value does not match InlineV1PaymentMethodsPostRequestFormMetadataAnyOf2Xbdc8a83c",
                    )
                }
            },
    )
