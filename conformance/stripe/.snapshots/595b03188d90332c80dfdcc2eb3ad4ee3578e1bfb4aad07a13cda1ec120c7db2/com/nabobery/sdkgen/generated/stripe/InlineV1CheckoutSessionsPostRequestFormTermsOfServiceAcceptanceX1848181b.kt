...
internal data class InlineV1CheckoutSessionsPostRequestFormTermsOfServiceAcceptanceX1848181bInspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesInlineV1CheckoutSessionsPostRequestFormCustomTextAnyOf1Xf5625044,
                matchesInlineV1CheckoutSessionsPostRequestFormCustomTextAnyOf2X470283cc,
            ).count {
                it
            }
}
...
public class InlineV1CheckoutSessionsPostRequestFormTermsOfServiceAcceptanceX1848181b internal constructor(
    ...
    private val inspection: InlineV1CheckoutSessionsPostRequestFormTermsOfServiceAcceptanceX1848181bInspection,
) {
    public val inlineV1CheckoutSessionsPostRequestFormCustomTextAnyOf1Xf5625044:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1CheckoutSessionsPostRequestFormCustomTextAnyOf1Xf5625044) {
                json
                    .decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormCustomTextAnyOf1Xf5625044>(
                        raw,
                    )
            } else {
                null
    ...
    public val inlineV1CheckoutSessionsPostRequestFormCustomTextAnyOf2X470283cc:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1CheckoutSessionsPostRequestFormCustomTextAnyOf2X470283cc) {
                json
                    .decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormCustomTextAnyOf2X470283cc>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches:
        ...
        get() =
            buildSet {
                if (inspection.matchesInlineV1CheckoutSessionsPostRequestFormCustomTextAnyOf1Xf5625044) {
                    add(
                        InlineV1CheckoutSessionsPostRequestFormTermsOfServiceAcceptanceX1848181bBranch.InlineV1CheckoutSessionsPostRequestFormCustomTextAnyOf1Xf5625044,
                    )
                }
                if (inspection.matchesInlineV1CheckoutSessionsPostRequestFormCustomTextAnyOf2X470283cc) {
                    add(
                        InlineV1CheckoutSessionsPostRequestFormTermsOfServiceAcceptanceX1848181bBranch.InlineV1CheckoutSessionsPostRequestFormCustomTextAnyOf2X470283cc,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1CheckoutSessionsPostRequestFormTermsOfServiceAcceptanceX1848181b {
            val inspection = inspectInlineV1CheckoutSessionsPostRequestFormTermsOfServiceAcceptanceX1848181b(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1CheckoutSessionsPostRequestFormTermsOfServiceAcceptanceX1848181bNoMatchException(
                    "InlineV1CheckoutSessionsPostRequestFormTermsOfServiceAcceptanceX1848181b matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormTermsOfServiceAcceptanceX1848181b> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsPostRequestFormTermsOfServiceAcceptanceX1848181b,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1CheckoutSessionsPostRequestFormTermsOfServiceAcceptanceX1848181b",
...
private fun inspectInlineV1CheckoutSessionsPostRequestFormTermsOfServiceAcceptanceX1848181b(
    element: JsonElement,
): InlineV1CheckoutSessionsPostRequestFormTermsOfServiceAcceptanceX1848181bInspection {
    val matchesInlineV1CheckoutSessionsPostRequestFormCustomTextAnyOf1Xf5625044 =
        element
            .isJsonDecodable<InlineV1CheckoutSessionsPostRequestFormCustomTextAnyOf1Xf5625044>()
    val matchesInlineV1CheckoutSessionsPostRequestFormCustomTextAnyOf2X470283cc =
        element
            .isJsonDecodable<InlineV1CheckoutSessionsPostRequestFormCustomTextAnyOf2X470283cc>()
    return InlineV1CheckoutSessionsPostRequestFormTermsOfServiceAcceptanceX1848181bInspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1CheckoutSessionsPostRequestFormCustomTextAnyOf1Xf5625044) {
                    add(
                        "InlineV1CheckoutSessionsPostRequestFormCustomTextAnyOf1Xf5625044: value does not match InlineV1CheckoutSessionsPostRequestFormCustomTextAnyOf1Xf5625044",
                    )
                }
                if (!matchesInlineV1CheckoutSessionsPostRequestFormCustomTextAnyOf2X470283cc) {
                    add(
                        "InlineV1CheckoutSessionsPostRequestFormCustomTextAnyOf2X470283cc: value does not match InlineV1CheckoutSessionsPostRequestFormCustomTextAnyOf2X470283cc",
                    )
                }
            },
    )
