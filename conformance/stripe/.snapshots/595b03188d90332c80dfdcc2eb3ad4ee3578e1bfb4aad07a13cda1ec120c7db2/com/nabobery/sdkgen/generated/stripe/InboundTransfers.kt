...
public class InboundTransfers(
    ...
    public object Serializer : KSerializer<InboundTransfers> {
        ...
        override fun deserialize(decoder: Decoder): InboundTransfers {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("InboundTransfers must be a JSON object")
            ...
            return InboundTransfers(
                ...
                usBankAccount =
                    rawObject["us_bank_account"]?.let {
                        json.decodeFromJsonElement<InboundTransfersPaymentMethodDetailsUsBankAccount>(it)
                    },
            )
        }
...
public fun inboundTransfers(block: InboundTransfers.Builder.() -> Unit): InboundTransfers =
    InboundTransfers.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("InboundTransfers is missing required property '" + name + "'")
