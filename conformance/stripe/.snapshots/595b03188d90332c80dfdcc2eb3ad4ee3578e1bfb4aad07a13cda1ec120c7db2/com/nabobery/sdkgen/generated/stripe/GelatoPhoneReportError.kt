...
public class GelatoPhoneReportError(
    ...
    public class Builder {
        ...
        public fun build(): GelatoPhoneReportError =
        ...
        override fun deserialize(decoder: Decoder): GelatoPhoneReportError {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("GelatoPhoneReportError must be a JSON object")
                ...
                code =
                    rawObject["code"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineGelatoPhoneReportErrorCodeX94340781?>(element)
                        }
                    },
                reason =
...
public fun gelatoPhoneReportError(block: GelatoPhoneReportError.Builder.() -> Unit): GelatoPhoneReportError =
    GelatoPhoneReportError.build(block)
