...
public sealed class InlineV1SourcesPostRequestFormFlowXa6144934 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1SourcesPostRequestFormFlowXa6144934 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1SourcesPostRequestFormFlowXa6144934> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1SourcesPostRequestFormFlowXa6144934",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1SourcesPostRequestFormFlowXa6144934 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SourcesPostRequestFormFlowXa6144934,
        ) {
