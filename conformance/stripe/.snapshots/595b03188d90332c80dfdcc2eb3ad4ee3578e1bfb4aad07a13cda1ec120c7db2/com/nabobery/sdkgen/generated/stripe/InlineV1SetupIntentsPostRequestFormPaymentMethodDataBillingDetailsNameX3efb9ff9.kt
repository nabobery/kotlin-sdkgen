...
internal data class InlineV1SetupIntentsPostRequestFormPaymentMethodDataBillingDetailsNameX3efb9ff9Inspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1SetupIntentsPostRequestFormPaymentMethodDataAnyOf2Xd5129031,
            ).count { it }
}
...
public class InlineV1SetupIntentsPostRequestFormPaymentMethodDataBillingDetailsNameX3efb9ff9 internal constructor(
    ...
    private val inspection: InlineV1SetupIntentsPostRequestFormPaymentMethodDataBillingDetailsNameX3efb9ff9Inspection,
) {
    ...
    public val inlineV1SetupIntentsPostRequestFormPaymentMethodDataAnyOf2Xd5129031:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1SetupIntentsPostRequestFormPaymentMethodDataAnyOf2Xd5129031) {
                json
                    .decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodDataAnyOf2Xd5129031>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1SetupIntentsPostRequestFormPaymentMethodDataBillingDetailsNameX3efb9ff9Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1SetupIntentsPostRequestFormPaymentMethodDataAnyOf2Xd5129031) {
                    add(
                        InlineV1SetupIntentsPostRequestFormPaymentMethodDataBillingDetailsNameX3efb9ff9Branch.InlineV1SetupIntentsPostRequestFormPaymentMethodDataAnyOf2Xd5129031,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1SetupIntentsPostRequestFormPaymentMethodDataBillingDetailsNameX3efb9ff9 {
            val inspection = inspectInlineV1SetupIntentsPostRequestFormPaymentMethodDataBillingDetailsNameX3efb9ff9(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1SetupIntentsPostRequestFormPaymentMethodDataBillingDetailsNameX3efb9ff9NoMatchException(
                    "InlineV1SetupIntentsPostRequestFormPaymentMethodDataBillingDetailsNameX3efb9ff9 matched 0 branches: " +
                        inspection.failures.joinToString("; "),
                )
            }
            return InlineV1SetupIntentsPostRequestFormPaymentMethodDataBillingDetailsNameX3efb9ff9(
                raw,
                json,
                inspection,
            )
    ...
    public object Serializer : KSerializer<InlineV1SetupIntentsPostRequestFormPaymentMethodDataBillingDetailsNameX3efb9ff9> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SetupIntentsPostRequestFormPaymentMethodDataBillingDetailsNameX3efb9ff9,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1SetupIntentsPostRequestFormPaymentMethodDataBillingDetailsNameX3efb9ff9",
...
private fun inspectInlineV1SetupIntentsPostRequestFormPaymentMethodDataBillingDetailsNameX3efb9ff9(
    element: JsonElement,
): InlineV1SetupIntentsPostRequestFormPaymentMethodDataBillingDetailsNameX3efb9ff9Inspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1SetupIntentsPostRequestFormPaymentMethodDataAnyOf2Xd5129031 =
        element
            .isJsonDecodable<InlineV1SetupIntentsPostRequestFormPaymentMethodDataAnyOf2Xd5129031>()
    return InlineV1SetupIntentsPostRequestFormPaymentMethodDataBillingDetailsNameX3efb9ff9Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1SetupIntentsPostRequestFormPaymentMethodDataAnyOf2Xd5129031) {
                    add(
                        "InlineV1SetupIntentsPostRequestFormPaymentMethodDataAnyOf2Xd5129031: value does not match InlineV1SetupIntentsPostRequestFormPaymentMethodDataAnyOf2Xd5129031",
                    )
                }
            },
    )
