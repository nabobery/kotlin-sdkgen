...
internal data class InlineV1SubscriptionsPostRequestFormTransferDataX885766c2Inspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesInlineV1SubscriptionsPostRequestFormTransferDataAnyOf1X169b82ec,
                matchesInlineV1SubscriptionsPostRequestFormTransferDataAnyOf2X26d114c8,
            ).count {
                it
            }
}
...
public class InlineV1SubscriptionsPostRequestFormTransferDataX885766c2 internal constructor(
    ...
    public val inlineV1SubscriptionsPostRequestFormTransferDataAnyOf1X169b82ec:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1SubscriptionsPostRequestFormTransferDataAnyOf1X169b82ec) {
                json
                    .decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormTransferDataAnyOf1X169b82ec>(
                        raw,
                    )
            } else {
                null
    ...
    public val inlineV1SubscriptionsPostRequestFormTransferDataAnyOf2X26d114c8:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1SubscriptionsPostRequestFormTransferDataAnyOf2X26d114c8) {
                json
                    .decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormTransferDataAnyOf2X26d114c8>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1SubscriptionsPostRequestFormTransferDataX885766c2Branch>
        get() =
            buildSet {
                if (inspection.matchesInlineV1SubscriptionsPostRequestFormTransferDataAnyOf1X169b82ec) {
                    add(
                        InlineV1SubscriptionsPostRequestFormTransferDataX885766c2Branch.InlineV1SubscriptionsPostRequestFormTransferDataAnyOf1X169b82ec,
                    )
                }
                if (inspection.matchesInlineV1SubscriptionsPostRequestFormTransferDataAnyOf2X26d114c8) {
                    add(
                        InlineV1SubscriptionsPostRequestFormTransferDataX885766c2Branch.InlineV1SubscriptionsPostRequestFormTransferDataAnyOf2X26d114c8,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1SubscriptionsPostRequestFormTransferDataX885766c2 {
            val inspection = inspectInlineV1SubscriptionsPostRequestFormTransferDataX885766c2(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1SubscriptionsPostRequestFormTransferDataX885766c2NoMatchException(
                    "InlineV1SubscriptionsPostRequestFormTransferDataX885766c2 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionsPostRequestFormTransferDataX885766c2> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsPostRequestFormTransferDataX885766c2,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1SubscriptionsPostRequestFormTransferDataX885766c2",
...
private fun inspectInlineV1SubscriptionsPostRequestFormTransferDataX885766c2(
    element: JsonElement,
): InlineV1SubscriptionsPostRequestFormTransferDataX885766c2Inspection {
    val matchesInlineV1SubscriptionsPostRequestFormTransferDataAnyOf1X169b82ec =
        element
            .isJsonDecodable<InlineV1SubscriptionsPostRequestFormTransferDataAnyOf1X169b82ec>()
    val matchesInlineV1SubscriptionsPostRequestFormTransferDataAnyOf2X26d114c8 =
        element
            .isJsonDecodable<InlineV1SubscriptionsPostRequestFormTransferDataAnyOf2X26d114c8>()
    return InlineV1SubscriptionsPostRequestFormTransferDataX885766c2Inspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1SubscriptionsPostRequestFormTransferDataAnyOf1X169b82ec) {
                    add(
                        "InlineV1SubscriptionsPostRequestFormTransferDataAnyOf1X169b82ec: value does not match InlineV1SubscriptionsPostRequestFormTransferDataAnyOf1X169b82ec",
                    )
                }
                if (!matchesInlineV1SubscriptionsPostRequestFormTransferDataAnyOf2X26d114c8) {
                    add(
                        "InlineV1SubscriptionsPostRequestFormTransferDataAnyOf2X26d114c8: value does not match InlineV1SubscriptionsPostRequestFormTransferDataAnyOf2X26d114c8",
                    )
                }
            },
    )
