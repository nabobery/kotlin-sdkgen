...
public class InlineV1BillingPortalSessionsPostRequestFormFlowDataRetentionXf3ca2ebd(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1BillingPortalSessionsPostRequestFormFlowDataRetentionXf3ca2ebd = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1BillingPortalSessionsPostRequestFormFlowDataRetentionXf3ca2ebd> {
        override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1BillingPortalSessionsPostRequestFormFlowDataRetentionXf3ca2ebd {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1BillingPortalSessionsPostRequestFormFlowDataRetentionXf3ca2ebd must be a JSON object",
                    )
            val couponOffer =
                json.decodeRequired<InlineV1BillingPortalSessionsPostRequestFormFlowDataCouponOfferX0efe861a>(
                    rawObject,
                    "coupon_offer",
                )
            val type =
                json.decodeRequired<InlineV1BillingPortalSessionsPostRequestFormFlowDataTypeXa8bde4ba>(
                    rawObject,
                    "type",
                )
            return InlineV1BillingPortalSessionsPostRequestFormFlowDataRetentionXf3ca2ebd(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1BillingPortalSessionsPostRequestFormFlowDataRetentionXf3ca2ebd,
        ) {
            val jsonEncoder =
...
public fun inlineV1BillingPortalSessionsPostRequestFormFlowDataRetentionXf3ca2ebd(
    block: InlineV1BillingPortalSessionsPostRequestFormFlowDataRetentionXf3ca2ebd.Builder.() -> Unit,
): InlineV1BillingPortalSessionsPostRequestFormFlowDataRetentionXf3ca2ebd =
    InlineV1BillingPortalSessionsPostRequestFormFlowDataRetentionXf3ca2ebd.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1BillingPortalSessionsPostRequestFormFlowDataRetentionXf3ca2ebd is missing required property '" +
                    name +
                    "'",
            )
