...
public class InlineV1CheckoutSessionsPostRequestFormPaymentIntentDataShippingAddressXbd0e4634(
    ...
    public object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormPaymentIntentDataShippingAddressXbd0e4634> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CheckoutSessionsPostRequestFormPaymentIntentDataShippingAddressXbd0e4634 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsPostRequestFormPaymentIntentDataShippingAddressXbd0e4634,
        ) {
            val jsonEncoder =
...
public fun inlineV1CheckoutSessionsPostRequestFormPaymentIntentDataShippingAddressXbd0e4634(
    block: InlineV1CheckoutSessionsPostRequestFormPaymentIntentDataShippingAddressXbd0e4634.Builder.() -> Unit,
): InlineV1CheckoutSessionsPostRequestFormPaymentIntentDataShippingAddressXbd0e4634 =
    InlineV1CheckoutSessionsPostRequestFormPaymentIntentDataShippingAddressXbd0e4634.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1CheckoutSessionsPostRequestFormPaymentIntentDataShippingAddressXbd0e4634 is missing required property '" +
                    name +
                    "'",
            )
