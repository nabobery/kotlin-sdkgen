...
public sealed class InlineV1SourcesPostRequestFormSourceOrderItemsItemTypeX1129cf6e {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1SourcesPostRequestFormSourceOrderItemsItemTypeX1129cf6e =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1SourcesPostRequestFormSourceOrderItemsItemTypeX1129cf6e> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1SourcesPostRequestFormSourceOrderItemsItemTypeX1129cf6e",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1SourcesPostRequestFormSourceOrderItemsItemTypeX1129cf6e =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SourcesPostRequestFormSourceOrderItemsItemTypeX1129cf6e,
        ) {
