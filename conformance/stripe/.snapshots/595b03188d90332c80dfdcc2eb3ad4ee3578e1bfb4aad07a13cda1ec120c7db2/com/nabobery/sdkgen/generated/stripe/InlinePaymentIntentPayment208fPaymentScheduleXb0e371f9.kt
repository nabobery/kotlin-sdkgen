...
public sealed class InlinePaymentIntentPayment208fPaymentScheduleXb0e371f9 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentIntentPayment208fPaymentScheduleXb0e371f9 =
            when (value) {
                Adhoc.value -> Adhoc
                Annual.value -> Annual
                Daily.value -> Daily
    ...
    public object Serializer : KSerializer<InlinePaymentIntentPayment208fPaymentScheduleXb0e371f9> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentIntentPayment208fPaymentScheduleXb0e371f9",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePaymentIntentPayment208fPaymentScheduleXb0e371f9 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentIntentPayment208fPaymentScheduleXb0e371f9,
        ) {
