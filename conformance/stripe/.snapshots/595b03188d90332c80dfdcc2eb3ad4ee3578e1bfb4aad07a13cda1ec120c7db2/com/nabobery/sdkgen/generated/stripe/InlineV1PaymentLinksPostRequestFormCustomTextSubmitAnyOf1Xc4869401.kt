...
public class InlineV1PaymentLinksPostRequestFormCustomTextSubmitAnyOf1Xc4869401(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentLinksPostRequestFormCustomTextSubmitAnyOf1Xc4869401 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1PaymentLinksPostRequestFormCustomTextSubmitAnyOf1Xc4869401> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentLinksPostRequestFormCustomTextSubmitAnyOf1Xc4869401 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentLinksPostRequestFormCustomTextSubmitAnyOf1Xc4869401,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentLinksPostRequestFormCustomTextSubmitAnyOf1Xc4869401(
    block: InlineV1PaymentLinksPostRequestFormCustomTextSubmitAnyOf1Xc4869401.Builder.() -> Unit,
): InlineV1PaymentLinksPostRequestFormCustomTextSubmitAnyOf1Xc4869401 =
    InlineV1PaymentLinksPostRequestFormCustomTextSubmitAnyOf1Xc4869401.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentLinksPostRequestFormCustomTextSubmitAnyOf1Xc4869401 is missing required property '" +
                    name +
                    "'",
            )
