...
public class LegalEntityJapanAddress(
    ...
    public class Builder {
        ...
        public fun build(): LegalEntityJapanAddress =
    ...
    public object Serializer : KSerializer<LegalEntityJapanAddress> {
        ...
        override fun deserialize(decoder: Decoder): LegalEntityJapanAddress {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("LegalEntityJapanAddress must be a JSON object")
...
public fun legalEntityJapanAddress(block: LegalEntityJapanAddress.Builder.() -> Unit): LegalEntityJapanAddress =
    LegalEntityJapanAddress.build(block)
