...
internal data class InlineV1TerminalConfigurationsPostRequestFormWifiX160be9acInspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesInlineV1TerminalConfigurationsPostRequestFormWifiAnyOf1X2ab6090d,
                matchesInlineV1TerminalConfigurationsPostRequestFormWifiAnyOf2X9fed819b,
            ).count {
                it
            }
}
...
public class InlineV1TerminalConfigurationsPostRequestFormWifiX160be9ac internal constructor(
    ...
    public val inlineV1TerminalConfigurationsPostRequestFormWifiAnyOf1X2ab6090d:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1TerminalConfigurationsPostRequestFormWifiAnyOf1X2ab6090d) {
                json
                    .decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormWifiAnyOf1X2ab6090d>(
                        raw,
                    )
            } else {
                null
    ...
    public val inlineV1TerminalConfigurationsPostRequestFormWifiAnyOf2X9fed819b:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1TerminalConfigurationsPostRequestFormWifiAnyOf2X9fed819b) {
                json
                    .decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormWifiAnyOf2X9fed819b>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1TerminalConfigurationsPostRequestFormWifiX160be9acBranch>
        get() =
            buildSet {
                if (inspection.matchesInlineV1TerminalConfigurationsPostRequestFormWifiAnyOf1X2ab6090d) {
                    add(
                        InlineV1TerminalConfigurationsPostRequestFormWifiX160be9acBranch.InlineV1TerminalConfigurationsPostRequestFormWifiAnyOf1X2ab6090d,
                    )
                }
                if (inspection.matchesInlineV1TerminalConfigurationsPostRequestFormWifiAnyOf2X9fed819b) {
                    add(
                        InlineV1TerminalConfigurationsPostRequestFormWifiX160be9acBranch.InlineV1TerminalConfigurationsPostRequestFormWifiAnyOf2X9fed819b,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1TerminalConfigurationsPostRequestFormWifiX160be9ac {
            val inspection = inspectInlineV1TerminalConfigurationsPostRequestFormWifiX160be9ac(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1TerminalConfigurationsPostRequestFormWifiX160be9acNoMatchException(
                    "InlineV1TerminalConfigurationsPostRequestFormWifiX160be9ac matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1TerminalConfigurationsPostRequestFormWifiX160be9ac> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TerminalConfigurationsPostRequestFormWifiX160be9ac,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1TerminalConfigurationsPostRequestFormWifiX160be9ac",
...
private fun inspectInlineV1TerminalConfigurationsPostRequestFormWifiX160be9ac(
    element: JsonElement,
): InlineV1TerminalConfigurationsPostRequestFormWifiX160be9acInspection {
    val matchesInlineV1TerminalConfigurationsPostRequestFormWifiAnyOf1X2ab6090d =
        element
            .isJsonDecodable<InlineV1TerminalConfigurationsPostRequestFormWifiAnyOf1X2ab6090d>()
    val matchesInlineV1TerminalConfigurationsPostRequestFormWifiAnyOf2X9fed819b =
        element
            .isJsonDecodable<InlineV1TerminalConfigurationsPostRequestFormWifiAnyOf2X9fed819b>()
    return InlineV1TerminalConfigurationsPostRequestFormWifiX160be9acInspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1TerminalConfigurationsPostRequestFormWifiAnyOf1X2ab6090d) {
                    add(
                        "InlineV1TerminalConfigurationsPostRequestFormWifiAnyOf1X2ab6090d: value does not match InlineV1TerminalConfigurationsPostRequestFormWifiAnyOf1X2ab6090d",
                    )
                }
                if (!matchesInlineV1TerminalConfigurationsPostRequestFormWifiAnyOf2X9fed819b) {
                    add(
                        "InlineV1TerminalConfigurationsPostRequestFormWifiAnyOf2X9fed819b: value does not match InlineV1TerminalConfigurationsPostRequestFormWifiAnyOf2X9fed819b",
                    )
                }
            },
    )
