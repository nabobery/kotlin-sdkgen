...
public class InsightsResourcesPaymentEvaluationUserInterventionRaisedCustom(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InsightsResourcesPaymentEvaluationUserInterventionRaisedCustom =
    ...
    public object Serializer : KSerializer<InsightsResourcesPaymentEvaluationUserInterventionRaisedCustom> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InsightsResourcesPaymentEvaluationUserInterventionRaisedCustom must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InsightsResourcesPaymentEvaluationUserInterventionRaisedCustom,
        ) {
            val jsonEncoder =
...
public fun insightsResourcesPaymentEvaluationUserInterventionRaisedCustom(
    block: InsightsResourcesPaymentEvaluationUserInterventionRaisedCustom.Builder.() -> Unit,
): InsightsResourcesPaymentEvaluationUserInterventionRaisedCustom =
    InsightsResourcesPaymentEvaluationUserInterventionRaisedCustom.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InsightsResourcesPaymentEvaluationUserInterventionRaisedCustom is missing required property '" + name +
                    "'",
            )
