...
public class InlineV1TokensPostRequestFormPersonX2c9b4fc3(
    public val additionalTosAcceptances: InlineV1TokensPostRequestFormPersonAdditionalTosAcceptancesXb8c9209f? = null,
    ...
    public val politicalExposure: InlineV1TokensPostRequestFormPersonPoliticalExposureXc153bfec? = null,
    public val registeredAddress: InlineV1TokensPostRequestFormPersonRegisteredAddressX52eaaf94? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1TokensPostRequestFormPersonX2c9b4fc3 =
            InlineV1TokensPostRequestFormPersonX2c9b4fc3(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TokensPostRequestFormPersonX2c9b4fc3 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TokensPostRequestFormPersonX2c9b4fc3> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TokensPostRequestFormPersonX2c9b4fc3 must be a JSON object",
                    )
            return InlineV1TokensPostRequestFormPersonX2c9b4fc3(
                additionalTosAcceptances =
                    rawObject["additional_tos_acceptances"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TokensPostRequestFormPersonAdditionalTosAcceptancesXb8c9209f>(
                                it,
                            )
                    },
                address =
                    rawObject["address"]?.let {
                        json.decodeFromJsonElement<InlineV1TokensPostRequestFormPersonAddressX0fca7f48>(it)
                    },
                addressKana =
                    rawObject["address_kana"]?.let {
                        json.decodeFromJsonElement<InlineV1TokensPostRequestFormPersonAddressKanaXe75e348e>(it)
                    },
                addressKanji =
                    rawObject["address_kanji"]?.let {
                        json.decodeFromJsonElement<InlineV1TokensPostRequestFormPersonAddressKanjiX767496c0>(it)
                    },
                dob =
                    rawObject["dob"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TokensPostRequestFormPersonDobXad0230b2>(
                                it,
                            )
                    },
                documents =
                    rawObject["documents"]?.let {
                        json.decodeFromJsonElement<InlineV1TokensPostRequestFormPersonDocumentsX6cae069c>(it)
                    },
                ...
                fullNameAliases =
                    rawObject["full_name_aliases"]?.let {
                        json.decodeFromJsonElement<InlineV1TokensPostRequestFormPersonFullNameAliasesX6f827c7d>(it)
                    },
                ...
                metadata =
                    rawObject["metadata"]?.let {
                        json.decodeFromJsonElement<InlineV1TokensPostRequestFormPersonMetadataX25e1fccd>(it)
                    },
                ...
                politicalExposure =
                    rawObject["political_exposure"]?.let {
                        json.decodeFromJsonElement<InlineV1TokensPostRequestFormPersonPoliticalExposureXc153bfec>(it)
                    },
                registeredAddress =
                    rawObject["registered_address"]?.let {
                        json.decodeFromJsonElement<InlineV1TokensPostRequestFormPersonRegisteredAddressX52eaaf94>(it)
                    },
                relationship =
                    rawObject["relationship"]?.let {
                        json.decodeFromJsonElement<InlineV1TokensPostRequestFormPersonRelationshipXa53c81a2>(it)
                    },
                ssnLast4 = rawObject["ssn_last_4"]?.let { json.decodeFromJsonElement<String>(it) },
                usCfpbData =
                    rawObject["us_cfpb_data"]?.let {
                        json.decodeFromJsonElement<InlineV1TokensPostRequestFormPersonUsCfpbDataX83866ef0>(it)
                    },
                verification =
                    rawObject["verification"]?.let {
                        json.decodeFromJsonElement<InlineV1TokensPostRequestFormPersonVerificationX3434d302>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TokensPostRequestFormPersonX2c9b4fc3,
        ) {
...
public fun inlineV1TokensPostRequestFormPersonX2c9b4fc3(
    block: InlineV1TokensPostRequestFormPersonX2c9b4fc3.Builder.() -> Unit,
): InlineV1TokensPostRequestFormPersonX2c9b4fc3 = InlineV1TokensPostRequestFormPersonX2c9b4fc3.build(block)
