...
@Serializable
public data class SetupAttemptView(
...
public class SetupAttempt(
    ...
    public class Builder {
         ...
         */
        public var flowDirections: List<InlineSetupAttemptFlowDirectionsItemXcbd0f944>? = null
    ...
    public object Serializer : KSerializer<SetupAttempt> {
        ...
        override fun deserialize(decoder: Decoder): SetupAttempt {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("SetupAttempt must be a JSON object")
            ...
            val paymentMethod =
                json.decodeRequired<InlineSetupAttemptPaymentMethodXdc9167e6>(
                    rawObject,
                    "payment_method",
                )
            val paymentMethodDetails =
                json.decodeRequired<SetupAttemptPaymentMethodDetails>(
                    rawObject,
                ...
                application =
                    rawObject["application"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineSetupAttemptApplicationXaec8dc26?>(element)
                        }
                    },
                ...
                customer =
                    rawObject["customer"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineSetupAttemptCustomerX4f3b3f84?>(element)
                        }
                    },
                customerAccount =
                ...
                flowDirections =
                    rawObject["flow_directions"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<List<InlineSetupAttemptFlowDirectionsItemXcbd0f944>?>(element)
                        }
                    },
                onBehalfOf =
                    rawObject["on_behalf_of"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineSetupAttemptOnBehalfOfXe2975a98?>(element)
                        }
                    },
                setupError =
                    rawObject["setup_error"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                        } else {
                            json.decodeFromJsonElement<InlineSetupAttemptSetupErrorXedd0b9b5?>(element)
                        }
                    },
            )
        }
