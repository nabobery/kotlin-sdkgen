...
public class InlineV1AccountsPostRequestFormCapabilitiesCardPaymentsX561aec6f(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1AccountsPostRequestFormCapabilitiesCardPaymentsX561aec6f =
            InlineV1AccountsPostRequestFormCapabilitiesCardPaymentsX561aec6f(
                requested = requested,
            )
    }

    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1AccountsPostRequestFormCapabilitiesCardPaymentsX561aec6f =
    ...
    public object Serializer : KSerializer<InlineV1AccountsPostRequestFormCapabilitiesCardPaymentsX561aec6f> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountsPostRequestFormCapabilitiesCardPaymentsX561aec6f must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPostRequestFormCapabilitiesCardPaymentsX561aec6f,
        ) {
            val jsonEncoder =
...
public fun inlineV1AccountsPostRequestFormCapabilitiesCardPaymentsX561aec6f(
    block: InlineV1AccountsPostRequestFormCapabilitiesCardPaymentsX561aec6f.Builder.() -> Unit,
): InlineV1AccountsPostRequestFormCapabilitiesCardPaymentsX561aec6f =
    InlineV1AccountsPostRequestFormCapabilitiesCardPaymentsX561aec6f.build(block)
