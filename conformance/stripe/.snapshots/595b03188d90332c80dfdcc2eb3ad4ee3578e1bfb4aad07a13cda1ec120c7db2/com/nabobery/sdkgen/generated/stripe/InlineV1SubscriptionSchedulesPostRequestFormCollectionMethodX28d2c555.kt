...
public sealed class InlineV1SubscriptionSchedulesPostRequestFormCollectionMethodX28d2c555 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1SubscriptionSchedulesPostRequestFormCollectionMethodX28d2c555 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionSchedulesPostRequestFormCollectionMethodX28d2c555> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1SubscriptionSchedulesPostRequestFormCollectionMethodX28d2c555",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1SubscriptionSchedulesPostRequestFormCollectionMethodX28d2c555 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionSchedulesPostRequestFormCollectionMethodX28d2c555,
        ) {
