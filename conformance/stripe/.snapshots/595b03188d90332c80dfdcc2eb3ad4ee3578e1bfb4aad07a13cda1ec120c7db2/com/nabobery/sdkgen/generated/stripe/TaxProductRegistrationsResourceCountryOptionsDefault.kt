...
public class TaxProductRegistrationsResourceCountryOptionsDefault(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): TaxProductRegistrationsResourceCountryOptionsDefault =
    ...
    public object Serializer : KSerializer<TaxProductRegistrationsResourceCountryOptionsDefault> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "TaxProductRegistrationsResourceCountryOptionsDefault must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineTaxProductRegistrationsResourceCountryOptionsDefaultTypeX522c9c9f>(
                    rawObject,
                    "type",
                )
            return TaxProductRegistrationsResourceCountryOptionsDefault(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: TaxProductRegistrationsResourceCountryOptionsDefault,
        ) {
...
public fun taxProductRegistrationsResourceCountryOptionsDefault(
    block: TaxProductRegistrationsResourceCountryOptionsDefault.Builder.() -> Unit,
): TaxProductRegistrationsResourceCountryOptionsDefault =
    TaxProductRegistrationsResourceCountryOptionsDefault.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "TaxProductRegistrationsResourceCountryOptionsDefault is missing required property '" + name + "'",
            )
