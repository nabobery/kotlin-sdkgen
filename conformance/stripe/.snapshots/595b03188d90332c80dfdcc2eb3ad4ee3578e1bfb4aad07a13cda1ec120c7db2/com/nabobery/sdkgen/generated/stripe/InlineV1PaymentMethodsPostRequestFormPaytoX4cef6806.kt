...
public class InlineV1PaymentMethodsPostRequestFormPaytoX4cef6806(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1PaymentMethodsPostRequestFormPaytoX4cef6806 =
            InlineV1PaymentMethodsPostRequestFormPaytoX4cef6806(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PaymentMethodsPostRequestFormPaytoX4cef6806 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentMethodsPostRequestFormPaytoX4cef6806> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentMethodsPostRequestFormPaytoX4cef6806 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentMethodsPostRequestFormPaytoX4cef6806,
        ) {
...
public fun inlineV1PaymentMethodsPostRequestFormPaytoX4cef6806(
    block: InlineV1PaymentMethodsPostRequestFormPaytoX4cef6806.Builder.() -> Unit,
): InlineV1PaymentMethodsPostRequestFormPaytoX4cef6806 =
    InlineV1PaymentMethodsPostRequestFormPaytoX4cef6806.build(block)
