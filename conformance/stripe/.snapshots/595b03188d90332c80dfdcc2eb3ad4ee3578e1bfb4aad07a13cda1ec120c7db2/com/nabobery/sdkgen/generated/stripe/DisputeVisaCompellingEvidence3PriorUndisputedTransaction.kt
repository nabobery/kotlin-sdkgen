...
public class DisputeVisaCompellingEvidence3PriorUndisputedTransaction(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): DisputeVisaCompellingEvidence3PriorUndisputedTransaction =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<DisputeVisaCompellingEvidence3PriorUndisputedTransaction> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "DisputeVisaCompellingEvidence3PriorUndisputedTransaction must be a JSON object",
                    )
                ...
                shippingAddress =
                    rawObject["shipping_address"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineDisputeVisaCompellinc87fShippingAddressX9b0e952c?>(element)
                        }
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: DisputeVisaCompellingEvidence3PriorUndisputedTransaction,
        ) {
...
public fun disputeVisaCompellingEvidence3PriorUndisputedTransaction(
    block: DisputeVisaCompellingEvidence3PriorUndisputedTransaction.Builder.() -> Unit,
): DisputeVisaCompellingEvidence3PriorUndisputedTransaction =
    DisputeVisaCompellingEvidence3PriorUndisputedTransaction.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "DisputeVisaCompellingEvidence3PriorUndisputedTransaction is missing required property '" + name + "'",
            )
