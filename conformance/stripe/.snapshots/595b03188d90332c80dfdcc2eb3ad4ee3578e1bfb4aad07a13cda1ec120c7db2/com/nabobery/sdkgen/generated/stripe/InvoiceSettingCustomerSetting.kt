...
public class InvoiceSettingCustomerSetting(
     ...
     */
    public val defaultPaymentMethod: InlineInvoiceSettingCustomerSettingDefaultPaymentMethodX144a10e2? = null,
    /**
    ...
    public class Builder {
        ...
        public fun build(): InvoiceSettingCustomerSetting =
    ...
    public object Serializer : KSerializer<InvoiceSettingCustomerSetting> {
        ...
        override fun deserialize(decoder: Decoder): InvoiceSettingCustomerSetting {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("InvoiceSettingCustomerSetting must be a JSON object")
                ...
                defaultPaymentMethod =
                    rawObject["default_payment_method"]?.let { element ->
                        if (element ==
                            ...
                            json
                                .decodeFromJsonElement<InlineInvoiceSettingCustomerSettingDefaultPaymentMethodX144a10e2?>(
                                    element,
                                )
                        }
                    },
                ...
                renderingOptions =
                    rawObject["rendering_options"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineInvoiceSettingCustomerSettingRenderingOptionsXe8181c96?>(
                                element,
                            )
                        }
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InvoiceSettingCustomerSetting,
        ) {
...
public fun invoiceSettingCustomerSetting(
    block: InvoiceSettingCustomerSetting.Builder.() -> Unit,
): InvoiceSettingCustomerSetting = InvoiceSettingCustomerSetting.build(block)
