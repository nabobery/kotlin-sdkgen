...
internal data class InlineV1CustomersCardsPostRequestFormBankAccountX32b5eec7Inspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesInlineV1CustomersCardsPostRequestFormBankAccountAnyOf1X93f8721a,
                matchesBranch2,
            ).count { it }
}
...
public class InlineV1CustomersCardsPostRequestFormBankAccountX32b5eec7 internal constructor(
    ...
    public val inlineV1CustomersCardsPostRequestFormBankAccountAnyOf1X93f8721a:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1CustomersCardsPostRequestFormBankAccountAnyOf1X93f8721a) {
                json
                    .decodeFromJsonElement<InlineV1CustomersCardsPostRequestFormBankAccountAnyOf1X93f8721a>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1CustomersCardsPostRequestFormBankAccountX32b5eec7Branch>
        get() =
            buildSet {
                if (inspection.matchesInlineV1CustomersCardsPostRequestFormBankAccountAnyOf1X93f8721a) {
                    add(
                        InlineV1CustomersCardsPostRequestFormBankAccountX32b5eec7Branch.InlineV1CustomersCardsPostRequestFormBankAccountAnyOf1X93f8721a,
                    )
                }
                if (inspection.matchesBranch2) {
                    add(
                        InlineV1CustomersCardsPostRequestFormBankAccountX32b5eec7Branch.Branch2,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1CustomersCardsPostRequestFormBankAccountX32b5eec7 {
            val inspection = inspectInlineV1CustomersCardsPostRequestFormBankAccountX32b5eec7(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1CustomersCardsPostRequestFormBankAccountX32b5eec7NoMatchException(
                    "InlineV1CustomersCardsPostRequestFormBankAccountX32b5eec7 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1CustomersCardsPostRequestFormBankAccountX32b5eec7> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersCardsPostRequestFormBankAccountX32b5eec7,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1CustomersCardsPostRequestFormBankAccountX32b5eec7",
...
private fun inspectInlineV1CustomersCardsPostRequestFormBankAccountX32b5eec7(
    element: JsonElement,
): InlineV1CustomersCardsPostRequestFormBankAccountX32b5eec7Inspection {
    val matchesInlineV1CustomersCardsPostRequestFormBankAccountAnyOf1X93f8721a =
        element
            .isJsonDecodable<InlineV1CustomersCardsPostRequestFormBankAccountAnyOf1X93f8721a>()
    ...
    return InlineV1CustomersCardsPostRequestFormBankAccountX32b5eec7Inspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1CustomersCardsPostRequestFormBankAccountAnyOf1X93f8721a) {
                    add(
                        "InlineV1CustomersCardsPostRequestFormBankAccountAnyOf1X93f8721a: value does not match InlineV1CustomersCardsPostRequestFormBankAccountAnyOf1X93f8721a",
                    )
                }
