...
internal data class InlineV1IssuingDisputesPostRequestFormEvidenceAdditionalDocumentationX4a927abeInspection(
    ...
    public val matchesInlineV1IssuingDisputesPostRequestFormEvidenceDuplicateAnyOf1AnyOf2Xcf921afb: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1IssuingDisputesPostRequestFormEvidenceDuplicateAnyOf1AnyOf2Xcf921afb,
            ).count {
                it
            }
}
...
public class InlineV1IssuingDisputesPostRequestFormEvidenceAdditionalDocumentationX4a927abe internal constructor(
    ...
    private val inspection: InlineV1IssuingDisputesPostRequestFormEvidenceAdditionalDocumentationX4a927abeInspection,
) {
    ...
    public val inlineV1IssuingDisputesPostRequestFormEvidenceDuplicateAnyOf1AnyOf2Xcf921afb:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1IssuingDisputesPostRequestFormEvidenceDuplicateAnyOf1AnyOf2Xcf921afb) {
                json
                    .decodeFromJsonElement<InlineV1IssuingDisputesPostRequestFormEvidenceDuplicateAnyOf1AnyOf2Xcf921afb>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1IssuingDisputesPostRequestFormEvidenceAdditionalDocumentationX4a927abeBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1IssuingDisputesPostRequestFormEvidenceDuplicateAnyOf1AnyOf2Xcf921afb) {
                    add(
                        InlineV1IssuingDisputesPostRequestFormEvidenceAdditionalDocumentationX4a927abeBranch.InlineV1IssuingDisputesPostRequestFormEvidenceDuplicateAnyOf1AnyOf2Xcf921afb,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1IssuingDisputesPostRequestFormEvidenceAdditionalDocumentationX4a927abe {
            val inspection = inspectInlineV1IssuingDisputesPostRequestFormEvidenceAdditionalDocumentationX4a927abe(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1IssuingDisputesPostRequestFormEvidenceAdditionalDocumentationX4a927abeNoMatchException(
                    "InlineV1IssuingDisputesPostRequestFormEvidenceAdditionalDocumentationX4a927abe matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1IssuingDisputesPostRequestFormEvidenceAdditionalDocumentationX4a927abe> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingDisputesPostRequestFormEvidenceAdditionalDocumentationX4a927abe,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1IssuingDisputesPostRequestFormEvidenceAdditionalDocumentationX4a927abe",
...
private fun inspectInlineV1IssuingDisputesPostRequestFormEvidenceAdditionalDocumentationX4a927abe(
    element: JsonElement,
): InlineV1IssuingDisputesPostRequestFormEvidenceAdditionalDocumentationX4a927abeInspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1IssuingDisputesPostRequestFormEvidenceDuplicateAnyOf1AnyOf2Xcf921afb =
        element
            .isJsonDecodable<InlineV1IssuingDisputesPostRequestFormEvidenceDuplicateAnyOf1AnyOf2Xcf921afb>()
    return InlineV1IssuingDisputesPostRequestFormEvidenceAdditionalDocumentationX4a927abeInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1IssuingDisputesPostRequestFormEvidenceDuplicateAnyOf1AnyOf2Xcf921afb) {
                    add(
                        "InlineV1IssuingDisputesPostRequestFormEvidenceDuplicateAnyOf1AnyOf2Xcf921afb: value does not match InlineV1IssuingDisputesPostRequestFormEvidenceDuplicateAnyOf1AnyOf2Xcf921afb",
                    )
                }
            },
    )
