...
public sealed class InlineCheckoutCustomerBalancePaymentMethodOptionsFundingTypeX8557d58a {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineCheckoutCustomerBalancePaymentMethodOptionsFundingTypeX8557d58a =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineCheckoutCustomerBalancePaymentMethodOptionsFundingTypeX8557d58a> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineCheckoutCustomerBalancePaymentMethodOptionsFundingTypeX8557d58a",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineCheckoutCustomerBalancePaymentMethodOptionsFundingTypeX8557d58a = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineCheckoutCustomerBalancePaymentMethodOptionsFundingTypeX8557d58a,
        ) {
