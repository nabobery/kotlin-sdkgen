...
public sealed class InlineV1TestHelpersIssuing6a15PostRequestFormFuelTypeXb6cd6ccb {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1TestHelpersIssuing6a15PostRequestFormFuelTypeXb6cd6ccb =
            when (value) {
                Diesel.value -> Diesel
                Other.value -> Other
    ...
    public object Serializer : KSerializer<InlineV1TestHelpersIssuing6a15PostRequestFormFuelTypeXb6cd6ccb> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1TestHelpersIssuing6a15PostRequestFormFuelTypeXb6cd6ccb",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1TestHelpersIssuing6a15PostRequestFormFuelTypeXb6cd6ccb =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TestHelpersIssuing6a15PostRequestFormFuelTypeXb6cd6ccb,
        ) {
