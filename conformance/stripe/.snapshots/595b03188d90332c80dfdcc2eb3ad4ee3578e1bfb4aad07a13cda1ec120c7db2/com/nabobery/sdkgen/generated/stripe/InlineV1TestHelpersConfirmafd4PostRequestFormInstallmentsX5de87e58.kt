...
public class InlineV1TestHelpersConfirmafd4PostRequestFormInstallmentsX5de87e58(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1TestHelpersConfirmafd4PostRequestFormInstallmentsX5de87e58 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1TestHelpersConfirmafd4PostRequestFormInstallmentsX5de87e58> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1TestHelpersConfirmafd4PostRequestFormInstallmentsX5de87e58 {
            val jsonDecoder =
                decoder.requireJsonDecoder(
                    "InlineV1TestHelpersConfirmafd4PostRequestFormInstallmentsX5de87e58",
                )
            val json = jsonDecoder.json
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TestHelpersConfirmafd4PostRequestFormInstallmentsX5de87e58 must be a JSON object",
                    )
            val plan =
                json.decodeRequired<InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodOptionsPlanX9f7a4417>(
                    rawObject,
                    "plan",
                )
            return InlineV1TestHelpersConfirmafd4PostRequestFormInstallmentsX5de87e58(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TestHelpersConfirmafd4PostRequestFormInstallmentsX5de87e58,
        ) {
            val jsonEncoder =
...
public fun inlineV1TestHelpersConfirmafd4PostRequestFormInstallmentsX5de87e58(
    block: InlineV1TestHelpersConfirmafd4PostRequestFormInstallmentsX5de87e58.Builder.() -> Unit,
): InlineV1TestHelpersConfirmafd4PostRequestFormInstallmentsX5de87e58 =
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TestHelpersConfirmafd4PostRequestFormInstallmentsX5de87e58 is missing required property '" +
                    name +
                    "'",
            )
