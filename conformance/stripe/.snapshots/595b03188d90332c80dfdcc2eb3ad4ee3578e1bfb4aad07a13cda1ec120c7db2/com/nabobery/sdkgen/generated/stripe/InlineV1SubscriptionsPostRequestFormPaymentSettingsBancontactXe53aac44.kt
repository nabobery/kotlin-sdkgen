...
internal data class InlineV1SubscriptionsPostRequestFormPaymentSettingsBancontactXe53aac44Inspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesInlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X478a4f02,
                matchesInlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2X21ad872f,
            ).count {
                it
            }
}
...
public class InlineV1SubscriptionsPostRequestFormPaymentSettingsBancontactXe53aac44 internal constructor(
    ...
    private val inspection: InlineV1SubscriptionsPostRequestFormPaymentSettingsBancontactXe53aac44Inspection,
) {
    public val inlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X478a4f02:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X478a4f02) {
                json
                    .decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X478a4f02>(
                        raw,
                    )
            } else {
                null
    ...
    public val inlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2X21ad872f:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2X21ad872f) {
                json
                    .decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2X21ad872f>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches:
        ...
        get() =
            buildSet {
                if (inspection.matchesInlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X478a4f02) {
                    add(
                        InlineV1SubscriptionsPostRequestFormPaymentSettingsBancontactXe53aac44Branch.InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X478a4f02,
                    )
                }
                if (inspection.matchesInlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2X21ad872f) {
                    add(
                        InlineV1SubscriptionsPostRequestFormPaymentSettingsBancontactXe53aac44Branch.InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2X21ad872f,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1SubscriptionsPostRequestFormPaymentSettingsBancontactXe53aac44 {
            val inspection = inspectInlineV1SubscriptionsPostRequestFormPaymentSettingsBancontactXe53aac44(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1SubscriptionsPostRequestFormPaymentSettingsBancontactXe53aac44NoMatchException(
                    "InlineV1SubscriptionsPostRequestFormPaymentSettingsBancontactXe53aac44 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionsPostRequestFormPaymentSettingsBancontactXe53aac44> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsPostRequestFormPaymentSettingsBancontactXe53aac44,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1SubscriptionsPostRequestFormPaymentSettingsBancontactXe53aac44",
...
private fun inspectInlineV1SubscriptionsPostRequestFormPaymentSettingsBancontactXe53aac44(
    element: JsonElement,
): InlineV1SubscriptionsPostRequestFormPaymentSettingsBancontactXe53aac44Inspection {
    val matchesInlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X478a4f02 =
        element
            .isJsonDecodable<InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X478a4f02>()
    val matchesInlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2X21ad872f =
        element
            .isJsonDecodable<InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2X21ad872f>()
    return InlineV1SubscriptionsPostRequestFormPaymentSettingsBancontactXe53aac44Inspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X478a4f02) {
                    add(
                        "InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X478a4f02: value does not match InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1X478a4f02",
                    )
                }
                if (!matchesInlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2X21ad872f) {
                    add(
                        "InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2X21ad872f: value does not match InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2X21ad872f",
                    )
                }
            },
    )
