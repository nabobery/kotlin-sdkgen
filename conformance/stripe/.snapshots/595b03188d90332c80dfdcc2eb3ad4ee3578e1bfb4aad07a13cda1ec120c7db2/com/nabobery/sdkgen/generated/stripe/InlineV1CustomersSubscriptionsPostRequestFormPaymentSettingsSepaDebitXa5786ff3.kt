...
internal data class InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsSepaDebitXa5786ff3Inspection(
    ...
    public val matchesInlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsAnyOf2X320c5ad2: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsAnyOf2X320c5ad2,
            ).count {
                it
            }
}
...
public class InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsSepaDebitXa5786ff3 internal constructor(
    ...
    private val inspection: InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsSepaDebitXa5786ff3Inspection,
) {
    ...
    public val inlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsAnyOf2X320c5ad2:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsAnyOf2X320c5ad2) {
                json
                    .decodeFromJsonElement<InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsAnyOf2X320c5ad2>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsSepaDebitXa5786ff3Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsAnyOf2X320c5ad2) {
                    add(
                        InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsSepaDebitXa5786ff3Branch.InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsAnyOf2X320c5ad2,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsSepaDebitXa5786ff3 {
            val inspection = inspectInlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsSepaDebitXa5786ff3(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsSepaDebitXa5786ff3NoMatchException(
                    "InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsSepaDebitXa5786ff3 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsSepaDebitXa5786ff3> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsSepaDebitXa5786ff3,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsSepaDebitXa5786ff3",
...
private fun inspectInlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsSepaDebitXa5786ff3(
    element: JsonElement,
): InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsSepaDebitXa5786ff3Inspection {
    val matchesBranch1 = element.isJsonDecodable<JsonObject>()
    val matchesInlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsAnyOf2X320c5ad2 =
        element
            .isJsonDecodable<InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsAnyOf2X320c5ad2>()
    return InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsSepaDebitXa5786ff3Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsAnyOf2X320c5ad2) {
                    add(
                        "InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsAnyOf2X320c5ad2: value does not match InlineV1CustomersSubscriptionsPostRequestFormPaymentSettingsAnyOf2X320c5ad2",
                    )
                }
            },
    )
