...
public sealed class InlineV1AccountsExternalAcd662PostRequestFormAccountHolderTypeX9e679f8e {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1AccountsExternalAcd662PostRequestFormAccountHolderTypeX9e679f8e =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1AccountsExternalAcd662PostRequestFormAccountHolderTypeX9e679f8e> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1AccountsExternalAcd662PostRequestFormAccountHolderTypeX9e679f8e",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1AccountsExternalAcd662PostRequestFormAccountHolderTypeX9e679f8e = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsExternalAcd662PostRequestFormAccountHolderTypeX9e679f8e,
        ) {
