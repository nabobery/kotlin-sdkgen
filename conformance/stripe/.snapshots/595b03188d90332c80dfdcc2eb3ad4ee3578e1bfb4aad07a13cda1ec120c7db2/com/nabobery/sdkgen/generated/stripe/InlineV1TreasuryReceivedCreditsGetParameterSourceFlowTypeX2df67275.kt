...
public sealed class InlineV1TreasuryReceivedCreditsGetParameterSourceFlowTypeX2df67275 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1TreasuryReceivedCreditsGetParameterSourceFlowTypeX2df67275 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1TreasuryReceivedCreditsGetParameterSourceFlowTypeX2df67275> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1TreasuryReceivedCreditsGetParameterSourceFlowTypeX2df67275",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1TreasuryReceivedCreditsGetParameterSourceFlowTypeX2df67275 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TreasuryReceivedCreditsGetParameterSourceFlowTypeX2df67275,
        ) {
