...
public class InlineV1TaxRegistrationsPostRequestFormCountryOptionsEsStandardX1cd1d5c8(
    public val placeOfSupplyScheme: InlineV1TaxRegistrationsPostRequestFormPlaceOfSupplySchemeX13752f39,
) {
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1TaxRegistrationsPostRequestFormCountryOptionsEsStandardX1cd1d5c8 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TaxRegistrationsPostRequestFormCountryOptionsEsStandardX1cd1d5c8> {
        override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1TaxRegistrationsPostRequestFormCountryOptionsEsStandardX1cd1d5c8 {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TaxRegistrationsPostRequestFormCountryOptionsEsStandardX1cd1d5c8 must be a JSON object",
                    )
            val placeOfSupplyScheme =
                json
                    .decodeRequired<InlineV1TaxRegistrationsPostRequestFormPlaceOfSupplySchemeX13752f39>(
                        rawObject,
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TaxRegistrationsPostRequestFormCountryOptionsEsStandardX1cd1d5c8,
        ) {
            val jsonEncoder =
...
public fun inlineV1TaxRegistrationsPostRequestFormCountryOptionsEsStandardX1cd1d5c8(
    block: InlineV1TaxRegistrationsPostRequestFormCountryOptionsEsStandardX1cd1d5c8.Builder.() -> Unit,
): InlineV1TaxRegistrationsPostRequestFormCountryOptionsEsStandardX1cd1d5c8 =
    InlineV1TaxRegistrationsPostRequestFormCountryOptionsEsStandardX1cd1d5c8.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TaxRegistrationsPostRequestFormCountryOptionsEsStandardX1cd1d5c8 is missing required property '" +
                    name +
                    "'",
            )
