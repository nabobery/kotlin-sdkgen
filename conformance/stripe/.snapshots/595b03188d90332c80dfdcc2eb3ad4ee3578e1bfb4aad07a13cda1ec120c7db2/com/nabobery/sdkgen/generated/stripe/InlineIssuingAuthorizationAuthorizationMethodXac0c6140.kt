...
public sealed class InlineIssuingAuthorizationAuthorizationMethodXac0c6140 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineIssuingAuthorizationAuthorizationMethodXac0c6140 =
            when (value) {
                Chip.value -> Chip
    ...
    public object Serializer : KSerializer<InlineIssuingAuthorizationAuthorizationMethodXac0c6140> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineIssuingAuthorizationAuthorizationMethodXac0c6140",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineIssuingAuthorizationAuthorizationMethodXac0c6140 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineIssuingAuthorizationAuthorizationMethodXac0c6140,
        ) {
