...
public class InlineV1TreasuryFinancialAc862PostRequestFormFeaturesDepositInsuranceXce3cf708(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1TreasuryFinancialAc862PostRequestFormFeaturesDepositInsuranceXce3cf708 =
    ...
    public object Serializer : KSerializer<InlineV1TreasuryFinancialAc862PostRequestFormFeaturesDepositInsuranceXce3cf708> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TreasuryFinancialAc862PostRequestFormFeaturesDepositInsuranceXce3cf708 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TreasuryFinancialAc862PostRequestFormFeaturesDepositInsuranceXce3cf708,
        ) {
            val jsonEncoder =
...
public fun inlineV1TreasuryFinancialAc862PostRequestFormFeaturesDepositInsuranceXce3cf708(
    block: InlineV1TreasuryFinancialAc862PostRequestFormFeaturesDepositInsuranceXce3cf708.Builder.() -> Unit,
): InlineV1TreasuryFinancialAc862PostRequestFormFeaturesDepositInsuranceXce3cf708 =
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TreasuryFinancialAc862PostRequestFormFeaturesDepositInsuranceXce3cf708 is missing required property '" +
                    name +
                    "'",
            )
