...
public class InlineV1AccountsPostRequestFormBusinessProfileXb836e1dc(
    public val annualRevenue: InlineV1AccountsPostRequestFormBusinessProfileAnnualRevenueX7f013cbd? = null,
    ...
    public val supportAddress: InlineV1AccountsPostRequestFormBusinessProfileSupportAddressX33768a9c? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1AccountsPostRequestFormBusinessProfileXb836e1dc =
            InlineV1AccountsPostRequestFormBusinessProfileXb836e1dc(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1AccountsPostRequestFormBusinessProfileXb836e1dc =
    ...
    public object Serializer : KSerializer<InlineV1AccountsPostRequestFormBusinessProfileXb836e1dc> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountsPostRequestFormBusinessProfileXb836e1dc must be a JSON object",
                    )
            return InlineV1AccountsPostRequestFormBusinessProfileXb836e1dc(
                annualRevenue =
                    rawObject["annual_revenue"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1AccountsPostRequestFormBusinessProfileAnnualRevenueX7f013cbd>(
                                it,
                            )
                    },
                ...
                minorityOwnedBusinessDesignation =
                    rawObject["minority_owned_business_designation"]?.let {
                        json.decodeFromJsonElement<List<InlineV1AccountsPostRequestFormBusinessProfileItemX58ddeefd>>(
                            it,
                        )
                    },
                monthlyEstimatedRevenue =
                    rawObject["monthly_estimated_revenue"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1AccountsPostRequestFormBusinessProfileMonthlyEstimatedRevenueX6918608c>(
                                it,
                            )
                    },
                ...
                supportAddress =
                    rawObject["support_address"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1AccountsPostRequestFormBusinessProfileSupportAddressX33768a9c>(
                                it,
                            )
                    },
                ...
                supportUrl =
                    rawObject["support_url"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPostRequestFormBusinessProfileSupportUrlX08b5f7bd>(
                            it,
                        )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPostRequestFormBusinessProfileXb836e1dc,
        ) {
...
public fun inlineV1AccountsPostRequestFormBusinessProfileXb836e1dc(
    block: InlineV1AccountsPostRequestFormBusinessProfileXb836e1dc.Builder.() -> Unit,
): InlineV1AccountsPostRequestFormBusinessProfileXb836e1dc =
    InlineV1AccountsPostRequestFormBusinessProfileXb836e1dc.build(block)
