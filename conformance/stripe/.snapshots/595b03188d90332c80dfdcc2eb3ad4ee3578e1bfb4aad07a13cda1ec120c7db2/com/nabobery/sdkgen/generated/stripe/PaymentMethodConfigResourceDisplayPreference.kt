...
public class PaymentMethodConfigResourceDisplayPreference(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentMethodConfigResourceDisplayPreference =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentMethodConfigResourceDisplayPreference> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "PaymentMethodConfigResourceDisplayPreference must be a JSON object",
                    )
            val preference =
                json.decodeRequired<InlinePaymentMethodConfigResourceDisplayPreferencePreferenceX8d28a137>(
                    rawObject,
                    "preference",
                )
            val value =
                json.decodeRequired<InlinePaymentMethodConfigResourceDisplayPreferenceValueX26477268>(
                    rawObject,
                    "value",
                )
            return PaymentMethodConfigResourceDisplayPreference(
                ...
                value = value,
                overridable =
                    rawObject["overridable"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentMethodConfigResourceDisplayPreference,
        ) {
...
public fun paymentMethodConfigResourceDisplayPreference(
    block: PaymentMethodConfigResourceDisplayPreference.Builder.() -> Unit,
): PaymentMethodConfigResourceDisplayPreference = PaymentMethodConfigResourceDisplayPreference.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "PaymentMethodConfigResourceDisplayPreference is missing required property '" + name + "'",
            )
