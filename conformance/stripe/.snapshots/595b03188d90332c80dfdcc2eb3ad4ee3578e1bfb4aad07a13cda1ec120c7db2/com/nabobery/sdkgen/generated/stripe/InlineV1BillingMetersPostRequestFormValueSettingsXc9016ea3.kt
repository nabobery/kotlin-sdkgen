...
public class InlineV1BillingMetersPostRequestFormValueSettingsXc9016ea3(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1BillingMetersPostRequestFormValueSettingsXc9016ea3 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1BillingMetersPostRequestFormValueSettingsXc9016ea3> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1BillingMetersPostRequestFormValueSettingsXc9016ea3 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1BillingMetersPostRequestFormValueSettingsXc9016ea3,
        ) {
...
public fun inlineV1BillingMetersPostRequestFormValueSettingsXc9016ea3(
    block: InlineV1BillingMetersPostRequestFormValueSettingsXc9016ea3.Builder.() -> Unit,
): InlineV1BillingMetersPostRequestFormValueSettingsXc9016ea3 =
    InlineV1BillingMetersPostRequestFormValueSettingsXc9016ea3.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1BillingMetersPostRequestFormValueSettingsXc9016ea3 is missing required property '" + name + "'",
            )
