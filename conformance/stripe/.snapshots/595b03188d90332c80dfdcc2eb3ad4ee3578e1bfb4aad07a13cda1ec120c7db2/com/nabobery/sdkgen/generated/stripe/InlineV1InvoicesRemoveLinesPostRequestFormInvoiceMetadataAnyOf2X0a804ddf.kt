    ...
    public object Serializer : KSerializer<InlineV1InvoicesRemoveLinesPostRequestFormInvoiceMetadataAnyOf2X0a804ddf> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1InvoicesRemoveLinesPostRequestFormInvoiceMetadataAnyOf2X0a804ddf",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1InvoicesRemoveLinesPostRequestFormInvoiceMetadataAnyOf2X0a804ddf = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesRemoveLinesPostRequestFormInvoiceMetadataAnyOf2X0a804ddf,
        ) {
