...
public sealed class InlineAccountFutureRequirementsDisabledReasonXa6ead16a {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineAccountFutureRequirementsDisabledReasonXa6ead16a =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineAccountFutureRequirementsDisabledReasonXa6ead16a> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineAccountFutureRequirementsDisabledReasonXa6ead16a",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineAccountFutureRequirementsDisabledReasonXa6ead16a =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineAccountFutureRequirementsDisabledReasonXa6ead16a,
        ) {
