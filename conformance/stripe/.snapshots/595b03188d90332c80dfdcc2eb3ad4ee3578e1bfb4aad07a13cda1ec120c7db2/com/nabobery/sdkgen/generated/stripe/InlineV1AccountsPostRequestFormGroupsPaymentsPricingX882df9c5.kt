...
internal data class InlineV1AccountsPostRequestFormGroupsPaymentsPricingX882df9c5Inspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1AccountsPostRequestFormGroupsPaymentsPricingAnyOf2Xc253936c,
            ).count { it }
}
...
public class InlineV1AccountsPostRequestFormGroupsPaymentsPricingX882df9c5 internal constructor(
    ...
    public val inlineV1AccountsPostRequestFormGroupsPaymentsPricingAnyOf2Xc253936c:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1AccountsPostRequestFormGroupsPaymentsPricingAnyOf2Xc253936c) {
                json
                    .decodeFromJsonElement<InlineV1AccountsPostRequestFormGroupsPaymentsPricingAnyOf2Xc253936c>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1AccountsPostRequestFormGroupsPaymentsPricingX882df9c5Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1AccountsPostRequestFormGroupsPaymentsPricingAnyOf2Xc253936c) {
                    add(
                        InlineV1AccountsPostRequestFormGroupsPaymentsPricingX882df9c5Branch.InlineV1AccountsPostRequestFormGroupsPaymentsPricingAnyOf2Xc253936c,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1AccountsPostRequestFormGroupsPaymentsPricingX882df9c5 {
            val inspection = inspectInlineV1AccountsPostRequestFormGroupsPaymentsPricingX882df9c5(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1AccountsPostRequestFormGroupsPaymentsPricingX882df9c5NoMatchException(
                    "InlineV1AccountsPostRequestFormGroupsPaymentsPricingX882df9c5 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1AccountsPostRequestFormGroupsPaymentsPricingX882df9c5> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPostRequestFormGroupsPaymentsPricingX882df9c5,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1AccountsPostRequestFormGroupsPaymentsPricingX882df9c5",
...
private fun inspectInlineV1AccountsPostRequestFormGroupsPaymentsPricingX882df9c5(
    element: JsonElement,
): InlineV1AccountsPostRequestFormGroupsPaymentsPricingX882df9c5Inspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1AccountsPostRequestFormGroupsPaymentsPricingAnyOf2Xc253936c =
        element
            .isJsonDecodable<InlineV1AccountsPostRequestFormGroupsPaymentsPricingAnyOf2Xc253936c>()
    return InlineV1AccountsPostRequestFormGroupsPaymentsPricingX882df9c5Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1AccountsPostRequestFormGroupsPaymentsPricingAnyOf2Xc253936c) {
                    add(
                        "InlineV1AccountsPostRequestFormGroupsPaymentsPricingAnyOf2Xc253936c: value does not match InlineV1AccountsPostRequestFormGroupsPaymentsPricingAnyOf2Xc253936c",
                    )
                }
            },
    )
