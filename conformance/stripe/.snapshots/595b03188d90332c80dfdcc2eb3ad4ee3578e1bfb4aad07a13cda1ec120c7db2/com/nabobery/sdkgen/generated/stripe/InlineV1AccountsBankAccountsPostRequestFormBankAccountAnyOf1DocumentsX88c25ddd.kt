...
public class InlineV1AccountsBankAccountsPostRequestFormBankAccountAnyOf1DocumentsX88c25ddd(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1AccountsBankAccountsPostRequestFormBankAccountAnyOf1DocumentsX88c25ddd =
    ...
    public object Serializer : KSerializer<InlineV1AccountsBankAccountsPostRequestFormBankAccountAnyOf1DocumentsX88c25ddd> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountsBankAccountsPostRequestFormBankAccountAnyOf1DocumentsX88c25ddd must be a JSON object",
                    )
            return InlineV1AccountsBankAccountsPostRequestFormBankAccountAnyOf1DocumentsX88c25ddd(
                bankAccountOwnershipVerification =
                    rawObject["bank_account_ownership_verification"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1AccountsBankAccountsPostRequestFormBankAccountOwnership2a7eX49b723e1>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsBankAccountsPostRequestFormBankAccountAnyOf1DocumentsX88c25ddd,
        ) {
            val jsonEncoder =
...
public fun inlineV1AccountsBankAccountsPostRequestFormBankAccountAnyOf1DocumentsX88c25ddd(
    block: InlineV1AccountsBankAccountsPostRequestFormBankAccountAnyOf1DocumentsX88c25ddd.Builder.() -> Unit,
): InlineV1AccountsBankAccountsPostRequestFormBankAccountAnyOf1DocumentsX88c25ddd =
    InlineV1AccountsBankAccountsPostRequestFormBankAccountAnyOf1DocumentsX88c25ddd.build(block)
