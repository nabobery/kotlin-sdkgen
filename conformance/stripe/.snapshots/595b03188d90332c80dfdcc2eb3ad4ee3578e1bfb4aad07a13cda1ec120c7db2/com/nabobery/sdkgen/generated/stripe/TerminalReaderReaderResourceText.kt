...
public class TerminalReaderReaderResourceText(
    ...
    public class Builder {
        ...
        public fun build(): TerminalReaderReaderResourceText =
    ...
    public object Serializer : KSerializer<TerminalReaderReaderResourceText> {
        ...
        override fun deserialize(decoder: Decoder): TerminalReaderReaderResourceText {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("TerminalReaderReaderResourceText must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: TerminalReaderReaderResourceText,
        ) {
...
public fun terminalReaderReaderResourceText(
    block: TerminalReaderReaderResourceText.Builder.() -> Unit,
): TerminalReaderReaderResourceText = TerminalReaderReaderResourceText.build(block)
