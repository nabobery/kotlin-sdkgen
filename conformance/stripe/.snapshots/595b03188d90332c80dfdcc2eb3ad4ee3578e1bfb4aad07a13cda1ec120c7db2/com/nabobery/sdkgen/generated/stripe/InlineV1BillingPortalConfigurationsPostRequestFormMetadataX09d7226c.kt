...
internal data class InlineV1BillingPortalConfigurationsPostRequestFormMetadataX09d7226cInspection(
    ...
    public val matchesInlineV1BillingPortalConfigurationsPostRequestFormMetadataAnyOf2X3bb01dab: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1BillingPortalConfigurationsPostRequestFormMetadataAnyOf2X3bb01dab,
            ).count {
                it
            }
}
...
public class InlineV1BillingPortalConfigurationsPostRequestFormMetadataX09d7226c internal constructor(
    ...
    private val inspection: InlineV1BillingPortalConfigurationsPostRequestFormMetadataX09d7226cInspection,
) {
    ...
    public val inlineV1BillingPortalConfigurationsPostRequestFormMetadataAnyOf2X3bb01dab:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1BillingPortalConfigurationsPostRequestFormMetadataAnyOf2X3bb01dab) {
                json
                    .decodeFromJsonElement<InlineV1BillingPortalConfigurationsPostRequestFormMetadataAnyOf2X3bb01dab>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1BillingPortalConfigurationsPostRequestFormMetadataX09d7226cBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1BillingPortalConfigurationsPostRequestFormMetadataAnyOf2X3bb01dab) {
                    add(
                        InlineV1BillingPortalConfigurationsPostRequestFormMetadataX09d7226cBranch.InlineV1BillingPortalConfigurationsPostRequestFormMetadataAnyOf2X3bb01dab,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1BillingPortalConfigurationsPostRequestFormMetadataX09d7226c {
            val inspection = inspectInlineV1BillingPortalConfigurationsPostRequestFormMetadataX09d7226c(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1BillingPortalConfigurationsPostRequestFormMetadataX09d7226cNoMatchException(
                    "InlineV1BillingPortalConfigurationsPostRequestFormMetadataX09d7226c matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1BillingPortalConfigurationsPostRequestFormMetadataX09d7226c> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1BillingPortalConfigurationsPostRequestFormMetadataX09d7226c,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1BillingPortalConfigurationsPostRequestFormMetadataX09d7226c",
...
private fun inspectInlineV1BillingPortalConfigurationsPostRequestFormMetadataX09d7226c(
    element: JsonElement,
): InlineV1BillingPortalConfigurationsPostRequestFormMetadataX09d7226cInspection {
    val matchesBranch1 = element.isJsonDecodable<JsonObject>()
    val matchesInlineV1BillingPortalConfigurationsPostRequestFormMetadataAnyOf2X3bb01dab =
        element
            .isJsonDecodable<InlineV1BillingPortalConfigurationsPostRequestFormMetadataAnyOf2X3bb01dab>()
    return InlineV1BillingPortalConfigurationsPostRequestFormMetadataX09d7226cInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1BillingPortalConfigurationsPostRequestFormMetadataAnyOf2X3bb01dab) {
                    add(
                        "InlineV1BillingPortalConfigurationsPostRequestFormMetadataAnyOf2X3bb01dab: value does not match InlineV1BillingPortalConfigurationsPostRequestFormMetadataAnyOf2X3bb01dab",
                    )
                }
            },
    )
