...
public class InlineV1CheckoutSessionsPostRequestFormShippingOptionsShippingRateDataX66a756ce(
    ...
    public val deliveryEstimate: InlineV1CheckoutSessionsPostRequestFormShippingOptionsDeliveryEstimateX23317080? = null,
    public val fixedAmount: InlineV1CheckoutSessionsPostRequestFormShippingOptionsItemFixedAmountX4b990741? = null,
    public val metadata: Map<String, String>? = null,
    public val taxBehavior: InlineV1CheckoutSessionsPostRequestFormShippingOptionsItemTaxBehaviorXafd09bb0? = null,
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1CheckoutSessionsPostRequestFormShippingOptionsShippingRateDataX66a756ce =
    ...
    public object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormShippingOptionsShippingRateDataX66a756ce> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CheckoutSessionsPostRequestFormShippingOptionsShippingRateDataX66a756ce must be a JSON object",
                    )
            ...
            return InlineV1CheckoutSessionsPostRequestFormShippingOptionsShippingRateDataX66a756ce(
                ...
                deliveryEstimate =
                    rawObject["delivery_estimate"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormShippingOptionsDeliveryEstimateX23317080>(
                                it,
                            )
                    },
                fixedAmount =
                    rawObject["fixed_amount"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormShippingOptionsItemFixedAmountX4b990741>(
                                it,
                            )
                    },
                ...
                taxBehavior =
                    rawObject["tax_behavior"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormShippingOptionsItemTaxBehaviorXafd09bb0>(
                                it,
                            )
                    },
                ...
                type =
                    rawObject["type"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormShippingOptionsItemTypeX33c3159e>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsPostRequestFormShippingOptionsShippingRateDataX66a756ce,
        ) {
            val jsonEncoder =
...
public fun inlineV1CheckoutSessionsPostRequestFormShippingOptionsShippingRateDataX66a756ce(
    block: InlineV1CheckoutSessionsPostRequestFormShippingOptionsShippingRateDataX66a756ce.Builder.() -> Unit,
): InlineV1CheckoutSessionsPostRequestFormShippingOptionsShippingRateDataX66a756ce =
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1CheckoutSessionsPostRequestFormShippingOptionsShippingRateDataX66a756ce is missing required property '" +
                    name +
                    "'",
            )
