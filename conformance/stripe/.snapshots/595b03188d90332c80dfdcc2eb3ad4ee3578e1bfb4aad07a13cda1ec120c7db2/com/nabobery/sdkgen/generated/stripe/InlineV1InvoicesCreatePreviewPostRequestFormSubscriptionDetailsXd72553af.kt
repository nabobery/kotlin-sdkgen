...
public class InlineV1InvoicesCreatePreviewPostRequestFormSubscriptionDetailsXd72553af(
    public val billingCycleAnchor: InlineV1InvoicesCreatePreviewPostRequestFormBillingCycleAnchorX07cb041c? = null,
    public val billingMode: InlineV1InvoicesCreatePreviewPostRequestFormBillingModeXa2159cf5? = null,
    public val billingSchedules: InlineV1InvoicesCreatePreviewPostRequestFormBillingSchedulesXb623335b? = null,
    public val cancelAt: InlineV1InvoicesCreatePreviewPostRequestFormSubscriptionDetailsCancelAtX3ec5eb08? = null,
    public val cancelAtPeriodEnd: Boolean? = null,
    public val cancelNow: Boolean? = null,
    public val defaultTaxRates: InlineV1InvoicesCreatePreviewPostRequestFormDefaultTaxRatesX1d38639e? = null,
    public val items: List<InlineV1InvoicesCreatePreviewPostRequestFormSubscriptionDetailsItemX8167b750>? = null,
    public val prorationBehavior: InlineV1InvoicesCreatePreviewPostRequestFormProrationBehaviorX7014020a? = null,
    public val prorationDate: Int? = null,
    public val resumeAt: InlineV1InvoicesCreatePreviewPostRequestFormSubscriptionDetailsResumeAtX31c0f3b4? = null,
    public val startDate: Int? = null,
    public val trialEnd: InlineV1InvoicesCreatePreviewPostRequestFormSubscriptionDetailsTrialEndXc7027e02? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1InvoicesCreatePreviewPostRequestFormSubscriptionDetailsXd72553af =
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1InvoicesCreatePreviewPostRequestFormSubscriptionDetailsXd72553af = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1InvoicesCreatePreviewPostRequestFormSubscriptionDetailsXd72553af> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1InvoicesCreatePreviewPostRequestFormSubscriptionDetailsXd72553af must be a JSON object",
                    )
            return InlineV1InvoicesCreatePreviewPostRequestFormSubscriptionDetailsXd72553af(
                billingCycleAnchor =
                    rawObject["billing_cycle_anchor"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1InvoicesCreatePreviewPostRequestFormBillingCycleAnchorX07cb041c>(
                                it,
                            )
                    },
                billingMode =
                    rawObject["billing_mode"]?.let {
                        json.decodeFromJsonElement<InlineV1InvoicesCreatePreviewPostRequestFormBillingModeXa2159cf5>(it)
                    },
                billingSchedules =
                    rawObject["billing_schedules"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1InvoicesCreatePreviewPostRequestFormBillingSchedulesXb623335b>(
                                it,
                            )
                    },
                cancelAt =
                    rawObject["cancel_at"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1InvoicesCreatePreviewPostRequestFormSubscriptionDetailsCancelAtX3ec5eb08>(
                                it,
                            )
                    },
                cancelAtPeriodEnd =
                ...
                defaultTaxRates =
                    rawObject["default_tax_rates"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1InvoicesCreatePreviewPostRequestFormDefaultTaxRatesX1d38639e>(
                                it,
                            )
                    },
                items =
                    rawObject["items"]?.let {
                        json
                            .decodeFromJsonElement<List<InlineV1InvoicesCreatePreviewPostRequestFormSubscriptionDetailsItemX8167b750>>(
                                it,
                            )
                    },
                prorationBehavior =
                    rawObject["proration_behavior"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1InvoicesCreatePreviewPostRequestFormProrationBehaviorX7014020a>(
                                it,
                            )
                    },
                prorationDate = rawObject["proration_date"]?.let { json.decodeFromJsonElement<Int>(it) },
                resumeAt =
                    rawObject["resume_at"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1InvoicesCreatePreviewPostRequestFormSubscriptionDetailsResumeAtX31c0f3b4>(
                                it,
                            )
                    },
                ...
                trialEnd =
                    rawObject["trial_end"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1InvoicesCreatePreviewPostRequestFormSubscriptionDetailsTrialEndXc7027e02>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesCreatePreviewPostRequestFormSubscriptionDetailsXd72553af,
        ) {
            val jsonEncoder =
...
public fun inlineV1InvoicesCreatePreviewPostRequestFormSubscriptionDetailsXd72553af(
    block: InlineV1InvoicesCreatePreviewPostRequestFormSubscriptionDetailsXd72553af.Builder.() -> Unit,
): InlineV1InvoicesCreatePreviewPostRequestFormSubscriptionDetailsXd72553af =
    InlineV1InvoicesCreatePreviewPostRequestFormSubscriptionDetailsXd72553af.build(block)
