...
internal data class InlineV1SubscriptionsPostRequestFormPaymentSettingsSepaDebitXf7f1c4a3Inspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2Xef1e91da,
            ).count { it }
}
...
public class InlineV1SubscriptionsPostRequestFormPaymentSettingsSepaDebitXf7f1c4a3 internal constructor(
    ...
    private val inspection: InlineV1SubscriptionsPostRequestFormPaymentSettingsSepaDebitXf7f1c4a3Inspection,
) {
    ...
    public val inlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2Xef1e91da:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2Xef1e91da) {
                json
                    .decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2Xef1e91da>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1SubscriptionsPostRequestFormPaymentSettingsSepaDebitXf7f1c4a3Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2Xef1e91da) {
                    add(
                        InlineV1SubscriptionsPostRequestFormPaymentSettingsSepaDebitXf7f1c4a3Branch.InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2Xef1e91da,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1SubscriptionsPostRequestFormPaymentSettingsSepaDebitXf7f1c4a3 {
            val inspection = inspectInlineV1SubscriptionsPostRequestFormPaymentSettingsSepaDebitXf7f1c4a3(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1SubscriptionsPostRequestFormPaymentSettingsSepaDebitXf7f1c4a3NoMatchException(
                    "InlineV1SubscriptionsPostRequestFormPaymentSettingsSepaDebitXf7f1c4a3 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionsPostRequestFormPaymentSettingsSepaDebitXf7f1c4a3> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsPostRequestFormPaymentSettingsSepaDebitXf7f1c4a3,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1SubscriptionsPostRequestFormPaymentSettingsSepaDebitXf7f1c4a3",
...
private fun inspectInlineV1SubscriptionsPostRequestFormPaymentSettingsSepaDebitXf7f1c4a3(
    element: JsonElement,
): InlineV1SubscriptionsPostRequestFormPaymentSettingsSepaDebitXf7f1c4a3Inspection {
    val matchesBranch1 = element.isJsonDecodable<JsonObject>()
    val matchesInlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2Xef1e91da =
        element
            .isJsonDecodable<InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2Xef1e91da>()
    return InlineV1SubscriptionsPostRequestFormPaymentSettingsSepaDebitXf7f1c4a3Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2Xef1e91da) {
                    add(
                        "InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2Xef1e91da: value does not match InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2Xef1e91da",
                    )
                }
            },
    )
