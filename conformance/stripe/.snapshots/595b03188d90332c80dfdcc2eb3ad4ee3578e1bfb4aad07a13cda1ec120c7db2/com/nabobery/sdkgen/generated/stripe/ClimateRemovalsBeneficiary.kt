...
public class ClimateRemovalsBeneficiary(
    ...
    public object Serializer : KSerializer<ClimateRemovalsBeneficiary> {
        ...
        override fun deserialize(decoder: Decoder): ClimateRemovalsBeneficiary {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("ClimateRemovalsBeneficiary must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: ClimateRemovalsBeneficiary,
        ) {
...
public fun climateRemovalsBeneficiary(
    block: ClimateRemovalsBeneficiary.Builder.() -> Unit,
): ClimateRemovalsBeneficiary = ClimateRemovalsBeneficiary.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException("ClimateRemovalsBeneficiary is missing required property '" + name + "'")
