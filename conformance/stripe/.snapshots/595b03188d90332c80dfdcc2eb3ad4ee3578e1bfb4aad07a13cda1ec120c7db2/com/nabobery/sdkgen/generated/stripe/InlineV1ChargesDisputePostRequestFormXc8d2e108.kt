...
public class InlineV1ChargesDisputePostRequestFormXc8d2e108(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1ChargesDisputePostRequestFormXc8d2e108 =
            InlineV1ChargesDisputePostRequestFormXc8d2e108(
                evidence = evidence,
                expand = expand,
                metadata = metadata,
                submit = submit,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1ChargesDisputePostRequestFormXc8d2e108 =
    ...
    public object Serializer : KSerializer<InlineV1ChargesDisputePostRequestFormXc8d2e108> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1ChargesDisputePostRequestFormXc8d2e108 must be a JSON object",
                    )
            return InlineV1ChargesDisputePostRequestFormXc8d2e108(
                evidence =
                    rawObject["evidence"]?.let {
                        json.decodeFromJsonElement<InlineV1ChargesDisputePostRequestFormEvidenceXbae9196a>(it)
                    },
                expand = rawObject["expand"]?.let { json.decodeFromJsonElement<List<String>>(it) },
                metadata =
                    rawObject["metadata"]?.let {
                        json.decodeFromJsonElement<InlineV1ChargesDisputePostRequestFormMetadataX7e319697>(it)
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ChargesDisputePostRequestFormXc8d2e108,
        ) {
...
public fun inlineV1ChargesDisputePostRequestFormXc8d2e108(
    block: InlineV1ChargesDisputePostRequestFormXc8d2e108.Builder.() -> Unit,
): InlineV1ChargesDisputePostRequestFormXc8d2e108 = InlineV1ChargesDisputePostRequestFormXc8d2e108.build(block)
