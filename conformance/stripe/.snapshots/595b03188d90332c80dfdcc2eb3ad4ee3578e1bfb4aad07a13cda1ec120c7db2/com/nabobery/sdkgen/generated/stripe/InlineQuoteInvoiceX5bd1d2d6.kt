...
public class InlineQuoteInvoiceX5bd1d2d6 internal constructor(
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineQuoteInvoiceX5bd1d2d6 {
            val inspection = inspectInlineQuoteInvoiceX5bd1d2d6(raw)
            if (inspection.matchCount == 0) {
                throw InlineQuoteInvoiceX5bd1d2d6NoMatchException(
                    "InlineQuoteInvoiceX5bd1d2d6 matched 0 branches: " + inspection.failures.joinToString("; "),
                )
            }
    ...
    public object Serializer : KSerializer<InlineQuoteInvoiceX5bd1d2d6> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineQuoteInvoiceX5bd1d2d6,
        ) {
