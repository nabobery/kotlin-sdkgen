...
public class InlineV1TreasuryOutboundPaymentsGetParameterX04cf9e2e internal constructor(
    ...
    public val inlineV1TreasuryOutboundPaymentsGetParameterAnyOf1Xc9b533a6:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1TreasuryOutboundPaymentsGetParameterAnyOf1Xc9b533a6) {
                json
                    .decodeFromJsonElement<InlineV1TreasuryOutboundPaymentsGetParameterAnyOf1Xc9b533a6>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1TreasuryOutboundPaymentsGetParameterX04cf9e2eBranch>
        get() =
            buildSet {
                if (inspection.matchesInlineV1TreasuryOutboundPaymentsGetParameterAnyOf1Xc9b533a6) {
                    add(
                        InlineV1TreasuryOutboundPaymentsGetParameterX04cf9e2eBranch.InlineV1TreasuryOutboundPaymentsGetParameterAnyOf1Xc9b533a6,
                    )
                }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1TreasuryOutboundPaymentsGetParameterX04cf9e2e {
            val inspection = inspectInlineV1TreasuryOutboundPaymentsGetParameterX04cf9e2e(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1TreasuryOutboundPaymentsGetParameterX04cf9e2eNoMatchException(
                    "InlineV1TreasuryOutboundPaymentsGetParameterX04cf9e2e matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1TreasuryOutboundPaymentsGetParameterX04cf9e2e> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TreasuryOutboundPaymentsGetParameterX04cf9e2e,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1TreasuryOutboundPaymentsGetParameterX04cf9e2e",
...
private fun inspectInlineV1TreasuryOutboundPaymentsGetParameterX04cf9e2e(
    element: JsonElement,
): InlineV1TreasuryOutboundPaymentsGetParameterX04cf9e2eInspection {
    val matchesInlineV1TreasuryOutboundPaymentsGetParameterAnyOf1Xc9b533a6 =
        element
            .isJsonDecodable<InlineV1TreasuryOutboundPaymentsGetParameterAnyOf1Xc9b533a6>()
    ...
    return InlineV1TreasuryOutboundPaymentsGetParameterX04cf9e2eInspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1TreasuryOutboundPaymentsGetParameterAnyOf1Xc9b533a6) {
                    add(
                        "InlineV1TreasuryOutboundPaymentsGetParameterAnyOf1Xc9b533a6: value does not match InlineV1TreasuryOutboundPaymentsGetParameterAnyOf1Xc9b533a6",
                    )
                }
