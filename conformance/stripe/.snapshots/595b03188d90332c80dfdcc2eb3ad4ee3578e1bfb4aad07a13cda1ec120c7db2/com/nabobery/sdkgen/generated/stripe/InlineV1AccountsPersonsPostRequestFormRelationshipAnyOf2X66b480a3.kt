...
public sealed class InlineV1AccountsPersonsPostRequestFormRelationshipAnyOf2X66b480a3 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1AccountsPersonsPostRequestFormRelationshipAnyOf2X66b480a3 =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1AccountsPersonsPostRequestFormRelationshipAnyOf2X66b480a3> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1AccountsPersonsPostRequestFormRelationshipAnyOf2X66b480a3",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1AccountsPersonsPostRequestFormRelationshipAnyOf2X66b480a3 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPersonsPostRequestFormRelationshipAnyOf2X66b480a3,
        ) {
