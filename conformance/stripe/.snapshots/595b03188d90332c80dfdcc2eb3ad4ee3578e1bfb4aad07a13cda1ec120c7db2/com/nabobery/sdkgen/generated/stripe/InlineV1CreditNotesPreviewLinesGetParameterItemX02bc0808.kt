...
public class InlineV1CreditNotesPreviewLinesGetParameterItemX02bc0808(
    ...
    public val paymentRecordRefund: InlineV1CreditNotesPreviewLinesGetParameterItemPaymentRecordRefundXd721d2ed? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1CreditNotesPreviewLinesGetParameterItemX02bc0808 =
            InlineV1CreditNotesPreviewLinesGetParameterItemX02bc0808(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1CreditNotesPreviewLinesGetParameterItemX02bc0808 =
    ...
    public object Serializer : KSerializer<InlineV1CreditNotesPreviewLinesGetParameterItemX02bc0808> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CreditNotesPreviewLinesGetParameterItemX02bc0808 must be a JSON object",
                    )
            return InlineV1CreditNotesPreviewLinesGetParameterItemX02bc0808(
                ...
                paymentRecordRefund =
                    rawObject["payment_record_refund"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CreditNotesPreviewLinesGetParameterItemPaymentRecordRefundXd721d2ed>(
                                it,
                            )
                    },
                ...
                type =
                    rawObject["type"]?.let {
                        json.decodeFromJsonElement<InlineV1CreditNotesPreviewLinesGetParameterItemTypeX8230b043>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CreditNotesPreviewLinesGetParameterItemX02bc0808,
        ) {
...
public fun inlineV1CreditNotesPreviewLinesGetParameterItemX02bc0808(
    block: InlineV1CreditNotesPreviewLinesGetParameterItemX02bc0808.Builder.() -> Unit,
): InlineV1CreditNotesPreviewLinesGetParameterItemX02bc0808 =
    InlineV1CreditNotesPreviewLinesGetParameterItemX02bc0808.build(block)
