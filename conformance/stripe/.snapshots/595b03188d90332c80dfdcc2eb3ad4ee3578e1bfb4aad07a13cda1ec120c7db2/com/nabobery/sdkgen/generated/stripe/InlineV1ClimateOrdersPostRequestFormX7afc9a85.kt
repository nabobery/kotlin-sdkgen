...
public class InlineV1ClimateOrdersPostRequestFormX7afc9a85(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1ClimateOrdersPostRequestFormX7afc9a85 =
            InlineV1ClimateOrdersPostRequestFormX7afc9a85(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1ClimateOrdersPostRequestFormX7afc9a85 =
    ...
    public object Serializer : KSerializer<InlineV1ClimateOrdersPostRequestFormX7afc9a85> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1ClimateOrdersPostRequestFormX7afc9a85 must be a JSON object",
                    )
            return InlineV1ClimateOrdersPostRequestFormX7afc9a85(
                beneficiary =
                    rawObject["beneficiary"]?.let {
                        json.decodeFromJsonElement<InlineV1ClimateOrdersPostRequestFormBeneficiaryX13d0f1f7>(it)
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ClimateOrdersPostRequestFormX7afc9a85,
        ) {
...
public fun inlineV1ClimateOrdersPostRequestFormX7afc9a85(
    block: InlineV1ClimateOrdersPostRequestFormX7afc9a85.Builder.() -> Unit,
): InlineV1ClimateOrdersPostRequestFormX7afc9a85 = InlineV1ClimateOrdersPostRequestFormX7afc9a85.build(block)
