...
public sealed class InlineInboundTransfersPaymentMethodDetailsUsBankAccountNetworkXca8f6023 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineInboundTransfersPaymentMethodDetailsUsBankAccountNetworkXca8f6023 =
            when (value) {
                Ach.value -> Ach
    ...
    public object Serializer : KSerializer<InlineInboundTransfersPaymentMethodDetailsUsBankAccountNetworkXca8f6023> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineInboundTransfersPaymentMethodDetailsUsBankAccountNetworkXca8f6023",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineInboundTransfersPaymentMethodDetailsUsBankAccountNetworkXca8f6023 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineInboundTransfersPaymentMethodDetailsUsBankAccountNetworkXca8f6023,
        ) {
