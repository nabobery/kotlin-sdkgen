...
public class InlineV1BillingPortalConfigurationsPostRequestFormBusinessProfileX568fb2ea(
    public val headline: InlineV1BillingPortalConfiab44PostRequestFormBusinessProfileHeadlineX96eb4cf8? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1BillingPortalConfigurationsPostRequestFormBusinessProfileX568fb2ea =
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1BillingPortalConfigurationsPostRequestFormBusinessProfileX568fb2ea = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1BillingPortalConfigurationsPostRequestFormBusinessProfileX568fb2ea> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1BillingPortalConfigurationsPostRequestFormBusinessProfileX568fb2ea must be a JSON object",
                    )
            return InlineV1BillingPortalConfigurationsPostRequestFormBusinessProfileX568fb2ea(
                headline =
                    rawObject["headline"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1BillingPortalConfiab44PostRequestFormBusinessProfileHeadlineX96eb4cf8>(
                                it,
                            )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1BillingPortalConfigurationsPostRequestFormBusinessProfileX568fb2ea,
        ) {
            val jsonEncoder =
...
public fun inlineV1BillingPortalConfigurationsPostRequestFormBusinessProfileX568fb2ea(
    block: InlineV1BillingPortalConfigurationsPostRequestFormBusinessProfileX568fb2ea.Builder.() -> Unit,
): InlineV1BillingPortalConfigurationsPostRequestFormBusinessProfileX568fb2ea =
    InlineV1BillingPortalConfigurationsPostRequestFormBusinessProfileX568fb2ea.build(block)
