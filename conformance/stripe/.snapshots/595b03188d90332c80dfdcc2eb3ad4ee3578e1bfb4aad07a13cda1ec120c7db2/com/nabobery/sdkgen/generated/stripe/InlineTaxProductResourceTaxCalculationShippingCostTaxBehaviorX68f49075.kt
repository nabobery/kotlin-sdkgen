...
public sealed class InlineTaxProductResourceTaxCalculationShippingCostTaxBehaviorX68f49075 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineTaxProductResourceTaxCalculationShippingCostTaxBehaviorX68f49075 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineTaxProductResourceTaxCalculationShippingCostTaxBehaviorX68f49075> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineTaxProductResourceTaxCalculationShippingCostTaxBehaviorX68f49075",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineTaxProductResourceTaxCalculationShippingCostTaxBehaviorX68f49075 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineTaxProductResourceTaxCalculationShippingCostTaxBehaviorX68f49075,
        ) {
