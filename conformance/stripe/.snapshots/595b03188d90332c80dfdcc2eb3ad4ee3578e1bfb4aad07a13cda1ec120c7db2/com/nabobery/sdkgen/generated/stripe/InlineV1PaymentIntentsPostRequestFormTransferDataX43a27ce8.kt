...
public class InlineV1PaymentIntentsPostRequestFormTransferDataX43a27ce8(
    ...
    public val paymentData: InlineV1PaymentIntentsPostRequestFormTransferDataPaymentDataX28fb9b6a? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1PaymentIntentsPostRequestFormTransferDataX43a27ce8 =
            InlineV1PaymentIntentsPostRequestFormTransferDataX43a27ce8(
                amount = amount,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PaymentIntentsPostRequestFormTransferDataX43a27ce8 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormTransferDataX43a27ce8> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsPostRequestFormTransferDataX43a27ce8 must be a JSON object",
                    )
            return InlineV1PaymentIntentsPostRequestFormTransferDataX43a27ce8(
                ...
                metadata =
                    rawObject["metadata"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormTransferDataMetadataX80580355>(
                            it,
                        )
                    },
                paymentData =
                    rawObject["payment_data"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormTransferDataPaymentDataX28fb9b6a>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormTransferDataX43a27ce8,
        ) {
...
public fun inlineV1PaymentIntentsPostRequestFormTransferDataX43a27ce8(
    block: InlineV1PaymentIntentsPostRequestFormTransferDataX43a27ce8.Builder.() -> Unit,
): InlineV1PaymentIntentsPostRequestFormTransferDataX43a27ce8 =
    InlineV1PaymentIntentsPostRequestFormTransferDataX43a27ce8.build(block)
