...
public class InlinePayoutDestinationXa1b3c2cf internal constructor(
    ...
    public val deletedBankAccount: DeletedBankAccount? by
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesDeletedBankAccount) json.decodeFromJsonElement<DeletedBankAccount>(raw) else null
        }

    public val deletedCard: DeletedCard? by
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesDeletedCard) json.decodeFromJsonElement<DeletedCard>(raw) else null
        }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlinePayoutDestinationXa1b3c2cf {
            val inspection = inspectInlinePayoutDestinationXa1b3c2cf(raw)
            if (inspection.matchCount == 0) {
                throw InlinePayoutDestinationXa1b3c2cfNoMatchException(
                    "InlinePayoutDestinationXa1b3c2cf matched 0 branches: " + inspection.failures.joinToString("; "),
                )
            }
    ...
    public object Serializer : KSerializer<InlinePayoutDestinationXa1b3c2cf> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlinePayoutDestinationXa1b3c2cf,
        ) {
