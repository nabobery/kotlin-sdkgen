...
public sealed class InlineV1PaymentLinksPostRequestFormConsentCollectionPositionX4f4416ef {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1PaymentLinksPostRequestFormConsentCollectionPositionX4f4416ef =
            when (value) {
                Auto.value -> Auto
                Hidden.value -> Hidden
    ...
    public object Serializer : KSerializer<InlineV1PaymentLinksPostRequestFormConsentCollectionPositionX4f4416ef> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1PaymentLinksPostRequestFormConsentCollectionPositionX4f4416ef",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1PaymentLinksPostRequestFormConsentCollectionPositionX4f4416ef = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentLinksPostRequestFormConsentCollectionPositionX4f4416ef,
        ) {
