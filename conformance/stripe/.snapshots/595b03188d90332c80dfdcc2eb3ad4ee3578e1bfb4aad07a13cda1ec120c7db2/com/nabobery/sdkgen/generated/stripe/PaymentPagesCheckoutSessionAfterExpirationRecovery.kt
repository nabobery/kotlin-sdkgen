...
public class PaymentPagesCheckoutSessionAfterExpirationRecovery(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentPagesCheckoutSessionAfterExpirationRecovery =
    ...
    public object Serializer : KSerializer<PaymentPagesCheckoutSessionAfterExpirationRecovery> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "PaymentPagesCheckoutSessionAfterExpirationRecovery must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentPagesCheckoutSessionAfterExpirationRecovery,
        ) {
...
public fun paymentPagesCheckoutSessionAfterExpirationRecovery(
    block: PaymentPagesCheckoutSessionAfterExpirationRecovery.Builder.() -> Unit,
): PaymentPagesCheckoutSessionAfterExpirationRecovery = PaymentPagesCheckoutSessionAfterExpirationRecovery.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "PaymentPagesCheckoutSessionAfterExpirationRecovery is missing required property '" + name + "'",
            )
