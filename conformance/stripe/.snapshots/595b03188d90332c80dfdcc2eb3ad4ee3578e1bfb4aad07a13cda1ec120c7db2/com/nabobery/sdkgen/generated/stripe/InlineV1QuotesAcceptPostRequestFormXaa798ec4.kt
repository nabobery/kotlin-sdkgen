...
public class InlineV1QuotesAcceptPostRequestFormXaa798ec4(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1QuotesAcceptPostRequestFormXaa798ec4 =
            InlineV1QuotesAcceptPostRequestFormXaa798ec4(
                expand = expand,
            )
    }

    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1QuotesAcceptPostRequestFormXaa798ec4 =
    ...
    public object Serializer : KSerializer<InlineV1QuotesAcceptPostRequestFormXaa798ec4> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1QuotesAcceptPostRequestFormXaa798ec4 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1QuotesAcceptPostRequestFormXaa798ec4,
        ) {
...
public fun inlineV1QuotesAcceptPostRequestFormXaa798ec4(
    block: InlineV1QuotesAcceptPostRequestFormXaa798ec4.Builder.() -> Unit,
): InlineV1QuotesAcceptPostRequestFormXaa798ec4 = InlineV1QuotesAcceptPostRequestFormXaa798ec4.build(block)
