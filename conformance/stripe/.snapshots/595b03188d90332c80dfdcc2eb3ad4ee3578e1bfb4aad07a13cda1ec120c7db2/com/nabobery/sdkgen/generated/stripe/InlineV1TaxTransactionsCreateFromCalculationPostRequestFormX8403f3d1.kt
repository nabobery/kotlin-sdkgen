...
public class InlineV1TaxTransactionsCreateFromCalculationPostRequestFormX8403f3d1(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1TaxTransactionsCreateFromCalculationPostRequestFormX8403f3d1 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TaxTransactionsCreateFromCalculationPostRequestFormX8403f3d1> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TaxTransactionsCreateFromCalculationPostRequestFormX8403f3d1 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TaxTransactionsCreateFromCalculationPostRequestFormX8403f3d1,
        ) {
            val jsonEncoder =
...
public fun inlineV1TaxTransactionsCreateFromCalculationPostRequestFormX8403f3d1(
    block: InlineV1TaxTransactionsCreateFromCalculationPostRequestFormX8403f3d1.Builder.() -> Unit,
): InlineV1TaxTransactionsCreateFromCalculationPostRequestFormX8403f3d1 =
    InlineV1TaxTransactionsCreateFromCalculationPostRequestFormX8403f3d1.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TaxTransactionsCreateFromCalculationPostRequestFormX8403f3d1 is missing required property '" +
                    name +
                    "'",
            )
