...
public class PaymentFlowsAmountDetailsClient(
    ...
    public class Builder {
        ...
        public fun build(): PaymentFlowsAmountDetailsClient =
    ...
    public object Serializer : KSerializer<PaymentFlowsAmountDetailsClient> {
        ...
        override fun deserialize(decoder: Decoder): PaymentFlowsAmountDetailsClient {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentFlowsAmountDetailsClient must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentFlowsAmountDetailsClient,
        ) {
...
public fun paymentFlowsAmountDetailsClient(
    block: PaymentFlowsAmountDetailsClient.Builder.() -> Unit,
): PaymentFlowsAmountDetailsClient = PaymentFlowsAmountDetailsClient.build(block)
