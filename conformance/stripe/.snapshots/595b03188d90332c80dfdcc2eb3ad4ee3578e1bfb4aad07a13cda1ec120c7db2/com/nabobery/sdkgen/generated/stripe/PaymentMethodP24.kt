...
public class PaymentMethodP24(
    ...
    public class Builder {
        ...
        public fun build(): PaymentMethodP24 =
            PaymentMethodP24(
                bank = bank,
            )
    }
    ...
    public object Serializer : KSerializer<PaymentMethodP24> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodP24 {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodP24 must be a JSON object")
                ...
                bank =
                    rawObject["bank"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentMethodP24BankX61d2f5c0?>(element)
                        }
                    },
            )
        }
...
public fun paymentMethodP24(block: PaymentMethodP24.Builder.() -> Unit): PaymentMethodP24 =
    PaymentMethodP24.build(block)
