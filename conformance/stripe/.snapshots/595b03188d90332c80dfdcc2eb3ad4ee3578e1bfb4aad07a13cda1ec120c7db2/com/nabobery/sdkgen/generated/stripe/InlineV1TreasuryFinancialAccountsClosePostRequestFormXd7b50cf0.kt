...
public class InlineV1TreasuryFinancialAccountsClosePostRequestFormXd7b50cf0(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1TreasuryFinancialAccountsClosePostRequestFormXd7b50cf0 =
            InlineV1TreasuryFinancialAccountsClosePostRequestFormXd7b50cf0(
                expand = expand,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TreasuryFinancialAccountsClosePostRequestFormXd7b50cf0 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TreasuryFinancialAccountsClosePostRequestFormXd7b50cf0> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TreasuryFinancialAccountsClosePostRequestFormXd7b50cf0 must be a JSON object",
                    )
            return InlineV1TreasuryFinancialAccountsClosePostRequestFormXd7b50cf0(
                ...
                forwardingSettings =
                    rawObject["forwarding_settings"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TreasuryFinancialAccountsClosePostRequestFormForwardingSettingsX83fc6e93>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TreasuryFinancialAccountsClosePostRequestFormXd7b50cf0,
        ) {
            val jsonEncoder =
...
public fun inlineV1TreasuryFinancialAccountsClosePostRequestFormXd7b50cf0(
    block: InlineV1TreasuryFinancialAccountsClosePostRequestFormXd7b50cf0.Builder.() -> Unit,
): InlineV1TreasuryFinancialAccountsClosePostRequestFormXd7b50cf0 =
    InlineV1TreasuryFinancialAccountsClosePostRequestFormXd7b50cf0.build(block)
