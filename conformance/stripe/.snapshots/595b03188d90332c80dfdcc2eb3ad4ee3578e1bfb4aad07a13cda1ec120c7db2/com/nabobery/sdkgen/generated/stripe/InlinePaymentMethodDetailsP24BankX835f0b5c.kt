...
public sealed class InlinePaymentMethodDetailsP24BankX835f0b5c {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentMethodDetailsP24BankX835f0b5c =
            when (value) {
    ...
    public object Serializer : KSerializer<InlinePaymentMethodDetailsP24BankX835f0b5c> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentMethodDetailsP24BankX835f0b5c",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePaymentMethodDetailsP24BankX835f0b5c =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentMethodDetailsP24BankX835f0b5c,
        ) {
