...
public class IssuingAuthorizationMerchantData(
    ...
    public object Serializer : KSerializer<IssuingAuthorizationMerchantData> {
        ...
        override fun deserialize(decoder: Decoder): IssuingAuthorizationMerchantData {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("IssuingAuthorizationMerchantData must be a JSON object")
            ...
            return IssuingAuthorizationMerchantData(
                ...
                terminalId =
                    rawObject["terminal_id"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: IssuingAuthorizationMerchantData,
        ) {
...
public fun issuingAuthorizationMerchantData(
    block: IssuingAuthorizationMerchantData.Builder.() -> Unit,
): IssuingAuthorizationMerchantData = IssuingAuthorizationMerchantData.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "IssuingAuthorizationMerchantData is missing required property '" + name + "'",
            )
