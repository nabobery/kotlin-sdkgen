...
public class SubscriptionPaymentMethodOptionsMandateOptionsPix(
     ...
     */
    public val paymentSchedule: InlineSubscriptionPaymentMethodOptionsMandateOptionsPixPaymentScheduleX6710d2c8? = null,
) {
    public class Builder {
        ...
        public fun build(): SubscriptionPaymentMethodOptionsMandateOptionsPix =
            SubscriptionPaymentMethodOptionsMandateOptionsPix(
                amount = amount,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): SubscriptionPaymentMethodOptionsMandateOptionsPix =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<SubscriptionPaymentMethodOptionsMandateOptionsPix> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "SubscriptionPaymentMethodOptionsMandateOptionsPix must be a JSON object",
                    )
                ...
                amountIncludesIof =
                    rawObject["amount_includes_iof"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineSubscriptionPaymentM7e19AmountIncludesIofX36fe4134?>(
                                element,
                            )
                        }
                    },
                ...
                paymentSchedule =
                    rawObject["payment_schedule"]?.let { element ->
                        if (element ==
                            ...
                            json
                                .decodeFromJsonElement<InlineSubscriptionPaymentMethodOptionsMandateOptionsPixPaymentScheduleX6710d2c8?>(
                                    element,
                                )
                        }
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: SubscriptionPaymentMethodOptionsMandateOptionsPix,
        ) {
...
public fun subscriptionPaymentMethodOptionsMandateOptionsPix(
    block: SubscriptionPaymentMethodOptionsMandateOptionsPix.Builder.() -> Unit,
): SubscriptionPaymentMethodOptionsMandateOptionsPix = SubscriptionPaymentMethodOptionsMandateOptionsPix.build(block)
