...
public class InlineV1PaymentLinksPostRequestFormRestrictionsX5f21586b(
    public val completedSessions: InlineV1PaymentLinksPostRequestFormRestrictionsCompletedSessionsX3240a5b8,
) {
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PaymentLinksPostRequestFormRestrictionsX5f21586b =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentLinksPostRequestFormRestrictionsX5f21586b> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentLinksPostRequestFormRestrictionsX5f21586b must be a JSON object",
                    )
            val completedSessions =
                json
                    .decodeRequired<InlineV1PaymentLinksPostRequestFormRestrictionsCompletedSessionsX3240a5b8>(
                        rawObject,
                        "completed_sessions",
                    )
            return InlineV1PaymentLinksPostRequestFormRestrictionsX5f21586b(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentLinksPostRequestFormRestrictionsX5f21586b,
        ) {
...
public fun inlineV1PaymentLinksPostRequestFormRestrictionsX5f21586b(
    block: InlineV1PaymentLinksPostRequestFormRestrictionsX5f21586b.Builder.() -> Unit,
): InlineV1PaymentLinksPostRequestFormRestrictionsX5f21586b =
    InlineV1PaymentLinksPostRequestFormRestrictionsX5f21586b.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentLinksPostRequestFormRestrictionsX5f21586b is missing required property '" + name + "'",
            )
