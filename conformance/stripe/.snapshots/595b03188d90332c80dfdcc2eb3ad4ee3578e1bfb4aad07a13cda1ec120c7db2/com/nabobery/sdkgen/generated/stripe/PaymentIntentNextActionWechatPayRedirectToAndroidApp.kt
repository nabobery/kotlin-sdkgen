...
public class PaymentIntentNextActionWechatPayRedirectToAndroidApp(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentIntentNextActionWechatPayRedirectToAndroidApp =
    ...
    public object Serializer : KSerializer<PaymentIntentNextActionWechatPayRedirectToAndroidApp> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "PaymentIntentNextActionWechatPayRedirectToAndroidApp must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentIntentNextActionWechatPayRedirectToAndroidApp,
        ) {
...
public fun paymentIntentNextActionWechatPayRedirectToAndroidApp(
    block: PaymentIntentNextActionWechatPayRedirectToAndroidApp.Builder.() -> Unit,
): PaymentIntentNextActionWechatPayRedirectToAndroidApp =
    PaymentIntentNextActionWechatPayRedirectToAndroidApp.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "PaymentIntentNextActionWechatPayRedirectToAndroidApp is missing required property '" + name + "'",
            )
