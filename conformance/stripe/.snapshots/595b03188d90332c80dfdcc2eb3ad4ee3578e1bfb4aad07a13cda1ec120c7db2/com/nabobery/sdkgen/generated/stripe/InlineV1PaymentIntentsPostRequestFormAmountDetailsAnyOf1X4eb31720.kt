...
public class InlineV1PaymentIntentsPostRequestFormAmountDetailsAnyOf1X4eb31720(
    public val discountAmount: InlineV1PaymentIntentsPostRequestFormAmountDetailsAnyOf1DiscountAmountX2f88022d? = null,
    public val enforceArithmeticValidation: Boolean? = null,
    public val lineItems: InlineV1PaymentIntentsPostRequestFormAmountDetailsAnyOf1LineItemsX07427448? = null,
    public val shipping: InlineV1PaymentIntentsPostRequestFormAmountDetailsAnyOf1ShippingX0f2d58ae? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1PaymentIntentsPostRequestFormAmountDetailsAnyOf1X4eb31720 =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PaymentIntentsPostRequestFormAmountDetailsAnyOf1X4eb31720 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormAmountDetailsAnyOf1X4eb31720> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsPostRequestFormAmountDetailsAnyOf1X4eb31720 must be a JSON object",
                    )
            return InlineV1PaymentIntentsPostRequestFormAmountDetailsAnyOf1X4eb31720(
                discountAmount =
                    rawObject["discount_amount"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormAmountDetailsAnyOf1DiscountAmountX2f88022d>(
                                it,
                            )
                    },
                ...
                lineItems =
                    rawObject["line_items"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormAmountDetailsAnyOf1LineItemsX07427448>(
                                it,
                            )
                    },
                shipping =
                    rawObject["shipping"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormAmountDetailsAnyOf1ShippingX0f2d58ae>(
                                it,
                            )
                    },
                tax =
                    rawObject["tax"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormAmountDetailsAnyOf1TaxX32b00337>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormAmountDetailsAnyOf1X4eb31720,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentIntentsPostRequestFormAmountDetailsAnyOf1X4eb31720(
    block: InlineV1PaymentIntentsPostRequestFormAmountDetailsAnyOf1X4eb31720.Builder.() -> Unit,
): InlineV1PaymentIntentsPostRequestFormAmountDetailsAnyOf1X4eb31720 =
    InlineV1PaymentIntentsPostRequestFormAmountDetailsAnyOf1X4eb31720.build(block)
