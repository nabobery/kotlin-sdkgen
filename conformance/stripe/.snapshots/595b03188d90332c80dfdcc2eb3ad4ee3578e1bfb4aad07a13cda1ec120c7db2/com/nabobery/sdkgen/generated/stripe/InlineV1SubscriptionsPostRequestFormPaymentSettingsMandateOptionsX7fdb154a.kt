...
public class InlineV1SubscriptionsPostRequestFormPaymentSettingsMandateOptionsX7fdb154a(
    ...
    public val amountIncludesIof: InlineV1SubscriptionsPostRequestFormPaymentSettingsAmountIncludesIofXd4784b60? = null,
    public val endDate: String? = null,
    public val paymentSchedule: InlineV1SubscriptionsPostRequestFormPaymentSettingsPaymentScheduleX05bb3fbf? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1SubscriptionsPostRequestFormPaymentSettingsMandateOptionsX7fdb154a =
            InlineV1SubscriptionsPostRequestFormPaymentSettingsMandateOptionsX7fdb154a(
                amount = amount,
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1SubscriptionsPostRequestFormPaymentSettingsMandateOptionsX7fdb154a = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionsPostRequestFormPaymentSettingsMandateOptionsX7fdb154a> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SubscriptionsPostRequestFormPaymentSettingsMandateOptionsX7fdb154a must be a JSON object",
                    )
            return InlineV1SubscriptionsPostRequestFormPaymentSettingsMandateOptionsX7fdb154a(
                ...
                amountIncludesIof =
                    rawObject["amount_includes_iof"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormPaymentSettingsAmountIncludesIofXd4784b60>(
                                it,
                            )
                    },
                ...
                paymentSchedule =
                    rawObject["payment_schedule"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormPaymentSettingsPaymentScheduleX05bb3fbf>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsPostRequestFormPaymentSettingsMandateOptionsX7fdb154a,
        ) {
            val jsonEncoder =
...
public fun inlineV1SubscriptionsPostRequestFormPaymentSettingsMandateOptionsX7fdb154a(
    block: InlineV1SubscriptionsPostRequestFormPaymentSettingsMandateOptionsX7fdb154a.Builder.() -> Unit,
): InlineV1SubscriptionsPostRequestFormPaymentSettingsMandateOptionsX7fdb154a =
    InlineV1SubscriptionsPostRequestFormPaymentSettingsMandateOptionsX7fdb154a.build(block)
