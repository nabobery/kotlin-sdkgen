...
public sealed class InlineV1PaymentLinksPostRequestFormCustomFieldsItemLabelTypeX0129ff8a {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1PaymentLinksPostRequestFormCustomFieldsItemLabelTypeX0129ff8a =
            when (value) {
                Custom.value -> Custom
    ...
    public object Serializer : KSerializer<InlineV1PaymentLinksPostRequestFormCustomFieldsItemLabelTypeX0129ff8a> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1PaymentLinksPostRequestFormCustomFieldsItemLabelTypeX0129ff8a",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1PaymentLinksPostRequestFormCustomFieldsItemLabelTypeX0129ff8a = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentLinksPostRequestFormCustomFieldsItemLabelTypeX0129ff8a,
        ) {
