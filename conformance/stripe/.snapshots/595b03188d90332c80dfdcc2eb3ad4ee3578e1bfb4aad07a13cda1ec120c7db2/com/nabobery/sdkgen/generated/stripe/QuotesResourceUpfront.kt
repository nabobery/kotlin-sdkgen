        ...
        override fun deserialize(decoder: Decoder): QuotesResourceUpfront {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("QuotesResourceUpfront must be a JSON object")
            ...
            return QuotesResourceUpfront(
                ...
                lineItems =
                    rawObject["line_items"]?.let {
                        json.decodeFromJsonElement<InlineQuotesResourceUpfrontLineItemsX66509c0b>(it)
                    },
            )
        }
...
public fun quotesResourceUpfront(block: QuotesResourceUpfront.Builder.() -> Unit): QuotesResourceUpfront =
    QuotesResourceUpfront.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("QuotesResourceUpfront is missing required property '" + name + "'")
