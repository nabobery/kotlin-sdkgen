...
internal data class InlineV1TaxRegistrationsPostRequestFormActiveFromXf72e779bInspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesInlineV1TaxRegistrationsPostRequestFormActiveFromAnyOf1X54af9075,
                matchesBranch2,
            ).count { it }
}
...
public class InlineV1TaxRegistrationsPostRequestFormActiveFromXf72e779b internal constructor(
    ...
    public val inlineV1TaxRegistrationsPostRequestFormActiveFromAnyOf1X54af9075:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1TaxRegistrationsPostRequestFormActiveFromAnyOf1X54af9075) {
                json
                    .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormActiveFromAnyOf1X54af9075>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1TaxRegistrationsPostRequestFormActiveFromXf72e779bBranch>
        get() =
            buildSet {
                if (inspection.matchesInlineV1TaxRegistrationsPostRequestFormActiveFromAnyOf1X54af9075) {
                    add(
                        InlineV1TaxRegistrationsPostRequestFormActiveFromXf72e779bBranch.InlineV1TaxRegistrationsPostRequestFormActiveFromAnyOf1X54af9075,
                    )
                }
                if (inspection.matchesBranch2) {
                    add(
                        InlineV1TaxRegistrationsPostRequestFormActiveFromXf72e779bBranch.Branch2,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1TaxRegistrationsPostRequestFormActiveFromXf72e779b {
            val inspection = inspectInlineV1TaxRegistrationsPostRequestFormActiveFromXf72e779b(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1TaxRegistrationsPostRequestFormActiveFromXf72e779bNoMatchException(
                    "InlineV1TaxRegistrationsPostRequestFormActiveFromXf72e779b matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1TaxRegistrationsPostRequestFormActiveFromXf72e779b> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TaxRegistrationsPostRequestFormActiveFromXf72e779b,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1TaxRegistrationsPostRequestFormActiveFromXf72e779b",
...
private fun inspectInlineV1TaxRegistrationsPostRequestFormActiveFromXf72e779b(
    element: JsonElement,
): InlineV1TaxRegistrationsPostRequestFormActiveFromXf72e779bInspection {
    val matchesInlineV1TaxRegistrationsPostRequestFormActiveFromAnyOf1X54af9075 =
        element
            .isJsonDecodable<InlineV1TaxRegistrationsPostRequestFormActiveFromAnyOf1X54af9075>()
    ...
    return InlineV1TaxRegistrationsPostRequestFormActiveFromXf72e779bInspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1TaxRegistrationsPostRequestFormActiveFromAnyOf1X54af9075) {
                    add(
                        "InlineV1TaxRegistrationsPostRequestFormActiveFromAnyOf1X54af9075: value does not match InlineV1TaxRegistrationsPostRequestFormActiveFromAnyOf1X54af9075",
                    )
                }
