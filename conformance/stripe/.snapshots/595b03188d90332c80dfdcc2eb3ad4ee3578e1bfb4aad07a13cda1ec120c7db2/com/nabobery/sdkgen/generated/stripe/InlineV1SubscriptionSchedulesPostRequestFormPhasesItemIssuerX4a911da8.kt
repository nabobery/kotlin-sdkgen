...
public class InlineV1SubscriptionSchedulesPostRequestFormPhasesItemIssuerX4a911da8(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1SubscriptionSchedulesPostRequestFormPhasesItemIssuerX4a911da8 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemIssuerX4a911da8> {
        override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1SubscriptionSchedulesPostRequestFormPhasesItemIssuerX4a911da8 {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SubscriptionSchedulesPostRequestFormPhasesItemIssuerX4a911da8 must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemTypeX6bda21a9>(
                    rawObject,
                    "type",
                )
            return InlineV1SubscriptionSchedulesPostRequestFormPhasesItemIssuerX4a911da8(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionSchedulesPostRequestFormPhasesItemIssuerX4a911da8,
        ) {
            val jsonEncoder =
...
public fun inlineV1SubscriptionSchedulesPostRequestFormPhasesItemIssuerX4a911da8(
    block: InlineV1SubscriptionSchedulesPostRequestFormPhasesItemIssuerX4a911da8.Builder.() -> Unit,
): InlineV1SubscriptionSchedulesPostRequestFormPhasesItemIssuerX4a911da8 =
    InlineV1SubscriptionSchedulesPostRequestFormPhasesItemIssuerX4a911da8.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1SubscriptionSchedulesPostRequestFormPhasesItemIssuerX4a911da8 is missing required property '" +
                    name +
                    "'",
            )
