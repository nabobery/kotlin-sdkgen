...
internal data class InlineV1PaymentIntentsPostRequestFormPaymentMethodDataNameX440b5d6aInspection(
    ...
    public val matchCount: Int
        get() =
            listOf(matchesBranch1, matchesInlineV1PaymentIntentsPostRequestFormPaymentMethodDataAnyOf2X97057edc).count {
                it
            }
}
...
public class InlineV1PaymentIntentsPostRequestFormPaymentMethodDataNameX440b5d6a internal constructor(
    ...
    private val inspection: InlineV1PaymentIntentsPostRequestFormPaymentMethodDataNameX440b5d6aInspection,
) {
    ...
    public val inlineV1PaymentIntentsPostRequestFormPaymentMethodDataAnyOf2X97057edc:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1PaymentIntentsPostRequestFormPaymentMethodDataAnyOf2X97057edc) {
                json
                    .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodDataAnyOf2X97057edc>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1PaymentIntentsPostRequestFormPaymentMethodDataNameX440b5d6aBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1PaymentIntentsPostRequestFormPaymentMethodDataAnyOf2X97057edc) {
                    add(
                        InlineV1PaymentIntentsPostRequestFormPaymentMethodDataNameX440b5d6aBranch.InlineV1PaymentIntentsPostRequestFormPaymentMethodDataAnyOf2X97057edc,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1PaymentIntentsPostRequestFormPaymentMethodDataNameX440b5d6a {
            val inspection = inspectInlineV1PaymentIntentsPostRequestFormPaymentMethodDataNameX440b5d6a(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1PaymentIntentsPostRequestFormPaymentMethodDataNameX440b5d6aNoMatchException(
                    "InlineV1PaymentIntentsPostRequestFormPaymentMethodDataNameX440b5d6a matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormPaymentMethodDataNameX440b5d6a> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormPaymentMethodDataNameX440b5d6a,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1PaymentIntentsPostRequestFormPaymentMethodDataNameX440b5d6a",
...
private fun inspectInlineV1PaymentIntentsPostRequestFormPaymentMethodDataNameX440b5d6a(
    element: JsonElement,
): InlineV1PaymentIntentsPostRequestFormPaymentMethodDataNameX440b5d6aInspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1PaymentIntentsPostRequestFormPaymentMethodDataAnyOf2X97057edc =
        element
            .isJsonDecodable<InlineV1PaymentIntentsPostRequestFormPaymentMethodDataAnyOf2X97057edc>()
    return InlineV1PaymentIntentsPostRequestFormPaymentMethodDataNameX440b5d6aInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1PaymentIntentsPostRequestFormPaymentMethodDataAnyOf2X97057edc) {
                    add(
                        "InlineV1PaymentIntentsPostRequestFormPaymentMethodDataAnyOf2X97057edc: value does not match InlineV1PaymentIntentsPostRequestFormPaymentMethodDataAnyOf2X97057edc",
                    )
                }
            },
    )
