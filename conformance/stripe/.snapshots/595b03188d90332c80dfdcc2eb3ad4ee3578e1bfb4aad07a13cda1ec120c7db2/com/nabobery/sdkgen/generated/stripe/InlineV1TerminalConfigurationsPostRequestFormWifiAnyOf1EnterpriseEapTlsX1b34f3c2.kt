...
public class InlineV1TerminalConfigurationsPostRequestFormWifiAnyOf1EnterpriseEapTlsX1b34f3c2(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1TerminalConfigurationsPostRequestFormWifiAnyOf1EnterpriseEapTlsX1b34f3c2 =
    ...
    public object Serializer : KSerializer<InlineV1TerminalConfigurationsPostRequestFormWifiAnyOf1EnterpriseEapTlsX1b34f3c2> {
        ...
        override fun deserialize(
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TerminalConfigurationsPostRequestFormWifiAnyOf1EnterpriseEapTlsX1b34f3c2 must be a JSON object",
                    )
            ...
            return InlineV1TerminalConfigurationsPostRequestFormWifiAnyOf1EnterpriseEapTlsX1b34f3c2(
                ...
                privateKeyFilePassword =
                    rawObject["private_key_file_password"]?.let {
                        json
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TerminalConfigurationsPostRequestFormWifiAnyOf1EnterpriseEapTlsX1b34f3c2,
        ) {
            val jsonEncoder =
...
public fun inlineV1TerminalConfigurationsPostRequestFormWifiAnyOf1EnterpriseEapTlsX1b34f3c2(
    block: InlineV1TerminalConfigurationsPostRequestFormWifiAnyOf1EnterpriseEapTlsX1b34f3c2.Builder.() -> Unit,
): InlineV1TerminalConfigurationsPostRequestFormWifiAnyOf1EnterpriseEapTlsX1b34f3c2 =
    InlineV1TerminalConfigurationsPostRequestFormWifiAnyOf1EnterpriseEapTlsX1b34f3c2.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TerminalConfigurationsPostRequestFormWifiAnyOf1EnterpriseEapTlsX1b34f3c2 is missing required property '" +
                    name +
                    "'",
            )
