...
public class TransferSchedule(
     ...
     */
    public val weeklyPayoutDays: List<InlineTransferScheduleWeeklyPayoutDaysItemXf290ac3e>? = null,
) {
    public class Builder {
         ...
         */
        public var weeklyPayoutDays: List<InlineTransferScheduleWeeklyPayoutDaysItemXf290ac3e>? = null
        ...
        override fun deserialize(decoder: Decoder): TransferSchedule {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("TransferSchedule must be a JSON object")
            ...
            return TransferSchedule(
                ...
                weeklyPayoutDays =
                    rawObject["weekly_payout_days"]?.let {
                        json.decodeFromJsonElement<List<InlineTransferScheduleWeeklyPayoutDaysItemXf290ac3e>>(it)
                    },
            )
        }
...
public fun transferSchedule(block: TransferSchedule.Builder.() -> Unit): TransferSchedule =
    TransferSchedule.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("TransferSchedule is missing required property '" + name + "'")
