        ...
        override fun deserialize(decoder: Decoder): TreasuryCreditReversal {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("TreasuryCreditReversal must be a JSON object")
            ...
            val statusTransitions =
                json.decodeRequired<TreasuryReceivedCreditsResourceStatusTransitions>(
                    rawObject,
                    "status_transitions",
                )
            return TreasuryCreditReversal(
                ...
                transaction =
                    rawObject["transaction"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineTreasuryCreditReversalTransactionXa5ee8634?>(element)
                        }
                    },
            )
        }
...
public fun treasuryCreditReversal(block: TreasuryCreditReversal.Builder.() -> Unit): TreasuryCreditReversal =
    TreasuryCreditReversal.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("TreasuryCreditReversal is missing required property '" + name + "'")
