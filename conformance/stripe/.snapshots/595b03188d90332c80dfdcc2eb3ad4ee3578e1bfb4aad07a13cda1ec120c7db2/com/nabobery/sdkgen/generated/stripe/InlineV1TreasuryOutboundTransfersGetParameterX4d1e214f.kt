...
public sealed class InlineV1TreasuryOutboundTransfersGetParameterX4d1e214f {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1TreasuryOutboundTransfersGetParameterX4d1e214f =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1TreasuryOutboundTransfersGetParameterX4d1e214f> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1TreasuryOutboundTransfersGetParameterX4d1e214f",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1TreasuryOutboundTransfersGetParameterX4d1e214f =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TreasuryOutboundTransfersGetParameterX4d1e214f,
        ) {
