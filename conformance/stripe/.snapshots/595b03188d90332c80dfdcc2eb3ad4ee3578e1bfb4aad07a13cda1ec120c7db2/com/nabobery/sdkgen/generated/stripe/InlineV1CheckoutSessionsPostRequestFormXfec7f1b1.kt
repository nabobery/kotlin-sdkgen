...
public class InlineV1CheckoutSessionsPostRequestFormXfec7f1b1(
     ...
     */
    public val adaptivePricing: InlineV1CheckoutSessionsPostRequestFormAdaptivePricingX5d1e82e2? = null,
    /**
     * Configure actions after a Checkout Session has expired. You can't set this parameter if `ui_mode` is `elements`.
     */
    public val afterExpiration: InlineV1CheckoutSessionsPostRequestFormAfterExpirationX7ea5f057? = null,
    /**
     ...
     */
    public val billingAddressCollection: InlineV1CheckoutSessionsPostRequestFormBillingAddressCollectionX37212d9e? = null,
    /**
     * The branding settings for the Checkout Session. This parameter is not allowed if ui_mode is `elements`.
     */
    public val brandingSettings: InlineV1CheckoutSessionsPostRequestFormBrandingSettingsX3b77ee02? = null,
    /**
     ...
     */
    public val consentCollection: InlineV1CheckoutSessionsPostRequestFormConsentCollectionX6ac5d757? = null,
    /**
     ...
     */
    public val customFields: List<InlineV1CheckoutSessionsPostRequestFormCustomFieldsItemX590b8a05>? = null,
    /**
     ...
     */
    public val customerCreation: InlineV1CheckoutSessionsPostRequestFormCustomerCreationX27f4a406? = null,
    /**
     ...
     */
    public val discounts: List<InlineV1CheckoutSessionsPostRequestFormDiscountsItemX84449925>? = null,
    /**
     ...
     */
    public val invoiceCreation: InlineV1CheckoutSessionsPostRequestFormInvoiceCreationXe7ab14dd? = null,
    /**
     ...
     */
    public val lineItems: List<InlineV1CheckoutSessionsPostRequestFormLineItemsItemX5aad24f3>? = null,
    /**
     ...
     */
    public val managedPayments: InlineV1CheckoutSessionsPostRequestFormManagedPaymentsX28369c5b? = null,
    /**
     ...
     */
    public val optionalItems: List<InlineV1CheckoutSessionsPostRequestFormOptionalItemsItemX9e5ceb0b>? = null,
    /**
     ...
     */
    public val paymentIntentData: InlineV1CheckoutSessionsPostRequestFormPaymentIntentDataXcfe9f51b? = null,
    /**
     ...
     */
    public val paymentMethodCollection: InlineV1CheckoutSessionsPostRequestFormPaymentMethodCollectionX43f11047? = null,
    /**
     ...
     */
    public val paymentMethodData: InlineV1CheckoutSessionsPostRequestFormPaymentMethodDataX3301b232? = null,
    /**
     * Payment-method-specific configuration.
     */
    public val paymentMethodOptions: InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsX5148282f? = null,
    /**
     ...
     */
    public val paymentMethodTypes: List<InlineV1CheckoutSessionsPostRequestFormPaymentMethodTypesItemX121556da>? = null,
    /**
     ...
     */
    public val phoneNumberCollection: InlineV1CheckoutSessionsPostRequestFormPhoneNumberCollectionX61835e05? = null,
    /**
     ...
     */
    public val redirectOnCompletion: InlineV1CheckoutSessionsPostRequestFormRedirectOnCompletionX42846404? = null,
    /**
     ...
     */
    public val setupIntentData: InlineV1CheckoutSessionsPostRequestFormSetupIntentDataX67888f5d? = null,
    /**
     ...
     */
    public val shippingOptions: List<InlineV1CheckoutSessionsPostRequestFormShippingOptionsItemXe60b9845>? = null,
    /**
     ...
     */
    public val subscriptionData: InlineV1CheckoutSessionsPostRequestFormSubscriptionDataX72b0f8c5? = null,
    /**
     ...
     */
    public val taxIdCollection: InlineV1CheckoutSessionsPostRequestFormTaxIdCollectionX56a0acb8? = null,
    /**
    ...
    public class Builder {
        ...
        public fun build(): InlineV1CheckoutSessionsPostRequestFormXfec7f1b1 =
            InlineV1CheckoutSessionsPostRequestFormXfec7f1b1(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1CheckoutSessionsPostRequestFormXfec7f1b1 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormXfec7f1b1> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CheckoutSessionsPostRequestFormXfec7f1b1 must be a JSON object",
                    )
            return InlineV1CheckoutSessionsPostRequestFormXfec7f1b1(
                adaptivePricing =
                    rawObject["adaptive_pricing"]?.let {
                        json.decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormAdaptivePricingX5d1e82e2>(it)
                    },
                afterExpiration =
                    rawObject["after_expiration"]?.let {
                        json.decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormAfterExpirationX7ea5f057>(it)
                    },
                allowPromotionCodes =
                    rawObject["allow_promotion_codes"]?.let {
                        json
                ...
                automaticTax =
                    rawObject["automatic_tax"]?.let {
                        json.decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormAutomaticTaxX34813ec4>(it)
                    },
                billingAddressCollection =
                    rawObject["billing_address_collection"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormBillingAddressCollectionX37212d9e>(
                                it,
                            )
                    },
                brandingSettings =
                    rawObject["branding_settings"]?.let {
                        json.decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormBrandingSettingsX3b77ee02>(it)
                    },
                ...
                consentCollection =
                    rawObject["consent_collection"]?.let {
                        json.decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormConsentCollectionX6ac5d757>(
                            it,
                        )
                    },
                ...
                customFields =
                    rawObject["custom_fields"]?.let {
                        json
                            .decodeFromJsonElement<List<InlineV1CheckoutSessionsPostRequestFormCustomFieldsItemX590b8a05>>(
                                it,
                            )
                    },
                customText =
                    rawObject["custom_text"]?.let {
                        json.decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormCustomTextXeef1566c>(it)
                    },
                ...
                customerCreation =
                    rawObject["customer_creation"]?.let {
                        json.decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormCustomerCreationX27f4a406>(it)
                    },
                customerEmail = rawObject["customer_email"]?.let { json.decodeFromJsonElement<String>(it) },
                customerUpdate =
                    rawObject["customer_update"]?.let {
                        json.decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormCustomerUpdateX6b07f2a0>(it)
                    },
                discounts =
                    rawObject["discounts"]?.let {
                        json.decodeFromJsonElement<List<InlineV1CheckoutSessionsPostRequestFormDiscountsItemX84449925>>(
                            it,
                        )
                    },
                excludedPaymentMethodTypes =
                    rawObject["excluded_payment_method_types"]?.let {
                        json
                            .decodeFromJsonElement<List<InlineV1CheckoutSessionsPostRequestFormExcludedPaymentMethodTypesItemX41500b9c>>(
                                it,
                            )
                    },
                ...
                integrationIdentifier =
                    rawObject["integration_identifier"]?.let {
                        json.decodeFromJsonElement<String>(
                            it,
                        )
                    },
                invoiceCreation =
                    rawObject["invoice_creation"]?.let {
                        json.decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormInvoiceCreationXe7ab14dd>(it)
                    },
                lineItems =
                    rawObject["line_items"]?.let {
                        json.decodeFromJsonElement<List<InlineV1CheckoutSessionsPostRequestFormLineItemsItemX5aad24f3>>(
                            it,
                        )
                    },
                locale =
                    rawObject["locale"]?.let {
                        json.decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormLocaleXc67a5bfc>(it)
                    },
                managedPayments =
                    rawObject["managed_payments"]?.let {
                        json.decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormManagedPaymentsX28369c5b>(it)
                    },
                metadata =
                ...
                mode =
                    rawObject["mode"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormModeX4d491c23>(
                                it,
                            )
                    },
                nameCollection =
                    rawObject["name_collection"]?.let {
                        json.decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormNameCollectionXfd9fce63>(it)
                    },
                optionalItems =
                    rawObject["optional_items"]?.let {
                        json
                            .decodeFromJsonElement<List<InlineV1CheckoutSessionsPostRequestFormOptionalItemsItemX9e5ceb0b>>(
                                it,
                            )
                    },
                originContext =
                    rawObject["origin_context"]?.let {
                        json.decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormOriginContextX4100c26b>(it)
                    },
                paymentIntentData =
                    rawObject["payment_intent_data"]?.let {
                        json.decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormPaymentIntentDataXcfe9f51b>(
                            it,
                        )
                    },
                paymentMethodCollection =
                    rawObject["payment_method_collection"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormPaymentMethodCollectionX43f11047>(
                                it,
                            )
                    },
                ...
                paymentMethodData =
                    rawObject["payment_method_data"]?.let {
                        json.decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormPaymentMethodDataX3301b232>(
                            it,
                        )
                    },
                paymentMethodOptions =
                    rawObject["payment_method_options"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsX5148282f>(
                                it,
                            )
                    },
                paymentMethodTypes =
                    rawObject["payment_method_types"]?.let {
                        json
                            .decodeFromJsonElement<List<InlineV1CheckoutSessionsPostRequestFormPaymentMethodTypesItemX121556da>>(
                                it,
                            )
                    },
                permissions =
                    rawObject["permissions"]?.let {
                        json.decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormPermissionsX7c93388c>(it)
                    },
                phoneNumberCollection =
                    rawObject["phone_number_collection"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormPhoneNumberCollectionX61835e05>(
                                it,
                            )
                    },
                redirectOnCompletion =
                    rawObject["redirect_on_completion"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormRedirectOnCompletionX42846404>(
                                it,
                            )
                    },
                returnUrl =
                    rawObject["return_url"]?.let {
                        json
                            .decodeFromJsonElement<String>(
                                it,
                            )
                ...
                savedPaymentMethodOptions =
                    rawObject["saved_payment_method_options"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormSavedPaymentMethodOptionsX79a210d3>(
                                it,
                            )
                    },
                setupIntentData =
                    rawObject["setup_intent_data"]?.let {
                        json.decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormSetupIntentDataX67888f5d>(it)
                    },
                shippingAddressCollection =
                    rawObject["shipping_address_collection"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormShippingAddressCollectionX9637aeeb>(
                                it,
                            )
                    },
                shippingOptions =
                    rawObject["shipping_options"]?.let {
                        json
                            .decodeFromJsonElement<List<InlineV1CheckoutSessionsPostRequestFormShippingOptionsItemXe60b9845>>(
                                it,
                            )
                    },
                submitType =
                    rawObject["submit_type"]?.let {
                        json.decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormSubmitTypeXa86e74d8>(it)
                    },
                subscriptionData =
                    rawObject["subscription_data"]?.let {
                        json.decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormSubscriptionDataX72b0f8c5>(it)
                    },
                successUrl =
                    rawObject["success_url"]?.let {
                        json.decodeFromJsonElement<String>(
                            it,
                        )
                    },
                taxIdCollection =
                    rawObject["tax_id_collection"]?.let {
                        json.decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormTaxIdCollectionX56a0acb8>(it)
                    },
                uiMode =
                    rawObject["ui_mode"]?.let {
                        json.decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormUiModeXafa2252d>(it)
                    },
                walletOptions =
                    rawObject["wallet_options"]?.let {
                        json.decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormWalletOptionsX76a7ca24>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsPostRequestFormXfec7f1b1,
        ) {
            ...
            val raw =
                buildJsonObject {
                    ...
                    value.billingAddressCollection?.let {
                        put(
                    ...
                    value.paymentMethodCollection?.let {
                        put(
                    ...
                    value.savedPaymentMethodOptions?.let {
                        put(
                    ...
                    value.shippingAddressCollection?.let {
                        put(
...
public fun inlineV1CheckoutSessionsPostRequestFormXfec7f1b1(
    block: InlineV1CheckoutSessionsPostRequestFormXfec7f1b1.Builder.() -> Unit,
): InlineV1CheckoutSessionsPostRequestFormXfec7f1b1 = InlineV1CheckoutSessionsPostRequestFormXfec7f1b1.build(block)
