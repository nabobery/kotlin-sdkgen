...
public sealed class InlineTokenObjectValueX08395b4c {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineTokenObjectValueX08395b4c =
            when (value) {
                Token.value -> Token
    ...
    public object Serializer : KSerializer<InlineTokenObjectValueX08395b4c> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineTokenObjectValueX08395b4c",
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineTokenObjectValueX08395b4c,
        ) {
