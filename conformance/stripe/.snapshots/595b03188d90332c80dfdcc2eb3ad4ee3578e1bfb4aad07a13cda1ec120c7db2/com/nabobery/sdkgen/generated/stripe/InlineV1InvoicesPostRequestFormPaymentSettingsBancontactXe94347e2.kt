...
internal data class InlineV1InvoicesPostRequestFormPaymentSettingsBancontactXe94347e2Inspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X6e9c7ae2,
                matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2X50bf992e,
            ).count {
                it
            }
}
...
public class InlineV1InvoicesPostRequestFormPaymentSettingsBancontactXe94347e2 internal constructor(
    ...
    private val inspection: InlineV1InvoicesPostRequestFormPaymentSettingsBancontactXe94347e2Inspection,
) {
    public val inlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X6e9c7ae2:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X6e9c7ae2) {
                json
                    .decodeFromJsonElement<InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X6e9c7ae2>(
                        raw,
                    )
            } else {
                null
    ...
    public val inlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2X50bf992e:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2X50bf992e) {
                json
                    .decodeFromJsonElement<InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2X50bf992e>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches:
        ...
        get() =
            buildSet {
                if (inspection.matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X6e9c7ae2) {
                    add(
                        InlineV1InvoicesPostRequestFormPaymentSettingsBancontactXe94347e2Branch.InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X6e9c7ae2,
                    )
                }
                if (inspection.matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2X50bf992e) {
                    add(
                        InlineV1InvoicesPostRequestFormPaymentSettingsBancontactXe94347e2Branch.InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2X50bf992e,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1InvoicesPostRequestFormPaymentSettingsBancontactXe94347e2 {
            val inspection = inspectInlineV1InvoicesPostRequestFormPaymentSettingsBancontactXe94347e2(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1InvoicesPostRequestFormPaymentSettingsBancontactXe94347e2NoMatchException(
                    "InlineV1InvoicesPostRequestFormPaymentSettingsBancontactXe94347e2 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1InvoicesPostRequestFormPaymentSettingsBancontactXe94347e2> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesPostRequestFormPaymentSettingsBancontactXe94347e2,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1InvoicesPostRequestFormPaymentSettingsBancontactXe94347e2",
...
private fun inspectInlineV1InvoicesPostRequestFormPaymentSettingsBancontactXe94347e2(
    element: JsonElement,
): InlineV1InvoicesPostRequestFormPaymentSettingsBancontactXe94347e2Inspection {
    val matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X6e9c7ae2 =
        element
            .isJsonDecodable<InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X6e9c7ae2>()
    val matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2X50bf992e =
        element
            .isJsonDecodable<InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2X50bf992e>()
    return InlineV1InvoicesPostRequestFormPaymentSettingsBancontactXe94347e2Inspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X6e9c7ae2) {
                    add(
                        "InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X6e9c7ae2: value does not match InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf1X6e9c7ae2",
                    )
                }
                if (!matchesInlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2X50bf992e) {
                    add(
                        "InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2X50bf992e: value does not match InlineV1InvoicesPostRequestFormPaymentSettingsAnyOf2X50bf992e",
                    )
                }
            },
    )
