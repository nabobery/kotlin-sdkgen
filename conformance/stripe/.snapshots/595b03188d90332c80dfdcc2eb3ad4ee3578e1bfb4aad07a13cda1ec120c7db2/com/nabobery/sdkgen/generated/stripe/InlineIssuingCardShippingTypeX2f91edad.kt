...
public sealed class InlineIssuingCardShippingTypeX2f91edad {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineIssuingCardShippingTypeX2f91edad =
            when (value) {
                Bulk.value -> Bulk
    ...
    public object Serializer : KSerializer<InlineIssuingCardShippingTypeX2f91edad> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineIssuingCardShippingTypeX2f91edad",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineIssuingCardShippingTypeX2f91edad =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineIssuingCardShippingTypeX2f91edad,
        ) {
