...
public class InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemX9c355106(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemX9c355106 =
            InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemX9c355106(
                coupon = coupon,
                discount = discount,
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemX9c355106 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemX9c355106> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemX9c355106 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemX9c355106,
        ) {
            val jsonEncoder =
...
public fun inlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemX9c355106(
    block: InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemX9c355106.Builder.() -> Unit,
): InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemX9c355106 =
    InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemX9c355106.build(block)
