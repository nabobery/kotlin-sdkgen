...
public sealed class InlineInsightsResourcesPaymentEvaluationOutcomeTypeXdeb70113 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineInsightsResourcesPaymentEvaluationOutcomeTypeXdeb70113 =
            when (value) {
                Failed.value -> Failed
    ...
    public object Serializer : KSerializer<InlineInsightsResourcesPaymentEvaluationOutcomeTypeXdeb70113> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineInsightsResourcesPaymentEvaluationOutcomeTypeXdeb70113",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineInsightsResourcesPaymentEvaluationOutcomeTypeXdeb70113 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineInsightsResourcesPaymentEvaluationOutcomeTypeXdeb70113,
        ) {
