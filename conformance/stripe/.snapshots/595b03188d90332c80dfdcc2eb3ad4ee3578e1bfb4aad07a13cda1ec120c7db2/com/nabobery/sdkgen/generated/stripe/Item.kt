...
public class Item(
     ...
     */
    public val discounts: List<LineItemsDiscountAmount>? = null,
    /**
    ...
    public class Builder {
         ...
         * The discounts applied to the line item.
         */
        public var discounts: List<LineItemsDiscountAmount>? = null
        ...
        override fun deserialize(decoder: Decoder): Item {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("Item must be a JSON object")
            ...
            return Item(
                ...
                adjustableQuantity =
                    rawObject["adjustable_quantity"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineItemAdjustableQuantityXcf27880b?>(element)
                        }
                    },
                description =
                ...
                discounts =
                    rawObject["discounts"]?.let {
                        json.decodeFromJsonElement<List<LineItemsDiscountAmount>>(
                            it,
                        )
                    },
                metadata =
                ...
                price =
                    rawObject["price"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineItemPriceXbaa2d9e5?>(element)
                        }
                    },
                quantity =
