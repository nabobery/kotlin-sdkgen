...
public class InlineV1CustomersSubscriptionsGetResponse200JsonX7fa17575(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1CustomersSubscriptionsGetResponse200JsonX7fa17575 =
    ...
    public object Serializer : KSerializer<InlineV1CustomersSubscriptionsGetResponse200JsonX7fa17575> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CustomersSubscriptionsGetResponse200JsonX7fa17575 must be a JSON object",
                    )
            val data = json.decodeRequired<List<Subscription>>(rawObject, "data")
            val hasMore = json.decodeRequired<Boolean>(rawObject, "has_more")
            val objectValue =
                json.decodeRequired<InlineV1CustomersSubscriptionsGetResponse200JsonObjectValueX315a74f9>(
                    rawObject,
                    "object",
                )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersSubscriptionsGetResponse200JsonX7fa17575,
        ) {
...
public fun inlineV1CustomersSubscriptionsGetResponse200JsonX7fa17575(
    block: InlineV1CustomersSubscriptionsGetResponse200JsonX7fa17575.Builder.() -> Unit,
): InlineV1CustomersSubscriptionsGetResponse200JsonX7fa17575 =
    InlineV1CustomersSubscriptionsGetResponse200JsonX7fa17575.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1CustomersSubscriptionsGetResponse200JsonX7fa17575 is missing required property '" + name + "'",
            )
