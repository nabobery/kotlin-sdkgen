...
public class InlineV1AccountsPostRequestFormGroupsX5f919c2b(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1AccountsPostRequestFormGroupsX5f919c2b =
            InlineV1AccountsPostRequestFormGroupsX5f919c2b(
                paymentsPricing = paymentsPricing,
            )
    }

    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1AccountsPostRequestFormGroupsX5f919c2b =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1AccountsPostRequestFormGroupsX5f919c2b> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountsPostRequestFormGroupsX5f919c2b must be a JSON object",
                    )
            return InlineV1AccountsPostRequestFormGroupsX5f919c2b(
                paymentsPricing =
                    rawObject["payments_pricing"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPostRequestFormGroupsPaymentsPricingX882df9c5>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPostRequestFormGroupsX5f919c2b,
        ) {
...
public fun inlineV1AccountsPostRequestFormGroupsX5f919c2b(
    block: InlineV1AccountsPostRequestFormGroupsX5f919c2b.Builder.() -> Unit,
): InlineV1AccountsPostRequestFormGroupsX5f919c2b = InlineV1AccountsPostRequestFormGroupsX5f919c2b.build(block)
