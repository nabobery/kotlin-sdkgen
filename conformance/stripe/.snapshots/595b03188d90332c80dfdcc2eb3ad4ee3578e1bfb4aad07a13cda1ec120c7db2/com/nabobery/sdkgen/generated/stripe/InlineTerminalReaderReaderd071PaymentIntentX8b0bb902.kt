...
public class InlineTerminalReaderReaderd071PaymentIntentX8b0bb902 internal constructor(
        ...
        get() =
            buildSet {
                ...
                if (inspection.matchesPaymentIntent) {
                    add(
                        InlineTerminalReaderReaderd071PaymentIntentX8b0bb902Branch.PaymentIntent,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineTerminalReaderReaderd071PaymentIntentX8b0bb902 {
            val inspection = inspectInlineTerminalReaderReaderd071PaymentIntentX8b0bb902(raw)
            if (inspection.matchCount == 0) {
                throw InlineTerminalReaderReaderd071PaymentIntentX8b0bb902NoMatchException(
                    "InlineTerminalReaderReaderd071PaymentIntentX8b0bb902 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineTerminalReaderReaderd071PaymentIntentX8b0bb902> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineTerminalReaderReaderd071PaymentIntentX8b0bb902,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineTerminalReaderReaderd071PaymentIntentX8b0bb902",
...
private fun inspectInlineTerminalReaderReaderd071PaymentIntentX8b0bb902(
    element: JsonElement,
): InlineTerminalReaderReaderd071PaymentIntentX8b0bb902Inspection {
