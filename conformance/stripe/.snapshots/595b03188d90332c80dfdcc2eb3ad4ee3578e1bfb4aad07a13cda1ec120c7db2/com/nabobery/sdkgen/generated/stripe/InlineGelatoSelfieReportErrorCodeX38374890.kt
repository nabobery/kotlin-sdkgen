...
public sealed class InlineGelatoSelfieReportErrorCodeX38374890 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineGelatoSelfieReportErrorCodeX38374890 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineGelatoSelfieReportErrorCodeX38374890> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineGelatoSelfieReportErrorCodeX38374890",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineGelatoSelfieReportErrorCodeX38374890 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineGelatoSelfieReportErrorCodeX38374890,
        ) {
