...
public class InlineV1SetupIntentsPostRequestFormPaymentMethodDataP24X4324f131(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1SetupIntentsPostRequestFormPaymentMethodDataP24X4324f131 =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1SetupIntentsPostRequestFormPaymentMethodDataP24X4324f131 =
    ...
    public object Serializer : KSerializer<InlineV1SetupIntentsPostRequestFormPaymentMethodDataP24X4324f131> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SetupIntentsPostRequestFormPaymentMethodDataP24X4324f131 must be a JSON object",
                    )
            return InlineV1SetupIntentsPostRequestFormPaymentMethodDataP24X4324f131(
                bank =
                    rawObject["bank"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodDataP24BankX828791f9>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SetupIntentsPostRequestFormPaymentMethodDataP24X4324f131,
        ) {
            val jsonEncoder =
...
public fun inlineV1SetupIntentsPostRequestFormPaymentMethodDataP24X4324f131(
    block: InlineV1SetupIntentsPostRequestFormPaymentMethodDataP24X4324f131.Builder.() -> Unit,
): InlineV1SetupIntentsPostRequestFormPaymentMethodDataP24X4324f131 =
    InlineV1SetupIntentsPostRequestFormPaymentMethodDataP24X4324f131.build(block)
