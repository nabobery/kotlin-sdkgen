...
public class InlineV1CustomersCardsPostRequestFormCardAnyOf1X0e7c1476(
    ...
    public val networkToken: InlineV1CustomersCardsPostRequestFormCardAnyOf1NetworkTokenX442fac8a? = null,
    public val objectValue: InlineV1CustomersCardsPostRequestFormCardAnyOf1ObjectValueX92f6509c? = null,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1CustomersCardsPostRequestFormCardAnyOf1X0e7c1476 =
    ...
    public object Serializer : KSerializer<InlineV1CustomersCardsPostRequestFormCardAnyOf1X0e7c1476> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CustomersCardsPostRequestFormCardAnyOf1X0e7c1476 must be a JSON object",
                    )
            ...
            return InlineV1CustomersCardsPostRequestFormCardAnyOf1X0e7c1476(
                ...
                networkToken =
                    rawObject["network_token"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CustomersCardsPostRequestFormCardAnyOf1NetworkTokenX442fac8a>(
                                it,
                            )
                    },
                objectValue =
                    rawObject["object"]?.let {
                        json.decodeFromJsonElement<InlineV1CustomersCardsPostRequestFormCardAnyOf1ObjectValueX92f6509c>(
                            it,
                        )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersCardsPostRequestFormCardAnyOf1X0e7c1476,
        ) {
...
public fun inlineV1CustomersCardsPostRequestFormCardAnyOf1X0e7c1476(
    block: InlineV1CustomersCardsPostRequestFormCardAnyOf1X0e7c1476.Builder.() -> Unit,
): InlineV1CustomersCardsPostRequestFormCardAnyOf1X0e7c1476 =
    InlineV1CustomersCardsPostRequestFormCardAnyOf1X0e7c1476.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1CustomersCardsPostRequestFormCardAnyOf1X0e7c1476 is missing required property '" + name + "'",
            )
