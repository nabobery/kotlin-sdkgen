...
internal data class InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceStateXf42cd4ccInspection(
    ...
    public val matchesInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2Xadd8b9b1: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2Xadd8b9b1,
            ).count {
                it
            }
}
...
public class InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceStateXf42cd4cc internal constructor(
    ...
    private val inspection: InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceStateXf42cd4ccInspection,
) {
    ...
    public val inlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2Xadd8b9b1:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2Xadd8b9b1) {
                json
                    .decodeFromJsonElement<InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2Xadd8b9b1>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceStateXf42cd4ccBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2Xadd8b9b1) {
                    add(
                        InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceStateXf42cd4ccBranch.InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2Xadd8b9b1,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceStateXf42cd4cc {
            val inspection = inspectInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceStateXf42cd4cc(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceStateXf42cd4ccNoMatchException(
                    "InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceStateXf42cd4cc matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceStateXf42cd4cc> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceStateXf42cd4cc,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceStateXf42cd4cc",
...
private fun inspectInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceStateXf42cd4cc(
    element: JsonElement,
): InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceStateXf42cd4ccInspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2Xadd8b9b1 =
        element
            .isJsonDecodable<InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2Xadd8b9b1>()
    return InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceStateXf42cd4ccInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2Xadd8b9b1) {
                    add(
                        "InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2Xadd8b9b1: value does not match InlineV1ChargesDisputePostRequestFormEvidenceEnhancedEvidenceAnyOf2Xadd8b9b1",
                    )
                }
            },
    )
