...
public class InlineV1InvoicesUpdateLinesPostRequestFormLinesItemPriceDataX2a66dd7b(
    ...
    public val productData: InlineV1InvoicesUpdateLinesPostRequestFormLinesItemPriceDataProductDataXb15ffacf? = null,
    public val taxBehavior: InlineV1InvoicesUpdateLinesPostRequestFormLinesItemPriceDataTaxBehaviorX1db0ed7a? = null,
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1InvoicesUpdateLinesPostRequestFormLinesItemPriceDataX2a66dd7b = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1InvoicesUpdateLinesPostRequestFormLinesItemPriceDataX2a66dd7b> {
        ...
        override fun deserialize(
            decoder: Decoder,
        ): InlineV1InvoicesUpdateLinesPostRequestFormLinesItemPriceDataX2a66dd7b {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1InvoicesUpdateLinesPostRequestFormLinesItemPriceDataX2a66dd7b must be a JSON object",
                    )
            ...
            return InlineV1InvoicesUpdateLinesPostRequestFormLinesItemPriceDataX2a66dd7b(
                ...
                productData =
                    rawObject["product_data"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1InvoicesUpdateLinesPostRequestFormLinesItemPriceDataProductDataXb15ffacf>(
                                it,
                            )
                    },
                taxBehavior =
                    rawObject["tax_behavior"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1InvoicesUpdateLinesPostRequestFormLinesItemPriceDataTaxBehaviorX1db0ed7a>(
                                it,
                            )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesUpdateLinesPostRequestFormLinesItemPriceDataX2a66dd7b,
        ) {
            val jsonEncoder =
...
public fun inlineV1InvoicesUpdateLinesPostRequestFormLinesItemPriceDataX2a66dd7b(
    block: InlineV1InvoicesUpdateLinesPostRequestFormLinesItemPriceDataX2a66dd7b.Builder.() -> Unit,
): InlineV1InvoicesUpdateLinesPostRequestFormLinesItemPriceDataX2a66dd7b =
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1InvoicesUpdateLinesPostRequestFormLinesItemPriceDataX2a66dd7b is missing required property '" +
                    name +
                    "'",
            )
