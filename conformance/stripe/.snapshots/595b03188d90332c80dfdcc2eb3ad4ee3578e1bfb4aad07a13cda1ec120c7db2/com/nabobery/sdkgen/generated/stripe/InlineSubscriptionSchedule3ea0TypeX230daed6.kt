...
public sealed class InlineSubscriptionSchedule3ea0TypeX230daed6 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineSubscriptionSchedule3ea0TypeX230daed6 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineSubscriptionSchedule3ea0TypeX230daed6> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineSubscriptionSchedule3ea0TypeX230daed6",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineSubscriptionSchedule3ea0TypeX230daed6 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineSubscriptionSchedule3ea0TypeX230daed6,
        ) {
