...
public class InlineSetupAttemptOnBehalfOfXe2975a98 internal constructor(
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineSetupAttemptOnBehalfOfXe2975a98 {
            val inspection = inspectInlineSetupAttemptOnBehalfOfXe2975a98(raw)
            if (inspection.matchCount == 0) {
                throw InlineSetupAttemptOnBehalfOfXe2975a98NoMatchException(
                    "InlineSetupAttemptOnBehalfOfXe2975a98 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineSetupAttemptOnBehalfOfXe2975a98> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineSetupAttemptOnBehalfOfXe2975a98,
        ) {
...
private fun inspectInlineSetupAttemptOnBehalfOfXe2975a98(
    element: JsonElement,
): InlineSetupAttemptOnBehalfOfXe2975a98Inspection {
