...
internal data class InlineV1PaymentIntentsCapturePostRequestFormHooksInputsTaxCalculationXb4d8e264Inspection(
    ...
    public val matchesInlineV1PaymentIntentsCapturePostRequestFormHooksInputsTaxAnyOf2X35eaa12c: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1PaymentIntentsCapturePostRequestFormHooksInputsTaxAnyOf2X35eaa12c,
            ).count {
                it
            }
}
...
public class InlineV1PaymentIntentsCapturePostRequestFormHooksInputsTaxCalculationXb4d8e264 internal constructor(
    ...
    private val inspection: InlineV1PaymentIntentsCapturePostRequestFormHooksInputsTaxCalculationXb4d8e264Inspection,
) {
    ...
    public val inlineV1PaymentIntentsCapturePostRequestFormHooksInputsTaxAnyOf2X35eaa12c:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1PaymentIntentsCapturePostRequestFormHooksInputsTaxAnyOf2X35eaa12c) {
                json
                    .decodeFromJsonElement<InlineV1PaymentIntentsCapturePostRequestFormHooksInputsTaxAnyOf2X35eaa12c>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1PaymentIntentsCapturePostRequestFormHooksInputsTaxCalculationXb4d8e264Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1PaymentIntentsCapturePostRequestFormHooksInputsTaxAnyOf2X35eaa12c) {
                    add(
                        InlineV1PaymentIntentsCapturePostRequestFormHooksInputsTaxCalculationXb4d8e264Branch.InlineV1PaymentIntentsCapturePostRequestFormHooksInputsTaxAnyOf2X35eaa12c,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            ...
            if (inspection.matchCount == 0) {
                throw InlineV1PaymentIntentsCapturePostRequestFormHooksInputsTaxCalculationXb4d8e264NoMatchException(
                    "InlineV1PaymentIntentsCapturePostRequestFormHooksInputsTaxCalculationXb4d8e264 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsCapturePostRequestFormHooksInputsTaxCalculationXb4d8e264> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsCapturePostRequestFormHooksInputsTaxCalculationXb4d8e264,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1PaymentIntentsCapturePostRequestFormHooksInputsTaxCalculationXb4d8e264",
...
private fun inspectInlineV1PaymentIntentsCapturePostRequestFormHooksInputsTaxCalculationXb4d8e264(
    element: JsonElement,
): InlineV1PaymentIntentsCapturePostRequestFormHooksInputsTaxCalculationXb4d8e264Inspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1PaymentIntentsCapturePostRequestFormHooksInputsTaxAnyOf2X35eaa12c =
        element
            .isJsonDecodable<InlineV1PaymentIntentsCapturePostRequestFormHooksInputsTaxAnyOf2X35eaa12c>()
    return InlineV1PaymentIntentsCapturePostRequestFormHooksInputsTaxCalculationXb4d8e264Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1PaymentIntentsCapturePostRequestFormHooksInputsTaxAnyOf2X35eaa12c) {
                    add(
                        "InlineV1PaymentIntentsCapturePostRequestFormHooksInputsTaxAnyOf2X35eaa12c: value does not match InlineV1PaymentIntentsCapturePostRequestFormHooksInputsTaxAnyOf2X35eaa12c",
                    )
                }
            },
    )
