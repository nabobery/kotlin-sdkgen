...
public sealed class InlineCheckoutLinkWalletOptionsDisplayXdd4f6193 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineCheckoutLinkWalletOptionsDisplayXdd4f6193 =
            when (value) {
                Auto.value -> Auto
                Never.value -> Never
    ...
    public object Serializer : KSerializer<InlineCheckoutLinkWalletOptionsDisplayXdd4f6193> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineCheckoutLinkWalletOptionsDisplayXdd4f6193",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineCheckoutLinkWalletOptionsDisplayXdd4f6193 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineCheckoutLinkWalletOptionsDisplayXdd4f6193,
        ) {
