...
public sealed class InlineTaxRateJurisdictionLevelX63ce8669 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineTaxRateJurisdictionLevelX63ce8669 =
            when (value) {
                City.value -> City
    ...
    public object Serializer : KSerializer<InlineTaxRateJurisdictionLevelX63ce8669> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineTaxRateJurisdictionLevelX63ce8669",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineTaxRateJurisdictionLevelX63ce8669 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineTaxRateJurisdictionLevelX63ce8669,
        ) {
