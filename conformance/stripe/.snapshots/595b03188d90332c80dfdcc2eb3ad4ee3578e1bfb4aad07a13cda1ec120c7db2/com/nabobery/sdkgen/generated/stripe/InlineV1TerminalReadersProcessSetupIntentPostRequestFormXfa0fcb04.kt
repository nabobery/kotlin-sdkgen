...
public class InlineV1TerminalReadersProcessSetupIntentPostRequestFormXfa0fcb04(
     ...
     */
    public val allowRedisplay: InlineV1TerminalReadersProcessSetupIntentPostRequestFormAllowRedisplayX037c7bf8,
    /**
     ...
     */
    public val processConfig: InlineV1TerminalReadersProcessSetupIntentPostRequestFormProcessConfigXfd1aeb47? = null,
) {
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TerminalReadersProcessSetupIntentPostRequestFormXfa0fcb04 =
    ...
    public object Serializer : KSerializer<InlineV1TerminalReadersProcessSetupIntentPostRequestFormXfa0fcb04> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1TerminalReadersProcessSetupIntentPostRequestFormXfa0fcb04 {
            val jsonDecoder =
                decoder.requireJsonDecoder(
                    "InlineV1TerminalReadersProcessSetupIntentPostRequestFormXfa0fcb04",
                )
            val json = jsonDecoder.json
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TerminalReadersProcessSetupIntentPostRequestFormXfa0fcb04 must be a JSON object",
                    )
            val allowRedisplay =
                json
                    .decodeRequired<InlineV1TerminalReadersProcessSetupIntentPostRequestFormAllowRedisplayX037c7bf8>(
                        rawObject,
                        "allow_redisplay",
                    )
            ...
            return InlineV1TerminalReadersProcessSetupIntentPostRequestFormXfa0fcb04(
                ...
                processConfig =
                    rawObject["process_config"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TerminalReadersProcessSetupIntentPostRequestFormProcessConfigXfd1aeb47>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TerminalReadersProcessSetupIntentPostRequestFormXfa0fcb04,
        ) {
            val jsonEncoder =
...
public fun inlineV1TerminalReadersProcessSetupIntentPostRequestFormXfa0fcb04(
    block: InlineV1TerminalReadersProcessSetupIntentPostRequestFormXfa0fcb04.Builder.() -> Unit,
): InlineV1TerminalReadersProcessSetupIntentPostRequestFormXfa0fcb04 =
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TerminalReadersProcessSetupIntentPostRequestFormXfa0fcb04 is missing required property '" +
                    name +
                    "'",
            )
