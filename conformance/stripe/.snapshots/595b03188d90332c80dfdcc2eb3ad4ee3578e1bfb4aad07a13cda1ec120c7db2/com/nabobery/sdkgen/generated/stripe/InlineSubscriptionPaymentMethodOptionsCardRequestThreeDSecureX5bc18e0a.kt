...
public sealed class InlineSubscriptionPaymentMethodOptionsCardRequestThreeDSecureX5bc18e0a {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineSubscriptionPaymentMethodOptionsCardRequestThreeDSecureX5bc18e0a =
            when (value) {
                Any.value -> Any
    ...
    public object Serializer : KSerializer<InlineSubscriptionPaymentMethodOptionsCardRequestThreeDSecureX5bc18e0a> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineSubscriptionPaymentMethodOptionsCardRequestThreeDSecureX5bc18e0a",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineSubscriptionPaymentMethodOptionsCardRequestThreeDSecureX5bc18e0a = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineSubscriptionPaymentMethodOptionsCardRequestThreeDSecureX5bc18e0a,
        ) {
