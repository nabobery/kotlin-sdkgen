...
public class PaymentFlowsInstallmentOptions(
    ...
    public object Serializer : KSerializer<PaymentFlowsInstallmentOptions> {
        ...
        override fun deserialize(decoder: Decoder): PaymentFlowsInstallmentOptions {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentFlowsInstallmentOptions must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentFlowsInstallmentOptions,
        ) {
...
public fun paymentFlowsInstallmentOptions(
    block: PaymentFlowsInstallmentOptions.Builder.() -> Unit,
): PaymentFlowsInstallmentOptions = PaymentFlowsInstallmentOptions.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "PaymentFlowsInstallmentOptions is missing required property '" + name + "'",
            )
