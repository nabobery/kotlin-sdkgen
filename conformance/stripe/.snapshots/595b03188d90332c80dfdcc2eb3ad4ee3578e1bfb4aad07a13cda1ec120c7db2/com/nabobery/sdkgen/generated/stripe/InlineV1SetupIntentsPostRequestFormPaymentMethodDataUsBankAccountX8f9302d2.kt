...
public class InlineV1SetupIntentsPostRequestFormPaymentMethodDataUsBankAccountX8f9302d2(
    public val accountHolderType: InlineV1SetupIntentsPostRequestFormPaymentMethodDataAccountHolderTypeX3c3e2c95? = null,
    public val accountNumber: String? = null,
    public val accountType: InlineV1SetupIntentsPostRequestFormPaymentMethodDataAccountTypeXb82673d9? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1SetupIntentsPostRequestFormPaymentMethodDataUsBankAccountX8f9302d2 =
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1SetupIntentsPostRequestFormPaymentMethodDataUsBankAccountX8f9302d2 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1SetupIntentsPostRequestFormPaymentMethodDataUsBankAccountX8f9302d2> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SetupIntentsPostRequestFormPaymentMethodDataUsBankAccountX8f9302d2 must be a JSON object",
                    )
            return InlineV1SetupIntentsPostRequestFormPaymentMethodDataUsBankAccountX8f9302d2(
                accountHolderType =
                    rawObject["account_holder_type"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodDataAccountHolderTypeX3c3e2c95>(
                                it,
                            )
                    },
                ...
                accountType =
                    rawObject["account_type"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodDataAccountTypeXb82673d9>(
                                it,
                            )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SetupIntentsPostRequestFormPaymentMethodDataUsBankAccountX8f9302d2,
        ) {
            val jsonEncoder =
...
public fun inlineV1SetupIntentsPostRequestFormPaymentMethodDataUsBankAccountX8f9302d2(
    block: InlineV1SetupIntentsPostRequestFormPaymentMethodDataUsBankAccountX8f9302d2.Builder.() -> Unit,
): InlineV1SetupIntentsPostRequestFormPaymentMethodDataUsBankAccountX8f9302d2 =
    InlineV1SetupIntentsPostRequestFormPaymentMethodDataUsBankAccountX8f9302d2.build(block)
