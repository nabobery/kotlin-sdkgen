...
public class InlineV1TokensPostRequestFormAccountCompanyRegistrationDateAnyOf1X59a1fdd7(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1TokensPostRequestFormAccountCompanyRegistrationDateAnyOf1X59a1fdd7 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1TokensPostRequestFormAccountCompanyRegistrationDateAnyOf1X59a1fdd7> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TokensPostRequestFormAccountCompanyRegistrationDateAnyOf1X59a1fdd7 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TokensPostRequestFormAccountCompanyRegistrationDateAnyOf1X59a1fdd7,
        ) {
            val jsonEncoder =
...
public fun inlineV1TokensPostRequestFormAccountCompanyRegistrationDateAnyOf1X59a1fdd7(
    block: InlineV1TokensPostRequestFormAccountCompanyRegistrationDateAnyOf1X59a1fdd7.Builder.() -> Unit,
): InlineV1TokensPostRequestFormAccountCompanyRegistrationDateAnyOf1X59a1fdd7 =
    InlineV1TokensPostRequestFormAccountCompanyRegistrationDateAnyOf1X59a1fdd7.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TokensPostRequestFormAccountCompanyRegistrationDateAnyOf1X59a1fdd7 is missing required property '" +
                    name +
                    "'",
            )
