...
public class PaymentMethodDetailsAffirm(
    ...
    public class Builder {
        ...
        public fun build(): PaymentMethodDetailsAffirm =
    ...
    public object Serializer : KSerializer<PaymentMethodDetailsAffirm> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodDetailsAffirm {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodDetailsAffirm must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentMethodDetailsAffirm,
        ) {
...
public fun paymentMethodDetailsAffirm(
    block: PaymentMethodDetailsAffirm.Builder.() -> Unit,
): PaymentMethodDetailsAffirm = PaymentMethodDetailsAffirm.build(block)
