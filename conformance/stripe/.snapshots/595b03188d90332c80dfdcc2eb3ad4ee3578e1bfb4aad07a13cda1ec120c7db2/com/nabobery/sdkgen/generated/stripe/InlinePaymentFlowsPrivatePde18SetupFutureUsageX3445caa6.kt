...
public sealed class InlinePaymentFlowsPrivatePde18SetupFutureUsageX3445caa6 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentFlowsPrivatePde18SetupFutureUsageX3445caa6 =
            when (value) {
                None.value -> None
    ...
    public object Serializer : KSerializer<InlinePaymentFlowsPrivatePde18SetupFutureUsageX3445caa6> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentFlowsPrivatePde18SetupFutureUsageX3445caa6",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePaymentFlowsPrivatePde18SetupFutureUsageX3445caa6 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentFlowsPrivatePde18SetupFutureUsageX3445caa6,
        ) {
