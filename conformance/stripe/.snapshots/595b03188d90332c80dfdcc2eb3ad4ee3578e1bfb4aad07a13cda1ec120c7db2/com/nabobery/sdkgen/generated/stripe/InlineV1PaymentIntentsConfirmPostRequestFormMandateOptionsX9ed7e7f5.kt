...
public class InlineV1PaymentIntentsConfirmPostRequestFormMandateOptionsX9ed7e7f5(
    ...
    public val amountIncludesIof: InlineV1PaymentIntentsConfirmPostRequestFormAmountIncludesIofXb81e64c9? = null,
    ...
    public val paymentSchedule: InlineV1PaymentIntentsConfirmPostRequestFormPaymentScheduleX4c2b8cef? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1PaymentIntentsConfirmPostRequestFormMandateOptionsX9ed7e7f5 =
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentIntentsConfirmPostRequestFormMandateOptionsX9ed7e7f5 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentIntentsConfirmPostRequestFormMandateOptionsX9ed7e7f5> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsConfirmPostRequestFormMandateOptionsX9ed7e7f5 must be a JSON object",
                    )
            return InlineV1PaymentIntentsConfirmPostRequestFormMandateOptionsX9ed7e7f5(
                ...
                amountIncludesIof =
                    rawObject["amount_includes_iof"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormAmountIncludesIofXb81e64c9>(
                                it,
                            )
                    },
                amountType =
                    rawObject["amount_type"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormAmountTypeX4f675c57>(it)
                    },
                ...
                paymentSchedule =
                    rawObject["payment_schedule"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormPaymentScheduleX4c2b8cef>(
                                it,
                            )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsConfirmPostRequestFormMandateOptionsX9ed7e7f5,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentIntentsConfirmPostRequestFormMandateOptionsX9ed7e7f5(
    block: InlineV1PaymentIntentsConfirmPostRequestFormMandateOptionsX9ed7e7f5.Builder.() -> Unit,
): InlineV1PaymentIntentsConfirmPostRequestFormMandateOptionsX9ed7e7f5 =
    InlineV1PaymentIntentsConfirmPostRequestFormMandateOptionsX9ed7e7f5.build(block)
