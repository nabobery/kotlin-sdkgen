...
internal data class InlineV1AccountsExternalAccountsPostRequestFormBankAccountX75957207Inspection(
    public val matchesInlineV1AccountsExternalAccountsPostRequestFormBankAccountAnyOf1X615b9fc4: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesInlineV1AccountsExternalAccountsPostRequestFormBankAccountAnyOf1X615b9fc4,
                matchesBranch2,
            ).count {
                it
            }
...
public class InlineV1AccountsExternalAccountsPostRequestFormBankAccountX75957207 internal constructor(
    ...
    private val inspection: InlineV1AccountsExternalAccountsPostRequestFormBankAccountX75957207Inspection,
) {
    public val inlineV1AccountsExternalAccountsPostRequestFormBankAccountAnyOf1X615b9fc4:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1AccountsExternalAccountsPostRequestFormBankAccountAnyOf1X615b9fc4) {
                json
                    .decodeFromJsonElement<InlineV1AccountsExternalAccountsPostRequestFormBankAccountAnyOf1X615b9fc4>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches:
        ...
        get() =
            buildSet {
                if (inspection.matchesInlineV1AccountsExternalAccountsPostRequestFormBankAccountAnyOf1X615b9fc4) {
                    add(
                        InlineV1AccountsExternalAccountsPostRequestFormBankAccountX75957207Branch.InlineV1AccountsExternalAccountsPostRequestFormBankAccountAnyOf1X615b9fc4,
                    )
                }
                if (inspection.matchesBranch2) {
                    add(
                        InlineV1AccountsExternalAccountsPostRequestFormBankAccountX75957207Branch.Branch2,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1AccountsExternalAccountsPostRequestFormBankAccountX75957207 {
            val inspection = inspectInlineV1AccountsExternalAccountsPostRequestFormBankAccountX75957207(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1AccountsExternalAccountsPostRequestFormBankAccountX75957207NoMatchException(
                    "InlineV1AccountsExternalAccountsPostRequestFormBankAccountX75957207 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1AccountsExternalAccountsPostRequestFormBankAccountX75957207> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsExternalAccountsPostRequestFormBankAccountX75957207,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1AccountsExternalAccountsPostRequestFormBankAccountX75957207",
...
private fun inspectInlineV1AccountsExternalAccountsPostRequestFormBankAccountX75957207(
    element: JsonElement,
): InlineV1AccountsExternalAccountsPostRequestFormBankAccountX75957207Inspection {
    val matchesInlineV1AccountsExternalAccountsPostRequestFormBankAccountAnyOf1X615b9fc4 =
        element
            .isJsonDecodable<InlineV1AccountsExternalAccountsPostRequestFormBankAccountAnyOf1X615b9fc4>()
    ...
    return InlineV1AccountsExternalAccountsPostRequestFormBankAccountX75957207Inspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1AccountsExternalAccountsPostRequestFormBankAccountAnyOf1X615b9fc4) {
                    add(
                        "InlineV1AccountsExternalAccountsPostRequestFormBankAccountAnyOf1X615b9fc4: value does not match InlineV1AccountsExternalAccountsPostRequestFormBankAccountAnyOf1X615b9fc4",
                    )
                }
