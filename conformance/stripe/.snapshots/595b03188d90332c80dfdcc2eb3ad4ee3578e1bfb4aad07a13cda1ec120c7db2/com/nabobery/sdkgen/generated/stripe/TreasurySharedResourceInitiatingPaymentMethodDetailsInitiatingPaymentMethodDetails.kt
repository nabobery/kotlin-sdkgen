 ...
 */
@Serializable(
    with = TreasurySharedResourceInitiatingPaymentMethodDetailsInitiatingPaymentMethodDetails.Serializer::class,
)
public class TreasurySharedResourceInitiatingPaymentMethodDetailsInitiatingPaymentMethodDetails(
    ...
    public val usBankAccount: TreasurySharedResourceInitiatingPaymentMethodDetailsUsBankAccount? = null,
) {
    ...
    public object Serializer : KSerializer<TreasurySharedResourceInitiatingPaymentMethodDetailsInitiatingPaymentMethodDetails> {
        ...
        override fun deserialize(
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "TreasurySharedResourceInitiatingPaymentMethodDetailsInitiatingPaymentMethodDetails must be a JSON object",
                    )
            ...
            return TreasurySharedResourceInitiatingPaymentMethodDetailsInitiatingPaymentMethodDetails(
                ...
                type = type,
                balance =
                    rawObject["balance"]?.let {
                        json
                            .decodeFromJsonElement<InlineTreasurySharedResour4545BalanceX74e6449c>(
                                it,
                            )
                    },
                financialAccount =
                    rawObject["financial_account"]?.let {
                        json.decodeFromJsonElement<ReceivedPaymentMethodDetailsFinancialAccount>(it)
                    },
                issuingCard = rawObject["issuing_card"]?.let { json.decodeFromJsonElement<String>(it) },
                usBankAccount =
                    rawObject["us_bank_account"]?.let {
                        json.decodeFromJsonElement<TreasurySharedResourceInitiatingPaymentMethodDetailsUsBankAccount>(
                            it,
                        )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: TreasurySharedResourceInitiatingPaymentMethodDetailsInitiatingPaymentMethodDetails,
        ) {
            val jsonEncoder =
...
public fun treasurySharedResourceInitiatingPaymentMethodDetailsInitiatingPaymentMethodDetails(
    block: TreasurySharedResourceInitiatingPaymentMethodDetailsInitiatingPaymentMethodDetails.Builder.() -> Unit,
): TreasurySharedResourceInitiatingPaymentMethodDetailsInitiatingPaymentMethodDetails =
    TreasurySharedResourceInitiatingPaymentMethodDetailsInitiatingPaymentMethodDetails.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "TreasurySharedResourceInitiatingPaymentMethodDetailsInitiatingPaymentMethodDetails is missing required property '" +
                    name +
                    "'",
            )
