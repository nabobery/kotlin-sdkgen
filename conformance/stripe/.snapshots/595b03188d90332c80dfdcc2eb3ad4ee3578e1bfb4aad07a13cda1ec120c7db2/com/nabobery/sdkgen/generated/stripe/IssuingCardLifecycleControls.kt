...
public class IssuingCardLifecycleControls(
    ...
    public object Serializer : KSerializer<IssuingCardLifecycleControls> {
        ...
        override fun deserialize(decoder: Decoder): IssuingCardLifecycleControls {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("IssuingCardLifecycleControls must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: IssuingCardLifecycleControls,
        ) {
...
public fun issuingCardLifecycleControls(
    block: IssuingCardLifecycleControls.Builder.() -> Unit,
): IssuingCardLifecycleControls = IssuingCardLifecycleControls.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException("IssuingCardLifecycleControls is missing required property '" + name + "'")
