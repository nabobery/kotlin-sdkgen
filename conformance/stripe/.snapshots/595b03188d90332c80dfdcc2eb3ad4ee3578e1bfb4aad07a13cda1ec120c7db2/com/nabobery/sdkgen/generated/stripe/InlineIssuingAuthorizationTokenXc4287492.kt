...
public class InlineIssuingAuthorizationTokenXc4287492 internal constructor(
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineIssuingAuthorizationTokenXc4287492 {
            val inspection = inspectInlineIssuingAuthorizationTokenXc4287492(raw)
            if (inspection.matchCount == 0) {
                throw InlineIssuingAuthorizationTokenXc4287492NoMatchException(
                    "InlineIssuingAuthorizationTokenXc4287492 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineIssuingAuthorizationTokenXc4287492> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineIssuingAuthorizationTokenXc4287492,
        ) {
...
private fun inspectInlineIssuingAuthorizationTokenXc4287492(
    element: JsonElement,
): InlineIssuingAuthorizationTokenXc4287492Inspection {
