...
internal data class InlineV1SubscriptionsPostRequestFormPaymentSettingsUsBankAccountX3b5e39eaInspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesInlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1Xa5c5c8a4,
                matchesInlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2X404ef88b,
            ).count {
                it
            }
}
...
public class InlineV1SubscriptionsPostRequestFormPaymentSettingsUsBankAccountX3b5e39ea internal constructor(
    ...
    private val inspection: InlineV1SubscriptionsPostRequestFormPaymentSettingsUsBankAccountX3b5e39eaInspection,
) {
    public val inlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1Xa5c5c8a4:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1Xa5c5c8a4) {
                json
                    .decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1Xa5c5c8a4>(
                        raw,
                    )
            } else {
                null
    ...
    public val inlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2X404ef88b:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2X404ef88b) {
                json
                    .decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2X404ef88b>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches:
        ...
        get() =
            buildSet {
                if (inspection.matchesInlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1Xa5c5c8a4) {
                    add(
                        InlineV1SubscriptionsPostRequestFormPaymentSettingsUsBankAccountX3b5e39eaBranch.InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1Xa5c5c8a4,
                    )
                }
                if (inspection.matchesInlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2X404ef88b) {
                    add(
                        InlineV1SubscriptionsPostRequestFormPaymentSettingsUsBankAccountX3b5e39eaBranch.InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2X404ef88b,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1SubscriptionsPostRequestFormPaymentSettingsUsBankAccountX3b5e39ea {
            val inspection = inspectInlineV1SubscriptionsPostRequestFormPaymentSettingsUsBankAccountX3b5e39ea(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1SubscriptionsPostRequestFormPaymentSettingsUsBankAccountX3b5e39eaNoMatchException(
                    "InlineV1SubscriptionsPostRequestFormPaymentSettingsUsBankAccountX3b5e39ea matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionsPostRequestFormPaymentSettingsUsBankAccountX3b5e39ea> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsPostRequestFormPaymentSettingsUsBankAccountX3b5e39ea,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1SubscriptionsPostRequestFormPaymentSettingsUsBankAccountX3b5e39ea",
...
private fun inspectInlineV1SubscriptionsPostRequestFormPaymentSettingsUsBankAccountX3b5e39ea(
    element: JsonElement,
): InlineV1SubscriptionsPostRequestFormPaymentSettingsUsBankAccountX3b5e39eaInspection {
    val matchesInlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1Xa5c5c8a4 =
        element
            .isJsonDecodable<InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1Xa5c5c8a4>()
    val matchesInlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2X404ef88b =
        element
            .isJsonDecodable<InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2X404ef88b>()
    return InlineV1SubscriptionsPostRequestFormPaymentSettingsUsBankAccountX3b5e39eaInspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1Xa5c5c8a4) {
                    add(
                        "InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1Xa5c5c8a4: value does not match InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf1Xa5c5c8a4",
                    )
                }
                if (!matchesInlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2X404ef88b) {
                    add(
                        "InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2X404ef88b: value does not match InlineV1SubscriptionsPostRequestFormPaymentSettingsAnyOf2X404ef88b",
                    )
                }
            },
    )
