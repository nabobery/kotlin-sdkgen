...
public class InlineV1IssuingDisputesPostRequestFormEvidenceXc37b39e9(
    ...
    public val noValidAuthorization: InlineV1IssuingDisputesPostRequestFormEvidenceNoValidAuthorizationX7d333ec9? = null,
    public val notReceived: InlineV1IssuingDisputesPostRequestFormEvidenceNotReceivedX67fd19b0? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1IssuingDisputesPostRequestFormEvidenceXc37b39e9 =
            InlineV1IssuingDisputesPostRequestFormEvidenceXc37b39e9(
                canceled = canceled,
                duplicate = duplicate,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1IssuingDisputesPostRequestFormEvidenceXc37b39e9 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1IssuingDisputesPostRequestFormEvidenceXc37b39e9> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1IssuingDisputesPostRequestFormEvidenceXc37b39e9 must be a JSON object",
                    )
            return InlineV1IssuingDisputesPostRequestFormEvidenceXc37b39e9(
                canceled =
                    rawObject["canceled"]?.let {
                        json.decodeFromJsonElement<InlineV1IssuingDisputesPostRequestFormEvidenceCanceledX27bb5887>(it)
                    },
                duplicate =
                    rawObject["duplicate"]?.let {
                        json.decodeFromJsonElement<InlineV1IssuingDisputesPostRequestFormEvidenceDuplicateXbc729c8f>(it)
                    },
                fraudulent =
                    rawObject["fraudulent"]?.let {
                        json.decodeFromJsonElement<InlineV1IssuingDisputesPostRequestFormEvidenceFraudulentX22d1210f>(
                            it,
                        )
                    },
                merchandiseNotAsDescribed =
                    rawObject["merchandise_not_as_described"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1IssuingDisputesPostRequestFormEvidenceMerchandiseNotAsDescribedX24e14259>(
                                it,
                            )
                    },
                noValidAuthorization =
                    rawObject["no_valid_authorization"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1IssuingDisputesPostRequestFormEvidenceNoValidAuthorizationX7d333ec9>(
                                it,
                            )
                    },
                notReceived =
                    rawObject["not_received"]?.let {
                        json.decodeFromJsonElement<InlineV1IssuingDisputesPostRequestFormEvidenceNotReceivedX67fd19b0>(
                            it,
                        )
                    },
                other =
                    rawObject["other"]?.let {
                        json.decodeFromJsonElement<InlineV1IssuingDisputesPostRequestFormEvidenceOtherX627ee1cc>(it)
                    },
                reason =
                    rawObject["reason"]?.let {
                        json.decodeFromJsonElement<InlineV1IssuingDisputesPostRequestFormEvidenceReasonX7793221a>(it)
                    },
                serviceNotAsDescribed =
                    rawObject["service_not_as_described"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1IssuingDisputesPostRequestFormEvidenceServiceNotAsDescribedXf4c8aae3>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingDisputesPostRequestFormEvidenceXc37b39e9,
        ) {
...
public fun inlineV1IssuingDisputesPostRequestFormEvidenceXc37b39e9(
    block: InlineV1IssuingDisputesPostRequestFormEvidenceXc37b39e9.Builder.() -> Unit,
): InlineV1IssuingDisputesPostRequestFormEvidenceXc37b39e9 =
    InlineV1IssuingDisputesPostRequestFormEvidenceXc37b39e9.build(block)
