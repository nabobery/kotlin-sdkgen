...
public class IssuingCardholderVerification(
    ...
    public class Builder {
        ...
        public fun build(): IssuingCardholderVerification =
    ...
    public object Serializer : KSerializer<IssuingCardholderVerification> {
        ...
        override fun deserialize(decoder: Decoder): IssuingCardholderVerification {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("IssuingCardholderVerification must be a JSON object")
                ...
                document =
                    rawObject["document"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineIssuingCardholderVerificationDocumentX8e3e3122?>(element)
                        }
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: IssuingCardholderVerification,
        ) {
...
public fun issuingCardholderVerification(
    block: IssuingCardholderVerification.Builder.() -> Unit,
): IssuingCardholderVerification = IssuingCardholderVerification.build(block)
