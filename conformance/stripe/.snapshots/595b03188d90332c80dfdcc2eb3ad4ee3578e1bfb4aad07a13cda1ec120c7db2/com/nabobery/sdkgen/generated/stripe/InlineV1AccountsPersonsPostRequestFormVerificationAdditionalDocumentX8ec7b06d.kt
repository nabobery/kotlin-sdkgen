...
public class InlineV1AccountsPersonsPostRequestFormVerificationAdditionalDocumentX8ec7b06d(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1AccountsPersonsPostRequestFormVerificationAdditionalDocumentX8ec7b06d =
    ...
    public object Serializer : KSerializer<InlineV1AccountsPersonsPostRequestFormVerificationAdditionalDocumentX8ec7b06d> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountsPersonsPostRequestFormVerificationAdditionalDocumentX8ec7b06d must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPersonsPostRequestFormVerificationAdditionalDocumentX8ec7b06d,
        ) {
            val jsonEncoder =
...
public fun inlineV1AccountsPersonsPostRequestFormVerificationAdditionalDocumentX8ec7b06d(
    block: InlineV1AccountsPersonsPostRequestFormVerificationAdditionalDocumentX8ec7b06d.Builder.() -> Unit,
): InlineV1AccountsPersonsPostRequestFormVerificationAdditionalDocumentX8ec7b06d =
    InlineV1AccountsPersonsPostRequestFormVerificationAdditionalDocumentX8ec7b06d.build(block)
