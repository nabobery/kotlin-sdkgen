...
public class TreasuryFinancialAccountsResourceOutboundPayments(
    ...
    public class Builder {
        ...
        public fun build(): TreasuryFinancialAccountsResourceOutboundPayments =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): TreasuryFinancialAccountsResourceOutboundPayments =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<TreasuryFinancialAccountsResourceOutboundPayments> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "TreasuryFinancialAccountsResourceOutboundPayments must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: TreasuryFinancialAccountsResourceOutboundPayments,
        ) {
...
public fun treasuryFinancialAccountsResourceOutboundPayments(
    block: TreasuryFinancialAccountsResourceOutboundPayments.Builder.() -> Unit,
): TreasuryFinancialAccountsResourceOutboundPayments = TreasuryFinancialAccountsResourceOutboundPayments.build(block)
