...
public sealed class InlinePaymentMethodDetailsKonbiniStoreChainXb550e3bd {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentMethodDetailsKonbiniStoreChainXb550e3bd =
            when (value) {
    ...
    public object Serializer : KSerializer<InlinePaymentMethodDetailsKonbiniStoreChainXb550e3bd> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentMethodDetailsKonbiniStoreChainXb550e3bd",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePaymentMethodDetailsKonbiniStoreChainXb550e3bd =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentMethodDetailsKonbiniStoreChainXb550e3bd,
        ) {
