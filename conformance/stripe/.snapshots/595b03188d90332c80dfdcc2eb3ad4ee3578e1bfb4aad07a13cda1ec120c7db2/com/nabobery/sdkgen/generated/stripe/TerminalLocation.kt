...
@Serializable
public data class TerminalLocationView(
...
public class TerminalLocation(
    ...
    public object Serializer : KSerializer<TerminalLocation> {
        ...
        override fun deserialize(decoder: Decoder): TerminalLocation {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("TerminalLocation must be a JSON object")
            ...
            return TerminalLocation(
                ...
                addressKana =
                    rawObject["address_kana"]?.let {
                        json.decodeFromJsonElement<LegalEntityJapanAddress>(
                            it,
                        )
                    },
                addressKanji =
                ...
                displayNameKana = rawObject["display_name_kana"]?.let {
                    json.decodeFromJsonElement<String>(
                        it,
                    )
                },
...
public fun terminalLocation(block: TerminalLocation.Builder.() -> Unit): TerminalLocation =
    TerminalLocation.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("TerminalLocation is missing required property '" + name + "'")
