...
public class InlineV1SourcesPostRequestFormSourceOrderX4330303b(
    public val items: List<InlineV1SourcesPostRequestFormSourceOrderItemsItemX5728b31a>? = null,
    public val shipping: InlineV1SourcesPostRequestFormSourceOrderShippingXe8073dfa? = null,
) {
    public class Builder {
        public var items: List<InlineV1SourcesPostRequestFormSourceOrderItemsItemX5728b31a>? = null

        public var shipping: InlineV1SourcesPostRequestFormSourceOrderShippingXe8073dfa? = null

        public fun build(): InlineV1SourcesPostRequestFormSourceOrderX4330303b =
            InlineV1SourcesPostRequestFormSourceOrderX4330303b(
                items = items,
                shipping = shipping,
            )
    }
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1SourcesPostRequestFormSourceOrderX4330303b =
    ...
    public object Serializer : KSerializer<InlineV1SourcesPostRequestFormSourceOrderX4330303b> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SourcesPostRequestFormSourceOrderX4330303b must be a JSON object",
                    )
            return InlineV1SourcesPostRequestFormSourceOrderX4330303b(
                items =
                    rawObject["items"]?.let {
                        json.decodeFromJsonElement<List<InlineV1SourcesPostRequestFormSourceOrderItemsItemX5728b31a>>(
                            it,
                        )
                    },
                shipping =
                    rawObject["shipping"]?.let {
                        json.decodeFromJsonElement<InlineV1SourcesPostRequestFormSourceOrderShippingXe8073dfa>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SourcesPostRequestFormSourceOrderX4330303b,
        ) {
...
public fun inlineV1SourcesPostRequestFormSourceOrderX4330303b(
    block: InlineV1SourcesPostRequestFormSourceOrderX4330303b.Builder.() -> Unit,
): InlineV1SourcesPostRequestFormSourceOrderX4330303b = InlineV1SourcesPostRequestFormSourceOrderX4330303b.build(block)
