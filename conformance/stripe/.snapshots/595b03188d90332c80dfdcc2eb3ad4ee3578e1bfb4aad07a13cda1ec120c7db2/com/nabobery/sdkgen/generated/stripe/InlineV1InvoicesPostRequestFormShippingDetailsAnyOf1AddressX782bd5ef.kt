...
public class InlineV1InvoicesPostRequestFormShippingDetailsAnyOf1AddressX782bd5ef(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1InvoicesPostRequestFormShippingDetailsAnyOf1AddressX782bd5ef =
            InlineV1InvoicesPostRequestFormShippingDetailsAnyOf1AddressX782bd5ef(
                city = city,
                country = country,
                line1 = line1,
                line2 = line2,
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1InvoicesPostRequestFormShippingDetailsAnyOf1AddressX782bd5ef = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1InvoicesPostRequestFormShippingDetailsAnyOf1AddressX782bd5ef> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1InvoicesPostRequestFormShippingDetailsAnyOf1AddressX782bd5ef must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesPostRequestFormShippingDetailsAnyOf1AddressX782bd5ef,
        ) {
            val jsonEncoder =
...
public fun inlineV1InvoicesPostRequestFormShippingDetailsAnyOf1AddressX782bd5ef(
    block: InlineV1InvoicesPostRequestFormShippingDetailsAnyOf1AddressX782bd5ef.Builder.() -> Unit,
): InlineV1InvoicesPostRequestFormShippingDetailsAnyOf1AddressX782bd5ef =
    InlineV1InvoicesPostRequestFormShippingDetailsAnyOf1AddressX782bd5ef.build(block)
