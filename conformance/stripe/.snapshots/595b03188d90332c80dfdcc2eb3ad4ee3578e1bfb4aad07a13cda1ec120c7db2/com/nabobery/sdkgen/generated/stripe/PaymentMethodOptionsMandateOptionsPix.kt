...
public class PaymentMethodOptionsMandateOptionsPix(
     ...
     */
    public val amountIncludesIof: InlinePaymentMethodOptionsMandateOptionsPixAmountIncludesIofX90ab6306? = null,
    /**
     * Type of amount.
     */
     ...
     */
    public val paymentSchedule: InlinePaymentMethodOptionsMandateOptionsPixPaymentScheduleX1a677405? = null,
    /**
    ...
    public class Builder {
        ...
        public fun build(): PaymentMethodOptionsMandateOptionsPix =
            PaymentMethodOptionsMandateOptionsPix(
                amount = amount,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentMethodOptionsMandateOptionsPix =
    ...
    public object Serializer : KSerializer<PaymentMethodOptionsMandateOptionsPix> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodOptionsMandateOptionsPix {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodOptionsMandateOptionsPix must be a JSON object")
            return PaymentMethodOptionsMandateOptionsPix(
                amount = rawObject["amount"]?.let { json.decodeFromJsonElement<Int>(it) },
                amountIncludesIof =
                    rawObject["amount_includes_iof"]?.let {
                        json
                            .decodeFromJsonElement<InlinePaymentMethodOptionsMandateOptionsPixAmountIncludesIofX90ab6306>(
                                it,
                            )
                    },
                amountType =
                    rawObject["amount_type"]?.let {
                        json.decodeFromJsonElement<InlinePaymentMethodOptionsMandateOptionsPixAmountTypeX7eacc7de>(it)
                    },
                ...
                paymentSchedule =
                    rawObject["payment_schedule"]?.let {
                        json.decodeFromJsonElement<InlinePaymentMethodOptionsMandateOptionsPixPaymentScheduleX1a677405>(
                            it,
                        )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentMethodOptionsMandateOptionsPix,
        ) {
...
public fun paymentMethodOptionsMandateOptionsPix(
    block: PaymentMethodOptionsMandateOptionsPix.Builder.() -> Unit,
): PaymentMethodOptionsMandateOptionsPix = PaymentMethodOptionsMandateOptionsPix.build(block)
