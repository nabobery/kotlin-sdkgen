...
public class InlineV1TokensPostRequestFormX37c67bb3(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1TokensPostRequestFormX37c67bb3 =
            InlineV1TokensPostRequestFormX37c67bb3(
                account = account,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TokensPostRequestFormX37c67bb3 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TokensPostRequestFormX37c67bb3> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1TokensPostRequestFormX37c67bb3 {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("InlineV1TokensPostRequestFormX37c67bb3 must be a JSON object")
            return InlineV1TokensPostRequestFormX37c67bb3(
                account =
                    rawObject["account"]?.let {
                        json.decodeFromJsonElement<InlineV1TokensPostRequestFormAccountXe0f6a7b3>(
                            it,
                        )
                    },
                bankAccount =
                    rawObject["bank_account"]?.let {
                        json.decodeFromJsonElement<InlineV1TokensPostRequestFormBankAccountX662538df>(it)
                    },
                card =
                    rawObject["card"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TokensPostRequestFormCardX3af5dd08>(
                                it,
                            )
                    },
                customer = rawObject["customer"]?.let { json.decodeFromJsonElement<String>(it) },
                cvcUpdate =
                    rawObject["cvc_update"]?.let {
                        json.decodeFromJsonElement<InlineV1TokensPostRequestFormCvcUpdateX5188265b>(it)
                    },
                expand = rawObject["expand"]?.let { json.decodeFromJsonElement<List<String>>(it) },
                person =
                    rawObject["person"]?.let {
                        json.decodeFromJsonElement<InlineV1TokensPostRequestFormPersonX2c9b4fc3>(
                            it,
                        )
                    },
                pii =
                    rawObject["pii"]?.let {
                        json.decodeFromJsonElement<InlineV1TokensPostRequestFormPiiX0553cae2>(
                            it,
                        )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TokensPostRequestFormX37c67bb3,
        ) {
...
public fun inlineV1TokensPostRequestFormX37c67bb3(
    block: InlineV1TokensPostRequestFormX37c67bb3.Builder.() -> Unit,
): InlineV1TokensPostRequestFormX37c67bb3 = InlineV1TokensPostRequestFormX37c67bb3.build(block)
