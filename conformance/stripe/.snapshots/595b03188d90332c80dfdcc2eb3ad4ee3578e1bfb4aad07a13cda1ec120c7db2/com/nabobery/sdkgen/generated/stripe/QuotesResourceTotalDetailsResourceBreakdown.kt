...
public class QuotesResourceTotalDetailsResourceBreakdown(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): QuotesResourceTotalDetailsResourceBreakdown =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<QuotesResourceTotalDetailsResourceBreakdown> {
        ...
        override fun deserialize(decoder: Decoder): QuotesResourceTotalDetailsResourceBreakdown {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("QuotesResourceTotalDetailsResourceBreakdown must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: QuotesResourceTotalDetailsResourceBreakdown,
        ) {
...
public fun quotesResourceTotalDetailsResourceBreakdown(
    block: QuotesResourceTotalDetailsResourceBreakdown.Builder.() -> Unit,
): QuotesResourceTotalDetailsResourceBreakdown = QuotesResourceTotalDetailsResourceBreakdown.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "QuotesResourceTotalDetailsResourceBreakdown is missing required property '" + name + "'",
            )
