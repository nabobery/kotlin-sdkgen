...
public class InlineV1CreditNotesPostRequestFormLinesItemX77ab601b(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1CreditNotesPostRequestFormLinesItemX77ab601b =
    ...
    public object Serializer : KSerializer<InlineV1CreditNotesPostRequestFormLinesItemX77ab601b> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CreditNotesPostRequestFormLinesItemX77ab601b must be a JSON object",
                    )
            ...
            return InlineV1CreditNotesPostRequestFormLinesItemX77ab601b(
                ...
                taxAmounts =
                    rawObject["tax_amounts"]?.let {
                        json.decodeFromJsonElement<InlineV1CreditNotesPostRequestFormLinesItemTaxAmountsXf48d6eac>(it)
                    },
                taxRates =
                    rawObject["tax_rates"]?.let {
                        json.decodeFromJsonElement<InlineV1CreditNotesPostRequestFormLinesItemTaxRatesX81dd0cc9>(it)
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CreditNotesPostRequestFormLinesItemX77ab601b,
        ) {
...
public fun inlineV1CreditNotesPostRequestFormLinesItemX77ab601b(
    block: InlineV1CreditNotesPostRequestFormLinesItemX77ab601b.Builder.() -> Unit,
): InlineV1CreditNotesPostRequestFormLinesItemX77ab601b =
    InlineV1CreditNotesPostRequestFormLinesItemX77ab601b.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1CreditNotesPostRequestFormLinesItemX77ab601b is missing required property '" + name + "'",
            )
