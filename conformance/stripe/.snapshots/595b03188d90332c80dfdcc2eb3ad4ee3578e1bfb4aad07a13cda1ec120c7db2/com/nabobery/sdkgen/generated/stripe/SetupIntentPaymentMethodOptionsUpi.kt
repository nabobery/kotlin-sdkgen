...
public class SetupIntentPaymentMethodOptionsUpi(
    ...
    public class Builder {
        ...
        public fun build(): SetupIntentPaymentMethodOptionsUpi =
    ...
    public object Serializer : KSerializer<SetupIntentPaymentMethodOptionsUpi> {
        ...
        override fun deserialize(decoder: Decoder): SetupIntentPaymentMethodOptionsUpi {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("SetupIntentPaymentMethodOptionsUpi must be a JSON object")
            return SetupIntentPaymentMethodOptionsUpi(
                mandateOptions =
                    rawObject["mandate_options"]?.let {
                        json.decodeFromJsonElement<PaymentMethodOptionsMandateOptionsUpi>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: SetupIntentPaymentMethodOptionsUpi,
        ) {
...
public fun setupIntentPaymentMethodOptionsUpi(
    block: SetupIntentPaymentMethodOptionsUpi.Builder.() -> Unit,
): SetupIntentPaymentMethodOptionsUpi = SetupIntentPaymentMethodOptionsUpi.build(block)
