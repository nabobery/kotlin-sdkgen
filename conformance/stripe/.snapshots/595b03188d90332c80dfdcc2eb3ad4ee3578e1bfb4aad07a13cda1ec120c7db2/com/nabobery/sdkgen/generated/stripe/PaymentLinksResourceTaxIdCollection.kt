...
public class PaymentLinksResourceTaxIdCollection(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentLinksResourceTaxIdCollection =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentLinksResourceTaxIdCollection> {
        ...
        override fun deserialize(decoder: Decoder): PaymentLinksResourceTaxIdCollection {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentLinksResourceTaxIdCollection must be a JSON object")
            val enabled = json.decodeRequired<Boolean>(rawObject, "enabled")
            val required =
                json.decodeRequired<InlinePaymentLinksResourceTaxIdCollectionRequiredXd1de9332>(
                    rawObject,
                    "required",
                )
            return PaymentLinksResourceTaxIdCollection(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentLinksResourceTaxIdCollection,
        ) {
...
public fun paymentLinksResourceTaxIdCollection(
    block: PaymentLinksResourceTaxIdCollection.Builder.() -> Unit,
): PaymentLinksResourceTaxIdCollection = PaymentLinksResourceTaxIdCollection.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "PaymentLinksResourceTaxIdCollection is missing required property '" + name + "'",
            )
