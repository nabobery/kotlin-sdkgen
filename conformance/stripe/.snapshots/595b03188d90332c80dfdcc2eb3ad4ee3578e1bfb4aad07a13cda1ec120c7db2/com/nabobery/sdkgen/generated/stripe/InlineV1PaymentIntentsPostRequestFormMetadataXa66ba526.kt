...
public class InlineV1PaymentIntentsPostRequestFormMetadataXa66ba526 internal constructor(
    ...
    public val inlineV1PaymentIntentsPostRequestFormMetadataAnyOf2Xad479630:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1PaymentIntentsPostRequestFormMetadataAnyOf2Xad479630) {
                json
                    .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormMetadataAnyOf2Xad479630>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1PaymentIntentsPostRequestFormMetadataXa66ba526Branch>
        get() =
            buildSet {
                ...
                if (inspection.matchesInlineV1PaymentIntentsPostRequestFormMetadataAnyOf2Xad479630) {
                    add(
                        InlineV1PaymentIntentsPostRequestFormMetadataXa66ba526Branch.InlineV1PaymentIntentsPostRequestFormMetadataAnyOf2Xad479630,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1PaymentIntentsPostRequestFormMetadataXa66ba526 {
            val inspection = inspectInlineV1PaymentIntentsPostRequestFormMetadataXa66ba526(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1PaymentIntentsPostRequestFormMetadataXa66ba526NoMatchException(
                    "InlineV1PaymentIntentsPostRequestFormMetadataXa66ba526 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormMetadataXa66ba526> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormMetadataXa66ba526,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1PaymentIntentsPostRequestFormMetadataXa66ba526",
...
private fun inspectInlineV1PaymentIntentsPostRequestFormMetadataXa66ba526(
    element: JsonElement,
): InlineV1PaymentIntentsPostRequestFormMetadataXa66ba526Inspection {
    val matchesBranch1 = element.isJsonDecodable<JsonObject>()
    val matchesInlineV1PaymentIntentsPostRequestFormMetadataAnyOf2Xad479630 =
        element
            .isJsonDecodable<InlineV1PaymentIntentsPostRequestFormMetadataAnyOf2Xad479630>()
    return InlineV1PaymentIntentsPostRequestFormMetadataXa66ba526Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1PaymentIntentsPostRequestFormMetadataAnyOf2Xad479630) {
                    add(
                        "InlineV1PaymentIntentsPostRequestFormMetadataAnyOf2Xad479630: value does not match InlineV1PaymentIntentsPostRequestFormMetadataAnyOf2Xad479630",
                    )
                }
            },
    )
