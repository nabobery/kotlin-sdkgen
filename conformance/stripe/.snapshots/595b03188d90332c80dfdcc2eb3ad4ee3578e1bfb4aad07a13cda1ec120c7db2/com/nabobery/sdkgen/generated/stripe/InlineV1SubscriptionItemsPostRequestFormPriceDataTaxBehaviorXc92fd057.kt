...
public sealed class InlineV1SubscriptionItemsPostRequestFormPriceDataTaxBehaviorXc92fd057 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1SubscriptionItemsPostRequestFormPriceDataTaxBehaviorXc92fd057 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionItemsPostRequestFormPriceDataTaxBehaviorXc92fd057> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1SubscriptionItemsPostRequestFormPriceDataTaxBehaviorXc92fd057",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1SubscriptionItemsPostRequestFormPriceDataTaxBehaviorXc92fd057 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionItemsPostRequestFormPriceDataTaxBehaviorXc92fd057,
        ) {
