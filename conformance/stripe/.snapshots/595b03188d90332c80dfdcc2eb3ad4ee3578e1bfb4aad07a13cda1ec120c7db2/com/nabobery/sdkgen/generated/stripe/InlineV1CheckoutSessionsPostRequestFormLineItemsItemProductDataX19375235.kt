...
public class InlineV1CheckoutSessionsPostRequestFormLineItemsItemProductDataX19375235(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1CheckoutSessionsPostRequestFormLineItemsItemProductDataX19375235 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormLineItemsItemProductDataX19375235> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CheckoutSessionsPostRequestFormLineItemsItemProductDataX19375235 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsPostRequestFormLineItemsItemProductDataX19375235,
        ) {
            val jsonEncoder =
...
public fun inlineV1CheckoutSessionsPostRequestFormLineItemsItemProductDataX19375235(
    block: InlineV1CheckoutSessionsPostRequestFormLineItemsItemProductDataX19375235.Builder.() -> Unit,
): InlineV1CheckoutSessionsPostRequestFormLineItemsItemProductDataX19375235 =
    InlineV1CheckoutSessionsPostRequestFormLineItemsItemProductDataX19375235.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1CheckoutSessionsPostRequestFormLineItemsItemProductDataX19375235 is missing required property '" +
                    name +
                    "'",
            )
