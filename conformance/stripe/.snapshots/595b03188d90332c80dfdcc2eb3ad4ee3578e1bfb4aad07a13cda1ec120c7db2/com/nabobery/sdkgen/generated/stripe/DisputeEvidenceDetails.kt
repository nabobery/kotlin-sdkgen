        ...
        override fun deserialize(decoder: Decoder): DisputeEvidenceDetails {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("DisputeEvidenceDetails must be a JSON object")
...
public fun disputeEvidenceDetails(block: DisputeEvidenceDetails.Builder.() -> Unit): DisputeEvidenceDetails =
    DisputeEvidenceDetails.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("DisputeEvidenceDetails is missing required property '" + name + "'")
