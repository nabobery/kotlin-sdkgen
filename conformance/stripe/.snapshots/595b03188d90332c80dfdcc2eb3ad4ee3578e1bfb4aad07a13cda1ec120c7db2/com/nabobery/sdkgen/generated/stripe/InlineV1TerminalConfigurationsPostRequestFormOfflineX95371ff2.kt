...
internal data class InlineV1TerminalConfigurationsPostRequestFormOfflineX95371ff2Inspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesInlineV1TerminalConfigurationsPostRequestFormOfflineAnyOf1Xe19e9da0,
                matchesInlineV1TerminalConfigurationsPostRequestFormOfflineAnyOf2Xbbee4d7b,
            ).count {
                it
            }
}
...
public class InlineV1TerminalConfigurationsPostRequestFormOfflineX95371ff2 internal constructor(
    ...
    public val inlineV1TerminalConfigurationsPostRequestFormOfflineAnyOf1Xe19e9da0:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1TerminalConfigurationsPostRequestFormOfflineAnyOf1Xe19e9da0) {
                json
                    .decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormOfflineAnyOf1Xe19e9da0>(
                        raw,
                    )
            } else {
                null
    ...
    public val inlineV1TerminalConfigurationsPostRequestFormOfflineAnyOf2Xbbee4d7b:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1TerminalConfigurationsPostRequestFormOfflineAnyOf2Xbbee4d7b) {
                json
                    .decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormOfflineAnyOf2Xbbee4d7b>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches:
        ...
        get() =
            buildSet {
                if (inspection.matchesInlineV1TerminalConfigurationsPostRequestFormOfflineAnyOf1Xe19e9da0) {
                    add(
                        InlineV1TerminalConfigurationsPostRequestFormOfflineX95371ff2Branch.InlineV1TerminalConfigurationsPostRequestFormOfflineAnyOf1Xe19e9da0,
                    )
                }
                if (inspection.matchesInlineV1TerminalConfigurationsPostRequestFormOfflineAnyOf2Xbbee4d7b) {
                    add(
                        InlineV1TerminalConfigurationsPostRequestFormOfflineX95371ff2Branch.InlineV1TerminalConfigurationsPostRequestFormOfflineAnyOf2Xbbee4d7b,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1TerminalConfigurationsPostRequestFormOfflineX95371ff2 {
            val inspection = inspectInlineV1TerminalConfigurationsPostRequestFormOfflineX95371ff2(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1TerminalConfigurationsPostRequestFormOfflineX95371ff2NoMatchException(
                    "InlineV1TerminalConfigurationsPostRequestFormOfflineX95371ff2 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1TerminalConfigurationsPostRequestFormOfflineX95371ff2> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TerminalConfigurationsPostRequestFormOfflineX95371ff2,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1TerminalConfigurationsPostRequestFormOfflineX95371ff2",
...
private fun inspectInlineV1TerminalConfigurationsPostRequestFormOfflineX95371ff2(
    element: JsonElement,
): InlineV1TerminalConfigurationsPostRequestFormOfflineX95371ff2Inspection {
    val matchesInlineV1TerminalConfigurationsPostRequestFormOfflineAnyOf1Xe19e9da0 =
        element
            .isJsonDecodable<InlineV1TerminalConfigurationsPostRequestFormOfflineAnyOf1Xe19e9da0>()
    val matchesInlineV1TerminalConfigurationsPostRequestFormOfflineAnyOf2Xbbee4d7b =
        element
            .isJsonDecodable<InlineV1TerminalConfigurationsPostRequestFormOfflineAnyOf2Xbbee4d7b>()
    return InlineV1TerminalConfigurationsPostRequestFormOfflineX95371ff2Inspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1TerminalConfigurationsPostRequestFormOfflineAnyOf1Xe19e9da0) {
                    add(
                        "InlineV1TerminalConfigurationsPostRequestFormOfflineAnyOf1Xe19e9da0: value does not match InlineV1TerminalConfigurationsPostRequestFormOfflineAnyOf1Xe19e9da0",
                    )
                }
                if (!matchesInlineV1TerminalConfigurationsPostRequestFormOfflineAnyOf2Xbbee4d7b) {
                    add(
                        "InlineV1TerminalConfigurationsPostRequestFormOfflineAnyOf2Xbbee4d7b: value does not match InlineV1TerminalConfigurationsPostRequestFormOfflineAnyOf2Xbbee4d7b",
                    )
                }
            },
    )
