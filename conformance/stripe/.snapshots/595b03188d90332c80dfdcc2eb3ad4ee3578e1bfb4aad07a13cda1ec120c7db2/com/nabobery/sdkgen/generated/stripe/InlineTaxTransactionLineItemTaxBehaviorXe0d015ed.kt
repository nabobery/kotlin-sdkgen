...
public sealed class InlineTaxTransactionLineItemTaxBehaviorXe0d015ed {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineTaxTransactionLineItemTaxBehaviorXe0d015ed =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineTaxTransactionLineItemTaxBehaviorXe0d015ed> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineTaxTransactionLineItemTaxBehaviorXe0d015ed",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineTaxTransactionLineItemTaxBehaviorXe0d015ed =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineTaxTransactionLineItemTaxBehaviorXe0d015ed,
        ) {
