...
public class InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsMandateOptionsXa5c0ec68(
    public val referencePrefix: InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsReferencePrefixX68f26994? = null,
) {
    public class Builder {
        public var referencePrefix:
            InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsReferencePrefixX68f26994? = null

        public fun build(): InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsMandateOptionsXa5c0ec68 =
    ...
    public object Serializer : KSerializer<InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsMandateOptionsXa5c0ec68> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsMandateOptionsXa5c0ec68 must be a JSON object",
                    )
            return InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsMandateOptionsXa5c0ec68(
                referencePrefix =
                    rawObject["reference_prefix"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsReferencePrefixX68f26994>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsMandateOptionsXa5c0ec68,
        ) {
            val jsonEncoder =
...
public fun inlineV1SetupIntentsPostRequestFormPaymentMethodOptionsMandateOptionsXa5c0ec68(
    block: InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsMandateOptionsXa5c0ec68.Builder.() -> Unit,
): InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsMandateOptionsXa5c0ec68 =
    InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsMandateOptionsXa5c0ec68.build(block)
