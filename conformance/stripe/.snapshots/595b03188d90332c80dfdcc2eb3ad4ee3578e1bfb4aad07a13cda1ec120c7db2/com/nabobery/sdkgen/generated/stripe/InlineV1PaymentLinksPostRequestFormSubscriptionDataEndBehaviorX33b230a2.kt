...
public class InlineV1PaymentLinksPostRequestFormSubscriptionDataEndBehaviorX33b230a2(
    public val missingPaymentMethod: InlineV1PaymentLinksPostRequestFormSubscriptionDataMissingPaymentMethodX1e5b3c6b,
) {
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentLinksPostRequestFormSubscriptionDataEndBehaviorX33b230a2 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1PaymentLinksPostRequestFormSubscriptionDataEndBehaviorX33b230a2> {
        ...
        override fun deserialize(
            decoder: Decoder,
        ): InlineV1PaymentLinksPostRequestFormSubscriptionDataEndBehaviorX33b230a2 {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentLinksPostRequestFormSubscriptionDataEndBehaviorX33b230a2 must be a JSON object",
                    )
            val missingPaymentMethod =
                json
                    .decodeRequired<InlineV1PaymentLinksPostRequestFormSubscriptionDataMissingPaymentMethodX1e5b3c6b>(
                        rawObject,
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentLinksPostRequestFormSubscriptionDataEndBehaviorX33b230a2,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentLinksPostRequestFormSubscriptionDataEndBehaviorX33b230a2(
    block: InlineV1PaymentLinksPostRequestFormSubscriptionDataEndBehaviorX33b230a2.Builder.() -> Unit,
): InlineV1PaymentLinksPostRequestFormSubscriptionDataEndBehaviorX33b230a2 =
    InlineV1PaymentLinksPostRequestFormSubscriptionDataEndBehaviorX33b230a2.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentLinksPostRequestFormSubscriptionDataEndBehaviorX33b230a2 is missing required property '" +
                    name +
                    "'",
            )
