...
public class InlineCreditNotesPretaxCreditAmountCreditBalanceTransactionX1303623d internal constructor(
    ...
    private val inspection: InlineCreditNotesPretaxCreditAmountCreditBalanceTransactionX1303623dInspection,
) {
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineCreditNotesPretaxCreditAmountCreditBalanceTransactionX1303623dBranch.Branch1,
                    )
                }
                if (inspection.matchesBillingCreditBalanceTransaction) {
                    add(
                        InlineCreditNotesPretaxCreditAmountCreditBalanceTransactionX1303623dBranch.BillingCreditBalanceTransaction,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineCreditNotesPretaxCreditAmountCreditBalanceTransactionX1303623d {
            val inspection = inspectInlineCreditNotesPretaxCreditAmountCreditBalanceTransactionX1303623d(raw)
            if (inspection.matchCount == 0) {
                throw InlineCreditNotesPretaxCreditAmountCreditBalanceTransactionX1303623dNoMatchException(
                    "InlineCreditNotesPretaxCreditAmountCreditBalanceTransactionX1303623d matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineCreditNotesPretaxCreditAmountCreditBalanceTransactionX1303623d> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineCreditNotesPretaxCreditAmountCreditBalanceTransactionX1303623d,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineCreditNotesPretaxCreditAmountCreditBalanceTransactionX1303623d",
...
private fun inspectInlineCreditNotesPretaxCreditAmountCreditBalanceTransactionX1303623d(
    element: JsonElement,
