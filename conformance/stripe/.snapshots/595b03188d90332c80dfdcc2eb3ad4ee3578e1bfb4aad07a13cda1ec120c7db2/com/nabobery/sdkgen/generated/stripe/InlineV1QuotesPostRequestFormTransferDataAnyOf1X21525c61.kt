...
public class InlineV1QuotesPostRequestFormTransferDataAnyOf1X21525c61(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1QuotesPostRequestFormTransferDataAnyOf1X21525c61 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1QuotesPostRequestFormTransferDataAnyOf1X21525c61> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1QuotesPostRequestFormTransferDataAnyOf1X21525c61 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1QuotesPostRequestFormTransferDataAnyOf1X21525c61,
        ) {
...
public fun inlineV1QuotesPostRequestFormTransferDataAnyOf1X21525c61(
    block: InlineV1QuotesPostRequestFormTransferDataAnyOf1X21525c61.Builder.() -> Unit,
): InlineV1QuotesPostRequestFormTransferDataAnyOf1X21525c61 =
    InlineV1QuotesPostRequestFormTransferDataAnyOf1X21525c61.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1QuotesPostRequestFormTransferDataAnyOf1X21525c61 is missing required property '" + name + "'",
            )
