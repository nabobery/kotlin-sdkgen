...
public class InlineV1PaymentLinksPostRequestFormInvoiceCreationX7108721b(
    ...
    public val invoiceData: InlineV1PaymentLinksPostRequestFormInvoiceCreationInvoiceDataXcd3dae65? = null,
) {
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PaymentLinksPostRequestFormInvoiceCreationX7108721b =
    ...
    public object Serializer : KSerializer<InlineV1PaymentLinksPostRequestFormInvoiceCreationX7108721b> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentLinksPostRequestFormInvoiceCreationX7108721b must be a JSON object",
                    )
            ...
            return InlineV1PaymentLinksPostRequestFormInvoiceCreationX7108721b(
                ...
                invoiceData =
                    rawObject["invoice_data"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormInvoiceCreationInvoiceDataXcd3dae65>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentLinksPostRequestFormInvoiceCreationX7108721b,
        ) {
...
public fun inlineV1PaymentLinksPostRequestFormInvoiceCreationX7108721b(
    block: InlineV1PaymentLinksPostRequestFormInvoiceCreationX7108721b.Builder.() -> Unit,
): InlineV1PaymentLinksPostRequestFormInvoiceCreationX7108721b =
    InlineV1PaymentLinksPostRequestFormInvoiceCreationX7108721b.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentLinksPostRequestFormInvoiceCreationX7108721b is missing required property '" + name +
                    "'",
            )
