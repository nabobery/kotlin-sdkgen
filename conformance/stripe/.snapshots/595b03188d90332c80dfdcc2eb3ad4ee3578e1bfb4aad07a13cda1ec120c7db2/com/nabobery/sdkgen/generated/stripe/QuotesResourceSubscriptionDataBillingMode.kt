...
public class QuotesResourceSubscriptionDataBillingMode(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): QuotesResourceSubscriptionDataBillingMode =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<QuotesResourceSubscriptionDataBillingMode> {
        ...
        override fun deserialize(decoder: Decoder): QuotesResourceSubscriptionDataBillingMode {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("QuotesResourceSubscriptionDataBillingMode must be a JSON object")
            val type =
                json.decodeRequired<InlineQuotesResourceSubscriptionDataBillingModeTypeX8387d824>(
                    rawObject,
                    "type",
                )
            return QuotesResourceSubscriptionDataBillingMode(
                ...
                flexible =
                    rawObject["flexible"]?.let {
                        json.decodeFromJsonElement<SubscriptionsResourceBillingModeFlexible>(
                            it,
                        )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: QuotesResourceSubscriptionDataBillingMode,
        ) {
...
public fun quotesResourceSubscriptionDataBillingMode(
    block: QuotesResourceSubscriptionDataBillingMode.Builder.() -> Unit,
): QuotesResourceSubscriptionDataBillingMode = QuotesResourceSubscriptionDataBillingMode.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "QuotesResourceSubscriptionDataBillingMode is missing required property '" + name + "'",
            )
