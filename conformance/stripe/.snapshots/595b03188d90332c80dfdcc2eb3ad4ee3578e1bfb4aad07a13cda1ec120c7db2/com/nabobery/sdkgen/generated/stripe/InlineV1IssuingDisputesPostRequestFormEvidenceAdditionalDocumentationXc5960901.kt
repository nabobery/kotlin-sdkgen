...
internal data class InlineV1IssuingDisputesPostRequestFormEvidenceAdditionalDocumentationXc5960901Inspection(
    ...
    public val matchesInlineV1IssuingDisputesPostRequestFormEvidenceFraudulentAnyOf1AnyOf2X62e6bfea: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1IssuingDisputesPostRequestFormEvidenceFraudulentAnyOf1AnyOf2X62e6bfea,
            ).count {
                it
            }
}
...
public class InlineV1IssuingDisputesPostRequestFormEvidenceAdditionalDocumentationXc5960901 internal constructor(
    ...
    private val inspection: InlineV1IssuingDisputesPostRequestFormEvidenceAdditionalDocumentationXc5960901Inspection,
) {
    ...
    public val inlineV1IssuingDisputesPostRequestFormEvidenceFraudulentAnyOf1AnyOf2X62e6bfea:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1IssuingDisputesPostRequestFormEvidenceFraudulentAnyOf1AnyOf2X62e6bfea) {
                json
                    .decodeFromJsonElement<InlineV1IssuingDisputesPostRequestFormEvidenceFraudulentAnyOf1AnyOf2X62e6bfea>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1IssuingDisputesPostRequestFormEvidenceAdditionalDocumentationXc5960901Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1IssuingDisputesPostRequestFormEvidenceFraudulentAnyOf1AnyOf2X62e6bfea) {
                    add(
                        InlineV1IssuingDisputesPostRequestFormEvidenceAdditionalDocumentationXc5960901Branch.InlineV1IssuingDisputesPostRequestFormEvidenceFraudulentAnyOf1AnyOf2X62e6bfea,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1IssuingDisputesPostRequestFormEvidenceAdditionalDocumentationXc5960901 {
            val inspection = inspectInlineV1IssuingDisputesPostRequestFormEvidenceAdditionalDocumentationXc5960901(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1IssuingDisputesPostRequestFormEvidenceAdditionalDocumentationXc5960901NoMatchException(
                    "InlineV1IssuingDisputesPostRequestFormEvidenceAdditionalDocumentationXc5960901 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1IssuingDisputesPostRequestFormEvidenceAdditionalDocumentationXc5960901> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingDisputesPostRequestFormEvidenceAdditionalDocumentationXc5960901,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1IssuingDisputesPostRequestFormEvidenceAdditionalDocumentationXc5960901",
...
private fun inspectInlineV1IssuingDisputesPostRequestFormEvidenceAdditionalDocumentationXc5960901(
    element: JsonElement,
): InlineV1IssuingDisputesPostRequestFormEvidenceAdditionalDocumentationXc5960901Inspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1IssuingDisputesPostRequestFormEvidenceFraudulentAnyOf1AnyOf2X62e6bfea =
        element
            .isJsonDecodable<InlineV1IssuingDisputesPostRequestFormEvidenceFraudulentAnyOf1AnyOf2X62e6bfea>()
    return InlineV1IssuingDisputesPostRequestFormEvidenceAdditionalDocumentationXc5960901Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1IssuingDisputesPostRequestFormEvidenceFraudulentAnyOf1AnyOf2X62e6bfea) {
                    add(
                        "InlineV1IssuingDisputesPostRequestFormEvidenceFraudulentAnyOf1AnyOf2X62e6bfea: value does not match InlineV1IssuingDisputesPostRequestFormEvidenceFraudulentAnyOf1AnyOf2X62e6bfea",
                    )
                }
            },
    )
