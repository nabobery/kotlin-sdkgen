...
internal data class InlineV1CustomersSourcesPostRequestFormBankAccountXfb61e7dcInspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesInlineV1CustomersSourcesPostRequestFormBankAccountAnyOf1X65d8afb5,
                matchesBranch2,
            ).count { it }
}
...
public class InlineV1CustomersSourcesPostRequestFormBankAccountXfb61e7dc internal constructor(
    ...
    public val inlineV1CustomersSourcesPostRequestFormBankAccountAnyOf1X65d8afb5:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1CustomersSourcesPostRequestFormBankAccountAnyOf1X65d8afb5) {
                json
                    .decodeFromJsonElement<InlineV1CustomersSourcesPostRequestFormBankAccountAnyOf1X65d8afb5>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1CustomersSourcesPostRequestFormBankAccountXfb61e7dcBranch>
        get() =
            buildSet {
                if (inspection.matchesInlineV1CustomersSourcesPostRequestFormBankAccountAnyOf1X65d8afb5) {
                    add(
                        InlineV1CustomersSourcesPostRequestFormBankAccountXfb61e7dcBranch.InlineV1CustomersSourcesPostRequestFormBankAccountAnyOf1X65d8afb5,
                    )
                }
                if (inspection.matchesBranch2) {
                    add(
                        InlineV1CustomersSourcesPostRequestFormBankAccountXfb61e7dcBranch.Branch2,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1CustomersSourcesPostRequestFormBankAccountXfb61e7dc {
            val inspection = inspectInlineV1CustomersSourcesPostRequestFormBankAccountXfb61e7dc(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1CustomersSourcesPostRequestFormBankAccountXfb61e7dcNoMatchException(
                    "InlineV1CustomersSourcesPostRequestFormBankAccountXfb61e7dc matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1CustomersSourcesPostRequestFormBankAccountXfb61e7dc> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersSourcesPostRequestFormBankAccountXfb61e7dc,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1CustomersSourcesPostRequestFormBankAccountXfb61e7dc",
...
private fun inspectInlineV1CustomersSourcesPostRequestFormBankAccountXfb61e7dc(
    element: JsonElement,
): InlineV1CustomersSourcesPostRequestFormBankAccountXfb61e7dcInspection {
    val matchesInlineV1CustomersSourcesPostRequestFormBankAccountAnyOf1X65d8afb5 =
        element
            .isJsonDecodable<InlineV1CustomersSourcesPostRequestFormBankAccountAnyOf1X65d8afb5>()
    ...
    return InlineV1CustomersSourcesPostRequestFormBankAccountXfb61e7dcInspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1CustomersSourcesPostRequestFormBankAccountAnyOf1X65d8afb5) {
                    add(
                        "InlineV1CustomersSourcesPostRequestFormBankAccountAnyOf1X65d8afb5: value does not match InlineV1CustomersSourcesPostRequestFormBankAccountAnyOf1X65d8afb5",
                    )
                }
