...
public class InlineV1PromotionCodesPostRequestFormXf8a049fa(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1PromotionCodesPostRequestFormXf8a049fa =
            InlineV1PromotionCodesPostRequestFormXf8a049fa(
                active = active,
                expand = expand,
                metadata = metadata,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PromotionCodesPostRequestFormXf8a049fa =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PromotionCodesPostRequestFormXf8a049fa> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PromotionCodesPostRequestFormXf8a049fa must be a JSON object",
                    )
            return InlineV1PromotionCodesPostRequestFormXf8a049fa(
                ...
                metadata =
                    rawObject["metadata"]?.let {
                        json.decodeFromJsonElement<InlineV1PromotionCodesPostRequestFormMetadataX1f097777>(it)
                    },
                restrictions =
                    rawObject["restrictions"]?.let {
                        json.decodeFromJsonElement<InlineV1PromotionCodesPostRequestFormRestrictionsX816e824e>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PromotionCodesPostRequestFormXf8a049fa,
        ) {
...
public fun inlineV1PromotionCodesPostRequestFormXf8a049fa(
    block: InlineV1PromotionCodesPostRequestFormXf8a049fa.Builder.() -> Unit,
): InlineV1PromotionCodesPostRequestFormXf8a049fa = InlineV1PromotionCodesPostRequestFormXf8a049fa.build(block)
