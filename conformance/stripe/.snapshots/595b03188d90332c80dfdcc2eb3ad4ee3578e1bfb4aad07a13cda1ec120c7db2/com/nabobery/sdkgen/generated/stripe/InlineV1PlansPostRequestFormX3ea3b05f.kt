...
public class InlineV1PlansPostRequestFormX3ea3b05f(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1PlansPostRequestFormX3ea3b05f =
            InlineV1PlansPostRequestFormX3ea3b05f(
                active = active,
                expand = expand,
                metadata = metadata,
                nickname = nickname,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PlansPostRequestFormX3ea3b05f =
    ...
    public object Serializer : KSerializer<InlineV1PlansPostRequestFormX3ea3b05f> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1PlansPostRequestFormX3ea3b05f {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("InlineV1PlansPostRequestFormX3ea3b05f must be a JSON object")
            return InlineV1PlansPostRequestFormX3ea3b05f(
                ...
                metadata =
                    rawObject["metadata"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PlansPostRequestFormMetadataXe8118113>(
                                it,
                            )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PlansPostRequestFormX3ea3b05f,
        ) {
...
public fun inlineV1PlansPostRequestFormX3ea3b05f(
    block: InlineV1PlansPostRequestFormX3ea3b05f.Builder.() -> Unit,
): InlineV1PlansPostRequestFormX3ea3b05f = InlineV1PlansPostRequestFormX3ea3b05f.build(block)
