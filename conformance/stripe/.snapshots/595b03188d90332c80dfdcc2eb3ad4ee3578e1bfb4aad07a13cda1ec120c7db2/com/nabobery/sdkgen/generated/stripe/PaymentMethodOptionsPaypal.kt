...
public class PaymentMethodOptionsPaypal(
    ...
    public class Builder {
        ...
        public fun build(): PaymentMethodOptionsPaypal =
    ...
    public object Serializer : KSerializer<PaymentMethodOptionsPaypal> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodOptionsPaypal {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodOptionsPaypal must be a JSON object")
            return PaymentMethodOptionsPaypal(
                captureMethod =
                    rawObject["capture_method"]?.let {
                        json.decodeFromJsonElement<InlinePaymentMethodOptionsPaypalCaptureMethodX0ff11584>(it)
                    },
                preferredLocale =
                ...
                setupFutureUsage =
                    rawObject["setup_future_usage"]?.let {
                        json.decodeFromJsonElement<InlinePaymentMethodOptionsPaypalSetupFutureUsageX8451a162>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentMethodOptionsPaypal,
        ) {
...
public fun paymentMethodOptionsPaypal(
    block: PaymentMethodOptionsPaypal.Builder.() -> Unit,
): PaymentMethodOptionsPaypal = PaymentMethodOptionsPaypal.build(block)
