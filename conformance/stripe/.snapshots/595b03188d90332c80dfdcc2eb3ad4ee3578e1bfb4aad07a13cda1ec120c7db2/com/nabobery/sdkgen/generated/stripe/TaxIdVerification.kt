...
public class TaxIdVerification(
    ...
    public object Serializer : KSerializer<TaxIdVerification> {
        ...
        override fun deserialize(decoder: Decoder): TaxIdVerification {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("TaxIdVerification must be a JSON object")
...
public fun taxIdVerification(block: TaxIdVerification.Builder.() -> Unit): TaxIdVerification =
    TaxIdVerification.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("TaxIdVerification is missing required property '" + name + "'")
