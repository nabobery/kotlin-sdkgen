...
public class PaymentMethodDetailsKrCard(
    ...
    public class Builder {
        ...
        public fun build(): PaymentMethodDetailsKrCard =
    ...
    public object Serializer : KSerializer<PaymentMethodDetailsKrCard> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodDetailsKrCard {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodDetailsKrCard must be a JSON object")
                ...
                brand =
                    rawObject["brand"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentMethodDetailsKrCardBrandX1f13668b?>(element)
                        }
                    },
                buyerId =
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentMethodDetailsKrCard,
        ) {
...
public fun paymentMethodDetailsKrCard(
    block: PaymentMethodDetailsKrCard.Builder.() -> Unit,
): PaymentMethodDetailsKrCard = PaymentMethodDetailsKrCard.build(block)
