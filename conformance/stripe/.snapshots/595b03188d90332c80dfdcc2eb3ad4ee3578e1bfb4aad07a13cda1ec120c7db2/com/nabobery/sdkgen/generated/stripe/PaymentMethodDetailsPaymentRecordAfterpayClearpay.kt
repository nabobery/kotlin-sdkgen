...
public class PaymentMethodDetailsPaymentRecordAfterpayClearpay(
    ...
    public class Builder {
        ...
        public fun build(): PaymentMethodDetailsPaymentRecordAfterpayClearpay =
            PaymentMethodDetailsPaymentRecordAfterpayClearpay(
                orderId = orderId,
                reference = reference,
            )
    }
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentMethodDetailsPaymentRecordAfterpayClearpay =
    ...
    public object Serializer : KSerializer<PaymentMethodDetailsPaymentRecordAfterpayClearpay> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "PaymentMethodDetailsPaymentRecordAfterpayClearpay must be a JSON object",
                    )
            return PaymentMethodDetailsPaymentRecordAfterpayClearpay(
                orderId =
                    rawObject["order_id"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentMethodDetailsPaymentRecordAfterpayClearpay,
        ) {
...
public fun paymentMethodDetailsPaymentRecordAfterpayClearpay(
    block: PaymentMethodDetailsPaymentRecordAfterpayClearpay.Builder.() -> Unit,
): PaymentMethodDetailsPaymentRecordAfterpayClearpay = PaymentMethodDetailsPaymentRecordAfterpayClearpay.build(block)
