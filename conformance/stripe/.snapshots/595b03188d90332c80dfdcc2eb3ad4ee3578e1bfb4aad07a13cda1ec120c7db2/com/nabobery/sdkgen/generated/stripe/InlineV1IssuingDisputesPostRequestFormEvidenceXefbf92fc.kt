...
public class InlineV1IssuingDisputesPostRequestFormEvidenceXefbf92fc(
    ...
    public val noValidAuthorization: InlineV1IssuingDisputesPostRequestFormEvidenceNoValidAuthorizationXf450ced2? = null,
    public val notReceived: InlineV1IssuingDisputesPostRequestFormEvidenceNotReceivedX1fdb963c? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1IssuingDisputesPostRequestFormEvidenceXefbf92fc =
            InlineV1IssuingDisputesPostRequestFormEvidenceXefbf92fc(
                canceled = canceled,
                duplicate = duplicate,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1IssuingDisputesPostRequestFormEvidenceXefbf92fc =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1IssuingDisputesPostRequestFormEvidenceXefbf92fc> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1IssuingDisputesPostRequestFormEvidenceXefbf92fc must be a JSON object",
                    )
            return InlineV1IssuingDisputesPostRequestFormEvidenceXefbf92fc(
                canceled =
                    rawObject["canceled"]?.let {
                        json.decodeFromJsonElement<InlineV1IssuingDisputesPostRequestFormEvidenceCanceledXfe885025>(it)
                    },
                duplicate =
                    rawObject["duplicate"]?.let {
                        json.decodeFromJsonElement<InlineV1IssuingDisputesPostRequestFormEvidenceDuplicateX3ca2e5f2>(it)
                    },
                fraudulent =
                    rawObject["fraudulent"]?.let {
                        json.decodeFromJsonElement<InlineV1IssuingDisputesPostRequestFormEvidenceFraudulentXaf1a492b>(
                            it,
                        )
                    },
                merchandiseNotAsDescribed =
                    rawObject["merchandise_not_as_described"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1IssuingDisputesPostRequestFormEvidenceMerchandiseNotAsDescribedXc0751726>(
                                it,
                            )
                    },
                noValidAuthorization =
                    rawObject["no_valid_authorization"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1IssuingDisputesPostRequestFormEvidenceNoValidAuthorizationXf450ced2>(
                                it,
                            )
                    },
                notReceived =
                    rawObject["not_received"]?.let {
                        json.decodeFromJsonElement<InlineV1IssuingDisputesPostRequestFormEvidenceNotReceivedX1fdb963c>(
                            it,
                        )
                    },
                other =
                    rawObject["other"]?.let {
                        json.decodeFromJsonElement<InlineV1IssuingDisputesPostRequestFormEvidenceOtherXb88e74db>(it)
                    },
                reason =
                    rawObject["reason"]?.let {
                        json.decodeFromJsonElement<InlineV1IssuingDisputesPostRequestFormEvidenceReasonX5d7580d5>(it)
                    },
                serviceNotAsDescribed =
                    rawObject["service_not_as_described"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1IssuingDisputesPostRequestFormEvidenceServiceNotAsDescribedXcc152e63>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingDisputesPostRequestFormEvidenceXefbf92fc,
        ) {
            ...
            val raw =
                buildJsonObject {
                    ...
                    value.merchandiseNotAsDescribed?.let {
                        put(
...
public fun inlineV1IssuingDisputesPostRequestFormEvidenceXefbf92fc(
    block: InlineV1IssuingDisputesPostRequestFormEvidenceXefbf92fc.Builder.() -> Unit,
): InlineV1IssuingDisputesPostRequestFormEvidenceXefbf92fc =
    InlineV1IssuingDisputesPostRequestFormEvidenceXefbf92fc.build(block)
