...
public class InlineV1TestHelpersConfirmafd4PostRequestFormUsBankAccountX7e8356e6(
    public val accountHolderType: InlineV1TestHelpersConfirmafd4PostRequestFormAccountHolderTypeX9bcafc98? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1TestHelpersConfirmafd4PostRequestFormUsBankAccountX7e8356e6 =
            InlineV1TestHelpersConfirmafd4PostRequestFormUsBankAccountX7e8356e6(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1TestHelpersConfirmafd4PostRequestFormUsBankAccountX7e8356e6 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TestHelpersConfirmafd4PostRequestFormUsBankAccountX7e8356e6> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TestHelpersConfirmafd4PostRequestFormUsBankAccountX7e8356e6 must be a JSON object",
                    )
            return InlineV1TestHelpersConfirmafd4PostRequestFormUsBankAccountX7e8356e6(
                accountHolderType =
                    rawObject["account_holder_type"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TestHelpersConfirmafd4PostRequestFormAccountHolderTypeX9bcafc98>(
                                it,
                            )
                    },
                ...
                accountType =
                    rawObject["account_type"]?.let {
                        json.decodeFromJsonElement<InlineV1TestHelpersConfirmafd4PostRequestFormAccountTypeX4aef74a6>(
                            it,
                        )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TestHelpersConfirmafd4PostRequestFormUsBankAccountX7e8356e6,
        ) {
            val jsonEncoder =
...
public fun inlineV1TestHelpersConfirmafd4PostRequestFormUsBankAccountX7e8356e6(
    block: InlineV1TestHelpersConfirmafd4PostRequestFormUsBankAccountX7e8356e6.Builder.() -> Unit,
): InlineV1TestHelpersConfirmafd4PostRequestFormUsBankAccountX7e8356e6 =
    InlineV1TestHelpersConfirmafd4PostRequestFormUsBankAccountX7e8356e6.build(block)
