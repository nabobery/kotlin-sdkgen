...
public sealed class InlineBillingBillResourceInvoicingPricingPricingTypeX8164aff2 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineBillingBillResourceInvoicingPricingPricingTypeX8164aff2 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineBillingBillResourceInvoicingPricingPricingTypeX8164aff2> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineBillingBillResourceInvoicingPricingPricingTypeX8164aff2",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineBillingBillResourceInvoicingPricingPricingTypeX8164aff2 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineBillingBillResourceInvoicingPricingPricingTypeX8164aff2,
        ) {
