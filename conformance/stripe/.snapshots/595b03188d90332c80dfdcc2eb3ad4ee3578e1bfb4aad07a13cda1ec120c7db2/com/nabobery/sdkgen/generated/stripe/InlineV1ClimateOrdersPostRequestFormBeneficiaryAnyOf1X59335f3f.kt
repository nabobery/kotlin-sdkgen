...
public class InlineV1ClimateOrdersPostRequestFormBeneficiaryAnyOf1X59335f3f(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1ClimateOrdersPostRequestFormBeneficiaryAnyOf1X59335f3f =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1ClimateOrdersPostRequestFormBeneficiaryAnyOf1X59335f3f> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1ClimateOrdersPostRequestFormBeneficiaryAnyOf1X59335f3f must be a JSON object",
                    )
            val publicName =
                json.decodeRequired<InlineV1ClimateOrdersPostRequestFormBeneficiaryAnyOf1PublicNameX123f1a1a>(
                    rawObject,
                    "public_name",
                )
            return InlineV1ClimateOrdersPostRequestFormBeneficiaryAnyOf1X59335f3f(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ClimateOrdersPostRequestFormBeneficiaryAnyOf1X59335f3f,
        ) {
            val jsonEncoder =
...
public fun inlineV1ClimateOrdersPostRequestFormBeneficiaryAnyOf1X59335f3f(
    block: InlineV1ClimateOrdersPostRequestFormBeneficiaryAnyOf1X59335f3f.Builder.() -> Unit,
): InlineV1ClimateOrdersPostRequestFormBeneficiaryAnyOf1X59335f3f =
    InlineV1ClimateOrdersPostRequestFormBeneficiaryAnyOf1X59335f3f.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1ClimateOrdersPostRequestFormBeneficiaryAnyOf1X59335f3f is missing required property '" + name +
                    "'",
            )
