...
public sealed class InlineV1SubscriptionsResumePostRequestFormBillingCycleAnchorXbcb7599e {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1SubscriptionsResumePostRequestFormBillingCycleAnchorXbcb7599e =
            when (value) {
                Now.value -> Now
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionsResumePostRequestFormBillingCycleAnchorXbcb7599e> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1SubscriptionsResumePostRequestFormBillingCycleAnchorXbcb7599e",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1SubscriptionsResumePostRequestFormBillingCycleAnchorXbcb7599e = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsResumePostRequestFormBillingCycleAnchorXbcb7599e,
        ) {
