...
public sealed class InlineV1SubscriptionSchedulesGetResponse200JsonObjectValueX6a546c74 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1SubscriptionSchedulesGetResponse200JsonObjectValueX6a546c74 =
            when (value) {
                List.value -> List
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionSchedulesGetResponse200JsonObjectValueX6a546c74> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1SubscriptionSchedulesGetResponse200JsonObjectValueX6a546c74",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1SubscriptionSchedulesGetResponse200JsonObjectValueX6a546c74 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionSchedulesGetResponse200JsonObjectValueX6a546c74,
        ) {
