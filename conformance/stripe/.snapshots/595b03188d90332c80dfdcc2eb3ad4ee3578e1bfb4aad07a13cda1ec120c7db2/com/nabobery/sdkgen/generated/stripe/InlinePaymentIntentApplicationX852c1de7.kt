...
public class InlinePaymentIntentApplicationX852c1de7 internal constructor(
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlinePaymentIntentApplicationX852c1de7 {
            val inspection = inspectInlinePaymentIntentApplicationX852c1de7(raw)
            if (inspection.matchCount == 0) {
                throw InlinePaymentIntentApplicationX852c1de7NoMatchException(
                    "InlinePaymentIntentApplicationX852c1de7 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlinePaymentIntentApplicationX852c1de7> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentIntentApplicationX852c1de7,
        ) {
...
private fun inspectInlinePaymentIntentApplicationX852c1de7(
    element: JsonElement,
): InlinePaymentIntentApplicationX852c1de7Inspection {
