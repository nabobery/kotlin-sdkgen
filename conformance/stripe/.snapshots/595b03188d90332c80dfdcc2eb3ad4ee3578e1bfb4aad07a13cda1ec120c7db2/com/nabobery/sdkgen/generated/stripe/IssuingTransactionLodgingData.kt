...
public class IssuingTransactionLodgingData(
    ...
    public class Builder {
        ...
        public fun build(): IssuingTransactionLodgingData =
    ...
    public object Serializer : KSerializer<IssuingTransactionLodgingData> {
        ...
        override fun deserialize(decoder: Decoder): IssuingTransactionLodgingData {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("IssuingTransactionLodgingData must be a JSON object")
            return IssuingTransactionLodgingData(
                checkInAt =
                    rawObject["check_in_at"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: IssuingTransactionLodgingData,
        ) {
...
public fun issuingTransactionLodgingData(
    block: IssuingTransactionLodgingData.Builder.() -> Unit,
): IssuingTransactionLodgingData = IssuingTransactionLodgingData.build(block)
