...
public class InlineV1PaymentIntentsConfirmPostRequestFormMandateOptionsX604eed4f(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentIntentsConfirmPostRequestFormMandateOptionsX604eed4f = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsConfirmPostRequestFormMandateOptionsX604eed4f> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsConfirmPostRequestFormMandateOptionsX604eed4f must be a JSON object",
                    )
            val amount = json.decodeRequired<Int>(rawObject, "amount")
            val amountType =
                json.decodeRequired<InlineV1PaymentIntentsConfirmPostRequestFormAmountTypeX453c27a3>(
                    rawObject,
                    "amount_type",
                )
            val interval =
                json.decodeRequired<InlineV1PaymentIntentsConfirmPostRequestFormIntervalX3d3eb2fc>(
                    rawObject,
                    "interval",
                )
            ...
            return InlineV1PaymentIntentsConfirmPostRequestFormMandateOptionsX604eed4f(
                ...
                supportedTypes =
                    rawObject["supported_types"]?.let {
                        json
                            .decodeFromJsonElement<List<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsItemX418a1f70>>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsConfirmPostRequestFormMandateOptionsX604eed4f,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentIntentsConfirmPostRequestFormMandateOptionsX604eed4f(
    block: InlineV1PaymentIntentsConfirmPostRequestFormMandateOptionsX604eed4f.Builder.() -> Unit,
): InlineV1PaymentIntentsConfirmPostRequestFormMandateOptionsX604eed4f =
    InlineV1PaymentIntentsConfirmPostRequestFormMandateOptionsX604eed4f.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentIntentsConfirmPostRequestFormMandateOptionsX604eed4f is missing required property '" +
                    name +
                    "'",
            )
