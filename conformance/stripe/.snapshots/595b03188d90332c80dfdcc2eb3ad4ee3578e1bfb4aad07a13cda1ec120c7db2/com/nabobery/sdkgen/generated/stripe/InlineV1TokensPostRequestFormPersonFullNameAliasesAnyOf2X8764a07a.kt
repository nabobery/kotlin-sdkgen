...
public sealed class InlineV1TokensPostRequestFormPersonFullNameAliasesAnyOf2X8764a07a {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1TokensPostRequestFormPersonFullNameAliasesAnyOf2X8764a07a =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1TokensPostRequestFormPersonFullNameAliasesAnyOf2X8764a07a> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1TokensPostRequestFormPersonFullNameAliasesAnyOf2X8764a07a",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1TokensPostRequestFormPersonFullNameAliasesAnyOf2X8764a07a =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TokensPostRequestFormPersonFullNameAliasesAnyOf2X8764a07a,
        ) {
