...
public sealed class InlinePaymentIntentSetupFutureUsageX44bafcda {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentIntentSetupFutureUsageX44bafcda =
            when (value) {
    ...
    public object Serializer : KSerializer<InlinePaymentIntentSetupFutureUsageX44bafcda> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentIntentSetupFutureUsageX44bafcda",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePaymentIntentSetupFutureUsageX44bafcda =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentIntentSetupFutureUsageX44bafcda,
        ) {
