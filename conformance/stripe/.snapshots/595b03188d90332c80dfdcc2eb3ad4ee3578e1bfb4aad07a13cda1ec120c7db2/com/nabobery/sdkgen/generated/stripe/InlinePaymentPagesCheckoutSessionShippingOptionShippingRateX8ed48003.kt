...
public class InlinePaymentPagesCheckoutSessionShippingOptionShippingRateX8ed48003 internal constructor(
    ...
    private val inspection: InlinePaymentPagesCheckoutSessionShippingOptionShippingRateX8ed48003Inspection,
) {
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlinePaymentPagesCheckoutSessionShippingOptionShippingRateX8ed48003Branch.Branch1,
                    )
                }
                if (inspection.matchesShippingRate) {
                    add(
                        InlinePaymentPagesCheckoutSessionShippingOptionShippingRateX8ed48003Branch.ShippingRate,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlinePaymentPagesCheckoutSessionShippingOptionShippingRateX8ed48003 {
            val inspection = inspectInlinePaymentPagesCheckoutSessionShippingOptionShippingRateX8ed48003(raw)
            if (inspection.matchCount == 0) {
                throw InlinePaymentPagesCheckoutSessionShippingOptionShippingRateX8ed48003NoMatchException(
                    "InlinePaymentPagesCheckoutSessionShippingOptionShippingRateX8ed48003 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlinePaymentPagesCheckoutSessionShippingOptionShippingRateX8ed48003> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentPagesCheckoutSessionShippingOptionShippingRateX8ed48003,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlinePaymentPagesCheckoutSessionShippingOptionShippingRateX8ed48003",
...
private fun inspectInlinePaymentPagesCheckoutSessionShippingOptionShippingRateX8ed48003(
    element: JsonElement,
