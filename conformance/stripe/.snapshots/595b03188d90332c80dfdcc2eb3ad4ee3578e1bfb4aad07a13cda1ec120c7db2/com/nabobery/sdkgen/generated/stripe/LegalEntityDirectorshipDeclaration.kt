...
public class LegalEntityDirectorshipDeclaration(
    ...
    public class Builder {
        ...
        public fun build(): LegalEntityDirectorshipDeclaration =
    ...
    public object Serializer : KSerializer<LegalEntityDirectorshipDeclaration> {
        ...
        override fun deserialize(decoder: Decoder): LegalEntityDirectorshipDeclaration {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("LegalEntityDirectorshipDeclaration must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: LegalEntityDirectorshipDeclaration,
        ) {
...
public fun legalEntityDirectorshipDeclaration(
    block: LegalEntityDirectorshipDeclaration.Builder.() -> Unit,
): LegalEntityDirectorshipDeclaration = LegalEntityDirectorshipDeclaration.build(block)
