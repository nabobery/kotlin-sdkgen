...
public class InlineV1AccountsPeoplePostRequestFormUsCfpbDataX5223c4aa(
    public val ethnicityDetails: InlineV1AccountsPeoplePostRequestFormUsCfpbDataEthnicityDetailsX8d48f1bb? = null,
    public val raceDetails: InlineV1AccountsPeoplePostRequestFormUsCfpbDataRaceDetailsX6fc2d809? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1AccountsPeoplePostRequestFormUsCfpbDataX5223c4aa =
            InlineV1AccountsPeoplePostRequestFormUsCfpbDataX5223c4aa(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1AccountsPeoplePostRequestFormUsCfpbDataX5223c4aa =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1AccountsPeoplePostRequestFormUsCfpbDataX5223c4aa> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountsPeoplePostRequestFormUsCfpbDataX5223c4aa must be a JSON object",
                    )
            return InlineV1AccountsPeoplePostRequestFormUsCfpbDataX5223c4aa(
                ethnicityDetails =
                    rawObject["ethnicity_details"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1AccountsPeoplePostRequestFormUsCfpbDataEthnicityDetailsX8d48f1bb>(
                                it,
                            )
                    },
                raceDetails =
                    rawObject["race_details"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountsPeoplePostRequestFormUsCfpbDataRaceDetailsX6fc2d809>(
                            it,
                        )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPeoplePostRequestFormUsCfpbDataX5223c4aa,
        ) {
...
public fun inlineV1AccountsPeoplePostRequestFormUsCfpbDataX5223c4aa(
    block: InlineV1AccountsPeoplePostRequestFormUsCfpbDataX5223c4aa.Builder.() -> Unit,
): InlineV1AccountsPeoplePostRequestFormUsCfpbDataX5223c4aa =
    InlineV1AccountsPeoplePostRequestFormUsCfpbDataX5223c4aa.build(block)
