...
public sealed class InlineCheckoutRevolutPayPaymentMethodOptionsSetupFutureUsageX5d22c693 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineCheckoutRevolutPayPaymentMethodOptionsSetupFutureUsageX5d22c693 =
            when (value) {
                None.value -> None
    ...
    public object Serializer : KSerializer<InlineCheckoutRevolutPayPaymentMethodOptionsSetupFutureUsageX5d22c693> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineCheckoutRevolutPayPaymentMethodOptionsSetupFutureUsageX5d22c693",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineCheckoutRevolutPayPaymentMethodOptionsSetupFutureUsageX5d22c693 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineCheckoutRevolutPayPaymentMethodOptionsSetupFutureUsageX5d22c693,
        ) {
