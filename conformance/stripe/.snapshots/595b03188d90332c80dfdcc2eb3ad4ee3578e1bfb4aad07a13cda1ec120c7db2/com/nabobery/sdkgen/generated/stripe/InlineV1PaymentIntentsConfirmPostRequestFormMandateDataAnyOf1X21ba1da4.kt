...
public class InlineV1PaymentIntentsConfirmPostRequestFormMandateDataAnyOf1X21ba1da4(
    public val customerAcceptance: InlineV1PaymentIntentsConfirmPostRequestFormCustomerAcceptanceX4236445d,
) {
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentIntentsConfirmPostRequestFormMandateDataAnyOf1X21ba1da4 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsConfirmPostRequestFormMandateDataAnyOf1X21ba1da4> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsConfirmPostRequestFormMandateDataAnyOf1X21ba1da4 must be a JSON object",
                    )
            val customerAcceptance =
                json
                    .decodeRequired<InlineV1PaymentIntentsConfirmPostRequestFormCustomerAcceptanceX4236445d>(
                        rawObject,
                        "customer_acceptance",
                    )
            return InlineV1PaymentIntentsConfirmPostRequestFormMandateDataAnyOf1X21ba1da4(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsConfirmPostRequestFormMandateDataAnyOf1X21ba1da4,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentIntentsConfirmPostRequestFormMandateDataAnyOf1X21ba1da4(
    block: InlineV1PaymentIntentsConfirmPostRequestFormMandateDataAnyOf1X21ba1da4.Builder.() -> Unit,
): InlineV1PaymentIntentsConfirmPostRequestFormMandateDataAnyOf1X21ba1da4 =
    InlineV1PaymentIntentsConfirmPostRequestFormMandateDataAnyOf1X21ba1da4.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentIntentsConfirmPostRequestFormMandateDataAnyOf1X21ba1da4 is missing required property '" +
                    name +
                    "'",
            )
