...
public class InlineV1QuotesPostRequestFormLineItemsItemPriceDataX9ab56738(
    ...
    public val recurring: InlineV1QuotesPostRequestFormLineItemsItemPriceDataRecurringX7c8bc457? = null,
    public val taxBehavior: InlineV1QuotesPostRequestFormLineItemsItemPriceDataTaxBehaviorX8941048e? = null,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1QuotesPostRequestFormLineItemsItemPriceDataX9ab56738 =
    ...
    public object Serializer : KSerializer<InlineV1QuotesPostRequestFormLineItemsItemPriceDataX9ab56738> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1QuotesPostRequestFormLineItemsItemPriceDataX9ab56738 must be a JSON object",
                    )
            ...
            return InlineV1QuotesPostRequestFormLineItemsItemPriceDataX9ab56738(
                ...
                recurring =
                    rawObject["recurring"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1QuotesPostRequestFormLineItemsItemPriceDataRecurringX7c8bc457>(
                                it,
                            )
                    },
                taxBehavior =
                    rawObject["tax_behavior"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1QuotesPostRequestFormLineItemsItemPriceDataTaxBehaviorX8941048e>(
                                it,
                            )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1QuotesPostRequestFormLineItemsItemPriceDataX9ab56738,
        ) {
...
public fun inlineV1QuotesPostRequestFormLineItemsItemPriceDataX9ab56738(
    block: InlineV1QuotesPostRequestFormLineItemsItemPriceDataX9ab56738.Builder.() -> Unit,
): InlineV1QuotesPostRequestFormLineItemsItemPriceDataX9ab56738 =
    InlineV1QuotesPostRequestFormLineItemsItemPriceDataX9ab56738.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1QuotesPostRequestFormLineItemsItemPriceDataX9ab56738 is missing required property '" + name +
                    "'",
            )
