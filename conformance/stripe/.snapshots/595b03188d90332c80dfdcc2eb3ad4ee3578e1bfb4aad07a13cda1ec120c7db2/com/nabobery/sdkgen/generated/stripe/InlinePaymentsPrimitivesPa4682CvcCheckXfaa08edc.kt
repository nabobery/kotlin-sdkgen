...
public sealed class InlinePaymentsPrimitivesPa4682CvcCheckXfaa08edc {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentsPrimitivesPa4682CvcCheckXfaa08edc =
            when (value) {
                Fail.value -> Fail
                Pass.value -> Pass
    ...
    public object Serializer : KSerializer<InlinePaymentsPrimitivesPa4682CvcCheckXfaa08edc> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentsPrimitivesPa4682CvcCheckXfaa08edc",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePaymentsPrimitivesPa4682CvcCheckXfaa08edc =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentsPrimitivesPa4682CvcCheckXfaa08edc,
        ) {
