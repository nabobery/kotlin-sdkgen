...
public class InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf1Xf4bad71e(
    public val captureMethod: InlineV1PaymentIntentsConfirmPostRequestFormCaptureMethodXd08cb514? = null,
    public val cvcToken: String? = null,
    public val installments: InlineV1PaymentIntentsConfirmPostRequestFormInstallmentsX6500bc61? = null,
    public val mandateOptions: InlineV1PaymentIntentsConfirmPostRequestFormMandateOptionsX604eed4f? = null,
    public val network: InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsNetworkX8e379a6b? = null,
    ...
    public val requestMulticapture: InlineV1PaymentIntentsConfirmPostRequestFormRequestMulticaptureX62caec4e? = null,
    public val requestOvercapture: InlineV1PaymentIntentsConfirmPostRequestFormRequestOvercaptureXb5bc38a4? = null,
    public val requestThreeDSecure: InlineV1PaymentIntentsConfirmPostRequestFormRequestThreeDSecureXc10609fc? = null,
    public val requireCvcRecollection: Boolean? = null,
    public val setupFutureUsage: InlineV1PaymentIntentsConfirmPostRequestFormSetupFutureUsageX8a0bf4c4? = null,
    ...
    public val threeDSecure: InlineV1PaymentIntentsConfirmPostRequestFormThreeDSecureX3c588fcd? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf1Xf4bad71e =
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf1Xf4bad71e> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf1Xf4bad71e must be a JSON object",
                    )
            return InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf1Xf4bad71e(
                captureMethod =
                    rawObject["capture_method"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormCaptureMethodXd08cb514>(
                            it,
                        )
                    },
                ...
                installments =
                    rawObject["installments"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormInstallmentsX6500bc61>(
                            it,
                        )
                    },
                mandateOptions =
                    rawObject["mandate_options"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormMandateOptionsX604eed4f>(
                            it,
                        )
                    },
                network =
                    rawObject["network"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsNetworkX8e379a6b>(
                                it,
                            )
                    },
                requestExtendedAuthorization =
                    rawObject["request_extended_authorization"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormRequestExtendedAutho403fXe9b605d8>(
                                it,
                            )
                    },
                requestIncrementalAuthorization =
                    rawObject["request_incremental_authorization"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormRequestIncrementalAu57cdX297201a3>(
                                it,
                            )
                    },
                requestMulticapture =
                    rawObject["request_multicapture"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormRequestMulticaptureX62caec4e>(
                                it,
                            )
                    },
                requestOvercapture =
                    rawObject["request_overcapture"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormRequestOvercaptureXb5bc38a4>(
                                it,
                            )
                    },
                requestThreeDSecure =
                    rawObject["request_three_d_secure"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormRequestThreeDSecureXc10609fc>(
                                it,
                            )
                    },
                ...
                setupFutureUsage =
                    rawObject["setup_future_usage"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormSetupFutureUsageX8a0bf4c4>(
                                it,
                            )
                    },
                statementDescriptorSuffixKana =
                    rawObject["statement_descriptor_suffix_kana"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormStatementDescriptorS583fXf9b759d2>(
                                it,
                            )
                    },
                statementDescriptorSuffixKanji =
                    rawObject["statement_descriptor_suffix_kanji"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormStatementDescriptorSb1afXec81a7f6>(
                                it,
                            )
                    },
                threeDSecure =
                    rawObject["three_d_secure"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormThreeDSecureX3c588fcd>(
                            it,
                        )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf1Xf4bad71e,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf1Xf4bad71e(
    block: InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf1Xf4bad71e.Builder.() -> Unit,
): InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf1Xf4bad71e =
    InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf1Xf4bad71e.build(block)
