...
internal data class InlineV1CustomersPostRequestFormShippingX3a4d1b73Inspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesInlineV1CustomersPostRequestFormShippingAnyOf1X716d3a19,
                matchesInlineV1CustomersPostRequestFormShippingAnyOf2Xe470517b,
            ).count {
                it
            }
}
...
public class InlineV1CustomersPostRequestFormShippingX3a4d1b73 internal constructor(
    ...
    public val inlineV1CustomersPostRequestFormShippingAnyOf1X716d3a19:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1CustomersPostRequestFormShippingAnyOf1X716d3a19) {
                json
                    .decodeFromJsonElement<InlineV1CustomersPostRequestFormShippingAnyOf1X716d3a19>(
                        raw,
                    )
            } else {
                null
    ...
    public val inlineV1CustomersPostRequestFormShippingAnyOf2Xe470517b:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1CustomersPostRequestFormShippingAnyOf2Xe470517b) {
                json
                    .decodeFromJsonElement<InlineV1CustomersPostRequestFormShippingAnyOf2Xe470517b>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1CustomersPostRequestFormShippingX3a4d1b73Branch>
        get() =
            buildSet {
                if (inspection.matchesInlineV1CustomersPostRequestFormShippingAnyOf1X716d3a19) {
                    add(
                        InlineV1CustomersPostRequestFormShippingX3a4d1b73Branch.InlineV1CustomersPostRequestFormShippingAnyOf1X716d3a19,
                    )
                }
                if (inspection.matchesInlineV1CustomersPostRequestFormShippingAnyOf2Xe470517b) {
                    add(
                        InlineV1CustomersPostRequestFormShippingX3a4d1b73Branch.InlineV1CustomersPostRequestFormShippingAnyOf2Xe470517b,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1CustomersPostRequestFormShippingX3a4d1b73 {
            val inspection = inspectInlineV1CustomersPostRequestFormShippingX3a4d1b73(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1CustomersPostRequestFormShippingX3a4d1b73NoMatchException(
                    "InlineV1CustomersPostRequestFormShippingX3a4d1b73 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1CustomersPostRequestFormShippingX3a4d1b73> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersPostRequestFormShippingX3a4d1b73,
        ) {
...
private fun inspectInlineV1CustomersPostRequestFormShippingX3a4d1b73(
    element: JsonElement,
): InlineV1CustomersPostRequestFormShippingX3a4d1b73Inspection {
    val matchesInlineV1CustomersPostRequestFormShippingAnyOf1X716d3a19 =
        element
            .isJsonDecodable<InlineV1CustomersPostRequestFormShippingAnyOf1X716d3a19>()
    val matchesInlineV1CustomersPostRequestFormShippingAnyOf2Xe470517b =
        element
            .isJsonDecodable<InlineV1CustomersPostRequestFormShippingAnyOf2Xe470517b>()
    return InlineV1CustomersPostRequestFormShippingX3a4d1b73Inspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1CustomersPostRequestFormShippingAnyOf1X716d3a19) {
                    add(
                        "InlineV1CustomersPostRequestFormShippingAnyOf1X716d3a19: value does not match InlineV1CustomersPostRequestFormShippingAnyOf1X716d3a19",
                    )
                }
                if (!matchesInlineV1CustomersPostRequestFormShippingAnyOf2Xe470517b) {
                    add(
                        "InlineV1CustomersPostRequestFormShippingAnyOf2Xe470517b: value does not match InlineV1CustomersPostRequestFormShippingAnyOf2Xe470517b",
                    )
                }
            },
    )
