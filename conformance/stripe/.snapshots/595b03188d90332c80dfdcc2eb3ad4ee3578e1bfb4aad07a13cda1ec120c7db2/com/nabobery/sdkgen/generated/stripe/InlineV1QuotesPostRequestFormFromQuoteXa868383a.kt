...
public class InlineV1QuotesPostRequestFormFromQuoteXa868383a(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1QuotesPostRequestFormFromQuoteXa868383a =
    ...
    public object Serializer : KSerializer<InlineV1QuotesPostRequestFormFromQuoteXa868383a> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1QuotesPostRequestFormFromQuoteXa868383a must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1QuotesPostRequestFormFromQuoteXa868383a,
        ) {
...
public fun inlineV1QuotesPostRequestFormFromQuoteXa868383a(
    block: InlineV1QuotesPostRequestFormFromQuoteXa868383a.Builder.() -> Unit,
): InlineV1QuotesPostRequestFormFromQuoteXa868383a = InlineV1QuotesPostRequestFormFromQuoteXa868383a.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1QuotesPostRequestFormFromQuoteXa868383a is missing required property '" + name + "'",
            )
