...
public sealed class InlineConfirmationTokenObjectValueXd062abfb {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineConfirmationTokenObjectValueXd062abfb =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineConfirmationTokenObjectValueXd062abfb> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineConfirmationTokenObjectValueXd062abfb",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineConfirmationTokenObjectValueXd062abfb =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineConfirmationTokenObjectValueXd062abfb,
        ) {
