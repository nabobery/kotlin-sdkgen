...
internal data class InlineV1PaymentIntentsPostRequestFormTransferDataPaymentDataMetadataXc9df835bInspection(
    ...
    public val matchesInlineV1PaymentIntentsPostRequestFormTransferDataPaymentDataAnyOf2Xd18ff118: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1PaymentIntentsPostRequestFormTransferDataPaymentDataAnyOf2Xd18ff118,
            ).count {
                it
            }
}
...
public class InlineV1PaymentIntentsPostRequestFormTransferDataPaymentDataMetadataXc9df835b internal constructor(
    ...
    private val inspection: InlineV1PaymentIntentsPostRequestFormTransferDataPaymentDataMetadataXc9df835bInspection,
) {
    ...
    public val inlineV1PaymentIntentsPostRequestFormTransferDataPaymentDataAnyOf2Xd18ff118:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1PaymentIntentsPostRequestFormTransferDataPaymentDataAnyOf2Xd18ff118) {
                json
                    .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormTransferDataPaymentDataAnyOf2Xd18ff118>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1PaymentIntentsPostRequestFormTransferDataPaymentDataMetadataXc9df835bBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1PaymentIntentsPostRequestFormTransferDataPaymentDataAnyOf2Xd18ff118) {
                    add(
                        InlineV1PaymentIntentsPostRequestFormTransferDataPaymentDataMetadataXc9df835bBranch.InlineV1PaymentIntentsPostRequestFormTransferDataPaymentDataAnyOf2Xd18ff118,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1PaymentIntentsPostRequestFormTransferDataPaymentDataMetadataXc9df835b {
            val inspection = inspectInlineV1PaymentIntentsPostRequestFormTransferDataPaymentDataMetadataXc9df835b(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1PaymentIntentsPostRequestFormTransferDataPaymentDataMetadataXc9df835bNoMatchException(
                    "InlineV1PaymentIntentsPostRequestFormTransferDataPaymentDataMetadataXc9df835b matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormTransferDataPaymentDataMetadataXc9df835b> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormTransferDataPaymentDataMetadataXc9df835b,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1PaymentIntentsPostRequestFormTransferDataPaymentDataMetadataXc9df835b",
...
private fun inspectInlineV1PaymentIntentsPostRequestFormTransferDataPaymentDataMetadataXc9df835b(
    element: JsonElement,
): InlineV1PaymentIntentsPostRequestFormTransferDataPaymentDataMetadataXc9df835bInspection {
    val matchesBranch1 = element.isJsonDecodable<JsonObject>()
    val matchesInlineV1PaymentIntentsPostRequestFormTransferDataPaymentDataAnyOf2Xd18ff118 =
        element
            .isJsonDecodable<InlineV1PaymentIntentsPostRequestFormTransferDataPaymentDataAnyOf2Xd18ff118>()
    return InlineV1PaymentIntentsPostRequestFormTransferDataPaymentDataMetadataXc9df835bInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1PaymentIntentsPostRequestFormTransferDataPaymentDataAnyOf2Xd18ff118) {
                    add(
                        "InlineV1PaymentIntentsPostRequestFormTransferDataPaymentDataAnyOf2Xd18ff118: value does not match InlineV1PaymentIntentsPostRequestFormTransferDataPaymentDataAnyOf2Xd18ff118",
                    )
                }
            },
    )
