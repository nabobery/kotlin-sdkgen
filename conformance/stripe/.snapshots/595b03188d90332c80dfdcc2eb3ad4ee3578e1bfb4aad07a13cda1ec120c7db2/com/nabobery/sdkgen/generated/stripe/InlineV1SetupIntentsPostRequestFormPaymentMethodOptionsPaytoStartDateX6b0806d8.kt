...
internal data class InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsPaytoStartDateX6b0806d8Inspection(
    ...
    public val matchesInlineV1SetupIntentsPostRequestFormPaymentMethodOptionsPaytoAnyOf2Xc0c8eb7a: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1SetupIntentsPostRequestFormPaymentMethodOptionsPaytoAnyOf2Xc0c8eb7a,
            ).count {
                it
            }
}
...
public class InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsPaytoStartDateX6b0806d8 internal constructor(
    ...
    private val inspection: InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsPaytoStartDateX6b0806d8Inspection,
) {
    ...
    public val inlineV1SetupIntentsPostRequestFormPaymentMethodOptionsPaytoAnyOf2Xc0c8eb7a:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1SetupIntentsPostRequestFormPaymentMethodOptionsPaytoAnyOf2Xc0c8eb7a) {
                json
                    .decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsPaytoAnyOf2Xc0c8eb7a>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsPaytoStartDateX6b0806d8Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1SetupIntentsPostRequestFormPaymentMethodOptionsPaytoAnyOf2Xc0c8eb7a) {
                    add(
                        InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsPaytoStartDateX6b0806d8Branch.InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsPaytoAnyOf2Xc0c8eb7a,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsPaytoStartDateX6b0806d8 {
            val inspection = inspectInlineV1SetupIntentsPostRequestFormPaymentMethodOptionsPaytoStartDateX6b0806d8(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsPaytoStartDateX6b0806d8NoMatchException(
                    "InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsPaytoStartDateX6b0806d8 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsPaytoStartDateX6b0806d8> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsPaytoStartDateX6b0806d8,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsPaytoStartDateX6b0806d8",
...
private fun inspectInlineV1SetupIntentsPostRequestFormPaymentMethodOptionsPaytoStartDateX6b0806d8(
    element: JsonElement,
): InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsPaytoStartDateX6b0806d8Inspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1SetupIntentsPostRequestFormPaymentMethodOptionsPaytoAnyOf2Xc0c8eb7a =
        element
            .isJsonDecodable<InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsPaytoAnyOf2Xc0c8eb7a>()
    return InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsPaytoStartDateX6b0806d8Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1SetupIntentsPostRequestFormPaymentMethodOptionsPaytoAnyOf2Xc0c8eb7a) {
                    add(
                        "InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsPaytoAnyOf2Xc0c8eb7a: value does not match InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsPaytoAnyOf2Xc0c8eb7a",
                    )
                }
            },
    )
