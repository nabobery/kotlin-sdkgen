...
public class InlineV1PaymentMethodsPostRequestFormAcssDebitX9cb3cc2f(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PaymentMethodsPostRequestFormAcssDebitX9cb3cc2f =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentMethodsPostRequestFormAcssDebitX9cb3cc2f> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentMethodsPostRequestFormAcssDebitX9cb3cc2f must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentMethodsPostRequestFormAcssDebitX9cb3cc2f,
        ) {
...
public fun inlineV1PaymentMethodsPostRequestFormAcssDebitX9cb3cc2f(
    block: InlineV1PaymentMethodsPostRequestFormAcssDebitX9cb3cc2f.Builder.() -> Unit,
): InlineV1PaymentMethodsPostRequestFormAcssDebitX9cb3cc2f =
    InlineV1PaymentMethodsPostRequestFormAcssDebitX9cb3cc2f.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentMethodsPostRequestFormAcssDebitX9cb3cc2f is missing required property '" + name + "'",
            )
