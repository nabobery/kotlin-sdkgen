...
public class InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsDurationX9d9dc670(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsDurationX9d9dc670 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsDurationX9d9dc670> {
        override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsDurationX9d9dc670 {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsDurationX9d9dc670 must be a JSON object",
                    )
            val interval =
                json.decodeRequired<InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsIntervalXc272de55>(
                    rawObject,
                    "interval",
                )
            return InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsDurationX9d9dc670(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsDurationX9d9dc670,
        ) {
            val jsonEncoder =
...
public fun inlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsDurationX9d9dc670(
    block: InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsDurationX9d9dc670.Builder.() -> Unit,
): InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsDurationX9d9dc670 =
    InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsDurationX9d9dc670.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsDurationX9d9dc670 is missing required property '" +
                    name +
                    "'",
            )
