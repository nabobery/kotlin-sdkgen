...
public sealed class InlineDisputeEnhancedEligibilityVisaComplianceStatusXb5803dfa {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineDisputeEnhancedEligibilityVisaComplianceStatusXb5803dfa =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineDisputeEnhancedEligibilityVisaComplianceStatusXb5803dfa> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineDisputeEnhancedEligibilityVisaComplianceStatusXb5803dfa",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineDisputeEnhancedEligibilityVisaComplianceStatusXb5803dfa =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineDisputeEnhancedEligibilityVisaComplianceStatusXb5803dfa,
        ) {
