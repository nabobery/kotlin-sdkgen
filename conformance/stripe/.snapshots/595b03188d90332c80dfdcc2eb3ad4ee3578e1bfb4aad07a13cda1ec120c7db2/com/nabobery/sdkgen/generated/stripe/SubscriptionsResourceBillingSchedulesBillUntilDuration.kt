...
public data class SubscriptionsResourceBillingSchedulesBillUntilDurationView(
    public val interval: InlineSubscriptionsResourceBillingSchedulesBillUntilDurationIntervalXafce0a8a,
...
public class SubscriptionsResourceBillingSchedulesBillUntilDuration(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): SubscriptionsResourceBillingSchedulesBillUntilDuration =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<SubscriptionsResourceBillingSchedulesBillUntilDuration> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "SubscriptionsResourceBillingSchedulesBillUntilDuration must be a JSON object",
                    )
            val interval =
                json.decodeRequired<InlineSubscriptionsResourceBillingSchedulesBillUntilDurationIntervalXafce0a8a>(
                    rawObject,
                    "interval",
                )
            return SubscriptionsResourceBillingSchedulesBillUntilDuration(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: SubscriptionsResourceBillingSchedulesBillUntilDuration,
        ) {
...
public fun subscriptionsResourceBillingSchedulesBillUntilDuration(
    block: SubscriptionsResourceBillingSchedulesBillUntilDuration.Builder.() -> Unit,
): SubscriptionsResourceBillingSchedulesBillUntilDuration =
    SubscriptionsResourceBillingSchedulesBillUntilDuration.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "SubscriptionsResourceBillingSchedulesBillUntilDuration is missing required property '" + name + "'",
            )
