...
public class InlineV1SetupIntentsPostRequestFormPaymentMethodDataNzBankAccountX3be81a6a(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1SetupIntentsPostRequestFormPaymentMethodDataNzBankAccountX3be81a6a = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1SetupIntentsPostRequestFormPaymentMethodDataNzBankAccountX3be81a6a> {
        override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1SetupIntentsPostRequestFormPaymentMethodDataNzBankAccountX3be81a6a {
            val jsonDecoder =
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SetupIntentsPostRequestFormPaymentMethodDataNzBankAccountX3be81a6a must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SetupIntentsPostRequestFormPaymentMethodDataNzBankAccountX3be81a6a,
        ) {
            val jsonEncoder =
...
public fun inlineV1SetupIntentsPostRequestFormPaymentMethodDataNzBankAccountX3be81a6a(
    block: InlineV1SetupIntentsPostRequestFormPaymentMethodDataNzBankAccountX3be81a6a.Builder.() -> Unit,
): InlineV1SetupIntentsPostRequestFormPaymentMethodDataNzBankAccountX3be81a6a =
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1SetupIntentsPostRequestFormPaymentMethodDataNzBankAccountX3be81a6a is missing required property '" +
                    name +
                    "'",
            )
