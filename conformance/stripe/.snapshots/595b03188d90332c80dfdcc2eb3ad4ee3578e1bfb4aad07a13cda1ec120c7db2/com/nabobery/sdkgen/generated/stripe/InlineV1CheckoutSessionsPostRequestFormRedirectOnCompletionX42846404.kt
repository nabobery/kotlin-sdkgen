...
public sealed class InlineV1CheckoutSessionsPostRequestFormRedirectOnCompletionX42846404 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1CheckoutSessionsPostRequestFormRedirectOnCompletionX42846404 =
            when (value) {
                Always.value -> Always
    ...
    public object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormRedirectOnCompletionX42846404> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1CheckoutSessionsPostRequestFormRedirectOnCompletionX42846404",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1CheckoutSessionsPostRequestFormRedirectOnCompletionX42846404 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CheckoutSessionsPostRequestFormRedirectOnCompletionX42846404,
        ) {
