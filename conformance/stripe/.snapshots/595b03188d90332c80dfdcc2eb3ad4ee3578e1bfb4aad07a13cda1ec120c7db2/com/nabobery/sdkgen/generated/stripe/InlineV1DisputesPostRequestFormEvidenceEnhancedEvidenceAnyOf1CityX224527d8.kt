...
internal data class InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1CityX224527d8Inspection(
    ...
    public val matchesInlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2Xab811538: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2Xab811538,
            ).count {
                it
            }
}
...
public class InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1CityX224527d8 internal constructor(
    ...
    private val inspection: InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1CityX224527d8Inspection,
) {
    ...
    public val inlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2Xab811538:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2Xab811538) {
                json
                    .decodeFromJsonElement<InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2Xab811538>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1CityX224527d8Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2Xab811538) {
                    add(
                        InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1CityX224527d8Branch.InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2Xab811538,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1CityX224527d8 {
            val inspection = inspectInlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1CityX224527d8(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1CityX224527d8NoMatchException(
                    "InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1CityX224527d8 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1CityX224527d8> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1CityX224527d8,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1CityX224527d8",
...
private fun inspectInlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1CityX224527d8(
    element: JsonElement,
): InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1CityX224527d8Inspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2Xab811538 =
        element
            .isJsonDecodable<InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2Xab811538>()
    return InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1CityX224527d8Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2Xab811538) {
                    add(
                        "InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2Xab811538: value does not match InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2Xab811538",
                    )
                }
            },
    )
