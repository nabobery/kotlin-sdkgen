...
public class InlineV1IssuingCardsPostRequestFormPinXeb8be2a5(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1IssuingCardsPostRequestFormPinXeb8be2a5 =
            InlineV1IssuingCardsPostRequestFormPinXeb8be2a5(
                encryptedNumber = encryptedNumber,
            )
    }

    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1IssuingCardsPostRequestFormPinXeb8be2a5 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1IssuingCardsPostRequestFormPinXeb8be2a5> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1IssuingCardsPostRequestFormPinXeb8be2a5 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingCardsPostRequestFormPinXeb8be2a5,
        ) {
...
public fun inlineV1IssuingCardsPostRequestFormPinXeb8be2a5(
    block: InlineV1IssuingCardsPostRequestFormPinXeb8be2a5.Builder.() -> Unit,
): InlineV1IssuingCardsPostRequestFormPinXeb8be2a5 = InlineV1IssuingCardsPostRequestFormPinXeb8be2a5.build(block)
