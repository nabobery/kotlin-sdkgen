...
public data class TreasuryOutboundTransfersResourceReturnedDetailsView(
    ...
    public val transaction: InlineTreasuryOutboundTransfersResourceReturnedDetailsTransactionX427e24ee,
)
...
public class TreasuryOutboundTransfersResourceReturnedDetails(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): TreasuryOutboundTransfersResourceReturnedDetails =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<TreasuryOutboundTransfersResourceReturnedDetails> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "TreasuryOutboundTransfersResourceReturnedDetails must be a JSON object",
                    )
            val code =
                json.decodeRequired<InlineTreasuryOutboundTransfersResourceReturnedDetailsCodeX5770bf46>(
                    rawObject,
                    "code",
                )
            val transaction =
                json.decodeRequired<InlineTreasuryOutboundTransfersResourceReturnedDetailsTransactionX427e24ee>(
                    rawObject,
                    "transaction",
                )
            return TreasuryOutboundTransfersResourceReturnedDetails(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: TreasuryOutboundTransfersResourceReturnedDetails,
        ) {
...
public fun treasuryOutboundTransfersResourceReturnedDetails(
    block: TreasuryOutboundTransfersResourceReturnedDetails.Builder.() -> Unit,
): TreasuryOutboundTransfersResourceReturnedDetails = TreasuryOutboundTransfersResourceReturnedDetails.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "TreasuryOutboundTransfersResourceReturnedDetails is missing required property '" + name + "'",
            )
