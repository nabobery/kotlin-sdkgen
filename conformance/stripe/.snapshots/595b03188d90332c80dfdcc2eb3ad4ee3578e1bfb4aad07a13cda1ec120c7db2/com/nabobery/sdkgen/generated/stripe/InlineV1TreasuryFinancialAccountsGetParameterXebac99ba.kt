...
public class InlineV1TreasuryFinancialAccountsGetParameterXebac99ba internal constructor(
    ...
    public val inlineV1TreasuryFinancialAccountsGetParameterAnyOf1X2c4f5a13:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1TreasuryFinancialAccountsGetParameterAnyOf1X2c4f5a13) {
                json
                    .decodeFromJsonElement<InlineV1TreasuryFinancialAccountsGetParameterAnyOf1X2c4f5a13>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1TreasuryFinancialAccountsGetParameterXebac99baBranch>
        get() =
            buildSet {
                if (inspection.matchesInlineV1TreasuryFinancialAccountsGetParameterAnyOf1X2c4f5a13) {
                    add(
                        InlineV1TreasuryFinancialAccountsGetParameterXebac99baBranch.InlineV1TreasuryFinancialAccountsGetParameterAnyOf1X2c4f5a13,
                    )
                }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1TreasuryFinancialAccountsGetParameterXebac99ba {
            val inspection = inspectInlineV1TreasuryFinancialAccountsGetParameterXebac99ba(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1TreasuryFinancialAccountsGetParameterXebac99baNoMatchException(
                    "InlineV1TreasuryFinancialAccountsGetParameterXebac99ba matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1TreasuryFinancialAccountsGetParameterXebac99ba> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TreasuryFinancialAccountsGetParameterXebac99ba,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1TreasuryFinancialAccountsGetParameterXebac99ba",
...
private fun inspectInlineV1TreasuryFinancialAccountsGetParameterXebac99ba(
    element: JsonElement,
): InlineV1TreasuryFinancialAccountsGetParameterXebac99baInspection {
    val matchesInlineV1TreasuryFinancialAccountsGetParameterAnyOf1X2c4f5a13 =
        element
            .isJsonDecodable<InlineV1TreasuryFinancialAccountsGetParameterAnyOf1X2c4f5a13>()
    ...
    return InlineV1TreasuryFinancialAccountsGetParameterXebac99baInspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1TreasuryFinancialAccountsGetParameterAnyOf1X2c4f5a13) {
                    add(
                        "InlineV1TreasuryFinancialAccountsGetParameterAnyOf1X2c4f5a13: value does not match InlineV1TreasuryFinancialAccountsGetParameterAnyOf1X2c4f5a13",
                    )
                }
