...
public sealed class InlineV1SubscriptionsPostRequestFormApplicationFeePercentAnyOf2Xb2ec1cf7 {
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionsPostRequestFormApplicationFeePercentAnyOf2Xb2ec1cf7> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1SubscriptionsPostRequestFormApplicationFeePercentAnyOf2Xb2ec1cf7",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1SubscriptionsPostRequestFormApplicationFeePercentAnyOf2Xb2ec1cf7 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionsPostRequestFormApplicationFeePercentAnyOf2Xb2ec1cf7,
        ) {
