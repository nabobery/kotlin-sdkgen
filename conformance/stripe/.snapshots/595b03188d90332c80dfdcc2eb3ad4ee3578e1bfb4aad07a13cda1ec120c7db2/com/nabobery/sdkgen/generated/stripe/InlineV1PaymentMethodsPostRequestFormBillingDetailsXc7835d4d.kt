...
public class InlineV1PaymentMethodsPostRequestFormBillingDetailsXc7835d4d(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1PaymentMethodsPostRequestFormBillingDetailsXc7835d4d =
            InlineV1PaymentMethodsPostRequestFormBillingDetailsXc7835d4d(
                address = address,
                email = email,
                name = name,
                phone = phone,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PaymentMethodsPostRequestFormBillingDetailsXc7835d4d =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentMethodsPostRequestFormBillingDetailsXc7835d4d> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentMethodsPostRequestFormBillingDetailsXc7835d4d must be a JSON object",
                    )
            return InlineV1PaymentMethodsPostRequestFormBillingDetailsXc7835d4d(
                address =
                    rawObject["address"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentMethodsPostRequestFormBillingDetailsAddressXd68da5ad>(
                            it,
                        )
                    },
                email =
                    rawObject["email"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentMethodsPostRequestFormBillingDetailsEmailXa4f46e6f>(
                            it,
                        )
                    },
                name =
                    rawObject["name"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentMethodsPostRequestFormBillingDetailsNameX6027b2c7>(it)
                    },
                phone =
                    rawObject["phone"]?.let {
                        json.decodeFromJsonElement<InlineV1PaymentMethodsPostRequestFormBillingDetailsPhoneX7fd2cf5f>(
                            it,
                        )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentMethodsPostRequestFormBillingDetailsXc7835d4d,
        ) {
...
public fun inlineV1PaymentMethodsPostRequestFormBillingDetailsXc7835d4d(
    block: InlineV1PaymentMethodsPostRequestFormBillingDetailsXc7835d4d.Builder.() -> Unit,
): InlineV1PaymentMethodsPostRequestFormBillingDetailsXc7835d4d =
    InlineV1PaymentMethodsPostRequestFormBillingDetailsXc7835d4d.build(block)
