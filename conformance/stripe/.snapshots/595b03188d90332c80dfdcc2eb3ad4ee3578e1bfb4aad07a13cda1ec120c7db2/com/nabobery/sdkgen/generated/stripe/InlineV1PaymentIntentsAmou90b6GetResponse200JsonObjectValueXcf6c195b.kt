...
public sealed class InlineV1PaymentIntentsAmou90b6GetResponse200JsonObjectValueXcf6c195b {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1PaymentIntentsAmou90b6GetResponse200JsonObjectValueXcf6c195b =
            when (value) {
                List.value -> List
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsAmou90b6GetResponse200JsonObjectValueXcf6c195b> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1PaymentIntentsAmou90b6GetResponse200JsonObjectValueXcf6c195b",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1PaymentIntentsAmou90b6GetResponse200JsonObjectValueXcf6c195b = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsAmou90b6GetResponse200JsonObjectValueXcf6c195b,
        ) {
