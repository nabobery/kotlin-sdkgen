...
public class InlineV1TokensPostRequestFormAccountIndividualXe27c278f(
    ...
    public val addressKana: InlineV1TokensPostRequestFormAccountIndividualAddressKanaX3c2317aa? = null,
    public val addressKanji: InlineV1TokensPostRequestFormAccountIndividualAddressKanjiX06d9eb46? = null,
    ...
    public val fullNameAliases: InlineV1TokensPostRequestFormAccountIndividualFullNameAliasesX310f21f8? = null,
    ...
    public val politicalExposure: InlineV1TokensPostRequestFormAccountIndividualPoliticalExposureX950cd3b6? = null,
    public val registeredAddress: InlineV1TokensPostRequestFormAccountIndividualRegisteredAddressXf5ac159b? = null,
    public val relationship: InlineV1TokensPostRequestFormAccountIndividualRelationshipXa70a21f8? = null,
    public val ssnLast4: String? = null,
    public val verification: InlineV1TokensPostRequestFormAccountIndividualVerificationX1e0a3dd9? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1TokensPostRequestFormAccountIndividualXe27c278f =
            InlineV1TokensPostRequestFormAccountIndividualXe27c278f(
                address = address,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TokensPostRequestFormAccountIndividualXe27c278f =
    ...
    public object Serializer : KSerializer<InlineV1TokensPostRequestFormAccountIndividualXe27c278f> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TokensPostRequestFormAccountIndividualXe27c278f must be a JSON object",
                    )
            return InlineV1TokensPostRequestFormAccountIndividualXe27c278f(
                address =
                    rawObject["address"]?.let {
                        json.decodeFromJsonElement<InlineV1TokensPostRequestFormAccountIndividualAddressX477ac07e>(it)
                    },
                addressKana =
                    rawObject["address_kana"]?.let {
                        json.decodeFromJsonElement<InlineV1TokensPostRequestFormAccountIndividualAddressKanaX3c2317aa>(
                            it,
                        )
                    },
                addressKanji =
                    rawObject["address_kanji"]?.let {
                        json.decodeFromJsonElement<InlineV1TokensPostRequestFormAccountIndividualAddressKanjiX06d9eb46>(
                            it,
                        )
                    },
                dob =
                    rawObject["dob"]?.let {
                        json.decodeFromJsonElement<InlineV1TokensPostRequestFormAccountIndividualDobX1dc512c4>(it)
                    },
                ...
                fullNameAliases =
                    rawObject["full_name_aliases"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TokensPostRequestFormAccountIndividualFullNameAliasesX310f21f8>(
                                it,
                            )
                    },
                ...
                metadata =
                    rawObject["metadata"]?.let {
                        json.decodeFromJsonElement<InlineV1TokensPostRequestFormAccountIndividualMetadataX5423e06b>(it)
                    },
                phone = rawObject["phone"]?.let { json.decodeFromJsonElement<String>(it) },
                politicalExposure =
                    rawObject["political_exposure"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TokensPostRequestFormAccountIndividualPoliticalExposureX950cd3b6>(
                                it,
                            )
                    },
                registeredAddress =
                    rawObject["registered_address"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TokensPostRequestFormAccountIndividualRegisteredAddressXf5ac159b>(
                                it,
                            )
                    },
                relationship =
                    rawObject["relationship"]?.let {
                        json.decodeFromJsonElement<InlineV1TokensPostRequestFormAccountIndividualRelationshipXa70a21f8>(
                            it,
                        )
                    },
                ...
                verification =
                    rawObject["verification"]?.let {
                        json.decodeFromJsonElement<InlineV1TokensPostRequestFormAccountIndividualVerificationX1e0a3dd9>(
                            it,
                        )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TokensPostRequestFormAccountIndividualXe27c278f,
        ) {
...
public fun inlineV1TokensPostRequestFormAccountIndividualXe27c278f(
    block: InlineV1TokensPostRequestFormAccountIndividualXe27c278f.Builder.() -> Unit,
): InlineV1TokensPostRequestFormAccountIndividualXe27c278f =
    InlineV1TokensPostRequestFormAccountIndividualXe27c278f.build(block)
