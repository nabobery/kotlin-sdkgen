...
public class ForwardedRequestHeader(
    ...
    public object Serializer : KSerializer<ForwardedRequestHeader> {
        ...
        override fun deserialize(decoder: Decoder): ForwardedRequestHeader {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("ForwardedRequestHeader must be a JSON object")
...
public fun forwardedRequestHeader(block: ForwardedRequestHeader.Builder.() -> Unit): ForwardedRequestHeader =
    ForwardedRequestHeader.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("ForwardedRequestHeader is missing required property '" + name + "'")
