...
public sealed class InlineIssuingNetworkTokenNetworkDataTypeXd429eeaa {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineIssuingNetworkTokenNetworkDataTypeXd429eeaa =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineIssuingNetworkTokenNetworkDataTypeXd429eeaa> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineIssuingNetworkTokenNetworkDataTypeXd429eeaa",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineIssuingNetworkTokenNetworkDataTypeXd429eeaa =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineIssuingNetworkTokenNetworkDataTypeXd429eeaa,
        ) {
