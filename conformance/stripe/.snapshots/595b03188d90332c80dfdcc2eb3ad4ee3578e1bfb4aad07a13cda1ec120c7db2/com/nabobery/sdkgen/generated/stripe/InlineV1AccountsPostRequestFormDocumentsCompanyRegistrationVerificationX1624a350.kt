...
public class InlineV1AccountsPostRequestFormDocumentsCompanyRegistrationVerificationX1624a350(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1AccountsPostRequestFormDocumentsCompanyRegistrationVerificationX1624a350 =
    ...
    public object Serializer : KSerializer<InlineV1AccountsPostRequestFormDocumentsCompanyRegistrationVerificationX1624a350> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountsPostRequestFormDocumentsCompanyRegistrationVerificationX1624a350 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPostRequestFormDocumentsCompanyRegistrationVerificationX1624a350,
        ) {
            val jsonEncoder =
...
public fun inlineV1AccountsPostRequestFormDocumentsCompanyRegistrationVerificationX1624a350(
    block: InlineV1AccountsPostRequestFormDocumentsCompanyRegistrationVerificationX1624a350.Builder.() -> Unit,
): InlineV1AccountsPostRequestFormDocumentsCompanyRegistrationVerificationX1624a350 =
    InlineV1AccountsPostRequestFormDocumentsCompanyRegistrationVerificationX1624a350.build(block)
