...
public sealed class InlineCustomerTaxExemptX8cad7368 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineCustomerTaxExemptX8cad7368 =
            when (value) {
                Exempt.value -> Exempt
                None.value -> None
    ...
    public object Serializer : KSerializer<InlineCustomerTaxExemptX8cad7368> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineCustomerTaxExemptX8cad7368",
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineCustomerTaxExemptX8cad7368,
        ) {
