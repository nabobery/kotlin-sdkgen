...
public sealed class InlineV1TreasuryTransactionEntriesGetResponse200JsonObjectValueXf793a2ee {
    ...
    public object Serializer : KSerializer<InlineV1TreasuryTransactionEntriesGetResponse200JsonObjectValueXf793a2ee> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1TreasuryTransactionEntriesGetResponse200JsonObjectValueXf793a2ee",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineV1TreasuryTransactionEntriesGetResponse200JsonObjectValueXf793a2ee = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TreasuryTransactionEntriesGetResponse200JsonObjectValueXf793a2ee,
        ) {
