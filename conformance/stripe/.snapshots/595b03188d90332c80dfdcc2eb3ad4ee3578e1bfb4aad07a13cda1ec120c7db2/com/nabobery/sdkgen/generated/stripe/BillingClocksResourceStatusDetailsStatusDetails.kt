...
public class BillingClocksResourceStatusDetailsStatusDetails(
    ...
    public class Builder {
        ...
        public fun build(): BillingClocksResourceStatusDetailsStatusDetails =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): BillingClocksResourceStatusDetailsStatusDetails =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<BillingClocksResourceStatusDetailsStatusDetails> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "BillingClocksResourceStatusDetailsStatusDetails must be a JSON object",
                    )
            return BillingClocksResourceStatusDetailsStatusDetails(
                advancing =
                    rawObject["advancing"]?.let {
                        json.decodeFromJsonElement<BillingClocksResourceStatusDetailsAdvancingStatusDetails>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: BillingClocksResourceStatusDetailsStatusDetails,
        ) {
...
public fun billingClocksResourceStatusDetailsStatusDetails(
    block: BillingClocksResourceStatusDetailsStatusDetails.Builder.() -> Unit,
): BillingClocksResourceStatusDetailsStatusDetails = BillingClocksResourceStatusDetailsStatusDetails.build(block)
