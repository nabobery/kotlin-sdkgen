...
public class InlineV1AccountsPostRequestFormSettingsCardPaymentsXac2b6762(
    public val declineOn: InlineV1AccountsPostRequestFormSettingsCardPaymentsDeclineOnX2a15c6d4? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1AccountsPostRequestFormSettingsCardPaymentsXac2b6762 =
            InlineV1AccountsPostRequestFormSettingsCardPaymentsXac2b6762(
                declineOn = declineOn,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1AccountsPostRequestFormSettingsCardPaymentsXac2b6762 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1AccountsPostRequestFormSettingsCardPaymentsXac2b6762> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountsPostRequestFormSettingsCardPaymentsXac2b6762 must be a JSON object",
                    )
            return InlineV1AccountsPostRequestFormSettingsCardPaymentsXac2b6762(
                declineOn =
                    rawObject["decline_on"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1AccountsPostRequestFormSettingsCardPaymentsDeclineOnX2a15c6d4>(
                                it,
                            )
                    },
                statementDescriptorPrefix =
                    rawObject["statement_descriptor_prefix"]?.let {
                        json.decodeFromJsonElement<String>(
                            it,
                        )
                    },
                statementDescriptorPrefixKana =
                    rawObject["statement_descriptor_prefix_kana"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1AccountsPostRequestFormSettingsStatementDescriptorP82b2Xfb1b6364>(
                                it,
                            )
                    },
                statementDescriptorPrefixKanji =
                    rawObject["statement_descriptor_prefix_kanji"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1AccountsPostRequestFormSettingsStatementDescriptorP143dXce21b6d2>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPostRequestFormSettingsCardPaymentsXac2b6762,
        ) {
            ...
            val raw =
                buildJsonObject {
                    ...
                    value.statementDescriptorPrefixKana?.let {
                        put(
                            "statement_descriptor_prefix_kana",
                            json.encodeToJsonElement(it),
                        )
                    }
                    value.statementDescriptorPrefixKanji?.let {
                        put(
...
public fun inlineV1AccountsPostRequestFormSettingsCardPaymentsXac2b6762(
    block: InlineV1AccountsPostRequestFormSettingsCardPaymentsXac2b6762.Builder.() -> Unit,
): InlineV1AccountsPostRequestFormSettingsCardPaymentsXac2b6762 =
    InlineV1AccountsPostRequestFormSettingsCardPaymentsXac2b6762.build(block)
