...
public class PaymentIntentNextActionDisplayMultibancoDetails(
    ...
    public class Builder {
        ...
        public fun build(): PaymentIntentNextActionDisplayMultibancoDetails =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentIntentNextActionDisplayMultibancoDetails =
    ...
    public object Serializer : KSerializer<PaymentIntentNextActionDisplayMultibancoDetails> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "PaymentIntentNextActionDisplayMultibancoDetails must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentIntentNextActionDisplayMultibancoDetails,
        ) {
...
public fun paymentIntentNextActionDisplayMultibancoDetails(
    block: PaymentIntentNextActionDisplayMultibancoDetails.Builder.() -> Unit,
): PaymentIntentNextActionDisplayMultibancoDetails = PaymentIntentNextActionDisplayMultibancoDetails.build(block)
