...
public class RefundDestinationDetails(
    ...
    public object Serializer : KSerializer<RefundDestinationDetails> {
        ...
        override fun deserialize(decoder: Decoder): RefundDestinationDetails {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("RefundDestinationDetails must be a JSON object")
            ...
            return RefundDestinationDetails(
                ...
                brBankTransfer =
                    rawObject["br_bank_transfer"]?.let {
                        json.decodeFromJsonElement<RefundDestinationDetailsBrBankTransfer>(it)
                    },
                ...
                customerCashBalance =
                    rawObject["customer_cash_balance"]?.let {
                ...
                euBankTransfer =
                    rawObject["eu_bank_transfer"]?.let {
                        json.decodeFromJsonElement<RefundDestinationDetailsEuBankTransfer>(it)
                    },
                gbBankTransfer =
                    rawObject["gb_bank_transfer"]?.let {
                        json.decodeFromJsonElement<RefundDestinationDetailsGbBankTransfer>(it)
                    },
                ...
                jpBankTransfer =
                    rawObject["jp_bank_transfer"]?.let {
                        json.decodeFromJsonElement<RefundDestinationDetailsJpBankTransfer>(it)
                    },
                ...
                multibanco =
                    rawObject["multibanco"]?.let {
                        json.decodeFromJsonElement<RefundDestinationDetailsMultibanco>(
                            it,
                        )
                    },
                mxBankTransfer =
                    rawObject["mx_bank_transfer"]?.let {
                        json.decodeFromJsonElement<RefundDestinationDetailsMxBankTransfer>(it)
                    },
                nzBankTransfer =
                    rawObject["nz_bank_transfer"]?.let {
                        json.decodeFromJsonElement<JsonObject>(
                            it,
                        )
                    },
                ...
                thBankTransfer =
                    rawObject["th_bank_transfer"]?.let {
                        json.decodeFromJsonElement<RefundDestinationDetailsThBankTransfer>(it)
                    },
                twint = rawObject["twint"]?.let { json.decodeFromJsonElement<JsonObject>(it) },
                usBankTransfer =
                    rawObject["us_bank_transfer"]?.let {
                        json.decodeFromJsonElement<RefundDestinationDetailsUsBankTransfer>(it)
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: RefundDestinationDetails,
        ) {
...
public fun refundDestinationDetails(block: RefundDestinationDetails.Builder.() -> Unit): RefundDestinationDetails =
    RefundDestinationDetails.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException("RefundDestinationDetails is missing required property '" + name + "'")
