...
public class PaymentLinksResourceCustomText(
     ...
     */
    public val termsOfServiceAcceptance: InlinePaymentLinksResourceCustomTextTermsOfServiceAcceptanceX43755f6d? = null,
) {
    public class Builder {
        ...
        public fun build(): PaymentLinksResourceCustomText =
    ...
    public object Serializer : KSerializer<PaymentLinksResourceCustomText> {
        ...
        override fun deserialize(decoder: Decoder): PaymentLinksResourceCustomText {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentLinksResourceCustomText must be a JSON object")
                ...
                afterSubmit =
                    rawObject["after_submit"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentLinksResourceCustomTextAfterSubmitXb277ae7c?>(
                                element,
                            )
                        }
                    },
                shippingAddress =
                    rawObject["shipping_address"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentLinksResourceCustomTextShippingAddressX7b901563?>(
                                element,
                            )
                        }
                    },
                submit =
                    rawObject["submit"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentLinksResourceCustomTextSubmitX46160aa5?>(element)
                        }
                    },
                termsOfServiceAcceptance =
                    rawObject["terms_of_service_acceptance"]?.let { element ->
                        if (element ==
                            ...
                            json
                                .decodeFromJsonElement<InlinePaymentLinksResourceCustomTextTermsOfServiceAcceptanceX43755f6d?>(
                                    element,
                                )
                        }
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentLinksResourceCustomText,
        ) {
...
public fun paymentLinksResourceCustomText(
    block: PaymentLinksResourceCustomText.Builder.() -> Unit,
): PaymentLinksResourceCustomText = PaymentLinksResourceCustomText.build(block)
