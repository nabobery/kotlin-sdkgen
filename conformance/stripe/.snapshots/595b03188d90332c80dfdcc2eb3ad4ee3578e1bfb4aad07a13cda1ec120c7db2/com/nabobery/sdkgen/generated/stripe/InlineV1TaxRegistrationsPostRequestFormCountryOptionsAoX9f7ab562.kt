...
public class InlineV1TaxRegistrationsPostRequestFormCountryOptionsAoX9f7ab562(
    ...
    public val standard: InlineV1TaxRegistrationsPostRequestFormCountryOptionsAoStandardX36e12273? = null,
) {
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TaxRegistrationsPostRequestFormCountryOptionsAoX9f7ab562 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TaxRegistrationsPostRequestFormCountryOptionsAoX9f7ab562> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1TaxRegistrationsPostRequestFormCountryOptionsAoX9f7ab562 {
            val jsonDecoder =
                decoder.requireJsonDecoder(
                    "InlineV1TaxRegistrationsPostRequestFormCountryOptionsAoX9f7ab562",
                )
            val json = jsonDecoder.json
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TaxRegistrationsPostRequestFormCountryOptionsAoX9f7ab562 must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineV1TaxRegistrationsPostRequestFormCountryOptionsAoTypeX0e983f1f>(
                    rawObject,
                    "type",
                )
            return InlineV1TaxRegistrationsPostRequestFormCountryOptionsAoX9f7ab562(
                ...
                standard =
                    rawObject["standard"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TaxRegistrationsPostRequestFormCountryOptionsAoStandardX36e12273>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TaxRegistrationsPostRequestFormCountryOptionsAoX9f7ab562,
        ) {
            val jsonEncoder =
...
public fun inlineV1TaxRegistrationsPostRequestFormCountryOptionsAoX9f7ab562(
    block: InlineV1TaxRegistrationsPostRequestFormCountryOptionsAoX9f7ab562.Builder.() -> Unit,
): InlineV1TaxRegistrationsPostRequestFormCountryOptionsAoX9f7ab562 =
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TaxRegistrationsPostRequestFormCountryOptionsAoX9f7ab562 is missing required property '" + name +
                    "'",
            )
