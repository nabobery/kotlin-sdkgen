...
public class InlineV1IssuingCardholdersPostRequestFormBillingXb94c2a99(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1IssuingCardholdersPostRequestFormBillingXb94c2a99 =
    ...
    public object Serializer : KSerializer<InlineV1IssuingCardholdersPostRequestFormBillingXb94c2a99> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1IssuingCardholdersPostRequestFormBillingXb94c2a99 must be a JSON object",
                    )
            val address =
                json.decodeRequired<InlineV1IssuingCardholdersPostRequestFormBillingAddressX055670a8>(
                    rawObject,
                    "address",
                )
            return InlineV1IssuingCardholdersPostRequestFormBillingXb94c2a99(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1IssuingCardholdersPostRequestFormBillingXb94c2a99,
        ) {
...
public fun inlineV1IssuingCardholdersPostRequestFormBillingXb94c2a99(
    block: InlineV1IssuingCardholdersPostRequestFormBillingXb94c2a99.Builder.() -> Unit,
): InlineV1IssuingCardholdersPostRequestFormBillingXb94c2a99 =
    InlineV1IssuingCardholdersPostRequestFormBillingXb94c2a99.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1IssuingCardholdersPostRequestFormBillingXb94c2a99 is missing required property '" + name + "'",
            )
