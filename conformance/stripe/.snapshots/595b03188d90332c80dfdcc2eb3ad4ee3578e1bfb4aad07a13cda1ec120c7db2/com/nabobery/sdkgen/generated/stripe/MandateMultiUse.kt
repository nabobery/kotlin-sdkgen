...
public class MandateMultiUse(
    ...
    public class Builder {
        ...
        public fun build(): MandateMultiUse =
            MandateMultiUse(
                amount = amount,
                currency = currency,
            )
    ...
    public object Serializer : KSerializer<MandateMultiUse> {
        ...
        override fun deserialize(decoder: Decoder): MandateMultiUse {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("MandateMultiUse must be a JSON object")
