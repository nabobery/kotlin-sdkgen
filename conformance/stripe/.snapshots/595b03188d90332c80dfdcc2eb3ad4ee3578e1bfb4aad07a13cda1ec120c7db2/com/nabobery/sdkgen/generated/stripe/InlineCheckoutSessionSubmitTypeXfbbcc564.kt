...
public sealed class InlineCheckoutSessionSubmitTypeXfbbcc564 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineCheckoutSessionSubmitTypeXfbbcc564 =
            when (value) {
                Auto.value -> Auto
                Book.value -> Book
                Donate.value -> Donate
    ...
    public object Serializer : KSerializer<InlineCheckoutSessionSubmitTypeXfbbcc564> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineCheckoutSessionSubmitTypeXfbbcc564",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineCheckoutSessionSubmitTypeXfbbcc564 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineCheckoutSessionSubmitTypeXfbbcc564,
        ) {
