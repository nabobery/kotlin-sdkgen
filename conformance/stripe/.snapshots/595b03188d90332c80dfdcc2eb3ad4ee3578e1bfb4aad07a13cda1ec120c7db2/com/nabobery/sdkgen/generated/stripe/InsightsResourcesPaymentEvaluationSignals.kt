...
public class InsightsResourcesPaymentEvaluationSignals(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InsightsResourcesPaymentEvaluationSignals =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InsightsResourcesPaymentEvaluationSignals> {
        ...
        override fun deserialize(decoder: Decoder): InsightsResourcesPaymentEvaluationSignals {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("InsightsResourcesPaymentEvaluationSignals must be a JSON object")
            val fraudulentPayment =
                json.decodeRequired<InsightsResourcesPaymentEvaluationSignalV2>(
                    rawObject,
                    "fraudulent_payment",
                )
            return InsightsResourcesPaymentEvaluationSignals(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InsightsResourcesPaymentEvaluationSignals,
        ) {
...
public fun insightsResourcesPaymentEvaluationSignals(
    block: InsightsResourcesPaymentEvaluationSignals.Builder.() -> Unit,
): InsightsResourcesPaymentEvaluationSignals = InsightsResourcesPaymentEvaluationSignals.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InsightsResourcesPaymentEvaluationSignals is missing required property '" + name + "'",
            )
