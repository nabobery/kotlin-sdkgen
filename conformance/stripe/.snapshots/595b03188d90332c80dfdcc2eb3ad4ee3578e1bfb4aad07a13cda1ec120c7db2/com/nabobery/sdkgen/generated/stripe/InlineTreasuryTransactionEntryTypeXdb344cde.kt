...
public sealed class InlineTreasuryTransactionEntryTypeXdb344cde {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineTreasuryTransactionEntryTypeXdb344cde =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineTreasuryTransactionEntryTypeXdb344cde> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineTreasuryTransactionEntryTypeXdb344cde",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineTreasuryTransactionEntryTypeXdb344cde =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineTreasuryTransactionEntryTypeXdb344cde,
        ) {
