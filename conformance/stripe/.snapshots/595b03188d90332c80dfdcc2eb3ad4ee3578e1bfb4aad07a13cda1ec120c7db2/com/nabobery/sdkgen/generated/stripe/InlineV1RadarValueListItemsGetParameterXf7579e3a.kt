...
public class InlineV1RadarValueListItemsGetParameterXf7579e3a internal constructor(
    ...
    public val inlineV1RadarValueListItemsGetParameterAnyOf1Xa279ec1f:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1RadarValueListItemsGetParameterAnyOf1Xa279ec1f) {
                json
                    .decodeFromJsonElement<InlineV1RadarValueListItemsGetParameterAnyOf1Xa279ec1f>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1RadarValueListItemsGetParameterXf7579e3aBranch>
        get() =
            buildSet {
                if (inspection.matchesInlineV1RadarValueListItemsGetParameterAnyOf1Xa279ec1f) {
                    add(
                        InlineV1RadarValueListItemsGetParameterXf7579e3aBranch.InlineV1RadarValueListItemsGetParameterAnyOf1Xa279ec1f,
                    )
                }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1RadarValueListItemsGetParameterXf7579e3a {
            val inspection = inspectInlineV1RadarValueListItemsGetParameterXf7579e3a(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1RadarValueListItemsGetParameterXf7579e3aNoMatchException(
                    "InlineV1RadarValueListItemsGetParameterXf7579e3a matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1RadarValueListItemsGetParameterXf7579e3a> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1RadarValueListItemsGetParameterXf7579e3a,
        ) {
...
private fun inspectInlineV1RadarValueListItemsGetParameterXf7579e3a(
    element: JsonElement,
): InlineV1RadarValueListItemsGetParameterXf7579e3aInspection {
    val matchesInlineV1RadarValueListItemsGetParameterAnyOf1Xa279ec1f =
        element
            .isJsonDecodable<InlineV1RadarValueListItemsGetParameterAnyOf1Xa279ec1f>()
    ...
    return InlineV1RadarValueListItemsGetParameterXf7579e3aInspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1RadarValueListItemsGetParameterAnyOf1Xa279ec1f) {
                    add(
                        "InlineV1RadarValueListItemsGetParameterAnyOf1Xa279ec1f: value does not match InlineV1RadarValueListItemsGetParameterAnyOf1Xa279ec1f",
                    )
                }
