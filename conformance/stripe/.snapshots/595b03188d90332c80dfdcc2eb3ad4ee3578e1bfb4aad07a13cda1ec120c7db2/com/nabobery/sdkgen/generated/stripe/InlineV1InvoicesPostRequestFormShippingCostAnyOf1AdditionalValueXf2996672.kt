...
public class InlineV1InvoicesPostRequestFormShippingCostAnyOf1AdditionalValueXf2996672(
    ...
    public val taxBehavior: InlineV1InvoicesPostRequestFormShippingCostAnyOf1TaxBehaviorX5fe493f5? = null,
) {
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1InvoicesPostRequestFormShippingCostAnyOf1AdditionalValueXf2996672 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1InvoicesPostRequestFormShippingCostAnyOf1AdditionalValueXf2996672> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1InvoicesPostRequestFormShippingCostAnyOf1AdditionalValueXf2996672 must be a JSON object",
                    )
            ...
            return InlineV1InvoicesPostRequestFormShippingCostAnyOf1AdditionalValueXf2996672(
                ...
                taxBehavior =
                    rawObject["tax_behavior"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1InvoicesPostRequestFormShippingCostAnyOf1TaxBehaviorX5fe493f5>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoicesPostRequestFormShippingCostAnyOf1AdditionalValueXf2996672,
        ) {
            val jsonEncoder =
...
public fun inlineV1InvoicesPostRequestFormShippingCostAnyOf1AdditionalValueXf2996672(
    block: InlineV1InvoicesPostRequestFormShippingCostAnyOf1AdditionalValueXf2996672.Builder.() -> Unit,
): InlineV1InvoicesPostRequestFormShippingCostAnyOf1AdditionalValueXf2996672 =
    InlineV1InvoicesPostRequestFormShippingCostAnyOf1AdditionalValueXf2996672.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1InvoicesPostRequestFormShippingCostAnyOf1AdditionalValueXf2996672 is missing required property '" +
                    name +
                    "'",
            )
