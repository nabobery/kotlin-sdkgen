...
public class InlineV1AccountSessionsPostRequestFormComponentsInstantPayoutsPromotionX1cf840ec(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1AccountSessionsPostRequestFormComponentsInstantPayoutsPromotionX1cf840ec =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1AccountSessionsPostRequestFormComponentsInstantPayoutsPromotionX1cf840ec> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountSessionsPostRequestFormComponentsInstantPayoutsPromotionX1cf840ec must be a JSON object",
                    )
            ...
            return InlineV1AccountSessionsPostRequestFormComponentsInstantPayoutsPromotionX1cf840ec(
                ...
                features =
                    rawObject["features"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountSessionsPostRequestFormComponentsFeaturesX93568909>(
                            it,
                        )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountSessionsPostRequestFormComponentsInstantPayoutsPromotionX1cf840ec,
        ) {
            val jsonEncoder =
...
public fun inlineV1AccountSessionsPostRequestFormComponentsInstantPayoutsPromotionX1cf840ec(
    block: InlineV1AccountSessionsPostRequestFormComponentsInstantPayoutsPromotionX1cf840ec.Builder.() -> Unit,
): InlineV1AccountSessionsPostRequestFormComponentsInstantPayoutsPromotionX1cf840ec =
    InlineV1AccountSessionsPostRequestFormComponentsInstantPayoutsPromotionX1cf840ec.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1AccountSessionsPostRequestFormComponentsInstantPayoutsPromotionX1cf840ec is missing required property '" +
                    name +
                    "'",
            )
