...
public class InlineV1PaymentRecordsReportRefundPostRequestFormRefundedX8664755a(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentRecordsReportRefundPostRequestFormRefundedX8664755a = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentRecordsReportRefundPostRequestFormRefundedX8664755a> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentRecordsReportRefundPostRequestFormRefundedX8664755a must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentRecordsReportRefundPostRequestFormRefundedX8664755a,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentRecordsReportRefundPostRequestFormRefundedX8664755a(
    block: InlineV1PaymentRecordsReportRefundPostRequestFormRefundedX8664755a.Builder.() -> Unit,
): InlineV1PaymentRecordsReportRefundPostRequestFormRefundedX8664755a =
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentRecordsReportRefundPostRequestFormRefundedX8664755a is missing required property '" +
                    name +
                    "'",
            )
