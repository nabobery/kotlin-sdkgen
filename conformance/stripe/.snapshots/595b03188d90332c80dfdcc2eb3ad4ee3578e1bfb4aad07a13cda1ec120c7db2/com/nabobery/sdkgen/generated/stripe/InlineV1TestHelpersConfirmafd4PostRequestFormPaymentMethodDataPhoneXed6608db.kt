...
internal data class InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataPhoneXed6608dbInspection(
    ...
    public val matchesInlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataAnyOf2X1af5323f: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataAnyOf2X1af5323f,
            ).count {
                it
            }
}
...
public class InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataPhoneXed6608db internal constructor(
    ...
    private val inspection: InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataPhoneXed6608dbInspection,
) {
    ...
    public val inlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataAnyOf2X1af5323f:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataAnyOf2X1af5323f) {
                json
                    .decodeFromJsonElement<InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataAnyOf2X1af5323f>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataPhoneXed6608dbBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataAnyOf2X1af5323f) {
                    add(
                        InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataPhoneXed6608dbBranch.InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataAnyOf2X1af5323f,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataPhoneXed6608db {
            val inspection = inspectInlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataPhoneXed6608db(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataPhoneXed6608dbNoMatchException(
                    "InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataPhoneXed6608db matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataPhoneXed6608db> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataPhoneXed6608db,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataPhoneXed6608db",
...
private fun inspectInlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataPhoneXed6608db(
    element: JsonElement,
): InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataPhoneXed6608dbInspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataAnyOf2X1af5323f =
        element
            .isJsonDecodable<InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataAnyOf2X1af5323f>()
    return InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataPhoneXed6608dbInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataAnyOf2X1af5323f) {
                    add(
                        "InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataAnyOf2X1af5323f: value does not match InlineV1TestHelpersConfirmafd4PostRequestFormPaymentMethodDataAnyOf2X1af5323f",
                    )
                }
            },
    )
