...
public class InlineInvoiceApplicationXa23803cc internal constructor(
        ...
        get() =
            buildSet {
                ...
                if (inspection.matchesDeletedApplication) {
                    add(
                        InlineInvoiceApplicationXa23803ccBranch.DeletedApplication,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineInvoiceApplicationXa23803cc {
            val inspection = inspectInlineInvoiceApplicationXa23803cc(raw)
            if (inspection.matchCount == 0) {
                throw InlineInvoiceApplicationXa23803ccNoMatchException(
                    "InlineInvoiceApplicationXa23803cc matched 0 branches: " + inspection.failures.joinToString("; "),
                )
            }
    ...
    public object Serializer : KSerializer<InlineInvoiceApplicationXa23803cc> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineInvoiceApplicationXa23803cc,
        ) {
...
private fun inspectInlineInvoiceApplicationXa23803cc(
    element: JsonElement,
): InlineInvoiceApplicationXa23803ccInspection {
