...
public class InlineV1ChargesPostRequestFormXa27d03d9(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1ChargesPostRequestFormXa27d03d9 =
            InlineV1ChargesPostRequestFormXa27d03d9(
                customer = customer,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1ChargesPostRequestFormXa27d03d9 =
    ...
    public object Serializer : KSerializer<InlineV1ChargesPostRequestFormXa27d03d9> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1ChargesPostRequestFormXa27d03d9 {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("InlineV1ChargesPostRequestFormXa27d03d9 must be a JSON object")
            return InlineV1ChargesPostRequestFormXa27d03d9(
                ...
                fraudDetails =
                    rawObject["fraud_details"]?.let {
                        json.decodeFromJsonElement<InlineV1ChargesPostRequestFormFraudDetailsXdf29dbc4>(it)
                    },
                metadata =
                    rawObject["metadata"]?.let {
                        json.decodeFromJsonElement<InlineV1ChargesPostRequestFormMetadataXae7bfa5e>(it)
                    },
                receiptEmail = rawObject["receipt_email"]?.let { json.decodeFromJsonElement<String>(it) },
                shipping =
                    rawObject["shipping"]?.let {
                        json.decodeFromJsonElement<InlineV1ChargesPostRequestFormShippingX03643664>(it)
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1ChargesPostRequestFormXa27d03d9,
        ) {
...
public fun inlineV1ChargesPostRequestFormXa27d03d9(
    block: InlineV1ChargesPostRequestFormXa27d03d9.Builder.() -> Unit,
): InlineV1ChargesPostRequestFormXa27d03d9 = InlineV1ChargesPostRequestFormXa27d03d9.build(block)
