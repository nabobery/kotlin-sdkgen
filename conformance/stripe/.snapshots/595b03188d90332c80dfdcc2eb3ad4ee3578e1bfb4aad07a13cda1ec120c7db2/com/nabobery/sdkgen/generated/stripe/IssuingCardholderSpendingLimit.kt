...
public class IssuingCardholderSpendingLimit(
     ...
     */
    public val categories: List<InlineIssuingCardholderSpendingLimitCategoriesItemX4fcf603b>? = null,
) {
    public class Builder {
         ...
         * to. Omitting this field will apply the limit to all categories.
         */
        public var categories: List<InlineIssuingCardholderSpendingLimitCategoriesItemX4fcf603b>? = null
    ...
    public object Serializer : KSerializer<IssuingCardholderSpendingLimit> {
        ...
        override fun deserialize(decoder: Decoder): IssuingCardholderSpendingLimit {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("IssuingCardholderSpendingLimit must be a JSON object")
            val amount = json.decodeRequired<Int>(rawObject, "amount")
            val interval =
                json.decodeRequired<InlineIssuingCardholderSpendingLimitIntervalX1263902e>(
                    rawObject,
                    "interval",
                )
            return IssuingCardholderSpendingLimit(
                ...
                categories =
                    rawObject["categories"]?.let { element ->
                        if (element ==
                            ...
                            json
                                .decodeFromJsonElement<List<InlineIssuingCardholderSpendingLimitCategoriesItemX4fcf603b>?>(
                                    element,
                                )
                        }
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: IssuingCardholderSpendingLimit,
        ) {
...
public fun issuingCardholderSpendingLimit(
    block: IssuingCardholderSpendingLimit.Builder.() -> Unit,
): IssuingCardholderSpendingLimit = IssuingCardholderSpendingLimit.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "IssuingCardholderSpendingLimit is missing required property '" + name + "'",
            )
