...
public sealed class InlineMandateAcssDebitDefaultForItemX1a0cdd90 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineMandateAcssDebitDefaultForItemX1a0cdd90 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineMandateAcssDebitDefaultForItemX1a0cdd90> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineMandateAcssDebitDefaultForItemX1a0cdd90",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineMandateAcssDebitDefaultForItemX1a0cdd90 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineMandateAcssDebitDefaultForItemX1a0cdd90,
        ) {
