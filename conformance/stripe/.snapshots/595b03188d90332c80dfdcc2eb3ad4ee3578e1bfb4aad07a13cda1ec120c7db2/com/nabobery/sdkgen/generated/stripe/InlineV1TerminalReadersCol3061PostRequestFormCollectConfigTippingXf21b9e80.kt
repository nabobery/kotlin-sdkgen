...
public class InlineV1TerminalReadersCol3061PostRequestFormCollectConfigTippingXf21b9e80(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1TerminalReadersCol3061PostRequestFormCollectConfigTippingXf21b9e80 =
            InlineV1TerminalReadersCol3061PostRequestFormCollectConfigTippingXf21b9e80(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1TerminalReadersCol3061PostRequestFormCollectConfigTippingXf21b9e80 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TerminalReadersCol3061PostRequestFormCollectConfigTippingXf21b9e80> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TerminalReadersCol3061PostRequestFormCollectConfigTippingXf21b9e80 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TerminalReadersCol3061PostRequestFormCollectConfigTippingXf21b9e80,
        ) {
            val jsonEncoder =
...
public fun inlineV1TerminalReadersCol3061PostRequestFormCollectConfigTippingXf21b9e80(
    block: InlineV1TerminalReadersCol3061PostRequestFormCollectConfigTippingXf21b9e80.Builder.() -> Unit,
): InlineV1TerminalReadersCol3061PostRequestFormCollectConfigTippingXf21b9e80 =
