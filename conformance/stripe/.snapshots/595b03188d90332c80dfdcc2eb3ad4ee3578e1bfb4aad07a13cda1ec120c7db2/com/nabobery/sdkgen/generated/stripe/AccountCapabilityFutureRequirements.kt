...
public class AccountCapabilityFutureRequirements(
     ...
     * account.
     */
    public val disabledReason: InlineAccountCapabilityFutureRequirementsDisabledReasonXa9b2ab06? = null,
) {
    /**
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): AccountCapabilityFutureRequirements =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<AccountCapabilityFutureRequirements> {
        ...
        override fun deserialize(decoder: Decoder): AccountCapabilityFutureRequirements {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("AccountCapabilityFutureRequirements must be a JSON object")
                ...
                disabledReason =
                    rawObject["disabled_reason"]?.let { element ->
                        if (element ==
                            ...
                            json
                                .decodeFromJsonElement<InlineAccountCapabilityFutureRequirementsDisabledReasonXa9b2ab06?>(
                                    element,
                                )
                        }
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: AccountCapabilityFutureRequirements,
        ) {
...
public fun accountCapabilityFutureRequirements(
    block: AccountCapabilityFutureRequirements.Builder.() -> Unit,
): AccountCapabilityFutureRequirements = AccountCapabilityFutureRequirements.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "AccountCapabilityFutureRequirements is missing required property '" + name + "'",
            )
