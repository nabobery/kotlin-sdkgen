...
public sealed class InlineCheckoutSessionStatusX6a7fc5ac {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineCheckoutSessionStatusX6a7fc5ac =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineCheckoutSessionStatusX6a7fc5ac> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineCheckoutSessionStatusX6a7fc5ac",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineCheckoutSessionStatusX6a7fc5ac =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineCheckoutSessionStatusX6a7fc5ac,
        ) {
