...
public sealed class InlineCustomerSessionResou1a5dPaymentMethodAllowRea1fdItemX950ca000 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineCustomerSessionResou1a5dPaymentMethodAllowRea1fdItemX950ca000 =
            when (value) {
                Always.value -> Always
    ...
    public object Serializer : KSerializer<InlineCustomerSessionResou1a5dPaymentMethodAllowRea1fdItemX950ca000> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineCustomerSessionResou1a5dPaymentMethodAllowRea1fdItemX950ca000",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineCustomerSessionResou1a5dPaymentMethodAllowRea1fdItemX950ca000 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineCustomerSessionResou1a5dPaymentMethodAllowRea1fdItemX950ca000,
        ) {
