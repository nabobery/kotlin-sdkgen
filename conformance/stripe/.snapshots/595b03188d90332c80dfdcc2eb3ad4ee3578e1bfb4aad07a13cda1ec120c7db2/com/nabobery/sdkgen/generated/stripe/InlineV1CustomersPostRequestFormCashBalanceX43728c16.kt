...
public class InlineV1CustomersPostRequestFormCashBalanceX43728c16(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1CustomersPostRequestFormCashBalanceX43728c16 =
            InlineV1CustomersPostRequestFormCashBalanceX43728c16(
                settings = settings,
            )
    }

    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1CustomersPostRequestFormCashBalanceX43728c16 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1CustomersPostRequestFormCashBalanceX43728c16> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CustomersPostRequestFormCashBalanceX43728c16 must be a JSON object",
                    )
            return InlineV1CustomersPostRequestFormCashBalanceX43728c16(
                settings =
                    rawObject["settings"]?.let {
                        json.decodeFromJsonElement<InlineV1CustomersPostRequestFormCashBalanceSettingsX07d5bcd7>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersPostRequestFormCashBalanceX43728c16,
        ) {
...
public fun inlineV1CustomersPostRequestFormCashBalanceX43728c16(
    block: InlineV1CustomersPostRequestFormCashBalanceX43728c16.Builder.() -> Unit,
): InlineV1CustomersPostRequestFormCashBalanceX43728c16 =
    InlineV1CustomersPostRequestFormCashBalanceX43728c16.build(block)
