...
public class InsightsResourcesPaymentEvaluationSignalV2(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InsightsResourcesPaymentEvaluationSignalV2 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InsightsResourcesPaymentEvaluationSignalV2> {
        ...
        override fun deserialize(decoder: Decoder): InsightsResourcesPaymentEvaluationSignalV2 {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("InsightsResourcesPaymentEvaluationSignalV2 must be a JSON object")
            val evaluatedAt = json.decodeRequired<Int>(rawObject, "evaluated_at")
            val riskLevel =
                json.decodeRequired<InlineInsightsResourcesPaymentEvaluationSignalV2RiskLevelX40fd06bb>(
                    rawObject,
                    "risk_level",
                )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InsightsResourcesPaymentEvaluationSignalV2,
        ) {
...
public fun insightsResourcesPaymentEvaluationSignalV2(
    block: InsightsResourcesPaymentEvaluationSignalV2.Builder.() -> Unit,
): InsightsResourcesPaymentEvaluationSignalV2 = InsightsResourcesPaymentEvaluationSignalV2.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InsightsResourcesPaymentEvaluationSignalV2 is missing required property '" + name + "'",
            )
