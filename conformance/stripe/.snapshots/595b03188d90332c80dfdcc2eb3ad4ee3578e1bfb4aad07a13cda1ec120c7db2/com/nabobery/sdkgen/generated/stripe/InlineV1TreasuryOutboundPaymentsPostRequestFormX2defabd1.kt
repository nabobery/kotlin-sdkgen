...
public class InlineV1TreasuryOutboundPaymentsPostRequestFormX2defabd1(
     ...
     * End user details.
     */
    public val endUserDetails: InlineV1TreasuryOutboundPaymentsPostRequestFormEndUserDetailsX9f3a6bde? = null,
    /**
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TreasuryOutboundPaymentsPostRequestFormX2defabd1 =
    ...
    public object Serializer : KSerializer<InlineV1TreasuryOutboundPaymentsPostRequestFormX2defabd1> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1TreasuryOutboundPaymentsPostRequestFormX2defabd1 {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TreasuryOutboundPaymentsPostRequestFormX2defabd1 must be a JSON object",
                    )
            ...
            return InlineV1TreasuryOutboundPaymentsPostRequestFormX2defabd1(
                ...
                destinationPaymentMethod =
                    rawObject["destination_payment_method"]?.let {
                        json.decodeFromJsonElement<String>(
                            it,
                        )
                    },
                destinationPaymentMethodData =
                    rawObject["destination_payment_method_data"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TreasuryOutboundPab148PostRequestFormDestinationPaymentMec421X96743474>(
                                it,
                            )
                    },
                destinationPaymentMethodOptions =
                    rawObject["destination_payment_method_options"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TreasuryOutboundPab148PostRequestFormDestinationPaymentMeeca5X23ec15a9>(
                                it,
                            )
                    },
                endUserDetails =
                    rawObject["end_user_details"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TreasuryOutboundPaymentsPostRequestFormEndUserDetailsX9f3a6bde>(
                                it,
                            )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TreasuryOutboundPaymentsPostRequestFormX2defabd1,
        ) {
            ...
            val raw =
                buildJsonObject {
                    ...
                    value.destinationPaymentMethodData?.let {
                        put(
                            "destination_payment_method_data",
                            json.encodeToJsonElement(it),
                        )
                    }
                    value.destinationPaymentMethodOptions?.let {
                        put(
...
public fun inlineV1TreasuryOutboundPaymentsPostRequestFormX2defabd1(
    block: InlineV1TreasuryOutboundPaymentsPostRequestFormX2defabd1.Builder.() -> Unit,
): InlineV1TreasuryOutboundPaymentsPostRequestFormX2defabd1 =
    InlineV1TreasuryOutboundPaymentsPostRequestFormX2defabd1.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TreasuryOutboundPaymentsPostRequestFormX2defabd1 is missing required property '" + name + "'",
            )
