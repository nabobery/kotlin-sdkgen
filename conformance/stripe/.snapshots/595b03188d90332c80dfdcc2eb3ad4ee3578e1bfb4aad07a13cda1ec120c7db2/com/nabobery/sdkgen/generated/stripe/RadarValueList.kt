...
public class RadarValueList(
    ...
    public object Serializer : KSerializer<RadarValueList> {
        ...
        override fun deserialize(decoder: Decoder): RadarValueList {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("RadarValueList must be a JSON object")
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("RadarValueList is missing required property '" + name + "'")
