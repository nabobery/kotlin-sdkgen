...
public class InlineSubscriptionSchedulePhaseConfigurationDefaultPaymentMethodX23a6342e internal constructor(
    ...
    private val inspection: InlineSubscriptionSchedulePhaseConfigurationDefaultPaymentMethodX23a6342eInspection,
) {
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineSubscriptionSchedulePhaseConfigurationDefaultPaymentMethodX23a6342eBranch.Branch1,
                    )
                }
                if (inspection.matchesPaymentMethod) {
                    add(
                        InlineSubscriptionSchedulePhaseConfigurationDefaultPaymentMethodX23a6342eBranch.PaymentMethod,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineSubscriptionSchedulePhaseConfigurationDefaultPaymentMethodX23a6342e {
            val inspection = inspectInlineSubscriptionSchedulePhaseConfigurationDefaultPaymentMethodX23a6342e(raw)
            if (inspection.matchCount == 0) {
                throw InlineSubscriptionSchedulePhaseConfigurationDefaultPaymentMethodX23a6342eNoMatchException(
                    "InlineSubscriptionSchedulePhaseConfigurationDefaultPaymentMethodX23a6342e matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineSubscriptionSchedulePhaseConfigurationDefaultPaymentMethodX23a6342e> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineSubscriptionSchedulePhaseConfigurationDefaultPaymentMethodX23a6342e,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineSubscriptionSchedulePhaseConfigurationDefaultPaymentMethodX23a6342e",
...
private fun inspectInlineSubscriptionSchedulePhaseConfigurationDefaultPaymentMethodX23a6342e(
    element: JsonElement,
