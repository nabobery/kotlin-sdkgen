...
public class InlineV1PaymentLinksPostRequestFormSubscriptionDataIssuerX286c2821(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentLinksPostRequestFormSubscriptionDataIssuerX286c2821 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentLinksPostRequestFormSubscriptionDataIssuerX286c2821> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1PaymentLinksPostRequestFormSubscriptionDataIssuerX286c2821 {
            val jsonDecoder =
                decoder.requireJsonDecoder(
                    "InlineV1PaymentLinksPostRequestFormSubscriptionDataIssuerX286c2821",
                )
            val json = jsonDecoder.json
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentLinksPostRequestFormSubscriptionDataIssuerX286c2821 must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineV1PaymentLinksPostRequestFormSubscriptionDataInvoiceSettingsTypeX8064daf5>(
                    rawObject,
                    "type",
                )
            return InlineV1PaymentLinksPostRequestFormSubscriptionDataIssuerX286c2821(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentLinksPostRequestFormSubscriptionDataIssuerX286c2821,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentLinksPostRequestFormSubscriptionDataIssuerX286c2821(
    block: InlineV1PaymentLinksPostRequestFormSubscriptionDataIssuerX286c2821.Builder.() -> Unit,
): InlineV1PaymentLinksPostRequestFormSubscriptionDataIssuerX286c2821 =
    InlineV1PaymentLinksPostRequestFormSubscriptionDataIssuerX286c2821.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentLinksPostRequestFormSubscriptionDataIssuerX286c2821 is missing required property '" +
                    name +
                    "'",
            )
