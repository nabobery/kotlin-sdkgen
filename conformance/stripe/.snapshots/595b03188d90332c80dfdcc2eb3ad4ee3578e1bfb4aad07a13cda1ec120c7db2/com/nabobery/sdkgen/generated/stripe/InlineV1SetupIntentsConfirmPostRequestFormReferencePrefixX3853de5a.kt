...
internal data class InlineV1SetupIntentsConfirmPostRequestFormReferencePrefixX3853de5aInspection(
    ...
    public val matchesInlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2X040f2285: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2X040f2285,
            ).count {
                it
            }
}
...
public class InlineV1SetupIntentsConfirmPostRequestFormReferencePrefixX3853de5a internal constructor(
    ...
    private val inspection: InlineV1SetupIntentsConfirmPostRequestFormReferencePrefixX3853de5aInspection,
) {
    ...
    public val inlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2X040f2285:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2X040f2285) {
                json
                    .decodeFromJsonElement<InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2X040f2285>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1SetupIntentsConfirmPostRequestFormReferencePrefixX3853de5aBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2X040f2285) {
                    add(
                        InlineV1SetupIntentsConfirmPostRequestFormReferencePrefixX3853de5aBranch.InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2X040f2285,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1SetupIntentsConfirmPostRequestFormReferencePrefixX3853de5a {
            val inspection = inspectInlineV1SetupIntentsConfirmPostRequestFormReferencePrefixX3853de5a(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1SetupIntentsConfirmPostRequestFormReferencePrefixX3853de5aNoMatchException(
                    "InlineV1SetupIntentsConfirmPostRequestFormReferencePrefixX3853de5a matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1SetupIntentsConfirmPostRequestFormReferencePrefixX3853de5a> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SetupIntentsConfirmPostRequestFormReferencePrefixX3853de5a,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1SetupIntentsConfirmPostRequestFormReferencePrefixX3853de5a",
...
private fun inspectInlineV1SetupIntentsConfirmPostRequestFormReferencePrefixX3853de5a(
    element: JsonElement,
): InlineV1SetupIntentsConfirmPostRequestFormReferencePrefixX3853de5aInspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2X040f2285 =
        element
            .isJsonDecodable<InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2X040f2285>()
    return InlineV1SetupIntentsConfirmPostRequestFormReferencePrefixX3853de5aInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2X040f2285) {
                    add(
                        "InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2X040f2285: value does not match InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsAnyOf2X040f2285",
                    )
                }
            },
    )
