...
public class InlineV1PaymentLinksPostRequestFormSubscriptionDataIssuerX25f8b706(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentLinksPostRequestFormSubscriptionDataIssuerX25f8b706 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentLinksPostRequestFormSubscriptionDataIssuerX25f8b706> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1PaymentLinksPostRequestFormSubscriptionDataIssuerX25f8b706 {
            val jsonDecoder =
                decoder.requireJsonDecoder(
                    "InlineV1PaymentLinksPostRequestFormSubscriptionDataIssuerX25f8b706",
                )
            val json = jsonDecoder.json
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentLinksPostRequestFormSubscriptionDataIssuerX25f8b706 must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineV1PaymentLinksPostRequestFormSubscriptionDataInvoiceSettingsTypeXfbd1739d>(
                    rawObject,
                    "type",
                )
            return InlineV1PaymentLinksPostRequestFormSubscriptionDataIssuerX25f8b706(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentLinksPostRequestFormSubscriptionDataIssuerX25f8b706,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentLinksPostRequestFormSubscriptionDataIssuerX25f8b706(
    block: InlineV1PaymentLinksPostRequestFormSubscriptionDataIssuerX25f8b706.Builder.() -> Unit,
): InlineV1PaymentLinksPostRequestFormSubscriptionDataIssuerX25f8b706 =
    InlineV1PaymentLinksPostRequestFormSubscriptionDataIssuerX25f8b706.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentLinksPostRequestFormSubscriptionDataIssuerX25f8b706 is missing required property '" +
                    name +
                    "'",
            )
