...
internal data class InlineV1TokensPostRequestFormPersonRelationshipPercentOwnershipXc0a62184Inspection(
    ...
    public val matchesInlineV1TokensPostRequestFormPersonRelationshipPercentOwnershipAnyOf2X98a5a11d: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1TokensPostRequestFormPersonRelationshipPercentOwnershipAnyOf2X98a5a11d,
            ).count {
                it
            }
}
...
public class InlineV1TokensPostRequestFormPersonRelationshipPercentOwnershipXc0a62184 internal constructor(
    ...
    private val inspection: InlineV1TokensPostRequestFormPersonRelationshipPercentOwnershipXc0a62184Inspection,
) {
    ...
    public val inlineV1TokensPostRequestFormPersonRelationshipPercentOwnershipAnyOf2X98a5a11d:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1TokensPostRequestFormPersonRelationshipPercentOwnershipAnyOf2X98a5a11d) {
                json
                    .decodeFromJsonElement<InlineV1TokensPostRequestFormPersonRelationshipPercentOwnershipAnyOf2X98a5a11d>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1TokensPostRequestFormPersonRelationshipPercentOwnershipXc0a62184Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1TokensPostRequestFormPersonRelationshipPercentOwnershipAnyOf2X98a5a11d) {
                    add(
                        InlineV1TokensPostRequestFormPersonRelationshipPercentOwnershipXc0a62184Branch.InlineV1TokensPostRequestFormPersonRelationshipPercentOwnershipAnyOf2X98a5a11d,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1TokensPostRequestFormPersonRelationshipPercentOwnershipXc0a62184 {
            val inspection = inspectInlineV1TokensPostRequestFormPersonRelationshipPercentOwnershipXc0a62184(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1TokensPostRequestFormPersonRelationshipPercentOwnershipXc0a62184NoMatchException(
                    "InlineV1TokensPostRequestFormPersonRelationshipPercentOwnershipXc0a62184 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1TokensPostRequestFormPersonRelationshipPercentOwnershipXc0a62184> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TokensPostRequestFormPersonRelationshipPercentOwnershipXc0a62184,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1TokensPostRequestFormPersonRelationshipPercentOwnershipXc0a62184",
...
private fun inspectInlineV1TokensPostRequestFormPersonRelationshipPercentOwnershipXc0a62184(
    element: JsonElement,
    ...
    val matchesInlineV1TokensPostRequestFormPersonRelationshipPercentOwnershipAnyOf2X98a5a11d =
        element
            .isJsonDecodable<InlineV1TokensPostRequestFormPersonRelationshipPercentOwnershipAnyOf2X98a5a11d>()
    return InlineV1TokensPostRequestFormPersonRelationshipPercentOwnershipXc0a62184Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1TokensPostRequestFormPersonRelationshipPercentOwnershipAnyOf2X98a5a11d) {
                    add(
                        "InlineV1TokensPostRequestFormPersonRelationshipPercentOwnershipAnyOf2X98a5a11d: value does not match InlineV1TokensPostRequestFormPersonRelationshipPercentOwnershipAnyOf2X98a5a11d",
                    )
                }
            },
    )
