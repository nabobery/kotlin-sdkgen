...
public sealed class InlineTaxRegistrationStatusX0281a401 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineTaxRegistrationStatusX0281a401 =
            when (value) {
                Active.value -> Active
    ...
    public object Serializer : KSerializer<InlineTaxRegistrationStatusX0281a401> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineTaxRegistrationStatusX0281a401",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineTaxRegistrationStatusX0281a401 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineTaxRegistrationStatusX0281a401,
        ) {
