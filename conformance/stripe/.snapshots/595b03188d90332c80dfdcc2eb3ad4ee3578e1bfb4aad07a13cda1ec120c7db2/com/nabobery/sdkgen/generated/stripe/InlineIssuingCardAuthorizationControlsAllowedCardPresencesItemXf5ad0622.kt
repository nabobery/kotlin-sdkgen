...
public sealed class InlineIssuingCardAuthorizationControlsAllowedCardPresencesItemXf5ad0622 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineIssuingCardAuthorizationControlsAllowedCardPresencesItemXf5ad0622 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineIssuingCardAuthorizationControlsAllowedCardPresencesItemXf5ad0622> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineIssuingCardAuthorizationControlsAllowedCardPresencesItemXf5ad0622",
                PrimitiveKind.STRING,
            )

        override fun deserialize(
            decoder: Decoder,
        ): InlineIssuingCardAuthorizationControlsAllowedCardPresencesItemXf5ad0622 = fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineIssuingCardAuthorizationControlsAllowedCardPresencesItemXf5ad0622,
        ) {
