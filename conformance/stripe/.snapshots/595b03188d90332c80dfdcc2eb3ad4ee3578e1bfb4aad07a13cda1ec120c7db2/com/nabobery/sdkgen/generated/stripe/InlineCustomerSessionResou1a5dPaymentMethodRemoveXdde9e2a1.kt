...
public sealed class InlineCustomerSessionResou1a5dPaymentMethodRemoveXdde9e2a1 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineCustomerSessionResou1a5dPaymentMethodRemoveXdde9e2a1 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineCustomerSessionResou1a5dPaymentMethodRemoveXdde9e2a1> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineCustomerSessionResou1a5dPaymentMethodRemoveXdde9e2a1",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineCustomerSessionResou1a5dPaymentMethodRemoveXdde9e2a1 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineCustomerSessionResou1a5dPaymentMethodRemoveXdde9e2a1,
        ) {
