...
public class InlineV1PaymentMethodsPostRequestFormNzBankAccountX261d52f6(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1PaymentMethodsPostRequestFormNzBankAccountX261d52f6 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentMethodsPostRequestFormNzBankAccountX261d52f6> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentMethodsPostRequestFormNzBankAccountX261d52f6 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentMethodsPostRequestFormNzBankAccountX261d52f6,
        ) {
...
public fun inlineV1PaymentMethodsPostRequestFormNzBankAccountX261d52f6(
    block: InlineV1PaymentMethodsPostRequestFormNzBankAccountX261d52f6.Builder.() -> Unit,
): InlineV1PaymentMethodsPostRequestFormNzBankAccountX261d52f6 =
    InlineV1PaymentMethodsPostRequestFormNzBankAccountX261d52f6.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentMethodsPostRequestFormNzBankAccountX261d52f6 is missing required property '" + name +
                    "'",
            )
