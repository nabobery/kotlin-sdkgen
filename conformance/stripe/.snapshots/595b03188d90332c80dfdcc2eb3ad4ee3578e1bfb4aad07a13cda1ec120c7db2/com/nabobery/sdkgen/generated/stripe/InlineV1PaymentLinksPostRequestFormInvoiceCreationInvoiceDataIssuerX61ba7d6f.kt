...
public class InlineV1PaymentLinksPostRequestFormInvoiceCreationInvoiceDataIssuerX61ba7d6f(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentLinksPostRequestFormInvoiceCreationInvoiceDataIssuerX61ba7d6f = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentLinksPostRequestFormInvoiceCreationInvoiceDataIssuerX61ba7d6f> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentLinksPostRequestFormInvoiceCreationInvoiceDataIssuerX61ba7d6f must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineV1PaymentLinksPostRequestFormInvoiceCreationInvoiceDataIssuerTypeXd16f2a94>(
                    rawObject,
                    "type",
                )
            return InlineV1PaymentLinksPostRequestFormInvoiceCreationInvoiceDataIssuerX61ba7d6f(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentLinksPostRequestFormInvoiceCreationInvoiceDataIssuerX61ba7d6f,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentLinksPostRequestFormInvoiceCreationInvoiceDataIssuerX61ba7d6f(
    block: InlineV1PaymentLinksPostRequestFormInvoiceCreationInvoiceDataIssuerX61ba7d6f.Builder.() -> Unit,
): InlineV1PaymentLinksPostRequestFormInvoiceCreationInvoiceDataIssuerX61ba7d6f =
    InlineV1PaymentLinksPostRequestFormInvoiceCreationInvoiceDataIssuerX61ba7d6f.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1PaymentLinksPostRequestFormInvoiceCreationInvoiceDataIssuerX61ba7d6f is missing required property '" +
                    name +
                    "'",
            )
