...
public sealed class InlineV1InvoiceitemsPostRequestFormMetadataAnyOf2X28e7aec6 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1InvoiceitemsPostRequestFormMetadataAnyOf2X28e7aec6 =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1InvoiceitemsPostRequestFormMetadataAnyOf2X28e7aec6> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1InvoiceitemsPostRequestFormMetadataAnyOf2X28e7aec6",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1InvoiceitemsPostRequestFormMetadataAnyOf2X28e7aec6 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1InvoiceitemsPostRequestFormMetadataAnyOf2X28e7aec6,
        ) {
