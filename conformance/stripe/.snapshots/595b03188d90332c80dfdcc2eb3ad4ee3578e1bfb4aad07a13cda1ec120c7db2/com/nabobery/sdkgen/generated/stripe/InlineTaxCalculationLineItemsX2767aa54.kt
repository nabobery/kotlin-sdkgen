...
public class InlineTaxCalculationLineItemsX2767aa54(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineTaxCalculationLineItemsX2767aa54 =
    ...
    public object Serializer : KSerializer<InlineTaxCalculationLineItemsX2767aa54> {
        ...
        override fun deserialize(decoder: Decoder): InlineTaxCalculationLineItemsX2767aa54 {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("InlineTaxCalculationLineItemsX2767aa54 must be a JSON object")
            ...
            val objectValue =
                json.decodeRequired<InlineTaxCalculationLineItemsObjectValueXb2e215da>(
                    rawObject,
                    "object",
                )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineTaxCalculationLineItemsX2767aa54,
        ) {
...
public fun inlineTaxCalculationLineItemsX2767aa54(
    block: InlineTaxCalculationLineItemsX2767aa54.Builder.() -> Unit,
): InlineTaxCalculationLineItemsX2767aa54 = InlineTaxCalculationLineItemsX2767aa54.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineTaxCalculationLineItemsX2767aa54 is missing required property '" + name + "'",
            )
