...
internal data class InlineV1PaymentIntentsPostRequestFormPaymentsPerPeriodXf5ef3618Inspection(
    ...
    public val matchesInlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPaytoAnyOf2X0cc9b826: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPaytoAnyOf2X0cc9b826,
            ).count {
                it
            }
}
...
public class InlineV1PaymentIntentsPostRequestFormPaymentsPerPeriodXf5ef3618 internal constructor(
    ...
    public val inlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPaytoAnyOf2X0cc9b826:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPaytoAnyOf2X0cc9b826) {
                json
                    .decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPaytoAnyOf2X0cc9b826>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1PaymentIntentsPostRequestFormPaymentsPerPeriodXf5ef3618Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPaytoAnyOf2X0cc9b826) {
                    add(
                        InlineV1PaymentIntentsPostRequestFormPaymentsPerPeriodXf5ef3618Branch.InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPaytoAnyOf2X0cc9b826,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1PaymentIntentsPostRequestFormPaymentsPerPeriodXf5ef3618 {
            val inspection = inspectInlineV1PaymentIntentsPostRequestFormPaymentsPerPeriodXf5ef3618(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1PaymentIntentsPostRequestFormPaymentsPerPeriodXf5ef3618NoMatchException(
                    "InlineV1PaymentIntentsPostRequestFormPaymentsPerPeriodXf5ef3618 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormPaymentsPerPeriodXf5ef3618> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormPaymentsPerPeriodXf5ef3618,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1PaymentIntentsPostRequestFormPaymentsPerPeriodXf5ef3618",
...
private fun inspectInlineV1PaymentIntentsPostRequestFormPaymentsPerPeriodXf5ef3618(
    element: JsonElement,
): InlineV1PaymentIntentsPostRequestFormPaymentsPerPeriodXf5ef3618Inspection {
    val matchesBranch1 = element.isJsonDecodable<Int>()
    val matchesInlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPaytoAnyOf2X0cc9b826 =
        element
            .isJsonDecodable<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPaytoAnyOf2X0cc9b826>()
    return InlineV1PaymentIntentsPostRequestFormPaymentsPerPeriodXf5ef3618Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPaytoAnyOf2X0cc9b826) {
                    add(
                        "InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPaytoAnyOf2X0cc9b826: value does not match InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPaytoAnyOf2X0cc9b826",
                    )
                }
            },
    )
