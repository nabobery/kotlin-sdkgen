...
public class PaymentsPrimitivesPaymentRecordsResourcePaymentMethodKonbiniDetailsResourceStore(
    ...
    public class Builder {
        ...
        public fun build(): PaymentsPrimitivesPaymentRecordsResourcePaymentMethodKonbiniDetailsResourceStore =
    ...
    public object Serializer : KSerializer<PaymentsPrimitivesPaymentRecordsResourcePaymentMethodKonbiniDetailsResourceStore> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "PaymentsPrimitivesPaymentRecordsResourcePaymentMethodKonbiniDetailsResourceStore must be a JSON object",
                    )
                ...
                chain =
                    rawObject["chain"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentsPrimitivesPad993ChainX9ba5422c?>(element)
                        }
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentsPrimitivesPaymentRecordsResourcePaymentMethodKonbiniDetailsResourceStore,
        ) {
            val jsonEncoder =
...
public fun paymentsPrimitivesPaymentRecordsResourcePaymentMethodKonbiniDetailsResourceStore(
    block: PaymentsPrimitivesPaymentRecordsResourcePaymentMethodKonbiniDetailsResourceStore.Builder.() -> Unit,
): PaymentsPrimitivesPaymentRecordsResourcePaymentMethodKonbiniDetailsResourceStore =
    PaymentsPrimitivesPaymentRecordsResourcePaymentMethodKonbiniDetailsResourceStore.build(block)
