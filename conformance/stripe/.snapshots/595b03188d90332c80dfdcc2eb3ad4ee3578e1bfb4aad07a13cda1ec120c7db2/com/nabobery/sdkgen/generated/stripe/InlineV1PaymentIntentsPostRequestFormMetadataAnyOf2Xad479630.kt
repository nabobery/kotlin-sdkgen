...
public sealed class InlineV1PaymentIntentsPostRequestFormMetadataAnyOf2Xad479630 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1PaymentIntentsPostRequestFormMetadataAnyOf2Xad479630 =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormMetadataAnyOf2Xad479630> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1PaymentIntentsPostRequestFormMetadataAnyOf2Xad479630",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1PaymentIntentsPostRequestFormMetadataAnyOf2Xad479630 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsPostRequestFormMetadataAnyOf2Xad479630,
        ) {
