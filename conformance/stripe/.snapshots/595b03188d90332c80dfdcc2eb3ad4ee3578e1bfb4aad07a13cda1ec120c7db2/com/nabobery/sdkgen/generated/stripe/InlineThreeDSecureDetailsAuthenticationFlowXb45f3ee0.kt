...
public sealed class InlineThreeDSecureDetailsAuthenticationFlowXb45f3ee0 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineThreeDSecureDetailsAuthenticationFlowXb45f3ee0 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineThreeDSecureDetailsAuthenticationFlowXb45f3ee0> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineThreeDSecureDetailsAuthenticationFlowXb45f3ee0",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineThreeDSecureDetailsAuthenticationFlowXb45f3ee0 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineThreeDSecureDetailsAuthenticationFlowXb45f3ee0,
        ) {
