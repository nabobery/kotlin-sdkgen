...
public class InlineV1TreasuryFinancialAccountsPostRequestFormPlatformRestrictionsXcaf2eb7c(
    public val inboundFlows: InlineV1TreasuryFinancialAc862PostRequestFormInboundFlowsXb4fe1d51? = null,
    public val outboundFlows: InlineV1TreasuryFinancialAc862PostRequestFormOutboundFlowsXcb458391? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1TreasuryFinancialAccountsPostRequestFormPlatformRestrictionsXcaf2eb7c =
    ...
    public object Serializer : KSerializer<InlineV1TreasuryFinancialAccountsPostRequestFormPlatformRestrictionsXcaf2eb7c> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TreasuryFinancialAccountsPostRequestFormPlatformRestrictionsXcaf2eb7c must be a JSON object",
                    )
            return InlineV1TreasuryFinancialAccountsPostRequestFormPlatformRestrictionsXcaf2eb7c(
                inboundFlows =
                    rawObject["inbound_flows"]?.let {
                        json.decodeFromJsonElement<InlineV1TreasuryFinancialAc862PostRequestFormInboundFlowsXb4fe1d51>(
                            it,
                        )
                    },
                outboundFlows =
                    rawObject["outbound_flows"]?.let {
                        json.decodeFromJsonElement<InlineV1TreasuryFinancialAc862PostRequestFormOutboundFlowsXcb458391>(
                            it,
                        )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TreasuryFinancialAccountsPostRequestFormPlatformRestrictionsXcaf2eb7c,
        ) {
            val jsonEncoder =
...
public fun inlineV1TreasuryFinancialAccountsPostRequestFormPlatformRestrictionsXcaf2eb7c(
    block: InlineV1TreasuryFinancialAccountsPostRequestFormPlatformRestrictionsXcaf2eb7c.Builder.() -> Unit,
): InlineV1TreasuryFinancialAccountsPostRequestFormPlatformRestrictionsXcaf2eb7c =
    InlineV1TreasuryFinancialAccountsPostRequestFormPlatformRestrictionsXcaf2eb7c.build(block)
