...
public data class PaymentIntentPaymentMethodOptionsView(
    ...
    public val afterpayClearpay: InlinePaymentIntentPaymentMethodOptionsAfterpayClearpayX1e0bc899? = null,
    ...
    public val customerBalance: InlinePaymentIntentPaymentMethodOptionsCustomerBalanceXa027f90e? = null,
...
public class PaymentIntentPaymentMethodOptions(
    ...
    public class Builder {
        ...
        public fun build(): PaymentIntentPaymentMethodOptions =
    ...
    public object Serializer : KSerializer<PaymentIntentPaymentMethodOptions> {
        ...
        override fun deserialize(decoder: Decoder): PaymentIntentPaymentMethodOptions {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentIntentPaymentMethodOptions must be a JSON object")
            return PaymentIntentPaymentMethodOptions(
                acssDebit =
                    rawObject["acss_debit"]?.let {
                        json.decodeFromJsonElement<InlinePaymentIntentPaymentMethodOptionsAcssDebitXef264253>(it)
                    },
                affirm =
                    rawObject["affirm"]?.let {
                        json.decodeFromJsonElement<InlinePaymentIntentPaymentMethodOptionsAffirmX05af83c5>(it)
                    },
                afterpayClearpay =
                    rawObject["afterpay_clearpay"]?.let {
                        json.decodeFromJsonElement<InlinePaymentIntentPaymentMethodOptionsAfterpayClearpayX1e0bc899>(it)
                    },
                alipay =
                    rawObject["alipay"]?.let {
                        json.decodeFromJsonElement<InlinePaymentIntentPaymentMethodOptionsAlipayXdeb93223>(it)
                    },
                alma =
                    rawObject["alma"]?.let {
                        json
                            .decodeFromJsonElement<InlinePaymentIntentPaymentMethodOptionsAlmaXd2de18ba>(
                                it,
                            )
                    },
                amazonPay =
                    rawObject["amazon_pay"]?.let {
                        json.decodeFromJsonElement<InlinePaymentIntentPaymentMethodOptionsAmazonPayX8ca371ec>(it)
                    },
                auBecsDebit =
                    rawObject["au_becs_debit"]?.let {
                        json.decodeFromJsonElement<InlinePaymentIntentPaymentMethodOptionsAuBecsDebitX0c408c96>(it)
                    },
                bacsDebit =
                    rawObject["bacs_debit"]?.let {
                        json.decodeFromJsonElement<InlinePaymentIntentPaymentMethodOptionsBacsDebitXdd6b2956>(it)
                    },
                bancontact =
                    rawObject["bancontact"]?.let {
                        json.decodeFromJsonElement<InlinePaymentIntentPaymentMethodOptionsBancontactX57dfdb2d>(it)
                    },
                billie =
                    rawObject["billie"]?.let {
                        json.decodeFromJsonElement<InlinePaymentIntentPaymentMethodOptionsBillieXfc138a56>(it)
                    },
                bizum =
                    rawObject["bizum"]?.let {
                        json.decodeFromJsonElement<InlinePaymentIntentPaymentMethodOptionsBizumX6a07fbdb>(it)
                    },
                blik =
                    rawObject["blik"]?.let {
                        json
                            .decodeFromJsonElement<InlinePaymentIntentPaymentMethodOptionsBlikX94e475d2>(
                                it,
                            )
                    },
                boleto =
                    rawObject["boleto"]?.let {
                        json.decodeFromJsonElement<InlinePaymentIntentPaymentMethodOptionsBoletoXed2b1550>(it)
                    },
                card =
                    rawObject["card"]?.let {
                        json
                            .decodeFromJsonElement<InlinePaymentIntentPaymentMethodOptionsCardX377e78c2>(
                                it,
                            )
                    },
                cardPresent =
                    rawObject["card_present"]?.let {
                        json.decodeFromJsonElement<InlinePaymentIntentPaymentMethodOptionsCardPresentX6c88b737>(it)
                    },
                cashapp =
                    rawObject["cashapp"]?.let {
                        json.decodeFromJsonElement<InlinePaymentIntentPaymentMethodOptionsCashappX0fe5ff7d>(it)
                    },
                crypto =
                    rawObject["crypto"]?.let {
                        json.decodeFromJsonElement<InlinePaymentIntentPaymentMethodOptionsCryptoX5609dc30>(it)
                    },
                customerBalance =
                    rawObject["customer_balance"]
                        ?.let {
                            json.decodeFromJsonElement<InlinePaymentIntentPaymentMethodOptionsCustomerBalanceXa027f90e>(
                                it,
                            )
                        },
                eps =
                    rawObject["eps"]?.let {
                        json.decodeFromJsonElement<InlinePaymentIntentPaymentMethodOptionsEpsX37abbad2>(
                            it,
                        )
                    },
                fpx =
                    rawObject["fpx"]?.let {
                        json.decodeFromJsonElement<InlinePaymentIntentPaymentMethodOptionsFpxX3f98c90f>(
                            it,
                        )
                    },
                giropay =
                    rawObject["giropay"]
                        ?.let {
                            json.decodeFromJsonElement<InlinePaymentIntentPaymentMethodOptionsGiropayX966a5a12>(it)
                        },
                grabpay =
                    rawObject["grabpay"]
                        ?.let {
                            json.decodeFromJsonElement<InlinePaymentIntentPaymentMethodOptionsGrabpayX698ab5c6>(it)
                        },
                ideal =
                    rawObject["ideal"]
                        ?.let {
                            json.decodeFromJsonElement<InlinePaymentIntentPaymentMethodOptionsIdealXfeaa92f7>(it)
                        },
                interacPresent =
                    rawObject["interac_present"]
                        ?.let {
                            json.decodeFromJsonElement<InlinePaymentIntentPaymentMethodOptionsInteracPresentX295231f8>(
                                it,
                            )
                        },
                kakaoPay =
                    rawObject["kakao_pay"]
                        ?.let {
                            json.decodeFromJsonElement<InlinePaymentIntentPaymentMethodOptionsKakaoPayXb58e4a08>(it)
                        },
                klarna =
                    rawObject["klarna"]
                        ?.let {
                            json.decodeFromJsonElement<InlinePaymentIntentPaymentMethodOptionsKlarnaXb088a347>(it)
                        },
                konbini =
                    rawObject["konbini"]
                        ?.let {
                            json.decodeFromJsonElement<InlinePaymentIntentPaymentMethodOptionsKonbiniX76392664>(it)
                        },
                krCard =
                    rawObject["kr_card"]
                        ?.let {
                            json.decodeFromJsonElement<InlinePaymentIntentPaymentMethodOptionsKrCardX43e82e0b>(it)
                        },
                link =
                    rawObject["link"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlinePaymentIntentPaymentMethodOptionsLinkXfb2037f7>(
                                    it,
                                )
                        },
                mbWay =
                    rawObject["mb_way"]
                        ?.let {
                            json.decodeFromJsonElement<InlinePaymentIntentPaymentMethodOptionsMbWayX63f59805>(it)
                        },
                mobilepay =
                    rawObject["mobilepay"]
                        ?.let {
                            json.decodeFromJsonElement<InlinePaymentIntentPaymentMethodOptionsMobilepayXa0143746>(it)
                        },
                multibanco =
                    rawObject["multibanco"]
                        ?.let {
                            json.decodeFromJsonElement<InlinePaymentIntentPaymentMethodOptionsMultibancoX3a8440b1>(it)
                        },
                naverPay =
                    rawObject["naver_pay"]
                        ?.let {
                            json.decodeFromJsonElement<InlinePaymentIntentPaymentMethodOptionsNaverPayXbb2d1bb6>(it)
                        },
                nzBankAccount =
                    rawObject["nz_bank_account"]
                        ?.let {
                            json.decodeFromJsonElement<InlinePaymentIntentPaymentMethodOptionsNzBankAccountX199bce43>(
                                it,
                            )
                        },
                oxxo =
                    rawObject["oxxo"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlinePaymentIntentPaymentMethodOptionsOxxoX81c4942d>(
                                    it,
                                )
                        },
                p24 =
                    rawObject["p24"]
                        ?.let {
                            json.decodeFromJsonElement<InlinePaymentIntentPaymentMethodOptionsP24X0b1f4d64>(
                                it,
                            )
                        },
                payByBank =
                    rawObject["pay_by_bank"]
                        ?.let {
                            json.decodeFromJsonElement<InlinePaymentIntentPaymentMethodOptionsPayByBankXaf881de1>(it)
                        },
                payco =
                    rawObject["payco"]
                        ?.let {
                            json.decodeFromJsonElement<InlinePaymentIntentPaymentMethodOptionsPaycoX8c73e0e3>(it)
                        },
                paynow =
                    rawObject["paynow"]
                        ?.let {
                            json.decodeFromJsonElement<InlinePaymentIntentPaymentMethodOptionsPaynowX5d11ac32>(it)
                        },
                paypal =
                    rawObject["paypal"]
                        ?.let {
                            json.decodeFromJsonElement<InlinePaymentIntentPaymentMethodOptionsPaypalX39208591>(it)
                        },
                payto =
                    rawObject["payto"]
                        ?.let {
                            json.decodeFromJsonElement<InlinePaymentIntentPaymentMethodOptionsPaytoXca12dd57>(it)
                        },
                pix =
                    rawObject["pix"]
                        ?.let {
                            json.decodeFromJsonElement<InlinePaymentIntentPaymentMethodOptionsPixXc9f24550>(
                                it,
                            )
                        },
                promptpay =
                    rawObject["promptpay"]
                        ?.let {
                            json.decodeFromJsonElement<InlinePaymentIntentPaymentMethodOptionsPromptpayXecdd5e19>(it)
                        },
                revolutPay =
                    rawObject["revolut_pay"]
                        ?.let {
                            json.decodeFromJsonElement<InlinePaymentIntentPaymentMethodOptionsRevolutPayX9ef48383>(it)
                        },
                samsungPay =
                    rawObject["samsung_pay"]
                        ?.let {
                            json.decodeFromJsonElement<InlinePaymentIntentPaymentMethodOptionsSamsungPayXa21874a2>(it)
                        },
                satispay =
                    rawObject["satispay"]
                        ?.let {
                            json.decodeFromJsonElement<InlinePaymentIntentPaymentMethodOptionsSatispayX7907b0b3>(it)
                        },
                scalapay =
                    rawObject["scalapay"]
                        ?.let {
                            json.decodeFromJsonElement<InlinePaymentIntentPaymentMethodOptionsScalapayX4750ac7c>(it)
                        },
                sepaDebit =
                    rawObject["sepa_debit"]
                        ?.let {
                            json.decodeFromJsonElement<InlinePaymentIntentPaymentMethodOptionsSepaDebitX34c6728c>(it)
                        },
                sofort =
                    rawObject["sofort"]
                        ?.let {
                            json.decodeFromJsonElement<InlinePaymentIntentPaymentMethodOptionsSofortX2c9e3d5f>(it)
                        },
                sunbit =
                    rawObject["sunbit"]
                        ?.let {
                            json.decodeFromJsonElement<InlinePaymentIntentPaymentMethodOptionsSunbitX86fca1f0>(it)
                        },
                swish =
                    rawObject["swish"]
                        ?.let {
                            json.decodeFromJsonElement<InlinePaymentIntentPaymentMethodOptionsSwishXbae2c923>(it)
                        },
                twint =
                    rawObject["twint"]
                        ?.let {
                            json.decodeFromJsonElement<InlinePaymentIntentPaymentMethodOptionsTwintX7c420c5a>(it)
                        },
                upi =
                    rawObject["upi"]
                        ?.let {
                            json.decodeFromJsonElement<InlinePaymentIntentPaymentMethodOptionsUpiX6ae5eb7c>(
                                it,
                            )
                        },
                usBankAccount =
                    rawObject["us_bank_account"]
                        ?.let {
                            json.decodeFromJsonElement<InlinePaymentIntentPaymentMethodOptionsUsBankAccountX10f42ecc>(
                                it,
                            )
                        },
                wechatPay =
                    rawObject["wechat_pay"]
                        ?.let {
                            json.decodeFromJsonElement<InlinePaymentIntentPaymentMethodOptionsWechatPayX057241c0>(it)
                        },
                zip =
                    rawObject["zip"]
                        ?.let {
                            json.decodeFromJsonElement<InlinePaymentIntentPaymentMethodOptionsZipX24317875>(
                                it,
                            )
                        },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentIntentPaymentMethodOptions,
        ) {
...
public fun paymentIntentPaymentMethodOptions(
    block: PaymentIntentPaymentMethodOptions.Builder.() -> Unit,
): PaymentIntentPaymentMethodOptions = PaymentIntentPaymentMethodOptions.build(block)
