...
public class TerminalConfigurationConfigurationResourceEnterpriseTlsWifi(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): TerminalConfigurationConfigurationResourceEnterpriseTlsWifi =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<TerminalConfigurationConfigurationResourceEnterpriseTlsWifi> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "TerminalConfigurationConfigurationResourceEnterpriseTlsWifi must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: TerminalConfigurationConfigurationResourceEnterpriseTlsWifi,
        ) {
...
public fun terminalConfigurationConfigurationResourceEnterpriseTlsWifi(
    block: TerminalConfigurationConfigurationResourceEnterpriseTlsWifi.Builder.() -> Unit,
): TerminalConfigurationConfigurationResourceEnterpriseTlsWifi =
    TerminalConfigurationConfigurationResourceEnterpriseTlsWifi.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "TerminalConfigurationConfigurationResourceEnterpriseTlsWifi is missing required property '" + name +
                    "'",
            )
