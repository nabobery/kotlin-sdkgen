...
public sealed class InlineInvoicePaymentMethoddec3CountryX7154029b {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineInvoicePaymentMethoddec3CountryX7154029b =
            when (value) {
                Be.value -> Be
                De.value -> De
                Es.value -> Es
    ...
    public object Serializer : KSerializer<InlineInvoicePaymentMethoddec3CountryX7154029b> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineInvoicePaymentMethoddec3CountryX7154029b",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineInvoicePaymentMethoddec3CountryX7154029b =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineInvoicePaymentMethoddec3CountryX7154029b,
        ) {
