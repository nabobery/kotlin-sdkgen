...
internal data class InlineV1DisputesPostRequestFormEvidenceCustomerAccountIdXf2de54efInspection(
    ...
    public val matchesInlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2X937dd214: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2X937dd214,
            ).count {
                it
            }
}
...
public class InlineV1DisputesPostRequestFormEvidenceCustomerAccountIdXf2de54ef internal constructor(
    ...
    private val inspection: InlineV1DisputesPostRequestFormEvidenceCustomerAccountIdXf2de54efInspection,
) {
    ...
    public val inlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2X937dd214:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2X937dd214) {
                json
                    .decodeFromJsonElement<InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2X937dd214>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1DisputesPostRequestFormEvidenceCustomerAccountIdXf2de54efBranch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2X937dd214) {
                    add(
                        InlineV1DisputesPostRequestFormEvidenceCustomerAccountIdXf2de54efBranch.InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2X937dd214,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1DisputesPostRequestFormEvidenceCustomerAccountIdXf2de54ef {
            val inspection = inspectInlineV1DisputesPostRequestFormEvidenceCustomerAccountIdXf2de54ef(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1DisputesPostRequestFormEvidenceCustomerAccountIdXf2de54efNoMatchException(
                    "InlineV1DisputesPostRequestFormEvidenceCustomerAccountIdXf2de54ef matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1DisputesPostRequestFormEvidenceCustomerAccountIdXf2de54ef> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1DisputesPostRequestFormEvidenceCustomerAccountIdXf2de54ef,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1DisputesPostRequestFormEvidenceCustomerAccountIdXf2de54ef",
...
private fun inspectInlineV1DisputesPostRequestFormEvidenceCustomerAccountIdXf2de54ef(
    element: JsonElement,
): InlineV1DisputesPostRequestFormEvidenceCustomerAccountIdXf2de54efInspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2X937dd214 =
        element
            .isJsonDecodable<InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2X937dd214>()
    return InlineV1DisputesPostRequestFormEvidenceCustomerAccountIdXf2de54efInspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2X937dd214) {
                    add(
                        "InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2X937dd214: value does not match InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2X937dd214",
                    )
                }
            },
    )
