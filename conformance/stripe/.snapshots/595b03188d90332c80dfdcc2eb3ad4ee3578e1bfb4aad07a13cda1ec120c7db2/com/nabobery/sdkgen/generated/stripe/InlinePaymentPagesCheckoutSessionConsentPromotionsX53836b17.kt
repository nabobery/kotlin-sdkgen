...
public sealed class InlinePaymentPagesCheckoutSessionConsentPromotionsX53836b17 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentPagesCheckoutSessionConsentPromotionsX53836b17 =
            when (value) {
                OptIn.value -> OptIn
                OptOut.value -> OptOut
    ...
    public object Serializer : KSerializer<InlinePaymentPagesCheckoutSessionConsentPromotionsX53836b17> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentPagesCheckoutSessionConsentPromotionsX53836b17",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePaymentPagesCheckoutSessionConsentPromotionsX53836b17 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentPagesCheckoutSessionConsentPromotionsX53836b17,
        ) {
