...
public class InlineV1CustomersSubscriptionsPostRequestFormItemsItemXdfdc9b17(
    ...
    public val discounts: InlineV1CustomersSubscriptionsPostRequestFormItemsItemDiscountsX390ec2a0? = null,
    public val metadata: Map<String, String>? = null,
    public val price: String? = null,
    public val priceData: InlineV1CustomersSubscriptionsPostRequestFormItemsItemPriceDataX814be096? = null,
    public val quantity: Int? = null,
    public val taxRates: InlineV1CustomersSubscriptionsPostRequestFormItemsItemTaxRatesX38c93af9? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1CustomersSubscriptionsPostRequestFormItemsItemXdfdc9b17 =
            InlineV1CustomersSubscriptionsPostRequestFormItemsItemXdfdc9b17(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1CustomersSubscriptionsPostRequestFormItemsItemXdfdc9b17 =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1CustomersSubscriptionsPostRequestFormItemsItemXdfdc9b17> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CustomersSubscriptionsPostRequestFormItemsItemXdfdc9b17 must be a JSON object",
                    )
            return InlineV1CustomersSubscriptionsPostRequestFormItemsItemXdfdc9b17(
                billingThresholds =
                    rawObject["billing_thresholds"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CustomersSubscriptionsPostRequestFormItemsItemBillingThresholdsX569df5ef>(
                                it,
                            )
                    },
                discounts =
                    rawObject["discounts"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CustomersSubscriptionsPostRequestFormItemsItemDiscountsX390ec2a0>(
                                it,
                            )
                    },
                ...
                priceData =
                    rawObject["price_data"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CustomersSubscriptionsPostRequestFormItemsItemPriceDataX814be096>(
                                it,
                            )
                    },
                ...
                taxRates =
                    rawObject["tax_rates"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CustomersSubscriptionsPostRequestFormItemsItemTaxRatesX38c93af9>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomersSubscriptionsPostRequestFormItemsItemXdfdc9b17,
        ) {
            val jsonEncoder =
...
public fun inlineV1CustomersSubscriptionsPostRequestFormItemsItemXdfdc9b17(
    block: InlineV1CustomersSubscriptionsPostRequestFormItemsItemXdfdc9b17.Builder.() -> Unit,
): InlineV1CustomersSubscriptionsPostRequestFormItemsItemXdfdc9b17 =
    InlineV1CustomersSubscriptionsPostRequestFormItemsItemXdfdc9b17.build(block)
