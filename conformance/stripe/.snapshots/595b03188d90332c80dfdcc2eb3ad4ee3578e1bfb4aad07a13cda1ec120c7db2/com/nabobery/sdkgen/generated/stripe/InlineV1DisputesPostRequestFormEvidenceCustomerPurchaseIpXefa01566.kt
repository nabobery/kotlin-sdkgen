...
internal data class InlineV1DisputesPostRequestFormEvidenceCustomerPurchaseIpXefa01566Inspection(
    ...
    public val matchesInlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2X504f18d0: Boolean,
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2X504f18d0,
            ).count {
                it
            }
}
...
public class InlineV1DisputesPostRequestFormEvidenceCustomerPurchaseIpXefa01566 internal constructor(
    ...
    private val inspection: InlineV1DisputesPostRequestFormEvidenceCustomerPurchaseIpXefa01566Inspection,
) {
    ...
    public val inlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2X504f18d0:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2X504f18d0) {
                json
                    .decodeFromJsonElement<InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2X504f18d0>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1DisputesPostRequestFormEvidenceCustomerPurchaseIpXefa01566Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2X504f18d0) {
                    add(
                        InlineV1DisputesPostRequestFormEvidenceCustomerPurchaseIpXefa01566Branch.InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2X504f18d0,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1DisputesPostRequestFormEvidenceCustomerPurchaseIpXefa01566 {
            val inspection = inspectInlineV1DisputesPostRequestFormEvidenceCustomerPurchaseIpXefa01566(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1DisputesPostRequestFormEvidenceCustomerPurchaseIpXefa01566NoMatchException(
                    "InlineV1DisputesPostRequestFormEvidenceCustomerPurchaseIpXefa01566 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1DisputesPostRequestFormEvidenceCustomerPurchaseIpXefa01566> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1DisputesPostRequestFormEvidenceCustomerPurchaseIpXefa01566,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1DisputesPostRequestFormEvidenceCustomerPurchaseIpXefa01566",
...
private fun inspectInlineV1DisputesPostRequestFormEvidenceCustomerPurchaseIpXefa01566(
    element: JsonElement,
): InlineV1DisputesPostRequestFormEvidenceCustomerPurchaseIpXefa01566Inspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2X504f18d0 =
        element
            .isJsonDecodable<InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2X504f18d0>()
    return InlineV1DisputesPostRequestFormEvidenceCustomerPurchaseIpXefa01566Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2X504f18d0) {
                    add(
                        "InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2X504f18d0: value does not match InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1AnyOf2X504f18d0",
                    )
                }
            },
    )
