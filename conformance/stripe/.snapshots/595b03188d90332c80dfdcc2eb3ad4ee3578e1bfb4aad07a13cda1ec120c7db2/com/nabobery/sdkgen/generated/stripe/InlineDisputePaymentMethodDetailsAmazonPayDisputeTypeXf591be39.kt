...
public sealed class InlineDisputePaymentMethodDetailsAmazonPayDisputeTypeXf591be39 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineDisputePaymentMethodDetailsAmazonPayDisputeTypeXf591be39 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineDisputePaymentMethodDetailsAmazonPayDisputeTypeXf591be39> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineDisputePaymentMethodDetailsAmazonPayDisputeTypeXf591be39",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineDisputePaymentMethodDetailsAmazonPayDisputeTypeXf591be39 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineDisputePaymentMethodDetailsAmazonPayDisputeTypeXf591be39,
        ) {
