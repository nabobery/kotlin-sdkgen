...
public class CustomerSessionResourceComponentsResourceMobilePaymentElement(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): CustomerSessionResourceComponentsResourceMobilePaymentElement =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<CustomerSessionResourceComponentsResourceMobilePaymentElement> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "CustomerSessionResourceComponentsResourceMobilePaymentElement must be a JSON object",
                    )
                ...
                features =
                    rawObject["features"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineCustomerSessionResou2ffcFeaturesX4813c261?>(element)
                        }
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: CustomerSessionResourceComponentsResourceMobilePaymentElement,
        ) {
            val jsonEncoder =
...
public fun customerSessionResourceComponentsResourceMobilePaymentElement(
    block: CustomerSessionResourceComponentsResourceMobilePaymentElement.Builder.() -> Unit,
): CustomerSessionResourceComponentsResourceMobilePaymentElement =
    CustomerSessionResourceComponentsResourceMobilePaymentElement.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "CustomerSessionResourceComponentsResourceMobilePaymentElement is missing required property '" + name +
                    "'",
            )
