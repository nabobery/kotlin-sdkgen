...
public class InlineV1TokensPostRequestFormPersonDocumentsX6cae069c(
    public val companyAuthorization: InlineV1TokensPostRequestFormPersonDocumentsCompanyAuthorizationXd52e902f? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1TokensPostRequestFormPersonDocumentsX6cae069c =
            InlineV1TokensPostRequestFormPersonDocumentsX6cae069c(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TokensPostRequestFormPersonDocumentsX6cae069c =
    ...
    public object Serializer : KSerializer<InlineV1TokensPostRequestFormPersonDocumentsX6cae069c> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TokensPostRequestFormPersonDocumentsX6cae069c must be a JSON object",
                    )
            return InlineV1TokensPostRequestFormPersonDocumentsX6cae069c(
                companyAuthorization =
                    rawObject["company_authorization"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TokensPostRequestFormPersonDocumentsCompanyAuthorizationXd52e902f>(
                                it,
                            )
                    },
                passport =
                    rawObject["passport"]?.let {
                        json.decodeFromJsonElement<InlineV1TokensPostRequestFormPersonDocumentsPassportX09246e54>(it)
                    },
                visa =
                    rawObject["visa"]?.let {
                        json.decodeFromJsonElement<InlineV1TokensPostRequestFormPersonDocumentsVisaXb0e14608>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TokensPostRequestFormPersonDocumentsX6cae069c,
        ) {
...
public fun inlineV1TokensPostRequestFormPersonDocumentsX6cae069c(
    block: InlineV1TokensPostRequestFormPersonDocumentsX6cae069c.Builder.() -> Unit,
): InlineV1TokensPostRequestFormPersonDocumentsX6cae069c =
    InlineV1TokensPostRequestFormPersonDocumentsX6cae069c.build(block)
