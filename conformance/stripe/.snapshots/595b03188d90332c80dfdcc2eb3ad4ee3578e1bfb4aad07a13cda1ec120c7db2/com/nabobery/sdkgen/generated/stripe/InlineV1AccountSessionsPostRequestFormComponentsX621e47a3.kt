...
public class InlineV1AccountSessionsPostRequestFormComponentsX621e47a3(
    public val accountManagement: InlineV1AccountSessionsPostRequestFormComponentsAccountManagementXf938a460? = null,
    public val accountOnboarding: InlineV1AccountSessionsPostRequestFormComponentsAccountOnboardingX2c600e84? = null,
    public val balanceReport: InlineV1AccountSessionsPostRequestFormComponentsBalanceReportX320fa6c7? = null,
    public val balances: InlineV1AccountSessionsPostRequestFormComponentsBalancesX47ba8513? = null,
    public val disputesList: InlineV1AccountSessionsPostRequestFormComponentsDisputesListXf3ff1ba6? = null,
    public val documents: InlineV1AccountSessionsPostRequestFormComponentsDocumentsX5c9d67c7? = null,
    public val financialAccount: InlineV1AccountSessionsPostRequestFormComponentsFinancialAccountX16c37f4a? = null,
    ...
    public val issuingCard: InlineV1AccountSessionsPostRequestFormComponentsIssuingCardX085614aa? = null,
    public val issuingCardsList: InlineV1AccountSessionsPostRequestFormComponentsIssuingCardsListX27e1c9cc? = null,
    public val notificationBanner: InlineV1AccountSessionsPostRequestFormComponentsNotificationBannerXd1d0b4d7? = null,
    public val paymentDetails: InlineV1AccountSessionsPostRequestFormComponentsPaymentDetailsX08e1c631? = null,
    public val paymentDisputes: InlineV1AccountSessionsPostRequestFormComponentsPaymentDisputesXfacf6bbb? = null,
    public val payments: InlineV1AccountSessionsPostRequestFormComponentsPaymentsX94816c2f? = null,
    public val payoutDetails: InlineV1AccountSessionsPostRequestFormComponentsPayoutDetailsX9bda0df5? = null,
    ...
    public val payoutsList: InlineV1AccountSessionsPostRequestFormComponentsPayoutsListX00d5f0e8? = null,
    public val taxRegistrations: InlineV1AccountSessionsPostRequestFormComponentsTaxRegistrationsXee75b36e? = null,
    public val taxSettings: InlineV1AccountSessionsPostRequestFormComponentsTaxSettingsX26422387? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1AccountSessionsPostRequestFormComponentsX621e47a3 =
            InlineV1AccountSessionsPostRequestFormComponentsX621e47a3(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1AccountSessionsPostRequestFormComponentsX621e47a3 =
    ...
    public object Serializer : KSerializer<InlineV1AccountSessionsPostRequestFormComponentsX621e47a3> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1AccountSessionsPostRequestFormComponentsX621e47a3 must be a JSON object",
                    )
            return InlineV1AccountSessionsPostRequestFormComponentsX621e47a3(
                accountManagement =
                    rawObject["account_management"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1AccountSessionsPostRequestFormComponentsAccountManagementXf938a460>(
                                it,
                            )
                    },
                accountOnboarding =
                    rawObject["account_onboarding"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1AccountSessionsPostRequestFormComponentsAccountOnboardingX2c600e84>(
                                it,
                            )
                    },
                balanceReport =
                    rawObject["balance_report"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1AccountSessionsPostRequestFormComponentsBalanceReportX320fa6c7>(
                                it,
                            )
                    },
                balances =
                    rawObject["balances"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountSessionsPostRequestFormComponentsBalancesX47ba8513>(
                            it,
                        )
                    },
                disputesList =
                    rawObject["disputes_list"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1AccountSessionsPostRequestFormComponentsDisputesListXf3ff1ba6>(
                                it,
                            )
                    },
                documents =
                    rawObject["documents"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountSessionsPostRequestFormComponentsDocumentsX5c9d67c7>(
                            it,
                        )
                    },
                financialAccount =
                    rawObject["financial_account"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1AccountSessionsPostRequestFormComponentsFinancialAccountX16c37f4a>(
                                it,
                            )
                    },
                financialAccountTransactions =
                    rawObject["financial_account_transactions"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1AccountSessionsPostRequestFormFinancialAccountTrane127X4bf4b8a7>(
                                it,
                            )
                    },
                instantPayoutsPromotion =
                    rawObject["instant_payouts_promotion"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1AccountSessionsPostRequestFormComponentsInstantPayoutsPromotionX1cf840ec>(
                                it,
                            )
                    },
                issuingCard =
                    rawObject["issuing_card"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1AccountSessionsPostRequestFormComponentsIssuingCardX085614aa>(
                                it,
                            )
                    },
                issuingCardsList =
                    rawObject["issuing_cards_list"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1AccountSessionsPostRequestFormComponentsIssuingCardsListX27e1c9cc>(
                                it,
                            )
                    },
                notificationBanner =
                    rawObject["notification_banner"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1AccountSessionsPostRequestFormComponentsNotificationBannerXd1d0b4d7>(
                                it,
                            )
                    },
                paymentDetails =
                    rawObject["payment_details"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1AccountSessionsPostRequestFormComponentsPaymentDetailsX08e1c631>(
                                it,
                            )
                    },
                paymentDisputes =
                    rawObject["payment_disputes"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1AccountSessionsPostRequestFormComponentsPaymentDisputesXfacf6bbb>(
                                it,
                            )
                    },
                payments =
                    rawObject["payments"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountSessionsPostRequestFormComponentsPaymentsX94816c2f>(
                            it,
                        )
                    },
                payoutDetails =
                    rawObject["payout_details"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1AccountSessionsPostRequestFormComponentsPayoutDetailsX9bda0df5>(
                                it,
                            )
                    },
                payoutReconciliationReport =
                    rawObject["payout_reconciliation_report"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1AccountSessionsPostRequestFormPayoutReconciliationfd97X634f1588>(
                                    it,
                                )
                        },
                payouts =
                    rawObject["payouts"]?.let {
                        json.decodeFromJsonElement<InlineV1AccountSessionsPostRequestFormComponentsPayoutsX7b5f15fa>(it)
                    },
                payoutsList =
                    rawObject["payouts_list"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1AccountSessionsPostRequestFormComponentsPayoutsListX00d5f0e8>(
                                    it,
                                )
                        },
                taxRegistrations =
                    rawObject["tax_registrations"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1AccountSessionsPostRequestFormComponentsTaxRegistrationsXee75b36e>(
                                    it,
                                )
                        },
                taxSettings =
                    rawObject["tax_settings"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineV1AccountSessionsPostRequestFormComponentsTaxSettingsX26422387>(
                                    it,
                                )
                        },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountSessionsPostRequestFormComponentsX621e47a3,
        ) {
            ...
            val raw =
                buildJsonObject {
                    ...
                    value.financialAccountTransactions?.let {
                        put(
                            "financial_account_transactions",
                            json.encodeToJsonElement(it),
                        )
                    }
                    value.instantPayoutsPromotion?.let {
                        put(
                    ...
                    value.payoutReconciliationReport?.let {
                        put(
...
public fun inlineV1AccountSessionsPostRequestFormComponentsX621e47a3(
    block: InlineV1AccountSessionsPostRequestFormComponentsX621e47a3.Builder.() -> Unit,
): InlineV1AccountSessionsPostRequestFormComponentsX621e47a3 =
    InlineV1AccountSessionsPostRequestFormComponentsX621e47a3.build(block)
