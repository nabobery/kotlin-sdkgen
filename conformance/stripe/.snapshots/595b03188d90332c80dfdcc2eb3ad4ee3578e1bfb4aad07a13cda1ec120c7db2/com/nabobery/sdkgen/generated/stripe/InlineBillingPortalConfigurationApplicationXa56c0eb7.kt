...
public class InlineBillingPortalConfigurationApplicationXa56c0eb7 internal constructor(
    ...
    public val matchedBranches: Set<InlineBillingPortalConfigurationApplicationXa56c0eb7Branch>
        get() =
            buildSet {
                ...
                if (inspection.matchesApplication) {
                    add(
                        InlineBillingPortalConfigurationApplicationXa56c0eb7Branch.Application,
                    )
                }
                if (inspection.matchesDeletedApplication) {
                    add(
                        InlineBillingPortalConfigurationApplicationXa56c0eb7Branch.DeletedApplication,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineBillingPortalConfigurationApplicationXa56c0eb7 {
            val inspection = inspectInlineBillingPortalConfigurationApplicationXa56c0eb7(raw)
            if (inspection.matchCount == 0) {
                throw InlineBillingPortalConfigurationApplicationXa56c0eb7NoMatchException(
                    "InlineBillingPortalConfigurationApplicationXa56c0eb7 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineBillingPortalConfigurationApplicationXa56c0eb7> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineBillingPortalConfigurationApplicationXa56c0eb7,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineBillingPortalConfigurationApplicationXa56c0eb7",
...
private fun inspectInlineBillingPortalConfigurationApplicationXa56c0eb7(
    element: JsonElement,
): InlineBillingPortalConfigurationApplicationXa56c0eb7Inspection {
