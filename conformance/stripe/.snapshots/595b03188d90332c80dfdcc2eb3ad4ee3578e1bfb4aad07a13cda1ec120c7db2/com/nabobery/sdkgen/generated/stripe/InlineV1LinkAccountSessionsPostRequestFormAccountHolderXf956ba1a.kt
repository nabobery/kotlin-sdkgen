...
public class InlineV1LinkAccountSessionsPostRequestFormAccountHolderXf956ba1a(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1LinkAccountSessionsPostRequestFormAccountHolderXf956ba1a =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1LinkAccountSessionsPostRequestFormAccountHolderXf956ba1a> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1LinkAccountSessionsPostRequestFormAccountHolderXf956ba1a {
            val jsonDecoder =
                decoder.requireJsonDecoder(
                    "InlineV1LinkAccountSessionsPostRequestFormAccountHolderXf956ba1a",
                )
            val json = jsonDecoder.json
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1LinkAccountSessionsPostRequestFormAccountHolderXf956ba1a must be a JSON object",
                    )
            val type =
                json.decodeRequired<InlineV1LinkAccountSessionsPostRequestFormAccountHolderTypeX59fc2b8a>(
                    rawObject,
                    "type",
                )
            return InlineV1LinkAccountSessionsPostRequestFormAccountHolderXf956ba1a(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1LinkAccountSessionsPostRequestFormAccountHolderXf956ba1a,
        ) {
            val jsonEncoder =
...
public fun inlineV1LinkAccountSessionsPostRequestFormAccountHolderXf956ba1a(
    block: InlineV1LinkAccountSessionsPostRequestFormAccountHolderXf956ba1a.Builder.() -> Unit,
): InlineV1LinkAccountSessionsPostRequestFormAccountHolderXf956ba1a =
    InlineV1LinkAccountSessionsPostRequestFormAccountHolderXf956ba1a.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1LinkAccountSessionsPostRequestFormAccountHolderXf956ba1a is missing required property '" + name +
                    "'",
            )
