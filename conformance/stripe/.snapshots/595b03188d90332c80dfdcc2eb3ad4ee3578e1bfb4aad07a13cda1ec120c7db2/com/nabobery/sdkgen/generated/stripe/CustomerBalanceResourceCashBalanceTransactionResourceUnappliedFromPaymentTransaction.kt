 ...
 */
@Serializable(
    with = CustomerBalanceResourceCashBalanceTransactionResourceUnappliedFromPaymentTransaction.Serializer::class,
)
public class CustomerBalanceResourceCashBalanceTransactionResourceUnappliedFromPaymentTransaction(
    ...
    public object Serializer : KSerializer<CustomerBalanceResourceCashBalanceTransactionResourceUnappliedFromPaymentTransaction> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "CustomerBalanceResourceCashBalanceTransactionResourceUnappliedFromPaymentTransaction must be a JSON object",
                    )
            val paymentIntent =
                json.decodeRequired<InlineCustomerBalanceResou4f2cPaymentIntentX0d166ba8>(
                    rawObject,
                    "payment_intent",
                )
            return CustomerBalanceResourceCashBalanceTransactionResourceUnappliedFromPaymentTransaction(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: CustomerBalanceResourceCashBalanceTransactionResourceUnappliedFromPaymentTransaction,
        ) {
            val jsonEncoder =
...
public fun customerBalanceResourceCashBalanceTransactionResourceUnappliedFromPaymentTransaction(
    block: CustomerBalanceResourceCashBalanceTransactionResourceUnappliedFromPaymentTransaction.Builder.() -> Unit,
): CustomerBalanceResourceCashBalanceTransactionResourceUnappliedFromPaymentTransaction =
    CustomerBalanceResourceCashBalanceTransactionResourceUnappliedFromPaymentTransaction.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "CustomerBalanceResourceCashBalanceTransactionResourceUnappliedFromPaymentTransaction is missing required property '" +
                    name +
                    "'",
            )
