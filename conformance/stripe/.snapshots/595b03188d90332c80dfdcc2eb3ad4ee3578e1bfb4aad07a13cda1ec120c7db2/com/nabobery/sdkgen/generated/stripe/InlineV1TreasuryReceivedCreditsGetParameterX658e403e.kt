...
public class InlineV1TreasuryReceivedCreditsGetParameterX658e403e(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TreasuryReceivedCreditsGetParameterX658e403e =
    ...
    public object Serializer : KSerializer<InlineV1TreasuryReceivedCreditsGetParameterX658e403e> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TreasuryReceivedCreditsGetParameterX658e403e must be a JSON object",
                    )
            val sourceFlowType =
                json.decodeRequired<InlineV1TreasuryReceivedCreditsGetParameterSourceFlowTypeX2df67275>(
                    rawObject,
                    "source_flow_type",
                )
            return InlineV1TreasuryReceivedCreditsGetParameterX658e403e(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TreasuryReceivedCreditsGetParameterX658e403e,
        ) {
...
public fun inlineV1TreasuryReceivedCreditsGetParameterX658e403e(
    block: InlineV1TreasuryReceivedCreditsGetParameterX658e403e.Builder.() -> Unit,
): InlineV1TreasuryReceivedCreditsGetParameterX658e403e =
    InlineV1TreasuryReceivedCreditsGetParameterX658e403e.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TreasuryReceivedCreditsGetParameterX658e403e is missing required property '" + name + "'",
            )
