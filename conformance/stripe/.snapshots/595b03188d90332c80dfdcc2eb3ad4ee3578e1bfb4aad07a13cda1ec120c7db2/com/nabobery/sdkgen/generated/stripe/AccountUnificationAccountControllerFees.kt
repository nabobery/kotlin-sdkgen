...
public class AccountUnificationAccountControllerFees(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): AccountUnificationAccountControllerFees =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<AccountUnificationAccountControllerFees> {
        ...
        override fun deserialize(decoder: Decoder): AccountUnificationAccountControllerFees {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("AccountUnificationAccountControllerFees must be a JSON object")
            val payer =
                json.decodeRequired<InlineAccountUnificationAccountControllerFeesPayerXf588ffe2>(
                    rawObject,
                    "payer",
                )
            return AccountUnificationAccountControllerFees(
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: AccountUnificationAccountControllerFees,
        ) {
...
public fun accountUnificationAccountControllerFees(
    block: AccountUnificationAccountControllerFees.Builder.() -> Unit,
): AccountUnificationAccountControllerFees = AccountUnificationAccountControllerFees.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "AccountUnificationAccountControllerFees is missing required property '" + name + "'",
            )
