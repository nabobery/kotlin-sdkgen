...
public sealed class InlineV1RefundsPostRequestFormOriginX66fb951a {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1RefundsPostRequestFormOriginX66fb951a =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineV1RefundsPostRequestFormOriginX66fb951a> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1RefundsPostRequestFormOriginX66fb951a",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1RefundsPostRequestFormOriginX66fb951a =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1RefundsPostRequestFormOriginX66fb951a,
        ) {
