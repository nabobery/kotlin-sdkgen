...
public class InlineV1TreasuryOutboundTrc70dPostRequestFormAnyOf1X9071ce4b(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1TreasuryOutboundTrc70dPostRequestFormAnyOf1X9071ce4b =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TreasuryOutboundTrc70dPostRequestFormAnyOf1X9071ce4b =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TreasuryOutboundTrc70dPostRequestFormAnyOf1X9071ce4b> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TreasuryOutboundTrc70dPostRequestFormAnyOf1X9071ce4b must be a JSON object",
                    )
            return InlineV1TreasuryOutboundTrc70dPostRequestFormAnyOf1X9071ce4b(
                network =
                    rawObject["network"]?.let {
                        json.decodeFromJsonElement<InlineV1TreasuryOutboundTrc70dPostRequestFormNetworkX56d3a4af>(it)
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TreasuryOutboundTrc70dPostRequestFormAnyOf1X9071ce4b,
        ) {
...
public fun inlineV1TreasuryOutboundTrc70dPostRequestFormAnyOf1X9071ce4b(
    block: InlineV1TreasuryOutboundTrc70dPostRequestFormAnyOf1X9071ce4b.Builder.() -> Unit,
): InlineV1TreasuryOutboundTrc70dPostRequestFormAnyOf1X9071ce4b =
    InlineV1TreasuryOutboundTrc70dPostRequestFormAnyOf1X9071ce4b.build(block)
