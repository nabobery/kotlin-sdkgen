...
public class MandateAcssDebit(
     ...
     */
    public val defaultFor: List<InlineMandateAcssDebitDefaultForItemX1a0cdd90>? = null,
    /**
    ...
    public class Builder {
         ...
         * List of Stripe products where this mandate can be selected automatically.
         */
        public var defaultFor: List<InlineMandateAcssDebitDefaultForItemX1a0cdd90>? = null
        ...
        override fun deserialize(decoder: Decoder): MandateAcssDebit {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("MandateAcssDebit must be a JSON object")
            val paymentSchedule =
                json.decodeRequired<InlineMandateAcssDebitPaymentScheduleX56c488b6>(
                    rawObject,
                    "payment_schedule",
                )
            val transactionType =
                json.decodeRequired<InlineMandateAcssDebitTransactionTypeXaf9f9ebd>(
                    rawObject,
                    "transaction_type",
                )
            return MandateAcssDebit(
                ...
                defaultFor =
                    rawObject["default_for"]?.let {
                        json.decodeFromJsonElement<List<InlineMandateAcssDebitDefaultForItemX1a0cdd90>>(it)
                    },
                intervalDescription =
...
public fun mandateAcssDebit(block: MandateAcssDebit.Builder.() -> Unit): MandateAcssDebit =
    MandateAcssDebit.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("MandateAcssDebit is missing required property '" + name + "'")
