...
public class InlineV1CustomerSessionsPostRequestFormComponentsCustomerSheetFeaturesX65d7888b(
    ...
    public val paymentMethodRemove: InlineV1CustomerSessionsPostRequestFormComponentsPaymentMethodRemoveX68c6af72? = null,
) {
    public class Builder {
        ...
        public fun build(): InlineV1CustomerSessionsPostRequestFormComponentsCustomerSheetFeaturesX65d7888b =
    ...
    public object Serializer : KSerializer<InlineV1CustomerSessionsPostRequestFormComponentsCustomerSheetFeaturesX65d7888b> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1CustomerSessionsPostRequestFormComponentsCustomerSheetFeaturesX65d7888b must be a JSON object",
                    )
            return InlineV1CustomerSessionsPostRequestFormComponentsCustomerSheetFeaturesX65d7888b(
                paymentMethodAllowRedisplayFilters =
                    rawObject["payment_method_allow_redisplay_filters"]?.let {
                        json
                            .decodeFromJsonElement<List<InlineV1CustomerSessionsPostRequestFormComponentsCustomerSheetItemXf4c0cecf>>(
                                it,
                            )
                    },
                paymentMethodRemove =
                    rawObject["payment_method_remove"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1CustomerSessionsPostRequestFormComponentsPaymentMethodRemoveX68c6af72>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1CustomerSessionsPostRequestFormComponentsCustomerSheetFeaturesX65d7888b,
        ) {
            val jsonEncoder =
...
public fun inlineV1CustomerSessionsPostRequestFormComponentsCustomerSheetFeaturesX65d7888b(
    block: InlineV1CustomerSessionsPostRequestFormComponentsCustomerSheetFeaturesX65d7888b.Builder.() -> Unit,
): InlineV1CustomerSessionsPostRequestFormComponentsCustomerSheetFeaturesX65d7888b =
    InlineV1CustomerSessionsPostRequestFormComponentsCustomerSheetFeaturesX65d7888b.build(block)
