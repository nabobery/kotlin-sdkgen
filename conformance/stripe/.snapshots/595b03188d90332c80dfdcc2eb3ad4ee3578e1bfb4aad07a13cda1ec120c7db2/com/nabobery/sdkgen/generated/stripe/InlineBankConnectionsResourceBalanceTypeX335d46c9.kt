...
public sealed class InlineBankConnectionsResourceBalanceTypeX335d46c9 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineBankConnectionsResourceBalanceTypeX335d46c9 =
            when (value) {
                Cash.value -> Cash
                Credit.value -> Credit
    ...
    public object Serializer : KSerializer<InlineBankConnectionsResourceBalanceTypeX335d46c9> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineBankConnectionsResourceBalanceTypeX335d46c9",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineBankConnectionsResourceBalanceTypeX335d46c9 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineBankConnectionsResourceBalanceTypeX335d46c9,
        ) {
