...
public sealed class InlineV1SetupIntentsPostRequestFormAmountIncludesIofX556c736b {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1SetupIntentsPostRequestFormAmountIncludesIofX556c736b =
            when (value) {
                Always.value -> Always
                Never.value -> Never
    ...
    public object Serializer : KSerializer<InlineV1SetupIntentsPostRequestFormAmountIncludesIofX556c736b> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1SetupIntentsPostRequestFormAmountIncludesIofX556c736b",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1SetupIntentsPostRequestFormAmountIncludesIofX556c736b =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SetupIntentsPostRequestFormAmountIncludesIofX556c736b,
        ) {
