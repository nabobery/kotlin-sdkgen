...
internal data class InlineV1AccountsPeoplePostRequestFormDocumentsCompanyAuthorizationItemXa7aea919Inspection(
    ...
    public val matchCount: Int
        get() =
            listOf(
                matchesBranch1,
                matchesInlineV1AccountsPeoplePostRequestFormDocumentsAnyOf2X2a9aa74d,
            ).count { it }
}
...
public class InlineV1AccountsPeoplePostRequestFormDocumentsCompanyAuthorizationItemXa7aea919 internal constructor(
    ...
    private val inspection: InlineV1AccountsPeoplePostRequestFormDocumentsCompanyAuthorizationItemXa7aea919Inspection,
) {
    ...
    public val inlineV1AccountsPeoplePostRequestFormDocumentsAnyOf2X2a9aa74d:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1AccountsPeoplePostRequestFormDocumentsAnyOf2X2a9aa74d) {
                json
                    .decodeFromJsonElement<InlineV1AccountsPeoplePostRequestFormDocumentsAnyOf2X2a9aa74d>(
                        raw,
                    )
            } else {
                null
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineV1AccountsPeoplePostRequestFormDocumentsCompanyAuthorizationItemXa7aea919Branch.Branch1,
                    )
                }
                if (inspection.matchesInlineV1AccountsPeoplePostRequestFormDocumentsAnyOf2X2a9aa74d) {
                    add(
                        InlineV1AccountsPeoplePostRequestFormDocumentsCompanyAuthorizationItemXa7aea919Branch.InlineV1AccountsPeoplePostRequestFormDocumentsAnyOf2X2a9aa74d,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1AccountsPeoplePostRequestFormDocumentsCompanyAuthorizationItemXa7aea919 {
            val inspection = inspectInlineV1AccountsPeoplePostRequestFormDocumentsCompanyAuthorizationItemXa7aea919(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1AccountsPeoplePostRequestFormDocumentsCompanyAuthorizationItemXa7aea919NoMatchException(
                    "InlineV1AccountsPeoplePostRequestFormDocumentsCompanyAuthorizationItemXa7aea919 matched 0 branches: " +
                        inspection.failures.joinToString("; "),
                )
            }
            return InlineV1AccountsPeoplePostRequestFormDocumentsCompanyAuthorizationItemXa7aea919(
                raw,
                json,
                inspection,
            )
    ...
    public object Serializer : KSerializer<InlineV1AccountsPeoplePostRequestFormDocumentsCompanyAuthorizationItemXa7aea919> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPeoplePostRequestFormDocumentsCompanyAuthorizationItemXa7aea919,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1AccountsPeoplePostRequestFormDocumentsCompanyAuthorizationItemXa7aea919",
...
private fun inspectInlineV1AccountsPeoplePostRequestFormDocumentsCompanyAuthorizationItemXa7aea919(
    element: JsonElement,
): InlineV1AccountsPeoplePostRequestFormDocumentsCompanyAuthorizationItemXa7aea919Inspection {
    val matchesBranch1 = element.isJsonDecodable<String>()
    val matchesInlineV1AccountsPeoplePostRequestFormDocumentsAnyOf2X2a9aa74d =
        element
            .isJsonDecodable<InlineV1AccountsPeoplePostRequestFormDocumentsAnyOf2X2a9aa74d>()
    return InlineV1AccountsPeoplePostRequestFormDocumentsCompanyAuthorizationItemXa7aea919Inspection(
        ...
        failures =
            buildList {
                ...
                if (!matchesInlineV1AccountsPeoplePostRequestFormDocumentsAnyOf2X2a9aa74d) {
                    add(
                        "InlineV1AccountsPeoplePostRequestFormDocumentsAnyOf2X2a9aa74d: value does not match InlineV1AccountsPeoplePostRequestFormDocumentsAnyOf2X2a9aa74d",
                    )
                }
            },
    )
