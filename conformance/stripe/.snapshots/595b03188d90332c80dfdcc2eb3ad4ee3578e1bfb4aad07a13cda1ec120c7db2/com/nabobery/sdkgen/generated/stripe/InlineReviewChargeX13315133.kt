...
public class InlineReviewChargeX13315133 internal constructor(
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineReviewChargeX13315133 {
            val inspection = inspectInlineReviewChargeX13315133(raw)
            if (inspection.matchCount == 0) {
                throw InlineReviewChargeX13315133NoMatchException(
                    "InlineReviewChargeX13315133 matched 0 branches: " + inspection.failures.joinToString("; "),
                )
            }
    ...
    public object Serializer : KSerializer<InlineReviewChargeX13315133> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineReviewChargeX13315133,
        ) {
