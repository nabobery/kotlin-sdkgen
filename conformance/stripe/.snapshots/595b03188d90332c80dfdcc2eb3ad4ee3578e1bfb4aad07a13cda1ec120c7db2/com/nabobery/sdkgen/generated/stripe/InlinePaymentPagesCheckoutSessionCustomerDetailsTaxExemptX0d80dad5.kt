...
public sealed class InlinePaymentPagesCheckoutSessionCustomerDetailsTaxExemptX0d80dad5 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentPagesCheckoutSessionCustomerDetailsTaxExemptX0d80dad5 =
            when (value) {
                Exempt.value -> Exempt
                None.value -> None
    ...
    public object Serializer : KSerializer<InlinePaymentPagesCheckoutSessionCustomerDetailsTaxExemptX0d80dad5> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentPagesCheckoutSessionCustomerDetailsTaxExemptX0d80dad5",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePaymentPagesCheckoutSessionCustomerDetailsTaxExemptX0d80dad5 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentPagesCheckoutSessionCustomerDetailsTaxExemptX0d80dad5,
        ) {
