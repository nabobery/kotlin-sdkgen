...
public class AccountCapabilities(
     ...
     * Clearpay charges.
     */
    public val afterpayClearpayPayments: InlineAccountCapabilitiesAfterpayClearpayPaymentsXb5295fb7? = null,
    /**
     ...
     */
    public val cartesBancairesPayments: InlineAccountCapabilitiesCartesBancairesPaymentsX839701e3? = null,
    /**
     ...
     */
    public val gbBankTransferPayments: InlineAccountCapabilitiesGbBankTransferPaymentsX277a5067? = null,
    /**
     ...
     */
    public val indiaInternationalPayments: InlineAccountCapabilitiesIndiaInternationalPaymentsX739ccc58? = null,
    /**
     ...
     */
    public val jpBankTransferPayments: InlineAccountCapabilitiesJpBankTransferPaymentsXf08aab54? = null,
    /**
     ...
     */
    public val mxBankTransferPayments: InlineAccountCapabilitiesMxBankTransferPaymentsX2a9ab982? = null,
    /**
     ...
     */
    public val nzBankAccountBecsDebitPayments: InlineAccountCapabilitiesNzBankAccountBecsDebitPaymentsX3e997848? = null,
    /**
     ...
     */
    public val sepaBankTransferPayments: InlineAccountCapabilitiesSepaBankTransferPaymentsX9cfc437e? = null,
    /**
     ...
     */
    public val taxReportingUs1099Misc: InlineAccountCapabilitiesTaxReportingUs1099MiscX0df3d0a4? = null,
    /**
     ...
     */
    public val usBankAccountAchPayments: InlineAccountCapabilitiesUsBankAccountAchPaymentsXe23b6dee? = null,
    /**
     ...
     */
    public val usBankTransferPayments: InlineAccountCapabilitiesUsBankTransferPaymentsXbbe78834? = null,
    /**
    ...
    public class Builder {
        ...
        public fun build(): AccountCapabilities =
            AccountCapabilities(
    ...
    public object Serializer : KSerializer<AccountCapabilities> {
        ...
        override fun deserialize(decoder: Decoder): AccountCapabilities {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("AccountCapabilities must be a JSON object")
            return AccountCapabilities(
                acssDebitPayments =
                    rawObject["acss_debit_payments"]?.let {
                        json.decodeFromJsonElement<InlineAccountCapabilitiesAcssDebitPaymentsX9230943b>(it)
                    },
                affirmPayments =
                    rawObject["affirm_payments"]?.let {
                        json.decodeFromJsonElement<InlineAccountCapabilitiesAffirmPaymentsX27b94e41>(it)
                    },
                afterpayClearpayPayments =
                    rawObject["afterpay_clearpay_payments"]?.let {
                        json.decodeFromJsonElement<InlineAccountCapabilitiesAfterpayClearpayPaymentsXb5295fb7>(it)
                    },
                almaPayments =
                    rawObject["alma_payments"]?.let {
                        json.decodeFromJsonElement<InlineAccountCapabilitiesAlmaPaymentsXf85c336d>(it)
                    },
                amazonPayPayments =
                    rawObject["amazon_pay_payments"]?.let {
                        json.decodeFromJsonElement<InlineAccountCapabilitiesAmazonPayPaymentsXefe1641d>(it)
                    },
                appDistribution =
                    rawObject["app_distribution"]?.let {
                        json.decodeFromJsonElement<InlineAccountCapabilitiesAppDistributionX29b556d0>(it)
                    },
                auBecsDebitPayments =
                    rawObject["au_becs_debit_payments"]?.let {
                        json.decodeFromJsonElement<InlineAccountCapabilitiesAuBecsDebitPaymentsXf2a0004f>(it)
                    },
                bacsDebitPayments =
                    rawObject["bacs_debit_payments"]?.let {
                        json.decodeFromJsonElement<InlineAccountCapabilitiesBacsDebitPaymentsX656445cd>(it)
                    },
                bancontactPayments =
                    rawObject["bancontact_payments"]?.let {
                        json.decodeFromJsonElement<InlineAccountCapabilitiesBancontactPaymentsXba86145d>(it)
                    },
                bankTransferPayments =
                    rawObject["bank_transfer_payments"]?.let {
                        json.decodeFromJsonElement<InlineAccountCapabilitiesBankTransferPaymentsX22b0b51c>(it)
                    },
                billiePayments =
                    rawObject["billie_payments"]?.let {
                        json.decodeFromJsonElement<InlineAccountCapabilitiesBilliePaymentsX11afbe60>(it)
                    },
                bizumPayments =
                    rawObject["bizum_payments"]?.let {
                        json.decodeFromJsonElement<InlineAccountCapabilitiesBizumPaymentsX8f9e0a66>(it)
                    },
                blikPayments =
                    rawObject["blik_payments"]?.let {
                        json.decodeFromJsonElement<InlineAccountCapabilitiesBlikPaymentsXccd9d2f2>(it)
                    },
                boletoPayments =
                    rawObject["boleto_payments"]?.let {
                        json.decodeFromJsonElement<InlineAccountCapabilitiesBoletoPaymentsX12b24742>(it)
                    },
                cardIssuing =
                    rawObject["card_issuing"]?.let {
                        json.decodeFromJsonElement<InlineAccountCapabilitiesCardIssuingX84b0d7d1>(it)
                    },
                cardPayments =
                    rawObject["card_payments"]?.let {
                        json.decodeFromJsonElement<InlineAccountCapabilitiesCardPaymentsX303e4dae>(it)
                    },
                cartesBancairesPayments =
                    rawObject["cartes_bancaires_payments"]
                        ?.let {
                            json.decodeFromJsonElement<InlineAccountCapabilitiesCartesBancairesPaymentsX839701e3>(it)
                        },
                cashappPayments =
                    rawObject["cashapp_payments"]
                        ?.let {
                            json.decodeFromJsonElement<InlineAccountCapabilitiesCashappPaymentsXf1cb2861>(it)
                        },
                cryptoPayments =
                    rawObject["crypto_payments"]
                        ?.let {
                            json.decodeFromJsonElement<InlineAccountCapabilitiesCryptoPaymentsXa11984a6>(it)
                        },
                epsPayments =
                    rawObject["eps_payments"]
                        ?.let {
                            json.decodeFromJsonElement<InlineAccountCapabilitiesEpsPaymentsX4ad26a74>(it)
                        },
                fpxPayments =
                    rawObject["fpx_payments"]
                        ?.let {
                            json.decodeFromJsonElement<InlineAccountCapabilitiesFpxPaymentsX8ac2b899>(it)
                        },
                gbBankTransferPayments =
                    rawObject["gb_bank_transfer_payments"]
                        ?.let {
                            json.decodeFromJsonElement<InlineAccountCapabilitiesGbBankTransferPaymentsX277a5067>(it)
                        },
                giropayPayments =
                    rawObject["giropay_payments"]
                        ?.let {
                            json.decodeFromJsonElement<InlineAccountCapabilitiesGiropayPaymentsX9c3ada7e>(it)
                        },
                grabpayPayments =
                    rawObject["grabpay_payments"]
                        ?.let {
                            json.decodeFromJsonElement<InlineAccountCapabilitiesGrabpayPaymentsX4fe9238c>(it)
                        },
                idealPayments =
                    rawObject["ideal_payments"]
                        ?.let {
                            json.decodeFromJsonElement<InlineAccountCapabilitiesIdealPaymentsXbb683bd9>(it)
                        },
                indiaInternationalPayments =
                    rawObject["india_international_payments"]
                        ?.let {
                            json.decodeFromJsonElement<InlineAccountCapabilitiesIndiaInternationalPaymentsX739ccc58>(it)
                        },
                jcbPayments =
                    rawObject["jcb_payments"]
                        ?.let {
                            json.decodeFromJsonElement<InlineAccountCapabilitiesJcbPaymentsXce99a2f0>(it)
                        },
                jpBankTransferPayments =
                    rawObject["jp_bank_transfer_payments"]
                        ?.let {
                            json.decodeFromJsonElement<InlineAccountCapabilitiesJpBankTransferPaymentsXf08aab54>(it)
                        },
                kakaoPayPayments =
                    rawObject["kakao_pay_payments"]
                        ?.let {
                            json.decodeFromJsonElement<InlineAccountCapabilitiesKakaoPayPaymentsXc2958402>(it)
                        },
                klarnaPayments =
                    rawObject["klarna_payments"]
                        ?.let {
                            json.decodeFromJsonElement<InlineAccountCapabilitiesKlarnaPaymentsX12f964c5>(it)
                        },
                konbiniPayments =
                    rawObject["konbini_payments"]
                        ?.let {
                            json.decodeFromJsonElement<InlineAccountCapabilitiesKonbiniPaymentsXae40db25>(it)
                        },
                krCardPayments =
                    rawObject["kr_card_payments"]
                        ?.let {
                            json.decodeFromJsonElement<InlineAccountCapabilitiesKrCardPaymentsXe49dbe6e>(it)
                        },
                legacyPayments =
                    rawObject["legacy_payments"]
                        ?.let {
                            json.decodeFromJsonElement<InlineAccountCapabilitiesLegacyPaymentsX98086295>(it)
                        },
                linkPayments =
                    rawObject["link_payments"]
                        ?.let {
                            json.decodeFromJsonElement<InlineAccountCapabilitiesLinkPaymentsXfb58cb1a>(it)
                        },
                mbWayPayments =
                    rawObject["mb_way_payments"]
                        ?.let {
                            json.decodeFromJsonElement<InlineAccountCapabilitiesMbWayPaymentsX82cdbce6>(it)
                        },
                mobilepayPayments =
                    rawObject["mobilepay_payments"]
                        ?.let {
                            json.decodeFromJsonElement<InlineAccountCapabilitiesMobilepayPaymentsXb3763aad>(it)
                        },
                multibancoPayments =
                    rawObject["multibanco_payments"]
                        ?.let {
                            json.decodeFromJsonElement<InlineAccountCapabilitiesMultibancoPaymentsX9247b418>(it)
                        },
                mxBankTransferPayments =
                    rawObject["mx_bank_transfer_payments"]
                        ?.let {
                            json.decodeFromJsonElement<InlineAccountCapabilitiesMxBankTransferPaymentsX2a9ab982>(it)
                        },
                naverPayPayments =
                    rawObject["naver_pay_payments"]
                        ?.let {
                            json.decodeFromJsonElement<InlineAccountCapabilitiesNaverPayPaymentsX4d152196>(it)
                        },
                nzBankAccountBecsDebitPayments =
                    rawObject["nz_bank_account_becs_debit_payments"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineAccountCapabilitiesNzBankAccountBecsDebitPaymentsX3e997848>(
                                    it,
                                )
                        },
                oxxoPayments =
                    rawObject["oxxo_payments"]
                        ?.let {
                            json.decodeFromJsonElement<InlineAccountCapabilitiesOxxoPaymentsX1aa67b0b>(it)
                        },
                p24Payments =
                    rawObject["p24_payments"]
                        ?.let {
                            json.decodeFromJsonElement<InlineAccountCapabilitiesP24PaymentsXe9b36672>(it)
                        },
                payByBankPayments =
                    rawObject["pay_by_bank_payments"]
                        ?.let {
                            json.decodeFromJsonElement<InlineAccountCapabilitiesPayByBankPaymentsX093ea529>(it)
                        },
                paycoPayments =
                    rawObject["payco_payments"]
                        ?.let {
                            json.decodeFromJsonElement<InlineAccountCapabilitiesPaycoPaymentsX7855c286>(it)
                        },
                paynowPayments =
                    rawObject["paynow_payments"]
                        ?.let {
                            json.decodeFromJsonElement<InlineAccountCapabilitiesPaynowPaymentsXdce3eda9>(it)
                        },
                paytoPayments =
                    rawObject["payto_payments"]
                        ?.let {
                            json.decodeFromJsonElement<InlineAccountCapabilitiesPaytoPaymentsX7aefdcaa>(it)
                        },
                pixPayments =
                    rawObject["pix_payments"]
                        ?.let {
                            json.decodeFromJsonElement<InlineAccountCapabilitiesPixPaymentsXac0ef8e1>(it)
                        },
                promptpayPayments =
                    rawObject["promptpay_payments"]
                        ?.let {
                            json.decodeFromJsonElement<InlineAccountCapabilitiesPromptpayPaymentsX63eae3ff>(it)
                        },
                revolutPayPayments =
                    rawObject["revolut_pay_payments"]
                        ?.let {
                            json.decodeFromJsonElement<InlineAccountCapabilitiesRevolutPayPaymentsX26d4ac94>(it)
                        },
                samsungPayPayments =
                    rawObject["samsung_pay_payments"]
                        ?.let {
                            json.decodeFromJsonElement<InlineAccountCapabilitiesSamsungPayPaymentsXe41ba902>(it)
                        },
                satispayPayments =
                    rawObject["satispay_payments"]
                        ?.let {
                            json.decodeFromJsonElement<InlineAccountCapabilitiesSatispayPaymentsXdb5d9f80>(it)
                        },
                scalapayPayments =
                    rawObject["scalapay_payments"]
                        ?.let {
                            json.decodeFromJsonElement<InlineAccountCapabilitiesScalapayPaymentsX3cd8a7f4>(it)
                        },
                sepaBankTransferPayments =
                    rawObject["sepa_bank_transfer_payments"]
                        ?.let {
                            json.decodeFromJsonElement<InlineAccountCapabilitiesSepaBankTransferPaymentsX9cfc437e>(it)
                        },
                sepaDebitPayments =
                    rawObject["sepa_debit_payments"]
                        ?.let {
                            json.decodeFromJsonElement<InlineAccountCapabilitiesSepaDebitPaymentsX2c568d4f>(it)
                        },
                sofortPayments =
                    rawObject["sofort_payments"]
                        ?.let {
                            json.decodeFromJsonElement<InlineAccountCapabilitiesSofortPaymentsX833a4c46>(it)
                        },
                sunbitPayments =
                    rawObject["sunbit_payments"]
                        ?.let {
                            json.decodeFromJsonElement<InlineAccountCapabilitiesSunbitPaymentsX2f50af72>(it)
                        },
                swishPayments =
                    rawObject["swish_payments"]
                        ?.let {
                            json.decodeFromJsonElement<InlineAccountCapabilitiesSwishPaymentsX7f4ed8cd>(it)
                        },
                taxReportingUs1099K =
                    rawObject["tax_reporting_us_1099_k"]
                        ?.let {
                            json.decodeFromJsonElement<InlineAccountCapabilitiesTaxReportingUs1099KXb46ba7e9>(it)
                        },
                taxReportingUs1099Misc =
                    rawObject["tax_reporting_us_1099_misc"]
                        ?.let {
                            json.decodeFromJsonElement<InlineAccountCapabilitiesTaxReportingUs1099MiscX0df3d0a4>(it)
                        },
                transfers =
                    rawObject["transfers"]
                        ?.let {
                            json
                                .decodeFromJsonElement<InlineAccountCapabilitiesTransfersXf1e84c29>(
                                    it,
                                )
                        },
                treasury =
                    rawObject["treasury"]
                        ?.let {
                            json.decodeFromJsonElement<InlineAccountCapabilitiesTreasuryX4b955612>(
                                it,
                            )
                        },
                twintPayments =
                    rawObject["twint_payments"]
                        ?.let {
                            json.decodeFromJsonElement<InlineAccountCapabilitiesTwintPaymentsXa9dbfff6>(it)
                        },
                upiPayments =
                    rawObject["upi_payments"]
                        ?.let {
                            json.decodeFromJsonElement<InlineAccountCapabilitiesUpiPaymentsXaa0dc75d>(it)
                        },
                usBankAccountAchPayments =
                    rawObject["us_bank_account_ach_payments"]
                        ?.let {
                            json.decodeFromJsonElement<InlineAccountCapabilitiesUsBankAccountAchPaymentsXe23b6dee>(it)
                        },
                usBankTransferPayments =
                    rawObject["us_bank_transfer_payments"]
                        ?.let {
                            json.decodeFromJsonElement<InlineAccountCapabilitiesUsBankTransferPaymentsXbbe78834>(it)
                        },
                zipPayments =
                    rawObject["zip_payments"]
                        ?.let {
                            json.decodeFromJsonElement<InlineAccountCapabilitiesZipPaymentsXbb9872a8>(it)
                        },
            )
        }
...
public fun accountCapabilities(block: AccountCapabilities.Builder.() -> Unit): AccountCapabilities =
    AccountCapabilities.build(block)
