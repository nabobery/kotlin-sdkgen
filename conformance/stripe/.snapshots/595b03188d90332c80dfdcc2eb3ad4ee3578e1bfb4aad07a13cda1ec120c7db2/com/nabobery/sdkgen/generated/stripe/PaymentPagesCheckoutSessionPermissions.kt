...
public data class PaymentPagesCheckoutSessionPermissionsView(
    ...
    public val updateShippingDetails: InlinePaymentPagesCheckoutSessionPermissionsUpdateShippingDetailsXf0320c3f? = null,
)
...
public class PaymentPagesCheckoutSessionPermissions(
    ...
    public class Builder {
        ...
        public fun build(): PaymentPagesCheckoutSessionPermissions =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentPagesCheckoutSessionPermissions =
    ...
    public object Serializer : KSerializer<PaymentPagesCheckoutSessionPermissions> {
        ...
        override fun deserialize(decoder: Decoder): PaymentPagesCheckoutSessionPermissions {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentPagesCheckoutSessionPermissions must be a JSON object")
            return PaymentPagesCheckoutSessionPermissions(
                updateShippingDetails =
                    rawObject["update_shipping_details"]?.let { element ->
                        if (element ==
                            JsonNull
                        ) {
                            null
                            ...
                            json
                                .decodeFromJsonElement<InlinePaymentPagesCheckoutSessionPermissionsUpdateShippingDetailsXf0320c3f?>(
                                    element,
                                )
                        }
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentPagesCheckoutSessionPermissions,
        ) {
...
public fun paymentPagesCheckoutSessionPermissions(
    block: PaymentPagesCheckoutSessionPermissions.Builder.() -> Unit,
): PaymentPagesCheckoutSessionPermissions = PaymentPagesCheckoutSessionPermissions.build(block)
