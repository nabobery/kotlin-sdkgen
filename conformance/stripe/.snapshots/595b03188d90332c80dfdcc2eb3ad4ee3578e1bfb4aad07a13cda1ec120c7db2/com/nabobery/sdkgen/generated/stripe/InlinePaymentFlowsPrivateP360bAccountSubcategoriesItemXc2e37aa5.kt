...
public sealed class InlinePaymentFlowsPrivateP360bAccountSubcategoriesItemXc2e37aa5 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlinePaymentFlowsPrivateP360bAccountSubcategoriesItemXc2e37aa5 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlinePaymentFlowsPrivateP360bAccountSubcategoriesItemXc2e37aa5> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlinePaymentFlowsPrivateP360bAccountSubcategoriesItemXc2e37aa5",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlinePaymentFlowsPrivateP360bAccountSubcategoriesItemXc2e37aa5 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlinePaymentFlowsPrivateP360bAccountSubcategoriesItemXc2e37aa5,
        ) {
