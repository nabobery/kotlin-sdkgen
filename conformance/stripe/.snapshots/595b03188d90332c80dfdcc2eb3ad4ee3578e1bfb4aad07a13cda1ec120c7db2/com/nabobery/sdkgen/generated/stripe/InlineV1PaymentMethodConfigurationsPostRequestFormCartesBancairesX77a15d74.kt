...
public class InlineV1PaymentMethodConfigurationsPostRequestFormCartesBancairesX77a15d74(
    public val displayPreference: InlineV1PaymentMethodConfidc49PostRequestFormDisplayPreferenceXb25072db? = null,
) {
    public class Builder {
        public var displayPreference:
            InlineV1PaymentMethodConfidc49PostRequestFormDisplayPreferenceXb25072db? = null

        public fun build(): InlineV1PaymentMethodConfigurationsPostRequestFormCartesBancairesX77a15d74 =
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentMethodConfigurationsPostRequestFormCartesBancairesX77a15d74 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1PaymentMethodConfigurationsPostRequestFormCartesBancairesX77a15d74> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentMethodConfigurationsPostRequestFormCartesBancairesX77a15d74 must be a JSON object",
                    )
            return InlineV1PaymentMethodConfigurationsPostRequestFormCartesBancairesX77a15d74(
                displayPreference =
                    rawObject["display_preference"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentMethodConfidc49PostRequestFormDisplayPreferenceXb25072db>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentMethodConfigurationsPostRequestFormCartesBancairesX77a15d74,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentMethodConfigurationsPostRequestFormCartesBancairesX77a15d74(
    block: InlineV1PaymentMethodConfigurationsPostRequestFormCartesBancairesX77a15d74.Builder.() -> Unit,
): InlineV1PaymentMethodConfigurationsPostRequestFormCartesBancairesX77a15d74 =
    InlineV1PaymentMethodConfigurationsPostRequestFormCartesBancairesX77a15d74.build(block)
