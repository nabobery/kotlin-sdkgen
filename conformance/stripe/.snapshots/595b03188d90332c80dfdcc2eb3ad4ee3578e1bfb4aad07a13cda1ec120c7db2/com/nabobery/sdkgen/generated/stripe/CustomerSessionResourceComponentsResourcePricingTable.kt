...
public class CustomerSessionResourceComponentsResourcePricingTable(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): CustomerSessionResourceComponentsResourcePricingTable =
    ...
    public object Serializer : KSerializer<CustomerSessionResourceComponentsResourcePricingTable> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "CustomerSessionResourceComponentsResourcePricingTable must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: CustomerSessionResourceComponentsResourcePricingTable,
        ) {
...
public fun customerSessionResourceComponentsResourcePricingTable(
    block: CustomerSessionResourceComponentsResourcePricingTable.Builder.() -> Unit,
): CustomerSessionResourceComponentsResourcePricingTable =
    CustomerSessionResourceComponentsResourcePricingTable.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "CustomerSessionResourceComponentsResourcePricingTable is missing required property '" + name + "'",
            )
