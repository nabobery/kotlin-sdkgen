...
public sealed class InlineIssuingCardObjectValueXeecda8e4 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineIssuingCardObjectValueXeecda8e4 =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineIssuingCardObjectValueXeecda8e4> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineIssuingCardObjectValueXeecda8e4",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineIssuingCardObjectValueXeecda8e4 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineIssuingCardObjectValueXeecda8e4,
        ) {
