...
public class ClimateSupplier(
    ...
    public class Builder {
        ...
        public var locations: List<ClimateRemovalsLocation>
            get() = requireNotNull(locationsValue) { "locations is required" }
            set(`value`) {
    ...
    public object Serializer : KSerializer<ClimateSupplier> {
        ...
        override fun deserialize(decoder: Decoder): ClimateSupplier {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("ClimateSupplier must be a JSON object")
            ...
            val removalPathway =
                json.decodeRequired<InlineClimateSupplierRemovalPathwayXc4cf9412>(
                    rawObject,
                    "removal_pathway",
                )
            return ClimateSupplier(
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("ClimateSupplier is missing required property '" + name + "'")
