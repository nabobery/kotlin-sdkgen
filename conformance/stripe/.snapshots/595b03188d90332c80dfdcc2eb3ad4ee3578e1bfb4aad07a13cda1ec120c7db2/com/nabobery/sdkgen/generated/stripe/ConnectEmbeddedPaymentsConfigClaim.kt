...
public class ConnectEmbeddedPaymentsConfigClaim(
    ...
    public object Serializer : KSerializer<ConnectEmbeddedPaymentsConfigClaim> {
        ...
        override fun deserialize(decoder: Decoder): ConnectEmbeddedPaymentsConfigClaim {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("ConnectEmbeddedPaymentsConfigClaim must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: ConnectEmbeddedPaymentsConfigClaim,
        ) {
...
public fun connectEmbeddedPaymentsConfigClaim(
    block: ConnectEmbeddedPaymentsConfigClaim.Builder.() -> Unit,
): ConnectEmbeddedPaymentsConfigClaim = ConnectEmbeddedPaymentsConfigClaim.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "ConnectEmbeddedPaymentsConfigClaim is missing required property '" + name + "'",
            )
