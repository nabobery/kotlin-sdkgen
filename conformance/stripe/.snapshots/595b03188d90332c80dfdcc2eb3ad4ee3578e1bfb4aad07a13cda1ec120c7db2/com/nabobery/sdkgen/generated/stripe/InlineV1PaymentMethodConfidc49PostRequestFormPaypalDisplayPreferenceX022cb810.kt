...
public class InlineV1PaymentMethodConfidc49PostRequestFormPaypalDisplayPreferenceX022cb810(
    public val preference: InlineV1PaymentMethodConfidc49PostRequestFormPaypalPreferenceX7becd660? = null,
) {
    public class Builder {
        public var preference: InlineV1PaymentMethodConfidc49PostRequestFormPaypalPreferenceX7becd660? =
            null

        public fun build(): InlineV1PaymentMethodConfidc49PostRequestFormPaypalDisplayPreferenceX022cb810 =
            InlineV1PaymentMethodConfidc49PostRequestFormPaypalDisplayPreferenceX022cb810(
    ...
    public object Serializer : KSerializer<InlineV1PaymentMethodConfidc49PostRequestFormPaypalDisplayPreferenceX022cb810> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentMethodConfidc49PostRequestFormPaypalDisplayPreferenceX022cb810 must be a JSON object",
                    )
            return InlineV1PaymentMethodConfidc49PostRequestFormPaypalDisplayPreferenceX022cb810(
                preference =
                    rawObject["preference"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1PaymentMethodConfidc49PostRequestFormPaypalPreferenceX7becd660>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentMethodConfidc49PostRequestFormPaypalDisplayPreferenceX022cb810,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentMethodConfidc49PostRequestFormPaypalDisplayPreferenceX022cb810(
    block: InlineV1PaymentMethodConfidc49PostRequestFormPaypalDisplayPreferenceX022cb810.Builder.() -> Unit,
): InlineV1PaymentMethodConfidc49PostRequestFormPaypalDisplayPreferenceX022cb810 =
