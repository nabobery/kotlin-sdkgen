...
public class PaymentMethodDetailsPaymentRecordCashapp(
    ...
    public class Builder {
        ...
        public fun build(): PaymentMethodDetailsPaymentRecordCashapp =
            PaymentMethodDetailsPaymentRecordCashapp(
                buyerId = buyerId,
                cashtag = cashtag,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentMethodDetailsPaymentRecordCashapp =
    ...
    public object Serializer : KSerializer<PaymentMethodDetailsPaymentRecordCashapp> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodDetailsPaymentRecordCashapp {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodDetailsPaymentRecordCashapp must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentMethodDetailsPaymentRecordCashapp,
        ) {
...
public fun paymentMethodDetailsPaymentRecordCashapp(
    block: PaymentMethodDetailsPaymentRecordCashapp.Builder.() -> Unit,
): PaymentMethodDetailsPaymentRecordCashapp = PaymentMethodDetailsPaymentRecordCashapp.build(block)
