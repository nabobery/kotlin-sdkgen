...
public class PromotionCodesResourcePromotion(
    ...
    public object Serializer : KSerializer<PromotionCodesResourcePromotion> {
        ...
        override fun deserialize(decoder: Decoder): PromotionCodesResourcePromotion {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PromotionCodesResourcePromotion must be a JSON object")
                ...
                coupon =
                    rawObject["coupon"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePromotionCodesResourcePromotionCouponX428da822?>(element)
                        }
                    },
            )
        }
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PromotionCodesResourcePromotion,
        ) {
...
public fun promotionCodesResourcePromotion(
    block: PromotionCodesResourcePromotion.Builder.() -> Unit,
): PromotionCodesResourcePromotion = PromotionCodesResourcePromotion.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "PromotionCodesResourcePromotion is missing required property '" + name + "'",
            )
