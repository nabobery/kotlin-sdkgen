...
public class InlineV1WebhookEndpointsPostRequestFormX13dfd1de(
     ...
     */
    public val enabledEvents: List<InlineV1WebhookEndpointsPostRequestFormEnabledEventsItemXcac7d4cd>? = null,
    /**
    ...
    public class Builder {
        ...
        public fun build(): InlineV1WebhookEndpointsPostRequestFormX13dfd1de =
            InlineV1WebhookEndpointsPostRequestFormX13dfd1de(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1WebhookEndpointsPostRequestFormX13dfd1de =
    ...
    public object Serializer : KSerializer<InlineV1WebhookEndpointsPostRequestFormX13dfd1de> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1WebhookEndpointsPostRequestFormX13dfd1de must be a JSON object",
                    )
            return InlineV1WebhookEndpointsPostRequestFormX13dfd1de(
                description =
                    rawObject["description"]?.let {
                        json.decodeFromJsonElement<InlineV1WebhookEndpointsPostRequestFormDescriptionX70ce9be6>(it)
                    },
                disabled = rawObject["disabled"]?.let { json.decodeFromJsonElement<Boolean>(it) },
                enabledEvents =
                    rawObject["enabled_events"]?.let {
                        json
                            .decodeFromJsonElement<List<InlineV1WebhookEndpointsPostRequestFormEnabledEventsItemXcac7d4cd>>(
                                it,
                            )
                    },
                ...
                metadata =
                    rawObject["metadata"]?.let {
                        json.decodeFromJsonElement<InlineV1WebhookEndpointsPostRequestFormMetadataXee719122>(it)
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1WebhookEndpointsPostRequestFormX13dfd1de,
        ) {
...
public fun inlineV1WebhookEndpointsPostRequestFormX13dfd1de(
    block: InlineV1WebhookEndpointsPostRequestFormX13dfd1de.Builder.() -> Unit,
): InlineV1WebhookEndpointsPostRequestFormX13dfd1de = InlineV1WebhookEndpointsPostRequestFormX13dfd1de.build(block)
