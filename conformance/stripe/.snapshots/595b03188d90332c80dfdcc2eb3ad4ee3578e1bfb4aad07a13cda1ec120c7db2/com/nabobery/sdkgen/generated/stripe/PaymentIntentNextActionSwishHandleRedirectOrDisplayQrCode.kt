...
public class PaymentIntentNextActionSwishHandleRedirectOrDisplayQrCode(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentIntentNextActionSwishHandleRedirectOrDisplayQrCode =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentIntentNextActionSwishHandleRedirectOrDisplayQrCode> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "PaymentIntentNextActionSwishHandleRedirectOrDisplayQrCode must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentIntentNextActionSwishHandleRedirectOrDisplayQrCode,
        ) {
...
public fun paymentIntentNextActionSwishHandleRedirectOrDisplayQrCode(
    block: PaymentIntentNextActionSwishHandleRedirectOrDisplayQrCode.Builder.() -> Unit,
): PaymentIntentNextActionSwishHandleRedirectOrDisplayQrCode =
    PaymentIntentNextActionSwishHandleRedirectOrDisplayQrCode.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "PaymentIntentNextActionSwishHandleRedirectOrDisplayQrCode is missing required property '" + name + "'",
            )
