...
public class InlineV1SubscriptionSchedulesGetParameterX1be8e61a internal constructor(
    ...
    public val inlineV1SubscriptionSchedulesGetParameterAnyOf1Xc996ad31:
        ...
        lazy(LazyThreadSafetyMode.NONE) {
            if (inspection.matchesInlineV1SubscriptionSchedulesGetParameterAnyOf1Xc996ad31) {
                json
                    .decodeFromJsonElement<InlineV1SubscriptionSchedulesGetParameterAnyOf1Xc996ad31>(
                        raw,
                    )
            } else {
                null
    ...
    public val matchedBranches: Set<InlineV1SubscriptionSchedulesGetParameterX1be8e61aBranch>
        get() =
            buildSet {
                if (inspection.matchesInlineV1SubscriptionSchedulesGetParameterAnyOf1Xc996ad31) {
                    add(
                        InlineV1SubscriptionSchedulesGetParameterX1be8e61aBranch.InlineV1SubscriptionSchedulesGetParameterAnyOf1Xc996ad31,
                    )
                }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineV1SubscriptionSchedulesGetParameterX1be8e61a {
            val inspection = inspectInlineV1SubscriptionSchedulesGetParameterX1be8e61a(raw)
            if (inspection.matchCount == 0) {
                throw InlineV1SubscriptionSchedulesGetParameterX1be8e61aNoMatchException(
                    "InlineV1SubscriptionSchedulesGetParameterX1be8e61a matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineV1SubscriptionSchedulesGetParameterX1be8e61a> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SubscriptionSchedulesGetParameterX1be8e61a,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineV1SubscriptionSchedulesGetParameterX1be8e61a",
...
private fun inspectInlineV1SubscriptionSchedulesGetParameterX1be8e61a(
    element: JsonElement,
): InlineV1SubscriptionSchedulesGetParameterX1be8e61aInspection {
    val matchesInlineV1SubscriptionSchedulesGetParameterAnyOf1Xc996ad31 =
        element
            .isJsonDecodable<InlineV1SubscriptionSchedulesGetParameterAnyOf1Xc996ad31>()
    ...
    return InlineV1SubscriptionSchedulesGetParameterX1be8e61aInspection(
        ...
        failures =
            buildList {
                if (!matchesInlineV1SubscriptionSchedulesGetParameterAnyOf1Xc996ad31) {
                    add(
                        "InlineV1SubscriptionSchedulesGetParameterAnyOf1Xc996ad31: value does not match InlineV1SubscriptionSchedulesGetParameterAnyOf1Xc996ad31",
                    )
                }
