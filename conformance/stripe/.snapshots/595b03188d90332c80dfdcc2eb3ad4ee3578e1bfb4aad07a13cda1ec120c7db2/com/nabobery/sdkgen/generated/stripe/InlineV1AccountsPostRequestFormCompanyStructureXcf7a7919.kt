...
public sealed class InlineV1AccountsPostRequestFormCompanyStructureXcf7a7919 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1AccountsPostRequestFormCompanyStructureXcf7a7919 =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1AccountsPostRequestFormCompanyStructureXcf7a7919> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1AccountsPostRequestFormCompanyStructureXcf7a7919",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1AccountsPostRequestFormCompanyStructureXcf7a7919 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1AccountsPostRequestFormCompanyStructureXcf7a7919,
        ) {
