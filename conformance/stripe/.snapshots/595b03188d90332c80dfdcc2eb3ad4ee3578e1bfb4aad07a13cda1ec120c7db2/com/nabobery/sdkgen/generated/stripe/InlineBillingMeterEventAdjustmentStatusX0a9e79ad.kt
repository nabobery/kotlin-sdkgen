...
public sealed class InlineBillingMeterEventAdjustmentStatusX0a9e79ad {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineBillingMeterEventAdjustmentStatusX0a9e79ad =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineBillingMeterEventAdjustmentStatusX0a9e79ad> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineBillingMeterEventAdjustmentStatusX0a9e79ad",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineBillingMeterEventAdjustmentStatusX0a9e79ad =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineBillingMeterEventAdjustmentStatusX0a9e79ad,
        ) {
