...
public class InlineV1SetupIntentsConfirmPostRequestFormBillingDetailsXc59ec639(
    public val address: InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodDataAddressXa3bec209? = null,
    public val email: InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodDataEmailXe67bf473? = null,
    public val name: InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodDataNameXde50d1ea? = null,
    public val phone: InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodDataPhoneXf1170165? = null,
    ...
    public class Builder {
        ...
        public fun build(): InlineV1SetupIntentsConfirmPostRequestFormBillingDetailsXc59ec639 =
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1SetupIntentsConfirmPostRequestFormBillingDetailsXc59ec639 =
    ...
    public object Serializer : KSerializer<InlineV1SetupIntentsConfirmPostRequestFormBillingDetailsXc59ec639> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1SetupIntentsConfirmPostRequestFormBillingDetailsXc59ec639 must be a JSON object",
                    )
            return InlineV1SetupIntentsConfirmPostRequestFormBillingDetailsXc59ec639(
                address =
                    rawObject["address"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodDataAddressXa3bec209>(
                                it,
                            )
                    },
                email =
                    rawObject["email"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodDataEmailXe67bf473>(
                                it,
                            )
                    },
                name =
                    rawObject["name"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodDataNameXde50d1ea>(
                                it,
                            )
                    },
                phone =
                    rawObject["phone"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodDataPhoneXf1170165>(
                                it,
                            )
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1SetupIntentsConfirmPostRequestFormBillingDetailsXc59ec639,
        ) {
            val jsonEncoder =
...
public fun inlineV1SetupIntentsConfirmPostRequestFormBillingDetailsXc59ec639(
    block: InlineV1SetupIntentsConfirmPostRequestFormBillingDetailsXc59ec639.Builder.() -> Unit,
): InlineV1SetupIntentsConfirmPostRequestFormBillingDetailsXc59ec639 =
    InlineV1SetupIntentsConfirmPostRequestFormBillingDetailsXc59ec639.build(block)
