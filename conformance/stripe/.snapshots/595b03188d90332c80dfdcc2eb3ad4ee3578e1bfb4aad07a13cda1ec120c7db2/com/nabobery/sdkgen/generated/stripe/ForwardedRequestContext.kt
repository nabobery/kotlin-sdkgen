...
public class ForwardedRequestContext(
    ...
    public object Serializer : KSerializer<ForwardedRequestContext> {
        ...
        override fun deserialize(decoder: Decoder): ForwardedRequestContext {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("ForwardedRequestContext must be a JSON object")
...
public fun forwardedRequestContext(block: ForwardedRequestContext.Builder.() -> Unit): ForwardedRequestContext =
    ForwardedRequestContext.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("ForwardedRequestContext is missing required property '" + name + "'")
