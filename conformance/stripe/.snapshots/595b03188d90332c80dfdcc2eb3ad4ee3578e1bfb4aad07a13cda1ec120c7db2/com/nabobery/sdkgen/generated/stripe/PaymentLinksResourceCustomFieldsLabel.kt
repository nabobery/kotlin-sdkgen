...
public class PaymentLinksResourceCustomFieldsLabel(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentLinksResourceCustomFieldsLabel =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<PaymentLinksResourceCustomFieldsLabel> {
        ...
        override fun deserialize(decoder: Decoder): PaymentLinksResourceCustomFieldsLabel {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentLinksResourceCustomFieldsLabel must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentLinksResourceCustomFieldsLabel,
        ) {
...
public fun paymentLinksResourceCustomFieldsLabel(
    block: PaymentLinksResourceCustomFieldsLabel.Builder.() -> Unit,
): PaymentLinksResourceCustomFieldsLabel = PaymentLinksResourceCustomFieldsLabel.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "PaymentLinksResourceCustomFieldsLabel is missing required property '" + name + "'",
            )
