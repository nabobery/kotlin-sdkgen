...
public class DisputeEnhancedEvidenceVisaCompliance(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): DisputeEnhancedEvidenceVisaCompliance =
    ...
    public object Serializer : KSerializer<DisputeEnhancedEvidenceVisaCompliance> {
        ...
        override fun deserialize(decoder: Decoder): DisputeEnhancedEvidenceVisaCompliance {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("DisputeEnhancedEvidenceVisaCompliance must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: DisputeEnhancedEvidenceVisaCompliance,
        ) {
...
public fun disputeEnhancedEvidenceVisaCompliance(
    block: DisputeEnhancedEvidenceVisaCompliance.Builder.() -> Unit,
): DisputeEnhancedEvidenceVisaCompliance = DisputeEnhancedEvidenceVisaCompliance.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "DisputeEnhancedEvidenceVisaCompliance is missing required property '" + name + "'",
            )
