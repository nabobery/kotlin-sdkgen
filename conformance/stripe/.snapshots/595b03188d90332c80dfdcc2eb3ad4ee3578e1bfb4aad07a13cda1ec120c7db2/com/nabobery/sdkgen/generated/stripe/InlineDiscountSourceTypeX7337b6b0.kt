...
public sealed class InlineDiscountSourceTypeX7337b6b0 {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineDiscountSourceTypeX7337b6b0 =
            when (value) {
                Coupon.value -> Coupon
    ...
    public object Serializer : KSerializer<InlineDiscountSourceTypeX7337b6b0> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineDiscountSourceTypeX7337b6b0",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineDiscountSourceTypeX7337b6b0 =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineDiscountSourceTypeX7337b6b0,
        ) {
