...
public class InlineInvoicesPaymentsInvoicePaymentAssociatedPaymentPaymentIntentXd0d3cf11 internal constructor(
    ...
    private val inspection: InlineInvoicesPaymentsInvoicePaymentAssociatedPaymentPaymentIntentXd0d3cf11Inspection,
) {
        ...
        get() =
            buildSet {
                if (inspection.matchesBranch1) {
                    add(
                        InlineInvoicesPaymentsInvoicePaymentAssociatedPaymentPaymentIntentXd0d3cf11Branch.Branch1,
                    )
                }
                if (inspection.matchesPaymentIntent) {
                    add(
                        InlineInvoicesPaymentsInvoicePaymentAssociatedPaymentPaymentIntentXd0d3cf11Branch.PaymentIntent,
                    )
                }
            }
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineInvoicesPaymentsInvoicePaymentAssociatedPaymentPaymentIntentXd0d3cf11 {
            val inspection = inspectInlineInvoicesPaymentsInvoicePaymentAssociatedPaymentPaymentIntentXd0d3cf11(raw)
            if (inspection.matchCount == 0) {
                throw InlineInvoicesPaymentsInvoicePaymentAssociatedPaymentPaymentIntentXd0d3cf11NoMatchException(
                    "InlineInvoicesPaymentsInvoicePaymentAssociatedPaymentPaymentIntentXd0d3cf11 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineInvoicesPaymentsInvoicePaymentAssociatedPaymentPaymentIntentXd0d3cf11> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineInvoicesPaymentsInvoicePaymentAssociatedPaymentPaymentIntentXd0d3cf11,
        ) {
            encoder
                .requireJsonEncoder(
                    "InlineInvoicesPaymentsInvoicePaymentAssociatedPaymentPaymentIntentXd0d3cf11",
...
private fun inspectInlineInvoicesPaymentsInvoicePaymentAssociatedPaymentPaymentIntentXd0d3cf11(
    element: JsonElement,
