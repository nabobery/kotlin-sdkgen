        ...
        override fun deserialize(decoder: Decoder): ProrationDetails {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("ProrationDetails must be a JSON object")
            val discountAmounts =
                ...
                creditedItems =
                    rawObject["credited_items"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlineProrationDetailsCreditedItemsXce2017bd?>(element)
                        }
                    },
            )
        }
...
public fun prorationDetails(block: ProrationDetails.Builder.() -> Unit): ProrationDetails =
    ProrationDetails.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("ProrationDetails is missing required property '" + name + "'")
