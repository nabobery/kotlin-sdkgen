...
public class PaymentMethodOptionsMandateOptionsUpi(
    ...
    public class Builder {
        ...
        public fun build(): PaymentMethodOptionsMandateOptionsUpi =
            PaymentMethodOptionsMandateOptionsUpi(
                amount = amount,
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): PaymentMethodOptionsMandateOptionsUpi =
    ...
    public object Serializer : KSerializer<PaymentMethodOptionsMandateOptionsUpi> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodOptionsMandateOptionsUpi {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodOptionsMandateOptionsUpi must be a JSON object")
                ...
                amountType =
                    rawObject["amount_type"]?.let { element ->
                        if (element ==
                            ...
                            json.decodeFromJsonElement<InlinePaymentMethodOptionsMandateOptionsUpiAmountTypeX6ab8da60?>(
                                element,
                            )
                        }
                    },
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentMethodOptionsMandateOptionsUpi,
        ) {
...
public fun paymentMethodOptionsMandateOptionsUpi(
    block: PaymentMethodOptionsMandateOptionsUpi.Builder.() -> Unit,
): PaymentMethodOptionsMandateOptionsUpi = PaymentMethodOptionsMandateOptionsUpi.build(block)
