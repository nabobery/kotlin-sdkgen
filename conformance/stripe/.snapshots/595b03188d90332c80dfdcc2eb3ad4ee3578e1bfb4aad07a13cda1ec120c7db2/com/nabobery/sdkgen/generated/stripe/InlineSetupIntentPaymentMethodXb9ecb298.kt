...
public class InlineSetupIntentPaymentMethodXb9ecb298 internal constructor(
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineSetupIntentPaymentMethodXb9ecb298 {
            val inspection = inspectInlineSetupIntentPaymentMethodXb9ecb298(raw)
            if (inspection.matchCount == 0) {
                throw InlineSetupIntentPaymentMethodXb9ecb298NoMatchException(
                    "InlineSetupIntentPaymentMethodXb9ecb298 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineSetupIntentPaymentMethodXb9ecb298> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineSetupIntentPaymentMethodXb9ecb298,
        ) {
...
private fun inspectInlineSetupIntentPaymentMethodXb9ecb298(
    element: JsonElement,
): InlineSetupIntentPaymentMethodXb9ecb298Inspection {
