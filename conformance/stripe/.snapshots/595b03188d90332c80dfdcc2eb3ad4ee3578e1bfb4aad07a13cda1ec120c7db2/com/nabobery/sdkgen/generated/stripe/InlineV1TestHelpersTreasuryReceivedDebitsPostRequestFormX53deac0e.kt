...
public class InlineV1TestHelpersTreasuryReceivedDebitsPostRequestFormX53deac0e(
    ...
    public companion object {
        public fun build(block: Builder.() -> Unit): InlineV1TestHelpersTreasuryReceivedDebitsPostRequestFormX53deac0e =
            Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TestHelpersTreasuryReceivedDebitsPostRequestFormX53deac0e> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1TestHelpersTreasuryReceivedDebitsPostRequestFormX53deac0e {
            val jsonDecoder =
                decoder.requireJsonDecoder(
                    "InlineV1TestHelpersTreasuryReceivedDebitsPostRequestFormX53deac0e",
                )
            val json = jsonDecoder.json
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TestHelpersTreasuryReceivedDebitsPostRequestFormX53deac0e must be a JSON object",
                    )
            val amount = json.decodeRequired<Int>(rawObject, "amount")
            val currency = json.decodeRequired<String>(rawObject, "currency")
            val financialAccount = json.decodeRequired<String>(rawObject, "financial_account")
            val network =
                json.decodeRequired<InlineV1TestHelpersTreasuryReceivedDebitsPostRequestFormNetworkXbdad12c0>(
                    rawObject,
                    "network",
                )
            return InlineV1TestHelpersTreasuryReceivedDebitsPostRequestFormX53deac0e(
                ...
                initiatingPaymentMethodDetails =
                    rawObject["initiating_payment_method_details"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TestHelpersTreasurbf2dPostRequestFormInitiatingPaymentMetfafcX20486327>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TestHelpersTreasuryReceivedDebitsPostRequestFormX53deac0e,
        ) {
            val jsonEncoder =
            ...
            val raw =
                buildJsonObject {
                    ...
                    value.initiatingPaymentMethodDetails?.let {
                        put(
...
public fun inlineV1TestHelpersTreasuryReceivedDebitsPostRequestFormX53deac0e(
    block: InlineV1TestHelpersTreasuryReceivedDebitsPostRequestFormX53deac0e.Builder.() -> Unit,
): InlineV1TestHelpersTreasuryReceivedDebitsPostRequestFormX53deac0e =
    InlineV1TestHelpersTreasuryReceivedDebitsPostRequestFormX53deac0e.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TestHelpersTreasuryReceivedDebitsPostRequestFormX53deac0e is missing required property '" +
                    name +
                    "'",
            )
