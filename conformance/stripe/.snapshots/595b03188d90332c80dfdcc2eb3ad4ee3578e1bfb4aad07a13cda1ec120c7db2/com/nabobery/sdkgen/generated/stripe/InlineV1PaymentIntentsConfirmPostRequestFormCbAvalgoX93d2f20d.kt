...
public sealed class InlineV1PaymentIntentsConfirmPostRequestFormCbAvalgoX93d2f20d {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1PaymentIntentsConfirmPostRequestFormCbAvalgoX93d2f20d =
            when (value) {
                _0.value -> _0
                _1.value -> _1
                _2.value -> _2
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsConfirmPostRequestFormCbAvalgoX93d2f20d> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1PaymentIntentsConfirmPostRequestFormCbAvalgoX93d2f20d",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1PaymentIntentsConfirmPostRequestFormCbAvalgoX93d2f20d =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsConfirmPostRequestFormCbAvalgoX93d2f20d,
        ) {
