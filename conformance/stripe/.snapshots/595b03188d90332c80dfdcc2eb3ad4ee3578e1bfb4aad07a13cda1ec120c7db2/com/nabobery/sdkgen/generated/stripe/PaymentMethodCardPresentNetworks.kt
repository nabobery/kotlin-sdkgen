...
@Serializable
public data class PaymentMethodCardPresentNetworksView(
...
public class PaymentMethodCardPresentNetworks(
    ...
    public object Serializer : KSerializer<PaymentMethodCardPresentNetworks> {
        ...
        override fun deserialize(decoder: Decoder): PaymentMethodCardPresentNetworks {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("PaymentMethodCardPresentNetworks must be a JSON object")
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: PaymentMethodCardPresentNetworks,
        ) {
...
public fun paymentMethodCardPresentNetworks(
    block: PaymentMethodCardPresentNetworks.Builder.() -> Unit,
): PaymentMethodCardPresentNetworks = PaymentMethodCardPresentNetworks.build(block)
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "PaymentMethodCardPresentNetworks is missing required property '" + name + "'",
            )
