...
public class InlineV1PaymentIntentsApplyCustomerBalancePostRequestFormXa54e4156(
    ...
    public class Builder {
        ...
        public fun build(): InlineV1PaymentIntentsApplyCustomerBalancePostRequestFormXa54e4156 =
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1PaymentIntentsApplyCustomerBalancePostRequestFormXa54e4156 = Builder().apply(block).build()
    }
    ...
    public object Serializer : KSerializer<InlineV1PaymentIntentsApplyCustomerBalancePostRequestFormXa54e4156> {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1PaymentIntentsApplyCustomerBalancePostRequestFormXa54e4156 must be a JSON object",
                    )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PaymentIntentsApplyCustomerBalancePostRequestFormXa54e4156,
        ) {
            val jsonEncoder =
...
public fun inlineV1PaymentIntentsApplyCustomerBalancePostRequestFormXa54e4156(
    block: InlineV1PaymentIntentsApplyCustomerBalancePostRequestFormXa54e4156.Builder.() -> Unit,
): InlineV1PaymentIntentsApplyCustomerBalancePostRequestFormXa54e4156 =
    InlineV1PaymentIntentsApplyCustomerBalancePostRequestFormXa54e4156.build(block)
