...
public sealed class InlineTreasuryTransactionEntryFlowTypeXd394617b {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineTreasuryTransactionEntryFlowTypeXd394617b =
            when (value) {
    ...
    public object Serializer : KSerializer<InlineTreasuryTransactionEntryFlowTypeXd394617b> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineTreasuryTransactionEntryFlowTypeXd394617b",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineTreasuryTransactionEntryFlowTypeXd394617b =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineTreasuryTransactionEntryFlowTypeXd394617b,
        ) {
