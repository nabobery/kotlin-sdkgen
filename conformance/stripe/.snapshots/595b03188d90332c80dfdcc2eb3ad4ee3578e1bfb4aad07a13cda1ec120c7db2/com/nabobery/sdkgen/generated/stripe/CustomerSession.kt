        ...
        override fun deserialize(decoder: Decoder): CustomerSession {
            ...
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException("CustomerSession must be a JSON object")
            ...
            return CustomerSession(
                ...
                objectValue = objectValue,
                components =
                    rawObject["components"]?.let {
                        json
                            .decodeFromJsonElement<CustomerSessionResourceComponents>(
                                it,
                            )
                    },
                customerAccount =
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name] ?: throw SerializationException("CustomerSession is missing required property '" + name + "'")
