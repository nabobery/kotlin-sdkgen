...
public class InlineV1TestHelpersTreasuryReceivedCreditsPostRequestFormX388af435(
    ...
    public companion object {
        public fun build(
            block: Builder.() -> Unit,
        ): InlineV1TestHelpersTreasuryReceivedCreditsPostRequestFormX388af435 = Builder().apply(block).build()
    }

    public object Serializer : KSerializer<InlineV1TestHelpersTreasuryReceivedCreditsPostRequestFormX388af435> {
        ...
        override fun deserialize(decoder: Decoder): InlineV1TestHelpersTreasuryReceivedCreditsPostRequestFormX388af435 {
            val jsonDecoder =
                decoder.requireJsonDecoder(
                    "InlineV1TestHelpersTreasuryReceivedCreditsPostRequestFormX388af435",
                )
            val json = jsonDecoder.json
            val rawObject =
                jsonDecoder.decodeJsonElement() as? JsonObject
                    ?: throw SerializationException(
                        "InlineV1TestHelpersTreasuryReceivedCreditsPostRequestFormX388af435 must be a JSON object",
                    )
            val amount = json.decodeRequired<Int>(rawObject, "amount")
            val currency = json.decodeRequired<String>(rawObject, "currency")
            val financialAccount = json.decodeRequired<String>(rawObject, "financial_account")
            val network =
                json.decodeRequired<InlineV1TestHelpersTreasuryReceivedCreditsPostRequestFormNetworkX26503d6c>(
                    rawObject,
                    "network",
                )
            return InlineV1TestHelpersTreasuryReceivedCreditsPostRequestFormX388af435(
                ...
                initiatingPaymentMethodDetails =
                    rawObject["initiating_payment_method_details"]?.let {
                        json
                            .decodeFromJsonElement<InlineV1TestHelpersTreasured25PostRequestFormInitiatingPaymentMetfafcXa025364f>(
                                it,
                            )
                    },
            )
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1TestHelpersTreasuryReceivedCreditsPostRequestFormX388af435,
        ) {
            val jsonEncoder =
...
public fun inlineV1TestHelpersTreasuryReceivedCreditsPostRequestFormX388af435(
    block: InlineV1TestHelpersTreasuryReceivedCreditsPostRequestFormX388af435.Builder.() -> Unit,
): InlineV1TestHelpersTreasuryReceivedCreditsPostRequestFormX388af435 =
    InlineV1TestHelpersTreasuryReceivedCreditsPostRequestFormX388af435.build(block)
...
private inline fun <reified T> Json.decodeRequired(
    ...
    val element =
        raw[name]
            ?: throw SerializationException(
                "InlineV1TestHelpersTreasuryReceivedCreditsPostRequestFormX388af435 is missing required property '" +
                    name +
                    "'",
            )
