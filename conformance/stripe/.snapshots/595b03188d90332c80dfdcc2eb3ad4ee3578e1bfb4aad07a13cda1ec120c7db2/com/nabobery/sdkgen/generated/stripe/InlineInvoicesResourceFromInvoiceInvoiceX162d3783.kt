...
public class InlineInvoicesResourceFromInvoiceInvoiceX162d3783 internal constructor(
    ...
    public companion object {
        ...
        public fun fromRaw(
            raw: JsonElement,
            json: Json = SdkJson,
        ): InlineInvoicesResourceFromInvoiceInvoiceX162d3783 {
            val inspection = inspectInlineInvoicesResourceFromInvoiceInvoiceX162d3783(raw)
            if (inspection.matchCount == 0) {
                throw InlineInvoicesResourceFromInvoiceInvoiceX162d3783NoMatchException(
                    "InlineInvoicesResourceFromInvoiceInvoiceX162d3783 matched 0 branches: " +
    ...
    public object Serializer : KSerializer<InlineInvoicesResourceFromInvoiceInvoiceX162d3783> {
        ...
        override fun serialize(
            encoder: Encoder,
            `value`: InlineInvoicesResourceFromInvoiceInvoiceX162d3783,
        ) {
...
private fun inspectInlineInvoicesResourceFromInvoiceInvoiceX162d3783(
    element: JsonElement,
): InlineInvoicesResourceFromInvoiceInvoiceX162d3783Inspection {
