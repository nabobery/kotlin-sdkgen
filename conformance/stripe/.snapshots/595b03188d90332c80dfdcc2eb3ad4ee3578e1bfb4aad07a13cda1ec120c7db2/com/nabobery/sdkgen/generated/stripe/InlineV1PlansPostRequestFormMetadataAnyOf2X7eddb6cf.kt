...
public sealed class InlineV1PlansPostRequestFormMetadataAnyOf2X7eddb6cf {
    ...
    public companion object {
        public fun fromValue(`value`: String): InlineV1PlansPostRequestFormMetadataAnyOf2X7eddb6cf =
            when (value) {
                Value.value -> Value
    ...
    public object Serializer : KSerializer<InlineV1PlansPostRequestFormMetadataAnyOf2X7eddb6cf> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor(
                "com.nabobery.sdkgen.generated.stripe.InlineV1PlansPostRequestFormMetadataAnyOf2X7eddb6cf",
                PrimitiveKind.STRING,
            )

        override fun deserialize(decoder: Decoder): InlineV1PlansPostRequestFormMetadataAnyOf2X7eddb6cf =
            fromValue(decoder.decodeString())

        override fun serialize(
            encoder: Encoder,
            `value`: InlineV1PlansPostRequestFormMetadataAnyOf2X7eddb6cf,
        ) {
