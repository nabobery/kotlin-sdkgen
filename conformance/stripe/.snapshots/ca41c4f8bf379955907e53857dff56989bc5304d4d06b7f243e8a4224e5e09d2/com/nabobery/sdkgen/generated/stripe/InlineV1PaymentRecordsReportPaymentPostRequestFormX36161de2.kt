...
public class InlineV1PaymentRecordsReportPaymentPostRequestFormX36161de2(
  ...
  public val guaranteed:
      InlineV1PaymentRecordsReportPaymentPostRequestFormGuaranteedXba30823c? = null,
  /**
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1PaymentRecordsReportPaymentPostRequestFormX36161de2 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1PaymentRecordsReportPaymentPostRequestFormX36161de2> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1PaymentRecordsReportPaymentPostRequestFormX36161de2 {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1PaymentRecordsReportPaymentPostRequestFormX36161de2 must be a JSON object")
      val amountRequested = json.decodeRequired<InlineV1PaymentRecordsReportPaymentPostRequestFormAmountRequestedX755a383d>(rawObject, "amount_requested")
      val initiatedAt = json.decodeRequired<Int>(rawObject, "initiated_at")
      val paymentMethodDetails = json.decodeRequired<InlineV1PaymentRecordsReportPaymentPostRequestFormPaymentMethodDetailsXdfe56de9>(rawObject, "payment_method_details")
      return InlineV1PaymentRecordsReportPaymentPostRequestFormX36161de2(
        amountRequested = amountRequested,
        initiatedAt = initiatedAt,
        paymentMethodDetails = paymentMethodDetails,
        customerDetails = rawObject["customer_details"]?.let { json.decodeFromJsonElement<InlineV1PaymentRecordsReportPaymentPostRequestFormCustomerDetailsX724b1073>(it) },
        customerPresence = rawObject["customer_presence"]?.let { json.decodeFromJsonElement<InlineV1PaymentRecordsReportPaymentPostRequestFormCustomerPresenceX57e5c357>(it) },
        description = rawObject["description"]?.let { json.decodeFromJsonElement<String>(it) },
        expand = rawObject["expand"]?.let { json.decodeFromJsonElement<List<String>>(it) },
        failed = rawObject["failed"]?.let { json.decodeFromJsonElement<InlineV1PaymentRecordsReportPaymentPostRequestFormFailedX13f3a037>(it) },
        guaranteed = rawObject["guaranteed"]?.let { json.decodeFromJsonElement<InlineV1PaymentRecordsReportPaymentPostRequestFormGuaranteedXba30823c>(it) },
        metadata = rawObject["metadata"]?.let { json.decodeFromJsonElement<InlineV1PaymentRecordsReportPaymentPostRequestFormMetadataX8a93bded>(it) },
        outcome = rawObject["outcome"]?.let { json.decodeFromJsonElement<InlineV1PaymentRecordsReportPaymentPostRequestFormOutcomeX2e14d97f>(it) },
        processorDetails = rawObject["processor_details"]?.let { json.decodeFromJsonElement<InlineV1PaymentRecordsReportPaymentPostRequestFormProcessorDetailsXc4483f5a>(it) },
        shippingDetails = rawObject["shipping_details"]?.let { json.decodeFromJsonElement<InlineV1PaymentRecordsReportPaymentPostRequestFormShippingDetailsX09ea491a>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineV1PaymentRecordsReportPaymentPostRequestFormX36161de2) {
...
public fun inlineV1PaymentRecordsReportPaymentPostRequestFormX36161de2(block: InlineV1PaymentRecordsReportPaymentPostRequestFormX36161de2.Builder.() -> Unit): InlineV1PaymentRecordsReportPaymentPostRequestFormX36161de2 = InlineV1PaymentRecordsReportPaymentPostRequestFormX36161de2.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineV1PaymentRecordsReportPaymentPostRequestFormX36161de2 is missing required property '" + name + "'")
