...
public class InlineBillingPortalSessionConfigurationX04be7630 internal constructor(
  ...
  public val billingPortalConfiguration: BillingPortalConfiguration? by
      lazy(LazyThreadSafetyMode.NONE) { if (inspection.matchesBillingPortalConfiguration) json.decodeFromJsonElement<BillingPortalConfiguration>(raw) else null }
  ...
  public val matchedBranches: Set<InlineBillingPortalSessionConfigurationX04be7630Branch>
    get() = buildSet {
      ...
      if (inspection.matchesBillingPortalConfiguration) add(InlineBillingPortalSessionConfigurationX04be7630Branch.BillingPortalConfiguration)
    }
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineBillingPortalSessionConfigurationX04be7630 {
      val inspection = inspectInlineBillingPortalSessionConfigurationX04be7630(raw)
      if (inspection.matchCount == 0) {
        throw InlineBillingPortalSessionConfigurationX04be7630NoMatchException("InlineBillingPortalSessionConfigurationX04be7630 matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineBillingPortalSessionConfigurationX04be7630(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineBillingPortalSessionConfigurationX04be7630> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineBillingPortalSessionConfigurationX04be7630) {
      encoder.requireJsonEncoder("InlineBillingPortalSessionConfigurationX04be7630").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineBillingPortalSessionConfigurationX04be7630(element: JsonElement): InlineBillingPortalSessionConfigurationX04be7630Inspection {
  ...
  return InlineBillingPortalSessionConfigurationX04be7630Inspection(
    ...
    failures = buildList {
      ...
      if (!matchesBillingPortalConfiguration) add("BillingPortalConfiguration: value does not match BillingPortalConfiguration")
    },
  )
}
