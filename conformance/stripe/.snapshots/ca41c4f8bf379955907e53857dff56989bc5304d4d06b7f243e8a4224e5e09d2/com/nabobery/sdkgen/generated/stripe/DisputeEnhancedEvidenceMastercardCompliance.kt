...
public class DisputeEnhancedEvidenceMastercardCompliance(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): DisputeEnhancedEvidenceMastercardCompliance = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<DisputeEnhancedEvidenceMastercardCompliance> {
    ...
    override fun deserialize(decoder: Decoder): DisputeEnhancedEvidenceMastercardCompliance {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("DisputeEnhancedEvidenceMastercardCompliance must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: DisputeEnhancedEvidenceMastercardCompliance) {
...
public fun disputeEnhancedEvidenceMastercardCompliance(block: DisputeEnhancedEvidenceMastercardCompliance.Builder.() -> Unit): DisputeEnhancedEvidenceMastercardCompliance = DisputeEnhancedEvidenceMastercardCompliance.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("DisputeEnhancedEvidenceMastercardCompliance is missing required property '" + name + "'")
