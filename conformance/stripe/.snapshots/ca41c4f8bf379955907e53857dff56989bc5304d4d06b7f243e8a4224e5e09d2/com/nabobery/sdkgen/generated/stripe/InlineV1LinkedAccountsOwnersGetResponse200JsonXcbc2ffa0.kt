...
public class InlineV1LinkedAccountsOwnersGetResponse200JsonXcbc2ffa0(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1LinkedAccountsOwnersGetResponse200JsonXcbc2ffa0 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1LinkedAccountsOwnersGetResponse200JsonXcbc2ffa0> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1LinkedAccountsOwnersGetResponse200JsonXcbc2ffa0 {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1LinkedAccountsOwnersGetResponse200JsonXcbc2ffa0 must be a JSON object")
      ...
      val objectValue = json.decodeRequired<InlineV1LinkedAccountsOwnersGetResponse200JsonObjectValueX2aaa97f9>(rawObject, "object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1LinkedAccountsOwnersGetResponse200JsonXcbc2ffa0) {
...
public fun inlineV1LinkedAccountsOwnersGetResponse200JsonXcbc2ffa0(block: InlineV1LinkedAccountsOwnersGetResponse200JsonXcbc2ffa0.Builder.() -> Unit): InlineV1LinkedAccountsOwnersGetResponse200JsonXcbc2ffa0 = InlineV1LinkedAccountsOwnersGetResponse200JsonXcbc2ffa0.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineV1LinkedAccountsOwnersGetResponse200JsonXcbc2ffa0 is missing required property '" + name + "'")
