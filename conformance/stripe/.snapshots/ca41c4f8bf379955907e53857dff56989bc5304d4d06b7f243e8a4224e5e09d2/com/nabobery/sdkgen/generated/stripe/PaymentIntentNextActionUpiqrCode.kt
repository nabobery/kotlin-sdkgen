...
public class PaymentIntentNextActionUpiqrCode(
  ...
  internal object Serializer : KSerializer<PaymentIntentNextActionUpiqrCode> {
    ...
    override fun deserialize(decoder: Decoder): PaymentIntentNextActionUpiqrCode {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("PaymentIntentNextActionUpiqrCode must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: PaymentIntentNextActionUpiqrCode) {
...
public fun paymentIntentNextActionUpiqrCode(block: PaymentIntentNextActionUpiqrCode.Builder.() -> Unit): PaymentIntentNextActionUpiqrCode = PaymentIntentNextActionUpiqrCode.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("PaymentIntentNextActionUpiqrCode is missing required property '" + name + "'")
