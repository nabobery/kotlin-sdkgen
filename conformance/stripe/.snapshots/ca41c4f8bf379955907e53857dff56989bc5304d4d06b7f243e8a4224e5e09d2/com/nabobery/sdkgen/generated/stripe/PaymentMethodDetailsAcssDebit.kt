...
public class PaymentMethodDetailsAcssDebit(
  ...
  public class Builder {
    ...
    public fun build(): PaymentMethodDetailsAcssDebit = PaymentMethodDetailsAcssDebit(
      bankName = bankName,
  ...
  internal object Serializer : KSerializer<PaymentMethodDetailsAcssDebit> {
    ...
    override fun deserialize(decoder: Decoder): PaymentMethodDetailsAcssDebit {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("PaymentMethodDetailsAcssDebit must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: PaymentMethodDetailsAcssDebit) {
...
public fun paymentMethodDetailsAcssDebit(block: PaymentMethodDetailsAcssDebit.Builder.() -> Unit): PaymentMethodDetailsAcssDebit = PaymentMethodDetailsAcssDebit.build(block)
