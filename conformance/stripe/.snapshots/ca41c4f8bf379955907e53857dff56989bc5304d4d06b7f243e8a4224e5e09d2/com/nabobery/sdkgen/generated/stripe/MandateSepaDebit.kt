...
public class MandateSepaDebit(
  ...
  internal object Serializer : KSerializer<MandateSepaDebit> {
    ...
    override fun deserialize(decoder: Decoder): MandateSepaDebit {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("MandateSepaDebit must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: MandateSepaDebit) {
...
public fun mandateSepaDebit(block: MandateSepaDebit.Builder.() -> Unit): MandateSepaDebit = MandateSepaDebit.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("MandateSepaDebit is missing required property '" + name + "'")
