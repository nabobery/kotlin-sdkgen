...
public class InlineV1IssuingCardholdersGetResponse200JsonXd91625ec(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1IssuingCardholdersGetResponse200JsonXd91625ec = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1IssuingCardholdersGetResponse200JsonXd91625ec> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1IssuingCardholdersGetResponse200JsonXd91625ec {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1IssuingCardholdersGetResponse200JsonXd91625ec must be a JSON object")
      ...
      val objectValue = json.decodeRequired<InlineV1IssuingCardholdersGetResponse200JsonObjectValueX364c9aea>(rawObject, "object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1IssuingCardholdersGetResponse200JsonXd91625ec) {
...
public fun inlineV1IssuingCardholdersGetResponse200JsonXd91625ec(block: InlineV1IssuingCardholdersGetResponse200JsonXd91625ec.Builder.() -> Unit): InlineV1IssuingCardholdersGetResponse200JsonXd91625ec = InlineV1IssuingCardholdersGetResponse200JsonXd91625ec.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineV1IssuingCardholdersGetResponse200JsonXd91625ec is missing required property '" + name + "'")
