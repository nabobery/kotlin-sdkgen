...
public class PaymentMethodConfigBizPaymentMethodConfigurationDetails(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): PaymentMethodConfigBizPaymentMethodConfigurationDetails = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<PaymentMethodConfigBizPaymentMethodConfigurationDetails> {
    ...
    override fun deserialize(decoder: Decoder): PaymentMethodConfigBizPaymentMethodConfigurationDetails {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("PaymentMethodConfigBizPaymentMethodConfigurationDetails must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: PaymentMethodConfigBizPaymentMethodConfigurationDetails) {
...
public fun paymentMethodConfigBizPaymentMethodConfigurationDetails(block: PaymentMethodConfigBizPaymentMethodConfigurationDetails.Builder.() -> Unit): PaymentMethodConfigBizPaymentMethodConfigurationDetails = PaymentMethodConfigBizPaymentMethodConfigurationDetails.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("PaymentMethodConfigBizPaymentMethodConfigurationDetails is missing required property '" + name + "'")
