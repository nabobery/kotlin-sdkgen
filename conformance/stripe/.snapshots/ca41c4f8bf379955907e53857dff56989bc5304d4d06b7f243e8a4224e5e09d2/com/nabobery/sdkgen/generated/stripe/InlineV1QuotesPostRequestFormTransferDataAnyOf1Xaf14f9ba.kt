...
public class InlineV1QuotesPostRequestFormTransferDataAnyOf1Xaf14f9ba(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1QuotesPostRequestFormTransferDataAnyOf1Xaf14f9ba = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1QuotesPostRequestFormTransferDataAnyOf1Xaf14f9ba> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1QuotesPostRequestFormTransferDataAnyOf1Xaf14f9ba {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1QuotesPostRequestFormTransferDataAnyOf1Xaf14f9ba must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1QuotesPostRequestFormTransferDataAnyOf1Xaf14f9ba) {
...
public fun inlineV1QuotesPostRequestFormTransferDataAnyOf1Xaf14f9ba(block: InlineV1QuotesPostRequestFormTransferDataAnyOf1Xaf14f9ba.Builder.() -> Unit): InlineV1QuotesPostRequestFormTransferDataAnyOf1Xaf14f9ba = InlineV1QuotesPostRequestFormTransferDataAnyOf1Xaf14f9ba.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineV1QuotesPostRequestFormTransferDataAnyOf1Xaf14f9ba is missing required property '" + name + "'")
