 ...
 * on~1x-www-form-urlencoded/schema
 */
@Serializable(with = InlineV1AccountsBankAccountsPostRequestFormX16c7f6ea.Serializer::class)
public class InlineV1AccountsBankAccountsPostRequestFormX16c7f6ea(
  /**
  ...
  public val accountHolderType:
      InlineV1AccountsBankAccountsPostRequestFormAccountHolderTypeX8942b3ac? = null,
  /**
   * The bank account type. This can only be `checking` or `savings` in most countries. In Japan, this can only be
   * `futsu` or `toza`.
   */
  public val accountType: InlineV1AccountsBankAccountsPostRequestFormAccountTypeXd767bebb? = null,
  /**
   ...
   */
  public val documents: InlineV1AccountsBankAccountsPostRequestFormDocumentsX39fc0d37? = null,
  /**
   ...
   */
  public val metadata: InlineV1AccountsBankAccountsPostRequestFormMetadataXb01c85c9? = null,
  /**
   * Cardholder name.
   */
  ...
  public class Builder {
     ...
     * `futsu` or `toza`.
     */
    public var accountType: InlineV1AccountsBankAccountsPostRequestFormAccountTypeXd767bebb? = null
     ...
     * Documents that may be submitted to satisfy various informational requests.
     */
    public var documents: InlineV1AccountsBankAccountsPostRequestFormDocumentsX39fc0d37? = null
     ...
     */
    public var metadata: InlineV1AccountsBankAccountsPostRequestFormMetadataXb01c85c9? = null
    ...
    public fun build(): InlineV1AccountsBankAccountsPostRequestFormX16c7f6ea = InlineV1AccountsBankAccountsPostRequestFormX16c7f6ea(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1AccountsBankAccountsPostRequestFormX16c7f6ea = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1AccountsBankAccountsPostRequestFormX16c7f6ea> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineV1AccountsBankAccountsPostRequestFormX16c7f6ea {
      val jsonDecoder = decoder.requireJsonDecoder("InlineV1AccountsBankAccountsPostRequestFormX16c7f6ea")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1AccountsBankAccountsPostRequestFormX16c7f6ea must be a JSON object")
      return InlineV1AccountsBankAccountsPostRequestFormX16c7f6ea(
        accountHolderName = rawObject["account_holder_name"]?.let { json.decodeFromJsonElement<String>(it) },
        accountHolderType = rawObject["account_holder_type"]?.let { json.decodeFromJsonElement<InlineV1AccountsBankAccountsPostRequestFormAccountHolderTypeX8942b3ac>(it) },
        accountType = rawObject["account_type"]?.let { json.decodeFromJsonElement<InlineV1AccountsBankAccountsPostRequestFormAccountTypeXd767bebb>(it) },
        ...
        documents = rawObject["documents"]?.let { json.decodeFromJsonElement<InlineV1AccountsBankAccountsPostRequestFormDocumentsX39fc0d37>(it) },
        ...
        metadata = rawObject["metadata"]?.let { json.decodeFromJsonElement<InlineV1AccountsBankAccountsPostRequestFormMetadataXb01c85c9>(it) },
        name = rawObject["name"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineV1AccountsBankAccountsPostRequestFormX16c7f6ea) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineV1AccountsBankAccountsPostRequestFormX16c7f6ea")
...
public fun inlineV1AccountsBankAccountsPostRequestFormX16c7f6ea(block: InlineV1AccountsBankAccountsPostRequestFormX16c7f6ea.Builder.() -> Unit): InlineV1AccountsBankAccountsPostRequestFormX16c7f6ea = InlineV1AccountsBankAccountsPostRequestFormX16c7f6ea.build(block)
