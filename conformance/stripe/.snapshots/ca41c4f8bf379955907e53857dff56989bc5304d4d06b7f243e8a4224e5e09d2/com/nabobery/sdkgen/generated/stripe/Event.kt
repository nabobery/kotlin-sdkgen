...
public class Event(
  ...
  internal object Serializer : KSerializer<Event> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): Event {
      val jsonDecoder = decoder.requireJsonDecoder("Event")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("Event must be a JSON object")
      ...
      return Event(
        ...
        request = rawObject["request"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineEventRequestXba251168?>(element) },
      )
    }
