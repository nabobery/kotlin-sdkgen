...
public class InlineCustomerSourcesX68a9816b(
  ...
  internal object Serializer : KSerializer<InlineCustomerSourcesX68a9816b> {
    ...
    override fun deserialize(decoder: Decoder): InlineCustomerSourcesX68a9816b {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineCustomerSourcesX68a9816b must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineCustomerSourcesX68a9816b) {
...
public fun inlineCustomerSourcesX68a9816b(block: InlineCustomerSourcesX68a9816b.Builder.() -> Unit): InlineCustomerSourcesX68a9816b = InlineCustomerSourcesX68a9816b.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineCustomerSourcesX68a9816b is missing required property '" + name + "'")
