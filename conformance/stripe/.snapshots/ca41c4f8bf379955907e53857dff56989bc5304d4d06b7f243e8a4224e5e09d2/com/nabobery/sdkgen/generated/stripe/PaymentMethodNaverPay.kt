...
public class PaymentMethodNaverPay(
  ...
  internal object Serializer : KSerializer<PaymentMethodNaverPay> {
    ...
    override fun deserialize(decoder: Decoder): PaymentMethodNaverPay {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("PaymentMethodNaverPay must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: PaymentMethodNaverPay) {
...
public fun paymentMethodNaverPay(block: PaymentMethodNaverPay.Builder.() -> Unit): PaymentMethodNaverPay = PaymentMethodNaverPay.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("PaymentMethodNaverPay is missing required property '" + name + "'")
