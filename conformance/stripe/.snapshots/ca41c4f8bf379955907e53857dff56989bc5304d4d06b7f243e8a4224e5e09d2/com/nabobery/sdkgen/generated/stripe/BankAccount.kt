...
@Serializable
public data class BankAccountView internal constructor(
  ...
  public val availablePayoutMethods:
      List<InlineBankAccountAvailablePayoutMethodsItemXe26a523b>? = null,
...
public class BankAccount(
   ...
   */
  public val accountType: String? = null,
  availablePayoutMethods: List<InlineBankAccountAvailablePayoutMethodsItemXe26a523b>? = null,
  /**
   ...
   */
  public val availablePayoutMethods: List<InlineBankAccountAvailablePayoutMethodsItemXe26a523b>? =
  ...
  public class Builder {
    ...
    private var availablePayoutMethodsValue:
        List<InlineBankAccountAvailablePayoutMethodsItemXe26a523b>? = null
  ...
  internal object Serializer : KSerializer<BankAccount> {
    ...
    override fun deserialize(decoder: Decoder): BankAccount {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("BankAccount must be a JSON object")
      ...
      return BankAccount(
        ...
        objectValue = objectValue,
        status = status,
        account = rawObject["account"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineBankAccountAccountX2cf2b751?>(element) },
        ...
        accountHolderType = rawObject["account_holder_type"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<String?>(element) },
        accountType = rawObject["account_type"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<String?>(element) },
        availablePayoutMethods = rawObject["available_payout_methods"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<List<InlineBankAccountAvailablePayoutMethodsItemXe26a523b>?>(element) },
        bankName = rawObject["bank_name"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<String?>(element) },
        customer = rawObject["customer"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineBankAccountCustomerX196a61c7?>(element) },
        ...
        futureRequirements = rawObject["future_requirements"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineBankAccountFutureRequirementsX2d2814a2?>(element) },
        ...
        requirements = rawObject["requirements"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineBankAccountRequirementsXf84df6b2?>(element) },
