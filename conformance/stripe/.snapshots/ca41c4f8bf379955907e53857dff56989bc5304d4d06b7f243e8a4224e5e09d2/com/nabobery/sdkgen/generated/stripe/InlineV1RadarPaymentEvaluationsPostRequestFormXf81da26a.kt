...
public class InlineV1RadarPaymentEvaluationsPostRequestFormXf81da26a(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1RadarPaymentEvaluationsPostRequestFormXf81da26a = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1RadarPaymentEvaluationsPostRequestFormXf81da26a> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1RadarPaymentEvaluationsPostRequestFormXf81da26a {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1RadarPaymentEvaluationsPostRequestFormXf81da26a must be a JSON object")
      val customerDetails = json.decodeRequired<InlineV1RadarPaymentEvaluationsPostRequestFormCustomerDetailsX7bb26d9f>(rawObject, "customer_details")
      val paymentDetails = json.decodeRequired<InlineV1RadarPaymentEvaluationsPostRequestFormPaymentDetailsX8c8260d1>(rawObject, "payment_details")
      return InlineV1RadarPaymentEvaluationsPostRequestFormXf81da26a(
        customerDetails = customerDetails,
        paymentDetails = paymentDetails,
        clientDeviceMetadataDetails = rawObject["client_device_metadata_details"]?.let { json.decodeFromJsonElement<InlineV1RadarPaymentEvaluacd5dPostRequestFormClientDeviceMetadata4d9aXde40d348>(it) },
        expand = rawObject["expand"]?.let { json.decodeFromJsonElement<List<String>>(it) },
        metadata = rawObject["metadata"]?.let { json.decodeFromJsonElement<Map<String, String>>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineV1RadarPaymentEvaluationsPostRequestFormXf81da26a) {
...
public fun inlineV1RadarPaymentEvaluationsPostRequestFormXf81da26a(block: InlineV1RadarPaymentEvaluationsPostRequestFormXf81da26a.Builder.() -> Unit): InlineV1RadarPaymentEvaluationsPostRequestFormXf81da26a = InlineV1RadarPaymentEvaluationsPostRequestFormXf81da26a.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineV1RadarPaymentEvaluationsPostRequestFormXf81da26a is missing required property '" + name + "'")
