...
public class InlineV1InvoicesPostRequestFormOnBehalfOfX1772b039 internal constructor(
  ...
  public val inlineV1InvoicesPostRequestFormOnBehalfOfAnyOf2X84ed7765:
      ...
      lazy(LazyThreadSafetyMode.NONE) { if (inspection.matchesInlineV1InvoicesPostRequestFormOnBehalfOfAnyOf2X84ed7765) json.decodeFromJsonElement<InlineV1InvoicesPostRequestFormOnBehalfOfAnyOf2X84ed7765>(raw) else null }
  ...
  public val matchedBranches: Set<InlineV1InvoicesPostRequestFormOnBehalfOfX1772b039Branch>
    get() = buildSet {
      ...
      if (inspection.matchesInlineV1InvoicesPostRequestFormOnBehalfOfAnyOf2X84ed7765) add(InlineV1InvoicesPostRequestFormOnBehalfOfX1772b039Branch.InlineV1InvoicesPostRequestFormOnBehalfOfAnyOf2X84ed7765)
    }
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineV1InvoicesPostRequestFormOnBehalfOfX1772b039 {
      val inspection = inspectInlineV1InvoicesPostRequestFormOnBehalfOfX1772b039(raw)
      if (inspection.matchCount == 0) {
        throw InlineV1InvoicesPostRequestFormOnBehalfOfX1772b039NoMatchException("InlineV1InvoicesPostRequestFormOnBehalfOfX1772b039 matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineV1InvoicesPostRequestFormOnBehalfOfX1772b039(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineV1InvoicesPostRequestFormOnBehalfOfX1772b039> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1InvoicesPostRequestFormOnBehalfOfX1772b039) {
      encoder.requireJsonEncoder("InlineV1InvoicesPostRequestFormOnBehalfOfX1772b039").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineV1InvoicesPostRequestFormOnBehalfOfX1772b039(element: JsonElement): InlineV1InvoicesPostRequestFormOnBehalfOfX1772b039Inspection {
  val matchesBranch1 = element.isJsonDecodable<String>()
  val matchesInlineV1InvoicesPostRequestFormOnBehalfOfAnyOf2X84ed7765 = element.isJsonDecodable<InlineV1InvoicesPostRequestFormOnBehalfOfAnyOf2X84ed7765>()
  return InlineV1InvoicesPostRequestFormOnBehalfOfX1772b039Inspection(
    ...
    failures = buildList {
      ...
      if (!matchesInlineV1InvoicesPostRequestFormOnBehalfOfAnyOf2X84ed7765) add("InlineV1InvoicesPostRequestFormOnBehalfOfAnyOf2X84ed7765: value does not match InlineV1InvoicesPostRequestFormOnBehalfOfAnyOf2X84ed7765")
    },
  )
}
