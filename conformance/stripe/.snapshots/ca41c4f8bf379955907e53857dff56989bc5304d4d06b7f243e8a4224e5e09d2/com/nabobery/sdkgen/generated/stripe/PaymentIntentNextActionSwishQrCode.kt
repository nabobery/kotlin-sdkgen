...
public class PaymentIntentNextActionSwishQrCode(
  ...
  internal object Serializer : KSerializer<PaymentIntentNextActionSwishQrCode> {
    ...
    override fun deserialize(decoder: Decoder): PaymentIntentNextActionSwishQrCode {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("PaymentIntentNextActionSwishQrCode must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: PaymentIntentNextActionSwishQrCode) {
...
public fun paymentIntentNextActionSwishQrCode(block: PaymentIntentNextActionSwishQrCode.Builder.() -> Unit): PaymentIntentNextActionSwishQrCode = PaymentIntentNextActionSwishQrCode.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("PaymentIntentNextActionSwishQrCode is missing required property '" + name + "'")
