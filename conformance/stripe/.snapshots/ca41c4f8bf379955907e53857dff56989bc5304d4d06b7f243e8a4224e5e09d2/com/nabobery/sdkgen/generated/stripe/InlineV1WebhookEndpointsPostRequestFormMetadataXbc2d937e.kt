...
internal data class InlineV1WebhookEndpointsPostRequestFormMetadataXbc2d937eInspection(
  ...
  public val matchCount: Int
    get() = listOf(matchesBranch1, matchesInlineV1WebhookEndpointsPostRequestFormMetadataAnyOf2X61474b6c).count { it }
}
...
public class InlineV1WebhookEndpointsPostRequestFormMetadataXbc2d937e internal constructor(
  ...
  public val inlineV1WebhookEndpointsPostRequestFormMetadataAnyOf2X61474b6c:
      ...
      lazy(LazyThreadSafetyMode.NONE) { if (inspection.matchesInlineV1WebhookEndpointsPostRequestFormMetadataAnyOf2X61474b6c) json.decodeFromJsonElement<InlineV1WebhookEndpointsPostRequestFormMetadataAnyOf2X61474b6c>(raw) else null }

  public val matchedBranches: Set<InlineV1WebhookEndpointsPostRequestFormMetadataXbc2d937eBranch>
    get() = buildSet {
      if (inspection.matchesBranch1) add(InlineV1WebhookEndpointsPostRequestFormMetadataXbc2d937eBranch.Branch1)
      if (inspection.matchesInlineV1WebhookEndpointsPostRequestFormMetadataAnyOf2X61474b6c) add(InlineV1WebhookEndpointsPostRequestFormMetadataXbc2d937eBranch.InlineV1WebhookEndpointsPostRequestFormMetadataAnyOf2X61474b6c)
    }
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineV1WebhookEndpointsPostRequestFormMetadataXbc2d937e {
      val inspection = inspectInlineV1WebhookEndpointsPostRequestFormMetadataXbc2d937e(raw)
      if (inspection.matchCount == 0) {
        throw InlineV1WebhookEndpointsPostRequestFormMetadataXbc2d937eNoMatchException("InlineV1WebhookEndpointsPostRequestFormMetadataXbc2d937e matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineV1WebhookEndpointsPostRequestFormMetadataXbc2d937e(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineV1WebhookEndpointsPostRequestFormMetadataXbc2d937e> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1WebhookEndpointsPostRequestFormMetadataXbc2d937e) {
      encoder.requireJsonEncoder("InlineV1WebhookEndpointsPostRequestFormMetadataXbc2d937e").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineV1WebhookEndpointsPostRequestFormMetadataXbc2d937e(element: JsonElement): InlineV1WebhookEndpointsPostRequestFormMetadataXbc2d937eInspection {
  val matchesBranch1 = element.isJsonDecodable<JsonObject>()
  val matchesInlineV1WebhookEndpointsPostRequestFormMetadataAnyOf2X61474b6c = element.isJsonDecodable<InlineV1WebhookEndpointsPostRequestFormMetadataAnyOf2X61474b6c>()
  return InlineV1WebhookEndpointsPostRequestFormMetadataXbc2d937eInspection(
    ...
    failures = buildList {
      ...
      if (!matchesInlineV1WebhookEndpointsPostRequestFormMetadataAnyOf2X61474b6c) add("InlineV1WebhookEndpointsPostRequestFormMetadataAnyOf2X61474b6c: value does not match InlineV1WebhookEndpointsPostRequestFormMetadataAnyOf2X61474b6c")
    },
  )
}
