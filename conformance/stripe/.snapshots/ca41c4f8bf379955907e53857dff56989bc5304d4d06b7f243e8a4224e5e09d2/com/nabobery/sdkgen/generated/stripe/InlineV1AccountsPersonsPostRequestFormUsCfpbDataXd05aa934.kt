...
public class InlineV1AccountsPersonsPostRequestFormUsCfpbDataXd05aa934(
  ...
  public val raceDetails:
      InlineV1AccountsPersonsPostRequestFormUsCfpbDataRaceDetailsXac08eb78? = null,
  ...
  public class Builder {
    ...
    public fun build(): InlineV1AccountsPersonsPostRequestFormUsCfpbDataXd05aa934 = InlineV1AccountsPersonsPostRequestFormUsCfpbDataXd05aa934(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1AccountsPersonsPostRequestFormUsCfpbDataXd05aa934 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1AccountsPersonsPostRequestFormUsCfpbDataXd05aa934> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1AccountsPersonsPostRequestFormUsCfpbDataXd05aa934 {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1AccountsPersonsPostRequestFormUsCfpbDataXd05aa934 must be a JSON object")
      return InlineV1AccountsPersonsPostRequestFormUsCfpbDataXd05aa934(
        ethnicityDetails = rawObject["ethnicity_details"]?.let { json.decodeFromJsonElement<InlineV1AccountsPersonsPostRequestFormUsCfpbDataEthnicityDetailsX923c55c2>(it) },
        raceDetails = rawObject["race_details"]?.let { json.decodeFromJsonElement<InlineV1AccountsPersonsPostRequestFormUsCfpbDataRaceDetailsXac08eb78>(it) },
        selfIdentifiedGender = rawObject["self_identified_gender"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineV1AccountsPersonsPostRequestFormUsCfpbDataXd05aa934) {
...
public fun inlineV1AccountsPersonsPostRequestFormUsCfpbDataXd05aa934(block: InlineV1AccountsPersonsPostRequestFormUsCfpbDataXd05aa934.Builder.() -> Unit): InlineV1AccountsPersonsPostRequestFormUsCfpbDataXd05aa934 = InlineV1AccountsPersonsPostRequestFormUsCfpbDataXd05aa934.build(block)
