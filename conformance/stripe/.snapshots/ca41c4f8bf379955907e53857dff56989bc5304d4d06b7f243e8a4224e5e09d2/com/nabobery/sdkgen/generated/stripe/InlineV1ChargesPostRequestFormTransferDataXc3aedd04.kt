...
public class InlineV1ChargesPostRequestFormTransferDataXc3aedd04(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1ChargesPostRequestFormTransferDataXc3aedd04 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1ChargesPostRequestFormTransferDataXc3aedd04> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1ChargesPostRequestFormTransferDataXc3aedd04 {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1ChargesPostRequestFormTransferDataXc3aedd04 must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1ChargesPostRequestFormTransferDataXc3aedd04) {
...
public fun inlineV1ChargesPostRequestFormTransferDataXc3aedd04(block: InlineV1ChargesPostRequestFormTransferDataXc3aedd04.Builder.() -> Unit): InlineV1ChargesPostRequestFormTransferDataXc3aedd04 = InlineV1ChargesPostRequestFormTransferDataXc3aedd04.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineV1ChargesPostRequestFormTransferDataXc3aedd04 is missing required property '" + name + "'")
