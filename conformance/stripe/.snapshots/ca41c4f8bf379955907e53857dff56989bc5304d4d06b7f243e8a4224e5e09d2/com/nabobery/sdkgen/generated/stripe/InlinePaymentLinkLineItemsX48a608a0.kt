...
public class InlinePaymentLinkLineItemsX48a608a0(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlinePaymentLinkLineItemsX48a608a0 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlinePaymentLinkLineItemsX48a608a0> {
    ...
    override fun deserialize(decoder: Decoder): InlinePaymentLinkLineItemsX48a608a0 {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlinePaymentLinkLineItemsX48a608a0 must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlinePaymentLinkLineItemsX48a608a0) {
...
public fun inlinePaymentLinkLineItemsX48a608a0(block: InlinePaymentLinkLineItemsX48a608a0.Builder.() -> Unit): InlinePaymentLinkLineItemsX48a608a0 = InlinePaymentLinkLineItemsX48a608a0.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlinePaymentLinkLineItemsX48a608a0 is missing required property '" + name + "'")
