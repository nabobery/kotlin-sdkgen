...
public class InlineV1AccountsPostRequestFormDocumentsXe7387a38(
  ...
  public val companyLicense:
      InlineV1AccountsPostRequestFormDocumentsCompanyLicenseX39466ea6? = null,
  ...
  public val proofOfAddress:
      InlineV1AccountsPostRequestFormDocumentsProofOfAddressX19ec63f3? = null,
  ...
  public class Builder {
    ...
    public fun build(): InlineV1AccountsPostRequestFormDocumentsXe7387a38 = InlineV1AccountsPostRequestFormDocumentsXe7387a38(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1AccountsPostRequestFormDocumentsXe7387a38 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1AccountsPostRequestFormDocumentsXe7387a38> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1AccountsPostRequestFormDocumentsXe7387a38 {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1AccountsPostRequestFormDocumentsXe7387a38 must be a JSON object")
      return InlineV1AccountsPostRequestFormDocumentsXe7387a38(
        bankAccountOwnershipVerification = rawObject["bank_account_ownership_verification"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormDocumentsBankAccountOwnership2a7eX9d88d873>(it) },
        companyLicense = rawObject["company_license"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormDocumentsCompanyLicenseX39466ea6>(it) },
        companyMemorandumOfAssociation = rawObject["company_memorandum_of_association"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormDocumentsCompanyMemorandumOfAssociationX80949ef2>(it) },
        companyMinisterialDecree = rawObject["company_ministerial_decree"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormDocumentsCompanyMinisterialDecreeX4c2fa998>(it) },
        companyRegistrationVerification = rawObject["company_registration_verification"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormDocumentsCompanyRegistrationVerificationXff986ea0>(it) },
        companyTaxIdVerification = rawObject["company_tax_id_verification"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormDocumentsCompanyTaxIdVerificationX110cc135>(it) },
        proofOfAddress = rawObject["proof_of_address"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormDocumentsProofOfAddressX19ec63f3>(it) },
        proofOfRegistration = rawObject["proof_of_registration"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormDocumentsProofOfRegistrationXe7e0491e>(it) },
        proofOfUltimateBeneficialOwnership = rawObject["proof_of_ultimate_beneficial_ownership"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormDocumentsProofOfUltimateBenefebd6Xf05366c4>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineV1AccountsPostRequestFormDocumentsXe7387a38) {
...
public fun inlineV1AccountsPostRequestFormDocumentsXe7387a38(block: InlineV1AccountsPostRequestFormDocumentsXe7387a38.Builder.() -> Unit): InlineV1AccountsPostRequestFormDocumentsXe7387a38 = InlineV1AccountsPostRequestFormDocumentsXe7387a38.build(block)
