...
public class RefundDestinationDetailsCrypto(
  ...
  public class Builder {
    ...
    public fun build(): RefundDestinationDetailsCrypto = RefundDestinationDetailsCrypto(
      reference = reference,
    )
  }
  ...
  internal object Serializer : KSerializer<RefundDestinationDetailsCrypto> {
    ...
    override fun deserialize(decoder: Decoder): RefundDestinationDetailsCrypto {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("RefundDestinationDetailsCrypto must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: RefundDestinationDetailsCrypto) {
...
public fun refundDestinationDetailsCrypto(block: RefundDestinationDetailsCrypto.Builder.() -> Unit): RefundDestinationDetailsCrypto = RefundDestinationDetailsCrypto.build(block)
