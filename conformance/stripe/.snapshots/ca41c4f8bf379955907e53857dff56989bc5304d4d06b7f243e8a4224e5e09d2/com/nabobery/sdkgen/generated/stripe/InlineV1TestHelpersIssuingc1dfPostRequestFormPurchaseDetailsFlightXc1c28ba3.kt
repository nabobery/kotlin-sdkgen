...
public class InlineV1TestHelpersIssuingc1dfPostRequestFormPurchaseDetailsFlightXc1c28ba3(
  ...
  segments: List<InlineV1TestHelpersIssuingc1dfPostRequestFormPurchaseDetailsFlightItemX35460fd1>? = null,
  ...
  public class Builder {
    ...
    public fun build(): InlineV1TestHelpersIssuingc1dfPostRequestFormPurchaseDetailsFlightXc1c28ba3 = InlineV1TestHelpersIssuingc1dfPostRequestFormPurchaseDetailsFlightXc1c28ba3(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1TestHelpersIssuingc1dfPostRequestFormPurchaseDetailsFlightXc1c28ba3 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1TestHelpersIssuingc1dfPostRequestFormPurchaseDetailsFlightXc1c28ba3> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineV1TestHelpersIssuingc1dfPostRequestFormPurchaseDetailsFlightXc1c28ba3 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineV1TestHelpersIssuingc1dfPostRequestFormPurchaseDetailsFlightXc1c28ba3")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1TestHelpersIssuingc1dfPostRequestFormPurchaseDetailsFlightXc1c28ba3 must be a JSON object")
      return InlineV1TestHelpersIssuingc1dfPostRequestFormPurchaseDetailsFlightXc1c28ba3(
        ...
        segments = rawObject["segments"]?.let { json.decodeFromJsonElement<List<InlineV1TestHelpersIssuingc1dfPostRequestFormPurchaseDetailsFlightItemX35460fd1>>(it) },
        travelAgency = rawObject["travel_agency"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineV1TestHelpersIssuingc1dfPostRequestFormPurchaseDetailsFlightXc1c28ba3) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineV1TestHelpersIssuingc1dfPostRequestFormPurchaseDetailsFlightXc1c28ba3")
...
public fun inlineV1TestHelpersIssuingc1dfPostRequestFormPurchaseDetailsFlightXc1c28ba3(block: InlineV1TestHelpersIssuingc1dfPostRequestFormPurchaseDetailsFlightXc1c28ba3.Builder.() -> Unit): InlineV1TestHelpersIssuingc1dfPostRequestFormPurchaseDetailsFlightXc1c28ba3 = InlineV1TestHelpersIssuingc1dfPostRequestFormPurchaseDetailsFlightXc1c28ba3.build(block)
