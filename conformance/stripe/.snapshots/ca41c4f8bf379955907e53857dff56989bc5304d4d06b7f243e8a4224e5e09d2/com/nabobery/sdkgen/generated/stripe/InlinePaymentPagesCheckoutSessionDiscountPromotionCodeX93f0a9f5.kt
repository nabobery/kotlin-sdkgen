...
public class InlinePaymentPagesCheckoutSessionDiscountPromotionCodeX93f0a9f5 internal constructor(
  ...
  public val matchedBranches:
    ...
    get() = buildSet {
      if (inspection.matchesBranch1) add(InlinePaymentPagesCheckoutSessionDiscountPromotionCodeX93f0a9f5Branch.Branch1)
      if (inspection.matchesPromotionCode) add(InlinePaymentPagesCheckoutSessionDiscountPromotionCodeX93f0a9f5Branch.PromotionCode)
    }
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlinePaymentPagesCheckoutSessionDiscountPromotionCodeX93f0a9f5 {
      val inspection = inspectInlinePaymentPagesCheckoutSessionDiscountPromotionCodeX93f0a9f5(raw)
      if (inspection.matchCount == 0) {
        throw InlinePaymentPagesCheckoutSessionDiscountPromotionCodeX93f0a9f5NoMatchException("InlinePaymentPagesCheckoutSessionDiscountPromotionCodeX93f0a9f5 matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlinePaymentPagesCheckoutSessionDiscountPromotionCodeX93f0a9f5(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlinePaymentPagesCheckoutSessionDiscountPromotionCodeX93f0a9f5> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlinePaymentPagesCheckoutSessionDiscountPromotionCodeX93f0a9f5 {
      val jsonDecoder = decoder.requireJsonDecoder("InlinePaymentPagesCheckoutSessionDiscountPromotionCodeX93f0a9f5")
      return fromRaw(jsonDecoder.decodeJsonElement(), jsonDecoder.json)
    }

    override fun serialize(encoder: Encoder, `value`: InlinePaymentPagesCheckoutSessionDiscountPromotionCodeX93f0a9f5) {
      encoder.requireJsonEncoder("InlinePaymentPagesCheckoutSessionDiscountPromotionCodeX93f0a9f5").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlinePaymentPagesCheckoutSessionDiscountPromotionCodeX93f0a9f5(element: JsonElement): InlinePaymentPagesCheckoutSessionDiscountPromotionCodeX93f0a9f5Inspection {
