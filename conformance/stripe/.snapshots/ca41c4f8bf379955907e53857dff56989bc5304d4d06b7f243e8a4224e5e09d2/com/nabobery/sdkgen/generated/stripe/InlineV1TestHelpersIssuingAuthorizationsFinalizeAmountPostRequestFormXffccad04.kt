...
public class InlineV1TestHelpersIssuingAuthorizationsFinalizeAmountPostRequestFormXffccad04(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1TestHelpersIssuingAuthorizationsFinalizeAmountPostRequestFormXffccad04 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1TestHelpersIssuingAuthorizationsFinalizeAmountPostRequestFormXffccad04> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineV1TestHelpersIssuingAuthorizationsFinalizeAmountPostRequestFormXffccad04 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineV1TestHelpersIssuingAuthorizationsFinalizeAmountPostRequestFormXffccad04")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1TestHelpersIssuingAuthorizationsFinalizeAmountPostRequestFormXffccad04 must be a JSON object")
      val finalAmount = json.decodeRequired<Int>(rawObject, "final_amount")
      return InlineV1TestHelpersIssuingAuthorizationsFinalizeAmountPostRequestFormXffccad04(
        finalAmount = finalAmount,
        expand = rawObject["expand"]?.let { json.decodeFromJsonElement<List<String>>(it) },
        fleet = rawObject["fleet"]?.let { json.decodeFromJsonElement<InlineV1TestHelpersIssuing6a15PostRequestFormFleetXf18649be>(it) },
        fuel = rawObject["fuel"]?.let { json.decodeFromJsonElement<InlineV1TestHelpersIssuing6a15PostRequestFormFuelX5df6fa3d>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineV1TestHelpersIssuingAuthorizationsFinalizeAmountPostRequestFormXffccad04) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineV1TestHelpersIssuingAuthorizationsFinalizeAmountPostRequestFormXffccad04")
...
public fun inlineV1TestHelpersIssuingAuthorizationsFinalizeAmountPostRequestFormXffccad04(block: InlineV1TestHelpersIssuingAuthorizationsFinalizeAmountPostRequestFormXffccad04.Builder.() -> Unit): InlineV1TestHelpersIssuingAuthorizationsFinalizeAmountPostRequestFormXffccad04 = InlineV1TestHelpersIssuingAuthorizationsFinalizeAmountPostRequestFormXffccad04.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineV1TestHelpersIssuingAuthorizationsFinalizeAmountPostRequestFormXffccad04 is missing required property '" + name + "'")
