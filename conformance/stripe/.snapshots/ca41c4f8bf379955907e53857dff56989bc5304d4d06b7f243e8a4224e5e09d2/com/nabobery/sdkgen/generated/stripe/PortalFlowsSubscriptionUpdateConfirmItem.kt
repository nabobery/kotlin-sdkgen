...
public class PortalFlowsSubscriptionUpdateConfirmItem(
  ...
  public class Builder {
    ...
    public fun build(): PortalFlowsSubscriptionUpdateConfirmItem = PortalFlowsSubscriptionUpdateConfirmItem(
      id = id,
      price = price,
      quantity = quantity,
    )
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): PortalFlowsSubscriptionUpdateConfirmItem = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<PortalFlowsSubscriptionUpdateConfirmItem> {
    ...
    override fun deserialize(decoder: Decoder): PortalFlowsSubscriptionUpdateConfirmItem {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("PortalFlowsSubscriptionUpdateConfirmItem must be a JSON object")
      return PortalFlowsSubscriptionUpdateConfirmItem(
        ...
        price = rawObject["price"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<String?>(element) },
        quantity = rawObject["quantity"]?.let { json.decodeFromJsonElement<Int>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: PortalFlowsSubscriptionUpdateConfirmItem) {
...
public fun portalFlowsSubscriptionUpdateConfirmItem(block: PortalFlowsSubscriptionUpdateConfirmItem.Builder.() -> Unit): PortalFlowsSubscriptionUpdateConfirmItem = PortalFlowsSubscriptionUpdateConfirmItem.build(block)
