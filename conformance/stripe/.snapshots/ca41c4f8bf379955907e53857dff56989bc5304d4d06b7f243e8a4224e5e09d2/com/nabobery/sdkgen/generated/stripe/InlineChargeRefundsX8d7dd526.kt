...
public class InlineChargeRefundsX8d7dd526(
  ...
  internal object Serializer : KSerializer<InlineChargeRefundsX8d7dd526> {
    ...
    override fun deserialize(decoder: Decoder): InlineChargeRefundsX8d7dd526 {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineChargeRefundsX8d7dd526 must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineChargeRefundsX8d7dd526) {
...
public fun inlineChargeRefundsX8d7dd526(block: InlineChargeRefundsX8d7dd526.Builder.() -> Unit): InlineChargeRefundsX8d7dd526 = InlineChargeRefundsX8d7dd526.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineChargeRefundsX8d7dd526 is missing required property '" + name + "'")
