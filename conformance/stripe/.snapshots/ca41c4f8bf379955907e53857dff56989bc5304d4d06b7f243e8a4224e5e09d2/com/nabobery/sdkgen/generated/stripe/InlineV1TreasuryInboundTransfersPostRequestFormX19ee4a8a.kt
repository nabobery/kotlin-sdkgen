...
public class InlineV1TreasuryInboundTransfersPostRequestFormX19ee4a8a(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1TreasuryInboundTransfersPostRequestFormX19ee4a8a = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1TreasuryInboundTransfersPostRequestFormX19ee4a8a> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1TreasuryInboundTransfersPostRequestFormX19ee4a8a {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1TreasuryInboundTransfersPostRequestFormX19ee4a8a must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1TreasuryInboundTransfersPostRequestFormX19ee4a8a) {
...
public fun inlineV1TreasuryInboundTransfersPostRequestFormX19ee4a8a(block: InlineV1TreasuryInboundTransfersPostRequestFormX19ee4a8a.Builder.() -> Unit): InlineV1TreasuryInboundTransfersPostRequestFormX19ee4a8a = InlineV1TreasuryInboundTransfersPostRequestFormX19ee4a8a.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineV1TreasuryInboundTransfersPostRequestFormX19ee4a8a is missing required property '" + name + "'")
