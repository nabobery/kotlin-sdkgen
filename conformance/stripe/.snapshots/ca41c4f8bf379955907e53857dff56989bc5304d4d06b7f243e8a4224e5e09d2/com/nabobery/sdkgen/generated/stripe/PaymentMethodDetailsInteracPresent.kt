 ...
 *
 *
 * Source: sdkgen://source/openapi.json#/components/schemas/payment_method_details_interac_present
 */
@Serializable(with = PaymentMethodDetailsInteracPresent.Serializer::class)
public class PaymentMethodDetailsInteracPresent(
   ...
   */
  public val readMethod: InlinePaymentMethodDetailsInteracPresentReadMethodX79c13c3e? = null,
  /**
   ...
   */
  public val receipt: InlinePaymentMethodDetailsInteracPresentReceiptX19411264? = null,
) {
  /**
  ...
  public class Builder {
     ...
     * How card details were read in this transaction.
     */
    public var readMethod: InlinePaymentMethodDetailsInteracPresentReadMethodX79c13c3e? = null
     ...
     * A collection of fields required to be displayed on receipts. Only required for EMV transactions.
     */
    public var receipt: InlinePaymentMethodDetailsInteracPresentReceiptX19411264? = null

    public fun build(): PaymentMethodDetailsInteracPresent {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): PaymentMethodDetailsInteracPresent = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<PaymentMethodDetailsInteracPresent> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): PaymentMethodDetailsInteracPresent {
      val jsonDecoder = decoder.requireJsonDecoder("PaymentMethodDetailsInteracPresent")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("PaymentMethodDetailsInteracPresent must be a JSON object")
      ...
      return PaymentMethodDetailsInteracPresent(
        ...
        emvAuthData = rawObject["emv_auth_data"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<String?>(element) },
        ...
        generatedCard = rawObject["generated_card"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<String?>(element) },
        ...
        readMethod = rawObject["read_method"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlinePaymentMethodDetailsInteracPresentReadMethodX79c13c3e?>(element) },
        reader = rawObject["reader"]?.let { json.decodeFromJsonElement<String>(it) },
        receipt = rawObject["receipt"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlinePaymentMethodDetailsInteracPresentReceiptX19411264?>(element) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: PaymentMethodDetailsInteracPresent) {
      val jsonEncoder = encoder.requireJsonEncoder("PaymentMethodDetailsInteracPresent")
...
public fun paymentMethodDetailsInteracPresent(block: PaymentMethodDetailsInteracPresent.Builder.() -> Unit): PaymentMethodDetailsInteracPresent = PaymentMethodDetailsInteracPresent.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("PaymentMethodDetailsInteracPresent is missing required property '" + name + "'")
