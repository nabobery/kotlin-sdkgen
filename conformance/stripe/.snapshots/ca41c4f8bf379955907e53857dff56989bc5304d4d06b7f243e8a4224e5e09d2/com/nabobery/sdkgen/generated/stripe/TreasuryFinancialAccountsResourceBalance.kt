...
public class TreasuryFinancialAccountsResourceBalance(
  cash: Map<String, Int>,
  inboundPending: Map<String, Int>,
  outboundPending: Map<String, Int>,
) {
  /**
   * Funds the user can spend right now.
   */
  public val cash: Map<String, Int> = cash.toMap()

  /**
   * Funds not spendable yet, but will become available at a later time.
   */
  public val inboundPending: Map<String, Int> = inboundPending.toMap()

  /**
   * Funds in the account, but not spendable because they are being held for pending outbound flows.
   */
  public val outboundPending: Map<String, Int> = outboundPending.toMap()

  public class Builder {
    private var cashValue: Map<String, Int>? = null

    public var cash: Map<String, Int>
      get() = requireNotNull(cashValue) { "cash is required" }.toMap()
      set(`value`) {
        cashValue = value.toMap()
      }

    private var inboundPendingValue: Map<String, Int>? = null

    public var inboundPending: Map<String, Int>
      get() = requireNotNull(inboundPendingValue) { "inboundPending is required" }.toMap()
      set(`value`) {
        inboundPendingValue = value.toMap()
      }

    private var outboundPendingValue: Map<String, Int>? = null

    public var outboundPending: Map<String, Int>
      get() = requireNotNull(outboundPendingValue) { "outboundPending is required" }.toMap()
      set(`value`) {
        outboundPendingValue = value.toMap()
      }
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): TreasuryFinancialAccountsResourceBalance = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<TreasuryFinancialAccountsResourceBalance> {
    ...
    override fun deserialize(decoder: Decoder): TreasuryFinancialAccountsResourceBalance {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("TreasuryFinancialAccountsResourceBalance must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: TreasuryFinancialAccountsResourceBalance) {
...
public fun treasuryFinancialAccountsResourceBalance(block: TreasuryFinancialAccountsResourceBalance.Builder.() -> Unit): TreasuryFinancialAccountsResourceBalance = TreasuryFinancialAccountsResourceBalance.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("TreasuryFinancialAccountsResourceBalance is missing required property '" + name + "'")
