...
public class InlineV1SourcesPostRequestFormSourceOrderShippingAddressX40073de9(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1SourcesPostRequestFormSourceOrderShippingAddressX40073de9 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1SourcesPostRequestFormSourceOrderShippingAddressX40073de9> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineV1SourcesPostRequestFormSourceOrderShippingAddressX40073de9 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineV1SourcesPostRequestFormSourceOrderShippingAddressX40073de9")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1SourcesPostRequestFormSourceOrderShippingAddressX40073de9 must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1SourcesPostRequestFormSourceOrderShippingAddressX40073de9) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineV1SourcesPostRequestFormSourceOrderShippingAddressX40073de9")
...
public fun inlineV1SourcesPostRequestFormSourceOrderShippingAddressX40073de9(block: InlineV1SourcesPostRequestFormSourceOrderShippingAddressX40073de9.Builder.() -> Unit): InlineV1SourcesPostRequestFormSourceOrderShippingAddressX40073de9 = InlineV1SourcesPostRequestFormSourceOrderShippingAddressX40073de9.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineV1SourcesPostRequestFormSourceOrderShippingAddressX40073de9 is missing required property '" + name + "'")
