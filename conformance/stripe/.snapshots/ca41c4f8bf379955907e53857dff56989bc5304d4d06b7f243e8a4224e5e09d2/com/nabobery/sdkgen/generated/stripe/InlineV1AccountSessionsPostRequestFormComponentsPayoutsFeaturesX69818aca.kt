...
public class InlineV1AccountSessionsPostRequestFormComponentsPayoutsFeaturesX69818aca(
  ...
  public class Builder {
    ...
    public fun build(): InlineV1AccountSessionsPostRequestFormComponentsPayoutsFeaturesX69818aca = InlineV1AccountSessionsPostRequestFormComponentsPayoutsFeaturesX69818aca(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1AccountSessionsPostRequestFormComponentsPayoutsFeaturesX69818aca = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1AccountSessionsPostRequestFormComponentsPayoutsFeaturesX69818aca> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineV1AccountSessionsPostRequestFormComponentsPayoutsFeaturesX69818aca {
      val jsonDecoder = decoder.requireJsonDecoder("InlineV1AccountSessionsPostRequestFormComponentsPayoutsFeaturesX69818aca")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1AccountSessionsPostRequestFormComponentsPayoutsFeaturesX69818aca must be a JSON object")
      return InlineV1AccountSessionsPostRequestFormComponentsPayoutsFeaturesX69818aca(
        ...
        editPayoutSchedule = rawObject["edit_payout_schedule"]?.let { json.decodeFromJsonElement<Boolean>(it) },
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1AccountSessionsPostRequestFormComponentsPayoutsFeaturesX69818aca) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineV1AccountSessionsPostRequestFormComponentsPayoutsFeaturesX69818aca")
...
public fun inlineV1AccountSessionsPostRequestFormComponentsPayoutsFeaturesX69818aca(block: InlineV1AccountSessionsPostRequestFormComponentsPayoutsFeaturesX69818aca.Builder.() -> Unit): InlineV1AccountSessionsPostRequestFormComponentsPayoutsFeaturesX69818aca = InlineV1AccountSessionsPostRequestFormComponentsPayoutsFeaturesX69818aca.build(block)
