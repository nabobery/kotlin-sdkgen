...
public class InlineV1ProductsPostRequestFormDescriptionX1695ae95 internal constructor(
  ...
  public val inlineV1ProductsPostRequestFormDescriptionAnyOf2X5ced3a8d:
      ...
      lazy(LazyThreadSafetyMode.NONE) { if (inspection.matchesInlineV1ProductsPostRequestFormDescriptionAnyOf2X5ced3a8d) json.decodeFromJsonElement<InlineV1ProductsPostRequestFormDescriptionAnyOf2X5ced3a8d>(raw) else null }
  ...
  public val matchedBranches: Set<InlineV1ProductsPostRequestFormDescriptionX1695ae95Branch>
    get() = buildSet {
      ...
      if (inspection.matchesInlineV1ProductsPostRequestFormDescriptionAnyOf2X5ced3a8d) add(InlineV1ProductsPostRequestFormDescriptionX1695ae95Branch.InlineV1ProductsPostRequestFormDescriptionAnyOf2X5ced3a8d)
    }
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineV1ProductsPostRequestFormDescriptionX1695ae95 {
      val inspection = inspectInlineV1ProductsPostRequestFormDescriptionX1695ae95(raw)
      if (inspection.matchCount == 0) {
        throw InlineV1ProductsPostRequestFormDescriptionX1695ae95NoMatchException("InlineV1ProductsPostRequestFormDescriptionX1695ae95 matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineV1ProductsPostRequestFormDescriptionX1695ae95(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineV1ProductsPostRequestFormDescriptionX1695ae95> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1ProductsPostRequestFormDescriptionX1695ae95) {
      encoder.requireJsonEncoder("InlineV1ProductsPostRequestFormDescriptionX1695ae95").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineV1ProductsPostRequestFormDescriptionX1695ae95(element: JsonElement): InlineV1ProductsPostRequestFormDescriptionX1695ae95Inspection {
  val matchesBranch1 = element.isJsonDecodable<String>()
  val matchesInlineV1ProductsPostRequestFormDescriptionAnyOf2X5ced3a8d = element.isJsonDecodable<InlineV1ProductsPostRequestFormDescriptionAnyOf2X5ced3a8d>()
  return InlineV1ProductsPostRequestFormDescriptionX1695ae95Inspection(
    ...
    failures = buildList {
      ...
      if (!matchesInlineV1ProductsPostRequestFormDescriptionAnyOf2X5ced3a8d) add("InlineV1ProductsPostRequestFormDescriptionAnyOf2X5ced3a8d: value does not match InlineV1ProductsPostRequestFormDescriptionAnyOf2X5ced3a8d")
    },
  )
}
