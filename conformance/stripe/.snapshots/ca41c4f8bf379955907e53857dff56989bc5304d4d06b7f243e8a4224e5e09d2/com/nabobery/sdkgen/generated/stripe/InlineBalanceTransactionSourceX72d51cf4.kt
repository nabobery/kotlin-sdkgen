...
internal data class InlineBalanceTransactionSourceX72d51cf4Inspection(
  ...
  public val matchCount: Int
    get() = listOf(matchesBranch1, matchesApplicationFee, matchesCharge, matchesConnectCollectionTransfer, matchesCustomerCashBalanceTransaction, matchesDispute, matchesFeeRefund, matchesIssuingAuthorization, matchesIssuingDispute, matchesIssuingTransaction, matchesPayout, matchesRefund, matchesReserveTransaction, matchesTaxDeductedAtSource, matchesTopup, matchesTransfer, matchesTransferReversal).count { it }
}
...
public class InlineBalanceTransactionSourceX72d51cf4 internal constructor(
  ...
  public val connectCollectionTransfer: ConnectCollectionTransfer? by
      lazy(LazyThreadSafetyMode.NONE) { if (inspection.matchesConnectCollectionTransfer) json.decodeFromJsonElement<ConnectCollectionTransfer>(raw) else null }

  public val customerCashBalanceTransaction: CustomerCashBalanceTransaction? by
      lazy(LazyThreadSafetyMode.NONE) { if (inspection.matchesCustomerCashBalanceTransaction) json.decodeFromJsonElement<CustomerCashBalanceTransaction>(raw) else null }

  public val dispute: Dispute? by
      lazy(LazyThreadSafetyMode.NONE) { if (inspection.matchesDispute) json.decodeFromJsonElement<Dispute>(raw) else null }

  public val feeRefund: FeeRefund? by
      lazy(LazyThreadSafetyMode.NONE) { if (inspection.matchesFeeRefund) json.decodeFromJsonElement<FeeRefund>(raw) else null }
  ...
  public val reserveTransaction: ReserveTransaction? by
      lazy(LazyThreadSafetyMode.NONE) { if (inspection.matchesReserveTransaction) json.decodeFromJsonElement<ReserveTransaction>(raw) else null }

  public val taxDeductedAtSource: TaxDeductedAtSource? by
      lazy(LazyThreadSafetyMode.NONE) { if (inspection.matchesTaxDeductedAtSource) json.decodeFromJsonElement<TaxDeductedAtSource>(raw) else null }

  public val topup: Topup? by
      lazy(LazyThreadSafetyMode.NONE) { if (inspection.matchesTopup) json.decodeFromJsonElement<Topup>(raw) else null }
  ...
  public val matchedBranches: Set<InlineBalanceTransactionSourceX72d51cf4Branch>
    get() = buildSet {
      ...
      if (inspection.matchesConnectCollectionTransfer) add(InlineBalanceTransactionSourceX72d51cf4Branch.ConnectCollectionTransfer)
      if (inspection.matchesCustomerCashBalanceTransaction) add(InlineBalanceTransactionSourceX72d51cf4Branch.CustomerCashBalanceTransaction)
      ...
      if (inspection.matchesIssuingAuthorization) add(InlineBalanceTransactionSourceX72d51cf4Branch.IssuingAuthorization)
      if (inspection.matchesIssuingDispute) add(InlineBalanceTransactionSourceX72d51cf4Branch.IssuingDispute)
      if (inspection.matchesIssuingTransaction) add(InlineBalanceTransactionSourceX72d51cf4Branch.IssuingTransaction)
      ...
      if (inspection.matchesReserveTransaction) add(InlineBalanceTransactionSourceX72d51cf4Branch.ReserveTransaction)
      if (inspection.matchesTaxDeductedAtSource) add(InlineBalanceTransactionSourceX72d51cf4Branch.TaxDeductedAtSource)
      ...
      if (inspection.matchesTransferReversal) add(InlineBalanceTransactionSourceX72d51cf4Branch.TransferReversal)
    }
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineBalanceTransactionSourceX72d51cf4 {
      val inspection = inspectInlineBalanceTransactionSourceX72d51cf4(raw)
      if (inspection.matchCount == 0) {
        throw InlineBalanceTransactionSourceX72d51cf4NoMatchException("InlineBalanceTransactionSourceX72d51cf4 matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineBalanceTransactionSourceX72d51cf4(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineBalanceTransactionSourceX72d51cf4> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineBalanceTransactionSourceX72d51cf4) {
      encoder.requireJsonEncoder("InlineBalanceTransactionSourceX72d51cf4").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineBalanceTransactionSourceX72d51cf4(element: JsonElement): InlineBalanceTransactionSourceX72d51cf4Inspection {
  ...
  return InlineBalanceTransactionSourceX72d51cf4Inspection(
    ...
    failures = buildList {
      ...
      if (!matchesConnectCollectionTransfer) add("ConnectCollectionTransfer: value does not match ConnectCollectionTransfer")
      if (!matchesCustomerCashBalanceTransaction) add("CustomerCashBalanceTransaction: value does not match CustomerCashBalanceTransaction")
