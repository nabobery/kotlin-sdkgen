...
public class InlineV1ChargesRefundPostRequestFormX2fe0e159(
  ...
  public class Builder {
    ...
    public fun build(): InlineV1ChargesRefundPostRequestFormX2fe0e159 = InlineV1ChargesRefundPostRequestFormX2fe0e159(
      amount = amount,
      expand = expand,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1ChargesRefundPostRequestFormX2fe0e159 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1ChargesRefundPostRequestFormX2fe0e159> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1ChargesRefundPostRequestFormX2fe0e159 {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1ChargesRefundPostRequestFormX2fe0e159 must be a JSON object")
      return InlineV1ChargesRefundPostRequestFormX2fe0e159(
        ...
        metadata = rawObject["metadata"]?.let { json.decodeFromJsonElement<InlineV1ChargesRefundPostRequestFormMetadataXa66ffa22>(it) },
        paymentIntent = rawObject["payment_intent"]?.let { json.decodeFromJsonElement<String>(it) },
        reason = rawObject["reason"]?.let { json.decodeFromJsonElement<InlineV1ChargesRefundPostRequestFormReasonXe2a87827>(it) },
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1ChargesRefundPostRequestFormX2fe0e159) {
...
public fun inlineV1ChargesRefundPostRequestFormX2fe0e159(block: InlineV1ChargesRefundPostRequestFormX2fe0e159.Builder.() -> Unit): InlineV1ChargesRefundPostRequestFormX2fe0e159 = InlineV1ChargesRefundPostRequestFormX2fe0e159.build(block)
