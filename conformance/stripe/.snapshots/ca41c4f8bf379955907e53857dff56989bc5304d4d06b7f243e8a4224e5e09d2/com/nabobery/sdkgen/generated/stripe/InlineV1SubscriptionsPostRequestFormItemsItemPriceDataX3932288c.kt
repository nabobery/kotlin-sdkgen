...
public class InlineV1SubscriptionsPostRequestFormItemsItemPriceDataX3932288c(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1SubscriptionsPostRequestFormItemsItemPriceDataX3932288c = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1SubscriptionsPostRequestFormItemsItemPriceDataX3932288c> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineV1SubscriptionsPostRequestFormItemsItemPriceDataX3932288c {
      val jsonDecoder = decoder.requireJsonDecoder("InlineV1SubscriptionsPostRequestFormItemsItemPriceDataX3932288c")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1SubscriptionsPostRequestFormItemsItemPriceDataX3932288c must be a JSON object")
      val currency = json.decodeRequired<String>(rawObject, "currency")
      val product = json.decodeRequired<String>(rawObject, "product")
      val recurring = json.decodeRequired<InlineV1SubscriptionsPostRequestFormItemsItemPriceDataRecurringX54769f3e>(rawObject, "recurring")
      return InlineV1SubscriptionsPostRequestFormItemsItemPriceDataX3932288c(
        currency = currency,
        product = product,
        recurring = recurring,
        taxBehavior = rawObject["tax_behavior"]?.let { json.decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormItemsItemPriceDataTaxBehaviorXa5623a86>(it) },
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1SubscriptionsPostRequestFormItemsItemPriceDataX3932288c) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineV1SubscriptionsPostRequestFormItemsItemPriceDataX3932288c")
...
public fun inlineV1SubscriptionsPostRequestFormItemsItemPriceDataX3932288c(block: InlineV1SubscriptionsPostRequestFormItemsItemPriceDataX3932288c.Builder.() -> Unit): InlineV1SubscriptionsPostRequestFormItemsItemPriceDataX3932288c = InlineV1SubscriptionsPostRequestFormItemsItemPriceDataX3932288c.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineV1SubscriptionsPostRequestFormItemsItemPriceDataX3932288c is missing required property '" + name + "'")
