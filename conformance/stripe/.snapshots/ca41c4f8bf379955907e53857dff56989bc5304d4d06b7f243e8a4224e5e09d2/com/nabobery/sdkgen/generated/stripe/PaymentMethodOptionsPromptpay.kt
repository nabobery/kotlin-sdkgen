...
public class PaymentMethodOptionsPromptpay(
  ...
  public class Builder {
    ...
    public fun build(): PaymentMethodOptionsPromptpay = PaymentMethodOptionsPromptpay(
  ...
  internal object Serializer : KSerializer<PaymentMethodOptionsPromptpay> {
    ...
    override fun deserialize(decoder: Decoder): PaymentMethodOptionsPromptpay {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("PaymentMethodOptionsPromptpay must be a JSON object")
      return PaymentMethodOptionsPromptpay(
        setupFutureUsage = rawObject["setup_future_usage"]?.let { json.decodeFromJsonElement<InlinePaymentMethodOptionsPromptpaySetupFutureUsageX96620ca0>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: PaymentMethodOptionsPromptpay) {
...
public fun paymentMethodOptionsPromptpay(block: PaymentMethodOptionsPromptpay.Builder.() -> Unit): PaymentMethodOptionsPromptpay = PaymentMethodOptionsPromptpay.build(block)
