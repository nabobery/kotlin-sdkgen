...
public class InlineV1PaymentLinksPostRequestFormAfterCompletionXc1602789(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1PaymentLinksPostRequestFormAfterCompletionXc1602789 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1PaymentLinksPostRequestFormAfterCompletionXc1602789> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1PaymentLinksPostRequestFormAfterCompletionXc1602789 {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1PaymentLinksPostRequestFormAfterCompletionXc1602789 must be a JSON object")
      val type = json.decodeRequired<InlineV1PaymentLinksPostRequestFormAfterCompletionTypeXcb71b089>(rawObject, "type")
      return InlineV1PaymentLinksPostRequestFormAfterCompletionXc1602789(
        type = type,
        hostedConfirmation = rawObject["hosted_confirmation"]?.let { json.decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormAfterCompletionHostedConfirmationX2570fcc6>(it) },
        redirect = rawObject["redirect"]?.let { json.decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormAfterCompletionRedirectX8bcd1897>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineV1PaymentLinksPostRequestFormAfterCompletionXc1602789) {
...
public fun inlineV1PaymentLinksPostRequestFormAfterCompletionXc1602789(block: InlineV1PaymentLinksPostRequestFormAfterCompletionXc1602789.Builder.() -> Unit): InlineV1PaymentLinksPostRequestFormAfterCompletionXc1602789 = InlineV1PaymentLinksPostRequestFormAfterCompletionXc1602789.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineV1PaymentLinksPostRequestFormAfterCompletionXc1602789 is missing required property '" + name + "'")
