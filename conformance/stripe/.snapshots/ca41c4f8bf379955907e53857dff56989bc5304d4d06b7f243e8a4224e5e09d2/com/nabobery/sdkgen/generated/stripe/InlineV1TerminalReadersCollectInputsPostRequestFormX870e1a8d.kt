...
public class InlineV1TerminalReadersCollectInputsPostRequestFormX870e1a8d(
  ...
  public class Builder {
    ...
    public var inputs: List<InlineV1TerminalReadersCollectInputsPostRequestFormInputsItemX49c862ca>
      get() = requireNotNull(inputsValue) { "inputs is required" }.toList()
      set(`value`) {
        inputsValue = value.toList()
      }
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1TerminalReadersCollectInputsPostRequestFormX870e1a8d = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1TerminalReadersCollectInputsPostRequestFormX870e1a8d> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1TerminalReadersCollectInputsPostRequestFormX870e1a8d {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1TerminalReadersCollectInputsPostRequestFormX870e1a8d must be a JSON object")
      val inputs = json.decodeRequired<List<InlineV1TerminalReadersCollectInputsPostRequestFormInputsItemX49c862ca>>(rawObject, "inputs")
      return InlineV1TerminalReadersCollectInputsPostRequestFormX870e1a8d(
        inputs = inputs,
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1TerminalReadersCollectInputsPostRequestFormX870e1a8d) {
...
public fun inlineV1TerminalReadersCollectInputsPostRequestFormX870e1a8d(block: InlineV1TerminalReadersCollectInputsPostRequestFormX870e1a8d.Builder.() -> Unit): InlineV1TerminalReadersCollectInputsPostRequestFormX870e1a8d = InlineV1TerminalReadersCollectInputsPostRequestFormX870e1a8d.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineV1TerminalReadersCollectInputsPostRequestFormX870e1a8d is missing required property '" + name + "'")
