...
public class RefundNextActionDisplayDetails(
  ...
  internal object Serializer : KSerializer<RefundNextActionDisplayDetails> {
    ...
    override fun deserialize(decoder: Decoder): RefundNextActionDisplayDetails {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("RefundNextActionDisplayDetails must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: RefundNextActionDisplayDetails) {
...
public fun refundNextActionDisplayDetails(block: RefundNextActionDisplayDetails.Builder.() -> Unit): RefundNextActionDisplayDetails = RefundNextActionDisplayDetails.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("RefundNextActionDisplayDetails is missing required property '" + name + "'")
