...
public class DisputeEnhancedEvidence(
  ...
  public class Builder {
    ...
    public fun build(): DisputeEnhancedEvidence = DisputeEnhancedEvidence(
  ...
  internal object Serializer : KSerializer<DisputeEnhancedEvidence> {
    ...
    override fun deserialize(decoder: Decoder): DisputeEnhancedEvidence {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("DisputeEnhancedEvidence must be a JSON object")
      return DisputeEnhancedEvidence(
        mastercardCompliance = rawObject["mastercard_compliance"]?.let { json.decodeFromJsonElement<DisputeEnhancedEvidenceMastercardCompliance>(it) },
        visaCompellingEvidence3 = rawObject["visa_compelling_evidence_3"]?.let { json.decodeFromJsonElement<DisputeEnhancedEvidenceVisaCompellingEvidence3>(it) },
        visaCompliance = rawObject["visa_compliance"]?.let { json.decodeFromJsonElement<DisputeEnhancedEvidenceVisaCompliance>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: DisputeEnhancedEvidence) {
...
public fun disputeEnhancedEvidence(block: DisputeEnhancedEvidence.Builder.() -> Unit): DisputeEnhancedEvidence = DisputeEnhancedEvidence.build(block)
