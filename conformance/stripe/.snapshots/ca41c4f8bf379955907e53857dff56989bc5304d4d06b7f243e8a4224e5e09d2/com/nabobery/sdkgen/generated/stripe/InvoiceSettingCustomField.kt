...
public class InvoiceSettingCustomField(
  ...
  internal object Serializer : KSerializer<InvoiceSettingCustomField> {
    ...
    override fun deserialize(decoder: Decoder): InvoiceSettingCustomField {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InvoiceSettingCustomField must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InvoiceSettingCustomField) {
...
public fun invoiceSettingCustomField(block: InvoiceSettingCustomField.Builder.() -> Unit): InvoiceSettingCustomField = InvoiceSettingCustomField.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InvoiceSettingCustomField is missing required property '" + name + "'")
