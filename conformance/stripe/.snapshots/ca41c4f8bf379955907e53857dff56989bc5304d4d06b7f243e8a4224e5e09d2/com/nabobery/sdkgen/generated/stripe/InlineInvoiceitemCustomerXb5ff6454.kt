...
public class InlineInvoiceitemCustomerXb5ff6454 internal constructor(
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineInvoiceitemCustomerXb5ff6454 {
      val inspection = inspectInlineInvoiceitemCustomerXb5ff6454(raw)
      if (inspection.matchCount == 0) {
        throw InlineInvoiceitemCustomerXb5ff6454NoMatchException("InlineInvoiceitemCustomerXb5ff6454 matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineInvoiceitemCustomerXb5ff6454(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineInvoiceitemCustomerXb5ff6454> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineInvoiceitemCustomerXb5ff6454) {
      encoder.requireJsonEncoder("InlineInvoiceitemCustomerXb5ff6454").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineInvoiceitemCustomerXb5ff6454(element: JsonElement): InlineInvoiceitemCustomerXb5ff6454Inspection {
