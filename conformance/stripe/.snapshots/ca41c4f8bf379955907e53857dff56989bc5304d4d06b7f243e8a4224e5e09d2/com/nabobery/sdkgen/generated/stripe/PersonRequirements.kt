...
@Serializable
public data class PersonRequirementsView internal constructor(
...
public class PersonRequirements(
  ...
  internal object Serializer : KSerializer<PersonRequirements> {
    ...
    override fun deserialize(decoder: Decoder): PersonRequirements {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("PersonRequirements must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: PersonRequirements) {
...
public fun personRequirements(block: PersonRequirements.Builder.() -> Unit): PersonRequirements = PersonRequirements.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("PersonRequirements is missing required property '" + name + "'")
