...
public class InlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1CadX56412023(
  ...
  public class Builder {
    ...
    public fun build(): InlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1CadX56412023 = InlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1CadX56412023(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1CadX56412023 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1CadX56412023> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1CadX56412023 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1CadX56412023")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1CadX56412023 must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1CadX56412023) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1CadX56412023")
...
public fun inlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1CadX56412023(block: InlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1CadX56412023.Builder.() -> Unit): InlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1CadX56412023 = InlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1CadX56412023.build(block)
