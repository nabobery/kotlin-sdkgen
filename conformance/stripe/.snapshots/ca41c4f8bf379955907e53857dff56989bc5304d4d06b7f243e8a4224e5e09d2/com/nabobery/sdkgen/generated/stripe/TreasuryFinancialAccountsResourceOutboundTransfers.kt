...
public class TreasuryFinancialAccountsResourceOutboundTransfers(
  ...
  public class Builder {
    ...
    public fun build(): TreasuryFinancialAccountsResourceOutboundTransfers = TreasuryFinancialAccountsResourceOutboundTransfers(
      ach = ach,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): TreasuryFinancialAccountsResourceOutboundTransfers = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<TreasuryFinancialAccountsResourceOutboundTransfers> {
    ...
    override fun deserialize(decoder: Decoder): TreasuryFinancialAccountsResourceOutboundTransfers {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("TreasuryFinancialAccountsResourceOutboundTransfers must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: TreasuryFinancialAccountsResourceOutboundTransfers) {
...
public fun treasuryFinancialAccountsResourceOutboundTransfers(block: TreasuryFinancialAccountsResourceOutboundTransfers.Builder.() -> Unit): TreasuryFinancialAccountsResourceOutboundTransfers = TreasuryFinancialAccountsResourceOutboundTransfers.build(block)
