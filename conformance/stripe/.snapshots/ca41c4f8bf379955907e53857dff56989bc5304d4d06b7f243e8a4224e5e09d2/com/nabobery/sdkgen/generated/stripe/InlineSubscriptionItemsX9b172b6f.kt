...
public class InlineSubscriptionItemsX9b172b6f(
  ...
  internal object Serializer : KSerializer<InlineSubscriptionItemsX9b172b6f> {
    ...
    override fun deserialize(decoder: Decoder): InlineSubscriptionItemsX9b172b6f {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineSubscriptionItemsX9b172b6f must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineSubscriptionItemsX9b172b6f) {
...
public fun inlineSubscriptionItemsX9b172b6f(block: InlineSubscriptionItemsX9b172b6f.Builder.() -> Unit): InlineSubscriptionItemsX9b172b6f = InlineSubscriptionItemsX9b172b6f.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineSubscriptionItemsX9b172b6f is missing required property '" + name + "'")
