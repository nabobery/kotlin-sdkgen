...
public class InlineV1SourcesPostRequestFormXcf12bebf(
  ...
  public class Builder {
    ...
    public fun build(): InlineV1SourcesPostRequestFormXcf12bebf = InlineV1SourcesPostRequestFormXcf12bebf(
      amount = amount,
      expand = expand,
      mandate = mandate,
      metadata = metadata,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1SourcesPostRequestFormXcf12bebf = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1SourcesPostRequestFormXcf12bebf> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1SourcesPostRequestFormXcf12bebf {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1SourcesPostRequestFormXcf12bebf must be a JSON object")
      return InlineV1SourcesPostRequestFormXcf12bebf(
        amount = rawObject["amount"]?.let { json.decodeFromJsonElement<Int>(it) },
        expand = rawObject["expand"]?.let { json.decodeFromJsonElement<List<String>>(it) },
        mandate = rawObject["mandate"]?.let { json.decodeFromJsonElement<InlineV1SourcesPostRequestFormMandateX9367a038>(it) },
        metadata = rawObject["metadata"]?.let { json.decodeFromJsonElement<InlineV1SourcesPostRequestFormMetadataX67c71bb8>(it) },
        owner = rawObject["owner"]?.let { json.decodeFromJsonElement<InlineV1SourcesPostRequestFormOwnerX482307eb>(it) },
        sourceOrder = rawObject["source_order"]?.let { json.decodeFromJsonElement<InlineV1SourcesPostRequestFormSourceOrderX4330303b>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineV1SourcesPostRequestFormXcf12bebf) {
...
public fun inlineV1SourcesPostRequestFormXcf12bebf(block: InlineV1SourcesPostRequestFormXcf12bebf.Builder.() -> Unit): InlineV1SourcesPostRequestFormXcf12bebf = InlineV1SourcesPostRequestFormXcf12bebf.build(block)
