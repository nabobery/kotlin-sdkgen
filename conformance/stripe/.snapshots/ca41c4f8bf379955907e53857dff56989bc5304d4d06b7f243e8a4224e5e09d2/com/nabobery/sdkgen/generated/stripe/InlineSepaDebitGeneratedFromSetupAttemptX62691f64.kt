...
public class InlineSepaDebitGeneratedFromSetupAttemptX62691f64 internal constructor(
  ...
  public val matchedBranches: Set<InlineSepaDebitGeneratedFromSetupAttemptX62691f64Branch>
    get() = buildSet {
      ...
      if (inspection.matchesSetupAttempt) add(InlineSepaDebitGeneratedFromSetupAttemptX62691f64Branch.SetupAttempt)
    }
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineSepaDebitGeneratedFromSetupAttemptX62691f64 {
      val inspection = inspectInlineSepaDebitGeneratedFromSetupAttemptX62691f64(raw)
      if (inspection.matchCount == 0) {
        throw InlineSepaDebitGeneratedFromSetupAttemptX62691f64NoMatchException("InlineSepaDebitGeneratedFromSetupAttemptX62691f64 matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineSepaDebitGeneratedFromSetupAttemptX62691f64(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineSepaDebitGeneratedFromSetupAttemptX62691f64> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineSepaDebitGeneratedFromSetupAttemptX62691f64) {
      encoder.requireJsonEncoder("InlineSepaDebitGeneratedFromSetupAttemptX62691f64").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineSepaDebitGeneratedFromSetupAttemptX62691f64(element: JsonElement): InlineSepaDebitGeneratedFromSetupAttemptX62691f64Inspection {
