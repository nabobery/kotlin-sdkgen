...
public class InlineV1AccountsPostRequestFormBankAccountX631136d5 internal constructor(
  ...
  public val inlineV1AccountsPostRequestFormBankAccountAnyOf1Xb37b485f:
      ...
      lazy(LazyThreadSafetyMode.NONE) { if (inspection.matchesInlineV1AccountsPostRequestFormBankAccountAnyOf1Xb37b485f) json.decodeFromJsonElement<InlineV1AccountsPostRequestFormBankAccountAnyOf1Xb37b485f>(raw) else null }
  ...
  public val matchedBranches: Set<InlineV1AccountsPostRequestFormBankAccountX631136d5Branch>
    get() = buildSet {
      if (inspection.matchesInlineV1AccountsPostRequestFormBankAccountAnyOf1Xb37b485f) add(InlineV1AccountsPostRequestFormBankAccountX631136d5Branch.InlineV1AccountsPostRequestFormBankAccountAnyOf1Xb37b485f)
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineV1AccountsPostRequestFormBankAccountX631136d5 {
      val inspection = inspectInlineV1AccountsPostRequestFormBankAccountX631136d5(raw)
      if (inspection.matchCount == 0) {
        throw InlineV1AccountsPostRequestFormBankAccountX631136d5NoMatchException("InlineV1AccountsPostRequestFormBankAccountX631136d5 matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineV1AccountsPostRequestFormBankAccountX631136d5(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineV1AccountsPostRequestFormBankAccountX631136d5> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1AccountsPostRequestFormBankAccountX631136d5) {
      encoder.requireJsonEncoder("InlineV1AccountsPostRequestFormBankAccountX631136d5").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineV1AccountsPostRequestFormBankAccountX631136d5(element: JsonElement): InlineV1AccountsPostRequestFormBankAccountX631136d5Inspection {
  val matchesInlineV1AccountsPostRequestFormBankAccountAnyOf1Xb37b485f = element.isJsonDecodable<InlineV1AccountsPostRequestFormBankAccountAnyOf1Xb37b485f>()
  ...
  return InlineV1AccountsPostRequestFormBankAccountX631136d5Inspection(
    ...
    failures = buildList {
      if (!matchesInlineV1AccountsPostRequestFormBankAccountAnyOf1Xb37b485f) add("InlineV1AccountsPostRequestFormBankAccountAnyOf1Xb37b485f: value does not match InlineV1AccountsPostRequestFormBankAccountAnyOf1Xb37b485f")
