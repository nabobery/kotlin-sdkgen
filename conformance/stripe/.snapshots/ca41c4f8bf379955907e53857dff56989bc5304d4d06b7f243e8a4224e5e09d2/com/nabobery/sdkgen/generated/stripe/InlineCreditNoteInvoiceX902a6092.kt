...
public class InlineCreditNoteInvoiceX902a6092 internal constructor(
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineCreditNoteInvoiceX902a6092 {
      val inspection = inspectInlineCreditNoteInvoiceX902a6092(raw)
      if (inspection.matchCount == 0) {
        throw InlineCreditNoteInvoiceX902a6092NoMatchException("InlineCreditNoteInvoiceX902a6092 matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineCreditNoteInvoiceX902a6092(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineCreditNoteInvoiceX902a6092> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineCreditNoteInvoiceX902a6092) {
