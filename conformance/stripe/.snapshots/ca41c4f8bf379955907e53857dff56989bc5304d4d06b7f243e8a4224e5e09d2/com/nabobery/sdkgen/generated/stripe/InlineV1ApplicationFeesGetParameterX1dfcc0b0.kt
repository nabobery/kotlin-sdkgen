...
public class InlineV1ApplicationFeesGetParameterX1dfcc0b0 internal constructor(
  ...
  public val inlineV1ApplicationFeesGetParameterAnyOf1X724ff4b8:
      ...
      lazy(LazyThreadSafetyMode.NONE) { if (inspection.matchesInlineV1ApplicationFeesGetParameterAnyOf1X724ff4b8) json.decodeFromJsonElement<InlineV1ApplicationFeesGetParameterAnyOf1X724ff4b8>(raw) else null }
  ...
  public val matchedBranches: Set<InlineV1ApplicationFeesGetParameterX1dfcc0b0Branch>
    get() = buildSet {
      if (inspection.matchesInlineV1ApplicationFeesGetParameterAnyOf1X724ff4b8) add(InlineV1ApplicationFeesGetParameterX1dfcc0b0Branch.InlineV1ApplicationFeesGetParameterAnyOf1X724ff4b8)
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineV1ApplicationFeesGetParameterX1dfcc0b0 {
      val inspection = inspectInlineV1ApplicationFeesGetParameterX1dfcc0b0(raw)
      if (inspection.matchCount == 0) {
        throw InlineV1ApplicationFeesGetParameterX1dfcc0b0NoMatchException("InlineV1ApplicationFeesGetParameterX1dfcc0b0 matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineV1ApplicationFeesGetParameterX1dfcc0b0(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineV1ApplicationFeesGetParameterX1dfcc0b0> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1ApplicationFeesGetParameterX1dfcc0b0) {
      encoder.requireJsonEncoder("InlineV1ApplicationFeesGetParameterX1dfcc0b0").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineV1ApplicationFeesGetParameterX1dfcc0b0(element: JsonElement): InlineV1ApplicationFeesGetParameterX1dfcc0b0Inspection {
  val matchesInlineV1ApplicationFeesGetParameterAnyOf1X724ff4b8 = element.isJsonDecodable<InlineV1ApplicationFeesGetParameterAnyOf1X724ff4b8>()
  ...
  return InlineV1ApplicationFeesGetParameterX1dfcc0b0Inspection(
    ...
    failures = buildList {
      if (!matchesInlineV1ApplicationFeesGetParameterAnyOf1X724ff4b8) add("InlineV1ApplicationFeesGetParameterAnyOf1X724ff4b8: value does not match InlineV1ApplicationFeesGetParameterAnyOf1X724ff4b8")
