...
public class InlineV1TreasuryFinancialAccountsPostRequestFormX1f246a49(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1TreasuryFinancialAccountsPostRequestFormX1f246a49 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1TreasuryFinancialAccountsPostRequestFormX1f246a49> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1TreasuryFinancialAccountsPostRequestFormX1f246a49 {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1TreasuryFinancialAccountsPostRequestFormX1f246a49 must be a JSON object")
      val supportedCurrencies = json.decodeRequired<List<String>>(rawObject, "supported_currencies")
      return InlineV1TreasuryFinancialAccountsPostRequestFormX1f246a49(
        supportedCurrencies = supportedCurrencies,
        expand = rawObject["expand"]?.let { json.decodeFromJsonElement<List<String>>(it) },
        features = rawObject["features"]?.let { json.decodeFromJsonElement<InlineV1TreasuryFinancialAccountsPostRequestFormFeaturesXf3055bef>(it) },
        metadata = rawObject["metadata"]?.let { json.decodeFromJsonElement<Map<String, String>>(it) },
        nickname = rawObject["nickname"]?.let { json.decodeFromJsonElement<InlineV1TreasuryFinancialAccountsPostRequestFormNicknameX39fe439f>(it) },
        platformRestrictions = rawObject["platform_restrictions"]?.let { json.decodeFromJsonElement<InlineV1TreasuryFinancialAccountsPostRequestFormPlatformRestrictionsX4dcbd1ad>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineV1TreasuryFinancialAccountsPostRequestFormX1f246a49) {
...
public fun inlineV1TreasuryFinancialAccountsPostRequestFormX1f246a49(block: InlineV1TreasuryFinancialAccountsPostRequestFormX1f246a49.Builder.() -> Unit): InlineV1TreasuryFinancialAccountsPostRequestFormX1f246a49 = InlineV1TreasuryFinancialAccountsPostRequestFormX1f246a49.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineV1TreasuryFinancialAccountsPostRequestFormX1f246a49 is missing required property '" + name + "'")
