...
public class InlineStackableDiscountWithDiscountSettingsAndDiscountEndCouponX49f71059 internal constructor(
  ...
  public val matchedBranches:
    ...
    get() = buildSet {
      if (inspection.matchesBranch1) add(InlineStackableDiscountWithDiscountSettingsAndDiscountEndCouponX49f71059Branch.Branch1)
      if (inspection.matchesCoupon) add(InlineStackableDiscountWithDiscountSettingsAndDiscountEndCouponX49f71059Branch.Coupon)
    }
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineStackableDiscountWithDiscountSettingsAndDiscountEndCouponX49f71059 {
      val inspection = inspectInlineStackableDiscountWithDiscountSettingsAndDiscountEndCouponX49f71059(raw)
      if (inspection.matchCount == 0) {
        throw InlineStackableDiscountWithDiscountSettingsAndDiscountEndCouponX49f71059NoMatchException("InlineStackableDiscountWithDiscountSettingsAndDiscountEndCouponX49f71059 matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineStackableDiscountWithDiscountSettingsAndDiscountEndCouponX49f71059(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineStackableDiscountWithDiscountSettingsAndDiscountEndCouponX49f71059> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineStackableDiscountWithDiscountSettingsAndDiscountEndCouponX49f71059 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineStackableDiscountWithDiscountSettingsAndDiscountEndCouponX49f71059")
      return fromRaw(jsonDecoder.decodeJsonElement(), jsonDecoder.json)
    }

    override fun serialize(encoder: Encoder, `value`: InlineStackableDiscountWithDiscountSettingsAndDiscountEndCouponX49f71059) {
      encoder.requireJsonEncoder("InlineStackableDiscountWithDiscountSettingsAndDiscountEndCouponX49f71059").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineStackableDiscountWithDiscountSettingsAndDiscountEndCouponX49f71059(element: JsonElement): InlineStackableDiscountWithDiscountSettingsAndDiscountEndCouponX49f71059Inspection {
