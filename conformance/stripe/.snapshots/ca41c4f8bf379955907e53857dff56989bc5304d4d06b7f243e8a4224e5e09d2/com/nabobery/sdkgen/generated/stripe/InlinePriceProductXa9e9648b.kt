...
public class InlinePriceProductXa9e9648b internal constructor(
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlinePriceProductXa9e9648b {
      val inspection = inspectInlinePriceProductXa9e9648b(raw)
      if (inspection.matchCount == 0) {
        throw InlinePriceProductXa9e9648bNoMatchException("InlinePriceProductXa9e9648b matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlinePriceProductXa9e9648b(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlinePriceProductXa9e9648b> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlinePriceProductXa9e9648b) {
