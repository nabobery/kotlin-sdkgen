...
public class InlineV1IssuingCardholdersPostRequestFormSpendingControlsXf32ac1c8(
  allowedCardPresences: List<InlineV1IssuingCardholdersPostRequestFormSpendingControlsItemXf3080f34>? = null,
  allowedCategories: List<InlineV1IssuingCardholdersPostRequestFormSpendingControlsItemX891b1138>? = null,
  allowedMerchantCountries: List<String>? = null,
  blockedCardPresences: List<InlineV1IssuingCardholdersPostRequestFormSpendingControlsItemX6da81281>? = null,
  blockedCategories: List<InlineV1IssuingCardholdersPostRequestFormSpendingControlsItemX90e65dea>? = null,
  blockedMerchantCountries: List<String>? = null,
  spendingLimits: List<InlineV1IssuingCardholdersPostRequestFormSpendingControlsItemXb1ef49d2>? = null,
  public val spendingLimitsCurrency: String? = null,
) {
  public val allowedCardPresences:
      List<InlineV1IssuingCardholdersPostRequestFormSpendingControlsItemXf3080f34>? =
      allowedCardPresences?.let { collection0 -> collection0.toList() }

  public val allowedCategories:
      List<InlineV1IssuingCardholdersPostRequestFormSpendingControlsItemX891b1138>? =
  ...
  public val blockedCardPresences:
      List<InlineV1IssuingCardholdersPostRequestFormSpendingControlsItemX6da81281>? =
      blockedCardPresences?.let { collection0 -> collection0.toList() }

  public val blockedCategories:
      List<InlineV1IssuingCardholdersPostRequestFormSpendingControlsItemX90e65dea>? =
  ...
  public val spendingLimits:
      List<InlineV1IssuingCardholdersPostRequestFormSpendingControlsItemXb1ef49d2>? =
  ...
  public class Builder {
    ...
    public fun build(): InlineV1IssuingCardholdersPostRequestFormSpendingControlsXf32ac1c8 = InlineV1IssuingCardholdersPostRequestFormSpendingControlsXf32ac1c8(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1IssuingCardholdersPostRequestFormSpendingControlsXf32ac1c8 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1IssuingCardholdersPostRequestFormSpendingControlsXf32ac1c8> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1IssuingCardholdersPostRequestFormSpendingControlsXf32ac1c8 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineV1IssuingCardholdersPostRequestFormSpendingControlsXf32ac1c8")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1IssuingCardholdersPostRequestFormSpendingControlsXf32ac1c8 must be a JSON object")
      return InlineV1IssuingCardholdersPostRequestFormSpendingControlsXf32ac1c8(
        allowedCardPresences = rawObject["allowed_card_presences"]?.let { json.decodeFromJsonElement<List<InlineV1IssuingCardholdersPostRequestFormSpendingControlsItemXf3080f34>>(it) },
        allowedCategories = rawObject["allowed_categories"]?.let { json.decodeFromJsonElement<List<InlineV1IssuingCardholdersPostRequestFormSpendingControlsItemX891b1138>>(it) },
        allowedMerchantCountries = rawObject["allowed_merchant_countries"]?.let { json.decodeFromJsonElement<List<String>>(it) },
        blockedCardPresences = rawObject["blocked_card_presences"]?.let { json.decodeFromJsonElement<List<InlineV1IssuingCardholdersPostRequestFormSpendingControlsItemX6da81281>>(it) },
        blockedCategories = rawObject["blocked_categories"]?.let { json.decodeFromJsonElement<List<InlineV1IssuingCardholdersPostRequestFormSpendingControlsItemX90e65dea>>(it) },
        blockedMerchantCountries = rawObject["blocked_merchant_countries"]?.let { json.decodeFromJsonElement<List<String>>(it) },
        spendingLimits = rawObject["spending_limits"]?.let { json.decodeFromJsonElement<List<InlineV1IssuingCardholdersPostRequestFormSpendingControlsItemXb1ef49d2>>(it) },
        spendingLimitsCurrency = rawObject["spending_limits_currency"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineV1IssuingCardholdersPostRequestFormSpendingControlsXf32ac1c8) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineV1IssuingCardholdersPostRequestFormSpendingControlsXf32ac1c8")
...
public fun inlineV1IssuingCardholdersPostRequestFormSpendingControlsXf32ac1c8(block: InlineV1IssuingCardholdersPostRequestFormSpendingControlsXf32ac1c8.Builder.() -> Unit): InlineV1IssuingCardholdersPostRequestFormSpendingControlsXf32ac1c8 = InlineV1IssuingCardholdersPostRequestFormSpendingControlsXf32ac1c8.build(block)
