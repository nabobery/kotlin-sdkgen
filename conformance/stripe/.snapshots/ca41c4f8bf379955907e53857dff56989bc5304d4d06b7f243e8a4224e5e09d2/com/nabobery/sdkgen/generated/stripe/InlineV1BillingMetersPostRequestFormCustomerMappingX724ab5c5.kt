...
public class InlineV1BillingMetersPostRequestFormCustomerMappingX724ab5c5(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1BillingMetersPostRequestFormCustomerMappingX724ab5c5 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1BillingMetersPostRequestFormCustomerMappingX724ab5c5> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1BillingMetersPostRequestFormCustomerMappingX724ab5c5 {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1BillingMetersPostRequestFormCustomerMappingX724ab5c5 must be a JSON object")
      val eventPayloadKey = json.decodeRequired<String>(rawObject, "event_payload_key")
      val type = json.decodeRequired<InlineV1BillingMetersPostRequestFormCustomerMappingTypeX9591eda8>(rawObject, "type")
      return InlineV1BillingMetersPostRequestFormCustomerMappingX724ab5c5(
        eventPayloadKey = eventPayloadKey,
        type = type,
      )
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1BillingMetersPostRequestFormCustomerMappingX724ab5c5) {
...
public fun inlineV1BillingMetersPostRequestFormCustomerMappingX724ab5c5(block: InlineV1BillingMetersPostRequestFormCustomerMappingX724ab5c5.Builder.() -> Unit): InlineV1BillingMetersPostRequestFormCustomerMappingX724ab5c5 = InlineV1BillingMetersPostRequestFormCustomerMappingX724ab5c5.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineV1BillingMetersPostRequestFormCustomerMappingX724ab5c5 is missing required property '" + name + "'")
