...
public class TreasurySharedResourceBillingDetails(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): TreasurySharedResourceBillingDetails = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<TreasurySharedResourceBillingDetails> {
    ...
    override fun deserialize(decoder: Decoder): TreasurySharedResourceBillingDetails {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("TreasurySharedResourceBillingDetails must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: TreasurySharedResourceBillingDetails) {
...
public fun treasurySharedResourceBillingDetails(block: TreasurySharedResourceBillingDetails.Builder.() -> Unit): TreasurySharedResourceBillingDetails = TreasurySharedResourceBillingDetails.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("TreasurySharedResourceBillingDetails is missing required property '" + name + "'")
