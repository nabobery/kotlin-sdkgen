...
public class MandateBacsDebit(
  ...
  internal object Serializer : KSerializer<MandateBacsDebit> {
    ...
    override fun deserialize(decoder: Decoder): MandateBacsDebit {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("MandateBacsDebit must be a JSON object")
      val networkStatus = json.decodeRequired<InlineMandateBacsDebitNetworkStatusX024d6c22>(rawObject, "network_status")
      ...
      return MandateBacsDebit(
        ...
        revocationReason = rawObject["revocation_reason"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineMandateBacsDebitRevocationReasonX9e329b29?>(element) },
    ...
    override fun serialize(encoder: Encoder, `value`: MandateBacsDebit) {
...
public fun mandateBacsDebit(block: MandateBacsDebit.Builder.() -> Unit): MandateBacsDebit = MandateBacsDebit.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("MandateBacsDebit is missing required property '" + name + "'")
