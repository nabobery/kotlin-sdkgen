...
public class PaymentMethodDetailsAuBecsDebit(
  ...
  public class Builder {
    ...
    public fun build(): PaymentMethodDetailsAuBecsDebit = PaymentMethodDetailsAuBecsDebit(
      bsbNumber = bsbNumber,
  ...
  internal object Serializer : KSerializer<PaymentMethodDetailsAuBecsDebit> {
    ...
    override fun deserialize(decoder: Decoder): PaymentMethodDetailsAuBecsDebit {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("PaymentMethodDetailsAuBecsDebit must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: PaymentMethodDetailsAuBecsDebit) {
...
public fun paymentMethodDetailsAuBecsDebit(block: PaymentMethodDetailsAuBecsDebit.Builder.() -> Unit): PaymentMethodDetailsAuBecsDebit = PaymentMethodDetailsAuBecsDebit.build(block)
