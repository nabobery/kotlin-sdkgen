...
public class PaymentMethodDetailsPayto(
  ...
  public class Builder {
    ...
    public fun build(): PaymentMethodDetailsPayto = PaymentMethodDetailsPayto(
      bsbNumber = bsbNumber,
      last4 = last4,
      mandate = mandate,
      payId = payId,
  ...
  internal object Serializer : KSerializer<PaymentMethodDetailsPayto> {
    ...
    override fun deserialize(decoder: Decoder): PaymentMethodDetailsPayto {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("PaymentMethodDetailsPayto must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: PaymentMethodDetailsPayto) {
...
public fun paymentMethodDetailsPayto(block: PaymentMethodDetailsPayto.Builder.() -> Unit): PaymentMethodDetailsPayto = PaymentMethodDetailsPayto.build(block)
