...
public class SetupAttemptPaymentMethodDetailsCard(
  ...
  public class Builder {
    ...
    public fun build(): SetupAttemptPaymentMethodDetailsCard = SetupAttemptPaymentMethodDetailsCard(
      brand = brand,
      checks = checks,
      country = country,
      expMonth = expMonth,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): SetupAttemptPaymentMethodDetailsCard = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<SetupAttemptPaymentMethodDetailsCard> {
    ...
    override fun deserialize(decoder: Decoder): SetupAttemptPaymentMethodDetailsCard {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("SetupAttemptPaymentMethodDetailsCard must be a JSON object")
      return SetupAttemptPaymentMethodDetailsCard(
        ...
        checks = rawObject["checks"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineSetupAttemptPaymentMethodDetailsCardChecksX0fc7918b?>(element) },
        ...
        threeDSecure = rawObject["three_d_secure"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineSetupAttemptPaymentMethodDetailsCardThreeDSecureX18bf40a5?>(element) },
        wallet = rawObject["wallet"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineSetupAttemptPaymentMethodDetailsCardWalletX9b59b209?>(element) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: SetupAttemptPaymentMethodDetailsCard) {
...
public fun setupAttemptPaymentMethodDetailsCard(block: SetupAttemptPaymentMethodDetailsCard.Builder.() -> Unit): SetupAttemptPaymentMethodDetailsCard = SetupAttemptPaymentMethodDetailsCard.build(block)
