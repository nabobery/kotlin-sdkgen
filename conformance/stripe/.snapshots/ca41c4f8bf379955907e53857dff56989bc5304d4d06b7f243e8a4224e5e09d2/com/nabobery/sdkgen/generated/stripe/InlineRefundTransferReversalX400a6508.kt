...
public class InlineRefundTransferReversalX400a6508 internal constructor(
  ...
  public val matchedBranches: Set<InlineRefundTransferReversalX400a6508Branch>
    get() = buildSet {
      ...
      if (inspection.matchesTransferReversal) add(InlineRefundTransferReversalX400a6508Branch.TransferReversal)
    }
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineRefundTransferReversalX400a6508 {
      val inspection = inspectInlineRefundTransferReversalX400a6508(raw)
      if (inspection.matchCount == 0) {
        throw InlineRefundTransferReversalX400a6508NoMatchException("InlineRefundTransferReversalX400a6508 matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineRefundTransferReversalX400a6508(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineRefundTransferReversalX400a6508> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineRefundTransferReversalX400a6508) {
      encoder.requireJsonEncoder("InlineRefundTransferReversalX400a6508").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineRefundTransferReversalX400a6508(element: JsonElement): InlineRefundTransferReversalX400a6508Inspection {
