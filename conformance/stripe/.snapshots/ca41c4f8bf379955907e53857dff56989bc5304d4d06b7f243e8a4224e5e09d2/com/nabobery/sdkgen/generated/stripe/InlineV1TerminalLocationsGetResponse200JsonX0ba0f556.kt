...
public class InlineV1TerminalLocationsGetResponse200JsonX0ba0f556(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1TerminalLocationsGetResponse200JsonX0ba0f556 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1TerminalLocationsGetResponse200JsonX0ba0f556> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1TerminalLocationsGetResponse200JsonX0ba0f556 {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1TerminalLocationsGetResponse200JsonX0ba0f556 must be a JSON object")
      ...
      val objectValue = json.decodeRequired<InlineV1TerminalLocationsGetResponse200JsonObjectValueX7e3dc9bc>(rawObject, "object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1TerminalLocationsGetResponse200JsonX0ba0f556) {
...
public fun inlineV1TerminalLocationsGetResponse200JsonX0ba0f556(block: InlineV1TerminalLocationsGetResponse200JsonX0ba0f556.Builder.() -> Unit): InlineV1TerminalLocationsGetResponse200JsonX0ba0f556 = InlineV1TerminalLocationsGetResponse200JsonX0ba0f556.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineV1TerminalLocationsGetResponse200JsonX0ba0f556 is missing required property '" + name + "'")
