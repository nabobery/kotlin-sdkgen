...
public data class PaymentMethodOptionsAfterpayClearpayView(
  ...
  public val captureMethod:
      InlinePaymentMethodOptionsAfterpayClearpayCaptureMethodXc9dc63eb? = null,
...
public class PaymentMethodOptionsAfterpayClearpay(
  ...
  public class Builder {
    ...
    public fun build(): PaymentMethodOptionsAfterpayClearpay = PaymentMethodOptionsAfterpayClearpay(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): PaymentMethodOptionsAfterpayClearpay = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<PaymentMethodOptionsAfterpayClearpay> {
    ...
    override fun deserialize(decoder: Decoder): PaymentMethodOptionsAfterpayClearpay {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("PaymentMethodOptionsAfterpayClearpay must be a JSON object")
      return PaymentMethodOptionsAfterpayClearpay(
        captureMethod = rawObject["capture_method"]?.let { json.decodeFromJsonElement<InlinePaymentMethodOptionsAfterpayClearpayCaptureMethodXc9dc63eb>(it) },
        reference = rawObject["reference"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<String?>(element) },
        setupFutureUsage = rawObject["setup_future_usage"]?.let { json.decodeFromJsonElement<InlinePaymentMethodOptionsAfterpayClearpaySetupFutureUsageXf666b267>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: PaymentMethodOptionsAfterpayClearpay) {
...
public fun paymentMethodOptionsAfterpayClearpay(block: PaymentMethodOptionsAfterpayClearpay.Builder.() -> Unit): PaymentMethodOptionsAfterpayClearpay = PaymentMethodOptionsAfterpayClearpay.build(block)
