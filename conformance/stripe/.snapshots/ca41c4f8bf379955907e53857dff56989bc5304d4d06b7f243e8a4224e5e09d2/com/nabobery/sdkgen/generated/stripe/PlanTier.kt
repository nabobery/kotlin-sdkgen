...
public class PlanTier(
  ...
  public class Builder {
    ...
    public fun build(): PlanTier = PlanTier(
  ...
  internal object Serializer : KSerializer<PlanTier> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): PlanTier {
      val jsonDecoder = decoder.requireJsonDecoder("PlanTier")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("PlanTier must be a JSON object")
      return PlanTier(
    ...
    override fun serialize(encoder: Encoder, `value`: PlanTier) {
