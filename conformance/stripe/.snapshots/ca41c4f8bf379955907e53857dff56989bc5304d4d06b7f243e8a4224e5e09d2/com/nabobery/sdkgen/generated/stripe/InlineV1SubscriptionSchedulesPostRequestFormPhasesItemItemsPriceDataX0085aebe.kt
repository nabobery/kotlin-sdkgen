...
public class InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemsPriceDataX0085aebe(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemsPriceDataX0085aebe = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemsPriceDataX0085aebe> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemsPriceDataX0085aebe {
      val jsonDecoder = decoder.requireJsonDecoder("InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemsPriceDataX0085aebe")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemsPriceDataX0085aebe must be a JSON object")
      val currency = json.decodeRequired<String>(rawObject, "currency")
      val product = json.decodeRequired<String>(rawObject, "product")
      val recurring = json.decodeRequired<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemsRecurringXb03f15f8>(rawObject, "recurring")
      return InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemsPriceDataX0085aebe(
        currency = currency,
        product = product,
        recurring = recurring,
        taxBehavior = rawObject["tax_behavior"]?.let { json.decodeFromJsonElement<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemsTaxBehaviorX7a1d03ed>(it) },
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemsPriceDataX0085aebe) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemsPriceDataX0085aebe")
...
public fun inlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemsPriceDataX0085aebe(block: InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemsPriceDataX0085aebe.Builder.() -> Unit): InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemsPriceDataX0085aebe = InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemsPriceDataX0085aebe.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemsPriceDataX0085aebe is missing required property '" + name + "'")
