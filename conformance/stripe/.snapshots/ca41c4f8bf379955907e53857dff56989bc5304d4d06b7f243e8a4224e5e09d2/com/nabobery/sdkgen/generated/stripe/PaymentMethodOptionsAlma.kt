...
public class PaymentMethodOptionsAlma(
  ...
  public class Builder {
    ...
    public fun build(): PaymentMethodOptionsAlma = PaymentMethodOptionsAlma(
  ...
  internal object Serializer : KSerializer<PaymentMethodOptionsAlma> {
    ...
    override fun deserialize(decoder: Decoder): PaymentMethodOptionsAlma {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("PaymentMethodOptionsAlma must be a JSON object")
      return PaymentMethodOptionsAlma(
        captureMethod = rawObject["capture_method"]?.let { json.decodeFromJsonElement<InlinePaymentMethodOptionsAlmaCaptureMethodX866f235d>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: PaymentMethodOptionsAlma) {
...
public fun paymentMethodOptionsAlma(block: PaymentMethodOptionsAlma.Builder.() -> Unit): PaymentMethodOptionsAlma = PaymentMethodOptionsAlma.build(block)
