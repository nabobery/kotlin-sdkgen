...
public class InlineV1TransfersGetParameterAnyOf1X8b05209c(
  ...
  public class Builder {
    ...
    public fun build(): InlineV1TransfersGetParameterAnyOf1X8b05209c = InlineV1TransfersGetParameterAnyOf1X8b05209c(
      gt = gt,
      gte = gte,
      lt = lt,
      lte = lte,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1TransfersGetParameterAnyOf1X8b05209c = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1TransfersGetParameterAnyOf1X8b05209c> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1TransfersGetParameterAnyOf1X8b05209c {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1TransfersGetParameterAnyOf1X8b05209c must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1TransfersGetParameterAnyOf1X8b05209c) {
...
public fun inlineV1TransfersGetParameterAnyOf1X8b05209c(block: InlineV1TransfersGetParameterAnyOf1X8b05209c.Builder.() -> Unit): InlineV1TransfersGetParameterAnyOf1X8b05209c = InlineV1TransfersGetParameterAnyOf1X8b05209c.build(block)
