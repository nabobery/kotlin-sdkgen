...
public class FundingInstructionsBankTransfer(
  ...
  internal object Serializer : KSerializer<FundingInstructionsBankTransfer> {
    ...
    override fun deserialize(decoder: Decoder): FundingInstructionsBankTransfer {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("FundingInstructionsBankTransfer must be a JSON object")
      val country = json.decodeRequired<String>(rawObject, "country")
      val financialAddresses = json.decodeRequired<List<FundingInstructionsBankTransferFinancialAddress>>(rawObject, "financial_addresses")
    ...
    override fun serialize(encoder: Encoder, `value`: FundingInstructionsBankTransfer) {
...
public fun fundingInstructionsBankTransfer(block: FundingInstructionsBankTransfer.Builder.() -> Unit): FundingInstructionsBankTransfer = FundingInstructionsBankTransfer.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("FundingInstructionsBankTransfer is missing required property '" + name + "'")
