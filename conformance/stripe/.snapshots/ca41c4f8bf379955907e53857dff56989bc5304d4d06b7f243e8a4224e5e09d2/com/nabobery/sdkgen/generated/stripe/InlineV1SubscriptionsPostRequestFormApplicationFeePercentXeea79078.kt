...
internal data class InlineV1SubscriptionsPostRequestFormApplicationFeePercentXeea79078Inspection(
  ...
  public val matchesInlineV1SubscriptionsPostRequestFormApplicationFeePercentAnyOf2X60394290:
      Boolean,
  public val failures: List<String>,
) {
  public val matchCount: Int
    get() = listOf(matchesBranch1, matchesInlineV1SubscriptionsPostRequestFormApplicationFeePercentAnyOf2X60394290).count { it }
}
...
public class InlineV1SubscriptionsPostRequestFormApplicationFeePercentXeea79078 internal constructor(
  ...
  public val inlineV1SubscriptionsPostRequestFormApplicationFeePercentAnyOf2X60394290:
      ...
      lazy(LazyThreadSafetyMode.NONE) { if (inspection.matchesInlineV1SubscriptionsPostRequestFormApplicationFeePercentAnyOf2X60394290) json.decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormApplicationFeePercentAnyOf2X60394290>(raw) else null }

  public val matchedBranches:
      Set<InlineV1SubscriptionsPostRequestFormApplicationFeePercentXeea79078Branch>
    get() = buildSet {
      if (inspection.matchesBranch1) add(InlineV1SubscriptionsPostRequestFormApplicationFeePercentXeea79078Branch.Branch1)
      if (inspection.matchesInlineV1SubscriptionsPostRequestFormApplicationFeePercentAnyOf2X60394290) add(InlineV1SubscriptionsPostRequestFormApplicationFeePercentXeea79078Branch.InlineV1SubscriptionsPostRequestFormApplicationFeePercentAnyOf2X60394290)
    }
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineV1SubscriptionsPostRequestFormApplicationFeePercentXeea79078 {
      val inspection = inspectInlineV1SubscriptionsPostRequestFormApplicationFeePercentXeea79078(raw)
      if (inspection.matchCount == 0) {
        throw InlineV1SubscriptionsPostRequestFormApplicationFeePercentXeea79078NoMatchException("InlineV1SubscriptionsPostRequestFormApplicationFeePercentXeea79078 matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineV1SubscriptionsPostRequestFormApplicationFeePercentXeea79078(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineV1SubscriptionsPostRequestFormApplicationFeePercentXeea79078> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1SubscriptionsPostRequestFormApplicationFeePercentXeea79078 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineV1SubscriptionsPostRequestFormApplicationFeePercentXeea79078")
      return fromRaw(jsonDecoder.decodeJsonElement(), jsonDecoder.json)
    }

    override fun serialize(encoder: Encoder, `value`: InlineV1SubscriptionsPostRequestFormApplicationFeePercentXeea79078) {
      encoder.requireJsonEncoder("InlineV1SubscriptionsPostRequestFormApplicationFeePercentXeea79078").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineV1SubscriptionsPostRequestFormApplicationFeePercentXeea79078(element: JsonElement): InlineV1SubscriptionsPostRequestFormApplicationFeePercentXeea79078Inspection {
  val matchesBranch1 = element.isJsonDecodable<Double>()
  val matchesInlineV1SubscriptionsPostRequestFormApplicationFeePercentAnyOf2X60394290 = element.isJsonDecodable<InlineV1SubscriptionsPostRequestFormApplicationFeePercentAnyOf2X60394290>()
  return InlineV1SubscriptionsPostRequestFormApplicationFeePercentXeea79078Inspection(
    ...
    failures = buildList {
      ...
      if (!matchesInlineV1SubscriptionsPostRequestFormApplicationFeePercentAnyOf2X60394290) add("InlineV1SubscriptionsPostRequestFormApplicationFeePercentAnyOf2X60394290: value does not match InlineV1SubscriptionsPostRequestFormApplicationFeePercentAnyOf2X60394290")
    },
  )
}
