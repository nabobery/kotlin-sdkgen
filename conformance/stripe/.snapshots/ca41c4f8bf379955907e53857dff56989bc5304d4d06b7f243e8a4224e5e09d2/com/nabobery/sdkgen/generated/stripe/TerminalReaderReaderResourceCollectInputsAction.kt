...
public class TerminalReaderReaderResourceCollectInputsAction(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): TerminalReaderReaderResourceCollectInputsAction = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<TerminalReaderReaderResourceCollectInputsAction> {
    ...
    override fun deserialize(decoder: Decoder): TerminalReaderReaderResourceCollectInputsAction {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("TerminalReaderReaderResourceCollectInputsAction must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: TerminalReaderReaderResourceCollectInputsAction) {
...
public fun terminalReaderReaderResourceCollectInputsAction(block: TerminalReaderReaderResourceCollectInputsAction.Builder.() -> Unit): TerminalReaderReaderResourceCollectInputsAction = TerminalReaderReaderResourceCollectInputsAction.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("TerminalReaderReaderResourceCollectInputsAction is missing required property '" + name + "'")
