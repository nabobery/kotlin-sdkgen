...
public class IssuingTransactionNetworkData(
  ...
  public class Builder {
    ...
    public fun build(): IssuingTransactionNetworkData = IssuingTransactionNetworkData(
  ...
  internal object Serializer : KSerializer<IssuingTransactionNetworkData> {
    ...
    override fun deserialize(decoder: Decoder): IssuingTransactionNetworkData {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("IssuingTransactionNetworkData must be a JSON object")
      return IssuingTransactionNetworkData(
        ...
        processingDate = rawObject["processing_date"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<String?>(element) },
    ...
    override fun serialize(encoder: Encoder, `value`: IssuingTransactionNetworkData) {
...
public fun issuingTransactionNetworkData(block: IssuingTransactionNetworkData.Builder.() -> Unit): IssuingTransactionNetworkData = IssuingTransactionNetworkData.build(block)
