...
public class InlinePaymentMethodDetailsUsBankAccountMandateX477127d7 internal constructor(
  ...
  public val matchedBranches: Set<InlinePaymentMethodDetailsUsBankAccountMandateX477127d7Branch>
    get() = buildSet {
      if (inspection.matchesBranch1) add(InlinePaymentMethodDetailsUsBankAccountMandateX477127d7Branch.Branch1)
      if (inspection.matchesMandate) add(InlinePaymentMethodDetailsUsBankAccountMandateX477127d7Branch.Mandate)
    }
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlinePaymentMethodDetailsUsBankAccountMandateX477127d7 {
      val inspection = inspectInlinePaymentMethodDetailsUsBankAccountMandateX477127d7(raw)
      if (inspection.matchCount == 0) {
        throw InlinePaymentMethodDetailsUsBankAccountMandateX477127d7NoMatchException("InlinePaymentMethodDetailsUsBankAccountMandateX477127d7 matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlinePaymentMethodDetailsUsBankAccountMandateX477127d7(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlinePaymentMethodDetailsUsBankAccountMandateX477127d7> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlinePaymentMethodDetailsUsBankAccountMandateX477127d7) {
      encoder.requireJsonEncoder("InlinePaymentMethodDetailsUsBankAccountMandateX477127d7").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlinePaymentMethodDetailsUsBankAccountMandateX477127d7(element: JsonElement): InlinePaymentMethodDetailsUsBankAccountMandateX477127d7Inspection {
