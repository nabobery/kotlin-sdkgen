...
public class InlineIssuingDisputeCanceledEvidenceAdditionalDocumentationX7b60331e internal constructor(
  ...
  public val matchedBranches:
    ...
    get() = buildSet {
      if (inspection.matchesBranch1) add(InlineIssuingDisputeCanceledEvidenceAdditionalDocumentationX7b60331eBranch.Branch1)
      if (inspection.matchesFile) add(InlineIssuingDisputeCanceledEvidenceAdditionalDocumentationX7b60331eBranch.File)
    }
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineIssuingDisputeCanceledEvidenceAdditionalDocumentationX7b60331e {
      val inspection = inspectInlineIssuingDisputeCanceledEvidenceAdditionalDocumentationX7b60331e(raw)
      if (inspection.matchCount == 0) {
        throw InlineIssuingDisputeCanceledEvidenceAdditionalDocumentationX7b60331eNoMatchException("InlineIssuingDisputeCanceledEvidenceAdditionalDocumentationX7b60331e matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineIssuingDisputeCanceledEvidenceAdditionalDocumentationX7b60331e(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineIssuingDisputeCanceledEvidenceAdditionalDocumentationX7b60331e> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineIssuingDisputeCanceledEvidenceAdditionalDocumentationX7b60331e {
      val jsonDecoder = decoder.requireJsonDecoder("InlineIssuingDisputeCanceledEvidenceAdditionalDocumentationX7b60331e")
      return fromRaw(jsonDecoder.decodeJsonElement(), jsonDecoder.json)
    }

    override fun serialize(encoder: Encoder, `value`: InlineIssuingDisputeCanceledEvidenceAdditionalDocumentationX7b60331e) {
      encoder.requireJsonEncoder("InlineIssuingDisputeCanceledEvidenceAdditionalDocumentationX7b60331e").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineIssuingDisputeCanceledEvidenceAdditionalDocumentationX7b60331e(element: JsonElement): InlineIssuingDisputeCanceledEvidenceAdditionalDocumentationX7b60331eInspection {
