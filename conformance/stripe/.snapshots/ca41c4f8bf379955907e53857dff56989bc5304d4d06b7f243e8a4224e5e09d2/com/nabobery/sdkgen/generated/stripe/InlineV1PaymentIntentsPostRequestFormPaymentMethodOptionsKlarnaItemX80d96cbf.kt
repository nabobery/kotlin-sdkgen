...
public class InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKlarnaItemX80d96cbf(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKlarnaItemX80d96cbf = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKlarnaItemX80d96cbf> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKlarnaItemX80d96cbf {
      val jsonDecoder = decoder.requireJsonDecoder("InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKlarnaItemX80d96cbf")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKlarnaItemX80d96cbf must be a JSON object")
      val interval = json.decodeRequired<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKlarnaIntervalX4d7f052b>(rawObject, "interval")
      ...
      return InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKlarnaItemX80d96cbf(
        ...
        nextBilling = rawObject["next_billing"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsNextBillingX146f8804>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKlarnaItemX80d96cbf) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKlarnaItemX80d96cbf")
...
public fun inlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKlarnaItemX80d96cbf(block: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKlarnaItemX80d96cbf.Builder.() -> Unit): InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKlarnaItemX80d96cbf = InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKlarnaItemX80d96cbf.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKlarnaItemX80d96cbf is missing required property '" + name + "'")
