...
public class TerminalReaderReaderResourceCustomText(
  ...
  public class Builder {
    ...
    public fun build(): TerminalReaderReaderResourceCustomText = TerminalReaderReaderResourceCustomText(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): TerminalReaderReaderResourceCustomText = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<TerminalReaderReaderResourceCustomText> {
    ...
    override fun deserialize(decoder: Decoder): TerminalReaderReaderResourceCustomText {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("TerminalReaderReaderResourceCustomText must be a JSON object")
      return TerminalReaderReaderResourceCustomText(
        description = rawObject["description"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<String?>(element) },
        skipButton = rawObject["skip_button"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<String?>(element) },
        submitButton = rawObject["submit_button"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<String?>(element) },
        title = rawObject["title"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<String?>(element) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: TerminalReaderReaderResourceCustomText) {
...
public fun terminalReaderReaderResourceCustomText(block: TerminalReaderReaderResourceCustomText.Builder.() -> Unit): TerminalReaderReaderResourceCustomText = TerminalReaderReaderResourceCustomText.build(block)
