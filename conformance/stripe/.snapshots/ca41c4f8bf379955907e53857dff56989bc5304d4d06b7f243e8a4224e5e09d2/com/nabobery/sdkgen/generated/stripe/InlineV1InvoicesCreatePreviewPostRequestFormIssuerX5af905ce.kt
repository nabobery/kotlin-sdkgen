...
public class InlineV1InvoicesCreatePreviewPostRequestFormIssuerX5af905ce(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1InvoicesCreatePreviewPostRequestFormIssuerX5af905ce = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1InvoicesCreatePreviewPostRequestFormIssuerX5af905ce> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1InvoicesCreatePreviewPostRequestFormIssuerX5af905ce {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1InvoicesCreatePreviewPostRequestFormIssuerX5af905ce must be a JSON object")
      val type = json.decodeRequired<InlineV1InvoicesCreatePreviewPostRequestFormIssuerTypeX76478e38>(rawObject, "type")
      return InlineV1InvoicesCreatePreviewPostRequestFormIssuerX5af905ce(
        type = type,
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1InvoicesCreatePreviewPostRequestFormIssuerX5af905ce) {
...
public fun inlineV1InvoicesCreatePreviewPostRequestFormIssuerX5af905ce(block: InlineV1InvoicesCreatePreviewPostRequestFormIssuerX5af905ce.Builder.() -> Unit): InlineV1InvoicesCreatePreviewPostRequestFormIssuerX5af905ce = InlineV1InvoicesCreatePreviewPostRequestFormIssuerX5af905ce.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineV1InvoicesCreatePreviewPostRequestFormIssuerX5af905ce is missing required property '" + name + "'")
