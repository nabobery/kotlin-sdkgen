...
public class CheckoutPaycoPaymentMethodOptions(
  ...
  public class Builder {
    ...
    public fun build(): CheckoutPaycoPaymentMethodOptions = CheckoutPaycoPaymentMethodOptions(
  ...
  internal object Serializer : KSerializer<CheckoutPaycoPaymentMethodOptions> {
    ...
    override fun deserialize(decoder: Decoder): CheckoutPaycoPaymentMethodOptions {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("CheckoutPaycoPaymentMethodOptions must be a JSON object")
      return CheckoutPaycoPaymentMethodOptions(
        captureMethod = rawObject["capture_method"]?.let { json.decodeFromJsonElement<InlineCheckoutPaycoPaymentMethodOptionsCaptureMethodX7e1ccd08>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: CheckoutPaycoPaymentMethodOptions) {
...
public fun checkoutPaycoPaymentMethodOptions(block: CheckoutPaycoPaymentMethodOptions.Builder.() -> Unit): CheckoutPaycoPaymentMethodOptions = CheckoutPaycoPaymentMethodOptions.build(block)
