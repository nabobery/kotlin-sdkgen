...
public class TreasuryOutboundPaymentsResourceOutboundPaymentResourceStatusTransitions(
  ...
  public class Builder {
    ...
    public fun build(): TreasuryOutboundPaymentsResourceOutboundPaymentResourceStatusTransitions = TreasuryOutboundPaymentsResourceOutboundPaymentResourceStatusTransitions(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): TreasuryOutboundPaymentsResourceOutboundPaymentResourceStatusTransitions = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<TreasuryOutboundPaymentsResourceOutboundPaymentResourceStatusTransitions> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): TreasuryOutboundPaymentsResourceOutboundPaymentResourceStatusTransitions {
      val jsonDecoder = decoder.requireJsonDecoder("TreasuryOutboundPaymentsResourceOutboundPaymentResourceStatusTransitions")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("TreasuryOutboundPaymentsResourceOutboundPaymentResourceStatusTransitions must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: TreasuryOutboundPaymentsResourceOutboundPaymentResourceStatusTransitions) {
      val jsonEncoder = encoder.requireJsonEncoder("TreasuryOutboundPaymentsResourceOutboundPaymentResourceStatusTransitions")
...
public fun treasuryOutboundPaymentsResourceOutboundPaymentResourceStatusTransitions(block: TreasuryOutboundPaymentsResourceOutboundPaymentResourceStatusTransitions.Builder.() -> Unit): TreasuryOutboundPaymentsResourceOutboundPaymentResourceStatusTransitions = TreasuryOutboundPaymentsResourceOutboundPaymentResourceStatusTransitions.build(block)
