...
public class InlineV1CustomersCardsGetResponse200JsonX1baae5ee(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1CustomersCardsGetResponse200JsonX1baae5ee = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1CustomersCardsGetResponse200JsonX1baae5ee> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1CustomersCardsGetResponse200JsonX1baae5ee {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1CustomersCardsGetResponse200JsonX1baae5ee must be a JSON object")
      val data = json.decodeRequired<List<Card>>(rawObject, "data")
      val hasMore = json.decodeRequired<Boolean>(rawObject, "has_more")
      val objectValue = json.decodeRequired<InlineV1CustomersCardsGetResponse200JsonObjectValueX7b6454fa>(rawObject, "object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1CustomersCardsGetResponse200JsonX1baae5ee) {
...
public fun inlineV1CustomersCardsGetResponse200JsonX1baae5ee(block: InlineV1CustomersCardsGetResponse200JsonX1baae5ee.Builder.() -> Unit): InlineV1CustomersCardsGetResponse200JsonX1baae5ee = InlineV1CustomersCardsGetResponse200JsonX1baae5ee.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineV1CustomersCardsGetResponse200JsonX1baae5ee is missing required property '" + name + "'")
