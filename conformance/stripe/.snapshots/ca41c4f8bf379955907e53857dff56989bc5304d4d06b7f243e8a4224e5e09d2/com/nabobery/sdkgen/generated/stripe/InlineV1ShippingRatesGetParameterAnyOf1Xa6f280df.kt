...
public class InlineV1ShippingRatesGetParameterAnyOf1Xa6f280df(
  ...
  public class Builder {
    ...
    public fun build(): InlineV1ShippingRatesGetParameterAnyOf1Xa6f280df = InlineV1ShippingRatesGetParameterAnyOf1Xa6f280df(
      gt = gt,
      gte = gte,
      lt = lt,
      lte = lte,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1ShippingRatesGetParameterAnyOf1Xa6f280df = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1ShippingRatesGetParameterAnyOf1Xa6f280df> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1ShippingRatesGetParameterAnyOf1Xa6f280df {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1ShippingRatesGetParameterAnyOf1Xa6f280df must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1ShippingRatesGetParameterAnyOf1Xa6f280df) {
...
public fun inlineV1ShippingRatesGetParameterAnyOf1Xa6f280df(block: InlineV1ShippingRatesGetParameterAnyOf1Xa6f280df.Builder.() -> Unit): InlineV1ShippingRatesGetParameterAnyOf1Xa6f280df = InlineV1ShippingRatesGetParameterAnyOf1Xa6f280df.build(block)
