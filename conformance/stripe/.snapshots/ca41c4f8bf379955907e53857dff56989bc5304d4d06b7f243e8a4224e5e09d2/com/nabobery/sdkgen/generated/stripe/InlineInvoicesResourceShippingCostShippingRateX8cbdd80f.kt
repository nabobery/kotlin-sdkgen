...
public class InlineInvoicesResourceShippingCostShippingRateX8cbdd80f internal constructor(
  ...
  public val matchedBranches: Set<InlineInvoicesResourceShippingCostShippingRateX8cbdd80fBranch>
    get() = buildSet {
      if (inspection.matchesBranch1) add(InlineInvoicesResourceShippingCostShippingRateX8cbdd80fBranch.Branch1)
      if (inspection.matchesShippingRate) add(InlineInvoicesResourceShippingCostShippingRateX8cbdd80fBranch.ShippingRate)
    }
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineInvoicesResourceShippingCostShippingRateX8cbdd80f {
      val inspection = inspectInlineInvoicesResourceShippingCostShippingRateX8cbdd80f(raw)
      if (inspection.matchCount == 0) {
        throw InlineInvoicesResourceShippingCostShippingRateX8cbdd80fNoMatchException("InlineInvoicesResourceShippingCostShippingRateX8cbdd80f matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineInvoicesResourceShippingCostShippingRateX8cbdd80f(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineInvoicesResourceShippingCostShippingRateX8cbdd80f> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineInvoicesResourceShippingCostShippingRateX8cbdd80f) {
      encoder.requireJsonEncoder("InlineInvoicesResourceShippingCostShippingRateX8cbdd80f").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineInvoicesResourceShippingCostShippingRateX8cbdd80f(element: JsonElement): InlineInvoicesResourceShippingCostShippingRateX8cbdd80fInspection {
