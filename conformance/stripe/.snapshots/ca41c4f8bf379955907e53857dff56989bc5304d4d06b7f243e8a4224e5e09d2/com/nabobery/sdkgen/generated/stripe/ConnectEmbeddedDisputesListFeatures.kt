 ...
 *
 *
 * Source: sdkgen://source/openapi.json#/components/schemas/connect_embedded_disputes_list_features
 */
@Serializable(with = ConnectEmbeddedDisputesListFeatures.Serializer::class)
public class ConnectEmbeddedDisputesListFeatures(
  /**
  ...
  public class Builder {
    ...
    public fun build(): ConnectEmbeddedDisputesListFeatures {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): ConnectEmbeddedDisputesListFeatures = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<ConnectEmbeddedDisputesListFeatures> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): ConnectEmbeddedDisputesListFeatures {
      val jsonDecoder = decoder.requireJsonDecoder("ConnectEmbeddedDisputesListFeatures")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("ConnectEmbeddedDisputesListFeatures must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: ConnectEmbeddedDisputesListFeatures) {
      val jsonEncoder = encoder.requireJsonEncoder("ConnectEmbeddedDisputesListFeatures")
...
public fun connectEmbeddedDisputesListFeatures(block: ConnectEmbeddedDisputesListFeatures.Builder.() -> Unit): ConnectEmbeddedDisputesListFeatures = ConnectEmbeddedDisputesListFeatures.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("ConnectEmbeddedDisputesListFeatures is missing required property '" + name + "'")
