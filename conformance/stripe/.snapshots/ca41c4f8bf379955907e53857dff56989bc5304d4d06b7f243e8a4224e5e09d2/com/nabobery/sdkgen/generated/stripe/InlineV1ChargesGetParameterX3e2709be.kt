...
public class InlineV1ChargesGetParameterX3e2709be internal constructor(
  ...
  public val inlineV1ChargesGetParameterAnyOf1X7a2241fc: InlineV1ChargesGetParameterAnyOf1X7a2241fc?
      by
      lazy(LazyThreadSafetyMode.NONE) { if (inspection.matchesInlineV1ChargesGetParameterAnyOf1X7a2241fc) json.decodeFromJsonElement<InlineV1ChargesGetParameterAnyOf1X7a2241fc>(raw) else null }
  ...
  public val matchedBranches: Set<InlineV1ChargesGetParameterX3e2709beBranch>
    get() = buildSet {
      if (inspection.matchesInlineV1ChargesGetParameterAnyOf1X7a2241fc) add(InlineV1ChargesGetParameterX3e2709beBranch.InlineV1ChargesGetParameterAnyOf1X7a2241fc)
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineV1ChargesGetParameterX3e2709be {
      val inspection = inspectInlineV1ChargesGetParameterX3e2709be(raw)
      if (inspection.matchCount == 0) {
        throw InlineV1ChargesGetParameterX3e2709beNoMatchException("InlineV1ChargesGetParameterX3e2709be matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineV1ChargesGetParameterX3e2709be(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineV1ChargesGetParameterX3e2709be> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1ChargesGetParameterX3e2709be) {
      encoder.requireJsonEncoder("InlineV1ChargesGetParameterX3e2709be").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineV1ChargesGetParameterX3e2709be(element: JsonElement): InlineV1ChargesGetParameterX3e2709beInspection {
  val matchesInlineV1ChargesGetParameterAnyOf1X7a2241fc = element.isJsonDecodable<InlineV1ChargesGetParameterAnyOf1X7a2241fc>()
  ...
  return InlineV1ChargesGetParameterX3e2709beInspection(
    ...
    failures = buildList {
      if (!matchesInlineV1ChargesGetParameterAnyOf1X7a2241fc) add("InlineV1ChargesGetParameterAnyOf1X7a2241fc: value does not match InlineV1ChargesGetParameterAnyOf1X7a2241fc")
