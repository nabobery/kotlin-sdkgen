...
public class AccountMonthlyEstimatedRevenue(
  ...
  internal object Serializer : KSerializer<AccountMonthlyEstimatedRevenue> {
    ...
    override fun deserialize(decoder: Decoder): AccountMonthlyEstimatedRevenue {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("AccountMonthlyEstimatedRevenue must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: AccountMonthlyEstimatedRevenue) {
...
public fun accountMonthlyEstimatedRevenue(block: AccountMonthlyEstimatedRevenue.Builder.() -> Unit): AccountMonthlyEstimatedRevenue = AccountMonthlyEstimatedRevenue.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("AccountMonthlyEstimatedRevenue is missing required property '" + name + "'")
