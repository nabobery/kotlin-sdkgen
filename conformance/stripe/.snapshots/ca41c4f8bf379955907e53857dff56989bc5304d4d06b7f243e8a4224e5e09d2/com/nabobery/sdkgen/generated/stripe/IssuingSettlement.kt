...
public class IssuingSettlement(
  ...
  internal object Serializer : KSerializer<IssuingSettlement> {
    ...
    override fun deserialize(decoder: Decoder): IssuingSettlement {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("IssuingSettlement must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: IssuingSettlement) {
...
public fun issuingSettlement(block: IssuingSettlement.Builder.() -> Unit): IssuingSettlement = IssuingSettlement.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("IssuingSettlement is missing required property '" + name + "'")
