...
public class InlineCheckoutSessionInvoiceX33315f78 internal constructor(
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineCheckoutSessionInvoiceX33315f78 {
      val inspection = inspectInlineCheckoutSessionInvoiceX33315f78(raw)
      if (inspection.matchCount == 0) {
        throw InlineCheckoutSessionInvoiceX33315f78NoMatchException("InlineCheckoutSessionInvoiceX33315f78 matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineCheckoutSessionInvoiceX33315f78(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineCheckoutSessionInvoiceX33315f78> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineCheckoutSessionInvoiceX33315f78) {
      encoder.requireJsonEncoder("InlineCheckoutSessionInvoiceX33315f78").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineCheckoutSessionInvoiceX33315f78(element: JsonElement): InlineCheckoutSessionInvoiceX33315f78Inspection {
