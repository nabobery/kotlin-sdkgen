...
public class InlineSubscriptionTransferDataDestinationXf63f04cd internal constructor(
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineSubscriptionTransferDataDestinationXf63f04cd {
      val inspection = inspectInlineSubscriptionTransferDataDestinationXf63f04cd(raw)
      if (inspection.matchCount == 0) {
        throw InlineSubscriptionTransferDataDestinationXf63f04cdNoMatchException("InlineSubscriptionTransferDataDestinationXf63f04cd matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineSubscriptionTransferDataDestinationXf63f04cd(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineSubscriptionTransferDataDestinationXf63f04cd> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineSubscriptionTransferDataDestinationXf63f04cd) {
      encoder.requireJsonEncoder("InlineSubscriptionTransferDataDestinationXf63f04cd").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineSubscriptionTransferDataDestinationXf63f04cd(element: JsonElement): InlineSubscriptionTransferDataDestinationXf63f04cdInspection {
