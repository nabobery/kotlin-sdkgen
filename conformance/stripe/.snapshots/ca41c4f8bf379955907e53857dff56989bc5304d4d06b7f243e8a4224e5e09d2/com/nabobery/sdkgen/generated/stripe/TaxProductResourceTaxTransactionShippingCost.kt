...
public class TaxProductResourceTaxTransactionShippingCost(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): TaxProductResourceTaxTransactionShippingCost = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<TaxProductResourceTaxTransactionShippingCost> {
    ...
    override fun deserialize(decoder: Decoder): TaxProductResourceTaxTransactionShippingCost {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("TaxProductResourceTaxTransactionShippingCost must be a JSON object")
      val amount = json.decodeRequired<Int>(rawObject, "amount")
      val amountTax = json.decodeRequired<Int>(rawObject, "amount_tax")
      val taxBehavior = json.decodeRequired<InlineTaxProductResourceTaxTransactionShippingCostTaxBehaviorXd2b0b279>(rawObject, "tax_behavior")
    ...
    override fun serialize(encoder: Encoder, `value`: TaxProductResourceTaxTransactionShippingCost) {
...
public fun taxProductResourceTaxTransactionShippingCost(block: TaxProductResourceTaxTransactionShippingCost.Builder.() -> Unit): TaxProductResourceTaxTransactionShippingCost = TaxProductResourceTaxTransactionShippingCost.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("TaxProductResourceTaxTransactionShippingCost is missing required property '" + name + "'")
