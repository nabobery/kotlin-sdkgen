...
public class ConnectEmbeddedInstantPayoutsPromotionConfig(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): ConnectEmbeddedInstantPayoutsPromotionConfig = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<ConnectEmbeddedInstantPayoutsPromotionConfig> {
    ...
    override fun deserialize(decoder: Decoder): ConnectEmbeddedInstantPayoutsPromotionConfig {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("ConnectEmbeddedInstantPayoutsPromotionConfig must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: ConnectEmbeddedInstantPayoutsPromotionConfig) {
...
public fun connectEmbeddedInstantPayoutsPromotionConfig(block: ConnectEmbeddedInstantPayoutsPromotionConfig.Builder.() -> Unit): ConnectEmbeddedInstantPayoutsPromotionConfig = ConnectEmbeddedInstantPayoutsPromotionConfig.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("ConnectEmbeddedInstantPayoutsPromotionConfig is missing required property '" + name + "'")
