...
@Serializable
public data class PaymentMethodCardWalletView(
  ...
  public val masterpass: PaymentMethodCardWalletMasterpass? = null,
  @SerialName("samsung_pay")
  public val samsungPay: JsonObject? = null,
  public val type: InlinePaymentMethodCardWalletTypeXa8edbe9b,
  @SerialName("visa_checkout")
  public val visaCheckout: PaymentMethodCardWalletVisaCheckout? = null,
)

/**
 *
 *
 * Source: sdkgen://source/openapi.json#/components/schemas/payment_method_card_wallet
 */
@Serializable(with = PaymentMethodCardWallet.Serializer::class)
public class PaymentMethodCardWallet(
  /**
  ...
  public class Builder {
    private var typeValue: InlinePaymentMethodCardWalletTypeXa8edbe9b? = null

    public var type: InlinePaymentMethodCardWalletTypeXa8edbe9b
    ...
    public var masterpass: PaymentMethodCardWalletMasterpass? = null

    public var samsungPay: JsonObject? = null

    public var visaCheckout: PaymentMethodCardWalletVisaCheckout? = null

    public fun build(): PaymentMethodCardWallet {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): PaymentMethodCardWallet = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<PaymentMethodCardWallet> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): PaymentMethodCardWallet {
      val jsonDecoder = decoder.requireJsonDecoder("PaymentMethodCardWallet")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("PaymentMethodCardWallet must be a JSON object")
      val type = json.decodeRequired<InlinePaymentMethodCardWalletTypeXa8edbe9b>(rawObject, "type")
      return PaymentMethodCardWallet(
        type = type,
        ...
        masterpass = rawObject["masterpass"]?.let { json.decodeFromJsonElement<PaymentMethodCardWalletMasterpass>(it) },
        samsungPay = rawObject["samsung_pay"]?.let { json.decodeFromJsonElement<JsonObject>(it) },
        visaCheckout = rawObject["visa_checkout"]?.let { json.decodeFromJsonElement<PaymentMethodCardWalletVisaCheckout>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: PaymentMethodCardWallet) {
      val jsonEncoder = encoder.requireJsonEncoder("PaymentMethodCardWallet")
...
public fun paymentMethodCardWallet(block: PaymentMethodCardWallet.Builder.() -> Unit): PaymentMethodCardWallet = PaymentMethodCardWallet.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("PaymentMethodCardWallet is missing required property '" + name + "'")
