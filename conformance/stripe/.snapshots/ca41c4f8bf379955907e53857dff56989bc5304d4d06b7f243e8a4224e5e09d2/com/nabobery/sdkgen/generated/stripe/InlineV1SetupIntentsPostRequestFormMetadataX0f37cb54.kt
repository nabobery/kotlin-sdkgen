...
public class InlineV1SetupIntentsPostRequestFormMetadataX0f37cb54 internal constructor(
  ...
  public val inlineV1SetupIntentsPostRequestFormMetadataAnyOf2Xa3f5948f:
      ...
      lazy(LazyThreadSafetyMode.NONE) { if (inspection.matchesInlineV1SetupIntentsPostRequestFormMetadataAnyOf2Xa3f5948f) json.decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormMetadataAnyOf2Xa3f5948f>(raw) else null }
  ...
  public val matchedBranches: Set<InlineV1SetupIntentsPostRequestFormMetadataX0f37cb54Branch>
    get() = buildSet {
      ...
      if (inspection.matchesInlineV1SetupIntentsPostRequestFormMetadataAnyOf2Xa3f5948f) add(InlineV1SetupIntentsPostRequestFormMetadataX0f37cb54Branch.InlineV1SetupIntentsPostRequestFormMetadataAnyOf2Xa3f5948f)
    }
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineV1SetupIntentsPostRequestFormMetadataX0f37cb54 {
      val inspection = inspectInlineV1SetupIntentsPostRequestFormMetadataX0f37cb54(raw)
      if (inspection.matchCount == 0) {
        throw InlineV1SetupIntentsPostRequestFormMetadataX0f37cb54NoMatchException("InlineV1SetupIntentsPostRequestFormMetadataX0f37cb54 matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineV1SetupIntentsPostRequestFormMetadataX0f37cb54(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineV1SetupIntentsPostRequestFormMetadataX0f37cb54> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1SetupIntentsPostRequestFormMetadataX0f37cb54) {
      encoder.requireJsonEncoder("InlineV1SetupIntentsPostRequestFormMetadataX0f37cb54").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineV1SetupIntentsPostRequestFormMetadataX0f37cb54(element: JsonElement): InlineV1SetupIntentsPostRequestFormMetadataX0f37cb54Inspection {
  val matchesBranch1 = element.isJsonDecodable<JsonObject>()
  val matchesInlineV1SetupIntentsPostRequestFormMetadataAnyOf2Xa3f5948f = element.isJsonDecodable<InlineV1SetupIntentsPostRequestFormMetadataAnyOf2Xa3f5948f>()
  return InlineV1SetupIntentsPostRequestFormMetadataX0f37cb54Inspection(
    ...
    failures = buildList {
      ...
      if (!matchesInlineV1SetupIntentsPostRequestFormMetadataAnyOf2Xa3f5948f) add("InlineV1SetupIntentsPostRequestFormMetadataAnyOf2Xa3f5948f: value does not match InlineV1SetupIntentsPostRequestFormMetadataAnyOf2Xa3f5948f")
    },
  )
}
