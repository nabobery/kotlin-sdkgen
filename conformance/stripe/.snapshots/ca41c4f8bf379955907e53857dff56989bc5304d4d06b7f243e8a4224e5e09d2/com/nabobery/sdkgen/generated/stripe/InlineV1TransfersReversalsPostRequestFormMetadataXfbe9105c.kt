...
internal data class InlineV1TransfersReversalsPostRequestFormMetadataXfbe9105cInspection(
  ...
  public val matchCount: Int
    get() = listOf(matchesBranch1, matchesInlineV1TransfersReversalsPostRequestFormMetadataAnyOf2X6e78514b).count { it }
}
...
public class InlineV1TransfersReversalsPostRequestFormMetadataXfbe9105c internal constructor(
  ...
  public val inlineV1TransfersReversalsPostRequestFormMetadataAnyOf2X6e78514b:
      ...
      lazy(LazyThreadSafetyMode.NONE) { if (inspection.matchesInlineV1TransfersReversalsPostRequestFormMetadataAnyOf2X6e78514b) json.decodeFromJsonElement<InlineV1TransfersReversalsPostRequestFormMetadataAnyOf2X6e78514b>(raw) else null }

  public val matchedBranches: Set<InlineV1TransfersReversalsPostRequestFormMetadataXfbe9105cBranch>
    get() = buildSet {
      if (inspection.matchesBranch1) add(InlineV1TransfersReversalsPostRequestFormMetadataXfbe9105cBranch.Branch1)
      if (inspection.matchesInlineV1TransfersReversalsPostRequestFormMetadataAnyOf2X6e78514b) add(InlineV1TransfersReversalsPostRequestFormMetadataXfbe9105cBranch.InlineV1TransfersReversalsPostRequestFormMetadataAnyOf2X6e78514b)
    }
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineV1TransfersReversalsPostRequestFormMetadataXfbe9105c {
      val inspection = inspectInlineV1TransfersReversalsPostRequestFormMetadataXfbe9105c(raw)
      if (inspection.matchCount == 0) {
        throw InlineV1TransfersReversalsPostRequestFormMetadataXfbe9105cNoMatchException("InlineV1TransfersReversalsPostRequestFormMetadataXfbe9105c matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineV1TransfersReversalsPostRequestFormMetadataXfbe9105c(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineV1TransfersReversalsPostRequestFormMetadataXfbe9105c> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1TransfersReversalsPostRequestFormMetadataXfbe9105c) {
      encoder.requireJsonEncoder("InlineV1TransfersReversalsPostRequestFormMetadataXfbe9105c").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineV1TransfersReversalsPostRequestFormMetadataXfbe9105c(element: JsonElement): InlineV1TransfersReversalsPostRequestFormMetadataXfbe9105cInspection {
  val matchesBranch1 = element.isJsonDecodable<JsonObject>()
  val matchesInlineV1TransfersReversalsPostRequestFormMetadataAnyOf2X6e78514b = element.isJsonDecodable<InlineV1TransfersReversalsPostRequestFormMetadataAnyOf2X6e78514b>()
  return InlineV1TransfersReversalsPostRequestFormMetadataXfbe9105cInspection(
    ...
    failures = buildList {
      ...
      if (!matchesInlineV1TransfersReversalsPostRequestFormMetadataAnyOf2X6e78514b) add("InlineV1TransfersReversalsPostRequestFormMetadataAnyOf2X6e78514b: value does not match InlineV1TransfersReversalsPostRequestFormMetadataAnyOf2X6e78514b")
    },
  )
}
