...
public class InlineDiscountsResourceStackableDiscountWithDiscountEndDiscountXc537ebea internal constructor(
  ...
  public val matchedBranches:
    ...
    get() = buildSet {
      if (inspection.matchesBranch1) add(InlineDiscountsResourceStackableDiscountWithDiscountEndDiscountXc537ebeaBranch.Branch1)
      if (inspection.matchesDiscount) add(InlineDiscountsResourceStackableDiscountWithDiscountEndDiscountXc537ebeaBranch.Discount)
    }
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineDiscountsResourceStackableDiscountWithDiscountEndDiscountXc537ebea {
      val inspection = inspectInlineDiscountsResourceStackableDiscountWithDiscountEndDiscountXc537ebea(raw)
      if (inspection.matchCount == 0) {
        throw InlineDiscountsResourceStackableDiscountWithDiscountEndDiscountXc537ebeaNoMatchException("InlineDiscountsResourceStackableDiscountWithDiscountEndDiscountXc537ebea matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineDiscountsResourceStackableDiscountWithDiscountEndDiscountXc537ebea(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineDiscountsResourceStackableDiscountWithDiscountEndDiscountXc537ebea> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineDiscountsResourceStackableDiscountWithDiscountEndDiscountXc537ebea {
      val jsonDecoder = decoder.requireJsonDecoder("InlineDiscountsResourceStackableDiscountWithDiscountEndDiscountXc537ebea")
      return fromRaw(jsonDecoder.decodeJsonElement(), jsonDecoder.json)
    }

    override fun serialize(encoder: Encoder, `value`: InlineDiscountsResourceStackableDiscountWithDiscountEndDiscountXc537ebea) {
      encoder.requireJsonEncoder("InlineDiscountsResourceStackableDiscountWithDiscountEndDiscountXc537ebea").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineDiscountsResourceStackableDiscountWithDiscountEndDiscountXc537ebea(element: JsonElement): InlineDiscountsResourceStackableDiscountWithDiscountEndDiscountXc537ebeaInspection {
