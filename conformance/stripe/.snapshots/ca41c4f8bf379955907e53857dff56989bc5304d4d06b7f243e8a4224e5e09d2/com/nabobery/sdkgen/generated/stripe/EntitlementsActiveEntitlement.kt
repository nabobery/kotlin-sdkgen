...
public class EntitlementsActiveEntitlement(
  ...
  internal object Serializer : KSerializer<EntitlementsActiveEntitlement> {
    ...
    override fun deserialize(decoder: Decoder): EntitlementsActiveEntitlement {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("EntitlementsActiveEntitlement must be a JSON object")
      ...
      val objectValue = json.decodeRequired<InlineEntitlementsActiveEntitlementObjectValueX098f8f09>(rawObject, "object")
      return EntitlementsActiveEntitlement(
        feature = feature,
        id = id,
        livemode = livemode,
    ...
    override fun serialize(encoder: Encoder, `value`: EntitlementsActiveEntitlement) {
...
public fun entitlementsActiveEntitlement(block: EntitlementsActiveEntitlement.Builder.() -> Unit): EntitlementsActiveEntitlement = EntitlementsActiveEntitlement.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("EntitlementsActiveEntitlement is missing required property '" + name + "'")
