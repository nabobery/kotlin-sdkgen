...
public class ReserveTransaction(
  ...
  internal object Serializer : KSerializer<ReserveTransaction> {
    ...
    override fun deserialize(decoder: Decoder): ReserveTransaction {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("ReserveTransaction must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: ReserveTransaction) {
...
public fun reserveTransaction(block: ReserveTransaction.Builder.() -> Unit): ReserveTransaction = ReserveTransaction.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("ReserveTransaction is missing required property '" + name + "'")
