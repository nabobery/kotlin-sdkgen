...
public class InlineSubscriptionsResourceBillingSchedulesAppliesToPriceXafa9c902 internal constructor(
  ...
  public val matchedBranches:
    ...
    get() = buildSet {
      if (inspection.matchesBranch1) add(InlineSubscriptionsResourceBillingSchedulesAppliesToPriceXafa9c902Branch.Branch1)
      if (inspection.matchesPrice) add(InlineSubscriptionsResourceBillingSchedulesAppliesToPriceXafa9c902Branch.Price)
    }
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineSubscriptionsResourceBillingSchedulesAppliesToPriceXafa9c902 {
      val inspection = inspectInlineSubscriptionsResourceBillingSchedulesAppliesToPriceXafa9c902(raw)
      if (inspection.matchCount == 0) {
        throw InlineSubscriptionsResourceBillingSchedulesAppliesToPriceXafa9c902NoMatchException("InlineSubscriptionsResourceBillingSchedulesAppliesToPriceXafa9c902 matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineSubscriptionsResourceBillingSchedulesAppliesToPriceXafa9c902(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineSubscriptionsResourceBillingSchedulesAppliesToPriceXafa9c902> {
    ...
    override fun deserialize(decoder: Decoder): InlineSubscriptionsResourceBillingSchedulesAppliesToPriceXafa9c902 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineSubscriptionsResourceBillingSchedulesAppliesToPriceXafa9c902")
      return fromRaw(jsonDecoder.decodeJsonElement(), jsonDecoder.json)
    }

    override fun serialize(encoder: Encoder, `value`: InlineSubscriptionsResourceBillingSchedulesAppliesToPriceXafa9c902) {
      encoder.requireJsonEncoder("InlineSubscriptionsResourceBillingSchedulesAppliesToPriceXafa9c902").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineSubscriptionsResourceBillingSchedulesAppliesToPriceXafa9c902(element: JsonElement): InlineSubscriptionsResourceBillingSchedulesAppliesToPriceXafa9c902Inspection {
