...
public class InlineV1SourcesPostRequestFormMandateX9367a038(
  ...
  public val notificationMethod:
      InlineV1SourcesPostRequestFormMandateNotificationMethodXa987664a? = null,
) {
  public class Builder {
    ...
    public fun build(): InlineV1SourcesPostRequestFormMandateX9367a038 = InlineV1SourcesPostRequestFormMandateX9367a038(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1SourcesPostRequestFormMandateX9367a038 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1SourcesPostRequestFormMandateX9367a038> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1SourcesPostRequestFormMandateX9367a038 {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1SourcesPostRequestFormMandateX9367a038 must be a JSON object")
      return InlineV1SourcesPostRequestFormMandateX9367a038(
        acceptance = rawObject["acceptance"]?.let { json.decodeFromJsonElement<InlineV1SourcesPostRequestFormMandateAcceptanceX8b67948c>(it) },
        amount = rawObject["amount"]?.let { json.decodeFromJsonElement<InlineV1SourcesPostRequestFormMandateAmountX44daab51>(it) },
        currency = rawObject["currency"]?.let { json.decodeFromJsonElement<String>(it) },
        interval = rawObject["interval"]?.let { json.decodeFromJsonElement<InlineV1SourcesPostRequestFormMandateIntervalX24e2e3bf>(it) },
        notificationMethod = rawObject["notification_method"]?.let { json.decodeFromJsonElement<InlineV1SourcesPostRequestFormMandateNotificationMethodXa987664a>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineV1SourcesPostRequestFormMandateX9367a038) {
...
public fun inlineV1SourcesPostRequestFormMandateX9367a038(block: InlineV1SourcesPostRequestFormMandateX9367a038.Builder.() -> Unit): InlineV1SourcesPostRequestFormMandateX9367a038 = InlineV1SourcesPostRequestFormMandateX9367a038.build(block)
