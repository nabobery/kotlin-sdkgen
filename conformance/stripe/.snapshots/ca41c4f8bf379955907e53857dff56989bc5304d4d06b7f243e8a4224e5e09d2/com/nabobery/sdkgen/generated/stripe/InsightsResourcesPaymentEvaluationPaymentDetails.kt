...
public class InsightsResourcesPaymentEvaluationPaymentDetails(
  ...
  public val moneyMovementDetails:
      InlineInsightsResourcesPay1e91MoneyMovementDetailsXd20bc7c4? = null,
  /**
   * Details about the payment method used for the payment.
   */
  public val paymentMethodDetails:
      InlineInsightsResourcesPay1e91PaymentMethodDetailsX1c90f570? = null,
  /**
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InsightsResourcesPaymentEvaluationPaymentDetails = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InsightsResourcesPaymentEvaluationPaymentDetails> {
    ...
    override fun deserialize(decoder: Decoder): InsightsResourcesPaymentEvaluationPaymentDetails {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InsightsResourcesPaymentEvaluationPaymentDetails must be a JSON object")
      ...
      return InsightsResourcesPaymentEvaluationPaymentDetails(
        ...
        moneyMovementDetails = rawObject["money_movement_details"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineInsightsResourcesPay1e91MoneyMovementDetailsXd20bc7c4?>(element) },
        paymentMethodDetails = rawObject["payment_method_details"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineInsightsResourcesPay1e91PaymentMethodDetailsX1c90f570?>(element) },
        shippingDetails = rawObject["shipping_details"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineInsightsResourcesPaymentEvaluationPaymentDetailsShippingDetailsXbc8fa696?>(element) },
    ...
    override fun serialize(encoder: Encoder, `value`: InsightsResourcesPaymentEvaluationPaymentDetails) {
...
public fun insightsResourcesPaymentEvaluationPaymentDetails(block: InsightsResourcesPaymentEvaluationPaymentDetails.Builder.() -> Unit): InsightsResourcesPaymentEvaluationPaymentDetails = InsightsResourcesPaymentEvaluationPaymentDetails.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InsightsResourcesPaymentEvaluationPaymentDetails is missing required property '" + name + "'")
