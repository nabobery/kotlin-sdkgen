...
public class DeletedInvoice(
  ...
  internal object Serializer : KSerializer<DeletedInvoice> {
    ...
    override fun deserialize(decoder: Decoder): DeletedInvoice {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("DeletedInvoice must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: DeletedInvoice) {
...
private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("DeletedInvoice is missing required property '" + name + "'")
