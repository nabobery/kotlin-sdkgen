...
public class BalanceAmount(
  ...
  internal object Serializer : KSerializer<BalanceAmount> {
    ...
    override fun deserialize(decoder: Decoder): BalanceAmount {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("BalanceAmount must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: BalanceAmount) {
