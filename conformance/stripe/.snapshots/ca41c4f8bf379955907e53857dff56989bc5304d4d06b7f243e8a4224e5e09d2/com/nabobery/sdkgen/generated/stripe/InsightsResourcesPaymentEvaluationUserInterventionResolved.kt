...
public class InsightsResourcesPaymentEvaluationUserInterventionResolved(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InsightsResourcesPaymentEvaluationUserInterventionResolved = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InsightsResourcesPaymentEvaluationUserInterventionResolved> {
    ...
    override fun deserialize(decoder: Decoder): InsightsResourcesPaymentEvaluationUserInterventionResolved {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InsightsResourcesPaymentEvaluationUserInterventionResolved must be a JSON object")
      val key = json.decodeRequired<String>(rawObject, "key")
      return InsightsResourcesPaymentEvaluationUserInterventionResolved(
        key = key,
        outcome = rawObject["outcome"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineInsightsResourcesPaymentEvaluationUserInterventionResolvedOutcomeX213724ab?>(element) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InsightsResourcesPaymentEvaluationUserInterventionResolved) {
...
public fun insightsResourcesPaymentEvaluationUserInterventionResolved(block: InsightsResourcesPaymentEvaluationUserInterventionResolved.Builder.() -> Unit): InsightsResourcesPaymentEvaluationUserInterventionResolved = InsightsResourcesPaymentEvaluationUserInterventionResolved.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InsightsResourcesPaymentEvaluationUserInterventionResolved is missing required property '" + name + "'")
