...
public class InlineV1CreditNotesPreviewLinesGetParameterItemPaymentRecordRefundXd721d2ed(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1CreditNotesPreviewLinesGetParameterItemPaymentRecordRefundXd721d2ed = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1CreditNotesPreviewLinesGetParameterItemPaymentRecordRefundXd721d2ed> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineV1CreditNotesPreviewLinesGetParameterItemPaymentRecordRefundXd721d2ed {
      val jsonDecoder = decoder.requireJsonDecoder("InlineV1CreditNotesPreviewLinesGetParameterItemPaymentRecordRefundXd721d2ed")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1CreditNotesPreviewLinesGetParameterItemPaymentRecordRefundXd721d2ed must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1CreditNotesPreviewLinesGetParameterItemPaymentRecordRefundXd721d2ed) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineV1CreditNotesPreviewLinesGetParameterItemPaymentRecordRefundXd721d2ed")
...
public fun inlineV1CreditNotesPreviewLinesGetParameterItemPaymentRecordRefundXd721d2ed(block: InlineV1CreditNotesPreviewLinesGetParameterItemPaymentRecordRefundXd721d2ed.Builder.() -> Unit): InlineV1CreditNotesPreviewLinesGetParameterItemPaymentRecordRefundXd721d2ed = InlineV1CreditNotesPreviewLinesGetParameterItemPaymentRecordRefundXd721d2ed.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineV1CreditNotesPreviewLinesGetParameterItemPaymentRecordRefundXd721d2ed is missing required property '" + name + "'")
