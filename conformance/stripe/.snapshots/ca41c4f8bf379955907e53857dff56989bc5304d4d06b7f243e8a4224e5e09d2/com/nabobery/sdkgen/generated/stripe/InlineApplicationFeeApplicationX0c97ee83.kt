...
public class InlineApplicationFeeApplicationX0c97ee83 internal constructor(
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineApplicationFeeApplicationX0c97ee83 {
      val inspection = inspectInlineApplicationFeeApplicationX0c97ee83(raw)
      if (inspection.matchCount == 0) {
        throw InlineApplicationFeeApplicationX0c97ee83NoMatchException("InlineApplicationFeeApplicationX0c97ee83 matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineApplicationFeeApplicationX0c97ee83(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineApplicationFeeApplicationX0c97ee83> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineApplicationFeeApplicationX0c97ee83) {
      encoder.requireJsonEncoder("InlineApplicationFeeApplicationX0c97ee83").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineApplicationFeeApplicationX0c97ee83(element: JsonElement): InlineApplicationFeeApplicationX0c97ee83Inspection {
