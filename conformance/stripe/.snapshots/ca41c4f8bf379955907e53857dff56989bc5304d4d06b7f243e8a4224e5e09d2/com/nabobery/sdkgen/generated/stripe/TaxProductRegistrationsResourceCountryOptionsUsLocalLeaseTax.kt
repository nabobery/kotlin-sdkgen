...
public class TaxProductRegistrationsResourceCountryOptionsUsLocalLeaseTax(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): TaxProductRegistrationsResourceCountryOptionsUsLocalLeaseTax = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<TaxProductRegistrationsResourceCountryOptionsUsLocalLeaseTax> {
    ...
    override fun deserialize(decoder: Decoder): TaxProductRegistrationsResourceCountryOptionsUsLocalLeaseTax {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("TaxProductRegistrationsResourceCountryOptionsUsLocalLeaseTax must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: TaxProductRegistrationsResourceCountryOptionsUsLocalLeaseTax) {
...
public fun taxProductRegistrationsResourceCountryOptionsUsLocalLeaseTax(block: TaxProductRegistrationsResourceCountryOptionsUsLocalLeaseTax.Builder.() -> Unit): TaxProductRegistrationsResourceCountryOptionsUsLocalLeaseTax = TaxProductRegistrationsResourceCountryOptionsUsLocalLeaseTax.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("TaxProductRegistrationsResourceCountryOptionsUsLocalLeaseTax is missing required property '" + name + "'")
