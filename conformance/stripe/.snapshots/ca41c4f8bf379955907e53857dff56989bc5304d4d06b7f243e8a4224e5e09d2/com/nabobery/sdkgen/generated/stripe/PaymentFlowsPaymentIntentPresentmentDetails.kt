...
public class PaymentFlowsPaymentIntentPresentmentDetails(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): PaymentFlowsPaymentIntentPresentmentDetails = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<PaymentFlowsPaymentIntentPresentmentDetails> {
    ...
    override fun deserialize(decoder: Decoder): PaymentFlowsPaymentIntentPresentmentDetails {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("PaymentFlowsPaymentIntentPresentmentDetails must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: PaymentFlowsPaymentIntentPresentmentDetails) {
...
public fun paymentFlowsPaymentIntentPresentmentDetails(block: PaymentFlowsPaymentIntentPresentmentDetails.Builder.() -> Unit): PaymentFlowsPaymentIntentPresentmentDetails = PaymentFlowsPaymentIntentPresentmentDetails.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("PaymentFlowsPaymentIntentPresentmentDetails is missing required property '" + name + "'")
