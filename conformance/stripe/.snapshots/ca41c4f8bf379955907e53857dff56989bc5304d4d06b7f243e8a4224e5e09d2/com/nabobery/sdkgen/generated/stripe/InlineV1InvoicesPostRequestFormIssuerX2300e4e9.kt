...
public class InlineV1InvoicesPostRequestFormIssuerX2300e4e9(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1InvoicesPostRequestFormIssuerX2300e4e9 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1InvoicesPostRequestFormIssuerX2300e4e9> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1InvoicesPostRequestFormIssuerX2300e4e9 {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1InvoicesPostRequestFormIssuerX2300e4e9 must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1InvoicesPostRequestFormIssuerX2300e4e9) {
...
public fun inlineV1InvoicesPostRequestFormIssuerX2300e4e9(block: InlineV1InvoicesPostRequestFormIssuerX2300e4e9.Builder.() -> Unit): InlineV1InvoicesPostRequestFormIssuerX2300e4e9 = InlineV1InvoicesPostRequestFormIssuerX2300e4e9.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineV1InvoicesPostRequestFormIssuerX2300e4e9 is missing required property '" + name + "'")
