...
public class IssuingTransactionFleetCardholderPromptData(
  ...
  public class Builder {
    ...
    public fun build(): IssuingTransactionFleetCardholderPromptData = IssuingTransactionFleetCardholderPromptData(
      driverId = driverId,
      odometer = odometer,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): IssuingTransactionFleetCardholderPromptData = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<IssuingTransactionFleetCardholderPromptData> {
    ...
    override fun deserialize(decoder: Decoder): IssuingTransactionFleetCardholderPromptData {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("IssuingTransactionFleetCardholderPromptData must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: IssuingTransactionFleetCardholderPromptData) {
...
public fun issuingTransactionFleetCardholderPromptData(block: IssuingTransactionFleetCardholderPromptData.Builder.() -> Unit): IssuingTransactionFleetCardholderPromptData = IssuingTransactionFleetCardholderPromptData.build(block)
