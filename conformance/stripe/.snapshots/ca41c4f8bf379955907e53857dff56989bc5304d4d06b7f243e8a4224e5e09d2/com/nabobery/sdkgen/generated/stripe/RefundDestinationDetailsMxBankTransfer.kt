...
public class RefundDestinationDetailsMxBankTransfer(
  ...
  public class Builder {
    ...
    public fun build(): RefundDestinationDetailsMxBankTransfer = RefundDestinationDetailsMxBankTransfer(
      reference = reference,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): RefundDestinationDetailsMxBankTransfer = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<RefundDestinationDetailsMxBankTransfer> {
    ...
    override fun deserialize(decoder: Decoder): RefundDestinationDetailsMxBankTransfer {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("RefundDestinationDetailsMxBankTransfer must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: RefundDestinationDetailsMxBankTransfer) {
...
public fun refundDestinationDetailsMxBankTransfer(block: RefundDestinationDetailsMxBankTransfer.Builder.() -> Unit): RefundDestinationDetailsMxBankTransfer = RefundDestinationDetailsMxBankTransfer.build(block)
