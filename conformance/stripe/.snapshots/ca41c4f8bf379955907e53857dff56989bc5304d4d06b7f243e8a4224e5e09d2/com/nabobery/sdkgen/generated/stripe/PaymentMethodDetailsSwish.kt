...
public class PaymentMethodDetailsSwish(
  ...
  public class Builder {
    ...
    public fun build(): PaymentMethodDetailsSwish = PaymentMethodDetailsSwish(
  ...
  internal object Serializer : KSerializer<PaymentMethodDetailsSwish> {
    ...
    override fun deserialize(decoder: Decoder): PaymentMethodDetailsSwish {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("PaymentMethodDetailsSwish must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: PaymentMethodDetailsSwish) {
...
public fun paymentMethodDetailsSwish(block: PaymentMethodDetailsSwish.Builder.() -> Unit): PaymentMethodDetailsSwish = PaymentMethodDetailsSwish.build(block)
