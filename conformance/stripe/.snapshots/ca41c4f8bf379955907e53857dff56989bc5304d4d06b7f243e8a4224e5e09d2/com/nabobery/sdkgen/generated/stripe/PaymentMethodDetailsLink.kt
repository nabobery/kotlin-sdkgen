...
public class PaymentMethodDetailsLink(
  ...
  public class Builder {
    ...
    public fun build(): PaymentMethodDetailsLink = PaymentMethodDetailsLink(
      country = country,
    )
  }
  ...
  internal object Serializer : KSerializer<PaymentMethodDetailsLink> {
    ...
    override fun deserialize(decoder: Decoder): PaymentMethodDetailsLink {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("PaymentMethodDetailsLink must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: PaymentMethodDetailsLink) {
...
public fun paymentMethodDetailsLink(block: PaymentMethodDetailsLink.Builder.() -> Unit): PaymentMethodDetailsLink = PaymentMethodDetailsLink.build(block)
