...
public class InvoiceItemThresholdReason(
  ...
  public class Builder {
    ...
    public var lineItemIds: List<String>
      get() = requireNotNull(lineItemIdsValue) { "lineItemIds is required" }.toList()
      set(`value`) {
        lineItemIdsValue = value.toList()
      }
  ...
  internal object Serializer : KSerializer<InvoiceItemThresholdReason> {
    ...
    override fun deserialize(decoder: Decoder): InvoiceItemThresholdReason {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InvoiceItemThresholdReason must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InvoiceItemThresholdReason) {
...
public fun invoiceItemThresholdReason(block: InvoiceItemThresholdReason.Builder.() -> Unit): InvoiceItemThresholdReason = InvoiceItemThresholdReason.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InvoiceItemThresholdReason is missing required property '" + name + "'")
