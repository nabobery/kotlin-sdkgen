...
public class InlineV1PaymentMethodsPostRequestFormFpxXb8e6acfd(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1PaymentMethodsPostRequestFormFpxXb8e6acfd = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1PaymentMethodsPostRequestFormFpxXb8e6acfd> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1PaymentMethodsPostRequestFormFpxXb8e6acfd {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1PaymentMethodsPostRequestFormFpxXb8e6acfd must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1PaymentMethodsPostRequestFormFpxXb8e6acfd) {
...
public fun inlineV1PaymentMethodsPostRequestFormFpxXb8e6acfd(block: InlineV1PaymentMethodsPostRequestFormFpxXb8e6acfd.Builder.() -> Unit): InlineV1PaymentMethodsPostRequestFormFpxXb8e6acfd = InlineV1PaymentMethodsPostRequestFormFpxXb8e6acfd.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineV1PaymentMethodsPostRequestFormFpxXb8e6acfd is missing required property '" + name + "'")
