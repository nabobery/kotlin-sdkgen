...
public class InlineV1InvoiceitemsPostRequestFormX6b3131e5(
  ...
  public class Builder {
    ...
    public fun build(): InlineV1InvoiceitemsPostRequestFormX6b3131e5 = InlineV1InvoiceitemsPostRequestFormX6b3131e5(
      amount = amount,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1InvoiceitemsPostRequestFormX6b3131e5 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1InvoiceitemsPostRequestFormX6b3131e5> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1InvoiceitemsPostRequestFormX6b3131e5 {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1InvoiceitemsPostRequestFormX6b3131e5 must be a JSON object")
      return InlineV1InvoiceitemsPostRequestFormX6b3131e5(
        ...
        discounts = rawObject["discounts"]?.let { json.decodeFromJsonElement<InlineV1InvoiceitemsPostRequestFormDiscountsX2a7c703b>(it) },
        expand = rawObject["expand"]?.let { json.decodeFromJsonElement<List<String>>(it) },
        metadata = rawObject["metadata"]?.let { json.decodeFromJsonElement<InlineV1InvoiceitemsPostRequestFormMetadataX326f4fd6>(it) },
        period = rawObject["period"]?.let { json.decodeFromJsonElement<InlineV1InvoiceitemsPostRequestFormPeriodXcae985a7>(it) },
        priceData = rawObject["price_data"]?.let { json.decodeFromJsonElement<InlineV1InvoiceitemsPostRequestFormPriceDataXd6200d26>(it) },
        pricing = rawObject["pricing"]?.let { json.decodeFromJsonElement<InlineV1InvoiceitemsPostRequestFormPricingXb7c9078a>(it) },
        ...
        taxBehavior = rawObject["tax_behavior"]?.let { json.decodeFromJsonElement<InlineV1InvoiceitemsPostRequestFormTaxBehaviorXd0ff4db1>(it) },
        taxCode = rawObject["tax_code"]?.let { json.decodeFromJsonElement<InlineV1InvoiceitemsPostRequestFormTaxCodeX8962e651>(it) },
        taxRates = rawObject["tax_rates"]?.let { json.decodeFromJsonElement<InlineV1InvoiceitemsPostRequestFormTaxRatesX226d041e>(it) },
        unitAmountDecimal = rawObject["unit_amount_decimal"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineV1InvoiceitemsPostRequestFormX6b3131e5) {
...
public fun inlineV1InvoiceitemsPostRequestFormX6b3131e5(block: InlineV1InvoiceitemsPostRequestFormX6b3131e5.Builder.() -> Unit): InlineV1InvoiceitemsPostRequestFormX6b3131e5 = InlineV1InvoiceitemsPostRequestFormX6b3131e5.build(block)
