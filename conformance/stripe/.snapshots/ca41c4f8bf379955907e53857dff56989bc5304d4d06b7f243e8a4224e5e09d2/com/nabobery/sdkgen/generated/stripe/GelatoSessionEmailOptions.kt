...
public class GelatoSessionEmailOptions(
  ...
  public class Builder {
    ...
    public fun build(): GelatoSessionEmailOptions = GelatoSessionEmailOptions(
  ...
  internal object Serializer : KSerializer<GelatoSessionEmailOptions> {
    ...
    override fun deserialize(decoder: Decoder): GelatoSessionEmailOptions {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("GelatoSessionEmailOptions must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: GelatoSessionEmailOptions) {
...
public fun gelatoSessionEmailOptions(block: GelatoSessionEmailOptions.Builder.() -> Unit): GelatoSessionEmailOptions = GelatoSessionEmailOptions.build(block)
