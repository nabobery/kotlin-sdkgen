...
public class InlinePaymentLinkOnBehalfOfX640a3de7 internal constructor(
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlinePaymentLinkOnBehalfOfX640a3de7 {
      val inspection = inspectInlinePaymentLinkOnBehalfOfX640a3de7(raw)
      if (inspection.matchCount == 0) {
        throw InlinePaymentLinkOnBehalfOfX640a3de7NoMatchException("InlinePaymentLinkOnBehalfOfX640a3de7 matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlinePaymentLinkOnBehalfOfX640a3de7(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlinePaymentLinkOnBehalfOfX640a3de7> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlinePaymentLinkOnBehalfOfX640a3de7) {
      encoder.requireJsonEncoder("InlinePaymentLinkOnBehalfOfX640a3de7").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlinePaymentLinkOnBehalfOfX640a3de7(element: JsonElement): InlinePaymentLinkOnBehalfOfX640a3de7Inspection {
