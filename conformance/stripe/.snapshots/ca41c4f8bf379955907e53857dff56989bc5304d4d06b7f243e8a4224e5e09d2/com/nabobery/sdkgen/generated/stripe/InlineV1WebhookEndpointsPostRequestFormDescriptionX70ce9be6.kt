...
internal data class InlineV1WebhookEndpointsPostRequestFormDescriptionX70ce9be6Inspection(
  ...
  public val matchCount: Int
    get() = listOf(matchesBranch1, matchesInlineV1WebhookEndpointsPostRequestFormDescriptionAnyOf2X11660662).count { it }
}
...
public class InlineV1WebhookEndpointsPostRequestFormDescriptionX70ce9be6 internal constructor(
  ...
  public val inlineV1WebhookEndpointsPostRequestFormDescriptionAnyOf2X11660662:
      ...
      lazy(LazyThreadSafetyMode.NONE) { if (inspection.matchesInlineV1WebhookEndpointsPostRequestFormDescriptionAnyOf2X11660662) json.decodeFromJsonElement<InlineV1WebhookEndpointsPostRequestFormDescriptionAnyOf2X11660662>(raw) else null }

  public val matchedBranches: Set<InlineV1WebhookEndpointsPostRequestFormDescriptionX70ce9be6Branch>
    get() = buildSet {
      if (inspection.matchesBranch1) add(InlineV1WebhookEndpointsPostRequestFormDescriptionX70ce9be6Branch.Branch1)
      if (inspection.matchesInlineV1WebhookEndpointsPostRequestFormDescriptionAnyOf2X11660662) add(InlineV1WebhookEndpointsPostRequestFormDescriptionX70ce9be6Branch.InlineV1WebhookEndpointsPostRequestFormDescriptionAnyOf2X11660662)
    }
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineV1WebhookEndpointsPostRequestFormDescriptionX70ce9be6 {
      val inspection = inspectInlineV1WebhookEndpointsPostRequestFormDescriptionX70ce9be6(raw)
      if (inspection.matchCount == 0) {
        throw InlineV1WebhookEndpointsPostRequestFormDescriptionX70ce9be6NoMatchException("InlineV1WebhookEndpointsPostRequestFormDescriptionX70ce9be6 matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineV1WebhookEndpointsPostRequestFormDescriptionX70ce9be6(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineV1WebhookEndpointsPostRequestFormDescriptionX70ce9be6> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1WebhookEndpointsPostRequestFormDescriptionX70ce9be6) {
      encoder.requireJsonEncoder("InlineV1WebhookEndpointsPostRequestFormDescriptionX70ce9be6").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineV1WebhookEndpointsPostRequestFormDescriptionX70ce9be6(element: JsonElement): InlineV1WebhookEndpointsPostRequestFormDescriptionX70ce9be6Inspection {
  val matchesBranch1 = element.isJsonDecodable<String>()
  val matchesInlineV1WebhookEndpointsPostRequestFormDescriptionAnyOf2X11660662 = element.isJsonDecodable<InlineV1WebhookEndpointsPostRequestFormDescriptionAnyOf2X11660662>()
  return InlineV1WebhookEndpointsPostRequestFormDescriptionX70ce9be6Inspection(
    ...
    failures = buildList {
      ...
      if (!matchesInlineV1WebhookEndpointsPostRequestFormDescriptionAnyOf2X11660662) add("InlineV1WebhookEndpointsPostRequestFormDescriptionAnyOf2X11660662: value does not match InlineV1WebhookEndpointsPostRequestFormDescriptionAnyOf2X11660662")
    },
  )
}
