...
public class InlineSubscriptionApplicationX28439c61 internal constructor(
  ...
  public val matchedBranches: Set<InlineSubscriptionApplicationX28439c61Branch>
    get() = buildSet {
      ...
      if (inspection.matchesDeletedApplication) add(InlineSubscriptionApplicationX28439c61Branch.DeletedApplication)
    }
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineSubscriptionApplicationX28439c61 {
      val inspection = inspectInlineSubscriptionApplicationX28439c61(raw)
      if (inspection.matchCount == 0) {
        throw InlineSubscriptionApplicationX28439c61NoMatchException("InlineSubscriptionApplicationX28439c61 matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineSubscriptionApplicationX28439c61(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineSubscriptionApplicationX28439c61> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineSubscriptionApplicationX28439c61) {
      encoder.requireJsonEncoder("InlineSubscriptionApplicationX28439c61").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineSubscriptionApplicationX28439c61(element: JsonElement): InlineSubscriptionApplicationX28439c61Inspection {
