...
public class InlineV1AccountsExternalAccountsGetResponse200JsonXfeb5979b(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1AccountsExternalAccountsGetResponse200JsonXfeb5979b = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1AccountsExternalAccountsGetResponse200JsonXfeb5979b> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1AccountsExternalAccountsGetResponse200JsonXfeb5979b {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1AccountsExternalAccountsGetResponse200JsonXfeb5979b must be a JSON object")
      val data = json.decodeRequired<List<InlineV1AccountsExternalAccountsGetResponse200JsonDataItemX40ebe1cb>>(rawObject, "data")
      val hasMore = json.decodeRequired<Boolean>(rawObject, "has_more")
      val objectValue = json.decodeRequired<InlineV1AccountsExternalAccountsGetResponse200JsonObjectValueXcf4fbe93>(rawObject, "object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1AccountsExternalAccountsGetResponse200JsonXfeb5979b) {
...
public fun inlineV1AccountsExternalAccountsGetResponse200JsonXfeb5979b(block: InlineV1AccountsExternalAccountsGetResponse200JsonXfeb5979b.Builder.() -> Unit): InlineV1AccountsExternalAccountsGetResponse200JsonXfeb5979b = InlineV1AccountsExternalAccountsGetResponse200JsonXfeb5979b.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineV1AccountsExternalAccountsGetResponse200JsonXfeb5979b is missing required property '" + name + "'")
