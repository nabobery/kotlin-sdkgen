...
public class InlineV1ProductsPostRequestFormUnitLabelX6c533a49 internal constructor(
  ...
  public val inlineV1ProductsPostRequestFormUnitLabelAnyOf2Xca6a9353:
      ...
      lazy(LazyThreadSafetyMode.NONE) { if (inspection.matchesInlineV1ProductsPostRequestFormUnitLabelAnyOf2Xca6a9353) json.decodeFromJsonElement<InlineV1ProductsPostRequestFormUnitLabelAnyOf2Xca6a9353>(raw) else null }
  ...
  public val matchedBranches: Set<InlineV1ProductsPostRequestFormUnitLabelX6c533a49Branch>
    get() = buildSet {
      ...
      if (inspection.matchesInlineV1ProductsPostRequestFormUnitLabelAnyOf2Xca6a9353) add(InlineV1ProductsPostRequestFormUnitLabelX6c533a49Branch.InlineV1ProductsPostRequestFormUnitLabelAnyOf2Xca6a9353)
    }
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineV1ProductsPostRequestFormUnitLabelX6c533a49 {
      val inspection = inspectInlineV1ProductsPostRequestFormUnitLabelX6c533a49(raw)
      if (inspection.matchCount == 0) {
        throw InlineV1ProductsPostRequestFormUnitLabelX6c533a49NoMatchException("InlineV1ProductsPostRequestFormUnitLabelX6c533a49 matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineV1ProductsPostRequestFormUnitLabelX6c533a49(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineV1ProductsPostRequestFormUnitLabelX6c533a49> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1ProductsPostRequestFormUnitLabelX6c533a49) {
      encoder.requireJsonEncoder("InlineV1ProductsPostRequestFormUnitLabelX6c533a49").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineV1ProductsPostRequestFormUnitLabelX6c533a49(element: JsonElement): InlineV1ProductsPostRequestFormUnitLabelX6c533a49Inspection {
  val matchesBranch1 = element.isJsonDecodable<String>()
  val matchesInlineV1ProductsPostRequestFormUnitLabelAnyOf2Xca6a9353 = element.isJsonDecodable<InlineV1ProductsPostRequestFormUnitLabelAnyOf2Xca6a9353>()
  return InlineV1ProductsPostRequestFormUnitLabelX6c533a49Inspection(
    ...
    failures = buildList {
      ...
      if (!matchesInlineV1ProductsPostRequestFormUnitLabelAnyOf2Xca6a9353) add("InlineV1ProductsPostRequestFormUnitLabelAnyOf2Xca6a9353: value does not match InlineV1ProductsPostRequestFormUnitLabelAnyOf2Xca6a9353")
    },
  )
}
