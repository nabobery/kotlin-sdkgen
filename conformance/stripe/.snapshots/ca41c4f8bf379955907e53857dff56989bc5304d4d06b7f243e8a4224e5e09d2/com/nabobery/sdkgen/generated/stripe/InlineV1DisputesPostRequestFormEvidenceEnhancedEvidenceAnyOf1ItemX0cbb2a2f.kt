...
public class InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1ItemX0cbb2a2f(
  ...
  public val customerAccountId:
      InlineV1DisputesPostRequestFormEvidenceCustomerAccountIdX5a373434? = null,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1ItemX0cbb2a2f = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1ItemX0cbb2a2f> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1ItemX0cbb2a2f {
      val jsonDecoder = decoder.requireJsonDecoder("InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1ItemX0cbb2a2f")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1ItemX0cbb2a2f must be a JSON object")
      val charge = json.decodeRequired<String>(rawObject, "charge")
      return InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1ItemX0cbb2a2f(
        charge = charge,
        customerAccountId = rawObject["customer_account_id"]?.let { json.decodeFromJsonElement<InlineV1DisputesPostRequestFormEvidenceCustomerAccountIdX5a373434>(it) },
        customerDeviceFingerprint = rawObject["customer_device_fingerprint"]?.let { json.decodeFromJsonElement<InlineV1DisputesPostRequestFormEvidenceCustomerDeviceFinger9c71X58ed18ee>(it) },
        customerDeviceId = rawObject["customer_device_id"]?.let { json.decodeFromJsonElement<InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceCustomerDeviceIdXcae44be8>(it) },
        customerEmailAddress = rawObject["customer_email_address"]?.let { json.decodeFromJsonElement<InlineV1DisputesPostRequestFormEvidenceCustomerEmailAddressXc51371f1>(it) },
        customerPurchaseIp = rawObject["customer_purchase_ip"]?.let { json.decodeFromJsonElement<InlineV1DisputesPostRequestFormEvidenceCustomerPurchaseIpXefa01566>(it) },
        productDescription = rawObject["product_description"]?.let { json.decodeFromJsonElement<InlineV1DisputesPostRequestFormEvidenceProductDescriptionXcd5f0772>(it) },
        shippingAddress = rawObject["shipping_address"]?.let { json.decodeFromJsonElement<InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceShippingAddressX7ccfc785>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1ItemX0cbb2a2f) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1ItemX0cbb2a2f")
...
public fun inlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1ItemX0cbb2a2f(block: InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1ItemX0cbb2a2f.Builder.() -> Unit): InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1ItemX0cbb2a2f = InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1ItemX0cbb2a2f.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceAnyOf1ItemX0cbb2a2f is missing required property '" + name + "'")
