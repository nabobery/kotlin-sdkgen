...
public class OutboundPaymentsPaymentMethodDetailsFinancialAccount(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): OutboundPaymentsPaymentMethodDetailsFinancialAccount = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<OutboundPaymentsPaymentMethodDetailsFinancialAccount> {
    ...
    override fun deserialize(decoder: Decoder): OutboundPaymentsPaymentMethodDetailsFinancialAccount {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("OutboundPaymentsPaymentMethodDetailsFinancialAccount must be a JSON object")
      val id = json.decodeRequired<String>(rawObject, "id")
      val network = json.decodeRequired<InlineOutboundPaymentsPaymentMethodDetailsFinancialAccountNetworkXbe57ed22>(rawObject, "network")
      return OutboundPaymentsPaymentMethodDetailsFinancialAccount(
        id = id,
        network = network,
      )
    ...
    override fun serialize(encoder: Encoder, `value`: OutboundPaymentsPaymentMethodDetailsFinancialAccount) {
...
public fun outboundPaymentsPaymentMethodDetailsFinancialAccount(block: OutboundPaymentsPaymentMethodDetailsFinancialAccount.Builder.() -> Unit): OutboundPaymentsPaymentMethodDetailsFinancialAccount = OutboundPaymentsPaymentMethodDetailsFinancialAccount.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("OutboundPaymentsPaymentMethodDetailsFinancialAccount is missing required property '" + name + "'")
