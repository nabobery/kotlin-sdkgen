...
public class BankConnectionsResourceBalanceApiResourceCashBalance(
  ...
  public class Builder {
    ...
    public fun build(): BankConnectionsResourceBalanceApiResourceCashBalance = BankConnectionsResourceBalanceApiResourceCashBalance(
      available = available,
    )
  }

  public companion object {
    public fun build(block: Builder.() -> Unit): BankConnectionsResourceBalanceApiResourceCashBalance = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<BankConnectionsResourceBalanceApiResourceCashBalance> {
    ...
    override fun deserialize(decoder: Decoder): BankConnectionsResourceBalanceApiResourceCashBalance {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("BankConnectionsResourceBalanceApiResourceCashBalance must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: BankConnectionsResourceBalanceApiResourceCashBalance) {
...
public fun bankConnectionsResourceBalanceApiResourceCashBalance(block: BankConnectionsResourceBalanceApiResourceCashBalance.Builder.() -> Unit): BankConnectionsResourceBalanceApiResourceCashBalance = BankConnectionsResourceBalanceApiResourceCashBalance.build(block)
