...
public class IssuingDisputeTreasury(
  ...
  internal object Serializer : KSerializer<IssuingDisputeTreasury> {
    ...
    override fun deserialize(decoder: Decoder): IssuingDisputeTreasury {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("IssuingDisputeTreasury must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: IssuingDisputeTreasury) {
...
public fun issuingDisputeTreasury(block: IssuingDisputeTreasury.Builder.() -> Unit): IssuingDisputeTreasury = IssuingDisputeTreasury.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("IssuingDisputeTreasury is missing required property '" + name + "'")
