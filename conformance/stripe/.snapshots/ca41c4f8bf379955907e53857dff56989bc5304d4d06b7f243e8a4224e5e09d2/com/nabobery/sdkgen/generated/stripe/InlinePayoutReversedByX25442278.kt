...
public class InlinePayoutReversedByX25442278 internal constructor(
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlinePayoutReversedByX25442278 {
      val inspection = inspectInlinePayoutReversedByX25442278(raw)
      if (inspection.matchCount == 0) {
        throw InlinePayoutReversedByX25442278NoMatchException("InlinePayoutReversedByX25442278 matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlinePayoutReversedByX25442278(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlinePayoutReversedByX25442278> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlinePayoutReversedByX25442278) {
