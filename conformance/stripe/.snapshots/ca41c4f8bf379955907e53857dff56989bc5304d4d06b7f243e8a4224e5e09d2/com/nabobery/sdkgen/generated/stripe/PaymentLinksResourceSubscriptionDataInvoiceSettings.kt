...
public class PaymentLinksResourceSubscriptionDataInvoiceSettings(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): PaymentLinksResourceSubscriptionDataInvoiceSettings = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<PaymentLinksResourceSubscriptionDataInvoiceSettings> {
    ...
    override fun deserialize(decoder: Decoder): PaymentLinksResourceSubscriptionDataInvoiceSettings {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("PaymentLinksResourceSubscriptionDataInvoiceSettings must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: PaymentLinksResourceSubscriptionDataInvoiceSettings) {
...
public fun paymentLinksResourceSubscriptionDataInvoiceSettings(block: PaymentLinksResourceSubscriptionDataInvoiceSettings.Builder.() -> Unit): PaymentLinksResourceSubscriptionDataInvoiceSettings = PaymentLinksResourceSubscriptionDataInvoiceSettings.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("PaymentLinksResourceSubscriptionDataInvoiceSettings is missing required property '" + name + "'")
