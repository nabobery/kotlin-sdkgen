...
public class TerminalReaderReaderResourceProcessConfig(
  ...
  public class Builder {
    ...
    public fun build(): TerminalReaderReaderResourceProcessConfig = TerminalReaderReaderResourceProcessConfig(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): TerminalReaderReaderResourceProcessConfig = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<TerminalReaderReaderResourceProcessConfig> {
    ...
    override fun deserialize(decoder: Decoder): TerminalReaderReaderResourceProcessConfig {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("TerminalReaderReaderResourceProcessConfig must be a JSON object")
      return TerminalReaderReaderResourceProcessConfig(
        ...
        tipping = rawObject["tipping"]?.let { json.decodeFromJsonElement<TerminalReaderReaderResourceTippingConfig>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: TerminalReaderReaderResourceProcessConfig) {
...
public fun terminalReaderReaderResourceProcessConfig(block: TerminalReaderReaderResourceProcessConfig.Builder.() -> Unit): TerminalReaderReaderResourceProcessConfig = TerminalReaderReaderResourceProcessConfig.build(block)
