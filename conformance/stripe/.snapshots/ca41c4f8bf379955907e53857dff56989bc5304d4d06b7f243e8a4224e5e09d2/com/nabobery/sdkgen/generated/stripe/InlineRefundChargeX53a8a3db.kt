...
public class InlineRefundChargeX53a8a3db internal constructor(
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineRefundChargeX53a8a3db {
      val inspection = inspectInlineRefundChargeX53a8a3db(raw)
      if (inspection.matchCount == 0) {
        throw InlineRefundChargeX53a8a3dbNoMatchException("InlineRefundChargeX53a8a3db matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineRefundChargeX53a8a3db(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineRefundChargeX53a8a3db> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineRefundChargeX53a8a3db) {
