 ...
 *
 *
 * Source: sdkgen://source/openapi.json#/components/schemas/payment_method_details_sepa_debit
 */
@Serializable(with = PaymentMethodDetailsSepaDebit.Serializer::class)
public class PaymentMethodDetailsSepaDebit(
  ...
  public class Builder {
    ...
    public fun build(): PaymentMethodDetailsSepaDebit = PaymentMethodDetailsSepaDebit(
      bankCode = bankCode,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): PaymentMethodDetailsSepaDebit = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<PaymentMethodDetailsSepaDebit> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): PaymentMethodDetailsSepaDebit {
      val jsonDecoder = decoder.requireJsonDecoder("PaymentMethodDetailsSepaDebit")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("PaymentMethodDetailsSepaDebit must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: PaymentMethodDetailsSepaDebit) {
      val jsonEncoder = encoder.requireJsonEncoder("PaymentMethodDetailsSepaDebit")
...
public fun paymentMethodDetailsSepaDebit(block: PaymentMethodDetailsSepaDebit.Builder.() -> Unit): PaymentMethodDetailsSepaDebit = PaymentMethodDetailsSepaDebit.build(block)
