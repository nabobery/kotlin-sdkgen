...
public class InlineV1SetupAttemptsGetParameterX58b2fbf8 internal constructor(
  ...
  public val inlineV1SetupAttemptsGetParameterAnyOf1Xa963d6de:
      ...
      lazy(LazyThreadSafetyMode.NONE) { if (inspection.matchesInlineV1SetupAttemptsGetParameterAnyOf1Xa963d6de) json.decodeFromJsonElement<InlineV1SetupAttemptsGetParameterAnyOf1Xa963d6de>(raw) else null }
  ...
  public val matchedBranches: Set<InlineV1SetupAttemptsGetParameterX58b2fbf8Branch>
    get() = buildSet {
      if (inspection.matchesInlineV1SetupAttemptsGetParameterAnyOf1Xa963d6de) add(InlineV1SetupAttemptsGetParameterX58b2fbf8Branch.InlineV1SetupAttemptsGetParameterAnyOf1Xa963d6de)
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineV1SetupAttemptsGetParameterX58b2fbf8 {
      val inspection = inspectInlineV1SetupAttemptsGetParameterX58b2fbf8(raw)
      if (inspection.matchCount == 0) {
        throw InlineV1SetupAttemptsGetParameterX58b2fbf8NoMatchException("InlineV1SetupAttemptsGetParameterX58b2fbf8 matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineV1SetupAttemptsGetParameterX58b2fbf8(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineV1SetupAttemptsGetParameterX58b2fbf8> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1SetupAttemptsGetParameterX58b2fbf8) {
      encoder.requireJsonEncoder("InlineV1SetupAttemptsGetParameterX58b2fbf8").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineV1SetupAttemptsGetParameterX58b2fbf8(element: JsonElement): InlineV1SetupAttemptsGetParameterX58b2fbf8Inspection {
  val matchesInlineV1SetupAttemptsGetParameterAnyOf1Xa963d6de = element.isJsonDecodable<InlineV1SetupAttemptsGetParameterAnyOf1Xa963d6de>()
  ...
  return InlineV1SetupAttemptsGetParameterX58b2fbf8Inspection(
    ...
    failures = buildList {
      if (!matchesInlineV1SetupAttemptsGetParameterAnyOf1Xa963d6de) add("InlineV1SetupAttemptsGetParameterAnyOf1Xa963d6de: value does not match InlineV1SetupAttemptsGetParameterAnyOf1Xa963d6de")
