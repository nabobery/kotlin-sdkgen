...
internal data class InlineV1AccountsPersonsPostRequestFormMetadataXbb7ab64eInspection(
  ...
  public val matchCount: Int
    get() = listOf(matchesBranch1, matchesInlineV1AccountsPersonsPostRequestFormMetadataAnyOf2X12741e64).count { it }
}
...
public class InlineV1AccountsPersonsPostRequestFormMetadataXbb7ab64e internal constructor(
  ...
  public val inlineV1AccountsPersonsPostRequestFormMetadataAnyOf2X12741e64:
      ...
      lazy(LazyThreadSafetyMode.NONE) { if (inspection.matchesInlineV1AccountsPersonsPostRequestFormMetadataAnyOf2X12741e64) json.decodeFromJsonElement<InlineV1AccountsPersonsPostRequestFormMetadataAnyOf2X12741e64>(raw) else null }

  public val matchedBranches: Set<InlineV1AccountsPersonsPostRequestFormMetadataXbb7ab64eBranch>
    get() = buildSet {
      if (inspection.matchesBranch1) add(InlineV1AccountsPersonsPostRequestFormMetadataXbb7ab64eBranch.Branch1)
      if (inspection.matchesInlineV1AccountsPersonsPostRequestFormMetadataAnyOf2X12741e64) add(InlineV1AccountsPersonsPostRequestFormMetadataXbb7ab64eBranch.InlineV1AccountsPersonsPostRequestFormMetadataAnyOf2X12741e64)
    }
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineV1AccountsPersonsPostRequestFormMetadataXbb7ab64e {
      val inspection = inspectInlineV1AccountsPersonsPostRequestFormMetadataXbb7ab64e(raw)
      if (inspection.matchCount == 0) {
        throw InlineV1AccountsPersonsPostRequestFormMetadataXbb7ab64eNoMatchException("InlineV1AccountsPersonsPostRequestFormMetadataXbb7ab64e matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineV1AccountsPersonsPostRequestFormMetadataXbb7ab64e(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineV1AccountsPersonsPostRequestFormMetadataXbb7ab64e> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1AccountsPersonsPostRequestFormMetadataXbb7ab64e) {
      encoder.requireJsonEncoder("InlineV1AccountsPersonsPostRequestFormMetadataXbb7ab64e").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineV1AccountsPersonsPostRequestFormMetadataXbb7ab64e(element: JsonElement): InlineV1AccountsPersonsPostRequestFormMetadataXbb7ab64eInspection {
  val matchesBranch1 = element.isJsonDecodable<JsonObject>()
  val matchesInlineV1AccountsPersonsPostRequestFormMetadataAnyOf2X12741e64 = element.isJsonDecodable<InlineV1AccountsPersonsPostRequestFormMetadataAnyOf2X12741e64>()
  return InlineV1AccountsPersonsPostRequestFormMetadataXbb7ab64eInspection(
    ...
    failures = buildList {
      ...
      if (!matchesInlineV1AccountsPersonsPostRequestFormMetadataAnyOf2X12741e64) add("InlineV1AccountsPersonsPostRequestFormMetadataAnyOf2X12741e64: value does not match InlineV1AccountsPersonsPostRequestFormMetadataAnyOf2X12741e64")
    },
  )
}
