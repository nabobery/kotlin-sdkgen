...
public class InlinePaymentPagesCheckoutSessionDiscountCouponX5818db5f internal constructor(
  ...
  public val matchedBranches: Set<InlinePaymentPagesCheckoutSessionDiscountCouponX5818db5fBranch>
    get() = buildSet {
      if (inspection.matchesBranch1) add(InlinePaymentPagesCheckoutSessionDiscountCouponX5818db5fBranch.Branch1)
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlinePaymentPagesCheckoutSessionDiscountCouponX5818db5f {
      val inspection = inspectInlinePaymentPagesCheckoutSessionDiscountCouponX5818db5f(raw)
      if (inspection.matchCount == 0) {
        throw InlinePaymentPagesCheckoutSessionDiscountCouponX5818db5fNoMatchException("InlinePaymentPagesCheckoutSessionDiscountCouponX5818db5f matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlinePaymentPagesCheckoutSessionDiscountCouponX5818db5f(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlinePaymentPagesCheckoutSessionDiscountCouponX5818db5f> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlinePaymentPagesCheckoutSessionDiscountCouponX5818db5f) {
      encoder.requireJsonEncoder("InlinePaymentPagesCheckoutSessionDiscountCouponX5818db5f").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlinePaymentPagesCheckoutSessionDiscountCouponX5818db5f(element: JsonElement): InlinePaymentPagesCheckoutSessionDiscountCouponX5818db5fInspection {
