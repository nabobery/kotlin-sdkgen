...
public class InlineV1IssuingCardholdersPostRequestFormBillingX75c3beb0(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1IssuingCardholdersPostRequestFormBillingX75c3beb0 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1IssuingCardholdersPostRequestFormBillingX75c3beb0> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1IssuingCardholdersPostRequestFormBillingX75c3beb0 {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1IssuingCardholdersPostRequestFormBillingX75c3beb0 must be a JSON object")
      val address = json.decodeRequired<InlineV1IssuingCardholdersPostRequestFormBillingAddressX0545dc9f>(rawObject, "address")
      return InlineV1IssuingCardholdersPostRequestFormBillingX75c3beb0(
        address = address,
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineV1IssuingCardholdersPostRequestFormBillingX75c3beb0) {
...
public fun inlineV1IssuingCardholdersPostRequestFormBillingX75c3beb0(block: InlineV1IssuingCardholdersPostRequestFormBillingX75c3beb0.Builder.() -> Unit): InlineV1IssuingCardholdersPostRequestFormBillingX75c3beb0 = InlineV1IssuingCardholdersPostRequestFormBillingX75c3beb0.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineV1IssuingCardholdersPostRequestFormBillingX75c3beb0 is missing required property '" + name + "'")
