...
public class GelatoSessionDocumentOptions(
  allowedTypes: List<InlineGelatoSessionDocumentOptionsAllowedTypesItemXcd341b94>? = null,
  /**
   ...
   */
  public val allowedTypes: List<InlineGelatoSessionDocumentOptionsAllowedTypesItemXcd341b94>? =
      allowedTypes?.let { collection0 -> collection0.toList() }

  public class Builder {
    private var allowedTypesValue:
        List<InlineGelatoSessionDocumentOptionsAllowedTypesItemXcd341b94>? = null
    ...
    public fun build(): GelatoSessionDocumentOptions = GelatoSessionDocumentOptions(
  ...
  internal object Serializer : KSerializer<GelatoSessionDocumentOptions> {
    ...
    override fun deserialize(decoder: Decoder): GelatoSessionDocumentOptions {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("GelatoSessionDocumentOptions must be a JSON object")
      return GelatoSessionDocumentOptions(
        allowedTypes = rawObject["allowed_types"]?.let { json.decodeFromJsonElement<List<InlineGelatoSessionDocumentOptionsAllowedTypesItemXcd341b94>>(it) },
    ...
    override fun serialize(encoder: Encoder, `value`: GelatoSessionDocumentOptions) {
...
public fun gelatoSessionDocumentOptions(block: GelatoSessionDocumentOptions.Builder.() -> Unit): GelatoSessionDocumentOptions = GelatoSessionDocumentOptions.build(block)
