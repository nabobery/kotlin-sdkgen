...
public class KlarnaAddress(
  ...
  public class Builder {
    ...
    public fun build(): KlarnaAddress = KlarnaAddress(
      country = country,
    )
  }
  ...
  internal object Serializer : KSerializer<KlarnaAddress> {
    ...
    override fun deserialize(decoder: Decoder): KlarnaAddress {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("KlarnaAddress must be a JSON object")
      return KlarnaAddress(
        country = rawObject["country"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<String?>(element) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: KlarnaAddress) {
