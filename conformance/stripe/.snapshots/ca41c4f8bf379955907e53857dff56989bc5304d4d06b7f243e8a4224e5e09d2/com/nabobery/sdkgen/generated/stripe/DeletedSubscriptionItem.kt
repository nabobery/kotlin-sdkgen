...
public class DeletedSubscriptionItem(
  ...
  internal object Serializer : KSerializer<DeletedSubscriptionItem> {
    ...
    override fun deserialize(decoder: Decoder): DeletedSubscriptionItem {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("DeletedSubscriptionItem must be a JSON object")
      val deleted = json.decodeRequired<Boolean>(rawObject, "deleted")
      val id = json.decodeRequired<String>(rawObject, "id")
      val objectValue = json.decodeRequired<InlineDeletedSubscriptionItemObjectValueXb0f4784b>(rawObject, "object")
      return DeletedSubscriptionItem(
        deleted = deleted,
        id = id,
        objectValue = objectValue,
    ...
    override fun serialize(encoder: Encoder, `value`: DeletedSubscriptionItem) {
...
public fun deletedSubscriptionItem(block: DeletedSubscriptionItem.Builder.() -> Unit): DeletedSubscriptionItem = DeletedSubscriptionItem.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("DeletedSubscriptionItem is missing required property '" + name + "'")
