...
public class InlineInvoicesResourcePretaxCreditAmountDiscountX4b97c12c internal constructor(
  ...
  public val matchedBranches: Set<InlineInvoicesResourcePretaxCreditAmountDiscountX4b97c12cBranch>
    get() = buildSet {
      if (inspection.matchesBranch1) add(InlineInvoicesResourcePretaxCreditAmountDiscountX4b97c12cBranch.Branch1)
      if (inspection.matchesDiscount) add(InlineInvoicesResourcePretaxCreditAmountDiscountX4b97c12cBranch.Discount)
      if (inspection.matchesDeletedDiscount) add(InlineInvoicesResourcePretaxCreditAmountDiscountX4b97c12cBranch.DeletedDiscount)
    }
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineInvoicesResourcePretaxCreditAmountDiscountX4b97c12c {
      val inspection = inspectInlineInvoicesResourcePretaxCreditAmountDiscountX4b97c12c(raw)
      if (inspection.matchCount == 0) {
        throw InlineInvoicesResourcePretaxCreditAmountDiscountX4b97c12cNoMatchException("InlineInvoicesResourcePretaxCreditAmountDiscountX4b97c12c matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineInvoicesResourcePretaxCreditAmountDiscountX4b97c12c(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineInvoicesResourcePretaxCreditAmountDiscountX4b97c12c> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineInvoicesResourcePretaxCreditAmountDiscountX4b97c12c) {
      encoder.requireJsonEncoder("InlineInvoicesResourcePretaxCreditAmountDiscountX4b97c12c").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineInvoicesResourcePretaxCreditAmountDiscountX4b97c12c(element: JsonElement): InlineInvoicesResourcePretaxCreditAmountDiscountX4b97c12cInspection {
