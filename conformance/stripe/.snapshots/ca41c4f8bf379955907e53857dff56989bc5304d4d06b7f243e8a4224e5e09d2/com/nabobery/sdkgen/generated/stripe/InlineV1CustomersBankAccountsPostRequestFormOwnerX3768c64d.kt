...
public class InlineV1CustomersBankAccountsPostRequestFormOwnerX3768c64d(
  ...
  public class Builder {
    ...
    public fun build(): InlineV1CustomersBankAccountsPostRequestFormOwnerX3768c64d = InlineV1CustomersBankAccountsPostRequestFormOwnerX3768c64d(
      address = address,
      email = email,
      name = name,
      phone = phone,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1CustomersBankAccountsPostRequestFormOwnerX3768c64d = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1CustomersBankAccountsPostRequestFormOwnerX3768c64d> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1CustomersBankAccountsPostRequestFormOwnerX3768c64d {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1CustomersBankAccountsPostRequestFormOwnerX3768c64d must be a JSON object")
      return InlineV1CustomersBankAccountsPostRequestFormOwnerX3768c64d(
        address = rawObject["address"]?.let { json.decodeFromJsonElement<InlineV1CustomersBankAccountsPostRequestFormOwnerAddressXabd159b3>(it) },
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1CustomersBankAccountsPostRequestFormOwnerX3768c64d) {
...
public fun inlineV1CustomersBankAccountsPostRequestFormOwnerX3768c64d(block: InlineV1CustomersBankAccountsPostRequestFormOwnerX3768c64d.Builder.() -> Unit): InlineV1CustomersBankAccountsPostRequestFormOwnerX3768c64d = InlineV1CustomersBankAccountsPostRequestFormOwnerX3768c64d.build(block)
