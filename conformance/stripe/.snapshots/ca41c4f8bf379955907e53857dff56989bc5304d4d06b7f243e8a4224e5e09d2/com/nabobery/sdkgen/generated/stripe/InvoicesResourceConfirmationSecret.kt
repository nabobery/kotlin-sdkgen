...
public class InvoicesResourceConfirmationSecret(
  ...
  internal object Serializer : KSerializer<InvoicesResourceConfirmationSecret> {
    ...
    override fun deserialize(decoder: Decoder): InvoicesResourceConfirmationSecret {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InvoicesResourceConfirmationSecret must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InvoicesResourceConfirmationSecret) {
...
public fun invoicesResourceConfirmationSecret(block: InvoicesResourceConfirmationSecret.Builder.() -> Unit): InvoicesResourceConfirmationSecret = InvoicesResourceConfirmationSecret.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InvoicesResourceConfirmationSecret is missing required property '" + name + "'")
