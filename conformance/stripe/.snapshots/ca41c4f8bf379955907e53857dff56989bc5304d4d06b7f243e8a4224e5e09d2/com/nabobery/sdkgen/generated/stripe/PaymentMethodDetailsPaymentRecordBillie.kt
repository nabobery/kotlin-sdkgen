...
public class PaymentMethodDetailsPaymentRecordBillie(
  ...
  public class Builder {
    ...
    public fun build(): PaymentMethodDetailsPaymentRecordBillie = PaymentMethodDetailsPaymentRecordBillie(
      transactionId = transactionId,
    )
  }

  public companion object {
    public fun build(block: Builder.() -> Unit): PaymentMethodDetailsPaymentRecordBillie = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<PaymentMethodDetailsPaymentRecordBillie> {
    ...
    override fun deserialize(decoder: Decoder): PaymentMethodDetailsPaymentRecordBillie {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("PaymentMethodDetailsPaymentRecordBillie must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: PaymentMethodDetailsPaymentRecordBillie) {
...
public fun paymentMethodDetailsPaymentRecordBillie(block: PaymentMethodDetailsPaymentRecordBillie.Builder.() -> Unit): PaymentMethodDetailsPaymentRecordBillie = PaymentMethodDetailsPaymentRecordBillie.build(block)
