...
public class InlineTreasuryOutboundTransferTransactionXb03a16d6 internal constructor(
  ...
  public val matchedBranches: Set<InlineTreasuryOutboundTransferTransactionXb03a16d6Branch>
    get() = buildSet {
      ...
      if (inspection.matchesTreasuryTransaction) add(InlineTreasuryOutboundTransferTransactionXb03a16d6Branch.TreasuryTransaction)
    }
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineTreasuryOutboundTransferTransactionXb03a16d6 {
      val inspection = inspectInlineTreasuryOutboundTransferTransactionXb03a16d6(raw)
      if (inspection.matchCount == 0) {
        throw InlineTreasuryOutboundTransferTransactionXb03a16d6NoMatchException("InlineTreasuryOutboundTransferTransactionXb03a16d6 matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineTreasuryOutboundTransferTransactionXb03a16d6(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineTreasuryOutboundTransferTransactionXb03a16d6> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineTreasuryOutboundTransferTransactionXb03a16d6) {
      encoder.requireJsonEncoder("InlineTreasuryOutboundTransferTransactionXb03a16d6").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineTreasuryOutboundTransferTransactionXb03a16d6(element: JsonElement): InlineTreasuryOutboundTransferTransactionXb03a16d6Inspection {
