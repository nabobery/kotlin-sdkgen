...
public class InlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsXb5a49a7a(
  ...
  public class Builder {
    ...
    public fun build(): InlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsXb5a49a7a = InlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsXb5a49a7a(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsXb5a49a7a = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsXb5a49a7a> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsXb5a49a7a {
      val jsonDecoder = decoder.requireJsonDecoder("InlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsXb5a49a7a")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsXb5a49a7a must be a JSON object")
      return InlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsXb5a49a7a(
        ...
        automaticTax = rawObject["automatic_tax"]?.let { json.decodeFromJsonElement<InlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsAutomaticTaxX38b7e294>(it) },
        billingCycleAnchor = rawObject["billing_cycle_anchor"]?.let { json.decodeFromJsonElement<InlineV1SubscriptionSchedulesPostRequestFormBillingCycleAnchorXb60f37c4>(it) },
        billingThresholds = rawObject["billing_thresholds"]?.let { json.decodeFromJsonElement<InlineV1SubscriptionSchedulesPostRequestFormBillingThresholdsX635c8c79>(it) },
        collectionMethod = rawObject["collection_method"]?.let { json.decodeFromJsonElement<InlineV1SubscriptionSchedulesPostRequestFormCollectionMethodX28d2c555>(it) },
        defaultPaymentMethod = rawObject["default_payment_method"]?.let { json.decodeFromJsonElement<String>(it) },
        description = rawObject["description"]?.let { json.decodeFromJsonElement<InlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsDescriptionXa66f448e>(it) },
        invoiceSettings = rawObject["invoice_settings"]?.let { json.decodeFromJsonElement<InlineV1SubscriptionSchedulesPostRequestFormInvoiceSettingsX739376be>(it) },
        onBehalfOf = rawObject["on_behalf_of"]?.let { json.decodeFromJsonElement<InlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsOnBehalfOfXd32d87d2>(it) },
        transferData = rawObject["transfer_data"]?.let { json.decodeFromJsonElement<InlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsTransferDataXa2c333e9>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsXb5a49a7a) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsXb5a49a7a")
...
public fun inlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsXb5a49a7a(block: InlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsXb5a49a7a.Builder.() -> Unit): InlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsXb5a49a7a = InlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsXb5a49a7a.build(block)
