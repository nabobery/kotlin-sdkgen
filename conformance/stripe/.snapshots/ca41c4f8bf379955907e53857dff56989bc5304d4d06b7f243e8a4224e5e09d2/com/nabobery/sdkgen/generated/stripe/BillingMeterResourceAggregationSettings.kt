...
public class BillingMeterResourceAggregationSettings(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): BillingMeterResourceAggregationSettings = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<BillingMeterResourceAggregationSettings> {
    ...
    override fun deserialize(decoder: Decoder): BillingMeterResourceAggregationSettings {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("BillingMeterResourceAggregationSettings must be a JSON object")
      val formula = json.decodeRequired<InlineBillingMeterResourceAggregationSettingsFormulaX28d0a7c6>(rawObject, "formula")
      return BillingMeterResourceAggregationSettings(
        formula = formula,
      )
    }

    override fun serialize(encoder: Encoder, `value`: BillingMeterResourceAggregationSettings) {
...
public fun billingMeterResourceAggregationSettings(block: BillingMeterResourceAggregationSettings.Builder.() -> Unit): BillingMeterResourceAggregationSettings = BillingMeterResourceAggregationSettings.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("BillingMeterResourceAggregationSettings is missing required property '" + name + "'")
