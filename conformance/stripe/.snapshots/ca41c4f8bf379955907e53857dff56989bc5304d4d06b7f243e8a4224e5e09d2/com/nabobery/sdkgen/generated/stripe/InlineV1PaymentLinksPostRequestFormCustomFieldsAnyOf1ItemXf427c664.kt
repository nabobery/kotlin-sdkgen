...
public class InlineV1PaymentLinksPostRequestFormCustomFieldsAnyOf1ItemXf427c664(
  ...
  public val dropdown:
      InlineV1PaymentLinksPostRequestFormCustomFieldsAnyOf1ItemDropdownXd3bed56e? = null,
  public val numeric:
      InlineV1PaymentLinksPostRequestFormCustomFieldsAnyOf1ItemNumericXaa29a00a? = null,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1PaymentLinksPostRequestFormCustomFieldsAnyOf1ItemXf427c664 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1PaymentLinksPostRequestFormCustomFieldsAnyOf1ItemXf427c664> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1PaymentLinksPostRequestFormCustomFieldsAnyOf1ItemXf427c664 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineV1PaymentLinksPostRequestFormCustomFieldsAnyOf1ItemXf427c664")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1PaymentLinksPostRequestFormCustomFieldsAnyOf1ItemXf427c664 must be a JSON object")
      val key = json.decodeRequired<String>(rawObject, "key")
      val label = json.decodeRequired<InlineV1PaymentLinksPostRequestFormCustomFieldsAnyOf1ItemLabelX4d4c6ea8>(rawObject, "label")
      val type = json.decodeRequired<InlineV1PaymentLinksPostRequestFormCustomFieldsAnyOf1ItemTypeX88cf311d>(rawObject, "type")
      return InlineV1PaymentLinksPostRequestFormCustomFieldsAnyOf1ItemXf427c664(
        key = key,
        label = label,
        type = type,
        dropdown = rawObject["dropdown"]?.let { json.decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormCustomFieldsAnyOf1ItemDropdownXd3bed56e>(it) },
        numeric = rawObject["numeric"]?.let { json.decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormCustomFieldsAnyOf1ItemNumericXaa29a00a>(it) },
        optional = rawObject["optional"]?.let { json.decodeFromJsonElement<Boolean>(it) },
        text = rawObject["text"]?.let { json.decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormCustomFieldsAnyOf1ItemTextX3ea804ae>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineV1PaymentLinksPostRequestFormCustomFieldsAnyOf1ItemXf427c664) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineV1PaymentLinksPostRequestFormCustomFieldsAnyOf1ItemXf427c664")
...
public fun inlineV1PaymentLinksPostRequestFormCustomFieldsAnyOf1ItemXf427c664(block: InlineV1PaymentLinksPostRequestFormCustomFieldsAnyOf1ItemXf427c664.Builder.() -> Unit): InlineV1PaymentLinksPostRequestFormCustomFieldsAnyOf1ItemXf427c664 = InlineV1PaymentLinksPostRequestFormCustomFieldsAnyOf1ItemXf427c664.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineV1PaymentLinksPostRequestFormCustomFieldsAnyOf1ItemXf427c664 is missing required property '" + name + "'")
