...
public class InlineSepaDebitGeneratedFromChargeX65c261e2 internal constructor(
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineSepaDebitGeneratedFromChargeX65c261e2 {
      val inspection = inspectInlineSepaDebitGeneratedFromChargeX65c261e2(raw)
      if (inspection.matchCount == 0) {
        throw InlineSepaDebitGeneratedFromChargeX65c261e2NoMatchException("InlineSepaDebitGeneratedFromChargeX65c261e2 matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineSepaDebitGeneratedFromChargeX65c261e2(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineSepaDebitGeneratedFromChargeX65c261e2> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineSepaDebitGeneratedFromChargeX65c261e2) {
      encoder.requireJsonEncoder("InlineSepaDebitGeneratedFromChargeX65c261e2").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineSepaDebitGeneratedFromChargeX65c261e2(element: JsonElement): InlineSepaDebitGeneratedFromChargeX65c261e2Inspection {
