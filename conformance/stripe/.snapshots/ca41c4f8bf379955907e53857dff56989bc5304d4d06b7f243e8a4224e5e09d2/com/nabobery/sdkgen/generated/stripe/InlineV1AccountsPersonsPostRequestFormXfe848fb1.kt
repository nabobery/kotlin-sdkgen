 ...
 * rm-urlencoded/schema
 */
@Serializable(with = InlineV1AccountsPersonsPostRequestFormXfe848fb1.Serializer::class)
public class InlineV1AccountsPersonsPostRequestFormXfe848fb1(
  /**
   * Details on the legal guardian's or authorizer's acceptance of the required Stripe agreements.
   */
  public val additionalTosAcceptances:
      InlineV1AccountsPersonsPostRequestFormAdditionalTosAcceptancesX427f04c2? = null,
  /**
   * The person's address.
   */
  public val address: InlineV1AccountsPersonsPostRequestFormAddressX3db668c8? = null,
  /**
   * The Kana variation of the person's address (Japan only).
   */
  public val addressKana: InlineV1AccountsPersonsPostRequestFormAddressKanaX84ad682d? = null,
  /**
   * The Kanji variation of the person's address (Japan only).
   */
  public val addressKanji: InlineV1AccountsPersonsPostRequestFormAddressKanjiXb98cd8eb? = null,
  /**
   * The person's date of birth.
   */
  public val dob: InlineV1AccountsPersonsPostRequestFormDobX10952955? = null,
  /**
   * Documents that may be submitted to satisfy various informational requests.
   */
  public val documents: InlineV1AccountsPersonsPostRequestFormDocumentsX9f95ff75? = null,
  /**
  ...
  public val fullNameAliases:
      InlineV1AccountsPersonsPostRequestFormFullNameAliasesX494b2d74? = null,
  /**
   ...
   */
  public val metadata: InlineV1AccountsPersonsPostRequestFormMetadataX57922428? = null,
  /**
  ...
  public val politicalExposure:
      InlineV1AccountsPersonsPostRequestFormPoliticalExposureX34d723ec? = null,
  /**
   * The person's registered address.
   */
  public val registeredAddress:
      InlineV1AccountsPersonsPostRequestFormRegisteredAddressXd6cd9f2f? = null,
  /**
   * The relationship that this person has with the account's legal entity.
   */
  public val relationship: InlineV1AccountsPersonsPostRequestFormRelationshipX267bfb47? = null,
  /**
   ...
   */
  public val usCfpbData: InlineV1AccountsPersonsPostRequestFormUsCfpbDataXd05aa934? = null,
  /**
   * The person's verification status.
   */
  public val verification: InlineV1AccountsPersonsPostRequestFormVerificationX30edb1f7? = null,
) {
  /**
  ...
  public class Builder {
     ...
     * The person's address.
     */
    public var address: InlineV1AccountsPersonsPostRequestFormAddressX3db668c8? = null

    /**
     * The Kana variation of the person's address (Japan only).
     */
    public var addressKana: InlineV1AccountsPersonsPostRequestFormAddressKanaX84ad682d? = null

    /**
     * The Kanji variation of the person's address (Japan only).
     */
    public var addressKanji: InlineV1AccountsPersonsPostRequestFormAddressKanjiXb98cd8eb? = null

    /**
     * The person's date of birth.
     */
    public var dob: InlineV1AccountsPersonsPostRequestFormDobX10952955? = null

    /**
     * Documents that may be submitted to satisfy various informational requests.
     */
    public var documents: InlineV1AccountsPersonsPostRequestFormDocumentsX9f95ff75? = null
     ...
     * A list of alternate names or aliases that the person is known by.
     */
    public var fullNameAliases: InlineV1AccountsPersonsPostRequestFormFullNameAliasesX494b2d74? =
        null
     ...
     */
    public var metadata: InlineV1AccountsPersonsPostRequestFormMetadataX57922428? = null
     ...
     */
    public var politicalExposure: InlineV1AccountsPersonsPostRequestFormPoliticalExposureX34d723ec?
        = null

    /**
     * The person's registered address.
     */
    public var registeredAddress: InlineV1AccountsPersonsPostRequestFormRegisteredAddressXd6cd9f2f?
        = null

    /**
     * The relationship that this person has with the account's legal entity.
     */
    public var relationship: InlineV1AccountsPersonsPostRequestFormRelationshipX267bfb47? = null
     ...
     * Demographic data related to the person.
     */
    public var usCfpbData: InlineV1AccountsPersonsPostRequestFormUsCfpbDataXd05aa934? = null

    /**
     * The person's verification status.
     */
    public var verification: InlineV1AccountsPersonsPostRequestFormVerificationX30edb1f7? = null

    public fun build(): InlineV1AccountsPersonsPostRequestFormXfe848fb1 = InlineV1AccountsPersonsPostRequestFormXfe848fb1(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1AccountsPersonsPostRequestFormXfe848fb1 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1AccountsPersonsPostRequestFormXfe848fb1> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineV1AccountsPersonsPostRequestFormXfe848fb1 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineV1AccountsPersonsPostRequestFormXfe848fb1")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1AccountsPersonsPostRequestFormXfe848fb1 must be a JSON object")
      return InlineV1AccountsPersonsPostRequestFormXfe848fb1(
        additionalTosAcceptances = rawObject["additional_tos_acceptances"]?.let { json.decodeFromJsonElement<InlineV1AccountsPersonsPostRequestFormAdditionalTosAcceptancesX427f04c2>(it) },
        address = rawObject["address"]?.let { json.decodeFromJsonElement<InlineV1AccountsPersonsPostRequestFormAddressX3db668c8>(it) },
        addressKana = rawObject["address_kana"]?.let { json.decodeFromJsonElement<InlineV1AccountsPersonsPostRequestFormAddressKanaX84ad682d>(it) },
        addressKanji = rawObject["address_kanji"]?.let { json.decodeFromJsonElement<InlineV1AccountsPersonsPostRequestFormAddressKanjiXb98cd8eb>(it) },
        dob = rawObject["dob"]?.let { json.decodeFromJsonElement<InlineV1AccountsPersonsPostRequestFormDobX10952955>(it) },
        documents = rawObject["documents"]?.let { json.decodeFromJsonElement<InlineV1AccountsPersonsPostRequestFormDocumentsX9f95ff75>(it) },
        ...
        fullNameAliases = rawObject["full_name_aliases"]?.let { json.decodeFromJsonElement<InlineV1AccountsPersonsPostRequestFormFullNameAliasesX494b2d74>(it) },
        ...
        metadata = rawObject["metadata"]?.let { json.decodeFromJsonElement<InlineV1AccountsPersonsPostRequestFormMetadataX57922428>(it) },
        ...
        politicalExposure = rawObject["political_exposure"]?.let { json.decodeFromJsonElement<InlineV1AccountsPersonsPostRequestFormPoliticalExposureX34d723ec>(it) },
        registeredAddress = rawObject["registered_address"]?.let { json.decodeFromJsonElement<InlineV1AccountsPersonsPostRequestFormRegisteredAddressXd6cd9f2f>(it) },
        relationship = rawObject["relationship"]?.let { json.decodeFromJsonElement<InlineV1AccountsPersonsPostRequestFormRelationshipX267bfb47>(it) },
        ssnLast4 = rawObject["ssn_last_4"]?.let { json.decodeFromJsonElement<String>(it) },
        usCfpbData = rawObject["us_cfpb_data"]?.let { json.decodeFromJsonElement<InlineV1AccountsPersonsPostRequestFormUsCfpbDataXd05aa934>(it) },
        verification = rawObject["verification"]?.let { json.decodeFromJsonElement<InlineV1AccountsPersonsPostRequestFormVerificationX30edb1f7>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineV1AccountsPersonsPostRequestFormXfe848fb1) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineV1AccountsPersonsPostRequestFormXfe848fb1")
...
public fun inlineV1AccountsPersonsPostRequestFormXfe848fb1(block: InlineV1AccountsPersonsPostRequestFormXfe848fb1.Builder.() -> Unit): InlineV1AccountsPersonsPostRequestFormXfe848fb1 = InlineV1AccountsPersonsPostRequestFormXfe848fb1.build(block)
