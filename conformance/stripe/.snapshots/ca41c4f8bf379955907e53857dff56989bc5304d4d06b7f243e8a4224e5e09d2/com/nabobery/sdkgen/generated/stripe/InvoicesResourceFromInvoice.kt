...
public class InvoicesResourceFromInvoice(
  ...
  internal object Serializer : KSerializer<InvoicesResourceFromInvoice> {
    ...
    override fun deserialize(decoder: Decoder): InvoicesResourceFromInvoice {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InvoicesResourceFromInvoice must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InvoicesResourceFromInvoice) {
...
public fun invoicesResourceFromInvoice(block: InvoicesResourceFromInvoice.Builder.() -> Unit): InvoicesResourceFromInvoice = InvoicesResourceFromInvoice.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InvoicesResourceFromInvoice is missing required property '" + name + "'")
