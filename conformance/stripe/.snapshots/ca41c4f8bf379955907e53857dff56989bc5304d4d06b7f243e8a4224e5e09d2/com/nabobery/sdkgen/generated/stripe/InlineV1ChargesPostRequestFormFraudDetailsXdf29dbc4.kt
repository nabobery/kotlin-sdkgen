...
public class InlineV1ChargesPostRequestFormFraudDetailsXdf29dbc4(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1ChargesPostRequestFormFraudDetailsXdf29dbc4 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1ChargesPostRequestFormFraudDetailsXdf29dbc4> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1ChargesPostRequestFormFraudDetailsXdf29dbc4 {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1ChargesPostRequestFormFraudDetailsXdf29dbc4 must be a JSON object")
      val userReport = json.decodeRequired<InlineV1ChargesPostRequestFormFraudDetailsUserReportX9d4f72cd>(rawObject, "user_report")
      return InlineV1ChargesPostRequestFormFraudDetailsXdf29dbc4(
        userReport = userReport,
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineV1ChargesPostRequestFormFraudDetailsXdf29dbc4) {
...
public fun inlineV1ChargesPostRequestFormFraudDetailsXdf29dbc4(block: InlineV1ChargesPostRequestFormFraudDetailsXdf29dbc4.Builder.() -> Unit): InlineV1ChargesPostRequestFormFraudDetailsXdf29dbc4 = InlineV1ChargesPostRequestFormFraudDetailsXdf29dbc4.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineV1ChargesPostRequestFormFraudDetailsXdf29dbc4 is missing required property '" + name + "'")
