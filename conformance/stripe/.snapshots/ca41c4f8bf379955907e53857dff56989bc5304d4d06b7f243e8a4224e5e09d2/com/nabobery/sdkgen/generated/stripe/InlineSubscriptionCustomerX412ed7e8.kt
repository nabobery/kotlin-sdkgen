...
public class InlineSubscriptionCustomerX412ed7e8 internal constructor(
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineSubscriptionCustomerX412ed7e8 {
      val inspection = inspectInlineSubscriptionCustomerX412ed7e8(raw)
      if (inspection.matchCount == 0) {
        throw InlineSubscriptionCustomerX412ed7e8NoMatchException("InlineSubscriptionCustomerX412ed7e8 matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineSubscriptionCustomerX412ed7e8(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineSubscriptionCustomerX412ed7e8> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineSubscriptionCustomerX412ed7e8) {
      encoder.requireJsonEncoder("InlineSubscriptionCustomerX412ed7e8").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineSubscriptionCustomerX412ed7e8(element: JsonElement): InlineSubscriptionCustomerX412ed7e8Inspection {
