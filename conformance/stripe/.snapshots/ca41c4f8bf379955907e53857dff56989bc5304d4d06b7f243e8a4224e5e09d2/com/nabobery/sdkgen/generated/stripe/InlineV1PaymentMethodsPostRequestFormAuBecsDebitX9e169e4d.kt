...
public class InlineV1PaymentMethodsPostRequestFormAuBecsDebitX9e169e4d(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1PaymentMethodsPostRequestFormAuBecsDebitX9e169e4d = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1PaymentMethodsPostRequestFormAuBecsDebitX9e169e4d> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1PaymentMethodsPostRequestFormAuBecsDebitX9e169e4d {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1PaymentMethodsPostRequestFormAuBecsDebitX9e169e4d must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1PaymentMethodsPostRequestFormAuBecsDebitX9e169e4d) {
...
public fun inlineV1PaymentMethodsPostRequestFormAuBecsDebitX9e169e4d(block: InlineV1PaymentMethodsPostRequestFormAuBecsDebitX9e169e4d.Builder.() -> Unit): InlineV1PaymentMethodsPostRequestFormAuBecsDebitX9e169e4d = InlineV1PaymentMethodsPostRequestFormAuBecsDebitX9e169e4d.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineV1PaymentMethodsPostRequestFormAuBecsDebitX9e169e4d is missing required property '" + name + "'")
