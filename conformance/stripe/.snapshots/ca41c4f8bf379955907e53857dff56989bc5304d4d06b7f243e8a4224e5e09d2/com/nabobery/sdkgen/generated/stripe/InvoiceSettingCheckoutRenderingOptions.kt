...
public class InvoiceSettingCheckoutRenderingOptions(
  ...
  public class Builder {
    ...
    public fun build(): InvoiceSettingCheckoutRenderingOptions = InvoiceSettingCheckoutRenderingOptions(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InvoiceSettingCheckoutRenderingOptions = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InvoiceSettingCheckoutRenderingOptions> {
    ...
    override fun deserialize(decoder: Decoder): InvoiceSettingCheckoutRenderingOptions {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InvoiceSettingCheckoutRenderingOptions must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InvoiceSettingCheckoutRenderingOptions) {
...
public fun invoiceSettingCheckoutRenderingOptions(block: InvoiceSettingCheckoutRenderingOptions.Builder.() -> Unit): InvoiceSettingCheckoutRenderingOptions = InvoiceSettingCheckoutRenderingOptions.build(block)
