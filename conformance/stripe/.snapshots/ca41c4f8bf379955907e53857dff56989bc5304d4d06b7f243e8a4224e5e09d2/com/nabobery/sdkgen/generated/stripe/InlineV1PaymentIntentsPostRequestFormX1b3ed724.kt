...
public class InlineV1PaymentIntentsPostRequestFormX1b3ed724(
  ...
  public val paymentMethodData:
      InlineV1PaymentIntentsPostRequestFormPaymentMethodDataX1234bded? = null,
  /**
  ...
  public val setupFutureUsage:
      InlineV1PaymentIntentsPostRequestFormSetupFutureUsageXc1a060ec? = null,
  /**
  ...
  public class Builder {
    ...
    public fun build(): InlineV1PaymentIntentsPostRequestFormX1b3ed724 = InlineV1PaymentIntentsPostRequestFormX1b3ed724(
      amount = amount,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1PaymentIntentsPostRequestFormX1b3ed724 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormX1b3ed724> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1PaymentIntentsPostRequestFormX1b3ed724 {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1PaymentIntentsPostRequestFormX1b3ed724 must be a JSON object")
      return InlineV1PaymentIntentsPostRequestFormX1b3ed724(
        amount = rawObject["amount"]?.let { json.decodeFromJsonElement<Int>(it) },
        amountDetails = rawObject["amount_details"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormAmountDetailsX93d20156>(it) },
        applicationFeeAmount = rawObject["application_fee_amount"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormApplicationFeeAmountX29b5acea>(it) },
        captureMethod = rawObject["capture_method"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormCaptureMethodXcc0e3e94>(it) },
        ...
        excludedPaymentMethodTypes = rawObject["excluded_payment_method_types"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormExcludedPaymentMethodTypesX74fbaaa9>(it) },
        expand = rawObject["expand"]?.let { json.decodeFromJsonElement<List<String>>(it) },
        hooks = rawObject["hooks"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormHooksX33240745>(it) },
        metadata = rawObject["metadata"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormMetadataXa66ba526>(it) },
        paymentDetails = rawObject["payment_details"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentDetailsX5d054eea>(it) },
        ...
        paymentMethodData = rawObject["payment_method_data"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodDataX1234bded>(it) },
        paymentMethodOptions = rawObject["payment_method_options"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsX1e08fc5e>(it) },
        paymentMethodTypes = rawObject["payment_method_types"]?.let { json.decodeFromJsonElement<List<String>>(it) },
        receiptEmail = rawObject["receipt_email"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormReceiptEmailXc593d772>(it) },
        setupFutureUsage = rawObject["setup_future_usage"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormSetupFutureUsageXc1a060ec>(it) },
        shipping = rawObject["shipping"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormShippingX781149ab>(it) },
        ...
        transferData = rawObject["transfer_data"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormTransferDataX43a27ce8>(it) },
        transferGroup = rawObject["transfer_group"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineV1PaymentIntentsPostRequestFormX1b3ed724) {
...
public fun inlineV1PaymentIntentsPostRequestFormX1b3ed724(block: InlineV1PaymentIntentsPostRequestFormX1b3ed724.Builder.() -> Unit): InlineV1PaymentIntentsPostRequestFormX1b3ed724 = InlineV1PaymentIntentsPostRequestFormX1b3ed724.build(block)
