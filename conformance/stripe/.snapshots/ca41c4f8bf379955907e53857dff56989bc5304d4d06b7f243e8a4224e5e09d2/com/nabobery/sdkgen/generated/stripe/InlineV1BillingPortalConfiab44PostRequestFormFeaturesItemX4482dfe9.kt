...
public class InlineV1BillingPortalConfiab44PostRequestFormFeaturesItemX4482dfe9(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1BillingPortalConfiab44PostRequestFormFeaturesItemX4482dfe9 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1BillingPortalConfiab44PostRequestFormFeaturesItemX4482dfe9> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1BillingPortalConfiab44PostRequestFormFeaturesItemX4482dfe9 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineV1BillingPortalConfiab44PostRequestFormFeaturesItemX4482dfe9")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1BillingPortalConfiab44PostRequestFormFeaturesItemX4482dfe9 must be a JSON object")
      val prices = json.decodeRequired<List<String>>(rawObject, "prices")
      val product = json.decodeRequired<String>(rawObject, "product")
      return InlineV1BillingPortalConfiab44PostRequestFormFeaturesItemX4482dfe9(
        prices = prices,
        product = product,
        adjustableQuantity = rawObject["adjustable_quantity"]?.let { json.decodeFromJsonElement<InlineV1BillingPortalConfiab44PostRequestFormFeaturesAdjustableQuantityXeaa36e7e>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineV1BillingPortalConfiab44PostRequestFormFeaturesItemX4482dfe9) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineV1BillingPortalConfiab44PostRequestFormFeaturesItemX4482dfe9")
...
public fun inlineV1BillingPortalConfiab44PostRequestFormFeaturesItemX4482dfe9(block: InlineV1BillingPortalConfiab44PostRequestFormFeaturesItemX4482dfe9.Builder.() -> Unit): InlineV1BillingPortalConfiab44PostRequestFormFeaturesItemX4482dfe9 = InlineV1BillingPortalConfiab44PostRequestFormFeaturesItemX4482dfe9.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineV1BillingPortalConfiab44PostRequestFormFeaturesItemX4482dfe9 is missing required property '" + name + "'")
