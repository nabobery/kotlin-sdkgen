...
public class PaymentPagesCheckoutSessionIndividualName(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): PaymentPagesCheckoutSessionIndividualName = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<PaymentPagesCheckoutSessionIndividualName> {
    ...
    override fun deserialize(decoder: Decoder): PaymentPagesCheckoutSessionIndividualName {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("PaymentPagesCheckoutSessionIndividualName must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: PaymentPagesCheckoutSessionIndividualName) {
...
public fun paymentPagesCheckoutSessionIndividualName(block: PaymentPagesCheckoutSessionIndividualName.Builder.() -> Unit): PaymentPagesCheckoutSessionIndividualName = PaymentPagesCheckoutSessionIndividualName.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("PaymentPagesCheckoutSessionIndividualName is missing required property '" + name + "'")
