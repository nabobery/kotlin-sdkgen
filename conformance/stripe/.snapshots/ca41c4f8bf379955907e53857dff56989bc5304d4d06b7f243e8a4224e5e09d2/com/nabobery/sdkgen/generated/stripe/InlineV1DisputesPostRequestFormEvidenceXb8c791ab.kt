...
public class InlineV1DisputesPostRequestFormEvidenceXb8c791ab(
  ...
  public val enhancedEvidence:
      InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceX108ef6c9? = null,
  ...
  public class Builder {
    ...
    public fun build(): InlineV1DisputesPostRequestFormEvidenceXb8c791ab = InlineV1DisputesPostRequestFormEvidenceXb8c791ab(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1DisputesPostRequestFormEvidenceXb8c791ab = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1DisputesPostRequestFormEvidenceXb8c791ab> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1DisputesPostRequestFormEvidenceXb8c791ab {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1DisputesPostRequestFormEvidenceXb8c791ab must be a JSON object")
      return InlineV1DisputesPostRequestFormEvidenceXb8c791ab(
        ...
        enhancedEvidence = rawObject["enhanced_evidence"]?.let { json.decodeFromJsonElement<InlineV1DisputesPostRequestFormEvidenceEnhancedEvidenceX108ef6c9>(it) },
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1DisputesPostRequestFormEvidenceXb8c791ab) {
...
public fun inlineV1DisputesPostRequestFormEvidenceXb8c791ab(block: InlineV1DisputesPostRequestFormEvidenceXb8c791ab.Builder.() -> Unit): InlineV1DisputesPostRequestFormEvidenceXb8c791ab = InlineV1DisputesPostRequestFormEvidenceXb8c791ab.build(block)
