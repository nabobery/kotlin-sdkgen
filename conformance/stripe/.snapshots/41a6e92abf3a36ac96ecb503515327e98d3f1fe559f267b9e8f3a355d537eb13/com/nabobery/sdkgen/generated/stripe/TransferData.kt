...
@Serializable
public data class TransferDataView internal constructor(
...
public class TransferData(
  ...
  internal object Serializer : KSerializer<TransferData> {
    ...
    override fun deserialize(decoder: Decoder): TransferData {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("TransferData must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: TransferData) {
