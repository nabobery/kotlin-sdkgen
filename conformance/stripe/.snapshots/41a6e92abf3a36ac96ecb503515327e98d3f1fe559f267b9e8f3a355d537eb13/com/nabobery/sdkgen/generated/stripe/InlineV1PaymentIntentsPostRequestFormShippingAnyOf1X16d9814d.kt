...
public class InlineV1PaymentIntentsPostRequestFormShippingAnyOf1X16d9814d(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1PaymentIntentsPostRequestFormShippingAnyOf1X16d9814d = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormShippingAnyOf1X16d9814d> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1PaymentIntentsPostRequestFormShippingAnyOf1X16d9814d {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1PaymentIntentsPostRequestFormShippingAnyOf1X16d9814d must be a JSON object")
      val address = json.decodeRequired<InlineV1PaymentIntentsPostRequestFormShippingAnyOf1AddressX2e26039e>(rawObject, "address")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1PaymentIntentsPostRequestFormShippingAnyOf1X16d9814d) {
...
public fun inlineV1PaymentIntentsPostRequestFormShippingAnyOf1X16d9814d(block: InlineV1PaymentIntentsPostRequestFormShippingAnyOf1X16d9814d.Builder.() -> Unit): InlineV1PaymentIntentsPostRequestFormShippingAnyOf1X16d9814d = InlineV1PaymentIntentsPostRequestFormShippingAnyOf1X16d9814d.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineV1PaymentIntentsPostRequestFormShippingAnyOf1X16d9814d is missing required property '" + name + "'")
