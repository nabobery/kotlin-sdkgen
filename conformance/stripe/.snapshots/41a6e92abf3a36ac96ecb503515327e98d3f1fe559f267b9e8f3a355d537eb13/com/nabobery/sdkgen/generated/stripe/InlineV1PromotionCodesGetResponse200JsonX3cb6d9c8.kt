...
public class InlineV1PromotionCodesGetResponse200JsonX3cb6d9c8(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1PromotionCodesGetResponse200JsonX3cb6d9c8 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1PromotionCodesGetResponse200JsonX3cb6d9c8> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1PromotionCodesGetResponse200JsonX3cb6d9c8 {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1PromotionCodesGetResponse200JsonX3cb6d9c8 must be a JSON object")
      val data = json.decodeRequired<List<PromotionCode>>(rawObject, "data")
      val hasMore = json.decodeRequired<Boolean>(rawObject, "has_more")
      val objectValue = json.decodeRequired<InlineV1PromotionCodesGetResponse200JsonObjectValueX398e196f>(rawObject, "object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1PromotionCodesGetResponse200JsonX3cb6d9c8) {
...
public fun inlineV1PromotionCodesGetResponse200JsonX3cb6d9c8(block: InlineV1PromotionCodesGetResponse200JsonX3cb6d9c8.Builder.() -> Unit): InlineV1PromotionCodesGetResponse200JsonX3cb6d9c8 = InlineV1PromotionCodesGetResponse200JsonX3cb6d9c8.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineV1PromotionCodesGetResponse200JsonX3cb6d9c8 is missing required property '" + name + "'")
