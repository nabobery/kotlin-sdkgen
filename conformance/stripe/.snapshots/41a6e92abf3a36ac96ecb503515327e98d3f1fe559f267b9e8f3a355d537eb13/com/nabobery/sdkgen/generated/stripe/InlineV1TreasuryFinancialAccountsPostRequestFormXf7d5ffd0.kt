...
public class InlineV1TreasuryFinancialAccountsPostRequestFormXf7d5ffd0(
  ...
  public class Builder {
    ...
    public fun build(): InlineV1TreasuryFinancialAccountsPostRequestFormXf7d5ffd0 = InlineV1TreasuryFinancialAccountsPostRequestFormXf7d5ffd0(
      expand = expand,
      features = features,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1TreasuryFinancialAccountsPostRequestFormXf7d5ffd0 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1TreasuryFinancialAccountsPostRequestFormXf7d5ffd0> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1TreasuryFinancialAccountsPostRequestFormXf7d5ffd0 {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1TreasuryFinancialAccountsPostRequestFormXf7d5ffd0 must be a JSON object")
      return InlineV1TreasuryFinancialAccountsPostRequestFormXf7d5ffd0(
        expand = rawObject["expand"]?.let { json.decodeFromJsonElement<List<String>>(it) },
        features = rawObject["features"]?.let { json.decodeFromJsonElement<InlineV1TreasuryFinancialAccountsPostRequestFormFeaturesX61532763>(it) },
        forwardingSettings = rawObject["forwarding_settings"]?.let { json.decodeFromJsonElement<InlineV1TreasuryFinancialAccountsPostRequestFormForwardingSettingsX7c5f67f7>(it) },
        metadata = rawObject["metadata"]?.let { json.decodeFromJsonElement<Map<String, String>>(it) },
        nickname = rawObject["nickname"]?.let { json.decodeFromJsonElement<InlineV1TreasuryFinancialAccountsPostRequestFormNicknameX3dbdbd77>(it) },
        platformRestrictions = rawObject["platform_restrictions"]?.let { json.decodeFromJsonElement<InlineV1TreasuryFinancialAccountsPostRequestFormPlatformRestrictionsXcaf2eb7c>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineV1TreasuryFinancialAccountsPostRequestFormXf7d5ffd0) {
...
public fun inlineV1TreasuryFinancialAccountsPostRequestFormXf7d5ffd0(block: InlineV1TreasuryFinancialAccountsPostRequestFormXf7d5ffd0.Builder.() -> Unit): InlineV1TreasuryFinancialAccountsPostRequestFormXf7d5ffd0 = InlineV1TreasuryFinancialAccountsPostRequestFormXf7d5ffd0.build(block)
