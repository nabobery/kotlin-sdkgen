...
public class PromotionCodeCurrencyOption(
  ...
  internal object Serializer : KSerializer<PromotionCodeCurrencyOption> {
    ...
    override fun deserialize(decoder: Decoder): PromotionCodeCurrencyOption {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("PromotionCodeCurrencyOption must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: PromotionCodeCurrencyOption) {
...
public fun promotionCodeCurrencyOption(block: PromotionCodeCurrencyOption.Builder.() -> Unit): PromotionCodeCurrencyOption = PromotionCodeCurrencyOption.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("PromotionCodeCurrencyOption is missing required property '" + name + "'")
