...
public class PaymentIntentNextActionUpiHandleRedirectOrDisplayQrCode(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): PaymentIntentNextActionUpiHandleRedirectOrDisplayQrCode = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<PaymentIntentNextActionUpiHandleRedirectOrDisplayQrCode> {
    ...
    override fun deserialize(decoder: Decoder): PaymentIntentNextActionUpiHandleRedirectOrDisplayQrCode {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("PaymentIntentNextActionUpiHandleRedirectOrDisplayQrCode must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: PaymentIntentNextActionUpiHandleRedirectOrDisplayQrCode) {
...
public fun paymentIntentNextActionUpiHandleRedirectOrDisplayQrCode(block: PaymentIntentNextActionUpiHandleRedirectOrDisplayQrCode.Builder.() -> Unit): PaymentIntentNextActionUpiHandleRedirectOrDisplayQrCode = PaymentIntentNextActionUpiHandleRedirectOrDisplayQrCode.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("PaymentIntentNextActionUpiHandleRedirectOrDisplayQrCode is missing required property '" + name + "'")
