...
@Serializable
public data class SetupIntentPaymentMethodOptionsCardMandateOptionsView internal constructor(
  ...
  public val supportedTypes:
      List<InlineSetupIntentPaymentMecd6aSupportedTypesItemXf71f619e>? = null,
)
...
public class SetupIntentPaymentMethodOptionsCardMandateOptions(
   ...
   */
  public val intervalCount: Int? = null,
  supportedTypes: List<InlineSetupIntentPaymentMecd6aSupportedTypesItemXf71f619e>? = null,
) {
  /**
   * Specifies the type of mandates supported. Possible values are `india`.
   */
  public val supportedTypes: List<InlineSetupIntentPaymentMecd6aSupportedTypesItemXf71f619e>? =
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): SetupIntentPaymentMethodOptionsCardMandateOptions = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<SetupIntentPaymentMethodOptionsCardMandateOptions> {
    ...
    override fun deserialize(decoder: Decoder): SetupIntentPaymentMethodOptionsCardMandateOptions {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("SetupIntentPaymentMethodOptionsCardMandateOptions must be a JSON object")
      val amount = json.decodeRequired<Int>(rawObject, "amount")
      val amountType = json.decodeRequired<InlineSetupIntentPaymentMethodOptionsCardMandateOptionsAmountTypeX329b3f74>(rawObject, "amount_type")
      val currency = json.decodeRequired<String>(rawObject, "currency")
      val interval = json.decodeRequired<InlineSetupIntentPaymentMethodOptionsCardMandateOptionsIntervalX6beb651a>(rawObject, "interval")
      ...
      return SetupIntentPaymentMethodOptionsCardMandateOptions(
        ...
        supportedTypes = rawObject["supported_types"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<List<InlineSetupIntentPaymentMecd6aSupportedTypesItemXf71f619e>?>(element) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: SetupIntentPaymentMethodOptionsCardMandateOptions) {
...
public fun setupIntentPaymentMethodOptionsCardMandateOptions(block: SetupIntentPaymentMethodOptionsCardMandateOptions.Builder.() -> Unit): SetupIntentPaymentMethodOptionsCardMandateOptions = SetupIntentPaymentMethodOptionsCardMandateOptions.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("SetupIntentPaymentMethodOptionsCardMandateOptions is missing required property '" + name + "'")
