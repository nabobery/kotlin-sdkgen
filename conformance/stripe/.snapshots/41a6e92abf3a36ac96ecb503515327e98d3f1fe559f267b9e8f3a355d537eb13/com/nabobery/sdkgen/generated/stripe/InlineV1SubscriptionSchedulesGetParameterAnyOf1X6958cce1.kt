...
public class InlineV1SubscriptionSchedulesGetParameterAnyOf1X6958cce1(
  ...
  public class Builder {
    ...
    public fun build(): InlineV1SubscriptionSchedulesGetParameterAnyOf1X6958cce1 = InlineV1SubscriptionSchedulesGetParameterAnyOf1X6958cce1(
      gt = gt,
      gte = gte,
      lt = lt,
      lte = lte,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1SubscriptionSchedulesGetParameterAnyOf1X6958cce1 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1SubscriptionSchedulesGetParameterAnyOf1X6958cce1> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1SubscriptionSchedulesGetParameterAnyOf1X6958cce1 {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1SubscriptionSchedulesGetParameterAnyOf1X6958cce1 must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1SubscriptionSchedulesGetParameterAnyOf1X6958cce1) {
...
public fun inlineV1SubscriptionSchedulesGetParameterAnyOf1X6958cce1(block: InlineV1SubscriptionSchedulesGetParameterAnyOf1X6958cce1.Builder.() -> Unit): InlineV1SubscriptionSchedulesGetParameterAnyOf1X6958cce1 = InlineV1SubscriptionSchedulesGetParameterAnyOf1X6958cce1.build(block)
