...
public class InlineV1SourcesVerifyPostRequestFormX1f834e47(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1SourcesVerifyPostRequestFormX1f834e47 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1SourcesVerifyPostRequestFormX1f834e47> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1SourcesVerifyPostRequestFormX1f834e47 {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1SourcesVerifyPostRequestFormX1f834e47 must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1SourcesVerifyPostRequestFormX1f834e47) {
...
public fun inlineV1SourcesVerifyPostRequestFormX1f834e47(block: InlineV1SourcesVerifyPostRequestFormX1f834e47.Builder.() -> Unit): InlineV1SourcesVerifyPostRequestFormX1f834e47 = InlineV1SourcesVerifyPostRequestFormX1f834e47.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineV1SourcesVerifyPostRequestFormX1f834e47 is missing required property '" + name + "'")
