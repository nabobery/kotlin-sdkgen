...
public class PaymentMethodDetailsUpi(
  ...
  public class Builder {
    ...
    public fun build(): PaymentMethodDetailsUpi = PaymentMethodDetailsUpi(
      vpa = vpa,
    )
  }
  ...
  internal object Serializer : KSerializer<PaymentMethodDetailsUpi> {
    ...
    override fun deserialize(decoder: Decoder): PaymentMethodDetailsUpi {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("PaymentMethodDetailsUpi must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: PaymentMethodDetailsUpi) {
...
public fun paymentMethodDetailsUpi(block: PaymentMethodDetailsUpi.Builder.() -> Unit): PaymentMethodDetailsUpi = PaymentMethodDetailsUpi.build(block)
