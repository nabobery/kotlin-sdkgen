...
public class RadarEarlyFraudWarning(
  ...
  internal object Serializer : KSerializer<RadarEarlyFraudWarning> {
    ...
    override fun deserialize(decoder: Decoder): RadarEarlyFraudWarning {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("RadarEarlyFraudWarning must be a JSON object")
      ...
      return RadarEarlyFraudWarning(
        ...
        livemode = livemode,
        objectValue = objectValue,
        paymentIntent = rawObject["payment_intent"]?.let { json.decodeFromJsonElement<InlineRadarEarlyFraudWarningPaymentIntentX11715895>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: RadarEarlyFraudWarning) {
...
public fun radarEarlyFraudWarning(block: RadarEarlyFraudWarning.Builder.() -> Unit): RadarEarlyFraudWarning = RadarEarlyFraudWarning.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("RadarEarlyFraudWarning is missing required property '" + name + "'")
