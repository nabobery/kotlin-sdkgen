...
public class PaymentMethodLink(
  ...
  public class Builder {
    ...
    public fun build(): PaymentMethodLink = PaymentMethodLink(
      email = email,
    )
  }
  ...
  internal object Serializer : KSerializer<PaymentMethodLink> {
    ...
    override fun deserialize(decoder: Decoder): PaymentMethodLink {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("PaymentMethodLink must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: PaymentMethodLink) {
...
public fun paymentMethodLink(block: PaymentMethodLink.Builder.() -> Unit): PaymentMethodLink = PaymentMethodLink.build(block)
