 ...
 * properties/card/anyOf/0
 */
@Serializable(with = InlineV1ChargesPostRequestFormCardAnyOf1X47b2c78d.Serializer::class)
public class InlineV1ChargesPostRequestFormCardAnyOf1X47b2c78d(
  ...
  public val networkToken: InlineV1ChargesPostRequestFormCardAnyOf1NetworkTokenX5841a88b? = null,
  public val objectValue: InlineV1ChargesPostRequestFormCardAnyOf1ObjectValueXe0421c7e? = null,
  ...
  public class Builder {
    ...
    public var networkToken: InlineV1ChargesPostRequestFormCardAnyOf1NetworkTokenX5841a88b? = null

    public var objectValue: InlineV1ChargesPostRequestFormCardAnyOf1ObjectValueXe0421c7e? = null

    public var swipeData: String? = null

    public fun build(): InlineV1ChargesPostRequestFormCardAnyOf1X47b2c78d {
      ...
      return InlineV1ChargesPostRequestFormCardAnyOf1X47b2c78d(
        expMonth = expMonth,
        expYear = expYear,
        number = number,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1ChargesPostRequestFormCardAnyOf1X47b2c78d = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1ChargesPostRequestFormCardAnyOf1X47b2c78d> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineV1ChargesPostRequestFormCardAnyOf1X47b2c78d {
      val jsonDecoder = decoder.requireJsonDecoder("InlineV1ChargesPostRequestFormCardAnyOf1X47b2c78d")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1ChargesPostRequestFormCardAnyOf1X47b2c78d must be a JSON object")
      ...
      return InlineV1ChargesPostRequestFormCardAnyOf1X47b2c78d(
        ...
        networkToken = rawObject["network_token"]?.let { json.decodeFromJsonElement<InlineV1ChargesPostRequestFormCardAnyOf1NetworkTokenX5841a88b>(it) },
        objectValue = rawObject["object"]?.let { json.decodeFromJsonElement<InlineV1ChargesPostRequestFormCardAnyOf1ObjectValueXe0421c7e>(it) },
        swipeData = rawObject["swipe_data"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineV1ChargesPostRequestFormCardAnyOf1X47b2c78d) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineV1ChargesPostRequestFormCardAnyOf1X47b2c78d")
...
public fun inlineV1ChargesPostRequestFormCardAnyOf1X47b2c78d(block: InlineV1ChargesPostRequestFormCardAnyOf1X47b2c78d.Builder.() -> Unit): InlineV1ChargesPostRequestFormCardAnyOf1X47b2c78d = InlineV1ChargesPostRequestFormCardAnyOf1X47b2c78d.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineV1ChargesPostRequestFormCardAnyOf1X47b2c78d is missing required property '" + name + "'")
