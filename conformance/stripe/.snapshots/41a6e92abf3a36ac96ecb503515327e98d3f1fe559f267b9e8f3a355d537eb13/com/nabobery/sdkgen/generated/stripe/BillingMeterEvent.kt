...
public class BillingMeterEvent(
  ...
  internal object Serializer : KSerializer<BillingMeterEvent> {
    ...
    override fun deserialize(decoder: Decoder): BillingMeterEvent {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("BillingMeterEvent must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: BillingMeterEvent) {
...
public fun billingMeterEvent(block: BillingMeterEvent.Builder.() -> Unit): BillingMeterEvent = BillingMeterEvent.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("BillingMeterEvent is missing required property '" + name + "'")
