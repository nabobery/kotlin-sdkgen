...
public class InlineV1PlansPostRequestFormTransformUsageX508b97d6(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1PlansPostRequestFormTransformUsageX508b97d6 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1PlansPostRequestFormTransformUsageX508b97d6> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1PlansPostRequestFormTransformUsageX508b97d6 {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1PlansPostRequestFormTransformUsageX508b97d6 must be a JSON object")
      val divideBy = json.decodeRequired<Int>(rawObject, "divide_by")
      val round = json.decodeRequired<InlineV1PlansPostRequestFormTransformUsageRoundX4e85f76f>(rawObject, "round")
      return InlineV1PlansPostRequestFormTransformUsageX508b97d6(
        divideBy = divideBy,
        round = round,
      )
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1PlansPostRequestFormTransformUsageX508b97d6) {
...
public fun inlineV1PlansPostRequestFormTransformUsageX508b97d6(block: InlineV1PlansPostRequestFormTransformUsageX508b97d6.Builder.() -> Unit): InlineV1PlansPostRequestFormTransformUsageX508b97d6 = InlineV1PlansPostRequestFormTransformUsageX508b97d6.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineV1PlansPostRequestFormTransformUsageX508b97d6 is missing required property '" + name + "'")
