...
public class InvoicesResourceStatusTransitions(
  ...
  public class Builder {
    ...
    public fun build(): InvoicesResourceStatusTransitions = InvoicesResourceStatusTransitions(
  ...
  internal object Serializer : KSerializer<InvoicesResourceStatusTransitions> {
    ...
    override fun deserialize(decoder: Decoder): InvoicesResourceStatusTransitions {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InvoicesResourceStatusTransitions must be a JSON object")
      return InvoicesResourceStatusTransitions(
        ...
        markedUncollectibleAt = rawObject["marked_uncollectible_at"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<Int?>(element) },
    ...
    override fun serialize(encoder: Encoder, `value`: InvoicesResourceStatusTransitions) {
...
public fun invoicesResourceStatusTransitions(block: InvoicesResourceStatusTransitions.Builder.() -> Unit): InvoicesResourceStatusTransitions = InvoicesResourceStatusTransitions.build(block)
