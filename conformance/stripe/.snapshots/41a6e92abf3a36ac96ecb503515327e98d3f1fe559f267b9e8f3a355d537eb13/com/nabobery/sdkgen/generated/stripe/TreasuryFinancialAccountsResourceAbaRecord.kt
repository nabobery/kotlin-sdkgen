...
public class TreasuryFinancialAccountsResourceAbaRecord(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): TreasuryFinancialAccountsResourceAbaRecord = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<TreasuryFinancialAccountsResourceAbaRecord> {
    ...
    override fun deserialize(decoder: Decoder): TreasuryFinancialAccountsResourceAbaRecord {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("TreasuryFinancialAccountsResourceAbaRecord must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: TreasuryFinancialAccountsResourceAbaRecord) {
...
public fun treasuryFinancialAccountsResourceAbaRecord(block: TreasuryFinancialAccountsResourceAbaRecord.Builder.() -> Unit): TreasuryFinancialAccountsResourceAbaRecord = TreasuryFinancialAccountsResourceAbaRecord.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("TreasuryFinancialAccountsResourceAbaRecord is missing required property '" + name + "'")
