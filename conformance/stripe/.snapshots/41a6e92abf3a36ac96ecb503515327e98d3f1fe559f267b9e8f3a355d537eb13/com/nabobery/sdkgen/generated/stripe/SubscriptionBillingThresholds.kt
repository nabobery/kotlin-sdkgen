...
public class SubscriptionBillingThresholds(
  ...
  public class Builder {
    ...
    public fun build(): SubscriptionBillingThresholds = SubscriptionBillingThresholds(
      amountGte = amountGte,
  ...
  internal object Serializer : KSerializer<SubscriptionBillingThresholds> {
    ...
    override fun deserialize(decoder: Decoder): SubscriptionBillingThresholds {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("SubscriptionBillingThresholds must be a JSON object")
      return SubscriptionBillingThresholds(
        ...
        resetBillingCycleAnchor = rawObject["reset_billing_cycle_anchor"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<Boolean?>(element) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: SubscriptionBillingThresholds) {
...
public fun subscriptionBillingThresholds(block: SubscriptionBillingThresholds.Builder.() -> Unit): SubscriptionBillingThresholds = SubscriptionBillingThresholds.build(block)
