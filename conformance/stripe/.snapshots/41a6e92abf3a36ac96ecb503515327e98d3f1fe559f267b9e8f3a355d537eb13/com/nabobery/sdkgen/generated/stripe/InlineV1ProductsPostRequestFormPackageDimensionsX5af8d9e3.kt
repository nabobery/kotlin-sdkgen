...
public class InlineV1ProductsPostRequestFormPackageDimensionsX5af8d9e3(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1ProductsPostRequestFormPackageDimensionsX5af8d9e3 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1ProductsPostRequestFormPackageDimensionsX5af8d9e3> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1ProductsPostRequestFormPackageDimensionsX5af8d9e3 {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1ProductsPostRequestFormPackageDimensionsX5af8d9e3 must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1ProductsPostRequestFormPackageDimensionsX5af8d9e3) {
...
public fun inlineV1ProductsPostRequestFormPackageDimensionsX5af8d9e3(block: InlineV1ProductsPostRequestFormPackageDimensionsX5af8d9e3.Builder.() -> Unit): InlineV1ProductsPostRequestFormPackageDimensionsX5af8d9e3 = InlineV1ProductsPostRequestFormPackageDimensionsX5af8d9e3.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineV1ProductsPostRequestFormPackageDimensionsX5af8d9e3 is missing required property '" + name + "'")
