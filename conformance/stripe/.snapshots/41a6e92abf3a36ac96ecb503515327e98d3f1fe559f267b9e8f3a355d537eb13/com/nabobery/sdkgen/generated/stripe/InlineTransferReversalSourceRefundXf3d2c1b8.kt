...
public class InlineTransferReversalSourceRefundXf3d2c1b8 internal constructor(
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineTransferReversalSourceRefundXf3d2c1b8 {
      val inspection = inspectInlineTransferReversalSourceRefundXf3d2c1b8(raw)
      if (inspection.matchCount == 0) {
        throw InlineTransferReversalSourceRefundXf3d2c1b8NoMatchException("InlineTransferReversalSourceRefundXf3d2c1b8 matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineTransferReversalSourceRefundXf3d2c1b8(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineTransferReversalSourceRefundXf3d2c1b8> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineTransferReversalSourceRefundXf3d2c1b8) {
      encoder.requireJsonEncoder("InlineTransferReversalSourceRefundXf3d2c1b8").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineTransferReversalSourceRefundXf3d2c1b8(element: JsonElement): InlineTransferReversalSourceRefundXf3d2c1b8Inspection {
