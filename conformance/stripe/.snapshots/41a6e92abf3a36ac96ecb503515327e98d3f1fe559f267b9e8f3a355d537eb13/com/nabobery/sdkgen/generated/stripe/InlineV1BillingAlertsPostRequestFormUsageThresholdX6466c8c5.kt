...
public class InlineV1BillingAlertsPostRequestFormUsageThresholdX6466c8c5(
  ...
  filters: List<InlineV1BillingAlertsPostRequestFormUsageThresholdFiltersItemXae51d03c>? = null,
) {
  public val filters: List<InlineV1BillingAlertsPostRequestFormUsageThresholdFiltersItemXae51d03c>?
  ...
  public class Builder {
    ...
    public var filters:
        List<InlineV1BillingAlertsPostRequestFormUsageThresholdFiltersItemXae51d03c>?
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1BillingAlertsPostRequestFormUsageThresholdX6466c8c5 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1BillingAlertsPostRequestFormUsageThresholdX6466c8c5> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1BillingAlertsPostRequestFormUsageThresholdX6466c8c5 {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1BillingAlertsPostRequestFormUsageThresholdX6466c8c5 must be a JSON object")
      val gte = json.decodeRequired<Int>(rawObject, "gte")
      val meter = json.decodeRequired<String>(rawObject, "meter")
      val recurrence = json.decodeRequired<InlineV1BillingAlertsPostRequestFormUsageThresholdRecurrenceX2c86a9a2>(rawObject, "recurrence")
      return InlineV1BillingAlertsPostRequestFormUsageThresholdX6466c8c5(
        gte = gte,
        meter = meter,
        recurrence = recurrence,
        filters = rawObject["filters"]?.let { json.decodeFromJsonElement<List<InlineV1BillingAlertsPostRequestFormUsageThresholdFiltersItemXae51d03c>>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineV1BillingAlertsPostRequestFormUsageThresholdX6466c8c5) {
...
public fun inlineV1BillingAlertsPostRequestFormUsageThresholdX6466c8c5(block: InlineV1BillingAlertsPostRequestFormUsageThresholdX6466c8c5.Builder.() -> Unit): InlineV1BillingAlertsPostRequestFormUsageThresholdX6466c8c5 = InlineV1BillingAlertsPostRequestFormUsageThresholdX6466c8c5.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineV1BillingAlertsPostRequestFormUsageThresholdX6466c8c5 is missing required property '" + name + "'")
