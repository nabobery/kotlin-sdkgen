...
public class InlineV1InvoicesAddLinesPostRequestFormLinesItemPriceDataX27a69332(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1InvoicesAddLinesPostRequestFormLinesItemPriceDataX27a69332 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1InvoicesAddLinesPostRequestFormLinesItemPriceDataX27a69332> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1InvoicesAddLinesPostRequestFormLinesItemPriceDataX27a69332 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineV1InvoicesAddLinesPostRequestFormLinesItemPriceDataX27a69332")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1InvoicesAddLinesPostRequestFormLinesItemPriceDataX27a69332 must be a JSON object")
      val currency = json.decodeRequired<String>(rawObject, "currency")
      return InlineV1InvoicesAddLinesPostRequestFormLinesItemPriceDataX27a69332(
        currency = currency,
        product = rawObject["product"]?.let { json.decodeFromJsonElement<String>(it) },
        productData = rawObject["product_data"]?.let { json.decodeFromJsonElement<InlineV1InvoicesAddLinesPostRequestFormLinesItemPriceDataProductDataX0c9822d5>(it) },
        taxBehavior = rawObject["tax_behavior"]?.let { json.decodeFromJsonElement<InlineV1InvoicesAddLinesPostRequestFormLinesItemPriceDataTaxBehaviorXe8883f64>(it) },
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1InvoicesAddLinesPostRequestFormLinesItemPriceDataX27a69332) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineV1InvoicesAddLinesPostRequestFormLinesItemPriceDataX27a69332")
...
public fun inlineV1InvoicesAddLinesPostRequestFormLinesItemPriceDataX27a69332(block: InlineV1InvoicesAddLinesPostRequestFormLinesItemPriceDataX27a69332.Builder.() -> Unit): InlineV1InvoicesAddLinesPostRequestFormLinesItemPriceDataX27a69332 = InlineV1InvoicesAddLinesPostRequestFormLinesItemPriceDataX27a69332.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineV1InvoicesAddLinesPostRequestFormLinesItemPriceDataX27a69332 is missing required property '" + name + "'")
