...
public class InlineV1CustomersPostRequestFormTaxX65e900f4(
  ...
  public class Builder {
    ...
    public fun build(): InlineV1CustomersPostRequestFormTaxX65e900f4 = InlineV1CustomersPostRequestFormTaxX65e900f4(
      ipAddress = ipAddress,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1CustomersPostRequestFormTaxX65e900f4 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1CustomersPostRequestFormTaxX65e900f4> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1CustomersPostRequestFormTaxX65e900f4 {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1CustomersPostRequestFormTaxX65e900f4 must be a JSON object")
      return InlineV1CustomersPostRequestFormTaxX65e900f4(
        ipAddress = rawObject["ip_address"]?.let { json.decodeFromJsonElement<InlineV1CustomersPostRequestFormTaxIpAddressX40cbf88c>(it) },
        validateLocation = rawObject["validate_location"]?.let { json.decodeFromJsonElement<InlineV1CustomersPostRequestFormTaxValidateLocationXcb50ae13>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineV1CustomersPostRequestFormTaxX65e900f4) {
...
public fun inlineV1CustomersPostRequestFormTaxX65e900f4(block: InlineV1CustomersPostRequestFormTaxX65e900f4.Builder.() -> Unit): InlineV1CustomersPostRequestFormTaxX65e900f4 = InlineV1CustomersPostRequestFormTaxX65e900f4.build(block)
