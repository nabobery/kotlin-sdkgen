...
public class ConnectEmbeddedPaymentDisputesConfig(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): ConnectEmbeddedPaymentDisputesConfig = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<ConnectEmbeddedPaymentDisputesConfig> {
    ...
    override fun deserialize(decoder: Decoder): ConnectEmbeddedPaymentDisputesConfig {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("ConnectEmbeddedPaymentDisputesConfig must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: ConnectEmbeddedPaymentDisputesConfig) {
...
public fun connectEmbeddedPaymentDisputesConfig(block: ConnectEmbeddedPaymentDisputesConfig.Builder.() -> Unit): ConnectEmbeddedPaymentDisputesConfig = ConnectEmbeddedPaymentDisputesConfig.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("ConnectEmbeddedPaymentDisputesConfig is missing required property '" + name + "'")
