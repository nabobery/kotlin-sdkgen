...
public class InlineBankAccountCustomerX196a61c7 internal constructor(
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineBankAccountCustomerX196a61c7 {
      val inspection = inspectInlineBankAccountCustomerX196a61c7(raw)
      if (inspection.matchCount == 0) {
        throw InlineBankAccountCustomerX196a61c7NoMatchException("InlineBankAccountCustomerX196a61c7 matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineBankAccountCustomerX196a61c7(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineBankAccountCustomerX196a61c7> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineBankAccountCustomerX196a61c7) {
      encoder.requireJsonEncoder("InlineBankAccountCustomerX196a61c7").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineBankAccountCustomerX196a61c7(element: JsonElement): InlineBankAccountCustomerX196a61c7Inspection {
