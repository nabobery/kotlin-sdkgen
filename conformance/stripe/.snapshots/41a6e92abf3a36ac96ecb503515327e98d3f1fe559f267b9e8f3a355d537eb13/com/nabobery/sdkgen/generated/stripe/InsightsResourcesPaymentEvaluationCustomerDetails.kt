...
public class InsightsResourcesPaymentEvaluationCustomerDetails(
  ...
  public class Builder {
    ...
    public fun build(): InsightsResourcesPaymentEvaluationCustomerDetails = InsightsResourcesPaymentEvaluationCustomerDetails(
      customer = customer,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InsightsResourcesPaymentEvaluationCustomerDetails = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InsightsResourcesPaymentEvaluationCustomerDetails> {
    ...
    override fun deserialize(decoder: Decoder): InsightsResourcesPaymentEvaluationCustomerDetails {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InsightsResourcesPaymentEvaluationCustomerDetails must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InsightsResourcesPaymentEvaluationCustomerDetails) {
...
public fun insightsResourcesPaymentEvaluationCustomerDetails(block: InsightsResourcesPaymentEvaluationCustomerDetails.Builder.() -> Unit): InsightsResourcesPaymentEvaluationCustomerDetails = InsightsResourcesPaymentEvaluationCustomerDetails.build(block)
