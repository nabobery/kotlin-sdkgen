...
public class TerminalReaderReaderResourceToggle(
  ...
  public class Builder {
    ...
    public fun build(): TerminalReaderReaderResourceToggle = TerminalReaderReaderResourceToggle(
  ...
  internal object Serializer : KSerializer<TerminalReaderReaderResourceToggle> {
    ...
    override fun deserialize(decoder: Decoder): TerminalReaderReaderResourceToggle {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("TerminalReaderReaderResourceToggle must be a JSON object")
      return TerminalReaderReaderResourceToggle(
        defaultValue = rawObject["default_value"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineTerminalReaderReaderResourceToggleDefaultValueXa8cf5ef4?>(element) },
        ...
        value = rawObject["value"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineTerminalReaderReaderResourceToggleValueX4d8b7bba?>(element) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: TerminalReaderReaderResourceToggle) {
...
public fun terminalReaderReaderResourceToggle(block: TerminalReaderReaderResourceToggle.Builder.() -> Unit): TerminalReaderReaderResourceToggle = TerminalReaderReaderResourceToggle.build(block)
