...
public class TerminalReaderReaderResourceEmail(
  ...
  public class Builder {
    ...
    public fun build(): TerminalReaderReaderResourceEmail = TerminalReaderReaderResourceEmail(
      value = value,
    )
  }
  ...
  internal object Serializer : KSerializer<TerminalReaderReaderResourceEmail> {
    ...
    override fun deserialize(decoder: Decoder): TerminalReaderReaderResourceEmail {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("TerminalReaderReaderResourceEmail must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: TerminalReaderReaderResourceEmail) {
...
public fun terminalReaderReaderResourceEmail(block: TerminalReaderReaderResourceEmail.Builder.() -> Unit): TerminalReaderReaderResourceEmail = TerminalReaderReaderResourceEmail.build(block)
