...
public class InlineV1PricesPostRequestFormX26912080(
  ...
  currencyOptions: Map<String, InlineV1PricesPostRequestFormCurrencyOptionsAdditionalValueX4584247f>? = null,
  /**
  ...
  tiers: List<InlineV1PricesPostRequestFormTiersItemX4171cb99>? = null,
  /**
  ...
  public val currencyOptions:
      Map<String, InlineV1PricesPostRequestFormCurrencyOptionsAdditionalValueX4584247f>? =
   ...
   */
  public val tiers: List<InlineV1PricesPostRequestFormTiersItemX4171cb99>? =
  ...
  public class Builder {
    ...
    private var tiersValue: List<InlineV1PricesPostRequestFormTiersItemX4171cb99>? = null

    /**
     * Each element represents a pricing tier. This parameter requires `billing_scheme` to be set to `tiered`. See also
     * the documentation for `billing_scheme`.
     */
    public var tiers: List<InlineV1PricesPostRequestFormTiersItemX4171cb99>?
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1PricesPostRequestFormX26912080 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1PricesPostRequestFormX26912080> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1PricesPostRequestFormX26912080 {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1PricesPostRequestFormX26912080 must be a JSON object")
      val currency = json.decodeRequired<String>(rawObject, "currency")
      return InlineV1PricesPostRequestFormX26912080(
        currency = currency,
        active = rawObject["active"]?.let { json.decodeFromJsonElement<Boolean>(it) },
        billingScheme = rawObject["billing_scheme"]?.let { json.decodeFromJsonElement<InlineV1PricesPostRequestFormBillingSchemeX67bff49a>(it) },
        currencyOptions = rawObject["currency_options"]?.let { json.decodeFromJsonElement<Map<String, InlineV1PricesPostRequestFormCurrencyOptionsAdditionalValueX4584247f>>(it) },
        customUnitAmount = rawObject["custom_unit_amount"]?.let { json.decodeFromJsonElement<InlineV1PricesPostRequestFormCustomUnitAmountX8bb5f273>(it) },
        ...
        productData = rawObject["product_data"]?.let { json.decodeFromJsonElement<InlineV1PricesPostRequestFormProductDataX52465f20>(it) },
        recurring = rawObject["recurring"]?.let { json.decodeFromJsonElement<InlineV1PricesPostRequestFormRecurringXac885c5d>(it) },
        taxBehavior = rawObject["tax_behavior"]?.let { json.decodeFromJsonElement<InlineV1PricesPostRequestFormTaxBehaviorX45616dab>(it) },
        tiers = rawObject["tiers"]?.let { json.decodeFromJsonElement<List<InlineV1PricesPostRequestFormTiersItemX4171cb99>>(it) },
        tiersMode = rawObject["tiers_mode"]?.let { json.decodeFromJsonElement<InlineV1PricesPostRequestFormTiersModeX7dd943f9>(it) },
        transferLookupKey = rawObject["transfer_lookup_key"]?.let { json.decodeFromJsonElement<Boolean>(it) },
        transformQuantity = rawObject["transform_quantity"]?.let { json.decodeFromJsonElement<InlineV1PricesPostRequestFormTransformQuantityXc0c69d44>(it) },
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1PricesPostRequestFormX26912080) {
...
public fun inlineV1PricesPostRequestFormX26912080(block: InlineV1PricesPostRequestFormX26912080.Builder.() -> Unit): InlineV1PricesPostRequestFormX26912080 = InlineV1PricesPostRequestFormX26912080.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineV1PricesPostRequestFormX26912080 is missing required property '" + name + "'")
