...
public class BillingMeter(
  ...
  internal object Serializer : KSerializer<BillingMeter> {
    ...
    override fun deserialize(decoder: Decoder): BillingMeter {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("BillingMeter must be a JSON object")
      val created = json.decodeRequired<Int>(rawObject, "created")
      val customerMapping = json.decodeRequired<BillingMeterResourceCustomerMappingSettings>(rawObject, "customer_mapping")
      val defaultAggregation = json.decodeRequired<BillingMeterResourceAggregationSettings>(rawObject, "default_aggregation")
      ...
      val statusTransitions = json.decodeRequired<BillingMeterResourceBillingMeterStatusTransitions>(rawObject, "status_transitions")
      ...
      return BillingMeter(
        ...
        updated = updated,
        valueSettings = valueSettings,
        eventTimeWindow = rawObject["event_time_window"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineBillingMeterEventTimeWindowX21f9c1a1?>(element) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: BillingMeter) {
