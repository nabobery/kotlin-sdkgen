...
public class PaymentMethodBacsDebit(
  ...
  public class Builder {
    ...
    public fun build(): PaymentMethodBacsDebit = PaymentMethodBacsDebit(
  ...
  internal object Serializer : KSerializer<PaymentMethodBacsDebit> {
    ...
    override fun deserialize(decoder: Decoder): PaymentMethodBacsDebit {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("PaymentMethodBacsDebit must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: PaymentMethodBacsDebit) {
...
public fun paymentMethodBacsDebit(block: PaymentMethodBacsDebit.Builder.() -> Unit): PaymentMethodBacsDebit = PaymentMethodBacsDebit.build(block)
