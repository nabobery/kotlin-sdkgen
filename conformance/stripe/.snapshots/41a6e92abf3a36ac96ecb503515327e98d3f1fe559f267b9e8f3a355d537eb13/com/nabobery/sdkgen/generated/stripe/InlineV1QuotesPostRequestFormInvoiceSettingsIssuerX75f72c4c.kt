...
public class InlineV1QuotesPostRequestFormInvoiceSettingsIssuerX75f72c4c(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1QuotesPostRequestFormInvoiceSettingsIssuerX75f72c4c = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1QuotesPostRequestFormInvoiceSettingsIssuerX75f72c4c> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1QuotesPostRequestFormInvoiceSettingsIssuerX75f72c4c {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1QuotesPostRequestFormInvoiceSettingsIssuerX75f72c4c must be a JSON object")
      val type = json.decodeRequired<InlineV1QuotesPostRequestFormInvoiceSettingsIssuerTypeX61c3643b>(rawObject, "type")
      return InlineV1QuotesPostRequestFormInvoiceSettingsIssuerX75f72c4c(
        type = type,
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1QuotesPostRequestFormInvoiceSettingsIssuerX75f72c4c) {
...
public fun inlineV1QuotesPostRequestFormInvoiceSettingsIssuerX75f72c4c(block: InlineV1QuotesPostRequestFormInvoiceSettingsIssuerX75f72c4c.Builder.() -> Unit): InlineV1QuotesPostRequestFormInvoiceSettingsIssuerX75f72c4c = InlineV1QuotesPostRequestFormInvoiceSettingsIssuerX75f72c4c.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineV1QuotesPostRequestFormInvoiceSettingsIssuerX75f72c4c is missing required property '" + name + "'")
