...
public class InlineInsightsResourcesPayf203PaymentMethodX825d85ed internal constructor(
  ...
  public val matchedBranches: Set<InlineInsightsResourcesPayf203PaymentMethodX825d85edBranch>
    get() = buildSet {
      ...
      if (inspection.matchesPaymentMethod) add(InlineInsightsResourcesPayf203PaymentMethodX825d85edBranch.PaymentMethod)
    }
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineInsightsResourcesPayf203PaymentMethodX825d85ed {
      val inspection = inspectInlineInsightsResourcesPayf203PaymentMethodX825d85ed(raw)
      if (inspection.matchCount == 0) {
        throw InlineInsightsResourcesPayf203PaymentMethodX825d85edNoMatchException("InlineInsightsResourcesPayf203PaymentMethodX825d85ed matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineInsightsResourcesPayf203PaymentMethodX825d85ed(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineInsightsResourcesPayf203PaymentMethodX825d85ed> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineInsightsResourcesPayf203PaymentMethodX825d85ed) {
      encoder.requireJsonEncoder("InlineInsightsResourcesPayf203PaymentMethodX825d85ed").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineInsightsResourcesPayf203PaymentMethodX825d85ed(element: JsonElement): InlineInsightsResourcesPayf203PaymentMethodX825d85edInspection {
