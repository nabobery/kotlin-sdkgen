...
public class PaymentPagesCheckoutSessionCustomFieldsNumeric(
  ...
  public class Builder {
    ...
    public fun build(): PaymentPagesCheckoutSessionCustomFieldsNumeric = PaymentPagesCheckoutSessionCustomFieldsNumeric(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): PaymentPagesCheckoutSessionCustomFieldsNumeric = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<PaymentPagesCheckoutSessionCustomFieldsNumeric> {
    ...
    override fun deserialize(decoder: Decoder): PaymentPagesCheckoutSessionCustomFieldsNumeric {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("PaymentPagesCheckoutSessionCustomFieldsNumeric must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: PaymentPagesCheckoutSessionCustomFieldsNumeric) {
...
public fun paymentPagesCheckoutSessionCustomFieldsNumeric(block: PaymentPagesCheckoutSessionCustomFieldsNumeric.Builder.() -> Unit): PaymentPagesCheckoutSessionCustomFieldsNumeric = PaymentPagesCheckoutSessionCustomFieldsNumeric.build(block)
