...
public class InlineV1TopupsPostRequestFormMetadataX4992b674 internal constructor(
  ...
  public val inlineV1TopupsPostRequestFormMetadataAnyOf2X852a7e75:
      ...
      lazy(LazyThreadSafetyMode.NONE) { if (inspection.matchesInlineV1TopupsPostRequestFormMetadataAnyOf2X852a7e75) json.decodeFromJsonElement<InlineV1TopupsPostRequestFormMetadataAnyOf2X852a7e75>(raw) else null }
  ...
  public val matchedBranches: Set<InlineV1TopupsPostRequestFormMetadataX4992b674Branch>
    get() = buildSet {
      ...
      if (inspection.matchesInlineV1TopupsPostRequestFormMetadataAnyOf2X852a7e75) add(InlineV1TopupsPostRequestFormMetadataX4992b674Branch.InlineV1TopupsPostRequestFormMetadataAnyOf2X852a7e75)
    }
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineV1TopupsPostRequestFormMetadataX4992b674 {
      val inspection = inspectInlineV1TopupsPostRequestFormMetadataX4992b674(raw)
      if (inspection.matchCount == 0) {
        throw InlineV1TopupsPostRequestFormMetadataX4992b674NoMatchException("InlineV1TopupsPostRequestFormMetadataX4992b674 matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineV1TopupsPostRequestFormMetadataX4992b674(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineV1TopupsPostRequestFormMetadataX4992b674> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1TopupsPostRequestFormMetadataX4992b674) {
      encoder.requireJsonEncoder("InlineV1TopupsPostRequestFormMetadataX4992b674").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineV1TopupsPostRequestFormMetadataX4992b674(element: JsonElement): InlineV1TopupsPostRequestFormMetadataX4992b674Inspection {
  val matchesBranch1 = element.isJsonDecodable<JsonObject>()
  val matchesInlineV1TopupsPostRequestFormMetadataAnyOf2X852a7e75 = element.isJsonDecodable<InlineV1TopupsPostRequestFormMetadataAnyOf2X852a7e75>()
  return InlineV1TopupsPostRequestFormMetadataX4992b674Inspection(
    ...
    failures = buildList {
      ...
      if (!matchesInlineV1TopupsPostRequestFormMetadataAnyOf2X852a7e75) add("InlineV1TopupsPostRequestFormMetadataAnyOf2X852a7e75: value does not match InlineV1TopupsPostRequestFormMetadataAnyOf2X852a7e75")
    },
  )
}
