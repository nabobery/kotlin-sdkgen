...
public class InlineV1PaymentLinksPostRequestFormLineItemsItemX40b508bb(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1PaymentLinksPostRequestFormLineItemsItemX40b508bb = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1PaymentLinksPostRequestFormLineItemsItemX40b508bb> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1PaymentLinksPostRequestFormLineItemsItemX40b508bb {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1PaymentLinksPostRequestFormLineItemsItemX40b508bb must be a JSON object")
      val quantity = json.decodeRequired<Int>(rawObject, "quantity")
      return InlineV1PaymentLinksPostRequestFormLineItemsItemX40b508bb(
        quantity = quantity,
        adjustableQuantity = rawObject["adjustable_quantity"]?.let { json.decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormLineItemsItemAdjustableQuantityX886fa941>(it) },
        price = rawObject["price"]?.let { json.decodeFromJsonElement<String>(it) },
        priceData = rawObject["price_data"]?.let { json.decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormLineItemsItemPriceDataX5ba488d5>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineV1PaymentLinksPostRequestFormLineItemsItemX40b508bb) {
...
public fun inlineV1PaymentLinksPostRequestFormLineItemsItemX40b508bb(block: InlineV1PaymentLinksPostRequestFormLineItemsItemX40b508bb.Builder.() -> Unit): InlineV1PaymentLinksPostRequestFormLineItemsItemX40b508bb = InlineV1PaymentLinksPostRequestFormLineItemsItemX40b508bb.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineV1PaymentLinksPostRequestFormLineItemsItemX40b508bb is missing required property '" + name + "'")
