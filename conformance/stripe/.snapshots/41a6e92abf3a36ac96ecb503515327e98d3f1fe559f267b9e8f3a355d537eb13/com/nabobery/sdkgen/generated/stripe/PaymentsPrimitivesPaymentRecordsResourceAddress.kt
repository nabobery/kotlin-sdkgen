...
public class PaymentsPrimitivesPaymentRecordsResourceAddress(
  ...
  public class Builder {
    ...
    public fun build(): PaymentsPrimitivesPaymentRecordsResourceAddress = PaymentsPrimitivesPaymentRecordsResourceAddress(
      city = city,
      country = country,
      line1 = line1,
      line2 = line2,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): PaymentsPrimitivesPaymentRecordsResourceAddress = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<PaymentsPrimitivesPaymentRecordsResourceAddress> {
    ...
    override fun deserialize(decoder: Decoder): PaymentsPrimitivesPaymentRecordsResourceAddress {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("PaymentsPrimitivesPaymentRecordsResourceAddress must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: PaymentsPrimitivesPaymentRecordsResourceAddress) {
...
public fun paymentsPrimitivesPaymentRecordsResourceAddress(block: PaymentsPrimitivesPaymentRecordsResourceAddress.Builder.() -> Unit): PaymentsPrimitivesPaymentRecordsResourceAddress = PaymentsPrimitivesPaymentRecordsResourceAddress.build(block)
