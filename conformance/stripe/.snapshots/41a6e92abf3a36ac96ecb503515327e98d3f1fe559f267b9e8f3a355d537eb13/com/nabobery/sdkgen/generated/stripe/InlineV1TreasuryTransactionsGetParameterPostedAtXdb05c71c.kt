...
internal data class InlineV1TreasuryTransactionsGetParameterPostedAtXdb05c71cInspection(
  ...
  public val matchCount: Int
    get() = listOf(matchesInlineV1TreasuryTransactionsGetParameterPostedAtAnyOf1Xcdd183dc, matchesBranch2).count { it }
}
...
public class InlineV1TreasuryTransactionsGetParameterPostedAtXdb05c71c internal constructor(
  ...
  public val inlineV1TreasuryTransactionsGetParameterPostedAtAnyOf1Xcdd183dc:
      ...
      lazy(LazyThreadSafetyMode.NONE) { if (inspection.matchesInlineV1TreasuryTransactionsGetParameterPostedAtAnyOf1Xcdd183dc) json.decodeFromJsonElement<InlineV1TreasuryTransactionsGetParameterPostedAtAnyOf1Xcdd183dc>(raw) else null }
  ...
  public val matchedBranches: Set<InlineV1TreasuryTransactionsGetParameterPostedAtXdb05c71cBranch>
    get() = buildSet {
      if (inspection.matchesInlineV1TreasuryTransactionsGetParameterPostedAtAnyOf1Xcdd183dc) add(InlineV1TreasuryTransactionsGetParameterPostedAtXdb05c71cBranch.InlineV1TreasuryTransactionsGetParameterPostedAtAnyOf1Xcdd183dc)
      if (inspection.matchesBranch2) add(InlineV1TreasuryTransactionsGetParameterPostedAtXdb05c71cBranch.Branch2)
    }
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineV1TreasuryTransactionsGetParameterPostedAtXdb05c71c {
      val inspection = inspectInlineV1TreasuryTransactionsGetParameterPostedAtXdb05c71c(raw)
      if (inspection.matchCount == 0) {
        throw InlineV1TreasuryTransactionsGetParameterPostedAtXdb05c71cNoMatchException("InlineV1TreasuryTransactionsGetParameterPostedAtXdb05c71c matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineV1TreasuryTransactionsGetParameterPostedAtXdb05c71c(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineV1TreasuryTransactionsGetParameterPostedAtXdb05c71c> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1TreasuryTransactionsGetParameterPostedAtXdb05c71c) {
      encoder.requireJsonEncoder("InlineV1TreasuryTransactionsGetParameterPostedAtXdb05c71c").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineV1TreasuryTransactionsGetParameterPostedAtXdb05c71c(element: JsonElement): InlineV1TreasuryTransactionsGetParameterPostedAtXdb05c71cInspection {
  val matchesInlineV1TreasuryTransactionsGetParameterPostedAtAnyOf1Xcdd183dc = element.isJsonDecodable<InlineV1TreasuryTransactionsGetParameterPostedAtAnyOf1Xcdd183dc>()
  ...
  return InlineV1TreasuryTransactionsGetParameterPostedAtXdb05c71cInspection(
    ...
    failures = buildList {
      if (!matchesInlineV1TreasuryTransactionsGetParameterPostedAtAnyOf1Xcdd183dc) add("InlineV1TreasuryTransactionsGetParameterPostedAtAnyOf1Xcdd183dc: value does not match InlineV1TreasuryTransactionsGetParameterPostedAtAnyOf1Xcdd183dc")
