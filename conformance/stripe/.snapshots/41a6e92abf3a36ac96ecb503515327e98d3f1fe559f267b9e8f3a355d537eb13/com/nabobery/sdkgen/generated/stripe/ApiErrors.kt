...
public class ApiErrors(
  ...
  internal object Serializer : KSerializer<ApiErrors> {
    ...
    override fun deserialize(decoder: Decoder): ApiErrors {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("ApiErrors must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: ApiErrors) {
