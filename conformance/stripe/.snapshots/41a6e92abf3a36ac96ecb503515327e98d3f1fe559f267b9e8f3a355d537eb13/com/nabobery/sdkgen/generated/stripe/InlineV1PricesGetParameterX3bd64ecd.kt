...
public class InlineV1PricesGetParameterX3bd64ecd(
  ...
  public class Builder {
    ...
    public fun build(): InlineV1PricesGetParameterX3bd64ecd = InlineV1PricesGetParameterX3bd64ecd(
      interval = interval,
      meter = meter,
      usageType = usageType,
    )
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1PricesGetParameterX3bd64ecd = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1PricesGetParameterX3bd64ecd> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1PricesGetParameterX3bd64ecd {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1PricesGetParameterX3bd64ecd must be a JSON object")
      return InlineV1PricesGetParameterX3bd64ecd(
        interval = rawObject["interval"]?.let { json.decodeFromJsonElement<InlineV1PricesGetParameterIntervalX75e88b2e>(it) },
        meter = rawObject["meter"]?.let { json.decodeFromJsonElement<String>(it) },
        usageType = rawObject["usage_type"]?.let { json.decodeFromJsonElement<InlineV1PricesGetParameterUsageTypeX4f7514a1>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineV1PricesGetParameterX3bd64ecd) {
...
public fun inlineV1PricesGetParameterX3bd64ecd(block: InlineV1PricesGetParameterX3bd64ecd.Builder.() -> Unit): InlineV1PricesGetParameterX3bd64ecd = InlineV1PricesGetParameterX3bd64ecd.build(block)
