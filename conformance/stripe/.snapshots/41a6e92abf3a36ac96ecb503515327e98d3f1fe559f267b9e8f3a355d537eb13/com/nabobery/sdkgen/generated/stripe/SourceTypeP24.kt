...
public class SourceTypeP24(
  ...
  public class Builder {
    ...
    public fun build(): SourceTypeP24 = SourceTypeP24(
      reference = reference,
    )
  }
  ...
  internal object Serializer : KSerializer<SourceTypeP24> {
    ...
    override fun deserialize(decoder: Decoder): SourceTypeP24 {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("SourceTypeP24 must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: SourceTypeP24) {
