...
public class InlineCustomerBalanceResou7348LinkedTransactionXd7ab40d7 internal constructor(
  ...
  public val matchedBranches: Set<InlineCustomerBalanceResou7348LinkedTransactionXd7ab40d7Branch>
    get() = buildSet {
      if (inspection.matchesBranch1) add(InlineCustomerBalanceResou7348LinkedTransactionXd7ab40d7Branch.Branch1)
      if (inspection.matchesCustomerCashBalanceTransaction) add(InlineCustomerBalanceResou7348LinkedTransactionXd7ab40d7Branch.CustomerCashBalanceTransaction)
    }
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineCustomerBalanceResou7348LinkedTransactionXd7ab40d7 {
      val inspection = inspectInlineCustomerBalanceResou7348LinkedTransactionXd7ab40d7(raw)
      if (inspection.matchCount == 0) {
        throw InlineCustomerBalanceResou7348LinkedTransactionXd7ab40d7NoMatchException("InlineCustomerBalanceResou7348LinkedTransactionXd7ab40d7 matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineCustomerBalanceResou7348LinkedTransactionXd7ab40d7(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineCustomerBalanceResou7348LinkedTransactionXd7ab40d7> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineCustomerBalanceResou7348LinkedTransactionXd7ab40d7) {
      encoder.requireJsonEncoder("InlineCustomerBalanceResou7348LinkedTransactionXd7ab40d7").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineCustomerBalanceResou7348LinkedTransactionXd7ab40d7(element: JsonElement): InlineCustomerBalanceResou7348LinkedTransactionXd7ab40d7Inspection {
