...
public class InlineV1PricesPostRequestFormCustomUnitAmountX8bb5f273(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1PricesPostRequestFormCustomUnitAmountX8bb5f273 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1PricesPostRequestFormCustomUnitAmountX8bb5f273> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1PricesPostRequestFormCustomUnitAmountX8bb5f273 {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1PricesPostRequestFormCustomUnitAmountX8bb5f273 must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1PricesPostRequestFormCustomUnitAmountX8bb5f273) {
...
public fun inlineV1PricesPostRequestFormCustomUnitAmountX8bb5f273(block: InlineV1PricesPostRequestFormCustomUnitAmountX8bb5f273.Builder.() -> Unit): InlineV1PricesPostRequestFormCustomUnitAmountX8bb5f273 = InlineV1PricesPostRequestFormCustomUnitAmountX8bb5f273.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineV1PricesPostRequestFormCustomUnitAmountX8bb5f273 is missing required property '" + name + "'")
