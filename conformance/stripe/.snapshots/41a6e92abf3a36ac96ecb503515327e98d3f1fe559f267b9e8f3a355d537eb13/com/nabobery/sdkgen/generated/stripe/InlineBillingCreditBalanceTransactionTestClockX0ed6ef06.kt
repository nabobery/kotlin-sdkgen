...
public class InlineBillingCreditBalanceTransactionTestClockX0ed6ef06 internal constructor(
  ...
  public val matchedBranches: Set<InlineBillingCreditBalanceTransactionTestClockX0ed6ef06Branch>
    get() = buildSet {
      if (inspection.matchesBranch1) add(InlineBillingCreditBalanceTransactionTestClockX0ed6ef06Branch.Branch1)
      if (inspection.matchesTestHelpersTestClock) add(InlineBillingCreditBalanceTransactionTestClockX0ed6ef06Branch.TestHelpersTestClock)
    }
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineBillingCreditBalanceTransactionTestClockX0ed6ef06 {
      val inspection = inspectInlineBillingCreditBalanceTransactionTestClockX0ed6ef06(raw)
      if (inspection.matchCount == 0) {
        throw InlineBillingCreditBalanceTransactionTestClockX0ed6ef06NoMatchException("InlineBillingCreditBalanceTransactionTestClockX0ed6ef06 matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineBillingCreditBalanceTransactionTestClockX0ed6ef06(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineBillingCreditBalanceTransactionTestClockX0ed6ef06> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineBillingCreditBalanceTransactionTestClockX0ed6ef06) {
      encoder.requireJsonEncoder("InlineBillingCreditBalanceTransactionTestClockX0ed6ef06").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineBillingCreditBalanceTransactionTestClockX0ed6ef06(element: JsonElement): InlineBillingCreditBalanceTransactionTestClockX0ed6ef06Inspection {
