...
public class InlineV1TreasuryReceivedCreditsGetResponse200JsonX654d8f88(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1TreasuryReceivedCreditsGetResponse200JsonX654d8f88 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1TreasuryReceivedCreditsGetResponse200JsonX654d8f88> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1TreasuryReceivedCreditsGetResponse200JsonX654d8f88 {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1TreasuryReceivedCreditsGetResponse200JsonX654d8f88 must be a JSON object")
      ...
      val objectValue = json.decodeRequired<InlineV1TreasuryReceivedCreditsGetResponse200JsonObjectValueXb04b6b85>(rawObject, "object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1TreasuryReceivedCreditsGetResponse200JsonX654d8f88) {
...
public fun inlineV1TreasuryReceivedCreditsGetResponse200JsonX654d8f88(block: InlineV1TreasuryReceivedCreditsGetResponse200JsonX654d8f88.Builder.() -> Unit): InlineV1TreasuryReceivedCreditsGetResponse200JsonX654d8f88 = InlineV1TreasuryReceivedCreditsGetResponse200JsonX654d8f88.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineV1TreasuryReceivedCreditsGetResponse200JsonX654d8f88 is missing required property '" + name + "'")
