...
@Serializable
public data class PaymentPagesCheckoutSessionShippingCostView internal constructor(
  ...
  public val shippingRate:
      InlinePaymentPagesCheckoutSessionShippingCostShippingRateX5b77a1d9? = null,
...
public class PaymentPagesCheckoutSessionShippingCost(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): PaymentPagesCheckoutSessionShippingCost = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<PaymentPagesCheckoutSessionShippingCost> {
    ...
    override fun deserialize(decoder: Decoder): PaymentPagesCheckoutSessionShippingCost {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("PaymentPagesCheckoutSessionShippingCost must be a JSON object")
      ...
      return PaymentPagesCheckoutSessionShippingCost(
        ...
        amountTax = amountTax,
        amountTotal = amountTotal,
        shippingRate = rawObject["shipping_rate"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlinePaymentPagesCheckoutSessionShippingCostShippingRateX5b77a1d9?>(element) },
        taxes = rawObject["taxes"]?.let { json.decodeFromJsonElement<List<LineItemsTaxAmount>>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: PaymentPagesCheckoutSessionShippingCost) {
...
public fun paymentPagesCheckoutSessionShippingCost(block: PaymentPagesCheckoutSessionShippingCost.Builder.() -> Unit): PaymentPagesCheckoutSessionShippingCost = PaymentPagesCheckoutSessionShippingCost.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("PaymentPagesCheckoutSessionShippingCost is missing required property '" + name + "'")
