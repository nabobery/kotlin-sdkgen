...
public class InlineV1QuotesPostRequestFormOnBehalfOfXd94a4d50 internal constructor(
  ...
  public val inlineV1QuotesPostRequestFormOnBehalfOfAnyOf2Xa2655a8e:
      ...
      lazy(LazyThreadSafetyMode.NONE) { if (inspection.matchesInlineV1QuotesPostRequestFormOnBehalfOfAnyOf2Xa2655a8e) json.decodeFromJsonElement<InlineV1QuotesPostRequestFormOnBehalfOfAnyOf2Xa2655a8e>(raw) else null }
  ...
  public val matchedBranches: Set<InlineV1QuotesPostRequestFormOnBehalfOfXd94a4d50Branch>
    get() = buildSet {
      ...
      if (inspection.matchesInlineV1QuotesPostRequestFormOnBehalfOfAnyOf2Xa2655a8e) add(InlineV1QuotesPostRequestFormOnBehalfOfXd94a4d50Branch.InlineV1QuotesPostRequestFormOnBehalfOfAnyOf2Xa2655a8e)
    }
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineV1QuotesPostRequestFormOnBehalfOfXd94a4d50 {
      val inspection = inspectInlineV1QuotesPostRequestFormOnBehalfOfXd94a4d50(raw)
      if (inspection.matchCount == 0) {
        throw InlineV1QuotesPostRequestFormOnBehalfOfXd94a4d50NoMatchException("InlineV1QuotesPostRequestFormOnBehalfOfXd94a4d50 matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineV1QuotesPostRequestFormOnBehalfOfXd94a4d50(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineV1QuotesPostRequestFormOnBehalfOfXd94a4d50> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1QuotesPostRequestFormOnBehalfOfXd94a4d50) {
      encoder.requireJsonEncoder("InlineV1QuotesPostRequestFormOnBehalfOfXd94a4d50").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineV1QuotesPostRequestFormOnBehalfOfXd94a4d50(element: JsonElement): InlineV1QuotesPostRequestFormOnBehalfOfXd94a4d50Inspection {
  val matchesBranch1 = element.isJsonDecodable<String>()
  val matchesInlineV1QuotesPostRequestFormOnBehalfOfAnyOf2Xa2655a8e = element.isJsonDecodable<InlineV1QuotesPostRequestFormOnBehalfOfAnyOf2Xa2655a8e>()
  return InlineV1QuotesPostRequestFormOnBehalfOfXd94a4d50Inspection(
    ...
    failures = buildList {
      ...
      if (!matchesInlineV1QuotesPostRequestFormOnBehalfOfAnyOf2Xa2655a8e) add("InlineV1QuotesPostRequestFormOnBehalfOfAnyOf2Xa2655a8e: value does not match InlineV1QuotesPostRequestFormOnBehalfOfAnyOf2Xa2655a8e")
    },
  )
}
