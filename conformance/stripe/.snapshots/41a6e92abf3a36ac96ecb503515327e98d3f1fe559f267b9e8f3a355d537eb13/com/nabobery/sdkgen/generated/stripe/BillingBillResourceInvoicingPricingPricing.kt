...
public class BillingBillResourceInvoicingPricingPricing(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): BillingBillResourceInvoicingPricingPricing = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<BillingBillResourceInvoicingPricingPricing> {
    ...
    override fun deserialize(decoder: Decoder): BillingBillResourceInvoicingPricingPricing {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("BillingBillResourceInvoicingPricingPricing must be a JSON object")
      val type = json.decodeRequired<InlineBillingBillResourceInvoicingPricingPricingTypeX8164aff2>(rawObject, "type")
      return BillingBillResourceInvoicingPricingPricing(
        type = type,
        priceDetails = rawObject["price_details"]?.let { json.decodeFromJsonElement<BillingBillResourceInvoicingPricingPricingPriceDetails>(it) },
    ...
    override fun serialize(encoder: Encoder, `value`: BillingBillResourceInvoicingPricingPricing) {
...
public fun billingBillResourceInvoicingPricingPricing(block: BillingBillResourceInvoicingPricingPricing.Builder.() -> Unit): BillingBillResourceInvoicingPricingPricing = BillingBillResourceInvoicingPricingPricing.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("BillingBillResourceInvoicingPricingPricing is missing required property '" + name + "'")
