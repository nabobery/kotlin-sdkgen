...
@Serializable
public data class PaymentLinksResourceCardRestrictionsView internal constructor(
...
public class PaymentLinksResourceCardRestrictions(
  ...
  public class Builder {
    ...
    public var brandsBlocked:
        List<InlinePaymentLinksResourceCardRestrictionsBrandsBlockedItemX01b21113>
      get() = requireNotNull(brandsBlockedValue) { "brandsBlocked is required" }.toList()
      set(`value`) {
        brandsBlockedValue = value.toList()
      }
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): PaymentLinksResourceCardRestrictions = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<PaymentLinksResourceCardRestrictions> {
    ...
    override fun deserialize(decoder: Decoder): PaymentLinksResourceCardRestrictions {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("PaymentLinksResourceCardRestrictions must be a JSON object")
      val brandsBlocked = json.decodeRequired<List<InlinePaymentLinksResourceCardRestrictionsBrandsBlockedItemX01b21113>>(rawObject, "brands_blocked")
      return PaymentLinksResourceCardRestrictions(
        brandsBlocked = brandsBlocked,
      )
    }

    override fun serialize(encoder: Encoder, `value`: PaymentLinksResourceCardRestrictions) {
...
public fun paymentLinksResourceCardRestrictions(block: PaymentLinksResourceCardRestrictions.Builder.() -> Unit): PaymentLinksResourceCardRestrictions = PaymentLinksResourceCardRestrictions.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("PaymentLinksResourceCardRestrictions is missing required property '" + name + "'")
