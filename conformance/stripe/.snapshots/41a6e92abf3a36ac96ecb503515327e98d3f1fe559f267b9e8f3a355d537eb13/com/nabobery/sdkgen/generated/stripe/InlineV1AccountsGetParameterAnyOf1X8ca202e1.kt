...
public class InlineV1AccountsGetParameterAnyOf1X8ca202e1(
  ...
  public class Builder {
    ...
    public fun build(): InlineV1AccountsGetParameterAnyOf1X8ca202e1 = InlineV1AccountsGetParameterAnyOf1X8ca202e1(
      gt = gt,
      gte = gte,
      lt = lt,
      lte = lte,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1AccountsGetParameterAnyOf1X8ca202e1 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1AccountsGetParameterAnyOf1X8ca202e1> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1AccountsGetParameterAnyOf1X8ca202e1 {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1AccountsGetParameterAnyOf1X8ca202e1 must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1AccountsGetParameterAnyOf1X8ca202e1) {
...
public fun inlineV1AccountsGetParameterAnyOf1X8ca202e1(block: InlineV1AccountsGetParameterAnyOf1X8ca202e1.Builder.() -> Unit): InlineV1AccountsGetParameterAnyOf1X8ca202e1 = InlineV1AccountsGetParameterAnyOf1X8ca202e1.build(block)
