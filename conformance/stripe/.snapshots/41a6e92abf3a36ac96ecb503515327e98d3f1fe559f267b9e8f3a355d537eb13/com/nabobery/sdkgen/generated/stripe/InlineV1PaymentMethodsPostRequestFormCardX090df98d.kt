...
public class InlineV1PaymentMethodsPostRequestFormCardX090df98d(
  ...
  public class Builder {
    ...
    public fun build(): InlineV1PaymentMethodsPostRequestFormCardX090df98d = InlineV1PaymentMethodsPostRequestFormCardX090df98d(
      expMonth = expMonth,
      expYear = expYear,
      networks = networks,
    )
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1PaymentMethodsPostRequestFormCardX090df98d = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1PaymentMethodsPostRequestFormCardX090df98d> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1PaymentMethodsPostRequestFormCardX090df98d {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1PaymentMethodsPostRequestFormCardX090df98d must be a JSON object")
      return InlineV1PaymentMethodsPostRequestFormCardX090df98d(
        ...
        networks = rawObject["networks"]?.let { json.decodeFromJsonElement<InlineV1PaymentMethodsPostRequestFormCardNetworksX8c7ffc11>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineV1PaymentMethodsPostRequestFormCardX090df98d) {
...
public fun inlineV1PaymentMethodsPostRequestFormCardX090df98d(block: InlineV1PaymentMethodsPostRequestFormCardX090df98d.Builder.() -> Unit): InlineV1PaymentMethodsPostRequestFormCardX090df98d = InlineV1PaymentMethodsPostRequestFormCardX090df98d.build(block)
