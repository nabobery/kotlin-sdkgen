...
public class RefundDestinationDetailsBlik(
  ...
  public class Builder {
    ...
    public fun build(): RefundDestinationDetailsBlik = RefundDestinationDetailsBlik(
  ...
  internal object Serializer : KSerializer<RefundDestinationDetailsBlik> {
    ...
    override fun deserialize(decoder: Decoder): RefundDestinationDetailsBlik {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("RefundDestinationDetailsBlik must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: RefundDestinationDetailsBlik) {
...
public fun refundDestinationDetailsBlik(block: RefundDestinationDetailsBlik.Builder.() -> Unit): RefundDestinationDetailsBlik = RefundDestinationDetailsBlik.build(block)
