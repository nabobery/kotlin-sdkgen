...
public class TreasuryReceivedDebitsResourceStatusTransitions(
  ...
  public class Builder {
    ...
    public fun build(): TreasuryReceivedDebitsResourceStatusTransitions = TreasuryReceivedDebitsResourceStatusTransitions(
      completedAt = completedAt,
    )
  }

  public companion object {
    public fun build(block: Builder.() -> Unit): TreasuryReceivedDebitsResourceStatusTransitions = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<TreasuryReceivedDebitsResourceStatusTransitions> {
    ...
    override fun deserialize(decoder: Decoder): TreasuryReceivedDebitsResourceStatusTransitions {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("TreasuryReceivedDebitsResourceStatusTransitions must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: TreasuryReceivedDebitsResourceStatusTransitions) {
...
public fun treasuryReceivedDebitsResourceStatusTransitions(block: TreasuryReceivedDebitsResourceStatusTransitions.Builder.() -> Unit): TreasuryReceivedDebitsResourceStatusTransitions = TreasuryReceivedDebitsResourceStatusTransitions.build(block)
