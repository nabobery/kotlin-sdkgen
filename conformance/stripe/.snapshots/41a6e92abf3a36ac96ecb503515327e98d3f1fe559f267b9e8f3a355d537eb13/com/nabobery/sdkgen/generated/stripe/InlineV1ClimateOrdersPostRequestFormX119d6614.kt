...
public class InlineV1ClimateOrdersPostRequestFormX119d6614(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1ClimateOrdersPostRequestFormX119d6614 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1ClimateOrdersPostRequestFormX119d6614> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1ClimateOrdersPostRequestFormX119d6614 {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1ClimateOrdersPostRequestFormX119d6614 must be a JSON object")
      val product = json.decodeRequired<String>(rawObject, "product")
      return InlineV1ClimateOrdersPostRequestFormX119d6614(
        product = product,
        amount = rawObject["amount"]?.let { json.decodeFromJsonElement<Int>(it) },
        beneficiary = rawObject["beneficiary"]?.let { json.decodeFromJsonElement<InlineV1ClimateOrdersPostRequestFormBeneficiaryX3f801589>(it) },
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1ClimateOrdersPostRequestFormX119d6614) {
...
public fun inlineV1ClimateOrdersPostRequestFormX119d6614(block: InlineV1ClimateOrdersPostRequestFormX119d6614.Builder.() -> Unit): InlineV1ClimateOrdersPostRequestFormX119d6614 = InlineV1ClimateOrdersPostRequestFormX119d6614.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineV1ClimateOrdersPostRequestFormX119d6614 is missing required property '" + name + "'")
