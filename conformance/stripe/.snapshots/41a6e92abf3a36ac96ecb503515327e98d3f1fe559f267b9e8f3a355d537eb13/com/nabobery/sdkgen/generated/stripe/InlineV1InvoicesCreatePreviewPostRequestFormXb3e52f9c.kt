...
public class InlineV1InvoicesCreatePreviewPostRequestFormXb3e52f9c(
  ...
  public val automaticTax:
      InlineV1InvoicesCreatePreviewPostRequestFormAutomaticTaxX6aef3e14? = null,
  /**
  ...
  invoiceItems: List<InlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemX6688a944>? = null,
  /**
   ...
   */
  public val invoiceItems:
      List<InlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemX6688a944>? =
      invoiceItems?.let { collection0 -> collection0.toList() }
  ...
  public class Builder {
    ...
    public var invoiceItems:
        List<InlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemX6688a944>?
      get() = invoiceItemsValue?.let { collection0 -> collection0.toList() }
      set(`value`) {
        invoiceItemsValue = value?.let { collection0 -> collection0.toList() }
      }
    ...
    public fun build(): InlineV1InvoicesCreatePreviewPostRequestFormXb3e52f9c = InlineV1InvoicesCreatePreviewPostRequestFormXb3e52f9c(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1InvoicesCreatePreviewPostRequestFormXb3e52f9c = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1InvoicesCreatePreviewPostRequestFormXb3e52f9c> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1InvoicesCreatePreviewPostRequestFormXb3e52f9c {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1InvoicesCreatePreviewPostRequestFormXb3e52f9c must be a JSON object")
      return InlineV1InvoicesCreatePreviewPostRequestFormXb3e52f9c(
        automaticTax = rawObject["automatic_tax"]?.let { json.decodeFromJsonElement<InlineV1InvoicesCreatePreviewPostRequestFormAutomaticTaxX6aef3e14>(it) },
        ...
        customerDetails = rawObject["customer_details"]?.let { json.decodeFromJsonElement<InlineV1InvoicesCreatePreviewPostRequestFormCustomerDetailsXf8694a9b>(it) },
        discounts = rawObject["discounts"]?.let { json.decodeFromJsonElement<InlineV1InvoicesCreatePreviewPostRequestFormDiscountsXfa7616a1>(it) },
        expand = rawObject["expand"]?.let { json.decodeFromJsonElement<List<String>>(it) },
        invoiceItems = rawObject["invoice_items"]?.let { json.decodeFromJsonElement<List<InlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemX6688a944>>(it) },
        issuer = rawObject["issuer"]?.let { json.decodeFromJsonElement<InlineV1InvoicesCreatePreviewPostRequestFormIssuerX5af905ce>(it) },
        onBehalfOf = rawObject["on_behalf_of"]?.let { json.decodeFromJsonElement<InlineV1InvoicesCreatePreviewPostRequestFormOnBehalfOfXaae62e86>(it) },
        previewMode = rawObject["preview_mode"]?.let { json.decodeFromJsonElement<InlineV1InvoicesCreatePreviewPostRequestFormPreviewModeXcb77da30>(it) },
        schedule = rawObject["schedule"]?.let { json.decodeFromJsonElement<String>(it) },
        scheduleDetails = rawObject["schedule_details"]?.let { json.decodeFromJsonElement<InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsXad6636e1>(it) },
        subscription = rawObject["subscription"]?.let { json.decodeFromJsonElement<String>(it) },
        subscriptionDetails = rawObject["subscription_details"]?.let { json.decodeFromJsonElement<InlineV1InvoicesCreatePreviewPostRequestFormSubscriptionDetailsXd72553af>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineV1InvoicesCreatePreviewPostRequestFormXb3e52f9c) {
...
public fun inlineV1InvoicesCreatePreviewPostRequestFormXb3e52f9c(block: InlineV1InvoicesCreatePreviewPostRequestFormXb3e52f9c.Builder.() -> Unit): InlineV1InvoicesCreatePreviewPostRequestFormXb3e52f9c = InlineV1InvoicesCreatePreviewPostRequestFormXb3e52f9c.build(block)
