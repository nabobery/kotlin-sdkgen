...
public class InlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsXc9278c34(
  ...
  public class Builder {
    ...
    public fun build(): InlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsXc9278c34 = InlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsXc9278c34(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsXc9278c34 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsXc9278c34> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsXc9278c34 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsXc9278c34")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsXc9278c34 must be a JSON object")
      return InlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsXc9278c34(
        ...
        automaticTax = rawObject["automatic_tax"]?.let { json.decodeFromJsonElement<InlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsAutomaticTaxX152f9007>(it) },
        billingCycleAnchor = rawObject["billing_cycle_anchor"]?.let { json.decodeFromJsonElement<InlineV1SubscriptionSchedulesPostRequestFormBillingCycleAnchorX23a66ba8>(it) },
        billingThresholds = rawObject["billing_thresholds"]?.let { json.decodeFromJsonElement<InlineV1SubscriptionSchedulesPostRequestFormBillingThresholdsXa93dc2fd>(it) },
        collectionMethod = rawObject["collection_method"]?.let { json.decodeFromJsonElement<InlineV1SubscriptionSchedulesPostRequestFormCollectionMethodX28bdbe08>(it) },
        defaultPaymentMethod = rawObject["default_payment_method"]?.let { json.decodeFromJsonElement<String>(it) },
        description = rawObject["description"]?.let { json.decodeFromJsonElement<InlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsDescriptionXff776e47>(it) },
        invoiceSettings = rawObject["invoice_settings"]?.let { json.decodeFromJsonElement<InlineV1SubscriptionSchedulesPostRequestFormInvoiceSettingsX59d4bd29>(it) },
        onBehalfOf = rawObject["on_behalf_of"]?.let { json.decodeFromJsonElement<InlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsOnBehalfOfX63a18718>(it) },
        transferData = rawObject["transfer_data"]?.let { json.decodeFromJsonElement<InlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsTransferDataXcd7220f1>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsXc9278c34) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsXc9278c34")
...
public fun inlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsXc9278c34(block: InlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsXc9278c34.Builder.() -> Unit): InlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsXc9278c34 = InlineV1SubscriptionSchedulesPostRequestFormDefaultSettingsXc9278c34.build(block)
