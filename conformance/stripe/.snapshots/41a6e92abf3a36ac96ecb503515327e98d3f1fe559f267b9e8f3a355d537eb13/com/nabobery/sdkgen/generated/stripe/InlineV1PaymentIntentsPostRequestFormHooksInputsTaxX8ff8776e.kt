...
public class InlineV1PaymentIntentsPostRequestFormHooksInputsTaxX8ff8776e(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1PaymentIntentsPostRequestFormHooksInputsTaxX8ff8776e = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormHooksInputsTaxX8ff8776e> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1PaymentIntentsPostRequestFormHooksInputsTaxX8ff8776e {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1PaymentIntentsPostRequestFormHooksInputsTaxX8ff8776e must be a JSON object")
      val calculation = json.decodeRequired<InlineV1PaymentIntentsPostRequestFormHooksInputsTaxCalculationX645188b1>(rawObject, "calculation")
      return InlineV1PaymentIntentsPostRequestFormHooksInputsTaxX8ff8776e(
        calculation = calculation,
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineV1PaymentIntentsPostRequestFormHooksInputsTaxX8ff8776e) {
...
public fun inlineV1PaymentIntentsPostRequestFormHooksInputsTaxX8ff8776e(block: InlineV1PaymentIntentsPostRequestFormHooksInputsTaxX8ff8776e.Builder.() -> Unit): InlineV1PaymentIntentsPostRequestFormHooksInputsTaxX8ff8776e = InlineV1PaymentIntentsPostRequestFormHooksInputsTaxX8ff8776e.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineV1PaymentIntentsPostRequestFormHooksInputsTaxX8ff8776e is missing required property '" + name + "'")
