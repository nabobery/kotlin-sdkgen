...
public class LegalEntityCompanyVerification(
  ...
  internal object Serializer : KSerializer<LegalEntityCompanyVerification> {
    ...
    override fun deserialize(decoder: Decoder): LegalEntityCompanyVerification {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("LegalEntityCompanyVerification must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: LegalEntityCompanyVerification) {
...
public fun legalEntityCompanyVerification(block: LegalEntityCompanyVerification.Builder.() -> Unit): LegalEntityCompanyVerification = LegalEntityCompanyVerification.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("LegalEntityCompanyVerification is missing required property '" + name + "'")
