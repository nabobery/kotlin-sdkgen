...
public class InlineV1IssuingDisputesGetParameterX942b23d5 internal constructor(
  ...
  public val inlineV1IssuingDisputesGetParameterAnyOf1X95b9516d:
      ...
      lazy(LazyThreadSafetyMode.NONE) { if (inspection.matchesInlineV1IssuingDisputesGetParameterAnyOf1X95b9516d) json.decodeFromJsonElement<InlineV1IssuingDisputesGetParameterAnyOf1X95b9516d>(raw) else null }
  ...
  public val matchedBranches: Set<InlineV1IssuingDisputesGetParameterX942b23d5Branch>
    get() = buildSet {
      if (inspection.matchesInlineV1IssuingDisputesGetParameterAnyOf1X95b9516d) add(InlineV1IssuingDisputesGetParameterX942b23d5Branch.InlineV1IssuingDisputesGetParameterAnyOf1X95b9516d)
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineV1IssuingDisputesGetParameterX942b23d5 {
      val inspection = inspectInlineV1IssuingDisputesGetParameterX942b23d5(raw)
      if (inspection.matchCount == 0) {
        throw InlineV1IssuingDisputesGetParameterX942b23d5NoMatchException("InlineV1IssuingDisputesGetParameterX942b23d5 matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineV1IssuingDisputesGetParameterX942b23d5(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineV1IssuingDisputesGetParameterX942b23d5> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1IssuingDisputesGetParameterX942b23d5) {
      encoder.requireJsonEncoder("InlineV1IssuingDisputesGetParameterX942b23d5").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineV1IssuingDisputesGetParameterX942b23d5(element: JsonElement): InlineV1IssuingDisputesGetParameterX942b23d5Inspection {
  val matchesInlineV1IssuingDisputesGetParameterAnyOf1X95b9516d = element.isJsonDecodable<InlineV1IssuingDisputesGetParameterAnyOf1X95b9516d>()
  ...
  return InlineV1IssuingDisputesGetParameterX942b23d5Inspection(
    ...
    failures = buildList {
      if (!matchesInlineV1IssuingDisputesGetParameterAnyOf1X95b9516d) add("InlineV1IssuingDisputesGetParameterAnyOf1X95b9516d: value does not match InlineV1IssuingDisputesGetParameterAnyOf1X95b9516d")
