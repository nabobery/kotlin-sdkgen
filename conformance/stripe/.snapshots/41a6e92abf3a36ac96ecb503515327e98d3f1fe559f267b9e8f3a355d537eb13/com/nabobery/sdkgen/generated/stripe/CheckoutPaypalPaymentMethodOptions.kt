...
public class CheckoutPaypalPaymentMethodOptions(
  ...
  public val setupFutureUsage:
      InlineCheckoutPaypalPaymentMethodOptionsSetupFutureUsageXac29268b? = null,
) {
  public class Builder {
    ...
    public fun build(): CheckoutPaypalPaymentMethodOptions = CheckoutPaypalPaymentMethodOptions(
  ...
  internal object Serializer : KSerializer<CheckoutPaypalPaymentMethodOptions> {
    ...
    override fun deserialize(decoder: Decoder): CheckoutPaypalPaymentMethodOptions {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("CheckoutPaypalPaymentMethodOptions must be a JSON object")
      return CheckoutPaypalPaymentMethodOptions(
        captureMethod = rawObject["capture_method"]?.let { json.decodeFromJsonElement<InlineCheckoutPaypalPaymentMethodOptionsCaptureMethodX3cb2a332>(it) },
        ...
        setupFutureUsage = rawObject["setup_future_usage"]?.let { json.decodeFromJsonElement<InlineCheckoutPaypalPaymentMethodOptionsSetupFutureUsageXac29268b>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: CheckoutPaypalPaymentMethodOptions) {
...
public fun checkoutPaypalPaymentMethodOptions(block: CheckoutPaypalPaymentMethodOptions.Builder.() -> Unit): CheckoutPaypalPaymentMethodOptions = CheckoutPaypalPaymentMethodOptions.build(block)
