...
public class InlineStackableDiscountWithDiscountSettingsCouponX2c37183c internal constructor(
  ...
  public val matchedBranches: Set<InlineStackableDiscountWithDiscountSettingsCouponX2c37183cBranch>
    get() = buildSet {
      if (inspection.matchesBranch1) add(InlineStackableDiscountWithDiscountSettingsCouponX2c37183cBranch.Branch1)
      if (inspection.matchesCoupon) add(InlineStackableDiscountWithDiscountSettingsCouponX2c37183cBranch.Coupon)
    }
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineStackableDiscountWithDiscountSettingsCouponX2c37183c {
      val inspection = inspectInlineStackableDiscountWithDiscountSettingsCouponX2c37183c(raw)
      if (inspection.matchCount == 0) {
        throw InlineStackableDiscountWithDiscountSettingsCouponX2c37183cNoMatchException("InlineStackableDiscountWithDiscountSettingsCouponX2c37183c matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineStackableDiscountWithDiscountSettingsCouponX2c37183c(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineStackableDiscountWithDiscountSettingsCouponX2c37183c> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineStackableDiscountWithDiscountSettingsCouponX2c37183c) {
      encoder.requireJsonEncoder("InlineStackableDiscountWithDiscountSettingsCouponX2c37183c").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineStackableDiscountWithDiscountSettingsCouponX2c37183c(element: JsonElement): InlineStackableDiscountWithDiscountSettingsCouponX2c37183cInspection {
