...
public class PaymentMethodAcssDebit(
  ...
  public class Builder {
    ...
    public fun build(): PaymentMethodAcssDebit = PaymentMethodAcssDebit(
      bankName = bankName,
  ...
  internal object Serializer : KSerializer<PaymentMethodAcssDebit> {
    ...
    override fun deserialize(decoder: Decoder): PaymentMethodAcssDebit {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("PaymentMethodAcssDebit must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: PaymentMethodAcssDebit) {
...
public fun paymentMethodAcssDebit(block: PaymentMethodAcssDebit.Builder.() -> Unit): PaymentMethodAcssDebit = PaymentMethodAcssDebit.build(block)
