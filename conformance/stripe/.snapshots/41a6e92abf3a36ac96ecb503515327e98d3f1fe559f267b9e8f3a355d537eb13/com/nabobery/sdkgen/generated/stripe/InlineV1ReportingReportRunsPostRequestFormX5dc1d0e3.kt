...
public class InlineV1ReportingReportRunsPostRequestFormX5dc1d0e3(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1ReportingReportRunsPostRequestFormX5dc1d0e3 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1ReportingReportRunsPostRequestFormX5dc1d0e3> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1ReportingReportRunsPostRequestFormX5dc1d0e3 {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1ReportingReportRunsPostRequestFormX5dc1d0e3 must be a JSON object")
      val reportType = json.decodeRequired<String>(rawObject, "report_type")
      return InlineV1ReportingReportRunsPostRequestFormX5dc1d0e3(
        reportType = reportType,
        expand = rawObject["expand"]?.let { json.decodeFromJsonElement<List<String>>(it) },
        parameters = rawObject["parameters"]?.let { json.decodeFromJsonElement<InlineV1ReportingReportRunsPostRequestFormParametersX2d2199bf>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineV1ReportingReportRunsPostRequestFormX5dc1d0e3) {
...
public fun inlineV1ReportingReportRunsPostRequestFormX5dc1d0e3(block: InlineV1ReportingReportRunsPostRequestFormX5dc1d0e3.Builder.() -> Unit): InlineV1ReportingReportRunsPostRequestFormX5dc1d0e3 = InlineV1ReportingReportRunsPostRequestFormX5dc1d0e3.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineV1ReportingReportRunsPostRequestFormX5dc1d0e3 is missing required property '" + name + "'")
