...
public class CustomerTaxLocation(
  ...
  internal object Serializer : KSerializer<CustomerTaxLocation> {
    ...
    override fun deserialize(decoder: Decoder): CustomerTaxLocation {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("CustomerTaxLocation must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: CustomerTaxLocation) {
...
public fun customerTaxLocation(block: CustomerTaxLocation.Builder.() -> Unit): CustomerTaxLocation = CustomerTaxLocation.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("CustomerTaxLocation is missing required property '" + name + "'")
