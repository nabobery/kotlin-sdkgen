...
public class InlineV1SourcesPostRequestFormMandateX2f4d7dcf(
  ...
  public val notificationMethod:
      InlineV1SourcesPostRequestFormMandateNotificationMethodX084b2c70? = null,
) {
  public class Builder {
    ...
    public fun build(): InlineV1SourcesPostRequestFormMandateX2f4d7dcf = InlineV1SourcesPostRequestFormMandateX2f4d7dcf(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1SourcesPostRequestFormMandateX2f4d7dcf = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1SourcesPostRequestFormMandateX2f4d7dcf> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1SourcesPostRequestFormMandateX2f4d7dcf {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1SourcesPostRequestFormMandateX2f4d7dcf must be a JSON object")
      return InlineV1SourcesPostRequestFormMandateX2f4d7dcf(
        acceptance = rawObject["acceptance"]?.let { json.decodeFromJsonElement<InlineV1SourcesPostRequestFormMandateAcceptanceX55fac191>(it) },
        amount = rawObject["amount"]?.let { json.decodeFromJsonElement<InlineV1SourcesPostRequestFormMandateAmountXabd4847d>(it) },
        currency = rawObject["currency"]?.let { json.decodeFromJsonElement<String>(it) },
        interval = rawObject["interval"]?.let { json.decodeFromJsonElement<InlineV1SourcesPostRequestFormMandateIntervalX63e53acc>(it) },
        notificationMethod = rawObject["notification_method"]?.let { json.decodeFromJsonElement<InlineV1SourcesPostRequestFormMandateNotificationMethodX084b2c70>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineV1SourcesPostRequestFormMandateX2f4d7dcf) {
...
public fun inlineV1SourcesPostRequestFormMandateX2f4d7dcf(block: InlineV1SourcesPostRequestFormMandateX2f4d7dcf.Builder.() -> Unit): InlineV1SourcesPostRequestFormMandateX2f4d7dcf = InlineV1SourcesPostRequestFormMandateX2f4d7dcf.build(block)
