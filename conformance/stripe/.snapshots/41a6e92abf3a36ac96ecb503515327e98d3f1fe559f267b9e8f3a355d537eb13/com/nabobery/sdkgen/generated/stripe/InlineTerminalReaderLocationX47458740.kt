...
public class InlineTerminalReaderLocationX47458740 internal constructor(
  ...
  public val terminalLocation: TerminalLocation? by
      lazy(LazyThreadSafetyMode.NONE) { if (inspection.matchesTerminalLocation) json.decodeFromJsonElement<TerminalLocation>(raw) else null }
  ...
  public val matchedBranches: Set<InlineTerminalReaderLocationX47458740Branch>
    get() = buildSet {
      ...
      if (inspection.matchesTerminalLocation) add(InlineTerminalReaderLocationX47458740Branch.TerminalLocation)
    }
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineTerminalReaderLocationX47458740 {
      val inspection = inspectInlineTerminalReaderLocationX47458740(raw)
      if (inspection.matchCount == 0) {
        throw InlineTerminalReaderLocationX47458740NoMatchException("InlineTerminalReaderLocationX47458740 matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineTerminalReaderLocationX47458740(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineTerminalReaderLocationX47458740> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineTerminalReaderLocationX47458740) {
      encoder.requireJsonEncoder("InlineTerminalReaderLocationX47458740").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineTerminalReaderLocationX47458740(element: JsonElement): InlineTerminalReaderLocationX47458740Inspection {
