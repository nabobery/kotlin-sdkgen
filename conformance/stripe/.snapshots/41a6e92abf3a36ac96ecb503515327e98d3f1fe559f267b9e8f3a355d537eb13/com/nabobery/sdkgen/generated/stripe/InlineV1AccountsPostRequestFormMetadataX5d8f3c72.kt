...
public class InlineV1AccountsPostRequestFormMetadataX5d8f3c72 internal constructor(
  ...
  public val inlineV1AccountsPostRequestFormMetadataAnyOf2X6609aeec:
      ...
      lazy(LazyThreadSafetyMode.NONE) { if (inspection.matchesInlineV1AccountsPostRequestFormMetadataAnyOf2X6609aeec) json.decodeFromJsonElement<InlineV1AccountsPostRequestFormMetadataAnyOf2X6609aeec>(raw) else null }
  ...
  public val matchedBranches: Set<InlineV1AccountsPostRequestFormMetadataX5d8f3c72Branch>
    get() = buildSet {
      ...
      if (inspection.matchesInlineV1AccountsPostRequestFormMetadataAnyOf2X6609aeec) add(InlineV1AccountsPostRequestFormMetadataX5d8f3c72Branch.InlineV1AccountsPostRequestFormMetadataAnyOf2X6609aeec)
    }
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineV1AccountsPostRequestFormMetadataX5d8f3c72 {
      val inspection = inspectInlineV1AccountsPostRequestFormMetadataX5d8f3c72(raw)
      if (inspection.matchCount == 0) {
        throw InlineV1AccountsPostRequestFormMetadataX5d8f3c72NoMatchException("InlineV1AccountsPostRequestFormMetadataX5d8f3c72 matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineV1AccountsPostRequestFormMetadataX5d8f3c72(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineV1AccountsPostRequestFormMetadataX5d8f3c72> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1AccountsPostRequestFormMetadataX5d8f3c72) {
      encoder.requireJsonEncoder("InlineV1AccountsPostRequestFormMetadataX5d8f3c72").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineV1AccountsPostRequestFormMetadataX5d8f3c72(element: JsonElement): InlineV1AccountsPostRequestFormMetadataX5d8f3c72Inspection {
  val matchesBranch1 = element.isJsonDecodable<JsonObject>()
  val matchesInlineV1AccountsPostRequestFormMetadataAnyOf2X6609aeec = element.isJsonDecodable<InlineV1AccountsPostRequestFormMetadataAnyOf2X6609aeec>()
  return InlineV1AccountsPostRequestFormMetadataX5d8f3c72Inspection(
    ...
    failures = buildList {
      ...
      if (!matchesInlineV1AccountsPostRequestFormMetadataAnyOf2X6609aeec) add("InlineV1AccountsPostRequestFormMetadataAnyOf2X6609aeec: value does not match InlineV1AccountsPostRequestFormMetadataAnyOf2X6609aeec")
    },
  )
}
