...
public class InvoicePaymentMethodOptionsPayto(
  ...
  public class Builder {
    ...
    public fun build(): InvoicePaymentMethodOptionsPayto = InvoicePaymentMethodOptionsPayto(
  ...
  internal object Serializer : KSerializer<InvoicePaymentMethodOptionsPayto> {
    ...
    override fun deserialize(decoder: Decoder): InvoicePaymentMethodOptionsPayto {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InvoicePaymentMethodOptionsPayto must be a JSON object")
      return InvoicePaymentMethodOptionsPayto(
        mandateOptions = rawObject["mandate_options"]?.let { json.decodeFromJsonElement<InvoiceMandateOptionsPayto>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InvoicePaymentMethodOptionsPayto) {
...
public fun invoicePaymentMethodOptionsPayto(block: InvoicePaymentMethodOptionsPayto.Builder.() -> Unit): InvoicePaymentMethodOptionsPayto = InvoicePaymentMethodOptionsPayto.build(block)
