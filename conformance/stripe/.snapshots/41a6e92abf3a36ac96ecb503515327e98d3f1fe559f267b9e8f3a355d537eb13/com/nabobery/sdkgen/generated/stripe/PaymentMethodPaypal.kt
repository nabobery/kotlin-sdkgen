...
public class PaymentMethodPaypal(
  ...
  public class Builder {
    ...
    public fun build(): PaymentMethodPaypal = PaymentMethodPaypal(
      country = country,
  ...
  internal object Serializer : KSerializer<PaymentMethodPaypal> {
    ...
    override fun deserialize(decoder: Decoder): PaymentMethodPaypal {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("PaymentMethodPaypal must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: PaymentMethodPaypal) {
...
public fun paymentMethodPaypal(block: PaymentMethodPaypal.Builder.() -> Unit): PaymentMethodPaypal = PaymentMethodPaypal.build(block)
