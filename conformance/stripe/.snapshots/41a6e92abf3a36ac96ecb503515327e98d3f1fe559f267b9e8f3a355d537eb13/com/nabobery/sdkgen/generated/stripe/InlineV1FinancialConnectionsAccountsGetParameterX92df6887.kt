...
public class InlineV1FinancialConnectionsAccountsGetParameterX92df6887(
  ...
  public class Builder {
    ...
    public fun build(): InlineV1FinancialConnectionsAccountsGetParameterX92df6887 = InlineV1FinancialConnectionsAccountsGetParameterX92df6887(
      account = account,
      customer = customer,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1FinancialConnectionsAccountsGetParameterX92df6887 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1FinancialConnectionsAccountsGetParameterX92df6887> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1FinancialConnectionsAccountsGetParameterX92df6887 {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1FinancialConnectionsAccountsGetParameterX92df6887 must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1FinancialConnectionsAccountsGetParameterX92df6887) {
...
public fun inlineV1FinancialConnectionsAccountsGetParameterX92df6887(block: InlineV1FinancialConnectionsAccountsGetParameterX92df6887.Builder.() -> Unit): InlineV1FinancialConnectionsAccountsGetParameterX92df6887 = InlineV1FinancialConnectionsAccountsGetParameterX92df6887.build(block)
