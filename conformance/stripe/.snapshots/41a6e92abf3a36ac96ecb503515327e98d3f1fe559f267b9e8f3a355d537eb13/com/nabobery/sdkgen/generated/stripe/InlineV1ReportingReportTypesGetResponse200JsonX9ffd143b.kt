...
public class InlineV1ReportingReportTypesGetResponse200JsonX9ffd143b(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1ReportingReportTypesGetResponse200JsonX9ffd143b = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1ReportingReportTypesGetResponse200JsonX9ffd143b> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1ReportingReportTypesGetResponse200JsonX9ffd143b {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1ReportingReportTypesGetResponse200JsonX9ffd143b must be a JSON object")
      ...
      val objectValue = json.decodeRequired<InlineV1ReportingReportTypesGetResponse200JsonObjectValueX674dca2e>(rawObject, "object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1ReportingReportTypesGetResponse200JsonX9ffd143b) {
...
public fun inlineV1ReportingReportTypesGetResponse200JsonX9ffd143b(block: InlineV1ReportingReportTypesGetResponse200JsonX9ffd143b.Builder.() -> Unit): InlineV1ReportingReportTypesGetResponse200JsonX9ffd143b = InlineV1ReportingReportTypesGetResponse200JsonX9ffd143b.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineV1ReportingReportTypesGetResponse200JsonX9ffd143b is missing required property '" + name + "'")
