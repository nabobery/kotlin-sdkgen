...
public class InlineV1CustomersBankAccountsPostRequestFormOwnerAddressXabd159b3(
  ...
  public class Builder {
    ...
    public fun build(): InlineV1CustomersBankAccountsPostRequestFormOwnerAddressXabd159b3 = InlineV1CustomersBankAccountsPostRequestFormOwnerAddressXabd159b3(
      city = city,
      country = country,
      line1 = line1,
      line2 = line2,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1CustomersBankAccountsPostRequestFormOwnerAddressXabd159b3 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1CustomersBankAccountsPostRequestFormOwnerAddressXabd159b3> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineV1CustomersBankAccountsPostRequestFormOwnerAddressXabd159b3 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineV1CustomersBankAccountsPostRequestFormOwnerAddressXabd159b3")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1CustomersBankAccountsPostRequestFormOwnerAddressXabd159b3 must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1CustomersBankAccountsPostRequestFormOwnerAddressXabd159b3) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineV1CustomersBankAccountsPostRequestFormOwnerAddressXabd159b3")
...
public fun inlineV1CustomersBankAccountsPostRequestFormOwnerAddressXabd159b3(block: InlineV1CustomersBankAccountsPostRequestFormOwnerAddressXabd159b3.Builder.() -> Unit): InlineV1CustomersBankAccountsPostRequestFormOwnerAddressXabd159b3 = InlineV1CustomersBankAccountsPostRequestFormOwnerAddressXabd159b3.build(block)
