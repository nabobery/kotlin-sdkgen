...
public class InlineV1AccountsPersonsPostRequestFormXac89d14a(
  ...
  public val fullNameAliases:
      InlineV1AccountsPersonsPostRequestFormFullNameAliasesXd6b9b76c? = null,
  /**
  ...
  public val politicalExposure:
      InlineV1AccountsPersonsPostRequestFormPoliticalExposureX08215856? = null,
  /**
   * The person's registered address.
   */
  public val registeredAddress:
      InlineV1AccountsPersonsPostRequestFormRegisteredAddressXf4dc3d90? = null,
  /**
  ...
  public class Builder {
    ...
    public fun build(): InlineV1AccountsPersonsPostRequestFormXac89d14a = InlineV1AccountsPersonsPostRequestFormXac89d14a(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1AccountsPersonsPostRequestFormXac89d14a = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1AccountsPersonsPostRequestFormXac89d14a> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1AccountsPersonsPostRequestFormXac89d14a {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1AccountsPersonsPostRequestFormXac89d14a must be a JSON object")
      return InlineV1AccountsPersonsPostRequestFormXac89d14a(
        additionalTosAcceptances = rawObject["additional_tos_acceptances"]?.let { json.decodeFromJsonElement<InlineV1AccountsPersonsPostRequestFormAdditionalTosAcceptancesX16254309>(it) },
        address = rawObject["address"]?.let { json.decodeFromJsonElement<InlineV1AccountsPersonsPostRequestFormAddressX03169b8a>(it) },
        addressKana = rawObject["address_kana"]?.let { json.decodeFromJsonElement<InlineV1AccountsPersonsPostRequestFormAddressKanaX89336ca2>(it) },
        addressKanji = rawObject["address_kanji"]?.let { json.decodeFromJsonElement<InlineV1AccountsPersonsPostRequestFormAddressKanjiX4b4a5d2a>(it) },
        dob = rawObject["dob"]?.let { json.decodeFromJsonElement<InlineV1AccountsPersonsPostRequestFormDobX92545eee>(it) },
        documents = rawObject["documents"]?.let { json.decodeFromJsonElement<InlineV1AccountsPersonsPostRequestFormDocumentsXda797a7a>(it) },
        ...
        fullNameAliases = rawObject["full_name_aliases"]?.let { json.decodeFromJsonElement<InlineV1AccountsPersonsPostRequestFormFullNameAliasesXd6b9b76c>(it) },
        ...
        metadata = rawObject["metadata"]?.let { json.decodeFromJsonElement<InlineV1AccountsPersonsPostRequestFormMetadataXbb7ab64e>(it) },
        ...
        politicalExposure = rawObject["political_exposure"]?.let { json.decodeFromJsonElement<InlineV1AccountsPersonsPostRequestFormPoliticalExposureX08215856>(it) },
        registeredAddress = rawObject["registered_address"]?.let { json.decodeFromJsonElement<InlineV1AccountsPersonsPostRequestFormRegisteredAddressXf4dc3d90>(it) },
        relationship = rawObject["relationship"]?.let { json.decodeFromJsonElement<InlineV1AccountsPersonsPostRequestFormRelationshipX6fd2dab7>(it) },
        ssnLast4 = rawObject["ssn_last_4"]?.let { json.decodeFromJsonElement<String>(it) },
        usCfpbData = rawObject["us_cfpb_data"]?.let { json.decodeFromJsonElement<InlineV1AccountsPersonsPostRequestFormUsCfpbDataX1bf5a9a3>(it) },
        verification = rawObject["verification"]?.let { json.decodeFromJsonElement<InlineV1AccountsPersonsPostRequestFormVerificationX56400555>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineV1AccountsPersonsPostRequestFormXac89d14a) {
...
public fun inlineV1AccountsPersonsPostRequestFormXac89d14a(block: InlineV1AccountsPersonsPostRequestFormXac89d14a.Builder.() -> Unit): InlineV1AccountsPersonsPostRequestFormXac89d14a = InlineV1AccountsPersonsPostRequestFormXac89d14a.build(block)
