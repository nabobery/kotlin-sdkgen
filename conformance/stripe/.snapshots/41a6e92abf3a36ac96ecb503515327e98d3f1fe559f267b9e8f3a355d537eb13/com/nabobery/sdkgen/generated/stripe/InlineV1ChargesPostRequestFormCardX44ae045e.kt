...
public class InlineV1ChargesPostRequestFormCardX44ae045e internal constructor(
  ...
  public val inlineV1ChargesPostRequestFormCardAnyOf1X47b2c78d:
      ...
      lazy(LazyThreadSafetyMode.NONE) { if (inspection.matchesInlineV1ChargesPostRequestFormCardAnyOf1X47b2c78d) json.decodeFromJsonElement<InlineV1ChargesPostRequestFormCardAnyOf1X47b2c78d>(raw) else null }
  ...
  public val matchedBranches: Set<InlineV1ChargesPostRequestFormCardX44ae045eBranch>
    get() = buildSet {
      if (inspection.matchesInlineV1ChargesPostRequestFormCardAnyOf1X47b2c78d) add(InlineV1ChargesPostRequestFormCardX44ae045eBranch.InlineV1ChargesPostRequestFormCardAnyOf1X47b2c78d)
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineV1ChargesPostRequestFormCardX44ae045e {
      val inspection = inspectInlineV1ChargesPostRequestFormCardX44ae045e(raw)
      if (inspection.matchCount == 0) {
        throw InlineV1ChargesPostRequestFormCardX44ae045eNoMatchException("InlineV1ChargesPostRequestFormCardX44ae045e matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineV1ChargesPostRequestFormCardX44ae045e(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineV1ChargesPostRequestFormCardX44ae045e> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1ChargesPostRequestFormCardX44ae045e) {
      encoder.requireJsonEncoder("InlineV1ChargesPostRequestFormCardX44ae045e").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineV1ChargesPostRequestFormCardX44ae045e(element: JsonElement): InlineV1ChargesPostRequestFormCardX44ae045eInspection {
  val matchesInlineV1ChargesPostRequestFormCardAnyOf1X47b2c78d = element.isJsonDecodable<InlineV1ChargesPostRequestFormCardAnyOf1X47b2c78d>()
  ...
  return InlineV1ChargesPostRequestFormCardX44ae045eInspection(
    ...
    failures = buildList {
      if (!matchesInlineV1ChargesPostRequestFormCardAnyOf1X47b2c78d) add("InlineV1ChargesPostRequestFormCardAnyOf1X47b2c78d: value does not match InlineV1ChargesPostRequestFormCardAnyOf1X47b2c78d")
