...
public class InlineV1CustomersPostRequestFormTaxIpAddressX92883f53 internal constructor(
  ...
  public val inlineV1CustomersPostRequestFormTaxIpAddressAnyOf2X2f07647d:
      ...
      lazy(LazyThreadSafetyMode.NONE) { if (inspection.matchesInlineV1CustomersPostRequestFormTaxIpAddressAnyOf2X2f07647d) json.decodeFromJsonElement<InlineV1CustomersPostRequestFormTaxIpAddressAnyOf2X2f07647d>(raw) else null }
  ...
  public val matchedBranches: Set<InlineV1CustomersPostRequestFormTaxIpAddressX92883f53Branch>
    get() = buildSet {
      ...
      if (inspection.matchesInlineV1CustomersPostRequestFormTaxIpAddressAnyOf2X2f07647d) add(InlineV1CustomersPostRequestFormTaxIpAddressX92883f53Branch.InlineV1CustomersPostRequestFormTaxIpAddressAnyOf2X2f07647d)
    }
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineV1CustomersPostRequestFormTaxIpAddressX92883f53 {
      val inspection = inspectInlineV1CustomersPostRequestFormTaxIpAddressX92883f53(raw)
      if (inspection.matchCount == 0) {
        throw InlineV1CustomersPostRequestFormTaxIpAddressX92883f53NoMatchException("InlineV1CustomersPostRequestFormTaxIpAddressX92883f53 matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineV1CustomersPostRequestFormTaxIpAddressX92883f53(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineV1CustomersPostRequestFormTaxIpAddressX92883f53> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1CustomersPostRequestFormTaxIpAddressX92883f53) {
      encoder.requireJsonEncoder("InlineV1CustomersPostRequestFormTaxIpAddressX92883f53").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineV1CustomersPostRequestFormTaxIpAddressX92883f53(element: JsonElement): InlineV1CustomersPostRequestFormTaxIpAddressX92883f53Inspection {
  val matchesBranch1 = element.isJsonDecodable<String>()
  val matchesInlineV1CustomersPostRequestFormTaxIpAddressAnyOf2X2f07647d = element.isJsonDecodable<InlineV1CustomersPostRequestFormTaxIpAddressAnyOf2X2f07647d>()
  return InlineV1CustomersPostRequestFormTaxIpAddressX92883f53Inspection(
    ...
    failures = buildList {
      ...
      if (!matchesInlineV1CustomersPostRequestFormTaxIpAddressAnyOf2X2f07647d) add("InlineV1CustomersPostRequestFormTaxIpAddressAnyOf2X2f07647d: value does not match InlineV1CustomersPostRequestFormTaxIpAddressAnyOf2X2f07647d")
    },
  )
}
