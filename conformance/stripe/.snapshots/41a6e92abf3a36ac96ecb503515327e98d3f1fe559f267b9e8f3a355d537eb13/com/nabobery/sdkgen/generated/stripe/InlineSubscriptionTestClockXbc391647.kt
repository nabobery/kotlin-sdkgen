...
public class InlineSubscriptionTestClockXbc391647 internal constructor(
  ...
  public val matchedBranches: Set<InlineSubscriptionTestClockXbc391647Branch>
    get() = buildSet {
      ...
      if (inspection.matchesTestHelpersTestClock) add(InlineSubscriptionTestClockXbc391647Branch.TestHelpersTestClock)
    }
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineSubscriptionTestClockXbc391647 {
      val inspection = inspectInlineSubscriptionTestClockXbc391647(raw)
      if (inspection.matchCount == 0) {
        throw InlineSubscriptionTestClockXbc391647NoMatchException("InlineSubscriptionTestClockXbc391647 matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineSubscriptionTestClockXbc391647(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineSubscriptionTestClockXbc391647> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineSubscriptionTestClockXbc391647) {
      encoder.requireJsonEncoder("InlineSubscriptionTestClockXbc391647").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineSubscriptionTestClockXbc391647(element: JsonElement): InlineSubscriptionTestClockXbc391647Inspection {
