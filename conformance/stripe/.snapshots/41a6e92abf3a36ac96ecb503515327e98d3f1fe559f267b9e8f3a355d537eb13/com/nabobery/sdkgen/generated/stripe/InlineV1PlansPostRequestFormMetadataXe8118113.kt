...
public class InlineV1PlansPostRequestFormMetadataXe8118113 internal constructor(
  ...
  public val inlineV1PlansPostRequestFormMetadataAnyOf2X8a4e8f7a:
      ...
      lazy(LazyThreadSafetyMode.NONE) { if (inspection.matchesInlineV1PlansPostRequestFormMetadataAnyOf2X8a4e8f7a) json.decodeFromJsonElement<InlineV1PlansPostRequestFormMetadataAnyOf2X8a4e8f7a>(raw) else null }
  ...
  public val matchedBranches: Set<InlineV1PlansPostRequestFormMetadataXe8118113Branch>
    get() = buildSet {
      ...
      if (inspection.matchesInlineV1PlansPostRequestFormMetadataAnyOf2X8a4e8f7a) add(InlineV1PlansPostRequestFormMetadataXe8118113Branch.InlineV1PlansPostRequestFormMetadataAnyOf2X8a4e8f7a)
    }
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineV1PlansPostRequestFormMetadataXe8118113 {
      val inspection = inspectInlineV1PlansPostRequestFormMetadataXe8118113(raw)
      if (inspection.matchCount == 0) {
        throw InlineV1PlansPostRequestFormMetadataXe8118113NoMatchException("InlineV1PlansPostRequestFormMetadataXe8118113 matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineV1PlansPostRequestFormMetadataXe8118113(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineV1PlansPostRequestFormMetadataXe8118113> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1PlansPostRequestFormMetadataXe8118113) {
      encoder.requireJsonEncoder("InlineV1PlansPostRequestFormMetadataXe8118113").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineV1PlansPostRequestFormMetadataXe8118113(element: JsonElement): InlineV1PlansPostRequestFormMetadataXe8118113Inspection {
  val matchesBranch1 = element.isJsonDecodable<JsonObject>()
  val matchesInlineV1PlansPostRequestFormMetadataAnyOf2X8a4e8f7a = element.isJsonDecodable<InlineV1PlansPostRequestFormMetadataAnyOf2X8a4e8f7a>()
  return InlineV1PlansPostRequestFormMetadataXe8118113Inspection(
    ...
    failures = buildList {
      ...
      if (!matchesInlineV1PlansPostRequestFormMetadataAnyOf2X8a4e8f7a) add("InlineV1PlansPostRequestFormMetadataAnyOf2X8a4e8f7a: value does not match InlineV1PlansPostRequestFormMetadataAnyOf2X8a4e8f7a")
    },
  )
}
