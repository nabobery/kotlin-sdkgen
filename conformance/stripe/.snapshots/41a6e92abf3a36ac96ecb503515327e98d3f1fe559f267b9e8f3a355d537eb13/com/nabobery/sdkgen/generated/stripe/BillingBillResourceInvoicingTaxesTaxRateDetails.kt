...
public class BillingBillResourceInvoicingTaxesTaxRateDetails(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): BillingBillResourceInvoicingTaxesTaxRateDetails = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<BillingBillResourceInvoicingTaxesTaxRateDetails> {
    ...
    override fun deserialize(decoder: Decoder): BillingBillResourceInvoicingTaxesTaxRateDetails {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("BillingBillResourceInvoicingTaxesTaxRateDetails must be a JSON object")
      val taxRate = json.decodeRequired<InlineBillingBillResourceInvoicingTaxesTaxRateDetailsTaxRateX7af9dd53>(rawObject, "tax_rate")
      return BillingBillResourceInvoicingTaxesTaxRateDetails(
        taxRate = taxRate,
      )
    }

    override fun serialize(encoder: Encoder, `value`: BillingBillResourceInvoicingTaxesTaxRateDetails) {
...
public fun billingBillResourceInvoicingTaxesTaxRateDetails(block: BillingBillResourceInvoicingTaxesTaxRateDetails.Builder.() -> Unit): BillingBillResourceInvoicingTaxesTaxRateDetails = BillingBillResourceInvoicingTaxesTaxRateDetails.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("BillingBillResourceInvoicingTaxesTaxRateDetails is missing required property '" + name + "'")
