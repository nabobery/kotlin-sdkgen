...
public class InlineSubscriptionScheduleAddInvoiceItemPriceX76a604a2 internal constructor(
  ...
  public val matchedBranches: Set<InlineSubscriptionScheduleAddInvoiceItemPriceX76a604a2Branch>
    get() = buildSet {
      ...
      if (inspection.matchesDeletedPrice) add(InlineSubscriptionScheduleAddInvoiceItemPriceX76a604a2Branch.DeletedPrice)
    }
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineSubscriptionScheduleAddInvoiceItemPriceX76a604a2 {
      val inspection = inspectInlineSubscriptionScheduleAddInvoiceItemPriceX76a604a2(raw)
      if (inspection.matchCount == 0) {
        throw InlineSubscriptionScheduleAddInvoiceItemPriceX76a604a2NoMatchException("InlineSubscriptionScheduleAddInvoiceItemPriceX76a604a2 matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineSubscriptionScheduleAddInvoiceItemPriceX76a604a2(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineSubscriptionScheduleAddInvoiceItemPriceX76a604a2> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineSubscriptionScheduleAddInvoiceItemPriceX76a604a2) {
      encoder.requireJsonEncoder("InlineSubscriptionScheduleAddInvoiceItemPriceX76a604a2").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineSubscriptionScheduleAddInvoiceItemPriceX76a604a2(element: JsonElement): InlineSubscriptionScheduleAddInvoiceItemPriceX76a604a2Inspection {
