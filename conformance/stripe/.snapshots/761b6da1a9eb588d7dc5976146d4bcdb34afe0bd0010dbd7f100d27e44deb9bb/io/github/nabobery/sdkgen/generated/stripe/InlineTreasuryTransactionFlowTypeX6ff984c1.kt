...
public sealed class InlineTreasuryTransactionFlowTypeX6ff984c1 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineTreasuryTransactionFlowTypeX6ff984c1 = when (value) {
  ...
  internal object Serializer : KSerializer<InlineTreasuryTransactionFlowTypeX6ff984c1> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineTreasuryTransactionFlowTypeX6ff984c1", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineTreasuryTransactionFlowTypeX6ff984c1 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineTreasuryTransactionFlowTypeX6ff984c1) {
