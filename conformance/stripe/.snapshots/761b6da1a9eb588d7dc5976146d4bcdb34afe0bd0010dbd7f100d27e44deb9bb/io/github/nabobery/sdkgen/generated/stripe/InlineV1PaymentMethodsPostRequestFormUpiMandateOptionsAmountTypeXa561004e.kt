...
public sealed class InlineV1PaymentMethodsPostRequestFormUpiMandateOptionsAmountTypeXa561004e {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1PaymentMethodsPostRequestFormUpiMandateOptionsAmountTypeXa561004e = when (value) {
      Fixed.value -> Fixed
  ...
  internal object Serializer : KSerializer<InlineV1PaymentMethodsPostRequestFormUpiMandateOptionsAmountTypeXa561004e> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1PaymentMethodsPostRequestFormUpiMandateOptionsAmountTypeXa561004e", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1PaymentMethodsPostRequestFormUpiMandateOptionsAmountTypeXa561004e = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1PaymentMethodsPostRequestFormUpiMandateOptionsAmountTypeXa561004e) {
