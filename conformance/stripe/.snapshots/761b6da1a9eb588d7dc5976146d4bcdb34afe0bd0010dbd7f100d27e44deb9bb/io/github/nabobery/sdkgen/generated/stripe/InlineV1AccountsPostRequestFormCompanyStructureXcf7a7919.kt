 ...
 * /properties/company/properties/structure.
 *
 * Source:
 * sdkgen://source/openapi.json#/paths/~1v1~1accounts/post/requestBody/content/application~1x-www-form-urlencoded/schema
 * /properties/company/properties/structure
 */
@Serializable(with = InlineV1AccountsPostRequestFormCompanyStructureXcf7a7919.Serializer::class)
public sealed class InlineV1AccountsPostRequestFormCompanyStructureXcf7a7919 {
  public abstract val `value`: String

  /**
   * Documented value. Wire value: ``.
   */
  public data object Value : InlineV1AccountsPostRequestFormCompanyStructureXcf7a7919() {
   ...
   */
  public data object FreeZoneEstablishment : InlineV1AccountsPostRequestFormCompanyStructureXcf7a7919() {
   ...
   */
  public data object FreeZoneLlc : InlineV1AccountsPostRequestFormCompanyStructureXcf7a7919() {
   ...
   */
  public data object GovernmentInstrumentality : InlineV1AccountsPostRequestFormCompanyStructureXcf7a7919() {
   ...
   */
  public data object GovernmentalUnit : InlineV1AccountsPostRequestFormCompanyStructureXcf7a7919() {
   ...
   */
  public data object IncorporatedNonProfit : InlineV1AccountsPostRequestFormCompanyStructureXcf7a7919() {
   ...
   */
  public data object IncorporatedPartnership : InlineV1AccountsPostRequestFormCompanyStructureXcf7a7919() {
   ...
   */
  public data object LimitedLiabilityPartnership : InlineV1AccountsPostRequestFormCompanyStructureXcf7a7919() {
   ...
   */
  public data object Llc : InlineV1AccountsPostRequestFormCompanyStructureXcf7a7919() {
   ...
   */
  public data object MultiMemberLlc : InlineV1AccountsPostRequestFormCompanyStructureXcf7a7919() {
   ...
   */
  public data object PrivateCompany : InlineV1AccountsPostRequestFormCompanyStructureXcf7a7919() {
   ...
   */
  public data object PrivateCorporation : InlineV1AccountsPostRequestFormCompanyStructureXcf7a7919() {
   ...
   */
  public data object PrivatePartnership : InlineV1AccountsPostRequestFormCompanyStructureXcf7a7919() {
   ...
   */
  public data object PublicCompany : InlineV1AccountsPostRequestFormCompanyStructureXcf7a7919() {
   ...
   */
  public data object PublicCorporation : InlineV1AccountsPostRequestFormCompanyStructureXcf7a7919() {
   ...
   */
  public data object PublicPartnership : InlineV1AccountsPostRequestFormCompanyStructureXcf7a7919() {
   ...
   */
  public data object RegisteredCharity : InlineV1AccountsPostRequestFormCompanyStructureXcf7a7919() {
   ...
   */
  public data object SingleMemberLlc : InlineV1AccountsPostRequestFormCompanyStructureXcf7a7919() {
   ...
   */
  public data object SoleEstablishment : InlineV1AccountsPostRequestFormCompanyStructureXcf7a7919() {
   ...
   */
  public data object SoleProprietorship : InlineV1AccountsPostRequestFormCompanyStructureXcf7a7919() {
   ...
   */
  public data object TaxExemptGovernmentInstrumentality : InlineV1AccountsPostRequestFormCompanyStructureXcf7a7919() {
   ...
   */
  public data object UnincorporatedAssociation : InlineV1AccountsPostRequestFormCompanyStructureXcf7a7919() {
   ...
   */
  public data object UnincorporatedNonProfit : InlineV1AccountsPostRequestFormCompanyStructureXcf7a7919() {
   ...
   */
  public data object UnincorporatedPartnership : InlineV1AccountsPostRequestFormCompanyStructureXcf7a7919() {
    public override val `value`: String = "unincorporated_partnership"
  }

  public data class SdkUnknown(
    public override val `value`: String,
  ) : InlineV1AccountsPostRequestFormCompanyStructureXcf7a7919()

  public companion object {
    public fun fromValue(`value`: String): InlineV1AccountsPostRequestFormCompanyStructureXcf7a7919 = when (value) {
      Value.value -> Value
  ...
  internal object Serializer : KSerializer<InlineV1AccountsPostRequestFormCompanyStructureXcf7a7919> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1AccountsPostRequestFormCompanyStructureXcf7a7919", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1AccountsPostRequestFormCompanyStructureXcf7a7919 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1AccountsPostRequestFormCompanyStructureXcf7a7919) {
