...
public sealed class InlineV1CustomersSourcesPostRequestFormBankAccountAccountHolderTypeXc8ed238d {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1CustomersSourcesPostRequestFormBankAccountAccountHolderTypeXc8ed238d = when (value) {
  ...
  internal object Serializer : KSerializer<InlineV1CustomersSourcesPostRequestFormBankAccountAccountHolderTypeXc8ed238d> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1CustomersSourcesPostRequestFormBankAccountAccountHolderTypeXc8ed238d", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1CustomersSourcesPostRequestFormBankAccountAccountHolderTypeXc8ed238d = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1CustomersSourcesPostRequestFormBankAccountAccountHolderTypeXc8ed238d) {
