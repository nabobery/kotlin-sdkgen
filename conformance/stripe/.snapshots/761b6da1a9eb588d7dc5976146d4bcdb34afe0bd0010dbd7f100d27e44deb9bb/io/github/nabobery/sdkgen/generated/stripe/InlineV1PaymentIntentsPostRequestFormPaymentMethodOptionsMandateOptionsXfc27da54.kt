...
public class InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsMandateOptionsXfc27da54(
  ...
  supportedTypes: List<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsCardAnyOf1ItemX65e0ef03>? = null,
) {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsMandateOptionsXfc27da54 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsMandateOptionsXfc27da54> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsMandateOptionsXfc27da54 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsMandateOptionsXfc27da54")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsMandateOptionsXfc27da54 must be a JSON object")
      val amount = json.decodeRequired<Int>(rawObject, "amount")
      val amountType = json.decodeRequired<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsCardAmountTypeX03683e83>(rawObject, "amount_type")
      val interval = json.decodeRequired<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsCardIntervalX8242e4f0>(rawObject, "interval")
      ...
      return InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsMandateOptionsXfc27da54(
        ...
        supportedTypes = rawObject["supported_types"]?.let { json.decodeFromJsonElement<List<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsCardAnyOf1ItemX65e0ef03>>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsMandateOptionsXfc27da54) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsMandateOptionsXfc27da54")
...
public fun inlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsMandateOptionsXfc27da54(block: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsMandateOptionsXfc27da54.Builder.() -> Unit): InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsMandateOptionsXfc27da54 = InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsMandateOptionsXfc27da54.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsMandateOptionsXfc27da54 is missing required property '" + name + "'")
