...
public class InlineQuotesResourceTransferDataDestinationX471ac850 internal constructor(
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineQuotesResourceTransferDataDestinationX471ac850 {
      val inspection = inspectInlineQuotesResourceTransferDataDestinationX471ac850(raw)
      if (inspection.matchCount == 0) {
        throw InlineQuotesResourceTransferDataDestinationX471ac850NoMatchException("InlineQuotesResourceTransferDataDestinationX471ac850 matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineQuotesResourceTransferDataDestinationX471ac850(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineQuotesResourceTransferDataDestinationX471ac850> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineQuotesResourceTransferDataDestinationX471ac850) {
      encoder.requireJsonEncoder("InlineQuotesResourceTransferDataDestinationX471ac850").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineQuotesResourceTransferDataDestinationX471ac850(element: JsonElement): InlineQuotesResourceTransferDataDestinationX471ac850Inspection {
