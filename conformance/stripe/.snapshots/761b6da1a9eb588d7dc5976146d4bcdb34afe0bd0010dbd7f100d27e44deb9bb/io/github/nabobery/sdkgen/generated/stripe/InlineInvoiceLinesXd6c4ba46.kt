...
public class InlineInvoiceLinesXd6c4ba46(
  ...
  internal object Serializer : KSerializer<InlineInvoiceLinesXd6c4ba46> {
    ...
    override fun deserialize(decoder: Decoder): InlineInvoiceLinesXd6c4ba46 {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineInvoiceLinesXd6c4ba46 must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineInvoiceLinesXd6c4ba46) {
...
public fun inlineInvoiceLinesXd6c4ba46(block: InlineInvoiceLinesXd6c4ba46.Builder.() -> Unit): InlineInvoiceLinesXd6c4ba46 = InlineInvoiceLinesXd6c4ba46.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineInvoiceLinesXd6c4ba46 is missing required property '" + name + "'")
