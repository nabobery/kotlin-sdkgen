...
public data class PaymentMethodOptionsCustomerBalanceView(
  ...
  public val setupFutureUsage:
      InlinePaymentMethodOptionsCustomerBalanceSetupFutureUsageXcc945e37? = null,
)
...
public class PaymentMethodOptionsCustomerBalance(
  ...
  public class Builder {
    ...
    public fun build(): PaymentMethodOptionsCustomerBalance = PaymentMethodOptionsCustomerBalance(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): PaymentMethodOptionsCustomerBalance = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<PaymentMethodOptionsCustomerBalance> {
    ...
    override fun deserialize(decoder: Decoder): PaymentMethodOptionsCustomerBalance {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("PaymentMethodOptionsCustomerBalance must be a JSON object")
      return PaymentMethodOptionsCustomerBalance(
        bankTransfer = rawObject["bank_transfer"]?.let { json.decodeFromJsonElement<PaymentMethodOptionsCustomerBalanceBankTransfer>(it) },
        fundingType = rawObject["funding_type"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlinePaymentMethodOptionsCustomerBalanceFundingTypeXf7f9ef21?>(element) },
        setupFutureUsage = rawObject["setup_future_usage"]?.let { json.decodeFromJsonElement<InlinePaymentMethodOptionsCustomerBalanceSetupFutureUsageXcc945e37>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: PaymentMethodOptionsCustomerBalance) {
...
public fun paymentMethodOptionsCustomerBalance(block: PaymentMethodOptionsCustomerBalance.Builder.() -> Unit): PaymentMethodOptionsCustomerBalance = PaymentMethodOptionsCustomerBalance.build(block)
