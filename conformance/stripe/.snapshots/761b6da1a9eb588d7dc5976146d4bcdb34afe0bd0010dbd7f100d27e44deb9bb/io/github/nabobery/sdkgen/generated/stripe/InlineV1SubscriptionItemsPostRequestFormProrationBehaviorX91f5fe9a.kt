...
public sealed class InlineV1SubscriptionItemsPostRequestFormProrationBehaviorX91f5fe9a {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1SubscriptionItemsPostRequestFormProrationBehaviorX91f5fe9a = when (value) {
  ...
  internal object Serializer : KSerializer<InlineV1SubscriptionItemsPostRequestFormProrationBehaviorX91f5fe9a> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1SubscriptionItemsPostRequestFormProrationBehaviorX91f5fe9a", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1SubscriptionItemsPostRequestFormProrationBehaviorX91f5fe9a = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1SubscriptionItemsPostRequestFormProrationBehaviorX91f5fe9a) {
