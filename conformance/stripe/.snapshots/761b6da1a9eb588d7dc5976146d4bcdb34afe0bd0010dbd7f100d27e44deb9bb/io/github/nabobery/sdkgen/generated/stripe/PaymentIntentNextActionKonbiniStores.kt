...
public class PaymentIntentNextActionKonbiniStores(
  ...
  public class Builder {
    ...
    public fun build(): PaymentIntentNextActionKonbiniStores = PaymentIntentNextActionKonbiniStores(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): PaymentIntentNextActionKonbiniStores = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<PaymentIntentNextActionKonbiniStores> {
    ...
    override fun deserialize(decoder: Decoder): PaymentIntentNextActionKonbiniStores {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("PaymentIntentNextActionKonbiniStores must be a JSON object")
      return PaymentIntentNextActionKonbiniStores(
        familymart = rawObject["familymart"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlinePaymentIntentNextActionKonbiniStoresFamilymartXdf5edf2f?>(element) },
        lawson = rawObject["lawson"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlinePaymentIntentNextActionKonbiniStoresLawsonX667e6d70?>(element) },
        ministop = rawObject["ministop"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlinePaymentIntentNextActionKonbiniStoresMinistopX9893f31a?>(element) },
        seicomart = rawObject["seicomart"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlinePaymentIntentNextActionKonbiniStoresSeicomartX058fdecf?>(element) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: PaymentIntentNextActionKonbiniStores) {
...
public fun paymentIntentNextActionKonbiniStores(block: PaymentIntentNextActionKonbiniStores.Builder.() -> Unit): PaymentIntentNextActionKonbiniStores = PaymentIntentNextActionKonbiniStores.build(block)
