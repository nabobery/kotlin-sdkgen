...
public sealed class InlineV1SetupIntentsConfirmPostRequestFormRequestThreeDSecureX8705b60a {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1SetupIntentsConfirmPostRequestFormRequestThreeDSecureX8705b60a = when (value) {
      Any.value -> Any
  ...
  internal object Serializer : KSerializer<InlineV1SetupIntentsConfirmPostRequestFormRequestThreeDSecureX8705b60a> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1SetupIntentsConfirmPostRequestFormRequestThreeDSecureX8705b60a", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1SetupIntentsConfirmPostRequestFormRequestThreeDSecureX8705b60a = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1SetupIntentsConfirmPostRequestFormRequestThreeDSecureX8705b60a) {
