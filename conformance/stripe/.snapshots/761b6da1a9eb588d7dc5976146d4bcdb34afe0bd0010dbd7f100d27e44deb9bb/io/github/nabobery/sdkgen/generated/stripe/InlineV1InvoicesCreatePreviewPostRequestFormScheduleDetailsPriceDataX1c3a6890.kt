...
public class InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPriceDataX1c3a6890(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPriceDataX1c3a6890 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPriceDataX1c3a6890> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPriceDataX1c3a6890 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPriceDataX1c3a6890")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPriceDataX1c3a6890 must be a JSON object")
      val currency = json.decodeRequired<String>(rawObject, "currency")
      val product = json.decodeRequired<String>(rawObject, "product")
      val recurring = json.decodeRequired<InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsRecurringXd980a450>(rawObject, "recurring")
      return InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPriceDataX1c3a6890(
        currency = currency,
        product = product,
        recurring = recurring,
        taxBehavior = rawObject["tax_behavior"]?.let { json.decodeFromJsonElement<InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsTaxBehaviorX17d1152b>(it) },
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPriceDataX1c3a6890) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPriceDataX1c3a6890")
...
public fun inlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPriceDataX1c3a6890(block: InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPriceDataX1c3a6890.Builder.() -> Unit): InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPriceDataX1c3a6890 = InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPriceDataX1c3a6890.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineV1InvoicesCreatePreviewPostRequestFormScheduleDetailsPriceDataX1c3a6890 is missing required property '" + name + "'")
