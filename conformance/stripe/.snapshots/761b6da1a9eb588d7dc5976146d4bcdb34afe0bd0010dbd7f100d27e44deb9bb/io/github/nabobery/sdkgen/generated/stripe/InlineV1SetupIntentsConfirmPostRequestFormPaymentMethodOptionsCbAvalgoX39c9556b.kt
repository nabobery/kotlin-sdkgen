...
public sealed class InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsCbAvalgoX39c9556b {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsCbAvalgoX39c9556b = when (value) {
      _0.value -> _0
      _1.value -> _1
      _2.value -> _2
      _3.value -> _3
  ...
  internal object Serializer : KSerializer<InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsCbAvalgoX39c9556b> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsCbAvalgoX39c9556b", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsCbAvalgoX39c9556b = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1SetupIntentsConfirmPostRequestFormPaymentMethodOptionsCbAvalgoX39c9556b) {
