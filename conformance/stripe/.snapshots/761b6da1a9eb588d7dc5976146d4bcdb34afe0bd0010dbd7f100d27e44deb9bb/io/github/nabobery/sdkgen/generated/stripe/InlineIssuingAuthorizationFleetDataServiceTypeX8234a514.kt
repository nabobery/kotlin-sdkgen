...
public sealed class InlineIssuingAuthorizationFleetDataServiceTypeX8234a514 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineIssuingAuthorizationFleetDataServiceTypeX8234a514 = when (value) {
  ...
  internal object Serializer : KSerializer<InlineIssuingAuthorizationFleetDataServiceTypeX8234a514> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineIssuingAuthorizationFleetDataServiceTypeX8234a514", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineIssuingAuthorizationFleetDataServiceTypeX8234a514 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineIssuingAuthorizationFleetDataServiceTypeX8234a514) {
