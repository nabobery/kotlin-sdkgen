...
public class ProductMarketingFeature(
  ...
  public class Builder {
    ...
    public fun build(): ProductMarketingFeature = ProductMarketingFeature(
      name = name,
    )
  }
  ...
  internal object Serializer : KSerializer<ProductMarketingFeature> {
    ...
    override fun deserialize(decoder: Decoder): ProductMarketingFeature {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("ProductMarketingFeature must be a JSON object")
      return ProductMarketingFeature(
        name = rawObject["name"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: ProductMarketingFeature) {
...
public fun productMarketingFeature(block: ProductMarketingFeature.Builder.() -> Unit): ProductMarketingFeature = ProductMarketingFeature.build(block)
