...
public sealed class InlineV1BillingMetersPostRequestFormDefaultAggregationFormulaX793833c0 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1BillingMetersPostRequestFormDefaultAggregationFormulaX793833c0 = when (value) {
      Count.value -> Count
      Last.value -> Last
      Sum.value -> Sum
  ...
  internal object Serializer : KSerializer<InlineV1BillingMetersPostRequestFormDefaultAggregationFormulaX793833c0> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1BillingMetersPostRequestFormDefaultAggregationFormulaX793833c0", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1BillingMetersPostRequestFormDefaultAggregationFormulaX793833c0 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1BillingMetersPostRequestFormDefaultAggregationFormulaX793833c0) {
