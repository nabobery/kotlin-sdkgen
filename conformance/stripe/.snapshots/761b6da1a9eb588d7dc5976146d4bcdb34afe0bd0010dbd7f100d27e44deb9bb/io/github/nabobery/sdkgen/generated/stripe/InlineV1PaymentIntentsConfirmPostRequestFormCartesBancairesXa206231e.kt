...
public class InlineV1PaymentIntentsConfirmPostRequestFormCartesBancairesXa206231e(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1PaymentIntentsConfirmPostRequestFormCartesBancairesXa206231e = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1PaymentIntentsConfirmPostRequestFormCartesBancairesXa206231e> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineV1PaymentIntentsConfirmPostRequestFormCartesBancairesXa206231e {
      val jsonDecoder = decoder.requireJsonDecoder("InlineV1PaymentIntentsConfirmPostRequestFormCartesBancairesXa206231e")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1PaymentIntentsConfirmPostRequestFormCartesBancairesXa206231e must be a JSON object")
      val cbAvalgo = json.decodeRequired<InlineV1PaymentIntentsConfirmPostRequestFormCbAvalgoX93d2f20d>(rawObject, "cb_avalgo")
      return InlineV1PaymentIntentsConfirmPostRequestFormCartesBancairesXa206231e(
        cbAvalgo = cbAvalgo,
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1PaymentIntentsConfirmPostRequestFormCartesBancairesXa206231e) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineV1PaymentIntentsConfirmPostRequestFormCartesBancairesXa206231e")
...
public fun inlineV1PaymentIntentsConfirmPostRequestFormCartesBancairesXa206231e(block: InlineV1PaymentIntentsConfirmPostRequestFormCartesBancairesXa206231e.Builder.() -> Unit): InlineV1PaymentIntentsConfirmPostRequestFormCartesBancairesXa206231e = InlineV1PaymentIntentsConfirmPostRequestFormCartesBancairesXa206231e.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineV1PaymentIntentsConfirmPostRequestFormCartesBancairesXa206231e is missing required property '" + name + "'")
