...
public sealed class InlineFinancialConnectionsSessionObjectValueX4c21bf02 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineFinancialConnectionsSessionObjectValueX4c21bf02 = when (value) {
      FinancialConnectionsSession.value -> FinancialConnectionsSession
      else -> SdkUnknown(value)
    }
  }

  internal object Serializer : KSerializer<InlineFinancialConnectionsSessionObjectValueX4c21bf02> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineFinancialConnectionsSessionObjectValueX4c21bf02", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineFinancialConnectionsSessionObjectValueX4c21bf02 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineFinancialConnectionsSessionObjectValueX4c21bf02) {
