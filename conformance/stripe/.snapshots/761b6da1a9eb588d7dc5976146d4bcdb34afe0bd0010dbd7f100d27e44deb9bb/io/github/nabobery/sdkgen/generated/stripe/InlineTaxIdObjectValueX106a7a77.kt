...
public sealed class InlineTaxIdObjectValueX106a7a77 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineTaxIdObjectValueX106a7a77 = when (value) {
      TaxId.value -> TaxId
      else -> SdkUnknown(value)
    }
  }

  internal object Serializer : KSerializer<InlineTaxIdObjectValueX106a7a77> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineTaxIdObjectValueX106a7a77", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineTaxIdObjectValueX106a7a77 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineTaxIdObjectValueX106a7a77) {
