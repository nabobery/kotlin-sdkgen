...
public sealed class InlineV1SubscriptionSchedulesPostRequestFormPhasesItemProrationBehaviorX9c36a412 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1SubscriptionSchedulesPostRequestFormPhasesItemProrationBehaviorX9c36a412 = when (value) {
  ...
  internal object Serializer : KSerializer<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemProrationBehaviorX9c36a412> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1SubscriptionSchedulesPostRequestFormPhasesItemProrationBehaviorX9c36a412", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1SubscriptionSchedulesPostRequestFormPhasesItemProrationBehaviorX9c36a412 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1SubscriptionSchedulesPostRequestFormPhasesItemProrationBehaviorX9c36a412) {
