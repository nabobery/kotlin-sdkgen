...
public sealed class InlineSetupAttemptPaymentMethodDetailsCardWalletTypeX01f38d3e {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineSetupAttemptPaymentMethodDetailsCardWalletTypeX01f38d3e = when (value) {
  ...
  internal object Serializer : KSerializer<InlineSetupAttemptPaymentMethodDetailsCardWalletTypeX01f38d3e> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineSetupAttemptPaymentMethodDetailsCardWalletTypeX01f38d3e", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineSetupAttemptPaymentMethodDetailsCardWalletTypeX01f38d3e = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineSetupAttemptPaymentMethodDetailsCardWalletTypeX01f38d3e) {
