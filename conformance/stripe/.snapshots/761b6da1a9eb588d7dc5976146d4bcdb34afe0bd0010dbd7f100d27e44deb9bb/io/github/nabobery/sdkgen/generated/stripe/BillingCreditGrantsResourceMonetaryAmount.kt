...
public class BillingCreditGrantsResourceMonetaryAmount(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): BillingCreditGrantsResourceMonetaryAmount = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<BillingCreditGrantsResourceMonetaryAmount> {
    ...
    override fun deserialize(decoder: Decoder): BillingCreditGrantsResourceMonetaryAmount {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("BillingCreditGrantsResourceMonetaryAmount must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: BillingCreditGrantsResourceMonetaryAmount) {
...
public fun billingCreditGrantsResourceMonetaryAmount(block: BillingCreditGrantsResourceMonetaryAmount.Builder.() -> Unit): BillingCreditGrantsResourceMonetaryAmount = BillingCreditGrantsResourceMonetaryAmount.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("BillingCreditGrantsResourceMonetaryAmount is missing required property '" + name + "'")
