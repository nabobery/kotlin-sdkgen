...
public class SetupIntentPaymentMethodOptionsMandateOptionsPayto(
   ...
   */
  public val purpose:
      InlineSetupIntentPaymentMethodOptionsMandateOptionsPaytoPurposeX6b4ee11f? = null,
  /**
  ...
  public class Builder {
    ...
    public fun build(): SetupIntentPaymentMethodOptionsMandateOptionsPayto = SetupIntentPaymentMethodOptionsMandateOptionsPayto(
      amount = amount,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): SetupIntentPaymentMethodOptionsMandateOptionsPayto = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<SetupIntentPaymentMethodOptionsMandateOptionsPayto> {
    ...
    override fun deserialize(decoder: Decoder): SetupIntentPaymentMethodOptionsMandateOptionsPayto {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("SetupIntentPaymentMethodOptionsMandateOptionsPayto must be a JSON object")
      return SetupIntentPaymentMethodOptionsMandateOptionsPayto(
        ...
        amountType = rawObject["amount_type"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineSetupIntentPaymentMethodOptionsMandateOptionsPaytoAmountTypeXdc9c92c0?>(element) },
        endDate = rawObject["end_date"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<String?>(element) },
        paymentSchedule = rawObject["payment_schedule"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineSetupIntentPaymentMethodOptionsMandateOptionsPaytoPaymentScheduleXaf2a90a3?>(element) },
        ...
        purpose = rawObject["purpose"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineSetupIntentPaymentMethodOptionsMandateOptionsPaytoPurposeX6b4ee11f?>(element) },
        startDate = rawObject["start_date"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<String?>(element) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: SetupIntentPaymentMethodOptionsMandateOptionsPayto) {
...
public fun setupIntentPaymentMethodOptionsMandateOptionsPayto(block: SetupIntentPaymentMethodOptionsMandateOptionsPayto.Builder.() -> Unit): SetupIntentPaymentMethodOptionsMandateOptionsPayto = SetupIntentPaymentMethodOptionsMandateOptionsPayto.build(block)
