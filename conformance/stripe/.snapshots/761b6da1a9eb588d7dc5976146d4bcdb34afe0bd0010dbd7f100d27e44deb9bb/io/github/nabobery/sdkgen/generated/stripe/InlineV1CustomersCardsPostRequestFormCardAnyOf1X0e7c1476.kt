 ...
 * rm-urlencoded/schema/properties/card/anyOf/0.
 *
 * Source:
 * sdkgen://source/openapi.json#/paths/~1v1~1customers~1{customer}~1cards/post/requestBody/content/application~1x-www-fo
 * rm-urlencoded/schema/properties/card/anyOf/0
 */
@Serializable(with = InlineV1CustomersCardsPostRequestFormCardAnyOf1X0e7c1476.Serializer::class)
public class InlineV1CustomersCardsPostRequestFormCardAnyOf1X0e7c1476(
  ...
  public val networkToken:
      InlineV1CustomersCardsPostRequestFormCardAnyOf1NetworkTokenX442fac8a? = null,
  public val objectValue:
      InlineV1CustomersCardsPostRequestFormCardAnyOf1ObjectValueX92f6509c? = null,
  ...
  public class Builder {
    ...
    public var networkToken: InlineV1CustomersCardsPostRequestFormCardAnyOf1NetworkTokenX442fac8a? =
        null

    public var objectValue: InlineV1CustomersCardsPostRequestFormCardAnyOf1ObjectValueX92f6509c? =
        null

    public var swipeData: String? = null

    public fun build(): InlineV1CustomersCardsPostRequestFormCardAnyOf1X0e7c1476 {
      ...
      return InlineV1CustomersCardsPostRequestFormCardAnyOf1X0e7c1476(
        expMonth = expMonth,
        expYear = expYear,
        number = number,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1CustomersCardsPostRequestFormCardAnyOf1X0e7c1476 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1CustomersCardsPostRequestFormCardAnyOf1X0e7c1476> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineV1CustomersCardsPostRequestFormCardAnyOf1X0e7c1476 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineV1CustomersCardsPostRequestFormCardAnyOf1X0e7c1476")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1CustomersCardsPostRequestFormCardAnyOf1X0e7c1476 must be a JSON object")
      ...
      return InlineV1CustomersCardsPostRequestFormCardAnyOf1X0e7c1476(
        ...
        networkToken = rawObject["network_token"]?.let { json.decodeFromJsonElement<InlineV1CustomersCardsPostRequestFormCardAnyOf1NetworkTokenX442fac8a>(it) },
        objectValue = rawObject["object"]?.let { json.decodeFromJsonElement<InlineV1CustomersCardsPostRequestFormCardAnyOf1ObjectValueX92f6509c>(it) },
        swipeData = rawObject["swipe_data"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineV1CustomersCardsPostRequestFormCardAnyOf1X0e7c1476) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineV1CustomersCardsPostRequestFormCardAnyOf1X0e7c1476")
...
public fun inlineV1CustomersCardsPostRequestFormCardAnyOf1X0e7c1476(block: InlineV1CustomersCardsPostRequestFormCardAnyOf1X0e7c1476.Builder.() -> Unit): InlineV1CustomersCardsPostRequestFormCardAnyOf1X0e7c1476 = InlineV1CustomersCardsPostRequestFormCardAnyOf1X0e7c1476.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineV1CustomersCardsPostRequestFormCardAnyOf1X0e7c1476 is missing required property '" + name + "'")
