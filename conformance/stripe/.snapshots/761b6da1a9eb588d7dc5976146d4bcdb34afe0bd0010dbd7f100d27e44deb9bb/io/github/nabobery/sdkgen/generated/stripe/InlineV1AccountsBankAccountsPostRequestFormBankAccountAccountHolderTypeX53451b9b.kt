...
public sealed class InlineV1AccountsBankAccountsPostRequestFormBankAccountAccountHolderTypeX53451b9b {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1AccountsBankAccountsPostRequestFormBankAccountAccountHolderTypeX53451b9b = when (value) {
  ...
  internal object Serializer : KSerializer<InlineV1AccountsBankAccountsPostRequestFormBankAccountAccountHolderTypeX53451b9b> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1AccountsBankAccountsPostRequestFormBankAccountAccountHolderTypeX53451b9b", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1AccountsBankAccountsPostRequestFormBankAccountAccountHolderTypeX53451b9b = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1AccountsBankAccountsPostRequestFormBankAccountAccountHolderTypeX53451b9b) {
