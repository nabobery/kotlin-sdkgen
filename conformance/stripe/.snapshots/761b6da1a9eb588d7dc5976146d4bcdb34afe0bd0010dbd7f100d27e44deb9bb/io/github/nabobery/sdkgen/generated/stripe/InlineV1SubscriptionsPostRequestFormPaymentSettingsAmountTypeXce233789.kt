...
public sealed class InlineV1SubscriptionsPostRequestFormPaymentSettingsAmountTypeXce233789 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1SubscriptionsPostRequestFormPaymentSettingsAmountTypeXce233789 = when (value) {
      Fixed.value -> Fixed
  ...
  internal object Serializer : KSerializer<InlineV1SubscriptionsPostRequestFormPaymentSettingsAmountTypeXce233789> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1SubscriptionsPostRequestFormPaymentSettingsAmountTypeXce233789", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1SubscriptionsPostRequestFormPaymentSettingsAmountTypeXce233789 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1SubscriptionsPostRequestFormPaymentSettingsAmountTypeXce233789) {
