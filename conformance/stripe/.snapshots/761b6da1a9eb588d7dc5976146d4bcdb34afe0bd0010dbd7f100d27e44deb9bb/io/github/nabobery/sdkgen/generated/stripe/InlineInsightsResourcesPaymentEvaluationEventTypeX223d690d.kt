...
public sealed class InlineInsightsResourcesPaymentEvaluationEventTypeX223d690d {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineInsightsResourcesPaymentEvaluationEventTypeX223d690d = when (value) {
  ...
  internal object Serializer : KSerializer<InlineInsightsResourcesPaymentEvaluationEventTypeX223d690d> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineInsightsResourcesPaymentEvaluationEventTypeX223d690d", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineInsightsResourcesPaymentEvaluationEventTypeX223d690d = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineInsightsResourcesPaymentEvaluationEventTypeX223d690d) {
