...
public class ExchangeRate(
   ...
   */
  public val rates: Map<String, Double> = rates.toMap()
  ...
  public class Builder {
    ...
    public var rates: Map<String, Double>
      get() = requireNotNull(ratesValue) { "rates is required" }.toMap()
      set(`value`) {
        ratesValue = value.toMap()
      }
  ...
  internal object Serializer : KSerializer<ExchangeRate> {
    ...
    override fun deserialize(decoder: Decoder): ExchangeRate {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("ExchangeRate must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: ExchangeRate) {
