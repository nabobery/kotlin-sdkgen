...
public sealed class InlineV1AccountsPostRequestFormControllerFeesPayerXa7287fe0 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1AccountsPostRequestFormControllerFeesPayerXa7287fe0 = when (value) {
  ...
  internal object Serializer : KSerializer<InlineV1AccountsPostRequestFormControllerFeesPayerXa7287fe0> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1AccountsPostRequestFormControllerFeesPayerXa7287fe0", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1AccountsPostRequestFormControllerFeesPayerXa7287fe0 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1AccountsPostRequestFormControllerFeesPayerXa7287fe0) {
