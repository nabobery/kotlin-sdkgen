...
public class GelatoVerificationSessionOptions(
  ...
  public class Builder {
    ...
    public fun build(): GelatoVerificationSessionOptions = GelatoVerificationSessionOptions(
      document = document,
      email = email,
      idNumber = idNumber,
      matching = matching,
  ...
  internal object Serializer : KSerializer<GelatoVerificationSessionOptions> {
    ...
    override fun deserialize(decoder: Decoder): GelatoVerificationSessionOptions {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("GelatoVerificationSessionOptions must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: GelatoVerificationSessionOptions) {
...
public fun gelatoVerificationSessionOptions(block: GelatoVerificationSessionOptions.Builder.() -> Unit): GelatoVerificationSessionOptions = GelatoVerificationSessionOptions.build(block)
