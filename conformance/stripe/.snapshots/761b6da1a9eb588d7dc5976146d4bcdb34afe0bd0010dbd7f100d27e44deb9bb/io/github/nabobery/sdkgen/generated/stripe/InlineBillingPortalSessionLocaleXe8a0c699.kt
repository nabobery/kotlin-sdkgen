...
public sealed class InlineBillingPortalSessionLocaleXe8a0c699 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineBillingPortalSessionLocaleXe8a0c699 = when (value) {
      Auto.value -> Auto
      Bg.value -> Bg
      Cs.value -> Cs
      Da.value -> Da
  ...
  internal object Serializer : KSerializer<InlineBillingPortalSessionLocaleXe8a0c699> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineBillingPortalSessionLocaleXe8a0c699", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineBillingPortalSessionLocaleXe8a0c699 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineBillingPortalSessionLocaleXe8a0c699) {
