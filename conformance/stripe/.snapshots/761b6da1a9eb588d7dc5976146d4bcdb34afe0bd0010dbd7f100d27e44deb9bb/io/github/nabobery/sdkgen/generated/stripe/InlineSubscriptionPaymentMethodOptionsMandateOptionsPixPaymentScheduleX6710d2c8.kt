...
public sealed class InlineSubscriptionPaymentMethodOptionsMandateOptionsPixPaymentScheduleX6710d2c8 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineSubscriptionPaymentMethodOptionsMandateOptionsPixPaymentScheduleX6710d2c8 = when (value) {
  ...
  internal object Serializer : KSerializer<InlineSubscriptionPaymentMethodOptionsMandateOptionsPixPaymentScheduleX6710d2c8> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineSubscriptionPaymentMethodOptionsMandateOptionsPixPaymentScheduleX6710d2c8", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineSubscriptionPaymentMethodOptionsMandateOptionsPixPaymentScheduleX6710d2c8 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineSubscriptionPaymentMethodOptionsMandateOptionsPixPaymentScheduleX6710d2c8) {
