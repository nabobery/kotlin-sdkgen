...
public sealed class InlineV1IssuingDisputesPostRequestFormEvidenceNotReceivedProductTypeXd9d431f3 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1IssuingDisputesPostRequestFormEvidenceNotReceivedProductTypeXd9d431f3 = when (value) {
      Value.value -> Value
  ...
  internal object Serializer : KSerializer<InlineV1IssuingDisputesPostRequestFormEvidenceNotReceivedProductTypeXd9d431f3> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1IssuingDisputesPostRequestFormEvidenceNotReceivedProductTypeXd9d431f3", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1IssuingDisputesPostRequestFormEvidenceNotReceivedProductTypeXd9d431f3 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1IssuingDisputesPostRequestFormEvidenceNotReceivedProductTypeXd9d431f3) {
