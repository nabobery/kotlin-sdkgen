...
public sealed class InlineCheckoutGiropayPaymentMethodOptionsSetupFutureUsageX40d6c077 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineCheckoutGiropayPaymentMethodOptionsSetupFutureUsageX40d6c077 = when (value) {
      None.value -> None
      else -> SdkUnknown(value)
    }
  }

  internal object Serializer : KSerializer<InlineCheckoutGiropayPaymentMethodOptionsSetupFutureUsageX40d6c077> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineCheckoutGiropayPaymentMethodOptionsSetupFutureUsageX40d6c077", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineCheckoutGiropayPaymentMethodOptionsSetupFutureUsageX40d6c077 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineCheckoutGiropayPaymentMethodOptionsSetupFutureUsageX40d6c077) {
