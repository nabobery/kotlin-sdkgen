...
public sealed class InlineTerminalReaderReaderResourceReaderActionTypeXdb26de8a {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineTerminalReaderReaderResourceReaderActionTypeXdb26de8a = when (value) {
  ...
  internal object Serializer : KSerializer<InlineTerminalReaderReaderResourceReaderActionTypeXdb26de8a> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineTerminalReaderReaderResourceReaderActionTypeXdb26de8a", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineTerminalReaderReaderResourceReaderActionTypeXdb26de8a = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineTerminalReaderReaderResourceReaderActionTypeXdb26de8a) {
