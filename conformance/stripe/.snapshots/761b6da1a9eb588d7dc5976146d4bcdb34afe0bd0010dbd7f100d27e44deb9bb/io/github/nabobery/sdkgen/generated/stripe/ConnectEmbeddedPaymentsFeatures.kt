...
public class ConnectEmbeddedPaymentsFeatures(
  ...
  internal object Serializer : KSerializer<ConnectEmbeddedPaymentsFeatures> {
    ...
    override fun deserialize(decoder: Decoder): ConnectEmbeddedPaymentsFeatures {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("ConnectEmbeddedPaymentsFeatures must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: ConnectEmbeddedPaymentsFeatures) {
...
public fun connectEmbeddedPaymentsFeatures(block: ConnectEmbeddedPaymentsFeatures.Builder.() -> Unit): ConnectEmbeddedPaymentsFeatures = ConnectEmbeddedPaymentsFeatures.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("ConnectEmbeddedPaymentsFeatures is missing required property '" + name + "'")
