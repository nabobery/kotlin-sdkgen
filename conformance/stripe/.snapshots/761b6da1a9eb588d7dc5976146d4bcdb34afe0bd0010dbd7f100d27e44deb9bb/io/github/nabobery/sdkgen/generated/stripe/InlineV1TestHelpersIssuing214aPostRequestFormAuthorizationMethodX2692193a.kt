...
public sealed class InlineV1TestHelpersIssuing214aPostRequestFormAuthorizationMethodX2692193a {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1TestHelpersIssuing214aPostRequestFormAuthorizationMethodX2692193a = when (value) {
      Chip.value -> Chip
  ...
  internal object Serializer : KSerializer<InlineV1TestHelpersIssuing214aPostRequestFormAuthorizationMethodX2692193a> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1TestHelpersIssuing214aPostRequestFormAuthorizationMethodX2692193a", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1TestHelpersIssuing214aPostRequestFormAuthorizationMethodX2692193a = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1TestHelpersIssuing214aPostRequestFormAuthorizationMethodX2692193a) {
