...
public sealed class InlineV1SubscriptionsPostRequestFormCancellationDetailsFeedbackX8680ed0d {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1SubscriptionsPostRequestFormCancellationDetailsFeedbackX8680ed0d = when (value) {
      Value.value -> Value
  ...
  internal object Serializer : KSerializer<InlineV1SubscriptionsPostRequestFormCancellationDetailsFeedbackX8680ed0d> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1SubscriptionsPostRequestFormCancellationDetailsFeedbackX8680ed0d", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1SubscriptionsPostRequestFormCancellationDetailsFeedbackX8680ed0d = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1SubscriptionsPostRequestFormCancellationDetailsFeedbackX8680ed0d) {
