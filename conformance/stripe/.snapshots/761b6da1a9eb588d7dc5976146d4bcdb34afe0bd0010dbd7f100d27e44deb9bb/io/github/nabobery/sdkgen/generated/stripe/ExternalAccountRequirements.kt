...
@Serializable
public data class ExternalAccountRequirementsView internal constructor(
...
public class ExternalAccountRequirements(
  ...
  public class Builder {
    ...
    public fun build(): ExternalAccountRequirements = ExternalAccountRequirements(
  ...
  internal object Serializer : KSerializer<ExternalAccountRequirements> {
    ...
    override fun deserialize(decoder: Decoder): ExternalAccountRequirements {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("ExternalAccountRequirements must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: ExternalAccountRequirements) {
...
public fun externalAccountRequirements(block: ExternalAccountRequirements.Builder.() -> Unit): ExternalAccountRequirements = ExternalAccountRequirements.build(block)
