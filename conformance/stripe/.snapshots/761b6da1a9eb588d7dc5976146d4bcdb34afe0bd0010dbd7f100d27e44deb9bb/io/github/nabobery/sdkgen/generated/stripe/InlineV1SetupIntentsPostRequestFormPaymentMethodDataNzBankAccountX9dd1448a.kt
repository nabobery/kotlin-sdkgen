...
public class InlineV1SetupIntentsPostRequestFormPaymentMethodDataNzBankAccountX9dd1448a(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1SetupIntentsPostRequestFormPaymentMethodDataNzBankAccountX9dd1448a = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1SetupIntentsPostRequestFormPaymentMethodDataNzBankAccountX9dd1448a> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineV1SetupIntentsPostRequestFormPaymentMethodDataNzBankAccountX9dd1448a {
      val jsonDecoder = decoder.requireJsonDecoder("InlineV1SetupIntentsPostRequestFormPaymentMethodDataNzBankAccountX9dd1448a")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1SetupIntentsPostRequestFormPaymentMethodDataNzBankAccountX9dd1448a must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1SetupIntentsPostRequestFormPaymentMethodDataNzBankAccountX9dd1448a) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineV1SetupIntentsPostRequestFormPaymentMethodDataNzBankAccountX9dd1448a")
...
public fun inlineV1SetupIntentsPostRequestFormPaymentMethodDataNzBankAccountX9dd1448a(block: InlineV1SetupIntentsPostRequestFormPaymentMethodDataNzBankAccountX9dd1448a.Builder.() -> Unit): InlineV1SetupIntentsPostRequestFormPaymentMethodDataNzBankAccountX9dd1448a = InlineV1SetupIntentsPostRequestFormPaymentMethodDataNzBankAccountX9dd1448a.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineV1SetupIntentsPostRequestFormPaymentMethodDataNzBankAccountX9dd1448a is missing required property '" + name + "'")
