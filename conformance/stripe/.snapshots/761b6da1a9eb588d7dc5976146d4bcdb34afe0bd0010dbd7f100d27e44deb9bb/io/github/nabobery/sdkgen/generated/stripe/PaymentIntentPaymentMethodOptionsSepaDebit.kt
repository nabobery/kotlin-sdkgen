...
public class PaymentIntentPaymentMethodOptionsSepaDebit(
  ...
  public class Builder {
    ...
    public fun build(): PaymentIntentPaymentMethodOptionsSepaDebit = PaymentIntentPaymentMethodOptionsSepaDebit(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): PaymentIntentPaymentMethodOptionsSepaDebit = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<PaymentIntentPaymentMethodOptionsSepaDebit> {
    ...
    override fun deserialize(decoder: Decoder): PaymentIntentPaymentMethodOptionsSepaDebit {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("PaymentIntentPaymentMethodOptionsSepaDebit must be a JSON object")
      return PaymentIntentPaymentMethodOptionsSepaDebit(
        mandateOptions = rawObject["mandate_options"]?.let { json.decodeFromJsonElement<PaymentIntentPaymentMethodOptionsMandateOptionsSepaDebit>(it) },
        setupFutureUsage = rawObject["setup_future_usage"]?.let { json.decodeFromJsonElement<InlinePaymentIntentPaymentMethodOptionsSepaDebitSetupFutureUsageX59f3bed8>(it) },
        targetDate = rawObject["target_date"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: PaymentIntentPaymentMethodOptionsSepaDebit) {
...
public fun paymentIntentPaymentMethodOptionsSepaDebit(block: PaymentIntentPaymentMethodOptionsSepaDebit.Builder.() -> Unit): PaymentIntentPaymentMethodOptionsSepaDebit = PaymentIntentPaymentMethodOptionsSepaDebit.build(block)
