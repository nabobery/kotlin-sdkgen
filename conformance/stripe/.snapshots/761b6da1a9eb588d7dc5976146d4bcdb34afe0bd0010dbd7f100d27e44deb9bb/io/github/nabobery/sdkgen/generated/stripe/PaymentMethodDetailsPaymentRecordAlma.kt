...
public class PaymentMethodDetailsPaymentRecordAlma(
  ...
  public class Builder {
    ...
    public fun build(): PaymentMethodDetailsPaymentRecordAlma = PaymentMethodDetailsPaymentRecordAlma(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): PaymentMethodDetailsPaymentRecordAlma = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<PaymentMethodDetailsPaymentRecordAlma> {
    ...
    override fun deserialize(decoder: Decoder): PaymentMethodDetailsPaymentRecordAlma {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("PaymentMethodDetailsPaymentRecordAlma must be a JSON object")
      return PaymentMethodDetailsPaymentRecordAlma(
        installments = rawObject["installments"]?.let { json.decodeFromJsonElement<PaymentsPrimitivesPaymentRecordsResourcePaymentMethodAlmaDetailsResourceInstallments>(it) },
    ...
    override fun serialize(encoder: Encoder, `value`: PaymentMethodDetailsPaymentRecordAlma) {
...
public fun paymentMethodDetailsPaymentRecordAlma(block: PaymentMethodDetailsPaymentRecordAlma.Builder.() -> Unit): PaymentMethodDetailsPaymentRecordAlma = PaymentMethodDetailsPaymentRecordAlma.build(block)
