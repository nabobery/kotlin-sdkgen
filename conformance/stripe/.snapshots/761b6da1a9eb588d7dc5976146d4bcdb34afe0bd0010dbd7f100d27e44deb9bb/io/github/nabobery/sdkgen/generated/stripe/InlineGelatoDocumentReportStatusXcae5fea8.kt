...
public sealed class InlineGelatoDocumentReportStatusXcae5fea8 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineGelatoDocumentReportStatusXcae5fea8 = when (value) {
  ...
  internal object Serializer : KSerializer<InlineGelatoDocumentReportStatusXcae5fea8> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineGelatoDocumentReportStatusXcae5fea8", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineGelatoDocumentReportStatusXcae5fea8 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineGelatoDocumentReportStatusXcae5fea8) {
