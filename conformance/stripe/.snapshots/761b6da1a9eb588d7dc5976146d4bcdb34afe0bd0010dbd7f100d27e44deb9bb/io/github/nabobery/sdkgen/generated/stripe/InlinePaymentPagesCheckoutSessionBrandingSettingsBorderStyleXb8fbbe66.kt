...
public sealed class InlinePaymentPagesCheckoutSessionBrandingSettingsBorderStyleXb8fbbe66 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlinePaymentPagesCheckoutSessionBrandingSettingsBorderStyleXb8fbbe66 = when (value) {
      Pill.value -> Pill
  ...
  internal object Serializer : KSerializer<InlinePaymentPagesCheckoutSessionBrandingSettingsBorderStyleXb8fbbe66> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlinePaymentPagesCheckoutSessionBrandingSettingsBorderStyleXb8fbbe66", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlinePaymentPagesCheckoutSessionBrandingSettingsBorderStyleXb8fbbe66 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlinePaymentPagesCheckoutSessionBrandingSettingsBorderStyleXb8fbbe66) {
