...
public class InlineCustomerBalanceTransactionCreditNoteX36733346 internal constructor(
  ...
  public val creditNote: CreditNote? by
      lazy(LazyThreadSafetyMode.NONE) { if (inspection.matchesCreditNote) json.decodeFromJsonElement<CreditNote>(raw) else null }
  ...
  public val matchedBranches: Set<InlineCustomerBalanceTransactionCreditNoteX36733346Branch>
    get() = buildSet {
      ...
      if (inspection.matchesCreditNote) add(InlineCustomerBalanceTransactionCreditNoteX36733346Branch.CreditNote)
    }
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineCustomerBalanceTransactionCreditNoteX36733346 {
      val inspection = inspectInlineCustomerBalanceTransactionCreditNoteX36733346(raw)
      if (inspection.matchCount == 0) {
        throw InlineCustomerBalanceTransactionCreditNoteX36733346NoMatchException("InlineCustomerBalanceTransactionCreditNoteX36733346 matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineCustomerBalanceTransactionCreditNoteX36733346(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineCustomerBalanceTransactionCreditNoteX36733346> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineCustomerBalanceTransactionCreditNoteX36733346) {
      encoder.requireJsonEncoder("InlineCustomerBalanceTransactionCreditNoteX36733346").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineCustomerBalanceTransactionCreditNoteX36733346(element: JsonElement): InlineCustomerBalanceTransactionCreditNoteX36733346Inspection {
