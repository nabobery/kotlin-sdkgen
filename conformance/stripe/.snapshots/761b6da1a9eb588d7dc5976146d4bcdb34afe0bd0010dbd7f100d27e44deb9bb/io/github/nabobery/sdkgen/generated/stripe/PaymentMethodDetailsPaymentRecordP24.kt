...
public class PaymentMethodDetailsPaymentRecordP24(
  ...
  public class Builder {
    ...
    public fun build(): PaymentMethodDetailsPaymentRecordP24 = PaymentMethodDetailsPaymentRecordP24(
      bank = bank,
      reference = reference,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): PaymentMethodDetailsPaymentRecordP24 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<PaymentMethodDetailsPaymentRecordP24> {
    ...
    override fun deserialize(decoder: Decoder): PaymentMethodDetailsPaymentRecordP24 {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("PaymentMethodDetailsPaymentRecordP24 must be a JSON object")
      return PaymentMethodDetailsPaymentRecordP24(
        bank = rawObject["bank"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlinePaymentMethodDetailsPaymentRecordP24BankX0bf22c88?>(element) },
    ...
    override fun serialize(encoder: Encoder, `value`: PaymentMethodDetailsPaymentRecordP24) {
...
public fun paymentMethodDetailsPaymentRecordP24(block: PaymentMethodDetailsPaymentRecordP24.Builder.() -> Unit): PaymentMethodDetailsPaymentRecordP24 = PaymentMethodDetailsPaymentRecordP24.build(block)
