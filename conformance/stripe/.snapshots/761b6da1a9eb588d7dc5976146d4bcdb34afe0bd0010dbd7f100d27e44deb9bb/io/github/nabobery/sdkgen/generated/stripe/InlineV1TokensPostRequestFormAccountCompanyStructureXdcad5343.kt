...
public sealed class InlineV1TokensPostRequestFormAccountCompanyStructureXdcad5343 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1TokensPostRequestFormAccountCompanyStructureXdcad5343 = when (value) {
      Value.value -> Value
  ...
  internal object Serializer : KSerializer<InlineV1TokensPostRequestFormAccountCompanyStructureXdcad5343> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1TokensPostRequestFormAccountCompanyStructureXdcad5343", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1TokensPostRequestFormAccountCompanyStructureXdcad5343 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1TokensPostRequestFormAccountCompanyStructureXdcad5343) {
