...
public sealed class InlineOutboundPaymentsPaymentMethodDetailsUsBankAccountNetworkXe07bc35c {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineOutboundPaymentsPaymentMethodDetailsUsBankAccountNetworkXe07bc35c = when (value) {
      Ach.value -> Ach
  ...
  internal object Serializer : KSerializer<InlineOutboundPaymentsPaymentMethodDetailsUsBankAccountNetworkXe07bc35c> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineOutboundPaymentsPaymentMethodDetailsUsBankAccountNetworkXe07bc35c", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineOutboundPaymentsPaymentMethodDetailsUsBankAccountNetworkXe07bc35c = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineOutboundPaymentsPaymentMethodDetailsUsBankAccountNetworkXe07bc35c) {
