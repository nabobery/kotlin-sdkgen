...
public sealed class InlineBillingMeterResourceAggregationSettingsFormulaX28d0a7c6 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineBillingMeterResourceAggregationSettingsFormulaX28d0a7c6 = when (value) {
      Count.value -> Count
      Last.value -> Last
      Sum.value -> Sum
  ...
  internal object Serializer : KSerializer<InlineBillingMeterResourceAggregationSettingsFormulaX28d0a7c6> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineBillingMeterResourceAggregationSettingsFormulaX28d0a7c6", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineBillingMeterResourceAggregationSettingsFormulaX28d0a7c6 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineBillingMeterResourceAggregationSettingsFormulaX28d0a7c6) {
