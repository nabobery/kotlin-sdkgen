...
public class InlineQuoteSubscriptionX578bf401 internal constructor(
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineQuoteSubscriptionX578bf401 {
      val inspection = inspectInlineQuoteSubscriptionX578bf401(raw)
      if (inspection.matchCount == 0) {
        throw InlineQuoteSubscriptionX578bf401NoMatchException("InlineQuoteSubscriptionX578bf401 matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineQuoteSubscriptionX578bf401(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineQuoteSubscriptionX578bf401> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineQuoteSubscriptionX578bf401) {
