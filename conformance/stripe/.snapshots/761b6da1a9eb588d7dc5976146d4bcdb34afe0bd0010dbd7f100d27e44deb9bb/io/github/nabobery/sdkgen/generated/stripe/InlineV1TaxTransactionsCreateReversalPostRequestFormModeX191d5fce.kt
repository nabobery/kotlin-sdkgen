...
public sealed class InlineV1TaxTransactionsCreateReversalPostRequestFormModeX191d5fce {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1TaxTransactionsCreateReversalPostRequestFormModeX191d5fce = when (value) {
      Full.value -> Full
  ...
  internal object Serializer : KSerializer<InlineV1TaxTransactionsCreateReversalPostRequestFormModeX191d5fce> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1TaxTransactionsCreateReversalPostRequestFormModeX191d5fce", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1TaxTransactionsCreateReversalPostRequestFormModeX191d5fce = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1TaxTransactionsCreateReversalPostRequestFormModeX191d5fce) {
