...
public sealed class InlineIssuingDisputeCanceledEvidenceProductTypeX3f171230 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineIssuingDisputeCanceledEvidenceProductTypeX3f171230 = when (value) {
  ...
  internal object Serializer : KSerializer<InlineIssuingDisputeCanceledEvidenceProductTypeX3f171230> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineIssuingDisputeCanceledEvidenceProductTypeX3f171230", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineIssuingDisputeCanceledEvidenceProductTypeX3f171230 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineIssuingDisputeCanceledEvidenceProductTypeX3f171230) {
