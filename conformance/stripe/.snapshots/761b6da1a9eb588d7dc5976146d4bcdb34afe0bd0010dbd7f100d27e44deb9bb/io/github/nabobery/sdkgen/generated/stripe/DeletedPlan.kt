...
public class DeletedPlan(
  ...
  internal object Serializer : KSerializer<DeletedPlan> {
    ...
    override fun deserialize(decoder: Decoder): DeletedPlan {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("DeletedPlan must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: DeletedPlan) {
