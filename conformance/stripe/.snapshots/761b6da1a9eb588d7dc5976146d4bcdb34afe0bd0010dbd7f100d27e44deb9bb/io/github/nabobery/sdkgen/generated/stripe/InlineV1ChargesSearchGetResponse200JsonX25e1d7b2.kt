...
public class InlineV1ChargesSearchGetResponse200JsonX25e1d7b2(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1ChargesSearchGetResponse200JsonX25e1d7b2 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1ChargesSearchGetResponse200JsonX25e1d7b2> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1ChargesSearchGetResponse200JsonX25e1d7b2 {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1ChargesSearchGetResponse200JsonX25e1d7b2 must be a JSON object")
      val data = json.decodeRequired<List<Charge>>(rawObject, "data")
      val hasMore = json.decodeRequired<Boolean>(rawObject, "has_more")
      val objectValue = json.decodeRequired<InlineV1ChargesSearchGetResponse200JsonObjectValueXcdaf41bc>(rawObject, "object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1ChargesSearchGetResponse200JsonX25e1d7b2) {
...
public fun inlineV1ChargesSearchGetResponse200JsonX25e1d7b2(block: InlineV1ChargesSearchGetResponse200JsonX25e1d7b2.Builder.() -> Unit): InlineV1ChargesSearchGetResponse200JsonX25e1d7b2 = InlineV1ChargesSearchGetResponse200JsonX25e1d7b2.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineV1ChargesSearchGetResponse200JsonX25e1d7b2 is missing required property '" + name + "'")
