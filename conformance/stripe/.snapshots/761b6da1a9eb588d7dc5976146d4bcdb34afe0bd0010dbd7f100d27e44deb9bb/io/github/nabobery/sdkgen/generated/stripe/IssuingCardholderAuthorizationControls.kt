...
@Serializable
public data class IssuingCardholderAuthorizationControlsView internal constructor(
...
public class IssuingCardholderAuthorizationControls(
  allowedCardPresences: List<InlineIssuingCardholderAuthorizationControlsAllowedCardPresencesItemXb9c2dc62>? = null,
  allowedCategories: List<InlineIssuingCardholderAuthorizationControlsAllowedCategoriesItemX2029800d>? = null,
  allowedMerchantCountries: List<String>? = null,
  blockedCardPresences: List<InlineIssuingCardholderAuthorizationControlsBlockedCardPresencesItemXcf173929>? = null,
  blockedCategories: List<InlineIssuingCardholderAuthorizationControlsBlockedCategoriesItemX90c50466>? = null,
  blockedMerchantCountries: List<String>? = null,
  spendingLimits: List<IssuingCardholderSpendingLimit>? = null,
  /**
   ...
   */
  public val allowedCardPresences:
      List<InlineIssuingCardholderAuthorizationControlsAllowedCardPresencesItemXb9c2dc62>? =
   ...
   */
  public val allowedCategories:
      List<InlineIssuingCardholderAuthorizationControlsAllowedCategoriesItemX2029800d>? =
   ...
   */
  public val blockedCardPresences:
      List<InlineIssuingCardholderAuthorizationControlsBlockedCardPresencesItemXcf173929>? =
   ...
   */
  public val blockedCategories:
      List<InlineIssuingCardholderAuthorizationControlsBlockedCategoriesItemX90c50466>? =
   ...
   */
  public val spendingLimits: List<IssuingCardholderSpendingLimit>? =
  ...
  public class Builder {
    ...
    private var spendingLimitsValue: List<IssuingCardholderSpendingLimit>? = null

    /**
     * Limit spending with amount-based rules that apply across this cardholder's cards.
     */
    public var spendingLimits: List<IssuingCardholderSpendingLimit>?
    ...
    public fun build(): IssuingCardholderAuthorizationControls = IssuingCardholderAuthorizationControls(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): IssuingCardholderAuthorizationControls = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<IssuingCardholderAuthorizationControls> {
    ...
    override fun deserialize(decoder: Decoder): IssuingCardholderAuthorizationControls {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("IssuingCardholderAuthorizationControls must be a JSON object")
      return IssuingCardholderAuthorizationControls(
        allowedCardPresences = rawObject["allowed_card_presences"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<List<InlineIssuingCardholderAuthorizationControlsAllowedCardPresencesItemXb9c2dc62>?>(element) },
        allowedCategories = rawObject["allowed_categories"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<List<InlineIssuingCardholderAuthorizationControlsAllowedCategoriesItemX2029800d>?>(element) },
        ...
        blockedCardPresences = rawObject["blocked_card_presences"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<List<InlineIssuingCardholderAuthorizationControlsBlockedCardPresencesItemXcf173929>?>(element) },
        blockedCategories = rawObject["blocked_categories"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<List<InlineIssuingCardholderAuthorizationControlsBlockedCategoriesItemX90c50466>?>(element) },
        ...
        spendingLimits = rawObject["spending_limits"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<List<IssuingCardholderSpendingLimit>?>(element) },
    ...
    override fun serialize(encoder: Encoder, `value`: IssuingCardholderAuthorizationControls) {
...
public fun issuingCardholderAuthorizationControls(block: IssuingCardholderAuthorizationControls.Builder.() -> Unit): IssuingCardholderAuthorizationControls = IssuingCardholderAuthorizationControls.build(block)
