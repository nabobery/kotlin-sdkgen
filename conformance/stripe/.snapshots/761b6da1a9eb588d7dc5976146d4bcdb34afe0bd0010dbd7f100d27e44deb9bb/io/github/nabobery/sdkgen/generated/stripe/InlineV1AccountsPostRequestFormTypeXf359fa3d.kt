...
public sealed class InlineV1AccountsPostRequestFormTypeXf359fa3d {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1AccountsPostRequestFormTypeXf359fa3d = when (value) {
      Custom.value -> Custom
  ...
  internal object Serializer : KSerializer<InlineV1AccountsPostRequestFormTypeXf359fa3d> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1AccountsPostRequestFormTypeXf359fa3d", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1AccountsPostRequestFormTypeXf359fa3d = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1AccountsPostRequestFormTypeXf359fa3d) {
