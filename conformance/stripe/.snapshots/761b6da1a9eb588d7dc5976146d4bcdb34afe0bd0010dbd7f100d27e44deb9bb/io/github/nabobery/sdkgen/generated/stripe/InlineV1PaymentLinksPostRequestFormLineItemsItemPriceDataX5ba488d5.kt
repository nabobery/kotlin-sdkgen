...
public class InlineV1PaymentLinksPostRequestFormLineItemsItemPriceDataX5ba488d5(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1PaymentLinksPostRequestFormLineItemsItemPriceDataX5ba488d5 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1PaymentLinksPostRequestFormLineItemsItemPriceDataX5ba488d5> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1PaymentLinksPostRequestFormLineItemsItemPriceDataX5ba488d5 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineV1PaymentLinksPostRequestFormLineItemsItemPriceDataX5ba488d5")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1PaymentLinksPostRequestFormLineItemsItemPriceDataX5ba488d5 must be a JSON object")
      val currency = json.decodeRequired<String>(rawObject, "currency")
      return InlineV1PaymentLinksPostRequestFormLineItemsItemPriceDataX5ba488d5(
        currency = currency,
        product = rawObject["product"]?.let { json.decodeFromJsonElement<String>(it) },
        productData = rawObject["product_data"]?.let { json.decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormLineItemsItemPriceDataProductDataXc6295b73>(it) },
        recurring = rawObject["recurring"]?.let { json.decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormLineItemsItemPriceDataRecurringX359a0eca>(it) },
        taxBehavior = rawObject["tax_behavior"]?.let { json.decodeFromJsonElement<InlineV1PaymentLinksPostRequestFormLineItemsItemPriceDataTaxBehaviorXdc1122d1>(it) },
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1PaymentLinksPostRequestFormLineItemsItemPriceDataX5ba488d5) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineV1PaymentLinksPostRequestFormLineItemsItemPriceDataX5ba488d5")
...
public fun inlineV1PaymentLinksPostRequestFormLineItemsItemPriceDataX5ba488d5(block: InlineV1PaymentLinksPostRequestFormLineItemsItemPriceDataX5ba488d5.Builder.() -> Unit): InlineV1PaymentLinksPostRequestFormLineItemsItemPriceDataX5ba488d5 = InlineV1PaymentLinksPostRequestFormLineItemsItemPriceDataX5ba488d5.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineV1PaymentLinksPostRequestFormLineItemsItemPriceDataX5ba488d5 is missing required property '" + name + "'")
