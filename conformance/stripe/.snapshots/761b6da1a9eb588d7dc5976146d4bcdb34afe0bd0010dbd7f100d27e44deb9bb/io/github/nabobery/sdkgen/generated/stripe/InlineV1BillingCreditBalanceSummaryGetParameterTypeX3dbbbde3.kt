...
public sealed class InlineV1BillingCreditBalanceSummaryGetParameterTypeX3dbbbde3 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1BillingCreditBalanceSummaryGetParameterTypeX3dbbbde3 = when (value) {
  ...
  internal object Serializer : KSerializer<InlineV1BillingCreditBalanceSummaryGetParameterTypeX3dbbbde3> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1BillingCreditBalanceSummaryGetParameterTypeX3dbbbde3", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1BillingCreditBalanceSummaryGetParameterTypeX3dbbbde3 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1BillingCreditBalanceSummaryGetParameterTypeX3dbbbde3) {
