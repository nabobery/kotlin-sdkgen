...
public sealed class InlinePaymentsPrimitivesPa0ad7FundingX5fc3e805 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlinePaymentsPrimitivesPa0ad7FundingX5fc3e805 = when (value) {
      Credit.value -> Credit
      Debit.value -> Debit
  ...
  internal object Serializer : KSerializer<InlinePaymentsPrimitivesPa0ad7FundingX5fc3e805> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlinePaymentsPrimitivesPa0ad7FundingX5fc3e805", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlinePaymentsPrimitivesPa0ad7FundingX5fc3e805 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlinePaymentsPrimitivesPa0ad7FundingX5fc3e805) {
