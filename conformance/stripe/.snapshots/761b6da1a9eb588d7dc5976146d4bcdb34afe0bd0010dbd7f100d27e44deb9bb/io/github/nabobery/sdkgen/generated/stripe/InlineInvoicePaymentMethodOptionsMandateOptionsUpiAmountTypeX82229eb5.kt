...
public sealed class InlineInvoicePaymentMethodOptionsMandateOptionsUpiAmountTypeX82229eb5 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineInvoicePaymentMethodOptionsMandateOptionsUpiAmountTypeX82229eb5 = when (value) {
      Fixed.value -> Fixed
  ...
  internal object Serializer : KSerializer<InlineInvoicePaymentMethodOptionsMandateOptionsUpiAmountTypeX82229eb5> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineInvoicePaymentMethodOptionsMandateOptionsUpiAmountTypeX82229eb5", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineInvoicePaymentMethodOptionsMandateOptionsUpiAmountTypeX82229eb5 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineInvoicePaymentMethodOptionsMandateOptionsUpiAmountTypeX82229eb5) {
