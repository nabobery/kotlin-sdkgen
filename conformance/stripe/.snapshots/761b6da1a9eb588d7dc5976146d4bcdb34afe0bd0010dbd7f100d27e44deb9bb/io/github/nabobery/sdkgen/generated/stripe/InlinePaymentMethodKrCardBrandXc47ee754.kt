...
public sealed class InlinePaymentMethodKrCardBrandXc47ee754 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlinePaymentMethodKrCardBrandXc47ee754 = when (value) {
      Bc.value -> Bc
      Citi.value -> Citi
      Hana.value -> Hana
  ...
  internal object Serializer : KSerializer<InlinePaymentMethodKrCardBrandXc47ee754> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlinePaymentMethodKrCardBrandXc47ee754", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlinePaymentMethodKrCardBrandXc47ee754 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlinePaymentMethodKrCardBrandXc47ee754) {
