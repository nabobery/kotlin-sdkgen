...
internal data class InlineV1CustomersPostRequestFormAddressX54fa48b0Inspection(
  ...
  public val matchCount: Int
    get() = listOf(matchesInlineV1CustomersPostRequestFormAddressAnyOf1X3332e09b, matchesInlineV1CustomersPostRequestFormAddressAnyOf2Xfe16359c).count { it }
}
...
public class InlineV1CustomersPostRequestFormAddressX54fa48b0 internal constructor(
  ...
  public val inlineV1CustomersPostRequestFormAddressAnyOf1X3332e09b:
      ...
      lazy(LazyThreadSafetyMode.NONE) { if (inspection.matchesInlineV1CustomersPostRequestFormAddressAnyOf1X3332e09b) json.decodeFromJsonElement<InlineV1CustomersPostRequestFormAddressAnyOf1X3332e09b>(raw) else null }
  ...
  public val inlineV1CustomersPostRequestFormAddressAnyOf2Xfe16359c:
      ...
      lazy(LazyThreadSafetyMode.NONE) { if (inspection.matchesInlineV1CustomersPostRequestFormAddressAnyOf2Xfe16359c) json.decodeFromJsonElement<InlineV1CustomersPostRequestFormAddressAnyOf2Xfe16359c>(raw) else null }

  public val matchedBranches: Set<InlineV1CustomersPostRequestFormAddressX54fa48b0Branch>
    get() = buildSet {
      if (inspection.matchesInlineV1CustomersPostRequestFormAddressAnyOf1X3332e09b) add(InlineV1CustomersPostRequestFormAddressX54fa48b0Branch.InlineV1CustomersPostRequestFormAddressAnyOf1X3332e09b)
      if (inspection.matchesInlineV1CustomersPostRequestFormAddressAnyOf2Xfe16359c) add(InlineV1CustomersPostRequestFormAddressX54fa48b0Branch.InlineV1CustomersPostRequestFormAddressAnyOf2Xfe16359c)
    }
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineV1CustomersPostRequestFormAddressX54fa48b0 {
      val inspection = inspectInlineV1CustomersPostRequestFormAddressX54fa48b0(raw)
      if (inspection.matchCount == 0) {
        throw InlineV1CustomersPostRequestFormAddressX54fa48b0NoMatchException("InlineV1CustomersPostRequestFormAddressX54fa48b0 matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineV1CustomersPostRequestFormAddressX54fa48b0(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineV1CustomersPostRequestFormAddressX54fa48b0> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1CustomersPostRequestFormAddressX54fa48b0) {
      encoder.requireJsonEncoder("InlineV1CustomersPostRequestFormAddressX54fa48b0").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineV1CustomersPostRequestFormAddressX54fa48b0(element: JsonElement): InlineV1CustomersPostRequestFormAddressX54fa48b0Inspection {
  val matchesInlineV1CustomersPostRequestFormAddressAnyOf1X3332e09b = element.isJsonDecodable<InlineV1CustomersPostRequestFormAddressAnyOf1X3332e09b>()
  val matchesInlineV1CustomersPostRequestFormAddressAnyOf2Xfe16359c = element.isJsonDecodable<InlineV1CustomersPostRequestFormAddressAnyOf2Xfe16359c>()
  return InlineV1CustomersPostRequestFormAddressX54fa48b0Inspection(
    ...
    failures = buildList {
      if (!matchesInlineV1CustomersPostRequestFormAddressAnyOf1X3332e09b) add("InlineV1CustomersPostRequestFormAddressAnyOf1X3332e09b: value does not match InlineV1CustomersPostRequestFormAddressAnyOf1X3332e09b")
      if (!matchesInlineV1CustomersPostRequestFormAddressAnyOf2Xfe16359c) add("InlineV1CustomersPostRequestFormAddressAnyOf2Xfe16359c: value does not match InlineV1CustomersPostRequestFormAddressAnyOf2Xfe16359c")
    },
  )
}
