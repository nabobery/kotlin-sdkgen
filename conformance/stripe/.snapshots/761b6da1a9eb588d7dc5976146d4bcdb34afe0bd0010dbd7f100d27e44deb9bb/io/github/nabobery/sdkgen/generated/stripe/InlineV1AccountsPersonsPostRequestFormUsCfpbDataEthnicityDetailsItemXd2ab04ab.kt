...
public sealed class InlineV1AccountsPersonsPostRequestFormUsCfpbDataEthnicityDetailsItemXd2ab04ab {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1AccountsPersonsPostRequestFormUsCfpbDataEthnicityDetailsItemXd2ab04ab = when (value) {
      Cuban.value -> Cuban
  ...
  internal object Serializer : KSerializer<InlineV1AccountsPersonsPostRequestFormUsCfpbDataEthnicityDetailsItemXd2ab04ab> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1AccountsPersonsPostRequestFormUsCfpbDataEthnicityDetailsItemXd2ab04ab", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1AccountsPersonsPostRequestFormUsCfpbDataEthnicityDetailsItemXd2ab04ab = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1AccountsPersonsPostRequestFormUsCfpbDataEthnicityDetailsItemXd2ab04ab) {
