...
public sealed class InlineV1TreasuryOutboundPab148PostRequestFormNetworkXf857f5ed {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1TreasuryOutboundPab148PostRequestFormNetworkXf857f5ed = when (value) {
      Ach.value -> Ach
  ...
  internal object Serializer : KSerializer<InlineV1TreasuryOutboundPab148PostRequestFormNetworkXf857f5ed> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1TreasuryOutboundPab148PostRequestFormNetworkXf857f5ed", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1TreasuryOutboundPab148PostRequestFormNetworkXf857f5ed = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1TreasuryOutboundPab148PostRequestFormNetworkXf857f5ed) {
