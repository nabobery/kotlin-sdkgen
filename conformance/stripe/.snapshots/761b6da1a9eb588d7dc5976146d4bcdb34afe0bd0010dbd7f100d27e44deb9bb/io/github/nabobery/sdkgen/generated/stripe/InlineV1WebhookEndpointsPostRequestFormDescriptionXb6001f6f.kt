...
internal data class InlineV1WebhookEndpointsPostRequestFormDescriptionXb6001f6fInspection(
  ...
  public val matchCount: Int
    get() = listOf(matchesBranch1, matchesInlineV1WebhookEndpointsPostRequestFormDescriptionAnyOf2X810fdb5c).count { it }
}
...
public class InlineV1WebhookEndpointsPostRequestFormDescriptionXb6001f6f internal constructor(
  ...
  public val inlineV1WebhookEndpointsPostRequestFormDescriptionAnyOf2X810fdb5c:
      ...
      lazy(LazyThreadSafetyMode.NONE) { if (inspection.matchesInlineV1WebhookEndpointsPostRequestFormDescriptionAnyOf2X810fdb5c) json.decodeFromJsonElement<InlineV1WebhookEndpointsPostRequestFormDescriptionAnyOf2X810fdb5c>(raw) else null }

  public val matchedBranches: Set<InlineV1WebhookEndpointsPostRequestFormDescriptionXb6001f6fBranch>
    get() = buildSet {
      if (inspection.matchesBranch1) add(InlineV1WebhookEndpointsPostRequestFormDescriptionXb6001f6fBranch.Branch1)
      if (inspection.matchesInlineV1WebhookEndpointsPostRequestFormDescriptionAnyOf2X810fdb5c) add(InlineV1WebhookEndpointsPostRequestFormDescriptionXb6001f6fBranch.InlineV1WebhookEndpointsPostRequestFormDescriptionAnyOf2X810fdb5c)
    }
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineV1WebhookEndpointsPostRequestFormDescriptionXb6001f6f {
      val inspection = inspectInlineV1WebhookEndpointsPostRequestFormDescriptionXb6001f6f(raw)
      if (inspection.matchCount == 0) {
        throw InlineV1WebhookEndpointsPostRequestFormDescriptionXb6001f6fNoMatchException("InlineV1WebhookEndpointsPostRequestFormDescriptionXb6001f6f matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineV1WebhookEndpointsPostRequestFormDescriptionXb6001f6f(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineV1WebhookEndpointsPostRequestFormDescriptionXb6001f6f> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1WebhookEndpointsPostRequestFormDescriptionXb6001f6f) {
      encoder.requireJsonEncoder("InlineV1WebhookEndpointsPostRequestFormDescriptionXb6001f6f").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineV1WebhookEndpointsPostRequestFormDescriptionXb6001f6f(element: JsonElement): InlineV1WebhookEndpointsPostRequestFormDescriptionXb6001f6fInspection {
  val matchesBranch1 = element.isJsonDecodable<String>()
  val matchesInlineV1WebhookEndpointsPostRequestFormDescriptionAnyOf2X810fdb5c = element.isJsonDecodable<InlineV1WebhookEndpointsPostRequestFormDescriptionAnyOf2X810fdb5c>()
  return InlineV1WebhookEndpointsPostRequestFormDescriptionXb6001f6fInspection(
    ...
    failures = buildList {
      ...
      if (!matchesInlineV1WebhookEndpointsPostRequestFormDescriptionAnyOf2X810fdb5c) add("InlineV1WebhookEndpointsPostRequestFormDescriptionAnyOf2X810fdb5c: value does not match InlineV1WebhookEndpointsPostRequestFormDescriptionAnyOf2X810fdb5c")
    },
  )
}
