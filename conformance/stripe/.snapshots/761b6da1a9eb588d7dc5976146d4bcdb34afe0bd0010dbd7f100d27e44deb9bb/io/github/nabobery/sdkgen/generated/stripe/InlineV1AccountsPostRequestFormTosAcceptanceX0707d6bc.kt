...
public class InlineV1AccountsPostRequestFormTosAcceptanceX0707d6bc(
  ...
  public class Builder {
    ...
    public fun build(): InlineV1AccountsPostRequestFormTosAcceptanceX0707d6bc = InlineV1AccountsPostRequestFormTosAcceptanceX0707d6bc(
      date = date,
      ip = ip,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1AccountsPostRequestFormTosAcceptanceX0707d6bc = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1AccountsPostRequestFormTosAcceptanceX0707d6bc> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1AccountsPostRequestFormTosAcceptanceX0707d6bc {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1AccountsPostRequestFormTosAcceptanceX0707d6bc must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1AccountsPostRequestFormTosAcceptanceX0707d6bc) {
...
public fun inlineV1AccountsPostRequestFormTosAcceptanceX0707d6bc(block: InlineV1AccountsPostRequestFormTosAcceptanceX0707d6bc.Builder.() -> Unit): InlineV1AccountsPostRequestFormTosAcceptanceX0707d6bc = InlineV1AccountsPostRequestFormTosAcceptanceX0707d6bc.build(block)
