...
public sealed class InlineCheckoutAcssDebitMandateOptionsDefaultForItemX933d1c8b {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineCheckoutAcssDebitMandateOptionsDefaultForItemX933d1c8b = when (value) {
  ...
  internal object Serializer : KSerializer<InlineCheckoutAcssDebitMandateOptionsDefaultForItemX933d1c8b> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineCheckoutAcssDebitMandateOptionsDefaultForItemX933d1c8b", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineCheckoutAcssDebitMandateOptionsDefaultForItemX933d1c8b = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineCheckoutAcssDebitMandateOptionsDefaultForItemX933d1c8b) {
