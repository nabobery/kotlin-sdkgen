package io.github.nabobery.sdkgen.generated.stripe.prices
...
import io.github.nabobery.sdkgen.generated.stripe.InlineV1PricesGetParameterX3bd64ecd
import io.github.nabobery.sdkgen.generated.stripe.InlineV1PricesGetParameterX903af275
import io.github.nabobery.sdkgen.generated.stripe.InlineV1PricesGetParameterXee4abeea
import io.github.nabobery.sdkgen.generated.stripe.InlineV1PricesGetResponse200JsonX04f7a5eb
import io.github.nabobery.sdkgen.generated.stripe.InlineV1PricesPostRequestFormX26912080
import io.github.nabobery.sdkgen.generated.stripe.InlineV1PricesPostRequestFormXe33007fa
import io.github.nabobery.sdkgen.generated.stripe.InlineV1PricesSearchGetResponse200JsonX5105616d
import io.github.nabobery.sdkgen.generated.stripe.Price
...
internal object PricesCodecs {
  internal const val GETPRICES_REQUEST_CODEC_ID: String = "GetPrices.request"
  ...
  internal val getPricesResponseCodecAlternative0Registry:
  ...
  internal val getPricesResponseCodecAlternative1Registry: MediaTypeCodecRegistry<Error> =
      MediaTypeCodecRegistry.of(getPricesResponseCodecAlternative1Codec)

  internal val getPricesRequestCodecRegistry: MediaTypeCodecRegistry<JsonObject?> =
      MediaTypeCodecRegistry.of(getPricesRequestCodec)

  internal const val GETPRICESPRICE_REQUEST_CODEC_ID: String = "GetPricesPrice.request"
  ...
  internal val getPricesPriceResponseCodecAlternative0Registry: MediaTypeCodecRegistry<Price> =
  ...
  internal val getPricesPriceResponseCodecAlternative1Registry: MediaTypeCodecRegistry<Error> =
      MediaTypeCodecRegistry.of(getPricesPriceResponseCodecAlternative1Codec)

  internal val getPricesPriceRequestCodecRegistry: MediaTypeCodecRegistry<JsonObject?> =
      MediaTypeCodecRegistry.of(getPricesPriceRequestCodec)

  internal const val GETPRICESSEARCH_REQUEST_CODEC_ID: String = "GetPricesSearch.request"
  ...
  internal val getPricesSearchResponseCodecAlternative0Registry:
  ...
  internal val getPricesSearchResponseCodecAlternative1Registry: MediaTypeCodecRegistry<Error> =
      MediaTypeCodecRegistry.of(getPricesSearchResponseCodecAlternative1Codec)

  internal val getPricesSearchRequestCodecRegistry: MediaTypeCodecRegistry<JsonObject?> =
      MediaTypeCodecRegistry.of(getPricesSearchRequestCodec)

  internal const val POSTPRICES_REQUEST_CODEC_ID: String = "PostPrices.request"
  ...
  internal val postPricesResponseCodecAlternative0Registry: MediaTypeCodecRegistry<Price> =
  ...
  internal val postPricesResponseCodecAlternative1Registry: MediaTypeCodecRegistry<Error> =
      MediaTypeCodecRegistry.of(postPricesResponseCodecAlternative1Codec)

  internal val postPricesRequestCodecRegistry:
      MediaTypeCodecRegistry<InlineV1PricesPostRequestFormX26912080> =
      MediaTypeCodecRegistry.of(postPricesRequestCodec)

  internal const val POSTPRICESPRICE_REQUEST_CODEC_ID: String = "PostPricesPrice.request"
  ...
  internal val postPricesPriceResponseCodecAlternative0Registry: MediaTypeCodecRegistry<Price> =
  ...
  internal val postPricesPriceResponseCodecAlternative1Registry: MediaTypeCodecRegistry<Error> =
      MediaTypeCodecRegistry.of(postPricesPriceResponseCodecAlternative1Codec)

  internal val postPricesPriceRequestCodecRegistry:
      MediaTypeCodecRegistry<InlineV1PricesPostRequestFormXe33007fa?> =
      MediaTypeCodecRegistry.of(postPricesPriceRequestCodec)

  internal object GetPricesFormCodec : MediaTypeCodec<JsonObject?> {
  ...
  internal object GetPricesPriceFormCodec : MediaTypeCodec<JsonObject?> {
  ...
  internal object GetPricesSearchFormCodec : MediaTypeCodec<JsonObject?> {
  ...
  internal object PostPricesFormCodec : MediaTypeCodec<InlineV1PricesPostRequestFormX26912080> {
  ...
  internal object PostPricesPriceFormCodec : MediaTypeCodec<InlineV1PricesPostRequestFormXe33007fa?> {
...
public class PricesClient(
  ...
  public companion object {
    internal val getPricesMetadata: OperationMetadata by
    ...
    internal val getPricesPriceMetadata: OperationMetadata by
        lazy(LazyThreadSafetyMode.PUBLICATION) { OperationMetadata(
    ...
    internal val getPricesSearchMetadata: OperationMetadata by
        lazy(LazyThreadSafetyMode.PUBLICATION) { OperationMetadata(
    ...
    internal val postPricesMetadata: OperationMetadata by
        lazy(LazyThreadSafetyMode.PUBLICATION) { OperationMetadata(
    ...
    internal val postPricesPriceMetadata: OperationMetadata by
        lazy(LazyThreadSafetyMode.PUBLICATION) { OperationMetadata(
