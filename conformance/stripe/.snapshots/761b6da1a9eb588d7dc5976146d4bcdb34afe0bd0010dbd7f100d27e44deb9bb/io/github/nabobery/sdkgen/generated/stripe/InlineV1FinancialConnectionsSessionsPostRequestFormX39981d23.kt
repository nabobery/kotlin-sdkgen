...
public class InlineV1FinancialConnectionsSessionsPostRequestFormX39981d23(
  ...
  prefetch: List<InlineV1FinancialConnectionsSessionsPostRequestFormPrefetchItemX03875602>? = null,
  /**
   ...
   */
  public val prefetch:
      List<InlineV1FinancialConnectionsSessionsPostRequestFormPrefetchItemX03875602>? =
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1FinancialConnectionsSessionsPostRequestFormX39981d23 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1FinancialConnectionsSessionsPostRequestFormX39981d23> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1FinancialConnectionsSessionsPostRequestFormX39981d23 {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1FinancialConnectionsSessionsPostRequestFormX39981d23 must be a JSON object")
      val accountHolder = json.decodeRequired<InlineV1FinancialConnectionsSessionsPostRequestFormAccountHolderX985337bc>(rawObject, "account_holder")
      val permissions = json.decodeRequired<List<InlineV1FinancialConnectionsSessionsPostRequestFormPermissionsItemX0bd19174>>(rawObject, "permissions")
      return InlineV1FinancialConnectionsSessionsPostRequestFormX39981d23(
        accountHolder = accountHolder,
        permissions = permissions,
        expand = rawObject["expand"]?.let { json.decodeFromJsonElement<List<String>>(it) },
        filters = rawObject["filters"]?.let { json.decodeFromJsonElement<InlineV1FinancialConnectionsSessionsPostRequestFormFiltersX18327f2f>(it) },
        prefetch = rawObject["prefetch"]?.let { json.decodeFromJsonElement<List<InlineV1FinancialConnectionsSessionsPostRequestFormPrefetchItemX03875602>>(it) },
        returnUrl = rawObject["return_url"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineV1FinancialConnectionsSessionsPostRequestFormX39981d23) {
...
public fun inlineV1FinancialConnectionsSessionsPostRequestFormX39981d23(block: InlineV1FinancialConnectionsSessionsPostRequestFormX39981d23.Builder.() -> Unit): InlineV1FinancialConnectionsSessionsPostRequestFormX39981d23 = InlineV1FinancialConnectionsSessionsPostRequestFormX39981d23.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineV1FinancialConnectionsSessionsPostRequestFormX39981d23 is missing required property '" + name + "'")
