 ...
 *
 * Source: sdkgen://source/openapi.json#/components/schemas/terminal.reader/properties/device_type
 */
@Serializable(with = InlineTerminalReaderDeviceTypeXfd438214.Serializer::class)
public sealed class InlineTerminalReaderDeviceTypeXfd438214 {
  public abstract val `value`: String

  /**
   * Documented value. Wire value: `bbpos_chipper2x`.
   */
  public data object BbposChipper2x : InlineTerminalReaderDeviceTypeXfd438214() {
   ...
   */
  public data object BbposWisepad3 : InlineTerminalReaderDeviceTypeXfd438214() {
   ...
   */
  public data object BbposWiseposE : InlineTerminalReaderDeviceTypeXfd438214() {
   ...
   */
  public data object MobilePhoneReader : InlineTerminalReaderDeviceTypeXfd438214() {
   ...
   */
  public data object SimulatedStripeS700 : InlineTerminalReaderDeviceTypeXfd438214() {
   ...
   */
  public data object SimulatedStripeS710 : InlineTerminalReaderDeviceTypeXfd438214() {
   ...
   */
  public data object SimulatedVerifoneM425 : InlineTerminalReaderDeviceTypeXfd438214() {
   ...
   */
  public data object SimulatedVerifoneP630 : InlineTerminalReaderDeviceTypeXfd438214() {
   ...
   */
  public data object SimulatedVerifoneUx700 : InlineTerminalReaderDeviceTypeXfd438214() {
   ...
   */
  public data object SimulatedVerifoneV660p : InlineTerminalReaderDeviceTypeXfd438214() {
   ...
   */
  public data object SimulatedWiseposE : InlineTerminalReaderDeviceTypeXfd438214() {
   ...
   */
  public data object StripeM2 : InlineTerminalReaderDeviceTypeXfd438214() {
   ...
   */
  public data object StripeS700 : InlineTerminalReaderDeviceTypeXfd438214() {
   ...
   */
  public data object StripeS710 : InlineTerminalReaderDeviceTypeXfd438214() {
   ...
   */
  public data object VerifoneP400 : InlineTerminalReaderDeviceTypeXfd438214() {
   ...
   */
  public data object VerifoneM425 : InlineTerminalReaderDeviceTypeXfd438214() {
   ...
   */
  public data object VerifoneP630 : InlineTerminalReaderDeviceTypeXfd438214() {
   ...
   */
  public data object VerifoneUx700 : InlineTerminalReaderDeviceTypeXfd438214() {
   ...
   */
  public data object VerifoneV660p : InlineTerminalReaderDeviceTypeXfd438214() {
    public override val `value`: String = "verifone_v660p"
  }

  public data class SdkUnknown(
    public override val `value`: String,
  ) : InlineTerminalReaderDeviceTypeXfd438214()

  public companion object {
    public fun fromValue(`value`: String): InlineTerminalReaderDeviceTypeXfd438214 = when (value) {
  ...
  internal object Serializer : KSerializer<InlineTerminalReaderDeviceTypeXfd438214> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineTerminalReaderDeviceTypeXfd438214", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineTerminalReaderDeviceTypeXfd438214 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineTerminalReaderDeviceTypeXfd438214) {
