...
public sealed class InlineV1BillingMetersGetParameterX34cf0a7b {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1BillingMetersGetParameterX34cf0a7b = when (value) {
      Active.value -> Active
  ...
  internal object Serializer : KSerializer<InlineV1BillingMetersGetParameterX34cf0a7b> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1BillingMetersGetParameterX34cf0a7b", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1BillingMetersGetParameterX34cf0a7b = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1BillingMetersGetParameterX34cf0a7b) {
