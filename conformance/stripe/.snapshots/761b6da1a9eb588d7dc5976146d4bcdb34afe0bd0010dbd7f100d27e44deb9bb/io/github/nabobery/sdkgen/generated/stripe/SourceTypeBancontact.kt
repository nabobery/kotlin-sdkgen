...
public class SourceTypeBancontact(
  ...
  public class Builder {
    ...
    public fun build(): SourceTypeBancontact = SourceTypeBancontact(
      bankCode = bankCode,
      bankName = bankName,
      bic = bic,
      ibanLast4 = ibanLast4,
  ...
  internal object Serializer : KSerializer<SourceTypeBancontact> {
    ...
    override fun deserialize(decoder: Decoder): SourceTypeBancontact {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("SourceTypeBancontact must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: SourceTypeBancontact) {
...
public fun sourceTypeBancontact(block: SourceTypeBancontact.Builder.() -> Unit): SourceTypeBancontact = SourceTypeBancontact.build(block)
