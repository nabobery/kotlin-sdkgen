...
public class SourceTransactionChfCreditTransferData(
  ...
  public class Builder {
    ...
    public fun build(): SourceTransactionChfCreditTransferData = SourceTransactionChfCreditTransferData(
      reference = reference,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): SourceTransactionChfCreditTransferData = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<SourceTransactionChfCreditTransferData> {
    ...
    override fun deserialize(decoder: Decoder): SourceTransactionChfCreditTransferData {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("SourceTransactionChfCreditTransferData must be a JSON object")
      return SourceTransactionChfCreditTransferData(
        reference = rawObject["reference"]?.let { json.decodeFromJsonElement<String>(it) },
        senderAddressCountry = rawObject["sender_address_country"]?.let { json.decodeFromJsonElement<String>(it) },
        senderAddressLine1 = rawObject["sender_address_line1"]?.let { json.decodeFromJsonElement<String>(it) },
    ...
    override fun serialize(encoder: Encoder, `value`: SourceTransactionChfCreditTransferData) {
...
public fun sourceTransactionChfCreditTransferData(block: SourceTransactionChfCreditTransferData.Builder.() -> Unit): SourceTransactionChfCreditTransferData = SourceTransactionChfCreditTransferData.build(block)
