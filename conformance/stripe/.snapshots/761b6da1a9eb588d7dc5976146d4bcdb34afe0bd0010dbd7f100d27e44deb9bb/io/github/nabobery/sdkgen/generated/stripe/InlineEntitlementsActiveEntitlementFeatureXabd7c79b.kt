...
public class InlineEntitlementsActiveEntitlementFeatureXabd7c79b internal constructor(
  ...
  public val entitlementsFeature: EntitlementsFeature? by
      lazy(LazyThreadSafetyMode.NONE) { if (inspection.matchesEntitlementsFeature) json.decodeFromJsonElement<EntitlementsFeature>(raw) else null }
  ...
  public val matchedBranches: Set<InlineEntitlementsActiveEntitlementFeatureXabd7c79bBranch>
    get() = buildSet {
      ...
      if (inspection.matchesEntitlementsFeature) add(InlineEntitlementsActiveEntitlementFeatureXabd7c79bBranch.EntitlementsFeature)
    }
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineEntitlementsActiveEntitlementFeatureXabd7c79b {
      val inspection = inspectInlineEntitlementsActiveEntitlementFeatureXabd7c79b(raw)
      if (inspection.matchCount == 0) {
        throw InlineEntitlementsActiveEntitlementFeatureXabd7c79bNoMatchException("InlineEntitlementsActiveEntitlementFeatureXabd7c79b matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineEntitlementsActiveEntitlementFeatureXabd7c79b(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineEntitlementsActiveEntitlementFeatureXabd7c79b> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineEntitlementsActiveEntitlementFeatureXabd7c79b) {
      encoder.requireJsonEncoder("InlineEntitlementsActiveEntitlementFeatureXabd7c79b").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineEntitlementsActiveEntitlementFeatureXabd7c79b(element: JsonElement): InlineEntitlementsActiveEntitlementFeatureXabd7c79bInspection {
