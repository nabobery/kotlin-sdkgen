...
public class InlineV1PaymentLinksGetResponse200JsonX148bd83a(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1PaymentLinksGetResponse200JsonX148bd83a = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1PaymentLinksGetResponse200JsonX148bd83a> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1PaymentLinksGetResponse200JsonX148bd83a {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1PaymentLinksGetResponse200JsonX148bd83a must be a JSON object")
      val data = json.decodeRequired<List<PaymentLink>>(rawObject, "data")
      val hasMore = json.decodeRequired<Boolean>(rawObject, "has_more")
      val objectValue = json.decodeRequired<InlineV1PaymentLinksGetResponse200JsonObjectValueX3fad3fca>(rawObject, "object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1PaymentLinksGetResponse200JsonX148bd83a) {
...
public fun inlineV1PaymentLinksGetResponse200JsonX148bd83a(block: InlineV1PaymentLinksGetResponse200JsonX148bd83a.Builder.() -> Unit): InlineV1PaymentLinksGetResponse200JsonX148bd83a = InlineV1PaymentLinksGetResponse200JsonX148bd83a.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineV1PaymentLinksGetResponse200JsonX148bd83a is missing required property '" + name + "'")
