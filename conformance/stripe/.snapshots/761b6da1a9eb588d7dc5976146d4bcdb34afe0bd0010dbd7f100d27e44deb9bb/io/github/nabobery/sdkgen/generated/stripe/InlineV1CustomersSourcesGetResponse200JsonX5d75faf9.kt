...
public class InlineV1CustomersSourcesGetResponse200JsonX5d75faf9(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1CustomersSourcesGetResponse200JsonX5d75faf9 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1CustomersSourcesGetResponse200JsonX5d75faf9> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1CustomersSourcesGetResponse200JsonX5d75faf9 {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1CustomersSourcesGetResponse200JsonX5d75faf9 must be a JSON object")
      val data = json.decodeRequired<List<InlineV1CustomersSourcesGetResponse200JsonDataItemXcc70a76c>>(rawObject, "data")
      val hasMore = json.decodeRequired<Boolean>(rawObject, "has_more")
      val objectValue = json.decodeRequired<InlineV1CustomersSourcesGetResponse200JsonObjectValueX178c859a>(rawObject, "object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1CustomersSourcesGetResponse200JsonX5d75faf9) {
...
public fun inlineV1CustomersSourcesGetResponse200JsonX5d75faf9(block: InlineV1CustomersSourcesGetResponse200JsonX5d75faf9.Builder.() -> Unit): InlineV1CustomersSourcesGetResponse200JsonX5d75faf9 = InlineV1CustomersSourcesGetResponse200JsonX5d75faf9.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineV1CustomersSourcesGetResponse200JsonX5d75faf9 is missing required property '" + name + "'")
