...
public class InlineTransferDestinationPaymentX1562c10c internal constructor(
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineTransferDestinationPaymentX1562c10c {
      val inspection = inspectInlineTransferDestinationPaymentX1562c10c(raw)
      if (inspection.matchCount == 0) {
        throw InlineTransferDestinationPaymentX1562c10cNoMatchException("InlineTransferDestinationPaymentX1562c10c matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineTransferDestinationPaymentX1562c10c(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineTransferDestinationPaymentX1562c10c> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineTransferDestinationPaymentX1562c10c) {
      encoder.requireJsonEncoder("InlineTransferDestinationPaymentX1562c10c").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineTransferDestinationPaymentX1562c10c(element: JsonElement): InlineTransferDestinationPaymentX1562c10cInspection {
