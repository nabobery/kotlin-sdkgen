...
public class AccountFutureRequirements(
  ...
  public class Builder {
    ...
    public fun build(): AccountFutureRequirements = AccountFutureRequirements(
  ...
  internal object Serializer : KSerializer<AccountFutureRequirements> {
    ...
    override fun deserialize(decoder: Decoder): AccountFutureRequirements {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("AccountFutureRequirements must be a JSON object")
      return AccountFutureRequirements(
        ...
        disabledReason = rawObject["disabled_reason"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineAccountFutureRequirementsDisabledReasonXa6ead16a?>(element) },
    ...
    override fun serialize(encoder: Encoder, `value`: AccountFutureRequirements) {
...
public fun accountFutureRequirements(block: AccountFutureRequirements.Builder.() -> Unit): AccountFutureRequirements = AccountFutureRequirements.build(block)
