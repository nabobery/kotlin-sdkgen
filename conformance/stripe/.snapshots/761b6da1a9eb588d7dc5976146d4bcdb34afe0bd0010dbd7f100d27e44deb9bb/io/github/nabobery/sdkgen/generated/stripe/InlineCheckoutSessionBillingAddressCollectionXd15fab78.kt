...
public sealed class InlineCheckoutSessionBillingAddressCollectionXd15fab78 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineCheckoutSessionBillingAddressCollectionXd15fab78 = when (value) {
      Auto.value -> Auto
  ...
  internal object Serializer : KSerializer<InlineCheckoutSessionBillingAddressCollectionXd15fab78> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineCheckoutSessionBillingAddressCollectionXd15fab78", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineCheckoutSessionBillingAddressCollectionXd15fab78 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineCheckoutSessionBillingAddressCollectionXd15fab78) {
