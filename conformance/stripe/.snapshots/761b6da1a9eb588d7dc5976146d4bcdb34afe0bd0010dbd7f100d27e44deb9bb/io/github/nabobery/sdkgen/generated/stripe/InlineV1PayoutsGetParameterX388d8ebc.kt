...
public class InlineV1PayoutsGetParameterX388d8ebc internal constructor(
  ...
  public val inlineV1PayoutsGetParameterAnyOf1Xbe200ca6: InlineV1PayoutsGetParameterAnyOf1Xbe200ca6?
      by
      lazy(LazyThreadSafetyMode.NONE) { if (inspection.matchesInlineV1PayoutsGetParameterAnyOf1Xbe200ca6) json.decodeFromJsonElement<InlineV1PayoutsGetParameterAnyOf1Xbe200ca6>(raw) else null }
  ...
  public val matchedBranches: Set<InlineV1PayoutsGetParameterX388d8ebcBranch>
    get() = buildSet {
      if (inspection.matchesInlineV1PayoutsGetParameterAnyOf1Xbe200ca6) add(InlineV1PayoutsGetParameterX388d8ebcBranch.InlineV1PayoutsGetParameterAnyOf1Xbe200ca6)
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineV1PayoutsGetParameterX388d8ebc {
      val inspection = inspectInlineV1PayoutsGetParameterX388d8ebc(raw)
      if (inspection.matchCount == 0) {
        throw InlineV1PayoutsGetParameterX388d8ebcNoMatchException("InlineV1PayoutsGetParameterX388d8ebc matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineV1PayoutsGetParameterX388d8ebc(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineV1PayoutsGetParameterX388d8ebc> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1PayoutsGetParameterX388d8ebc) {
      encoder.requireJsonEncoder("InlineV1PayoutsGetParameterX388d8ebc").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineV1PayoutsGetParameterX388d8ebc(element: JsonElement): InlineV1PayoutsGetParameterX388d8ebcInspection {
  val matchesInlineV1PayoutsGetParameterAnyOf1Xbe200ca6 = element.isJsonDecodable<InlineV1PayoutsGetParameterAnyOf1Xbe200ca6>()
  ...
  return InlineV1PayoutsGetParameterX388d8ebcInspection(
    ...
    failures = buildList {
      if (!matchesInlineV1PayoutsGetParameterAnyOf1Xbe200ca6) add("InlineV1PayoutsGetParameterAnyOf1Xbe200ca6: value does not match InlineV1PayoutsGetParameterAnyOf1Xbe200ca6")
