...
public class InlineDisputeEvidenceShippingDocumentationX5192d247 internal constructor(
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineDisputeEvidenceShippingDocumentationX5192d247 {
      val inspection = inspectInlineDisputeEvidenceShippingDocumentationX5192d247(raw)
      if (inspection.matchCount == 0) {
        throw InlineDisputeEvidenceShippingDocumentationX5192d247NoMatchException("InlineDisputeEvidenceShippingDocumentationX5192d247 matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineDisputeEvidenceShippingDocumentationX5192d247(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineDisputeEvidenceShippingDocumentationX5192d247> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineDisputeEvidenceShippingDocumentationX5192d247) {
      encoder.requireJsonEncoder("InlineDisputeEvidenceShippingDocumentationX5192d247").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineDisputeEvidenceShippingDocumentationX5192d247(element: JsonElement): InlineDisputeEvidenceShippingDocumentationX5192d247Inspection {
