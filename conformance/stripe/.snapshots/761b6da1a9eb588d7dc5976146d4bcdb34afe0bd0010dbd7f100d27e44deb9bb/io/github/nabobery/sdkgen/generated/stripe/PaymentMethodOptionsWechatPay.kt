...
public class PaymentMethodOptionsWechatPay(
  ...
  public class Builder {
    ...
    public fun build(): PaymentMethodOptionsWechatPay = PaymentMethodOptionsWechatPay(
      appId = appId,
      client = client,
  ...
  internal object Serializer : KSerializer<PaymentMethodOptionsWechatPay> {
    ...
    override fun deserialize(decoder: Decoder): PaymentMethodOptionsWechatPay {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("PaymentMethodOptionsWechatPay must be a JSON object")
      return PaymentMethodOptionsWechatPay(
        ...
        client = rawObject["client"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlinePaymentMethodOptionsWechatPayClientX1509d3f9?>(element) },
        setupFutureUsage = rawObject["setup_future_usage"]?.let { json.decodeFromJsonElement<InlinePaymentMethodOptionsWechatPaySetupFutureUsageX0df33116>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: PaymentMethodOptionsWechatPay) {
...
public fun paymentMethodOptionsWechatPay(block: PaymentMethodOptionsWechatPay.Builder.() -> Unit): PaymentMethodOptionsWechatPay = PaymentMethodOptionsWechatPay.build(block)
