...
public sealed class InlineTaxSettingsStatusX499abf9f {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineTaxSettingsStatusX499abf9f = when (value) {
      Active.value -> Active
  ...
  internal object Serializer : KSerializer<InlineTaxSettingsStatusX499abf9f> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineTaxSettingsStatusX499abf9f", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineTaxSettingsStatusX499abf9f = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineTaxSettingsStatusX499abf9f) {
