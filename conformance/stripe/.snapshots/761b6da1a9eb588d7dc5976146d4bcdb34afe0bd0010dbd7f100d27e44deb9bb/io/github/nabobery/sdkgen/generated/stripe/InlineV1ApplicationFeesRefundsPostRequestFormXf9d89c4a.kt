...
public class InlineV1ApplicationFeesRefundsPostRequestFormXf9d89c4a(
  ...
  public class Builder {
    ...
    public fun build(): InlineV1ApplicationFeesRefundsPostRequestFormXf9d89c4a = InlineV1ApplicationFeesRefundsPostRequestFormXf9d89c4a(
      amount = amount,
      expand = expand,
      metadata = metadata,
    )
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1ApplicationFeesRefundsPostRequestFormXf9d89c4a = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1ApplicationFeesRefundsPostRequestFormXf9d89c4a> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1ApplicationFeesRefundsPostRequestFormXf9d89c4a {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1ApplicationFeesRefundsPostRequestFormXf9d89c4a must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1ApplicationFeesRefundsPostRequestFormXf9d89c4a) {
...
public fun inlineV1ApplicationFeesRefundsPostRequestFormXf9d89c4a(block: InlineV1ApplicationFeesRefundsPostRequestFormXf9d89c4a.Builder.() -> Unit): InlineV1ApplicationFeesRefundsPostRequestFormXf9d89c4a = InlineV1ApplicationFeesRefundsPostRequestFormXf9d89c4a.build(block)
