...
public sealed class InlineV1AccountsPostRequestFormCompanyStructureX5dfb9a32 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1AccountsPostRequestFormCompanyStructureX5dfb9a32 = when (value) {
      Value.value -> Value
  ...
  internal object Serializer : KSerializer<InlineV1AccountsPostRequestFormCompanyStructureX5dfb9a32> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1AccountsPostRequestFormCompanyStructureX5dfb9a32", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1AccountsPostRequestFormCompanyStructureX5dfb9a32 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1AccountsPostRequestFormCompanyStructureX5dfb9a32) {
