...
public sealed class InlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemTaxBehaviorX8f1093b9 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemTaxBehaviorX8f1093b9 = when (value) {
  ...
  internal object Serializer : KSerializer<InlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemTaxBehaviorX8f1093b9> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemTaxBehaviorX8f1093b9", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemTaxBehaviorX8f1093b9 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1InvoicesCreatePreviewPostRequestFormInvoiceItemsItemTaxBehaviorX8f1093b9) {
