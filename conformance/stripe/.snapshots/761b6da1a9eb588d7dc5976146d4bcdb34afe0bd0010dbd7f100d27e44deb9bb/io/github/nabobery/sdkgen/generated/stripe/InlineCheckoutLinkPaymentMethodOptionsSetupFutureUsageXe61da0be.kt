...
public sealed class InlineCheckoutLinkPaymentMethodOptionsSetupFutureUsageXe61da0be {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineCheckoutLinkPaymentMethodOptionsSetupFutureUsageXe61da0be = when (value) {
      None.value -> None
  ...
  internal object Serializer : KSerializer<InlineCheckoutLinkPaymentMethodOptionsSetupFutureUsageXe61da0be> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineCheckoutLinkPaymentMethodOptionsSetupFutureUsageXe61da0be", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineCheckoutLinkPaymentMethodOptionsSetupFutureUsageXe61da0be = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineCheckoutLinkPaymentMethodOptionsSetupFutureUsageXe61da0be) {
