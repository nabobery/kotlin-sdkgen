...
public class InlineV1FileLinksPostRequestFormMetadataX293f2b96 internal constructor(
  ...
  public val inlineV1FileLinksPostRequestFormMetadataAnyOf2Xf4d0177f:
      ...
      lazy(LazyThreadSafetyMode.NONE) { if (inspection.matchesInlineV1FileLinksPostRequestFormMetadataAnyOf2Xf4d0177f) json.decodeFromJsonElement<InlineV1FileLinksPostRequestFormMetadataAnyOf2Xf4d0177f>(raw) else null }
  ...
  public val matchedBranches: Set<InlineV1FileLinksPostRequestFormMetadataX293f2b96Branch>
    get() = buildSet {
      ...
      if (inspection.matchesInlineV1FileLinksPostRequestFormMetadataAnyOf2Xf4d0177f) add(InlineV1FileLinksPostRequestFormMetadataX293f2b96Branch.InlineV1FileLinksPostRequestFormMetadataAnyOf2Xf4d0177f)
    }
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineV1FileLinksPostRequestFormMetadataX293f2b96 {
      val inspection = inspectInlineV1FileLinksPostRequestFormMetadataX293f2b96(raw)
      if (inspection.matchCount == 0) {
        throw InlineV1FileLinksPostRequestFormMetadataX293f2b96NoMatchException("InlineV1FileLinksPostRequestFormMetadataX293f2b96 matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineV1FileLinksPostRequestFormMetadataX293f2b96(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineV1FileLinksPostRequestFormMetadataX293f2b96> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1FileLinksPostRequestFormMetadataX293f2b96) {
      encoder.requireJsonEncoder("InlineV1FileLinksPostRequestFormMetadataX293f2b96").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineV1FileLinksPostRequestFormMetadataX293f2b96(element: JsonElement): InlineV1FileLinksPostRequestFormMetadataX293f2b96Inspection {
  val matchesBranch1 = element.isJsonDecodable<JsonObject>()
  val matchesInlineV1FileLinksPostRequestFormMetadataAnyOf2Xf4d0177f = element.isJsonDecodable<InlineV1FileLinksPostRequestFormMetadataAnyOf2Xf4d0177f>()
  return InlineV1FileLinksPostRequestFormMetadataX293f2b96Inspection(
    ...
    failures = buildList {
      ...
      if (!matchesInlineV1FileLinksPostRequestFormMetadataAnyOf2Xf4d0177f) add("InlineV1FileLinksPostRequestFormMetadataAnyOf2Xf4d0177f: value does not match InlineV1FileLinksPostRequestFormMetadataAnyOf2Xf4d0177f")
    },
  )
}
