...
public sealed class InlineCustomerBalanceTransactionObjectValueXfd80c0ef {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineCustomerBalanceTransactionObjectValueXfd80c0ef = when (value) {
      CustomerBalanceTransaction.value -> CustomerBalanceTransaction
      else -> SdkUnknown(value)
    }
  }

  internal object Serializer : KSerializer<InlineCustomerBalanceTransactionObjectValueXfd80c0ef> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineCustomerBalanceTransactionObjectValueXfd80c0ef", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineCustomerBalanceTransactionObjectValueXfd80c0ef = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineCustomerBalanceTransactionObjectValueXfd80c0ef) {
