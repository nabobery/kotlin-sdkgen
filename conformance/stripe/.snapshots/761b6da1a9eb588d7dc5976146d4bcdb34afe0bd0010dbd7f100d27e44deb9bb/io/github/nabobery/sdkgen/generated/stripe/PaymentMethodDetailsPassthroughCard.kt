...
public class PaymentMethodDetailsPassthroughCard(
  ...
  public class Builder {
    ...
    public fun build(): PaymentMethodDetailsPassthroughCard = PaymentMethodDetailsPassthroughCard(
      brand = brand,
      country = country,
      expMonth = expMonth,
      expYear = expYear,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): PaymentMethodDetailsPassthroughCard = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<PaymentMethodDetailsPassthroughCard> {
    ...
    override fun deserialize(decoder: Decoder): PaymentMethodDetailsPassthroughCard {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("PaymentMethodDetailsPassthroughCard must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: PaymentMethodDetailsPassthroughCard) {
...
public fun paymentMethodDetailsPassthroughCard(block: PaymentMethodDetailsPassthroughCard.Builder.() -> Unit): PaymentMethodDetailsPassthroughCard = PaymentMethodDetailsPassthroughCard.build(block)
