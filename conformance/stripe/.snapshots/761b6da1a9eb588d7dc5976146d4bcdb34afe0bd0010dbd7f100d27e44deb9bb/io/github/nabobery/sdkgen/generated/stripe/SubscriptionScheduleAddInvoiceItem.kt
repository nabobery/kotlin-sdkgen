...
public class SubscriptionScheduleAddInvoiceItem(
  ...
  internal object Serializer : KSerializer<SubscriptionScheduleAddInvoiceItem> {
    ...
    override fun deserialize(decoder: Decoder): SubscriptionScheduleAddInvoiceItem {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("SubscriptionScheduleAddInvoiceItem must be a JSON object")
      val discounts = json.decodeRequired<List<DiscountsResourceStackableDiscountWithDiscountEnd>>(rawObject, "discounts")
      ...
      return SubscriptionScheduleAddInvoiceItem(
        ...
        period = period,
        price = price,
        discountable = rawObject["discountable"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<Boolean?>(element) },
    ...
    override fun serialize(encoder: Encoder, `value`: SubscriptionScheduleAddInvoiceItem) {
...
public fun subscriptionScheduleAddInvoiceItem(block: SubscriptionScheduleAddInvoiceItem.Builder.() -> Unit): SubscriptionScheduleAddInvoiceItem = SubscriptionScheduleAddInvoiceItem.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("SubscriptionScheduleAddInvoiceItem is missing required property '" + name + "'")
