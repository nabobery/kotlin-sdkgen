...
public sealed class InlineMandatePixPaymentScheduleX3970c16e {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineMandatePixPaymentScheduleX3970c16e = when (value) {
  ...
  internal object Serializer : KSerializer<InlineMandatePixPaymentScheduleX3970c16e> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineMandatePixPaymentScheduleX3970c16e", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineMandatePixPaymentScheduleX3970c16e = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineMandatePixPaymentScheduleX3970c16e) {
