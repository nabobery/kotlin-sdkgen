...
public data class DisputeVisaCompellingEvidence3DisputedTransactionView(
  ...
  public val merchandiseOrServices:
      InlineDisputeVisaCompellinb4beMerchandiseOrServicesX2426c79d? = null,
...
public class DisputeVisaCompellingEvidence3DisputedTransaction(
  ...
  public class Builder {
    ...
    public fun build(): DisputeVisaCompellingEvidence3DisputedTransaction = DisputeVisaCompellingEvidence3DisputedTransaction(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): DisputeVisaCompellingEvidence3DisputedTransaction = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<DisputeVisaCompellingEvidence3DisputedTransaction> {
    ...
    override fun deserialize(decoder: Decoder): DisputeVisaCompellingEvidence3DisputedTransaction {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("DisputeVisaCompellingEvidence3DisputedTransaction must be a JSON object")
      return DisputeVisaCompellingEvidence3DisputedTransaction(
        ...
        merchandiseOrServices = rawObject["merchandise_or_services"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineDisputeVisaCompellinb4beMerchandiseOrServicesX2426c79d?>(element) },
        ...
        shippingAddress = rawObject["shipping_address"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineDisputeVisaCompellingEvidence3DisputedTransactionShippingAddressXd74f38cb?>(element) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: DisputeVisaCompellingEvidence3DisputedTransaction) {
...
public fun disputeVisaCompellingEvidence3DisputedTransaction(block: DisputeVisaCompellingEvidence3DisputedTransaction.Builder.() -> Unit): DisputeVisaCompellingEvidence3DisputedTransaction = DisputeVisaCompellingEvidence3DisputedTransaction.build(block)
