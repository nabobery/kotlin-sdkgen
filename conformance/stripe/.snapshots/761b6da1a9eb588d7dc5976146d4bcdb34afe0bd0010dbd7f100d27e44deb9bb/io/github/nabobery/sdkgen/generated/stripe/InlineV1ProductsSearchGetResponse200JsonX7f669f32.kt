...
public class InlineV1ProductsSearchGetResponse200JsonX7f669f32(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1ProductsSearchGetResponse200JsonX7f669f32 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1ProductsSearchGetResponse200JsonX7f669f32> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1ProductsSearchGetResponse200JsonX7f669f32 {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1ProductsSearchGetResponse200JsonX7f669f32 must be a JSON object")
      val data = json.decodeRequired<List<Product>>(rawObject, "data")
      val hasMore = json.decodeRequired<Boolean>(rawObject, "has_more")
      val objectValue = json.decodeRequired<InlineV1ProductsSearchGetResponse200JsonObjectValueX79be551b>(rawObject, "object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1ProductsSearchGetResponse200JsonX7f669f32) {
...
public fun inlineV1ProductsSearchGetResponse200JsonX7f669f32(block: InlineV1ProductsSearchGetResponse200JsonX7f669f32.Builder.() -> Unit): InlineV1ProductsSearchGetResponse200JsonX7f669f32 = InlineV1ProductsSearchGetResponse200JsonX7f669f32.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineV1ProductsSearchGetResponse200JsonX7f669f32 is missing required property '" + name + "'")
