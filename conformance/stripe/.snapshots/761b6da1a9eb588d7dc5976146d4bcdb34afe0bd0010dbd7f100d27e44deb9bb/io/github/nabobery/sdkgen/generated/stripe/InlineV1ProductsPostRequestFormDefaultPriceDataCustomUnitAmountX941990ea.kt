...
public class InlineV1ProductsPostRequestFormDefaultPriceDataCustomUnitAmountX941990ea(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1ProductsPostRequestFormDefaultPriceDataCustomUnitAmountX941990ea = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1ProductsPostRequestFormDefaultPriceDataCustomUnitAmountX941990ea> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineV1ProductsPostRequestFormDefaultPriceDataCustomUnitAmountX941990ea {
      val jsonDecoder = decoder.requireJsonDecoder("InlineV1ProductsPostRequestFormDefaultPriceDataCustomUnitAmountX941990ea")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1ProductsPostRequestFormDefaultPriceDataCustomUnitAmountX941990ea must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1ProductsPostRequestFormDefaultPriceDataCustomUnitAmountX941990ea) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineV1ProductsPostRequestFormDefaultPriceDataCustomUnitAmountX941990ea")
...
public fun inlineV1ProductsPostRequestFormDefaultPriceDataCustomUnitAmountX941990ea(block: InlineV1ProductsPostRequestFormDefaultPriceDataCustomUnitAmountX941990ea.Builder.() -> Unit): InlineV1ProductsPostRequestFormDefaultPriceDataCustomUnitAmountX941990ea = InlineV1ProductsPostRequestFormDefaultPriceDataCustomUnitAmountX941990ea.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineV1ProductsPostRequestFormDefaultPriceDataCustomUnitAmountX941990ea is missing required property '" + name + "'")
