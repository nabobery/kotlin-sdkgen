...
public sealed class InlineBankConnectionsResourceBalanceRefreshStatusX70dc5746 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineBankConnectionsResourceBalanceRefreshStatusX70dc5746 = when (value) {
      Failed.value -> Failed
  ...
  internal object Serializer : KSerializer<InlineBankConnectionsResourceBalanceRefreshStatusX70dc5746> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineBankConnectionsResourceBalanceRefreshStatusX70dc5746", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineBankConnectionsResourceBalanceRefreshStatusX70dc5746 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineBankConnectionsResourceBalanceRefreshStatusX70dc5746) {
