...
public class InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsX1e08fc5e(
  ...
  public val affirm:
      InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAffirmX9e5f074f? = null,
  public val afterpayClearpay:
      InlineV1PaymentIntentsPostRequestFormAfterpayClearpayX6b0e7ef6? = null,
  public val alipay:
      InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAlipayX38de3857? = null,
  ...
  public val billie:
      InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsBillieXa8d91d93? = null,
  ...
  public val boleto:
      InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsBoletoXc328cbeb? = null,
  ...
  public val cashapp:
      InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsCashappX9c19f394? = null,
  public val crypto:
      InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsCryptoXaf261f95? = null,
  ...
  public val giropay:
      InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsGiropayX53e72dc7? = null,
  public val grabpay:
      InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsGrabpayXf2d95365? = null,
  ...
  public val kakaoPay:
      InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKakaoPayXe838832b? = null,
  public val klarna:
      InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKlarnaXa532cb7c? = null,
  public val konbini:
      InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKonbiniXe8ab309b? = null,
  public val krCard:
      InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKrCardXe9f82caa? = null,
  ...
  public val naverPay:
      InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsNaverPayX78865735? = null,
  ...
  public val paynow:
      InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPaynowX462e2f21? = null,
  public val paypal:
      InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPaypalX6cc3fb8d? = null,
  ...
  public val satispay:
      InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsSatispayX76831b17? = null,
  public val scalapay:
      InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsScalapayX53b5a46b? = null,
  public val sepaDebit:
      InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsSepaDebitX39257688? = null,
  public val sofort:
      InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsSofortX0d9038d5? = null,
  public val sunbit:
      InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsSunbitXe1de5f4f? = null,
  ...
  public class Builder {
    ...
    public fun build(): InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsX1e08fc5e = InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsX1e08fc5e(
      acssDebit = acssDebit,
      affirm = affirm,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsX1e08fc5e = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsX1e08fc5e> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsX1e08fc5e {
      val jsonDecoder = decoder.requireJsonDecoder("InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsX1e08fc5e")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsX1e08fc5e must be a JSON object")
      return InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsX1e08fc5e(
        acssDebit = rawObject["acss_debit"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAcssDebitXadb3736b>(it) },
        affirm = rawObject["affirm"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAffirmX9e5f074f>(it) },
        afterpayClearpay = rawObject["afterpay_clearpay"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormAfterpayClearpayX6b0e7ef6>(it) },
        alipay = rawObject["alipay"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAlipayX38de3857>(it) },
        alma = rawObject["alma"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAlmaXbf4acc1c>(it) },
        amazonPay = rawObject["amazon_pay"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAmazonPayX37380d7b>(it) },
        auBecsDebit = rawObject["au_becs_debit"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAuBecsDebitXd59e6e33>(it) },
        bacsDebit = rawObject["bacs_debit"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsBacsDebitX28ffc4fd>(it) },
        bancontact = rawObject["bancontact"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsBancontactXdd58d3ab>(it) },
        billie = rawObject["billie"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsBillieXa8d91d93>(it) },
        bizum = rawObject["bizum"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsBizumXede2a279>(it) },
        blik = rawObject["blik"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsBlikX0f5e8475>(it) },
        boleto = rawObject["boleto"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsBoletoXc328cbeb>(it) },
        card = rawObject["card"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsCardX2d3e097f>(it) },
        cardPresent = rawObject["card_present"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsCardPresentX59c2a9ce>(it) },
        cashapp = rawObject["cashapp"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsCashappX9c19f394>(it) },
        crypto = rawObject["crypto"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsCryptoXaf261f95>(it) },
        customerBalance = rawObject["customer_balance"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormCustomerBalanceX17714256>(it) },
        eps = rawObject["eps"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsEpsX2981f002>(it) },
        fpx = rawObject["fpx"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsFpxX22e07062>(it) },
        giropay = rawObject["giropay"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsGiropayX53e72dc7>(it) },
        grabpay = rawObject["grabpay"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsGrabpayXf2d95365>(it) },
        ideal = rawObject["ideal"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsIdealXdfa7bf6a>(it) },
        interacPresent = rawObject["interac_present"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsInteracPresentX58af8d32>(it) },
        kakaoPay = rawObject["kakao_pay"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKakaoPayXe838832b>(it) },
        klarna = rawObject["klarna"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKlarnaXa532cb7c>(it) },
        konbini = rawObject["konbini"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKonbiniXe8ab309b>(it) },
        krCard = rawObject["kr_card"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKrCardXe9f82caa>(it) },
        link = rawObject["link"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsLinkX8626f40a>(it) },
        mbWay = rawObject["mb_way"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsMbWayX6a77d8f2>(it) },
        mobilepay = rawObject["mobilepay"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsMobilepayX14f3580b>(it) },
        multibanco = rawObject["multibanco"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsMultibancoX248e507b>(it) },
        naverPay = rawObject["naver_pay"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsNaverPayX78865735>(it) },
        nzBankAccount = rawObject["nz_bank_account"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsNzBankAccountX38a59941>(it) },
        oxxo = rawObject["oxxo"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsOxxoXe73bd318>(it) },
        p24 = rawObject["p24"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsP24Xc874aadb>(it) },
        payByBank = rawObject["pay_by_bank"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPayByBankXa2da8749>(it) },
        payco = rawObject["payco"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPaycoX1cb2fa2a>(it) },
        paynow = rawObject["paynow"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPaynowX462e2f21>(it) },
        paypal = rawObject["paypal"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPaypalX6cc3fb8d>(it) },
        payto = rawObject["payto"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPaytoXc6ed2c30>(it) },
        pix = rawObject["pix"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPixX2680e506>(it) },
        promptpay = rawObject["promptpay"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsPromptpayX421583bd>(it) },
        revolutPay = rawObject["revolut_pay"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsRevolutPayXb9b28deb>(it) },
        samsungPay = rawObject["samsung_pay"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsSamsungPayXeaadb66c>(it) },
        satispay = rawObject["satispay"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsSatispayX76831b17>(it) },
        scalapay = rawObject["scalapay"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsScalapayX53b5a46b>(it) },
        sepaDebit = rawObject["sepa_debit"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsSepaDebitX39257688>(it) },
        sofort = rawObject["sofort"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsSofortX0d9038d5>(it) },
        sunbit = rawObject["sunbit"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsSunbitXe1de5f4f>(it) },
        swish = rawObject["swish"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsSwishXa96f5b98>(it) },
        twint = rawObject["twint"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsTwintXe92cccd2>(it) },
        upi = rawObject["upi"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsUpiX1e35b977>(it) },
        usBankAccount = rawObject["us_bank_account"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsUsBankAccountX3f2e943d>(it) },
        wechatPay = rawObject["wechat_pay"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsWechatPayX19b781ab>(it) },
        zip = rawObject["zip"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsZipX65f56a82>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsX1e08fc5e) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsX1e08fc5e")
...
public fun inlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsX1e08fc5e(block: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsX1e08fc5e.Builder.() -> Unit): InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsX1e08fc5e = InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsX1e08fc5e.build(block)
