...
public sealed class InlineOutboundTransfersPaymentMethodDetailsTypeX3cfd6f32 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineOutboundTransfersPaymentMethodDetailsTypeX3cfd6f32 = when (value) {
  ...
  internal object Serializer : KSerializer<InlineOutboundTransfersPaymentMethodDetailsTypeX3cfd6f32> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineOutboundTransfersPaymentMethodDetailsTypeX3cfd6f32", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineOutboundTransfersPaymentMethodDetailsTypeX3cfd6f32 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineOutboundTransfersPaymentMethodDetailsTypeX3cfd6f32) {
