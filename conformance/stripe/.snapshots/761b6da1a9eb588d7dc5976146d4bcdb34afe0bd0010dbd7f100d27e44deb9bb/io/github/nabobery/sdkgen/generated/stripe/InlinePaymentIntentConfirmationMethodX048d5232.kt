...
public sealed class InlinePaymentIntentConfirmationMethodX048d5232 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlinePaymentIntentConfirmationMethodX048d5232 = when (value) {
  ...
  internal object Serializer : KSerializer<InlinePaymentIntentConfirmationMethodX048d5232> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlinePaymentIntentConfirmationMethodX048d5232", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlinePaymentIntentConfirmationMethodX048d5232 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlinePaymentIntentConfirmationMethodX048d5232) {
