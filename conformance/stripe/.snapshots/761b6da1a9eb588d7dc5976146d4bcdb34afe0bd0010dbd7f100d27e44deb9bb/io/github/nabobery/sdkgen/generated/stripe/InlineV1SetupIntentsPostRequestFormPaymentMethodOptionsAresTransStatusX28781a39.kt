...
public sealed class InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsAresTransStatusX28781a39 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsAresTransStatusX28781a39 = when (value) {
      A.value -> A
      C.value -> C
      I.value -> I
      N.value -> N
  ...
  internal object Serializer : KSerializer<InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsAresTransStatusX28781a39> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsAresTransStatusX28781a39", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsAresTransStatusX28781a39 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsAresTransStatusX28781a39) {
