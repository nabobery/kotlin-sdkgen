...
public sealed class InlineCreditNoteTypeX53cc7c94 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineCreditNoteTypeX53cc7c94 = when (value) {
      Mixed.value -> Mixed
  ...
  internal object Serializer : KSerializer<InlineCreditNoteTypeX53cc7c94> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineCreditNoteTypeX53cc7c94", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineCreditNoteTypeX53cc7c94 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineCreditNoteTypeX53cc7c94) {
