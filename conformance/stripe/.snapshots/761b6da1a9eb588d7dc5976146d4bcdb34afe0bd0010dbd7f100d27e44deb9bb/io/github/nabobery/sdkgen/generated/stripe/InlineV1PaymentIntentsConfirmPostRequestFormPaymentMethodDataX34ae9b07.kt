 ...
 * www-form-urlencoded/schema/properties/payment_method_data
 */
@Serializable(with = InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataX34ae9b07.Serializer::class)
public class InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataX34ae9b07(
  public val type: InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataTypeX046b2889,
  public val acssDebit:
      InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataAcssDebitX8d5f67d1? = null,
  ...
  public val allowRedisplay:
      InlineV1PaymentIntentsConfirmPostRequestFormAllowRedisplayX05aee8f8? = null,
  public val alma: JsonObject? = null,
  public val amazonPay: JsonObject? = null,
  public val auBecsDebit: InlineV1PaymentIntentsConfirmPostRequestFormAuBecsDebitX935d2e91? = null,
  public val bacsDebit:
      InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataBacsDebitX0683c000? = null,
  public val bancontact: JsonObject? = null,
  public val billie: JsonObject? = null,
  public val billingDetails:
      InlineV1PaymentIntentsConfirmPostRequestFormBillingDetailsX890d2399? = null,
  public val bizum: JsonObject? = null,
  public val blik: JsonObject? = null,
  public val boleto:
      InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataBoletoXd8d9ea3a? = null,
  public val cashapp: JsonObject? = null,
  public val crypto: JsonObject? = null,
  public val customerBalance: JsonObject? = null,
  public val eps: InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataEpsX877c2fb5? = null,
  public val fpx: InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataFpxX6b7277a7? = null,
  public val giropay: JsonObject? = null,
  public val grabpay: JsonObject? = null,
  public val ideal:
      InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataIdealX1586b560? = null,
  public val interacPresent: JsonObject? = null,
  public val kakaoPay: JsonObject? = null,
  public val klarna:
      InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataKlarnaX8d1d10d3? = null,
  ...
  public val naverPay:
      InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataNaverPayXf6a0a08b? = null,
  public val nzBankAccount:
      InlineV1PaymentIntentsConfirmPostRequestFormNzBankAccountX4d30acf2? = null,
  public val oxxo: JsonObject? = null,
  public val p24: InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataP24X9d28c532? = null,
  ...
  public val payto:
      InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataPaytoX0af9181d? = null,
  public val pix: JsonObject? = null,
  public val promptpay: JsonObject? = null,
  public val radarOptions:
      InlineV1PaymentIntentsConfirmPostRequestFormRadarOptionsX9a7ca3fe? = null,
  ...
  public val sepaDebit:
      InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataSepaDebitXa7ba3111? = null,
  public val sofort:
      InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataSofortXf2040d76? = null,
  public val sunbit: JsonObject? = null,
  public val swish: JsonObject? = null,
  public val twint: JsonObject? = null,
  public val upi: InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataUpiXe2281e23? = null,
  public val usBankAccount:
      InlineV1PaymentIntentsConfirmPostRequestFormUsBankAccountX09ce459b? = null,
  ...
  public class Builder {
    private var typeValue:
        InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataTypeX046b2889? = null

    public var type: InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataTypeX046b2889
    ...
    public var allowRedisplay: InlineV1PaymentIntentsConfirmPostRequestFormAllowRedisplayX05aee8f8?
        = null
    ...
    public var auBecsDebit: InlineV1PaymentIntentsConfirmPostRequestFormAuBecsDebitX935d2e91? = null
    ...
    public var billingDetails: InlineV1PaymentIntentsConfirmPostRequestFormBillingDetailsX890d2399?
        = null
    ...
    public var boleto: InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataBoletoXd8d9ea3a?
        = null
    ...
    public var eps: InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataEpsX877c2fb5? =
        null

    public var fpx: InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataFpxX6b7277a7? =
        null
    ...
    public var ideal: InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataIdealX1586b560? =
        null
    ...
    public var klarna: InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataKlarnaX8d1d10d3?
        = null
    ...
    public var nzBankAccount: InlineV1PaymentIntentsConfirmPostRequestFormNzBankAccountX4d30acf2? =
        null

    public var oxxo: JsonObject? = null

    public var p24: InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataP24X9d28c532? =
        null
    ...
    public var payto: InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataPaytoX0af9181d? =
        null
    ...
    public var radarOptions: InlineV1PaymentIntentsConfirmPostRequestFormRadarOptionsX9a7ca3fe? =
        null
    ...
    public var sofort: InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataSofortXf2040d76?
        = null
    ...
    public var upi: InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataUpiXe2281e23? =
        null

    public var usBankAccount: InlineV1PaymentIntentsConfirmPostRequestFormUsBankAccountX09ce459b? =
        null
    ...
    public fun build(): InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataX34ae9b07 {
      check(typeValue != null) { "type is required" }
      return InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataX34ae9b07(
        type = type,
        acssDebit = acssDebit,
        affirm = affirm,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataX34ae9b07 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataX34ae9b07> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataX34ae9b07 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataX34ae9b07")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataX34ae9b07 must be a JSON object")
      val type = json.decodeRequired<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataTypeX046b2889>(rawObject, "type")
      return InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataX34ae9b07(
        type = type,
        acssDebit = rawObject["acss_debit"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataAcssDebitX8d5f67d1>(it) },
        ...
        allowRedisplay = rawObject["allow_redisplay"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormAllowRedisplayX05aee8f8>(it) },
        ...
        auBecsDebit = rawObject["au_becs_debit"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormAuBecsDebitX935d2e91>(it) },
        bacsDebit = rawObject["bacs_debit"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataBacsDebitX0683c000>(it) },
        ...
        billingDetails = rawObject["billing_details"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormBillingDetailsX890d2399>(it) },
        ...
        boleto = rawObject["boleto"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataBoletoXd8d9ea3a>(it) },
        ...
        eps = rawObject["eps"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataEpsX877c2fb5>(it) },
        fpx = rawObject["fpx"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataFpxX6b7277a7>(it) },
        ...
        ideal = rawObject["ideal"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataIdealX1586b560>(it) },
        ...
        klarna = rawObject["klarna"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataKlarnaX8d1d10d3>(it) },
        ...
        naverPay = rawObject["naver_pay"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataNaverPayXf6a0a08b>(it) },
        nzBankAccount = rawObject["nz_bank_account"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormNzBankAccountX4d30acf2>(it) },
        oxxo = rawObject["oxxo"]?.let { json.decodeFromJsonElement<JsonObject>(it) },
        p24 = rawObject["p24"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataP24X9d28c532>(it) },
        ...
        payto = rawObject["payto"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataPaytoX0af9181d>(it) },
        ...
        radarOptions = rawObject["radar_options"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormRadarOptionsX9a7ca3fe>(it) },
        ...
        sepaDebit = rawObject["sepa_debit"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataSepaDebitXa7ba3111>(it) },
        sofort = rawObject["sofort"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataSofortXf2040d76>(it) },
        ...
        upi = rawObject["upi"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataUpiXe2281e23>(it) },
        usBankAccount = rawObject["us_bank_account"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormUsBankAccountX09ce459b>(it) },
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataX34ae9b07) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataX34ae9b07")
...
public fun inlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataX34ae9b07(block: InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataX34ae9b07.Builder.() -> Unit): InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataX34ae9b07 = InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataX34ae9b07.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodDataX34ae9b07 is missing required property '" + name + "'")
