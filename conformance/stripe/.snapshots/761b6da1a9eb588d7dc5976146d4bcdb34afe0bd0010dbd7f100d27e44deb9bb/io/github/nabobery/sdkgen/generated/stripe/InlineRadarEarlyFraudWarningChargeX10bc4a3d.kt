...
public class InlineRadarEarlyFraudWarningChargeX10bc4a3d internal constructor(
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineRadarEarlyFraudWarningChargeX10bc4a3d {
      val inspection = inspectInlineRadarEarlyFraudWarningChargeX10bc4a3d(raw)
      if (inspection.matchCount == 0) {
        throw InlineRadarEarlyFraudWarningChargeX10bc4a3dNoMatchException("InlineRadarEarlyFraudWarningChargeX10bc4a3d matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineRadarEarlyFraudWarningChargeX10bc4a3d(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineRadarEarlyFraudWarningChargeX10bc4a3d> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineRadarEarlyFraudWarningChargeX10bc4a3d) {
      encoder.requireJsonEncoder("InlineRadarEarlyFraudWarningChargeX10bc4a3d").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineRadarEarlyFraudWarningChargeX10bc4a3d(element: JsonElement): InlineRadarEarlyFraudWarningChargeX10bc4a3dInspection {
