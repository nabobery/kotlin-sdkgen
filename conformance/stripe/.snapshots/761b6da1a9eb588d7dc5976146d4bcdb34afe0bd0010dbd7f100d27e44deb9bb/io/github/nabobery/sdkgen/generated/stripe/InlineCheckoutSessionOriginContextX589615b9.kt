...
public sealed class InlineCheckoutSessionOriginContextX589615b9 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineCheckoutSessionOriginContextX589615b9 = when (value) {
  ...
  internal object Serializer : KSerializer<InlineCheckoutSessionOriginContextX589615b9> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineCheckoutSessionOriginContextX589615b9", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineCheckoutSessionOriginContextX589615b9 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineCheckoutSessionOriginContextX589615b9) {
