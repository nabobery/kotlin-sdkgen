...
@Serializable
public data class FeeRefundView internal constructor(
...
public class FeeRefund(
  ...
  internal object Serializer : KSerializer<FeeRefund> {
    ...
    override fun deserialize(decoder: Decoder): FeeRefund {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("FeeRefund must be a JSON object")
      ...
      return FeeRefund(
        ...
        id = id,
        objectValue = objectValue,
        balanceTransaction = rawObject["balance_transaction"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineFeeRefundBalanceTransactionX75308484?>(element) },
    ...
    override fun serialize(encoder: Encoder, `value`: FeeRefund) {
