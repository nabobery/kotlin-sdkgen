...
public class InlineV1CustomersSourcesPostRequestFormCardXaca4ebd8 internal constructor(
  ...
  public val inlineV1CustomersSourcesPostRequestFormCardAnyOf1Xe829b03e:
      ...
      lazy(LazyThreadSafetyMode.NONE) { if (inspection.matchesInlineV1CustomersSourcesPostRequestFormCardAnyOf1Xe829b03e) json.decodeFromJsonElement<InlineV1CustomersSourcesPostRequestFormCardAnyOf1Xe829b03e>(raw) else null }
  ...
  public val matchedBranches: Set<InlineV1CustomersSourcesPostRequestFormCardXaca4ebd8Branch>
    get() = buildSet {
      if (inspection.matchesInlineV1CustomersSourcesPostRequestFormCardAnyOf1Xe829b03e) add(InlineV1CustomersSourcesPostRequestFormCardXaca4ebd8Branch.InlineV1CustomersSourcesPostRequestFormCardAnyOf1Xe829b03e)
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineV1CustomersSourcesPostRequestFormCardXaca4ebd8 {
      val inspection = inspectInlineV1CustomersSourcesPostRequestFormCardXaca4ebd8(raw)
      if (inspection.matchCount == 0) {
        throw InlineV1CustomersSourcesPostRequestFormCardXaca4ebd8NoMatchException("InlineV1CustomersSourcesPostRequestFormCardXaca4ebd8 matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineV1CustomersSourcesPostRequestFormCardXaca4ebd8(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineV1CustomersSourcesPostRequestFormCardXaca4ebd8> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1CustomersSourcesPostRequestFormCardXaca4ebd8) {
      encoder.requireJsonEncoder("InlineV1CustomersSourcesPostRequestFormCardXaca4ebd8").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineV1CustomersSourcesPostRequestFormCardXaca4ebd8(element: JsonElement): InlineV1CustomersSourcesPostRequestFormCardXaca4ebd8Inspection {
  val matchesInlineV1CustomersSourcesPostRequestFormCardAnyOf1Xe829b03e = element.isJsonDecodable<InlineV1CustomersSourcesPostRequestFormCardAnyOf1Xe829b03e>()
  ...
  return InlineV1CustomersSourcesPostRequestFormCardXaca4ebd8Inspection(
    ...
    failures = buildList {
      if (!matchesInlineV1CustomersSourcesPostRequestFormCardAnyOf1Xe829b03e) add("InlineV1CustomersSourcesPostRequestFormCardAnyOf1Xe829b03e: value does not match InlineV1CustomersSourcesPostRequestFormCardAnyOf1Xe829b03e")
