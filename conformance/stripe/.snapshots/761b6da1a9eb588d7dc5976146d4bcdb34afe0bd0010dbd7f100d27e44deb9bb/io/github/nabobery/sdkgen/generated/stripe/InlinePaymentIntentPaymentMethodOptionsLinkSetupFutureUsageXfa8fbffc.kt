...
public sealed class InlinePaymentIntentPaymentMethodOptionsLinkSetupFutureUsageXfa8fbffc {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlinePaymentIntentPaymentMethodOptionsLinkSetupFutureUsageXfa8fbffc = when (value) {
      None.value -> None
  ...
  internal object Serializer : KSerializer<InlinePaymentIntentPaymentMethodOptionsLinkSetupFutureUsageXfa8fbffc> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlinePaymentIntentPaymentMethodOptionsLinkSetupFutureUsageXfa8fbffc", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlinePaymentIntentPaymentMethodOptionsLinkSetupFutureUsageXfa8fbffc = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlinePaymentIntentPaymentMethodOptionsLinkSetupFutureUsageXfa8fbffc) {
