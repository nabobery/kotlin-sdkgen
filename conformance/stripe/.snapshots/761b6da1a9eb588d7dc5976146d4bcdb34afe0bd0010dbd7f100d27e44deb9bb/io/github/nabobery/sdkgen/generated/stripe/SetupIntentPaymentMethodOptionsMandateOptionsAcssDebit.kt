...
public class SetupIntentPaymentMethodOptionsMandateOptionsAcssDebit(
  ...
  defaultFor: List<InlineSetupIntentPaymentMe30d4DefaultForItemXd3847b16>? = null,
  /**
   ...
   */
  public val defaultFor: List<InlineSetupIntentPaymentMe30d4DefaultForItemXd3847b16>? =
  ...
  public class Builder {
    ...
    private var defaultForValue: List<InlineSetupIntentPaymentMe30d4DefaultForItemXd3847b16>? = null

    /**
     * List of Stripe products where this mandate can be selected automatically.
     */
    public var defaultFor: List<InlineSetupIntentPaymentMe30d4DefaultForItemXd3847b16>?
    ...
    public fun build(): SetupIntentPaymentMethodOptionsMandateOptionsAcssDebit = SetupIntentPaymentMethodOptionsMandateOptionsAcssDebit(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): SetupIntentPaymentMethodOptionsMandateOptionsAcssDebit = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<SetupIntentPaymentMethodOptionsMandateOptionsAcssDebit> {
    ...
    override fun deserialize(decoder: Decoder): SetupIntentPaymentMethodOptionsMandateOptionsAcssDebit {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("SetupIntentPaymentMethodOptionsMandateOptionsAcssDebit must be a JSON object")
      return SetupIntentPaymentMethodOptionsMandateOptionsAcssDebit(
        ...
        defaultFor = rawObject["default_for"]?.let { json.decodeFromJsonElement<List<InlineSetupIntentPaymentMe30d4DefaultForItemXd3847b16>>(it) },
        ...
        paymentSchedule = rawObject["payment_schedule"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineSetupIntentPaymentMe30d4PaymentScheduleXc436d59f?>(element) },
        transactionType = rawObject["transaction_type"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineSetupIntentPaymentMe30d4TransactionTypeX9254f557?>(element) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: SetupIntentPaymentMethodOptionsMandateOptionsAcssDebit) {
...
public fun setupIntentPaymentMethodOptionsMandateOptionsAcssDebit(block: SetupIntentPaymentMethodOptionsMandateOptionsAcssDebit.Builder.() -> Unit): SetupIntentPaymentMethodOptionsMandateOptionsAcssDebit = SetupIntentPaymentMethodOptionsMandateOptionsAcssDebit.build(block)
