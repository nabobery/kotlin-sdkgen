...
public class BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoided(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoided = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoided> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoided {
      val jsonDecoder = decoder.requireJsonDecoder("BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoided")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoided must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoided) {
      val jsonEncoder = encoder.requireJsonEncoder("BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoided")
...
public fun billingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoided(block: BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoided.Builder.() -> Unit): BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoided = BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoided.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoided is missing required property '" + name + "'")
