...
public sealed class InlineV1PaymentRecordsReportPaymentPostRequestFormOutcomeX2e14d97f {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1PaymentRecordsReportPaymentPostRequestFormOutcomeX2e14d97f = when (value) {
      Failed.value -> Failed
  ...
  internal object Serializer : KSerializer<InlineV1PaymentRecordsReportPaymentPostRequestFormOutcomeX2e14d97f> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1PaymentRecordsReportPaymentPostRequestFormOutcomeX2e14d97f", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1PaymentRecordsReportPaymentPostRequestFormOutcomeX2e14d97f = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1PaymentRecordsReportPaymentPostRequestFormOutcomeX2e14d97f) {
