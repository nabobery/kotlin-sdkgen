...
public sealed class InlineV1SourcesPostRequestFormMandateAcceptanceStatusXd05b4351 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1SourcesPostRequestFormMandateAcceptanceStatusXd05b4351 = when (value) {
  ...
  internal object Serializer : KSerializer<InlineV1SourcesPostRequestFormMandateAcceptanceStatusXd05b4351> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1SourcesPostRequestFormMandateAcceptanceStatusXd05b4351", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1SourcesPostRequestFormMandateAcceptanceStatusXd05b4351 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1SourcesPostRequestFormMandateAcceptanceStatusXd05b4351) {
