...
public class InlineV1AccountsPostRequestFormCapabilitiesXf340f39e(
  ...
  public val affirmPayments:
      InlineV1AccountsPostRequestFormCapabilitiesAffirmPaymentsXedbc71f8? = null,
  ...
  public val appDistribution:
      InlineV1AccountsPostRequestFormCapabilitiesAppDistributionXe9a43394? = null,
  ...
  public val billiePayments:
      InlineV1AccountsPostRequestFormCapabilitiesBilliePaymentsX76b460e9? = null,
  public val bizumPayments:
      InlineV1AccountsPostRequestFormCapabilitiesBizumPaymentsXbb41140e? = null,
  public val blikPayments: InlineV1AccountsPostRequestFormCapabilitiesBlikPaymentsXf8e90a4a? = null,
  public val boletoPayments:
      InlineV1AccountsPostRequestFormCapabilitiesBoletoPaymentsX81f93101? = null,
  ...
  public val cashappPayments:
      InlineV1AccountsPostRequestFormCapabilitiesCashappPaymentsX60bdaefb? = null,
  public val cryptoPayments:
      InlineV1AccountsPostRequestFormCapabilitiesCryptoPaymentsXe5b90934? = null,
  ...
  public val giropayPayments:
      InlineV1AccountsPostRequestFormCapabilitiesGiropayPaymentsX021d94d9? = null,
  public val grabpayPayments:
      InlineV1AccountsPostRequestFormCapabilitiesGrabpayPaymentsXe4c2757a? = null,
  public val idealPayments:
      InlineV1AccountsPostRequestFormCapabilitiesIdealPaymentsXa6d85acc? = null,
  ...
  public val klarnaPayments:
      InlineV1AccountsPostRequestFormCapabilitiesKlarnaPaymentsX32c51e6c? = null,
  public val konbiniPayments:
      InlineV1AccountsPostRequestFormCapabilitiesKonbiniPaymentsX025c62b8? = null,
  public val krCardPayments:
      InlineV1AccountsPostRequestFormCapabilitiesKrCardPaymentsXb567e814? = null,
  public val legacyPayments:
      InlineV1AccountsPostRequestFormCapabilitiesLegacyPaymentsX6941c998? = null,
  public val linkPayments: InlineV1AccountsPostRequestFormCapabilitiesLinkPaymentsXe88bc220? = null,
  public val mbWayPayments:
      InlineV1AccountsPostRequestFormCapabilitiesMbWayPaymentsX4f5156ee? = null,
  ...
  public val paycoPayments:
      InlineV1AccountsPostRequestFormCapabilitiesPaycoPaymentsXc7fe29bb? = null,
  public val paynowPayments:
      InlineV1AccountsPostRequestFormCapabilitiesPaynowPaymentsXb8caaeaf? = null,
  public val paytoPayments:
      InlineV1AccountsPostRequestFormCapabilitiesPaytoPaymentsXc6a2d43d? = null,
  ...
  public val sofortPayments:
      InlineV1AccountsPostRequestFormCapabilitiesSofortPaymentsX78d2a6ef? = null,
  public val sunbitPayments:
      InlineV1AccountsPostRequestFormCapabilitiesSunbitPaymentsXeb722720? = null,
  public val swishPayments:
      InlineV1AccountsPostRequestFormCapabilitiesSwishPaymentsX45d862be? = null,
  ...
  public val twintPayments:
      InlineV1AccountsPostRequestFormCapabilitiesTwintPaymentsX5b4cc8fc? = null,
  ...
  public class Builder {
    ...
    public fun build(): InlineV1AccountsPostRequestFormCapabilitiesXf340f39e = InlineV1AccountsPostRequestFormCapabilitiesXf340f39e(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1AccountsPostRequestFormCapabilitiesXf340f39e = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1AccountsPostRequestFormCapabilitiesXf340f39e> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1AccountsPostRequestFormCapabilitiesXf340f39e {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1AccountsPostRequestFormCapabilitiesXf340f39e must be a JSON object")
      return InlineV1AccountsPostRequestFormCapabilitiesXf340f39e(
        acssDebitPayments = rawObject["acss_debit_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesAcssDebitPaymentsX724f9d12>(it) },
        affirmPayments = rawObject["affirm_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesAffirmPaymentsXedbc71f8>(it) },
        afterpayClearpayPayments = rawObject["afterpay_clearpay_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesAfterpayClearpayPaymentsXb5890880>(it) },
        almaPayments = rawObject["alma_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesAlmaPaymentsX8b8136d4>(it) },
        amazonPayPayments = rawObject["amazon_pay_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesAmazonPayPaymentsX11834d29>(it) },
        appDistribution = rawObject["app_distribution"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesAppDistributionXe9a43394>(it) },
        auBecsDebitPayments = rawObject["au_becs_debit_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesAuBecsDebitPaymentsXd01a531e>(it) },
        bacsDebitPayments = rawObject["bacs_debit_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesBacsDebitPaymentsXfb5737f1>(it) },
        bancontactPayments = rawObject["bancontact_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesBancontactPaymentsX0134babe>(it) },
        bankTransferPayments = rawObject["bank_transfer_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesBankTransferPaymentsXbe432317>(it) },
        billiePayments = rawObject["billie_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesBilliePaymentsX76b460e9>(it) },
        bizumPayments = rawObject["bizum_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesBizumPaymentsXbb41140e>(it) },
        blikPayments = rawObject["blik_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesBlikPaymentsXf8e90a4a>(it) },
        boletoPayments = rawObject["boleto_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesBoletoPaymentsX81f93101>(it) },
        cardIssuing = rawObject["card_issuing"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesCardIssuingXce837811>(it) },
        cardPayments = rawObject["card_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesCardPaymentsX8adba7e2>(it) },
        cartesBancairesPayments = rawObject["cartes_bancaires_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesCartesBancairesPaymentsXe4cf54c1>(it) },
        cashappPayments = rawObject["cashapp_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesCashappPaymentsX60bdaefb>(it) },
        cryptoPayments = rawObject["crypto_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesCryptoPaymentsXe5b90934>(it) },
        epsPayments = rawObject["eps_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesEpsPaymentsXdf8d3460>(it) },
        fpxPayments = rawObject["fpx_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesFpxPaymentsXb66c0cce>(it) },
        gbBankTransferPayments = rawObject["gb_bank_transfer_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesGbBankTransferPaymentsX69c770d9>(it) },
        giropayPayments = rawObject["giropay_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesGiropayPaymentsX021d94d9>(it) },
        grabpayPayments = rawObject["grabpay_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesGrabpayPaymentsXe4c2757a>(it) },
        idealPayments = rawObject["ideal_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesIdealPaymentsXa6d85acc>(it) },
        indiaInternationalPayments = rawObject["india_international_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesIndiaInternationalPaymentsX4dd185a0>(it) },
        jcbPayments = rawObject["jcb_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesJcbPaymentsXbefbb38d>(it) },
        jpBankTransferPayments = rawObject["jp_bank_transfer_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesJpBankTransferPaymentsX85dbfa70>(it) },
        kakaoPayPayments = rawObject["kakao_pay_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesKakaoPayPaymentsX6cc74ae8>(it) },
        klarnaPayments = rawObject["klarna_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesKlarnaPaymentsX32c51e6c>(it) },
        konbiniPayments = rawObject["konbini_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesKonbiniPaymentsX025c62b8>(it) },
        krCardPayments = rawObject["kr_card_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesKrCardPaymentsXb567e814>(it) },
        legacyPayments = rawObject["legacy_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesLegacyPaymentsX6941c998>(it) },
        linkPayments = rawObject["link_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesLinkPaymentsXe88bc220>(it) },
        mbWayPayments = rawObject["mb_way_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesMbWayPaymentsX4f5156ee>(it) },
        mobilepayPayments = rawObject["mobilepay_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesMobilepayPaymentsX3f931952>(it) },
        multibancoPayments = rawObject["multibanco_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesMultibancoPaymentsX09e1acc5>(it) },
        mxBankTransferPayments = rawObject["mx_bank_transfer_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesMxBankTransferPaymentsX4886d3a6>(it) },
        naverPayPayments = rawObject["naver_pay_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesNaverPayPaymentsX6e78a2e2>(it) },
        nzBankAccountBecsDebitPayments = rawObject["nz_bank_account_becs_debit_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesNzBankAccountBecsDebf2d0X0685edee>(it) },
        oxxoPayments = rawObject["oxxo_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesOxxoPaymentsX577fec32>(it) },
        p24Payments = rawObject["p24_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesP24PaymentsXe88a70c9>(it) },
        payByBankPayments = rawObject["pay_by_bank_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesPayByBankPaymentsX71f69d6d>(it) },
        paycoPayments = rawObject["payco_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesPaycoPaymentsXc7fe29bb>(it) },
        paynowPayments = rawObject["paynow_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesPaynowPaymentsXb8caaeaf>(it) },
        paytoPayments = rawObject["payto_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesPaytoPaymentsXc6a2d43d>(it) },
        pixPayments = rawObject["pix_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesPixPaymentsXad280602>(it) },
        promptpayPayments = rawObject["promptpay_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesPromptpayPaymentsX2cb29060>(it) },
        revolutPayPayments = rawObject["revolut_pay_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesRevolutPayPaymentsX91f6e2c5>(it) },
        samsungPayPayments = rawObject["samsung_pay_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesSamsungPayPaymentsX35d61fce>(it) },
        satispayPayments = rawObject["satispay_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesSatispayPaymentsX9bdc7473>(it) },
        scalapayPayments = rawObject["scalapay_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesScalapayPaymentsX50e31d27>(it) },
        sepaBankTransferPayments = rawObject["sepa_bank_transfer_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesSepaBankTransferPaymentsXadacac4a>(it) },
        sepaDebitPayments = rawObject["sepa_debit_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesSepaDebitPaymentsXaadf131b>(it) },
        sofortPayments = rawObject["sofort_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesSofortPaymentsX78d2a6ef>(it) },
        sunbitPayments = rawObject["sunbit_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesSunbitPaymentsXeb722720>(it) },
        swishPayments = rawObject["swish_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesSwishPaymentsX45d862be>(it) },
        taxReportingUs1099K = rawObject["tax_reporting_us_1099_k"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesTaxReportingUs1099KXc94aa4c1>(it) },
        taxReportingUs1099Misc = rawObject["tax_reporting_us_1099_misc"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesTaxReportingUs1099MiscX1c32b759>(it) },
        transfers = rawObject["transfers"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesTransfersX62944fff>(it) },
        treasury = rawObject["treasury"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesTreasuryXed3aa913>(it) },
        twintPayments = rawObject["twint_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesTwintPaymentsX5b4cc8fc>(it) },
        upiPayments = rawObject["upi_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesUpiPaymentsX35f080ee>(it) },
        usBankAccountAchPayments = rawObject["us_bank_account_ach_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesUsBankAccountAchPaymentsXacb45960>(it) },
        usBankTransferPayments = rawObject["us_bank_transfer_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesUsBankTransferPaymentsX6f7c2de5>(it) },
        zipPayments = rawObject["zip_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesZipPaymentsX7c0b350b>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineV1AccountsPostRequestFormCapabilitiesXf340f39e) {
...
public fun inlineV1AccountsPostRequestFormCapabilitiesXf340f39e(block: InlineV1AccountsPostRequestFormCapabilitiesXf340f39e.Builder.() -> Unit): InlineV1AccountsPostRequestFormCapabilitiesXf340f39e = InlineV1AccountsPostRequestFormCapabilitiesXf340f39e.build(block)
