...
public class InlineQuoteOnBehalfOfXcdb50ea5 internal constructor(
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineQuoteOnBehalfOfXcdb50ea5 {
      val inspection = inspectInlineQuoteOnBehalfOfXcdb50ea5(raw)
      if (inspection.matchCount == 0) {
        throw InlineQuoteOnBehalfOfXcdb50ea5NoMatchException("InlineQuoteOnBehalfOfXcdb50ea5 matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineQuoteOnBehalfOfXcdb50ea5(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineQuoteOnBehalfOfXcdb50ea5> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineQuoteOnBehalfOfXcdb50ea5) {
