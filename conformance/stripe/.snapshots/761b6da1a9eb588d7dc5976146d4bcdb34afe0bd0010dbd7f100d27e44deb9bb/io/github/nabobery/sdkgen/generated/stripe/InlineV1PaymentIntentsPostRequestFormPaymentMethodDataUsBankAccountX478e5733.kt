...
public class InlineV1PaymentIntentsPostRequestFormPaymentMethodDataUsBankAccountX478e5733(
  ...
  public class Builder {
    ...
    public fun build(): InlineV1PaymentIntentsPostRequestFormPaymentMethodDataUsBankAccountX478e5733 = InlineV1PaymentIntentsPostRequestFormPaymentMethodDataUsBankAccountX478e5733(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1PaymentIntentsPostRequestFormPaymentMethodDataUsBankAccountX478e5733 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormPaymentMethodDataUsBankAccountX478e5733> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineV1PaymentIntentsPostRequestFormPaymentMethodDataUsBankAccountX478e5733 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineV1PaymentIntentsPostRequestFormPaymentMethodDataUsBankAccountX478e5733")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1PaymentIntentsPostRequestFormPaymentMethodDataUsBankAccountX478e5733 must be a JSON object")
      return InlineV1PaymentIntentsPostRequestFormPaymentMethodDataUsBankAccountX478e5733(
        accountHolderType = rawObject["account_holder_type"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodDataAccountHolderTypeXc810c56c>(it) },
        accountNumber = rawObject["account_number"]?.let { json.decodeFromJsonElement<String>(it) },
        accountType = rawObject["account_type"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodDataAccountTypeXc61e4aca>(it) },
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1PaymentIntentsPostRequestFormPaymentMethodDataUsBankAccountX478e5733) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineV1PaymentIntentsPostRequestFormPaymentMethodDataUsBankAccountX478e5733")
...
public fun inlineV1PaymentIntentsPostRequestFormPaymentMethodDataUsBankAccountX478e5733(block: InlineV1PaymentIntentsPostRequestFormPaymentMethodDataUsBankAccountX478e5733.Builder.() -> Unit): InlineV1PaymentIntentsPostRequestFormPaymentMethodDataUsBankAccountX478e5733 = InlineV1PaymentIntentsPostRequestFormPaymentMethodDataUsBankAccountX478e5733.build(block)
