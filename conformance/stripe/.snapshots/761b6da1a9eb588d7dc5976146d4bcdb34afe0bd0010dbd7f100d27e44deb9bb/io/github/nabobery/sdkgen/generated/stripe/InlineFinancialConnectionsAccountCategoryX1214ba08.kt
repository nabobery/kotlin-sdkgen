...
public sealed class InlineFinancialConnectionsAccountCategoryX1214ba08 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineFinancialConnectionsAccountCategoryX1214ba08 = when (value) {
      Cash.value -> Cash
      Credit.value -> Credit
  ...
  internal object Serializer : KSerializer<InlineFinancialConnectionsAccountCategoryX1214ba08> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineFinancialConnectionsAccountCategoryX1214ba08", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineFinancialConnectionsAccountCategoryX1214ba08 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineFinancialConnectionsAccountCategoryX1214ba08) {
