...
public class IssuingDisputeNotReceivedEvidence(
  ...
  public class Builder {
    ...
    public fun build(): IssuingDisputeNotReceivedEvidence = IssuingDisputeNotReceivedEvidence(
  ...
  internal object Serializer : KSerializer<IssuingDisputeNotReceivedEvidence> {
    ...
    override fun deserialize(decoder: Decoder): IssuingDisputeNotReceivedEvidence {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("IssuingDisputeNotReceivedEvidence must be a JSON object")
      return IssuingDisputeNotReceivedEvidence(
        additionalDocumentation = rawObject["additional_documentation"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineIssuingDisputeNotReceivedEvidenceAdditionalDocumentationX80cf7c95?>(element) },
        ...
        productType = rawObject["product_type"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineIssuingDisputeNotReceivedEvidenceProductTypeX7fa548a8?>(element) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: IssuingDisputeNotReceivedEvidence) {
...
public fun issuingDisputeNotReceivedEvidence(block: IssuingDisputeNotReceivedEvidence.Builder.() -> Unit): IssuingDisputeNotReceivedEvidence = IssuingDisputeNotReceivedEvidence.build(block)
