...
public class GelatoDataVerifiedOutputsDate(
  ...
  public class Builder {
    ...
    public fun build(): GelatoDataVerifiedOutputsDate = GelatoDataVerifiedOutputsDate(
      day = day,
      month = month,
      year = year,
    )
  ...
  internal object Serializer : KSerializer<GelatoDataVerifiedOutputsDate> {
    ...
    override fun deserialize(decoder: Decoder): GelatoDataVerifiedOutputsDate {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("GelatoDataVerifiedOutputsDate must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: GelatoDataVerifiedOutputsDate) {
...
public fun gelatoDataVerifiedOutputsDate(block: GelatoDataVerifiedOutputsDate.Builder.() -> Unit): GelatoDataVerifiedOutputsDate = GelatoDataVerifiedOutputsDate.build(block)
