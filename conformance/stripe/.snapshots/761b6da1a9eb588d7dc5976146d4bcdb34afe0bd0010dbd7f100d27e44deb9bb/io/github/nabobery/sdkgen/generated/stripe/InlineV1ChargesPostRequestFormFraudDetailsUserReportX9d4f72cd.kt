...
public sealed class InlineV1ChargesPostRequestFormFraudDetailsUserReportX9d4f72cd {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1ChargesPostRequestFormFraudDetailsUserReportX9d4f72cd = when (value) {
      Value.value -> Value
  ...
  internal object Serializer : KSerializer<InlineV1ChargesPostRequestFormFraudDetailsUserReportX9d4f72cd> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1ChargesPostRequestFormFraudDetailsUserReportX9d4f72cd", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1ChargesPostRequestFormFraudDetailsUserReportX9d4f72cd = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1ChargesPostRequestFormFraudDetailsUserReportX9d4f72cd) {
