...
public sealed class InlineV1CustomersFundingInstructionsPostRequestFormFundingTypeXb2d2a487 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1CustomersFundingInstructionsPostRequestFormFundingTypeXb2d2a487 = when (value) {
      BankTransfer.value -> BankTransfer
      else -> SdkUnknown(value)
    }
  }

  internal object Serializer : KSerializer<InlineV1CustomersFundingInstructionsPostRequestFormFundingTypeXb2d2a487> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1CustomersFundingInstructionsPostRequestFormFundingTypeXb2d2a487", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1CustomersFundingInstructionsPostRequestFormFundingTypeXb2d2a487 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1CustomersFundingInstructionsPostRequestFormFundingTypeXb2d2a487) {
