 ...
 * chema/properties/payment_method_data
 */
@Serializable(with = InlineV1SetupIntentsPostRequestFormPaymentMethodDataX076e36a5.Serializer::class)
public class InlineV1SetupIntentsPostRequestFormPaymentMethodDataX076e36a5(
  public val type: InlineV1SetupIntentsPostRequestFormPaymentMethodDataTypeX50cdba8a,
  public val acssDebit:
      InlineV1SetupIntentsPostRequestFormPaymentMethodDataAcssDebitXd5c92856? = null,
  ...
  public val allowRedisplay:
      InlineV1SetupIntentsPostRequestFormPaymentMethodDataAllowRedisplayX6ba4c1e4? = null,
  public val alma: JsonObject? = null,
  public val amazonPay: JsonObject? = null,
  public val auBecsDebit:
      InlineV1SetupIntentsPostRequestFormPaymentMethodDataAuBecsDebitX31fb309e? = null,
  public val bacsDebit:
      InlineV1SetupIntentsPostRequestFormPaymentMethodDataBacsDebitX6f66f016? = null,
  public val bancontact: JsonObject? = null,
  public val billie: JsonObject? = null,
  public val billingDetails:
      InlineV1SetupIntentsPostRequestFormPaymentMethodDataBillingDetailsX5bed1b10? = null,
  public val bizum: JsonObject? = null,
  public val blik: JsonObject? = null,
  public val boleto: InlineV1SetupIntentsPostRequestFormPaymentMethodDataBoletoX414ff3df? = null,
  public val cashapp: JsonObject? = null,
  public val crypto: JsonObject? = null,
  public val customerBalance: JsonObject? = null,
  public val eps: InlineV1SetupIntentsPostRequestFormPaymentMethodDataEpsX1ad348c4? = null,
  public val fpx: InlineV1SetupIntentsPostRequestFormPaymentMethodDataFpxX7a735eb2? = null,
  public val giropay: JsonObject? = null,
  public val grabpay: JsonObject? = null,
  public val ideal: InlineV1SetupIntentsPostRequestFormPaymentMethodDataIdealX9f2238fe? = null,
  public val interacPresent: JsonObject? = null,
  public val kakaoPay: JsonObject? = null,
  public val klarna: InlineV1SetupIntentsPostRequestFormPaymentMethodDataKlarnaX79b52604? = null,
  ...
  public val naverPay:
      InlineV1SetupIntentsPostRequestFormPaymentMethodDataNaverPayXd7447413? = null,
  public val nzBankAccount:
      InlineV1SetupIntentsPostRequestFormPaymentMethodDataNzBankAccountX9dd1448a? = null,
  public val oxxo: JsonObject? = null,
  public val p24: InlineV1SetupIntentsPostRequestFormPaymentMethodDataP24X4324f131? = null,
  ...
  public val payto: InlineV1SetupIntentsPostRequestFormPaymentMethodDataPaytoXde12c38f? = null,
  public val pix: JsonObject? = null,
  public val promptpay: JsonObject? = null,
  public val radarOptions:
      InlineV1SetupIntentsPostRequestFormPaymentMethodDataRadarOptionsX47674bd4? = null,
  ...
  public val sepaDebit:
      InlineV1SetupIntentsPostRequestFormPaymentMethodDataSepaDebitX9dae8053? = null,
  public val sofort: InlineV1SetupIntentsPostRequestFormPaymentMethodDataSofortXbac840ce? = null,
  public val sunbit: JsonObject? = null,
  public val swish: JsonObject? = null,
  public val twint: JsonObject? = null,
  public val upi: InlineV1SetupIntentsPostRequestFormPaymentMethodDataUpiX177b1f7b? = null,
  public val usBankAccount:
      InlineV1SetupIntentsPostRequestFormPaymentMethodDataUsBankAccountX8f9302d2? = null,
  ...
  public class Builder {
    private var typeValue: InlineV1SetupIntentsPostRequestFormPaymentMethodDataTypeX50cdba8a? = null

    public var type: InlineV1SetupIntentsPostRequestFormPaymentMethodDataTypeX50cdba8a
      get() = requireNotNull(typeValue) { "type is required" }
      set(`value`) {
        typeValue = value
      }

    public var acssDebit: InlineV1SetupIntentsPostRequestFormPaymentMethodDataAcssDebitXd5c92856? =
        null
    ...
    public var bacsDebit: InlineV1SetupIntentsPostRequestFormPaymentMethodDataBacsDebitX6f66f016? =
        null
    ...
    public var boleto: InlineV1SetupIntentsPostRequestFormPaymentMethodDataBoletoX414ff3df? = null
    ...
    public var eps: InlineV1SetupIntentsPostRequestFormPaymentMethodDataEpsX1ad348c4? = null

    public var fpx: InlineV1SetupIntentsPostRequestFormPaymentMethodDataFpxX7a735eb2? = null

    public var giropay: JsonObject? = null

    public var grabpay: JsonObject? = null

    public var ideal: InlineV1SetupIntentsPostRequestFormPaymentMethodDataIdealX9f2238fe? = null

    public var interacPresent: JsonObject? = null

    public var kakaoPay: JsonObject? = null

    public var klarna: InlineV1SetupIntentsPostRequestFormPaymentMethodDataKlarnaX79b52604? = null
    ...
    public var naverPay: InlineV1SetupIntentsPostRequestFormPaymentMethodDataNaverPayXd7447413? =
        null
    ...
    public var p24: InlineV1SetupIntentsPostRequestFormPaymentMethodDataP24X4324f131? = null
    ...
    public var payto: InlineV1SetupIntentsPostRequestFormPaymentMethodDataPaytoXde12c38f? = null
    ...
    public var sepaDebit: InlineV1SetupIntentsPostRequestFormPaymentMethodDataSepaDebitX9dae8053? =
        null

    public var sofort: InlineV1SetupIntentsPostRequestFormPaymentMethodDataSofortXbac840ce? = null
    ...
    public var upi: InlineV1SetupIntentsPostRequestFormPaymentMethodDataUpiX177b1f7b? = null
    ...
    public fun build(): InlineV1SetupIntentsPostRequestFormPaymentMethodDataX076e36a5 {
      check(typeValue != null) { "type is required" }
      return InlineV1SetupIntentsPostRequestFormPaymentMethodDataX076e36a5(
        type = type,
        acssDebit = acssDebit,
        affirm = affirm,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1SetupIntentsPostRequestFormPaymentMethodDataX076e36a5 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1SetupIntentsPostRequestFormPaymentMethodDataX076e36a5> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineV1SetupIntentsPostRequestFormPaymentMethodDataX076e36a5 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineV1SetupIntentsPostRequestFormPaymentMethodDataX076e36a5")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1SetupIntentsPostRequestFormPaymentMethodDataX076e36a5 must be a JSON object")
      val type = json.decodeRequired<InlineV1SetupIntentsPostRequestFormPaymentMethodDataTypeX50cdba8a>(rawObject, "type")
      return InlineV1SetupIntentsPostRequestFormPaymentMethodDataX076e36a5(
        type = type,
        acssDebit = rawObject["acss_debit"]?.let { json.decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodDataAcssDebitXd5c92856>(it) },
        ...
        allowRedisplay = rawObject["allow_redisplay"]?.let { json.decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodDataAllowRedisplayX6ba4c1e4>(it) },
        ...
        auBecsDebit = rawObject["au_becs_debit"]?.let { json.decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodDataAuBecsDebitX31fb309e>(it) },
        bacsDebit = rawObject["bacs_debit"]?.let { json.decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodDataBacsDebitX6f66f016>(it) },
        ...
        billingDetails = rawObject["billing_details"]?.let { json.decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodDataBillingDetailsX5bed1b10>(it) },
        ...
        boleto = rawObject["boleto"]?.let { json.decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodDataBoletoX414ff3df>(it) },
        ...
        eps = rawObject["eps"]?.let { json.decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodDataEpsX1ad348c4>(it) },
        fpx = rawObject["fpx"]?.let { json.decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodDataFpxX7a735eb2>(it) },
        ...
        ideal = rawObject["ideal"]?.let { json.decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodDataIdealX9f2238fe>(it) },
        ...
        klarna = rawObject["klarna"]?.let { json.decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodDataKlarnaX79b52604>(it) },
        ...
        naverPay = rawObject["naver_pay"]?.let { json.decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodDataNaverPayXd7447413>(it) },
        nzBankAccount = rawObject["nz_bank_account"]?.let { json.decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodDataNzBankAccountX9dd1448a>(it) },
        oxxo = rawObject["oxxo"]?.let { json.decodeFromJsonElement<JsonObject>(it) },
        p24 = rawObject["p24"]?.let { json.decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodDataP24X4324f131>(it) },
        ...
        payto = rawObject["payto"]?.let { json.decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodDataPaytoXde12c38f>(it) },
        ...
        radarOptions = rawObject["radar_options"]?.let { json.decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodDataRadarOptionsX47674bd4>(it) },
        ...
        sepaDebit = rawObject["sepa_debit"]?.let { json.decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodDataSepaDebitX9dae8053>(it) },
        sofort = rawObject["sofort"]?.let { json.decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodDataSofortXbac840ce>(it) },
        ...
        upi = rawObject["upi"]?.let { json.decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodDataUpiX177b1f7b>(it) },
        usBankAccount = rawObject["us_bank_account"]?.let { json.decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodDataUsBankAccountX8f9302d2>(it) },
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1SetupIntentsPostRequestFormPaymentMethodDataX076e36a5) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineV1SetupIntentsPostRequestFormPaymentMethodDataX076e36a5")
...
public fun inlineV1SetupIntentsPostRequestFormPaymentMethodDataX076e36a5(block: InlineV1SetupIntentsPostRequestFormPaymentMethodDataX076e36a5.Builder.() -> Unit): InlineV1SetupIntentsPostRequestFormPaymentMethodDataX076e36a5 = InlineV1SetupIntentsPostRequestFormPaymentMethodDataX076e36a5.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineV1SetupIntentsPostRequestFormPaymentMethodDataX076e36a5 is missing required property '" + name + "'")
