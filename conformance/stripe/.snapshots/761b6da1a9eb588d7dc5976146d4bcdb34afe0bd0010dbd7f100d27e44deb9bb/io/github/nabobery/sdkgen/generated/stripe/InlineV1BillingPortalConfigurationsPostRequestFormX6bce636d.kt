...
public class InlineV1BillingPortalConfigurationsPostRequestFormX6bce636d(
  ...
  public val loginPage:
      InlineV1BillingPortalConfigurationsPostRequestFormLoginPageX03ccc776? = null,
  /**
  ...
  public class Builder {
    ...
    public fun build(): InlineV1BillingPortalConfigurationsPostRequestFormX6bce636d = InlineV1BillingPortalConfigurationsPostRequestFormX6bce636d(
      active = active,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1BillingPortalConfigurationsPostRequestFormX6bce636d = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1BillingPortalConfigurationsPostRequestFormX6bce636d> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1BillingPortalConfigurationsPostRequestFormX6bce636d {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1BillingPortalConfigurationsPostRequestFormX6bce636d must be a JSON object")
      return InlineV1BillingPortalConfigurationsPostRequestFormX6bce636d(
        ...
        businessProfile = rawObject["business_profile"]?.let { json.decodeFromJsonElement<InlineV1BillingPortalConfigurationsPostRequestFormBusinessProfileXf334d2d5>(it) },
        defaultReturnUrl = rawObject["default_return_url"]?.let { json.decodeFromJsonElement<InlineV1BillingPortalConfigurationsPostRequestFormDefaultReturnUrlXb50f2cd3>(it) },
        expand = rawObject["expand"]?.let { json.decodeFromJsonElement<List<String>>(it) },
        features = rawObject["features"]?.let { json.decodeFromJsonElement<InlineV1BillingPortalConfigurationsPostRequestFormFeaturesX378a9f5b>(it) },
        loginPage = rawObject["login_page"]?.let { json.decodeFromJsonElement<InlineV1BillingPortalConfigurationsPostRequestFormLoginPageX03ccc776>(it) },
        metadata = rawObject["metadata"]?.let { json.decodeFromJsonElement<InlineV1BillingPortalConfigurationsPostRequestFormMetadataX09d7226c>(it) },
        name = rawObject["name"]?.let { json.decodeFromJsonElement<InlineV1BillingPortalConfigurationsPostRequestFormNameX1352debb>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineV1BillingPortalConfigurationsPostRequestFormX6bce636d) {
...
public fun inlineV1BillingPortalConfigurationsPostRequestFormX6bce636d(block: InlineV1BillingPortalConfigurationsPostRequestFormX6bce636d.Builder.() -> Unit): InlineV1BillingPortalConfigurationsPostRequestFormX6bce636d = InlineV1BillingPortalConfigurationsPostRequestFormX6bce636d.build(block)
