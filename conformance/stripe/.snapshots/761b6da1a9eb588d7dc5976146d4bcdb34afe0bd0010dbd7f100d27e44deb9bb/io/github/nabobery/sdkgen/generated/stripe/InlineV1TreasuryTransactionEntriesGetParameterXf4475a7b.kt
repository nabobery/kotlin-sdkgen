...
internal data class InlineV1TreasuryTransactionEntriesGetParameterXf4475a7bInspection(
  ...
  public val matchCount: Int
    get() = listOf(matchesInlineV1TreasuryTransactionEntriesGetParameterAnyOf1X47a7d028, matchesBranch2).count { it }
}
...
public class InlineV1TreasuryTransactionEntriesGetParameterXf4475a7b internal constructor(
  ...
  public val inlineV1TreasuryTransactionEntriesGetParameterAnyOf1X47a7d028:
      ...
      lazy(LazyThreadSafetyMode.NONE) { if (inspection.matchesInlineV1TreasuryTransactionEntriesGetParameterAnyOf1X47a7d028) json.decodeFromJsonElement<InlineV1TreasuryTransactionEntriesGetParameterAnyOf1X47a7d028>(raw) else null }
  ...
  public val matchedBranches: Set<InlineV1TreasuryTransactionEntriesGetParameterXf4475a7bBranch>
    get() = buildSet {
      if (inspection.matchesInlineV1TreasuryTransactionEntriesGetParameterAnyOf1X47a7d028) add(InlineV1TreasuryTransactionEntriesGetParameterXf4475a7bBranch.InlineV1TreasuryTransactionEntriesGetParameterAnyOf1X47a7d028)
      if (inspection.matchesBranch2) add(InlineV1TreasuryTransactionEntriesGetParameterXf4475a7bBranch.Branch2)
    }
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineV1TreasuryTransactionEntriesGetParameterXf4475a7b {
      val inspection = inspectInlineV1TreasuryTransactionEntriesGetParameterXf4475a7b(raw)
      if (inspection.matchCount == 0) {
        throw InlineV1TreasuryTransactionEntriesGetParameterXf4475a7bNoMatchException("InlineV1TreasuryTransactionEntriesGetParameterXf4475a7b matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineV1TreasuryTransactionEntriesGetParameterXf4475a7b(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineV1TreasuryTransactionEntriesGetParameterXf4475a7b> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1TreasuryTransactionEntriesGetParameterXf4475a7b) {
      encoder.requireJsonEncoder("InlineV1TreasuryTransactionEntriesGetParameterXf4475a7b").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineV1TreasuryTransactionEntriesGetParameterXf4475a7b(element: JsonElement): InlineV1TreasuryTransactionEntriesGetParameterXf4475a7bInspection {
  val matchesInlineV1TreasuryTransactionEntriesGetParameterAnyOf1X47a7d028 = element.isJsonDecodable<InlineV1TreasuryTransactionEntriesGetParameterAnyOf1X47a7d028>()
  ...
  return InlineV1TreasuryTransactionEntriesGetParameterXf4475a7bInspection(
    ...
    failures = buildList {
      if (!matchesInlineV1TreasuryTransactionEntriesGetParameterAnyOf1X47a7d028) add("InlineV1TreasuryTransactionEntriesGetParameterAnyOf1X47a7d028: value does not match InlineV1TreasuryTransactionEntriesGetParameterAnyOf1X47a7d028")
