...
public sealed class InlinePaymentMethodOptionsCryptoSetupFutureUsageX539134ab {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlinePaymentMethodOptionsCryptoSetupFutureUsageX539134ab = when (value) {
      None.value -> None
      else -> SdkUnknown(value)
    }
  }

  internal object Serializer : KSerializer<InlinePaymentMethodOptionsCryptoSetupFutureUsageX539134ab> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlinePaymentMethodOptionsCryptoSetupFutureUsageX539134ab", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlinePaymentMethodOptionsCryptoSetupFutureUsageX539134ab = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlinePaymentMethodOptionsCryptoSetupFutureUsageX539134ab) {
