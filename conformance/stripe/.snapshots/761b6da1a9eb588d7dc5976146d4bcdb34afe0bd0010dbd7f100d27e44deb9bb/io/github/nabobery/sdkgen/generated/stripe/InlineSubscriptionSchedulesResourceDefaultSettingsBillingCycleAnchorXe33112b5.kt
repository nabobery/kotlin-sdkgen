...
public sealed class InlineSubscriptionSchedulesResourceDefaultSettingsBillingCycleAnchorXe33112b5 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineSubscriptionSchedulesResourceDefaultSettingsBillingCycleAnchorXe33112b5 = when (value) {
  ...
  internal object Serializer : KSerializer<InlineSubscriptionSchedulesResourceDefaultSettingsBillingCycleAnchorXe33112b5> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineSubscriptionSchedulesResourceDefaultSettingsBillingCycleAnchorXe33112b5", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineSubscriptionSchedulesResourceDefaultSettingsBillingCycleAnchorXe33112b5 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineSubscriptionSchedulesResourceDefaultSettingsBillingCycleAnchorXe33112b5) {
