...
internal data class InlineV1EntitlementsFeaturesPostRequestFormMetadataXacbde597Inspection(
  ...
  public val matchCount: Int
    get() = listOf(matchesBranch1, matchesInlineV1EntitlementsFeaturesPostRequestFormMetadataAnyOf2Xdfe02695).count { it }
}
...
public class InlineV1EntitlementsFeaturesPostRequestFormMetadataXacbde597 internal constructor(
  ...
  public val inlineV1EntitlementsFeaturesPostRequestFormMetadataAnyOf2Xdfe02695:
      ...
      lazy(LazyThreadSafetyMode.NONE) { if (inspection.matchesInlineV1EntitlementsFeaturesPostRequestFormMetadataAnyOf2Xdfe02695) json.decodeFromJsonElement<InlineV1EntitlementsFeaturesPostRequestFormMetadataAnyOf2Xdfe02695>(raw) else null }

  public val matchedBranches:
      Set<InlineV1EntitlementsFeaturesPostRequestFormMetadataXacbde597Branch>
    get() = buildSet {
      if (inspection.matchesBranch1) add(InlineV1EntitlementsFeaturesPostRequestFormMetadataXacbde597Branch.Branch1)
      if (inspection.matchesInlineV1EntitlementsFeaturesPostRequestFormMetadataAnyOf2Xdfe02695) add(InlineV1EntitlementsFeaturesPostRequestFormMetadataXacbde597Branch.InlineV1EntitlementsFeaturesPostRequestFormMetadataAnyOf2Xdfe02695)
    }
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineV1EntitlementsFeaturesPostRequestFormMetadataXacbde597 {
      val inspection = inspectInlineV1EntitlementsFeaturesPostRequestFormMetadataXacbde597(raw)
      if (inspection.matchCount == 0) {
        throw InlineV1EntitlementsFeaturesPostRequestFormMetadataXacbde597NoMatchException("InlineV1EntitlementsFeaturesPostRequestFormMetadataXacbde597 matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineV1EntitlementsFeaturesPostRequestFormMetadataXacbde597(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineV1EntitlementsFeaturesPostRequestFormMetadataXacbde597> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1EntitlementsFeaturesPostRequestFormMetadataXacbde597) {
      encoder.requireJsonEncoder("InlineV1EntitlementsFeaturesPostRequestFormMetadataXacbde597").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineV1EntitlementsFeaturesPostRequestFormMetadataXacbde597(element: JsonElement): InlineV1EntitlementsFeaturesPostRequestFormMetadataXacbde597Inspection {
  val matchesBranch1 = element.isJsonDecodable<JsonObject>()
  val matchesInlineV1EntitlementsFeaturesPostRequestFormMetadataAnyOf2Xdfe02695 = element.isJsonDecodable<InlineV1EntitlementsFeaturesPostRequestFormMetadataAnyOf2Xdfe02695>()
  return InlineV1EntitlementsFeaturesPostRequestFormMetadataXacbde597Inspection(
    ...
    failures = buildList {
      ...
      if (!matchesInlineV1EntitlementsFeaturesPostRequestFormMetadataAnyOf2Xdfe02695) add("InlineV1EntitlementsFeaturesPostRequestFormMetadataAnyOf2Xdfe02695: value does not match InlineV1EntitlementsFeaturesPostRequestFormMetadataAnyOf2Xdfe02695")
    },
  )
}
