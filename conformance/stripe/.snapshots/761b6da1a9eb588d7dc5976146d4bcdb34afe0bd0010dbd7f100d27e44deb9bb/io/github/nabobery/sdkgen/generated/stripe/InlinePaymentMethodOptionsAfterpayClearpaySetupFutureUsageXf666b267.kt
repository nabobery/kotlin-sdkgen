...
public sealed class InlinePaymentMethodOptionsAfterpayClearpaySetupFutureUsageXf666b267 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlinePaymentMethodOptionsAfterpayClearpaySetupFutureUsageXf666b267 = when (value) {
      None.value -> None
      else -> SdkUnknown(value)
    }
  }

  internal object Serializer : KSerializer<InlinePaymentMethodOptionsAfterpayClearpaySetupFutureUsageXf666b267> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlinePaymentMethodOptionsAfterpayClearpaySetupFutureUsageXf666b267", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlinePaymentMethodOptionsAfterpayClearpaySetupFutureUsageXf666b267 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlinePaymentMethodOptionsAfterpayClearpaySetupFutureUsageXf666b267) {
