...
public sealed class InlineMandateUpiAmountTypeX9eb5e33d {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineMandateUpiAmountTypeX9eb5e33d = when (value) {
      Fixed.value -> Fixed
  ...
  internal object Serializer : KSerializer<InlineMandateUpiAmountTypeX9eb5e33d> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineMandateUpiAmountTypeX9eb5e33d", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineMandateUpiAmountTypeX9eb5e33d = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineMandateUpiAmountTypeX9eb5e33d) {
