...
public sealed class InlineMandateTypeX0a63be5f {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineMandateTypeX0a63be5f = when (value) {
  ...
  internal object Serializer : KSerializer<InlineMandateTypeX0a63be5f> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineMandateTypeX0a63be5f", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineMandateTypeX0a63be5f = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineMandateTypeX0a63be5f) {
