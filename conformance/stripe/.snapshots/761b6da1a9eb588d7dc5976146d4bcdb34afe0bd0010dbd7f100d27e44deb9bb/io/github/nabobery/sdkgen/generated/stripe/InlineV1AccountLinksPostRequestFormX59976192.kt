...
public class InlineV1AccountLinksPostRequestFormX59976192(
   ...
   */
  public val collectionOptions:
      InlineV1AccountLinksPostRequestFormCollectionOptionsXb477fac8? = null,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1AccountLinksPostRequestFormX59976192 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1AccountLinksPostRequestFormX59976192> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1AccountLinksPostRequestFormX59976192 {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1AccountLinksPostRequestFormX59976192 must be a JSON object")
      ...
      return InlineV1AccountLinksPostRequestFormX59976192(
        account = account,
        type = type,
        collect = rawObject["collect"]?.let { json.decodeFromJsonElement<InlineV1AccountLinksPostRequestFormCollectXcde1cfeb>(it) },
        collectionOptions = rawObject["collection_options"]?.let { json.decodeFromJsonElement<InlineV1AccountLinksPostRequestFormCollectionOptionsXb477fac8>(it) },
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1AccountLinksPostRequestFormX59976192) {
...
public fun inlineV1AccountLinksPostRequestFormX59976192(block: InlineV1AccountLinksPostRequestFormX59976192.Builder.() -> Unit): InlineV1AccountLinksPostRequestFormX59976192 = InlineV1AccountLinksPostRequestFormX59976192.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineV1AccountLinksPostRequestFormX59976192 is missing required property '" + name + "'")
