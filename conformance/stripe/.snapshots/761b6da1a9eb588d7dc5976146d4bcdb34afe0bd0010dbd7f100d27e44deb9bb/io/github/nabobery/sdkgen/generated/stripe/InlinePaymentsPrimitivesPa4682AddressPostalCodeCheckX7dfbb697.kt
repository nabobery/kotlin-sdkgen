...
public sealed class InlinePaymentsPrimitivesPa4682AddressPostalCodeCheckX7dfbb697 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlinePaymentsPrimitivesPa4682AddressPostalCodeCheckX7dfbb697 = when (value) {
      Fail.value -> Fail
      Pass.value -> Pass
  ...
  internal object Serializer : KSerializer<InlinePaymentsPrimitivesPa4682AddressPostalCodeCheckX7dfbb697> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlinePaymentsPrimitivesPa4682AddressPostalCodeCheckX7dfbb697", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlinePaymentsPrimitivesPa4682AddressPostalCodeCheckX7dfbb697 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlinePaymentsPrimitivesPa4682AddressPostalCodeCheckX7dfbb697) {
