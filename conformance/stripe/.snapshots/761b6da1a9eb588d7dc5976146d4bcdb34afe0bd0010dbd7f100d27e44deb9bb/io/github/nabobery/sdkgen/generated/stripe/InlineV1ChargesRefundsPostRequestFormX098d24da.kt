 ...
 * -urlencoded/schema
 */
@Serializable(with = InlineV1ChargesRefundsPostRequestFormX098d24da.Serializer::class)
public class InlineV1ChargesRefundsPostRequestFormX098d24da(
   ...
   */
  public val metadata: InlineV1ChargesRefundsPostRequestFormMetadataX2be9a45c? = null,
  /**
   * Origin of the refund
   */
  public val origin: InlineV1ChargesRefundsPostRequestFormOriginX4a79114c? = null,
  /**
   ...
   */
  public val reason: InlineV1ChargesRefundsPostRequestFormReasonX896929c9? = null,
  /**
  ...
  public class Builder {
     ...
     */
    public var metadata: InlineV1ChargesRefundsPostRequestFormMetadataX2be9a45c? = null

    /**
     * Origin of the refund
     */
    public var origin: InlineV1ChargesRefundsPostRequestFormOriginX4a79114c? = null
     ...
     */
    public var reason: InlineV1ChargesRefundsPostRequestFormReasonX896929c9? = null
    ...
    public fun build(): InlineV1ChargesRefundsPostRequestFormX098d24da = InlineV1ChargesRefundsPostRequestFormX098d24da(
      amount = amount,
      currency = currency,
      customer = customer,
      expand = expand,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1ChargesRefundsPostRequestFormX098d24da = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1ChargesRefundsPostRequestFormX098d24da> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineV1ChargesRefundsPostRequestFormX098d24da {
      val jsonDecoder = decoder.requireJsonDecoder("InlineV1ChargesRefundsPostRequestFormX098d24da")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1ChargesRefundsPostRequestFormX098d24da must be a JSON object")
      return InlineV1ChargesRefundsPostRequestFormX098d24da(
        ...
        metadata = rawObject["metadata"]?.let { json.decodeFromJsonElement<InlineV1ChargesRefundsPostRequestFormMetadataX2be9a45c>(it) },
        origin = rawObject["origin"]?.let { json.decodeFromJsonElement<InlineV1ChargesRefundsPostRequestFormOriginX4a79114c>(it) },
        paymentIntent = rawObject["payment_intent"]?.let { json.decodeFromJsonElement<String>(it) },
        reason = rawObject["reason"]?.let { json.decodeFromJsonElement<InlineV1ChargesRefundsPostRequestFormReasonX896929c9>(it) },
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1ChargesRefundsPostRequestFormX098d24da) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineV1ChargesRefundsPostRequestFormX098d24da")
...
public fun inlineV1ChargesRefundsPostRequestFormX098d24da(block: InlineV1ChargesRefundsPostRequestFormX098d24da.Builder.() -> Unit): InlineV1ChargesRefundsPostRequestFormX098d24da = InlineV1ChargesRefundsPostRequestFormX098d24da.build(block)
