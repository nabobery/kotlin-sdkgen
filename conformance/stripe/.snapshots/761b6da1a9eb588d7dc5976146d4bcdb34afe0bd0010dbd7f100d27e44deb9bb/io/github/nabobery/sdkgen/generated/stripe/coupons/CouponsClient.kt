package io.github.nabobery.sdkgen.generated.stripe.coupons
...
import io.github.nabobery.sdkgen.generated.stripe.Coupon
import io.github.nabobery.sdkgen.generated.stripe.DeletedCoupon
import io.github.nabobery.sdkgen.generated.stripe.Error
import io.github.nabobery.sdkgen.generated.stripe.InlineV1CouponsGetParameterX3b2359f8
import io.github.nabobery.sdkgen.generated.stripe.InlineV1CouponsGetResponse200JsonXf21a52f2
import io.github.nabobery.sdkgen.generated.stripe.InlineV1CouponsPostRequestFormX8a95aa20
import io.github.nabobery.sdkgen.generated.stripe.InlineV1CouponsPostRequestFormXb16bd4b6
...
internal object CouponsCodecs {
  internal const val DELETECOUPONSCOUPON_REQUEST_CODEC_ID: String = "DeleteCouponsCoupon.request"
  ...
  internal val deleteCouponsCouponResponseCodecAlternative0Registry:
  ...
  internal val deleteCouponsCouponResponseCodecAlternative1Registry: MediaTypeCodecRegistry<Error> =
      MediaTypeCodecRegistry.of(deleteCouponsCouponResponseCodecAlternative1Codec)

  internal val deleteCouponsCouponRequestCodecRegistry: MediaTypeCodecRegistry<JsonObject?> =
      MediaTypeCodecRegistry.of(deleteCouponsCouponRequestCodec)

  internal const val GETCOUPONS_REQUEST_CODEC_ID: String = "GetCoupons.request"
  ...
  internal val getCouponsResponseCodecAlternative0Registry:
  ...
  internal val getCouponsResponseCodecAlternative1Registry: MediaTypeCodecRegistry<Error> =
      MediaTypeCodecRegistry.of(getCouponsResponseCodecAlternative1Codec)

  internal val getCouponsRequestCodecRegistry: MediaTypeCodecRegistry<JsonObject?> =
      MediaTypeCodecRegistry.of(getCouponsRequestCodec)

  internal const val GETCOUPONSCOUPON_REQUEST_CODEC_ID: String = "GetCouponsCoupon.request"
  ...
  internal val getCouponsCouponResponseCodecAlternative0Registry: MediaTypeCodecRegistry<Coupon> =
  ...
  internal val getCouponsCouponResponseCodecAlternative1Registry: MediaTypeCodecRegistry<Error> =
      MediaTypeCodecRegistry.of(getCouponsCouponResponseCodecAlternative1Codec)

  internal val getCouponsCouponRequestCodecRegistry: MediaTypeCodecRegistry<JsonObject?> =
      MediaTypeCodecRegistry.of(getCouponsCouponRequestCodec)

  internal const val POSTCOUPONS_REQUEST_CODEC_ID: String = "PostCoupons.request"
  ...
  internal val postCouponsResponseCodecAlternative0Registry: MediaTypeCodecRegistry<Coupon> =
  ...
  internal val postCouponsResponseCodecAlternative1Registry: MediaTypeCodecRegistry<Error> =
      MediaTypeCodecRegistry.of(postCouponsResponseCodecAlternative1Codec)

  internal val postCouponsRequestCodecRegistry:
      MediaTypeCodecRegistry<InlineV1CouponsPostRequestFormX8a95aa20?> =
      MediaTypeCodecRegistry.of(postCouponsRequestCodec)

  internal const val POSTCOUPONSCOUPON_REQUEST_CODEC_ID: String = "PostCouponsCoupon.request"
  ...
  internal val postCouponsCouponResponseCodecAlternative0Registry: MediaTypeCodecRegistry<Coupon> =
  ...
  internal val postCouponsCouponResponseCodecAlternative1Registry: MediaTypeCodecRegistry<Error> =
      MediaTypeCodecRegistry.of(postCouponsCouponResponseCodecAlternative1Codec)

  internal val postCouponsCouponRequestCodecRegistry:
      MediaTypeCodecRegistry<InlineV1CouponsPostRequestFormXb16bd4b6?> =
      MediaTypeCodecRegistry.of(postCouponsCouponRequestCodec)

  internal object DeleteCouponsCouponFormCodec : MediaTypeCodec<JsonObject?> {
  ...
  internal object GetCouponsFormCodec : MediaTypeCodec<JsonObject?> {
  ...
  internal object GetCouponsCouponFormCodec : MediaTypeCodec<JsonObject?> {
  ...
  internal object PostCouponsFormCodec : MediaTypeCodec<InlineV1CouponsPostRequestFormX8a95aa20?> {
  ...
  internal object PostCouponsCouponFormCodec : MediaTypeCodec<InlineV1CouponsPostRequestFormXb16bd4b6?> {
...
public class CouponsClient(
  ...
  public companion object {
    internal val deleteCouponsCouponMetadata: OperationMetadata by
    ...
    internal val getCouponsMetadata: OperationMetadata by
        lazy(LazyThreadSafetyMode.PUBLICATION) { OperationMetadata(
    ...
    internal val getCouponsCouponMetadata: OperationMetadata by
        lazy(LazyThreadSafetyMode.PUBLICATION) { OperationMetadata(
    ...
    internal val postCouponsMetadata: OperationMetadata by
        lazy(LazyThreadSafetyMode.PUBLICATION) { OperationMetadata(
    ...
    internal val postCouponsCouponMetadata: OperationMetadata by
        lazy(LazyThreadSafetyMode.PUBLICATION) { OperationMetadata(
