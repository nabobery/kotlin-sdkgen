...
public class InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAnyOf1X7f793458(
  ...
  public val routing:
      InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsRoutingXa26d40c6? = null,
) {
  public class Builder {
    ...
    public fun build(): InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAnyOf1X7f793458 = InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAnyOf1X7f793458(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAnyOf1X7f793458 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAnyOf1X7f793458> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAnyOf1X7f793458 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAnyOf1X7f793458")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAnyOf1X7f793458 must be a JSON object")
      return InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAnyOf1X7f793458(
        captureMethod = rawObject["capture_method"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsCaptureMethodXf359d701>(it) },
        ...
        routing = rawObject["routing"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsRoutingXa26d40c6>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAnyOf1X7f793458) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAnyOf1X7f793458")
...
public fun inlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAnyOf1X7f793458(block: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAnyOf1X7f793458.Builder.() -> Unit): InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAnyOf1X7f793458 = InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsAnyOf1X7f793458.build(block)
