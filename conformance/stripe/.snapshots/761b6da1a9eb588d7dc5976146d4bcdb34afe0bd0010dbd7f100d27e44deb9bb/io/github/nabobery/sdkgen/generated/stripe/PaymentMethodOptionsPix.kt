...
public class PaymentMethodOptionsPix(
  ...
  public class Builder {
    ...
    public fun build(): PaymentMethodOptionsPix = PaymentMethodOptionsPix(
  ...
  internal object Serializer : KSerializer<PaymentMethodOptionsPix> {
    ...
    override fun deserialize(decoder: Decoder): PaymentMethodOptionsPix {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("PaymentMethodOptionsPix must be a JSON object")
      return PaymentMethodOptionsPix(
        amountIncludesIof = rawObject["amount_includes_iof"]?.let { json.decodeFromJsonElement<InlinePaymentMethodOptionsPixAmountIncludesIofXb30d753a>(it) },
        ...
        setupFutureUsage = rawObject["setup_future_usage"]?.let { json.decodeFromJsonElement<InlinePaymentMethodOptionsPixSetupFutureUsageX1a799d05>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: PaymentMethodOptionsPix) {
...
public fun paymentMethodOptionsPix(block: PaymentMethodOptionsPix.Builder.() -> Unit): PaymentMethodOptionsPix = PaymentMethodOptionsPix.build(block)
