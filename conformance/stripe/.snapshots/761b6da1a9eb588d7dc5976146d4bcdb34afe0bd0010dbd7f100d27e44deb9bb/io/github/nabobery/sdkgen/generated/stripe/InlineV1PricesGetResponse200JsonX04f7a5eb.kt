...
public class InlineV1PricesGetResponse200JsonX04f7a5eb(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1PricesGetResponse200JsonX04f7a5eb = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1PricesGetResponse200JsonX04f7a5eb> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1PricesGetResponse200JsonX04f7a5eb {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1PricesGetResponse200JsonX04f7a5eb must be a JSON object")
      val data = json.decodeRequired<List<Price>>(rawObject, "data")
      val hasMore = json.decodeRequired<Boolean>(rawObject, "has_more")
      val objectValue = json.decodeRequired<InlineV1PricesGetResponse200JsonObjectValueXb3e7e89f>(rawObject, "object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1PricesGetResponse200JsonX04f7a5eb) {
...
public fun inlineV1PricesGetResponse200JsonX04f7a5eb(block: InlineV1PricesGetResponse200JsonX04f7a5eb.Builder.() -> Unit): InlineV1PricesGetResponse200JsonX04f7a5eb = InlineV1PricesGetResponse200JsonX04f7a5eb.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineV1PricesGetResponse200JsonX04f7a5eb is missing required property '" + name + "'")
