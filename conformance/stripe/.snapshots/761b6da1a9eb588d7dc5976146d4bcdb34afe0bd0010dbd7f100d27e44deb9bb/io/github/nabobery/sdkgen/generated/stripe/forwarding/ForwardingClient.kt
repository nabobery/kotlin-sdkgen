package io.github.nabobery.sdkgen.generated.stripe.forwarding
...
import io.github.nabobery.sdkgen.generated.stripe.ForwardingRequest
import io.github.nabobery.sdkgen.generated.stripe.InlineV1ForwardingRequestsGetParameterX9a27da50
import io.github.nabobery.sdkgen.generated.stripe.InlineV1ForwardingRequestsGetResponse200JsonX84c350c4
import io.github.nabobery.sdkgen.generated.stripe.InlineV1ForwardingRequestsPostRequestFormXe4abb4a8
...
internal object ForwardingCodecs {
  internal const val GETFORWARDINGREQUESTS_REQUEST_CODEC_ID: String =
      "GetForwardingRequests.request"
  ...
  internal val getForwardingRequestsResponseCodecAlternative0Registry:
  ...
  internal val getForwardingRequestsResponseCodecAlternative1Registry: MediaTypeCodecRegistry<Error>
      = MediaTypeCodecRegistry.of(getForwardingRequestsResponseCodecAlternative1Codec)

  internal val getForwardingRequestsRequestCodecRegistry: MediaTypeCodecRegistry<JsonObject?> =
      MediaTypeCodecRegistry.of(getForwardingRequestsRequestCodec)

  internal const val GETFORWARDINGREQUESTSID_REQUEST_CODEC_ID: String =
  ...
  internal val getForwardingRequestsIdResponseCodecAlternative0Registry:
  ...
  internal val getForwardingRequestsIdResponseCodecAlternative1Registry:
      MediaTypeCodecRegistry<Error> =
      MediaTypeCodecRegistry.of(getForwardingRequestsIdResponseCodecAlternative1Codec)

  internal val getForwardingRequestsIdRequestCodecRegistry: MediaTypeCodecRegistry<JsonObject?> =
      MediaTypeCodecRegistry.of(getForwardingRequestsIdRequestCodec)

  internal const val POSTFORWARDINGREQUESTS_REQUEST_CODEC_ID: String =
  ...
  internal val postForwardingRequestsResponseCodecAlternative0Registry:
      MediaTypeCodecRegistry<ForwardingRequest> =
  ...
  internal val postForwardingRequestsResponseCodecAlternative1Registry:
      MediaTypeCodecRegistry<Error> =
      MediaTypeCodecRegistry.of(postForwardingRequestsResponseCodecAlternative1Codec)

  internal val postForwardingRequestsRequestCodecRegistry:
  ...
  internal object GetForwardingRequestsFormCodec : MediaTypeCodec<JsonObject?> {
  ...
  internal object GetForwardingRequestsIdFormCodec : MediaTypeCodec<JsonObject?> {
  ...
  internal object PostForwardingRequestsFormCodec : MediaTypeCodec<InlineV1ForwardingRequestsPostRequestFormXe4abb4a8> {
...
public class ForwardingClient(
  ...
  public companion object {
    internal val getForwardingRequestsMetadata: OperationMetadata by
    ...
    internal val getForwardingRequestsIdMetadata: OperationMetadata by
        lazy(LazyThreadSafetyMode.PUBLICATION) { OperationMetadata(
    ...
    internal val postForwardingRequestsMetadata: OperationMetadata by
        lazy(LazyThreadSafetyMode.PUBLICATION) { OperationMetadata(
