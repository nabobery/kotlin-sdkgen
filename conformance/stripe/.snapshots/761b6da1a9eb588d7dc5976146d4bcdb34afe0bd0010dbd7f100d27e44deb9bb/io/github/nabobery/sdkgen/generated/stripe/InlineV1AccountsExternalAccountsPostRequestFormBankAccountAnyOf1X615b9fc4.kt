...
public class InlineV1AccountsExternalAccountsPostRequestFormBankAccountAnyOf1X615b9fc4(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1AccountsExternalAccountsPostRequestFormBankAccountAnyOf1X615b9fc4 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1AccountsExternalAccountsPostRequestFormBankAccountAnyOf1X615b9fc4> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineV1AccountsExternalAccountsPostRequestFormBankAccountAnyOf1X615b9fc4 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineV1AccountsExternalAccountsPostRequestFormBankAccountAnyOf1X615b9fc4")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1AccountsExternalAccountsPostRequestFormBankAccountAnyOf1X615b9fc4 must be a JSON object")
      ...
      return InlineV1AccountsExternalAccountsPostRequestFormBankAccountAnyOf1X615b9fc4(
        ...
        accountHolderType = rawObject["account_holder_type"]?.let { json.decodeFromJsonElement<InlineV1AccountsExternalAcd662PostRequestFormAccountHolderTypeX9e679f8e>(it) },
        accountType = rawObject["account_type"]?.let { json.decodeFromJsonElement<InlineV1AccountsExternalAcd662PostRequestFormBankAccountAccountTypeX6d8da078>(it) },
        currency = rawObject["currency"]?.let { json.decodeFromJsonElement<String>(it) },
        documents = rawObject["documents"]?.let { json.decodeFromJsonElement<InlineV1AccountsExternalAcd662PostRequestFormBankAccountAnyOf1DocumentsX83c94ab0>(it) },
        objectValue = rawObject["object"]?.let { json.decodeFromJsonElement<InlineV1AccountsExternalAcd662PostRequestFormBankAccountObjectValueX37d1545b>(it) },
        routingNumber = rawObject["routing_number"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineV1AccountsExternalAccountsPostRequestFormBankAccountAnyOf1X615b9fc4) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineV1AccountsExternalAccountsPostRequestFormBankAccountAnyOf1X615b9fc4")
...
public fun inlineV1AccountsExternalAccountsPostRequestFormBankAccountAnyOf1X615b9fc4(block: InlineV1AccountsExternalAccountsPostRequestFormBankAccountAnyOf1X615b9fc4.Builder.() -> Unit): InlineV1AccountsExternalAccountsPostRequestFormBankAccountAnyOf1X615b9fc4 = InlineV1AccountsExternalAccountsPostRequestFormBankAccountAnyOf1X615b9fc4.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineV1AccountsExternalAccountsPostRequestFormBankAccountAnyOf1X615b9fc4 is missing required property '" + name + "'")
