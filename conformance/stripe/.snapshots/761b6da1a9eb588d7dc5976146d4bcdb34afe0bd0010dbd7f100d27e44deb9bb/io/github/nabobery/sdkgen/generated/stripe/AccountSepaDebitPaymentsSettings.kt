...
public class AccountSepaDebitPaymentsSettings(
  ...
  public class Builder {
    ...
    public fun build(): AccountSepaDebitPaymentsSettings = AccountSepaDebitPaymentsSettings(
  ...
  internal object Serializer : KSerializer<AccountSepaDebitPaymentsSettings> {
    ...
    override fun deserialize(decoder: Decoder): AccountSepaDebitPaymentsSettings {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("AccountSepaDebitPaymentsSettings must be a JSON object")
      return AccountSepaDebitPaymentsSettings(
        creditorId = rawObject["creditor_id"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: AccountSepaDebitPaymentsSettings) {
...
public fun accountSepaDebitPaymentsSettings(block: AccountSepaDebitPaymentsSettings.Builder.() -> Unit): AccountSepaDebitPaymentsSettings = AccountSepaDebitPaymentsSettings.build(block)
