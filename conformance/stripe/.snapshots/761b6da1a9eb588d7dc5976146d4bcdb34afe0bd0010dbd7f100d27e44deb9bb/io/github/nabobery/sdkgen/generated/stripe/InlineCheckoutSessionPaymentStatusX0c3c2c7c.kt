...
public sealed class InlineCheckoutSessionPaymentStatusX0c3c2c7c {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineCheckoutSessionPaymentStatusX0c3c2c7c = when (value) {
  ...
  internal object Serializer : KSerializer<InlineCheckoutSessionPaymentStatusX0c3c2c7c> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineCheckoutSessionPaymentStatusX0c3c2c7c", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineCheckoutSessionPaymentStatusX0c3c2c7c = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineCheckoutSessionPaymentStatusX0c3c2c7c) {
