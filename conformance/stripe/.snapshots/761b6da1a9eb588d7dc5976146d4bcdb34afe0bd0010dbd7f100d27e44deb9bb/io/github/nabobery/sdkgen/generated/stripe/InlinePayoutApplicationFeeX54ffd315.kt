...
public class InlinePayoutApplicationFeeX54ffd315 internal constructor(
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlinePayoutApplicationFeeX54ffd315 {
      val inspection = inspectInlinePayoutApplicationFeeX54ffd315(raw)
      if (inspection.matchCount == 0) {
        throw InlinePayoutApplicationFeeX54ffd315NoMatchException("InlinePayoutApplicationFeeX54ffd315 matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlinePayoutApplicationFeeX54ffd315(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlinePayoutApplicationFeeX54ffd315> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlinePayoutApplicationFeeX54ffd315) {
      encoder.requireJsonEncoder("InlinePayoutApplicationFeeX54ffd315").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlinePayoutApplicationFeeX54ffd315(element: JsonElement): InlinePayoutApplicationFeeX54ffd315Inspection {
