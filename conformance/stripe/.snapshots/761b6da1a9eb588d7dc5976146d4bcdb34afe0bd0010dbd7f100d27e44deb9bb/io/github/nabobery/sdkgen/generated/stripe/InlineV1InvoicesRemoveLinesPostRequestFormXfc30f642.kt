...
public class InlineV1InvoicesRemoveLinesPostRequestFormXfc30f642(
  ...
  public val invoiceMetadata:
      InlineV1InvoicesRemoveLinesPostRequestFormInvoiceMetadataXdbc0ce10? = null,
) {
  /**
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1InvoicesRemoveLinesPostRequestFormXfc30f642 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1InvoicesRemoveLinesPostRequestFormXfc30f642> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1InvoicesRemoveLinesPostRequestFormXfc30f642 {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1InvoicesRemoveLinesPostRequestFormXfc30f642 must be a JSON object")
      val lines = json.decodeRequired<List<InlineV1InvoicesRemoveLinesPostRequestFormLinesItemXe21b4f55>>(rawObject, "lines")
      return InlineV1InvoicesRemoveLinesPostRequestFormXfc30f642(
        lines = lines,
        expand = rawObject["expand"]?.let { json.decodeFromJsonElement<List<String>>(it) },
        invoiceMetadata = rawObject["invoice_metadata"]?.let { json.decodeFromJsonElement<InlineV1InvoicesRemoveLinesPostRequestFormInvoiceMetadataXdbc0ce10>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineV1InvoicesRemoveLinesPostRequestFormXfc30f642) {
...
public fun inlineV1InvoicesRemoveLinesPostRequestFormXfc30f642(block: InlineV1InvoicesRemoveLinesPostRequestFormXfc30f642.Builder.() -> Unit): InlineV1InvoicesRemoveLinesPostRequestFormXfc30f642 = InlineV1InvoicesRemoveLinesPostRequestFormXfc30f642.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineV1InvoicesRemoveLinesPostRequestFormXfc30f642 is missing required property '" + name + "'")
