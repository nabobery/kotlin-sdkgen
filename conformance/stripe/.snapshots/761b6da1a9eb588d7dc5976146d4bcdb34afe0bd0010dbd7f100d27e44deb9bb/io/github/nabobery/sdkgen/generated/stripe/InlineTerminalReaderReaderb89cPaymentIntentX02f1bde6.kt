...
public class InlineTerminalReaderReaderb89cPaymentIntentX02f1bde6 internal constructor(
  ...
  public val matchedBranches: Set<InlineTerminalReaderReaderb89cPaymentIntentX02f1bde6Branch>
    get() = buildSet {
      ...
      if (inspection.matchesPaymentIntent) add(InlineTerminalReaderReaderb89cPaymentIntentX02f1bde6Branch.PaymentIntent)
    }
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineTerminalReaderReaderb89cPaymentIntentX02f1bde6 {
      val inspection = inspectInlineTerminalReaderReaderb89cPaymentIntentX02f1bde6(raw)
      if (inspection.matchCount == 0) {
        throw InlineTerminalReaderReaderb89cPaymentIntentX02f1bde6NoMatchException("InlineTerminalReaderReaderb89cPaymentIntentX02f1bde6 matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineTerminalReaderReaderb89cPaymentIntentX02f1bde6(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineTerminalReaderReaderb89cPaymentIntentX02f1bde6> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineTerminalReaderReaderb89cPaymentIntentX02f1bde6) {
      encoder.requireJsonEncoder("InlineTerminalReaderReaderb89cPaymentIntentX02f1bde6").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineTerminalReaderReaderb89cPaymentIntentX02f1bde6(element: JsonElement): InlineTerminalReaderReaderb89cPaymentIntentX02f1bde6Inspection {
