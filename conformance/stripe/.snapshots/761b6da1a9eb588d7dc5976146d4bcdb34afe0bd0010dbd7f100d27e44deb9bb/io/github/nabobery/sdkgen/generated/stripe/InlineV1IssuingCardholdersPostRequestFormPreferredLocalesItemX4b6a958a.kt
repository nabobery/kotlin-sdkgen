...
public sealed class InlineV1IssuingCardholdersPostRequestFormPreferredLocalesItemX4b6a958a {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1IssuingCardholdersPostRequestFormPreferredLocalesItemX4b6a958a = when (value) {
      De.value -> De
      En.value -> En
      Es.value -> Es
      Fr.value -> Fr
  ...
  internal object Serializer : KSerializer<InlineV1IssuingCardholdersPostRequestFormPreferredLocalesItemX4b6a958a> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1IssuingCardholdersPostRequestFormPreferredLocalesItemX4b6a958a", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1IssuingCardholdersPostRequestFormPreferredLocalesItemX4b6a958a = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1IssuingCardholdersPostRequestFormPreferredLocalesItemX4b6a958a) {
