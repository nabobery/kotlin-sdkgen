...
public sealed class InlineV1SetupIntentsConfirmPostRequestFormAmountTypeX7e60476d {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1SetupIntentsConfirmPostRequestFormAmountTypeX7e60476d = when (value) {
      Fixed.value -> Fixed
  ...
  internal object Serializer : KSerializer<InlineV1SetupIntentsConfirmPostRequestFormAmountTypeX7e60476d> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1SetupIntentsConfirmPostRequestFormAmountTypeX7e60476d", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1SetupIntentsConfirmPostRequestFormAmountTypeX7e60476d = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1SetupIntentsConfirmPostRequestFormAmountTypeX7e60476d) {
