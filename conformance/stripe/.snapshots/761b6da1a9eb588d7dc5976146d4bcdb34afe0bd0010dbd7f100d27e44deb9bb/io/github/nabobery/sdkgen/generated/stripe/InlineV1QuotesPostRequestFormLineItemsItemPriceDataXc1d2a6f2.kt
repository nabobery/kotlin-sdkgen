...
public class InlineV1QuotesPostRequestFormLineItemsItemPriceDataXc1d2a6f2(
  ...
  public val recurring:
      InlineV1QuotesPostRequestFormLineItemsItemPriceDataRecurringX7fe86afb? = null,
  public val taxBehavior:
      InlineV1QuotesPostRequestFormLineItemsItemPriceDataTaxBehaviorXf6bfff43? = null,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1QuotesPostRequestFormLineItemsItemPriceDataXc1d2a6f2 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1QuotesPostRequestFormLineItemsItemPriceDataXc1d2a6f2> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1QuotesPostRequestFormLineItemsItemPriceDataXc1d2a6f2 {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1QuotesPostRequestFormLineItemsItemPriceDataXc1d2a6f2 must be a JSON object")
      val currency = json.decodeRequired<String>(rawObject, "currency")
      val product = json.decodeRequired<String>(rawObject, "product")
      return InlineV1QuotesPostRequestFormLineItemsItemPriceDataXc1d2a6f2(
        currency = currency,
        product = product,
        recurring = rawObject["recurring"]?.let { json.decodeFromJsonElement<InlineV1QuotesPostRequestFormLineItemsItemPriceDataRecurringX7fe86afb>(it) },
        taxBehavior = rawObject["tax_behavior"]?.let { json.decodeFromJsonElement<InlineV1QuotesPostRequestFormLineItemsItemPriceDataTaxBehaviorXf6bfff43>(it) },
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1QuotesPostRequestFormLineItemsItemPriceDataXc1d2a6f2) {
...
public fun inlineV1QuotesPostRequestFormLineItemsItemPriceDataXc1d2a6f2(block: InlineV1QuotesPostRequestFormLineItemsItemPriceDataXc1d2a6f2.Builder.() -> Unit): InlineV1QuotesPostRequestFormLineItemsItemPriceDataXc1d2a6f2 = InlineV1QuotesPostRequestFormLineItemsItemPriceDataXc1d2a6f2.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineV1QuotesPostRequestFormLineItemsItemPriceDataXc1d2a6f2 is missing required property '" + name + "'")
