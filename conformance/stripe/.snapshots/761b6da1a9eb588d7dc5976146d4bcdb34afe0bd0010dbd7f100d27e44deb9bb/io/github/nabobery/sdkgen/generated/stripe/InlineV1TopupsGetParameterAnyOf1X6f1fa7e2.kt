...
public class InlineV1TopupsGetParameterAnyOf1X6f1fa7e2(
  ...
  public class Builder {
    ...
    public fun build(): InlineV1TopupsGetParameterAnyOf1X6f1fa7e2 = InlineV1TopupsGetParameterAnyOf1X6f1fa7e2(
      gt = gt,
      gte = gte,
      lt = lt,
      lte = lte,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1TopupsGetParameterAnyOf1X6f1fa7e2 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1TopupsGetParameterAnyOf1X6f1fa7e2> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1TopupsGetParameterAnyOf1X6f1fa7e2 {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1TopupsGetParameterAnyOf1X6f1fa7e2 must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1TopupsGetParameterAnyOf1X6f1fa7e2) {
...
public fun inlineV1TopupsGetParameterAnyOf1X6f1fa7e2(block: InlineV1TopupsGetParameterAnyOf1X6f1fa7e2.Builder.() -> Unit): InlineV1TopupsGetParameterAnyOf1X6f1fa7e2 = InlineV1TopupsGetParameterAnyOf1X6f1fa7e2.build(block)
