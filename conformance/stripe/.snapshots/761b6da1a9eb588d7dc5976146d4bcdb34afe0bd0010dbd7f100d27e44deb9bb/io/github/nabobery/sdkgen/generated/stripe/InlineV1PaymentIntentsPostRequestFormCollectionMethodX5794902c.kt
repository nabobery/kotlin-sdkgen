...
public sealed class InlineV1PaymentIntentsPostRequestFormCollectionMethodX5794902c {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1PaymentIntentsPostRequestFormCollectionMethodX5794902c = when (value) {
      Value.value -> Value
      Paper.value -> Paper
  ...
  internal object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormCollectionMethodX5794902c> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1PaymentIntentsPostRequestFormCollectionMethodX5794902c", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1PaymentIntentsPostRequestFormCollectionMethodX5794902c = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1PaymentIntentsPostRequestFormCollectionMethodX5794902c) {
