...
public class InlineV1TerminalConnectionTokensPostRequestFormXa133cd51(
  ...
  public class Builder {
    ...
    public fun build(): InlineV1TerminalConnectionTokensPostRequestFormXa133cd51 = InlineV1TerminalConnectionTokensPostRequestFormXa133cd51(
      expand = expand,
      location = location,
    )
  }
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1TerminalConnectionTokensPostRequestFormXa133cd51 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1TerminalConnectionTokensPostRequestFormXa133cd51> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1TerminalConnectionTokensPostRequestFormXa133cd51 {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1TerminalConnectionTokensPostRequestFormXa133cd51 must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1TerminalConnectionTokensPostRequestFormXa133cd51) {
...
public fun inlineV1TerminalConnectionTokensPostRequestFormXa133cd51(block: InlineV1TerminalConnectionTokensPostRequestFormXa133cd51.Builder.() -> Unit): InlineV1TerminalConnectionTokensPostRequestFormXa133cd51 = InlineV1TerminalConnectionTokensPostRequestFormXa133cd51.build(block)
