...
public sealed class InlineTaxProductRegistrationsResourceCountryOptionsCanadaTypeX916e1e7b {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineTaxProductRegistrationsResourceCountryOptionsCanadaTypeX916e1e7b = when (value) {
  ...
  internal object Serializer : KSerializer<InlineTaxProductRegistrationsResourceCountryOptionsCanadaTypeX916e1e7b> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineTaxProductRegistrationsResourceCountryOptionsCanadaTypeX916e1e7b", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineTaxProductRegistrationsResourceCountryOptionsCanadaTypeX916e1e7b = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineTaxProductRegistrationsResourceCountryOptionsCanadaTypeX916e1e7b) {
