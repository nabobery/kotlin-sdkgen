...
public sealed class InlineCheckoutBacsDebitPaymentMethodOptionsSetupFutureUsageX6c1aa115 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineCheckoutBacsDebitPaymentMethodOptionsSetupFutureUsageX6c1aa115 = when (value) {
      None.value -> None
  ...
  internal object Serializer : KSerializer<InlineCheckoutBacsDebitPaymentMethodOptionsSetupFutureUsageX6c1aa115> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineCheckoutBacsDebitPaymentMethodOptionsSetupFutureUsageX6c1aa115", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineCheckoutBacsDebitPaymentMethodOptionsSetupFutureUsageX6c1aa115 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineCheckoutBacsDebitPaymentMethodOptionsSetupFutureUsageX6c1aa115) {
