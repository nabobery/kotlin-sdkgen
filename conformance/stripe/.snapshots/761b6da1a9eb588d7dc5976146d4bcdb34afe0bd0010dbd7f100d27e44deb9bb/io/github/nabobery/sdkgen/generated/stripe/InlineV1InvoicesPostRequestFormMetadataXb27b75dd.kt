...
public class InlineV1InvoicesPostRequestFormMetadataXb27b75dd internal constructor(
  ...
  public val inlineV1InvoicesPostRequestFormMetadataAnyOf2X97141575:
      ...
      lazy(LazyThreadSafetyMode.NONE) { if (inspection.matchesInlineV1InvoicesPostRequestFormMetadataAnyOf2X97141575) json.decodeFromJsonElement<InlineV1InvoicesPostRequestFormMetadataAnyOf2X97141575>(raw) else null }
  ...
  public val matchedBranches: Set<InlineV1InvoicesPostRequestFormMetadataXb27b75ddBranch>
    get() = buildSet {
      ...
      if (inspection.matchesInlineV1InvoicesPostRequestFormMetadataAnyOf2X97141575) add(InlineV1InvoicesPostRequestFormMetadataXb27b75ddBranch.InlineV1InvoicesPostRequestFormMetadataAnyOf2X97141575)
    }
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineV1InvoicesPostRequestFormMetadataXb27b75dd {
      val inspection = inspectInlineV1InvoicesPostRequestFormMetadataXb27b75dd(raw)
      if (inspection.matchCount == 0) {
        throw InlineV1InvoicesPostRequestFormMetadataXb27b75ddNoMatchException("InlineV1InvoicesPostRequestFormMetadataXb27b75dd matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineV1InvoicesPostRequestFormMetadataXb27b75dd(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineV1InvoicesPostRequestFormMetadataXb27b75dd> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1InvoicesPostRequestFormMetadataXb27b75dd) {
      encoder.requireJsonEncoder("InlineV1InvoicesPostRequestFormMetadataXb27b75dd").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineV1InvoicesPostRequestFormMetadataXb27b75dd(element: JsonElement): InlineV1InvoicesPostRequestFormMetadataXb27b75ddInspection {
  val matchesBranch1 = element.isJsonDecodable<JsonObject>()
  val matchesInlineV1InvoicesPostRequestFormMetadataAnyOf2X97141575 = element.isJsonDecodable<InlineV1InvoicesPostRequestFormMetadataAnyOf2X97141575>()
  return InlineV1InvoicesPostRequestFormMetadataXb27b75ddInspection(
    ...
    failures = buildList {
      ...
      if (!matchesInlineV1InvoicesPostRequestFormMetadataAnyOf2X97141575) add("InlineV1InvoicesPostRequestFormMetadataAnyOf2X97141575: value does not match InlineV1InvoicesPostRequestFormMetadataAnyOf2X97141575")
    },
  )
}
