...
public sealed class InlineV1AccountsPersonsPostRequestFormUsCfpbDataEthnicityDetailsItemX6ca4356e {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1AccountsPersonsPostRequestFormUsCfpbDataEthnicityDetailsItemX6ca4356e = when (value) {
      Cuban.value -> Cuban
  ...
  internal object Serializer : KSerializer<InlineV1AccountsPersonsPostRequestFormUsCfpbDataEthnicityDetailsItemX6ca4356e> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1AccountsPersonsPostRequestFormUsCfpbDataEthnicityDetailsItemX6ca4356e", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1AccountsPersonsPostRequestFormUsCfpbDataEthnicityDetailsItemX6ca4356e = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1AccountsPersonsPostRequestFormUsCfpbDataEthnicityDetailsItemX6ca4356e) {
