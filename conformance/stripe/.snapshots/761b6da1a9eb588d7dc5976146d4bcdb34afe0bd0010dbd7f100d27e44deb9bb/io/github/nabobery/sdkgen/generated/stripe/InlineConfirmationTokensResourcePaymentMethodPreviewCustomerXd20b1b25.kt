...
public class InlineConfirmationTokensResourcePaymentMethodPreviewCustomerXd20b1b25 internal constructor(
  ...
  public val matchedBranches:
    ...
    get() = buildSet {
      if (inspection.matchesBranch1) add(InlineConfirmationTokensResourcePaymentMethodPreviewCustomerXd20b1b25Branch.Branch1)
      if (inspection.matchesCustomer) add(InlineConfirmationTokensResourcePaymentMethodPreviewCustomerXd20b1b25Branch.Customer)
    }
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineConfirmationTokensResourcePaymentMethodPreviewCustomerXd20b1b25 {
      val inspection = inspectInlineConfirmationTokensResourcePaymentMethodPreviewCustomerXd20b1b25(raw)
      if (inspection.matchCount == 0) {
        throw InlineConfirmationTokensResourcePaymentMethodPreviewCustomerXd20b1b25NoMatchException("InlineConfirmationTokensResourcePaymentMethodPreviewCustomerXd20b1b25 matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineConfirmationTokensResourcePaymentMethodPreviewCustomerXd20b1b25(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineConfirmationTokensResourcePaymentMethodPreviewCustomerXd20b1b25> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineConfirmationTokensResourcePaymentMethodPreviewCustomerXd20b1b25 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineConfirmationTokensResourcePaymentMethodPreviewCustomerXd20b1b25")
      return fromRaw(jsonDecoder.decodeJsonElement(), jsonDecoder.json)
    }

    override fun serialize(encoder: Encoder, `value`: InlineConfirmationTokensResourcePaymentMethodPreviewCustomerXd20b1b25) {
      encoder.requireJsonEncoder("InlineConfirmationTokensResourcePaymentMethodPreviewCustomerXd20b1b25").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineConfirmationTokensResourcePaymentMethodPreviewCustomerXd20b1b25(element: JsonElement): InlineConfirmationTokensResourcePaymentMethodPreviewCustomerXd20b1b25Inspection {
