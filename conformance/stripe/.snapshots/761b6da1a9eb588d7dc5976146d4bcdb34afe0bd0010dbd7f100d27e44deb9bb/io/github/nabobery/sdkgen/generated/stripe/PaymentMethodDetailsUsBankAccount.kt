...
public class PaymentMethodDetailsUsBankAccount(
  ...
  public val accountHolderType:
      InlinePaymentMethodDetailsUsBankAccountAccountHolderTypeX45d7508e? = null,
  /**
  ...
  public class Builder {
    ...
    public fun build(): PaymentMethodDetailsUsBankAccount = PaymentMethodDetailsUsBankAccount(
  ...
  internal object Serializer : KSerializer<PaymentMethodDetailsUsBankAccount> {
    ...
    override fun deserialize(decoder: Decoder): PaymentMethodDetailsUsBankAccount {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("PaymentMethodDetailsUsBankAccount must be a JSON object")
      return PaymentMethodDetailsUsBankAccount(
        accountHolderType = rawObject["account_holder_type"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlinePaymentMethodDetailsUsBankAccountAccountHolderTypeX45d7508e?>(element) },
        accountType = rawObject["account_type"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlinePaymentMethodDetailsUsBankAccountAccountTypeX6c240b2e?>(element) },
        ...
        mandate = rawObject["mandate"]?.let { json.decodeFromJsonElement<InlinePaymentMethodDetailsUsBankAccountMandateX477127d7>(it) },
    ...
    override fun serialize(encoder: Encoder, `value`: PaymentMethodDetailsUsBankAccount) {
...
public fun paymentMethodDetailsUsBankAccount(block: PaymentMethodDetailsUsBankAccount.Builder.() -> Unit): PaymentMethodDetailsUsBankAccount = PaymentMethodDetailsUsBankAccount.build(block)
