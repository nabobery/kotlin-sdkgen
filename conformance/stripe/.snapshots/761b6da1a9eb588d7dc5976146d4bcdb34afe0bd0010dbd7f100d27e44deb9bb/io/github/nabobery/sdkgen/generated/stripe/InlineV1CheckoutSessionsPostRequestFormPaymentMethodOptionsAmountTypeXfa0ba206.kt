...
public sealed class InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsAmountTypeXfa0ba206 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsAmountTypeXfa0ba206 = when (value) {
      Value.value -> Value
      Fixed.value -> Fixed
  ...
  internal object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsAmountTypeXfa0ba206> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsAmountTypeXfa0ba206", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsAmountTypeXfa0ba206 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1CheckoutSessionsPostRequestFormPaymentMethodOptionsAmountTypeXfa0ba206) {
