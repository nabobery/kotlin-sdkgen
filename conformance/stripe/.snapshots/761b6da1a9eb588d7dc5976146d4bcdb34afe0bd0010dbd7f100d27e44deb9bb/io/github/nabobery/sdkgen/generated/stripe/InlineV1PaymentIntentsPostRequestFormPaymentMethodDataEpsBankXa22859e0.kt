 ...
 * urlencoded/schema/properties/payment_method_data/properties/eps/properties/bank.
 *
 * Source:
 * sdkgen://source/openapi.json#/paths/~1v1~1payment_intents~1{intent}/post/requestBody/content/application~1x-www-form-
 * urlencoded/schema/properties/payment_method_data/properties/eps/properties/bank
 */
@Serializable(with = InlineV1PaymentIntentsPostRequestFormPaymentMethodDataEpsBankXa22859e0.Serializer::class)
public sealed class InlineV1PaymentIntentsPostRequestFormPaymentMethodDataEpsBankXa22859e0 {
  public abstract val `value`: String

  /**
   * Documented value. Wire value: `arzte_und_apotheker_bank`.
   */
  public data object ArzteUndApothekerBank : InlineV1PaymentIntentsPostRequestFormPaymentMethodDataEpsBankXa22859e0() {
   ...
   */
  public data object AustrianAnadiBankAg : InlineV1PaymentIntentsPostRequestFormPaymentMethodDataEpsBankXa22859e0() {
   ...
   */
  public data object BankAustria : InlineV1PaymentIntentsPostRequestFormPaymentMethodDataEpsBankXa22859e0() {
   ...
   */
  public data object BankhausCarlSpangler : InlineV1PaymentIntentsPostRequestFormPaymentMethodDataEpsBankXa22859e0() {
   ...
   */
  public data object BankhausSchelhammerUndSchatteraAg : InlineV1PaymentIntentsPostRequestFormPaymentMethodDataEpsBankXa22859e0() {
   ...
   */
  public data object BawagPskAg : InlineV1PaymentIntentsPostRequestFormPaymentMethodDataEpsBankXa22859e0() {
   ...
   */
  public data object BksBankAg : InlineV1PaymentIntentsPostRequestFormPaymentMethodDataEpsBankXa22859e0() {
   ...
   */
  public data object BrullKallmusBankAg : InlineV1PaymentIntentsPostRequestFormPaymentMethodDataEpsBankXa22859e0() {
   ...
   */
  public data object BtvVierLanderBank : InlineV1PaymentIntentsPostRequestFormPaymentMethodDataEpsBankXa22859e0() {
   ...
   */
  public data object CapitalBankGraweGruppeAg : InlineV1PaymentIntentsPostRequestFormPaymentMethodDataEpsBankXa22859e0() {
   ...
   */
  public data object DeutscheBankAg : InlineV1PaymentIntentsPostRequestFormPaymentMethodDataEpsBankXa22859e0() {
   ...
   */
  public data object Dolomitenbank : InlineV1PaymentIntentsPostRequestFormPaymentMethodDataEpsBankXa22859e0() {
   ...
   */
  public data object EasybankAg : InlineV1PaymentIntentsPostRequestFormPaymentMethodDataEpsBankXa22859e0() {
   ...
   */
  public data object ErsteBankUndSparkassen : InlineV1PaymentIntentsPostRequestFormPaymentMethodDataEpsBankXa22859e0() {
   ...
   */
  public data object HypoAlpeadriabankInternationalAg : InlineV1PaymentIntentsPostRequestFormPaymentMethodDataEpsBankXa22859e0() {
   ...
   */
  public data object HypoBankBurgenlandAktiengesellschaft : InlineV1PaymentIntentsPostRequestFormPaymentMethodDataEpsBankXa22859e0() {
   ...
   */
  public data object HypoNoeLbFurNiederosterreichUWien : InlineV1PaymentIntentsPostRequestFormPaymentMethodDataEpsBankXa22859e0() {
   ...
   */
  public data object HypoOberosterreichSalzburgSteiermark : InlineV1PaymentIntentsPostRequestFormPaymentMethodDataEpsBankXa22859e0() {
   ...
   */
  public data object HypoTirolBankAg : InlineV1PaymentIntentsPostRequestFormPaymentMethodDataEpsBankXa22859e0() {
   ...
   */
  public data object HypoVorarlbergBankAg : InlineV1PaymentIntentsPostRequestFormPaymentMethodDataEpsBankXa22859e0() {
   ...
   */
  public data object MarchfelderBank : InlineV1PaymentIntentsPostRequestFormPaymentMethodDataEpsBankXa22859e0() {
   ...
   */
  public data object OberbankAg : InlineV1PaymentIntentsPostRequestFormPaymentMethodDataEpsBankXa22859e0() {
   ...
   */
  public data object RaiffeisenBankengruppeOsterreich : InlineV1PaymentIntentsPostRequestFormPaymentMethodDataEpsBankXa22859e0() {
   ...
   */
  public data object SchoellerbankAg : InlineV1PaymentIntentsPostRequestFormPaymentMethodDataEpsBankXa22859e0() {
   ...
   */
  public data object SpardaBankWien : InlineV1PaymentIntentsPostRequestFormPaymentMethodDataEpsBankXa22859e0() {
   ...
   */
  public data object VolksbankGruppe : InlineV1PaymentIntentsPostRequestFormPaymentMethodDataEpsBankXa22859e0() {
   ...
   */
  public data object VolkskreditbankAg : InlineV1PaymentIntentsPostRequestFormPaymentMethodDataEpsBankXa22859e0() {
   ...
   */
  public data object VrBankBraunau : InlineV1PaymentIntentsPostRequestFormPaymentMethodDataEpsBankXa22859e0() {
    public override val `value`: String = "vr_bank_braunau"
  }

  public data class SdkUnknown(
    public override val `value`: String,
  ) : InlineV1PaymentIntentsPostRequestFormPaymentMethodDataEpsBankXa22859e0()

  public companion object {
    public fun fromValue(`value`: String): InlineV1PaymentIntentsPostRequestFormPaymentMethodDataEpsBankXa22859e0 = when (value) {
  ...
  internal object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormPaymentMethodDataEpsBankXa22859e0> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1PaymentIntentsPostRequestFormPaymentMethodDataEpsBankXa22859e0", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1PaymentIntentsPostRequestFormPaymentMethodDataEpsBankXa22859e0 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1PaymentIntentsPostRequestFormPaymentMethodDataEpsBankXa22859e0) {
