...
public sealed class InlineThreeDSecureDetailsChargeAuthenticationFlowX33b6c32f {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineThreeDSecureDetailsChargeAuthenticationFlowX33b6c32f = when (value) {
  ...
  internal object Serializer : KSerializer<InlineThreeDSecureDetailsChargeAuthenticationFlowX33b6c32f> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineThreeDSecureDetailsChargeAuthenticationFlowX33b6c32f", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineThreeDSecureDetailsChargeAuthenticationFlowX33b6c32f = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineThreeDSecureDetailsChargeAuthenticationFlowX33b6c32f) {
