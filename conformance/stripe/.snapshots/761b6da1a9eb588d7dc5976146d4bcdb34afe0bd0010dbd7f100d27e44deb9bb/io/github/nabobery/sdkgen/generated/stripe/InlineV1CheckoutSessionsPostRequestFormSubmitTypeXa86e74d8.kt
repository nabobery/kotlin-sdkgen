...
public sealed class InlineV1CheckoutSessionsPostRequestFormSubmitTypeXa86e74d8 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1CheckoutSessionsPostRequestFormSubmitTypeXa86e74d8 = when (value) {
      Auto.value -> Auto
      Book.value -> Book
      Donate.value -> Donate
      Pay.value -> Pay
  ...
  internal object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormSubmitTypeXa86e74d8> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1CheckoutSessionsPostRequestFormSubmitTypeXa86e74d8", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1CheckoutSessionsPostRequestFormSubmitTypeXa86e74d8 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1CheckoutSessionsPostRequestFormSubmitTypeXa86e74d8) {
