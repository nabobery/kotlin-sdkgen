...
public class InlineV1CustomersPostRequestFormMetadataX4ae4881c internal constructor(
  ...
  public val inlineV1CustomersPostRequestFormMetadataAnyOf2X129f5b1e:
      ...
      lazy(LazyThreadSafetyMode.NONE) { if (inspection.matchesInlineV1CustomersPostRequestFormMetadataAnyOf2X129f5b1e) json.decodeFromJsonElement<InlineV1CustomersPostRequestFormMetadataAnyOf2X129f5b1e>(raw) else null }
  ...
  public val matchedBranches: Set<InlineV1CustomersPostRequestFormMetadataX4ae4881cBranch>
    get() = buildSet {
      ...
      if (inspection.matchesInlineV1CustomersPostRequestFormMetadataAnyOf2X129f5b1e) add(InlineV1CustomersPostRequestFormMetadataX4ae4881cBranch.InlineV1CustomersPostRequestFormMetadataAnyOf2X129f5b1e)
    }
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineV1CustomersPostRequestFormMetadataX4ae4881c {
      val inspection = inspectInlineV1CustomersPostRequestFormMetadataX4ae4881c(raw)
      if (inspection.matchCount == 0) {
        throw InlineV1CustomersPostRequestFormMetadataX4ae4881cNoMatchException("InlineV1CustomersPostRequestFormMetadataX4ae4881c matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineV1CustomersPostRequestFormMetadataX4ae4881c(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineV1CustomersPostRequestFormMetadataX4ae4881c> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1CustomersPostRequestFormMetadataX4ae4881c) {
      encoder.requireJsonEncoder("InlineV1CustomersPostRequestFormMetadataX4ae4881c").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineV1CustomersPostRequestFormMetadataX4ae4881c(element: JsonElement): InlineV1CustomersPostRequestFormMetadataX4ae4881cInspection {
  val matchesBranch1 = element.isJsonDecodable<JsonObject>()
  val matchesInlineV1CustomersPostRequestFormMetadataAnyOf2X129f5b1e = element.isJsonDecodable<InlineV1CustomersPostRequestFormMetadataAnyOf2X129f5b1e>()
  return InlineV1CustomersPostRequestFormMetadataX4ae4881cInspection(
    ...
    failures = buildList {
      ...
      if (!matchesInlineV1CustomersPostRequestFormMetadataAnyOf2X129f5b1e) add("InlineV1CustomersPostRequestFormMetadataAnyOf2X129f5b1e: value does not match InlineV1CustomersPostRequestFormMetadataAnyOf2X129f5b1e")
    },
  )
}
