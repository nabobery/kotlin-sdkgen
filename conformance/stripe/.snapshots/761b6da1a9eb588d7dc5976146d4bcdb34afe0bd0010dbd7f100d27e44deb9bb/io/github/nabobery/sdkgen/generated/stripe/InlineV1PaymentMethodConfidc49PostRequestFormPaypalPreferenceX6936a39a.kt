...
public sealed class InlineV1PaymentMethodConfidc49PostRequestFormPaypalPreferenceX6936a39a {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1PaymentMethodConfidc49PostRequestFormPaypalPreferenceX6936a39a = when (value) {
      None.value -> None
      Off.value -> Off
      On.value -> On
  ...
  internal object Serializer : KSerializer<InlineV1PaymentMethodConfidc49PostRequestFormPaypalPreferenceX6936a39a> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1PaymentMethodConfidc49PostRequestFormPaypalPreferenceX6936a39a", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1PaymentMethodConfidc49PostRequestFormPaypalPreferenceX6936a39a = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1PaymentMethodConfidc49PostRequestFormPaypalPreferenceX6936a39a) {
