...
public sealed class InlineV1AccountsPostRequestFormSettingsInvoicesHostedPaymentMethodSaveX1edcdeae {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1AccountsPostRequestFormSettingsInvoicesHostedPaymentMethodSaveX1edcdeae = when (value) {
      Always.value -> Always
      Never.value -> Never
      Offer.value -> Offer
  ...
  internal object Serializer : KSerializer<InlineV1AccountsPostRequestFormSettingsInvoicesHostedPaymentMethodSaveX1edcdeae> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1AccountsPostRequestFormSettingsInvoicesHostedPaymentMethodSaveX1edcdeae", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1AccountsPostRequestFormSettingsInvoicesHostedPaymentMethodSaveX1edcdeae = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1AccountsPostRequestFormSettingsInvoicesHostedPaymentMethodSaveX1edcdeae) {
