...
public sealed class InlineSetupIntentTypeSpeci142bVerificationMethodX806b0bbe {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineSetupIntentTypeSpeci142bVerificationMethodX806b0bbe = when (value) {
  ...
  internal object Serializer : KSerializer<InlineSetupIntentTypeSpeci142bVerificationMethodX806b0bbe> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineSetupIntentTypeSpeci142bVerificationMethodX806b0bbe", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineSetupIntentTypeSpeci142bVerificationMethodX806b0bbe = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineSetupIntentTypeSpeci142bVerificationMethodX806b0bbe) {
