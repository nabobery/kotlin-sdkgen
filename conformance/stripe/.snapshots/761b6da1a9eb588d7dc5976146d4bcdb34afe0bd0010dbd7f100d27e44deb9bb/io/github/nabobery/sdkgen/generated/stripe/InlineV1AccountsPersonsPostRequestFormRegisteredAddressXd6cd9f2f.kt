...
public class InlineV1AccountsPersonsPostRequestFormRegisteredAddressXd6cd9f2f(
  ...
  public class Builder {
    ...
    public fun build(): InlineV1AccountsPersonsPostRequestFormRegisteredAddressXd6cd9f2f = InlineV1AccountsPersonsPostRequestFormRegisteredAddressXd6cd9f2f(
      city = city,
      country = country,
      line1 = line1,
      line2 = line2,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1AccountsPersonsPostRequestFormRegisteredAddressXd6cd9f2f = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1AccountsPersonsPostRequestFormRegisteredAddressXd6cd9f2f> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineV1AccountsPersonsPostRequestFormRegisteredAddressXd6cd9f2f {
      val jsonDecoder = decoder.requireJsonDecoder("InlineV1AccountsPersonsPostRequestFormRegisteredAddressXd6cd9f2f")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1AccountsPersonsPostRequestFormRegisteredAddressXd6cd9f2f must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1AccountsPersonsPostRequestFormRegisteredAddressXd6cd9f2f) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineV1AccountsPersonsPostRequestFormRegisteredAddressXd6cd9f2f")
...
public fun inlineV1AccountsPersonsPostRequestFormRegisteredAddressXd6cd9f2f(block: InlineV1AccountsPersonsPostRequestFormRegisteredAddressXd6cd9f2f.Builder.() -> Unit): InlineV1AccountsPersonsPostRequestFormRegisteredAddressXd6cd9f2f = InlineV1AccountsPersonsPostRequestFormRegisteredAddressXd6cd9f2f.build(block)
