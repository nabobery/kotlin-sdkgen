...
public class PaymentMethodDetailsSatispay(
  ...
  public class Builder {
    ...
    public fun build(): PaymentMethodDetailsSatispay = PaymentMethodDetailsSatispay(
  ...
  internal object Serializer : KSerializer<PaymentMethodDetailsSatispay> {
    ...
    override fun deserialize(decoder: Decoder): PaymentMethodDetailsSatispay {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("PaymentMethodDetailsSatispay must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: PaymentMethodDetailsSatispay) {
...
public fun paymentMethodDetailsSatispay(block: PaymentMethodDetailsSatispay.Builder.() -> Unit): PaymentMethodDetailsSatispay = PaymentMethodDetailsSatispay.build(block)
