...
public class InlineV1QuotesPostRequestFormHeaderX35374ae5 internal constructor(
  ...
  public val inlineV1QuotesPostRequestFormHeaderAnyOf2X501145cb:
      ...
      lazy(LazyThreadSafetyMode.NONE) { if (inspection.matchesInlineV1QuotesPostRequestFormHeaderAnyOf2X501145cb) json.decodeFromJsonElement<InlineV1QuotesPostRequestFormHeaderAnyOf2X501145cb>(raw) else null }
  ...
  public val matchedBranches: Set<InlineV1QuotesPostRequestFormHeaderX35374ae5Branch>
    get() = buildSet {
      ...
      if (inspection.matchesInlineV1QuotesPostRequestFormHeaderAnyOf2X501145cb) add(InlineV1QuotesPostRequestFormHeaderX35374ae5Branch.InlineV1QuotesPostRequestFormHeaderAnyOf2X501145cb)
    }
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineV1QuotesPostRequestFormHeaderX35374ae5 {
      val inspection = inspectInlineV1QuotesPostRequestFormHeaderX35374ae5(raw)
      if (inspection.matchCount == 0) {
        throw InlineV1QuotesPostRequestFormHeaderX35374ae5NoMatchException("InlineV1QuotesPostRequestFormHeaderX35374ae5 matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineV1QuotesPostRequestFormHeaderX35374ae5(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineV1QuotesPostRequestFormHeaderX35374ae5> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1QuotesPostRequestFormHeaderX35374ae5) {
      encoder.requireJsonEncoder("InlineV1QuotesPostRequestFormHeaderX35374ae5").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineV1QuotesPostRequestFormHeaderX35374ae5(element: JsonElement): InlineV1QuotesPostRequestFormHeaderX35374ae5Inspection {
  val matchesBranch1 = element.isJsonDecodable<String>()
  val matchesInlineV1QuotesPostRequestFormHeaderAnyOf2X501145cb = element.isJsonDecodable<InlineV1QuotesPostRequestFormHeaderAnyOf2X501145cb>()
  return InlineV1QuotesPostRequestFormHeaderX35374ae5Inspection(
    ...
    failures = buildList {
      ...
      if (!matchesInlineV1QuotesPostRequestFormHeaderAnyOf2X501145cb) add("InlineV1QuotesPostRequestFormHeaderAnyOf2X501145cb: value does not match InlineV1QuotesPostRequestFormHeaderAnyOf2X501145cb")
    },
  )
}
