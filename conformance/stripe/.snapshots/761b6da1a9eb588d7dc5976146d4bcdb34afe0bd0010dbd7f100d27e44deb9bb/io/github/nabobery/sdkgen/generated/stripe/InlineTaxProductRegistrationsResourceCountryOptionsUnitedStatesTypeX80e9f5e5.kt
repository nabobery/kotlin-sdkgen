...
public sealed class InlineTaxProductRegistrationsResourceCountryOptionsUnitedStatesTypeX80e9f5e5 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineTaxProductRegistrationsResourceCountryOptionsUnitedStatesTypeX80e9f5e5 = when (value) {
  ...
  internal object Serializer : KSerializer<InlineTaxProductRegistrationsResourceCountryOptionsUnitedStatesTypeX80e9f5e5> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineTaxProductRegistrationsResourceCountryOptionsUnitedStatesTypeX80e9f5e5", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineTaxProductRegistrationsResourceCountryOptionsUnitedStatesTypeX80e9f5e5 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineTaxProductRegistrationsResourceCountryOptionsUnitedStatesTypeX80e9f5e5) {
