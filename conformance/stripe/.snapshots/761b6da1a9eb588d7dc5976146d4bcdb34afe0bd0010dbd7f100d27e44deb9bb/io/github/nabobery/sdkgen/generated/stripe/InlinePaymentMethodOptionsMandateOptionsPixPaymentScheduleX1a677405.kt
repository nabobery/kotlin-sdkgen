...
public sealed class InlinePaymentMethodOptionsMandateOptionsPixPaymentScheduleX1a677405 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlinePaymentMethodOptionsMandateOptionsPixPaymentScheduleX1a677405 = when (value) {
  ...
  internal object Serializer : KSerializer<InlinePaymentMethodOptionsMandateOptionsPixPaymentScheduleX1a677405> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlinePaymentMethodOptionsMandateOptionsPixPaymentScheduleX1a677405", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlinePaymentMethodOptionsMandateOptionsPixPaymentScheduleX1a677405 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlinePaymentMethodOptionsMandateOptionsPixPaymentScheduleX1a677405) {
