...
public sealed class InlineFinancialConnectionsAccountStatusXdb3bb633 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineFinancialConnectionsAccountStatusXdb3bb633 = when (value) {
      Active.value -> Active
  ...
  internal object Serializer : KSerializer<InlineFinancialConnectionsAccountStatusXdb3bb633> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineFinancialConnectionsAccountStatusXdb3bb633", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineFinancialConnectionsAccountStatusXdb3bb633 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineFinancialConnectionsAccountStatusXdb3bb633) {
