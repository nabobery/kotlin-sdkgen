package io.github.nabobery.sdkgen.generated.stripe.shippingrates
...
import io.github.nabobery.sdkgen.generated.stripe.InlineV1ShippingRatesGetParameterX8d7ebb7f
import io.github.nabobery.sdkgen.generated.stripe.InlineV1ShippingRatesGetResponse200JsonX65a764d3
import io.github.nabobery.sdkgen.generated.stripe.InlineV1ShippingRatesPostRequestFormX9221dee2
import io.github.nabobery.sdkgen.generated.stripe.InlineV1ShippingRatesPostRequestFormXc4ae2656
import io.github.nabobery.sdkgen.generated.stripe.SdkJson
import io.github.nabobery.sdkgen.generated.stripe.ShippingRate
...
internal object ShippingRatesCodecs {
  internal const val GETSHIPPINGRATES_REQUEST_CODEC_ID: String = "GetShippingRates.request"
  ...
  internal val getShippingRatesResponseCodecAlternative0Registry:
  ...
  internal val getShippingRatesResponseCodecAlternative1Registry: MediaTypeCodecRegistry<Error> =
      MediaTypeCodecRegistry.of(getShippingRatesResponseCodecAlternative1Codec)

  internal val getShippingRatesRequestCodecRegistry: MediaTypeCodecRegistry<JsonObject?> =
      MediaTypeCodecRegistry.of(getShippingRatesRequestCodec)

  internal const val GETSHIPPINGRATESSHIPPINGRATETOKEN_REQUEST_CODEC_ID: String =
  ...
  internal val getShippingRatesShippingRateTokenResponseCodecAlternative0Registry:
  ...
  internal val getShippingRatesShippingRateTokenResponseCodecAlternative1Registry:
      MediaTypeCodecRegistry<Error> =
      MediaTypeCodecRegistry.of(getShippingRatesShippingRateTokenResponseCodecAlternative1Codec)

  internal val getShippingRatesShippingRateTokenRequestCodecRegistry:
      MediaTypeCodecRegistry<JsonObject?> =
      MediaTypeCodecRegistry.of(getShippingRatesShippingRateTokenRequestCodec)

  internal const val POSTSHIPPINGRATES_REQUEST_CODEC_ID: String = "PostShippingRates.request"
  ...
  internal val postShippingRatesResponseCodecAlternative0Registry:
      MediaTypeCodecRegistry<ShippingRate> =
  ...
  internal val postShippingRatesResponseCodecAlternative1Registry: MediaTypeCodecRegistry<Error> =
      MediaTypeCodecRegistry.of(postShippingRatesResponseCodecAlternative1Codec)

  internal val postShippingRatesRequestCodecRegistry:
  ...
  internal const val POSTSHIPPINGRATESSHIPPINGRATETOKEN_REQUEST_CODEC_ID: String =
  ...
  internal val postShippingRatesShippingRateTokenResponseCodecAlternative0Registry:
      MediaTypeCodecRegistry<ShippingRate> =
  ...
  internal val postShippingRatesShippingRateTokenResponseCodecAlternative1Registry:
      MediaTypeCodecRegistry<Error> =
      MediaTypeCodecRegistry.of(postShippingRatesShippingRateTokenResponseCodecAlternative1Codec)

  internal val postShippingRatesShippingRateTokenRequestCodecRegistry:
  ...
  internal object GetShippingRatesFormCodec : MediaTypeCodec<JsonObject?> {
  ...
  internal object GetShippingRatesShippingRateTokenFormCodec : MediaTypeCodec<JsonObject?> {
  ...
  internal object PostShippingRatesFormCodec : MediaTypeCodec<InlineV1ShippingRatesPostRequestFormXc4ae2656> {
  ...
  internal object PostShippingRatesShippingRateTokenFormCodec : MediaTypeCodec<InlineV1ShippingRatesPostRequestFormX9221dee2?> {
...
public class ShippingRatesClient(
  ...
  public companion object {
    internal val getShippingRatesMetadata: OperationMetadata by
    ...
    internal val getShippingRatesShippingRateTokenMetadata: OperationMetadata by
        lazy(LazyThreadSafetyMode.PUBLICATION) { OperationMetadata(
    ...
    internal val postShippingRatesMetadata: OperationMetadata by
        lazy(LazyThreadSafetyMode.PUBLICATION) { OperationMetadata(
    ...
    internal val postShippingRatesShippingRateTokenMetadata: OperationMetadata by
        lazy(LazyThreadSafetyMode.PUBLICATION) { OperationMetadata(
