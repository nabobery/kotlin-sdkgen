...
public class InlineTransferReversalBalanceTransactionX1338043b internal constructor(
  ...
  public val matchedBranches: Set<InlineTransferReversalBalanceTransactionX1338043bBranch>
    get() = buildSet {
      ...
      if (inspection.matchesBalanceTransaction) add(InlineTransferReversalBalanceTransactionX1338043bBranch.BalanceTransaction)
    }
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineTransferReversalBalanceTransactionX1338043b {
      val inspection = inspectInlineTransferReversalBalanceTransactionX1338043b(raw)
      if (inspection.matchCount == 0) {
        throw InlineTransferReversalBalanceTransactionX1338043bNoMatchException("InlineTransferReversalBalanceTransactionX1338043b matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineTransferReversalBalanceTransactionX1338043b(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineTransferReversalBalanceTransactionX1338043b> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineTransferReversalBalanceTransactionX1338043b) {
      encoder.requireJsonEncoder("InlineTransferReversalBalanceTransactionX1338043b").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineTransferReversalBalanceTransactionX1338043b(element: JsonElement): InlineTransferReversalBalanceTransactionX1338043bInspection {
