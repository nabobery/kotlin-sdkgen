...
public class TreasuryTransactionsResourceBalanceImpact(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): TreasuryTransactionsResourceBalanceImpact = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<TreasuryTransactionsResourceBalanceImpact> {
    ...
    override fun deserialize(decoder: Decoder): TreasuryTransactionsResourceBalanceImpact {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("TreasuryTransactionsResourceBalanceImpact must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: TreasuryTransactionsResourceBalanceImpact) {
...
public fun treasuryTransactionsResourceBalanceImpact(block: TreasuryTransactionsResourceBalanceImpact.Builder.() -> Unit): TreasuryTransactionsResourceBalanceImpact = TreasuryTransactionsResourceBalanceImpact.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("TreasuryTransactionsResourceBalanceImpact is missing required property '" + name + "'")
