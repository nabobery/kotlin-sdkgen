...
public class InlineV1TerminalLocationsPostRequestFormX62a4b533(
   ...
   */
  public val configurationOverrides:
   ...
   */
  public val displayNameKana:
      InlineV1TerminalLocationsPostRequestFormDisplayNameKanaX9bf21f5f? = null,
  /**
   * The Kanji variation of the name for the location (Japan only).
   */
  public val displayNameKanji:
      InlineV1TerminalLocationsPostRequestFormDisplayNameKanjiX02f7819c? = null,
  ...
  public class Builder {
    ...
    public fun build(): InlineV1TerminalLocationsPostRequestFormX62a4b533 = InlineV1TerminalLocationsPostRequestFormX62a4b533(
      address = address,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1TerminalLocationsPostRequestFormX62a4b533 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1TerminalLocationsPostRequestFormX62a4b533> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1TerminalLocationsPostRequestFormX62a4b533 {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1TerminalLocationsPostRequestFormX62a4b533 must be a JSON object")
      return InlineV1TerminalLocationsPostRequestFormX62a4b533(
        address = rawObject["address"]?.let { json.decodeFromJsonElement<InlineV1TerminalLocationsPostRequestFormAddressX18dbb007>(it) },
        addressKana = rawObject["address_kana"]?.let { json.decodeFromJsonElement<InlineV1TerminalLocationsPostRequestFormAddressKanaXe49a73e8>(it) },
        addressKanji = rawObject["address_kanji"]?.let { json.decodeFromJsonElement<InlineV1TerminalLocationsPostRequestFormAddressKanjiX36415c5b>(it) },
        configurationOverrides = rawObject["configuration_overrides"]?.let { json.decodeFromJsonElement<InlineV1TerminalLocationsPostRequestFormConfigurationOverridesXa36a9d04>(it) },
        displayName = rawObject["display_name"]?.let { json.decodeFromJsonElement<InlineV1TerminalLocationsPostRequestFormDisplayNameXc804549d>(it) },
        displayNameKana = rawObject["display_name_kana"]?.let { json.decodeFromJsonElement<InlineV1TerminalLocationsPostRequestFormDisplayNameKanaX9bf21f5f>(it) },
        displayNameKanji = rawObject["display_name_kanji"]?.let { json.decodeFromJsonElement<InlineV1TerminalLocationsPostRequestFormDisplayNameKanjiX02f7819c>(it) },
        expand = rawObject["expand"]?.let { json.decodeFromJsonElement<List<String>>(it) },
        metadata = rawObject["metadata"]?.let { json.decodeFromJsonElement<InlineV1TerminalLocationsPostRequestFormMetadataXfd4c4a0a>(it) },
        phone = rawObject["phone"]?.let { json.decodeFromJsonElement<InlineV1TerminalLocationsPostRequestFormPhoneX618229f9>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineV1TerminalLocationsPostRequestFormX62a4b533) {
...
public fun inlineV1TerminalLocationsPostRequestFormX62a4b533(block: InlineV1TerminalLocationsPostRequestFormX62a4b533.Builder.() -> Unit): InlineV1TerminalLocationsPostRequestFormX62a4b533 = InlineV1TerminalLocationsPostRequestFormX62a4b533.build(block)
