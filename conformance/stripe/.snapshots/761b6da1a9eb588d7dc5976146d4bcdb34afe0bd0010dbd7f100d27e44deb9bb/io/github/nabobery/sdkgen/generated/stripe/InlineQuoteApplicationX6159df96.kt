...
public class InlineQuoteApplicationX6159df96 internal constructor(
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineQuoteApplicationX6159df96 {
      val inspection = inspectInlineQuoteApplicationX6159df96(raw)
      if (inspection.matchCount == 0) {
        throw InlineQuoteApplicationX6159df96NoMatchException("InlineQuoteApplicationX6159df96 matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineQuoteApplicationX6159df96(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineQuoteApplicationX6159df96> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineQuoteApplicationX6159df96) {
