...
public sealed class InlineV1TestHelpersTreasurd1ebPostRequestFormTrackingDetailsTypeX539facf4 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1TestHelpersTreasurd1ebPostRequestFormTrackingDetailsTypeX539facf4 = when (value) {
      Ach.value -> Ach
  ...
  internal object Serializer : KSerializer<InlineV1TestHelpersTreasurd1ebPostRequestFormTrackingDetailsTypeX539facf4> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1TestHelpersTreasurd1ebPostRequestFormTrackingDetailsTypeX539facf4", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1TestHelpersTreasurd1ebPostRequestFormTrackingDetailsTypeX539facf4 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1TestHelpersTreasurd1ebPostRequestFormTrackingDetailsTypeX539facf4) {
