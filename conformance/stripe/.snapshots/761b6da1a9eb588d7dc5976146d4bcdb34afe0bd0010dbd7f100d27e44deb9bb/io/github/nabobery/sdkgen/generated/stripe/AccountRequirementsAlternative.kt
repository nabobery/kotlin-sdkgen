...
public class AccountRequirementsAlternative(
  ...
  public class Builder {
    ...
    public var alternativeFieldsDue: List<String>
      get() = requireNotNull(alternativeFieldsDueValue) { "alternativeFieldsDue is required" }.toList()
      set(`value`) {
        alternativeFieldsDueValue = value.toList()
      }

    private var originalFieldsDueValue: List<String>? = null

    public var originalFieldsDue: List<String>
      get() = requireNotNull(originalFieldsDueValue) { "originalFieldsDue is required" }.toList()
      set(`value`) {
        originalFieldsDueValue = value.toList()
      }
  ...
  internal object Serializer : KSerializer<AccountRequirementsAlternative> {
    ...
    override fun deserialize(decoder: Decoder): AccountRequirementsAlternative {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("AccountRequirementsAlternative must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: AccountRequirementsAlternative) {
...
public fun accountRequirementsAlternative(block: AccountRequirementsAlternative.Builder.() -> Unit): AccountRequirementsAlternative = AccountRequirementsAlternative.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("AccountRequirementsAlternative is missing required property '" + name + "'")
