...
public sealed class InlineV1TestHelpersConfirmationTokensPostRequestFormSetupFutureUsageX081fa35d {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1TestHelpersConfirmationTokensPostRequestFormSetupFutureUsageX081fa35d = when (value) {
  ...
  internal object Serializer : KSerializer<InlineV1TestHelpersConfirmationTokensPostRequestFormSetupFutureUsageX081fa35d> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1TestHelpersConfirmationTokensPostRequestFormSetupFutureUsageX081fa35d", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1TestHelpersConfirmationTokensPostRequestFormSetupFutureUsageX081fa35d = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1TestHelpersConfirmationTokensPostRequestFormSetupFutureUsageX081fa35d) {
