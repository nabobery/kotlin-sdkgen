...
public sealed class InlineTreasuryTransactionEntryObjectValueX5712b74d {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineTreasuryTransactionEntryObjectValueX5712b74d = when (value) {
      TreasuryTransactionEntry.value -> TreasuryTransactionEntry
      else -> SdkUnknown(value)
    }
  }

  internal object Serializer : KSerializer<InlineTreasuryTransactionEntryObjectValueX5712b74d> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineTreasuryTransactionEntryObjectValueX5712b74d", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineTreasuryTransactionEntryObjectValueX5712b74d = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineTreasuryTransactionEntryObjectValueX5712b74d) {
