...
public class InlineFeeRefundFeeX229a86d0 internal constructor(
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineFeeRefundFeeX229a86d0 {
      val inspection = inspectInlineFeeRefundFeeX229a86d0(raw)
      if (inspection.matchCount == 0) {
        throw InlineFeeRefundFeeX229a86d0NoMatchException("InlineFeeRefundFeeX229a86d0 matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineFeeRefundFeeX229a86d0(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineFeeRefundFeeX229a86d0> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineFeeRefundFeeX229a86d0) {
