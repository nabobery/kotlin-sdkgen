...
public sealed class InlineV1CustomersSubscriptionsPostRequestFormFeedbackX1d708127 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1CustomersSubscriptionsPostRequestFormFeedbackX1d708127 = when (value) {
      Value.value -> Value
  ...
  internal object Serializer : KSerializer<InlineV1CustomersSubscriptionsPostRequestFormFeedbackX1d708127> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1CustomersSubscriptionsPostRequestFormFeedbackX1d708127", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1CustomersSubscriptionsPostRequestFormFeedbackX1d708127 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1CustomersSubscriptionsPostRequestFormFeedbackX1d708127) {
