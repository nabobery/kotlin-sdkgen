...
public class InlineV1CheckoutSessionsPostRequestFormPaymentIntentDataXcfe9f51b(
  ...
  public val setupFutureUsage:
      InlineV1CheckoutSessionsPostRequestFormSetupFutureUsageX5efc728f? = null,
  public val shipping:
      InlineV1CheckoutSessionsPostRequestFormPaymentIntentDataShippingX34bb8989? = null,
  ...
  public class Builder {
    ...
    public fun build(): InlineV1CheckoutSessionsPostRequestFormPaymentIntentDataXcfe9f51b = InlineV1CheckoutSessionsPostRequestFormPaymentIntentDataXcfe9f51b(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1CheckoutSessionsPostRequestFormPaymentIntentDataXcfe9f51b = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormPaymentIntentDataXcfe9f51b> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineV1CheckoutSessionsPostRequestFormPaymentIntentDataXcfe9f51b {
      val jsonDecoder = decoder.requireJsonDecoder("InlineV1CheckoutSessionsPostRequestFormPaymentIntentDataXcfe9f51b")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1CheckoutSessionsPostRequestFormPaymentIntentDataXcfe9f51b must be a JSON object")
      return InlineV1CheckoutSessionsPostRequestFormPaymentIntentDataXcfe9f51b(
        ...
        captureMethod = rawObject["capture_method"]?.let { json.decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormPaymentIntentDataCaptureMethodX53ead7fd>(it) },
        ...
        setupFutureUsage = rawObject["setup_future_usage"]?.let { json.decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormSetupFutureUsageX5efc728f>(it) },
        shipping = rawObject["shipping"]?.let { json.decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormPaymentIntentDataShippingX34bb8989>(it) },
        ...
        transferData = rawObject["transfer_data"]?.let { json.decodeFromJsonElement<InlineV1CheckoutSessionsPostRequestFormPaymentIntentDataTransferDataXc42f081a>(it) },
        transferGroup = rawObject["transfer_group"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineV1CheckoutSessionsPostRequestFormPaymentIntentDataXcfe9f51b) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineV1CheckoutSessionsPostRequestFormPaymentIntentDataXcfe9f51b")
