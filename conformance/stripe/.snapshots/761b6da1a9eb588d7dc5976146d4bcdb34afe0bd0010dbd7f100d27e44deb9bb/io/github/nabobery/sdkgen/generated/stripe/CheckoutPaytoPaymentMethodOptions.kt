...
public class CheckoutPaytoPaymentMethodOptions(
  ...
  public val setupFutureUsage:
      InlineCheckoutPaytoPaymentMethodOptionsSetupFutureUsageX8b08d571? = null,
) {
  public class Builder {
    ...
    public fun build(): CheckoutPaytoPaymentMethodOptions = CheckoutPaytoPaymentMethodOptions(
  ...
  internal object Serializer : KSerializer<CheckoutPaytoPaymentMethodOptions> {
    ...
    override fun deserialize(decoder: Decoder): CheckoutPaytoPaymentMethodOptions {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("CheckoutPaytoPaymentMethodOptions must be a JSON object")
      return CheckoutPaytoPaymentMethodOptions(
        mandateOptions = rawObject["mandate_options"]?.let { json.decodeFromJsonElement<MandateOptionsPayto>(it) },
        setupFutureUsage = rawObject["setup_future_usage"]?.let { json.decodeFromJsonElement<InlineCheckoutPaytoPaymentMethodOptionsSetupFutureUsageX8b08d571>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: CheckoutPaytoPaymentMethodOptions) {
...
public fun checkoutPaytoPaymentMethodOptions(block: CheckoutPaytoPaymentMethodOptions.Builder.() -> Unit): CheckoutPaytoPaymentMethodOptions = CheckoutPaytoPaymentMethodOptions.build(block)
