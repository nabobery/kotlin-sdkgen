...
public sealed class InlineV1PaymentIntentsConfirmPostRequestFormPreferredLanguageX5d4fc31a {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1PaymentIntentsConfirmPostRequestFormPreferredLanguageX5d4fc31a = when (value) {
      De.value -> De
      En.value -> En
      Fr.value -> Fr
      Nl.value -> Nl
  ...
  internal object Serializer : KSerializer<InlineV1PaymentIntentsConfirmPostRequestFormPreferredLanguageX5d4fc31a> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1PaymentIntentsConfirmPostRequestFormPreferredLanguageX5d4fc31a", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1PaymentIntentsConfirmPostRequestFormPreferredLanguageX5d4fc31a = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1PaymentIntentsConfirmPostRequestFormPreferredLanguageX5d4fc31a) {
