...
public sealed class InlinePaymentAttemptRecordCustomerPresenceX8fdd03e0 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlinePaymentAttemptRecordCustomerPresenceX8fdd03e0 = when (value) {
  ...
  internal object Serializer : KSerializer<InlinePaymentAttemptRecordCustomerPresenceX8fdd03e0> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlinePaymentAttemptRecordCustomerPresenceX8fdd03e0", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlinePaymentAttemptRecordCustomerPresenceX8fdd03e0 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlinePaymentAttemptRecordCustomerPresenceX8fdd03e0) {
