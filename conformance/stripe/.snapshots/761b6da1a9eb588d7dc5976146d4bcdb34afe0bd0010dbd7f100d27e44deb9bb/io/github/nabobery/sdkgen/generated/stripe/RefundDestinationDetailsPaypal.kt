...
public class RefundDestinationDetailsPaypal(
  ...
  public class Builder {
    ...
    public fun build(): RefundDestinationDetailsPaypal = RefundDestinationDetailsPaypal(
  ...
  internal object Serializer : KSerializer<RefundDestinationDetailsPaypal> {
    ...
    override fun deserialize(decoder: Decoder): RefundDestinationDetailsPaypal {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("RefundDestinationDetailsPaypal must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: RefundDestinationDetailsPaypal) {
...
public fun refundDestinationDetailsPaypal(block: RefundDestinationDetailsPaypal.Builder.() -> Unit): RefundDestinationDetailsPaypal = RefundDestinationDetailsPaypal.build(block)
