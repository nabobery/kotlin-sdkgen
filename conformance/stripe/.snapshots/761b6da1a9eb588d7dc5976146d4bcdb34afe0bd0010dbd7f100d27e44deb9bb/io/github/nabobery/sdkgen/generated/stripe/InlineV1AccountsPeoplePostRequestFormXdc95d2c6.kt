 ...
 * m-urlencoded/schema
 */
@Serializable(with = InlineV1AccountsPeoplePostRequestFormXdc95d2c6.Serializer::class)
public class InlineV1AccountsPeoplePostRequestFormXdc95d2c6(
  /**
   * Details on the legal guardian's or authorizer's acceptance of the required Stripe agreements.
   */
  public val additionalTosAcceptances:
      InlineV1AccountsPeoplePostRequestFormAdditionalTosAcceptancesXdcdc20f5? = null,
  /**
   * The person's address.
   */
  public val address: InlineV1AccountsPeoplePostRequestFormAddressX2f8c38cc? = null,
  /**
   * The Kana variation of the person's address (Japan only).
   */
  public val addressKana: InlineV1AccountsPeoplePostRequestFormAddressKanaX2de08290? = null,
  /**
   * The Kanji variation of the person's address (Japan only).
   */
  public val addressKanji: InlineV1AccountsPeoplePostRequestFormAddressKanjiX1c833046? = null,
  /**
   * The person's date of birth.
   */
  public val dob: InlineV1AccountsPeoplePostRequestFormDobXbd651902? = null,
  /**
   * Documents that may be submitted to satisfy various informational requests.
   */
  public val documents: InlineV1AccountsPeoplePostRequestFormDocumentsX4c87b407? = null,
  /**
   ...
   */
  public val fullNameAliases: InlineV1AccountsPeoplePostRequestFormFullNameAliasesXfbd9325e? = null,
  /**
   ...
   */
  public val metadata: InlineV1AccountsPeoplePostRequestFormMetadataXe5af6fee? = null,
  /**
  ...
  public val politicalExposure:
      InlineV1AccountsPeoplePostRequestFormPoliticalExposureXdc1040a1? = null,
  /**
   * The person's registered address.
   */
  public val registeredAddress:
      InlineV1AccountsPeoplePostRequestFormRegisteredAddressXba767cfc? = null,
  /**
   * The relationship that this person has with the account's legal entity.
   */
  public val relationship: InlineV1AccountsPeoplePostRequestFormRelationshipX494ad25f? = null,
  /**
   ...
   */
  public val usCfpbData: InlineV1AccountsPeoplePostRequestFormUsCfpbDataX1916267e? = null,
  /**
   * The person's verification status.
   */
  public val verification: InlineV1AccountsPeoplePostRequestFormVerificationXf1f3ec34? = null,
) {
  /**
  ...
  public class Builder {
     ...
     * The person's address.
     */
    public var address: InlineV1AccountsPeoplePostRequestFormAddressX2f8c38cc? = null

    /**
     * The Kana variation of the person's address (Japan only).
     */
    public var addressKana: InlineV1AccountsPeoplePostRequestFormAddressKanaX2de08290? = null

    /**
     * The Kanji variation of the person's address (Japan only).
     */
    public var addressKanji: InlineV1AccountsPeoplePostRequestFormAddressKanjiX1c833046? = null

    /**
     * The person's date of birth.
     */
    public var dob: InlineV1AccountsPeoplePostRequestFormDobXbd651902? = null

    /**
     * Documents that may be submitted to satisfy various informational requests.
     */
    public var documents: InlineV1AccountsPeoplePostRequestFormDocumentsX4c87b407? = null
     ...
     * A list of alternate names or aliases that the person is known by.
     */
    public var fullNameAliases: InlineV1AccountsPeoplePostRequestFormFullNameAliasesXfbd9325e? =
        null
     ...
     */
    public var metadata: InlineV1AccountsPeoplePostRequestFormMetadataXe5af6fee? = null
     ...
     */
    public var politicalExposure: InlineV1AccountsPeoplePostRequestFormPoliticalExposureXdc1040a1? =
        null

    /**
     * The person's registered address.
     */
    public var registeredAddress: InlineV1AccountsPeoplePostRequestFormRegisteredAddressXba767cfc? =
        null

    /**
     * The relationship that this person has with the account's legal entity.
     */
    public var relationship: InlineV1AccountsPeoplePostRequestFormRelationshipX494ad25f? = null
     ...
     * Demographic data related to the person.
     */
    public var usCfpbData: InlineV1AccountsPeoplePostRequestFormUsCfpbDataX1916267e? = null

    /**
     * The person's verification status.
     */
    public var verification: InlineV1AccountsPeoplePostRequestFormVerificationXf1f3ec34? = null

    public fun build(): InlineV1AccountsPeoplePostRequestFormXdc95d2c6 = InlineV1AccountsPeoplePostRequestFormXdc95d2c6(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1AccountsPeoplePostRequestFormXdc95d2c6 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1AccountsPeoplePostRequestFormXdc95d2c6> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineV1AccountsPeoplePostRequestFormXdc95d2c6 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineV1AccountsPeoplePostRequestFormXdc95d2c6")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1AccountsPeoplePostRequestFormXdc95d2c6 must be a JSON object")
      return InlineV1AccountsPeoplePostRequestFormXdc95d2c6(
        additionalTosAcceptances = rawObject["additional_tos_acceptances"]?.let { json.decodeFromJsonElement<InlineV1AccountsPeoplePostRequestFormAdditionalTosAcceptancesXdcdc20f5>(it) },
        address = rawObject["address"]?.let { json.decodeFromJsonElement<InlineV1AccountsPeoplePostRequestFormAddressX2f8c38cc>(it) },
        addressKana = rawObject["address_kana"]?.let { json.decodeFromJsonElement<InlineV1AccountsPeoplePostRequestFormAddressKanaX2de08290>(it) },
        addressKanji = rawObject["address_kanji"]?.let { json.decodeFromJsonElement<InlineV1AccountsPeoplePostRequestFormAddressKanjiX1c833046>(it) },
        dob = rawObject["dob"]?.let { json.decodeFromJsonElement<InlineV1AccountsPeoplePostRequestFormDobXbd651902>(it) },
        documents = rawObject["documents"]?.let { json.decodeFromJsonElement<InlineV1AccountsPeoplePostRequestFormDocumentsX4c87b407>(it) },
        ...
        fullNameAliases = rawObject["full_name_aliases"]?.let { json.decodeFromJsonElement<InlineV1AccountsPeoplePostRequestFormFullNameAliasesXfbd9325e>(it) },
        ...
        metadata = rawObject["metadata"]?.let { json.decodeFromJsonElement<InlineV1AccountsPeoplePostRequestFormMetadataXe5af6fee>(it) },
        ...
        politicalExposure = rawObject["political_exposure"]?.let { json.decodeFromJsonElement<InlineV1AccountsPeoplePostRequestFormPoliticalExposureXdc1040a1>(it) },
        registeredAddress = rawObject["registered_address"]?.let { json.decodeFromJsonElement<InlineV1AccountsPeoplePostRequestFormRegisteredAddressXba767cfc>(it) },
        relationship = rawObject["relationship"]?.let { json.decodeFromJsonElement<InlineV1AccountsPeoplePostRequestFormRelationshipX494ad25f>(it) },
        ssnLast4 = rawObject["ssn_last_4"]?.let { json.decodeFromJsonElement<String>(it) },
        usCfpbData = rawObject["us_cfpb_data"]?.let { json.decodeFromJsonElement<InlineV1AccountsPeoplePostRequestFormUsCfpbDataX1916267e>(it) },
        verification = rawObject["verification"]?.let { json.decodeFromJsonElement<InlineV1AccountsPeoplePostRequestFormVerificationXf1f3ec34>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineV1AccountsPeoplePostRequestFormXdc95d2c6) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineV1AccountsPeoplePostRequestFormXdc95d2c6")
...
public fun inlineV1AccountsPeoplePostRequestFormXdc95d2c6(block: InlineV1AccountsPeoplePostRequestFormXdc95d2c6.Builder.() -> Unit): InlineV1AccountsPeoplePostRequestFormXdc95d2c6 = InlineV1AccountsPeoplePostRequestFormXdc95d2c6.build(block)
