...
public class InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsX6c469682(
  ...
  public val alma:
      InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAlmaX97e2e3b4? = null,
  ...
  public val blik:
      InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsBlikX45497dc9? = null,
  public val boleto:
      InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsBoletoX20ada7d8? = null,
  public val card:
      InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsCardX9c017d40? = null,
  ...
  public val eps:
      InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsEpsX98ca2c09? = null,
  public val fpx:
      InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsFpxX6b77e675? = null,
  public val giropay:
  ...
  public val interacPresent:
      InlineV1PaymentIntentsConfirmPostRequestFormInteracPresentXb4bf95ff? = null,
  ...
  public val link:
      InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsLinkX1a2873a6? = null,
  public val mbWay:
  ...
  public val nzBankAccount:
      InlineV1PaymentIntentsConfirmPostRequestFormNzBankAccountX57d5409b? = null,
  public val oxxo:
      InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsOxxoX72a98763? = null,
  public val p24:
      InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsP24Xd83dbf27? = null,
  ...
  public val pix:
      InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsPixX7d1df79c? = null,
  ...
  public val upi:
      InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsUpiX4a0aa888? = null,
  public val usBankAccount:
      InlineV1PaymentIntentsConfirmPostRequestFormUsBankAccountX8ef36ba1? = null,
  public val wechatPay: InlineV1PaymentIntentsConfirmPostRequestFormWechatPayX7f95f49e? = null,
  public val zip:
      InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsZipX095eb06f? = null,
) {
  public class Builder {
    ...
    public fun build(): InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsX6c469682 = InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsX6c469682(
      acssDebit = acssDebit,
      affirm = affirm,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsX6c469682 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsX6c469682> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsX6c469682 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsX6c469682")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsX6c469682 must be a JSON object")
      return InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsX6c469682(
        acssDebit = rawObject["acss_debit"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormAcssDebitX9823bf9e>(it) },
        affirm = rawObject["affirm"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAffirmX1777df44>(it) },
        afterpayClearpay = rawObject["afterpay_clearpay"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormAfterpayClearpayX9e51f724>(it) },
        alipay = rawObject["alipay"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAlipayXea79c781>(it) },
        alma = rawObject["alma"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsAlmaX97e2e3b4>(it) },
        amazonPay = rawObject["amazon_pay"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormAmazonPayXa11d3712>(it) },
        auBecsDebit = rawObject["au_becs_debit"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormAuBecsDebitX76406295>(it) },
        bacsDebit = rawObject["bacs_debit"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormBacsDebitX7b59b051>(it) },
        bancontact = rawObject["bancontact"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormBancontactXa66ea5f6>(it) },
        billie = rawObject["billie"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsBillieX32e88b67>(it) },
        bizum = rawObject["bizum"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsBizumX7ef6ee7a>(it) },
        blik = rawObject["blik"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsBlikX45497dc9>(it) },
        boleto = rawObject["boleto"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsBoletoX20ada7d8>(it) },
        card = rawObject["card"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsCardX9c017d40>(it) },
        cardPresent = rawObject["card_present"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormCardPresentX4f5ce63c>(it) },
        cashapp = rawObject["cashapp"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsCashappXc4cc1479>(it) },
        crypto = rawObject["crypto"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsCryptoX053de1bb>(it) },
        customerBalance = rawObject["customer_balance"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormCustomerBalanceXf3fe3e41>(it) },
        eps = rawObject["eps"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsEpsX98ca2c09>(it) },
        fpx = rawObject["fpx"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsFpxX6b77e675>(it) },
        giropay = rawObject["giropay"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsGiropayX8644b0b1>(it) },
        grabpay = rawObject["grabpay"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsGrabpayXbf263228>(it) },
        ideal = rawObject["ideal"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsIdealX4d7a17b4>(it) },
        interacPresent = rawObject["interac_present"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormInteracPresentXb4bf95ff>(it) },
        kakaoPay = rawObject["kakao_pay"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormKakaoPayX5ea857cd>(it) },
        klarna = rawObject["klarna"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsKlarnaXf39fea3f>(it) },
        konbini = rawObject["konbini"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsKonbiniX23baf1c9>(it) },
        krCard = rawObject["kr_card"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsKrCardXaab95c40>(it) },
        link = rawObject["link"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsLinkX1a2873a6>(it) },
        mbWay = rawObject["mb_way"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsMbWayX2a552c6d>(it) },
        mobilepay = rawObject["mobilepay"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormMobilepayXe07a92f6>(it) },
        multibanco = rawObject["multibanco"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormMultibancoXc08241b1>(it) },
        naverPay = rawObject["naver_pay"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormNaverPayX354d8db3>(it) },
        nzBankAccount = rawObject["nz_bank_account"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormNzBankAccountX57d5409b>(it) },
        oxxo = rawObject["oxxo"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsOxxoX72a98763>(it) },
        p24 = rawObject["p24"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsP24Xd83dbf27>(it) },
        payByBank = rawObject["pay_by_bank"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormPayByBankXb4013665>(it) },
        payco = rawObject["payco"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsPaycoX82a90d05>(it) },
        paynow = rawObject["paynow"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsPaynowXfb8ab0c7>(it) },
        paypal = rawObject["paypal"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsPaypalXbfc81675>(it) },
        payto = rawObject["payto"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsPaytoXc78619dc>(it) },
        pix = rawObject["pix"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsPixX7d1df79c>(it) },
        promptpay = rawObject["promptpay"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormPromptpayX99093fac>(it) },
        revolutPay = rawObject["revolut_pay"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormRevolutPayXb8176f68>(it) },
        samsungPay = rawObject["samsung_pay"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormSamsungPayX17eff9a5>(it) },
        satispay = rawObject["satispay"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormSatispayX67af2a9c>(it) },
        scalapay = rawObject["scalapay"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormScalapayX84751e69>(it) },
        sepaDebit = rawObject["sepa_debit"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormSepaDebitX5a25910d>(it) },
        sofort = rawObject["sofort"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsSofortXfe3a4bdc>(it) },
        sunbit = rawObject["sunbit"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsSunbitX24d0999b>(it) },
        swish = rawObject["swish"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsSwishX5be3b295>(it) },
        twint = rawObject["twint"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsTwintXf98db25b>(it) },
        upi = rawObject["upi"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsUpiX4a0aa888>(it) },
        usBankAccount = rawObject["us_bank_account"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormUsBankAccountX8ef36ba1>(it) },
        wechatPay = rawObject["wechat_pay"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormWechatPayX7f95f49e>(it) },
        zip = rawObject["zip"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsZipX095eb06f>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsX6c469682) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsX6c469682")
...
public fun inlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsX6c469682(block: InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsX6c469682.Builder.() -> Unit): InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsX6c469682 = InlineV1PaymentIntentsConfirmPostRequestFormPaymentMethodOptionsX6c469682.build(block)
