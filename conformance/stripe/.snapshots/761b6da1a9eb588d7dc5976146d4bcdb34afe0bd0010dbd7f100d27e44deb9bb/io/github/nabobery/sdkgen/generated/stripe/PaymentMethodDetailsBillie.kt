...
public class PaymentMethodDetailsBillie(
  ...
  public class Builder {
    ...
    public fun build(): PaymentMethodDetailsBillie = PaymentMethodDetailsBillie(
  ...
  internal object Serializer : KSerializer<PaymentMethodDetailsBillie> {
    ...
    override fun deserialize(decoder: Decoder): PaymentMethodDetailsBillie {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("PaymentMethodDetailsBillie must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: PaymentMethodDetailsBillie) {
...
public fun paymentMethodDetailsBillie(block: PaymentMethodDetailsBillie.Builder.() -> Unit): PaymentMethodDetailsBillie = PaymentMethodDetailsBillie.build(block)
