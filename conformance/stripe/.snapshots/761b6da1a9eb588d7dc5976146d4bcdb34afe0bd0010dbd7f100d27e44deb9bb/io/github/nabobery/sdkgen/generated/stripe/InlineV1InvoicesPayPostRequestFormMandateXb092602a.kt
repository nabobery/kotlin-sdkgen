...
public class InlineV1InvoicesPayPostRequestFormMandateXb092602a internal constructor(
  ...
  public val inlineV1InvoicesPayPostRequestFormMandateAnyOf2Xb1439620:
      ...
      lazy(LazyThreadSafetyMode.NONE) { if (inspection.matchesInlineV1InvoicesPayPostRequestFormMandateAnyOf2Xb1439620) json.decodeFromJsonElement<InlineV1InvoicesPayPostRequestFormMandateAnyOf2Xb1439620>(raw) else null }
  ...
  public val matchedBranches: Set<InlineV1InvoicesPayPostRequestFormMandateXb092602aBranch>
    get() = buildSet {
      ...
      if (inspection.matchesInlineV1InvoicesPayPostRequestFormMandateAnyOf2Xb1439620) add(InlineV1InvoicesPayPostRequestFormMandateXb092602aBranch.InlineV1InvoicesPayPostRequestFormMandateAnyOf2Xb1439620)
    }
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineV1InvoicesPayPostRequestFormMandateXb092602a {
      val inspection = inspectInlineV1InvoicesPayPostRequestFormMandateXb092602a(raw)
      if (inspection.matchCount == 0) {
        throw InlineV1InvoicesPayPostRequestFormMandateXb092602aNoMatchException("InlineV1InvoicesPayPostRequestFormMandateXb092602a matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineV1InvoicesPayPostRequestFormMandateXb092602a(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineV1InvoicesPayPostRequestFormMandateXb092602a> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1InvoicesPayPostRequestFormMandateXb092602a) {
      encoder.requireJsonEncoder("InlineV1InvoicesPayPostRequestFormMandateXb092602a").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineV1InvoicesPayPostRequestFormMandateXb092602a(element: JsonElement): InlineV1InvoicesPayPostRequestFormMandateXb092602aInspection {
  val matchesBranch1 = element.isJsonDecodable<String>()
  val matchesInlineV1InvoicesPayPostRequestFormMandateAnyOf2Xb1439620 = element.isJsonDecodable<InlineV1InvoicesPayPostRequestFormMandateAnyOf2Xb1439620>()
  return InlineV1InvoicesPayPostRequestFormMandateXb092602aInspection(
    ...
    failures = buildList {
      ...
      if (!matchesInlineV1InvoicesPayPostRequestFormMandateAnyOf2Xb1439620) add("InlineV1InvoicesPayPostRequestFormMandateAnyOf2Xb1439620: value does not match InlineV1InvoicesPayPostRequestFormMandateAnyOf2Xb1439620")
    },
  )
}
