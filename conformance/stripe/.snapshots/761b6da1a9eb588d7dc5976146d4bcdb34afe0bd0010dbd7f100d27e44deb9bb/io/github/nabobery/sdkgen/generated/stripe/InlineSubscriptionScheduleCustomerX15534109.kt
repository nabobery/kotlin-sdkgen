...
public class InlineSubscriptionScheduleCustomerX15534109 internal constructor(
  ...
  public val matchedBranches: Set<InlineSubscriptionScheduleCustomerX15534109Branch>
    get() = buildSet {
      ...
      if (inspection.matchesDeletedCustomer) add(InlineSubscriptionScheduleCustomerX15534109Branch.DeletedCustomer)
    }
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineSubscriptionScheduleCustomerX15534109 {
      val inspection = inspectInlineSubscriptionScheduleCustomerX15534109(raw)
      if (inspection.matchCount == 0) {
        throw InlineSubscriptionScheduleCustomerX15534109NoMatchException("InlineSubscriptionScheduleCustomerX15534109 matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineSubscriptionScheduleCustomerX15534109(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineSubscriptionScheduleCustomerX15534109> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineSubscriptionScheduleCustomerX15534109) {
      encoder.requireJsonEncoder("InlineSubscriptionScheduleCustomerX15534109").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineSubscriptionScheduleCustomerX15534109(element: JsonElement): InlineSubscriptionScheduleCustomerX15534109Inspection {
