...
public sealed class InlineTreasuryFinancialAccountActiveFeaturesItemXace1f2bf {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineTreasuryFinancialAccountActiveFeaturesItemXace1f2bf = when (value) {
  ...
  internal object Serializer : KSerializer<InlineTreasuryFinancialAccountActiveFeaturesItemXace1f2bf> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineTreasuryFinancialAccountActiveFeaturesItemXace1f2bf", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineTreasuryFinancialAccountActiveFeaturesItemXace1f2bf = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineTreasuryFinancialAccountActiveFeaturesItemXace1f2bf) {
