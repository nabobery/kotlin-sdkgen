...
public sealed class InlineCheckoutPaypalPaymentMethodOptionsSetupFutureUsageXac29268b {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineCheckoutPaypalPaymentMethodOptionsSetupFutureUsageXac29268b = when (value) {
      None.value -> None
  ...
  internal object Serializer : KSerializer<InlineCheckoutPaypalPaymentMethodOptionsSetupFutureUsageXac29268b> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineCheckoutPaypalPaymentMethodOptionsSetupFutureUsageXac29268b", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineCheckoutPaypalPaymentMethodOptionsSetupFutureUsageXac29268b = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineCheckoutPaypalPaymentMethodOptionsSetupFutureUsageXac29268b) {
