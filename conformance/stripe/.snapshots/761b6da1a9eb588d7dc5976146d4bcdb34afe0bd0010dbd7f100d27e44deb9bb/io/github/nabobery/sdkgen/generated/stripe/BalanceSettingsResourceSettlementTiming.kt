...
public class BalanceSettingsResourceSettlementTiming(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): BalanceSettingsResourceSettlementTiming = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<BalanceSettingsResourceSettlementTiming> {
    ...
    override fun deserialize(decoder: Decoder): BalanceSettingsResourceSettlementTiming {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("BalanceSettingsResourceSettlementTiming must be a JSON object")
      ...
      return BalanceSettingsResourceSettlementTiming(
        ...
        startOfDay = rawObject["start_of_day"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineBalanceSettingsResourceSettlementTimingStartOfDayXc16f705b?>(element) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: BalanceSettingsResourceSettlementTiming) {
...
public fun balanceSettingsResourceSettlementTiming(block: BalanceSettingsResourceSettlementTiming.Builder.() -> Unit): BalanceSettingsResourceSettlementTiming = BalanceSettingsResourceSettlementTiming.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("BalanceSettingsResourceSettlementTiming is missing required property '" + name + "'")
