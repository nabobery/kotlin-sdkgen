...
public sealed class InlineV1PaymentMethodConfidc49PostRequestFormCryptoPreferenceXa38e923d {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1PaymentMethodConfidc49PostRequestFormCryptoPreferenceXa38e923d = when (value) {
      None.value -> None
      Off.value -> Off
      On.value -> On
  ...
  internal object Serializer : KSerializer<InlineV1PaymentMethodConfidc49PostRequestFormCryptoPreferenceXa38e923d> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1PaymentMethodConfidc49PostRequestFormCryptoPreferenceXa38e923d", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1PaymentMethodConfidc49PostRequestFormCryptoPreferenceXa38e923d = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1PaymentMethodConfidc49PostRequestFormCryptoPreferenceXa38e923d) {
