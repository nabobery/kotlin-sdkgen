...
public sealed class InlineV1SetupIntentsPostRequestFormRequestThreeDSecureX7aa799fd {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1SetupIntentsPostRequestFormRequestThreeDSecureX7aa799fd = when (value) {
      Any.value -> Any
  ...
  internal object Serializer : KSerializer<InlineV1SetupIntentsPostRequestFormRequestThreeDSecureX7aa799fd> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1SetupIntentsPostRequestFormRequestThreeDSecureX7aa799fd", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1SetupIntentsPostRequestFormRequestThreeDSecureX7aa799fd = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1SetupIntentsPostRequestFormRequestThreeDSecureX7aa799fd) {
