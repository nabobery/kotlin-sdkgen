...
public sealed class InlineIssuingAuthorizationVerificationDataCvcCheckX82d5aa7d {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineIssuingAuthorizationVerificationDataCvcCheckX82d5aa7d = when (value) {
      Match.value -> Match
  ...
  internal object Serializer : KSerializer<InlineIssuingAuthorizationVerificationDataCvcCheckX82d5aa7d> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineIssuingAuthorizationVerificationDataCvcCheckX82d5aa7d", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineIssuingAuthorizationVerificationDataCvcCheckX82d5aa7d = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineIssuingAuthorizationVerificationDataCvcCheckX82d5aa7d) {
