...
public class InlineV1AccountsPeoplePostRequestFormAddressKanjiXff7cca37(
  ...
  public class Builder {
    ...
    public fun build(): InlineV1AccountsPeoplePostRequestFormAddressKanjiXff7cca37 = InlineV1AccountsPeoplePostRequestFormAddressKanjiXff7cca37(
      city = city,
      country = country,
      line1 = line1,
      line2 = line2,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1AccountsPeoplePostRequestFormAddressKanjiXff7cca37 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1AccountsPeoplePostRequestFormAddressKanjiXff7cca37> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1AccountsPeoplePostRequestFormAddressKanjiXff7cca37 {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1AccountsPeoplePostRequestFormAddressKanjiXff7cca37 must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1AccountsPeoplePostRequestFormAddressKanjiXff7cca37) {
...
public fun inlineV1AccountsPeoplePostRequestFormAddressKanjiXff7cca37(block: InlineV1AccountsPeoplePostRequestFormAddressKanjiXff7cca37.Builder.() -> Unit): InlineV1AccountsPeoplePostRequestFormAddressKanjiXff7cca37 = InlineV1AccountsPeoplePostRequestFormAddressKanjiXff7cca37.build(block)
