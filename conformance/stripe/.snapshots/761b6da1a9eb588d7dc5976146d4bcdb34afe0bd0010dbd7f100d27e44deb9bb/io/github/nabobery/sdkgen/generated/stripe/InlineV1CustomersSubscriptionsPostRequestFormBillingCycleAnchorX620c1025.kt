...
public sealed class InlineV1CustomersSubscriptionsPostRequestFormBillingCycleAnchorX620c1025 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1CustomersSubscriptionsPostRequestFormBillingCycleAnchorX620c1025 = when (value) {
      Now.value -> Now
  ...
  internal object Serializer : KSerializer<InlineV1CustomersSubscriptionsPostRequestFormBillingCycleAnchorX620c1025> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1CustomersSubscriptionsPostRequestFormBillingCycleAnchorX620c1025", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1CustomersSubscriptionsPostRequestFormBillingCycleAnchorX620c1025 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1CustomersSubscriptionsPostRequestFormBillingCycleAnchorX620c1025) {
