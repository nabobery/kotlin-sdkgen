...
public class DeletedCustomer(
  ...
  internal object Serializer : KSerializer<DeletedCustomer> {
    ...
    override fun deserialize(decoder: Decoder): DeletedCustomer {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("DeletedCustomer must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: DeletedCustomer) {
...
private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("DeletedCustomer is missing required property '" + name + "'")
