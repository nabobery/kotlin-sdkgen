...
public sealed class InlineCustomerTaxProviderX12c86023 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineCustomerTaxProviderX12c86023 = when (value) {
      Anrok.value -> Anrok
  ...
  internal object Serializer : KSerializer<InlineCustomerTaxProviderX12c86023> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineCustomerTaxProviderX12c86023", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineCustomerTaxProviderX12c86023 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineCustomerTaxProviderX12c86023) {
