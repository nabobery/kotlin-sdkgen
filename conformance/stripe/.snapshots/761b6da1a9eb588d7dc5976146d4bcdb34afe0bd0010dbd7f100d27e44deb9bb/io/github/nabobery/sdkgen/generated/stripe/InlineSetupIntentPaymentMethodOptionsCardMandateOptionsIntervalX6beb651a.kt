...
public sealed class InlineSetupIntentPaymentMethodOptionsCardMandateOptionsIntervalX6beb651a {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineSetupIntentPaymentMethodOptionsCardMandateOptionsIntervalX6beb651a = when (value) {
      Day.value -> Day
      Month.value -> Month
  ...
  internal object Serializer : KSerializer<InlineSetupIntentPaymentMethodOptionsCardMandateOptionsIntervalX6beb651a> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineSetupIntentPaymentMethodOptionsCardMandateOptionsIntervalX6beb651a", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineSetupIntentPaymentMethodOptionsCardMandateOptionsIntervalX6beb651a = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineSetupIntentPaymentMethodOptionsCardMandateOptionsIntervalX6beb651a) {
