...
public sealed class InlineV1PaymentLinksPostRequestFormCustomerCreationX9b9731af {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1PaymentLinksPostRequestFormCustomerCreationX9b9731af = when (value) {
      Always.value -> Always
  ...
  internal object Serializer : KSerializer<InlineV1PaymentLinksPostRequestFormCustomerCreationX9b9731af> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1PaymentLinksPostRequestFormCustomerCreationX9b9731af", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1PaymentLinksPostRequestFormCustomerCreationX9b9731af = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1PaymentLinksPostRequestFormCustomerCreationX9b9731af) {
