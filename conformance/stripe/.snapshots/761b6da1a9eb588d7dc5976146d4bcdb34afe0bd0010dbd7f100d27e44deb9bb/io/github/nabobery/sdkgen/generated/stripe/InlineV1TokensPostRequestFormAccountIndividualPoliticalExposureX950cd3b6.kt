...
public sealed class InlineV1TokensPostRequestFormAccountIndividualPoliticalExposureX950cd3b6 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1TokensPostRequestFormAccountIndividualPoliticalExposureX950cd3b6 = when (value) {
  ...
  internal object Serializer : KSerializer<InlineV1TokensPostRequestFormAccountIndividualPoliticalExposureX950cd3b6> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1TokensPostRequestFormAccountIndividualPoliticalExposureX950cd3b6", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1TokensPostRequestFormAccountIndividualPoliticalExposureX950cd3b6 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1TokensPostRequestFormAccountIndividualPoliticalExposureX950cd3b6) {
