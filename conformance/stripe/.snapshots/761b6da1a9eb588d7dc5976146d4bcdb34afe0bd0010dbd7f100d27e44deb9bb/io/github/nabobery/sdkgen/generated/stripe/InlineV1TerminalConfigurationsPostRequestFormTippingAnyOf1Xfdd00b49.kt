...
public class InlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1Xfdd00b49(
  ...
  public class Builder {
    ...
    public fun build(): InlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1Xfdd00b49 = InlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1Xfdd00b49(
      aed = aed,
      aud = aud,
      cad = cad,
      chf = chf,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1Xfdd00b49 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1Xfdd00b49> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1Xfdd00b49 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1Xfdd00b49")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1Xfdd00b49 must be a JSON object")
      return InlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1Xfdd00b49(
        aed = rawObject["aed"]?.let { json.decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1AedX2aa35b44>(it) },
        aud = rawObject["aud"]?.let { json.decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1AudX2d5797e1>(it) },
        cad = rawObject["cad"]?.let { json.decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1CadX2de79cdb>(it) },
        chf = rawObject["chf"]?.let { json.decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1ChfX1112c37c>(it) },
        czk = rawObject["czk"]?.let { json.decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1CzkXdb0dd172>(it) },
        dkk = rawObject["dkk"]?.let { json.decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1DkkX8bcba30e>(it) },
        eur = rawObject["eur"]?.let { json.decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1EurX2029fbcb>(it) },
        gbp = rawObject["gbp"]?.let { json.decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1GbpXe322ca5c>(it) },
        gip = rawObject["gip"]?.let { json.decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1GipX7e87eaae>(it) },
        hkd = rawObject["hkd"]?.let { json.decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1HkdX6e34f8de>(it) },
        huf = rawObject["huf"]?.let { json.decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1HufX75d02f67>(it) },
        jpy = rawObject["jpy"]?.let { json.decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1JpyXe6c944e5>(it) },
        mxn = rawObject["mxn"]?.let { json.decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1MxnXfdaf74e7>(it) },
        myr = rawObject["myr"]?.let { json.decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1MyrXefe8232b>(it) },
        nok = rawObject["nok"]?.let { json.decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1NokXaa375330>(it) },
        nzd = rawObject["nzd"]?.let { json.decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1NzdXa8efc9a3>(it) },
        pln = rawObject["pln"]?.let { json.decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1PlnX2b0d4268>(it) },
        ron = rawObject["ron"]?.let { json.decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1RonXce3f377a>(it) },
        sek = rawObject["sek"]?.let { json.decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1SekX0476b03a>(it) },
        sgd = rawObject["sgd"]?.let { json.decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1SgdXb95aa5d6>(it) },
        usd = rawObject["usd"]?.let { json.decodeFromJsonElement<InlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1UsdX27df6f17>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1Xfdd00b49) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1Xfdd00b49")
...
public fun inlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1Xfdd00b49(block: InlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1Xfdd00b49.Builder.() -> Unit): InlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1Xfdd00b49 = InlineV1TerminalConfigurationsPostRequestFormTippingAnyOf1Xfdd00b49.build(block)
