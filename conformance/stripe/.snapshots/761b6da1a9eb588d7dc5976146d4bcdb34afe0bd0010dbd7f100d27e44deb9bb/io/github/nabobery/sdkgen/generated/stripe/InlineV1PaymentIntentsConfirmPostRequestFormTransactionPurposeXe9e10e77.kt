...
public sealed class InlineV1PaymentIntentsConfirmPostRequestFormTransactionPurposeXe9e10e77 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1PaymentIntentsConfirmPostRequestFormTransactionPurposeXe9e10e77 = when (value) {
      Value.value -> Value
      Goods.value -> Goods
      Other.value -> Other
  ...
  internal object Serializer : KSerializer<InlineV1PaymentIntentsConfirmPostRequestFormTransactionPurposeXe9e10e77> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1PaymentIntentsConfirmPostRequestFormTransactionPurposeXe9e10e77", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1PaymentIntentsConfirmPostRequestFormTransactionPurposeXe9e10e77 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1PaymentIntentsConfirmPostRequestFormTransactionPurposeXe9e10e77) {
