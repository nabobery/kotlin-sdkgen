...
public class PaymentIntentCardProcessing(
  ...
  public class Builder {
    ...
    public fun build(): PaymentIntentCardProcessing = PaymentIntentCardProcessing(
  ...
  internal object Serializer : KSerializer<PaymentIntentCardProcessing> {
    ...
    override fun deserialize(decoder: Decoder): PaymentIntentCardProcessing {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("PaymentIntentCardProcessing must be a JSON object")
      return PaymentIntentCardProcessing(
        customerNotification = rawObject["customer_notification"]?.let { json.decodeFromJsonElement<PaymentIntentProcessingCustomerNotification>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: PaymentIntentCardProcessing) {
...
public fun paymentIntentCardProcessing(block: PaymentIntentCardProcessing.Builder.() -> Unit): PaymentIntentCardProcessing = PaymentIntentCardProcessing.build(block)
