...
public class PaymentMethodDetailsPaymentRecordKlarna(
   ...
   */
  public val payerDetails:
      InlinePaymentMethodDetailsPaymentRecordKlarnaPayerDetailsXfb9186aa? = null,
  /**
  ...
  public class Builder {
    ...
    public fun build(): PaymentMethodDetailsPaymentRecordKlarna = PaymentMethodDetailsPaymentRecordKlarna(
      location = location,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): PaymentMethodDetailsPaymentRecordKlarna = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<PaymentMethodDetailsPaymentRecordKlarna> {
    ...
    override fun deserialize(decoder: Decoder): PaymentMethodDetailsPaymentRecordKlarna {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("PaymentMethodDetailsPaymentRecordKlarna must be a JSON object")
      return PaymentMethodDetailsPaymentRecordKlarna(
        location = rawObject["location"]?.let { json.decodeFromJsonElement<String>(it) },
        payerDetails = rawObject["payer_details"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlinePaymentMethodDetailsPaymentRecordKlarnaPayerDetailsXfb9186aa?>(element) },
    ...
    override fun serialize(encoder: Encoder, `value`: PaymentMethodDetailsPaymentRecordKlarna) {
...
public fun paymentMethodDetailsPaymentRecordKlarna(block: PaymentMethodDetailsPaymentRecordKlarna.Builder.() -> Unit): PaymentMethodDetailsPaymentRecordKlarna = PaymentMethodDetailsPaymentRecordKlarna.build(block)
