...
public class BillingMeterResourceBillingMeterValue(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): BillingMeterResourceBillingMeterValue = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<BillingMeterResourceBillingMeterValue> {
    ...
    override fun deserialize(decoder: Decoder): BillingMeterResourceBillingMeterValue {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("BillingMeterResourceBillingMeterValue must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: BillingMeterResourceBillingMeterValue) {
...
public fun billingMeterResourceBillingMeterValue(block: BillingMeterResourceBillingMeterValue.Builder.() -> Unit): BillingMeterResourceBillingMeterValue = BillingMeterResourceBillingMeterValue.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("BillingMeterResourceBillingMeterValue is missing required property '" + name + "'")
