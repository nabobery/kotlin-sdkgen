...
public sealed class InlinePaymentIntentPaymentMethodOptionsUsBankAccountTransactionPurposeX0ccb14eb {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlinePaymentIntentPaymentMethodOptionsUsBankAccountTransactionPurposeX0ccb14eb = when (value) {
      Goods.value -> Goods
      Other.value -> Other
  ...
  internal object Serializer : KSerializer<InlinePaymentIntentPaymentMethodOptionsUsBankAccountTransactionPurposeX0ccb14eb> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlinePaymentIntentPaymentMethodOptionsUsBankAccountTransactionPurposeX0ccb14eb", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlinePaymentIntentPaymentMethodOptionsUsBankAccountTransactionPurposeX0ccb14eb = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlinePaymentIntentPaymentMethodOptionsUsBankAccountTransactionPurposeX0ccb14eb) {
