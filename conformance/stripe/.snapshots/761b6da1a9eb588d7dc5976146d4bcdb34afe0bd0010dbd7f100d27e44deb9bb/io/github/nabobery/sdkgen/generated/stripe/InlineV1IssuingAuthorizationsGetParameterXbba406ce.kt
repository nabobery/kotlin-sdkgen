...
public class InlineV1IssuingAuthorizationsGetParameterXbba406ce internal constructor(
  ...
  public val inlineV1IssuingAuthorizationsGetParameterAnyOf1X40b6f7f8:
      ...
      lazy(LazyThreadSafetyMode.NONE) { if (inspection.matchesInlineV1IssuingAuthorizationsGetParameterAnyOf1X40b6f7f8) json.decodeFromJsonElement<InlineV1IssuingAuthorizationsGetParameterAnyOf1X40b6f7f8>(raw) else null }
  ...
  public val matchedBranches: Set<InlineV1IssuingAuthorizationsGetParameterXbba406ceBranch>
    get() = buildSet {
      if (inspection.matchesInlineV1IssuingAuthorizationsGetParameterAnyOf1X40b6f7f8) add(InlineV1IssuingAuthorizationsGetParameterXbba406ceBranch.InlineV1IssuingAuthorizationsGetParameterAnyOf1X40b6f7f8)
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineV1IssuingAuthorizationsGetParameterXbba406ce {
      val inspection = inspectInlineV1IssuingAuthorizationsGetParameterXbba406ce(raw)
      if (inspection.matchCount == 0) {
        throw InlineV1IssuingAuthorizationsGetParameterXbba406ceNoMatchException("InlineV1IssuingAuthorizationsGetParameterXbba406ce matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineV1IssuingAuthorizationsGetParameterXbba406ce(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineV1IssuingAuthorizationsGetParameterXbba406ce> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1IssuingAuthorizationsGetParameterXbba406ce) {
      encoder.requireJsonEncoder("InlineV1IssuingAuthorizationsGetParameterXbba406ce").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineV1IssuingAuthorizationsGetParameterXbba406ce(element: JsonElement): InlineV1IssuingAuthorizationsGetParameterXbba406ceInspection {
  val matchesInlineV1IssuingAuthorizationsGetParameterAnyOf1X40b6f7f8 = element.isJsonDecodable<InlineV1IssuingAuthorizationsGetParameterAnyOf1X40b6f7f8>()
  ...
  return InlineV1IssuingAuthorizationsGetParameterXbba406ceInspection(
    ...
    failures = buildList {
      if (!matchesInlineV1IssuingAuthorizationsGetParameterAnyOf1X40b6f7f8) add("InlineV1IssuingAuthorizationsGetParameterAnyOf1X40b6f7f8: value does not match InlineV1IssuingAuthorizationsGetParameterAnyOf1X40b6f7f8")
