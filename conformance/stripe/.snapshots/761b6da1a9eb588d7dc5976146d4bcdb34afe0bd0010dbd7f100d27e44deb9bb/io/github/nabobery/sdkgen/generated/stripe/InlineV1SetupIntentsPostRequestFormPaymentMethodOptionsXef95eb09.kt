...
public class InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsXef95eb09(
  public val acssDebit:
      InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsAcssDebitX2e5c5e86? = null,
  public val amazonPay: JsonObject? = null,
  public val bacsDebit:
      InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsBacsDebitX2c91225c? = null,
  ...
  public val sepaDebit:
      InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsSepaDebitX1c7e1adf? = null,
  ...
  public class Builder {
    ...
    public fun build(): InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsXef95eb09 = InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsXef95eb09(
      acssDebit = acssDebit,
      amazonPay = amazonPay,
      bacsDebit = bacsDebit,
      bizum = bizum,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsXef95eb09 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsXef95eb09> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsXef95eb09 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsXef95eb09")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsXef95eb09 must be a JSON object")
      return InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsXef95eb09(
        acssDebit = rawObject["acss_debit"]?.let { json.decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsAcssDebitX2e5c5e86>(it) },
        amazonPay = rawObject["amazon_pay"]?.let { json.decodeFromJsonElement<JsonObject>(it) },
        bacsDebit = rawObject["bacs_debit"]?.let { json.decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsBacsDebitX2c91225c>(it) },
        bizum = rawObject["bizum"]?.let { json.decodeFromJsonElement<JsonObject>(it) },
        card = rawObject["card"]?.let { json.decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsCardXafff7c6d>(it) },
        cardPresent = rawObject["card_present"]?.let { json.decodeFromJsonElement<JsonObject>(it) },
        klarna = rawObject["klarna"]?.let { json.decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsKlarnaX5d448afe>(it) },
        link = rawObject["link"]?.let { json.decodeFromJsonElement<JsonObject>(it) },
        paypal = rawObject["paypal"]?.let { json.decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsPaypalXb8119ff4>(it) },
        payto = rawObject["payto"]?.let { json.decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsPaytoXd18fa833>(it) },
        pix = rawObject["pix"]?.let { json.decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsPixXfb86f062>(it) },
        sepaDebit = rawObject["sepa_debit"]?.let { json.decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsSepaDebitX1c7e1adf>(it) },
        upi = rawObject["upi"]?.let { json.decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsUpiX037186b8>(it) },
        usBankAccount = rawObject["us_bank_account"]?.let { json.decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsUsBankAccountX8e1d683a>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsXef95eb09) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsXef95eb09")
...
public fun inlineV1SetupIntentsPostRequestFormPaymentMethodOptionsXef95eb09(block: InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsXef95eb09.Builder.() -> Unit): InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsXef95eb09 = InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsXef95eb09.build(block)
