...
public sealed class InlinePaymentFlowsPrivatePaymentMethodsCardPresentCommonWalletTypeX67e044aa {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlinePaymentFlowsPrivatePaymentMethodsCardPresentCommonWalletTypeX67e044aa = when (value) {
  ...
  internal object Serializer : KSerializer<InlinePaymentFlowsPrivatePaymentMethodsCardPresentCommonWalletTypeX67e044aa> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlinePaymentFlowsPrivatePaymentMethodsCardPresentCommonWalletTypeX67e044aa", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlinePaymentFlowsPrivatePaymentMethodsCardPresentCommonWalletTypeX67e044aa = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlinePaymentFlowsPrivatePaymentMethodsCardPresentCommonWalletTypeX67e044aa) {
