...
public class InlineV1SubscriptionItemsPostRequestFormX6e71422d(
  ...
  public val paymentBehavior:
      InlineV1SubscriptionItemsPostRequestFormPaymentBehaviorX611e4ba8? = null,
  /**
  ...
  public class Builder {
    ...
    public fun build(): InlineV1SubscriptionItemsPostRequestFormX6e71422d = InlineV1SubscriptionItemsPostRequestFormX6e71422d(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1SubscriptionItemsPostRequestFormX6e71422d = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1SubscriptionItemsPostRequestFormX6e71422d> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1SubscriptionItemsPostRequestFormX6e71422d {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1SubscriptionItemsPostRequestFormX6e71422d must be a JSON object")
      return InlineV1SubscriptionItemsPostRequestFormX6e71422d(
        billingThresholds = rawObject["billing_thresholds"]?.let { json.decodeFromJsonElement<InlineV1SubscriptionItemsPostRequestFormBillingThresholdsX4c87d8a0>(it) },
        discounts = rawObject["discounts"]?.let { json.decodeFromJsonElement<InlineV1SubscriptionItemsPostRequestFormDiscountsX16c6ebe1>(it) },
        expand = rawObject["expand"]?.let { json.decodeFromJsonElement<List<String>>(it) },
        metadata = rawObject["metadata"]?.let { json.decodeFromJsonElement<InlineV1SubscriptionItemsPostRequestFormMetadataXd0db8ca2>(it) },
        offSession = rawObject["off_session"]?.let { json.decodeFromJsonElement<Boolean>(it) },
        paymentBehavior = rawObject["payment_behavior"]?.let { json.decodeFromJsonElement<InlineV1SubscriptionItemsPostRequestFormPaymentBehaviorX611e4ba8>(it) },
        price = rawObject["price"]?.let { json.decodeFromJsonElement<String>(it) },
        priceData = rawObject["price_data"]?.let { json.decodeFromJsonElement<InlineV1SubscriptionItemsPostRequestFormPriceDataX31e93d4c>(it) },
        prorationBehavior = rawObject["proration_behavior"]?.let { json.decodeFromJsonElement<InlineV1SubscriptionItemsPostRequestFormProrationBehaviorX91f5fe9a>(it) },
        ...
        taxRates = rawObject["tax_rates"]?.let { json.decodeFromJsonElement<InlineV1SubscriptionItemsPostRequestFormTaxRatesX59bfd0ef>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineV1SubscriptionItemsPostRequestFormX6e71422d) {
...
public fun inlineV1SubscriptionItemsPostRequestFormX6e71422d(block: InlineV1SubscriptionItemsPostRequestFormX6e71422d.Builder.() -> Unit): InlineV1SubscriptionItemsPostRequestFormX6e71422d = InlineV1SubscriptionItemsPostRequestFormX6e71422d.build(block)
