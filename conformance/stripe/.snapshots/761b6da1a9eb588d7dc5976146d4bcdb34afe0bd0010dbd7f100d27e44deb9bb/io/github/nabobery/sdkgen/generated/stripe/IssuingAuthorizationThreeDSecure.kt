...
public class IssuingAuthorizationThreeDSecure(
  ...
  internal object Serializer : KSerializer<IssuingAuthorizationThreeDSecure> {
    ...
    override fun deserialize(decoder: Decoder): IssuingAuthorizationThreeDSecure {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("IssuingAuthorizationThreeDSecure must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: IssuingAuthorizationThreeDSecure) {
...
public fun issuingAuthorizationThreeDSecure(block: IssuingAuthorizationThreeDSecure.Builder.() -> Unit): IssuingAuthorizationThreeDSecure = IssuingAuthorizationThreeDSecure.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("IssuingAuthorizationThreeDSecure is missing required property '" + name + "'")
