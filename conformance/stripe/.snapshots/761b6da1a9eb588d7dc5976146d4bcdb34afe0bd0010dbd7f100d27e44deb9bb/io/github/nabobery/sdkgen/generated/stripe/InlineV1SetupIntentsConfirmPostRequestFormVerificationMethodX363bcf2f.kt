...
public sealed class InlineV1SetupIntentsConfirmPostRequestFormVerificationMethodX363bcf2f {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1SetupIntentsConfirmPostRequestFormVerificationMethodX363bcf2f = when (value) {
  ...
  internal object Serializer : KSerializer<InlineV1SetupIntentsConfirmPostRequestFormVerificationMethodX363bcf2f> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1SetupIntentsConfirmPostRequestFormVerificationMethodX363bcf2f", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1SetupIntentsConfirmPostRequestFormVerificationMethodX363bcf2f = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1SetupIntentsConfirmPostRequestFormVerificationMethodX363bcf2f) {
