...
public class InlineV1PaymentIntentsPostRequestFormMandateDataCustomerAcceptanceXab5ae0e4(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1PaymentIntentsPostRequestFormMandateDataCustomerAcceptanceXab5ae0e4 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormMandateDataCustomerAcceptanceXab5ae0e4> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineV1PaymentIntentsPostRequestFormMandateDataCustomerAcceptanceXab5ae0e4 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineV1PaymentIntentsPostRequestFormMandateDataCustomerAcceptanceXab5ae0e4")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1PaymentIntentsPostRequestFormMandateDataCustomerAcceptanceXab5ae0e4 must be a JSON object")
      val type = json.decodeRequired<InlineV1PaymentIntentsPostRequestFormMandateDataAnyOf1TypeX463bae54>(rawObject, "type")
      return InlineV1PaymentIntentsPostRequestFormMandateDataCustomerAcceptanceXab5ae0e4(
        type = type,
        ...
        online = rawObject["online"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormMandateDataAnyOf1OnlineXdd0ef976>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineV1PaymentIntentsPostRequestFormMandateDataCustomerAcceptanceXab5ae0e4) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineV1PaymentIntentsPostRequestFormMandateDataCustomerAcceptanceXab5ae0e4")
...
public fun inlineV1PaymentIntentsPostRequestFormMandateDataCustomerAcceptanceXab5ae0e4(block: InlineV1PaymentIntentsPostRequestFormMandateDataCustomerAcceptanceXab5ae0e4.Builder.() -> Unit): InlineV1PaymentIntentsPostRequestFormMandateDataCustomerAcceptanceXab5ae0e4 = InlineV1PaymentIntentsPostRequestFormMandateDataCustomerAcceptanceXab5ae0e4.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineV1PaymentIntentsPostRequestFormMandateDataCustomerAcceptanceXab5ae0e4 is missing required property '" + name + "'")
