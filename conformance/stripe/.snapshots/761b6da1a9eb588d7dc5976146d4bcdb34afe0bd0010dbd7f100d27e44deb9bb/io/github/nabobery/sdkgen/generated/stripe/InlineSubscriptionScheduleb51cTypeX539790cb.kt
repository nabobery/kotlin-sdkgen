...
public sealed class InlineSubscriptionScheduleb51cTypeX539790cb {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineSubscriptionScheduleb51cTypeX539790cb = when (value) {
  ...
  internal object Serializer : KSerializer<InlineSubscriptionScheduleb51cTypeX539790cb> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineSubscriptionScheduleb51cTypeX539790cb", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineSubscriptionScheduleb51cTypeX539790cb = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineSubscriptionScheduleb51cTypeX539790cb) {
