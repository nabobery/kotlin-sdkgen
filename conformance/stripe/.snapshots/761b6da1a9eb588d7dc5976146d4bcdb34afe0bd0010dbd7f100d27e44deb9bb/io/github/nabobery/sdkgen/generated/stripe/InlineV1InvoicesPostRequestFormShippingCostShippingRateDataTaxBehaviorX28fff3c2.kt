...
public sealed class InlineV1InvoicesPostRequestFormShippingCostShippingRateDataTaxBehaviorX28fff3c2 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1InvoicesPostRequestFormShippingCostShippingRateDataTaxBehaviorX28fff3c2 = when (value) {
  ...
  internal object Serializer : KSerializer<InlineV1InvoicesPostRequestFormShippingCostShippingRateDataTaxBehaviorX28fff3c2> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1InvoicesPostRequestFormShippingCostShippingRateDataTaxBehaviorX28fff3c2", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1InvoicesPostRequestFormShippingCostShippingRateDataTaxBehaviorX28fff3c2 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1InvoicesPostRequestFormShippingCostShippingRateDataTaxBehaviorX28fff3c2) {
