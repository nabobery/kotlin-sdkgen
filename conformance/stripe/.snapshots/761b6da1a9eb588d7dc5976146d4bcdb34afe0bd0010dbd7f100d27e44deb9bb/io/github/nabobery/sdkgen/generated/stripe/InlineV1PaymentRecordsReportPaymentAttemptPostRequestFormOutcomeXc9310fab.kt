...
public sealed class InlineV1PaymentRecordsReportPaymentAttemptPostRequestFormOutcomeXc9310fab {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1PaymentRecordsReportPaymentAttemptPostRequestFormOutcomeXc9310fab = when (value) {
      Failed.value -> Failed
  ...
  internal object Serializer : KSerializer<InlineV1PaymentRecordsReportPaymentAttemptPostRequestFormOutcomeXc9310fab> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1PaymentRecordsReportPaymentAttemptPostRequestFormOutcomeXc9310fab", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1PaymentRecordsReportPaymentAttemptPostRequestFormOutcomeXc9310fab = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1PaymentRecordsReportPaymentAttemptPostRequestFormOutcomeXc9310fab) {
