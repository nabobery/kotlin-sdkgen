...
public sealed class InlineV1PlansPostRequestFormBillingSchemeX33887b9a {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1PlansPostRequestFormBillingSchemeX33887b9a = when (value) {
  ...
  internal object Serializer : KSerializer<InlineV1PlansPostRequestFormBillingSchemeX33887b9a> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1PlansPostRequestFormBillingSchemeX33887b9a", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1PlansPostRequestFormBillingSchemeX33887b9a = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1PlansPostRequestFormBillingSchemeX33887b9a) {
