...
public class PaymentMethodDetailsPaymentRecordPaynow(
  ...
  public class Builder {
    ...
    public fun build(): PaymentMethodDetailsPaymentRecordPaynow = PaymentMethodDetailsPaymentRecordPaynow(
      location = location,
      reader = reader,
      reference = reference,
    )
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): PaymentMethodDetailsPaymentRecordPaynow = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<PaymentMethodDetailsPaymentRecordPaynow> {
    ...
    override fun deserialize(decoder: Decoder): PaymentMethodDetailsPaymentRecordPaynow {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("PaymentMethodDetailsPaymentRecordPaynow must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: PaymentMethodDetailsPaymentRecordPaynow) {
...
public fun paymentMethodDetailsPaymentRecordPaynow(block: PaymentMethodDetailsPaymentRecordPaynow.Builder.() -> Unit): PaymentMethodDetailsPaymentRecordPaynow = PaymentMethodDetailsPaymentRecordPaynow.build(block)
