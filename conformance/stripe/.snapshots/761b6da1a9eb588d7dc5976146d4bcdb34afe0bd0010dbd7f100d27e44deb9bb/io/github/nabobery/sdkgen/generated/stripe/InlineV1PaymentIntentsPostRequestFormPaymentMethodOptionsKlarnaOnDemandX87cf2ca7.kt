...
public class InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKlarnaOnDemandX87cf2ca7(
  ...
  public val purchaseInterval:
      InlineV1PaymentIntentsPostRequestFormPurchaseIntervalXd1c3e8fd? = null,
  ...
  public class Builder {
    ...
    public fun build(): InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKlarnaOnDemandX87cf2ca7 = InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKlarnaOnDemandX87cf2ca7(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKlarnaOnDemandX87cf2ca7 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKlarnaOnDemandX87cf2ca7> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKlarnaOnDemandX87cf2ca7 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKlarnaOnDemandX87cf2ca7")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKlarnaOnDemandX87cf2ca7 must be a JSON object")
      return InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKlarnaOnDemandX87cf2ca7(
        ...
        purchaseInterval = rawObject["purchase_interval"]?.let { json.decodeFromJsonElement<InlineV1PaymentIntentsPostRequestFormPurchaseIntervalXd1c3e8fd>(it) },
        purchaseIntervalCount = rawObject["purchase_interval_count"]?.let { json.decodeFromJsonElement<Int>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKlarnaOnDemandX87cf2ca7) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineV1PaymentIntentsPostRequestFormPaymentMethodOptionsKlarnaOnDemandX87cf2ca7")
