...
public sealed class InlineCapabilityStatusX7c7eeca5 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineCapabilityStatusX7c7eeca5 = when (value) {
      Active.value -> Active
  ...
  internal object Serializer : KSerializer<InlineCapabilityStatusX7c7eeca5> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineCapabilityStatusX7c7eeca5", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineCapabilityStatusX7c7eeca5 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineCapabilityStatusX7c7eeca5) {
