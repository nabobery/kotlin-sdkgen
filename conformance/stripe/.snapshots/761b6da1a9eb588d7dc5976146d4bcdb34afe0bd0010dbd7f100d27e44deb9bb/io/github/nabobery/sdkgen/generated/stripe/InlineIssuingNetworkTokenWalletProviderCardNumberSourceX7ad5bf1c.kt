...
public sealed class InlineIssuingNetworkTokenWalletProviderCardNumberSourceX7ad5bf1c {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineIssuingNetworkTokenWalletProviderCardNumberSourceX7ad5bf1c = when (value) {
      App.value -> App
      Manual.value -> Manual
      OnFile.value -> OnFile
      Other.value -> Other
  ...
  internal object Serializer : KSerializer<InlineIssuingNetworkTokenWalletProviderCardNumberSourceX7ad5bf1c> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineIssuingNetworkTokenWalletProviderCardNumberSourceX7ad5bf1c", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineIssuingNetworkTokenWalletProviderCardNumberSourceX7ad5bf1c = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineIssuingNetworkTokenWalletProviderCardNumberSourceX7ad5bf1c) {
