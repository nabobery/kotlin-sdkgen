...
public sealed class InlineV1PaymentIntentsPostRequestFormPreferredLocaleX2f991843 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1PaymentIntentsPostRequestFormPreferredLocaleX2f991843 = when (value) {
      CsCz.value -> CsCz
      DaDk.value -> DaDk
      DeAt.value -> DeAt
      DeCh.value -> DeCh
  ...
  internal object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormPreferredLocaleX2f991843> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1PaymentIntentsPostRequestFormPreferredLocaleX2f991843", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1PaymentIntentsPostRequestFormPreferredLocaleX2f991843 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1PaymentIntentsPostRequestFormPreferredLocaleX2f991843) {
