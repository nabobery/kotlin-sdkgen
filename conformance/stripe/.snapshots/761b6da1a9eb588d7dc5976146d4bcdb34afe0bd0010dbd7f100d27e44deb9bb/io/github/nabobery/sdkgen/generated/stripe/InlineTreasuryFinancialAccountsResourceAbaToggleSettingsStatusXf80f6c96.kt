...
public sealed class InlineTreasuryFinancialAccountsResourceAbaToggleSettingsStatusXf80f6c96 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineTreasuryFinancialAccountsResourceAbaToggleSettingsStatusXf80f6c96 = when (value) {
      Active.value -> Active
  ...
  internal object Serializer : KSerializer<InlineTreasuryFinancialAccountsResourceAbaToggleSettingsStatusXf80f6c96> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineTreasuryFinancialAccountsResourceAbaToggleSettingsStatusXf80f6c96", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineTreasuryFinancialAccountsResourceAbaToggleSettingsStatusXf80f6c96 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineTreasuryFinancialAccountsResourceAbaToggleSettingsStatusXf80f6c96) {
