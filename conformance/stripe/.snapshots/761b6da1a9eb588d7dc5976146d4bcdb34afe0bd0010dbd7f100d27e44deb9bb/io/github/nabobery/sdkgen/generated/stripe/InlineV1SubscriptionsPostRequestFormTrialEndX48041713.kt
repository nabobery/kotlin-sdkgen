...
public class InlineV1SubscriptionsPostRequestFormTrialEndX48041713 internal constructor(
  ...
  public val inlineV1SubscriptionsPostRequestFormTrialEndAnyOf1X16dd672d:
      ...
      lazy(LazyThreadSafetyMode.NONE) { if (inspection.matchesInlineV1SubscriptionsPostRequestFormTrialEndAnyOf1X16dd672d) json.decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormTrialEndAnyOf1X16dd672d>(raw) else null }
  ...
  public val matchedBranches: Set<InlineV1SubscriptionsPostRequestFormTrialEndX48041713Branch>
    get() = buildSet {
      if (inspection.matchesInlineV1SubscriptionsPostRequestFormTrialEndAnyOf1X16dd672d) add(InlineV1SubscriptionsPostRequestFormTrialEndX48041713Branch.InlineV1SubscriptionsPostRequestFormTrialEndAnyOf1X16dd672d)
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineV1SubscriptionsPostRequestFormTrialEndX48041713 {
      val inspection = inspectInlineV1SubscriptionsPostRequestFormTrialEndX48041713(raw)
      if (inspection.matchCount == 0) {
        throw InlineV1SubscriptionsPostRequestFormTrialEndX48041713NoMatchException("InlineV1SubscriptionsPostRequestFormTrialEndX48041713 matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineV1SubscriptionsPostRequestFormTrialEndX48041713(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineV1SubscriptionsPostRequestFormTrialEndX48041713> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1SubscriptionsPostRequestFormTrialEndX48041713) {
      encoder.requireJsonEncoder("InlineV1SubscriptionsPostRequestFormTrialEndX48041713").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineV1SubscriptionsPostRequestFormTrialEndX48041713(element: JsonElement): InlineV1SubscriptionsPostRequestFormTrialEndX48041713Inspection {
  val matchesInlineV1SubscriptionsPostRequestFormTrialEndAnyOf1X16dd672d = element.isJsonDecodable<InlineV1SubscriptionsPostRequestFormTrialEndAnyOf1X16dd672d>()
  ...
  return InlineV1SubscriptionsPostRequestFormTrialEndX48041713Inspection(
    ...
    failures = buildList {
      if (!matchesInlineV1SubscriptionsPostRequestFormTrialEndAnyOf1X16dd672d) add("InlineV1SubscriptionsPostRequestFormTrialEndAnyOf1X16dd672d: value does not match InlineV1SubscriptionsPostRequestFormTrialEndAnyOf1X16dd672d")
