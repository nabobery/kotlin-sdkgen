...
public class OnlineAcceptance(
  ...
  public class Builder {
    ...
    public fun build(): OnlineAcceptance = OnlineAcceptance(
      ipAddress = ipAddress,
      userAgent = userAgent,
    )
  }
  ...
  internal object Serializer : KSerializer<OnlineAcceptance> {
    ...
    override fun deserialize(decoder: Decoder): OnlineAcceptance {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("OnlineAcceptance must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: OnlineAcceptance) {
...
public fun onlineAcceptance(block: OnlineAcceptance.Builder.() -> Unit): OnlineAcceptance = OnlineAcceptance.build(block)
