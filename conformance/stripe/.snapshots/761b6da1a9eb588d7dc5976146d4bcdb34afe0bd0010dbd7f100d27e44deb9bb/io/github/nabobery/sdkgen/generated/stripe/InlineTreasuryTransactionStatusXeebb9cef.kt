...
public sealed class InlineTreasuryTransactionStatusXeebb9cef {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineTreasuryTransactionStatusXeebb9cef = when (value) {
      Open.value -> Open
      Posted.value -> Posted
      Void.value -> Void
  ...
  internal object Serializer : KSerializer<InlineTreasuryTransactionStatusXeebb9cef> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineTreasuryTransactionStatusXeebb9cef", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineTreasuryTransactionStatusXeebb9cef = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineTreasuryTransactionStatusXeebb9cef) {
