...
public sealed class InlineV1InvoicesPostRequestFormPendingInvoiceItemsBehaviorX0af94a86 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1InvoicesPostRequestFormPendingInvoiceItemsBehaviorX0af94a86 = when (value) {
  ...
  internal object Serializer : KSerializer<InlineV1InvoicesPostRequestFormPendingInvoiceItemsBehaviorX0af94a86> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1InvoicesPostRequestFormPendingInvoiceItemsBehaviorX0af94a86", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1InvoicesPostRequestFormPendingInvoiceItemsBehaviorX0af94a86 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1InvoicesPostRequestFormPendingInvoiceItemsBehaviorX0af94a86) {
