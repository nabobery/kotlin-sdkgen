...
public class PortalFeatures(
  ...
  internal object Serializer : KSerializer<PortalFeatures> {
    ...
    override fun deserialize(decoder: Decoder): PortalFeatures {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("PortalFeatures must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: PortalFeatures) {
...
private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("PortalFeatures is missing required property '" + name + "'")
