...
public class IssuingPhysicalBundle(
  ...
  internal object Serializer : KSerializer<IssuingPhysicalBundle> {
    ...
    override fun deserialize(decoder: Decoder): IssuingPhysicalBundle {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("IssuingPhysicalBundle must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: IssuingPhysicalBundle) {
...
public fun issuingPhysicalBundle(block: IssuingPhysicalBundle.Builder.() -> Unit): IssuingPhysicalBundle = IssuingPhysicalBundle.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("IssuingPhysicalBundle is missing required property '" + name + "'")
