...
public sealed class InlineInvoiceStatusXe812c730 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineInvoiceStatusXe812c730 = when (value) {
      Draft.value -> Draft
      Open.value -> Open
      Paid.value -> Paid
  ...
  internal object Serializer : KSerializer<InlineInvoiceStatusXe812c730> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineInvoiceStatusXe812c730", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineInvoiceStatusXe812c730 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineInvoiceStatusXe812c730) {
