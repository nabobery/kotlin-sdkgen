...
public sealed class InlineV1SubscriptionsPostRequestFormPaymentSettingsVerificationMethodX8fd91a6d {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1SubscriptionsPostRequestFormPaymentSettingsVerificationMethodX8fd91a6d = when (value) {
  ...
  internal object Serializer : KSerializer<InlineV1SubscriptionsPostRequestFormPaymentSettingsVerificationMethodX8fd91a6d> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1SubscriptionsPostRequestFormPaymentSettingsVerificationMethodX8fd91a6d", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1SubscriptionsPostRequestFormPaymentSettingsVerificationMethodX8fd91a6d = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1SubscriptionsPostRequestFormPaymentSettingsVerificationMethodX8fd91a6d) {
