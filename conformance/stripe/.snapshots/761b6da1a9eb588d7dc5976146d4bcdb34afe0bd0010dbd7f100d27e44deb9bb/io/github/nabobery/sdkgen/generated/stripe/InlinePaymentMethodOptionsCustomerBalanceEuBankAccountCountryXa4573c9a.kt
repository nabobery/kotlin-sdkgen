...
public sealed class InlinePaymentMethodOptionsCustomerBalanceEuBankAccountCountryXa4573c9a {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlinePaymentMethodOptionsCustomerBalanceEuBankAccountCountryXa4573c9a = when (value) {
      Be.value -> Be
      De.value -> De
      Es.value -> Es
      Fr.value -> Fr
  ...
  internal object Serializer : KSerializer<InlinePaymentMethodOptionsCustomerBalanceEuBankAccountCountryXa4573c9a> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlinePaymentMethodOptionsCustomerBalanceEuBankAccountCountryXa4573c9a", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlinePaymentMethodOptionsCustomerBalanceEuBankAccountCountryXa4573c9a = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlinePaymentMethodOptionsCustomerBalanceEuBankAccountCountryXa4573c9a) {
