...
public class TaxProductResourceTaxTransactionLineItemResourceReversal(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): TaxProductResourceTaxTransactionLineItemResourceReversal = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<TaxProductResourceTaxTransactionLineItemResourceReversal> {
    ...
    override fun deserialize(decoder: Decoder): TaxProductResourceTaxTransactionLineItemResourceReversal {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("TaxProductResourceTaxTransactionLineItemResourceReversal must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: TaxProductResourceTaxTransactionLineItemResourceReversal) {
...
public fun taxProductResourceTaxTransactionLineItemResourceReversal(block: TaxProductResourceTaxTransactionLineItemResourceReversal.Builder.() -> Unit): TaxProductResourceTaxTransactionLineItemResourceReversal = TaxProductResourceTaxTransactionLineItemResourceReversal.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("TaxProductResourceTaxTransactionLineItemResourceReversal is missing required property '" + name + "'")
