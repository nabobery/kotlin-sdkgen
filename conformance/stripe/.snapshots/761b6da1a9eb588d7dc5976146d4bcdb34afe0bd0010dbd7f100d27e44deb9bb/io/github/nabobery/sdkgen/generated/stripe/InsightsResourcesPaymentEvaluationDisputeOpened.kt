...
public class InsightsResourcesPaymentEvaluationDisputeOpened(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InsightsResourcesPaymentEvaluationDisputeOpened = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InsightsResourcesPaymentEvaluationDisputeOpened> {
    ...
    override fun deserialize(decoder: Decoder): InsightsResourcesPaymentEvaluationDisputeOpened {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InsightsResourcesPaymentEvaluationDisputeOpened must be a JSON object")
      val amount = json.decodeRequired<Int>(rawObject, "amount")
      val currency = json.decodeRequired<String>(rawObject, "currency")
      val reason = json.decodeRequired<InlineInsightsResourcesPaymentEvaluationDisputeOpenedReasonX5af9f06c>(rawObject, "reason")
      return InsightsResourcesPaymentEvaluationDisputeOpened(
        amount = amount,
        currency = currency,
        reason = reason,
    ...
    override fun serialize(encoder: Encoder, `value`: InsightsResourcesPaymentEvaluationDisputeOpened) {
...
public fun insightsResourcesPaymentEvaluationDisputeOpened(block: InsightsResourcesPaymentEvaluationDisputeOpened.Builder.() -> Unit): InsightsResourcesPaymentEvaluationDisputeOpened = InsightsResourcesPaymentEvaluationDisputeOpened.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InsightsResourcesPaymentEvaluationDisputeOpened is missing required property '" + name + "'")
