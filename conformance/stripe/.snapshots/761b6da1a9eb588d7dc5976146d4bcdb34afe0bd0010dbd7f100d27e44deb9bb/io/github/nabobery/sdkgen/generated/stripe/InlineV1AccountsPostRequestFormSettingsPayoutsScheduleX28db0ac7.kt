...
public class InlineV1AccountsPostRequestFormSettingsPayoutsScheduleX28db0ac7(
  public val delayDays:
      InlineV1AccountsPostRequestFormSettingsPayoutsScheduleDelayDaysX5e3d3674? = null,
  public val interval:
      InlineV1AccountsPostRequestFormSettingsPayoutsScheduleIntervalX777e235e? = null,
  ...
  weeklyPayoutDays: List<InlineV1AccountsPostRequestFormSettingsPayoutsScheduleItemXa29e32f2>? = null,
) {
  public val monthlyPayoutDays: List<Int>? =
      monthlyPayoutDays?.let { collection0 -> collection0.toList() }

  public val weeklyPayoutDays:
      List<InlineV1AccountsPostRequestFormSettingsPayoutsScheduleItemXa29e32f2>? =
  ...
  public class Builder {
    ...
    public fun build(): InlineV1AccountsPostRequestFormSettingsPayoutsScheduleX28db0ac7 = InlineV1AccountsPostRequestFormSettingsPayoutsScheduleX28db0ac7(
      delayDays = delayDays,
      interval = interval,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1AccountsPostRequestFormSettingsPayoutsScheduleX28db0ac7 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1AccountsPostRequestFormSettingsPayoutsScheduleX28db0ac7> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineV1AccountsPostRequestFormSettingsPayoutsScheduleX28db0ac7 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineV1AccountsPostRequestFormSettingsPayoutsScheduleX28db0ac7")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1AccountsPostRequestFormSettingsPayoutsScheduleX28db0ac7 must be a JSON object")
      return InlineV1AccountsPostRequestFormSettingsPayoutsScheduleX28db0ac7(
        delayDays = rawObject["delay_days"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormSettingsPayoutsScheduleDelayDaysX5e3d3674>(it) },
        interval = rawObject["interval"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormSettingsPayoutsScheduleIntervalX777e235e>(it) },
        ...
        weeklyAnchor = rawObject["weekly_anchor"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormSettingsPayoutsScheduleWeeklyAnchorX09082814>(it) },
        weeklyPayoutDays = rawObject["weekly_payout_days"]?.let { json.decodeFromJsonElement<List<InlineV1AccountsPostRequestFormSettingsPayoutsScheduleItemXa29e32f2>>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineV1AccountsPostRequestFormSettingsPayoutsScheduleX28db0ac7) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineV1AccountsPostRequestFormSettingsPayoutsScheduleX28db0ac7")
...
public fun inlineV1AccountsPostRequestFormSettingsPayoutsScheduleX28db0ac7(block: InlineV1AccountsPostRequestFormSettingsPayoutsScheduleX28db0ac7.Builder.() -> Unit): InlineV1AccountsPostRequestFormSettingsPayoutsScheduleX28db0ac7 = InlineV1AccountsPostRequestFormSettingsPayoutsScheduleX28db0ac7.build(block)
