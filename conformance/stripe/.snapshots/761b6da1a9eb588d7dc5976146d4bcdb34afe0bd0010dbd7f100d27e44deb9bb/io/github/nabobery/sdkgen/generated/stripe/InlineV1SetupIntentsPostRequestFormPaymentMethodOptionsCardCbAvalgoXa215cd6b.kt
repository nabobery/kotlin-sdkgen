...
public sealed class InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsCardCbAvalgoXa215cd6b {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsCardCbAvalgoXa215cd6b = when (value) {
      _0.value -> _0
      _1.value -> _1
      _2.value -> _2
      _3.value -> _3
  ...
  internal object Serializer : KSerializer<InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsCardCbAvalgoXa215cd6b> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsCardCbAvalgoXa215cd6b", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsCardCbAvalgoXa215cd6b = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsCardCbAvalgoXa215cd6b) {
