...
public class InsightsResourcesPaymentEvaluationRefunded(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InsightsResourcesPaymentEvaluationRefunded = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InsightsResourcesPaymentEvaluationRefunded> {
    ...
    override fun deserialize(decoder: Decoder): InsightsResourcesPaymentEvaluationRefunded {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InsightsResourcesPaymentEvaluationRefunded must be a JSON object")
      val amount = json.decodeRequired<Int>(rawObject, "amount")
      val currency = json.decodeRequired<String>(rawObject, "currency")
      val reason = json.decodeRequired<InlineInsightsResourcesPaymentEvaluationRefundedReasonX8b59c797>(rawObject, "reason")
      return InsightsResourcesPaymentEvaluationRefunded(
        amount = amount,
        currency = currency,
        reason = reason,
    ...
    override fun serialize(encoder: Encoder, `value`: InsightsResourcesPaymentEvaluationRefunded) {
...
public fun insightsResourcesPaymentEvaluationRefunded(block: InsightsResourcesPaymentEvaluationRefunded.Builder.() -> Unit): InsightsResourcesPaymentEvaluationRefunded = InsightsResourcesPaymentEvaluationRefunded.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InsightsResourcesPaymentEvaluationRefunded is missing required property '" + name + "'")
