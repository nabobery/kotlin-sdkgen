...
public class RefundDestinationDetailsP24(
  ...
  public class Builder {
    ...
    public fun build(): RefundDestinationDetailsP24 = RefundDestinationDetailsP24(
      reference = reference,
  ...
  internal object Serializer : KSerializer<RefundDestinationDetailsP24> {
    ...
    override fun deserialize(decoder: Decoder): RefundDestinationDetailsP24 {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("RefundDestinationDetailsP24 must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: RefundDestinationDetailsP24) {
...
public fun refundDestinationDetailsP24(block: RefundDestinationDetailsP24.Builder.() -> Unit): RefundDestinationDetailsP24 = RefundDestinationDetailsP24.build(block)
