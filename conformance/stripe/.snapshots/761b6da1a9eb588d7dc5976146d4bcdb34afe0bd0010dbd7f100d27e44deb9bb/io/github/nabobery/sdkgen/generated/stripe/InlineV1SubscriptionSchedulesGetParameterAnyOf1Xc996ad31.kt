...
public class InlineV1SubscriptionSchedulesGetParameterAnyOf1Xc996ad31(
  ...
  public class Builder {
    ...
    public fun build(): InlineV1SubscriptionSchedulesGetParameterAnyOf1Xc996ad31 = InlineV1SubscriptionSchedulesGetParameterAnyOf1Xc996ad31(
      gt = gt,
      gte = gte,
      lt = lt,
      lte = lte,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1SubscriptionSchedulesGetParameterAnyOf1Xc996ad31 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1SubscriptionSchedulesGetParameterAnyOf1Xc996ad31> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1SubscriptionSchedulesGetParameterAnyOf1Xc996ad31 {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1SubscriptionSchedulesGetParameterAnyOf1Xc996ad31 must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1SubscriptionSchedulesGetParameterAnyOf1Xc996ad31) {
...
public fun inlineV1SubscriptionSchedulesGetParameterAnyOf1Xc996ad31(block: InlineV1SubscriptionSchedulesGetParameterAnyOf1Xc996ad31.Builder.() -> Unit): InlineV1SubscriptionSchedulesGetParameterAnyOf1Xc996ad31 = InlineV1SubscriptionSchedulesGetParameterAnyOf1Xc996ad31.build(block)
