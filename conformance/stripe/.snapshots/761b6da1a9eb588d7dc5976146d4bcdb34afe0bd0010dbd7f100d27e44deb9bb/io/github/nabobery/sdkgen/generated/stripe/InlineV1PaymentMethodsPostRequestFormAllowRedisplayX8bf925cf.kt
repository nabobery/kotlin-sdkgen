...
public sealed class InlineV1PaymentMethodsPostRequestFormAllowRedisplayX8bf925cf {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1PaymentMethodsPostRequestFormAllowRedisplayX8bf925cf = when (value) {
      Always.value -> Always
  ...
  internal object Serializer : KSerializer<InlineV1PaymentMethodsPostRequestFormAllowRedisplayX8bf925cf> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1PaymentMethodsPostRequestFormAllowRedisplayX8bf925cf", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1PaymentMethodsPostRequestFormAllowRedisplayX8bf925cf = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1PaymentMethodsPostRequestFormAllowRedisplayX8bf925cf) {
