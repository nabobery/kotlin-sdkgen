...
public sealed class InlineV1SetupIntentsPostRequestFormElectronicCommerceIn67d5X916161ca {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1SetupIntentsPostRequestFormElectronicCommerceIn67d5X916161ca = when (value) {
      _01.value -> _01
      _02.value -> _02
      _05.value -> _05
      _06.value -> _06
  ...
  internal object Serializer : KSerializer<InlineV1SetupIntentsPostRequestFormElectronicCommerceIn67d5X916161ca> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1SetupIntentsPostRequestFormElectronicCommerceIn67d5X916161ca", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1SetupIntentsPostRequestFormElectronicCommerceIn67d5X916161ca = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1SetupIntentsPostRequestFormElectronicCommerceIn67d5X916161ca) {
