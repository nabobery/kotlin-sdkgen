...
public sealed class InlineV1PaymentLinksPostRequestFormCustomerCreationX4cdc4cda {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1PaymentLinksPostRequestFormCustomerCreationX4cdc4cda = when (value) {
      Always.value -> Always
  ...
  internal object Serializer : KSerializer<InlineV1PaymentLinksPostRequestFormCustomerCreationX4cdc4cda> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1PaymentLinksPostRequestFormCustomerCreationX4cdc4cda", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1PaymentLinksPostRequestFormCustomerCreationX4cdc4cda = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1PaymentLinksPostRequestFormCustomerCreationX4cdc4cda) {
