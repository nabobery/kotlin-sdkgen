...
public sealed class InlineV1AccountsExternalAccountsGetParameterX44f2e643 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1AccountsExternalAccountsGetParameterX44f2e643 = when (value) {
  ...
  internal object Serializer : KSerializer<InlineV1AccountsExternalAccountsGetParameterX44f2e643> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1AccountsExternalAccountsGetParameterX44f2e643", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1AccountsExternalAccountsGetParameterX44f2e643 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1AccountsExternalAccountsGetParameterX44f2e643) {
