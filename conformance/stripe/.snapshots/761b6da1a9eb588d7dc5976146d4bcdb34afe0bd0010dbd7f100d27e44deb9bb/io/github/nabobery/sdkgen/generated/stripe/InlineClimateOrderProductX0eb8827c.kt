...
public class InlineClimateOrderProductX0eb8827c internal constructor(
  ...
  public val climateProduct: ClimateProduct? by
      lazy(LazyThreadSafetyMode.NONE) { if (inspection.matchesClimateProduct) json.decodeFromJsonElement<ClimateProduct>(raw) else null }
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineClimateOrderProductX0eb8827c {
      val inspection = inspectInlineClimateOrderProductX0eb8827c(raw)
      if (inspection.matchCount == 0) {
        throw InlineClimateOrderProductX0eb8827cNoMatchException("InlineClimateOrderProductX0eb8827c matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineClimateOrderProductX0eb8827c(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineClimateOrderProductX0eb8827c> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineClimateOrderProductX0eb8827c) {
      encoder.requireJsonEncoder("InlineClimateOrderProductX0eb8827c").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineClimateOrderProductX0eb8827c(element: JsonElement): InlineClimateOrderProductX0eb8827cInspection {
