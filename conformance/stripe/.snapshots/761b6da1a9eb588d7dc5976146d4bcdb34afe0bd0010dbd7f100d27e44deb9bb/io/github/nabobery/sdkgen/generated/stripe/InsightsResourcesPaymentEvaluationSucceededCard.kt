...
public class InsightsResourcesPaymentEvaluationSucceededCard(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InsightsResourcesPaymentEvaluationSucceededCard = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InsightsResourcesPaymentEvaluationSucceededCard> {
    ...
    override fun deserialize(decoder: Decoder): InsightsResourcesPaymentEvaluationSucceededCard {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InsightsResourcesPaymentEvaluationSucceededCard must be a JSON object")
      val addressLine1Check = json.decodeRequired<InlineInsightsResourcesPaymentEvaluationSucceededCardAddressLine1CheckX27330ad7>(rawObject, "address_line1_check")
      val addressPostalCodeCheck = json.decodeRequired<InlineInsightsResourcesPayfa19AddressPostalCodeCheckX8169f88a>(rawObject, "address_postal_code_check")
      val cvcCheck = json.decodeRequired<InlineInsightsResourcesPaymentEvaluationSucceededCardCvcCheckX33ac2c45>(rawObject, "cvc_check")
      return InsightsResourcesPaymentEvaluationSucceededCard(
        addressLine1Check = addressLine1Check,
        addressPostalCodeCheck = addressPostalCodeCheck,
        cvcCheck = cvcCheck,
    ...
    override fun serialize(encoder: Encoder, `value`: InsightsResourcesPaymentEvaluationSucceededCard) {
...
public fun insightsResourcesPaymentEvaluationSucceededCard(block: InsightsResourcesPaymentEvaluationSucceededCard.Builder.() -> Unit): InsightsResourcesPaymentEvaluationSucceededCard = InsightsResourcesPaymentEvaluationSucceededCard.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InsightsResourcesPaymentEvaluationSucceededCard is missing required property '" + name + "'")
