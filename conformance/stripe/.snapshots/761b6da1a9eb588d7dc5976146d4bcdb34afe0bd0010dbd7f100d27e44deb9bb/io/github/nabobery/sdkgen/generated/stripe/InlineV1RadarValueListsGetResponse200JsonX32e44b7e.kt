...
public class InlineV1RadarValueListsGetResponse200JsonX32e44b7e(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1RadarValueListsGetResponse200JsonX32e44b7e = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1RadarValueListsGetResponse200JsonX32e44b7e> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1RadarValueListsGetResponse200JsonX32e44b7e {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1RadarValueListsGetResponse200JsonX32e44b7e must be a JSON object")
      ...
      val objectValue = json.decodeRequired<InlineV1RadarValueListsGetResponse200JsonObjectValueX120c35bd>(rawObject, "object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1RadarValueListsGetResponse200JsonX32e44b7e) {
...
public fun inlineV1RadarValueListsGetResponse200JsonX32e44b7e(block: InlineV1RadarValueListsGetResponse200JsonX32e44b7e.Builder.() -> Unit): InlineV1RadarValueListsGetResponse200JsonX32e44b7e = InlineV1RadarValueListsGetResponse200JsonX32e44b7e.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineV1RadarValueListsGetResponse200JsonX32e44b7e is missing required property '" + name + "'")
