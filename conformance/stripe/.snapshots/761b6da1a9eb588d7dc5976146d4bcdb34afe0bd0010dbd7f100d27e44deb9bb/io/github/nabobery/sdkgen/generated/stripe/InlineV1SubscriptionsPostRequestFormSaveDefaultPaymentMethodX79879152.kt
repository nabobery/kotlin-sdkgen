...
public sealed class InlineV1SubscriptionsPostRequestFormSaveDefaultPaymentMethodX79879152 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1SubscriptionsPostRequestFormSaveDefaultPaymentMethodX79879152 = when (value) {
      Off.value -> Off
  ...
  internal object Serializer : KSerializer<InlineV1SubscriptionsPostRequestFormSaveDefaultPaymentMethodX79879152> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1SubscriptionsPostRequestFormSaveDefaultPaymentMethodX79879152", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1SubscriptionsPostRequestFormSaveDefaultPaymentMethodX79879152 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1SubscriptionsPostRequestFormSaveDefaultPaymentMethodX79879152) {
