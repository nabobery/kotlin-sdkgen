...
public class InlineV1AccountsPostRequestFormIndividualDobAnyOf1Xb16dedab(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1AccountsPostRequestFormIndividualDobAnyOf1Xb16dedab = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1AccountsPostRequestFormIndividualDobAnyOf1Xb16dedab> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1AccountsPostRequestFormIndividualDobAnyOf1Xb16dedab {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1AccountsPostRequestFormIndividualDobAnyOf1Xb16dedab must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1AccountsPostRequestFormIndividualDobAnyOf1Xb16dedab) {
...
public fun inlineV1AccountsPostRequestFormIndividualDobAnyOf1Xb16dedab(block: InlineV1AccountsPostRequestFormIndividualDobAnyOf1Xb16dedab.Builder.() -> Unit): InlineV1AccountsPostRequestFormIndividualDobAnyOf1Xb16dedab = InlineV1AccountsPostRequestFormIndividualDobAnyOf1Xb16dedab.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineV1AccountsPostRequestFormIndividualDobAnyOf1Xb16dedab is missing required property '" + name + "'")
