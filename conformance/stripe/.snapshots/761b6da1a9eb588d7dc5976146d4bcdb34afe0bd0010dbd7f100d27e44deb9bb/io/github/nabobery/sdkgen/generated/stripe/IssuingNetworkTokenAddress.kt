...
public class IssuingNetworkTokenAddress(
  ...
  internal object Serializer : KSerializer<IssuingNetworkTokenAddress> {
    ...
    override fun deserialize(decoder: Decoder): IssuingNetworkTokenAddress {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("IssuingNetworkTokenAddress must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: IssuingNetworkTokenAddress) {
...
public fun issuingNetworkTokenAddress(block: IssuingNetworkTokenAddress.Builder.() -> Unit): IssuingNetworkTokenAddress = IssuingNetworkTokenAddress.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("IssuingNetworkTokenAddress is missing required property '" + name + "'")
