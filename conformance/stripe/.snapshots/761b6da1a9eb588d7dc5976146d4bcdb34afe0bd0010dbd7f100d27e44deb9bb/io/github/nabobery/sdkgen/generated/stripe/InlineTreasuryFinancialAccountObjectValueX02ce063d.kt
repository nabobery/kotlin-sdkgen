...
public sealed class InlineTreasuryFinancialAccountObjectValueX02ce063d {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineTreasuryFinancialAccountObjectValueX02ce063d = when (value) {
      TreasuryFinancialAccount.value -> TreasuryFinancialAccount
      else -> SdkUnknown(value)
    }
  }

  internal object Serializer : KSerializer<InlineTreasuryFinancialAccountObjectValueX02ce063d> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineTreasuryFinancialAccountObjectValueX02ce063d", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineTreasuryFinancialAccountObjectValueX02ce063d = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineTreasuryFinancialAccountObjectValueX02ce063d) {
