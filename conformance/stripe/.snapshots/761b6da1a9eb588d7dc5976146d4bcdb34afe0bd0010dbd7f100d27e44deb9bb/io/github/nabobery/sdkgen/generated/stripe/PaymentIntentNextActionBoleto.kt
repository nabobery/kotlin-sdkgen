...
public class PaymentIntentNextActionBoleto(
  ...
  public class Builder {
    ...
    public fun build(): PaymentIntentNextActionBoleto = PaymentIntentNextActionBoleto(
      expiresAt = expiresAt,
  ...
  internal object Serializer : KSerializer<PaymentIntentNextActionBoleto> {
    ...
    override fun deserialize(decoder: Decoder): PaymentIntentNextActionBoleto {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("PaymentIntentNextActionBoleto must be a JSON object")
      return PaymentIntentNextActionBoleto(
        ...
        pdf = rawObject["pdf"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<String?>(element) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: PaymentIntentNextActionBoleto) {
...
public fun paymentIntentNextActionBoleto(block: PaymentIntentNextActionBoleto.Builder.() -> Unit): PaymentIntentNextActionBoleto = PaymentIntentNextActionBoleto.build(block)
