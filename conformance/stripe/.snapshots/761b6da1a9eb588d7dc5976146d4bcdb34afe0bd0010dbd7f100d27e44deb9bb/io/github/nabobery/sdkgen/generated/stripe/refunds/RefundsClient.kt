package io.github.nabobery.sdkgen.generated.stripe.refunds
...
import io.github.nabobery.sdkgen.generated.stripe.InlineV1RefundsCancelPostRequestFormX0d2b9aec
import io.github.nabobery.sdkgen.generated.stripe.InlineV1RefundsGetParameterX7638b41e
import io.github.nabobery.sdkgen.generated.stripe.InlineV1RefundsGetResponse200JsonX9b79e480
import io.github.nabobery.sdkgen.generated.stripe.InlineV1RefundsPostRequestFormX3e77f244
import io.github.nabobery.sdkgen.generated.stripe.InlineV1RefundsPostRequestFormXeb4d6677
...
internal object RefundsCodecs {
  internal const val GETREFUNDS_REQUEST_CODEC_ID: String = "GetRefunds.request"
  ...
  internal val getRefundsResponseCodecAlternative0Registry:
  ...
  internal val getRefundsResponseCodecAlternative1Registry: MediaTypeCodecRegistry<Error> =
      MediaTypeCodecRegistry.of(getRefundsResponseCodecAlternative1Codec)

  internal val getRefundsRequestCodecRegistry: MediaTypeCodecRegistry<JsonObject?> =
      MediaTypeCodecRegistry.of(getRefundsRequestCodec)

  internal const val GETREFUNDSREFUND_REQUEST_CODEC_ID: String = "GetRefundsRefund.request"
  ...
  internal val getRefundsRefundResponseCodecAlternative0Registry: MediaTypeCodecRegistry<Refund> =
  ...
  internal val getRefundsRefundResponseCodecAlternative1Registry: MediaTypeCodecRegistry<Error> =
      MediaTypeCodecRegistry.of(getRefundsRefundResponseCodecAlternative1Codec)

  internal val getRefundsRefundRequestCodecRegistry: MediaTypeCodecRegistry<JsonObject?> =
      MediaTypeCodecRegistry.of(getRefundsRefundRequestCodec)

  internal const val POSTREFUNDS_REQUEST_CODEC_ID: String = "PostRefunds.request"
  ...
  internal val postRefundsResponseCodecAlternative0Registry: MediaTypeCodecRegistry<Refund> =
  ...
  internal val postRefundsResponseCodecAlternative1Registry: MediaTypeCodecRegistry<Error> =
      MediaTypeCodecRegistry.of(postRefundsResponseCodecAlternative1Codec)

  internal val postRefundsRequestCodecRegistry:
      MediaTypeCodecRegistry<InlineV1RefundsPostRequestFormX3e77f244?> =
      MediaTypeCodecRegistry.of(postRefundsRequestCodec)

  internal const val POSTREFUNDSREFUND_REQUEST_CODEC_ID: String = "PostRefundsRefund.request"
  ...
  internal val postRefundsRefundResponseCodecAlternative0Registry: MediaTypeCodecRegistry<Refund> =
  ...
  internal val postRefundsRefundResponseCodecAlternative1Registry: MediaTypeCodecRegistry<Error> =
      MediaTypeCodecRegistry.of(postRefundsRefundResponseCodecAlternative1Codec)

  internal val postRefundsRefundRequestCodecRegistry:
      MediaTypeCodecRegistry<InlineV1RefundsPostRequestFormXeb4d6677?> =
      MediaTypeCodecRegistry.of(postRefundsRefundRequestCodec)

  internal const val POSTREFUNDSREFUNDCANCEL_REQUEST_CODEC_ID: String =
  ...
  internal val postRefundsRefundCancelResponseCodecAlternative0Registry:
  ...
  internal val postRefundsRefundCancelResponseCodecAlternative1Registry:
      MediaTypeCodecRegistry<Error> =
      MediaTypeCodecRegistry.of(postRefundsRefundCancelResponseCodecAlternative1Codec)

  internal val postRefundsRefundCancelRequestCodecRegistry:
  ...
  internal object GetRefundsFormCodec : MediaTypeCodec<JsonObject?> {
  ...
  internal object GetRefundsRefundFormCodec : MediaTypeCodec<JsonObject?> {
  ...
  internal object PostRefundsFormCodec : MediaTypeCodec<InlineV1RefundsPostRequestFormX3e77f244?> {
  ...
  internal object PostRefundsRefundFormCodec : MediaTypeCodec<InlineV1RefundsPostRequestFormXeb4d6677?> {
  ...
  internal object PostRefundsRefundCancelFormCodec : MediaTypeCodec<InlineV1RefundsCancelPostRequestFormX0d2b9aec?> {
...
public class RefundsClient(
  ...
  public companion object {
    internal val getRefundsMetadata: OperationMetadata by
    ...
    internal val getRefundsRefundMetadata: OperationMetadata by
        lazy(LazyThreadSafetyMode.PUBLICATION) { OperationMetadata(
    ...
    internal val postRefundsMetadata: OperationMetadata by
        lazy(LazyThreadSafetyMode.PUBLICATION) { OperationMetadata(
    ...
    internal val postRefundsRefundMetadata: OperationMetadata by
        lazy(LazyThreadSafetyMode.PUBLICATION) { OperationMetadata(
    ...
    internal val postRefundsRefundCancelMetadata: OperationMetadata by
        lazy(LazyThreadSafetyMode.PUBLICATION) { OperationMetadata(
