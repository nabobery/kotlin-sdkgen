...
public sealed class InlineV1PaymentIntentsPostRequestFormPaymentMethodDataSofortCountryX86793b94 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1PaymentIntentsPostRequestFormPaymentMethodDataSofortCountryX86793b94 = when (value) {
      At.value -> At
      Be.value -> Be
      De.value -> De
      Es.value -> Es
  ...
  internal object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormPaymentMethodDataSofortCountryX86793b94> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1PaymentIntentsPostRequestFormPaymentMethodDataSofortCountryX86793b94", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1PaymentIntentsPostRequestFormPaymentMethodDataSofortCountryX86793b94 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1PaymentIntentsPostRequestFormPaymentMethodDataSofortCountryX86793b94) {
