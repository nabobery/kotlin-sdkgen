...
internal data class InlineV1SubscriptionItemsPostRequestFormMetadataXd0db8ca2Inspection(
  ...
  public val matchCount: Int
    get() = listOf(matchesBranch1, matchesInlineV1SubscriptionItemsPostRequestFormMetadataAnyOf2Xd717b993).count { it }
}
...
public class InlineV1SubscriptionItemsPostRequestFormMetadataXd0db8ca2 internal constructor(
  ...
  public val inlineV1SubscriptionItemsPostRequestFormMetadataAnyOf2Xd717b993:
      ...
      lazy(LazyThreadSafetyMode.NONE) { if (inspection.matchesInlineV1SubscriptionItemsPostRequestFormMetadataAnyOf2Xd717b993) json.decodeFromJsonElement<InlineV1SubscriptionItemsPostRequestFormMetadataAnyOf2Xd717b993>(raw) else null }

  public val matchedBranches: Set<InlineV1SubscriptionItemsPostRequestFormMetadataXd0db8ca2Branch>
    get() = buildSet {
      if (inspection.matchesBranch1) add(InlineV1SubscriptionItemsPostRequestFormMetadataXd0db8ca2Branch.Branch1)
      if (inspection.matchesInlineV1SubscriptionItemsPostRequestFormMetadataAnyOf2Xd717b993) add(InlineV1SubscriptionItemsPostRequestFormMetadataXd0db8ca2Branch.InlineV1SubscriptionItemsPostRequestFormMetadataAnyOf2Xd717b993)
    }
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineV1SubscriptionItemsPostRequestFormMetadataXd0db8ca2 {
      val inspection = inspectInlineV1SubscriptionItemsPostRequestFormMetadataXd0db8ca2(raw)
      if (inspection.matchCount == 0) {
        throw InlineV1SubscriptionItemsPostRequestFormMetadataXd0db8ca2NoMatchException("InlineV1SubscriptionItemsPostRequestFormMetadataXd0db8ca2 matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineV1SubscriptionItemsPostRequestFormMetadataXd0db8ca2(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineV1SubscriptionItemsPostRequestFormMetadataXd0db8ca2> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1SubscriptionItemsPostRequestFormMetadataXd0db8ca2) {
      encoder.requireJsonEncoder("InlineV1SubscriptionItemsPostRequestFormMetadataXd0db8ca2").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineV1SubscriptionItemsPostRequestFormMetadataXd0db8ca2(element: JsonElement): InlineV1SubscriptionItemsPostRequestFormMetadataXd0db8ca2Inspection {
  val matchesBranch1 = element.isJsonDecodable<JsonObject>()
  val matchesInlineV1SubscriptionItemsPostRequestFormMetadataAnyOf2Xd717b993 = element.isJsonDecodable<InlineV1SubscriptionItemsPostRequestFormMetadataAnyOf2Xd717b993>()
  return InlineV1SubscriptionItemsPostRequestFormMetadataXd0db8ca2Inspection(
    ...
    failures = buildList {
      ...
      if (!matchesInlineV1SubscriptionItemsPostRequestFormMetadataAnyOf2Xd717b993) add("InlineV1SubscriptionItemsPostRequestFormMetadataAnyOf2Xd717b993: value does not match InlineV1SubscriptionItemsPostRequestFormMetadataAnyOf2Xd717b993")
    },
  )
}
