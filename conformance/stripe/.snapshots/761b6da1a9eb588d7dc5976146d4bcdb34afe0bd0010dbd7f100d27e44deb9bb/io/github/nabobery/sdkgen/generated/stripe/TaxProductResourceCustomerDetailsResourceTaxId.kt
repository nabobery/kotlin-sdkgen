...
public class TaxProductResourceCustomerDetailsResourceTaxId(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): TaxProductResourceCustomerDetailsResourceTaxId = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<TaxProductResourceCustomerDetailsResourceTaxId> {
    ...
    override fun deserialize(decoder: Decoder): TaxProductResourceCustomerDetailsResourceTaxId {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("TaxProductResourceCustomerDetailsResourceTaxId must be a JSON object")
      val type = json.decodeRequired<InlineTaxProductResourceCustomerDetailsResourceTaxIdTypeXee0dc45d>(rawObject, "type")
    ...
    override fun serialize(encoder: Encoder, `value`: TaxProductResourceCustomerDetailsResourceTaxId) {
...
public fun taxProductResourceCustomerDetailsResourceTaxId(block: TaxProductResourceCustomerDetailsResourceTaxId.Builder.() -> Unit): TaxProductResourceCustomerDetailsResourceTaxId = TaxProductResourceCustomerDetailsResourceTaxId.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("TaxProductResourceCustomerDetailsResourceTaxId is missing required property '" + name + "'")
