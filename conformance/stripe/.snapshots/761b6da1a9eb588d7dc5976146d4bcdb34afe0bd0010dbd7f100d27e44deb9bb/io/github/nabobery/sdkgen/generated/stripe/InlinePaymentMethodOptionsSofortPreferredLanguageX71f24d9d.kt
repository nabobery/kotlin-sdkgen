...
public sealed class InlinePaymentMethodOptionsSofortPreferredLanguageX71f24d9d {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlinePaymentMethodOptionsSofortPreferredLanguageX71f24d9d = when (value) {
      De.value -> De
      En.value -> En
      Es.value -> Es
      Fr.value -> Fr
  ...
  internal object Serializer : KSerializer<InlinePaymentMethodOptionsSofortPreferredLanguageX71f24d9d> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlinePaymentMethodOptionsSofortPreferredLanguageX71f24d9d", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlinePaymentMethodOptionsSofortPreferredLanguageX71f24d9d = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlinePaymentMethodOptionsSofortPreferredLanguageX71f24d9d) {
