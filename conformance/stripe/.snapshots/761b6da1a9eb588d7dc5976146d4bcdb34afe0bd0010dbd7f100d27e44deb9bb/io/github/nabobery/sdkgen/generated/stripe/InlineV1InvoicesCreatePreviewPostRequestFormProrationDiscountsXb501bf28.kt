...
public sealed class InlineV1InvoicesCreatePreviewPostRequestFormProrationDiscountsXb501bf28 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1InvoicesCreatePreviewPostRequestFormProrationDiscountsXb501bf28 = when (value) {
  ...
  internal object Serializer : KSerializer<InlineV1InvoicesCreatePreviewPostRequestFormProrationDiscountsXb501bf28> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1InvoicesCreatePreviewPostRequestFormProrationDiscountsXb501bf28", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1InvoicesCreatePreviewPostRequestFormProrationDiscountsXb501bf28 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1InvoicesCreatePreviewPostRequestFormProrationDiscountsXb501bf28) {
