...
public class InlineV1InvoicesAttachPaymentPostRequestFormX4b78a621(
  ...
  public class Builder {
    ...
    public fun build(): InlineV1InvoicesAttachPaymentPostRequestFormX4b78a621 = InlineV1InvoicesAttachPaymentPostRequestFormX4b78a621(
      expand = expand,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1InvoicesAttachPaymentPostRequestFormX4b78a621 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1InvoicesAttachPaymentPostRequestFormX4b78a621> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1InvoicesAttachPaymentPostRequestFormX4b78a621 {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1InvoicesAttachPaymentPostRequestFormX4b78a621 must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1InvoicesAttachPaymentPostRequestFormX4b78a621) {
...
public fun inlineV1InvoicesAttachPaymentPostRequestFormX4b78a621(block: InlineV1InvoicesAttachPaymentPostRequestFormX4b78a621.Builder.() -> Unit): InlineV1InvoicesAttachPaymentPostRequestFormX4b78a621 = InlineV1InvoicesAttachPaymentPostRequestFormX4b78a621.build(block)
