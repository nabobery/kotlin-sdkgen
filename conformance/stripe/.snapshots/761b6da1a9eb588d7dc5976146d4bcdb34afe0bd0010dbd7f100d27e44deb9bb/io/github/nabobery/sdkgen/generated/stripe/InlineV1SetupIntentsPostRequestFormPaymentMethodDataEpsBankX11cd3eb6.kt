 ...
 * lencoded/schema/properties/payment_method_data/properties/eps/properties/bank.
 *
 * Source:
 * sdkgen://source/openapi.json#/paths/~1v1~1setup_intents~1{intent}/post/requestBody/content/application~1x-www-form-ur
 * lencoded/schema/properties/payment_method_data/properties/eps/properties/bank
 */
@Serializable(with = InlineV1SetupIntentsPostRequestFormPaymentMethodDataEpsBankX11cd3eb6.Serializer::class)
public sealed class InlineV1SetupIntentsPostRequestFormPaymentMethodDataEpsBankX11cd3eb6 {
  public abstract val `value`: String

  /**
   * Documented value. Wire value: `arzte_und_apotheker_bank`.
   */
  public data object ArzteUndApothekerBank : InlineV1SetupIntentsPostRequestFormPaymentMethodDataEpsBankX11cd3eb6() {
   ...
   */
  public data object AustrianAnadiBankAg : InlineV1SetupIntentsPostRequestFormPaymentMethodDataEpsBankX11cd3eb6() {
   ...
   */
  public data object BankAustria : InlineV1SetupIntentsPostRequestFormPaymentMethodDataEpsBankX11cd3eb6() {
   ...
   */
  public data object BankhausCarlSpangler : InlineV1SetupIntentsPostRequestFormPaymentMethodDataEpsBankX11cd3eb6() {
   ...
   */
  public data object BankhausSchelhammerUndSchatteraAg : InlineV1SetupIntentsPostRequestFormPaymentMethodDataEpsBankX11cd3eb6() {
   ...
   */
  public data object BawagPskAg : InlineV1SetupIntentsPostRequestFormPaymentMethodDataEpsBankX11cd3eb6() {
   ...
   */
  public data object BksBankAg : InlineV1SetupIntentsPostRequestFormPaymentMethodDataEpsBankX11cd3eb6() {
   ...
   */
  public data object BrullKallmusBankAg : InlineV1SetupIntentsPostRequestFormPaymentMethodDataEpsBankX11cd3eb6() {
   ...
   */
  public data object BtvVierLanderBank : InlineV1SetupIntentsPostRequestFormPaymentMethodDataEpsBankX11cd3eb6() {
   ...
   */
  public data object CapitalBankGraweGruppeAg : InlineV1SetupIntentsPostRequestFormPaymentMethodDataEpsBankX11cd3eb6() {
   ...
   */
  public data object DeutscheBankAg : InlineV1SetupIntentsPostRequestFormPaymentMethodDataEpsBankX11cd3eb6() {
   ...
   */
  public data object Dolomitenbank : InlineV1SetupIntentsPostRequestFormPaymentMethodDataEpsBankX11cd3eb6() {
   ...
   */
  public data object EasybankAg : InlineV1SetupIntentsPostRequestFormPaymentMethodDataEpsBankX11cd3eb6() {
   ...
   */
  public data object ErsteBankUndSparkassen : InlineV1SetupIntentsPostRequestFormPaymentMethodDataEpsBankX11cd3eb6() {
   ...
   */
  public data object HypoAlpeadriabankInternationalAg : InlineV1SetupIntentsPostRequestFormPaymentMethodDataEpsBankX11cd3eb6() {
   ...
   */
  public data object HypoBankBurgenlandAktiengesellschaft : InlineV1SetupIntentsPostRequestFormPaymentMethodDataEpsBankX11cd3eb6() {
   ...
   */
  public data object HypoNoeLbFurNiederosterreichUWien : InlineV1SetupIntentsPostRequestFormPaymentMethodDataEpsBankX11cd3eb6() {
   ...
   */
  public data object HypoOberosterreichSalzburgSteiermark : InlineV1SetupIntentsPostRequestFormPaymentMethodDataEpsBankX11cd3eb6() {
   ...
   */
  public data object HypoTirolBankAg : InlineV1SetupIntentsPostRequestFormPaymentMethodDataEpsBankX11cd3eb6() {
   ...
   */
  public data object HypoVorarlbergBankAg : InlineV1SetupIntentsPostRequestFormPaymentMethodDataEpsBankX11cd3eb6() {
   ...
   */
  public data object MarchfelderBank : InlineV1SetupIntentsPostRequestFormPaymentMethodDataEpsBankX11cd3eb6() {
   ...
   */
  public data object OberbankAg : InlineV1SetupIntentsPostRequestFormPaymentMethodDataEpsBankX11cd3eb6() {
   ...
   */
  public data object RaiffeisenBankengruppeOsterreich : InlineV1SetupIntentsPostRequestFormPaymentMethodDataEpsBankX11cd3eb6() {
   ...
   */
  public data object SchoellerbankAg : InlineV1SetupIntentsPostRequestFormPaymentMethodDataEpsBankX11cd3eb6() {
   ...
   */
  public data object SpardaBankWien : InlineV1SetupIntentsPostRequestFormPaymentMethodDataEpsBankX11cd3eb6() {
   ...
   */
  public data object VolksbankGruppe : InlineV1SetupIntentsPostRequestFormPaymentMethodDataEpsBankX11cd3eb6() {
   ...
   */
  public data object VolkskreditbankAg : InlineV1SetupIntentsPostRequestFormPaymentMethodDataEpsBankX11cd3eb6() {
   ...
   */
  public data object VrBankBraunau : InlineV1SetupIntentsPostRequestFormPaymentMethodDataEpsBankX11cd3eb6() {
    public override val `value`: String = "vr_bank_braunau"
  }

  public data class SdkUnknown(
    public override val `value`: String,
  ) : InlineV1SetupIntentsPostRequestFormPaymentMethodDataEpsBankX11cd3eb6()

  public companion object {
    public fun fromValue(`value`: String): InlineV1SetupIntentsPostRequestFormPaymentMethodDataEpsBankX11cd3eb6 = when (value) {
  ...
  internal object Serializer : KSerializer<InlineV1SetupIntentsPostRequestFormPaymentMethodDataEpsBankX11cd3eb6> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1SetupIntentsPostRequestFormPaymentMethodDataEpsBankX11cd3eb6", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1SetupIntentsPostRequestFormPaymentMethodDataEpsBankX11cd3eb6 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1SetupIntentsPostRequestFormPaymentMethodDataEpsBankX11cd3eb6) {
