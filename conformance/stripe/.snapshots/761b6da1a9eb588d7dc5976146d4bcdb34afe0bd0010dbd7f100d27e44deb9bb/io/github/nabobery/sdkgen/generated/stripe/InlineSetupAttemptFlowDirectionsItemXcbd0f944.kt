...
public sealed class InlineSetupAttemptFlowDirectionsItemXcbd0f944 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineSetupAttemptFlowDirectionsItemXcbd0f944 = when (value) {
  ...
  internal object Serializer : KSerializer<InlineSetupAttemptFlowDirectionsItemXcbd0f944> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineSetupAttemptFlowDirectionsItemXcbd0f944", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineSetupAttemptFlowDirectionsItemXcbd0f944 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineSetupAttemptFlowDirectionsItemXcbd0f944) {
