...
public sealed class InlineV1TreasuryOutboundTrc70dPostRequestFormNetworkX56d3a4af {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1TreasuryOutboundTrc70dPostRequestFormNetworkX56d3a4af = when (value) {
      Ach.value -> Ach
  ...
  internal object Serializer : KSerializer<InlineV1TreasuryOutboundTrc70dPostRequestFormNetworkX56d3a4af> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1TreasuryOutboundTrc70dPostRequestFormNetworkX56d3a4af", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1TreasuryOutboundTrc70dPostRequestFormNetworkX56d3a4af = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1TreasuryOutboundTrc70dPostRequestFormNetworkX56d3a4af) {
