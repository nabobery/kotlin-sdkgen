...
public sealed class InlineV1QuotesPostRequestFormLineItemsItemPriceDataRecurringIntervalX785e72ab {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1QuotesPostRequestFormLineItemsItemPriceDataRecurringIntervalX785e72ab = when (value) {
      Day.value -> Day
      Month.value -> Month
      Week.value -> Week
      Year.value -> Year
  ...
  internal object Serializer : KSerializer<InlineV1QuotesPostRequestFormLineItemsItemPriceDataRecurringIntervalX785e72ab> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1QuotesPostRequestFormLineItemsItemPriceDataRecurringIntervalX785e72ab", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1QuotesPostRequestFormLineItemsItemPriceDataRecurringIntervalX785e72ab = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1QuotesPostRequestFormLineItemsItemPriceDataRecurringIntervalX785e72ab) {
