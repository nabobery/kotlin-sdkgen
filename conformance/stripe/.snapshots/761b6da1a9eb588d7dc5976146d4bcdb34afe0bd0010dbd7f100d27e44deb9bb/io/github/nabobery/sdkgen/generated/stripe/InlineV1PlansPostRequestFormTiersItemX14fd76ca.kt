...
public class InlineV1PlansPostRequestFormTiersItemX14fd76ca(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1PlansPostRequestFormTiersItemX14fd76ca = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1PlansPostRequestFormTiersItemX14fd76ca> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1PlansPostRequestFormTiersItemX14fd76ca {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1PlansPostRequestFormTiersItemX14fd76ca must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1PlansPostRequestFormTiersItemX14fd76ca) {
...
public fun inlineV1PlansPostRequestFormTiersItemX14fd76ca(block: InlineV1PlansPostRequestFormTiersItemX14fd76ca.Builder.() -> Unit): InlineV1PlansPostRequestFormTiersItemX14fd76ca = InlineV1PlansPostRequestFormTiersItemX14fd76ca.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineV1PlansPostRequestFormTiersItemX14fd76ca is missing required property '" + name + "'")
