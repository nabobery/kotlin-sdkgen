...
public class Mandate(
  ...
  internal object Serializer : KSerializer<Mandate> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): Mandate {
      val jsonDecoder = decoder.requireJsonDecoder("Mandate")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("Mandate must be a JSON object")
      ...
      val paymentMethodDetails = json.decodeRequired<MandatePaymentMethodDetails>(rawObject, "payment_method_details")
    ...
    override fun serialize(encoder: Encoder, `value`: Mandate) {
