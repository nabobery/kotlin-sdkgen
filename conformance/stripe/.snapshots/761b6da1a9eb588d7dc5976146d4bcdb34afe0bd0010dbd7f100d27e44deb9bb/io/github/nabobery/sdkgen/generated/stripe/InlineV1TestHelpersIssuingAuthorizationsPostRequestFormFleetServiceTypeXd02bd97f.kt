...
public sealed class InlineV1TestHelpersIssuingAuthorizationsPostRequestFormFleetServiceTypeXd02bd97f {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1TestHelpersIssuingAuthorizationsPostRequestFormFleetServiceTypeXd02bd97f = when (value) {
  ...
  internal object Serializer : KSerializer<InlineV1TestHelpersIssuingAuthorizationsPostRequestFormFleetServiceTypeXd02bd97f> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1TestHelpersIssuingAuthorizationsPostRequestFormFleetServiceTypeXd02bd97f", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1TestHelpersIssuingAuthorizationsPostRequestFormFleetServiceTypeXd02bd97f = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1TestHelpersIssuingAuthorizationsPostRequestFormFleetServiceTypeXd02bd97f) {
