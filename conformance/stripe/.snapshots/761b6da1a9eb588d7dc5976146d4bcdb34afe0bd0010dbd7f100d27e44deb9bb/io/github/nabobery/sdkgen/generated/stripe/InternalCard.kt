...
public class InternalCard(
  ...
  public class Builder {
    ...
    public fun build(): InternalCard = InternalCard(
      brand = brand,
      country = country,
      expMonth = expMonth,
      expYear = expYear,
  ...
  internal object Serializer : KSerializer<InternalCard> {
    ...
    override fun deserialize(decoder: Decoder): InternalCard {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InternalCard must be a JSON object")
      return InternalCard(
    ...
    override fun serialize(encoder: Encoder, `value`: InternalCard) {
