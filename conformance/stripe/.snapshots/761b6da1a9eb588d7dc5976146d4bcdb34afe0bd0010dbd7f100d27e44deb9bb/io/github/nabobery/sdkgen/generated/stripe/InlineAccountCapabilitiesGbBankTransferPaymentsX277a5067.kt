...
public sealed class InlineAccountCapabilitiesGbBankTransferPaymentsX277a5067 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineAccountCapabilitiesGbBankTransferPaymentsX277a5067 = when (value) {
      Active.value -> Active
  ...
  internal object Serializer : KSerializer<InlineAccountCapabilitiesGbBankTransferPaymentsX277a5067> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineAccountCapabilitiesGbBankTransferPaymentsX277a5067", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineAccountCapabilitiesGbBankTransferPaymentsX277a5067 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineAccountCapabilitiesGbBankTransferPaymentsX277a5067) {
