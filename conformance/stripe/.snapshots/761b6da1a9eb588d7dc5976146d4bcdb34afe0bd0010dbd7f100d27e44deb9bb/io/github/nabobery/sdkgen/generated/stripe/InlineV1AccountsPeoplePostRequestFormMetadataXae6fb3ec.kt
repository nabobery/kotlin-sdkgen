...
public class InlineV1AccountsPeoplePostRequestFormMetadataXae6fb3ec internal constructor(
  ...
  public val inlineV1AccountsPeoplePostRequestFormMetadataAnyOf2X39552d6c:
      ...
      lazy(LazyThreadSafetyMode.NONE) { if (inspection.matchesInlineV1AccountsPeoplePostRequestFormMetadataAnyOf2X39552d6c) json.decodeFromJsonElement<InlineV1AccountsPeoplePostRequestFormMetadataAnyOf2X39552d6c>(raw) else null }
  ...
  public val matchedBranches: Set<InlineV1AccountsPeoplePostRequestFormMetadataXae6fb3ecBranch>
    get() = buildSet {
      ...
      if (inspection.matchesInlineV1AccountsPeoplePostRequestFormMetadataAnyOf2X39552d6c) add(InlineV1AccountsPeoplePostRequestFormMetadataXae6fb3ecBranch.InlineV1AccountsPeoplePostRequestFormMetadataAnyOf2X39552d6c)
    }
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineV1AccountsPeoplePostRequestFormMetadataXae6fb3ec {
      val inspection = inspectInlineV1AccountsPeoplePostRequestFormMetadataXae6fb3ec(raw)
      if (inspection.matchCount == 0) {
        throw InlineV1AccountsPeoplePostRequestFormMetadataXae6fb3ecNoMatchException("InlineV1AccountsPeoplePostRequestFormMetadataXae6fb3ec matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineV1AccountsPeoplePostRequestFormMetadataXae6fb3ec(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineV1AccountsPeoplePostRequestFormMetadataXae6fb3ec> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1AccountsPeoplePostRequestFormMetadataXae6fb3ec) {
      encoder.requireJsonEncoder("InlineV1AccountsPeoplePostRequestFormMetadataXae6fb3ec").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineV1AccountsPeoplePostRequestFormMetadataXae6fb3ec(element: JsonElement): InlineV1AccountsPeoplePostRequestFormMetadataXae6fb3ecInspection {
  val matchesBranch1 = element.isJsonDecodable<JsonObject>()
  val matchesInlineV1AccountsPeoplePostRequestFormMetadataAnyOf2X39552d6c = element.isJsonDecodable<InlineV1AccountsPeoplePostRequestFormMetadataAnyOf2X39552d6c>()
  return InlineV1AccountsPeoplePostRequestFormMetadataXae6fb3ecInspection(
    ...
    failures = buildList {
      ...
      if (!matchesInlineV1AccountsPeoplePostRequestFormMetadataAnyOf2X39552d6c) add("InlineV1AccountsPeoplePostRequestFormMetadataAnyOf2X39552d6c: value does not match InlineV1AccountsPeoplePostRequestFormMetadataAnyOf2X39552d6c")
    },
  )
}
