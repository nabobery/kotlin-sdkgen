...
public class TerminalReaderReaderResourceLineItem(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): TerminalReaderReaderResourceLineItem = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<TerminalReaderReaderResourceLineItem> {
    ...
    override fun deserialize(decoder: Decoder): TerminalReaderReaderResourceLineItem {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("TerminalReaderReaderResourceLineItem must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: TerminalReaderReaderResourceLineItem) {
...
public fun terminalReaderReaderResourceLineItem(block: TerminalReaderReaderResourceLineItem.Builder.() -> Unit): TerminalReaderReaderResourceLineItem = TerminalReaderReaderResourceLineItem.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("TerminalReaderReaderResourceLineItem is missing required property '" + name + "'")
