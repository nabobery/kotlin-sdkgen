...
public class InlineTerminalReaderReaderResourceRefundPaymentActionChargeXfab6da75 internal constructor(
  ...
  public val matchedBranches:
    ...
    get() = buildSet {
      if (inspection.matchesBranch1) add(InlineTerminalReaderReaderResourceRefundPaymentActionChargeXfab6da75Branch.Branch1)
      if (inspection.matchesCharge) add(InlineTerminalReaderReaderResourceRefundPaymentActionChargeXfab6da75Branch.Charge)
    }
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineTerminalReaderReaderResourceRefundPaymentActionChargeXfab6da75 {
      val inspection = inspectInlineTerminalReaderReaderResourceRefundPaymentActionChargeXfab6da75(raw)
      if (inspection.matchCount == 0) {
        throw InlineTerminalReaderReaderResourceRefundPaymentActionChargeXfab6da75NoMatchException("InlineTerminalReaderReaderResourceRefundPaymentActionChargeXfab6da75 matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineTerminalReaderReaderResourceRefundPaymentActionChargeXfab6da75(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineTerminalReaderReaderResourceRefundPaymentActionChargeXfab6da75> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineTerminalReaderReaderResourceRefundPaymentActionChargeXfab6da75 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineTerminalReaderReaderResourceRefundPaymentActionChargeXfab6da75")
      return fromRaw(jsonDecoder.decodeJsonElement(), jsonDecoder.json)
    }

    override fun serialize(encoder: Encoder, `value`: InlineTerminalReaderReaderResourceRefundPaymentActionChargeXfab6da75) {
      encoder.requireJsonEncoder("InlineTerminalReaderReaderResourceRefundPaymentActionChargeXfab6da75").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineTerminalReaderReaderResourceRefundPaymentActionChargeXfab6da75(element: JsonElement): InlineTerminalReaderReaderResourceRefundPaymentActionChargeXfab6da75Inspection {
