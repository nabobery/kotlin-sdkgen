...
public class SourceTypeEps(
  ...
  public class Builder {
    ...
    public fun build(): SourceTypeEps = SourceTypeEps(
      reference = reference,
  ...
  internal object Serializer : KSerializer<SourceTypeEps> {
    ...
    override fun deserialize(decoder: Decoder): SourceTypeEps {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("SourceTypeEps must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: SourceTypeEps) {
