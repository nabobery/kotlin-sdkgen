...
public sealed class InlineThreeDSecureDetailsChargeElectronicCommerceIndicatorXfc9e735a {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineThreeDSecureDetailsChargeElectronicCommerceIndicatorXfc9e735a = when (value) {
      _01.value -> _01
      _02.value -> _02
      _05.value -> _05
      _06.value -> _06
  ...
  internal object Serializer : KSerializer<InlineThreeDSecureDetailsChargeElectronicCommerceIndicatorXfc9e735a> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineThreeDSecureDetailsChargeElectronicCommerceIndicatorXfc9e735a", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineThreeDSecureDetailsChargeElectronicCommerceIndicatorXfc9e735a = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineThreeDSecureDetailsChargeElectronicCommerceIndicatorXfc9e735a) {
