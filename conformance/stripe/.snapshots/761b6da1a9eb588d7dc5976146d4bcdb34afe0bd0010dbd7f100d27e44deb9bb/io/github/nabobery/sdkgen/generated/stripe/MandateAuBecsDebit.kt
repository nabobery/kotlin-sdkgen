...
public class MandateAuBecsDebit(
  ...
  internal object Serializer : KSerializer<MandateAuBecsDebit> {
    ...
    override fun deserialize(decoder: Decoder): MandateAuBecsDebit {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("MandateAuBecsDebit must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: MandateAuBecsDebit) {
...
public fun mandateAuBecsDebit(block: MandateAuBecsDebit.Builder.() -> Unit): MandateAuBecsDebit = MandateAuBecsDebit.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("MandateAuBecsDebit is missing required property '" + name + "'")
