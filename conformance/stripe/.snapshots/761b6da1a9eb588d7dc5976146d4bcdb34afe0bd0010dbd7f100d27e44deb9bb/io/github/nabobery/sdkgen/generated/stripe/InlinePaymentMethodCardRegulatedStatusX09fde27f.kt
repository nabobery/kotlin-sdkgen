...
public sealed class InlinePaymentMethodCardRegulatedStatusX09fde27f {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlinePaymentMethodCardRegulatedStatusX09fde27f = when (value) {
  ...
  internal object Serializer : KSerializer<InlinePaymentMethodCardRegulatedStatusX09fde27f> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlinePaymentMethodCardRegulatedStatusX09fde27f", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlinePaymentMethodCardRegulatedStatusX09fde27f = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlinePaymentMethodCardRegulatedStatusX09fde27f) {
