...
public sealed class InlineV1CustomersSubscriptionsPostRequestFormItemsItemTaxBehaviorXc12102ec {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1CustomersSubscriptionsPostRequestFormItemsItemTaxBehaviorXc12102ec = when (value) {
  ...
  internal object Serializer : KSerializer<InlineV1CustomersSubscriptionsPostRequestFormItemsItemTaxBehaviorXc12102ec> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1CustomersSubscriptionsPostRequestFormItemsItemTaxBehaviorXc12102ec", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1CustomersSubscriptionsPostRequestFormItemsItemTaxBehaviorXc12102ec = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1CustomersSubscriptionsPostRequestFormItemsItemTaxBehaviorXc12102ec) {
