...
public class InlineV1CustomersPostRequestFormInvoiceSettingsX99c0a3df(
  public val customFields:
      InlineV1CustomersPostRequestFormInvoiceSettingsCustomFieldsX76ba806f? = null,
  ...
  public class Builder {
    ...
    public fun build(): InlineV1CustomersPostRequestFormInvoiceSettingsX99c0a3df = InlineV1CustomersPostRequestFormInvoiceSettingsX99c0a3df(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1CustomersPostRequestFormInvoiceSettingsX99c0a3df = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1CustomersPostRequestFormInvoiceSettingsX99c0a3df> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1CustomersPostRequestFormInvoiceSettingsX99c0a3df {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1CustomersPostRequestFormInvoiceSettingsX99c0a3df must be a JSON object")
      return InlineV1CustomersPostRequestFormInvoiceSettingsX99c0a3df(
        customFields = rawObject["custom_fields"]?.let { json.decodeFromJsonElement<InlineV1CustomersPostRequestFormInvoiceSettingsCustomFieldsX76ba806f>(it) },
        ...
        renderingOptions = rawObject["rendering_options"]?.let { json.decodeFromJsonElement<InlineV1CustomersPostRequestFormInvoiceSettingsRenderingOptionsXb4913c35>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineV1CustomersPostRequestFormInvoiceSettingsX99c0a3df) {
...
public fun inlineV1CustomersPostRequestFormInvoiceSettingsX99c0a3df(block: InlineV1CustomersPostRequestFormInvoiceSettingsX99c0a3df.Builder.() -> Unit): InlineV1CustomersPostRequestFormInvoiceSettingsX99c0a3df = InlineV1CustomersPostRequestFormInvoiceSettingsX99c0a3df.build(block)
