...
public sealed class InlineCheckoutSessionLocaleX143da667 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineCheckoutSessionLocaleX143da667 = when (value) {
      Auto.value -> Auto
      Bg.value -> Bg
      Cs.value -> Cs
      Da.value -> Da
  ...
  internal object Serializer : KSerializer<InlineCheckoutSessionLocaleX143da667> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineCheckoutSessionLocaleX143da667", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineCheckoutSessionLocaleX143da667 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineCheckoutSessionLocaleX143da667) {
