...
public sealed class InlineReviewObjectValueX3a6a0700 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineReviewObjectValueX3a6a0700 = when (value) {
      Review.value -> Review
      else -> SdkUnknown(value)
    }
  }

  internal object Serializer : KSerializer<InlineReviewObjectValueX3a6a0700> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineReviewObjectValueX3a6a0700", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineReviewObjectValueX3a6a0700 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineReviewObjectValueX3a6a0700) {
