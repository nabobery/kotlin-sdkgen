...
public class InlineV1AccountsBankAccountsPostRequestFormX8a64f5af(
  ...
  public class Builder {
    ...
    public fun build(): InlineV1AccountsBankAccountsPostRequestFormX8a64f5af = InlineV1AccountsBankAccountsPostRequestFormX8a64f5af(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1AccountsBankAccountsPostRequestFormX8a64f5af = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1AccountsBankAccountsPostRequestFormX8a64f5af> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1AccountsBankAccountsPostRequestFormX8a64f5af {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1AccountsBankAccountsPostRequestFormX8a64f5af must be a JSON object")
      return InlineV1AccountsBankAccountsPostRequestFormX8a64f5af(
        bankAccount = rawObject["bank_account"]?.let { json.decodeFromJsonElement<InlineV1AccountsBankAccountsPostRequestFormBankAccountX6b45297f>(it) },
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1AccountsBankAccountsPostRequestFormX8a64f5af) {
...
public fun inlineV1AccountsBankAccountsPostRequestFormX8a64f5af(block: InlineV1AccountsBankAccountsPostRequestFormX8a64f5af.Builder.() -> Unit): InlineV1AccountsBankAccountsPostRequestFormX8a64f5af = InlineV1AccountsBankAccountsPostRequestFormX8a64f5af.build(block)
