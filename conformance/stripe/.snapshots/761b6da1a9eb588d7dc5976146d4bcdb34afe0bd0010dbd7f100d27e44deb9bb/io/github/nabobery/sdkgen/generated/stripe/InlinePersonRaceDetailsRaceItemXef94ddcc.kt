 ...
 * sdkgen://source/openapi.json#/components/schemas/person_race_details/properties/race/items.
 *
 * Source: sdkgen://source/openapi.json#/components/schemas/person_race_details/properties/race/items
 */
@Serializable(with = InlinePersonRaceDetailsRaceItemXef94ddcc.Serializer::class)
public sealed class InlinePersonRaceDetailsRaceItemXef94ddcc {
  public abstract val `value`: String

  /**
   * Documented value. Wire value: `african_american`.
   */
  public data object AfricanAmerican : InlinePersonRaceDetailsRaceItemXef94ddcc() {
   ...
   */
  public data object AmericanIndianOrAlaskaNative : InlinePersonRaceDetailsRaceItemXef94ddcc() {
   ...
   */
  public data object Asian : InlinePersonRaceDetailsRaceItemXef94ddcc() {
   ...
   */
  public data object AsianIndian : InlinePersonRaceDetailsRaceItemXef94ddcc() {
   ...
   */
  public data object BlackOrAfricanAmerican : InlinePersonRaceDetailsRaceItemXef94ddcc() {
   ...
   */
  public data object Chinese : InlinePersonRaceDetailsRaceItemXef94ddcc() {
   ...
   */
  public data object Ethiopian : InlinePersonRaceDetailsRaceItemXef94ddcc() {
   ...
   */
  public data object Filipino : InlinePersonRaceDetailsRaceItemXef94ddcc() {
   ...
   */
  public data object GuamanianOrChamorro : InlinePersonRaceDetailsRaceItemXef94ddcc() {
   ...
   */
  public data object Haitian : InlinePersonRaceDetailsRaceItemXef94ddcc() {
   ...
   */
  public data object Jamaican : InlinePersonRaceDetailsRaceItemXef94ddcc() {
   ...
   */
  public data object Japanese : InlinePersonRaceDetailsRaceItemXef94ddcc() {
   ...
   */
  public data object Korean : InlinePersonRaceDetailsRaceItemXef94ddcc() {
   ...
   */
  public data object NativeHawaiian : InlinePersonRaceDetailsRaceItemXef94ddcc() {
   ...
   */
  public data object NativeHawaiianOrOtherPacificIslander : InlinePersonRaceDetailsRaceItemXef94ddcc() {
   ...
   */
  public data object Nigerian : InlinePersonRaceDetailsRaceItemXef94ddcc() {
   ...
   */
  public data object OtherAsian : InlinePersonRaceDetailsRaceItemXef94ddcc() {
   ...
   */
  public data object OtherBlackOrAfricanAmerican : InlinePersonRaceDetailsRaceItemXef94ddcc() {
   ...
   */
  public data object OtherPacificIslander : InlinePersonRaceDetailsRaceItemXef94ddcc() {
   ...
   */
  public data object PreferNotToAnswer : InlinePersonRaceDetailsRaceItemXef94ddcc() {
   ...
   */
  public data object Samoan : InlinePersonRaceDetailsRaceItemXef94ddcc() {
   ...
   */
  public data object Somali : InlinePersonRaceDetailsRaceItemXef94ddcc() {
   ...
   */
  public data object Vietnamese : InlinePersonRaceDetailsRaceItemXef94ddcc() {
   ...
   */
  public data object White : InlinePersonRaceDetailsRaceItemXef94ddcc() {
    public override val `value`: String = "white"
  }

  public data class SdkUnknown(
    public override val `value`: String,
  ) : InlinePersonRaceDetailsRaceItemXef94ddcc()

  public companion object {
    public fun fromValue(`value`: String): InlinePersonRaceDetailsRaceItemXef94ddcc = when (value) {
  ...
  internal object Serializer : KSerializer<InlinePersonRaceDetailsRaceItemXef94ddcc> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlinePersonRaceDetailsRaceItemXef94ddcc", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlinePersonRaceDetailsRaceItemXef94ddcc = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlinePersonRaceDetailsRaceItemXef94ddcc) {
