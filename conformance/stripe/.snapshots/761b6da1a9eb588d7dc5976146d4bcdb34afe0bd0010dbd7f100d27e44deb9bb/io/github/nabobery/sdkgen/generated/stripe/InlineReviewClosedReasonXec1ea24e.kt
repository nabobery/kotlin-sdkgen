...
public sealed class InlineReviewClosedReasonXec1ea24e {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineReviewClosedReasonXec1ea24e = when (value) {
  ...
  internal object Serializer : KSerializer<InlineReviewClosedReasonXec1ea24e> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineReviewClosedReasonXec1ea24e", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineReviewClosedReasonXec1ea24e = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineReviewClosedReasonXec1ea24e) {
