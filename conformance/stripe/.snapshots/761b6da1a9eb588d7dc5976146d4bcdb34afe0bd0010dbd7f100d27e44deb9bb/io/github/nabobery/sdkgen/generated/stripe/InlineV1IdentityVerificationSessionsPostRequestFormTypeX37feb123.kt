...
public sealed class InlineV1IdentityVerificationSessionsPostRequestFormTypeX37feb123 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1IdentityVerificationSessionsPostRequestFormTypeX37feb123 = when (value) {
  ...
  internal object Serializer : KSerializer<InlineV1IdentityVerificationSessionsPostRequestFormTypeX37feb123> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1IdentityVerificationSessionsPostRequestFormTypeX37feb123", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1IdentityVerificationSessionsPostRequestFormTypeX37feb123 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1IdentityVerificationSessionsPostRequestFormTypeX37feb123) {
