...
internal data class InlineV1ExternalAccountsPostRequestFormMetadataX1645c9f4Inspection(
  ...
  public val matchCount: Int
    get() = listOf(matchesBranch1, matchesInlineV1ExternalAccountsPostRequestFormMetadataAnyOf2X20678b44).count { it }
}
...
public class InlineV1ExternalAccountsPostRequestFormMetadataX1645c9f4 internal constructor(
  ...
  public val inlineV1ExternalAccountsPostRequestFormMetadataAnyOf2X20678b44:
      ...
      lazy(LazyThreadSafetyMode.NONE) { if (inspection.matchesInlineV1ExternalAccountsPostRequestFormMetadataAnyOf2X20678b44) json.decodeFromJsonElement<InlineV1ExternalAccountsPostRequestFormMetadataAnyOf2X20678b44>(raw) else null }

  public val matchedBranches: Set<InlineV1ExternalAccountsPostRequestFormMetadataX1645c9f4Branch>
    get() = buildSet {
      if (inspection.matchesBranch1) add(InlineV1ExternalAccountsPostRequestFormMetadataX1645c9f4Branch.Branch1)
      if (inspection.matchesInlineV1ExternalAccountsPostRequestFormMetadataAnyOf2X20678b44) add(InlineV1ExternalAccountsPostRequestFormMetadataX1645c9f4Branch.InlineV1ExternalAccountsPostRequestFormMetadataAnyOf2X20678b44)
    }
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineV1ExternalAccountsPostRequestFormMetadataX1645c9f4 {
      val inspection = inspectInlineV1ExternalAccountsPostRequestFormMetadataX1645c9f4(raw)
      if (inspection.matchCount == 0) {
        throw InlineV1ExternalAccountsPostRequestFormMetadataX1645c9f4NoMatchException("InlineV1ExternalAccountsPostRequestFormMetadataX1645c9f4 matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineV1ExternalAccountsPostRequestFormMetadataX1645c9f4(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineV1ExternalAccountsPostRequestFormMetadataX1645c9f4> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1ExternalAccountsPostRequestFormMetadataX1645c9f4) {
      encoder.requireJsonEncoder("InlineV1ExternalAccountsPostRequestFormMetadataX1645c9f4").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineV1ExternalAccountsPostRequestFormMetadataX1645c9f4(element: JsonElement): InlineV1ExternalAccountsPostRequestFormMetadataX1645c9f4Inspection {
  val matchesBranch1 = element.isJsonDecodable<JsonObject>()
  val matchesInlineV1ExternalAccountsPostRequestFormMetadataAnyOf2X20678b44 = element.isJsonDecodable<InlineV1ExternalAccountsPostRequestFormMetadataAnyOf2X20678b44>()
  return InlineV1ExternalAccountsPostRequestFormMetadataX1645c9f4Inspection(
    ...
    failures = buildList {
      ...
      if (!matchesInlineV1ExternalAccountsPostRequestFormMetadataAnyOf2X20678b44) add("InlineV1ExternalAccountsPostRequestFormMetadataAnyOf2X20678b44: value does not match InlineV1ExternalAccountsPostRequestFormMetadataAnyOf2X20678b44")
    },
  )
}
