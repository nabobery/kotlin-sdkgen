...
public sealed class InlineV1PaymentLinksPostRequestFormPaymentMethodCollectionXecd22be6 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1PaymentLinksPostRequestFormPaymentMethodCollectionXecd22be6 = when (value) {
      Always.value -> Always
  ...
  internal object Serializer : KSerializer<InlineV1PaymentLinksPostRequestFormPaymentMethodCollectionXecd22be6> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1PaymentLinksPostRequestFormPaymentMethodCollectionXecd22be6", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1PaymentLinksPostRequestFormPaymentMethodCollectionXecd22be6 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1PaymentLinksPostRequestFormPaymentMethodCollectionXecd22be6) {
