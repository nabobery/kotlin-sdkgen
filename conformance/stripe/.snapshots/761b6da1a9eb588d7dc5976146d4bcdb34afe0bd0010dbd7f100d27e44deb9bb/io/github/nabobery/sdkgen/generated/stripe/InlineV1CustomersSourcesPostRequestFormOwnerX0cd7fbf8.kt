...
public class InlineV1CustomersSourcesPostRequestFormOwnerX0cd7fbf8(
  ...
  public class Builder {
    ...
    public fun build(): InlineV1CustomersSourcesPostRequestFormOwnerX0cd7fbf8 = InlineV1CustomersSourcesPostRequestFormOwnerX0cd7fbf8(
      address = address,
      email = email,
      name = name,
      phone = phone,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1CustomersSourcesPostRequestFormOwnerX0cd7fbf8 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1CustomersSourcesPostRequestFormOwnerX0cd7fbf8> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1CustomersSourcesPostRequestFormOwnerX0cd7fbf8 {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1CustomersSourcesPostRequestFormOwnerX0cd7fbf8 must be a JSON object")
      return InlineV1CustomersSourcesPostRequestFormOwnerX0cd7fbf8(
        address = rawObject["address"]?.let { json.decodeFromJsonElement<InlineV1CustomersSourcesPostRequestFormOwnerAddressXcc4f7fc8>(it) },
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1CustomersSourcesPostRequestFormOwnerX0cd7fbf8) {
...
public fun inlineV1CustomersSourcesPostRequestFormOwnerX0cd7fbf8(block: InlineV1CustomersSourcesPostRequestFormOwnerX0cd7fbf8.Builder.() -> Unit): InlineV1CustomersSourcesPostRequestFormOwnerX0cd7fbf8 = InlineV1CustomersSourcesPostRequestFormOwnerX0cd7fbf8.build(block)
