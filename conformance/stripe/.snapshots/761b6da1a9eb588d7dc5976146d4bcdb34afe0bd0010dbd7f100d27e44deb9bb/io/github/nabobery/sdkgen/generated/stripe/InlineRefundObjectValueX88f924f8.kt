...
public sealed class InlineRefundObjectValueX88f924f8 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineRefundObjectValueX88f924f8 = when (value) {
      Refund.value -> Refund
      else -> SdkUnknown(value)
    }
  }

  internal object Serializer : KSerializer<InlineRefundObjectValueX88f924f8> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineRefundObjectValueX88f924f8", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineRefundObjectValueX88f924f8 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineRefundObjectValueX88f924f8) {
