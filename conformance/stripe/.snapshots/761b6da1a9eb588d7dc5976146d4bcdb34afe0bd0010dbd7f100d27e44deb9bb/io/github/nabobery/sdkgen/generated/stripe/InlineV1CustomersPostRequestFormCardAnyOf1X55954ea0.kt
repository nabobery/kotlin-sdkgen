 ...
 * ncoded/schema/properties/card/anyOf/0.
 *
 * Source:
 * sdkgen://source/openapi.json#/paths/~1v1~1customers~1{customer}/post/requestBody/content/application~1x-www-form-urle
 * ncoded/schema/properties/card/anyOf/0
 */
@Serializable(with = InlineV1CustomersPostRequestFormCardAnyOf1X55954ea0.Serializer::class)
public class InlineV1CustomersPostRequestFormCardAnyOf1X55954ea0(
  ...
  public val networkToken: InlineV1CustomersPostRequestFormCardAnyOf1NetworkTokenX65932f0a? = null,
  public val objectValue: InlineV1CustomersPostRequestFormCardAnyOf1ObjectValueX34af4e30? = null,
  ...
  public class Builder {
    ...
    public var networkToken: InlineV1CustomersPostRequestFormCardAnyOf1NetworkTokenX65932f0a? = null

    public var objectValue: InlineV1CustomersPostRequestFormCardAnyOf1ObjectValueX34af4e30? = null

    public var swipeData: String? = null

    public fun build(): InlineV1CustomersPostRequestFormCardAnyOf1X55954ea0 {
      ...
      return InlineV1CustomersPostRequestFormCardAnyOf1X55954ea0(
        expMonth = expMonth,
        expYear = expYear,
        number = number,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1CustomersPostRequestFormCardAnyOf1X55954ea0 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1CustomersPostRequestFormCardAnyOf1X55954ea0> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineV1CustomersPostRequestFormCardAnyOf1X55954ea0 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineV1CustomersPostRequestFormCardAnyOf1X55954ea0")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1CustomersPostRequestFormCardAnyOf1X55954ea0 must be a JSON object")
      ...
      return InlineV1CustomersPostRequestFormCardAnyOf1X55954ea0(
        ...
        networkToken = rawObject["network_token"]?.let { json.decodeFromJsonElement<InlineV1CustomersPostRequestFormCardAnyOf1NetworkTokenX65932f0a>(it) },
        objectValue = rawObject["object"]?.let { json.decodeFromJsonElement<InlineV1CustomersPostRequestFormCardAnyOf1ObjectValueX34af4e30>(it) },
        swipeData = rawObject["swipe_data"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineV1CustomersPostRequestFormCardAnyOf1X55954ea0) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineV1CustomersPostRequestFormCardAnyOf1X55954ea0")
...
public fun inlineV1CustomersPostRequestFormCardAnyOf1X55954ea0(block: InlineV1CustomersPostRequestFormCardAnyOf1X55954ea0.Builder.() -> Unit): InlineV1CustomersPostRequestFormCardAnyOf1X55954ea0 = InlineV1CustomersPostRequestFormCardAnyOf1X55954ea0.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineV1CustomersPostRequestFormCardAnyOf1X55954ea0 is missing required property '" + name + "'")
