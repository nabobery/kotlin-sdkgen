...
public class LegalEntityDob(
  ...
  public class Builder {
    ...
    public fun build(): LegalEntityDob = LegalEntityDob(
      day = day,
      month = month,
      year = year,
    )
  ...
  internal object Serializer : KSerializer<LegalEntityDob> {
    ...
    override fun deserialize(decoder: Decoder): LegalEntityDob {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("LegalEntityDob must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: LegalEntityDob) {
