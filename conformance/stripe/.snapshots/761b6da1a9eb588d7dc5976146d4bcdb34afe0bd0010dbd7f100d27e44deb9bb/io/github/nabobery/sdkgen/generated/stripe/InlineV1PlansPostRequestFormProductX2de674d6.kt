...
public class InlineV1PlansPostRequestFormProductX2de674d6 internal constructor(
  ...
  public val inlineV1PlansPostRequestFormProductAnyOf1X83e9ef31:
      ...
      lazy(LazyThreadSafetyMode.NONE) { if (inspection.matchesInlineV1PlansPostRequestFormProductAnyOf1X83e9ef31) json.decodeFromJsonElement<InlineV1PlansPostRequestFormProductAnyOf1X83e9ef31>(raw) else null }
  ...
  public val matchedBranches: Set<InlineV1PlansPostRequestFormProductX2de674d6Branch>
    get() = buildSet {
      if (inspection.matchesInlineV1PlansPostRequestFormProductAnyOf1X83e9ef31) add(InlineV1PlansPostRequestFormProductX2de674d6Branch.InlineV1PlansPostRequestFormProductAnyOf1X83e9ef31)
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineV1PlansPostRequestFormProductX2de674d6 {
      val inspection = inspectInlineV1PlansPostRequestFormProductX2de674d6(raw)
      if (inspection.matchCount == 0) {
        throw InlineV1PlansPostRequestFormProductX2de674d6NoMatchException("InlineV1PlansPostRequestFormProductX2de674d6 matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineV1PlansPostRequestFormProductX2de674d6(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineV1PlansPostRequestFormProductX2de674d6> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1PlansPostRequestFormProductX2de674d6) {
      encoder.requireJsonEncoder("InlineV1PlansPostRequestFormProductX2de674d6").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineV1PlansPostRequestFormProductX2de674d6(element: JsonElement): InlineV1PlansPostRequestFormProductX2de674d6Inspection {
  val matchesInlineV1PlansPostRequestFormProductAnyOf1X83e9ef31 = element.isJsonDecodable<InlineV1PlansPostRequestFormProductAnyOf1X83e9ef31>()
  ...
  return InlineV1PlansPostRequestFormProductX2de674d6Inspection(
    ...
    failures = buildList {
      if (!matchesInlineV1PlansPostRequestFormProductAnyOf1X83e9ef31) add("InlineV1PlansPostRequestFormProductAnyOf1X83e9ef31: value does not match InlineV1PlansPostRequestFormProductAnyOf1X83e9ef31")
