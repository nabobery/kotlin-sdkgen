...
public class TreasuryFinancialAccountsResourcePlatformRestrictions(
  ...
  public class Builder {
    ...
    public fun build(): TreasuryFinancialAccountsResourcePlatformRestrictions = TreasuryFinancialAccountsResourcePlatformRestrictions(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): TreasuryFinancialAccountsResourcePlatformRestrictions = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<TreasuryFinancialAccountsResourcePlatformRestrictions> {
    ...
    override fun deserialize(decoder: Decoder): TreasuryFinancialAccountsResourcePlatformRestrictions {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("TreasuryFinancialAccountsResourcePlatformRestrictions must be a JSON object")
      return TreasuryFinancialAccountsResourcePlatformRestrictions(
        inboundFlows = rawObject["inbound_flows"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineTreasuryFinancialAccountsResourcePlatformRestrictionsInboundFlowsX22f182d6?>(element) },
        outboundFlows = rawObject["outbound_flows"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineTreasuryFinancialAccf105OutboundFlowsX187438a4?>(element) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: TreasuryFinancialAccountsResourcePlatformRestrictions) {
...
public fun treasuryFinancialAccountsResourcePlatformRestrictions(block: TreasuryFinancialAccountsResourcePlatformRestrictions.Builder.() -> Unit): TreasuryFinancialAccountsResourcePlatformRestrictions = TreasuryFinancialAccountsResourcePlatformRestrictions.build(block)
