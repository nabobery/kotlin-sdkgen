...
public class InlineV1CreditNotesPostRequestFormXc40c1d58(
  ...
  lines: List<InlineV1CreditNotesPostRequestFormLinesItemX77ab601b>? = null,
  /**
  ...
  refunds: List<InlineV1CreditNotesPostRequestFormRefundsItemX1217bf2d>? = null,
  /**
   ...
   */
  public val lines: List<InlineV1CreditNotesPostRequestFormLinesItemX77ab601b>? =
      lines?.let { collection0 -> collection0.toList() }
   ...
   */
  public val refunds: List<InlineV1CreditNotesPostRequestFormRefundsItemX1217bf2d>? =
      refunds?.let { collection0 -> collection0.toList() }
  ...
  public class Builder {
    ...
    private var linesValue: List<InlineV1CreditNotesPostRequestFormLinesItemX77ab601b>? = null

    /**
     * Line items that make up the credit note. One of `amount`, `lines`, or `shipping_cost` must be provided.
     */
    public var lines: List<InlineV1CreditNotesPostRequestFormLinesItemX77ab601b>?
      get() = linesValue?.let { collection0 -> collection0.toList() }
      set(`value`) {
        linesValue = value?.let { collection0 -> collection0.toList() }
      }
    ...
    private var refundsValue: List<InlineV1CreditNotesPostRequestFormRefundsItemX1217bf2d>? = null

    /**
     * Refunds to link to this credit note.
     */
    public var refunds: List<InlineV1CreditNotesPostRequestFormRefundsItemX1217bf2d>?
      get() = refundsValue?.let { collection0 -> collection0.toList() }
      set(`value`) {
        refundsValue = value?.let { collection0 -> collection0.toList() }
      }
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1CreditNotesPostRequestFormXc40c1d58 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1CreditNotesPostRequestFormXc40c1d58> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1CreditNotesPostRequestFormXc40c1d58 {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1CreditNotesPostRequestFormXc40c1d58 must be a JSON object")
      ...
      return InlineV1CreditNotesPostRequestFormXc40c1d58(
        ...
        emailType = rawObject["email_type"]?.let { json.decodeFromJsonElement<InlineV1CreditNotesPostRequestFormEmailTypeX85727b78>(it) },
        expand = rawObject["expand"]?.let { json.decodeFromJsonElement<List<String>>(it) },
        lines = rawObject["lines"]?.let { json.decodeFromJsonElement<List<InlineV1CreditNotesPostRequestFormLinesItemX77ab601b>>(it) },
        ...
        reason = rawObject["reason"]?.let { json.decodeFromJsonElement<InlineV1CreditNotesPostRequestFormReasonX90841925>(it) },
        refundAmount = rawObject["refund_amount"]?.let { json.decodeFromJsonElement<Int>(it) },
        refunds = rawObject["refunds"]?.let { json.decodeFromJsonElement<List<InlineV1CreditNotesPostRequestFormRefundsItemX1217bf2d>>(it) },
        shippingCost = rawObject["shipping_cost"]?.let { json.decodeFromJsonElement<InlineV1CreditNotesPostRequestFormShippingCostX8cdba8f5>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineV1CreditNotesPostRequestFormXc40c1d58) {
...
public fun inlineV1CreditNotesPostRequestFormXc40c1d58(block: InlineV1CreditNotesPostRequestFormXc40c1d58.Builder.() -> Unit): InlineV1CreditNotesPostRequestFormXc40c1d58 = InlineV1CreditNotesPostRequestFormXc40c1d58.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineV1CreditNotesPostRequestFormXc40c1d58 is missing required property '" + name + "'")
