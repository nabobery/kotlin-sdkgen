...
public class InlineSubscriptionSchedulePhaseConfigurationOnBehalfOfX2e679968 internal constructor(
  ...
  public val matchedBranches:
    ...
    get() = buildSet {
      if (inspection.matchesBranch1) add(InlineSubscriptionSchedulePhaseConfigurationOnBehalfOfX2e679968Branch.Branch1)
      if (inspection.matchesAccount) add(InlineSubscriptionSchedulePhaseConfigurationOnBehalfOfX2e679968Branch.Account)
    }
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineSubscriptionSchedulePhaseConfigurationOnBehalfOfX2e679968 {
      val inspection = inspectInlineSubscriptionSchedulePhaseConfigurationOnBehalfOfX2e679968(raw)
      if (inspection.matchCount == 0) {
        throw InlineSubscriptionSchedulePhaseConfigurationOnBehalfOfX2e679968NoMatchException("InlineSubscriptionSchedulePhaseConfigurationOnBehalfOfX2e679968 matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineSubscriptionSchedulePhaseConfigurationOnBehalfOfX2e679968(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineSubscriptionSchedulePhaseConfigurationOnBehalfOfX2e679968> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineSubscriptionSchedulePhaseConfigurationOnBehalfOfX2e679968 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineSubscriptionSchedulePhaseConfigurationOnBehalfOfX2e679968")
      return fromRaw(jsonDecoder.decodeJsonElement(), jsonDecoder.json)
    }

    override fun serialize(encoder: Encoder, `value`: InlineSubscriptionSchedulePhaseConfigurationOnBehalfOfX2e679968) {
      encoder.requireJsonEncoder("InlineSubscriptionSchedulePhaseConfigurationOnBehalfOfX2e679968").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineSubscriptionSchedulePhaseConfigurationOnBehalfOfX2e679968(element: JsonElement): InlineSubscriptionSchedulePhaseConfigurationOnBehalfOfX2e679968Inspection {
