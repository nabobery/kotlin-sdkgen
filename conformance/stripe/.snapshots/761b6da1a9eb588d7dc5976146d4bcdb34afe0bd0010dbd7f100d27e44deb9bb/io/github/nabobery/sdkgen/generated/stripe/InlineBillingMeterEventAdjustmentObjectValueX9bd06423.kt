...
public sealed class InlineBillingMeterEventAdjustmentObjectValueX9bd06423 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineBillingMeterEventAdjustmentObjectValueX9bd06423 = when (value) {
      BillingMeterEventAdjustment.value -> BillingMeterEventAdjustment
      else -> SdkUnknown(value)
    }
  }

  internal object Serializer : KSerializer<InlineBillingMeterEventAdjustmentObjectValueX9bd06423> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineBillingMeterEventAdjustmentObjectValueX9bd06423", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineBillingMeterEventAdjustmentObjectValueX9bd06423 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineBillingMeterEventAdjustmentObjectValueX9bd06423) {
