...
public class PaymentIntentNextActionPixDisplayQrCode(
  ...
  public class Builder {
    ...
    public fun build(): PaymentIntentNextActionPixDisplayQrCode = PaymentIntentNextActionPixDisplayQrCode(
      data = data,
      expiresAt = expiresAt,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): PaymentIntentNextActionPixDisplayQrCode = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<PaymentIntentNextActionPixDisplayQrCode> {
    ...
    override fun deserialize(decoder: Decoder): PaymentIntentNextActionPixDisplayQrCode {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("PaymentIntentNextActionPixDisplayQrCode must be a JSON object")
      return PaymentIntentNextActionPixDisplayQrCode(
        ...
        hostedInstructionsUrl = rawObject["hosted_instructions_url"]?.let { json.decodeFromJsonElement<String>(it) },
    ...
    override fun serialize(encoder: Encoder, `value`: PaymentIntentNextActionPixDisplayQrCode) {
...
public fun paymentIntentNextActionPixDisplayQrCode(block: PaymentIntentNextActionPixDisplayQrCode.Builder.() -> Unit): PaymentIntentNextActionPixDisplayQrCode = PaymentIntentNextActionPixDisplayQrCode.build(block)
