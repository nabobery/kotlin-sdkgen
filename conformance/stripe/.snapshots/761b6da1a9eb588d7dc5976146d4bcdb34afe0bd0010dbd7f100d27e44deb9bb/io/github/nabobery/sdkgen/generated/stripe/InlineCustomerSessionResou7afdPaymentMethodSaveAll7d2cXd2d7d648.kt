...
public sealed class InlineCustomerSessionResou7afdPaymentMethodSaveAll7d2cXd2d7d648 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineCustomerSessionResou7afdPaymentMethodSaveAll7d2cXd2d7d648 = when (value) {
      Always.value -> Always
  ...
  internal object Serializer : KSerializer<InlineCustomerSessionResou7afdPaymentMethodSaveAll7d2cXd2d7d648> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineCustomerSessionResou7afdPaymentMethodSaveAll7d2cXd2d7d648", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineCustomerSessionResou7afdPaymentMethodSaveAll7d2cXd2d7d648 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineCustomerSessionResou7afdPaymentMethodSaveAll7d2cXd2d7d648) {
