...
public sealed class InlineV1PricesPostRequestFormBillingSchemeX67bff49a {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1PricesPostRequestFormBillingSchemeX67bff49a = when (value) {
  ...
  internal object Serializer : KSerializer<InlineV1PricesPostRequestFormBillingSchemeX67bff49a> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1PricesPostRequestFormBillingSchemeX67bff49a", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1PricesPostRequestFormBillingSchemeX67bff49a = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1PricesPostRequestFormBillingSchemeX67bff49a) {
