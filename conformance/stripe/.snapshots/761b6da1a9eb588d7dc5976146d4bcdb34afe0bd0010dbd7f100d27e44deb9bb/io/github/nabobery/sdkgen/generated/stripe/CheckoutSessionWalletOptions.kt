...
public class CheckoutSessionWalletOptions(
  ...
  public class Builder {
    ...
    public fun build(): CheckoutSessionWalletOptions = CheckoutSessionWalletOptions(
      link = link,
    )
  }
  ...
  internal object Serializer : KSerializer<CheckoutSessionWalletOptions> {
    ...
    override fun deserialize(decoder: Decoder): CheckoutSessionWalletOptions {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("CheckoutSessionWalletOptions must be a JSON object")
      return CheckoutSessionWalletOptions(
        link = rawObject["link"]?.let { json.decodeFromJsonElement<CheckoutLinkWalletOptions>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: CheckoutSessionWalletOptions) {
...
public fun checkoutSessionWalletOptions(block: CheckoutSessionWalletOptions.Builder.() -> Unit): CheckoutSessionWalletOptions = CheckoutSessionWalletOptions.build(block)
