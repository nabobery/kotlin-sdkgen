...
public class InlineV1CustomersBankAccountsVerifyPostRequestFormXec8066db(
  ...
  public class Builder {
    ...
    public fun build(): InlineV1CustomersBankAccountsVerifyPostRequestFormXec8066db = InlineV1CustomersBankAccountsVerifyPostRequestFormXec8066db(
      amounts = amounts,
      expand = expand,
    )
  }
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1CustomersBankAccountsVerifyPostRequestFormXec8066db = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1CustomersBankAccountsVerifyPostRequestFormXec8066db> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1CustomersBankAccountsVerifyPostRequestFormXec8066db {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1CustomersBankAccountsVerifyPostRequestFormXec8066db must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1CustomersBankAccountsVerifyPostRequestFormXec8066db) {
...
public fun inlineV1CustomersBankAccountsVerifyPostRequestFormXec8066db(block: InlineV1CustomersBankAccountsVerifyPostRequestFormXec8066db.Builder.() -> Unit): InlineV1CustomersBankAccountsVerifyPostRequestFormXec8066db = InlineV1CustomersBankAccountsVerifyPostRequestFormXec8066db.build(block)
