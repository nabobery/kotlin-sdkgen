...
public class InlineV1QuotesPostRequestFormInvoiceSettingsX5c5f38e8(
  ...
  public class Builder {
    ...
    public fun build(): InlineV1QuotesPostRequestFormInvoiceSettingsX5c5f38e8 = InlineV1QuotesPostRequestFormInvoiceSettingsX5c5f38e8(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1QuotesPostRequestFormInvoiceSettingsX5c5f38e8 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1QuotesPostRequestFormInvoiceSettingsX5c5f38e8> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1QuotesPostRequestFormInvoiceSettingsX5c5f38e8 {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1QuotesPostRequestFormInvoiceSettingsX5c5f38e8 must be a JSON object")
      return InlineV1QuotesPostRequestFormInvoiceSettingsX5c5f38e8(
        ...
        issuer = rawObject["issuer"]?.let { json.decodeFromJsonElement<InlineV1QuotesPostRequestFormInvoiceSettingsIssuerX644e86c0>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineV1QuotesPostRequestFormInvoiceSettingsX5c5f38e8) {
...
public fun inlineV1QuotesPostRequestFormInvoiceSettingsX5c5f38e8(block: InlineV1QuotesPostRequestFormInvoiceSettingsX5c5f38e8.Builder.() -> Unit): InlineV1QuotesPostRequestFormInvoiceSettingsX5c5f38e8 = InlineV1QuotesPostRequestFormInvoiceSettingsX5c5f38e8.build(block)
