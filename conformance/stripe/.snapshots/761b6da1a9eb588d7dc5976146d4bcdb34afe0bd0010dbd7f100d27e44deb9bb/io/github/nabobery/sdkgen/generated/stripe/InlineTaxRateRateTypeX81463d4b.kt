...
public sealed class InlineTaxRateRateTypeX81463d4b {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineTaxRateRateTypeX81463d4b = when (value) {
  ...
  internal object Serializer : KSerializer<InlineTaxRateRateTypeX81463d4b> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineTaxRateRateTypeX81463d4b", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineTaxRateRateTypeX81463d4b = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineTaxRateRateTypeX81463d4b) {
