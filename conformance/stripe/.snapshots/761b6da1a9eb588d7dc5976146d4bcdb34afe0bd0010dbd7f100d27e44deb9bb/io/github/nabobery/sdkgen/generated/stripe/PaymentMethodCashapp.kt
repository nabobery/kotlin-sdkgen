...
public class PaymentMethodCashapp(
  ...
  public class Builder {
    ...
    public fun build(): PaymentMethodCashapp = PaymentMethodCashapp(
      buyerId = buyerId,
      cashtag = cashtag,
    )
  }
  ...
  internal object Serializer : KSerializer<PaymentMethodCashapp> {
    ...
    override fun deserialize(decoder: Decoder): PaymentMethodCashapp {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("PaymentMethodCashapp must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: PaymentMethodCashapp) {
...
public fun paymentMethodCashapp(block: PaymentMethodCashapp.Builder.() -> Unit): PaymentMethodCashapp = PaymentMethodCashapp.build(block)
