...
public class InlineV1TokensPostRequestFormCvcUpdateX5188265b(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1TokensPostRequestFormCvcUpdateX5188265b = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1TokensPostRequestFormCvcUpdateX5188265b> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1TokensPostRequestFormCvcUpdateX5188265b {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1TokensPostRequestFormCvcUpdateX5188265b must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1TokensPostRequestFormCvcUpdateX5188265b) {
...
public fun inlineV1TokensPostRequestFormCvcUpdateX5188265b(block: InlineV1TokensPostRequestFormCvcUpdateX5188265b.Builder.() -> Unit): InlineV1TokensPostRequestFormCvcUpdateX5188265b = InlineV1TokensPostRequestFormCvcUpdateX5188265b.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineV1TokensPostRequestFormCvcUpdateX5188265b is missing required property '" + name + "'")
