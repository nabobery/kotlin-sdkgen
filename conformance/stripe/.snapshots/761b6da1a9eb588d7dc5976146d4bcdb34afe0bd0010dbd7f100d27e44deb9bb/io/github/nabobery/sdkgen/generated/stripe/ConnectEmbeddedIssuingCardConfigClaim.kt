...
public class ConnectEmbeddedIssuingCardConfigClaim(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): ConnectEmbeddedIssuingCardConfigClaim = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<ConnectEmbeddedIssuingCardConfigClaim> {
    ...
    override fun deserialize(decoder: Decoder): ConnectEmbeddedIssuingCardConfigClaim {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("ConnectEmbeddedIssuingCardConfigClaim must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: ConnectEmbeddedIssuingCardConfigClaim) {
...
public fun connectEmbeddedIssuingCardConfigClaim(block: ConnectEmbeddedIssuingCardConfigClaim.Builder.() -> Unit): ConnectEmbeddedIssuingCardConfigClaim = ConnectEmbeddedIssuingCardConfigClaim.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("ConnectEmbeddedIssuingCardConfigClaim is missing required property '" + name + "'")
