...
public sealed class InlineV1SubscriptionsPostRequestFormSaveDefaultPaymentMethodXa7be33b3 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1SubscriptionsPostRequestFormSaveDefaultPaymentMethodXa7be33b3 = when (value) {
      Off.value -> Off
  ...
  internal object Serializer : KSerializer<InlineV1SubscriptionsPostRequestFormSaveDefaultPaymentMethodXa7be33b3> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1SubscriptionsPostRequestFormSaveDefaultPaymentMethodXa7be33b3", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1SubscriptionsPostRequestFormSaveDefaultPaymentMethodXa7be33b3 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1SubscriptionsPostRequestFormSaveDefaultPaymentMethodXa7be33b3) {
