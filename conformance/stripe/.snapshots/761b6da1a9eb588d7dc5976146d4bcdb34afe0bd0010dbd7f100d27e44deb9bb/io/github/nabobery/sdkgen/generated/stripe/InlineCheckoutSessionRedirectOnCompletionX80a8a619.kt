...
public sealed class InlineCheckoutSessionRedirectOnCompletionX80a8a619 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineCheckoutSessionRedirectOnCompletionX80a8a619 = when (value) {
      Always.value -> Always
  ...
  internal object Serializer : KSerializer<InlineCheckoutSessionRedirectOnCompletionX80a8a619> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineCheckoutSessionRedirectOnCompletionX80a8a619", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineCheckoutSessionRedirectOnCompletionX80a8a619 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineCheckoutSessionRedirectOnCompletionX80a8a619) {
