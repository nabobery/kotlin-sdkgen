...
public sealed class InlinePaymentMethodOptionsCustomerBalanceBankTransferTypeX8f1d2f26 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlinePaymentMethodOptionsCustomerBalanceBankTransferTypeX8f1d2f26 = when (value) {
  ...
  internal object Serializer : KSerializer<InlinePaymentMethodOptionsCustomerBalanceBankTransferTypeX8f1d2f26> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlinePaymentMethodOptionsCustomerBalanceBankTransferTypeX8f1d2f26", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlinePaymentMethodOptionsCustomerBalanceBankTransferTypeX8f1d2f26 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlinePaymentMethodOptionsCustomerBalanceBankTransferTypeX8f1d2f26) {
