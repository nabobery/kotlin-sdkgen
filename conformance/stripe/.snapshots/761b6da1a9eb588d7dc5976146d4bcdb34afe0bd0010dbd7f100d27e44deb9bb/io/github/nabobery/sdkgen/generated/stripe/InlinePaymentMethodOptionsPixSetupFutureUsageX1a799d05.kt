...
public sealed class InlinePaymentMethodOptionsPixSetupFutureUsageX1a799d05 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlinePaymentMethodOptionsPixSetupFutureUsageX1a799d05 = when (value) {
      None.value -> None
  ...
  internal object Serializer : KSerializer<InlinePaymentMethodOptionsPixSetupFutureUsageX1a799d05> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlinePaymentMethodOptionsPixSetupFutureUsageX1a799d05", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlinePaymentMethodOptionsPixSetupFutureUsageX1a799d05 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlinePaymentMethodOptionsPixSetupFutureUsageX1a799d05) {
