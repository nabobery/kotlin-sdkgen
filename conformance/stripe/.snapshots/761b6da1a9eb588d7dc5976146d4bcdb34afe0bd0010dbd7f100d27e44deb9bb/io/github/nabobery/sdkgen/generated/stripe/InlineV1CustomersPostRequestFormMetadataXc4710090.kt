...
public class InlineV1CustomersPostRequestFormMetadataXc4710090 internal constructor(
  ...
  public val inlineV1CustomersPostRequestFormMetadataAnyOf2Xd3025eaa:
      ...
      lazy(LazyThreadSafetyMode.NONE) { if (inspection.matchesInlineV1CustomersPostRequestFormMetadataAnyOf2Xd3025eaa) json.decodeFromJsonElement<InlineV1CustomersPostRequestFormMetadataAnyOf2Xd3025eaa>(raw) else null }
  ...
  public val matchedBranches: Set<InlineV1CustomersPostRequestFormMetadataXc4710090Branch>
    get() = buildSet {
      ...
      if (inspection.matchesInlineV1CustomersPostRequestFormMetadataAnyOf2Xd3025eaa) add(InlineV1CustomersPostRequestFormMetadataXc4710090Branch.InlineV1CustomersPostRequestFormMetadataAnyOf2Xd3025eaa)
    }
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineV1CustomersPostRequestFormMetadataXc4710090 {
      val inspection = inspectInlineV1CustomersPostRequestFormMetadataXc4710090(raw)
      if (inspection.matchCount == 0) {
        throw InlineV1CustomersPostRequestFormMetadataXc4710090NoMatchException("InlineV1CustomersPostRequestFormMetadataXc4710090 matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineV1CustomersPostRequestFormMetadataXc4710090(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineV1CustomersPostRequestFormMetadataXc4710090> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1CustomersPostRequestFormMetadataXc4710090) {
      encoder.requireJsonEncoder("InlineV1CustomersPostRequestFormMetadataXc4710090").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineV1CustomersPostRequestFormMetadataXc4710090(element: JsonElement): InlineV1CustomersPostRequestFormMetadataXc4710090Inspection {
  val matchesBranch1 = element.isJsonDecodable<JsonObject>()
  val matchesInlineV1CustomersPostRequestFormMetadataAnyOf2Xd3025eaa = element.isJsonDecodable<InlineV1CustomersPostRequestFormMetadataAnyOf2Xd3025eaa>()
  return InlineV1CustomersPostRequestFormMetadataXc4710090Inspection(
    ...
    failures = buildList {
      ...
      if (!matchesInlineV1CustomersPostRequestFormMetadataAnyOf2Xd3025eaa) add("InlineV1CustomersPostRequestFormMetadataAnyOf2Xd3025eaa: value does not match InlineV1CustomersPostRequestFormMetadataAnyOf2Xd3025eaa")
    },
  )
}
