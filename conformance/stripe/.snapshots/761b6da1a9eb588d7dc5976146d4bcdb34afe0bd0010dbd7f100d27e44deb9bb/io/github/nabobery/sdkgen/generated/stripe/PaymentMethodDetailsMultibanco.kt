...
public class PaymentMethodDetailsMultibanco(
  ...
  public class Builder {
    ...
    public fun build(): PaymentMethodDetailsMultibanco = PaymentMethodDetailsMultibanco(
      entity = entity,
      reference = reference,
    )
  }
  ...
  internal object Serializer : KSerializer<PaymentMethodDetailsMultibanco> {
    ...
    override fun deserialize(decoder: Decoder): PaymentMethodDetailsMultibanco {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("PaymentMethodDetailsMultibanco must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: PaymentMethodDetailsMultibanco) {
...
public fun paymentMethodDetailsMultibanco(block: PaymentMethodDetailsMultibanco.Builder.() -> Unit): PaymentMethodDetailsMultibanco = PaymentMethodDetailsMultibanco.build(block)
