...
public class DeletedInvoiceitem(
  ...
  internal object Serializer : KSerializer<DeletedInvoiceitem> {
    ...
    override fun deserialize(decoder: Decoder): DeletedInvoiceitem {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("DeletedInvoiceitem must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: DeletedInvoiceitem) {
...
public fun deletedInvoiceitem(block: DeletedInvoiceitem.Builder.() -> Unit): DeletedInvoiceitem = DeletedInvoiceitem.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("DeletedInvoiceitem is missing required property '" + name + "'")
