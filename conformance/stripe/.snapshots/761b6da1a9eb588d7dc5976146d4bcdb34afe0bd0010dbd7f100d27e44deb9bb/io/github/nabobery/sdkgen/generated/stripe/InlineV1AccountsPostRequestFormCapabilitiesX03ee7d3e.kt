...
public class InlineV1AccountsPostRequestFormCapabilitiesX03ee7d3e(
  public val acssDebitPayments:
      InlineV1AccountsPostRequestFormCapabilitiesAcssDebitPaymentsX1623dcc7? = null,
  public val affirmPayments:
      InlineV1AccountsPostRequestFormCapabilitiesAffirmPaymentsX256980be? = null,
  ...
  public val amazonPayPayments:
      InlineV1AccountsPostRequestFormCapabilitiesAmazonPayPaymentsX6a456fef? = null,
  public val appDistribution:
      InlineV1AccountsPostRequestFormCapabilitiesAppDistributionXaa377c88? = null,
  public val auBecsDebitPayments:
  ...
  public val bancontactPayments:
      InlineV1AccountsPostRequestFormCapabilitiesBancontactPaymentsX11889117? = null,
  public val bankTransferPayments:
      InlineV1AccountsPostRequestFormCapabilitiesBankTransferPaymentsX027f0dd0? = null,
  public val billiePayments:
      InlineV1AccountsPostRequestFormCapabilitiesBilliePaymentsXc8d22aa1? = null,
  public val bizumPayments:
      InlineV1AccountsPostRequestFormCapabilitiesBizumPaymentsXc415cc4e? = null,
  public val blikPayments: InlineV1AccountsPostRequestFormCapabilitiesBlikPaymentsXf5ff89c6? = null,
  public val boletoPayments:
      InlineV1AccountsPostRequestFormCapabilitiesBoletoPaymentsX9c195d50? = null,
  ...
  public val cashappPayments:
      InlineV1AccountsPostRequestFormCapabilitiesCashappPaymentsXe9ac134b? = null,
  public val cryptoPayments:
      InlineV1AccountsPostRequestFormCapabilitiesCryptoPaymentsXb04ff1ec? = null,
  ...
  public val giropayPayments:
      InlineV1AccountsPostRequestFormCapabilitiesGiropayPaymentsXe077bd0c? = null,
  public val grabpayPayments:
      InlineV1AccountsPostRequestFormCapabilitiesGrabpayPaymentsXa7bd7322? = null,
  public val idealPayments:
      InlineV1AccountsPostRequestFormCapabilitiesIdealPaymentsXf829ce96? = null,
  ...
  public val kakaoPayPayments:
      InlineV1AccountsPostRequestFormCapabilitiesKakaoPayPaymentsX931b29ff? = null,
  public val klarnaPayments:
      InlineV1AccountsPostRequestFormCapabilitiesKlarnaPaymentsX57189c5d? = null,
  public val konbiniPayments:
      InlineV1AccountsPostRequestFormCapabilitiesKonbiniPaymentsX8f4f3073? = null,
  public val krCardPayments:
      InlineV1AccountsPostRequestFormCapabilitiesKrCardPaymentsX1f7e1459? = null,
  public val legacyPayments:
      InlineV1AccountsPostRequestFormCapabilitiesLegacyPaymentsX3e15fde5? = null,
  public val linkPayments: InlineV1AccountsPostRequestFormCapabilitiesLinkPaymentsXac4496f7? = null,
  public val mbWayPayments:
      InlineV1AccountsPostRequestFormCapabilitiesMbWayPaymentsX7d3d1b0c? = null,
  public val mobilepayPayments:
      InlineV1AccountsPostRequestFormCapabilitiesMobilepayPaymentsX20f65018? = null,
  public val multibancoPayments:
  ...
  public val sepaDebitPayments:
      InlineV1AccountsPostRequestFormCapabilitiesSepaDebitPaymentsXa1e24efa? = null,
  public val sofortPayments:
      InlineV1AccountsPostRequestFormCapabilitiesSofortPaymentsXf6bccc49? = null,
  public val sunbitPayments:
      InlineV1AccountsPostRequestFormCapabilitiesSunbitPaymentsXbc81da38? = null,
  public val swishPayments:
      InlineV1AccountsPostRequestFormCapabilitiesSwishPaymentsX86405c81? = null,
  public val taxReportingUs1099K:
  ...
  public val twintPayments:
      InlineV1AccountsPostRequestFormCapabilitiesTwintPaymentsX74d459fc? = null,
  ...
  public class Builder {
    ...
    public fun build(): InlineV1AccountsPostRequestFormCapabilitiesX03ee7d3e = InlineV1AccountsPostRequestFormCapabilitiesX03ee7d3e(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1AccountsPostRequestFormCapabilitiesX03ee7d3e = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1AccountsPostRequestFormCapabilitiesX03ee7d3e> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1AccountsPostRequestFormCapabilitiesX03ee7d3e {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1AccountsPostRequestFormCapabilitiesX03ee7d3e must be a JSON object")
      return InlineV1AccountsPostRequestFormCapabilitiesX03ee7d3e(
        acssDebitPayments = rawObject["acss_debit_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesAcssDebitPaymentsX1623dcc7>(it) },
        affirmPayments = rawObject["affirm_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesAffirmPaymentsX256980be>(it) },
        afterpayClearpayPayments = rawObject["afterpay_clearpay_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesAfterpayClearpayPaymentsX4d3b7da9>(it) },
        almaPayments = rawObject["alma_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesAlmaPaymentsXe1c3036b>(it) },
        amazonPayPayments = rawObject["amazon_pay_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesAmazonPayPaymentsX6a456fef>(it) },
        appDistribution = rawObject["app_distribution"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesAppDistributionXaa377c88>(it) },
        auBecsDebitPayments = rawObject["au_becs_debit_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesAuBecsDebitPaymentsXe165e30c>(it) },
        bacsDebitPayments = rawObject["bacs_debit_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesBacsDebitPaymentsXe246c980>(it) },
        bancontactPayments = rawObject["bancontact_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesBancontactPaymentsX11889117>(it) },
        bankTransferPayments = rawObject["bank_transfer_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesBankTransferPaymentsX027f0dd0>(it) },
        billiePayments = rawObject["billie_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesBilliePaymentsXc8d22aa1>(it) },
        bizumPayments = rawObject["bizum_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesBizumPaymentsXc415cc4e>(it) },
        blikPayments = rawObject["blik_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesBlikPaymentsXf5ff89c6>(it) },
        boletoPayments = rawObject["boleto_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesBoletoPaymentsX9c195d50>(it) },
        cardIssuing = rawObject["card_issuing"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesCardIssuingX9be954ad>(it) },
        cardPayments = rawObject["card_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesCardPaymentsX561aec6f>(it) },
        cartesBancairesPayments = rawObject["cartes_bancaires_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesCartesBancairesPaymentsX03f2b845>(it) },
        cashappPayments = rawObject["cashapp_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesCashappPaymentsXe9ac134b>(it) },
        cryptoPayments = rawObject["crypto_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesCryptoPaymentsXb04ff1ec>(it) },
        epsPayments = rawObject["eps_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesEpsPaymentsX9760b813>(it) },
        fpxPayments = rawObject["fpx_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesFpxPaymentsX92cd28b3>(it) },
        gbBankTransferPayments = rawObject["gb_bank_transfer_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesGbBankTransferPaymentsX380fc838>(it) },
        giropayPayments = rawObject["giropay_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesGiropayPaymentsXe077bd0c>(it) },
        grabpayPayments = rawObject["grabpay_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesGrabpayPaymentsXa7bd7322>(it) },
        idealPayments = rawObject["ideal_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesIdealPaymentsXf829ce96>(it) },
        indiaInternationalPayments = rawObject["india_international_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesIndiaInternationalPaymentsX83525930>(it) },
        jcbPayments = rawObject["jcb_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesJcbPaymentsX9c20d6d4>(it) },
        jpBankTransferPayments = rawObject["jp_bank_transfer_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesJpBankTransferPaymentsX43dcebec>(it) },
        kakaoPayPayments = rawObject["kakao_pay_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesKakaoPayPaymentsX931b29ff>(it) },
        klarnaPayments = rawObject["klarna_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesKlarnaPaymentsX57189c5d>(it) },
        konbiniPayments = rawObject["konbini_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesKonbiniPaymentsX8f4f3073>(it) },
        krCardPayments = rawObject["kr_card_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesKrCardPaymentsX1f7e1459>(it) },
        legacyPayments = rawObject["legacy_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesLegacyPaymentsX3e15fde5>(it) },
        linkPayments = rawObject["link_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesLinkPaymentsXac4496f7>(it) },
        mbWayPayments = rawObject["mb_way_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesMbWayPaymentsX7d3d1b0c>(it) },
        mobilepayPayments = rawObject["mobilepay_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesMobilepayPaymentsX20f65018>(it) },
        multibancoPayments = rawObject["multibanco_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesMultibancoPaymentsX1beb7b56>(it) },
        mxBankTransferPayments = rawObject["mx_bank_transfer_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesMxBankTransferPaymentsX800e261d>(it) },
        naverPayPayments = rawObject["naver_pay_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesNaverPayPaymentsXd105c462>(it) },
        nzBankAccountBecsDebitPayments = rawObject["nz_bank_account_becs_debit_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesNzBankAccountBecsDebf2d0X4eac2b86>(it) },
        oxxoPayments = rawObject["oxxo_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesOxxoPaymentsX9a18bb6d>(it) },
        p24Payments = rawObject["p24_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesP24PaymentsX411bec04>(it) },
        payByBankPayments = rawObject["pay_by_bank_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesPayByBankPaymentsX90952dc5>(it) },
        paycoPayments = rawObject["payco_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesPaycoPaymentsXe5fc30d5>(it) },
        paynowPayments = rawObject["paynow_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesPaynowPaymentsX6fd2d9b9>(it) },
        paytoPayments = rawObject["payto_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesPaytoPaymentsXb34d8313>(it) },
        pixPayments = rawObject["pix_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesPixPaymentsX8ed85769>(it) },
        promptpayPayments = rawObject["promptpay_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesPromptpayPaymentsXbc3069f4>(it) },
        revolutPayPayments = rawObject["revolut_pay_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesRevolutPayPaymentsX967c2872>(it) },
        samsungPayPayments = rawObject["samsung_pay_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesSamsungPayPaymentsX2d08369f>(it) },
        satispayPayments = rawObject["satispay_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesSatispayPaymentsX3b428cad>(it) },
        scalapayPayments = rawObject["scalapay_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesScalapayPaymentsXd4a1c97e>(it) },
        sepaBankTransferPayments = rawObject["sepa_bank_transfer_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesSepaBankTransferPaymentsX83e48ff7>(it) },
        sepaDebitPayments = rawObject["sepa_debit_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesSepaDebitPaymentsXa1e24efa>(it) },
        sofortPayments = rawObject["sofort_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesSofortPaymentsXf6bccc49>(it) },
        sunbitPayments = rawObject["sunbit_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesSunbitPaymentsXbc81da38>(it) },
        swishPayments = rawObject["swish_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesSwishPaymentsX86405c81>(it) },
        taxReportingUs1099K = rawObject["tax_reporting_us_1099_k"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesTaxReportingUs1099KXf42c5fbd>(it) },
        taxReportingUs1099Misc = rawObject["tax_reporting_us_1099_misc"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesTaxReportingUs1099MiscX96b67f16>(it) },
        transfers = rawObject["transfers"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesTransfersXe77a5a94>(it) },
        treasury = rawObject["treasury"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesTreasuryX7cd7a96b>(it) },
        twintPayments = rawObject["twint_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesTwintPaymentsX74d459fc>(it) },
        upiPayments = rawObject["upi_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesUpiPaymentsXb0a4b7ef>(it) },
        usBankAccountAchPayments = rawObject["us_bank_account_ach_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesUsBankAccountAchPaymentsXf88de79d>(it) },
        usBankTransferPayments = rawObject["us_bank_transfer_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesUsBankTransferPaymentsXe44a1faf>(it) },
        zipPayments = rawObject["zip_payments"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormCapabilitiesZipPaymentsXe0ac6db6>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineV1AccountsPostRequestFormCapabilitiesX03ee7d3e) {
...
public fun inlineV1AccountsPostRequestFormCapabilitiesX03ee7d3e(block: InlineV1AccountsPostRequestFormCapabilitiesX03ee7d3e.Builder.() -> Unit): InlineV1AccountsPostRequestFormCapabilitiesX03ee7d3e = InlineV1AccountsPostRequestFormCapabilitiesX03ee7d3e.build(block)
