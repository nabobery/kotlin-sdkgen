...
public sealed class InlineIssuingAuthorizationVerificationDataAddressPostalCodeCheckX7628f69b {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineIssuingAuthorizationVerificationDataAddressPostalCodeCheckX7628f69b = when (value) {
      Match.value -> Match
  ...
  internal object Serializer : KSerializer<InlineIssuingAuthorizationVerificationDataAddressPostalCodeCheckX7628f69b> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineIssuingAuthorizationVerificationDataAddressPostalCodeCheckX7628f69b", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineIssuingAuthorizationVerificationDataAddressPostalCodeCheckX7628f69b = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineIssuingAuthorizationVerificationDataAddressPostalCodeCheckX7628f69b) {
