package io.github.nabobery.sdkgen.generated.stripe.applepay
...
import io.github.nabobery.sdkgen.generated.stripe.ApplePayDomain
import io.github.nabobery.sdkgen.generated.stripe.DeletedApplePayDomain
import io.github.nabobery.sdkgen.generated.stripe.Error
import io.github.nabobery.sdkgen.generated.stripe.InlineV1ApplePayDomainsGetResponse200JsonXb67a19ac
import io.github.nabobery.sdkgen.generated.stripe.InlineV1ApplePayDomainsPostRequestFormXfcb63491
...
internal object ApplePayCodecs {
  internal const val DELETEAPPLEPAYDOMAINSDOMAIN_REQUEST_CODEC_ID: String =
  ...
  internal val deleteApplePayDomainsDomainResponseCodecAlternative0Registry:
  ...
  internal val deleteApplePayDomainsDomainResponseCodecAlternative1Registry:
      MediaTypeCodecRegistry<Error> =
      MediaTypeCodecRegistry.of(deleteApplePayDomainsDomainResponseCodecAlternative1Codec)

  internal val deleteApplePayDomainsDomainRequestCodecRegistry: MediaTypeCodecRegistry<JsonObject?>
      = MediaTypeCodecRegistry.of(deleteApplePayDomainsDomainRequestCodec)

  internal const val GETAPPLEPAYDOMAINS_REQUEST_CODEC_ID: String = "GetApplePayDomains.request"
  ...
  internal val getApplePayDomainsResponseCodecAlternative0Registry:
  ...
  internal val getApplePayDomainsResponseCodecAlternative1Registry: MediaTypeCodecRegistry<Error> =
      MediaTypeCodecRegistry.of(getApplePayDomainsResponseCodecAlternative1Codec)

  internal val getApplePayDomainsRequestCodecRegistry: MediaTypeCodecRegistry<JsonObject?> =
      MediaTypeCodecRegistry.of(getApplePayDomainsRequestCodec)

  internal const val GETAPPLEPAYDOMAINSDOMAIN_REQUEST_CODEC_ID: String =
  ...
  internal val getApplePayDomainsDomainResponseCodecAlternative0Registry:
  ...
  internal val getApplePayDomainsDomainResponseCodecAlternative1Registry:
      MediaTypeCodecRegistry<Error> =
      MediaTypeCodecRegistry.of(getApplePayDomainsDomainResponseCodecAlternative1Codec)

  internal val getApplePayDomainsDomainRequestCodecRegistry: MediaTypeCodecRegistry<JsonObject?> =
      MediaTypeCodecRegistry.of(getApplePayDomainsDomainRequestCodec)

  internal const val POSTAPPLEPAYDOMAINS_REQUEST_CODEC_ID: String = "PostApplePayDomains.request"
  ...
  internal val postApplePayDomainsResponseCodecAlternative0Registry:
      MediaTypeCodecRegistry<ApplePayDomain> =
  ...
  internal val postApplePayDomainsResponseCodecAlternative1Registry: MediaTypeCodecRegistry<Error> =
      MediaTypeCodecRegistry.of(postApplePayDomainsResponseCodecAlternative1Codec)

  internal val postApplePayDomainsRequestCodecRegistry:
  ...
  internal object DeleteApplePayDomainsDomainFormCodec : MediaTypeCodec<JsonObject?> {
  ...
  internal object GetApplePayDomainsFormCodec : MediaTypeCodec<JsonObject?> {
  ...
  internal object GetApplePayDomainsDomainFormCodec : MediaTypeCodec<JsonObject?> {
  ...
  internal object PostApplePayDomainsFormCodec : MediaTypeCodec<InlineV1ApplePayDomainsPostRequestFormXfcb63491> {
...
public class ApplePayClient(
  ...
  public companion object {
    internal val deleteApplePayDomainsDomainMetadata: OperationMetadata by
    ...
    internal val getApplePayDomainsMetadata: OperationMetadata by
        lazy(LazyThreadSafetyMode.PUBLICATION) { OperationMetadata(
    ...
    internal val getApplePayDomainsDomainMetadata: OperationMetadata by
        lazy(LazyThreadSafetyMode.PUBLICATION) { OperationMetadata(
    ...
    internal val postApplePayDomainsMetadata: OperationMetadata by
        lazy(LazyThreadSafetyMode.PUBLICATION) { OperationMetadata(
