...
public sealed class InlineBillingCreditGrantsResourceBalanceDebitTypeX2282ffcc {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineBillingCreditGrantsResourceBalanceDebitTypeX2282ffcc = when (value) {
  ...
  internal object Serializer : KSerializer<InlineBillingCreditGrantsResourceBalanceDebitTypeX2282ffcc> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineBillingCreditGrantsResourceBalanceDebitTypeX2282ffcc", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineBillingCreditGrantsResourceBalanceDebitTypeX2282ffcc = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineBillingCreditGrantsResourceBalanceDebitTypeX2282ffcc) {
