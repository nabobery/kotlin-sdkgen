...
public sealed class InlineV1PaymentMethodConfidc49PostRequestFormAuBecsDebitPreferenceXe1f6c7f5 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1PaymentMethodConfidc49PostRequestFormAuBecsDebitPreferenceXe1f6c7f5 = when (value) {
      None.value -> None
      Off.value -> Off
      On.value -> On
  ...
  internal object Serializer : KSerializer<InlineV1PaymentMethodConfidc49PostRequestFormAuBecsDebitPreferenceXe1f6c7f5> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1PaymentMethodConfidc49PostRequestFormAuBecsDebitPreferenceXe1f6c7f5", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1PaymentMethodConfidc49PostRequestFormAuBecsDebitPreferenceXe1f6c7f5 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1PaymentMethodConfidc49PostRequestFormAuBecsDebitPreferenceXe1f6c7f5) {
