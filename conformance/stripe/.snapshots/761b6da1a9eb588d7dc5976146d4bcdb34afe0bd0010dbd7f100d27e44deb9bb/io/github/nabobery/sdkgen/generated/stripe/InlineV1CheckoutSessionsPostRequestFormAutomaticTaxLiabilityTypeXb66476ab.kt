...
public sealed class InlineV1CheckoutSessionsPostRequestFormAutomaticTaxLiabilityTypeXb66476ab {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1CheckoutSessionsPostRequestFormAutomaticTaxLiabilityTypeXb66476ab = when (value) {
  ...
  internal object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormAutomaticTaxLiabilityTypeXb66476ab> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1CheckoutSessionsPostRequestFormAutomaticTaxLiabilityTypeXb66476ab", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1CheckoutSessionsPostRequestFormAutomaticTaxLiabilityTypeXb66476ab = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1CheckoutSessionsPostRequestFormAutomaticTaxLiabilityTypeXb66476ab) {
