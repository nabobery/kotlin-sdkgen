...
public class InlineV1QuotesPostRequestFormDescriptionX33a47f56 internal constructor(
  ...
  public val inlineV1QuotesPostRequestFormDescriptionAnyOf2Xbf7c6fcf:
      ...
      lazy(LazyThreadSafetyMode.NONE) { if (inspection.matchesInlineV1QuotesPostRequestFormDescriptionAnyOf2Xbf7c6fcf) json.decodeFromJsonElement<InlineV1QuotesPostRequestFormDescriptionAnyOf2Xbf7c6fcf>(raw) else null }
  ...
  public val matchedBranches: Set<InlineV1QuotesPostRequestFormDescriptionX33a47f56Branch>
    get() = buildSet {
      ...
      if (inspection.matchesInlineV1QuotesPostRequestFormDescriptionAnyOf2Xbf7c6fcf) add(InlineV1QuotesPostRequestFormDescriptionX33a47f56Branch.InlineV1QuotesPostRequestFormDescriptionAnyOf2Xbf7c6fcf)
    }
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineV1QuotesPostRequestFormDescriptionX33a47f56 {
      val inspection = inspectInlineV1QuotesPostRequestFormDescriptionX33a47f56(raw)
      if (inspection.matchCount == 0) {
        throw InlineV1QuotesPostRequestFormDescriptionX33a47f56NoMatchException("InlineV1QuotesPostRequestFormDescriptionX33a47f56 matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineV1QuotesPostRequestFormDescriptionX33a47f56(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineV1QuotesPostRequestFormDescriptionX33a47f56> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1QuotesPostRequestFormDescriptionX33a47f56) {
      encoder.requireJsonEncoder("InlineV1QuotesPostRequestFormDescriptionX33a47f56").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineV1QuotesPostRequestFormDescriptionX33a47f56(element: JsonElement): InlineV1QuotesPostRequestFormDescriptionX33a47f56Inspection {
  val matchesBranch1 = element.isJsonDecodable<String>()
  val matchesInlineV1QuotesPostRequestFormDescriptionAnyOf2Xbf7c6fcf = element.isJsonDecodable<InlineV1QuotesPostRequestFormDescriptionAnyOf2Xbf7c6fcf>()
  return InlineV1QuotesPostRequestFormDescriptionX33a47f56Inspection(
    ...
    failures = buildList {
      ...
      if (!matchesInlineV1QuotesPostRequestFormDescriptionAnyOf2Xbf7c6fcf) add("InlineV1QuotesPostRequestFormDescriptionAnyOf2Xbf7c6fcf: value does not match InlineV1QuotesPostRequestFormDescriptionAnyOf2Xbf7c6fcf")
    },
  )
}
