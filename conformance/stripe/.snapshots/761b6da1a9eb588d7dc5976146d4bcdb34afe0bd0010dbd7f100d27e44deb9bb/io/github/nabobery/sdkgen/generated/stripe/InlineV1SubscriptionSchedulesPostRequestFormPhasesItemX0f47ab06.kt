...
public class InlineV1SubscriptionSchedulesPostRequestFormPhasesItemX0f47ab06(
  ...
  addInvoiceItems: List<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemX6fa88330>? = null,
  /**
  ...
  public val discounts:
      InlineV1SubscriptionSchedulesPostRequestFormPhasesItemDiscountsX64b77ece? = null,
  public val duration:
      InlineV1SubscriptionSchedulesPostRequestFormPhasesItemDurationX3905b555? = null,
  ...
  public val addInvoiceItems:
      List<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemX6fa88330>? =
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1SubscriptionSchedulesPostRequestFormPhasesItemX0f47ab06 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemX0f47ab06> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineV1SubscriptionSchedulesPostRequestFormPhasesItemX0f47ab06 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineV1SubscriptionSchedulesPostRequestFormPhasesItemX0f47ab06")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1SubscriptionSchedulesPostRequestFormPhasesItemX0f47ab06 must be a JSON object")
      val items = json.decodeRequired<List<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemsItemX457be849>>(rawObject, "items")
      return InlineV1SubscriptionSchedulesPostRequestFormPhasesItemX0f47ab06(
        items = items,
        addInvoiceItems = rawObject["add_invoice_items"]?.let { json.decodeFromJsonElement<List<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemItemX6fa88330>>(it) },
        applicationFeePercent = rawObject["application_fee_percent"]?.let { json.decodeFromJsonElement<Double>(it) },
        automaticTax = rawObject["automatic_tax"]?.let { json.decodeFromJsonElement<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemAutomaticTaxXba49e122>(it) },
        billingCycleAnchor = rawObject["billing_cycle_anchor"]?.let { json.decodeFromJsonElement<InlineV1SubscriptionSchedulesPostRequestFormPhasesBillingCycleAnchorXbdb541cf>(it) },
        billingThresholds = rawObject["billing_thresholds"]?.let { json.decodeFromJsonElement<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemBillingThresholdsX927362a3>(it) },
        collectionMethod = rawObject["collection_method"]?.let { json.decodeFromJsonElement<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemCollectionMethodX6fffc30e>(it) },
        ...
        defaultTaxRates = rawObject["default_tax_rates"]?.let { json.decodeFromJsonElement<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemDefaultTaxRatesX999dcfcf>(it) },
        description = rawObject["description"]?.let { json.decodeFromJsonElement<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemDescriptionXc4b6a535>(it) },
        discounts = rawObject["discounts"]?.let { json.decodeFromJsonElement<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemDiscountsX64b77ece>(it) },
        duration = rawObject["duration"]?.let { json.decodeFromJsonElement<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemDurationX3905b555>(it) },
        endDate = rawObject["end_date"]?.let { json.decodeFromJsonElement<Int>(it) },
        invoiceSettings = rawObject["invoice_settings"]?.let { json.decodeFromJsonElement<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemInvoiceSettingsXbbd5e35c>(it) },
        metadata = rawObject["metadata"]?.let { json.decodeFromJsonElement<Map<String, String>>(it) },
        onBehalfOf = rawObject["on_behalf_of"]?.let { json.decodeFromJsonElement<String>(it) },
        prorationBehavior = rawObject["proration_behavior"]?.let { json.decodeFromJsonElement<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemProrationBehaviorX9c36a412>(it) },
        transferData = rawObject["transfer_data"]?.let { json.decodeFromJsonElement<InlineV1SubscriptionSchedulesPostRequestFormPhasesItemTransferDataX8949d55f>(it) },
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1SubscriptionSchedulesPostRequestFormPhasesItemX0f47ab06) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineV1SubscriptionSchedulesPostRequestFormPhasesItemX0f47ab06")
...
public fun inlineV1SubscriptionSchedulesPostRequestFormPhasesItemX0f47ab06(block: InlineV1SubscriptionSchedulesPostRequestFormPhasesItemX0f47ab06.Builder.() -> Unit): InlineV1SubscriptionSchedulesPostRequestFormPhasesItemX0f47ab06 = InlineV1SubscriptionSchedulesPostRequestFormPhasesItemX0f47ab06.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineV1SubscriptionSchedulesPostRequestFormPhasesItemX0f47ab06 is missing required property '" + name + "'")
