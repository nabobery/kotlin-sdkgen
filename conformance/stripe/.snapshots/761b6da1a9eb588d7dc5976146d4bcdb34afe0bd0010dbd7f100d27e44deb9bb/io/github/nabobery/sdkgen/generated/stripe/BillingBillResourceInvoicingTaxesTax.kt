...
public class BillingBillResourceInvoicingTaxesTax(
  ...
  public val taxRateDetails:
      InlineBillingBillResourceInvoicingTaxesTaxTaxRateDetailsXd36f26bc? = null,
  /**
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): BillingBillResourceInvoicingTaxesTax = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<BillingBillResourceInvoicingTaxesTax> {
    ...
    override fun deserialize(decoder: Decoder): BillingBillResourceInvoicingTaxesTax {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("BillingBillResourceInvoicingTaxesTax must be a JSON object")
      val amount = json.decodeRequired<Int>(rawObject, "amount")
      val taxBehavior = json.decodeRequired<InlineBillingBillResourceInvoicingTaxesTaxTaxBehaviorXb3894f7a>(rawObject, "tax_behavior")
      val taxabilityReason = json.decodeRequired<InlineBillingBillResourceInvoicingTaxesTaxTaxabilityReasonXc6ddf993>(rawObject, "taxability_reason")
      ...
      return BillingBillResourceInvoicingTaxesTax(
        ...
        taxabilityReason = taxabilityReason,
        type = type,
        taxRateDetails = rawObject["tax_rate_details"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineBillingBillResourceInvoicingTaxesTaxTaxRateDetailsXd36f26bc?>(element) },
        taxableAmount = rawObject["taxable_amount"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<Int?>(element) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: BillingBillResourceInvoicingTaxesTax) {
...
public fun billingBillResourceInvoicingTaxesTax(block: BillingBillResourceInvoicingTaxesTax.Builder.() -> Unit): BillingBillResourceInvoicingTaxesTax = BillingBillResourceInvoicingTaxesTax.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("BillingBillResourceInvoicingTaxesTax is missing required property '" + name + "'")
