...
public class InlineDisputeEvidenceReceiptXefa00443 internal constructor(
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineDisputeEvidenceReceiptXefa00443 {
      val inspection = inspectInlineDisputeEvidenceReceiptXefa00443(raw)
      if (inspection.matchCount == 0) {
        throw InlineDisputeEvidenceReceiptXefa00443NoMatchException("InlineDisputeEvidenceReceiptXefa00443 matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineDisputeEvidenceReceiptXefa00443(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineDisputeEvidenceReceiptXefa00443> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineDisputeEvidenceReceiptXefa00443) {
      encoder.requireJsonEncoder("InlineDisputeEvidenceReceiptXefa00443").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineDisputeEvidenceReceiptXefa00443(element: JsonElement): InlineDisputeEvidenceReceiptXefa00443Inspection {
