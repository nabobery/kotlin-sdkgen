...
public sealed class InlineV1CustomersSubscriptionsPostRequestFormMissingPaymentMethodX71a99531 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1CustomersSubscriptionsPostRequestFormMissingPaymentMethodX71a99531 = when (value) {
      Cancel.value -> Cancel
  ...
  internal object Serializer : KSerializer<InlineV1CustomersSubscriptionsPostRequestFormMissingPaymentMethodX71a99531> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1CustomersSubscriptionsPostRequestFormMissingPaymentMethodX71a99531", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1CustomersSubscriptionsPostRequestFormMissingPaymentMethodX71a99531 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1CustomersSubscriptionsPostRequestFormMissingPaymentMethodX71a99531) {
