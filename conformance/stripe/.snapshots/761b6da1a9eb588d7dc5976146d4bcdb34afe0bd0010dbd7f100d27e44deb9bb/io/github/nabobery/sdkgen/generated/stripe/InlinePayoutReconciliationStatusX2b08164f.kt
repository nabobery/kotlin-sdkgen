...
public sealed class InlinePayoutReconciliationStatusX2b08164f {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlinePayoutReconciliationStatusX2b08164f = when (value) {
  ...
  internal object Serializer : KSerializer<InlinePayoutReconciliationStatusX2b08164f> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlinePayoutReconciliationStatusX2b08164f", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlinePayoutReconciliationStatusX2b08164f = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlinePayoutReconciliationStatusX2b08164f) {
