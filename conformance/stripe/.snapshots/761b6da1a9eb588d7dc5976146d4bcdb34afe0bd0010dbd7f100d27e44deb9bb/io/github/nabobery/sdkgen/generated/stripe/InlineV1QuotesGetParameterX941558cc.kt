...
public sealed class InlineV1QuotesGetParameterX941558cc {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1QuotesGetParameterX941558cc = when (value) {
  ...
  internal object Serializer : KSerializer<InlineV1QuotesGetParameterX941558cc> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1QuotesGetParameterX941558cc", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1QuotesGetParameterX941558cc = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1QuotesGetParameterX941558cc) {
