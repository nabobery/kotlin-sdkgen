...
public sealed class InlineV1InvoicesPostRequestFormShippingCostShippingRateDataUnitX9dd7b165 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1InvoicesPostRequestFormShippingCostShippingRateDataUnitX9dd7b165 = when (value) {
  ...
  internal object Serializer : KSerializer<InlineV1InvoicesPostRequestFormShippingCostShippingRateDataUnitX9dd7b165> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1InvoicesPostRequestFormShippingCostShippingRateDataUnitX9dd7b165", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1InvoicesPostRequestFormShippingCostShippingRateDataUnitX9dd7b165 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1InvoicesPostRequestFormShippingCostShippingRateDataUnitX9dd7b165) {
