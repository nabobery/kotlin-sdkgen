...
public class PaymentLinksResourceIndividualName(
  ...
  internal object Serializer : KSerializer<PaymentLinksResourceIndividualName> {
    ...
    override fun deserialize(decoder: Decoder): PaymentLinksResourceIndividualName {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("PaymentLinksResourceIndividualName must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: PaymentLinksResourceIndividualName) {
...
public fun paymentLinksResourceIndividualName(block: PaymentLinksResourceIndividualName.Builder.() -> Unit): PaymentLinksResourceIndividualName = PaymentLinksResourceIndividualName.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("PaymentLinksResourceIndividualName is missing required property '" + name + "'")
