 ...
 * a
 */
@Serializable(with = InlineV1TaxRatesPostRequestFormXdec5ed3b.Serializer::class)
public class InlineV1TaxRatesPostRequestFormXdec5ed3b(
  /**
   ...
   */
  public val taxType: InlineV1TaxRatesPostRequestFormTaxTypeX4a8c05f8? = null,
) {
  /**
  ...
  public class Builder {
     ...
     * The high-level tax type, such as `vat` or `sales_tax`.
     */
    public var taxType: InlineV1TaxRatesPostRequestFormTaxTypeX4a8c05f8? = null

    public fun build(): InlineV1TaxRatesPostRequestFormXdec5ed3b {
      ...
      return InlineV1TaxRatesPostRequestFormXdec5ed3b(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1TaxRatesPostRequestFormXdec5ed3b = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1TaxRatesPostRequestFormXdec5ed3b> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineV1TaxRatesPostRequestFormXdec5ed3b {
      val jsonDecoder = decoder.requireJsonDecoder("InlineV1TaxRatesPostRequestFormXdec5ed3b")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1TaxRatesPostRequestFormXdec5ed3b must be a JSON object")
      ...
      return InlineV1TaxRatesPostRequestFormXdec5ed3b(
        ...
        taxType = rawObject["tax_type"]?.let { json.decodeFromJsonElement<InlineV1TaxRatesPostRequestFormTaxTypeX4a8c05f8>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineV1TaxRatesPostRequestFormXdec5ed3b) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineV1TaxRatesPostRequestFormXdec5ed3b")
...
public fun inlineV1TaxRatesPostRequestFormXdec5ed3b(block: InlineV1TaxRatesPostRequestFormXdec5ed3b.Builder.() -> Unit): InlineV1TaxRatesPostRequestFormXdec5ed3b = InlineV1TaxRatesPostRequestFormXdec5ed3b.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineV1TaxRatesPostRequestFormXdec5ed3b is missing required property '" + name + "'")
