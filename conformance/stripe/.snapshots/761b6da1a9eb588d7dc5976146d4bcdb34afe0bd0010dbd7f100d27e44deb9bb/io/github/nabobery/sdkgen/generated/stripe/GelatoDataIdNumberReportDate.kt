...
public class GelatoDataIdNumberReportDate(
  ...
  public class Builder {
    ...
    public fun build(): GelatoDataIdNumberReportDate = GelatoDataIdNumberReportDate(
      day = day,
      month = month,
      year = year,
    )
  ...
  internal object Serializer : KSerializer<GelatoDataIdNumberReportDate> {
    ...
    override fun deserialize(decoder: Decoder): GelatoDataIdNumberReportDate {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("GelatoDataIdNumberReportDate must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: GelatoDataIdNumberReportDate) {
...
public fun gelatoDataIdNumberReportDate(block: GelatoDataIdNumberReportDate.Builder.() -> Unit): GelatoDataIdNumberReportDate = GelatoDataIdNumberReportDate.build(block)
