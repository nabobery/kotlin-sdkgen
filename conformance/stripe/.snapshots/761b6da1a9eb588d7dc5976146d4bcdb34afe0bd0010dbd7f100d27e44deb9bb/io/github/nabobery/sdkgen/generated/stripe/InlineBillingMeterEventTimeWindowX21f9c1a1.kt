...
public sealed class InlineBillingMeterEventTimeWindowX21f9c1a1 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineBillingMeterEventTimeWindowX21f9c1a1 = when (value) {
      Day.value -> Day
      Hour.value -> Hour
  ...
  internal object Serializer : KSerializer<InlineBillingMeterEventTimeWindowX21f9c1a1> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineBillingMeterEventTimeWindowX21f9c1a1", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineBillingMeterEventTimeWindowX21f9c1a1 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineBillingMeterEventTimeWindowX21f9c1a1) {
