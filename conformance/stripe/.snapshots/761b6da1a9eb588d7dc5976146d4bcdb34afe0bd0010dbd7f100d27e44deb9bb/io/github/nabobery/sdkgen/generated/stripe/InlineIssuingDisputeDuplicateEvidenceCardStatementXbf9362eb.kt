...
public class InlineIssuingDisputeDuplicateEvidenceCardStatementXbf9362eb internal constructor(
  ...
  public val matchedBranches: Set<InlineIssuingDisputeDuplicateEvidenceCardStatementXbf9362ebBranch>
    get() = buildSet {
      if (inspection.matchesBranch1) add(InlineIssuingDisputeDuplicateEvidenceCardStatementXbf9362ebBranch.Branch1)
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineIssuingDisputeDuplicateEvidenceCardStatementXbf9362eb {
      val inspection = inspectInlineIssuingDisputeDuplicateEvidenceCardStatementXbf9362eb(raw)
      if (inspection.matchCount == 0) {
        throw InlineIssuingDisputeDuplicateEvidenceCardStatementXbf9362ebNoMatchException("InlineIssuingDisputeDuplicateEvidenceCardStatementXbf9362eb matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineIssuingDisputeDuplicateEvidenceCardStatementXbf9362eb(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineIssuingDisputeDuplicateEvidenceCardStatementXbf9362eb> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineIssuingDisputeDuplicateEvidenceCardStatementXbf9362eb) {
      encoder.requireJsonEncoder("InlineIssuingDisputeDuplicateEvidenceCardStatementXbf9362eb").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineIssuingDisputeDuplicateEvidenceCardStatementXbf9362eb(element: JsonElement): InlineIssuingDisputeDuplicateEvidenceCardStatementXbf9362ebInspection {
