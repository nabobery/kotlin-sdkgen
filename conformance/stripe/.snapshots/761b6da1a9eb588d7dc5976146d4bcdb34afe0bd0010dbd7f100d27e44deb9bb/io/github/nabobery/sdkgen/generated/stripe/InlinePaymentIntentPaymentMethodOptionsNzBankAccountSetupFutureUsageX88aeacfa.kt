...
public sealed class InlinePaymentIntentPaymentMethodOptionsNzBankAccountSetupFutureUsageX88aeacfa {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlinePaymentIntentPaymentMethodOptionsNzBankAccountSetupFutureUsageX88aeacfa = when (value) {
      None.value -> None
  ...
  internal object Serializer : KSerializer<InlinePaymentIntentPaymentMethodOptionsNzBankAccountSetupFutureUsageX88aeacfa> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlinePaymentIntentPaymentMethodOptionsNzBankAccountSetupFutureUsageX88aeacfa", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlinePaymentIntentPaymentMethodOptionsNzBankAccountSetupFutureUsageX88aeacfa = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlinePaymentIntentPaymentMethodOptionsNzBankAccountSetupFutureUsageX88aeacfa) {
