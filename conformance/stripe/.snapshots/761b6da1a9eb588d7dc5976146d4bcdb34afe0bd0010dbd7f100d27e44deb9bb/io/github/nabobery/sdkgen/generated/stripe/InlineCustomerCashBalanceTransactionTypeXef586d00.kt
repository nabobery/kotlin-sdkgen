...
public sealed class InlineCustomerCashBalanceTransactionTypeXef586d00 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineCustomerCashBalanceTransactionTypeXef586d00 = when (value) {
  ...
  internal object Serializer : KSerializer<InlineCustomerCashBalanceTransactionTypeXef586d00> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineCustomerCashBalanceTransactionTypeXef586d00", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineCustomerCashBalanceTransactionTypeXef586d00 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineCustomerCashBalanceTransactionTypeXef586d00) {
