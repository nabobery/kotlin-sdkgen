...
public class InlineV1IssuingPersonalizationDesignsPostRequestFormXab59ee59(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1IssuingPersonalizationDesignsPostRequestFormXab59ee59 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1IssuingPersonalizationDesignsPostRequestFormXab59ee59> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineV1IssuingPersonalizationDesignsPostRequestFormXab59ee59 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineV1IssuingPersonalizationDesignsPostRequestFormXab59ee59")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1IssuingPersonalizationDesignsPostRequestFormXab59ee59 must be a JSON object")
      ...
      return InlineV1IssuingPersonalizationDesignsPostRequestFormXab59ee59(
        ...
        carrierText = rawObject["carrier_text"]?.let { json.decodeFromJsonElement<InlineV1IssuingPersonalizationDesignsPostRequestFormCarrierTextX00f05ffe>(it) },
        expand = rawObject["expand"]?.let { json.decodeFromJsonElement<List<String>>(it) },
        lookupKey = rawObject["lookup_key"]?.let { json.decodeFromJsonElement<String>(it) },
        metadata = rawObject["metadata"]?.let { json.decodeFromJsonElement<Map<String, String>>(it) },
        name = rawObject["name"]?.let { json.decodeFromJsonElement<String>(it) },
        preferences = rawObject["preferences"]?.let { json.decodeFromJsonElement<InlineV1IssuingPersonalizationDesignsPostRequestFormPreferencesX720c7859>(it) },
        transferLookupKey = rawObject["transfer_lookup_key"]?.let { json.decodeFromJsonElement<Boolean>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineV1IssuingPersonalizationDesignsPostRequestFormXab59ee59) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineV1IssuingPersonalizationDesignsPostRequestFormXab59ee59")
...
public fun inlineV1IssuingPersonalizationDesignsPostRequestFormXab59ee59(block: InlineV1IssuingPersonalizationDesignsPostRequestFormXab59ee59.Builder.() -> Unit): InlineV1IssuingPersonalizationDesignsPostRequestFormXab59ee59 = InlineV1IssuingPersonalizationDesignsPostRequestFormXab59ee59.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineV1IssuingPersonalizationDesignsPostRequestFormXab59ee59 is missing required property '" + name + "'")
