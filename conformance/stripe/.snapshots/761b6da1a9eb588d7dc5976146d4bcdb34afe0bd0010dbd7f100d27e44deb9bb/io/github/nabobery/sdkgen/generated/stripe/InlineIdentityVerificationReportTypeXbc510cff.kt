...
public sealed class InlineIdentityVerificationReportTypeXbc510cff {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineIdentityVerificationReportTypeXbc510cff = when (value) {
  ...
  internal object Serializer : KSerializer<InlineIdentityVerificationReportTypeXbc510cff> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineIdentityVerificationReportTypeXbc510cff", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineIdentityVerificationReportTypeXbc510cff = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineIdentityVerificationReportTypeXbc510cff) {
