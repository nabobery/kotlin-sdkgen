 ...
 * /schema/properties/p24/properties/bank.
 *
 * Source:
 * sdkgen://source/openapi.json#/paths/~1v1~1payment_methods/post/requestBody/content/application~1x-www-form-urlencoded
 * /schema/properties/p24/properties/bank
 */
@Serializable(with = InlineV1PaymentMethodsPostRequestFormP24BankXc67799a3.Serializer::class)
public sealed class InlineV1PaymentMethodsPostRequestFormP24BankXc67799a3 {
  public abstract val `value`: String

  /**
   * Documented value. Wire value: `alior_bank`.
   */
  public data object AliorBank : InlineV1PaymentMethodsPostRequestFormP24BankXc67799a3() {
   ...
   */
  public data object BankMillennium : InlineV1PaymentMethodsPostRequestFormP24BankXc67799a3() {
   ...
   */
  public data object BankNowyBfgSa : InlineV1PaymentMethodsPostRequestFormP24BankXc67799a3() {
   ...
   */
  public data object BankPekaoSa : InlineV1PaymentMethodsPostRequestFormP24BankXc67799a3() {
   ...
   */
  public data object BankiSpbdzielcze : InlineV1PaymentMethodsPostRequestFormP24BankXc67799a3() {
   ...
   */
  public data object Blik : InlineV1PaymentMethodsPostRequestFormP24BankXc67799a3() {
   ...
   */
  public data object BnpParibas : InlineV1PaymentMethodsPostRequestFormP24BankXc67799a3() {
   ...
   */
  public data object Boz : InlineV1PaymentMethodsPostRequestFormP24BankXc67799a3() {
   ...
   */
  public data object CitiHandlowy : InlineV1PaymentMethodsPostRequestFormP24BankXc67799a3() {
   ...
   */
  public data object CreditAgricole : InlineV1PaymentMethodsPostRequestFormP24BankXc67799a3() {
   ...
   */
  public data object Envelobank : InlineV1PaymentMethodsPostRequestFormP24BankXc67799a3() {
   ...
   */
  public data object EtransferPocztowy24 : InlineV1PaymentMethodsPostRequestFormP24BankXc67799a3() {
   ...
   */
  public data object GetinBank : InlineV1PaymentMethodsPostRequestFormP24BankXc67799a3() {
   ...
   */
  public data object Ideabank : InlineV1PaymentMethodsPostRequestFormP24BankXc67799a3() {
   ...
   */
  public data object Ing : InlineV1PaymentMethodsPostRequestFormP24BankXc67799a3() {
   ...
   */
  public data object Inteligo : InlineV1PaymentMethodsPostRequestFormP24BankXc67799a3() {
   ...
   */
  public data object MbankMtransfer : InlineV1PaymentMethodsPostRequestFormP24BankXc67799a3() {
   ...
   */
  public data object NestPrzelew : InlineV1PaymentMethodsPostRequestFormP24BankXc67799a3() {
   ...
   */
  public data object NoblePay : InlineV1PaymentMethodsPostRequestFormP24BankXc67799a3() {
   ...
   */
  public data object PbacZIpko : InlineV1PaymentMethodsPostRequestFormP24BankXc67799a3() {
   ...
   */
  public data object PlusBank : InlineV1PaymentMethodsPostRequestFormP24BankXc67799a3() {
   ...
   */
  public data object SantanderPrzelew24 : InlineV1PaymentMethodsPostRequestFormP24BankXc67799a3() {
   ...
   */
  public data object TmobileUsbugiBankowe : InlineV1PaymentMethodsPostRequestFormP24BankXc67799a3() {
   ...
   */
  public data object ToyotaBank : InlineV1PaymentMethodsPostRequestFormP24BankXc67799a3() {
   ...
   */
  public data object Velobank : InlineV1PaymentMethodsPostRequestFormP24BankXc67799a3() {
   ...
   */
  public data object VolkswagenBank : InlineV1PaymentMethodsPostRequestFormP24BankXc67799a3() {
    public override val `value`: String = "volkswagen_bank"
  }

  public data class SdkUnknown(
    public override val `value`: String,
  ) : InlineV1PaymentMethodsPostRequestFormP24BankXc67799a3()

  public companion object {
    public fun fromValue(`value`: String): InlineV1PaymentMethodsPostRequestFormP24BankXc67799a3 = when (value) {
  ...
  internal object Serializer : KSerializer<InlineV1PaymentMethodsPostRequestFormP24BankXc67799a3> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1PaymentMethodsPostRequestFormP24BankXc67799a3", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1PaymentMethodsPostRequestFormP24BankXc67799a3 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1PaymentMethodsPostRequestFormP24BankXc67799a3) {
