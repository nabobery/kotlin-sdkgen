...
public sealed class InlineTaxProductResourceCustomerDetailsTaxabilityOverrideXae37b37b {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineTaxProductResourceCustomerDetailsTaxabilityOverrideXae37b37b = when (value) {
  ...
  internal object Serializer : KSerializer<InlineTaxProductResourceCustomerDetailsTaxabilityOverrideXae37b37b> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineTaxProductResourceCustomerDetailsTaxabilityOverrideXae37b37b", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineTaxProductResourceCustomerDetailsTaxabilityOverrideXae37b37b = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineTaxProductResourceCustomerDetailsTaxabilityOverrideXae37b37b) {
