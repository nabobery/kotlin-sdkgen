...
public sealed class InlineV1QuotesPostRequestFormSubscriptionDataBillingModeTypeXc9d0ae5c {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1QuotesPostRequestFormSubscriptionDataBillingModeTypeXc9d0ae5c = when (value) {
  ...
  internal object Serializer : KSerializer<InlineV1QuotesPostRequestFormSubscriptionDataBillingModeTypeXc9d0ae5c> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1QuotesPostRequestFormSubscriptionDataBillingModeTypeXc9d0ae5c", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1QuotesPostRequestFormSubscriptionDataBillingModeTypeXc9d0ae5c = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1QuotesPostRequestFormSubscriptionDataBillingModeTypeXc9d0ae5c) {
