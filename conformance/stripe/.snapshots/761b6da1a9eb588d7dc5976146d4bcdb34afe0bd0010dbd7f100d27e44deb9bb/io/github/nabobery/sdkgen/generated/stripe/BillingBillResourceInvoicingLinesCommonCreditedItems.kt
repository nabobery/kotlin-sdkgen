...
@Serializable
public data class BillingBillResourceInvoicingLinesCommonCreditedItemsView internal constructor(
...
public class BillingBillResourceInvoicingLinesCommonCreditedItems(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): BillingBillResourceInvoicingLinesCommonCreditedItems = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<BillingBillResourceInvoicingLinesCommonCreditedItems> {
    ...
    override fun deserialize(decoder: Decoder): BillingBillResourceInvoicingLinesCommonCreditedItems {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("BillingBillResourceInvoicingLinesCommonCreditedItems must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: BillingBillResourceInvoicingLinesCommonCreditedItems) {
...
public fun billingBillResourceInvoicingLinesCommonCreditedItems(block: BillingBillResourceInvoicingLinesCommonCreditedItems.Builder.() -> Unit): BillingBillResourceInvoicingLinesCommonCreditedItems = BillingBillResourceInvoicingLinesCommonCreditedItems.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("BillingBillResourceInvoicingLinesCommonCreditedItems is missing required property '" + name + "'")
