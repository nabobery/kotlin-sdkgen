...
public sealed class InlineV1CheckoutSessionsPostRequestFormSubscriptionDataBillingModeTypeX2a893bb2 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1CheckoutSessionsPostRequestFormSubscriptionDataBillingModeTypeX2a893bb2 = when (value) {
  ...
  internal object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormSubscriptionDataBillingModeTypeX2a893bb2> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1CheckoutSessionsPostRequestFormSubscriptionDataBillingModeTypeX2a893bb2", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1CheckoutSessionsPostRequestFormSubscriptionDataBillingModeTypeX2a893bb2 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1CheckoutSessionsPostRequestFormSubscriptionDataBillingModeTypeX2a893bb2) {
