...
public sealed class InlineSubscriptionScheduleObjectValueX6722ea6d {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineSubscriptionScheduleObjectValueX6722ea6d = when (value) {
      SubscriptionSchedule.value -> SubscriptionSchedule
      else -> SdkUnknown(value)
    }
  }

  internal object Serializer : KSerializer<InlineSubscriptionScheduleObjectValueX6722ea6d> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineSubscriptionScheduleObjectValueX6722ea6d", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineSubscriptionScheduleObjectValueX6722ea6d = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineSubscriptionScheduleObjectValueX6722ea6d) {
