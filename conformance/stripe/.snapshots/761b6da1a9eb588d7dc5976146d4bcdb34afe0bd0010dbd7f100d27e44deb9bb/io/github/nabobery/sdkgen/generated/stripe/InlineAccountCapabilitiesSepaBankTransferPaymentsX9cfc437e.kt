...
public sealed class InlineAccountCapabilitiesSepaBankTransferPaymentsX9cfc437e {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineAccountCapabilitiesSepaBankTransferPaymentsX9cfc437e = when (value) {
      Active.value -> Active
  ...
  internal object Serializer : KSerializer<InlineAccountCapabilitiesSepaBankTransferPaymentsX9cfc437e> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineAccountCapabilitiesSepaBankTransferPaymentsX9cfc437e", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineAccountCapabilitiesSepaBankTransferPaymentsX9cfc437e = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineAccountCapabilitiesSepaBankTransferPaymentsX9cfc437e) {
