package io.github.nabobery.sdkgen.generated.stripe.setupintents
...
import io.github.nabobery.sdkgen.generated.stripe.InlineV1SetupIntentsCancelPostRequestFormXde74045b
import io.github.nabobery.sdkgen.generated.stripe.InlineV1SetupIntentsGetParameterX536b4840
import io.github.nabobery.sdkgen.generated.stripe.InlineV1SetupIntentsGetResponse200JsonXeb399bcb
import io.github.nabobery.sdkgen.generated.stripe.InlineV1SetupIntentsVerifyMicrodepositsPostRequestFormX01f1f47d
import io.github.nabobery.sdkgen.generated.stripe.SdkJson
import io.github.nabobery.sdkgen.generated.stripe.SetupIntent
...
internal object SetupIntentsCodecs {
  internal const val GETSETUPINTENTS_REQUEST_CODEC_ID: String = "GetSetupIntents.request"
  ...
  internal val getSetupIntentsResponseCodecAlternative0Registry:
  ...
  internal val getSetupIntentsResponseCodecAlternative1Registry: MediaTypeCodecRegistry<Error> =
      MediaTypeCodecRegistry.of(getSetupIntentsResponseCodecAlternative1Codec)

  internal val getSetupIntentsRequestCodecRegistry: MediaTypeCodecRegistry<JsonObject?> =
      MediaTypeCodecRegistry.of(getSetupIntentsRequestCodec)

  internal const val GETSETUPINTENTSINTENT_REQUEST_CODEC_ID: String =
      "GetSetupIntentsIntent.request"
  ...
  internal val getSetupIntentsIntentResponseCodecAlternative0Registry:
  ...
  internal val getSetupIntentsIntentResponseCodecAlternative1Registry: MediaTypeCodecRegistry<Error>
      = MediaTypeCodecRegistry.of(getSetupIntentsIntentResponseCodecAlternative1Codec)

  internal val getSetupIntentsIntentRequestCodecRegistry: MediaTypeCodecRegistry<JsonObject?> =
      MediaTypeCodecRegistry.of(getSetupIntentsIntentRequestCodec)

  internal const val POSTSETUPINTENTSINTENTCANCEL_REQUEST_CODEC_ID: String =
  ...
  internal val postSetupIntentsIntentCancelResponseCodecAlternative0Registry:
      MediaTypeCodecRegistry<SetupIntent> =
  ...
  internal val postSetupIntentsIntentCancelResponseCodecAlternative1Registry:
      MediaTypeCodecRegistry<Error> =
      MediaTypeCodecRegistry.of(postSetupIntentsIntentCancelResponseCodecAlternative1Codec)

  internal val postSetupIntentsIntentCancelRequestCodecRegistry:
  ...
  internal const val POSTSETUPINTENTSINTENTVERIFYMICRODEPOSITS_REQUEST_CODEC_ID: String =
  ...
  internal val postSetupIntentsIntentVerifyMicrodepositsResponseCodecAlternative0Registry:
      MediaTypeCodecRegistry<SetupIntent> =
  ...
  internal val postSetupIntentsIntentVerifyMicrodepositsResponseCodecAlternative1Registry:
      MediaTypeCodecRegistry<Error> =
      MediaTypeCodecRegistry.of(postSetupIntentsIntentVerifyMicrodepositsResponseCodecAlternative1Codec)

  internal val postSetupIntentsIntentVerifyMicrodepositsRequestCodecRegistry:
  ...
  internal object GetSetupIntentsFormCodec : MediaTypeCodec<JsonObject?> {
  ...
  internal object GetSetupIntentsIntentFormCodec : MediaTypeCodec<JsonObject?> {
  ...
  internal object PostSetupIntentsIntentCancelFormCodec : MediaTypeCodec<InlineV1SetupIntentsCancelPostRequestFormXde74045b?> {
  ...
  internal object PostSetupIntentsIntentVerifyMicrodepositsFormCodec : MediaTypeCodec<InlineV1SetupIntentsVerifyMicrodepositsPostRequestFormX01f1f47d?> {
...
public class SetupIntentsClient(
  ...
  public companion object {
    internal val getSetupIntentsMetadata: OperationMetadata by
    ...
    internal val getSetupIntentsIntentMetadata: OperationMetadata by
        lazy(LazyThreadSafetyMode.PUBLICATION) { OperationMetadata(
    ...
    internal val postSetupIntentsIntentCancelMetadata: OperationMetadata by
        lazy(LazyThreadSafetyMode.PUBLICATION) { OperationMetadata(
    ...
    internal val postSetupIntentsIntentVerifyMicrodepositsMetadata: OperationMetadata by
        lazy(LazyThreadSafetyMode.PUBLICATION) { OperationMetadata(
