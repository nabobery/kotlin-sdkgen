...
public class InlineCreditNotesPretaxCreditAmountDiscountX67821026 internal constructor(
  ...
  public val matchedBranches: Set<InlineCreditNotesPretaxCreditAmountDiscountX67821026Branch>
    get() = buildSet {
      ...
      if (inspection.matchesDeletedDiscount) add(InlineCreditNotesPretaxCreditAmountDiscountX67821026Branch.DeletedDiscount)
    }
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineCreditNotesPretaxCreditAmountDiscountX67821026 {
      val inspection = inspectInlineCreditNotesPretaxCreditAmountDiscountX67821026(raw)
      if (inspection.matchCount == 0) {
        throw InlineCreditNotesPretaxCreditAmountDiscountX67821026NoMatchException("InlineCreditNotesPretaxCreditAmountDiscountX67821026 matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineCreditNotesPretaxCreditAmountDiscountX67821026(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineCreditNotesPretaxCreditAmountDiscountX67821026> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineCreditNotesPretaxCreditAmountDiscountX67821026) {
      encoder.requireJsonEncoder("InlineCreditNotesPretaxCreditAmountDiscountX67821026").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineCreditNotesPretaxCreditAmountDiscountX67821026(element: JsonElement): InlineCreditNotesPretaxCreditAmountDiscountX67821026Inspection {
