package io.github.nabobery.sdkgen.generated.stripe.taxcodes
...
import io.github.nabobery.sdkgen.generated.stripe.InlineV1TaxCodesGetResponse200JsonX445fad4b
import io.github.nabobery.sdkgen.generated.stripe.SdkJson
import io.github.nabobery.sdkgen.generated.stripe.TaxCode
import kotlin.Int
...
internal object TaxCodesCodecs {
  internal const val GETTAXCODES_REQUEST_CODEC_ID: String = "GetTaxCodes.request"
  ...
  internal val getTaxCodesResponseCodecAlternative0Registry:
  ...
  internal val getTaxCodesResponseCodecAlternative1Registry: MediaTypeCodecRegistry<Error> =
      MediaTypeCodecRegistry.of(getTaxCodesResponseCodecAlternative1Codec)

  internal val getTaxCodesRequestCodecRegistry: MediaTypeCodecRegistry<JsonObject?> =
      MediaTypeCodecRegistry.of(getTaxCodesRequestCodec)

  internal const val GETTAXCODESID_REQUEST_CODEC_ID: String = "GetTaxCodesId.request"
  ...
  internal val getTaxCodesIdResponseCodecAlternative0Registry: MediaTypeCodecRegistry<TaxCode> =
  ...
  internal val getTaxCodesIdResponseCodecAlternative1Registry: MediaTypeCodecRegistry<Error> =
      MediaTypeCodecRegistry.of(getTaxCodesIdResponseCodecAlternative1Codec)

  internal val getTaxCodesIdRequestCodecRegistry: MediaTypeCodecRegistry<JsonObject?> =
      MediaTypeCodecRegistry.of(getTaxCodesIdRequestCodec)

  internal object GetTaxCodesFormCodec : MediaTypeCodec<JsonObject?> {
  ...
  internal object GetTaxCodesIdFormCodec : MediaTypeCodec<JsonObject?> {
...
public class TaxCodesClient(
  ...
  public companion object {
    internal val getTaxCodesMetadata: OperationMetadata by
    ...
    internal val getTaxCodesIdMetadata: OperationMetadata by
        lazy(LazyThreadSafetyMode.PUBLICATION) { OperationMetadata(
