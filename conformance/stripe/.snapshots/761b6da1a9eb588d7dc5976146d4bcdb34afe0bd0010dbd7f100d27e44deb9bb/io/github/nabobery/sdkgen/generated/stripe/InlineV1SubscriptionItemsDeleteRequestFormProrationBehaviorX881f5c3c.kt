...
public sealed class InlineV1SubscriptionItemsDeleteRequestFormProrationBehaviorX881f5c3c {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1SubscriptionItemsDeleteRequestFormProrationBehaviorX881f5c3c = when (value) {
  ...
  internal object Serializer : KSerializer<InlineV1SubscriptionItemsDeleteRequestFormProrationBehaviorX881f5c3c> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1SubscriptionItemsDeleteRequestFormProrationBehaviorX881f5c3c", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1SubscriptionItemsDeleteRequestFormProrationBehaviorX881f5c3c = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1SubscriptionItemsDeleteRequestFormProrationBehaviorX881f5c3c) {
