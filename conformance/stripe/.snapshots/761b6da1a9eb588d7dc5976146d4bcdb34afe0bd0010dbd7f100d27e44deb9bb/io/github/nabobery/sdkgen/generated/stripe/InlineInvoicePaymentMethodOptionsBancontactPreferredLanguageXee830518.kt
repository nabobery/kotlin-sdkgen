...
public sealed class InlineInvoicePaymentMethodOptionsBancontactPreferredLanguageXee830518 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineInvoicePaymentMethodOptionsBancontactPreferredLanguageXee830518 = when (value) {
      De.value -> De
      En.value -> En
      Fr.value -> Fr
      Nl.value -> Nl
  ...
  internal object Serializer : KSerializer<InlineInvoicePaymentMethodOptionsBancontactPreferredLanguageXee830518> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineInvoicePaymentMethodOptionsBancontactPreferredLanguageXee830518", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineInvoicePaymentMethodOptionsBancontactPreferredLanguageXee830518 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineInvoicePaymentMethodOptionsBancontactPreferredLanguageXee830518) {
