...
public sealed class InlineV1CustomersSubscriptionsPostRequestFormRequestThreeDSecureX815619db {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1CustomersSubscriptionsPostRequestFormRequestThreeDSecureX815619db = when (value) {
      Any.value -> Any
  ...
  internal object Serializer : KSerializer<InlineV1CustomersSubscriptionsPostRequestFormRequestThreeDSecureX815619db> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1CustomersSubscriptionsPostRequestFormRequestThreeDSecureX815619db", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1CustomersSubscriptionsPostRequestFormRequestThreeDSecureX815619db = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1CustomersSubscriptionsPostRequestFormRequestThreeDSecureX815619db) {
