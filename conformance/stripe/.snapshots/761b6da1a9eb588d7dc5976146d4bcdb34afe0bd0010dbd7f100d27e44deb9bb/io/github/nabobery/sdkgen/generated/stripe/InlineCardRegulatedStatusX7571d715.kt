...
public sealed class InlineCardRegulatedStatusX7571d715 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineCardRegulatedStatusX7571d715 = when (value) {
  ...
  internal object Serializer : KSerializer<InlineCardRegulatedStatusX7571d715> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineCardRegulatedStatusX7571d715", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineCardRegulatedStatusX7571d715 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineCardRegulatedStatusX7571d715) {
