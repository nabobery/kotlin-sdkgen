...
public sealed class InlineBankConnectionsResourceAccountNumberDetailsStatusX0a0ad0ea {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineBankConnectionsResourceAccountNumberDetailsStatusX0a0ad0ea = when (value) {
  ...
  internal object Serializer : KSerializer<InlineBankConnectionsResourceAccountNumberDetailsStatusX0a0ad0ea> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineBankConnectionsResourceAccountNumberDetailsStatusX0a0ad0ea", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineBankConnectionsResourceAccountNumberDetailsStatusX0a0ad0ea = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineBankConnectionsResourceAccountNumberDetailsStatusX0a0ad0ea) {
