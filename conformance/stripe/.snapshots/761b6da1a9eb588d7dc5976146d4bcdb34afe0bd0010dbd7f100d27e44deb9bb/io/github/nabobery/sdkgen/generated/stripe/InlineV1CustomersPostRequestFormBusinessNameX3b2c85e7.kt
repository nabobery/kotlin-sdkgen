...
public class InlineV1CustomersPostRequestFormBusinessNameX3b2c85e7 internal constructor(
  ...
  public val inlineV1CustomersPostRequestFormBusinessNameAnyOf2X41449add:
      ...
      lazy(LazyThreadSafetyMode.NONE) { if (inspection.matchesInlineV1CustomersPostRequestFormBusinessNameAnyOf2X41449add) json.decodeFromJsonElement<InlineV1CustomersPostRequestFormBusinessNameAnyOf2X41449add>(raw) else null }
  ...
  public val matchedBranches: Set<InlineV1CustomersPostRequestFormBusinessNameX3b2c85e7Branch>
    get() = buildSet {
      ...
      if (inspection.matchesInlineV1CustomersPostRequestFormBusinessNameAnyOf2X41449add) add(InlineV1CustomersPostRequestFormBusinessNameX3b2c85e7Branch.InlineV1CustomersPostRequestFormBusinessNameAnyOf2X41449add)
    }
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineV1CustomersPostRequestFormBusinessNameX3b2c85e7 {
      val inspection = inspectInlineV1CustomersPostRequestFormBusinessNameX3b2c85e7(raw)
      if (inspection.matchCount == 0) {
        throw InlineV1CustomersPostRequestFormBusinessNameX3b2c85e7NoMatchException("InlineV1CustomersPostRequestFormBusinessNameX3b2c85e7 matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineV1CustomersPostRequestFormBusinessNameX3b2c85e7(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineV1CustomersPostRequestFormBusinessNameX3b2c85e7> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1CustomersPostRequestFormBusinessNameX3b2c85e7) {
      encoder.requireJsonEncoder("InlineV1CustomersPostRequestFormBusinessNameX3b2c85e7").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineV1CustomersPostRequestFormBusinessNameX3b2c85e7(element: JsonElement): InlineV1CustomersPostRequestFormBusinessNameX3b2c85e7Inspection {
  val matchesBranch1 = element.isJsonDecodable<String>()
  val matchesInlineV1CustomersPostRequestFormBusinessNameAnyOf2X41449add = element.isJsonDecodable<InlineV1CustomersPostRequestFormBusinessNameAnyOf2X41449add>()
  return InlineV1CustomersPostRequestFormBusinessNameX3b2c85e7Inspection(
    ...
    failures = buildList {
      ...
      if (!matchesInlineV1CustomersPostRequestFormBusinessNameAnyOf2X41449add) add("InlineV1CustomersPostRequestFormBusinessNameAnyOf2X41449add: value does not match InlineV1CustomersPostRequestFormBusinessNameAnyOf2X41449add")
    },
  )
}
