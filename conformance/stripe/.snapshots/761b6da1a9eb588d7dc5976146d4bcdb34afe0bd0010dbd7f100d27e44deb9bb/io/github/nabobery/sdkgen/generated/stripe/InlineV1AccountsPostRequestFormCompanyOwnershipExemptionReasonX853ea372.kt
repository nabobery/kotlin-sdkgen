...
public sealed class InlineV1AccountsPostRequestFormCompanyOwnershipExemptionReasonX853ea372 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1AccountsPostRequestFormCompanyOwnershipExemptionReasonX853ea372 = when (value) {
      Value.value -> Value
  ...
  internal object Serializer : KSerializer<InlineV1AccountsPostRequestFormCompanyOwnershipExemptionReasonX853ea372> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1AccountsPostRequestFormCompanyOwnershipExemptionReasonX853ea372", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1AccountsPostRequestFormCompanyOwnershipExemptionReasonX853ea372 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1AccountsPostRequestFormCompanyOwnershipExemptionReasonX853ea372) {
