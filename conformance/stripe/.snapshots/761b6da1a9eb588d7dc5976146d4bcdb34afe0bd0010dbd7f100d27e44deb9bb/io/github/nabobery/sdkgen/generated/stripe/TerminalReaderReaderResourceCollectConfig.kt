...
public class TerminalReaderReaderResourceCollectConfig(
  ...
  public class Builder {
    ...
    public fun build(): TerminalReaderReaderResourceCollectConfig = TerminalReaderReaderResourceCollectConfig(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): TerminalReaderReaderResourceCollectConfig = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<TerminalReaderReaderResourceCollectConfig> {
    ...
    override fun deserialize(decoder: Decoder): TerminalReaderReaderResourceCollectConfig {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("TerminalReaderReaderResourceCollectConfig must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: TerminalReaderReaderResourceCollectConfig) {
...
public fun terminalReaderReaderResourceCollectConfig(block: TerminalReaderReaderResourceCollectConfig.Builder.() -> Unit): TerminalReaderReaderResourceCollectConfig = TerminalReaderReaderResourceCollectConfig.build(block)
