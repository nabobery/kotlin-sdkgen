...
public sealed class InlineV1AccountsPostRequestFormSettingsPayoutsScheduleIntervalX777e235e {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1AccountsPostRequestFormSettingsPayoutsScheduleIntervalX777e235e = when (value) {
      Daily.value -> Daily
      Manual.value -> Manual
  ...
  internal object Serializer : KSerializer<InlineV1AccountsPostRequestFormSettingsPayoutsScheduleIntervalX777e235e> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1AccountsPostRequestFormSettingsPayoutsScheduleIntervalX777e235e", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1AccountsPostRequestFormSettingsPayoutsScheduleIntervalX777e235e = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1AccountsPostRequestFormSettingsPayoutsScheduleIntervalX777e235e) {
