...
public sealed class InlineAccountCapabilitiesKlarnaPaymentsX12f964c5 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineAccountCapabilitiesKlarnaPaymentsX12f964c5 = when (value) {
      Active.value -> Active
  ...
  internal object Serializer : KSerializer<InlineAccountCapabilitiesKlarnaPaymentsX12f964c5> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineAccountCapabilitiesKlarnaPaymentsX12f964c5", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineAccountCapabilitiesKlarnaPaymentsX12f964c5 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineAccountCapabilitiesKlarnaPaymentsX12f964c5) {
