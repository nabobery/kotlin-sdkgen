...
public class InlineV1TerminalLocationsPostRequestFormPhoneX618229f9 internal constructor(
  ...
  public val inlineV1TerminalLocationsPostRequestFormPhoneAnyOf2X0e5d19e5:
      ...
      lazy(LazyThreadSafetyMode.NONE) { if (inspection.matchesInlineV1TerminalLocationsPostRequestFormPhoneAnyOf2X0e5d19e5) json.decodeFromJsonElement<InlineV1TerminalLocationsPostRequestFormPhoneAnyOf2X0e5d19e5>(raw) else null }
  ...
  public val matchedBranches: Set<InlineV1TerminalLocationsPostRequestFormPhoneX618229f9Branch>
    get() = buildSet {
      ...
      if (inspection.matchesInlineV1TerminalLocationsPostRequestFormPhoneAnyOf2X0e5d19e5) add(InlineV1TerminalLocationsPostRequestFormPhoneX618229f9Branch.InlineV1TerminalLocationsPostRequestFormPhoneAnyOf2X0e5d19e5)
    }
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineV1TerminalLocationsPostRequestFormPhoneX618229f9 {
      val inspection = inspectInlineV1TerminalLocationsPostRequestFormPhoneX618229f9(raw)
      if (inspection.matchCount == 0) {
        throw InlineV1TerminalLocationsPostRequestFormPhoneX618229f9NoMatchException("InlineV1TerminalLocationsPostRequestFormPhoneX618229f9 matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineV1TerminalLocationsPostRequestFormPhoneX618229f9(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineV1TerminalLocationsPostRequestFormPhoneX618229f9> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1TerminalLocationsPostRequestFormPhoneX618229f9) {
      encoder.requireJsonEncoder("InlineV1TerminalLocationsPostRequestFormPhoneX618229f9").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineV1TerminalLocationsPostRequestFormPhoneX618229f9(element: JsonElement): InlineV1TerminalLocationsPostRequestFormPhoneX618229f9Inspection {
  val matchesBranch1 = element.isJsonDecodable<String>()
  val matchesInlineV1TerminalLocationsPostRequestFormPhoneAnyOf2X0e5d19e5 = element.isJsonDecodable<InlineV1TerminalLocationsPostRequestFormPhoneAnyOf2X0e5d19e5>()
  return InlineV1TerminalLocationsPostRequestFormPhoneX618229f9Inspection(
    ...
    failures = buildList {
      ...
      if (!matchesInlineV1TerminalLocationsPostRequestFormPhoneAnyOf2X0e5d19e5) add("InlineV1TerminalLocationsPostRequestFormPhoneAnyOf2X0e5d19e5: value does not match InlineV1TerminalLocationsPostRequestFormPhoneAnyOf2X0e5d19e5")
    },
  )
}
