...
public sealed class InlineTaxIdVerificationStatusX7596920a {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineTaxIdVerificationStatusX7596920a = when (value) {
  ...
  internal object Serializer : KSerializer<InlineTaxIdVerificationStatusX7596920a> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineTaxIdVerificationStatusX7596920a", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineTaxIdVerificationStatusX7596920a = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineTaxIdVerificationStatusX7596920a) {
