...
public sealed class InlineCreditNoteReasonX7a4479ce {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineCreditNoteReasonX7a4479ce = when (value) {
  ...
  internal object Serializer : KSerializer<InlineCreditNoteReasonX7a4479ce> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineCreditNoteReasonX7a4479ce", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineCreditNoteReasonX7a4479ce = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineCreditNoteReasonX7a4479ce) {
