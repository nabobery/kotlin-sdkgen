...
public sealed class InlinePaymentLinksResourceTaxIdCollectionRequiredXd1de9332 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlinePaymentLinksResourceTaxIdCollectionRequiredXd1de9332 = when (value) {
  ...
  internal object Serializer : KSerializer<InlinePaymentLinksResourceTaxIdCollectionRequiredXd1de9332> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlinePaymentLinksResourceTaxIdCollectionRequiredXd1de9332", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlinePaymentLinksResourceTaxIdCollectionRequiredXd1de9332 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlinePaymentLinksResourceTaxIdCollectionRequiredXd1de9332) {
