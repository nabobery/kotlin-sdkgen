...
public class InlineIssuingDisputeNotReceivedEvidenceAdditionalDocumentationX80cf7c95 internal constructor(
  ...
  public val matchedBranches:
    ...
    get() = buildSet {
      if (inspection.matchesBranch1) add(InlineIssuingDisputeNotReceivedEvidenceAdditionalDocumentationX80cf7c95Branch.Branch1)
      if (inspection.matchesFile) add(InlineIssuingDisputeNotReceivedEvidenceAdditionalDocumentationX80cf7c95Branch.File)
    }
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineIssuingDisputeNotReceivedEvidenceAdditionalDocumentationX80cf7c95 {
      val inspection = inspectInlineIssuingDisputeNotReceivedEvidenceAdditionalDocumentationX80cf7c95(raw)
      if (inspection.matchCount == 0) {
        throw InlineIssuingDisputeNotReceivedEvidenceAdditionalDocumentationX80cf7c95NoMatchException("InlineIssuingDisputeNotReceivedEvidenceAdditionalDocumentationX80cf7c95 matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineIssuingDisputeNotReceivedEvidenceAdditionalDocumentationX80cf7c95(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineIssuingDisputeNotReceivedEvidenceAdditionalDocumentationX80cf7c95> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineIssuingDisputeNotReceivedEvidenceAdditionalDocumentationX80cf7c95 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineIssuingDisputeNotReceivedEvidenceAdditionalDocumentationX80cf7c95")
      return fromRaw(jsonDecoder.decodeJsonElement(), jsonDecoder.json)
    }

    override fun serialize(encoder: Encoder, `value`: InlineIssuingDisputeNotReceivedEvidenceAdditionalDocumentationX80cf7c95) {
      encoder.requireJsonEncoder("InlineIssuingDisputeNotReceivedEvidenceAdditionalDocumentationX80cf7c95").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineIssuingDisputeNotReceivedEvidenceAdditionalDocumentationX80cf7c95(element: JsonElement): InlineIssuingDisputeNotReceivedEvidenceAdditionalDocumentationX80cf7c95Inspection {
