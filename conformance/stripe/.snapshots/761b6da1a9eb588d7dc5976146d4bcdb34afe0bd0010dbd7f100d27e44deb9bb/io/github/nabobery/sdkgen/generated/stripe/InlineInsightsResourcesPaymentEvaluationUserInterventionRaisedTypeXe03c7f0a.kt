...
public sealed class InlineInsightsResourcesPaymentEvaluationUserInterventionRaisedTypeXe03c7f0a {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineInsightsResourcesPaymentEvaluationUserInterventionRaisedTypeXe03c7f0a = when (value) {
      _3ds.value -> _3ds
  ...
  internal object Serializer : KSerializer<InlineInsightsResourcesPaymentEvaluationUserInterventionRaisedTypeXe03c7f0a> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineInsightsResourcesPaymentEvaluationUserInterventionRaisedTypeXe03c7f0a", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineInsightsResourcesPaymentEvaluationUserInterventionRaisedTypeXe03c7f0a = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineInsightsResourcesPaymentEvaluationUserInterventionRaisedTypeXe03c7f0a) {
