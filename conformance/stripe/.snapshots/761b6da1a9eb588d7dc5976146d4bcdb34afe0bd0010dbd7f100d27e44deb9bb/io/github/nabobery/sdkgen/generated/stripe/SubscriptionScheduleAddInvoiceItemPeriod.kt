...
public class SubscriptionScheduleAddInvoiceItemPeriod(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): SubscriptionScheduleAddInvoiceItemPeriod = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<SubscriptionScheduleAddInvoiceItemPeriod> {
    ...
    override fun deserialize(decoder: Decoder): SubscriptionScheduleAddInvoiceItemPeriod {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("SubscriptionScheduleAddInvoiceItemPeriod must be a JSON object")
      val end = json.decodeRequired<SubscriptionSchedulesResourceInvoiceItemPeriodResourcePeriodEnd>(rawObject, "end")
      val start = json.decodeRequired<SubscriptionSchedulesResourceInvoiceItemPeriodResourcePeriodStart>(rawObject, "start")
      return SubscriptionScheduleAddInvoiceItemPeriod(
        end = end,
        start = start,
      )
    ...
    override fun serialize(encoder: Encoder, `value`: SubscriptionScheduleAddInvoiceItemPeriod) {
...
public fun subscriptionScheduleAddInvoiceItemPeriod(block: SubscriptionScheduleAddInvoiceItemPeriod.Builder.() -> Unit): SubscriptionScheduleAddInvoiceItemPeriod = SubscriptionScheduleAddInvoiceItemPeriod.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("SubscriptionScheduleAddInvoiceItemPeriod is missing required property '" + name + "'")
