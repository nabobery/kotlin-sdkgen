...
public class InlineV1AccountsPostRequestFormIndividualX5383dde5(
  ...
  public val fullNameAliases:
      InlineV1AccountsPostRequestFormIndividualFullNameAliasesXd2a66610? = null,
  ...
  public class Builder {
    ...
    public fun build(): InlineV1AccountsPostRequestFormIndividualX5383dde5 = InlineV1AccountsPostRequestFormIndividualX5383dde5(
      address = address,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1AccountsPostRequestFormIndividualX5383dde5 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1AccountsPostRequestFormIndividualX5383dde5> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1AccountsPostRequestFormIndividualX5383dde5 {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1AccountsPostRequestFormIndividualX5383dde5 must be a JSON object")
      return InlineV1AccountsPostRequestFormIndividualX5383dde5(
        address = rawObject["address"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormIndividualAddressX85fda2d4>(it) },
        addressKana = rawObject["address_kana"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormIndividualAddressKanaX6648cc74>(it) },
        addressKanji = rawObject["address_kanji"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormIndividualAddressKanjiX15cad2d0>(it) },
        dob = rawObject["dob"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormIndividualDobXdc1057be>(it) },
        ...
        fullNameAliases = rawObject["full_name_aliases"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormIndividualFullNameAliasesXd2a66610>(it) },
        ...
        metadata = rawObject["metadata"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormIndividualMetadataXbb2c33b3>(it) },
        phone = rawObject["phone"]?.let { json.decodeFromJsonElement<String>(it) },
        politicalExposure = rawObject["political_exposure"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormIndividualPoliticalExposureXf6099d5a>(it) },
        registeredAddress = rawObject["registered_address"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormIndividualRegisteredAddressXf099f458>(it) },
        relationship = rawObject["relationship"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormIndividualRelationshipX76dece08>(it) },
        ssnLast4 = rawObject["ssn_last_4"]?.let { json.decodeFromJsonElement<String>(it) },
        verification = rawObject["verification"]?.let { json.decodeFromJsonElement<InlineV1AccountsPostRequestFormIndividualVerificationX641c7c46>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineV1AccountsPostRequestFormIndividualX5383dde5) {
...
public fun inlineV1AccountsPostRequestFormIndividualX5383dde5(block: InlineV1AccountsPostRequestFormIndividualX5383dde5.Builder.() -> Unit): InlineV1AccountsPostRequestFormIndividualX5383dde5 = InlineV1AccountsPostRequestFormIndividualX5383dde5.build(block)
