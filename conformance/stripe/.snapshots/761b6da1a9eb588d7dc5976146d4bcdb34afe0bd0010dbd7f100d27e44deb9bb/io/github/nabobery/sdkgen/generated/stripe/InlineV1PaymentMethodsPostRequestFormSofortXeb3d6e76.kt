...
public class InlineV1PaymentMethodsPostRequestFormSofortXeb3d6e76(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1PaymentMethodsPostRequestFormSofortXeb3d6e76 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1PaymentMethodsPostRequestFormSofortXeb3d6e76> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1PaymentMethodsPostRequestFormSofortXeb3d6e76 {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1PaymentMethodsPostRequestFormSofortXeb3d6e76 must be a JSON object")
      val country = json.decodeRequired<InlineV1PaymentMethodsPostRequestFormSofortCountryX83678afa>(rawObject, "country")
      return InlineV1PaymentMethodsPostRequestFormSofortXeb3d6e76(
        country = country,
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineV1PaymentMethodsPostRequestFormSofortXeb3d6e76) {
...
public fun inlineV1PaymentMethodsPostRequestFormSofortXeb3d6e76(block: InlineV1PaymentMethodsPostRequestFormSofortXeb3d6e76.Builder.() -> Unit): InlineV1PaymentMethodsPostRequestFormSofortXeb3d6e76 = InlineV1PaymentMethodsPostRequestFormSofortXeb3d6e76.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineV1PaymentMethodsPostRequestFormSofortXeb3d6e76 is missing required property '" + name + "'")
