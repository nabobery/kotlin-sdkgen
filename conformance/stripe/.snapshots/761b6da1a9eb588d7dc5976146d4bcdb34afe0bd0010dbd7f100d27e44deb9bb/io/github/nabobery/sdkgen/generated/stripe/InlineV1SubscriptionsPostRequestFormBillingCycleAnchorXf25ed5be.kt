...
public sealed class InlineV1SubscriptionsPostRequestFormBillingCycleAnchorXf25ed5be {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1SubscriptionsPostRequestFormBillingCycleAnchorXf25ed5be = when (value) {
      Now.value -> Now
  ...
  internal object Serializer : KSerializer<InlineV1SubscriptionsPostRequestFormBillingCycleAnchorXf25ed5be> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1SubscriptionsPostRequestFormBillingCycleAnchorXf25ed5be", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1SubscriptionsPostRequestFormBillingCycleAnchorXf25ed5be = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1SubscriptionsPostRequestFormBillingCycleAnchorXf25ed5be) {
