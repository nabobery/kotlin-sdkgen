...
public sealed class InlineMandateAcssDebitPaymentScheduleX56c488b6 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineMandateAcssDebitPaymentScheduleX56c488b6 = when (value) {
  ...
  internal object Serializer : KSerializer<InlineMandateAcssDebitPaymentScheduleX56c488b6> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineMandateAcssDebitPaymentScheduleX56c488b6", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineMandateAcssDebitPaymentScheduleX56c488b6 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineMandateAcssDebitPaymentScheduleX56c488b6) {
