...
public class PaymentIntentNextActionPaynowDisplayQrCode(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): PaymentIntentNextActionPaynowDisplayQrCode = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<PaymentIntentNextActionPaynowDisplayQrCode> {
    ...
    override fun deserialize(decoder: Decoder): PaymentIntentNextActionPaynowDisplayQrCode {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("PaymentIntentNextActionPaynowDisplayQrCode must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: PaymentIntentNextActionPaynowDisplayQrCode) {
...
public fun paymentIntentNextActionPaynowDisplayQrCode(block: PaymentIntentNextActionPaynowDisplayQrCode.Builder.() -> Unit): PaymentIntentNextActionPaynowDisplayQrCode = PaymentIntentNextActionPaynowDisplayQrCode.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("PaymentIntentNextActionPaynowDisplayQrCode is missing required property '" + name + "'")
