...
public class GelatoRelatedPerson(
  ...
  internal object Serializer : KSerializer<GelatoRelatedPerson> {
    ...
    override fun deserialize(decoder: Decoder): GelatoRelatedPerson {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("GelatoRelatedPerson must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: GelatoRelatedPerson) {
...
public fun gelatoRelatedPerson(block: GelatoRelatedPerson.Builder.() -> Unit): GelatoRelatedPerson = GelatoRelatedPerson.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("GelatoRelatedPerson is missing required property '" + name + "'")
