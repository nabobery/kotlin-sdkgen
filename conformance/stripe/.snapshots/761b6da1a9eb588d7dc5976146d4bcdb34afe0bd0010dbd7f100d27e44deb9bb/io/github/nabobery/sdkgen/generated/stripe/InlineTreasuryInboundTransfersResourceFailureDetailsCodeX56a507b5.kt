...
public sealed class InlineTreasuryInboundTransfersResourceFailureDetailsCodeX56a507b5 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineTreasuryInboundTransfersResourceFailureDetailsCodeX56a507b5 = when (value) {
  ...
  internal object Serializer : KSerializer<InlineTreasuryInboundTransfersResourceFailureDetailsCodeX56a507b5> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineTreasuryInboundTransfersResourceFailureDetailsCodeX56a507b5", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineTreasuryInboundTransfersResourceFailureDetailsCodeX56a507b5 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineTreasuryInboundTransfersResourceFailureDetailsCodeX56a507b5) {
