...
public class RefundDestinationDetailsUsBankTransfer(
  ...
  public class Builder {
    ...
    public fun build(): RefundDestinationDetailsUsBankTransfer = RefundDestinationDetailsUsBankTransfer(
      reference = reference,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): RefundDestinationDetailsUsBankTransfer = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<RefundDestinationDetailsUsBankTransfer> {
    ...
    override fun deserialize(decoder: Decoder): RefundDestinationDetailsUsBankTransfer {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("RefundDestinationDetailsUsBankTransfer must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: RefundDestinationDetailsUsBankTransfer) {
...
public fun refundDestinationDetailsUsBankTransfer(block: RefundDestinationDetailsUsBankTransfer.Builder.() -> Unit): RefundDestinationDetailsUsBankTransfer = RefundDestinationDetailsUsBankTransfer.build(block)
