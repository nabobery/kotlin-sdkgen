...
public sealed class InlineV1SetupIntentsConfirmPostRequestFormCollectionMethodX5c8b77ab {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1SetupIntentsConfirmPostRequestFormCollectionMethodX5c8b77ab = when (value) {
      Value.value -> Value
      Paper.value -> Paper
  ...
  internal object Serializer : KSerializer<InlineV1SetupIntentsConfirmPostRequestFormCollectionMethodX5c8b77ab> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1SetupIntentsConfirmPostRequestFormCollectionMethodX5c8b77ab", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1SetupIntentsConfirmPostRequestFormCollectionMethodX5c8b77ab = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1SetupIntentsConfirmPostRequestFormCollectionMethodX5c8b77ab) {
