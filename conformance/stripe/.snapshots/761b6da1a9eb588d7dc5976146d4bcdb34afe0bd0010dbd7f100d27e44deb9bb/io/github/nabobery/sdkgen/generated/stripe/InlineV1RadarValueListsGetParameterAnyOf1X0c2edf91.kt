...
public class InlineV1RadarValueListsGetParameterAnyOf1X0c2edf91(
  ...
  public class Builder {
    ...
    public fun build(): InlineV1RadarValueListsGetParameterAnyOf1X0c2edf91 = InlineV1RadarValueListsGetParameterAnyOf1X0c2edf91(
      gt = gt,
      gte = gte,
      lt = lt,
      lte = lte,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1RadarValueListsGetParameterAnyOf1X0c2edf91 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1RadarValueListsGetParameterAnyOf1X0c2edf91> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1RadarValueListsGetParameterAnyOf1X0c2edf91 {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1RadarValueListsGetParameterAnyOf1X0c2edf91 must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1RadarValueListsGetParameterAnyOf1X0c2edf91) {
...
public fun inlineV1RadarValueListsGetParameterAnyOf1X0c2edf91(block: InlineV1RadarValueListsGetParameterAnyOf1X0c2edf91.Builder.() -> Unit): InlineV1RadarValueListsGetParameterAnyOf1X0c2edf91 = InlineV1RadarValueListsGetParameterAnyOf1X0c2edf91.build(block)
