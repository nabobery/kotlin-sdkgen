...
public class TaxProductResourceTaxAssociationTransactionAttemptsResourceErrored(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): TaxProductResourceTaxAssociationTransactionAttemptsResourceErrored = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<TaxProductResourceTaxAssociationTransactionAttemptsResourceErrored> {
    ...
    override fun deserialize(decoder: Decoder): TaxProductResourceTaxAssociationTransactionAttemptsResourceErrored {
      val jsonDecoder = decoder.requireJsonDecoder("TaxProductResourceTaxAssociationTransactionAttemptsResourceErrored")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("TaxProductResourceTaxAssociationTransactionAttemptsResourceErrored must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: TaxProductResourceTaxAssociationTransactionAttemptsResourceErrored) {
      val jsonEncoder = encoder.requireJsonEncoder("TaxProductResourceTaxAssociationTransactionAttemptsResourceErrored")
...
public fun taxProductResourceTaxAssociationTransactionAttemptsResourceErrored(block: TaxProductResourceTaxAssociationTransactionAttemptsResourceErrored.Builder.() -> Unit): TaxProductResourceTaxAssociationTransactionAttemptsResourceErrored = TaxProductResourceTaxAssociationTransactionAttemptsResourceErrored.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("TaxProductResourceTaxAssociationTransactionAttemptsResourceErrored is missing required property '" + name + "'")
