...
public sealed class InlineV1InvoicesPostRequestFormShippingCostShippingRateDataTaxBehaviorXd38659b5 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1InvoicesPostRequestFormShippingCostShippingRateDataTaxBehaviorXd38659b5 = when (value) {
  ...
  internal object Serializer : KSerializer<InlineV1InvoicesPostRequestFormShippingCostShippingRateDataTaxBehaviorXd38659b5> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1InvoicesPostRequestFormShippingCostShippingRateDataTaxBehaviorXd38659b5", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1InvoicesPostRequestFormShippingCostShippingRateDataTaxBehaviorXd38659b5 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1InvoicesPostRequestFormShippingCostShippingRateDataTaxBehaviorXd38659b5) {
