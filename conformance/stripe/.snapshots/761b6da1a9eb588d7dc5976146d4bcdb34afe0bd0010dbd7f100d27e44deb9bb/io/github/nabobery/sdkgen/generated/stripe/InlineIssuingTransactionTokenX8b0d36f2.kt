...
public class InlineIssuingTransactionTokenX8b0d36f2 internal constructor(
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineIssuingTransactionTokenX8b0d36f2 {
      val inspection = inspectInlineIssuingTransactionTokenX8b0d36f2(raw)
      if (inspection.matchCount == 0) {
        throw InlineIssuingTransactionTokenX8b0d36f2NoMatchException("InlineIssuingTransactionTokenX8b0d36f2 matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineIssuingTransactionTokenX8b0d36f2(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineIssuingTransactionTokenX8b0d36f2> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineIssuingTransactionTokenX8b0d36f2) {
      encoder.requireJsonEncoder("InlineIssuingTransactionTokenX8b0d36f2").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineIssuingTransactionTokenX8b0d36f2(element: JsonElement): InlineIssuingTransactionTokenX8b0d36f2Inspection {
