...
public sealed class InlineInsightsResourcesPayd3e6AddressPostalCodeCheckXc9bbccff {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineInsightsResourcesPayd3e6AddressPostalCodeCheckXc9bbccff = when (value) {
      Fail.value -> Fail
      Pass.value -> Pass
  ...
  internal object Serializer : KSerializer<InlineInsightsResourcesPayd3e6AddressPostalCodeCheckXc9bbccff> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineInsightsResourcesPayd3e6AddressPostalCodeCheckXc9bbccff", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineInsightsResourcesPayd3e6AddressPostalCodeCheckXc9bbccff = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineInsightsResourcesPayd3e6AddressPostalCodeCheckXc9bbccff) {
