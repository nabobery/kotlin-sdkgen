...
public sealed class InlineV1QuotesPostRequestFormLineItemsItemPriceDataRecurringIntervalX3ea2750b {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1QuotesPostRequestFormLineItemsItemPriceDataRecurringIntervalX3ea2750b = when (value) {
      Day.value -> Day
      Month.value -> Month
      Week.value -> Week
      Year.value -> Year
  ...
  internal object Serializer : KSerializer<InlineV1QuotesPostRequestFormLineItemsItemPriceDataRecurringIntervalX3ea2750b> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1QuotesPostRequestFormLineItemsItemPriceDataRecurringIntervalX3ea2750b", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1QuotesPostRequestFormLineItemsItemPriceDataRecurringIntervalX3ea2750b = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1QuotesPostRequestFormLineItemsItemPriceDataRecurringIntervalX3ea2750b) {
