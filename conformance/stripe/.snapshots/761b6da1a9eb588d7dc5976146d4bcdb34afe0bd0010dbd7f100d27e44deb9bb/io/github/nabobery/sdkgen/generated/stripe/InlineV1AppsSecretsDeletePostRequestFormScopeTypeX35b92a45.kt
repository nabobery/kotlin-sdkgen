...
public sealed class InlineV1AppsSecretsDeletePostRequestFormScopeTypeX35b92a45 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1AppsSecretsDeletePostRequestFormScopeTypeX35b92a45 = when (value) {
  ...
  internal object Serializer : KSerializer<InlineV1AppsSecretsDeletePostRequestFormScopeTypeX35b92a45> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1AppsSecretsDeletePostRequestFormScopeTypeX35b92a45", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1AppsSecretsDeletePostRequestFormScopeTypeX35b92a45 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1AppsSecretsDeletePostRequestFormScopeTypeX35b92a45) {
