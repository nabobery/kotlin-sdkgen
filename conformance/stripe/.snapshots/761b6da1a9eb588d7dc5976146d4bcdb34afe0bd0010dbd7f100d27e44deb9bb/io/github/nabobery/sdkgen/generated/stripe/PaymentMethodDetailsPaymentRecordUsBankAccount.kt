...
public class PaymentMethodDetailsPaymentRecordUsBankAccount(
  ...
  public class Builder {
    ...
    public fun build(): PaymentMethodDetailsPaymentRecordUsBankAccount = PaymentMethodDetailsPaymentRecordUsBankAccount(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): PaymentMethodDetailsPaymentRecordUsBankAccount = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<PaymentMethodDetailsPaymentRecordUsBankAccount> {
    ...
    override fun deserialize(decoder: Decoder): PaymentMethodDetailsPaymentRecordUsBankAccount {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("PaymentMethodDetailsPaymentRecordUsBankAccount must be a JSON object")
      return PaymentMethodDetailsPaymentRecordUsBankAccount(
        accountHolderType = rawObject["account_holder_type"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlinePaymentMethodDetailsPaymentRecordUsBankAccountAccountHolderTypeXc426e6d6?>(element) },
        accountType = rawObject["account_type"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlinePaymentMethodDetailsPaymentRecordUsBankAccountAccountTypeX3764d783?>(element) },
        ...
        mandate = rawObject["mandate"]?.let { json.decodeFromJsonElement<InlinePaymentMethodDetailsPaymentRecordUsBankAccountMandateX66eea151>(it) },
    ...
    override fun serialize(encoder: Encoder, `value`: PaymentMethodDetailsPaymentRecordUsBankAccount) {
...
public fun paymentMethodDetailsPaymentRecordUsBankAccount(block: PaymentMethodDetailsPaymentRecordUsBankAccount.Builder.() -> Unit): PaymentMethodDetailsPaymentRecordUsBankAccount = PaymentMethodDetailsPaymentRecordUsBankAccount.build(block)
