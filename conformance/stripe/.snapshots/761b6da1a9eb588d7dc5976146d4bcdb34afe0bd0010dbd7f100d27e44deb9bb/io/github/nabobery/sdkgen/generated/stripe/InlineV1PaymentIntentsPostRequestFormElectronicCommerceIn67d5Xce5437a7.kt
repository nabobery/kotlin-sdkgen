...
public sealed class InlineV1PaymentIntentsPostRequestFormElectronicCommerceIn67d5Xce5437a7 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1PaymentIntentsPostRequestFormElectronicCommerceIn67d5Xce5437a7 = when (value) {
      _01.value -> _01
      _02.value -> _02
      _05.value -> _05
      _06.value -> _06
  ...
  internal object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormElectronicCommerceIn67d5Xce5437a7> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1PaymentIntentsPostRequestFormElectronicCommerceIn67d5Xce5437a7", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1PaymentIntentsPostRequestFormElectronicCommerceIn67d5Xce5437a7 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1PaymentIntentsPostRequestFormElectronicCommerceIn67d5Xce5437a7) {
