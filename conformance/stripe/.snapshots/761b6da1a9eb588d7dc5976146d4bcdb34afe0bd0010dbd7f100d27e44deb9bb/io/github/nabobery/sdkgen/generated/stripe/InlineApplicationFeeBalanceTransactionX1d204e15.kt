...
public class InlineApplicationFeeBalanceTransactionX1d204e15 internal constructor(
  ...
  public val matchedBranches: Set<InlineApplicationFeeBalanceTransactionX1d204e15Branch>
    get() = buildSet {
      ...
      if (inspection.matchesBalanceTransaction) add(InlineApplicationFeeBalanceTransactionX1d204e15Branch.BalanceTransaction)
    }
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineApplicationFeeBalanceTransactionX1d204e15 {
      val inspection = inspectInlineApplicationFeeBalanceTransactionX1d204e15(raw)
      if (inspection.matchCount == 0) {
        throw InlineApplicationFeeBalanceTransactionX1d204e15NoMatchException("InlineApplicationFeeBalanceTransactionX1d204e15 matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineApplicationFeeBalanceTransactionX1d204e15(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineApplicationFeeBalanceTransactionX1d204e15> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineApplicationFeeBalanceTransactionX1d204e15) {
      encoder.requireJsonEncoder("InlineApplicationFeeBalanceTransactionX1d204e15").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineApplicationFeeBalanceTransactionX1d204e15(element: JsonElement): InlineApplicationFeeBalanceTransactionX1d204e15Inspection {
