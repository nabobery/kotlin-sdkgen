...
public sealed class InlineGelatoDocumentReportTypeXef41d7e5 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineGelatoDocumentReportTypeXef41d7e5 = when (value) {
  ...
  internal object Serializer : KSerializer<InlineGelatoDocumentReportTypeXef41d7e5> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineGelatoDocumentReportTypeXef41d7e5", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineGelatoDocumentReportTypeXef41d7e5 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineGelatoDocumentReportTypeXef41d7e5) {
