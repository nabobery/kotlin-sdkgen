...
public sealed class InlineBillingPortalSessionObjectValueX21dda222 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineBillingPortalSessionObjectValueX21dda222 = when (value) {
      BillingPortalSession.value -> BillingPortalSession
      else -> SdkUnknown(value)
    }
  }

  internal object Serializer : KSerializer<InlineBillingPortalSessionObjectValueX21dda222> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineBillingPortalSessionObjectValueX21dda222", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineBillingPortalSessionObjectValueX21dda222 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineBillingPortalSessionObjectValueX21dda222) {
