...
public sealed class InlineV1TreasuryOutboundTrc70dPostRequestFormTypeX63a048a1 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1TreasuryOutboundTrc70dPostRequestFormTypeX63a048a1 = when (value) {
      FinancialAccount.value -> FinancialAccount
      else -> SdkUnknown(value)
    }
  }

  internal object Serializer : KSerializer<InlineV1TreasuryOutboundTrc70dPostRequestFormTypeX63a048a1> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1TreasuryOutboundTrc70dPostRequestFormTypeX63a048a1", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1TreasuryOutboundTrc70dPostRequestFormTypeX63a048a1 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1TreasuryOutboundTrc70dPostRequestFormTypeX63a048a1) {
