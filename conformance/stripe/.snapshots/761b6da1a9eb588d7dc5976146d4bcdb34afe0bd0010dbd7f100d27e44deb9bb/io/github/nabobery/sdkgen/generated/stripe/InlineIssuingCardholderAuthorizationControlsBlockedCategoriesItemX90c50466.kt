...
public sealed class InlineIssuingCardholderAuthorizationControlsBlockedCategoriesItemX90c50466 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineIssuingCardholderAuthorizationControlsBlockedCategoriesItemX90c50466 = when (value) {
  ...
  internal object Serializer : KSerializer<InlineIssuingCardholderAuthorizationControlsBlockedCategoriesItemX90c50466> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineIssuingCardholderAuthorizationControlsBlockedCategoriesItemX90c50466", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineIssuingCardholderAuthorizationControlsBlockedCategoriesItemX90c50466 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineIssuingCardholderAuthorizationControlsBlockedCategoriesItemX90c50466) {
