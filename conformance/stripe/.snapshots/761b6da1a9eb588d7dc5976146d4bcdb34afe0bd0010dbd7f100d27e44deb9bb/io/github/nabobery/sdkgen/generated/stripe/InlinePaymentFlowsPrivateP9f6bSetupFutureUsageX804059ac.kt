...
public sealed class InlinePaymentFlowsPrivateP9f6bSetupFutureUsageX804059ac {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlinePaymentFlowsPrivateP9f6bSetupFutureUsageX804059ac = when (value) {
      None.value -> None
  ...
  internal object Serializer : KSerializer<InlinePaymentFlowsPrivateP9f6bSetupFutureUsageX804059ac> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlinePaymentFlowsPrivateP9f6bSetupFutureUsageX804059ac", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlinePaymentFlowsPrivateP9f6bSetupFutureUsageX804059ac = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlinePaymentFlowsPrivateP9f6bSetupFutureUsageX804059ac) {
