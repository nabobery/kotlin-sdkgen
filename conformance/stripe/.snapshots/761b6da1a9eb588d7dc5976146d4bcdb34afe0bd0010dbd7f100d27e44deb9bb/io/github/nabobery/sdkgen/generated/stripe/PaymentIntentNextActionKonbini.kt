...
public class PaymentIntentNextActionKonbini(
  ...
  internal object Serializer : KSerializer<PaymentIntentNextActionKonbini> {
    ...
    override fun deserialize(decoder: Decoder): PaymentIntentNextActionKonbini {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("PaymentIntentNextActionKonbini must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: PaymentIntentNextActionKonbini) {
...
public fun paymentIntentNextActionKonbini(block: PaymentIntentNextActionKonbini.Builder.() -> Unit): PaymentIntentNextActionKonbini = PaymentIntentNextActionKonbini.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("PaymentIntentNextActionKonbini is missing required property '" + name + "'")
