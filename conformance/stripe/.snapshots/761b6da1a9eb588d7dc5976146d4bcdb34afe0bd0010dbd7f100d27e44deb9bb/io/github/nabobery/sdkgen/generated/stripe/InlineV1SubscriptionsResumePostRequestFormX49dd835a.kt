...
public class InlineV1SubscriptionsResumePostRequestFormX49dd835a(
  ...
  public class Builder {
    ...
    public fun build(): InlineV1SubscriptionsResumePostRequestFormX49dd835a = InlineV1SubscriptionsResumePostRequestFormX49dd835a(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1SubscriptionsResumePostRequestFormX49dd835a = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1SubscriptionsResumePostRequestFormX49dd835a> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1SubscriptionsResumePostRequestFormX49dd835a {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1SubscriptionsResumePostRequestFormX49dd835a must be a JSON object")
      return InlineV1SubscriptionsResumePostRequestFormX49dd835a(
        billingCycleAnchor = rawObject["billing_cycle_anchor"]?.let { json.decodeFromJsonElement<InlineV1SubscriptionsResumePostRequestFormBillingCycleAnchorXbcb7599e>(it) },
        expand = rawObject["expand"]?.let { json.decodeFromJsonElement<List<String>>(it) },
        prorationBehavior = rawObject["proration_behavior"]?.let { json.decodeFromJsonElement<InlineV1SubscriptionsResumePostRequestFormProrationBehaviorX4d5c438a>(it) },
        prorationDate = rawObject["proration_date"]?.let { json.decodeFromJsonElement<Int>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineV1SubscriptionsResumePostRequestFormX49dd835a) {
...
public fun inlineV1SubscriptionsResumePostRequestFormX49dd835a(block: InlineV1SubscriptionsResumePostRequestFormX49dd835a.Builder.() -> Unit): InlineV1SubscriptionsResumePostRequestFormX49dd835a = InlineV1SubscriptionsResumePostRequestFormX49dd835a.build(block)
