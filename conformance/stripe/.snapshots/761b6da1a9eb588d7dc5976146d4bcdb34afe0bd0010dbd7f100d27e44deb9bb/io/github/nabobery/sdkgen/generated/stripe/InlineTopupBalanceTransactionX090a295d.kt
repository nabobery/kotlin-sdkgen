...
public class InlineTopupBalanceTransactionX090a295d internal constructor(
  ...
  public val matchedBranches: Set<InlineTopupBalanceTransactionX090a295dBranch>
    get() = buildSet {
      ...
      if (inspection.matchesBalanceTransaction) add(InlineTopupBalanceTransactionX090a295dBranch.BalanceTransaction)
    }
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineTopupBalanceTransactionX090a295d {
      val inspection = inspectInlineTopupBalanceTransactionX090a295d(raw)
      if (inspection.matchCount == 0) {
        throw InlineTopupBalanceTransactionX090a295dNoMatchException("InlineTopupBalanceTransactionX090a295d matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineTopupBalanceTransactionX090a295d(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineTopupBalanceTransactionX090a295d> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineTopupBalanceTransactionX090a295d) {
      encoder.requireJsonEncoder("InlineTopupBalanceTransactionX090a295d").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineTopupBalanceTransactionX090a295d(element: JsonElement): InlineTopupBalanceTransactionX090a295dInspection {
