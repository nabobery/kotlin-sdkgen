...
public sealed class InlineBillingMeterEventSummaryObjectValueX1b2b2ac7 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineBillingMeterEventSummaryObjectValueX1b2b2ac7 = when (value) {
      BillingMeterEventSummary.value -> BillingMeterEventSummary
      else -> SdkUnknown(value)
    }
  }

  internal object Serializer : KSerializer<InlineBillingMeterEventSummaryObjectValueX1b2b2ac7> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineBillingMeterEventSummaryObjectValueX1b2b2ac7", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineBillingMeterEventSummaryObjectValueX1b2b2ac7 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineBillingMeterEventSummaryObjectValueX1b2b2ac7) {
