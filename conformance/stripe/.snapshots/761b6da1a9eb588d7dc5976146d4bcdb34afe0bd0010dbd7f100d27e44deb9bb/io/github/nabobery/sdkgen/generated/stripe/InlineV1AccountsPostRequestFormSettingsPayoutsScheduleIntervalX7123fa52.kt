...
public sealed class InlineV1AccountsPostRequestFormSettingsPayoutsScheduleIntervalX7123fa52 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1AccountsPostRequestFormSettingsPayoutsScheduleIntervalX7123fa52 = when (value) {
      Daily.value -> Daily
      Manual.value -> Manual
  ...
  internal object Serializer : KSerializer<InlineV1AccountsPostRequestFormSettingsPayoutsScheduleIntervalX7123fa52> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1AccountsPostRequestFormSettingsPayoutsScheduleIntervalX7123fa52", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1AccountsPostRequestFormSettingsPayoutsScheduleIntervalX7123fa52 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1AccountsPostRequestFormSettingsPayoutsScheduleIntervalX7123fa52) {
