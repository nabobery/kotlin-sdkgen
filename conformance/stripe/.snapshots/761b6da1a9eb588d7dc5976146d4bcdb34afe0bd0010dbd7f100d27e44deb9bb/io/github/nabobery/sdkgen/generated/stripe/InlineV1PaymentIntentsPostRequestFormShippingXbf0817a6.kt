...
public class InlineV1PaymentIntentsPostRequestFormShippingXbf0817a6(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1PaymentIntentsPostRequestFormShippingXbf0817a6 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormShippingXbf0817a6> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1PaymentIntentsPostRequestFormShippingXbf0817a6 {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1PaymentIntentsPostRequestFormShippingXbf0817a6 must be a JSON object")
      val address = json.decodeRequired<InlineV1PaymentIntentsPostRequestFormShippingAddressX1edc3736>(rawObject, "address")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1PaymentIntentsPostRequestFormShippingXbf0817a6) {
...
public fun inlineV1PaymentIntentsPostRequestFormShippingXbf0817a6(block: InlineV1PaymentIntentsPostRequestFormShippingXbf0817a6.Builder.() -> Unit): InlineV1PaymentIntentsPostRequestFormShippingXbf0817a6 = InlineV1PaymentIntentsPostRequestFormShippingXbf0817a6.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineV1PaymentIntentsPostRequestFormShippingXbf0817a6 is missing required property '" + name + "'")
