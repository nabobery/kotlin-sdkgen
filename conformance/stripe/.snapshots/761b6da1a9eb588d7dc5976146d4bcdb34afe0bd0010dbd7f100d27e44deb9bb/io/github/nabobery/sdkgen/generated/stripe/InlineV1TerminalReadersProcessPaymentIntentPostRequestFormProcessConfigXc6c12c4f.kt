...
public class InlineV1TerminalReadersProcessPaymentIntentPostRequestFormProcessConfigXc6c12c4f(
  public val allowRedisplay:
      InlineV1TerminalReadersProe407PostRequestFormAllowRedisplayX678ec0cd? = null,
  public val enableCustomerCancellation: Boolean? = null,
  public val returnUrl: String? = null,
  public val skipTipping: Boolean? = null,
  public val tipping:
      InlineV1TerminalReadersProe407PostRequestFormProcessConfigTippingX78e613d4? = null,
) {
  public class Builder {
    ...
    public fun build(): InlineV1TerminalReadersProcessPaymentIntentPostRequestFormProcessConfigXc6c12c4f = InlineV1TerminalReadersProcessPaymentIntentPostRequestFormProcessConfigXc6c12c4f(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1TerminalReadersProcessPaymentIntentPostRequestFormProcessConfigXc6c12c4f = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1TerminalReadersProcessPaymentIntentPostRequestFormProcessConfigXc6c12c4f> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineV1TerminalReadersProcessPaymentIntentPostRequestFormProcessConfigXc6c12c4f {
      val jsonDecoder = decoder.requireJsonDecoder("InlineV1TerminalReadersProcessPaymentIntentPostRequestFormProcessConfigXc6c12c4f")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1TerminalReadersProcessPaymentIntentPostRequestFormProcessConfigXc6c12c4f must be a JSON object")
      return InlineV1TerminalReadersProcessPaymentIntentPostRequestFormProcessConfigXc6c12c4f(
        allowRedisplay = rawObject["allow_redisplay"]?.let { json.decodeFromJsonElement<InlineV1TerminalReadersProe407PostRequestFormAllowRedisplayX678ec0cd>(it) },
        ...
        tipping = rawObject["tipping"]?.let { json.decodeFromJsonElement<InlineV1TerminalReadersProe407PostRequestFormProcessConfigTippingX78e613d4>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineV1TerminalReadersProcessPaymentIntentPostRequestFormProcessConfigXc6c12c4f) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineV1TerminalReadersProcessPaymentIntentPostRequestFormProcessConfigXc6c12c4f")
...
public fun inlineV1TerminalReadersProcessPaymentIntentPostRequestFormProcessConfigXc6c12c4f(block: InlineV1TerminalReadersProcessPaymentIntentPostRequestFormProcessConfigXc6c12c4f.Builder.() -> Unit): InlineV1TerminalReadersProcessPaymentIntentPostRequestFormProcessConfigXc6c12c4f = InlineV1TerminalReadersProcessPaymentIntentPostRequestFormProcessConfigXc6c12c4f.build(block)
