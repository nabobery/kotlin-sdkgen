...
public sealed class InlineDeletedTerminalReaderDeviceTypeX5fd400f5 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineDeletedTerminalReaderDeviceTypeX5fd400f5 = when (value) {
  ...
  internal object Serializer : KSerializer<InlineDeletedTerminalReaderDeviceTypeX5fd400f5> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineDeletedTerminalReaderDeviceTypeX5fd400f5", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineDeletedTerminalReaderDeviceTypeX5fd400f5 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineDeletedTerminalReaderDeviceTypeX5fd400f5) {
