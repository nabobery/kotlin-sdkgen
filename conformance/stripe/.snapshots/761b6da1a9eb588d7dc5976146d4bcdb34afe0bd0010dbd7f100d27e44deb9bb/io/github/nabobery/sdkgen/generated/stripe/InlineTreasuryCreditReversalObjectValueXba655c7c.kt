...
public sealed class InlineTreasuryCreditReversalObjectValueXba655c7c {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineTreasuryCreditReversalObjectValueXba655c7c = when (value) {
      TreasuryCreditReversal.value -> TreasuryCreditReversal
      else -> SdkUnknown(value)
    }
  }

  internal object Serializer : KSerializer<InlineTreasuryCreditReversalObjectValueXba655c7c> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineTreasuryCreditReversalObjectValueXba655c7c", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineTreasuryCreditReversalObjectValueXba655c7c = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineTreasuryCreditReversalObjectValueXba655c7c) {
