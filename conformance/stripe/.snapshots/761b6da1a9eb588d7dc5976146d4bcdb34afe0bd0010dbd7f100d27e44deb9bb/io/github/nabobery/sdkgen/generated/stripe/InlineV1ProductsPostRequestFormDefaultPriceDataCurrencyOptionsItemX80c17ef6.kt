...
public class InlineV1ProductsPostRequestFormDefaultPriceDataCurrencyOptionsItemX80c17ef6(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1ProductsPostRequestFormDefaultPriceDataCurrencyOptionsItemX80c17ef6 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1ProductsPostRequestFormDefaultPriceDataCurrencyOptionsItemX80c17ef6> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineV1ProductsPostRequestFormDefaultPriceDataCurrencyOptionsItemX80c17ef6 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineV1ProductsPostRequestFormDefaultPriceDataCurrencyOptionsItemX80c17ef6")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1ProductsPostRequestFormDefaultPriceDataCurrencyOptionsItemX80c17ef6 must be a JSON object")
      val upTo = json.decodeRequired<InlineV1ProductsPostRequestFormDefaultPriceDataCurrencyOptionsUpToX187a4074>(rawObject, "up_to")
      return InlineV1ProductsPostRequestFormDefaultPriceDataCurrencyOptionsItemX80c17ef6(
        upTo = upTo,
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1ProductsPostRequestFormDefaultPriceDataCurrencyOptionsItemX80c17ef6) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineV1ProductsPostRequestFormDefaultPriceDataCurrencyOptionsItemX80c17ef6")
...
public fun inlineV1ProductsPostRequestFormDefaultPriceDataCurrencyOptionsItemX80c17ef6(block: InlineV1ProductsPostRequestFormDefaultPriceDataCurrencyOptionsItemX80c17ef6.Builder.() -> Unit): InlineV1ProductsPostRequestFormDefaultPriceDataCurrencyOptionsItemX80c17ef6 = InlineV1ProductsPostRequestFormDefaultPriceDataCurrencyOptionsItemX80c17ef6.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineV1ProductsPostRequestFormDefaultPriceDataCurrencyOptionsItemX80c17ef6 is missing required property '" + name + "'")
