...
public sealed class InlineAccountCapabilityRequirementsDisabledReasonXbebf8378 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineAccountCapabilityRequirementsDisabledReasonXbebf8378 = when (value) {
      Other.value -> Other
  ...
  internal object Serializer : KSerializer<InlineAccountCapabilityRequirementsDisabledReasonXbebf8378> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineAccountCapabilityRequirementsDisabledReasonXbebf8378", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineAccountCapabilityRequirementsDisabledReasonXbebf8378 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineAccountCapabilityRequirementsDisabledReasonXbebf8378) {
