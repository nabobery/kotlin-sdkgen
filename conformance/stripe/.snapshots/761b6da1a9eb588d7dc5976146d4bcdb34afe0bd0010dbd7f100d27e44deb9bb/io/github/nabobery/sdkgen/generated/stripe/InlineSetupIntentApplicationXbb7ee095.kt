...
public class InlineSetupIntentApplicationXbb7ee095 internal constructor(
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineSetupIntentApplicationXbb7ee095 {
      val inspection = inspectInlineSetupIntentApplicationXbb7ee095(raw)
      if (inspection.matchCount == 0) {
        throw InlineSetupIntentApplicationXbb7ee095NoMatchException("InlineSetupIntentApplicationXbb7ee095 matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineSetupIntentApplicationXbb7ee095(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineSetupIntentApplicationXbb7ee095> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineSetupIntentApplicationXbb7ee095) {
      encoder.requireJsonEncoder("InlineSetupIntentApplicationXbb7ee095").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineSetupIntentApplicationXbb7ee095(element: JsonElement): InlineSetupIntentApplicationXbb7ee095Inspection {
