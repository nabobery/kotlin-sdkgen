...
public class TaxProductResourceTaxSettingsStatusDetails(
  ...
  public class Builder {
    ...
    public fun build(): TaxProductResourceTaxSettingsStatusDetails = TaxProductResourceTaxSettingsStatusDetails(
      active = active,
      pending = pending,
    )
  }
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): TaxProductResourceTaxSettingsStatusDetails = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<TaxProductResourceTaxSettingsStatusDetails> {
    ...
    override fun deserialize(decoder: Decoder): TaxProductResourceTaxSettingsStatusDetails {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("TaxProductResourceTaxSettingsStatusDetails must be a JSON object")
      return TaxProductResourceTaxSettingsStatusDetails(
        active = rawObject["active"]?.let { json.decodeFromJsonElement<JsonObject>(it) },
        pending = rawObject["pending"]?.let { json.decodeFromJsonElement<TaxProductResourceTaxSettingsStatusDetailsResourcePending>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: TaxProductResourceTaxSettingsStatusDetails) {
...
public fun taxProductResourceTaxSettingsStatusDetails(block: TaxProductResourceTaxSettingsStatusDetails.Builder.() -> Unit): TaxProductResourceTaxSettingsStatusDetails = TaxProductResourceTaxSettingsStatusDetails.build(block)
