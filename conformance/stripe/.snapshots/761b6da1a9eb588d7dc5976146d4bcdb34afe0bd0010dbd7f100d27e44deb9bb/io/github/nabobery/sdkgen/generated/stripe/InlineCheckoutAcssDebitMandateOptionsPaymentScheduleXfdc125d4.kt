...
public sealed class InlineCheckoutAcssDebitMandateOptionsPaymentScheduleXfdc125d4 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineCheckoutAcssDebitMandateOptionsPaymentScheduleXfdc125d4 = when (value) {
  ...
  internal object Serializer : KSerializer<InlineCheckoutAcssDebitMandateOptionsPaymentScheduleXfdc125d4> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineCheckoutAcssDebitMandateOptionsPaymentScheduleXfdc125d4", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineCheckoutAcssDebitMandateOptionsPaymentScheduleXfdc125d4 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineCheckoutAcssDebitMandateOptionsPaymentScheduleXfdc125d4) {
