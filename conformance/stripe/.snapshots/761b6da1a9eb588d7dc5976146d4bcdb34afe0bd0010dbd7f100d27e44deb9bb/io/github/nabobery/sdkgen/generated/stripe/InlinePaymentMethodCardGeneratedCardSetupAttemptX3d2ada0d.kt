...
public class InlinePaymentMethodCardGeneratedCardSetupAttemptX3d2ada0d internal constructor(
  ...
  public val matchedBranches: Set<InlinePaymentMethodCardGeneratedCardSetupAttemptX3d2ada0dBranch>
    get() = buildSet {
      if (inspection.matchesBranch1) add(InlinePaymentMethodCardGeneratedCardSetupAttemptX3d2ada0dBranch.Branch1)
      if (inspection.matchesSetupAttempt) add(InlinePaymentMethodCardGeneratedCardSetupAttemptX3d2ada0dBranch.SetupAttempt)
    }
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlinePaymentMethodCardGeneratedCardSetupAttemptX3d2ada0d {
      val inspection = inspectInlinePaymentMethodCardGeneratedCardSetupAttemptX3d2ada0d(raw)
      if (inspection.matchCount == 0) {
        throw InlinePaymentMethodCardGeneratedCardSetupAttemptX3d2ada0dNoMatchException("InlinePaymentMethodCardGeneratedCardSetupAttemptX3d2ada0d matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlinePaymentMethodCardGeneratedCardSetupAttemptX3d2ada0d(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlinePaymentMethodCardGeneratedCardSetupAttemptX3d2ada0d> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlinePaymentMethodCardGeneratedCardSetupAttemptX3d2ada0d) {
      encoder.requireJsonEncoder("InlinePaymentMethodCardGeneratedCardSetupAttemptX3d2ada0d").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlinePaymentMethodCardGeneratedCardSetupAttemptX3d2ada0d(element: JsonElement): InlinePaymentMethodCardGeneratedCardSetupAttemptX3d2ada0dInspection {
