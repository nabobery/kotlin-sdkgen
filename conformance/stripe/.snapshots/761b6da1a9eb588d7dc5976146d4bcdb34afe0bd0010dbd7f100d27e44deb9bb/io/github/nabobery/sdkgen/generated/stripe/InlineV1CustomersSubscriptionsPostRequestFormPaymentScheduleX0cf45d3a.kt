...
public sealed class InlineV1CustomersSubscriptionsPostRequestFormPaymentScheduleX0cf45d3a {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1CustomersSubscriptionsPostRequestFormPaymentScheduleX0cf45d3a = when (value) {
  ...
  internal object Serializer : KSerializer<InlineV1CustomersSubscriptionsPostRequestFormPaymentScheduleX0cf45d3a> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1CustomersSubscriptionsPostRequestFormPaymentScheduleX0cf45d3a", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1CustomersSubscriptionsPostRequestFormPaymentScheduleX0cf45d3a = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1CustomersSubscriptionsPostRequestFormPaymentScheduleX0cf45d3a) {
