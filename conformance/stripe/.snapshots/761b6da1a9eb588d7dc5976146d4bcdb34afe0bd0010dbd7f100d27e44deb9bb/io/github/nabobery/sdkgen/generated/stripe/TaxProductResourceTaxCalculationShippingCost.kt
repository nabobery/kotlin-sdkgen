...
@Serializable
public data class TaxProductResourceTaxCalculationShippingCostView internal constructor(
...
public class TaxProductResourceTaxCalculationShippingCost(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): TaxProductResourceTaxCalculationShippingCost = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<TaxProductResourceTaxCalculationShippingCost> {
    ...
    override fun deserialize(decoder: Decoder): TaxProductResourceTaxCalculationShippingCost {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("TaxProductResourceTaxCalculationShippingCost must be a JSON object")
      val amount = json.decodeRequired<Int>(rawObject, "amount")
      val amountTax = json.decodeRequired<Int>(rawObject, "amount_tax")
      val taxBehavior = json.decodeRequired<InlineTaxProductResourceTaxCalculationShippingCostTaxBehaviorX68f49075>(rawObject, "tax_behavior")
      ...
      return TaxProductResourceTaxCalculationShippingCost(
        ...
        taxBreakdown = rawObject["tax_breakdown"]?.let { json.decodeFromJsonElement<List<TaxProductResourceLineItemTaxBreakdown>>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: TaxProductResourceTaxCalculationShippingCost) {
...
public fun taxProductResourceTaxCalculationShippingCost(block: TaxProductResourceTaxCalculationShippingCost.Builder.() -> Unit): TaxProductResourceTaxCalculationShippingCost = TaxProductResourceTaxCalculationShippingCost.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("TaxProductResourceTaxCalculationShippingCost is missing required property '" + name + "'")
