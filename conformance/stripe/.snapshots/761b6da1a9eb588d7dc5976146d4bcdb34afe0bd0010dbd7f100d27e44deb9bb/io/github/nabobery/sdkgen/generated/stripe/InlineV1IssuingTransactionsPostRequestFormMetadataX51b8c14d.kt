...
internal data class InlineV1IssuingTransactionsPostRequestFormMetadataX51b8c14dInspection(
  ...
  public val matchCount: Int
    get() = listOf(matchesBranch1, matchesInlineV1IssuingTransactionsPostRequestFormMetadataAnyOf2X3a4f97b2).count { it }
}
...
public class InlineV1IssuingTransactionsPostRequestFormMetadataX51b8c14d internal constructor(
  ...
  public val inlineV1IssuingTransactionsPostRequestFormMetadataAnyOf2X3a4f97b2:
      ...
      lazy(LazyThreadSafetyMode.NONE) { if (inspection.matchesInlineV1IssuingTransactionsPostRequestFormMetadataAnyOf2X3a4f97b2) json.decodeFromJsonElement<InlineV1IssuingTransactionsPostRequestFormMetadataAnyOf2X3a4f97b2>(raw) else null }

  public val matchedBranches: Set<InlineV1IssuingTransactionsPostRequestFormMetadataX51b8c14dBranch>
    get() = buildSet {
      if (inspection.matchesBranch1) add(InlineV1IssuingTransactionsPostRequestFormMetadataX51b8c14dBranch.Branch1)
      if (inspection.matchesInlineV1IssuingTransactionsPostRequestFormMetadataAnyOf2X3a4f97b2) add(InlineV1IssuingTransactionsPostRequestFormMetadataX51b8c14dBranch.InlineV1IssuingTransactionsPostRequestFormMetadataAnyOf2X3a4f97b2)
    }
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineV1IssuingTransactionsPostRequestFormMetadataX51b8c14d {
      val inspection = inspectInlineV1IssuingTransactionsPostRequestFormMetadataX51b8c14d(raw)
      if (inspection.matchCount == 0) {
        throw InlineV1IssuingTransactionsPostRequestFormMetadataX51b8c14dNoMatchException("InlineV1IssuingTransactionsPostRequestFormMetadataX51b8c14d matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineV1IssuingTransactionsPostRequestFormMetadataX51b8c14d(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineV1IssuingTransactionsPostRequestFormMetadataX51b8c14d> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1IssuingTransactionsPostRequestFormMetadataX51b8c14d) {
      encoder.requireJsonEncoder("InlineV1IssuingTransactionsPostRequestFormMetadataX51b8c14d").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineV1IssuingTransactionsPostRequestFormMetadataX51b8c14d(element: JsonElement): InlineV1IssuingTransactionsPostRequestFormMetadataX51b8c14dInspection {
  val matchesBranch1 = element.isJsonDecodable<JsonObject>()
  val matchesInlineV1IssuingTransactionsPostRequestFormMetadataAnyOf2X3a4f97b2 = element.isJsonDecodable<InlineV1IssuingTransactionsPostRequestFormMetadataAnyOf2X3a4f97b2>()
  return InlineV1IssuingTransactionsPostRequestFormMetadataX51b8c14dInspection(
    ...
    failures = buildList {
      ...
      if (!matchesInlineV1IssuingTransactionsPostRequestFormMetadataAnyOf2X3a4f97b2) add("InlineV1IssuingTransactionsPostRequestFormMetadataAnyOf2X3a4f97b2: value does not match InlineV1IssuingTransactionsPostRequestFormMetadataAnyOf2X3a4f97b2")
    },
  )
}
