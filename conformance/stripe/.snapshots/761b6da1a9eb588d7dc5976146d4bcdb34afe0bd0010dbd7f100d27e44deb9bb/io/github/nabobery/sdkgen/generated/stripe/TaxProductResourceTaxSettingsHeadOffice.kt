...
public class TaxProductResourceTaxSettingsHeadOffice(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): TaxProductResourceTaxSettingsHeadOffice = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<TaxProductResourceTaxSettingsHeadOffice> {
    ...
    override fun deserialize(decoder: Decoder): TaxProductResourceTaxSettingsHeadOffice {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("TaxProductResourceTaxSettingsHeadOffice must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: TaxProductResourceTaxSettingsHeadOffice) {
...
public fun taxProductResourceTaxSettingsHeadOffice(block: TaxProductResourceTaxSettingsHeadOffice.Builder.() -> Unit): TaxProductResourceTaxSettingsHeadOffice = TaxProductResourceTaxSettingsHeadOffice.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("TaxProductResourceTaxSettingsHeadOffice is missing required property '" + name + "'")
