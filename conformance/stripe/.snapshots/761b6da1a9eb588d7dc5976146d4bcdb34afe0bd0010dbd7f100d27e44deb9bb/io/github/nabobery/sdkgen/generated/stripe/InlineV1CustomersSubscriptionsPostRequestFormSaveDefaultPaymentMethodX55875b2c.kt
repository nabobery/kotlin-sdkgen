...
public sealed class InlineV1CustomersSubscriptionsPostRequestFormSaveDefaultPaymentMethodX55875b2c {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1CustomersSubscriptionsPostRequestFormSaveDefaultPaymentMethodX55875b2c = when (value) {
      Off.value -> Off
  ...
  internal object Serializer : KSerializer<InlineV1CustomersSubscriptionsPostRequestFormSaveDefaultPaymentMethodX55875b2c> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1CustomersSubscriptionsPostRequestFormSaveDefaultPaymentMethodX55875b2c", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1CustomersSubscriptionsPostRequestFormSaveDefaultPaymentMethodX55875b2c = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1CustomersSubscriptionsPostRequestFormSaveDefaultPaymentMethodX55875b2c) {
