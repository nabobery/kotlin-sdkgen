...
public sealed class InlineTaxProductResourceTaxTransactionShippingCostTaxBehaviorXd2b0b279 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineTaxProductResourceTaxTransactionShippingCostTaxBehaviorXd2b0b279 = when (value) {
  ...
  internal object Serializer : KSerializer<InlineTaxProductResourceTaxTransactionShippingCostTaxBehaviorXd2b0b279> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineTaxProductResourceTaxTransactionShippingCostTaxBehaviorXd2b0b279", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineTaxProductResourceTaxTransactionShippingCostTaxBehaviorXd2b0b279 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineTaxProductResourceTaxTransactionShippingCostTaxBehaviorXd2b0b279) {
