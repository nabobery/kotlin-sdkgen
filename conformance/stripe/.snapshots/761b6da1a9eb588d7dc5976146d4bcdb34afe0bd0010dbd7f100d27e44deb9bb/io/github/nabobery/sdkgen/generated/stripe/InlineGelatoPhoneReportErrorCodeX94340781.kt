...
public sealed class InlineGelatoPhoneReportErrorCodeX94340781 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineGelatoPhoneReportErrorCodeX94340781 = when (value) {
  ...
  internal object Serializer : KSerializer<InlineGelatoPhoneReportErrorCodeX94340781> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineGelatoPhoneReportErrorCodeX94340781", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineGelatoPhoneReportErrorCodeX94340781 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineGelatoPhoneReportErrorCodeX94340781) {
