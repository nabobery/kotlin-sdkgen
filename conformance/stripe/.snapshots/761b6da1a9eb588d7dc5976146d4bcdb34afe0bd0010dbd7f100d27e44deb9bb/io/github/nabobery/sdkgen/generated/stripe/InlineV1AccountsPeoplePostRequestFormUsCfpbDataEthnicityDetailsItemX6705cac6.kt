...
public sealed class InlineV1AccountsPeoplePostRequestFormUsCfpbDataEthnicityDetailsItemX6705cac6 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1AccountsPeoplePostRequestFormUsCfpbDataEthnicityDetailsItemX6705cac6 = when (value) {
      Cuban.value -> Cuban
  ...
  internal object Serializer : KSerializer<InlineV1AccountsPeoplePostRequestFormUsCfpbDataEthnicityDetailsItemX6705cac6> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1AccountsPeoplePostRequestFormUsCfpbDataEthnicityDetailsItemX6705cac6", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1AccountsPeoplePostRequestFormUsCfpbDataEthnicityDetailsItemX6705cac6 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1AccountsPeoplePostRequestFormUsCfpbDataEthnicityDetailsItemX6705cac6) {
