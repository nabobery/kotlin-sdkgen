...
public sealed class InlineV1TestHelpersTreasured25PostRequestFormTypeXebb68e0d {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1TestHelpersTreasured25PostRequestFormTypeXebb68e0d = when (value) {
      UsBankAccount.value -> UsBankAccount
      else -> SdkUnknown(value)
    }
  }

  internal object Serializer : KSerializer<InlineV1TestHelpersTreasured25PostRequestFormTypeXebb68e0d> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1TestHelpersTreasured25PostRequestFormTypeXebb68e0d", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1TestHelpersTreasured25PostRequestFormTypeXebb68e0d = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1TestHelpersTreasured25PostRequestFormTypeXebb68e0d) {
