...
public class ConnectEmbeddedAccountConfigClaim(
  ...
  internal object Serializer : KSerializer<ConnectEmbeddedAccountConfigClaim> {
    ...
    override fun deserialize(decoder: Decoder): ConnectEmbeddedAccountConfigClaim {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("ConnectEmbeddedAccountConfigClaim must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: ConnectEmbeddedAccountConfigClaim) {
...
public fun connectEmbeddedAccountConfigClaim(block: ConnectEmbeddedAccountConfigClaim.Builder.() -> Unit): ConnectEmbeddedAccountConfigClaim = ConnectEmbeddedAccountConfigClaim.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("ConnectEmbeddedAccountConfigClaim is missing required property '" + name + "'")
