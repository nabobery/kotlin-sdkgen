...
public class ClimateRemovalsLocation(
  ...
  internal object Serializer : KSerializer<ClimateRemovalsLocation> {
    ...
    override fun deserialize(decoder: Decoder): ClimateRemovalsLocation {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("ClimateRemovalsLocation must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: ClimateRemovalsLocation) {
...
public fun climateRemovalsLocation(block: ClimateRemovalsLocation.Builder.() -> Unit): ClimateRemovalsLocation = ClimateRemovalsLocation.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("ClimateRemovalsLocation is missing required property '" + name + "'")
