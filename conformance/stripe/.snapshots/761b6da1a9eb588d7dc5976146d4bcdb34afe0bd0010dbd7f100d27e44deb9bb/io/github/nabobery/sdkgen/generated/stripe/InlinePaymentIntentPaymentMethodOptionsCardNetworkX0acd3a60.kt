...
public sealed class InlinePaymentIntentPaymentMethodOptionsCardNetworkX0acd3a60 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlinePaymentIntentPaymentMethodOptionsCardNetworkX0acd3a60 = when (value) {
      Amex.value -> Amex
  ...
  internal object Serializer : KSerializer<InlinePaymentIntentPaymentMethodOptionsCardNetworkX0acd3a60> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlinePaymentIntentPaymentMethodOptionsCardNetworkX0acd3a60", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlinePaymentIntentPaymentMethodOptionsCardNetworkX0acd3a60 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlinePaymentIntentPaymentMethodOptionsCardNetworkX0acd3a60) {
