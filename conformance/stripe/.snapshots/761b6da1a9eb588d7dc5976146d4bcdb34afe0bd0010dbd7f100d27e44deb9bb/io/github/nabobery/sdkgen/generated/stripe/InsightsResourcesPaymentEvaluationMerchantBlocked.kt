...
public class InsightsResourcesPaymentEvaluationMerchantBlocked(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InsightsResourcesPaymentEvaluationMerchantBlocked = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InsightsResourcesPaymentEvaluationMerchantBlocked> {
    ...
    override fun deserialize(decoder: Decoder): InsightsResourcesPaymentEvaluationMerchantBlocked {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InsightsResourcesPaymentEvaluationMerchantBlocked must be a JSON object")
      val reason = json.decodeRequired<InlineInsightsResourcesPaymentEvaluationMerchantBlockedReasonX2845e6fd>(rawObject, "reason")
      return InsightsResourcesPaymentEvaluationMerchantBlocked(
        reason = reason,
      )
    }

    override fun serialize(encoder: Encoder, `value`: InsightsResourcesPaymentEvaluationMerchantBlocked) {
...
public fun insightsResourcesPaymentEvaluationMerchantBlocked(block: InsightsResourcesPaymentEvaluationMerchantBlocked.Builder.() -> Unit): InsightsResourcesPaymentEvaluationMerchantBlocked = InsightsResourcesPaymentEvaluationMerchantBlocked.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InsightsResourcesPaymentEvaluationMerchantBlocked is missing required property '" + name + "'")
