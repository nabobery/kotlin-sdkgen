...
public sealed class InlinePaymentMethodDetailsPaymentRecordBancontactPreferredLanguageXe4a4fd58 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlinePaymentMethodDetailsPaymentRecordBancontactPreferredLanguageXe4a4fd58 = when (value) {
      De.value -> De
      En.value -> En
      Fr.value -> Fr
      Nl.value -> Nl
  ...
  internal object Serializer : KSerializer<InlinePaymentMethodDetailsPaymentRecordBancontactPreferredLanguageXe4a4fd58> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlinePaymentMethodDetailsPaymentRecordBancontactPreferredLanguageXe4a4fd58", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlinePaymentMethodDetailsPaymentRecordBancontactPreferredLanguageXe4a4fd58 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlinePaymentMethodDetailsPaymentRecordBancontactPreferredLanguageXe4a4fd58) {
