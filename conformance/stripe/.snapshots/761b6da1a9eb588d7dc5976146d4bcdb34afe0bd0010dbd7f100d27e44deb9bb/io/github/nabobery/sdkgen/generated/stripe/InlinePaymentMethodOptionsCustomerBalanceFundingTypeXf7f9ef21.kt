...
public sealed class InlinePaymentMethodOptionsCustomerBalanceFundingTypeXf7f9ef21 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlinePaymentMethodOptionsCustomerBalanceFundingTypeXf7f9ef21 = when (value) {
      BankTransfer.value -> BankTransfer
      else -> SdkUnknown(value)
    }
  }

  internal object Serializer : KSerializer<InlinePaymentMethodOptionsCustomerBalanceFundingTypeXf7f9ef21> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlinePaymentMethodOptionsCustomerBalanceFundingTypeXf7f9ef21", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlinePaymentMethodOptionsCustomerBalanceFundingTypeXf7f9ef21 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlinePaymentMethodOptionsCustomerBalanceFundingTypeXf7f9ef21) {
