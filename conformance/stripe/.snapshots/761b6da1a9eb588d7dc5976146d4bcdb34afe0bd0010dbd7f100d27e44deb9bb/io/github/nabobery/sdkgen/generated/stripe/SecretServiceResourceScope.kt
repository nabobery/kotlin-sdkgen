...
public class SecretServiceResourceScope(
  ...
  internal object Serializer : KSerializer<SecretServiceResourceScope> {
    ...
    override fun deserialize(decoder: Decoder): SecretServiceResourceScope {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("SecretServiceResourceScope must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: SecretServiceResourceScope) {
...
public fun secretServiceResourceScope(block: SecretServiceResourceScope.Builder.() -> Unit): SecretServiceResourceScope = SecretServiceResourceScope.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("SecretServiceResourceScope is missing required property '" + name + "'")
