...
public sealed class InlineV1PaymentIntentsPostRequestFormRequestThreeDSecureX2f01196e {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1PaymentIntentsPostRequestFormRequestThreeDSecureX2f01196e = when (value) {
      Any.value -> Any
  ...
  internal object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormRequestThreeDSecureX2f01196e> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1PaymentIntentsPostRequestFormRequestThreeDSecureX2f01196e", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1PaymentIntentsPostRequestFormRequestThreeDSecureX2f01196e = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1PaymentIntentsPostRequestFormRequestThreeDSecureX2f01196e) {
