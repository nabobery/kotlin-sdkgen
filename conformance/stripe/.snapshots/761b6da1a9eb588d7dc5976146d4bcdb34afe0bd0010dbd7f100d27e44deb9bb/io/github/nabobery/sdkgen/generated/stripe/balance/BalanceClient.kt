package io.github.nabobery.sdkgen.generated.stripe.balance
...
import io.github.nabobery.sdkgen.generated.stripe.Balance
import io.github.nabobery.sdkgen.generated.stripe.BalanceTransaction
import io.github.nabobery.sdkgen.generated.stripe.Error
import io.github.nabobery.sdkgen.generated.stripe.InlineV1BalanceHistoryGetParameterXc82176db
import io.github.nabobery.sdkgen.generated.stripe.InlineV1BalanceHistoryGetResponse200JsonXee492d75
...
internal object BalanceCodecs {
  internal const val GETBALANCE_REQUEST_CODEC_ID: String = "GetBalance.request"
  ...
  internal val getBalanceResponseCodecAlternative0Registry: MediaTypeCodecRegistry<Balance> =
  ...
  internal val getBalanceResponseCodecAlternative1Registry: MediaTypeCodecRegistry<Error> =
      MediaTypeCodecRegistry.of(getBalanceResponseCodecAlternative1Codec)

  internal val getBalanceRequestCodecRegistry: MediaTypeCodecRegistry<JsonObject?> =
      MediaTypeCodecRegistry.of(getBalanceRequestCodec)

  internal const val GETBALANCEHISTORY_REQUEST_CODEC_ID: String = "GetBalanceHistory.request"
  ...
  internal val getBalanceHistoryResponseCodecAlternative0Registry:
  ...
  internal val getBalanceHistoryResponseCodecAlternative1Registry: MediaTypeCodecRegistry<Error> =
      MediaTypeCodecRegistry.of(getBalanceHistoryResponseCodecAlternative1Codec)

  internal val getBalanceHistoryRequestCodecRegistry: MediaTypeCodecRegistry<JsonObject?> =
      MediaTypeCodecRegistry.of(getBalanceHistoryRequestCodec)

  internal const val GETBALANCEHISTORYID_REQUEST_CODEC_ID: String = "GetBalanceHistoryId.request"
  ...
  internal val getBalanceHistoryIdResponseCodecAlternative0Registry:
  ...
  internal val getBalanceHistoryIdResponseCodecAlternative1Registry: MediaTypeCodecRegistry<Error> =
      MediaTypeCodecRegistry.of(getBalanceHistoryIdResponseCodecAlternative1Codec)

  internal val getBalanceHistoryIdRequestCodecRegistry: MediaTypeCodecRegistry<JsonObject?> =
      MediaTypeCodecRegistry.of(getBalanceHistoryIdRequestCodec)

  internal object GetBalanceFormCodec : MediaTypeCodec<JsonObject?> {
  ...
  internal object GetBalanceHistoryFormCodec : MediaTypeCodec<JsonObject?> {
  ...
  internal object GetBalanceHistoryIdFormCodec : MediaTypeCodec<JsonObject?> {
...
public class BalanceClient(
  ...
  public companion object {
    internal val getBalanceMetadata: OperationMetadata by
    ...
    internal val getBalanceHistoryMetadata: OperationMetadata by
        lazy(LazyThreadSafetyMode.PUBLICATION) { OperationMetadata(
    ...
    internal val getBalanceHistoryIdMetadata: OperationMetadata by
        lazy(LazyThreadSafetyMode.PUBLICATION) { OperationMetadata(
