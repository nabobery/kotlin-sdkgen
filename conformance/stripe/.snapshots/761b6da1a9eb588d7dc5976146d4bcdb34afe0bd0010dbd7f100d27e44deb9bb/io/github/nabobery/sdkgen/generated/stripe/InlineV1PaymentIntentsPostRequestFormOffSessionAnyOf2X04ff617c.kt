...
public sealed class InlineV1PaymentIntentsPostRequestFormOffSessionAnyOf2X04ff617c {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1PaymentIntentsPostRequestFormOffSessionAnyOf2X04ff617c = when (value) {
      OneOff.value -> OneOff
  ...
  internal object Serializer : KSerializer<InlineV1PaymentIntentsPostRequestFormOffSessionAnyOf2X04ff617c> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1PaymentIntentsPostRequestFormOffSessionAnyOf2X04ff617c", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1PaymentIntentsPostRequestFormOffSessionAnyOf2X04ff617c = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1PaymentIntentsPostRequestFormOffSessionAnyOf2X04ff617c) {
