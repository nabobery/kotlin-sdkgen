...
public class InlineV1TaxRegistrationsPostRequestFormX98b4d7b7(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1TaxRegistrationsPostRequestFormX98b4d7b7 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1TaxRegistrationsPostRequestFormX98b4d7b7> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1TaxRegistrationsPostRequestFormX98b4d7b7 {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1TaxRegistrationsPostRequestFormX98b4d7b7 must be a JSON object")
      val activeFrom = json.decodeRequired<InlineV1TaxRegistrationsPostRequestFormActiveFromX0cdfd46a>(rawObject, "active_from")
      val country = json.decodeRequired<String>(rawObject, "country")
      val countryOptions = json.decodeRequired<InlineV1TaxRegistrationsPostRequestFormCountryOptionsX26279f3f>(rawObject, "country_options")
      return InlineV1TaxRegistrationsPostRequestFormX98b4d7b7(
        activeFrom = activeFrom,
        country = country,
        countryOptions = countryOptions,
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1TaxRegistrationsPostRequestFormX98b4d7b7) {
...
public fun inlineV1TaxRegistrationsPostRequestFormX98b4d7b7(block: InlineV1TaxRegistrationsPostRequestFormX98b4d7b7.Builder.() -> Unit): InlineV1TaxRegistrationsPostRequestFormX98b4d7b7 = InlineV1TaxRegistrationsPostRequestFormX98b4d7b7.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineV1TaxRegistrationsPostRequestFormX98b4d7b7 is missing required property '" + name + "'")
