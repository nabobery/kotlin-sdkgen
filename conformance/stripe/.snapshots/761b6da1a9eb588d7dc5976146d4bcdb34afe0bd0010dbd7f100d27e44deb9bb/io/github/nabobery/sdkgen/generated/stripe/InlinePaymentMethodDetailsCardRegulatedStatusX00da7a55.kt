...
public sealed class InlinePaymentMethodDetailsCardRegulatedStatusX00da7a55 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlinePaymentMethodDetailsCardRegulatedStatusX00da7a55 = when (value) {
  ...
  internal object Serializer : KSerializer<InlinePaymentMethodDetailsCardRegulatedStatusX00da7a55> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlinePaymentMethodDetailsCardRegulatedStatusX00da7a55", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlinePaymentMethodDetailsCardRegulatedStatusX00da7a55 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlinePaymentMethodDetailsCardRegulatedStatusX00da7a55) {
