...
public sealed class InlineV1PaymentLinksPostRequestFormPaymentMethodTypesAnyOf1ItemX5c826591 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1PaymentLinksPostRequestFormPaymentMethodTypesAnyOf1ItemX5c826591 = when (value) {
      Affirm.value -> Affirm
  ...
  internal object Serializer : KSerializer<InlineV1PaymentLinksPostRequestFormPaymentMethodTypesAnyOf1ItemX5c826591> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1PaymentLinksPostRequestFormPaymentMethodTypesAnyOf1ItemX5c826591", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1PaymentLinksPostRequestFormPaymentMethodTypesAnyOf1ItemX5c826591 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1PaymentLinksPostRequestFormPaymentMethodTypesAnyOf1ItemX5c826591) {
