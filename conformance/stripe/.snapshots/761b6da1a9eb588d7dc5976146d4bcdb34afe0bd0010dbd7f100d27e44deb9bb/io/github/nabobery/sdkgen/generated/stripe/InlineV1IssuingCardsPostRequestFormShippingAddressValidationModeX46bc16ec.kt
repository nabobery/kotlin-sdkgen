...
public sealed class InlineV1IssuingCardsPostRequestFormShippingAddressValidationModeX46bc16ec {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1IssuingCardsPostRequestFormShippingAddressValidationModeX46bc16ec = when (value) {
  ...
  internal object Serializer : KSerializer<InlineV1IssuingCardsPostRequestFormShippingAddressValidationModeX46bc16ec> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1IssuingCardsPostRequestFormShippingAddressValidationModeX46bc16ec", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1IssuingCardsPostRequestFormShippingAddressValidationModeX46bc16ec = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1IssuingCardsPostRequestFormShippingAddressValidationModeX46bc16ec) {
