...
public sealed class InlinePaymentPagesCheckoutSessionPaymentMethodReuseAgreementPositionX2a885d55 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlinePaymentPagesCheckoutSessionPaymentMethodReuseAgreementPositionX2a885d55 = when (value) {
      Auto.value -> Auto
      Hidden.value -> Hidden
  ...
  internal object Serializer : KSerializer<InlinePaymentPagesCheckoutSessionPaymentMethodReuseAgreementPositionX2a885d55> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlinePaymentPagesCheckoutSessionPaymentMethodReuseAgreementPositionX2a885d55", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlinePaymentPagesCheckoutSessionPaymentMethodReuseAgreementPositionX2a885d55 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlinePaymentPagesCheckoutSessionPaymentMethodReuseAgreementPositionX2a885d55) {
