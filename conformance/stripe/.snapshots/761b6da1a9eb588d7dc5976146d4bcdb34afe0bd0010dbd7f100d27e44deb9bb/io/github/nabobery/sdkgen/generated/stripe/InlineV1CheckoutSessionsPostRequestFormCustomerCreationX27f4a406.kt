...
public sealed class InlineV1CheckoutSessionsPostRequestFormCustomerCreationX27f4a406 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1CheckoutSessionsPostRequestFormCustomerCreationX27f4a406 = when (value) {
      Always.value -> Always
  ...
  internal object Serializer : KSerializer<InlineV1CheckoutSessionsPostRequestFormCustomerCreationX27f4a406> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1CheckoutSessionsPostRequestFormCustomerCreationX27f4a406", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1CheckoutSessionsPostRequestFormCustomerCreationX27f4a406 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1CheckoutSessionsPostRequestFormCustomerCreationX27f4a406) {
