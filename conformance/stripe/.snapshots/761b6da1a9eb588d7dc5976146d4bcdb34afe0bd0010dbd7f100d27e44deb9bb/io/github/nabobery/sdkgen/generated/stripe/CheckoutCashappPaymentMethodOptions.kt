...
public class CheckoutCashappPaymentMethodOptions(
  ...
  public val setupFutureUsage:
      InlineCheckoutCashappPaymentMethodOptionsSetupFutureUsageXbdddb245? = null,
) {
  public class Builder {
    ...
    public fun build(): CheckoutCashappPaymentMethodOptions = CheckoutCashappPaymentMethodOptions(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): CheckoutCashappPaymentMethodOptions = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<CheckoutCashappPaymentMethodOptions> {
    ...
    override fun deserialize(decoder: Decoder): CheckoutCashappPaymentMethodOptions {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("CheckoutCashappPaymentMethodOptions must be a JSON object")
      return CheckoutCashappPaymentMethodOptions(
        captureMethod = rawObject["capture_method"]?.let { json.decodeFromJsonElement<InlineCheckoutCashappPaymentMethodOptionsCaptureMethodXc921e582>(it) },
        setupFutureUsage = rawObject["setup_future_usage"]?.let { json.decodeFromJsonElement<InlineCheckoutCashappPaymentMethodOptionsSetupFutureUsageXbdddb245>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: CheckoutCashappPaymentMethodOptions) {
...
public fun checkoutCashappPaymentMethodOptions(block: CheckoutCashappPaymentMethodOptions.Builder.() -> Unit): CheckoutCashappPaymentMethodOptions = CheckoutCashappPaymentMethodOptions.build(block)
