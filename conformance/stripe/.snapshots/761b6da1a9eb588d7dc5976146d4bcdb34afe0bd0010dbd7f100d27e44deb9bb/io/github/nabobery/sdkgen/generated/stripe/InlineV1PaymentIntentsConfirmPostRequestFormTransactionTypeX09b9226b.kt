...
public sealed class InlineV1PaymentIntentsConfirmPostRequestFormTransactionTypeX09b9226b {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1PaymentIntentsConfirmPostRequestFormTransactionTypeX09b9226b = when (value) {
  ...
  internal object Serializer : KSerializer<InlineV1PaymentIntentsConfirmPostRequestFormTransactionTypeX09b9226b> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1PaymentIntentsConfirmPostRequestFormTransactionTypeX09b9226b", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1PaymentIntentsConfirmPostRequestFormTransactionTypeX09b9226b = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1PaymentIntentsConfirmPostRequestFormTransactionTypeX09b9226b) {
