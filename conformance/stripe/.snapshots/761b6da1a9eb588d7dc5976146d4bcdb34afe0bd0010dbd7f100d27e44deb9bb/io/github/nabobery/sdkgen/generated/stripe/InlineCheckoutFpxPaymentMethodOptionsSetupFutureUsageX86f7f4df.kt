...
public sealed class InlineCheckoutFpxPaymentMethodOptionsSetupFutureUsageX86f7f4df {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineCheckoutFpxPaymentMethodOptionsSetupFutureUsageX86f7f4df = when (value) {
      None.value -> None
      else -> SdkUnknown(value)
    }
  }

  internal object Serializer : KSerializer<InlineCheckoutFpxPaymentMethodOptionsSetupFutureUsageX86f7f4df> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineCheckoutFpxPaymentMethodOptionsSetupFutureUsageX86f7f4df", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineCheckoutFpxPaymentMethodOptionsSetupFutureUsageX86f7f4df = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineCheckoutFpxPaymentMethodOptionsSetupFutureUsageX86f7f4df) {
