...
public class InlineTreasuryDebitReversalTransactionX6d21296f internal constructor(
  ...
  public val matchedBranches: Set<InlineTreasuryDebitReversalTransactionX6d21296fBranch>
    get() = buildSet {
      ...
      if (inspection.matchesTreasuryTransaction) add(InlineTreasuryDebitReversalTransactionX6d21296fBranch.TreasuryTransaction)
    }
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineTreasuryDebitReversalTransactionX6d21296f {
      val inspection = inspectInlineTreasuryDebitReversalTransactionX6d21296f(raw)
      if (inspection.matchCount == 0) {
        throw InlineTreasuryDebitReversalTransactionX6d21296fNoMatchException("InlineTreasuryDebitReversalTransactionX6d21296f matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineTreasuryDebitReversalTransactionX6d21296f(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineTreasuryDebitReversalTransactionX6d21296f> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineTreasuryDebitReversalTransactionX6d21296f) {
      encoder.requireJsonEncoder("InlineTreasuryDebitReversalTransactionX6d21296f").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineTreasuryDebitReversalTransactionX6d21296f(element: JsonElement): InlineTreasuryDebitReversalTransactionX6d21296fInspection {
