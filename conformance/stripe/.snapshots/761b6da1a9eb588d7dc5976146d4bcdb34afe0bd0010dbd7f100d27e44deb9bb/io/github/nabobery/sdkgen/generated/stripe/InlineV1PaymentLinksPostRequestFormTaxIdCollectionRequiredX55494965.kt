...
public sealed class InlineV1PaymentLinksPostRequestFormTaxIdCollectionRequiredX55494965 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1PaymentLinksPostRequestFormTaxIdCollectionRequiredX55494965 = when (value) {
  ...
  internal object Serializer : KSerializer<InlineV1PaymentLinksPostRequestFormTaxIdCollectionRequiredX55494965> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1PaymentLinksPostRequestFormTaxIdCollectionRequiredX55494965", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1PaymentLinksPostRequestFormTaxIdCollectionRequiredX55494965 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1PaymentLinksPostRequestFormTaxIdCollectionRequiredX55494965) {
