...
/**
 * Forward-compatible enum for sdkgen://source/openapi.json#/paths/~1v1~1terminal~1readers/get/parameters/0/schema.
 *
 * Source: sdkgen://source/openapi.json#/paths/~1v1~1terminal~1readers/get/parameters/0/schema
 */
@Serializable(with = InlineV1TerminalReadersGetParameterX1c327cde.Serializer::class)
public sealed class InlineV1TerminalReadersGetParameterX1c327cde {
  public abstract val `value`: String

  /**
   * Documented value. Wire value: `bbpos_chipper2x`.
   */
  public data object BbposChipper2x : InlineV1TerminalReadersGetParameterX1c327cde() {
   ...
   */
  public data object BbposWisepad3 : InlineV1TerminalReadersGetParameterX1c327cde() {
   ...
   */
  public data object BbposWiseposE : InlineV1TerminalReadersGetParameterX1c327cde() {
   ...
   */
  public data object MobilePhoneReader : InlineV1TerminalReadersGetParameterX1c327cde() {
   ...
   */
  public data object SimulatedStripeS700 : InlineV1TerminalReadersGetParameterX1c327cde() {
   ...
   */
  public data object SimulatedStripeS710 : InlineV1TerminalReadersGetParameterX1c327cde() {
   ...
   */
  public data object SimulatedVerifoneM425 : InlineV1TerminalReadersGetParameterX1c327cde() {
   ...
   */
  public data object SimulatedVerifoneP630 : InlineV1TerminalReadersGetParameterX1c327cde() {
   ...
   */
  public data object SimulatedVerifoneUx700 : InlineV1TerminalReadersGetParameterX1c327cde() {
   ...
   */
  public data object SimulatedVerifoneV660p : InlineV1TerminalReadersGetParameterX1c327cde() {
   ...
   */
  public data object SimulatedWiseposE : InlineV1TerminalReadersGetParameterX1c327cde() {
   ...
   */
  public data object StripeM2 : InlineV1TerminalReadersGetParameterX1c327cde() {
   ...
   */
  public data object StripeS700 : InlineV1TerminalReadersGetParameterX1c327cde() {
   ...
   */
  public data object StripeS710 : InlineV1TerminalReadersGetParameterX1c327cde() {
   ...
   */
  public data object VerifoneP400 : InlineV1TerminalReadersGetParameterX1c327cde() {
   ...
   */
  public data object VerifoneM425 : InlineV1TerminalReadersGetParameterX1c327cde() {
   ...
   */
  public data object VerifoneP630 : InlineV1TerminalReadersGetParameterX1c327cde() {
   ...
   */
  public data object VerifoneUx700 : InlineV1TerminalReadersGetParameterX1c327cde() {
   ...
   */
  public data object VerifoneV660p : InlineV1TerminalReadersGetParameterX1c327cde() {
    public override val `value`: String = "verifone_v660p"
  }

  public data class SdkUnknown(
    public override val `value`: String,
  ) : InlineV1TerminalReadersGetParameterX1c327cde()

  public companion object {
    public fun fromValue(`value`: String): InlineV1TerminalReadersGetParameterX1c327cde = when (value) {
  ...
  internal object Serializer : KSerializer<InlineV1TerminalReadersGetParameterX1c327cde> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1TerminalReadersGetParameterX1c327cde", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1TerminalReadersGetParameterX1c327cde = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1TerminalReadersGetParameterX1c327cde) {
