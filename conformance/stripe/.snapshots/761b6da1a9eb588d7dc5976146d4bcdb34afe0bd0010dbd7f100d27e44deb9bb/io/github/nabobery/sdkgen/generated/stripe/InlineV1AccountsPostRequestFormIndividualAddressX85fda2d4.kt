...
public class InlineV1AccountsPostRequestFormIndividualAddressX85fda2d4(
  ...
  public class Builder {
    ...
    public fun build(): InlineV1AccountsPostRequestFormIndividualAddressX85fda2d4 = InlineV1AccountsPostRequestFormIndividualAddressX85fda2d4(
      city = city,
      country = country,
      line1 = line1,
      line2 = line2,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1AccountsPostRequestFormIndividualAddressX85fda2d4 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1AccountsPostRequestFormIndividualAddressX85fda2d4> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1AccountsPostRequestFormIndividualAddressX85fda2d4 {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1AccountsPostRequestFormIndividualAddressX85fda2d4 must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1AccountsPostRequestFormIndividualAddressX85fda2d4) {
...
public fun inlineV1AccountsPostRequestFormIndividualAddressX85fda2d4(block: InlineV1AccountsPostRequestFormIndividualAddressX85fda2d4.Builder.() -> Unit): InlineV1AccountsPostRequestFormIndividualAddressX85fda2d4 = InlineV1AccountsPostRequestFormIndividualAddressX85fda2d4.build(block)
