...
public sealed class InlineV1CustomersSubscriptionsPostRequestFormPauseCollectionBehaviorXdf428e23 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1CustomersSubscriptionsPostRequestFormPauseCollectionBehaviorXdf428e23 = when (value) {
  ...
  internal object Serializer : KSerializer<InlineV1CustomersSubscriptionsPostRequestFormPauseCollectionBehaviorXdf428e23> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1CustomersSubscriptionsPostRequestFormPauseCollectionBehaviorXdf428e23", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1CustomersSubscriptionsPostRequestFormPauseCollectionBehaviorXdf428e23 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1CustomersSubscriptionsPostRequestFormPauseCollectionBehaviorXdf428e23) {
