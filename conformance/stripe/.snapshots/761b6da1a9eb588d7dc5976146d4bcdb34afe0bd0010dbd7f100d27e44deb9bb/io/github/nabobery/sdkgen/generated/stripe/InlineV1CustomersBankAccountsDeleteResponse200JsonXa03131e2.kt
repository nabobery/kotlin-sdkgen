...
public class InlineV1CustomersBankAccountsDeleteResponse200JsonXa03131e2 internal constructor(
  ...
  public val matchedBranches: Set<InlineV1CustomersBankAccountsDeleteResponse200JsonXa03131e2Branch>
    get() = buildSet {
      if (inspection.matchesPaymentSource) add(InlineV1CustomersBankAccountsDeleteResponse200JsonXa03131e2Branch.PaymentSource)
      if (inspection.matchesDeletedPaymentSource) add(InlineV1CustomersBankAccountsDeleteResponse200JsonXa03131e2Branch.DeletedPaymentSource)
    }
  ...
  public companion object {
     ...
     */
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): InlineV1CustomersBankAccountsDeleteResponse200JsonXa03131e2 {
      val inspection = inspectInlineV1CustomersBankAccountsDeleteResponse200JsonXa03131e2(raw)
      if (inspection.matchCount == 0) {
        throw InlineV1CustomersBankAccountsDeleteResponse200JsonXa03131e2NoMatchException("InlineV1CustomersBankAccountsDeleteResponse200JsonXa03131e2 matched 0 branches: " + inspection.failures.joinToString("; "))
      }
      return InlineV1CustomersBankAccountsDeleteResponse200JsonXa03131e2(raw, json, inspection)
    }
  }

  internal object Serializer : KSerializer<InlineV1CustomersBankAccountsDeleteResponse200JsonXa03131e2> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineV1CustomersBankAccountsDeleteResponse200JsonXa03131e2) {
      encoder.requireJsonEncoder("InlineV1CustomersBankAccountsDeleteResponse200JsonXa03131e2").encodeJsonElement(value.raw)
    }
  }
}

private fun inspectInlineV1CustomersBankAccountsDeleteResponse200JsonXa03131e2(element: JsonElement): InlineV1CustomersBankAccountsDeleteResponse200JsonXa03131e2Inspection {
