...
public class InlineV1QuotesPostRequestFormX99c4efb9(
  ...
  public val applicationFeeAmount:
      InlineV1QuotesPostRequestFormApplicationFeeAmountX3daeb39d? = null,
  /**
  ...
  public val applicationFeePercent:
      InlineV1QuotesPostRequestFormApplicationFeePercentXb102a83e? = null,
  /**
  ...
  lineItems: List<InlineV1QuotesPostRequestFormLineItemsItemX6f3fab70>? = null,
   ...
   */
  public val lineItems: List<InlineV1QuotesPostRequestFormLineItemsItemX6f3fab70>? =
  ...
  public class Builder {
    ...
    private var lineItemsValue: List<InlineV1QuotesPostRequestFormLineItemsItemX6f3fab70>? = null

    /**
     * A list of line items the customer is being quoted for. Each line item includes information about the product, the
     * quantity, and the resulting cost.
     */
    public var lineItems: List<InlineV1QuotesPostRequestFormLineItemsItemX6f3fab70>?
    ...
    public fun build(): InlineV1QuotesPostRequestFormX99c4efb9 = InlineV1QuotesPostRequestFormX99c4efb9(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1QuotesPostRequestFormX99c4efb9 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1QuotesPostRequestFormX99c4efb9> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1QuotesPostRequestFormX99c4efb9 {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1QuotesPostRequestFormX99c4efb9 must be a JSON object")
      return InlineV1QuotesPostRequestFormX99c4efb9(
        applicationFeeAmount = rawObject["application_fee_amount"]?.let { json.decodeFromJsonElement<InlineV1QuotesPostRequestFormApplicationFeeAmountX3daeb39d>(it) },
        applicationFeePercent = rawObject["application_fee_percent"]?.let { json.decodeFromJsonElement<InlineV1QuotesPostRequestFormApplicationFeePercentXb102a83e>(it) },
        automaticTax = rawObject["automatic_tax"]?.let { json.decodeFromJsonElement<InlineV1QuotesPostRequestFormAutomaticTaxX2c209eca>(it) },
        collectionMethod = rawObject["collection_method"]?.let { json.decodeFromJsonElement<InlineV1QuotesPostRequestFormCollectionMethodXf5619bcc>(it) },
        ...
        defaultTaxRates = rawObject["default_tax_rates"]?.let { json.decodeFromJsonElement<InlineV1QuotesPostRequestFormDefaultTaxRatesXd69b66d3>(it) },
        description = rawObject["description"]?.let { json.decodeFromJsonElement<InlineV1QuotesPostRequestFormDescriptionX670239c2>(it) },
        discounts = rawObject["discounts"]?.let { json.decodeFromJsonElement<InlineV1QuotesPostRequestFormDiscountsXcce02801>(it) },
        expand = rawObject["expand"]?.let { json.decodeFromJsonElement<List<String>>(it) },
        expiresAt = rawObject["expires_at"]?.let { json.decodeFromJsonElement<Int>(it) },
        footer = rawObject["footer"]?.let { json.decodeFromJsonElement<InlineV1QuotesPostRequestFormFooterXd71da30b>(it) },
        fromQuote = rawObject["from_quote"]?.let { json.decodeFromJsonElement<InlineV1QuotesPostRequestFormFromQuoteXa868383a>(it) },
        header = rawObject["header"]?.let { json.decodeFromJsonElement<InlineV1QuotesPostRequestFormHeaderX35374ae5>(it) },
        invoiceSettings = rawObject["invoice_settings"]?.let { json.decodeFromJsonElement<InlineV1QuotesPostRequestFormInvoiceSettingsX8baa645b>(it) },
        lineItems = rawObject["line_items"]?.let { json.decodeFromJsonElement<List<InlineV1QuotesPostRequestFormLineItemsItemX6f3fab70>>(it) },
        metadata = rawObject["metadata"]?.let { json.decodeFromJsonElement<Map<String, String>>(it) },
        onBehalfOf = rawObject["on_behalf_of"]?.let { json.decodeFromJsonElement<InlineV1QuotesPostRequestFormOnBehalfOfX04b5ad02>(it) },
        subscriptionData = rawObject["subscription_data"]?.let { json.decodeFromJsonElement<InlineV1QuotesPostRequestFormSubscriptionDataXf3ca95d4>(it) },
        testClock = rawObject["test_clock"]?.let { json.decodeFromJsonElement<String>(it) },
        transferData = rawObject["transfer_data"]?.let { json.decodeFromJsonElement<InlineV1QuotesPostRequestFormTransferDataX3547f5d0>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineV1QuotesPostRequestFormX99c4efb9) {
...
public fun inlineV1QuotesPostRequestFormX99c4efb9(block: InlineV1QuotesPostRequestFormX99c4efb9.Builder.() -> Unit): InlineV1QuotesPostRequestFormX99c4efb9 = InlineV1QuotesPostRequestFormX99c4efb9.build(block)
