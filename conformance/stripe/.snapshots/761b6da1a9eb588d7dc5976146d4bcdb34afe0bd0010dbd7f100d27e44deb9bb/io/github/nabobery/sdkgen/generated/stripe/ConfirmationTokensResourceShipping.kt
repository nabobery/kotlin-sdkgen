...
public class ConfirmationTokensResourceShipping(
  ...
  internal object Serializer : KSerializer<ConfirmationTokensResourceShipping> {
    ...
    override fun deserialize(decoder: Decoder): ConfirmationTokensResourceShipping {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("ConfirmationTokensResourceShipping must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: ConfirmationTokensResourceShipping) {
...
public fun confirmationTokensResourceShipping(block: ConfirmationTokensResourceShipping.Builder.() -> Unit): ConfirmationTokensResourceShipping = ConfirmationTokensResourceShipping.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("ConfirmationTokensResourceShipping is missing required property '" + name + "'")
