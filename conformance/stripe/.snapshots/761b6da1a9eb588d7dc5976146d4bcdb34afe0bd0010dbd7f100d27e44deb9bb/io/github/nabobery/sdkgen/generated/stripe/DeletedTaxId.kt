...
public class DeletedTaxId(
  ...
  internal object Serializer : KSerializer<DeletedTaxId> {
    ...
    override fun deserialize(decoder: Decoder): DeletedTaxId {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("DeletedTaxId must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: DeletedTaxId) {
