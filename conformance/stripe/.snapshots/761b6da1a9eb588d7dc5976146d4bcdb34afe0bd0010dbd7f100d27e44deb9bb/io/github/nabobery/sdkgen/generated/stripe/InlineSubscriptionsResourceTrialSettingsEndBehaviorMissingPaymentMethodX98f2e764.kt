...
public sealed class InlineSubscriptionsResourceTrialSettingsEndBehaviorMissingPaymentMethodX98f2e764 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineSubscriptionsResourceTrialSettingsEndBehaviorMissingPaymentMethodX98f2e764 = when (value) {
      Cancel.value -> Cancel
  ...
  internal object Serializer : KSerializer<InlineSubscriptionsResourceTrialSettingsEndBehaviorMissingPaymentMethodX98f2e764> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineSubscriptionsResourceTrialSettingsEndBehaviorMissingPaymentMethodX98f2e764", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineSubscriptionsResourceTrialSettingsEndBehaviorMissingPaymentMethodX98f2e764 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineSubscriptionsResourceTrialSettingsEndBehaviorMissingPaymentMethodX98f2e764) {
