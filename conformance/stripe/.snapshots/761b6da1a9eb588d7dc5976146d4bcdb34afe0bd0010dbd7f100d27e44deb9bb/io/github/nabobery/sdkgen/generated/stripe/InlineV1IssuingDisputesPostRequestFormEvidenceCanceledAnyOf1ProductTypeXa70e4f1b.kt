...
public sealed class InlineV1IssuingDisputesPostRequestFormEvidenceCanceledAnyOf1ProductTypeXa70e4f1b {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1IssuingDisputesPostRequestFormEvidenceCanceledAnyOf1ProductTypeXa70e4f1b = when (value) {
      Value.value -> Value
  ...
  internal object Serializer : KSerializer<InlineV1IssuingDisputesPostRequestFormEvidenceCanceledAnyOf1ProductTypeXa70e4f1b> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1IssuingDisputesPostRequestFormEvidenceCanceledAnyOf1ProductTypeXa70e4f1b", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1IssuingDisputesPostRequestFormEvidenceCanceledAnyOf1ProductTypeXa70e4f1b = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1IssuingDisputesPostRequestFormEvidenceCanceledAnyOf1ProductTypeXa70e4f1b) {
