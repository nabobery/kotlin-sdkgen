...
public class InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsKlarnaOnDemandXb0c542ff(
  ...
  public class Builder {
    ...
    public fun build(): InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsKlarnaOnDemandXb0c542ff = InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsKlarnaOnDemandXb0c542ff(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsKlarnaOnDemandXb0c542ff = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsKlarnaOnDemandXb0c542ff> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsKlarnaOnDemandXb0c542ff {
      val jsonDecoder = decoder.requireJsonDecoder("InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsKlarnaOnDemandXb0c542ff")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsKlarnaOnDemandXb0c542ff must be a JSON object")
      return InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsKlarnaOnDemandXb0c542ff(
        ...
        purchaseInterval = rawObject["purchase_interval"]?.let { json.decodeFromJsonElement<InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsPurchaseIntervalXb830f611>(it) },
        purchaseIntervalCount = rawObject["purchase_interval_count"]?.let { json.decodeFromJsonElement<Int>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsKlarnaOnDemandXb0c542ff) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsKlarnaOnDemandXb0c542ff")
...
public fun inlineV1SetupIntentsPostRequestFormPaymentMethodOptionsKlarnaOnDemandXb0c542ff(block: InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsKlarnaOnDemandXb0c542ff.Builder.() -> Unit): InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsKlarnaOnDemandXb0c542ff = InlineV1SetupIntentsPostRequestFormPaymentMethodOptionsKlarnaOnDemandXb0c542ff.build(block)
