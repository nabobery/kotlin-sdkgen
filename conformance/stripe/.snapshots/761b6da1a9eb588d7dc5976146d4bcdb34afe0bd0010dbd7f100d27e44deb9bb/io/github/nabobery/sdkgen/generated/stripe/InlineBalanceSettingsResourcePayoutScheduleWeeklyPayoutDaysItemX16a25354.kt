...
public sealed class InlineBalanceSettingsResourcePayoutScheduleWeeklyPayoutDaysItemX16a25354 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineBalanceSettingsResourcePayoutScheduleWeeklyPayoutDaysItemX16a25354 = when (value) {
      Friday.value -> Friday
      Monday.value -> Monday
  ...
  internal object Serializer : KSerializer<InlineBalanceSettingsResourcePayoutScheduleWeeklyPayoutDaysItemX16a25354> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineBalanceSettingsResourcePayoutScheduleWeeklyPayoutDaysItemX16a25354", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineBalanceSettingsResourcePayoutScheduleWeeklyPayoutDaysItemX16a25354 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineBalanceSettingsResourcePayoutScheduleWeeklyPayoutDaysItemX16a25354) {
