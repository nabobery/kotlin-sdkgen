...
public sealed class InlineV1BillingMetersPostRequestFormEventTimeWindowXada513c9 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1BillingMetersPostRequestFormEventTimeWindowXada513c9 = when (value) {
      Day.value -> Day
      Hour.value -> Hour
  ...
  internal object Serializer : KSerializer<InlineV1BillingMetersPostRequestFormEventTimeWindowXada513c9> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1BillingMetersPostRequestFormEventTimeWindowXada513c9", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1BillingMetersPostRequestFormEventTimeWindowXada513c9 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1BillingMetersPostRequestFormEventTimeWindowXada513c9) {
