...
public class InlineV1SubscriptionsPostRequestFormX91d1b175(
  addInvoiceItems: List<InlineV1SubscriptionsPostRequestFormAddInvoiceItemsItemX887b9cd0>? = null,
  /**
  ...
  billingSchedules: List<InlineV1SubscriptionsPostRequestFormBillingSchedulesItemX2aa4b98c>? = null,
  /**
  ...
  public val billingThresholds:
      InlineV1SubscriptionsPostRequestFormBillingThresholdsXc724c751? = null,
  /**
  ...
  public val collectionMethod:
      InlineV1SubscriptionsPostRequestFormCollectionMethodX000dc0ad? = null,
  /**
  ...
  items: List<InlineV1SubscriptionsPostRequestFormItemsItemX0aa31836>? = null,
  /**
  ...
  public val prorationBehavior:
      InlineV1SubscriptionsPostRequestFormProrationBehaviorXebd81fe4? = null,
  /**
  ...
  public val addInvoiceItems:
      List<InlineV1SubscriptionsPostRequestFormAddInvoiceItemsItemX887b9cd0>? =
  ...
  public val billingSchedules:
      List<InlineV1SubscriptionsPostRequestFormBillingSchedulesItemX2aa4b98c>? =
      billingSchedules?.let { collection0 -> collection0.toList() }
   ...
   */
  public val items: List<InlineV1SubscriptionsPostRequestFormItemsItemX0aa31836>? =
  ...
  public class Builder {
    ...
    private var billingSchedulesValue:
    ...
    public var billingSchedules:
        List<InlineV1SubscriptionsPostRequestFormBillingSchedulesItemX2aa4b98c>?
      get() = billingSchedulesValue?.let { collection0 -> collection0.toList() }
      set(`value`) {
        billingSchedulesValue = value?.let { collection0 -> collection0.toList() }
      }
    ...
    private var itemsValue: List<InlineV1SubscriptionsPostRequestFormItemsItemX0aa31836>? = null

    /**
     * A list of up to 20 subscription items, each with an attached price.
     */
    public var items: List<InlineV1SubscriptionsPostRequestFormItemsItemX0aa31836>?
    ...
    public fun build(): InlineV1SubscriptionsPostRequestFormX91d1b175 = InlineV1SubscriptionsPostRequestFormX91d1b175(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1SubscriptionsPostRequestFormX91d1b175 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1SubscriptionsPostRequestFormX91d1b175> {
    ...
    override fun deserialize(decoder: Decoder): InlineV1SubscriptionsPostRequestFormX91d1b175 {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1SubscriptionsPostRequestFormX91d1b175 must be a JSON object")
      return InlineV1SubscriptionsPostRequestFormX91d1b175(
        addInvoiceItems = rawObject["add_invoice_items"]?.let { json.decodeFromJsonElement<List<InlineV1SubscriptionsPostRequestFormAddInvoiceItemsItemX887b9cd0>>(it) },
        applicationFeePercent = rawObject["application_fee_percent"]?.let { json.decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormApplicationFeePercentXeea79078>(it) },
        automaticTax = rawObject["automatic_tax"]?.let { json.decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormAutomaticTaxX2895c5fd>(it) },
        ...
        billingCycleAnchorConfig = rawObject["billing_cycle_anchor_config"]?.let { json.decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormBillingCycleAnchorConfigX18b8a838>(it) },
        billingMode = rawObject["billing_mode"]?.let { json.decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormBillingModeX933573e8>(it) },
        billingSchedules = rawObject["billing_schedules"]?.let { json.decodeFromJsonElement<List<InlineV1SubscriptionsPostRequestFormBillingSchedulesItemX2aa4b98c>>(it) },
        billingThresholds = rawObject["billing_thresholds"]?.let { json.decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormBillingThresholdsXc724c751>(it) },
        cancelAt = rawObject["cancel_at"]?.let { json.decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormCancelAtX90e20647>(it) },
        cancelAtPeriodEnd = rawObject["cancel_at_period_end"]?.let { json.decodeFromJsonElement<Boolean>(it) },
        collectionMethod = rawObject["collection_method"]?.let { json.decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormCollectionMethodX000dc0ad>(it) },
        ...
        defaultTaxRates = rawObject["default_tax_rates"]?.let { json.decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormDefaultTaxRatesX3d96bc44>(it) },
        description = rawObject["description"]?.let { json.decodeFromJsonElement<String>(it) },
        discounts = rawObject["discounts"]?.let { json.decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormDiscountsX04b76c3c>(it) },
        expand = rawObject["expand"]?.let { json.decodeFromJsonElement<List<String>>(it) },
        invoiceSettings = rawObject["invoice_settings"]?.let { json.decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormInvoiceSettingsXba14be76>(it) },
        items = rawObject["items"]?.let { json.decodeFromJsonElement<List<InlineV1SubscriptionsPostRequestFormItemsItemX0aa31836>>(it) },
        metadata = rawObject["metadata"]?.let { json.decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormMetadataX303ca204>(it) },
        offSession = rawObject["off_session"]?.let { json.decodeFromJsonElement<Boolean>(it) },
        onBehalfOf = rawObject["on_behalf_of"]?.let { json.decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormOnBehalfOfXb0fbbfaa>(it) },
        paymentBehavior = rawObject["payment_behavior"]?.let { json.decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormPaymentBehaviorX62aac0c5>(it) },
        paymentSettings = rawObject["payment_settings"]?.let { json.decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormPaymentSettingsX4fbccb44>(it) },
        pendingInvoiceItemInterval = rawObject["pending_invoice_item_interval"]?.let { json.decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormPendingInvoiceItemIntervalXa949b0af>(it) },
        prorationBehavior = rawObject["proration_behavior"]?.let { json.decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormProrationBehaviorXebd81fe4>(it) },
        transferData = rawObject["transfer_data"]?.let { json.decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormTransferDataX3d77fe0b>(it) },
        trialEnd = rawObject["trial_end"]?.let { json.decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormTrialEndX48041713>(it) },
        ...
        trialSettings = rawObject["trial_settings"]?.let { json.decodeFromJsonElement<InlineV1SubscriptionsPostRequestFormTrialSettingsXe20b5ab9>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineV1SubscriptionsPostRequestFormX91d1b175) {
...
public fun inlineV1SubscriptionsPostRequestFormX91d1b175(block: InlineV1SubscriptionsPostRequestFormX91d1b175.Builder.() -> Unit): InlineV1SubscriptionsPostRequestFormX91d1b175 = InlineV1SubscriptionsPostRequestFormX91d1b175.build(block)
