 ...
 * form-urlencoded/schema/properties/card/anyOf/0.
 *
 * Source:
 * sdkgen://source/openapi.json#/paths/~1v1~1customers~1{customer}~1sources/post/requestBody/content/application~1x-www-
 * form-urlencoded/schema/properties/card/anyOf/0
 */
@Serializable(with = InlineV1CustomersSourcesPostRequestFormCardAnyOf1Xe829b03e.Serializer::class)
public class InlineV1CustomersSourcesPostRequestFormCardAnyOf1Xe829b03e(
  ...
  public val networkToken:
      InlineV1CustomersSourcesPostRequestFormCardAnyOf1NetworkTokenXd124f687? = null,
  public val objectValue:
      InlineV1CustomersSourcesPostRequestFormCardAnyOf1ObjectValueX53ce9254? = null,
  ...
  public class Builder {
    ...
    public var networkToken: InlineV1CustomersSourcesPostRequestFormCardAnyOf1NetworkTokenXd124f687?
        = null

    public var objectValue: InlineV1CustomersSourcesPostRequestFormCardAnyOf1ObjectValueX53ce9254? =
        null

    public var swipeData: String? = null

    public fun build(): InlineV1CustomersSourcesPostRequestFormCardAnyOf1Xe829b03e {
      ...
      return InlineV1CustomersSourcesPostRequestFormCardAnyOf1Xe829b03e(
        expMonth = expMonth,
        expYear = expYear,
        number = number,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineV1CustomersSourcesPostRequestFormCardAnyOf1Xe829b03e = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineV1CustomersSourcesPostRequestFormCardAnyOf1Xe829b03e> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineV1CustomersSourcesPostRequestFormCardAnyOf1Xe829b03e {
      val jsonDecoder = decoder.requireJsonDecoder("InlineV1CustomersSourcesPostRequestFormCardAnyOf1Xe829b03e")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineV1CustomersSourcesPostRequestFormCardAnyOf1Xe829b03e must be a JSON object")
      ...
      return InlineV1CustomersSourcesPostRequestFormCardAnyOf1Xe829b03e(
        ...
        networkToken = rawObject["network_token"]?.let { json.decodeFromJsonElement<InlineV1CustomersSourcesPostRequestFormCardAnyOf1NetworkTokenXd124f687>(it) },
        objectValue = rawObject["object"]?.let { json.decodeFromJsonElement<InlineV1CustomersSourcesPostRequestFormCardAnyOf1ObjectValueX53ce9254>(it) },
        swipeData = rawObject["swipe_data"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineV1CustomersSourcesPostRequestFormCardAnyOf1Xe829b03e) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineV1CustomersSourcesPostRequestFormCardAnyOf1Xe829b03e")
...
public fun inlineV1CustomersSourcesPostRequestFormCardAnyOf1Xe829b03e(block: InlineV1CustomersSourcesPostRequestFormCardAnyOf1Xe829b03e.Builder.() -> Unit): InlineV1CustomersSourcesPostRequestFormCardAnyOf1Xe829b03e = InlineV1CustomersSourcesPostRequestFormCardAnyOf1Xe829b03e.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineV1CustomersSourcesPostRequestFormCardAnyOf1Xe829b03e is missing required property '" + name + "'")
