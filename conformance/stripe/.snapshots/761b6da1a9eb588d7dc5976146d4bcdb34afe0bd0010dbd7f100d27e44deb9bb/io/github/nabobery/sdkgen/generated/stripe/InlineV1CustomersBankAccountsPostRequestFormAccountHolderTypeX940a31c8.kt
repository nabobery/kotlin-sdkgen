...
public sealed class InlineV1CustomersBankAccountsPostRequestFormAccountHolderTypeX940a31c8 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1CustomersBankAccountsPostRequestFormAccountHolderTypeX940a31c8 = when (value) {
  ...
  internal object Serializer : KSerializer<InlineV1CustomersBankAccountsPostRequestFormAccountHolderTypeX940a31c8> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1CustomersBankAccountsPostRequestFormAccountHolderTypeX940a31c8", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1CustomersBankAccountsPostRequestFormAccountHolderTypeX940a31c8 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1CustomersBankAccountsPostRequestFormAccountHolderTypeX940a31c8) {
