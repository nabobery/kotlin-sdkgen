...
public sealed class InlineV1CustomersPostRequestFormTaxValidateLocationX4ff0b30a {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineV1CustomersPostRequestFormTaxValidateLocationX4ff0b30a = when (value) {
      Auto.value -> Auto
  ...
  internal object Serializer : KSerializer<InlineV1CustomersPostRequestFormTaxValidateLocationX4ff0b30a> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineV1CustomersPostRequestFormTaxValidateLocationX4ff0b30a", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineV1CustomersPostRequestFormTaxValidateLocationX4ff0b30a = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineV1CustomersPostRequestFormTaxValidateLocationX4ff0b30a) {
