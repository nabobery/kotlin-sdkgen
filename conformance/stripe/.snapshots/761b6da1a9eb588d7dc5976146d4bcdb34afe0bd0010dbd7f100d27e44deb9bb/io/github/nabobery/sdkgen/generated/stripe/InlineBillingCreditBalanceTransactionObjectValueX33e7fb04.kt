...
public sealed class InlineBillingCreditBalanceTransactionObjectValueX33e7fb04 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineBillingCreditBalanceTransactionObjectValueX33e7fb04 = when (value) {
      BillingCreditBalanceTransaction.value -> BillingCreditBalanceTransaction
      else -> SdkUnknown(value)
    }
  }

  internal object Serializer : KSerializer<InlineBillingCreditBalanceTransactionObjectValueX33e7fb04> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineBillingCreditBalanceTransactionObjectValueX33e7fb04", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineBillingCreditBalanceTransactionObjectValueX33e7fb04 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineBillingCreditBalanceTransactionObjectValueX33e7fb04) {
