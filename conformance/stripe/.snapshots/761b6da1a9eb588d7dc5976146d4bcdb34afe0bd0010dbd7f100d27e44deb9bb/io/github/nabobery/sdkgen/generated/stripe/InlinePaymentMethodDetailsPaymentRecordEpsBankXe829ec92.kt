...
public sealed class InlinePaymentMethodDetailsPaymentRecordEpsBankXe829ec92 {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlinePaymentMethodDetailsPaymentRecordEpsBankXe829ec92 = when (value) {
  ...
  internal object Serializer : KSerializer<InlinePaymentMethodDetailsPaymentRecordEpsBankXe829ec92> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlinePaymentMethodDetailsPaymentRecordEpsBankXe829ec92", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlinePaymentMethodDetailsPaymentRecordEpsBankXe829ec92 = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlinePaymentMethodDetailsPaymentRecordEpsBankXe829ec92) {
