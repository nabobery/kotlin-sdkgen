...
public sealed class InlineFinancialConnectionsAccountOwnerObjectValueX05d0828b {
  ...
  public companion object {
    public fun fromValue(`value`: String): InlineFinancialConnectionsAccountOwnerObjectValueX05d0828b = when (value) {
      FinancialConnectionsAccountOwner.value -> FinancialConnectionsAccountOwner
      else -> SdkUnknown(value)
    }
  }

  internal object Serializer : KSerializer<InlineFinancialConnectionsAccountOwnerObjectValueX05d0828b> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("io.github.nabobery.sdkgen.generated.stripe.InlineFinancialConnectionsAccountOwnerObjectValueX05d0828b", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): InlineFinancialConnectionsAccountOwnerObjectValueX05d0828b = fromValue(decoder.decodeString())

    override fun serialize(encoder: Encoder, `value`: InlineFinancialConnectionsAccountOwnerObjectValueX05d0828b) {
