...
public class ContentFilterEntry internal constructor(
  ...
  public object Serializer : KSerializer<ContentFilterEntry> {
    ...
    override fun deserialize(decoder: Decoder): ContentFilterEntry {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("ContentFilterEntry must be a JSON object")
      val action = json.decodeRequired<ContentFilterAction>(raw, "action")
      val pattern = json.decodeRequired<String>(raw, "pattern")
      return ContentFilterEntry(
        action = action,
        pattern = pattern,
        labelState = json.decodeOptional(raw, "label", nullable = true),
      )
    }
...
public fun contentFilterEntry(block: ContentFilterEntry.Builder.() -> Unit): ContentFilterEntry = ContentFilterEntry
  .build(block)
