...
public class AnthropicCodeExecutionToolResultError(
  ...
  public class Builder {
    ...
    private var typeValue:
        InlineComponentsSchemasAnthropicCodeExecutionToolResultErrorPropertiesType? = null

    public var type: InlineComponentsSchemasAnthropicCodeExecutionToolResultErrorPropertiesType
  ...
  public object Serializer : KSerializer<AnthropicCodeExecutionToolResultError> {
    ...
    override fun deserialize(decoder: Decoder): AnthropicCodeExecutionToolResultError {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("AnthropicCodeExecutionToolResultError must be a JSON object")
      val errorCode = json.decodeRequired<AnthropicServerToolErrorCode>(raw, "error_code")
      val type = json.decodeRequired<InlineComponentsSchemasAnthropicCodeExecutionToolResultErrorPropertiesType>(raw,
        "type")
      return AnthropicCodeExecutionToolResultError(
        errorCode = errorCode,
        type = type,
...
public fun anthropicCodeExecutionToolResultError(block: AnthropicCodeExecutionToolResultError.Builder.() ->
  Unit): AnthropicCodeExecutionToolResultError = AnthropicCodeExecutionToolResultError.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("AnthropicCodeExecutionToolResultError is missing required property '" + name + "'")
