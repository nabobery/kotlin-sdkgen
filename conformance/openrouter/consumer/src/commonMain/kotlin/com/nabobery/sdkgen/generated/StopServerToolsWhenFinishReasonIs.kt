...
public class StopServerToolsWhenFinishReasonIs(
  ...
  public class Builder {
    ...
    private var typeValue: InlineComponentsSchemasStopServerToolsWhenFinishReasonIsPropertiesType? =
        null

    public var type: InlineComponentsSchemasStopServerToolsWhenFinishReasonIsPropertiesType
  ...
  public object Serializer : KSerializer<StopServerToolsWhenFinishReasonIs> {
    ...
    override fun deserialize(decoder: Decoder): StopServerToolsWhenFinishReasonIs {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("StopServerToolsWhenFinishReasonIs must be a JSON object")
      val reason = json.decodeRequired<String>(raw, "reason")
      val type = json.decodeRequired<InlineComponentsSchemasStopServerToolsWhenFinishReasonIsPropertiesType>(raw,
        "type")
      return StopServerToolsWhenFinishReasonIs(
        reason = reason,
        type = type,
...
public fun stopServerToolsWhenFinishReasonIs(block: StopServerToolsWhenFinishReasonIs.Builder.() ->
  Unit): StopServerToolsWhenFinishReasonIs = StopServerToolsWhenFinishReasonIs.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("StopServerToolsWhenFinishReasonIs is missing required property '" + name + "'")
