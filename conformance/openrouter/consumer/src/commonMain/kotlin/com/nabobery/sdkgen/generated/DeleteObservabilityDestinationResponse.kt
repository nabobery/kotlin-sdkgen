...
public class DeleteObservabilityDestinationResponse(
  ...
  public object Serializer : KSerializer<DeleteObservabilityDestinationResponse> {
    ...
    override fun deserialize(decoder: Decoder): DeleteObservabilityDestinationResponse {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("DeleteObservabilityDestinationResponse must be a JSON object")
...
public fun deleteObservabilityDestinationResponse(block: DeleteObservabilityDestinationResponse.Builder.() ->
  Unit): DeleteObservabilityDestinationResponse = DeleteObservabilityDestinationResponse.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("DeleteObservabilityDestinationResponse is missing required property '" + name + "'")
