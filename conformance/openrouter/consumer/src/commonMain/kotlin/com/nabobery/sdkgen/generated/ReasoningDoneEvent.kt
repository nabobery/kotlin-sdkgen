 ...
 */
@Serializable(with = ReasoningDoneEvent.Serializer::class)
public class ReasoningDoneEvent(
  public val contentIndex: Int,
  public val itemId: String,
  public val outputIndex: Int,
  public val sequenceNumber: Int,
  public val text: String,
  public val type: InlineComponentsSchemasBaseReasoningDoneEventPropertiesType,
) {
  public class Builder {
    ...
    private var typeValue: InlineComponentsSchemasBaseReasoningDoneEventPropertiesType? = null

    public var type: InlineComponentsSchemasBaseReasoningDoneEventPropertiesType
      get() = requireNotNull(typeValue) { "type is required" }
      set(`value`) {
        typeValue = value
      }

    public fun build(): ReasoningDoneEvent {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): ReasoningDoneEvent = Builder().apply(block).build()
  }

  public object Serializer : KSerializer<ReasoningDoneEvent> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): ReasoningDoneEvent {
      val jsonDecoder = decoder.requireJsonDecoder("ReasoningDoneEvent")
      val json = jsonDecoder.json
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("ReasoningDoneEvent must be a JSON object")
      ...
      val type = json.decodeRequired<InlineComponentsSchemasBaseReasoningDoneEventPropertiesType>(raw, "type")
      return ReasoningDoneEvent(
        contentIndex = contentIndex,
        itemId = itemId,
        outputIndex = outputIndex,
    ...
    override fun serialize(encoder: Encoder, `value`: ReasoningDoneEvent) {
      val jsonEncoder = encoder.requireJsonEncoder("ReasoningDoneEvent")
...
public fun reasoningDoneEvent(block: ReasoningDoneEvent.Builder.() -> Unit): ReasoningDoneEvent = ReasoningDoneEvent
  .build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("ReasoningDoneEvent is missing required property '" + name +
    "'")
