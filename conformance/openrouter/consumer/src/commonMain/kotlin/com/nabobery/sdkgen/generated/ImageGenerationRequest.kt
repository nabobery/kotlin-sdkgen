...
public class ImageGenerationRequest(
  ...
  public val aspectRatio:
      InlineComponentsSchemasImageGenerationRequestPropertiesAspectRatio? = null,
  /**
   * Background treatment. `transparent` requires an output_format that supports alpha (png or webp).
   */
  public val background: InlineComponentsSchemasImageGenerationRequestPropertiesBackground? = null,
  /**
   * Reference images to guide image-to-image generation, as base64 data URLs or HTTP(S) URLs.
   */
  public val inputReferences: List<ContentPartImage>? = null,
  /**
  ...
  public val outputFormat:
      InlineComponentsSchemasImageGenerationRequestPropertiesOutputFormat? = null,
   ...
   */
  public val quality: InlineComponentsSchemasImageGenerationRequestPropertiesQuality? = null,
  /**
   * Normalized resolution tier of the generated image. Concrete pixel dimensions are derived per-provider.
   */
  public val resolution: InlineComponentsSchemasImageGenerationRequestPropertiesResolution? = null,
  /**
  ...
  public class Builder {
     ...
     * Normalized aspect ratio of the generated image. Providers clamp to their supported subset.
     */
    public var aspectRatio: InlineComponentsSchemasImageGenerationRequestPropertiesAspectRatio? =
        null

    /**
     * Background treatment. `transparent` requires an output_format that supports alpha (png or webp).
     */
    public var background: InlineComponentsSchemasImageGenerationRequestPropertiesBackground? = null

    /**
     * Reference images to guide image-to-image generation, as base64 data URLs or HTTP(S) URLs.
     */
    public var inputReferences: List<ContentPartImage>? = null
     ...
     * vectorization models (e.g. Quiver) — the SVG markup is UTF-8 base64-encoded in `b64_json`.
     */
    public var outputFormat: InlineComponentsSchemasImageGenerationRequestPropertiesOutputFormat? =
        null
     ...
     * Rendering quality. Providers without a quality knob ignore this.
     */
    public var quality: InlineComponentsSchemasImageGenerationRequestPropertiesQuality? = null

    /**
     * Normalized resolution tier of the generated image. Concrete pixel dimensions are derived per-provider.
     */
    public var resolution: InlineComponentsSchemasImageGenerationRequestPropertiesResolution? = null
  ...
  public object Serializer : KSerializer<ImageGenerationRequest> {
    ...
    override fun deserialize(decoder: Decoder): ImageGenerationRequest {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("ImageGenerationRequest must be a JSON object")
      ...
      return ImageGenerationRequest(
        ...
        aspectRatio = raw["aspect_ratio"]?.let { json
          .decodeFromJsonElement<InlineComponentsSchemasImageGenerationRequestPropertiesAspectRatio>(it) },
        background = raw["background"]?.let { json
          .decodeFromJsonElement<InlineComponentsSchemasImageGenerationRequestPropertiesBackground>(it) },
        inputReferences = raw["input_references"]?.let { json.decodeFromJsonElement<List<ContentPartImage>>(it) },
        n = raw["n"]?.let { json.decodeFromJsonElement<Int>(it) },
        outputCompression = raw["output_compression"]?.let { json.decodeFromJsonElement<Int>(it) },
        outputFormat = raw["output_format"]?.let { json
          .decodeFromJsonElement<InlineComponentsSchemasImageGenerationRequestPropertiesOutputFormat>(it) },
        provider = raw["provider"]?.let { json.decodeFromJsonElement<ImageGenerationProviderPreferences>(it) },
        quality = raw["quality"]?.let { json
          .decodeFromJsonElement<InlineComponentsSchemasImageGenerationRequestPropertiesQuality>(it) },
        resolution = raw["resolution"]?.let { json
          .decodeFromJsonElement<InlineComponentsSchemasImageGenerationRequestPropertiesResolution>(it) },
...
public fun imageGenerationRequest(block: ImageGenerationRequest.Builder.() -> Unit): ImageGenerationRequest =
  ImageGenerationRequest.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("ImageGenerationRequest is missing required property '" +
    name + "'")
