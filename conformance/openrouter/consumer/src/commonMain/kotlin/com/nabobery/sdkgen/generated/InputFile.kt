...
public class InputFile(
  ...
  public class Builder {
    private var typeValue: InlineComponentsSchemasInputFilePropertiesType? = null

    public var type: InlineComponentsSchemasInputFilePropertiesType
  ...
  public object Serializer : KSerializer<InputFile> {
    ...
    override fun deserialize(decoder: Decoder): InputFile {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("InputFile must be a JSON object")
      val type = json.decodeRequired<InlineComponentsSchemasInputFilePropertiesType>(raw, "type")
      return InputFile(
        type = type,
        fileData = raw["file_data"]?.let { json.decodeFromJsonElement<String>(it) },
        fileId = raw["file_id"]?.let { element -> if (element == JsonNull) null else json
          .decodeFromJsonElement<String?>(element) },
        fileUrl = raw["file_url"]?.let { json.decodeFromJsonElement<String>(it) },
