...
public class InputVideo(
  ...
  public class Builder {
    private var typeValue: InlineComponentsSchemasInputVideoPropertiesType? = null

    public var type: InlineComponentsSchemasInputVideoPropertiesType
  ...
  public object Serializer : KSerializer<InputVideo> {
    ...
    override fun deserialize(decoder: Decoder): InputVideo {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("InputVideo must be a JSON object")
      val type = json.decodeRequired<InlineComponentsSchemasInputVideoPropertiesType>(raw, "type")
      val videoUrl = json.decodeRequired<String>(raw, "video_url")
      return InputVideo(
        type = type,
        videoUrl = videoUrl,
      )
