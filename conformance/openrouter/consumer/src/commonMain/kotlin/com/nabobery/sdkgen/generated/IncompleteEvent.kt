...
public class IncompleteEvent(
  ...
  public val type: InlineComponentsSchemasIncompleteEventPropertiesType,
) {
  public class Builder {
    ...
    private var typeValue: InlineComponentsSchemasIncompleteEventPropertiesType? = null

    public var type: InlineComponentsSchemasIncompleteEventPropertiesType
  ...
  public object Serializer : KSerializer<IncompleteEvent> {
    ...
    override fun deserialize(decoder: Decoder): IncompleteEvent {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("IncompleteEvent must be a JSON object")
      ...
      val type = json.decodeRequired<InlineComponentsSchemasIncompleteEventPropertiesType>(raw, "type")
      return IncompleteEvent(
        response = response,
        sequenceNumber = sequenceNumber,
        type = type,
