...
public class ApplyPatchCallOperationDiffDeltaEvent(
  ...
  public val type: InlineComponentsSchemasApplyPatchCallOperationDiffDeltaEventPropertiesType,
) {
  public class Builder {
    ...
    private var typeValue:
        InlineComponentsSchemasApplyPatchCallOperationDiffDeltaEventPropertiesType? = null

    public var type: InlineComponentsSchemasApplyPatchCallOperationDiffDeltaEventPropertiesType
  ...
  public object Serializer : KSerializer<ApplyPatchCallOperationDiffDeltaEvent> {
    ...
    override fun deserialize(decoder: Decoder): ApplyPatchCallOperationDiffDeltaEvent {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("ApplyPatchCallOperationDiffDeltaEvent must be a JSON object")
      ...
      val type = json.decodeRequired<InlineComponentsSchemasApplyPatchCallOperationDiffDeltaEventPropertiesType>(raw,
        "type")
      return ApplyPatchCallOperationDiffDeltaEvent(
        delta = delta,
        itemId = itemId,
...
public fun applyPatchCallOperationDiffDeltaEvent(block: ApplyPatchCallOperationDiffDeltaEvent.Builder.() ->
  Unit): ApplyPatchCallOperationDiffDeltaEvent = ApplyPatchCallOperationDiffDeltaEvent.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("ApplyPatchCallOperationDiffDeltaEvent is missing required property '" + name + "'")
