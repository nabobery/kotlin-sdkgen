...
public class BulkAssignKeysRequest(
  ...
  public object Serializer : KSerializer<BulkAssignKeysRequest> {
    ...
    override fun deserialize(decoder: Decoder): BulkAssignKeysRequest {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("BulkAssignKeysRequest must be a JSON object")
...
public fun bulkAssignKeysRequest(block: BulkAssignKeysRequest.Builder.() -> Unit): BulkAssignKeysRequest =
  BulkAssignKeysRequest.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("BulkAssignKeysRequest is missing required property '" +
    name + "'")
