...
public class Preview20250311WebSearchServerTool(
  ...
  public class Builder {
    private var typeValue: InlineComponentsSchemasPreview20250311WebSearchServerToolPropertiesType?
        = null

    public var type: InlineComponentsSchemasPreview20250311WebSearchServerToolPropertiesType
  ...
  public object Serializer : KSerializer<Preview20250311WebSearchServerTool> {
    ...
    override fun deserialize(decoder: Decoder): Preview20250311WebSearchServerTool {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("Preview20250311WebSearchServerTool must be a JSON object")
      val type = json.decodeRequired<InlineComponentsSchemasPreview20250311WebSearchServerToolPropertiesType>(raw,
        "type")
      return Preview20250311WebSearchServerTool(
        type = type,
...
public fun preview20250311WebSearchServerTool(block: Preview20250311WebSearchServerTool.Builder.() ->
  Unit): Preview20250311WebSearchServerTool = Preview20250311WebSearchServerTool.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("Preview20250311WebSearchServerTool is missing required property '" + name + "'")
