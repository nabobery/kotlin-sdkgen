...
/**
 * Generated model for sdkgen://source/openapi.yaml#/components/schemas/ObservabilityLangfuseDestination.
 */
@Serializable(with = ObservabilityLangfuseDestination.Serializer::class)
public class ObservabilityLangfuseDestination(
  /**
  ...
  public class Builder {
    private var configValue:
        InlineComponentsSchemasObservabilityLangfuseDestinationPropertiesConfig? = null

    public var config: InlineComponentsSchemasObservabilityLangfuseDestinationPropertiesConfig
    ...
    private var typeValue: InlineComponentsSchemasObservabilityLangfuseDestinationPropertiesType? =
        null

    public var type: InlineComponentsSchemasObservabilityLangfuseDestinationPropertiesType
    ...
    public fun build(): ObservabilityLangfuseDestination {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): ObservabilityLangfuseDestination = Builder().apply(block).build()
  }

  public object Serializer : KSerializer<ObservabilityLangfuseDestination> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): ObservabilityLangfuseDestination {
      val jsonDecoder = decoder.requireJsonDecoder("ObservabilityLangfuseDestination")
      val json = jsonDecoder.json
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("ObservabilityLangfuseDestination must be a JSON object")
      val config = json.decodeRequired<InlineComponentsSchemasObservabilityLangfuseDestinationPropertiesConfig>(raw,
        "config")
      ...
      val type = json.decodeRequired<InlineComponentsSchemasObservabilityLangfuseDestinationPropertiesType>(raw, "type")
      ...
      if (!raw.containsKey("api_key_hashes")) {
        throw SerializationException("ObservabilityLangfuseDestination is missing required property 'api_key_hashes'")
      }
      ...
      if (!raw.containsKey("filter_rules")) {
        throw SerializationException("ObservabilityLangfuseDestination is missing required property 'filter_rules'")
      }
      ...
      if (!raw.containsKey("name")) {
        throw SerializationException("ObservabilityLangfuseDestination is missing required property 'name'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: ObservabilityLangfuseDestination) {
      val jsonEncoder = encoder.requireJsonEncoder("ObservabilityLangfuseDestination")
...
public fun observabilityLangfuseDestination(block: ObservabilityLangfuseDestination.Builder.() ->
  Unit): ObservabilityLangfuseDestination = ObservabilityLangfuseDestination.build(block)
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("ObservabilityLangfuseDestination property '" + name +
      "' is not nullable")
