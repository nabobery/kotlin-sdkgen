...
public class GetPresetVersionResponse(
  ...
  public object Serializer : KSerializer<GetPresetVersionResponse> {
    ...
    override fun deserialize(decoder: Decoder): GetPresetVersionResponse {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("GetPresetVersionResponse must be a JSON object")
      if (!raw.containsKey("data")) {
        throw SerializationException("GetPresetVersionResponse is missing required property 'data'")
      }
      val data = raw["data"].let { element -> if (element == JsonNull) null else json
...
public fun getPresetVersionResponse(block: GetPresetVersionResponse.Builder.() -> Unit): GetPresetVersionResponse =
  GetPresetVersionResponse.build(block)
