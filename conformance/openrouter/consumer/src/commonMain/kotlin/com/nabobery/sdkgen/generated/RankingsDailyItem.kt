...
public class RankingsDailyItem(
  ...
  public object Serializer : KSerializer<RankingsDailyItem> {
    ...
    override fun deserialize(decoder: Decoder): RankingsDailyItem {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("RankingsDailyItem must be a JSON object")
...
public fun rankingsDailyItem(block: RankingsDailyItem.Builder.() -> Unit): RankingsDailyItem = RankingsDailyItem
  .build(block)
