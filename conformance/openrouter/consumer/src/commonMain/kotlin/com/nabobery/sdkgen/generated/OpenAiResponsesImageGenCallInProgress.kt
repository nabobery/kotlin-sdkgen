...
public class OpenAiResponsesImageGenCallInProgress(
  ...
  public val type: InlineComponentsSchemasOpenAiResponsesImageGenCallInProgressPropertiesType,
) {
  public class Builder {
    ...
    private var typeValue:
        InlineComponentsSchemasOpenAiResponsesImageGenCallInProgressPropertiesType? = null

    public var type: InlineComponentsSchemasOpenAiResponsesImageGenCallInProgressPropertiesType
  ...
  public object Serializer : KSerializer<OpenAiResponsesImageGenCallInProgress> {
    ...
    override fun deserialize(decoder: Decoder): OpenAiResponsesImageGenCallInProgress {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("OpenAiResponsesImageGenCallInProgress must be a JSON object")
      ...
      val type = json.decodeRequired<InlineComponentsSchemasOpenAiResponsesImageGenCallInProgressPropertiesType>(raw,
        "type")
      return OpenAiResponsesImageGenCallInProgress(
        itemId = itemId,
        outputIndex = outputIndex,
...
public fun openAiResponsesImageGenCallInProgress(block: OpenAiResponsesImageGenCallInProgress.Builder.() ->
  Unit): OpenAiResponsesImageGenCallInProgress = OpenAiResponsesImageGenCallInProgress.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("OpenAiResponsesImageGenCallInProgress is missing required property '" + name + "'")
