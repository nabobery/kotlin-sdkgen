...
public class OutputApplyPatchServerToolItem(
  ...
  public val type: InlineComponentsSchemasOutputApplyPatchServerToolItemPropertiesType,
  ...
  public class Builder {
    ...
    private var typeValue: InlineComponentsSchemasOutputApplyPatchServerToolItemPropertiesType? =
        null

    public var type: InlineComponentsSchemasOutputApplyPatchServerToolItemPropertiesType
  ...
  public object Serializer : KSerializer<OutputApplyPatchServerToolItem> {
    ...
    override fun deserialize(decoder: Decoder): OutputApplyPatchServerToolItem {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("OutputApplyPatchServerToolItem must be a JSON object")
      val status = json.decodeRequired<ToolCallStatus>(raw, "status")
      val type = json.decodeRequired<InlineComponentsSchemasOutputApplyPatchServerToolItemPropertiesType>(raw, "type")
      return OutputApplyPatchServerToolItem(
        status = status,
        type = type,
        callId = raw["call_id"]?.let { json.decodeFromJsonElement<String>(it) },
        id = raw["id"]?.let { json.decodeFromJsonElement<String>(it) },
        operation = raw["operation"]?.let { json.decodeFromJsonElement<ApplyPatchCallOperation>(it) },
      )
    }
...
public fun outputApplyPatchServerToolItem(block: OutputApplyPatchServerToolItem.Builder.() ->
  Unit): OutputApplyPatchServerToolItem = OutputApplyPatchServerToolItem.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("OutputApplyPatchServerToolItem is missing required property '" + name + "'")
