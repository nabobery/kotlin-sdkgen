...
public class WebFetchServerToolConfig(
  ...
  public object Serializer : KSerializer<WebFetchServerToolConfig> {
    ...
    override fun deserialize(decoder: Decoder): WebFetchServerToolConfig {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("WebFetchServerToolConfig must be a JSON object")
      return WebFetchServerToolConfig(
        ...
        engine = raw["engine"]?.let { json.decodeFromJsonElement<WebFetchEngineEnum>(it) },
...
public fun webFetchServerToolConfig(block: WebFetchServerToolConfig.Builder.() -> Unit): WebFetchServerToolConfig =
  WebFetchServerToolConfig.build(block)
