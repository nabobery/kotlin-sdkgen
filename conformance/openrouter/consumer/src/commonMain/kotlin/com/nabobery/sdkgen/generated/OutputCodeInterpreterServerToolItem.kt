...
public class OutputCodeInterpreterServerToolItem(
  ...
  public val type: InlineComponentsSchemasOutputCodeInterpreterServerToolItemPropertiesType,
  ...
  public class Builder {
    ...
    private var typeValue: InlineComponentsSchemasOutputCodeInterpreterServerToolItemPropertiesType?
        = null

    public var type: InlineComponentsSchemasOutputCodeInterpreterServerToolItemPropertiesType
  ...
  public object Serializer : KSerializer<OutputCodeInterpreterServerToolItem> {
    ...
    override fun deserialize(decoder: Decoder): OutputCodeInterpreterServerToolItem {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("OutputCodeInterpreterServerToolItem must be a JSON object")
      val status = json.decodeRequired<ToolCallStatus>(raw, "status")
      val type = json.decodeRequired<InlineComponentsSchemasOutputCodeInterpreterServerToolItemPropertiesType>(raw,
        "type")
      return OutputCodeInterpreterServerToolItem(
        status = status,
        type = type,
        code = raw["code"]?.let { json.decodeFromJsonElement<String>(it) },
...
public fun outputCodeInterpreterServerToolItem(block: OutputCodeInterpreterServerToolItem.Builder.() ->
  Unit): OutputCodeInterpreterServerToolItem = OutputCodeInterpreterServerToolItem.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("OutputCodeInterpreterServerToolItem is missing required property '" + name + "'")
