...
public class AnthropicWebFetchBlock(
  ...
  public class Builder {
    ...
    private var typeValue: InlineComponentsSchemasAnthropicWebFetchBlockPropertiesType? = null

    public var type: InlineComponentsSchemasAnthropicWebFetchBlockPropertiesType
  ...
  public object Serializer : KSerializer<AnthropicWebFetchBlock> {
    ...
    override fun deserialize(decoder: Decoder): AnthropicWebFetchBlock {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("AnthropicWebFetchBlock must be a JSON object")
      val content = json.decodeRequired<AnthropicDocumentBlock>(raw, "content")
      val type = json.decodeRequired<InlineComponentsSchemasAnthropicWebFetchBlockPropertiesType>(raw, "type")
      val url = json.decodeRequired<String>(raw, "url")
      if (!raw.containsKey("retrieved_at")) {
        throw SerializationException("AnthropicWebFetchBlock is missing required property 'retrieved_at'")
      }
      val retrievedAt = raw["retrieved_at"].let { element -> if (element == JsonNull) null else json
...
public fun anthropicWebFetchBlock(block: AnthropicWebFetchBlock.Builder.() -> Unit): AnthropicWebFetchBlock =
  AnthropicWebFetchBlock.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("AnthropicWebFetchBlock is missing required property '" +
    name + "'")
