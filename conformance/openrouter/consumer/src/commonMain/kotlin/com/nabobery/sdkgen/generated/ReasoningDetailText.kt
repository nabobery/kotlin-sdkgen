...
public class ReasoningDetailText(
  ...
  public class Builder {
    private var typeValue: InlineComponentsSchemasReasoningDetailTextPropertiesType? = null

    public var type: InlineComponentsSchemasReasoningDetailTextPropertiesType
  ...
  public object Serializer : KSerializer<ReasoningDetailText> {
    ...
    override fun deserialize(decoder: Decoder): ReasoningDetailText {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("ReasoningDetailText must be a JSON object")
      val type = json.decodeRequired<InlineComponentsSchemasReasoningDetailTextPropertiesType>(raw, "type")
      return ReasoningDetailText(
        type = type,
        ...
        signature = raw["signature"]?.let { element -> if (element == JsonNull) null else json
          .decodeFromJsonElement<String?>(element) },
        text = raw["text"]?.let { element -> if (element == JsonNull) null else json
          .decodeFromJsonElement<String?>(element) },
      )
    }
...
public fun reasoningDetailText(block: ReasoningDetailText.Builder.() -> Unit): ReasoningDetailText =
  ReasoningDetailText.build(block)
