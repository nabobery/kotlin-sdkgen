...
public data class MessagesSearchModelsServerToolView(
  ...
  public val type: InlineComponentsSchemasMessagesSearchModelsServerToolPropertiesType,
)
...
public class MessagesSearchModelsServerTool(
  ...
  public class Builder {
    private var typeValue: InlineComponentsSchemasMessagesSearchModelsServerToolPropertiesType? =
        null

    public var type: InlineComponentsSchemasMessagesSearchModelsServerToolPropertiesType
  ...
  public object Serializer : KSerializer<MessagesSearchModelsServerTool> {
    ...
    override fun deserialize(decoder: Decoder): MessagesSearchModelsServerTool {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("MessagesSearchModelsServerTool must be a JSON object")
      val type = json.decodeRequired<InlineComponentsSchemasMessagesSearchModelsServerToolPropertiesType>(raw, "type")
      return MessagesSearchModelsServerTool(
        type = type,
...
public fun messagesSearchModelsServerTool(block: MessagesSearchModelsServerTool.Builder.() ->
  Unit): MessagesSearchModelsServerTool = MessagesSearchModelsServerTool.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("MessagesSearchModelsServerTool is missing required property '" + name + "'")
