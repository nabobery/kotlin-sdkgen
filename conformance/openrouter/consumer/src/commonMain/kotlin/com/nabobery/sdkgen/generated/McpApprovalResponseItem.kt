...
public class McpApprovalResponseItem(
  ...
  public val type: InlineComponentsSchemasMcpApprovalResponseItemPropertiesType,
  ...
  public class Builder {
    ...
    private var typeValue: InlineComponentsSchemasMcpApprovalResponseItemPropertiesType? = null

    public var type: InlineComponentsSchemasMcpApprovalResponseItemPropertiesType
  ...
  public object Serializer : KSerializer<McpApprovalResponseItem> {
    ...
    override fun deserialize(decoder: Decoder): McpApprovalResponseItem {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("McpApprovalResponseItem must be a JSON object")
      val approvalRequestId = json.decodeRequired<String>(raw, "approval_request_id")
      val approve = json.decodeRequired<Boolean>(raw, "approve")
      val type = json.decodeRequired<InlineComponentsSchemasMcpApprovalResponseItemPropertiesType>(raw, "type")
      return McpApprovalResponseItem(
        approvalRequestId = approvalRequestId,
        approve = approve,
        type = type,
        ...
        reason = raw["reason"]?.let { element -> if (element == JsonNull) null else json
          .decodeFromJsonElement<String?>(element) },
      )
    }
...
public fun mcpApprovalResponseItem(block: McpApprovalResponseItem.Builder.() -> Unit): McpApprovalResponseItem =
  McpApprovalResponseItem.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("McpApprovalResponseItem is missing required property '" +
    name + "'")
