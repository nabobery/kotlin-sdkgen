...
public class ImageModelEndpointsResponse(
  ...
  public object Serializer : KSerializer<ImageModelEndpointsResponse> {
    ...
    override fun deserialize(decoder: Decoder): ImageModelEndpointsResponse {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("ImageModelEndpointsResponse must be a JSON object")
      val endpoints = json.decodeRequired<List<ImageEndpoint>>(raw, "endpoints")
...
public fun imageModelEndpointsResponse(block: ImageModelEndpointsResponse.Builder.() ->
  Unit): ImageModelEndpointsResponse = ImageModelEndpointsResponse.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("ImageModelEndpointsResponse is missing required property '" + name + "'")
