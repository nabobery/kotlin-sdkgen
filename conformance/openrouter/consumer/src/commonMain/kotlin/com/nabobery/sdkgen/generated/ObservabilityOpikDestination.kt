...
/**
 * Generated model for sdkgen://source/openapi.yaml#/components/schemas/ObservabilityOpikDestination.
 */
@Serializable(with = ObservabilityOpikDestination.Serializer::class)
public class ObservabilityOpikDestination(
  /**
  ...
  public class Builder {
    private var configValue: InlineComponentsSchemasObservabilityOpikDestinationPropertiesConfig? =
        null

    public var config: InlineComponentsSchemasObservabilityOpikDestinationPropertiesConfig
    ...
    private var typeValue: InlineComponentsSchemasObservabilityOpikDestinationPropertiesType? = null

    public var type: InlineComponentsSchemasObservabilityOpikDestinationPropertiesType
    ...
    public fun build(): ObservabilityOpikDestination {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): ObservabilityOpikDestination = Builder().apply(block).build()
  }

  public object Serializer : KSerializer<ObservabilityOpikDestination> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): ObservabilityOpikDestination {
      val jsonDecoder = decoder.requireJsonDecoder("ObservabilityOpikDestination")
      val json = jsonDecoder.json
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("ObservabilityOpikDestination must be a JSON object")
      val config = json.decodeRequired<InlineComponentsSchemasObservabilityOpikDestinationPropertiesConfig>(raw,
        "config")
      ...
      val type = json.decodeRequired<InlineComponentsSchemasObservabilityOpikDestinationPropertiesType>(raw, "type")
      ...
      if (!raw.containsKey("api_key_hashes")) {
        throw SerializationException("ObservabilityOpikDestination is missing required property 'api_key_hashes'")
      }
      ...
      if (!raw.containsKey("filter_rules")) {
        throw SerializationException("ObservabilityOpikDestination is missing required property 'filter_rules'")
      }
      ...
      if (!raw.containsKey("name")) {
        throw SerializationException("ObservabilityOpikDestination is missing required property 'name'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: ObservabilityOpikDestination) {
      val jsonEncoder = encoder.requireJsonEncoder("ObservabilityOpikDestination")
...
public fun observabilityOpikDestination(block: ObservabilityOpikDestination.Builder.() ->
  Unit): ObservabilityOpikDestination = ObservabilityOpikDestination.build(block)
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("ObservabilityOpikDestination property '" + name + "' is not nullable")
