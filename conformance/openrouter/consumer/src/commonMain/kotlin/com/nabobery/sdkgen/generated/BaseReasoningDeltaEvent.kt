...
public class BaseReasoningDeltaEvent(
  ...
  public object Serializer : KSerializer<BaseReasoningDeltaEvent> {
    ...
    override fun deserialize(decoder: Decoder): BaseReasoningDeltaEvent {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("BaseReasoningDeltaEvent must be a JSON object")
...
public fun baseReasoningDeltaEvent(block: BaseReasoningDeltaEvent.Builder.() -> Unit): BaseReasoningDeltaEvent =
  BaseReasoningDeltaEvent.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("BaseReasoningDeltaEvent is missing required property '" +
    name + "'")
