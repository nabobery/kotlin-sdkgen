...
public class MessagesErrorDetail(
  ...
  public object Serializer : KSerializer<MessagesErrorDetail> {
    ...
    override fun deserialize(decoder: Decoder): MessagesErrorDetail {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("MessagesErrorDetail must be a JSON object")
...
public fun messagesErrorDetail(block: MessagesErrorDetail.Builder.() -> Unit): MessagesErrorDetail =
  MessagesErrorDetail.build(block)
