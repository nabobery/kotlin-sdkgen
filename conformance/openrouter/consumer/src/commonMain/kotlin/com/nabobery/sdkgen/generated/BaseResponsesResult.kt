...
public class BaseResponsesResult internal constructor(
  ...
  public val objectValue: InlineComponentsSchemasBaseResponsesResultPropertiesObject,
  output: List<InlineComponentsSchemasBaseResponsesResultPropertiesOutputItems>,
  ...
  tools: List<InlineComponentsSchemasBaseResponsesResultPropertiesToolsItems>,
  ...
  public val output: List<InlineComponentsSchemasBaseResponsesResultPropertiesOutputItems> =
      output.toList()

  public val tools: List<InlineComponentsSchemasBaseResponsesResultPropertiesToolsItems> =
      tools.toList()
  ...
  public constructor(
    ...
    model: String,
    objectValue: InlineComponentsSchemasBaseResponsesResultPropertiesObject,
    output: List<InlineComponentsSchemasBaseResponsesResultPropertiesOutputItems>,
  ...
  public class Builder {
    ...
    private var objectValueValue: InlineComponentsSchemasBaseResponsesResultPropertiesObject? = null

    public var objectValue: InlineComponentsSchemasBaseResponsesResultPropertiesObject
      get() = requireNotNull(objectValueValue) { "objectValue is required" }
      set(`value`) {
        objectValueValue = value
      }

    private var outputValue: List<InlineComponentsSchemasBaseResponsesResultPropertiesOutputItems>?
        = null

    public var output: List<InlineComponentsSchemasBaseResponsesResultPropertiesOutputItems>
    ...
    private var toolsValue: List<InlineComponentsSchemasBaseResponsesResultPropertiesToolsItems>? =
        null

    public var tools: List<InlineComponentsSchemasBaseResponsesResultPropertiesToolsItems>
    ...
    public var metadata: Map<String, String>?
      ...
      set(`value`) {
        metadataState = value.toNullableFieldState()
      }
  ...
  public object Serializer : KSerializer<BaseResponsesResult> {
    ...
    override fun deserialize(decoder: Decoder): BaseResponsesResult {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("BaseResponsesResult must be a JSON object")
      val createdAt = json.decodeRequired<Int>(raw, "created_at")
      val id = json.decodeRequired<String>(raw, "id")
      val model = json.decodeRequired<String>(raw, "model")
      val objectValue = json.decodeRequired<InlineComponentsSchemasBaseResponsesResultPropertiesObject>(raw, "object")
      val output = json.decodeRequired<List<InlineComponentsSchemasBaseResponsesResultPropertiesOutputItems>>(raw,
        "output")
      val parallelToolCalls = json.decodeRequired<Boolean>(raw, "parallel_tool_calls")
      val status = json.decodeRequired<OpenAiResponsesResponseStatus>(raw, "status")
      val toolChoice = json.decodeRequired<OpenAiResponsesToolChoice>(raw, "tool_choice")
      val tools = json.decodeRequired<List<InlineComponentsSchemasBaseResponsesResultPropertiesToolsItems>>(raw,
        "tools")
      if (!raw.containsKey("completed_at")) {
        throw SerializationException("BaseResponsesResult is missing required property 'completed_at'")
      }
      val completedAt = raw["completed_at"].let { element -> if (element == JsonNull) null else json
      ...
      val error = raw["error"].let { element -> if (element == JsonNull) null else json
        .decodeFromJsonElement<ResponsesErrorField?>(requireNotNull(element)) }
      if (!raw.containsKey("frequency_penalty")) {
        throw SerializationException("BaseResponsesResult is missing required property 'frequency_penalty'")
      }
      val frequencyPenalty = raw["frequency_penalty"].let { element -> if (element == JsonNull) null else json
        .decodeFromJsonElement<Double?>(requireNotNull(element)) }
      if (!raw.containsKey("incomplete_details")) {
        throw SerializationException("BaseResponsesResult is missing required property 'incomplete_details'")
      }
      val incompleteDetails = raw["incomplete_details"].let { element -> if (element == JsonNull) null else json
        .decodeFromJsonElement<IncompleteDetails?>(requireNotNull(element)) }
      if (!raw.containsKey("instructions")) {
        throw SerializationException("BaseResponsesResult is missing required property 'instructions'")
      }
      val instructions = raw["instructions"].let { element -> if (element == JsonNull) null else json
        .decodeFromJsonElement<BaseInputs?>(requireNotNull(element)) }
      if (!raw.containsKey("metadata")) {
        throw SerializationException("BaseResponsesResult is missing required property 'metadata'")
      }
      val metadata = raw["metadata"].let { element -> if (element == JsonNull) null else json
        .decodeFromJsonElement<Map<String, String>?>(requireNotNull(element)) }
      if (!raw.containsKey("presence_penalty")) {
        throw SerializationException("BaseResponsesResult is missing required property 'presence_penalty'")
      }
      val presencePenalty = raw["presence_penalty"].let { element -> if (element == JsonNull) null else json
        .decodeFromJsonElement<Double?>(requireNotNull(element)) }
      if (!raw.containsKey("temperature")) {
        throw SerializationException("BaseResponsesResult is missing required property 'temperature'")
      }
      val temperature = raw["temperature"].let { element -> if (element == JsonNull) null else json
        .decodeFromJsonElement<Double?>(requireNotNull(element)) }
      if (!raw.containsKey("top_p")) {
        throw SerializationException("BaseResponsesResult is missing required property 'top_p'")
      }
      val topP = raw["top_p"].let { element -> if (element == JsonNull) null else json
        .decodeFromJsonElement<Double?>(requireNotNull(element)) }
      return BaseResponsesResult(
        ...
        tools = tools,
        topP = topP,
        backgroundState = json.decodeOptional(raw, "background", nullable = true),
        maxOutputTokensState = json.decodeOptional(raw, "max_output_tokens", nullable = true),
        maxToolCallsState = json.decodeOptional(raw, "max_tool_calls", nullable = true),
        outputTextState = json.decodeOptional(raw, "output_text", nullable = false),
        previousResponseIdState = json.decodeOptional(raw, "previous_response_id", nullable = true),
        promptState = json.decodeOptional(raw, "prompt", nullable = true),
        promptCacheKeyState = json.decodeOptional(raw, "prompt_cache_key", nullable = true),
        reasoningState = json.decodeOptional(raw, "reasoning", nullable = true),
        safetyIdentifierState = json.decodeOptional(raw, "safety_identifier", nullable = true),
        serviceTierState = json.decodeOptional(raw, "service_tier", nullable = true),
        storeState = json.decodeOptional(raw, "store", nullable = false),
        textState = json.decodeOptional(raw, "text", nullable = false),
        topLogprobsState = json.decodeOptional(raw, "top_logprobs", nullable = true),
        truncationState = json.decodeOptional(raw, "truncation", nullable = true),
        usageState = json.decodeOptional(raw, "usage", nullable = false),
        userState = json.decodeOptional(raw, "user", nullable = true),
      )
    }
...
public fun baseResponsesResult(block: BaseResponsesResult.Builder.() -> Unit): BaseResponsesResult =
  BaseResponsesResult.build(block)
