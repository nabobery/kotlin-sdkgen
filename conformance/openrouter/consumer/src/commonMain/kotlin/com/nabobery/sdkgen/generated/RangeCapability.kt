...
public class RangeCapability(
  ...
  public class Builder {
    ...
    private var typeValue: InlineComponentsSchemasRangeCapabilityPropertiesType? = null

    public var type: InlineComponentsSchemasRangeCapabilityPropertiesType
  ...
  public object Serializer : KSerializer<RangeCapability> {
    ...
    override fun deserialize(decoder: Decoder): RangeCapability {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("RangeCapability must be a JSON object")
      val max = json.decodeRequired<Double>(raw, "max")
      val min = json.decodeRequired<Double>(raw, "min")
      val type = json.decodeRequired<InlineComponentsSchemasRangeCapabilityPropertiesType>(raw, "type")
      return RangeCapability(
        max = max,
        min = min,
        type = type,
