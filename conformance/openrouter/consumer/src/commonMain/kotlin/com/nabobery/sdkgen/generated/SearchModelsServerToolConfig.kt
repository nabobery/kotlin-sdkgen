...
public class SearchModelsServerToolConfig(
  ...
  public object Serializer : KSerializer<SearchModelsServerToolConfig> {
    ...
    override fun deserialize(decoder: Decoder): SearchModelsServerToolConfig {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("SearchModelsServerToolConfig must be a JSON object")
...
public fun searchModelsServerToolConfig(block: SearchModelsServerToolConfig.Builder.() ->
  Unit): SearchModelsServerToolConfig = SearchModelsServerToolConfig.build(block)
