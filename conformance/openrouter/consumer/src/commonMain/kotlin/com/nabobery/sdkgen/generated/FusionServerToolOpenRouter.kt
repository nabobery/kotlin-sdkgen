...
public data class FusionServerToolOpenRouterView(
  ...
  public val type: InlineComponentsSchemasFusionServerToolOpenRouterPropertiesType,
)
...
public class FusionServerToolOpenRouter(
  ...
  public class Builder {
    private var typeValue: InlineComponentsSchemasFusionServerToolOpenRouterPropertiesType? = null

    public var type: InlineComponentsSchemasFusionServerToolOpenRouterPropertiesType
  ...
  public object Serializer : KSerializer<FusionServerToolOpenRouter> {
    ...
    override fun deserialize(decoder: Decoder): FusionServerToolOpenRouter {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("FusionServerToolOpenRouter must be a JSON object")
      val type = json.decodeRequired<InlineComponentsSchemasFusionServerToolOpenRouterPropertiesType>(raw, "type")
      return FusionServerToolOpenRouter(
        type = type,
        parameters = raw["parameters"]?.let { json.decodeFromJsonElement<FusionServerToolConfig>(it) },
      )
    }
...
public fun fusionServerToolOpenRouter(block: FusionServerToolOpenRouter.Builder.() ->
  Unit): FusionServerToolOpenRouter = FusionServerToolOpenRouter.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("FusionServerToolOpenRouter is missing required property '" +
    name + "'")
