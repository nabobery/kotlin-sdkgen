...
public class InternalServerResponseErrorData(
  ...
  public object Serializer : KSerializer<InternalServerResponseErrorData> {
    ...
    override fun deserialize(decoder: Decoder): InternalServerResponseErrorData {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("InternalServerResponseErrorData must be a JSON object")
...
public fun internalServerResponseErrorData(block: InternalServerResponseErrorData.Builder.() ->
  Unit): InternalServerResponseErrorData = InternalServerResponseErrorData.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("InternalServerResponseErrorData is missing required property '" + name + "'")
