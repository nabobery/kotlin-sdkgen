...
/**
 * Generated model for sdkgen://source/openapi.yaml#/components/schemas/ListEndpointsResponse/properties/architecture.
 */
@Serializable(with = InlineComponentsSchemasListEndpointsResponsePropertiesArchitecture.Serializer::class)
public class InlineComponentsSchemasListEndpointsResponsePropertiesArchitecture(
  ...
  public class Builder {
    ...
    private var tokenizerValue: ModelGroup? = null

    public var tokenizer: ModelGroup
      get() = requireNotNull(tokenizerValue) { "tokenizer is required" }
      set(`value`) {
        tokenizerValue = value
      }
    ...
    public fun build(): InlineComponentsSchemasListEndpointsResponsePropertiesArchitecture {
      check(inputModalitiesValue != null) { "inputModalities is required" }
      check(outputModalitiesValue != null) { "outputModalities is required" }
      check(tokenizerValue != null) { "tokenizer is required" }
      ...
      return InlineComponentsSchemasListEndpointsResponsePropertiesArchitecture(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineComponentsSchemasListEndpointsResponsePropertiesArchitecture =
      Builder().apply(block).build()
  }

  public object Serializer : KSerializer<InlineComponentsSchemasListEndpointsResponsePropertiesArchitecture> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineComponentsSchemasListEndpointsResponsePropertiesArchitecture {
      val jsonDecoder = decoder.requireJsonDecoder("InlineComponentsSchemasListEndpointsResponsePropertiesArchitecture")
      val json = jsonDecoder.json
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("InlineComponentsSchemasListEndpointsResponsePropertiesArchitecture must be a " +
          "JSON object")
      ...
      val tokenizer = json.decodeRequired<ModelGroup>(raw, "tokenizer")
      if (!raw.containsKey("instruct_type")) {
        throw SerializationException("InlineComponentsSchemasListEndpointsResponsePropertiesArchitecture is missing " +
          "required property 'instruct_type'")
      }
    ...
    override fun serialize(encoder: Encoder,
      `value`: InlineComponentsSchemasListEndpointsResponsePropertiesArchitecture) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineComponentsSchemasListEndpointsResponsePropertiesArchitecture")
      ...
      val raw = buildJsonObject {
        ...
        put("tokenizer", json.encodeToJsonElement(value.tokenizer))
      }
...
public fun inlineComponentsSchemasListEndpointsResponsePropertiesArchitecture(block: InlineComponentsSchemasListEndpointsResponsePropertiesArchitecture.Builder.() -> Unit): InlineComponentsSchemasListEndpointsResponsePropertiesArchitecture = InlineComponentsSchemasListEndpointsResponsePropertiesArchitecture.build(block)
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineComponentsSchemasListEndpointsResponsePropertiesArchitecture " +
