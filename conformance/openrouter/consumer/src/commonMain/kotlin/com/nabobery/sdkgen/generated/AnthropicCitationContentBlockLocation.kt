...
public class AnthropicCitationContentBlockLocation(
  ...
  public class Builder {
    ...
    private var typeValue:
        InlineComponentsSchemasAnthropicCitationContentBlockLocationPropertiesType? = null

    public var type: InlineComponentsSchemasAnthropicCitationContentBlockLocationPropertiesType
  ...
  public object Serializer : KSerializer<AnthropicCitationContentBlockLocation> {
    ...
    override fun deserialize(decoder: Decoder): AnthropicCitationContentBlockLocation {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("AnthropicCitationContentBlockLocation must be a JSON object")
      ...
      val type = json.decodeRequired<InlineComponentsSchemasAnthropicCitationContentBlockLocationPropertiesType>(raw,
        "type")
      if (!raw.containsKey("document_title")) {
        throw SerializationException("AnthropicCitationContentBlockLocation is missing required property " +
          "'document_title'")
      }
...
public fun anthropicCitationContentBlockLocation(block: AnthropicCitationContentBlockLocation.Builder.() ->
  Unit): AnthropicCitationContentBlockLocation = AnthropicCitationContentBlockLocation.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("AnthropicCitationContentBlockLocation is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("AnthropicCitationContentBlockLocation property '" + name +
      "' is not nullable")
