...
public class ListMemberAssignmentsResponse(
  ...
  public object Serializer : KSerializer<ListMemberAssignmentsResponse> {
    ...
    override fun deserialize(decoder: Decoder): ListMemberAssignmentsResponse {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("ListMemberAssignmentsResponse must be a JSON object")
      val data = json.decodeRequired<List<MemberAssignment>>(raw, "data")
...
public fun listMemberAssignmentsResponse(block: ListMemberAssignmentsResponse.Builder.() ->
  Unit): ListMemberAssignmentsResponse = ListMemberAssignmentsResponse.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("ListMemberAssignmentsResponse is missing required property '" + name + "'")
