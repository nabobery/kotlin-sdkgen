...
public class TopProviderInfo(
  ...
  public object Serializer : KSerializer<TopProviderInfo> {
    ...
    override fun deserialize(decoder: Decoder): TopProviderInfo {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("TopProviderInfo must be a JSON object")
      val isModerated = json.decodeRequired<Boolean>(raw, "is_moderated")
      return TopProviderInfo(
        isModerated = isModerated,
        contextLength = raw["context_length"]?.let { element -> if (element == JsonNull) null else json
