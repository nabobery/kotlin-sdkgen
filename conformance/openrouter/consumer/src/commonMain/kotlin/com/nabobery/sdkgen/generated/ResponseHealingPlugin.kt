...
public class ResponseHealingPlugin(
  ...
  public class Builder {
    private var idValue: InlineComponentsSchemasResponseHealingPluginPropertiesId? = null

    public var id: InlineComponentsSchemasResponseHealingPluginPropertiesId
  ...
  public object Serializer : KSerializer<ResponseHealingPlugin> {
    ...
    override fun deserialize(decoder: Decoder): ResponseHealingPlugin {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("ResponseHealingPlugin must be a JSON object")
      val id = json.decodeRequired<InlineComponentsSchemasResponseHealingPluginPropertiesId>(raw, "id")
      return ResponseHealingPlugin(
        id = id,
...
public fun responseHealingPlugin(block: ResponseHealingPlugin.Builder.() -> Unit): ResponseHealingPlugin =
  ResponseHealingPlugin.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("ResponseHealingPlugin is missing required property '" +
    name + "'")
