...
public class CreatePresetFromInferenceResponse(
  ...
  public object Serializer : KSerializer<CreatePresetFromInferenceResponse> {
    ...
    override fun deserialize(decoder: Decoder): CreatePresetFromInferenceResponse {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("CreatePresetFromInferenceResponse must be a JSON object")
      val data = json.decodeRequired<PresetWithDesignatedVersion>(raw, "data")
      return CreatePresetFromInferenceResponse(
        data = data,
      )
    }
...
public fun createPresetFromInferenceResponse(block: CreatePresetFromInferenceResponse.Builder.() ->
  Unit): CreatePresetFromInferenceResponse = CreatePresetFromInferenceResponse.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("CreatePresetFromInferenceResponse is missing required property '" + name + "'")
