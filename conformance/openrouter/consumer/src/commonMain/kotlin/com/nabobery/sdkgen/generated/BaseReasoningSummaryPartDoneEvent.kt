...
public class BaseReasoningSummaryPartDoneEvent(
  ...
  public object Serializer : KSerializer<BaseReasoningSummaryPartDoneEvent> {
    ...
    override fun deserialize(decoder: Decoder): BaseReasoningSummaryPartDoneEvent {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("BaseReasoningSummaryPartDoneEvent must be a JSON object")
...
public fun baseReasoningSummaryPartDoneEvent(block: BaseReasoningSummaryPartDoneEvent.Builder.() ->
  Unit): BaseReasoningSummaryPartDoneEvent = BaseReasoningSummaryPartDoneEvent.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("BaseReasoningSummaryPartDoneEvent is missing required property '" + name + "'")
