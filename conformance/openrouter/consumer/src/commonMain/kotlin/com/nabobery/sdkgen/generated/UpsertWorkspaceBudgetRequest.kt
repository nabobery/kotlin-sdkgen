...
public class UpsertWorkspaceBudgetRequest(
  ...
  public object Serializer : KSerializer<UpsertWorkspaceBudgetRequest> {
    ...
    override fun deserialize(decoder: Decoder): UpsertWorkspaceBudgetRequest {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("UpsertWorkspaceBudgetRequest must be a JSON object")
...
public fun upsertWorkspaceBudgetRequest(block: UpsertWorkspaceBudgetRequest.Builder.() ->
  Unit): UpsertWorkspaceBudgetRequest = UpsertWorkspaceBudgetRequest.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("UpsertWorkspaceBudgetRequest is missing required property '" + name + "'")
