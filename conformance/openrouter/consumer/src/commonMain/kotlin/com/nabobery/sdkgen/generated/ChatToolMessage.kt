...
public class ChatToolMessage(
  ...
  public class Builder {
    private var contentValue: InlineComponentsSchemasChatToolMessagePropertiesContent? = null

    public var content: InlineComponentsSchemasChatToolMessagePropertiesContent
      get() = requireNotNull(contentValue) { "content is required" }
      set(`value`) {
        contentValue = value
      }

    private var roleValue: InlineComponentsSchemasChatToolMessagePropertiesRole? = null

    public var role: InlineComponentsSchemasChatToolMessagePropertiesRole
  ...
  public object Serializer : KSerializer<ChatToolMessage> {
    ...
    override fun deserialize(decoder: Decoder): ChatToolMessage {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("ChatToolMessage must be a JSON object")
      val content = json.decodeRequired<InlineComponentsSchemasChatToolMessagePropertiesContent>(raw, "content")
      val role = json.decodeRequired<InlineComponentsSchemasChatToolMessagePropertiesRole>(raw, "role")
      val toolCallId = json.decodeRequired<String>(raw, "tool_call_id")
      return ChatToolMessage(
        content = content,
        role = role,
        toolCallId = toolCallId,
