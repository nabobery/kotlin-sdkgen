...
public class BooleanCapability(
  ...
  public class Builder {
    private var typeValue: InlineComponentsSchemasBooleanCapabilityPropertiesType? = null

    public var type: InlineComponentsSchemasBooleanCapabilityPropertiesType
  ...
  public object Serializer : KSerializer<BooleanCapability> {
    ...
    override fun deserialize(decoder: Decoder): BooleanCapability {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("BooleanCapability must be a JSON object")
      val type = json.decodeRequired<InlineComponentsSchemasBooleanCapabilityPropertiesType>(raw, "type")
      return BooleanCapability(
        type = type,
      )
    }
...
public fun booleanCapability(block: BooleanCapability.Builder.() -> Unit): BooleanCapability = BooleanCapability
  .build(block)
