...
public data class ApplyPatchCallItemView(
  ...
  public val type: InlineComponentsSchemasApplyPatchCallItemPropertiesType,
)
...
public class ApplyPatchCallItem(
  ...
  public class Builder {
    ...
    private var typeValue: InlineComponentsSchemasApplyPatchCallItemPropertiesType? = null

    public var type: InlineComponentsSchemasApplyPatchCallItemPropertiesType
  ...
  public object Serializer : KSerializer<ApplyPatchCallItem> {
    ...
    override fun deserialize(decoder: Decoder): ApplyPatchCallItem {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("ApplyPatchCallItem must be a JSON object")
      ...
      val type = json.decodeRequired<InlineComponentsSchemasApplyPatchCallItemPropertiesType>(raw, "type")
      return ApplyPatchCallItem(
        callId = callId,
        operation = operation,
        status = status,
...
public fun applyPatchCallItem(block: ApplyPatchCallItem.Builder.() -> Unit): ApplyPatchCallItem = ApplyPatchCallItem
  .build(block)
