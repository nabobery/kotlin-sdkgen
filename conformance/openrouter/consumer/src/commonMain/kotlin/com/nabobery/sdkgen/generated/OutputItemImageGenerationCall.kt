...
public class OutputItemImageGenerationCall(
  ...
  public class Builder {
    ...
    private var typeValue: InlineComponentsSchemasOutputItemImageGenerationCallPropertiesType? =
        null

    public var type: InlineComponentsSchemasOutputItemImageGenerationCallPropertiesType
  ...
  public object Serializer : KSerializer<OutputItemImageGenerationCall> {
    ...
    override fun deserialize(decoder: Decoder): OutputItemImageGenerationCall {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("OutputItemImageGenerationCall must be a JSON object")
      val id = json.decodeRequired<String>(raw, "id")
      val status = json.decodeRequired<ImageGenerationStatus>(raw, "status")
      val type = json.decodeRequired<InlineComponentsSchemasOutputItemImageGenerationCallPropertiesType>(raw, "type")
      return OutputItemImageGenerationCall(
        id = id,
        status = status,
        type = type,
...
public fun outputItemImageGenerationCall(block: OutputItemImageGenerationCall.Builder.() ->
  Unit): OutputItemImageGenerationCall = OutputItemImageGenerationCall.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("OutputItemImageGenerationCall is missing required property '" + name + "'")
