...
public class UnauthorizedResponseErrorData(
  ...
  public object Serializer : KSerializer<UnauthorizedResponseErrorData> {
    ...
    override fun deserialize(decoder: Decoder): UnauthorizedResponseErrorData {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("UnauthorizedResponseErrorData must be a JSON object")
...
public fun unauthorizedResponseErrorData(block: UnauthorizedResponseErrorData.Builder.() ->
  Unit): UnauthorizedResponseErrorData = UnauthorizedResponseErrorData.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("UnauthorizedResponseErrorData is missing required property '" + name + "'")
