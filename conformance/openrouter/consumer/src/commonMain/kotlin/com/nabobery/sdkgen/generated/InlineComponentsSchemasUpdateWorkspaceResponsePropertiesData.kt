 ...
 */
@Serializable(with = InlineComponentsSchemasUpdateWorkspaceResponsePropertiesData.Serializer::class)
public class InlineComponentsSchemasUpdateWorkspaceResponsePropertiesData(
  /**
  ...
  public class Builder {
    ...
    public fun build(): InlineComponentsSchemasUpdateWorkspaceResponsePropertiesData {
      ...
      return InlineComponentsSchemasUpdateWorkspaceResponsePropertiesData(
        createdAt = createdAt,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineComponentsSchemasUpdateWorkspaceResponsePropertiesData =
      Builder().apply(block).build()
  }

  public object Serializer : KSerializer<InlineComponentsSchemasUpdateWorkspaceResponsePropertiesData> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineComponentsSchemasUpdateWorkspaceResponsePropertiesData {
      val jsonDecoder = decoder.requireJsonDecoder("InlineComponentsSchemasUpdateWorkspaceResponsePropertiesData")
      val json = jsonDecoder.json
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("InlineComponentsSchemasUpdateWorkspaceResponsePropertiesData must be a JSON " +
          "object")
      ...
      if (!raw.containsKey("created_by")) {
        throw SerializationException("InlineComponentsSchemasUpdateWorkspaceResponsePropertiesData is missing " +
    ...
    override fun serialize(encoder: Encoder, `value`: InlineComponentsSchemasUpdateWorkspaceResponsePropertiesData) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineComponentsSchemasUpdateWorkspaceResponsePropertiesData")
...
public fun inlineComponentsSchemasUpdateWorkspaceResponsePropertiesData(block: InlineComponentsSchemasUpdateWorkspaceResponsePropertiesData.Builder.() -> Unit): InlineComponentsSchemasUpdateWorkspaceResponsePropertiesData = InlineComponentsSchemasUpdateWorkspaceResponsePropertiesData.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("InlineComponentsSchemasUpdateWorkspaceResponsePropertiesData is missing required " +
      "property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineComponentsSchemasUpdateWorkspaceResponsePropertiesData " +
