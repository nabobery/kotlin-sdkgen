...
public class OpenAiResponsesImageGenCallCompleted(
  ...
  public object Serializer : KSerializer<OpenAiResponsesImageGenCallCompleted> {
    ...
    override fun deserialize(decoder: Decoder): OpenAiResponsesImageGenCallCompleted {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("OpenAiResponsesImageGenCallCompleted must be a JSON object")
...
public fun openAiResponsesImageGenCallCompleted(block: OpenAiResponsesImageGenCallCompleted.Builder.() ->
  Unit): OpenAiResponsesImageGenCallCompleted = OpenAiResponsesImageGenCallCompleted.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("OpenAiResponsesImageGenCallCompleted is missing required property '" + name + "'")
