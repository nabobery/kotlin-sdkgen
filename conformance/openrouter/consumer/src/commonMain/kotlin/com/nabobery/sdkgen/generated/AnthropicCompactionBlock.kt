...
public class AnthropicCompactionBlock(
  ...
  public val type: InlineComponentsSchemasAnthropicCompactionBlockPropertiesType,
) {
  public class Builder {
    private var typeValue: InlineComponentsSchemasAnthropicCompactionBlockPropertiesType? = null

    public var type: InlineComponentsSchemasAnthropicCompactionBlockPropertiesType
  ...
  public object Serializer : KSerializer<AnthropicCompactionBlock> {
    ...
    override fun deserialize(decoder: Decoder): AnthropicCompactionBlock {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("AnthropicCompactionBlock must be a JSON object")
      val type = json.decodeRequired<InlineComponentsSchemasAnthropicCompactionBlockPropertiesType>(raw, "type")
...
public fun anthropicCompactionBlock(block: AnthropicCompactionBlock.Builder.() -> Unit): AnthropicCompactionBlock =
  AnthropicCompactionBlock.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("AnthropicCompactionBlock is missing required property '" +
    name + "'")
