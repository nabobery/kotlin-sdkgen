...
public class ChatDebugOptions(
  ...
  public object Serializer : KSerializer<ChatDebugOptions> {
    ...
    override fun deserialize(decoder: Decoder): ChatDebugOptions {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("ChatDebugOptions must be a JSON object")
      return ChatDebugOptions(
        echoUpstreamBody = raw["echo_upstream_body"]?.let { json.decodeFromJsonElement<Boolean>(it) },
      )
    }
...
public fun chatDebugOptions(block: ChatDebugOptions.Builder.() -> Unit): ChatDebugOptions = ChatDebugOptions
  .build(block)
