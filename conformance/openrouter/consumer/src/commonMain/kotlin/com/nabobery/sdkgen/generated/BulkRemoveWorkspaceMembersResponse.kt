...
public class BulkRemoveWorkspaceMembersResponse(
  ...
  public object Serializer : KSerializer<BulkRemoveWorkspaceMembersResponse> {
    ...
    override fun deserialize(decoder: Decoder): BulkRemoveWorkspaceMembersResponse {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("BulkRemoveWorkspaceMembersResponse must be a JSON object")
      val removedCount = json.decodeRequired<Int>(raw, "removed_count")
      return BulkRemoveWorkspaceMembersResponse(
        removedCount = removedCount,
      )
    }
...
public fun bulkRemoveWorkspaceMembersResponse(block: BulkRemoveWorkspaceMembersResponse.Builder.() ->
  Unit): BulkRemoveWorkspaceMembersResponse = BulkRemoveWorkspaceMembersResponse.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("BulkRemoveWorkspaceMembersResponse is missing required property '" + name + "'")
