...
public class PromptCacheBreakpoint(
  public val mode: InlineComponentsSchemasPromptCacheBreakpointPropertiesMode,
) {
  public class Builder {
    private var modeValue: InlineComponentsSchemasPromptCacheBreakpointPropertiesMode? = null

    public var mode: InlineComponentsSchemasPromptCacheBreakpointPropertiesMode
  ...
  public object Serializer : KSerializer<PromptCacheBreakpoint> {
    ...
    override fun deserialize(decoder: Decoder): PromptCacheBreakpoint {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("PromptCacheBreakpoint must be a JSON object")
      val mode = json.decodeRequired<InlineComponentsSchemasPromptCacheBreakpointPropertiesMode>(raw, "mode")
      return PromptCacheBreakpoint(
        mode = mode,
      )
    }
...
public fun promptCacheBreakpoint(block: PromptCacheBreakpoint.Builder.() -> Unit): PromptCacheBreakpoint =
  PromptCacheBreakpoint.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("PromptCacheBreakpoint is missing required property '" +
    name + "'")
