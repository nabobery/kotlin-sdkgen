 ...
 */
@Serializable(with = InlineComponentsSchemasMessagesDeltaEventPropertiesUsage.Serializer::class)
public class InlineComponentsSchemasMessagesDeltaEventPropertiesUsage internal constructor(
  ...
  public val serverToolUse:
      InlineComponentsSchemasMessagesDeltaEventPropertiesUsagePropertiesServerToolUse?,
  ...
  public constructor(
    ...
    serverToolUse: InlineComponentsSchemasMessagesDeltaEventPropertiesUsagePropertiesServerToolUse?,
  ...
  public class Builder {
    ...
    private var serverToolUseState:
        FieldState<InlineComponentsSchemasMessagesDeltaEventPropertiesUsagePropertiesServerToolUse?>
        = FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var serverToolUse:
        InlineComponentsSchemasMessagesDeltaEventPropertiesUsagePropertiesServerToolUse?
    ...
    public var iterations: List<AnthropicUsageIteration>?
      ...
      set(`value`) {
        ...
        iterationsState = FieldState.Value(present)
      }
    ...
    public fun build(): InlineComponentsSchemasMessagesDeltaEventPropertiesUsage {
      check(outputTokensValue != null) { "outputTokens is required" }
      check(cacheCreationInputTokensState !== FieldState.Absent) {
        "cacheCreationInputTokens is required, even when null" }
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineComponentsSchemasMessagesDeltaEventPropertiesUsage = Builder()
      .apply(block).build()
  }

  public object Serializer : KSerializer<InlineComponentsSchemasMessagesDeltaEventPropertiesUsage> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineComponentsSchemasMessagesDeltaEventPropertiesUsage {
      val jsonDecoder = decoder.requireJsonDecoder("InlineComponentsSchemasMessagesDeltaEventPropertiesUsage")
      val json = jsonDecoder.json
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("InlineComponentsSchemasMessagesDeltaEventPropertiesUsage must be a JSON object")
      val outputTokens = json.decodeRequired<Int>(raw, "output_tokens")
      if (!raw.containsKey("cache_creation_input_tokens")) {
        throw SerializationException("InlineComponentsSchemasMessagesDeltaEventPropertiesUsage is missing required " +
          "property 'cache_creation_input_tokens'")
      }
      val cacheCreationInputTokens = raw["cache_creation_input_tokens"].let { element ->
        if (element == JsonNull) null else json.decodeFromJsonElement<Int?>(requireNotNull(element)) }
      if (!raw.containsKey("cache_read_input_tokens")) {
        throw SerializationException("InlineComponentsSchemasMessagesDeltaEventPropertiesUsage is missing required " +
          "property 'cache_read_input_tokens'")
      }
      val cacheReadInputTokens = raw["cache_read_input_tokens"].let { element ->
        if (element == JsonNull) null else json.decodeFromJsonElement<Int?>(requireNotNull(element)) }
      if (!raw.containsKey("input_tokens")) {
        throw SerializationException("InlineComponentsSchemasMessagesDeltaEventPropertiesUsage is missing required " +
          "property 'input_tokens'")
      }
      val inputTokens = raw["input_tokens"].let { element -> if (element == JsonNull) null else json
        .decodeFromJsonElement<Int?>(requireNotNull(element)) }
      if (!raw.containsKey("output_tokens_details")) {
        throw SerializationException("InlineComponentsSchemasMessagesDeltaEventPropertiesUsage is missing required " +
          "property 'output_tokens_details'")
      }
      val outputTokensDetails = raw["output_tokens_details"].let { element -> if (element == JsonNull) null else json
        .decodeFromJsonElement<AnthropicOutputTokensDetails?>(requireNotNull(element)) }
      if (!raw.containsKey("server_tool_use")) {
        throw SerializationException("InlineComponentsSchemasMessagesDeltaEventPropertiesUsage is missing required " +
      ...
      return InlineComponentsSchemasMessagesDeltaEventPropertiesUsage(
        ...
        outputTokensDetails = outputTokensDetails,
        serverToolUse = serverToolUse,
        cacheCreationState = json.decodeOptional(raw, "cache_creation", nullable = true),
        iterationsState = json.decodeOptional(raw, "iterations", nullable = false),
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineComponentsSchemasMessagesDeltaEventPropertiesUsage) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineComponentsSchemasMessagesDeltaEventPropertiesUsage")
      val json = jsonEncoder.json
      val raw = buildJsonObject {
        put("cache_creation_input_tokens", value.cacheCreationInputTokens?.let { json.encodeToJsonElement(it) } ?:
          JsonNull)
...
public fun inlineComponentsSchemasMessagesDeltaEventPropertiesUsage(block: InlineComponentsSchemasMessagesDeltaEventPropertiesUsage.Builder.() -> Unit): InlineComponentsSchemasMessagesDeltaEventPropertiesUsage = InlineComponentsSchemasMessagesDeltaEventPropertiesUsage.build(block)
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineComponentsSchemasMessagesDeltaEventPropertiesUsage property '" +
