...
public data class BashServerToolView(
  ...
  public val type: InlineComponentsSchemasBashServerToolPropertiesType,
)
...
public class BashServerTool(
  ...
  public class Builder {
    private var typeValue: InlineComponentsSchemasBashServerToolPropertiesType? = null

    public var type: InlineComponentsSchemasBashServerToolPropertiesType
  ...
  public object Serializer : KSerializer<BashServerTool> {
    ...
    override fun deserialize(decoder: Decoder): BashServerTool {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("BashServerTool must be a JSON object")
      val type = json.decodeRequired<InlineComponentsSchemasBashServerToolPropertiesType>(raw, "type")
      return BashServerTool(
        type = type,
        parameters = raw["parameters"]?.let { json.decodeFromJsonElement<BashServerToolConfig>(it) },
      )
    }
