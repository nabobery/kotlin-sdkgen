...
public class ModelsCountResponse(
   ...
   * Model count data
   */
  public val `data`: InlineComponentsSchemasModelsCountResponsePropertiesData,
) {
  public class Builder {
    private var dataValue: InlineComponentsSchemasModelsCountResponsePropertiesData? = null

    public var `data`: InlineComponentsSchemasModelsCountResponsePropertiesData
  ...
  public object Serializer : KSerializer<ModelsCountResponse> {
    ...
    override fun deserialize(decoder: Decoder): ModelsCountResponse {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("ModelsCountResponse must be a JSON object")
      val data = json.decodeRequired<InlineComponentsSchemasModelsCountResponsePropertiesData>(raw, "data")
      return ModelsCountResponse(
        data = data,
      )
    }
...
public fun modelsCountResponse(block: ModelsCountResponse.Builder.() -> Unit): ModelsCountResponse =
  ModelsCountResponse.build(block)
