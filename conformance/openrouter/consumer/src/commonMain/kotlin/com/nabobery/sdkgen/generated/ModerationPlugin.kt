...
public class ModerationPlugin(
  ...
  public class Builder {
    private var idValue: InlineComponentsSchemasModerationPluginPropertiesId? = null

    public var id: InlineComponentsSchemasModerationPluginPropertiesId
  ...
  public object Serializer : KSerializer<ModerationPlugin> {
    ...
    override fun deserialize(decoder: Decoder): ModerationPlugin {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("ModerationPlugin must be a JSON object")
      val id = json.decodeRequired<InlineComponentsSchemasModerationPluginPropertiesId>(raw, "id")
      return ModerationPlugin(
        id = id,
      )
    }
...
public fun moderationPlugin(block: ModerationPlugin.Builder.() -> Unit): ModerationPlugin = ModerationPlugin
  .build(block)
