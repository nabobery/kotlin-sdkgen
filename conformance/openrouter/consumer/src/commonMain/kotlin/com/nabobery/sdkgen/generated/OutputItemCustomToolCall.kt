...
public class OutputItemCustomToolCall(
  ...
  public class Builder {
    ...
    private var typeValue: InlineComponentsSchemasOutputItemCustomToolCallPropertiesType? = null

    public var type: InlineComponentsSchemasOutputItemCustomToolCallPropertiesType
  ...
  public object Serializer : KSerializer<OutputItemCustomToolCall> {
    ...
    override fun deserialize(decoder: Decoder): OutputItemCustomToolCall {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("OutputItemCustomToolCall must be a JSON object")
      ...
      val type = json.decodeRequired<InlineComponentsSchemasOutputItemCustomToolCallPropertiesType>(raw, "type")
      return OutputItemCustomToolCall(
        callId = callId,
        input = input,
        name = name,
...
public fun outputItemCustomToolCall(block: OutputItemCustomToolCall.Builder.() -> Unit): OutputItemCustomToolCall =
  OutputItemCustomToolCall.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("OutputItemCustomToolCall is missing required property '" +
    name + "'")
