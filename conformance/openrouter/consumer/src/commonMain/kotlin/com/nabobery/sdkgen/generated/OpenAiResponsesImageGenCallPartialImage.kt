...
public class OpenAiResponsesImageGenCallPartialImage(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): OpenAiResponsesImageGenCallPartialImage = Builder().apply(block)
      .build()
  }

  public object Serializer : KSerializer<OpenAiResponsesImageGenCallPartialImage> {
    ...
    override fun deserialize(decoder: Decoder): OpenAiResponsesImageGenCallPartialImage {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("OpenAiResponsesImageGenCallPartialImage must be a JSON object")
...
public fun openAiResponsesImageGenCallPartialImage(block: OpenAiResponsesImageGenCallPartialImage.Builder.() ->
  Unit): OpenAiResponsesImageGenCallPartialImage = OpenAiResponsesImageGenCallPartialImage.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("OpenAiResponsesImageGenCallPartialImage is missing required property '" + name + "'")
