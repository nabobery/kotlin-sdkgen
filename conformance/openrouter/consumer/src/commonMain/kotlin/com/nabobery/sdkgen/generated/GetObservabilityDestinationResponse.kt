...
public class GetObservabilityDestinationResponse(
  ...
  public object Serializer : KSerializer<GetObservabilityDestinationResponse> {
    ...
    override fun deserialize(decoder: Decoder): GetObservabilityDestinationResponse {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("GetObservabilityDestinationResponse must be a JSON object")
...
public fun getObservabilityDestinationResponse(block: GetObservabilityDestinationResponse.Builder.() ->
  Unit): GetObservabilityDestinationResponse = GetObservabilityDestinationResponse.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("GetObservabilityDestinationResponse is missing required property '" + name + "'")
