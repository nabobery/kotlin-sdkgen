...
public data class ChatSearchModelsServerToolView(
  ...
  public val type: InlineComponentsSchemasChatSearchModelsServerToolPropertiesType,
)
...
public class ChatSearchModelsServerTool(
  ...
  public class Builder {
    private var typeValue: InlineComponentsSchemasChatSearchModelsServerToolPropertiesType? = null

    public var type: InlineComponentsSchemasChatSearchModelsServerToolPropertiesType
  ...
  public object Serializer : KSerializer<ChatSearchModelsServerTool> {
    ...
    override fun deserialize(decoder: Decoder): ChatSearchModelsServerTool {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("ChatSearchModelsServerTool must be a JSON object")
      val type = json.decodeRequired<InlineComponentsSchemasChatSearchModelsServerToolPropertiesType>(raw, "type")
      return ChatSearchModelsServerTool(
        type = type,
...
public fun chatSearchModelsServerTool(block: ChatSearchModelsServerTool.Builder.() ->
  Unit): ChatSearchModelsServerTool = ChatSearchModelsServerTool.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("ChatSearchModelsServerTool is missing required property '" +
    name + "'")
