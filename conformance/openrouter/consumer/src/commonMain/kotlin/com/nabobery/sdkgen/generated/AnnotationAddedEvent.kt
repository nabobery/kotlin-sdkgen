...
public class AnnotationAddedEvent(
  ...
  public object Serializer : KSerializer<AnnotationAddedEvent> {
    ...
    override fun deserialize(decoder: Decoder): AnnotationAddedEvent {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("AnnotationAddedEvent must be a JSON object")
...
public fun annotationAddedEvent(block: AnnotationAddedEvent.Builder.() -> Unit): AnnotationAddedEvent =
  AnnotationAddedEvent.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("AnnotationAddedEvent is missing required property '" +
    name + "'")
