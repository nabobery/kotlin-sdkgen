...
public class ChatChoice internal constructor(
  ...
  public object Serializer : KSerializer<ChatChoice> {
    ...
    override fun deserialize(decoder: Decoder): ChatChoice {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("ChatChoice must be a JSON object")
      val index = json.decodeRequired<Int>(raw, "index")
      val message = json.decodeRequired<ChatAssistantMessage>(raw, "message")
