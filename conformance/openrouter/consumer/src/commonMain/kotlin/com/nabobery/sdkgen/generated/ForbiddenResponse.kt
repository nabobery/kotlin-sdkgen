...
public class ForbiddenResponse(
  ...
  public object Serializer : KSerializer<ForbiddenResponse> {
    ...
    override fun deserialize(decoder: Decoder): ForbiddenResponse {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("ForbiddenResponse must be a JSON object")
      val error = json.decodeRequired<ForbiddenResponseErrorData>(raw, "error")
      return ForbiddenResponse(
        error = error,
...
public fun forbiddenResponse(block: ForbiddenResponse.Builder.() -> Unit): ForbiddenResponse = ForbiddenResponse
  .build(block)
