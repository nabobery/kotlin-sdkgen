 ...
 */
@Serializable(with = InlinePathsKeysHashPatchRequestBodyContentApplicationJsonSchema.Serializer::class)
public class InlinePathsKeysHashPatchRequestBodyContentApplicationJsonSchema internal constructor(
  ...
  private val limitResetState:
      FieldState<InlinePathsKeysHashPatchRequestBodyContentApplicationJsonSchemaPropertiesLimitReset?>,
  ...
  public class Builder {
    ...
    public var includeByokInLimit: Boolean?
      ...
      set(`value`) {
        val present = requireNotNull(value) {
          "includeByokInLimit is not nullable; call unsetIncludeByokInLimit() to omit it" }
    ...
    public fun build(): InlinePathsKeysHashPatchRequestBodyContentApplicationJsonSchema =
      InlinePathsKeysHashPatchRequestBodyContentApplicationJsonSchema(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlinePathsKeysHashPatchRequestBodyContentApplicationJsonSchema =
      Builder().apply(block).build()
  }

  public object Serializer : KSerializer<InlinePathsKeysHashPatchRequestBodyContentApplicationJsonSchema> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlinePathsKeysHashPatchRequestBodyContentApplicationJsonSchema {
      val jsonDecoder = decoder.requireJsonDecoder("InlinePathsKeysHashPatchRequestBodyContentApplicationJsonSchema")
      val json = jsonDecoder.json
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("InlinePathsKeysHashPatchRequestBodyContentApplicationJsonSchema must be a JSON " +
          "object")
      return InlinePathsKeysHashPatchRequestBodyContentApplicationJsonSchema(
        disabledState = json.decodeOptional(raw, "disabled", nullable = false),
        includeByokInLimitState = json.decodeOptional(raw, "include_byok_in_limit", nullable = false),
        limitState = json.decodeOptional(raw, "limit", nullable = true),
        limitResetState = json.decodeOptional(raw, "limit_reset", nullable = true),
        nameState = json.decodeOptional(raw, "name", nullable = false),
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlinePathsKeysHashPatchRequestBodyContentApplicationJsonSchema) {
      val jsonEncoder = encoder.requireJsonEncoder("InlinePathsKeysHashPatchRequestBodyContentApplicationJsonSchema")
...
public fun inlinePathsKeysHashPatchRequestBodyContentApplicationJsonSchema(block: InlinePathsKeysHashPatchRequestBodyContentApplicationJsonSchema.Builder.() -> Unit): InlinePathsKeysHashPatchRequestBodyContentApplicationJsonSchema = InlinePathsKeysHashPatchRequestBodyContentApplicationJsonSchema.build(block)
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlinePathsKeysHashPatchRequestBodyContentApplicationJsonSchema " +
