...
public class UpdateObservabilityDestinationResponse(
  ...
  public object Serializer : KSerializer<UpdateObservabilityDestinationResponse> {
    ...
    override fun deserialize(decoder: Decoder): UpdateObservabilityDestinationResponse {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("UpdateObservabilityDestinationResponse must be a JSON object")
...
public fun updateObservabilityDestinationResponse(block: UpdateObservabilityDestinationResponse.Builder.() ->
  Unit): UpdateObservabilityDestinationResponse = UpdateObservabilityDestinationResponse.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("UpdateObservabilityDestinationResponse is missing required property '" + name + "'")
