 ...
 */
@Serializable(with = InlinePathsKeysPostResponses201ContentApplicationJsonSchemaPropertiesData.Serializer::class)
public class InlinePathsKeysPostResponses201ContentApplicationJsonSchemaPropertiesData internal constructor(
  /**
  ...
  public class Builder {
    ...
    public fun build(): InlinePathsKeysPostResponses201ContentApplicationJsonSchemaPropertiesData {
      ...
      return InlinePathsKeysPostResponses201ContentApplicationJsonSchemaPropertiesData(
        byokUsage = byokUsage,
        byokUsageDaily = byokUsageDaily,
        byokUsageMonthly = byokUsageMonthly,
        byokUsageWeekly = byokUsageWeekly,
  ...
  public companion object {
    public fun build(block: Builder.() ->
      Unit): InlinePathsKeysPostResponses201ContentApplicationJsonSchemaPropertiesData = Builder().apply(block).build()
  }

  public object Serializer : KSerializer<InlinePathsKeysPostResponses201ContentApplicationJsonSchemaPropertiesData> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlinePathsKeysPostResponses201ContentApplicationJsonSchemaPropertiesData {
      val jsonDecoder = decoder
        .requireJsonDecoder("InlinePathsKeysPostResponses201ContentApplicationJsonSchemaPropertiesData")
      val json = jsonDecoder.json
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("InlinePathsKeysPostResponses201ContentApplicationJsonSchemaPropertiesData must " +
          "be a JSON object")
      ...
      if (!raw.containsKey("creator_user_id")) {
        throw SerializationException("InlinePathsKeysPostResponses201ContentApplicationJsonSchemaPropertiesData is " +
    ...
    override fun serialize(encoder: Encoder,
      `value`: InlinePathsKeysPostResponses201ContentApplicationJsonSchemaPropertiesData) {
      val jsonEncoder = encoder
        .requireJsonEncoder("InlinePathsKeysPostResponses201ContentApplicationJsonSchemaPropertiesData")
...
public fun inlinePathsKeysPostResponses201ContentApplicationJsonSchemaPropertiesData(block: InlinePathsKeysPostResponses201ContentApplicationJsonSchemaPropertiesData.Builder.() -> Unit): InlinePathsKeysPostResponses201ContentApplicationJsonSchemaPropertiesData = InlinePathsKeysPostResponses201ContentApplicationJsonSchemaPropertiesData.build(block)
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlinePathsKeysPostResponses201ContentApplicationJsonSchemaPropertiesData " +
