 ...
 */
@Serializable(with = InlineComponentsSchemasCreateWorkspaceResponsePropertiesData.Serializer::class)
public class InlineComponentsSchemasCreateWorkspaceResponsePropertiesData(
  /**
  ...
  public class Builder {
    ...
    public fun build(): InlineComponentsSchemasCreateWorkspaceResponsePropertiesData {
      ...
      return InlineComponentsSchemasCreateWorkspaceResponsePropertiesData(
        createdAt = createdAt,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineComponentsSchemasCreateWorkspaceResponsePropertiesData =
      Builder().apply(block).build()
  }

  public object Serializer : KSerializer<InlineComponentsSchemasCreateWorkspaceResponsePropertiesData> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineComponentsSchemasCreateWorkspaceResponsePropertiesData {
      val jsonDecoder = decoder.requireJsonDecoder("InlineComponentsSchemasCreateWorkspaceResponsePropertiesData")
      val json = jsonDecoder.json
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("InlineComponentsSchemasCreateWorkspaceResponsePropertiesData must be a JSON " +
          "object")
      ...
      if (!raw.containsKey("created_by")) {
        throw SerializationException("InlineComponentsSchemasCreateWorkspaceResponsePropertiesData is missing " +
      ...
      if (!raw.containsKey("default_image_model")) {
        throw SerializationException("InlineComponentsSchemasCreateWorkspaceResponsePropertiesData is missing " +
          "required property 'default_image_model'")
      }
      ...
      if (!raw.containsKey("default_provider_sort")) {
        throw SerializationException("InlineComponentsSchemasCreateWorkspaceResponsePropertiesData is missing " +
          "required property 'default_provider_sort'")
      }
      ...
      if (!raw.containsKey("default_text_model")) {
        throw SerializationException("InlineComponentsSchemasCreateWorkspaceResponsePropertiesData is missing " +
          "required property 'default_text_model'")
      }
      ...
      if (!raw.containsKey("io_logging_api_key_ids")) {
        throw SerializationException("InlineComponentsSchemasCreateWorkspaceResponsePropertiesData is missing " +
          "required property 'io_logging_api_key_ids'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineComponentsSchemasCreateWorkspaceResponsePropertiesData) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineComponentsSchemasCreateWorkspaceResponsePropertiesData")
...
public fun inlineComponentsSchemasCreateWorkspaceResponsePropertiesData(block: InlineComponentsSchemasCreateWorkspaceResponsePropertiesData.Builder.() -> Unit): InlineComponentsSchemasCreateWorkspaceResponsePropertiesData = InlineComponentsSchemasCreateWorkspaceResponsePropertiesData.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("InlineComponentsSchemasCreateWorkspaceResponsePropertiesData is missing required " +
      "property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineComponentsSchemasCreateWorkspaceResponsePropertiesData " +
