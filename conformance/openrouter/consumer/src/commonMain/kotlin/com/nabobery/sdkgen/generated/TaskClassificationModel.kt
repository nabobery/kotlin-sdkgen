...
public class TaskClassificationModel(
  ...
  public object Serializer : KSerializer<TaskClassificationModel> {
    ...
    override fun deserialize(decoder: Decoder): TaskClassificationModel {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("TaskClassificationModel must be a JSON object")
      val id = json.decodeRequired<String>(raw, "id")
      val tagTokenShare = json.decodeRequired<Double>(raw, "tag_token_share")
      val tagUsageShare = json.decodeRequired<Double>(raw, "tag_usage_share")
      return TaskClassificationModel(
        id = id,
        tagTokenShare = tagTokenShare,
        tagUsageShare = tagUsageShare,
...
public fun taskClassificationModel(block: TaskClassificationModel.Builder.() -> Unit): TaskClassificationModel =
  TaskClassificationModel.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("TaskClassificationModel is missing required property '" +
    name + "'")
