...
public class ChatContentVideoInput(
  ...
  public object Serializer : KSerializer<ChatContentVideoInput> {
    ...
    override fun deserialize(decoder: Decoder): ChatContentVideoInput {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("ChatContentVideoInput must be a JSON object")
...
public fun chatContentVideoInput(block: ChatContentVideoInput.Builder.() -> Unit): ChatContentVideoInput =
  ChatContentVideoInput.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("ChatContentVideoInput is missing required property '" +
    name + "'")
