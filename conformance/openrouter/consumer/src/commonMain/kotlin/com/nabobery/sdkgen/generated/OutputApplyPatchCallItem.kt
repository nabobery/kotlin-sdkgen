...
public class OutputApplyPatchCallItem(
  ...
  public val type: InlineComponentsSchemasOutputApplyPatchCallItemPropertiesType,
) {
  public class Builder {
    ...
    private var typeValue: InlineComponentsSchemasOutputApplyPatchCallItemPropertiesType? = null

    public var type: InlineComponentsSchemasOutputApplyPatchCallItemPropertiesType
  ...
  public object Serializer : KSerializer<OutputApplyPatchCallItem> {
    ...
    override fun deserialize(decoder: Decoder): OutputApplyPatchCallItem {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("OutputApplyPatchCallItem must be a JSON object")
      val callId = json.decodeRequired<String>(raw, "call_id")
      val id = json.decodeRequired<String>(raw, "id")
      val operation = json.decodeRequired<ApplyPatchCallOperation>(raw, "operation")
      val status = json.decodeRequired<ApplyPatchCallStatus>(raw, "status")
      val type = json.decodeRequired<InlineComponentsSchemasOutputApplyPatchCallItemPropertiesType>(raw, "type")
      return OutputApplyPatchCallItem(
        callId = callId,
        id = id,
        operation = operation,
...
public fun outputApplyPatchCallItem(block: OutputApplyPatchCallItem.Builder.() -> Unit): OutputApplyPatchCallItem =
  OutputApplyPatchCallItem.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("OutputApplyPatchCallItem is missing required property '" +
    name + "'")
