...
public class RefusalDeltaEvent(
  ...
  public object Serializer : KSerializer<RefusalDeltaEvent> {
    ...
    override fun deserialize(decoder: Decoder): RefusalDeltaEvent {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("RefusalDeltaEvent must be a JSON object")
...
public fun refusalDeltaEvent(block: RefusalDeltaEvent.Builder.() -> Unit): RefusalDeltaEvent = RefusalDeltaEvent
  .build(block)
