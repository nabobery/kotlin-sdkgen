...
public class InternalServerResponse(
  ...
  public object Serializer : KSerializer<InternalServerResponse> {
    ...
    override fun deserialize(decoder: Decoder): InternalServerResponse {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("InternalServerResponse must be a JSON object")
      val error = json.decodeRequired<InternalServerResponseErrorData>(raw, "error")
      return InternalServerResponse(
        error = error,
...
public fun internalServerResponse(block: InternalServerResponse.Builder.() -> Unit): InternalServerResponse =
  InternalServerResponse.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InternalServerResponse is missing required property '" +
    name + "'")
