...
public class ServiceUnavailableResponseErrorData(
  ...
  public object Serializer : KSerializer<ServiceUnavailableResponseErrorData> {
    ...
    override fun deserialize(decoder: Decoder): ServiceUnavailableResponseErrorData {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("ServiceUnavailableResponseErrorData must be a JSON object")
...
public fun serviceUnavailableResponseErrorData(block: ServiceUnavailableResponseErrorData.Builder.() ->
  Unit): ServiceUnavailableResponseErrorData = ServiceUnavailableResponseErrorData.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("ServiceUnavailableResponseErrorData is missing required property '" + name + "'")
