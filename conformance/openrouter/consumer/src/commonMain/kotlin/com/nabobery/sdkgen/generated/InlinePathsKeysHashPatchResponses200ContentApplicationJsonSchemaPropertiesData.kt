 ...
 */
@Serializable(with = InlinePathsKeysHashPatchResponses200ContentApplicationJsonSchemaPropertiesData.Serializer::class)
public class InlinePathsKeysHashPatchResponses200ContentApplicationJsonSchemaPropertiesData internal constructor(
  /**
  ...
  public class Builder {
    ...
    public fun build(): InlinePathsKeysHashPatchResponses200ContentApplicationJsonSchemaPropertiesData {
      ...
      return InlinePathsKeysHashPatchResponses200ContentApplicationJsonSchemaPropertiesData(
        byokUsage = byokUsage,
        byokUsageDaily = byokUsageDaily,
        byokUsageMonthly = byokUsageMonthly,
        byokUsageWeekly = byokUsageWeekly,
  ...
  public companion object {
    public fun build(block: Builder.() ->
      Unit): InlinePathsKeysHashPatchResponses200ContentApplicationJsonSchemaPropertiesData = Builder().apply(block)
        .build()
  }

  public object Serializer : KSerializer<InlinePathsKeysHashPatchResponses200ContentApplicationJsonSchemaPropertiesData> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlinePathsKeysHashPatchResponses200ContentApplicationJsonSchemaPropertiesData {
      val jsonDecoder = decoder
        .requireJsonDecoder("InlinePathsKeysHashPatchResponses200ContentApplicationJsonSchemaPropertiesData")
      val json = jsonDecoder.json
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("InlinePathsKeysHashPatchResponses200ContentApplicationJsonSchemaPropertiesData " +
    ...
    override fun serialize(encoder: Encoder,
      `value`: InlinePathsKeysHashPatchResponses200ContentApplicationJsonSchemaPropertiesData) {
      val jsonEncoder = encoder
        .requireJsonEncoder("InlinePathsKeysHashPatchResponses200ContentApplicationJsonSchemaPropertiesData")
...
public fun inlinePathsKeysHashPatchResponses200ContentApplicationJsonSchemaPropertiesData(block: InlinePathsKeysHashPatchResponses200ContentApplicationJsonSchemaPropertiesData.Builder.() -> Unit): InlinePathsKeysHashPatchResponses200ContentApplicationJsonSchemaPropertiesData = InlinePathsKeysHashPatchResponses200ContentApplicationJsonSchemaPropertiesData.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("InlinePathsKeysHashPatchResponses200ContentApplicationJsonSchemaPropertiesData is " +
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlinePathsKeysHashPatchResponses200ContentApplicationJsonSchemaPropertiesData " +
