...
public class AnthropicUnknownUsageIteration(
  ...
  public object Serializer : KSerializer<AnthropicUnknownUsageIteration> {
    ...
    override fun deserialize(decoder: Decoder): AnthropicUnknownUsageIteration {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("AnthropicUnknownUsageIteration must be a JSON object")
...
public fun anthropicUnknownUsageIteration(block: AnthropicUnknownUsageIteration.Builder.() ->
  Unit): AnthropicUnknownUsageIteration = AnthropicUnknownUsageIteration.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("AnthropicUnknownUsageIteration is missing required property '" + name + "'")
