...
/**
 * Generated model for sdkgen://source/openapi.yaml#/components/schemas/ObservabilitySentryDestination.
 */
@Serializable(with = ObservabilitySentryDestination.Serializer::class)
public class ObservabilitySentryDestination(
  /**
  ...
  public class Builder {
    private var configValue: InlineComponentsSchemasObservabilitySentryDestinationPropertiesConfig?
        = null

    public var config: InlineComponentsSchemasObservabilitySentryDestinationPropertiesConfig
    ...
    private var typeValue: InlineComponentsSchemasObservabilitySentryDestinationPropertiesType? =
        null

    public var type: InlineComponentsSchemasObservabilitySentryDestinationPropertiesType
    ...
    public fun build(): ObservabilitySentryDestination {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): ObservabilitySentryDestination = Builder().apply(block).build()
  }

  public object Serializer : KSerializer<ObservabilitySentryDestination> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): ObservabilitySentryDestination {
      val jsonDecoder = decoder.requireJsonDecoder("ObservabilitySentryDestination")
      val json = jsonDecoder.json
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("ObservabilitySentryDestination must be a JSON object")
      val config = json.decodeRequired<InlineComponentsSchemasObservabilitySentryDestinationPropertiesConfig>(raw,
        "config")
      ...
      val type = json.decodeRequired<InlineComponentsSchemasObservabilitySentryDestinationPropertiesType>(raw, "type")
      ...
      if (!raw.containsKey("api_key_hashes")) {
        throw SerializationException("ObservabilitySentryDestination is missing required property 'api_key_hashes'")
      }
      ...
      if (!raw.containsKey("filter_rules")) {
        throw SerializationException("ObservabilitySentryDestination is missing required property 'filter_rules'")
      }
      ...
      if (!raw.containsKey("name")) {
        throw SerializationException("ObservabilitySentryDestination is missing required property 'name'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: ObservabilitySentryDestination) {
      val jsonEncoder = encoder.requireJsonEncoder("ObservabilitySentryDestination")
...
public fun observabilitySentryDestination(block: ObservabilitySentryDestination.Builder.() ->
  Unit): ObservabilitySentryDestination = ObservabilitySentryDestination.build(block)
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("ObservabilitySentryDestination property '" + name +
      "' is not nullable")
