...
public class RankingsDailyResponse(
  ...
  public object Serializer : KSerializer<RankingsDailyResponse> {
    ...
    override fun deserialize(decoder: Decoder): RankingsDailyResponse {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("RankingsDailyResponse must be a JSON object")
      val data = json.decodeRequired<List<RankingsDailyItem>>(raw, "data")
      val meta = json.decodeRequired<RankingsDailyMeta>(raw, "meta")
      return RankingsDailyResponse(
        data = data,
        meta = meta,
      )
...
public fun rankingsDailyResponse(block: RankingsDailyResponse.Builder.() -> Unit): RankingsDailyResponse =
  RankingsDailyResponse.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("RankingsDailyResponse is missing required property '" +
    name + "'")
