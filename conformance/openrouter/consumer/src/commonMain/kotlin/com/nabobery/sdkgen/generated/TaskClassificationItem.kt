...
public class TaskClassificationItem(
  ...
  public object Serializer : KSerializer<TaskClassificationItem> {
    ...
    override fun deserialize(decoder: Decoder): TaskClassificationItem {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("TaskClassificationItem must be a JSON object")
      val categoryTokenShare = json.decodeRequired<Double>(raw, "category_token_share")
      val categoryUsageShare = json.decodeRequired<Double>(raw, "category_usage_share")
      val displayName = json.decodeRequired<String>(raw, "display_name")
      val macroCategory = json.decodeRequired<String>(raw, "macro_category")
      val models = json.decodeRequired<List<TaskClassificationModel>>(raw, "models")
      val tag = json.decodeRequired<String>(raw, "tag")
      val tokenShare = json.decodeRequired<Double>(raw, "token_share")
      val usageShare = json.decodeRequired<Double>(raw, "usage_share")
      return TaskClassificationItem(
        categoryTokenShare = categoryTokenShare,
        categoryUsageShare = categoryUsageShare,
        displayName = displayName,
...
public fun taskClassificationItem(block: TaskClassificationItem.Builder.() -> Unit): TaskClassificationItem =
  TaskClassificationItem.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("TaskClassificationItem is missing required property '" +
    name + "'")
