...
public class ImageModelsListResponse(
  ...
  public object Serializer : KSerializer<ImageModelsListResponse> {
    ...
    override fun deserialize(decoder: Decoder): ImageModelsListResponse {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("ImageModelsListResponse must be a JSON object")
      val data = json.decodeRequired<List<ImageModelListItem>>(raw, "data")
      return ImageModelsListResponse(
        data = data,
      )
    }
...
public fun imageModelsListResponse(block: ImageModelsListResponse.Builder.() -> Unit): ImageModelsListResponse =
  ImageModelsListResponse.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("ImageModelsListResponse is missing required property '" +
    name + "'")
