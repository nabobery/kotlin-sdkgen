...
public class ParetoRouterPlugin(
   ...
   */
  public val priceSource: InlineComponentsSchemasParetoRouterPluginPropertiesPriceSource? = null,
) {
  public class Builder {
    private var idValue: InlineComponentsSchemasParetoRouterPluginPropertiesId? = null

    public var id: InlineComponentsSchemasParetoRouterPluginPropertiesId
     ...
     */
    public var priceSource: InlineComponentsSchemasParetoRouterPluginPropertiesPriceSource? = null
  ...
  public object Serializer : KSerializer<ParetoRouterPlugin> {
    ...
    override fun deserialize(decoder: Decoder): ParetoRouterPlugin {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("ParetoRouterPlugin must be a JSON object")
      val id = json.decodeRequired<InlineComponentsSchemasParetoRouterPluginPropertiesId>(raw, "id")
      return ParetoRouterPlugin(
        id = id,
        enabled = raw["enabled"]?.let { json.decodeFromJsonElement<Boolean>(it) },
        minCodingScore = raw["min_coding_score"]?.let { json.decodeFromJsonElement<Double>(it) },
        priceSource = raw["price_source"]?.let { json
          .decodeFromJsonElement<InlineComponentsSchemasParetoRouterPluginPropertiesPriceSource>(it) },
      )
    }
...
public fun paretoRouterPlugin(block: ParetoRouterPlugin.Builder.() -> Unit): ParetoRouterPlugin = ParetoRouterPlugin
  .build(block)
