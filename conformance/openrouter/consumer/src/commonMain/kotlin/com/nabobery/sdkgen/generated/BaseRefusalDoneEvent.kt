...
public class BaseRefusalDoneEvent(
  ...
  public object Serializer : KSerializer<BaseRefusalDoneEvent> {
    ...
    override fun deserialize(decoder: Decoder): BaseRefusalDoneEvent {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("BaseRefusalDoneEvent must be a JSON object")
...
public fun baseRefusalDoneEvent(block: BaseRefusalDoneEvent.Builder.() -> Unit): BaseRefusalDoneEvent =
  BaseRefusalDoneEvent.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("BaseRefusalDoneEvent is missing required property '" +
    name + "'")
