...
public class ImageGenCallInProgressEvent(
  ...
  public object Serializer : KSerializer<ImageGenCallInProgressEvent> {
    ...
    override fun deserialize(decoder: Decoder): ImageGenCallInProgressEvent {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("ImageGenCallInProgressEvent must be a JSON object")
...
public fun imageGenCallInProgressEvent(block: ImageGenCallInProgressEvent.Builder.() ->
  Unit): ImageGenCallInProgressEvent = ImageGenCallInProgressEvent.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("ImageGenCallInProgressEvent is missing required property '" + name + "'")
