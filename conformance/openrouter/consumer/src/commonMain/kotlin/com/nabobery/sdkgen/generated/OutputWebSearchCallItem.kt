...
public class OutputWebSearchCallItem(
  ...
  public object Serializer : KSerializer<OutputWebSearchCallItem> {
    ...
    override fun deserialize(decoder: Decoder): OutputWebSearchCallItem {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("OutputWebSearchCallItem must be a JSON object")
...
public fun outputWebSearchCallItem(block: OutputWebSearchCallItem.Builder.() -> Unit): OutputWebSearchCallItem =
  OutputWebSearchCallItem.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("OutputWebSearchCallItem is missing required property '" +
    name + "'")
