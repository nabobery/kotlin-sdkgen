...
public class ContentPartVideo(
  ...
  public class Builder {
    private var typeValue: InlineComponentsSchemasContentPartVideoPropertiesType? = null

    public var type: InlineComponentsSchemasContentPartVideoPropertiesType
      get() = requireNotNull(typeValue) { "type is required" }
      set(`value`) {
        typeValue = value
      }

    private var videoUrlValue: InlineComponentsSchemasContentPartVideoPropertiesVideoUrl? = null

    public var videoUrl: InlineComponentsSchemasContentPartVideoPropertiesVideoUrl
  ...
  public object Serializer : KSerializer<ContentPartVideo> {
    ...
    override fun deserialize(decoder: Decoder): ContentPartVideo {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("ContentPartVideo must be a JSON object")
      val type = json.decodeRequired<InlineComponentsSchemasContentPartVideoPropertiesType>(raw, "type")
      val videoUrl = json.decodeRequired<InlineComponentsSchemasContentPartVideoPropertiesVideoUrl>(raw, "video_url")
      return ContentPartVideo(
        type = type,
        videoUrl = videoUrl,
      )
...
public fun contentPartVideo(block: ContentPartVideo.Builder.() -> Unit): ContentPartVideo = ContentPartVideo
  .build(block)
