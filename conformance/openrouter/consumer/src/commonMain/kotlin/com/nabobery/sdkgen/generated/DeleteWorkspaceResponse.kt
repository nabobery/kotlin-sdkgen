...
public class DeleteWorkspaceResponse(
  ...
  public object Serializer : KSerializer<DeleteWorkspaceResponse> {
    ...
    override fun deserialize(decoder: Decoder): DeleteWorkspaceResponse {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("DeleteWorkspaceResponse must be a JSON object")
...
public fun deleteWorkspaceResponse(block: DeleteWorkspaceResponse.Builder.() -> Unit): DeleteWorkspaceResponse =
  DeleteWorkspaceResponse.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("DeleteWorkspaceResponse is missing required property '" +
    name + "'")
