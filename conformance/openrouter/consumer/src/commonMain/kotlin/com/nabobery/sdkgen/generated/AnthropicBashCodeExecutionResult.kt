...
public class AnthropicBashCodeExecutionResult(
  ...
  public class Builder {
    ...
    private var typeValue: InlineComponentsSchemasAnthropicBashCodeExecutionResultPropertiesType? =
        null

    public var type: InlineComponentsSchemasAnthropicBashCodeExecutionResultPropertiesType
  ...
  public object Serializer : KSerializer<AnthropicBashCodeExecutionResult> {
    ...
    override fun deserialize(decoder: Decoder): AnthropicBashCodeExecutionResult {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("AnthropicBashCodeExecutionResult must be a JSON object")
      val content = json.decodeRequired<List<AnthropicBashCodeExecutionOutput>>(raw, "content")
      ...
      val type = json.decodeRequired<InlineComponentsSchemasAnthropicBashCodeExecutionResultPropertiesType>(raw, "type")
      return AnthropicBashCodeExecutionResult(
        content = content,
        returnCode = returnCode,
        stderr = stderr,
...
public fun anthropicBashCodeExecutionResult(block: AnthropicBashCodeExecutionResult.Builder.() ->
  Unit): AnthropicBashCodeExecutionResult = AnthropicBashCodeExecutionResult.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("AnthropicBashCodeExecutionResult is missing required property '" + name + "'")
