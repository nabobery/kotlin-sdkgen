 ...
 */
@Serializable(with = ReasoningDeltaEvent.Serializer::class)
public class ReasoningDeltaEvent(
  public val contentIndex: Int,
  public val delta: String,
  public val itemId: String,
  public val outputIndex: Int,
  public val sequenceNumber: Int,
  public val type: InlineComponentsSchemasBaseReasoningDeltaEventPropertiesType,
) {
  public class Builder {
    ...
    private var typeValue: InlineComponentsSchemasBaseReasoningDeltaEventPropertiesType? = null

    public var type: InlineComponentsSchemasBaseReasoningDeltaEventPropertiesType
      get() = requireNotNull(typeValue) { "type is required" }
      set(`value`) {
        typeValue = value
      }

    public fun build(): ReasoningDeltaEvent {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): ReasoningDeltaEvent = Builder().apply(block).build()
  }

  public object Serializer : KSerializer<ReasoningDeltaEvent> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): ReasoningDeltaEvent {
      val jsonDecoder = decoder.requireJsonDecoder("ReasoningDeltaEvent")
      val json = jsonDecoder.json
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("ReasoningDeltaEvent must be a JSON object")
      ...
      val type = json.decodeRequired<InlineComponentsSchemasBaseReasoningDeltaEventPropertiesType>(raw, "type")
      return ReasoningDeltaEvent(
        contentIndex = contentIndex,
        delta = delta,
        itemId = itemId,
    ...
    override fun serialize(encoder: Encoder, `value`: ReasoningDeltaEvent) {
      val jsonEncoder = encoder.requireJsonEncoder("ReasoningDeltaEvent")
...
public fun reasoningDeltaEvent(block: ReasoningDeltaEvent.Builder.() -> Unit): ReasoningDeltaEvent =
  ReasoningDeltaEvent.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("ReasoningDeltaEvent is missing required property '" + name +
    "'")
