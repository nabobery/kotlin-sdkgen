...
public class ApplyPatchCreateFileOperation(
  ...
  public class Builder {
    ...
    private var typeValue: InlineComponentsSchemasApplyPatchCreateFileOperationPropertiesType? =
        null

    public var type: InlineComponentsSchemasApplyPatchCreateFileOperationPropertiesType
  ...
  public object Serializer : KSerializer<ApplyPatchCreateFileOperation> {
    ...
    override fun deserialize(decoder: Decoder): ApplyPatchCreateFileOperation {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("ApplyPatchCreateFileOperation must be a JSON object")
      val diff = json.decodeRequired<String>(raw, "diff")
      val path = json.decodeRequired<String>(raw, "path")
      val type = json.decodeRequired<InlineComponentsSchemasApplyPatchCreateFileOperationPropertiesType>(raw, "type")
      return ApplyPatchCreateFileOperation(
        diff = diff,
        path = path,
        type = type,
...
public fun applyPatchCreateFileOperation(block: ApplyPatchCreateFileOperation.Builder.() ->
  Unit): ApplyPatchCreateFileOperation = ApplyPatchCreateFileOperation.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("ApplyPatchCreateFileOperation is missing required property '" + name + "'")
