...
public class EndpointsMetadata(
  ...
  public object Serializer : KSerializer<EndpointsMetadata> {
    ...
    override fun deserialize(decoder: Decoder): EndpointsMetadata {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("EndpointsMetadata must be a JSON object")
      val available = json.decodeRequired<List<EndpointInfo>>(raw, "available")
...
public fun endpointsMetadata(block: EndpointsMetadata.Builder.() -> Unit): EndpointsMetadata = EndpointsMetadata
  .build(block)
