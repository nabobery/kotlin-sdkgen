...
public class AnthropicInputTokensClearAtLeast(
  public val type: InlineComponentsSchemasAnthropicInputTokensClearAtLeastPropertiesType,
  public val `value`: Int,
) {
  public class Builder {
    private var typeValue: InlineComponentsSchemasAnthropicInputTokensClearAtLeastPropertiesType? =
        null

    public var type: InlineComponentsSchemasAnthropicInputTokensClearAtLeastPropertiesType
  ...
  public object Serializer : KSerializer<AnthropicInputTokensClearAtLeast> {
    ...
    override fun deserialize(decoder: Decoder): AnthropicInputTokensClearAtLeast {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("AnthropicInputTokensClearAtLeast must be a JSON object")
      val type = json.decodeRequired<InlineComponentsSchemasAnthropicInputTokensClearAtLeastPropertiesType>(raw, "type")
...
public fun anthropicInputTokensClearAtLeast(block: AnthropicInputTokensClearAtLeast.Builder.() ->
  Unit): AnthropicInputTokensClearAtLeast = AnthropicInputTokensClearAtLeast.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("AnthropicInputTokensClearAtLeast is missing required property '" + name + "'")
