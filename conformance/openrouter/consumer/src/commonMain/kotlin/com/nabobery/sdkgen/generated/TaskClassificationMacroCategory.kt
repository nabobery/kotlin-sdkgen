...
public class TaskClassificationMacroCategory(
  ...
  public object Serializer : KSerializer<TaskClassificationMacroCategory> {
    ...
    override fun deserialize(decoder: Decoder): TaskClassificationMacroCategory {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("TaskClassificationMacroCategory must be a JSON object")
...
public fun taskClassificationMacroCategory(block: TaskClassificationMacroCategory.Builder.() ->
  Unit): TaskClassificationMacroCategory = TaskClassificationMacroCategory.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("TaskClassificationMacroCategory is missing required property '" + name + "'")
