...
public class BulkUnassignKeysRequest(
  ...
  public class Builder {
    ...
    public var keyHashes: List<String>
      get() = requireNotNull(keyHashesValue) { "keyHashes is required" }
      set(`value`) {
        keyHashesValue = value
      }
  ...
  public object Serializer : KSerializer<BulkUnassignKeysRequest> {
    ...
    override fun deserialize(decoder: Decoder): BulkUnassignKeysRequest {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("BulkUnassignKeysRequest must be a JSON object")
      val keyHashes = json.decodeRequired<List<String>>(raw, "key_hashes")
      return BulkUnassignKeysRequest(
        keyHashes = keyHashes,
      )
    }
...
public fun bulkUnassignKeysRequest(block: BulkUnassignKeysRequest.Builder.() -> Unit): BulkUnassignKeysRequest =
  BulkUnassignKeysRequest.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("BulkUnassignKeysRequest is missing required property '" +
    name + "'")
