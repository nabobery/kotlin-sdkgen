...
public class AnthropicWebFetchToolResult(
  ...
  public val type: InlineComponentsSchemasAnthropicWebFetchToolResultPropertiesType,
) {
  public class Builder {
    ...
    private var typeValue: InlineComponentsSchemasAnthropicWebFetchToolResultPropertiesType? = null

    public var type: InlineComponentsSchemasAnthropicWebFetchToolResultPropertiesType
  ...
  public object Serializer : KSerializer<AnthropicWebFetchToolResult> {
    ...
    override fun deserialize(decoder: Decoder): AnthropicWebFetchToolResult {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("AnthropicWebFetchToolResult must be a JSON object")
      val caller = json.decodeRequired<AnthropicCaller>(raw, "caller")
      val content = json.decodeRequired<AnthropicWebFetchContent>(raw, "content")
      val toolUseId = json.decodeRequired<String>(raw, "tool_use_id")
      val type = json.decodeRequired<InlineComponentsSchemasAnthropicWebFetchToolResultPropertiesType>(raw, "type")
      return AnthropicWebFetchToolResult(
        caller = caller,
        content = content,
        toolUseId = toolUseId,
...
public fun anthropicWebFetchToolResult(block: AnthropicWebFetchToolResult.Builder.() ->
  Unit): AnthropicWebFetchToolResult = AnthropicWebFetchToolResult.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("AnthropicWebFetchToolResult is missing required property '" + name + "'")
