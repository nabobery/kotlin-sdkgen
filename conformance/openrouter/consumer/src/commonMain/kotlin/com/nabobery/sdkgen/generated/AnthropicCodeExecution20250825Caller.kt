...
public class AnthropicCodeExecution20250825Caller(
  ...
  public class Builder {
    ...
    private var typeValue:
        InlineComponentsSchemasAnthropicCodeExecution20250825CallerPropertiesType? = null

    public var type: InlineComponentsSchemasAnthropicCodeExecution20250825CallerPropertiesType
  ...
  public object Serializer : KSerializer<AnthropicCodeExecution20250825Caller> {
    ...
    override fun deserialize(decoder: Decoder): AnthropicCodeExecution20250825Caller {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("AnthropicCodeExecution20250825Caller must be a JSON object")
      val toolId = json.decodeRequired<String>(raw, "tool_id")
      val type = json.decodeRequired<InlineComponentsSchemasAnthropicCodeExecution20250825CallerPropertiesType>(raw,
        "type")
      return AnthropicCodeExecution20250825Caller(
        toolId = toolId,
        type = type,
...
public fun anthropicCodeExecution20250825Caller(block: AnthropicCodeExecution20250825Caller.Builder.() ->
  Unit): AnthropicCodeExecution20250825Caller = AnthropicCodeExecution20250825Caller.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("AnthropicCodeExecution20250825Caller is missing required property '" + name + "'")
