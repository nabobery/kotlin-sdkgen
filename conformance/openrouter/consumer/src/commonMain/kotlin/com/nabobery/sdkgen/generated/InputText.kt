...
public class InputText(
  ...
  public class Builder {
    ...
    private var typeValue: InlineComponentsSchemasInputTextPropertiesType? = null

    public var type: InlineComponentsSchemasInputTextPropertiesType
  ...
  public object Serializer : KSerializer<InputText> {
    ...
    override fun deserialize(decoder: Decoder): InputText {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("InputText must be a JSON object")
      val text = json.decodeRequired<String>(raw, "text")
      val type = json.decodeRequired<InlineComponentsSchemasInputTextPropertiesType>(raw, "type")
      return InputText(
        text = text,
        type = type,
