...
public class ReasoningTextContent(
  ...
  public val type: InlineComponentsSchemasReasoningTextContentPropertiesType,
) {
  public class Builder {
    ...
    private var typeValue: InlineComponentsSchemasReasoningTextContentPropertiesType? = null

    public var type: InlineComponentsSchemasReasoningTextContentPropertiesType
  ...
  public object Serializer : KSerializer<ReasoningTextContent> {
    ...
    override fun deserialize(decoder: Decoder): ReasoningTextContent {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("ReasoningTextContent must be a JSON object")
      val text = json.decodeRequired<String>(raw, "text")
      val type = json.decodeRequired<InlineComponentsSchemasReasoningTextContentPropertiesType>(raw, "type")
      return ReasoningTextContent(
        text = text,
        type = type,
      )
...
public fun reasoningTextContent(block: ReasoningTextContent.Builder.() -> Unit): ReasoningTextContent =
  ReasoningTextContent.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("ReasoningTextContent is missing required property '" +
    name + "'")
