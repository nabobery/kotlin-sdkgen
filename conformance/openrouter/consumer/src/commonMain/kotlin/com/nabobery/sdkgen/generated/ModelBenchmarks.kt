...
public class ModelBenchmarks(
  ...
  public class Builder {
    ...
    public var designArena: List<DaBenchmarkEntry>
      get() = requireNotNull(designArenaValue) { "designArena is required" }
      set(`value`) {
        designArenaValue = value
      }
  ...
  public object Serializer : KSerializer<ModelBenchmarks> {
    ...
    override fun deserialize(decoder: Decoder): ModelBenchmarks {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("ModelBenchmarks must be a JSON object")
      val designArena = json.decodeRequired<List<DaBenchmarkEntry>>(raw, "design_arena")
      return ModelBenchmarks(
        designArena = designArena,
        artificialAnalysis = raw["artificial_analysis"]?.let { json.decodeFromJsonElement<AaBenchmarkEntry>(it) },
      )
    }
