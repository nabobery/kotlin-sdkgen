 ...
 */
@Serializable(with = ReasoningSummaryTextDeltaEvent.Serializer::class)
public class ReasoningSummaryTextDeltaEvent(
  public val delta: String,
  public val itemId: String,
  public val outputIndex: Int,
  public val sequenceNumber: Int,
  public val summaryIndex: Int,
  public val type: InlineComponentsSchemasBaseReasoningSummaryTextDeltaEventPropertiesType,
) {
  public class Builder {
    ...
    private var typeValue: InlineComponentsSchemasBaseReasoningSummaryTextDeltaEventPropertiesType?
        = null

    public var type: InlineComponentsSchemasBaseReasoningSummaryTextDeltaEventPropertiesType
      get() = requireNotNull(typeValue) { "type is required" }
      set(`value`) {
        typeValue = value
      }

    public fun build(): ReasoningSummaryTextDeltaEvent {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): ReasoningSummaryTextDeltaEvent = Builder().apply(block).build()
  }

  public object Serializer : KSerializer<ReasoningSummaryTextDeltaEvent> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): ReasoningSummaryTextDeltaEvent {
      val jsonDecoder = decoder.requireJsonDecoder("ReasoningSummaryTextDeltaEvent")
      val json = jsonDecoder.json
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("ReasoningSummaryTextDeltaEvent must be a JSON object")
      ...
      val type = json.decodeRequired<InlineComponentsSchemasBaseReasoningSummaryTextDeltaEventPropertiesType>(raw,
        "type")
      return ReasoningSummaryTextDeltaEvent(
        delta = delta,
        itemId = itemId,
    ...
    override fun serialize(encoder: Encoder, `value`: ReasoningSummaryTextDeltaEvent) {
      val jsonEncoder = encoder.requireJsonEncoder("ReasoningSummaryTextDeltaEvent")
...
public fun reasoningSummaryTextDeltaEvent(block: ReasoningSummaryTextDeltaEvent.Builder.() ->
  Unit): ReasoningSummaryTextDeltaEvent = ReasoningSummaryTextDeltaEvent.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("ReasoningSummaryTextDeltaEvent is missing required property '" + name + "'")
