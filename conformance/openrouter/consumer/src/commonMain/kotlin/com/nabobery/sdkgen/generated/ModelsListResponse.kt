...
public class ModelsListResponse(
   ...
   * Pagination links
   */
  public val links: InlineComponentsSchemasModelsListResponsePropertiesLinks,
  /**
  ...
  public class Builder {
    ...
    private var linksValue: InlineComponentsSchemasModelsListResponsePropertiesLinks? = null

    public var links: InlineComponentsSchemasModelsListResponsePropertiesLinks
  ...
  public object Serializer : KSerializer<ModelsListResponse> {
    ...
    override fun deserialize(decoder: Decoder): ModelsListResponse {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("ModelsListResponse must be a JSON object")
      val data = json.decodeRequired<List<Model>>(raw, "data")
      val links = json.decodeRequired<InlineComponentsSchemasModelsListResponsePropertiesLinks>(raw, "links")
...
public fun modelsListResponse(block: ModelsListResponse.Builder.() -> Unit): ModelsListResponse = ModelsListResponse
  .build(block)
