...
public class CodexLocalShellTool(
  ...
  public class Builder {
    private var typeValue: InlineComponentsSchemasCodexLocalShellToolPropertiesType? = null

    public var type: InlineComponentsSchemasCodexLocalShellToolPropertiesType
  ...
  public object Serializer : KSerializer<CodexLocalShellTool> {
    ...
    override fun deserialize(decoder: Decoder): CodexLocalShellTool {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("CodexLocalShellTool must be a JSON object")
      val type = json.decodeRequired<InlineComponentsSchemasCodexLocalShellToolPropertiesType>(raw, "type")
      return CodexLocalShellTool(
        type = type,
      )
    }
...
public fun codexLocalShellTool(block: CodexLocalShellTool.Builder.() -> Unit): CodexLocalShellTool =
  CodexLocalShellTool.build(block)
