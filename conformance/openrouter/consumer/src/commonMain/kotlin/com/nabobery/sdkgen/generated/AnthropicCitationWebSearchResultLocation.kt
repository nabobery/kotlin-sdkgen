...
public class AnthropicCitationWebSearchResultLocation(
  ...
  public class Builder {
    ...
    private var typeValue:
        InlineComponentsSchemasAnthropicCitationWebSearchResultLocationPropertiesType? = null

    public var type: InlineComponentsSchemasAnthropicCitationWebSearchResultLocationPropertiesType
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): AnthropicCitationWebSearchResultLocation = Builder().apply(block)
      .build()
  }

  public object Serializer : KSerializer<AnthropicCitationWebSearchResultLocation> {
    ...
    override fun deserialize(decoder: Decoder): AnthropicCitationWebSearchResultLocation {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("AnthropicCitationWebSearchResultLocation must be a JSON object")
      val citedText = json.decodeRequired<String>(raw, "cited_text")
      val encryptedIndex = json.decodeRequired<String>(raw, "encrypted_index")
      val type = json
        .decodeRequired<InlineComponentsSchemasAnthropicCitationWebSearchResultLocationPropertiesType>(raw, "type")
...
public fun anthropicCitationWebSearchResultLocation(block: AnthropicCitationWebSearchResultLocation.Builder.() ->
  Unit): AnthropicCitationWebSearchResultLocation = AnthropicCitationWebSearchResultLocation.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("AnthropicCitationWebSearchResultLocation is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("AnthropicCitationWebSearchResultLocation property '" + name +
      "' is not nullable")
