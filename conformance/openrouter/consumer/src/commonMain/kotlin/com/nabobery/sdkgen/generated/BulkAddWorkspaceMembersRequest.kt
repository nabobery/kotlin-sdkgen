...
public class BulkAddWorkspaceMembersRequest(
  ...
  public object Serializer : KSerializer<BulkAddWorkspaceMembersRequest> {
    ...
    override fun deserialize(decoder: Decoder): BulkAddWorkspaceMembersRequest {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("BulkAddWorkspaceMembersRequest must be a JSON object")
...
public fun bulkAddWorkspaceMembersRequest(block: BulkAddWorkspaceMembersRequest.Builder.() ->
  Unit): BulkAddWorkspaceMembersRequest = BulkAddWorkspaceMembersRequest.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("BulkAddWorkspaceMembersRequest is missing required property '" + name + "'")
