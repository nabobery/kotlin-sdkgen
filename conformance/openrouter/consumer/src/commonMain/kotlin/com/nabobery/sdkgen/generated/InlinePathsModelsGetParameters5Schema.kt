 ...
 */
@Serializable(with = InlinePathsModelsGetParameters5Schema.Serializer::class)
public sealed class InlinePathsModelsGetParameters5Schema {
  public abstract val `value`: String

  /**
   * Documented value. Wire value: `most-popular`.
   */
  public data object MostPopular : InlinePathsModelsGetParameters5Schema() {
   ...
   */
  public data object Newest : InlinePathsModelsGetParameters5Schema() {
   ...
   */
  public data object TopWeekly : InlinePathsModelsGetParameters5Schema() {
   ...
   */
  public data object PricingLowToHigh : InlinePathsModelsGetParameters5Schema() {
   ...
   */
  public data object PricingHighToLow : InlinePathsModelsGetParameters5Schema() {
   ...
   */
  public data object ContextHighToLow : InlinePathsModelsGetParameters5Schema() {
   ...
   */
  public data object ThroughputHighToLow : InlinePathsModelsGetParameters5Schema() {
   ...
   */
  public data object LatencyLowToHigh : InlinePathsModelsGetParameters5Schema() {
   ...
   */
  public data object IntelligenceHighToLow : InlinePathsModelsGetParameters5Schema() {
   ...
   */
  public data object CodingHighToLow : InlinePathsModelsGetParameters5Schema() {
   ...
   */
  public data object AgenticHighToLow : InlinePathsModelsGetParameters5Schema() {
   ...
   */
  public data object DesignArenaEloHighToLow : InlinePathsModelsGetParameters5Schema() {
    public override val `value`: String = "design-arena-elo-high-to-low"
  }

  public data class SdkUnknown(
    public override val `value`: String,
  ) : InlinePathsModelsGetParameters5Schema()

  public companion object {
    public fun fromValue(`value`: String): InlinePathsModelsGetParameters5Schema = when (value) {
  ...
  public object Serializer : KSerializer<InlinePathsModelsGetParameters5Schema> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("com.nabobery.sdkgen.generated.InlinePathsModelsGetParameters5Schema", PrimitiveKind
          .STRING)

    override fun deserialize(decoder: Decoder): InlinePathsModelsGetParameters5Schema = fromValue(decoder
      .decodeString())

    override fun serialize(encoder: Encoder, `value`: InlinePathsModelsGetParameters5Schema) {
