...
public class AnthropicCitationCharLocationParam(
  ...
  public class Builder {
    ...
    private var typeValue: InlineComponentsSchemasAnthropicCitationCharLocationParamPropertiesType?
        = null

    public var type: InlineComponentsSchemasAnthropicCitationCharLocationParamPropertiesType
  ...
  public object Serializer : KSerializer<AnthropicCitationCharLocationParam> {
    ...
    override fun deserialize(decoder: Decoder): AnthropicCitationCharLocationParam {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("AnthropicCitationCharLocationParam must be a JSON object")
      val citedText = json.decodeRequired<String>(raw, "cited_text")
      val documentIndex = json.decodeRequired<Int>(raw, "document_index")
      val endCharIndex = json.decodeRequired<Int>(raw, "end_char_index")
      val startCharIndex = json.decodeRequired<Int>(raw, "start_char_index")
      val type = json.decodeRequired<InlineComponentsSchemasAnthropicCitationCharLocationParamPropertiesType>(raw,
        "type")
...
public fun anthropicCitationCharLocationParam(block: AnthropicCitationCharLocationParam.Builder.() ->
  Unit): AnthropicCitationCharLocationParam = AnthropicCitationCharLocationParam.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("AnthropicCitationCharLocationParam is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("AnthropicCitationCharLocationParam property '" + name +
      "' is not nullable")
