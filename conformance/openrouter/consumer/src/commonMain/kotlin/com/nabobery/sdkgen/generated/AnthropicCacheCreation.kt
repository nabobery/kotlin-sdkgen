...
public class AnthropicCacheCreation(
  ...
  public object Serializer : KSerializer<AnthropicCacheCreation> {
    ...
    override fun deserialize(decoder: Decoder): AnthropicCacheCreation {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("AnthropicCacheCreation must be a JSON object")
      val ephemeral1hInputTokens = json.decodeRequired<Int>(raw, "ephemeral_1h_input_tokens")
      val ephemeral5mInputTokens = json.decodeRequired<Int>(raw, "ephemeral_5m_input_tokens")
      return AnthropicCacheCreation(
        ephemeral1hInputTokens = ephemeral1hInputTokens,
        ephemeral5mInputTokens = ephemeral5mInputTokens,
      )
...
public fun anthropicCacheCreation(block: AnthropicCacheCreation.Builder.() -> Unit): AnthropicCacheCreation =
  AnthropicCacheCreation.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("AnthropicCacheCreation is missing required property '" +
    name + "'")
