...
public class OpenAiResponseFunctionToolCall(
  ...
  public object Serializer : KSerializer<OpenAiResponseFunctionToolCall> {
    ...
    override fun deserialize(decoder: Decoder): OpenAiResponseFunctionToolCall {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("OpenAiResponseFunctionToolCall must be a JSON object")
...
public fun openAiResponseFunctionToolCall(block: OpenAiResponseFunctionToolCall.Builder.() ->
  Unit): OpenAiResponseFunctionToolCall = OpenAiResponseFunctionToolCall.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("OpenAiResponseFunctionToolCall is missing required property '" + name + "'")
