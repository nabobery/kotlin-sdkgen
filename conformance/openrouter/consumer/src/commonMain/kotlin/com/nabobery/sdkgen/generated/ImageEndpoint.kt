...
public class ImageEndpoint(
  ...
  public object Serializer : KSerializer<ImageEndpoint> {
    ...
    override fun deserialize(decoder: Decoder): ImageEndpoint {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("ImageEndpoint must be a JSON object")
      val allowedPassthroughParameters = json.decodeRequired<List<String>>(raw, "allowed_passthrough_parameters")
      val pricing = json.decodeRequired<List<ImagePricingEntry>>(raw, "pricing")
      val providerName = json.decodeRequired<String>(raw, "provider_name")
      val providerSlug = json.decodeRequired<String>(raw, "provider_slug")
      ...
      if (!raw.containsKey("provider_tag")) {
        throw SerializationException("ImageEndpoint is missing required property 'provider_tag'")
      }
      val providerTag = raw["provider_tag"].let { element -> if (element == JsonNull) null else json
