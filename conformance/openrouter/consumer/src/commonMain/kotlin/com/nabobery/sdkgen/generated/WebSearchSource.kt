...
public class WebSearchSource(
  public val type: InlineComponentsSchemasWebSearchSourcePropertiesType,
  public val url: String,
) {
  public class Builder {
    private var typeValue: InlineComponentsSchemasWebSearchSourcePropertiesType? = null

    public var type: InlineComponentsSchemasWebSearchSourcePropertiesType
  ...
  public object Serializer : KSerializer<WebSearchSource> {
    ...
    override fun deserialize(decoder: Decoder): WebSearchSource {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("WebSearchSource must be a JSON object")
      val type = json.decodeRequired<InlineComponentsSchemasWebSearchSourcePropertiesType>(raw, "type")
