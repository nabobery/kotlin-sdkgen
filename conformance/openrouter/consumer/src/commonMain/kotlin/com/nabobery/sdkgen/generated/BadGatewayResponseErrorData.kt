...
public class BadGatewayResponseErrorData(
  ...
  public object Serializer : KSerializer<BadGatewayResponseErrorData> {
    ...
    override fun deserialize(decoder: Decoder): BadGatewayResponseErrorData {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("BadGatewayResponseErrorData must be a JSON object")
...
public fun badGatewayResponseErrorData(block: BadGatewayResponseErrorData.Builder.() ->
  Unit): BadGatewayResponseErrorData = BadGatewayResponseErrorData.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("BadGatewayResponseErrorData is missing required property '" + name + "'")
