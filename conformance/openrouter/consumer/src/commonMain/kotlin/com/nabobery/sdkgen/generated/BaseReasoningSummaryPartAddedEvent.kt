...
public class BaseReasoningSummaryPartAddedEvent(
  ...
  public object Serializer : KSerializer<BaseReasoningSummaryPartAddedEvent> {
    ...
    override fun deserialize(decoder: Decoder): BaseReasoningSummaryPartAddedEvent {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("BaseReasoningSummaryPartAddedEvent must be a JSON object")
...
public fun baseReasoningSummaryPartAddedEvent(block: BaseReasoningSummaryPartAddedEvent.Builder.() ->
  Unit): BaseReasoningSummaryPartAddedEvent = BaseReasoningSummaryPartAddedEvent.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("BaseReasoningSummaryPartAddedEvent is missing required property '" + name + "'")
