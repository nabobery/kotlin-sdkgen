...
public class MessagesPingEvent(
  public val type: InlineComponentsSchemasMessagesPingEventPropertiesType,
) {
  public class Builder {
    private var typeValue: InlineComponentsSchemasMessagesPingEventPropertiesType? = null

    public var type: InlineComponentsSchemasMessagesPingEventPropertiesType
  ...
  public object Serializer : KSerializer<MessagesPingEvent> {
    ...
    override fun deserialize(decoder: Decoder): MessagesPingEvent {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("MessagesPingEvent must be a JSON object")
      val type = json.decodeRequired<InlineComponentsSchemasMessagesPingEventPropertiesType>(raw, "type")
      return MessagesPingEvent(
        type = type,
      )
    }
...
public fun messagesPingEvent(block: MessagesPingEvent.Builder.() -> Unit): MessagesPingEvent = MessagesPingEvent
  .build(block)
