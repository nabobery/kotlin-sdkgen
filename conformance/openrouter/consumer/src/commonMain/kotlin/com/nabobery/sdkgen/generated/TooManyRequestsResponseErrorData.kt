...
public class TooManyRequestsResponseErrorData(
  ...
  public object Serializer : KSerializer<TooManyRequestsResponseErrorData> {
    ...
    override fun deserialize(decoder: Decoder): TooManyRequestsResponseErrorData {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("TooManyRequestsResponseErrorData must be a JSON object")
...
public fun tooManyRequestsResponseErrorData(block: TooManyRequestsResponseErrorData.Builder.() ->
  Unit): TooManyRequestsResponseErrorData = TooManyRequestsResponseErrorData.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("TooManyRequestsResponseErrorData is missing required property '" + name + "'")
