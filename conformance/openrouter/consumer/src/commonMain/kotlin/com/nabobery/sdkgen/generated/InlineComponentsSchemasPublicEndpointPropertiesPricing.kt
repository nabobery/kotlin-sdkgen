...
/**
 * Generated model for sdkgen://source/openapi.yaml#/components/schemas/PublicEndpoint/properties/pricing.
 */
@Serializable(with = InlineComponentsSchemasPublicEndpointPropertiesPricing.Serializer::class)
public class InlineComponentsSchemasPublicEndpointPropertiesPricing(
  /**
  ...
  public class Builder {
    ...
    public fun build(): InlineComponentsSchemasPublicEndpointPropertiesPricing {
      check(completionValue != null) { "completion is required" }
      check(promptValue != null) { "prompt is required" }
      return InlineComponentsSchemasPublicEndpointPropertiesPricing(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineComponentsSchemasPublicEndpointPropertiesPricing = Builder()
      .apply(block).build()
  }

  public object Serializer : KSerializer<InlineComponentsSchemasPublicEndpointPropertiesPricing> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineComponentsSchemasPublicEndpointPropertiesPricing {
      val jsonDecoder = decoder.requireJsonDecoder("InlineComponentsSchemasPublicEndpointPropertiesPricing")
      val json = jsonDecoder.json
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("InlineComponentsSchemasPublicEndpointPropertiesPricing must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineComponentsSchemasPublicEndpointPropertiesPricing) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineComponentsSchemasPublicEndpointPropertiesPricing")
...
public fun inlineComponentsSchemasPublicEndpointPropertiesPricing(block: InlineComponentsSchemasPublicEndpointPropertiesPricing.Builder.() -> Unit): InlineComponentsSchemasPublicEndpointPropertiesPricing = InlineComponentsSchemasPublicEndpointPropertiesPricing.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("InlineComponentsSchemasPublicEndpointPropertiesPricing is missing required property " +
      "'" + name + "'")
