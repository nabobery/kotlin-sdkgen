...
public class FunctionCallArgsDoneEvent(
  ...
  public object Serializer : KSerializer<FunctionCallArgsDoneEvent> {
    ...
    override fun deserialize(decoder: Decoder): FunctionCallArgsDoneEvent {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("FunctionCallArgsDoneEvent must be a JSON object")
...
public fun functionCallArgsDoneEvent(block: FunctionCallArgsDoneEvent.Builder.() -> Unit): FunctionCallArgsDoneEvent =
  FunctionCallArgsDoneEvent.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("FunctionCallArgsDoneEvent is missing required property '" +
    name + "'")
