...
public class BaseTextDeltaEvent(
  ...
  public val type: InlineComponentsSchemasBaseTextDeltaEventPropertiesType,
) {
  ...
  public class Builder {
    ...
    private var typeValue: InlineComponentsSchemasBaseTextDeltaEventPropertiesType? = null

    public var type: InlineComponentsSchemasBaseTextDeltaEventPropertiesType
  ...
  public object Serializer : KSerializer<BaseTextDeltaEvent> {
    ...
    override fun deserialize(decoder: Decoder): BaseTextDeltaEvent {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("BaseTextDeltaEvent must be a JSON object")
      ...
      val type = json.decodeRequired<InlineComponentsSchemasBaseTextDeltaEventPropertiesType>(raw, "type")
      return BaseTextDeltaEvent(
        contentIndex = contentIndex,
        delta = delta,
        itemId = itemId,
...
public fun baseTextDeltaEvent(block: BaseTextDeltaEvent.Builder.() -> Unit): BaseTextDeltaEvent = BaseTextDeltaEvent
  .build(block)
