...
public class ListKeyAssignmentsResponse(
  ...
  public object Serializer : KSerializer<ListKeyAssignmentsResponse> {
    ...
    override fun deserialize(decoder: Decoder): ListKeyAssignmentsResponse {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("ListKeyAssignmentsResponse must be a JSON object")
      val data = json.decodeRequired<List<KeyAssignment>>(raw, "data")
...
public fun listKeyAssignmentsResponse(block: ListKeyAssignmentsResponse.Builder.() ->
  Unit): ListKeyAssignmentsResponse = ListKeyAssignmentsResponse.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("ListKeyAssignmentsResponse is missing required property '" +
    name + "'")
