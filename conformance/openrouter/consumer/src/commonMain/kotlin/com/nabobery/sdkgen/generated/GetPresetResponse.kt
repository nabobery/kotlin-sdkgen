...
public class GetPresetResponse(
  ...
  public object Serializer : KSerializer<GetPresetResponse> {
    ...
    override fun deserialize(decoder: Decoder): GetPresetResponse {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("GetPresetResponse must be a JSON object")
...
public fun getPresetResponse(block: GetPresetResponse.Builder.() -> Unit): GetPresetResponse = GetPresetResponse
  .build(block)
