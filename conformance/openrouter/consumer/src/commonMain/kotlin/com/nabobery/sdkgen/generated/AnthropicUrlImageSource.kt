...
public class AnthropicUrlImageSource(
  ...
  public class Builder {
    private var typeValue: InlineComponentsSchemasAnthropicUrlImageSourcePropertiesType? = null

    public var type: InlineComponentsSchemasAnthropicUrlImageSourcePropertiesType
  ...
  public object Serializer : KSerializer<AnthropicUrlImageSource> {
    ...
    override fun deserialize(decoder: Decoder): AnthropicUrlImageSource {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("AnthropicUrlImageSource must be a JSON object")
      val type = json.decodeRequired<InlineComponentsSchemasAnthropicUrlImageSourcePropertiesType>(raw, "type")
...
public fun anthropicUrlImageSource(block: AnthropicUrlImageSource.Builder.() -> Unit): AnthropicUrlImageSource =
  AnthropicUrlImageSource.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("AnthropicUrlImageSource is missing required property '" +
    name + "'")
