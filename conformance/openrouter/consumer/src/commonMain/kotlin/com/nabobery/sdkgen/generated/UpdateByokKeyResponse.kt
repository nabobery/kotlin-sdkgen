...
public class UpdateByokKeyResponse(
  ...
  public object Serializer : KSerializer<UpdateByokKeyResponse> {
    ...
    override fun deserialize(decoder: Decoder): UpdateByokKeyResponse {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("UpdateByokKeyResponse must be a JSON object")
...
public fun updateByokKeyResponse(block: UpdateByokKeyResponse.Builder.() -> Unit): UpdateByokKeyResponse =
  UpdateByokKeyResponse.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("UpdateByokKeyResponse is missing required property '" +
    name + "'")
