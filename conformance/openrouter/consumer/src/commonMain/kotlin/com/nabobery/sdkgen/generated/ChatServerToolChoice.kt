...
public class ChatServerToolChoice(
  ...
  public object Serializer : KSerializer<ChatServerToolChoice> {
    ...
    override fun deserialize(decoder: Decoder): ChatServerToolChoice {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("ChatServerToolChoice must be a JSON object")
...
public fun chatServerToolChoice(block: ChatServerToolChoice.Builder.() -> Unit): ChatServerToolChoice =
  ChatServerToolChoice.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("ChatServerToolChoice is missing required property '" +
    name + "'")
