 ...
 */
@Serializable(with = InlineComponentsSchemasCreateByokKeyResponsePropertiesData.Serializer::class)
public class InlineComponentsSchemasCreateByokKeyResponsePropertiesData internal constructor(
  /**
  ...
  public class Builder {
    ...
    public fun build(): InlineComponentsSchemasCreateByokKeyResponsePropertiesData {
      ...
      return InlineComponentsSchemasCreateByokKeyResponsePropertiesData(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineComponentsSchemasCreateByokKeyResponsePropertiesData = Builder()
      .apply(block).build()
  }

  public object Serializer : KSerializer<InlineComponentsSchemasCreateByokKeyResponsePropertiesData> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineComponentsSchemasCreateByokKeyResponsePropertiesData {
      val jsonDecoder = decoder.requireJsonDecoder("InlineComponentsSchemasCreateByokKeyResponsePropertiesData")
      val json = jsonDecoder.json
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("InlineComponentsSchemasCreateByokKeyResponsePropertiesData must be a JSON object")
      ...
      if (!raw.containsKey("allowed_api_key_hashes")) {
        throw SerializationException("InlineComponentsSchemasCreateByokKeyResponsePropertiesData is missing required " +
    ...
    override fun serialize(encoder: Encoder, `value`: InlineComponentsSchemasCreateByokKeyResponsePropertiesData) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineComponentsSchemasCreateByokKeyResponsePropertiesData")
...
public fun inlineComponentsSchemasCreateByokKeyResponsePropertiesData(block: InlineComponentsSchemasCreateByokKeyResponsePropertiesData.Builder.() -> Unit): InlineComponentsSchemasCreateByokKeyResponsePropertiesData = InlineComponentsSchemasCreateByokKeyResponsePropertiesData.build(block)
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineComponentsSchemasCreateByokKeyResponsePropertiesData property " +
