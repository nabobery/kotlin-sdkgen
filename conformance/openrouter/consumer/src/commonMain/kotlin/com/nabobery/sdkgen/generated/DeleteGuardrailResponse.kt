...
public class DeleteGuardrailResponse(
  ...
  public object Serializer : KSerializer<DeleteGuardrailResponse> {
    ...
    override fun deserialize(decoder: Decoder): DeleteGuardrailResponse {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("DeleteGuardrailResponse must be a JSON object")
...
public fun deleteGuardrailResponse(block: DeleteGuardrailResponse.Builder.() -> Unit): DeleteGuardrailResponse =
  DeleteGuardrailResponse.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("DeleteGuardrailResponse is missing required property '" +
    name + "'")
