...
public class OpenRouterClient(
   ...
   */
  public suspend fun sendChatCompletionRequest(request: ChatRequest, options: CallOptions = CallOptions()): JsonElement = executor.execute<ChatRequest, JsonElement>(metadata, baseUri, request, listOf(OpenRouterCodecs.CHAT_REQUEST_CODEC_ID), listOf(OpenRouterCodecs.JSON_ELEMENT_CODEC_ID), OpenRouterCodecs.chatRequestCodecRegistry, OpenRouterCodecs.jsonElementCodecRegistry, options)

  public companion object {
    public val metadata: OperationMetadata = OperationMetadata(
