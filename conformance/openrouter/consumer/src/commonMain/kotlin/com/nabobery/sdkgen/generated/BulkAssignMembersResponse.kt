...
public class BulkAssignMembersResponse(
  ...
  public object Serializer : KSerializer<BulkAssignMembersResponse> {
    ...
    override fun deserialize(decoder: Decoder): BulkAssignMembersResponse {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("BulkAssignMembersResponse must be a JSON object")
      val assignedCount = json.decodeRequired<Int>(raw, "assigned_count")
      return BulkAssignMembersResponse(
        assignedCount = assignedCount,
      )
    }
...
public fun bulkAssignMembersResponse(block: BulkAssignMembersResponse.Builder.() -> Unit): BulkAssignMembersResponse =
  BulkAssignMembersResponse.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("BulkAssignMembersResponse is missing required property '" +
    name + "'")
