...
public class FileDeleteResponse(
  ...
  public val type: InlineComponentsSchemasFileDeleteResponsePropertiesType,
) {
  public class Builder {
    ...
    private var typeValue: InlineComponentsSchemasFileDeleteResponsePropertiesType? = null

    public var type: InlineComponentsSchemasFileDeleteResponsePropertiesType
  ...
  public object Serializer : KSerializer<FileDeleteResponse> {
    ...
    override fun deserialize(decoder: Decoder): FileDeleteResponse {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("FileDeleteResponse must be a JSON object")
      val id = json.decodeRequired<String>(raw, "id")
      val type = json.decodeRequired<InlineComponentsSchemasFileDeleteResponsePropertiesType>(raw, "type")
      return FileDeleteResponse(
        id = id,
        type = type,
      )
...
public fun fileDeleteResponse(block: FileDeleteResponse.Builder.() -> Unit): FileDeleteResponse = FileDeleteResponse
  .build(block)
