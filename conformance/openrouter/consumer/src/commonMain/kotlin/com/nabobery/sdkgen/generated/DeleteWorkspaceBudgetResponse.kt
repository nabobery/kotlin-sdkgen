...
public class DeleteWorkspaceBudgetResponse(
  ...
  public object Serializer : KSerializer<DeleteWorkspaceBudgetResponse> {
    ...
    override fun deserialize(decoder: Decoder): DeleteWorkspaceBudgetResponse {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("DeleteWorkspaceBudgetResponse must be a JSON object")
...
public fun deleteWorkspaceBudgetResponse(block: DeleteWorkspaceBudgetResponse.Builder.() ->
  Unit): DeleteWorkspaceBudgetResponse = DeleteWorkspaceBudgetResponse.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("DeleteWorkspaceBudgetResponse is missing required property '" + name + "'")
