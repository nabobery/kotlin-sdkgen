...
public class AnthropicToolReference(
  ...
  public val type: InlineComponentsSchemasAnthropicToolReferencePropertiesType,
) {
  public class Builder {
    ...
    private var typeValue: InlineComponentsSchemasAnthropicToolReferencePropertiesType? = null

    public var type: InlineComponentsSchemasAnthropicToolReferencePropertiesType
  ...
  public object Serializer : KSerializer<AnthropicToolReference> {
    ...
    override fun deserialize(decoder: Decoder): AnthropicToolReference {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("AnthropicToolReference must be a JSON object")
      val toolName = json.decodeRequired<String>(raw, "tool_name")
      val type = json.decodeRequired<InlineComponentsSchemasAnthropicToolReferencePropertiesType>(raw, "type")
      return AnthropicToolReference(
        toolName = toolName,
        type = type,
      )
...
public fun anthropicToolReference(block: AnthropicToolReference.Builder.() -> Unit): AnthropicToolReference =
  AnthropicToolReference.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("AnthropicToolReference is missing required property '" +
    name + "'")
