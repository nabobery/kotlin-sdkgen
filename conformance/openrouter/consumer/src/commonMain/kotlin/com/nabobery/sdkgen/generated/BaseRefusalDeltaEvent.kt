 ...
 */
@Serializable(with = BaseRefusalDeltaEvent.Serializer::class)
public class BaseRefusalDeltaEvent(
  public val contentIndex: Int,
  public val delta: String,
  public val itemId: String,
  public val outputIndex: Int,
  public val sequenceNumber: Int,
  public val type: InlineComponentsSchemasBaseRefusalDeltaEventPropertiesType,
) {
  public class Builder {
    ...
    private var typeValue: InlineComponentsSchemasBaseRefusalDeltaEventPropertiesType? = null

    public var type: InlineComponentsSchemasBaseRefusalDeltaEventPropertiesType
      get() = requireNotNull(typeValue) { "type is required" }
      set(`value`) {
        typeValue = value
      }

    public fun build(): BaseRefusalDeltaEvent {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): BaseRefusalDeltaEvent = Builder().apply(block).build()
  }

  public object Serializer : KSerializer<BaseRefusalDeltaEvent> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): BaseRefusalDeltaEvent {
      val jsonDecoder = decoder.requireJsonDecoder("BaseRefusalDeltaEvent")
      val json = jsonDecoder.json
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("BaseRefusalDeltaEvent must be a JSON object")
      ...
      val type = json.decodeRequired<InlineComponentsSchemasBaseRefusalDeltaEventPropertiesType>(raw, "type")
      return BaseRefusalDeltaEvent(
        contentIndex = contentIndex,
        delta = delta,
        itemId = itemId,
    ...
    override fun serialize(encoder: Encoder, `value`: BaseRefusalDeltaEvent) {
      val jsonEncoder = encoder.requireJsonEncoder("BaseRefusalDeltaEvent")
...
public fun baseRefusalDeltaEvent(block: BaseRefusalDeltaEvent.Builder.() -> Unit): BaseRefusalDeltaEvent =
  BaseRefusalDeltaEvent.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("BaseRefusalDeltaEvent is missing required property '" +
    name + "'")
