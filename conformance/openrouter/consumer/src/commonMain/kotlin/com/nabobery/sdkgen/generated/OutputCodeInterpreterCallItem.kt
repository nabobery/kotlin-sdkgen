...
public class OutputCodeInterpreterCallItem(
  ...
  public object Serializer : KSerializer<OutputCodeInterpreterCallItem> {
    ...
    override fun deserialize(decoder: Decoder): OutputCodeInterpreterCallItem {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("OutputCodeInterpreterCallItem must be a JSON object")
...
public fun outputCodeInterpreterCallItem(block: OutputCodeInterpreterCallItem.Builder.() ->
  Unit): OutputCodeInterpreterCallItem = OutputCodeInterpreterCallItem.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("OutputCodeInterpreterCallItem is missing required property '" + name + "'")
