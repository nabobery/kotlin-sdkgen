...
/**
 * Generated model for sdkgen://source/openapi.yaml#/components/schemas/ObservabilityGrafanaDestination.
 */
@Serializable(with = ObservabilityGrafanaDestination.Serializer::class)
public class ObservabilityGrafanaDestination(
  /**
  ...
  public class Builder {
    private var configValue: InlineComponentsSchemasObservabilityGrafanaDestinationPropertiesConfig?
        = null

    public var config: InlineComponentsSchemasObservabilityGrafanaDestinationPropertiesConfig
    ...
    private var typeValue: InlineComponentsSchemasObservabilityGrafanaDestinationPropertiesType? =
        null

    public var type: InlineComponentsSchemasObservabilityGrafanaDestinationPropertiesType
    ...
    public fun build(): ObservabilityGrafanaDestination {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): ObservabilityGrafanaDestination = Builder().apply(block).build()
  }

  public object Serializer : KSerializer<ObservabilityGrafanaDestination> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): ObservabilityGrafanaDestination {
      val jsonDecoder = decoder.requireJsonDecoder("ObservabilityGrafanaDestination")
      val json = jsonDecoder.json
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("ObservabilityGrafanaDestination must be a JSON object")
      val config = json.decodeRequired<InlineComponentsSchemasObservabilityGrafanaDestinationPropertiesConfig>(raw,
        "config")
      ...
      val type = json.decodeRequired<InlineComponentsSchemasObservabilityGrafanaDestinationPropertiesType>(raw, "type")
      ...
      if (!raw.containsKey("api_key_hashes")) {
        throw SerializationException("ObservabilityGrafanaDestination is missing required property 'api_key_hashes'")
      }
      ...
      if (!raw.containsKey("filter_rules")) {
        throw SerializationException("ObservabilityGrafanaDestination is missing required property 'filter_rules'")
      }
      ...
      if (!raw.containsKey("name")) {
        throw SerializationException("ObservabilityGrafanaDestination is missing required property 'name'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: ObservabilityGrafanaDestination) {
      val jsonEncoder = encoder.requireJsonEncoder("ObservabilityGrafanaDestination")
...
public fun observabilityGrafanaDestination(block: ObservabilityGrafanaDestination.Builder.() ->
  Unit): ObservabilityGrafanaDestination = ObservabilityGrafanaDestination.build(block)
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("ObservabilityGrafanaDestination property '" + name +
      "' is not nullable")
