...
public data class OpenAiResponsesRefusalContentView(
  ...
  public val type: InlineComponentsSchemasOpenAiResponsesRefusalContentPropertiesType,
)
...
public class OpenAiResponsesRefusalContent(
  ...
  public class Builder {
    ...
    private var typeValue: InlineComponentsSchemasOpenAiResponsesRefusalContentPropertiesType? =
        null

    public var type: InlineComponentsSchemasOpenAiResponsesRefusalContentPropertiesType
  ...
  public object Serializer : KSerializer<OpenAiResponsesRefusalContent> {
    ...
    override fun deserialize(decoder: Decoder): OpenAiResponsesRefusalContent {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("OpenAiResponsesRefusalContent must be a JSON object")
      val refusal = json.decodeRequired<String>(raw, "refusal")
      val type = json.decodeRequired<InlineComponentsSchemasOpenAiResponsesRefusalContentPropertiesType>(raw, "type")
      return OpenAiResponsesRefusalContent(
        refusal = refusal,
        type = type,
      )
...
public fun openAiResponsesRefusalContent(block: OpenAiResponsesRefusalContent.Builder.() ->
  Unit): OpenAiResponsesRefusalContent = OpenAiResponsesRefusalContent.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("OpenAiResponsesRefusalContent is missing required property '" + name + "'")
