...
public class OutputItemDoneEvent(
  public val item: InlineComponentsSchemasOutputItemDoneEventPropertiesItem,
  public val outputIndex: Int,
  public val sequenceNumber: Int,
  public val type: InlineComponentsSchemasOutputItemDoneEventPropertiesType,
) {
  public class Builder {
    private var itemValue: InlineComponentsSchemasOutputItemDoneEventPropertiesItem? = null

    public var item: InlineComponentsSchemasOutputItemDoneEventPropertiesItem
    ...
    private var typeValue: InlineComponentsSchemasOutputItemDoneEventPropertiesType? = null

    public var type: InlineComponentsSchemasOutputItemDoneEventPropertiesType
  ...
  public object Serializer : KSerializer<OutputItemDoneEvent> {
    ...
    override fun deserialize(decoder: Decoder): OutputItemDoneEvent {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("OutputItemDoneEvent must be a JSON object")
      val item = json.decodeRequired<InlineComponentsSchemasOutputItemDoneEventPropertiesItem>(raw, "item")
      val outputIndex = json.decodeRequired<Int>(raw, "output_index")
      val sequenceNumber = json.decodeRequired<Int>(raw, "sequence_number")
      val type = json.decodeRequired<InlineComponentsSchemasOutputItemDoneEventPropertiesType>(raw, "type")
      return OutputItemDoneEvent(
        item = item,
        outputIndex = outputIndex,
        sequenceNumber = sequenceNumber,
...
public fun outputItemDoneEvent(block: OutputItemDoneEvent.Builder.() -> Unit): OutputItemDoneEvent =
  OutputItemDoneEvent.build(block)
