...
/**
 * Generated model for sdkgen://source/openapi.yaml#/components/schemas/ObservabilityBraintrustDestination.
 */
@Serializable(with = ObservabilityBraintrustDestination.Serializer::class)
public class ObservabilityBraintrustDestination(
  /**
  ...
  public class Builder {
    private var configValue:
        InlineComponentsSchemasObservabilityBraintrustDestinationPropertiesConfig? = null

    public var config: InlineComponentsSchemasObservabilityBraintrustDestinationPropertiesConfig
    ...
    private var typeValue: InlineComponentsSchemasObservabilityBraintrustDestinationPropertiesType?
        = null

    public var type: InlineComponentsSchemasObservabilityBraintrustDestinationPropertiesType
    ...
    public fun build(): ObservabilityBraintrustDestination {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): ObservabilityBraintrustDestination = Builder().apply(block).build()
  }

  public object Serializer : KSerializer<ObservabilityBraintrustDestination> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): ObservabilityBraintrustDestination {
      val jsonDecoder = decoder.requireJsonDecoder("ObservabilityBraintrustDestination")
      val json = jsonDecoder.json
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("ObservabilityBraintrustDestination must be a JSON object")
      val config = json.decodeRequired<InlineComponentsSchemasObservabilityBraintrustDestinationPropertiesConfig>(raw,
        "config")
      ...
      val type = json.decodeRequired<InlineComponentsSchemasObservabilityBraintrustDestinationPropertiesType>(raw,
        "type")
      ...
      if (!raw.containsKey("api_key_hashes")) {
        throw SerializationException("ObservabilityBraintrustDestination is missing required property 'api_key_hashes'")
      }
      ...
      if (!raw.containsKey("filter_rules")) {
        throw SerializationException("ObservabilityBraintrustDestination is missing required property 'filter_rules'")
      }
      ...
      if (!raw.containsKey("name")) {
        throw SerializationException("ObservabilityBraintrustDestination is missing required property 'name'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: ObservabilityBraintrustDestination) {
      val jsonEncoder = encoder.requireJsonEncoder("ObservabilityBraintrustDestination")
...
public fun observabilityBraintrustDestination(block: ObservabilityBraintrustDestination.Builder.() ->
  Unit): ObservabilityBraintrustDestination = ObservabilityBraintrustDestination.build(block)
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("ObservabilityBraintrustDestination property '" + name +
      "' is not nullable")
