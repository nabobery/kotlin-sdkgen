...
public class BaseReasoningSummaryTextDoneEvent(
  ...
  public object Serializer : KSerializer<BaseReasoningSummaryTextDoneEvent> {
    ...
    override fun deserialize(decoder: Decoder): BaseReasoningSummaryTextDoneEvent {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("BaseReasoningSummaryTextDoneEvent must be a JSON object")
...
public fun baseReasoningSummaryTextDoneEvent(block: BaseReasoningSummaryTextDoneEvent.Builder.() ->
  Unit): BaseReasoningSummaryTextDoneEvent = BaseReasoningSummaryTextDoneEvent.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("BaseReasoningSummaryTextDoneEvent is missing required property '" + name + "'")
