...
public class ProviderResponse internal constructor(
  ...
  private val providerNameState:
      FieldState<InlineComponentsSchemasProviderResponsePropertiesProviderName>,
  private val routedServiceTierState:
      FieldState<InlineComponentsSchemasProviderResponsePropertiesRoutedServiceTier>,
) {
  /**
   ...
   */
  public val providerName: InlineComponentsSchemasProviderResponsePropertiesProviderName?
   ...
   */
  public val routedServiceTier: InlineComponentsSchemasProviderResponsePropertiesRoutedServiceTier?
  ...
  public class Builder {
     ...
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var providerName: InlineComponentsSchemasProviderResponsePropertiesProviderName?
      get() = providerNameState.valueOrNull()
      set(`value`) {
    ...
    private var routedServiceTierState:
        FieldState<InlineComponentsSchemasProviderResponsePropertiesRoutedServiceTier> =
        FieldState.Absent
     ...
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var routedServiceTier:
        InlineComponentsSchemasProviderResponsePropertiesRoutedServiceTier?
      get() = routedServiceTierState.valueOrNull()
      set(`value`) {
        val present = requireNotNull(value) {
          "routedServiceTier is not nullable; call unsetRoutedServiceTier() to omit it" }
  ...
  public object Serializer : KSerializer<ProviderResponse> {
    ...
    override fun deserialize(decoder: Decoder): ProviderResponse {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("ProviderResponse must be a JSON object")
      if (!raw.containsKey("status")) {
        throw SerializationException("ProviderResponse is missing required property 'status'")
      }
      val status = raw["status"].let { element -> if (element == JsonNull) null else json
        .decodeFromJsonElement<Int?>(requireNotNull(element)) }
      return ProviderResponse(
        status = status,
        endpointIdState = json.decodeOptional(raw, "endpoint_id", nullable = false),
        idState = json.decodeOptional(raw, "id", nullable = false),
        isByokState = json.decodeOptional(raw, "is_byok", nullable = false),
        latencyState = json.decodeOptional(raw, "latency", nullable = false),
        modelPermaslugState = json.decodeOptional(raw, "model_permaslug", nullable = false),
        providerNameState = json.decodeOptional(raw, "provider_name", nullable = false),
        routedServiceTierState = json.decodeOptional(raw, "routed_service_tier", nullable = false),
      )
    }
...
public fun providerResponse(block: ProviderResponse.Builder.() -> Unit): ProviderResponse = ProviderResponse
  .build(block)
