...
public class CreateGuardrailResponse(
  ...
  public object Serializer : KSerializer<CreateGuardrailResponse> {
    ...
    override fun deserialize(decoder: Decoder): CreateGuardrailResponse {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("CreateGuardrailResponse must be a JSON object")
...
public fun createGuardrailResponse(block: CreateGuardrailResponse.Builder.() -> Unit): CreateGuardrailResponse =
  CreateGuardrailResponse.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("CreateGuardrailResponse is missing required property '" +
    name + "'")
