...
public class ModelArchitecture internal constructor(
  ...
  public object Serializer : KSerializer<ModelArchitecture> {
    ...
    override fun deserialize(decoder: Decoder): ModelArchitecture {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("ModelArchitecture must be a JSON object")
      ...
      return ModelArchitecture(
        ...
        modality = modality,
        outputModalities = outputModalities,
        instructTypeState = json.decodeOptional(raw, "instruct_type", nullable = true),
        tokenizerState = json.decodeOptional(raw, "tokenizer", nullable = false),
      )
    }
...
public fun modelArchitecture(block: ModelArchitecture.Builder.() -> Unit): ModelArchitecture = ModelArchitecture
  .build(block)
