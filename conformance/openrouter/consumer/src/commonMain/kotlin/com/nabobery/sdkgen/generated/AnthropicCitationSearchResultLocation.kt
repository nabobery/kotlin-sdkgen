...
public class AnthropicCitationSearchResultLocation(
  ...
  public class Builder {
    ...
    private var typeValue:
        InlineComponentsSchemasAnthropicCitationSearchResultLocationPropertiesType? = null

    public var type: InlineComponentsSchemasAnthropicCitationSearchResultLocationPropertiesType
  ...
  public object Serializer : KSerializer<AnthropicCitationSearchResultLocation> {
    ...
    override fun deserialize(decoder: Decoder): AnthropicCitationSearchResultLocation {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("AnthropicCitationSearchResultLocation must be a JSON object")
      ...
      val type = json.decodeRequired<InlineComponentsSchemasAnthropicCitationSearchResultLocationPropertiesType>(raw,
        "type")
...
public fun anthropicCitationSearchResultLocation(block: AnthropicCitationSearchResultLocation.Builder.() ->
  Unit): AnthropicCitationSearchResultLocation = AnthropicCitationSearchResultLocation.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("AnthropicCitationSearchResultLocation is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("AnthropicCitationSearchResultLocation property '" + name +
      "' is not nullable")
