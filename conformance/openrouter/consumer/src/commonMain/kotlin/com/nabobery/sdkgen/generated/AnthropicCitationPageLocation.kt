...
public class AnthropicCitationPageLocation(
  ...
  public class Builder {
    ...
    private var typeValue: InlineComponentsSchemasAnthropicCitationPageLocationPropertiesType? =
        null

    public var type: InlineComponentsSchemasAnthropicCitationPageLocationPropertiesType
  ...
  public object Serializer : KSerializer<AnthropicCitationPageLocation> {
    ...
    override fun deserialize(decoder: Decoder): AnthropicCitationPageLocation {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("AnthropicCitationPageLocation must be a JSON object")
      ...
      val type = json.decodeRequired<InlineComponentsSchemasAnthropicCitationPageLocationPropertiesType>(raw, "type")
...
public fun anthropicCitationPageLocation(block: AnthropicCitationPageLocation.Builder.() ->
  Unit): AnthropicCitationPageLocation = AnthropicCitationPageLocation.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("AnthropicCitationPageLocation is missing required property '" + name + "'")
