...
public class AnthropicToolSearchToolResult(
  ...
  public val type: InlineComponentsSchemasAnthropicToolSearchToolResultPropertiesType,
) {
  public class Builder {
    ...
    private var typeValue: InlineComponentsSchemasAnthropicToolSearchToolResultPropertiesType? =
        null

    public var type: InlineComponentsSchemasAnthropicToolSearchToolResultPropertiesType
  ...
  public object Serializer : KSerializer<AnthropicToolSearchToolResult> {
    ...
    override fun deserialize(decoder: Decoder): AnthropicToolSearchToolResult {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("AnthropicToolSearchToolResult must be a JSON object")
      val content = json.decodeRequired<AnthropicToolSearchContent>(raw, "content")
      val toolUseId = json.decodeRequired<String>(raw, "tool_use_id")
      val type = json.decodeRequired<InlineComponentsSchemasAnthropicToolSearchToolResultPropertiesType>(raw, "type")
      return AnthropicToolSearchToolResult(
        content = content,
        toolUseId = toolUseId,
        type = type,
...
public fun anthropicToolSearchToolResult(block: AnthropicToolSearchToolResult.Builder.() ->
  Unit): AnthropicToolSearchToolResult = AnthropicToolSearchToolResult.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("AnthropicToolSearchToolResult is missing required property '" + name + "'")
