...
public class WebSearchServerToolConfig(
  ...
  public object Serializer : KSerializer<WebSearchServerToolConfig> {
    ...
    override fun deserialize(decoder: Decoder): WebSearchServerToolConfig {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("WebSearchServerToolConfig must be a JSON object")
...
public fun webSearchServerToolConfig(block: WebSearchServerToolConfig.Builder.() -> Unit): WebSearchServerToolConfig =
  WebSearchServerToolConfig.build(block)
