...
public class AnthropicCitationSearchResultLocationParam(
  ...
  public val type: InlineComponentsSchemasAnthropicCitationSearchResultLocationParamPropertiesType,
) {
  public class Builder {
    ...
    private var typeValue:
        InlineComponentsSchemasAnthropicCitationSearchResultLocationParamPropertiesType? = null

    public var type: InlineComponentsSchemasAnthropicCitationSearchResultLocationParamPropertiesType
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): AnthropicCitationSearchResultLocationParam = Builder().apply(block)
      .build()
  }

  public object Serializer : KSerializer<AnthropicCitationSearchResultLocationParam> {
    ...
    override fun deserialize(decoder: Decoder): AnthropicCitationSearchResultLocationParam {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("AnthropicCitationSearchResultLocationParam must be a JSON object")
      val citedText = json.decodeRequired<String>(raw, "cited_text")
      val endBlockIndex = json.decodeRequired<Int>(raw, "end_block_index")
      val searchResultIndex = json.decodeRequired<Int>(raw, "search_result_index")
      val source = json.decodeRequired<String>(raw, "source")
      val startBlockIndex = json.decodeRequired<Int>(raw, "start_block_index")
      val type = json
        .decodeRequired<InlineComponentsSchemasAnthropicCitationSearchResultLocationParamPropertiesType>(raw, "type")
...
public fun anthropicCitationSearchResultLocationParam(block: AnthropicCitationSearchResultLocationParam.Builder.() ->
  Unit): AnthropicCitationSearchResultLocationParam = AnthropicCitationSearchResultLocationParam.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("AnthropicCitationSearchResultLocationParam is missing required property '" + name +
      "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("AnthropicCitationSearchResultLocationParam property '" + name +
      "' is not nullable")
