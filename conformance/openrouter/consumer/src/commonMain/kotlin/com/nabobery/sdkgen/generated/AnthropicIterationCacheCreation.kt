...
public class AnthropicIterationCacheCreation(
  ...
  public object Serializer : KSerializer<AnthropicIterationCacheCreation> {
    ...
    override fun deserialize(decoder: Decoder): AnthropicIterationCacheCreation {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("AnthropicIterationCacheCreation must be a JSON object")
      return AnthropicIterationCacheCreation(
        ephemeral1hInputTokens = raw["ephemeral_1h_input_tokens"]?.let { json.decodeFromJsonElement<Int>(it) },
        ephemeral5mInputTokens = raw["ephemeral_5m_input_tokens"]?.let { json.decodeFromJsonElement<Int>(it) },
      )
    }
...
public fun anthropicIterationCacheCreation(block: AnthropicIterationCacheCreation.Builder.() ->
  Unit): AnthropicIterationCacheCreation = AnthropicIterationCacheCreation.build(block)
