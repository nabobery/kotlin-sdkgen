...
public class BashServerToolConfig(
  ...
  public object Serializer : KSerializer<BashServerToolConfig> {
    ...
    override fun deserialize(decoder: Decoder): BashServerToolConfig {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("BashServerToolConfig must be a JSON object")
      return BashServerToolConfig(
        engine = raw["engine"]?.let { json.decodeFromJsonElement<BashServerToolEngine>(it) },
        environment = raw["environment"]?.let { json.decodeFromJsonElement<BashServerToolEnvironment>(it) },
...
public fun bashServerToolConfig(block: BashServerToolConfig.Builder.() -> Unit): BashServerToolConfig =
  BashServerToolConfig.build(block)
