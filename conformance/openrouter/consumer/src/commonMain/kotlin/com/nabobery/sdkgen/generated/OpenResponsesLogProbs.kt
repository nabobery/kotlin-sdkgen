...
public class OpenResponsesLogProbs(
  ...
  public val topLogprobs: List<OpenResponsesTopLogprobs>? = null,
) {
  public class Builder {
    ...
    public var topLogprobs: List<OpenResponsesTopLogprobs>? = null
  ...
  public object Serializer : KSerializer<OpenResponsesLogProbs> {
    ...
    override fun deserialize(decoder: Decoder): OpenResponsesLogProbs {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("OpenResponsesLogProbs must be a JSON object")
      ...
      return OpenResponsesLogProbs(
        ...
        topLogprobs = raw["top_logprobs"]?.let { json.decodeFromJsonElement<List<OpenResponsesTopLogprobs>>(it) },
      )
    }
...
public fun openResponsesLogProbs(block: OpenResponsesLogProbs.Builder.() -> Unit): OpenResponsesLogProbs =
  OpenResponsesLogProbs.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("OpenResponsesLogProbs is missing required property '" +
    name + "'")
