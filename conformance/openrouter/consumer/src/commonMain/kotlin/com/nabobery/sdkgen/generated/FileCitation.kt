...
public data class FileCitationView(
  ...
  public val type: InlineComponentsSchemasFileCitationPropertiesType,
)
...
public class FileCitation(
  ...
  public class Builder {
    ...
    private var typeValue: InlineComponentsSchemasFileCitationPropertiesType? = null

    public var type: InlineComponentsSchemasFileCitationPropertiesType
  ...
  public object Serializer : KSerializer<FileCitation> {
    ...
    override fun deserialize(decoder: Decoder): FileCitation {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("FileCitation must be a JSON object")
      ...
      val type = json.decodeRequired<InlineComponentsSchemasFileCitationPropertiesType>(raw, "type")
      return FileCitation(
        fileId = fileId,
        filename = filename,
        index = index,
