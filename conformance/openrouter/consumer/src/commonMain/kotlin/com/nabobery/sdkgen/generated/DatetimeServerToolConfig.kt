...
public class DatetimeServerToolConfig(
  ...
  public object Serializer : KSerializer<DatetimeServerToolConfig> {
    ...
    override fun deserialize(decoder: Decoder): DatetimeServerToolConfig {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("DatetimeServerToolConfig must be a JSON object")
      return DatetimeServerToolConfig(
        timezone = raw["timezone"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }
...
public fun datetimeServerToolConfig(block: DatetimeServerToolConfig.Builder.() -> Unit): DatetimeServerToolConfig =
  DatetimeServerToolConfig.build(block)
