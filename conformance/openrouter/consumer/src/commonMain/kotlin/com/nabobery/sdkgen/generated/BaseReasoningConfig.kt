...
public class BaseReasoningConfig(
  ...
  public object Serializer : KSerializer<BaseReasoningConfig> {
    ...
    override fun deserialize(decoder: Decoder): BaseReasoningConfig {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("BaseReasoningConfig must be a JSON object")
...
public fun baseReasoningConfig(block: BaseReasoningConfig.Builder.() -> Unit): BaseReasoningConfig =
  BaseReasoningConfig.build(block)
