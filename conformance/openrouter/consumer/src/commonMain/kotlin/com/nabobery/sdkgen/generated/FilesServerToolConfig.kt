...
public class FilesServerToolConfig(
  ...
  public object Serializer : KSerializer<FilesServerToolConfig> {
    ...
    override fun deserialize(decoder: Decoder): FilesServerToolConfig {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("FilesServerToolConfig must be a JSON object")
      return FilesServerToolConfig(
        allowWrites = raw["allow_writes"]?.let { json.decodeFromJsonElement<Boolean>(it) },
      )
    }
...
public fun filesServerToolConfig(block: FilesServerToolConfig.Builder.() -> Unit): FilesServerToolConfig =
  FilesServerToolConfig.build(block)
