...
/**
 * Generated model for sdkgen://source/openapi.yaml#/components/schemas/ObservabilityLangsmithDestination.
 */
@Serializable(with = ObservabilityLangsmithDestination.Serializer::class)
public class ObservabilityLangsmithDestination(
  /**
  ...
  public class Builder {
    private var configValue:
        InlineComponentsSchemasObservabilityLangsmithDestinationPropertiesConfig? = null

    public var config: InlineComponentsSchemasObservabilityLangsmithDestinationPropertiesConfig
    ...
    private var typeValue: InlineComponentsSchemasObservabilityLangsmithDestinationPropertiesType? =
        null

    public var type: InlineComponentsSchemasObservabilityLangsmithDestinationPropertiesType
    ...
    public fun build(): ObservabilityLangsmithDestination {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): ObservabilityLangsmithDestination = Builder().apply(block).build()
  }

  public object Serializer : KSerializer<ObservabilityLangsmithDestination> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): ObservabilityLangsmithDestination {
      val jsonDecoder = decoder.requireJsonDecoder("ObservabilityLangsmithDestination")
      val json = jsonDecoder.json
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("ObservabilityLangsmithDestination must be a JSON object")
      val config = json.decodeRequired<InlineComponentsSchemasObservabilityLangsmithDestinationPropertiesConfig>(raw,
        "config")
      ...
      val type = json.decodeRequired<InlineComponentsSchemasObservabilityLangsmithDestinationPropertiesType>(raw,
        "type")
      ...
      if (!raw.containsKey("api_key_hashes")) {
        throw SerializationException("ObservabilityLangsmithDestination is missing required property 'api_key_hashes'")
      }
      ...
      if (!raw.containsKey("filter_rules")) {
        throw SerializationException("ObservabilityLangsmithDestination is missing required property 'filter_rules'")
      }
      ...
      if (!raw.containsKey("name")) {
        throw SerializationException("ObservabilityLangsmithDestination is missing required property 'name'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: ObservabilityLangsmithDestination) {
      val jsonEncoder = encoder.requireJsonEncoder("ObservabilityLangsmithDestination")
...
public fun observabilityLangsmithDestination(block: ObservabilityLangsmithDestination.Builder.() ->
  Unit): ObservabilityLangsmithDestination = ObservabilityLangsmithDestination.build(block)
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("ObservabilityLangsmithDestination property '" + name +
      "' is not nullable")
