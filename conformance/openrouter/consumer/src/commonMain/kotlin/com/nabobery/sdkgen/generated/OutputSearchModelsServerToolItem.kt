...
public class OutputSearchModelsServerToolItem(
  ...
  public val type: InlineComponentsSchemasOutputSearchModelsServerToolItemPropertiesType,
  /**
  ...
  public class Builder {
    ...
    private var typeValue: InlineComponentsSchemasOutputSearchModelsServerToolItemPropertiesType? =
        null

    public var type: InlineComponentsSchemasOutputSearchModelsServerToolItemPropertiesType
  ...
  public object Serializer : KSerializer<OutputSearchModelsServerToolItem> {
    ...
    override fun deserialize(decoder: Decoder): OutputSearchModelsServerToolItem {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("OutputSearchModelsServerToolItem must be a JSON object")
      val status = json.decodeRequired<ToolCallStatus>(raw, "status")
      val type = json.decodeRequired<InlineComponentsSchemasOutputSearchModelsServerToolItemPropertiesType>(raw, "type")
      return OutputSearchModelsServerToolItem(
        status = status,
        type = type,
...
public fun outputSearchModelsServerToolItem(block: OutputSearchModelsServerToolItem.Builder.() ->
  Unit): OutputSearchModelsServerToolItem = OutputSearchModelsServerToolItem.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("OutputSearchModelsServerToolItem is missing required property '" + name + "'")
