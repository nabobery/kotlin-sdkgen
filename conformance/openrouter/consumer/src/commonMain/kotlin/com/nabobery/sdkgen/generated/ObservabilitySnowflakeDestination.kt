...
/**
 * Generated model for sdkgen://source/openapi.yaml#/components/schemas/ObservabilitySnowflakeDestination.
 */
@Serializable(with = ObservabilitySnowflakeDestination.Serializer::class)
public class ObservabilitySnowflakeDestination(
  /**
  ...
  public class Builder {
    private var configValue:
        InlineComponentsSchemasObservabilitySnowflakeDestinationPropertiesConfig? = null

    public var config: InlineComponentsSchemasObservabilitySnowflakeDestinationPropertiesConfig
    ...
    private var typeValue: InlineComponentsSchemasObservabilitySnowflakeDestinationPropertiesType? =
        null

    public var type: InlineComponentsSchemasObservabilitySnowflakeDestinationPropertiesType
    ...
    public fun build(): ObservabilitySnowflakeDestination {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): ObservabilitySnowflakeDestination = Builder().apply(block).build()
  }

  public object Serializer : KSerializer<ObservabilitySnowflakeDestination> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): ObservabilitySnowflakeDestination {
      val jsonDecoder = decoder.requireJsonDecoder("ObservabilitySnowflakeDestination")
      val json = jsonDecoder.json
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("ObservabilitySnowflakeDestination must be a JSON object")
      val config = json.decodeRequired<InlineComponentsSchemasObservabilitySnowflakeDestinationPropertiesConfig>(raw,
        "config")
      ...
      val type = json.decodeRequired<InlineComponentsSchemasObservabilitySnowflakeDestinationPropertiesType>(raw,
        "type")
      ...
      if (!raw.containsKey("api_key_hashes")) {
        throw SerializationException("ObservabilitySnowflakeDestination is missing required property 'api_key_hashes'")
      }
      ...
      if (!raw.containsKey("filter_rules")) {
        throw SerializationException("ObservabilitySnowflakeDestination is missing required property 'filter_rules'")
      }
      ...
      if (!raw.containsKey("name")) {
        throw SerializationException("ObservabilitySnowflakeDestination is missing required property 'name'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: ObservabilitySnowflakeDestination) {
      val jsonEncoder = encoder.requireJsonEncoder("ObservabilitySnowflakeDestination")
...
public fun observabilitySnowflakeDestination(block: ObservabilitySnowflakeDestination.Builder.() ->
  Unit): ObservabilitySnowflakeDestination = ObservabilitySnowflakeDestination.build(block)
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("ObservabilitySnowflakeDestination property '" + name +
      "' is not nullable")
