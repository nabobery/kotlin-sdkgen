 ...
 */
@Serializable(with = InlineComponentsSchemasVideoGenerationRequestPropertiesProviderPropertiesOptions.Serializer::class)
public class InlineComponentsSchemasVideoGenerationRequestPropertiesProviderPropertiesOptions(
  ...
  public class Builder {
    ...
    public fun build(): InlineComponentsSchemasVideoGenerationRequestPropertiesProviderPropertiesOptions =
      InlineComponentsSchemasVideoGenerationRequestPropertiesProviderPropertiesOptions(
      _01ai = _01ai,
      ai21 = ai21,
      aionLabs = aionLabs,
      akashml = akashml,
  ...
  public companion object {
    public fun build(block: Builder.() ->
      Unit): InlineComponentsSchemasVideoGenerationRequestPropertiesProviderPropertiesOptions = Builder().apply(block)
        .build()
  }

  public object Serializer : KSerializer<InlineComponentsSchemasVideoGenerationRequestPropertiesProviderPropertiesOptions> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineComponentsSchemasVideoGenerationRequestPropertiesProviderPropertiesOptions {
      val jsonDecoder = decoder
        .requireJsonDecoder("InlineComponentsSchemasVideoGenerationRequestPropertiesProviderPropertiesOptions")
      val json = jsonDecoder.json
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("InlineComponentsSchemasVideoGenerationRequestPropertiesProviderPropertiesOptions " +
          "must be a JSON object")
      return InlineComponentsSchemasVideoGenerationRequestPropertiesProviderPropertiesOptions(
    ...
    override fun serialize(encoder: Encoder,
      `value`: InlineComponentsSchemasVideoGenerationRequestPropertiesProviderPropertiesOptions) {
      val jsonEncoder = encoder
        .requireJsonEncoder("InlineComponentsSchemasVideoGenerationRequestPropertiesProviderPropertiesOptions")
...
public fun inlineComponentsSchemasVideoGenerationRequestPropertiesProviderPropertiesOptions(block: InlineComponentsSchemasVideoGenerationRequestPropertiesProviderPropertiesOptions.Builder.() -> Unit): InlineComponentsSchemasVideoGenerationRequestPropertiesProviderPropertiesOptions = InlineComponentsSchemasVideoGenerationRequestPropertiesProviderPropertiesOptions.build(block)
