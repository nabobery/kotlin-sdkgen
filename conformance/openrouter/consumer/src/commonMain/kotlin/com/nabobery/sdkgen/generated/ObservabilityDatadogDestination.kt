...
/**
 * Generated model for sdkgen://source/openapi.yaml#/components/schemas/ObservabilityDatadogDestination.
 */
@Serializable(with = ObservabilityDatadogDestination.Serializer::class)
public class ObservabilityDatadogDestination(
  /**
  ...
  public class Builder {
    private var configValue: InlineComponentsSchemasObservabilityDatadogDestinationPropertiesConfig?
        = null

    public var config: InlineComponentsSchemasObservabilityDatadogDestinationPropertiesConfig
    ...
    private var typeValue: InlineComponentsSchemasObservabilityDatadogDestinationPropertiesType? =
        null

    public var type: InlineComponentsSchemasObservabilityDatadogDestinationPropertiesType
    ...
    public fun build(): ObservabilityDatadogDestination {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): ObservabilityDatadogDestination = Builder().apply(block).build()
  }

  public object Serializer : KSerializer<ObservabilityDatadogDestination> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): ObservabilityDatadogDestination {
      val jsonDecoder = decoder.requireJsonDecoder("ObservabilityDatadogDestination")
      val json = jsonDecoder.json
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("ObservabilityDatadogDestination must be a JSON object")
      val config = json.decodeRequired<InlineComponentsSchemasObservabilityDatadogDestinationPropertiesConfig>(raw,
        "config")
      ...
      val type = json.decodeRequired<InlineComponentsSchemasObservabilityDatadogDestinationPropertiesType>(raw, "type")
      ...
      if (!raw.containsKey("api_key_hashes")) {
        throw SerializationException("ObservabilityDatadogDestination is missing required property 'api_key_hashes'")
      }
      ...
      if (!raw.containsKey("filter_rules")) {
        throw SerializationException("ObservabilityDatadogDestination is missing required property 'filter_rules'")
      }
      ...
      if (!raw.containsKey("name")) {
        throw SerializationException("ObservabilityDatadogDestination is missing required property 'name'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: ObservabilityDatadogDestination) {
      val jsonEncoder = encoder.requireJsonEncoder("ObservabilityDatadogDestination")
...
public fun observabilityDatadogDestination(block: ObservabilityDatadogDestination.Builder.() ->
  Unit): ObservabilityDatadogDestination = ObservabilityDatadogDestination.build(block)
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("ObservabilityDatadogDestination property '" + name +
      "' is not nullable")
