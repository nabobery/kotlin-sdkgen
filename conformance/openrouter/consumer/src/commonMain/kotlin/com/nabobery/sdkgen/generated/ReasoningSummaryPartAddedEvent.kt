 ...
 */
@Serializable(with = ReasoningSummaryPartAddedEvent.Serializer::class)
public class ReasoningSummaryPartAddedEvent(
  public val itemId: String,
  public val outputIndex: Int,
  public val part: ReasoningSummaryText,
  public val sequenceNumber: Int,
  public val summaryIndex: Int,
  public val type: InlineComponentsSchemasBaseReasoningSummaryPartAddedEventPropertiesType,
) {
  public class Builder {
    ...
    private var typeValue: InlineComponentsSchemasBaseReasoningSummaryPartAddedEventPropertiesType?
        = null

    public var type: InlineComponentsSchemasBaseReasoningSummaryPartAddedEventPropertiesType
      get() = requireNotNull(typeValue) { "type is required" }
      set(`value`) {
        typeValue = value
      }

    public fun build(): ReasoningSummaryPartAddedEvent {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): ReasoningSummaryPartAddedEvent = Builder().apply(block).build()
  }

  public object Serializer : KSerializer<ReasoningSummaryPartAddedEvent> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): ReasoningSummaryPartAddedEvent {
      val jsonDecoder = decoder.requireJsonDecoder("ReasoningSummaryPartAddedEvent")
      val json = jsonDecoder.json
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("ReasoningSummaryPartAddedEvent must be a JSON object")
      ...
      val type = json.decodeRequired<InlineComponentsSchemasBaseReasoningSummaryPartAddedEventPropertiesType>(raw,
        "type")
      return ReasoningSummaryPartAddedEvent(
        itemId = itemId,
        outputIndex = outputIndex,
    ...
    override fun serialize(encoder: Encoder, `value`: ReasoningSummaryPartAddedEvent) {
      val jsonEncoder = encoder.requireJsonEncoder("ReasoningSummaryPartAddedEvent")
...
public fun reasoningSummaryPartAddedEvent(block: ReasoningSummaryPartAddedEvent.Builder.() ->
  Unit): ReasoningSummaryPartAddedEvent = ReasoningSummaryPartAddedEvent.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("ReasoningSummaryPartAddedEvent is missing required property '" + name + "'")
