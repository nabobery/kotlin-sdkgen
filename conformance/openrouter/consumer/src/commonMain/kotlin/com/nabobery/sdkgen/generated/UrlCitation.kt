...
public data class UrlCitationView(
  ...
  public val type: InlineComponentsSchemasUrlCitationPropertiesType,
...
public class UrlCitation(
  ...
  public class Builder {
    ...
    private var typeValue: InlineComponentsSchemasUrlCitationPropertiesType? = null

    public var type: InlineComponentsSchemasUrlCitationPropertiesType
  ...
  public object Serializer : KSerializer<UrlCitation> {
    ...
    override fun deserialize(decoder: Decoder): UrlCitation {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("UrlCitation must be a JSON object")
      val endIndex = json.decodeRequired<Int>(raw, "end_index")
      val startIndex = json.decodeRequired<Int>(raw, "start_index")
      val title = json.decodeRequired<String>(raw, "title")
      val type = json.decodeRequired<InlineComponentsSchemasUrlCitationPropertiesType>(raw, "type")
