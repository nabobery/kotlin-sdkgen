...
public class BulkUnassignMembersResponse(
  ...
  public object Serializer : KSerializer<BulkUnassignMembersResponse> {
    ...
    override fun deserialize(decoder: Decoder): BulkUnassignMembersResponse {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("BulkUnassignMembersResponse must be a JSON object")
...
public fun bulkUnassignMembersResponse(block: BulkUnassignMembersResponse.Builder.() ->
  Unit): BulkUnassignMembersResponse = BulkUnassignMembersResponse.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("BulkUnassignMembersResponse is missing required property '" + name + "'")
