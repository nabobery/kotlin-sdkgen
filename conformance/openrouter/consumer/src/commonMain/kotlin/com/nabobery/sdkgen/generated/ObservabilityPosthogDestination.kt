...
/**
 * Generated model for sdkgen://source/openapi.yaml#/components/schemas/ObservabilityPosthogDestination.
 */
@Serializable(with = ObservabilityPosthogDestination.Serializer::class)
public class ObservabilityPosthogDestination(
  /**
  ...
  public class Builder {
    private var configValue: InlineComponentsSchemasObservabilityPosthogDestinationPropertiesConfig?
        = null

    public var config: InlineComponentsSchemasObservabilityPosthogDestinationPropertiesConfig
    ...
    private var typeValue: InlineComponentsSchemasObservabilityPosthogDestinationPropertiesType? =
        null

    public var type: InlineComponentsSchemasObservabilityPosthogDestinationPropertiesType
    ...
    public fun build(): ObservabilityPosthogDestination {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): ObservabilityPosthogDestination = Builder().apply(block).build()
  }

  public object Serializer : KSerializer<ObservabilityPosthogDestination> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): ObservabilityPosthogDestination {
      val jsonDecoder = decoder.requireJsonDecoder("ObservabilityPosthogDestination")
      val json = jsonDecoder.json
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("ObservabilityPosthogDestination must be a JSON object")
      val config = json.decodeRequired<InlineComponentsSchemasObservabilityPosthogDestinationPropertiesConfig>(raw,
        "config")
      ...
      val type = json.decodeRequired<InlineComponentsSchemasObservabilityPosthogDestinationPropertiesType>(raw, "type")
      ...
      if (!raw.containsKey("api_key_hashes")) {
        throw SerializationException("ObservabilityPosthogDestination is missing required property 'api_key_hashes'")
      }
      ...
      if (!raw.containsKey("filter_rules")) {
        throw SerializationException("ObservabilityPosthogDestination is missing required property 'filter_rules'")
      }
      ...
      if (!raw.containsKey("name")) {
        throw SerializationException("ObservabilityPosthogDestination is missing required property 'name'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: ObservabilityPosthogDestination) {
      val jsonEncoder = encoder.requireJsonEncoder("ObservabilityPosthogDestination")
...
public fun observabilityPosthogDestination(block: ObservabilityPosthogDestination.Builder.() ->
  Unit): ObservabilityPosthogDestination = ObservabilityPosthogDestination.build(block)
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("ObservabilityPosthogDestination property '" + name +
      "' is not nullable")
