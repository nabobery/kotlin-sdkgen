...
public class UnifiedBenchmarkPricing(
  ...
  public object Serializer : KSerializer<UnifiedBenchmarkPricing> {
    ...
    override fun deserialize(decoder: Decoder): UnifiedBenchmarkPricing {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("UnifiedBenchmarkPricing must be a JSON object")
...
public fun unifiedBenchmarkPricing(block: UnifiedBenchmarkPricing.Builder.() -> Unit): UnifiedBenchmarkPricing =
  UnifiedBenchmarkPricing.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("UnifiedBenchmarkPricing is missing required property '" +
    name + "'")
