...
public class AnthropicServerToolUsage(
  ...
  public object Serializer : KSerializer<AnthropicServerToolUsage> {
    ...
    override fun deserialize(decoder: Decoder): AnthropicServerToolUsage {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("AnthropicServerToolUsage must be a JSON object")
...
public fun anthropicServerToolUsage(block: AnthropicServerToolUsage.Builder.() -> Unit): AnthropicServerToolUsage =
  AnthropicServerToolUsage.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("AnthropicServerToolUsage is missing required property '" +
    name + "'")
