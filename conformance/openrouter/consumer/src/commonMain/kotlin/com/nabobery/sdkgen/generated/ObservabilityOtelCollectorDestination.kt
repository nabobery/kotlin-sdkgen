...
/**
 * Generated model for sdkgen://source/openapi.yaml#/components/schemas/ObservabilityOtelCollectorDestination.
 */
@Serializable(with = ObservabilityOtelCollectorDestination.Serializer::class)
public class ObservabilityOtelCollectorDestination(
  /**
  ...
  public class Builder {
    private var configValue:
        InlineComponentsSchemasObservabilityOtelCollectorDestinationPropertiesConfig? = null

    public var config: InlineComponentsSchemasObservabilityOtelCollectorDestinationPropertiesConfig
    ...
    private var typeValue:
        InlineComponentsSchemasObservabilityOtelCollectorDestinationPropertiesType? = null

    public var type: InlineComponentsSchemasObservabilityOtelCollectorDestinationPropertiesType
    ...
    public fun build(): ObservabilityOtelCollectorDestination {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): ObservabilityOtelCollectorDestination = Builder().apply(block).build()
  }

  public object Serializer : KSerializer<ObservabilityOtelCollectorDestination> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): ObservabilityOtelCollectorDestination {
      val jsonDecoder = decoder.requireJsonDecoder("ObservabilityOtelCollectorDestination")
      val json = jsonDecoder.json
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("ObservabilityOtelCollectorDestination must be a JSON object")
      val config = json
        .decodeRequired<InlineComponentsSchemasObservabilityOtelCollectorDestinationPropertiesConfig>(raw, "config")
      ...
      val type = json.decodeRequired<InlineComponentsSchemasObservabilityOtelCollectorDestinationPropertiesType>(raw,
        "type")
      ...
      if (!raw.containsKey("api_key_hashes")) {
        throw SerializationException("ObservabilityOtelCollectorDestination is missing required property " +
          "'api_key_hashes'")
      }
      ...
      if (!raw.containsKey("name")) {
        throw SerializationException("ObservabilityOtelCollectorDestination is missing required property 'name'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: ObservabilityOtelCollectorDestination) {
      val jsonEncoder = encoder.requireJsonEncoder("ObservabilityOtelCollectorDestination")
...
public fun observabilityOtelCollectorDestination(block: ObservabilityOtelCollectorDestination.Builder.() ->
  Unit): ObservabilityOtelCollectorDestination = ObservabilityOtelCollectorDestination.build(block)
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("ObservabilityOtelCollectorDestination property '" + name +
      "' is not nullable")
