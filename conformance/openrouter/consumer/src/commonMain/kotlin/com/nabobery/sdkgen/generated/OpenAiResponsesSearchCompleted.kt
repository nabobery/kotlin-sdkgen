...
public class OpenAiResponsesSearchCompleted(
  ...
  public object Serializer : KSerializer<OpenAiResponsesSearchCompleted> {
    ...
    override fun deserialize(decoder: Decoder): OpenAiResponsesSearchCompleted {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("OpenAiResponsesSearchCompleted must be a JSON object")
...
public fun openAiResponsesSearchCompleted(block: OpenAiResponsesSearchCompleted.Builder.() ->
  Unit): OpenAiResponsesSearchCompleted = OpenAiResponsesSearchCompleted.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("OpenAiResponsesSearchCompleted is missing required property '" + name + "'")
