...
public class ChatFormatJsonSchemaConfig(
  ...
  public class Builder {
    ...
    private var typeValue: InlineComponentsSchemasChatFormatJsonSchemaConfigPropertiesType? = null

    public var type: InlineComponentsSchemasChatFormatJsonSchemaConfigPropertiesType
  ...
  public object Serializer : KSerializer<ChatFormatJsonSchemaConfig> {
    ...
    override fun deserialize(decoder: Decoder): ChatFormatJsonSchemaConfig {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("ChatFormatJsonSchemaConfig must be a JSON object")
      val jsonSchema = json.decodeRequired<ChatJsonSchemaConfig>(raw, "json_schema")
      val type = json.decodeRequired<InlineComponentsSchemasChatFormatJsonSchemaConfigPropertiesType>(raw, "type")
      return ChatFormatJsonSchemaConfig(
        jsonSchema = jsonSchema,
        type = type,
      )
...
public fun chatFormatJsonSchemaConfig(block: ChatFormatJsonSchemaConfig.Builder.() ->
  Unit): ChatFormatJsonSchemaConfig = ChatFormatJsonSchemaConfig.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("ChatFormatJsonSchemaConfig is missing required property '" +
    name + "'")
