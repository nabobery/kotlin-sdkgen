...
public class IncompleteDetails(
  public val reason: InlineComponentsSchemasIncompleteDetailsPropertiesReason? = null,
) {
  public class Builder {
    public var reason: InlineComponentsSchemasIncompleteDetailsPropertiesReason? = null
  ...
  public object Serializer : KSerializer<IncompleteDetails> {
    ...
    override fun deserialize(decoder: Decoder): IncompleteDetails {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("IncompleteDetails must be a JSON object")
      return IncompleteDetails(
        reason = raw["reason"]?.let { json
          .decodeFromJsonElement<InlineComponentsSchemasIncompleteDetailsPropertiesReason>(it) },
      )
    }
...
public fun incompleteDetails(block: IncompleteDetails.Builder.() -> Unit): IncompleteDetails = IncompleteDetails
  .build(block)
