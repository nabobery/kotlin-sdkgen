...
public class ChatContentVideo(
  ...
  public class Builder {
    private var typeValue: InlineComponentsSchemasChatContentVideoPropertiesType? = null

    public var type: InlineComponentsSchemasChatContentVideoPropertiesType
  ...
  public object Serializer : KSerializer<ChatContentVideo> {
    ...
    override fun deserialize(decoder: Decoder): ChatContentVideo {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("ChatContentVideo must be a JSON object")
      val type = json.decodeRequired<InlineComponentsSchemasChatContentVideoPropertiesType>(raw, "type")
      val videoUrl = json.decodeRequired<ChatContentVideoInput>(raw, "video_url")
      return ChatContentVideo(
        type = type,
        videoUrl = videoUrl,
      )
...
public fun chatContentVideo(block: ChatContentVideo.Builder.() -> Unit): ChatContentVideo = ChatContentVideo
  .build(block)
