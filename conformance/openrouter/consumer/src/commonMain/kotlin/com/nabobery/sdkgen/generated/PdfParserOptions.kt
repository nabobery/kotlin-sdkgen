...
public class PdfParserOptions(
  ...
  public object Serializer : KSerializer<PdfParserOptions> {
    ...
    override fun deserialize(decoder: Decoder): PdfParserOptions {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("PdfParserOptions must be a JSON object")
      return PdfParserOptions(
        engine = raw["engine"]?.let { json.decodeFromJsonElement<PdfParserEngine>(it) },
      )
    }
...
public fun pdfParserOptions(block: PdfParserOptions.Builder.() -> Unit): PdfParserOptions = PdfParserOptions
  .build(block)
