...
public class AnthropicTextEditorCodeExecutionViewResult(
  ...
  public val type: InlineComponentsSchemasAnthropicTextEditorCodeExecutionViewResultPropertiesType,
) {
  public class Builder {
    ...
    private var fileTypeValue:
        InlineComponentsSchemasAnthropicTextEditorCodeExecutionViewResultPropertiesFileType? = null
    ...
    private var typeValue:
        InlineComponentsSchemasAnthropicTextEditorCodeExecutionViewResultPropertiesType? = null

    public var type: InlineComponentsSchemasAnthropicTextEditorCodeExecutionViewResultPropertiesType
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): AnthropicTextEditorCodeExecutionViewResult = Builder().apply(block)
      .build()
  }

  public object Serializer : KSerializer<AnthropicTextEditorCodeExecutionViewResult> {
    ...
    override fun deserialize(decoder: Decoder): AnthropicTextEditorCodeExecutionViewResult {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("AnthropicTextEditorCodeExecutionViewResult must be a JSON object")
      val content = json.decodeRequired<String>(raw, "content")
      val fileType = json
        .decodeRequired<InlineComponentsSchemasAnthropicTextEditorCodeExecutionViewResultPropertiesFileType>(raw,
          "file_type")
      val type = json
        .decodeRequired<InlineComponentsSchemasAnthropicTextEditorCodeExecutionViewResultPropertiesType>(raw, "type")
      if (!raw.containsKey("num_lines")) {
        throw SerializationException("AnthropicTextEditorCodeExecutionViewResult is missing required property " +
          "'num_lines'")
      }
      val numLines = raw["num_lines"].let { element -> if (element == JsonNull) null else json
        .decodeFromJsonElement<Int?>(requireNotNull(element)) }
      if (!raw.containsKey("start_line")) {
        throw SerializationException("AnthropicTextEditorCodeExecutionViewResult is missing required property " +
          "'start_line'")
      }
      val startLine = raw["start_line"].let { element -> if (element == JsonNull) null else json
        .decodeFromJsonElement<Int?>(requireNotNull(element)) }
      if (!raw.containsKey("total_lines")) {
        throw SerializationException("AnthropicTextEditorCodeExecutionViewResult is missing required property " +
          "'total_lines'")
      }
      val totalLines = raw["total_lines"].let { element -> if (element == JsonNull) null else json
        .decodeFromJsonElement<Int?>(requireNotNull(element)) }
      return AnthropicTextEditorCodeExecutionViewResult(
        content = content,
        fileType = fileType,
...
public fun anthropicTextEditorCodeExecutionViewResult(block: AnthropicTextEditorCodeExecutionViewResult.Builder.() ->
  Unit): AnthropicTextEditorCodeExecutionViewResult = AnthropicTextEditorCodeExecutionViewResult.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("AnthropicTextEditorCodeExecutionViewResult is missing required property '" + name +
      "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("AnthropicTextEditorCodeExecutionViewResult property '" + name +
      "' is not nullable")
