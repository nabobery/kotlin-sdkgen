...
public class MultimodalMedia(
  ...
  public object Serializer : KSerializer<MultimodalMedia> {
    ...
    override fun deserialize(decoder: Decoder): MultimodalMedia {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("MultimodalMedia must be a JSON object")
      val data = json.decodeRequired<String>(raw, "data")
      return MultimodalMedia(
        data = data,
        format = raw["format"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }
