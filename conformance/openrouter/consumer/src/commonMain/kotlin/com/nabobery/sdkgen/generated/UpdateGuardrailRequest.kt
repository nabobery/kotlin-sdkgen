...
public class UpdateGuardrailRequest internal constructor(
  ...
  public class Builder {
    ...
    public var allowedProviders: List<String>?
      get() = allowedProvidersState.valueOrNull()
      set(`value`) {
        allowedProvidersState = value.toNullableFieldState()
      }
    ...
    public var contentFilterBuiltins: List<ContentFilterBuiltinEntryInput>?
      get() = contentFilterBuiltinsState.valueOrNull()
      set(`value`) {
        contentFilterBuiltinsState = value.toNullableFieldState()
      }
    ...
    public var contentFilters: List<ContentFilterEntry>?
      get() = contentFiltersState.valueOrNull()
      set(`value`) {
        contentFiltersState = value.toNullableFieldState()
      }
    ...
    public var ignoredModels: List<String>?
      get() = ignoredModelsState.valueOrNull()
      set(`value`) {
        ignoredModelsState = value.toNullableFieldState()
      }
    ...
    public var ignoredProviders: List<String>?
      get() = ignoredProvidersState.valueOrNull()
      set(`value`) {
        ignoredProvidersState = value.toNullableFieldState()
      }
  ...
  public object Serializer : KSerializer<UpdateGuardrailRequest> {
    ...
    override fun deserialize(decoder: Decoder): UpdateGuardrailRequest {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("UpdateGuardrailRequest must be a JSON object")
      return UpdateGuardrailRequest(
        allowedModelsState = json.decodeOptional(raw, "allowed_models", nullable = true),
        allowedProvidersState = json.decodeOptional(raw, "allowed_providers", nullable = true),
        contentFilterBuiltinsState = json.decodeOptional(raw, "content_filter_builtins", nullable = true),
        contentFiltersState = json.decodeOptional(raw, "content_filters", nullable = true),
        descriptionState = json.decodeOptional(raw, "description", nullable = true),
        enforceZdrState = json.decodeOptional(raw, "enforce_zdr", nullable = true),
        enforceZdrAnthropicState = json.decodeOptional(raw, "enforce_zdr_anthropic", nullable = true),
        enforceZdrGoogleState = json.decodeOptional(raw, "enforce_zdr_google", nullable = true),
        enforceZdrOpenaiState = json.decodeOptional(raw, "enforce_zdr_openai", nullable = true),
        enforceZdrOtherState = json.decodeOptional(raw, "enforce_zdr_other", nullable = true),
        enforceZdrXaiState = json.decodeOptional(raw, "enforce_zdr_xai", nullable = true),
        ignoredModelsState = json.decodeOptional(raw, "ignored_models", nullable = true),
        ignoredProvidersState = json.decodeOptional(raw, "ignored_providers", nullable = true),
        limitUsdState = json.decodeOptional(raw, "limit_usd", nullable = true),
        nameState = json.decodeOptional(raw, "name", nullable = false),
        resetIntervalState = json.decodeOptional(raw, "reset_interval", nullable = true),
      )
    }
...
public fun updateGuardrailRequest(block: UpdateGuardrailRequest.Builder.() -> Unit): UpdateGuardrailRequest =
  UpdateGuardrailRequest.build(block)
