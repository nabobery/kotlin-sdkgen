...
public class ProviderPreferences(
  ...
  public object Serializer : KSerializer<ProviderPreferences> {
    ...
    override fun deserialize(decoder: Decoder): ProviderPreferences {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("ProviderPreferences must be a JSON object")
...
public fun providerPreferences(block: ProviderPreferences.Builder.() -> Unit): ProviderPreferences =
  ProviderPreferences.build(block)
