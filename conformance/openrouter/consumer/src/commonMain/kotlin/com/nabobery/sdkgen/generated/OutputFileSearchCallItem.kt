...
public class OutputFileSearchCallItem(
  ...
  public object Serializer : KSerializer<OutputFileSearchCallItem> {
    ...
    override fun deserialize(decoder: Decoder): OutputFileSearchCallItem {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("OutputFileSearchCallItem must be a JSON object")
...
public fun outputFileSearchCallItem(block: OutputFileSearchCallItem.Builder.() -> Unit): OutputFileSearchCallItem =
  OutputFileSearchCallItem.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("OutputFileSearchCallItem is missing required property '" +
    name + "'")
