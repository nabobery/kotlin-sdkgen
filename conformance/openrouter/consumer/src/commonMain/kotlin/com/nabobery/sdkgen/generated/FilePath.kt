...
public data class FilePathView(
  ...
  public val type: InlineComponentsSchemasFilePathPropertiesType,
)
...
public class FilePath(
  ...
  public class Builder {
    ...
    private var typeValue: InlineComponentsSchemasFilePathPropertiesType? = null

    public var type: InlineComponentsSchemasFilePathPropertiesType
  ...
  public object Serializer : KSerializer<FilePath> {
    ...
    override fun deserialize(decoder: Decoder): FilePath {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("FilePath must be a JSON object")
      val fileId = json.decodeRequired<String>(raw, "file_id")
      val index = json.decodeRequired<Int>(raw, "index")
      val type = json.decodeRequired<InlineComponentsSchemasFilePathPropertiesType>(raw, "type")
      return FilePath(
        fileId = fileId,
        index = index,
        type = type,
