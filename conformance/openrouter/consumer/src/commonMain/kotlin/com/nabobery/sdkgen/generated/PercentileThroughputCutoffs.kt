...
public class PercentileThroughputCutoffs(
  ...
  public object Serializer : KSerializer<PercentileThroughputCutoffs> {
    ...
    override fun deserialize(decoder: Decoder): PercentileThroughputCutoffs {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("PercentileThroughputCutoffs must be a JSON object")
...
public fun percentileThroughputCutoffs(block: PercentileThroughputCutoffs.Builder.() ->
  Unit): PercentileThroughputCutoffs = PercentileThroughputCutoffs.build(block)
