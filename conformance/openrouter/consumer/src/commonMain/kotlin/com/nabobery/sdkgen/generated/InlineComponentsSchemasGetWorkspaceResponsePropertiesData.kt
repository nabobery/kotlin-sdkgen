 ...
 */
@Serializable(with = InlineComponentsSchemasGetWorkspaceResponsePropertiesData.Serializer::class)
public class InlineComponentsSchemasGetWorkspaceResponsePropertiesData(
  /**
  ...
  public class Builder {
    ...
    public fun build(): InlineComponentsSchemasGetWorkspaceResponsePropertiesData {
      ...
      return InlineComponentsSchemasGetWorkspaceResponsePropertiesData(
        createdAt = createdAt,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineComponentsSchemasGetWorkspaceResponsePropertiesData = Builder()
      .apply(block).build()
  }

  public object Serializer : KSerializer<InlineComponentsSchemasGetWorkspaceResponsePropertiesData> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineComponentsSchemasGetWorkspaceResponsePropertiesData {
      val jsonDecoder = decoder.requireJsonDecoder("InlineComponentsSchemasGetWorkspaceResponsePropertiesData")
      val json = jsonDecoder.json
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("InlineComponentsSchemasGetWorkspaceResponsePropertiesData must be a JSON object")
      ...
      if (!raw.containsKey("created_by")) {
        throw SerializationException("InlineComponentsSchemasGetWorkspaceResponsePropertiesData is missing required " +
          "property 'created_by'")
      }
      ...
      if (!raw.containsKey("default_provider_sort")) {
        throw SerializationException("InlineComponentsSchemasGetWorkspaceResponsePropertiesData is missing required " +
          "property 'default_provider_sort'")
      }
      ...
      if (!raw.containsKey("io_logging_api_key_ids")) {
        throw SerializationException("InlineComponentsSchemasGetWorkspaceResponsePropertiesData is missing required " +
          "property 'io_logging_api_key_ids'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineComponentsSchemasGetWorkspaceResponsePropertiesData) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineComponentsSchemasGetWorkspaceResponsePropertiesData")
...
public fun inlineComponentsSchemasGetWorkspaceResponsePropertiesData(block: InlineComponentsSchemasGetWorkspaceResponsePropertiesData.Builder.() -> Unit): InlineComponentsSchemasGetWorkspaceResponsePropertiesData = InlineComponentsSchemasGetWorkspaceResponsePropertiesData.build(block)
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineComponentsSchemasGetWorkspaceResponsePropertiesData property " +
