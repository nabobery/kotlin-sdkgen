...
public class ReasoningSummaryText(
  ...
  public val type: InlineComponentsSchemasReasoningSummaryTextPropertiesType,
) {
  public class Builder {
    ...
    private var typeValue: InlineComponentsSchemasReasoningSummaryTextPropertiesType? = null

    public var type: InlineComponentsSchemasReasoningSummaryTextPropertiesType
  ...
  public object Serializer : KSerializer<ReasoningSummaryText> {
    ...
    override fun deserialize(decoder: Decoder): ReasoningSummaryText {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("ReasoningSummaryText must be a JSON object")
      val text = json.decodeRequired<String>(raw, "text")
      val type = json.decodeRequired<InlineComponentsSchemasReasoningSummaryTextPropertiesType>(raw, "type")
      return ReasoningSummaryText(
        text = text,
        type = type,
      )
...
public fun reasoningSummaryText(block: ReasoningSummaryText.Builder.() -> Unit): ReasoningSummaryText =
  ReasoningSummaryText.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("ReasoningSummaryText is missing required property '" +
    name + "'")
