...
public class WebSearchUserLocation(
  ...
  public object Serializer : KSerializer<WebSearchUserLocation> {
    ...
    override fun deserialize(decoder: Decoder): WebSearchUserLocation {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("WebSearchUserLocation must be a JSON object")
...
public fun webSearchUserLocation(block: WebSearchUserLocation.Builder.() -> Unit): WebSearchUserLocation =
  WebSearchUserLocation.build(block)
