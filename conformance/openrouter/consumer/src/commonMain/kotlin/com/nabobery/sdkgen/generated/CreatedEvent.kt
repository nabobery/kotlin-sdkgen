...
public class CreatedEvent(
  ...
  public val type: InlineComponentsSchemasCreatedEventPropertiesType,
) {
  public class Builder {
    ...
    private var typeValue: InlineComponentsSchemasCreatedEventPropertiesType? = null

    public var type: InlineComponentsSchemasCreatedEventPropertiesType
  ...
  public object Serializer : KSerializer<CreatedEvent> {
    ...
    override fun deserialize(decoder: Decoder): CreatedEvent {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("CreatedEvent must be a JSON object")
      ...
      val type = json.decodeRequired<InlineComponentsSchemasCreatedEventPropertiesType>(raw, "type")
      return CreatedEvent(
        response = response,
        sequenceNumber = sequenceNumber,
        type = type,
