 ...
 */
@Serializable(with = PresetWithDesignatedVersion.Serializer::class)
public class PresetWithDesignatedVersion(
  ...
  public class Builder {
    ...
    public fun build(): PresetWithDesignatedVersion {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): PresetWithDesignatedVersion = Builder().apply(block).build()
  }

  public object Serializer : KSerializer<PresetWithDesignatedVersion> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): PresetWithDesignatedVersion {
      val jsonDecoder = decoder.requireJsonDecoder("PresetWithDesignatedVersion")
      val json = jsonDecoder.json
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("PresetWithDesignatedVersion must be a JSON object")
      ...
      val status = json.decodeRequired<PresetStatus>(raw, "status")
      val updatedAt = json.decodeRequired<String>(raw, "updated_at")
      if (!raw.containsKey("creator_user_id")) {
        throw SerializationException("PresetWithDesignatedVersion is missing required property 'creator_user_id'")
      }
      ...
      if (!raw.containsKey("description")) {
        throw SerializationException("PresetWithDesignatedVersion is missing required property 'description'")
      }
      val description = raw["description"].let { element -> if (element == JsonNull) null else json
        .decodeFromJsonElement<String?>(requireNotNull(element)) }
      if (!raw.containsKey("designated_version")) {
        throw SerializationException("PresetWithDesignatedVersion is missing required property 'designated_version'")
      }
      ...
      if (!raw.containsKey("designated_version_id")) {
        throw SerializationException("PresetWithDesignatedVersion is missing required property 'designated_version_id'")
      }
      val designatedVersionId = raw["designated_version_id"].let { element -> if (element == JsonNull) null else json
        .decodeFromJsonElement<String?>(requireNotNull(element)) }
      if (!raw.containsKey("status_updated_at")) {
        throw SerializationException("PresetWithDesignatedVersion is missing required property 'status_updated_at'")
      }
      val statusUpdatedAt = raw["status_updated_at"].let { element -> if (element == JsonNull) null else json
        .decodeFromJsonElement<String?>(requireNotNull(element)) }
      if (!raw.containsKey("workspace_id")) {
        throw SerializationException("PresetWithDesignatedVersion is missing required property 'workspace_id'")
      }
      val workspaceId = raw["workspace_id"].let { element -> if (element == JsonNull) null else json
        .decodeFromJsonElement<String?>(requireNotNull(element)) }
      return PresetWithDesignatedVersion(
        createdAt = createdAt,
    ...
    override fun serialize(encoder: Encoder, `value`: PresetWithDesignatedVersion) {
      val jsonEncoder = encoder.requireJsonEncoder("PresetWithDesignatedVersion")
...
public fun presetWithDesignatedVersion(block: PresetWithDesignatedVersion.Builder.() ->
  Unit): PresetWithDesignatedVersion = PresetWithDesignatedVersion.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("PresetWithDesignatedVersion is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("PresetWithDesignatedVersion property '" + name + "' is not nullable")
