...
public class LocalShellCallOutputItem(
  ...
  public val type: InlineComponentsSchemasLocalShellCallOutputItemPropertiesType,
  ...
  public class Builder {
    ...
    private var typeValue: InlineComponentsSchemasLocalShellCallOutputItemPropertiesType? = null

    public var type: InlineComponentsSchemasLocalShellCallOutputItemPropertiesType
  ...
  public object Serializer : KSerializer<LocalShellCallOutputItem> {
    ...
    override fun deserialize(decoder: Decoder): LocalShellCallOutputItem {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("LocalShellCallOutputItem must be a JSON object")
      val id = json.decodeRequired<String>(raw, "id")
      val output = json.decodeRequired<String>(raw, "output")
      val type = json.decodeRequired<InlineComponentsSchemasLocalShellCallOutputItemPropertiesType>(raw, "type")
      return LocalShellCallOutputItem(
        id = id,
        output = output,
        type = type,
...
public fun localShellCallOutputItem(block: LocalShellCallOutputItem.Builder.() -> Unit): LocalShellCallOutputItem =
  LocalShellCallOutputItem.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("LocalShellCallOutputItem is missing required property '" +
    name + "'")
