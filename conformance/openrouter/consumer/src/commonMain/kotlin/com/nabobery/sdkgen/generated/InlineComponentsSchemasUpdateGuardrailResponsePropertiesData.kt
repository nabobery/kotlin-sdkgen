...
/**
 * Generated model for sdkgen://source/openapi.yaml#/components/schemas/UpdateGuardrailResponse/properties/data.
 */
@Serializable(with = InlineComponentsSchemasUpdateGuardrailResponsePropertiesData.Serializer::class)
public class InlineComponentsSchemasUpdateGuardrailResponsePropertiesData(
  /**
  ...
  public class Builder {
    ...
    public fun build(): InlineComponentsSchemasUpdateGuardrailResponsePropertiesData {
      check(createdAtValue != null) { "createdAt is required" }
      check(idValue != null) { "id is required" }
      check(nameValue != null) { "name is required" }
      check(workspaceIdValue != null) { "workspaceId is required" }
      return InlineComponentsSchemasUpdateGuardrailResponsePropertiesData(
        createdAt = createdAt,
        id = id,
        name = name,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineComponentsSchemasUpdateGuardrailResponsePropertiesData =
      Builder().apply(block).build()
  }

  public object Serializer : KSerializer<InlineComponentsSchemasUpdateGuardrailResponsePropertiesData> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineComponentsSchemasUpdateGuardrailResponsePropertiesData {
      val jsonDecoder = decoder.requireJsonDecoder("InlineComponentsSchemasUpdateGuardrailResponsePropertiesData")
      val json = jsonDecoder.json
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("InlineComponentsSchemasUpdateGuardrailResponsePropertiesData must be a JSON " +
          "object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineComponentsSchemasUpdateGuardrailResponsePropertiesData) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineComponentsSchemasUpdateGuardrailResponsePropertiesData")
...
public fun inlineComponentsSchemasUpdateGuardrailResponsePropertiesData(block: InlineComponentsSchemasUpdateGuardrailResponsePropertiesData.Builder.() -> Unit): InlineComponentsSchemasUpdateGuardrailResponsePropertiesData = InlineComponentsSchemasUpdateGuardrailResponsePropertiesData.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("InlineComponentsSchemasUpdateGuardrailResponsePropertiesData is missing required " +
      "property '" + name + "'")
