...
public class MessagesContentBlockStopEvent(
  ...
  public val type: InlineComponentsSchemasMessagesContentBlockStopEventPropertiesType,
) {
  public class Builder {
    ...
    private var typeValue: InlineComponentsSchemasMessagesContentBlockStopEventPropertiesType? =
        null

    public var type: InlineComponentsSchemasMessagesContentBlockStopEventPropertiesType
  ...
  public object Serializer : KSerializer<MessagesContentBlockStopEvent> {
    ...
    override fun deserialize(decoder: Decoder): MessagesContentBlockStopEvent {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("MessagesContentBlockStopEvent must be a JSON object")
      val index = json.decodeRequired<Int>(raw, "index")
      val type = json.decodeRequired<InlineComponentsSchemasMessagesContentBlockStopEventPropertiesType>(raw, "type")
      return MessagesContentBlockStopEvent(
        index = index,
        type = type,
      )
...
public fun messagesContentBlockStopEvent(block: MessagesContentBlockStopEvent.Builder.() ->
  Unit): MessagesContentBlockStopEvent = MessagesContentBlockStopEvent.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("MessagesContentBlockStopEvent is missing required property '" + name + "'")
