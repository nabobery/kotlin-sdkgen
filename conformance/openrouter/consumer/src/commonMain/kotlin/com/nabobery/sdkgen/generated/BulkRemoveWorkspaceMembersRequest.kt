...
public class BulkRemoveWorkspaceMembersRequest(
  ...
  public class Builder {
    ...
    public var userIds: List<String>
      get() = requireNotNull(userIdsValue) { "userIds is required" }
      set(`value`) {
        userIdsValue = value
      }
  ...
  public object Serializer : KSerializer<BulkRemoveWorkspaceMembersRequest> {
    ...
    override fun deserialize(decoder: Decoder): BulkRemoveWorkspaceMembersRequest {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("BulkRemoveWorkspaceMembersRequest must be a JSON object")
      val userIds = json.decodeRequired<List<String>>(raw, "user_ids")
      return BulkRemoveWorkspaceMembersRequest(
        userIds = userIds,
      )
    }
...
public fun bulkRemoveWorkspaceMembersRequest(block: BulkRemoveWorkspaceMembersRequest.Builder.() ->
  Unit): BulkRemoveWorkspaceMembersRequest = BulkRemoveWorkspaceMembersRequest.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("BulkRemoveWorkspaceMembersRequest is missing required property '" + name + "'")
