...
public class BaseReasoningDoneEvent(
  ...
  public object Serializer : KSerializer<BaseReasoningDoneEvent> {
    ...
    override fun deserialize(decoder: Decoder): BaseReasoningDoneEvent {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("BaseReasoningDoneEvent must be a JSON object")
...
public fun baseReasoningDoneEvent(block: BaseReasoningDoneEvent.Builder.() -> Unit): BaseReasoningDoneEvent =
  BaseReasoningDoneEvent.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("BaseReasoningDoneEvent is missing required property '" +
    name + "'")
