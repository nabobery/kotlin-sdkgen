...
public class UpdateByokKeyRequest internal constructor(
  ...
  public object Serializer : KSerializer<UpdateByokKeyRequest> {
    ...
    override fun deserialize(decoder: Decoder): UpdateByokKeyRequest {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("UpdateByokKeyRequest must be a JSON object")
      return UpdateByokKeyRequest(
        allowedModelsState = json.decodeOptional(raw, "allowed_models", nullable = true),
        allowedUserIdsState = json.decodeOptional(raw, "allowed_user_ids", nullable = true),
        disabledState = json.decodeOptional(raw, "disabled", nullable = false),
        isFallbackState = json.decodeOptional(raw, "is_fallback", nullable = false),
        keyState = json.decodeOptional(raw, "key", nullable = false),
...
public fun updateByokKeyRequest(block: UpdateByokKeyRequest.Builder.() -> Unit): UpdateByokKeyRequest =
  UpdateByokKeyRequest.build(block)
