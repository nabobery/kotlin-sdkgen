...
public class FusionCallAnalysisCompletedEvent(
  ...
  public val type: InlineComponentsSchemasFusionCallAnalysisCompletedEventPropertiesType,
) {
  public class Builder {
    ...
    private var typeValue: InlineComponentsSchemasFusionCallAnalysisCompletedEventPropertiesType? =
        null

    public var type: InlineComponentsSchemasFusionCallAnalysisCompletedEventPropertiesType
  ...
  public object Serializer : KSerializer<FusionCallAnalysisCompletedEvent> {
    ...
    override fun deserialize(decoder: Decoder): FusionCallAnalysisCompletedEvent {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("FusionCallAnalysisCompletedEvent must be a JSON object")
      val analysis = json.decodeRequired<FusionAnalysisResult>(raw, "analysis")
      ...
      val type = json.decodeRequired<InlineComponentsSchemasFusionCallAnalysisCompletedEventPropertiesType>(raw, "type")
      return FusionCallAnalysisCompletedEvent(
        analysis = analysis,
        itemId = itemId,
        outputIndex = outputIndex,
...
public fun fusionCallAnalysisCompletedEvent(block: FusionCallAnalysisCompletedEvent.Builder.() ->
  Unit): FusionCallAnalysisCompletedEvent = FusionCallAnalysisCompletedEvent.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("FusionCallAnalysisCompletedEvent is missing required property '" + name + "'")
