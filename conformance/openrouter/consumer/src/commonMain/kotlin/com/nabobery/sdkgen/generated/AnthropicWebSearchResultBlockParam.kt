...
public class AnthropicWebSearchResultBlockParam(
  ...
  public val type: InlineComponentsSchemasAnthropicWebSearchResultBlockParamPropertiesType,
  ...
  public class Builder {
    ...
    private var typeValue: InlineComponentsSchemasAnthropicWebSearchResultBlockParamPropertiesType?
        = null

    public var type: InlineComponentsSchemasAnthropicWebSearchResultBlockParamPropertiesType
  ...
  public object Serializer : KSerializer<AnthropicWebSearchResultBlockParam> {
    ...
    override fun deserialize(decoder: Decoder): AnthropicWebSearchResultBlockParam {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("AnthropicWebSearchResultBlockParam must be a JSON object")
      val encryptedContent = json.decodeRequired<String>(raw, "encrypted_content")
      val title = json.decodeRequired<String>(raw, "title")
      val type = json.decodeRequired<InlineComponentsSchemasAnthropicWebSearchResultBlockParamPropertiesType>(raw,
        "type")
      ...
      return AnthropicWebSearchResultBlockParam(
        ...
        type = type,
        url = url,
        pageAge = raw["page_age"]?.let { element -> if (element == JsonNull) null else json
...
public fun anthropicWebSearchResultBlockParam(block: AnthropicWebSearchResultBlockParam.Builder.() ->
  Unit): AnthropicWebSearchResultBlockParam = AnthropicWebSearchResultBlockParam.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("AnthropicWebSearchResultBlockParam is missing required property '" + name + "'")
