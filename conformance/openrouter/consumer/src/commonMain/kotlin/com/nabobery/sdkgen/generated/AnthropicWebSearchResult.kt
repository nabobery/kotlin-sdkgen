...
public class AnthropicWebSearchResult(
  ...
  public val type: InlineComponentsSchemasAnthropicWebSearchResultPropertiesType,
  ...
  public class Builder {
    ...
    private var typeValue: InlineComponentsSchemasAnthropicWebSearchResultPropertiesType? = null

    public var type: InlineComponentsSchemasAnthropicWebSearchResultPropertiesType
  ...
  public object Serializer : KSerializer<AnthropicWebSearchResult> {
    ...
    override fun deserialize(decoder: Decoder): AnthropicWebSearchResult {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("AnthropicWebSearchResult must be a JSON object")
      val encryptedContent = json.decodeRequired<String>(raw, "encrypted_content")
      val title = json.decodeRequired<String>(raw, "title")
      val type = json.decodeRequired<InlineComponentsSchemasAnthropicWebSearchResultPropertiesType>(raw, "type")
      val url = json.decodeRequired<String>(raw, "url")
      if (!raw.containsKey("page_age")) {
        throw SerializationException("AnthropicWebSearchResult is missing required property 'page_age'")
      }
      val pageAge = raw["page_age"].let { element -> if (element == JsonNull) null else json
...
public fun anthropicWebSearchResult(block: AnthropicWebSearchResult.Builder.() -> Unit): AnthropicWebSearchResult =
  AnthropicWebSearchResult.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("AnthropicWebSearchResult is missing required property '" +
    name + "'")
