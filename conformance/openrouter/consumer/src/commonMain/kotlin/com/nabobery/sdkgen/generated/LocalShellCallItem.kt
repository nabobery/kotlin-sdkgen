...
public class LocalShellCallItem(
  public val action: InlineComponentsSchemasLocalShellCallItemPropertiesAction,
  public val callId: String,
  public val id: String,
  public val status: ToolCallStatus,
  public val type: InlineComponentsSchemasLocalShellCallItemPropertiesType,
) {
  public class Builder {
    private var actionValue: InlineComponentsSchemasLocalShellCallItemPropertiesAction? = null

    public var action: InlineComponentsSchemasLocalShellCallItemPropertiesAction
    ...
    private var typeValue: InlineComponentsSchemasLocalShellCallItemPropertiesType? = null

    public var type: InlineComponentsSchemasLocalShellCallItemPropertiesType
  ...
  public object Serializer : KSerializer<LocalShellCallItem> {
    ...
    override fun deserialize(decoder: Decoder): LocalShellCallItem {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("LocalShellCallItem must be a JSON object")
      val action = json.decodeRequired<InlineComponentsSchemasLocalShellCallItemPropertiesAction>(raw, "action")
      ...
      val type = json.decodeRequired<InlineComponentsSchemasLocalShellCallItemPropertiesType>(raw, "type")
      return LocalShellCallItem(
        action = action,
        callId = callId,
        id = id,
...
public fun localShellCallItem(block: LocalShellCallItem.Builder.() -> Unit): LocalShellCallItem = LocalShellCallItem
  .build(block)
