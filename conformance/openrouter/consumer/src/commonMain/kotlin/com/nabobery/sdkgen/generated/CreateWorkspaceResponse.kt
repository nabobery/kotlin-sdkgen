...
public class CreateWorkspaceResponse(
  ...
  public object Serializer : KSerializer<CreateWorkspaceResponse> {
    ...
    override fun deserialize(decoder: Decoder): CreateWorkspaceResponse {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("CreateWorkspaceResponse must be a JSON object")
...
public fun createWorkspaceResponse(block: CreateWorkspaceResponse.Builder.() -> Unit): CreateWorkspaceResponse =
  CreateWorkspaceResponse.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("CreateWorkspaceResponse is missing required property '" +
    name + "'")
