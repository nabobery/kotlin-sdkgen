...
public class FusionCallPanelReasoningDeltaEvent(
  ...
  public val type: InlineComponentsSchemasFusionCallPanelReasoningDeltaEventPropertiesType,
) {
  public class Builder {
    ...
    private var typeValue: InlineComponentsSchemasFusionCallPanelReasoningDeltaEventPropertiesType?
        = null

    public var type: InlineComponentsSchemasFusionCallPanelReasoningDeltaEventPropertiesType
  ...
  public object Serializer : KSerializer<FusionCallPanelReasoningDeltaEvent> {
    ...
    override fun deserialize(decoder: Decoder): FusionCallPanelReasoningDeltaEvent {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("FusionCallPanelReasoningDeltaEvent must be a JSON object")
      ...
      val type = json.decodeRequired<InlineComponentsSchemasFusionCallPanelReasoningDeltaEventPropertiesType>(raw,
        "type")
      return FusionCallPanelReasoningDeltaEvent(
        delta = delta,
        itemId = itemId,
...
public fun fusionCallPanelReasoningDeltaEvent(block: FusionCallPanelReasoningDeltaEvent.Builder.() ->
  Unit): FusionCallPanelReasoningDeltaEvent = FusionCallPanelReasoningDeltaEvent.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("FusionCallPanelReasoningDeltaEvent is missing required property '" + name + "'")
