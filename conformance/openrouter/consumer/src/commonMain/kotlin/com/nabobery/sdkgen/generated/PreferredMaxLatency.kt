...
public class PreferredMaxLatency internal constructor(
  ...
  public val percentileLatencyCutoffs: PercentileLatencyCutoffs? by
      lazy(LazyThreadSafetyMode.NONE) { if (inspection.matchesPercentileLatencyCutoffs) json
        .decodeFromJsonElement<PercentileLatencyCutoffs>(raw) else null }
  ...
  public companion object {
    ...
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): PreferredMaxLatency {
      ...
      if (inspection.matchCount == 0) {
        throw PreferredMaxLatencyNoMatchException("PreferredMaxLatency matched 0 branches: " + inspection.failures
          .joinToString("; "))
      }
  ...
  public object Serializer : KSerializer<PreferredMaxLatency> {
...
private fun inspectPreferredMaxLatency(element: JsonElement): PreferredMaxLatencyInspection {
  ...
  return PreferredMaxLatencyInspection(
    ...
    failures = buildList {
      ...
      if (!matchesPercentileLatencyCutoffs) add("PercentileLatencyCutoffs: value does not match " +
        "PercentileLatencyCutoffs")
