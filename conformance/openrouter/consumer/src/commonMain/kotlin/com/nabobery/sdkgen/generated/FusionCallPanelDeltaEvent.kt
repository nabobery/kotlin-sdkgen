...
public class FusionCallPanelDeltaEvent(
  ...
  public val type: InlineComponentsSchemasFusionCallPanelDeltaEventPropertiesType,
) {
  public class Builder {
    ...
    private var typeValue: InlineComponentsSchemasFusionCallPanelDeltaEventPropertiesType? = null

    public var type: InlineComponentsSchemasFusionCallPanelDeltaEventPropertiesType
  ...
  public object Serializer : KSerializer<FusionCallPanelDeltaEvent> {
    ...
    override fun deserialize(decoder: Decoder): FusionCallPanelDeltaEvent {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("FusionCallPanelDeltaEvent must be a JSON object")
      ...
      val type = json.decodeRequired<InlineComponentsSchemasFusionCallPanelDeltaEventPropertiesType>(raw, "type")
      return FusionCallPanelDeltaEvent(
        delta = delta,
        itemId = itemId,
        model = model,
...
public fun fusionCallPanelDeltaEvent(block: FusionCallPanelDeltaEvent.Builder.() -> Unit): FusionCallPanelDeltaEvent =
  FusionCallPanelDeltaEvent.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("FusionCallPanelDeltaEvent is missing required property '" +
    name + "'")
