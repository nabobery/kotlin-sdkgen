...
public class AnthropicInputTokensTrigger(
  ...
  public object Serializer : KSerializer<AnthropicInputTokensTrigger> {
    ...
    override fun deserialize(decoder: Decoder): AnthropicInputTokensTrigger {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("AnthropicInputTokensTrigger must be a JSON object")
...
public fun anthropicInputTokensTrigger(block: AnthropicInputTokensTrigger.Builder.() ->
  Unit): AnthropicInputTokensTrigger = AnthropicInputTokensTrigger.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("AnthropicInputTokensTrigger is missing required property '" + name + "'")
