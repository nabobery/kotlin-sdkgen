...
public class AppRankingsResponse(
  ...
  public object Serializer : KSerializer<AppRankingsResponse> {
    ...
    override fun deserialize(decoder: Decoder): AppRankingsResponse {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("AppRankingsResponse must be a JSON object")
      val data = json.decodeRequired<List<AppRankingsItem>>(raw, "data")
...
public fun appRankingsResponse(block: AppRankingsResponse.Builder.() -> Unit): AppRankingsResponse =
  AppRankingsResponse.build(block)
