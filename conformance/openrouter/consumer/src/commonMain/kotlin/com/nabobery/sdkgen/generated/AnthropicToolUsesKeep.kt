...
public class AnthropicToolUsesKeep(
  public val type: InlineComponentsSchemasAnthropicToolUsesKeepPropertiesType,
  public val `value`: Int,
) {
  public class Builder {
    private var typeValue: InlineComponentsSchemasAnthropicToolUsesKeepPropertiesType? = null

    public var type: InlineComponentsSchemasAnthropicToolUsesKeepPropertiesType
  ...
  public object Serializer : KSerializer<AnthropicToolUsesKeep> {
    ...
    override fun deserialize(decoder: Decoder): AnthropicToolUsesKeep {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("AnthropicToolUsesKeep must be a JSON object")
      val type = json.decodeRequired<InlineComponentsSchemasAnthropicToolUsesKeepPropertiesType>(raw, "type")
...
public fun anthropicToolUsesKeep(block: AnthropicToolUsesKeep.Builder.() -> Unit): AnthropicToolUsesKeep =
  AnthropicToolUsesKeep.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("AnthropicToolUsesKeep is missing required property '" +
    name + "'")
