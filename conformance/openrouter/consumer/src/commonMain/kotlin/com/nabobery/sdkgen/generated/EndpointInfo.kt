...
public class EndpointInfo(
  ...
  public object Serializer : KSerializer<EndpointInfo> {
    ...
    override fun deserialize(decoder: Decoder): EndpointInfo {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("EndpointInfo must be a JSON object")
      val model = json.decodeRequired<String>(raw, "model")
      val provider = json.decodeRequired<String>(raw, "provider")
      val selected = json.decodeRequired<Boolean>(raw, "selected")
      return EndpointInfo(
        model = model,
        provider = provider,
        selected = selected,
