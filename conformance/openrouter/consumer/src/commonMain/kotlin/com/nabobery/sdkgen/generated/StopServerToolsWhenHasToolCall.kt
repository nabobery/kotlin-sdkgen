...
public class StopServerToolsWhenHasToolCall(
  ...
  public class Builder {
    ...
    private var typeValue: InlineComponentsSchemasStopServerToolsWhenHasToolCallPropertiesType? =
        null

    public var type: InlineComponentsSchemasStopServerToolsWhenHasToolCallPropertiesType
  ...
  public object Serializer : KSerializer<StopServerToolsWhenHasToolCall> {
    ...
    override fun deserialize(decoder: Decoder): StopServerToolsWhenHasToolCall {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("StopServerToolsWhenHasToolCall must be a JSON object")
      val toolName = json.decodeRequired<String>(raw, "tool_name")
      val type = json.decodeRequired<InlineComponentsSchemasStopServerToolsWhenHasToolCallPropertiesType>(raw, "type")
      return StopServerToolsWhenHasToolCall(
        toolName = toolName,
        type = type,
      )
...
public fun stopServerToolsWhenHasToolCall(block: StopServerToolsWhenHasToolCall.Builder.() ->
  Unit): StopServerToolsWhenHasToolCall = StopServerToolsWhenHasToolCall.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("StopServerToolsWhenHasToolCall is missing required property '" + name + "'")
