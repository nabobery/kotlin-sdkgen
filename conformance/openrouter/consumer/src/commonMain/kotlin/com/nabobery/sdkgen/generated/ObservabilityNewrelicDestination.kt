...
/**
 * Generated model for sdkgen://source/openapi.yaml#/components/schemas/ObservabilityNewrelicDestination.
 */
@Serializable(with = ObservabilityNewrelicDestination.Serializer::class)
public class ObservabilityNewrelicDestination(
  /**
  ...
  public class Builder {
    private var configValue:
        InlineComponentsSchemasObservabilityNewrelicDestinationPropertiesConfig? = null

    public var config: InlineComponentsSchemasObservabilityNewrelicDestinationPropertiesConfig
    ...
    private var typeValue: InlineComponentsSchemasObservabilityNewrelicDestinationPropertiesType? =
        null

    public var type: InlineComponentsSchemasObservabilityNewrelicDestinationPropertiesType
    ...
    public fun build(): ObservabilityNewrelicDestination {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): ObservabilityNewrelicDestination = Builder().apply(block).build()
  }

  public object Serializer : KSerializer<ObservabilityNewrelicDestination> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): ObservabilityNewrelicDestination {
      val jsonDecoder = decoder.requireJsonDecoder("ObservabilityNewrelicDestination")
      val json = jsonDecoder.json
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("ObservabilityNewrelicDestination must be a JSON object")
      val config = json.decodeRequired<InlineComponentsSchemasObservabilityNewrelicDestinationPropertiesConfig>(raw,
        "config")
      ...
      val type = json.decodeRequired<InlineComponentsSchemasObservabilityNewrelicDestinationPropertiesType>(raw, "type")
      ...
      if (!raw.containsKey("api_key_hashes")) {
        throw SerializationException("ObservabilityNewrelicDestination is missing required property 'api_key_hashes'")
      }
      ...
      if (!raw.containsKey("filter_rules")) {
        throw SerializationException("ObservabilityNewrelicDestination is missing required property 'filter_rules'")
      }
      ...
      if (!raw.containsKey("name")) {
        throw SerializationException("ObservabilityNewrelicDestination is missing required property 'name'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: ObservabilityNewrelicDestination) {
      val jsonEncoder = encoder.requireJsonEncoder("ObservabilityNewrelicDestination")
...
public fun observabilityNewrelicDestination(block: ObservabilityNewrelicDestination.Builder.() ->
  Unit): ObservabilityNewrelicDestination = ObservabilityNewrelicDestination.build(block)
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("ObservabilityNewrelicDestination property '" + name +
      "' is not nullable")
