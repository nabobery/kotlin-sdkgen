...
public class OutputItemApplyPatchCall(
  ...
  public class Builder {
    ...
    private var operationValue: InlineComponentsSchemasOutputItemApplyPatchCallPropertiesOperation?
        = null

    public var operation: InlineComponentsSchemasOutputItemApplyPatchCallPropertiesOperation
      get() = requireNotNull(operationValue) { "operation is required" }
      set(`value`) {
        operationValue = value
      }

    private var statusValue: InlineComponentsSchemasOutputItemApplyPatchCallPropertiesStatus? = null

    public var status: InlineComponentsSchemasOutputItemApplyPatchCallPropertiesStatus
      get() = requireNotNull(statusValue) { "status is required" }
      set(`value`) {
        statusValue = value
      }

    private var typeValue: InlineComponentsSchemasOutputItemApplyPatchCallPropertiesType? = null

    public var type: InlineComponentsSchemasOutputItemApplyPatchCallPropertiesType
  ...
  public object Serializer : KSerializer<OutputItemApplyPatchCall> {
    ...
    override fun deserialize(decoder: Decoder): OutputItemApplyPatchCall {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("OutputItemApplyPatchCall must be a JSON object")
      val callId = json.decodeRequired<String>(raw, "call_id")
      val id = json.decodeRequired<String>(raw, "id")
      val operation = json.decodeRequired<InlineComponentsSchemasOutputItemApplyPatchCallPropertiesOperation>(raw,
        "operation")
      val status = json.decodeRequired<InlineComponentsSchemasOutputItemApplyPatchCallPropertiesStatus>(raw, "status")
      val type = json.decodeRequired<InlineComponentsSchemasOutputItemApplyPatchCallPropertiesType>(raw, "type")
      return OutputItemApplyPatchCall(
        callId = callId,
        id = id,
        operation = operation,
        status = status,
        type = type,
        createdBy = raw["created_by"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }
...
public fun outputItemApplyPatchCall(block: OutputItemApplyPatchCall.Builder.() -> Unit): OutputItemApplyPatchCall =
  OutputItemApplyPatchCall.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("OutputItemApplyPatchCall is missing required property '" +
    name + "'")
