...
public class EnumCapability(
  ...
  public class Builder {
    private var typeValue: InlineComponentsSchemasEnumCapabilityPropertiesType? = null

    public var type: InlineComponentsSchemasEnumCapabilityPropertiesType
  ...
  public object Serializer : KSerializer<EnumCapability> {
    ...
    override fun deserialize(decoder: Decoder): EnumCapability {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("EnumCapability must be a JSON object")
      val type = json.decodeRequired<InlineComponentsSchemasEnumCapabilityPropertiesType>(raw, "type")
      val values = json.decodeRequired<List<String>>(raw, "values")
      return EnumCapability(
        type = type,
        values = values,
      )
