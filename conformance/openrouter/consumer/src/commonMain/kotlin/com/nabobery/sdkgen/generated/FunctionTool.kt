 ...
 */
@Serializable(with = FunctionTool.Serializer::class)
public class FunctionTool internal constructor(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): FunctionTool = Builder().apply(block).build()
  }

  public object Serializer : KSerializer<FunctionTool> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): FunctionTool {
      val jsonDecoder = decoder.requireJsonDecoder("FunctionTool")
      val json = jsonDecoder.json
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("FunctionTool must be a JSON object")
      ...
      if (!raw.containsKey("parameters")) {
        throw SerializationException("FunctionTool is missing required property 'parameters'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: FunctionTool) {
      val jsonEncoder = encoder.requireJsonEncoder("FunctionTool")
...
public fun functionTool(block: FunctionTool.Builder.() -> Unit): FunctionTool = FunctionTool.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("FunctionTool is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("FunctionTool property '" + name + "' is not nullable")
