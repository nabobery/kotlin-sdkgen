...
public class ChatResult internal constructor(
  ...
  public val objectValue: InlineComponentsSchemasChatResultPropertiesObject,
  /**
   * System fingerprint
   */
  ...
  public constructor(
    ...
    id: String,
    model: String,
    objectValue: InlineComponentsSchemasChatResultPropertiesObject,
  ...
  public class Builder {
    ...
    private var objectValueValue: InlineComponentsSchemasChatResultPropertiesObject? = null

    public var objectValue: InlineComponentsSchemasChatResultPropertiesObject
    ...
    public var openrouterMetadata: OpenRouterMetadata?
      ...
      set(`value`) {
        val present = requireNotNull(value) {
          "openrouterMetadata is not nullable; call unsetOpenrouterMetadata() to omit it" }
  ...
  public object Serializer : KSerializer<ChatResult> {
    ...
    override fun deserialize(decoder: Decoder): ChatResult {
      ...
      val choices = json.decodeRequired<List<ChatChoice>>(raw, "choices")
      ...
      val objectValue = json.decodeRequired<InlineComponentsSchemasChatResultPropertiesObject>(raw, "object")
      if (!raw.containsKey("system_fingerprint")) {
        throw SerializationException("ChatResult is missing required property 'system_fingerprint'")
      }
      val systemFingerprint = raw["system_fingerprint"].let { element -> if (element == JsonNull) null else json
      ...
      return ChatResult(
        ...
        objectValue = objectValue,
        systemFingerprint = systemFingerprint,
        openrouterMetadataState = json.decodeOptional(raw, "openrouter_metadata", nullable = false),
