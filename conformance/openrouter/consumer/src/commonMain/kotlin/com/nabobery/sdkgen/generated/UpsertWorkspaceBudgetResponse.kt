...
public class UpsertWorkspaceBudgetResponse(
  ...
  public object Serializer : KSerializer<UpsertWorkspaceBudgetResponse> {
    ...
    override fun deserialize(decoder: Decoder): UpsertWorkspaceBudgetResponse {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("UpsertWorkspaceBudgetResponse must be a JSON object")
      val data = json.decodeRequired<WorkspaceBudget>(raw, "data")
      return UpsertWorkspaceBudgetResponse(
        data = data,
      )
    }
...
public fun upsertWorkspaceBudgetResponse(block: UpsertWorkspaceBudgetResponse.Builder.() ->
  Unit): UpsertWorkspaceBudgetResponse = UpsertWorkspaceBudgetResponse.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("UpsertWorkspaceBudgetResponse is missing required property '" + name + "'")
