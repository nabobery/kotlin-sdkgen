...
public class ConflictResponseErrorData(
  ...
  public object Serializer : KSerializer<ConflictResponseErrorData> {
    ...
    override fun deserialize(decoder: Decoder): ConflictResponseErrorData {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("ConflictResponseErrorData must be a JSON object")
...
public fun conflictResponseErrorData(block: ConflictResponseErrorData.Builder.() -> Unit): ConflictResponseErrorData =
  ConflictResponseErrorData.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("ConflictResponseErrorData is missing required property '" +
    name + "'")
