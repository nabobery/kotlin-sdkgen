...
public class WorkspaceMember(
   ...
   */
  public val role: InlineComponentsSchemasWorkspaceMemberPropertiesRole,
  /**
  ...
  public class Builder {
    ...
    private var roleValue: InlineComponentsSchemasWorkspaceMemberPropertiesRole? = null

    public var role: InlineComponentsSchemasWorkspaceMemberPropertiesRole
  ...
  public object Serializer : KSerializer<WorkspaceMember> {
    ...
    override fun deserialize(decoder: Decoder): WorkspaceMember {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("WorkspaceMember must be a JSON object")
      val createdAt = json.decodeRequired<String>(raw, "created_at")
      val id = json.decodeRequired<String>(raw, "id")
      val role = json.decodeRequired<InlineComponentsSchemasWorkspaceMemberPropertiesRole>(raw, "role")
