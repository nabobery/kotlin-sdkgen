...
public class NotFoundResponseErrorData(
  ...
  public object Serializer : KSerializer<NotFoundResponseErrorData> {
    ...
    override fun deserialize(decoder: Decoder): NotFoundResponseErrorData {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("NotFoundResponseErrorData must be a JSON object")
...
public fun notFoundResponseErrorData(block: NotFoundResponseErrorData.Builder.() -> Unit): NotFoundResponseErrorData =
  NotFoundResponseErrorData.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("NotFoundResponseErrorData is missing required property '" +
    name + "'")
