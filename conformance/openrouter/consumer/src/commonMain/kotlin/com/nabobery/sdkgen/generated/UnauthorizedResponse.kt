...
public class UnauthorizedResponse(
  ...
  public object Serializer : KSerializer<UnauthorizedResponse> {
    ...
    override fun deserialize(decoder: Decoder): UnauthorizedResponse {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("UnauthorizedResponse must be a JSON object")
      val error = json.decodeRequired<UnauthorizedResponseErrorData>(raw, "error")
      return UnauthorizedResponse(
        error = error,
...
public fun unauthorizedResponse(block: UnauthorizedResponse.Builder.() -> Unit): UnauthorizedResponse =
  UnauthorizedResponse.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("UnauthorizedResponse is missing required property '" +
    name + "'")
