...
public class AnthropicOutputTokensDetails(
  ...
  public object Serializer : KSerializer<AnthropicOutputTokensDetails> {
    ...
    override fun deserialize(decoder: Decoder): AnthropicOutputTokensDetails {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("AnthropicOutputTokensDetails must be a JSON object")
      val thinkingTokens = json.decodeRequired<Int>(raw, "thinking_tokens")
      return AnthropicOutputTokensDetails(
        thinkingTokens = thinkingTokens,
      )
    }
...
public fun anthropicOutputTokensDetails(block: AnthropicOutputTokensDetails.Builder.() ->
  Unit): AnthropicOutputTokensDetails = AnthropicOutputTokensDetails.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("AnthropicOutputTokensDetails is missing required property '" + name + "'")
