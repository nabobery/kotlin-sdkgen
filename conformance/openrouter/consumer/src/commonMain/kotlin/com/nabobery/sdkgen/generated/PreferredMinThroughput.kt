...
public class PreferredMinThroughput internal constructor(
  ...
  public val percentileThroughputCutoffs: PercentileThroughputCutoffs? by
      lazy(LazyThreadSafetyMode.NONE) { if (inspection.matchesPercentileThroughputCutoffs) json
        .decodeFromJsonElement<PercentileThroughputCutoffs>(raw) else null }
  ...
  public companion object {
    ...
    public fun fromRaw(raw: JsonElement, json: Json = SdkJson): PreferredMinThroughput {
      ...
      if (inspection.matchCount == 0) {
        throw PreferredMinThroughputNoMatchException("PreferredMinThroughput matched 0 branches: " + inspection
  ...
  public object Serializer : KSerializer<PreferredMinThroughput> {
...
private fun inspectPreferredMinThroughput(element: JsonElement): PreferredMinThroughputInspection {
  ...
  return PreferredMinThroughputInspection(
    ...
    failures = buildList {
      ...
      if (!matchesPercentileThroughputCutoffs) add("PercentileThroughputCutoffs: value does not match " +
        "PercentileThroughputCutoffs")
