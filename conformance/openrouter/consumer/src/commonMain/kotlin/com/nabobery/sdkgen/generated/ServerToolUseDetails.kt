...
public class ServerToolUseDetails(
  ...
  public object Serializer : KSerializer<ServerToolUseDetails> {
    ...
    override fun deserialize(decoder: Decoder): ServerToolUseDetails {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("ServerToolUseDetails must be a JSON object")
...
public fun serverToolUseDetails(block: ServerToolUseDetails.Builder.() -> Unit): ServerToolUseDetails =
  ServerToolUseDetails.build(block)
