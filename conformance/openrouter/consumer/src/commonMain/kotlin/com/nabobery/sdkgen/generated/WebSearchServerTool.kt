...
public class WebSearchServerTool(
  ...
  public class Builder {
    private var typeValue: InlineComponentsSchemasWebSearchServerToolPropertiesType? = null

    public var type: InlineComponentsSchemasWebSearchServerToolPropertiesType
  ...
  public object Serializer : KSerializer<WebSearchServerTool> {
    ...
    override fun deserialize(decoder: Decoder): WebSearchServerTool {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("WebSearchServerTool must be a JSON object")
      val type = json.decodeRequired<InlineComponentsSchemasWebSearchServerToolPropertiesType>(raw, "type")
      return WebSearchServerTool(
        type = type,
...
public fun webSearchServerTool(block: WebSearchServerTool.Builder.() -> Unit): WebSearchServerTool =
  WebSearchServerTool.build(block)
