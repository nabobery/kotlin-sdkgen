...
public class BulkAssignKeysResponse(
  ...
  public object Serializer : KSerializer<BulkAssignKeysResponse> {
    ...
    override fun deserialize(decoder: Decoder): BulkAssignKeysResponse {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("BulkAssignKeysResponse must be a JSON object")
...
public fun bulkAssignKeysResponse(block: BulkAssignKeysResponse.Builder.() -> Unit): BulkAssignKeysResponse =
  BulkAssignKeysResponse.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("BulkAssignKeysResponse is missing required property '" +
    name + "'")
