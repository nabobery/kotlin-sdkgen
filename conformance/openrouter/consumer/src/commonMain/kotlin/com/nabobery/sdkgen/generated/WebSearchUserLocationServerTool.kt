...
public class WebSearchUserLocationServerTool(
  ...
  public val type: InlineComponentsSchemasWebSearchUserLocationServerToolPropertiesType? = null,
) {
  public class Builder {
    ...
    public var type: InlineComponentsSchemasWebSearchUserLocationServerToolPropertiesType? = null
  ...
  public object Serializer : KSerializer<WebSearchUserLocationServerTool> {
    ...
    override fun deserialize(decoder: Decoder): WebSearchUserLocationServerTool {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("WebSearchUserLocationServerTool must be a JSON object")
      return WebSearchUserLocationServerTool(
        ...
        type = raw["type"]?.let { json
          .decodeFromJsonElement<InlineComponentsSchemasWebSearchUserLocationServerToolPropertiesType>(it) },
      )
    }
...
public fun webSearchUserLocationServerTool(block: WebSearchUserLocationServerTool.Builder.() ->
  Unit): WebSearchUserLocationServerTool = WebSearchUserLocationServerTool.build(block)
