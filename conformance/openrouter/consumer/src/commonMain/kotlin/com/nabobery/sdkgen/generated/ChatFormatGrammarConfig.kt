...
public class ChatFormatGrammarConfig(
  ...
  public class Builder {
    ...
    private var typeValue: InlineComponentsSchemasChatFormatGrammarConfigPropertiesType? = null

    public var type: InlineComponentsSchemasChatFormatGrammarConfigPropertiesType
  ...
  public object Serializer : KSerializer<ChatFormatGrammarConfig> {
    ...
    override fun deserialize(decoder: Decoder): ChatFormatGrammarConfig {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("ChatFormatGrammarConfig must be a JSON object")
      val grammar = json.decodeRequired<String>(raw, "grammar")
      val type = json.decodeRequired<InlineComponentsSchemasChatFormatGrammarConfigPropertiesType>(raw, "type")
      return ChatFormatGrammarConfig(
        grammar = grammar,
        type = type,
      )
...
public fun chatFormatGrammarConfig(block: ChatFormatGrammarConfig.Builder.() -> Unit): ChatFormatGrammarConfig =
  ChatFormatGrammarConfig.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("ChatFormatGrammarConfig is missing required property '" +
    name + "'")
