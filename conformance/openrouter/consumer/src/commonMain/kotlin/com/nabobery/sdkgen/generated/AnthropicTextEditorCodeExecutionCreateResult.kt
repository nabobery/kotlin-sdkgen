...
public class AnthropicTextEditorCodeExecutionCreateResult(
  ...
  public class Builder {
    ...
    private var typeValue:
        InlineComponentsSchemasAnthropicTextEditorCodeExecutionCreateResultPropertiesType? = null
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): AnthropicTextEditorCodeExecutionCreateResult = Builder().apply(block)
      .build()
  }

  public object Serializer : KSerializer<AnthropicTextEditorCodeExecutionCreateResult> {
    ...
    override fun deserialize(decoder: Decoder): AnthropicTextEditorCodeExecutionCreateResult {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("AnthropicTextEditorCodeExecutionCreateResult must be a JSON object")
      val isFileUpdate = json.decodeRequired<Boolean>(raw, "is_file_update")
      val type = json
        .decodeRequired<InlineComponentsSchemasAnthropicTextEditorCodeExecutionCreateResultPropertiesType>(raw, "type")
      return AnthropicTextEditorCodeExecutionCreateResult(
        isFileUpdate = isFileUpdate,
        type = type,
      )
...
public fun anthropicTextEditorCodeExecutionCreateResult(block: AnthropicTextEditorCodeExecutionCreateResult.Builder
  .() -> Unit): AnthropicTextEditorCodeExecutionCreateResult = AnthropicTextEditorCodeExecutionCreateResult.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("AnthropicTextEditorCodeExecutionCreateResult is missing required property '" + name +
      "'")
