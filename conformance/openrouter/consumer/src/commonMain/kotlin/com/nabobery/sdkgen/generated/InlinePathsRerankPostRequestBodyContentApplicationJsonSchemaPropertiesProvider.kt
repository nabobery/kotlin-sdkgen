...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/paths/~1rerank/post/requestBody/content/application~1json/schema/properties/provider.
 */
@Serializable(with = InlinePathsRerankPostRequestBodyContentApplicationJsonSchemaPropertiesProvider.Serializer::class)
public class InlinePathsRerankPostRequestBodyContentApplicationJsonSchemaPropertiesProvider(
  /**
  ...
  public class Builder {
    ...
    public fun build(): InlinePathsRerankPostRequestBodyContentApplicationJsonSchemaPropertiesProvider =
      InlinePathsRerankPostRequestBodyContentApplicationJsonSchemaPropertiesProvider(
  ...
  public companion object {
    public fun build(block: Builder.() ->
      Unit): InlinePathsRerankPostRequestBodyContentApplicationJsonSchemaPropertiesProvider = Builder().apply(block)
        .build()
  }

  public object Serializer : KSerializer<InlinePathsRerankPostRequestBodyContentApplicationJsonSchemaPropertiesProvider> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlinePathsRerankPostRequestBodyContentApplicationJsonSchemaPropertiesProvider {
      val jsonDecoder = decoder
        .requireJsonDecoder("InlinePathsRerankPostRequestBodyContentApplicationJsonSchemaPropertiesProvider")
      val json = jsonDecoder.json
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("InlinePathsRerankPostRequestBodyContentApplicationJsonSchemaPropertiesProvider " +
          "must be a JSON object")
      return InlinePathsRerankPostRequestBodyContentApplicationJsonSchemaPropertiesProvider(
    ...
    override fun serialize(encoder: Encoder,
      `value`: InlinePathsRerankPostRequestBodyContentApplicationJsonSchemaPropertiesProvider) {
      val jsonEncoder = encoder
        .requireJsonEncoder("InlinePathsRerankPostRequestBodyContentApplicationJsonSchemaPropertiesProvider")
...
public fun inlinePathsRerankPostRequestBodyContentApplicationJsonSchemaPropertiesProvider(block: InlinePathsRerankPostRequestBodyContentApplicationJsonSchemaPropertiesProvider.Builder.() -> Unit): InlinePathsRerankPostRequestBodyContentApplicationJsonSchemaPropertiesProvider = InlinePathsRerankPostRequestBodyContentApplicationJsonSchemaPropertiesProvider.build(block)
