...
public class AnthropicCitationCharLocation(
  ...
  public class Builder {
    ...
    private var typeValue: InlineComponentsSchemasAnthropicCitationCharLocationPropertiesType? =
        null

    public var type: InlineComponentsSchemasAnthropicCitationCharLocationPropertiesType
  ...
  public object Serializer : KSerializer<AnthropicCitationCharLocation> {
    ...
    override fun deserialize(decoder: Decoder): AnthropicCitationCharLocation {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("AnthropicCitationCharLocation must be a JSON object")
      ...
      val type = json.decodeRequired<InlineComponentsSchemasAnthropicCitationCharLocationPropertiesType>(raw, "type")
...
public fun anthropicCitationCharLocation(block: AnthropicCitationCharLocation.Builder.() ->
  Unit): AnthropicCitationCharLocation = AnthropicCitationCharLocation.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("AnthropicCitationCharLocation is missing required property '" + name + "'")
