...
/**
 * Generated model for sdkgen://source/openapi.yaml#/components/schemas/ObservabilityWeaveDestination.
 */
@Serializable(with = ObservabilityWeaveDestination.Serializer::class)
public class ObservabilityWeaveDestination(
  /**
  ...
  public class Builder {
    private var configValue: InlineComponentsSchemasObservabilityWeaveDestinationPropertiesConfig? =
        null

    public var config: InlineComponentsSchemasObservabilityWeaveDestinationPropertiesConfig
    ...
    private var typeValue: InlineComponentsSchemasObservabilityWeaveDestinationPropertiesType? =
        null

    public var type: InlineComponentsSchemasObservabilityWeaveDestinationPropertiesType
    ...
    public fun build(): ObservabilityWeaveDestination {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): ObservabilityWeaveDestination = Builder().apply(block).build()
  }

  public object Serializer : KSerializer<ObservabilityWeaveDestination> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): ObservabilityWeaveDestination {
      val jsonDecoder = decoder.requireJsonDecoder("ObservabilityWeaveDestination")
      val json = jsonDecoder.json
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("ObservabilityWeaveDestination must be a JSON object")
      val config = json.decodeRequired<InlineComponentsSchemasObservabilityWeaveDestinationPropertiesConfig>(raw,
        "config")
      ...
      val type = json.decodeRequired<InlineComponentsSchemasObservabilityWeaveDestinationPropertiesType>(raw, "type")
      ...
      if (!raw.containsKey("api_key_hashes")) {
        throw SerializationException("ObservabilityWeaveDestination is missing required property 'api_key_hashes'")
      }
      ...
      if (!raw.containsKey("filter_rules")) {
        throw SerializationException("ObservabilityWeaveDestination is missing required property 'filter_rules'")
      }
      ...
      if (!raw.containsKey("name")) {
        throw SerializationException("ObservabilityWeaveDestination is missing required property 'name'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: ObservabilityWeaveDestination) {
      val jsonEncoder = encoder.requireJsonEncoder("ObservabilityWeaveDestination")
...
public fun observabilityWeaveDestination(block: ObservabilityWeaveDestination.Builder.() ->
  Unit): ObservabilityWeaveDestination = ObservabilityWeaveDestination.build(block)
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("ObservabilityWeaveDestination property '" + name + "' is not nullable")
