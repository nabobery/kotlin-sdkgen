...
/**
 * Generated model for sdkgen://source/openapi.yaml#/components/schemas/ObservabilityWebhookDestination.
 */
@Serializable(with = ObservabilityWebhookDestination.Serializer::class)
public class ObservabilityWebhookDestination(
  /**
  ...
  public class Builder {
    private var configValue: InlineComponentsSchemasObservabilityWebhookDestinationPropertiesConfig?
        = null

    public var config: InlineComponentsSchemasObservabilityWebhookDestinationPropertiesConfig
    ...
    private var typeValue: InlineComponentsSchemasObservabilityWebhookDestinationPropertiesType? =
        null

    public var type: InlineComponentsSchemasObservabilityWebhookDestinationPropertiesType
    ...
    public fun build(): ObservabilityWebhookDestination {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): ObservabilityWebhookDestination = Builder().apply(block).build()
  }

  public object Serializer : KSerializer<ObservabilityWebhookDestination> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): ObservabilityWebhookDestination {
      val jsonDecoder = decoder.requireJsonDecoder("ObservabilityWebhookDestination")
      val json = jsonDecoder.json
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("ObservabilityWebhookDestination must be a JSON object")
      val config = json.decodeRequired<InlineComponentsSchemasObservabilityWebhookDestinationPropertiesConfig>(raw,
        "config")
      ...
      val type = json.decodeRequired<InlineComponentsSchemasObservabilityWebhookDestinationPropertiesType>(raw, "type")
      ...
      if (!raw.containsKey("api_key_hashes")) {
        throw SerializationException("ObservabilityWebhookDestination is missing required property 'api_key_hashes'")
      }
      ...
      if (!raw.containsKey("filter_rules")) {
        throw SerializationException("ObservabilityWebhookDestination is missing required property 'filter_rules'")
      }
      ...
      if (!raw.containsKey("name")) {
        throw SerializationException("ObservabilityWebhookDestination is missing required property 'name'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: ObservabilityWebhookDestination) {
      val jsonEncoder = encoder.requireJsonEncoder("ObservabilityWebhookDestination")
...
public fun observabilityWebhookDestination(block: ObservabilityWebhookDestination.Builder.() ->
  Unit): ObservabilityWebhookDestination = ObservabilityWebhookDestination.build(block)
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("ObservabilityWebhookDestination property '" + name +
      "' is not nullable")
