...
public class AnthropicEncryptedCodeExecutionResult(
  ...
  public class Builder {
    ...
    private var typeValue:
        InlineComponentsSchemasAnthropicEncryptedCodeExecutionResultPropertiesType? = null

    public var type: InlineComponentsSchemasAnthropicEncryptedCodeExecutionResultPropertiesType
  ...
  public object Serializer : KSerializer<AnthropicEncryptedCodeExecutionResult> {
    ...
    override fun deserialize(decoder: Decoder): AnthropicEncryptedCodeExecutionResult {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("AnthropicEncryptedCodeExecutionResult must be a JSON object")
      val content = json.decodeRequired<List<AnthropicCodeExecutionOutput>>(raw, "content")
      val encryptedStdout = json.decodeRequired<String>(raw, "encrypted_stdout")
      val returnCode = json.decodeRequired<Int>(raw, "return_code")
      val stderr = json.decodeRequired<String>(raw, "stderr")
      val type = json.decodeRequired<InlineComponentsSchemasAnthropicEncryptedCodeExecutionResultPropertiesType>(raw,
        "type")
      return AnthropicEncryptedCodeExecutionResult(
        content = content,
        encryptedStdout = encryptedStdout,
...
public fun anthropicEncryptedCodeExecutionResult(block: AnthropicEncryptedCodeExecutionResult.Builder.() ->
  Unit): AnthropicEncryptedCodeExecutionResult = AnthropicEncryptedCodeExecutionResult.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("AnthropicEncryptedCodeExecutionResult is missing required property '" + name + "'")
