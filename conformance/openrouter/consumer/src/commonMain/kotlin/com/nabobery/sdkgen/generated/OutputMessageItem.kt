...
public class OutputMessageItem(
  ...
  public object Serializer : KSerializer<OutputMessageItem> {
    ...
    override fun deserialize(decoder: Decoder): OutputMessageItem {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("OutputMessageItem must be a JSON object")
...
public fun outputMessageItem(block: OutputMessageItem.Builder.() -> Unit): OutputMessageItem = OutputMessageItem
  .build(block)
