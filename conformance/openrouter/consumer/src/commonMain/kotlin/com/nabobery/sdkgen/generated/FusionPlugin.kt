...
public class FusionPlugin(
   ...
   */
  public val preset: InlineComponentsSchemasFusionPluginPropertiesPreset? = null,
  /**
   ...
   * knowledge only).
   */
  public val tools: List<InlineComponentsSchemasFusionPluginPropertiesToolsItems>? = null,
) {
  public class Builder {
    private var idValue: InlineComponentsSchemasFusionPluginPropertiesId? = null

    public var id: InlineComponentsSchemasFusionPluginPropertiesId
     ...
     * `analysis_models` / `model` take precedence.
     */
    public var preset: InlineComponentsSchemasFusionPluginPropertiesPreset? = null
     ...
     * knowledge only).
     */
    public var tools: List<InlineComponentsSchemasFusionPluginPropertiesToolsItems>? = null
  ...
  public object Serializer : KSerializer<FusionPlugin> {
    ...
    override fun deserialize(decoder: Decoder): FusionPlugin {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("FusionPlugin must be a JSON object")
      val id = json.decodeRequired<InlineComponentsSchemasFusionPluginPropertiesId>(raw, "id")
      return FusionPlugin(
        id = id,
        ...
        preset = raw["preset"]?.let { json
          .decodeFromJsonElement<InlineComponentsSchemasFusionPluginPropertiesPreset>(it) },
        tools = raw["tools"]?.let { json
          .decodeFromJsonElement<List<InlineComponentsSchemasFusionPluginPropertiesToolsItems>>(it) },
      )
    }
