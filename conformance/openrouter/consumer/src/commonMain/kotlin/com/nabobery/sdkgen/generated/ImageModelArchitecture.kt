...
public class ImageModelArchitecture(
  ...
  public object Serializer : KSerializer<ImageModelArchitecture> {
    ...
    override fun deserialize(decoder: Decoder): ImageModelArchitecture {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("ImageModelArchitecture must be a JSON object")
      val inputModalities = json.decodeRequired<List<ImageInputModality>>(raw, "input_modalities")
      val outputModalities = json.decodeRequired<List<ImageOutputModality>>(raw, "output_modalities")
      return ImageModelArchitecture(
        inputModalities = inputModalities,
        outputModalities = outputModalities,
      )
...
public fun imageModelArchitecture(block: ImageModelArchitecture.Builder.() -> Unit): ImageModelArchitecture =
  ImageModelArchitecture.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("ImageModelArchitecture is missing required property '" +
    name + "'")
