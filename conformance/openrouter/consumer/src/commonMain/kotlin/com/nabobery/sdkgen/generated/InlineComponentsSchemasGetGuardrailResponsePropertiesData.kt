 ...
 */
@Serializable(with = InlineComponentsSchemasGetGuardrailResponsePropertiesData.Serializer::class)
public class InlineComponentsSchemasGetGuardrailResponsePropertiesData(
  /**
  ...
  public class Builder {
    ...
    public fun build(): InlineComponentsSchemasGetGuardrailResponsePropertiesData {
      check(createdAtValue != null) { "createdAt is required" }
      check(idValue != null) { "id is required" }
      check(nameValue != null) { "name is required" }
      check(workspaceIdValue != null) { "workspaceId is required" }
      return InlineComponentsSchemasGetGuardrailResponsePropertiesData(
        createdAt = createdAt,
        id = id,
        name = name,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineComponentsSchemasGetGuardrailResponsePropertiesData = Builder()
      .apply(block).build()
  }

  public object Serializer : KSerializer<InlineComponentsSchemasGetGuardrailResponsePropertiesData> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineComponentsSchemasGetGuardrailResponsePropertiesData {
      val jsonDecoder = decoder.requireJsonDecoder("InlineComponentsSchemasGetGuardrailResponsePropertiesData")
      val json = jsonDecoder.json
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("InlineComponentsSchemasGetGuardrailResponsePropertiesData must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineComponentsSchemasGetGuardrailResponsePropertiesData) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineComponentsSchemasGetGuardrailResponsePropertiesData")
...
public fun inlineComponentsSchemasGetGuardrailResponsePropertiesData(block: InlineComponentsSchemasGetGuardrailResponsePropertiesData.Builder.() -> Unit): InlineComponentsSchemasGetGuardrailResponsePropertiesData = InlineComponentsSchemasGetGuardrailResponsePropertiesData.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("InlineComponentsSchemasGetGuardrailResponsePropertiesData is missing required " +
      "property '" + name + "'")
