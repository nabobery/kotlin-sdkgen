...
public class OutputMcpServerToolItem(
  ...
  public val type: InlineComponentsSchemasOutputMcpServerToolItemPropertiesType,
  ...
  public class Builder {
    ...
    private var typeValue: InlineComponentsSchemasOutputMcpServerToolItemPropertiesType? = null

    public var type: InlineComponentsSchemasOutputMcpServerToolItemPropertiesType
  ...
  public object Serializer : KSerializer<OutputMcpServerToolItem> {
    ...
    override fun deserialize(decoder: Decoder): OutputMcpServerToolItem {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("OutputMcpServerToolItem must be a JSON object")
      val status = json.decodeRequired<ToolCallStatus>(raw, "status")
      val type = json.decodeRequired<InlineComponentsSchemasOutputMcpServerToolItemPropertiesType>(raw, "type")
      return OutputMcpServerToolItem(
        status = status,
        type = type,
        id = raw["id"]?.let { json.decodeFromJsonElement<String>(it) },
        serverLabel = raw["serverLabel"]?.let { json.decodeFromJsonElement<String>(it) },
        toolName = raw["toolName"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }
...
public fun outputMcpServerToolItem(block: OutputMcpServerToolItem.Builder.() -> Unit): OutputMcpServerToolItem =
  OutputMcpServerToolItem.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("OutputMcpServerToolItem is missing required property '" +
    name + "'")
