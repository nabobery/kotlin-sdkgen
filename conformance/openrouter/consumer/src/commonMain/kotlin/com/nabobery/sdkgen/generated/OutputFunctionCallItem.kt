...
public class OutputFunctionCallItem(
  ...
  public object Serializer : KSerializer<OutputFunctionCallItem> {
    ...
    override fun deserialize(decoder: Decoder): OutputFunctionCallItem {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("OutputFunctionCallItem must be a JSON object")
...
public fun outputFunctionCallItem(block: OutputFunctionCallItem.Builder.() -> Unit): OutputFunctionCallItem =
  OutputFunctionCallItem.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("OutputFunctionCallItem is missing required property '" +
    name + "'")
