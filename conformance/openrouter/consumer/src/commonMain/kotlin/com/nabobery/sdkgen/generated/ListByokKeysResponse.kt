...
public class ListByokKeysResponse(
  ...
  public object Serializer : KSerializer<ListByokKeysResponse> {
    ...
    override fun deserialize(decoder: Decoder): ListByokKeysResponse {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("ListByokKeysResponse must be a JSON object")
      val data = json.decodeRequired<List<ByokKey>>(raw, "data")
...
public fun listByokKeysResponse(block: ListByokKeysResponse.Builder.() -> Unit): ListByokKeysResponse =
  ListByokKeysResponse.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("ListByokKeysResponse is missing required property '" +
    name + "'")
