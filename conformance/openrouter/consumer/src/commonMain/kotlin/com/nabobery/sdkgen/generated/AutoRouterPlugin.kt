...
public class AutoRouterPlugin(
  ...
  public class Builder {
    private var idValue: InlineComponentsSchemasAutoRouterPluginPropertiesId? = null

    public var id: InlineComponentsSchemasAutoRouterPluginPropertiesId
  ...
  public object Serializer : KSerializer<AutoRouterPlugin> {
    ...
    override fun deserialize(decoder: Decoder): AutoRouterPlugin {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("AutoRouterPlugin must be a JSON object")
      val id = json.decodeRequired<InlineComponentsSchemasAutoRouterPluginPropertiesId>(raw, "id")
      return AutoRouterPlugin(
        id = id,
        allowedModels = raw["allowed_models"]?.let { json.decodeFromJsonElement<List<String>>(it) },
        costQualityTradeoff = raw["cost_quality_tradeoff"]?.let { json.decodeFromJsonElement<Int>(it) },
...
public fun autoRouterPlugin(block: AutoRouterPlugin.Builder.() -> Unit): AutoRouterPlugin = AutoRouterPlugin
  .build(block)
