...
public class BaseReasoningSummaryTextDeltaEvent(
  ...
  public object Serializer : KSerializer<BaseReasoningSummaryTextDeltaEvent> {
    ...
    override fun deserialize(decoder: Decoder): BaseReasoningSummaryTextDeltaEvent {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("BaseReasoningSummaryTextDeltaEvent must be a JSON object")
...
public fun baseReasoningSummaryTextDeltaEvent(block: BaseReasoningSummaryTextDeltaEvent.Builder.() ->
  Unit): BaseReasoningSummaryTextDeltaEvent = BaseReasoningSummaryTextDeltaEvent.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("BaseReasoningSummaryTextDeltaEvent is missing required property '" + name + "'")
