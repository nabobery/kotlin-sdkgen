...
public data class ImageGenCompletedEventView(
  ...
  public val type: InlineComponentsSchemasImageGenCompletedEventPropertiesType,
...
public class ImageGenCompletedEvent(
  ...
  public class Builder {
    ...
    private var typeValue: InlineComponentsSchemasImageGenCompletedEventPropertiesType? = null

    public var type: InlineComponentsSchemasImageGenCompletedEventPropertiesType
  ...
  public object Serializer : KSerializer<ImageGenCompletedEvent> {
    ...
    override fun deserialize(decoder: Decoder): ImageGenCompletedEvent {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("ImageGenCompletedEvent must be a JSON object")
      val b64Json = json.decodeRequired<String>(raw, "b64_json")
      val created = json.decodeRequired<Int>(raw, "created")
      val type = json.decodeRequired<InlineComponentsSchemasImageGenCompletedEventPropertiesType>(raw, "type")
      return ImageGenCompletedEvent(
        b64Json = b64Json,
        created = created,
        type = type,
...
public fun imageGenCompletedEvent(block: ImageGenCompletedEvent.Builder.() -> Unit): ImageGenCompletedEvent =
  ImageGenCompletedEvent.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("ImageGenCompletedEvent is missing required property '" +
    name + "'")
