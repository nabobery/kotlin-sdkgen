...
/**
 * Generated model for sdkgen://source/openapi.yaml#/components/schemas/ObservabilityClickhouseDestination.
 */
@Serializable(with = ObservabilityClickhouseDestination.Serializer::class)
public class ObservabilityClickhouseDestination(
  /**
  ...
  public class Builder {
    private var configValue:
        InlineComponentsSchemasObservabilityClickhouseDestinationPropertiesConfig? = null

    public var config: InlineComponentsSchemasObservabilityClickhouseDestinationPropertiesConfig
    ...
    private var typeValue: InlineComponentsSchemasObservabilityClickhouseDestinationPropertiesType?
        = null

    public var type: InlineComponentsSchemasObservabilityClickhouseDestinationPropertiesType
    ...
    public var apiKeyHashes: List<String>?
      ...
      set(`value`) {
        apiKeyHashesState = value.toNullableFieldState()
      }
    ...
    public fun build(): ObservabilityClickhouseDestination {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): ObservabilityClickhouseDestination = Builder().apply(block).build()
  }

  public object Serializer : KSerializer<ObservabilityClickhouseDestination> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): ObservabilityClickhouseDestination {
      val jsonDecoder = decoder.requireJsonDecoder("ObservabilityClickhouseDestination")
      val json = jsonDecoder.json
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("ObservabilityClickhouseDestination must be a JSON object")
      val config = json.decodeRequired<InlineComponentsSchemasObservabilityClickhouseDestinationPropertiesConfig>(raw,
        "config")
      val createdAt = json.decodeRequired<String>(raw, "created_at")
      val enabled = json.decodeRequired<Boolean>(raw, "enabled")
      val id = json.decodeRequired<String>(raw, "id")
      val privacyMode = json.decodeRequired<Boolean>(raw, "privacy_mode")
      val samplingRate = json.decodeRequired<Double>(raw, "sampling_rate")
      val type = json.decodeRequired<InlineComponentsSchemasObservabilityClickhouseDestinationPropertiesType>(raw,
        "type")
      val updatedAt = json.decodeRequired<String>(raw, "updated_at")
      val workspaceId = json.decodeRequired<String>(raw, "workspace_id")
      if (!raw.containsKey("api_key_hashes")) {
        throw SerializationException("ObservabilityClickhouseDestination is missing required property 'api_key_hashes'")
      }
      val apiKeyHashes = raw["api_key_hashes"].let { element -> if (element == JsonNull) null else json
        .decodeFromJsonElement<List<String>?>(requireNotNull(element)) }
      if (!raw.containsKey("filter_rules")) {
        throw SerializationException("ObservabilityClickhouseDestination is missing required property 'filter_rules'")
      }
      val filterRules = raw["filter_rules"].let { element -> if (element == JsonNull) null else json
        .decodeFromJsonElement<ObservabilityFilterRulesConfig?>(requireNotNull(element)) }
      if (!raw.containsKey("name")) {
        throw SerializationException("ObservabilityClickhouseDestination is missing required property 'name'")
      }
      val name = raw["name"].let { element -> if (element == JsonNull) null else json
    ...
    override fun serialize(encoder: Encoder, `value`: ObservabilityClickhouseDestination) {
      val jsonEncoder = encoder.requireJsonEncoder("ObservabilityClickhouseDestination")
...
public fun observabilityClickhouseDestination(block: ObservabilityClickhouseDestination.Builder.() ->
  Unit): ObservabilityClickhouseDestination = ObservabilityClickhouseDestination.build(block)
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("ObservabilityClickhouseDestination property '" + name +
      "' is not nullable")
