...
public data class ApplyPatchCallOutputItemView(
  ...
  public val status: InlineComponentsSchemasApplyPatchCallOutputItemPropertiesStatus,
  public val type: InlineComponentsSchemasApplyPatchCallOutputItemPropertiesType,
)
...
public class ApplyPatchCallOutputItem(
  ...
  public class Builder {
    ...
    private var statusValue: InlineComponentsSchemasApplyPatchCallOutputItemPropertiesStatus? = null

    public var status: InlineComponentsSchemasApplyPatchCallOutputItemPropertiesStatus
      get() = requireNotNull(statusValue) { "status is required" }
      set(`value`) {
        statusValue = value
      }

    private var typeValue: InlineComponentsSchemasApplyPatchCallOutputItemPropertiesType? = null

    public var type: InlineComponentsSchemasApplyPatchCallOutputItemPropertiesType
  ...
  public object Serializer : KSerializer<ApplyPatchCallOutputItem> {
    ...
    override fun deserialize(decoder: Decoder): ApplyPatchCallOutputItem {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("ApplyPatchCallOutputItem must be a JSON object")
      val callId = json.decodeRequired<String>(raw, "call_id")
      val status = json.decodeRequired<InlineComponentsSchemasApplyPatchCallOutputItemPropertiesStatus>(raw, "status")
      val type = json.decodeRequired<InlineComponentsSchemasApplyPatchCallOutputItemPropertiesType>(raw, "type")
      return ApplyPatchCallOutputItem(
        callId = callId,
        status = status,
        type = type,
...
public fun applyPatchCallOutputItem(block: ApplyPatchCallOutputItem.Builder.() -> Unit): ApplyPatchCallOutputItem =
  ApplyPatchCallOutputItem.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("ApplyPatchCallOutputItem is missing required property '" +
    name + "'")
