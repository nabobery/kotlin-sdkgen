...
public class AnthropicBase64PdfSource(
  ...
  public class Builder {
    ...
    private var mediaTypeValue: InlineComponentsSchemasAnthropicBase64PdfSourcePropertiesMediaType?
        = null

    public var mediaType: InlineComponentsSchemasAnthropicBase64PdfSourcePropertiesMediaType
      get() = requireNotNull(mediaTypeValue) { "mediaType is required" }
      set(`value`) {
        mediaTypeValue = value
      }

    private var typeValue: InlineComponentsSchemasAnthropicBase64PdfSourcePropertiesType? = null

    public var type: InlineComponentsSchemasAnthropicBase64PdfSourcePropertiesType
  ...
  public object Serializer : KSerializer<AnthropicBase64PdfSource> {
    ...
    override fun deserialize(decoder: Decoder): AnthropicBase64PdfSource {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("AnthropicBase64PdfSource must be a JSON object")
      val data = json.decodeRequired<String>(raw, "data")
      val mediaType = json.decodeRequired<InlineComponentsSchemasAnthropicBase64PdfSourcePropertiesMediaType>(raw,
        "media_type")
      val type = json.decodeRequired<InlineComponentsSchemasAnthropicBase64PdfSourcePropertiesType>(raw, "type")
      return AnthropicBase64PdfSource(
        data = data,
        mediaType = mediaType,
        type = type,
...
public fun anthropicBase64PdfSource(block: AnthropicBase64PdfSource.Builder.() -> Unit): AnthropicBase64PdfSource =
  AnthropicBase64PdfSource.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("AnthropicBase64PdfSource is missing required property '" +
    name + "'")
