...
public class ComputerUseServerTool(
  ...
  public class Builder {
    ...
    private var environmentValue: InlineComponentsSchemasComputerUseServerToolPropertiesEnvironment?
        = null

    public var environment: InlineComponentsSchemasComputerUseServerToolPropertiesEnvironment
      get() = requireNotNull(environmentValue) { "environment is required" }
      set(`value`) {
        environmentValue = value
      }

    private var typeValue: InlineComponentsSchemasComputerUseServerToolPropertiesType? = null

    public var type: InlineComponentsSchemasComputerUseServerToolPropertiesType
  ...
  public object Serializer : KSerializer<ComputerUseServerTool> {
    ...
    override fun deserialize(decoder: Decoder): ComputerUseServerTool {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("ComputerUseServerTool must be a JSON object")
      val displayHeight = json.decodeRequired<Int>(raw, "display_height")
      val displayWidth = json.decodeRequired<Int>(raw, "display_width")
      val environment = json.decodeRequired<InlineComponentsSchemasComputerUseServerToolPropertiesEnvironment>(raw,
        "environment")
      val type = json.decodeRequired<InlineComponentsSchemasComputerUseServerToolPropertiesType>(raw, "type")
      return ComputerUseServerTool(
        displayHeight = displayHeight,
        displayWidth = displayWidth,
        environment = environment,
...
public fun computerUseServerTool(block: ComputerUseServerTool.Builder.() -> Unit): ComputerUseServerTool =
  ComputerUseServerTool.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("ComputerUseServerTool is missing required property '" +
    name + "'")
