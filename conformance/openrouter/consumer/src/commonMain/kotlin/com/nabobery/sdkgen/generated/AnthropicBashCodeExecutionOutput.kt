...
public class AnthropicBashCodeExecutionOutput(
  ...
  public val type: InlineComponentsSchemasAnthropicBashCodeExecutionOutputPropertiesType,
) {
  public class Builder {
    ...
    private var typeValue: InlineComponentsSchemasAnthropicBashCodeExecutionOutputPropertiesType? =
        null

    public var type: InlineComponentsSchemasAnthropicBashCodeExecutionOutputPropertiesType
  ...
  public object Serializer : KSerializer<AnthropicBashCodeExecutionOutput> {
    ...
    override fun deserialize(decoder: Decoder): AnthropicBashCodeExecutionOutput {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("AnthropicBashCodeExecutionOutput must be a JSON object")
      val fileId = json.decodeRequired<String>(raw, "file_id")
      val type = json.decodeRequired<InlineComponentsSchemasAnthropicBashCodeExecutionOutputPropertiesType>(raw, "type")
      return AnthropicBashCodeExecutionOutput(
        fileId = fileId,
        type = type,
      )
...
public fun anthropicBashCodeExecutionOutput(block: AnthropicBashCodeExecutionOutput.Builder.() ->
  Unit): AnthropicBashCodeExecutionOutput = AnthropicBashCodeExecutionOutput.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("AnthropicBashCodeExecutionOutput is missing required property '" + name + "'")
