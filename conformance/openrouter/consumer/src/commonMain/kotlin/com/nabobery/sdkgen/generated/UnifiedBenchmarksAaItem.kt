...
public class UnifiedBenchmarksAaItem(
  ...
  public class Builder {
    ...
    private var sourceValue: InlineComponentsSchemasUnifiedBenchmarksAaItemPropertiesSource? = null

    public var source: InlineComponentsSchemasUnifiedBenchmarksAaItemPropertiesSource
  ...
  public object Serializer : KSerializer<UnifiedBenchmarksAaItem> {
    ...
    override fun deserialize(decoder: Decoder): UnifiedBenchmarksAaItem {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("UnifiedBenchmarksAaItem must be a JSON object")
      ...
      val source = json.decodeRequired<InlineComponentsSchemasUnifiedBenchmarksAaItemPropertiesSource>(raw, "source")
...
public fun unifiedBenchmarksAaItem(block: UnifiedBenchmarksAaItem.Builder.() -> Unit): UnifiedBenchmarksAaItem =
  UnifiedBenchmarksAaItem.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("UnifiedBenchmarksAaItem is missing required property '" +
    name + "'")
