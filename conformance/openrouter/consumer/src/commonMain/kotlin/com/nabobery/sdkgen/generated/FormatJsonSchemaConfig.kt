...
@Serializable
public data class FormatJsonSchemaConfigView(
  public val description: String? = null,
  public val name: String,
  public val schema: Map<String, JsonElement?>,
  public val strict: Boolean? = null,
  public val type: InlineComponentsSchemasFormatJsonSchemaConfigPropertiesType,
)
...
public class FormatJsonSchemaConfig(
  ...
  public class Builder {
    ...
    private var typeValue: InlineComponentsSchemasFormatJsonSchemaConfigPropertiesType? = null

    public var type: InlineComponentsSchemasFormatJsonSchemaConfigPropertiesType
  ...
  public object Serializer : KSerializer<FormatJsonSchemaConfig> {
    ...
    override fun deserialize(decoder: Decoder): FormatJsonSchemaConfig {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("FormatJsonSchemaConfig must be a JSON object")
      val name = json.decodeRequired<String>(raw, "name")
      val schema = json.decodeRequired<Map<String, JsonElement?>>(raw, "schema")
      val type = json.decodeRequired<InlineComponentsSchemasFormatJsonSchemaConfigPropertiesType>(raw, "type")
      return FormatJsonSchemaConfig(
        name = name,
        schema = schema,
        type = type,
...
public fun formatJsonSchemaConfig(block: FormatJsonSchemaConfig.Builder.() -> Unit): FormatJsonSchemaConfig =
  FormatJsonSchemaConfig.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("FormatJsonSchemaConfig is missing required property '" +
    name + "'")
