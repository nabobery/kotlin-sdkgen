...
public class OpenAiResponsesImageGenCallGenerating(
  ...
  public object Serializer : KSerializer<OpenAiResponsesImageGenCallGenerating> {
    ...
    override fun deserialize(decoder: Decoder): OpenAiResponsesImageGenCallGenerating {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("OpenAiResponsesImageGenCallGenerating must be a JSON object")
...
public fun openAiResponsesImageGenCallGenerating(block: OpenAiResponsesImageGenCallGenerating.Builder.() ->
  Unit): OpenAiResponsesImageGenCallGenerating = OpenAiResponsesImageGenCallGenerating.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("OpenAiResponsesImageGenCallGenerating is missing required property '" + name + "'")
