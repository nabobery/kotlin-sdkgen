...
public class AnthropicCacheControlDirective(
  ...
  public object Serializer : KSerializer<AnthropicCacheControlDirective> {
    ...
    override fun deserialize(decoder: Decoder): AnthropicCacheControlDirective {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("AnthropicCacheControlDirective must be a JSON object")
...
public fun anthropicCacheControlDirective(block: AnthropicCacheControlDirective.Builder.() ->
  Unit): AnthropicCacheControlDirective = AnthropicCacheControlDirective.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("AnthropicCacheControlDirective is missing required property '" + name + "'")
