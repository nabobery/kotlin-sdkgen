 ...
 */
@Serializable(with = InlineComponentsSchemasUpdateByokKeyResponsePropertiesData.Serializer::class)
public class InlineComponentsSchemasUpdateByokKeyResponsePropertiesData internal constructor(
  /**
  ...
  public class Builder {
    ...
    public fun build(): InlineComponentsSchemasUpdateByokKeyResponsePropertiesData {
      ...
      return InlineComponentsSchemasUpdateByokKeyResponsePropertiesData(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineComponentsSchemasUpdateByokKeyResponsePropertiesData = Builder()
      .apply(block).build()
  }

  public object Serializer : KSerializer<InlineComponentsSchemasUpdateByokKeyResponsePropertiesData> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineComponentsSchemasUpdateByokKeyResponsePropertiesData {
      val jsonDecoder = decoder.requireJsonDecoder("InlineComponentsSchemasUpdateByokKeyResponsePropertiesData")
      val json = jsonDecoder.json
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("InlineComponentsSchemasUpdateByokKeyResponsePropertiesData must be a JSON object")
      ...
      if (!raw.containsKey("allowed_api_key_hashes")) {
        throw SerializationException("InlineComponentsSchemasUpdateByokKeyResponsePropertiesData is missing required " +
    ...
    override fun serialize(encoder: Encoder, `value`: InlineComponentsSchemasUpdateByokKeyResponsePropertiesData) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineComponentsSchemasUpdateByokKeyResponsePropertiesData")
...
public fun inlineComponentsSchemasUpdateByokKeyResponsePropertiesData(block: InlineComponentsSchemasUpdateByokKeyResponsePropertiesData.Builder.() -> Unit): InlineComponentsSchemasUpdateByokKeyResponsePropertiesData = InlineComponentsSchemasUpdateByokKeyResponsePropertiesData.build(block)
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineComponentsSchemasUpdateByokKeyResponsePropertiesData property " +
