...
public class WebSearchCallSearchingEvent(
  ...
  public object Serializer : KSerializer<WebSearchCallSearchingEvent> {
    ...
    override fun deserialize(decoder: Decoder): WebSearchCallSearchingEvent {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("WebSearchCallSearchingEvent must be a JSON object")
...
public fun webSearchCallSearchingEvent(block: WebSearchCallSearchingEvent.Builder.() ->
  Unit): WebSearchCallSearchingEvent = WebSearchCallSearchingEvent.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("WebSearchCallSearchingEvent is missing required property '" + name + "'")
