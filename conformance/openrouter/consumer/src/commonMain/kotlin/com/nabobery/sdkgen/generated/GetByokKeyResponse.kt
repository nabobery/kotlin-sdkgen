...
public class GetByokKeyResponse(
  ...
  public object Serializer : KSerializer<GetByokKeyResponse> {
    ...
    override fun deserialize(decoder: Decoder): GetByokKeyResponse {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("GetByokKeyResponse must be a JSON object")
...
public fun getByokKeyResponse(block: GetByokKeyResponse.Builder.() -> Unit): GetByokKeyResponse = GetByokKeyResponse
  .build(block)
