...
public class AnthropicCompactionUsageIteration(
  ...
  public object Serializer : KSerializer<AnthropicCompactionUsageIteration> {
    ...
    override fun deserialize(decoder: Decoder): AnthropicCompactionUsageIteration {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("AnthropicCompactionUsageIteration must be a JSON object")
...
public fun anthropicCompactionUsageIteration(block: AnthropicCompactionUsageIteration.Builder.() ->
  Unit): AnthropicCompactionUsageIteration = AnthropicCompactionUsageIteration.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("AnthropicCompactionUsageIteration is missing required property '" + name + "'")
