 ...
 * Generation data
 */
@Serializable(with = InlineComponentsSchemasGenerationResponsePropertiesData.Serializer::class)
public class InlineComponentsSchemasGenerationResponsePropertiesData internal constructor(
  /**
   * Type of API used for the generation
   */
  public val apiType: InlineComponentsSchemasGenerationResponsePropertiesDataPropertiesApiType?,
  /**
  ...
  public constructor(
    apiType: InlineComponentsSchemasGenerationResponsePropertiesDataPropertiesApiType?,
    appId: Int?,
    cacheDiscount: Double?,
    cancelled: Boolean?,
    createdAt: String,
    dataRegion: InlineComponentsSchemasGenerationResponsePropertiesDataPropertiesDataRegion,
    externalUser: String?,
    finishReason: String?,
  ...
  public class Builder {
    ...
    private var dataRegionValue:
        InlineComponentsSchemasGenerationResponsePropertiesDataPropertiesDataRegion? = null

    public var dataRegion:
        InlineComponentsSchemasGenerationResponsePropertiesDataPropertiesDataRegion
    ...
    private var apiTypeState:
        FieldState<InlineComponentsSchemasGenerationResponsePropertiesDataPropertiesApiType?> =
        FieldState.Absent
     ...
     */
    public var apiType: InlineComponentsSchemasGenerationResponsePropertiesDataPropertiesApiType?
    ...
    public var providerResponses: List<ProviderResponse>?
      get() = providerResponsesState.valueOrNull()
      set(`value`) {
        providerResponsesState = value.toNullableFieldState()
      }
    ...
    public fun build(): InlineComponentsSchemasGenerationResponsePropertiesData {
      ...
      check(nativeTokensCompletionImagesState !== FieldState.Absent) {
        "nativeTokensCompletionImages is required, even when null" }
      ...
      return InlineComponentsSchemasGenerationResponsePropertiesData(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineComponentsSchemasGenerationResponsePropertiesData = Builder()
      .apply(block).build()
  }

  public object Serializer : KSerializer<InlineComponentsSchemasGenerationResponsePropertiesData> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineComponentsSchemasGenerationResponsePropertiesData {
      val jsonDecoder = decoder.requireJsonDecoder("InlineComponentsSchemasGenerationResponsePropertiesData")
      val json = jsonDecoder.json
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("InlineComponentsSchemasGenerationResponsePropertiesData must be a JSON object")
      val createdAt = json.decodeRequired<String>(raw, "created_at")
      val dataRegion = json
        .decodeRequired<InlineComponentsSchemasGenerationResponsePropertiesDataPropertiesDataRegion>(raw, "data_region")
      ...
      val origin = json.decodeRequired<String>(raw, "origin")
      val totalCost = json.decodeRequired<Double>(raw, "total_cost")
      val usage = json.decodeRequired<Double>(raw, "usage")
      if (!raw.containsKey("api_type")) {
      ...
      val appId = raw["app_id"].let { element -> if (element == JsonNull) null else json
        .decodeFromJsonElement<Int?>(requireNotNull(element)) }
      if (!raw.containsKey("cache_discount")) {
        throw SerializationException("InlineComponentsSchemasGenerationResponsePropertiesData is missing required " +
          "property 'cache_discount'")
      }
      val cacheDiscount = raw["cache_discount"].let { element -> if (element == JsonNull) null else json
        .decodeFromJsonElement<Double?>(requireNotNull(element)) }
      if (!raw.containsKey("cancelled")) {
        throw SerializationException("InlineComponentsSchemasGenerationResponsePropertiesData is missing required " +
          "property 'cancelled'")
      }
      val cancelled = raw["cancelled"].let { element -> if (element == JsonNull) null else json
        .decodeFromJsonElement<Boolean?>(requireNotNull(element)) }
      if (!raw.containsKey("external_user")) {
        throw SerializationException("InlineComponentsSchemasGenerationResponsePropertiesData is missing required " +
          "property 'external_user'")
      }
      val externalUser = raw["external_user"].let { element -> if (element == JsonNull) null else json
        .decodeFromJsonElement<String?>(requireNotNull(element)) }
      if (!raw.containsKey("finish_reason")) {
        throw SerializationException("InlineComponentsSchemasGenerationResponsePropertiesData is missing required " +
          "property 'finish_reason'")
      }
      val finishReason = raw["finish_reason"].let { element -> if (element == JsonNull) null else json
        .decodeFromJsonElement<String?>(requireNotNull(element)) }
      if (!raw.containsKey("generation_time")) {
        throw SerializationException("InlineComponentsSchemasGenerationResponsePropertiesData is missing required " +
          "property 'generation_time'")
      }
      val generationTime = raw["generation_time"].let { element -> if (element == JsonNull) null else json
        .decodeFromJsonElement<Double?>(requireNotNull(element)) }
      if (!raw.containsKey("http_referer")) {
        throw SerializationException("InlineComponentsSchemasGenerationResponsePropertiesData is missing required " +
          "property 'http_referer'")
      }
      val httpReferer = raw["http_referer"].let { element -> if (element == JsonNull) null else json
        .decodeFromJsonElement<String?>(requireNotNull(element)) }
      if (!raw.containsKey("latency")) {
        throw SerializationException("InlineComponentsSchemasGenerationResponsePropertiesData is missing required " +
          "property 'latency'")
      }
      val latency = raw["latency"].let { element -> if (element == JsonNull) null else json
        .decodeFromJsonElement<Double?>(requireNotNull(element)) }
      if (!raw.containsKey("moderation_latency")) {
        throw SerializationException("InlineComponentsSchemasGenerationResponsePropertiesData is missing required " +
          "property 'moderation_latency'")
      }
      val moderationLatency = raw["moderation_latency"].let { element -> if (element == JsonNull) null else json
        .decodeFromJsonElement<Double?>(requireNotNull(element)) }
      if (!raw.containsKey("native_finish_reason")) {
        throw SerializationException("InlineComponentsSchemasGenerationResponsePropertiesData is missing required " +
          "property 'native_finish_reason'")
      }
      val nativeFinishReason = raw["native_finish_reason"].let { element -> if (element == JsonNull) null else json
        .decodeFromJsonElement<String?>(requireNotNull(element)) }
      if (!raw.containsKey("native_tokens_cached")) {
        throw SerializationException("InlineComponentsSchemasGenerationResponsePropertiesData is missing required " +
          "property 'native_tokens_cached'")
      }
      val nativeTokensCached = raw["native_tokens_cached"].let { element -> if (element == JsonNull) null else json
        .decodeFromJsonElement<Int?>(requireNotNull(element)) }
      if (!raw.containsKey("native_tokens_completion")) {
        throw SerializationException("InlineComponentsSchemasGenerationResponsePropertiesData is missing required " +
          "property 'native_tokens_completion'")
      }
      val nativeTokensCompletion = raw["native_tokens_completion"].let { element ->
        if (element == JsonNull) null else json.decodeFromJsonElement<Int?>(requireNotNull(element)) }
      if (!raw.containsKey("native_tokens_completion_images")) {
        throw SerializationException("InlineComponentsSchemasGenerationResponsePropertiesData is missing required " +
          "property 'native_tokens_completion_images'")
      }
      val nativeTokensCompletionImages = raw["native_tokens_completion_images"].let { element ->
        if (element == JsonNull) null else json.decodeFromJsonElement<Int?>(requireNotNull(element)) }
      if (!raw.containsKey("native_tokens_prompt")) {
        throw SerializationException("InlineComponentsSchemasGenerationResponsePropertiesData is missing required " +
          "property 'native_tokens_prompt'")
      }
      val nativeTokensPrompt = raw["native_tokens_prompt"].let { element -> if (element == JsonNull) null else json
        .decodeFromJsonElement<Int?>(requireNotNull(element)) }
      if (!raw.containsKey("native_tokens_reasoning")) {
        throw SerializationException("InlineComponentsSchemasGenerationResponsePropertiesData is missing required " +
          "property 'native_tokens_reasoning'")
      }
      val nativeTokensReasoning = raw["native_tokens_reasoning"].let { element ->
        if (element == JsonNull) null else json.decodeFromJsonElement<Int?>(requireNotNull(element)) }
      if (!raw.containsKey("num_fetches")) {
        throw SerializationException("InlineComponentsSchemasGenerationResponsePropertiesData is missing required " +
          "property 'num_fetches'")
      }
      val numFetches = raw["num_fetches"].let { element -> if (element == JsonNull) null else json
        .decodeFromJsonElement<Int?>(requireNotNull(element)) }
      if (!raw.containsKey("num_input_audio_prompt")) {
        throw SerializationException("InlineComponentsSchemasGenerationResponsePropertiesData is missing required " +
          "property 'num_input_audio_prompt'")
      }
      val numInputAudioPrompt = raw["num_input_audio_prompt"].let { element -> if (element == JsonNull) null else json
        .decodeFromJsonElement<Int?>(requireNotNull(element)) }
      if (!raw.containsKey("num_media_completion")) {
        throw SerializationException("InlineComponentsSchemasGenerationResponsePropertiesData is missing required " +
          "property 'num_media_completion'")
      }
      val numMediaCompletion = raw["num_media_completion"].let { element -> if (element == JsonNull) null else json
        .decodeFromJsonElement<Int?>(requireNotNull(element)) }
      if (!raw.containsKey("num_media_prompt")) {
        throw SerializationException("InlineComponentsSchemasGenerationResponsePropertiesData is missing required " +
          "property 'num_media_prompt'")
      }
      val numMediaPrompt = raw["num_media_prompt"].let { element -> if (element == JsonNull) null else json
        .decodeFromJsonElement<Int?>(requireNotNull(element)) }
      if (!raw.containsKey("num_search_results")) {
        throw SerializationException("InlineComponentsSchemasGenerationResponsePropertiesData is missing required " +
          "property 'num_search_results'")
      }
      val numSearchResults = raw["num_search_results"].let { element -> if (element == JsonNull) null else json
        .decodeFromJsonElement<Int?>(requireNotNull(element)) }
      if (!raw.containsKey("preset_id")) {
        throw SerializationException("InlineComponentsSchemasGenerationResponsePropertiesData is missing required " +
          "property 'preset_id'")
      }
      val presetId = raw["preset_id"].let { element -> if (element == JsonNull) null else json
        .decodeFromJsonElement<String?>(requireNotNull(element)) }
      if (!raw.containsKey("provider_name")) {
        throw SerializationException("InlineComponentsSchemasGenerationResponsePropertiesData is missing required " +
          "property 'provider_name'")
      }
      val providerName = raw["provider_name"].let { element -> if (element == JsonNull) null else json
        .decodeFromJsonElement<String?>(requireNotNull(element)) }
      if (!raw.containsKey("provider_responses")) {
        throw SerializationException("InlineComponentsSchemasGenerationResponsePropertiesData is missing required " +
          "property 'provider_responses'")
      }
      val providerResponses = raw["provider_responses"].let { element -> if (element == JsonNull) null else json
        .decodeFromJsonElement<List<ProviderResponse>?>(requireNotNull(element)) }
      if (!raw.containsKey("router")) {
        throw SerializationException("InlineComponentsSchemasGenerationResponsePropertiesData is missing required " +
          "property 'router'")
      }
      val router = raw["router"].let { element -> if (element == JsonNull) null else json
        .decodeFromJsonElement<String?>(requireNotNull(element)) }
      if (!raw.containsKey("service_tier")) {
        throw SerializationException("InlineComponentsSchemasGenerationResponsePropertiesData is missing required " +
          "property 'service_tier'")
      }
      val serviceTier = raw["service_tier"].let { element -> if (element == JsonNull) null else json
        .decodeFromJsonElement<String?>(requireNotNull(element)) }
      if (!raw.containsKey("streamed")) {
        throw SerializationException("InlineComponentsSchemasGenerationResponsePropertiesData is missing required " +
          "property 'streamed'")
      }
      val streamed = raw["streamed"].let { element -> if (element == JsonNull) null else json
        .decodeFromJsonElement<Boolean?>(requireNotNull(element)) }
      if (!raw.containsKey("tokens_completion")) {
        throw SerializationException("InlineComponentsSchemasGenerationResponsePropertiesData is missing required " +
          "property 'tokens_completion'")
      }
      val tokensCompletion = raw["tokens_completion"].let { element -> if (element == JsonNull) null else json
        .decodeFromJsonElement<Int?>(requireNotNull(element)) }
      if (!raw.containsKey("tokens_prompt")) {
        throw SerializationException("InlineComponentsSchemasGenerationResponsePropertiesData is missing required " +
          "property 'tokens_prompt'")
      }
      val tokensPrompt = raw["tokens_prompt"].let { element -> if (element == JsonNull) null else json
        .decodeFromJsonElement<Int?>(requireNotNull(element)) }
      if (!raw.containsKey("upstream_id")) {
        throw SerializationException("InlineComponentsSchemasGenerationResponsePropertiesData is missing required " +
          "property 'upstream_id'")
      }
      val upstreamId = raw["upstream_id"].let { element -> if (element == JsonNull) null else json
        .decodeFromJsonElement<String?>(requireNotNull(element)) }
      if (!raw.containsKey("upstream_inference_cost")) {
        throw SerializationException("InlineComponentsSchemasGenerationResponsePropertiesData is missing required " +
          "property 'upstream_inference_cost'")
      }
      val upstreamInferenceCost = raw["upstream_inference_cost"].let { element ->
        if (element == JsonNull) null else json.decodeFromJsonElement<Double?>(requireNotNull(element)) }
      if (!raw.containsKey("user_agent")) {
        throw SerializationException("InlineComponentsSchemasGenerationResponsePropertiesData is missing required " +
          "property 'user_agent'")
      }
      val userAgent = raw["user_agent"].let { element -> if (element == JsonNull) null else json
        .decodeFromJsonElement<String?>(requireNotNull(element)) }
      if (!raw.containsKey("web_search_engine")) {
        throw SerializationException("InlineComponentsSchemasGenerationResponsePropertiesData is missing required " +
          "property 'web_search_engine'")
      }
      val webSearchEngine = raw["web_search_engine"].let { element -> if (element == JsonNull) null else json
        .decodeFromJsonElement<String?>(requireNotNull(element)) }
      return InlineComponentsSchemasGenerationResponsePropertiesData(
        apiType = apiType,
        appId = appId,
        ...
        userAgent = userAgent,
        webSearchEngine = webSearchEngine,
        requestIdState = json.decodeOptional(raw, "request_id", nullable = true),
        responseCacheSourceIdState = json.decodeOptional(raw, "response_cache_source_id", nullable = true),
        sessionIdState = json.decodeOptional(raw, "session_id", nullable = true),
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineComponentsSchemasGenerationResponsePropertiesData) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineComponentsSchemasGenerationResponsePropertiesData")
      ...
      val raw = buildJsonObject {
        ...
        put("native_tokens_completion_images", value.nativeTokensCompletionImages?.let { json
          .encodeToJsonElement(it) } ?: JsonNull)
...
public fun inlineComponentsSchemasGenerationResponsePropertiesData(block: InlineComponentsSchemasGenerationResponsePropertiesData.Builder.() -> Unit): InlineComponentsSchemasGenerationResponsePropertiesData = InlineComponentsSchemasGenerationResponsePropertiesData.build(block)
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineComponentsSchemasGenerationResponsePropertiesData property '" +
