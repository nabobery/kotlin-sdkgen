...
/**
 * Generated model for sdkgen://source/openapi.yaml#/components/schemas/ObservabilityS3Destination.
 */
@Serializable(with = ObservabilityS3Destination.Serializer::class)
public class ObservabilityS3Destination(
  /**
  ...
  public class Builder {
    private var configValue: InlineComponentsSchemasObservabilityS3DestinationPropertiesConfig? =
        null

    public var config: InlineComponentsSchemasObservabilityS3DestinationPropertiesConfig
    ...
    private var typeValue: InlineComponentsSchemasObservabilityS3DestinationPropertiesType? = null

    public var type: InlineComponentsSchemasObservabilityS3DestinationPropertiesType
    ...
    public fun build(): ObservabilityS3Destination {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): ObservabilityS3Destination = Builder().apply(block).build()
  }

  public object Serializer : KSerializer<ObservabilityS3Destination> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): ObservabilityS3Destination {
      val jsonDecoder = decoder.requireJsonDecoder("ObservabilityS3Destination")
      val json = jsonDecoder.json
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("ObservabilityS3Destination must be a JSON object")
      val config = json.decodeRequired<InlineComponentsSchemasObservabilityS3DestinationPropertiesConfig>(raw, "config")
      ...
      val type = json.decodeRequired<InlineComponentsSchemasObservabilityS3DestinationPropertiesType>(raw, "type")
      ...
      if (!raw.containsKey("api_key_hashes")) {
        throw SerializationException("ObservabilityS3Destination is missing required property 'api_key_hashes'")
      }
      ...
      if (!raw.containsKey("filter_rules")) {
        throw SerializationException("ObservabilityS3Destination is missing required property 'filter_rules'")
      }
      ...
      if (!raw.containsKey("name")) {
        throw SerializationException("ObservabilityS3Destination is missing required property 'name'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: ObservabilityS3Destination) {
      val jsonEncoder = encoder.requireJsonEncoder("ObservabilityS3Destination")
...
public fun observabilityS3Destination(block: ObservabilityS3Destination.Builder.() ->
  Unit): ObservabilityS3Destination = ObservabilityS3Destination.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("ObservabilityS3Destination is missing required property '" +
    name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("ObservabilityS3Destination property '" + name + "' is not nullable")
