...
public class OutputAdvisorServerToolItem(
  ...
  public val type: InlineComponentsSchemasOutputAdvisorServerToolItemPropertiesType,
  /**
  ...
  public class Builder {
    ...
    private var typeValue: InlineComponentsSchemasOutputAdvisorServerToolItemPropertiesType? = null

    public var type: InlineComponentsSchemasOutputAdvisorServerToolItemPropertiesType
  ...
  public object Serializer : KSerializer<OutputAdvisorServerToolItem> {
    ...
    override fun deserialize(decoder: Decoder): OutputAdvisorServerToolItem {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("OutputAdvisorServerToolItem must be a JSON object")
      val status = json.decodeRequired<ToolCallStatus>(raw, "status")
      val type = json.decodeRequired<InlineComponentsSchemasOutputAdvisorServerToolItemPropertiesType>(raw, "type")
      return OutputAdvisorServerToolItem(
        status = status,
        type = type,
        advice = raw["advice"]?.let { json.decodeFromJsonElement<String>(it) },
        error = raw["error"]?.let { json.decodeFromJsonElement<String>(it) },
        id = raw["id"]?.let { json.decodeFromJsonElement<String>(it) },
        instanceName = raw["instance_name"]?.let { json.decodeFromJsonElement<String>(it) },
...
public fun outputAdvisorServerToolItem(block: OutputAdvisorServerToolItem.Builder.() ->
  Unit): OutputAdvisorServerToolItem = OutputAdvisorServerToolItem.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("OutputAdvisorServerToolItem is missing required property '" + name + "'")
