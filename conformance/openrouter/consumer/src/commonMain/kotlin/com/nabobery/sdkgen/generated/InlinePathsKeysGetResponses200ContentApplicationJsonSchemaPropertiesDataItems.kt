 ...
 */
@Serializable(with = InlinePathsKeysGetResponses200ContentApplicationJsonSchemaPropertiesDataItems.Serializer::class)
public class InlinePathsKeysGetResponses200ContentApplicationJsonSchemaPropertiesDataItems internal constructor(
  /**
  ...
  public class Builder {
    ...
    public fun build(): InlinePathsKeysGetResponses200ContentApplicationJsonSchemaPropertiesDataItems {
      ...
      return InlinePathsKeysGetResponses200ContentApplicationJsonSchemaPropertiesDataItems(
        byokUsage = byokUsage,
        byokUsageDaily = byokUsageDaily,
        byokUsageMonthly = byokUsageMonthly,
        byokUsageWeekly = byokUsageWeekly,
  ...
  public companion object {
    public fun build(block: Builder.() ->
      Unit): InlinePathsKeysGetResponses200ContentApplicationJsonSchemaPropertiesDataItems = Builder().apply(block)
        .build()
  }

  public object Serializer : KSerializer<InlinePathsKeysGetResponses200ContentApplicationJsonSchemaPropertiesDataItems> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlinePathsKeysGetResponses200ContentApplicationJsonSchemaPropertiesDataItems {
      val jsonDecoder = decoder
        .requireJsonDecoder("InlinePathsKeysGetResponses200ContentApplicationJsonSchemaPropertiesDataItems")
      val json = jsonDecoder.json
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("InlinePathsKeysGetResponses200ContentApplicationJsonSchemaPropertiesDataItems " +
      ...
      val hash = json.decodeRequired<String>(raw, "hash")
      ...
      if (!raw.containsKey("creator_user_id")) {
        throw SerializationException("InlinePathsKeysGetResponses200ContentApplicationJsonSchemaPropertiesDataItems " +
          "is missing required property 'creator_user_id'")
      }
      ...
      if (!raw.containsKey("limit")) {
        throw SerializationException("InlinePathsKeysGetResponses200ContentApplicationJsonSchemaPropertiesDataItems " +
          "is missing required property 'limit'")
      }
    ...
    override fun serialize(encoder: Encoder,
      `value`: InlinePathsKeysGetResponses200ContentApplicationJsonSchemaPropertiesDataItems) {
      val jsonEncoder = encoder
        .requireJsonEncoder("InlinePathsKeysGetResponses200ContentApplicationJsonSchemaPropertiesDataItems")
...
public fun inlinePathsKeysGetResponses200ContentApplicationJsonSchemaPropertiesDataItems(block: InlinePathsKeysGetResponses200ContentApplicationJsonSchemaPropertiesDataItems.Builder.() -> Unit): InlinePathsKeysGetResponses200ContentApplicationJsonSchemaPropertiesDataItems = InlinePathsKeysGetResponses200ContentApplicationJsonSchemaPropertiesDataItems.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("InlinePathsKeysGetResponses200ContentApplicationJsonSchemaPropertiesDataItems is " +
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlinePathsKeysGetResponses200ContentApplicationJsonSchemaPropertiesDataItems " +
