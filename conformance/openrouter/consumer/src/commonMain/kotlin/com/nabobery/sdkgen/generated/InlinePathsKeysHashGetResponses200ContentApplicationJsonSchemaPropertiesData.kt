 ...
 */
@Serializable(with = InlinePathsKeysHashGetResponses200ContentApplicationJsonSchemaPropertiesData.Serializer::class)
public class InlinePathsKeysHashGetResponses200ContentApplicationJsonSchemaPropertiesData internal constructor(
  /**
  ...
  public class Builder {
    ...
    public fun build(): InlinePathsKeysHashGetResponses200ContentApplicationJsonSchemaPropertiesData {
      ...
      return InlinePathsKeysHashGetResponses200ContentApplicationJsonSchemaPropertiesData(
        byokUsage = byokUsage,
        byokUsageDaily = byokUsageDaily,
        byokUsageMonthly = byokUsageMonthly,
        byokUsageWeekly = byokUsageWeekly,
  ...
  public companion object {
    public fun build(block: Builder.() ->
      Unit): InlinePathsKeysHashGetResponses200ContentApplicationJsonSchemaPropertiesData = Builder().apply(block)
        .build()
  }

  public object Serializer : KSerializer<InlinePathsKeysHashGetResponses200ContentApplicationJsonSchemaPropertiesData> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlinePathsKeysHashGetResponses200ContentApplicationJsonSchemaPropertiesData {
      val jsonDecoder = decoder
        .requireJsonDecoder("InlinePathsKeysHashGetResponses200ContentApplicationJsonSchemaPropertiesData")
      val json = jsonDecoder.json
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("InlinePathsKeysHashGetResponses200ContentApplicationJsonSchemaPropertiesData " +
      ...
      if (!raw.containsKey("creator_user_id")) {
        throw SerializationException("InlinePathsKeysHashGetResponses200ContentApplicationJsonSchemaPropertiesData is " +
      ...
      if (!raw.containsKey("updated_at")) {
        throw SerializationException("InlinePathsKeysHashGetResponses200ContentApplicationJsonSchemaPropertiesData is " +
          "missing required property 'updated_at'")
      }
    ...
    override fun serialize(encoder: Encoder,
      `value`: InlinePathsKeysHashGetResponses200ContentApplicationJsonSchemaPropertiesData) {
      val jsonEncoder = encoder
        .requireJsonEncoder("InlinePathsKeysHashGetResponses200ContentApplicationJsonSchemaPropertiesData")
...
public fun inlinePathsKeysHashGetResponses200ContentApplicationJsonSchemaPropertiesData(block: InlinePathsKeysHashGetResponses200ContentApplicationJsonSchemaPropertiesData.Builder.() -> Unit): InlinePathsKeysHashGetResponses200ContentApplicationJsonSchemaPropertiesData = InlinePathsKeysHashGetResponses200ContentApplicationJsonSchemaPropertiesData.build(block)
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlinePathsKeysHashGetResponses200ContentApplicationJsonSchemaPropertiesData " +
