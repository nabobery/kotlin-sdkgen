...
public class GetWorkspaceResponse(
  ...
  public object Serializer : KSerializer<GetWorkspaceResponse> {
    ...
    override fun deserialize(decoder: Decoder): GetWorkspaceResponse {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("GetWorkspaceResponse must be a JSON object")
...
public fun getWorkspaceResponse(block: GetWorkspaceResponse.Builder.() -> Unit): GetWorkspaceResponse =
  GetWorkspaceResponse.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("GetWorkspaceResponse is missing required property '" +
    name + "'")
