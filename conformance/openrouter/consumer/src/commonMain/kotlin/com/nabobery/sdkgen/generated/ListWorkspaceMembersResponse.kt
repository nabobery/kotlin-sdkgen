...
public class ListWorkspaceMembersResponse(
  ...
  public object Serializer : KSerializer<ListWorkspaceMembersResponse> {
    ...
    override fun deserialize(decoder: Decoder): ListWorkspaceMembersResponse {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("ListWorkspaceMembersResponse must be a JSON object")
...
public fun listWorkspaceMembersResponse(block: ListWorkspaceMembersResponse.Builder.() ->
  Unit): ListWorkspaceMembersResponse = ListWorkspaceMembersResponse.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("ListWorkspaceMembersResponse is missing required property '" + name + "'")
