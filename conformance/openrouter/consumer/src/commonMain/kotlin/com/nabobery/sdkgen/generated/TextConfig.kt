...
public class TextConfig(
  ...
  public val verbosity: InlineComponentsSchemasTextConfigPropertiesVerbosity? = null,
) {
  public class Builder {
    public var format: Formats? = null

    public var verbosity: InlineComponentsSchemasTextConfigPropertiesVerbosity? = null
  ...
  public object Serializer : KSerializer<TextConfig> {
    ...
    override fun deserialize(decoder: Decoder): TextConfig {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("TextConfig must be a JSON object")
      return TextConfig(
        format = raw["format"]?.let { json.decodeFromJsonElement<Formats>(it) },
        verbosity = raw["verbosity"]?.let { element -> if (element == JsonNull) null else json
          .decodeFromJsonElement<InlineComponentsSchemasTextConfigPropertiesVerbosity?>(element) },
      )
    }
