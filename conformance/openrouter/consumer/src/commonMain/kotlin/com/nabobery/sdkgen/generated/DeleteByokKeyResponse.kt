...
public class DeleteByokKeyResponse(
  ...
  public object Serializer : KSerializer<DeleteByokKeyResponse> {
    ...
    override fun deserialize(decoder: Decoder): DeleteByokKeyResponse {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("DeleteByokKeyResponse must be a JSON object")
...
public fun deleteByokKeyResponse(block: DeleteByokKeyResponse.Builder.() -> Unit): DeleteByokKeyResponse =
  DeleteByokKeyResponse.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("DeleteByokKeyResponse is missing required property '" +
    name + "'")
