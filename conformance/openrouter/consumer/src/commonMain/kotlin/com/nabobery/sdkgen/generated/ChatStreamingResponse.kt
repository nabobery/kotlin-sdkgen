...
public class ChatStreamingResponse(
  ...
  public object Serializer : KSerializer<ChatStreamingResponse> {
    ...
    override fun deserialize(decoder: Decoder): ChatStreamingResponse {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("ChatStreamingResponse must be a JSON object")
      val data = json.decodeRequired<ChatStreamChunk>(raw, "data")
      return ChatStreamingResponse(
        data = data,
      )
    }
...
public fun chatStreamingResponse(block: ChatStreamingResponse.Builder.() -> Unit): ChatStreamingResponse =
  ChatStreamingResponse.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("ChatStreamingResponse is missing required property '" +
    name + "'")
