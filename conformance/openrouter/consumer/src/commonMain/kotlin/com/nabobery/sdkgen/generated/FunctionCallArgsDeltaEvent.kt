...
public class FunctionCallArgsDeltaEvent(
  ...
  public object Serializer : KSerializer<FunctionCallArgsDeltaEvent> {
    ...
    override fun deserialize(decoder: Decoder): FunctionCallArgsDeltaEvent {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("FunctionCallArgsDeltaEvent must be a JSON object")
...
public fun functionCallArgsDeltaEvent(block: FunctionCallArgsDeltaEvent.Builder.() ->
  Unit): FunctionCallArgsDeltaEvent = FunctionCallArgsDeltaEvent.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("FunctionCallArgsDeltaEvent is missing required property '" +
    name + "'")
