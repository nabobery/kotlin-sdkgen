...
public class AnthropicContainer(
  ...
  public object Serializer : KSerializer<AnthropicContainer> {
    ...
    override fun deserialize(decoder: Decoder): AnthropicContainer {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("AnthropicContainer must be a JSON object")
      val expiresAt = json.decodeRequired<String>(raw, "expires_at")
...
public fun anthropicContainer(block: AnthropicContainer.Builder.() -> Unit): AnthropicContainer = AnthropicContainer
  .build(block)
