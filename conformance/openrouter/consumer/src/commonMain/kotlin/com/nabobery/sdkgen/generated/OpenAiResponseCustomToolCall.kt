...
public data class OpenAiResponseCustomToolCallView(
  ...
  public val type: InlineComponentsSchemasOpenAiResponseCustomToolCallPropertiesType,
)
...
public class OpenAiResponseCustomToolCall(
  ...
  public class Builder {
    ...
    private var typeValue: InlineComponentsSchemasOpenAiResponseCustomToolCallPropertiesType? = null

    public var type: InlineComponentsSchemasOpenAiResponseCustomToolCallPropertiesType
  ...
  public object Serializer : KSerializer<OpenAiResponseCustomToolCall> {
    ...
    override fun deserialize(decoder: Decoder): OpenAiResponseCustomToolCall {
      ...
      val raw = jsonDecoder.decodeJsonElement() as? JsonObject ?:
        throw SerializationException("OpenAiResponseCustomToolCall must be a JSON object")
      ...
      val type = json.decodeRequired<InlineComponentsSchemasOpenAiResponseCustomToolCallPropertiesType>(raw, "type")
      return OpenAiResponseCustomToolCall(
        callId = callId,
        input = input,
        name = name,
...
public fun openAiResponseCustomToolCall(block: OpenAiResponseCustomToolCall.Builder.() ->
  Unit): OpenAiResponseCustomToolCall = OpenAiResponseCustomToolCall.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?:
    throw SerializationException("OpenAiResponseCustomToolCall is missing required property '" + name + "'")
