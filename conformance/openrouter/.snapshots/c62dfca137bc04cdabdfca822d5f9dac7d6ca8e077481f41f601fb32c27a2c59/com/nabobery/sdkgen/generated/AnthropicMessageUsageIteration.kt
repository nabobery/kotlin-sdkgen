 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/AnthropicMessageUsageIteration
 */
...
public class AnthropicMessageUsageIteration(
  ...
  internal object Serializer : KSerializer<AnthropicMessageUsageIteration> {
    ...
    override fun deserialize(decoder: Decoder): AnthropicMessageUsageIteration {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("AnthropicMessageUsageIteration must be a JSON object")
...
public fun anthropicMessageUsageIteration(block: AnthropicMessageUsageIteration.Builder.() -> Unit): AnthropicMessageUsageIteration = AnthropicMessageUsageIteration.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("AnthropicMessageUsageIteration is missing required property '" + name + "'")
