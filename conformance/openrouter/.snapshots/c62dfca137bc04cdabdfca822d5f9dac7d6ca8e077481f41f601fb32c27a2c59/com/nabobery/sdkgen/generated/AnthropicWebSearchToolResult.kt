 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/AnthropicWebSearchToolResult
 */
...
public class AnthropicWebSearchToolResult(
  ...
  public class Builder {
    ...
    private var contentValue: InlineAnthropicWebSearchToolResultContentX8bf35e95? = null

    public var content: InlineAnthropicWebSearchToolResultContentX8bf35e95
    ...
    private var typeValue: InlineAnthropicWebSearchToolResultTypeX0fb13727? = null

    public var type: InlineAnthropicWebSearchToolResultTypeX0fb13727
  ...
  internal object Serializer : KSerializer<AnthropicWebSearchToolResult> {
    ...
    override fun deserialize(decoder: Decoder): AnthropicWebSearchToolResult {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("AnthropicWebSearchToolResult must be a JSON object")
      val caller = json.decodeRequired<AnthropicCaller>(rawObject, "caller")
      val content = json.decodeRequired<InlineAnthropicWebSearchToolResultContentX8bf35e95>(rawObject, "content")
      val toolUseId = json.decodeRequired<String>(rawObject, "tool_use_id")
      val type = json.decodeRequired<InlineAnthropicWebSearchToolResultTypeX0fb13727>(rawObject, "type")
      return AnthropicWebSearchToolResult(
        caller = caller,
        content = content,
        toolUseId = toolUseId,
...
public fun anthropicWebSearchToolResult(block: AnthropicWebSearchToolResult.Builder.() -> Unit): AnthropicWebSearchToolResult = AnthropicWebSearchToolResult.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("AnthropicWebSearchToolResult is missing required property '" + name + "'")
