 ...
 *
 * Source:
 * sdkgen://source/openapi.yaml#/paths/~1keys~1{hash}/get/responses/200/content/application~1json/schema/properties/data
 */
@Serializable(with = InlineKeysGetResponse200JsonDataX5145d42b.Serializer::class)
public class InlineKeysGetResponse200JsonDataX5145d42b internal constructor(
  /**
  ...
  public class Builder {
    ...
    public fun build(): InlineKeysGetResponse200JsonDataX5145d42b {
      ...
      return InlineKeysGetResponse200JsonDataX5145d42b(
        byokUsage = byokUsage,
        byokUsageDaily = byokUsageDaily,
        byokUsageMonthly = byokUsageMonthly,
        byokUsageWeekly = byokUsageWeekly,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineKeysGetResponse200JsonDataX5145d42b = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineKeysGetResponse200JsonDataX5145d42b> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineKeysGetResponse200JsonDataX5145d42b {
      val jsonDecoder = decoder.requireJsonDecoder("InlineKeysGetResponse200JsonDataX5145d42b")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineKeysGetResponse200JsonDataX5145d42b must be a JSON object")
      ...
      if (!rawObject.containsKey("creator_user_id")) {
        throw SerializationException("InlineKeysGetResponse200JsonDataX5145d42b is missing required property 'creator_user_id'")
      }
      ...
      if (!rawObject.containsKey("limit")) {
        throw SerializationException("InlineKeysGetResponse200JsonDataX5145d42b is missing required property 'limit'")
      }
      ...
      if (!rawObject.containsKey("limit_remaining")) {
        throw SerializationException("InlineKeysGetResponse200JsonDataX5145d42b is missing required property 'limit_remaining'")
      }
      ...
      if (!rawObject.containsKey("limit_reset")) {
        throw SerializationException("InlineKeysGetResponse200JsonDataX5145d42b is missing required property 'limit_reset'")
      }
      ...
      if (!rawObject.containsKey("updated_at")) {
        throw SerializationException("InlineKeysGetResponse200JsonDataX5145d42b is missing required property 'updated_at'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineKeysGetResponse200JsonDataX5145d42b) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineKeysGetResponse200JsonDataX5145d42b")
...
public fun inlineKeysGetResponse200JsonDataX5145d42b(block: InlineKeysGetResponse200JsonDataX5145d42b.Builder.() -> Unit): InlineKeysGetResponse200JsonDataX5145d42b = InlineKeysGetResponse200JsonDataX5145d42b.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineKeysGetResponse200JsonDataX5145d42b is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineKeysGetResponse200JsonDataX5145d42b property '" + name + "' is not nullable")
