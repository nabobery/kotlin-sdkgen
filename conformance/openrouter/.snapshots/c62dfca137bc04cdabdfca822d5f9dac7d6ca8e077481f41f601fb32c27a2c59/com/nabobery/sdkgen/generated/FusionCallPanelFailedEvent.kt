 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/FusionCallPanelFailedEvent
 */
...
public class FusionCallPanelFailedEvent(
  ...
  public class Builder {
    ...
    private var typeValue: InlineFusionCallPanelFailedEventTypeXf84539ef? = null

    public var type: InlineFusionCallPanelFailedEventTypeXf84539ef
  ...
  internal object Serializer : KSerializer<FusionCallPanelFailedEvent> {
    ...
    override fun deserialize(decoder: Decoder): FusionCallPanelFailedEvent {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("FusionCallPanelFailedEvent must be a JSON object")
      ...
      val type = json.decodeRequired<InlineFusionCallPanelFailedEventTypeXf84539ef>(rawObject, "type")
      return FusionCallPanelFailedEvent(
        error = error,
        itemId = itemId,
        model = model,
...
public fun fusionCallPanelFailedEvent(block: FusionCallPanelFailedEvent.Builder.() -> Unit): FusionCallPanelFailedEvent = FusionCallPanelFailedEvent.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("FusionCallPanelFailedEvent is missing required property '" + name + "'")
