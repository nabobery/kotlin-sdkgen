 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/ObservabilityDatadogDestination
 */
...
public class ObservabilityDatadogDestination(
  ...
  public class Builder {
    private var configValue: InlineObservabilityDatadogDestinationConfigX54fdef51? = null

    public var config: InlineObservabilityDatadogDestinationConfigX54fdef51
    ...
    private var typeValue: InlineObservabilityDatadogDestinationTypeXaafd1c26? = null

    public var type: InlineObservabilityDatadogDestinationTypeXaafd1c26
  ...
  internal object Serializer : KSerializer<ObservabilityDatadogDestination> {
    ...
    override fun deserialize(decoder: Decoder): ObservabilityDatadogDestination {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("ObservabilityDatadogDestination must be a JSON object")
      val config = json.decodeRequired<InlineObservabilityDatadogDestinationConfigX54fdef51>(rawObject, "config")
      ...
      val type = json.decodeRequired<InlineObservabilityDatadogDestinationTypeXaafd1c26>(rawObject, "type")
...
public fun observabilityDatadogDestination(block: ObservabilityDatadogDestination.Builder.() -> Unit): ObservabilityDatadogDestination = ObservabilityDatadogDestination.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("ObservabilityDatadogDestination is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("ObservabilityDatadogDestination property '" + name + "' is not nullable")
