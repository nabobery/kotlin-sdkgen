 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/VideoGenerationUsage
 */
...
public class VideoGenerationUsage(
  ...
  internal object Serializer : KSerializer<VideoGenerationUsage> {
    ...
    override fun deserialize(decoder: Decoder): VideoGenerationUsage {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("VideoGenerationUsage must be a JSON object")
...
public fun videoGenerationUsage(block: VideoGenerationUsage.Builder.() -> Unit): VideoGenerationUsage = VideoGenerationUsage.build(block)
