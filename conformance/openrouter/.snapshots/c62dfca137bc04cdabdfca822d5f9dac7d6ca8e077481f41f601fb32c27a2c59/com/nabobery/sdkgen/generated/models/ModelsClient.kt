...
public class ModelsClient(
  ...
  public suspend fun getModels(
    ...
    val engine = PaginationEngine<ModelsListResponse, Model>(
          descriptor = requireNotNull(getModelsMetadata.pagination as? PaginationDescriptor.OffsetLimit),
          operationId = getModelsMetadata.operationId,
          requestedPageSize = limit,
          initialOffset = offset?.toLong() ?: 0L,
        )
    return engine.firstPage { pageRequest -> fetchgetModelsPage(Unit, arch, category, context, distillable, inputModalities, limit, maxAgeDays, maxAgenticIndex, maxCodingIndex, maxIntelligenceIndex, maxOutputPrice, maxPrice, maxToolSuccessRate, minAgeDays, minAgenticIndex, minCodingIndex, minIntelligenceIndex, minOutputPrice, minPrice, minToolSuccessRate, modelAuthors, offset, outputModalities, providers, q, region, sort, supportedParameters, zdr, httpReferer, xOpenRouterCategories, xOpenRouterTitle, pageRequest, options) }
  }
  ...
  /**
   * Returns a cold page flow for getModels.
   *
   * @param arch Filter models by architecture/model family (e.g. GPT, Claude, Gemini, Llama).
   * @param category Filter models by use case category
   * @param context Minimum context length (tokens). Models with smaller context are excluded.
  ...
  public fun getModelsPages(
    ...
    requestedPageSize = limit,
    initialOffset = offset?.toLong() ?: 0L,
  ).pages(fetch = { pageRequest -> fetchgetModelsPage(Unit, arch, category, context, distillable, inputModalities, limit, maxAgeDays, maxAgenticIndex, maxCodingIndex, maxIntelligenceIndex, maxOutputPrice, maxPrice, maxToolSuccessRate, minAgeDays, minAgenticIndex, minCodingIndex, minIntelligenceIndex, minOutputPrice, minPrice, minToolSuccessRate, modelAuthors, offset, outputModalities, providers, q, region, sort, supportedParameters, zdr, httpReferer, xOpenRouterCategories, xOpenRouterTitle, pageRequest, options) }, pagination = options.pagination)

  /**
   * Returns a cold item flow for getModels.
   *
   * @param options Execution options, including pagination bounds.
   */
  public fun getModelsItems(
    arch: String? = null,
    category: InlineModelsGetParameterX6456382f? = null,
    context: Int? = null,
    distillable: InlineModelsGetParameterX490d8ee9? = null,
    ...
    requestedPageSize = limit,
    initialOffset = offset?.toLong() ?: 0L,
  ).items(fetch = { pageRequest -> fetchgetModelsPage(Unit, arch, category, context, distillable, inputModalities, limit, maxAgeDays, maxAgenticIndex, maxCodingIndex, maxIntelligenceIndex, maxOutputPrice, maxPrice, maxToolSuccessRate, minAgeDays, minAgenticIndex, minCodingIndex, minIntelligenceIndex, minOutputPrice, minPrice, minToolSuccessRate, modelAuthors, offset, outputModalities, providers, q, region, sort, supportedParameters, zdr, httpReferer, xOpenRouterCategories, xOpenRouterTitle, pageRequest, options) }, pagination = options.pagination)

  private fun metadataForGetModelsPage(
    ...
    xOpenRouterCategories: String? = null,
    xOpenRouterTitle: String? = null,
  ): OperationMetadata = getModelsMetadata

  private suspend fun fetchgetModelsPage(
    request: Unit,
    arch: String? = null,
    category: InlineModelsGetParameterX6456382f? = null,
    context: Int? = null,
    ...
    val pageMetadata = metadataForGetModelsPage(pageRequest, arch, category, context, distillable, inputModalities, limit, maxAgeDays, maxAgenticIndex, maxCodingIndex, maxIntelligenceIndex, maxOutputPrice, maxPrice, maxToolSuccessRate, minAgeDays, minAgenticIndex, minCodingIndex, minIntelligenceIndex, minOutputPrice, minPrice, minToolSuccessRate, modelAuthors, offset, outputModalities, providers, q, region, sort, supportedParameters, zdr, httpReferer, xOpenRouterCategories, xOpenRouterTitle)
    val response = executor.execute<Unit, ModelsListResponse>(SdkExecutionRequest(pageMetadata, baseUri, pageRequestValue, emptyList(), buildList {
      ...
      add(SdkRequestParameter(location = SdkParameterLocation.HEADER, name = "X-OpenRouter-Categories", values = xOpenRouterCategories?.let { listOf(it.toString()) }.orEmpty()))
      add(SdkRequestParameter(location = SdkParameterLocation.HEADER, name = "X-OpenRouter-Title", values = xOpenRouterTitle?.let { listOf(it.toString()) }.orEmpty()))
    }), listOf(ModelsCodecs.GETMODELS_RESPONSE_CODEC_ID), ModelsCodecs.getModelsRequestCodecRegistry, ModelsCodecs.getModelsResponseCodecRegistry, options)
  ...
  public suspend fun listModelsUser(
    ...
    val engine = PaginationEngine<ModelsListResponse, Model>(
          descriptor = requireNotNull(listModelsUserMetadata.pagination as? PaginationDescriptor.OffsetLimit),
          operationId = listModelsUserMetadata.operationId,
          requestedPageSize = limit,
          initialOffset = offset?.toLong() ?: 0L,
        )
    return engine.firstPage { pageRequest -> fetchlistModelsUserPage(Unit, limit, offset, httpReferer, xOpenRouterCategories, xOpenRouterTitle, pageRequest, options) }
  }
  ...
  /**
   * Returns a cold page flow for listModelsUser.
   *
   * @param limit Maximum number of records to return (max 1000). When both offset and limit are omitted, the full list
   * is returned
   * @param offset Number of records to skip for pagination. When both offset and limit are omitted, the full list is
   ...
   * @param options Execution options, including pagination bounds.
   */
  public fun listModelsUserPages(
    limit: Int? = null,
    offset: Int? = null,
    httpReferer: String? = null,
    xOpenRouterCategories: String? = null,
    ...
    requestedPageSize = limit,
    initialOffset = offset?.toLong() ?: 0L,
  ).pages(fetch = { pageRequest -> fetchlistModelsUserPage(Unit, limit, offset, httpReferer, xOpenRouterCategories, xOpenRouterTitle, pageRequest, options) }, pagination = options.pagination)

  /**
   * Returns a cold item flow for listModelsUser.
   *
   * @param options Execution options, including pagination bounds.
   */
  public fun listModelsUserItems(
    limit: Int? = null,
    offset: Int? = null,
    httpReferer: String? = null,
    xOpenRouterCategories: String? = null,
    ...
    requestedPageSize = limit,
    initialOffset = offset?.toLong() ?: 0L,
  ).items(fetch = { pageRequest -> fetchlistModelsUserPage(Unit, limit, offset, httpReferer, xOpenRouterCategories, xOpenRouterTitle, pageRequest, options) }, pagination = options.pagination)

  private fun metadataForListModelsUserPage(
    pageRequest: PageRequest,
    limit: Int? = null,
    offset: Int? = null,
    httpReferer: String? = null,
    xOpenRouterCategories: String? = null,
    xOpenRouterTitle: String? = null,
  ): OperationMetadata = listModelsUserMetadata

  private suspend fun fetchlistModelsUserPage(
    request: Unit,
    limit: Int? = null,
    offset: Int? = null,
    httpReferer: String? = null,
    ...
    val pageMetadata = metadataForListModelsUserPage(pageRequest, limit, offset, httpReferer, xOpenRouterCategories, xOpenRouterTitle)
    val response = executor.execute<Unit, ModelsListResponse>(SdkExecutionRequest(pageMetadata, baseUri, pageRequestValue, emptyList(), buildList {
      add(SdkRequestParameter(location = SdkParameterLocation.QUERY, name = "limit", values = limit?.let { listOf(it.toString()) }.orEmpty()))
      add(SdkRequestParameter(location = SdkParameterLocation.QUERY, name = "offset", values = when (pageRequest) {
        is PageRequest.NextOffset -> listOf(pageRequest.offset.toString())
      ...
      add(SdkRequestParameter(location = SdkParameterLocation.HEADER, name = "X-OpenRouter-Categories", values = xOpenRouterCategories?.let { listOf(it.toString()) }.orEmpty()))
      add(SdkRequestParameter(location = SdkParameterLocation.HEADER, name = "X-OpenRouter-Title", values = xOpenRouterTitle?.let { listOf(it.toString()) }.orEmpty()))
    }), listOf(ModelsCodecs.LISTMODELSUSER_RESPONSE_CODEC_ID), ModelsCodecs.listModelsUserRequestCodecRegistry, ModelsCodecs.listModelsUserResponseCodecRegistry, options)
    return PageEnvelope(value = response, items = response.data.orEmpty())
  }
