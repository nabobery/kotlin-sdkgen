 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/StopServerToolsWhenStepCountIs
 */
...
public class StopServerToolsWhenStepCountIs(
  ...
  public class Builder {
    ...
    private var typeValue: InlineStopServerToolsWhenStepCountIsTypeXb5e4dd48? = null

    public var type: InlineStopServerToolsWhenStepCountIsTypeXb5e4dd48
  ...
  internal object Serializer : KSerializer<StopServerToolsWhenStepCountIs> {
    ...
    override fun deserialize(decoder: Decoder): StopServerToolsWhenStepCountIs {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("StopServerToolsWhenStepCountIs must be a JSON object")
      val stepCount = json.decodeRequired<Int>(rawObject, "step_count")
      val type = json.decodeRequired<InlineStopServerToolsWhenStepCountIsTypeXb5e4dd48>(rawObject, "type")
      return StopServerToolsWhenStepCountIs(
        stepCount = stepCount,
        type = type,
      )
...
public fun stopServerToolsWhenStepCountIs(block: StopServerToolsWhenStepCountIs.Builder.() -> Unit): StopServerToolsWhenStepCountIs = StopServerToolsWhenStepCountIs.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("StopServerToolsWhenStepCountIs is missing required property '" + name + "'")
