 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/ReasoningSummaryPartDoneEvent
 */
...
public class ReasoningSummaryPartDoneEvent(
  ...
  internal object Serializer : KSerializer<ReasoningSummaryPartDoneEvent> {
    ...
    override fun deserialize(decoder: Decoder): ReasoningSummaryPartDoneEvent {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("ReasoningSummaryPartDoneEvent must be a JSON object")
...
public fun reasoningSummaryPartDoneEvent(block: ReasoningSummaryPartDoneEvent.Builder.() -> Unit): ReasoningSummaryPartDoneEvent = ReasoningSummaryPartDoneEvent.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("ReasoningSummaryPartDoneEvent is missing required property '" + name + "'")
