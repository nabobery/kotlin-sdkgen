 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/UpdateWorkspaceResponse
 */
...
public class UpdateWorkspaceResponse(
  ...
  internal object Serializer : KSerializer<UpdateWorkspaceResponse> {
    ...
    override fun deserialize(decoder: Decoder): UpdateWorkspaceResponse {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("UpdateWorkspaceResponse must be a JSON object")
...
public fun updateWorkspaceResponse(block: UpdateWorkspaceResponse.Builder.() -> Unit): UpdateWorkspaceResponse = UpdateWorkspaceResponse.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("UpdateWorkspaceResponse is missing required property '" + name + "'")
