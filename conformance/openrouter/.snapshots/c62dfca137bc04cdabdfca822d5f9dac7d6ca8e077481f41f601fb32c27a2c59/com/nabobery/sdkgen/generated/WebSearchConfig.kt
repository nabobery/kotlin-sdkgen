...
/**
 * Generated model for sdkgen://source/openapi.yaml#/components/schemas/WebSearchConfig.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/WebSearchConfig
 */
@Serializable(with = WebSearchConfig.Serializer::class)
public class WebSearchConfig(
  ...
  public class Builder {
    ...
    public fun build(): WebSearchConfig = WebSearchConfig(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): WebSearchConfig = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<WebSearchConfig> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): WebSearchConfig {
      val jsonDecoder = decoder.requireJsonDecoder("WebSearchConfig")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("WebSearchConfig must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: WebSearchConfig) {
      val jsonEncoder = encoder.requireJsonEncoder("WebSearchConfig")
...
public fun webSearchConfig(block: WebSearchConfig.Builder.() -> Unit): WebSearchConfig = WebSearchConfig.build(block)
