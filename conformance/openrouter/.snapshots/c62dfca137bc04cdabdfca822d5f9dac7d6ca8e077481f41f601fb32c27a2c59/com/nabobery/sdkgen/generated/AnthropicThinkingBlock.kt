 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/AnthropicThinkingBlock
 */
...
public class AnthropicThinkingBlock(
  ...
  public class Builder {
    ...
    private var typeValue: InlineAnthropicThinkingBlockTypeX4f592c6b? = null

    public var type: InlineAnthropicThinkingBlockTypeX4f592c6b
  ...
  internal object Serializer : KSerializer<AnthropicThinkingBlock> {
    ...
    override fun deserialize(decoder: Decoder): AnthropicThinkingBlock {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("AnthropicThinkingBlock must be a JSON object")
      val signature = json.decodeRequired<String>(rawObject, "signature")
      val thinking = json.decodeRequired<String>(rawObject, "thinking")
      val type = json.decodeRequired<InlineAnthropicThinkingBlockTypeX4f592c6b>(rawObject, "type")
      return AnthropicThinkingBlock(
        signature = signature,
        thinking = thinking,
        type = type,
...
public fun anthropicThinkingBlock(block: AnthropicThinkingBlock.Builder.() -> Unit): AnthropicThinkingBlock = AnthropicThinkingBlock.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("AnthropicThinkingBlock is missing required property '" + name + "'")
