 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/BulkAssignMembersRequest
 */
...
public class BulkAssignMembersRequest(
  ...
  internal object Serializer : KSerializer<BulkAssignMembersRequest> {
    ...
    override fun deserialize(decoder: Decoder): BulkAssignMembersRequest {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("BulkAssignMembersRequest must be a JSON object")
...
public fun bulkAssignMembersRequest(block: BulkAssignMembersRequest.Builder.() -> Unit): BulkAssignMembersRequest = BulkAssignMembersRequest.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("BulkAssignMembersRequest is missing required property '" + name + "'")
