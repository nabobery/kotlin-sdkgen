 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/AnthropicCodeExecution20260120Caller
 */
...
public class AnthropicCodeExecution20260120Caller(
  ...
  public class Builder {
    ...
    private var typeValue: InlineAnthropicCodeExecution20260120CallerTypeX84bb47d9? = null

    public var type: InlineAnthropicCodeExecution20260120CallerTypeX84bb47d9
  ...
  internal object Serializer : KSerializer<AnthropicCodeExecution20260120Caller> {
    ...
    override fun deserialize(decoder: Decoder): AnthropicCodeExecution20260120Caller {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("AnthropicCodeExecution20260120Caller must be a JSON object")
      val toolId = json.decodeRequired<String>(rawObject, "tool_id")
      val type = json.decodeRequired<InlineAnthropicCodeExecution20260120CallerTypeX84bb47d9>(rawObject, "type")
      return AnthropicCodeExecution20260120Caller(
        toolId = toolId,
        type = type,
      )
...
public fun anthropicCodeExecution20260120Caller(block: AnthropicCodeExecution20260120Caller.Builder.() -> Unit): AnthropicCodeExecution20260120Caller = AnthropicCodeExecution20260120Caller.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("AnthropicCodeExecution20260120Caller is missing required property '" + name + "'")
