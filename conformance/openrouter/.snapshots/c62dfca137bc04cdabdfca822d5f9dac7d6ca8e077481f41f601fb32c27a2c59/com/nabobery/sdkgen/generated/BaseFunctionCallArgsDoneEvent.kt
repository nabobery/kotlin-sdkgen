 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/BaseFunctionCallArgsDoneEvent
 */
...
public class BaseFunctionCallArgsDoneEvent(
  ...
  internal object Serializer : KSerializer<BaseFunctionCallArgsDoneEvent> {
    ...
    override fun deserialize(decoder: Decoder): BaseFunctionCallArgsDoneEvent {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("BaseFunctionCallArgsDoneEvent must be a JSON object")
...
public fun baseFunctionCallArgsDoneEvent(block: BaseFunctionCallArgsDoneEvent.Builder.() -> Unit): BaseFunctionCallArgsDoneEvent = BaseFunctionCallArgsDoneEvent.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("BaseFunctionCallArgsDoneEvent is missing required property '" + name + "'")
