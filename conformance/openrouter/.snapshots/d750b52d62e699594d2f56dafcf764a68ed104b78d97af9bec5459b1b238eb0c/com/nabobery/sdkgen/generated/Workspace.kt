 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/Workspace
 */
...
public class Workspace(
  ...
  internal object Serializer : KSerializer<Workspace> {
    ...
    override fun deserialize(decoder: Decoder): Workspace {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("Workspace must be a JSON object")
