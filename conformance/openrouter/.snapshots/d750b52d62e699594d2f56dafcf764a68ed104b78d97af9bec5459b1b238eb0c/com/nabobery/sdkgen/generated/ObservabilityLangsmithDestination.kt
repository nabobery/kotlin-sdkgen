 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/ObservabilityLangsmithDestination
 */
...
public class ObservabilityLangsmithDestination(
  ...
  public class Builder {
    private var configValue: InlineObservabilityLangsmithDestinationConfigX8b295aef? = null

    public var config: InlineObservabilityLangsmithDestinationConfigX8b295aef
    ...
    private var typeValue: InlineObservabilityLangsmithDestinationTypeX509d5017? = null

    public var type: InlineObservabilityLangsmithDestinationTypeX509d5017
  ...
  internal object Serializer : KSerializer<ObservabilityLangsmithDestination> {
    ...
    override fun deserialize(decoder: Decoder): ObservabilityLangsmithDestination {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("ObservabilityLangsmithDestination must be a JSON object")
      val config = json.decodeRequired<InlineObservabilityLangsmithDestinationConfigX8b295aef>(rawObject, "config")
      ...
      val type = json.decodeRequired<InlineObservabilityLangsmithDestinationTypeX509d5017>(rawObject, "type")
...
public fun observabilityLangsmithDestination(block: ObservabilityLangsmithDestination.Builder.() -> Unit): ObservabilityLangsmithDestination = ObservabilityLangsmithDestination.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("ObservabilityLangsmithDestination is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("ObservabilityLangsmithDestination property '" + name + "' is not nullable")
