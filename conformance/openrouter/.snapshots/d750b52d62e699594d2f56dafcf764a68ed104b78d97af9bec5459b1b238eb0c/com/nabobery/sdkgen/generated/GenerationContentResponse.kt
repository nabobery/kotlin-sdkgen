 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/GenerationContentResponse
 */
...
public class GenerationContentResponse(
  ...
  internal object Serializer : KSerializer<GenerationContentResponse> {
    ...
    override fun deserialize(decoder: Decoder): GenerationContentResponse {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("GenerationContentResponse must be a JSON object")
      val data = json.decodeRequired<GenerationContentData>(rawObject, "data")
      return GenerationContentResponse(
        data = data,
      )
    }
...
public fun generationContentResponse(block: GenerationContentResponse.Builder.() -> Unit): GenerationContentResponse = GenerationContentResponse.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("GenerationContentResponse is missing required property '" + name + "'")
