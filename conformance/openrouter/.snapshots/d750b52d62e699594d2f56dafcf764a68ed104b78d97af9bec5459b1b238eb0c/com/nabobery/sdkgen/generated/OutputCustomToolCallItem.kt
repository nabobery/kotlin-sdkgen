 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/OutputCustomToolCallItem
 */
...
public class OutputCustomToolCallItem(
  ...
  public class Builder {
    ...
    private var typeValue: InlineOutputCustomToolCallItemTypeX6abf3792? = null

    public var type: InlineOutputCustomToolCallItemTypeX6abf3792
  ...
  internal object Serializer : KSerializer<OutputCustomToolCallItem> {
    ...
    override fun deserialize(decoder: Decoder): OutputCustomToolCallItem {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("OutputCustomToolCallItem must be a JSON object")
      val callId = json.decodeRequired<String>(rawObject, "call_id")
      val input = json.decodeRequired<String>(rawObject, "input")
      val name = json.decodeRequired<String>(rawObject, "name")
      val type = json.decodeRequired<InlineOutputCustomToolCallItemTypeX6abf3792>(rawObject, "type")
      return OutputCustomToolCallItem(
        callId = callId,
        input = input,
        name = name,
...
public fun outputCustomToolCallItem(block: OutputCustomToolCallItem.Builder.() -> Unit): OutputCustomToolCallItem = OutputCustomToolCallItem.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("OutputCustomToolCallItem is missing required property '" + name + "'")
