 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/ResponsesRequest/properties/tools/items/anyOf/0
 */
@Serializable(with = InlineResponsesRequestToolsItemAnyOf1Xdfe01760.Serializer::class)
public class InlineResponsesRequestToolsItemAnyOf1Xdfe01760 internal constructor(
  ...
  public class Builder {
    ...
    public fun build(): InlineResponsesRequestToolsItemAnyOf1Xdfe01760 {
      check(nameValue != null) { "name is required" }
      check(typeValue != null) { "type is required" }
      check(parametersState !== FieldState.Absent) { "parameters is required, even when null" }
      return InlineResponsesRequestToolsItemAnyOf1Xdfe01760(
        name = name,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineResponsesRequestToolsItemAnyOf1Xdfe01760 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineResponsesRequestToolsItemAnyOf1Xdfe01760> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineResponsesRequestToolsItemAnyOf1Xdfe01760 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineResponsesRequestToolsItemAnyOf1Xdfe01760")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineResponsesRequestToolsItemAnyOf1Xdfe01760 must be a JSON object")
      val name = json.decodeRequired<String>(rawObject, "name")
      val type = json.decodeRequired<InlineFunctionToolTypeX23edb1b8>(rawObject, "type")
      if (!rawObject.containsKey("parameters")) {
        throw SerializationException("InlineResponsesRequestToolsItemAnyOf1Xdfe01760 is missing required property 'parameters'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineResponsesRequestToolsItemAnyOf1Xdfe01760) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineResponsesRequestToolsItemAnyOf1Xdfe01760")
...
public fun inlineResponsesRequestToolsItemAnyOf1Xdfe01760(block: InlineResponsesRequestToolsItemAnyOf1Xdfe01760.Builder.() -> Unit): InlineResponsesRequestToolsItemAnyOf1Xdfe01760 = InlineResponsesRequestToolsItemAnyOf1Xdfe01760.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineResponsesRequestToolsItemAnyOf1Xdfe01760 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineResponsesRequestToolsItemAnyOf1Xdfe01760 property '" + name + "' is not nullable")
