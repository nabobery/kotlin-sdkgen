...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/paths/~1keys/get/responses/200/content/application~1json/schema/properties/data/items.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/paths/~1keys/get/responses/200/content/application~1json/schema/properties/data/items
 */
@Serializable(with = InlineKeysGetResponse200JsonDataItemX600a6c0b.Serializer::class)
public class InlineKeysGetResponse200JsonDataItemX600a6c0b internal constructor(
  /**
  ...
  public class Builder {
    ...
    public fun build(): InlineKeysGetResponse200JsonDataItemX600a6c0b {
      ...
      return InlineKeysGetResponse200JsonDataItemX600a6c0b(
        byokUsage = byokUsage,
        byokUsageDaily = byokUsageDaily,
        byokUsageMonthly = byokUsageMonthly,
        byokUsageWeekly = byokUsageWeekly,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineKeysGetResponse200JsonDataItemX600a6c0b = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineKeysGetResponse200JsonDataItemX600a6c0b> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineKeysGetResponse200JsonDataItemX600a6c0b {
      val jsonDecoder = decoder.requireJsonDecoder("InlineKeysGetResponse200JsonDataItemX600a6c0b")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineKeysGetResponse200JsonDataItemX600a6c0b must be a JSON object")
      ...
      if (!rawObject.containsKey("creator_user_id")) {
        throw SerializationException("InlineKeysGetResponse200JsonDataItemX600a6c0b is missing required property 'creator_user_id'")
      }
      ...
      if (!rawObject.containsKey("limit")) {
        throw SerializationException("InlineKeysGetResponse200JsonDataItemX600a6c0b is missing required property 'limit'")
      }
      ...
      if (!rawObject.containsKey("limit_remaining")) {
        throw SerializationException("InlineKeysGetResponse200JsonDataItemX600a6c0b is missing required property 'limit_remaining'")
      }
      ...
      if (!rawObject.containsKey("limit_reset")) {
        throw SerializationException("InlineKeysGetResponse200JsonDataItemX600a6c0b is missing required property 'limit_reset'")
      }
      ...
      if (!rawObject.containsKey("updated_at")) {
        throw SerializationException("InlineKeysGetResponse200JsonDataItemX600a6c0b is missing required property 'updated_at'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineKeysGetResponse200JsonDataItemX600a6c0b) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineKeysGetResponse200JsonDataItemX600a6c0b")
...
public fun inlineKeysGetResponse200JsonDataItemX600a6c0b(block: InlineKeysGetResponse200JsonDataItemX600a6c0b.Builder.() -> Unit): InlineKeysGetResponse200JsonDataItemX600a6c0b = InlineKeysGetResponse200JsonDataItemX600a6c0b.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineKeysGetResponse200JsonDataItemX600a6c0b is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineKeysGetResponse200JsonDataItemX600a6c0b property '" + name + "' is not nullable")
