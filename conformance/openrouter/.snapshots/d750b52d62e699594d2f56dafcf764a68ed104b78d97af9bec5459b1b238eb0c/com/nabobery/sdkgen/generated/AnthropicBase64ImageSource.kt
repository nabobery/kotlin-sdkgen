 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/AnthropicBase64ImageSource
 */
...
public class AnthropicBase64ImageSource(
  ...
  public class Builder {
    ...
    private var typeValue: InlineAnthropicBase64ImageSourceTypeXe4e16cd8? = null

    public var type: InlineAnthropicBase64ImageSourceTypeXe4e16cd8
  ...
  internal object Serializer : KSerializer<AnthropicBase64ImageSource> {
    ...
    override fun deserialize(decoder: Decoder): AnthropicBase64ImageSource {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("AnthropicBase64ImageSource must be a JSON object")
      val data = json.decodeRequired<String>(rawObject, "data")
      val mediaType = json.decodeRequired<AnthropicImageMimeType>(rawObject, "media_type")
      val type = json.decodeRequired<InlineAnthropicBase64ImageSourceTypeXe4e16cd8>(rawObject, "type")
      return AnthropicBase64ImageSource(
        data = data,
        mediaType = mediaType,
        type = type,
...
public fun anthropicBase64ImageSource(block: AnthropicBase64ImageSource.Builder.() -> Unit): AnthropicBase64ImageSource = AnthropicBase64ImageSource.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("AnthropicBase64ImageSource is missing required property '" + name + "'")
