 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/OutputItemFunctionCall
 */
...
public class OutputItemFunctionCall(
  ...
  internal object Serializer : KSerializer<OutputItemFunctionCall> {
    ...
    override fun deserialize(decoder: Decoder): OutputItemFunctionCall {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("OutputItemFunctionCall must be a JSON object")
...
public fun outputItemFunctionCall(block: OutputItemFunctionCall.Builder.() -> Unit): OutputItemFunctionCall = OutputItemFunctionCall.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("OutputItemFunctionCall is missing required property '" + name + "'")
