 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/CreateBYOKKeyResponse
 */
...
public class CreateByokKeyResponse(
  ...
  internal object Serializer : KSerializer<CreateByokKeyResponse> {
    ...
    override fun deserialize(decoder: Decoder): CreateByokKeyResponse {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("CreateByokKeyResponse must be a JSON object")
...
public fun createByokKeyResponse(block: CreateByokKeyResponse.Builder.() -> Unit): CreateByokKeyResponse = CreateByokKeyResponse.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("CreateByokKeyResponse is missing required property '" + name + "'")
