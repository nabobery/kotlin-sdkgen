 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/ChatStreamDelta
 */
...
public class ChatStreamDelta(
   ...
   */
  public val role: InlineChatStreamDeltaRoleXfa695768? = null,
  toolCalls: List<ChatStreamToolCall>? = null,
) {
   ...
   * Tool calls delta
   */
  public val toolCalls: List<ChatStreamToolCall>? =
      toolCalls?.let { collection0 -> collection0.toList() }
  ...
  public class Builder {
     ...
     * The role of the message author
     */
    public var role: InlineChatStreamDeltaRoleXfa695768? = null

    private var toolCallsValue: List<ChatStreamToolCall>? = null

    /**
     * Tool calls delta
     */
    public var toolCalls: List<ChatStreamToolCall>?
  ...
  internal object Serializer : KSerializer<ChatStreamDelta> {
    ...
    override fun deserialize(decoder: Decoder): ChatStreamDelta {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("ChatStreamDelta must be a JSON object")
      return ChatStreamDelta(
        ...
        role = rawObject["role"]?.let { json.decodeFromJsonElement<InlineChatStreamDeltaRoleXfa695768>(it) },
        toolCalls = rawObject["tool_calls"]?.let { json.decodeFromJsonElement<List<ChatStreamToolCall>>(it) },
      )
    }
