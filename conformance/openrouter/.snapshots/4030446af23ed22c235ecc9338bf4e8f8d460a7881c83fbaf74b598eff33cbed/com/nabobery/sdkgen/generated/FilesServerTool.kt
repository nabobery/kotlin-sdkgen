...
public data class FilesServerToolView(
  ...
  public val type: InlineFilesServerToolTypeX3d61e8fb,
)
 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/FilesServerTool
 */
...
public class FilesServerTool(
  ...
  public class Builder {
    private var typeValue: InlineFilesServerToolTypeX3d61e8fb? = null

    public var type: InlineFilesServerToolTypeX3d61e8fb
  ...
  internal object Serializer : KSerializer<FilesServerTool> {
    ...
    override fun deserialize(decoder: Decoder): FilesServerTool {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("FilesServerTool must be a JSON object")
      val type = json.decodeRequired<InlineFilesServerToolTypeX3d61e8fb>(rawObject, "type")
      return FilesServerTool(
        type = type,
        parameters = rawObject["parameters"]?.let { json.decodeFromJsonElement<FilesServerToolConfig>(it) },
      )
    }
