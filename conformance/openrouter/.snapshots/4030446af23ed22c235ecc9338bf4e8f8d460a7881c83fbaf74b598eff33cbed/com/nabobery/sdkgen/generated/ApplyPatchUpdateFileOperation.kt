 ...
 * file.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/ApplyPatchUpdateFileOperation
 */
...
public class ApplyPatchUpdateFileOperation(
  ...
  public class Builder {
    ...
    private var typeValue: InlineApplyPatchUpdateFileOperationTypeX6ab9115a? = null

    public var type: InlineApplyPatchUpdateFileOperationTypeX6ab9115a
  ...
  internal object Serializer : KSerializer<ApplyPatchUpdateFileOperation> {
    ...
    override fun deserialize(decoder: Decoder): ApplyPatchUpdateFileOperation {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("ApplyPatchUpdateFileOperation must be a JSON object")
      val diff = json.decodeRequired<String>(rawObject, "diff")
      val path = json.decodeRequired<String>(rawObject, "path")
      val type = json.decodeRequired<InlineApplyPatchUpdateFileOperationTypeX6ab9115a>(rawObject, "type")
      return ApplyPatchUpdateFileOperation(
        diff = diff,
        path = path,
        type = type,
...
public fun applyPatchUpdateFileOperation(block: ApplyPatchUpdateFileOperation.Builder.() -> Unit): ApplyPatchUpdateFileOperation = ApplyPatchUpdateFileOperation.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("ApplyPatchUpdateFileOperation is missing required property '" + name + "'")
