 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/UpdateWorkspaceRequest
 */
...
public class UpdateWorkspaceRequest internal constructor(
  ...
  ioLoggingApiKeyIdsState: FieldState<List<Int>?>,
  ...
  private val ioLoggingApiKeyIdsState: FieldState<List<Int>?> =
      ioLoggingApiKeyIdsState.copyValue { fieldValue -> fieldValue?.let { collection0 -> collection0.toList() } }
  ...
  public class Builder {
    ...
    public var ioLoggingSamplingRate: Double?
      get() = ioLoggingSamplingRateState.valueOrNull()
      set(`value`) {
        val present = requireNotNull(value) { "ioLoggingSamplingRate is not nullable; call unsetIoLoggingSamplingRate() to omit it" }
    ...
    public var isDataDiscountLoggingEnabled: Boolean?
      get() = isDataDiscountLoggingEnabledState.valueOrNull()
      set(`value`) {
        val present = requireNotNull(value) { "isDataDiscountLoggingEnabled is not nullable; call unsetIsDataDiscountLoggingEnabled() to omit it" }
    ...
    public var isObservabilityBroadcastEnabled: Boolean?
      get() = isObservabilityBroadcastEnabledState.valueOrNull()
      set(`value`) {
        val present = requireNotNull(value) { "isObservabilityBroadcastEnabled is not nullable; call unsetIsObservabilityBroadcastEnabled() to omit it" }
    ...
    public var isObservabilityIoLoggingEnabled: Boolean?
      get() = isObservabilityIoLoggingEnabledState.valueOrNull()
      set(`value`) {
        val present = requireNotNull(value) { "isObservabilityIoLoggingEnabled is not nullable; call unsetIsObservabilityIoLoggingEnabled() to omit it" }
  ...
  internal object Serializer : KSerializer<UpdateWorkspaceRequest> {
    ...
    override fun deserialize(decoder: Decoder): UpdateWorkspaceRequest {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("UpdateWorkspaceRequest must be a JSON object")
      return UpdateWorkspaceRequest(
        defaultImageModelState = json.decodeOptional(rawObject, "default_image_model", nullable = true),
        defaultProviderSortState = json.decodeOptional(rawObject, "default_provider_sort", nullable = true),
        defaultTextModelState = json.decodeOptional(rawObject, "default_text_model", nullable = true),
        descriptionState = json.decodeOptional(rawObject, "description", nullable = true),
        ioLoggingApiKeyIdsState = json.decodeOptional(rawObject, "io_logging_api_key_ids", nullable = true),
        ioLoggingSamplingRateState = json.decodeOptional(rawObject, "io_logging_sampling_rate", nullable = false),
        isDataDiscountLoggingEnabledState = json.decodeOptional(rawObject, "is_data_discount_logging_enabled", nullable = false),
        isObservabilityBroadcastEnabledState = json.decodeOptional(rawObject, "is_observability_broadcast_enabled", nullable = false),
        isObservabilityIoLoggingEnabledState = json.decodeOptional(rawObject, "is_observability_io_logging_enabled", nullable = false),
    ...
    override fun serialize(encoder: Encoder, `value`: UpdateWorkspaceRequest) {
      ...
      val raw = buildJsonObject {
        ...
        putState("is_observability_broadcast_enabled", value.isObservabilityBroadcastEnabledState, json::encodeToJsonElement)
        putState("is_observability_io_logging_enabled", value.isObservabilityIoLoggingEnabledState, json::encodeToJsonElement)
...
public fun updateWorkspaceRequest(block: UpdateWorkspaceRequest.Builder.() -> Unit): UpdateWorkspaceRequest = UpdateWorkspaceRequest.build(block)
