 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/ImageGenerationUsage/properties/server_tool_use
 */
@Serializable(with = InlineImageGenerationUsageServerToolUseXcb279edb.Serializer::class)
public class InlineImageGenerationUsageServerToolUseXcb279edb(
  /**
  ...
  public class Builder {
    ...
    public fun build(): InlineImageGenerationUsageServerToolUseXcb279edb = InlineImageGenerationUsageServerToolUseXcb279edb(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineImageGenerationUsageServerToolUseXcb279edb = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineImageGenerationUsageServerToolUseXcb279edb> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineImageGenerationUsageServerToolUseXcb279edb {
      val jsonDecoder = decoder.requireJsonDecoder("InlineImageGenerationUsageServerToolUseXcb279edb")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineImageGenerationUsageServerToolUseXcb279edb must be a JSON object")
      return InlineImageGenerationUsageServerToolUseXcb279edb(
    ...
    override fun serialize(encoder: Encoder, `value`: InlineImageGenerationUsageServerToolUseXcb279edb) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineImageGenerationUsageServerToolUseXcb279edb")
...
public fun inlineImageGenerationUsageServerToolUseXcb279edb(block: InlineImageGenerationUsageServerToolUseXcb279edb.Builder.() -> Unit): InlineImageGenerationUsageServerToolUseXcb279edb = InlineImageGenerationUsageServerToolUseXcb279edb.build(block)
