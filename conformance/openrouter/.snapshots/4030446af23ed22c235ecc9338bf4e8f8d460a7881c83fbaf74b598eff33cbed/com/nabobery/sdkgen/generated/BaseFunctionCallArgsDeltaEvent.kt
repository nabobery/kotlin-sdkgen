 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/BaseFunctionCallArgsDeltaEvent
 */
...
public class BaseFunctionCallArgsDeltaEvent(
  ...
  internal object Serializer : KSerializer<BaseFunctionCallArgsDeltaEvent> {
    ...
    override fun deserialize(decoder: Decoder): BaseFunctionCallArgsDeltaEvent {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("BaseFunctionCallArgsDeltaEvent must be a JSON object")
...
public fun baseFunctionCallArgsDeltaEvent(block: BaseFunctionCallArgsDeltaEvent.Builder.() -> Unit): BaseFunctionCallArgsDeltaEvent = BaseFunctionCallArgsDeltaEvent.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("BaseFunctionCallArgsDeltaEvent is missing required property '" + name + "'")
