 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/ShellServerTool
 */
...
public class ShellServerTool(
  ...
  public class Builder {
    private var typeValue: InlineShellServerToolTypeX5a1681b4? = null

    public var type: InlineShellServerToolTypeX5a1681b4
  ...
  internal object Serializer : KSerializer<ShellServerTool> {
    ...
    override fun deserialize(decoder: Decoder): ShellServerTool {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("ShellServerTool must be a JSON object")
      val type = json.decodeRequired<InlineShellServerToolTypeX5a1681b4>(rawObject, "type")
      return ShellServerTool(
        type = type,
      )
    }
