...
/**
 * Generated model for sdkgen://source/openapi.yaml#/components/schemas/BYOKKey.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/BYOKKey
 */
@Serializable(with = ByokKey.Serializer::class)
public class ByokKey internal constructor(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): ByokKey = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<ByokKey> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): ByokKey {
      val jsonDecoder = decoder.requireJsonDecoder("ByokKey")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("ByokKey must be a JSON object")
      ...
      if (!rawObject.containsKey("allowed_api_key_hashes")) {
        throw SerializationException("ByokKey is missing required property 'allowed_api_key_hashes'")
      }
      ...
      if (!rawObject.containsKey("allowed_models")) {
        throw SerializationException("ByokKey is missing required property 'allowed_models'")
      }
      ...
      if (!rawObject.containsKey("allowed_user_ids")) {
        throw SerializationException("ByokKey is missing required property 'allowed_user_ids'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: ByokKey) {
      val jsonEncoder = encoder.requireJsonEncoder("ByokKey")
...
public fun byokKey(block: ByokKey.Builder.() -> Unit): ByokKey = ByokKey.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("ByokKey is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("ByokKey property '" + name + "' is not nullable")
