 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/ListObservabilityDestinationsResponse
 */
...
public class ListObservabilityDestinationsResponse(
  ...
  internal object Serializer : KSerializer<ListObservabilityDestinationsResponse> {
    ...
    override fun deserialize(decoder: Decoder): ListObservabilityDestinationsResponse {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("ListObservabilityDestinationsResponse must be a JSON object")
      val data = json.decodeRequired<List<ObservabilityDestination>>(rawObject, "data")
...
public fun listObservabilityDestinationsResponse(block: ListObservabilityDestinationsResponse.Builder.() -> Unit): ListObservabilityDestinationsResponse = ListObservabilityDestinationsResponse.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("ListObservabilityDestinationsResponse is missing required property '" + name + "'")
