 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/ListWorkspacesResponse
 */
...
public class ListWorkspacesResponse(
  ...
  internal object Serializer : KSerializer<ListWorkspacesResponse> {
    ...
    override fun deserialize(decoder: Decoder): ListWorkspacesResponse {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("ListWorkspacesResponse must be a JSON object")
      val data = json.decodeRequired<List<Workspace>>(rawObject, "data")
...
public fun listWorkspacesResponse(block: ListWorkspacesResponse.Builder.() -> Unit): ListWorkspacesResponse = ListWorkspacesResponse.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("ListWorkspacesResponse is missing required property '" + name + "'")
