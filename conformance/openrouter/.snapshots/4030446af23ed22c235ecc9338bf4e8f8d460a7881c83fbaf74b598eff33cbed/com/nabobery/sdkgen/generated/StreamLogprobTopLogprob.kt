 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/StreamLogprobTopLogprob
 */
...
public class StreamLogprobTopLogprob(
  ...
  internal object Serializer : KSerializer<StreamLogprobTopLogprob> {
    ...
    override fun deserialize(decoder: Decoder): StreamLogprobTopLogprob {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("StreamLogprobTopLogprob must be a JSON object")
...
public fun streamLogprobTopLogprob(block: StreamLogprobTopLogprob.Builder.() -> Unit): StreamLogprobTopLogprob = StreamLogprobTopLogprob.build(block)
