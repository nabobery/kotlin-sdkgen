 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/STTUsage
 */
...
public class SttUsage(
  ...
  internal object Serializer : KSerializer<SttUsage> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): SttUsage {
      val jsonDecoder = decoder.requireJsonDecoder("SttUsage")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("SttUsage must be a JSON object")
      return SttUsage(
        ...
        seconds = rawObject["seconds"]?.let { json.decodeFromJsonElement<Double>(it) },
