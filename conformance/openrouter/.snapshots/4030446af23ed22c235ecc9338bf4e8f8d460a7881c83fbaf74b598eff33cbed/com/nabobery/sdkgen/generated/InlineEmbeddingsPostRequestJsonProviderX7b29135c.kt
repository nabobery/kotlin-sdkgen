 ...
 * r
 */
@Serializable(with = InlineEmbeddingsPostRequestJsonProviderX7b29135c.Serializer::class)
public class InlineEmbeddingsPostRequestJsonProviderX7b29135c(
  /**
  ...
  public class Builder {
    ...
    public fun build(): InlineEmbeddingsPostRequestJsonProviderX7b29135c = InlineEmbeddingsPostRequestJsonProviderX7b29135c(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineEmbeddingsPostRequestJsonProviderX7b29135c = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineEmbeddingsPostRequestJsonProviderX7b29135c> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineEmbeddingsPostRequestJsonProviderX7b29135c {
      val jsonDecoder = decoder.requireJsonDecoder("InlineEmbeddingsPostRequestJsonProviderX7b29135c")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineEmbeddingsPostRequestJsonProviderX7b29135c must be a JSON object")
      return InlineEmbeddingsPostRequestJsonProviderX7b29135c(
    ...
    override fun serialize(encoder: Encoder, `value`: InlineEmbeddingsPostRequestJsonProviderX7b29135c) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineEmbeddingsPostRequestJsonProviderX7b29135c")
...
public fun inlineEmbeddingsPostRequestJsonProviderX7b29135c(block: InlineEmbeddingsPostRequestJsonProviderX7b29135c.Builder.() -> Unit): InlineEmbeddingsPostRequestJsonProviderX7b29135c = InlineEmbeddingsPostRequestJsonProviderX7b29135c.build(block)
