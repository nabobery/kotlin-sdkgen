 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/BulkUnassignKeysResponse
 */
...
public class BulkUnassignKeysResponse(
  ...
  internal object Serializer : KSerializer<BulkUnassignKeysResponse> {
    ...
    override fun deserialize(decoder: Decoder): BulkUnassignKeysResponse {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("BulkUnassignKeysResponse must be a JSON object")
...
public fun bulkUnassignKeysResponse(block: BulkUnassignKeysResponse.Builder.() -> Unit): BulkUnassignKeysResponse = BulkUnassignKeysResponse.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("BulkUnassignKeysResponse is missing required property '" + name + "'")
