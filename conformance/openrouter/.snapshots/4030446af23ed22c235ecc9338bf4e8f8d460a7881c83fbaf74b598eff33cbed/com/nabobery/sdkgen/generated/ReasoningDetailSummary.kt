 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/ReasoningDetailSummary
 */
...
public class ReasoningDetailSummary(
  ...
  public class Builder {
    ...
    private var typeValue: InlineReasoningDetailSummaryTypeX14c56c20? = null

    public var type: InlineReasoningDetailSummaryTypeX14c56c20
  ...
  internal object Serializer : KSerializer<ReasoningDetailSummary> {
    ...
    override fun deserialize(decoder: Decoder): ReasoningDetailSummary {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("ReasoningDetailSummary must be a JSON object")
      val summary = json.decodeRequired<String>(rawObject, "summary")
      val type = json.decodeRequired<InlineReasoningDetailSummaryTypeX14c56c20>(rawObject, "type")
      return ReasoningDetailSummary(
        summary = summary,
        type = type,
...
public fun reasoningDetailSummary(block: ReasoningDetailSummary.Builder.() -> Unit): ReasoningDetailSummary = ReasoningDetailSummary.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("ReasoningDetailSummary is missing required property '" + name + "'")
