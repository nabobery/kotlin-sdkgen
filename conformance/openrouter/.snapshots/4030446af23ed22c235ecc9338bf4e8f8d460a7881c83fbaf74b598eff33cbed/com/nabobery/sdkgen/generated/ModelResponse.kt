 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/ModelResponse
 */
...
public class ModelResponse(
  ...
  internal object Serializer : KSerializer<ModelResponse> {
    ...
    override fun deserialize(decoder: Decoder): ModelResponse {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("ModelResponse must be a JSON object")
      val data = json.decodeRequired<Model>(rawObject, "data")
      return ModelResponse(
        data = data,
      )
    }
