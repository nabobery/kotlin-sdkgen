 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/OutputItemFileSearchCall
 */
...
public class OutputItemFileSearchCall(
  ...
  internal object Serializer : KSerializer<OutputItemFileSearchCall> {
    ...
    override fun deserialize(decoder: Decoder): OutputItemFileSearchCall {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("OutputItemFileSearchCall must be a JSON object")
...
public fun outputItemFileSearchCall(block: OutputItemFileSearchCall.Builder.() -> Unit): OutputItemFileSearchCall = OutputItemFileSearchCall.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("OutputItemFileSearchCall is missing required property '" + name + "'")
