 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/ObservabilityBraintrustDestination
 */
...
public class ObservabilityBraintrustDestination(
  ...
  public class Builder {
    private var configValue: InlineObservabilityBraintrustDestinationConfigXca3254f1? = null

    public var config: InlineObservabilityBraintrustDestinationConfigXca3254f1
    ...
    private var typeValue: InlineObservabilityBraintrustDestinationTypeXdc9ebcbd? = null

    public var type: InlineObservabilityBraintrustDestinationTypeXdc9ebcbd
  ...
  internal object Serializer : KSerializer<ObservabilityBraintrustDestination> {
    ...
    override fun deserialize(decoder: Decoder): ObservabilityBraintrustDestination {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("ObservabilityBraintrustDestination must be a JSON object")
      val config = json.decodeRequired<InlineObservabilityBraintrustDestinationConfigXca3254f1>(rawObject, "config")
      ...
      val type = json.decodeRequired<InlineObservabilityBraintrustDestinationTypeXdc9ebcbd>(rawObject, "type")
...
public fun observabilityBraintrustDestination(block: ObservabilityBraintrustDestination.Builder.() -> Unit): ObservabilityBraintrustDestination = ObservabilityBraintrustDestination.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("ObservabilityBraintrustDestination is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("ObservabilityBraintrustDestination property '" + name + "' is not nullable")
