 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/ReasoningSummaryPartAddedEvent
 */
...
public class ReasoningSummaryPartAddedEvent(
  ...
  internal object Serializer : KSerializer<ReasoningSummaryPartAddedEvent> {
    ...
    override fun deserialize(decoder: Decoder): ReasoningSummaryPartAddedEvent {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("ReasoningSummaryPartAddedEvent must be a JSON object")
...
public fun reasoningSummaryPartAddedEvent(block: ReasoningSummaryPartAddedEvent.Builder.() -> Unit): ReasoningSummaryPartAddedEvent = ReasoningSummaryPartAddedEvent.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("ReasoningSummaryPartAddedEvent is missing required property '" + name + "'")
