 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/InProgressEvent
 */
...
public class InProgressEvent(
  ...
  internal object Serializer : KSerializer<InProgressEvent> {
    ...
    override fun deserialize(decoder: Decoder): InProgressEvent {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InProgressEvent must be a JSON object")
