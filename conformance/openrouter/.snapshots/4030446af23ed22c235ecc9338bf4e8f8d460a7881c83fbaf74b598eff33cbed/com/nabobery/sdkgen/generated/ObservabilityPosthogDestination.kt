 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/ObservabilityPosthogDestination
 */
...
public class ObservabilityPosthogDestination(
  ...
  public class Builder {
    private var configValue: InlineObservabilityPosthogDestinationConfigX67c98908? = null

    public var config: InlineObservabilityPosthogDestinationConfigX67c98908
    ...
    private var typeValue: InlineObservabilityPosthogDestinationTypeXecda09da? = null

    public var type: InlineObservabilityPosthogDestinationTypeXecda09da
  ...
  internal object Serializer : KSerializer<ObservabilityPosthogDestination> {
    ...
    override fun deserialize(decoder: Decoder): ObservabilityPosthogDestination {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("ObservabilityPosthogDestination must be a JSON object")
      val config = json.decodeRequired<InlineObservabilityPosthogDestinationConfigX67c98908>(rawObject, "config")
      ...
      val type = json.decodeRequired<InlineObservabilityPosthogDestinationTypeXecda09da>(rawObject, "type")
...
public fun observabilityPosthogDestination(block: ObservabilityPosthogDestination.Builder.() -> Unit): ObservabilityPosthogDestination = ObservabilityPosthogDestination.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("ObservabilityPosthogDestination is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("ObservabilityPosthogDestination property '" + name + "' is not nullable")
