 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/ContentPartInputVideo
 */
...
public class ContentPartInputVideo(
  ...
  public class Builder {
    ...
    private var typeValue: InlineContentPartInputVideoTypeXc13a2526? = null

    public var type: InlineContentPartInputVideoTypeXc13a2526
  ...
  internal object Serializer : KSerializer<ContentPartInputVideo> {
    ...
    override fun deserialize(decoder: Decoder): ContentPartInputVideo {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("ContentPartInputVideo must be a JSON object")
      val inputVideo = json.decodeRequired<MultimodalMedia>(rawObject, "input_video")
      val type = json.decodeRequired<InlineContentPartInputVideoTypeXc13a2526>(rawObject, "type")
      return ContentPartInputVideo(
        inputVideo = inputVideo,
        type = type,
      )
...
public fun contentPartInputVideo(block: ContentPartInputVideo.Builder.() -> Unit): ContentPartInputVideo = ContentPartInputVideo.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("ContentPartInputVideo is missing required property '" + name + "'")
