 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/FusionCallCompletedEvent
 */
...
public class FusionCallCompletedEvent(
  ...
  public class Builder {
    ...
    private var typeValue: InlineFusionCallCompletedEventTypeX098a1518? = null

    public var type: InlineFusionCallCompletedEventTypeX098a1518
  ...
  internal object Serializer : KSerializer<FusionCallCompletedEvent> {
    ...
    override fun deserialize(decoder: Decoder): FusionCallCompletedEvent {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("FusionCallCompletedEvent must be a JSON object")
      ...
      val type = json.decodeRequired<InlineFusionCallCompletedEventTypeX098a1518>(rawObject, "type")
      return FusionCallCompletedEvent(
        itemId = itemId,
        outputIndex = outputIndex,
        sequenceNumber = sequenceNumber,
...
public fun fusionCallCompletedEvent(block: FusionCallCompletedEvent.Builder.() -> Unit): FusionCallCompletedEvent = FusionCallCompletedEvent.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("FusionCallCompletedEvent is missing required property '" + name + "'")
