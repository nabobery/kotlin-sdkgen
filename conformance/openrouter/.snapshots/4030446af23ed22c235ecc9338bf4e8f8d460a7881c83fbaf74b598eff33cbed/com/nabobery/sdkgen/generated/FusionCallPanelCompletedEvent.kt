 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/FusionCallPanelCompletedEvent
 */
...
public class FusionCallPanelCompletedEvent(
  ...
  public class Builder {
    ...
    private var typeValue: InlineFusionCallPanelCompletedEventTypeXccd0e5e6? = null

    public var type: InlineFusionCallPanelCompletedEventTypeXccd0e5e6
  ...
  internal object Serializer : KSerializer<FusionCallPanelCompletedEvent> {
    ...
    override fun deserialize(decoder: Decoder): FusionCallPanelCompletedEvent {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("FusionCallPanelCompletedEvent must be a JSON object")
      ...
      val type = json.decodeRequired<InlineFusionCallPanelCompletedEventTypeXccd0e5e6>(rawObject, "type")
      return FusionCallPanelCompletedEvent(
        content = content,
        itemId = itemId,
        model = model,
...
public fun fusionCallPanelCompletedEvent(block: FusionCallPanelCompletedEvent.Builder.() -> Unit): FusionCallPanelCompletedEvent = FusionCallPanelCompletedEvent.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("FusionCallPanelCompletedEvent is missing required property '" + name + "'")
