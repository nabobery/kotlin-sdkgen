 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/AnthropicContainerUpload
 */
...
public class AnthropicContainerUpload(
  ...
  public class Builder {
    ...
    private var typeValue: InlineAnthropicContainerUploadTypeXb985c53e? = null

    public var type: InlineAnthropicContainerUploadTypeXb985c53e
  ...
  internal object Serializer : KSerializer<AnthropicContainerUpload> {
    ...
    override fun deserialize(decoder: Decoder): AnthropicContainerUpload {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("AnthropicContainerUpload must be a JSON object")
      val fileId = json.decodeRequired<String>(rawObject, "file_id")
      val type = json.decodeRequired<InlineAnthropicContainerUploadTypeXb985c53e>(rawObject, "type")
      return AnthropicContainerUpload(
        fileId = fileId,
        type = type,
      )
...
public fun anthropicContainerUpload(block: AnthropicContainerUpload.Builder.() -> Unit): AnthropicContainerUpload = AnthropicContainerUpload.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("AnthropicContainerUpload is missing required property '" + name + "'")
