...
import com.nabobery.sdkgen.generated.Workspace
import com.nabobery.sdkgen.generated.WorkspaceBudgetInterval
import com.nabobery.sdkgen.generated.WorkspaceMember
...
public class WorkspacesClient(
  ...
  public suspend fun listWorkspaceMembers(
    ...
    xOpenRouterTitle: String? = null,
    options: CallOptions = CallOptions(),
  ): Page<com.nabobery.sdkgen.generated.ListWorkspaceMembersResponse, WorkspaceMember> {
    val engine = PaginationEngine<com.nabobery.sdkgen.generated.ListWorkspaceMembersResponse, WorkspaceMember>(
          descriptor = requireNotNull(listWorkspaceMembersMetadata.pagination as? PaginationDescriptor.OffsetLimit),
          operationId = listWorkspaceMembersMetadata.operationId,
          requestedPageSize = limit,
          initialOffset = offset?.toLong() ?: 0L,
        )
    return engine.firstPage { pageRequest -> fetchlistWorkspaceMembersPage(Unit, id, limit, offset, httpReferer, xOpenRouterCategories, xOpenRouterTitle, pageRequest, options) }
  }
  ...
  /**
   * Returns a cold page flow for listWorkspaceMembers.
   *
   * @param id The workspace ID (UUID) or slug
   * @param limit Maximum number of records to return (max 100)
   * @param offset Number of records to skip for pagination
   ...
   * @param options Execution options, including pagination bounds.
   */
  public fun listWorkspaceMembersPages(
    id: String,
    limit: Int? = null,
    offset: Int? = null,
    httpReferer: String? = null,
    ...
    xOpenRouterTitle: String? = null,
    options: CallOptions = CallOptions(),
  ): Flow<Page<com.nabobery.sdkgen.generated.ListWorkspaceMembersResponse, WorkspaceMember>> = PaginationEngine<com.nabobery.sdkgen.generated.ListWorkspaceMembersResponse, WorkspaceMember>(
    descriptor = requireNotNull(listWorkspaceMembersMetadata.pagination as? PaginationDescriptor.OffsetLimit),
    operationId = listWorkspaceMembersMetadata.operationId,
    requestedPageSize = limit,
    initialOffset = offset?.toLong() ?: 0L,
  ).pages(fetch = { pageRequest -> fetchlistWorkspaceMembersPage(Unit, id, limit, offset, httpReferer, xOpenRouterCategories, xOpenRouterTitle, pageRequest, options) }, pagination = options.pagination)

  /**
   * Returns a cold item flow for listWorkspaceMembers.
   *
   * @param options Execution options, including pagination bounds.
   */
  public fun listWorkspaceMembersItems(
    id: String,
    limit: Int? = null,
    offset: Int? = null,
    httpReferer: String? = null,
    ...
    xOpenRouterTitle: String? = null,
    options: CallOptions = CallOptions(),
  ): Flow<WorkspaceMember> = PaginationEngine<com.nabobery.sdkgen.generated.ListWorkspaceMembersResponse, WorkspaceMember>(
    descriptor = requireNotNull(listWorkspaceMembersMetadata.pagination as? PaginationDescriptor.OffsetLimit),
    operationId = listWorkspaceMembersMetadata.operationId,
    requestedPageSize = limit,
    initialOffset = offset?.toLong() ?: 0L,
  ).items(fetch = { pageRequest -> fetchlistWorkspaceMembersPage(Unit, id, limit, offset, httpReferer, xOpenRouterCategories, xOpenRouterTitle, pageRequest, options) }, pagination = options.pagination)

  private fun metadataForListWorkspaceMembersPage(
    ...
    xOpenRouterCategories: String? = null,
    xOpenRouterTitle: String? = null,
  ): OperationMetadata = listWorkspaceMembersMetadata

  private suspend fun fetchlistWorkspaceMembersPage(
    request: Unit,
    id: String,
    limit: Int? = null,
    offset: Int? = null,
    ...
    pageRequest: PageRequest,
    options: CallOptions,
  ): PageEnvelope<com.nabobery.sdkgen.generated.ListWorkspaceMembersResponse, WorkspaceMember> {
    ...
    val pageMetadata = metadataForListWorkspaceMembersPage(pageRequest, id, limit, offset, httpReferer, xOpenRouterCategories, xOpenRouterTitle)
    val response = executor.execute<Unit, com.nabobery.sdkgen.generated.ListWorkspaceMembersResponse>(SdkExecutionRequest(pageMetadata, baseUri, pageRequestValue, emptyList(), buildList {
      add(SdkRequestParameter(location = SdkParameterLocation.PATH, name = "id", values = listOf(id.toString())))
      add(SdkRequestParameter(location = SdkParameterLocation.QUERY, name = "limit", values = limit?.let { listOf(it.toString()) }.orEmpty()))
      ...
      add(SdkRequestParameter(location = SdkParameterLocation.HEADER, name = "X-OpenRouter-Categories", values = xOpenRouterCategories?.let { listOf(it.toString()) }.orEmpty()))
      add(SdkRequestParameter(location = SdkParameterLocation.HEADER, name = "X-OpenRouter-Title", values = xOpenRouterTitle?.let { listOf(it.toString()) }.orEmpty()))
    }), listOf(WorkspacesCodecs.LISTWORKSPACEMEMBERS_RESPONSE_CODEC_ID), WorkspacesCodecs.listWorkspaceMembersRequestCodecRegistry, WorkspacesCodecs.listWorkspaceMembersResponseCodecRegistry, options)
  ...
  public suspend fun listWorkspaces(
    ...
    xOpenRouterTitle: String? = null,
    options: CallOptions = CallOptions(),
  ): Page<com.nabobery.sdkgen.generated.ListWorkspacesResponse, Workspace> {
    val engine = PaginationEngine<com.nabobery.sdkgen.generated.ListWorkspacesResponse, Workspace>(
          descriptor = requireNotNull(listWorkspacesMetadata.pagination as? PaginationDescriptor.OffsetLimit),
          operationId = listWorkspacesMetadata.operationId,
          requestedPageSize = limit,
          initialOffset = offset?.toLong() ?: 0L,
        )
    return engine.firstPage { pageRequest -> fetchlistWorkspacesPage(Unit, limit, offset, httpReferer, xOpenRouterCategories, xOpenRouterTitle, pageRequest, options) }
  }
  ...
  /**
   * Returns a cold page flow for listWorkspaces.
   *
   * @param limit Maximum number of records to return (max 100)
   * @param offset Number of records to skip for pagination
   * @param httpReferer The app identifier should be your app's URL and is used as the primary identifier for rankings.
   ...
   * @param options Execution options, including pagination bounds.
   */
  public fun listWorkspacesPages(
    limit: Int? = null,
    offset: Int? = null,
    httpReferer: String? = null,
    xOpenRouterCategories: String? = null,
    xOpenRouterTitle: String? = null,
    options: CallOptions = CallOptions(),
  ): Flow<Page<com.nabobery.sdkgen.generated.ListWorkspacesResponse, Workspace>> = PaginationEngine<com.nabobery.sdkgen.generated.ListWorkspacesResponse, Workspace>(
    descriptor = requireNotNull(listWorkspacesMetadata.pagination as? PaginationDescriptor.OffsetLimit),
    operationId = listWorkspacesMetadata.operationId,
    requestedPageSize = limit,
    initialOffset = offset?.toLong() ?: 0L,
  ).pages(fetch = { pageRequest -> fetchlistWorkspacesPage(Unit, limit, offset, httpReferer, xOpenRouterCategories, xOpenRouterTitle, pageRequest, options) }, pagination = options.pagination)

  /**
   * Returns a cold item flow for listWorkspaces.
   *
   * @param options Execution options, including pagination bounds.
   */
  public fun listWorkspacesItems(
    limit: Int? = null,
    offset: Int? = null,
    httpReferer: String? = null,
    xOpenRouterCategories: String? = null,
    xOpenRouterTitle: String? = null,
    options: CallOptions = CallOptions(),
  ): Flow<Workspace> = PaginationEngine<com.nabobery.sdkgen.generated.ListWorkspacesResponse, Workspace>(
    descriptor = requireNotNull(listWorkspacesMetadata.pagination as? PaginationDescriptor.OffsetLimit),
    operationId = listWorkspacesMetadata.operationId,
    requestedPageSize = limit,
    initialOffset = offset?.toLong() ?: 0L,
  ).items(fetch = { pageRequest -> fetchlistWorkspacesPage(Unit, limit, offset, httpReferer, xOpenRouterCategories, xOpenRouterTitle, pageRequest, options) }, pagination = options.pagination)

  private fun metadataForListWorkspacesPage(
    pageRequest: PageRequest,
    limit: Int? = null,
    offset: Int? = null,
    httpReferer: String? = null,
    xOpenRouterCategories: String? = null,
    xOpenRouterTitle: String? = null,
  ): OperationMetadata = listWorkspacesMetadata

  private suspend fun fetchlistWorkspacesPage(
    request: Unit,
    limit: Int? = null,
    offset: Int? = null,
    httpReferer: String? = null,
    ...
    pageRequest: PageRequest,
    options: CallOptions,
  ): PageEnvelope<com.nabobery.sdkgen.generated.ListWorkspacesResponse, Workspace> {
    val pageRequestValue = when (pageRequest) {
      PageRequest.First -> request
      is PageRequest.NextCursor -> request
      is PageRequest.NextOffset -> request
    ...
    val pageMetadata = metadataForListWorkspacesPage(pageRequest, limit, offset, httpReferer, xOpenRouterCategories, xOpenRouterTitle)
    val response = executor.execute<Unit, com.nabobery.sdkgen.generated.ListWorkspacesResponse>(SdkExecutionRequest(pageMetadata, baseUri, pageRequestValue, emptyList(), buildList {
      add(SdkRequestParameter(location = SdkParameterLocation.QUERY, name = "limit", values = limit?.let { listOf(it.toString()) }.orEmpty()))
      add(SdkRequestParameter(location = SdkParameterLocation.QUERY, name = "offset", values = when (pageRequest) {
        is PageRequest.NextOffset -> listOf(pageRequest.offset.toString())
        else -> offset?.let { listOf(it.toString()) }.orEmpty()
      ...
      add(SdkRequestParameter(location = SdkParameterLocation.HEADER, name = "X-OpenRouter-Categories", values = xOpenRouterCategories?.let { listOf(it.toString()) }.orEmpty()))
      add(SdkRequestParameter(location = SdkParameterLocation.HEADER, name = "X-OpenRouter-Title", values = xOpenRouterTitle?.let { listOf(it.toString()) }.orEmpty()))
    }), listOf(WorkspacesCodecs.LISTWORKSPACES_RESPONSE_CODEC_ID), WorkspacesCodecs.listWorkspacesRequestCodecRegistry, WorkspacesCodecs.listWorkspacesResponseCodecRegistry, options)
    return PageEnvelope(value = response, items = response.data.orEmpty())
  }
