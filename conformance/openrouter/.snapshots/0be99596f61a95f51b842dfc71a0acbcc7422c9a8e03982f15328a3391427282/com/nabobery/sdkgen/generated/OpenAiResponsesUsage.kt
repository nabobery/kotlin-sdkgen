 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/OpenAIResponsesUsage
 */
...
public class OpenAiResponsesUsage(
  ...
  internal object Serializer : KSerializer<OpenAiResponsesUsage> {
    ...
    override fun deserialize(decoder: Decoder): OpenAiResponsesUsage {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("OpenAiResponsesUsage must be a JSON object")
...
public fun openAiResponsesUsage(block: OpenAiResponsesUsage.Builder.() -> Unit): OpenAiResponsesUsage = OpenAiResponsesUsage.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("OpenAiResponsesUsage is missing required property '" + name + "'")
