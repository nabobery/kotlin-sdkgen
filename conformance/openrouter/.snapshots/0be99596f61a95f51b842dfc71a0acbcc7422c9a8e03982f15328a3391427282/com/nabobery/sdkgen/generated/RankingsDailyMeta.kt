 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/RankingsDailyMeta
 */
...
public class RankingsDailyMeta(
   ...
   */
  public val version: InlineRankingsDailyMetaVersionX9c51844e,
) {
  public class Builder {
    ...
    private var versionValue: InlineRankingsDailyMetaVersionX9c51844e? = null

    public var version: InlineRankingsDailyMetaVersionX9c51844e
  ...
  internal object Serializer : KSerializer<RankingsDailyMeta> {
    ...
    override fun deserialize(decoder: Decoder): RankingsDailyMeta {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("RankingsDailyMeta must be a JSON object")
      val asOf = json.decodeRequired<String>(rawObject, "as_of")
      val endDate = json.decodeRequired<String>(rawObject, "end_date")
      val startDate = json.decodeRequired<String>(rawObject, "start_date")
      val version = json.decodeRequired<InlineRankingsDailyMetaVersionX9c51844e>(rawObject, "version")
      return RankingsDailyMeta(
        asOf = asOf,
        endDate = endDate,
        startDate = startDate,
...
public fun rankingsDailyMeta(block: RankingsDailyMeta.Builder.() -> Unit): RankingsDailyMeta = RankingsDailyMeta.build(block)
