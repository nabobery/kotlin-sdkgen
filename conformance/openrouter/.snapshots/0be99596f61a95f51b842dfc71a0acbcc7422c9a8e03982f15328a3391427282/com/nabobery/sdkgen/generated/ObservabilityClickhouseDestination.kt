 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/ObservabilityClickhouseDestination
 */
...
public class ObservabilityClickhouseDestination(
  ...
  public class Builder {
    private var configValue: InlineObservabilityClickhouseDestinationConfigXc10e4bca? = null

    public var config: InlineObservabilityClickhouseDestinationConfigXc10e4bca
    ...
    private var typeValue: InlineObservabilityClickhouseDestinationTypeXab25c58f? = null

    public var type: InlineObservabilityClickhouseDestinationTypeXab25c58f
  ...
  internal object Serializer : KSerializer<ObservabilityClickhouseDestination> {
    ...
    override fun deserialize(decoder: Decoder): ObservabilityClickhouseDestination {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("ObservabilityClickhouseDestination must be a JSON object")
      val config = json.decodeRequired<InlineObservabilityClickhouseDestinationConfigXc10e4bca>(rawObject, "config")
      ...
      val type = json.decodeRequired<InlineObservabilityClickhouseDestinationTypeXab25c58f>(rawObject, "type")
...
public fun observabilityClickhouseDestination(block: ObservabilityClickhouseDestination.Builder.() -> Unit): ObservabilityClickhouseDestination = ObservabilityClickhouseDestination.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("ObservabilityClickhouseDestination is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("ObservabilityClickhouseDestination property '" + name + "' is not nullable")
