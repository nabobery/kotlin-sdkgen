 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/WebFetchPlugin
 */
...
public class WebFetchPlugin(
  ...
  public class Builder {
    private var idValue: InlineWebFetchPluginIdXbfd564fa? = null

    public var id: InlineWebFetchPluginIdXbfd564fa
  ...
  internal object Serializer : KSerializer<WebFetchPlugin> {
    ...
    override fun deserialize(decoder: Decoder): WebFetchPlugin {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("WebFetchPlugin must be a JSON object")
      val id = json.decodeRequired<InlineWebFetchPluginIdXbfd564fa>(rawObject, "id")
      return WebFetchPlugin(
        id = id,
