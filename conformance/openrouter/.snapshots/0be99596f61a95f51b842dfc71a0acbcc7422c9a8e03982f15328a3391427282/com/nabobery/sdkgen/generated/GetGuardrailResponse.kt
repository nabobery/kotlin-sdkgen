 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/GetGuardrailResponse
 */
...
public class GetGuardrailResponse(
  ...
  internal object Serializer : KSerializer<GetGuardrailResponse> {
    ...
    override fun deserialize(decoder: Decoder): GetGuardrailResponse {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("GetGuardrailResponse must be a JSON object")
...
public fun getGuardrailResponse(block: GetGuardrailResponse.Builder.() -> Unit): GetGuardrailResponse = GetGuardrailResponse.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("GetGuardrailResponse is missing required property '" + name + "'")
