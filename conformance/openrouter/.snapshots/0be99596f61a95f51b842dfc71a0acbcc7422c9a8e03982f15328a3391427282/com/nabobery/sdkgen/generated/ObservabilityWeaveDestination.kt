 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/ObservabilityWeaveDestination
 */
...
public class ObservabilityWeaveDestination(
  ...
  public class Builder {
    private var configValue: InlineObservabilityWeaveDestinationConfigX6fab4547? = null

    public var config: InlineObservabilityWeaveDestinationConfigX6fab4547
    ...
    private var typeValue: InlineObservabilityWeaveDestinationTypeX7ef86b2d? = null

    public var type: InlineObservabilityWeaveDestinationTypeX7ef86b2d
  ...
  internal object Serializer : KSerializer<ObservabilityWeaveDestination> {
    ...
    override fun deserialize(decoder: Decoder): ObservabilityWeaveDestination {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("ObservabilityWeaveDestination must be a JSON object")
      val config = json.decodeRequired<InlineObservabilityWeaveDestinationConfigX6fab4547>(rawObject, "config")
      ...
      val type = json.decodeRequired<InlineObservabilityWeaveDestinationTypeX7ef86b2d>(rawObject, "type")
...
public fun observabilityWeaveDestination(block: ObservabilityWeaveDestination.Builder.() -> Unit): ObservabilityWeaveDestination = ObservabilityWeaveDestination.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("ObservabilityWeaveDestination is missing required property '" + name + "'")
