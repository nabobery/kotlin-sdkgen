 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/AnthropicCitationPageLocationParam
 */
...
public class AnthropicCitationPageLocationParam(
  ...
  public class Builder {
    ...
    private var typeValue: InlineAnthropicCitationPageLocationParamTypeX53ed0e6c? = null

    public var type: InlineAnthropicCitationPageLocationParamTypeX53ed0e6c
  ...
  internal object Serializer : KSerializer<AnthropicCitationPageLocationParam> {
    ...
    override fun deserialize(decoder: Decoder): AnthropicCitationPageLocationParam {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("AnthropicCitationPageLocationParam must be a JSON object")
      ...
      val type = json.decodeRequired<InlineAnthropicCitationPageLocationParamTypeX53ed0e6c>(rawObject, "type")
...
public fun anthropicCitationPageLocationParam(block: AnthropicCitationPageLocationParam.Builder.() -> Unit): AnthropicCitationPageLocationParam = AnthropicCitationPageLocationParam.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("AnthropicCitationPageLocationParam is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("AnthropicCitationPageLocationParam property '" + name + "' is not nullable")
