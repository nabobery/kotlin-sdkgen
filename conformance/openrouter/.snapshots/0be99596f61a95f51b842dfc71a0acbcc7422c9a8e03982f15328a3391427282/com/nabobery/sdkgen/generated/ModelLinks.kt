 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/ModelLinks
 */
...
public class ModelLinks(
  ...
  internal object Serializer : KSerializer<ModelLinks> {
    ...
    override fun deserialize(decoder: Decoder): ModelLinks {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("ModelLinks must be a JSON object")
      val details = json.decodeRequired<String>(rawObject, "details")
      return ModelLinks(
        details = details,
      )
    }
