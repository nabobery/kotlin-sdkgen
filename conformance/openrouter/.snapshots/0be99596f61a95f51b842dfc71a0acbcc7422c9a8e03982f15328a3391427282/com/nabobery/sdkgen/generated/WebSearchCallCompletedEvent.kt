 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/WebSearchCallCompletedEvent
 */
...
public class WebSearchCallCompletedEvent(
  ...
  internal object Serializer : KSerializer<WebSearchCallCompletedEvent> {
    ...
    override fun deserialize(decoder: Decoder): WebSearchCallCompletedEvent {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("WebSearchCallCompletedEvent must be a JSON object")
...
public fun webSearchCallCompletedEvent(block: WebSearchCallCompletedEvent.Builder.() -> Unit): WebSearchCallCompletedEvent = WebSearchCallCompletedEvent.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("WebSearchCallCompletedEvent is missing required property '" + name + "'")
