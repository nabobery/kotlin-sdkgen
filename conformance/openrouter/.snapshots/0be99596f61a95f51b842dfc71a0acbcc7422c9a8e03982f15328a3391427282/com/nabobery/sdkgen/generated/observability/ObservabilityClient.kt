...
import com.nabobery.sdkgen.generated.ObservabilityDestination
...
public class ObservabilityClient(
  ...
  public suspend fun listObservabilityDestinations(
    ...
    xOpenRouterTitle: String? = null,
    options: CallOptions = CallOptions(),
  ): Page<com.nabobery.sdkgen.generated.ListObservabilityDestinationsResponse, ObservabilityDestination> {
    val engine = PaginationEngine<com.nabobery.sdkgen.generated.ListObservabilityDestinationsResponse, ObservabilityDestination>(
          descriptor = requireNotNull(listObservabilityDestinationsMetadata.pagination as? PaginationDescriptor.OffsetLimit),
          operationId = listObservabilityDestinationsMetadata.operationId,
          requestedPageSize = limit,
          initialOffset = offset?.toLong() ?: 0L,
        )
    return engine.firstPage { pageRequest -> fetchlistObservabilityDestinationsPage(Unit, limit, offset, workspaceId, httpReferer, xOpenRouterCategories, xOpenRouterTitle, pageRequest, options) }
  }
  ...
  /**
   * Returns a cold page flow for listObservabilityDestinations.
   *
   * @param limit Maximum number of records to return (max 100)
   * @param offset Number of records to skip for pagination
   * @param workspaceId Optional workspace ID to filter by. Defaults to the authenticated entity's default workspace.
   ...
   * @param options Execution options, including pagination bounds.
   */
  public fun listObservabilityDestinationsPages(
    limit: Int? = null,
    offset: Int? = null,
    workspaceId: String? = null,
    httpReferer: String? = null,
    ...
    xOpenRouterTitle: String? = null,
    options: CallOptions = CallOptions(),
  ): Flow<Page<com.nabobery.sdkgen.generated.ListObservabilityDestinationsResponse, ObservabilityDestination>> = PaginationEngine<com.nabobery.sdkgen.generated.ListObservabilityDestinationsResponse, ObservabilityDestination>(
    descriptor = requireNotNull(listObservabilityDestinationsMetadata.pagination as? PaginationDescriptor.OffsetLimit),
    operationId = listObservabilityDestinationsMetadata.operationId,
    requestedPageSize = limit,
    initialOffset = offset?.toLong() ?: 0L,
  ).pages(fetch = { pageRequest -> fetchlistObservabilityDestinationsPage(Unit, limit, offset, workspaceId, httpReferer, xOpenRouterCategories, xOpenRouterTitle, pageRequest, options) }, pagination = options.pagination)

  /**
   * Returns a cold item flow for listObservabilityDestinations.
   *
   * @param options Execution options, including pagination bounds.
   */
  public fun listObservabilityDestinationsItems(
    limit: Int? = null,
    offset: Int? = null,
    workspaceId: String? = null,
    httpReferer: String? = null,
    ...
    xOpenRouterTitle: String? = null,
    options: CallOptions = CallOptions(),
  ): Flow<ObservabilityDestination> = PaginationEngine<com.nabobery.sdkgen.generated.ListObservabilityDestinationsResponse, ObservabilityDestination>(
    descriptor = requireNotNull(listObservabilityDestinationsMetadata.pagination as? PaginationDescriptor.OffsetLimit),
    operationId = listObservabilityDestinationsMetadata.operationId,
    requestedPageSize = limit,
    initialOffset = offset?.toLong() ?: 0L,
  ).items(fetch = { pageRequest -> fetchlistObservabilityDestinationsPage(Unit, limit, offset, workspaceId, httpReferer, xOpenRouterCategories, xOpenRouterTitle, pageRequest, options) }, pagination = options.pagination)

  private fun metadataForListObservabilityDestinationsPage(
    ...
    xOpenRouterCategories: String? = null,
    xOpenRouterTitle: String? = null,
  ): OperationMetadata = listObservabilityDestinationsMetadata

  private suspend fun fetchlistObservabilityDestinationsPage(
    request: Unit,
    limit: Int? = null,
    offset: Int? = null,
    workspaceId: String? = null,
    ...
    pageRequest: PageRequest,
    options: CallOptions,
  ): PageEnvelope<com.nabobery.sdkgen.generated.ListObservabilityDestinationsResponse, ObservabilityDestination> {
    ...
    val pageMetadata = metadataForListObservabilityDestinationsPage(pageRequest, limit, offset, workspaceId, httpReferer, xOpenRouterCategories, xOpenRouterTitle)
    val response = executor.execute<Unit, com.nabobery.sdkgen.generated.ListObservabilityDestinationsResponse>(SdkExecutionRequest(pageMetadata, baseUri, pageRequestValue, emptyList(), buildList {
      add(SdkRequestParameter(location = SdkParameterLocation.QUERY, name = "limit", values = limit?.let { listOf(it.toString()) }.orEmpty()))
      ...
      add(SdkRequestParameter(location = SdkParameterLocation.HEADER, name = "X-OpenRouter-Categories", values = xOpenRouterCategories?.let { listOf(it.toString()) }.orEmpty()))
      add(SdkRequestParameter(location = SdkParameterLocation.HEADER, name = "X-OpenRouter-Title", values = xOpenRouterTitle?.let { listOf(it.toString()) }.orEmpty()))
    }), listOf(ObservabilityCodecs.LISTOBSERVABILITYDESTINATIONS_RESPONSE_CODEC_ID), ObservabilityCodecs.listObservabilityDestinationsRequestCodecRegistry, ObservabilityCodecs.listObservabilityDestinationsResponseCodecRegistry, options)
