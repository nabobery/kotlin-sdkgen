 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/OutputDatetimeItem
 */
...
public class OutputDatetimeItem(
  ...
  public class Builder {
    ...
    private var typeValue: InlineOutputDatetimeItemTypeXb3ed5cc0? = null

    public var type: InlineOutputDatetimeItemTypeXb3ed5cc0
  ...
  internal object Serializer : KSerializer<OutputDatetimeItem> {
    ...
    override fun deserialize(decoder: Decoder): OutputDatetimeItem {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("OutputDatetimeItem must be a JSON object")
      val datetime = json.decodeRequired<String>(rawObject, "datetime")
      val status = json.decodeRequired<ToolCallStatus>(rawObject, "status")
      val timezone = json.decodeRequired<String>(rawObject, "timezone")
      val type = json.decodeRequired<InlineOutputDatetimeItemTypeXb3ed5cc0>(rawObject, "type")
      return OutputDatetimeItem(
        datetime = datetime,
        status = status,
        timezone = timezone,
...
public fun outputDatetimeItem(block: OutputDatetimeItem.Builder.() -> Unit): OutputDatetimeItem = OutputDatetimeItem.build(block)
