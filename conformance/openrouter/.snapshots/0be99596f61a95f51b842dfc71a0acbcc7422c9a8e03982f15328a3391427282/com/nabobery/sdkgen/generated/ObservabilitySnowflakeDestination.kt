 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/ObservabilitySnowflakeDestination
 */
...
public class ObservabilitySnowflakeDestination(
  ...
  public class Builder {
    private var configValue: InlineObservabilitySnowflakeDestinationConfigXd7bd4928? = null

    public var config: InlineObservabilitySnowflakeDestinationConfigXd7bd4928
    ...
    private var typeValue: InlineObservabilitySnowflakeDestinationTypeXddfe0d50? = null

    public var type: InlineObservabilitySnowflakeDestinationTypeXddfe0d50
  ...
  internal object Serializer : KSerializer<ObservabilitySnowflakeDestination> {
    ...
    override fun deserialize(decoder: Decoder): ObservabilitySnowflakeDestination {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("ObservabilitySnowflakeDestination must be a JSON object")
      val config = json.decodeRequired<InlineObservabilitySnowflakeDestinationConfigXd7bd4928>(rawObject, "config")
      ...
      val type = json.decodeRequired<InlineObservabilitySnowflakeDestinationTypeXddfe0d50>(rawObject, "type")
...
public fun observabilitySnowflakeDestination(block: ObservabilitySnowflakeDestination.Builder.() -> Unit): ObservabilitySnowflakeDestination = ObservabilitySnowflakeDestination.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("ObservabilitySnowflakeDestination is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("ObservabilitySnowflakeDestination property '" + name + "' is not nullable")
