 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/ListPresetVersionsResponse
 */
...
public class ListPresetVersionsResponse(
  ...
  internal object Serializer : KSerializer<ListPresetVersionsResponse> {
    ...
    override fun deserialize(decoder: Decoder): ListPresetVersionsResponse {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("ListPresetVersionsResponse must be a JSON object")
      val data = json.decodeRequired<List<PresetDesignatedVersion?>>(rawObject, "data")
...
public fun listPresetVersionsResponse(block: ListPresetVersionsResponse.Builder.() -> Unit): ListPresetVersionsResponse = ListPresetVersionsResponse.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("ListPresetVersionsResponse is missing required property '" + name + "'")
