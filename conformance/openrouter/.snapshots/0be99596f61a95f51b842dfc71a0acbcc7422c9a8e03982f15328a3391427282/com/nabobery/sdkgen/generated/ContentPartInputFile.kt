 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/ContentPartInputFile
 */
...
public class ContentPartInputFile(
  ...
  public class Builder {
    ...
    private var typeValue: InlineContentPartInputFileTypeXe38b4826? = null

    public var type: InlineContentPartInputFileTypeXe38b4826
  ...
  internal object Serializer : KSerializer<ContentPartInputFile> {
    ...
    override fun deserialize(decoder: Decoder): ContentPartInputFile {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("ContentPartInputFile must be a JSON object")
      val inputFile = json.decodeRequired<MultimodalMedia>(rawObject, "input_file")
      val type = json.decodeRequired<InlineContentPartInputFileTypeXe38b4826>(rawObject, "type")
      return ContentPartInputFile(
        inputFile = inputFile,
        type = type,
      )
...
public fun contentPartInputFile(block: ContentPartInputFile.Builder.() -> Unit): ContentPartInputFile = ContentPartInputFile.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("ContentPartInputFile is missing required property '" + name + "'")
