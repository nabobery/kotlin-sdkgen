 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/ReasoningDeltaEvent
 */
...
public class ReasoningDeltaEvent(
  ...
  internal object Serializer : KSerializer<ReasoningDeltaEvent> {
    ...
    override fun deserialize(decoder: Decoder): ReasoningDeltaEvent {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("ReasoningDeltaEvent must be a JSON object")
...
public fun reasoningDeltaEvent(block: ReasoningDeltaEvent.Builder.() -> Unit): ReasoningDeltaEvent = ReasoningDeltaEvent.build(block)
