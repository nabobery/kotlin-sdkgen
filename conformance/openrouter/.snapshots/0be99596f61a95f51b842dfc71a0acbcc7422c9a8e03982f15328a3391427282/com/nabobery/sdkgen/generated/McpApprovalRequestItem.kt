 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/McpApprovalRequestItem
 */
...
public class McpApprovalRequestItem(
  ...
  public val type: InlineMcpApprovalRequestItemTypeX9ec23cf5,
) {
  public class Builder {
    ...
    private var typeValue: InlineMcpApprovalRequestItemTypeX9ec23cf5? = null

    public var type: InlineMcpApprovalRequestItemTypeX9ec23cf5
  ...
  internal object Serializer : KSerializer<McpApprovalRequestItem> {
    ...
    override fun deserialize(decoder: Decoder): McpApprovalRequestItem {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("McpApprovalRequestItem must be a JSON object")
      ...
      val type = json.decodeRequired<InlineMcpApprovalRequestItemTypeX9ec23cf5>(rawObject, "type")
      return McpApprovalRequestItem(
        arguments = arguments,
        id = id,
        name = name,
...
public fun mcpApprovalRequestItem(block: McpApprovalRequestItem.Builder.() -> Unit): McpApprovalRequestItem = McpApprovalRequestItem.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("McpApprovalRequestItem is missing required property '" + name + "'")
