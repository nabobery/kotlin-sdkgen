 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/ReasoningDoneEvent
 */
...
public class ReasoningDoneEvent(
  ...
  internal object Serializer : KSerializer<ReasoningDoneEvent> {
    ...
    override fun deserialize(decoder: Decoder): ReasoningDoneEvent {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("ReasoningDoneEvent must be a JSON object")
...
public fun reasoningDoneEvent(block: ReasoningDoneEvent.Builder.() -> Unit): ReasoningDoneEvent = ReasoningDoneEvent.build(block)
