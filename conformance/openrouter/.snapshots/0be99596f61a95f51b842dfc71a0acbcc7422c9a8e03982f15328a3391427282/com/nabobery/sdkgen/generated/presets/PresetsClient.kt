...
import com.nabobery.sdkgen.generated.Preset
import com.nabobery.sdkgen.generated.PresetDesignatedVersion
...
public class PresetsClient(
  ...
  public suspend fun listPresetVersions(
    ...
    xOpenRouterTitle: String? = null,
    options: CallOptions = CallOptions(),
  ): Page<com.nabobery.sdkgen.generated.ListPresetVersionsResponse, PresetDesignatedVersion?> {
    val engine = PaginationEngine<com.nabobery.sdkgen.generated.ListPresetVersionsResponse, PresetDesignatedVersion?>(
          descriptor = requireNotNull(listPresetVersionsMetadata.pagination as? PaginationDescriptor.OffsetLimit),
          operationId = listPresetVersionsMetadata.operationId,
          requestedPageSize = limit,
          initialOffset = offset?.toLong() ?: 0L,
        )
    return engine.firstPage { pageRequest -> fetchlistPresetVersionsPage(Unit, slug, limit, offset, httpReferer, xOpenRouterCategories, xOpenRouterTitle, pageRequest, options) }
  }
  ...
  /**
   * Returns a cold page flow for listPresetVersions.
   *
   * @param slug URL-safe slug identifying the preset.
   * @param limit Maximum number of records to return (max 100)
   * @param offset Number of records to skip for pagination
   ...
   * @param options Execution options, including pagination bounds.
   */
  public fun listPresetVersionsPages(
    slug: String,
    limit: Int? = null,
    offset: Int? = null,
    httpReferer: String? = null,
    ...
    xOpenRouterTitle: String? = null,
    options: CallOptions = CallOptions(),
  ): Flow<Page<com.nabobery.sdkgen.generated.ListPresetVersionsResponse, PresetDesignatedVersion?>> = PaginationEngine<com.nabobery.sdkgen.generated.ListPresetVersionsResponse, PresetDesignatedVersion?>(
    descriptor = requireNotNull(listPresetVersionsMetadata.pagination as? PaginationDescriptor.OffsetLimit),
    operationId = listPresetVersionsMetadata.operationId,
    requestedPageSize = limit,
    initialOffset = offset?.toLong() ?: 0L,
  ).pages(fetch = { pageRequest -> fetchlistPresetVersionsPage(Unit, slug, limit, offset, httpReferer, xOpenRouterCategories, xOpenRouterTitle, pageRequest, options) }, pagination = options.pagination)

  /**
   * Returns a cold item flow for listPresetVersions.
   *
   * @param options Execution options, including pagination bounds.
   */
  public fun listPresetVersionsItems(
    slug: String,
    limit: Int? = null,
    offset: Int? = null,
    httpReferer: String? = null,
    ...
    xOpenRouterTitle: String? = null,
    options: CallOptions = CallOptions(),
  ): Flow<PresetDesignatedVersion?> = PaginationEngine<com.nabobery.sdkgen.generated.ListPresetVersionsResponse, PresetDesignatedVersion?>(
    descriptor = requireNotNull(listPresetVersionsMetadata.pagination as? PaginationDescriptor.OffsetLimit),
    operationId = listPresetVersionsMetadata.operationId,
    requestedPageSize = limit,
    initialOffset = offset?.toLong() ?: 0L,
  ).items(fetch = { pageRequest -> fetchlistPresetVersionsPage(Unit, slug, limit, offset, httpReferer, xOpenRouterCategories, xOpenRouterTitle, pageRequest, options) }, pagination = options.pagination)

  private fun metadataForListPresetVersionsPage(
    ...
    xOpenRouterCategories: String? = null,
    xOpenRouterTitle: String? = null,
  ): OperationMetadata = listPresetVersionsMetadata

  private suspend fun fetchlistPresetVersionsPage(
    request: Unit,
    slug: String,
    limit: Int? = null,
    offset: Int? = null,
    ...
    pageRequest: PageRequest,
    options: CallOptions,
  ): PageEnvelope<com.nabobery.sdkgen.generated.ListPresetVersionsResponse, PresetDesignatedVersion?> {
    ...
    val pageMetadata = metadataForListPresetVersionsPage(pageRequest, slug, limit, offset, httpReferer, xOpenRouterCategories, xOpenRouterTitle)
    val response = executor.execute<Unit, com.nabobery.sdkgen.generated.ListPresetVersionsResponse>(SdkExecutionRequest(pageMetadata, baseUri, pageRequestValue, emptyList(), buildList {
      add(SdkRequestParameter(location = SdkParameterLocation.PATH, name = "slug", values = listOf(slug.toString())))
      add(SdkRequestParameter(location = SdkParameterLocation.QUERY, name = "limit", values = limit?.let { listOf(it.toString()) }.orEmpty()))
      ...
      add(SdkRequestParameter(location = SdkParameterLocation.HEADER, name = "X-OpenRouter-Categories", values = xOpenRouterCategories?.let { listOf(it.toString()) }.orEmpty()))
      add(SdkRequestParameter(location = SdkParameterLocation.HEADER, name = "X-OpenRouter-Title", values = xOpenRouterTitle?.let { listOf(it.toString()) }.orEmpty()))
    }), listOf(PresetsCodecs.LISTPRESETVERSIONS_RESPONSE_CODEC_ID), PresetsCodecs.listPresetVersionsRequestCodecRegistry, PresetsCodecs.listPresetVersionsResponseCodecRegistry, options)
  ...
  public suspend fun listPresets(
    ...
    xOpenRouterTitle: String? = null,
    options: CallOptions = CallOptions(),
  ): Page<com.nabobery.sdkgen.generated.ListPresetsResponse, Preset> {
    val engine = PaginationEngine<com.nabobery.sdkgen.generated.ListPresetsResponse, Preset>(
          descriptor = requireNotNull(listPresetsMetadata.pagination as? PaginationDescriptor.OffsetLimit),
          operationId = listPresetsMetadata.operationId,
          requestedPageSize = limit,
          initialOffset = offset?.toLong() ?: 0L,
        )
    return engine.firstPage { pageRequest -> fetchlistPresetsPage(Unit, limit, offset, httpReferer, xOpenRouterCategories, xOpenRouterTitle, pageRequest, options) }
  }
  ...
  /**
   * Returns a cold page flow for listPresets.
   *
   * @param limit Maximum number of records to return (max 100)
   * @param offset Number of records to skip for pagination
   * @param httpReferer The app identifier should be your app's URL and is used as the primary identifier for rankings.
  ...
  public fun listPresetsPages(
    ...
    xOpenRouterTitle: String? = null,
    options: CallOptions = CallOptions(),
  ): Flow<Page<com.nabobery.sdkgen.generated.ListPresetsResponse, Preset>> = PaginationEngine<com.nabobery.sdkgen.generated.ListPresetsResponse, Preset>(
    descriptor = requireNotNull(listPresetsMetadata.pagination as? PaginationDescriptor.OffsetLimit),
    operationId = listPresetsMetadata.operationId,
    requestedPageSize = limit,
    initialOffset = offset?.toLong() ?: 0L,
  ).pages(fetch = { pageRequest -> fetchlistPresetsPage(Unit, limit, offset, httpReferer, xOpenRouterCategories, xOpenRouterTitle, pageRequest, options) }, pagination = options.pagination)

  /**
   * Returns a cold item flow for listPresets.
   *
   * @param options Execution options, including pagination bounds.
   */
  public fun listPresetsItems(
    limit: Int? = null,
    offset: Int? = null,
    httpReferer: String? = null,
    xOpenRouterCategories: String? = null,
    xOpenRouterTitle: String? = null,
    options: CallOptions = CallOptions(),
  ): Flow<Preset> = PaginationEngine<com.nabobery.sdkgen.generated.ListPresetsResponse, Preset>(
    descriptor = requireNotNull(listPresetsMetadata.pagination as? PaginationDescriptor.OffsetLimit),
    operationId = listPresetsMetadata.operationId,
    requestedPageSize = limit,
    initialOffset = offset?.toLong() ?: 0L,
  ).items(fetch = { pageRequest -> fetchlistPresetsPage(Unit, limit, offset, httpReferer, xOpenRouterCategories, xOpenRouterTitle, pageRequest, options) }, pagination = options.pagination)

  private fun metadataForListPresetsPage(
    pageRequest: PageRequest,
    limit: Int? = null,
    offset: Int? = null,
    httpReferer: String? = null,
    xOpenRouterCategories: String? = null,
    xOpenRouterTitle: String? = null,
  ): OperationMetadata = listPresetsMetadata

  private suspend fun fetchlistPresetsPage(
    request: Unit,
    limit: Int? = null,
    offset: Int? = null,
    httpReferer: String? = null,
    ...
    pageRequest: PageRequest,
    options: CallOptions,
  ): PageEnvelope<com.nabobery.sdkgen.generated.ListPresetsResponse, Preset> {
    val pageRequestValue = when (pageRequest) {
      PageRequest.First -> request
      is PageRequest.NextCursor -> request
      is PageRequest.NextOffset -> request
    ...
    val pageMetadata = metadataForListPresetsPage(pageRequest, limit, offset, httpReferer, xOpenRouterCategories, xOpenRouterTitle)
    val response = executor.execute<Unit, com.nabobery.sdkgen.generated.ListPresetsResponse>(SdkExecutionRequest(pageMetadata, baseUri, pageRequestValue, emptyList(), buildList {
      add(SdkRequestParameter(location = SdkParameterLocation.QUERY, name = "limit", values = limit?.let { listOf(it.toString()) }.orEmpty()))
      add(SdkRequestParameter(location = SdkParameterLocation.QUERY, name = "offset", values = when (pageRequest) {
        is PageRequest.NextOffset -> listOf(pageRequest.offset.toString())
        else -> offset?.let { listOf(it.toString()) }.orEmpty()
      ...
      add(SdkRequestParameter(location = SdkParameterLocation.HEADER, name = "X-OpenRouter-Categories", values = xOpenRouterCategories?.let { listOf(it.toString()) }.orEmpty()))
      add(SdkRequestParameter(location = SdkParameterLocation.HEADER, name = "X-OpenRouter-Title", values = xOpenRouterTitle?.let { listOf(it.toString()) }.orEmpty()))
    }), listOf(PresetsCodecs.LISTPRESETS_RESPONSE_CODEC_ID), PresetsCodecs.listPresetsRequestCodecRegistry, PresetsCodecs.listPresetsResponseCodecRegistry, options)
    return PageEnvelope(value = response, items = response.data.orEmpty())
  }
