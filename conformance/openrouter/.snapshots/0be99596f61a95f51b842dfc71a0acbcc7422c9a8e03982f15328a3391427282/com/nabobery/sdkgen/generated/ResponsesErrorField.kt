 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/ResponsesErrorField
 */
@Serializable(with = ResponsesErrorField.Serializer::class)
public class ResponsesErrorField(
  public val code: InlineResponsesErrorFieldCodeX734f62c3,
  public val message: String,
) {
  public class Builder {
    private var codeValue: InlineResponsesErrorFieldCodeX734f62c3? = null

    public var code: InlineResponsesErrorFieldCodeX734f62c3
  ...
  internal object Serializer : KSerializer<ResponsesErrorField> {
    ...
    override fun deserialize(decoder: Decoder): ResponsesErrorField {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("ResponsesErrorField must be a JSON object")
      val code = json.decodeRequired<InlineResponsesErrorFieldCodeX734f62c3>(rawObject, "code")
...
public fun responsesErrorField(block: ResponsesErrorField.Builder.() -> Unit): ResponsesErrorField = ResponsesErrorField.build(block)
