 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/ChatStreamToolCall
 */
...
public class ChatStreamToolCall(
   ...
   */
  public val function: InlineChatStreamToolCallFunctionX01cca6f3? = null,
  /**
   ...
   * Tool call type
   */
  public val type: InlineChatStreamToolCallTypeXecffef62? = null,
) {
  public class Builder {
     ...
     * Function call details
     */
    public var function: InlineChatStreamToolCallFunctionX01cca6f3? = null
     ...
     * Tool call type
     */
    public var type: InlineChatStreamToolCallTypeXecffef62? = null
  ...
  internal object Serializer : KSerializer<ChatStreamToolCall> {
    ...
    override fun deserialize(decoder: Decoder): ChatStreamToolCall {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("ChatStreamToolCall must be a JSON object")
      val index = json.decodeRequired<Int>(rawObject, "index")
      return ChatStreamToolCall(
        index = index,
        function = rawObject["function"]?.let { json.decodeFromJsonElement<InlineChatStreamToolCallFunctionX01cca6f3>(it) },
        id = rawObject["id"]?.let { json.decodeFromJsonElement<String>(it) },
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineChatStreamToolCallTypeXecffef62>(it) },
      )
    }
...
public fun chatStreamToolCall(block: ChatStreamToolCall.Builder.() -> Unit): ChatStreamToolCall = ChatStreamToolCall.build(block)
