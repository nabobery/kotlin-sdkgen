 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/BaseTextDoneEvent
 */
...
public class BaseTextDoneEvent(
  ...
  public class Builder {
    ...
    private var typeValue: InlineBaseTextDoneEventTypeX0b2acb76? = null

    public var type: InlineBaseTextDoneEventTypeX0b2acb76
  ...
  internal object Serializer : KSerializer<BaseTextDoneEvent> {
    ...
    override fun deserialize(decoder: Decoder): BaseTextDoneEvent {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("BaseTextDoneEvent must be a JSON object")
      ...
      val type = json.decodeRequired<InlineBaseTextDoneEventTypeX0b2acb76>(rawObject, "type")
      return BaseTextDoneEvent(
        contentIndex = contentIndex,
        itemId = itemId,
        logprobs = logprobs,
...
public fun baseTextDoneEvent(block: BaseTextDoneEvent.Builder.() -> Unit): BaseTextDoneEvent = BaseTextDoneEvent.build(block)
