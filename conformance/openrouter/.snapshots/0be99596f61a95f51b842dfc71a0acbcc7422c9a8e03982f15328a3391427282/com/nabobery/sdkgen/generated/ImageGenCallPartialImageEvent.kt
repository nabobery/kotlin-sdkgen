 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/ImageGenCallPartialImageEvent
 */
...
public class ImageGenCallPartialImageEvent(
  ...
  internal object Serializer : KSerializer<ImageGenCallPartialImageEvent> {
    ...
    override fun deserialize(decoder: Decoder): ImageGenCallPartialImageEvent {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("ImageGenCallPartialImageEvent must be a JSON object")
...
public fun imageGenCallPartialImageEvent(block: ImageGenCallPartialImageEvent.Builder.() -> Unit): ImageGenCallPartialImageEvent = ImageGenCallPartialImageEvent.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("ImageGenCallPartialImageEvent is missing required property '" + name + "'")
