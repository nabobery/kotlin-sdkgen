 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/PublicEndpoint/properties/pricing
 */
@Serializable(with = InlinePublicEndpointPricingX2f179764.Serializer::class)
public class InlinePublicEndpointPricingX2f179764(
  /**
  ...
  public class Builder {
    ...
    public fun build(): InlinePublicEndpointPricingX2f179764 {
      check(completionValue != null) { "completion is required" }
      check(promptValue != null) { "prompt is required" }
      return InlinePublicEndpointPricingX2f179764(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlinePublicEndpointPricingX2f179764 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlinePublicEndpointPricingX2f179764> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlinePublicEndpointPricingX2f179764 {
      val jsonDecoder = decoder.requireJsonDecoder("InlinePublicEndpointPricingX2f179764")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlinePublicEndpointPricingX2f179764 must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlinePublicEndpointPricingX2f179764) {
      val jsonEncoder = encoder.requireJsonEncoder("InlinePublicEndpointPricingX2f179764")
...
public fun inlinePublicEndpointPricingX2f179764(block: InlinePublicEndpointPricingX2f179764.Builder.() -> Unit): InlinePublicEndpointPricingX2f179764 = InlinePublicEndpointPricingX2f179764.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlinePublicEndpointPricingX2f179764 is missing required property '" + name + "'")
