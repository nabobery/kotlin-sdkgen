 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/ChatStreamOptions
 */
...
public class ChatStreamOptions(
  ...
  internal object Serializer : KSerializer<ChatStreamOptions> {
    ...
    override fun deserialize(decoder: Decoder): ChatStreamOptions {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("ChatStreamOptions must be a JSON object")
      return ChatStreamOptions(
        includeUsage = rawObject["include_usage"]?.let { json.decodeFromJsonElement<Boolean>(it) },
      )
    }
...
public fun chatStreamOptions(block: ChatStreamOptions.Builder.() -> Unit): ChatStreamOptions = ChatStreamOptions.build(block)
