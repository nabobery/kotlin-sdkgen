 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/ImageGenerationProviderPreferences/properties/options
 */
@Serializable(with = InlineImageGenerationProviderPreferencesOptionsX928030c1.Serializer::class)
public class InlineImageGenerationProviderPreferencesOptionsX928030c1(
  ...
  public class Builder {
    ...
    public fun build(): InlineImageGenerationProviderPreferencesOptionsX928030c1 = InlineImageGenerationProviderPreferencesOptionsX928030c1(
      _01ai = _01ai,
      ai21 = ai21,
      aionLabs = aionLabs,
      akashml = akashml,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineImageGenerationProviderPreferencesOptionsX928030c1 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineImageGenerationProviderPreferencesOptionsX928030c1> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineImageGenerationProviderPreferencesOptionsX928030c1 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineImageGenerationProviderPreferencesOptionsX928030c1")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineImageGenerationProviderPreferencesOptionsX928030c1 must be a JSON object")
      return InlineImageGenerationProviderPreferencesOptionsX928030c1(
    ...
    override fun serialize(encoder: Encoder, `value`: InlineImageGenerationProviderPreferencesOptionsX928030c1) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineImageGenerationProviderPreferencesOptionsX928030c1")
...
public fun inlineImageGenerationProviderPreferencesOptionsX928030c1(block: InlineImageGenerationProviderPreferencesOptionsX928030c1.Builder.() -> Unit): InlineImageGenerationProviderPreferencesOptionsX928030c1 = InlineImageGenerationProviderPreferencesOptionsX928030c1.build(block)
