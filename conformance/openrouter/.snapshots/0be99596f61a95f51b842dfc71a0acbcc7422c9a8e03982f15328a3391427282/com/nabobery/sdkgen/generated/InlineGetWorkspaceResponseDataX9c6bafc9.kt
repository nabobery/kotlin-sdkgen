...
/**
 * Generated model for sdkgen://source/openapi.yaml#/components/schemas/GetWorkspaceResponse/properties/data.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/GetWorkspaceResponse/properties/data
 */
@Serializable(with = InlineGetWorkspaceResponseDataX9c6bafc9.Serializer::class)
public class InlineGetWorkspaceResponseDataX9c6bafc9(
  /**
  ...
  public class Builder {
    ...
    public fun build(): InlineGetWorkspaceResponseDataX9c6bafc9 {
      ...
      return InlineGetWorkspaceResponseDataX9c6bafc9(
        createdAt = createdAt,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineGetWorkspaceResponseDataX9c6bafc9 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineGetWorkspaceResponseDataX9c6bafc9> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineGetWorkspaceResponseDataX9c6bafc9 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineGetWorkspaceResponseDataX9c6bafc9")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineGetWorkspaceResponseDataX9c6bafc9 must be a JSON object")
      ...
      if (!rawObject.containsKey("created_by")) {
        throw SerializationException("InlineGetWorkspaceResponseDataX9c6bafc9 is missing required property 'created_by'")
      }
      ...
      if (!rawObject.containsKey("default_image_model")) {
        throw SerializationException("InlineGetWorkspaceResponseDataX9c6bafc9 is missing required property 'default_image_model'")
      }
      ...
      if (!rawObject.containsKey("default_provider_sort")) {
        throw SerializationException("InlineGetWorkspaceResponseDataX9c6bafc9 is missing required property 'default_provider_sort'")
      }
      ...
      if (!rawObject.containsKey("default_text_model")) {
        throw SerializationException("InlineGetWorkspaceResponseDataX9c6bafc9 is missing required property 'default_text_model'")
      }
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineGetWorkspaceResponseDataX9c6bafc9 is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("io_logging_api_key_ids")) {
        throw SerializationException("InlineGetWorkspaceResponseDataX9c6bafc9 is missing required property 'io_logging_api_key_ids'")
      }
      ...
      if (!rawObject.containsKey("updated_at")) {
        throw SerializationException("InlineGetWorkspaceResponseDataX9c6bafc9 is missing required property 'updated_at'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineGetWorkspaceResponseDataX9c6bafc9) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineGetWorkspaceResponseDataX9c6bafc9")
...
public fun inlineGetWorkspaceResponseDataX9c6bafc9(block: InlineGetWorkspaceResponseDataX9c6bafc9.Builder.() -> Unit): InlineGetWorkspaceResponseDataX9c6bafc9 = InlineGetWorkspaceResponseDataX9c6bafc9.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineGetWorkspaceResponseDataX9c6bafc9 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineGetWorkspaceResponseDataX9c6bafc9 property '" + name + "' is not nullable")
