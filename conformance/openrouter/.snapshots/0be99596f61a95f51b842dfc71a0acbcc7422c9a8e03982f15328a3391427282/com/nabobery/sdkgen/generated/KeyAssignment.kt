 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/KeyAssignment
 */
...
public class KeyAssignment(
  ...
  internal object Serializer : KSerializer<KeyAssignment> {
    ...
    override fun deserialize(decoder: Decoder): KeyAssignment {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("KeyAssignment must be a JSON object")
      val createdAt = json.decodeRequired<String>(rawObject, "created_at")
      val guardrailId = json.decodeRequired<String>(rawObject, "guardrail_id")
      val id = json.decodeRequired<String>(rawObject, "id")
      val keyHash = json.decodeRequired<String>(rawObject, "key_hash")
      val keyLabel = json.decodeRequired<String>(rawObject, "key_label")
      val keyName = json.decodeRequired<String>(rawObject, "key_name")
