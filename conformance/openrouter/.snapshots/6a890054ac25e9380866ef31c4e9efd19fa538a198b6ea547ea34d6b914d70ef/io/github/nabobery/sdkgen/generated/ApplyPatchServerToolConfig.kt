 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/ApplyPatchServerToolConfig
 */
...
public class ApplyPatchServerToolConfig(
  ...
  internal object Serializer : KSerializer<ApplyPatchServerToolConfig> {
    ...
    override fun deserialize(decoder: Decoder): ApplyPatchServerToolConfig {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("ApplyPatchServerToolConfig must be a JSON object")
      return ApplyPatchServerToolConfig(
        engine = rawObject["engine"]?.let { json.decodeFromJsonElement<ApplyPatchEngineEnum>(it) },
      )
    }
...
public fun applyPatchServerToolConfig(block: ApplyPatchServerToolConfig.Builder.() -> Unit): ApplyPatchServerToolConfig = ApplyPatchServerToolConfig.build(block)
