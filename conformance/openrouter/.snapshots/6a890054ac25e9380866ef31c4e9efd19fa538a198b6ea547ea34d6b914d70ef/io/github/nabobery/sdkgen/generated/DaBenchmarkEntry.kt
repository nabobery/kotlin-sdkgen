 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/DABenchmarkEntry
 */
...
public class DaBenchmarkEntry(
  ...
  internal object Serializer : KSerializer<DaBenchmarkEntry> {
    ...
    override fun deserialize(decoder: Decoder): DaBenchmarkEntry {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("DaBenchmarkEntry must be a JSON object")
...
public fun daBenchmarkEntry(block: DaBenchmarkEntry.Builder.() -> Unit): DaBenchmarkEntry = DaBenchmarkEntry.build(block)
