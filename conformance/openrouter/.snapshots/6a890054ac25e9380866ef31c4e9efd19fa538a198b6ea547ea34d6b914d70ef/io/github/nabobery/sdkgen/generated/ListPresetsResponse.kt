 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/ListPresetsResponse
 */
...
public class ListPresetsResponse(
  ...
  internal object Serializer : KSerializer<ListPresetsResponse> {
    ...
    override fun deserialize(decoder: Decoder): ListPresetsResponse {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("ListPresetsResponse must be a JSON object")
      val data = json.decodeRequired<List<Preset>>(rawObject, "data")
...
public fun listPresetsResponse(block: ListPresetsResponse.Builder.() -> Unit): ListPresetsResponse = ListPresetsResponse.build(block)
