 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/ListWorkspaceBudgetsResponse
 */
...
public class ListWorkspaceBudgetsResponse(
  ...
  internal object Serializer : KSerializer<ListWorkspaceBudgetsResponse> {
    ...
    override fun deserialize(decoder: Decoder): ListWorkspaceBudgetsResponse {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("ListWorkspaceBudgetsResponse must be a JSON object")
      val data = json.decodeRequired<List<WorkspaceBudget>>(rawObject, "data")
      return ListWorkspaceBudgetsResponse(
        data = data,
      )
    }
...
public fun listWorkspaceBudgetsResponse(block: ListWorkspaceBudgetsResponse.Builder.() -> Unit): ListWorkspaceBudgetsResponse = ListWorkspaceBudgetsResponse.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("ListWorkspaceBudgetsResponse is missing required property '" + name + "'")
