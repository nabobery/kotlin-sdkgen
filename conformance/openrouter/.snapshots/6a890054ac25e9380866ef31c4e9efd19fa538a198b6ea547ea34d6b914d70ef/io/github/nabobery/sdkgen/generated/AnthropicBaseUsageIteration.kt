 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/AnthropicBaseUsageIteration
 */
...
public class AnthropicBaseUsageIteration(
  ...
  internal object Serializer : KSerializer<AnthropicBaseUsageIteration> {
    ...
    override fun deserialize(decoder: Decoder): AnthropicBaseUsageIteration {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("AnthropicBaseUsageIteration must be a JSON object")
...
public fun anthropicBaseUsageIteration(block: AnthropicBaseUsageIteration.Builder.() -> Unit): AnthropicBaseUsageIteration = AnthropicBaseUsageIteration.build(block)
