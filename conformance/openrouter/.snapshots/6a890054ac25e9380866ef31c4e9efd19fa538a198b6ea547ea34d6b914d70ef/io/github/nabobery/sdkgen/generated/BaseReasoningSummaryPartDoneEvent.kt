 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/BaseReasoningSummaryPartDoneEvent
 */
@Serializable(with = BaseReasoningSummaryPartDoneEvent.Serializer::class)
public class BaseReasoningSummaryPartDoneEvent(
  ...
  public class Builder {
    ...
    private var typeValue: InlineBaseReasoningSummaryPartDoneEventTypeXddb16b1a? = null

    public var type: InlineBaseReasoningSummaryPartDoneEventTypeXddb16b1a
      get() = requireNotNull(typeValue) { "type is required" }
      set(`value`) {
        typeValue = value
      }

    public fun build(): BaseReasoningSummaryPartDoneEvent {
      ...
      return BaseReasoningSummaryPartDoneEvent(
        itemId = itemId,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): BaseReasoningSummaryPartDoneEvent = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<BaseReasoningSummaryPartDoneEvent> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): BaseReasoningSummaryPartDoneEvent {
      val jsonDecoder = decoder.requireJsonDecoder("BaseReasoningSummaryPartDoneEvent")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("BaseReasoningSummaryPartDoneEvent must be a JSON object")
      ...
      val type = json.decodeRequired<InlineBaseReasoningSummaryPartDoneEventTypeXddb16b1a>(rawObject, "type")
      return BaseReasoningSummaryPartDoneEvent(
        itemId = itemId,
        outputIndex = outputIndex,
        part = part,
    ...
    override fun serialize(encoder: Encoder, `value`: BaseReasoningSummaryPartDoneEvent) {
      val jsonEncoder = encoder.requireJsonEncoder("BaseReasoningSummaryPartDoneEvent")
...
public fun baseReasoningSummaryPartDoneEvent(block: BaseReasoningSummaryPartDoneEvent.Builder.() -> Unit): BaseReasoningSummaryPartDoneEvent = BaseReasoningSummaryPartDoneEvent.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("BaseReasoningSummaryPartDoneEvent is missing required property '" + name + "'")
