 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/FunctionTool
 */
...
public class FunctionTool internal constructor(
  ...
  internal object Serializer : KSerializer<FunctionTool> {
    ...
    override fun deserialize(decoder: Decoder): FunctionTool {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("FunctionTool must be a JSON object")
