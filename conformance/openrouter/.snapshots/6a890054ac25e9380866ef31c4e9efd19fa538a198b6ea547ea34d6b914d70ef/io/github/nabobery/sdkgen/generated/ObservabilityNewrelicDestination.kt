 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/ObservabilityNewrelicDestination
 */
...
public class ObservabilityNewrelicDestination(
  ...
  public class Builder {
    private var configValue: InlineObservabilityNewrelicDestinationConfigX9a13614a? = null

    public var config: InlineObservabilityNewrelicDestinationConfigX9a13614a
    ...
    private var typeValue: InlineObservabilityNewrelicDestinationTypeX5f5ea9f0? = null

    public var type: InlineObservabilityNewrelicDestinationTypeX5f5ea9f0
  ...
  internal object Serializer : KSerializer<ObservabilityNewrelicDestination> {
    ...
    override fun deserialize(decoder: Decoder): ObservabilityNewrelicDestination {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("ObservabilityNewrelicDestination must be a JSON object")
      val config = json.decodeRequired<InlineObservabilityNewrelicDestinationConfigX9a13614a>(rawObject, "config")
      ...
      val type = json.decodeRequired<InlineObservabilityNewrelicDestinationTypeX5f5ea9f0>(rawObject, "type")
...
public fun observabilityNewrelicDestination(block: ObservabilityNewrelicDestination.Builder.() -> Unit): ObservabilityNewrelicDestination = ObservabilityNewrelicDestination.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("ObservabilityNewrelicDestination is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("ObservabilityNewrelicDestination property '" + name + "' is not nullable")
