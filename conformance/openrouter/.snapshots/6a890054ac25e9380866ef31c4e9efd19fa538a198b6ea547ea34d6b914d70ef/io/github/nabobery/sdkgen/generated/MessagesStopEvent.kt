 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/MessagesStopEvent
 */
...
public class MessagesStopEvent(
  ...
  public class Builder {
    private var typeValue: InlineMessagesStopEventTypeX456a472f? = null

    public var type: InlineMessagesStopEventTypeX456a472f
  ...
  internal object Serializer : KSerializer<MessagesStopEvent> {
    ...
    override fun deserialize(decoder: Decoder): MessagesStopEvent {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("MessagesStopEvent must be a JSON object")
      val type = json.decodeRequired<InlineMessagesStopEventTypeX456a472f>(rawObject, "type")
      return MessagesStopEvent(
        type = type,
...
public fun messagesStopEvent(block: MessagesStopEvent.Builder.() -> Unit): MessagesStopEvent = MessagesStopEvent.build(block)
