 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/PresetWithDesignatedVersion
 */
...
public class PresetWithDesignatedVersion(
  ...
  internal object Serializer : KSerializer<PresetWithDesignatedVersion> {
    ...
    override fun deserialize(decoder: Decoder): PresetWithDesignatedVersion {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("PresetWithDesignatedVersion must be a JSON object")
...
public fun presetWithDesignatedVersion(block: PresetWithDesignatedVersion.Builder.() -> Unit): PresetWithDesignatedVersion = PresetWithDesignatedVersion.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("PresetWithDesignatedVersion is missing required property '" + name + "'")
