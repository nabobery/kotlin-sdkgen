 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/ObservabilityOtelCollectorDestination
 */
...
public class ObservabilityOtelCollectorDestination(
  ...
  public class Builder {
    private var configValue: InlineObservabilityOtelCollectorDestinationConfigX25371089? = null

    public var config: InlineObservabilityOtelCollectorDestinationConfigX25371089
    ...
    private var typeValue: InlineObservabilityOtelCollectorDestinationTypeX374fb456? = null

    public var type: InlineObservabilityOtelCollectorDestinationTypeX374fb456
  ...
  internal object Serializer : KSerializer<ObservabilityOtelCollectorDestination> {
    ...
    override fun deserialize(decoder: Decoder): ObservabilityOtelCollectorDestination {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("ObservabilityOtelCollectorDestination must be a JSON object")
      val config = json.decodeRequired<InlineObservabilityOtelCollectorDestinationConfigX25371089>(rawObject, "config")
      ...
      val type = json.decodeRequired<InlineObservabilityOtelCollectorDestinationTypeX374fb456>(rawObject, "type")
      val updatedAt = json.decodeRequired<String>(rawObject, "updated_at")
      val workspaceId = json.decodeRequired<String>(rawObject, "workspace_id")
      if (!rawObject.containsKey("api_key_hashes")) {
        throw SerializationException("ObservabilityOtelCollectorDestination is missing required property 'api_key_hashes'")
      }
      ...
      if (!rawObject.containsKey("filter_rules")) {
        throw SerializationException("ObservabilityOtelCollectorDestination is missing required property 'filter_rules'")
      }
...
public fun observabilityOtelCollectorDestination(block: ObservabilityOtelCollectorDestination.Builder.() -> Unit): ObservabilityOtelCollectorDestination = ObservabilityOtelCollectorDestination.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("ObservabilityOtelCollectorDestination is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("ObservabilityOtelCollectorDestination property '" + name + "' is not nullable")
