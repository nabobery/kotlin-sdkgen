 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/MemberAssignment
 */
...
public class MemberAssignment(
  ...
  internal object Serializer : KSerializer<MemberAssignment> {
    ...
    override fun deserialize(decoder: Decoder): MemberAssignment {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("MemberAssignment must be a JSON object")
      val createdAt = json.decodeRequired<String>(rawObject, "created_at")
      val guardrailId = json.decodeRequired<String>(rawObject, "guardrail_id")
      val id = json.decodeRequired<String>(rawObject, "id")
      val organizationId = json.decodeRequired<String>(rawObject, "organization_id")
      val userId = json.decodeRequired<String>(rawObject, "user_id")
      if (!rawObject.containsKey("assigned_by")) {
        throw SerializationException("MemberAssignment is missing required property 'assigned_by'")
      }
      val assignedBy = rawObject["assigned_by"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<String?>(requireNotNull(element)) }
      return MemberAssignment(
...
public fun memberAssignment(block: MemberAssignment.Builder.() -> Unit): MemberAssignment = MemberAssignment.build(block)
