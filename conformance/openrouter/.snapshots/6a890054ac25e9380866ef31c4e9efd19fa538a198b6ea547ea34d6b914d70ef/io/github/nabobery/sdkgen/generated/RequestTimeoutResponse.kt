 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/RequestTimeoutResponse
 */
...
public class RequestTimeoutResponse(
  ...
  internal object Serializer : KSerializer<RequestTimeoutResponse> {
    ...
    override fun deserialize(decoder: Decoder): RequestTimeoutResponse {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("RequestTimeoutResponse must be a JSON object")
      val error = json.decodeRequired<RequestTimeoutResponseErrorData>(rawObject, "error")
      return RequestTimeoutResponse(
        error = error,
...
public fun requestTimeoutResponse(block: RequestTimeoutResponse.Builder.() -> Unit): RequestTimeoutResponse = RequestTimeoutResponse.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("RequestTimeoutResponse is missing required property '" + name + "'")
