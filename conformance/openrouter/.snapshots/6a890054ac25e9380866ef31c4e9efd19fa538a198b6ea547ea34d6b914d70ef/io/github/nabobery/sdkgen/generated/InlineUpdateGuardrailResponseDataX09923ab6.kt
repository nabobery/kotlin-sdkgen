 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/UpdateGuardrailResponse/properties/data
 */
@Serializable(with = InlineUpdateGuardrailResponseDataX09923ab6.Serializer::class)
public class InlineUpdateGuardrailResponseDataX09923ab6(
  /**
  ...
  public class Builder {
    ...
    public fun build(): InlineUpdateGuardrailResponseDataX09923ab6 {
      check(createdAtValue != null) { "createdAt is required" }
      check(idValue != null) { "id is required" }
      check(nameValue != null) { "name is required" }
      check(workspaceIdValue != null) { "workspaceId is required" }
      return InlineUpdateGuardrailResponseDataX09923ab6(
        createdAt = createdAt,
        id = id,
        name = name,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineUpdateGuardrailResponseDataX09923ab6 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineUpdateGuardrailResponseDataX09923ab6> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineUpdateGuardrailResponseDataX09923ab6 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineUpdateGuardrailResponseDataX09923ab6")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineUpdateGuardrailResponseDataX09923ab6 must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineUpdateGuardrailResponseDataX09923ab6) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineUpdateGuardrailResponseDataX09923ab6")
...
public fun inlineUpdateGuardrailResponseDataX09923ab6(block: InlineUpdateGuardrailResponseDataX09923ab6.Builder.() -> Unit): InlineUpdateGuardrailResponseDataX09923ab6 = InlineUpdateGuardrailResponseDataX09923ab6.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineUpdateGuardrailResponseDataX09923ab6 is missing required property '" + name + "'")
