 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/MessagesErrorResponse
 */
...
public class MessagesErrorResponse(
  ...
  public val type: InlineMessagesErrorResponseTypeX56dd5b56,
) {
  public class Builder {
    ...
    private var typeValue: InlineMessagesErrorResponseTypeX56dd5b56? = null

    public var type: InlineMessagesErrorResponseTypeX56dd5b56
  ...
  internal object Serializer : KSerializer<MessagesErrorResponse> {
    ...
    override fun deserialize(decoder: Decoder): MessagesErrorResponse {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("MessagesErrorResponse must be a JSON object")
      val error = json.decodeRequired<MessagesErrorDetail>(rawObject, "error")
      val type = json.decodeRequired<InlineMessagesErrorResponseTypeX56dd5b56>(rawObject, "type")
      return MessagesErrorResponse(
        error = error,
        type = type,
      )
...
public fun messagesErrorResponse(block: MessagesErrorResponse.Builder.() -> Unit): MessagesErrorResponse = MessagesErrorResponse.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("MessagesErrorResponse is missing required property '" + name + "'")
