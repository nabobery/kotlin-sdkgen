 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/ReasoningDetailServerToolCall
 */
...
public class ReasoningDetailServerToolCall(
  ...
  public class Builder {
    ...
    private var typeValue: InlineReasoningDetailServerToolCallTypeX5388f950? = null

    public var type: InlineReasoningDetailServerToolCallTypeX5388f950
  ...
  internal object Serializer : KSerializer<ReasoningDetailServerToolCall> {
    ...
    override fun deserialize(decoder: Decoder): ReasoningDetailServerToolCall {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("ReasoningDetailServerToolCall must be a JSON object")
      ...
      val type = json.decodeRequired<InlineReasoningDetailServerToolCallTypeX5388f950>(rawObject, "type")
      return ReasoningDetailServerToolCall(
        arguments = arguments,
        result = result,
        toolName = toolName,
        ...
        toolCallId = rawObject["tool_call_id"]?.let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<String?>(element) },
      )
    }
...
public fun reasoningDetailServerToolCall(block: ReasoningDetailServerToolCall.Builder.() -> Unit): ReasoningDetailServerToolCall = ReasoningDetailServerToolCall.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("ReasoningDetailServerToolCall is missing required property '" + name + "'")
