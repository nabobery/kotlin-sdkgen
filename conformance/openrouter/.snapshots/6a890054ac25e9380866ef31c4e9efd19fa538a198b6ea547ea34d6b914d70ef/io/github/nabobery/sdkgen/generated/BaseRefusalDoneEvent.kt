 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/BaseRefusalDoneEvent
 */
@Serializable(with = BaseRefusalDoneEvent.Serializer::class)
public class BaseRefusalDoneEvent(
  ...
  public class Builder {
    ...
    public fun build(): BaseRefusalDoneEvent {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): BaseRefusalDoneEvent = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<BaseRefusalDoneEvent> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): BaseRefusalDoneEvent {
      val jsonDecoder = decoder.requireJsonDecoder("BaseRefusalDoneEvent")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("BaseRefusalDoneEvent must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: BaseRefusalDoneEvent) {
      val jsonEncoder = encoder.requireJsonEncoder("BaseRefusalDoneEvent")
...
public fun baseRefusalDoneEvent(block: BaseRefusalDoneEvent.Builder.() -> Unit): BaseRefusalDoneEvent = BaseRefusalDoneEvent.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("BaseRefusalDoneEvent is missing required property '" + name + "'")
