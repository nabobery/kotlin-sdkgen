 ...
 *
 * Source:
 * sdkgen://source/openapi.yaml#/paths/~1keys/post/responses/201/content/application~1json/schema/properties/data
 */
@Serializable(with = InlineKeysPostResponse201JsonDataX8e245ea2.Serializer::class)
public class InlineKeysPostResponse201JsonDataX8e245ea2 internal constructor(
  /**
  ...
  public class Builder {
    ...
    public fun build(): InlineKeysPostResponse201JsonDataX8e245ea2 {
      ...
      return InlineKeysPostResponse201JsonDataX8e245ea2(
        byokUsage = byokUsage,
        byokUsageDaily = byokUsageDaily,
        byokUsageMonthly = byokUsageMonthly,
        byokUsageWeekly = byokUsageWeekly,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineKeysPostResponse201JsonDataX8e245ea2 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineKeysPostResponse201JsonDataX8e245ea2> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineKeysPostResponse201JsonDataX8e245ea2 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineKeysPostResponse201JsonDataX8e245ea2")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineKeysPostResponse201JsonDataX8e245ea2 must be a JSON object")
      ...
      if (!rawObject.containsKey("creator_user_id")) {
        throw SerializationException("InlineKeysPostResponse201JsonDataX8e245ea2 is missing required property 'creator_user_id'")
      }
      ...
      if (!rawObject.containsKey("limit")) {
        throw SerializationException("InlineKeysPostResponse201JsonDataX8e245ea2 is missing required property 'limit'")
      }
      ...
      if (!rawObject.containsKey("limit_remaining")) {
        throw SerializationException("InlineKeysPostResponse201JsonDataX8e245ea2 is missing required property 'limit_remaining'")
      }
      ...
      if (!rawObject.containsKey("limit_reset")) {
        throw SerializationException("InlineKeysPostResponse201JsonDataX8e245ea2 is missing required property 'limit_reset'")
      }
      ...
      if (!rawObject.containsKey("updated_at")) {
        throw SerializationException("InlineKeysPostResponse201JsonDataX8e245ea2 is missing required property 'updated_at'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineKeysPostResponse201JsonDataX8e245ea2) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineKeysPostResponse201JsonDataX8e245ea2")
...
public fun inlineKeysPostResponse201JsonDataX8e245ea2(block: InlineKeysPostResponse201JsonDataX8e245ea2.Builder.() -> Unit): InlineKeysPostResponse201JsonDataX8e245ea2 = InlineKeysPostResponse201JsonDataX8e245ea2.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineKeysPostResponse201JsonDataX8e245ea2 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineKeysPostResponse201JsonDataX8e245ea2 property '" + name + "' is not nullable")
