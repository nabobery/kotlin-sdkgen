package io.github.nabobery.sdkgen.generated.files
...
import io.github.nabobery.sdkgen.generated.FileDeleteResponse
import io.github.nabobery.sdkgen.generated.FileListResponse
import io.github.nabobery.sdkgen.generated.FileMetadata
import io.github.nabobery.sdkgen.generated.ForbiddenResponse
import io.github.nabobery.sdkgen.generated.InlineFilesPostRequestMultipartX7e99eef0
  ...
  public suspend fun listFiles(
    ...
    mapSuccess = { response ->
      when (response) {
        ...
        is ListFilesResponse.Http400Json -> error("Runtime selected a non-success response for success mapping.")
        is ListFilesResponse.Http401Json -> error("Runtime selected a non-success response for success mapping.")
        is ListFilesResponse.Http429Json -> error("Runtime selected a non-success response for success mapping.")
        is ListFilesResponse.Http500Json -> error("Runtime selected a non-success response for success mapping.")
    ...
    mapError = { response, statusCode, headers ->
      when (response) {
        ...
        is ListFilesResponse.Http400Json -> ListFilesApiException(response, statusCode, headers)
        is ListFilesResponse.Http401Json -> ListFilesApiException(response, statusCode, headers)
        is ListFilesResponse.Http429Json -> ListFilesApiException(response, statusCode, headers)
        is ListFilesResponse.Http500Json -> ListFilesApiException(response, statusCode, headers)
