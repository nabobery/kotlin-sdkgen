 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/ImageModelListItem
 */
...
public class ImageModelListItem(
  ...
  internal object Serializer : KSerializer<ImageModelListItem> {
    ...
    override fun deserialize(decoder: Decoder): ImageModelListItem {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("ImageModelListItem must be a JSON object")
      val architecture = json.decodeRequired<ImageModelArchitecture>(rawObject, "architecture")
      val created = json.decodeRequired<Int>(rawObject, "created")
      val description = json.decodeRequired<String>(rawObject, "description")
      val endpoints = json.decodeRequired<String>(rawObject, "endpoints")
...
public fun imageModelListItem(block: ImageModelListItem.Builder.() -> Unit): ImageModelListItem = ImageModelListItem.build(block)
