 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/PercentileLatencyCutoffs
 */
...
public class PercentileLatencyCutoffs(
  ...
  internal object Serializer : KSerializer<PercentileLatencyCutoffs> {
    ...
    override fun deserialize(decoder: Decoder): PercentileLatencyCutoffs {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("PercentileLatencyCutoffs must be a JSON object")
...
public fun percentileLatencyCutoffs(block: PercentileLatencyCutoffs.Builder.() -> Unit): PercentileLatencyCutoffs = PercentileLatencyCutoffs.build(block)
