...
/**
 * Generated model for sdkgen://source/openapi.yaml#/components/schemas/CreateWorkspaceResponse/properties/data.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/CreateWorkspaceResponse/properties/data
 */
@Serializable(with = InlineCreateWorkspaceResponseDataXf5e7009b.Serializer::class)
public class InlineCreateWorkspaceResponseDataXf5e7009b(
  /**
  ...
  public class Builder {
    ...
    public fun build(): InlineCreateWorkspaceResponseDataXf5e7009b {
      ...
      return InlineCreateWorkspaceResponseDataXf5e7009b(
        createdAt = createdAt,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineCreateWorkspaceResponseDataXf5e7009b = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineCreateWorkspaceResponseDataXf5e7009b> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineCreateWorkspaceResponseDataXf5e7009b {
      val jsonDecoder = decoder.requireJsonDecoder("InlineCreateWorkspaceResponseDataXf5e7009b")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineCreateWorkspaceResponseDataXf5e7009b must be a JSON object")
      ...
      if (!rawObject.containsKey("created_by")) {
        throw SerializationException("InlineCreateWorkspaceResponseDataXf5e7009b is missing required property 'created_by'")
      }
      ...
      if (!rawObject.containsKey("default_image_model")) {
        throw SerializationException("InlineCreateWorkspaceResponseDataXf5e7009b is missing required property 'default_image_model'")
      }
      ...
      if (!rawObject.containsKey("default_provider_sort")) {
        throw SerializationException("InlineCreateWorkspaceResponseDataXf5e7009b is missing required property 'default_provider_sort'")
      }
      ...
      if (!rawObject.containsKey("default_text_model")) {
        throw SerializationException("InlineCreateWorkspaceResponseDataXf5e7009b is missing required property 'default_text_model'")
      }
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineCreateWorkspaceResponseDataXf5e7009b is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("io_logging_api_key_ids")) {
        throw SerializationException("InlineCreateWorkspaceResponseDataXf5e7009b is missing required property 'io_logging_api_key_ids'")
      }
      ...
      if (!rawObject.containsKey("updated_at")) {
        throw SerializationException("InlineCreateWorkspaceResponseDataXf5e7009b is missing required property 'updated_at'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineCreateWorkspaceResponseDataXf5e7009b) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineCreateWorkspaceResponseDataXf5e7009b")
...
public fun inlineCreateWorkspaceResponseDataXf5e7009b(block: InlineCreateWorkspaceResponseDataXf5e7009b.Builder.() -> Unit): InlineCreateWorkspaceResponseDataXf5e7009b = InlineCreateWorkspaceResponseDataXf5e7009b.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineCreateWorkspaceResponseDataXf5e7009b is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineCreateWorkspaceResponseDataXf5e7009b property '" + name + "' is not nullable")
