 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/ActivityResponse
 */
...
public class ActivityResponse(
  ...
  internal object Serializer : KSerializer<ActivityResponse> {
    ...
    override fun deserialize(decoder: Decoder): ActivityResponse {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("ActivityResponse must be a JSON object")
      val data = json.decodeRequired<List<ActivityItem>>(rawObject, "data")
      return ActivityResponse(
        data = data,
      )
    }
...
public fun activityResponse(block: ActivityResponse.Builder.() -> Unit): ActivityResponse = ActivityResponse.build(block)
