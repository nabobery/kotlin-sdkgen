 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/ObservabilityFilterRulesConfig
 */
...
public class ObservabilityFilterRulesConfig(
  ...
  internal object Serializer : KSerializer<ObservabilityFilterRulesConfig> {
    ...
    override fun deserialize(decoder: Decoder): ObservabilityFilterRulesConfig {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("ObservabilityFilterRulesConfig must be a JSON object")
...
public fun observabilityFilterRulesConfig(block: ObservabilityFilterRulesConfig.Builder.() -> Unit): ObservabilityFilterRulesConfig = ObservabilityFilterRulesConfig.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("ObservabilityFilterRulesConfig is missing required property '" + name + "'")
