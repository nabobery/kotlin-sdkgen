 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/ObservabilitySentryDestination
 */
...
public class ObservabilitySentryDestination(
  ...
  public class Builder {
    private var configValue: InlineObservabilitySentryDestinationConfigX9f3ba772? = null

    public var config: InlineObservabilitySentryDestinationConfigX9f3ba772
    ...
    private var typeValue: InlineObservabilitySentryDestinationTypeX111ec570? = null

    public var type: InlineObservabilitySentryDestinationTypeX111ec570
  ...
  internal object Serializer : KSerializer<ObservabilitySentryDestination> {
    ...
    override fun deserialize(decoder: Decoder): ObservabilitySentryDestination {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("ObservabilitySentryDestination must be a JSON object")
      val config = json.decodeRequired<InlineObservabilitySentryDestinationConfigX9f3ba772>(rawObject, "config")
      ...
      val type = json.decodeRequired<InlineObservabilitySentryDestinationTypeX111ec570>(rawObject, "type")
...
public fun observabilitySentryDestination(block: ObservabilitySentryDestination.Builder.() -> Unit): ObservabilitySentryDestination = ObservabilitySentryDestination.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("ObservabilitySentryDestination is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("ObservabilitySentryDestination property '" + name + "' is not nullable")
