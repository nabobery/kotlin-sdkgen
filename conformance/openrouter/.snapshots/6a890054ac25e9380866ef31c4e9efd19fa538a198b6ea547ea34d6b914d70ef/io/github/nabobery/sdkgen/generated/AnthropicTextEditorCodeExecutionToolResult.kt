 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/AnthropicTextEditorCodeExecutionToolResult
 */
...
public class AnthropicTextEditorCodeExecutionToolResult(
  ...
  public class Builder {
    ...
    private var typeValue: InlineAnthropicTextEditorCodeExecutionToolResultTypeX62bd7294? = null

    public var type: InlineAnthropicTextEditorCodeExecutionToolResultTypeX62bd7294
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): AnthropicTextEditorCodeExecutionToolResult = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<AnthropicTextEditorCodeExecutionToolResult> {
    ...
    override fun deserialize(decoder: Decoder): AnthropicTextEditorCodeExecutionToolResult {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("AnthropicTextEditorCodeExecutionToolResult must be a JSON object")
      val content = json.decodeRequired<AnthropicTextEditorCodeExecutionContent>(rawObject, "content")
      val toolUseId = json.decodeRequired<String>(rawObject, "tool_use_id")
      val type = json.decodeRequired<InlineAnthropicTextEditorCodeExecutionToolResultTypeX62bd7294>(rawObject, "type")
      return AnthropicTextEditorCodeExecutionToolResult(
        content = content,
        toolUseId = toolUseId,
        type = type,
...
public fun anthropicTextEditorCodeExecutionToolResult(block: AnthropicTextEditorCodeExecutionToolResult.Builder.() -> Unit): AnthropicTextEditorCodeExecutionToolResult = AnthropicTextEditorCodeExecutionToolResult.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("AnthropicTextEditorCodeExecutionToolResult is missing required property '" + name + "'")
