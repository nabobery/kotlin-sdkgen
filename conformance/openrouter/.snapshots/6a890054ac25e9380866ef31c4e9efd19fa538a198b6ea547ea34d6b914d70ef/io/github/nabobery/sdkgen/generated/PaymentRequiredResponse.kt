 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/PaymentRequiredResponse
 */
...
public class PaymentRequiredResponse(
  ...
  internal object Serializer : KSerializer<PaymentRequiredResponse> {
    ...
    override fun deserialize(decoder: Decoder): PaymentRequiredResponse {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("PaymentRequiredResponse must be a JSON object")
      val error = json.decodeRequired<PaymentRequiredResponseErrorData>(rawObject, "error")
      return PaymentRequiredResponse(
        error = error,
...
public fun paymentRequiredResponse(block: PaymentRequiredResponse.Builder.() -> Unit): PaymentRequiredResponse = PaymentRequiredResponse.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("PaymentRequiredResponse is missing required property '" + name + "'")
