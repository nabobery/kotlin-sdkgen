 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/BaseAnnotationAddedEvent
 */
...
public class BaseAnnotationAddedEvent(
  ...
  internal object Serializer : KSerializer<BaseAnnotationAddedEvent> {
    ...
    override fun deserialize(decoder: Decoder): BaseAnnotationAddedEvent {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("BaseAnnotationAddedEvent must be a JSON object")
...
public fun baseAnnotationAddedEvent(block: BaseAnnotationAddedEvent.Builder.() -> Unit): BaseAnnotationAddedEvent = BaseAnnotationAddedEvent.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("BaseAnnotationAddedEvent is missing required property '" + name + "'")
