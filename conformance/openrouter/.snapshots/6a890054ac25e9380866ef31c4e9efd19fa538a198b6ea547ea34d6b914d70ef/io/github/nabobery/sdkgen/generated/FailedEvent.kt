 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/FailedEvent
 */
...
public class FailedEvent(
  ...
  public class Builder {
    ...
    private var typeValue: InlineFailedEventTypeX5da253bb? = null

    public var type: InlineFailedEventTypeX5da253bb
  ...
  internal object Serializer : KSerializer<FailedEvent> {
    ...
    override fun deserialize(decoder: Decoder): FailedEvent {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("FailedEvent must be a JSON object")
      ...
      val type = json.decodeRequired<InlineFailedEventTypeX5da253bb>(rawObject, "type")
      return FailedEvent(
        response = response,
        sequenceNumber = sequenceNumber,
        type = type,
