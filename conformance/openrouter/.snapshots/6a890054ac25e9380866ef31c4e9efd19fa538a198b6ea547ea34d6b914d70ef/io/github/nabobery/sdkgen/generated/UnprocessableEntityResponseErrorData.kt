 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/UnprocessableEntityResponseErrorData
 */
...
public class UnprocessableEntityResponseErrorData(
  ...
  internal object Serializer : KSerializer<UnprocessableEntityResponseErrorData> {
    ...
    override fun deserialize(decoder: Decoder): UnprocessableEntityResponseErrorData {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("UnprocessableEntityResponseErrorData must be a JSON object")
...
public fun unprocessableEntityResponseErrorData(block: UnprocessableEntityResponseErrorData.Builder.() -> Unit): UnprocessableEntityResponseErrorData = UnprocessableEntityResponseErrorData.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("UnprocessableEntityResponseErrorData is missing required property '" + name + "'")
