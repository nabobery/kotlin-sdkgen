 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/FunctionCallItem
 */
...
public class FunctionCallItem(
  ...
  internal object Serializer : KSerializer<FunctionCallItem> {
    ...
    override fun deserialize(decoder: Decoder): FunctionCallItem {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("FunctionCallItem must be a JSON object")
...
public fun functionCallItem(block: FunctionCallItem.Builder.() -> Unit): FunctionCallItem = FunctionCallItem.build(block)
