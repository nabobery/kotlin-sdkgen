 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/PerRequestLimits
 */
...
public class PerRequestLimits(
  ...
  internal object Serializer : KSerializer<PerRequestLimits> {
    ...
    override fun deserialize(decoder: Decoder): PerRequestLimits {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("PerRequestLimits must be a JSON object")
      val completionTokens = json.decodeRequired<Double>(rawObject, "completion_tokens")
      val promptTokens = json.decodeRequired<Double>(rawObject, "prompt_tokens")
      return PerRequestLimits(
        completionTokens = completionTokens,
        promptTokens = promptTokens,
      )
...
public fun perRequestLimits(block: PerRequestLimits.Builder.() -> Unit): PerRequestLimits = PerRequestLimits.build(block)
