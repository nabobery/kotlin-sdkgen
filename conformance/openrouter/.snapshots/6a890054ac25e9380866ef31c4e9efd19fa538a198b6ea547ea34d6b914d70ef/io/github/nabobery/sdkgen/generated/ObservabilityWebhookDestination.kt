 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/ObservabilityWebhookDestination
 */
...
public class ObservabilityWebhookDestination(
  ...
  public class Builder {
    private var configValue: InlineObservabilityWebhookDestinationConfigXbcd5a650? = null

    public var config: InlineObservabilityWebhookDestinationConfigXbcd5a650
    ...
    private var typeValue: InlineObservabilityWebhookDestinationTypeX8453f751? = null

    public var type: InlineObservabilityWebhookDestinationTypeX8453f751
  ...
  internal object Serializer : KSerializer<ObservabilityWebhookDestination> {
    ...
    override fun deserialize(decoder: Decoder): ObservabilityWebhookDestination {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("ObservabilityWebhookDestination must be a JSON object")
      val config = json.decodeRequired<InlineObservabilityWebhookDestinationConfigXbcd5a650>(rawObject, "config")
      ...
      val type = json.decodeRequired<InlineObservabilityWebhookDestinationTypeX8453f751>(rawObject, "type")
...
public fun observabilityWebhookDestination(block: ObservabilityWebhookDestination.Builder.() -> Unit): ObservabilityWebhookDestination = ObservabilityWebhookDestination.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("ObservabilityWebhookDestination is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("ObservabilityWebhookDestination property '" + name + "' is not nullable")
