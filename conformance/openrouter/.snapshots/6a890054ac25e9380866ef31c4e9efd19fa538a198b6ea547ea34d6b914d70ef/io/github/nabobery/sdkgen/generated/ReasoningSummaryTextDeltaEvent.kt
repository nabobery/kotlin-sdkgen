 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/ReasoningSummaryTextDeltaEvent
 */
...
public class ReasoningSummaryTextDeltaEvent(
  ...
  internal object Serializer : KSerializer<ReasoningSummaryTextDeltaEvent> {
    ...
    override fun deserialize(decoder: Decoder): ReasoningSummaryTextDeltaEvent {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("ReasoningSummaryTextDeltaEvent must be a JSON object")
...
public fun reasoningSummaryTextDeltaEvent(block: ReasoningSummaryTextDeltaEvent.Builder.() -> Unit): ReasoningSummaryTextDeltaEvent = ReasoningSummaryTextDeltaEvent.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("ReasoningSummaryTextDeltaEvent is missing required property '" + name + "'")
