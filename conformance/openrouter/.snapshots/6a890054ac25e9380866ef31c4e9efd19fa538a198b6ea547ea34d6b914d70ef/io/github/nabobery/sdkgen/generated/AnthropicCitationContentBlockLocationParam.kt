 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/AnthropicCitationContentBlockLocationParam
 */
...
public class AnthropicCitationContentBlockLocationParam(
  ...
  public class Builder {
    ...
    private var typeValue: InlineAnthropicCitationContentBlockLocationParamTypeX951a2013? = null

    public var type: InlineAnthropicCitationContentBlockLocationParamTypeX951a2013
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): AnthropicCitationContentBlockLocationParam = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<AnthropicCitationContentBlockLocationParam> {
    ...
    override fun deserialize(decoder: Decoder): AnthropicCitationContentBlockLocationParam {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("AnthropicCitationContentBlockLocationParam must be a JSON object")
      ...
      val type = json.decodeRequired<InlineAnthropicCitationContentBlockLocationParamTypeX951a2013>(rawObject, "type")
      if (!rawObject.containsKey("document_title")) {
        throw SerializationException("AnthropicCitationContentBlockLocationParam is missing required property 'document_title'")
      }
...
public fun anthropicCitationContentBlockLocationParam(block: AnthropicCitationContentBlockLocationParam.Builder.() -> Unit): AnthropicCitationContentBlockLocationParam = AnthropicCitationContentBlockLocationParam.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("AnthropicCitationContentBlockLocationParam is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("AnthropicCitationContentBlockLocationParam property '" + name + "' is not nullable")
