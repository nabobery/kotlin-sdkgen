...
/**
 * Generated model for sdkgen://source/openapi.yaml#/components/schemas/CreateBYOKKeyResponse/properties/data.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/CreateBYOKKeyResponse/properties/data
 */
@Serializable(with = InlineCreateByokKeyResponseDataX9730925f.Serializer::class)
public class InlineCreateByokKeyResponseDataX9730925f internal constructor(
  ...
  public class Builder {
    ...
    public fun build(): InlineCreateByokKeyResponseDataX9730925f {
      ...
      return InlineCreateByokKeyResponseDataX9730925f(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineCreateByokKeyResponseDataX9730925f = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineCreateByokKeyResponseDataX9730925f> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineCreateByokKeyResponseDataX9730925f {
      val jsonDecoder = decoder.requireJsonDecoder("InlineCreateByokKeyResponseDataX9730925f")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineCreateByokKeyResponseDataX9730925f must be a JSON object")
      ...
      if (!rawObject.containsKey("allowed_api_key_hashes")) {
        throw SerializationException("InlineCreateByokKeyResponseDataX9730925f is missing required property 'allowed_api_key_hashes'")
      }
      ...
      if (!rawObject.containsKey("allowed_models")) {
        throw SerializationException("InlineCreateByokKeyResponseDataX9730925f is missing required property 'allowed_models'")
      }
      ...
      if (!rawObject.containsKey("allowed_user_ids")) {
        throw SerializationException("InlineCreateByokKeyResponseDataX9730925f is missing required property 'allowed_user_ids'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineCreateByokKeyResponseDataX9730925f) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineCreateByokKeyResponseDataX9730925f")
...
public fun inlineCreateByokKeyResponseDataX9730925f(block: InlineCreateByokKeyResponseDataX9730925f.Builder.() -> Unit): InlineCreateByokKeyResponseDataX9730925f = InlineCreateByokKeyResponseDataX9730925f.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineCreateByokKeyResponseDataX9730925f is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineCreateByokKeyResponseDataX9730925f property '" + name + "' is not nullable")
