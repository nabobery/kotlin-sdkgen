 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/ObservabilityArizeDestination
 */
...
public class ObservabilityArizeDestination(
  ...
  public class Builder {
    private var configValue: InlineObservabilityArizeDestinationConfigXfbccede6? = null

    public var config: InlineObservabilityArizeDestinationConfigXfbccede6
    ...
    private var typeValue: InlineObservabilityArizeDestinationTypeXaa945fac? = null

    public var type: InlineObservabilityArizeDestinationTypeXaa945fac
  ...
  internal object Serializer : KSerializer<ObservabilityArizeDestination> {
    ...
    override fun deserialize(decoder: Decoder): ObservabilityArizeDestination {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("ObservabilityArizeDestination must be a JSON object")
      val config = json.decodeRequired<InlineObservabilityArizeDestinationConfigXfbccede6>(rawObject, "config")
      ...
      val type = json.decodeRequired<InlineObservabilityArizeDestinationTypeXaa945fac>(rawObject, "type")
...
public fun observabilityArizeDestination(block: ObservabilityArizeDestination.Builder.() -> Unit): ObservabilityArizeDestination = ObservabilityArizeDestination.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("ObservabilityArizeDestination is missing required property '" + name + "'")
