 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/AppRankingsItem
 */
...
public class AppRankingsItem(
  ...
  internal object Serializer : KSerializer<AppRankingsItem> {
    ...
    override fun deserialize(decoder: Decoder): AppRankingsItem {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("AppRankingsItem must be a JSON object")
      val appId = json.decodeRequired<Int>(rawObject, "app_id")
      val appName = json.decodeRequired<String>(rawObject, "app_name")
      val rank = json.decodeRequired<Int>(rawObject, "rank")
      val totalRequests = json.decodeRequired<Int>(rawObject, "total_requests")
