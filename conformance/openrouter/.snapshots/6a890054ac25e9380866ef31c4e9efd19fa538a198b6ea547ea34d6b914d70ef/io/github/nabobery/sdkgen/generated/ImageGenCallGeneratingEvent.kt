 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/ImageGenCallGeneratingEvent
 */
...
public class ImageGenCallGeneratingEvent(
  ...
  internal object Serializer : KSerializer<ImageGenCallGeneratingEvent> {
    ...
    override fun deserialize(decoder: Decoder): ImageGenCallGeneratingEvent {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("ImageGenCallGeneratingEvent must be a JSON object")
...
public fun imageGenCallGeneratingEvent(block: ImageGenCallGeneratingEvent.Builder.() -> Unit): ImageGenCallGeneratingEvent = ImageGenCallGeneratingEvent.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("ImageGenCallGeneratingEvent is missing required property '" + name + "'")
