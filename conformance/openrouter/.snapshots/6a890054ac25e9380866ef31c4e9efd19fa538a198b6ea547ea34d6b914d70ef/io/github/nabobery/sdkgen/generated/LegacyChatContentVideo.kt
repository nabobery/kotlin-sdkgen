 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/Legacy_ChatContentVideo
 */
...
public class LegacyChatContentVideo(
  ...
  public class Builder {
    private var typeValue: InlineLegacyChatContentVideoTypeX8ec04550? = null

    public var type: InlineLegacyChatContentVideoTypeX8ec04550
  ...
  internal object Serializer : KSerializer<LegacyChatContentVideo> {
    ...
    override fun deserialize(decoder: Decoder): LegacyChatContentVideo {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("LegacyChatContentVideo must be a JSON object")
      val type = json.decodeRequired<InlineLegacyChatContentVideoTypeX8ec04550>(rawObject, "type")
      val videoUrl = json.decodeRequired<LegacyChatContentVideoInput>(rawObject, "video_url")
      return LegacyChatContentVideo(
        type = type,
        videoUrl = videoUrl,
      )
...
public fun legacyChatContentVideo(block: LegacyChatContentVideo.Builder.() -> Unit): LegacyChatContentVideo = LegacyChatContentVideo.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("LegacyChatContentVideo is missing required property '" + name + "'")
