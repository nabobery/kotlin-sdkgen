 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/BaseErrorEvent
 */
...
public class BaseErrorEvent(
  ...
  internal object Serializer : KSerializer<BaseErrorEvent> {
    ...
    override fun deserialize(decoder: Decoder): BaseErrorEvent {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("BaseErrorEvent must be a JSON object")
