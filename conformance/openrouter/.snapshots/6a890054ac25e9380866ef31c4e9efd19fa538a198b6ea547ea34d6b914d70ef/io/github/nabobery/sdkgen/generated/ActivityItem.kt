 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/ActivityItem
 */
...
public class ActivityItem(
  ...
  internal object Serializer : KSerializer<ActivityItem> {
    ...
    override fun deserialize(decoder: Decoder): ActivityItem {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("ActivityItem must be a JSON object")
      val byokUsageInference = json.decodeRequired<Double>(rawObject, "byok_usage_inference")
      ...
      val endpointId = json.decodeRequired<String>(rawObject, "endpoint_id")
