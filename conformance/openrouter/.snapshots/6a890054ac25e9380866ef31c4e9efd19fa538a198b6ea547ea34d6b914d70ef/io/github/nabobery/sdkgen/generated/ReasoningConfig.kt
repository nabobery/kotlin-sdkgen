 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/ReasoningConfig
 */
...
public class ReasoningConfig(
  ...
  internal object Serializer : KSerializer<ReasoningConfig> {
    ...
    override fun deserialize(decoder: Decoder): ReasoningConfig {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("ReasoningConfig must be a JSON object")
