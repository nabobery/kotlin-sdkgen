 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/CustomToolCallItem
 */
...
public class CustomToolCallItem(
  ...
  public val type: InlineCustomToolCallItemTypeX522cffb3,
  ...
  public class Builder {
    ...
    private var typeValue: InlineCustomToolCallItemTypeX522cffb3? = null

    public var type: InlineCustomToolCallItemTypeX522cffb3
  ...
  internal object Serializer : KSerializer<CustomToolCallItem> {
    ...
    override fun deserialize(decoder: Decoder): CustomToolCallItem {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("CustomToolCallItem must be a JSON object")
      val callId = json.decodeRequired<String>(rawObject, "call_id")
      val input = json.decodeRequired<String>(rawObject, "input")
      val name = json.decodeRequired<String>(rawObject, "name")
      val type = json.decodeRequired<InlineCustomToolCallItemTypeX522cffb3>(rawObject, "type")
      return CustomToolCallItem(
        callId = callId,
        input = input,
        name = name,
...
public fun customToolCallItem(block: CustomToolCallItem.Builder.() -> Unit): CustomToolCallItem = CustomToolCallItem.build(block)
