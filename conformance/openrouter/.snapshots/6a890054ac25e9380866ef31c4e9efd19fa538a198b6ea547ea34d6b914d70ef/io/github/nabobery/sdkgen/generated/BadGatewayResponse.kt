 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/BadGatewayResponse
 */
...
public class BadGatewayResponse(
  ...
  internal object Serializer : KSerializer<BadGatewayResponse> {
    ...
    override fun deserialize(decoder: Decoder): BadGatewayResponse {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("BadGatewayResponse must be a JSON object")
      val error = json.decodeRequired<BadGatewayResponseErrorData>(rawObject, "error")
      return BadGatewayResponse(
        error = error,
...
public fun badGatewayResponse(block: BadGatewayResponse.Builder.() -> Unit): BadGatewayResponse = BadGatewayResponse.build(block)
