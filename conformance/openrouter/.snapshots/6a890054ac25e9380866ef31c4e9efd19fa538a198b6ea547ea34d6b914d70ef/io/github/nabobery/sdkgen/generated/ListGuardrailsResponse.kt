 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/ListGuardrailsResponse
 */
...
public class ListGuardrailsResponse(
  ...
  internal object Serializer : KSerializer<ListGuardrailsResponse> {
    ...
    override fun deserialize(decoder: Decoder): ListGuardrailsResponse {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("ListGuardrailsResponse must be a JSON object")
      val data = json.decodeRequired<List<Guardrail>>(rawObject, "data")
...
public fun listGuardrailsResponse(block: ListGuardrailsResponse.Builder.() -> Unit): ListGuardrailsResponse = ListGuardrailsResponse.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("ListGuardrailsResponse is missing required property '" + name + "'")
