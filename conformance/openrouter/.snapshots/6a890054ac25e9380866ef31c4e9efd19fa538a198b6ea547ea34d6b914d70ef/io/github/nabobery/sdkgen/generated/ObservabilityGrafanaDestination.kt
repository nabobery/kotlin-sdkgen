 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/ObservabilityGrafanaDestination
 */
...
public class ObservabilityGrafanaDestination(
  ...
  public class Builder {
    private var configValue: InlineObservabilityGrafanaDestinationConfigXfba37ac5? = null

    public var config: InlineObservabilityGrafanaDestinationConfigXfba37ac5
    ...
    private var typeValue: InlineObservabilityGrafanaDestinationTypeXc4e6d71b? = null

    public var type: InlineObservabilityGrafanaDestinationTypeXc4e6d71b
  ...
  internal object Serializer : KSerializer<ObservabilityGrafanaDestination> {
    ...
    override fun deserialize(decoder: Decoder): ObservabilityGrafanaDestination {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("ObservabilityGrafanaDestination must be a JSON object")
      val config = json.decodeRequired<InlineObservabilityGrafanaDestinationConfigXfba37ac5>(rawObject, "config")
      ...
      val type = json.decodeRequired<InlineObservabilityGrafanaDestinationTypeXc4e6d71b>(rawObject, "type")
...
public fun observabilityGrafanaDestination(block: ObservabilityGrafanaDestination.Builder.() -> Unit): ObservabilityGrafanaDestination = ObservabilityGrafanaDestination.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("ObservabilityGrafanaDestination is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("ObservabilityGrafanaDestination property '" + name + "' is not nullable")
