 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/AnthropicBashCodeExecutionToolResult
 */
...
public class AnthropicBashCodeExecutionToolResult(
  ...
  public class Builder {
    ...
    private var typeValue: InlineAnthropicBashCodeExecutionToolResultTypeXf5f082e6? = null

    public var type: InlineAnthropicBashCodeExecutionToolResultTypeXf5f082e6
  ...
  internal object Serializer : KSerializer<AnthropicBashCodeExecutionToolResult> {
    ...
    override fun deserialize(decoder: Decoder): AnthropicBashCodeExecutionToolResult {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("AnthropicBashCodeExecutionToolResult must be a JSON object")
      val content = json.decodeRequired<AnthropicBashCodeExecutionContent>(rawObject, "content")
      val toolUseId = json.decodeRequired<String>(rawObject, "tool_use_id")
      val type = json.decodeRequired<InlineAnthropicBashCodeExecutionToolResultTypeXf5f082e6>(rawObject, "type")
      return AnthropicBashCodeExecutionToolResult(
        content = content,
        toolUseId = toolUseId,
        type = type,
...
public fun anthropicBashCodeExecutionToolResult(block: AnthropicBashCodeExecutionToolResult.Builder.() -> Unit): AnthropicBashCodeExecutionToolResult = AnthropicBashCodeExecutionToolResult.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("AnthropicBashCodeExecutionToolResult is missing required property '" + name + "'")
