 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/PublicEndpoint
 */
...
public class PublicEndpoint internal constructor(
  ...
  public val pricing: InlinePublicEndpointPricingX2f179764,
  ...
  public constructor(
    ...
    modelName: String,
    name: String,
    pricing: InlinePublicEndpointPricingX2f179764,
  ...
  public class Builder {
    ...
    private var pricingValue: InlinePublicEndpointPricingX2f179764? = null

    public var pricing: InlinePublicEndpointPricingX2f179764
  ...
  internal object Serializer : KSerializer<PublicEndpoint> {
    ...
    override fun deserialize(decoder: Decoder): PublicEndpoint {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("PublicEndpoint must be a JSON object")
      val contextLength = json.decodeRequired<Int>(rawObject, "context_length")
      val modelId = json.decodeRequired<String>(rawObject, "model_id")
      val modelName = json.decodeRequired<String>(rawObject, "model_name")
      val name = json.decodeRequired<String>(rawObject, "name")
      val pricing = json.decodeRequired<InlinePublicEndpointPricingX2f179764>(rawObject, "pricing")
      val providerName = json.decodeRequired<ProviderName>(rawObject, "provider_name")
      val supportedParameters = json.decodeRequired<List<Parameter>>(rawObject, "supported_parameters")
      val supportsImplicitCaching = json.decodeRequired<Boolean>(rawObject, "supports_implicit_caching")
      val tag = json.decodeRequired<String>(rawObject, "tag")
      if (!rawObject.containsKey("latency_last_30m")) {
        throw SerializationException("PublicEndpoint is missing required property 'latency_last_30m'")
      }
      val latencyLast30m = rawObject["latency_last_30m"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<PercentileStats?>(requireNotNull(element)) }
      if (!rawObject.containsKey("max_completion_tokens")) {
        throw SerializationException("PublicEndpoint is missing required property 'max_completion_tokens'")
      }
      val maxCompletionTokens = rawObject["max_completion_tokens"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<Int?>(requireNotNull(element)) }
      if (!rawObject.containsKey("max_prompt_tokens")) {
        throw SerializationException("PublicEndpoint is missing required property 'max_prompt_tokens'")
      }
      val maxPromptTokens = rawObject["max_prompt_tokens"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<Int?>(requireNotNull(element)) }
      if (!rawObject.containsKey("quantization")) {
        throw SerializationException("PublicEndpoint is missing required property 'quantization'")
      }
      val quantization = rawObject["quantization"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<Quantization?>(requireNotNull(element)) }
      if (!rawObject.containsKey("throughput_last_30m")) {
        throw SerializationException("PublicEndpoint is missing required property 'throughput_last_30m'")
      }
      val throughputLast30m = rawObject["throughput_last_30m"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<PercentileStats?>(requireNotNull(element)) }
      if (!rawObject.containsKey("uptime_last_1d")) {
        throw SerializationException("PublicEndpoint is missing required property 'uptime_last_1d'")
      }
      val uptimeLast1d = rawObject["uptime_last_1d"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<Double?>(requireNotNull(element)) }
      if (!rawObject.containsKey("uptime_last_30m")) {
        throw SerializationException("PublicEndpoint is missing required property 'uptime_last_30m'")
      }
      val uptimeLast30m = rawObject["uptime_last_30m"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<Double?>(requireNotNull(element)) }
      if (!rawObject.containsKey("uptime_last_5m")) {
        throw SerializationException("PublicEndpoint is missing required property 'uptime_last_5m'")
      }
      val uptimeLast5m = rawObject["uptime_last_5m"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<Double?>(requireNotNull(element)) }
      return PublicEndpoint(
        contextLength = contextLength,
        latencyLast30m = latencyLast30m,
        maxCompletionTokens = maxCompletionTokens,
