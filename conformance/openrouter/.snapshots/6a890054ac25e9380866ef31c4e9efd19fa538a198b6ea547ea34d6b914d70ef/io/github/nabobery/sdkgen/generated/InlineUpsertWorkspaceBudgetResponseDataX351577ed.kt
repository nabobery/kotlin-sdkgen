 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/UpsertWorkspaceBudgetResponse/properties/data
 */
@Serializable(with = InlineUpsertWorkspaceBudgetResponseDataX351577ed.Serializer::class)
public class InlineUpsertWorkspaceBudgetResponseDataX351577ed(
  /**
  ...
  public class Builder {
    ...
    public fun build(): InlineUpsertWorkspaceBudgetResponseDataX351577ed {
      ...
      return InlineUpsertWorkspaceBudgetResponseDataX351577ed(
        createdAt = createdAt,
        id = id,
        limitUsd = limitUsd,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineUpsertWorkspaceBudgetResponseDataX351577ed = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineUpsertWorkspaceBudgetResponseDataX351577ed> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineUpsertWorkspaceBudgetResponseDataX351577ed {
      val jsonDecoder = decoder.requireJsonDecoder("InlineUpsertWorkspaceBudgetResponseDataX351577ed")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineUpsertWorkspaceBudgetResponseDataX351577ed must be a JSON object")
      ...
      if (!rawObject.containsKey("reset_interval")) {
        throw SerializationException("InlineUpsertWorkspaceBudgetResponseDataX351577ed is missing required property 'reset_interval'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineUpsertWorkspaceBudgetResponseDataX351577ed) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineUpsertWorkspaceBudgetResponseDataX351577ed")
...
public fun inlineUpsertWorkspaceBudgetResponseDataX351577ed(block: InlineUpsertWorkspaceBudgetResponseDataX351577ed.Builder.() -> Unit): InlineUpsertWorkspaceBudgetResponseDataX351577ed = InlineUpsertWorkspaceBudgetResponseDataX351577ed.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineUpsertWorkspaceBudgetResponseDataX351577ed is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineUpsertWorkspaceBudgetResponseDataX351577ed property '" + name + "' is not nullable")
