 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/ContainerReferenceEnvironment
 */
...
public class ContainerReferenceEnvironment(
  ...
  public class Builder {
    ...
    private var typeValue: InlineContainerReferenceEnvironmentTypeX8e21dd4c? = null

    public var type: InlineContainerReferenceEnvironmentTypeX8e21dd4c
  ...
  internal object Serializer : KSerializer<ContainerReferenceEnvironment> {
    ...
    override fun deserialize(decoder: Decoder): ContainerReferenceEnvironment {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("ContainerReferenceEnvironment must be a JSON object")
      val containerId = json.decodeRequired<String>(rawObject, "container_id")
      val type = json.decodeRequired<InlineContainerReferenceEnvironmentTypeX8e21dd4c>(rawObject, "type")
      return ContainerReferenceEnvironment(
        containerId = containerId,
        type = type,
      )
...
public fun containerReferenceEnvironment(block: ContainerReferenceEnvironment.Builder.() -> Unit): ContainerReferenceEnvironment = ContainerReferenceEnvironment.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("ContainerReferenceEnvironment is missing required property '" + name + "'")
