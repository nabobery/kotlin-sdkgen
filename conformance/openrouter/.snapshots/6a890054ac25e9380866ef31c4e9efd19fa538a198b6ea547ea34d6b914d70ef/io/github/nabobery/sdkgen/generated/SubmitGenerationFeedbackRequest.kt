 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/SubmitGenerationFeedbackRequest
 */
...
public class SubmitGenerationFeedbackRequest(
   ...
   */
  public val category: InlineSubmitGenerationFeedbackRequestCategoryX243a33a3,
  /**
  ...
  public class Builder {
    private var categoryValue: InlineSubmitGenerationFeedbackRequestCategoryX243a33a3? = null

    public var category: InlineSubmitGenerationFeedbackRequestCategoryX243a33a3
  ...
  internal object Serializer : KSerializer<SubmitGenerationFeedbackRequest> {
    ...
    override fun deserialize(decoder: Decoder): SubmitGenerationFeedbackRequest {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("SubmitGenerationFeedbackRequest must be a JSON object")
      val category = json.decodeRequired<InlineSubmitGenerationFeedbackRequestCategoryX243a33a3>(rawObject, "category")
      val generationId = json.decodeRequired<String>(rawObject, "generation_id")
      return SubmitGenerationFeedbackRequest(
        category = category,
        generationId = generationId,
...
public fun submitGenerationFeedbackRequest(block: SubmitGenerationFeedbackRequest.Builder.() -> Unit): SubmitGenerationFeedbackRequest = SubmitGenerationFeedbackRequest.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("SubmitGenerationFeedbackRequest is missing required property '" + name + "'")
