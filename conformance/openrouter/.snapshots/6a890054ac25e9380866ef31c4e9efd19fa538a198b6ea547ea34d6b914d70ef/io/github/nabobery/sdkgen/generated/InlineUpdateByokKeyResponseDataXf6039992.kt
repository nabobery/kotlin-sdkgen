...
/**
 * Generated model for sdkgen://source/openapi.yaml#/components/schemas/UpdateBYOKKeyResponse/properties/data.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/UpdateBYOKKeyResponse/properties/data
 */
@Serializable(with = InlineUpdateByokKeyResponseDataXf6039992.Serializer::class)
public class InlineUpdateByokKeyResponseDataXf6039992 internal constructor(
  ...
  public class Builder {
    ...
    public fun build(): InlineUpdateByokKeyResponseDataXf6039992 {
      ...
      return InlineUpdateByokKeyResponseDataXf6039992(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineUpdateByokKeyResponseDataXf6039992 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineUpdateByokKeyResponseDataXf6039992> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineUpdateByokKeyResponseDataXf6039992 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineUpdateByokKeyResponseDataXf6039992")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineUpdateByokKeyResponseDataXf6039992 must be a JSON object")
      ...
      if (!rawObject.containsKey("allowed_api_key_hashes")) {
        throw SerializationException("InlineUpdateByokKeyResponseDataXf6039992 is missing required property 'allowed_api_key_hashes'")
      }
      ...
      if (!rawObject.containsKey("allowed_models")) {
        throw SerializationException("InlineUpdateByokKeyResponseDataXf6039992 is missing required property 'allowed_models'")
      }
      ...
      if (!rawObject.containsKey("allowed_user_ids")) {
        throw SerializationException("InlineUpdateByokKeyResponseDataXf6039992 is missing required property 'allowed_user_ids'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineUpdateByokKeyResponseDataXf6039992) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineUpdateByokKeyResponseDataXf6039992")
...
public fun inlineUpdateByokKeyResponseDataXf6039992(block: InlineUpdateByokKeyResponseDataXf6039992.Builder.() -> Unit): InlineUpdateByokKeyResponseDataXf6039992 = InlineUpdateByokKeyResponseDataXf6039992.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineUpdateByokKeyResponseDataXf6039992 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineUpdateByokKeyResponseDataXf6039992 property '" + name + "' is not nullable")
