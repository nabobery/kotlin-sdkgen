...
@Serializable
public data class OutputMessageView internal constructor(
 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/OutputMessage
 */
...
public class OutputMessage(
  ...
  internal object Serializer : KSerializer<OutputMessage> {
    ...
    override fun deserialize(decoder: Decoder): OutputMessage {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("OutputMessage must be a JSON object")
