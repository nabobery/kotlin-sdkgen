 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/ObservabilityLangfuseDestination
 */
...
public class ObservabilityLangfuseDestination(
  ...
  public class Builder {
    private var configValue: InlineObservabilityLangfuseDestinationConfigX61477ff1? = null

    public var config: InlineObservabilityLangfuseDestinationConfigX61477ff1
    ...
    private var typeValue: InlineObservabilityLangfuseDestinationTypeXd56f0579? = null

    public var type: InlineObservabilityLangfuseDestinationTypeXd56f0579
  ...
  internal object Serializer : KSerializer<ObservabilityLangfuseDestination> {
    ...
    override fun deserialize(decoder: Decoder): ObservabilityLangfuseDestination {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("ObservabilityLangfuseDestination must be a JSON object")
      val config = json.decodeRequired<InlineObservabilityLangfuseDestinationConfigX61477ff1>(rawObject, "config")
      ...
      val type = json.decodeRequired<InlineObservabilityLangfuseDestinationTypeXd56f0579>(rawObject, "type")
...
public fun observabilityLangfuseDestination(block: ObservabilityLangfuseDestination.Builder.() -> Unit): ObservabilityLangfuseDestination = ObservabilityLangfuseDestination.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("ObservabilityLangfuseDestination is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("ObservabilityLangfuseDestination property '" + name + "' is not nullable")
