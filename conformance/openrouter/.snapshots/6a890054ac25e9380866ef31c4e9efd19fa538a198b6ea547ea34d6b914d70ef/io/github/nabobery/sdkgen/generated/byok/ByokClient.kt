package io.github.nabobery.sdkgen.generated.byok
...
import io.github.nabobery.sdkgen.generated.CreateByokKeyRequest
import io.github.nabobery.sdkgen.generated.CreateByokKeyResponse
import io.github.nabobery.sdkgen.generated.DeleteByokKeyResponse
import io.github.nabobery.sdkgen.generated.ForbiddenResponse
import io.github.nabobery.sdkgen.generated.GetByokKeyResponse
import io.github.nabobery.sdkgen.generated.InlineByokGetParameterX79c1482f
import io.github.nabobery.sdkgen.generated.InternalServerResponse
import io.github.nabobery.sdkgen.generated.ListByokKeysResponse
...
import io.github.nabobery.sdkgen.generated.UpdateByokKeyRequest
import io.github.nabobery.sdkgen.generated.UpdateByokKeyResponse
import kotlin.Int
...
public class ByokClient(
  ...
  ): io.github.nabobery.sdkgen.generated.CreateByokKeyResponse = executor.executeWithTypedErrors<CreateByokKeyRequest, CreateByokKeyResponse, io.github.nabobery.sdkgen.generated.CreateByokKeyResponse>(
  ...
  public suspend fun deleteByokKey(
    ...
    xOpenRouterTitle: String? = null,
    options: CallOptions = CallOptions(),
  ): io.github.nabobery.sdkgen.generated.DeleteByokKeyResponse = executor.executeWithTypedErrors<Unit, DeleteByokKeyResponse, io.github.nabobery.sdkgen.generated.DeleteByokKeyResponse>(
  ...
  public suspend fun getByokKey(
    ...
    xOpenRouterTitle: String? = null,
    options: CallOptions = CallOptions(),
  ): io.github.nabobery.sdkgen.generated.GetByokKeyResponse = executor.executeWithTypedErrors<Unit, GetByokKeyResponse, io.github.nabobery.sdkgen.generated.GetByokKeyResponse>(
   ...
   * @param options Execution options.
   * @return Buffered response body.
   * @throws ListByokKeysApiException When the service returns a declared non-success response; its `error` property
   * exposes the decoded ListByokKeysError payload.
   * @throws SdkSerializationException When a request or response cannot be serialized.
   * @throws SdkTransportException When transport execution fails.
   */
  public suspend fun listByokKeys(
    ...
    xOpenRouterTitle: String? = null,
    options: CallOptions = CallOptions(),
  ): io.github.nabobery.sdkgen.generated.ListByokKeysResponse = executor.executeWithTypedErrors<Unit, ListByokKeysResponse, io.github.nabobery.sdkgen.generated.ListByokKeysResponse>(
    request = SdkExecutionRequest(listByokKeysMetadata, baseUri, Unit, emptyList(), buildList {
    ...
    requestCodecs = ByokCodecs.listByokKeysRequestCodecRegistry,
    responseDecoder = ListByokKeysResponseDecoder,
    mapSuccess = { response ->
      when (response) {
        is ListByokKeysResponse.SuccessJson -> response.json
        is ListByokKeysResponse.Http401Json -> error("Runtime selected a non-success response for success mapping.")
        is ListByokKeysResponse.Http500Json -> error("Runtime selected a non-success response for success mapping.")
        is ListByokKeysResponse.Unknown -> error("Runtime returned an unmatched response through the typed success path.")
      }
    },
    mapError = { response, statusCode, headers ->
      when (response) {
        is ListByokKeysResponse.SuccessJson -> error("Runtime selected a success response for error mapping.")
        is ListByokKeysResponse.Http401Json -> ListByokKeysApiException(response, statusCode, headers)
        is ListByokKeysResponse.Http500Json -> ListByokKeysApiException(response, statusCode, headers)
        is ListByokKeysResponse.Unknown -> error("Runtime returned an unmatched response through the typed error path.")
      }
    },
    options = options,
  )
  ...
  public suspend fun updateByokKey(
    ...
    xOpenRouterTitle: String? = null,
    options: CallOptions = CallOptions(),
  ): io.github.nabobery.sdkgen.generated.UpdateByokKeyResponse = executor.executeWithTypedErrors<UpdateByokKeyRequest, UpdateByokKeyResponse, io.github.nabobery.sdkgen.generated.UpdateByokKeyResponse>(
  ...
  public sealed interface CreateByokKeyResponse {
    public class SuccessJson(
      public val json: io.github.nabobery.sdkgen.generated.CreateByokKeyResponse,
  ...
  public sealed interface DeleteByokKeyResponse {
    public class SuccessJson(
      public val json: io.github.nabobery.sdkgen.generated.DeleteByokKeyResponse,
      public val statusCode: Int,
      public val headers: List<SdkHeader>,
  ...
  public sealed interface GetByokKeyResponse {
    public class SuccessJson(
      public val json: io.github.nabobery.sdkgen.generated.GetByokKeyResponse,
      public val statusCode: Int,
      public val headers: List<SdkHeader>,
    ) : GetByokKeyResponse
  ...
  public sealed interface ListByokKeysResponse {
    public class SuccessJson(
      public val json: io.github.nabobery.sdkgen.generated.ListByokKeysResponse,
      public val statusCode: Int,
      public val headers: List<SdkHeader>,
  ...
  public sealed interface UpdateByokKeyResponse {
    public class SuccessJson(
      public val json: io.github.nabobery.sdkgen.generated.UpdateByokKeyResponse,
      public val statusCode: Int,
      public val headers: List<SdkHeader>,
