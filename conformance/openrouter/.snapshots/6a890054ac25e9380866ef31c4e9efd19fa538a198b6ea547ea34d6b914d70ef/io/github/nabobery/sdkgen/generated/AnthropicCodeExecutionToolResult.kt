 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/AnthropicCodeExecutionToolResult
 */
...
public class AnthropicCodeExecutionToolResult(
  ...
  public class Builder {
    ...
    private var typeValue: InlineAnthropicCodeExecutionToolResultTypeXa2888711? = null

    public var type: InlineAnthropicCodeExecutionToolResultTypeXa2888711
  ...
  internal object Serializer : KSerializer<AnthropicCodeExecutionToolResult> {
    ...
    override fun deserialize(decoder: Decoder): AnthropicCodeExecutionToolResult {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("AnthropicCodeExecutionToolResult must be a JSON object")
      val content = json.decodeRequired<AnthropicCodeExecutionContent>(rawObject, "content")
      val toolUseId = json.decodeRequired<String>(rawObject, "tool_use_id")
      val type = json.decodeRequired<InlineAnthropicCodeExecutionToolResultTypeXa2888711>(rawObject, "type")
      return AnthropicCodeExecutionToolResult(
        content = content,
        toolUseId = toolUseId,
        type = type,
...
public fun anthropicCodeExecutionToolResult(block: AnthropicCodeExecutionToolResult.Builder.() -> Unit): AnthropicCodeExecutionToolResult = AnthropicCodeExecutionToolResult.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("AnthropicCodeExecutionToolResult is missing required property '" + name + "'")
