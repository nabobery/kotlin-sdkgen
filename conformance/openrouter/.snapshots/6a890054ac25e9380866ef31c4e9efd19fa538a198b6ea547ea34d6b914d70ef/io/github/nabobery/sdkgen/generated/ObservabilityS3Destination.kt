 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/ObservabilityS3Destination
 */
...
public class ObservabilityS3Destination(
  ...
  public class Builder {
    private var configValue: InlineObservabilityS3DestinationConfigX48a00451? = null

    public var config: InlineObservabilityS3DestinationConfigX48a00451
    ...
    private var typeValue: InlineObservabilityS3DestinationTypeX9c0c7555? = null

    public var type: InlineObservabilityS3DestinationTypeX9c0c7555
  ...
  internal object Serializer : KSerializer<ObservabilityS3Destination> {
    ...
    override fun deserialize(decoder: Decoder): ObservabilityS3Destination {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("ObservabilityS3Destination must be a JSON object")
      val config = json.decodeRequired<InlineObservabilityS3DestinationConfigX48a00451>(rawObject, "config")
      ...
      val type = json.decodeRequired<InlineObservabilityS3DestinationTypeX9c0c7555>(rawObject, "type")
...
public fun observabilityS3Destination(block: ObservabilityS3Destination.Builder.() -> Unit): ObservabilityS3Destination = ObservabilityS3Destination.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("ObservabilityS3Destination is missing required property '" + name + "'")
