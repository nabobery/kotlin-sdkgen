 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/ChatSystemMessage
 */
...
public class ChatSystemMessage(
  ...
  public class Builder {
    private var contentValue: InlineChatSystemMessageContentX1d9f1659? = null

    public var content: InlineChatSystemMessageContentX1d9f1659
      get() = requireNotNull(contentValue) { "content is required" }
      set(`value`) {
        contentValue = value
      }

    private var roleValue: InlineChatSystemMessageRoleX9f2ec5e2? = null

    public var role: InlineChatSystemMessageRoleX9f2ec5e2
  ...
  internal object Serializer : KSerializer<ChatSystemMessage> {
    ...
    override fun deserialize(decoder: Decoder): ChatSystemMessage {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("ChatSystemMessage must be a JSON object")
      val content = json.decodeRequired<InlineChatSystemMessageContentX1d9f1659>(rawObject, "content")
      val role = json.decodeRequired<InlineChatSystemMessageRoleX9f2ec5e2>(rawObject, "role")
      return ChatSystemMessage(
        content = content,
        role = role,
...
public fun chatSystemMessage(block: ChatSystemMessage.Builder.() -> Unit): ChatSystemMessage = ChatSystemMessage.build(block)
