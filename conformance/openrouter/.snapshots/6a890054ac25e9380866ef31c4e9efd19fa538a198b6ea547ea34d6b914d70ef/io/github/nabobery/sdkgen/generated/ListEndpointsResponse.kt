 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/ListEndpointsResponse
 */
...
public class ListEndpointsResponse(
   ...
   */
  public val architecture: InlineListEndpointsResponseArchitectureX070fc976,
  /**
  ...
  public class Builder {
    private var architectureValue: InlineListEndpointsResponseArchitectureX070fc976? = null

    public var architecture: InlineListEndpointsResponseArchitectureX070fc976
  ...
  internal object Serializer : KSerializer<ListEndpointsResponse> {
    ...
    override fun deserialize(decoder: Decoder): ListEndpointsResponse {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("ListEndpointsResponse must be a JSON object")
      val architecture = json.decodeRequired<InlineListEndpointsResponseArchitectureX070fc976>(rawObject, "architecture")
      val created = json.decodeRequired<Int>(rawObject, "created")
      val description = json.decodeRequired<String>(rawObject, "description")
      val endpoints = json.decodeRequired<List<PublicEndpoint>>(rawObject, "endpoints")
...
public fun listEndpointsResponse(block: ListEndpointsResponse.Builder.() -> Unit): ListEndpointsResponse = ListEndpointsResponse.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("ListEndpointsResponse is missing required property '" + name + "'")
