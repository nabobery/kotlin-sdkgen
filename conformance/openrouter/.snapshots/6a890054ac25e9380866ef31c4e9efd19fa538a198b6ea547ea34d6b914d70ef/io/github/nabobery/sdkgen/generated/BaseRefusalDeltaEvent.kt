 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/BaseRefusalDeltaEvent
 */
...
public class BaseRefusalDeltaEvent(
  ...
  internal object Serializer : KSerializer<BaseRefusalDeltaEvent> {
    ...
    override fun deserialize(decoder: Decoder): BaseRefusalDeltaEvent {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("BaseRefusalDeltaEvent must be a JSON object")
...
public fun baseRefusalDeltaEvent(block: BaseRefusalDeltaEvent.Builder.() -> Unit): BaseRefusalDeltaEvent = BaseRefusalDeltaEvent.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("BaseRefusalDeltaEvent is missing required property '" + name + "'")
