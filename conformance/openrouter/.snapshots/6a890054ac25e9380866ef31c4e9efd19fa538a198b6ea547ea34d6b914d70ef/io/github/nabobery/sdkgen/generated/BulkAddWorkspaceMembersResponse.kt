 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/BulkAddWorkspaceMembersResponse
 */
...
public class BulkAddWorkspaceMembersResponse(
  ...
  internal object Serializer : KSerializer<BulkAddWorkspaceMembersResponse> {
    ...
    override fun deserialize(decoder: Decoder): BulkAddWorkspaceMembersResponse {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("BulkAddWorkspaceMembersResponse must be a JSON object")
      val addedCount = json.decodeRequired<Int>(rawObject, "added_count")
...
public fun bulkAddWorkspaceMembersResponse(block: BulkAddWorkspaceMembersResponse.Builder.() -> Unit): BulkAddWorkspaceMembersResponse = BulkAddWorkspaceMembersResponse.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("BulkAddWorkspaceMembersResponse is missing required property '" + name + "'")
