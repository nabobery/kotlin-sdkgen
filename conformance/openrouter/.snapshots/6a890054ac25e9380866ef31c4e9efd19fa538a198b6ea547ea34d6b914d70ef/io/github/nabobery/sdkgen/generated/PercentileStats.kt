 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/PercentileStats
 */
...
public class PercentileStats(
  ...
  internal object Serializer : KSerializer<PercentileStats> {
    ...
    override fun deserialize(decoder: Decoder): PercentileStats {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("PercentileStats must be a JSON object")
