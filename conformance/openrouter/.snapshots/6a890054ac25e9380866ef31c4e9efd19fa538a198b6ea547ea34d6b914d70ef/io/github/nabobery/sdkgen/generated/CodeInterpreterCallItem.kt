 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/CodeInterpreterCallItem
 */
...
public class CodeInterpreterCallItem(
  ...
  internal object Serializer : KSerializer<CodeInterpreterCallItem> {
    ...
    override fun deserialize(decoder: Decoder): CodeInterpreterCallItem {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("CodeInterpreterCallItem must be a JSON object")
...
public fun codeInterpreterCallItem(block: CodeInterpreterCallItem.Builder.() -> Unit): CodeInterpreterCallItem = CodeInterpreterCallItem.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("CodeInterpreterCallItem is missing required property '" + name + "'")
