 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/AnthropicFileDocumentSource
 */
...
public class AnthropicFileDocumentSource(
  ...
  public class Builder {
    ...
    private var typeValue: InlineAnthropicFileDocumentSourceTypeX87400e76? = null

    public var type: InlineAnthropicFileDocumentSourceTypeX87400e76
  ...
  internal object Serializer : KSerializer<AnthropicFileDocumentSource> {
    ...
    override fun deserialize(decoder: Decoder): AnthropicFileDocumentSource {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("AnthropicFileDocumentSource must be a JSON object")
      val fileId = json.decodeRequired<String>(rawObject, "file_id")
      val type = json.decodeRequired<InlineAnthropicFileDocumentSourceTypeX87400e76>(rawObject, "type")
      return AnthropicFileDocumentSource(
        fileId = fileId,
        type = type,
      )
...
public fun anthropicFileDocumentSource(block: AnthropicFileDocumentSource.Builder.() -> Unit): AnthropicFileDocumentSource = AnthropicFileDocumentSource.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("AnthropicFileDocumentSource is missing required property '" + name + "'")
