 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/AnthropicDocumentBlock
 */
@Serializable(with = AnthropicDocumentBlock.Serializer::class)
public class AnthropicDocumentBlock internal constructor(
  public val source: InlineAnthropicDocumentBlockSourceX6fa721bf,
  public val title: String?,
  public val type: InlineAnthropicDocumentBlockTypeX02c563ca,
  ...
  public constructor(
    source: InlineAnthropicDocumentBlockSourceX6fa721bf,
    title: String?,
    type: InlineAnthropicDocumentBlockTypeX02c563ca,
  ) : this(source = source,
  title = title,
  type = type,
  ...
  public class Builder {
    private var sourceValue: InlineAnthropicDocumentBlockSourceX6fa721bf? = null

    public var source: InlineAnthropicDocumentBlockSourceX6fa721bf
      get() = requireNotNull(sourceValue) { "source is required" }
      set(`value`) {
        sourceValue = value
      }

    private var typeValue: InlineAnthropicDocumentBlockTypeX02c563ca? = null

    public var type: InlineAnthropicDocumentBlockTypeX02c563ca
  ...
  internal object Serializer : KSerializer<AnthropicDocumentBlock> {
    ...
    override fun deserialize(decoder: Decoder): AnthropicDocumentBlock {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("AnthropicDocumentBlock must be a JSON object")
      val source = json.decodeRequired<InlineAnthropicDocumentBlockSourceX6fa721bf>(rawObject, "source")
      val type = json.decodeRequired<InlineAnthropicDocumentBlockTypeX02c563ca>(rawObject, "type")
      ...
      return AnthropicDocumentBlock(
        ...
        title = title,
        type = type,
        citationsState = json.decodeOptional(rawObject, "citations", nullable = true),
      )
    }
...
public fun anthropicDocumentBlock(block: AnthropicDocumentBlock.Builder.() -> Unit): AnthropicDocumentBlock = AnthropicDocumentBlock.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("AnthropicDocumentBlock is missing required property '" + name + "'")
