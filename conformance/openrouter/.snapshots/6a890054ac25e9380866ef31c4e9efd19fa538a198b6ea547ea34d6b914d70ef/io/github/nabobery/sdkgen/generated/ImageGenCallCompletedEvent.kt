 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/ImageGenCallCompletedEvent
 */
...
public class ImageGenCallCompletedEvent(
  ...
  internal object Serializer : KSerializer<ImageGenCallCompletedEvent> {
    ...
    override fun deserialize(decoder: Decoder): ImageGenCallCompletedEvent {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("ImageGenCallCompletedEvent must be a JSON object")
...
public fun imageGenCallCompletedEvent(block: ImageGenCallCompletedEvent.Builder.() -> Unit): ImageGenCallCompletedEvent = ImageGenCallCompletedEvent.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("ImageGenCallCompletedEvent is missing required property '" + name + "'")
