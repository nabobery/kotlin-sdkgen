 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/VideoModelsListResponse
 */
...
public class VideoModelsListResponse(
  ...
  internal object Serializer : KSerializer<VideoModelsListResponse> {
    ...
    override fun deserialize(decoder: Decoder): VideoModelsListResponse {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("VideoModelsListResponse must be a JSON object")
      val data = json.decodeRequired<List<VideoModel>>(rawObject, "data")
      return VideoModelsListResponse(
        data = data,
      )
    }
...
public fun videoModelsListResponse(block: VideoModelsListResponse.Builder.() -> Unit): VideoModelsListResponse = VideoModelsListResponse.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("VideoModelsListResponse is missing required property '" + name + "'")
