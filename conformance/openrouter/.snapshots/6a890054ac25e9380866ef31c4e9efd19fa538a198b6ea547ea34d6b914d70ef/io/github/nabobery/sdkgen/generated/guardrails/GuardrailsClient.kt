package io.github.nabobery.sdkgen.generated.guardrails
...
import io.github.nabobery.sdkgen.generated.BulkAssignKeysRequest
import io.github.nabobery.sdkgen.generated.BulkAssignKeysResponse
import io.github.nabobery.sdkgen.generated.BulkAssignMembersRequest
import io.github.nabobery.sdkgen.generated.BulkAssignMembersResponse
import io.github.nabobery.sdkgen.generated.BulkUnassignKeysRequest
import io.github.nabobery.sdkgen.generated.BulkUnassignKeysResponse
import io.github.nabobery.sdkgen.generated.BulkUnassignMembersRequest
import io.github.nabobery.sdkgen.generated.BulkUnassignMembersResponse
import io.github.nabobery.sdkgen.generated.CreateGuardrailRequest
import io.github.nabobery.sdkgen.generated.CreateGuardrailResponse
import io.github.nabobery.sdkgen.generated.DeleteGuardrailResponse
import io.github.nabobery.sdkgen.generated.ForbiddenResponse
import io.github.nabobery.sdkgen.generated.GetGuardrailResponse
import io.github.nabobery.sdkgen.generated.InternalServerResponse
import io.github.nabobery.sdkgen.generated.ListGuardrailsResponse
import io.github.nabobery.sdkgen.generated.ListKeyAssignmentsResponse
import io.github.nabobery.sdkgen.generated.ListMemberAssignmentsResponse
...
import io.github.nabobery.sdkgen.generated.UpdateGuardrailRequest
import io.github.nabobery.sdkgen.generated.UpdateGuardrailResponse
import kotlin.Int
...
public class GuardrailsClient(
  ...
  public suspend fun createGuardrail(
    ...
    xOpenRouterTitle: String? = null,
    options: CallOptions = CallOptions(),
  ): io.github.nabobery.sdkgen.generated.CreateGuardrailResponse = executor.executeWithTypedErrors<CreateGuardrailRequest, CreateGuardrailResponse, io.github.nabobery.sdkgen.generated.CreateGuardrailResponse>(
  ...
  public suspend fun deleteGuardrail(
    ...
    xOpenRouterTitle: String? = null,
    options: CallOptions = CallOptions(),
  ): io.github.nabobery.sdkgen.generated.DeleteGuardrailResponse = executor.executeWithTypedErrors<Unit, DeleteGuardrailResponse, io.github.nabobery.sdkgen.generated.DeleteGuardrailResponse>(
  ...
  public suspend fun getGuardrail(
    ...
    xOpenRouterTitle: String? = null,
    options: CallOptions = CallOptions(),
  ): io.github.nabobery.sdkgen.generated.GetGuardrailResponse = executor.executeWithTypedErrors<Unit, GetGuardrailResponse, io.github.nabobery.sdkgen.generated.GetGuardrailResponse>(
   ...
   * @param options Execution options.
   * @return Buffered response body.
   * @throws ListGuardrailKeyAssignmentsApiException When the service returns a declared non-success response; its
   * `error` property exposes the decoded ListGuardrailKeyAssignmentsError payload.
   * @throws SdkSerializationException When a request or response cannot be serialized.
   * @throws SdkTransportException When transport execution fails.
   */
  public suspend fun listGuardrailKeyAssignments(
    ...
    xOpenRouterTitle: String? = null,
    options: CallOptions = CallOptions(),
  ): io.github.nabobery.sdkgen.generated.ListKeyAssignmentsResponse = executor.executeWithTypedErrors<Unit, ListGuardrailKeyAssignmentsResponse, io.github.nabobery.sdkgen.generated.ListKeyAssignmentsResponse>(
    request = SdkExecutionRequest(listGuardrailKeyAssignmentsMetadata, baseUri, Unit, emptyList(), buildList {
      add(SdkRequestParameter(location = SdkParameterLocation.PATH, name = "id", values = listOf(id.toString())))
    ...
    requestCodecs = GuardrailsCodecs.listGuardrailKeyAssignmentsRequestCodecRegistry,
    responseDecoder = ListGuardrailKeyAssignmentsResponseDecoder,
    mapSuccess = { response ->
      when (response) {
        is ListGuardrailKeyAssignmentsResponse.SuccessJson -> response.json
        is ListGuardrailKeyAssignmentsResponse.Http401Json -> error("Runtime selected a non-success response for success mapping.")
        is ListGuardrailKeyAssignmentsResponse.Http404Json -> error("Runtime selected a non-success response for success mapping.")
        is ListGuardrailKeyAssignmentsResponse.Http500Json -> error("Runtime selected a non-success response for success mapping.")
        is ListGuardrailKeyAssignmentsResponse.Unknown -> error("Runtime returned an unmatched response through the typed success path.")
      }
    },
    mapError = { response, statusCode, headers ->
      when (response) {
        is ListGuardrailKeyAssignmentsResponse.SuccessJson -> error("Runtime selected a success response for error mapping.")
        is ListGuardrailKeyAssignmentsResponse.Http401Json -> ListGuardrailKeyAssignmentsApiException(response, statusCode, headers)
        is ListGuardrailKeyAssignmentsResponse.Http404Json -> ListGuardrailKeyAssignmentsApiException(response, statusCode, headers)
        is ListGuardrailKeyAssignmentsResponse.Http500Json -> ListGuardrailKeyAssignmentsApiException(response, statusCode, headers)
        is ListGuardrailKeyAssignmentsResponse.Unknown -> error("Runtime returned an unmatched response through the typed error path.")
      }
    },
    options = options,
  )
   ...
   * @param options Execution options.
   * @return Buffered response body.
   * @throws ListGuardrailMemberAssignmentsApiException When the service returns a declared non-success response; its
   * `error` property exposes the decoded ListGuardrailMemberAssignmentsError payload.
   * @throws SdkSerializationException When a request or response cannot be serialized.
   * @throws SdkTransportException When transport execution fails.
   */
  public suspend fun listGuardrailMemberAssignments(
    ...
    xOpenRouterTitle: String? = null,
    options: CallOptions = CallOptions(),
  ): io.github.nabobery.sdkgen.generated.ListMemberAssignmentsResponse = executor.executeWithTypedErrors<Unit, ListGuardrailMemberAssignmentsResponse, io.github.nabobery.sdkgen.generated.ListMemberAssignmentsResponse>(
    request = SdkExecutionRequest(listGuardrailMemberAssignmentsMetadata, baseUri, Unit, emptyList(), buildList {
      add(SdkRequestParameter(location = SdkParameterLocation.PATH, name = "id", values = listOf(id.toString())))
      add(SdkRequestParameter(location = SdkParameterLocation.QUERY, name = "limit", values = limit?.let { listOf(it.toString()) }.orEmpty()))
      add(SdkRequestParameter(location = SdkParameterLocation.QUERY, name = "offset", values = offset?.let { listOf(it.toString()) }.orEmpty()))
      add(SdkRequestParameter(location = SdkParameterLocation.HEADER, name = "HTTP-Referer", values = httpReferer?.let { listOf(it.toString()) }.orEmpty()))
    ...
    requestCodecs = GuardrailsCodecs.listGuardrailMemberAssignmentsRequestCodecRegistry,
    responseDecoder = ListGuardrailMemberAssignmentsResponseDecoder,
    mapSuccess = { response ->
      when (response) {
        is ListGuardrailMemberAssignmentsResponse.SuccessJson -> response.json
        is ListGuardrailMemberAssignmentsResponse.Http401Json -> error("Runtime selected a non-success response for success mapping.")
        is ListGuardrailMemberAssignmentsResponse.Http404Json -> error("Runtime selected a non-success response for success mapping.")
        is ListGuardrailMemberAssignmentsResponse.Http500Json -> error("Runtime selected a non-success response for success mapping.")
        is ListGuardrailMemberAssignmentsResponse.Unknown -> error("Runtime returned an unmatched response through the typed success path.")
      }
    },
    mapError = { response, statusCode, headers ->
      when (response) {
        is ListGuardrailMemberAssignmentsResponse.SuccessJson -> error("Runtime selected a success response for error mapping.")
        is ListGuardrailMemberAssignmentsResponse.Http401Json -> ListGuardrailMemberAssignmentsApiException(response, statusCode, headers)
        is ListGuardrailMemberAssignmentsResponse.Http404Json -> ListGuardrailMemberAssignmentsApiException(response, statusCode, headers)
        is ListGuardrailMemberAssignmentsResponse.Http500Json -> ListGuardrailMemberAssignmentsApiException(response, statusCode, headers)
        is ListGuardrailMemberAssignmentsResponse.Unknown -> error("Runtime returned an unmatched response through the typed error path.")
      }
    },
    options = options,
  )
   ...
   * @param options Execution options.
   * @return Buffered response body.
   * @throws ListGuardrailsApiException When the service returns a declared non-success response; its `error` property
   * exposes the decoded ListGuardrailsError payload.
   * @throws SdkSerializationException When a request or response cannot be serialized.
   * @throws SdkTransportException When transport execution fails.
   */
  public suspend fun listGuardrails(
    ...
    xOpenRouterTitle: String? = null,
    options: CallOptions = CallOptions(),
  ): io.github.nabobery.sdkgen.generated.ListGuardrailsResponse = executor.executeWithTypedErrors<Unit, ListGuardrailsResponse, io.github.nabobery.sdkgen.generated.ListGuardrailsResponse>(
    request = SdkExecutionRequest(listGuardrailsMetadata, baseUri, Unit, emptyList(), buildList {
      add(SdkRequestParameter(location = SdkParameterLocation.QUERY, name = "limit", values = limit?.let { listOf(it.toString()) }.orEmpty()))
      add(SdkRequestParameter(location = SdkParameterLocation.QUERY, name = "offset", values = offset?.let { listOf(it.toString()) }.orEmpty()))
    ...
    requestCodecs = GuardrailsCodecs.listGuardrailsRequestCodecRegistry,
    responseDecoder = ListGuardrailsResponseDecoder,
    mapSuccess = { response ->
      when (response) {
        is ListGuardrailsResponse.SuccessJson -> response.json
        is ListGuardrailsResponse.Http401Json -> error("Runtime selected a non-success response for success mapping.")
        is ListGuardrailsResponse.Http500Json -> error("Runtime selected a non-success response for success mapping.")
        is ListGuardrailsResponse.Unknown -> error("Runtime returned an unmatched response through the typed success path.")
      }
    },
    mapError = { response, statusCode, headers ->
      when (response) {
        is ListGuardrailsResponse.SuccessJson -> error("Runtime selected a success response for error mapping.")
        is ListGuardrailsResponse.Http401Json -> ListGuardrailsApiException(response, statusCode, headers)
        is ListGuardrailsResponse.Http500Json -> ListGuardrailsApiException(response, statusCode, headers)
        is ListGuardrailsResponse.Unknown -> error("Runtime returned an unmatched response through the typed error path.")
      }
    },
    options = options,
  )
   ...
   * @param options Execution options.
   * @return Buffered response body.
   * @throws ListKeyAssignmentsApiException When the service returns a declared non-success response; its `error`
   * property exposes the decoded ListKeyAssignmentsError payload.
   * @throws SdkSerializationException When a request or response cannot be serialized.
   * @throws SdkTransportException When transport execution fails.
   */
  public suspend fun listKeyAssignments(
    ...
    xOpenRouterTitle: String? = null,
    options: CallOptions = CallOptions(),
  ): io.github.nabobery.sdkgen.generated.ListKeyAssignmentsResponse = executor.executeWithTypedErrors<Unit, ListKeyAssignmentsResponse, io.github.nabobery.sdkgen.generated.ListKeyAssignmentsResponse>(
    request = SdkExecutionRequest(listKeyAssignmentsMetadata, baseUri, Unit, emptyList(), buildList {
      add(SdkRequestParameter(location = SdkParameterLocation.QUERY, name = "limit", values = limit?.let { listOf(it.toString()) }.orEmpty()))
      add(SdkRequestParameter(location = SdkParameterLocation.QUERY, name = "offset", values = offset?.let { listOf(it.toString()) }.orEmpty()))
      add(SdkRequestParameter(location = SdkParameterLocation.HEADER, name = "HTTP-Referer", values = httpReferer?.let { listOf(it.toString()) }.orEmpty()))
      add(SdkRequestParameter(location = SdkParameterLocation.HEADER, name = "X-OpenRouter-Categories", values = xOpenRouterCategories?.let { listOf(it.toString()) }.orEmpty()))
    ...
    requestCodecs = GuardrailsCodecs.listKeyAssignmentsRequestCodecRegistry,
    responseDecoder = ListKeyAssignmentsResponseDecoder,
    mapSuccess = { response ->
      when (response) {
        is ListKeyAssignmentsResponse.SuccessJson -> response.json
        is ListKeyAssignmentsResponse.Http401Json -> error("Runtime selected a non-success response for success mapping.")
        is ListKeyAssignmentsResponse.Http500Json -> error("Runtime selected a non-success response for success mapping.")
        is ListKeyAssignmentsResponse.Unknown -> error("Runtime returned an unmatched response through the typed success path.")
      }
    },
    mapError = { response, statusCode, headers ->
      when (response) {
        is ListKeyAssignmentsResponse.SuccessJson -> error("Runtime selected a success response for error mapping.")
        is ListKeyAssignmentsResponse.Http401Json -> ListKeyAssignmentsApiException(response, statusCode, headers)
        is ListKeyAssignmentsResponse.Http500Json -> ListKeyAssignmentsApiException(response, statusCode, headers)
        is ListKeyAssignmentsResponse.Unknown -> error("Runtime returned an unmatched response through the typed error path.")
      }
    },
    options = options,
  )
   ...
   * @param options Execution options.
   * @return Buffered response body.
   * @throws ListMemberAssignmentsApiException When the service returns a declared non-success response; its `error`
   * property exposes the decoded ListMemberAssignmentsError payload.
   * @throws SdkSerializationException When a request or response cannot be serialized.
   * @throws SdkTransportException When transport execution fails.
   */
  public suspend fun listMemberAssignments(
    ...
    xOpenRouterTitle: String? = null,
    options: CallOptions = CallOptions(),
  ): io.github.nabobery.sdkgen.generated.ListMemberAssignmentsResponse = executor.executeWithTypedErrors<Unit, ListMemberAssignmentsResponse, io.github.nabobery.sdkgen.generated.ListMemberAssignmentsResponse>(
    request = SdkExecutionRequest(listMemberAssignmentsMetadata, baseUri, Unit, emptyList(), buildList {
      add(SdkRequestParameter(location = SdkParameterLocation.QUERY, name = "limit", values = limit?.let { listOf(it.toString()) }.orEmpty()))
      add(SdkRequestParameter(location = SdkParameterLocation.QUERY, name = "offset", values = offset?.let { listOf(it.toString()) }.orEmpty()))
      add(SdkRequestParameter(location = SdkParameterLocation.HEADER, name = "HTTP-Referer", values = httpReferer?.let { listOf(it.toString()) }.orEmpty()))
      add(SdkRequestParameter(location = SdkParameterLocation.HEADER, name = "X-OpenRouter-Categories", values = xOpenRouterCategories?.let { listOf(it.toString()) }.orEmpty()))
    ...
    requestCodecs = GuardrailsCodecs.listMemberAssignmentsRequestCodecRegistry,
    responseDecoder = ListMemberAssignmentsResponseDecoder,
    mapSuccess = { response ->
      when (response) {
        is ListMemberAssignmentsResponse.SuccessJson -> response.json
        is ListMemberAssignmentsResponse.Http401Json -> error("Runtime selected a non-success response for success mapping.")
        is ListMemberAssignmentsResponse.Http500Json -> error("Runtime selected a non-success response for success mapping.")
        is ListMemberAssignmentsResponse.Unknown -> error("Runtime returned an unmatched response through the typed success path.")
      }
    },
    mapError = { response, statusCode, headers ->
      when (response) {
        is ListMemberAssignmentsResponse.SuccessJson -> error("Runtime selected a success response for error mapping.")
        is ListMemberAssignmentsResponse.Http401Json -> ListMemberAssignmentsApiException(response, statusCode, headers)
        is ListMemberAssignmentsResponse.Http500Json -> ListMemberAssignmentsApiException(response, statusCode, headers)
        is ListMemberAssignmentsResponse.Unknown -> error("Runtime returned an unmatched response through the typed error path.")
      }
    },
    options = options,
  )
  ...
  public suspend fun updateGuardrail(
    ...
    xOpenRouterTitle: String? = null,
    options: CallOptions = CallOptions(),
  ): io.github.nabobery.sdkgen.generated.UpdateGuardrailResponse = executor.executeWithTypedErrors<UpdateGuardrailRequest, UpdateGuardrailResponse, io.github.nabobery.sdkgen.generated.UpdateGuardrailResponse>(
  ...
  public sealed interface CreateGuardrailResponse {
    public class SuccessJson(
      public val json: io.github.nabobery.sdkgen.generated.CreateGuardrailResponse,
      public val statusCode: Int,
      public val headers: List<SdkHeader>,
  ...
  public sealed interface DeleteGuardrailResponse {
    public class SuccessJson(
      public val json: io.github.nabobery.sdkgen.generated.DeleteGuardrailResponse,
      public val statusCode: Int,
      public val headers: List<SdkHeader>,
  ...
  public sealed interface GetGuardrailResponse {
    public class SuccessJson(
      public val json: io.github.nabobery.sdkgen.generated.GetGuardrailResponse,
      public val statusCode: Int,
      public val headers: List<SdkHeader>,
  ...
  public sealed interface ListGuardrailKeyAssignmentsResponse {
    public class SuccessJson(
      public val json: io.github.nabobery.sdkgen.generated.ListKeyAssignmentsResponse,
      public val statusCode: Int,
      public val headers: List<SdkHeader>,
  ...
  public sealed interface ListGuardrailMemberAssignmentsResponse {
    public class SuccessJson(
      public val json: io.github.nabobery.sdkgen.generated.ListMemberAssignmentsResponse,
      public val statusCode: Int,
      public val headers: List<SdkHeader>,
  ...
  public sealed interface ListGuardrailsResponse {
    public class SuccessJson(
      public val json: io.github.nabobery.sdkgen.generated.ListGuardrailsResponse,
      public val statusCode: Int,
      public val headers: List<SdkHeader>,
  ...
  public sealed interface UpdateGuardrailResponse {
    public class SuccessJson(
      public val json: io.github.nabobery.sdkgen.generated.UpdateGuardrailResponse,
      public val statusCode: Int,
      public val headers: List<SdkHeader>,
