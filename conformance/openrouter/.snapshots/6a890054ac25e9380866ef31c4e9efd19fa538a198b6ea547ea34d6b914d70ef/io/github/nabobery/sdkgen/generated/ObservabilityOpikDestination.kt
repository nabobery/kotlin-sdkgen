 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/ObservabilityOpikDestination
 */
...
public class ObservabilityOpikDestination(
  ...
  public class Builder {
    private var configValue: InlineObservabilityOpikDestinationConfigX2c5bed62? = null

    public var config: InlineObservabilityOpikDestinationConfigX2c5bed62
    ...
    private var typeValue: InlineObservabilityOpikDestinationTypeXf88b0504? = null

    public var type: InlineObservabilityOpikDestinationTypeXf88b0504
  ...
  internal object Serializer : KSerializer<ObservabilityOpikDestination> {
    ...
    override fun deserialize(decoder: Decoder): ObservabilityOpikDestination {
      ...
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("ObservabilityOpikDestination must be a JSON object")
      val config = json.decodeRequired<InlineObservabilityOpikDestinationConfigX2c5bed62>(rawObject, "config")
      ...
      val type = json.decodeRequired<InlineObservabilityOpikDestinationTypeXf88b0504>(rawObject, "type")
...
public fun observabilityOpikDestination(block: ObservabilityOpikDestination.Builder.() -> Unit): ObservabilityOpikDestination = ObservabilityOpikDestination.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("ObservabilityOpikDestination is missing required property '" + name + "'")
