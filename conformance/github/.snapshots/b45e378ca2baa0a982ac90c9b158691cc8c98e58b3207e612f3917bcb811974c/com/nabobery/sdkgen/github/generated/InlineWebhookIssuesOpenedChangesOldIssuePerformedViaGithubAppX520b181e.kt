 ...
 * ties/performed_via_github_app
 */
@Serializable(with = InlineWebhookIssuesOpenedChangesOldIssuePerformedViaGithubAppX520b181e.Serializer::class)
public class InlineWebhookIssuesOpenedChangesOldIssuePerformedViaGithubAppX520b181e internal constructor(
  /**
  ...
  public val owner: InlineWebhookIssuesOpenedChangesOldIssuePerformedViaGithubAppOwnerXcf131011?,
  /**
   * Wire format: `date-time`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  public val updatedAt: String?,
  eventsState: FieldState<List<InlineWebhookIssuesOpenedChangesOldIssuePerformedViaGithubAppEventsItemXae2c53ab>>,
  private val permissionsState:
      FieldState<InlineWebhookIssuesOpenedChangesOldIssuePermissionsXb0b3a19f>,
  private val slugState: FieldState<String>,
) {
  private val eventsState:
      FieldState<List<InlineWebhookIssuesOpenedChangesOldIssuePerformedViaGithubAppEventsItemXae2c53ab>>
   ...
   */
  public val events:
      List<InlineWebhookIssuesOpenedChangesOldIssuePerformedViaGithubAppEventsItemXae2c53ab>?
    get() = eventsState.valueOrNull()

  /**
   * The set of permissions for the GitHub app
   */
  public val permissions: InlineWebhookIssuesOpenedChangesOldIssuePermissionsXb0b3a19f?
  ...
  public constructor(
    ...
    name: String,
    nodeId: String,
    owner: InlineWebhookIssuesOpenedChangesOldIssuePerformedViaGithubAppOwnerXcf131011?,
    updatedAt: String?,
  ...
  public class Builder {
    ...
    private var ownerState:
        FieldState<InlineWebhookIssuesOpenedChangesOldIssuePerformedViaGithubAppOwnerXcf131011?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var owner: InlineWebhookIssuesOpenedChangesOldIssuePerformedViaGithubAppOwnerXcf131011?
    ...
    private var permissionsState:
        FieldState<InlineWebhookIssuesOpenedChangesOldIssuePermissionsXb0b3a19f> = FieldState.Absent

    /**
     * The set of permissions for the GitHub app
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var permissions: InlineWebhookIssuesOpenedChangesOldIssuePermissionsXb0b3a19f?
      get() = permissionsState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): InlineWebhookIssuesOpenedChangesOldIssuePerformedViaGithubAppX520b181e {
      ...
      return InlineWebhookIssuesOpenedChangesOldIssuePerformedViaGithubAppX520b181e(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesOpenedChangesOldIssuePerformedViaGithubAppX520b181e = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesOpenedChangesOldIssuePerformedViaGithubAppX520b181e> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesOpenedChangesOldIssuePerformedViaGithubAppX520b181e {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesOpenedChangesOldIssuePerformedViaGithubAppX520b181e")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesOpenedChangesOldIssuePerformedViaGithubAppX520b181e must be a JSON object")
      val htmlUrl = json.decodeRequired<String>(rawObject, "html_url")
      val name = json.decodeRequired<String>(rawObject, "name")
      val nodeId = json.decodeRequired<String>(rawObject, "node_id")
      if (!rawObject.containsKey("created_at")) {
        throw SerializationException("InlineWebhookIssuesOpenedChangesOldIssuePerformedViaGithubAppX520b181e is missing required property 'created_at'")
      }
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookIssuesOpenedChangesOldIssuePerformedViaGithubAppX520b181e is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("external_url")) {
        throw SerializationException("InlineWebhookIssuesOpenedChangesOldIssuePerformedViaGithubAppX520b181e is missing required property 'external_url'")
      }
      ...
      if (!rawObject.containsKey("id")) {
        throw SerializationException("InlineWebhookIssuesOpenedChangesOldIssuePerformedViaGithubAppX520b181e is missing required property 'id'")
      }
      ...
      if (!rawObject.containsKey("owner")) {
        throw SerializationException("InlineWebhookIssuesOpenedChangesOldIssuePerformedViaGithubAppX520b181e is missing required property 'owner'")
      }
      val owner = rawObject["owner"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookIssuesOpenedChangesOldIssuePerformedViaGithubAppOwnerXcf131011?>(requireNotNull(element)) }
      if (!rawObject.containsKey("updated_at")) {
        throw SerializationException("InlineWebhookIssuesOpenedChangesOldIssuePerformedViaGithubAppX520b181e is missing required property 'updated_at'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesOpenedChangesOldIssuePerformedViaGithubAppX520b181e) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesOpenedChangesOldIssuePerformedViaGithubAppX520b181e")
...
public fun inlineWebhookIssuesOpenedChangesOldIssuePerformedViaGithubAppX520b181e(block: InlineWebhookIssuesOpenedChangesOldIssuePerformedViaGithubAppX520b181e.Builder.() -> Unit): InlineWebhookIssuesOpenedChangesOldIssuePerformedViaGithubAppX520b181e = InlineWebhookIssuesOpenedChangesOldIssuePerformedViaGithubAppX520b181e.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesOpenedChangesOldIssuePerformedViaGithubAppX520b181e is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookIssuesOpenedChangesOldIssuePerformedViaGithubAppX520b181e property '" + name + "' is not nullable")
