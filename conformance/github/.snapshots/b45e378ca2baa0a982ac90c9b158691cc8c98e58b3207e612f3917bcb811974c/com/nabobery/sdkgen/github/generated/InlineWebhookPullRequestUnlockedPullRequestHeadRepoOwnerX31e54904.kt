 ...
 * d/properties/repo/properties/owner
 */
@Serializable(with = InlineWebhookPullRequestUnlockedPullRequestHeadRepoOwnerX31e54904.Serializer::class)
public class InlineWebhookPullRequestUnlockedPullRequestHeadRepoOwnerX31e54904(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestUnlockedPullRequestHeadRepoOwnerTypeXa63f84e8? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestUnlockedPullRequestHeadRepoOwnerTypeXa63f84e8? = null
    ...
    public fun build(): InlineWebhookPullRequestUnlockedPullRequestHeadRepoOwnerX31e54904 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestUnlockedPullRequestHeadRepoOwnerX31e54904(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestUnlockedPullRequestHeadRepoOwnerX31e54904 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestUnlockedPullRequestHeadRepoOwnerX31e54904> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestUnlockedPullRequestHeadRepoOwnerX31e54904 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestUnlockedPullRequestHeadRepoOwnerX31e54904")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestUnlockedPullRequestHeadRepoOwnerX31e54904 must be a JSON object")
      ...
      return InlineWebhookPullRequestUnlockedPullRequestHeadRepoOwnerX31e54904(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestUnlockedPullRequestHeadRepoOwnerTypeXa63f84e8>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestUnlockedPullRequestHeadRepoOwnerX31e54904) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestUnlockedPullRequestHeadRepoOwnerX31e54904")
...
public fun inlineWebhookPullRequestUnlockedPullRequestHeadRepoOwnerX31e54904(block: InlineWebhookPullRequestUnlockedPullRequestHeadRepoOwnerX31e54904.Builder.() -> Unit): InlineWebhookPullRequestUnlockedPullRequestHeadRepoOwnerX31e54904 = InlineWebhookPullRequestUnlockedPullRequestHeadRepoOwnerX31e54904.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestUnlockedPullRequestHeadRepoOwnerX31e54904 is missing required property '" + name + "'")
