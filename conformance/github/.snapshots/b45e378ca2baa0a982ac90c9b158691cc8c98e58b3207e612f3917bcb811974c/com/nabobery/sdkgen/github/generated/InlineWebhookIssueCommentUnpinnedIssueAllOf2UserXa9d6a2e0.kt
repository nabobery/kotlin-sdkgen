...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-issue-comment-unpinned/properties/issue/allOf/1/properties/u
 * ser.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-issue-comment-unpinned/properties/issue/allOf/1/properties/u
 * ser
 */
@Serializable(with = InlineWebhookIssueCommentUnpinnedIssueAllOf2UserXa9d6a2e0.Serializer::class)
public class InlineWebhookIssueCommentUnpinnedIssueAllOf2UserXa9d6a2e0(
  ...
  public class Builder {
    ...
    public fun build(): InlineWebhookIssueCommentUnpinnedIssueAllOf2UserXa9d6a2e0 = InlineWebhookIssueCommentUnpinnedIssueAllOf2UserXa9d6a2e0(
      avatarUrl = avatarUrl,
      eventsUrl = eventsUrl,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssueCommentUnpinnedIssueAllOf2UserXa9d6a2e0 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssueCommentUnpinnedIssueAllOf2UserXa9d6a2e0> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssueCommentUnpinnedIssueAllOf2UserXa9d6a2e0 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssueCommentUnpinnedIssueAllOf2UserXa9d6a2e0")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssueCommentUnpinnedIssueAllOf2UserXa9d6a2e0 must be a JSON object")
      return InlineWebhookIssueCommentUnpinnedIssueAllOf2UserXa9d6a2e0(
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssueCommentUnpinnedIssueAllOf2UserXa9d6a2e0) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssueCommentUnpinnedIssueAllOf2UserXa9d6a2e0")
...
public fun inlineWebhookIssueCommentUnpinnedIssueAllOf2UserXa9d6a2e0(block: InlineWebhookIssueCommentUnpinnedIssueAllOf2UserXa9d6a2e0.Builder.() -> Unit): InlineWebhookIssueCommentUnpinnedIssueAllOf2UserXa9d6a2e0 = InlineWebhookIssueCommentUnpinnedIssueAllOf2UserXa9d6a2e0.build(block)
