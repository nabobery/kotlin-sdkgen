 ...
 * signee
 */
@Serializable(with = InlineWebhookIssueCommentDeletedIssueAllOf2AssigneeX3e6b9c19.Serializer::class)
public class InlineWebhookIssueCommentDeletedIssueAllOf2AssigneeX3e6b9c19(
  public val id: Int,
  ...
  public val type: InlineWebhookIssueCommentDeletedIssueAllOf2AssigneeTypeX80404724? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookIssueCommentDeletedIssueAllOf2AssigneeTypeX80404724? = null
    ...
    public fun build(): InlineWebhookIssueCommentDeletedIssueAllOf2AssigneeX3e6b9c19 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssueCommentDeletedIssueAllOf2AssigneeX3e6b9c19(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssueCommentDeletedIssueAllOf2AssigneeX3e6b9c19 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssueCommentDeletedIssueAllOf2AssigneeX3e6b9c19> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssueCommentDeletedIssueAllOf2AssigneeX3e6b9c19 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssueCommentDeletedIssueAllOf2AssigneeX3e6b9c19")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssueCommentDeletedIssueAllOf2AssigneeX3e6b9c19 must be a JSON object")
      ...
      return InlineWebhookIssueCommentDeletedIssueAllOf2AssigneeX3e6b9c19(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssueCommentDeletedIssueAllOf2AssigneeTypeX80404724>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssueCommentDeletedIssueAllOf2AssigneeX3e6b9c19) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssueCommentDeletedIssueAllOf2AssigneeX3e6b9c19")
...
public fun inlineWebhookIssueCommentDeletedIssueAllOf2AssigneeX3e6b9c19(block: InlineWebhookIssueCommentDeletedIssueAllOf2AssigneeX3e6b9c19.Builder.() -> Unit): InlineWebhookIssueCommentDeletedIssueAllOf2AssigneeX3e6b9c19 = InlineWebhookIssueCommentDeletedIssueAllOf2AssigneeX3e6b9c19.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssueCommentDeletedIssueAllOf2AssigneeX3e6b9c19 is missing required property '" + name + "'")
