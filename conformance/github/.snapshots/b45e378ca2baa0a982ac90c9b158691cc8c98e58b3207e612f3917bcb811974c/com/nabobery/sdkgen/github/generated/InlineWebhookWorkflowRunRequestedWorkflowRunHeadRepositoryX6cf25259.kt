 ...
 * ad_repository
 */
@Serializable(with = InlineWebhookWorkflowRunRequestedWorkflowRunHeadRepositoryX6cf25259.Serializer::class)
public class InlineWebhookWorkflowRunRequestedWorkflowRunHeadRepositoryX6cf25259(
  /**
  ...
  public val owner: InlineWebhookWorkflowRunRequestedWorkflowRunHeadRepositoryOwnerX8f01367c?,
  /**
  ...
  public class Builder {
    ...
    private var ownerState:
        FieldState<InlineWebhookWorkflowRunRequestedWorkflowRunHeadRepositoryOwnerX8f01367c?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var owner: InlineWebhookWorkflowRunRequestedWorkflowRunHeadRepositoryOwnerX8f01367c?
      get() = ownerState.valueOrNull()
      set(`value`) {
        ownerState = value.toNullableFieldState()
      }

    public fun build(): InlineWebhookWorkflowRunRequestedWorkflowRunHeadRepositoryX6cf25259 {
      ...
      return InlineWebhookWorkflowRunRequestedWorkflowRunHeadRepositoryX6cf25259(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookWorkflowRunRequestedWorkflowRunHeadRepositoryX6cf25259 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookWorkflowRunRequestedWorkflowRunHeadRepositoryX6cf25259> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookWorkflowRunRequestedWorkflowRunHeadRepositoryX6cf25259 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookWorkflowRunRequestedWorkflowRunHeadRepositoryX6cf25259")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookWorkflowRunRequestedWorkflowRunHeadRepositoryX6cf25259 must be a JSON object")
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookWorkflowRunRequestedWorkflowRunHeadRepositoryX6cf25259 is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("owner")) {
        throw SerializationException("InlineWebhookWorkflowRunRequestedWorkflowRunHeadRepositoryX6cf25259 is missing required property 'owner'")
      }
      val owner = rawObject["owner"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookWorkflowRunRequestedWorkflowRunHeadRepositoryOwnerX8f01367c?>(requireNotNull(element)) }
      return InlineWebhookWorkflowRunRequestedWorkflowRunHeadRepositoryX6cf25259(
        archiveUrl = archiveUrl,
        assigneesUrl = assigneesUrl,
        blobsUrl = blobsUrl,
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookWorkflowRunRequestedWorkflowRunHeadRepositoryX6cf25259) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookWorkflowRunRequestedWorkflowRunHeadRepositoryX6cf25259")
...
public fun inlineWebhookWorkflowRunRequestedWorkflowRunHeadRepositoryX6cf25259(block: InlineWebhookWorkflowRunRequestedWorkflowRunHeadRepositoryX6cf25259.Builder.() -> Unit): InlineWebhookWorkflowRunRequestedWorkflowRunHeadRepositoryX6cf25259 = InlineWebhookWorkflowRunRequestedWorkflowRunHeadRepositoryX6cf25259.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookWorkflowRunRequestedWorkflowRunHeadRepositoryX6cf25259 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookWorkflowRunRequestedWorkflowRunHeadRepositoryX6cf25259 property '" + name + "' is not nullable")
