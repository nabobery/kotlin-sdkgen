...
public class GlobalAdvisory internal constructor(
  ...
  public val cwes: List<InlineGlobalAdvisoryCwesItemX1a9e04b8>? =
      cwes?.let { collection0 -> collection0.toList() }

  public val identifiers: List<InlineGlobalAdvisoryIdentifiersItemXa24e0c60>? =
      identifiers?.let { collection0 -> collection0.toList() }

  public val references: List<String>? = references?.let { collection0 -> collection0.toList() }

  /**
   * The products and respective version ranges affected by the advisory.
   */
  public val vulnerabilities: List<Vulnerability>? =
      vulnerabilities?.let { collection0 -> collection0.toList() }
  ...
  public class Builder {
    ...
    public var cwes: List<InlineGlobalAdvisoryCwesItemX1a9e04b8>?
      get() = cwesState.valueOrNull()?.let { collection0 -> collection0.toList() }
      set(`value`) {
        cwesState = value?.let { collection0 -> collection0.toList() }.toNullableFieldState()
      }
    ...
    public var identifiers: List<InlineGlobalAdvisoryIdentifiersItemXa24e0c60>?
      get() = identifiersState.valueOrNull()?.let { collection0 -> collection0.toList() }
      set(`value`) {
        identifiersState = value?.let { collection0 -> collection0.toList() }.toNullableFieldState()
      }
    ...
    public var references: List<String>?
      get() = referencesState.valueOrNull()?.let { collection0 -> collection0.toList() }
      set(`value`) {
        referencesState = value?.let { collection0 -> collection0.toList() }.toNullableFieldState()
      }
    ...
    public var vulnerabilities: List<Vulnerability>?
      ...
      set(`value`) {
        vulnerabilitiesState = value?.let { collection0 -> collection0.toList() }.toNullableFieldState()
      }
  ...
  internal object Serializer : KSerializer<GlobalAdvisory> {
