...
@Serializable
public data class ParentIssueAddedIssueEventView(
 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/parent-issue-added-issue-event
 */
@Serializable(with = ParentIssueAddedIssueEvent.Serializer::class)
public class ParentIssueAddedIssueEvent(
  public val actor: SimpleUser,
  public val commitId: String?,
  public val commitUrl: String?,
  public val createdAt: String,
  ...
  public class Builder {
    ...
    public fun build(): ParentIssueAddedIssueEvent {
      ...
      return ParentIssueAddedIssueEvent(
        actor = actor,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): ParentIssueAddedIssueEvent = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<ParentIssueAddedIssueEvent> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): ParentIssueAddedIssueEvent {
      val jsonDecoder = decoder.requireJsonDecoder("ParentIssueAddedIssueEvent")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("ParentIssueAddedIssueEvent must be a JSON object")
      ...
      if (!rawObject.containsKey("commit_id")) {
        throw SerializationException("ParentIssueAddedIssueEvent is missing required property 'commit_id'")
      }
      ...
      if (!rawObject.containsKey("commit_url")) {
        throw SerializationException("ParentIssueAddedIssueEvent is missing required property 'commit_url'")
      }
      ...
      if (!rawObject.containsKey("parent_issue")) {
        throw SerializationException("ParentIssueAddedIssueEvent is missing required property 'parent_issue'")
      }
      ...
      if (!rawObject.containsKey("performed_via_github_app")) {
        throw SerializationException("ParentIssueAddedIssueEvent is missing required property 'performed_via_github_app'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: ParentIssueAddedIssueEvent) {
      val jsonEncoder = encoder.requireJsonEncoder("ParentIssueAddedIssueEvent")
...
public fun parentIssueAddedIssueEvent(block: ParentIssueAddedIssueEvent.Builder.() -> Unit): ParentIssueAddedIssueEvent = ParentIssueAddedIssueEvent.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("ParentIssueAddedIssueEvent is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("ParentIssueAddedIssueEvent property '" + name + "' is not nullable")
