 ...
 * roperties/from/properties/user.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-repository-transferred/properties/changes/properties/owner/p
 * roperties/from/properties/user
 */
@Serializable(with = InlineWebhookRepositoryTransferredChangesOwnerFromUserXc2be5bca.Serializer::class)
public class InlineWebhookRepositoryTransferredChangesOwnerFromUserXc2be5bca(
  public val id: Long,
  ...
  public val type: InlineWebhookRepositoryTransferredChangesOwnerFromUserTypeXfe8eb1d5? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookRepositoryTransferredChangesOwnerFromUserTypeXfe8eb1d5? = null
    ...
    public fun build(): InlineWebhookRepositoryTransferredChangesOwnerFromUserXc2be5bca {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookRepositoryTransferredChangesOwnerFromUserXc2be5bca(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookRepositoryTransferredChangesOwnerFromUserXc2be5bca = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookRepositoryTransferredChangesOwnerFromUserXc2be5bca> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookRepositoryTransferredChangesOwnerFromUserXc2be5bca {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookRepositoryTransferredChangesOwnerFromUserXc2be5bca")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookRepositoryTransferredChangesOwnerFromUserXc2be5bca must be a JSON object")
      ...
      return InlineWebhookRepositoryTransferredChangesOwnerFromUserXc2be5bca(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookRepositoryTransferredChangesOwnerFromUserTypeXfe8eb1d5>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookRepositoryTransferredChangesOwnerFromUserXc2be5bca) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookRepositoryTransferredChangesOwnerFromUserXc2be5bca")
...
public fun inlineWebhookRepositoryTransferredChangesOwnerFromUserXc2be5bca(block: InlineWebhookRepositoryTransferredChangesOwnerFromUserXc2be5bca.Builder.() -> Unit): InlineWebhookRepositoryTransferredChangesOwnerFromUserXc2be5bca = InlineWebhookRepositoryTransferredChangesOwnerFromUserXc2be5bca.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookRepositoryTransferredChangesOwnerFromUserXc2be5bca is missing required property '" + name + "'")
