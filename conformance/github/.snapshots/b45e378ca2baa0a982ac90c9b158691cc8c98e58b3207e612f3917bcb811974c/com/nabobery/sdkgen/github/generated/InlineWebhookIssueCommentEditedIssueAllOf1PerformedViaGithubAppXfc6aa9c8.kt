 ...
 * formed_via_github_app
 */
@Serializable(with = InlineWebhookIssueCommentEditedIssueAllOf1PerformedViaGithubAppXfc6aa9c8.Serializer::class)
public class InlineWebhookIssueCommentEditedIssueAllOf1PerformedViaGithubAppXfc6aa9c8 internal constructor(
  /**
  ...
  public val owner: InlineWebhookIssueCommentEditedIssueAllOf1PerformedViaGithubAppOwnerX8cdc79c1?,
  /**
   * Wire format: `date-time`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  public val updatedAt: String?,
  eventsState: FieldState<List<InlineWebhookIssueCommentE365aIssueAllOf1PerformedViaGithubAppItemX6340c9c8>>,
  private val permissionsState:
      FieldState<InlineWebhookIssueCommentE365aIssueAllOf1PermissionsXd9d6a82b>,
  private val slugState: FieldState<String>,
) {
  private val eventsState:
      FieldState<List<InlineWebhookIssueCommentE365aIssueAllOf1PerformedViaGithubAppItemX6340c9c8>>
   ...
   */
  public val events:
      List<InlineWebhookIssueCommentE365aIssueAllOf1PerformedViaGithubAppItemX6340c9c8>?
    get() = eventsState.valueOrNull()

  /**
   * The set of permissions for the GitHub app
   */
  public val permissions: InlineWebhookIssueCommentE365aIssueAllOf1PermissionsXd9d6a82b?
  ...
  public constructor(
    ...
    name: String,
    nodeId: String,
    owner: InlineWebhookIssueCommentEditedIssueAllOf1PerformedViaGithubAppOwnerX8cdc79c1?,
    updatedAt: String?,
  ...
  public class Builder {
    ...
    private var ownerState:
        FieldState<InlineWebhookIssueCommentEditedIssueAllOf1PerformedViaGithubAppOwnerX8cdc79c1?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var owner: InlineWebhookIssueCommentEditedIssueAllOf1PerformedViaGithubAppOwnerX8cdc79c1?
     ...
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var permissions: InlineWebhookIssueCommentE365aIssueAllOf1PermissionsXd9d6a82b?
      get() = permissionsState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): InlineWebhookIssueCommentEditedIssueAllOf1PerformedViaGithubAppXfc6aa9c8 {
      ...
      return InlineWebhookIssueCommentEditedIssueAllOf1PerformedViaGithubAppXfc6aa9c8(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssueCommentEditedIssueAllOf1PerformedViaGithubAppXfc6aa9c8 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssueCommentEditedIssueAllOf1PerformedViaGithubAppXfc6aa9c8> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssueCommentEditedIssueAllOf1PerformedViaGithubAppXfc6aa9c8 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssueCommentEditedIssueAllOf1PerformedViaGithubAppXfc6aa9c8")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssueCommentEditedIssueAllOf1PerformedViaGithubAppXfc6aa9c8 must be a JSON object")
      val htmlUrl = json.decodeRequired<String>(rawObject, "html_url")
      val name = json.decodeRequired<String>(rawObject, "name")
      val nodeId = json.decodeRequired<String>(rawObject, "node_id")
      if (!rawObject.containsKey("created_at")) {
        throw SerializationException("InlineWebhookIssueCommentEditedIssueAllOf1PerformedViaGithubAppXfc6aa9c8 is missing required property 'created_at'")
      }
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookIssueCommentEditedIssueAllOf1PerformedViaGithubAppXfc6aa9c8 is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("external_url")) {
        throw SerializationException("InlineWebhookIssueCommentEditedIssueAllOf1PerformedViaGithubAppXfc6aa9c8 is missing required property 'external_url'")
      }
      ...
      if (!rawObject.containsKey("id")) {
        throw SerializationException("InlineWebhookIssueCommentEditedIssueAllOf1PerformedViaGithubAppXfc6aa9c8 is missing required property 'id'")
      }
      ...
      if (!rawObject.containsKey("owner")) {
        throw SerializationException("InlineWebhookIssueCommentEditedIssueAllOf1PerformedViaGithubAppXfc6aa9c8 is missing required property 'owner'")
      }
      val owner = rawObject["owner"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookIssueCommentEditedIssueAllOf1PerformedViaGithubAppOwnerX8cdc79c1?>(requireNotNull(element)) }
      if (!rawObject.containsKey("updated_at")) {
        throw SerializationException("InlineWebhookIssueCommentEditedIssueAllOf1PerformedViaGithubAppXfc6aa9c8 is missing required property 'updated_at'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssueCommentEditedIssueAllOf1PerformedViaGithubAppXfc6aa9c8) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssueCommentEditedIssueAllOf1PerformedViaGithubAppXfc6aa9c8")
...
public fun inlineWebhookIssueCommentEditedIssueAllOf1PerformedViaGithubAppXfc6aa9c8(block: InlineWebhookIssueCommentEditedIssueAllOf1PerformedViaGithubAppXfc6aa9c8.Builder.() -> Unit): InlineWebhookIssueCommentEditedIssueAllOf1PerformedViaGithubAppXfc6aa9c8 = InlineWebhookIssueCommentEditedIssueAllOf1PerformedViaGithubAppXfc6aa9c8.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssueCommentEditedIssueAllOf1PerformedViaGithubAppXfc6aa9c8 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookIssueCommentEditedIssueAllOf1PerformedViaGithubAppXfc6aa9c8 property '" + name + "' is not nullable")
