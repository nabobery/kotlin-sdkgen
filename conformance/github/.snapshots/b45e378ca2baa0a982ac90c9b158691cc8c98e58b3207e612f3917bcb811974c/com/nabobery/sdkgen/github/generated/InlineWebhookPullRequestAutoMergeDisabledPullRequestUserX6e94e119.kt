 ...
 * perties/user
 */
@Serializable(with = InlineWebhookPullRequestAutoMergeDisabledPullRequestUserX6e94e119.Serializer::class)
public class InlineWebhookPullRequestAutoMergeDisabledPullRequestUserX6e94e119(
  public val id: Long,
  ...
  public val type: InlineWebhookPullRequestAutoMergeDisabledPullRequestUserTypeX8a1c1655? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestAutoMergeDisabledPullRequestUserTypeX8a1c1655? = null
    ...
    public fun build(): InlineWebhookPullRequestAutoMergeDisabledPullRequestUserX6e94e119 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestAutoMergeDisabledPullRequestUserX6e94e119(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestAutoMergeDisabledPullRequestUserX6e94e119 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestAutoMergeDisabledPullRequestUserX6e94e119> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestAutoMergeDisabledPullRequestUserX6e94e119 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestAutoMergeDisabledPullRequestUserX6e94e119")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestAutoMergeDisabledPullRequestUserX6e94e119 must be a JSON object")
      ...
      return InlineWebhookPullRequestAutoMergeDisabledPullRequestUserX6e94e119(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestAutoMergeDisabledPullRequestUserTypeX8a1c1655>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestAutoMergeDisabledPullRequestUserX6e94e119) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestAutoMergeDisabledPullRequestUserX6e94e119")
...
public fun inlineWebhookPullRequestAutoMergeDisabledPullRequestUserX6e94e119(block: InlineWebhookPullRequestAutoMergeDisabledPullRequestUserX6e94e119.Builder.() -> Unit): InlineWebhookPullRequestAutoMergeDisabledPullRequestUserX6e94e119 = InlineWebhookPullRequestAutoMergeDisabledPullRequestUserX6e94e119.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestAutoMergeDisabledPullRequestUserX6e94e119 is missing required property '" + name + "'")
