 ...
 */
@Serializable(with = InlineWebhookPullRequestReviewRequestedOneOf2PullRequestMilestoneXa3e21ade.Serializer::class)
public class InlineWebhookPullRequestReviewRequestedOneOf2PullRequestMilestoneXa3e21ade(
  /**
  ...
  public val creator: InlineWebhookPullRequestReffb1OneOf2PullRequestMilestoneCreatorXbc46af29?,
   ...
   */
  public val state: InlineWebhookPullRequestReviewRequestedOneOf2PullRequestMilestoneStateXb2714d85,
  /**
  ...
  public class Builder {
    ...
    private var stateValue:
        InlineWebhookPullRequestReviewRequestedOneOf2PullRequestMilestoneStateXb2714d85? = null
    ...
    private var creatorState:
        FieldState<InlineWebhookPullRequestReffb1OneOf2PullRequestMilestoneCreatorXbc46af29?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var creator: InlineWebhookPullRequestReffb1OneOf2PullRequestMilestoneCreatorXbc46af29?
    ...
    public fun build(): InlineWebhookPullRequestReviewRequestedOneOf2PullRequestMilestoneXa3e21ade {
      ...
      return InlineWebhookPullRequestReviewRequestedOneOf2PullRequestMilestoneXa3e21ade(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewRequestedOneOf2PullRequestMilestoneXa3e21ade = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewRequestedOneOf2PullRequestMilestoneXa3e21ade> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewRequestedOneOf2PullRequestMilestoneXa3e21ade {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewRequestedOneOf2PullRequestMilestoneXa3e21ade")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewRequestedOneOf2PullRequestMilestoneXa3e21ade must be a JSON object")
      ...
      val state = json.decodeRequired<InlineWebhookPullRequestReviewRequestedOneOf2PullRequestMilestoneStateXb2714d85>(rawObject, "state")
      val title = json.decodeRequired<String>(rawObject, "title")
      val updatedAt = json.decodeRequired<String>(rawObject, "updated_at")
      val url = json.decodeRequired<String>(rawObject, "url")
      if (!rawObject.containsKey("closed_at")) {
        throw SerializationException("InlineWebhookPullRequestReviewRequestedOneOf2PullRequestMilestoneXa3e21ade is missing required property 'closed_at'")
      }
      ...
      if (!rawObject.containsKey("creator")) {
        throw SerializationException("InlineWebhookPullRequestReviewRequestedOneOf2PullRequestMilestoneXa3e21ade is missing required property 'creator'")
      }
      val creator = rawObject["creator"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestReffb1OneOf2PullRequestMilestoneCreatorXbc46af29?>(requireNotNull(element)) }
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookPullRequestReviewRequestedOneOf2PullRequestMilestoneXa3e21ade is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("due_on")) {
        throw SerializationException("InlineWebhookPullRequestReviewRequestedOneOf2PullRequestMilestoneXa3e21ade is missing required property 'due_on'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewRequestedOneOf2PullRequestMilestoneXa3e21ade) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewRequestedOneOf2PullRequestMilestoneXa3e21ade")
...
public fun inlineWebhookPullRequestReviewRequestedOneOf2PullRequestMilestoneXa3e21ade(block: InlineWebhookPullRequestReviewRequestedOneOf2PullRequestMilestoneXa3e21ade.Builder.() -> Unit): InlineWebhookPullRequestReviewRequestedOneOf2PullRequestMilestoneXa3e21ade = InlineWebhookPullRequestReviewRequestedOneOf2PullRequestMilestoneXa3e21ade.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewRequestedOneOf2PullRequestMilestoneXa3e21ade is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookPullRequestReviewRequestedOneOf2PullRequestMilestoneXa3e21ade property '" + name + "' is not nullable")
