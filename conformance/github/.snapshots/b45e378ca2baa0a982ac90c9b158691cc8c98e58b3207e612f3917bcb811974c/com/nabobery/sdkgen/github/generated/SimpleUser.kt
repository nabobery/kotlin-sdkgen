...
@Serializable
public data class SimpleUserView(
 ...
 * A GitHub user.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/simple-user
 */
@Serializable(with = SimpleUser.Serializer::class)
public class SimpleUser internal constructor(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): SimpleUser = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<SimpleUser> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): SimpleUser {
      val jsonDecoder = decoder.requireJsonDecoder("SimpleUser")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("SimpleUser must be a JSON object")
      ...
      if (!rawObject.containsKey("gravatar_id")) {
        throw SerializationException("SimpleUser is missing required property 'gravatar_id'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: SimpleUser) {
      val jsonEncoder = encoder.requireJsonEncoder("SimpleUser")
...
public fun simpleUser(block: SimpleUser.Builder.() -> Unit): SimpleUser = SimpleUser.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("SimpleUser is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("SimpleUser property '" + name + "' is not nullable")
