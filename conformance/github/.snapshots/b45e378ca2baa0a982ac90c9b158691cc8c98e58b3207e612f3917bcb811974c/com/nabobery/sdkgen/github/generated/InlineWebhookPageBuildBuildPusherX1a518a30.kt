...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-page-build/properties/build/properties/pusher.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhook-page-build/properties/build/properties/pusher
 */
@Serializable(with = InlineWebhookPageBuildBuildPusherX1a518a30.Serializer::class)
public class InlineWebhookPageBuildBuildPusherX1a518a30(
  public val id: Int,
  ...
  public val type: InlineWebhookPageBuildBuildPusherTypeX8c76a1c4? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPageBuildBuildPusherTypeX8c76a1c4? = null
    ...
    public fun build(): InlineWebhookPageBuildBuildPusherX1a518a30 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPageBuildBuildPusherX1a518a30(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPageBuildBuildPusherX1a518a30 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPageBuildBuildPusherX1a518a30> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPageBuildBuildPusherX1a518a30 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPageBuildBuildPusherX1a518a30")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPageBuildBuildPusherX1a518a30 must be a JSON object")
      ...
      return InlineWebhookPageBuildBuildPusherX1a518a30(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPageBuildBuildPusherTypeX8c76a1c4>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPageBuildBuildPusherX1a518a30) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPageBuildBuildPusherX1a518a30")
...
public fun inlineWebhookPageBuildBuildPusherX1a518a30(block: InlineWebhookPageBuildBuildPusherX1a518a30.Builder.() -> Unit): InlineWebhookPageBuildBuildPusherX1a518a30 = InlineWebhookPageBuildBuildPusherX1a518a30.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPageBuildBuildPusherX1a518a30 is missing required property '" + name + "'")
