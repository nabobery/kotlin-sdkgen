 ...
 * nee
 */
@Serializable(with = InlineWebhookPullRequestLockedPullRequestAssigneeX2d8fd912.Serializer::class)
public class InlineWebhookPullRequestLockedPullRequestAssigneeX2d8fd912(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestLockedPullRequestAssigneeTypeX174a9e0b? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestLockedPullRequestAssigneeTypeX174a9e0b? = null
    ...
    public fun build(): InlineWebhookPullRequestLockedPullRequestAssigneeX2d8fd912 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestLockedPullRequestAssigneeX2d8fd912(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestLockedPullRequestAssigneeX2d8fd912 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestLockedPullRequestAssigneeX2d8fd912> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestLockedPullRequestAssigneeX2d8fd912 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestLockedPullRequestAssigneeX2d8fd912")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestLockedPullRequestAssigneeX2d8fd912 must be a JSON object")
      ...
      return InlineWebhookPullRequestLockedPullRequestAssigneeX2d8fd912(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestLockedPullRequestAssigneeTypeX174a9e0b>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestLockedPullRequestAssigneeX2d8fd912) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestLockedPullRequestAssigneeX2d8fd912")
...
public fun inlineWebhookPullRequestLockedPullRequestAssigneeX2d8fd912(block: InlineWebhookPullRequestLockedPullRequestAssigneeX2d8fd912.Builder.() -> Unit): InlineWebhookPullRequestLockedPullRequestAssigneeX2d8fd912 = InlineWebhookPullRequestLockedPullRequestAssigneeX2d8fd912.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestLockedPullRequestAssigneeX2d8fd912 is missing required property '" + name + "'")
