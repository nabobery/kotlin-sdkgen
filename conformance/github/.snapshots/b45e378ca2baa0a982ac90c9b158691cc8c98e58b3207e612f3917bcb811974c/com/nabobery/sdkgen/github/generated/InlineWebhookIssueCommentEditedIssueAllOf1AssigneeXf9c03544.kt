 ...
 * ignee
 */
@Serializable(with = InlineWebhookIssueCommentEditedIssueAllOf1AssigneeXf9c03544.Serializer::class)
public class InlineWebhookIssueCommentEditedIssueAllOf1AssigneeXf9c03544(
  public val id: Int,
  ...
  public val type: InlineWebhookIssueCommentEditedIssueAllOf1AssigneeTypeXb7ef0bbc? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookIssueCommentEditedIssueAllOf1AssigneeTypeXb7ef0bbc? = null
    ...
    public fun build(): InlineWebhookIssueCommentEditedIssueAllOf1AssigneeXf9c03544 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssueCommentEditedIssueAllOf1AssigneeXf9c03544(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssueCommentEditedIssueAllOf1AssigneeXf9c03544 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssueCommentEditedIssueAllOf1AssigneeXf9c03544> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssueCommentEditedIssueAllOf1AssigneeXf9c03544 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssueCommentEditedIssueAllOf1AssigneeXf9c03544")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssueCommentEditedIssueAllOf1AssigneeXf9c03544 must be a JSON object")
      ...
      return InlineWebhookIssueCommentEditedIssueAllOf1AssigneeXf9c03544(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssueCommentEditedIssueAllOf1AssigneeTypeXb7ef0bbc>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssueCommentEditedIssueAllOf1AssigneeXf9c03544) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssueCommentEditedIssueAllOf1AssigneeXf9c03544")
...
public fun inlineWebhookIssueCommentEditedIssueAllOf1AssigneeXf9c03544(block: InlineWebhookIssueCommentEditedIssueAllOf1AssigneeXf9c03544.Builder.() -> Unit): InlineWebhookIssueCommentEditedIssueAllOf1AssigneeXf9c03544 = InlineWebhookIssueCommentEditedIssueAllOf1AssigneeXf9c03544.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssueCommentEditedIssueAllOf1AssigneeXf9c03544 is missing required property '" + name + "'")
