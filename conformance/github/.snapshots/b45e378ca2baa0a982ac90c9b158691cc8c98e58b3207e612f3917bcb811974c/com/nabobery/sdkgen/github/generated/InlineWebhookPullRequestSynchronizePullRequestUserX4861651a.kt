 ...
 * user
 */
@Serializable(with = InlineWebhookPullRequestSynchronizePullRequestUserX4861651a.Serializer::class)
public class InlineWebhookPullRequestSynchronizePullRequestUserX4861651a(
  public val id: Long,
  ...
  public val type: InlineWebhookPullRequestSynchronizePullRequestUserTypeXf5039f0f? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestSynchronizePullRequestUserTypeXf5039f0f? = null
    ...
    public fun build(): InlineWebhookPullRequestSynchronizePullRequestUserX4861651a {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestSynchronizePullRequestUserX4861651a(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestSynchronizePullRequestUserX4861651a = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestSynchronizePullRequestUserX4861651a> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestSynchronizePullRequestUserX4861651a {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestSynchronizePullRequestUserX4861651a")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestSynchronizePullRequestUserX4861651a must be a JSON object")
      ...
      return InlineWebhookPullRequestSynchronizePullRequestUserX4861651a(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestSynchronizePullRequestUserTypeXf5039f0f>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestSynchronizePullRequestUserX4861651a) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestSynchronizePullRequestUserX4861651a")
...
public fun inlineWebhookPullRequestSynchronizePullRequestUserX4861651a(block: InlineWebhookPullRequestSynchronizePullRequestUserX4861651a.Builder.() -> Unit): InlineWebhookPullRequestSynchronizePullRequestUserX4861651a = InlineWebhookPullRequestSynchronizePullRequestUserX4861651a.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestSynchronizePullRequestUserX4861651a is missing required property '" + name + "'")
