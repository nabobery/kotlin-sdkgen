 ...
 * erties/head/properties/user.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-auto-merge-enabled/properties/pull_request/prop
 * erties/head/properties/user
 */
@Serializable(with = InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadUserX81878ea3.Serializer::class)
public class InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadUserX81878ea3(
  public val id: Long,
  ...
  public val type: InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadUserTypeX0d74d399? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadUserTypeX0d74d399? =
        null
    ...
    public fun build(): InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadUserX81878ea3 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadUserX81878ea3(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadUserX81878ea3 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadUserX81878ea3> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadUserX81878ea3 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadUserX81878ea3")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadUserX81878ea3 must be a JSON object")
      ...
      return InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadUserX81878ea3(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadUserTypeX0d74d399>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadUserX81878ea3) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadUserX81878ea3")
...
public fun inlineWebhookPullRequestAutoMergeEnabledPullRequestHeadUserX81878ea3(block: InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadUserX81878ea3.Builder.() -> Unit): InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadUserX81878ea3 = InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadUserX81878ea3.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestAutoMergeEnabledPullRequestHeadUserX81878ea3 is missing required property '" + name + "'")
