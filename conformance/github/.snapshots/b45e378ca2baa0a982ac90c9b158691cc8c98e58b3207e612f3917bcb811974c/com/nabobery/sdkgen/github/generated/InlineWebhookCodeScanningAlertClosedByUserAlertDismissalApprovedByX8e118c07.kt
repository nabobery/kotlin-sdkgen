 ...
 * es/dismissal_approved_by.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-code-scanning-alert-closed-by-user/properties/alert/properti
 * es/dismissal_approved_by
 */
@Serializable(with = InlineWebhookCodeScanningAlertClosedByUserAlertDismissalApprovedByX8e118c07.Serializer::class)
public class InlineWebhookCodeScanningAlertClosedByUserAlertDismissalApprovedByX8e118c07(
  public val id: Int,
  ...
  public val type:
      InlineWebhookCodeScanningAlertClosedByUserAlertDismissalApprovedByTypeX6b1f1ac1? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public fun build(): InlineWebhookCodeScanningAlertClosedByUserAlertDismissalApprovedByX8e118c07 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookCodeScanningAlertClosedByUserAlertDismissalApprovedByX8e118c07(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookCodeScanningAlertClosedByUserAlertDismissalApprovedByX8e118c07 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookCodeScanningAlertClosedByUserAlertDismissalApprovedByX8e118c07> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookCodeScanningAlertClosedByUserAlertDismissalApprovedByX8e118c07 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookCodeScanningAlertClosedByUserAlertDismissalApprovedByX8e118c07")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookCodeScanningAlertClosedByUserAlertDismissalApprovedByX8e118c07 must be a JSON object")
      ...
      return InlineWebhookCodeScanningAlertClosedByUserAlertDismissalApprovedByX8e118c07(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookCodeScanningAlertClosedByUserAlertDismissalApprovedByTypeX6b1f1ac1>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookCodeScanningAlertClosedByUserAlertDismissalApprovedByX8e118c07) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookCodeScanningAlertClosedByUserAlertDismissalApprovedByX8e118c07")
...
public fun inlineWebhookCodeScanningAlertClosedByUserAlertDismissalApprovedByX8e118c07(block: InlineWebhookCodeScanningAlertClosedByUserAlertDismissalApprovedByX8e118c07.Builder.() -> Unit): InlineWebhookCodeScanningAlertClosedByUserAlertDismissalApprovedByX8e118c07 = InlineWebhookCodeScanningAlertClosedByUserAlertDismissalApprovedByX8e118c07.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookCodeScanningAlertClosedByUserAlertDismissalApprovedByX8e118c07 is missing required property '" + name + "'")
