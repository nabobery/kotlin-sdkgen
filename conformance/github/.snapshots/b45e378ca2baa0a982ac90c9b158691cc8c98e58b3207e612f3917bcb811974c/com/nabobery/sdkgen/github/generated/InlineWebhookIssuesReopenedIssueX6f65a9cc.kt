 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-reopened/properties/issue
 */
@Serializable(with = InlineWebhookIssuesReopenedIssueX6f65a9cc.Serializer::class)
public class InlineWebhookIssuesReopenedIssueX6f65a9cc internal constructor(
  public val activeLockReason: InlineWebhookIssuesReopenedIssueActiveLockReasonXd60e4175?,
  assignees: List<InlineWebhookIssuesReopenedIssueAssigneesItemXd186e203?>,
  /**
   * How the author is associated with the repository.
   */
  public val authorAssociation: InlineWebhookIssuesReopenedIssueAuthorAssociationXd7cc458e,
  /**
   ...
   */
  public val milestone: InlineWebhookIssuesReopenedIssueMilestoneXf1d091d1?,
  public val nodeId: String,
  public val number: Int,
  public val reactions: InlineWebhookIssuesReopenedIssueReactionsX6e90bd51,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
   ...
   */
  public val state: InlineWebhookIssuesReopenedIssueStateXaab1434a,
  /**
   * Title of the issue
   */
  ...
  public val user: InlineWebhookIssuesReopenedIssueUserXc96519ba?,
  private val assigneeState: FieldState<InlineWebhookIssuesReopenedIssueAssigneeX9bc99275?>,
  ...
  labelsState: FieldState<List<InlineWebhookIssuesReopenedIssueLabelsItemX25e35b5a?>>,
  private val lockedState: FieldState<Boolean>,
  private val performedViaGithubAppState:
      FieldState<InlineWebhookIssuesReopenedIssuePerformedViaGithubAppX71f47702?>,
  private val pinnedCommentState: FieldState<NullableIssueComment?>,
  private val pullRequestState: FieldState<InlineWebhookIssuesReopenedIssuePullRequestX795a2267>,
  ...
  public val assignees: List<InlineWebhookIssuesReopenedIssueAssigneesItemXd186e203?> =
      assignees.toList()
  ...
  private val labelsState: FieldState<List<InlineWebhookIssuesReopenedIssueLabelsItemX25e35b5a?>> =
      labelsState.copyValue { fieldValue -> fieldValue.toList() }

  public val assignee: InlineWebhookIssuesReopenedIssueAssigneeX9bc99275?
  ...
  public val labels: List<InlineWebhookIssuesReopenedIssueLabelsItemX25e35b5a?>?
   ...
   */
  public val performedViaGithubApp: InlineWebhookIssuesReopenedIssuePerformedViaGithubAppX71f47702?
  ...
  public val pullRequest: InlineWebhookIssuesReopenedIssuePullRequestX795a2267?
  ...
  public constructor(
    activeLockReason: InlineWebhookIssuesReopenedIssueActiveLockReasonXd60e4175?,
    assignees: List<InlineWebhookIssuesReopenedIssueAssigneesItemXd186e203?>,
    authorAssociation: InlineWebhookIssuesReopenedIssueAuthorAssociationXd7cc458e,
    body: String?,
    closedAt: String?,
    comments: Int,
    commentsUrl: String,
    ...
    id: Long,
    labelsUrl: String,
    milestone: InlineWebhookIssuesReopenedIssueMilestoneXf1d091d1?,
    nodeId: String,
    number: Int,
    reactions: InlineWebhookIssuesReopenedIssueReactionsX6e90bd51,
    repositoryUrl: String,
    state: InlineWebhookIssuesReopenedIssueStateXaab1434a,
    title: String,
    updatedAt: String,
    url: String,
    user: InlineWebhookIssuesReopenedIssueUserXc96519ba?,
  ...
  public class Builder {
    private var assigneesValue: List<InlineWebhookIssuesReopenedIssueAssigneesItemXd186e203?>? =
        null

    public var assignees: List<InlineWebhookIssuesReopenedIssueAssigneesItemXd186e203?>
      get() = requireNotNull(assigneesValue) { "assignees is required" }.toList()
      set(`value`) {
        assigneesValue = value.toList()
      }

    private var authorAssociationValue: InlineWebhookIssuesReopenedIssueAuthorAssociationXd7cc458e?
        = null

    public var authorAssociation: InlineWebhookIssuesReopenedIssueAuthorAssociationXd7cc458e
    ...
    private var reactionsValue: InlineWebhookIssuesReopenedIssueReactionsX6e90bd51? = null

    public var reactions: InlineWebhookIssuesReopenedIssueReactionsX6e90bd51
    ...
    private var stateValue: InlineWebhookIssuesReopenedIssueStateXaab1434a? = null

    public var state: InlineWebhookIssuesReopenedIssueStateXaab1434a
    ...
    private var activeLockReasonState:
        FieldState<InlineWebhookIssuesReopenedIssueActiveLockReasonXd60e4175?> = FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var activeLockReason: InlineWebhookIssuesReopenedIssueActiveLockReasonXd60e4175?
    ...
    private var milestoneState: FieldState<InlineWebhookIssuesReopenedIssueMilestoneXf1d091d1?> =
        FieldState.Absent
     ...
     * Required nullable field; assigning `null` records present-null.
     */
    public var milestone: InlineWebhookIssuesReopenedIssueMilestoneXf1d091d1?
      get() = milestoneState.valueOrNull()
      set(`value`) {
        milestoneState = value.toNullableFieldState()
      }

    private var userState: FieldState<InlineWebhookIssuesReopenedIssueUserXc96519ba?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var user: InlineWebhookIssuesReopenedIssueUserXc96519ba?
      get() = userState.valueOrNull()
      set(`value`) {
        userState = value.toNullableFieldState()
      }

    private var assigneeState: FieldState<InlineWebhookIssuesReopenedIssueAssigneeX9bc99275?> =
        FieldState.Absent

    /**
     * Assigning `null` records present-null; use the unset function to omit the property.
     */
    public var assignee: InlineWebhookIssuesReopenedIssueAssigneeX9bc99275?
      get() = assigneeState.valueOrNull()
      set(`value`) {
    ...
    private var labelsState: FieldState<List<InlineWebhookIssuesReopenedIssueLabelsItemX25e35b5a?>>
        = FieldState.Absent

    /**
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var labels: List<InlineWebhookIssuesReopenedIssueLabelsItemX25e35b5a?>?
    ...
    public var performedViaGithubApp:
        InlineWebhookIssuesReopenedIssuePerformedViaGithubAppX71f47702?
      get() = performedViaGithubAppState.valueOrNull()
      set(`value`) {
    ...
    private var pullRequestState: FieldState<InlineWebhookIssuesReopenedIssuePullRequestX795a2267> =
        FieldState.Absent

    /**
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var pullRequest: InlineWebhookIssuesReopenedIssuePullRequestX795a2267?
      get() = pullRequestState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): InlineWebhookIssuesReopenedIssueX6f65a9cc {
      ...
      return InlineWebhookIssuesReopenedIssueX6f65a9cc(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesReopenedIssueX6f65a9cc = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesReopenedIssueX6f65a9cc> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesReopenedIssueX6f65a9cc {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesReopenedIssueX6f65a9cc")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesReopenedIssueX6f65a9cc must be a JSON object")
      val assignees = json.decodeRequired<List<InlineWebhookIssuesReopenedIssueAssigneesItemXd186e203?>>(rawObject, "assignees")
      val authorAssociation = json.decodeRequired<InlineWebhookIssuesReopenedIssueAuthorAssociationXd7cc458e>(rawObject, "author_association")
      ...
      val reactions = json.decodeRequired<InlineWebhookIssuesReopenedIssueReactionsX6e90bd51>(rawObject, "reactions")
      val repositoryUrl = json.decodeRequired<String>(rawObject, "repository_url")
      val state = json.decodeRequired<InlineWebhookIssuesReopenedIssueStateXaab1434a>(rawObject, "state")
      val title = json.decodeRequired<String>(rawObject, "title")
      val updatedAt = json.decodeRequired<String>(rawObject, "updated_at")
      val url = json.decodeRequired<String>(rawObject, "url")
      if (!rawObject.containsKey("active_lock_reason")) {
        throw SerializationException("InlineWebhookIssuesReopenedIssueX6f65a9cc is missing required property 'active_lock_reason'")
      }
      val activeLockReason = rawObject["active_lock_reason"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookIssuesReopenedIssueActiveLockReasonXd60e4175?>(requireNotNull(element)) }
      if (!rawObject.containsKey("body")) {
        throw SerializationException("InlineWebhookIssuesReopenedIssueX6f65a9cc is missing required property 'body'")
      }
      ...
      if (!rawObject.containsKey("closed_at")) {
        throw SerializationException("InlineWebhookIssuesReopenedIssueX6f65a9cc is missing required property 'closed_at'")
      }
      ...
      if (!rawObject.containsKey("milestone")) {
        throw SerializationException("InlineWebhookIssuesReopenedIssueX6f65a9cc is missing required property 'milestone'")
      }
      val milestone = rawObject["milestone"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookIssuesReopenedIssueMilestoneXf1d091d1?>(requireNotNull(element)) }
      if (!rawObject.containsKey("user")) {
        throw SerializationException("InlineWebhookIssuesReopenedIssueX6f65a9cc is missing required property 'user'")
      }
      val user = rawObject["user"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookIssuesReopenedIssueUserXc96519ba?>(requireNotNull(element)) }
      return InlineWebhookIssuesReopenedIssueX6f65a9cc(
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesReopenedIssueX6f65a9cc) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesReopenedIssueX6f65a9cc")
...
public fun inlineWebhookIssuesReopenedIssueX6f65a9cc(block: InlineWebhookIssuesReopenedIssueX6f65a9cc.Builder.() -> Unit): InlineWebhookIssuesReopenedIssueX6f65a9cc = InlineWebhookIssuesReopenedIssueX6f65a9cc.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesReopenedIssueX6f65a9cc is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookIssuesReopenedIssueX6f65a9cc property '" + name + "' is not nullable")
