...
@Serializable
public data class AddedToProjectIssueEventView(
  ...
  public val projectCard: InlineAddedToProjectIssueEventProjectCardXed387057? = null,
 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/added-to-project-issue-event
 */
@Serializable(with = AddedToProjectIssueEvent.Serializer::class)
public class AddedToProjectIssueEvent internal constructor(
  public val actor: SimpleUser,
  public val commitId: String?,
  public val commitUrl: String?,
  public val createdAt: String,
  ...
  public val performedViaGithubApp: NullableIntegration?,
  public val url: String,
  private val projectCardState: FieldState<InlineAddedToProjectIssueEventProjectCardXed387057>,
) {
  public val projectCard: InlineAddedToProjectIssueEventProjectCardXed387057?
  ...
  public class Builder {
    ...
    private var projectCardState: FieldState<InlineAddedToProjectIssueEventProjectCardXed387057> =
        FieldState.Absent

    /**
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var projectCard: InlineAddedToProjectIssueEventProjectCardXed387057?
      get() = projectCardState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): AddedToProjectIssueEvent {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): AddedToProjectIssueEvent = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<AddedToProjectIssueEvent> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): AddedToProjectIssueEvent {
      val jsonDecoder = decoder.requireJsonDecoder("AddedToProjectIssueEvent")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("AddedToProjectIssueEvent must be a JSON object")
      ...
      if (!rawObject.containsKey("commit_id")) {
        throw SerializationException("AddedToProjectIssueEvent is missing required property 'commit_id'")
      }
      ...
      if (!rawObject.containsKey("commit_url")) {
        throw SerializationException("AddedToProjectIssueEvent is missing required property 'commit_url'")
      }
      ...
      if (!rawObject.containsKey("performed_via_github_app")) {
        throw SerializationException("AddedToProjectIssueEvent is missing required property 'performed_via_github_app'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: AddedToProjectIssueEvent) {
      val jsonEncoder = encoder.requireJsonEncoder("AddedToProjectIssueEvent")
...
public fun addedToProjectIssueEvent(block: AddedToProjectIssueEvent.Builder.() -> Unit): AddedToProjectIssueEvent = AddedToProjectIssueEvent.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("AddedToProjectIssueEvent is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("AddedToProjectIssueEvent property '" + name + "' is not nullable")
