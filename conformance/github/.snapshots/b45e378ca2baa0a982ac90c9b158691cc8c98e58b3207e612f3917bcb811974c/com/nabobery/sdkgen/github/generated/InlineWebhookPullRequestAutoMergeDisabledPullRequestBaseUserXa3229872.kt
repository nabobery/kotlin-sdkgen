 ...
 * perties/base/properties/user.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-auto-merge-disabled/properties/pull_request/pro
 * perties/base/properties/user
 */
@Serializable(with = InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseUserXa3229872.Serializer::class)
public class InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseUserXa3229872(
  public val id: Long,
  ...
  public val type:
      InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseUserTypeX6b839e45? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseUserTypeX6b839e45? =
        null
    ...
    public fun build(): InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseUserXa3229872 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseUserXa3229872(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseUserXa3229872 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseUserXa3229872> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseUserXa3229872 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseUserXa3229872")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseUserXa3229872 must be a JSON object")
      ...
      return InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseUserXa3229872(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseUserTypeX6b839e45>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseUserXa3229872) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseUserXa3229872")
...
public fun inlineWebhookPullRequestAutoMergeDisabledPullRequestBaseUserXa3229872(block: InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseUserXa3229872.Builder.() -> Unit): InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseUserXa3229872 = InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseUserXa3229872.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseUserXa3229872 is missing required property '" + name + "'")
