 ...
 * properties/requested_reviewers/items/oneOf/0.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-review-comment-created/properties/pull_request/
 * properties/requested_reviewers/items/oneOf/0
 */
@Serializable(with = InlineWebhookPullRequestRe0d91PullRequestRequestedReviewersItemOneOf1X57e8be1a.Serializer::class)
public class InlineWebhookPullRequestRe0d91PullRequestRequestedReviewersItemOneOf1X57e8be1a(
  public val id: Int,
  ...
  public val type:
      InlineWebhookPullRequestRe0d91PullRequestRequestedReviewersItemTypeX7c1eb16b? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestRe0d91PullRequestRequestedReviewersItemTypeX7c1eb16b? =
        null
    ...
    public fun build(): InlineWebhookPullRequestRe0d91PullRequestRequestedReviewersItemOneOf1X57e8be1a {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestRe0d91PullRequestRequestedReviewersItemOneOf1X57e8be1a = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestRe0d91PullRequestRequestedReviewersItemOneOf1X57e8be1a> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestRe0d91PullRequestRequestedReviewersItemOneOf1X57e8be1a {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestRe0d91PullRequestRequestedReviewersItemOneOf1X57e8be1a")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestRe0d91PullRequestRequestedReviewersItemOneOf1X57e8be1a must be a JSON object")
      ...
      return InlineWebhookPullRequestRe0d91PullRequestRequestedReviewersItemOneOf1X57e8be1a(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestRe0d91PullRequestRequestedReviewersItemTypeX7c1eb16b>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestRe0d91PullRequestRequestedReviewersItemOneOf1X57e8be1a) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestRe0d91PullRequestRequestedReviewersItemOneOf1X57e8be1a")
...
public fun inlineWebhookPullRequestRe0d91PullRequestRequestedReviewersItemOneOf1X57e8be1a(block: InlineWebhookPullRequestRe0d91PullRequestRequestedReviewersItemOneOf1X57e8be1a.Builder.() -> Unit): InlineWebhookPullRequestRe0d91PullRequestRequestedReviewersItemOneOf1X57e8be1a = InlineWebhookPullRequestRe0d91PullRequestRequestedReviewersItemOneOf1X57e8be1a.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestRe0d91PullRequestRequestedReviewersItemOneOf1X57e8be1a is missing required property '" + name + "'")
