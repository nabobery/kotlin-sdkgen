 ...
 * equested_reviewers/items/oneOf/0.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-unassigned/properties/pull_request/properties/r
 * equested_reviewers/items/oneOf/0
 */
@Serializable(with = InlineWebhookPullRequestUn16b6PullRequestRequestedReviewersItemOneOf1Xf05decd7.Serializer::class)
public class InlineWebhookPullRequestUn16b6PullRequestRequestedReviewersItemOneOf1Xf05decd7(
  public val id: Int,
  ...
  public val type:
      InlineWebhookPullRequestUn16b6PullRequestRequestedReviewersItemTypeX7c4387f4? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestUn16b6PullRequestRequestedReviewersItemTypeX7c4387f4? =
        null
    ...
    public fun build(): InlineWebhookPullRequestUn16b6PullRequestRequestedReviewersItemOneOf1Xf05decd7 {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestUn16b6PullRequestRequestedReviewersItemOneOf1Xf05decd7 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestUn16b6PullRequestRequestedReviewersItemOneOf1Xf05decd7> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestUn16b6PullRequestRequestedReviewersItemOneOf1Xf05decd7 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestUn16b6PullRequestRequestedReviewersItemOneOf1Xf05decd7")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestUn16b6PullRequestRequestedReviewersItemOneOf1Xf05decd7 must be a JSON object")
      ...
      return InlineWebhookPullRequestUn16b6PullRequestRequestedReviewersItemOneOf1Xf05decd7(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestUn16b6PullRequestRequestedReviewersItemTypeX7c4387f4>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestUn16b6PullRequestRequestedReviewersItemOneOf1Xf05decd7) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestUn16b6PullRequestRequestedReviewersItemOneOf1Xf05decd7")
...
public fun inlineWebhookPullRequestUn16b6PullRequestRequestedReviewersItemOneOf1Xf05decd7(block: InlineWebhookPullRequestUn16b6PullRequestRequestedReviewersItemOneOf1Xf05decd7.Builder.() -> Unit): InlineWebhookPullRequestUn16b6PullRequestRequestedReviewersItemOneOf1Xf05decd7 = InlineWebhookPullRequestUn16b6PullRequestRequestedReviewersItemOneOf1Xf05decd7.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestUn16b6PullRequestRequestedReviewersItemOneOf1Xf05decd7 is missing required property '" + name + "'")
