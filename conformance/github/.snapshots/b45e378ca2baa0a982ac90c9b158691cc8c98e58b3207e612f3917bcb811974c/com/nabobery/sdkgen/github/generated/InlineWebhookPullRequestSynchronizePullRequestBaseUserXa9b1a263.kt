 ...
 * base/properties/user
 */
@Serializable(with = InlineWebhookPullRequestSynchronizePullRequestBaseUserXa9b1a263.Serializer::class)
public class InlineWebhookPullRequestSynchronizePullRequestBaseUserXa9b1a263(
  public val id: Long,
  ...
  public val type: InlineWebhookPullRequestSynchronizePullRequestBaseUserTypeX31ce2ca0? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestSynchronizePullRequestBaseUserTypeX31ce2ca0? = null
    ...
    public fun build(): InlineWebhookPullRequestSynchronizePullRequestBaseUserXa9b1a263 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestSynchronizePullRequestBaseUserXa9b1a263(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestSynchronizePullRequestBaseUserXa9b1a263 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestSynchronizePullRequestBaseUserXa9b1a263> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestSynchronizePullRequestBaseUserXa9b1a263 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestSynchronizePullRequestBaseUserXa9b1a263")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestSynchronizePullRequestBaseUserXa9b1a263 must be a JSON object")
      ...
      return InlineWebhookPullRequestSynchronizePullRequestBaseUserXa9b1a263(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestSynchronizePullRequestBaseUserTypeX31ce2ca0>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestSynchronizePullRequestBaseUserXa9b1a263) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestSynchronizePullRequestBaseUserXa9b1a263")
...
public fun inlineWebhookPullRequestSynchronizePullRequestBaseUserXa9b1a263(block: InlineWebhookPullRequestSynchronizePullRequestBaseUserXa9b1a263.Builder.() -> Unit): InlineWebhookPullRequestSynchronizePullRequestBaseUserXa9b1a263 = InlineWebhookPullRequestSynchronizePullRequestBaseUserXa9b1a263.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestSynchronizePullRequestBaseUserXa9b1a263 is missing required property '" + name + "'")
