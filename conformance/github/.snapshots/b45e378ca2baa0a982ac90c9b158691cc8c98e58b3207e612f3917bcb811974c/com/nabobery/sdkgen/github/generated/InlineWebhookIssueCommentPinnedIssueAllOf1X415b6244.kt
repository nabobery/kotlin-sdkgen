 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhook-issue-comment-pinned/properties/issue/allOf/0
 */
@Serializable(with = InlineWebhookIssueCommentPinnedIssueAllOf1X415b6244.Serializer::class)
public class InlineWebhookIssueCommentPinnedIssueAllOf1X415b6244 internal constructor(
  ...
  public val user: InlineWebhookIssueCommentPinnedIssueAllOf1UserX95ea864b?,
  private val assigneeState:
      FieldState<InlineWebhookIssueCommentPinnedIssueAllOf1AssigneeXee83456a?>,
  private val draftState: FieldState<Boolean>,
  private val issueDependenciesSummaryState: FieldState<IssueDependenciesSummary>,
  labelsState: FieldState<List<InlineWebhookIssueCommentPinnedIssueAllOf1LabelsItemXd67d7e3f>>,
  ...
  private val stateState: FieldState<InlineWebhookIssueCommentPinnedIssueAllOf1StateX77e4c853>,
  ...
  private val labelsState:
      FieldState<List<InlineWebhookIssueCommentPinnedIssueAllOf1LabelsItemXd67d7e3f>> =
      labelsState.copyValue { fieldValue -> fieldValue.toList() }

  public val assignee: InlineWebhookIssueCommentPinnedIssueAllOf1AssigneeXee83456a?
  ...
  public constructor(
    ...
    updatedAt: String,
    url: String,
    user: InlineWebhookIssueCommentPinnedIssueAllOf1UserX95ea864b?,
  ...
  public class Builder {
    ...
    private var userState: FieldState<InlineWebhookIssueCommentPinnedIssueAllOf1UserX95ea864b?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var user: InlineWebhookIssueCommentPinnedIssueAllOf1UserX95ea864b?
    ...
    private var assigneeState:
        FieldState<InlineWebhookIssueCommentPinnedIssueAllOf1AssigneeXee83456a?> = FieldState.Absent

    /**
     * Assigning `null` records present-null; use the unset function to omit the property.
     */
    public var assignee: InlineWebhookIssueCommentPinnedIssueAllOf1AssigneeXee83456a?
      get() = assigneeState.valueOrNull()
      set(`value`) {
    ...
    private var stateState: FieldState<InlineWebhookIssueCommentPinnedIssueAllOf1StateX77e4c853> =
        FieldState.Absent
    ...
    public fun build(): InlineWebhookIssueCommentPinnedIssueAllOf1X415b6244 {
      ...
      return InlineWebhookIssueCommentPinnedIssueAllOf1X415b6244(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssueCommentPinnedIssueAllOf1X415b6244 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssueCommentPinnedIssueAllOf1X415b6244> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssueCommentPinnedIssueAllOf1X415b6244 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssueCommentPinnedIssueAllOf1X415b6244")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssueCommentPinnedIssueAllOf1X415b6244 must be a JSON object")
      ...
      if (!rawObject.containsKey("active_lock_reason")) {
        throw SerializationException("InlineWebhookIssueCommentPinnedIssueAllOf1X415b6244 is missing required property 'active_lock_reason'")
      }
      ...
      if (!rawObject.containsKey("body")) {
        throw SerializationException("InlineWebhookIssueCommentPinnedIssueAllOf1X415b6244 is missing required property 'body'")
      }
      ...
      if (!rawObject.containsKey("closed_at")) {
        throw SerializationException("InlineWebhookIssueCommentPinnedIssueAllOf1X415b6244 is missing required property 'closed_at'")
      }
      ...
      if (!rawObject.containsKey("milestone")) {
        throw SerializationException("InlineWebhookIssueCommentPinnedIssueAllOf1X415b6244 is missing required property 'milestone'")
      }
      ...
      if (!rawObject.containsKey("user")) {
        throw SerializationException("InlineWebhookIssueCommentPinnedIssueAllOf1X415b6244 is missing required property 'user'")
      }
      val user = rawObject["user"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookIssueCommentPinnedIssueAllOf1UserX95ea864b?>(requireNotNull(element)) }
      return InlineWebhookIssueCommentPinnedIssueAllOf1X415b6244(
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssueCommentPinnedIssueAllOf1X415b6244) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssueCommentPinnedIssueAllOf1X415b6244")
...
public fun inlineWebhookIssueCommentPinnedIssueAllOf1X415b6244(block: InlineWebhookIssueCommentPinnedIssueAllOf1X415b6244.Builder.() -> Unit): InlineWebhookIssueCommentPinnedIssueAllOf1X415b6244 = InlineWebhookIssueCommentPinnedIssueAllOf1X415b6244.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssueCommentPinnedIssueAllOf1X415b6244 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookIssueCommentPinnedIssueAllOf1X415b6244 property '" + name + "' is not nullable")
