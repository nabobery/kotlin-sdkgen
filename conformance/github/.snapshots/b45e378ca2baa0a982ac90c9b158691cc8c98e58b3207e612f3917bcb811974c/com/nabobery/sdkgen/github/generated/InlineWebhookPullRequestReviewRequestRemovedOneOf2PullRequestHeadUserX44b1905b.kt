 ...
 * request/properties/head/properties/user
 */
@Serializable(with = InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestHeadUserX44b1905b.Serializer::class)
public class InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestHeadUserX44b1905b(
  public val id: Long,
  ...
  public val type: InlineWebhookPullRequestReacd1OneOf2PullRequestHeadUserTypeX277facc2? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestReacd1OneOf2PullRequestHeadUserTypeX277facc2? = null
    ...
    public fun build(): InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestHeadUserX44b1905b {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestHeadUserX44b1905b(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestHeadUserX44b1905b = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestHeadUserX44b1905b> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestHeadUserX44b1905b {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestHeadUserX44b1905b")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestHeadUserX44b1905b must be a JSON object")
      ...
      return InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestHeadUserX44b1905b(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestReacd1OneOf2PullRequestHeadUserTypeX277facc2>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestHeadUserX44b1905b) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestHeadUserX44b1905b")
...
public fun inlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestHeadUserX44b1905b(block: InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestHeadUserX44b1905b.Builder.() -> Unit): InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestHeadUserX44b1905b = InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestHeadUserX44b1905b.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestHeadUserX44b1905b is missing required property '" + name + "'")
