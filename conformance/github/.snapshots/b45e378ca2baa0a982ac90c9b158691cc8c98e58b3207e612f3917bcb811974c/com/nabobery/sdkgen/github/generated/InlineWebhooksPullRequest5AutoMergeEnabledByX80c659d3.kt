 ...
 * sdkgen://source/openapi.yaml#/components/schemas/webhooks_pull_request_5/properties/auto_merge/properties/enabled_by
 */
@Serializable(with = InlineWebhooksPullRequest5AutoMergeEnabledByX80c659d3.Serializer::class)
public class InlineWebhooksPullRequest5AutoMergeEnabledByX80c659d3(
  public val id: Int,
  ...
  public val type: InlineWebhooksPullRequest5AutoMergeEnabledByTypeXae535fe7? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhooksPullRequest5AutoMergeEnabledByTypeXae535fe7? = null
    ...
    public fun build(): InlineWebhooksPullRequest5AutoMergeEnabledByX80c659d3 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhooksPullRequest5AutoMergeEnabledByX80c659d3(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhooksPullRequest5AutoMergeEnabledByX80c659d3 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhooksPullRequest5AutoMergeEnabledByX80c659d3> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhooksPullRequest5AutoMergeEnabledByX80c659d3 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhooksPullRequest5AutoMergeEnabledByX80c659d3")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhooksPullRequest5AutoMergeEnabledByX80c659d3 must be a JSON object")
      ...
      return InlineWebhooksPullRequest5AutoMergeEnabledByX80c659d3(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhooksPullRequest5AutoMergeEnabledByTypeXae535fe7>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhooksPullRequest5AutoMergeEnabledByX80c659d3) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhooksPullRequest5AutoMergeEnabledByX80c659d3")
...
public fun inlineWebhooksPullRequest5AutoMergeEnabledByX80c659d3(block: InlineWebhooksPullRequest5AutoMergeEnabledByX80c659d3.Builder.() -> Unit): InlineWebhooksPullRequest5AutoMergeEnabledByX80c659d3 = InlineWebhooksPullRequest5AutoMergeEnabledByX80c659d3.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhooksPullRequest5AutoMergeEnabledByX80c659d3 is missing required property '" + name + "'")
