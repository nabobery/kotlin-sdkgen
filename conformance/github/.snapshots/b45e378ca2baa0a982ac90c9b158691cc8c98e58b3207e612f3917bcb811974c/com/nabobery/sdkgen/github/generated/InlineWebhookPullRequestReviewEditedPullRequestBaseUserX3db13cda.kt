 ...
 * s/base/properties/user.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-review-edited/properties/pull_request/propertie
 * s/base/properties/user
 */
@Serializable(with = InlineWebhookPullRequestReviewEditedPullRequestBaseUserX3db13cda.Serializer::class)
public class InlineWebhookPullRequestReviewEditedPullRequestBaseUserX3db13cda(
  public val id: Long,
  ...
  public val type: InlineWebhookPullRequestReviewEditedPullRequestBaseUserTypeXc8cff911? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestReviewEditedPullRequestBaseUserTypeXc8cff911? = null
    ...
    public fun build(): InlineWebhookPullRequestReviewEditedPullRequestBaseUserX3db13cda {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestReviewEditedPullRequestBaseUserX3db13cda(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewEditedPullRequestBaseUserX3db13cda = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewEditedPullRequestBaseUserX3db13cda> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewEditedPullRequestBaseUserX3db13cda {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewEditedPullRequestBaseUserX3db13cda")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewEditedPullRequestBaseUserX3db13cda must be a JSON object")
      ...
      return InlineWebhookPullRequestReviewEditedPullRequestBaseUserX3db13cda(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestReviewEditedPullRequestBaseUserTypeXc8cff911>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewEditedPullRequestBaseUserX3db13cda) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewEditedPullRequestBaseUserX3db13cda")
...
public fun inlineWebhookPullRequestReviewEditedPullRequestBaseUserX3db13cda(block: InlineWebhookPullRequestReviewEditedPullRequestBaseUserX3db13cda.Builder.() -> Unit): InlineWebhookPullRequestReviewEditedPullRequestBaseUserX3db13cda = InlineWebhookPullRequestReviewEditedPullRequestBaseUserX3db13cda.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewEditedPullRequestBaseUserX3db13cda is missing required property '" + name + "'")
