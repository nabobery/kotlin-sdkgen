 ...
 * s/head_repository
 */
@Serializable(with = InlineWebhookDeploymentReviewApprovedWorkflowRunHeadRepositoryX7217a158.Serializer::class)
public class InlineWebhookDeploymentReviewApprovedWorkflowRunHeadRepositoryX7217a158(
  ...
  public val owner:
      InlineWebhookDeploymentReviewApprovedWorkflowRunHeadRepositoryOwnerX7b87e152? = null,
  ...
  public class Builder {
    ...
    public var owner: InlineWebhookDeploymentReviewApprovedWorkflowRunHeadRepositoryOwnerX7b87e152?
        = null
    ...
    public fun build(): InlineWebhookDeploymentReviewApprovedWorkflowRunHeadRepositoryX7217a158 = InlineWebhookDeploymentReviewApprovedWorkflowRunHeadRepositoryX7217a158(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookDeploymentReviewApprovedWorkflowRunHeadRepositoryX7217a158 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookDeploymentReviewApprovedWorkflowRunHeadRepositoryX7217a158> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookDeploymentReviewApprovedWorkflowRunHeadRepositoryX7217a158 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookDeploymentReviewApprovedWorkflowRunHeadRepositoryX7217a158")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookDeploymentReviewApprovedWorkflowRunHeadRepositoryX7217a158 must be a JSON object")
      return InlineWebhookDeploymentReviewApprovedWorkflowRunHeadRepositoryX7217a158(
        ...
        owner = rawObject["owner"]?.let { json.decodeFromJsonElement<InlineWebhookDeploymentReviewApprovedWorkflowRunHeadRepositoryOwnerX7b87e152>(it) },
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookDeploymentReviewApprovedWorkflowRunHeadRepositoryX7217a158) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookDeploymentReviewApprovedWorkflowRunHeadRepositoryX7217a158")
...
public fun inlineWebhookDeploymentReviewApprovedWorkflowRunHeadRepositoryX7217a158(block: InlineWebhookDeploymentReviewApprovedWorkflowRunHeadRepositoryX7217a158.Builder.() -> Unit): InlineWebhookDeploymentReviewApprovedWorkflowRunHeadRepositoryX7217a158 = InlineWebhookDeploymentReviewApprovedWorkflowRunHeadRepositoryX7217a158.build(block)
