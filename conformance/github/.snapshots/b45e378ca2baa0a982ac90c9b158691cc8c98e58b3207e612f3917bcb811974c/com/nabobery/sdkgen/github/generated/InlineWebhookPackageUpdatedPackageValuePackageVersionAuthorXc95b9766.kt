 ...
 * n/properties/author
 */
@Serializable(with = InlineWebhookPackageUpdatedPackageValuePackageVersionAuthorXc95b9766.Serializer::class)
public class InlineWebhookPackageUpdatedPackageValuePackageVersionAuthorXc95b9766(
  public val id: Int,
  ...
  public val type: InlineWebhookPackageUpdatedPackageValuePackageVersionAuthorTypeXf96d5005? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPackageUpdatedPackageValuePackageVersionAuthorTypeXf96d5005? =
        null
    ...
    public fun build(): InlineWebhookPackageUpdatedPackageValuePackageVersionAuthorXc95b9766 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPackageUpdatedPackageValuePackageVersionAuthorXc95b9766(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPackageUpdatedPackageValuePackageVersionAuthorXc95b9766 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPackageUpdatedPackageValuePackageVersionAuthorXc95b9766> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPackageUpdatedPackageValuePackageVersionAuthorXc95b9766 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPackageUpdatedPackageValuePackageVersionAuthorXc95b9766")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPackageUpdatedPackageValuePackageVersionAuthorXc95b9766 must be a JSON object")
      ...
      return InlineWebhookPackageUpdatedPackageValuePackageVersionAuthorXc95b9766(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPackageUpdatedPackageValuePackageVersionAuthorTypeXf96d5005>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPackageUpdatedPackageValuePackageVersionAuthorXc95b9766) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPackageUpdatedPackageValuePackageVersionAuthorXc95b9766")
...
public fun inlineWebhookPackageUpdatedPackageValuePackageVersionAuthorXc95b9766(block: InlineWebhookPackageUpdatedPackageValuePackageVersionAuthorXc95b9766.Builder.() -> Unit): InlineWebhookPackageUpdatedPackageValuePackageVersionAuthorXc95b9766 = InlineWebhookPackageUpdatedPackageValuePackageVersionAuthorXc95b9766.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPackageUpdatedPackageValuePackageVersionAuthorXc95b9766 is missing required property '" + name + "'")
