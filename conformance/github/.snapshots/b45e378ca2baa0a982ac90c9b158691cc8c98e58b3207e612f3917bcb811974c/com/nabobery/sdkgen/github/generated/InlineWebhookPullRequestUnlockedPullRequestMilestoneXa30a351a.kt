 ...
 * estone
 */
@Serializable(with = InlineWebhookPullRequestUnlockedPullRequestMilestoneXa30a351a.Serializer::class)
public class InlineWebhookPullRequestUnlockedPullRequestMilestoneXa30a351a(
  /**
  ...
  public val creator: InlineWebhookPullRequestUnlockedPullRequestMilestoneCreatorX79467c29?,
   ...
   */
  public val state: InlineWebhookPullRequestUnlockedPullRequestMilestoneStateXbd02ad7e,
  /**
  ...
  public class Builder {
    ...
    private var stateValue: InlineWebhookPullRequestUnlockedPullRequestMilestoneStateXbd02ad7e? =
        null

    public var state: InlineWebhookPullRequestUnlockedPullRequestMilestoneStateXbd02ad7e
    ...
    private var creatorState:
        FieldState<InlineWebhookPullRequestUnlockedPullRequestMilestoneCreatorX79467c29?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var creator: InlineWebhookPullRequestUnlockedPullRequestMilestoneCreatorX79467c29?
    ...
    public fun build(): InlineWebhookPullRequestUnlockedPullRequestMilestoneXa30a351a {
      ...
      return InlineWebhookPullRequestUnlockedPullRequestMilestoneXa30a351a(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestUnlockedPullRequestMilestoneXa30a351a = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestUnlockedPullRequestMilestoneXa30a351a> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestUnlockedPullRequestMilestoneXa30a351a {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestUnlockedPullRequestMilestoneXa30a351a")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestUnlockedPullRequestMilestoneXa30a351a must be a JSON object")
      ...
      val state = json.decodeRequired<InlineWebhookPullRequestUnlockedPullRequestMilestoneStateXbd02ad7e>(rawObject, "state")
      val title = json.decodeRequired<String>(rawObject, "title")
      val updatedAt = json.decodeRequired<String>(rawObject, "updated_at")
      val url = json.decodeRequired<String>(rawObject, "url")
      if (!rawObject.containsKey("closed_at")) {
        throw SerializationException("InlineWebhookPullRequestUnlockedPullRequestMilestoneXa30a351a is missing required property 'closed_at'")
      }
      ...
      if (!rawObject.containsKey("creator")) {
        throw SerializationException("InlineWebhookPullRequestUnlockedPullRequestMilestoneXa30a351a is missing required property 'creator'")
      }
      val creator = rawObject["creator"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestUnlockedPullRequestMilestoneCreatorX79467c29?>(requireNotNull(element)) }
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookPullRequestUnlockedPullRequestMilestoneXa30a351a is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("due_on")) {
        throw SerializationException("InlineWebhookPullRequestUnlockedPullRequestMilestoneXa30a351a is missing required property 'due_on'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestUnlockedPullRequestMilestoneXa30a351a) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestUnlockedPullRequestMilestoneXa30a351a")
...
public fun inlineWebhookPullRequestUnlockedPullRequestMilestoneXa30a351a(block: InlineWebhookPullRequestUnlockedPullRequestMilestoneXa30a351a.Builder.() -> Unit): InlineWebhookPullRequestUnlockedPullRequestMilestoneXa30a351a = InlineWebhookPullRequestUnlockedPullRequestMilestoneXa30a351a.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestUnlockedPullRequestMilestoneXa30a351a is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookPullRequestUnlockedPullRequestMilestoneXa30a351a property '" + name + "' is not nullable")
