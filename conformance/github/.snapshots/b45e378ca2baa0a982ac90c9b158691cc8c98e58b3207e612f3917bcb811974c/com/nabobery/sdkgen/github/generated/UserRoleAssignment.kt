 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/user-role-assignment
 */
@Serializable(with = UserRoleAssignment.Serializer::class)
public class UserRoleAssignment internal constructor(
  /**
  ...
  private val assignmentState: FieldState<InlineUserRoleAssignmentAssignmentXe3fcc7a3>,
  private val emailState: FieldState<String?>,
  inheritedFromState: FieldState<List<TeamSimple>>,
  ...
  private val inheritedFromState: FieldState<List<TeamSimple>> =
      inheritedFromState.copyValue { fieldValue -> fieldValue.toList() }

  /**
   * Determines if the user has a direct, indirect, or mixed relationship to a role
   */
  public val assignment: InlineUserRoleAssignmentAssignmentXe3fcc7a3?
   ...
   */
  public val inheritedFrom: List<TeamSimple>?
    get() = inheritedFromState.valueOrNull()
  ...
  inheritedFromState = FieldState.Absent,
  ...
  /**
   * Returns the wire presence of `inherited_from`.
   */
  public fun inheritedFromPresence(): FieldPresence = inheritedFromState.presence
  ...
  public class Builder {
    ...
    private var assignmentState: FieldState<InlineUserRoleAssignmentAssignmentXe3fcc7a3> =
        FieldState.Absent
     ...
     */
    public var assignment: InlineUserRoleAssignmentAssignmentXe3fcc7a3?
      get() = assignmentState.valueOrNull()
      set(`value`) {
    ...
    private var inheritedFromState: FieldState<List<TeamSimple>> = FieldState.Absent

    /**
     * Team the user has gotten the role through
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var inheritedFrom: List<TeamSimple>?
      get() = inheritedFromState.valueOrNull()?.let { collection0 -> collection0.toList() }
      set(`value`) {
        val present = requireNotNull(value) { "inheritedFrom is not nullable; call unsetInheritedFrom() to omit it" }
        inheritedFromState = FieldState.Value(present.toList())
      }
    ...
    /**
     * Omits `inherited_from` from serialized output.
     */
    public fun unsetInheritedFrom() {
      inheritedFromState = FieldState.Absent
    }
    ...
    public fun build(): UserRoleAssignment {
      ...
      return UserRoleAssignment(
        ...
        inheritedFromState = inheritedFromState,
        nameState = nameState,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): UserRoleAssignment = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<UserRoleAssignment> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): UserRoleAssignment {
      val jsonDecoder = decoder.requireJsonDecoder("UserRoleAssignment")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("UserRoleAssignment must be a JSON object")
      ...
      if (!rawObject.containsKey("gravatar_id")) {
        throw SerializationException("UserRoleAssignment is missing required property 'gravatar_id'")
      }
      ...
      return UserRoleAssignment(
        ...
        inheritedFromState = json.decodeOptional(rawObject, "inherited_from", nullable = false),
    ...
    override fun serialize(encoder: Encoder, `value`: UserRoleAssignment) {
      val jsonEncoder = encoder.requireJsonEncoder("UserRoleAssignment")
      ...
      val raw = buildJsonObject {
        ...
        putState("inherited_from", value.inheritedFromState, json::encodeToJsonElement)
...
public fun userRoleAssignment(block: UserRoleAssignment.Builder.() -> Unit): UserRoleAssignment = UserRoleAssignment.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("UserRoleAssignment is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("UserRoleAssignment property '" + name + "' is not nullable")
