 ...
 * t/properties/base/properties/user.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-review-thread-unresolved/properties/pull_reques
 * t/properties/base/properties/user
 */
@Serializable(with = InlineWebhookPullRequestReviewThreadUnresolvedPullRequestBaseUserX3ea5e715.Serializer::class)
public class InlineWebhookPullRequestReviewThreadUnresolvedPullRequestBaseUserX3ea5e715(
  public val id: Long,
  ...
  public val type:
      InlineWebhookPullRequestReviewThreadUnresolvedPullRequestBaseUserTypeXa7ea9386? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestReviewThreadUnresolvedPullRequestBaseUserTypeXa7ea9386?
        = null
    ...
    public fun build(): InlineWebhookPullRequestReviewThreadUnresolvedPullRequestBaseUserX3ea5e715 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestReviewThreadUnresolvedPullRequestBaseUserX3ea5e715(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewThreadUnresolvedPullRequestBaseUserX3ea5e715 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewThreadUnresolvedPullRequestBaseUserX3ea5e715> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewThreadUnresolvedPullRequestBaseUserX3ea5e715 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewThreadUnresolvedPullRequestBaseUserX3ea5e715")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewThreadUnresolvedPullRequestBaseUserX3ea5e715 must be a JSON object")
      ...
      return InlineWebhookPullRequestReviewThreadUnresolvedPullRequestBaseUserX3ea5e715(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestReviewThreadUnresolvedPullRequestBaseUserTypeXa7ea9386>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewThreadUnresolvedPullRequestBaseUserX3ea5e715) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewThreadUnresolvedPullRequestBaseUserX3ea5e715")
...
public fun inlineWebhookPullRequestReviewThreadUnresolvedPullRequestBaseUserX3ea5e715(block: InlineWebhookPullRequestReviewThreadUnresolvedPullRequestBaseUserX3ea5e715.Builder.() -> Unit): InlineWebhookPullRequestReviewThreadUnresolvedPullRequestBaseUserX3ea5e715 = InlineWebhookPullRequestReviewThreadUnresolvedPullRequestBaseUserX3ea5e715.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewThreadUnresolvedPullRequestBaseUserX3ea5e715 is missing required property '" + name + "'")
