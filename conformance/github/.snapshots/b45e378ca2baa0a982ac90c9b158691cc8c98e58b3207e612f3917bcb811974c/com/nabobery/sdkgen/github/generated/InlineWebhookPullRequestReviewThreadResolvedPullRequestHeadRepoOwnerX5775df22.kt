 ...
 * properties/head/properties/repo/properties/owner
 */
@Serializable(with = InlineWebhookPullRequestReviewThreadResolvedPullRequestHeadRepoOwnerX5775df22.Serializer::class)
public class InlineWebhookPullRequestReviewThreadResolvedPullRequestHeadRepoOwnerX5775df22(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestRe0df9PullRequestHeadRepoOwnerTypeXca38fb21? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestRe0df9PullRequestHeadRepoOwnerTypeXca38fb21? = null
    ...
    public fun build(): InlineWebhookPullRequestReviewThreadResolvedPullRequestHeadRepoOwnerX5775df22 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestReviewThreadResolvedPullRequestHeadRepoOwnerX5775df22(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewThreadResolvedPullRequestHeadRepoOwnerX5775df22 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewThreadResolvedPullRequestHeadRepoOwnerX5775df22> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewThreadResolvedPullRequestHeadRepoOwnerX5775df22 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewThreadResolvedPullRequestHeadRepoOwnerX5775df22")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewThreadResolvedPullRequestHeadRepoOwnerX5775df22 must be a JSON object")
      ...
      return InlineWebhookPullRequestReviewThreadResolvedPullRequestHeadRepoOwnerX5775df22(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestRe0df9PullRequestHeadRepoOwnerTypeXca38fb21>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewThreadResolvedPullRequestHeadRepoOwnerX5775df22) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewThreadResolvedPullRequestHeadRepoOwnerX5775df22")
...
public fun inlineWebhookPullRequestReviewThreadResolvedPullRequestHeadRepoOwnerX5775df22(block: InlineWebhookPullRequestReviewThreadResolvedPullRequestHeadRepoOwnerX5775df22.Builder.() -> Unit): InlineWebhookPullRequestReviewThreadResolvedPullRequestHeadRepoOwnerX5775df22 = InlineWebhookPullRequestReviewThreadResolvedPullRequestHeadRepoOwnerX5775df22.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewThreadResolvedPullRequestHeadRepoOwnerX5775df22 is missing required property '" + name + "'")
