...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/components/schemas/webhooks_pull_request_5/properties/milestone/properties/creator.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhooks_pull_request_5/properties/milestone/properties/creator
 */
@Serializable(with = InlineWebhooksPullRequest5MilestoneCreatorXf3c28fdf.Serializer::class)
public class InlineWebhooksPullRequest5MilestoneCreatorXf3c28fdf(
  public val id: Int,
  ...
  public val type: InlineWebhooksPullRequest5MilestoneCreatorTypeX3863abe8? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhooksPullRequest5MilestoneCreatorTypeX3863abe8? = null
    ...
    public fun build(): InlineWebhooksPullRequest5MilestoneCreatorXf3c28fdf {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhooksPullRequest5MilestoneCreatorXf3c28fdf(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhooksPullRequest5MilestoneCreatorXf3c28fdf = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhooksPullRequest5MilestoneCreatorXf3c28fdf> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhooksPullRequest5MilestoneCreatorXf3c28fdf {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhooksPullRequest5MilestoneCreatorXf3c28fdf")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhooksPullRequest5MilestoneCreatorXf3c28fdf must be a JSON object")
      ...
      return InlineWebhooksPullRequest5MilestoneCreatorXf3c28fdf(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhooksPullRequest5MilestoneCreatorTypeX3863abe8>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhooksPullRequest5MilestoneCreatorXf3c28fdf) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhooksPullRequest5MilestoneCreatorXf3c28fdf")
...
public fun inlineWebhooksPullRequest5MilestoneCreatorXf3c28fdf(block: InlineWebhooksPullRequest5MilestoneCreatorXf3c28fdf.Builder.() -> Unit): InlineWebhooksPullRequest5MilestoneCreatorXf3c28fdf = InlineWebhooksPullRequest5MilestoneCreatorXf3c28fdf.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhooksPullRequest5MilestoneCreatorXf3c28fdf is missing required property '" + name + "'")
