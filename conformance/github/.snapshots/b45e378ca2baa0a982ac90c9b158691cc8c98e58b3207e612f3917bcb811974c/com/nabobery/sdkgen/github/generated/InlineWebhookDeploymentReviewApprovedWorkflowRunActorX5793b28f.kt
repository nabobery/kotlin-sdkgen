 ...
 * s/actor
 */
@Serializable(with = InlineWebhookDeploymentReviewApprovedWorkflowRunActorX5793b28f.Serializer::class)
public class InlineWebhookDeploymentReviewApprovedWorkflowRunActorX5793b28f(
  public val id: Int,
  ...
  public val type: InlineWebhookDeploymentReviewApprovedWorkflowRunActorTypeX80002ab0? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookDeploymentReviewApprovedWorkflowRunActorTypeX80002ab0? = null
    ...
    public fun build(): InlineWebhookDeploymentReviewApprovedWorkflowRunActorX5793b28f {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookDeploymentReviewApprovedWorkflowRunActorX5793b28f(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookDeploymentReviewApprovedWorkflowRunActorX5793b28f = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookDeploymentReviewApprovedWorkflowRunActorX5793b28f> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookDeploymentReviewApprovedWorkflowRunActorX5793b28f {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookDeploymentReviewApprovedWorkflowRunActorX5793b28f")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookDeploymentReviewApprovedWorkflowRunActorX5793b28f must be a JSON object")
      ...
      return InlineWebhookDeploymentReviewApprovedWorkflowRunActorX5793b28f(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookDeploymentReviewApprovedWorkflowRunActorTypeX80002ab0>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookDeploymentReviewApprovedWorkflowRunActorX5793b28f) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookDeploymentReviewApprovedWorkflowRunActorX5793b28f")
...
public fun inlineWebhookDeploymentReviewApprovedWorkflowRunActorX5793b28f(block: InlineWebhookDeploymentReviewApprovedWorkflowRunActorX5793b28f.Builder.() -> Unit): InlineWebhookDeploymentReviewApprovedWorkflowRunActorX5793b28f = InlineWebhookDeploymentReviewApprovedWorkflowRunActorX5793b28f.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookDeploymentReviewApprovedWorkflowRunActorX5793b28f is missing required property '" + name + "'")
