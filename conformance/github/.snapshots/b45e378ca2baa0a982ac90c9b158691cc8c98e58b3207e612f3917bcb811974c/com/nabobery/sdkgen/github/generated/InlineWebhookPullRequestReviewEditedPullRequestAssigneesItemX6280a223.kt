 ...
 * s/assignees/items
 */
@Serializable(with = InlineWebhookPullRequestReviewEditedPullRequestAssigneesItemX6280a223.Serializer::class)
public class InlineWebhookPullRequestReviewEditedPullRequestAssigneesItemX6280a223(
  public val id: Int,
  ...
  public val type:
      InlineWebhookPullRequestReviewEditedPullRequestAssigneesItemTypeX65342b42? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestReviewEditedPullRequestAssigneesItemTypeX65342b42? =
        null
    ...
    public fun build(): InlineWebhookPullRequestReviewEditedPullRequestAssigneesItemX6280a223 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestReviewEditedPullRequestAssigneesItemX6280a223(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewEditedPullRequestAssigneesItemX6280a223 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewEditedPullRequestAssigneesItemX6280a223> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewEditedPullRequestAssigneesItemX6280a223 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewEditedPullRequestAssigneesItemX6280a223")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewEditedPullRequestAssigneesItemX6280a223 must be a JSON object")
      ...
      return InlineWebhookPullRequestReviewEditedPullRequestAssigneesItemX6280a223(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestReviewEditedPullRequestAssigneesItemTypeX65342b42>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewEditedPullRequestAssigneesItemX6280a223) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewEditedPullRequestAssigneesItemX6280a223")
...
public fun inlineWebhookPullRequestReviewEditedPullRequestAssigneesItemX6280a223(block: InlineWebhookPullRequestReviewEditedPullRequestAssigneesItemX6280a223.Builder.() -> Unit): InlineWebhookPullRequestReviewEditedPullRequestAssigneesItemX6280a223 = InlineWebhookPullRequestReviewEditedPullRequestAssigneesItemX6280a223.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewEditedPullRequestAssigneesItemX6280a223 is missing required property '" + name + "'")
