 ...
 * assignees/items
 */
@Serializable(with = InlineWebhookPullRequestSynchronizePullRequestAssigneesItemX9a05091a.Serializer::class)
public class InlineWebhookPullRequestSynchronizePullRequestAssigneesItemX9a05091a(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestSynchronizePullRequestAssigneesItemTypeXac2fd168? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestSynchronizePullRequestAssigneesItemTypeXac2fd168? =
        null
    ...
    public fun build(): InlineWebhookPullRequestSynchronizePullRequestAssigneesItemX9a05091a {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestSynchronizePullRequestAssigneesItemX9a05091a(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestSynchronizePullRequestAssigneesItemX9a05091a = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestSynchronizePullRequestAssigneesItemX9a05091a> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestSynchronizePullRequestAssigneesItemX9a05091a {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestSynchronizePullRequestAssigneesItemX9a05091a")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestSynchronizePullRequestAssigneesItemX9a05091a must be a JSON object")
      ...
      return InlineWebhookPullRequestSynchronizePullRequestAssigneesItemX9a05091a(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestSynchronizePullRequestAssigneesItemTypeXac2fd168>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestSynchronizePullRequestAssigneesItemX9a05091a) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestSynchronizePullRequestAssigneesItemX9a05091a")
...
public fun inlineWebhookPullRequestSynchronizePullRequestAssigneesItemX9a05091a(block: InlineWebhookPullRequestSynchronizePullRequestAssigneesItemX9a05091a.Builder.() -> Unit): InlineWebhookPullRequestSynchronizePullRequestAssigneesItemX9a05091a = InlineWebhookPullRequestSynchronizePullRequestAssigneesItemX9a05091a.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestSynchronizePullRequestAssigneesItemX9a05091a is missing required property '" + name + "'")
