 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhooks_issue/properties/performed_via_github_app
 */
@Serializable(with = InlineWebhooksIssuePerformedViaGithubAppXe8214b34.Serializer::class)
public class InlineWebhooksIssuePerformedViaGithubAppXe8214b34 internal constructor(
  /**
  ...
  public val owner: InlineWebhooksIssuePerformedViaGithubAppOwnerX72ce9b65?,
  /**
   * Wire format: `date-time`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  public val updatedAt: String?,
  eventsState: FieldState<List<InlineWebhooksIssuePerformedViaGithubAppEventsItemXcacf6b7c>>,
  private val permissionsState:
      FieldState<InlineWebhooksIssuePerformedViaGithubAppPermissionsXd1882dd1>,
  private val slugState: FieldState<String>,
) {
  private val eventsState:
      FieldState<List<InlineWebhooksIssuePerformedViaGithubAppEventsItemXcacf6b7c>> =
      eventsState.copyValue { fieldValue -> fieldValue.toList() }

  /**
   * The list of events for the GitHub app
   */
  public val events: List<InlineWebhooksIssuePerformedViaGithubAppEventsItemXcacf6b7c>?
    get() = eventsState.valueOrNull()

  /**
   * The set of permissions for the GitHub app
   */
  public val permissions: InlineWebhooksIssuePerformedViaGithubAppPermissionsXd1882dd1?
  ...
  public constructor(
    ...
    name: String,
    nodeId: String,
    owner: InlineWebhooksIssuePerformedViaGithubAppOwnerX72ce9b65?,
    updatedAt: String?,
  ...
  public class Builder {
    ...
    private var ownerState: FieldState<InlineWebhooksIssuePerformedViaGithubAppOwnerX72ce9b65?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var owner: InlineWebhooksIssuePerformedViaGithubAppOwnerX72ce9b65?
     ...
     */
    public var events: List<InlineWebhooksIssuePerformedViaGithubAppEventsItemXcacf6b7c>?
    ...
    private var permissionsState:
        FieldState<InlineWebhooksIssuePerformedViaGithubAppPermissionsXd1882dd1> = FieldState.Absent

    /**
     * The set of permissions for the GitHub app
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var permissions: InlineWebhooksIssuePerformedViaGithubAppPermissionsXd1882dd1?
      get() = permissionsState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): InlineWebhooksIssuePerformedViaGithubAppXe8214b34 {
      ...
      return InlineWebhooksIssuePerformedViaGithubAppXe8214b34(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhooksIssuePerformedViaGithubAppXe8214b34 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhooksIssuePerformedViaGithubAppXe8214b34> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhooksIssuePerformedViaGithubAppXe8214b34 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhooksIssuePerformedViaGithubAppXe8214b34")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhooksIssuePerformedViaGithubAppXe8214b34 must be a JSON object")
      val htmlUrl = json.decodeRequired<String>(rawObject, "html_url")
      val name = json.decodeRequired<String>(rawObject, "name")
      val nodeId = json.decodeRequired<String>(rawObject, "node_id")
      if (!rawObject.containsKey("created_at")) {
        throw SerializationException("InlineWebhooksIssuePerformedViaGithubAppXe8214b34 is missing required property 'created_at'")
      }
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhooksIssuePerformedViaGithubAppXe8214b34 is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("external_url")) {
        throw SerializationException("InlineWebhooksIssuePerformedViaGithubAppXe8214b34 is missing required property 'external_url'")
      }
      ...
      if (!rawObject.containsKey("id")) {
        throw SerializationException("InlineWebhooksIssuePerformedViaGithubAppXe8214b34 is missing required property 'id'")
      }
      ...
      if (!rawObject.containsKey("owner")) {
        throw SerializationException("InlineWebhooksIssuePerformedViaGithubAppXe8214b34 is missing required property 'owner'")
      }
      val owner = rawObject["owner"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhooksIssuePerformedViaGithubAppOwnerX72ce9b65?>(requireNotNull(element)) }
      if (!rawObject.containsKey("updated_at")) {
        throw SerializationException("InlineWebhooksIssuePerformedViaGithubAppXe8214b34 is missing required property 'updated_at'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhooksIssuePerformedViaGithubAppXe8214b34) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhooksIssuePerformedViaGithubAppXe8214b34")
...
public fun inlineWebhooksIssuePerformedViaGithubAppXe8214b34(block: InlineWebhooksIssuePerformedViaGithubAppXe8214b34.Builder.() -> Unit): InlineWebhooksIssuePerformedViaGithubAppXe8214b34 = InlineWebhooksIssuePerformedViaGithubAppXe8214b34.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhooksIssuePerformedViaGithubAppXe8214b34 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhooksIssuePerformedViaGithubAppXe8214b34 property '" + name + "' is not nullable")
