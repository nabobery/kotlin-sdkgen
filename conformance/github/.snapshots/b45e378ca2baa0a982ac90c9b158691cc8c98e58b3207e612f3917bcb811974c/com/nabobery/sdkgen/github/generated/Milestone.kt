 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/milestone
 */
...
public class Milestone(
   ...
   */
  public val state: InlineMilestoneStateX5013bcc8,
  /**
  ...
  public class Builder {
    ...
    private var stateValue: InlineMilestoneStateX5013bcc8? = null

    public var state: InlineMilestoneStateX5013bcc8
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): Milestone = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<Milestone> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): Milestone {
      val jsonDecoder = decoder.requireJsonDecoder("Milestone")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("Milestone must be a JSON object")
      ...
      val state = json.decodeRequired<InlineMilestoneStateX5013bcc8>(rawObject, "state")
      val title = json.decodeRequired<String>(rawObject, "title")
      val updatedAt = json.decodeRequired<String>(rawObject, "updated_at")
      val url = json.decodeRequired<String>(rawObject, "url")
      if (!rawObject.containsKey("closed_at")) {
        throw SerializationException("Milestone is missing required property 'closed_at'")
      }
      ...
      if (!rawObject.containsKey("creator")) {
        throw SerializationException("Milestone is missing required property 'creator'")
      }
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("Milestone is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("due_on")) {
        throw SerializationException("Milestone is missing required property 'due_on'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: Milestone) {
      val jsonEncoder = encoder.requireJsonEncoder("Milestone")
...
public fun milestone(block: Milestone.Builder.() -> Unit): Milestone = Milestone.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("Milestone is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("Milestone property '" + name + "' is not nullable")
