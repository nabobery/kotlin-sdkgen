 ...
 * s/assignee
 */
@Serializable(with = InlineWebhookPullRequestReviewEditedPullRequestAssigneeX0e01cbf9.Serializer::class)
public class InlineWebhookPullRequestReviewEditedPullRequestAssigneeX0e01cbf9(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestReviewEditedPullRequestAssigneeTypeXabbbe171? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestReviewEditedPullRequestAssigneeTypeXabbbe171? = null
    ...
    public fun build(): InlineWebhookPullRequestReviewEditedPullRequestAssigneeX0e01cbf9 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestReviewEditedPullRequestAssigneeX0e01cbf9(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewEditedPullRequestAssigneeX0e01cbf9 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewEditedPullRequestAssigneeX0e01cbf9> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewEditedPullRequestAssigneeX0e01cbf9 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewEditedPullRequestAssigneeX0e01cbf9")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewEditedPullRequestAssigneeX0e01cbf9 must be a JSON object")
      ...
      return InlineWebhookPullRequestReviewEditedPullRequestAssigneeX0e01cbf9(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestReviewEditedPullRequestAssigneeTypeXabbbe171>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewEditedPullRequestAssigneeX0e01cbf9) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewEditedPullRequestAssigneeX0e01cbf9")
...
public fun inlineWebhookPullRequestReviewEditedPullRequestAssigneeX0e01cbf9(block: InlineWebhookPullRequestReviewEditedPullRequestAssigneeX0e01cbf9.Builder.() -> Unit): InlineWebhookPullRequestReviewEditedPullRequestAssigneeX0e01cbf9 = InlineWebhookPullRequestReviewEditedPullRequestAssigneeX0e01cbf9.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewEditedPullRequestAssigneeX0e01cbf9 is missing required property '" + name + "'")
