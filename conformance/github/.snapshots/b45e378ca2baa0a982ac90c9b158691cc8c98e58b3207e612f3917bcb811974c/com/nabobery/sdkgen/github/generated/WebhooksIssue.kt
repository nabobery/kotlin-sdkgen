 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhooks_issue
 */
@Serializable(with = WebhooksIssue.Serializer::class)
public class WebhooksIssue internal constructor(
  public val activeLockReason: InlineWebhooksIssueActiveLockReasonX0170fac5?,
  assignees: List<InlineWebhooksIssueAssigneesItemXc1de8a8c?>,
  /**
   * How the author is associated with the repository.
   */
  public val authorAssociation: InlineWebhooksIssueAuthorAssociationX59c55e5a,
  /**
   ...
   */
  public val milestone: InlineWebhooksIssueMilestoneXd4627731?,
  public val nodeId: String,
  public val number: Int,
  public val reactions: InlineWebhooksIssueReactionsXf513d3ba,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val user: InlineWebhooksIssueUserXb40fe13e?,
  private val assigneeState: FieldState<InlineWebhooksIssueAssigneeXf195acb9?>,
  ...
  labelsState: FieldState<List<InlineWebhooksIssueLabelsItemXdbb0edff>>,
  private val lockedState: FieldState<Boolean>,
  private val performedViaGithubAppState:
      FieldState<InlineWebhooksIssuePerformedViaGithubAppXe8214b34?>,
  private val pinnedCommentState: FieldState<NullableIssueComment?>,
  private val pullRequestState: FieldState<InlineWebhooksIssuePullRequestX123ecea1>,
  private val stateState: FieldState<InlineWebhooksIssueStateX81bc32e8>,
  ...
  public val assignees: List<InlineWebhooksIssueAssigneesItemXc1de8a8c?> = assignees.toList()
  ...
  private val labelsState: FieldState<List<InlineWebhooksIssueLabelsItemXdbb0edff>> =
      labelsState.copyValue { fieldValue -> fieldValue.toList() }

  public val assignee: InlineWebhooksIssueAssigneeXf195acb9?
  ...
  public val labels: List<InlineWebhooksIssueLabelsItemXdbb0edff>?
   ...
   */
  public val performedViaGithubApp: InlineWebhooksIssuePerformedViaGithubAppXe8214b34?
  ...
  public val pullRequest: InlineWebhooksIssuePullRequestX123ecea1?
    get() = pullRequestState.valueOrNull()

  /**
   * State of the issue; either 'open' or 'closed'
   */
  public val state: InlineWebhooksIssueStateX81bc32e8?
  ...
  public constructor(
    activeLockReason: InlineWebhooksIssueActiveLockReasonX0170fac5?,
    assignees: List<InlineWebhooksIssueAssigneesItemXc1de8a8c?>,
    authorAssociation: InlineWebhooksIssueAuthorAssociationX59c55e5a,
    body: String?,
    closedAt: String?,
    comments: Int,
    commentsUrl: String,
    ...
    id: Long,
    labelsUrl: String,
    milestone: InlineWebhooksIssueMilestoneXd4627731?,
    nodeId: String,
    number: Int,
    reactions: InlineWebhooksIssueReactionsXf513d3ba,
    repositoryUrl: String,
    title: String,
    updatedAt: String,
    url: String,
    user: InlineWebhooksIssueUserXb40fe13e?,
  ...
  public class Builder {
    private var assigneesValue: List<InlineWebhooksIssueAssigneesItemXc1de8a8c?>? = null

    public var assignees: List<InlineWebhooksIssueAssigneesItemXc1de8a8c?>
      get() = requireNotNull(assigneesValue) { "assignees is required" }.toList()
      set(`value`) {
        assigneesValue = value.toList()
      }

    private var authorAssociationValue: InlineWebhooksIssueAuthorAssociationX59c55e5a? = null

    public var authorAssociation: InlineWebhooksIssueAuthorAssociationX59c55e5a
    ...
    private var reactionsValue: InlineWebhooksIssueReactionsXf513d3ba? = null

    public var reactions: InlineWebhooksIssueReactionsXf513d3ba
    ...
    private var activeLockReasonState: FieldState<InlineWebhooksIssueActiveLockReasonX0170fac5?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var activeLockReason: InlineWebhooksIssueActiveLockReasonX0170fac5?
    ...
    private var milestoneState: FieldState<InlineWebhooksIssueMilestoneXd4627731?> =
        FieldState.Absent
     ...
     * Required nullable field; assigning `null` records present-null.
     */
    public var milestone: InlineWebhooksIssueMilestoneXd4627731?
      get() = milestoneState.valueOrNull()
      set(`value`) {
        milestoneState = value.toNullableFieldState()
      }

    private var userState: FieldState<InlineWebhooksIssueUserXb40fe13e?> = FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var user: InlineWebhooksIssueUserXb40fe13e?
      get() = userState.valueOrNull()
      set(`value`) {
        userState = value.toNullableFieldState()
      }

    private var assigneeState: FieldState<InlineWebhooksIssueAssigneeXf195acb9?> = FieldState.Absent

    /**
     * Assigning `null` records present-null; use the unset function to omit the property.
     */
    public var assignee: InlineWebhooksIssueAssigneeXf195acb9?
      get() = assigneeState.valueOrNull()
      set(`value`) {
    ...
    private var labelsState: FieldState<List<InlineWebhooksIssueLabelsItemXdbb0edff>> =
        FieldState.Absent

    /**
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var labels: List<InlineWebhooksIssueLabelsItemXdbb0edff>?
    ...
    private var performedViaGithubAppState:
        FieldState<InlineWebhooksIssuePerformedViaGithubAppXe8214b34?> = FieldState.Absent
     ...
     * Assigning `null` records present-null; use the unset function to omit the property.
     */
    public var performedViaGithubApp: InlineWebhooksIssuePerformedViaGithubAppXe8214b34?
      get() = performedViaGithubAppState.valueOrNull()
      set(`value`) {
    ...
    private var pullRequestState: FieldState<InlineWebhooksIssuePullRequestX123ecea1> =
        FieldState.Absent

    /**
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var pullRequest: InlineWebhooksIssuePullRequestX123ecea1?
      get() = pullRequestState.valueOrNull()
      set(`value`) {
    ...
    private var stateState: FieldState<InlineWebhooksIssueStateX81bc32e8> = FieldState.Absent

    /**
     * State of the issue; either 'open' or 'closed'
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var state: InlineWebhooksIssueStateX81bc32e8?
      get() = stateState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): WebhooksIssue {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): WebhooksIssue = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<WebhooksIssue> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): WebhooksIssue {
      val jsonDecoder = decoder.requireJsonDecoder("WebhooksIssue")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("WebhooksIssue must be a JSON object")
      val assignees = json.decodeRequired<List<InlineWebhooksIssueAssigneesItemXc1de8a8c?>>(rawObject, "assignees")
      val authorAssociation = json.decodeRequired<InlineWebhooksIssueAuthorAssociationX59c55e5a>(rawObject, "author_association")
      ...
      val reactions = json.decodeRequired<InlineWebhooksIssueReactionsXf513d3ba>(rawObject, "reactions")
      ...
      if (!rawObject.containsKey("active_lock_reason")) {
        throw SerializationException("WebhooksIssue is missing required property 'active_lock_reason'")
      }
      val activeLockReason = rawObject["active_lock_reason"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhooksIssueActiveLockReasonX0170fac5?>(requireNotNull(element)) }
      if (!rawObject.containsKey("body")) {
        throw SerializationException("WebhooksIssue is missing required property 'body'")
      }
      ...
      if (!rawObject.containsKey("closed_at")) {
        throw SerializationException("WebhooksIssue is missing required property 'closed_at'")
      }
      ...
      if (!rawObject.containsKey("milestone")) {
        throw SerializationException("WebhooksIssue is missing required property 'milestone'")
      }
      val milestone = rawObject["milestone"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhooksIssueMilestoneXd4627731?>(requireNotNull(element)) }
      if (!rawObject.containsKey("user")) {
        throw SerializationException("WebhooksIssue is missing required property 'user'")
      }
      val user = rawObject["user"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhooksIssueUserXb40fe13e?>(requireNotNull(element)) }
      return WebhooksIssue(
    ...
    override fun serialize(encoder: Encoder, `value`: WebhooksIssue) {
      val jsonEncoder = encoder.requireJsonEncoder("WebhooksIssue")
...
public fun webhooksIssue(block: WebhooksIssue.Builder.() -> Unit): WebhooksIssue = WebhooksIssue.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("WebhooksIssue is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("WebhooksIssue property '" + name + "' is not nullable")
