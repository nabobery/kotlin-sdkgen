 ...
 * erties/dismissed_by
 */
@Serializable(with = InlineWebhookCodeScanningAlertUpdatedAssignmentAlertDismissedByX246e4cb2.Serializer::class)
public class InlineWebhookCodeScanningAlertUpdatedAssignmentAlertDismissedByX246e4cb2(
  public val id: Int,
  ...
  public val type:
      InlineWebhookCodeScanningAlertUpdatedAssignmentAlertDismissedByTypeX4fe2b94b? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookCodeScanningAlertUpdatedAssignmentAlertDismissedByTypeX4fe2b94b? =
        null
    ...
    public fun build(): InlineWebhookCodeScanningAlertUpdatedAssignmentAlertDismissedByX246e4cb2 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookCodeScanningAlertUpdatedAssignmentAlertDismissedByX246e4cb2(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookCodeScanningAlertUpdatedAssignmentAlertDismissedByX246e4cb2 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookCodeScanningAlertUpdatedAssignmentAlertDismissedByX246e4cb2> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookCodeScanningAlertUpdatedAssignmentAlertDismissedByX246e4cb2 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookCodeScanningAlertUpdatedAssignmentAlertDismissedByX246e4cb2")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookCodeScanningAlertUpdatedAssignmentAlertDismissedByX246e4cb2 must be a JSON object")
      ...
      return InlineWebhookCodeScanningAlertUpdatedAssignmentAlertDismissedByX246e4cb2(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookCodeScanningAlertUpdatedAssignmentAlertDismissedByTypeX4fe2b94b>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookCodeScanningAlertUpdatedAssignmentAlertDismissedByX246e4cb2) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookCodeScanningAlertUpdatedAssignmentAlertDismissedByX246e4cb2")
...
public fun inlineWebhookCodeScanningAlertUpdatedAssignmentAlertDismissedByX246e4cb2(block: InlineWebhookCodeScanningAlertUpdatedAssignmentAlertDismissedByX246e4cb2.Builder.() -> Unit): InlineWebhookCodeScanningAlertUpdatedAssignmentAlertDismissedByX246e4cb2 = InlineWebhookCodeScanningAlertUpdatedAssignmentAlertDismissedByX246e4cb2.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookCodeScanningAlertUpdatedAssignmentAlertDismissedByX246e4cb2 is missing required property '" + name + "'")
