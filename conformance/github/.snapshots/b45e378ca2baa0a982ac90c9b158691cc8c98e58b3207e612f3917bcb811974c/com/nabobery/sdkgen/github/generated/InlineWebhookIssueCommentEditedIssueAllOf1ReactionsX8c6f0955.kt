...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-issue-comment-edited/properties/issue/allOf/0/properties/rea
 * ctions.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-issue-comment-edited/properties/issue/allOf/0/properties/rea
 * ctions
 */
@Serializable(with = InlineWebhookIssueCommentEditedIssueAllOf1ReactionsX8c6f0955.Serializer::class)
public class InlineWebhookIssueCommentEditedIssueAllOf1ReactionsX8c6f0955(
  public val _1: Int,
  public val _12: Int,
  ...
  public class Builder {
    ...
    public fun build(): InlineWebhookIssueCommentEditedIssueAllOf1ReactionsX8c6f0955 {
      ...
      return InlineWebhookIssueCommentEditedIssueAllOf1ReactionsX8c6f0955(
        _1 = _1,
        _12 = _12,
        confused = confused,
        eyes = eyes,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssueCommentEditedIssueAllOf1ReactionsX8c6f0955 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssueCommentEditedIssueAllOf1ReactionsX8c6f0955> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssueCommentEditedIssueAllOf1ReactionsX8c6f0955 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssueCommentEditedIssueAllOf1ReactionsX8c6f0955")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssueCommentEditedIssueAllOf1ReactionsX8c6f0955 must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssueCommentEditedIssueAllOf1ReactionsX8c6f0955) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssueCommentEditedIssueAllOf1ReactionsX8c6f0955")
...
public fun inlineWebhookIssueCommentEditedIssueAllOf1ReactionsX8c6f0955(block: InlineWebhookIssueCommentEditedIssueAllOf1ReactionsX8c6f0955.Builder.() -> Unit): InlineWebhookIssueCommentEditedIssueAllOf1ReactionsX8c6f0955 = InlineWebhookIssueCommentEditedIssueAllOf1ReactionsX8c6f0955.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssueCommentEditedIssueAllOf1ReactionsX8c6f0955 is missing required property '" + name + "'")
