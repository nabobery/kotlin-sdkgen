...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-milestoned/properties/issue/properties/user.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-milestoned/properties/issue/properties/user
 */
@Serializable(with = InlineWebhookIssuesMilestonedIssueUserX256a6361.Serializer::class)
public class InlineWebhookIssuesMilestonedIssueUserX256a6361(
  public val id: Long,
  ...
  public val type: InlineWebhookIssuesMilestonedIssueUserTypeX89057c9d? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookIssuesMilestonedIssueUserTypeX89057c9d? = null
    ...
    public fun build(): InlineWebhookIssuesMilestonedIssueUserX256a6361 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssuesMilestonedIssueUserX256a6361(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesMilestonedIssueUserX256a6361 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesMilestonedIssueUserX256a6361> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesMilestonedIssueUserX256a6361 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesMilestonedIssueUserX256a6361")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesMilestonedIssueUserX256a6361 must be a JSON object")
      ...
      return InlineWebhookIssuesMilestonedIssueUserX256a6361(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssuesMilestonedIssueUserTypeX89057c9d>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesMilestonedIssueUserX256a6361) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesMilestonedIssueUserX256a6361")
...
public fun inlineWebhookIssuesMilestonedIssueUserX256a6361(block: InlineWebhookIssuesMilestonedIssueUserX256a6361.Builder.() -> Unit): InlineWebhookIssuesMilestonedIssueUserX256a6361 = InlineWebhookIssuesMilestonedIssueUserX256a6361.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesMilestonedIssueUserX256a6361 is missing required property '" + name + "'")
