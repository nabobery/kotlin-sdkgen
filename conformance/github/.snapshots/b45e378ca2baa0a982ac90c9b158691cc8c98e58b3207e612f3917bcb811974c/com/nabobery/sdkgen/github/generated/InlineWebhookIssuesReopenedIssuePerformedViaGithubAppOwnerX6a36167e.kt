 ...
 * thub_app/properties/owner.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-reopened/properties/issue/properties/performed_via_gi
 * thub_app/properties/owner
 */
@Serializable(with = InlineWebhookIssuesReopenedIssuePerformedViaGithubAppOwnerX6a36167e.Serializer::class)
public class InlineWebhookIssuesReopenedIssuePerformedViaGithubAppOwnerX6a36167e(
  public val id: Int,
  ...
  public val type: InlineWebhookIssuesReopenedIssuePerformedViaGithubAppOwnerTypeX7b2533ba? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookIssuesReopenedIssuePerformedViaGithubAppOwnerTypeX7b2533ba? = null
    ...
    public fun build(): InlineWebhookIssuesReopenedIssuePerformedViaGithubAppOwnerX6a36167e {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssuesReopenedIssuePerformedViaGithubAppOwnerX6a36167e(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesReopenedIssuePerformedViaGithubAppOwnerX6a36167e = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesReopenedIssuePerformedViaGithubAppOwnerX6a36167e> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesReopenedIssuePerformedViaGithubAppOwnerX6a36167e {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesReopenedIssuePerformedViaGithubAppOwnerX6a36167e")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesReopenedIssuePerformedViaGithubAppOwnerX6a36167e must be a JSON object")
      ...
      return InlineWebhookIssuesReopenedIssuePerformedViaGithubAppOwnerX6a36167e(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssuesReopenedIssuePerformedViaGithubAppOwnerTypeX7b2533ba>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesReopenedIssuePerformedViaGithubAppOwnerX6a36167e) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesReopenedIssuePerformedViaGithubAppOwnerX6a36167e")
...
public fun inlineWebhookIssuesReopenedIssuePerformedViaGithubAppOwnerX6a36167e(block: InlineWebhookIssuesReopenedIssuePerformedViaGithubAppOwnerX6a36167e.Builder.() -> Unit): InlineWebhookIssuesReopenedIssuePerformedViaGithubAppOwnerX6a36167e = InlineWebhookIssuesReopenedIssuePerformedViaGithubAppOwnerX6a36167e.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesReopenedIssuePerformedViaGithubAppOwnerX6a36167e is missing required property '" + name + "'")
