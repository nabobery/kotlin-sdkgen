 ...
 * ignee
 */
@Serializable(with = InlineWebhookIssueCommentPinnedIssueAllOf1AssigneeXee83456a.Serializer::class)
public class InlineWebhookIssueCommentPinnedIssueAllOf1AssigneeXee83456a(
  public val id: Int,
  ...
  public val type: InlineWebhookIssueCommentPinnedIssueAllOf1AssigneeTypeX82dd02d4? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookIssueCommentPinnedIssueAllOf1AssigneeTypeX82dd02d4? = null
    ...
    public fun build(): InlineWebhookIssueCommentPinnedIssueAllOf1AssigneeXee83456a {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssueCommentPinnedIssueAllOf1AssigneeXee83456a(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssueCommentPinnedIssueAllOf1AssigneeXee83456a = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssueCommentPinnedIssueAllOf1AssigneeXee83456a> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssueCommentPinnedIssueAllOf1AssigneeXee83456a {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssueCommentPinnedIssueAllOf1AssigneeXee83456a")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssueCommentPinnedIssueAllOf1AssigneeXee83456a must be a JSON object")
      ...
      return InlineWebhookIssueCommentPinnedIssueAllOf1AssigneeXee83456a(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssueCommentPinnedIssueAllOf1AssigneeTypeX82dd02d4>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssueCommentPinnedIssueAllOf1AssigneeXee83456a) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssueCommentPinnedIssueAllOf1AssigneeXee83456a")
...
public fun inlineWebhookIssueCommentPinnedIssueAllOf1AssigneeXee83456a(block: InlineWebhookIssueCommentPinnedIssueAllOf1AssigneeXee83456a.Builder.() -> Unit): InlineWebhookIssueCommentPinnedIssueAllOf1AssigneeXee83456a = InlineWebhookIssueCommentPinnedIssueAllOf1AssigneeXee83456a.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssueCommentPinnedIssueAllOf1AssigneeXee83456a is missing required property '" + name + "'")
