 ...
 * milestone
 */
@Serializable(with = InlineWebhookPullRequestSynchronizePullRequestMilestoneXe996b4e1.Serializer::class)
public class InlineWebhookPullRequestSynchronizePullRequestMilestoneXe996b4e1(
  /**
  ...
  public val creator: InlineWebhookPullRequestSynchronizePullRequestMilestoneCreatorXb8264cd0?,
   ...
   */
  public val state: InlineWebhookPullRequestSynchronizePullRequestMilestoneStateX1788f2e1,
  /**
  ...
  public class Builder {
    ...
    private var stateValue: InlineWebhookPullRequestSynchronizePullRequestMilestoneStateX1788f2e1? =
        null

    public var state: InlineWebhookPullRequestSynchronizePullRequestMilestoneStateX1788f2e1
    ...
    private var creatorState:
        FieldState<InlineWebhookPullRequestSynchronizePullRequestMilestoneCreatorXb8264cd0?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var creator: InlineWebhookPullRequestSynchronizePullRequestMilestoneCreatorXb8264cd0?
    ...
    public fun build(): InlineWebhookPullRequestSynchronizePullRequestMilestoneXe996b4e1 {
      ...
      return InlineWebhookPullRequestSynchronizePullRequestMilestoneXe996b4e1(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestSynchronizePullRequestMilestoneXe996b4e1 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestSynchronizePullRequestMilestoneXe996b4e1> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestSynchronizePullRequestMilestoneXe996b4e1 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestSynchronizePullRequestMilestoneXe996b4e1")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestSynchronizePullRequestMilestoneXe996b4e1 must be a JSON object")
      ...
      val state = json.decodeRequired<InlineWebhookPullRequestSynchronizePullRequestMilestoneStateX1788f2e1>(rawObject, "state")
      val title = json.decodeRequired<String>(rawObject, "title")
      val updatedAt = json.decodeRequired<String>(rawObject, "updated_at")
      val url = json.decodeRequired<String>(rawObject, "url")
      if (!rawObject.containsKey("closed_at")) {
        throw SerializationException("InlineWebhookPullRequestSynchronizePullRequestMilestoneXe996b4e1 is missing required property 'closed_at'")
      }
      ...
      if (!rawObject.containsKey("creator")) {
        throw SerializationException("InlineWebhookPullRequestSynchronizePullRequestMilestoneXe996b4e1 is missing required property 'creator'")
      }
      val creator = rawObject["creator"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestSynchronizePullRequestMilestoneCreatorXb8264cd0?>(requireNotNull(element)) }
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookPullRequestSynchronizePullRequestMilestoneXe996b4e1 is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("due_on")) {
        throw SerializationException("InlineWebhookPullRequestSynchronizePullRequestMilestoneXe996b4e1 is missing required property 'due_on'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestSynchronizePullRequestMilestoneXe996b4e1) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestSynchronizePullRequestMilestoneXe996b4e1")
...
public fun inlineWebhookPullRequestSynchronizePullRequestMilestoneXe996b4e1(block: InlineWebhookPullRequestSynchronizePullRequestMilestoneXe996b4e1.Builder.() -> Unit): InlineWebhookPullRequestSynchronizePullRequestMilestoneXe996b4e1 = InlineWebhookPullRequestSynchronizePullRequestMilestoneXe996b4e1.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestSynchronizePullRequestMilestoneXe996b4e1 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookPullRequestSynchronizePullRequestMilestoneXe996b4e1 property '" + name + "' is not nullable")
