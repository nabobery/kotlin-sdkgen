...
/**
 * Generated model for sdkgen://source/openapi.yaml#/components/schemas/webhooks_pull_request_5/properties/merged_by.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhooks_pull_request_5/properties/merged_by
 */
@Serializable(with = InlineWebhooksPullRequest5MergedByX80f8f5b2.Serializer::class)
public class InlineWebhooksPullRequest5MergedByX80f8f5b2(
  public val id: Int,
  ...
  public val type: InlineWebhooksPullRequest5MergedByTypeXbea520b2? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhooksPullRequest5MergedByTypeXbea520b2? = null
    ...
    public fun build(): InlineWebhooksPullRequest5MergedByX80f8f5b2 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhooksPullRequest5MergedByX80f8f5b2(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhooksPullRequest5MergedByX80f8f5b2 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhooksPullRequest5MergedByX80f8f5b2> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhooksPullRequest5MergedByX80f8f5b2 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhooksPullRequest5MergedByX80f8f5b2")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhooksPullRequest5MergedByX80f8f5b2 must be a JSON object")
      ...
      return InlineWebhooksPullRequest5MergedByX80f8f5b2(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhooksPullRequest5MergedByTypeXbea520b2>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhooksPullRequest5MergedByX80f8f5b2) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhooksPullRequest5MergedByX80f8f5b2")
...
public fun inlineWebhooksPullRequest5MergedByX80f8f5b2(block: InlineWebhooksPullRequest5MergedByX80f8f5b2.Builder.() -> Unit): InlineWebhooksPullRequest5MergedByX80f8f5b2 = InlineWebhooksPullRequest5MergedByX80f8f5b2.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhooksPullRequest5MergedByX80f8f5b2 is missing required property '" + name + "'")
