 ...
 * d/properties/user
 */
@Serializable(with = InlineWebhookPullRequestAssignedPullRequestHeadUserX802a084f.Serializer::class)
public class InlineWebhookPullRequestAssignedPullRequestHeadUserX802a084f(
  public val id: Long,
  ...
  public val type: InlineWebhookPullRequestAssignedPullRequestHeadUserTypeXdd27c0ff? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestAssignedPullRequestHeadUserTypeXdd27c0ff? = null
    ...
    public fun build(): InlineWebhookPullRequestAssignedPullRequestHeadUserX802a084f {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestAssignedPullRequestHeadUserX802a084f(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestAssignedPullRequestHeadUserX802a084f = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestAssignedPullRequestHeadUserX802a084f> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestAssignedPullRequestHeadUserX802a084f {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestAssignedPullRequestHeadUserX802a084f")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestAssignedPullRequestHeadUserX802a084f must be a JSON object")
      ...
      return InlineWebhookPullRequestAssignedPullRequestHeadUserX802a084f(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestAssignedPullRequestHeadUserTypeXdd27c0ff>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestAssignedPullRequestHeadUserX802a084f) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestAssignedPullRequestHeadUserX802a084f")
...
public fun inlineWebhookPullRequestAssignedPullRequestHeadUserX802a084f(block: InlineWebhookPullRequestAssignedPullRequestHeadUserX802a084f.Builder.() -> Unit): InlineWebhookPullRequestAssignedPullRequestHeadUserX802a084f = InlineWebhookPullRequestAssignedPullRequestHeadUserX802a084f.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestAssignedPullRequestHeadUserX802a084f is missing required property '" + name + "'")
