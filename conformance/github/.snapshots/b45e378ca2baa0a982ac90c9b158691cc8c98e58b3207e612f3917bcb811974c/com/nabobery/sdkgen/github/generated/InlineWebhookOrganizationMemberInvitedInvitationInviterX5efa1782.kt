 ...
 * /inviter
 */
@Serializable(with = InlineWebhookOrganizationMemberInvitedInvitationInviterX5efa1782.Serializer::class)
public class InlineWebhookOrganizationMemberInvitedInvitationInviterX5efa1782(
  public val id: Int,
  ...
  public val type: InlineWebhookOrganizationMemberInvitedInvitationInviterTypeXa2b1ff95? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookOrganizationMemberInvitedInvitationInviterTypeXa2b1ff95? = null
    ...
    public fun build(): InlineWebhookOrganizationMemberInvitedInvitationInviterX5efa1782 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookOrganizationMemberInvitedInvitationInviterX5efa1782(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookOrganizationMemberInvitedInvitationInviterX5efa1782 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookOrganizationMemberInvitedInvitationInviterX5efa1782> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookOrganizationMemberInvitedInvitationInviterX5efa1782 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookOrganizationMemberInvitedInvitationInviterX5efa1782")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookOrganizationMemberInvitedInvitationInviterX5efa1782 must be a JSON object")
      ...
      return InlineWebhookOrganizationMemberInvitedInvitationInviterX5efa1782(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookOrganizationMemberInvitedInvitationInviterTypeXa2b1ff95>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookOrganizationMemberInvitedInvitationInviterX5efa1782) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookOrganizationMemberInvitedInvitationInviterX5efa1782")
...
public fun inlineWebhookOrganizationMemberInvitedInvitationInviterX5efa1782(block: InlineWebhookOrganizationMemberInvitedInvitationInviterX5efa1782.Builder.() -> Unit): InlineWebhookOrganizationMemberInvitedInvitationInviterX5efa1782 = InlineWebhookOrganizationMemberInvitedInvitationInviterX5efa1782.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookOrganizationMemberInvitedInvitationInviterX5efa1782 is missing required property '" + name + "'")
