...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-deployment-review-requested/properties/workflow_run.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhook-deployment-review-requested/properties/workflow_run
 */
@Serializable(with = InlineWebhookDeploymentReviewRequestedWorkflowRunX00c9e685.Serializer::class)
public class InlineWebhookDeploymentReviewRequestedWorkflowRunX00c9e685 internal constructor(
  public val actor: InlineWebhookDeploymentReviewRequestedWorkflowRunActorXa1f227ad?,
  public val checkSuiteId: Int,
  public val checkSuiteNodeId: String,
  public val conclusion: InlineWebhookDeploymentReviewRequestedWorkflowRunConclusionXbf811727?,
  /**
  ...
  pullRequests: List<InlineWebhookDeploymentReviewRequestedWorkflowRunPullRequestsItemX5c1546c0>,
  ...
  public val status: InlineWebhookDeploymentReviewRequestedWorkflowRunStatusXd18eb56d,
  public val triggeringActor:
      InlineWebhookDeploymentReviewRequestedWorkflowRunTriggeringActorXd9b2521f?,
  /**
   * Wire format: `date-time`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  private val headRepositoryState:
      FieldState<InlineWebhookDeploymentReviewRequestedWorkflowRunHeadRepositoryX53437933>,
  ...
  referencedWorkflowsState: FieldState<List<InlineWebhookDeploymentRevd4e8WorkflowRunReferencedWorkflowsItemXa0a9f2cc>?>,
  private val repositoryState:
      FieldState<InlineWebhookDeploymentReviewRequestedWorkflowRunRepositoryX4f263126>,
  private val rerunUrlState: FieldState<String>,
  private val workflowUrlState: FieldState<String>,
) {
  public val pullRequests:
      List<InlineWebhookDeploymentReviewRequestedWorkflowRunPullRequestsItemX5c1546c0> =
      pullRequests.toList()

  private val referencedWorkflowsState:
      FieldState<List<InlineWebhookDeploymentRevd4e8WorkflowRunReferencedWorkflowsItemXa0a9f2cc>?> =
  ...
  public val headRepository:
      InlineWebhookDeploymentReviewRequestedWorkflowRunHeadRepositoryX53437933?
  ...
  public val referencedWorkflows:
      List<InlineWebhookDeploymentRevd4e8WorkflowRunReferencedWorkflowsItemXa0a9f2cc>?
    get() = referencedWorkflowsState.valueOrNull()

  public val repository: InlineWebhookDeploymentReviewRequestedWorkflowRunRepositoryX4f263126?
  ...
  public constructor(
    actor: InlineWebhookDeploymentReviewRequestedWorkflowRunActorXa1f227ad?,
    checkSuiteId: Int,
    checkSuiteNodeId: String,
    conclusion: InlineWebhookDeploymentReviewRequestedWorkflowRunConclusionXbf811727?,
    createdAt: String,
    displayTitle: String,
    event: String,
    headBranch: String,
    ...
    runNumber: Int,
    runStartedAt: String,
    status: InlineWebhookDeploymentReviewRequestedWorkflowRunStatusXd18eb56d,
    triggeringActor: InlineWebhookDeploymentReviewRequestedWorkflowRunTriggeringActorXd9b2521f?,
    updatedAt: String,
    url: String,
    workflowId: Int,
  ) : this(actor = actor,
  ...
  public class Builder {
    ...
    private var pullRequestsValue:
        List<InlineWebhookDeploymentReviewRequestedWorkflowRunPullRequestsItemX5c1546c0>? = null
    ...
    private var statusValue: InlineWebhookDeploymentReviewRequestedWorkflowRunStatusXd18eb56d? =
        null

    public var status: InlineWebhookDeploymentReviewRequestedWorkflowRunStatusXd18eb56d
    ...
    private var actorState:
        FieldState<InlineWebhookDeploymentReviewRequestedWorkflowRunActorXa1f227ad?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var actor: InlineWebhookDeploymentReviewRequestedWorkflowRunActorXa1f227ad?
    ...
    private var conclusionState:
        FieldState<InlineWebhookDeploymentReviewRequestedWorkflowRunConclusionXbf811727?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var conclusion: InlineWebhookDeploymentReviewRequestedWorkflowRunConclusionXbf811727?
    ...
    private var triggeringActorState:
        FieldState<InlineWebhookDeploymentReviewRequestedWorkflowRunTriggeringActorXd9b2521f?> =
        FieldState.Absent
     ...
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var repository: InlineWebhookDeploymentReviewRequestedWorkflowRunRepositoryX4f263126?
      get() = repositoryState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): InlineWebhookDeploymentReviewRequestedWorkflowRunX00c9e685 {
      ...
      return InlineWebhookDeploymentReviewRequestedWorkflowRunX00c9e685(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookDeploymentReviewRequestedWorkflowRunX00c9e685 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookDeploymentReviewRequestedWorkflowRunX00c9e685> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookDeploymentReviewRequestedWorkflowRunX00c9e685 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookDeploymentReviewRequestedWorkflowRunX00c9e685")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookDeploymentReviewRequestedWorkflowRunX00c9e685 must be a JSON object")
      ...
      val pullRequests = json.decodeRequired<List<InlineWebhookDeploymentReviewRequestedWorkflowRunPullRequestsItemX5c1546c0>>(rawObject, "pull_requests")
      ...
      val status = json.decodeRequired<InlineWebhookDeploymentReviewRequestedWorkflowRunStatusXd18eb56d>(rawObject, "status")
      val updatedAt = json.decodeRequired<String>(rawObject, "updated_at")
      val url = json.decodeRequired<String>(rawObject, "url")
      val workflowId = json.decodeRequired<Int>(rawObject, "workflow_id")
      if (!rawObject.containsKey("actor")) {
        throw SerializationException("InlineWebhookDeploymentReviewRequestedWorkflowRunX00c9e685 is missing required property 'actor'")
      }
      val actor = rawObject["actor"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookDeploymentReviewRequestedWorkflowRunActorXa1f227ad?>(requireNotNull(element)) }
      if (!rawObject.containsKey("conclusion")) {
        throw SerializationException("InlineWebhookDeploymentReviewRequestedWorkflowRunX00c9e685 is missing required property 'conclusion'")
      }
      val conclusion = rawObject["conclusion"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookDeploymentReviewRequestedWorkflowRunConclusionXbf811727?>(requireNotNull(element)) }
      if (!rawObject.containsKey("triggering_actor")) {
        throw SerializationException("InlineWebhookDeploymentReviewRequestedWorkflowRunX00c9e685 is missing required property 'triggering_actor'")
      }
      val triggeringActor = rawObject["triggering_actor"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookDeploymentReviewRequestedWorkflowRunTriggeringActorXd9b2521f?>(requireNotNull(element)) }
      return InlineWebhookDeploymentReviewRequestedWorkflowRunX00c9e685(
        actor = actor,
        checkSuiteId = checkSuiteId,
        checkSuiteNodeId = checkSuiteNodeId,
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookDeploymentReviewRequestedWorkflowRunX00c9e685) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookDeploymentReviewRequestedWorkflowRunX00c9e685")
...
public fun inlineWebhookDeploymentReviewRequestedWorkflowRunX00c9e685(block: InlineWebhookDeploymentReviewRequestedWorkflowRunX00c9e685.Builder.() -> Unit): InlineWebhookDeploymentReviewRequestedWorkflowRunX00c9e685 = InlineWebhookDeploymentReviewRequestedWorkflowRunX00c9e685.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookDeploymentReviewRequestedWorkflowRunX00c9e685 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookDeploymentReviewRequestedWorkflowRunX00c9e685 property '" + name + "' is not nullable")
