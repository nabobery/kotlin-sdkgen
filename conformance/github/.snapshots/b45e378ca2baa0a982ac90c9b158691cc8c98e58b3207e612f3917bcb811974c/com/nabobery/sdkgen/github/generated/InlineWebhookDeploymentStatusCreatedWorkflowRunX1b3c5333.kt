...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-deployment-status-created/properties/workflow_run.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhook-deployment-status-created/properties/workflow_run
 */
@Serializable(with = InlineWebhookDeploymentStatusCreatedWorkflowRunX1b3c5333.Serializer::class)
public class InlineWebhookDeploymentStatusCreatedWorkflowRunX1b3c5333 internal constructor(
  public val actor: InlineWebhookDeploymentStatusCreatedWorkflowRunActorX42a08248?,
  public val checkSuiteId: Int,
  public val checkSuiteNodeId: String,
  public val conclusion: InlineWebhookDeploymentStatusCreatedWorkflowRunConclusionX8ac80719?,
  /**
  ...
  pullRequests: List<InlineWebhookDeploymentStatusCreatedWorkflowRunPullRequestsItemXb9e6b82c>,
  ...
  public val status: InlineWebhookDeploymentStatusCreatedWorkflowRunStatusX3e422667,
  public val triggeringActor:
      InlineWebhookDeploymentStatusCreatedWorkflowRunTriggeringActorX0391eb84?,
  /**
   * Wire format: `date-time`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  private val headCommitState: FieldState<JsonElement?>,
  private val headRepositoryState:
      FieldState<InlineWebhookDeploymentStatusCreatedWorkflowRunHeadRepositoryX9eede9e9>,
  private val jobsUrlState: FieldState<String>,
  private val logsUrlState: FieldState<String>,
  private val previousAttemptUrlState: FieldState<JsonElement?>,
  referencedWorkflowsState: FieldState<List<InlineWebhookDeploymentStatusCreatedWorkflowRunReferencedWorkflowsItemX7a91fe86>?>,
  private val repositoryState:
      FieldState<InlineWebhookDeploymentStatusCreatedWorkflowRunRepositoryX51b0038b>,
  private val rerunUrlState: FieldState<String>,
  private val workflowUrlState: FieldState<String>,
) {
  public val pullRequests:
      List<InlineWebhookDeploymentStatusCreatedWorkflowRunPullRequestsItemXb9e6b82c> =
      pullRequests.toList()

  private val referencedWorkflowsState:
      FieldState<List<InlineWebhookDeploymentStatusCreatedWorkflowRunReferencedWorkflowsItemX7a91fe86>?>
      =
  ...
  public val headCommit: JsonElement?
    get() = headCommitState.valueOrNull()

  public val headRepository: InlineWebhookDeploymentStatusCreatedWorkflowRunHeadRepositoryX9eede9e9?
  ...
  public val previousAttemptUrl: JsonElement?
    get() = previousAttemptUrlState.valueOrNull()

  public val referencedWorkflows:
      List<InlineWebhookDeploymentStatusCreatedWorkflowRunReferencedWorkflowsItemX7a91fe86>?
    get() = referencedWorkflowsState.valueOrNull()

  public val repository: InlineWebhookDeploymentStatusCreatedWorkflowRunRepositoryX51b0038b?
  ...
  public constructor(
    actor: InlineWebhookDeploymentStatusCreatedWorkflowRunActorX42a08248?,
    checkSuiteId: Int,
    checkSuiteNodeId: String,
    conclusion: InlineWebhookDeploymentStatusCreatedWorkflowRunConclusionX8ac80719?,
    createdAt: String,
    displayTitle: String,
    event: String,
    headBranch: String,
    ...
    runNumber: Int,
    runStartedAt: String,
    status: InlineWebhookDeploymentStatusCreatedWorkflowRunStatusX3e422667,
    triggeringActor: InlineWebhookDeploymentStatusCreatedWorkflowRunTriggeringActorX0391eb84?,
    updatedAt: String,
    url: String,
    workflowId: Int,
  ) : this(actor = actor,
  ...
  public class Builder {
    ...
    private var pullRequestsValue:
        List<InlineWebhookDeploymentStatusCreatedWorkflowRunPullRequestsItemXb9e6b82c>? = null
    ...
    private var statusValue: InlineWebhookDeploymentStatusCreatedWorkflowRunStatusX3e422667? = null

    public var status: InlineWebhookDeploymentStatusCreatedWorkflowRunStatusX3e422667
    ...
    private var actorState:
        FieldState<InlineWebhookDeploymentStatusCreatedWorkflowRunActorX42a08248?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var actor: InlineWebhookDeploymentStatusCreatedWorkflowRunActorX42a08248?
    ...
    private var conclusionState:
        FieldState<InlineWebhookDeploymentStatusCreatedWorkflowRunConclusionX8ac80719?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var conclusion: InlineWebhookDeploymentStatusCreatedWorkflowRunConclusionX8ac80719?
    ...
    private var triggeringActorState:
        FieldState<InlineWebhookDeploymentStatusCreatedWorkflowRunTriggeringActorX0391eb84?> =
        FieldState.Absent
    ...
    private var headCommitState: FieldState<JsonElement?> = FieldState.Absent

    /**
     * Assigning `null` records present-null; use the unset function to omit the property.
     */
    public var headCommit: JsonElement?
      get() = headCommitState.valueOrNull()
      set(`value`) {
    ...
    public var headRepository:
        InlineWebhookDeploymentStatusCreatedWorkflowRunHeadRepositoryX9eede9e9?
      get() = headRepositoryState.valueOrNull()
      set(`value`) {
    ...
    private var previousAttemptUrlState: FieldState<JsonElement?> = FieldState.Absent

    /**
     * Assigning `null` records present-null; use the unset function to omit the property.
     */
    public var previousAttemptUrl: JsonElement?
      get() = previousAttemptUrlState.valueOrNull()
      set(`value`) {
     ...
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var repository: InlineWebhookDeploymentStatusCreatedWorkflowRunRepositoryX51b0038b?
      get() = repositoryState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): InlineWebhookDeploymentStatusCreatedWorkflowRunX1b3c5333 {
      ...
      return InlineWebhookDeploymentStatusCreatedWorkflowRunX1b3c5333(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookDeploymentStatusCreatedWorkflowRunX1b3c5333 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookDeploymentStatusCreatedWorkflowRunX1b3c5333> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookDeploymentStatusCreatedWorkflowRunX1b3c5333 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookDeploymentStatusCreatedWorkflowRunX1b3c5333")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookDeploymentStatusCreatedWorkflowRunX1b3c5333 must be a JSON object")
      ...
      val pullRequests = json.decodeRequired<List<InlineWebhookDeploymentStatusCreatedWorkflowRunPullRequestsItemXb9e6b82c>>(rawObject, "pull_requests")
      ...
      val status = json.decodeRequired<InlineWebhookDeploymentStatusCreatedWorkflowRunStatusX3e422667>(rawObject, "status")
      val updatedAt = json.decodeRequired<String>(rawObject, "updated_at")
      val url = json.decodeRequired<String>(rawObject, "url")
      val workflowId = json.decodeRequired<Int>(rawObject, "workflow_id")
      if (!rawObject.containsKey("actor")) {
        throw SerializationException("InlineWebhookDeploymentStatusCreatedWorkflowRunX1b3c5333 is missing required property 'actor'")
      }
      val actor = rawObject["actor"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookDeploymentStatusCreatedWorkflowRunActorX42a08248?>(requireNotNull(element)) }
      if (!rawObject.containsKey("conclusion")) {
        throw SerializationException("InlineWebhookDeploymentStatusCreatedWorkflowRunX1b3c5333 is missing required property 'conclusion'")
      }
      val conclusion = rawObject["conclusion"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookDeploymentStatusCreatedWorkflowRunConclusionX8ac80719?>(requireNotNull(element)) }
      if (!rawObject.containsKey("triggering_actor")) {
        throw SerializationException("InlineWebhookDeploymentStatusCreatedWorkflowRunX1b3c5333 is missing required property 'triggering_actor'")
      }
      val triggeringActor = rawObject["triggering_actor"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookDeploymentStatusCreatedWorkflowRunTriggeringActorX0391eb84?>(requireNotNull(element)) }
      return InlineWebhookDeploymentStatusCreatedWorkflowRunX1b3c5333(
        actor = actor,
        checkSuiteId = checkSuiteId,
        checkSuiteNodeId = checkSuiteNodeId,
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookDeploymentStatusCreatedWorkflowRunX1b3c5333) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookDeploymentStatusCreatedWorkflowRunX1b3c5333")
...
public fun inlineWebhookDeploymentStatusCreatedWorkflowRunX1b3c5333(block: InlineWebhookDeploymentStatusCreatedWorkflowRunX1b3c5333.Builder.() -> Unit): InlineWebhookDeploymentStatusCreatedWorkflowRunX1b3c5333 = InlineWebhookDeploymentStatusCreatedWorkflowRunX1b3c5333.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookDeploymentStatusCreatedWorkflowRunX1b3c5333 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookDeploymentStatusCreatedWorkflowRunX1b3c5333 property '" + name + "' is not nullable")
