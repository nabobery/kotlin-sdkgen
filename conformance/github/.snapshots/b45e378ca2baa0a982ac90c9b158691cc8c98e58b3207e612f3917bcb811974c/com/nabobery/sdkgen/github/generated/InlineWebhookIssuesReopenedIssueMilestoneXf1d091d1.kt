 ...
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-reopened/properties/issue/properties/milestone
 */
@Serializable(with = InlineWebhookIssuesReopenedIssueMilestoneXf1d091d1.Serializer::class)
public class InlineWebhookIssuesReopenedIssueMilestoneXf1d091d1(
  /**
  ...
  public val creator: InlineWebhookIssuesReopenedIssueMilestoneCreatorX6e92025e?,
   ...
   */
  public val state: InlineWebhookIssuesReopenedIssueMilestoneStateXa62c145c,
  /**
  ...
  public class Builder {
    ...
    private var stateValue: InlineWebhookIssuesReopenedIssueMilestoneStateXa62c145c? = null

    public var state: InlineWebhookIssuesReopenedIssueMilestoneStateXa62c145c
    ...
    private var creatorState: FieldState<InlineWebhookIssuesReopenedIssueMilestoneCreatorX6e92025e?>
        = FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var creator: InlineWebhookIssuesReopenedIssueMilestoneCreatorX6e92025e?
    ...
    public fun build(): InlineWebhookIssuesReopenedIssueMilestoneXf1d091d1 {
      ...
      return InlineWebhookIssuesReopenedIssueMilestoneXf1d091d1(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesReopenedIssueMilestoneXf1d091d1 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesReopenedIssueMilestoneXf1d091d1> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesReopenedIssueMilestoneXf1d091d1 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesReopenedIssueMilestoneXf1d091d1")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesReopenedIssueMilestoneXf1d091d1 must be a JSON object")
      ...
      val state = json.decodeRequired<InlineWebhookIssuesReopenedIssueMilestoneStateXa62c145c>(rawObject, "state")
      val title = json.decodeRequired<String>(rawObject, "title")
      val updatedAt = json.decodeRequired<String>(rawObject, "updated_at")
      val url = json.decodeRequired<String>(rawObject, "url")
      if (!rawObject.containsKey("closed_at")) {
        throw SerializationException("InlineWebhookIssuesReopenedIssueMilestoneXf1d091d1 is missing required property 'closed_at'")
      }
      ...
      if (!rawObject.containsKey("creator")) {
        throw SerializationException("InlineWebhookIssuesReopenedIssueMilestoneXf1d091d1 is missing required property 'creator'")
      }
      val creator = rawObject["creator"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookIssuesReopenedIssueMilestoneCreatorX6e92025e?>(requireNotNull(element)) }
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookIssuesReopenedIssueMilestoneXf1d091d1 is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("due_on")) {
        throw SerializationException("InlineWebhookIssuesReopenedIssueMilestoneXf1d091d1 is missing required property 'due_on'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesReopenedIssueMilestoneXf1d091d1) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesReopenedIssueMilestoneXf1d091d1")
...
public fun inlineWebhookIssuesReopenedIssueMilestoneXf1d091d1(block: InlineWebhookIssuesReopenedIssueMilestoneXf1d091d1.Builder.() -> Unit): InlineWebhookIssuesReopenedIssueMilestoneXf1d091d1 = InlineWebhookIssuesReopenedIssueMilestoneXf1d091d1.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesReopenedIssueMilestoneXf1d091d1 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookIssuesReopenedIssueMilestoneXf1d091d1 property '" + name + "' is not nullable")
