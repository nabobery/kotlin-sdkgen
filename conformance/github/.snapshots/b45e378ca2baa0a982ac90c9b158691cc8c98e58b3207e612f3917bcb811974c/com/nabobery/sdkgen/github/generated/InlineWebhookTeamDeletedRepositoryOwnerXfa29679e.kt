...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-team-deleted/properties/repository/properties/owner.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhook-team-deleted/properties/repository/properties/owner
 */
@Serializable(with = InlineWebhookTeamDeletedRepositoryOwnerXfa29679e.Serializer::class)
public class InlineWebhookTeamDeletedRepositoryOwnerXfa29679e(
  public val id: Int,
  ...
  public val type: InlineWebhookTeamDeletedRepositoryOwnerTypeX9ebb7a55? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookTeamDeletedRepositoryOwnerTypeX9ebb7a55? = null
    ...
    public fun build(): InlineWebhookTeamDeletedRepositoryOwnerXfa29679e {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookTeamDeletedRepositoryOwnerXfa29679e(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookTeamDeletedRepositoryOwnerXfa29679e = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookTeamDeletedRepositoryOwnerXfa29679e> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookTeamDeletedRepositoryOwnerXfa29679e {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookTeamDeletedRepositoryOwnerXfa29679e")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookTeamDeletedRepositoryOwnerXfa29679e must be a JSON object")
      ...
      return InlineWebhookTeamDeletedRepositoryOwnerXfa29679e(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookTeamDeletedRepositoryOwnerTypeX9ebb7a55>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookTeamDeletedRepositoryOwnerXfa29679e) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookTeamDeletedRepositoryOwnerXfa29679e")
...
public fun inlineWebhookTeamDeletedRepositoryOwnerXfa29679e(block: InlineWebhookTeamDeletedRepositoryOwnerXfa29679e.Builder.() -> Unit): InlineWebhookTeamDeletedRepositoryOwnerXfa29679e = InlineWebhookTeamDeletedRepositoryOwnerXfa29679e.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookTeamDeletedRepositoryOwnerXfa29679e is missing required property '" + name + "'")
