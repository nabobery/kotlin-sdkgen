...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-commit-comment-created/properties/comment/properties/reactio
 * ns.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-commit-comment-created/properties/comment/properties/reactio
 * ns
 */
@Serializable(with = InlineWebhookCommitCommentCreatedCommentReactionsXd27f2ade.Serializer::class)
public class InlineWebhookCommitCommentCreatedCommentReactionsXd27f2ade(
  public val _1: Int,
  public val _12: Int,
  ...
  public class Builder {
    ...
    public fun build(): InlineWebhookCommitCommentCreatedCommentReactionsXd27f2ade {
      ...
      return InlineWebhookCommitCommentCreatedCommentReactionsXd27f2ade(
        _1 = _1,
        _12 = _12,
        confused = confused,
        eyes = eyes,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookCommitCommentCreatedCommentReactionsXd27f2ade = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookCommitCommentCreatedCommentReactionsXd27f2ade> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookCommitCommentCreatedCommentReactionsXd27f2ade {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookCommitCommentCreatedCommentReactionsXd27f2ade")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookCommitCommentCreatedCommentReactionsXd27f2ade must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookCommitCommentCreatedCommentReactionsXd27f2ade) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookCommitCommentCreatedCommentReactionsXd27f2ade")
...
public fun inlineWebhookCommitCommentCreatedCommentReactionsXd27f2ade(block: InlineWebhookCommitCommentCreatedCommentReactionsXd27f2ade.Builder.() -> Unit): InlineWebhookCommitCommentCreatedCommentReactionsXd27f2ade = InlineWebhookCommitCommentCreatedCommentReactionsXd27f2ade.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookCommitCommentCreatedCommentReactionsXd27f2ade is missing required property '" + name + "'")
