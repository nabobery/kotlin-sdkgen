 ...
 * roperties/head/properties/repo/properties/owner.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-review-comment-edited/properties/pull_request/p
 * roperties/head/properties/repo/properties/owner
 */
@Serializable(with = InlineWebhookPullRequestReviewCommentEditedPullRequestHeadRepoOwnerXe72e6afb.Serializer::class)
public class InlineWebhookPullRequestReviewCommentEditedPullRequestHeadRepoOwnerXe72e6afb(
  public val id: Int,
  ...
  public val type:
      InlineWebhookPullRequestReviewCommentEditedPullRequestHeadRepoOwnerTypeX2b4ef0ba? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public fun build(): InlineWebhookPullRequestReviewCommentEditedPullRequestHeadRepoOwnerXe72e6afb {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestReviewCommentEditedPullRequestHeadRepoOwnerXe72e6afb(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewCommentEditedPullRequestHeadRepoOwnerXe72e6afb = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewCommentEditedPullRequestHeadRepoOwnerXe72e6afb> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewCommentEditedPullRequestHeadRepoOwnerXe72e6afb {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewCommentEditedPullRequestHeadRepoOwnerXe72e6afb")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewCommentEditedPullRequestHeadRepoOwnerXe72e6afb must be a JSON object")
      ...
      return InlineWebhookPullRequestReviewCommentEditedPullRequestHeadRepoOwnerXe72e6afb(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestReviewCommentEditedPullRequestHeadRepoOwnerTypeX2b4ef0ba>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewCommentEditedPullRequestHeadRepoOwnerXe72e6afb) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewCommentEditedPullRequestHeadRepoOwnerXe72e6afb")
...
public fun inlineWebhookPullRequestReviewCommentEditedPullRequestHeadRepoOwnerXe72e6afb(block: InlineWebhookPullRequestReviewCommentEditedPullRequestHeadRepoOwnerXe72e6afb.Builder.() -> Unit): InlineWebhookPullRequestReviewCommentEditedPullRequestHeadRepoOwnerXe72e6afb = InlineWebhookPullRequestReviewCommentEditedPullRequestHeadRepoOwnerXe72e6afb.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewCommentEditedPullRequestHeadRepoOwnerXe72e6afb is missing required property '" + name + "'")
