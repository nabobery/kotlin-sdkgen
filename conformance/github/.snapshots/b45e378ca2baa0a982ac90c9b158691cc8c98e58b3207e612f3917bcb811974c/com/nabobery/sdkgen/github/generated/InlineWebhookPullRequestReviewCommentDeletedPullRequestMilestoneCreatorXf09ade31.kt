 ...
 * properties/milestone/properties/creator
 */
@Serializable(with = InlineWebhookPullRequestReviewCommentDeletedPullRequestMilestoneCreatorXf09ade31.Serializer::class)
public class InlineWebhookPullRequestReviewCommentDeletedPullRequestMilestoneCreatorXf09ade31(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestRe8fbbPullRequestMilestoneCreatorTypeX67adc64a? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestRe8fbbPullRequestMilestoneCreatorTypeX67adc64a? = null
    ...
    public fun build(): InlineWebhookPullRequestReviewCommentDeletedPullRequestMilestoneCreatorXf09ade31 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestReviewCommentDeletedPullRequestMilestoneCreatorXf09ade31(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewCommentDeletedPullRequestMilestoneCreatorXf09ade31 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewCommentDeletedPullRequestMilestoneCreatorXf09ade31> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewCommentDeletedPullRequestMilestoneCreatorXf09ade31 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewCommentDeletedPullRequestMilestoneCreatorXf09ade31")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewCommentDeletedPullRequestMilestoneCreatorXf09ade31 must be a JSON object")
      ...
      return InlineWebhookPullRequestReviewCommentDeletedPullRequestMilestoneCreatorXf09ade31(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestRe8fbbPullRequestMilestoneCreatorTypeX67adc64a>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewCommentDeletedPullRequestMilestoneCreatorXf09ade31) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewCommentDeletedPullRequestMilestoneCreatorXf09ade31")
...
public fun inlineWebhookPullRequestReviewCommentDeletedPullRequestMilestoneCreatorXf09ade31(block: InlineWebhookPullRequestReviewCommentDeletedPullRequestMilestoneCreatorXf09ade31.Builder.() -> Unit): InlineWebhookPullRequestReviewCommentDeletedPullRequestMilestoneCreatorXf09ade31 = InlineWebhookPullRequestReviewCommentDeletedPullRequestMilestoneCreatorXf09ade31.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewCommentDeletedPullRequestMilestoneCreatorXf09ade31 is missing required property '" + name + "'")
