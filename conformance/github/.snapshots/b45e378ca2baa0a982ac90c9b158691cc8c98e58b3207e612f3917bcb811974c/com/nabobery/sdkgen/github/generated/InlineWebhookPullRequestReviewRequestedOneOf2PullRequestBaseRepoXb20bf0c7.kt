 ...
 */
@Serializable(with = InlineWebhookPullRequestReviewRequestedOneOf2PullRequestBaseRepoXb20bf0c7.Serializer::class)
public class InlineWebhookPullRequestReviewRequestedOneOf2PullRequestBaseRepoXb20bf0c7 internal constructor(
  /**
  ...
  public val createdAt: InlineWebhookPullRequestReffb1OneOf2PullRequestBaseRepoCreatedAtX9359ad9c,
  /**
  ...
  public val license:
      InlineWebhookPullRequestReviewRequestedOneOf2PullRequestBaseRepoLicenseXd6b3483a?,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val owner: InlineWebhookPullRequestReviewRequestedOneOf2PullRequestBaseRepoOwnerX2ffa4e9e?,
  /**
  ...
  public val pushedAt: InlineWebhookPullRequestReffb1OneOf2PullRequestBaseRepoPushedAtX284a2aa1?,
  /**
   * Wire format: `uri-template`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val visibility: InlineWebhookPullRequestReffb1OneOf2PullRequestBaseRepoVisibilityX8c163e9d,
  ...
  private val mergeCommitMessageState:
      FieldState<InlineWebhookPullRequestReffb1OneOf2PullRequestBaseMergeCommitMessageX96f7d67c>,
  private val mergeCommitTitleState:
      FieldState<InlineWebhookPullRequestReffb1OneOf2PullRequestBaseRepoMergeCommitTitleXb1afa990>,
  private val organizationState: FieldState<String>,
  private val permissionsState:
      FieldState<InlineWebhookPullRequestReffb1OneOf2PullRequestBaseRepoPermissionsXfcc58f3a>,
  private val publicState: FieldState<Boolean>,
  private val pullRequestCreationPolicyState:
      FieldState<InlineWebhookPullRequestReffb1OneOf2PullRequestPullRequestCreationP824dXc9fa65c5>,
  private val roleNameState: FieldState<String?>,
  private val squashMergeCommitMessageState:
      FieldState<InlineWebhookPullRequestReffb1OneOf2PullRequestSquashMergeCommitMessageX5a70925d>,
  private val squashMergeCommitTitleState:
      FieldState<InlineWebhookPullRequestReffb1OneOf2PullRequestSquashMergeCommitTitleX5a9fa409>,
  ...
  public val permissions:
      InlineWebhookPullRequestReffb1OneOf2PullRequestBaseRepoPermissionsXfcc58f3a?
  ...
  public val squashMergeCommitTitle:
      InlineWebhookPullRequestReffb1OneOf2PullRequestSquashMergeCommitTitleX5a9fa409?
  ...
  public constructor(
    ...
    createdAt: InlineWebhookPullRequestReffb1OneOf2PullRequestBaseRepoCreatedAtX9359ad9c,
    ...
    language: String?,
    languagesUrl: String,
    license: InlineWebhookPullRequestReviewRequestedOneOf2PullRequestBaseRepoLicenseXd6b3483a?,
    mergesUrl: String,
    ...
    openIssues: Int,
    openIssuesCount: Int,
    owner: InlineWebhookPullRequestReviewRequestedOneOf2PullRequestBaseRepoOwnerX2ffa4e9e?,
    `private`: Boolean,
    pullsUrl: String,
    pushedAt: InlineWebhookPullRequestReffb1OneOf2PullRequestBaseRepoPushedAtX284a2aa1?,
    releasesUrl: String,
    size: Int,
    sshUrl: String,
    stargazersCount: Int,
    ...
    updatedAt: String,
    url: String,
    visibility: InlineWebhookPullRequestReffb1OneOf2PullRequestBaseRepoVisibilityX8c163e9d,
    watchers: Int,
    watchersCount: Int,
  ...
  public class Builder {
    ...
    private var createdAtValue:
        InlineWebhookPullRequestReffb1OneOf2PullRequestBaseRepoCreatedAtX9359ad9c? = null

    public var createdAt: InlineWebhookPullRequestReffb1OneOf2PullRequestBaseRepoCreatedAtX9359ad9c
    ...
    private var visibilityValue:
        InlineWebhookPullRequestReffb1OneOf2PullRequestBaseRepoVisibilityX8c163e9d? = null
    ...
    private var licenseState:
        FieldState<InlineWebhookPullRequestReviewRequestedOneOf2PullRequestBaseRepoLicenseXd6b3483a?>
        = FieldState.Absent
    ...
    private var ownerState:
        FieldState<InlineWebhookPullRequestReviewRequestedOneOf2PullRequestBaseRepoOwnerX2ffa4e9e?>
        = FieldState.Absent
     ...
     */
    public var owner:
        InlineWebhookPullRequestReviewRequestedOneOf2PullRequestBaseRepoOwnerX2ffa4e9e?
    ...
    private var pushedAtState:
        FieldState<InlineWebhookPullRequestReffb1OneOf2PullRequestBaseRepoPushedAtX284a2aa1?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var pushedAt: InlineWebhookPullRequestReffb1OneOf2PullRequestBaseRepoPushedAtX284a2aa1?
    ...
    public fun build(): InlineWebhookPullRequestReviewRequestedOneOf2PullRequestBaseRepoXb20bf0c7 {
      ...
      return InlineWebhookPullRequestReviewRequestedOneOf2PullRequestBaseRepoXb20bf0c7(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewRequestedOneOf2PullRequestBaseRepoXb20bf0c7 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewRequestedOneOf2PullRequestBaseRepoXb20bf0c7> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewRequestedOneOf2PullRequestBaseRepoXb20bf0c7 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewRequestedOneOf2PullRequestBaseRepoXb20bf0c7")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewRequestedOneOf2PullRequestBaseRepoXb20bf0c7 must be a JSON object")
      ...
      val createdAt = json.decodeRequired<InlineWebhookPullRequestReffb1OneOf2PullRequestBaseRepoCreatedAtX9359ad9c>(rawObject, "created_at")
      ...
      val visibility = json.decodeRequired<InlineWebhookPullRequestReffb1OneOf2PullRequestBaseRepoVisibilityX8c163e9d>(rawObject, "visibility")
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookPullRequestReviewRequestedOneOf2PullRequestBaseRepoXb20bf0c7 is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("homepage")) {
        throw SerializationException("InlineWebhookPullRequestReviewRequestedOneOf2PullRequestBaseRepoXb20bf0c7 is missing required property 'homepage'")
      }
      ...
      if (!rawObject.containsKey("language")) {
        throw SerializationException("InlineWebhookPullRequestReviewRequestedOneOf2PullRequestBaseRepoXb20bf0c7 is missing required property 'language'")
      }
      ...
      if (!rawObject.containsKey("license")) {
        throw SerializationException("InlineWebhookPullRequestReviewRequestedOneOf2PullRequestBaseRepoXb20bf0c7 is missing required property 'license'")
      }
      val license = rawObject["license"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestReviewRequestedOneOf2PullRequestBaseRepoLicenseXd6b3483a?>(requireNotNull(element)) }
      if (!rawObject.containsKey("mirror_url")) {
        throw SerializationException("InlineWebhookPullRequestReviewRequestedOneOf2PullRequestBaseRepoXb20bf0c7 is missing required property 'mirror_url'")
      }
      ...
      if (!rawObject.containsKey("owner")) {
        throw SerializationException("InlineWebhookPullRequestReviewRequestedOneOf2PullRequestBaseRepoXb20bf0c7 is missing required property 'owner'")
      }
      val owner = rawObject["owner"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestReviewRequestedOneOf2PullRequestBaseRepoOwnerX2ffa4e9e?>(requireNotNull(element)) }
      if (!rawObject.containsKey("pushed_at")) {
        throw SerializationException("InlineWebhookPullRequestReviewRequestedOneOf2PullRequestBaseRepoXb20bf0c7 is missing required property 'pushed_at'")
      }
      val pushedAt = rawObject["pushed_at"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestReffb1OneOf2PullRequestBaseRepoPushedAtX284a2aa1?>(requireNotNull(element)) }
      return InlineWebhookPullRequestReviewRequestedOneOf2PullRequestBaseRepoXb20bf0c7(
        archiveUrl = archiveUrl,
        archived = archived,
        assigneesUrl = assigneesUrl,
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewRequestedOneOf2PullRequestBaseRepoXb20bf0c7) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewRequestedOneOf2PullRequestBaseRepoXb20bf0c7")
...
public fun inlineWebhookPullRequestReviewRequestedOneOf2PullRequestBaseRepoXb20bf0c7(block: InlineWebhookPullRequestReviewRequestedOneOf2PullRequestBaseRepoXb20bf0c7.Builder.() -> Unit): InlineWebhookPullRequestReviewRequestedOneOf2PullRequestBaseRepoXb20bf0c7 = InlineWebhookPullRequestReviewRequestedOneOf2PullRequestBaseRepoXb20bf0c7.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewRequestedOneOf2PullRequestBaseRepoXb20bf0c7 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookPullRequestReviewRequestedOneOf2PullRequestBaseRepoXb20bf0c7 property '" + name + "' is not nullable")
