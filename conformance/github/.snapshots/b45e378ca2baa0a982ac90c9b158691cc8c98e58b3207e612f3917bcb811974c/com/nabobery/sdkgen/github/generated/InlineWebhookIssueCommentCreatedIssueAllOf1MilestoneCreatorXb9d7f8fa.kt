 ...
 * lestone/properties/creator
 */
@Serializable(with = InlineWebhookIssueCommentCreatedIssueAllOf1MilestoneCreatorXb9d7f8fa.Serializer::class)
public class InlineWebhookIssueCommentCreatedIssueAllOf1MilestoneCreatorXb9d7f8fa(
  public val id: Int,
  ...
  public val type: InlineWebhookIssueCommentCreatedIssueAllOf1MilestoneCreatorTypeXca9355d7? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookIssueCommentCreatedIssueAllOf1MilestoneCreatorTypeXca9355d7? =
        null
    ...
    public fun build(): InlineWebhookIssueCommentCreatedIssueAllOf1MilestoneCreatorXb9d7f8fa {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssueCommentCreatedIssueAllOf1MilestoneCreatorXb9d7f8fa(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssueCommentCreatedIssueAllOf1MilestoneCreatorXb9d7f8fa = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssueCommentCreatedIssueAllOf1MilestoneCreatorXb9d7f8fa> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssueCommentCreatedIssueAllOf1MilestoneCreatorXb9d7f8fa {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssueCommentCreatedIssueAllOf1MilestoneCreatorXb9d7f8fa")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssueCommentCreatedIssueAllOf1MilestoneCreatorXb9d7f8fa must be a JSON object")
      ...
      return InlineWebhookIssueCommentCreatedIssueAllOf1MilestoneCreatorXb9d7f8fa(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssueCommentCreatedIssueAllOf1MilestoneCreatorTypeXca9355d7>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssueCommentCreatedIssueAllOf1MilestoneCreatorXb9d7f8fa) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssueCommentCreatedIssueAllOf1MilestoneCreatorXb9d7f8fa")
...
public fun inlineWebhookIssueCommentCreatedIssueAllOf1MilestoneCreatorXb9d7f8fa(block: InlineWebhookIssueCommentCreatedIssueAllOf1MilestoneCreatorXb9d7f8fa.Builder.() -> Unit): InlineWebhookIssueCommentCreatedIssueAllOf1MilestoneCreatorXb9d7f8fa = InlineWebhookIssueCommentCreatedIssueAllOf1MilestoneCreatorXb9d7f8fa.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssueCommentCreatedIssueAllOf1MilestoneCreatorXb9d7f8fa is missing required property '" + name + "'")
