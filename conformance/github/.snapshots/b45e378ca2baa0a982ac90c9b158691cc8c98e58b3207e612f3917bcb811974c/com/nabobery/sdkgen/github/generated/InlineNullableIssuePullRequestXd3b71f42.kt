...
/**
 * Generated model for sdkgen://source/openapi.yaml#/components/schemas/nullable-issue/properties/pull_request.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/nullable-issue/properties/pull_request
 */
@Serializable(with = InlineNullableIssuePullRequestXd3b71f42.Serializer::class)
public class InlineNullableIssuePullRequestXd3b71f42 internal constructor(
  /**
  ...
  public class Builder {
    ...
    public fun build(): InlineNullableIssuePullRequestXd3b71f42 {
      ...
      return InlineNullableIssuePullRequestXd3b71f42(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineNullableIssuePullRequestXd3b71f42 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineNullableIssuePullRequestXd3b71f42> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineNullableIssuePullRequestXd3b71f42 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineNullableIssuePullRequestXd3b71f42")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineNullableIssuePullRequestXd3b71f42 must be a JSON object")
      if (!rawObject.containsKey("diff_url")) {
        throw SerializationException("InlineNullableIssuePullRequestXd3b71f42 is missing required property 'diff_url'")
      }
      ...
      if (!rawObject.containsKey("html_url")) {
        throw SerializationException("InlineNullableIssuePullRequestXd3b71f42 is missing required property 'html_url'")
      }
      ...
      if (!rawObject.containsKey("patch_url")) {
        throw SerializationException("InlineNullableIssuePullRequestXd3b71f42 is missing required property 'patch_url'")
      }
      ...
      if (!rawObject.containsKey("url")) {
        throw SerializationException("InlineNullableIssuePullRequestXd3b71f42 is missing required property 'url'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineNullableIssuePullRequestXd3b71f42) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineNullableIssuePullRequestXd3b71f42")
...
public fun inlineNullableIssuePullRequestXd3b71f42(block: InlineNullableIssuePullRequestXd3b71f42.Builder.() -> Unit): InlineNullableIssuePullRequestXd3b71f42 = InlineNullableIssuePullRequestXd3b71f42.build(block)
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineNullableIssuePullRequestXd3b71f42 property '" + name + "' is not nullable")
