 ...
 * ties/head/properties/repo
 */
@Serializable(with = InlineWebhookPullRequestReviewSubmittedPullRequestHeadRepoX4dbc2762.Serializer::class)
public class InlineWebhookPullRequestReviewSubmittedPullRequestHeadRepoX4dbc2762 internal constructor(
  /**
  ...
  public val createdAt:
      InlineWebhookPullRequestReviewSubmittedPullRequestHeadRepoCreatedAtX81f8d49d,
  /**
  ...
  public val license: InlineWebhookPullRequestReviewSubmittedPullRequestHeadRepoLicenseX4d6defcb?,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val owner: InlineWebhookPullRequestReviewSubmittedPullRequestHeadRepoOwnerX5159264d?,
  /**
  ...
  public val pushedAt: InlineWebhookPullRequestReviewSubmittedPullRequestHeadRepoPushedAtX7e211a78?,
  /**
   * Wire format: `uri-template`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  private val mergeCommitMessageState:
      FieldState<InlineWebhookPullRequestRe5d81PullRequestHeadRepoMergeCommitMessageX2b2cd8db>,
  private val mergeCommitTitleState:
      FieldState<InlineWebhookPullRequestRe5d81PullRequestHeadRepoMergeCommitTitleX4a778627>,
  private val organizationState: FieldState<String>,
  private val permissionsState:
      FieldState<InlineWebhookPullRequestReviewSubmittedPullRequestHeadRepoPermissionsXfec50f5b>,
  private val publicState: FieldState<Boolean>,
  private val pullRequestCreationPolicyState:
      FieldState<InlineWebhookPullRequestRe5d81PullRequestHeadPullRequestCreationP824dX11c826a8>,
  private val roleNameState: FieldState<String?>,
  private val squashMergeCommitMessageState:
      FieldState<InlineWebhookPullRequestRe5d81PullRequestHeadSquashMergeCommitMessageXfb98693d>,
  private val squashMergeCommitTitleState:
      FieldState<InlineWebhookPullRequestRe5d81PullRequestHeadRepoSquashMergeCommitTitleXb79df794>,
  ...
  public val permissions:
      InlineWebhookPullRequestReviewSubmittedPullRequestHeadRepoPermissionsXfec50f5b?
  ...
  public val squashMergeCommitMessage:
      InlineWebhookPullRequestRe5d81PullRequestHeadSquashMergeCommitMessageXfb98693d?
  ...
  public constructor(
    ...
    createdAt: InlineWebhookPullRequestReviewSubmittedPullRequestHeadRepoCreatedAtX81f8d49d,
    ...
    language: String?,
    languagesUrl: String,
    license: InlineWebhookPullRequestReviewSubmittedPullRequestHeadRepoLicenseX4d6defcb?,
    mergesUrl: String,
    ...
    openIssues: Int,
    openIssuesCount: Int,
    owner: InlineWebhookPullRequestReviewSubmittedPullRequestHeadRepoOwnerX5159264d?,
    `private`: Boolean,
    pullsUrl: String,
    pushedAt: InlineWebhookPullRequestReviewSubmittedPullRequestHeadRepoPushedAtX7e211a78?,
    releasesUrl: String,
    size: Int,
    sshUrl: String,
    stargazersCount: Int,
    ...
    updatedAt: String,
    url: String,
    visibility: InlineWebhookPullRequestReviewSubmittedPullRequestHeadRepoVisibilityX0bef7156,
    watchers: Int,
    watchersCount: Int,
  ...
  public class Builder {
    ...
    private var createdAtValue:
        InlineWebhookPullRequestReviewSubmittedPullRequestHeadRepoCreatedAtX81f8d49d? = null
    ...
    private var visibilityValue:
        InlineWebhookPullRequestReviewSubmittedPullRequestHeadRepoVisibilityX0bef7156? = null
    ...
    private var licenseState:
        FieldState<InlineWebhookPullRequestReviewSubmittedPullRequestHeadRepoLicenseX4d6defcb?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var license: InlineWebhookPullRequestReviewSubmittedPullRequestHeadRepoLicenseX4d6defcb?
    ...
    private var ownerState:
        FieldState<InlineWebhookPullRequestReviewSubmittedPullRequestHeadRepoOwnerX5159264d?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var owner: InlineWebhookPullRequestReviewSubmittedPullRequestHeadRepoOwnerX5159264d?
    ...
    private var pushedAtState:
        FieldState<InlineWebhookPullRequestReviewSubmittedPullRequestHeadRepoPushedAtX7e211a78?> =
        FieldState.Absent
     ...
     */
    public var pushedAt:
        InlineWebhookPullRequestReviewSubmittedPullRequestHeadRepoPushedAtX7e211a78?
    ...
    public fun build(): InlineWebhookPullRequestReviewSubmittedPullRequestHeadRepoX4dbc2762 {
      ...
      return InlineWebhookPullRequestReviewSubmittedPullRequestHeadRepoX4dbc2762(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewSubmittedPullRequestHeadRepoX4dbc2762 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewSubmittedPullRequestHeadRepoX4dbc2762> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewSubmittedPullRequestHeadRepoX4dbc2762 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewSubmittedPullRequestHeadRepoX4dbc2762")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewSubmittedPullRequestHeadRepoX4dbc2762 must be a JSON object")
      ...
      val createdAt = json.decodeRequired<InlineWebhookPullRequestReviewSubmittedPullRequestHeadRepoCreatedAtX81f8d49d>(rawObject, "created_at")
      ...
      val visibility = json.decodeRequired<InlineWebhookPullRequestReviewSubmittedPullRequestHeadRepoVisibilityX0bef7156>(rawObject, "visibility")
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookPullRequestReviewSubmittedPullRequestHeadRepoX4dbc2762 is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("homepage")) {
        throw SerializationException("InlineWebhookPullRequestReviewSubmittedPullRequestHeadRepoX4dbc2762 is missing required property 'homepage'")
      }
      ...
      if (!rawObject.containsKey("language")) {
        throw SerializationException("InlineWebhookPullRequestReviewSubmittedPullRequestHeadRepoX4dbc2762 is missing required property 'language'")
      }
      ...
      if (!rawObject.containsKey("license")) {
        throw SerializationException("InlineWebhookPullRequestReviewSubmittedPullRequestHeadRepoX4dbc2762 is missing required property 'license'")
      }
      val license = rawObject["license"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestReviewSubmittedPullRequestHeadRepoLicenseX4d6defcb?>(requireNotNull(element)) }
      if (!rawObject.containsKey("mirror_url")) {
        throw SerializationException("InlineWebhookPullRequestReviewSubmittedPullRequestHeadRepoX4dbc2762 is missing required property 'mirror_url'")
      }
      ...
      if (!rawObject.containsKey("owner")) {
        throw SerializationException("InlineWebhookPullRequestReviewSubmittedPullRequestHeadRepoX4dbc2762 is missing required property 'owner'")
      }
      val owner = rawObject["owner"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestReviewSubmittedPullRequestHeadRepoOwnerX5159264d?>(requireNotNull(element)) }
      if (!rawObject.containsKey("pushed_at")) {
        throw SerializationException("InlineWebhookPullRequestReviewSubmittedPullRequestHeadRepoX4dbc2762 is missing required property 'pushed_at'")
      }
      val pushedAt = rawObject["pushed_at"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestReviewSubmittedPullRequestHeadRepoPushedAtX7e211a78?>(requireNotNull(element)) }
      return InlineWebhookPullRequestReviewSubmittedPullRequestHeadRepoX4dbc2762(
        archiveUrl = archiveUrl,
        archived = archived,
        assigneesUrl = assigneesUrl,
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewSubmittedPullRequestHeadRepoX4dbc2762) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewSubmittedPullRequestHeadRepoX4dbc2762")
...
public fun inlineWebhookPullRequestReviewSubmittedPullRequestHeadRepoX4dbc2762(block: InlineWebhookPullRequestReviewSubmittedPullRequestHeadRepoX4dbc2762.Builder.() -> Unit): InlineWebhookPullRequestReviewSubmittedPullRequestHeadRepoX4dbc2762 = InlineWebhookPullRequestReviewSubmittedPullRequestHeadRepoX4dbc2762.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewSubmittedPullRequestHeadRepoX4dbc2762 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookPullRequestReviewSubmittedPullRequestHeadRepoX4dbc2762 property '" + name + "' is not nullable")
