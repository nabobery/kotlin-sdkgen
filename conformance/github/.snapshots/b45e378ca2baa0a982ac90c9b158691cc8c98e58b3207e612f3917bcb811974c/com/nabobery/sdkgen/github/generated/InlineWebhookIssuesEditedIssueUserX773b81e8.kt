...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-edited/properties/issue/properties/user.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-edited/properties/issue/properties/user
 */
@Serializable(with = InlineWebhookIssuesEditedIssueUserX773b81e8.Serializer::class)
public class InlineWebhookIssuesEditedIssueUserX773b81e8(
  public val id: Long,
  ...
  public val type: InlineWebhookIssuesEditedIssueUserTypeXa0d59124? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookIssuesEditedIssueUserTypeXa0d59124? = null
    ...
    public fun build(): InlineWebhookIssuesEditedIssueUserX773b81e8 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssuesEditedIssueUserX773b81e8(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesEditedIssueUserX773b81e8 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesEditedIssueUserX773b81e8> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesEditedIssueUserX773b81e8 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesEditedIssueUserX773b81e8")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesEditedIssueUserX773b81e8 must be a JSON object")
      ...
      return InlineWebhookIssuesEditedIssueUserX773b81e8(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssuesEditedIssueUserTypeXa0d59124>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesEditedIssueUserX773b81e8) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesEditedIssueUserX773b81e8")
...
public fun inlineWebhookIssuesEditedIssueUserX773b81e8(block: InlineWebhookIssuesEditedIssueUserX773b81e8.Builder.() -> Unit): InlineWebhookIssuesEditedIssueUserX773b81e8 = InlineWebhookIssuesEditedIssueUserX773b81e8.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesEditedIssueUserX773b81e8 is missing required property '" + name + "'")
