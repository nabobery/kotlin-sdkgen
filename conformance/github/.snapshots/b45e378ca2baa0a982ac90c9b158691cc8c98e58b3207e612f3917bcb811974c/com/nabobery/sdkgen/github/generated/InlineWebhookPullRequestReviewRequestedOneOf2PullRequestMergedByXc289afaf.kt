 ...
 * t/properties/merged_by.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-review-requested/oneOf/1/properties/pull_reques
 * t/properties/merged_by
 */
@Serializable(with = InlineWebhookPullRequestReviewRequestedOneOf2PullRequestMergedByXc289afaf.Serializer::class)
public class InlineWebhookPullRequestReviewRequestedOneOf2PullRequestMergedByXc289afaf(
  public val id: Int,
  ...
  public val type:
      InlineWebhookPullRequestReviewRequestedOneOf2PullRequestMergedByTypeX1f6c77f3? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestReviewRequestedOneOf2PullRequestMergedByTypeX1f6c77f3?
        = null
    ...
    public fun build(): InlineWebhookPullRequestReviewRequestedOneOf2PullRequestMergedByXc289afaf {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestReviewRequestedOneOf2PullRequestMergedByXc289afaf(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewRequestedOneOf2PullRequestMergedByXc289afaf = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewRequestedOneOf2PullRequestMergedByXc289afaf> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewRequestedOneOf2PullRequestMergedByXc289afaf {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewRequestedOneOf2PullRequestMergedByXc289afaf")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewRequestedOneOf2PullRequestMergedByXc289afaf must be a JSON object")
      ...
      return InlineWebhookPullRequestReviewRequestedOneOf2PullRequestMergedByXc289afaf(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestReviewRequestedOneOf2PullRequestMergedByTypeX1f6c77f3>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewRequestedOneOf2PullRequestMergedByXc289afaf) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewRequestedOneOf2PullRequestMergedByXc289afaf")
...
public fun inlineWebhookPullRequestReviewRequestedOneOf2PullRequestMergedByXc289afaf(block: InlineWebhookPullRequestReviewRequestedOneOf2PullRequestMergedByXc289afaf.Builder.() -> Unit): InlineWebhookPullRequestReviewRequestedOneOf2PullRequestMergedByXc289afaf = InlineWebhookPullRequestReviewRequestedOneOf2PullRequestMergedByXc289afaf.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewRequestedOneOf2PullRequestMergedByXc289afaf is missing required property '" + name + "'")
