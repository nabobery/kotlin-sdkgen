 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/nullable-issue-comment
 */
@Serializable(with = NullableIssueComment.Serializer::class)
public class NullableIssueComment internal constructor(
  /**
  ...
  public class Builder {
    ...
    public fun build(): NullableIssueComment {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): NullableIssueComment = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<NullableIssueComment> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): NullableIssueComment {
      val jsonDecoder = decoder.requireJsonDecoder("NullableIssueComment")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("NullableIssueComment must be a JSON object")
      ...
      if (!rawObject.containsKey("user")) {
        throw SerializationException("NullableIssueComment is missing required property 'user'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: NullableIssueComment) {
      val jsonEncoder = encoder.requireJsonEncoder("NullableIssueComment")
...
public fun nullableIssueComment(block: NullableIssueComment.Builder.() -> Unit): NullableIssueComment = NullableIssueComment.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("NullableIssueComment is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("NullableIssueComment property '" + name + "' is not nullable")
