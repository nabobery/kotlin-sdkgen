...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/components/schemas/webhooks_issue_2/properties/milestone/properties/creator.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhooks_issue_2/properties/milestone/properties/creator
 */
@Serializable(with = InlineWebhooksIssue2MilestoneCreatorX2508857c.Serializer::class)
public class InlineWebhooksIssue2MilestoneCreatorX2508857c(
  public val id: Int,
  ...
  public val type: InlineWebhooksIssue2MilestoneCreatorTypeXcb657a29? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhooksIssue2MilestoneCreatorTypeXcb657a29? = null
    ...
    public fun build(): InlineWebhooksIssue2MilestoneCreatorX2508857c {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhooksIssue2MilestoneCreatorX2508857c(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhooksIssue2MilestoneCreatorX2508857c = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhooksIssue2MilestoneCreatorX2508857c> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhooksIssue2MilestoneCreatorX2508857c {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhooksIssue2MilestoneCreatorX2508857c")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhooksIssue2MilestoneCreatorX2508857c must be a JSON object")
      ...
      return InlineWebhooksIssue2MilestoneCreatorX2508857c(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhooksIssue2MilestoneCreatorTypeXcb657a29>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhooksIssue2MilestoneCreatorX2508857c) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhooksIssue2MilestoneCreatorX2508857c")
...
public fun inlineWebhooksIssue2MilestoneCreatorX2508857c(block: InlineWebhooksIssue2MilestoneCreatorX2508857c.Builder.() -> Unit): InlineWebhooksIssue2MilestoneCreatorX2508857c = InlineWebhooksIssue2MilestoneCreatorX2508857c.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhooksIssue2MilestoneCreatorX2508857c is missing required property '" + name + "'")
