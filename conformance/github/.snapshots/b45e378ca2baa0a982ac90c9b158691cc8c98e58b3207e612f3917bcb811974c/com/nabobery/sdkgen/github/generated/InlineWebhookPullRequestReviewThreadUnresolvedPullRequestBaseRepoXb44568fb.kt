 ...
 */
@Serializable(with = InlineWebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoXb44568fb.Serializer::class)
public class InlineWebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoXb44568fb internal constructor(
  /**
  ...
  public val createdAt: InlineWebhookPullRequestRe5e87PullRequestBaseRepoCreatedAtX658c6b27,
  /**
  ...
  public val license: InlineWebhookPullRequestRe5e87PullRequestBaseRepoLicenseX7460651a?,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val owner:
      InlineWebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoOwnerX315811a3?,
  /**
  ...
  public val pushedAt: InlineWebhookPullRequestRe5e87PullRequestBaseRepoPushedAtX2c5b7d12?,
  /**
   * Wire format: `uri-template`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val visibility: InlineWebhookPullRequestRe5e87PullRequestBaseRepoVisibilityXd47371fe,
  ...
  private val permissionsState:
      FieldState<InlineWebhookPullRequestRe5e87PullRequestBaseRepoPermissionsXe627736b>,
  private val publicState: FieldState<Boolean>,
  private val pullRequestCreationPolicyState:
      FieldState<InlineWebhookPullRequestRe5e87PullRequestBasePullRequestCreationP824dX1d265532>,
  ...
  public val permissions: InlineWebhookPullRequestRe5e87PullRequestBaseRepoPermissionsXe627736b?
  ...
  public val pullRequestCreationPolicy:
      InlineWebhookPullRequestRe5e87PullRequestBasePullRequestCreationP824dX1d265532?
  ...
  public constructor(
    ...
    createdAt: InlineWebhookPullRequestRe5e87PullRequestBaseRepoCreatedAtX658c6b27,
    ...
    language: String?,
    languagesUrl: String,
    license: InlineWebhookPullRequestRe5e87PullRequestBaseRepoLicenseX7460651a?,
    mergesUrl: String,
    ...
    openIssues: Int,
    openIssuesCount: Int,
    owner: InlineWebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoOwnerX315811a3?,
    `private`: Boolean,
    pullsUrl: String,
    pushedAt: InlineWebhookPullRequestRe5e87PullRequestBaseRepoPushedAtX2c5b7d12?,
    releasesUrl: String,
    size: Int,
    sshUrl: String,
    stargazersCount: Int,
    ...
    updatedAt: String,
    url: String,
    visibility: InlineWebhookPullRequestRe5e87PullRequestBaseRepoVisibilityXd47371fe,
    watchers: Int,
    watchersCount: Int,
  ...
  public class Builder {
    ...
    private var createdAtValue: InlineWebhookPullRequestRe5e87PullRequestBaseRepoCreatedAtX658c6b27?
        = null

    public var createdAt: InlineWebhookPullRequestRe5e87PullRequestBaseRepoCreatedAtX658c6b27
    ...
    private var visibilityValue:
        InlineWebhookPullRequestRe5e87PullRequestBaseRepoVisibilityXd47371fe? = null

    public var visibility: InlineWebhookPullRequestRe5e87PullRequestBaseRepoVisibilityXd47371fe
    ...
    private var licenseState:
        FieldState<InlineWebhookPullRequestRe5e87PullRequestBaseRepoLicenseX7460651a?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var license: InlineWebhookPullRequestRe5e87PullRequestBaseRepoLicenseX7460651a?
    ...
    private var ownerState:
        FieldState<InlineWebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoOwnerX315811a3?>
        = FieldState.Absent
    ...
    private var pushedAtState:
        FieldState<InlineWebhookPullRequestRe5e87PullRequestBaseRepoPushedAtX2c5b7d12?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var pushedAt: InlineWebhookPullRequestRe5e87PullRequestBaseRepoPushedAtX2c5b7d12?
     ...
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var permissions: InlineWebhookPullRequestRe5e87PullRequestBaseRepoPermissionsXe627736b?
      get() = permissionsState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): InlineWebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoXb44568fb {
      ...
      return InlineWebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoXb44568fb(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoXb44568fb = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoXb44568fb> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoXb44568fb {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoXb44568fb")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoXb44568fb must be a JSON object")
      ...
      val createdAt = json.decodeRequired<InlineWebhookPullRequestRe5e87PullRequestBaseRepoCreatedAtX658c6b27>(rawObject, "created_at")
      ...
      val visibility = json.decodeRequired<InlineWebhookPullRequestRe5e87PullRequestBaseRepoVisibilityXd47371fe>(rawObject, "visibility")
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoXb44568fb is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("homepage")) {
        throw SerializationException("InlineWebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoXb44568fb is missing required property 'homepage'")
      }
      ...
      if (!rawObject.containsKey("language")) {
        throw SerializationException("InlineWebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoXb44568fb is missing required property 'language'")
      }
      ...
      if (!rawObject.containsKey("license")) {
        throw SerializationException("InlineWebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoXb44568fb is missing required property 'license'")
      }
      val license = rawObject["license"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestRe5e87PullRequestBaseRepoLicenseX7460651a?>(requireNotNull(element)) }
      if (!rawObject.containsKey("mirror_url")) {
        throw SerializationException("InlineWebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoXb44568fb is missing required property 'mirror_url'")
      }
      ...
      if (!rawObject.containsKey("owner")) {
        throw SerializationException("InlineWebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoXb44568fb is missing required property 'owner'")
      }
      val owner = rawObject["owner"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoOwnerX315811a3?>(requireNotNull(element)) }
      if (!rawObject.containsKey("pushed_at")) {
        throw SerializationException("InlineWebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoXb44568fb is missing required property 'pushed_at'")
      }
      val pushedAt = rawObject["pushed_at"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestRe5e87PullRequestBaseRepoPushedAtX2c5b7d12?>(requireNotNull(element)) }
      return InlineWebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoXb44568fb(
        archiveUrl = archiveUrl,
        archived = archived,
        assigneesUrl = assigneesUrl,
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoXb44568fb) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoXb44568fb")
...
public fun inlineWebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoXb44568fb(block: InlineWebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoXb44568fb.Builder.() -> Unit): InlineWebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoXb44568fb = InlineWebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoXb44568fb.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoXb44568fb is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoXb44568fb property '" + name + "' is not nullable")
