 ...
 * signees/items
 */
@Serializable(with = InlineWebhookPullRequestUnlabeledPullRequestAssigneesItemX6e734168.Serializer::class)
public class InlineWebhookPullRequestUnlabeledPullRequestAssigneesItemX6e734168(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestUnlabeledPullRequestAssigneesItemTypeXb4c9e161? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestUnlabeledPullRequestAssigneesItemTypeXb4c9e161? = null
    ...
    public fun build(): InlineWebhookPullRequestUnlabeledPullRequestAssigneesItemX6e734168 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestUnlabeledPullRequestAssigneesItemX6e734168(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestUnlabeledPullRequestAssigneesItemX6e734168 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestUnlabeledPullRequestAssigneesItemX6e734168> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestUnlabeledPullRequestAssigneesItemX6e734168 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestUnlabeledPullRequestAssigneesItemX6e734168")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestUnlabeledPullRequestAssigneesItemX6e734168 must be a JSON object")
      ...
      return InlineWebhookPullRequestUnlabeledPullRequestAssigneesItemX6e734168(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestUnlabeledPullRequestAssigneesItemTypeXb4c9e161>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestUnlabeledPullRequestAssigneesItemX6e734168) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestUnlabeledPullRequestAssigneesItemX6e734168")
...
public fun inlineWebhookPullRequestUnlabeledPullRequestAssigneesItemX6e734168(block: InlineWebhookPullRequestUnlabeledPullRequestAssigneesItemX6e734168.Builder.() -> Unit): InlineWebhookPullRequestUnlabeledPullRequestAssigneesItemX6e734168 = InlineWebhookPullRequestUnlabeledPullRequestAssigneesItemX6e734168.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestUnlabeledPullRequestAssigneesItemX6e734168 is missing required property '" + name + "'")
