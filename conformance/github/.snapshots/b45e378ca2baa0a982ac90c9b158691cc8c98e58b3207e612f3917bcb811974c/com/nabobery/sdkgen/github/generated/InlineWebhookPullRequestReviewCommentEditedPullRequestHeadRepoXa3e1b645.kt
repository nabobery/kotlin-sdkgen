 ...
 * roperties/head/properties/repo
 */
@Serializable(with = InlineWebhookPullRequestReviewCommentEditedPullRequestHeadRepoXa3e1b645.Serializer::class)
public class InlineWebhookPullRequestReviewCommentEditedPullRequestHeadRepoXa3e1b645 internal constructor(
  /**
  ...
  public val createdAt:
      InlineWebhookPullRequestReviewCommentEditedPullRequestHeadRepoCreatedAtX0ce3bff1,
  /**
  ...
  public val license:
      InlineWebhookPullRequestReviewCommentEditedPullRequestHeadRepoLicenseX2f3b8828?,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val owner: InlineWebhookPullRequestReviewCommentEditedPullRequestHeadRepoOwnerXe72e6afb?,
  /**
  ...
  public val pushedAt:
      InlineWebhookPullRequestReviewCommentEditedPullRequestHeadRepoPushedAtX80e06696?,
  /**
   * Wire format: `uri-template`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val visibility: InlineWebhookPullRequestRed95bPullRequestHeadRepoVisibilityXa52800a3,
  ...
  private val mergeCommitMessageState:
      FieldState<InlineWebhookPullRequestRed95bPullRequestHeadRepoMergeCommitMessageX4840b22b>,
  private val mergeCommitTitleState:
      FieldState<InlineWebhookPullRequestRed95bPullRequestHeadRepoMergeCommitTitleX6caa2e13>,
  private val organizationState: FieldState<String>,
  private val permissionsState:
      FieldState<InlineWebhookPullRequestRed95bPullRequestHeadRepoPermissionsX06ba27fa>,
  private val publicState: FieldState<Boolean>,
  private val pullRequestCreationPolicyState:
      FieldState<InlineWebhookPullRequestRed95bPullRequestHeadPullRequestCreationP824dX69d6a695>,
  private val roleNameState: FieldState<String?>,
  private val squashMergeCommitMessageState:
      FieldState<InlineWebhookPullRequestRed95bPullRequestHeadSquashMergeCommitMessageX23a95473>,
  private val squashMergeCommitTitleState:
      FieldState<InlineWebhookPullRequestRed95bPullRequestHeadRepoSquashMergeCommitTitleXb2b0f7ef>,
  ...
  public val mergeCommitMessage:
      InlineWebhookPullRequestRed95bPullRequestHeadRepoMergeCommitMessageX4840b22b?
  ...
  public val permissions: InlineWebhookPullRequestRed95bPullRequestHeadRepoPermissionsX06ba27fa?
  ...
  public constructor(
    ...
    createdAt: InlineWebhookPullRequestReviewCommentEditedPullRequestHeadRepoCreatedAtX0ce3bff1,
    ...
    language: String?,
    languagesUrl: String,
    license: InlineWebhookPullRequestReviewCommentEditedPullRequestHeadRepoLicenseX2f3b8828?,
    mergesUrl: String,
    ...
    openIssues: Int,
    openIssuesCount: Int,
    owner: InlineWebhookPullRequestReviewCommentEditedPullRequestHeadRepoOwnerXe72e6afb?,
    `private`: Boolean,
    pullsUrl: String,
    pushedAt: InlineWebhookPullRequestReviewCommentEditedPullRequestHeadRepoPushedAtX80e06696?,
    releasesUrl: String,
    size: Int,
    sshUrl: String,
    stargazersCount: Int,
    ...
    updatedAt: String,
    url: String,
    visibility: InlineWebhookPullRequestRed95bPullRequestHeadRepoVisibilityXa52800a3,
    watchers: Int,
    watchersCount: Int,
  ...
  public class Builder {
    ...
    private var createdAtValue:
        InlineWebhookPullRequestReviewCommentEditedPullRequestHeadRepoCreatedAtX0ce3bff1? = null
    ...
    private var visibilityValue:
        InlineWebhookPullRequestRed95bPullRequestHeadRepoVisibilityXa52800a3? = null

    public var visibility: InlineWebhookPullRequestRed95bPullRequestHeadRepoVisibilityXa52800a3
    ...
    private var licenseState:
        FieldState<InlineWebhookPullRequestReviewCommentEditedPullRequestHeadRepoLicenseX2f3b8828?>
        = FieldState.Absent
    ...
    private var ownerState:
        FieldState<InlineWebhookPullRequestReviewCommentEditedPullRequestHeadRepoOwnerXe72e6afb?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var owner: InlineWebhookPullRequestReviewCommentEditedPullRequestHeadRepoOwnerXe72e6afb?
    ...
    private var pushedAtState:
        FieldState<InlineWebhookPullRequestReviewCommentEditedPullRequestHeadRepoPushedAtX80e06696?>
        = FieldState.Absent
     ...
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var permissions: InlineWebhookPullRequestRed95bPullRequestHeadRepoPermissionsX06ba27fa?
      get() = permissionsState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): InlineWebhookPullRequestReviewCommentEditedPullRequestHeadRepoXa3e1b645 {
      ...
      return InlineWebhookPullRequestReviewCommentEditedPullRequestHeadRepoXa3e1b645(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewCommentEditedPullRequestHeadRepoXa3e1b645 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewCommentEditedPullRequestHeadRepoXa3e1b645> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewCommentEditedPullRequestHeadRepoXa3e1b645 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewCommentEditedPullRequestHeadRepoXa3e1b645")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewCommentEditedPullRequestHeadRepoXa3e1b645 must be a JSON object")
      ...
      val createdAt = json.decodeRequired<InlineWebhookPullRequestReviewCommentEditedPullRequestHeadRepoCreatedAtX0ce3bff1>(rawObject, "created_at")
      ...
      val visibility = json.decodeRequired<InlineWebhookPullRequestRed95bPullRequestHeadRepoVisibilityXa52800a3>(rawObject, "visibility")
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookPullRequestReviewCommentEditedPullRequestHeadRepoXa3e1b645 is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("homepage")) {
        throw SerializationException("InlineWebhookPullRequestReviewCommentEditedPullRequestHeadRepoXa3e1b645 is missing required property 'homepage'")
      }
      ...
      if (!rawObject.containsKey("language")) {
        throw SerializationException("InlineWebhookPullRequestReviewCommentEditedPullRequestHeadRepoXa3e1b645 is missing required property 'language'")
      }
      ...
      if (!rawObject.containsKey("license")) {
        throw SerializationException("InlineWebhookPullRequestReviewCommentEditedPullRequestHeadRepoXa3e1b645 is missing required property 'license'")
      }
      val license = rawObject["license"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestReviewCommentEditedPullRequestHeadRepoLicenseX2f3b8828?>(requireNotNull(element)) }
      if (!rawObject.containsKey("mirror_url")) {
        throw SerializationException("InlineWebhookPullRequestReviewCommentEditedPullRequestHeadRepoXa3e1b645 is missing required property 'mirror_url'")
      }
      ...
      if (!rawObject.containsKey("owner")) {
        throw SerializationException("InlineWebhookPullRequestReviewCommentEditedPullRequestHeadRepoXa3e1b645 is missing required property 'owner'")
      }
      val owner = rawObject["owner"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestReviewCommentEditedPullRequestHeadRepoOwnerXe72e6afb?>(requireNotNull(element)) }
      if (!rawObject.containsKey("pushed_at")) {
        throw SerializationException("InlineWebhookPullRequestReviewCommentEditedPullRequestHeadRepoXa3e1b645 is missing required property 'pushed_at'")
      }
      val pushedAt = rawObject["pushed_at"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestReviewCommentEditedPullRequestHeadRepoPushedAtX80e06696?>(requireNotNull(element)) }
      return InlineWebhookPullRequestReviewCommentEditedPullRequestHeadRepoXa3e1b645(
        archiveUrl = archiveUrl,
        archived = archived,
        assigneesUrl = assigneesUrl,
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewCommentEditedPullRequestHeadRepoXa3e1b645) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewCommentEditedPullRequestHeadRepoXa3e1b645")
...
public fun inlineWebhookPullRequestReviewCommentEditedPullRequestHeadRepoXa3e1b645(block: InlineWebhookPullRequestReviewCommentEditedPullRequestHeadRepoXa3e1b645.Builder.() -> Unit): InlineWebhookPullRequestReviewCommentEditedPullRequestHeadRepoXa3e1b645 = InlineWebhookPullRequestReviewCommentEditedPullRequestHeadRepoXa3e1b645.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewCommentEditedPullRequestHeadRepoXa3e1b645 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookPullRequestReviewCommentEditedPullRequestHeadRepoXa3e1b645 property '" + name + "' is not nullable")
