 ...
 * sdkgen://source/openapi.yaml#/components/schemas/webhooks_pull_request_5/properties/requested_reviewers/items/oneOf/0
 */
@Serializable(with = InlineWebhooksPullRequest5RequestedReviewersItemOneOf1X77986f43.Serializer::class)
public class InlineWebhooksPullRequest5RequestedReviewersItemOneOf1X77986f43(
  public val id: Int,
  ...
  public val type: InlineWebhooksPullRequest5RequestedReviewersItemOneOf1TypeX2d2da02f? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhooksPullRequest5RequestedReviewersItemOneOf1TypeX2d2da02f? = null
    ...
    public fun build(): InlineWebhooksPullRequest5RequestedReviewersItemOneOf1X77986f43 {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhooksPullRequest5RequestedReviewersItemOneOf1X77986f43 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhooksPullRequest5RequestedReviewersItemOneOf1X77986f43> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhooksPullRequest5RequestedReviewersItemOneOf1X77986f43 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhooksPullRequest5RequestedReviewersItemOneOf1X77986f43")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhooksPullRequest5RequestedReviewersItemOneOf1X77986f43 must be a JSON object")
      ...
      return InlineWebhooksPullRequest5RequestedReviewersItemOneOf1X77986f43(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhooksPullRequest5RequestedReviewersItemOneOf1TypeX2d2da02f>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhooksPullRequest5RequestedReviewersItemOneOf1X77986f43) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhooksPullRequest5RequestedReviewersItemOneOf1X77986f43")
...
public fun inlineWebhooksPullRequest5RequestedReviewersItemOneOf1X77986f43(block: InlineWebhooksPullRequest5RequestedReviewersItemOneOf1X77986f43.Builder.() -> Unit): InlineWebhooksPullRequest5RequestedReviewersItemOneOf1X77986f43 = InlineWebhooksPullRequest5RequestedReviewersItemOneOf1X77986f43.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhooksPullRequest5RequestedReviewersItemOneOf1X77986f43 is missing required property '" + name + "'")
