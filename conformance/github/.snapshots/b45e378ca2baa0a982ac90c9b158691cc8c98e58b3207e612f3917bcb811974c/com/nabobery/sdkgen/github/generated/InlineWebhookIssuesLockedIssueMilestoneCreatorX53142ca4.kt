 ...
 * es/creator
 */
@Serializable(with = InlineWebhookIssuesLockedIssueMilestoneCreatorX53142ca4.Serializer::class)
public class InlineWebhookIssuesLockedIssueMilestoneCreatorX53142ca4(
  public val id: Int,
  ...
  public val type: InlineWebhookIssuesLockedIssueMilestoneCreatorTypeX8d272e7e? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookIssuesLockedIssueMilestoneCreatorTypeX8d272e7e? = null
    ...
    public fun build(): InlineWebhookIssuesLockedIssueMilestoneCreatorX53142ca4 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssuesLockedIssueMilestoneCreatorX53142ca4(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesLockedIssueMilestoneCreatorX53142ca4 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesLockedIssueMilestoneCreatorX53142ca4> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesLockedIssueMilestoneCreatorX53142ca4 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesLockedIssueMilestoneCreatorX53142ca4")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesLockedIssueMilestoneCreatorX53142ca4 must be a JSON object")
      ...
      return InlineWebhookIssuesLockedIssueMilestoneCreatorX53142ca4(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssuesLockedIssueMilestoneCreatorTypeX8d272e7e>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesLockedIssueMilestoneCreatorX53142ca4) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesLockedIssueMilestoneCreatorX53142ca4")
...
public fun inlineWebhookIssuesLockedIssueMilestoneCreatorX53142ca4(block: InlineWebhookIssuesLockedIssueMilestoneCreatorX53142ca4.Builder.() -> Unit): InlineWebhookIssuesLockedIssueMilestoneCreatorX53142ca4 = InlineWebhookIssuesLockedIssueMilestoneCreatorX53142ca4.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesLockedIssueMilestoneCreatorX53142ca4 is missing required property '" + name + "'")
