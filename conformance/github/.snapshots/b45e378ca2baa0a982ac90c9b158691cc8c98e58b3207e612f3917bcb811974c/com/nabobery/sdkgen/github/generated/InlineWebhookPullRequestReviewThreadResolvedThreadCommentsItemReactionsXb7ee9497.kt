 ...
 * ties/comments/items/properties/reactions.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-review-thread-resolved/properties/thread/proper
 * ties/comments/items/properties/reactions
 */
@Serializable(with = InlineWebhookPullRequestReviewThreadResolvedThreadCommentsItemReactionsXb7ee9497.Serializer::class)
public class InlineWebhookPullRequestReviewThreadResolvedThreadCommentsItemReactionsXb7ee9497(
  public val _1: Int,
  public val _12: Int,
  ...
  public class Builder {
    ...
    public fun build(): InlineWebhookPullRequestReviewThreadResolvedThreadCommentsItemReactionsXb7ee9497 {
      ...
      return InlineWebhookPullRequestReviewThreadResolvedThreadCommentsItemReactionsXb7ee9497(
        _1 = _1,
        _12 = _12,
        confused = confused,
        eyes = eyes,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewThreadResolvedThreadCommentsItemReactionsXb7ee9497 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewThreadResolvedThreadCommentsItemReactionsXb7ee9497> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewThreadResolvedThreadCommentsItemReactionsXb7ee9497 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewThreadResolvedThreadCommentsItemReactionsXb7ee9497")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewThreadResolvedThreadCommentsItemReactionsXb7ee9497 must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewThreadResolvedThreadCommentsItemReactionsXb7ee9497) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewThreadResolvedThreadCommentsItemReactionsXb7ee9497")
...
public fun inlineWebhookPullRequestReviewThreadResolvedThreadCommentsItemReactionsXb7ee9497(block: InlineWebhookPullRequestReviewThreadResolvedThreadCommentsItemReactionsXb7ee9497.Builder.() -> Unit): InlineWebhookPullRequestReviewThreadResolvedThreadCommentsItemReactionsXb7ee9497 = InlineWebhookPullRequestReviewThreadResolvedThreadCommentsItemReactionsXb7ee9497.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewThreadResolvedThreadCommentsItemReactionsXb7ee9497 is missing required property '" + name + "'")
