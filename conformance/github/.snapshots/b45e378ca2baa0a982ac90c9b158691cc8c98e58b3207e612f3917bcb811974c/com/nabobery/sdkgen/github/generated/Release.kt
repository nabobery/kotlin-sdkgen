 ...
 * A release.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/release
 */
@Serializable(with = Release.Serializer::class)
public class Release internal constructor(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): Release = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<Release> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): Release {
      val jsonDecoder = decoder.requireJsonDecoder("Release")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("Release must be a JSON object")
      ...
      if (!rawObject.containsKey("name")) {
        throw SerializationException("Release is missing required property 'name'")
      }
      ...
      if (!rawObject.containsKey("published_at")) {
        throw SerializationException("Release is missing required property 'published_at'")
      }
      ...
      if (!rawObject.containsKey("tarball_url")) {
        throw SerializationException("Release is missing required property 'tarball_url'")
      }
      ...
      if (!rawObject.containsKey("zipball_url")) {
        throw SerializationException("Release is missing required property 'zipball_url'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: Release) {
      val jsonEncoder = encoder.requireJsonEncoder("Release")
...
public fun release(block: Release.Builder.() -> Unit): Release = Release.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("Release is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("Release property '" + name + "' is not nullable")
