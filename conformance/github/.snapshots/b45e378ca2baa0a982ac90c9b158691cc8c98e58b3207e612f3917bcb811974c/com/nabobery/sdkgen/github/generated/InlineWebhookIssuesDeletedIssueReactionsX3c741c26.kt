...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-deleted/properties/issue/properties/reactions.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-deleted/properties/issue/properties/reactions
 */
@Serializable(with = InlineWebhookIssuesDeletedIssueReactionsX3c741c26.Serializer::class)
public class InlineWebhookIssuesDeletedIssueReactionsX3c741c26(
  public val _1: Int,
  public val _12: Int,
  ...
  public class Builder {
    ...
    public fun build(): InlineWebhookIssuesDeletedIssueReactionsX3c741c26 {
      ...
      return InlineWebhookIssuesDeletedIssueReactionsX3c741c26(
        _1 = _1,
        _12 = _12,
        confused = confused,
        eyes = eyes,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesDeletedIssueReactionsX3c741c26 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesDeletedIssueReactionsX3c741c26> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesDeletedIssueReactionsX3c741c26 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesDeletedIssueReactionsX3c741c26")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesDeletedIssueReactionsX3c741c26 must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesDeletedIssueReactionsX3c741c26) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesDeletedIssueReactionsX3c741c26")
...
public fun inlineWebhookIssuesDeletedIssueReactionsX3c741c26(block: InlineWebhookIssuesDeletedIssueReactionsX3c741c26.Builder.() -> Unit): InlineWebhookIssuesDeletedIssueReactionsX3c741c26 = InlineWebhookIssuesDeletedIssueReactionsX3c741c26.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesDeletedIssueReactionsX3c741c26 is missing required property '" + name + "'")
