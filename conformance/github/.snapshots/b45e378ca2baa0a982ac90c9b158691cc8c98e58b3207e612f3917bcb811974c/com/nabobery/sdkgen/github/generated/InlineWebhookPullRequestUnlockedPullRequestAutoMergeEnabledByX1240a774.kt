 ...
 * o_merge/properties/enabled_by
 */
@Serializable(with = InlineWebhookPullRequestUnlockedPullRequestAutoMergeEnabledByX1240a774.Serializer::class)
public class InlineWebhookPullRequestUnlockedPullRequestAutoMergeEnabledByX1240a774(
  public val id: Int,
  ...
  public val type:
      InlineWebhookPullRequestUnlockedPullRequestAutoMergeEnabledByTypeX4095b9b9? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestUnlockedPullRequestAutoMergeEnabledByTypeX4095b9b9? =
        null
    ...
    public fun build(): InlineWebhookPullRequestUnlockedPullRequestAutoMergeEnabledByX1240a774 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestUnlockedPullRequestAutoMergeEnabledByX1240a774(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestUnlockedPullRequestAutoMergeEnabledByX1240a774 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestUnlockedPullRequestAutoMergeEnabledByX1240a774> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestUnlockedPullRequestAutoMergeEnabledByX1240a774 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestUnlockedPullRequestAutoMergeEnabledByX1240a774")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestUnlockedPullRequestAutoMergeEnabledByX1240a774 must be a JSON object")
      ...
      return InlineWebhookPullRequestUnlockedPullRequestAutoMergeEnabledByX1240a774(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestUnlockedPullRequestAutoMergeEnabledByTypeX4095b9b9>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestUnlockedPullRequestAutoMergeEnabledByX1240a774) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestUnlockedPullRequestAutoMergeEnabledByX1240a774")
...
public fun inlineWebhookPullRequestUnlockedPullRequestAutoMergeEnabledByX1240a774(block: InlineWebhookPullRequestUnlockedPullRequestAutoMergeEnabledByX1240a774.Builder.() -> Unit): InlineWebhookPullRequestUnlockedPullRequestAutoMergeEnabledByX1240a774 = InlineWebhookPullRequestUnlockedPullRequestAutoMergeEnabledByX1240a774.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestUnlockedPullRequestAutoMergeEnabledByX1240a774 is missing required property '" + name + "'")
