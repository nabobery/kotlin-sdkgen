...
public class ValidationError(
  ...
  errors: List<InlineValidationErrorErrorsItemX68da37f1>? = null,
) {
  public val errors: List<InlineValidationErrorErrorsItemX68da37f1>? =
  ...
  public class Builder {
    ...
    private var errorsValue: List<InlineValidationErrorErrorsItemX68da37f1>? = null

    public var errors: List<InlineValidationErrorErrorsItemX68da37f1>?
  ...
  internal object Serializer : KSerializer<ValidationError> {
