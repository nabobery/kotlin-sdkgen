...
public class InlineReposCheckSuitesPreferencesPatchRequestJsonXabce1dbd internal constructor(
  autoTriggerChecksState: FieldState<List<InlineReposCheckSuitesPreferencesPatchRequestJsonAutoTriggerChecksItemX5186cf7d>>,
) {
  private val autoTriggerChecksState:
      ...
      = autoTriggerChecksState.copyValue { fieldValue -> fieldValue.toList() }
  ...
  public class Builder {
    ...
    public var autoTriggerChecks:
        List<InlineReposCheckSuitesPreferencesPatchRequestJsonAutoTriggerChecksItemX5186cf7d>?
      get() = autoTriggerChecksState.valueOrNull()?.let { collection0 -> collection0.toList() }
      set(`value`) {
        val present = requireNotNull(value) { "autoTriggerChecks is not nullable; call unsetAutoTriggerChecks() to omit it" }
        autoTriggerChecksState = FieldState.Value(present.toList())
      }
  ...
  internal object Serializer : KSerializer<InlineReposCheckSuitesPreferencesPatchRequestJsonXabce1dbd> {
