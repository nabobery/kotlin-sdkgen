 ...
 */
@Serializable(with = InlineWebhookCheckSuiteCompletedCheckSuiteAppX2aab6b84.Serializer::class)
public class InlineWebhookCheckSuiteCompletedCheckSuiteAppX2aab6b84 internal constructor(
  /**
  ...
  public val owner: InlineWebhookCheckSuiteCompletedCheckSuiteAppOwnerXcc972d21?,
  /**
   * Wire format: `date-time`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  public val updatedAt: String?,
  private val clientIdState: FieldState<String?>,
  eventsState: FieldState<List<InlineWebhookCheckSuiteCompletedCheckSuiteAppEventsItemXf6cd0559>>,
  private val permissionsState:
      FieldState<InlineWebhookCheckSuiteCompletedCheckSuiteAppPermissionsXbb1bb583>,
  private val slugState: FieldState<String>,
) {
  private val eventsState:
      FieldState<List<InlineWebhookCheckSuiteCompletedCheckSuiteAppEventsItemXf6cd0559>> =
   ...
   */
  public val events: List<InlineWebhookCheckSuiteCompletedCheckSuiteAppEventsItemXf6cd0559>?
    get() = eventsState.valueOrNull()

  /**
   * The set of permissions for the GitHub app
   */
  public val permissions: InlineWebhookCheckSuiteCompletedCheckSuiteAppPermissionsXbb1bb583?
  ...
  public constructor(
    ...
    name: String,
    nodeId: String,
    owner: InlineWebhookCheckSuiteCompletedCheckSuiteAppOwnerXcc972d21?,
    updatedAt: String?,
  ...
  public class Builder {
    ...
    private var ownerState: FieldState<InlineWebhookCheckSuiteCompletedCheckSuiteAppOwnerXcc972d21?>
        = FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var owner: InlineWebhookCheckSuiteCompletedCheckSuiteAppOwnerXcc972d21?
     ...
     */
    public var events: List<InlineWebhookCheckSuiteCompletedCheckSuiteAppEventsItemXf6cd0559>?
     ...
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var permissions: InlineWebhookCheckSuiteCompletedCheckSuiteAppPermissionsXbb1bb583?
      get() = permissionsState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): InlineWebhookCheckSuiteCompletedCheckSuiteAppX2aab6b84 {
      ...
      return InlineWebhookCheckSuiteCompletedCheckSuiteAppX2aab6b84(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookCheckSuiteCompletedCheckSuiteAppX2aab6b84 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookCheckSuiteCompletedCheckSuiteAppX2aab6b84> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookCheckSuiteCompletedCheckSuiteAppX2aab6b84 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookCheckSuiteCompletedCheckSuiteAppX2aab6b84")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookCheckSuiteCompletedCheckSuiteAppX2aab6b84 must be a JSON object")
      val htmlUrl = json.decodeRequired<String>(rawObject, "html_url")
      val name = json.decodeRequired<String>(rawObject, "name")
      val nodeId = json.decodeRequired<String>(rawObject, "node_id")
      if (!rawObject.containsKey("created_at")) {
        throw SerializationException("InlineWebhookCheckSuiteCompletedCheckSuiteAppX2aab6b84 is missing required property 'created_at'")
      }
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookCheckSuiteCompletedCheckSuiteAppX2aab6b84 is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("external_url")) {
        throw SerializationException("InlineWebhookCheckSuiteCompletedCheckSuiteAppX2aab6b84 is missing required property 'external_url'")
      }
      ...
      if (!rawObject.containsKey("id")) {
        throw SerializationException("InlineWebhookCheckSuiteCompletedCheckSuiteAppX2aab6b84 is missing required property 'id'")
      }
      ...
      if (!rawObject.containsKey("owner")) {
        throw SerializationException("InlineWebhookCheckSuiteCompletedCheckSuiteAppX2aab6b84 is missing required property 'owner'")
      }
      val owner = rawObject["owner"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookCheckSuiteCompletedCheckSuiteAppOwnerXcc972d21?>(requireNotNull(element)) }
      if (!rawObject.containsKey("updated_at")) {
        throw SerializationException("InlineWebhookCheckSuiteCompletedCheckSuiteAppX2aab6b84 is missing required property 'updated_at'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookCheckSuiteCompletedCheckSuiteAppX2aab6b84) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookCheckSuiteCompletedCheckSuiteAppX2aab6b84")
...
public fun inlineWebhookCheckSuiteCompletedCheckSuiteAppX2aab6b84(block: InlineWebhookCheckSuiteCompletedCheckSuiteAppX2aab6b84.Builder.() -> Unit): InlineWebhookCheckSuiteCompletedCheckSuiteAppX2aab6b84 = InlineWebhookCheckSuiteCompletedCheckSuiteAppX2aab6b84.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookCheckSuiteCompletedCheckSuiteAppX2aab6b84 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookCheckSuiteCompletedCheckSuiteAppX2aab6b84 property '" + name + "' is not nullable")
