 ...
 * formed_via_github_app/properties/owner.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-issue-comment-edited/properties/issue/allOf/0/properties/per
 * formed_via_github_app/properties/owner
 */
@Serializable(with = InlineWebhookIssueCommentEditedIssueAllOf1PerformedViaGithubAppOwnerX8cdc79c1.Serializer::class)
public class InlineWebhookIssueCommentEditedIssueAllOf1PerformedViaGithubAppOwnerX8cdc79c1(
  public val id: Int,
  ...
  public val type:
      InlineWebhookIssueCommentE365aIssueAllOf1PerformedViaGithubAppOwnerTypeX9a3e26a7? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public fun build(): InlineWebhookIssueCommentEditedIssueAllOf1PerformedViaGithubAppOwnerX8cdc79c1 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssueCommentEditedIssueAllOf1PerformedViaGithubAppOwnerX8cdc79c1(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssueCommentEditedIssueAllOf1PerformedViaGithubAppOwnerX8cdc79c1 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssueCommentEditedIssueAllOf1PerformedViaGithubAppOwnerX8cdc79c1> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssueCommentEditedIssueAllOf1PerformedViaGithubAppOwnerX8cdc79c1 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssueCommentEditedIssueAllOf1PerformedViaGithubAppOwnerX8cdc79c1")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssueCommentEditedIssueAllOf1PerformedViaGithubAppOwnerX8cdc79c1 must be a JSON object")
      ...
      return InlineWebhookIssueCommentEditedIssueAllOf1PerformedViaGithubAppOwnerX8cdc79c1(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssueCommentE365aIssueAllOf1PerformedViaGithubAppOwnerTypeX9a3e26a7>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssueCommentEditedIssueAllOf1PerformedViaGithubAppOwnerX8cdc79c1) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssueCommentEditedIssueAllOf1PerformedViaGithubAppOwnerX8cdc79c1")
...
public fun inlineWebhookIssueCommentEditedIssueAllOf1PerformedViaGithubAppOwnerX8cdc79c1(block: InlineWebhookIssueCommentEditedIssueAllOf1PerformedViaGithubAppOwnerX8cdc79c1.Builder.() -> Unit): InlineWebhookIssueCommentEditedIssueAllOf1PerformedViaGithubAppOwnerX8cdc79c1 = InlineWebhookIssueCommentEditedIssueAllOf1PerformedViaGithubAppOwnerX8cdc79c1.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssueCommentEditedIssueAllOf1PerformedViaGithubAppOwnerX8cdc79c1 is missing required property '" + name + "'")
