 ...
 * /repository/properties/owner
 */
@Serializable(with = InlineWebhookDeploymentStatusCreatedWorkflowRunRepositoryOwnerXb99739f1.Serializer::class)
public class InlineWebhookDeploymentStatusCreatedWorkflowRunRepositoryOwnerXb99739f1(
  ...
  public class Builder {
    ...
    public fun build(): InlineWebhookDeploymentStatusCreatedWorkflowRunRepositoryOwnerXb99739f1 = InlineWebhookDeploymentStatusCreatedWorkflowRunRepositoryOwnerXb99739f1(
      avatarUrl = avatarUrl,
      eventsUrl = eventsUrl,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookDeploymentStatusCreatedWorkflowRunRepositoryOwnerXb99739f1 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookDeploymentStatusCreatedWorkflowRunRepositoryOwnerXb99739f1> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookDeploymentStatusCreatedWorkflowRunRepositoryOwnerXb99739f1 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookDeploymentStatusCreatedWorkflowRunRepositoryOwnerXb99739f1")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookDeploymentStatusCreatedWorkflowRunRepositoryOwnerXb99739f1 must be a JSON object")
      return InlineWebhookDeploymentStatusCreatedWorkflowRunRepositoryOwnerXb99739f1(
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookDeploymentStatusCreatedWorkflowRunRepositoryOwnerXb99739f1) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookDeploymentStatusCreatedWorkflowRunRepositoryOwnerXb99739f1")
...
public fun inlineWebhookDeploymentStatusCreatedWorkflowRunRepositoryOwnerXb99739f1(block: InlineWebhookDeploymentStatusCreatedWorkflowRunRepositoryOwnerXb99739f1.Builder.() -> Unit): InlineWebhookDeploymentStatusCreatedWorkflowRunRepositoryOwnerXb99739f1 = InlineWebhookDeploymentStatusCreatedWorkflowRunRepositoryOwnerXb99739f1.build(block)
