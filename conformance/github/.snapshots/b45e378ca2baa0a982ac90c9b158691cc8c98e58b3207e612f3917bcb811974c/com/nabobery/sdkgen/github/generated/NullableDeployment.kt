 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/nullable-deployment
 */
@Serializable(with = NullableDeployment.Serializer::class)
public class NullableDeployment internal constructor(
  /**
  ...
  public val payload: InlineNullableDeploymentPayloadX65efbd75,
  /**
  ...
  public constructor(
    ...
    id: Long,
    nodeId: String,
    payload: InlineNullableDeploymentPayloadX65efbd75,
    ref: String,
  ...
  public class Builder {
    ...
    private var payloadValue: InlineNullableDeploymentPayloadX65efbd75? = null

    public var payload: InlineNullableDeploymentPayloadX65efbd75
    ...
    public fun build(): NullableDeployment {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): NullableDeployment = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<NullableDeployment> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): NullableDeployment {
      val jsonDecoder = decoder.requireJsonDecoder("NullableDeployment")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("NullableDeployment must be a JSON object")
      ...
      val payload = json.decodeRequired<InlineNullableDeploymentPayloadX65efbd75>(rawObject, "payload")
      ...
      if (!rawObject.containsKey("creator")) {
        throw SerializationException("NullableDeployment is missing required property 'creator'")
      }
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("NullableDeployment is missing required property 'description'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: NullableDeployment) {
      val jsonEncoder = encoder.requireJsonEncoder("NullableDeployment")
...
public fun nullableDeployment(block: NullableDeployment.Builder.() -> Unit): NullableDeployment = NullableDeployment.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("NullableDeployment is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("NullableDeployment property '" + name + "' is not nullable")
