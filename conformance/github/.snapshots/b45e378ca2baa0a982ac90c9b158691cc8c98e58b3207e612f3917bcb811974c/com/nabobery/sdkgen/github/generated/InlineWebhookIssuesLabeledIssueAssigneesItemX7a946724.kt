...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-labeled/properties/issue/properties/assignees/items.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-labeled/properties/issue/properties/assignees/items
 */
@Serializable(with = InlineWebhookIssuesLabeledIssueAssigneesItemX7a946724.Serializer::class)
public class InlineWebhookIssuesLabeledIssueAssigneesItemX7a946724(
  public val id: Int,
  ...
  public val type: InlineWebhookIssuesLabeledIssueAssigneesItemTypeX25a8d055? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookIssuesLabeledIssueAssigneesItemTypeX25a8d055? = null
    ...
    public fun build(): InlineWebhookIssuesLabeledIssueAssigneesItemX7a946724 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssuesLabeledIssueAssigneesItemX7a946724(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesLabeledIssueAssigneesItemX7a946724 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesLabeledIssueAssigneesItemX7a946724> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesLabeledIssueAssigneesItemX7a946724 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesLabeledIssueAssigneesItemX7a946724")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesLabeledIssueAssigneesItemX7a946724 must be a JSON object")
      ...
      return InlineWebhookIssuesLabeledIssueAssigneesItemX7a946724(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssuesLabeledIssueAssigneesItemTypeX25a8d055>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesLabeledIssueAssigneesItemX7a946724) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesLabeledIssueAssigneesItemX7a946724")
...
public fun inlineWebhookIssuesLabeledIssueAssigneesItemX7a946724(block: InlineWebhookIssuesLabeledIssueAssigneesItemX7a946724.Builder.() -> Unit): InlineWebhookIssuesLabeledIssueAssigneesItemX7a946724 = InlineWebhookIssuesLabeledIssueAssigneesItemX7a946724.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesLabeledIssueAssigneesItemX7a946724 is missing required property '" + name + "'")
