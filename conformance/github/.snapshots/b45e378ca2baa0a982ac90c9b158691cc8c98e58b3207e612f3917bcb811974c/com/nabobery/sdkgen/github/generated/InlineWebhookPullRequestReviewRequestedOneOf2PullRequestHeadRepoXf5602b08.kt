 ...
 * t/properties/head/properties/repo
 */
@Serializable(with = InlineWebhookPullRequestReviewRequestedOneOf2PullRequestHeadRepoXf5602b08.Serializer::class)
public class InlineWebhookPullRequestReviewRequestedOneOf2PullRequestHeadRepoXf5602b08 internal constructor(
  /**
  ...
  public val createdAt: InlineWebhookPullRequestReffb1OneOf2PullRequestHeadRepoCreatedAtXdf48866b,
  /**
  ...
  public val license:
      InlineWebhookPullRequestReviewRequestedOneOf2PullRequestHeadRepoLicenseX00eed9c3?,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val owner: InlineWebhookPullRequestReviewRequestedOneOf2PullRequestHeadRepoOwnerXa79301f8?,
  /**
  ...
  public val pushedAt: InlineWebhookPullRequestReffb1OneOf2PullRequestHeadRepoPushedAtX88c3b6ac?,
  /**
   * Wire format: `uri-template`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val visibility: InlineWebhookPullRequestReffb1OneOf2PullRequestHeadRepoVisibilityX72839aae,
  ...
  private val mergeCommitMessageState:
      FieldState<InlineWebhookPullRequestReffb1OneOf2PullRequestHeadMergeCommitMessageX64787060>,
  private val mergeCommitTitleState:
      FieldState<InlineWebhookPullRequestReffb1OneOf2PullRequestHeadRepoMergeCommitTitleX181f4fa4>,
  private val organizationState: FieldState<String>,
  private val permissionsState:
      FieldState<InlineWebhookPullRequestReffb1OneOf2PullRequestHeadRepoPermissionsX554af68c>,
  private val publicState: FieldState<Boolean>,
  private val pullRequestCreationPolicyState:
      FieldState<InlineWebhookPullRequestReffb1OneOf2PullRequestPullRequestCreationP824dX5a465da6>,
  private val roleNameState: FieldState<String?>,
  private val squashMergeCommitMessageState:
      FieldState<InlineWebhookPullRequestReffb1OneOf2PullRequestSquashMergeCommitMessageX95657577>,
  private val squashMergeCommitTitleState:
      FieldState<InlineWebhookPullRequestReffb1OneOf2PullRequestSquashMergeCommitTitleX86d4a643>,
  ...
  public val mergeCommitTitle:
      InlineWebhookPullRequestReffb1OneOf2PullRequestHeadRepoMergeCommitTitleX181f4fa4?
  ...
  public val permissions:
      InlineWebhookPullRequestReffb1OneOf2PullRequestHeadRepoPermissionsX554af68c?
  ...
  public val pullRequestCreationPolicy:
      InlineWebhookPullRequestReffb1OneOf2PullRequestPullRequestCreationP824dX5a465da6?
  ...
  public constructor(
    ...
    createdAt: InlineWebhookPullRequestReffb1OneOf2PullRequestHeadRepoCreatedAtXdf48866b,
    ...
    language: String?,
    languagesUrl: String,
    license: InlineWebhookPullRequestReviewRequestedOneOf2PullRequestHeadRepoLicenseX00eed9c3?,
    mergesUrl: String,
    ...
    openIssues: Int,
    openIssuesCount: Int,
    owner: InlineWebhookPullRequestReviewRequestedOneOf2PullRequestHeadRepoOwnerXa79301f8?,
    `private`: Boolean,
    pullsUrl: String,
    pushedAt: InlineWebhookPullRequestReffb1OneOf2PullRequestHeadRepoPushedAtX88c3b6ac?,
    releasesUrl: String,
    size: Int,
    sshUrl: String,
    stargazersCount: Int,
    ...
    updatedAt: String,
    url: String,
    visibility: InlineWebhookPullRequestReffb1OneOf2PullRequestHeadRepoVisibilityX72839aae,
    watchers: Int,
    watchersCount: Int,
  ...
  public class Builder {
    ...
    private var createdAtValue:
        InlineWebhookPullRequestReffb1OneOf2PullRequestHeadRepoCreatedAtXdf48866b? = null

    public var createdAt: InlineWebhookPullRequestReffb1OneOf2PullRequestHeadRepoCreatedAtXdf48866b
    ...
    private var visibilityValue:
        InlineWebhookPullRequestReffb1OneOf2PullRequestHeadRepoVisibilityX72839aae? = null

    public var visibility:
        InlineWebhookPullRequestReffb1OneOf2PullRequestHeadRepoVisibilityX72839aae
    ...
    private var licenseState:
        FieldState<InlineWebhookPullRequestReviewRequestedOneOf2PullRequestHeadRepoLicenseX00eed9c3?>
        = FieldState.Absent
    ...
    private var ownerState:
        FieldState<InlineWebhookPullRequestReviewRequestedOneOf2PullRequestHeadRepoOwnerXa79301f8?>
        = FieldState.Absent
     ...
     */
    public var owner:
        InlineWebhookPullRequestReviewRequestedOneOf2PullRequestHeadRepoOwnerXa79301f8?
    ...
    private var pushedAtState:
        FieldState<InlineWebhookPullRequestReffb1OneOf2PullRequestHeadRepoPushedAtX88c3b6ac?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var pushedAt: InlineWebhookPullRequestReffb1OneOf2PullRequestHeadRepoPushedAtX88c3b6ac?
    ...
    public fun build(): InlineWebhookPullRequestReviewRequestedOneOf2PullRequestHeadRepoXf5602b08 {
      ...
      return InlineWebhookPullRequestReviewRequestedOneOf2PullRequestHeadRepoXf5602b08(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewRequestedOneOf2PullRequestHeadRepoXf5602b08 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewRequestedOneOf2PullRequestHeadRepoXf5602b08> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewRequestedOneOf2PullRequestHeadRepoXf5602b08 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewRequestedOneOf2PullRequestHeadRepoXf5602b08")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewRequestedOneOf2PullRequestHeadRepoXf5602b08 must be a JSON object")
      ...
      val createdAt = json.decodeRequired<InlineWebhookPullRequestReffb1OneOf2PullRequestHeadRepoCreatedAtXdf48866b>(rawObject, "created_at")
      ...
      val visibility = json.decodeRequired<InlineWebhookPullRequestReffb1OneOf2PullRequestHeadRepoVisibilityX72839aae>(rawObject, "visibility")
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookPullRequestReviewRequestedOneOf2PullRequestHeadRepoXf5602b08 is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("homepage")) {
        throw SerializationException("InlineWebhookPullRequestReviewRequestedOneOf2PullRequestHeadRepoXf5602b08 is missing required property 'homepage'")
      }
      ...
      if (!rawObject.containsKey("language")) {
        throw SerializationException("InlineWebhookPullRequestReviewRequestedOneOf2PullRequestHeadRepoXf5602b08 is missing required property 'language'")
      }
      ...
      if (!rawObject.containsKey("license")) {
        throw SerializationException("InlineWebhookPullRequestReviewRequestedOneOf2PullRequestHeadRepoXf5602b08 is missing required property 'license'")
      }
      val license = rawObject["license"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestReviewRequestedOneOf2PullRequestHeadRepoLicenseX00eed9c3?>(requireNotNull(element)) }
      if (!rawObject.containsKey("mirror_url")) {
        throw SerializationException("InlineWebhookPullRequestReviewRequestedOneOf2PullRequestHeadRepoXf5602b08 is missing required property 'mirror_url'")
      }
      ...
      if (!rawObject.containsKey("owner")) {
        throw SerializationException("InlineWebhookPullRequestReviewRequestedOneOf2PullRequestHeadRepoXf5602b08 is missing required property 'owner'")
      }
      val owner = rawObject["owner"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestReviewRequestedOneOf2PullRequestHeadRepoOwnerXa79301f8?>(requireNotNull(element)) }
      if (!rawObject.containsKey("pushed_at")) {
        throw SerializationException("InlineWebhookPullRequestReviewRequestedOneOf2PullRequestHeadRepoXf5602b08 is missing required property 'pushed_at'")
      }
      val pushedAt = rawObject["pushed_at"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestReffb1OneOf2PullRequestHeadRepoPushedAtX88c3b6ac?>(requireNotNull(element)) }
      return InlineWebhookPullRequestReviewRequestedOneOf2PullRequestHeadRepoXf5602b08(
        archiveUrl = archiveUrl,
        archived = archived,
        assigneesUrl = assigneesUrl,
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewRequestedOneOf2PullRequestHeadRepoXf5602b08) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewRequestedOneOf2PullRequestHeadRepoXf5602b08")
...
public fun inlineWebhookPullRequestReviewRequestedOneOf2PullRequestHeadRepoXf5602b08(block: InlineWebhookPullRequestReviewRequestedOneOf2PullRequestHeadRepoXf5602b08.Builder.() -> Unit): InlineWebhookPullRequestReviewRequestedOneOf2PullRequestHeadRepoXf5602b08 = InlineWebhookPullRequestReviewRequestedOneOf2PullRequestHeadRepoXf5602b08.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewRequestedOneOf2PullRequestHeadRepoXf5602b08 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookPullRequestReviewRequestedOneOf2PullRequestHeadRepoXf5602b08 property '" + name + "' is not nullable")
