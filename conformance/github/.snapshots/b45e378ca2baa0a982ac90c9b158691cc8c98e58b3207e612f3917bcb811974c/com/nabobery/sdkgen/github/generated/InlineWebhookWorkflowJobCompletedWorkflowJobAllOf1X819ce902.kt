 ...
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-workflow-job-completed/properties/workflow_job/allOf/0
 */
@Serializable(with = InlineWebhookWorkflowJobCompletedWorkflowJobAllOf1X819ce902.Serializer::class)
public class InlineWebhookWorkflowJobCompletedWorkflowJobAllOf1X819ce902(
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  public val checkRunUrl: String,
  public val completedAt: String?,
  public val conclusion: InlineWebhookWorkflowJobCompletedWorkflowJobAllOf1ConclusionXde769fe6?,
  /**
   ...
   */
  public val status: InlineWebhookWorkflowJobCompletedWorkflowJobAllOf1StatusX1ef639bc,
  steps: List<InlineWebhookWorkflowJobCompletedWorkflowJobAllOf1StepsItemXf3e1d7f9>,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val steps: List<InlineWebhookWorkflowJobCompletedWorkflowJobAllOf1StepsItemXf3e1d7f9> =
      steps.toList()
  ...
  public class Builder {
    ...
    private var statusValue: InlineWebhookWorkflowJobCompletedWorkflowJobAllOf1StatusX1ef639bc? =
        null

    public var status: InlineWebhookWorkflowJobCompletedWorkflowJobAllOf1StatusX1ef639bc
    ...
    private var stepsValue:
        List<InlineWebhookWorkflowJobCompletedWorkflowJobAllOf1StepsItemXf3e1d7f9>? = null

    public var steps: List<InlineWebhookWorkflowJobCompletedWorkflowJobAllOf1StepsItemXf3e1d7f9>
    ...
    private var conclusionState:
        FieldState<InlineWebhookWorkflowJobCompletedWorkflowJobAllOf1ConclusionXde769fe6?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var conclusion: InlineWebhookWorkflowJobCompletedWorkflowJobAllOf1ConclusionXde769fe6?
    ...
    public fun build(): InlineWebhookWorkflowJobCompletedWorkflowJobAllOf1X819ce902 {
      ...
      return InlineWebhookWorkflowJobCompletedWorkflowJobAllOf1X819ce902(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookWorkflowJobCompletedWorkflowJobAllOf1X819ce902 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookWorkflowJobCompletedWorkflowJobAllOf1X819ce902> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookWorkflowJobCompletedWorkflowJobAllOf1X819ce902 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookWorkflowJobCompletedWorkflowJobAllOf1X819ce902")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookWorkflowJobCompletedWorkflowJobAllOf1X819ce902 must be a JSON object")
      ...
      val status = json.decodeRequired<InlineWebhookWorkflowJobCompletedWorkflowJobAllOf1StatusX1ef639bc>(rawObject, "status")
      val steps = json.decodeRequired<List<InlineWebhookWorkflowJobCompletedWorkflowJobAllOf1StepsItemXf3e1d7f9>>(rawObject, "steps")
      val url = json.decodeRequired<String>(rawObject, "url")
      if (!rawObject.containsKey("completed_at")) {
        throw SerializationException("InlineWebhookWorkflowJobCompletedWorkflowJobAllOf1X819ce902 is missing required property 'completed_at'")
      }
      ...
      if (!rawObject.containsKey("conclusion")) {
        throw SerializationException("InlineWebhookWorkflowJobCompletedWorkflowJobAllOf1X819ce902 is missing required property 'conclusion'")
      }
      val conclusion = rawObject["conclusion"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookWorkflowJobCompletedWorkflowJobAllOf1ConclusionXde769fe6?>(requireNotNull(element)) }
      if (!rawObject.containsKey("head_branch")) {
        throw SerializationException("InlineWebhookWorkflowJobCompletedWorkflowJobAllOf1X819ce902 is missing required property 'head_branch'")
      }
      ...
      if (!rawObject.containsKey("runner_group_id")) {
        throw SerializationException("InlineWebhookWorkflowJobCompletedWorkflowJobAllOf1X819ce902 is missing required property 'runner_group_id'")
      }
      ...
      if (!rawObject.containsKey("runner_group_name")) {
        throw SerializationException("InlineWebhookWorkflowJobCompletedWorkflowJobAllOf1X819ce902 is missing required property 'runner_group_name'")
      }
      ...
      if (!rawObject.containsKey("runner_id")) {
        throw SerializationException("InlineWebhookWorkflowJobCompletedWorkflowJobAllOf1X819ce902 is missing required property 'runner_id'")
      }
      ...
      if (!rawObject.containsKey("runner_name")) {
        throw SerializationException("InlineWebhookWorkflowJobCompletedWorkflowJobAllOf1X819ce902 is missing required property 'runner_name'")
      }
      ...
      if (!rawObject.containsKey("workflow_name")) {
        throw SerializationException("InlineWebhookWorkflowJobCompletedWorkflowJobAllOf1X819ce902 is missing required property 'workflow_name'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookWorkflowJobCompletedWorkflowJobAllOf1X819ce902) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookWorkflowJobCompletedWorkflowJobAllOf1X819ce902")
...
public fun inlineWebhookWorkflowJobCompletedWorkflowJobAllOf1X819ce902(block: InlineWebhookWorkflowJobCompletedWorkflowJobAllOf1X819ce902.Builder.() -> Unit): InlineWebhookWorkflowJobCompletedWorkflowJobAllOf1X819ce902 = InlineWebhookWorkflowJobCompletedWorkflowJobAllOf1X819ce902.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookWorkflowJobCompletedWorkflowJobAllOf1X819ce902 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookWorkflowJobCompletedWorkflowJobAllOf1X819ce902 property '" + name + "' is not nullable")
