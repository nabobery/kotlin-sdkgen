 ...
 * request/properties/auto_merge/properties/enabled_by
 */
@Serializable(with = InlineWebhookPullRequestReacd1OneOf2PullRequestAutoMergeEnabledByX262f713b.Serializer::class)
public class InlineWebhookPullRequestReacd1OneOf2PullRequestAutoMergeEnabledByX262f713b(
  public val id: Int,
  ...
  public val type:
      InlineWebhookPullRequestReacd1OneOf2PullRequestAutoMergeEnabledByTypeX09bc3430? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestReacd1OneOf2PullRequestAutoMergeEnabledByTypeX09bc3430?
        = null
    ...
    public fun build(): InlineWebhookPullRequestReacd1OneOf2PullRequestAutoMergeEnabledByX262f713b {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestReacd1OneOf2PullRequestAutoMergeEnabledByX262f713b(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReacd1OneOf2PullRequestAutoMergeEnabledByX262f713b = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReacd1OneOf2PullRequestAutoMergeEnabledByX262f713b> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReacd1OneOf2PullRequestAutoMergeEnabledByX262f713b {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReacd1OneOf2PullRequestAutoMergeEnabledByX262f713b")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReacd1OneOf2PullRequestAutoMergeEnabledByX262f713b must be a JSON object")
      ...
      return InlineWebhookPullRequestReacd1OneOf2PullRequestAutoMergeEnabledByX262f713b(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestReacd1OneOf2PullRequestAutoMergeEnabledByTypeX09bc3430>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReacd1OneOf2PullRequestAutoMergeEnabledByX262f713b) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReacd1OneOf2PullRequestAutoMergeEnabledByX262f713b")
...
public fun inlineWebhookPullRequestReacd1OneOf2PullRequestAutoMergeEnabledByX262f713b(block: InlineWebhookPullRequestReacd1OneOf2PullRequestAutoMergeEnabledByX262f713b.Builder.() -> Unit): InlineWebhookPullRequestReacd1OneOf2PullRequestAutoMergeEnabledByX262f713b = InlineWebhookPullRequestReacd1OneOf2PullRequestAutoMergeEnabledByX262f713b.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReacd1OneOf2PullRequestAutoMergeEnabledByX262f713b is missing required property '" + name + "'")
