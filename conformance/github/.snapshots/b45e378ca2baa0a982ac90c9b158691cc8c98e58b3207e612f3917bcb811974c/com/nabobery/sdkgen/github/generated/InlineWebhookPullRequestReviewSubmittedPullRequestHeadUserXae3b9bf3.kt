 ...
 * ties/head/properties/user.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-review-submitted/properties/pull_request/proper
 * ties/head/properties/user
 */
@Serializable(with = InlineWebhookPullRequestReviewSubmittedPullRequestHeadUserXae3b9bf3.Serializer::class)
public class InlineWebhookPullRequestReviewSubmittedPullRequestHeadUserXae3b9bf3(
  public val id: Long,
  ...
  public val type: InlineWebhookPullRequestReviewSubmittedPullRequestHeadUserTypeX376724cd? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestReviewSubmittedPullRequestHeadUserTypeX376724cd? = null
    ...
    public fun build(): InlineWebhookPullRequestReviewSubmittedPullRequestHeadUserXae3b9bf3 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestReviewSubmittedPullRequestHeadUserXae3b9bf3(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewSubmittedPullRequestHeadUserXae3b9bf3 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewSubmittedPullRequestHeadUserXae3b9bf3> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewSubmittedPullRequestHeadUserXae3b9bf3 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewSubmittedPullRequestHeadUserXae3b9bf3")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewSubmittedPullRequestHeadUserXae3b9bf3 must be a JSON object")
      ...
      return InlineWebhookPullRequestReviewSubmittedPullRequestHeadUserXae3b9bf3(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestReviewSubmittedPullRequestHeadUserTypeX376724cd>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewSubmittedPullRequestHeadUserXae3b9bf3) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewSubmittedPullRequestHeadUserXae3b9bf3")
...
public fun inlineWebhookPullRequestReviewSubmittedPullRequestHeadUserXae3b9bf3(block: InlineWebhookPullRequestReviewSubmittedPullRequestHeadUserXae3b9bf3.Builder.() -> Unit): InlineWebhookPullRequestReviewSubmittedPullRequestHeadUserXae3b9bf3 = InlineWebhookPullRequestReviewSubmittedPullRequestHeadUserXae3b9bf3.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewSubmittedPullRequestHeadUserXae3b9bf3 is missing required property '" + name + "'")
