...
public class InlineAgentsTasksGetResponse404JsonXdd9058db(
  ...
  errors: List<InlineAgentsTasksGetResponse404JsonErrorsItemX1db4cf7d>? = null,
) {
  /**
   * List of validation errors (present only for 422 responses)
   */
  public val errors: List<InlineAgentsTasksGetResponse404JsonErrorsItemX1db4cf7d>? =
  ...
  public class Builder {
    ...
    private var errorsValue: List<InlineAgentsTasksGetResponse404JsonErrorsItemX1db4cf7d>? = null

    /**
     * List of validation errors (present only for 422 responses)
     */
    public var errors: List<InlineAgentsTasksGetResponse404JsonErrorsItemX1db4cf7d>?
  ...
  internal object Serializer : KSerializer<InlineAgentsTasksGetResponse404JsonXdd9058db> {
