 ...
 * ead/properties/repo/properties/owner.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-unassigned/properties/pull_request/properties/h
 * ead/properties/repo/properties/owner
 */
@Serializable(with = InlineWebhookPullRequestUnassignedPullRequestHeadRepoOwnerX3b57c09e.Serializer::class)
public class InlineWebhookPullRequestUnassignedPullRequestHeadRepoOwnerX3b57c09e(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestUnassignedPullRequestHeadRepoOwnerTypeX48db9da3? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestUnassignedPullRequestHeadRepoOwnerTypeX48db9da3? = null
    ...
    public fun build(): InlineWebhookPullRequestUnassignedPullRequestHeadRepoOwnerX3b57c09e {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestUnassignedPullRequestHeadRepoOwnerX3b57c09e(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestUnassignedPullRequestHeadRepoOwnerX3b57c09e = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestUnassignedPullRequestHeadRepoOwnerX3b57c09e> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestUnassignedPullRequestHeadRepoOwnerX3b57c09e {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestUnassignedPullRequestHeadRepoOwnerX3b57c09e")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestUnassignedPullRequestHeadRepoOwnerX3b57c09e must be a JSON object")
      ...
      return InlineWebhookPullRequestUnassignedPullRequestHeadRepoOwnerX3b57c09e(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestUnassignedPullRequestHeadRepoOwnerTypeX48db9da3>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestUnassignedPullRequestHeadRepoOwnerX3b57c09e) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestUnassignedPullRequestHeadRepoOwnerX3b57c09e")
...
public fun inlineWebhookPullRequestUnassignedPullRequestHeadRepoOwnerX3b57c09e(block: InlineWebhookPullRequestUnassignedPullRequestHeadRepoOwnerX3b57c09e.Builder.() -> Unit): InlineWebhookPullRequestUnassignedPullRequestHeadRepoOwnerX3b57c09e = InlineWebhookPullRequestUnassignedPullRequestHeadRepoOwnerX3b57c09e.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestUnassignedPullRequestHeadRepoOwnerX3b57c09e is missing required property '" + name + "'")
