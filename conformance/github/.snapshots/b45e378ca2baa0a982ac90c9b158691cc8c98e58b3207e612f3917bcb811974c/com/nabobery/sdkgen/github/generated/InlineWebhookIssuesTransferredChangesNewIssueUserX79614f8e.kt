 ...
 * roperties/user
 */
@Serializable(with = InlineWebhookIssuesTransferredChangesNewIssueUserX79614f8e.Serializer::class)
public class InlineWebhookIssuesTransferredChangesNewIssueUserX79614f8e(
  public val id: Long,
  ...
  public val type: InlineWebhookIssuesTransferredChangesNewIssueUserTypeX1ea162bb? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookIssuesTransferredChangesNewIssueUserTypeX1ea162bb? = null
    ...
    public fun build(): InlineWebhookIssuesTransferredChangesNewIssueUserX79614f8e {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssuesTransferredChangesNewIssueUserX79614f8e(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesTransferredChangesNewIssueUserX79614f8e = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesTransferredChangesNewIssueUserX79614f8e> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesTransferredChangesNewIssueUserX79614f8e {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesTransferredChangesNewIssueUserX79614f8e")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesTransferredChangesNewIssueUserX79614f8e must be a JSON object")
      ...
      return InlineWebhookIssuesTransferredChangesNewIssueUserX79614f8e(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssuesTransferredChangesNewIssueUserTypeX1ea162bb>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesTransferredChangesNewIssueUserX79614f8e) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesTransferredChangesNewIssueUserX79614f8e")
...
public fun inlineWebhookIssuesTransferredChangesNewIssueUserX79614f8e(block: InlineWebhookIssuesTransferredChangesNewIssueUserX79614f8e.Builder.() -> Unit): InlineWebhookIssuesTransferredChangesNewIssueUserX79614f8e = InlineWebhookIssuesTransferredChangesNewIssueUserX79614f8e.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesTransferredChangesNewIssueUserX79614f8e is missing required property '" + name + "'")
