 ...
 * ketplace_purchase/properties/plan.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-marketplace-purchase-pending-change-cancelled/properties/mar
 * ketplace_purchase/properties/plan
 */
@Serializable(with = InlineWebhookMarketplacePudb4aMarketplacePurchasePlanXd6aec867.Serializer::class)
public class InlineWebhookMarketplacePudb4aMarketplacePurchasePlanXd6aec867(
  bullets: List<String>,
  ...
  public val priceModel: InlineWebhookMarketplacePudb4aMarketplacePurchasePlanPriceModelX9ad30e45,
  ...
  public class Builder {
    ...
    private var priceModelValue:
        InlineWebhookMarketplacePudb4aMarketplacePurchasePlanPriceModelX9ad30e45? = null

    public var priceModel: InlineWebhookMarketplacePudb4aMarketplacePurchasePlanPriceModelX9ad30e45
    ...
    public fun build(): InlineWebhookMarketplacePudb4aMarketplacePurchasePlanXd6aec867 {
      ...
      return InlineWebhookMarketplacePudb4aMarketplacePurchasePlanXd6aec867(
        bullets = bullets,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookMarketplacePudb4aMarketplacePurchasePlanXd6aec867 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookMarketplacePudb4aMarketplacePurchasePlanXd6aec867> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookMarketplacePudb4aMarketplacePurchasePlanXd6aec867 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookMarketplacePudb4aMarketplacePurchasePlanXd6aec867")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookMarketplacePudb4aMarketplacePurchasePlanXd6aec867 must be a JSON object")
      ...
      val priceModel = json.decodeRequired<InlineWebhookMarketplacePudb4aMarketplacePurchasePlanPriceModelX9ad30e45>(rawObject, "price_model")
      val yearlyPriceInCents = json.decodeRequired<Int>(rawObject, "yearly_price_in_cents")
      if (!rawObject.containsKey("unit_name")) {
        throw SerializationException("InlineWebhookMarketplacePudb4aMarketplacePurchasePlanXd6aec867 is missing required property 'unit_name'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookMarketplacePudb4aMarketplacePurchasePlanXd6aec867) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookMarketplacePudb4aMarketplacePurchasePlanXd6aec867")
...
public fun inlineWebhookMarketplacePudb4aMarketplacePurchasePlanXd6aec867(block: InlineWebhookMarketplacePudb4aMarketplacePurchasePlanXd6aec867.Builder.() -> Unit): InlineWebhookMarketplacePudb4aMarketplacePurchasePlanXd6aec867 = InlineWebhookMarketplacePudb4aMarketplacePurchasePlanXd6aec867.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookMarketplacePudb4aMarketplacePurchasePlanXd6aec867 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookMarketplacePudb4aMarketplacePurchasePlanXd6aec867 property '" + name + "' is not nullable")
