 ...
 * s/head_repository
 */
@Serializable(with = InlineWebhookDeploymentReviewRejectedWorkflowRunHeadRepositoryXb8d5152a.Serializer::class)
public class InlineWebhookDeploymentReviewRejectedWorkflowRunHeadRepositoryXb8d5152a(
  ...
  public val owner:
      InlineWebhookDeploymentReviewRejectedWorkflowRunHeadRepositoryOwnerX57180791? = null,
  ...
  public class Builder {
    ...
    public var owner: InlineWebhookDeploymentReviewRejectedWorkflowRunHeadRepositoryOwnerX57180791?
        = null
    ...
    public fun build(): InlineWebhookDeploymentReviewRejectedWorkflowRunHeadRepositoryXb8d5152a = InlineWebhookDeploymentReviewRejectedWorkflowRunHeadRepositoryXb8d5152a(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookDeploymentReviewRejectedWorkflowRunHeadRepositoryXb8d5152a = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookDeploymentReviewRejectedWorkflowRunHeadRepositoryXb8d5152a> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookDeploymentReviewRejectedWorkflowRunHeadRepositoryXb8d5152a {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookDeploymentReviewRejectedWorkflowRunHeadRepositoryXb8d5152a")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookDeploymentReviewRejectedWorkflowRunHeadRepositoryXb8d5152a must be a JSON object")
      return InlineWebhookDeploymentReviewRejectedWorkflowRunHeadRepositoryXb8d5152a(
        ...
        owner = rawObject["owner"]?.let { json.decodeFromJsonElement<InlineWebhookDeploymentReviewRejectedWorkflowRunHeadRepositoryOwnerX57180791>(it) },
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookDeploymentReviewRejectedWorkflowRunHeadRepositoryXb8d5152a) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookDeploymentReviewRejectedWorkflowRunHeadRepositoryXb8d5152a")
...
public fun inlineWebhookDeploymentReviewRejectedWorkflowRunHeadRepositoryXb8d5152a(block: InlineWebhookDeploymentReviewRejectedWorkflowRunHeadRepositoryXb8d5152a.Builder.() -> Unit): InlineWebhookDeploymentReviewRejectedWorkflowRunHeadRepositoryXb8d5152a = InlineWebhookDeploymentReviewRejectedWorkflowRunHeadRepositoryXb8d5152a.build(block)
