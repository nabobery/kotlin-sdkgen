 ...
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-reopened/properties/issue/properties/assignees/items
 */
@Serializable(with = InlineWebhookIssuesReopenedIssueAssigneesItemXd186e203.Serializer::class)
public class InlineWebhookIssuesReopenedIssueAssigneesItemXd186e203(
  public val id: Int,
  ...
  public val type: InlineWebhookIssuesReopenedIssueAssigneesItemTypeXd5351bb7? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookIssuesReopenedIssueAssigneesItemTypeXd5351bb7? = null
    ...
    public fun build(): InlineWebhookIssuesReopenedIssueAssigneesItemXd186e203 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssuesReopenedIssueAssigneesItemXd186e203(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesReopenedIssueAssigneesItemXd186e203 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesReopenedIssueAssigneesItemXd186e203> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesReopenedIssueAssigneesItemXd186e203 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesReopenedIssueAssigneesItemXd186e203")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesReopenedIssueAssigneesItemXd186e203 must be a JSON object")
      ...
      return InlineWebhookIssuesReopenedIssueAssigneesItemXd186e203(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssuesReopenedIssueAssigneesItemTypeXd5351bb7>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesReopenedIssueAssigneesItemXd186e203) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesReopenedIssueAssigneesItemXd186e203")
...
public fun inlineWebhookIssuesReopenedIssueAssigneesItemXd186e203(block: InlineWebhookIssuesReopenedIssueAssigneesItemXd186e203.Builder.() -> Unit): InlineWebhookIssuesReopenedIssueAssigneesItemXd186e203 = InlineWebhookIssuesReopenedIssueAssigneesItemXd186e203.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesReopenedIssueAssigneesItemXd186e203 is missing required property '" + name + "'")
