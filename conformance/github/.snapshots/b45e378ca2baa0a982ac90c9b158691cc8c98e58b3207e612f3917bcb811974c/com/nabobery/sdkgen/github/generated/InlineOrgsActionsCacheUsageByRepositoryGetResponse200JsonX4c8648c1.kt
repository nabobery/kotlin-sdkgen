...
public class InlineOrgsActionsCacheUsageByRepositoryGetResponse200JsonX4c8648c1(
  ...
  public class Builder {
    ...
    public var repositoryCacheUsages: List<ActionsCacheUsageByRepository>
      get() = requireNotNull(repositoryCacheUsagesValue) { "repositoryCacheUsages is required" }.toList()
      set(`value`) {
        repositoryCacheUsagesValue = value.toList()
      }
  ...
  internal object Serializer : KSerializer<InlineOrgsActionsCacheUsageByRepositoryGetResponse200JsonX4c8648c1> {
