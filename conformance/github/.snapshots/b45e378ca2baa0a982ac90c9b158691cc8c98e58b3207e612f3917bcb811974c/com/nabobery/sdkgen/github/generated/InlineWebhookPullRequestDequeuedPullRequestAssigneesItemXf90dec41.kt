 ...
 * ignees/items
 */
@Serializable(with = InlineWebhookPullRequestDequeuedPullRequestAssigneesItemXf90dec41.Serializer::class)
public class InlineWebhookPullRequestDequeuedPullRequestAssigneesItemXf90dec41(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestDequeuedPullRequestAssigneesItemTypeX2cf3dcdd? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestDequeuedPullRequestAssigneesItemTypeX2cf3dcdd? = null
    ...
    public fun build(): InlineWebhookPullRequestDequeuedPullRequestAssigneesItemXf90dec41 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestDequeuedPullRequestAssigneesItemXf90dec41(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestDequeuedPullRequestAssigneesItemXf90dec41 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestDequeuedPullRequestAssigneesItemXf90dec41> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestDequeuedPullRequestAssigneesItemXf90dec41 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestDequeuedPullRequestAssigneesItemXf90dec41")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestDequeuedPullRequestAssigneesItemXf90dec41 must be a JSON object")
      ...
      return InlineWebhookPullRequestDequeuedPullRequestAssigneesItemXf90dec41(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestDequeuedPullRequestAssigneesItemTypeX2cf3dcdd>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestDequeuedPullRequestAssigneesItemXf90dec41) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestDequeuedPullRequestAssigneesItemXf90dec41")
...
public fun inlineWebhookPullRequestDequeuedPullRequestAssigneesItemXf90dec41(block: InlineWebhookPullRequestDequeuedPullRequestAssigneesItemXf90dec41.Builder.() -> Unit): InlineWebhookPullRequestDequeuedPullRequestAssigneesItemXf90dec41 = InlineWebhookPullRequestDequeuedPullRequestAssigneesItemXf90dec41.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestDequeuedPullRequestAssigneesItemXf90dec41 is missing required property '" + name + "'")
