 ...
 * ase/properties/repo
 */
@Serializable(with = InlineWebhookPullRequestUnassignedPullRequestBaseRepoX3ef262bf.Serializer::class)
public class InlineWebhookPullRequestUnassignedPullRequestBaseRepoX3ef262bf internal constructor(
  /**
  ...
  public val createdAt: InlineWebhookPullRequestUnassignedPullRequestBaseRepoCreatedAtXb67f3eaf,
  /**
  ...
  public val license: InlineWebhookPullRequestUnassignedPullRequestBaseRepoLicenseXc0b8bf15?,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val owner: InlineWebhookPullRequestUnassignedPullRequestBaseRepoOwnerXb98f8a62?,
  /**
  ...
  public val pushedAt: InlineWebhookPullRequestUnassignedPullRequestBaseRepoPushedAtX9c165fd2?,
  /**
   * Wire format: `uri-template`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val visibility: InlineWebhookPullRequestUnassignedPullRequestBaseRepoVisibilityX64b686a3,
  ...
  private val mergeCommitMessageState:
      FieldState<InlineWebhookPullRequestUnassignedPullRequestBaseRepoMergeCommitMessageX95e895d6>,
  private val mergeCommitTitleState:
      FieldState<InlineWebhookPullRequestUnassignedPullRequestBaseRepoMergeCommitTitleXcfa1516c>,
  private val organizationState: FieldState<String>,
  private val permissionsState:
      FieldState<InlineWebhookPullRequestUnassignedPullRequestBaseRepoPermissionsX2552a4c9>,
  private val publicState: FieldState<Boolean>,
  private val pullRequestCreationPolicyState:
      FieldState<InlineWebhookPullRequestUn16b6PullRequestBasePullRequestCreationP824dX79ff91a6>,
  private val roleNameState: FieldState<String?>,
  private val squashMergeCommitMessageState:
      FieldState<InlineWebhookPullRequestUn16b6PullRequestBaseSquashMergeCommitMessageX0569c36b>,
  private val squashMergeCommitTitleState:
      FieldState<InlineWebhookPullRequestUn16b6PullRequestBaseRepoSquashMergeCommitTitleX2588b53c>,
  ...
  public val permissions: InlineWebhookPullRequestUnassignedPullRequestBaseRepoPermissionsX2552a4c9?
  ...
  public val squashMergeCommitTitle:
      InlineWebhookPullRequestUn16b6PullRequestBaseRepoSquashMergeCommitTitleX2588b53c?
  ...
  public constructor(
    ...
    createdAt: InlineWebhookPullRequestUnassignedPullRequestBaseRepoCreatedAtXb67f3eaf,
    ...
    language: String?,
    languagesUrl: String,
    license: InlineWebhookPullRequestUnassignedPullRequestBaseRepoLicenseXc0b8bf15?,
    mergesUrl: String,
    ...
    openIssues: Int,
    openIssuesCount: Int,
    owner: InlineWebhookPullRequestUnassignedPullRequestBaseRepoOwnerXb98f8a62?,
    `private`: Boolean,
    pullsUrl: String,
    pushedAt: InlineWebhookPullRequestUnassignedPullRequestBaseRepoPushedAtX9c165fd2?,
    releasesUrl: String,
    size: Int,
    sshUrl: String,
    stargazersCount: Int,
    ...
    updatedAt: String,
    url: String,
    visibility: InlineWebhookPullRequestUnassignedPullRequestBaseRepoVisibilityX64b686a3,
    watchers: Int,
    watchersCount: Int,
  ...
  public class Builder {
    ...
    private var createdAtValue:
        InlineWebhookPullRequestUnassignedPullRequestBaseRepoCreatedAtXb67f3eaf? = null

    public var createdAt: InlineWebhookPullRequestUnassignedPullRequestBaseRepoCreatedAtXb67f3eaf
    ...
    private var visibilityValue:
        InlineWebhookPullRequestUnassignedPullRequestBaseRepoVisibilityX64b686a3? = null

    public var visibility: InlineWebhookPullRequestUnassignedPullRequestBaseRepoVisibilityX64b686a3
    ...
    private var licenseState:
        FieldState<InlineWebhookPullRequestUnassignedPullRequestBaseRepoLicenseXc0b8bf15?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var license: InlineWebhookPullRequestUnassignedPullRequestBaseRepoLicenseXc0b8bf15?
    ...
    private var ownerState:
        FieldState<InlineWebhookPullRequestUnassignedPullRequestBaseRepoOwnerXb98f8a62?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var owner: InlineWebhookPullRequestUnassignedPullRequestBaseRepoOwnerXb98f8a62?
    ...
    private var pushedAtState:
        FieldState<InlineWebhookPullRequestUnassignedPullRequestBaseRepoPushedAtX9c165fd2?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var pushedAt: InlineWebhookPullRequestUnassignedPullRequestBaseRepoPushedAtX9c165fd2?
    ...
    public var permissions:
        InlineWebhookPullRequestUnassignedPullRequestBaseRepoPermissionsX2552a4c9?
      get() = permissionsState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): InlineWebhookPullRequestUnassignedPullRequestBaseRepoX3ef262bf {
      ...
      return InlineWebhookPullRequestUnassignedPullRequestBaseRepoX3ef262bf(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestUnassignedPullRequestBaseRepoX3ef262bf = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestUnassignedPullRequestBaseRepoX3ef262bf> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestUnassignedPullRequestBaseRepoX3ef262bf {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestUnassignedPullRequestBaseRepoX3ef262bf")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestUnassignedPullRequestBaseRepoX3ef262bf must be a JSON object")
      ...
      val createdAt = json.decodeRequired<InlineWebhookPullRequestUnassignedPullRequestBaseRepoCreatedAtXb67f3eaf>(rawObject, "created_at")
      ...
      val visibility = json.decodeRequired<InlineWebhookPullRequestUnassignedPullRequestBaseRepoVisibilityX64b686a3>(rawObject, "visibility")
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookPullRequestUnassignedPullRequestBaseRepoX3ef262bf is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("homepage")) {
        throw SerializationException("InlineWebhookPullRequestUnassignedPullRequestBaseRepoX3ef262bf is missing required property 'homepage'")
      }
      ...
      if (!rawObject.containsKey("language")) {
        throw SerializationException("InlineWebhookPullRequestUnassignedPullRequestBaseRepoX3ef262bf is missing required property 'language'")
      }
      ...
      if (!rawObject.containsKey("license")) {
        throw SerializationException("InlineWebhookPullRequestUnassignedPullRequestBaseRepoX3ef262bf is missing required property 'license'")
      }
      val license = rawObject["license"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestUnassignedPullRequestBaseRepoLicenseXc0b8bf15?>(requireNotNull(element)) }
      if (!rawObject.containsKey("mirror_url")) {
        throw SerializationException("InlineWebhookPullRequestUnassignedPullRequestBaseRepoX3ef262bf is missing required property 'mirror_url'")
      }
      ...
      if (!rawObject.containsKey("owner")) {
        throw SerializationException("InlineWebhookPullRequestUnassignedPullRequestBaseRepoX3ef262bf is missing required property 'owner'")
      }
      val owner = rawObject["owner"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestUnassignedPullRequestBaseRepoOwnerXb98f8a62?>(requireNotNull(element)) }
      if (!rawObject.containsKey("pushed_at")) {
        throw SerializationException("InlineWebhookPullRequestUnassignedPullRequestBaseRepoX3ef262bf is missing required property 'pushed_at'")
      }
      val pushedAt = rawObject["pushed_at"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestUnassignedPullRequestBaseRepoPushedAtX9c165fd2?>(requireNotNull(element)) }
      return InlineWebhookPullRequestUnassignedPullRequestBaseRepoX3ef262bf(
        archiveUrl = archiveUrl,
        archived = archived,
        assigneesUrl = assigneesUrl,
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestUnassignedPullRequestBaseRepoX3ef262bf) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestUnassignedPullRequestBaseRepoX3ef262bf")
...
public fun inlineWebhookPullRequestUnassignedPullRequestBaseRepoX3ef262bf(block: InlineWebhookPullRequestUnassignedPullRequestBaseRepoX3ef262bf.Builder.() -> Unit): InlineWebhookPullRequestUnassignedPullRequestBaseRepoX3ef262bf = InlineWebhookPullRequestUnassignedPullRequestBaseRepoX3ef262bf.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestUnassignedPullRequestBaseRepoX3ef262bf is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookPullRequestUnassignedPullRequestBaseRepoX3ef262bf property '" + name + "' is not nullable")
