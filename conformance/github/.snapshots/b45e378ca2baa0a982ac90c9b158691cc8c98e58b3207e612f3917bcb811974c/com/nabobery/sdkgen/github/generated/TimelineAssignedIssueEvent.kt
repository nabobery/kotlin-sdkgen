 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/timeline-assigned-issue-event
 */
@Serializable(with = TimelineAssignedIssueEvent.Serializer::class)
public class TimelineAssignedIssueEvent(
  ...
  public class Builder {
    ...
    public fun build(): TimelineAssignedIssueEvent {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): TimelineAssignedIssueEvent = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<TimelineAssignedIssueEvent> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): TimelineAssignedIssueEvent {
      val jsonDecoder = decoder.requireJsonDecoder("TimelineAssignedIssueEvent")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("TimelineAssignedIssueEvent must be a JSON object")
      ...
      if (!rawObject.containsKey("commit_id")) {
        throw SerializationException("TimelineAssignedIssueEvent is missing required property 'commit_id'")
      }
      ...
      if (!rawObject.containsKey("commit_url")) {
        throw SerializationException("TimelineAssignedIssueEvent is missing required property 'commit_url'")
      }
      ...
      if (!rawObject.containsKey("performed_via_github_app")) {
        throw SerializationException("TimelineAssignedIssueEvent is missing required property 'performed_via_github_app'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: TimelineAssignedIssueEvent) {
      val jsonEncoder = encoder.requireJsonEncoder("TimelineAssignedIssueEvent")
...
public fun timelineAssignedIssueEvent(block: TimelineAssignedIssueEvent.Builder.() -> Unit): TimelineAssignedIssueEvent = TimelineAssignedIssueEvent.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("TimelineAssignedIssueEvent is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("TimelineAssignedIssueEvent property '" + name + "' is not nullable")
