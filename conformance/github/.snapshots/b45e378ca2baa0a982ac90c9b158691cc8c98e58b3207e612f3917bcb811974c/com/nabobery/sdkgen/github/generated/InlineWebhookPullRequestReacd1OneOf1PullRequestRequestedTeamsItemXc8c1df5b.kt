 ...
 * request/properties/requested_teams/items
 */
@Serializable(with = InlineWebhookPullRequestReacd1OneOf1PullRequestRequestedTeamsItemXc8c1df5b.Serializer::class)
public class InlineWebhookPullRequestReacd1OneOf1PullRequestRequestedTeamsItemXc8c1df5b internal constructor(
  /**
  ...
  public val privacy: InlineWebhookPullRequestReacd1OneOf1PullRequestRequestedTeamsPrivacyX59a185bd,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  private val parentState:
      FieldState<InlineWebhookPullRequestReacd1OneOf1PullRequestRequestedTeamsItemParentXe30f1cd5?>,
) {
  public val deleted: Boolean?
    get() = deletedState.valueOrNull()

  public val parent:
      InlineWebhookPullRequestReacd1OneOf1PullRequestRequestedTeamsItemParentXe30f1cd5?
  ...
  public constructor(
    ...
    nodeId: String,
    permission: String,
    privacy: InlineWebhookPullRequestReacd1OneOf1PullRequestRequestedTeamsPrivacyX59a185bd,
  ...
  public class Builder {
    ...
    private var privacyValue:
        InlineWebhookPullRequestReacd1OneOf1PullRequestRequestedTeamsPrivacyX59a185bd? = null

    public var privacy:
        InlineWebhookPullRequestReacd1OneOf1PullRequestRequestedTeamsPrivacyX59a185bd
    ...
    public fun build(): InlineWebhookPullRequestReacd1OneOf1PullRequestRequestedTeamsItemXc8c1df5b {
      ...
      return InlineWebhookPullRequestReacd1OneOf1PullRequestRequestedTeamsItemXc8c1df5b(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReacd1OneOf1PullRequestRequestedTeamsItemXc8c1df5b = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReacd1OneOf1PullRequestRequestedTeamsItemXc8c1df5b> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReacd1OneOf1PullRequestRequestedTeamsItemXc8c1df5b {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReacd1OneOf1PullRequestRequestedTeamsItemXc8c1df5b")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReacd1OneOf1PullRequestRequestedTeamsItemXc8c1df5b must be a JSON object")
      ...
      val privacy = json.decodeRequired<InlineWebhookPullRequestReacd1OneOf1PullRequestRequestedTeamsPrivacyX59a185bd>(rawObject, "privacy")
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookPullRequestReacd1OneOf1PullRequestRequestedTeamsItemXc8c1df5b is missing required property 'description'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReacd1OneOf1PullRequestRequestedTeamsItemXc8c1df5b) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReacd1OneOf1PullRequestRequestedTeamsItemXc8c1df5b")
...
public fun inlineWebhookPullRequestReacd1OneOf1PullRequestRequestedTeamsItemXc8c1df5b(block: InlineWebhookPullRequestReacd1OneOf1PullRequestRequestedTeamsItemXc8c1df5b.Builder.() -> Unit): InlineWebhookPullRequestReacd1OneOf1PullRequestRequestedTeamsItemXc8c1df5b = InlineWebhookPullRequestReacd1OneOf1PullRequestRequestedTeamsItemXc8c1df5b.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReacd1OneOf1PullRequestRequestedTeamsItemXc8c1df5b is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookPullRequestReacd1OneOf1PullRequestRequestedTeamsItemXc8c1df5b property '" + name + "' is not nullable")
