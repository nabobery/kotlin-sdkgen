 ...
 * ies/package_version/properties/author.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-registry-package-updated/properties/registry_package/propert
 * ies/package_version/properties/author
 */
@Serializable(with = InlineWebhookRegistryPackageUpdatedRegistryPackagePackageVersionAuthorX0d4067da.Serializer::class)
public class InlineWebhookRegistryPackageUpdatedRegistryPackagePackageVersionAuthorX0d4067da(
  ...
  public class Builder {
    ...
    public fun build(): InlineWebhookRegistryPackageUpdatedRegistryPackagePackageVersionAuthorX0d4067da {
      ...
      return InlineWebhookRegistryPackageUpdatedRegistryPackagePackageVersionAuthorX0d4067da(
        avatarUrl = avatarUrl,
        eventsUrl = eventsUrl,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookRegistryPackageUpdatedRegistryPackagePackageVersionAuthorX0d4067da = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookRegistryPackageUpdatedRegistryPackagePackageVersionAuthorX0d4067da> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookRegistryPackageUpdatedRegistryPackagePackageVersionAuthorX0d4067da {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookRegistryPackageUpdatedRegistryPackagePackageVersionAuthorX0d4067da")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookRegistryPackageUpdatedRegistryPackagePackageVersionAuthorX0d4067da must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookRegistryPackageUpdatedRegistryPackagePackageVersionAuthorX0d4067da) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookRegistryPackageUpdatedRegistryPackagePackageVersionAuthorX0d4067da")
...
public fun inlineWebhookRegistryPackageUpdatedRegistryPackagePackageVersionAuthorX0d4067da(block: InlineWebhookRegistryPackageUpdatedRegistryPackagePackageVersionAuthorX0d4067da.Builder.() -> Unit): InlineWebhookRegistryPackageUpdatedRegistryPackagePackageVersionAuthorX0d4067da = InlineWebhookRegistryPackageUpdatedRegistryPackagePackageVersionAuthorX0d4067da.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookRegistryPackageUpdatedRegistryPackagePackageVersionAuthorX0d4067da is missing required property '" + name + "'")
