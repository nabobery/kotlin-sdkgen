 ...
 * estone/properties/creator
 */
@Serializable(with = InlineWebhookPullRequestDequeuedPullRequestMilestoneCreatorX2cc1afea.Serializer::class)
public class InlineWebhookPullRequestDequeuedPullRequestMilestoneCreatorX2cc1afea(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestDequeuedPullRequestMilestoneCreatorTypeXdeeeebff? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestDequeuedPullRequestMilestoneCreatorTypeXdeeeebff? =
        null
    ...
    public fun build(): InlineWebhookPullRequestDequeuedPullRequestMilestoneCreatorX2cc1afea {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestDequeuedPullRequestMilestoneCreatorX2cc1afea(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestDequeuedPullRequestMilestoneCreatorX2cc1afea = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestDequeuedPullRequestMilestoneCreatorX2cc1afea> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestDequeuedPullRequestMilestoneCreatorX2cc1afea {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestDequeuedPullRequestMilestoneCreatorX2cc1afea")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestDequeuedPullRequestMilestoneCreatorX2cc1afea must be a JSON object")
      ...
      return InlineWebhookPullRequestDequeuedPullRequestMilestoneCreatorX2cc1afea(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestDequeuedPullRequestMilestoneCreatorTypeXdeeeebff>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestDequeuedPullRequestMilestoneCreatorX2cc1afea) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestDequeuedPullRequestMilestoneCreatorX2cc1afea")
...
public fun inlineWebhookPullRequestDequeuedPullRequestMilestoneCreatorX2cc1afea(block: InlineWebhookPullRequestDequeuedPullRequestMilestoneCreatorX2cc1afea.Builder.() -> Unit): InlineWebhookPullRequestDequeuedPullRequestMilestoneCreatorX2cc1afea = InlineWebhookPullRequestDequeuedPullRequestMilestoneCreatorX2cc1afea.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestDequeuedPullRequestMilestoneCreatorX2cc1afea is missing required property '" + name + "'")
