 ...
 */
@Serializable(with = InlineWebhookPullRequestRe5d81PullRequestRequestedReviewersItemOneOf2X0f0f6ce5.Serializer::class)
public class InlineWebhookPullRequestRe5d81PullRequestRequestedReviewersItemOneOf2X0f0f6ce5 internal constructor(
  ...
  private val parentState:
      FieldState<InlineWebhookPullRequestRe5d81PullRequestRequestedReviewersItemParentX6ee07cf3?>,
) {
  public val deleted: Boolean?
    get() = deletedState.valueOrNull()

  public val parent: InlineWebhookPullRequestRe5d81PullRequestRequestedReviewersItemParentX6ee07cf3?
  ...
  public class Builder {
    ...
    private var privacyValue:
        InlineWebhookPullRequestRe5d81PullRequestRequestedReviewersItemPrivacyXe7fbaac8? = null
     ...
     */
    public var parent:
        InlineWebhookPullRequestRe5d81PullRequestRequestedReviewersItemParentX6ee07cf3?
      get() = parentState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): InlineWebhookPullRequestRe5d81PullRequestRequestedReviewersItemOneOf2X0f0f6ce5 {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestRe5d81PullRequestRequestedReviewersItemOneOf2X0f0f6ce5 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestRe5d81PullRequestRequestedReviewersItemOneOf2X0f0f6ce5> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestRe5d81PullRequestRequestedReviewersItemOneOf2X0f0f6ce5 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestRe5d81PullRequestRequestedReviewersItemOneOf2X0f0f6ce5")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestRe5d81PullRequestRequestedReviewersItemOneOf2X0f0f6ce5 must be a JSON object")
      ...
      val privacy = json.decodeRequired<InlineWebhookPullRequestRe5d81PullRequestRequestedReviewersItemPrivacyXe7fbaac8>(rawObject, "privacy")
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookPullRequestRe5d81PullRequestRequestedReviewersItemOneOf2X0f0f6ce5 is missing required property 'description'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestRe5d81PullRequestRequestedReviewersItemOneOf2X0f0f6ce5) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestRe5d81PullRequestRequestedReviewersItemOneOf2X0f0f6ce5")
...
public fun inlineWebhookPullRequestRe5d81PullRequestRequestedReviewersItemOneOf2X0f0f6ce5(block: InlineWebhookPullRequestRe5d81PullRequestRequestedReviewersItemOneOf2X0f0f6ce5.Builder.() -> Unit): InlineWebhookPullRequestRe5d81PullRequestRequestedReviewersItemOneOf2X0f0f6ce5 = InlineWebhookPullRequestRe5d81PullRequestRequestedReviewersItemOneOf2X0f0f6ce5.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestRe5d81PullRequestRequestedReviewersItemOneOf2X0f0f6ce5 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookPullRequestRe5d81PullRequestRequestedReviewersItemOneOf2X0f0f6ce5 property '" + name + "' is not nullable")
