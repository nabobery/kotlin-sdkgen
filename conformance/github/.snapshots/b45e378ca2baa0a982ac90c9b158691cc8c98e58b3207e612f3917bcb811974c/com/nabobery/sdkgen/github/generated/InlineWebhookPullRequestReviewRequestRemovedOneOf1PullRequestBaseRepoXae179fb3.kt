 ...
 */
@Serializable(with = InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestBaseRepoXae179fb3.Serializer::class)
public class InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestBaseRepoXae179fb3 internal constructor(
  /**
  ...
  public val createdAt: InlineWebhookPullRequestReacd1OneOf1PullRequestBaseRepoCreatedAtX6702a26a,
  /**
  ...
  public val license: InlineWebhookPullRequestReacd1OneOf1PullRequestBaseRepoLicenseXc1a0b452?,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val owner: InlineWebhookPullRequestReacd1OneOf1PullRequestBaseRepoOwnerX50748a59?,
  /**
  ...
  public val pushedAt: InlineWebhookPullRequestReacd1OneOf1PullRequestBaseRepoPushedAtX10361a4a?,
  /**
   * Wire format: `uri-template`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val visibility: InlineWebhookPullRequestReacd1OneOf1PullRequestBaseRepoVisibilityX8ebaf601,
  ...
  private val mergeCommitMessageState:
      FieldState<InlineWebhookPullRequestReacd1OneOf1PullRequestBaseMergeCommitMessageX2594e2c6>,
  private val mergeCommitTitleState:
      FieldState<InlineWebhookPullRequestReacd1OneOf1PullRequestBaseRepoMergeCommitTitleXd17ca1e2>,
  private val organizationState: FieldState<String>,
  private val permissionsState:
      FieldState<InlineWebhookPullRequestReacd1OneOf1PullRequestBaseRepoPermissionsX921edf69>,
  private val publicState: FieldState<Boolean>,
  private val pullRequestCreationPolicyState:
      FieldState<InlineWebhookPullRequestReacd1OneOf1PullRequestPullRequestCreationP824dX0c375178>,
  private val roleNameState: FieldState<String?>,
  private val squashMergeCommitMessageState:
      FieldState<InlineWebhookPullRequestReacd1OneOf1PullRequestSquashMergeCommitMessageX0a82afcc>,
  private val squashMergeCommitTitleState:
      FieldState<InlineWebhookPullRequestReacd1OneOf1PullRequestSquashMergeCommitTitleX9feffd7c>,
  ...
  public val permissions:
      InlineWebhookPullRequestReacd1OneOf1PullRequestBaseRepoPermissionsX921edf69?
  ...
  public constructor(
    ...
    createdAt: InlineWebhookPullRequestReacd1OneOf1PullRequestBaseRepoCreatedAtX6702a26a,
    ...
    language: String?,
    languagesUrl: String,
    license: InlineWebhookPullRequestReacd1OneOf1PullRequestBaseRepoLicenseXc1a0b452?,
    mergesUrl: String,
    ...
    openIssues: Int,
    openIssuesCount: Int,
    owner: InlineWebhookPullRequestReacd1OneOf1PullRequestBaseRepoOwnerX50748a59?,
    `private`: Boolean,
    pullsUrl: String,
    pushedAt: InlineWebhookPullRequestReacd1OneOf1PullRequestBaseRepoPushedAtX10361a4a?,
    releasesUrl: String,
    size: Int,
    sshUrl: String,
    stargazersCount: Int,
    ...
    updatedAt: String,
    url: String,
    visibility: InlineWebhookPullRequestReacd1OneOf1PullRequestBaseRepoVisibilityX8ebaf601,
    watchers: Int,
    watchersCount: Int,
  ...
  public class Builder {
    ...
    private var createdAtValue:
        InlineWebhookPullRequestReacd1OneOf1PullRequestBaseRepoCreatedAtX6702a26a? = null

    public var createdAt: InlineWebhookPullRequestReacd1OneOf1PullRequestBaseRepoCreatedAtX6702a26a
    ...
    private var visibilityValue:
        InlineWebhookPullRequestReacd1OneOf1PullRequestBaseRepoVisibilityX8ebaf601? = null
    ...
    private var licenseState:
        FieldState<InlineWebhookPullRequestReacd1OneOf1PullRequestBaseRepoLicenseXc1a0b452?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var license: InlineWebhookPullRequestReacd1OneOf1PullRequestBaseRepoLicenseXc1a0b452?
    ...
    private var ownerState:
        FieldState<InlineWebhookPullRequestReacd1OneOf1PullRequestBaseRepoOwnerX50748a59?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var owner: InlineWebhookPullRequestReacd1OneOf1PullRequestBaseRepoOwnerX50748a59?
    ...
    private var pushedAtState:
        FieldState<InlineWebhookPullRequestReacd1OneOf1PullRequestBaseRepoPushedAtX10361a4a?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var pushedAt: InlineWebhookPullRequestReacd1OneOf1PullRequestBaseRepoPushedAtX10361a4a?
    ...
    public fun build(): InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestBaseRepoXae179fb3 {
      ...
      return InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestBaseRepoXae179fb3(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestBaseRepoXae179fb3 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestBaseRepoXae179fb3> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestBaseRepoXae179fb3 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestBaseRepoXae179fb3")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestBaseRepoXae179fb3 must be a JSON object")
      ...
      val createdAt = json.decodeRequired<InlineWebhookPullRequestReacd1OneOf1PullRequestBaseRepoCreatedAtX6702a26a>(rawObject, "created_at")
      ...
      val visibility = json.decodeRequired<InlineWebhookPullRequestReacd1OneOf1PullRequestBaseRepoVisibilityX8ebaf601>(rawObject, "visibility")
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestBaseRepoXae179fb3 is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("homepage")) {
        throw SerializationException("InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestBaseRepoXae179fb3 is missing required property 'homepage'")
      }
      ...
      if (!rawObject.containsKey("language")) {
        throw SerializationException("InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestBaseRepoXae179fb3 is missing required property 'language'")
      }
      ...
      if (!rawObject.containsKey("license")) {
        throw SerializationException("InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestBaseRepoXae179fb3 is missing required property 'license'")
      }
      val license = rawObject["license"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestReacd1OneOf1PullRequestBaseRepoLicenseXc1a0b452?>(requireNotNull(element)) }
      if (!rawObject.containsKey("mirror_url")) {
        throw SerializationException("InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestBaseRepoXae179fb3 is missing required property 'mirror_url'")
      }
      ...
      if (!rawObject.containsKey("owner")) {
        throw SerializationException("InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestBaseRepoXae179fb3 is missing required property 'owner'")
      }
      val owner = rawObject["owner"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestReacd1OneOf1PullRequestBaseRepoOwnerX50748a59?>(requireNotNull(element)) }
      if (!rawObject.containsKey("pushed_at")) {
        throw SerializationException("InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestBaseRepoXae179fb3 is missing required property 'pushed_at'")
      }
      val pushedAt = rawObject["pushed_at"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestReacd1OneOf1PullRequestBaseRepoPushedAtX10361a4a?>(requireNotNull(element)) }
      return InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestBaseRepoXae179fb3(
        archiveUrl = archiveUrl,
        archived = archived,
        assigneesUrl = assigneesUrl,
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestBaseRepoXae179fb3) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestBaseRepoXae179fb3")
...
public fun inlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestBaseRepoXae179fb3(block: InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestBaseRepoXae179fb3.Builder.() -> Unit): InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestBaseRepoXae179fb3 = InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestBaseRepoXae179fb3.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestBaseRepoXae179fb3 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookPullRequestReviewRequestRemovedOneOf1PullRequestBaseRepoXae179fb3 property '" + name + "' is not nullable")
