 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhooks_release_1/properties/assets/items
 */
@Serializable(with = InlineWebhooksRelease1AssetsItemXf2dba3dc.Serializer::class)
public class InlineWebhooksRelease1AssetsItemXf2dba3dc internal constructor(
  /**
   ...
   */
  public val state: InlineWebhooksRelease1AssetsItemStateXc75f492f,
  /**
   * Wire format: `date-time`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  private val uploaderState: FieldState<InlineWebhooksRelease1AssetsItemUploaderX5e0ef77d?>,
) {
  public val uploader: InlineWebhooksRelease1AssetsItemUploaderX5e0ef77d?
  ...
  public constructor(
    ...
    nodeId: String,
    size: Int,
    state: InlineWebhooksRelease1AssetsItemStateXc75f492f,
    updatedAt: String,
    url: String,
  ...
  public class Builder {
    ...
    private var stateValue: InlineWebhooksRelease1AssetsItemStateXc75f492f? = null

    public var state: InlineWebhooksRelease1AssetsItemStateXc75f492f
    ...
    private var uploaderState: FieldState<InlineWebhooksRelease1AssetsItemUploaderX5e0ef77d?> =
        FieldState.Absent

    /**
     * Assigning `null` records present-null; use the unset function to omit the property.
     */
    public var uploader: InlineWebhooksRelease1AssetsItemUploaderX5e0ef77d?
      get() = uploaderState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): InlineWebhooksRelease1AssetsItemXf2dba3dc {
      ...
      return InlineWebhooksRelease1AssetsItemXf2dba3dc(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhooksRelease1AssetsItemXf2dba3dc = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhooksRelease1AssetsItemXf2dba3dc> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhooksRelease1AssetsItemXf2dba3dc {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhooksRelease1AssetsItemXf2dba3dc")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhooksRelease1AssetsItemXf2dba3dc must be a JSON object")
      ...
      val state = json.decodeRequired<InlineWebhooksRelease1AssetsItemStateXc75f492f>(rawObject, "state")
      val updatedAt = json.decodeRequired<String>(rawObject, "updated_at")
      val url = json.decodeRequired<String>(rawObject, "url")
      if (!rawObject.containsKey("digest")) {
        throw SerializationException("InlineWebhooksRelease1AssetsItemXf2dba3dc is missing required property 'digest'")
      }
      ...
      if (!rawObject.containsKey("label")) {
        throw SerializationException("InlineWebhooksRelease1AssetsItemXf2dba3dc is missing required property 'label'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhooksRelease1AssetsItemXf2dba3dc) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhooksRelease1AssetsItemXf2dba3dc")
...
public fun inlineWebhooksRelease1AssetsItemXf2dba3dc(block: InlineWebhooksRelease1AssetsItemXf2dba3dc.Builder.() -> Unit): InlineWebhooksRelease1AssetsItemXf2dba3dc = InlineWebhooksRelease1AssetsItemXf2dba3dc.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhooksRelease1AssetsItemXf2dba3dc is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhooksRelease1AssetsItemXf2dba3dc property '" + name + "' is not nullable")
