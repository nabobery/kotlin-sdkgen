 ...
 * ties/base/properties/user.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-review-dismissed/properties/pull_request/proper
 * ties/base/properties/user
 */
@Serializable(with = InlineWebhookPullRequestReviewDismissedPullRequestBaseUserX194c0dbb.Serializer::class)
public class InlineWebhookPullRequestReviewDismissedPullRequestBaseUserX194c0dbb(
  public val id: Long,
  ...
  public val type: InlineWebhookPullRequestReviewDismissedPullRequestBaseUserTypeX97e4aafc? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestReviewDismissedPullRequestBaseUserTypeX97e4aafc? = null
    ...
    public fun build(): InlineWebhookPullRequestReviewDismissedPullRequestBaseUserX194c0dbb {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestReviewDismissedPullRequestBaseUserX194c0dbb(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewDismissedPullRequestBaseUserX194c0dbb = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewDismissedPullRequestBaseUserX194c0dbb> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewDismissedPullRequestBaseUserX194c0dbb {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewDismissedPullRequestBaseUserX194c0dbb")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewDismissedPullRequestBaseUserX194c0dbb must be a JSON object")
      ...
      return InlineWebhookPullRequestReviewDismissedPullRequestBaseUserX194c0dbb(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestReviewDismissedPullRequestBaseUserTypeX97e4aafc>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewDismissedPullRequestBaseUserX194c0dbb) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewDismissedPullRequestBaseUserX194c0dbb")
...
public fun inlineWebhookPullRequestReviewDismissedPullRequestBaseUserX194c0dbb(block: InlineWebhookPullRequestReviewDismissedPullRequestBaseUserX194c0dbb.Builder.() -> Unit): InlineWebhookPullRequestReviewDismissedPullRequestBaseUserX194c0dbb = InlineWebhookPullRequestReviewDismissedPullRequestBaseUserX194c0dbb.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewDismissedPullRequestBaseUserX194c0dbb is missing required property '" + name + "'")
