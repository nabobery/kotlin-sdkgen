 ...
 * ignees/items
 */
@Serializable(with = InlineWebhookPullRequestAssignedPullRequestAssigneesItemXc7a8e2a7.Serializer::class)
public class InlineWebhookPullRequestAssignedPullRequestAssigneesItemXc7a8e2a7(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestAssignedPullRequestAssigneesItemTypeX7d3fd832? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestAssignedPullRequestAssigneesItemTypeX7d3fd832? = null
    ...
    public fun build(): InlineWebhookPullRequestAssignedPullRequestAssigneesItemXc7a8e2a7 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestAssignedPullRequestAssigneesItemXc7a8e2a7(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestAssignedPullRequestAssigneesItemXc7a8e2a7 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestAssignedPullRequestAssigneesItemXc7a8e2a7> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestAssignedPullRequestAssigneesItemXc7a8e2a7 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestAssignedPullRequestAssigneesItemXc7a8e2a7")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestAssignedPullRequestAssigneesItemXc7a8e2a7 must be a JSON object")
      ...
      return InlineWebhookPullRequestAssignedPullRequestAssigneesItemXc7a8e2a7(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestAssignedPullRequestAssigneesItemTypeX7d3fd832>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestAssignedPullRequestAssigneesItemXc7a8e2a7) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestAssignedPullRequestAssigneesItemXc7a8e2a7")
...
public fun inlineWebhookPullRequestAssignedPullRequestAssigneesItemXc7a8e2a7(block: InlineWebhookPullRequestAssignedPullRequestAssigneesItemXc7a8e2a7.Builder.() -> Unit): InlineWebhookPullRequestAssignedPullRequestAssigneesItemXc7a8e2a7 = InlineWebhookPullRequestAssignedPullRequestAssigneesItemXc7a8e2a7.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestAssignedPullRequestAssigneesItemXc7a8e2a7 is missing required property '" + name + "'")
