...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-issue-comment-edited/properties/issue/allOf/1/properties/use
 * r.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-issue-comment-edited/properties/issue/allOf/1/properties/use
 * r
 */
@Serializable(with = InlineWebhookIssueCommentEditedIssueAllOf2UserX6c3d3b08.Serializer::class)
public class InlineWebhookIssueCommentEditedIssueAllOf2UserX6c3d3b08(
  ...
  public class Builder {
    ...
    public fun build(): InlineWebhookIssueCommentEditedIssueAllOf2UserX6c3d3b08 = InlineWebhookIssueCommentEditedIssueAllOf2UserX6c3d3b08(
      avatarUrl = avatarUrl,
      eventsUrl = eventsUrl,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssueCommentEditedIssueAllOf2UserX6c3d3b08 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssueCommentEditedIssueAllOf2UserX6c3d3b08> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssueCommentEditedIssueAllOf2UserX6c3d3b08 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssueCommentEditedIssueAllOf2UserX6c3d3b08")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssueCommentEditedIssueAllOf2UserX6c3d3b08 must be a JSON object")
      return InlineWebhookIssueCommentEditedIssueAllOf2UserX6c3d3b08(
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssueCommentEditedIssueAllOf2UserX6c3d3b08) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssueCommentEditedIssueAllOf2UserX6c3d3b08")
...
public fun inlineWebhookIssueCommentEditedIssueAllOf2UserX6c3d3b08(block: InlineWebhookIssueCommentEditedIssueAllOf2UserX6c3d3b08.Builder.() -> Unit): InlineWebhookIssueCommentEditedIssueAllOf2UserX6c3d3b08 = InlineWebhookIssueCommentEditedIssueAllOf2UserX6c3d3b08.build(block)
