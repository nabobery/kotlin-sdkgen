 ...
 */
@Serializable(with = InlineWebhookPullRequestReviewCommentDeletedPullRequestBaseRepoX589df380.Serializer::class)
public class InlineWebhookPullRequestReviewCommentDeletedPullRequestBaseRepoX589df380 internal constructor(
  /**
  ...
  public val createdAt: InlineWebhookPullRequestRe8fbbPullRequestBaseRepoCreatedAtX515989ff,
  /**
  ...
  public val license:
      InlineWebhookPullRequestReviewCommentDeletedPullRequestBaseRepoLicenseXd6eaeaf3?,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val owner: InlineWebhookPullRequestReviewCommentDeletedPullRequestBaseRepoOwnerX24656df7?,
  /**
  ...
  public val pushedAt:
      InlineWebhookPullRequestReviewCommentDeletedPullRequestBaseRepoPushedAtX4c502d36?,
  /**
   * Wire format: `uri-template`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val visibility: InlineWebhookPullRequestRe8fbbPullRequestBaseRepoVisibilityXd1a1c438,
  ...
  private val mergeCommitMessageState:
      FieldState<InlineWebhookPullRequestRe8fbbPullRequestBaseRepoMergeCommitMessageXd19373a6>,
  private val mergeCommitTitleState:
      FieldState<InlineWebhookPullRequestRe8fbbPullRequestBaseRepoMergeCommitTitleXd0166fce>,
  private val organizationState: FieldState<String>,
  private val permissionsState:
      FieldState<InlineWebhookPullRequestRe8fbbPullRequestBaseRepoPermissionsXa3442fd8>,
  private val publicState: FieldState<Boolean>,
  private val pullRequestCreationPolicyState:
      FieldState<InlineWebhookPullRequestRe8fbbPullRequestBasePullRequestCreationP824dXf419059e>,
  private val roleNameState: FieldState<String?>,
  private val squashMergeCommitMessageState:
      FieldState<InlineWebhookPullRequestRe8fbbPullRequestBaseSquashMergeCommitMessageX19298454>,
  private val squashMergeCommitTitleState:
      FieldState<InlineWebhookPullRequestRe8fbbPullRequestBaseRepoSquashMergeCommitTitleX336d9cba>,
  ...
  public val mergeCommitMessage:
      InlineWebhookPullRequestRe8fbbPullRequestBaseRepoMergeCommitMessageXd19373a6?
  ...
  public val permissions: InlineWebhookPullRequestRe8fbbPullRequestBaseRepoPermissionsXa3442fd8?
  ...
  public constructor(
    ...
    createdAt: InlineWebhookPullRequestRe8fbbPullRequestBaseRepoCreatedAtX515989ff,
    ...
    language: String?,
    languagesUrl: String,
    license: InlineWebhookPullRequestReviewCommentDeletedPullRequestBaseRepoLicenseXd6eaeaf3?,
    mergesUrl: String,
    ...
    openIssues: Int,
    openIssuesCount: Int,
    owner: InlineWebhookPullRequestReviewCommentDeletedPullRequestBaseRepoOwnerX24656df7?,
    `private`: Boolean,
    pullsUrl: String,
    pushedAt: InlineWebhookPullRequestReviewCommentDeletedPullRequestBaseRepoPushedAtX4c502d36?,
    releasesUrl: String,
    size: Int,
    sshUrl: String,
    stargazersCount: Int,
    ...
    updatedAt: String,
    url: String,
    visibility: InlineWebhookPullRequestRe8fbbPullRequestBaseRepoVisibilityXd1a1c438,
    watchers: Int,
    watchersCount: Int,
  ...
  public class Builder {
    ...
    private var createdAtValue: InlineWebhookPullRequestRe8fbbPullRequestBaseRepoCreatedAtX515989ff?
        = null

    public var createdAt: InlineWebhookPullRequestRe8fbbPullRequestBaseRepoCreatedAtX515989ff
    ...
    private var visibilityValue:
        InlineWebhookPullRequestRe8fbbPullRequestBaseRepoVisibilityXd1a1c438? = null

    public var visibility: InlineWebhookPullRequestRe8fbbPullRequestBaseRepoVisibilityXd1a1c438
    ...
    private var licenseState:
        FieldState<InlineWebhookPullRequestReviewCommentDeletedPullRequestBaseRepoLicenseXd6eaeaf3?>
        = FieldState.Absent
    ...
    private var ownerState:
        FieldState<InlineWebhookPullRequestReviewCommentDeletedPullRequestBaseRepoOwnerX24656df7?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var owner: InlineWebhookPullRequestReviewCommentDeletedPullRequestBaseRepoOwnerX24656df7?
    ...
    private var pushedAtState:
        FieldState<InlineWebhookPullRequestReviewCommentDeletedPullRequestBaseRepoPushedAtX4c502d36?>
        = FieldState.Absent
     ...
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var permissions: InlineWebhookPullRequestRe8fbbPullRequestBaseRepoPermissionsXa3442fd8?
      get() = permissionsState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): InlineWebhookPullRequestReviewCommentDeletedPullRequestBaseRepoX589df380 {
      ...
      return InlineWebhookPullRequestReviewCommentDeletedPullRequestBaseRepoX589df380(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewCommentDeletedPullRequestBaseRepoX589df380 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewCommentDeletedPullRequestBaseRepoX589df380> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewCommentDeletedPullRequestBaseRepoX589df380 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewCommentDeletedPullRequestBaseRepoX589df380")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewCommentDeletedPullRequestBaseRepoX589df380 must be a JSON object")
      ...
      val createdAt = json.decodeRequired<InlineWebhookPullRequestRe8fbbPullRequestBaseRepoCreatedAtX515989ff>(rawObject, "created_at")
      ...
      val visibility = json.decodeRequired<InlineWebhookPullRequestRe8fbbPullRequestBaseRepoVisibilityXd1a1c438>(rawObject, "visibility")
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookPullRequestReviewCommentDeletedPullRequestBaseRepoX589df380 is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("homepage")) {
        throw SerializationException("InlineWebhookPullRequestReviewCommentDeletedPullRequestBaseRepoX589df380 is missing required property 'homepage'")
      }
      ...
      if (!rawObject.containsKey("language")) {
        throw SerializationException("InlineWebhookPullRequestReviewCommentDeletedPullRequestBaseRepoX589df380 is missing required property 'language'")
      }
      ...
      if (!rawObject.containsKey("license")) {
        throw SerializationException("InlineWebhookPullRequestReviewCommentDeletedPullRequestBaseRepoX589df380 is missing required property 'license'")
      }
      val license = rawObject["license"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestReviewCommentDeletedPullRequestBaseRepoLicenseXd6eaeaf3?>(requireNotNull(element)) }
      if (!rawObject.containsKey("mirror_url")) {
        throw SerializationException("InlineWebhookPullRequestReviewCommentDeletedPullRequestBaseRepoX589df380 is missing required property 'mirror_url'")
      }
      ...
      if (!rawObject.containsKey("owner")) {
        throw SerializationException("InlineWebhookPullRequestReviewCommentDeletedPullRequestBaseRepoX589df380 is missing required property 'owner'")
      }
      val owner = rawObject["owner"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestReviewCommentDeletedPullRequestBaseRepoOwnerX24656df7?>(requireNotNull(element)) }
      if (!rawObject.containsKey("pushed_at")) {
        throw SerializationException("InlineWebhookPullRequestReviewCommentDeletedPullRequestBaseRepoX589df380 is missing required property 'pushed_at'")
      }
      val pushedAt = rawObject["pushed_at"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestReviewCommentDeletedPullRequestBaseRepoPushedAtX4c502d36?>(requireNotNull(element)) }
      return InlineWebhookPullRequestReviewCommentDeletedPullRequestBaseRepoX589df380(
        archiveUrl = archiveUrl,
        archived = archived,
        assigneesUrl = assigneesUrl,
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewCommentDeletedPullRequestBaseRepoX589df380) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewCommentDeletedPullRequestBaseRepoX589df380")
...
public fun inlineWebhookPullRequestReviewCommentDeletedPullRequestBaseRepoX589df380(block: InlineWebhookPullRequestReviewCommentDeletedPullRequestBaseRepoX589df380.Builder.() -> Unit): InlineWebhookPullRequestReviewCommentDeletedPullRequestBaseRepoX589df380 = InlineWebhookPullRequestReviewCommentDeletedPullRequestBaseRepoX589df380.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewCommentDeletedPullRequestBaseRepoX589df380 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookPullRequestReviewCommentDeletedPullRequestBaseRepoX589df380 property '" + name + "' is not nullable")
