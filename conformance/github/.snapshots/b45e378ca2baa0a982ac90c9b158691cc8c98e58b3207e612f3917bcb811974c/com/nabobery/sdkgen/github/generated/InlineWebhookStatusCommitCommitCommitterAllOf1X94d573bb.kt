 ...
 * ter/allOf/0
 */
@Serializable(with = InlineWebhookStatusCommitCommitCommitterAllOf1X94d573bb.Serializer::class)
public class InlineWebhookStatusCommitCommitCommitterAllOf1X94d573bb internal constructor(
  /**
  ...
  public class Builder {
    ...
    public fun build(): InlineWebhookStatusCommitCommitCommitterAllOf1X94d573bb {
      check(nameValue != null) { "name is required" }
      check(emailState !== FieldState.Absent) { "email is required, even when null" }
      return InlineWebhookStatusCommitCommitCommitterAllOf1X94d573bb(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookStatusCommitCommitCommitterAllOf1X94d573bb = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookStatusCommitCommitCommitterAllOf1X94d573bb> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookStatusCommitCommitCommitterAllOf1X94d573bb {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookStatusCommitCommitCommitterAllOf1X94d573bb")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookStatusCommitCommitCommitterAllOf1X94d573bb must be a JSON object")
      val name = json.decodeRequired<String>(rawObject, "name")
      if (!rawObject.containsKey("email")) {
        throw SerializationException("InlineWebhookStatusCommitCommitCommitterAllOf1X94d573bb is missing required property 'email'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookStatusCommitCommitCommitterAllOf1X94d573bb) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookStatusCommitCommitCommitterAllOf1X94d573bb")
...
public fun inlineWebhookStatusCommitCommitCommitterAllOf1X94d573bb(block: InlineWebhookStatusCommitCommitCommitterAllOf1X94d573bb.Builder.() -> Unit): InlineWebhookStatusCommitCommitCommitterAllOf1X94d573bb = InlineWebhookStatusCommitCommitCommitterAllOf1X94d573bb.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookStatusCommitCommitCommitterAllOf1X94d573bb is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookStatusCommitCommitCommitterAllOf1X94d573bb property '" + name + "' is not nullable")
