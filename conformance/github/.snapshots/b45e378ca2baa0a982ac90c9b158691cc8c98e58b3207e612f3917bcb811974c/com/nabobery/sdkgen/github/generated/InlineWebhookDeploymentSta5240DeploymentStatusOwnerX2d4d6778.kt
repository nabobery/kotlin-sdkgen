 ...
 * rties/performed_via_github_app/properties/owner.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-deployment-status-created/properties/deployment_status/prope
 * rties/performed_via_github_app/properties/owner
 */
@Serializable(with = InlineWebhookDeploymentSta5240DeploymentStatusOwnerX2d4d6778.Serializer::class)
public class InlineWebhookDeploymentSta5240DeploymentStatusOwnerX2d4d6778(
  public val id: Int,
  ...
  public val type:
      InlineWebhookDeploymentSta5240DeploymentStatusPerformedViaGithubAppTypeXb218c634? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public fun build(): InlineWebhookDeploymentSta5240DeploymentStatusOwnerX2d4d6778 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookDeploymentSta5240DeploymentStatusOwnerX2d4d6778(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookDeploymentSta5240DeploymentStatusOwnerX2d4d6778 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookDeploymentSta5240DeploymentStatusOwnerX2d4d6778> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookDeploymentSta5240DeploymentStatusOwnerX2d4d6778 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookDeploymentSta5240DeploymentStatusOwnerX2d4d6778")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookDeploymentSta5240DeploymentStatusOwnerX2d4d6778 must be a JSON object")
      ...
      return InlineWebhookDeploymentSta5240DeploymentStatusOwnerX2d4d6778(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookDeploymentSta5240DeploymentStatusPerformedViaGithubAppTypeXb218c634>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookDeploymentSta5240DeploymentStatusOwnerX2d4d6778) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookDeploymentSta5240DeploymentStatusOwnerX2d4d6778")
...
public fun inlineWebhookDeploymentSta5240DeploymentStatusOwnerX2d4d6778(block: InlineWebhookDeploymentSta5240DeploymentStatusOwnerX2d4d6778.Builder.() -> Unit): InlineWebhookDeploymentSta5240DeploymentStatusOwnerX2d4d6778 = InlineWebhookDeploymentSta5240DeploymentStatusOwnerX2d4d6778.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookDeploymentSta5240DeploymentStatusOwnerX2d4d6778 is missing required property '" + name + "'")
