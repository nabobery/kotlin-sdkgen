...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-edited/properties/issue/properties/assignee.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-edited/properties/issue/properties/assignee
 */
@Serializable(with = InlineWebhookIssuesEditedIssueAssigneeX6a0f3ae0.Serializer::class)
public class InlineWebhookIssuesEditedIssueAssigneeX6a0f3ae0(
  public val id: Int,
  ...
  public val type: InlineWebhookIssuesEditedIssueAssigneeTypeXd04ffc78? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookIssuesEditedIssueAssigneeTypeXd04ffc78? = null
    ...
    public fun build(): InlineWebhookIssuesEditedIssueAssigneeX6a0f3ae0 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssuesEditedIssueAssigneeX6a0f3ae0(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesEditedIssueAssigneeX6a0f3ae0 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesEditedIssueAssigneeX6a0f3ae0> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesEditedIssueAssigneeX6a0f3ae0 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesEditedIssueAssigneeX6a0f3ae0")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesEditedIssueAssigneeX6a0f3ae0 must be a JSON object")
      ...
      return InlineWebhookIssuesEditedIssueAssigneeX6a0f3ae0(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssuesEditedIssueAssigneeTypeXd04ffc78>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesEditedIssueAssigneeX6a0f3ae0) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesEditedIssueAssigneeX6a0f3ae0")
...
public fun inlineWebhookIssuesEditedIssueAssigneeX6a0f3ae0(block: InlineWebhookIssuesEditedIssueAssigneeX6a0f3ae0.Builder.() -> Unit): InlineWebhookIssuesEditedIssueAssigneeX6a0f3ae0 = InlineWebhookIssuesEditedIssueAssigneeX6a0f3ae0.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesEditedIssueAssigneeX6a0f3ae0 is missing required property '" + name + "'")
