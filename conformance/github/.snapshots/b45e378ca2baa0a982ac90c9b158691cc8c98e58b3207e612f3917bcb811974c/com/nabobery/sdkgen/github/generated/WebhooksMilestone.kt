 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhooks_milestone
 */
@Serializable(with = WebhooksMilestone.Serializer::class)
public class WebhooksMilestone(
  ...
  public val creator: InlineWebhooksMilestoneCreatorX97e15615?,
   ...
   */
  public val state: InlineWebhooksMilestoneStateX544a11ad,
  /**
  ...
  public class Builder {
    ...
    private var stateValue: InlineWebhooksMilestoneStateX544a11ad? = null

    public var state: InlineWebhooksMilestoneStateX544a11ad
    ...
    private var creatorState: FieldState<InlineWebhooksMilestoneCreatorX97e15615?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var creator: InlineWebhooksMilestoneCreatorX97e15615?
    ...
    public fun build(): WebhooksMilestone {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): WebhooksMilestone = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<WebhooksMilestone> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): WebhooksMilestone {
      val jsonDecoder = decoder.requireJsonDecoder("WebhooksMilestone")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("WebhooksMilestone must be a JSON object")
      ...
      val state = json.decodeRequired<InlineWebhooksMilestoneStateX544a11ad>(rawObject, "state")
      val title = json.decodeRequired<String>(rawObject, "title")
      val updatedAt = json.decodeRequired<String>(rawObject, "updated_at")
      val url = json.decodeRequired<String>(rawObject, "url")
      if (!rawObject.containsKey("closed_at")) {
        throw SerializationException("WebhooksMilestone is missing required property 'closed_at'")
      }
      ...
      if (!rawObject.containsKey("creator")) {
        throw SerializationException("WebhooksMilestone is missing required property 'creator'")
      }
      val creator = rawObject["creator"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhooksMilestoneCreatorX97e15615?>(requireNotNull(element)) }
      if (!rawObject.containsKey("description")) {
        throw SerializationException("WebhooksMilestone is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("due_on")) {
        throw SerializationException("WebhooksMilestone is missing required property 'due_on'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: WebhooksMilestone) {
      val jsonEncoder = encoder.requireJsonEncoder("WebhooksMilestone")
...
public fun webhooksMilestone(block: WebhooksMilestone.Builder.() -> Unit): WebhooksMilestone = WebhooksMilestone.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("WebhooksMilestone is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("WebhooksMilestone property '" + name + "' is not nullable")
