 ...
 * estone
 */
@Serializable(with = InlineWebhookIssueCommentEditedIssueAllOf1MilestoneX7b86aadf.Serializer::class)
public class InlineWebhookIssueCommentEditedIssueAllOf1MilestoneX7b86aadf(
  /**
  ...
  public val creator: InlineWebhookIssueCommentEditedIssueAllOf1MilestoneCreatorX1ceec536?,
   ...
   */
  public val state: InlineWebhookIssueCommentEditedIssueAllOf1MilestoneStateX5bceee4a,
  /**
  ...
  public class Builder {
    ...
    private var stateValue: InlineWebhookIssueCommentEditedIssueAllOf1MilestoneStateX5bceee4a? =
        null

    public var state: InlineWebhookIssueCommentEditedIssueAllOf1MilestoneStateX5bceee4a
    ...
    private var creatorState:
        FieldState<InlineWebhookIssueCommentEditedIssueAllOf1MilestoneCreatorX1ceec536?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var creator: InlineWebhookIssueCommentEditedIssueAllOf1MilestoneCreatorX1ceec536?
    ...
    public fun build(): InlineWebhookIssueCommentEditedIssueAllOf1MilestoneX7b86aadf {
      ...
      return InlineWebhookIssueCommentEditedIssueAllOf1MilestoneX7b86aadf(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssueCommentEditedIssueAllOf1MilestoneX7b86aadf = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssueCommentEditedIssueAllOf1MilestoneX7b86aadf> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssueCommentEditedIssueAllOf1MilestoneX7b86aadf {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssueCommentEditedIssueAllOf1MilestoneX7b86aadf")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssueCommentEditedIssueAllOf1MilestoneX7b86aadf must be a JSON object")
      ...
      val state = json.decodeRequired<InlineWebhookIssueCommentEditedIssueAllOf1MilestoneStateX5bceee4a>(rawObject, "state")
      val title = json.decodeRequired<String>(rawObject, "title")
      val updatedAt = json.decodeRequired<String>(rawObject, "updated_at")
      val url = json.decodeRequired<String>(rawObject, "url")
      if (!rawObject.containsKey("closed_at")) {
        throw SerializationException("InlineWebhookIssueCommentEditedIssueAllOf1MilestoneX7b86aadf is missing required property 'closed_at'")
      }
      ...
      if (!rawObject.containsKey("creator")) {
        throw SerializationException("InlineWebhookIssueCommentEditedIssueAllOf1MilestoneX7b86aadf is missing required property 'creator'")
      }
      val creator = rawObject["creator"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookIssueCommentEditedIssueAllOf1MilestoneCreatorX1ceec536?>(requireNotNull(element)) }
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookIssueCommentEditedIssueAllOf1MilestoneX7b86aadf is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("due_on")) {
        throw SerializationException("InlineWebhookIssueCommentEditedIssueAllOf1MilestoneX7b86aadf is missing required property 'due_on'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssueCommentEditedIssueAllOf1MilestoneX7b86aadf) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssueCommentEditedIssueAllOf1MilestoneX7b86aadf")
...
public fun inlineWebhookIssueCommentEditedIssueAllOf1MilestoneX7b86aadf(block: InlineWebhookIssueCommentEditedIssueAllOf1MilestoneX7b86aadf.Builder.() -> Unit): InlineWebhookIssueCommentEditedIssueAllOf1MilestoneX7b86aadf = InlineWebhookIssueCommentEditedIssueAllOf1MilestoneX7b86aadf.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssueCommentEditedIssueAllOf1MilestoneX7b86aadf is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookIssueCommentEditedIssueAllOf1MilestoneX7b86aadf property '" + name + "' is not nullable")
