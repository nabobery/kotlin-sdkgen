 ...
 * hub_app
 */
@Serializable(with = InlineWebhookIssuesDeletedIssuePerformedViaGithubAppX9a123bad.Serializer::class)
public class InlineWebhookIssuesDeletedIssuePerformedViaGithubAppX9a123bad internal constructor(
  /**
  ...
  public val owner: InlineWebhookIssuesDeletedIssuePerformedViaGithubAppOwnerX70cc5f42?,
  /**
   * Wire format: `date-time`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  public val updatedAt: String?,
  eventsState: FieldState<List<InlineWebhookIssuesDeletedIssuePerformedViaGithubAppEventsItemXe2bd0a39>>,
  private val permissionsState:
      FieldState<InlineWebhookIssuesDeletedIssuePerformedViaGithubAppPermissionsXda7efcb5>,
  private val slugState: FieldState<String>,
) {
  private val eventsState:
      FieldState<List<InlineWebhookIssuesDeletedIssuePerformedViaGithubAppEventsItemXe2bd0a39>> =
      eventsState.copyValue { fieldValue -> fieldValue.toList() }

  /**
   * The list of events for the GitHub app
   */
  public val events: List<InlineWebhookIssuesDeletedIssuePerformedViaGithubAppEventsItemXe2bd0a39>?
    get() = eventsState.valueOrNull()

  /**
   * The set of permissions for the GitHub app
   */
  public val permissions: InlineWebhookIssuesDeletedIssuePerformedViaGithubAppPermissionsXda7efcb5?
  ...
  public constructor(
    ...
    name: String,
    nodeId: String,
    owner: InlineWebhookIssuesDeletedIssuePerformedViaGithubAppOwnerX70cc5f42?,
    updatedAt: String?,
  ...
  public class Builder {
    ...
    private var ownerState:
        FieldState<InlineWebhookIssuesDeletedIssuePerformedViaGithubAppOwnerX70cc5f42?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var owner: InlineWebhookIssuesDeletedIssuePerformedViaGithubAppOwnerX70cc5f42?
     ...
     */
    public var events:
        List<InlineWebhookIssuesDeletedIssuePerformedViaGithubAppEventsItemXe2bd0a39>?
    ...
    public var permissions:
        InlineWebhookIssuesDeletedIssuePerformedViaGithubAppPermissionsXda7efcb5?
      get() = permissionsState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): InlineWebhookIssuesDeletedIssuePerformedViaGithubAppX9a123bad {
      ...
      return InlineWebhookIssuesDeletedIssuePerformedViaGithubAppX9a123bad(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesDeletedIssuePerformedViaGithubAppX9a123bad = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesDeletedIssuePerformedViaGithubAppX9a123bad> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesDeletedIssuePerformedViaGithubAppX9a123bad {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesDeletedIssuePerformedViaGithubAppX9a123bad")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesDeletedIssuePerformedViaGithubAppX9a123bad must be a JSON object")
      val htmlUrl = json.decodeRequired<String>(rawObject, "html_url")
      val name = json.decodeRequired<String>(rawObject, "name")
      val nodeId = json.decodeRequired<String>(rawObject, "node_id")
      if (!rawObject.containsKey("created_at")) {
        throw SerializationException("InlineWebhookIssuesDeletedIssuePerformedViaGithubAppX9a123bad is missing required property 'created_at'")
      }
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookIssuesDeletedIssuePerformedViaGithubAppX9a123bad is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("external_url")) {
        throw SerializationException("InlineWebhookIssuesDeletedIssuePerformedViaGithubAppX9a123bad is missing required property 'external_url'")
      }
      ...
      if (!rawObject.containsKey("id")) {
        throw SerializationException("InlineWebhookIssuesDeletedIssuePerformedViaGithubAppX9a123bad is missing required property 'id'")
      }
      ...
      if (!rawObject.containsKey("owner")) {
        throw SerializationException("InlineWebhookIssuesDeletedIssuePerformedViaGithubAppX9a123bad is missing required property 'owner'")
      }
      val owner = rawObject["owner"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookIssuesDeletedIssuePerformedViaGithubAppOwnerX70cc5f42?>(requireNotNull(element)) }
      if (!rawObject.containsKey("updated_at")) {
        throw SerializationException("InlineWebhookIssuesDeletedIssuePerformedViaGithubAppX9a123bad is missing required property 'updated_at'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesDeletedIssuePerformedViaGithubAppX9a123bad) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesDeletedIssuePerformedViaGithubAppX9a123bad")
...
public fun inlineWebhookIssuesDeletedIssuePerformedViaGithubAppX9a123bad(block: InlineWebhookIssuesDeletedIssuePerformedViaGithubAppX9a123bad.Builder.() -> Unit): InlineWebhookIssuesDeletedIssuePerformedViaGithubAppX9a123bad = InlineWebhookIssuesDeletedIssuePerformedViaGithubAppX9a123bad.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesDeletedIssuePerformedViaGithubAppX9a123bad is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookIssuesDeletedIssuePerformedViaGithubAppX9a123bad property '" + name + "' is not nullable")
