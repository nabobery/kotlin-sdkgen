 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-closed/properties/issue/allOf/0
 */
@Serializable(with = InlineWebhookIssuesClosedIssueAllOf1Xced53732.Serializer::class)
public class InlineWebhookIssuesClosedIssueAllOf1Xced53732 internal constructor(
  public val activeLockReason: InlineWebhookIssuesClosedIssueAllOf1ActiveLockReasonX8b539de0?,
  assignees: List<InlineWebhookIssuesClosedIssueAllOf1AssigneesItemX501ffaf7?>,
  /**
   * How the author is associated with the repository.
   */
  public val authorAssociation: InlineWebhookIssuesClosedIssueAllOf1AuthorAssociationX360279d3,
  /**
   ...
   */
  public val milestone: InlineWebhookIssuesClosedIssueAllOf1MilestoneXe17cc971?,
  public val nodeId: String,
  public val number: Int,
  public val reactions: InlineWebhookIssuesClosedIssueAllOf1ReactionsX6d773e96,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val user: InlineWebhookIssuesClosedIssueAllOf1UserXec708940?,
  private val assigneeState: FieldState<InlineWebhookIssuesClosedIssueAllOf1AssigneeXd8974207?>,
  ...
  labelsState: FieldState<List<InlineWebhookIssuesClosedIssueAllOf1LabelsItemX981126f3>>,
  private val lockedState: FieldState<Boolean>,
  private val performedViaGithubAppState:
      FieldState<InlineWebhookIssuesClosedIssueAllOf1PerformedViaGithubAppXf3faf063?>,
  private val pinnedCommentState: FieldState<NullableIssueComment?>,
  private val pullRequestState:
      FieldState<InlineWebhookIssuesClosedIssueAllOf1PullRequestXc23900c8>,
  private val stateState: FieldState<InlineWebhookIssuesClosedIssueAllOf1StateXd508b104>,
  ...
  public val assignees: List<InlineWebhookIssuesClosedIssueAllOf1AssigneesItemX501ffaf7?> =
      assignees.toList()
  ...
  private val labelsState: FieldState<List<InlineWebhookIssuesClosedIssueAllOf1LabelsItemX981126f3>>
      = labelsState.copyValue { fieldValue -> fieldValue.toList() }

  public val assignee: InlineWebhookIssuesClosedIssueAllOf1AssigneeXd8974207?
  ...
  public val labels: List<InlineWebhookIssuesClosedIssueAllOf1LabelsItemX981126f3>?
  ...
  public val performedViaGithubApp:
      InlineWebhookIssuesClosedIssueAllOf1PerformedViaGithubAppXf3faf063?
  ...
  public val pullRequest: InlineWebhookIssuesClosedIssueAllOf1PullRequestXc23900c8?
    get() = pullRequestState.valueOrNull()

  /**
   * State of the issue; either 'open' or 'closed'
   */
  public val state: InlineWebhookIssuesClosedIssueAllOf1StateXd508b104?
  ...
  public constructor(
    activeLockReason: InlineWebhookIssuesClosedIssueAllOf1ActiveLockReasonX8b539de0?,
    assignees: List<InlineWebhookIssuesClosedIssueAllOf1AssigneesItemX501ffaf7?>,
    authorAssociation: InlineWebhookIssuesClosedIssueAllOf1AuthorAssociationX360279d3,
    body: String?,
    closedAt: String?,
    comments: Int,
    commentsUrl: String,
    ...
    id: Long,
    labelsUrl: String,
    milestone: InlineWebhookIssuesClosedIssueAllOf1MilestoneXe17cc971?,
    nodeId: String,
    number: Int,
    reactions: InlineWebhookIssuesClosedIssueAllOf1ReactionsX6d773e96,
    repositoryUrl: String,
    title: String,
    updatedAt: String,
    url: String,
    user: InlineWebhookIssuesClosedIssueAllOf1UserXec708940?,
  ...
  public class Builder {
    private var assigneesValue: List<InlineWebhookIssuesClosedIssueAllOf1AssigneesItemX501ffaf7?>? =
        null

    public var assignees: List<InlineWebhookIssuesClosedIssueAllOf1AssigneesItemX501ffaf7?>
    ...
    private var authorAssociationValue:
        InlineWebhookIssuesClosedIssueAllOf1AuthorAssociationX360279d3? = null

    public var authorAssociation: InlineWebhookIssuesClosedIssueAllOf1AuthorAssociationX360279d3
    ...
    private var reactionsValue: InlineWebhookIssuesClosedIssueAllOf1ReactionsX6d773e96? = null

    public var reactions: InlineWebhookIssuesClosedIssueAllOf1ReactionsX6d773e96
    ...
    private var activeLockReasonState:
        FieldState<InlineWebhookIssuesClosedIssueAllOf1ActiveLockReasonX8b539de0?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var activeLockReason: InlineWebhookIssuesClosedIssueAllOf1ActiveLockReasonX8b539de0?
    ...
    private var milestoneState: FieldState<InlineWebhookIssuesClosedIssueAllOf1MilestoneXe17cc971?>
        = FieldState.Absent
     ...
     * Required nullable field; assigning `null` records present-null.
     */
    public var milestone: InlineWebhookIssuesClosedIssueAllOf1MilestoneXe17cc971?
      get() = milestoneState.valueOrNull()
      set(`value`) {
        milestoneState = value.toNullableFieldState()
      }

    private var userState: FieldState<InlineWebhookIssuesClosedIssueAllOf1UserXec708940?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var user: InlineWebhookIssuesClosedIssueAllOf1UserXec708940?
      get() = userState.valueOrNull()
      set(`value`) {
        userState = value.toNullableFieldState()
      }

    private var assigneeState: FieldState<InlineWebhookIssuesClosedIssueAllOf1AssigneeXd8974207?> =
        FieldState.Absent

    /**
     * Assigning `null` records present-null; use the unset function to omit the property.
     */
    public var assignee: InlineWebhookIssuesClosedIssueAllOf1AssigneeXd8974207?
      get() = assigneeState.valueOrNull()
      set(`value`) {
    ...
    private var labelsState:
        FieldState<List<InlineWebhookIssuesClosedIssueAllOf1LabelsItemX981126f3>> =
        FieldState.Absent

    /**
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var labels: List<InlineWebhookIssuesClosedIssueAllOf1LabelsItemX981126f3>?
    ...
    private var pullRequestState:
        FieldState<InlineWebhookIssuesClosedIssueAllOf1PullRequestXc23900c8> = FieldState.Absent

    /**
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var pullRequest: InlineWebhookIssuesClosedIssueAllOf1PullRequestXc23900c8?
      get() = pullRequestState.valueOrNull()
      set(`value`) {
    ...
    private var stateState: FieldState<InlineWebhookIssuesClosedIssueAllOf1StateXd508b104> =
        FieldState.Absent
     ...
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var state: InlineWebhookIssuesClosedIssueAllOf1StateXd508b104?
      get() = stateState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): InlineWebhookIssuesClosedIssueAllOf1Xced53732 {
      ...
      return InlineWebhookIssuesClosedIssueAllOf1Xced53732(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesClosedIssueAllOf1Xced53732 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesClosedIssueAllOf1Xced53732> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesClosedIssueAllOf1Xced53732 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesClosedIssueAllOf1Xced53732")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesClosedIssueAllOf1Xced53732 must be a JSON object")
      val assignees = json.decodeRequired<List<InlineWebhookIssuesClosedIssueAllOf1AssigneesItemX501ffaf7?>>(rawObject, "assignees")
      val authorAssociation = json.decodeRequired<InlineWebhookIssuesClosedIssueAllOf1AuthorAssociationX360279d3>(rawObject, "author_association")
      ...
      val reactions = json.decodeRequired<InlineWebhookIssuesClosedIssueAllOf1ReactionsX6d773e96>(rawObject, "reactions")
      ...
      if (!rawObject.containsKey("active_lock_reason")) {
        throw SerializationException("InlineWebhookIssuesClosedIssueAllOf1Xced53732 is missing required property 'active_lock_reason'")
      }
      val activeLockReason = rawObject["active_lock_reason"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookIssuesClosedIssueAllOf1ActiveLockReasonX8b539de0?>(requireNotNull(element)) }
      if (!rawObject.containsKey("body")) {
        throw SerializationException("InlineWebhookIssuesClosedIssueAllOf1Xced53732 is missing required property 'body'")
      }
      ...
      if (!rawObject.containsKey("closed_at")) {
        throw SerializationException("InlineWebhookIssuesClosedIssueAllOf1Xced53732 is missing required property 'closed_at'")
      }
      ...
      if (!rawObject.containsKey("milestone")) {
        throw SerializationException("InlineWebhookIssuesClosedIssueAllOf1Xced53732 is missing required property 'milestone'")
      }
      val milestone = rawObject["milestone"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookIssuesClosedIssueAllOf1MilestoneXe17cc971?>(requireNotNull(element)) }
      if (!rawObject.containsKey("user")) {
        throw SerializationException("InlineWebhookIssuesClosedIssueAllOf1Xced53732 is missing required property 'user'")
      }
      val user = rawObject["user"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookIssuesClosedIssueAllOf1UserXec708940?>(requireNotNull(element)) }
      return InlineWebhookIssuesClosedIssueAllOf1Xced53732(
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesClosedIssueAllOf1Xced53732) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesClosedIssueAllOf1Xced53732")
...
public fun inlineWebhookIssuesClosedIssueAllOf1Xced53732(block: InlineWebhookIssuesClosedIssueAllOf1Xced53732.Builder.() -> Unit): InlineWebhookIssuesClosedIssueAllOf1Xced53732 = InlineWebhookIssuesClosedIssueAllOf1Xced53732.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesClosedIssueAllOf1Xced53732 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookIssuesClosedIssueAllOf1Xced53732 property '" + name + "' is not nullable")
