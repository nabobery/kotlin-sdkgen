 ...
 * erties/merged_by
 */
@Serializable(with = InlineWebhookPullRequestAutoMergeEnabledPullRequestMergedByX27620eb0.Serializer::class)
public class InlineWebhookPullRequestAutoMergeEnabledPullRequestMergedByX27620eb0(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestAutoMergeEnabledPullRequestMergedByTypeX58b9285f? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestAutoMergeEnabledPullRequestMergedByTypeX58b9285f? =
        null
    ...
    public fun build(): InlineWebhookPullRequestAutoMergeEnabledPullRequestMergedByX27620eb0 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestAutoMergeEnabledPullRequestMergedByX27620eb0(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestAutoMergeEnabledPullRequestMergedByX27620eb0 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestAutoMergeEnabledPullRequestMergedByX27620eb0> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestAutoMergeEnabledPullRequestMergedByX27620eb0 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestAutoMergeEnabledPullRequestMergedByX27620eb0")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestAutoMergeEnabledPullRequestMergedByX27620eb0 must be a JSON object")
      ...
      return InlineWebhookPullRequestAutoMergeEnabledPullRequestMergedByX27620eb0(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestAutoMergeEnabledPullRequestMergedByTypeX58b9285f>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestAutoMergeEnabledPullRequestMergedByX27620eb0) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestAutoMergeEnabledPullRequestMergedByX27620eb0")
...
public fun inlineWebhookPullRequestAutoMergeEnabledPullRequestMergedByX27620eb0(block: InlineWebhookPullRequestAutoMergeEnabledPullRequestMergedByX27620eb0.Builder.() -> Unit): InlineWebhookPullRequestAutoMergeEnabledPullRequestMergedByX27620eb0 = InlineWebhookPullRequestAutoMergeEnabledPullRequestMergedByX27620eb0.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestAutoMergeEnabledPullRequestMergedByX27620eb0 is missing required property '" + name + "'")
