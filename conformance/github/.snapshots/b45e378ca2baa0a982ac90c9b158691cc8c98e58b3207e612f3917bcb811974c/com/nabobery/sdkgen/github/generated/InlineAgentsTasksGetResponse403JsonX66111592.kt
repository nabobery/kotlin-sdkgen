...
public class InlineAgentsTasksGetResponse403JsonX66111592(
  ...
  errors: List<InlineAgentsTasksGetResponse403JsonErrorsItemX28d7fb0e>? = null,
) {
  /**
   * List of validation errors (present only for 422 responses)
   */
  public val errors: List<InlineAgentsTasksGetResponse403JsonErrorsItemX28d7fb0e>? =
  ...
  public class Builder {
    ...
    private var errorsValue: List<InlineAgentsTasksGetResponse403JsonErrorsItemX28d7fb0e>? = null

    /**
     * List of validation errors (present only for 422 responses)
     */
    public var errors: List<InlineAgentsTasksGetResponse403JsonErrorsItemX28d7fb0e>?
  ...
  internal object Serializer : KSerializer<InlineAgentsTasksGetResponse403JsonX66111592> {
