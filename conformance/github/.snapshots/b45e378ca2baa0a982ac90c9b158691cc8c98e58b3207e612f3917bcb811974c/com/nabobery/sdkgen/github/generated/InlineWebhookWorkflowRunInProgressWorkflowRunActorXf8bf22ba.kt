 ...
 * actor
 */
@Serializable(with = InlineWebhookWorkflowRunInProgressWorkflowRunActorXf8bf22ba.Serializer::class)
public class InlineWebhookWorkflowRunInProgressWorkflowRunActorXf8bf22ba(
  public val id: Int,
  ...
  public val type: InlineWebhookWorkflowRunInProgressWorkflowRunActorTypeX729128b0? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookWorkflowRunInProgressWorkflowRunActorTypeX729128b0? = null
    ...
    public fun build(): InlineWebhookWorkflowRunInProgressWorkflowRunActorXf8bf22ba {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookWorkflowRunInProgressWorkflowRunActorXf8bf22ba(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookWorkflowRunInProgressWorkflowRunActorXf8bf22ba = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookWorkflowRunInProgressWorkflowRunActorXf8bf22ba> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookWorkflowRunInProgressWorkflowRunActorXf8bf22ba {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookWorkflowRunInProgressWorkflowRunActorXf8bf22ba")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookWorkflowRunInProgressWorkflowRunActorXf8bf22ba must be a JSON object")
      ...
      return InlineWebhookWorkflowRunInProgressWorkflowRunActorXf8bf22ba(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookWorkflowRunInProgressWorkflowRunActorTypeX729128b0>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookWorkflowRunInProgressWorkflowRunActorXf8bf22ba) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookWorkflowRunInProgressWorkflowRunActorXf8bf22ba")
...
public fun inlineWebhookWorkflowRunInProgressWorkflowRunActorXf8bf22ba(block: InlineWebhookWorkflowRunInProgressWorkflowRunActorXf8bf22ba.Builder.() -> Unit): InlineWebhookWorkflowRunInProgressWorkflowRunActorXf8bf22ba = InlineWebhookWorkflowRunInProgressWorkflowRunActorXf8bf22ba.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookWorkflowRunInProgressWorkflowRunActorXf8bf22ba is missing required property '" + name + "'")
