...
/**
 * Generated model for sdkgen://source/openapi.yaml#/components/schemas/webhooks_approver.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhooks_approver
 */
@Serializable(with = WebhooksApprover.Serializer::class)
public class WebhooksApprover(
  ...
  public class Builder {
    ...
    public fun build(): WebhooksApprover = WebhooksApprover(
      avatarUrl = avatarUrl,
      eventsUrl = eventsUrl,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): WebhooksApprover = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<WebhooksApprover> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): WebhooksApprover {
      val jsonDecoder = decoder.requireJsonDecoder("WebhooksApprover")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("WebhooksApprover must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: WebhooksApprover) {
      val jsonEncoder = encoder.requireJsonEncoder("WebhooksApprover")
...
public fun webhooksApprover(block: WebhooksApprover.Builder.() -> Unit): WebhooksApprover = WebhooksApprover.build(block)
