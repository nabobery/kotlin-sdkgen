 ...
 * s/repository
 */
@Serializable(with = InlineWebhookDeploymentReviewApprovedWorkflowRunRepositoryX19b501e2.Serializer::class)
public class InlineWebhookDeploymentReviewApprovedWorkflowRunRepositoryX19b501e2(
  ...
  public val owner:
      InlineWebhookDeploymentReviewApprovedWorkflowRunRepositoryOwnerXfee87d61? = null,
  ...
  public class Builder {
    ...
    public var owner: InlineWebhookDeploymentReviewApprovedWorkflowRunRepositoryOwnerXfee87d61? =
        null
    ...
    public fun build(): InlineWebhookDeploymentReviewApprovedWorkflowRunRepositoryX19b501e2 = InlineWebhookDeploymentReviewApprovedWorkflowRunRepositoryX19b501e2(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookDeploymentReviewApprovedWorkflowRunRepositoryX19b501e2 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookDeploymentReviewApprovedWorkflowRunRepositoryX19b501e2> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookDeploymentReviewApprovedWorkflowRunRepositoryX19b501e2 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookDeploymentReviewApprovedWorkflowRunRepositoryX19b501e2")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookDeploymentReviewApprovedWorkflowRunRepositoryX19b501e2 must be a JSON object")
      return InlineWebhookDeploymentReviewApprovedWorkflowRunRepositoryX19b501e2(
        ...
        owner = rawObject["owner"]?.let { json.decodeFromJsonElement<InlineWebhookDeploymentReviewApprovedWorkflowRunRepositoryOwnerXfee87d61>(it) },
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookDeploymentReviewApprovedWorkflowRunRepositoryX19b501e2) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookDeploymentReviewApprovedWorkflowRunRepositoryX19b501e2")
...
public fun inlineWebhookDeploymentReviewApprovedWorkflowRunRepositoryX19b501e2(block: InlineWebhookDeploymentReviewApprovedWorkflowRunRepositoryX19b501e2.Builder.() -> Unit): InlineWebhookDeploymentReviewApprovedWorkflowRunRepositoryX19b501e2 = InlineWebhookDeploymentReviewApprovedWorkflowRunRepositoryX19b501e2.build(block)
