...
@Serializable
public data class ReviewRequestRemovedIssueEventView(
 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/review-request-removed-issue-event
 */
@Serializable(with = ReviewRequestRemovedIssueEvent.Serializer::class)
public class ReviewRequestRemovedIssueEvent internal constructor(
  public val actor: SimpleUser,
  public val commitId: String?,
  public val commitUrl: String?,
  public val createdAt: String,
  ...
  public class Builder {
    ...
    public fun build(): ReviewRequestRemovedIssueEvent {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): ReviewRequestRemovedIssueEvent = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<ReviewRequestRemovedIssueEvent> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): ReviewRequestRemovedIssueEvent {
      val jsonDecoder = decoder.requireJsonDecoder("ReviewRequestRemovedIssueEvent")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("ReviewRequestRemovedIssueEvent must be a JSON object")
      ...
      if (!rawObject.containsKey("commit_id")) {
        throw SerializationException("ReviewRequestRemovedIssueEvent is missing required property 'commit_id'")
      }
      ...
      if (!rawObject.containsKey("commit_url")) {
        throw SerializationException("ReviewRequestRemovedIssueEvent is missing required property 'commit_url'")
      }
      ...
      if (!rawObject.containsKey("performed_via_github_app")) {
        throw SerializationException("ReviewRequestRemovedIssueEvent is missing required property 'performed_via_github_app'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: ReviewRequestRemovedIssueEvent) {
      val jsonEncoder = encoder.requireJsonEncoder("ReviewRequestRemovedIssueEvent")
...
public fun reviewRequestRemovedIssueEvent(block: ReviewRequestRemovedIssueEvent.Builder.() -> Unit): ReviewRequestRemovedIssueEvent = ReviewRequestRemovedIssueEvent.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("ReviewRequestRemovedIssueEvent is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("ReviewRequestRemovedIssueEvent property '" + name + "' is not nullable")
