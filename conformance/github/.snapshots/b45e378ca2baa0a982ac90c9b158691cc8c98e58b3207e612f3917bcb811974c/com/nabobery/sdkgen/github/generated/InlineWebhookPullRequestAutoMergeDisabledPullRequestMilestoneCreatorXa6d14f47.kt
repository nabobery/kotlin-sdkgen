 ...
 * perties/milestone/properties/creator.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-auto-merge-disabled/properties/pull_request/pro
 * perties/milestone/properties/creator
 */
@Serializable(with = InlineWebhookPullRequestAutoMergeDisabledPullRequestMilestoneCreatorXa6d14f47.Serializer::class)
public class InlineWebhookPullRequestAutoMergeDisabledPullRequestMilestoneCreatorXa6d14f47(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestAu1a35PullRequestMilestoneCreatorTypeXea69e445? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestAu1a35PullRequestMilestoneCreatorTypeXea69e445? = null
    ...
    public fun build(): InlineWebhookPullRequestAutoMergeDisabledPullRequestMilestoneCreatorXa6d14f47 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestAutoMergeDisabledPullRequestMilestoneCreatorXa6d14f47(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestAutoMergeDisabledPullRequestMilestoneCreatorXa6d14f47 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestAutoMergeDisabledPullRequestMilestoneCreatorXa6d14f47> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestAutoMergeDisabledPullRequestMilestoneCreatorXa6d14f47 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestAutoMergeDisabledPullRequestMilestoneCreatorXa6d14f47")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestAutoMergeDisabledPullRequestMilestoneCreatorXa6d14f47 must be a JSON object")
      ...
      return InlineWebhookPullRequestAutoMergeDisabledPullRequestMilestoneCreatorXa6d14f47(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestAu1a35PullRequestMilestoneCreatorTypeXea69e445>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestAutoMergeDisabledPullRequestMilestoneCreatorXa6d14f47) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestAutoMergeDisabledPullRequestMilestoneCreatorXa6d14f47")
...
public fun inlineWebhookPullRequestAutoMergeDisabledPullRequestMilestoneCreatorXa6d14f47(block: InlineWebhookPullRequestAutoMergeDisabledPullRequestMilestoneCreatorXa6d14f47.Builder.() -> Unit): InlineWebhookPullRequestAutoMergeDisabledPullRequestMilestoneCreatorXa6d14f47 = InlineWebhookPullRequestAutoMergeDisabledPullRequestMilestoneCreatorXa6d14f47.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestAutoMergeDisabledPullRequestMilestoneCreatorXa6d14f47 is missing required property '" + name + "'")
