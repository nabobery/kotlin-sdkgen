...
/**
 * Generated model for sdkgen://source/openapi.yaml#/components/schemas/code-scanning-alert-items.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/code-scanning-alert-items
 */
@Serializable(with = CodeScanningAlertItems.Serializer::class)
public class CodeScanningAlertItems internal constructor(
  /**
  ...
  public class Builder {
    ...
    public fun build(): CodeScanningAlertItems {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): CodeScanningAlertItems = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<CodeScanningAlertItems> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): CodeScanningAlertItems {
      val jsonDecoder = decoder.requireJsonDecoder("CodeScanningAlertItems")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("CodeScanningAlertItems must be a JSON object")
      ...
      if (!rawObject.containsKey("dismissed_at")) {
        throw SerializationException("CodeScanningAlertItems is missing required property 'dismissed_at'")
      }
      ...
      if (!rawObject.containsKey("dismissed_by")) {
        throw SerializationException("CodeScanningAlertItems is missing required property 'dismissed_by'")
      }
      ...
      if (!rawObject.containsKey("dismissed_reason")) {
        throw SerializationException("CodeScanningAlertItems is missing required property 'dismissed_reason'")
      }
      ...
      if (!rawObject.containsKey("state")) {
        throw SerializationException("CodeScanningAlertItems is missing required property 'state'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: CodeScanningAlertItems) {
      val jsonEncoder = encoder.requireJsonEncoder("CodeScanningAlertItems")
...
public fun codeScanningAlertItems(block: CodeScanningAlertItems.Builder.() -> Unit): CodeScanningAlertItems = CodeScanningAlertItems.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("CodeScanningAlertItems is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("CodeScanningAlertItems property '" + name + "' is not nullable")
