 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/label
 */
@Serializable(with = Label.Serializer::class)
public class Label(
  /**
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): Label = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<Label> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): Label {
      val jsonDecoder = decoder.requireJsonDecoder("Label")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("Label must be a JSON object")
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("Label is missing required property 'description'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: Label) {
      val jsonEncoder = encoder.requireJsonEncoder("Label")
...
public fun label(block: Label.Builder.() -> Unit): Label = Label.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("Label is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("Label property '" + name + "' is not nullable")
