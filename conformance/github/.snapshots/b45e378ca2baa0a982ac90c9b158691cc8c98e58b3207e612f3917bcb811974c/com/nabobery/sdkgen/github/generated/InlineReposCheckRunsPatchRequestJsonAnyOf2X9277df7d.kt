...
public class InlineReposCheckRunsPatchRequestJsonAnyOf2X9277df7d internal constructor(
  ...
  public val additionalProperties: Map<String, JsonElement> =
      copyAndValidateInlineReposCheckRunsPatchRequestJsonAnyOf2X9277df7dAdditionalProperties(additionalProperties)
  ...
  internal object Serializer : KSerializer<InlineReposCheckRunsPatchRequestJsonAnyOf2X9277df7d> {
    ...
    override fun serialize(encoder: Encoder, `value`: InlineReposCheckRunsPatchRequestJsonAnyOf2X9277df7d) {
      ...
      val raw = buildJsonObject {
        ...
        value.additionalProperties.keys.sorted().forEach { key ->
          ...
          check(key !in setOf("status")) { "InlineReposCheckRunsPatchRequestJsonAnyOf2X9277df7d additionalProperties key '" + key + "' collides with a fixed property" }
...
private fun copyAndValidateInlineReposCheckRunsPatchRequestJsonAnyOf2X9277df7dAdditionalProperties(additionalProperties: Map<String, JsonElement>): Map<String, JsonElement> {
  val copied = additionalProperties.toMap()
  val collision = copied.keys.sorted().firstOrNull { key -> key in setOf("status") }
  require(collision == null) { "InlineReposCheckRunsPatchRequestJsonAnyOf2X9277df7d additionalProperties key '" + collision + "' collides with a fixed property" }
  return copied
}
