 ...
 * reator
 */
@Serializable(with = InlineWebhookDeploymentStatusCreatedDeploymentCreatorX8cefa207.Serializer::class)
public class InlineWebhookDeploymentStatusCreatedDeploymentCreatorX8cefa207(
  public val id: Int,
  ...
  public val type: InlineWebhookDeploymentStatusCreatedDeploymentCreatorTypeXfd80f422? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookDeploymentStatusCreatedDeploymentCreatorTypeXfd80f422? = null
    ...
    public fun build(): InlineWebhookDeploymentStatusCreatedDeploymentCreatorX8cefa207 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookDeploymentStatusCreatedDeploymentCreatorX8cefa207(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookDeploymentStatusCreatedDeploymentCreatorX8cefa207 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookDeploymentStatusCreatedDeploymentCreatorX8cefa207> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookDeploymentStatusCreatedDeploymentCreatorX8cefa207 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookDeploymentStatusCreatedDeploymentCreatorX8cefa207")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookDeploymentStatusCreatedDeploymentCreatorX8cefa207 must be a JSON object")
      ...
      return InlineWebhookDeploymentStatusCreatedDeploymentCreatorX8cefa207(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookDeploymentStatusCreatedDeploymentCreatorTypeXfd80f422>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookDeploymentStatusCreatedDeploymentCreatorX8cefa207) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookDeploymentStatusCreatedDeploymentCreatorX8cefa207")
...
public fun inlineWebhookDeploymentStatusCreatedDeploymentCreatorX8cefa207(block: InlineWebhookDeploymentStatusCreatedDeploymentCreatorX8cefa207.Builder.() -> Unit): InlineWebhookDeploymentStatusCreatedDeploymentCreatorX8cefa207 = InlineWebhookDeploymentStatusCreatedDeploymentCreatorX8cefa207.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookDeploymentStatusCreatedDeploymentCreatorX8cefa207 is missing required property '" + name + "'")
