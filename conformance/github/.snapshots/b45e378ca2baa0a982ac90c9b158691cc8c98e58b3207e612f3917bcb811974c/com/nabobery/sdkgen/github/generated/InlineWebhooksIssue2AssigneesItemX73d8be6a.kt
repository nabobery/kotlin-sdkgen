...
/**
 * Generated model for sdkgen://source/openapi.yaml#/components/schemas/webhooks_issue_2/properties/assignees/items.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhooks_issue_2/properties/assignees/items
 */
@Serializable(with = InlineWebhooksIssue2AssigneesItemX73d8be6a.Serializer::class)
public class InlineWebhooksIssue2AssigneesItemX73d8be6a(
  public val id: Int,
  ...
  public val type: InlineWebhooksIssue2AssigneesItemTypeX6e4f118c? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhooksIssue2AssigneesItemTypeX6e4f118c? = null
    ...
    public fun build(): InlineWebhooksIssue2AssigneesItemX73d8be6a {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhooksIssue2AssigneesItemX73d8be6a(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhooksIssue2AssigneesItemX73d8be6a = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhooksIssue2AssigneesItemX73d8be6a> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhooksIssue2AssigneesItemX73d8be6a {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhooksIssue2AssigneesItemX73d8be6a")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhooksIssue2AssigneesItemX73d8be6a must be a JSON object")
      ...
      return InlineWebhooksIssue2AssigneesItemX73d8be6a(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhooksIssue2AssigneesItemTypeX6e4f118c>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhooksIssue2AssigneesItemX73d8be6a) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhooksIssue2AssigneesItemX73d8be6a")
...
public fun inlineWebhooksIssue2AssigneesItemX73d8be6a(block: InlineWebhooksIssue2AssigneesItemX73d8be6a.Builder.() -> Unit): InlineWebhooksIssue2AssigneesItemX73d8be6a = InlineWebhooksIssue2AssigneesItemX73d8be6a.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhooksIssue2AssigneesItemX73d8be6a is missing required property '" + name + "'")
