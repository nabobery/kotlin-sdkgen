...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-issue-comment-unpinned/properties/issue/allOf/1.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhook-issue-comment-unpinned/properties/issue/allOf/1
 */
@Serializable(with = InlineWebhookIssueCommentUnpinnedIssueAllOf2X8a19a18d.Serializer::class)
public class InlineWebhookIssueCommentUnpinnedIssueAllOf2X8a19a18d internal constructor(
  public val assignee: InlineWebhookIssueCommentUnpinnedIssueAllOf2AssigneeX6866af4b?,
  labels: List<InlineWebhookIssueCommentUnpinnedIssueAllOf2LabelsItemX002e79ae>,
  public val locked: Boolean,
  /**
   * State of the issue; either 'open' or 'closed'
   */
  public val state: InlineWebhookIssueCommentUnpinnedIssueAllOf2StateX672e15ce,
  ...
  private val reactionsState:
      FieldState<InlineWebhookIssueCommentUnpinnedIssueAllOf2ReactionsX1716dcc2>,
  ...
  private val userState: FieldState<InlineWebhookIssueCommentUnpinnedIssueAllOf2UserXa9d6a2e0>,
) {
  public val labels: List<InlineWebhookIssueCommentUnpinnedIssueAllOf2LabelsItemX002e79ae> =
      labels.toList()
  ...
  public val reactions: InlineWebhookIssueCommentUnpinnedIssueAllOf2ReactionsX1716dcc2?
  ...
  public constructor(
    ...
    labels: List<InlineWebhookIssueCommentUnpinnedIssueAllOf2LabelsItemX002e79ae>,
    locked: Boolean,
    state: InlineWebhookIssueCommentUnpinnedIssueAllOf2StateX672e15ce,
  ...
  public class Builder {
    private var labelsValue: List<InlineWebhookIssueCommentUnpinnedIssueAllOf2LabelsItemX002e79ae>?
        = null

    public var labels: List<InlineWebhookIssueCommentUnpinnedIssueAllOf2LabelsItemX002e79ae>
    ...
    private var stateValue: InlineWebhookIssueCommentUnpinnedIssueAllOf2StateX672e15ce? = null

    public var state: InlineWebhookIssueCommentUnpinnedIssueAllOf2StateX672e15ce
     ...
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var reactions: InlineWebhookIssueCommentUnpinnedIssueAllOf2ReactionsX1716dcc2?
      get() = reactionsState.valueOrNull()
      set(`value`) {
    ...
    private var userState: FieldState<InlineWebhookIssueCommentUnpinnedIssueAllOf2UserXa9d6a2e0> =
        FieldState.Absent
    ...
    public fun build(): InlineWebhookIssueCommentUnpinnedIssueAllOf2X8a19a18d {
      ...
      return InlineWebhookIssueCommentUnpinnedIssueAllOf2X8a19a18d(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssueCommentUnpinnedIssueAllOf2X8a19a18d = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssueCommentUnpinnedIssueAllOf2X8a19a18d> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssueCommentUnpinnedIssueAllOf2X8a19a18d {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssueCommentUnpinnedIssueAllOf2X8a19a18d")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssueCommentUnpinnedIssueAllOf2X8a19a18d must be a JSON object")
      val labels = json.decodeRequired<List<InlineWebhookIssueCommentUnpinnedIssueAllOf2LabelsItemX002e79ae>>(rawObject, "labels")
      val locked = json.decodeRequired<Boolean>(rawObject, "locked")
      val state = json.decodeRequired<InlineWebhookIssueCommentUnpinnedIssueAllOf2StateX672e15ce>(rawObject, "state")
      if (!rawObject.containsKey("assignee")) {
        throw SerializationException("InlineWebhookIssueCommentUnpinnedIssueAllOf2X8a19a18d is missing required property 'assignee'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssueCommentUnpinnedIssueAllOf2X8a19a18d) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssueCommentUnpinnedIssueAllOf2X8a19a18d")
...
public fun inlineWebhookIssueCommentUnpinnedIssueAllOf2X8a19a18d(block: InlineWebhookIssueCommentUnpinnedIssueAllOf2X8a19a18d.Builder.() -> Unit): InlineWebhookIssueCommentUnpinnedIssueAllOf2X8a19a18d = InlineWebhookIssueCommentUnpinnedIssueAllOf2X8a19a18d.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssueCommentUnpinnedIssueAllOf2X8a19a18d is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookIssueCommentUnpinnedIssueAllOf2X8a19a18d property '" + name + "' is not nullable")
