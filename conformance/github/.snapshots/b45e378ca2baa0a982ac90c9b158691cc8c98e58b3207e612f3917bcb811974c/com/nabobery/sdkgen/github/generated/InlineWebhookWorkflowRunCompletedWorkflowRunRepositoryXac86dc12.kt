...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-workflow-run-completed/properties/workflow_run/properties/re
 * pository.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-workflow-run-completed/properties/workflow_run/properties/re
 * pository
 */
@Serializable(with = InlineWebhookWorkflowRunCompletedWorkflowRunRepositoryXac86dc12.Serializer::class)
public class InlineWebhookWorkflowRunCompletedWorkflowRunRepositoryXac86dc12(
  /**
  ...
  public val owner: InlineWebhookWorkflowRunCompletedWorkflowRunRepositoryOwnerXde4c4a5a?,
  /**
  ...
  public class Builder {
    ...
    private var ownerState:
        FieldState<InlineWebhookWorkflowRunCompletedWorkflowRunRepositoryOwnerXde4c4a5a?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var owner: InlineWebhookWorkflowRunCompletedWorkflowRunRepositoryOwnerXde4c4a5a?
      get() = ownerState.valueOrNull()
      set(`value`) {
        ownerState = value.toNullableFieldState()
      }

    public fun build(): InlineWebhookWorkflowRunCompletedWorkflowRunRepositoryXac86dc12 {
      ...
      return InlineWebhookWorkflowRunCompletedWorkflowRunRepositoryXac86dc12(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookWorkflowRunCompletedWorkflowRunRepositoryXac86dc12 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookWorkflowRunCompletedWorkflowRunRepositoryXac86dc12> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookWorkflowRunCompletedWorkflowRunRepositoryXac86dc12 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookWorkflowRunCompletedWorkflowRunRepositoryXac86dc12")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookWorkflowRunCompletedWorkflowRunRepositoryXac86dc12 must be a JSON object")
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookWorkflowRunCompletedWorkflowRunRepositoryXac86dc12 is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("owner")) {
        throw SerializationException("InlineWebhookWorkflowRunCompletedWorkflowRunRepositoryXac86dc12 is missing required property 'owner'")
      }
      val owner = rawObject["owner"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookWorkflowRunCompletedWorkflowRunRepositoryOwnerXde4c4a5a?>(requireNotNull(element)) }
      return InlineWebhookWorkflowRunCompletedWorkflowRunRepositoryXac86dc12(
        archiveUrl = archiveUrl,
        assigneesUrl = assigneesUrl,
        blobsUrl = blobsUrl,
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookWorkflowRunCompletedWorkflowRunRepositoryXac86dc12) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookWorkflowRunCompletedWorkflowRunRepositoryXac86dc12")
...
public fun inlineWebhookWorkflowRunCompletedWorkflowRunRepositoryXac86dc12(block: InlineWebhookWorkflowRunCompletedWorkflowRunRepositoryXac86dc12.Builder.() -> Unit): InlineWebhookWorkflowRunCompletedWorkflowRunRepositoryXac86dc12 = InlineWebhookWorkflowRunCompletedWorkflowRunRepositoryXac86dc12.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookWorkflowRunCompletedWorkflowRunRepositoryXac86dc12 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookWorkflowRunCompletedWorkflowRunRepositoryXac86dc12 property '" + name + "' is not nullable")
