...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-closed/properties/issue/allOf/0/properties/user.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-closed/properties/issue/allOf/0/properties/user
 */
@Serializable(with = InlineWebhookIssuesClosedIssueAllOf1UserXec708940.Serializer::class)
public class InlineWebhookIssuesClosedIssueAllOf1UserXec708940(
  public val id: Long,
  ...
  public val type: InlineWebhookIssuesClosedIssueAllOf1UserTypeX0c0653af? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookIssuesClosedIssueAllOf1UserTypeX0c0653af? = null
    ...
    public fun build(): InlineWebhookIssuesClosedIssueAllOf1UserXec708940 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssuesClosedIssueAllOf1UserXec708940(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesClosedIssueAllOf1UserXec708940 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesClosedIssueAllOf1UserXec708940> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesClosedIssueAllOf1UserXec708940 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesClosedIssueAllOf1UserXec708940")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesClosedIssueAllOf1UserXec708940 must be a JSON object")
      ...
      return InlineWebhookIssuesClosedIssueAllOf1UserXec708940(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssuesClosedIssueAllOf1UserTypeX0c0653af>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesClosedIssueAllOf1UserXec708940) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesClosedIssueAllOf1UserXec708940")
...
public fun inlineWebhookIssuesClosedIssueAllOf1UserXec708940(block: InlineWebhookIssuesClosedIssueAllOf1UserXec708940.Builder.() -> Unit): InlineWebhookIssuesClosedIssueAllOf1UserXec708940 = InlineWebhookIssuesClosedIssueAllOf1UserXec708940.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesClosedIssueAllOf1UserXec708940 is missing required property '" + name + "'")
