 ...
 * signee
 */
@Serializable(with = InlineWebhookIssueCommentCreatedIssueAllOf2AssigneeXde820a66.Serializer::class)
public class InlineWebhookIssueCommentCreatedIssueAllOf2AssigneeXde820a66(
  public val id: Int,
  ...
  public val type: InlineWebhookIssueCommentCreatedIssueAllOf2AssigneeTypeX700bd77c? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookIssueCommentCreatedIssueAllOf2AssigneeTypeX700bd77c? = null
    ...
    public fun build(): InlineWebhookIssueCommentCreatedIssueAllOf2AssigneeXde820a66 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssueCommentCreatedIssueAllOf2AssigneeXde820a66(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssueCommentCreatedIssueAllOf2AssigneeXde820a66 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssueCommentCreatedIssueAllOf2AssigneeXde820a66> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssueCommentCreatedIssueAllOf2AssigneeXde820a66 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssueCommentCreatedIssueAllOf2AssigneeXde820a66")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssueCommentCreatedIssueAllOf2AssigneeXde820a66 must be a JSON object")
      ...
      return InlineWebhookIssueCommentCreatedIssueAllOf2AssigneeXde820a66(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssueCommentCreatedIssueAllOf2AssigneeTypeX700bd77c>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssueCommentCreatedIssueAllOf2AssigneeXde820a66) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssueCommentCreatedIssueAllOf2AssigneeXde820a66")
...
public fun inlineWebhookIssueCommentCreatedIssueAllOf2AssigneeXde820a66(block: InlineWebhookIssueCommentCreatedIssueAllOf2AssigneeXde820a66.Builder.() -> Unit): InlineWebhookIssueCommentCreatedIssueAllOf2AssigneeXde820a66 = InlineWebhookIssueCommentCreatedIssueAllOf2AssigneeXde820a66.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssueCommentCreatedIssueAllOf2AssigneeXde820a66 is missing required property '" + name + "'")
