 ...
 * ead/properties/repo
 */
@Serializable(with = InlineWebhookPullRequestUnassignedPullRequestHeadRepoX2afbb660.Serializer::class)
public class InlineWebhookPullRequestUnassignedPullRequestHeadRepoX2afbb660 internal constructor(
  /**
  ...
  public val createdAt: InlineWebhookPullRequestUnassignedPullRequestHeadRepoCreatedAtX9d311827,
  /**
  ...
  public val license: InlineWebhookPullRequestUnassignedPullRequestHeadRepoLicenseX81021b17?,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val owner: InlineWebhookPullRequestUnassignedPullRequestHeadRepoOwnerX3b57c09e?,
  /**
  ...
  public val pushedAt: InlineWebhookPullRequestUnassignedPullRequestHeadRepoPushedAtX5ea42cb5?,
  /**
   * Wire format: `uri-template`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val visibility: InlineWebhookPullRequestUnassignedPullRequestHeadRepoVisibilityX9e6dbbc1,
  ...
  private val mergeCommitMessageState:
      FieldState<InlineWebhookPullRequestUnassignedPullRequestHeadRepoMergeCommitMessageXc33e02f4>,
  private val mergeCommitTitleState:
      FieldState<InlineWebhookPullRequestUnassignedPullRequestHeadRepoMergeCommitTitleX58bd2146>,
  private val organizationState: FieldState<String>,
  private val permissionsState:
      FieldState<InlineWebhookPullRequestUnassignedPullRequestHeadRepoPermissionsX4b4e0a75>,
  private val publicState: FieldState<Boolean>,
  private val pullRequestCreationPolicyState:
      FieldState<InlineWebhookPullRequestUn16b6PullRequestHeadPullRequestCreationP824dXb7ab3d76>,
  private val roleNameState: FieldState<String?>,
  private val squashMergeCommitMessageState:
      FieldState<InlineWebhookPullRequestUn16b6PullRequestHeadSquashMergeCommitMessageXb5daea68>,
  private val squashMergeCommitTitleState:
      FieldState<InlineWebhookPullRequestUn16b6PullRequestHeadRepoSquashMergeCommitTitleX6257ff3d>,
  ...
  public val permissions: InlineWebhookPullRequestUnassignedPullRequestHeadRepoPermissionsX4b4e0a75?
  ...
  public val squashMergeCommitMessage:
      InlineWebhookPullRequestUn16b6PullRequestHeadSquashMergeCommitMessageXb5daea68?
  ...
  public constructor(
    ...
    createdAt: InlineWebhookPullRequestUnassignedPullRequestHeadRepoCreatedAtX9d311827,
    ...
    language: String?,
    languagesUrl: String,
    license: InlineWebhookPullRequestUnassignedPullRequestHeadRepoLicenseX81021b17?,
    mergesUrl: String,
    ...
    openIssues: Int,
    openIssuesCount: Int,
    owner: InlineWebhookPullRequestUnassignedPullRequestHeadRepoOwnerX3b57c09e?,
    `private`: Boolean,
    pullsUrl: String,
    pushedAt: InlineWebhookPullRequestUnassignedPullRequestHeadRepoPushedAtX5ea42cb5?,
    releasesUrl: String,
    size: Int,
    sshUrl: String,
    stargazersCount: Int,
    ...
    updatedAt: String,
    url: String,
    visibility: InlineWebhookPullRequestUnassignedPullRequestHeadRepoVisibilityX9e6dbbc1,
    watchers: Int,
    watchersCount: Int,
  ...
  public class Builder {
    ...
    private var createdAtValue:
        InlineWebhookPullRequestUnassignedPullRequestHeadRepoCreatedAtX9d311827? = null

    public var createdAt: InlineWebhookPullRequestUnassignedPullRequestHeadRepoCreatedAtX9d311827
    ...
    private var visibilityValue:
        InlineWebhookPullRequestUnassignedPullRequestHeadRepoVisibilityX9e6dbbc1? = null

    public var visibility: InlineWebhookPullRequestUnassignedPullRequestHeadRepoVisibilityX9e6dbbc1
    ...
    private var licenseState:
        FieldState<InlineWebhookPullRequestUnassignedPullRequestHeadRepoLicenseX81021b17?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var license: InlineWebhookPullRequestUnassignedPullRequestHeadRepoLicenseX81021b17?
    ...
    private var ownerState:
        FieldState<InlineWebhookPullRequestUnassignedPullRequestHeadRepoOwnerX3b57c09e?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var owner: InlineWebhookPullRequestUnassignedPullRequestHeadRepoOwnerX3b57c09e?
    ...
    private var pushedAtState:
        FieldState<InlineWebhookPullRequestUnassignedPullRequestHeadRepoPushedAtX5ea42cb5?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var pushedAt: InlineWebhookPullRequestUnassignedPullRequestHeadRepoPushedAtX5ea42cb5?
    ...
    public var permissions:
        InlineWebhookPullRequestUnassignedPullRequestHeadRepoPermissionsX4b4e0a75?
      get() = permissionsState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): InlineWebhookPullRequestUnassignedPullRequestHeadRepoX2afbb660 {
      ...
      return InlineWebhookPullRequestUnassignedPullRequestHeadRepoX2afbb660(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestUnassignedPullRequestHeadRepoX2afbb660 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestUnassignedPullRequestHeadRepoX2afbb660> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestUnassignedPullRequestHeadRepoX2afbb660 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestUnassignedPullRequestHeadRepoX2afbb660")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestUnassignedPullRequestHeadRepoX2afbb660 must be a JSON object")
      ...
      val createdAt = json.decodeRequired<InlineWebhookPullRequestUnassignedPullRequestHeadRepoCreatedAtX9d311827>(rawObject, "created_at")
      ...
      val visibility = json.decodeRequired<InlineWebhookPullRequestUnassignedPullRequestHeadRepoVisibilityX9e6dbbc1>(rawObject, "visibility")
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookPullRequestUnassignedPullRequestHeadRepoX2afbb660 is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("homepage")) {
        throw SerializationException("InlineWebhookPullRequestUnassignedPullRequestHeadRepoX2afbb660 is missing required property 'homepage'")
      }
      ...
      if (!rawObject.containsKey("language")) {
        throw SerializationException("InlineWebhookPullRequestUnassignedPullRequestHeadRepoX2afbb660 is missing required property 'language'")
      }
      ...
      if (!rawObject.containsKey("license")) {
        throw SerializationException("InlineWebhookPullRequestUnassignedPullRequestHeadRepoX2afbb660 is missing required property 'license'")
      }
      val license = rawObject["license"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestUnassignedPullRequestHeadRepoLicenseX81021b17?>(requireNotNull(element)) }
      if (!rawObject.containsKey("mirror_url")) {
        throw SerializationException("InlineWebhookPullRequestUnassignedPullRequestHeadRepoX2afbb660 is missing required property 'mirror_url'")
      }
      ...
      if (!rawObject.containsKey("owner")) {
        throw SerializationException("InlineWebhookPullRequestUnassignedPullRequestHeadRepoX2afbb660 is missing required property 'owner'")
      }
      val owner = rawObject["owner"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestUnassignedPullRequestHeadRepoOwnerX3b57c09e?>(requireNotNull(element)) }
      if (!rawObject.containsKey("pushed_at")) {
        throw SerializationException("InlineWebhookPullRequestUnassignedPullRequestHeadRepoX2afbb660 is missing required property 'pushed_at'")
      }
      val pushedAt = rawObject["pushed_at"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestUnassignedPullRequestHeadRepoPushedAtX5ea42cb5?>(requireNotNull(element)) }
      return InlineWebhookPullRequestUnassignedPullRequestHeadRepoX2afbb660(
        archiveUrl = archiveUrl,
        archived = archived,
        assigneesUrl = assigneesUrl,
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestUnassignedPullRequestHeadRepoX2afbb660) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestUnassignedPullRequestHeadRepoX2afbb660")
...
public fun inlineWebhookPullRequestUnassignedPullRequestHeadRepoX2afbb660(block: InlineWebhookPullRequestUnassignedPullRequestHeadRepoX2afbb660.Builder.() -> Unit): InlineWebhookPullRequestUnassignedPullRequestHeadRepoX2afbb660 = InlineWebhookPullRequestUnassignedPullRequestHeadRepoX2afbb660.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestUnassignedPullRequestHeadRepoX2afbb660 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookPullRequestUnassignedPullRequestHeadRepoX2afbb660 property '" + name + "' is not nullable")
