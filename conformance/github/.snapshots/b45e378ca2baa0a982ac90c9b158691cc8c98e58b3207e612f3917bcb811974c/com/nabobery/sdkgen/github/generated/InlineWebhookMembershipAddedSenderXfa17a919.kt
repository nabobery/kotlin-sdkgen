...
/**
 * Generated model for sdkgen://source/openapi.yaml#/components/schemas/webhook-membership-added/properties/sender.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhook-membership-added/properties/sender
 */
@Serializable(with = InlineWebhookMembershipAddedSenderXfa17a919.Serializer::class)
public class InlineWebhookMembershipAddedSenderXfa17a919(
  public val id: Int,
  ...
  public val type: InlineWebhookMembershipAddedSenderTypeXf71af496? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookMembershipAddedSenderTypeXf71af496? = null
    ...
    public fun build(): InlineWebhookMembershipAddedSenderXfa17a919 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookMembershipAddedSenderXfa17a919(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookMembershipAddedSenderXfa17a919 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookMembershipAddedSenderXfa17a919> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookMembershipAddedSenderXfa17a919 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookMembershipAddedSenderXfa17a919")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookMembershipAddedSenderXfa17a919 must be a JSON object")
      ...
      return InlineWebhookMembershipAddedSenderXfa17a919(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookMembershipAddedSenderTypeXf71af496>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookMembershipAddedSenderXfa17a919) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookMembershipAddedSenderXfa17a919")
...
public fun inlineWebhookMembershipAddedSenderXfa17a919(block: InlineWebhookMembershipAddedSenderXfa17a919.Builder.() -> Unit): InlineWebhookMembershipAddedSenderXfa17a919 = InlineWebhookMembershipAddedSenderXfa17a919.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookMembershipAddedSenderXfa17a919 is missing required property '" + name + "'")
