...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/paths/~1repos~1{owner}~1{repo}~1hooks~1{hook_id}~1config/patch/requestBody/content/appl
 ...
 * ication~1json/schema
 */
@Serializable(with = InlineReposHooksConfigPatchRequestJsonX11d8f0ef.Serializer::class)
public class InlineReposHooksConfigPatchRequestJsonX11d8f0ef internal constructor(
  ...
  public class Builder {
    ...
    public fun build(): InlineReposHooksConfigPatchRequestJsonX11d8f0ef = InlineReposHooksConfigPatchRequestJsonX11d8f0ef(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineReposHooksConfigPatchRequestJsonX11d8f0ef = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineReposHooksConfigPatchRequestJsonX11d8f0ef> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineReposHooksConfigPatchRequestJsonX11d8f0ef {
      val jsonDecoder = decoder.requireJsonDecoder("InlineReposHooksConfigPatchRequestJsonX11d8f0ef")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineReposHooksConfigPatchRequestJsonX11d8f0ef must be a JSON object")
      return InlineReposHooksConfigPatchRequestJsonX11d8f0ef(
    ...
    override fun serialize(encoder: Encoder, `value`: InlineReposHooksConfigPatchRequestJsonX11d8f0ef) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineReposHooksConfigPatchRequestJsonX11d8f0ef")
...
public fun inlineReposHooksConfigPatchRequestJsonX11d8f0ef(block: InlineReposHooksConfigPatchRequestJsonX11d8f0ef.Builder.() -> Unit): InlineReposHooksConfigPatchRequestJsonX11d8f0ef = InlineReposHooksConfigPatchRequestJsonX11d8f0ef.build(block)
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineReposHooksConfigPatchRequestJsonX11d8f0ef property '" + name + "' is not nullable")
