...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-unlocked/properties/pull_request/properties/mer
 * ged_by.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-unlocked/properties/pull_request/properties/mer
 * ged_by
 */
@Serializable(with = InlineWebhookPullRequestUnlockedPullRequestMergedByX85006ac6.Serializer::class)
public class InlineWebhookPullRequestUnlockedPullRequestMergedByX85006ac6(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestUnlockedPullRequestMergedByTypeX9c7d9c4f? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestUnlockedPullRequestMergedByTypeX9c7d9c4f? = null
    ...
    public fun build(): InlineWebhookPullRequestUnlockedPullRequestMergedByX85006ac6 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestUnlockedPullRequestMergedByX85006ac6(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestUnlockedPullRequestMergedByX85006ac6 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestUnlockedPullRequestMergedByX85006ac6> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestUnlockedPullRequestMergedByX85006ac6 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestUnlockedPullRequestMergedByX85006ac6")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestUnlockedPullRequestMergedByX85006ac6 must be a JSON object")
      ...
      return InlineWebhookPullRequestUnlockedPullRequestMergedByX85006ac6(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestUnlockedPullRequestMergedByTypeX9c7d9c4f>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestUnlockedPullRequestMergedByX85006ac6) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestUnlockedPullRequestMergedByX85006ac6")
...
public fun inlineWebhookPullRequestUnlockedPullRequestMergedByX85006ac6(block: InlineWebhookPullRequestUnlockedPullRequestMergedByX85006ac6.Builder.() -> Unit): InlineWebhookPullRequestUnlockedPullRequestMergedByX85006ac6 = InlineWebhookPullRequestUnlockedPullRequestMergedByX85006ac6.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestUnlockedPullRequestMergedByX85006ac6 is missing required property '" + name + "'")
