 ...
 * s/head/properties/repo
 */
@Serializable(with = InlineWebhookPullRequestReviewEditedPullRequestHeadRepoX46338e8b.Serializer::class)
public class InlineWebhookPullRequestReviewEditedPullRequestHeadRepoX46338e8b internal constructor(
  /**
  ...
  public val createdAt: InlineWebhookPullRequestReviewEditedPullRequestHeadRepoCreatedAtXbde534b3,
  /**
  ...
  public val license: InlineWebhookPullRequestReviewEditedPullRequestHeadRepoLicenseXb01c43c1?,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val owner: InlineWebhookPullRequestReviewEditedPullRequestHeadRepoOwnerX16f8af3d?,
  /**
  ...
  public val pushedAt: InlineWebhookPullRequestReviewEditedPullRequestHeadRepoPushedAtXa63e7666?,
  /**
   * Wire format: `uri-template`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val visibility: InlineWebhookPullRequestReviewEditedPullRequestHeadRepoVisibilityXf2a0d5a0,
  ...
  private val permissionsState:
      FieldState<InlineWebhookPullRequestReviewEditedPullRequestHeadRepoPermissionsXbfb02d3e>,
  ...
  public constructor(
    ...
    createdAt: InlineWebhookPullRequestReviewEditedPullRequestHeadRepoCreatedAtXbde534b3,
    ...
    language: String?,
    languagesUrl: String,
    license: InlineWebhookPullRequestReviewEditedPullRequestHeadRepoLicenseXb01c43c1?,
    mergesUrl: String,
    ...
    openIssues: Int,
    openIssuesCount: Int,
    owner: InlineWebhookPullRequestReviewEditedPullRequestHeadRepoOwnerX16f8af3d?,
    `private`: Boolean,
    pullsUrl: String,
    pushedAt: InlineWebhookPullRequestReviewEditedPullRequestHeadRepoPushedAtXa63e7666?,
    releasesUrl: String,
    size: Int,
    sshUrl: String,
    stargazersCount: Int,
    ...
    updatedAt: String,
    url: String,
    visibility: InlineWebhookPullRequestReviewEditedPullRequestHeadRepoVisibilityXf2a0d5a0,
    watchers: Int,
    watchersCount: Int,
  ...
  public class Builder {
    ...
    private var createdAtValue:
        InlineWebhookPullRequestReviewEditedPullRequestHeadRepoCreatedAtXbde534b3? = null

    public var createdAt: InlineWebhookPullRequestReviewEditedPullRequestHeadRepoCreatedAtXbde534b3
    ...
    private var visibilityValue:
        InlineWebhookPullRequestReviewEditedPullRequestHeadRepoVisibilityXf2a0d5a0? = null
    ...
    private var licenseState:
        FieldState<InlineWebhookPullRequestReviewEditedPullRequestHeadRepoLicenseXb01c43c1?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var license: InlineWebhookPullRequestReviewEditedPullRequestHeadRepoLicenseXb01c43c1?
    ...
    private var ownerState:
        FieldState<InlineWebhookPullRequestReviewEditedPullRequestHeadRepoOwnerX16f8af3d?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var owner: InlineWebhookPullRequestReviewEditedPullRequestHeadRepoOwnerX16f8af3d?
    ...
    private var pushedAtState:
        FieldState<InlineWebhookPullRequestReviewEditedPullRequestHeadRepoPushedAtXa63e7666?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var pushedAt: InlineWebhookPullRequestReviewEditedPullRequestHeadRepoPushedAtXa63e7666?
    ...
    public fun build(): InlineWebhookPullRequestReviewEditedPullRequestHeadRepoX46338e8b {
      ...
      return InlineWebhookPullRequestReviewEditedPullRequestHeadRepoX46338e8b(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewEditedPullRequestHeadRepoX46338e8b = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewEditedPullRequestHeadRepoX46338e8b> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewEditedPullRequestHeadRepoX46338e8b {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewEditedPullRequestHeadRepoX46338e8b")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewEditedPullRequestHeadRepoX46338e8b must be a JSON object")
      ...
      val createdAt = json.decodeRequired<InlineWebhookPullRequestReviewEditedPullRequestHeadRepoCreatedAtXbde534b3>(rawObject, "created_at")
      ...
      val visibility = json.decodeRequired<InlineWebhookPullRequestReviewEditedPullRequestHeadRepoVisibilityXf2a0d5a0>(rawObject, "visibility")
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookPullRequestReviewEditedPullRequestHeadRepoX46338e8b is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("homepage")) {
        throw SerializationException("InlineWebhookPullRequestReviewEditedPullRequestHeadRepoX46338e8b is missing required property 'homepage'")
      }
      ...
      if (!rawObject.containsKey("language")) {
        throw SerializationException("InlineWebhookPullRequestReviewEditedPullRequestHeadRepoX46338e8b is missing required property 'language'")
      }
      ...
      if (!rawObject.containsKey("license")) {
        throw SerializationException("InlineWebhookPullRequestReviewEditedPullRequestHeadRepoX46338e8b is missing required property 'license'")
      }
      val license = rawObject["license"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestReviewEditedPullRequestHeadRepoLicenseXb01c43c1?>(requireNotNull(element)) }
      if (!rawObject.containsKey("mirror_url")) {
        throw SerializationException("InlineWebhookPullRequestReviewEditedPullRequestHeadRepoX46338e8b is missing required property 'mirror_url'")
      }
      ...
      if (!rawObject.containsKey("owner")) {
        throw SerializationException("InlineWebhookPullRequestReviewEditedPullRequestHeadRepoX46338e8b is missing required property 'owner'")
      }
      val owner = rawObject["owner"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestReviewEditedPullRequestHeadRepoOwnerX16f8af3d?>(requireNotNull(element)) }
      if (!rawObject.containsKey("pushed_at")) {
        throw SerializationException("InlineWebhookPullRequestReviewEditedPullRequestHeadRepoX46338e8b is missing required property 'pushed_at'")
      }
      val pushedAt = rawObject["pushed_at"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestReviewEditedPullRequestHeadRepoPushedAtXa63e7666?>(requireNotNull(element)) }
      return InlineWebhookPullRequestReviewEditedPullRequestHeadRepoX46338e8b(
        archiveUrl = archiveUrl,
        archived = archived,
        assigneesUrl = assigneesUrl,
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewEditedPullRequestHeadRepoX46338e8b) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewEditedPullRequestHeadRepoX46338e8b")
...
public fun inlineWebhookPullRequestReviewEditedPullRequestHeadRepoX46338e8b(block: InlineWebhookPullRequestReviewEditedPullRequestHeadRepoX46338e8b.Builder.() -> Unit): InlineWebhookPullRequestReviewEditedPullRequestHeadRepoX46338e8b = InlineWebhookPullRequestReviewEditedPullRequestHeadRepoX46338e8b.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewEditedPullRequestHeadRepoX46338e8b is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookPullRequestReviewEditedPullRequestHeadRepoX46338e8b property '" + name + "' is not nullable")
