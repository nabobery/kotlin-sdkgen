...
public class WebhookRubygemsMetadata(
  ...
  dependencies: List<Map<String, String>>? = null,
  ...
  public val dependencies: List<Map<String, String>>? =
      dependencies?.let { collection0 -> collection0.map { element1 -> element1.toMap() } }
  ...
  public class Builder {
    ...
    private var dependenciesValue: List<Map<String, String>>? = null

    public var dependencies: List<Map<String, String>>?
      get() = dependenciesValue?.let { collection0 -> collection0.map { element1 -> element1.toMap() } }
      set(`value`) {
        dependenciesValue = value?.let { collection0 -> collection0.map { element1 -> element1.toMap() } }
      }
  ...
  internal object Serializer : KSerializer<WebhookRubygemsMetadata> {
