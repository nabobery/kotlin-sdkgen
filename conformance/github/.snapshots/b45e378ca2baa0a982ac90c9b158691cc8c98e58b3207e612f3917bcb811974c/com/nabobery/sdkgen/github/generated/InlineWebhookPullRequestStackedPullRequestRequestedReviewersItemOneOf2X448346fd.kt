 ...
 * ested_reviewers/items/oneOf/1
 */
@Serializable(with = InlineWebhookPullRequestStackedPullRequestRequestedReviewersItemOneOf2X448346fd.Serializer::class)
public class InlineWebhookPullRequestStackedPullRequestRequestedReviewersItemOneOf2X448346fd internal constructor(
  ...
  private val parentState:
      FieldState<InlineWebhookPullRequestStae55PullRequestRequestedReviewersItemParentXc1be66ed?>,
) {
  public val deleted: Boolean?
    get() = deletedState.valueOrNull()

  public val parent: InlineWebhookPullRequestStae55PullRequestRequestedReviewersItemParentXc1be66ed?
  ...
  public class Builder {
    ...
    private var privacyValue:
        InlineWebhookPullRequestStae55PullRequestRequestedReviewersItemPrivacyXe5e8b1ec? = null
     ...
     */
    public var parent:
        InlineWebhookPullRequestStae55PullRequestRequestedReviewersItemParentXc1be66ed?
      get() = parentState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): InlineWebhookPullRequestStackedPullRequestRequestedReviewersItemOneOf2X448346fd {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestStackedPullRequestRequestedReviewersItemOneOf2X448346fd = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestStackedPullRequestRequestedReviewersItemOneOf2X448346fd> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestStackedPullRequestRequestedReviewersItemOneOf2X448346fd {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestStackedPullRequestRequestedReviewersItemOneOf2X448346fd")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestStackedPullRequestRequestedReviewersItemOneOf2X448346fd must be a JSON object")
      ...
      val privacy = json.decodeRequired<InlineWebhookPullRequestStae55PullRequestRequestedReviewersItemPrivacyXe5e8b1ec>(rawObject, "privacy")
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookPullRequestStackedPullRequestRequestedReviewersItemOneOf2X448346fd is missing required property 'description'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestStackedPullRequestRequestedReviewersItemOneOf2X448346fd) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestStackedPullRequestRequestedReviewersItemOneOf2X448346fd")
...
public fun inlineWebhookPullRequestStackedPullRequestRequestedReviewersItemOneOf2X448346fd(block: InlineWebhookPullRequestStackedPullRequestRequestedReviewersItemOneOf2X448346fd.Builder.() -> Unit): InlineWebhookPullRequestStackedPullRequestRequestedReviewersItemOneOf2X448346fd = InlineWebhookPullRequestStackedPullRequestRequestedReviewersItemOneOf2X448346fd.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestStackedPullRequestRequestedReviewersItemOneOf2X448346fd is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookPullRequestStackedPullRequestRequestedReviewersItemOneOf2X448346fd property '" + name + "' is not nullable")
