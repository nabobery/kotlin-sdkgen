 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/repository-advisory/properties/private_fork
 */
@Serializable(with = InlineRepositoryAdvisoryPrivateForkX38a51c4b.Serializer::class)
public class InlineRepositoryAdvisoryPrivateForkX38a51c4b(
  /**
  ...
  public class Builder {
    ...
    public fun build(): InlineRepositoryAdvisoryPrivateForkX38a51c4b {
      ...
      return InlineRepositoryAdvisoryPrivateForkX38a51c4b(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineRepositoryAdvisoryPrivateForkX38a51c4b = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineRepositoryAdvisoryPrivateForkX38a51c4b> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineRepositoryAdvisoryPrivateForkX38a51c4b {
      val jsonDecoder = decoder.requireJsonDecoder("InlineRepositoryAdvisoryPrivateForkX38a51c4b")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineRepositoryAdvisoryPrivateForkX38a51c4b must be a JSON object")
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineRepositoryAdvisoryPrivateForkX38a51c4b is missing required property 'description'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineRepositoryAdvisoryPrivateForkX38a51c4b) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineRepositoryAdvisoryPrivateForkX38a51c4b")
...
public fun inlineRepositoryAdvisoryPrivateForkX38a51c4b(block: InlineRepositoryAdvisoryPrivateForkX38a51c4b.Builder.() -> Unit): InlineRepositoryAdvisoryPrivateForkX38a51c4b = InlineRepositoryAdvisoryPrivateForkX38a51c4b.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineRepositoryAdvisoryPrivateForkX38a51c4b is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineRepositoryAdvisoryPrivateForkX38a51c4b property '" + name + "' is not nullable")
