 ...
 * ring_actor
 */
@Serializable(with = InlineWebhookDeploymentCreatedWorkflowRunTriggeringActorXdc7ffe45.Serializer::class)
public class InlineWebhookDeploymentCreatedWorkflowRunTriggeringActorXdc7ffe45(
  public val id: Int,
  ...
  public val type: InlineWebhookDeploymentCreatedWorkflowRunTriggeringActorTypeX0214c0a4? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookDeploymentCreatedWorkflowRunTriggeringActorTypeX0214c0a4? = null
    ...
    public fun build(): InlineWebhookDeploymentCreatedWorkflowRunTriggeringActorXdc7ffe45 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookDeploymentCreatedWorkflowRunTriggeringActorXdc7ffe45(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookDeploymentCreatedWorkflowRunTriggeringActorXdc7ffe45 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookDeploymentCreatedWorkflowRunTriggeringActorXdc7ffe45> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookDeploymentCreatedWorkflowRunTriggeringActorXdc7ffe45 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookDeploymentCreatedWorkflowRunTriggeringActorXdc7ffe45")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookDeploymentCreatedWorkflowRunTriggeringActorXdc7ffe45 must be a JSON object")
      ...
      return InlineWebhookDeploymentCreatedWorkflowRunTriggeringActorXdc7ffe45(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookDeploymentCreatedWorkflowRunTriggeringActorTypeX0214c0a4>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookDeploymentCreatedWorkflowRunTriggeringActorXdc7ffe45) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookDeploymentCreatedWorkflowRunTriggeringActorXdc7ffe45")
...
public fun inlineWebhookDeploymentCreatedWorkflowRunTriggeringActorXdc7ffe45(block: InlineWebhookDeploymentCreatedWorkflowRunTriggeringActorXdc7ffe45.Builder.() -> Unit): InlineWebhookDeploymentCreatedWorkflowRunTriggeringActorXdc7ffe45 = InlineWebhookDeploymentCreatedWorkflowRunTriggeringActorXdc7ffe45.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookDeploymentCreatedWorkflowRunTriggeringActorXdc7ffe45 is missing required property '" + name + "'")
