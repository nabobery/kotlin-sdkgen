...
@Serializable
public data class IssueTypeRemovedIssueEventView(
 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/issue-type-removed-issue-event
 */
@Serializable(with = IssueTypeRemovedIssueEvent.Serializer::class)
public class IssueTypeRemovedIssueEvent(
  public val actor: SimpleUser,
  public val commitId: String?,
  public val commitUrl: String?,
  public val createdAt: String,
  ...
  public class Builder {
    ...
    public fun build(): IssueTypeRemovedIssueEvent {
      ...
      return IssueTypeRemovedIssueEvent(
        actor = actor,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): IssueTypeRemovedIssueEvent = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<IssueTypeRemovedIssueEvent> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): IssueTypeRemovedIssueEvent {
      val jsonDecoder = decoder.requireJsonDecoder("IssueTypeRemovedIssueEvent")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("IssueTypeRemovedIssueEvent must be a JSON object")
      ...
      if (!rawObject.containsKey("commit_id")) {
        throw SerializationException("IssueTypeRemovedIssueEvent is missing required property 'commit_id'")
      }
      ...
      if (!rawObject.containsKey("commit_url")) {
        throw SerializationException("IssueTypeRemovedIssueEvent is missing required property 'commit_url'")
      }
      ...
      if (!rawObject.containsKey("performed_via_github_app")) {
        throw SerializationException("IssueTypeRemovedIssueEvent is missing required property 'performed_via_github_app'")
      }
      ...
      if (!rawObject.containsKey("prev_issue_type")) {
        throw SerializationException("IssueTypeRemovedIssueEvent is missing required property 'prev_issue_type'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: IssueTypeRemovedIssueEvent) {
      val jsonEncoder = encoder.requireJsonEncoder("IssueTypeRemovedIssueEvent")
...
public fun issueTypeRemovedIssueEvent(block: IssueTypeRemovedIssueEvent.Builder.() -> Unit): IssueTypeRemovedIssueEvent = IssueTypeRemovedIssueEvent.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("IssueTypeRemovedIssueEvent is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("IssueTypeRemovedIssueEvent property '" + name + "' is not nullable")
