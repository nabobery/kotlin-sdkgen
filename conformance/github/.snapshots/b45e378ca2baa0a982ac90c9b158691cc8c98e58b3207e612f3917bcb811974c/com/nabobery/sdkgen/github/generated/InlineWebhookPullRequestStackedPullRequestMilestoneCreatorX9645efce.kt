 ...
 * stone/properties/creator.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-stacked/properties/pull_request/properties/mile
 * stone/properties/creator
 */
@Serializable(with = InlineWebhookPullRequestStackedPullRequestMilestoneCreatorX9645efce.Serializer::class)
public class InlineWebhookPullRequestStackedPullRequestMilestoneCreatorX9645efce(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestStackedPullRequestMilestoneCreatorTypeX86ad5ec4? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestStackedPullRequestMilestoneCreatorTypeX86ad5ec4? = null
    ...
    public fun build(): InlineWebhookPullRequestStackedPullRequestMilestoneCreatorX9645efce {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestStackedPullRequestMilestoneCreatorX9645efce(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestStackedPullRequestMilestoneCreatorX9645efce = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestStackedPullRequestMilestoneCreatorX9645efce> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestStackedPullRequestMilestoneCreatorX9645efce {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestStackedPullRequestMilestoneCreatorX9645efce")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestStackedPullRequestMilestoneCreatorX9645efce must be a JSON object")
      ...
      return InlineWebhookPullRequestStackedPullRequestMilestoneCreatorX9645efce(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestStackedPullRequestMilestoneCreatorTypeX86ad5ec4>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestStackedPullRequestMilestoneCreatorX9645efce) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestStackedPullRequestMilestoneCreatorX9645efce")
...
public fun inlineWebhookPullRequestStackedPullRequestMilestoneCreatorX9645efce(block: InlineWebhookPullRequestStackedPullRequestMilestoneCreatorX9645efce.Builder.() -> Unit): InlineWebhookPullRequestStackedPullRequestMilestoneCreatorX9645efce = InlineWebhookPullRequestStackedPullRequestMilestoneCreatorX9645efce.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestStackedPullRequestMilestoneCreatorX9645efce is missing required property '" + name + "'")
