 ...
 * assignee
 */
@Serializable(with = InlineWebhookPullRequestSynchronizePullRequestAssigneeXd8577489.Serializer::class)
public class InlineWebhookPullRequestSynchronizePullRequestAssigneeXd8577489(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestSynchronizePullRequestAssigneeTypeXf386b81c? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestSynchronizePullRequestAssigneeTypeXf386b81c? = null
    ...
    public fun build(): InlineWebhookPullRequestSynchronizePullRequestAssigneeXd8577489 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestSynchronizePullRequestAssigneeXd8577489(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestSynchronizePullRequestAssigneeXd8577489 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestSynchronizePullRequestAssigneeXd8577489> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestSynchronizePullRequestAssigneeXd8577489 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestSynchronizePullRequestAssigneeXd8577489")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestSynchronizePullRequestAssigneeXd8577489 must be a JSON object")
      ...
      return InlineWebhookPullRequestSynchronizePullRequestAssigneeXd8577489(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestSynchronizePullRequestAssigneeTypeXf386b81c>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestSynchronizePullRequestAssigneeXd8577489) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestSynchronizePullRequestAssigneeXd8577489")
...
public fun inlineWebhookPullRequestSynchronizePullRequestAssigneeXd8577489(block: InlineWebhookPullRequestSynchronizePullRequestAssigneeXd8577489.Builder.() -> Unit): InlineWebhookPullRequestSynchronizePullRequestAssigneeXd8577489 = InlineWebhookPullRequestSynchronizePullRequestAssigneeXd8577489.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestSynchronizePullRequestAssigneeXd8577489 is missing required property '" + name + "'")
