...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-issue-comment-unpinned/properties/issue/allOf/0/properties/r
 * eactions.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-issue-comment-unpinned/properties/issue/allOf/0/properties/r
 * eactions
 */
@Serializable(with = InlineWebhookIssueCommentUnpinnedIssueAllOf1ReactionsX6144d025.Serializer::class)
public class InlineWebhookIssueCommentUnpinnedIssueAllOf1ReactionsX6144d025(
  public val _1: Int,
  public val _12: Int,
  ...
  public class Builder {
    ...
    public fun build(): InlineWebhookIssueCommentUnpinnedIssueAllOf1ReactionsX6144d025 {
      ...
      return InlineWebhookIssueCommentUnpinnedIssueAllOf1ReactionsX6144d025(
        _1 = _1,
        _12 = _12,
        confused = confused,
        eyes = eyes,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssueCommentUnpinnedIssueAllOf1ReactionsX6144d025 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssueCommentUnpinnedIssueAllOf1ReactionsX6144d025> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssueCommentUnpinnedIssueAllOf1ReactionsX6144d025 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssueCommentUnpinnedIssueAllOf1ReactionsX6144d025")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssueCommentUnpinnedIssueAllOf1ReactionsX6144d025 must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssueCommentUnpinnedIssueAllOf1ReactionsX6144d025) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssueCommentUnpinnedIssueAllOf1ReactionsX6144d025")
...
public fun inlineWebhookIssueCommentUnpinnedIssueAllOf1ReactionsX6144d025(block: InlineWebhookIssueCommentUnpinnedIssueAllOf1ReactionsX6144d025.Builder.() -> Unit): InlineWebhookIssueCommentUnpinnedIssueAllOf1ReactionsX6144d025 = InlineWebhookIssueCommentUnpinnedIssueAllOf1ReactionsX6144d025.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssueCommentUnpinnedIssueAllOf1ReactionsX6144d025 is missing required property '" + name + "'")
