...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-unlocked/properties/issue/properties/reactions.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-unlocked/properties/issue/properties/reactions
 */
@Serializable(with = InlineWebhookIssuesUnlockedIssueReactionsX1c150211.Serializer::class)
public class InlineWebhookIssuesUnlockedIssueReactionsX1c150211(
  public val _1: Int,
  public val _12: Int,
  ...
  public class Builder {
    ...
    public fun build(): InlineWebhookIssuesUnlockedIssueReactionsX1c150211 {
      ...
      return InlineWebhookIssuesUnlockedIssueReactionsX1c150211(
        _1 = _1,
        _12 = _12,
        confused = confused,
        eyes = eyes,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesUnlockedIssueReactionsX1c150211 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesUnlockedIssueReactionsX1c150211> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesUnlockedIssueReactionsX1c150211 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesUnlockedIssueReactionsX1c150211")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesUnlockedIssueReactionsX1c150211 must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesUnlockedIssueReactionsX1c150211) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesUnlockedIssueReactionsX1c150211")
...
public fun inlineWebhookIssuesUnlockedIssueReactionsX1c150211(block: InlineWebhookIssuesUnlockedIssueReactionsX1c150211.Builder.() -> Unit): InlineWebhookIssuesUnlockedIssueReactionsX1c150211 = InlineWebhookIssuesUnlockedIssueReactionsX1c150211.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesUnlockedIssueReactionsX1c150211 is missing required property '" + name + "'")
