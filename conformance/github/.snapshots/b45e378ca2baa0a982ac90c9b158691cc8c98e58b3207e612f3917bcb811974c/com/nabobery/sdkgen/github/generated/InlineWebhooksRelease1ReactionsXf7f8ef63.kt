...
/**
 * Generated model for sdkgen://source/openapi.yaml#/components/schemas/webhooks_release_1/properties/reactions.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhooks_release_1/properties/reactions
 */
@Serializable(with = InlineWebhooksRelease1ReactionsXf7f8ef63.Serializer::class)
public class InlineWebhooksRelease1ReactionsXf7f8ef63(
  public val _1: Int,
  public val _12: Int,
  ...
  public class Builder {
    ...
    public fun build(): InlineWebhooksRelease1ReactionsXf7f8ef63 {
      ...
      return InlineWebhooksRelease1ReactionsXf7f8ef63(
        _1 = _1,
        _12 = _12,
        confused = confused,
        eyes = eyes,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhooksRelease1ReactionsXf7f8ef63 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhooksRelease1ReactionsXf7f8ef63> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhooksRelease1ReactionsXf7f8ef63 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhooksRelease1ReactionsXf7f8ef63")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhooksRelease1ReactionsXf7f8ef63 must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhooksRelease1ReactionsXf7f8ef63) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhooksRelease1ReactionsXf7f8ef63")
...
public fun inlineWebhooksRelease1ReactionsXf7f8ef63(block: InlineWebhooksRelease1ReactionsXf7f8ef63.Builder.() -> Unit): InlineWebhooksRelease1ReactionsXf7f8ef63 = InlineWebhooksRelease1ReactionsXf7f8ef63.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhooksRelease1ReactionsXf7f8ef63 is missing required property '" + name + "'")
