...
public class OidcCustomSub(
  ...
  public class Builder {
    ...
    public var includeClaimKeys: List<String>
      get() = requireNotNull(includeClaimKeysValue) { "includeClaimKeys is required" }.toList()
      set(`value`) {
        includeClaimKeysValue = value.toList()
      }
  ...
  internal object Serializer : KSerializer<OidcCustomSub> {
