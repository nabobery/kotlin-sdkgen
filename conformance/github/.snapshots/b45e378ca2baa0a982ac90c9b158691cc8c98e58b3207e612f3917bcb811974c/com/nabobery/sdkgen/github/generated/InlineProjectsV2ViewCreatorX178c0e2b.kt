...
/**
 * Generated model for sdkgen://source/openapi.yaml#/components/schemas/projects-v2-view/properties/creator.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/projects-v2-view/properties/creator
 */
@Serializable(with = InlineProjectsV2ViewCreatorX178c0e2b.Serializer::class)
public class InlineProjectsV2ViewCreatorX178c0e2b internal constructor(
  /**
  ...
  public class Builder {
    ...
    public fun build(): InlineProjectsV2ViewCreatorX178c0e2b {
      ...
      return InlineProjectsV2ViewCreatorX178c0e2b(
        avatarUrl = avatarUrl,
        eventsUrl = eventsUrl,
        followersUrl = followersUrl,
        followingUrl = followingUrl,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineProjectsV2ViewCreatorX178c0e2b = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineProjectsV2ViewCreatorX178c0e2b> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineProjectsV2ViewCreatorX178c0e2b {
      val jsonDecoder = decoder.requireJsonDecoder("InlineProjectsV2ViewCreatorX178c0e2b")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineProjectsV2ViewCreatorX178c0e2b must be a JSON object")
      ...
      if (!rawObject.containsKey("gravatar_id")) {
        throw SerializationException("InlineProjectsV2ViewCreatorX178c0e2b is missing required property 'gravatar_id'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineProjectsV2ViewCreatorX178c0e2b) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineProjectsV2ViewCreatorX178c0e2b")
...
public fun inlineProjectsV2ViewCreatorX178c0e2b(block: InlineProjectsV2ViewCreatorX178c0e2b.Builder.() -> Unit): InlineProjectsV2ViewCreatorX178c0e2b = InlineProjectsV2ViewCreatorX178c0e2b.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineProjectsV2ViewCreatorX178c0e2b is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineProjectsV2ViewCreatorX178c0e2b property '" + name + "' is not nullable")
