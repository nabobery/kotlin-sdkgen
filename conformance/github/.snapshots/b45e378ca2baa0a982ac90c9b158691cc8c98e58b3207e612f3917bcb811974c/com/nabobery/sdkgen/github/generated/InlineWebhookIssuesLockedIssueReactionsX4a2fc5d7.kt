...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-locked/properties/issue/properties/reactions.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-locked/properties/issue/properties/reactions
 */
@Serializable(with = InlineWebhookIssuesLockedIssueReactionsX4a2fc5d7.Serializer::class)
public class InlineWebhookIssuesLockedIssueReactionsX4a2fc5d7(
  public val _1: Int,
  public val _12: Int,
  ...
  public class Builder {
    ...
    public fun build(): InlineWebhookIssuesLockedIssueReactionsX4a2fc5d7 {
      ...
      return InlineWebhookIssuesLockedIssueReactionsX4a2fc5d7(
        _1 = _1,
        _12 = _12,
        confused = confused,
        eyes = eyes,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesLockedIssueReactionsX4a2fc5d7 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesLockedIssueReactionsX4a2fc5d7> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesLockedIssueReactionsX4a2fc5d7 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesLockedIssueReactionsX4a2fc5d7")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesLockedIssueReactionsX4a2fc5d7 must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesLockedIssueReactionsX4a2fc5d7) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesLockedIssueReactionsX4a2fc5d7")
...
public fun inlineWebhookIssuesLockedIssueReactionsX4a2fc5d7(block: InlineWebhookIssuesLockedIssueReactionsX4a2fc5d7.Builder.() -> Unit): InlineWebhookIssuesLockedIssueReactionsX4a2fc5d7 = InlineWebhookIssuesLockedIssueReactionsX4a2fc5d7.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesLockedIssueReactionsX4a2fc5d7 is missing required property '" + name + "'")
