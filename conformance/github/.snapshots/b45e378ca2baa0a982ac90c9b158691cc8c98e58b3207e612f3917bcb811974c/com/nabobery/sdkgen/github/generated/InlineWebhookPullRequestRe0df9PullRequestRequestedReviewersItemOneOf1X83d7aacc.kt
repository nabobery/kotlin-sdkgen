 ...
 * properties/requested_reviewers/items/oneOf/0
 */
@Serializable(with = InlineWebhookPullRequestRe0df9PullRequestRequestedReviewersItemOneOf1X83d7aacc.Serializer::class)
public class InlineWebhookPullRequestRe0df9PullRequestRequestedReviewersItemOneOf1X83d7aacc(
  public val id: Int,
  ...
  public val type:
      InlineWebhookPullRequestRe0df9PullRequestRequestedReviewersItemTypeXebb84b03? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestRe0df9PullRequestRequestedReviewersItemTypeXebb84b03? =
        null
    ...
    public fun build(): InlineWebhookPullRequestRe0df9PullRequestRequestedReviewersItemOneOf1X83d7aacc {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestRe0df9PullRequestRequestedReviewersItemOneOf1X83d7aacc = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestRe0df9PullRequestRequestedReviewersItemOneOf1X83d7aacc> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestRe0df9PullRequestRequestedReviewersItemOneOf1X83d7aacc {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestRe0df9PullRequestRequestedReviewersItemOneOf1X83d7aacc")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestRe0df9PullRequestRequestedReviewersItemOneOf1X83d7aacc must be a JSON object")
      ...
      return InlineWebhookPullRequestRe0df9PullRequestRequestedReviewersItemOneOf1X83d7aacc(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestRe0df9PullRequestRequestedReviewersItemTypeXebb84b03>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestRe0df9PullRequestRequestedReviewersItemOneOf1X83d7aacc) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestRe0df9PullRequestRequestedReviewersItemOneOf1X83d7aacc")
...
public fun inlineWebhookPullRequestRe0df9PullRequestRequestedReviewersItemOneOf1X83d7aacc(block: InlineWebhookPullRequestRe0df9PullRequestRequestedReviewersItemOneOf1X83d7aacc.Builder.() -> Unit): InlineWebhookPullRequestRe0df9PullRequestRequestedReviewersItemOneOf1X83d7aacc = InlineWebhookPullRequestRe0df9PullRequestRequestedReviewersItemOneOf1X83d7aacc.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestRe0df9PullRequestRequestedReviewersItemOneOf1X83d7aacc is missing required property '" + name + "'")
