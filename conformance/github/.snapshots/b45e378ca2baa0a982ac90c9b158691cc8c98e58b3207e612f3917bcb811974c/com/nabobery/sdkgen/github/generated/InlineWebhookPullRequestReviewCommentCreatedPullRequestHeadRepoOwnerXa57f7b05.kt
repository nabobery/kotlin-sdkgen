 ...
 * properties/head/properties/repo/properties/owner
 */
@Serializable(with = InlineWebhookPullRequestReviewCommentCreatedPullRequestHeadRepoOwnerXa57f7b05.Serializer::class)
public class InlineWebhookPullRequestReviewCommentCreatedPullRequestHeadRepoOwnerXa57f7b05(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestRe0d91PullRequestHeadRepoOwnerTypeX1ba28eeb? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestRe0d91PullRequestHeadRepoOwnerTypeX1ba28eeb? = null
    ...
    public fun build(): InlineWebhookPullRequestReviewCommentCreatedPullRequestHeadRepoOwnerXa57f7b05 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestReviewCommentCreatedPullRequestHeadRepoOwnerXa57f7b05(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewCommentCreatedPullRequestHeadRepoOwnerXa57f7b05 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewCommentCreatedPullRequestHeadRepoOwnerXa57f7b05> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewCommentCreatedPullRequestHeadRepoOwnerXa57f7b05 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewCommentCreatedPullRequestHeadRepoOwnerXa57f7b05")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewCommentCreatedPullRequestHeadRepoOwnerXa57f7b05 must be a JSON object")
      ...
      return InlineWebhookPullRequestReviewCommentCreatedPullRequestHeadRepoOwnerXa57f7b05(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestRe0d91PullRequestHeadRepoOwnerTypeX1ba28eeb>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewCommentCreatedPullRequestHeadRepoOwnerXa57f7b05) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewCommentCreatedPullRequestHeadRepoOwnerXa57f7b05")
...
public fun inlineWebhookPullRequestReviewCommentCreatedPullRequestHeadRepoOwnerXa57f7b05(block: InlineWebhookPullRequestReviewCommentCreatedPullRequestHeadRepoOwnerXa57f7b05.Builder.() -> Unit): InlineWebhookPullRequestReviewCommentCreatedPullRequestHeadRepoOwnerXa57f7b05 = InlineWebhookPullRequestReviewCommentCreatedPullRequestHeadRepoOwnerXa57f7b05.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewCommentCreatedPullRequestHeadRepoOwnerXa57f7b05 is missing required property '" + name + "'")
