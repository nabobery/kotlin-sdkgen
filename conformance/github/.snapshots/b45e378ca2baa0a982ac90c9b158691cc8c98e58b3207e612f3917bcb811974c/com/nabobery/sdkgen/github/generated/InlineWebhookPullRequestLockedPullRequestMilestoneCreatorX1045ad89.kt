 ...
 * tone/properties/creator.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-locked/properties/pull_request/properties/miles
 * tone/properties/creator
 */
@Serializable(with = InlineWebhookPullRequestLockedPullRequestMilestoneCreatorX1045ad89.Serializer::class)
public class InlineWebhookPullRequestLockedPullRequestMilestoneCreatorX1045ad89(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestLockedPullRequestMilestoneCreatorTypeX54b22749? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestLockedPullRequestMilestoneCreatorTypeX54b22749? = null
    ...
    public fun build(): InlineWebhookPullRequestLockedPullRequestMilestoneCreatorX1045ad89 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestLockedPullRequestMilestoneCreatorX1045ad89(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestLockedPullRequestMilestoneCreatorX1045ad89 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestLockedPullRequestMilestoneCreatorX1045ad89> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestLockedPullRequestMilestoneCreatorX1045ad89 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestLockedPullRequestMilestoneCreatorX1045ad89")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestLockedPullRequestMilestoneCreatorX1045ad89 must be a JSON object")
      ...
      return InlineWebhookPullRequestLockedPullRequestMilestoneCreatorX1045ad89(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestLockedPullRequestMilestoneCreatorTypeX54b22749>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestLockedPullRequestMilestoneCreatorX1045ad89) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestLockedPullRequestMilestoneCreatorX1045ad89")
...
public fun inlineWebhookPullRequestLockedPullRequestMilestoneCreatorX1045ad89(block: InlineWebhookPullRequestLockedPullRequestMilestoneCreatorX1045ad89.Builder.() -> Unit): InlineWebhookPullRequestLockedPullRequestMilestoneCreatorX1045ad89 = InlineWebhookPullRequestLockedPullRequestMilestoneCreatorX1045ad89.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestLockedPullRequestMilestoneCreatorX1045ad89 is missing required property '" + name + "'")
