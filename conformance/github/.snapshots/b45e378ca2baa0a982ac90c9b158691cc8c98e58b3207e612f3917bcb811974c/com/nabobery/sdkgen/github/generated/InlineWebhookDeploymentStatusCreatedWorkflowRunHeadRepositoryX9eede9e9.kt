 ...
 * /head_repository
 */
@Serializable(with = InlineWebhookDeploymentStatusCreatedWorkflowRunHeadRepositoryX9eede9e9.Serializer::class)
public class InlineWebhookDeploymentStatusCreatedWorkflowRunHeadRepositoryX9eede9e9(
  ...
  public val owner:
      InlineWebhookDeploymentStatusCreatedWorkflowRunHeadRepositoryOwnerXb5240b9f? = null,
  ...
  public class Builder {
    ...
    public var owner: InlineWebhookDeploymentStatusCreatedWorkflowRunHeadRepositoryOwnerXb5240b9f? =
        null
    ...
    public fun build(): InlineWebhookDeploymentStatusCreatedWorkflowRunHeadRepositoryX9eede9e9 = InlineWebhookDeploymentStatusCreatedWorkflowRunHeadRepositoryX9eede9e9(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookDeploymentStatusCreatedWorkflowRunHeadRepositoryX9eede9e9 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookDeploymentStatusCreatedWorkflowRunHeadRepositoryX9eede9e9> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookDeploymentStatusCreatedWorkflowRunHeadRepositoryX9eede9e9 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookDeploymentStatusCreatedWorkflowRunHeadRepositoryX9eede9e9")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookDeploymentStatusCreatedWorkflowRunHeadRepositoryX9eede9e9 must be a JSON object")
      return InlineWebhookDeploymentStatusCreatedWorkflowRunHeadRepositoryX9eede9e9(
        ...
        owner = rawObject["owner"]?.let { json.decodeFromJsonElement<InlineWebhookDeploymentStatusCreatedWorkflowRunHeadRepositoryOwnerXb5240b9f>(it) },
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookDeploymentStatusCreatedWorkflowRunHeadRepositoryX9eede9e9) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookDeploymentStatusCreatedWorkflowRunHeadRepositoryX9eede9e9")
...
public fun inlineWebhookDeploymentStatusCreatedWorkflowRunHeadRepositoryX9eede9e9(block: InlineWebhookDeploymentStatusCreatedWorkflowRunHeadRepositoryX9eede9e9.Builder.() -> Unit): InlineWebhookDeploymentStatusCreatedWorkflowRunHeadRepositoryX9eede9e9 = InlineWebhookDeploymentStatusCreatedWorkflowRunHeadRepositoryX9eede9e9.build(block)
