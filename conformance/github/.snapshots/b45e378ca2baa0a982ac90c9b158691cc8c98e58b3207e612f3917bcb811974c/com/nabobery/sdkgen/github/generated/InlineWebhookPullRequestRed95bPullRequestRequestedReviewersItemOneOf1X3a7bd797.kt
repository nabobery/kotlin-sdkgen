 ...
 * roperties/requested_reviewers/items/oneOf/0.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-review-comment-edited/properties/pull_request/p
 * roperties/requested_reviewers/items/oneOf/0
 */
@Serializable(with = InlineWebhookPullRequestRed95bPullRequestRequestedReviewersItemOneOf1X3a7bd797.Serializer::class)
public class InlineWebhookPullRequestRed95bPullRequestRequestedReviewersItemOneOf1X3a7bd797(
  public val id: Int,
  ...
  public val type:
      InlineWebhookPullRequestRed95bPullRequestRequestedReviewersItemTypeX14a310e4? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestRed95bPullRequestRequestedReviewersItemTypeX14a310e4? =
        null
    ...
    public fun build(): InlineWebhookPullRequestRed95bPullRequestRequestedReviewersItemOneOf1X3a7bd797 {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestRed95bPullRequestRequestedReviewersItemOneOf1X3a7bd797 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestRed95bPullRequestRequestedReviewersItemOneOf1X3a7bd797> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestRed95bPullRequestRequestedReviewersItemOneOf1X3a7bd797 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestRed95bPullRequestRequestedReviewersItemOneOf1X3a7bd797")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestRed95bPullRequestRequestedReviewersItemOneOf1X3a7bd797 must be a JSON object")
      ...
      return InlineWebhookPullRequestRed95bPullRequestRequestedReviewersItemOneOf1X3a7bd797(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestRed95bPullRequestRequestedReviewersItemTypeX14a310e4>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestRed95bPullRequestRequestedReviewersItemOneOf1X3a7bd797) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestRed95bPullRequestRequestedReviewersItemOneOf1X3a7bd797")
...
public fun inlineWebhookPullRequestRed95bPullRequestRequestedReviewersItemOneOf1X3a7bd797(block: InlineWebhookPullRequestRed95bPullRequestRequestedReviewersItemOneOf1X3a7bd797.Builder.() -> Unit): InlineWebhookPullRequestRed95bPullRequestRequestedReviewersItemOneOf1X3a7bd797 = InlineWebhookPullRequestRed95bPullRequestRequestedReviewersItemOneOf1X3a7bd797.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestRed95bPullRequestRequestedReviewersItemOneOf1X3a7bd797 is missing required property '" + name + "'")
