...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-release-prereleased/properties/release/properties/author.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-release-prereleased/properties/release/properties/author
 */
@Serializable(with = InlineWebhookReleasePrereleasedReleaseAuthorX19b9a075.Serializer::class)
public class InlineWebhookReleasePrereleasedReleaseAuthorX19b9a075(
  public val id: Int,
  ...
  public val type: InlineWebhookReleasePrereleasedReleaseAuthorTypeX54099e6e? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookReleasePrereleasedReleaseAuthorTypeX54099e6e? = null
    ...
    public fun build(): InlineWebhookReleasePrereleasedReleaseAuthorX19b9a075 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookReleasePrereleasedReleaseAuthorX19b9a075(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookReleasePrereleasedReleaseAuthorX19b9a075 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookReleasePrereleasedReleaseAuthorX19b9a075> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookReleasePrereleasedReleaseAuthorX19b9a075 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookReleasePrereleasedReleaseAuthorX19b9a075")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookReleasePrereleasedReleaseAuthorX19b9a075 must be a JSON object")
      ...
      return InlineWebhookReleasePrereleasedReleaseAuthorX19b9a075(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookReleasePrereleasedReleaseAuthorTypeX54099e6e>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookReleasePrereleasedReleaseAuthorX19b9a075) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookReleasePrereleasedReleaseAuthorX19b9a075")
...
public fun inlineWebhookReleasePrereleasedReleaseAuthorX19b9a075(block: InlineWebhookReleasePrereleasedReleaseAuthorX19b9a075.Builder.() -> Unit): InlineWebhookReleasePrereleasedReleaseAuthorX19b9a075 = InlineWebhookReleasePrereleasedReleaseAuthorX19b9a075.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookReleasePrereleasedReleaseAuthorX19b9a075 is missing required property '" + name + "'")
