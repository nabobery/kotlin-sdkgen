 ...
 * s/base/properties/repo
 */
@Serializable(with = InlineWebhookPullRequestReviewEditedPullRequestBaseRepoXec340630.Serializer::class)
public class InlineWebhookPullRequestReviewEditedPullRequestBaseRepoXec340630 internal constructor(
  /**
  ...
  public val createdAt: InlineWebhookPullRequestReviewEditedPullRequestBaseRepoCreatedAtX6d754ac6,
  /**
  ...
  public val license: InlineWebhookPullRequestReviewEditedPullRequestBaseRepoLicenseX248708bb?,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val owner: InlineWebhookPullRequestReviewEditedPullRequestBaseRepoOwnerXe6f448a3?,
  /**
  ...
  public val pushedAt: InlineWebhookPullRequestReviewEditedPullRequestBaseRepoPushedAtX8a5b87bc?,
  /**
   * Wire format: `uri-template`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val visibility: InlineWebhookPullRequestReviewEditedPullRequestBaseRepoVisibilityX8d74beb5,
  ...
  private val permissionsState:
      FieldState<InlineWebhookPullRequestReviewEditedPullRequestBaseRepoPermissionsXef53aa92>,
  ...
  public constructor(
    ...
    createdAt: InlineWebhookPullRequestReviewEditedPullRequestBaseRepoCreatedAtX6d754ac6,
    ...
    language: String?,
    languagesUrl: String,
    license: InlineWebhookPullRequestReviewEditedPullRequestBaseRepoLicenseX248708bb?,
    mergesUrl: String,
    ...
    openIssues: Int,
    openIssuesCount: Int,
    owner: InlineWebhookPullRequestReviewEditedPullRequestBaseRepoOwnerXe6f448a3?,
    `private`: Boolean,
    pullsUrl: String,
    pushedAt: InlineWebhookPullRequestReviewEditedPullRequestBaseRepoPushedAtX8a5b87bc?,
    releasesUrl: String,
    size: Int,
    sshUrl: String,
    stargazersCount: Int,
    ...
    updatedAt: String,
    url: String,
    visibility: InlineWebhookPullRequestReviewEditedPullRequestBaseRepoVisibilityX8d74beb5,
    watchers: Int,
    watchersCount: Int,
  ...
  public class Builder {
    ...
    private var createdAtValue:
        InlineWebhookPullRequestReviewEditedPullRequestBaseRepoCreatedAtX6d754ac6? = null

    public var createdAt: InlineWebhookPullRequestReviewEditedPullRequestBaseRepoCreatedAtX6d754ac6
    ...
    private var visibilityValue:
        InlineWebhookPullRequestReviewEditedPullRequestBaseRepoVisibilityX8d74beb5? = null
    ...
    private var licenseState:
        FieldState<InlineWebhookPullRequestReviewEditedPullRequestBaseRepoLicenseX248708bb?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var license: InlineWebhookPullRequestReviewEditedPullRequestBaseRepoLicenseX248708bb?
    ...
    private var ownerState:
        FieldState<InlineWebhookPullRequestReviewEditedPullRequestBaseRepoOwnerXe6f448a3?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var owner: InlineWebhookPullRequestReviewEditedPullRequestBaseRepoOwnerXe6f448a3?
    ...
    private var pushedAtState:
        FieldState<InlineWebhookPullRequestReviewEditedPullRequestBaseRepoPushedAtX8a5b87bc?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var pushedAt: InlineWebhookPullRequestReviewEditedPullRequestBaseRepoPushedAtX8a5b87bc?
    ...
    public fun build(): InlineWebhookPullRequestReviewEditedPullRequestBaseRepoXec340630 {
      ...
      return InlineWebhookPullRequestReviewEditedPullRequestBaseRepoXec340630(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewEditedPullRequestBaseRepoXec340630 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewEditedPullRequestBaseRepoXec340630> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewEditedPullRequestBaseRepoXec340630 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewEditedPullRequestBaseRepoXec340630")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewEditedPullRequestBaseRepoXec340630 must be a JSON object")
      ...
      val createdAt = json.decodeRequired<InlineWebhookPullRequestReviewEditedPullRequestBaseRepoCreatedAtX6d754ac6>(rawObject, "created_at")
      ...
      val visibility = json.decodeRequired<InlineWebhookPullRequestReviewEditedPullRequestBaseRepoVisibilityX8d74beb5>(rawObject, "visibility")
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookPullRequestReviewEditedPullRequestBaseRepoXec340630 is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("homepage")) {
        throw SerializationException("InlineWebhookPullRequestReviewEditedPullRequestBaseRepoXec340630 is missing required property 'homepage'")
      }
      ...
      if (!rawObject.containsKey("language")) {
        throw SerializationException("InlineWebhookPullRequestReviewEditedPullRequestBaseRepoXec340630 is missing required property 'language'")
      }
      ...
      if (!rawObject.containsKey("license")) {
        throw SerializationException("InlineWebhookPullRequestReviewEditedPullRequestBaseRepoXec340630 is missing required property 'license'")
      }
      val license = rawObject["license"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestReviewEditedPullRequestBaseRepoLicenseX248708bb?>(requireNotNull(element)) }
      if (!rawObject.containsKey("mirror_url")) {
        throw SerializationException("InlineWebhookPullRequestReviewEditedPullRequestBaseRepoXec340630 is missing required property 'mirror_url'")
      }
      ...
      if (!rawObject.containsKey("owner")) {
        throw SerializationException("InlineWebhookPullRequestReviewEditedPullRequestBaseRepoXec340630 is missing required property 'owner'")
      }
      val owner = rawObject["owner"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestReviewEditedPullRequestBaseRepoOwnerXe6f448a3?>(requireNotNull(element)) }
      if (!rawObject.containsKey("pushed_at")) {
        throw SerializationException("InlineWebhookPullRequestReviewEditedPullRequestBaseRepoXec340630 is missing required property 'pushed_at'")
      }
      val pushedAt = rawObject["pushed_at"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestReviewEditedPullRequestBaseRepoPushedAtX8a5b87bc?>(requireNotNull(element)) }
      return InlineWebhookPullRequestReviewEditedPullRequestBaseRepoXec340630(
        archiveUrl = archiveUrl,
        archived = archived,
        assigneesUrl = assigneesUrl,
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewEditedPullRequestBaseRepoXec340630) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewEditedPullRequestBaseRepoXec340630")
...
public fun inlineWebhookPullRequestReviewEditedPullRequestBaseRepoXec340630(block: InlineWebhookPullRequestReviewEditedPullRequestBaseRepoXec340630.Builder.() -> Unit): InlineWebhookPullRequestReviewEditedPullRequestBaseRepoXec340630 = InlineWebhookPullRequestReviewEditedPullRequestBaseRepoXec340630.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewEditedPullRequestBaseRepoXec340630 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookPullRequestReviewEditedPullRequestBaseRepoXec340630 property '" + name + "' is not nullable")
