 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhook-push/properties/head_commit/properties/author
 */
@Serializable(with = InlineWebhookPushHeadCommitAuthorXe91d0385.Serializer::class)
public class InlineWebhookPushHeadCommitAuthorXe91d0385 internal constructor(
  /**
  ...
  public class Builder {
    ...
    public fun build(): InlineWebhookPushHeadCommitAuthorXe91d0385 {
      check(nameValue != null) { "name is required" }
      check(emailState !== FieldState.Absent) { "email is required, even when null" }
      return InlineWebhookPushHeadCommitAuthorXe91d0385(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPushHeadCommitAuthorXe91d0385 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPushHeadCommitAuthorXe91d0385> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPushHeadCommitAuthorXe91d0385 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPushHeadCommitAuthorXe91d0385")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPushHeadCommitAuthorXe91d0385 must be a JSON object")
      val name = json.decodeRequired<String>(rawObject, "name")
      if (!rawObject.containsKey("email")) {
        throw SerializationException("InlineWebhookPushHeadCommitAuthorXe91d0385 is missing required property 'email'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookPushHeadCommitAuthorXe91d0385) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPushHeadCommitAuthorXe91d0385")
...
public fun inlineWebhookPushHeadCommitAuthorXe91d0385(block: InlineWebhookPushHeadCommitAuthorXe91d0385.Builder.() -> Unit): InlineWebhookPushHeadCommitAuthorXe91d0385 = InlineWebhookPushHeadCommitAuthorXe91d0385.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPushHeadCommitAuthorXe91d0385 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookPushHeadCommitAuthorXe91d0385 property '" + name + "' is not nullable")
