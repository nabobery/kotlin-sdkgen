 ...
 * ory/properties/owner.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-transferred/properties/changes/properties/new_reposit
 * ory/properties/owner
 */
@Serializable(with = InlineWebhookIssuesTransferredChangesNewRepositoryOwnerX96dc919c.Serializer::class)
public class InlineWebhookIssuesTransferredChangesNewRepositoryOwnerX96dc919c(
  public val id: Int,
  ...
  public val type: InlineWebhookIssuesTransferredChangesNewRepositoryOwnerTypeX4547cda5? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookIssuesTransferredChangesNewRepositoryOwnerTypeX4547cda5? = null
    ...
    public fun build(): InlineWebhookIssuesTransferredChangesNewRepositoryOwnerX96dc919c {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssuesTransferredChangesNewRepositoryOwnerX96dc919c(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesTransferredChangesNewRepositoryOwnerX96dc919c = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesTransferredChangesNewRepositoryOwnerX96dc919c> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesTransferredChangesNewRepositoryOwnerX96dc919c {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesTransferredChangesNewRepositoryOwnerX96dc919c")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesTransferredChangesNewRepositoryOwnerX96dc919c must be a JSON object")
      ...
      return InlineWebhookIssuesTransferredChangesNewRepositoryOwnerX96dc919c(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssuesTransferredChangesNewRepositoryOwnerTypeX4547cda5>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesTransferredChangesNewRepositoryOwnerX96dc919c) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesTransferredChangesNewRepositoryOwnerX96dc919c")
...
public fun inlineWebhookIssuesTransferredChangesNewRepositoryOwnerX96dc919c(block: InlineWebhookIssuesTransferredChangesNewRepositoryOwnerX96dc919c.Builder.() -> Unit): InlineWebhookIssuesTransferredChangesNewRepositoryOwnerX96dc919c = InlineWebhookIssuesTransferredChangesNewRepositoryOwnerX96dc919c.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesTransferredChangesNewRepositoryOwnerX96dc919c is missing required property '" + name + "'")
