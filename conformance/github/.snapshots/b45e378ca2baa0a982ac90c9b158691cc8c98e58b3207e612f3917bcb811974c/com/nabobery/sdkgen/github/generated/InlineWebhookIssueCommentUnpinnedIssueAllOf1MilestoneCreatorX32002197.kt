 ...
 * ilestone/properties/creator
 */
@Serializable(with = InlineWebhookIssueCommentUnpinnedIssueAllOf1MilestoneCreatorX32002197.Serializer::class)
public class InlineWebhookIssueCommentUnpinnedIssueAllOf1MilestoneCreatorX32002197(
  public val id: Int,
  ...
  public val type:
      InlineWebhookIssueCommentUnpinnedIssueAllOf1MilestoneCreatorTypeX51164a70? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookIssueCommentUnpinnedIssueAllOf1MilestoneCreatorTypeX51164a70? =
        null
    ...
    public fun build(): InlineWebhookIssueCommentUnpinnedIssueAllOf1MilestoneCreatorX32002197 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssueCommentUnpinnedIssueAllOf1MilestoneCreatorX32002197(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssueCommentUnpinnedIssueAllOf1MilestoneCreatorX32002197 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssueCommentUnpinnedIssueAllOf1MilestoneCreatorX32002197> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssueCommentUnpinnedIssueAllOf1MilestoneCreatorX32002197 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssueCommentUnpinnedIssueAllOf1MilestoneCreatorX32002197")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssueCommentUnpinnedIssueAllOf1MilestoneCreatorX32002197 must be a JSON object")
      ...
      return InlineWebhookIssueCommentUnpinnedIssueAllOf1MilestoneCreatorX32002197(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssueCommentUnpinnedIssueAllOf1MilestoneCreatorTypeX51164a70>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssueCommentUnpinnedIssueAllOf1MilestoneCreatorX32002197) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssueCommentUnpinnedIssueAllOf1MilestoneCreatorX32002197")
...
public fun inlineWebhookIssueCommentUnpinnedIssueAllOf1MilestoneCreatorX32002197(block: InlineWebhookIssueCommentUnpinnedIssueAllOf1MilestoneCreatorX32002197.Builder.() -> Unit): InlineWebhookIssueCommentUnpinnedIssueAllOf1MilestoneCreatorX32002197 = InlineWebhookIssueCommentUnpinnedIssueAllOf1MilestoneCreatorX32002197.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssueCommentUnpinnedIssueAllOf1MilestoneCreatorX32002197 is missing required property '" + name + "'")
