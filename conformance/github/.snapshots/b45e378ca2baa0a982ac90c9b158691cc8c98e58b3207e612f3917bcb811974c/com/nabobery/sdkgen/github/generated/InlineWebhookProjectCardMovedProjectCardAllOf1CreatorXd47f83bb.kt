 ...
 * s/creator
 */
@Serializable(with = InlineWebhookProjectCardMovedProjectCardAllOf1CreatorXd47f83bb.Serializer::class)
public class InlineWebhookProjectCardMovedProjectCardAllOf1CreatorXd47f83bb(
  public val id: Int,
  ...
  public val type: InlineWebhookProjectCardMovedProjectCardAllOf1CreatorTypeX8cbbcadd? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookProjectCardMovedProjectCardAllOf1CreatorTypeX8cbbcadd? = null
    ...
    public fun build(): InlineWebhookProjectCardMovedProjectCardAllOf1CreatorXd47f83bb {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookProjectCardMovedProjectCardAllOf1CreatorXd47f83bb(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookProjectCardMovedProjectCardAllOf1CreatorXd47f83bb = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookProjectCardMovedProjectCardAllOf1CreatorXd47f83bb> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookProjectCardMovedProjectCardAllOf1CreatorXd47f83bb {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookProjectCardMovedProjectCardAllOf1CreatorXd47f83bb")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookProjectCardMovedProjectCardAllOf1CreatorXd47f83bb must be a JSON object")
      ...
      return InlineWebhookProjectCardMovedProjectCardAllOf1CreatorXd47f83bb(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookProjectCardMovedProjectCardAllOf1CreatorTypeX8cbbcadd>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookProjectCardMovedProjectCardAllOf1CreatorXd47f83bb) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookProjectCardMovedProjectCardAllOf1CreatorXd47f83bb")
...
public fun inlineWebhookProjectCardMovedProjectCardAllOf1CreatorXd47f83bb(block: InlineWebhookProjectCardMovedProjectCardAllOf1CreatorXd47f83bb.Builder.() -> Unit): InlineWebhookProjectCardMovedProjectCardAllOf1CreatorXd47f83bb = InlineWebhookProjectCardMovedProjectCardAllOf1CreatorXd47f83bb.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookProjectCardMovedProjectCardAllOf1CreatorXd47f83bb is missing required property '" + name + "'")
