...
/**
 * The workflow job. Many `workflow_job` keys, such as `head_sha`, `conclusion`, and `started_at` are the same as those
 * in a [`check_run`](#check_run) object.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-workflow-job-in-progress/properties/workflow_job/allOf/0
 */
@Serializable(with = InlineWebhookWorkflowJobInProgressWorkflowJobAllOf1X5525bbb2.Serializer::class)
public class InlineWebhookWorkflowJobInProgressWorkflowJobAllOf1X5525bbb2(
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  public val checkRunUrl: String,
  public val completedAt: String?,
  public val conclusion: InlineWebhookWorkflowJobInProgressWorkflowJobAllOf1ConclusionXe17f02b1?,
  /**
  ...
  /**
   * The ID of the runner group that is running this job. This will be `null` as long as `workflow_job[status]` is
   * `queued`.
   */
  public val runnerGroupId: Int?,
  /**
   * The name of the runner group that is running this job. This will be `null` as long as `workflow_job[status]` is
   * `queued`.
   */
   ...
   */
  public val status: InlineWebhookWorkflowJobInProgressWorkflowJobAllOf1StatusX24eb8c3f,
  steps: List<InlineWebhookWorkflowJobInProgressWorkflowJobAllOf1StepsItemX6d9bd7d6>,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
   ...
   * attribute](https://docs.github.com/actions/reference/workflow-syntax-for-github-actions#jobsjob_idruns-on) in the
   * workflow YAML.
   */
  public val labels: List<String> = labels.toList()

  public val steps: List<InlineWebhookWorkflowJobInProgressWorkflowJobAllOf1StepsItemX6d9bd7d6> =
      steps.toList()
  ...
  public class Builder {
    ...
    private var statusValue: InlineWebhookWorkflowJobInProgressWorkflowJobAllOf1StatusX24eb8c3f? =
        null

    public var status: InlineWebhookWorkflowJobInProgressWorkflowJobAllOf1StatusX24eb8c3f
    ...
    private var stepsValue:
        List<InlineWebhookWorkflowJobInProgressWorkflowJobAllOf1StepsItemX6d9bd7d6>? = null

    public var steps: List<InlineWebhookWorkflowJobInProgressWorkflowJobAllOf1StepsItemX6d9bd7d6>
    ...
    private var conclusionState:
        FieldState<InlineWebhookWorkflowJobInProgressWorkflowJobAllOf1ConclusionXe17f02b1?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var conclusion: InlineWebhookWorkflowJobInProgressWorkflowJobAllOf1ConclusionXe17f02b1?
    ...
    public fun build(): InlineWebhookWorkflowJobInProgressWorkflowJobAllOf1X5525bbb2 {
      ...
      return InlineWebhookWorkflowJobInProgressWorkflowJobAllOf1X5525bbb2(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookWorkflowJobInProgressWorkflowJobAllOf1X5525bbb2 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookWorkflowJobInProgressWorkflowJobAllOf1X5525bbb2> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookWorkflowJobInProgressWorkflowJobAllOf1X5525bbb2 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookWorkflowJobInProgressWorkflowJobAllOf1X5525bbb2")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookWorkflowJobInProgressWorkflowJobAllOf1X5525bbb2 must be a JSON object")
      ...
      val status = json.decodeRequired<InlineWebhookWorkflowJobInProgressWorkflowJobAllOf1StatusX24eb8c3f>(rawObject, "status")
      val steps = json.decodeRequired<List<InlineWebhookWorkflowJobInProgressWorkflowJobAllOf1StepsItemX6d9bd7d6>>(rawObject, "steps")
      val url = json.decodeRequired<String>(rawObject, "url")
      if (!rawObject.containsKey("completed_at")) {
        throw SerializationException("InlineWebhookWorkflowJobInProgressWorkflowJobAllOf1X5525bbb2 is missing required property 'completed_at'")
      }
      ...
      if (!rawObject.containsKey("conclusion")) {
        throw SerializationException("InlineWebhookWorkflowJobInProgressWorkflowJobAllOf1X5525bbb2 is missing required property 'conclusion'")
      }
      val conclusion = rawObject["conclusion"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookWorkflowJobInProgressWorkflowJobAllOf1ConclusionXe17f02b1?>(requireNotNull(element)) }
      if (!rawObject.containsKey("head_branch")) {
        throw SerializationException("InlineWebhookWorkflowJobInProgressWorkflowJobAllOf1X5525bbb2 is missing required property 'head_branch'")
      }
      ...
      if (!rawObject.containsKey("runner_group_id")) {
        throw SerializationException("InlineWebhookWorkflowJobInProgressWorkflowJobAllOf1X5525bbb2 is missing required property 'runner_group_id'")
      }
      ...
      if (!rawObject.containsKey("runner_group_name")) {
        throw SerializationException("InlineWebhookWorkflowJobInProgressWorkflowJobAllOf1X5525bbb2 is missing required property 'runner_group_name'")
      }
      ...
      if (!rawObject.containsKey("runner_id")) {
        throw SerializationException("InlineWebhookWorkflowJobInProgressWorkflowJobAllOf1X5525bbb2 is missing required property 'runner_id'")
      }
      ...
      if (!rawObject.containsKey("runner_name")) {
        throw SerializationException("InlineWebhookWorkflowJobInProgressWorkflowJobAllOf1X5525bbb2 is missing required property 'runner_name'")
      }
      ...
      if (!rawObject.containsKey("workflow_name")) {
        throw SerializationException("InlineWebhookWorkflowJobInProgressWorkflowJobAllOf1X5525bbb2 is missing required property 'workflow_name'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookWorkflowJobInProgressWorkflowJobAllOf1X5525bbb2) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookWorkflowJobInProgressWorkflowJobAllOf1X5525bbb2")
...
public fun inlineWebhookWorkflowJobInProgressWorkflowJobAllOf1X5525bbb2(block: InlineWebhookWorkflowJobInProgressWorkflowJobAllOf1X5525bbb2.Builder.() -> Unit): InlineWebhookWorkflowJobInProgressWorkflowJobAllOf1X5525bbb2 = InlineWebhookWorkflowJobInProgressWorkflowJobAllOf1X5525bbb2.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookWorkflowJobInProgressWorkflowJobAllOf1X5525bbb2 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookWorkflowJobInProgressWorkflowJobAllOf1X5525bbb2 property '" + name + "' is not nullable")
