 ...
 * estone
 */
@Serializable(with = InlineWebhookPullRequestDequeuedPullRequestMilestoneX3d594285.Serializer::class)
public class InlineWebhookPullRequestDequeuedPullRequestMilestoneX3d594285(
  /**
  ...
  public val creator: InlineWebhookPullRequestDequeuedPullRequestMilestoneCreatorX2cc1afea?,
   ...
   */
  public val state: InlineWebhookPullRequestDequeuedPullRequestMilestoneStateX87d5abe9,
  /**
  ...
  public class Builder {
    ...
    private var stateValue: InlineWebhookPullRequestDequeuedPullRequestMilestoneStateX87d5abe9? =
        null

    public var state: InlineWebhookPullRequestDequeuedPullRequestMilestoneStateX87d5abe9
    ...
    private var creatorState:
        FieldState<InlineWebhookPullRequestDequeuedPullRequestMilestoneCreatorX2cc1afea?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var creator: InlineWebhookPullRequestDequeuedPullRequestMilestoneCreatorX2cc1afea?
    ...
    public fun build(): InlineWebhookPullRequestDequeuedPullRequestMilestoneX3d594285 {
      ...
      return InlineWebhookPullRequestDequeuedPullRequestMilestoneX3d594285(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestDequeuedPullRequestMilestoneX3d594285 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestDequeuedPullRequestMilestoneX3d594285> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestDequeuedPullRequestMilestoneX3d594285 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestDequeuedPullRequestMilestoneX3d594285")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestDequeuedPullRequestMilestoneX3d594285 must be a JSON object")
      ...
      val state = json.decodeRequired<InlineWebhookPullRequestDequeuedPullRequestMilestoneStateX87d5abe9>(rawObject, "state")
      val title = json.decodeRequired<String>(rawObject, "title")
      val updatedAt = json.decodeRequired<String>(rawObject, "updated_at")
      val url = json.decodeRequired<String>(rawObject, "url")
      if (!rawObject.containsKey("closed_at")) {
        throw SerializationException("InlineWebhookPullRequestDequeuedPullRequestMilestoneX3d594285 is missing required property 'closed_at'")
      }
      ...
      if (!rawObject.containsKey("creator")) {
        throw SerializationException("InlineWebhookPullRequestDequeuedPullRequestMilestoneX3d594285 is missing required property 'creator'")
      }
      val creator = rawObject["creator"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestDequeuedPullRequestMilestoneCreatorX2cc1afea?>(requireNotNull(element)) }
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookPullRequestDequeuedPullRequestMilestoneX3d594285 is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("due_on")) {
        throw SerializationException("InlineWebhookPullRequestDequeuedPullRequestMilestoneX3d594285 is missing required property 'due_on'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestDequeuedPullRequestMilestoneX3d594285) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestDequeuedPullRequestMilestoneX3d594285")
...
public fun inlineWebhookPullRequestDequeuedPullRequestMilestoneX3d594285(block: InlineWebhookPullRequestDequeuedPullRequestMilestoneX3d594285.Builder.() -> Unit): InlineWebhookPullRequestDequeuedPullRequestMilestoneX3d594285 = InlineWebhookPullRequestDequeuedPullRequestMilestoneX3d594285.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestDequeuedPullRequestMilestoneX3d594285 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookPullRequestDequeuedPullRequestMilestoneX3d594285 property '" + name + "' is not nullable")
