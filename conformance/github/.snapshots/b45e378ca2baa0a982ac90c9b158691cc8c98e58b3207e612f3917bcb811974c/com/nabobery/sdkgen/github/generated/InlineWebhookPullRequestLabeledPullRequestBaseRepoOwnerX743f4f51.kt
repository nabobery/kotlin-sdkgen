 ...
 * /properties/repo/properties/owner
 */
@Serializable(with = InlineWebhookPullRequestLabeledPullRequestBaseRepoOwnerX743f4f51.Serializer::class)
public class InlineWebhookPullRequestLabeledPullRequestBaseRepoOwnerX743f4f51(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestLabeledPullRequestBaseRepoOwnerTypeXb641941b? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestLabeledPullRequestBaseRepoOwnerTypeXb641941b? = null
    ...
    public fun build(): InlineWebhookPullRequestLabeledPullRequestBaseRepoOwnerX743f4f51 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestLabeledPullRequestBaseRepoOwnerX743f4f51(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestLabeledPullRequestBaseRepoOwnerX743f4f51 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestLabeledPullRequestBaseRepoOwnerX743f4f51> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestLabeledPullRequestBaseRepoOwnerX743f4f51 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestLabeledPullRequestBaseRepoOwnerX743f4f51")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestLabeledPullRequestBaseRepoOwnerX743f4f51 must be a JSON object")
      ...
      return InlineWebhookPullRequestLabeledPullRequestBaseRepoOwnerX743f4f51(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestLabeledPullRequestBaseRepoOwnerTypeXb641941b>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestLabeledPullRequestBaseRepoOwnerX743f4f51) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestLabeledPullRequestBaseRepoOwnerX743f4f51")
...
public fun inlineWebhookPullRequestLabeledPullRequestBaseRepoOwnerX743f4f51(block: InlineWebhookPullRequestLabeledPullRequestBaseRepoOwnerX743f4f51.Builder.() -> Unit): InlineWebhookPullRequestLabeledPullRequestBaseRepoOwnerX743f4f51 = InlineWebhookPullRequestLabeledPullRequestBaseRepoOwnerX743f4f51.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestLabeledPullRequestBaseRepoOwnerX743f4f51 is missing required property '" + name + "'")
