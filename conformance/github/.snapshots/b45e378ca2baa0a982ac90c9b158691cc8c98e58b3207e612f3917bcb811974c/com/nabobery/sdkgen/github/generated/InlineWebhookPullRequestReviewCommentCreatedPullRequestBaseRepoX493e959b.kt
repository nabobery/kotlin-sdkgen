 ...
 * properties/base/properties/repo
 */
@Serializable(with = InlineWebhookPullRequestReviewCommentCreatedPullRequestBaseRepoX493e959b.Serializer::class)
public class InlineWebhookPullRequestReviewCommentCreatedPullRequestBaseRepoX493e959b internal constructor(
  /**
  ...
  public val createdAt: InlineWebhookPullRequestRe0d91PullRequestBaseRepoCreatedAtX2ad58faf,
  /**
  ...
  public val license:
      InlineWebhookPullRequestReviewCommentCreatedPullRequestBaseRepoLicenseX0d2883d7?,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val owner: InlineWebhookPullRequestReviewCommentCreatedPullRequestBaseRepoOwnerX41ac276b?,
  /**
  ...
  public val pushedAt:
      InlineWebhookPullRequestReviewCommentCreatedPullRequestBaseRepoPushedAtX3ca2e93a?,
  /**
   * Wire format: `uri-template`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val visibility: InlineWebhookPullRequestRe0d91PullRequestBaseRepoVisibilityX0d7a9d8b,
  ...
  private val mergeCommitMessageState:
      FieldState<InlineWebhookPullRequestRe0d91PullRequestBaseRepoMergeCommitMessageXa7d817ca>,
  private val mergeCommitTitleState:
      FieldState<InlineWebhookPullRequestRe0d91PullRequestBaseRepoMergeCommitTitleX17058b5c>,
  private val organizationState: FieldState<String>,
  private val permissionsState:
      FieldState<InlineWebhookPullRequestRe0d91PullRequestBaseRepoPermissionsX71289767>,
  private val publicState: FieldState<Boolean>,
  private val pullRequestCreationPolicyState:
      FieldState<InlineWebhookPullRequestRe0d91PullRequestBasePullRequestCreationP824dX38a7a261>,
  private val roleNameState: FieldState<String?>,
  private val squashMergeCommitMessageState:
      FieldState<InlineWebhookPullRequestRe0d91PullRequestBaseSquashMergeCommitMessageX3e870c6c>,
  private val squashMergeCommitTitleState:
      FieldState<InlineWebhookPullRequestRe0d91PullRequestBaseRepoSquashMergeCommitTitleX6e3c1300>,
  ...
  public val mergeCommitTitle:
      InlineWebhookPullRequestRe0d91PullRequestBaseRepoMergeCommitTitleX17058b5c?
    get() = mergeCommitTitleState.valueOrNull()

  public val organization: String?
    get() = organizationState.valueOrNull()

  public val permissions: InlineWebhookPullRequestRe0d91PullRequestBaseRepoPermissionsX71289767?
  ...
  public constructor(
    ...
    createdAt: InlineWebhookPullRequestRe0d91PullRequestBaseRepoCreatedAtX2ad58faf,
    ...
    language: String?,
    languagesUrl: String,
    license: InlineWebhookPullRequestReviewCommentCreatedPullRequestBaseRepoLicenseX0d2883d7?,
    mergesUrl: String,
    ...
    openIssues: Int,
    openIssuesCount: Int,
    owner: InlineWebhookPullRequestReviewCommentCreatedPullRequestBaseRepoOwnerX41ac276b?,
    `private`: Boolean,
    pullsUrl: String,
    pushedAt: InlineWebhookPullRequestReviewCommentCreatedPullRequestBaseRepoPushedAtX3ca2e93a?,
    releasesUrl: String,
    size: Int,
    sshUrl: String,
    stargazersCount: Int,
    ...
    updatedAt: String,
    url: String,
    visibility: InlineWebhookPullRequestRe0d91PullRequestBaseRepoVisibilityX0d7a9d8b,
    watchers: Int,
    watchersCount: Int,
  ...
  public class Builder {
    ...
    private var createdAtValue: InlineWebhookPullRequestRe0d91PullRequestBaseRepoCreatedAtX2ad58faf?
        = null

    public var createdAt: InlineWebhookPullRequestRe0d91PullRequestBaseRepoCreatedAtX2ad58faf
    ...
    private var visibilityValue:
        InlineWebhookPullRequestRe0d91PullRequestBaseRepoVisibilityX0d7a9d8b? = null

    public var visibility: InlineWebhookPullRequestRe0d91PullRequestBaseRepoVisibilityX0d7a9d8b
    ...
    private var licenseState:
        FieldState<InlineWebhookPullRequestReviewCommentCreatedPullRequestBaseRepoLicenseX0d2883d7?>
        = FieldState.Absent
    ...
    private var ownerState:
        FieldState<InlineWebhookPullRequestReviewCommentCreatedPullRequestBaseRepoOwnerX41ac276b?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var owner: InlineWebhookPullRequestReviewCommentCreatedPullRequestBaseRepoOwnerX41ac276b?
    ...
    private var pushedAtState:
        FieldState<InlineWebhookPullRequestReviewCommentCreatedPullRequestBaseRepoPushedAtX3ca2e93a?>
        = FieldState.Absent
     ...
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var permissions: InlineWebhookPullRequestRe0d91PullRequestBaseRepoPermissionsX71289767?
      get() = permissionsState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): InlineWebhookPullRequestReviewCommentCreatedPullRequestBaseRepoX493e959b {
      ...
      return InlineWebhookPullRequestReviewCommentCreatedPullRequestBaseRepoX493e959b(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewCommentCreatedPullRequestBaseRepoX493e959b = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewCommentCreatedPullRequestBaseRepoX493e959b> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewCommentCreatedPullRequestBaseRepoX493e959b {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewCommentCreatedPullRequestBaseRepoX493e959b")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewCommentCreatedPullRequestBaseRepoX493e959b must be a JSON object")
      ...
      val createdAt = json.decodeRequired<InlineWebhookPullRequestRe0d91PullRequestBaseRepoCreatedAtX2ad58faf>(rawObject, "created_at")
      ...
      val visibility = json.decodeRequired<InlineWebhookPullRequestRe0d91PullRequestBaseRepoVisibilityX0d7a9d8b>(rawObject, "visibility")
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookPullRequestReviewCommentCreatedPullRequestBaseRepoX493e959b is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("homepage")) {
        throw SerializationException("InlineWebhookPullRequestReviewCommentCreatedPullRequestBaseRepoX493e959b is missing required property 'homepage'")
      }
      ...
      if (!rawObject.containsKey("language")) {
        throw SerializationException("InlineWebhookPullRequestReviewCommentCreatedPullRequestBaseRepoX493e959b is missing required property 'language'")
      }
      ...
      if (!rawObject.containsKey("license")) {
        throw SerializationException("InlineWebhookPullRequestReviewCommentCreatedPullRequestBaseRepoX493e959b is missing required property 'license'")
      }
      val license = rawObject["license"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestReviewCommentCreatedPullRequestBaseRepoLicenseX0d2883d7?>(requireNotNull(element)) }
      if (!rawObject.containsKey("mirror_url")) {
        throw SerializationException("InlineWebhookPullRequestReviewCommentCreatedPullRequestBaseRepoX493e959b is missing required property 'mirror_url'")
      }
      ...
      if (!rawObject.containsKey("owner")) {
        throw SerializationException("InlineWebhookPullRequestReviewCommentCreatedPullRequestBaseRepoX493e959b is missing required property 'owner'")
      }
      val owner = rawObject["owner"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestReviewCommentCreatedPullRequestBaseRepoOwnerX41ac276b?>(requireNotNull(element)) }
      if (!rawObject.containsKey("pushed_at")) {
        throw SerializationException("InlineWebhookPullRequestReviewCommentCreatedPullRequestBaseRepoX493e959b is missing required property 'pushed_at'")
      }
      val pushedAt = rawObject["pushed_at"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestReviewCommentCreatedPullRequestBaseRepoPushedAtX3ca2e93a?>(requireNotNull(element)) }
      return InlineWebhookPullRequestReviewCommentCreatedPullRequestBaseRepoX493e959b(
        archiveUrl = archiveUrl,
        archived = archived,
        assigneesUrl = assigneesUrl,
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewCommentCreatedPullRequestBaseRepoX493e959b) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewCommentCreatedPullRequestBaseRepoX493e959b")
...
public fun inlineWebhookPullRequestReviewCommentCreatedPullRequestBaseRepoX493e959b(block: InlineWebhookPullRequestReviewCommentCreatedPullRequestBaseRepoX493e959b.Builder.() -> Unit): InlineWebhookPullRequestReviewCommentCreatedPullRequestBaseRepoX493e959b = InlineWebhookPullRequestReviewCommentCreatedPullRequestBaseRepoX493e959b.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewCommentCreatedPullRequestBaseRepoX493e959b is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookPullRequestReviewCommentCreatedPullRequestBaseRepoX493e959b property '" + name + "' is not nullable")
