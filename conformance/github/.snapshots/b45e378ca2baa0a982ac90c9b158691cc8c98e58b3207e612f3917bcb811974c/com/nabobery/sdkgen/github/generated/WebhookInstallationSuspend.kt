...
/**
 * Generated model for sdkgen://source/openapi.yaml#/components/schemas/webhook-installation-suspend.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhook-installation-suspend
 */
@Serializable(with = WebhookInstallationSuspend.Serializer::class)
public class WebhookInstallationSuspend(
  public val action: InlineWebhookInstallationSuspendActionX4f88994a,
  ...
  public class Builder {
    private var actionValue: InlineWebhookInstallationSuspendActionX4f88994a? = null

    public var action: InlineWebhookInstallationSuspendActionX4f88994a
    ...
    public fun build(): WebhookInstallationSuspend {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): WebhookInstallationSuspend = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<WebhookInstallationSuspend> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): WebhookInstallationSuspend {
      val jsonDecoder = decoder.requireJsonDecoder("WebhookInstallationSuspend")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("WebhookInstallationSuspend must be a JSON object")
      val action = json.decodeRequired<InlineWebhookInstallationSuspendActionX4f88994a>(rawObject, "action")
    ...
    override fun serialize(encoder: Encoder, `value`: WebhookInstallationSuspend) {
      val jsonEncoder = encoder.requireJsonEncoder("WebhookInstallationSuspend")
...
public fun webhookInstallationSuspend(block: WebhookInstallationSuspend.Builder.() -> Unit): WebhookInstallationSuspend = WebhookInstallationSuspend.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("WebhookInstallationSuspend is missing required property '" + name + "'")
