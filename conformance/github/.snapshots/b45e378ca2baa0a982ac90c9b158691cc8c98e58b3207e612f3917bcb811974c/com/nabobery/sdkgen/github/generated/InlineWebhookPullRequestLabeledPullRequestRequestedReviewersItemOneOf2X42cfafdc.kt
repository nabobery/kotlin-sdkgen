 ...
 */
@Serializable(with = InlineWebhookPullRequestLabeledPullRequestRequestedReviewersItemOneOf2X42cfafdc.Serializer::class)
public class InlineWebhookPullRequestLabeledPullRequestRequestedReviewersItemOneOf2X42cfafdc internal constructor(
  ...
  private val parentState:
      FieldState<InlineWebhookPullRequestLa835fPullRequestRequestedReviewersItemParentXcfed7b16?>,
) {
  public val deleted: Boolean?
    get() = deletedState.valueOrNull()

  public val parent: InlineWebhookPullRequestLa835fPullRequestRequestedReviewersItemParentXcfed7b16?
  ...
  public class Builder {
    ...
    private var privacyValue:
        InlineWebhookPullRequestLa835fPullRequestRequestedReviewersItemPrivacyXb101e282? = null
     ...
     */
    public var parent:
        InlineWebhookPullRequestLa835fPullRequestRequestedReviewersItemParentXcfed7b16?
      get() = parentState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): InlineWebhookPullRequestLabeledPullRequestRequestedReviewersItemOneOf2X42cfafdc {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestLabeledPullRequestRequestedReviewersItemOneOf2X42cfafdc = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestLabeledPullRequestRequestedReviewersItemOneOf2X42cfafdc> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestLabeledPullRequestRequestedReviewersItemOneOf2X42cfafdc {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestLabeledPullRequestRequestedReviewersItemOneOf2X42cfafdc")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestLabeledPullRequestRequestedReviewersItemOneOf2X42cfafdc must be a JSON object")
      ...
      val privacy = json.decodeRequired<InlineWebhookPullRequestLa835fPullRequestRequestedReviewersItemPrivacyXb101e282>(rawObject, "privacy")
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookPullRequestLabeledPullRequestRequestedReviewersItemOneOf2X42cfafdc is missing required property 'description'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestLabeledPullRequestRequestedReviewersItemOneOf2X42cfafdc) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestLabeledPullRequestRequestedReviewersItemOneOf2X42cfafdc")
...
public fun inlineWebhookPullRequestLabeledPullRequestRequestedReviewersItemOneOf2X42cfafdc(block: InlineWebhookPullRequestLabeledPullRequestRequestedReviewersItemOneOf2X42cfafdc.Builder.() -> Unit): InlineWebhookPullRequestLabeledPullRequestRequestedReviewersItemOneOf2X42cfafdc = InlineWebhookPullRequestLabeledPullRequestRequestedReviewersItemOneOf2X42cfafdc.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestLabeledPullRequestRequestedReviewersItemOneOf2X42cfafdc is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookPullRequestLabeledPullRequestRequestedReviewersItemOneOf2X42cfafdc property '" + name + "' is not nullable")
