...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-labeled/properties/issue/properties/user.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-labeled/properties/issue/properties/user
 */
@Serializable(with = InlineWebhookIssuesLabeledIssueUserX5187f2e0.Serializer::class)
public class InlineWebhookIssuesLabeledIssueUserX5187f2e0(
  public val id: Long,
  ...
  public val type: InlineWebhookIssuesLabeledIssueUserTypeX87038989? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookIssuesLabeledIssueUserTypeX87038989? = null
    ...
    public fun build(): InlineWebhookIssuesLabeledIssueUserX5187f2e0 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssuesLabeledIssueUserX5187f2e0(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesLabeledIssueUserX5187f2e0 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesLabeledIssueUserX5187f2e0> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesLabeledIssueUserX5187f2e0 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesLabeledIssueUserX5187f2e0")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesLabeledIssueUserX5187f2e0 must be a JSON object")
      ...
      return InlineWebhookIssuesLabeledIssueUserX5187f2e0(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssuesLabeledIssueUserTypeX87038989>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesLabeledIssueUserX5187f2e0) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesLabeledIssueUserX5187f2e0")
...
public fun inlineWebhookIssuesLabeledIssueUserX5187f2e0(block: InlineWebhookIssuesLabeledIssueUserX5187f2e0.Builder.() -> Unit): InlineWebhookIssuesLabeledIssueUserX5187f2e0 = InlineWebhookIssuesLabeledIssueUserX5187f2e0.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesLabeledIssueUserX5187f2e0 is missing required property '" + name + "'")
