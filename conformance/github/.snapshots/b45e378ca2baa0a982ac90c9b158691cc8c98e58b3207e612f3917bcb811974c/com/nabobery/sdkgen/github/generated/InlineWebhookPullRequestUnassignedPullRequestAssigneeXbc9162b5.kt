 ...
 * ssignee
 */
@Serializable(with = InlineWebhookPullRequestUnassignedPullRequestAssigneeXbc9162b5.Serializer::class)
public class InlineWebhookPullRequestUnassignedPullRequestAssigneeXbc9162b5(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestUnassignedPullRequestAssigneeTypeX348a6d5c? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestUnassignedPullRequestAssigneeTypeX348a6d5c? = null
    ...
    public fun build(): InlineWebhookPullRequestUnassignedPullRequestAssigneeXbc9162b5 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestUnassignedPullRequestAssigneeXbc9162b5(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestUnassignedPullRequestAssigneeXbc9162b5 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestUnassignedPullRequestAssigneeXbc9162b5> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestUnassignedPullRequestAssigneeXbc9162b5 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestUnassignedPullRequestAssigneeXbc9162b5")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestUnassignedPullRequestAssigneeXbc9162b5 must be a JSON object")
      ...
      return InlineWebhookPullRequestUnassignedPullRequestAssigneeXbc9162b5(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestUnassignedPullRequestAssigneeTypeX348a6d5c>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestUnassignedPullRequestAssigneeXbc9162b5) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestUnassignedPullRequestAssigneeXbc9162b5")
...
public fun inlineWebhookPullRequestUnassignedPullRequestAssigneeXbc9162b5(block: InlineWebhookPullRequestUnassignedPullRequestAssigneeXbc9162b5.Builder.() -> Unit): InlineWebhookPullRequestUnassignedPullRequestAssigneeXbc9162b5 = InlineWebhookPullRequestUnassignedPullRequestAssigneeXbc9162b5.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestUnassignedPullRequestAssigneeXbc9162b5 is missing required property '" + name + "'")
