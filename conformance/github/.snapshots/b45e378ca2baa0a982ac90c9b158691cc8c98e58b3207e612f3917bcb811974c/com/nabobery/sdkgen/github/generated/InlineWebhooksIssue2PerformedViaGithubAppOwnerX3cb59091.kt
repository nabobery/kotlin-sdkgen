 ...
 * r
 */
@Serializable(with = InlineWebhooksIssue2PerformedViaGithubAppOwnerX3cb59091.Serializer::class)
public class InlineWebhooksIssue2PerformedViaGithubAppOwnerX3cb59091(
  public val id: Int,
  ...
  public val type: InlineWebhooksIssue2PerformedViaGithubAppOwnerTypeX2131a572? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhooksIssue2PerformedViaGithubAppOwnerTypeX2131a572? = null
    ...
    public fun build(): InlineWebhooksIssue2PerformedViaGithubAppOwnerX3cb59091 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhooksIssue2PerformedViaGithubAppOwnerX3cb59091(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhooksIssue2PerformedViaGithubAppOwnerX3cb59091 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhooksIssue2PerformedViaGithubAppOwnerX3cb59091> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhooksIssue2PerformedViaGithubAppOwnerX3cb59091 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhooksIssue2PerformedViaGithubAppOwnerX3cb59091")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhooksIssue2PerformedViaGithubAppOwnerX3cb59091 must be a JSON object")
      ...
      return InlineWebhooksIssue2PerformedViaGithubAppOwnerX3cb59091(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhooksIssue2PerformedViaGithubAppOwnerTypeX2131a572>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhooksIssue2PerformedViaGithubAppOwnerX3cb59091) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhooksIssue2PerformedViaGithubAppOwnerX3cb59091")
...
public fun inlineWebhooksIssue2PerformedViaGithubAppOwnerX3cb59091(block: InlineWebhooksIssue2PerformedViaGithubAppOwnerX3cb59091.Builder.() -> Unit): InlineWebhooksIssue2PerformedViaGithubAppOwnerX3cb59091 = InlineWebhooksIssue2PerformedViaGithubAppOwnerX3cb59091.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhooksIssue2PerformedViaGithubAppOwnerX3cb59091 is missing required property '" + name + "'")
