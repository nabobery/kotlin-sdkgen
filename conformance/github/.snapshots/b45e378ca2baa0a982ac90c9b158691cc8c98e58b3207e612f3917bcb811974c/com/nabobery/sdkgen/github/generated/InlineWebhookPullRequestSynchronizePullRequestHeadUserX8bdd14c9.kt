 ...
 * head/properties/user.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-synchronize/properties/pull_request/properties/
 * head/properties/user
 */
@Serializable(with = InlineWebhookPullRequestSynchronizePullRequestHeadUserX8bdd14c9.Serializer::class)
public class InlineWebhookPullRequestSynchronizePullRequestHeadUserX8bdd14c9(
  public val id: Long,
  ...
  public val type: InlineWebhookPullRequestSynchronizePullRequestHeadUserTypeXec8cea3c? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestSynchronizePullRequestHeadUserTypeXec8cea3c? = null
    ...
    public fun build(): InlineWebhookPullRequestSynchronizePullRequestHeadUserX8bdd14c9 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestSynchronizePullRequestHeadUserX8bdd14c9(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestSynchronizePullRequestHeadUserX8bdd14c9 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestSynchronizePullRequestHeadUserX8bdd14c9> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestSynchronizePullRequestHeadUserX8bdd14c9 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestSynchronizePullRequestHeadUserX8bdd14c9")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestSynchronizePullRequestHeadUserX8bdd14c9 must be a JSON object")
      ...
      return InlineWebhookPullRequestSynchronizePullRequestHeadUserX8bdd14c9(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestSynchronizePullRequestHeadUserTypeXec8cea3c>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestSynchronizePullRequestHeadUserX8bdd14c9) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestSynchronizePullRequestHeadUserX8bdd14c9")
...
public fun inlineWebhookPullRequestSynchronizePullRequestHeadUserX8bdd14c9(block: InlineWebhookPullRequestSynchronizePullRequestHeadUserX8bdd14c9.Builder.() -> Unit): InlineWebhookPullRequestSynchronizePullRequestHeadUserX8bdd14c9 = InlineWebhookPullRequestSynchronizePullRequestHeadUserX8bdd14c9.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestSynchronizePullRequestHeadUserX8bdd14c9 is missing required property '" + name + "'")
