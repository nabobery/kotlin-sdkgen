 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhooks_pull_request_5/properties/milestone
 */
@Serializable(with = InlineWebhooksPullRequest5MilestoneX9b9e4dbe.Serializer::class)
public class InlineWebhooksPullRequest5MilestoneX9b9e4dbe(
  /**
  ...
  public val creator: InlineWebhooksPullRequest5MilestoneCreatorXf3c28fdf?,
   ...
   */
  public val state: InlineWebhooksPullRequest5MilestoneStateX991cc88e,
  /**
  ...
  public class Builder {
    ...
    private var stateValue: InlineWebhooksPullRequest5MilestoneStateX991cc88e? = null

    public var state: InlineWebhooksPullRequest5MilestoneStateX991cc88e
    ...
    private var creatorState: FieldState<InlineWebhooksPullRequest5MilestoneCreatorXf3c28fdf?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var creator: InlineWebhooksPullRequest5MilestoneCreatorXf3c28fdf?
    ...
    public fun build(): InlineWebhooksPullRequest5MilestoneX9b9e4dbe {
      ...
      return InlineWebhooksPullRequest5MilestoneX9b9e4dbe(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhooksPullRequest5MilestoneX9b9e4dbe = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhooksPullRequest5MilestoneX9b9e4dbe> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhooksPullRequest5MilestoneX9b9e4dbe {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhooksPullRequest5MilestoneX9b9e4dbe")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhooksPullRequest5MilestoneX9b9e4dbe must be a JSON object")
      ...
      val state = json.decodeRequired<InlineWebhooksPullRequest5MilestoneStateX991cc88e>(rawObject, "state")
      val title = json.decodeRequired<String>(rawObject, "title")
      val updatedAt = json.decodeRequired<String>(rawObject, "updated_at")
      val url = json.decodeRequired<String>(rawObject, "url")
      if (!rawObject.containsKey("closed_at")) {
        throw SerializationException("InlineWebhooksPullRequest5MilestoneX9b9e4dbe is missing required property 'closed_at'")
      }
      ...
      if (!rawObject.containsKey("creator")) {
        throw SerializationException("InlineWebhooksPullRequest5MilestoneX9b9e4dbe is missing required property 'creator'")
      }
      val creator = rawObject["creator"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhooksPullRequest5MilestoneCreatorXf3c28fdf?>(requireNotNull(element)) }
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhooksPullRequest5MilestoneX9b9e4dbe is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("due_on")) {
        throw SerializationException("InlineWebhooksPullRequest5MilestoneX9b9e4dbe is missing required property 'due_on'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhooksPullRequest5MilestoneX9b9e4dbe) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhooksPullRequest5MilestoneX9b9e4dbe")
...
public fun inlineWebhooksPullRequest5MilestoneX9b9e4dbe(block: InlineWebhooksPullRequest5MilestoneX9b9e4dbe.Builder.() -> Unit): InlineWebhooksPullRequest5MilestoneX9b9e4dbe = InlineWebhooksPullRequest5MilestoneX9b9e4dbe.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhooksPullRequest5MilestoneX9b9e4dbe is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhooksPullRequest5MilestoneX9b9e4dbe property '" + name + "' is not nullable")
