...
public class InlineWebhookWorkflowJobCompletedWorkflowJobAllOf2X26069deb(
  ...
  public val steps: List<JsonObject?>? = steps?.let { collection0 -> collection0.toList() }
  ...
  public class Builder {
    ...
    private var stepsValue: List<JsonObject?>? = null

    public var steps: List<JsonObject?>?
      get() = stepsValue?.let { collection0 -> collection0.toList() }
      set(`value`) {
        stepsValue = value?.let { collection0 -> collection0.toList() }
      }
  ...
  internal object Serializer : KSerializer<InlineWebhookWorkflowJobCompletedWorkflowJobAllOf2X26069deb> {
