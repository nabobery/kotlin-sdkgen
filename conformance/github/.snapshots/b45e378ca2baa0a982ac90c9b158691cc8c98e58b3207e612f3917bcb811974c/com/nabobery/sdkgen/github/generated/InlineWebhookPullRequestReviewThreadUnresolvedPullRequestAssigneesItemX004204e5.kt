 ...
 * t/properties/assignees/items.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-review-thread-unresolved/properties/pull_reques
 * t/properties/assignees/items
 */
@Serializable(with = InlineWebhookPullRequestReviewThreadUnresolvedPullRequestAssigneesItemX004204e5.Serializer::class)
public class InlineWebhookPullRequestReviewThreadUnresolvedPullRequestAssigneesItemX004204e5(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestRe5e87PullRequestAssigneesItemTypeXb6604fcc? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestRe5e87PullRequestAssigneesItemTypeXb6604fcc? = null
    ...
    public fun build(): InlineWebhookPullRequestReviewThreadUnresolvedPullRequestAssigneesItemX004204e5 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestReviewThreadUnresolvedPullRequestAssigneesItemX004204e5(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewThreadUnresolvedPullRequestAssigneesItemX004204e5 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewThreadUnresolvedPullRequestAssigneesItemX004204e5> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewThreadUnresolvedPullRequestAssigneesItemX004204e5 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewThreadUnresolvedPullRequestAssigneesItemX004204e5")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewThreadUnresolvedPullRequestAssigneesItemX004204e5 must be a JSON object")
      ...
      return InlineWebhookPullRequestReviewThreadUnresolvedPullRequestAssigneesItemX004204e5(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestRe5e87PullRequestAssigneesItemTypeXb6604fcc>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewThreadUnresolvedPullRequestAssigneesItemX004204e5) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewThreadUnresolvedPullRequestAssigneesItemX004204e5")
...
public fun inlineWebhookPullRequestReviewThreadUnresolvedPullRequestAssigneesItemX004204e5(block: InlineWebhookPullRequestReviewThreadUnresolvedPullRequestAssigneesItemX004204e5.Builder.() -> Unit): InlineWebhookPullRequestReviewThreadUnresolvedPullRequestAssigneesItemX004204e5 = InlineWebhookPullRequestReviewThreadUnresolvedPullRequestAssigneesItemX004204e5.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewThreadUnresolvedPullRequestAssigneesItemX004204e5 is missing required property '" + name + "'")
