 ...
 * ties/assignees/items
 */
@Serializable(with = InlineWebhookIssuesOpenedChangesOldIssueAssigneesItemXa5c9a4e5.Serializer::class)
public class InlineWebhookIssuesOpenedChangesOldIssueAssigneesItemXa5c9a4e5(
  public val id: Int,
  ...
  public val type: InlineWebhookIssuesOpenedChangesOldIssueAssigneesItemTypeX3ca173b5? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookIssuesOpenedChangesOldIssueAssigneesItemTypeX3ca173b5? = null
    ...
    public fun build(): InlineWebhookIssuesOpenedChangesOldIssueAssigneesItemXa5c9a4e5 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssuesOpenedChangesOldIssueAssigneesItemXa5c9a4e5(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesOpenedChangesOldIssueAssigneesItemXa5c9a4e5 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesOpenedChangesOldIssueAssigneesItemXa5c9a4e5> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesOpenedChangesOldIssueAssigneesItemXa5c9a4e5 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesOpenedChangesOldIssueAssigneesItemXa5c9a4e5")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesOpenedChangesOldIssueAssigneesItemXa5c9a4e5 must be a JSON object")
      ...
      return InlineWebhookIssuesOpenedChangesOldIssueAssigneesItemXa5c9a4e5(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssuesOpenedChangesOldIssueAssigneesItemTypeX3ca173b5>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesOpenedChangesOldIssueAssigneesItemXa5c9a4e5) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesOpenedChangesOldIssueAssigneesItemXa5c9a4e5")
...
public fun inlineWebhookIssuesOpenedChangesOldIssueAssigneesItemXa5c9a4e5(block: InlineWebhookIssuesOpenedChangesOldIssueAssigneesItemXa5c9a4e5.Builder.() -> Unit): InlineWebhookIssuesOpenedChangesOldIssueAssigneesItemXa5c9a4e5 = InlineWebhookIssuesOpenedChangesOldIssueAssigneesItemXa5c9a4e5.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesOpenedChangesOldIssueAssigneesItemXa5c9a4e5 is missing required property '" + name + "'")
