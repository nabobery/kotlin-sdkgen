 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhook-issue-comment-deleted/properties/issue/allOf/0
 */
@Serializable(with = InlineWebhookIssueCommentDeletedIssueAllOf1X67b32bad.Serializer::class)
public class InlineWebhookIssueCommentDeletedIssueAllOf1X67b32bad internal constructor(
  ...
  public val user: InlineWebhookIssueCommentDeletedIssueAllOf1UserX17082cba?,
  private val assigneeState:
      FieldState<InlineWebhookIssueCommentDeletedIssueAllOf1AssigneeXc2e01e87?>,
  private val draftState: FieldState<Boolean>,
  private val issueDependenciesSummaryState: FieldState<IssueDependenciesSummary>,
  labelsState: FieldState<List<InlineWebhookIssueCommentDeletedIssueAllOf1LabelsItemX65dbf854>>,
  ...
  private val stateState: FieldState<InlineWebhookIssueCommentDeletedIssueAllOf1StateX2b5f460f>,
  ...
  private val labelsState:
      FieldState<List<InlineWebhookIssueCommentDeletedIssueAllOf1LabelsItemX65dbf854>> =
      labelsState.copyValue { fieldValue -> fieldValue.toList() }

  public val assignee: InlineWebhookIssueCommentDeletedIssueAllOf1AssigneeXc2e01e87?
  ...
  public constructor(
    ...
    updatedAt: String,
    url: String,
    user: InlineWebhookIssueCommentDeletedIssueAllOf1UserX17082cba?,
  ...
  public class Builder {
    ...
    private var userState: FieldState<InlineWebhookIssueCommentDeletedIssueAllOf1UserX17082cba?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var user: InlineWebhookIssueCommentDeletedIssueAllOf1UserX17082cba?
     ...
     */
    public var assignee: InlineWebhookIssueCommentDeletedIssueAllOf1AssigneeXc2e01e87?
      get() = assigneeState.valueOrNull()
      set(`value`) {
    ...
    private var stateState: FieldState<InlineWebhookIssueCommentDeletedIssueAllOf1StateX2b5f460f> =
        FieldState.Absent
    ...
    public fun build(): InlineWebhookIssueCommentDeletedIssueAllOf1X67b32bad {
      ...
      return InlineWebhookIssueCommentDeletedIssueAllOf1X67b32bad(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssueCommentDeletedIssueAllOf1X67b32bad = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssueCommentDeletedIssueAllOf1X67b32bad> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssueCommentDeletedIssueAllOf1X67b32bad {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssueCommentDeletedIssueAllOf1X67b32bad")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssueCommentDeletedIssueAllOf1X67b32bad must be a JSON object")
      ...
      if (!rawObject.containsKey("active_lock_reason")) {
        throw SerializationException("InlineWebhookIssueCommentDeletedIssueAllOf1X67b32bad is missing required property 'active_lock_reason'")
      }
      ...
      if (!rawObject.containsKey("body")) {
        throw SerializationException("InlineWebhookIssueCommentDeletedIssueAllOf1X67b32bad is missing required property 'body'")
      }
      ...
      if (!rawObject.containsKey("closed_at")) {
        throw SerializationException("InlineWebhookIssueCommentDeletedIssueAllOf1X67b32bad is missing required property 'closed_at'")
      }
      ...
      if (!rawObject.containsKey("milestone")) {
        throw SerializationException("InlineWebhookIssueCommentDeletedIssueAllOf1X67b32bad is missing required property 'milestone'")
      }
      ...
      if (!rawObject.containsKey("user")) {
        throw SerializationException("InlineWebhookIssueCommentDeletedIssueAllOf1X67b32bad is missing required property 'user'")
      }
      val user = rawObject["user"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookIssueCommentDeletedIssueAllOf1UserX17082cba?>(requireNotNull(element)) }
      return InlineWebhookIssueCommentDeletedIssueAllOf1X67b32bad(
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssueCommentDeletedIssueAllOf1X67b32bad) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssueCommentDeletedIssueAllOf1X67b32bad")
...
public fun inlineWebhookIssueCommentDeletedIssueAllOf1X67b32bad(block: InlineWebhookIssueCommentDeletedIssueAllOf1X67b32bad.Builder.() -> Unit): InlineWebhookIssueCommentDeletedIssueAllOf1X67b32bad = InlineWebhookIssueCommentDeletedIssueAllOf1X67b32bad.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssueCommentDeletedIssueAllOf1X67b32bad is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookIssueCommentDeletedIssueAllOf1X67b32bad property '" + name + "' is not nullable")
