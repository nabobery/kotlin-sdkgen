 ...
 * d/properties/repo/properties/owner
 */
@Serializable(with = InlineWebhookPullRequestAssignedPullRequestHeadRepoOwnerX24a4e1c0.Serializer::class)
public class InlineWebhookPullRequestAssignedPullRequestHeadRepoOwnerX24a4e1c0(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestAssignedPullRequestHeadRepoOwnerTypeX32fed05a? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestAssignedPullRequestHeadRepoOwnerTypeX32fed05a? = null
    ...
    public fun build(): InlineWebhookPullRequestAssignedPullRequestHeadRepoOwnerX24a4e1c0 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestAssignedPullRequestHeadRepoOwnerX24a4e1c0(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestAssignedPullRequestHeadRepoOwnerX24a4e1c0 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestAssignedPullRequestHeadRepoOwnerX24a4e1c0> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestAssignedPullRequestHeadRepoOwnerX24a4e1c0 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestAssignedPullRequestHeadRepoOwnerX24a4e1c0")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestAssignedPullRequestHeadRepoOwnerX24a4e1c0 must be a JSON object")
      ...
      return InlineWebhookPullRequestAssignedPullRequestHeadRepoOwnerX24a4e1c0(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestAssignedPullRequestHeadRepoOwnerTypeX32fed05a>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestAssignedPullRequestHeadRepoOwnerX24a4e1c0) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestAssignedPullRequestHeadRepoOwnerX24a4e1c0")
...
public fun inlineWebhookPullRequestAssignedPullRequestHeadRepoOwnerX24a4e1c0(block: InlineWebhookPullRequestAssignedPullRequestHeadRepoOwnerX24a4e1c0.Builder.() -> Unit): InlineWebhookPullRequestAssignedPullRequestHeadRepoOwnerX24a4e1c0 = InlineWebhookPullRequestAssignedPullRequestHeadRepoOwnerX24a4e1c0.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestAssignedPullRequestHeadRepoOwnerX24a4e1c0 is missing required property '" + name + "'")
