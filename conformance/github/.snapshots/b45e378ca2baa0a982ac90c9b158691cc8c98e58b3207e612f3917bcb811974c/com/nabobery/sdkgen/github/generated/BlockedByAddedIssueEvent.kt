...
@Serializable
public data class BlockedByAddedIssueEventView(
 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/blocked-by-added-issue-event
 */
@Serializable(with = BlockedByAddedIssueEvent.Serializer::class)
public class BlockedByAddedIssueEvent(
  public val actor: SimpleUser,
  public val blockedBy: NullableIssueReference?,
  public val commitId: String?,
  public val commitUrl: String?,
  ...
  public class Builder {
    ...
    public fun build(): BlockedByAddedIssueEvent {
      ...
      return BlockedByAddedIssueEvent(
        actor = actor,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): BlockedByAddedIssueEvent = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<BlockedByAddedIssueEvent> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): BlockedByAddedIssueEvent {
      val jsonDecoder = decoder.requireJsonDecoder("BlockedByAddedIssueEvent")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("BlockedByAddedIssueEvent must be a JSON object")
      ...
      if (!rawObject.containsKey("blocked_by")) {
        throw SerializationException("BlockedByAddedIssueEvent is missing required property 'blocked_by'")
      }
      ...
      if (!rawObject.containsKey("commit_id")) {
        throw SerializationException("BlockedByAddedIssueEvent is missing required property 'commit_id'")
      }
      ...
      if (!rawObject.containsKey("commit_url")) {
        throw SerializationException("BlockedByAddedIssueEvent is missing required property 'commit_url'")
      }
      ...
      if (!rawObject.containsKey("performed_via_github_app")) {
        throw SerializationException("BlockedByAddedIssueEvent is missing required property 'performed_via_github_app'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: BlockedByAddedIssueEvent) {
      val jsonEncoder = encoder.requireJsonEncoder("BlockedByAddedIssueEvent")
...
public fun blockedByAddedIssueEvent(block: BlockedByAddedIssueEvent.Builder.() -> Unit): BlockedByAddedIssueEvent = BlockedByAddedIssueEvent.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("BlockedByAddedIssueEvent is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("BlockedByAddedIssueEvent property '" + name + "' is not nullable")
