 ...
 * request/properties/assignee.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-review-request-removed/oneOf/1/properties/pull_
 * request/properties/assignee
 */
@Serializable(with = InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestAssigneeX8aa664ad.Serializer::class)
public class InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestAssigneeX8aa664ad(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestReacd1OneOf2PullRequestAssigneeTypeX9f115d49? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestReacd1OneOf2PullRequestAssigneeTypeX9f115d49? = null
    ...
    public fun build(): InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestAssigneeX8aa664ad {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestAssigneeX8aa664ad(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestAssigneeX8aa664ad = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestAssigneeX8aa664ad> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestAssigneeX8aa664ad {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestAssigneeX8aa664ad")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestAssigneeX8aa664ad must be a JSON object")
      ...
      return InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestAssigneeX8aa664ad(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestReacd1OneOf2PullRequestAssigneeTypeX9f115d49>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestAssigneeX8aa664ad) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestAssigneeX8aa664ad")
...
public fun inlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestAssigneeX8aa664ad(block: InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestAssigneeX8aa664ad.Builder.() -> Unit): InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestAssigneeX8aa664ad = InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestAssigneeX8aa664ad.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestAssigneeX8aa664ad is missing required property '" + name + "'")
