 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-edited/properties/issue/properties/milestone
 */
@Serializable(with = InlineWebhookIssuesEditedIssueMilestoneXc93f377b.Serializer::class)
public class InlineWebhookIssuesEditedIssueMilestoneXc93f377b(
  /**
  ...
  public val creator: InlineWebhookIssuesEditedIssueMilestoneCreatorX5858f3a6?,
   ...
   */
  public val state: InlineWebhookIssuesEditedIssueMilestoneStateXaa2f4163,
  /**
  ...
  public class Builder {
    ...
    private var stateValue: InlineWebhookIssuesEditedIssueMilestoneStateXaa2f4163? = null

    public var state: InlineWebhookIssuesEditedIssueMilestoneStateXaa2f4163
    ...
    private var creatorState: FieldState<InlineWebhookIssuesEditedIssueMilestoneCreatorX5858f3a6?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var creator: InlineWebhookIssuesEditedIssueMilestoneCreatorX5858f3a6?
    ...
    public fun build(): InlineWebhookIssuesEditedIssueMilestoneXc93f377b {
      ...
      return InlineWebhookIssuesEditedIssueMilestoneXc93f377b(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesEditedIssueMilestoneXc93f377b = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesEditedIssueMilestoneXc93f377b> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesEditedIssueMilestoneXc93f377b {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesEditedIssueMilestoneXc93f377b")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesEditedIssueMilestoneXc93f377b must be a JSON object")
      ...
      val state = json.decodeRequired<InlineWebhookIssuesEditedIssueMilestoneStateXaa2f4163>(rawObject, "state")
      val title = json.decodeRequired<String>(rawObject, "title")
      val updatedAt = json.decodeRequired<String>(rawObject, "updated_at")
      val url = json.decodeRequired<String>(rawObject, "url")
      if (!rawObject.containsKey("closed_at")) {
        throw SerializationException("InlineWebhookIssuesEditedIssueMilestoneXc93f377b is missing required property 'closed_at'")
      }
      ...
      if (!rawObject.containsKey("creator")) {
        throw SerializationException("InlineWebhookIssuesEditedIssueMilestoneXc93f377b is missing required property 'creator'")
      }
      val creator = rawObject["creator"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookIssuesEditedIssueMilestoneCreatorX5858f3a6?>(requireNotNull(element)) }
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookIssuesEditedIssueMilestoneXc93f377b is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("due_on")) {
        throw SerializationException("InlineWebhookIssuesEditedIssueMilestoneXc93f377b is missing required property 'due_on'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesEditedIssueMilestoneXc93f377b) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesEditedIssueMilestoneXc93f377b")
...
public fun inlineWebhookIssuesEditedIssueMilestoneXc93f377b(block: InlineWebhookIssuesEditedIssueMilestoneXc93f377b.Builder.() -> Unit): InlineWebhookIssuesEditedIssueMilestoneXc93f377b = InlineWebhookIssuesEditedIssueMilestoneXc93f377b.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesEditedIssueMilestoneXc93f377b is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookIssuesEditedIssueMilestoneXc93f377b property '" + name + "' is not nullable")
