 ...
 * uested_reviewers/items/oneOf/0
 */
@Serializable(with = InlineWebhookPullRequestAssignedPullRequestRequestedReviewersItemOneOf1Xd59ea5e9.Serializer::class)
public class InlineWebhookPullRequestAssignedPullRequestRequestedReviewersItemOneOf1Xd59ea5e9(
  public val id: Int,
  ...
  public val type:
      InlineWebhookPullRequestAsbb98PullRequestRequestedReviewersItemTypeXefd5114f? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestAsbb98PullRequestRequestedReviewersItemTypeXefd5114f? =
        null
    ...
    public fun build(): InlineWebhookPullRequestAssignedPullRequestRequestedReviewersItemOneOf1Xd59ea5e9 {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestAssignedPullRequestRequestedReviewersItemOneOf1Xd59ea5e9 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestAssignedPullRequestRequestedReviewersItemOneOf1Xd59ea5e9> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestAssignedPullRequestRequestedReviewersItemOneOf1Xd59ea5e9 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestAssignedPullRequestRequestedReviewersItemOneOf1Xd59ea5e9")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestAssignedPullRequestRequestedReviewersItemOneOf1Xd59ea5e9 must be a JSON object")
      ...
      return InlineWebhookPullRequestAssignedPullRequestRequestedReviewersItemOneOf1Xd59ea5e9(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestAsbb98PullRequestRequestedReviewersItemTypeXefd5114f>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestAssignedPullRequestRequestedReviewersItemOneOf1Xd59ea5e9) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestAssignedPullRequestRequestedReviewersItemOneOf1Xd59ea5e9")
...
public fun inlineWebhookPullRequestAssignedPullRequestRequestedReviewersItemOneOf1Xd59ea5e9(block: InlineWebhookPullRequestAssignedPullRequestRequestedReviewersItemOneOf1Xd59ea5e9.Builder.() -> Unit): InlineWebhookPullRequestAssignedPullRequestRequestedReviewersItemOneOf1Xd59ea5e9 = InlineWebhookPullRequestAssignedPullRequestRequestedReviewersItemOneOf1Xd59ea5e9.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestAssignedPullRequestRequestedReviewersItemOneOf1Xd59ea5e9 is missing required property '" + name + "'")
