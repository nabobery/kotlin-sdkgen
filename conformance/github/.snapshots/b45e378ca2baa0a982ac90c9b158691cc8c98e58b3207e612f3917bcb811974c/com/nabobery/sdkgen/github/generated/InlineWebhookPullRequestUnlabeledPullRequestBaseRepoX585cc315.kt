 ...
 * se/properties/repo
 */
@Serializable(with = InlineWebhookPullRequestUnlabeledPullRequestBaseRepoX585cc315.Serializer::class)
public class InlineWebhookPullRequestUnlabeledPullRequestBaseRepoX585cc315 internal constructor(
  /**
  ...
  public val createdAt: InlineWebhookPullRequestUnlabeledPullRequestBaseRepoCreatedAtX475def3a,
  /**
  ...
  public val license: InlineWebhookPullRequestUnlabeledPullRequestBaseRepoLicenseX35ff0caf?,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val owner: InlineWebhookPullRequestUnlabeledPullRequestBaseRepoOwnerX5d5f7441?,
  /**
  ...
  public val pushedAt: InlineWebhookPullRequestUnlabeledPullRequestBaseRepoPushedAtX263057e7?,
  /**
   * Wire format: `uri-template`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val visibility: InlineWebhookPullRequestUnlabeledPullRequestBaseRepoVisibilityX4bf0fd86,
  ...
  private val mergeCommitMessageState:
      FieldState<InlineWebhookPullRequestUnlabeledPullRequestBaseRepoMergeCommitMessageXebe6a068>,
  private val mergeCommitTitleState:
      FieldState<InlineWebhookPullRequestUnlabeledPullRequestBaseRepoMergeCommitTitleXae0b5513>,
  private val organizationState: FieldState<String>,
  private val permissionsState:
      FieldState<InlineWebhookPullRequestUnlabeledPullRequestBaseRepoPermissionsXfd740b95>,
  private val publicState: FieldState<Boolean>,
  private val pullRequestCreationPolicyState:
      FieldState<InlineWebhookPullRequestUn950ePullRequestBasePullRequestCreationP824dXc92a5af7>,
  private val roleNameState: FieldState<String?>,
  private val squashMergeCommitMessageState:
      FieldState<InlineWebhookPullRequestUn950ePullRequestBaseSquashMergeCommitMessageXe57f32e9>,
  private val squashMergeCommitTitleState:
      FieldState<InlineWebhookPullRequestUn950ePullRequestBaseRepoSquashMergeCommitTitleX317d5a25>,
  ...
  public val permissions: InlineWebhookPullRequestUnlabeledPullRequestBaseRepoPermissionsXfd740b95?
  ...
  public constructor(
    ...
    createdAt: InlineWebhookPullRequestUnlabeledPullRequestBaseRepoCreatedAtX475def3a,
    ...
    language: String?,
    languagesUrl: String,
    license: InlineWebhookPullRequestUnlabeledPullRequestBaseRepoLicenseX35ff0caf?,
    mergesUrl: String,
    ...
    openIssues: Int,
    openIssuesCount: Int,
    owner: InlineWebhookPullRequestUnlabeledPullRequestBaseRepoOwnerX5d5f7441?,
    `private`: Boolean,
    pullsUrl: String,
    pushedAt: InlineWebhookPullRequestUnlabeledPullRequestBaseRepoPushedAtX263057e7?,
    releasesUrl: String,
    size: Int,
    sshUrl: String,
    stargazersCount: Int,
    ...
    updatedAt: String,
    url: String,
    visibility: InlineWebhookPullRequestUnlabeledPullRequestBaseRepoVisibilityX4bf0fd86,
    watchers: Int,
    watchersCount: Int,
  ...
  public class Builder {
    ...
    private var createdAtValue:
        InlineWebhookPullRequestUnlabeledPullRequestBaseRepoCreatedAtX475def3a? = null

    public var createdAt: InlineWebhookPullRequestUnlabeledPullRequestBaseRepoCreatedAtX475def3a
    ...
    private var visibilityValue:
        InlineWebhookPullRequestUnlabeledPullRequestBaseRepoVisibilityX4bf0fd86? = null

    public var visibility: InlineWebhookPullRequestUnlabeledPullRequestBaseRepoVisibilityX4bf0fd86
    ...
    private var licenseState:
        FieldState<InlineWebhookPullRequestUnlabeledPullRequestBaseRepoLicenseX35ff0caf?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var license: InlineWebhookPullRequestUnlabeledPullRequestBaseRepoLicenseX35ff0caf?
    ...
    private var ownerState:
        FieldState<InlineWebhookPullRequestUnlabeledPullRequestBaseRepoOwnerX5d5f7441?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var owner: InlineWebhookPullRequestUnlabeledPullRequestBaseRepoOwnerX5d5f7441?
    ...
    private var pushedAtState:
        FieldState<InlineWebhookPullRequestUnlabeledPullRequestBaseRepoPushedAtX263057e7?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var pushedAt: InlineWebhookPullRequestUnlabeledPullRequestBaseRepoPushedAtX263057e7?
    ...
    public var permissions:
        InlineWebhookPullRequestUnlabeledPullRequestBaseRepoPermissionsXfd740b95?
      get() = permissionsState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): InlineWebhookPullRequestUnlabeledPullRequestBaseRepoX585cc315 {
      ...
      return InlineWebhookPullRequestUnlabeledPullRequestBaseRepoX585cc315(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestUnlabeledPullRequestBaseRepoX585cc315 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestUnlabeledPullRequestBaseRepoX585cc315> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestUnlabeledPullRequestBaseRepoX585cc315 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestUnlabeledPullRequestBaseRepoX585cc315")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestUnlabeledPullRequestBaseRepoX585cc315 must be a JSON object")
      ...
      val createdAt = json.decodeRequired<InlineWebhookPullRequestUnlabeledPullRequestBaseRepoCreatedAtX475def3a>(rawObject, "created_at")
      ...
      val visibility = json.decodeRequired<InlineWebhookPullRequestUnlabeledPullRequestBaseRepoVisibilityX4bf0fd86>(rawObject, "visibility")
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookPullRequestUnlabeledPullRequestBaseRepoX585cc315 is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("homepage")) {
        throw SerializationException("InlineWebhookPullRequestUnlabeledPullRequestBaseRepoX585cc315 is missing required property 'homepage'")
      }
      ...
      if (!rawObject.containsKey("language")) {
        throw SerializationException("InlineWebhookPullRequestUnlabeledPullRequestBaseRepoX585cc315 is missing required property 'language'")
      }
      ...
      if (!rawObject.containsKey("license")) {
        throw SerializationException("InlineWebhookPullRequestUnlabeledPullRequestBaseRepoX585cc315 is missing required property 'license'")
      }
      val license = rawObject["license"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestUnlabeledPullRequestBaseRepoLicenseX35ff0caf?>(requireNotNull(element)) }
      if (!rawObject.containsKey("mirror_url")) {
        throw SerializationException("InlineWebhookPullRequestUnlabeledPullRequestBaseRepoX585cc315 is missing required property 'mirror_url'")
      }
      ...
      if (!rawObject.containsKey("owner")) {
        throw SerializationException("InlineWebhookPullRequestUnlabeledPullRequestBaseRepoX585cc315 is missing required property 'owner'")
      }
      val owner = rawObject["owner"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestUnlabeledPullRequestBaseRepoOwnerX5d5f7441?>(requireNotNull(element)) }
      if (!rawObject.containsKey("pushed_at")) {
        throw SerializationException("InlineWebhookPullRequestUnlabeledPullRequestBaseRepoX585cc315 is missing required property 'pushed_at'")
      }
      val pushedAt = rawObject["pushed_at"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestUnlabeledPullRequestBaseRepoPushedAtX263057e7?>(requireNotNull(element)) }
      return InlineWebhookPullRequestUnlabeledPullRequestBaseRepoX585cc315(
        archiveUrl = archiveUrl,
        archived = archived,
        assigneesUrl = assigneesUrl,
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestUnlabeledPullRequestBaseRepoX585cc315) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestUnlabeledPullRequestBaseRepoX585cc315")
...
public fun inlineWebhookPullRequestUnlabeledPullRequestBaseRepoX585cc315(block: InlineWebhookPullRequestUnlabeledPullRequestBaseRepoX585cc315.Builder.() -> Unit): InlineWebhookPullRequestUnlabeledPullRequestBaseRepoX585cc315 = InlineWebhookPullRequestUnlabeledPullRequestBaseRepoX585cc315.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestUnlabeledPullRequestBaseRepoX585cc315 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookPullRequestUnlabeledPullRequestBaseRepoX585cc315 property '" + name + "' is not nullable")
