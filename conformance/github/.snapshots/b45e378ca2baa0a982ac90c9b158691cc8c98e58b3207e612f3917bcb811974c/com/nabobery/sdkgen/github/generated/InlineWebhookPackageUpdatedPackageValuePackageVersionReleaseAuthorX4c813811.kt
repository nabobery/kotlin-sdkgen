 ...
 * n/properties/release/properties/author.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-package-updated/properties/package/properties/package_versio
 * n/properties/release/properties/author
 */
@Serializable(with = InlineWebhookPackageUpdatedPackageValuePackageVersionReleaseAuthorX4c813811.Serializer::class)
public class InlineWebhookPackageUpdatedPackageValuePackageVersionReleaseAuthorX4c813811(
  public val id: Int,
  ...
  public val type:
      InlineWebhookPackageUpdatedPackageValuePackageVersionReleaseAuthorTypeXa090f32e? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public fun build(): InlineWebhookPackageUpdatedPackageValuePackageVersionReleaseAuthorX4c813811 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPackageUpdatedPackageValuePackageVersionReleaseAuthorX4c813811(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPackageUpdatedPackageValuePackageVersionReleaseAuthorX4c813811 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPackageUpdatedPackageValuePackageVersionReleaseAuthorX4c813811> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPackageUpdatedPackageValuePackageVersionReleaseAuthorX4c813811 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPackageUpdatedPackageValuePackageVersionReleaseAuthorX4c813811")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPackageUpdatedPackageValuePackageVersionReleaseAuthorX4c813811 must be a JSON object")
      ...
      return InlineWebhookPackageUpdatedPackageValuePackageVersionReleaseAuthorX4c813811(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPackageUpdatedPackageValuePackageVersionReleaseAuthorTypeXa090f32e>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPackageUpdatedPackageValuePackageVersionReleaseAuthorX4c813811) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPackageUpdatedPackageValuePackageVersionReleaseAuthorX4c813811")
...
public fun inlineWebhookPackageUpdatedPackageValuePackageVersionReleaseAuthorX4c813811(block: InlineWebhookPackageUpdatedPackageValuePackageVersionReleaseAuthorX4c813811.Builder.() -> Unit): InlineWebhookPackageUpdatedPackageValuePackageVersionReleaseAuthorX4c813811 = InlineWebhookPackageUpdatedPackageValuePackageVersionReleaseAuthorX4c813811.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPackageUpdatedPackageValuePackageVersionReleaseAuthorX4c813811 is missing required property '" + name + "'")
