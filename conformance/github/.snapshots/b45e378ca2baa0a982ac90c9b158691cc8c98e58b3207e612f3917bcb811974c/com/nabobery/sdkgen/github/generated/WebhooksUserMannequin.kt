...
/**
 * Generated model for sdkgen://source/openapi.yaml#/components/schemas/webhooks_user_mannequin.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhooks_user_mannequin
 */
@Serializable(with = WebhooksUserMannequin.Serializer::class)
public class WebhooksUserMannequin(
  ...
  public val type: InlineWebhooksUserMannequinTypeXa33735db? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhooksUserMannequinTypeXa33735db? = null
    ...
    public fun build(): WebhooksUserMannequin {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): WebhooksUserMannequin = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<WebhooksUserMannequin> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): WebhooksUserMannequin {
      val jsonDecoder = decoder.requireJsonDecoder("WebhooksUserMannequin")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("WebhooksUserMannequin must be a JSON object")
      ...
      return WebhooksUserMannequin(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhooksUserMannequinTypeXa33735db>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: WebhooksUserMannequin) {
      val jsonEncoder = encoder.requireJsonEncoder("WebhooksUserMannequin")
...
public fun webhooksUserMannequin(block: WebhooksUserMannequin.Builder.() -> Unit): WebhooksUserMannequin = WebhooksUserMannequin.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("WebhooksUserMannequin is missing required property '" + name + "'")
