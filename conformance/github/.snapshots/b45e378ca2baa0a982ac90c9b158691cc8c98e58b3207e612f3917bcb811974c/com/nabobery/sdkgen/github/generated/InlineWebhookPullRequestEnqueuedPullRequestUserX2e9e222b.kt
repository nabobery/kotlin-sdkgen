 ...
 * r
 */
@Serializable(with = InlineWebhookPullRequestEnqueuedPullRequestUserX2e9e222b.Serializer::class)
public class InlineWebhookPullRequestEnqueuedPullRequestUserX2e9e222b(
  public val id: Long,
  ...
  public val type: InlineWebhookPullRequestEnqueuedPullRequestUserTypeXbdfb8754? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestEnqueuedPullRequestUserTypeXbdfb8754? = null
    ...
    public fun build(): InlineWebhookPullRequestEnqueuedPullRequestUserX2e9e222b {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestEnqueuedPullRequestUserX2e9e222b(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestEnqueuedPullRequestUserX2e9e222b = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestEnqueuedPullRequestUserX2e9e222b> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestEnqueuedPullRequestUserX2e9e222b {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestEnqueuedPullRequestUserX2e9e222b")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestEnqueuedPullRequestUserX2e9e222b must be a JSON object")
      ...
      return InlineWebhookPullRequestEnqueuedPullRequestUserX2e9e222b(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestEnqueuedPullRequestUserTypeXbdfb8754>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestEnqueuedPullRequestUserX2e9e222b) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestEnqueuedPullRequestUserX2e9e222b")
...
public fun inlineWebhookPullRequestEnqueuedPullRequestUserX2e9e222b(block: InlineWebhookPullRequestEnqueuedPullRequestUserX2e9e222b.Builder.() -> Unit): InlineWebhookPullRequestEnqueuedPullRequestUserX2e9e222b = InlineWebhookPullRequestEnqueuedPullRequestUserX2e9e222b.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestEnqueuedPullRequestUserX2e9e222b is missing required property '" + name + "'")
