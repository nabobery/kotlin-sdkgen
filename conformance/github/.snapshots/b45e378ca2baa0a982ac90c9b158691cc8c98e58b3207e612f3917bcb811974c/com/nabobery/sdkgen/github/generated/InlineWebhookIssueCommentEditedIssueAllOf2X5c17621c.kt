...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-issue-comment-edited/properties/issue/allOf/1.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhook-issue-comment-edited/properties/issue/allOf/1
 */
@Serializable(with = InlineWebhookIssueCommentEditedIssueAllOf2X5c17621c.Serializer::class)
public class InlineWebhookIssueCommentEditedIssueAllOf2X5c17621c internal constructor(
  public val assignee: InlineWebhookIssueCommentEditedIssueAllOf2AssigneeXfabf6016?,
  labels: List<InlineWebhookIssueCommentEditedIssueAllOf2LabelsItemX6e7e3bde>,
  public val locked: Boolean,
  /**
   * State of the issue; either 'open' or 'closed'
   */
  public val state: InlineWebhookIssueCommentEditedIssueAllOf2StateXc8e34aa0,
  ...
  private val reactionsState:
      FieldState<InlineWebhookIssueCommentEditedIssueAllOf2ReactionsXf34c9256>,
  ...
  private val userState: FieldState<InlineWebhookIssueCommentEditedIssueAllOf2UserX6c3d3b08>,
) {
  public val labels: List<InlineWebhookIssueCommentEditedIssueAllOf2LabelsItemX6e7e3bde> =
      labels.toList()
  ...
  public val reactions: InlineWebhookIssueCommentEditedIssueAllOf2ReactionsXf34c9256?
  ...
  public val user: InlineWebhookIssueCommentEditedIssueAllOf2UserX6c3d3b08?
    get() = userState.valueOrNull()

  public constructor(
    assignee: InlineWebhookIssueCommentEditedIssueAllOf2AssigneeXfabf6016?,
    labels: List<InlineWebhookIssueCommentEditedIssueAllOf2LabelsItemX6e7e3bde>,
    locked: Boolean,
    state: InlineWebhookIssueCommentEditedIssueAllOf2StateXc8e34aa0,
  ...
  public class Builder {
    private var labelsValue: List<InlineWebhookIssueCommentEditedIssueAllOf2LabelsItemX6e7e3bde>? =
        null

    public var labels: List<InlineWebhookIssueCommentEditedIssueAllOf2LabelsItemX6e7e3bde>
    ...
    private var stateValue: InlineWebhookIssueCommentEditedIssueAllOf2StateXc8e34aa0? = null

    public var state: InlineWebhookIssueCommentEditedIssueAllOf2StateXc8e34aa0
    ...
    private var assigneeState:
        FieldState<InlineWebhookIssueCommentEditedIssueAllOf2AssigneeXfabf6016?> = FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var assignee: InlineWebhookIssueCommentEditedIssueAllOf2AssigneeXfabf6016?
    ...
    private var reactionsState:
        FieldState<InlineWebhookIssueCommentEditedIssueAllOf2ReactionsXf34c9256> = FieldState.Absent

    /**
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var reactions: InlineWebhookIssueCommentEditedIssueAllOf2ReactionsXf34c9256?
      get() = reactionsState.valueOrNull()
      set(`value`) {
    ...
    private var userState: FieldState<InlineWebhookIssueCommentEditedIssueAllOf2UserX6c3d3b08> =
        FieldState.Absent

    /**
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var user: InlineWebhookIssueCommentEditedIssueAllOf2UserX6c3d3b08?
      get() = userState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): InlineWebhookIssueCommentEditedIssueAllOf2X5c17621c {
      ...
      return InlineWebhookIssueCommentEditedIssueAllOf2X5c17621c(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssueCommentEditedIssueAllOf2X5c17621c = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssueCommentEditedIssueAllOf2X5c17621c> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssueCommentEditedIssueAllOf2X5c17621c {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssueCommentEditedIssueAllOf2X5c17621c")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssueCommentEditedIssueAllOf2X5c17621c must be a JSON object")
      val labels = json.decodeRequired<List<InlineWebhookIssueCommentEditedIssueAllOf2LabelsItemX6e7e3bde>>(rawObject, "labels")
      val locked = json.decodeRequired<Boolean>(rawObject, "locked")
      val state = json.decodeRequired<InlineWebhookIssueCommentEditedIssueAllOf2StateXc8e34aa0>(rawObject, "state")
      if (!rawObject.containsKey("assignee")) {
        throw SerializationException("InlineWebhookIssueCommentEditedIssueAllOf2X5c17621c is missing required property 'assignee'")
      }
      val assignee = rawObject["assignee"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookIssueCommentEditedIssueAllOf2AssigneeXfabf6016?>(requireNotNull(element)) }
      return InlineWebhookIssueCommentEditedIssueAllOf2X5c17621c(
        assignee = assignee,
        labels = labels,
        locked = locked,
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssueCommentEditedIssueAllOf2X5c17621c) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssueCommentEditedIssueAllOf2X5c17621c")
...
public fun inlineWebhookIssueCommentEditedIssueAllOf2X5c17621c(block: InlineWebhookIssueCommentEditedIssueAllOf2X5c17621c.Builder.() -> Unit): InlineWebhookIssueCommentEditedIssueAllOf2X5c17621c = InlineWebhookIssueCommentEditedIssueAllOf2X5c17621c.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssueCommentEditedIssueAllOf2X5c17621c is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookIssueCommentEditedIssueAllOf2X5c17621c property '" + name + "' is not nullable")
