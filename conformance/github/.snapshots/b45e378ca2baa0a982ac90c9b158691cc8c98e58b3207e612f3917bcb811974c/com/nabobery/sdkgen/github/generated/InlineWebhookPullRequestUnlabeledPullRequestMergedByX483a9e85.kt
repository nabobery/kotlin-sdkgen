 ...
 * rged_by
 */
@Serializable(with = InlineWebhookPullRequestUnlabeledPullRequestMergedByX483a9e85.Serializer::class)
public class InlineWebhookPullRequestUnlabeledPullRequestMergedByX483a9e85(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestUnlabeledPullRequestMergedByTypeXf6eaee99? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestUnlabeledPullRequestMergedByTypeXf6eaee99? = null
    ...
    public fun build(): InlineWebhookPullRequestUnlabeledPullRequestMergedByX483a9e85 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestUnlabeledPullRequestMergedByX483a9e85(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestUnlabeledPullRequestMergedByX483a9e85 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestUnlabeledPullRequestMergedByX483a9e85> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestUnlabeledPullRequestMergedByX483a9e85 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestUnlabeledPullRequestMergedByX483a9e85")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestUnlabeledPullRequestMergedByX483a9e85 must be a JSON object")
      ...
      return InlineWebhookPullRequestUnlabeledPullRequestMergedByX483a9e85(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestUnlabeledPullRequestMergedByTypeXf6eaee99>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestUnlabeledPullRequestMergedByX483a9e85) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestUnlabeledPullRequestMergedByX483a9e85")
...
public fun inlineWebhookPullRequestUnlabeledPullRequestMergedByX483a9e85(block: InlineWebhookPullRequestUnlabeledPullRequestMergedByX483a9e85.Builder.() -> Unit): InlineWebhookPullRequestUnlabeledPullRequestMergedByX483a9e85 = InlineWebhookPullRequestUnlabeledPullRequestMergedByX483a9e85.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestUnlabeledPullRequestMergedByX483a9e85 is missing required property '" + name + "'")
