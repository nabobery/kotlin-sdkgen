...
/**
 * Generated model for sdkgen://source/openapi.yaml#/components/schemas/webhooks_project/properties/creator.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhooks_project/properties/creator
 */
@Serializable(with = InlineWebhooksProjectCreatorX4ce312ad.Serializer::class)
public class InlineWebhooksProjectCreatorX4ce312ad(
  public val id: Int,
  ...
  public val type: InlineWebhooksProjectCreatorTypeXab9bd41e? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhooksProjectCreatorTypeXab9bd41e? = null
    ...
    public fun build(): InlineWebhooksProjectCreatorX4ce312ad {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhooksProjectCreatorX4ce312ad(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhooksProjectCreatorX4ce312ad = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhooksProjectCreatorX4ce312ad> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhooksProjectCreatorX4ce312ad {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhooksProjectCreatorX4ce312ad")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhooksProjectCreatorX4ce312ad must be a JSON object")
      ...
      return InlineWebhooksProjectCreatorX4ce312ad(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhooksProjectCreatorTypeXab9bd41e>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhooksProjectCreatorX4ce312ad) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhooksProjectCreatorX4ce312ad")
...
public fun inlineWebhooksProjectCreatorX4ce312ad(block: InlineWebhooksProjectCreatorX4ce312ad.Builder.() -> Unit): InlineWebhooksProjectCreatorX4ce312ad = InlineWebhooksProjectCreatorX4ce312ad.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhooksProjectCreatorX4ce312ad is missing required property '" + name + "'")
