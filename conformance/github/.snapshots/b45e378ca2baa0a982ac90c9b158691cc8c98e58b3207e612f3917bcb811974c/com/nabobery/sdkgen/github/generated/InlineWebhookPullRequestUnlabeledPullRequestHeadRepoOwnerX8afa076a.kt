 ...
 * ad/properties/repo/properties/owner.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-unlabeled/properties/pull_request/properties/he
 * ad/properties/repo/properties/owner
 */
@Serializable(with = InlineWebhookPullRequestUnlabeledPullRequestHeadRepoOwnerX8afa076a.Serializer::class)
public class InlineWebhookPullRequestUnlabeledPullRequestHeadRepoOwnerX8afa076a(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestUnlabeledPullRequestHeadRepoOwnerTypeX5ee943fb? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestUnlabeledPullRequestHeadRepoOwnerTypeX5ee943fb? = null
    ...
    public fun build(): InlineWebhookPullRequestUnlabeledPullRequestHeadRepoOwnerX8afa076a {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestUnlabeledPullRequestHeadRepoOwnerX8afa076a(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestUnlabeledPullRequestHeadRepoOwnerX8afa076a = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestUnlabeledPullRequestHeadRepoOwnerX8afa076a> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestUnlabeledPullRequestHeadRepoOwnerX8afa076a {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestUnlabeledPullRequestHeadRepoOwnerX8afa076a")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestUnlabeledPullRequestHeadRepoOwnerX8afa076a must be a JSON object")
      ...
      return InlineWebhookPullRequestUnlabeledPullRequestHeadRepoOwnerX8afa076a(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestUnlabeledPullRequestHeadRepoOwnerTypeX5ee943fb>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestUnlabeledPullRequestHeadRepoOwnerX8afa076a) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestUnlabeledPullRequestHeadRepoOwnerX8afa076a")
...
public fun inlineWebhookPullRequestUnlabeledPullRequestHeadRepoOwnerX8afa076a(block: InlineWebhookPullRequestUnlabeledPullRequestHeadRepoOwnerX8afa076a.Builder.() -> Unit): InlineWebhookPullRequestUnlabeledPullRequestHeadRepoOwnerX8afa076a = InlineWebhookPullRequestUnlabeledPullRequestHeadRepoOwnerX8afa076a.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestUnlabeledPullRequestHeadRepoOwnerX8afa076a is missing required property '" + name + "'")
