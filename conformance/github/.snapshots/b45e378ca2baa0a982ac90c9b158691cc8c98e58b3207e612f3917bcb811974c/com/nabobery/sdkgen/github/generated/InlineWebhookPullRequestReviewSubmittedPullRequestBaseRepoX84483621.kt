 ...
 * ties/base/properties/repo
 */
@Serializable(with = InlineWebhookPullRequestReviewSubmittedPullRequestBaseRepoX84483621.Serializer::class)
public class InlineWebhookPullRequestReviewSubmittedPullRequestBaseRepoX84483621 internal constructor(
  /**
  ...
  public val createdAt:
      InlineWebhookPullRequestReviewSubmittedPullRequestBaseRepoCreatedAtX211a1e39,
  /**
  ...
  public val license: InlineWebhookPullRequestReviewSubmittedPullRequestBaseRepoLicenseXb01190f3?,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val owner: InlineWebhookPullRequestReviewSubmittedPullRequestBaseRepoOwnerX7b892a81?,
  /**
  ...
  public val pushedAt: InlineWebhookPullRequestReviewSubmittedPullRequestBaseRepoPushedAtX8a9e8e14?,
  /**
   * Wire format: `uri-template`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  private val mergeCommitMessageState:
      FieldState<InlineWebhookPullRequestRe5d81PullRequestBaseRepoMergeCommitMessageX0d9a39a9>,
  private val mergeCommitTitleState:
      FieldState<InlineWebhookPullRequestRe5d81PullRequestBaseRepoMergeCommitTitleX9d0d4187>,
  private val organizationState: FieldState<String>,
  private val permissionsState:
      FieldState<InlineWebhookPullRequestReviewSubmittedPullRequestBaseRepoPermissionsX2dd521c1>,
  private val publicState: FieldState<Boolean>,
  private val pullRequestCreationPolicyState:
      FieldState<InlineWebhookPullRequestRe5d81PullRequestBasePullRequestCreationP824dX62ae9c59>,
  private val roleNameState: FieldState<String?>,
  private val squashMergeCommitMessageState:
      FieldState<InlineWebhookPullRequestRe5d81PullRequestBaseSquashMergeCommitMessageX59eb06ae>,
  private val squashMergeCommitTitleState:
      FieldState<InlineWebhookPullRequestRe5d81PullRequestBaseRepoSquashMergeCommitTitleX7ac1f0a7>,
  ...
  public val mergeCommitTitle:
      InlineWebhookPullRequestRe5d81PullRequestBaseRepoMergeCommitTitleX9d0d4187?
  ...
  public val permissions:
      InlineWebhookPullRequestReviewSubmittedPullRequestBaseRepoPermissionsX2dd521c1?
  ...
  public val squashMergeCommitTitle:
      InlineWebhookPullRequestRe5d81PullRequestBaseRepoSquashMergeCommitTitleX7ac1f0a7?
  ...
  public constructor(
    ...
    createdAt: InlineWebhookPullRequestReviewSubmittedPullRequestBaseRepoCreatedAtX211a1e39,
    ...
    language: String?,
    languagesUrl: String,
    license: InlineWebhookPullRequestReviewSubmittedPullRequestBaseRepoLicenseXb01190f3?,
    mergesUrl: String,
    ...
    openIssues: Int,
    openIssuesCount: Int,
    owner: InlineWebhookPullRequestReviewSubmittedPullRequestBaseRepoOwnerX7b892a81?,
    `private`: Boolean,
    pullsUrl: String,
    pushedAt: InlineWebhookPullRequestReviewSubmittedPullRequestBaseRepoPushedAtX8a9e8e14?,
    releasesUrl: String,
    size: Int,
    sshUrl: String,
    stargazersCount: Int,
    ...
    updatedAt: String,
    url: String,
    visibility: InlineWebhookPullRequestReviewSubmittedPullRequestBaseRepoVisibilityXac890139,
    watchers: Int,
    watchersCount: Int,
  ...
  public class Builder {
    ...
    private var createdAtValue:
        InlineWebhookPullRequestReviewSubmittedPullRequestBaseRepoCreatedAtX211a1e39? = null
    ...
    private var visibilityValue:
        InlineWebhookPullRequestReviewSubmittedPullRequestBaseRepoVisibilityXac890139? = null
    ...
    private var licenseState:
        FieldState<InlineWebhookPullRequestReviewSubmittedPullRequestBaseRepoLicenseXb01190f3?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var license: InlineWebhookPullRequestReviewSubmittedPullRequestBaseRepoLicenseXb01190f3?
    ...
    private var ownerState:
        FieldState<InlineWebhookPullRequestReviewSubmittedPullRequestBaseRepoOwnerX7b892a81?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var owner: InlineWebhookPullRequestReviewSubmittedPullRequestBaseRepoOwnerX7b892a81?
    ...
    private var pushedAtState:
        FieldState<InlineWebhookPullRequestReviewSubmittedPullRequestBaseRepoPushedAtX8a9e8e14?> =
        FieldState.Absent
     ...
     */
    public var pushedAt:
        InlineWebhookPullRequestReviewSubmittedPullRequestBaseRepoPushedAtX8a9e8e14?
    ...
    public fun build(): InlineWebhookPullRequestReviewSubmittedPullRequestBaseRepoX84483621 {
      ...
      return InlineWebhookPullRequestReviewSubmittedPullRequestBaseRepoX84483621(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewSubmittedPullRequestBaseRepoX84483621 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewSubmittedPullRequestBaseRepoX84483621> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewSubmittedPullRequestBaseRepoX84483621 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewSubmittedPullRequestBaseRepoX84483621")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewSubmittedPullRequestBaseRepoX84483621 must be a JSON object")
      ...
      val createdAt = json.decodeRequired<InlineWebhookPullRequestReviewSubmittedPullRequestBaseRepoCreatedAtX211a1e39>(rawObject, "created_at")
      ...
      val visibility = json.decodeRequired<InlineWebhookPullRequestReviewSubmittedPullRequestBaseRepoVisibilityXac890139>(rawObject, "visibility")
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookPullRequestReviewSubmittedPullRequestBaseRepoX84483621 is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("homepage")) {
        throw SerializationException("InlineWebhookPullRequestReviewSubmittedPullRequestBaseRepoX84483621 is missing required property 'homepage'")
      }
      ...
      if (!rawObject.containsKey("language")) {
        throw SerializationException("InlineWebhookPullRequestReviewSubmittedPullRequestBaseRepoX84483621 is missing required property 'language'")
      }
      ...
      if (!rawObject.containsKey("license")) {
        throw SerializationException("InlineWebhookPullRequestReviewSubmittedPullRequestBaseRepoX84483621 is missing required property 'license'")
      }
      val license = rawObject["license"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestReviewSubmittedPullRequestBaseRepoLicenseXb01190f3?>(requireNotNull(element)) }
      if (!rawObject.containsKey("mirror_url")) {
        throw SerializationException("InlineWebhookPullRequestReviewSubmittedPullRequestBaseRepoX84483621 is missing required property 'mirror_url'")
      }
      ...
      if (!rawObject.containsKey("owner")) {
        throw SerializationException("InlineWebhookPullRequestReviewSubmittedPullRequestBaseRepoX84483621 is missing required property 'owner'")
      }
      val owner = rawObject["owner"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestReviewSubmittedPullRequestBaseRepoOwnerX7b892a81?>(requireNotNull(element)) }
      if (!rawObject.containsKey("pushed_at")) {
        throw SerializationException("InlineWebhookPullRequestReviewSubmittedPullRequestBaseRepoX84483621 is missing required property 'pushed_at'")
      }
      val pushedAt = rawObject["pushed_at"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestReviewSubmittedPullRequestBaseRepoPushedAtX8a9e8e14?>(requireNotNull(element)) }
      return InlineWebhookPullRequestReviewSubmittedPullRequestBaseRepoX84483621(
        archiveUrl = archiveUrl,
        archived = archived,
        assigneesUrl = assigneesUrl,
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewSubmittedPullRequestBaseRepoX84483621) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewSubmittedPullRequestBaseRepoX84483621")
...
public fun inlineWebhookPullRequestReviewSubmittedPullRequestBaseRepoX84483621(block: InlineWebhookPullRequestReviewSubmittedPullRequestBaseRepoX84483621.Builder.() -> Unit): InlineWebhookPullRequestReviewSubmittedPullRequestBaseRepoX84483621 = InlineWebhookPullRequestReviewSubmittedPullRequestBaseRepoX84483621.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewSubmittedPullRequestBaseRepoX84483621 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookPullRequestReviewSubmittedPullRequestBaseRepoX84483621 property '" + name + "' is not nullable")
