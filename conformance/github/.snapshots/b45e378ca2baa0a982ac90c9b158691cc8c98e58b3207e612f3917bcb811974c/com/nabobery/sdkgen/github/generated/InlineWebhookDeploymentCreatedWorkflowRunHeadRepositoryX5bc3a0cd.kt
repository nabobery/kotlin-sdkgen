...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-deployment-created/properties/workflow_run/properties/head_r
 * epository.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-deployment-created/properties/workflow_run/properties/head_r
 * epository
 */
@Serializable(with = InlineWebhookDeploymentCreatedWorkflowRunHeadRepositoryX5bc3a0cd.Serializer::class)
public class InlineWebhookDeploymentCreatedWorkflowRunHeadRepositoryX5bc3a0cd(
  ...
  public val owner: InlineWebhookDeploymentCreatedWorkflowRunHeadRepositoryOwnerX2edfc248? = null,
  ...
  public class Builder {
    ...
    public var owner: InlineWebhookDeploymentCreatedWorkflowRunHeadRepositoryOwnerX2edfc248? = null
    ...
    public fun build(): InlineWebhookDeploymentCreatedWorkflowRunHeadRepositoryX5bc3a0cd = InlineWebhookDeploymentCreatedWorkflowRunHeadRepositoryX5bc3a0cd(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookDeploymentCreatedWorkflowRunHeadRepositoryX5bc3a0cd = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookDeploymentCreatedWorkflowRunHeadRepositoryX5bc3a0cd> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookDeploymentCreatedWorkflowRunHeadRepositoryX5bc3a0cd {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookDeploymentCreatedWorkflowRunHeadRepositoryX5bc3a0cd")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookDeploymentCreatedWorkflowRunHeadRepositoryX5bc3a0cd must be a JSON object")
      return InlineWebhookDeploymentCreatedWorkflowRunHeadRepositoryX5bc3a0cd(
        ...
        owner = rawObject["owner"]?.let { json.decodeFromJsonElement<InlineWebhookDeploymentCreatedWorkflowRunHeadRepositoryOwnerX2edfc248>(it) },
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookDeploymentCreatedWorkflowRunHeadRepositoryX5bc3a0cd) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookDeploymentCreatedWorkflowRunHeadRepositoryX5bc3a0cd")
...
public fun inlineWebhookDeploymentCreatedWorkflowRunHeadRepositoryX5bc3a0cd(block: InlineWebhookDeploymentCreatedWorkflowRunHeadRepositoryX5bc3a0cd.Builder.() -> Unit): InlineWebhookDeploymentCreatedWorkflowRunHeadRepositoryX5bc3a0cd = InlineWebhookDeploymentCreatedWorkflowRunHeadRepositoryX5bc3a0cd.build(block)
