...
@Serializable
public data class RemovedFromProjectIssueEventView(
  ...
  public val projectCard: InlineRemovedFromProjectIssueEventProjectCardX48381631? = null,
 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/removed-from-project-issue-event
 */
@Serializable(with = RemovedFromProjectIssueEvent.Serializer::class)
public class RemovedFromProjectIssueEvent internal constructor(
  public val actor: SimpleUser,
  public val commitId: String?,
  public val commitUrl: String?,
  public val createdAt: String,
  ...
  public val performedViaGithubApp: NullableIntegration?,
  public val url: String,
  private val projectCardState: FieldState<InlineRemovedFromProjectIssueEventProjectCardX48381631>,
) {
  public val projectCard: InlineRemovedFromProjectIssueEventProjectCardX48381631?
  ...
  public class Builder {
    ...
    private var projectCardState: FieldState<InlineRemovedFromProjectIssueEventProjectCardX48381631>
        = FieldState.Absent

    /**
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var projectCard: InlineRemovedFromProjectIssueEventProjectCardX48381631?
      get() = projectCardState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): RemovedFromProjectIssueEvent {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): RemovedFromProjectIssueEvent = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<RemovedFromProjectIssueEvent> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): RemovedFromProjectIssueEvent {
      val jsonDecoder = decoder.requireJsonDecoder("RemovedFromProjectIssueEvent")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("RemovedFromProjectIssueEvent must be a JSON object")
      ...
      if (!rawObject.containsKey("commit_id")) {
        throw SerializationException("RemovedFromProjectIssueEvent is missing required property 'commit_id'")
      }
      ...
      if (!rawObject.containsKey("commit_url")) {
        throw SerializationException("RemovedFromProjectIssueEvent is missing required property 'commit_url'")
      }
      ...
      if (!rawObject.containsKey("performed_via_github_app")) {
        throw SerializationException("RemovedFromProjectIssueEvent is missing required property 'performed_via_github_app'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: RemovedFromProjectIssueEvent) {
      val jsonEncoder = encoder.requireJsonEncoder("RemovedFromProjectIssueEvent")
...
public fun removedFromProjectIssueEvent(block: RemovedFromProjectIssueEvent.Builder.() -> Unit): RemovedFromProjectIssueEvent = RemovedFromProjectIssueEvent.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("RemovedFromProjectIssueEvent is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("RemovedFromProjectIssueEvent property '" + name + "' is not nullable")
