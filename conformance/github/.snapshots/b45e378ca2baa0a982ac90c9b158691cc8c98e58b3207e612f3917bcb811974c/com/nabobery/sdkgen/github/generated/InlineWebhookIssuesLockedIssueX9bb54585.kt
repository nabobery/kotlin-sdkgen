 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-locked/properties/issue
 */
@Serializable(with = InlineWebhookIssuesLockedIssueX9bb54585.Serializer::class)
public class InlineWebhookIssuesLockedIssueX9bb54585 internal constructor(
  public val activeLockReason: InlineWebhookIssuesLockedIssueActiveLockReasonX928d8949?,
  assignees: List<InlineWebhookIssuesLockedIssueAssigneesItemX7bbb5874?>,
  /**
   * How the author is associated with the repository.
   */
  public val authorAssociation: InlineWebhookIssuesLockedIssueAuthorAssociationX02cb9a1e,
  /**
   ...
   */
  public val milestone: InlineWebhookIssuesLockedIssueMilestoneX8884c724?,
  public val nodeId: String,
  public val number: Int,
  public val reactions: InlineWebhookIssuesLockedIssueReactionsX4a2fc5d7,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val user: InlineWebhookIssuesLockedIssueUserXa148d362?,
  private val assigneeState: FieldState<InlineWebhookIssuesLockedIssueAssigneeXf181c961?>,
  ...
  labelsState: FieldState<List<InlineWebhookIssuesLockedIssueLabelsItemX4dfaa95e?>>,
  private val performedViaGithubAppState:
      FieldState<InlineWebhookIssuesLockedIssuePerformedViaGithubAppX5923f4f7?>,
  private val pinnedCommentState: FieldState<NullableIssueComment?>,
  private val pullRequestState: FieldState<InlineWebhookIssuesLockedIssuePullRequestX0ba24ac7>,
  private val stateState: FieldState<InlineWebhookIssuesLockedIssueStateXe8a4f091>,
  ...
  public val assignees: List<InlineWebhookIssuesLockedIssueAssigneesItemX7bbb5874?> =
      assignees.toList()
  ...
  private val labelsState: FieldState<List<InlineWebhookIssuesLockedIssueLabelsItemX4dfaa95e?>> =
      labelsState.copyValue { fieldValue -> fieldValue.toList() }

  public val assignee: InlineWebhookIssuesLockedIssueAssigneeXf181c961?
  ...
  public val labels: List<InlineWebhookIssuesLockedIssueLabelsItemX4dfaa95e?>?
   ...
   */
  public val performedViaGithubApp: InlineWebhookIssuesLockedIssuePerformedViaGithubAppX5923f4f7?
  ...
  public val pullRequest: InlineWebhookIssuesLockedIssuePullRequestX0ba24ac7?
    get() = pullRequestState.valueOrNull()

  /**
   * State of the issue; either 'open' or 'closed'
   */
  public val state: InlineWebhookIssuesLockedIssueStateXe8a4f091?
  ...
  public constructor(
    activeLockReason: InlineWebhookIssuesLockedIssueActiveLockReasonX928d8949?,
    assignees: List<InlineWebhookIssuesLockedIssueAssigneesItemX7bbb5874?>,
    authorAssociation: InlineWebhookIssuesLockedIssueAuthorAssociationX02cb9a1e,
    body: String?,
    closedAt: String?,
    comments: Int,
    commentsUrl: String,
    ...
    labelsUrl: String,
    locked: Boolean,
    milestone: InlineWebhookIssuesLockedIssueMilestoneX8884c724?,
    nodeId: String,
    number: Int,
    reactions: InlineWebhookIssuesLockedIssueReactionsX4a2fc5d7,
    repositoryUrl: String,
    title: String,
    updatedAt: String,
    url: String,
    user: InlineWebhookIssuesLockedIssueUserXa148d362?,
  ...
  public class Builder {
    private var assigneesValue: List<InlineWebhookIssuesLockedIssueAssigneesItemX7bbb5874?>? = null

    public var assignees: List<InlineWebhookIssuesLockedIssueAssigneesItemX7bbb5874?>
      get() = requireNotNull(assigneesValue) { "assignees is required" }.toList()
      set(`value`) {
        assigneesValue = value.toList()
      }

    private var authorAssociationValue: InlineWebhookIssuesLockedIssueAuthorAssociationX02cb9a1e? =
        null

    public var authorAssociation: InlineWebhookIssuesLockedIssueAuthorAssociationX02cb9a1e
    ...
    private var reactionsValue: InlineWebhookIssuesLockedIssueReactionsX4a2fc5d7? = null

    public var reactions: InlineWebhookIssuesLockedIssueReactionsX4a2fc5d7
    ...
    private var activeLockReasonState:
        FieldState<InlineWebhookIssuesLockedIssueActiveLockReasonX928d8949?> = FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var activeLockReason: InlineWebhookIssuesLockedIssueActiveLockReasonX928d8949?
    ...
    private var milestoneState: FieldState<InlineWebhookIssuesLockedIssueMilestoneX8884c724?> =
        FieldState.Absent
     ...
     * Required nullable field; assigning `null` records present-null.
     */
    public var milestone: InlineWebhookIssuesLockedIssueMilestoneX8884c724?
      get() = milestoneState.valueOrNull()
      set(`value`) {
        milestoneState = value.toNullableFieldState()
      }

    private var userState: FieldState<InlineWebhookIssuesLockedIssueUserXa148d362?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var user: InlineWebhookIssuesLockedIssueUserXa148d362?
      get() = userState.valueOrNull()
      set(`value`) {
        userState = value.toNullableFieldState()
      }

    private var assigneeState: FieldState<InlineWebhookIssuesLockedIssueAssigneeXf181c961?> =
        FieldState.Absent

    /**
     * Assigning `null` records present-null; use the unset function to omit the property.
     */
    public var assignee: InlineWebhookIssuesLockedIssueAssigneeXf181c961?
      get() = assigneeState.valueOrNull()
      set(`value`) {
    ...
    private var labelsState: FieldState<List<InlineWebhookIssuesLockedIssueLabelsItemX4dfaa95e?>> =
        FieldState.Absent

    /**
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var labels: List<InlineWebhookIssuesLockedIssueLabelsItemX4dfaa95e?>?
     ...
     * Assigning `null` records present-null; use the unset function to omit the property.
     */
    public var performedViaGithubApp: InlineWebhookIssuesLockedIssuePerformedViaGithubAppX5923f4f7?
      get() = performedViaGithubAppState.valueOrNull()
      set(`value`) {
    ...
    private var pullRequestState: FieldState<InlineWebhookIssuesLockedIssuePullRequestX0ba24ac7> =
        FieldState.Absent

    /**
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var pullRequest: InlineWebhookIssuesLockedIssuePullRequestX0ba24ac7?
      get() = pullRequestState.valueOrNull()
      set(`value`) {
    ...
    private var stateState: FieldState<InlineWebhookIssuesLockedIssueStateXe8a4f091> =
        FieldState.Absent
     ...
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var state: InlineWebhookIssuesLockedIssueStateXe8a4f091?
      get() = stateState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): InlineWebhookIssuesLockedIssueX9bb54585 {
      ...
      return InlineWebhookIssuesLockedIssueX9bb54585(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesLockedIssueX9bb54585 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesLockedIssueX9bb54585> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesLockedIssueX9bb54585 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesLockedIssueX9bb54585")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesLockedIssueX9bb54585 must be a JSON object")
      val assignees = json.decodeRequired<List<InlineWebhookIssuesLockedIssueAssigneesItemX7bbb5874?>>(rawObject, "assignees")
      val authorAssociation = json.decodeRequired<InlineWebhookIssuesLockedIssueAuthorAssociationX02cb9a1e>(rawObject, "author_association")
      ...
      val reactions = json.decodeRequired<InlineWebhookIssuesLockedIssueReactionsX4a2fc5d7>(rawObject, "reactions")
      ...
      if (!rawObject.containsKey("active_lock_reason")) {
        throw SerializationException("InlineWebhookIssuesLockedIssueX9bb54585 is missing required property 'active_lock_reason'")
      }
      val activeLockReason = rawObject["active_lock_reason"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookIssuesLockedIssueActiveLockReasonX928d8949?>(requireNotNull(element)) }
      if (!rawObject.containsKey("body")) {
        throw SerializationException("InlineWebhookIssuesLockedIssueX9bb54585 is missing required property 'body'")
      }
      ...
      if (!rawObject.containsKey("closed_at")) {
        throw SerializationException("InlineWebhookIssuesLockedIssueX9bb54585 is missing required property 'closed_at'")
      }
      ...
      if (!rawObject.containsKey("milestone")) {
        throw SerializationException("InlineWebhookIssuesLockedIssueX9bb54585 is missing required property 'milestone'")
      }
      val milestone = rawObject["milestone"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookIssuesLockedIssueMilestoneX8884c724?>(requireNotNull(element)) }
      if (!rawObject.containsKey("user")) {
        throw SerializationException("InlineWebhookIssuesLockedIssueX9bb54585 is missing required property 'user'")
      }
      val user = rawObject["user"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookIssuesLockedIssueUserXa148d362?>(requireNotNull(element)) }
      return InlineWebhookIssuesLockedIssueX9bb54585(
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesLockedIssueX9bb54585) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesLockedIssueX9bb54585")
...
public fun inlineWebhookIssuesLockedIssueX9bb54585(block: InlineWebhookIssuesLockedIssueX9bb54585.Builder.() -> Unit): InlineWebhookIssuesLockedIssueX9bb54585 = InlineWebhookIssuesLockedIssueX9bb54585.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesLockedIssueX9bb54585 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookIssuesLockedIssueX9bb54585 property '" + name + "' is not nullable")
