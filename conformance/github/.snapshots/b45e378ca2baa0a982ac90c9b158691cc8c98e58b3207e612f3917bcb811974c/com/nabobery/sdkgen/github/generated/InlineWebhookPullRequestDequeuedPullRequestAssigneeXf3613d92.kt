 ...
 * ignee
 */
@Serializable(with = InlineWebhookPullRequestDequeuedPullRequestAssigneeXf3613d92.Serializer::class)
public class InlineWebhookPullRequestDequeuedPullRequestAssigneeXf3613d92(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestDequeuedPullRequestAssigneeTypeXc1891bfe? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestDequeuedPullRequestAssigneeTypeXc1891bfe? = null
    ...
    public fun build(): InlineWebhookPullRequestDequeuedPullRequestAssigneeXf3613d92 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestDequeuedPullRequestAssigneeXf3613d92(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestDequeuedPullRequestAssigneeXf3613d92 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestDequeuedPullRequestAssigneeXf3613d92> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestDequeuedPullRequestAssigneeXf3613d92 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestDequeuedPullRequestAssigneeXf3613d92")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestDequeuedPullRequestAssigneeXf3613d92 must be a JSON object")
      ...
      return InlineWebhookPullRequestDequeuedPullRequestAssigneeXf3613d92(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestDequeuedPullRequestAssigneeTypeXc1891bfe>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestDequeuedPullRequestAssigneeXf3613d92) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestDequeuedPullRequestAssigneeXf3613d92")
...
public fun inlineWebhookPullRequestDequeuedPullRequestAssigneeXf3613d92(block: InlineWebhookPullRequestDequeuedPullRequestAssigneeXf3613d92.Builder.() -> Unit): InlineWebhookPullRequestDequeuedPullRequestAssigneeXf3613d92 = InlineWebhookPullRequestDequeuedPullRequestAssigneeXf3613d92.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestDequeuedPullRequestAssigneeXf3613d92 is missing required property '" + name + "'")
