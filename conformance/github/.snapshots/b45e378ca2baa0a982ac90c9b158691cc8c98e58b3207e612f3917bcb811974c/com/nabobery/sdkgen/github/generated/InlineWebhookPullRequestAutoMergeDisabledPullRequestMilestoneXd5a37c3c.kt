 ...
 * perties/milestone
 */
@Serializable(with = InlineWebhookPullRequestAutoMergeDisabledPullRequestMilestoneXd5a37c3c.Serializer::class)
public class InlineWebhookPullRequestAutoMergeDisabledPullRequestMilestoneXd5a37c3c(
  /**
  ...
  public val creator:
      InlineWebhookPullRequestAutoMergeDisabledPullRequestMilestoneCreatorXa6d14f47?,
   ...
   */
  public val state: InlineWebhookPullRequestAutoMergeDisabledPullRequestMilestoneStateX5834d373,
  /**
  ...
  public class Builder {
    ...
    private var stateValue:
        InlineWebhookPullRequestAutoMergeDisabledPullRequestMilestoneStateX5834d373? = null

    public var state: InlineWebhookPullRequestAutoMergeDisabledPullRequestMilestoneStateX5834d373
    ...
    private var creatorState:
        FieldState<InlineWebhookPullRequestAutoMergeDisabledPullRequestMilestoneCreatorXa6d14f47?> =
        FieldState.Absent
    ...
    public fun build(): InlineWebhookPullRequestAutoMergeDisabledPullRequestMilestoneXd5a37c3c {
      ...
      return InlineWebhookPullRequestAutoMergeDisabledPullRequestMilestoneXd5a37c3c(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestAutoMergeDisabledPullRequestMilestoneXd5a37c3c = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestAutoMergeDisabledPullRequestMilestoneXd5a37c3c> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestAutoMergeDisabledPullRequestMilestoneXd5a37c3c {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestAutoMergeDisabledPullRequestMilestoneXd5a37c3c")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestAutoMergeDisabledPullRequestMilestoneXd5a37c3c must be a JSON object")
      ...
      val state = json.decodeRequired<InlineWebhookPullRequestAutoMergeDisabledPullRequestMilestoneStateX5834d373>(rawObject, "state")
      val title = json.decodeRequired<String>(rawObject, "title")
      val updatedAt = json.decodeRequired<String>(rawObject, "updated_at")
      val url = json.decodeRequired<String>(rawObject, "url")
      if (!rawObject.containsKey("closed_at")) {
        throw SerializationException("InlineWebhookPullRequestAutoMergeDisabledPullRequestMilestoneXd5a37c3c is missing required property 'closed_at'")
      }
      ...
      if (!rawObject.containsKey("creator")) {
        throw SerializationException("InlineWebhookPullRequestAutoMergeDisabledPullRequestMilestoneXd5a37c3c is missing required property 'creator'")
      }
      val creator = rawObject["creator"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestAutoMergeDisabledPullRequestMilestoneCreatorXa6d14f47?>(requireNotNull(element)) }
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookPullRequestAutoMergeDisabledPullRequestMilestoneXd5a37c3c is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("due_on")) {
        throw SerializationException("InlineWebhookPullRequestAutoMergeDisabledPullRequestMilestoneXd5a37c3c is missing required property 'due_on'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestAutoMergeDisabledPullRequestMilestoneXd5a37c3c) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestAutoMergeDisabledPullRequestMilestoneXd5a37c3c")
...
public fun inlineWebhookPullRequestAutoMergeDisabledPullRequestMilestoneXd5a37c3c(block: InlineWebhookPullRequestAutoMergeDisabledPullRequestMilestoneXd5a37c3c.Builder.() -> Unit): InlineWebhookPullRequestAutoMergeDisabledPullRequestMilestoneXd5a37c3c = InlineWebhookPullRequestAutoMergeDisabledPullRequestMilestoneXd5a37c3c.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestAutoMergeDisabledPullRequestMilestoneXd5a37c3c is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookPullRequestAutoMergeDisabledPullRequestMilestoneXd5a37c3c property '" + name + "' is not nullable")
