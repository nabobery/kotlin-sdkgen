 ...
 * ad_repository/properties/owner
 */
@Serializable(with = InlineWebhookWorkflowRunCompletedWorkflowRunHeadRepositoryOwnerX8733f216.Serializer::class)
public class InlineWebhookWorkflowRunCompletedWorkflowRunHeadRepositoryOwnerX8733f216(
  public val id: Int,
  ...
  public val type:
      InlineWebhookWorkflowRunCompletedWorkflowRunHeadRepositoryOwnerTypeX9c5d54ee? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookWorkflowRunCompletedWorkflowRunHeadRepositoryOwnerTypeX9c5d54ee? =
        null
    ...
    public fun build(): InlineWebhookWorkflowRunCompletedWorkflowRunHeadRepositoryOwnerX8733f216 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookWorkflowRunCompletedWorkflowRunHeadRepositoryOwnerX8733f216(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookWorkflowRunCompletedWorkflowRunHeadRepositoryOwnerX8733f216 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookWorkflowRunCompletedWorkflowRunHeadRepositoryOwnerX8733f216> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookWorkflowRunCompletedWorkflowRunHeadRepositoryOwnerX8733f216 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookWorkflowRunCompletedWorkflowRunHeadRepositoryOwnerX8733f216")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookWorkflowRunCompletedWorkflowRunHeadRepositoryOwnerX8733f216 must be a JSON object")
      ...
      return InlineWebhookWorkflowRunCompletedWorkflowRunHeadRepositoryOwnerX8733f216(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookWorkflowRunCompletedWorkflowRunHeadRepositoryOwnerTypeX9c5d54ee>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookWorkflowRunCompletedWorkflowRunHeadRepositoryOwnerX8733f216) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookWorkflowRunCompletedWorkflowRunHeadRepositoryOwnerX8733f216")
...
public fun inlineWebhookWorkflowRunCompletedWorkflowRunHeadRepositoryOwnerX8733f216(block: InlineWebhookWorkflowRunCompletedWorkflowRunHeadRepositoryOwnerX8733f216.Builder.() -> Unit): InlineWebhookWorkflowRunCompletedWorkflowRunHeadRepositoryOwnerX8733f216 = InlineWebhookWorkflowRunCompletedWorkflowRunHeadRepositoryOwnerX8733f216.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookWorkflowRunCompletedWorkflowRunHeadRepositoryOwnerX8733f216 is missing required property '" + name + "'")
