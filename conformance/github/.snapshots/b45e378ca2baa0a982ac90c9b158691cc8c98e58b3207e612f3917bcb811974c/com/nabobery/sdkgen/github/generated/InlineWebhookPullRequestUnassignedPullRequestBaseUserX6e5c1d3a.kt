 ...
 * ase/properties/user
 */
@Serializable(with = InlineWebhookPullRequestUnassignedPullRequestBaseUserX6e5c1d3a.Serializer::class)
public class InlineWebhookPullRequestUnassignedPullRequestBaseUserX6e5c1d3a(
  public val id: Long,
  ...
  public val type: InlineWebhookPullRequestUnassignedPullRequestBaseUserTypeX7419d1cd? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestUnassignedPullRequestBaseUserTypeX7419d1cd? = null
    ...
    public fun build(): InlineWebhookPullRequestUnassignedPullRequestBaseUserX6e5c1d3a {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestUnassignedPullRequestBaseUserX6e5c1d3a(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestUnassignedPullRequestBaseUserX6e5c1d3a = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestUnassignedPullRequestBaseUserX6e5c1d3a> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestUnassignedPullRequestBaseUserX6e5c1d3a {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestUnassignedPullRequestBaseUserX6e5c1d3a")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestUnassignedPullRequestBaseUserX6e5c1d3a must be a JSON object")
      ...
      return InlineWebhookPullRequestUnassignedPullRequestBaseUserX6e5c1d3a(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestUnassignedPullRequestBaseUserTypeX7419d1cd>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestUnassignedPullRequestBaseUserX6e5c1d3a) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestUnassignedPullRequestBaseUserX6e5c1d3a")
...
public fun inlineWebhookPullRequestUnassignedPullRequestBaseUserX6e5c1d3a(block: InlineWebhookPullRequestUnassignedPullRequestBaseUserX6e5c1d3a.Builder.() -> Unit): InlineWebhookPullRequestUnassignedPullRequestBaseUserX6e5c1d3a = InlineWebhookPullRequestUnassignedPullRequestBaseUserX6e5c1d3a.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestUnassignedPullRequestBaseUserX6e5c1d3a is missing required property '" + name + "'")
