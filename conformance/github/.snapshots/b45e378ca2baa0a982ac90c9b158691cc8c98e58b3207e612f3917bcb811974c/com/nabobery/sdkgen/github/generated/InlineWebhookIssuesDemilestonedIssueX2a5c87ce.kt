 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-demilestoned/properties/issue
 */
@Serializable(with = InlineWebhookIssuesDemilestonedIssueX2a5c87ce.Serializer::class)
public class InlineWebhookIssuesDemilestonedIssueX2a5c87ce internal constructor(
  public val activeLockReason: InlineWebhookIssuesDemilestonedIssueActiveLockReasonX16ea0cfe?,
  assignees: List<InlineWebhookIssuesDemilestonedIssueAssigneesItemXb37da2f7?>,
  /**
   * How the author is associated with the repository.
   */
  public val authorAssociation: InlineWebhookIssuesDemilestonedIssueAuthorAssociationX3c0042fe,
  /**
   ...
   */
  public val milestone: InlineWebhookIssuesDemilestonedIssueMilestoneX0a5976fa?,
  public val nodeId: String,
  public val number: Int,
  public val reactions: InlineWebhookIssuesDemilestonedIssueReactionsX17b13ef6,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val user: InlineWebhookIssuesDemilestonedIssueUserXb6b9095c?,
  private val assigneeState: FieldState<InlineWebhookIssuesDemilestonedIssueAssigneeX2b94b8ca?>,
  ...
  labelsState: FieldState<List<InlineWebhookIssuesDemilestonedIssueLabelsItemX9e9684b8?>>,
  private val lockedState: FieldState<Boolean>,
  private val performedViaGithubAppState:
      FieldState<InlineWebhookIssuesDemilestonedIssuePerformedViaGithubAppXf20c94bf?>,
  private val pinnedCommentState: FieldState<NullableIssueComment?>,
  private val pullRequestState:
      FieldState<InlineWebhookIssuesDemilestonedIssuePullRequestX512508ec>,
  private val stateState: FieldState<InlineWebhookIssuesDemilestonedIssueStateX158be201>,
  ...
  public val assignees: List<InlineWebhookIssuesDemilestonedIssueAssigneesItemXb37da2f7?> =
      assignees.toList()
  ...
  private val labelsState:
      FieldState<List<InlineWebhookIssuesDemilestonedIssueLabelsItemX9e9684b8?>> =
      labelsState.copyValue { fieldValue -> fieldValue.toList() }

  public val assignee: InlineWebhookIssuesDemilestonedIssueAssigneeX2b94b8ca?
  ...
  public val labels: List<InlineWebhookIssuesDemilestonedIssueLabelsItemX9e9684b8?>?
  ...
  public val performedViaGithubApp:
      InlineWebhookIssuesDemilestonedIssuePerformedViaGithubAppXf20c94bf?
  ...
  public val pullRequest: InlineWebhookIssuesDemilestonedIssuePullRequestX512508ec?
    get() = pullRequestState.valueOrNull()

  /**
   * State of the issue; either 'open' or 'closed'
   */
  public val state: InlineWebhookIssuesDemilestonedIssueStateX158be201?
  ...
  public constructor(
    activeLockReason: InlineWebhookIssuesDemilestonedIssueActiveLockReasonX16ea0cfe?,
    assignees: List<InlineWebhookIssuesDemilestonedIssueAssigneesItemXb37da2f7?>,
    authorAssociation: InlineWebhookIssuesDemilestonedIssueAuthorAssociationX3c0042fe,
    body: String?,
    closedAt: String?,
    comments: Int,
    commentsUrl: String,
    ...
    id: Long,
    labelsUrl: String,
    milestone: InlineWebhookIssuesDemilestonedIssueMilestoneX0a5976fa?,
    nodeId: String,
    number: Int,
    reactions: InlineWebhookIssuesDemilestonedIssueReactionsX17b13ef6,
    repositoryUrl: String,
    title: String,
    updatedAt: String,
    url: String,
    user: InlineWebhookIssuesDemilestonedIssueUserXb6b9095c?,
  ...
  public class Builder {
    private var assigneesValue: List<InlineWebhookIssuesDemilestonedIssueAssigneesItemXb37da2f7?>? =
        null

    public var assignees: List<InlineWebhookIssuesDemilestonedIssueAssigneesItemXb37da2f7?>
    ...
    private var authorAssociationValue:
        InlineWebhookIssuesDemilestonedIssueAuthorAssociationX3c0042fe? = null

    public var authorAssociation: InlineWebhookIssuesDemilestonedIssueAuthorAssociationX3c0042fe
    ...
    private var reactionsValue: InlineWebhookIssuesDemilestonedIssueReactionsX17b13ef6? = null

    public var reactions: InlineWebhookIssuesDemilestonedIssueReactionsX17b13ef6
    ...
    private var activeLockReasonState:
        FieldState<InlineWebhookIssuesDemilestonedIssueActiveLockReasonX16ea0cfe?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var activeLockReason: InlineWebhookIssuesDemilestonedIssueActiveLockReasonX16ea0cfe?
    ...
    private var milestoneState: FieldState<InlineWebhookIssuesDemilestonedIssueMilestoneX0a5976fa?>
        = FieldState.Absent
     ...
     * Required nullable field; assigning `null` records present-null.
     */
    public var milestone: InlineWebhookIssuesDemilestonedIssueMilestoneX0a5976fa?
      get() = milestoneState.valueOrNull()
      set(`value`) {
        milestoneState = value.toNullableFieldState()
      }

    private var userState: FieldState<InlineWebhookIssuesDemilestonedIssueUserXb6b9095c?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var user: InlineWebhookIssuesDemilestonedIssueUserXb6b9095c?
      get() = userState.valueOrNull()
      set(`value`) {
        userState = value.toNullableFieldState()
      }

    private var assigneeState: FieldState<InlineWebhookIssuesDemilestonedIssueAssigneeX2b94b8ca?> =
        FieldState.Absent

    /**
     * Assigning `null` records present-null; use the unset function to omit the property.
     */
    public var assignee: InlineWebhookIssuesDemilestonedIssueAssigneeX2b94b8ca?
      get() = assigneeState.valueOrNull()
      set(`value`) {
     ...
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var labels: List<InlineWebhookIssuesDemilestonedIssueLabelsItemX9e9684b8?>?
    ...
    private var pullRequestState:
        FieldState<InlineWebhookIssuesDemilestonedIssuePullRequestX512508ec> = FieldState.Absent

    /**
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var pullRequest: InlineWebhookIssuesDemilestonedIssuePullRequestX512508ec?
      get() = pullRequestState.valueOrNull()
      set(`value`) {
    ...
    private var stateState: FieldState<InlineWebhookIssuesDemilestonedIssueStateX158be201> =
        FieldState.Absent
     ...
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var state: InlineWebhookIssuesDemilestonedIssueStateX158be201?
      get() = stateState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): InlineWebhookIssuesDemilestonedIssueX2a5c87ce {
      ...
      return InlineWebhookIssuesDemilestonedIssueX2a5c87ce(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesDemilestonedIssueX2a5c87ce = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesDemilestonedIssueX2a5c87ce> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesDemilestonedIssueX2a5c87ce {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesDemilestonedIssueX2a5c87ce")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesDemilestonedIssueX2a5c87ce must be a JSON object")
      val assignees = json.decodeRequired<List<InlineWebhookIssuesDemilestonedIssueAssigneesItemXb37da2f7?>>(rawObject, "assignees")
      val authorAssociation = json.decodeRequired<InlineWebhookIssuesDemilestonedIssueAuthorAssociationX3c0042fe>(rawObject, "author_association")
      ...
      val reactions = json.decodeRequired<InlineWebhookIssuesDemilestonedIssueReactionsX17b13ef6>(rawObject, "reactions")
      ...
      if (!rawObject.containsKey("active_lock_reason")) {
        throw SerializationException("InlineWebhookIssuesDemilestonedIssueX2a5c87ce is missing required property 'active_lock_reason'")
      }
      val activeLockReason = rawObject["active_lock_reason"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookIssuesDemilestonedIssueActiveLockReasonX16ea0cfe?>(requireNotNull(element)) }
      if (!rawObject.containsKey("body")) {
        throw SerializationException("InlineWebhookIssuesDemilestonedIssueX2a5c87ce is missing required property 'body'")
      }
      ...
      if (!rawObject.containsKey("closed_at")) {
        throw SerializationException("InlineWebhookIssuesDemilestonedIssueX2a5c87ce is missing required property 'closed_at'")
      }
      ...
      if (!rawObject.containsKey("milestone")) {
        throw SerializationException("InlineWebhookIssuesDemilestonedIssueX2a5c87ce is missing required property 'milestone'")
      }
      val milestone = rawObject["milestone"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookIssuesDemilestonedIssueMilestoneX0a5976fa?>(requireNotNull(element)) }
      if (!rawObject.containsKey("user")) {
        throw SerializationException("InlineWebhookIssuesDemilestonedIssueX2a5c87ce is missing required property 'user'")
      }
      val user = rawObject["user"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookIssuesDemilestonedIssueUserXb6b9095c?>(requireNotNull(element)) }
      return InlineWebhookIssuesDemilestonedIssueX2a5c87ce(
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesDemilestonedIssueX2a5c87ce) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesDemilestonedIssueX2a5c87ce")
...
public fun inlineWebhookIssuesDemilestonedIssueX2a5c87ce(block: InlineWebhookIssuesDemilestonedIssueX2a5c87ce.Builder.() -> Unit): InlineWebhookIssuesDemilestonedIssueX2a5c87ce = InlineWebhookIssuesDemilestonedIssueX2a5c87ce.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesDemilestonedIssueX2a5c87ce is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookIssuesDemilestonedIssueX2a5c87ce property '" + name + "' is not nullable")
