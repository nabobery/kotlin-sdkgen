...
public class GpgKey internal constructor(
  ...
  public class Builder {
    ...
    public var emails: List<InlineGpgKeyEmailsItemX35db4821>
      get() = requireNotNull(emailsValue) { "emails is required" }.toList()
      set(`value`) {
        emailsValue = value.toList()
      }
    ...
    public var subkeys: List<InlineGpgKeySubkeysItemX34dfab1f>
      get() = requireNotNull(subkeysValue) { "subkeys is required" }.toList()
      set(`value`) {
        subkeysValue = value.toList()
      }
  ...
  internal object Serializer : KSerializer<GpgKey> {
