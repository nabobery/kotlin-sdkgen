 ...
 * ad_repository
 */
@Serializable(with = InlineWebhookWorkflowRunCompletedWorkflowRunHeadRepositoryX1d185027.Serializer::class)
public class InlineWebhookWorkflowRunCompletedWorkflowRunHeadRepositoryX1d185027(
  /**
  ...
  public val owner: InlineWebhookWorkflowRunCompletedWorkflowRunHeadRepositoryOwnerX8733f216?,
  /**
  ...
  public class Builder {
    ...
    private var ownerState:
        FieldState<InlineWebhookWorkflowRunCompletedWorkflowRunHeadRepositoryOwnerX8733f216?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var owner: InlineWebhookWorkflowRunCompletedWorkflowRunHeadRepositoryOwnerX8733f216?
      get() = ownerState.valueOrNull()
      set(`value`) {
        ownerState = value.toNullableFieldState()
      }

    public fun build(): InlineWebhookWorkflowRunCompletedWorkflowRunHeadRepositoryX1d185027 {
      ...
      return InlineWebhookWorkflowRunCompletedWorkflowRunHeadRepositoryX1d185027(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookWorkflowRunCompletedWorkflowRunHeadRepositoryX1d185027 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookWorkflowRunCompletedWorkflowRunHeadRepositoryX1d185027> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookWorkflowRunCompletedWorkflowRunHeadRepositoryX1d185027 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookWorkflowRunCompletedWorkflowRunHeadRepositoryX1d185027")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookWorkflowRunCompletedWorkflowRunHeadRepositoryX1d185027 must be a JSON object")
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookWorkflowRunCompletedWorkflowRunHeadRepositoryX1d185027 is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("owner")) {
        throw SerializationException("InlineWebhookWorkflowRunCompletedWorkflowRunHeadRepositoryX1d185027 is missing required property 'owner'")
      }
      val owner = rawObject["owner"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookWorkflowRunCompletedWorkflowRunHeadRepositoryOwnerX8733f216?>(requireNotNull(element)) }
      return InlineWebhookWorkflowRunCompletedWorkflowRunHeadRepositoryX1d185027(
        archiveUrl = archiveUrl,
        assigneesUrl = assigneesUrl,
        blobsUrl = blobsUrl,
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookWorkflowRunCompletedWorkflowRunHeadRepositoryX1d185027) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookWorkflowRunCompletedWorkflowRunHeadRepositoryX1d185027")
...
public fun inlineWebhookWorkflowRunCompletedWorkflowRunHeadRepositoryX1d185027(block: InlineWebhookWorkflowRunCompletedWorkflowRunHeadRepositoryX1d185027.Builder.() -> Unit): InlineWebhookWorkflowRunCompletedWorkflowRunHeadRepositoryX1d185027 = InlineWebhookWorkflowRunCompletedWorkflowRunHeadRepositoryX1d185027.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookWorkflowRunCompletedWorkflowRunHeadRepositoryX1d185027 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookWorkflowRunCompletedWorkflowRunHeadRepositoryX1d185027 property '" + name + "' is not nullable")
