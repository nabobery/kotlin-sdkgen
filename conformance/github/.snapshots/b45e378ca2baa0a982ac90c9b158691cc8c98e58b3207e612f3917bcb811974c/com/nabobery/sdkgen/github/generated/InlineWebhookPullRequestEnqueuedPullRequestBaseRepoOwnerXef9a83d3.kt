 ...
 * e/properties/repo/properties/owner
 */
@Serializable(with = InlineWebhookPullRequestEnqueuedPullRequestBaseRepoOwnerXef9a83d3.Serializer::class)
public class InlineWebhookPullRequestEnqueuedPullRequestBaseRepoOwnerXef9a83d3(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestEnqueuedPullRequestBaseRepoOwnerTypeX5b5b66c8? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestEnqueuedPullRequestBaseRepoOwnerTypeX5b5b66c8? = null
    ...
    public fun build(): InlineWebhookPullRequestEnqueuedPullRequestBaseRepoOwnerXef9a83d3 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestEnqueuedPullRequestBaseRepoOwnerXef9a83d3(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestEnqueuedPullRequestBaseRepoOwnerXef9a83d3 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestEnqueuedPullRequestBaseRepoOwnerXef9a83d3> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestEnqueuedPullRequestBaseRepoOwnerXef9a83d3 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestEnqueuedPullRequestBaseRepoOwnerXef9a83d3")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestEnqueuedPullRequestBaseRepoOwnerXef9a83d3 must be a JSON object")
      ...
      return InlineWebhookPullRequestEnqueuedPullRequestBaseRepoOwnerXef9a83d3(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestEnqueuedPullRequestBaseRepoOwnerTypeX5b5b66c8>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestEnqueuedPullRequestBaseRepoOwnerXef9a83d3) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestEnqueuedPullRequestBaseRepoOwnerXef9a83d3")
...
public fun inlineWebhookPullRequestEnqueuedPullRequestBaseRepoOwnerXef9a83d3(block: InlineWebhookPullRequestEnqueuedPullRequestBaseRepoOwnerXef9a83d3.Builder.() -> Unit): InlineWebhookPullRequestEnqueuedPullRequestBaseRepoOwnerXef9a83d3 = InlineWebhookPullRequestEnqueuedPullRequestBaseRepoOwnerXef9a83d3.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestEnqueuedPullRequestBaseRepoOwnerXef9a83d3 is missing required property '" + name + "'")
