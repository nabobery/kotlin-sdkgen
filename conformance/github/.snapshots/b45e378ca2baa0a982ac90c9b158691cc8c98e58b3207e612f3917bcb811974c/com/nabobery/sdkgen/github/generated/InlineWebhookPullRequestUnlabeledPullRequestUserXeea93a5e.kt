...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-unlabeled/properties/pull_request/properties/us
 * er.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-unlabeled/properties/pull_request/properties/us
 * er
 */
@Serializable(with = InlineWebhookPullRequestUnlabeledPullRequestUserXeea93a5e.Serializer::class)
public class InlineWebhookPullRequestUnlabeledPullRequestUserXeea93a5e(
  public val id: Long,
  ...
  public val type: InlineWebhookPullRequestUnlabeledPullRequestUserTypeX7371e8f4? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestUnlabeledPullRequestUserTypeX7371e8f4? = null
    ...
    public fun build(): InlineWebhookPullRequestUnlabeledPullRequestUserXeea93a5e {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestUnlabeledPullRequestUserXeea93a5e(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestUnlabeledPullRequestUserXeea93a5e = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestUnlabeledPullRequestUserXeea93a5e> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestUnlabeledPullRequestUserXeea93a5e {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestUnlabeledPullRequestUserXeea93a5e")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestUnlabeledPullRequestUserXeea93a5e must be a JSON object")
      ...
      return InlineWebhookPullRequestUnlabeledPullRequestUserXeea93a5e(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestUnlabeledPullRequestUserTypeX7371e8f4>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestUnlabeledPullRequestUserXeea93a5e) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestUnlabeledPullRequestUserXeea93a5e")
...
public fun inlineWebhookPullRequestUnlabeledPullRequestUserXeea93a5e(block: InlineWebhookPullRequestUnlabeledPullRequestUserXeea93a5e.Builder.() -> Unit): InlineWebhookPullRequestUnlabeledPullRequestUserXeea93a5e = InlineWebhookPullRequestUnlabeledPullRequestUserXeea93a5e.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestUnlabeledPullRequestUserXeea93a5e is missing required property '" + name + "'")
