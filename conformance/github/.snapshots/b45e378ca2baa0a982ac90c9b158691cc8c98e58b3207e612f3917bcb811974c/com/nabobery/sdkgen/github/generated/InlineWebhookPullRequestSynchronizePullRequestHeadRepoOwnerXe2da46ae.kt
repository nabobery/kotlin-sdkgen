 ...
 * head/properties/repo/properties/owner.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-synchronize/properties/pull_request/properties/
 * head/properties/repo/properties/owner
 */
@Serializable(with = InlineWebhookPullRequestSynchronizePullRequestHeadRepoOwnerXe2da46ae.Serializer::class)
public class InlineWebhookPullRequestSynchronizePullRequestHeadRepoOwnerXe2da46ae(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestSynchronizePullRequestHeadRepoOwnerTypeX513cbaf7? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestSynchronizePullRequestHeadRepoOwnerTypeX513cbaf7? =
        null
    ...
    public fun build(): InlineWebhookPullRequestSynchronizePullRequestHeadRepoOwnerXe2da46ae {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestSynchronizePullRequestHeadRepoOwnerXe2da46ae(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestSynchronizePullRequestHeadRepoOwnerXe2da46ae = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestSynchronizePullRequestHeadRepoOwnerXe2da46ae> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestSynchronizePullRequestHeadRepoOwnerXe2da46ae {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestSynchronizePullRequestHeadRepoOwnerXe2da46ae")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestSynchronizePullRequestHeadRepoOwnerXe2da46ae must be a JSON object")
      ...
      return InlineWebhookPullRequestSynchronizePullRequestHeadRepoOwnerXe2da46ae(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestSynchronizePullRequestHeadRepoOwnerTypeX513cbaf7>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestSynchronizePullRequestHeadRepoOwnerXe2da46ae) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestSynchronizePullRequestHeadRepoOwnerXe2da46ae")
...
public fun inlineWebhookPullRequestSynchronizePullRequestHeadRepoOwnerXe2da46ae(block: InlineWebhookPullRequestSynchronizePullRequestHeadRepoOwnerXe2da46ae.Builder.() -> Unit): InlineWebhookPullRequestSynchronizePullRequestHeadRepoOwnerXe2da46ae = InlineWebhookPullRequestSynchronizePullRequestHeadRepoOwnerXe2da46ae.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestSynchronizePullRequestHeadRepoOwnerXe2da46ae is missing required property '" + name + "'")
