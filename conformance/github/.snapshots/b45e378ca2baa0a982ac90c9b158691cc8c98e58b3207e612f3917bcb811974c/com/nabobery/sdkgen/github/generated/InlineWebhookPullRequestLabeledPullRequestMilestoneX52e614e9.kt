 ...
 * stone
 */
@Serializable(with = InlineWebhookPullRequestLabeledPullRequestMilestoneX52e614e9.Serializer::class)
public class InlineWebhookPullRequestLabeledPullRequestMilestoneX52e614e9(
  /**
  ...
  public val creator: InlineWebhookPullRequestLabeledPullRequestMilestoneCreatorX17fbbdbf?,
   ...
   */
  public val state: InlineWebhookPullRequestLabeledPullRequestMilestoneStateX47daa30e,
  /**
  ...
  public class Builder {
    ...
    private var stateValue: InlineWebhookPullRequestLabeledPullRequestMilestoneStateX47daa30e? =
        null

    public var state: InlineWebhookPullRequestLabeledPullRequestMilestoneStateX47daa30e
    ...
    private var creatorState:
        FieldState<InlineWebhookPullRequestLabeledPullRequestMilestoneCreatorX17fbbdbf?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var creator: InlineWebhookPullRequestLabeledPullRequestMilestoneCreatorX17fbbdbf?
    ...
    public fun build(): InlineWebhookPullRequestLabeledPullRequestMilestoneX52e614e9 {
      ...
      return InlineWebhookPullRequestLabeledPullRequestMilestoneX52e614e9(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestLabeledPullRequestMilestoneX52e614e9 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestLabeledPullRequestMilestoneX52e614e9> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestLabeledPullRequestMilestoneX52e614e9 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestLabeledPullRequestMilestoneX52e614e9")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestLabeledPullRequestMilestoneX52e614e9 must be a JSON object")
      ...
      val state = json.decodeRequired<InlineWebhookPullRequestLabeledPullRequestMilestoneStateX47daa30e>(rawObject, "state")
      val title = json.decodeRequired<String>(rawObject, "title")
      val updatedAt = json.decodeRequired<String>(rawObject, "updated_at")
      val url = json.decodeRequired<String>(rawObject, "url")
      if (!rawObject.containsKey("closed_at")) {
        throw SerializationException("InlineWebhookPullRequestLabeledPullRequestMilestoneX52e614e9 is missing required property 'closed_at'")
      }
      ...
      if (!rawObject.containsKey("creator")) {
        throw SerializationException("InlineWebhookPullRequestLabeledPullRequestMilestoneX52e614e9 is missing required property 'creator'")
      }
      val creator = rawObject["creator"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestLabeledPullRequestMilestoneCreatorX17fbbdbf?>(requireNotNull(element)) }
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookPullRequestLabeledPullRequestMilestoneX52e614e9 is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("due_on")) {
        throw SerializationException("InlineWebhookPullRequestLabeledPullRequestMilestoneX52e614e9 is missing required property 'due_on'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestLabeledPullRequestMilestoneX52e614e9) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestLabeledPullRequestMilestoneX52e614e9")
...
public fun inlineWebhookPullRequestLabeledPullRequestMilestoneX52e614e9(block: InlineWebhookPullRequestLabeledPullRequestMilestoneX52e614e9.Builder.() -> Unit): InlineWebhookPullRequestLabeledPullRequestMilestoneX52e614e9 = InlineWebhookPullRequestLabeledPullRequestMilestoneX52e614e9.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestLabeledPullRequestMilestoneX52e614e9 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookPullRequestLabeledPullRequestMilestoneX52e614e9 property '" + name + "' is not nullable")
