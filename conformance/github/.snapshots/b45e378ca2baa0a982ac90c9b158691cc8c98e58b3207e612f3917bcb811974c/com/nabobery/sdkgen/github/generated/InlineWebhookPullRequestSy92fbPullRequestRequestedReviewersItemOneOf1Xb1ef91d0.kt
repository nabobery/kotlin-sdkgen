 ...
 * requested_reviewers/items/oneOf/0.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-synchronize/properties/pull_request/properties/
 * requested_reviewers/items/oneOf/0
 */
@Serializable(with = InlineWebhookPullRequestSy92fbPullRequestRequestedReviewersItemOneOf1Xb1ef91d0.Serializer::class)
public class InlineWebhookPullRequestSy92fbPullRequestRequestedReviewersItemOneOf1Xb1ef91d0(
  public val id: Int,
  ...
  public val type:
      InlineWebhookPullRequestSy92fbPullRequestRequestedReviewersItemTypeX9cd01c63? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestSy92fbPullRequestRequestedReviewersItemTypeX9cd01c63? =
        null
    ...
    public fun build(): InlineWebhookPullRequestSy92fbPullRequestRequestedReviewersItemOneOf1Xb1ef91d0 {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestSy92fbPullRequestRequestedReviewersItemOneOf1Xb1ef91d0 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestSy92fbPullRequestRequestedReviewersItemOneOf1Xb1ef91d0> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestSy92fbPullRequestRequestedReviewersItemOneOf1Xb1ef91d0 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestSy92fbPullRequestRequestedReviewersItemOneOf1Xb1ef91d0")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestSy92fbPullRequestRequestedReviewersItemOneOf1Xb1ef91d0 must be a JSON object")
      ...
      return InlineWebhookPullRequestSy92fbPullRequestRequestedReviewersItemOneOf1Xb1ef91d0(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestSy92fbPullRequestRequestedReviewersItemTypeX9cd01c63>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestSy92fbPullRequestRequestedReviewersItemOneOf1Xb1ef91d0) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestSy92fbPullRequestRequestedReviewersItemOneOf1Xb1ef91d0")
...
public fun inlineWebhookPullRequestSy92fbPullRequestRequestedReviewersItemOneOf1Xb1ef91d0(block: InlineWebhookPullRequestSy92fbPullRequestRequestedReviewersItemOneOf1Xb1ef91d0.Builder.() -> Unit): InlineWebhookPullRequestSy92fbPullRequestRequestedReviewersItemOneOf1Xb1ef91d0 = InlineWebhookPullRequestSy92fbPullRequestRequestedReviewersItemOneOf1Xb1ef91d0.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestSy92fbPullRequestRequestedReviewersItemOneOf1Xb1ef91d0 is missing required property '" + name + "'")
