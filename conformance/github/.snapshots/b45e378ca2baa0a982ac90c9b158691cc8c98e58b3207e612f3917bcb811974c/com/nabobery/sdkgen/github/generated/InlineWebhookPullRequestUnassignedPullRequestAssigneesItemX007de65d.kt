 ...
 * ssignees/items
 */
@Serializable(with = InlineWebhookPullRequestUnassignedPullRequestAssigneesItemX007de65d.Serializer::class)
public class InlineWebhookPullRequestUnassignedPullRequestAssigneesItemX007de65d(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestUnassignedPullRequestAssigneesItemTypeXa802bcad? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestUnassignedPullRequestAssigneesItemTypeXa802bcad? = null
    ...
    public fun build(): InlineWebhookPullRequestUnassignedPullRequestAssigneesItemX007de65d {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestUnassignedPullRequestAssigneesItemX007de65d(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestUnassignedPullRequestAssigneesItemX007de65d = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestUnassignedPullRequestAssigneesItemX007de65d> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestUnassignedPullRequestAssigneesItemX007de65d {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestUnassignedPullRequestAssigneesItemX007de65d")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestUnassignedPullRequestAssigneesItemX007de65d must be a JSON object")
      ...
      return InlineWebhookPullRequestUnassignedPullRequestAssigneesItemX007de65d(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestUnassignedPullRequestAssigneesItemTypeXa802bcad>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestUnassignedPullRequestAssigneesItemX007de65d) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestUnassignedPullRequestAssigneesItemX007de65d")
...
public fun inlineWebhookPullRequestUnassignedPullRequestAssigneesItemX007de65d(block: InlineWebhookPullRequestUnassignedPullRequestAssigneesItemX007de65d.Builder.() -> Unit): InlineWebhookPullRequestUnassignedPullRequestAssigneesItemX007de65d = InlineWebhookPullRequestUnassignedPullRequestAssigneesItemX007de65d.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestUnassignedPullRequestAssigneesItemX007de65d is missing required property '" + name + "'")
