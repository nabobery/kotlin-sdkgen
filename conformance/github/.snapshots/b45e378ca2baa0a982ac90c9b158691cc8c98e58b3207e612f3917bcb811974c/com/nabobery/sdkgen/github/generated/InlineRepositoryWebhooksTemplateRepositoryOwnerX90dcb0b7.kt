...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/components/schemas/repository-webhooks/properties/template_repository/properties/owner.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/repository-webhooks/properties/template_repository/properties/owner
 */
@Serializable(with = InlineRepositoryWebhooksTemplateRepositoryOwnerX90dcb0b7.Serializer::class)
public class InlineRepositoryWebhooksTemplateRepositoryOwnerX90dcb0b7(
  ...
  public class Builder {
    ...
    public fun build(): InlineRepositoryWebhooksTemplateRepositoryOwnerX90dcb0b7 = InlineRepositoryWebhooksTemplateRepositoryOwnerX90dcb0b7(
      avatarUrl = avatarUrl,
      eventsUrl = eventsUrl,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineRepositoryWebhooksTemplateRepositoryOwnerX90dcb0b7 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineRepositoryWebhooksTemplateRepositoryOwnerX90dcb0b7> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineRepositoryWebhooksTemplateRepositoryOwnerX90dcb0b7 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineRepositoryWebhooksTemplateRepositoryOwnerX90dcb0b7")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineRepositoryWebhooksTemplateRepositoryOwnerX90dcb0b7 must be a JSON object")
      return InlineRepositoryWebhooksTemplateRepositoryOwnerX90dcb0b7(
    ...
    override fun serialize(encoder: Encoder, `value`: InlineRepositoryWebhooksTemplateRepositoryOwnerX90dcb0b7) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineRepositoryWebhooksTemplateRepositoryOwnerX90dcb0b7")
...
public fun inlineRepositoryWebhooksTemplateRepositoryOwnerX90dcb0b7(block: InlineRepositoryWebhooksTemplateRepositoryOwnerX90dcb0b7.Builder.() -> Unit): InlineRepositoryWebhooksTemplateRepositoryOwnerX90dcb0b7 = InlineRepositoryWebhooksTemplateRepositoryOwnerX90dcb0b7.build(block)
