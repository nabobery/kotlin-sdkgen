 ...
 * estone
 */
@Serializable(with = InlineWebhookPullRequestEnqueuedPullRequestMilestoneXd252e38b.Serializer::class)
public class InlineWebhookPullRequestEnqueuedPullRequestMilestoneXd252e38b(
  /**
  ...
  public val creator: InlineWebhookPullRequestEnqueuedPullRequestMilestoneCreatorXbb3764ee?,
   ...
   */
  public val state: InlineWebhookPullRequestEnqueuedPullRequestMilestoneStateXdb0f0409,
  /**
  ...
  public class Builder {
    ...
    private var stateValue: InlineWebhookPullRequestEnqueuedPullRequestMilestoneStateXdb0f0409? =
        null

    public var state: InlineWebhookPullRequestEnqueuedPullRequestMilestoneStateXdb0f0409
    ...
    private var creatorState:
        FieldState<InlineWebhookPullRequestEnqueuedPullRequestMilestoneCreatorXbb3764ee?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var creator: InlineWebhookPullRequestEnqueuedPullRequestMilestoneCreatorXbb3764ee?
    ...
    public fun build(): InlineWebhookPullRequestEnqueuedPullRequestMilestoneXd252e38b {
      ...
      return InlineWebhookPullRequestEnqueuedPullRequestMilestoneXd252e38b(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestEnqueuedPullRequestMilestoneXd252e38b = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestEnqueuedPullRequestMilestoneXd252e38b> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestEnqueuedPullRequestMilestoneXd252e38b {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestEnqueuedPullRequestMilestoneXd252e38b")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestEnqueuedPullRequestMilestoneXd252e38b must be a JSON object")
      ...
      val state = json.decodeRequired<InlineWebhookPullRequestEnqueuedPullRequestMilestoneStateXdb0f0409>(rawObject, "state")
      val title = json.decodeRequired<String>(rawObject, "title")
      val updatedAt = json.decodeRequired<String>(rawObject, "updated_at")
      val url = json.decodeRequired<String>(rawObject, "url")
      if (!rawObject.containsKey("closed_at")) {
        throw SerializationException("InlineWebhookPullRequestEnqueuedPullRequestMilestoneXd252e38b is missing required property 'closed_at'")
      }
      ...
      if (!rawObject.containsKey("creator")) {
        throw SerializationException("InlineWebhookPullRequestEnqueuedPullRequestMilestoneXd252e38b is missing required property 'creator'")
      }
      val creator = rawObject["creator"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestEnqueuedPullRequestMilestoneCreatorXbb3764ee?>(requireNotNull(element)) }
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookPullRequestEnqueuedPullRequestMilestoneXd252e38b is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("due_on")) {
        throw SerializationException("InlineWebhookPullRequestEnqueuedPullRequestMilestoneXd252e38b is missing required property 'due_on'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestEnqueuedPullRequestMilestoneXd252e38b) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestEnqueuedPullRequestMilestoneXd252e38b")
...
public fun inlineWebhookPullRequestEnqueuedPullRequestMilestoneXd252e38b(block: InlineWebhookPullRequestEnqueuedPullRequestMilestoneXd252e38b.Builder.() -> Unit): InlineWebhookPullRequestEnqueuedPullRequestMilestoneXd252e38b = InlineWebhookPullRequestEnqueuedPullRequestMilestoneXd252e38b.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestEnqueuedPullRequestMilestoneXd252e38b is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookPullRequestEnqueuedPullRequestMilestoneXd252e38b property '" + name + "' is not nullable")
