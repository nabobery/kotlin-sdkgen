 ...
 */
@Serializable(with = InlineWebhookIssueCommentUnpinnedIssueAllOf1PerformedViaGithubAppX8a563758.Serializer::class)
public class InlineWebhookIssueCommentUnpinnedIssueAllOf1PerformedViaGithubAppX8a563758 internal constructor(
  /**
  ...
  public val owner:
      InlineWebhookIssueCommentUnpinnedIssueAllOf1PerformedViaGithubAppOwnerX4b3f2706?,
  /**
   * Wire format: `date-time`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  public val updatedAt: String?,
  eventsState: FieldState<List<InlineWebhookIssueCommentUe6d8IssueAllOf1PerformedViaGithubAppItemX22b535e4>>,
  private val permissionsState:
      FieldState<InlineWebhookIssueCommentUe6d8IssueAllOf1PermissionsX3bc2660a>,
  private val slugState: FieldState<String>,
) {
  private val eventsState:
      FieldState<List<InlineWebhookIssueCommentUe6d8IssueAllOf1PerformedViaGithubAppItemX22b535e4>>
   ...
   */
  public val events:
      List<InlineWebhookIssueCommentUe6d8IssueAllOf1PerformedViaGithubAppItemX22b535e4>?
    get() = eventsState.valueOrNull()

  /**
   * The set of permissions for the GitHub app
   */
  public val permissions: InlineWebhookIssueCommentUe6d8IssueAllOf1PermissionsX3bc2660a?
  ...
  public constructor(
    ...
    name: String,
    nodeId: String,
    owner: InlineWebhookIssueCommentUnpinnedIssueAllOf1PerformedViaGithubAppOwnerX4b3f2706?,
    updatedAt: String?,
  ...
  public class Builder {
    ...
    private var ownerState:
        FieldState<InlineWebhookIssueCommentUnpinnedIssueAllOf1PerformedViaGithubAppOwnerX4b3f2706?>
        = FieldState.Absent
     ...
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var permissions: InlineWebhookIssueCommentUe6d8IssueAllOf1PermissionsX3bc2660a?
      get() = permissionsState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): InlineWebhookIssueCommentUnpinnedIssueAllOf1PerformedViaGithubAppX8a563758 {
      ...
      return InlineWebhookIssueCommentUnpinnedIssueAllOf1PerformedViaGithubAppX8a563758(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssueCommentUnpinnedIssueAllOf1PerformedViaGithubAppX8a563758 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssueCommentUnpinnedIssueAllOf1PerformedViaGithubAppX8a563758> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssueCommentUnpinnedIssueAllOf1PerformedViaGithubAppX8a563758 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssueCommentUnpinnedIssueAllOf1PerformedViaGithubAppX8a563758")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssueCommentUnpinnedIssueAllOf1PerformedViaGithubAppX8a563758 must be a JSON object")
      val htmlUrl = json.decodeRequired<String>(rawObject, "html_url")
      val name = json.decodeRequired<String>(rawObject, "name")
      val nodeId = json.decodeRequired<String>(rawObject, "node_id")
      if (!rawObject.containsKey("created_at")) {
        throw SerializationException("InlineWebhookIssueCommentUnpinnedIssueAllOf1PerformedViaGithubAppX8a563758 is missing required property 'created_at'")
      }
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookIssueCommentUnpinnedIssueAllOf1PerformedViaGithubAppX8a563758 is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("external_url")) {
        throw SerializationException("InlineWebhookIssueCommentUnpinnedIssueAllOf1PerformedViaGithubAppX8a563758 is missing required property 'external_url'")
      }
      ...
      if (!rawObject.containsKey("id")) {
        throw SerializationException("InlineWebhookIssueCommentUnpinnedIssueAllOf1PerformedViaGithubAppX8a563758 is missing required property 'id'")
      }
      ...
      if (!rawObject.containsKey("owner")) {
        throw SerializationException("InlineWebhookIssueCommentUnpinnedIssueAllOf1PerformedViaGithubAppX8a563758 is missing required property 'owner'")
      }
      val owner = rawObject["owner"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookIssueCommentUnpinnedIssueAllOf1PerformedViaGithubAppOwnerX4b3f2706?>(requireNotNull(element)) }
      if (!rawObject.containsKey("updated_at")) {
        throw SerializationException("InlineWebhookIssueCommentUnpinnedIssueAllOf1PerformedViaGithubAppX8a563758 is missing required property 'updated_at'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssueCommentUnpinnedIssueAllOf1PerformedViaGithubAppX8a563758) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssueCommentUnpinnedIssueAllOf1PerformedViaGithubAppX8a563758")
...
public fun inlineWebhookIssueCommentUnpinnedIssueAllOf1PerformedViaGithubAppX8a563758(block: InlineWebhookIssueCommentUnpinnedIssueAllOf1PerformedViaGithubAppX8a563758.Builder.() -> Unit): InlineWebhookIssueCommentUnpinnedIssueAllOf1PerformedViaGithubAppX8a563758 = InlineWebhookIssueCommentUnpinnedIssueAllOf1PerformedViaGithubAppX8a563758.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssueCommentUnpinnedIssueAllOf1PerformedViaGithubAppX8a563758 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookIssueCommentUnpinnedIssueAllOf1PerformedViaGithubAppX8a563758 property '" + name + "' is not nullable")
