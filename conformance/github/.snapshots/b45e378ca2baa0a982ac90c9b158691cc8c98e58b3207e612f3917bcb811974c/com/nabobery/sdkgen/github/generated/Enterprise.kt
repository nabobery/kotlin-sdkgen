...
@Serializable
public data class EnterpriseView(
 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/enterprise
 */
@Serializable(with = Enterprise.Serializer::class)
public class Enterprise internal constructor(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): Enterprise = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<Enterprise> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): Enterprise {
      val jsonDecoder = decoder.requireJsonDecoder("Enterprise")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("Enterprise must be a JSON object")
      ...
      if (!rawObject.containsKey("created_at")) {
        throw SerializationException("Enterprise is missing required property 'created_at'")
      }
      ...
      if (!rawObject.containsKey("updated_at")) {
        throw SerializationException("Enterprise is missing required property 'updated_at'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: Enterprise) {
      val jsonEncoder = encoder.requireJsonEncoder("Enterprise")
...
public fun enterprise(block: Enterprise.Builder.() -> Unit): Enterprise = Enterprise.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("Enterprise is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("Enterprise property '" + name + "' is not nullable")
