 ...
 * request/properties/auto_merge/properties/enabled_by.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-review-request-removed/oneOf/0/properties/pull_
 * request/properties/auto_merge/properties/enabled_by
 */
@Serializable(with = InlineWebhookPullRequestReacd1OneOf1PullRequestAutoMergeEnabledByX6a5fd49c.Serializer::class)
public class InlineWebhookPullRequestReacd1OneOf1PullRequestAutoMergeEnabledByX6a5fd49c(
  public val id: Int,
  ...
  public val type:
      InlineWebhookPullRequestReacd1OneOf1PullRequestAutoMergeEnabledByTypeXf1fbf169? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestReacd1OneOf1PullRequestAutoMergeEnabledByTypeXf1fbf169?
        = null
    ...
    public fun build(): InlineWebhookPullRequestReacd1OneOf1PullRequestAutoMergeEnabledByX6a5fd49c {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestReacd1OneOf1PullRequestAutoMergeEnabledByX6a5fd49c(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReacd1OneOf1PullRequestAutoMergeEnabledByX6a5fd49c = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReacd1OneOf1PullRequestAutoMergeEnabledByX6a5fd49c> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReacd1OneOf1PullRequestAutoMergeEnabledByX6a5fd49c {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReacd1OneOf1PullRequestAutoMergeEnabledByX6a5fd49c")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReacd1OneOf1PullRequestAutoMergeEnabledByX6a5fd49c must be a JSON object")
      ...
      return InlineWebhookPullRequestReacd1OneOf1PullRequestAutoMergeEnabledByX6a5fd49c(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestReacd1OneOf1PullRequestAutoMergeEnabledByTypeXf1fbf169>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReacd1OneOf1PullRequestAutoMergeEnabledByX6a5fd49c) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReacd1OneOf1PullRequestAutoMergeEnabledByX6a5fd49c")
...
public fun inlineWebhookPullRequestReacd1OneOf1PullRequestAutoMergeEnabledByX6a5fd49c(block: InlineWebhookPullRequestReacd1OneOf1PullRequestAutoMergeEnabledByX6a5fd49c.Builder.() -> Unit): InlineWebhookPullRequestReacd1OneOf1PullRequestAutoMergeEnabledByX6a5fd49c = InlineWebhookPullRequestReacd1OneOf1PullRequestAutoMergeEnabledByX6a5fd49c.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReacd1OneOf1PullRequestAutoMergeEnabledByX6a5fd49c is missing required property '" + name + "'")
