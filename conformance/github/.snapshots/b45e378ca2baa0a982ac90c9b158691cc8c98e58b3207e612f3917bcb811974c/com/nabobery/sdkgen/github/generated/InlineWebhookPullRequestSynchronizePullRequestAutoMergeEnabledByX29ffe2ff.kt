 ...
 * auto_merge/properties/enabled_by.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-synchronize/properties/pull_request/properties/
 * auto_merge/properties/enabled_by
 */
@Serializable(with = InlineWebhookPullRequestSynchronizePullRequestAutoMergeEnabledByX29ffe2ff.Serializer::class)
public class InlineWebhookPullRequestSynchronizePullRequestAutoMergeEnabledByX29ffe2ff(
  public val id: Int,
  ...
  public val type:
      InlineWebhookPullRequestSynchronizePullRequestAutoMergeEnabledByTypeX70929fca? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestSynchronizePullRequestAutoMergeEnabledByTypeX70929fca?
        = null
    ...
    public fun build(): InlineWebhookPullRequestSynchronizePullRequestAutoMergeEnabledByX29ffe2ff {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestSynchronizePullRequestAutoMergeEnabledByX29ffe2ff(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestSynchronizePullRequestAutoMergeEnabledByX29ffe2ff = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestSynchronizePullRequestAutoMergeEnabledByX29ffe2ff> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestSynchronizePullRequestAutoMergeEnabledByX29ffe2ff {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestSynchronizePullRequestAutoMergeEnabledByX29ffe2ff")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestSynchronizePullRequestAutoMergeEnabledByX29ffe2ff must be a JSON object")
      ...
      return InlineWebhookPullRequestSynchronizePullRequestAutoMergeEnabledByX29ffe2ff(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestSynchronizePullRequestAutoMergeEnabledByTypeX70929fca>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestSynchronizePullRequestAutoMergeEnabledByX29ffe2ff) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestSynchronizePullRequestAutoMergeEnabledByX29ffe2ff")
...
public fun inlineWebhookPullRequestSynchronizePullRequestAutoMergeEnabledByX29ffe2ff(block: InlineWebhookPullRequestSynchronizePullRequestAutoMergeEnabledByX29ffe2ff.Builder.() -> Unit): InlineWebhookPullRequestSynchronizePullRequestAutoMergeEnabledByX29ffe2ff = InlineWebhookPullRequestSynchronizePullRequestAutoMergeEnabledByX29ffe2ff.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestSynchronizePullRequestAutoMergeEnabledByX29ffe2ff is missing required property '" + name + "'")
