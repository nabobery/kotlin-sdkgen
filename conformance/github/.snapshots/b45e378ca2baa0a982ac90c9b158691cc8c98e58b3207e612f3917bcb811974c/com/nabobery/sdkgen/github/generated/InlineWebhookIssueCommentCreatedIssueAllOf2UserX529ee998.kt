...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-issue-comment-created/properties/issue/allOf/1/properties/us
 * er.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-issue-comment-created/properties/issue/allOf/1/properties/us
 * er
 */
@Serializable(with = InlineWebhookIssueCommentCreatedIssueAllOf2UserX529ee998.Serializer::class)
public class InlineWebhookIssueCommentCreatedIssueAllOf2UserX529ee998(
  ...
  public class Builder {
    ...
    public fun build(): InlineWebhookIssueCommentCreatedIssueAllOf2UserX529ee998 = InlineWebhookIssueCommentCreatedIssueAllOf2UserX529ee998(
      avatarUrl = avatarUrl,
      eventsUrl = eventsUrl,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssueCommentCreatedIssueAllOf2UserX529ee998 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssueCommentCreatedIssueAllOf2UserX529ee998> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssueCommentCreatedIssueAllOf2UserX529ee998 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssueCommentCreatedIssueAllOf2UserX529ee998")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssueCommentCreatedIssueAllOf2UserX529ee998 must be a JSON object")
      return InlineWebhookIssueCommentCreatedIssueAllOf2UserX529ee998(
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssueCommentCreatedIssueAllOf2UserX529ee998) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssueCommentCreatedIssueAllOf2UserX529ee998")
...
public fun inlineWebhookIssueCommentCreatedIssueAllOf2UserX529ee998(block: InlineWebhookIssueCommentCreatedIssueAllOf2UserX529ee998.Builder.() -> Unit): InlineWebhookIssueCommentCreatedIssueAllOf2UserX529ee998 = InlineWebhookIssueCommentCreatedIssueAllOf2UserX529ee998.build(block)
