...
/**
 * Generated model for sdkgen://source/openapi.yaml#/components/schemas/secret-scanning-alert-with-metadata.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/secret-scanning-alert-with-metadata
 */
@Serializable(with = SecretScanningAlertWithMetadata.Serializer::class)
public class SecretScanningAlertWithMetadata(
  ...
  metadata: List<InlineSecretScanningAlertMetadataItemX047497f2>? = null,
  /**
   ...
   */
  public val validity: InlineSecretScanningAlertWithMetadataValidityXc3ff802f? = null,
) {
  public val metadata: List<InlineSecretScanningAlertMetadataItemX047497f2>? =
      metadata?.let { collection0 -> collection0.toList() }
  ...
  public class Builder {
    ...
    private var metadataValue: List<InlineSecretScanningAlertMetadataItemX047497f2>? = null

    public var metadata: List<InlineSecretScanningAlertMetadataItemX047497f2>?
      get() = metadataValue?.let { collection0 -> collection0.toList() }
      set(`value`) {
        metadataValue = value?.let { collection0 -> collection0.toList() }
      }
     ...
     * The token status as of the latest validity check.
     */
    public var validity: InlineSecretScanningAlertWithMetadataValidityXc3ff802f? = null

    public fun build(): SecretScanningAlertWithMetadata = SecretScanningAlertWithMetadata(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): SecretScanningAlertWithMetadata = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<SecretScanningAlertWithMetadata> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): SecretScanningAlertWithMetadata {
      val jsonDecoder = decoder.requireJsonDecoder("SecretScanningAlertWithMetadata")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("SecretScanningAlertWithMetadata must be a JSON object")
      return SecretScanningAlertWithMetadata(
        ...
        validity = rawObject["validity"]?.let { json.decodeFromJsonElement<InlineSecretScanningAlertWithMetadataValidityXc3ff802f>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: SecretScanningAlertWithMetadata) {
      val jsonEncoder = encoder.requireJsonEncoder("SecretScanningAlertWithMetadata")
...
public fun secretScanningAlertWithMetadata(block: SecretScanningAlertWithMetadata.Builder.() -> Unit): SecretScanningAlertWithMetadata = SecretScanningAlertWithMetadata.build(block)
