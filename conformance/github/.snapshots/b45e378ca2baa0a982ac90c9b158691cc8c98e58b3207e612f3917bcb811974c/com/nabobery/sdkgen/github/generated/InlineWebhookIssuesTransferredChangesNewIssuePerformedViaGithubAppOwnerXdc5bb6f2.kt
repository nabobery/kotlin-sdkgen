 ...
 * roperties/performed_via_github_app/properties/owner.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-transferred/properties/changes/properties/new_issue/p
 * roperties/performed_via_github_app/properties/owner
 */
@Serializable(with = InlineWebhookIssuesTransferredChangesNewIssuePerformedViaGithubAppOwnerXdc5bb6f2.Serializer::class)
public class InlineWebhookIssuesTransferredChangesNewIssuePerformedViaGithubAppOwnerXdc5bb6f2(
  public val id: Int,
  ...
  public val type:
      InlineWebhookIssuesTransferredChangesNewIssuePerformedViaGithubAppTypeX223abf93? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public fun build(): InlineWebhookIssuesTransferredChangesNewIssuePerformedViaGithubAppOwnerXdc5bb6f2 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssuesTransferredChangesNewIssuePerformedViaGithubAppOwnerXdc5bb6f2(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesTransferredChangesNewIssuePerformedViaGithubAppOwnerXdc5bb6f2 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesTransferredChangesNewIssuePerformedViaGithubAppOwnerXdc5bb6f2> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesTransferredChangesNewIssuePerformedViaGithubAppOwnerXdc5bb6f2 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesTransferredChangesNewIssuePerformedViaGithubAppOwnerXdc5bb6f2")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesTransferredChangesNewIssuePerformedViaGithubAppOwnerXdc5bb6f2 must be a JSON object")
      ...
      return InlineWebhookIssuesTransferredChangesNewIssuePerformedViaGithubAppOwnerXdc5bb6f2(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssuesTransferredChangesNewIssuePerformedViaGithubAppTypeX223abf93>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesTransferredChangesNewIssuePerformedViaGithubAppOwnerXdc5bb6f2) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesTransferredChangesNewIssuePerformedViaGithubAppOwnerXdc5bb6f2")
...
public fun inlineWebhookIssuesTransferredChangesNewIssuePerformedViaGithubAppOwnerXdc5bb6f2(block: InlineWebhookIssuesTransferredChangesNewIssuePerformedViaGithubAppOwnerXdc5bb6f2.Builder.() -> Unit): InlineWebhookIssuesTransferredChangesNewIssuePerformedViaGithubAppOwnerXdc5bb6f2 = InlineWebhookIssuesTransferredChangesNewIssuePerformedViaGithubAppOwnerXdc5bb6f2.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesTransferredChangesNewIssuePerformedViaGithubAppOwnerXdc5bb6f2 is missing required property '" + name + "'")
