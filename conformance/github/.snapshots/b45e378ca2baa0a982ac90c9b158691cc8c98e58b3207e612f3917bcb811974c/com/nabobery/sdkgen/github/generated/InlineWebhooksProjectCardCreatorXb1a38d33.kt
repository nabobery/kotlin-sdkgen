...
/**
 * Generated model for sdkgen://source/openapi.yaml#/components/schemas/webhooks_project_card/properties/creator.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhooks_project_card/properties/creator
 */
@Serializable(with = InlineWebhooksProjectCardCreatorXb1a38d33.Serializer::class)
public class InlineWebhooksProjectCardCreatorXb1a38d33(
  public val id: Int,
  ...
  public val type: InlineWebhooksProjectCardCreatorTypeX1ab7bdef? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhooksProjectCardCreatorTypeX1ab7bdef? = null
    ...
    public fun build(): InlineWebhooksProjectCardCreatorXb1a38d33 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhooksProjectCardCreatorXb1a38d33(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhooksProjectCardCreatorXb1a38d33 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhooksProjectCardCreatorXb1a38d33> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhooksProjectCardCreatorXb1a38d33 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhooksProjectCardCreatorXb1a38d33")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhooksProjectCardCreatorXb1a38d33 must be a JSON object")
      ...
      return InlineWebhooksProjectCardCreatorXb1a38d33(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhooksProjectCardCreatorTypeX1ab7bdef>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhooksProjectCardCreatorXb1a38d33) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhooksProjectCardCreatorXb1a38d33")
...
public fun inlineWebhooksProjectCardCreatorXb1a38d33(block: InlineWebhooksProjectCardCreatorXb1a38d33.Builder.() -> Unit): InlineWebhooksProjectCardCreatorXb1a38d33 = InlineWebhooksProjectCardCreatorXb1a38d33.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhooksProjectCardCreatorXb1a38d33 is missing required property '" + name + "'")
