...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-package-published/properties/package/properties/owner.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-package-published/properties/package/properties/owner
 */
@Serializable(with = InlineWebhookPackagePublishedPackageValueOwnerXb682cbbc.Serializer::class)
public class InlineWebhookPackagePublishedPackageValueOwnerXb682cbbc(
  public val id: Int,
  ...
  public val type: InlineWebhookPackagePublishedPackageValueOwnerTypeXfc84d5a1? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPackagePublishedPackageValueOwnerTypeXfc84d5a1? = null
    ...
    public fun build(): InlineWebhookPackagePublishedPackageValueOwnerXb682cbbc {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPackagePublishedPackageValueOwnerXb682cbbc(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPackagePublishedPackageValueOwnerXb682cbbc = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPackagePublishedPackageValueOwnerXb682cbbc> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPackagePublishedPackageValueOwnerXb682cbbc {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPackagePublishedPackageValueOwnerXb682cbbc")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPackagePublishedPackageValueOwnerXb682cbbc must be a JSON object")
      ...
      return InlineWebhookPackagePublishedPackageValueOwnerXb682cbbc(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPackagePublishedPackageValueOwnerTypeXfc84d5a1>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPackagePublishedPackageValueOwnerXb682cbbc) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPackagePublishedPackageValueOwnerXb682cbbc")
...
public fun inlineWebhookPackagePublishedPackageValueOwnerXb682cbbc(block: InlineWebhookPackagePublishedPackageValueOwnerXb682cbbc.Builder.() -> Unit): InlineWebhookPackagePublishedPackageValueOwnerXb682cbbc = InlineWebhookPackagePublishedPackageValueOwnerXb682cbbc.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPackagePublishedPackageValueOwnerXb682cbbc is missing required property '" + name + "'")
