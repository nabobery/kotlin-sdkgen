...
/**
 * Generated model for sdkgen://source/openapi.yaml#/components/schemas/webhooks_issue_2/properties/assignee.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhooks_issue_2/properties/assignee
 */
@Serializable(with = InlineWebhooksIssue2AssigneeX8dd91385.Serializer::class)
public class InlineWebhooksIssue2AssigneeX8dd91385(
  public val id: Int,
  ...
  public val type: InlineWebhooksIssue2AssigneeTypeXaf6611f1? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhooksIssue2AssigneeTypeXaf6611f1? = null
    ...
    public fun build(): InlineWebhooksIssue2AssigneeX8dd91385 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhooksIssue2AssigneeX8dd91385(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhooksIssue2AssigneeX8dd91385 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhooksIssue2AssigneeX8dd91385> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhooksIssue2AssigneeX8dd91385 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhooksIssue2AssigneeX8dd91385")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhooksIssue2AssigneeX8dd91385 must be a JSON object")
      ...
      return InlineWebhooksIssue2AssigneeX8dd91385(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhooksIssue2AssigneeTypeXaf6611f1>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhooksIssue2AssigneeX8dd91385) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhooksIssue2AssigneeX8dd91385")
...
public fun inlineWebhooksIssue2AssigneeX8dd91385(block: InlineWebhooksIssue2AssigneeX8dd91385.Builder.() -> Unit): InlineWebhooksIssue2AssigneeX8dd91385 = InlineWebhooksIssue2AssigneeX8dd91385.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhooksIssue2AssigneeX8dd91385 is missing required property '" + name + "'")
