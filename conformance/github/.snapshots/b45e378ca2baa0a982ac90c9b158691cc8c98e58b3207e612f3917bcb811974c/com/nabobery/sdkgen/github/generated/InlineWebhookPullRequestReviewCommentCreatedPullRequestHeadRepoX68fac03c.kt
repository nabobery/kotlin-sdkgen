 ...
 * properties/head/properties/repo
 */
@Serializable(with = InlineWebhookPullRequestReviewCommentCreatedPullRequestHeadRepoX68fac03c.Serializer::class)
public class InlineWebhookPullRequestReviewCommentCreatedPullRequestHeadRepoX68fac03c internal constructor(
  /**
  ...
  public val createdAt: InlineWebhookPullRequestRe0d91PullRequestHeadRepoCreatedAtX7a2d8400,
  /**
  ...
  public val license:
      InlineWebhookPullRequestReviewCommentCreatedPullRequestHeadRepoLicenseX356a2a1d?,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val owner: InlineWebhookPullRequestReviewCommentCreatedPullRequestHeadRepoOwnerXa57f7b05?,
  /**
  ...
  public val pushedAt:
      InlineWebhookPullRequestReviewCommentCreatedPullRequestHeadRepoPushedAtX18fc73cc?,
  /**
   * Wire format: `uri-template`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val visibility: InlineWebhookPullRequestRe0d91PullRequestHeadRepoVisibilityX4ba0b604,
  ...
  private val mergeCommitMessageState:
      FieldState<InlineWebhookPullRequestRe0d91PullRequestHeadRepoMergeCommitMessageX5cbb1af7>,
  private val mergeCommitTitleState:
      FieldState<InlineWebhookPullRequestRe0d91PullRequestHeadRepoMergeCommitTitleXa0b29558>,
  private val organizationState: FieldState<String>,
  private val permissionsState:
      FieldState<InlineWebhookPullRequestRe0d91PullRequestHeadRepoPermissionsX9e29f540>,
  private val publicState: FieldState<Boolean>,
  private val pullRequestCreationPolicyState:
      FieldState<InlineWebhookPullRequestRe0d91PullRequestHeadPullRequestCreationP824dX91cdb93a>,
  private val roleNameState: FieldState<String?>,
  private val squashMergeCommitMessageState:
      FieldState<InlineWebhookPullRequestRe0d91PullRequestHeadSquashMergeCommitMessageX96269fc5>,
  private val squashMergeCommitTitleState:
      FieldState<InlineWebhookPullRequestRe0d91PullRequestHeadRepoSquashMergeCommitTitleXd8960885>,
  ...
  public val permissions: InlineWebhookPullRequestRe0d91PullRequestHeadRepoPermissionsX9e29f540?
  ...
  public val pullRequestCreationPolicy:
      InlineWebhookPullRequestRe0d91PullRequestHeadPullRequestCreationP824dX91cdb93a?
  ...
  public val squashMergeCommitMessage:
      InlineWebhookPullRequestRe0d91PullRequestHeadSquashMergeCommitMessageX96269fc5?
  ...
  public constructor(
    ...
    createdAt: InlineWebhookPullRequestRe0d91PullRequestHeadRepoCreatedAtX7a2d8400,
    ...
    language: String?,
    languagesUrl: String,
    license: InlineWebhookPullRequestReviewCommentCreatedPullRequestHeadRepoLicenseX356a2a1d?,
    mergesUrl: String,
    ...
    openIssues: Int,
    openIssuesCount: Int,
    owner: InlineWebhookPullRequestReviewCommentCreatedPullRequestHeadRepoOwnerXa57f7b05?,
    `private`: Boolean,
    pullsUrl: String,
    pushedAt: InlineWebhookPullRequestReviewCommentCreatedPullRequestHeadRepoPushedAtX18fc73cc?,
    releasesUrl: String,
    size: Int,
    sshUrl: String,
    stargazersCount: Int,
    ...
    updatedAt: String,
    url: String,
    visibility: InlineWebhookPullRequestRe0d91PullRequestHeadRepoVisibilityX4ba0b604,
    watchers: Int,
    watchersCount: Int,
  ...
  public class Builder {
    ...
    private var createdAtValue: InlineWebhookPullRequestRe0d91PullRequestHeadRepoCreatedAtX7a2d8400?
        = null

    public var createdAt: InlineWebhookPullRequestRe0d91PullRequestHeadRepoCreatedAtX7a2d8400
    ...
    private var visibilityValue:
        InlineWebhookPullRequestRe0d91PullRequestHeadRepoVisibilityX4ba0b604? = null

    public var visibility: InlineWebhookPullRequestRe0d91PullRequestHeadRepoVisibilityX4ba0b604
    ...
    private var licenseState:
        FieldState<InlineWebhookPullRequestReviewCommentCreatedPullRequestHeadRepoLicenseX356a2a1d?>
        = FieldState.Absent
    ...
    private var ownerState:
        FieldState<InlineWebhookPullRequestReviewCommentCreatedPullRequestHeadRepoOwnerXa57f7b05?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var owner: InlineWebhookPullRequestReviewCommentCreatedPullRequestHeadRepoOwnerXa57f7b05?
    ...
    private var pushedAtState:
        FieldState<InlineWebhookPullRequestReviewCommentCreatedPullRequestHeadRepoPushedAtX18fc73cc?>
        = FieldState.Absent
     ...
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var permissions: InlineWebhookPullRequestRe0d91PullRequestHeadRepoPermissionsX9e29f540?
      get() = permissionsState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): InlineWebhookPullRequestReviewCommentCreatedPullRequestHeadRepoX68fac03c {
      ...
      return InlineWebhookPullRequestReviewCommentCreatedPullRequestHeadRepoX68fac03c(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewCommentCreatedPullRequestHeadRepoX68fac03c = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewCommentCreatedPullRequestHeadRepoX68fac03c> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewCommentCreatedPullRequestHeadRepoX68fac03c {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewCommentCreatedPullRequestHeadRepoX68fac03c")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewCommentCreatedPullRequestHeadRepoX68fac03c must be a JSON object")
      ...
      val createdAt = json.decodeRequired<InlineWebhookPullRequestRe0d91PullRequestHeadRepoCreatedAtX7a2d8400>(rawObject, "created_at")
      ...
      val visibility = json.decodeRequired<InlineWebhookPullRequestRe0d91PullRequestHeadRepoVisibilityX4ba0b604>(rawObject, "visibility")
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookPullRequestReviewCommentCreatedPullRequestHeadRepoX68fac03c is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("homepage")) {
        throw SerializationException("InlineWebhookPullRequestReviewCommentCreatedPullRequestHeadRepoX68fac03c is missing required property 'homepage'")
      }
      ...
      if (!rawObject.containsKey("language")) {
        throw SerializationException("InlineWebhookPullRequestReviewCommentCreatedPullRequestHeadRepoX68fac03c is missing required property 'language'")
      }
      ...
      if (!rawObject.containsKey("license")) {
        throw SerializationException("InlineWebhookPullRequestReviewCommentCreatedPullRequestHeadRepoX68fac03c is missing required property 'license'")
      }
      val license = rawObject["license"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestReviewCommentCreatedPullRequestHeadRepoLicenseX356a2a1d?>(requireNotNull(element)) }
      if (!rawObject.containsKey("mirror_url")) {
        throw SerializationException("InlineWebhookPullRequestReviewCommentCreatedPullRequestHeadRepoX68fac03c is missing required property 'mirror_url'")
      }
      ...
      if (!rawObject.containsKey("owner")) {
        throw SerializationException("InlineWebhookPullRequestReviewCommentCreatedPullRequestHeadRepoX68fac03c is missing required property 'owner'")
      }
      val owner = rawObject["owner"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestReviewCommentCreatedPullRequestHeadRepoOwnerXa57f7b05?>(requireNotNull(element)) }
      if (!rawObject.containsKey("pushed_at")) {
        throw SerializationException("InlineWebhookPullRequestReviewCommentCreatedPullRequestHeadRepoX68fac03c is missing required property 'pushed_at'")
      }
      val pushedAt = rawObject["pushed_at"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestReviewCommentCreatedPullRequestHeadRepoPushedAtX18fc73cc?>(requireNotNull(element)) }
      return InlineWebhookPullRequestReviewCommentCreatedPullRequestHeadRepoX68fac03c(
        archiveUrl = archiveUrl,
        archived = archived,
        assigneesUrl = assigneesUrl,
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewCommentCreatedPullRequestHeadRepoX68fac03c) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewCommentCreatedPullRequestHeadRepoX68fac03c")
...
public fun inlineWebhookPullRequestReviewCommentCreatedPullRequestHeadRepoX68fac03c(block: InlineWebhookPullRequestReviewCommentCreatedPullRequestHeadRepoX68fac03c.Builder.() -> Unit): InlineWebhookPullRequestReviewCommentCreatedPullRequestHeadRepoX68fac03c = InlineWebhookPullRequestReviewCommentCreatedPullRequestHeadRepoX68fac03c.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewCommentCreatedPullRequestHeadRepoX68fac03c is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookPullRequestReviewCommentCreatedPullRequestHeadRepoX68fac03c property '" + name + "' is not nullable")
