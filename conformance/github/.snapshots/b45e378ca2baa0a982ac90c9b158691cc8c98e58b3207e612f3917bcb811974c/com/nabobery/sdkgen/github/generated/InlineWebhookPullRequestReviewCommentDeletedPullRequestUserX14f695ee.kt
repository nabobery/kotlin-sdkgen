 ...
 * properties/user
 */
@Serializable(with = InlineWebhookPullRequestReviewCommentDeletedPullRequestUserX14f695ee.Serializer::class)
public class InlineWebhookPullRequestReviewCommentDeletedPullRequestUserX14f695ee(
  public val id: Long,
  ...
  public val type: InlineWebhookPullRequestReviewCommentDeletedPullRequestUserTypeX36cbed3b? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestReviewCommentDeletedPullRequestUserTypeX36cbed3b? =
        null
    ...
    public fun build(): InlineWebhookPullRequestReviewCommentDeletedPullRequestUserX14f695ee {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestReviewCommentDeletedPullRequestUserX14f695ee(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewCommentDeletedPullRequestUserX14f695ee = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewCommentDeletedPullRequestUserX14f695ee> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewCommentDeletedPullRequestUserX14f695ee {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewCommentDeletedPullRequestUserX14f695ee")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewCommentDeletedPullRequestUserX14f695ee must be a JSON object")
      ...
      return InlineWebhookPullRequestReviewCommentDeletedPullRequestUserX14f695ee(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestReviewCommentDeletedPullRequestUserTypeX36cbed3b>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewCommentDeletedPullRequestUserX14f695ee) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewCommentDeletedPullRequestUserX14f695ee")
...
public fun inlineWebhookPullRequestReviewCommentDeletedPullRequestUserX14f695ee(block: InlineWebhookPullRequestReviewCommentDeletedPullRequestUserX14f695ee.Builder.() -> Unit): InlineWebhookPullRequestReviewCommentDeletedPullRequestUserX14f695ee = InlineWebhookPullRequestReviewCommentDeletedPullRequestUserX14f695ee.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewCommentDeletedPullRequestUserX14f695ee is missing required property '" + name + "'")
