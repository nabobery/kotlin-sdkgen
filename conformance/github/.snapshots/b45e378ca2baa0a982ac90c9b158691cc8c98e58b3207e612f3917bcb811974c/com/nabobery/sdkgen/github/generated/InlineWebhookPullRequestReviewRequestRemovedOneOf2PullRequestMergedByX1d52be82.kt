 ...
 * request/properties/merged_by.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-review-request-removed/oneOf/1/properties/pull_
 * request/properties/merged_by
 */
@Serializable(with = InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestMergedByX1d52be82.Serializer::class)
public class InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestMergedByX1d52be82(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestReacd1OneOf2PullRequestMergedByTypeX01c410b2? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestReacd1OneOf2PullRequestMergedByTypeX01c410b2? = null
    ...
    public fun build(): InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestMergedByX1d52be82 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestMergedByX1d52be82(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestMergedByX1d52be82 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestMergedByX1d52be82> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestMergedByX1d52be82 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestMergedByX1d52be82")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestMergedByX1d52be82 must be a JSON object")
      ...
      return InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestMergedByX1d52be82(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestReacd1OneOf2PullRequestMergedByTypeX01c410b2>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestMergedByX1d52be82) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestMergedByX1d52be82")
...
public fun inlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestMergedByX1d52be82(block: InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestMergedByX1d52be82.Builder.() -> Unit): InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestMergedByX1d52be82 = InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestMergedByX1d52be82.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewRequestRemovedOneOf2PullRequestMergedByX1d52be82 is missing required property '" + name + "'")
