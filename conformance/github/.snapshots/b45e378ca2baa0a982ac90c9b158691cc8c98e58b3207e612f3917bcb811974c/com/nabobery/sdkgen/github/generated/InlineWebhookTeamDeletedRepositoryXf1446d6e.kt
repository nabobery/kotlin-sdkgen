 ...
 * A git repository
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhook-team-deleted/properties/repository
 */
@Serializable(with = InlineWebhookTeamDeletedRepositoryXf1446d6e.Serializer::class)
public class InlineWebhookTeamDeletedRepositoryXf1446d6e internal constructor(
  /**
  ...
  public val createdAt: InlineWebhookTeamDeletedRepositoryCreatedAtXb2c1d22a,
  /**
  ...
  public val license: InlineWebhookTeamDeletedRepositoryLicenseX411156f7?,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val owner: InlineWebhookTeamDeletedRepositoryOwnerXfa29679e?,
  /**
  ...
  public val pushedAt: InlineWebhookTeamDeletedRepositoryPushedAtXd9a6fab7?,
  /**
   * Wire format: `uri-template`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val visibility: InlineWebhookTeamDeletedRepositoryVisibilityX6cdff3e2,
  ...
  private val permissionsState: FieldState<InlineWebhookTeamDeletedRepositoryPermissionsX25eb1b1c>,
  ...
  public val permissions: InlineWebhookTeamDeletedRepositoryPermissionsX25eb1b1c?
  ...
  public constructor(
    ...
    createdAt: InlineWebhookTeamDeletedRepositoryCreatedAtXb2c1d22a,
    ...
    language: String?,
    languagesUrl: String,
    license: InlineWebhookTeamDeletedRepositoryLicenseX411156f7?,
    mergesUrl: String,
    ...
    openIssues: Int,
    openIssuesCount: Int,
    owner: InlineWebhookTeamDeletedRepositoryOwnerXfa29679e?,
    `private`: Boolean,
    pullsUrl: String,
    pushedAt: InlineWebhookTeamDeletedRepositoryPushedAtXd9a6fab7?,
    releasesUrl: String,
    size: Int,
    sshUrl: String,
    stargazersCount: Int,
    ...
    updatedAt: String,
    url: String,
    visibility: InlineWebhookTeamDeletedRepositoryVisibilityX6cdff3e2,
    watchers: Int,
    watchersCount: Int,
  ...
  public class Builder {
    ...
    private var createdAtValue: InlineWebhookTeamDeletedRepositoryCreatedAtXb2c1d22a? = null

    public var createdAt: InlineWebhookTeamDeletedRepositoryCreatedAtXb2c1d22a
    ...
    private var visibilityValue: InlineWebhookTeamDeletedRepositoryVisibilityX6cdff3e2? = null

    public var visibility: InlineWebhookTeamDeletedRepositoryVisibilityX6cdff3e2
    ...
    private var licenseState: FieldState<InlineWebhookTeamDeletedRepositoryLicenseX411156f7?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var license: InlineWebhookTeamDeletedRepositoryLicenseX411156f7?
    ...
    private var ownerState: FieldState<InlineWebhookTeamDeletedRepositoryOwnerXfa29679e?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var owner: InlineWebhookTeamDeletedRepositoryOwnerXfa29679e?
      get() = ownerState.valueOrNull()
      set(`value`) {
        ownerState = value.toNullableFieldState()
      }

    private var pushedAtState: FieldState<InlineWebhookTeamDeletedRepositoryPushedAtXd9a6fab7?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var pushedAt: InlineWebhookTeamDeletedRepositoryPushedAtXd9a6fab7?
    ...
    private var permissionsState: FieldState<InlineWebhookTeamDeletedRepositoryPermissionsX25eb1b1c>
        = FieldState.Absent

    /**
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var permissions: InlineWebhookTeamDeletedRepositoryPermissionsX25eb1b1c?
      get() = permissionsState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): InlineWebhookTeamDeletedRepositoryXf1446d6e {
      ...
      return InlineWebhookTeamDeletedRepositoryXf1446d6e(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookTeamDeletedRepositoryXf1446d6e = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookTeamDeletedRepositoryXf1446d6e> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookTeamDeletedRepositoryXf1446d6e {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookTeamDeletedRepositoryXf1446d6e")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookTeamDeletedRepositoryXf1446d6e must be a JSON object")
      ...
      val createdAt = json.decodeRequired<InlineWebhookTeamDeletedRepositoryCreatedAtXb2c1d22a>(rawObject, "created_at")
      ...
      val visibility = json.decodeRequired<InlineWebhookTeamDeletedRepositoryVisibilityX6cdff3e2>(rawObject, "visibility")
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookTeamDeletedRepositoryXf1446d6e is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("homepage")) {
        throw SerializationException("InlineWebhookTeamDeletedRepositoryXf1446d6e is missing required property 'homepage'")
      }
      ...
      if (!rawObject.containsKey("language")) {
        throw SerializationException("InlineWebhookTeamDeletedRepositoryXf1446d6e is missing required property 'language'")
      }
      ...
      if (!rawObject.containsKey("license")) {
        throw SerializationException("InlineWebhookTeamDeletedRepositoryXf1446d6e is missing required property 'license'")
      }
      val license = rawObject["license"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookTeamDeletedRepositoryLicenseX411156f7?>(requireNotNull(element)) }
      if (!rawObject.containsKey("mirror_url")) {
        throw SerializationException("InlineWebhookTeamDeletedRepositoryXf1446d6e is missing required property 'mirror_url'")
      }
      ...
      if (!rawObject.containsKey("owner")) {
        throw SerializationException("InlineWebhookTeamDeletedRepositoryXf1446d6e is missing required property 'owner'")
      }
      val owner = rawObject["owner"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookTeamDeletedRepositoryOwnerXfa29679e?>(requireNotNull(element)) }
      if (!rawObject.containsKey("pushed_at")) {
        throw SerializationException("InlineWebhookTeamDeletedRepositoryXf1446d6e is missing required property 'pushed_at'")
      }
      val pushedAt = rawObject["pushed_at"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookTeamDeletedRepositoryPushedAtXd9a6fab7?>(requireNotNull(element)) }
      return InlineWebhookTeamDeletedRepositoryXf1446d6e(
        archiveUrl = archiveUrl,
        archived = archived,
        assigneesUrl = assigneesUrl,
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookTeamDeletedRepositoryXf1446d6e) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookTeamDeletedRepositoryXf1446d6e")
...
public fun inlineWebhookTeamDeletedRepositoryXf1446d6e(block: InlineWebhookTeamDeletedRepositoryXf1446d6e.Builder.() -> Unit): InlineWebhookTeamDeletedRepositoryXf1446d6e = InlineWebhookTeamDeletedRepositoryXf1446d6e.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookTeamDeletedRepositoryXf1446d6e is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookTeamDeletedRepositoryXf1446d6e property '" + name + "' is not nullable")
