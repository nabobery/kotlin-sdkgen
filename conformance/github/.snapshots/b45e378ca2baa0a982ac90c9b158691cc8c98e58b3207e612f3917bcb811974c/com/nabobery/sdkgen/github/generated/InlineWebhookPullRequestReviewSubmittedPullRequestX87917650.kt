...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-review-submitted/properties/pull_request.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-review-submitted/properties/pull_request
 */
@Serializable(with = InlineWebhookPullRequestReviewSubmittedPullRequestX87917650.Serializer::class)
public class InlineWebhookPullRequestReviewSubmittedPullRequestX87917650(
  public val links: InlineWebhookPullRequestReviewSubmittedPullRequestLinksX2c7957bc,
  public val activeLockReason:
      InlineWebhookPullRequestReviewSubmittedPullRequestActiveLockReasonXc4e689a0?,
  public val assignee: InlineWebhookPullRequestReviewSubmittedPullRequestAssigneeX5b55f04d?,
  assignees: List<InlineWebhookPullRequestReviewSubmittedPullRequestAssigneesItemX06dcf2b3?>,
  /**
   ...
   */
  public val autoMerge: InlineWebhookPullRequestReviewSubmittedPullRequestAutoMergeX3b14fb20?,
  public val base: InlineWebhookPullRequestReviewSubmittedPullRequestBaseX1e0830ae,
  ...
  public val head: InlineWebhookPullRequestReviewSubmittedPullRequestHeadX32a4943c,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  labels: List<InlineWebhookPullRequestReviewSubmittedPullRequestLabelsItemXfe14a6e3>,
   ...
   */
  public val milestone: InlineWebhookPullRequestReviewSubmittedPullRequestMilestoneXc4b57fb3?,
  ...
  requestedReviewers: List<InlineWebhookPullRequestRe5d81PullRequestRequestedReviewersItemXd3e87db0>,
  requestedTeams: List<InlineWebhookPullRequestReviewSubmittedPullRequestRequestedTeamsItemX9fd5aff0>,
  /**
  ...
  public val state: InlineWebhookPullRequestReviewSubmittedPullRequestStateXbcf65c26,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val user: InlineWebhookPullRequestReviewSubmittedPullRequestUserXe318d225?,
) {
  public val assignees:
      List<InlineWebhookPullRequestReviewSubmittedPullRequestAssigneesItemX06dcf2b3?> =
      assignees.toList()

  public val labels: List<InlineWebhookPullRequestReviewSubmittedPullRequestLabelsItemXfe14a6e3> =
      labels.toList()

  public val requestedReviewers:
      List<InlineWebhookPullRequestRe5d81PullRequestRequestedReviewersItemXd3e87db0> =
      requestedReviewers.toList()

  public val requestedTeams:
      List<InlineWebhookPullRequestReviewSubmittedPullRequestRequestedTeamsItemX9fd5aff0> =
      requestedTeams.toList()

  public class Builder {
    private var linksValue: InlineWebhookPullRequestReviewSubmittedPullRequestLinksX2c7957bc? = null

    public var links: InlineWebhookPullRequestReviewSubmittedPullRequestLinksX2c7957bc
    ...
    private var assigneesValue:
        List<InlineWebhookPullRequestReviewSubmittedPullRequestAssigneesItemX06dcf2b3?>? = null
    ...
    private var authorAssociationValue:
        InlineWebhookPullRequestReviewSubmittedPullRequestAuthorAssociationX2b48ca42? = null
    ...
    private var baseValue: InlineWebhookPullRequestReviewSubmittedPullRequestBaseX1e0830ae? = null

    public var base: InlineWebhookPullRequestReviewSubmittedPullRequestBaseX1e0830ae
    ...
    private var headValue: InlineWebhookPullRequestReviewSubmittedPullRequestHeadX32a4943c? = null

    public var head: InlineWebhookPullRequestReviewSubmittedPullRequestHeadX32a4943c
    ...
    private var labelsValue:
        List<InlineWebhookPullRequestReviewSubmittedPullRequestLabelsItemXfe14a6e3>? = null

    public var labels: List<InlineWebhookPullRequestReviewSubmittedPullRequestLabelsItemXfe14a6e3>
    ...
    private var requestedReviewersValue:
        List<InlineWebhookPullRequestRe5d81PullRequestRequestedReviewersItemXd3e87db0>? = null
    ...
    private var requestedTeamsValue:
        List<InlineWebhookPullRequestReviewSubmittedPullRequestRequestedTeamsItemX9fd5aff0>? = null
    ...
    private var stateValue: InlineWebhookPullRequestReviewSubmittedPullRequestStateXbcf65c26? = null

    public var state: InlineWebhookPullRequestReviewSubmittedPullRequestStateXbcf65c26
    ...
    private var activeLockReasonState:
        FieldState<InlineWebhookPullRequestReviewSubmittedPullRequestActiveLockReasonXc4e689a0?> =
        FieldState.Absent
    ...
    private var assigneeState:
        FieldState<InlineWebhookPullRequestReviewSubmittedPullRequestAssigneeX5b55f04d?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var assignee: InlineWebhookPullRequestReviewSubmittedPullRequestAssigneeX5b55f04d?
    ...
    private var autoMergeState:
        FieldState<InlineWebhookPullRequestReviewSubmittedPullRequestAutoMergeX3b14fb20?> =
        FieldState.Absent
     ...
     * Required nullable field; assigning `null` records present-null.
     */
    public var autoMerge: InlineWebhookPullRequestReviewSubmittedPullRequestAutoMergeX3b14fb20?
    ...
    private var milestoneState:
        FieldState<InlineWebhookPullRequestReviewSubmittedPullRequestMilestoneXc4b57fb3?> =
        FieldState.Absent
     ...
     * Required nullable field; assigning `null` records present-null.
     */
    public var milestone: InlineWebhookPullRequestReviewSubmittedPullRequestMilestoneXc4b57fb3?
    ...
    private var userState:
        FieldState<InlineWebhookPullRequestReviewSubmittedPullRequestUserXe318d225?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var user: InlineWebhookPullRequestReviewSubmittedPullRequestUserXe318d225?
      get() = userState.valueOrNull()
      set(`value`) {
        userState = value.toNullableFieldState()
      }

    public fun build(): InlineWebhookPullRequestReviewSubmittedPullRequestX87917650 {
      ...
      return InlineWebhookPullRequestReviewSubmittedPullRequestX87917650(
        links = links,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewSubmittedPullRequestX87917650 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewSubmittedPullRequestX87917650> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewSubmittedPullRequestX87917650 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewSubmittedPullRequestX87917650")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewSubmittedPullRequestX87917650 must be a JSON object")
      val links = json.decodeRequired<InlineWebhookPullRequestReviewSubmittedPullRequestLinksX2c7957bc>(rawObject, "_links")
      val assignees = json.decodeRequired<List<InlineWebhookPullRequestReviewSubmittedPullRequestAssigneesItemX06dcf2b3?>>(rawObject, "assignees")
      val authorAssociation = json.decodeRequired<InlineWebhookPullRequestReviewSubmittedPullRequestAuthorAssociationX2b48ca42>(rawObject, "author_association")
      val base = json.decodeRequired<InlineWebhookPullRequestReviewSubmittedPullRequestBaseX1e0830ae>(rawObject, "base")
      ...
      val head = json.decodeRequired<InlineWebhookPullRequestReviewSubmittedPullRequestHeadX32a4943c>(rawObject, "head")
      val htmlUrl = json.decodeRequired<String>(rawObject, "html_url")
      val id = json.decodeRequired<Int>(rawObject, "id")
      val issueUrl = json.decodeRequired<String>(rawObject, "issue_url")
      val labels = json.decodeRequired<List<InlineWebhookPullRequestReviewSubmittedPullRequestLabelsItemXfe14a6e3>>(rawObject, "labels")
      ...
      val requestedReviewers = json.decodeRequired<List<InlineWebhookPullRequestRe5d81PullRequestRequestedReviewersItemXd3e87db0>>(rawObject, "requested_reviewers")
      val requestedTeams = json.decodeRequired<List<InlineWebhookPullRequestReviewSubmittedPullRequestRequestedTeamsItemX9fd5aff0>>(rawObject, "requested_teams")
      ...
      val state = json.decodeRequired<InlineWebhookPullRequestReviewSubmittedPullRequestStateXbcf65c26>(rawObject, "state")
      ...
      if (!rawObject.containsKey("active_lock_reason")) {
        throw SerializationException("InlineWebhookPullRequestReviewSubmittedPullRequestX87917650 is missing required property 'active_lock_reason'")
      }
      val activeLockReason = rawObject["active_lock_reason"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestReviewSubmittedPullRequestActiveLockReasonXc4e689a0?>(requireNotNull(element)) }
      if (!rawObject.containsKey("assignee")) {
        throw SerializationException("InlineWebhookPullRequestReviewSubmittedPullRequestX87917650 is missing required property 'assignee'")
      }
      val assignee = rawObject["assignee"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestReviewSubmittedPullRequestAssigneeX5b55f04d?>(requireNotNull(element)) }
      if (!rawObject.containsKey("auto_merge")) {
        throw SerializationException("InlineWebhookPullRequestReviewSubmittedPullRequestX87917650 is missing required property 'auto_merge'")
      }
      val autoMerge = rawObject["auto_merge"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestReviewSubmittedPullRequestAutoMergeX3b14fb20?>(requireNotNull(element)) }
      if (!rawObject.containsKey("body")) {
        throw SerializationException("InlineWebhookPullRequestReviewSubmittedPullRequestX87917650 is missing required property 'body'")
      }
      ...
      if (!rawObject.containsKey("closed_at")) {
        throw SerializationException("InlineWebhookPullRequestReviewSubmittedPullRequestX87917650 is missing required property 'closed_at'")
      }
      ...
      if (!rawObject.containsKey("merge_commit_sha")) {
        throw SerializationException("InlineWebhookPullRequestReviewSubmittedPullRequestX87917650 is missing required property 'merge_commit_sha'")
      }
      ...
      if (!rawObject.containsKey("merged_at")) {
        throw SerializationException("InlineWebhookPullRequestReviewSubmittedPullRequestX87917650 is missing required property 'merged_at'")
      }
      ...
      if (!rawObject.containsKey("milestone")) {
        throw SerializationException("InlineWebhookPullRequestReviewSubmittedPullRequestX87917650 is missing required property 'milestone'")
      }
      val milestone = rawObject["milestone"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestReviewSubmittedPullRequestMilestoneXc4b57fb3?>(requireNotNull(element)) }
      if (!rawObject.containsKey("user")) {
        throw SerializationException("InlineWebhookPullRequestReviewSubmittedPullRequestX87917650 is missing required property 'user'")
      }
      val user = rawObject["user"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestReviewSubmittedPullRequestUserXe318d225?>(requireNotNull(element)) }
      return InlineWebhookPullRequestReviewSubmittedPullRequestX87917650(
        links = links,
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewSubmittedPullRequestX87917650) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewSubmittedPullRequestX87917650")
...
public fun inlineWebhookPullRequestReviewSubmittedPullRequestX87917650(block: InlineWebhookPullRequestReviewSubmittedPullRequestX87917650.Builder.() -> Unit): InlineWebhookPullRequestReviewSubmittedPullRequestX87917650 = InlineWebhookPullRequestReviewSubmittedPullRequestX87917650.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewSubmittedPullRequestX87917650 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookPullRequestReviewSubmittedPullRequestX87917650 property '" + name + "' is not nullable")
