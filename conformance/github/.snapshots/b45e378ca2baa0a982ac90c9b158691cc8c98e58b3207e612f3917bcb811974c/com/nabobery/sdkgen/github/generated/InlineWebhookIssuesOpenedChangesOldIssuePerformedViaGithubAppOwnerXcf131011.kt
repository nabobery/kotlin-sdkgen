 ...
 * ties/performed_via_github_app/properties/owner.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-opened/properties/changes/properties/old_issue/proper
 * ties/performed_via_github_app/properties/owner
 */
@Serializable(with = InlineWebhookIssuesOpenedChangesOldIssuePerformedViaGithubAppOwnerXcf131011.Serializer::class)
public class InlineWebhookIssuesOpenedChangesOldIssuePerformedViaGithubAppOwnerXcf131011(
  public val id: Int,
  ...
  public val type:
      InlineWebhookIssuesOpenedChangesOldIssuePerformedViaGithubAppOwnerTypeX1cc95431? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public fun build(): InlineWebhookIssuesOpenedChangesOldIssuePerformedViaGithubAppOwnerXcf131011 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssuesOpenedChangesOldIssuePerformedViaGithubAppOwnerXcf131011(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesOpenedChangesOldIssuePerformedViaGithubAppOwnerXcf131011 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesOpenedChangesOldIssuePerformedViaGithubAppOwnerXcf131011> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesOpenedChangesOldIssuePerformedViaGithubAppOwnerXcf131011 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesOpenedChangesOldIssuePerformedViaGithubAppOwnerXcf131011")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesOpenedChangesOldIssuePerformedViaGithubAppOwnerXcf131011 must be a JSON object")
      ...
      return InlineWebhookIssuesOpenedChangesOldIssuePerformedViaGithubAppOwnerXcf131011(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssuesOpenedChangesOldIssuePerformedViaGithubAppOwnerTypeX1cc95431>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesOpenedChangesOldIssuePerformedViaGithubAppOwnerXcf131011) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesOpenedChangesOldIssuePerformedViaGithubAppOwnerXcf131011")
...
public fun inlineWebhookIssuesOpenedChangesOldIssuePerformedViaGithubAppOwnerXcf131011(block: InlineWebhookIssuesOpenedChangesOldIssuePerformedViaGithubAppOwnerXcf131011.Builder.() -> Unit): InlineWebhookIssuesOpenedChangesOldIssuePerformedViaGithubAppOwnerXcf131011 = InlineWebhookIssuesOpenedChangesOldIssuePerformedViaGithubAppOwnerXcf131011.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesOpenedChangesOldIssuePerformedViaGithubAppOwnerXcf131011 is missing required property '" + name + "'")
