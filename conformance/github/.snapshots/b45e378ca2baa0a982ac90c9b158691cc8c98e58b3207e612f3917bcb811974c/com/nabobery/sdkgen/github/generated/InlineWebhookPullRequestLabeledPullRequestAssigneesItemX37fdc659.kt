 ...
 * gnees/items
 */
@Serializable(with = InlineWebhookPullRequestLabeledPullRequestAssigneesItemX37fdc659.Serializer::class)
public class InlineWebhookPullRequestLabeledPullRequestAssigneesItemX37fdc659(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestLabeledPullRequestAssigneesItemTypeXa35caf0b? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestLabeledPullRequestAssigneesItemTypeXa35caf0b? = null
    ...
    public fun build(): InlineWebhookPullRequestLabeledPullRequestAssigneesItemX37fdc659 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestLabeledPullRequestAssigneesItemX37fdc659(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestLabeledPullRequestAssigneesItemX37fdc659 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestLabeledPullRequestAssigneesItemX37fdc659> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestLabeledPullRequestAssigneesItemX37fdc659 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestLabeledPullRequestAssigneesItemX37fdc659")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestLabeledPullRequestAssigneesItemX37fdc659 must be a JSON object")
      ...
      return InlineWebhookPullRequestLabeledPullRequestAssigneesItemX37fdc659(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestLabeledPullRequestAssigneesItemTypeXa35caf0b>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestLabeledPullRequestAssigneesItemX37fdc659) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestLabeledPullRequestAssigneesItemX37fdc659")
...
public fun inlineWebhookPullRequestLabeledPullRequestAssigneesItemX37fdc659(block: InlineWebhookPullRequestLabeledPullRequestAssigneesItemX37fdc659.Builder.() -> Unit): InlineWebhookPullRequestLabeledPullRequestAssigneesItemX37fdc659 = InlineWebhookPullRequestLabeledPullRequestAssigneesItemX37fdc659.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestLabeledPullRequestAssigneesItemX37fdc659 is missing required property '" + name + "'")
