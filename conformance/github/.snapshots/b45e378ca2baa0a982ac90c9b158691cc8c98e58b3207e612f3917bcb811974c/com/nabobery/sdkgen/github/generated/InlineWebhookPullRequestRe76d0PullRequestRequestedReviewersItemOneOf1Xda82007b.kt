 ...
 * s/requested_reviewers/items/oneOf/0.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-review-edited/properties/pull_request/propertie
 * s/requested_reviewers/items/oneOf/0
 */
@Serializable(with = InlineWebhookPullRequestRe76d0PullRequestRequestedReviewersItemOneOf1Xda82007b.Serializer::class)
public class InlineWebhookPullRequestRe76d0PullRequestRequestedReviewersItemOneOf1Xda82007b(
  public val id: Int,
  ...
  public val type:
      InlineWebhookPullRequestRe76d0PullRequestRequestedReviewersItemTypeXdee99a5c? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestRe76d0PullRequestRequestedReviewersItemTypeXdee99a5c? =
        null
    ...
    public fun build(): InlineWebhookPullRequestRe76d0PullRequestRequestedReviewersItemOneOf1Xda82007b {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestRe76d0PullRequestRequestedReviewersItemOneOf1Xda82007b = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestRe76d0PullRequestRequestedReviewersItemOneOf1Xda82007b> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestRe76d0PullRequestRequestedReviewersItemOneOf1Xda82007b {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestRe76d0PullRequestRequestedReviewersItemOneOf1Xda82007b")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestRe76d0PullRequestRequestedReviewersItemOneOf1Xda82007b must be a JSON object")
      ...
      return InlineWebhookPullRequestRe76d0PullRequestRequestedReviewersItemOneOf1Xda82007b(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestRe76d0PullRequestRequestedReviewersItemTypeXdee99a5c>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestRe76d0PullRequestRequestedReviewersItemOneOf1Xda82007b) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestRe76d0PullRequestRequestedReviewersItemOneOf1Xda82007b")
...
public fun inlineWebhookPullRequestRe76d0PullRequestRequestedReviewersItemOneOf1Xda82007b(block: InlineWebhookPullRequestRe76d0PullRequestRequestedReviewersItemOneOf1Xda82007b.Builder.() -> Unit): InlineWebhookPullRequestRe76d0PullRequestRequestedReviewersItemOneOf1Xda82007b = InlineWebhookPullRequestRe76d0PullRequestRequestedReviewersItemOneOf1Xda82007b.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestRe76d0PullRequestRequestedReviewersItemOneOf1Xda82007b is missing required property '" + name + "'")
