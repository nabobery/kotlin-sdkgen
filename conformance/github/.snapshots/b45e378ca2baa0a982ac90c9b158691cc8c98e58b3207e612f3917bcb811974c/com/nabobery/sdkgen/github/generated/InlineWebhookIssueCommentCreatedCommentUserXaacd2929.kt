...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-issue-comment-created/properties/comment/properties/user.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-issue-comment-created/properties/comment/properties/user
 */
@Serializable(with = InlineWebhookIssueCommentCreatedCommentUserXaacd2929.Serializer::class)
public class InlineWebhookIssueCommentCreatedCommentUserXaacd2929(
  public val id: Long,
  ...
  public val type: InlineWebhookIssueCommentCreatedCommentUserTypeX7cc4e654? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookIssueCommentCreatedCommentUserTypeX7cc4e654? = null
    ...
    public fun build(): InlineWebhookIssueCommentCreatedCommentUserXaacd2929 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssueCommentCreatedCommentUserXaacd2929(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssueCommentCreatedCommentUserXaacd2929 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssueCommentCreatedCommentUserXaacd2929> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssueCommentCreatedCommentUserXaacd2929 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssueCommentCreatedCommentUserXaacd2929")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssueCommentCreatedCommentUserXaacd2929 must be a JSON object")
      ...
      return InlineWebhookIssueCommentCreatedCommentUserXaacd2929(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssueCommentCreatedCommentUserTypeX7cc4e654>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssueCommentCreatedCommentUserXaacd2929) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssueCommentCreatedCommentUserXaacd2929")
...
public fun inlineWebhookIssueCommentCreatedCommentUserXaacd2929(block: InlineWebhookIssueCommentCreatedCommentUserXaacd2929.Builder.() -> Unit): InlineWebhookIssueCommentCreatedCommentUserXaacd2929 = InlineWebhookIssueCommentCreatedCommentUserXaacd2929.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssueCommentCreatedCommentUserXaacd2929 is missing required property '" + name + "'")
