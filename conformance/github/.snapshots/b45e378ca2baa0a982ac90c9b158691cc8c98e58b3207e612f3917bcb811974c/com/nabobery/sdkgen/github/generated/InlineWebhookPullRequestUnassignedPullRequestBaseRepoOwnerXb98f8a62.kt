 ...
 * ase/properties/repo/properties/owner.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-unassigned/properties/pull_request/properties/b
 * ase/properties/repo/properties/owner
 */
@Serializable(with = InlineWebhookPullRequestUnassignedPullRequestBaseRepoOwnerXb98f8a62.Serializer::class)
public class InlineWebhookPullRequestUnassignedPullRequestBaseRepoOwnerXb98f8a62(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestUnassignedPullRequestBaseRepoOwnerTypeXf384d1f0? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestUnassignedPullRequestBaseRepoOwnerTypeXf384d1f0? = null
    ...
    public fun build(): InlineWebhookPullRequestUnassignedPullRequestBaseRepoOwnerXb98f8a62 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestUnassignedPullRequestBaseRepoOwnerXb98f8a62(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestUnassignedPullRequestBaseRepoOwnerXb98f8a62 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestUnassignedPullRequestBaseRepoOwnerXb98f8a62> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestUnassignedPullRequestBaseRepoOwnerXb98f8a62 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestUnassignedPullRequestBaseRepoOwnerXb98f8a62")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestUnassignedPullRequestBaseRepoOwnerXb98f8a62 must be a JSON object")
      ...
      return InlineWebhookPullRequestUnassignedPullRequestBaseRepoOwnerXb98f8a62(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestUnassignedPullRequestBaseRepoOwnerTypeXf384d1f0>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestUnassignedPullRequestBaseRepoOwnerXb98f8a62) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestUnassignedPullRequestBaseRepoOwnerXb98f8a62")
...
public fun inlineWebhookPullRequestUnassignedPullRequestBaseRepoOwnerXb98f8a62(block: InlineWebhookPullRequestUnassignedPullRequestBaseRepoOwnerXb98f8a62.Builder.() -> Unit): InlineWebhookPullRequestUnassignedPullRequestBaseRepoOwnerXb98f8a62 = InlineWebhookPullRequestUnassignedPullRequestBaseRepoOwnerXb98f8a62.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestUnassignedPullRequestBaseRepoOwnerXb98f8a62 is missing required property '" + name + "'")
