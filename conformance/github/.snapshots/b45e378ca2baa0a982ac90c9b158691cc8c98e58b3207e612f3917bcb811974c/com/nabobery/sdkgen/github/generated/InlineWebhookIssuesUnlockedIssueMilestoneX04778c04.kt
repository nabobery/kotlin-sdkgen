 ...
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-unlocked/properties/issue/properties/milestone
 */
@Serializable(with = InlineWebhookIssuesUnlockedIssueMilestoneX04778c04.Serializer::class)
public class InlineWebhookIssuesUnlockedIssueMilestoneX04778c04(
  /**
  ...
  public val creator: InlineWebhookIssuesUnlockedIssueMilestoneCreatorX541d1614?,
   ...
   */
  public val state: InlineWebhookIssuesUnlockedIssueMilestoneStateX8435dac0,
  /**
  ...
  public class Builder {
    ...
    private var stateValue: InlineWebhookIssuesUnlockedIssueMilestoneStateX8435dac0? = null

    public var state: InlineWebhookIssuesUnlockedIssueMilestoneStateX8435dac0
    ...
    private var creatorState: FieldState<InlineWebhookIssuesUnlockedIssueMilestoneCreatorX541d1614?>
        = FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var creator: InlineWebhookIssuesUnlockedIssueMilestoneCreatorX541d1614?
    ...
    public fun build(): InlineWebhookIssuesUnlockedIssueMilestoneX04778c04 {
      ...
      return InlineWebhookIssuesUnlockedIssueMilestoneX04778c04(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesUnlockedIssueMilestoneX04778c04 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesUnlockedIssueMilestoneX04778c04> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesUnlockedIssueMilestoneX04778c04 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesUnlockedIssueMilestoneX04778c04")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesUnlockedIssueMilestoneX04778c04 must be a JSON object")
      ...
      val state = json.decodeRequired<InlineWebhookIssuesUnlockedIssueMilestoneStateX8435dac0>(rawObject, "state")
      val title = json.decodeRequired<String>(rawObject, "title")
      val updatedAt = json.decodeRequired<String>(rawObject, "updated_at")
      val url = json.decodeRequired<String>(rawObject, "url")
      if (!rawObject.containsKey("closed_at")) {
        throw SerializationException("InlineWebhookIssuesUnlockedIssueMilestoneX04778c04 is missing required property 'closed_at'")
      }
      ...
      if (!rawObject.containsKey("creator")) {
        throw SerializationException("InlineWebhookIssuesUnlockedIssueMilestoneX04778c04 is missing required property 'creator'")
      }
      val creator = rawObject["creator"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookIssuesUnlockedIssueMilestoneCreatorX541d1614?>(requireNotNull(element)) }
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookIssuesUnlockedIssueMilestoneX04778c04 is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("due_on")) {
        throw SerializationException("InlineWebhookIssuesUnlockedIssueMilestoneX04778c04 is missing required property 'due_on'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesUnlockedIssueMilestoneX04778c04) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesUnlockedIssueMilestoneX04778c04")
...
public fun inlineWebhookIssuesUnlockedIssueMilestoneX04778c04(block: InlineWebhookIssuesUnlockedIssueMilestoneX04778c04.Builder.() -> Unit): InlineWebhookIssuesUnlockedIssueMilestoneX04778c04 = InlineWebhookIssuesUnlockedIssueMilestoneX04778c04.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesUnlockedIssueMilestoneX04778c04 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookIssuesUnlockedIssueMilestoneX04778c04 property '" + name + "' is not nullable")
