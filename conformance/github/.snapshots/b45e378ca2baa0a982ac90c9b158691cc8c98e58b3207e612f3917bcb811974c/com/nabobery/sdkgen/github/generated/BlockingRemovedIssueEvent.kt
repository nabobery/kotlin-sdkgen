...
@Serializable
public data class BlockingRemovedIssueEventView(
  public val actor: SimpleUser,
  public val blocking: NullableIssueReference?,
 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/blocking-removed-issue-event
 */
@Serializable(with = BlockingRemovedIssueEvent.Serializer::class)
public class BlockingRemovedIssueEvent(
  public val actor: SimpleUser,
  public val blocking: NullableIssueReference?,
  public val commitId: String?,
  public val commitUrl: String?,
  ...
  public class Builder {
    ...
    private var blockingState: FieldState<NullableIssueReference?> = FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var blocking: NullableIssueReference?
      get() = blockingState.valueOrNull()
      set(`value`) {
        blockingState = value.toNullableFieldState()
      }
    ...
    public fun build(): BlockingRemovedIssueEvent {
      ...
      check(blockingState !== FieldState.Absent) { "blocking is required, even when null" }
      ...
      return BlockingRemovedIssueEvent(
        actor = actor,
        blocking = blockingState.valueOrNull(),
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): BlockingRemovedIssueEvent = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<BlockingRemovedIssueEvent> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): BlockingRemovedIssueEvent {
      val jsonDecoder = decoder.requireJsonDecoder("BlockingRemovedIssueEvent")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("BlockingRemovedIssueEvent must be a JSON object")
      ...
      if (!rawObject.containsKey("blocking")) {
        throw SerializationException("BlockingRemovedIssueEvent is missing required property 'blocking'")
      }
      val blocking = rawObject["blocking"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<NullableIssueReference?>(requireNotNull(element)) }
      if (!rawObject.containsKey("commit_id")) {
        throw SerializationException("BlockingRemovedIssueEvent is missing required property 'commit_id'")
      }
      ...
      if (!rawObject.containsKey("commit_url")) {
        throw SerializationException("BlockingRemovedIssueEvent is missing required property 'commit_url'")
      }
      ...
      if (!rawObject.containsKey("performed_via_github_app")) {
        throw SerializationException("BlockingRemovedIssueEvent is missing required property 'performed_via_github_app'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: BlockingRemovedIssueEvent) {
      val jsonEncoder = encoder.requireJsonEncoder("BlockingRemovedIssueEvent")
      val json = jsonEncoder.json
      val raw = buildJsonObject {
        put("actor", json.encodeToJsonElement(value.actor))
        put("blocking", value.blocking?.let { json.encodeToJsonElement(it) } ?: JsonNull)
...
public fun blockingRemovedIssueEvent(block: BlockingRemovedIssueEvent.Builder.() -> Unit): BlockingRemovedIssueEvent = BlockingRemovedIssueEvent.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("BlockingRemovedIssueEvent is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("BlockingRemovedIssueEvent property '" + name + "' is not nullable")
