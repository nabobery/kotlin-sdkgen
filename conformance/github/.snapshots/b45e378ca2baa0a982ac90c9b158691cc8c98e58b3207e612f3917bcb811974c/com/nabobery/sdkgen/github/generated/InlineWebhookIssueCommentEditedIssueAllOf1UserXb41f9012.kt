 ...
 * r
 */
@Serializable(with = InlineWebhookIssueCommentEditedIssueAllOf1UserXb41f9012.Serializer::class)
public class InlineWebhookIssueCommentEditedIssueAllOf1UserXb41f9012(
  public val id: Long,
  ...
  public val type: InlineWebhookIssueCommentEditedIssueAllOf1UserTypeXe08c80da? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookIssueCommentEditedIssueAllOf1UserTypeXe08c80da? = null
    ...
    public fun build(): InlineWebhookIssueCommentEditedIssueAllOf1UserXb41f9012 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssueCommentEditedIssueAllOf1UserXb41f9012(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssueCommentEditedIssueAllOf1UserXb41f9012 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssueCommentEditedIssueAllOf1UserXb41f9012> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssueCommentEditedIssueAllOf1UserXb41f9012 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssueCommentEditedIssueAllOf1UserXb41f9012")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssueCommentEditedIssueAllOf1UserXb41f9012 must be a JSON object")
      ...
      return InlineWebhookIssueCommentEditedIssueAllOf1UserXb41f9012(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssueCommentEditedIssueAllOf1UserTypeXe08c80da>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssueCommentEditedIssueAllOf1UserXb41f9012) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssueCommentEditedIssueAllOf1UserXb41f9012")
...
public fun inlineWebhookIssueCommentEditedIssueAllOf1UserXb41f9012(block: InlineWebhookIssueCommentEditedIssueAllOf1UserXb41f9012.Builder.() -> Unit): InlineWebhookIssueCommentEditedIssueAllOf1UserXb41f9012 = InlineWebhookIssueCommentEditedIssueAllOf1UserXb41f9012.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssueCommentEditedIssueAllOf1UserXb41f9012 is missing required property '" + name + "'")
