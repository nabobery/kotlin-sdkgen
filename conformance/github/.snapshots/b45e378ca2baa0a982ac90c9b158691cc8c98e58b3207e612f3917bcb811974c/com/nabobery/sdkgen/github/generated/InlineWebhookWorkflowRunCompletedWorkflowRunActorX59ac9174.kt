 ...
 * tor
 */
@Serializable(with = InlineWebhookWorkflowRunCompletedWorkflowRunActorX59ac9174.Serializer::class)
public class InlineWebhookWorkflowRunCompletedWorkflowRunActorX59ac9174(
  public val id: Int,
  ...
  public val type: InlineWebhookWorkflowRunCompletedWorkflowRunActorTypeX9adb0ec1? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookWorkflowRunCompletedWorkflowRunActorTypeX9adb0ec1? = null
    ...
    public fun build(): InlineWebhookWorkflowRunCompletedWorkflowRunActorX59ac9174 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookWorkflowRunCompletedWorkflowRunActorX59ac9174(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookWorkflowRunCompletedWorkflowRunActorX59ac9174 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookWorkflowRunCompletedWorkflowRunActorX59ac9174> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookWorkflowRunCompletedWorkflowRunActorX59ac9174 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookWorkflowRunCompletedWorkflowRunActorX59ac9174")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookWorkflowRunCompletedWorkflowRunActorX59ac9174 must be a JSON object")
      ...
      return InlineWebhookWorkflowRunCompletedWorkflowRunActorX59ac9174(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookWorkflowRunCompletedWorkflowRunActorTypeX9adb0ec1>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookWorkflowRunCompletedWorkflowRunActorX59ac9174) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookWorkflowRunCompletedWorkflowRunActorX59ac9174")
...
public fun inlineWebhookWorkflowRunCompletedWorkflowRunActorX59ac9174(block: InlineWebhookWorkflowRunCompletedWorkflowRunActorX59ac9174.Builder.() -> Unit): InlineWebhookWorkflowRunCompletedWorkflowRunActorX59ac9174 = InlineWebhookWorkflowRunCompletedWorkflowRunActorX59ac9174.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookWorkflowRunCompletedWorkflowRunActorX59ac9174 is missing required property '" + name + "'")
