 ...
 * tor
 */
@Serializable(with = InlineWebhookWorkflowRunRequestedWorkflowRunActorXf4e3cf40.Serializer::class)
public class InlineWebhookWorkflowRunRequestedWorkflowRunActorXf4e3cf40(
  public val id: Int,
  ...
  public val type: InlineWebhookWorkflowRunRequestedWorkflowRunActorTypeX8f545978? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookWorkflowRunRequestedWorkflowRunActorTypeX8f545978? = null
    ...
    public fun build(): InlineWebhookWorkflowRunRequestedWorkflowRunActorXf4e3cf40 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookWorkflowRunRequestedWorkflowRunActorXf4e3cf40(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookWorkflowRunRequestedWorkflowRunActorXf4e3cf40 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookWorkflowRunRequestedWorkflowRunActorXf4e3cf40> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookWorkflowRunRequestedWorkflowRunActorXf4e3cf40 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookWorkflowRunRequestedWorkflowRunActorXf4e3cf40")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookWorkflowRunRequestedWorkflowRunActorXf4e3cf40 must be a JSON object")
      ...
      return InlineWebhookWorkflowRunRequestedWorkflowRunActorXf4e3cf40(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookWorkflowRunRequestedWorkflowRunActorTypeX8f545978>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookWorkflowRunRequestedWorkflowRunActorXf4e3cf40) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookWorkflowRunRequestedWorkflowRunActorXf4e3cf40")
...
public fun inlineWebhookWorkflowRunRequestedWorkflowRunActorXf4e3cf40(block: InlineWebhookWorkflowRunRequestedWorkflowRunActorXf4e3cf40.Builder.() -> Unit): InlineWebhookWorkflowRunRequestedWorkflowRunActorXf4e3cf40 = InlineWebhookWorkflowRunRequestedWorkflowRunActorXf4e3cf40.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookWorkflowRunRequestedWorkflowRunActorXf4e3cf40 is missing required property '" + name + "'")
