...
/**
 * Generated model for sdkgen://source/openapi.yaml#/components/schemas/webhooks_sponsorship/properties/sponsorable.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhooks_sponsorship/properties/sponsorable
 */
@Serializable(with = InlineWebhooksSponsorshipSponsorableX373093d2.Serializer::class)
public class InlineWebhooksSponsorshipSponsorableX373093d2(
  public val id: Int,
  ...
  public val type: InlineWebhooksSponsorshipSponsorableTypeXa54f3660? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhooksSponsorshipSponsorableTypeXa54f3660? = null
    ...
    public fun build(): InlineWebhooksSponsorshipSponsorableX373093d2 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhooksSponsorshipSponsorableX373093d2(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhooksSponsorshipSponsorableX373093d2 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhooksSponsorshipSponsorableX373093d2> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhooksSponsorshipSponsorableX373093d2 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhooksSponsorshipSponsorableX373093d2")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhooksSponsorshipSponsorableX373093d2 must be a JSON object")
      ...
      return InlineWebhooksSponsorshipSponsorableX373093d2(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhooksSponsorshipSponsorableTypeXa54f3660>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhooksSponsorshipSponsorableX373093d2) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhooksSponsorshipSponsorableX373093d2")
...
public fun inlineWebhooksSponsorshipSponsorableX373093d2(block: InlineWebhooksSponsorshipSponsorableX373093d2.Builder.() -> Unit): InlineWebhooksSponsorshipSponsorableX373093d2 = InlineWebhooksSponsorshipSponsorableX373093d2.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhooksSponsorshipSponsorableX373093d2 is missing required property '" + name + "'")
