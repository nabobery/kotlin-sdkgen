 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-milestoned/properties/issue
 */
@Serializable(with = InlineWebhookIssuesMilestonedIssueX31152acf.Serializer::class)
public class InlineWebhookIssuesMilestonedIssueX31152acf internal constructor(
  public val activeLockReason: InlineWebhookIssuesMilestonedIssueActiveLockReasonX9d961372?,
  assignees: List<InlineWebhookIssuesMilestonedIssueAssigneesItemXfe86e1e2?>,
  /**
   * How the author is associated with the repository.
   */
  public val authorAssociation: InlineWebhookIssuesMilestonedIssueAuthorAssociationXe1ec66e9,
  /**
   ...
   */
  public val milestone: InlineWebhookIssuesMilestonedIssueMilestoneX7982f9e0?,
  public val nodeId: String,
  public val number: Int,
  public val reactions: InlineWebhookIssuesMilestonedIssueReactionsX57ed70d5,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val user: InlineWebhookIssuesMilestonedIssueUserX256a6361?,
  private val assigneeState: FieldState<InlineWebhookIssuesMilestonedIssueAssigneeXe5b37635?>,
  ...
  labelsState: FieldState<List<InlineWebhookIssuesMilestonedIssueLabelsItemX56b720c9?>>,
  private val lockedState: FieldState<Boolean>,
  private val performedViaGithubAppState:
      FieldState<InlineWebhookIssuesMilestonedIssuePerformedViaGithubAppXd92914d4?>,
  private val pinnedCommentState: FieldState<NullableIssueComment?>,
  private val pullRequestState: FieldState<InlineWebhookIssuesMilestonedIssuePullRequestX29717268>,
  private val stateState: FieldState<InlineWebhookIssuesMilestonedIssueStateXccc243dc>,
  ...
  public val assignees: List<InlineWebhookIssuesMilestonedIssueAssigneesItemXfe86e1e2?> =
      assignees.toList()
  ...
  private val labelsState: FieldState<List<InlineWebhookIssuesMilestonedIssueLabelsItemX56b720c9?>>
      = labelsState.copyValue { fieldValue -> fieldValue.toList() }

  public val assignee: InlineWebhookIssuesMilestonedIssueAssigneeXe5b37635?
  ...
  public val labels: List<InlineWebhookIssuesMilestonedIssueLabelsItemX56b720c9?>?
  ...
  public val performedViaGithubApp:
      InlineWebhookIssuesMilestonedIssuePerformedViaGithubAppXd92914d4?
  ...
  public val pullRequest: InlineWebhookIssuesMilestonedIssuePullRequestX29717268?
    get() = pullRequestState.valueOrNull()

  /**
   * State of the issue; either 'open' or 'closed'
   */
  public val state: InlineWebhookIssuesMilestonedIssueStateXccc243dc?
  ...
  public constructor(
    activeLockReason: InlineWebhookIssuesMilestonedIssueActiveLockReasonX9d961372?,
    assignees: List<InlineWebhookIssuesMilestonedIssueAssigneesItemXfe86e1e2?>,
    authorAssociation: InlineWebhookIssuesMilestonedIssueAuthorAssociationXe1ec66e9,
    body: String?,
    closedAt: String?,
    comments: Int,
    commentsUrl: String,
    ...
    id: Long,
    labelsUrl: String,
    milestone: InlineWebhookIssuesMilestonedIssueMilestoneX7982f9e0?,
    nodeId: String,
    number: Int,
    reactions: InlineWebhookIssuesMilestonedIssueReactionsX57ed70d5,
    repositoryUrl: String,
    title: String,
    updatedAt: String,
    url: String,
    user: InlineWebhookIssuesMilestonedIssueUserX256a6361?,
  ...
  public class Builder {
    private var assigneesValue: List<InlineWebhookIssuesMilestonedIssueAssigneesItemXfe86e1e2?>? =
        null

    public var assignees: List<InlineWebhookIssuesMilestonedIssueAssigneesItemXfe86e1e2?>
    ...
    private var authorAssociationValue:
        InlineWebhookIssuesMilestonedIssueAuthorAssociationXe1ec66e9? = null

    public var authorAssociation: InlineWebhookIssuesMilestonedIssueAuthorAssociationXe1ec66e9
    ...
    private var reactionsValue: InlineWebhookIssuesMilestonedIssueReactionsX57ed70d5? = null

    public var reactions: InlineWebhookIssuesMilestonedIssueReactionsX57ed70d5
    ...
    private var activeLockReasonState:
        FieldState<InlineWebhookIssuesMilestonedIssueActiveLockReasonX9d961372?> = FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var activeLockReason: InlineWebhookIssuesMilestonedIssueActiveLockReasonX9d961372?
    ...
    private var milestoneState: FieldState<InlineWebhookIssuesMilestonedIssueMilestoneX7982f9e0?> =
        FieldState.Absent
     ...
     * Required nullable field; assigning `null` records present-null.
     */
    public var milestone: InlineWebhookIssuesMilestonedIssueMilestoneX7982f9e0?
      get() = milestoneState.valueOrNull()
      set(`value`) {
        milestoneState = value.toNullableFieldState()
      }

    private var userState: FieldState<InlineWebhookIssuesMilestonedIssueUserX256a6361?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var user: InlineWebhookIssuesMilestonedIssueUserX256a6361?
      get() = userState.valueOrNull()
      set(`value`) {
        userState = value.toNullableFieldState()
      }

    private var assigneeState: FieldState<InlineWebhookIssuesMilestonedIssueAssigneeXe5b37635?> =
        FieldState.Absent

    /**
     * Assigning `null` records present-null; use the unset function to omit the property.
     */
    public var assignee: InlineWebhookIssuesMilestonedIssueAssigneeXe5b37635?
      get() = assigneeState.valueOrNull()
      set(`value`) {
    ...
    private var labelsState:
        FieldState<List<InlineWebhookIssuesMilestonedIssueLabelsItemX56b720c9?>> = FieldState.Absent

    /**
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var labels: List<InlineWebhookIssuesMilestonedIssueLabelsItemX56b720c9?>?
    ...
    private var pullRequestState: FieldState<InlineWebhookIssuesMilestonedIssuePullRequestX29717268>
        = FieldState.Absent

    /**
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var pullRequest: InlineWebhookIssuesMilestonedIssuePullRequestX29717268?
      get() = pullRequestState.valueOrNull()
      set(`value`) {
    ...
    private var stateState: FieldState<InlineWebhookIssuesMilestonedIssueStateXccc243dc> =
        FieldState.Absent
     ...
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var state: InlineWebhookIssuesMilestonedIssueStateXccc243dc?
      get() = stateState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): InlineWebhookIssuesMilestonedIssueX31152acf {
      ...
      return InlineWebhookIssuesMilestonedIssueX31152acf(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesMilestonedIssueX31152acf = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesMilestonedIssueX31152acf> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesMilestonedIssueX31152acf {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesMilestonedIssueX31152acf")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesMilestonedIssueX31152acf must be a JSON object")
      val assignees = json.decodeRequired<List<InlineWebhookIssuesMilestonedIssueAssigneesItemXfe86e1e2?>>(rawObject, "assignees")
      val authorAssociation = json.decodeRequired<InlineWebhookIssuesMilestonedIssueAuthorAssociationXe1ec66e9>(rawObject, "author_association")
      ...
      val reactions = json.decodeRequired<InlineWebhookIssuesMilestonedIssueReactionsX57ed70d5>(rawObject, "reactions")
      ...
      if (!rawObject.containsKey("active_lock_reason")) {
        throw SerializationException("InlineWebhookIssuesMilestonedIssueX31152acf is missing required property 'active_lock_reason'")
      }
      val activeLockReason = rawObject["active_lock_reason"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookIssuesMilestonedIssueActiveLockReasonX9d961372?>(requireNotNull(element)) }
      if (!rawObject.containsKey("body")) {
        throw SerializationException("InlineWebhookIssuesMilestonedIssueX31152acf is missing required property 'body'")
      }
      ...
      if (!rawObject.containsKey("closed_at")) {
        throw SerializationException("InlineWebhookIssuesMilestonedIssueX31152acf is missing required property 'closed_at'")
      }
      ...
      if (!rawObject.containsKey("milestone")) {
        throw SerializationException("InlineWebhookIssuesMilestonedIssueX31152acf is missing required property 'milestone'")
      }
      val milestone = rawObject["milestone"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookIssuesMilestonedIssueMilestoneX7982f9e0?>(requireNotNull(element)) }
      if (!rawObject.containsKey("user")) {
        throw SerializationException("InlineWebhookIssuesMilestonedIssueX31152acf is missing required property 'user'")
      }
      val user = rawObject["user"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookIssuesMilestonedIssueUserX256a6361?>(requireNotNull(element)) }
      return InlineWebhookIssuesMilestonedIssueX31152acf(
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesMilestonedIssueX31152acf) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesMilestonedIssueX31152acf")
...
public fun inlineWebhookIssuesMilestonedIssueX31152acf(block: InlineWebhookIssuesMilestonedIssueX31152acf.Builder.() -> Unit): InlineWebhookIssuesMilestonedIssueX31152acf = InlineWebhookIssuesMilestonedIssueX31152acf.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesMilestonedIssueX31152acf is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookIssuesMilestonedIssueX31152acf property '" + name + "' is not nullable")
