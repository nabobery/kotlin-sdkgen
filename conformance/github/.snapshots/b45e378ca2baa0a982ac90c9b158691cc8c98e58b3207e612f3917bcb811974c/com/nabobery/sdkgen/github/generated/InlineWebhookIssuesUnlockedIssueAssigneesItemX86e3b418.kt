 ...
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-unlocked/properties/issue/properties/assignees/items
 */
@Serializable(with = InlineWebhookIssuesUnlockedIssueAssigneesItemX86e3b418.Serializer::class)
public class InlineWebhookIssuesUnlockedIssueAssigneesItemX86e3b418(
  public val id: Int,
  ...
  public val type: InlineWebhookIssuesUnlockedIssueAssigneesItemTypeX6264ab5d? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookIssuesUnlockedIssueAssigneesItemTypeX6264ab5d? = null
    ...
    public fun build(): InlineWebhookIssuesUnlockedIssueAssigneesItemX86e3b418 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssuesUnlockedIssueAssigneesItemX86e3b418(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesUnlockedIssueAssigneesItemX86e3b418 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesUnlockedIssueAssigneesItemX86e3b418> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesUnlockedIssueAssigneesItemX86e3b418 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesUnlockedIssueAssigneesItemX86e3b418")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesUnlockedIssueAssigneesItemX86e3b418 must be a JSON object")
      ...
      return InlineWebhookIssuesUnlockedIssueAssigneesItemX86e3b418(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssuesUnlockedIssueAssigneesItemTypeX6264ab5d>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesUnlockedIssueAssigneesItemX86e3b418) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesUnlockedIssueAssigneesItemX86e3b418")
...
public fun inlineWebhookIssuesUnlockedIssueAssigneesItemX86e3b418(block: InlineWebhookIssuesUnlockedIssueAssigneesItemX86e3b418.Builder.() -> Unit): InlineWebhookIssuesUnlockedIssueAssigneesItemX86e3b418 = InlineWebhookIssuesUnlockedIssueAssigneesItemX86e3b418.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesUnlockedIssueAssigneesItemX86e3b418 is missing required property '" + name + "'")
