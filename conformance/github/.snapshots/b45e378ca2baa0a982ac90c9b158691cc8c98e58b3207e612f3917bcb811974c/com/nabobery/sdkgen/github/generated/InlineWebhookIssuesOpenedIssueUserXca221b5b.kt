...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-opened/properties/issue/properties/user.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-opened/properties/issue/properties/user
 */
@Serializable(with = InlineWebhookIssuesOpenedIssueUserXca221b5b.Serializer::class)
public class InlineWebhookIssuesOpenedIssueUserXca221b5b(
  public val id: Long,
  ...
  public val type: InlineWebhookIssuesOpenedIssueUserTypeX721211b0? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookIssuesOpenedIssueUserTypeX721211b0? = null
    ...
    public fun build(): InlineWebhookIssuesOpenedIssueUserXca221b5b {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssuesOpenedIssueUserXca221b5b(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesOpenedIssueUserXca221b5b = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesOpenedIssueUserXca221b5b> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesOpenedIssueUserXca221b5b {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesOpenedIssueUserXca221b5b")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesOpenedIssueUserXca221b5b must be a JSON object")
      ...
      return InlineWebhookIssuesOpenedIssueUserXca221b5b(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssuesOpenedIssueUserTypeX721211b0>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesOpenedIssueUserXca221b5b) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesOpenedIssueUserXca221b5b")
...
public fun inlineWebhookIssuesOpenedIssueUserXca221b5b(block: InlineWebhookIssuesOpenedIssueUserXca221b5b.Builder.() -> Unit): InlineWebhookIssuesOpenedIssueUserXca221b5b = InlineWebhookIssuesOpenedIssueUserXca221b5b.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesOpenedIssueUserXca221b5b is missing required property '" + name + "'")
