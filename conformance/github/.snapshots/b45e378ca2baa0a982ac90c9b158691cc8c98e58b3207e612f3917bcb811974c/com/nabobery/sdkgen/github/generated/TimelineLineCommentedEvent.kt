...
public class TimelineLineCommentedEvent(
  comments: List<PullRequestReviewComment>? = null,
  public val event: String? = null,
  public val nodeId: String? = null,
) {
  public val comments: List<PullRequestReviewComment>? =
      comments?.let { collection0 -> collection0.toList() }

  public class Builder {
    private var commentsValue: List<PullRequestReviewComment>? = null

    public var comments: List<PullRequestReviewComment>?
  ...
  internal object Serializer : KSerializer<TimelineLineCommentedEvent> {
