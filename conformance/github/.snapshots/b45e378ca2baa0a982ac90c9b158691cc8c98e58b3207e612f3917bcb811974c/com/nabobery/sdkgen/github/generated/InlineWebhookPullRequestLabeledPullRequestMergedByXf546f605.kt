 ...
 * ed_by
 */
@Serializable(with = InlineWebhookPullRequestLabeledPullRequestMergedByXf546f605.Serializer::class)
public class InlineWebhookPullRequestLabeledPullRequestMergedByXf546f605(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestLabeledPullRequestMergedByTypeX33d28e38? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestLabeledPullRequestMergedByTypeX33d28e38? = null
    ...
    public fun build(): InlineWebhookPullRequestLabeledPullRequestMergedByXf546f605 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestLabeledPullRequestMergedByXf546f605(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestLabeledPullRequestMergedByXf546f605 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestLabeledPullRequestMergedByXf546f605> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestLabeledPullRequestMergedByXf546f605 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestLabeledPullRequestMergedByXf546f605")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestLabeledPullRequestMergedByXf546f605 must be a JSON object")
      ...
      return InlineWebhookPullRequestLabeledPullRequestMergedByXf546f605(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestLabeledPullRequestMergedByTypeX33d28e38>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestLabeledPullRequestMergedByXf546f605) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestLabeledPullRequestMergedByXf546f605")
...
public fun inlineWebhookPullRequestLabeledPullRequestMergedByXf546f605(block: InlineWebhookPullRequestLabeledPullRequestMergedByXf546f605.Builder.() -> Unit): InlineWebhookPullRequestLabeledPullRequestMergedByXf546f605 = InlineWebhookPullRequestLabeledPullRequestMergedByXf546f605.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestLabeledPullRequestMergedByXf546f605 is missing required property '" + name + "'")
