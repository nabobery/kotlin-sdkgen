 ...
 * request/properties/assignees/items
 */
@Serializable(with = InlineWebhookPullRequestReacd1OneOf1PullRequestAssigneesItemX95821c9c.Serializer::class)
public class InlineWebhookPullRequestReacd1OneOf1PullRequestAssigneesItemX95821c9c(
  public val id: Int,
  ...
  public val type:
      InlineWebhookPullRequestReacd1OneOf1PullRequestAssigneesItemTypeXdcbd93d4? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestReacd1OneOf1PullRequestAssigneesItemTypeXdcbd93d4? =
        null
    ...
    public fun build(): InlineWebhookPullRequestReacd1OneOf1PullRequestAssigneesItemX95821c9c {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestReacd1OneOf1PullRequestAssigneesItemX95821c9c(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReacd1OneOf1PullRequestAssigneesItemX95821c9c = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReacd1OneOf1PullRequestAssigneesItemX95821c9c> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReacd1OneOf1PullRequestAssigneesItemX95821c9c {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReacd1OneOf1PullRequestAssigneesItemX95821c9c")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReacd1OneOf1PullRequestAssigneesItemX95821c9c must be a JSON object")
      ...
      return InlineWebhookPullRequestReacd1OneOf1PullRequestAssigneesItemX95821c9c(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestReacd1OneOf1PullRequestAssigneesItemTypeXdcbd93d4>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReacd1OneOf1PullRequestAssigneesItemX95821c9c) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReacd1OneOf1PullRequestAssigneesItemX95821c9c")
...
public fun inlineWebhookPullRequestReacd1OneOf1PullRequestAssigneesItemX95821c9c(block: InlineWebhookPullRequestReacd1OneOf1PullRequestAssigneesItemX95821c9c.Builder.() -> Unit): InlineWebhookPullRequestReacd1OneOf1PullRequestAssigneesItemX95821c9c = InlineWebhookPullRequestReacd1OneOf1PullRequestAssigneesItemX95821c9c.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReacd1OneOf1PullRequestAssigneesItemX95821c9c is missing required property '" + name + "'")
