 ...
 * ies/creator
 */
@Serializable(with = InlineWebhookIssuesLabeledIssueMilestoneCreatorXa6bfdf5b.Serializer::class)
public class InlineWebhookIssuesLabeledIssueMilestoneCreatorXa6bfdf5b(
  public val id: Int,
  ...
  public val type: InlineWebhookIssuesLabeledIssueMilestoneCreatorTypeX0ebfc8a9? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookIssuesLabeledIssueMilestoneCreatorTypeX0ebfc8a9? = null
    ...
    public fun build(): InlineWebhookIssuesLabeledIssueMilestoneCreatorXa6bfdf5b {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssuesLabeledIssueMilestoneCreatorXa6bfdf5b(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesLabeledIssueMilestoneCreatorXa6bfdf5b = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesLabeledIssueMilestoneCreatorXa6bfdf5b> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesLabeledIssueMilestoneCreatorXa6bfdf5b {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesLabeledIssueMilestoneCreatorXa6bfdf5b")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesLabeledIssueMilestoneCreatorXa6bfdf5b must be a JSON object")
      ...
      return InlineWebhookIssuesLabeledIssueMilestoneCreatorXa6bfdf5b(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssuesLabeledIssueMilestoneCreatorTypeX0ebfc8a9>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesLabeledIssueMilestoneCreatorXa6bfdf5b) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesLabeledIssueMilestoneCreatorXa6bfdf5b")
...
public fun inlineWebhookIssuesLabeledIssueMilestoneCreatorXa6bfdf5b(block: InlineWebhookIssuesLabeledIssueMilestoneCreatorXa6bfdf5b.Builder.() -> Unit): InlineWebhookIssuesLabeledIssueMilestoneCreatorXa6bfdf5b = InlineWebhookIssuesLabeledIssueMilestoneCreatorXa6bfdf5b.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesLabeledIssueMilestoneCreatorXa6bfdf5b is missing required property '" + name + "'")
