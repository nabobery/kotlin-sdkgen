...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-team-edited/properties/repository/properties/owner.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhook-team-edited/properties/repository/properties/owner
 */
@Serializable(with = InlineWebhookTeamEditedRepositoryOwnerX87f220a9.Serializer::class)
public class InlineWebhookTeamEditedRepositoryOwnerX87f220a9(
  public val id: Int,
  ...
  public val type: InlineWebhookTeamEditedRepositoryOwnerTypeX99d7858b? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookTeamEditedRepositoryOwnerTypeX99d7858b? = null
    ...
    public fun build(): InlineWebhookTeamEditedRepositoryOwnerX87f220a9 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookTeamEditedRepositoryOwnerX87f220a9(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookTeamEditedRepositoryOwnerX87f220a9 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookTeamEditedRepositoryOwnerX87f220a9> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookTeamEditedRepositoryOwnerX87f220a9 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookTeamEditedRepositoryOwnerX87f220a9")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookTeamEditedRepositoryOwnerX87f220a9 must be a JSON object")
      ...
      return InlineWebhookTeamEditedRepositoryOwnerX87f220a9(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookTeamEditedRepositoryOwnerTypeX99d7858b>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookTeamEditedRepositoryOwnerX87f220a9) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookTeamEditedRepositoryOwnerX87f220a9")
...
public fun inlineWebhookTeamEditedRepositoryOwnerX87f220a9(block: InlineWebhookTeamEditedRepositoryOwnerX87f220a9.Builder.() -> Unit): InlineWebhookTeamEditedRepositoryOwnerX87f220a9 = InlineWebhookTeamEditedRepositoryOwnerX87f220a9.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookTeamEditedRepositoryOwnerX87f220a9 is missing required property '" + name + "'")
