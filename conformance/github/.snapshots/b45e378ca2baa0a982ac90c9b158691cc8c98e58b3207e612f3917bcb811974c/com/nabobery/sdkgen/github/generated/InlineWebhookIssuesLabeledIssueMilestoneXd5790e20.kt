 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-labeled/properties/issue/properties/milestone
 */
@Serializable(with = InlineWebhookIssuesLabeledIssueMilestoneXd5790e20.Serializer::class)
public class InlineWebhookIssuesLabeledIssueMilestoneXd5790e20(
  /**
  ...
  public val creator: InlineWebhookIssuesLabeledIssueMilestoneCreatorXa6bfdf5b?,
   ...
   */
  public val state: InlineWebhookIssuesLabeledIssueMilestoneStateXb0838087,
  /**
  ...
  public class Builder {
    ...
    private var stateValue: InlineWebhookIssuesLabeledIssueMilestoneStateXb0838087? = null

    public var state: InlineWebhookIssuesLabeledIssueMilestoneStateXb0838087
    ...
    private var creatorState: FieldState<InlineWebhookIssuesLabeledIssueMilestoneCreatorXa6bfdf5b?>
        = FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var creator: InlineWebhookIssuesLabeledIssueMilestoneCreatorXa6bfdf5b?
    ...
    public fun build(): InlineWebhookIssuesLabeledIssueMilestoneXd5790e20 {
      ...
      return InlineWebhookIssuesLabeledIssueMilestoneXd5790e20(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesLabeledIssueMilestoneXd5790e20 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesLabeledIssueMilestoneXd5790e20> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesLabeledIssueMilestoneXd5790e20 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesLabeledIssueMilestoneXd5790e20")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesLabeledIssueMilestoneXd5790e20 must be a JSON object")
      ...
      val state = json.decodeRequired<InlineWebhookIssuesLabeledIssueMilestoneStateXb0838087>(rawObject, "state")
      val title = json.decodeRequired<String>(rawObject, "title")
      val updatedAt = json.decodeRequired<String>(rawObject, "updated_at")
      val url = json.decodeRequired<String>(rawObject, "url")
      if (!rawObject.containsKey("closed_at")) {
        throw SerializationException("InlineWebhookIssuesLabeledIssueMilestoneXd5790e20 is missing required property 'closed_at'")
      }
      ...
      if (!rawObject.containsKey("creator")) {
        throw SerializationException("InlineWebhookIssuesLabeledIssueMilestoneXd5790e20 is missing required property 'creator'")
      }
      val creator = rawObject["creator"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookIssuesLabeledIssueMilestoneCreatorXa6bfdf5b?>(requireNotNull(element)) }
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookIssuesLabeledIssueMilestoneXd5790e20 is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("due_on")) {
        throw SerializationException("InlineWebhookIssuesLabeledIssueMilestoneXd5790e20 is missing required property 'due_on'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesLabeledIssueMilestoneXd5790e20) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesLabeledIssueMilestoneXd5790e20")
...
public fun inlineWebhookIssuesLabeledIssueMilestoneXd5790e20(block: InlineWebhookIssuesLabeledIssueMilestoneXd5790e20.Builder.() -> Unit): InlineWebhookIssuesLabeledIssueMilestoneXd5790e20 = InlineWebhookIssuesLabeledIssueMilestoneXd5790e20.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesLabeledIssueMilestoneXd5790e20 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookIssuesLabeledIssueMilestoneXd5790e20 property '" + name + "' is not nullable")
