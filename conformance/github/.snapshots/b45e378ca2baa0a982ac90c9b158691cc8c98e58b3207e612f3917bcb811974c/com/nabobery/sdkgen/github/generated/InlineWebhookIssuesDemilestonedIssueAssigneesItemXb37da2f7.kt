...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-demilestoned/properties/issue/properties/assignees/it
 * ems.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-demilestoned/properties/issue/properties/assignees/it
 * ems
 */
@Serializable(with = InlineWebhookIssuesDemilestonedIssueAssigneesItemXb37da2f7.Serializer::class)
public class InlineWebhookIssuesDemilestonedIssueAssigneesItemXb37da2f7(
  public val id: Int,
  ...
  public val type: InlineWebhookIssuesDemilestonedIssueAssigneesItemTypeX45d83e8c? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookIssuesDemilestonedIssueAssigneesItemTypeX45d83e8c? = null
    ...
    public fun build(): InlineWebhookIssuesDemilestonedIssueAssigneesItemXb37da2f7 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssuesDemilestonedIssueAssigneesItemXb37da2f7(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesDemilestonedIssueAssigneesItemXb37da2f7 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesDemilestonedIssueAssigneesItemXb37da2f7> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesDemilestonedIssueAssigneesItemXb37da2f7 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesDemilestonedIssueAssigneesItemXb37da2f7")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesDemilestonedIssueAssigneesItemXb37da2f7 must be a JSON object")
      ...
      return InlineWebhookIssuesDemilestonedIssueAssigneesItemXb37da2f7(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssuesDemilestonedIssueAssigneesItemTypeX45d83e8c>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesDemilestonedIssueAssigneesItemXb37da2f7) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesDemilestonedIssueAssigneesItemXb37da2f7")
...
public fun inlineWebhookIssuesDemilestonedIssueAssigneesItemXb37da2f7(block: InlineWebhookIssuesDemilestonedIssueAssigneesItemXb37da2f7.Builder.() -> Unit): InlineWebhookIssuesDemilestonedIssueAssigneesItemXb37da2f7 = InlineWebhookIssuesDemilestonedIssueAssigneesItemXb37da2f7.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesDemilestonedIssueAssigneesItemXb37da2f7 is missing required property '" + name + "'")
