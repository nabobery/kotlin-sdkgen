...
public class InlineAgentsTasksGetResponse401JsonX1d8b1c6d(
  ...
  errors: List<InlineAgentsTasksGetResponse401JsonErrorsItemX9caebb02>? = null,
) {
  /**
   * List of validation errors (present only for 422 responses)
   */
  public val errors: List<InlineAgentsTasksGetResponse401JsonErrorsItemX9caebb02>? =
  ...
  public class Builder {
    ...
    private var errorsValue: List<InlineAgentsTasksGetResponse401JsonErrorsItemX9caebb02>? = null

    /**
     * List of validation errors (present only for 422 responses)
     */
    public var errors: List<InlineAgentsTasksGetResponse401JsonErrorsItemX9caebb02>?
  ...
  internal object Serializer : KSerializer<InlineAgentsTasksGetResponse401JsonX1d8b1c6d> {
