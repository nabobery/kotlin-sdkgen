 ...
 * estone/properties/creator
 */
@Serializable(with = InlineWebhookPullRequestUnlockedPullRequestMilestoneCreatorX79467c29.Serializer::class)
public class InlineWebhookPullRequestUnlockedPullRequestMilestoneCreatorX79467c29(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestUnlockedPullRequestMilestoneCreatorTypeX07af37fe? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestUnlockedPullRequestMilestoneCreatorTypeX07af37fe? =
        null
    ...
    public fun build(): InlineWebhookPullRequestUnlockedPullRequestMilestoneCreatorX79467c29 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestUnlockedPullRequestMilestoneCreatorX79467c29(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestUnlockedPullRequestMilestoneCreatorX79467c29 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestUnlockedPullRequestMilestoneCreatorX79467c29> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestUnlockedPullRequestMilestoneCreatorX79467c29 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestUnlockedPullRequestMilestoneCreatorX79467c29")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestUnlockedPullRequestMilestoneCreatorX79467c29 must be a JSON object")
      ...
      return InlineWebhookPullRequestUnlockedPullRequestMilestoneCreatorX79467c29(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestUnlockedPullRequestMilestoneCreatorTypeX07af37fe>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestUnlockedPullRequestMilestoneCreatorX79467c29) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestUnlockedPullRequestMilestoneCreatorX79467c29")
...
public fun inlineWebhookPullRequestUnlockedPullRequestMilestoneCreatorX79467c29(block: InlineWebhookPullRequestUnlockedPullRequestMilestoneCreatorX79467c29.Builder.() -> Unit): InlineWebhookPullRequestUnlockedPullRequestMilestoneCreatorX79467c29 = InlineWebhookPullRequestUnlockedPullRequestMilestoneCreatorX79467c29.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestUnlockedPullRequestMilestoneCreatorX79467c29 is missing required property '" + name + "'")
