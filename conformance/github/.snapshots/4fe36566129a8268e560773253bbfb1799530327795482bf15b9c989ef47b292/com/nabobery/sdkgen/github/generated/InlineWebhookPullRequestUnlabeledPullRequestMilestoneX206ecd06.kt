 ...
 * lestone
 */
@Serializable(with = InlineWebhookPullRequestUnlabeledPullRequestMilestoneX206ecd06.Serializer::class)
public class InlineWebhookPullRequestUnlabeledPullRequestMilestoneX206ecd06(
  /**
  ...
  public val creator: InlineWebhookPullRequestUnlabeledPullRequestMilestoneCreatorX3f0ad1bd?,
   ...
   */
  public val state: InlineWebhookPullRequestUnlabeledPullRequestMilestoneStateX905e3899,
  /**
  ...
  public class Builder {
    ...
    private var stateValue: InlineWebhookPullRequestUnlabeledPullRequestMilestoneStateX905e3899? =
        null

    public var state: InlineWebhookPullRequestUnlabeledPullRequestMilestoneStateX905e3899
    ...
    private var creatorState:
        FieldState<InlineWebhookPullRequestUnlabeledPullRequestMilestoneCreatorX3f0ad1bd?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var creator: InlineWebhookPullRequestUnlabeledPullRequestMilestoneCreatorX3f0ad1bd?
    ...
    public fun build(): InlineWebhookPullRequestUnlabeledPullRequestMilestoneX206ecd06 {
      ...
      return InlineWebhookPullRequestUnlabeledPullRequestMilestoneX206ecd06(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestUnlabeledPullRequestMilestoneX206ecd06 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestUnlabeledPullRequestMilestoneX206ecd06> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestUnlabeledPullRequestMilestoneX206ecd06 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestUnlabeledPullRequestMilestoneX206ecd06")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestUnlabeledPullRequestMilestoneX206ecd06 must be a JSON object")
      ...
      val state = json.decodeRequired<InlineWebhookPullRequestUnlabeledPullRequestMilestoneStateX905e3899>(rawObject, "state")
      val title = json.decodeRequired<String>(rawObject, "title")
      val updatedAt = json.decodeRequired<String>(rawObject, "updated_at")
      val url = json.decodeRequired<String>(rawObject, "url")
      if (!rawObject.containsKey("closed_at")) {
        throw SerializationException("InlineWebhookPullRequestUnlabeledPullRequestMilestoneX206ecd06 is missing required property 'closed_at'")
      }
      ...
      if (!rawObject.containsKey("creator")) {
        throw SerializationException("InlineWebhookPullRequestUnlabeledPullRequestMilestoneX206ecd06 is missing required property 'creator'")
      }
      val creator = rawObject["creator"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestUnlabeledPullRequestMilestoneCreatorX3f0ad1bd?>(requireNotNull(element)) }
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookPullRequestUnlabeledPullRequestMilestoneX206ecd06 is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("due_on")) {
        throw SerializationException("InlineWebhookPullRequestUnlabeledPullRequestMilestoneX206ecd06 is missing required property 'due_on'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestUnlabeledPullRequestMilestoneX206ecd06) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestUnlabeledPullRequestMilestoneX206ecd06")
...
public fun inlineWebhookPullRequestUnlabeledPullRequestMilestoneX206ecd06(block: InlineWebhookPullRequestUnlabeledPullRequestMilestoneX206ecd06.Builder.() -> Unit): InlineWebhookPullRequestUnlabeledPullRequestMilestoneX206ecd06 = InlineWebhookPullRequestUnlabeledPullRequestMilestoneX206ecd06.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestUnlabeledPullRequestMilestoneX206ecd06 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookPullRequestUnlabeledPullRequestMilestoneX206ecd06 property '" + name + "' is not nullable")
