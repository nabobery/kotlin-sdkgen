 ...
 * roperties/milestone
 */
@Serializable(with = InlineWebhookIssuesTransferredChangesNewIssueMilestoneX9db6891b.Serializer::class)
public class InlineWebhookIssuesTransferredChangesNewIssueMilestoneX9db6891b(
  /**
  ...
  public val creator: InlineWebhookIssuesTransferredChangesNewIssueMilestoneCreatorX0ad9cb69?,
   ...
   */
  public val state: InlineWebhookIssuesTransferredChangesNewIssueMilestoneStateXe79632d8,
  /**
  ...
  public class Builder {
    ...
    private var stateValue: InlineWebhookIssuesTransferredChangesNewIssueMilestoneStateXe79632d8? =
        null

    public var state: InlineWebhookIssuesTransferredChangesNewIssueMilestoneStateXe79632d8
    ...
    private var creatorState:
        FieldState<InlineWebhookIssuesTransferredChangesNewIssueMilestoneCreatorX0ad9cb69?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var creator: InlineWebhookIssuesTransferredChangesNewIssueMilestoneCreatorX0ad9cb69?
    ...
    public fun build(): InlineWebhookIssuesTransferredChangesNewIssueMilestoneX9db6891b {
      ...
      return InlineWebhookIssuesTransferredChangesNewIssueMilestoneX9db6891b(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesTransferredChangesNewIssueMilestoneX9db6891b = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesTransferredChangesNewIssueMilestoneX9db6891b> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesTransferredChangesNewIssueMilestoneX9db6891b {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesTransferredChangesNewIssueMilestoneX9db6891b")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesTransferredChangesNewIssueMilestoneX9db6891b must be a JSON object")
      ...
      val state = json.decodeRequired<InlineWebhookIssuesTransferredChangesNewIssueMilestoneStateXe79632d8>(rawObject, "state")
      val title = json.decodeRequired<String>(rawObject, "title")
      val updatedAt = json.decodeRequired<String>(rawObject, "updated_at")
      val url = json.decodeRequired<String>(rawObject, "url")
      if (!rawObject.containsKey("closed_at")) {
        throw SerializationException("InlineWebhookIssuesTransferredChangesNewIssueMilestoneX9db6891b is missing required property 'closed_at'")
      }
      ...
      if (!rawObject.containsKey("creator")) {
        throw SerializationException("InlineWebhookIssuesTransferredChangesNewIssueMilestoneX9db6891b is missing required property 'creator'")
      }
      val creator = rawObject["creator"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookIssuesTransferredChangesNewIssueMilestoneCreatorX0ad9cb69?>(requireNotNull(element)) }
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookIssuesTransferredChangesNewIssueMilestoneX9db6891b is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("due_on")) {
        throw SerializationException("InlineWebhookIssuesTransferredChangesNewIssueMilestoneX9db6891b is missing required property 'due_on'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesTransferredChangesNewIssueMilestoneX9db6891b) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesTransferredChangesNewIssueMilestoneX9db6891b")
...
public fun inlineWebhookIssuesTransferredChangesNewIssueMilestoneX9db6891b(block: InlineWebhookIssuesTransferredChangesNewIssueMilestoneX9db6891b.Builder.() -> Unit): InlineWebhookIssuesTransferredChangesNewIssueMilestoneX9db6891b = InlineWebhookIssuesTransferredChangesNewIssueMilestoneX9db6891b.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesTransferredChangesNewIssueMilestoneX9db6891b is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookIssuesTransferredChangesNewIssueMilestoneX9db6891b property '" + name + "' is not nullable")
