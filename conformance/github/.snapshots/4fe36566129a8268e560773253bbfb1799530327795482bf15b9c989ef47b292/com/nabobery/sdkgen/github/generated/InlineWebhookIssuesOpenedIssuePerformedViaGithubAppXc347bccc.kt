 ...
 * ub_app
 */
@Serializable(with = InlineWebhookIssuesOpenedIssuePerformedViaGithubAppXc347bccc.Serializer::class)
public class InlineWebhookIssuesOpenedIssuePerformedViaGithubAppXc347bccc internal constructor(
  /**
  ...
  public val owner: InlineWebhookIssuesOpenedIssuePerformedViaGithubAppOwnerX1e2a76a5?,
  /**
   * Wire format: `date-time`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  public val updatedAt: String?,
  eventsState: FieldState<List<InlineWebhookIssuesOpenedIssuePerformedViaGithubAppEventsItemXc5c3034b>>,
  private val permissionsState:
      FieldState<InlineWebhookIssuesOpenedIssuePerformedViaGithubAppPermissionsX9d011bef>,
  private val slugState: FieldState<String>,
) {
  private val eventsState:
      FieldState<List<InlineWebhookIssuesOpenedIssuePerformedViaGithubAppEventsItemXc5c3034b>> =
      eventsState.copyValue { fieldValue -> fieldValue.toList() }

  /**
   * The list of events for the GitHub app
   */
  public val events: List<InlineWebhookIssuesOpenedIssuePerformedViaGithubAppEventsItemXc5c3034b>?
    get() = eventsState.valueOrNull()

  /**
   * The set of permissions for the GitHub app
   */
  public val permissions: InlineWebhookIssuesOpenedIssuePerformedViaGithubAppPermissionsX9d011bef?
  ...
  public constructor(
    ...
    name: String,
    nodeId: String,
    owner: InlineWebhookIssuesOpenedIssuePerformedViaGithubAppOwnerX1e2a76a5?,
    updatedAt: String?,
  ...
  public class Builder {
    ...
    private var ownerState:
        FieldState<InlineWebhookIssuesOpenedIssuePerformedViaGithubAppOwnerX1e2a76a5?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var owner: InlineWebhookIssuesOpenedIssuePerformedViaGithubAppOwnerX1e2a76a5?
     ...
     */
    public var events: List<InlineWebhookIssuesOpenedIssuePerformedViaGithubAppEventsItemXc5c3034b>?
     ...
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var permissions: InlineWebhookIssuesOpenedIssuePerformedViaGithubAppPermissionsX9d011bef?
      get() = permissionsState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): InlineWebhookIssuesOpenedIssuePerformedViaGithubAppXc347bccc {
      ...
      return InlineWebhookIssuesOpenedIssuePerformedViaGithubAppXc347bccc(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesOpenedIssuePerformedViaGithubAppXc347bccc = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesOpenedIssuePerformedViaGithubAppXc347bccc> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesOpenedIssuePerformedViaGithubAppXc347bccc {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesOpenedIssuePerformedViaGithubAppXc347bccc")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesOpenedIssuePerformedViaGithubAppXc347bccc must be a JSON object")
      val htmlUrl = json.decodeRequired<String>(rawObject, "html_url")
      val name = json.decodeRequired<String>(rawObject, "name")
      val nodeId = json.decodeRequired<String>(rawObject, "node_id")
      if (!rawObject.containsKey("created_at")) {
        throw SerializationException("InlineWebhookIssuesOpenedIssuePerformedViaGithubAppXc347bccc is missing required property 'created_at'")
      }
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookIssuesOpenedIssuePerformedViaGithubAppXc347bccc is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("external_url")) {
        throw SerializationException("InlineWebhookIssuesOpenedIssuePerformedViaGithubAppXc347bccc is missing required property 'external_url'")
      }
      ...
      if (!rawObject.containsKey("id")) {
        throw SerializationException("InlineWebhookIssuesOpenedIssuePerformedViaGithubAppXc347bccc is missing required property 'id'")
      }
      ...
      if (!rawObject.containsKey("owner")) {
        throw SerializationException("InlineWebhookIssuesOpenedIssuePerformedViaGithubAppXc347bccc is missing required property 'owner'")
      }
      val owner = rawObject["owner"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookIssuesOpenedIssuePerformedViaGithubAppOwnerX1e2a76a5?>(requireNotNull(element)) }
      if (!rawObject.containsKey("updated_at")) {
        throw SerializationException("InlineWebhookIssuesOpenedIssuePerformedViaGithubAppXc347bccc is missing required property 'updated_at'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesOpenedIssuePerformedViaGithubAppXc347bccc) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesOpenedIssuePerformedViaGithubAppXc347bccc")
...
public fun inlineWebhookIssuesOpenedIssuePerformedViaGithubAppXc347bccc(block: InlineWebhookIssuesOpenedIssuePerformedViaGithubAppXc347bccc.Builder.() -> Unit): InlineWebhookIssuesOpenedIssuePerformedViaGithubAppXc347bccc = InlineWebhookIssuesOpenedIssuePerformedViaGithubAppXc347bccc.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesOpenedIssuePerformedViaGithubAppXc347bccc is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookIssuesOpenedIssuePerformedViaGithubAppXc347bccc property '" + name + "' is not nullable")
