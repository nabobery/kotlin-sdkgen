 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/organization-simple-webhooks
 */
@Serializable(with = OrganizationSimpleWebhooks.Serializer::class)
public class OrganizationSimpleWebhooks(
  ...
  public class Builder {
    ...
    public fun build(): OrganizationSimpleWebhooks {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): OrganizationSimpleWebhooks = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<OrganizationSimpleWebhooks> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): OrganizationSimpleWebhooks {
      val jsonDecoder = decoder.requireJsonDecoder("OrganizationSimpleWebhooks")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("OrganizationSimpleWebhooks must be a JSON object")
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("OrganizationSimpleWebhooks is missing required property 'description'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: OrganizationSimpleWebhooks) {
      val jsonEncoder = encoder.requireJsonEncoder("OrganizationSimpleWebhooks")
...
public fun organizationSimpleWebhooks(block: OrganizationSimpleWebhooks.Builder.() -> Unit): OrganizationSimpleWebhooks = OrganizationSimpleWebhooks.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("OrganizationSimpleWebhooks is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("OrganizationSimpleWebhooks property '" + name + "' is not nullable")
