 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhooks_deploy_key
 */
@Serializable(with = WebhooksDeployKey.Serializer::class)
public class WebhooksDeployKey(
  ...
  public class Builder {
    ...
    public fun build(): WebhooksDeployKey {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): WebhooksDeployKey = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<WebhooksDeployKey> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): WebhooksDeployKey {
      val jsonDecoder = decoder.requireJsonDecoder("WebhooksDeployKey")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("WebhooksDeployKey must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: WebhooksDeployKey) {
      val jsonEncoder = encoder.requireJsonEncoder("WebhooksDeployKey")
...
public fun webhooksDeployKey(block: WebhooksDeployKey.Builder.() -> Unit): WebhooksDeployKey = WebhooksDeployKey.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("WebhooksDeployKey is missing required property '" + name + "'")
