 ...
 * s/repository/properties/owner
 */
@Serializable(with = InlineWebhookDeploymentReviewApprovedWorkflowRunRepositoryOwnerXfee87d61.Serializer::class)
public class InlineWebhookDeploymentReviewApprovedWorkflowRunRepositoryOwnerXfee87d61(
  ...
  public class Builder {
    ...
    public fun build(): InlineWebhookDeploymentReviewApprovedWorkflowRunRepositoryOwnerXfee87d61 = InlineWebhookDeploymentReviewApprovedWorkflowRunRepositoryOwnerXfee87d61(
      avatarUrl = avatarUrl,
      eventsUrl = eventsUrl,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookDeploymentReviewApprovedWorkflowRunRepositoryOwnerXfee87d61 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookDeploymentReviewApprovedWorkflowRunRepositoryOwnerXfee87d61> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookDeploymentReviewApprovedWorkflowRunRepositoryOwnerXfee87d61 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookDeploymentReviewApprovedWorkflowRunRepositoryOwnerXfee87d61")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookDeploymentReviewApprovedWorkflowRunRepositoryOwnerXfee87d61 must be a JSON object")
      return InlineWebhookDeploymentReviewApprovedWorkflowRunRepositoryOwnerXfee87d61(
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookDeploymentReviewApprovedWorkflowRunRepositoryOwnerXfee87d61) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookDeploymentReviewApprovedWorkflowRunRepositoryOwnerXfee87d61")
...
public fun inlineWebhookDeploymentReviewApprovedWorkflowRunRepositoryOwnerXfee87d61(block: InlineWebhookDeploymentReviewApprovedWorkflowRunRepositoryOwnerXfee87d61.Builder.() -> Unit): InlineWebhookDeploymentReviewApprovedWorkflowRunRepositoryOwnerXfee87d61 = InlineWebhookDeploymentReviewApprovedWorkflowRunRepositoryOwnerXfee87d61.build(block)
