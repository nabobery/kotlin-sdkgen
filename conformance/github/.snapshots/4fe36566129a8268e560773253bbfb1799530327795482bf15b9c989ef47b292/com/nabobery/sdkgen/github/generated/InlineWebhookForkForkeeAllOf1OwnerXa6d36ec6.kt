...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-fork/properties/forkee/allOf/0/properties/owner.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhook-fork/properties/forkee/allOf/0/properties/owner
 */
@Serializable(with = InlineWebhookForkForkeeAllOf1OwnerXa6d36ec6.Serializer::class)
public class InlineWebhookForkForkeeAllOf1OwnerXa6d36ec6(
  public val id: Int,
  ...
  public val type: InlineWebhookForkForkeeAllOf1OwnerTypeXf126cbe5? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookForkForkeeAllOf1OwnerTypeXf126cbe5? = null
    ...
    public fun build(): InlineWebhookForkForkeeAllOf1OwnerXa6d36ec6 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookForkForkeeAllOf1OwnerXa6d36ec6(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookForkForkeeAllOf1OwnerXa6d36ec6 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookForkForkeeAllOf1OwnerXa6d36ec6> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookForkForkeeAllOf1OwnerXa6d36ec6 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookForkForkeeAllOf1OwnerXa6d36ec6")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookForkForkeeAllOf1OwnerXa6d36ec6 must be a JSON object")
      ...
      return InlineWebhookForkForkeeAllOf1OwnerXa6d36ec6(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookForkForkeeAllOf1OwnerTypeXf126cbe5>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookForkForkeeAllOf1OwnerXa6d36ec6) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookForkForkeeAllOf1OwnerXa6d36ec6")
...
public fun inlineWebhookForkForkeeAllOf1OwnerXa6d36ec6(block: InlineWebhookForkForkeeAllOf1OwnerXa6d36ec6.Builder.() -> Unit): InlineWebhookForkForkeeAllOf1OwnerXa6d36ec6 = InlineWebhookForkForkeeAllOf1OwnerXa6d36ec6.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookForkForkeeAllOf1OwnerXa6d36ec6 is missing required property '" + name + "'")
