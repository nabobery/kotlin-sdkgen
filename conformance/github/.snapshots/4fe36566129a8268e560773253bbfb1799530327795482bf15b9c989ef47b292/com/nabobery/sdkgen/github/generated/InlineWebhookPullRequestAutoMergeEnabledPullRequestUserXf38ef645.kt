 ...
 * erties/user
 */
@Serializable(with = InlineWebhookPullRequestAutoMergeEnabledPullRequestUserXf38ef645.Serializer::class)
public class InlineWebhookPullRequestAutoMergeEnabledPullRequestUserXf38ef645(
  public val id: Long,
  ...
  public val type: InlineWebhookPullRequestAutoMergeEnabledPullRequestUserTypeXb70b6f19? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestAutoMergeEnabledPullRequestUserTypeXb70b6f19? = null
    ...
    public fun build(): InlineWebhookPullRequestAutoMergeEnabledPullRequestUserXf38ef645 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestAutoMergeEnabledPullRequestUserXf38ef645(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestAutoMergeEnabledPullRequestUserXf38ef645 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestAutoMergeEnabledPullRequestUserXf38ef645> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestAutoMergeEnabledPullRequestUserXf38ef645 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestAutoMergeEnabledPullRequestUserXf38ef645")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestAutoMergeEnabledPullRequestUserXf38ef645 must be a JSON object")
      ...
      return InlineWebhookPullRequestAutoMergeEnabledPullRequestUserXf38ef645(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestAutoMergeEnabledPullRequestUserTypeXb70b6f19>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestAutoMergeEnabledPullRequestUserXf38ef645) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestAutoMergeEnabledPullRequestUserXf38ef645")
...
public fun inlineWebhookPullRequestAutoMergeEnabledPullRequestUserXf38ef645(block: InlineWebhookPullRequestAutoMergeEnabledPullRequestUserXf38ef645.Builder.() -> Unit): InlineWebhookPullRequestAutoMergeEnabledPullRequestUserXf38ef645 = InlineWebhookPullRequestAutoMergeEnabledPullRequestUserXf38ef645.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestAutoMergeEnabledPullRequestUserXf38ef645 is missing required property '" + name + "'")
