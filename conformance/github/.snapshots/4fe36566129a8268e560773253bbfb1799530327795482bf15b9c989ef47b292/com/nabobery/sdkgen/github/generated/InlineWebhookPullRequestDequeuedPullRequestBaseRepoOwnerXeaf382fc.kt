 ...
 * e/properties/repo/properties/owner
 */
@Serializable(with = InlineWebhookPullRequestDequeuedPullRequestBaseRepoOwnerXeaf382fc.Serializer::class)
public class InlineWebhookPullRequestDequeuedPullRequestBaseRepoOwnerXeaf382fc(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestDequeuedPullRequestBaseRepoOwnerTypeX4fb6a234? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestDequeuedPullRequestBaseRepoOwnerTypeX4fb6a234? = null
    ...
    public fun build(): InlineWebhookPullRequestDequeuedPullRequestBaseRepoOwnerXeaf382fc {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestDequeuedPullRequestBaseRepoOwnerXeaf382fc(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestDequeuedPullRequestBaseRepoOwnerXeaf382fc = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestDequeuedPullRequestBaseRepoOwnerXeaf382fc> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestDequeuedPullRequestBaseRepoOwnerXeaf382fc {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestDequeuedPullRequestBaseRepoOwnerXeaf382fc")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestDequeuedPullRequestBaseRepoOwnerXeaf382fc must be a JSON object")
      ...
      return InlineWebhookPullRequestDequeuedPullRequestBaseRepoOwnerXeaf382fc(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestDequeuedPullRequestBaseRepoOwnerTypeX4fb6a234>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestDequeuedPullRequestBaseRepoOwnerXeaf382fc) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestDequeuedPullRequestBaseRepoOwnerXeaf382fc")
...
public fun inlineWebhookPullRequestDequeuedPullRequestBaseRepoOwnerXeaf382fc(block: InlineWebhookPullRequestDequeuedPullRequestBaseRepoOwnerXeaf382fc.Builder.() -> Unit): InlineWebhookPullRequestDequeuedPullRequestBaseRepoOwnerXeaf382fc = InlineWebhookPullRequestDequeuedPullRequestBaseRepoOwnerXeaf382fc.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestDequeuedPullRequestBaseRepoOwnerXeaf382fc is missing required property '" + name + "'")
