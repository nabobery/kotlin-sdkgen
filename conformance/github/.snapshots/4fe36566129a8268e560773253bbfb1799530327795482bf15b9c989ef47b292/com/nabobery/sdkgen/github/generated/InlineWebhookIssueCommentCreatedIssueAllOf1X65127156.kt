 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhook-issue-comment-created/properties/issue/allOf/0
 */
@Serializable(with = InlineWebhookIssueCommentCreatedIssueAllOf1X65127156.Serializer::class)
public class InlineWebhookIssueCommentCreatedIssueAllOf1X65127156 internal constructor(
  public val activeLockReason:
      InlineWebhookIssueCommentCreatedIssueAllOf1ActiveLockReasonXf470c3f1?,
  assignees: List<InlineWebhookIssueCommentCreatedIssueAllOf1AssigneesItemX8bacdc8c?>,
  /**
   ...
   */
  public val milestone: InlineWebhookIssueCommentCreatedIssueAllOf1MilestoneX56cd6f82?,
  public val nodeId: String,
  public val number: Int,
  public val reactions: InlineWebhookIssueCommentCreatedIssueAllOf1ReactionsX44295a89,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val user: InlineWebhookIssueCommentCreatedIssueAllOf1UserXe02d0b8f?,
  private val assigneeState:
      FieldState<InlineWebhookIssueCommentCreatedIssueAllOf1AssigneeXf037954e?>,
  private val draftState: FieldState<Boolean>,
  private val issueDependenciesSummaryState: FieldState<IssueDependenciesSummary>,
  labelsState: FieldState<List<InlineWebhookIssueCommentCreatedIssueAllOf1LabelsItemXf51346a8>>,
  private val lockedState: FieldState<Boolean>,
  private val performedViaGithubAppState:
      FieldState<InlineWebhookIssueCommentCreatedIssueAllOf1PerformedViaGithubAppX01e9c345?>,
  private val pullRequestState:
      FieldState<InlineWebhookIssueCommentCreatedIssueAllOf1PullRequestXe79b2742>,
  private val stateState: FieldState<InlineWebhookIssueCommentCreatedIssueAllOf1StateX965b43db>,
  ...
  public val assignees: List<InlineWebhookIssueCommentCreatedIssueAllOf1AssigneesItemX8bacdc8c?> =
      assignees.toList()

  private val labelsState:
      FieldState<List<InlineWebhookIssueCommentCreatedIssueAllOf1LabelsItemXf51346a8>> =
      labelsState.copyValue { fieldValue -> fieldValue.toList() }

  public val assignee: InlineWebhookIssueCommentCreatedIssueAllOf1AssigneeXf037954e?
  ...
  public val labels: List<InlineWebhookIssueCommentCreatedIssueAllOf1LabelsItemXf51346a8>?
  ...
  public val performedViaGithubApp:
      InlineWebhookIssueCommentCreatedIssueAllOf1PerformedViaGithubAppX01e9c345?
    get() = performedViaGithubAppState.valueOrNull()

  public val pullRequest: InlineWebhookIssueCommentCreatedIssueAllOf1PullRequestXe79b2742?
    get() = pullRequestState.valueOrNull()

  /**
   * State of the issue; either 'open' or 'closed'
   */
  public val state: InlineWebhookIssueCommentCreatedIssueAllOf1StateX965b43db?
  ...
  public constructor(
    activeLockReason: InlineWebhookIssueCommentCreatedIssueAllOf1ActiveLockReasonXf470c3f1?,
    assignees: List<InlineWebhookIssueCommentCreatedIssueAllOf1AssigneesItemX8bacdc8c?>,
    authorAssociation: InlineWebhookIssueCommentCreatedIssueAllOf1AuthorAssociationX7630fd2d,
    body: String?,
    closedAt: String?,
    comments: Int,
    commentsUrl: String,
    ...
    id: Long,
    labelsUrl: String,
    milestone: InlineWebhookIssueCommentCreatedIssueAllOf1MilestoneX56cd6f82?,
    nodeId: String,
    number: Int,
    reactions: InlineWebhookIssueCommentCreatedIssueAllOf1ReactionsX44295a89,
    repositoryUrl: String,
    title: String,
    updatedAt: String,
    url: String,
    user: InlineWebhookIssueCommentCreatedIssueAllOf1UserXe02d0b8f?,
  ...
  public class Builder {
    private var assigneesValue:
        List<InlineWebhookIssueCommentCreatedIssueAllOf1AssigneesItemX8bacdc8c?>? = null

    public var assignees: List<InlineWebhookIssueCommentCreatedIssueAllOf1AssigneesItemX8bacdc8c?>
    ...
    private var authorAssociationValue:
        InlineWebhookIssueCommentCreatedIssueAllOf1AuthorAssociationX7630fd2d? = null
    ...
    private var reactionsValue: InlineWebhookIssueCommentCreatedIssueAllOf1ReactionsX44295a89? =
        null

    public var reactions: InlineWebhookIssueCommentCreatedIssueAllOf1ReactionsX44295a89
    ...
    private var activeLockReasonState:
        FieldState<InlineWebhookIssueCommentCreatedIssueAllOf1ActiveLockReasonXf470c3f1?> =
        FieldState.Absent
    ...
    private var milestoneState:
        FieldState<InlineWebhookIssueCommentCreatedIssueAllOf1MilestoneX56cd6f82?> =
        FieldState.Absent
     ...
     * Required nullable field; assigning `null` records present-null.
     */
    public var milestone: InlineWebhookIssueCommentCreatedIssueAllOf1MilestoneX56cd6f82?
      get() = milestoneState.valueOrNull()
      set(`value`) {
        milestoneState = value.toNullableFieldState()
      }

    private var userState: FieldState<InlineWebhookIssueCommentCreatedIssueAllOf1UserXe02d0b8f?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var user: InlineWebhookIssueCommentCreatedIssueAllOf1UserXe02d0b8f?
     ...
     */
    public var assignee: InlineWebhookIssueCommentCreatedIssueAllOf1AssigneeXf037954e?
      get() = assigneeState.valueOrNull()
      set(`value`) {
     ...
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var labels: List<InlineWebhookIssueCommentCreatedIssueAllOf1LabelsItemXf51346a8>?
     ...
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var pullRequest: InlineWebhookIssueCommentCreatedIssueAllOf1PullRequestXe79b2742?
      get() = pullRequestState.valueOrNull()
      set(`value`) {
    ...
    private var stateState: FieldState<InlineWebhookIssueCommentCreatedIssueAllOf1StateX965b43db> =
        FieldState.Absent
     ...
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var state: InlineWebhookIssueCommentCreatedIssueAllOf1StateX965b43db?
      get() = stateState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): InlineWebhookIssueCommentCreatedIssueAllOf1X65127156 {
      ...
      return InlineWebhookIssueCommentCreatedIssueAllOf1X65127156(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssueCommentCreatedIssueAllOf1X65127156 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssueCommentCreatedIssueAllOf1X65127156> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssueCommentCreatedIssueAllOf1X65127156 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssueCommentCreatedIssueAllOf1X65127156")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssueCommentCreatedIssueAllOf1X65127156 must be a JSON object")
      val assignees = json.decodeRequired<List<InlineWebhookIssueCommentCreatedIssueAllOf1AssigneesItemX8bacdc8c?>>(rawObject, "assignees")
      val authorAssociation = json.decodeRequired<InlineWebhookIssueCommentCreatedIssueAllOf1AuthorAssociationX7630fd2d>(rawObject, "author_association")
      ...
      val reactions = json.decodeRequired<InlineWebhookIssueCommentCreatedIssueAllOf1ReactionsX44295a89>(rawObject, "reactions")
      ...
      if (!rawObject.containsKey("active_lock_reason")) {
        throw SerializationException("InlineWebhookIssueCommentCreatedIssueAllOf1X65127156 is missing required property 'active_lock_reason'")
      }
      val activeLockReason = rawObject["active_lock_reason"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookIssueCommentCreatedIssueAllOf1ActiveLockReasonXf470c3f1?>(requireNotNull(element)) }
      if (!rawObject.containsKey("body")) {
        throw SerializationException("InlineWebhookIssueCommentCreatedIssueAllOf1X65127156 is missing required property 'body'")
      }
      ...
      if (!rawObject.containsKey("closed_at")) {
        throw SerializationException("InlineWebhookIssueCommentCreatedIssueAllOf1X65127156 is missing required property 'closed_at'")
      }
      ...
      if (!rawObject.containsKey("milestone")) {
        throw SerializationException("InlineWebhookIssueCommentCreatedIssueAllOf1X65127156 is missing required property 'milestone'")
      }
      val milestone = rawObject["milestone"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookIssueCommentCreatedIssueAllOf1MilestoneX56cd6f82?>(requireNotNull(element)) }
      if (!rawObject.containsKey("user")) {
        throw SerializationException("InlineWebhookIssueCommentCreatedIssueAllOf1X65127156 is missing required property 'user'")
      }
      val user = rawObject["user"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookIssueCommentCreatedIssueAllOf1UserXe02d0b8f?>(requireNotNull(element)) }
      return InlineWebhookIssueCommentCreatedIssueAllOf1X65127156(
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssueCommentCreatedIssueAllOf1X65127156) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssueCommentCreatedIssueAllOf1X65127156")
...
public fun inlineWebhookIssueCommentCreatedIssueAllOf1X65127156(block: InlineWebhookIssueCommentCreatedIssueAllOf1X65127156.Builder.() -> Unit): InlineWebhookIssueCommentCreatedIssueAllOf1X65127156 = InlineWebhookIssueCommentCreatedIssueAllOf1X65127156.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssueCommentCreatedIssueAllOf1X65127156 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookIssueCommentCreatedIssueAllOf1X65127156 property '" + name + "' is not nullable")
