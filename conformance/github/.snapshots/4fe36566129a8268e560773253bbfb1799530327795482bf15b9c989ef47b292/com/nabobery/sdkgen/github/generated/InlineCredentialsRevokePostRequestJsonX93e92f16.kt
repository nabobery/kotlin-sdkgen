...
public class InlineCredentialsRevokePostRequestJsonX93e92f16(
  ...
  public class Builder {
    ...
    public var credentials: List<String>
      get() = requireNotNull(credentialsValue) { "credentials is required" }.toList()
      set(`value`) {
        credentialsValue = value.toList()
      }
  ...
  internal object Serializer : KSerializer<InlineCredentialsRevokePostRequestJsonX93e92f16> {
