 ...
 * es/head_repository
 */
@Serializable(with = InlineWebhookDeploymentReviewRequestedWorkflowRunHeadRepositoryX53437933.Serializer::class)
public class InlineWebhookDeploymentReviewRequestedWorkflowRunHeadRepositoryX53437933(
  ...
  public val owner:
      InlineWebhookDeploymentReviewRequestedWorkflowRunHeadRepositoryOwnerXfd19262b? = null,
  ...
  public class Builder {
    ...
    public var owner: InlineWebhookDeploymentReviewRequestedWorkflowRunHeadRepositoryOwnerXfd19262b?
        = null
    ...
    public fun build(): InlineWebhookDeploymentReviewRequestedWorkflowRunHeadRepositoryX53437933 = InlineWebhookDeploymentReviewRequestedWorkflowRunHeadRepositoryX53437933(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookDeploymentReviewRequestedWorkflowRunHeadRepositoryX53437933 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookDeploymentReviewRequestedWorkflowRunHeadRepositoryX53437933> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookDeploymentReviewRequestedWorkflowRunHeadRepositoryX53437933 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookDeploymentReviewRequestedWorkflowRunHeadRepositoryX53437933")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookDeploymentReviewRequestedWorkflowRunHeadRepositoryX53437933 must be a JSON object")
      return InlineWebhookDeploymentReviewRequestedWorkflowRunHeadRepositoryX53437933(
        ...
        owner = rawObject["owner"]?.let { json.decodeFromJsonElement<InlineWebhookDeploymentReviewRequestedWorkflowRunHeadRepositoryOwnerXfd19262b>(it) },
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookDeploymentReviewRequestedWorkflowRunHeadRepositoryX53437933) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookDeploymentReviewRequestedWorkflowRunHeadRepositoryX53437933")
...
public fun inlineWebhookDeploymentReviewRequestedWorkflowRunHeadRepositoryX53437933(block: InlineWebhookDeploymentReviewRequestedWorkflowRunHeadRepositoryX53437933.Builder.() -> Unit): InlineWebhookDeploymentReviewRequestedWorkflowRunHeadRepositoryX53437933 = InlineWebhookDeploymentReviewRequestedWorkflowRunHeadRepositoryX53437933.build(block)
