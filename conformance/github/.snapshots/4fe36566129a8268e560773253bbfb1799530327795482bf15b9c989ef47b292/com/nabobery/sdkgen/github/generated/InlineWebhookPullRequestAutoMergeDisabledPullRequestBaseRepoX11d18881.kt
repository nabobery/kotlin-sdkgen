 ...
 * perties/base/properties/repo
 */
@Serializable(with = InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseRepoX11d18881.Serializer::class)
public class InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseRepoX11d18881 internal constructor(
  /**
  ...
  public val createdAt:
      InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseRepoCreatedAtXb47ae6c5,
  /**
  ...
  public val license: InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseRepoLicenseX224f89b8?,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val owner: InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseRepoOwnerX25b53065?,
  /**
  ...
  public val pushedAt:
      InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseRepoPushedAtXb600d29a?,
  /**
   * Wire format: `uri-template`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  private val mergeCommitMessageState:
      FieldState<InlineWebhookPullRequestAu1a35PullRequestBaseRepoMergeCommitMessageXb3219ac9>,
  private val mergeCommitTitleState:
      FieldState<InlineWebhookPullRequestAu1a35PullRequestBaseRepoMergeCommitTitleX28b44c4c>,
  private val organizationState: FieldState<String>,
  private val permissionsState:
      FieldState<InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseRepoPermissionsX58dacf36>,
  private val publicState: FieldState<Boolean>,
  private val pullRequestCreationPolicyState:
      FieldState<InlineWebhookPullRequestAu1a35PullRequestBasePullRequestCreationP824dX9affda38>,
  private val roleNameState: FieldState<String?>,
  private val squashMergeCommitMessageState:
      FieldState<InlineWebhookPullRequestAu1a35PullRequestBaseSquashMergeCommitMessageXc475aef9>,
  private val squashMergeCommitTitleState:
      FieldState<InlineWebhookPullRequestAu1a35PullRequestBaseRepoSquashMergeCommitTitleXb0bf60f6>,
  ...
  public val mergeCommitMessage:
      InlineWebhookPullRequestAu1a35PullRequestBaseRepoMergeCommitMessageXb3219ac9?
  ...
  public val permissions:
      InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseRepoPermissionsX58dacf36?
  ...
  public val pullRequestCreationPolicy:
      InlineWebhookPullRequestAu1a35PullRequestBasePullRequestCreationP824dX9affda38?
  ...
  public val squashMergeCommitTitle:
      InlineWebhookPullRequestAu1a35PullRequestBaseRepoSquashMergeCommitTitleXb0bf60f6?
  ...
  public constructor(
    ...
    createdAt: InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseRepoCreatedAtXb47ae6c5,
    ...
    language: String?,
    languagesUrl: String,
    license: InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseRepoLicenseX224f89b8?,
    mergesUrl: String,
    ...
    openIssues: Int,
    openIssuesCount: Int,
    owner: InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseRepoOwnerX25b53065?,
    `private`: Boolean,
    pullsUrl: String,
    pushedAt: InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseRepoPushedAtXb600d29a?,
    releasesUrl: String,
    size: Int,
    sshUrl: String,
    stargazersCount: Int,
    ...
    updatedAt: String,
    url: String,
    visibility: InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseRepoVisibilityXfdad2882,
    watchers: Int,
    watchersCount: Int,
  ...
  public class Builder {
    ...
    private var createdAtValue:
        InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseRepoCreatedAtXb47ae6c5? = null
    ...
    private var visibilityValue:
        InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseRepoVisibilityXfdad2882? = null
    ...
    private var licenseState:
        FieldState<InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseRepoLicenseX224f89b8?> =
        FieldState.Absent
    ...
    private var ownerState:
        FieldState<InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseRepoOwnerX25b53065?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var owner: InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseRepoOwnerX25b53065?
    ...
    private var pushedAtState:
        FieldState<InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseRepoPushedAtXb600d29a?> =
        FieldState.Absent
    ...
    public fun build(): InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseRepoX11d18881 {
      ...
      return InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseRepoX11d18881(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseRepoX11d18881 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseRepoX11d18881> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseRepoX11d18881 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseRepoX11d18881")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseRepoX11d18881 must be a JSON object")
      ...
      val createdAt = json.decodeRequired<InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseRepoCreatedAtXb47ae6c5>(rawObject, "created_at")
      ...
      val visibility = json.decodeRequired<InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseRepoVisibilityXfdad2882>(rawObject, "visibility")
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseRepoX11d18881 is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("homepage")) {
        throw SerializationException("InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseRepoX11d18881 is missing required property 'homepage'")
      }
      ...
      if (!rawObject.containsKey("language")) {
        throw SerializationException("InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseRepoX11d18881 is missing required property 'language'")
      }
      ...
      if (!rawObject.containsKey("license")) {
        throw SerializationException("InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseRepoX11d18881 is missing required property 'license'")
      }
      val license = rawObject["license"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseRepoLicenseX224f89b8?>(requireNotNull(element)) }
      if (!rawObject.containsKey("mirror_url")) {
        throw SerializationException("InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseRepoX11d18881 is missing required property 'mirror_url'")
      }
      ...
      if (!rawObject.containsKey("owner")) {
        throw SerializationException("InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseRepoX11d18881 is missing required property 'owner'")
      }
      val owner = rawObject["owner"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseRepoOwnerX25b53065?>(requireNotNull(element)) }
      if (!rawObject.containsKey("pushed_at")) {
        throw SerializationException("InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseRepoX11d18881 is missing required property 'pushed_at'")
      }
      val pushedAt = rawObject["pushed_at"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseRepoPushedAtXb600d29a?>(requireNotNull(element)) }
      return InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseRepoX11d18881(
        archiveUrl = archiveUrl,
        archived = archived,
        assigneesUrl = assigneesUrl,
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseRepoX11d18881) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseRepoX11d18881")
...
public fun inlineWebhookPullRequestAutoMergeDisabledPullRequestBaseRepoX11d18881(block: InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseRepoX11d18881.Builder.() -> Unit): InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseRepoX11d18881 = InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseRepoX11d18881.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseRepoX11d18881 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookPullRequestAutoMergeDisabledPullRequestBaseRepoX11d18881 property '" + name + "' is not nullable")
