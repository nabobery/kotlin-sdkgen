...
/**
 * Generated model for sdkgen://source/openapi.yaml#/components/schemas/webhooks_review_comment/properties/user.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhooks_review_comment/properties/user
 */
@Serializable(with = InlineWebhooksReviewCommentUserX53e4038e.Serializer::class)
public class InlineWebhooksReviewCommentUserX53e4038e(
  public val id: Long,
  ...
  public val type: InlineWebhooksReviewCommentUserTypeX5c5ea4cd? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhooksReviewCommentUserTypeX5c5ea4cd? = null
    ...
    public fun build(): InlineWebhooksReviewCommentUserX53e4038e {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhooksReviewCommentUserX53e4038e(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhooksReviewCommentUserX53e4038e = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhooksReviewCommentUserX53e4038e> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhooksReviewCommentUserX53e4038e {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhooksReviewCommentUserX53e4038e")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhooksReviewCommentUserX53e4038e must be a JSON object")
      ...
      return InlineWebhooksReviewCommentUserX53e4038e(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhooksReviewCommentUserTypeX5c5ea4cd>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhooksReviewCommentUserX53e4038e) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhooksReviewCommentUserX53e4038e")
...
public fun inlineWebhooksReviewCommentUserX53e4038e(block: InlineWebhooksReviewCommentUserX53e4038e.Builder.() -> Unit): InlineWebhooksReviewCommentUserX53e4038e = InlineWebhooksReviewCommentUserX53e4038e.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhooksReviewCommentUserX53e4038e is missing required property '" + name + "'")
