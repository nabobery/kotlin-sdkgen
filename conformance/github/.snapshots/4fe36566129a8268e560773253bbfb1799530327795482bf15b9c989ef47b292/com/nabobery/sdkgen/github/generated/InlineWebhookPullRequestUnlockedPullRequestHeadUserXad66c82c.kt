 ...
 * d/properties/user
 */
@Serializable(with = InlineWebhookPullRequestUnlockedPullRequestHeadUserXad66c82c.Serializer::class)
public class InlineWebhookPullRequestUnlockedPullRequestHeadUserXad66c82c(
  public val id: Long,
  ...
  public val type: InlineWebhookPullRequestUnlockedPullRequestHeadUserTypeX43eb2637? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestUnlockedPullRequestHeadUserTypeX43eb2637? = null
    ...
    public fun build(): InlineWebhookPullRequestUnlockedPullRequestHeadUserXad66c82c {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestUnlockedPullRequestHeadUserXad66c82c(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestUnlockedPullRequestHeadUserXad66c82c = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestUnlockedPullRequestHeadUserXad66c82c> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestUnlockedPullRequestHeadUserXad66c82c {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestUnlockedPullRequestHeadUserXad66c82c")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestUnlockedPullRequestHeadUserXad66c82c must be a JSON object")
      ...
      return InlineWebhookPullRequestUnlockedPullRequestHeadUserXad66c82c(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestUnlockedPullRequestHeadUserTypeX43eb2637>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestUnlockedPullRequestHeadUserXad66c82c) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestUnlockedPullRequestHeadUserXad66c82c")
...
public fun inlineWebhookPullRequestUnlockedPullRequestHeadUserXad66c82c(block: InlineWebhookPullRequestUnlockedPullRequestHeadUserXad66c82c.Builder.() -> Unit): InlineWebhookPullRequestUnlockedPullRequestHeadUserXad66c82c = InlineWebhookPullRequestUnlockedPullRequestHeadUserXad66c82c.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestUnlockedPullRequestHeadUserXad66c82c is missing required property '" + name + "'")
