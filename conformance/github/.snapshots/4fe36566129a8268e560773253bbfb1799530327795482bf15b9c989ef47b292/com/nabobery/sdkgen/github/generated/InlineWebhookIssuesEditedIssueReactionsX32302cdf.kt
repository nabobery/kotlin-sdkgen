...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-edited/properties/issue/properties/reactions.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-edited/properties/issue/properties/reactions
 */
@Serializable(with = InlineWebhookIssuesEditedIssueReactionsX32302cdf.Serializer::class)
public class InlineWebhookIssuesEditedIssueReactionsX32302cdf(
  public val _1: Int,
  public val _12: Int,
  ...
  public class Builder {
    ...
    public fun build(): InlineWebhookIssuesEditedIssueReactionsX32302cdf {
      ...
      return InlineWebhookIssuesEditedIssueReactionsX32302cdf(
        _1 = _1,
        _12 = _12,
        confused = confused,
        eyes = eyes,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesEditedIssueReactionsX32302cdf = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesEditedIssueReactionsX32302cdf> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesEditedIssueReactionsX32302cdf {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesEditedIssueReactionsX32302cdf")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesEditedIssueReactionsX32302cdf must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesEditedIssueReactionsX32302cdf) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesEditedIssueReactionsX32302cdf")
...
public fun inlineWebhookIssuesEditedIssueReactionsX32302cdf(block: InlineWebhookIssuesEditedIssueReactionsX32302cdf.Builder.() -> Unit): InlineWebhookIssuesEditedIssueReactionsX32302cdf = InlineWebhookIssuesEditedIssueReactionsX32302cdf.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesEditedIssueReactionsX32302cdf is missing required property '" + name + "'")
