...
/**
 * Generated model for sdkgen://source/openapi.yaml#/components/schemas/webhooks_issue_2/properties/reactions.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhooks_issue_2/properties/reactions
 */
@Serializable(with = InlineWebhooksIssue2ReactionsXb59d67b2.Serializer::class)
public class InlineWebhooksIssue2ReactionsXb59d67b2(
  public val _1: Int,
  public val _12: Int,
  ...
  public class Builder {
    ...
    public fun build(): InlineWebhooksIssue2ReactionsXb59d67b2 {
      ...
      return InlineWebhooksIssue2ReactionsXb59d67b2(
        _1 = _1,
        _12 = _12,
        confused = confused,
        eyes = eyes,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhooksIssue2ReactionsXb59d67b2 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhooksIssue2ReactionsXb59d67b2> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhooksIssue2ReactionsXb59d67b2 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhooksIssue2ReactionsXb59d67b2")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhooksIssue2ReactionsXb59d67b2 must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhooksIssue2ReactionsXb59d67b2) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhooksIssue2ReactionsXb59d67b2")
...
public fun inlineWebhooksIssue2ReactionsXb59d67b2(block: InlineWebhooksIssue2ReactionsXb59d67b2.Builder.() -> Unit): InlineWebhooksIssue2ReactionsXb59d67b2 = InlineWebhooksIssue2ReactionsXb59d67b2.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhooksIssue2ReactionsXb59d67b2 is missing required property '" + name + "'")
