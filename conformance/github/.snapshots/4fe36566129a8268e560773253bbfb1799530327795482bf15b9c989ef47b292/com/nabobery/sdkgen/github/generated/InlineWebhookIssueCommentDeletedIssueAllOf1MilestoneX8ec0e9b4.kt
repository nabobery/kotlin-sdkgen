 ...
 * lestone
 */
@Serializable(with = InlineWebhookIssueCommentDeletedIssueAllOf1MilestoneX8ec0e9b4.Serializer::class)
public class InlineWebhookIssueCommentDeletedIssueAllOf1MilestoneX8ec0e9b4(
  /**
  ...
  public val creator: InlineWebhookIssueCommentDeletedIssueAllOf1MilestoneCreatorXab4ce9e7?,
   ...
   */
  public val state: InlineWebhookIssueCommentDeletedIssueAllOf1MilestoneStateX6468a3b2,
  /**
  ...
  public class Builder {
    ...
    private var stateValue: InlineWebhookIssueCommentDeletedIssueAllOf1MilestoneStateX6468a3b2? =
        null

    public var state: InlineWebhookIssueCommentDeletedIssueAllOf1MilestoneStateX6468a3b2
    ...
    private var creatorState:
        FieldState<InlineWebhookIssueCommentDeletedIssueAllOf1MilestoneCreatorXab4ce9e7?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var creator: InlineWebhookIssueCommentDeletedIssueAllOf1MilestoneCreatorXab4ce9e7?
    ...
    public fun build(): InlineWebhookIssueCommentDeletedIssueAllOf1MilestoneX8ec0e9b4 {
      ...
      return InlineWebhookIssueCommentDeletedIssueAllOf1MilestoneX8ec0e9b4(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssueCommentDeletedIssueAllOf1MilestoneX8ec0e9b4 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssueCommentDeletedIssueAllOf1MilestoneX8ec0e9b4> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssueCommentDeletedIssueAllOf1MilestoneX8ec0e9b4 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssueCommentDeletedIssueAllOf1MilestoneX8ec0e9b4")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssueCommentDeletedIssueAllOf1MilestoneX8ec0e9b4 must be a JSON object")
      ...
      val state = json.decodeRequired<InlineWebhookIssueCommentDeletedIssueAllOf1MilestoneStateX6468a3b2>(rawObject, "state")
      val title = json.decodeRequired<String>(rawObject, "title")
      val updatedAt = json.decodeRequired<String>(rawObject, "updated_at")
      val url = json.decodeRequired<String>(rawObject, "url")
      if (!rawObject.containsKey("closed_at")) {
        throw SerializationException("InlineWebhookIssueCommentDeletedIssueAllOf1MilestoneX8ec0e9b4 is missing required property 'closed_at'")
      }
      ...
      if (!rawObject.containsKey("creator")) {
        throw SerializationException("InlineWebhookIssueCommentDeletedIssueAllOf1MilestoneX8ec0e9b4 is missing required property 'creator'")
      }
      val creator = rawObject["creator"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookIssueCommentDeletedIssueAllOf1MilestoneCreatorXab4ce9e7?>(requireNotNull(element)) }
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookIssueCommentDeletedIssueAllOf1MilestoneX8ec0e9b4 is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("due_on")) {
        throw SerializationException("InlineWebhookIssueCommentDeletedIssueAllOf1MilestoneX8ec0e9b4 is missing required property 'due_on'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssueCommentDeletedIssueAllOf1MilestoneX8ec0e9b4) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssueCommentDeletedIssueAllOf1MilestoneX8ec0e9b4")
...
public fun inlineWebhookIssueCommentDeletedIssueAllOf1MilestoneX8ec0e9b4(block: InlineWebhookIssueCommentDeletedIssueAllOf1MilestoneX8ec0e9b4.Builder.() -> Unit): InlineWebhookIssueCommentDeletedIssueAllOf1MilestoneX8ec0e9b4 = InlineWebhookIssueCommentDeletedIssueAllOf1MilestoneX8ec0e9b4.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssueCommentDeletedIssueAllOf1MilestoneX8ec0e9b4 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookIssueCommentDeletedIssueAllOf1MilestoneX8ec0e9b4 property '" + name + "' is not nullable")
