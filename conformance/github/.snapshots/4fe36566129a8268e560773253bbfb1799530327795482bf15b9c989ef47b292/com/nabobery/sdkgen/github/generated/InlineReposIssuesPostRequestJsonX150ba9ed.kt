...
public class InlineReposIssuesPostRequestJsonX150ba9ed(
  ...
  issueFieldValues: List<InlineReposIssuesPostRequestJsonIssueFieldValuesItemX21b2fa03>? = null,
  labels: List<InlineReposIssuesPostRequestJsonLabelsItemX3916d72d>? = null,
   ...
   */
  public val issueFieldValues: List<InlineReposIssuesPostRequestJsonIssueFieldValuesItemX21b2fa03>?
   ...
   */
  public val labels: List<InlineReposIssuesPostRequestJsonLabelsItemX3916d72d>? =
  ...
  public class Builder {
    ...
    public var issueFieldValues:
        List<InlineReposIssuesPostRequestJsonIssueFieldValuesItemX21b2fa03>?
    ...
    private var labelsValue: List<InlineReposIssuesPostRequestJsonLabelsItemX3916d72d>? = null

    /**
     * Labels to associate with this issue. _NOTE: Only users with push access can set labels for new issues. Labels are
     * silently dropped otherwise._
     */
    public var labels: List<InlineReposIssuesPostRequestJsonLabelsItemX3916d72d>?
  ...
  internal object Serializer : KSerializer<InlineReposIssuesPostRequestJsonX150ba9ed> {
