 ...
 * es/triggering_actor
 */
@Serializable(with = InlineWebhookDeploymentReviewRequestedWorkflowRunTriggeringActorXd9b2521f.Serializer::class)
public class InlineWebhookDeploymentReviewRequestedWorkflowRunTriggeringActorXd9b2521f(
  public val id: Int,
  ...
  public val type:
      InlineWebhookDeploymentReviewRequestedWorkflowRunTriggeringActorTypeX4a257da1? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookDeploymentReviewRequestedWorkflowRunTriggeringActorTypeX4a257da1?
        = null
    ...
    public fun build(): InlineWebhookDeploymentReviewRequestedWorkflowRunTriggeringActorXd9b2521f {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookDeploymentReviewRequestedWorkflowRunTriggeringActorXd9b2521f(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookDeploymentReviewRequestedWorkflowRunTriggeringActorXd9b2521f = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookDeploymentReviewRequestedWorkflowRunTriggeringActorXd9b2521f> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookDeploymentReviewRequestedWorkflowRunTriggeringActorXd9b2521f {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookDeploymentReviewRequestedWorkflowRunTriggeringActorXd9b2521f")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookDeploymentReviewRequestedWorkflowRunTriggeringActorXd9b2521f must be a JSON object")
      ...
      return InlineWebhookDeploymentReviewRequestedWorkflowRunTriggeringActorXd9b2521f(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookDeploymentReviewRequestedWorkflowRunTriggeringActorTypeX4a257da1>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookDeploymentReviewRequestedWorkflowRunTriggeringActorXd9b2521f) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookDeploymentReviewRequestedWorkflowRunTriggeringActorXd9b2521f")
...
public fun inlineWebhookDeploymentReviewRequestedWorkflowRunTriggeringActorXd9b2521f(block: InlineWebhookDeploymentReviewRequestedWorkflowRunTriggeringActorXd9b2521f.Builder.() -> Unit): InlineWebhookDeploymentReviewRequestedWorkflowRunTriggeringActorXd9b2521f = InlineWebhookDeploymentReviewRequestedWorkflowRunTriggeringActorXd9b2521f.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookDeploymentReviewRequestedWorkflowRunTriggeringActorXd9b2521f is missing required property '" + name + "'")
