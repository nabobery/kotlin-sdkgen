 ...
 * s/head/properties/user.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-review-edited/properties/pull_request/propertie
 * s/head/properties/user
 */
@Serializable(with = InlineWebhookPullRequestReviewEditedPullRequestHeadUserX6213b21e.Serializer::class)
public class InlineWebhookPullRequestReviewEditedPullRequestHeadUserX6213b21e(
  public val id: Long,
  ...
  public val type: InlineWebhookPullRequestReviewEditedPullRequestHeadUserTypeXb3fb1544? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestReviewEditedPullRequestHeadUserTypeXb3fb1544? = null
    ...
    public fun build(): InlineWebhookPullRequestReviewEditedPullRequestHeadUserX6213b21e {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestReviewEditedPullRequestHeadUserX6213b21e(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewEditedPullRequestHeadUserX6213b21e = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewEditedPullRequestHeadUserX6213b21e> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewEditedPullRequestHeadUserX6213b21e {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewEditedPullRequestHeadUserX6213b21e")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewEditedPullRequestHeadUserX6213b21e must be a JSON object")
      ...
      return InlineWebhookPullRequestReviewEditedPullRequestHeadUserX6213b21e(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestReviewEditedPullRequestHeadUserTypeXb3fb1544>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewEditedPullRequestHeadUserX6213b21e) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewEditedPullRequestHeadUserX6213b21e")
...
public fun inlineWebhookPullRequestReviewEditedPullRequestHeadUserX6213b21e(block: InlineWebhookPullRequestReviewEditedPullRequestHeadUserX6213b21e.Builder.() -> Unit): InlineWebhookPullRequestReviewEditedPullRequestHeadUserX6213b21e = InlineWebhookPullRequestReviewEditedPullRequestHeadUserX6213b21e.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewEditedPullRequestHeadUserX6213b21e is missing required property '" + name + "'")
