...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/components/schemas/webhooks_previous_marketplace_purchase/properties/plan.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhooks_previous_marketplace_purchase/properties/plan
 */
@Serializable(with = InlineWebhooksPreviousMarketplacePurchasePlanX59b3f774.Serializer::class)
public class InlineWebhooksPreviousMarketplacePurchasePlanX59b3f774(
  bullets: List<String>,
  ...
  public val priceModel: InlineWebhooksPreviousMarketplacePurchasePlanPriceModelX8d9d376d,
  ...
  public class Builder {
    ...
    private var priceModelValue: InlineWebhooksPreviousMarketplacePurchasePlanPriceModelX8d9d376d? =
        null

    public var priceModel: InlineWebhooksPreviousMarketplacePurchasePlanPriceModelX8d9d376d
    ...
    public fun build(): InlineWebhooksPreviousMarketplacePurchasePlanX59b3f774 {
      ...
      return InlineWebhooksPreviousMarketplacePurchasePlanX59b3f774(
        bullets = bullets,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhooksPreviousMarketplacePurchasePlanX59b3f774 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhooksPreviousMarketplacePurchasePlanX59b3f774> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhooksPreviousMarketplacePurchasePlanX59b3f774 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhooksPreviousMarketplacePurchasePlanX59b3f774")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhooksPreviousMarketplacePurchasePlanX59b3f774 must be a JSON object")
      ...
      val priceModel = json.decodeRequired<InlineWebhooksPreviousMarketplacePurchasePlanPriceModelX8d9d376d>(rawObject, "price_model")
      val yearlyPriceInCents = json.decodeRequired<Int>(rawObject, "yearly_price_in_cents")
      if (!rawObject.containsKey("unit_name")) {
        throw SerializationException("InlineWebhooksPreviousMarketplacePurchasePlanX59b3f774 is missing required property 'unit_name'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhooksPreviousMarketplacePurchasePlanX59b3f774) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhooksPreviousMarketplacePurchasePlanX59b3f774")
...
public fun inlineWebhooksPreviousMarketplacePurchasePlanX59b3f774(block: InlineWebhooksPreviousMarketplacePurchasePlanX59b3f774.Builder.() -> Unit): InlineWebhooksPreviousMarketplacePurchasePlanX59b3f774 = InlineWebhooksPreviousMarketplacePurchasePlanX59b3f774.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhooksPreviousMarketplacePurchasePlanX59b3f774 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhooksPreviousMarketplacePurchasePlanX59b3f774 property '" + name + "' is not nullable")
