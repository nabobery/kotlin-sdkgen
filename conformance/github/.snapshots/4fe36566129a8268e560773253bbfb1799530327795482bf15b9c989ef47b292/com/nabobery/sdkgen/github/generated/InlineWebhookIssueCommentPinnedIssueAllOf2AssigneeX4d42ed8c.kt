 ...
 * ignee
 */
@Serializable(with = InlineWebhookIssueCommentPinnedIssueAllOf2AssigneeX4d42ed8c.Serializer::class)
public class InlineWebhookIssueCommentPinnedIssueAllOf2AssigneeX4d42ed8c(
  public val id: Int,
  ...
  public val type: InlineWebhookIssueCommentPinnedIssueAllOf2AssigneeTypeXa2b33f6f? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookIssueCommentPinnedIssueAllOf2AssigneeTypeXa2b33f6f? = null
    ...
    public fun build(): InlineWebhookIssueCommentPinnedIssueAllOf2AssigneeX4d42ed8c {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssueCommentPinnedIssueAllOf2AssigneeX4d42ed8c(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssueCommentPinnedIssueAllOf2AssigneeX4d42ed8c = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssueCommentPinnedIssueAllOf2AssigneeX4d42ed8c> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssueCommentPinnedIssueAllOf2AssigneeX4d42ed8c {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssueCommentPinnedIssueAllOf2AssigneeX4d42ed8c")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssueCommentPinnedIssueAllOf2AssigneeX4d42ed8c must be a JSON object")
      ...
      return InlineWebhookIssueCommentPinnedIssueAllOf2AssigneeX4d42ed8c(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssueCommentPinnedIssueAllOf2AssigneeTypeXa2b33f6f>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssueCommentPinnedIssueAllOf2AssigneeX4d42ed8c) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssueCommentPinnedIssueAllOf2AssigneeX4d42ed8c")
...
public fun inlineWebhookIssueCommentPinnedIssueAllOf2AssigneeX4d42ed8c(block: InlineWebhookIssueCommentPinnedIssueAllOf2AssigneeX4d42ed8c.Builder.() -> Unit): InlineWebhookIssueCommentPinnedIssueAllOf2AssigneeX4d42ed8c = InlineWebhookIssueCommentPinnedIssueAllOf2AssigneeX4d42ed8c.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssueCommentPinnedIssueAllOf2AssigneeX4d42ed8c is missing required property '" + name + "'")
