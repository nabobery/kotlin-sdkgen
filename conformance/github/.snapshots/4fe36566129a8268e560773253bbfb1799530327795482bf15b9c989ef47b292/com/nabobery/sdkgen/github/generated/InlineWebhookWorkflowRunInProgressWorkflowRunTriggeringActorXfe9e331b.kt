 ...
 * triggering_actor
 */
@Serializable(with = InlineWebhookWorkflowRunInProgressWorkflowRunTriggeringActorXfe9e331b.Serializer::class)
public class InlineWebhookWorkflowRunInProgressWorkflowRunTriggeringActorXfe9e331b(
  public val id: Int,
  ...
  public val type:
      InlineWebhookWorkflowRunInProgressWorkflowRunTriggeringActorTypeXf580f493? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookWorkflowRunInProgressWorkflowRunTriggeringActorTypeXf580f493? =
        null
    ...
    public fun build(): InlineWebhookWorkflowRunInProgressWorkflowRunTriggeringActorXfe9e331b {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookWorkflowRunInProgressWorkflowRunTriggeringActorXfe9e331b(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookWorkflowRunInProgressWorkflowRunTriggeringActorXfe9e331b = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookWorkflowRunInProgressWorkflowRunTriggeringActorXfe9e331b> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookWorkflowRunInProgressWorkflowRunTriggeringActorXfe9e331b {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookWorkflowRunInProgressWorkflowRunTriggeringActorXfe9e331b")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookWorkflowRunInProgressWorkflowRunTriggeringActorXfe9e331b must be a JSON object")
      ...
      return InlineWebhookWorkflowRunInProgressWorkflowRunTriggeringActorXfe9e331b(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookWorkflowRunInProgressWorkflowRunTriggeringActorTypeXf580f493>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookWorkflowRunInProgressWorkflowRunTriggeringActorXfe9e331b) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookWorkflowRunInProgressWorkflowRunTriggeringActorXfe9e331b")
...
public fun inlineWebhookWorkflowRunInProgressWorkflowRunTriggeringActorXfe9e331b(block: InlineWebhookWorkflowRunInProgressWorkflowRunTriggeringActorXfe9e331b.Builder.() -> Unit): InlineWebhookWorkflowRunInProgressWorkflowRunTriggeringActorXfe9e331b = InlineWebhookWorkflowRunInProgressWorkflowRunTriggeringActorXfe9e331b.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookWorkflowRunInProgressWorkflowRunTriggeringActorXfe9e331b is missing required property '" + name + "'")
