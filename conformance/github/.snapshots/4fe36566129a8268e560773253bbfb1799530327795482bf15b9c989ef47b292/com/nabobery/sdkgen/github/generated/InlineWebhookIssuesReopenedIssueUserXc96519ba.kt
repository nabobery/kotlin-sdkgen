...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-reopened/properties/issue/properties/user.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-reopened/properties/issue/properties/user
 */
@Serializable(with = InlineWebhookIssuesReopenedIssueUserXc96519ba.Serializer::class)
public class InlineWebhookIssuesReopenedIssueUserXc96519ba(
  public val id: Long,
  ...
  public val type: InlineWebhookIssuesReopenedIssueUserTypeX5b93d6af? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookIssuesReopenedIssueUserTypeX5b93d6af? = null
    ...
    public fun build(): InlineWebhookIssuesReopenedIssueUserXc96519ba {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssuesReopenedIssueUserXc96519ba(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesReopenedIssueUserXc96519ba = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesReopenedIssueUserXc96519ba> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesReopenedIssueUserXc96519ba {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesReopenedIssueUserXc96519ba")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesReopenedIssueUserXc96519ba must be a JSON object")
      ...
      return InlineWebhookIssuesReopenedIssueUserXc96519ba(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssuesReopenedIssueUserTypeX5b93d6af>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesReopenedIssueUserXc96519ba) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesReopenedIssueUserXc96519ba")
...
public fun inlineWebhookIssuesReopenedIssueUserXc96519ba(block: InlineWebhookIssuesReopenedIssueUserXc96519ba.Builder.() -> Unit): InlineWebhookIssuesReopenedIssueUserXc96519ba = InlineWebhookIssuesReopenedIssueUserXc96519ba.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesReopenedIssueUserXc96519ba is missing required property '" + name + "'")
