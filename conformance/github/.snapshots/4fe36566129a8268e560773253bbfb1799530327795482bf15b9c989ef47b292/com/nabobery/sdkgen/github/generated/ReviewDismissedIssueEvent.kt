...
@Serializable
public data class ReviewDismissedIssueEventView(
  ...
  public val dismissedReview: InlineReviewDismissedIssueEventDismissedReviewX07708f91,
 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/review-dismissed-issue-event
 */
@Serializable(with = ReviewDismissedIssueEvent.Serializer::class)
public class ReviewDismissedIssueEvent(
  ...
  public class Builder {
    ...
    private var dismissedReviewValue: InlineReviewDismissedIssueEventDismissedReviewX07708f91? =
        null

    public var dismissedReview: InlineReviewDismissedIssueEventDismissedReviewX07708f91
      get() = requireNotNull(dismissedReviewValue) { "dismissedReview is required" }
      set(`value`) {
        dismissedReviewValue = value
      }
    ...
    public fun build(): ReviewDismissedIssueEvent {
      check(actorValue != null) { "actor is required" }
      check(createdAtValue != null) { "createdAt is required" }
      check(dismissedReviewValue != null) { "dismissedReview is required" }
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): ReviewDismissedIssueEvent = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<ReviewDismissedIssueEvent> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): ReviewDismissedIssueEvent {
      val jsonDecoder = decoder.requireJsonDecoder("ReviewDismissedIssueEvent")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("ReviewDismissedIssueEvent must be a JSON object")
      val actor = json.decodeRequired<SimpleUser>(rawObject, "actor")
      val createdAt = json.decodeRequired<String>(rawObject, "created_at")
      val dismissedReview = json.decodeRequired<InlineReviewDismissedIssueEventDismissedReviewX07708f91>(rawObject, "dismissed_review")
      val event = json.decodeRequired<String>(rawObject, "event")
      val id = json.decodeRequired<Int>(rawObject, "id")
      val nodeId = json.decodeRequired<String>(rawObject, "node_id")
      val url = json.decodeRequired<String>(rawObject, "url")
      if (!rawObject.containsKey("commit_id")) {
        throw SerializationException("ReviewDismissedIssueEvent is missing required property 'commit_id'")
      }
      ...
      if (!rawObject.containsKey("commit_url")) {
        throw SerializationException("ReviewDismissedIssueEvent is missing required property 'commit_url'")
      }
      ...
      if (!rawObject.containsKey("performed_via_github_app")) {
        throw SerializationException("ReviewDismissedIssueEvent is missing required property 'performed_via_github_app'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: ReviewDismissedIssueEvent) {
      val jsonEncoder = encoder.requireJsonEncoder("ReviewDismissedIssueEvent")
      ...
      val raw = buildJsonObject {
        ...
        put("dismissed_review", json.encodeToJsonElement(value.dismissedReview))
...
public fun reviewDismissedIssueEvent(block: ReviewDismissedIssueEvent.Builder.() -> Unit): ReviewDismissedIssueEvent = ReviewDismissedIssueEvent.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("ReviewDismissedIssueEvent is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("ReviewDismissedIssueEvent property '" + name + "' is not nullable")
