 ...
 * sted_reviewers/items/oneOf/1
 */
@Serializable(with = InlineWebhookPullRequestLockedPullRequestRequestedReviewersItemOneOf2X3b9f3399.Serializer::class)
public class InlineWebhookPullRequestLockedPullRequestRequestedReviewersItemOneOf2X3b9f3399 internal constructor(
  ...
  private val parentState:
      FieldState<InlineWebhookPullRequestLockedPullRequestRequestedReviewersItemParentXc03399af?>,
) {
  public val deleted: Boolean?
    get() = deletedState.valueOrNull()

  public val parent: InlineWebhookPullRequestLockedPullRequestRequestedReviewersItemParentXc03399af?
  ...
  public class Builder {
    ...
    private var privacyValue:
        InlineWebhookPullRequestLockedPullRequestRequestedReviewersItemPrivacyXd1dd0ba1? = null
     ...
     */
    public var parent:
        InlineWebhookPullRequestLockedPullRequestRequestedReviewersItemParentXc03399af?
      get() = parentState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): InlineWebhookPullRequestLockedPullRequestRequestedReviewersItemOneOf2X3b9f3399 {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestLockedPullRequestRequestedReviewersItemOneOf2X3b9f3399 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestLockedPullRequestRequestedReviewersItemOneOf2X3b9f3399> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestLockedPullRequestRequestedReviewersItemOneOf2X3b9f3399 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestLockedPullRequestRequestedReviewersItemOneOf2X3b9f3399")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestLockedPullRequestRequestedReviewersItemOneOf2X3b9f3399 must be a JSON object")
      ...
      val privacy = json.decodeRequired<InlineWebhookPullRequestLockedPullRequestRequestedReviewersItemPrivacyXd1dd0ba1>(rawObject, "privacy")
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookPullRequestLockedPullRequestRequestedReviewersItemOneOf2X3b9f3399 is missing required property 'description'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestLockedPullRequestRequestedReviewersItemOneOf2X3b9f3399) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestLockedPullRequestRequestedReviewersItemOneOf2X3b9f3399")
...
public fun inlineWebhookPullRequestLockedPullRequestRequestedReviewersItemOneOf2X3b9f3399(block: InlineWebhookPullRequestLockedPullRequestRequestedReviewersItemOneOf2X3b9f3399.Builder.() -> Unit): InlineWebhookPullRequestLockedPullRequestRequestedReviewersItemOneOf2X3b9f3399 = InlineWebhookPullRequestLockedPullRequestRequestedReviewersItemOneOf2X3b9f3399.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestLockedPullRequestRequestedReviewersItemOneOf2X3b9f3399 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookPullRequestLockedPullRequestRequestedReviewersItemOneOf2X3b9f3399 property '" + name + "' is not nullable")
