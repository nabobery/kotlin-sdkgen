...
@Serializable
public data class IssueTypeChangedIssueEventView(
  ...
  @SerialName("prev_issue_type")
  public val prevIssueType: IssueTypeWebhook?,
 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/issue-type-changed-issue-event
 */
@Serializable(with = IssueTypeChangedIssueEvent.Serializer::class)
public class IssueTypeChangedIssueEvent(
  public val actor: SimpleUser,
  public val commitId: String?,
  public val commitUrl: String?,
  public val createdAt: String,
  ...
  public class Builder {
    ...
    private var prevIssueTypeState: FieldState<IssueTypeWebhook?> = FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var prevIssueType: IssueTypeWebhook?
      get() = prevIssueTypeState.valueOrNull()
      set(`value`) {
        prevIssueTypeState = value.toNullableFieldState()
      }

    public fun build(): IssueTypeChangedIssueEvent {
      ...
      check(prevIssueTypeState !== FieldState.Absent) { "prevIssueType is required, even when null" }
      return IssueTypeChangedIssueEvent(
        actor = actor,
        ...
        prevIssueType = prevIssueTypeState.valueOrNull(),
        url = url,
      )
    }
  }
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): IssueTypeChangedIssueEvent = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<IssueTypeChangedIssueEvent> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): IssueTypeChangedIssueEvent {
      val jsonDecoder = decoder.requireJsonDecoder("IssueTypeChangedIssueEvent")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("IssueTypeChangedIssueEvent must be a JSON object")
      ...
      if (!rawObject.containsKey("commit_id")) {
        throw SerializationException("IssueTypeChangedIssueEvent is missing required property 'commit_id'")
      }
      ...
      if (!rawObject.containsKey("commit_url")) {
        throw SerializationException("IssueTypeChangedIssueEvent is missing required property 'commit_url'")
      }
      ...
      if (!rawObject.containsKey("issue_type")) {
        throw SerializationException("IssueTypeChangedIssueEvent is missing required property 'issue_type'")
      }
      ...
      if (!rawObject.containsKey("performed_via_github_app")) {
        throw SerializationException("IssueTypeChangedIssueEvent is missing required property 'performed_via_github_app'")
      }
      ...
      if (!rawObject.containsKey("prev_issue_type")) {
        throw SerializationException("IssueTypeChangedIssueEvent is missing required property 'prev_issue_type'")
      }
      val prevIssueType = rawObject["prev_issue_type"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<IssueTypeWebhook?>(requireNotNull(element)) }
      return IssueTypeChangedIssueEvent(
        actor = actor,
        commitId = commitId,
        commitUrl = commitUrl,
        ...
        prevIssueType = prevIssueType,
        url = url,
      )
    }

    override fun serialize(encoder: Encoder, `value`: IssueTypeChangedIssueEvent) {
      val jsonEncoder = encoder.requireJsonEncoder("IssueTypeChangedIssueEvent")
      ...
      val raw = buildJsonObject {
        ...
        put("prev_issue_type", value.prevIssueType?.let { json.encodeToJsonElement(it) } ?: JsonNull)
        put("url", value.url)
      }
...
public fun issueTypeChangedIssueEvent(block: IssueTypeChangedIssueEvent.Builder.() -> Unit): IssueTypeChangedIssueEvent = IssueTypeChangedIssueEvent.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("IssueTypeChangedIssueEvent is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("IssueTypeChangedIssueEvent property '" + name + "' is not nullable")
