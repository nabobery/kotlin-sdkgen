...
/**
 * Generated model for sdkgen://source/openapi.yaml#/components/schemas/webhooks_issue_comment/properties/reactions.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhooks_issue_comment/properties/reactions
 */
@Serializable(with = InlineWebhooksIssueCommentReactionsX662c52c8.Serializer::class)
public class InlineWebhooksIssueCommentReactionsX662c52c8(
  public val _1: Int,
  public val _12: Int,
  ...
  public class Builder {
    ...
    public fun build(): InlineWebhooksIssueCommentReactionsX662c52c8 {
      ...
      return InlineWebhooksIssueCommentReactionsX662c52c8(
        _1 = _1,
        _12 = _12,
        confused = confused,
        eyes = eyes,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhooksIssueCommentReactionsX662c52c8 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhooksIssueCommentReactionsX662c52c8> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhooksIssueCommentReactionsX662c52c8 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhooksIssueCommentReactionsX662c52c8")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhooksIssueCommentReactionsX662c52c8 must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhooksIssueCommentReactionsX662c52c8) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhooksIssueCommentReactionsX662c52c8")
...
public fun inlineWebhooksIssueCommentReactionsX662c52c8(block: InlineWebhooksIssueCommentReactionsX662c52c8.Builder.() -> Unit): InlineWebhooksIssueCommentReactionsX662c52c8 = InlineWebhooksIssueCommentReactionsX662c52c8.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhooksIssueCommentReactionsX662c52c8 is missing required property '" + name + "'")
