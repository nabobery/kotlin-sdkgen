 ...
 * erformed_via_github_app/properties/owner.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-issue-comment-unpinned/properties/issue/allOf/0/properties/p
 * erformed_via_github_app/properties/owner
 */
@Serializable(with = InlineWebhookIssueCommentUnpinnedIssueAllOf1PerformedViaGithubAppOwnerX4b3f2706.Serializer::class)
public class InlineWebhookIssueCommentUnpinnedIssueAllOf1PerformedViaGithubAppOwnerX4b3f2706(
  public val id: Int,
  ...
  public val type:
      InlineWebhookIssueCommentUe6d8IssueAllOf1PerformedViaGithubAppOwnerTypeX56bd0a1c? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public fun build(): InlineWebhookIssueCommentUnpinnedIssueAllOf1PerformedViaGithubAppOwnerX4b3f2706 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssueCommentUnpinnedIssueAllOf1PerformedViaGithubAppOwnerX4b3f2706(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssueCommentUnpinnedIssueAllOf1PerformedViaGithubAppOwnerX4b3f2706 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssueCommentUnpinnedIssueAllOf1PerformedViaGithubAppOwnerX4b3f2706> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssueCommentUnpinnedIssueAllOf1PerformedViaGithubAppOwnerX4b3f2706 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssueCommentUnpinnedIssueAllOf1PerformedViaGithubAppOwnerX4b3f2706")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssueCommentUnpinnedIssueAllOf1PerformedViaGithubAppOwnerX4b3f2706 must be a JSON object")
      ...
      return InlineWebhookIssueCommentUnpinnedIssueAllOf1PerformedViaGithubAppOwnerX4b3f2706(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssueCommentUe6d8IssueAllOf1PerformedViaGithubAppOwnerTypeX56bd0a1c>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssueCommentUnpinnedIssueAllOf1PerformedViaGithubAppOwnerX4b3f2706) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssueCommentUnpinnedIssueAllOf1PerformedViaGithubAppOwnerX4b3f2706")
...
public fun inlineWebhookIssueCommentUnpinnedIssueAllOf1PerformedViaGithubAppOwnerX4b3f2706(block: InlineWebhookIssueCommentUnpinnedIssueAllOf1PerformedViaGithubAppOwnerX4b3f2706.Builder.() -> Unit): InlineWebhookIssueCommentUnpinnedIssueAllOf1PerformedViaGithubAppOwnerX4b3f2706 = InlineWebhookIssueCommentUnpinnedIssueAllOf1PerformedViaGithubAppOwnerX4b3f2706.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssueCommentUnpinnedIssueAllOf1PerformedViaGithubAppOwnerX4b3f2706 is missing required property '" + name + "'")
