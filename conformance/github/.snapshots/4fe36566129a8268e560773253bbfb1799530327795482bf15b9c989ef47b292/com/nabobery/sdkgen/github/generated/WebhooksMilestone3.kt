 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhooks_milestone_3
 */
@Serializable(with = WebhooksMilestone3.Serializer::class)
public class WebhooksMilestone3(
  ...
  public val creator: InlineWebhooksMilestone3CreatorX71c4a0ef?,
   ...
   */
  public val state: InlineWebhooksMilestone3StateX8a6dd6ff,
  /**
  ...
  public class Builder {
    ...
    private var stateValue: InlineWebhooksMilestone3StateX8a6dd6ff? = null

    public var state: InlineWebhooksMilestone3StateX8a6dd6ff
    ...
    private var creatorState: FieldState<InlineWebhooksMilestone3CreatorX71c4a0ef?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var creator: InlineWebhooksMilestone3CreatorX71c4a0ef?
    ...
    public fun build(): WebhooksMilestone3 {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): WebhooksMilestone3 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<WebhooksMilestone3> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): WebhooksMilestone3 {
      val jsonDecoder = decoder.requireJsonDecoder("WebhooksMilestone3")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("WebhooksMilestone3 must be a JSON object")
      ...
      val state = json.decodeRequired<InlineWebhooksMilestone3StateX8a6dd6ff>(rawObject, "state")
      val title = json.decodeRequired<String>(rawObject, "title")
      val updatedAt = json.decodeRequired<String>(rawObject, "updated_at")
      val url = json.decodeRequired<String>(rawObject, "url")
      if (!rawObject.containsKey("closed_at")) {
        throw SerializationException("WebhooksMilestone3 is missing required property 'closed_at'")
      }
      ...
      if (!rawObject.containsKey("creator")) {
        throw SerializationException("WebhooksMilestone3 is missing required property 'creator'")
      }
      val creator = rawObject["creator"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhooksMilestone3CreatorX71c4a0ef?>(requireNotNull(element)) }
      if (!rawObject.containsKey("description")) {
        throw SerializationException("WebhooksMilestone3 is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("due_on")) {
        throw SerializationException("WebhooksMilestone3 is missing required property 'due_on'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: WebhooksMilestone3) {
      val jsonEncoder = encoder.requireJsonEncoder("WebhooksMilestone3")
...
public fun webhooksMilestone3(block: WebhooksMilestone3.Builder.() -> Unit): WebhooksMilestone3 = WebhooksMilestone3.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("WebhooksMilestone3 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("WebhooksMilestone3 property '" + name + "' is not nullable")
