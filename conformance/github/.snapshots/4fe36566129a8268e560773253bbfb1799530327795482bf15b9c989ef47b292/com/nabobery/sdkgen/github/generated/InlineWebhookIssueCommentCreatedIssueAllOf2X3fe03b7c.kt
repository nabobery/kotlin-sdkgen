...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-issue-comment-created/properties/issue/allOf/1.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhook-issue-comment-created/properties/issue/allOf/1
 */
@Serializable(with = InlineWebhookIssueCommentCreatedIssueAllOf2X3fe03b7c.Serializer::class)
public class InlineWebhookIssueCommentCreatedIssueAllOf2X3fe03b7c internal constructor(
  public val assignee: InlineWebhookIssueCommentCreatedIssueAllOf2AssigneeXde820a66?,
  labels: List<InlineWebhookIssueCommentCreatedIssueAllOf2LabelsItemX61e152ff>,
  public val locked: Boolean,
  /**
   * State of the issue; either 'open' or 'closed'
   */
  public val state: InlineWebhookIssueCommentCreatedIssueAllOf2StateX4faa7429,
  ...
  private val reactionsState:
      FieldState<InlineWebhookIssueCommentCreatedIssueAllOf2ReactionsX496abcd3>,
  ...
  private val userState: FieldState<InlineWebhookIssueCommentCreatedIssueAllOf2UserX529ee998>,
) {
  public val labels: List<InlineWebhookIssueCommentCreatedIssueAllOf2LabelsItemX61e152ff> =
      labels.toList()
  ...
  public val reactions: InlineWebhookIssueCommentCreatedIssueAllOf2ReactionsX496abcd3?
  ...
  public val user: InlineWebhookIssueCommentCreatedIssueAllOf2UserX529ee998?
    get() = userState.valueOrNull()

  public constructor(
    assignee: InlineWebhookIssueCommentCreatedIssueAllOf2AssigneeXde820a66?,
    labels: List<InlineWebhookIssueCommentCreatedIssueAllOf2LabelsItemX61e152ff>,
    locked: Boolean,
    state: InlineWebhookIssueCommentCreatedIssueAllOf2StateX4faa7429,
  ...
  public class Builder {
    private var labelsValue: List<InlineWebhookIssueCommentCreatedIssueAllOf2LabelsItemX61e152ff>? =
        null

    public var labels: List<InlineWebhookIssueCommentCreatedIssueAllOf2LabelsItemX61e152ff>
    ...
    private var stateValue: InlineWebhookIssueCommentCreatedIssueAllOf2StateX4faa7429? = null

    public var state: InlineWebhookIssueCommentCreatedIssueAllOf2StateX4faa7429
    ...
    private var assigneeState:
        FieldState<InlineWebhookIssueCommentCreatedIssueAllOf2AssigneeXde820a66?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var assignee: InlineWebhookIssueCommentCreatedIssueAllOf2AssigneeXde820a66?
     ...
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var reactions: InlineWebhookIssueCommentCreatedIssueAllOf2ReactionsX496abcd3?
      get() = reactionsState.valueOrNull()
      set(`value`) {
    ...
    private var userState: FieldState<InlineWebhookIssueCommentCreatedIssueAllOf2UserX529ee998> =
        FieldState.Absent

    /**
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var user: InlineWebhookIssueCommentCreatedIssueAllOf2UserX529ee998?
      get() = userState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): InlineWebhookIssueCommentCreatedIssueAllOf2X3fe03b7c {
      ...
      return InlineWebhookIssueCommentCreatedIssueAllOf2X3fe03b7c(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssueCommentCreatedIssueAllOf2X3fe03b7c = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssueCommentCreatedIssueAllOf2X3fe03b7c> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssueCommentCreatedIssueAllOf2X3fe03b7c {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssueCommentCreatedIssueAllOf2X3fe03b7c")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssueCommentCreatedIssueAllOf2X3fe03b7c must be a JSON object")
      val labels = json.decodeRequired<List<InlineWebhookIssueCommentCreatedIssueAllOf2LabelsItemX61e152ff>>(rawObject, "labels")
      val locked = json.decodeRequired<Boolean>(rawObject, "locked")
      val state = json.decodeRequired<InlineWebhookIssueCommentCreatedIssueAllOf2StateX4faa7429>(rawObject, "state")
      if (!rawObject.containsKey("assignee")) {
        throw SerializationException("InlineWebhookIssueCommentCreatedIssueAllOf2X3fe03b7c is missing required property 'assignee'")
      }
      val assignee = rawObject["assignee"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookIssueCommentCreatedIssueAllOf2AssigneeXde820a66?>(requireNotNull(element)) }
      return InlineWebhookIssueCommentCreatedIssueAllOf2X3fe03b7c(
        assignee = assignee,
        labels = labels,
        locked = locked,
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssueCommentCreatedIssueAllOf2X3fe03b7c) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssueCommentCreatedIssueAllOf2X3fe03b7c")
...
public fun inlineWebhookIssueCommentCreatedIssueAllOf2X3fe03b7c(block: InlineWebhookIssueCommentCreatedIssueAllOf2X3fe03b7c.Builder.() -> Unit): InlineWebhookIssueCommentCreatedIssueAllOf2X3fe03b7c = InlineWebhookIssueCommentCreatedIssueAllOf2X3fe03b7c.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssueCommentCreatedIssueAllOf2X3fe03b7c is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookIssueCommentCreatedIssueAllOf2X3fe03b7c property '" + name + "' is not nullable")
