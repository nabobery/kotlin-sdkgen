...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-commit-comment-created/properties/comment/properties/user.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-commit-comment-created/properties/comment/properties/user
 */
@Serializable(with = InlineWebhookCommitCommentCreatedCommentUserX1f20fcda.Serializer::class)
public class InlineWebhookCommitCommentCreatedCommentUserX1f20fcda(
  public val id: Long,
  ...
  public val type: InlineWebhookCommitCommentCreatedCommentUserTypeX3297e3eb? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookCommitCommentCreatedCommentUserTypeX3297e3eb? = null
    ...
    public fun build(): InlineWebhookCommitCommentCreatedCommentUserX1f20fcda {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookCommitCommentCreatedCommentUserX1f20fcda(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookCommitCommentCreatedCommentUserX1f20fcda = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookCommitCommentCreatedCommentUserX1f20fcda> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookCommitCommentCreatedCommentUserX1f20fcda {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookCommitCommentCreatedCommentUserX1f20fcda")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookCommitCommentCreatedCommentUserX1f20fcda must be a JSON object")
      ...
      return InlineWebhookCommitCommentCreatedCommentUserX1f20fcda(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookCommitCommentCreatedCommentUserTypeX3297e3eb>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookCommitCommentCreatedCommentUserX1f20fcda) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookCommitCommentCreatedCommentUserX1f20fcda")
...
public fun inlineWebhookCommitCommentCreatedCommentUserX1f20fcda(block: InlineWebhookCommitCommentCreatedCommentUserX1f20fcda.Builder.() -> Unit): InlineWebhookCommitCommentCreatedCommentUserX1f20fcda = InlineWebhookCommitCommentCreatedCommentUserX1f20fcda.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookCommitCommentCreatedCommentUserX1f20fcda is missing required property '" + name + "'")
