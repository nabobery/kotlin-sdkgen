 ...
 * ties/head/properties/repo/properties/owner.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-review-submitted/properties/pull_request/proper
 * ties/head/properties/repo/properties/owner
 */
@Serializable(with = InlineWebhookPullRequestReviewSubmittedPullRequestHeadRepoOwnerX5159264d.Serializer::class)
public class InlineWebhookPullRequestReviewSubmittedPullRequestHeadRepoOwnerX5159264d(
  public val id: Int,
  ...
  public val type:
      InlineWebhookPullRequestReviewSubmittedPullRequestHeadRepoOwnerTypeX3c7cb370? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestReviewSubmittedPullRequestHeadRepoOwnerTypeX3c7cb370? =
        null
    ...
    public fun build(): InlineWebhookPullRequestReviewSubmittedPullRequestHeadRepoOwnerX5159264d {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestReviewSubmittedPullRequestHeadRepoOwnerX5159264d(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewSubmittedPullRequestHeadRepoOwnerX5159264d = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewSubmittedPullRequestHeadRepoOwnerX5159264d> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewSubmittedPullRequestHeadRepoOwnerX5159264d {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewSubmittedPullRequestHeadRepoOwnerX5159264d")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewSubmittedPullRequestHeadRepoOwnerX5159264d must be a JSON object")
      ...
      return InlineWebhookPullRequestReviewSubmittedPullRequestHeadRepoOwnerX5159264d(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestReviewSubmittedPullRequestHeadRepoOwnerTypeX3c7cb370>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewSubmittedPullRequestHeadRepoOwnerX5159264d) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewSubmittedPullRequestHeadRepoOwnerX5159264d")
...
public fun inlineWebhookPullRequestReviewSubmittedPullRequestHeadRepoOwnerX5159264d(block: InlineWebhookPullRequestReviewSubmittedPullRequestHeadRepoOwnerX5159264d.Builder.() -> Unit): InlineWebhookPullRequestReviewSubmittedPullRequestHeadRepoOwnerX5159264d = InlineWebhookPullRequestReviewSubmittedPullRequestHeadRepoOwnerX5159264d.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewSubmittedPullRequestHeadRepoOwnerX5159264d is missing required property '" + name + "'")
