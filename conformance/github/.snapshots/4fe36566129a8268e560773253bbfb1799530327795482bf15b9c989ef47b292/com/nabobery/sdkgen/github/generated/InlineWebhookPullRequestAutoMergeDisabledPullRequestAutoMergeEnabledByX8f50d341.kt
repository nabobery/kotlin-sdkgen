 ...
 * perties/auto_merge/properties/enabled_by.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-auto-merge-disabled/properties/pull_request/pro
 * perties/auto_merge/properties/enabled_by
 */
@Serializable(with = InlineWebhookPullRequestAutoMergeDisabledPullRequestAutoMergeEnabledByX8f50d341.Serializer::class)
public class InlineWebhookPullRequestAutoMergeDisabledPullRequestAutoMergeEnabledByX8f50d341(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestAu1a35PullRequestAutoMergeEnabledByTypeX90fdd40d? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestAu1a35PullRequestAutoMergeEnabledByTypeX90fdd40d? =
        null
    ...
    public fun build(): InlineWebhookPullRequestAutoMergeDisabledPullRequestAutoMergeEnabledByX8f50d341 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestAutoMergeDisabledPullRequestAutoMergeEnabledByX8f50d341(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestAutoMergeDisabledPullRequestAutoMergeEnabledByX8f50d341 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestAutoMergeDisabledPullRequestAutoMergeEnabledByX8f50d341> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestAutoMergeDisabledPullRequestAutoMergeEnabledByX8f50d341 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestAutoMergeDisabledPullRequestAutoMergeEnabledByX8f50d341")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestAutoMergeDisabledPullRequestAutoMergeEnabledByX8f50d341 must be a JSON object")
      ...
      return InlineWebhookPullRequestAutoMergeDisabledPullRequestAutoMergeEnabledByX8f50d341(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestAu1a35PullRequestAutoMergeEnabledByTypeX90fdd40d>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestAutoMergeDisabledPullRequestAutoMergeEnabledByX8f50d341) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestAutoMergeDisabledPullRequestAutoMergeEnabledByX8f50d341")
...
public fun inlineWebhookPullRequestAutoMergeDisabledPullRequestAutoMergeEnabledByX8f50d341(block: InlineWebhookPullRequestAutoMergeDisabledPullRequestAutoMergeEnabledByX8f50d341.Builder.() -> Unit): InlineWebhookPullRequestAutoMergeDisabledPullRequestAutoMergeEnabledByX8f50d341 = InlineWebhookPullRequestAutoMergeDisabledPullRequestAutoMergeEnabledByX8f50d341.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestAutoMergeDisabledPullRequestAutoMergeEnabledByX8f50d341 is missing required property '" + name + "'")
