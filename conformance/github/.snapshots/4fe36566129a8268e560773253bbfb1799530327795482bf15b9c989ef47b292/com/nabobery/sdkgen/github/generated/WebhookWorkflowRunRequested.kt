...
/**
 * Generated model for sdkgen://source/openapi.yaml#/components/schemas/webhook-workflow-run-requested.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhook-workflow-run-requested
 */
@Serializable(with = WebhookWorkflowRunRequested.Serializer::class)
public class WebhookWorkflowRunRequested internal constructor(
  public val action: InlineWebhookWorkflowRunRequestedActionX04f0b670,
  public val repository: RepositoryWebhooks,
  public val sender: SimpleUser,
  public val workflow: WebhooksWorkflow?,
  public val workflowRun: InlineWebhookWorkflowRunRequestedWorkflowRunXaedda01b,
  ...
  public constructor(
    action: InlineWebhookWorkflowRunRequestedActionX04f0b670,
    repository: RepositoryWebhooks,
    sender: SimpleUser,
    workflow: WebhooksWorkflow?,
    workflowRun: InlineWebhookWorkflowRunRequestedWorkflowRunXaedda01b,
  ) : this(action = action,
  ...
  public class Builder {
    private var actionValue: InlineWebhookWorkflowRunRequestedActionX04f0b670? = null

    public var action: InlineWebhookWorkflowRunRequestedActionX04f0b670
    ...
    private var workflowRunValue: InlineWebhookWorkflowRunRequestedWorkflowRunXaedda01b? = null

    public var workflowRun: InlineWebhookWorkflowRunRequestedWorkflowRunXaedda01b
    ...
    public fun build(): WebhookWorkflowRunRequested {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): WebhookWorkflowRunRequested = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<WebhookWorkflowRunRequested> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): WebhookWorkflowRunRequested {
      val jsonDecoder = decoder.requireJsonDecoder("WebhookWorkflowRunRequested")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("WebhookWorkflowRunRequested must be a JSON object")
      val action = json.decodeRequired<InlineWebhookWorkflowRunRequestedActionX04f0b670>(rawObject, "action")
      val repository = json.decodeRequired<RepositoryWebhooks>(rawObject, "repository")
      val sender = json.decodeRequired<SimpleUser>(rawObject, "sender")
      val workflowRun = json.decodeRequired<InlineWebhookWorkflowRunRequestedWorkflowRunXaedda01b>(rawObject, "workflow_run")
      if (!rawObject.containsKey("workflow")) {
        throw SerializationException("WebhookWorkflowRunRequested is missing required property 'workflow'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: WebhookWorkflowRunRequested) {
      val jsonEncoder = encoder.requireJsonEncoder("WebhookWorkflowRunRequested")
...
public fun webhookWorkflowRunRequested(block: WebhookWorkflowRunRequested.Builder.() -> Unit): WebhookWorkflowRunRequested = WebhookWorkflowRunRequested.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("WebhookWorkflowRunRequested is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("WebhookWorkflowRunRequested property '" + name + "' is not nullable")
