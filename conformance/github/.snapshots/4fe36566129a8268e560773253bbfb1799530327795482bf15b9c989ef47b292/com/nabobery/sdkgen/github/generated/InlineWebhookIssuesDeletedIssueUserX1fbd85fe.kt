...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-deleted/properties/issue/properties/user.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-deleted/properties/issue/properties/user
 */
@Serializable(with = InlineWebhookIssuesDeletedIssueUserX1fbd85fe.Serializer::class)
public class InlineWebhookIssuesDeletedIssueUserX1fbd85fe(
  public val id: Long,
  ...
  public val type: InlineWebhookIssuesDeletedIssueUserTypeXc3ccf112? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookIssuesDeletedIssueUserTypeXc3ccf112? = null
    ...
    public fun build(): InlineWebhookIssuesDeletedIssueUserX1fbd85fe {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssuesDeletedIssueUserX1fbd85fe(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesDeletedIssueUserX1fbd85fe = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesDeletedIssueUserX1fbd85fe> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesDeletedIssueUserX1fbd85fe {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesDeletedIssueUserX1fbd85fe")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesDeletedIssueUserX1fbd85fe must be a JSON object")
      ...
      return InlineWebhookIssuesDeletedIssueUserX1fbd85fe(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssuesDeletedIssueUserTypeXc3ccf112>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesDeletedIssueUserX1fbd85fe) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesDeletedIssueUserX1fbd85fe")
...
public fun inlineWebhookIssuesDeletedIssueUserX1fbd85fe(block: InlineWebhookIssuesDeletedIssueUserX1fbd85fe.Builder.() -> Unit): InlineWebhookIssuesDeletedIssueUserX1fbd85fe = InlineWebhookIssuesDeletedIssueUserX1fbd85fe.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesDeletedIssueUserX1fbd85fe is missing required property '" + name + "'")
