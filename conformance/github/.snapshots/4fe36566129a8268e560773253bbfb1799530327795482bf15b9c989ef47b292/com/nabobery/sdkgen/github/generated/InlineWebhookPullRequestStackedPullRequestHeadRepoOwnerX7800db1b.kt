 ...
 * /properties/repo/properties/owner
 */
@Serializable(with = InlineWebhookPullRequestStackedPullRequestHeadRepoOwnerX7800db1b.Serializer::class)
public class InlineWebhookPullRequestStackedPullRequestHeadRepoOwnerX7800db1b(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestStackedPullRequestHeadRepoOwnerTypeX94fabfc7? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestStackedPullRequestHeadRepoOwnerTypeX94fabfc7? = null
    ...
    public fun build(): InlineWebhookPullRequestStackedPullRequestHeadRepoOwnerX7800db1b {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestStackedPullRequestHeadRepoOwnerX7800db1b(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestStackedPullRequestHeadRepoOwnerX7800db1b = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestStackedPullRequestHeadRepoOwnerX7800db1b> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestStackedPullRequestHeadRepoOwnerX7800db1b {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestStackedPullRequestHeadRepoOwnerX7800db1b")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestStackedPullRequestHeadRepoOwnerX7800db1b must be a JSON object")
      ...
      return InlineWebhookPullRequestStackedPullRequestHeadRepoOwnerX7800db1b(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestStackedPullRequestHeadRepoOwnerTypeX94fabfc7>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestStackedPullRequestHeadRepoOwnerX7800db1b) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestStackedPullRequestHeadRepoOwnerX7800db1b")
...
public fun inlineWebhookPullRequestStackedPullRequestHeadRepoOwnerX7800db1b(block: InlineWebhookPullRequestStackedPullRequestHeadRepoOwnerX7800db1b.Builder.() -> Unit): InlineWebhookPullRequestStackedPullRequestHeadRepoOwnerX7800db1b = InlineWebhookPullRequestStackedPullRequestHeadRepoOwnerX7800db1b.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestStackedPullRequestHeadRepoOwnerX7800db1b is missing required property '" + name + "'")
