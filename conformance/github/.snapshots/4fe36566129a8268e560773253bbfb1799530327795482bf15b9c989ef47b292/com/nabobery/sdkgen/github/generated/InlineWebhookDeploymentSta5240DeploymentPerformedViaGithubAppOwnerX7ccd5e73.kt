 ...
 * erformed_via_github_app/properties/owner
 */
@Serializable(with = InlineWebhookDeploymentSta5240DeploymentPerformedViaGithubAppOwnerX7ccd5e73.Serializer::class)
public class InlineWebhookDeploymentSta5240DeploymentPerformedViaGithubAppOwnerX7ccd5e73(
  public val id: Int,
  ...
  public val type:
      InlineWebhookDeploymentSta5240DeploymentPerformedViaGithubAppOwnerTypeXbc0f19af? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public fun build(): InlineWebhookDeploymentSta5240DeploymentPerformedViaGithubAppOwnerX7ccd5e73 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookDeploymentSta5240DeploymentPerformedViaGithubAppOwnerX7ccd5e73(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookDeploymentSta5240DeploymentPerformedViaGithubAppOwnerX7ccd5e73 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookDeploymentSta5240DeploymentPerformedViaGithubAppOwnerX7ccd5e73> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookDeploymentSta5240DeploymentPerformedViaGithubAppOwnerX7ccd5e73 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookDeploymentSta5240DeploymentPerformedViaGithubAppOwnerX7ccd5e73")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookDeploymentSta5240DeploymentPerformedViaGithubAppOwnerX7ccd5e73 must be a JSON object")
      ...
      return InlineWebhookDeploymentSta5240DeploymentPerformedViaGithubAppOwnerX7ccd5e73(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookDeploymentSta5240DeploymentPerformedViaGithubAppOwnerTypeXbc0f19af>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookDeploymentSta5240DeploymentPerformedViaGithubAppOwnerX7ccd5e73) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookDeploymentSta5240DeploymentPerformedViaGithubAppOwnerX7ccd5e73")
...
public fun inlineWebhookDeploymentSta5240DeploymentPerformedViaGithubAppOwnerX7ccd5e73(block: InlineWebhookDeploymentSta5240DeploymentPerformedViaGithubAppOwnerX7ccd5e73.Builder.() -> Unit): InlineWebhookDeploymentSta5240DeploymentPerformedViaGithubAppOwnerX7ccd5e73 = InlineWebhookDeploymentSta5240DeploymentPerformedViaGithubAppOwnerX7ccd5e73.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookDeploymentSta5240DeploymentPerformedViaGithubAppOwnerX7ccd5e73 is missing required property '" + name + "'")
