...
public class InlineRepositoryRulePullRequestParametersX345d67b5(
  ...
  allowedMergeMethods: List<InlineRepositoryRulePullRequestParametersAllowedMergeMethodsItemX5d1c7941>? = null,
  public val dismissalRestriction: RepositoryRuleParamsDismissalRestriction? = null,
  requiredReviewers: List<RepositoryRuleParamsRequiredReviewerConfiguration>? = null,
) {
  /**
  ...
  public val allowedMergeMethods:
      List<InlineRepositoryRulePullRequestParametersAllowedMergeMethodsItemX5d1c7941>? =
      allowedMergeMethods?.let { collection0 -> collection0.toList() }
   ...
   */
  public val requiredReviewers: List<RepositoryRuleParamsRequiredReviewerConfiguration>? =
      requiredReviewers?.let { collection0 -> collection0.toList() }
  ...
  public class Builder {
    ...
    private var allowedMergeMethodsValue:
    ...
    public var allowedMergeMethods:
        List<InlineRepositoryRulePullRequestParametersAllowedMergeMethodsItemX5d1c7941>?
      get() = allowedMergeMethodsValue?.let { collection0 -> collection0.toList() }
      set(`value`) {
        allowedMergeMethodsValue = value?.let { collection0 -> collection0.toList() }
      }

    public var dismissalRestriction: RepositoryRuleParamsDismissalRestriction? = null

    private var requiredReviewersValue: List<RepositoryRuleParamsRequiredReviewerConfiguration>? =
        null
     ...
     * the files that reviewer is required to review.
     */
    public var requiredReviewers: List<RepositoryRuleParamsRequiredReviewerConfiguration>?
      get() = requiredReviewersValue?.let { collection0 -> collection0.toList() }
      set(`value`) {
        requiredReviewersValue = value?.let { collection0 -> collection0.toList() }
      }
  ...
  internal object Serializer : KSerializer<InlineRepositoryRulePullRequestParametersX345d67b5> {
