...
public class BillingUsageReport(
  usageItems: List<InlineBillingUsageReportUsageItemsItemXd7a8f9c2>? = null,
) {
  public val usageItems: List<InlineBillingUsageReportUsageItemsItemXd7a8f9c2>? =
      usageItems?.let { collection0 -> collection0.toList() }

  public class Builder {
    private var usageItemsValue: List<InlineBillingUsageReportUsageItemsItemXd7a8f9c2>? = null

    public var usageItems: List<InlineBillingUsageReportUsageItemsItemXd7a8f9c2>?
  ...
  internal object Serializer : KSerializer<BillingUsageReport> {
