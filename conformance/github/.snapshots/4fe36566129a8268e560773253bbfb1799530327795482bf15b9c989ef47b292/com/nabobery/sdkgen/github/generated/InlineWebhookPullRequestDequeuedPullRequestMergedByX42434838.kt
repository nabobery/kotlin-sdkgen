 ...
 * ged_by
 */
@Serializable(with = InlineWebhookPullRequestDequeuedPullRequestMergedByX42434838.Serializer::class)
public class InlineWebhookPullRequestDequeuedPullRequestMergedByX42434838(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestDequeuedPullRequestMergedByTypeX8df97108? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestDequeuedPullRequestMergedByTypeX8df97108? = null
    ...
    public fun build(): InlineWebhookPullRequestDequeuedPullRequestMergedByX42434838 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestDequeuedPullRequestMergedByX42434838(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestDequeuedPullRequestMergedByX42434838 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestDequeuedPullRequestMergedByX42434838> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestDequeuedPullRequestMergedByX42434838 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestDequeuedPullRequestMergedByX42434838")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestDequeuedPullRequestMergedByX42434838 must be a JSON object")
      ...
      return InlineWebhookPullRequestDequeuedPullRequestMergedByX42434838(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestDequeuedPullRequestMergedByTypeX8df97108>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestDequeuedPullRequestMergedByX42434838) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestDequeuedPullRequestMergedByX42434838")
...
public fun inlineWebhookPullRequestDequeuedPullRequestMergedByX42434838(block: InlineWebhookPullRequestDequeuedPullRequestMergedByX42434838.Builder.() -> Unit): InlineWebhookPullRequestDequeuedPullRequestMergedByX42434838 = InlineWebhookPullRequestDequeuedPullRequestMergedByX42434838.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestDequeuedPullRequestMergedByX42434838 is missing required property '" + name + "'")
