 ...
 * properties/base/properties/user.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-review-comment-created/properties/pull_request/
 * properties/base/properties/user
 */
@Serializable(with = InlineWebhookPullRequestReviewCommentCreatedPullRequestBaseUserX62d9eecf.Serializer::class)
public class InlineWebhookPullRequestReviewCommentCreatedPullRequestBaseUserX62d9eecf(
  public val id: Long,
  ...
  public val type:
      InlineWebhookPullRequestReviewCommentCreatedPullRequestBaseUserTypeX201491ef? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestReviewCommentCreatedPullRequestBaseUserTypeX201491ef? =
        null
    ...
    public fun build(): InlineWebhookPullRequestReviewCommentCreatedPullRequestBaseUserX62d9eecf {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestReviewCommentCreatedPullRequestBaseUserX62d9eecf(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewCommentCreatedPullRequestBaseUserX62d9eecf = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewCommentCreatedPullRequestBaseUserX62d9eecf> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewCommentCreatedPullRequestBaseUserX62d9eecf {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewCommentCreatedPullRequestBaseUserX62d9eecf")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewCommentCreatedPullRequestBaseUserX62d9eecf must be a JSON object")
      ...
      return InlineWebhookPullRequestReviewCommentCreatedPullRequestBaseUserX62d9eecf(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestReviewCommentCreatedPullRequestBaseUserTypeX201491ef>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewCommentCreatedPullRequestBaseUserX62d9eecf) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewCommentCreatedPullRequestBaseUserX62d9eecf")
...
public fun inlineWebhookPullRequestReviewCommentCreatedPullRequestBaseUserX62d9eecf(block: InlineWebhookPullRequestReviewCommentCreatedPullRequestBaseUserX62d9eecf.Builder.() -> Unit): InlineWebhookPullRequestReviewCommentCreatedPullRequestBaseUserX62d9eecf = InlineWebhookPullRequestReviewCommentCreatedPullRequestBaseUserX62d9eecf.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewCommentCreatedPullRequestBaseUserX62d9eecf is missing required property '" + name + "'")
