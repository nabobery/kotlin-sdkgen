 ...
 * rties/package_version/properties/package_files/items.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-registry-package-published/properties/registry_package/prope
 * rties/package_version/properties/package_files/items
 */
@Serializable(with = InlineWebhookRegistryPackae13fRegistryPackagePackageVersionItemXdf6f91e8.Serializer::class)
public class InlineWebhookRegistryPackae13fRegistryPackagePackageVersionItemXdf6f91e8(
  ...
  public class Builder {
    ...
    public fun build(): InlineWebhookRegistryPackae13fRegistryPackagePackageVersionItemXdf6f91e8 {
      ...
      return InlineWebhookRegistryPackae13fRegistryPackagePackageVersionItemXdf6f91e8(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookRegistryPackae13fRegistryPackagePackageVersionItemXdf6f91e8 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookRegistryPackae13fRegistryPackagePackageVersionItemXdf6f91e8> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookRegistryPackae13fRegistryPackagePackageVersionItemXdf6f91e8 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookRegistryPackae13fRegistryPackagePackageVersionItemXdf6f91e8")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookRegistryPackae13fRegistryPackagePackageVersionItemXdf6f91e8 must be a JSON object")
      ...
      if (!rawObject.containsKey("md5")) {
        throw SerializationException("InlineWebhookRegistryPackae13fRegistryPackagePackageVersionItemXdf6f91e8 is missing required property 'md5'")
      }
      ...
      if (!rawObject.containsKey("sha1")) {
        throw SerializationException("InlineWebhookRegistryPackae13fRegistryPackagePackageVersionItemXdf6f91e8 is missing required property 'sha1'")
      }
      ...
      if (!rawObject.containsKey("sha256")) {
        throw SerializationException("InlineWebhookRegistryPackae13fRegistryPackagePackageVersionItemXdf6f91e8 is missing required property 'sha256'")
      }
      ...
      if (!rawObject.containsKey("state")) {
        throw SerializationException("InlineWebhookRegistryPackae13fRegistryPackagePackageVersionItemXdf6f91e8 is missing required property 'state'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookRegistryPackae13fRegistryPackagePackageVersionItemXdf6f91e8) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookRegistryPackae13fRegistryPackagePackageVersionItemXdf6f91e8")
...
public fun inlineWebhookRegistryPackae13fRegistryPackagePackageVersionItemXdf6f91e8(block: InlineWebhookRegistryPackae13fRegistryPackagePackageVersionItemXdf6f91e8.Builder.() -> Unit): InlineWebhookRegistryPackae13fRegistryPackagePackageVersionItemXdf6f91e8 = InlineWebhookRegistryPackae13fRegistryPackagePackageVersionItemXdf6f91e8.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookRegistryPackae13fRegistryPackagePackageVersionItemXdf6f91e8 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookRegistryPackae13fRegistryPackagePackageVersionItemXdf6f91e8 property '" + name + "' is not nullable")
