 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhooks_issue_2
 */
@Serializable(with = WebhooksIssue2.Serializer::class)
public class WebhooksIssue2 internal constructor(
  public val activeLockReason: InlineWebhooksIssue2ActiveLockReasonX2960a506?,
  assignees: List<InlineWebhooksIssue2AssigneesItemX73d8be6a?>,
  /**
   * How the author is associated with the repository.
   */
  public val authorAssociation: InlineWebhooksIssue2AuthorAssociationXa68359eb,
  /**
   ...
   */
  public val milestone: InlineWebhooksIssue2MilestoneX7235fa8b?,
  public val nodeId: String,
  public val number: Int,
  public val reactions: InlineWebhooksIssue2ReactionsXb59d67b2,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val user: InlineWebhooksIssue2UserXccfb85ce?,
  private val assigneeState: FieldState<InlineWebhooksIssue2AssigneeX8dd91385?>,
  ...
  labelsState: FieldState<List<InlineWebhooksIssue2LabelsItemX22d1c14f>>,
  private val lockedState: FieldState<Boolean>,
  private val performedViaGithubAppState:
      FieldState<InlineWebhooksIssue2PerformedViaGithubAppXc6b77f68?>,
  private val pinnedCommentState: FieldState<NullableIssueComment?>,
  private val pullRequestState: FieldState<InlineWebhooksIssue2PullRequestXb2263fec>,
  private val stateState: FieldState<InlineWebhooksIssue2StateXd10086f6>,
  ...
  public val assignees: List<InlineWebhooksIssue2AssigneesItemX73d8be6a?> = assignees.toList()
  ...
  private val labelsState: FieldState<List<InlineWebhooksIssue2LabelsItemX22d1c14f>> =
      labelsState.copyValue { fieldValue -> fieldValue.toList() }

  public val assignee: InlineWebhooksIssue2AssigneeX8dd91385?
  ...
  public val labels: List<InlineWebhooksIssue2LabelsItemX22d1c14f>?
   ...
   */
  public val performedViaGithubApp: InlineWebhooksIssue2PerformedViaGithubAppXc6b77f68?
  ...
  public val pullRequest: InlineWebhooksIssue2PullRequestXb2263fec?
    get() = pullRequestState.valueOrNull()

  /**
   * State of the issue; either 'open' or 'closed'
   */
  public val state: InlineWebhooksIssue2StateXd10086f6?
  ...
  public constructor(
    activeLockReason: InlineWebhooksIssue2ActiveLockReasonX2960a506?,
    assignees: List<InlineWebhooksIssue2AssigneesItemX73d8be6a?>,
    authorAssociation: InlineWebhooksIssue2AuthorAssociationXa68359eb,
    body: String?,
    closedAt: String?,
    comments: Int,
    commentsUrl: String,
    ...
    id: Long,
    labelsUrl: String,
    milestone: InlineWebhooksIssue2MilestoneX7235fa8b?,
    nodeId: String,
    number: Int,
    reactions: InlineWebhooksIssue2ReactionsXb59d67b2,
    repositoryUrl: String,
    title: String,
    updatedAt: String,
    url: String,
    user: InlineWebhooksIssue2UserXccfb85ce?,
  ...
  public class Builder {
    private var assigneesValue: List<InlineWebhooksIssue2AssigneesItemX73d8be6a?>? = null

    public var assignees: List<InlineWebhooksIssue2AssigneesItemX73d8be6a?>
      get() = requireNotNull(assigneesValue) { "assignees is required" }.toList()
      set(`value`) {
        assigneesValue = value.toList()
      }

    private var authorAssociationValue: InlineWebhooksIssue2AuthorAssociationXa68359eb? = null

    public var authorAssociation: InlineWebhooksIssue2AuthorAssociationXa68359eb
    ...
    private var reactionsValue: InlineWebhooksIssue2ReactionsXb59d67b2? = null

    public var reactions: InlineWebhooksIssue2ReactionsXb59d67b2
    ...
    private var activeLockReasonState: FieldState<InlineWebhooksIssue2ActiveLockReasonX2960a506?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var activeLockReason: InlineWebhooksIssue2ActiveLockReasonX2960a506?
    ...
    private var milestoneState: FieldState<InlineWebhooksIssue2MilestoneX7235fa8b?> =
        FieldState.Absent
     ...
     * Required nullable field; assigning `null` records present-null.
     */
    public var milestone: InlineWebhooksIssue2MilestoneX7235fa8b?
      get() = milestoneState.valueOrNull()
      set(`value`) {
        milestoneState = value.toNullableFieldState()
      }

    private var userState: FieldState<InlineWebhooksIssue2UserXccfb85ce?> = FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var user: InlineWebhooksIssue2UserXccfb85ce?
      get() = userState.valueOrNull()
      set(`value`) {
        userState = value.toNullableFieldState()
      }

    private var assigneeState: FieldState<InlineWebhooksIssue2AssigneeX8dd91385?> =
        FieldState.Absent

    /**
     * Assigning `null` records present-null; use the unset function to omit the property.
     */
    public var assignee: InlineWebhooksIssue2AssigneeX8dd91385?
      get() = assigneeState.valueOrNull()
      set(`value`) {
    ...
    private var labelsState: FieldState<List<InlineWebhooksIssue2LabelsItemX22d1c14f>> =
        FieldState.Absent

    /**
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var labels: List<InlineWebhooksIssue2LabelsItemX22d1c14f>?
    ...
    private var performedViaGithubAppState:
        FieldState<InlineWebhooksIssue2PerformedViaGithubAppXc6b77f68?> = FieldState.Absent
     ...
     * Assigning `null` records present-null; use the unset function to omit the property.
     */
    public var performedViaGithubApp: InlineWebhooksIssue2PerformedViaGithubAppXc6b77f68?
      get() = performedViaGithubAppState.valueOrNull()
      set(`value`) {
    ...
    private var pullRequestState: FieldState<InlineWebhooksIssue2PullRequestXb2263fec> =
        FieldState.Absent

    /**
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var pullRequest: InlineWebhooksIssue2PullRequestXb2263fec?
      get() = pullRequestState.valueOrNull()
      set(`value`) {
    ...
    private var stateState: FieldState<InlineWebhooksIssue2StateXd10086f6> = FieldState.Absent

    /**
     * State of the issue; either 'open' or 'closed'
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var state: InlineWebhooksIssue2StateXd10086f6?
      get() = stateState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): WebhooksIssue2 {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): WebhooksIssue2 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<WebhooksIssue2> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): WebhooksIssue2 {
      val jsonDecoder = decoder.requireJsonDecoder("WebhooksIssue2")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("WebhooksIssue2 must be a JSON object")
      val assignees = json.decodeRequired<List<InlineWebhooksIssue2AssigneesItemX73d8be6a?>>(rawObject, "assignees")
      val authorAssociation = json.decodeRequired<InlineWebhooksIssue2AuthorAssociationXa68359eb>(rawObject, "author_association")
      ...
      val reactions = json.decodeRequired<InlineWebhooksIssue2ReactionsXb59d67b2>(rawObject, "reactions")
      ...
      if (!rawObject.containsKey("active_lock_reason")) {
        throw SerializationException("WebhooksIssue2 is missing required property 'active_lock_reason'")
      }
      val activeLockReason = rawObject["active_lock_reason"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhooksIssue2ActiveLockReasonX2960a506?>(requireNotNull(element)) }
      if (!rawObject.containsKey("body")) {
        throw SerializationException("WebhooksIssue2 is missing required property 'body'")
      }
      ...
      if (!rawObject.containsKey("closed_at")) {
        throw SerializationException("WebhooksIssue2 is missing required property 'closed_at'")
      }
      ...
      if (!rawObject.containsKey("milestone")) {
        throw SerializationException("WebhooksIssue2 is missing required property 'milestone'")
      }
      val milestone = rawObject["milestone"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhooksIssue2MilestoneX7235fa8b?>(requireNotNull(element)) }
      if (!rawObject.containsKey("user")) {
        throw SerializationException("WebhooksIssue2 is missing required property 'user'")
      }
      val user = rawObject["user"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhooksIssue2UserXccfb85ce?>(requireNotNull(element)) }
      return WebhooksIssue2(
    ...
    override fun serialize(encoder: Encoder, `value`: WebhooksIssue2) {
      val jsonEncoder = encoder.requireJsonEncoder("WebhooksIssue2")
...
public fun webhooksIssue2(block: WebhooksIssue2.Builder.() -> Unit): WebhooksIssue2 = WebhooksIssue2.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("WebhooksIssue2 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("WebhooksIssue2 property '" + name + "' is not nullable")
