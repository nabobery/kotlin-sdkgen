 ...
 * ties/head/properties/user
 */
@Serializable(with = InlineWebhookPullRequestReviewDismissedPullRequestHeadUserXa94df5a1.Serializer::class)
public class InlineWebhookPullRequestReviewDismissedPullRequestHeadUserXa94df5a1(
  public val id: Long,
  ...
  public val type: InlineWebhookPullRequestReviewDismissedPullRequestHeadUserTypeX9ae4ba3a? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestReviewDismissedPullRequestHeadUserTypeX9ae4ba3a? = null
    ...
    public fun build(): InlineWebhookPullRequestReviewDismissedPullRequestHeadUserXa94df5a1 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestReviewDismissedPullRequestHeadUserXa94df5a1(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewDismissedPullRequestHeadUserXa94df5a1 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewDismissedPullRequestHeadUserXa94df5a1> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewDismissedPullRequestHeadUserXa94df5a1 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewDismissedPullRequestHeadUserXa94df5a1")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewDismissedPullRequestHeadUserXa94df5a1 must be a JSON object")
      ...
      return InlineWebhookPullRequestReviewDismissedPullRequestHeadUserXa94df5a1(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestReviewDismissedPullRequestHeadUserTypeX9ae4ba3a>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewDismissedPullRequestHeadUserXa94df5a1) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewDismissedPullRequestHeadUserXa94df5a1")
...
public fun inlineWebhookPullRequestReviewDismissedPullRequestHeadUserXa94df5a1(block: InlineWebhookPullRequestReviewDismissedPullRequestHeadUserXa94df5a1.Builder.() -> Unit): InlineWebhookPullRequestReviewDismissedPullRequestHeadUserXa94df5a1 = InlineWebhookPullRequestReviewDismissedPullRequestHeadUserXa94df5a1.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewDismissedPullRequestHeadUserXa94df5a1 is missing required property '" + name + "'")
