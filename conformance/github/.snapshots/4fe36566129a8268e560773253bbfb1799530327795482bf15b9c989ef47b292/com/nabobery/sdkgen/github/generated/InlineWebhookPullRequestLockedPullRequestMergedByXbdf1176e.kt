 ...
 * d_by
 */
@Serializable(with = InlineWebhookPullRequestLockedPullRequestMergedByXbdf1176e.Serializer::class)
public class InlineWebhookPullRequestLockedPullRequestMergedByXbdf1176e(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestLockedPullRequestMergedByTypeXedabb562? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestLockedPullRequestMergedByTypeXedabb562? = null
    ...
    public fun build(): InlineWebhookPullRequestLockedPullRequestMergedByXbdf1176e {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestLockedPullRequestMergedByXbdf1176e(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestLockedPullRequestMergedByXbdf1176e = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestLockedPullRequestMergedByXbdf1176e> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestLockedPullRequestMergedByXbdf1176e {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestLockedPullRequestMergedByXbdf1176e")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestLockedPullRequestMergedByXbdf1176e must be a JSON object")
      ...
      return InlineWebhookPullRequestLockedPullRequestMergedByXbdf1176e(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestLockedPullRequestMergedByTypeXedabb562>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestLockedPullRequestMergedByXbdf1176e) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestLockedPullRequestMergedByXbdf1176e")
...
public fun inlineWebhookPullRequestLockedPullRequestMergedByXbdf1176e(block: InlineWebhookPullRequestLockedPullRequestMergedByXbdf1176e.Builder.() -> Unit): InlineWebhookPullRequestLockedPullRequestMergedByXbdf1176e = InlineWebhookPullRequestLockedPullRequestMergedByXbdf1176e.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestLockedPullRequestMergedByXbdf1176e is missing required property '" + name + "'")
