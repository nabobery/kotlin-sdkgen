 ...
 */
@Serializable(with = InlineWebhookPullRequestReviewThreadResolvedPullRequestHeadRepoXe222e1e2.Serializer::class)
public class InlineWebhookPullRequestReviewThreadResolvedPullRequestHeadRepoXe222e1e2 internal constructor(
  /**
  ...
  public val createdAt: InlineWebhookPullRequestRe0df9PullRequestHeadRepoCreatedAtXa586de52,
  /**
  ...
  public val license:
      InlineWebhookPullRequestReviewThreadResolvedPullRequestHeadRepoLicenseX109e9396?,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val owner: InlineWebhookPullRequestReviewThreadResolvedPullRequestHeadRepoOwnerX5775df22?,
  /**
  ...
  public val pushedAt:
      InlineWebhookPullRequestReviewThreadResolvedPullRequestHeadRepoPushedAtX33618baf?,
  /**
   * Wire format: `uri-template`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val visibility: InlineWebhookPullRequestRe0df9PullRequestHeadRepoVisibilityX082ccf82,
  ...
  private val permissionsState:
      FieldState<InlineWebhookPullRequestRe0df9PullRequestHeadRepoPermissionsX8d5ec8ac>,
  private val publicState: FieldState<Boolean>,
  private val pullRequestCreationPolicyState:
      FieldState<InlineWebhookPullRequestRe0df9PullRequestHeadPullRequestCreationP824dX406a8b35>,
  ...
  public val permissions: InlineWebhookPullRequestRe0df9PullRequestHeadRepoPermissionsX8d5ec8ac?
  ...
  public constructor(
    ...
    createdAt: InlineWebhookPullRequestRe0df9PullRequestHeadRepoCreatedAtXa586de52,
    ...
    language: String?,
    languagesUrl: String,
    license: InlineWebhookPullRequestReviewThreadResolvedPullRequestHeadRepoLicenseX109e9396?,
    mergesUrl: String,
    ...
    openIssues: Int,
    openIssuesCount: Int,
    owner: InlineWebhookPullRequestReviewThreadResolvedPullRequestHeadRepoOwnerX5775df22?,
    `private`: Boolean,
    pullsUrl: String,
    pushedAt: InlineWebhookPullRequestReviewThreadResolvedPullRequestHeadRepoPushedAtX33618baf?,
    releasesUrl: String,
    size: Int,
    sshUrl: String,
    stargazersCount: Int,
    ...
    updatedAt: String,
    url: String,
    visibility: InlineWebhookPullRequestRe0df9PullRequestHeadRepoVisibilityX082ccf82,
    watchers: Int,
    watchersCount: Int,
  ...
  public class Builder {
    ...
    private var createdAtValue: InlineWebhookPullRequestRe0df9PullRequestHeadRepoCreatedAtXa586de52?
        = null

    public var createdAt: InlineWebhookPullRequestRe0df9PullRequestHeadRepoCreatedAtXa586de52
    ...
    private var visibilityValue:
        InlineWebhookPullRequestRe0df9PullRequestHeadRepoVisibilityX082ccf82? = null

    public var visibility: InlineWebhookPullRequestRe0df9PullRequestHeadRepoVisibilityX082ccf82
    ...
    private var licenseState:
        FieldState<InlineWebhookPullRequestReviewThreadResolvedPullRequestHeadRepoLicenseX109e9396?>
        = FieldState.Absent
    ...
    private var ownerState:
        FieldState<InlineWebhookPullRequestReviewThreadResolvedPullRequestHeadRepoOwnerX5775df22?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var owner: InlineWebhookPullRequestReviewThreadResolvedPullRequestHeadRepoOwnerX5775df22?
    ...
    private var pushedAtState:
        FieldState<InlineWebhookPullRequestReviewThreadResolvedPullRequestHeadRepoPushedAtX33618baf?>
        = FieldState.Absent
     ...
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var permissions: InlineWebhookPullRequestRe0df9PullRequestHeadRepoPermissionsX8d5ec8ac?
      get() = permissionsState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): InlineWebhookPullRequestReviewThreadResolvedPullRequestHeadRepoXe222e1e2 {
      ...
      return InlineWebhookPullRequestReviewThreadResolvedPullRequestHeadRepoXe222e1e2(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewThreadResolvedPullRequestHeadRepoXe222e1e2 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewThreadResolvedPullRequestHeadRepoXe222e1e2> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewThreadResolvedPullRequestHeadRepoXe222e1e2 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewThreadResolvedPullRequestHeadRepoXe222e1e2")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewThreadResolvedPullRequestHeadRepoXe222e1e2 must be a JSON object")
      ...
      val createdAt = json.decodeRequired<InlineWebhookPullRequestRe0df9PullRequestHeadRepoCreatedAtXa586de52>(rawObject, "created_at")
      ...
      val visibility = json.decodeRequired<InlineWebhookPullRequestRe0df9PullRequestHeadRepoVisibilityX082ccf82>(rawObject, "visibility")
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookPullRequestReviewThreadResolvedPullRequestHeadRepoXe222e1e2 is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("homepage")) {
        throw SerializationException("InlineWebhookPullRequestReviewThreadResolvedPullRequestHeadRepoXe222e1e2 is missing required property 'homepage'")
      }
      ...
      if (!rawObject.containsKey("language")) {
        throw SerializationException("InlineWebhookPullRequestReviewThreadResolvedPullRequestHeadRepoXe222e1e2 is missing required property 'language'")
      }
      ...
      if (!rawObject.containsKey("license")) {
        throw SerializationException("InlineWebhookPullRequestReviewThreadResolvedPullRequestHeadRepoXe222e1e2 is missing required property 'license'")
      }
      val license = rawObject["license"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestReviewThreadResolvedPullRequestHeadRepoLicenseX109e9396?>(requireNotNull(element)) }
      if (!rawObject.containsKey("mirror_url")) {
        throw SerializationException("InlineWebhookPullRequestReviewThreadResolvedPullRequestHeadRepoXe222e1e2 is missing required property 'mirror_url'")
      }
      ...
      if (!rawObject.containsKey("owner")) {
        throw SerializationException("InlineWebhookPullRequestReviewThreadResolvedPullRequestHeadRepoXe222e1e2 is missing required property 'owner'")
      }
      val owner = rawObject["owner"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestReviewThreadResolvedPullRequestHeadRepoOwnerX5775df22?>(requireNotNull(element)) }
      if (!rawObject.containsKey("pushed_at")) {
        throw SerializationException("InlineWebhookPullRequestReviewThreadResolvedPullRequestHeadRepoXe222e1e2 is missing required property 'pushed_at'")
      }
      val pushedAt = rawObject["pushed_at"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestReviewThreadResolvedPullRequestHeadRepoPushedAtX33618baf?>(requireNotNull(element)) }
      return InlineWebhookPullRequestReviewThreadResolvedPullRequestHeadRepoXe222e1e2(
        archiveUrl = archiveUrl,
        archived = archived,
        assigneesUrl = assigneesUrl,
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewThreadResolvedPullRequestHeadRepoXe222e1e2) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewThreadResolvedPullRequestHeadRepoXe222e1e2")
...
public fun inlineWebhookPullRequestReviewThreadResolvedPullRequestHeadRepoXe222e1e2(block: InlineWebhookPullRequestReviewThreadResolvedPullRequestHeadRepoXe222e1e2.Builder.() -> Unit): InlineWebhookPullRequestReviewThreadResolvedPullRequestHeadRepoXe222e1e2 = InlineWebhookPullRequestReviewThreadResolvedPullRequestHeadRepoXe222e1e2.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewThreadResolvedPullRequestHeadRepoXe222e1e2 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookPullRequestReviewThreadResolvedPullRequestHeadRepoXe222e1e2 property '" + name + "' is not nullable")
