 ...
 * perties/merged_by
 */
@Serializable(with = InlineWebhookPullRequestAutoMergeDisabledPullRequestMergedByXdfa34fa9.Serializer::class)
public class InlineWebhookPullRequestAutoMergeDisabledPullRequestMergedByXdfa34fa9(
  public val id: Int,
  ...
  public val type:
      InlineWebhookPullRequestAutoMergeDisabledPullRequestMergedByTypeX9cd73f44? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestAutoMergeDisabledPullRequestMergedByTypeX9cd73f44? =
        null
    ...
    public fun build(): InlineWebhookPullRequestAutoMergeDisabledPullRequestMergedByXdfa34fa9 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestAutoMergeDisabledPullRequestMergedByXdfa34fa9(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestAutoMergeDisabledPullRequestMergedByXdfa34fa9 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestAutoMergeDisabledPullRequestMergedByXdfa34fa9> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestAutoMergeDisabledPullRequestMergedByXdfa34fa9 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestAutoMergeDisabledPullRequestMergedByXdfa34fa9")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestAutoMergeDisabledPullRequestMergedByXdfa34fa9 must be a JSON object")
      ...
      return InlineWebhookPullRequestAutoMergeDisabledPullRequestMergedByXdfa34fa9(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestAutoMergeDisabledPullRequestMergedByTypeX9cd73f44>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestAutoMergeDisabledPullRequestMergedByXdfa34fa9) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestAutoMergeDisabledPullRequestMergedByXdfa34fa9")
...
public fun inlineWebhookPullRequestAutoMergeDisabledPullRequestMergedByXdfa34fa9(block: InlineWebhookPullRequestAutoMergeDisabledPullRequestMergedByXdfa34fa9.Builder.() -> Unit): InlineWebhookPullRequestAutoMergeDisabledPullRequestMergedByXdfa34fa9 = InlineWebhookPullRequestAutoMergeDisabledPullRequestMergedByXdfa34fa9.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestAutoMergeDisabledPullRequestMergedByXdfa34fa9 is missing required property '" + name + "'")
