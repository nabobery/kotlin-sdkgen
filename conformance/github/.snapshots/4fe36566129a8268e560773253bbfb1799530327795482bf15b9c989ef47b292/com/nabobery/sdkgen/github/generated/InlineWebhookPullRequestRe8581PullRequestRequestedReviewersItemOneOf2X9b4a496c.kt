 ...
 * ties/requested_reviewers/items/oneOf/1
 */
@Serializable(with = InlineWebhookPullRequestRe8581PullRequestRequestedReviewersItemOneOf2X9b4a496c.Serializer::class)
public class InlineWebhookPullRequestRe8581PullRequestRequestedReviewersItemOneOf2X9b4a496c internal constructor(
  ...
  private val parentState:
      FieldState<InlineWebhookPullRequestRe8581PullRequestRequestedReviewersItemParentX7351dd93?>,
) {
  public val deleted: Boolean?
    get() = deletedState.valueOrNull()

  public val parent: InlineWebhookPullRequestRe8581PullRequestRequestedReviewersItemParentX7351dd93?
  ...
  public class Builder {
    ...
    private var privacyValue:
        InlineWebhookPullRequestRe8581PullRequestRequestedReviewersItemPrivacyX97cff1b8? = null
     ...
     */
    public var parent:
        InlineWebhookPullRequestRe8581PullRequestRequestedReviewersItemParentX7351dd93?
      get() = parentState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): InlineWebhookPullRequestRe8581PullRequestRequestedReviewersItemOneOf2X9b4a496c {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestRe8581PullRequestRequestedReviewersItemOneOf2X9b4a496c = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestRe8581PullRequestRequestedReviewersItemOneOf2X9b4a496c> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestRe8581PullRequestRequestedReviewersItemOneOf2X9b4a496c {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestRe8581PullRequestRequestedReviewersItemOneOf2X9b4a496c")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestRe8581PullRequestRequestedReviewersItemOneOf2X9b4a496c must be a JSON object")
      ...
      val privacy = json.decodeRequired<InlineWebhookPullRequestRe8581PullRequestRequestedReviewersItemPrivacyX97cff1b8>(rawObject, "privacy")
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookPullRequestRe8581PullRequestRequestedReviewersItemOneOf2X9b4a496c is missing required property 'description'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestRe8581PullRequestRequestedReviewersItemOneOf2X9b4a496c) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestRe8581PullRequestRequestedReviewersItemOneOf2X9b4a496c")
...
public fun inlineWebhookPullRequestRe8581PullRequestRequestedReviewersItemOneOf2X9b4a496c(block: InlineWebhookPullRequestRe8581PullRequestRequestedReviewersItemOneOf2X9b4a496c.Builder.() -> Unit): InlineWebhookPullRequestRe8581PullRequestRequestedReviewersItemOneOf2X9b4a496c = InlineWebhookPullRequestRe8581PullRequestRequestedReviewersItemOneOf2X9b4a496c.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestRe8581PullRequestRequestedReviewersItemOneOf2X9b4a496c is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookPullRequestRe8581PullRequestRequestedReviewersItemOneOf2X9b4a496c property '" + name + "' is not nullable")
