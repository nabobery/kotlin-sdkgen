 ...
 * pository
 */
@Serializable(with = InlineWebhookWorkflowRunRequestedWorkflowRunRepositoryX77f90b26.Serializer::class)
public class InlineWebhookWorkflowRunRequestedWorkflowRunRepositoryX77f90b26(
  /**
  ...
  public val owner: InlineWebhookWorkflowRunRequestedWorkflowRunRepositoryOwnerX4271096f?,
  /**
  ...
  public class Builder {
    ...
    private var ownerState:
        FieldState<InlineWebhookWorkflowRunRequestedWorkflowRunRepositoryOwnerX4271096f?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var owner: InlineWebhookWorkflowRunRequestedWorkflowRunRepositoryOwnerX4271096f?
      get() = ownerState.valueOrNull()
      set(`value`) {
        ownerState = value.toNullableFieldState()
      }

    public fun build(): InlineWebhookWorkflowRunRequestedWorkflowRunRepositoryX77f90b26 {
      ...
      return InlineWebhookWorkflowRunRequestedWorkflowRunRepositoryX77f90b26(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookWorkflowRunRequestedWorkflowRunRepositoryX77f90b26 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookWorkflowRunRequestedWorkflowRunRepositoryX77f90b26> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookWorkflowRunRequestedWorkflowRunRepositoryX77f90b26 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookWorkflowRunRequestedWorkflowRunRepositoryX77f90b26")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookWorkflowRunRequestedWorkflowRunRepositoryX77f90b26 must be a JSON object")
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookWorkflowRunRequestedWorkflowRunRepositoryX77f90b26 is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("owner")) {
        throw SerializationException("InlineWebhookWorkflowRunRequestedWorkflowRunRepositoryX77f90b26 is missing required property 'owner'")
      }
      val owner = rawObject["owner"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookWorkflowRunRequestedWorkflowRunRepositoryOwnerX4271096f?>(requireNotNull(element)) }
      return InlineWebhookWorkflowRunRequestedWorkflowRunRepositoryX77f90b26(
        archiveUrl = archiveUrl,
        assigneesUrl = assigneesUrl,
        blobsUrl = blobsUrl,
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookWorkflowRunRequestedWorkflowRunRepositoryX77f90b26) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookWorkflowRunRequestedWorkflowRunRepositoryX77f90b26")
...
public fun inlineWebhookWorkflowRunRequestedWorkflowRunRepositoryX77f90b26(block: InlineWebhookWorkflowRunRequestedWorkflowRunRepositoryX77f90b26.Builder.() -> Unit): InlineWebhookWorkflowRunRequestedWorkflowRunRepositoryX77f90b26 = InlineWebhookWorkflowRunRequestedWorkflowRunRepositoryX77f90b26.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookWorkflowRunRequestedWorkflowRunRepositoryX77f90b26 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookWorkflowRunRequestedWorkflowRunRepositoryX77f90b26 property '" + name + "' is not nullable")
