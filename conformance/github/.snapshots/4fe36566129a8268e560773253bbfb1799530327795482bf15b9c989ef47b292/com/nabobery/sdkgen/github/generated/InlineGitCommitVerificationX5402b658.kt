...
/**
 * Generated model for sdkgen://source/openapi.yaml#/components/schemas/git-commit/properties/verification.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/git-commit/properties/verification
 */
@Serializable(with = InlineGitCommitVerificationX5402b658.Serializer::class)
public class InlineGitCommitVerificationX5402b658(
  ...
  public class Builder {
    ...
    public fun build(): InlineGitCommitVerificationX5402b658 {
      ...
      return InlineGitCommitVerificationX5402b658(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineGitCommitVerificationX5402b658 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineGitCommitVerificationX5402b658> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineGitCommitVerificationX5402b658 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineGitCommitVerificationX5402b658")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineGitCommitVerificationX5402b658 must be a JSON object")
      ...
      if (!rawObject.containsKey("payload")) {
        throw SerializationException("InlineGitCommitVerificationX5402b658 is missing required property 'payload'")
      }
      ...
      if (!rawObject.containsKey("signature")) {
        throw SerializationException("InlineGitCommitVerificationX5402b658 is missing required property 'signature'")
      }
      ...
      if (!rawObject.containsKey("verified_at")) {
        throw SerializationException("InlineGitCommitVerificationX5402b658 is missing required property 'verified_at'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineGitCommitVerificationX5402b658) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineGitCommitVerificationX5402b658")
...
public fun inlineGitCommitVerificationX5402b658(block: InlineGitCommitVerificationX5402b658.Builder.() -> Unit): InlineGitCommitVerificationX5402b658 = InlineGitCommitVerificationX5402b658.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineGitCommitVerificationX5402b658 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineGitCommitVerificationX5402b658 property '" + name + "' is not nullable")
