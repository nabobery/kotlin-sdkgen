 ...
 */
@Serializable(with = InlineWebhookPullRequestReviewDismissedPullRequestHeadRepoX081ef946.Serializer::class)
public class InlineWebhookPullRequestReviewDismissedPullRequestHeadRepoX081ef946 internal constructor(
  /**
  ...
  public val createdAt:
      InlineWebhookPullRequestReviewDismissedPullRequestHeadRepoCreatedAtX92d51edf,
  /**
  ...
  public val license: InlineWebhookPullRequestReviewDismissedPullRequestHeadRepoLicenseX23525411?,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val owner: InlineWebhookPullRequestReviewDismissedPullRequestHeadRepoOwnerX431b9305?,
  /**
  ...
  public val pushedAt: InlineWebhookPullRequestReviewDismissedPullRequestHeadRepoPushedAtX9597e4f6?,
  /**
   * Wire format: `uri-template`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  private val mergeCommitMessageState:
      FieldState<InlineWebhookPullRequestRe8581PullRequestHeadRepoMergeCommitMessageXd5840009>,
  private val mergeCommitTitleState:
      FieldState<InlineWebhookPullRequestRe8581PullRequestHeadRepoMergeCommitTitleX9b20410b>,
  private val organizationState: FieldState<String>,
  private val permissionsState:
      FieldState<InlineWebhookPullRequestReviewDismissedPullRequestHeadRepoPermissionsX3b12dffe>,
  private val publicState: FieldState<Boolean>,
  private val pullRequestCreationPolicyState:
      FieldState<InlineWebhookPullRequestRe8581PullRequestHeadPullRequestCreationP824dX786d9eac>,
  private val roleNameState: FieldState<String?>,
  private val squashMergeCommitMessageState:
      FieldState<InlineWebhookPullRequestRe8581PullRequestHeadSquashMergeCommitMessageX6939e0a1>,
  private val squashMergeCommitTitleState:
      FieldState<InlineWebhookPullRequestRe8581PullRequestHeadRepoSquashMergeCommitTitleX7e0c67d1>,
  ...
  public val permissions:
      InlineWebhookPullRequestReviewDismissedPullRequestHeadRepoPermissionsX3b12dffe?
  ...
  public val squashMergeCommitTitle:
      InlineWebhookPullRequestRe8581PullRequestHeadRepoSquashMergeCommitTitleX7e0c67d1?
  ...
  public constructor(
    ...
    createdAt: InlineWebhookPullRequestReviewDismissedPullRequestHeadRepoCreatedAtX92d51edf,
    ...
    language: String?,
    languagesUrl: String,
    license: InlineWebhookPullRequestReviewDismissedPullRequestHeadRepoLicenseX23525411?,
    mergesUrl: String,
    ...
    openIssues: Int,
    openIssuesCount: Int,
    owner: InlineWebhookPullRequestReviewDismissedPullRequestHeadRepoOwnerX431b9305?,
    `private`: Boolean,
    pullsUrl: String,
    pushedAt: InlineWebhookPullRequestReviewDismissedPullRequestHeadRepoPushedAtX9597e4f6?,
    releasesUrl: String,
    size: Int,
    sshUrl: String,
    stargazersCount: Int,
    ...
    updatedAt: String,
    url: String,
    visibility: InlineWebhookPullRequestReviewDismissedPullRequestHeadRepoVisibilityXe8c0fca6,
    watchers: Int,
    watchersCount: Int,
  ...
  public class Builder {
    ...
    private var createdAtValue:
        InlineWebhookPullRequestReviewDismissedPullRequestHeadRepoCreatedAtX92d51edf? = null
    ...
    private var visibilityValue:
        InlineWebhookPullRequestReviewDismissedPullRequestHeadRepoVisibilityXe8c0fca6? = null
    ...
    private var licenseState:
        FieldState<InlineWebhookPullRequestReviewDismissedPullRequestHeadRepoLicenseX23525411?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var license: InlineWebhookPullRequestReviewDismissedPullRequestHeadRepoLicenseX23525411?
    ...
    private var ownerState:
        FieldState<InlineWebhookPullRequestReviewDismissedPullRequestHeadRepoOwnerX431b9305?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var owner: InlineWebhookPullRequestReviewDismissedPullRequestHeadRepoOwnerX431b9305?
    ...
    private var pushedAtState:
        FieldState<InlineWebhookPullRequestReviewDismissedPullRequestHeadRepoPushedAtX9597e4f6?> =
        FieldState.Absent
     ...
     */
    public var pushedAt:
        InlineWebhookPullRequestReviewDismissedPullRequestHeadRepoPushedAtX9597e4f6?
    ...
    public fun build(): InlineWebhookPullRequestReviewDismissedPullRequestHeadRepoX081ef946 {
      ...
      return InlineWebhookPullRequestReviewDismissedPullRequestHeadRepoX081ef946(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReviewDismissedPullRequestHeadRepoX081ef946 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReviewDismissedPullRequestHeadRepoX081ef946> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReviewDismissedPullRequestHeadRepoX081ef946 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReviewDismissedPullRequestHeadRepoX081ef946")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReviewDismissedPullRequestHeadRepoX081ef946 must be a JSON object")
      ...
      val createdAt = json.decodeRequired<InlineWebhookPullRequestReviewDismissedPullRequestHeadRepoCreatedAtX92d51edf>(rawObject, "created_at")
      ...
      val visibility = json.decodeRequired<InlineWebhookPullRequestReviewDismissedPullRequestHeadRepoVisibilityXe8c0fca6>(rawObject, "visibility")
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookPullRequestReviewDismissedPullRequestHeadRepoX081ef946 is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("homepage")) {
        throw SerializationException("InlineWebhookPullRequestReviewDismissedPullRequestHeadRepoX081ef946 is missing required property 'homepage'")
      }
      ...
      if (!rawObject.containsKey("language")) {
        throw SerializationException("InlineWebhookPullRequestReviewDismissedPullRequestHeadRepoX081ef946 is missing required property 'language'")
      }
      ...
      if (!rawObject.containsKey("license")) {
        throw SerializationException("InlineWebhookPullRequestReviewDismissedPullRequestHeadRepoX081ef946 is missing required property 'license'")
      }
      val license = rawObject["license"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestReviewDismissedPullRequestHeadRepoLicenseX23525411?>(requireNotNull(element)) }
      if (!rawObject.containsKey("mirror_url")) {
        throw SerializationException("InlineWebhookPullRequestReviewDismissedPullRequestHeadRepoX081ef946 is missing required property 'mirror_url'")
      }
      ...
      if (!rawObject.containsKey("owner")) {
        throw SerializationException("InlineWebhookPullRequestReviewDismissedPullRequestHeadRepoX081ef946 is missing required property 'owner'")
      }
      val owner = rawObject["owner"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestReviewDismissedPullRequestHeadRepoOwnerX431b9305?>(requireNotNull(element)) }
      if (!rawObject.containsKey("pushed_at")) {
        throw SerializationException("InlineWebhookPullRequestReviewDismissedPullRequestHeadRepoX081ef946 is missing required property 'pushed_at'")
      }
      val pushedAt = rawObject["pushed_at"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestReviewDismissedPullRequestHeadRepoPushedAtX9597e4f6?>(requireNotNull(element)) }
      return InlineWebhookPullRequestReviewDismissedPullRequestHeadRepoX081ef946(
        archiveUrl = archiveUrl,
        archived = archived,
        assigneesUrl = assigneesUrl,
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReviewDismissedPullRequestHeadRepoX081ef946) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReviewDismissedPullRequestHeadRepoX081ef946")
...
public fun inlineWebhookPullRequestReviewDismissedPullRequestHeadRepoX081ef946(block: InlineWebhookPullRequestReviewDismissedPullRequestHeadRepoX081ef946.Builder.() -> Unit): InlineWebhookPullRequestReviewDismissedPullRequestHeadRepoX081ef946 = InlineWebhookPullRequestReviewDismissedPullRequestHeadRepoX081ef946.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReviewDismissedPullRequestHeadRepoX081ef946 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookPullRequestReviewDismissedPullRequestHeadRepoX081ef946 property '" + name + "' is not nullable")
