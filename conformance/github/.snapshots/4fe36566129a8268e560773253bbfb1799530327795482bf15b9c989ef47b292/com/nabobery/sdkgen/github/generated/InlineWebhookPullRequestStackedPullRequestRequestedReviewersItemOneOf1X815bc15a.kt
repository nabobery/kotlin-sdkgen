 ...
 * ested_reviewers/items/oneOf/0
 */
@Serializable(with = InlineWebhookPullRequestStackedPullRequestRequestedReviewersItemOneOf1X815bc15a.Serializer::class)
public class InlineWebhookPullRequestStackedPullRequestRequestedReviewersItemOneOf1X815bc15a(
  public val id: Int,
  ...
  public val type:
      InlineWebhookPullRequestStae55PullRequestRequestedReviewersItemTypeXe3ff2fd9? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestStae55PullRequestRequestedReviewersItemTypeXe3ff2fd9? =
        null
    ...
    public fun build(): InlineWebhookPullRequestStackedPullRequestRequestedReviewersItemOneOf1X815bc15a {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestStackedPullRequestRequestedReviewersItemOneOf1X815bc15a = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestStackedPullRequestRequestedReviewersItemOneOf1X815bc15a> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestStackedPullRequestRequestedReviewersItemOneOf1X815bc15a {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestStackedPullRequestRequestedReviewersItemOneOf1X815bc15a")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestStackedPullRequestRequestedReviewersItemOneOf1X815bc15a must be a JSON object")
      ...
      return InlineWebhookPullRequestStackedPullRequestRequestedReviewersItemOneOf1X815bc15a(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestStae55PullRequestRequestedReviewersItemTypeXe3ff2fd9>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestStackedPullRequestRequestedReviewersItemOneOf1X815bc15a) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestStackedPullRequestRequestedReviewersItemOneOf1X815bc15a")
...
public fun inlineWebhookPullRequestStackedPullRequestRequestedReviewersItemOneOf1X815bc15a(block: InlineWebhookPullRequestStackedPullRequestRequestedReviewersItemOneOf1X815bc15a.Builder.() -> Unit): InlineWebhookPullRequestStackedPullRequestRequestedReviewersItemOneOf1X815bc15a = InlineWebhookPullRequestStackedPullRequestRequestedReviewersItemOneOf1X815bc15a.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestStackedPullRequestRequestedReviewersItemOneOf1X815bc15a is missing required property '" + name + "'")
