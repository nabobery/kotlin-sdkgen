...
@Serializable
public data class MovedColumnInProjectIssueEventView(
  ...
  public val projectCard: InlineMovedColumnInProjectIssueEventProjectCardX5831335c? = null,
 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/moved-column-in-project-issue-event
 */
@Serializable(with = MovedColumnInProjectIssueEvent.Serializer::class)
public class MovedColumnInProjectIssueEvent internal constructor(
  public val actor: SimpleUser,
  public val commitId: String?,
  public val commitUrl: String?,
  public val createdAt: String,
  ...
  private val projectCardState:
      FieldState<InlineMovedColumnInProjectIssueEventProjectCardX5831335c>,
) {
  public val projectCard: InlineMovedColumnInProjectIssueEventProjectCardX5831335c?
  ...
  public class Builder {
    ...
    private var projectCardState:
        FieldState<InlineMovedColumnInProjectIssueEventProjectCardX5831335c> = FieldState.Absent

    /**
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var projectCard: InlineMovedColumnInProjectIssueEventProjectCardX5831335c?
      get() = projectCardState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): MovedColumnInProjectIssueEvent {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): MovedColumnInProjectIssueEvent = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<MovedColumnInProjectIssueEvent> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): MovedColumnInProjectIssueEvent {
      val jsonDecoder = decoder.requireJsonDecoder("MovedColumnInProjectIssueEvent")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("MovedColumnInProjectIssueEvent must be a JSON object")
      ...
      if (!rawObject.containsKey("commit_id")) {
        throw SerializationException("MovedColumnInProjectIssueEvent is missing required property 'commit_id'")
      }
      ...
      if (!rawObject.containsKey("commit_url")) {
        throw SerializationException("MovedColumnInProjectIssueEvent is missing required property 'commit_url'")
      }
      ...
      if (!rawObject.containsKey("performed_via_github_app")) {
        throw SerializationException("MovedColumnInProjectIssueEvent is missing required property 'performed_via_github_app'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: MovedColumnInProjectIssueEvent) {
      val jsonEncoder = encoder.requireJsonEncoder("MovedColumnInProjectIssueEvent")
...
public fun movedColumnInProjectIssueEvent(block: MovedColumnInProjectIssueEvent.Builder.() -> Unit): MovedColumnInProjectIssueEvent = MovedColumnInProjectIssueEvent.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("MovedColumnInProjectIssueEvent is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("MovedColumnInProjectIssueEvent property '" + name + "' is not nullable")
