 ...
 * t/properties/milestone/properties/creator
 */
@Serializable(with = InlineWebhookPullRequestReffb1OneOf1PullRequestMilestoneCreatorX2bb48cf8.Serializer::class)
public class InlineWebhookPullRequestReffb1OneOf1PullRequestMilestoneCreatorX2bb48cf8(
  public val id: Int,
  ...
  public val type:
      InlineWebhookPullRequestReffb1OneOf1PullRequestMilestoneCreatorTypeX6b29c6e8? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestReffb1OneOf1PullRequestMilestoneCreatorTypeX6b29c6e8? =
        null
    ...
    public fun build(): InlineWebhookPullRequestReffb1OneOf1PullRequestMilestoneCreatorX2bb48cf8 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestReffb1OneOf1PullRequestMilestoneCreatorX2bb48cf8(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestReffb1OneOf1PullRequestMilestoneCreatorX2bb48cf8 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestReffb1OneOf1PullRequestMilestoneCreatorX2bb48cf8> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestReffb1OneOf1PullRequestMilestoneCreatorX2bb48cf8 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestReffb1OneOf1PullRequestMilestoneCreatorX2bb48cf8")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestReffb1OneOf1PullRequestMilestoneCreatorX2bb48cf8 must be a JSON object")
      ...
      return InlineWebhookPullRequestReffb1OneOf1PullRequestMilestoneCreatorX2bb48cf8(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestReffb1OneOf1PullRequestMilestoneCreatorTypeX6b29c6e8>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestReffb1OneOf1PullRequestMilestoneCreatorX2bb48cf8) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestReffb1OneOf1PullRequestMilestoneCreatorX2bb48cf8")
...
public fun inlineWebhookPullRequestReffb1OneOf1PullRequestMilestoneCreatorX2bb48cf8(block: InlineWebhookPullRequestReffb1OneOf1PullRequestMilestoneCreatorX2bb48cf8.Builder.() -> Unit): InlineWebhookPullRequestReffb1OneOf1PullRequestMilestoneCreatorX2bb48cf8 = InlineWebhookPullRequestReffb1OneOf1PullRequestMilestoneCreatorX2bb48cf8.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestReffb1OneOf1PullRequestMilestoneCreatorX2bb48cf8 is missing required property '" + name + "'")
