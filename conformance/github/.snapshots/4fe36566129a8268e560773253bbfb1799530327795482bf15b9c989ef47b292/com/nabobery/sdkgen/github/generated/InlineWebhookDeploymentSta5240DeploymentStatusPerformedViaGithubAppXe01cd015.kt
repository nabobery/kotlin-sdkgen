 ...
 * rties/performed_via_github_app
 */
@Serializable(with = InlineWebhookDeploymentSta5240DeploymentStatusPerformedViaGithubAppXe01cd015.Serializer::class)
public class InlineWebhookDeploymentSta5240DeploymentStatusPerformedViaGithubAppXe01cd015 internal constructor(
  /**
  ...
  public val owner: InlineWebhookDeploymentSta5240DeploymentStatusOwnerX2d4d6778?,
  /**
   * Wire format: `date-time`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  public val updatedAt: String?,
  eventsState: FieldState<List<InlineWebhookDeploymentSta5240DeploymentStatusPerformedViaGithubAppItemXb2e6086d>>,
  private val permissionsState:
      FieldState<InlineWebhookDeploymentSta5240DeploymentStatusPermissionsX2e6b71ac>,
  private val slugState: FieldState<String>,
) {
  private val eventsState:
      FieldState<List<InlineWebhookDeploymentSta5240DeploymentStatusPerformedViaGithubAppItemXb2e6086d>>
   ...
   */
  public val events:
      List<InlineWebhookDeploymentSta5240DeploymentStatusPerformedViaGithubAppItemXb2e6086d>?
    get() = eventsState.valueOrNull()

  /**
   * The set of permissions for the GitHub app
   */
  public val permissions: InlineWebhookDeploymentSta5240DeploymentStatusPermissionsX2e6b71ac?
  ...
  public constructor(
    ...
    name: String,
    nodeId: String,
    owner: InlineWebhookDeploymentSta5240DeploymentStatusOwnerX2d4d6778?,
    updatedAt: String?,
  ...
  public class Builder {
    ...
    private var ownerState:
        FieldState<InlineWebhookDeploymentSta5240DeploymentStatusOwnerX2d4d6778?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var owner: InlineWebhookDeploymentSta5240DeploymentStatusOwnerX2d4d6778?
     ...
     * Assign a non-null value, or use the unset function to omit the property.
     */
    public var permissions: InlineWebhookDeploymentSta5240DeploymentStatusPermissionsX2e6b71ac?
      get() = permissionsState.valueOrNull()
      set(`value`) {
    ...
    public fun build(): InlineWebhookDeploymentSta5240DeploymentStatusPerformedViaGithubAppXe01cd015 {
      ...
      return InlineWebhookDeploymentSta5240DeploymentStatusPerformedViaGithubAppXe01cd015(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookDeploymentSta5240DeploymentStatusPerformedViaGithubAppXe01cd015 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookDeploymentSta5240DeploymentStatusPerformedViaGithubAppXe01cd015> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookDeploymentSta5240DeploymentStatusPerformedViaGithubAppXe01cd015 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookDeploymentSta5240DeploymentStatusPerformedViaGithubAppXe01cd015")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookDeploymentSta5240DeploymentStatusPerformedViaGithubAppXe01cd015 must be a JSON object")
      val htmlUrl = json.decodeRequired<String>(rawObject, "html_url")
      val name = json.decodeRequired<String>(rawObject, "name")
      val nodeId = json.decodeRequired<String>(rawObject, "node_id")
      if (!rawObject.containsKey("created_at")) {
        throw SerializationException("InlineWebhookDeploymentSta5240DeploymentStatusPerformedViaGithubAppXe01cd015 is missing required property 'created_at'")
      }
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookDeploymentSta5240DeploymentStatusPerformedViaGithubAppXe01cd015 is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("external_url")) {
        throw SerializationException("InlineWebhookDeploymentSta5240DeploymentStatusPerformedViaGithubAppXe01cd015 is missing required property 'external_url'")
      }
      ...
      if (!rawObject.containsKey("id")) {
        throw SerializationException("InlineWebhookDeploymentSta5240DeploymentStatusPerformedViaGithubAppXe01cd015 is missing required property 'id'")
      }
      ...
      if (!rawObject.containsKey("owner")) {
        throw SerializationException("InlineWebhookDeploymentSta5240DeploymentStatusPerformedViaGithubAppXe01cd015 is missing required property 'owner'")
      }
      val owner = rawObject["owner"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookDeploymentSta5240DeploymentStatusOwnerX2d4d6778?>(requireNotNull(element)) }
      if (!rawObject.containsKey("updated_at")) {
        throw SerializationException("InlineWebhookDeploymentSta5240DeploymentStatusPerformedViaGithubAppXe01cd015 is missing required property 'updated_at'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookDeploymentSta5240DeploymentStatusPerformedViaGithubAppXe01cd015) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookDeploymentSta5240DeploymentStatusPerformedViaGithubAppXe01cd015")
...
public fun inlineWebhookDeploymentSta5240DeploymentStatusPerformedViaGithubAppXe01cd015(block: InlineWebhookDeploymentSta5240DeploymentStatusPerformedViaGithubAppXe01cd015.Builder.() -> Unit): InlineWebhookDeploymentSta5240DeploymentStatusPerformedViaGithubAppXe01cd015 = InlineWebhookDeploymentSta5240DeploymentStatusPerformedViaGithubAppXe01cd015.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookDeploymentSta5240DeploymentStatusPerformedViaGithubAppXe01cd015 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookDeploymentSta5240DeploymentStatusPerformedViaGithubAppXe01cd015 property '" + name + "' is not nullable")
