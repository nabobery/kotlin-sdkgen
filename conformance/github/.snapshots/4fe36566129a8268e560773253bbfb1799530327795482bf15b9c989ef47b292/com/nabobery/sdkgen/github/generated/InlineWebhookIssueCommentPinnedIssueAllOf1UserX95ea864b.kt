 ...
 * r
 */
@Serializable(with = InlineWebhookIssueCommentPinnedIssueAllOf1UserX95ea864b.Serializer::class)
public class InlineWebhookIssueCommentPinnedIssueAllOf1UserX95ea864b(
  public val id: Long,
  ...
  public val type: InlineWebhookIssueCommentPinnedIssueAllOf1UserTypeXe594651a? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookIssueCommentPinnedIssueAllOf1UserTypeXe594651a? = null
    ...
    public fun build(): InlineWebhookIssueCommentPinnedIssueAllOf1UserX95ea864b {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssueCommentPinnedIssueAllOf1UserX95ea864b(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssueCommentPinnedIssueAllOf1UserX95ea864b = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssueCommentPinnedIssueAllOf1UserX95ea864b> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssueCommentPinnedIssueAllOf1UserX95ea864b {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssueCommentPinnedIssueAllOf1UserX95ea864b")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssueCommentPinnedIssueAllOf1UserX95ea864b must be a JSON object")
      ...
      return InlineWebhookIssueCommentPinnedIssueAllOf1UserX95ea864b(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssueCommentPinnedIssueAllOf1UserTypeXe594651a>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssueCommentPinnedIssueAllOf1UserX95ea864b) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssueCommentPinnedIssueAllOf1UserX95ea864b")
...
public fun inlineWebhookIssueCommentPinnedIssueAllOf1UserX95ea864b(block: InlineWebhookIssueCommentPinnedIssueAllOf1UserX95ea864b.Builder.() -> Unit): InlineWebhookIssueCommentPinnedIssueAllOf1UserX95ea864b = InlineWebhookIssueCommentPinnedIssueAllOf1UserX95ea864b.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssueCommentPinnedIssueAllOf1UserX95ea864b is missing required property '" + name + "'")
