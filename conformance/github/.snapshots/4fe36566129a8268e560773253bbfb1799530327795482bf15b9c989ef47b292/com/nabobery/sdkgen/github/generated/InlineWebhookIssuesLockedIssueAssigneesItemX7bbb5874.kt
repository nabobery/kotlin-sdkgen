...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-locked/properties/issue/properties/assignees/items.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-locked/properties/issue/properties/assignees/items
 */
@Serializable(with = InlineWebhookIssuesLockedIssueAssigneesItemX7bbb5874.Serializer::class)
public class InlineWebhookIssuesLockedIssueAssigneesItemX7bbb5874(
  public val id: Int,
  ...
  public val type: InlineWebhookIssuesLockedIssueAssigneesItemTypeXfc0b1a33? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookIssuesLockedIssueAssigneesItemTypeXfc0b1a33? = null
    ...
    public fun build(): InlineWebhookIssuesLockedIssueAssigneesItemX7bbb5874 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssuesLockedIssueAssigneesItemX7bbb5874(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesLockedIssueAssigneesItemX7bbb5874 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesLockedIssueAssigneesItemX7bbb5874> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesLockedIssueAssigneesItemX7bbb5874 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesLockedIssueAssigneesItemX7bbb5874")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesLockedIssueAssigneesItemX7bbb5874 must be a JSON object")
      ...
      return InlineWebhookIssuesLockedIssueAssigneesItemX7bbb5874(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssuesLockedIssueAssigneesItemTypeXfc0b1a33>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesLockedIssueAssigneesItemX7bbb5874) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesLockedIssueAssigneesItemX7bbb5874")
...
public fun inlineWebhookIssuesLockedIssueAssigneesItemX7bbb5874(block: InlineWebhookIssuesLockedIssueAssigneesItemX7bbb5874.Builder.() -> Unit): InlineWebhookIssuesLockedIssueAssigneesItemX7bbb5874 = InlineWebhookIssuesLockedIssueAssigneesItemX7bbb5874.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesLockedIssueAssigneesItemX7bbb5874 is missing required property '" + name + "'")
