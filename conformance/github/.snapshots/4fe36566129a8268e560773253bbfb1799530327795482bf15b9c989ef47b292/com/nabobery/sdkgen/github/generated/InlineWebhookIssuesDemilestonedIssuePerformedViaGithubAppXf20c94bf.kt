 ...
 * a_github_app
 */
@Serializable(with = InlineWebhookIssuesDemilestonedIssuePerformedViaGithubAppXf20c94bf.Serializer::class)
public class InlineWebhookIssuesDemilestonedIssuePerformedViaGithubAppXf20c94bf internal constructor(
  /**
  ...
  public val owner: InlineWebhookIssuesDemilestonedIssuePerformedViaGithubAppOwnerX92686923?,
  /**
   * Wire format: `date-time`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  public val updatedAt: String?,
  eventsState: FieldState<List<InlineWebhookIssuesDemilestonedIssuePerformedViaGithubAppEventsItemXacf2db68>>,
  private val permissionsState:
      FieldState<InlineWebhookIssuesDemilestonedIssuePerformedViaGithubAppPermissionsXf105f860>,
  private val slugState: FieldState<String>,
) {
  private val eventsState:
      FieldState<List<InlineWebhookIssuesDemilestonedIssuePerformedViaGithubAppEventsItemXacf2db68>>
   ...
   */
  public val events:
      List<InlineWebhookIssuesDemilestonedIssuePerformedViaGithubAppEventsItemXacf2db68>?
  ...
  public constructor(
    ...
    name: String,
    nodeId: String,
    owner: InlineWebhookIssuesDemilestonedIssuePerformedViaGithubAppOwnerX92686923?,
    updatedAt: String?,
  ...
  public class Builder {
    ...
    private var ownerState:
        FieldState<InlineWebhookIssuesDemilestonedIssuePerformedViaGithubAppOwnerX92686923?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var owner: InlineWebhookIssuesDemilestonedIssuePerformedViaGithubAppOwnerX92686923?
    ...
    public fun build(): InlineWebhookIssuesDemilestonedIssuePerformedViaGithubAppXf20c94bf {
      ...
      return InlineWebhookIssuesDemilestonedIssuePerformedViaGithubAppXf20c94bf(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesDemilestonedIssuePerformedViaGithubAppXf20c94bf = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesDemilestonedIssuePerformedViaGithubAppXf20c94bf> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesDemilestonedIssuePerformedViaGithubAppXf20c94bf {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesDemilestonedIssuePerformedViaGithubAppXf20c94bf")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesDemilestonedIssuePerformedViaGithubAppXf20c94bf must be a JSON object")
      val htmlUrl = json.decodeRequired<String>(rawObject, "html_url")
      val name = json.decodeRequired<String>(rawObject, "name")
      val nodeId = json.decodeRequired<String>(rawObject, "node_id")
      if (!rawObject.containsKey("created_at")) {
        throw SerializationException("InlineWebhookIssuesDemilestonedIssuePerformedViaGithubAppXf20c94bf is missing required property 'created_at'")
      }
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookIssuesDemilestonedIssuePerformedViaGithubAppXf20c94bf is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("external_url")) {
        throw SerializationException("InlineWebhookIssuesDemilestonedIssuePerformedViaGithubAppXf20c94bf is missing required property 'external_url'")
      }
      ...
      if (!rawObject.containsKey("id")) {
        throw SerializationException("InlineWebhookIssuesDemilestonedIssuePerformedViaGithubAppXf20c94bf is missing required property 'id'")
      }
      ...
      if (!rawObject.containsKey("owner")) {
        throw SerializationException("InlineWebhookIssuesDemilestonedIssuePerformedViaGithubAppXf20c94bf is missing required property 'owner'")
      }
      val owner = rawObject["owner"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookIssuesDemilestonedIssuePerformedViaGithubAppOwnerX92686923?>(requireNotNull(element)) }
      if (!rawObject.containsKey("updated_at")) {
        throw SerializationException("InlineWebhookIssuesDemilestonedIssuePerformedViaGithubAppXf20c94bf is missing required property 'updated_at'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesDemilestonedIssuePerformedViaGithubAppXf20c94bf) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesDemilestonedIssuePerformedViaGithubAppXf20c94bf")
...
public fun inlineWebhookIssuesDemilestonedIssuePerformedViaGithubAppXf20c94bf(block: InlineWebhookIssuesDemilestonedIssuePerformedViaGithubAppXf20c94bf.Builder.() -> Unit): InlineWebhookIssuesDemilestonedIssuePerformedViaGithubAppXf20c94bf = InlineWebhookIssuesDemilestonedIssuePerformedViaGithubAppXf20c94bf.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesDemilestonedIssuePerformedViaGithubAppXf20c94bf is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookIssuesDemilestonedIssuePerformedViaGithubAppXf20c94bf property '" + name + "' is not nullable")
