 ...
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhooks_issue/properties/milestone
 */
@Serializable(with = InlineWebhooksIssueMilestoneXd4627731.Serializer::class)
public class InlineWebhooksIssueMilestoneXd4627731(
  /**
  ...
  public val creator: InlineWebhooksIssueMilestoneCreatorXc00aa031?,
   ...
   */
  public val state: InlineWebhooksIssueMilestoneStateXdc335839,
  /**
  ...
  public class Builder {
    ...
    private var stateValue: InlineWebhooksIssueMilestoneStateXdc335839? = null

    public var state: InlineWebhooksIssueMilestoneStateXdc335839
    ...
    private var creatorState: FieldState<InlineWebhooksIssueMilestoneCreatorXc00aa031?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var creator: InlineWebhooksIssueMilestoneCreatorXc00aa031?
    ...
    public fun build(): InlineWebhooksIssueMilestoneXd4627731 {
      ...
      return InlineWebhooksIssueMilestoneXd4627731(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhooksIssueMilestoneXd4627731 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhooksIssueMilestoneXd4627731> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhooksIssueMilestoneXd4627731 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhooksIssueMilestoneXd4627731")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhooksIssueMilestoneXd4627731 must be a JSON object")
      ...
      val state = json.decodeRequired<InlineWebhooksIssueMilestoneStateXdc335839>(rawObject, "state")
      val title = json.decodeRequired<String>(rawObject, "title")
      val updatedAt = json.decodeRequired<String>(rawObject, "updated_at")
      val url = json.decodeRequired<String>(rawObject, "url")
      if (!rawObject.containsKey("closed_at")) {
        throw SerializationException("InlineWebhooksIssueMilestoneXd4627731 is missing required property 'closed_at'")
      }
      ...
      if (!rawObject.containsKey("creator")) {
        throw SerializationException("InlineWebhooksIssueMilestoneXd4627731 is missing required property 'creator'")
      }
      val creator = rawObject["creator"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhooksIssueMilestoneCreatorXc00aa031?>(requireNotNull(element)) }
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhooksIssueMilestoneXd4627731 is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("due_on")) {
        throw SerializationException("InlineWebhooksIssueMilestoneXd4627731 is missing required property 'due_on'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhooksIssueMilestoneXd4627731) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhooksIssueMilestoneXd4627731")
...
public fun inlineWebhooksIssueMilestoneXd4627731(block: InlineWebhooksIssueMilestoneXd4627731.Builder.() -> Unit): InlineWebhooksIssueMilestoneXd4627731 = InlineWebhooksIssueMilestoneXd4627731.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhooksIssueMilestoneXd4627731 is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhooksIssueMilestoneXd4627731 property '" + name + "' is not nullable")
