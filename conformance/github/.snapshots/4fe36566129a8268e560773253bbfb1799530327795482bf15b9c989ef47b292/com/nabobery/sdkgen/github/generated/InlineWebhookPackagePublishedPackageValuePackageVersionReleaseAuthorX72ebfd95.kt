 ...
 * ion/properties/release/properties/author.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-package-published/properties/package/properties/package_vers
 * ion/properties/release/properties/author
 */
@Serializable(with = InlineWebhookPackagePublishedPackageValuePackageVersionReleaseAuthorX72ebfd95.Serializer::class)
public class InlineWebhookPackagePublishedPackageValuePackageVersionReleaseAuthorX72ebfd95(
  public val id: Int,
  ...
  public val type:
      InlineWebhookPackagePublishedPackageValuePackageVersionReleaseTypeX366c22da? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPackagePublishedPackageValuePackageVersionReleaseTypeX366c22da? =
        null
    ...
    public fun build(): InlineWebhookPackagePublishedPackageValuePackageVersionReleaseAuthorX72ebfd95 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPackagePublishedPackageValuePackageVersionReleaseAuthorX72ebfd95(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPackagePublishedPackageValuePackageVersionReleaseAuthorX72ebfd95 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPackagePublishedPackageValuePackageVersionReleaseAuthorX72ebfd95> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPackagePublishedPackageValuePackageVersionReleaseAuthorX72ebfd95 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPackagePublishedPackageValuePackageVersionReleaseAuthorX72ebfd95")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPackagePublishedPackageValuePackageVersionReleaseAuthorX72ebfd95 must be a JSON object")
      ...
      return InlineWebhookPackagePublishedPackageValuePackageVersionReleaseAuthorX72ebfd95(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPackagePublishedPackageValuePackageVersionReleaseTypeX366c22da>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPackagePublishedPackageValuePackageVersionReleaseAuthorX72ebfd95) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPackagePublishedPackageValuePackageVersionReleaseAuthorX72ebfd95")
...
public fun inlineWebhookPackagePublishedPackageValuePackageVersionReleaseAuthorX72ebfd95(block: InlineWebhookPackagePublishedPackageValuePackageVersionReleaseAuthorX72ebfd95.Builder.() -> Unit): InlineWebhookPackagePublishedPackageValuePackageVersionReleaseAuthorX72ebfd95 = InlineWebhookPackagePublishedPackageValuePackageVersionReleaseAuthorX72ebfd95.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPackagePublishedPackageValuePackageVersionReleaseAuthorX72ebfd95 is missing required property '" + name + "'")
