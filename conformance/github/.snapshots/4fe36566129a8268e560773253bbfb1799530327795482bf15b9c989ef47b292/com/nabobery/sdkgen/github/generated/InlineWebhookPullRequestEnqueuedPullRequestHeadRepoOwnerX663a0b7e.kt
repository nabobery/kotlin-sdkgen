 ...
 * d/properties/repo/properties/owner.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-enqueued/properties/pull_request/properties/hea
 * d/properties/repo/properties/owner
 */
@Serializable(with = InlineWebhookPullRequestEnqueuedPullRequestHeadRepoOwnerX663a0b7e.Serializer::class)
public class InlineWebhookPullRequestEnqueuedPullRequestHeadRepoOwnerX663a0b7e(
  public val id: Int,
  ...
  public val type: InlineWebhookPullRequestEnqueuedPullRequestHeadRepoOwnerTypeXc81b6982? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestEnqueuedPullRequestHeadRepoOwnerTypeXc81b6982? = null
    ...
    public fun build(): InlineWebhookPullRequestEnqueuedPullRequestHeadRepoOwnerX663a0b7e {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestEnqueuedPullRequestHeadRepoOwnerX663a0b7e(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestEnqueuedPullRequestHeadRepoOwnerX663a0b7e = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestEnqueuedPullRequestHeadRepoOwnerX663a0b7e> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestEnqueuedPullRequestHeadRepoOwnerX663a0b7e {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestEnqueuedPullRequestHeadRepoOwnerX663a0b7e")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestEnqueuedPullRequestHeadRepoOwnerX663a0b7e must be a JSON object")
      ...
      return InlineWebhookPullRequestEnqueuedPullRequestHeadRepoOwnerX663a0b7e(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestEnqueuedPullRequestHeadRepoOwnerTypeXc81b6982>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestEnqueuedPullRequestHeadRepoOwnerX663a0b7e) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestEnqueuedPullRequestHeadRepoOwnerX663a0b7e")
...
public fun inlineWebhookPullRequestEnqueuedPullRequestHeadRepoOwnerX663a0b7e(block: InlineWebhookPullRequestEnqueuedPullRequestHeadRepoOwnerX663a0b7e.Builder.() -> Unit): InlineWebhookPullRequestEnqueuedPullRequestHeadRepoOwnerX663a0b7e = InlineWebhookPullRequestEnqueuedPullRequestHeadRepoOwnerX663a0b7e.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestEnqueuedPullRequestHeadRepoOwnerX663a0b7e is missing required property '" + name + "'")
