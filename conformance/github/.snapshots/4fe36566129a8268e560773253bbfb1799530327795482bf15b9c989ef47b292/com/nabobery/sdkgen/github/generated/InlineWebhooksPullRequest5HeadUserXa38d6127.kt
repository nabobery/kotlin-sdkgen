...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/components/schemas/webhooks_pull_request_5/properties/head/properties/user.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhooks_pull_request_5/properties/head/properties/user
 */
@Serializable(with = InlineWebhooksPullRequest5HeadUserXa38d6127.Serializer::class)
public class InlineWebhooksPullRequest5HeadUserXa38d6127(
  public val id: Long,
  ...
  public val type: InlineWebhooksPullRequest5HeadUserTypeX26fd609b? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhooksPullRequest5HeadUserTypeX26fd609b? = null
    ...
    public fun build(): InlineWebhooksPullRequest5HeadUserXa38d6127 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhooksPullRequest5HeadUserXa38d6127(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhooksPullRequest5HeadUserXa38d6127 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhooksPullRequest5HeadUserXa38d6127> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhooksPullRequest5HeadUserXa38d6127 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhooksPullRequest5HeadUserXa38d6127")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhooksPullRequest5HeadUserXa38d6127 must be a JSON object")
      ...
      return InlineWebhooksPullRequest5HeadUserXa38d6127(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhooksPullRequest5HeadUserTypeX26fd609b>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhooksPullRequest5HeadUserXa38d6127) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhooksPullRequest5HeadUserXa38d6127")
...
public fun inlineWebhooksPullRequest5HeadUserXa38d6127(block: InlineWebhooksPullRequest5HeadUserXa38d6127.Builder.() -> Unit): InlineWebhooksPullRequest5HeadUserXa38d6127 = InlineWebhooksPullRequest5HeadUserXa38d6127.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhooksPullRequest5HeadUserXa38d6127 is missing required property '" + name + "'")
