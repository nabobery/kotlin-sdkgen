 ...
 * d/properties/user
 */
@Serializable(with = InlineWebhookPullRequestEnqueuedPullRequestHeadUserX1df0d165.Serializer::class)
public class InlineWebhookPullRequestEnqueuedPullRequestHeadUserX1df0d165(
  public val id: Long,
  ...
  public val type: InlineWebhookPullRequestEnqueuedPullRequestHeadUserTypeXae2e12af? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestEnqueuedPullRequestHeadUserTypeXae2e12af? = null
    ...
    public fun build(): InlineWebhookPullRequestEnqueuedPullRequestHeadUserX1df0d165 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestEnqueuedPullRequestHeadUserX1df0d165(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestEnqueuedPullRequestHeadUserX1df0d165 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestEnqueuedPullRequestHeadUserX1df0d165> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestEnqueuedPullRequestHeadUserX1df0d165 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestEnqueuedPullRequestHeadUserX1df0d165")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestEnqueuedPullRequestHeadUserX1df0d165 must be a JSON object")
      ...
      return InlineWebhookPullRequestEnqueuedPullRequestHeadUserX1df0d165(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestEnqueuedPullRequestHeadUserTypeXae2e12af>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestEnqueuedPullRequestHeadUserX1df0d165) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestEnqueuedPullRequestHeadUserX1df0d165")
...
public fun inlineWebhookPullRequestEnqueuedPullRequestHeadUserX1df0d165(block: InlineWebhookPullRequestEnqueuedPullRequestHeadUserX1df0d165.Builder.() -> Unit): InlineWebhookPullRequestEnqueuedPullRequestHeadUserX1df0d165 = InlineWebhookPullRequestEnqueuedPullRequestHeadUserX1df0d165.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestEnqueuedPullRequestHeadUserX1df0d165 is missing required property '" + name + "'")
