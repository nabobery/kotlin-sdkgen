 ...
 * /repository
 */
@Serializable(with = InlineWebhookDeploymentStatusCreatedWorkflowRunRepositoryX51b0038b.Serializer::class)
public class InlineWebhookDeploymentStatusCreatedWorkflowRunRepositoryX51b0038b(
  ...
  public val owner: InlineWebhookDeploymentStatusCreatedWorkflowRunRepositoryOwnerXb99739f1? = null,
  ...
  public class Builder {
    ...
    public var owner: InlineWebhookDeploymentStatusCreatedWorkflowRunRepositoryOwnerXb99739f1? =
        null
    ...
    public fun build(): InlineWebhookDeploymentStatusCreatedWorkflowRunRepositoryX51b0038b = InlineWebhookDeploymentStatusCreatedWorkflowRunRepositoryX51b0038b(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookDeploymentStatusCreatedWorkflowRunRepositoryX51b0038b = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookDeploymentStatusCreatedWorkflowRunRepositoryX51b0038b> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookDeploymentStatusCreatedWorkflowRunRepositoryX51b0038b {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookDeploymentStatusCreatedWorkflowRunRepositoryX51b0038b")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookDeploymentStatusCreatedWorkflowRunRepositoryX51b0038b must be a JSON object")
      return InlineWebhookDeploymentStatusCreatedWorkflowRunRepositoryX51b0038b(
        ...
        owner = rawObject["owner"]?.let { json.decodeFromJsonElement<InlineWebhookDeploymentStatusCreatedWorkflowRunRepositoryOwnerXb99739f1>(it) },
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookDeploymentStatusCreatedWorkflowRunRepositoryX51b0038b) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookDeploymentStatusCreatedWorkflowRunRepositoryX51b0038b")
...
public fun inlineWebhookDeploymentStatusCreatedWorkflowRunRepositoryX51b0038b(block: InlineWebhookDeploymentStatusCreatedWorkflowRunRepositoryX51b0038b.Builder.() -> Unit): InlineWebhookDeploymentStatusCreatedWorkflowRunRepositoryX51b0038b = InlineWebhookDeploymentStatusCreatedWorkflowRunRepositoryX51b0038b.build(block)
