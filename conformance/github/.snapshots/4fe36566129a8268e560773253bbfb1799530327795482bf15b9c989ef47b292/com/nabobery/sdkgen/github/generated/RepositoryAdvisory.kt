...
public class RepositoryAdvisory internal constructor(
  ...
  public val collaboratingTeams: List<Team>? =
      collaboratingTeams?.let { collection0 -> collection0.toList() }

  /**
   * A list of users that collaborate on the advisory.
   */
  public val collaboratingUsers: List<SimpleUser>? =
      collaboratingUsers?.let { collection0 -> collection0.toList() }
  ...
  public val creditsDetailed: List<RepositoryAdvisoryCredit>? =
      creditsDetailed?.let { collection0 -> collection0.toList() }
  ...
  public class Builder {
    ...
    public var creditsDetailed: List<RepositoryAdvisoryCredit>?
      get() = creditsDetailedState.valueOrNull()?.let { collection0 -> collection0.toList() }
      set(`value`) {
        creditsDetailedState = value?.let { collection0 -> collection0.toList() }.toNullableFieldState()
      }
  ...
  internal object Serializer : KSerializer<RepositoryAdvisory> {
