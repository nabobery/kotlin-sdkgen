 ...
 * head/properties/repo
 */
@Serializable(with = InlineWebhookPullRequestSynchronizePullRequestHeadRepoXad0d7e4b.Serializer::class)
public class InlineWebhookPullRequestSynchronizePullRequestHeadRepoXad0d7e4b internal constructor(
  /**
  ...
  public val createdAt: InlineWebhookPullRequestSynchronizePullRequestHeadRepoCreatedAtX1ae925f3,
  /**
  ...
  public val license: InlineWebhookPullRequestSynchronizePullRequestHeadRepoLicenseX55bc642a?,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val owner: InlineWebhookPullRequestSynchronizePullRequestHeadRepoOwnerXe2da46ae?,
  /**
  ...
  public val pushedAt: InlineWebhookPullRequestSynchronizePullRequestHeadRepoPushedAtX3dae004a?,
  /**
   * Wire format: `uri-template`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public val visibility: InlineWebhookPullRequestSynchronizePullRequestHeadRepoVisibilityXdd49ec4d,
  ...
  private val mergeCommitMessageState:
      FieldState<InlineWebhookPullRequestSy92fbPullRequestHeadRepoMergeCommitMessageX169ab7a8>,
  private val mergeCommitTitleState:
      FieldState<InlineWebhookPullRequestSynchronizePullRequestHeadRepoMergeCommitTitleX54ac5458>,
  private val organizationState: FieldState<String>,
  private val permissionsState:
      FieldState<InlineWebhookPullRequestSynchronizePullRequestHeadRepoPermissionsX51130049>,
  private val publicState: FieldState<Boolean>,
  private val pullRequestCreationPolicyState:
      FieldState<InlineWebhookPullRequestSy92fbPullRequestHeadPullRequestCreationP824dXb619663e>,
  private val roleNameState: FieldState<String?>,
  private val squashMergeCommitMessageState:
      FieldState<InlineWebhookPullRequestSy92fbPullRequestHeadSquashMergeCommitMessageX50d03540>,
  private val squashMergeCommitTitleState:
      FieldState<InlineWebhookPullRequestSy92fbPullRequestHeadRepoSquashMergeCommitTitleXc8cb8ca3>,
  ...
  public val permissions:
      InlineWebhookPullRequestSynchronizePullRequestHeadRepoPermissionsX51130049?
  ...
  public val squashMergeCommitTitle:
      InlineWebhookPullRequestSy92fbPullRequestHeadRepoSquashMergeCommitTitleXc8cb8ca3?
  ...
  public constructor(
    ...
    createdAt: InlineWebhookPullRequestSynchronizePullRequestHeadRepoCreatedAtX1ae925f3,
    ...
    language: String?,
    languagesUrl: String,
    license: InlineWebhookPullRequestSynchronizePullRequestHeadRepoLicenseX55bc642a?,
    mergesUrl: String,
    ...
    openIssues: Int,
    openIssuesCount: Int,
    owner: InlineWebhookPullRequestSynchronizePullRequestHeadRepoOwnerXe2da46ae?,
    `private`: Boolean,
    pullsUrl: String,
    pushedAt: InlineWebhookPullRequestSynchronizePullRequestHeadRepoPushedAtX3dae004a?,
    releasesUrl: String,
    size: Int,
    sshUrl: String,
    stargazersCount: Int,
    ...
    updatedAt: String,
    url: String,
    visibility: InlineWebhookPullRequestSynchronizePullRequestHeadRepoVisibilityXdd49ec4d,
    watchers: Int,
    watchersCount: Int,
  ...
  public class Builder {
    ...
    private var createdAtValue:
        InlineWebhookPullRequestSynchronizePullRequestHeadRepoCreatedAtX1ae925f3? = null

    public var createdAt: InlineWebhookPullRequestSynchronizePullRequestHeadRepoCreatedAtX1ae925f3
    ...
    private var visibilityValue:
        InlineWebhookPullRequestSynchronizePullRequestHeadRepoVisibilityXdd49ec4d? = null

    public var visibility: InlineWebhookPullRequestSynchronizePullRequestHeadRepoVisibilityXdd49ec4d
    ...
    private var licenseState:
        FieldState<InlineWebhookPullRequestSynchronizePullRequestHeadRepoLicenseX55bc642a?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var license: InlineWebhookPullRequestSynchronizePullRequestHeadRepoLicenseX55bc642a?
    ...
    private var ownerState:
        FieldState<InlineWebhookPullRequestSynchronizePullRequestHeadRepoOwnerXe2da46ae?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var owner: InlineWebhookPullRequestSynchronizePullRequestHeadRepoOwnerXe2da46ae?
    ...
    private var pushedAtState:
        FieldState<InlineWebhookPullRequestSynchronizePullRequestHeadRepoPushedAtX3dae004a?> =
        FieldState.Absent

    /**
     * Required nullable field; assigning `null` records present-null.
     */
    public var pushedAt: InlineWebhookPullRequestSynchronizePullRequestHeadRepoPushedAtX3dae004a?
    ...
    public fun build(): InlineWebhookPullRequestSynchronizePullRequestHeadRepoXad0d7e4b {
      ...
      return InlineWebhookPullRequestSynchronizePullRequestHeadRepoXad0d7e4b(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestSynchronizePullRequestHeadRepoXad0d7e4b = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestSynchronizePullRequestHeadRepoXad0d7e4b> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestSynchronizePullRequestHeadRepoXad0d7e4b {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestSynchronizePullRequestHeadRepoXad0d7e4b")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestSynchronizePullRequestHeadRepoXad0d7e4b must be a JSON object")
      ...
      val createdAt = json.decodeRequired<InlineWebhookPullRequestSynchronizePullRequestHeadRepoCreatedAtX1ae925f3>(rawObject, "created_at")
      ...
      val visibility = json.decodeRequired<InlineWebhookPullRequestSynchronizePullRequestHeadRepoVisibilityXdd49ec4d>(rawObject, "visibility")
      ...
      if (!rawObject.containsKey("description")) {
        throw SerializationException("InlineWebhookPullRequestSynchronizePullRequestHeadRepoXad0d7e4b is missing required property 'description'")
      }
      ...
      if (!rawObject.containsKey("homepage")) {
        throw SerializationException("InlineWebhookPullRequestSynchronizePullRequestHeadRepoXad0d7e4b is missing required property 'homepage'")
      }
      ...
      if (!rawObject.containsKey("language")) {
        throw SerializationException("InlineWebhookPullRequestSynchronizePullRequestHeadRepoXad0d7e4b is missing required property 'language'")
      }
      ...
      if (!rawObject.containsKey("license")) {
        throw SerializationException("InlineWebhookPullRequestSynchronizePullRequestHeadRepoXad0d7e4b is missing required property 'license'")
      }
      val license = rawObject["license"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestSynchronizePullRequestHeadRepoLicenseX55bc642a?>(requireNotNull(element)) }
      if (!rawObject.containsKey("mirror_url")) {
        throw SerializationException("InlineWebhookPullRequestSynchronizePullRequestHeadRepoXad0d7e4b is missing required property 'mirror_url'")
      }
      ...
      if (!rawObject.containsKey("owner")) {
        throw SerializationException("InlineWebhookPullRequestSynchronizePullRequestHeadRepoXad0d7e4b is missing required property 'owner'")
      }
      val owner = rawObject["owner"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestSynchronizePullRequestHeadRepoOwnerXe2da46ae?>(requireNotNull(element)) }
      if (!rawObject.containsKey("pushed_at")) {
        throw SerializationException("InlineWebhookPullRequestSynchronizePullRequestHeadRepoXad0d7e4b is missing required property 'pushed_at'")
      }
      val pushedAt = rawObject["pushed_at"].let { element -> if (element == JsonNull) null else json.decodeFromJsonElement<InlineWebhookPullRequestSynchronizePullRequestHeadRepoPushedAtX3dae004a?>(requireNotNull(element)) }
      return InlineWebhookPullRequestSynchronizePullRequestHeadRepoXad0d7e4b(
        archiveUrl = archiveUrl,
        archived = archived,
        assigneesUrl = assigneesUrl,
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestSynchronizePullRequestHeadRepoXad0d7e4b) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestSynchronizePullRequestHeadRepoXad0d7e4b")
...
public fun inlineWebhookPullRequestSynchronizePullRequestHeadRepoXad0d7e4b(block: InlineWebhookPullRequestSynchronizePullRequestHeadRepoXad0d7e4b.Builder.() -> Unit): InlineWebhookPullRequestSynchronizePullRequestHeadRepoXad0d7e4b = InlineWebhookPullRequestSynchronizePullRequestHeadRepoXad0d7e4b.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestSynchronizePullRequestHeadRepoXad0d7e4b is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("InlineWebhookPullRequestSynchronizePullRequestHeadRepoXad0d7e4b property '" + name + "' is not nullable")
