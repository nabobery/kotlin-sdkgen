 ...
 * lestone/properties/creator
 */
@Serializable(with = InlineWebhookIssueCommentDeletedIssueAllOf1MilestoneCreatorXab4ce9e7.Serializer::class)
public class InlineWebhookIssueCommentDeletedIssueAllOf1MilestoneCreatorXab4ce9e7(
  public val id: Int,
  ...
  public val type: InlineWebhookIssueCommentDeletedIssueAllOf1MilestoneCreatorTypeXd3168577? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookIssueCommentDeletedIssueAllOf1MilestoneCreatorTypeXd3168577? =
        null
    ...
    public fun build(): InlineWebhookIssueCommentDeletedIssueAllOf1MilestoneCreatorXab4ce9e7 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssueCommentDeletedIssueAllOf1MilestoneCreatorXab4ce9e7(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssueCommentDeletedIssueAllOf1MilestoneCreatorXab4ce9e7 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssueCommentDeletedIssueAllOf1MilestoneCreatorXab4ce9e7> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssueCommentDeletedIssueAllOf1MilestoneCreatorXab4ce9e7 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssueCommentDeletedIssueAllOf1MilestoneCreatorXab4ce9e7")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssueCommentDeletedIssueAllOf1MilestoneCreatorXab4ce9e7 must be a JSON object")
      ...
      return InlineWebhookIssueCommentDeletedIssueAllOf1MilestoneCreatorXab4ce9e7(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssueCommentDeletedIssueAllOf1MilestoneCreatorTypeXd3168577>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssueCommentDeletedIssueAllOf1MilestoneCreatorXab4ce9e7) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssueCommentDeletedIssueAllOf1MilestoneCreatorXab4ce9e7")
...
public fun inlineWebhookIssueCommentDeletedIssueAllOf1MilestoneCreatorXab4ce9e7(block: InlineWebhookIssueCommentDeletedIssueAllOf1MilestoneCreatorXab4ce9e7.Builder.() -> Unit): InlineWebhookIssueCommentDeletedIssueAllOf1MilestoneCreatorXab4ce9e7 = InlineWebhookIssueCommentDeletedIssueAllOf1MilestoneCreatorXab4ce9e7.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssueCommentDeletedIssueAllOf1MilestoneCreatorXab4ce9e7 is missing required property '" + name + "'")
