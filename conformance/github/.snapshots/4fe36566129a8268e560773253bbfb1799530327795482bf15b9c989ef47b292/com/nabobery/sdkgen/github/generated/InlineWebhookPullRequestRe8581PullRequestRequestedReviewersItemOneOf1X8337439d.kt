 ...
 * ties/requested_reviewers/items/oneOf/0.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-review-dismissed/properties/pull_request/proper
 * ties/requested_reviewers/items/oneOf/0
 */
@Serializable(with = InlineWebhookPullRequestRe8581PullRequestRequestedReviewersItemOneOf1X8337439d.Serializer::class)
public class InlineWebhookPullRequestRe8581PullRequestRequestedReviewersItemOneOf1X8337439d(
  public val id: Int,
  ...
  public val type:
      InlineWebhookPullRequestRe8581PullRequestRequestedReviewersItemTypeX17db2f2f? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestRe8581PullRequestRequestedReviewersItemTypeX17db2f2f? =
        null
    ...
    public fun build(): InlineWebhookPullRequestRe8581PullRequestRequestedReviewersItemOneOf1X8337439d {
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestRe8581PullRequestRequestedReviewersItemOneOf1X8337439d = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestRe8581PullRequestRequestedReviewersItemOneOf1X8337439d> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestRe8581PullRequestRequestedReviewersItemOneOf1X8337439d {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestRe8581PullRequestRequestedReviewersItemOneOf1X8337439d")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestRe8581PullRequestRequestedReviewersItemOneOf1X8337439d must be a JSON object")
      ...
      return InlineWebhookPullRequestRe8581PullRequestRequestedReviewersItemOneOf1X8337439d(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestRe8581PullRequestRequestedReviewersItemTypeX17db2f2f>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestRe8581PullRequestRequestedReviewersItemOneOf1X8337439d) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestRe8581PullRequestRequestedReviewersItemOneOf1X8337439d")
...
public fun inlineWebhookPullRequestRe8581PullRequestRequestedReviewersItemOneOf1X8337439d(block: InlineWebhookPullRequestRe8581PullRequestRequestedReviewersItemOneOf1X8337439d.Builder.() -> Unit): InlineWebhookPullRequestRe8581PullRequestRequestedReviewersItemOneOf1X8337439d = InlineWebhookPullRequestRe8581PullRequestRequestedReviewersItemOneOf1X8337439d.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestRe8581PullRequestRequestedReviewersItemOneOf1X8337439d is missing required property '" + name + "'")
