...
/**
 * Generated model for
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-release-prereleased/properties/release/properties/reactions.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-release-prereleased/properties/release/properties/reactions
 */
@Serializable(with = InlineWebhookReleasePrereleasedReleaseReactionsX472995c1.Serializer::class)
public class InlineWebhookReleasePrereleasedReleaseReactionsX472995c1(
  public val _1: Int,
  public val _12: Int,
  ...
  public class Builder {
    ...
    public fun build(): InlineWebhookReleasePrereleasedReleaseReactionsX472995c1 {
      ...
      return InlineWebhookReleasePrereleasedReleaseReactionsX472995c1(
        _1 = _1,
        _12 = _12,
        confused = confused,
        eyes = eyes,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookReleasePrereleasedReleaseReactionsX472995c1 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookReleasePrereleasedReleaseReactionsX472995c1> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookReleasePrereleasedReleaseReactionsX472995c1 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookReleasePrereleasedReleaseReactionsX472995c1")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookReleasePrereleasedReleaseReactionsX472995c1 must be a JSON object")
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhookReleasePrereleasedReleaseReactionsX472995c1) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookReleasePrereleasedReleaseReactionsX472995c1")
...
public fun inlineWebhookReleasePrereleasedReleaseReactionsX472995c1(block: InlineWebhookReleasePrereleasedReleaseReactionsX472995c1.Builder.() -> Unit): InlineWebhookReleasePrereleasedReleaseReactionsX472995c1 = InlineWebhookReleasePrereleasedReleaseReactionsX472995c1.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookReleasePrereleasedReleaseReactionsX472995c1 is missing required property '" + name + "'")
