...
/**
 * Generated model for sdkgen://source/openapi.yaml#/components/schemas/verification.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/verification
 */
@Serializable(with = Verification.Serializer::class)
public class Verification(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): Verification = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<Verification> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): Verification {
      val jsonDecoder = decoder.requireJsonDecoder("Verification")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("Verification must be a JSON object")
      ...
      if (!rawObject.containsKey("payload")) {
        throw SerializationException("Verification is missing required property 'payload'")
      }
      ...
      if (!rawObject.containsKey("signature")) {
        throw SerializationException("Verification is missing required property 'signature'")
      }
      ...
      if (!rawObject.containsKey("verified_at")) {
        throw SerializationException("Verification is missing required property 'verified_at'")
      }
    ...
    override fun serialize(encoder: Encoder, `value`: Verification) {
      val jsonEncoder = encoder.requireJsonEncoder("Verification")
...
public fun verification(block: Verification.Builder.() -> Unit): Verification = Verification.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("Verification is missing required property '" + name + "'")
...
private inline fun <reified T> Json.decodeOptional(
  ...
  if (element == JsonNull) {
    if (!nullable) throw SerializationException("Verification property '" + name + "' is not nullable")
