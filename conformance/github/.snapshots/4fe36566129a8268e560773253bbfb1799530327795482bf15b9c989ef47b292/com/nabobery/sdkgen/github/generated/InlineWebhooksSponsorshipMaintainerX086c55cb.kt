...
/**
 * Generated model for sdkgen://source/openapi.yaml#/components/schemas/webhooks_sponsorship/properties/maintainer.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/webhooks_sponsorship/properties/maintainer
 */
@Serializable(with = InlineWebhooksSponsorshipMaintainerX086c55cb.Serializer::class)
public class InlineWebhooksSponsorshipMaintainerX086c55cb(
  ...
  public class Builder {
    ...
    public fun build(): InlineWebhooksSponsorshipMaintainerX086c55cb = InlineWebhooksSponsorshipMaintainerX086c55cb(
      avatarUrl = avatarUrl,
      eventsUrl = eventsUrl,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhooksSponsorshipMaintainerX086c55cb = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhooksSponsorshipMaintainerX086c55cb> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhooksSponsorshipMaintainerX086c55cb {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhooksSponsorshipMaintainerX086c55cb")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhooksSponsorshipMaintainerX086c55cb must be a JSON object")
      return InlineWebhooksSponsorshipMaintainerX086c55cb(
    ...
    override fun serialize(encoder: Encoder, `value`: InlineWebhooksSponsorshipMaintainerX086c55cb) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhooksSponsorshipMaintainerX086c55cb")
...
public fun inlineWebhooksSponsorshipMaintainerX086c55cb(block: InlineWebhooksSponsorshipMaintainerX086c55cb.Builder.() -> Unit): InlineWebhooksSponsorshipMaintainerX086c55cb = InlineWebhooksSponsorshipMaintainerX086c55cb.build(block)
