...
public class InlineReposPullsReviewsPostRequestJsonX257d334c(
  ...
  comments: List<InlineReposPullsReviewsPostRequestJsonCommentsItemX1ee97ce5>? = null,
  /**
   ...
   */
  public val comments: List<InlineReposPullsReviewsPostRequestJsonCommentsItemX1ee97ce5>? =
      comments?.let { collection0 -> collection0.toList() }
  ...
  public class Builder {
    ...
    private var commentsValue: List<InlineReposPullsReviewsPostRequestJsonCommentsItemX1ee97ce5>? =
        null

    /**
     * Use the following table to specify the location, destination, and contents of the draft review comment.
     */
    public var comments: List<InlineReposPullsReviewsPostRequestJsonCommentsItemX1ee97ce5>?
  ...
  internal object Serializer : KSerializer<InlineReposPullsReviewsPostRequestJsonX257d334c> {
