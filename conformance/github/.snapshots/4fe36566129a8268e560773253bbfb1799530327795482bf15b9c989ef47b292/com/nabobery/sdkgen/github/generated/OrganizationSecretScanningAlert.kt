...
/**
 * Generated model for sdkgen://source/openapi.yaml#/components/schemas/organization-secret-scanning-alert.
 *
 * Source: sdkgen://source/openapi.yaml#/components/schemas/organization-secret-scanning-alert
 */
@Serializable(with = OrganizationSecretScanningAlert.Serializer::class)
public class OrganizationSecretScanningAlert(
   ...
   */
  public val validity: InlineOrganizationSecretScanningAlertValidityX0fe942b6? = null,
) {
  public class Builder {
     ...
     * The token status as of the latest validity check.
     */
    public var validity: InlineOrganizationSecretScanningAlertValidityX0fe942b6? = null

    public fun build(): OrganizationSecretScanningAlert = OrganizationSecretScanningAlert(
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): OrganizationSecretScanningAlert = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<OrganizationSecretScanningAlert> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): OrganizationSecretScanningAlert {
      val jsonDecoder = decoder.requireJsonDecoder("OrganizationSecretScanningAlert")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("OrganizationSecretScanningAlert must be a JSON object")
      return OrganizationSecretScanningAlert(
        ...
        validity = rawObject["validity"]?.let { json.decodeFromJsonElement<InlineOrganizationSecretScanningAlertValidityX0fe942b6>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: OrganizationSecretScanningAlert) {
      val jsonEncoder = encoder.requireJsonEncoder("OrganizationSecretScanningAlert")
...
public fun organizationSecretScanningAlert(block: OrganizationSecretScanningAlert.Builder.() -> Unit): OrganizationSecretScanningAlert = OrganizationSecretScanningAlert.build(block)
