...
public class InlineOrgsCodeSecurityConf078bPostRequestJsonSecretScanningDelega7d2cX3848280f(
  reviewers: List<InlineOrgsCodeSecurityConf078bPostRequestJsonItemX6fce6a4b>? = null,
) {
  /**
   * The bypass reviewers for secret scanning delegated bypass
   */
  public val reviewers: List<InlineOrgsCodeSecurityConf078bPostRequestJsonItemX6fce6a4b>? =
      reviewers?.let { collection0 -> collection0.toList() }

  public class Builder {
    private var reviewersValue: List<InlineOrgsCodeSecurityConf078bPostRequestJsonItemX6fce6a4b>? =
        null

    /**
     * The bypass reviewers for secret scanning delegated bypass
     */
    public var reviewers: List<InlineOrgsCodeSecurityConf078bPostRequestJsonItemX6fce6a4b>?
  ...
  internal object Serializer : KSerializer<InlineOrgsCodeSecurityConf078bPostRequestJsonSecretScanningDelega7d2cX3848280f> {
