 ...
 * ub_app/properties/owner
 */
@Serializable(with = InlineWebhookIssuesLockedIssuePerformedViaGithubAppOwnerXfd2e05a1.Serializer::class)
public class InlineWebhookIssuesLockedIssuePerformedViaGithubAppOwnerXfd2e05a1(
  public val id: Int,
  ...
  public val type: InlineWebhookIssuesLockedIssuePerformedViaGithubAppOwnerTypeXe06bca77? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookIssuesLockedIssuePerformedViaGithubAppOwnerTypeXe06bca77? = null
    ...
    public fun build(): InlineWebhookIssuesLockedIssuePerformedViaGithubAppOwnerXfd2e05a1 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssuesLockedIssuePerformedViaGithubAppOwnerXfd2e05a1(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesLockedIssuePerformedViaGithubAppOwnerXfd2e05a1 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesLockedIssuePerformedViaGithubAppOwnerXfd2e05a1> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesLockedIssuePerformedViaGithubAppOwnerXfd2e05a1 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesLockedIssuePerformedViaGithubAppOwnerXfd2e05a1")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesLockedIssuePerformedViaGithubAppOwnerXfd2e05a1 must be a JSON object")
      ...
      return InlineWebhookIssuesLockedIssuePerformedViaGithubAppOwnerXfd2e05a1(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssuesLockedIssuePerformedViaGithubAppOwnerTypeXe06bca77>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesLockedIssuePerformedViaGithubAppOwnerXfd2e05a1) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesLockedIssuePerformedViaGithubAppOwnerXfd2e05a1")
...
public fun inlineWebhookIssuesLockedIssuePerformedViaGithubAppOwnerXfd2e05a1(block: InlineWebhookIssuesLockedIssuePerformedViaGithubAppOwnerXfd2e05a1.Builder.() -> Unit): InlineWebhookIssuesLockedIssuePerformedViaGithubAppOwnerXfd2e05a1 = InlineWebhookIssuesLockedIssuePerformedViaGithubAppOwnerXfd2e05a1.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesLockedIssuePerformedViaGithubAppOwnerXfd2e05a1 is missing required property '" + name + "'")
