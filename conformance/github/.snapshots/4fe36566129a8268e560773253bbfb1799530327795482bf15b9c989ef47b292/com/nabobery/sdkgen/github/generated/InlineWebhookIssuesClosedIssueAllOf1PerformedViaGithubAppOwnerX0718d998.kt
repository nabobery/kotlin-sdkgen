 ...
 * via_github_app/properties/owner.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-issues-closed/properties/issue/allOf/0/properties/performed_
 * via_github_app/properties/owner
 */
@Serializable(with = InlineWebhookIssuesClosedIssueAllOf1PerformedViaGithubAppOwnerX0718d998.Serializer::class)
public class InlineWebhookIssuesClosedIssueAllOf1PerformedViaGithubAppOwnerX0718d998(
  public val id: Int,
  ...
  public val type:
      InlineWebhookIssuesClosedIssueAllOf1PerformedViaGithubAppOwnerTypeX2236b66f? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookIssuesClosedIssueAllOf1PerformedViaGithubAppOwnerTypeX2236b66f? =
        null
    ...
    public fun build(): InlineWebhookIssuesClosedIssueAllOf1PerformedViaGithubAppOwnerX0718d998 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookIssuesClosedIssueAllOf1PerformedViaGithubAppOwnerX0718d998(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookIssuesClosedIssueAllOf1PerformedViaGithubAppOwnerX0718d998 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookIssuesClosedIssueAllOf1PerformedViaGithubAppOwnerX0718d998> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookIssuesClosedIssueAllOf1PerformedViaGithubAppOwnerX0718d998 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookIssuesClosedIssueAllOf1PerformedViaGithubAppOwnerX0718d998")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookIssuesClosedIssueAllOf1PerformedViaGithubAppOwnerX0718d998 must be a JSON object")
      ...
      return InlineWebhookIssuesClosedIssueAllOf1PerformedViaGithubAppOwnerX0718d998(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookIssuesClosedIssueAllOf1PerformedViaGithubAppOwnerTypeX2236b66f>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookIssuesClosedIssueAllOf1PerformedViaGithubAppOwnerX0718d998) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookIssuesClosedIssueAllOf1PerformedViaGithubAppOwnerX0718d998")
...
public fun inlineWebhookIssuesClosedIssueAllOf1PerformedViaGithubAppOwnerX0718d998(block: InlineWebhookIssuesClosedIssueAllOf1PerformedViaGithubAppOwnerX0718d998.Builder.() -> Unit): InlineWebhookIssuesClosedIssueAllOf1PerformedViaGithubAppOwnerX0718d998 = InlineWebhookIssuesClosedIssueAllOf1PerformedViaGithubAppOwnerX0718d998.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookIssuesClosedIssueAllOf1PerformedViaGithubAppOwnerX0718d998 is missing required property '" + name + "'")
