 ...
 * _merge/properties/enabled_by.
 *
 * Source:
 * sdkgen://source/openapi.yaml#/components/schemas/webhook-pull-request-stacked/properties/pull_request/properties/auto
 * _merge/properties/enabled_by
 */
@Serializable(with = InlineWebhookPullRequestStackedPullRequestAutoMergeEnabledByXfdf40011.Serializer::class)
public class InlineWebhookPullRequestStackedPullRequestAutoMergeEnabledByXfdf40011(
  public val id: Int,
  ...
  public val type:
      InlineWebhookPullRequestStackedPullRequestAutoMergeEnabledByTypeX6c00993d? = null,
  /**
   * Wire format: `uri`. Represented as `String` in this release; SDKGen does not validate this format.
   */
  ...
  public class Builder {
    ...
    public var type: InlineWebhookPullRequestStackedPullRequestAutoMergeEnabledByTypeX6c00993d? =
        null
    ...
    public fun build(): InlineWebhookPullRequestStackedPullRequestAutoMergeEnabledByXfdf40011 {
      check(idValue != null) { "id is required" }
      check(loginValue != null) { "login is required" }
      return InlineWebhookPullRequestStackedPullRequestAutoMergeEnabledByXfdf40011(
        id = id,
        login = login,
        avatarUrl = avatarUrl,
        deleted = deleted,
  ...
  public companion object {
    public fun build(block: Builder.() -> Unit): InlineWebhookPullRequestStackedPullRequestAutoMergeEnabledByXfdf40011 = Builder().apply(block).build()
  }

  internal object Serializer : KSerializer<InlineWebhookPullRequestStackedPullRequestAutoMergeEnabledByXfdf40011> {
    override val descriptor: SerialDescriptor = JsonElement.serializer().descriptor

    override fun deserialize(decoder: Decoder): InlineWebhookPullRequestStackedPullRequestAutoMergeEnabledByXfdf40011 {
      val jsonDecoder = decoder.requireJsonDecoder("InlineWebhookPullRequestStackedPullRequestAutoMergeEnabledByXfdf40011")
      val json = jsonDecoder.json
      val rawObject = jsonDecoder.decodeJsonElement() as? JsonObject ?: throw SerializationException("InlineWebhookPullRequestStackedPullRequestAutoMergeEnabledByXfdf40011 must be a JSON object")
      ...
      return InlineWebhookPullRequestStackedPullRequestAutoMergeEnabledByXfdf40011(
        ...
        type = rawObject["type"]?.let { json.decodeFromJsonElement<InlineWebhookPullRequestStackedPullRequestAutoMergeEnabledByTypeX6c00993d>(it) },
        url = rawObject["url"]?.let { json.decodeFromJsonElement<String>(it) },
        userViewType = rawObject["user_view_type"]?.let { json.decodeFromJsonElement<String>(it) },
      )
    }

    override fun serialize(encoder: Encoder, `value`: InlineWebhookPullRequestStackedPullRequestAutoMergeEnabledByXfdf40011) {
      val jsonEncoder = encoder.requireJsonEncoder("InlineWebhookPullRequestStackedPullRequestAutoMergeEnabledByXfdf40011")
...
public fun inlineWebhookPullRequestStackedPullRequestAutoMergeEnabledByXfdf40011(block: InlineWebhookPullRequestStackedPullRequestAutoMergeEnabledByXfdf40011.Builder.() -> Unit): InlineWebhookPullRequestStackedPullRequestAutoMergeEnabledByXfdf40011 = InlineWebhookPullRequestStackedPullRequestAutoMergeEnabledByXfdf40011.build(block)

private inline fun <reified T> Json.decodeRequired(raw: JsonObject, name: String): T {
  val element = raw[name] ?: throw SerializationException("InlineWebhookPullRequestStackedPullRequestAutoMergeEnabledByXfdf40011 is missing required property '" + name + "'")
